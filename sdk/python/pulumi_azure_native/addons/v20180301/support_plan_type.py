...
class SupportPlanType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:addons/v20180301:SupportPlanType"), pulumi.Alias(type_="azure-native:addons:SupportPlanType"), pulumi.Alias(type_="azure-nextgen:addons:SupportPlanType"), pulumi.Alias(type_="azure-native:addons/v20170515:SupportPlanType"), pulumi.Alias(type_="azure-nextgen:addons/v20170515:SupportPlanType")])
