...
class SupportPlanTypeArgs:
    def __init__(__self__, *,
                 ...
                 plan_type_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SupportPlanType resource.
        :param pulumi.Input[builtins.str] provider_name: The support plan type. For now the only valid type is "canonical".
        :param pulumi.Input[builtins.str] plan_type_name: The Canonical support plan type.
        """
    ...
    def plan_type_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plan_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SupportPlanType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:addons/v20170515:SupportPlanType"), pulumi.Alias(type_="azure-native:addons/v20180301:SupportPlanType")])
