...
class SupportPlanType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:addons/v20180301:SupportPlanType"), pulumi.Alias(type_="azure-native_addons_v20170515:addons:SupportPlanType"), pulumi.Alias(type_="azure-native_addons_v20180301:addons:SupportPlanType")])
