...
def get_support_plan_type(plan_type_name: Optional[_builtins.str] = None,
...
def get_support_plan_type_output(plan_type_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
