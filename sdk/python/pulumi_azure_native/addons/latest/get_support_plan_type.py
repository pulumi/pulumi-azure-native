...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:addons:getSupportPlanType'.""", DeprecationWarning)
...
def get_support_plan_type(plan_type_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:addons/latest:getSupportPlanType', __args__, opts=opts, typ=GetSupportPlanTypeResult).value
