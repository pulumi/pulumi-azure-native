...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace = azure_native.operationalinsights.v20210601.Workspace("workspace",
            location="australiasoutheast",
            resource_group_name="oiautorest6685",
            retention_in_days=30,
            sku=azure_native.operationalinsights.v20210601.WorkspaceSkuResponseArgs(
                name="PerGB2018",
            ),
            tags={
                "tag1": "val1",
        ...
        ```sh
        $ pulumi import azure-native:operationalinsights/v20210601:Workspace AzTest2170 /subscriptions/00000000-0000-0000-0000-000000000005/resourcegroups/oiautorest6685/providers/microsoft.operationalinsights/workspaces/aztest2170 
        ```
