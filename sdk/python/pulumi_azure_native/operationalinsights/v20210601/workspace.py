...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if 'forceCmkForQuery' in kwargs:
            force_cmk_for_query = kwargs['forceCmkForQuery']
        if 'provisioningState' in kwargs:
            provisioning_state = kwargs['provisioningState']
        if 'publicNetworkAccessForIngestion' in kwargs:
            public_network_access_for_ingestion = kwargs['publicNetworkAccessForIngestion']
        if 'publicNetworkAccessForQuery' in kwargs:
        ...
        if 'workspaceCapping' in kwargs:
            workspace_capping = kwargs['workspaceCapping']
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if features is not None and not isinstance(features, WorkspaceFeaturesArgs):
            ...
            if sku is not None and not isinstance(sku, WorkspaceSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
            ...
            if workspace_capping is not None and not isinstance(workspace_capping, WorkspaceCappingArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20151101preview:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20201001:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20211201preview:Workspace"), pulumi.Alias(type_="azure-native:operationalinsights/v20221001:Workspace")])
