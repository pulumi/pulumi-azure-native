...
class StorageInsightConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20150320:StorageInsightConfig"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:StorageInsightConfig"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:StorageInsightConfig"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:StorageInsightConfig"), pulumi.Alias(type_="azure-native:operationalinsights:StorageInsightConfig")])
