...
class StorageInsightConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_insight_config = azure_native.operationalinsights.v20200801.StorageInsightConfig("storageInsightConfig",
            containers=["wad-iis-logfiles"],
            resource_group_name="OIAutoRest5123",
            storage_account=azure_native.operationalinsights.v20200801.StorageAccountArgs(
