...
class Table(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20211201preview:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20221001:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:Table"), pulumi.Alias(type_="azure-native:operationalinsights:Table")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Table, __self__).__init__(
            'azure-native:operationalinsights/v20230901:Table',
            resource_name,
            __props__,
            opts)
