...
class GetQueryPackResult:
    ...
    """
    def __init__(__self__, id=None, location=None, name=None, provisioning_state=None, query_pack_id=None, system_data=None, tags=None, time_created=None, time_modified=None, type=None):
...
def get_query_pack(query_pack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20230901:getQueryPack', __args__, opts=opts, typ=GetQueryPackResult).value
...
def get_query_pack_output(query_pack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20230901:getQueryPack', __args__, opts=opts, typ=GetQueryPackResult)
