...
def get_data_source(data_source_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20230901:getDataSource', __args__, opts=opts, typ=GetDataSourceResult).value
...
def get_data_source_output(data_source_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20230901:getDataSource', __args__, opts=opts, typ=GetDataSourceResult)
