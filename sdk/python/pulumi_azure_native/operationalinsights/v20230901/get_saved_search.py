...
def get_saved_search(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20230901:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult).value
...
def get_saved_search_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20230901:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult)
