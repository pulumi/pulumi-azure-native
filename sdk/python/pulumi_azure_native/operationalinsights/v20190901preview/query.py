...
class Query(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        query = azure_native.operationalinsights.v20190901preview.Query("query",
        ...
        \"\"\",
            ...
            related=azure_native.operationalinsights.v20190901preview.LogAnalyticsQueryPackQueryPropertiesRelatedArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20190901:Query")])
