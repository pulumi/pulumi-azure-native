...
class Query(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190901:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:Query"), pulumi.Alias(type_="azure-native:operationalinsights:Query")])
