...
def get_data_source(data_source_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_source_name: Name of the datasource
...
def get_data_source_output(data_source_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
