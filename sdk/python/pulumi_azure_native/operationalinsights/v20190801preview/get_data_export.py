...
warnings.warn("""azure-native:operationalinsights/v20190801preview:DataExport is being removed in the next major version of this provider. Please upgrade to azure-native:operationalinsights/v20200801:DataExport to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_export(data_export_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_export is deprecated: azure-native:operationalinsights/v20190801preview:DataExport is being removed in the next major version of this provider. Please upgrade to azure-native:operationalinsights/v20200801:DataExport to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataExportName'] = data_export_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20190801preview:getDataExport', __args__, opts=opts, typ=GetDataExportResult).value
