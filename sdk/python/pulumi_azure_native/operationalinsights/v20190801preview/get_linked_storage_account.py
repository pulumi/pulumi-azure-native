...
def get_linked_storage_account_output(data_source_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20190801preview:getLinkedStorageAccount', __args__, opts=opts, typ=GetLinkedStorageAccountResult)
