...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:operationalinsights/v20190801preview:DataExport":
                return DataExport(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20190801preview:LinkedService":
                return LinkedService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20190801preview:LinkedStorageAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "operationalinsights/v20190801preview", _module_instance)
