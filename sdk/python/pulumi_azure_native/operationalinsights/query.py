...
class QueryArgs:
    ...
    def _configure(
        ...
        if query_pack_name is None and 'queryPackName' in kwargs:
            query_pack_name = kwargs['queryPackName']
        if query_pack_name is None:
            raise TypeError("Missing 'query_pack_name' argument")
...
class Query(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            related = _utilities.configure(related, LogAnalyticsQueryPackQueryPropertiesRelatedArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190901:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20190901preview:Query")])
