...
class QueryArgs:
    def __init__(__self__, *,
                 ...
                 query_pack_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] body: Body of the query.
        :param pulumi.Input[builtins.str] display_name: Unique display name for your query within the Query Pack.
        :param pulumi.Input[builtins.str] query_pack_name: The name of the Log Analytics QueryPack resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] description: Description of the query.
        :param pulumi.Input[builtins.str] id: The id of a specific query defined in the Log Analytics QueryPack
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] tags: Tags associated with the query.
        """
    ...
    def query_pack_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def query_pack_name(self, value: pulumi.Input[builtins.str]):
...
class Query(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190901:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20190901preview:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:Query"), pulumi.Alias(type_="azure-native:operationalinsights/v20250701:Query")])
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Mapping[str, Sequence[builtins.str]]]]:
        """
        Tags associated with the query.
        """
        return pulumi.get(self, "tags")
