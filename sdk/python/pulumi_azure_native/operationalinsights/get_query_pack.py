...
def get_query_pack(query_pack_name: Optional[_builtins.str] = None,
...
def get_query_pack_output(query_pack_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
