...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:listWorkspaceKeys'.""", DeprecationWarning)
...
def list_workspace_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:listWorkspaceKeys', __args__, opts=opts, typ=ListWorkspaceKeysResult).value
