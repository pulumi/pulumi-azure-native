...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getLinkedStorageAccount'.""", DeprecationWarning)
...
def get_linked_storage_account(data_source_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_storage_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getLinkedStorageAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:getLinkedStorageAccount', __args__, opts=opts, typ=GetLinkedStorageAccountResult).value
