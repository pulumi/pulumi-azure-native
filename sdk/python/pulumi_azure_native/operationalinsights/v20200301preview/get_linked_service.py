...
def get_linked_service(linked_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_service is deprecated: azure-native:operationalinsights/v20200301preview:LinkedService is being removed in the next major version of this provider. Upgrade to at least azure-native:operationalinsights/v20200801:LinkedService to guarantee forwards compatibility.""")
    __args__ = dict()
