...
def get_saved_search(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_saved_search is deprecated: azure-native:operationalinsights/v20200301preview:SavedSearch is being removed in the next major version of this provider. Upgrade to at least azure-native:operationalinsights/v20200801:SavedSearch to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['savedSearchId'] = saved_search_id
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20200301preview:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult).value
