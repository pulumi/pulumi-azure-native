...
class ColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ColumnTypeEnum']] type: Column data type.
        """
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key_version: The version of the key associated with the Log Analytics cluster.
        """
...
class RuleDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] destination_table: The destination table used for the Summary rule results.
        :param pulumi.Input[_builtins.str] query: Summary rule query.
        :param pulumi.Input[Union[_builtins.str, 'TimeSelectorEnum']] time_selector: The time cursor used in Summary rules bins processing, e.g. TimeGenerated.
        """
...
class SearchResultsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] query: Search job query.
        :param pulumi.Input[_builtins.str] start_search_time: The timestamp to start the search from (UTC)
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class WorkspaceFeaturesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_log_access_using_only_resource_permissions: Flag that indicate which permission to use - resource or workspace or both.
        :param pulumi.Input[_builtins.bool] immediate_purge_data_on30_days: Flag that describes if we want to remove the data after 30 days.
        """
