...
def get_summary_log(resource_group_name: Optional[_builtins.str] = None,
                    summary_logs_name: Optional[_builtins.str] = None,
...
def get_summary_log_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                           summary_logs_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
