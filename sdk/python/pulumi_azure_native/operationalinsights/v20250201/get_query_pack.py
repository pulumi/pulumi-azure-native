...
def get_query_pack(query_pack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getQueryPack', __args__, opts=opts, typ=GetQueryPackResult).value
...
def get_query_pack_output(query_pack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getQueryPack', __args__, opts=opts, typ=GetQueryPackResult)
