...
__all__ = [
    ...
    'ClusterReplicationPropertiesResponse',
    'ClusterSkuResponse',
    'ColumnResponse',
    'IdentityResponse',
    ...
    'WorkspaceFailoverPropertiesResponse',
    'WorkspaceFeaturesResponse',
    'WorkspaceReplicationPropertiesResponse',
...
@pulumi.output_type
class ClusterReplicationPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if key == "createdDate":
            ...
            suggest = "last_modified_date"
        elif key == "provisioningState":
            suggest = "provisioning_state"
        elif key == "isAvailabilityZonesEnabled":
            suggest = "is_availability_zones_enabled"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ClusterReplicationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ClusterReplicationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster replication properties.
        :param str created_date: The cluster's replication creation time
        :param str last_modified_date: The last time the cluster's replication was updated.
        :param str provisioning_state: The provisioning state of the cluster replication.
        :param bool enabled: Specifies whether the replication is enabled or not. When true the cluster is replicate to the specified location.
        :param bool is_availability_zones_enabled: Should enable AvailabilityZones for the given replicated cluster
        :param str location: The secondary location of the replication. If replication is being enabled, enabled must be provided.
        """
...
@pulumi.output_type
class WorkspaceFailoverPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in WorkspaceFailoverPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        WorkspaceFailoverPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The failover state of the replication.
        :param str last_modified_date: The last time when the failover state was updated.
        :param str state: The failover state of the replication.
        """
        pulumi.set(__self__, "last_modified_date", last_modified_date)
        pulumi.set(__self__, "state", state)
...
@pulumi.output_type
class WorkspaceReplicationPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in WorkspaceReplicationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        WorkspaceReplicationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Workspace replication properties.
        :param str created_date: The last time when the replication was enabled.
        :param str last_modified_date: The last time when the replication was updated.
        :param str provisioning_state: The provisioning state of the replication.
        :param bool enabled: Specifies whether the replication is enabled or not. When true, workspace configuration and data is replicated to the specified location. If replication is been enabled, location must be provided.
        :param str location: The location of the replication.
        """
        pulumi.set(__self__, "created_date", created_date)
        pulumi.set(__self__, "last_modified_date", last_modified_date)
        pulumi.set(__self__, "provisioning_state", provisioning_state)
