...
__all__ = [
    ...
    'ClusterReplicationPropertiesArgsDict',
    'ClusterSkuArgs',
    'ClusterSkuArgsDict',
    'ColumnArgs',
    'ColumnArgsDict',
    ...
    'WorkspaceReplicationPropertiesArgsDict',
    'WorkspaceSkuArgs',
...
if not MYPY:
    class ClusterReplicationPropertiesArgsDict(TypedDict):
        """
        ...
        """
        is_availability_zones_enabled: NotRequired[pulumi.Input[bool]]
        """
    ...
    ClusterReplicationPropertiesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ClusterReplicationPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Cluster replication properties.
        :param pulumi.Input[bool] enabled: Specifies whether the replication is enabled or not. When true the cluster is replicate to the specified location.
        :param pulumi.Input[bool] is_availability_zones_enabled: Should enable AvailabilityZones for the given replicated cluster
        :param pulumi.Input[str] location: The secondary location of the replication. If replication is being enabled, enabled must be provided.
        """
...
if not MYPY:
    class WorkspaceReplicationPropertiesArgsDict(TypedDict):
        """
    ...
    WorkspaceReplicationPropertiesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class WorkspaceReplicationPropertiesArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 location: Optional[pulumi.Input[str]] = None):
        """
        Workspace replication properties.
        :param pulumi.Input[bool] enabled: Specifies whether the replication is enabled or not. When true, workspace configuration and data is replicated to the specified location. If replication is been enabled, location must be provided.
        :param pulumi.Input[str] location: The location of the replication.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if location is not None:
