...
def get_data_source(data_source_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getDataSource', __args__, opts=opts, typ=GetDataSourceResult).value
...
def get_data_source_output(data_source_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getDataSource', __args__, opts=opts, typ=GetDataSourceResult)
