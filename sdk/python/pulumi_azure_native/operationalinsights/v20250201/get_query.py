...
def get_query(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getQuery', __args__, opts=opts, typ=GetQueryResult).value
...
def get_query_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getQuery', __args__, opts=opts, typ=GetQueryResult)
