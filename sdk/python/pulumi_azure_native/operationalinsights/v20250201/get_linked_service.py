...
def get_linked_service(linked_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult).value
...
def get_linked_service_output(linked_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult)
