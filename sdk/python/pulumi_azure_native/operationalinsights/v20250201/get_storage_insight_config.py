...
def get_storage_insight_config(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getStorageInsightConfig', __args__, opts=opts, typ=GetStorageInsightConfigResult).value
...
def get_storage_insight_config_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getStorageInsightConfig', __args__, opts=opts, typ=GetStorageInsightConfigResult)
