...
def get_linked_storage_account(data_source_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getLinkedStorageAccount', __args__, opts=opts, typ=GetLinkedStorageAccountResult).value
...
def get_linked_storage_account_output(data_source_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getLinkedStorageAccount', __args__, opts=opts, typ=GetLinkedStorageAccountResult)
