...
def get_shared_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getSharedKeys', __args__, opts=opts, typ=GetSharedKeysResult).value
...
def get_shared_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getSharedKeys', __args__, opts=opts, typ=GetSharedKeysResult)
