...
def get_saved_search(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult).value
...
def get_saved_search_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult)
