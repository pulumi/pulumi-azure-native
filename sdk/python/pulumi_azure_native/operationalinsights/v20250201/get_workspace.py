...
class GetWorkspaceResult:
    ...
    def __init__(__self__, created_date=None, customer_id=None, default_data_collection_rule_resource_id=None, etag=None, failover=None, features=None, force_cmk_for_query=None, id=None, identity=None, location=None, modified_date=None, name=None, private_link_scoped_resources=None, provisioning_state=None, public_network_access_for_ingestion=None, public_network_access_for_query=None, replication=None, retention_in_days=None, sku=None, system_data=None, tags=None, type=None, workspace_capping=None):
        ...
        if failover and not isinstance(failover, dict):
            raise TypeError("Expected argument 'failover' to be a dict")
    ...
    @property
    @pulumi.getter
    def failover(self) -> Optional['outputs.WorkspaceFailoverPropertiesResponse']:
        """
    ...
    @property
    @pulumi.getter
    def replication(self) -> Optional['outputs.WorkspaceReplicationPropertiesResponse']:
        """
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
...
def get_workspace_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
