...
class GetClusterResult:
    ...
    @property
    @pulumi.getter
    def replication(self) -> Optional['outputs.ClusterReplicationPropertiesResponse']:
        """
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20250201:getCluster', __args__, opts=opts, typ=GetClusterResult).value
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20250201:getCluster', __args__, opts=opts, typ=GetClusterResult)
