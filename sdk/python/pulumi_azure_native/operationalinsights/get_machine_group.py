...
def get_machine_group(end_time: Optional[_builtins.str] = None,
                      machine_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str end_time: UTC date and time specifying the end time of an interval. When not specified the service uses DateTime.UtcNow
    :param _builtins.str machine_group_name: Machine Group resource name.
    :param _builtins.str resource_group_name: Resource group name within the specified subscriptionId.
    :param _builtins.str start_time: UTC date and time specifying the start time of an interval. When not specified the service uses DateTime.UtcNow - 10m
    :param _builtins.str workspace_name: OMS workspace containing the resources of interest.
    """
    __args__ = dict()
