...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if default_data_collection_rule_resource_id is None and 'defaultDataCollectionRuleResourceId' in kwargs:
            default_data_collection_rule_resource_id = kwargs['defaultDataCollectionRuleResourceId']
        ...
        if default_data_collection_rule_resource_id is not None:
            _setter("default_data_collection_rule_resource_id", default_data_collection_rule_resource_id)
