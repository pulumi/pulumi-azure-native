...
class Table(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        table = azure_native.operationalinsights.v20221001.Table("table",
            resource_group_name="oiautorest6685",
            retention_in_days=45,
            schema=azure_native.operationalinsights.v20221001.SchemaResponseArgs(
                columns=[azure_native.operationalinsights.v20221001.ColumnArgs(
                    name="MyNewColumn",
                    type="guid",
                )],
