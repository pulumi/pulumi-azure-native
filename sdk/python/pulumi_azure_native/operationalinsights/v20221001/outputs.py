...
class RestoredLogsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'azureAsyncOperationId' in kwargs:
...
class ResultStatisticsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'ingestedRecords' in kwargs:
            ingested_records = kwargs['ingestedRecords']
        if 'scannedGb' in kwargs:
...
class SchemaResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'standardColumns' in kwargs:
            standard_columns = kwargs['standardColumns']
        if 'tableSubType' in kwargs:
