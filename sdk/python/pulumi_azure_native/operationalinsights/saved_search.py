...
class SavedSearchArgs:
    def __init__(__self__, *,
                 ...
                 function_parameters: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] category: The category of the saved search. This helps the user to find a saved search faster. 
        :param pulumi.Input[builtins.str] display_name: Saved search display name.
        :param pulumi.Input[builtins.str] query: The query expression for the saved search.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] workspace_name: The name of the workspace.
        :param pulumi.Input[builtins.str] function_alias: The function alias if query serves as a function.
        :param pulumi.Input[builtins.str] function_parameters: The optional function parameters if query serves as a function. Value should be in the following format: 'param-name1:type1 = default_value1, param-name2:type2 = default_value2'. For more examples and proper syntax please refer to https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions.
        :param pulumi.Input[builtins.str] saved_search_id: The id of the saved search.
        :param pulumi.Input[Sequence[pulumi.Input['TagArgs']]] tags: The tags attached to the saved search.
        :param pulumi.Input[builtins.float] version: The version number of the query language. The current version is 2 and is the default.
        """
    ...
    def function_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def function_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SavedSearch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20150320:SavedSearch"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:SavedSearch"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:SavedSearch"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:SavedSearch"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:SavedSearch"), pulumi.Alias(type_="azure-native:operationalinsights/v20250701:SavedSearch")])
    ...
    @property
    @pulumi.getter(name="functionParameters")
    def function_parameters(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The optional function parameters if query serves as a function. Value should be in the following format: 'param-name1:type1 = default_value1, param-name2:type2 = default_value2'. For more examples and proper syntax please refer to https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions.
        """
        return pulumi.get(self, "function_parameters")
    ...
    @property
    @pulumi.getter
    def version(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The version number of the query language. The current version is 2 and is the default.
        """
        return pulumi.get(self, "version")
