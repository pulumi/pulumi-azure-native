...
class StorageInsight(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_insight = azure_native.operationalinsights.v20150320.StorageInsight("storageInsight",
            containers=["wad-iis-logfiles"],
            resource_group_name="OIAutoRest5123",
            storage_account=azure_native.operationalinsights.v20150320.StorageAccountArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights:StorageInsight"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:StorageInsight"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:StorageInsight")])
