...
class StorageInsight(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights:StorageInsight"), pulumi.Alias(type_="azure-nextgen:operationalinsights:StorageInsight"), pulumi.Alias(type_="azure-native:operationalinsights/latest:StorageInsight"), pulumi.Alias(type_="azure-nextgen:operationalinsights/latest:StorageInsight"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:StorageInsight"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:StorageInsight"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:StorageInsight"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:StorageInsight")])
