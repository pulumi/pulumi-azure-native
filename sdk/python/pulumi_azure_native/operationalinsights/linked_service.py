...
class LinkedService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20151101preview:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20190801preview:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20200301preview:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20200801:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20230901:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native_operationalinsights_v20250201:operationalinsights:LinkedService")])
