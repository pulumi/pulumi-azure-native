...
def get_query(id: Optional[_builtins.str] = None,
              query_pack_name: Optional[_builtins.str] = None,
...
def get_query_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
