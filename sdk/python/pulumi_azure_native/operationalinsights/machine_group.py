...
class MachineGroupArgs:
    def __init__(__self__, *,
                 ...
                 group_type: Optional[pulumi.Input[Union[builtins.str, 'MachineGroupType']]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: User defined name for the group
        :param pulumi.Input[builtins.str] kind: Additional resource type qualifier.
               Expected value is 'machineGroup'.
        :param pulumi.Input[builtins.str] resource_group_name: Resource group name within the specified subscriptionId.
        :param pulumi.Input[builtins.str] workspace_name: OMS workspace containing the resources of interest.
        :param pulumi.Input[builtins.int] count: Count of machines in this group. The value of count may be bigger than the number of machines in case of the group has been truncated due to exceeding the max number of machines a group can handle.
        :param pulumi.Input[Union[builtins.str, 'MachineGroupType']] group_type: Type of the machine group
        :param pulumi.Input[builtins.str] machine_group_name: Machine Group resource name.
    ...
    def group_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'MachineGroupType']]]:
        """
    ...
    @group_type.setter
    def group_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'MachineGroupType']]]):
        pulumi.set(self, "group_type", value)

    @property
    @pulumi.getter(name="machineGroupName")
    def machine_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def machine_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
