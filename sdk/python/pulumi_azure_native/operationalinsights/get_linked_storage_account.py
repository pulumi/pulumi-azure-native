...
def get_linked_storage_account(data_source_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_source_type: Linked storage accounts type.
...
def get_linked_storage_account_output(data_source_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
