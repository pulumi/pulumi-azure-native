...
class Table(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        table = azure_native.operationalinsights.v20211201preview.Table("table",
            resource_group_name="oiautorest6685",
            retention_in_days=45,
            schema=azure_native.operationalinsights.v20211201preview.SchemaResponseArgs(
                columns=[azure_native.operationalinsights.v20211201preview.ColumnArgs(
                    name="MyNewColumn",
                    type="guid",
                )],
        ...
        ```sh
        $ pulumi import azure-native:operationalinsights/v20211201preview:Table AzureNetworkFlow /subscriptions/00000000-0000-0000-0000-00000000000/resourcegroups/oiautorest6685/providers/Microsoft.OperationalInsights/workspaces/oiautorest6685/tables/AzureNetworkFlow 
        ```
