...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace = azure_native.operationalinsights.v20211201preview.Workspace("workspace",
            location="australiasoutheast",
            resource_group_name="oiautorest6685",
            retention_in_days=30,
            sku=azure_native.operationalinsights.v20211201preview.WorkspaceSkuResponseArgs(
                name="PerGB2018",
            ),
            tags={
                "tag1": "val1",
