...
class AssociatedWorkspaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str workspace_name: Associated workspace resource name.
        """
...
class ColumnResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_type_hint: Optional[_builtins.str] = None,
        ...
        :param _builtins.str description: Column description.
        :param _builtins.str display_name: Column display name.
        :param _builtins.str name: Column name.
        :param _builtins.str type: Column data type.
        """
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_rsa_size: Optional[_builtins.int] = None,
        ...
        :param _builtins.str key_version: The version of the key associated with the Log Analytics cluster.
        """
...
class MachineReferenceWithHintsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str os_family_hint: Last known operating system family.
        :param _builtins.str type: Resource type qualifier.
        """
...
class RestoredLogsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 end_restore_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str start_restore_time: The timestamp to start the restore from (UTC).
        """
...
class SchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str source: Table's creator.
        :param Sequence['ColumnResponse'] standard_columns: A list of table standard columns.
        :param _builtins.str table_sub_type: The subtype describes what APIs can be used to interact with the table, and what features are available against it.
        :param _builtins.str table_type: Table's creator.
        :param Sequence['ColumnResponse'] columns: A list of table custom columns.
        :param _builtins.str description: Table description.
        :param _builtins.str display_name: Table display name.
...
class SearchResultsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None,
                 end_search_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str end_search_time: The timestamp to end the search by (UTC)
        :param _builtins.int limit: Limit the search job to return up to specified number of rows.
        :param _builtins.str query: Search job query.
        :param _builtins.str start_search_time: The timestamp to start the search from (UTC)
        """
        pulumi.set(__self__, "azure_async_operation_id", azure_async_operation_id)
        pulumi.set(__self__, "source_table", source_table)
        if description is not None:
...
class WorkspaceFeaturesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cluster_resource_id: Optional[_builtins.str] = None,
                 disable_local_auth: Optional[_builtins.bool] = None,
                 enable_data_export: Optional[_builtins.bool] = None,
                 enable_log_access_using_only_resource_permissions: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool enable_data_export: Flag that indicate if data should be exported.
        :param _builtins.bool enable_log_access_using_only_resource_permissions: Flag that indicate which permission to use - resource or workspace or both.
        :param _builtins.bool immediate_purge_data_on30_days: Flag that describes if we want to remove the data after 30 days.
        """
