...
class GetDataSourceResult:
    ...
    """
    def __init__(__self__, e_tag=None, id=None, kind=None, name=None, properties=None, tags=None, type=None):
...
def get_data_source(data_source_name: Optional[str] = None,
    ...
    :param str workspace_name: Name of the Log Analytics Workspace that contains the datasource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/v20151101preview:getDataSource', __args__, opts=opts, typ=GetDataSourceResult).value
...
def get_data_source_output(data_source_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:operationalinsights/v20151101preview:getDataSource', __args__, opts=opts, typ=GetDataSourceResult)
