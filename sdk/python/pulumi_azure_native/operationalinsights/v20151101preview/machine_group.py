...
class MachineGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20151101preview:MachineGroup"), pulumi.Alias(type_="azure-native:operationalinsights:MachineGroup"), pulumi.Alias(type_="azure-nextgen:operationalinsights:MachineGroup")])
