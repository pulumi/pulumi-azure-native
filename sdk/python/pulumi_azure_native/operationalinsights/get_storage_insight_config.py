...
def get_storage_insight_config(resource_group_name: Optional[_builtins.str] = None,
                               storage_insight_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str storage_insight_name: Name of the storageInsightsConfigs resource
...
def get_storage_insight_config_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                      storage_insight_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
