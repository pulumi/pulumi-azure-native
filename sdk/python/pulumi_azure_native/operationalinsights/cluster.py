...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 billing_type: Optional[pulumi.Input[Union[builtins.str, 'BillingType']]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['ManagedServiceIdentityArgs']] = None,
                 is_availability_zones_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_double_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'BillingType']] billing_type: The cluster's billing type.
        :param pulumi.Input[builtins.str] cluster_name: The name of the Log Analytics cluster.
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: Resource's identity.
        :param pulumi.Input[builtins.bool] is_availability_zones_enabled: Sets whether the cluster will support availability zones. This can be set as true only in regions where Azure Data Explorer support Availability Zones. This Property can not be modified after cluster creation. Default value is 'true' if region supports Availability Zones.
        :param pulumi.Input[builtins.bool] is_double_encryption_enabled: Configures whether cluster will use double encryption. This Property can not be modified after cluster creation. Default value is 'true'
    ...
    def billing_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'BillingType']]]:
        """
    ...
    @billing_type.setter
    def billing_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'BillingType']]]):
    ...
    def is_availability_zones_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_availability_zones_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_availability_zones_enabled", value)

    @property
    @pulumi.getter(name="isDoubleEncryptionEnabled")
    def is_double_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_double_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190801preview:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20201001:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20210601:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20221001:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20250701:Cluster")])
    ...
    @property
    @pulumi.getter(name="isAvailabilityZonesEnabled")
    def is_availability_zones_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Sets whether the cluster will support availability zones. This can be set as true only in regions where Azure Data Explorer support Availability Zones. This Property can not be modified after cluster creation. Default value is 'true' if region supports Availability Zones.
        """
        return pulumi.get(self, "is_availability_zones_enabled")
    ...
    @property
    @pulumi.getter(name="isDoubleEncryptionEnabled")
    def is_double_encryption_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Configures whether cluster will use double encryption. This Property can not be modified after cluster creation. Default value is 'true'
        """
        return pulumi.get(self, "is_double_encryption_enabled")
