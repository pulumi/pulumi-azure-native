...
class ClusterArgs:
    ...
    def _configure(
        ...
        if is_availability_zones_enabled is None and 'isAvailabilityZonesEnabled' in kwargs:
            is_availability_zones_enabled = kwargs['isAvailabilityZonesEnabled']
        if is_double_encryption_enabled is None and 'isDoubleEncryptionEnabled' in kwargs:
            is_double_encryption_enabled = kwargs['isDoubleEncryptionEnabled']
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190801preview:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20201001:Cluster"), pulumi.Alias(type_="azure-native:operationalinsights/v20210601:Cluster")])
