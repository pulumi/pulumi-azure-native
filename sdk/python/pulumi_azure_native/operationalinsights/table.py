...
class TableArgs:
    def __init__(__self__, *,
                 ...
                 plan: Optional[pulumi.Input[Union[builtins.str, 'TablePlanEnum']]] = None,
                 ...
                 total_retention_in_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Table resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] workspace_name: The name of the workspace.
        :param pulumi.Input[Union[builtins.str, 'TablePlanEnum']] plan: Instruct the system how to handle and charge the logs ingested to this table.
        :param pulumi.Input['RestoredLogsArgs'] restored_logs: Parameters of the restore operation that initiated this table.
        :param pulumi.Input[builtins.int] retention_in_days: The table retention in days, between 4 and 730. Setting this property to -1 will default to the workspace retention.
        ...
        :param pulumi.Input[builtins.int] total_retention_in_days: The table total retention in days, between 4 and 4383. Setting this property to -1 will default to table retention.
        """
    ...
    @property
    @pulumi.getter
    def plan(self) -> Optional[pulumi.Input[Union[builtins.str, 'TablePlanEnum']]]:
        """
    ...
    @plan.setter
    def plan(self, value: Optional[pulumi.Input[Union[builtins.str, 'TablePlanEnum']]]):
    ...
    def total_retention_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_retention_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Table(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20211201preview:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20221001:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:Table"), pulumi.Alias(type_="azure-native:operationalinsights/v20250701:Table")])
    ...
    def archive_retention_in_days(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def last_plan_modified_date(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def retention_in_days_as_default(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="totalRetentionInDays")
    def total_retention_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The table total retention in days, between 4 and 4383. Setting this property to -1 will default to table retention.
        """
        return pulumi.get(self, "total_retention_in_days")
    ...
    def total_retention_in_days_as_default(self) -> pulumi.Output[builtins.bool]:
        """
