...
class QueryPackArgs:
    ...
    def query_pack_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def query_pack_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class QueryPack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:operationalinsights/v20190901:QueryPack"), pulumi.Alias(type_="azure-native:operationalinsights/v20190901preview:QueryPack"), pulumi.Alias(type_="azure-native:operationalinsights/v20230901:QueryPack"), pulumi.Alias(type_="azure-native:operationalinsights/v20250201:QueryPack"), pulumi.Alias(type_="azure-native:operationalinsights/v20250701:QueryPack")])
