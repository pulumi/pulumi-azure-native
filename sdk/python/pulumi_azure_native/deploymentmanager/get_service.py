...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deploymentmanager:getService', __args__, opts=opts, typ=GetServiceResult).value
    ...
    return AwaitableGetServiceResult(
        ...
        target_location=pulumi.get(__ret__, 'target_location'),
        target_subscription_id=pulumi.get(__ret__, 'target_subscription_id'),
