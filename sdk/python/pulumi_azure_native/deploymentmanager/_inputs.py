...
class ApiKeyAuthenticationArgs:
    ...
    def _configure(
             ...
             in_: Optional[pulumi.Input['RestAuthLocation']] = None,
...
class HealthCheckStepPropertiesArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             attributes: Optional[pulumi.Input['RestHealthCheckStepAttributesArgs']] = None,
...
class RestHealthCheckStepAttributesArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             health_checks: Optional[pulumi.Input[Sequence[pulumi.Input['RestHealthCheckArgs']]]] = None,
             healthy_state_duration: Optional[pulumi.Input[str]] = None,
             type: Optional[pulumi.Input[str]] = None,
             max_elastic_duration: Optional[pulumi.Input[str]] = None,
             wait_duration: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class RestHealthCheckArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             name: Optional[pulumi.Input[str]] = None,
             request: Optional[pulumi.Input['RestRequestArgs']] = None,
             response: Optional[pulumi.Input['RestResponseArgs']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if name is None:
...
class RestRequestArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             authentication: Optional[pulumi.Input[Union['ApiKeyAuthenticationArgs', 'RolloutIdentityAuthenticationArgs']]] = None,
             method: Optional[pulumi.Input['RestRequestMethod']] = None,
