...
class ServiceTopology(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager:ServiceTopology"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:ServiceTopology"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:ServiceTopology"), pulumi.Alias(type_="azure-native:deploymentmanager/v20191101preview:ServiceTopology"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:ServiceTopology")])
