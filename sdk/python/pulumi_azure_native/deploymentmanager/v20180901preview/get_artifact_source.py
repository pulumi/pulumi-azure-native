...
def get_artifact_source(artifact_source_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_artifact_source is deprecated: Version v20180901preview will be removed in the next major version of the provider. Upgrade to version v20191101preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deploymentmanager/v20180901preview:getArtifactSource', __args__, opts=opts, typ=GetArtifactSourceResult).value
