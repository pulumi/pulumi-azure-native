...
class Rollout(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rollout = azure_native.deploymentmanager.v20180901preview.Rollout("rollout",
            ...
            identity=azure_native.deploymentmanager.v20180901preview.IdentityArgs(
            ...
            step_groups=[
                azure_native.deploymentmanager.v20180901preview.StepArgs(
                    ...
                    name="FirstRegion",
                    post_deployment_steps=[azure_native.deploymentmanager.v20180901preview.PrePostStepArgs(
                        step_id="Microsoft.DeploymentManager/steps/postDeployStep1",
                    )],
                    pre_deployment_steps=[
                        azure_native.deploymentmanager.v20180901preview.PrePostStepArgs(
