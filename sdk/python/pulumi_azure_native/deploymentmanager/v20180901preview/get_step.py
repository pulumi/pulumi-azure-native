...
def get_step(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_step is deprecated: Version 2018-09-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['stepName'] = step_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:deploymentmanager/v20180901preview:getStep', __args__, opts=opts, typ=GetStepResult).value
