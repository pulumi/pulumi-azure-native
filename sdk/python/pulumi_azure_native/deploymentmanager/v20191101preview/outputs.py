...
class RolloutOperationInfoResponse(dict):
    ...
    def _configure(
        ...
        if 'retryAttempt' in kwargs:
            retry_attempt = kwargs['retryAttempt']
        if 'skipSucceededOnRetry' in kwargs:
