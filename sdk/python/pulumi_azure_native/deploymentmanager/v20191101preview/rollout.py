...
class Rollout(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rollout = azure_native.deploymentmanager.v20191101preview.Rollout("rollout",
            ...
            identity=azure_native.deploymentmanager.v20191101preview.IdentityArgs(
            ...
            step_groups=[
                azure_native.deploymentmanager.v20191101preview.StepGroupArgs(
                    ...
                    name="FirstRegion",
                    post_deployment_steps=[azure_native.deploymentmanager.v20191101preview.PrePostStepArgs(
                        step_id="Microsoft.DeploymentManager/steps/postDeployStep1",
                    )],
                    pre_deployment_steps=[
                        azure_native.deploymentmanager.v20191101preview.PrePostStepArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deploymentmanager:Rollout"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:Rollout")])
