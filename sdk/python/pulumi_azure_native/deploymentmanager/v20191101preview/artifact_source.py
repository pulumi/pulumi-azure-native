...
class ArtifactSourceArgs:
    ...
    def _configure(
        ...
        if 'artifactRoot' in kwargs:
            artifact_root = kwargs['artifactRoot']
        if 'artifactSourceName' in kwargs:
...
class ArtifactSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication is not None and not isinstance(authentication, SasAuthenticationArgs):
                authentication = authentication or {}
                def _setter(key, value):
                    authentication[key] = value
                SasAuthenticationArgs._configure(_setter, **authentication)
