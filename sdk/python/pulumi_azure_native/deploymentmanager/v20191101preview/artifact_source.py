...
class ArtifactSourceArgs:
    ...
    def _configure(
             ...
             authentication: Optional[pulumi.Input['SasAuthenticationArgs']] = None,
        ...
        if artifact_root is None and 'artifactRoot' in kwargs:
            artifact_root = kwargs['artifactRoot']
        if artifact_source_name is None and 'artifactSourceName' in kwargs:
            artifact_source_name = kwargs['artifactSourceName']

        _setter("authentication", authentication)
        _setter("resource_group_name", resource_group_name)
        _setter("source_type", source_type)
        if artifact_root is not None:
            _setter("artifact_root", artifact_root)
        if artifact_source_name is not None:
            _setter("artifact_source_name", artifact_source_name)
...
class ArtifactSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, SasAuthenticationArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deploymentmanager:ArtifactSource"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:ArtifactSource")])
