...
class ServiceUnit(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service_unit = azure_native.deploymentmanager.v20191101preview.ServiceUnit("serviceUnit",
            artifacts=azure_native.deploymentmanager.v20191101preview.ServiceUnitArtifactsArgs(
            ...
            deployment_mode=azure_native.deploymentmanager/v20191101preview.DeploymentMode.INCREMENTAL,
            location="centralus",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deploymentmanager:ServiceUnit"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:ServiceUnit")])
