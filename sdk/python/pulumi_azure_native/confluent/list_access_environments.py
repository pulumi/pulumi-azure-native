...
def list_access_environments(organization_name: Optional[_builtins.str] = None,
                             resource_group_name: Optional[_builtins.str] = None,
                             search_filters: Optional[Mapping[str, _builtins.str]] = None,
    ...
    :param Mapping[str, _builtins.str] search_filters: Search filters for the request
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent:listAccessEnvironments', __args__, opts=opts, typ=ListAccessEnvironmentsResult).value

    return AwaitableListAccessEnvironmentsResult(
        data=pulumi.get(__ret__, 'data'),
        kind=pulumi.get(__ret__, 'kind'),
        metadata=pulumi.get(__ret__, 'metadata'))
def list_access_environments_output(organization_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent:listAccessEnvironments', __args__, opts=opts, typ=ListAccessEnvironmentsResult)
