...
def list_access_environments(organization_name: Optional[builtins.str] = None,
...
def list_access_environments_output(organization_name: Optional[pulumi.Input[builtins.str]] = None,
