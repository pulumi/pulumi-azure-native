...
warnings.warn("""azure-native:confluent/v20210301preview:Organization is being removed in the next major version of this provider. Upgrade to at least azure-native:confluent/v20211201:Organization to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_organization(organization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_organization is deprecated: azure-native:confluent/v20210301preview:Organization is being removed in the next major version of this provider. Upgrade to at least azure-native:confluent/v20211201:Organization to guarantee forwards compatibility.""")
    __args__ = dict()
