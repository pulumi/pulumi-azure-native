...
def get_organization(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent/v20230822:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
...
def get_organization_output(organization_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent/v20230822:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
