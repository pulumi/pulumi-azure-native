...
class OrganizationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if offer_detail is None and 'offerDetail' in kwargs:
            offer_detail = kwargs['offerDetail']
        if offer_detail is None:
            raise TypeError("Missing 'offer_detail' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if user_detail is None and 'userDetail' in kwargs:
            user_detail = kwargs['userDetail']
        if user_detail is None:
            raise TypeError("Missing 'user_detail' argument")
        if link_organization is None and 'linkOrganization' in kwargs:
            link_organization = kwargs['linkOrganization']
        ...
        if link_organization is not None:
            _setter("link_organization", link_organization)
...
class Organization(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 link_organization: Optional[pulumi.Input[pulumi.InputType['LinkOrganizationArgs']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LinkOrganizationArgs']] link_organization: Link an existing Confluent organization
        :param pulumi.Input[str] location: Location of Organization resource
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            link_organization = _utilities.configure(link_organization, LinkOrganizationArgs, True)
            __props__.__dict__["link_organization"] = link_organization
            __props__.__dict__["location"] = location
            offer_detail = _utilities.configure(offer_detail, OfferDetailArgs, True)
            ...
            user_detail = _utilities.configure(user_detail, UserDetailArgs, True)
