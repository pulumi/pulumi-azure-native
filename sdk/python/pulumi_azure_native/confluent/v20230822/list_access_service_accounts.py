...
def list_access_service_accounts(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent/v20230822:listAccessServiceAccounts', __args__, opts=opts, typ=ListAccessServiceAccountsResult).value
...
def list_access_service_accounts_output(organization_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['searchFilters'] = search_filters
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent/v20230822:listAccessServiceAccounts', __args__, opts=opts, typ=ListAccessServiceAccountsResult)
