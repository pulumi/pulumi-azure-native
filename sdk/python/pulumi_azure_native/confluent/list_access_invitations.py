...
def list_access_invitations(organization_name: Optional[_builtins.str] = None,
...
def list_access_invitations_output(organization_name: Optional[pulumi.Input[_builtins.str]] = None,
