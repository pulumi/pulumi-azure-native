...
def list_access_users(organization_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent:listAccessUsers', __args__, opts=opts, typ=ListAccessUsersResult).value

    return AwaitableListAccessUsersResult(
        data=pulumi.get(__ret__, 'data'),
        kind=pulumi.get(__ret__, 'kind'),
        metadata=pulumi.get(__ret__, 'metadata'))
def list_access_users_output(organization_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent:listAccessUsers', __args__, opts=opts, typ=ListAccessUsersResult)
