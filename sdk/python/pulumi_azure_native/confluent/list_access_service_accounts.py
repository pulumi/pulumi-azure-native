...
def list_access_service_accounts(organization_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent:listAccessServiceAccounts', __args__, opts=opts, typ=ListAccessServiceAccountsResult).value

    return AwaitableListAccessServiceAccountsResult(
        data=pulumi.get(__ret__, 'data'),
        kind=pulumi.get(__ret__, 'kind'),
        metadata=pulumi.get(__ret__, 'metadata'))
def list_access_service_accounts_output(organization_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent:listAccessServiceAccounts', __args__, opts=opts, typ=ListAccessServiceAccountsResult)
