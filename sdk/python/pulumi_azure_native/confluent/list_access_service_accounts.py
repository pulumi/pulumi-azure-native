...
def list_access_service_accounts(organization_name: Optional[builtins.str] = None,
...
def list_access_service_accounts_output(organization_name: Optional[pulumi.Input[builtins.str]] = None,
