...
class OrganizationEnvironmentByIdArgs:
    ...
    def stream_governance_config(self) -> pulumi.Input[Optional['StreamGovernanceConfigArgs']]:
        """
    ...
    def stream_governance_config(self, value: pulumi.Input[Optional['StreamGovernanceConfigArgs']]):
...
class OrganizationEnvironmentById(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 stream_governance_config: pulumi.Input[Optional[Union['StreamGovernanceConfigArgs', 'StreamGovernanceConfigArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:confluent/v20240701:OrganizationEnvironmentById"), pulumi.Alias(type_="azure-native:confluent/v20250717preview:OrganizationEnvironmentById"), pulumi.Alias(type_="azure-native:confluent/v20250818preview:OrganizationEnvironmentById"), pulumi.Alias(type_="azure-native:confluent/v20260501preview:OrganizationEnvironmentById"), pulumi.Alias(type_="azure-native:confluent/v20260602preview:OrganizationEnvironmentById")])
