...
class OrganizationClusterById(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:confluent/v20240701:OrganizationClusterById"), pulumi.Alias(type_="azure-native:confluent/v20250717preview:OrganizationClusterById"), pulumi.Alias(type_="azure-native:confluent/v20250818preview:OrganizationClusterById"), pulumi.Alias(type_="azure-native:confluent/v20260501preview:OrganizationClusterById"), pulumi.Alias(type_="azure-native:confluent/v20260602preview:OrganizationClusterById")])
