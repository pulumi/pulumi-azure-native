...
class Organization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(offer_detail, OrganizationResourcePropertiesOfferDetailArgs):
            ...
            if not isinstance(user_detail, OrganizationResourcePropertiesUserDetailArgs):
