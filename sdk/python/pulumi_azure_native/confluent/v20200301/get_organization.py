...
def get_organization(organization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_organization is deprecated: azure-native:confluent/v20200301:Organization is being removed in the next major version of this provider. Upgrade to at least azure-native:confluent/v20200301preview:Organization to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['organizationName'] = organization_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:confluent/v20200301:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
