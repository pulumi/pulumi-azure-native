...
def list_access_role_binding_name(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent/v20240213:listAccessRoleBindingName', __args__, opts=opts, typ=ListAccessRoleBindingNameResult).value
...
def list_access_role_binding_name_output(organization_name: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ListAccessRoleBindingNameResult]:
    """
    Details of the role binding names returned on successful response
    ...
    __args__['searchFilters'] = search_filters
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:confluent/v20240213:listAccessRoleBindingName', __args__, opts=opts, typ=ListAccessRoleBindingNameResult)
