...
def get_organization_cluster_by_id(cluster_id: Optional[_builtins.str] = None,
...
def get_organization_cluster_by_id_output(cluster_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
