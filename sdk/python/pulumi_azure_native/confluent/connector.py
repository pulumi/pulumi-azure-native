...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:confluent/v20240701:Connector"), pulumi.Alias(type_="azure-native:confluent/v20250717preview:Connector"), pulumi.Alias(type_="azure-native:confluent/v20250818preview:Connector"), pulumi.Alias(type_="azure-native:confluent/v20260501preview:Connector"), pulumi.Alias(type_="azure-native:confluent/v20260602preview:Connector")])
