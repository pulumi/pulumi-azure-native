...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:confluent:getOrganization'.""", DeprecationWarning)
...
def get_organization(organization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confluent/latest:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
