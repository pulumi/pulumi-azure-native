...
def get_cloud_hsm_cluster(cloud_hsm_cluster_name: Optional[_builtins.str] = None,
...
def get_cloud_hsm_cluster_output(cloud_hsm_cluster_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
