...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if management_network_profile is not None and not isinstance(management_network_profile, NetworkProfileArgs):
                management_network_profile = management_network_profile or {}
                def _setter(key, value):
                    management_network_profile[key] = value
                NetworkProfileArgs._configure(_setter, **management_network_profile)
