...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dedicated_hsm = azure_native.hardwaresecuritymodules.v20211130.DedicatedHsm("dedicatedHsm",
            location="westus",
            name="hsm1",
            network_profile=azure_native.hardwaresecuritymodules.v20211130.NetworkProfileResponseArgs(
                network_interfaces=[azure_native.hardwaresecuritymodules.v20211130.NetworkInterfaceArgs(
                    private_ip_address="1.0.0.1",
                )],
                subnet=azure_native.hardwaresecuritymodules.v20211130.ApiEntityReferenceArgs(
            ...
            sku=azure_native.hardwaresecuritymodules.v20211130.SkuArgs(
        ...
        dedicated_hsm = azure_native.hardwaresecuritymodules.v20211130.DedicatedHsm("dedicatedHsm",
            location="westus",
            management_network_profile=azure_native.hardwaresecuritymodules.v20211130.NetworkProfileResponseArgs(
                network_interfaces=[azure_native.hardwaresecuritymodules.v20211130.NetworkInterfaceArgs(
