...
class DedicatedHsmPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "managementNetworkProfile":
            suggest = "management_network_profile"
    ...
    def __init__(__self__, *,
                 ...
                 status_message: str,
                 management_network_profile: Optional['outputs.NetworkProfileResponse'] = None,
        ...
        :param 'NetworkProfileResponse' management_network_profile: Specifies the management network interfaces of the dedicated hsm.
