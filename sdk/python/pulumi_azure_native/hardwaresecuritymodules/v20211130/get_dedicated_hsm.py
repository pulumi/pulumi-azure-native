...
class GetDedicatedHsmResult:
    ...
    """
    def __init__(__self__, id=None, location=None, name=None, properties=None, sku=None, system_data=None, tags=None, type=None, zones=None):
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.DedicatedHsmPropertiesResponse':
        """
