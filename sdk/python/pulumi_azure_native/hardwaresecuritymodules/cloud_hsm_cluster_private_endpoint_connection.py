...
class CloudHsmClusterPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 cloud_hsm_cluster_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] pe_connection_name: Name of the private endpoint connection associated with the Cloud HSM Cluster.
        """
    ...
    def cloud_hsm_cluster_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cloud_hsm_cluster_name(self, value: pulumi.Input[builtins.str]):
