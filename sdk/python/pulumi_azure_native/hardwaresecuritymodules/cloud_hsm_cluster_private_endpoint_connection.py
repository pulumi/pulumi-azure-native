...
class CloudHsmClusterPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        CloudHsmClusterPrivateEndpointConnectionArgs._configure(
    ...
    def _configure(
        ...
        if cloud_hsm_cluster_name is None:
            raise TypeError("Missing 'cloud_hsm_cluster_name' argument")
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CloudHsmClusterPrivateEndpointConnectionArgs._configure(_setter, **kwargs)
