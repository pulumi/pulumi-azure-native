...
class ApiEntityReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        The API entity reference.
        :param pulumi.Input[builtins.str] resource_id: The Azure resource id in the form of /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/...
        """
...
if not MYPY:
    class CloudHsmClusterSkuArgsDict(TypedDict):
        ...
        """
        family: pulumi.Input[Union[builtins.str, 'CloudHsmClusterSkuFamily']]
        """
...
class CloudHsmClusterSkuArgs:
    def __init__(__self__, *,
        ...
        """
        Cloud Hsm Cluster SKU information
        :param pulumi.Input[Union[builtins.str, 'CloudHsmClusterSkuFamily']] family: Sku family of the Cloud HSM Cluster
        :param pulumi.Input['CloudHsmClusterSkuName'] name: Sku name of the Cloud HSM Cluster
        :param pulumi.Input[builtins.int] capacity: Sku capacity
        """
    ...
    @property
    @pulumi.getter
    def family(self) -> pulumi.Input[Union[builtins.str, 'CloudHsmClusterSkuFamily']]:
        """
        Sku family of the Cloud HSM Cluster
        """
    ...
    @family.setter
    def family(self, value: pulumi.Input[Union[builtins.str, 'CloudHsmClusterSkuFamily']]):
...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        """
        The network interface definition.
        :param pulumi.Input[builtins.str] private_ip_address: Private Ip address of the interface
        """
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        """
        SKU of the dedicated HSM
        :param pulumi.Input[Union[builtins.str, 'SkuName']] name: SKU of the dedicated HSM
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
