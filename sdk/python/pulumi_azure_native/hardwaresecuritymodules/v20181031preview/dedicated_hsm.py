...
warnings.warn("""Version 2018-10-31-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DedicatedHsm is deprecated: Version 2018-10-31-preview will be removed in v2 of the provider.""")
