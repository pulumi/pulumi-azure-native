...
def get_dedicated_hsm_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hardwaresecuritymodules/v20181031preview:getDedicatedHsm', __args__, opts=opts, typ=GetDedicatedHsmResult)
