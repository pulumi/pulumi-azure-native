...
class CloudHsmClusterArgs:
    ...
    def _configure(
        ...
        if 'cloudHsmClusterName' in kwargs:
...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if security_domain is not None and not isinstance(security_domain, CloudHsmClusterSecurityDomainPropertiesArgs):
            ...
            if sku is not None and not isinstance(sku, CloudHsmClusterSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
