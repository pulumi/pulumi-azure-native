...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmCluster"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmCluster"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmCluster"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20220831preview:hardwaresecuritymodules:CloudHsmCluster"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20231210preview:hardwaresecuritymodules:CloudHsmCluster"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20240630preview:hardwaresecuritymodules:CloudHsmCluster")])
