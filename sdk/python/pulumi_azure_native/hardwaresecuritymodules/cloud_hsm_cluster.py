...
class CloudHsmClusterArgs:
    ...
    def _configure(
        ...
        if cloud_hsm_cluster_name is None and 'cloudHsmClusterName' in kwargs:
            cloud_hsm_cluster_name = kwargs['cloudHsmClusterName']
        ...
        if security_domain is None and 'securityDomain' in kwargs:
            security_domain = kwargs['securityDomain']
    ...
    @property
    @pulumi.getter
    def hsms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudHsmPropertiesArgs']]]]:
        """
    ...
    @hsms.setter
    def hsms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudHsmPropertiesArgs']]]]):
        pulumi.set(self, "hsms", value)
    ...
    def security_domain(self) -> Optional[pulumi.Input['CloudHsmClusterSecurityDomainPropertiesArgs']]:
        """
    ...
    def security_domain(self, value: Optional[pulumi.Input['CloudHsmClusterSecurityDomainPropertiesArgs']]):
        pulumi.set(self, "security_domain", value)
...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            security_domain = _utilities.configure(security_domain, CloudHsmClusterSecurityDomainPropertiesArgs, True)
            __props__.__dict__["security_domain"] = security_domain
            sku = _utilities.configure(sku, CloudHsmClusterSkuArgs, True)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["security_domain"] = None
    ...
    @property
    @pulumi.getter
    def hsms(self) -> pulumi.Output[Optional[Sequence['outputs.CloudHsmPropertiesResponse']]]:
        """
        An array of Cloud HSM Cluster's HSMs
        """
        return pulumi.get(self, "hsms")
    ...
    @property
    @pulumi.getter(name="securityDomain")
    def security_domain(self) -> pulumi.Output[Optional['outputs.CloudHsmClusterSecurityDomainPropertiesResponse']]:
        """
        Security domain properties information for Cloud HSM cluster
        """
        return pulumi.get(self, "security_domain")
