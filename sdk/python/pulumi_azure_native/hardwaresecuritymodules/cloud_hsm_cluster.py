...
class CloudHsmClusterArgs:
    def __init__(__self__, *,
                 ...
                 cloud_hsm_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'AutoGeneratedDomainNameLabelScope']] auto_generated_domain_name_label_scope: The Cloud HSM Cluster's auto-generated Domain Name Label Scope
        :param pulumi.Input[builtins.str] cloud_hsm_cluster_name: The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must be between 3 and 23 characters in length.
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: Managed service identity (system assigned and/or user assigned identities)
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: The Cloud HSM Cluster public network access
    ...
    def cloud_hsm_cluster_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cloud_hsm_cluster_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def activation_state(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="autoGeneratedDomainNameLabelScope")
    def auto_generated_domain_name_label_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Cloud HSM Cluster's auto-generated Domain Name Label Scope
        """
        return pulumi.get(self, "auto_generated_domain_name_label_scope")
