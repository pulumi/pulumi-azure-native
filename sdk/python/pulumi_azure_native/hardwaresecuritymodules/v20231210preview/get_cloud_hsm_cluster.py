...
class GetCloudHsmClusterResult:
    ...
    """
    def __init__(__self__, auto_generated_domain_name_label_scope=None, backup_properties=None, hsms=None, id=None, identity=None, location=None, name=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, restore_properties=None, security_domain=None, sku=None, status_message=None, system_data=None, tags=None, type=None):
        ...
        if restore_properties and not isinstance(restore_properties, dict):
            raise TypeError("Expected argument 'restore_properties' to be a dict")
    ...
    def backup_properties(self) -> Optional['outputs.BackupPropertiesResponse']:
        """
    ...
    def restore_properties(self) -> Optional['outputs.RestorePropertiesResponse']:
        """
...
class AwaitableGetCloudHsmClusterResult(GetCloudHsmClusterResult):
    ...
    def __await__(self):
        ...
        return GetCloudHsmClusterResult(
            ...
            restore_properties=self.restore_properties,
...
def get_cloud_hsm_cluster(cloud_hsm_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hardwaresecuritymodules/v20231210preview:getCloudHsmCluster', __args__, opts=opts, typ=GetCloudHsmClusterResult).value
    ...
    return AwaitableGetCloudHsmClusterResult(
        ...
        restore_properties=pulumi.get(__ret__, 'restore_properties'),
