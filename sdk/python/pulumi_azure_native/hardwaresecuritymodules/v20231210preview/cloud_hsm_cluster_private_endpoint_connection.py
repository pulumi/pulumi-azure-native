...
class CloudHsmClusterPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmClusterPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmClusterPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudHsmClusterPrivateEndpointConnection, __self__).__init__(
            'azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmClusterPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
