...
__all__ = [
    ...
    'RestorePropertiesArgsDict',
]

MYPY = False

if not MYPY:
    class BackupPropertiesArgsDict(TypedDict):
        """
        Cloud Hsm Cluster backup information
        """
        azure_storage_resource_uri: NotRequired[pulumi.Input[str]]
        """
        Azure storage Resource Uri
        """
elif False:
    BackupPropertiesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class BackupPropertiesArgs:
    def __init__(__self__, *,
                 azure_storage_resource_uri: Optional[pulumi.Input[str]] = None):
        """
        Cloud Hsm Cluster backup information
        :param pulumi.Input[str] azure_storage_resource_uri: Azure storage Resource Uri
        """
    ...
    def azure_storage_resource_uri(self) -> Optional[pulumi.Input[str]]:
        """
        Azure storage Resource Uri
        """
        return pulumi.get(self, "azure_storage_resource_uri")

    @azure_storage_resource_uri.setter
    def azure_storage_resource_uri(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "azure_storage_resource_uri", value)
...
if not MYPY:
    class RestorePropertiesArgsDict(TypedDict):
        """
        ...
        """
        foldername: NotRequired[pulumi.Input[str]]
        """
        Directory name in Azure Storage Blob where the backup is stored
        """
elif False:
    RestorePropertiesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class RestorePropertiesArgs:
    def __init__(__self__, *,
                 azure_storage_resource_uri: Optional[pulumi.Input[str]] = None,
                 foldername: Optional[pulumi.Input[str]] = None):
        """
        Cloud Hsm Cluster restore information
        :param pulumi.Input[str] azure_storage_resource_uri: Azure Blob storage container Uri
        :param pulumi.Input[str] foldername: Directory name in Azure Storage Blob where the backup is stored
        """
        if azure_storage_resource_uri is not None:
            pulumi.set(__self__, "azure_storage_resource_uri", azure_storage_resource_uri)
    ...
    @property
    @pulumi.getter
    def foldername(self) -> Optional[pulumi.Input[str]]:
        """
        Directory name in Azure Storage Blob where the backup is stored
        """
    ...
    @foldername.setter
    def foldername(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "foldername", value)
