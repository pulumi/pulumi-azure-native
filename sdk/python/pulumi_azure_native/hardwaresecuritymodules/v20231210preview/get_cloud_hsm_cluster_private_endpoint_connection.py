...
def get_cloud_hsm_cluster_private_endpoint_connection(cloud_hsm_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hardwaresecuritymodules/v20231210preview:getCloudHsmClusterPrivateEndpointConnection', __args__, opts=opts, typ=GetCloudHsmClusterPrivateEndpointConnectionResult).value
