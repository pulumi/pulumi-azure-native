...
class CloudHsmClusterArgs:
    def __init__(__self__, *,
                 ...
                 backup_properties: Optional[pulumi.Input['BackupPropertiesArgs']] = None,
                 ...
                 restore_properties: Optional[pulumi.Input['RestorePropertiesArgs']] = None,
        ...
        :param pulumi.Input['BackupPropertiesArgs'] backup_properties: Cloud Hsm Cluster backup information
        ...
        :param pulumi.Input['RestorePropertiesArgs'] restore_properties: Cloud Hsm Cluster restore information
        ...
        if restore_properties is not None:
            pulumi.set(__self__, "restore_properties", restore_properties)
    ...
    def backup_properties(self) -> Optional[pulumi.Input['BackupPropertiesArgs']]:
        """
    ...
    def backup_properties(self, value: Optional[pulumi.Input['BackupPropertiesArgs']]):
    ...
    @property
    @pulumi.getter(name="restoreProperties")
    def restore_properties(self) -> Optional[pulumi.Input['RestorePropertiesArgs']]:
        """
        Cloud Hsm Cluster restore information
        """
        return pulumi.get(self, "restore_properties")

    @restore_properties.setter
    def restore_properties(self, value: Optional[pulumi.Input['RestorePropertiesArgs']]):
        pulumi.set(self, "restore_properties", value)
...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["restore_properties"] = restore_properties
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules:CloudHsmCluster"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmCluster")])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["backup_properties"] = None
        ...
        __props__.__dict__["restore_properties"] = None
    ...
    @property
    @pulumi.getter(name="backupProperties")
    def backup_properties(self) -> pulumi.Output[Optional['outputs.BackupPropertiesResponse']]:
        """
        Cloud Hsm Cluster backup information
        """
        return pulumi.get(self, "backup_properties")
    ...
    @property
    @pulumi.getter(name="restoreProperties")
    def restore_properties(self) -> pulumi.Output[Optional['outputs.RestorePropertiesResponse']]:
        """
        Cloud Hsm Cluster restore information
        """
        return pulumi.get(self, "restore_properties")
