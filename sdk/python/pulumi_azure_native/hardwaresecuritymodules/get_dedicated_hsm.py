...
def get_dedicated_hsm(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the dedicated Hsm
...
def get_dedicated_hsm_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
