...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20181031preview:hardwaresecuritymodules:DedicatedHsm"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20211130:hardwaresecuritymodules:DedicatedHsm"), pulumi.Alias(type_="azure-native_hardwaresecuritymodules_v20240630preview:hardwaresecuritymodules:DedicatedHsm")])
