...
class DedicatedHsmArgs:
    def __init__(__self__, *,
                 ...
                 stamp_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Name of the dedicated Hsm
        :param pulumi.Input['NetworkProfileArgs'] network_profile: Specifies the network interfaces of the dedicated hsm.
        :param pulumi.Input[builtins.str] stamp_id: This field will be used when RP does not support Availability zones.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: The Dedicated Hsm zones.
        """
    ...
    def stamp_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @stamp_id.setter
    def stamp_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20181031preview:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20250331:DedicatedHsm")])
    ...
    @property
    @pulumi.getter(name="stampId")
    def stamp_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This field will be used when RP does not support Availability zones.
        """
        return pulumi.get(self, "stamp_id")
