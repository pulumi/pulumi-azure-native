...
class DedicatedHsmArgs:
    ...
    def management_network_profile(self) -> pulumi.Input[Optional['NetworkProfileArgs']]:
        """
...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 management_network_profile: pulumi.Input[Optional[Union['NetworkProfileArgs', 'NetworkProfileArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20181031preview:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20211130:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20250331:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20251201preview:DedicatedHsm")])
