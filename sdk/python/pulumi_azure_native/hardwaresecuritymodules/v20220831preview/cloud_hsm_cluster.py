...
class CloudHsmCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hardwaresecuritymodules:CloudHsmCluster"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmCluster"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20240630preview:CloudHsmCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudHsmCluster, __self__).__init__(
            'azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmCluster',
            resource_name,
            __props__,
            opts)
