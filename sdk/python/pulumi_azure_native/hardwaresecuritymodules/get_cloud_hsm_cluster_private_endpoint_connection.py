...
def get_cloud_hsm_cluster_private_endpoint_connection(cloud_hsm_cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pe_connection_name: Name of the private endpoint connection associated with the Cloud HSM Cluster.
...
def get_cloud_hsm_cluster_private_endpoint_connection_output(cloud_hsm_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
