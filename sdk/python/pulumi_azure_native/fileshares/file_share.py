...
class FileShareArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['FileSharePropertiesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['FileSharePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['FileSharePropertiesArgs']]):
...
class FileShare(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['FileSharePropertiesArgs', 'FileSharePropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:fileshares/v20250601preview:FileShare"), pulumi.Alias(type_="azure-native:fileshares/v20250901preview:FileShare"), pulumi.Alias(type_="azure-native:fileshares/v20260601:FileShare")])
