...
class LedgerPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "enclavePlatform":
            suggest = "enclave_platform"
        elif key == "hostLevel":
            suggest = "host_level"
        elif key == "ledgerSku":
            suggest = "ledger_sku"
    ...
    def __init__(__self__, *,
                 ...
                 enclave_platform: Optional[str] = None,
        ...
        :param str application_type: Application type of the Confidential Ledger.
        ...
        :param str enclave_platform: Enclave platform of the Confidential Ledger.
    ...
    def enclave_platform(self) -> Optional[str]:
        """
...
class ManagedCCFPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str enclave_platform: Enclave platform of Managed CCF.
