...
if not MYPY:
    class LedgerPropertiesArgsDict(TypedDict):
        ...
        """
        enclave_platform: NotRequired[pulumi.Input[Union[str, 'EnclavePlatform']]]
        """
...
class LedgerPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 enclave_platform: Optional[pulumi.Input[Union[str, 'EnclavePlatform']]] = None,
        ...
        :param pulumi.Input[Union[str, 'ApplicationType']] application_type: Application type of the Confidential Ledger.
        ...
        :param pulumi.Input[Union[str, 'EnclavePlatform']] enclave_platform: Enclave platform of the Confidential Ledger.
        ...
        if enclave_platform is not None:
            pulumi.set(__self__, "enclave_platform", enclave_platform)
    ...
    @property
    @pulumi.getter(name="enclavePlatform")
    def enclave_platform(self) -> Optional[pulumi.Input[Union[str, 'EnclavePlatform']]]:
        """
        Enclave platform of the Confidential Ledger.
        """
        return pulumi.get(self, "enclave_platform")

    @enclave_platform.setter
    def enclave_platform(self, value: Optional[pulumi.Input[Union[str, 'EnclavePlatform']]]):
        pulumi.set(self, "enclave_platform", value)
...
class ManagedCCFPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'EnclavePlatform']] enclave_platform: Enclave platform of Managed CCF.
