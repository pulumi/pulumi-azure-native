...
class Ledger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:confidentialledger/v20201201preview:Ledger"), pulumi.Alias(type_="azure-native:confidentialledger:Ledger"), pulumi.Alias(type_="azure-nextgen:confidentialledger:Ledger"), pulumi.Alias(type_="azure-native:confidentialledger/v20210513preview:Ledger"), pulumi.Alias(type_="azure-nextgen:confidentialledger/v20210513preview:Ledger")])
