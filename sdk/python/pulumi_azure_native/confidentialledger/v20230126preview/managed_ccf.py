...
class ManagedCCF(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:confidentialledger:ManagedCCF"), pulumi.Alias(type_="azure-native:confidentialledger/v20220908preview:ManagedCCF"), pulumi.Alias(type_="azure-native:confidentialledger/v20230628preview:ManagedCCF"), pulumi.Alias(type_="azure-native:confidentialledger/v20240709preview:ManagedCCF"), pulumi.Alias(type_="azure-native:confidentialledger/v20240919preview:ManagedCCF")])
