...
def get_ledger(ledger_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confidentialledger/v20230126preview:getLedger', __args__, opts=opts, typ=GetLedgerResult).value
...
def get_ledger_output(ledger_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:confidentialledger/v20230126preview:getLedger', __args__, opts=opts, typ=GetLedgerResult)
