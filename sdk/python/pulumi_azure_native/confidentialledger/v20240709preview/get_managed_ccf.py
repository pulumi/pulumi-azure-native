...
def get_managed_ccf(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:confidentialledger/v20240709preview:getManagedCCF', __args__, opts=opts, typ=GetManagedCCFResult).value
...
def get_managed_ccf_output(app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:confidentialledger/v20240709preview:getManagedCCF', __args__, opts=opts, typ=GetManagedCCFResult)
