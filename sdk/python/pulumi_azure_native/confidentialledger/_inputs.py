...
if not MYPY:
    class AADBasedSecurityPrincipalArgsDict(TypedDict):
        ...
        """
        ledger_role_name: NotRequired[pulumi.Input[Union[builtins.str, 'LedgerRoleName']]]
        """
...
class AADBasedSecurityPrincipalArgs:
    def __init__(__self__, *,
                 ledger_role_name: Optional[pulumi.Input[Union[builtins.str, 'LedgerRoleName']]] = None,
                 principal_id: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        AAD based security principal with associated Ledger RoleName
        :param pulumi.Input[Union[builtins.str, 'LedgerRoleName']] ledger_role_name: LedgerRole associated with the Security Principal of Ledger
        :param pulumi.Input[builtins.str] principal_id: UUID/GUID based Principal Id of the Security Principal
        :param pulumi.Input[builtins.str] tenant_id: UUID/GUID based Tenant Id of the Security Principal
        """
    ...
    def ledger_role_name(self) -> Optional[pulumi.Input[Union[builtins.str, 'LedgerRoleName']]]:
        """
        LedgerRole associated with the Security Principal of Ledger
        """
    ...
    def ledger_role_name(self, value: Optional[pulumi.Input[Union[builtins.str, 'LedgerRoleName']]]):
...
class CertBasedSecurityPrincipalArgs:
    def __init__(__self__, *,
        ...
        """
        Cert based security principal with Ledger RoleName
        :param pulumi.Input[builtins.str] cert: Public key of the user cert (.pem or .cer)
        :param pulumi.Input[Union[builtins.str, 'LedgerRoleName']] ledger_role_name: LedgerRole associated with the Security Principal of Ledger
        """
        if cert is not None:
...
class CertificateTagsArgs:
    def __init__(__self__, *,
        ...
        """
        Tags for Managed CCF Certificates
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Additional tags for Managed CCF Certificates
        """
        if tags is not None:
...
if not MYPY:
    class DeploymentTypeArgsDict(TypedDict):
        ...
        """
        app_source_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        Source Uri containing ManagedCCF code
        """
        language_runtime: NotRequired[pulumi.Input[Union[builtins.str, 'LanguageRuntime']]]
        """
...
class DeploymentTypeArgs:
    def __init__(__self__, *,
                 app_source_uri: Optional[pulumi.Input[builtins.str]] = None,
                 language_runtime: Optional[pulumi.Input[Union[builtins.str, 'LanguageRuntime']]] = None):
        """
        Object representing DeploymentType for Managed CCF.
        :param pulumi.Input[builtins.str] app_source_uri: Source Uri containing ManagedCCF code
        :param pulumi.Input[Union[builtins.str, 'LanguageRuntime']] language_runtime: Unique name for the Managed CCF.
        """
    ...
    def app_source_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Source Uri containing ManagedCCF code
        """
    ...
    def app_source_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_source_uri", value)

    @property
    @pulumi.getter(name="languageRuntime")
    def language_runtime(self) -> Optional[pulumi.Input[Union[builtins.str, 'LanguageRuntime']]]:
        """
        Unique name for the Managed CCF.
        """
    ...
    def language_runtime(self, value: Optional[pulumi.Input[Union[builtins.str, 'LanguageRuntime']]]):
...
if not MYPY:
    class LedgerPropertiesArgsDict(TypedDict):
        ...
        """
        ledger_sku: NotRequired[pulumi.Input[Union[builtins.str, 'LedgerSku']]]
        """
        SKU associated with the ledger
        """
        ledger_type: NotRequired[pulumi.Input[Union[builtins.str, 'LedgerType']]]
        """
        Type of Confidential Ledger
        """
        running_state: NotRequired[pulumi.Input[Union[builtins.str, 'RunningState']]]
        """
...
class LedgerPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 ledger_sku: Optional[pulumi.Input[Union[builtins.str, 'LedgerSku']]] = None,
                 ledger_type: Optional[pulumi.Input[Union[builtins.str, 'LedgerType']]] = None,
                 running_state: Optional[pulumi.Input[Union[builtins.str, 'RunningState']]] = None):
        """
        Additional Confidential Ledger properties.
        ...
        :param pulumi.Input[Union[builtins.str, 'LedgerSku']] ledger_sku: SKU associated with the ledger
        :param pulumi.Input[Union[builtins.str, 'LedgerType']] ledger_type: Type of Confidential Ledger
        :param pulumi.Input[Union[builtins.str, 'RunningState']] running_state: Object representing RunningState for Ledger.
        """
    ...
    def ledger_sku(self) -> Optional[pulumi.Input[Union[builtins.str, 'LedgerSku']]]:
        """
        SKU associated with the ledger
        """
    ...
    @ledger_sku.setter
    def ledger_sku(self, value: Optional[pulumi.Input[Union[builtins.str, 'LedgerSku']]]):
        pulumi.set(self, "ledger_sku", value)

    @property
    @pulumi.getter(name="ledgerType")
    def ledger_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'LedgerType']]]:
        """
        Type of Confidential Ledger
        """
    ...
    @ledger_type.setter
    def ledger_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'LedgerType']]]):
        pulumi.set(self, "ledger_type", value)

    @property
    @pulumi.getter(name="runningState")
    def running_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'RunningState']]]:
        """
        Object representing RunningState for Ledger.
        """
    ...
    def running_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'RunningState']]]):
...
class ManagedCCFPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] node_count: Number of CCF nodes in the Managed CCF.
        :param pulumi.Input[Union[builtins.str, 'RunningState']] running_state: Object representing RunningState for Managed CCF.
        """
...
if not MYPY:
    class MemberIdentityCertificateArgsDict(TypedDict):
        ...
        """
        encryptionkey: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MemberIdentityCertificateArgs:
    def __init__(__self__, *,
                 ...
                 encryptionkey: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['CertificateTagsArgs']]]] = None):
        """
        Object representing MemberIdentityCertificate for Managed CCF.
        :param pulumi.Input[builtins.str] certificate: Member Identity Certificate
        :param pulumi.Input[builtins.str] encryptionkey: Member Identity Certificate Encryption Key
        """
    ...
    @property
    @pulumi.getter
    def encryptionkey(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Member Identity Certificate Encryption Key
        """
    ...
    def encryptionkey(self, value: Optional[pulumi.Input[builtins.str]]):
