...
def get_ledger(ledger_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ledger_name: Name of the Confidential Ledger
...
def get_ledger_output(ledger_name: Optional[pulumi.Input[builtins.str]] = None,
