...
warnings.warn("""azure-native:confidentialledger/v20210513preview:Ledger is being removed in the next major version of this provider. Upgrade to at least azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ledger(ledger_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ledger is deprecated: azure-native:confidentialledger/v20210513preview:Ledger is being removed in the next major version of this provider. Upgrade to at least azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['ledgerName'] = ledger_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:confidentialledger/v20210513preview:getLedger', __args__, opts=opts, typ=GetLedgerResult).value
