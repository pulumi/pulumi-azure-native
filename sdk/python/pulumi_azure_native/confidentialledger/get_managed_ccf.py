...
def get_managed_ccf(app_name: Optional[builtins.str] = None,
    ...
    :param builtins.str app_name: Name of the Managed CCF
...
def get_managed_ccf_output(app_name: Optional[pulumi.Input[builtins.str]] = None,
