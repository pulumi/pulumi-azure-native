...
def get_managed_ccf(app_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str app_name: Name of the Managed CCF
...
def get_managed_ccf_output(app_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                           resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedCCFResult]:
    """
    Retrieves the properties of a Managed CCF app.
