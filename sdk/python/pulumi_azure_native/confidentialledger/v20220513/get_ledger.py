...
def get_ledger(ledger_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ledger is deprecated: azure-native:confidentialledger/v20220513:Ledger is being removed in the next major version of this provider. Please upgrade to azure-native:confidentialledger/v20230126preview:Ledger to guarantee forwards compatibility.""")
    __args__ = dict()
