...
class AkriConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20250701preview:AkriConnector"), pulumi.Alias(type_="azure-native:iotoperations/v20251001:AkriConnector"), pulumi.Alias(type_="azure-native:iotoperations/v20260301:AkriConnector")])
