...
def get_dataflow(dataflow_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dataflow_name: Name of Instance dataflowProfile dataflow resource
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations:getDataflow', __args__, opts=opts, typ=GetDataflowResult).value
...
def get_dataflow_output(dataflow_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations:getDataflow', __args__, opts=opts, typ=GetDataflowResult)
