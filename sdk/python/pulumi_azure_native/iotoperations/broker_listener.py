...
class BrokerListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerListener"), pulumi.Alias(type_="azure-native_iotoperations_v20240701preview:iotoperations:BrokerListener"), pulumi.Alias(type_="azure-native_iotoperations_v20240815preview:iotoperations:BrokerListener"), pulumi.Alias(type_="azure-native_iotoperations_v20240915preview:iotoperations:BrokerListener"), pulumi.Alias(type_="azure-native_iotoperations_v20241101:iotoperations:BrokerListener"), pulumi.Alias(type_="azure-native_iotoperations_v20250401:iotoperations:BrokerListener")])
