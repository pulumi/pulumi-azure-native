...
class BrokerListenerArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['BrokerListenerPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['BrokerListenerPropertiesArgs']]):
...
class BrokerListener(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 listener_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['BrokerListenerPropertiesArgs', 'BrokerListenerPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20250701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20251001:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20260301:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20260701:BrokerListener")])
