...
class BrokerListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerListener")])
