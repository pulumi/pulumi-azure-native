...
def get_broker(broker_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str broker_name: Name of broker.
...
def get_broker_output(broker_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
