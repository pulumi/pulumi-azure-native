...
class BrokerAuthorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations:BrokerAuthorization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerAuthorization, __self__).__init__(
            'azure-native:iotoperations/v20241101:BrokerAuthorization',
            resource_name,
            __props__,
            opts)
