...
class DataflowEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations:DataflowEndpoint")])
