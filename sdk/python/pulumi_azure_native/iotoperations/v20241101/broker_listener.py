...
class BrokerListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] listener_name: Name of Instance broker listener resource
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['BrokerListenerPropertiesArgs']]):
...
class BrokerListener(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 listener_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['BrokerListenerPropertiesArgs', 'BrokerListenerPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] instance_name: Name of instance.
        :param pulumi.Input[str] listener_name: Name of Instance broker listener resource
        :param pulumi.Input[Union['BrokerListenerPropertiesArgs', 'BrokerListenerPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations:BrokerListener")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerListener, __self__).__init__(
            'azure-native:iotoperations/v20241101:BrokerListener',
            resource_name,
            __props__,
            opts)
