...
def get_dataflow(dataflow_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20241101:getDataflow', __args__, opts=opts, typ=GetDataflowResult).value
...
def get_dataflow_output(dataflow_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20241101:getDataflow', __args__, opts=opts, typ=GetDataflowResult)
