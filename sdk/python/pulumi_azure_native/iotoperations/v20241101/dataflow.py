...
class Dataflow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:DataFlow"), pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations:DataFlow"), pulumi.Alias(type_="azure-native:iotoperations:Dataflow")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dataflow, __self__).__init__(
            'azure-native:iotoperations/v20241101:Dataflow',
            resource_name,
            __props__,
            opts)
