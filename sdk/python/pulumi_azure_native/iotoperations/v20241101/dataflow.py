...
class Dataflow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:Dataflow"), pulumi.Alias(type_="azure-native:iotoperations:Dataflow")])
