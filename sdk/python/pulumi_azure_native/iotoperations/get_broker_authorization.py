...
def get_broker_authorization(authorization_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str authorization_name: Name of Instance broker authorization resource
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations:getBrokerAuthorization', __args__, opts=opts, typ=GetBrokerAuthorizationResult).value
...
def get_broker_authorization_output(authorization_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations:getBrokerAuthorization', __args__, opts=opts, typ=GetBrokerAuthorizationResult)
