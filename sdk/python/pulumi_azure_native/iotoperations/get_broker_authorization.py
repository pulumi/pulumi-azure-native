...
def get_broker_authorization(authorization_name: Optional[builtins.str] = None,
    ...
    :param builtins.str authorization_name: Name of Instance broker authorization resource
...
def get_broker_authorization_output(authorization_name: Optional[pulumi.Input[builtins.str]] = None,
