...
def get_broker(broker_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getBroker', __args__, opts=opts, typ=GetBrokerResult).value
...
def get_broker_output(broker_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getBroker', __args__, opts=opts, typ=GetBrokerResult)
