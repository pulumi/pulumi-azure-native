...
def get_dataflow_profile(dataflow_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getDataflowProfile', __args__, opts=opts, typ=GetDataflowProfileResult).value
...
def get_dataflow_profile_output(dataflow_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getDataflowProfile', __args__, opts=opts, typ=GetDataflowProfileResult)
