...
def get_dataflow_endpoint(dataflow_endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getDataflowEndpoint', __args__, opts=opts, typ=GetDataflowEndpointResult).value
...
def get_dataflow_endpoint_output(dataflow_endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getDataflowEndpoint', __args__, opts=opts, typ=GetDataflowEndpointResult)
