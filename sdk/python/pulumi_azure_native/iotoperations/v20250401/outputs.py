...
@pulumi.output_type
class InstanceFeatureResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        The features of the AIO Instance.
        :param str mode: The state of the feature.
        :param Mapping[str, str] settings: The settings of the feature.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
...
class InstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 version: str,
                 description: Optional[str] = None,
                 features: Optional[Mapping[str, 'outputs.InstanceFeatureResponse']] = None):
        """
        The properties of the Instance resource.
        :param str provisioning_state: The status of the last operation.
        ...
        :param Mapping[str, 'InstanceFeatureResponse'] features: The features of the AIO Instance.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
    ...
    @property
    @pulumi.getter
    def features(self) -> Optional[Mapping[str, 'outputs.InstanceFeatureResponse']]:
        """
        The features of the AIO Instance.
        """
