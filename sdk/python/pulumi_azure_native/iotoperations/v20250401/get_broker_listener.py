...
def get_broker_listener(broker_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getBrokerListener', __args__, opts=opts, typ=GetBrokerListenerResult).value
...
def get_broker_listener_output(broker_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getBrokerListener', __args__, opts=opts, typ=GetBrokerListenerResult)
