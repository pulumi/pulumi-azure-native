...
def get_broker_authentication(authentication_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getBrokerAuthentication', __args__, opts=opts, typ=GetBrokerAuthenticationResult).value
...
def get_broker_authentication_output(authentication_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getBrokerAuthentication', __args__, opts=opts, typ=GetBrokerAuthenticationResult)
