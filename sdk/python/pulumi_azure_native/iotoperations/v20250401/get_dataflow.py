...
def get_dataflow(dataflow_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getDataflow', __args__, opts=opts, typ=GetDataflowResult).value
...
def get_dataflow_output(dataflow_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getDataflow', __args__, opts=opts, typ=GetDataflowResult)
