...
def get_broker_authorization(authorization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20250401:getBrokerAuthorization', __args__, opts=opts, typ=GetBrokerAuthorizationResult).value
...
def get_broker_authorization_output(authorization_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20250401:getBrokerAuthorization', __args__, opts=opts, typ=GetBrokerAuthorizationResult)
