...
def get_broker_listener(broker_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20240701preview:getBrokerListener', __args__, opts=opts, typ=GetBrokerListenerResult).value
...
def get_broker_listener_output(broker_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20240701preview:getBrokerListener', __args__, opts=opts, typ=GetBrokerListenerResult)
