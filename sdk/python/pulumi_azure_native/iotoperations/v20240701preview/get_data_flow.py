...
def get_data_flow(dataflow_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20240701preview:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult).value
...
def get_data_flow_output(dataflow_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20240701preview:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult)
