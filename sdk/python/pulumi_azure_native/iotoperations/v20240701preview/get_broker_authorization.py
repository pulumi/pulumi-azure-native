...
def get_broker_authorization(authorization_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20240701preview:getBrokerAuthorization', __args__, opts=opts, typ=GetBrokerAuthorizationResult).value
