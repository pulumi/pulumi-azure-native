...
class DataFlowEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations:DataFlowEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataFlowEndpoint, __self__).__init__(
            'azure-native:iotoperations/v20240701preview:DataFlowEndpoint',
            resource_name,
            __props__,
            opts)
