...
class DataFlowEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:DataFlowEndpoint")])
