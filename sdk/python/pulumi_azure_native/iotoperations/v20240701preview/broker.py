...
class Broker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:Broker"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:Broker"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:Broker"), pulumi.Alias(type_="azure-native:iotoperations:Broker")])
