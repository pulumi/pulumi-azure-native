...
class BrokerAuthentication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations:BrokerAuthentication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerAuthentication, __self__).__init__(
            'azure-native:iotoperations/v20240701preview:BrokerAuthentication',
            resource_name,
            __props__,
            opts)
