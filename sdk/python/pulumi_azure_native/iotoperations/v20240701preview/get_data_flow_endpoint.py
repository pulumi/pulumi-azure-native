...
__all__ = [
    ...
    'get_data_flow_endpoint',
    'get_data_flow_endpoint_output',
]
...
def get_data_flow_endpoint(dataflow_endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20240701preview:getDataFlowEndpoint', __args__, opts=opts, typ=GetDataFlowEndpointResult).value
...
def get_data_flow_endpoint_output(dataflow_endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20240701preview:getDataFlowEndpoint', __args__, opts=opts, typ=GetDataFlowEndpointResult)
