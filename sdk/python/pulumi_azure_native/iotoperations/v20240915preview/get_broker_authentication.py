...
def get_broker_authentication(authentication_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations/v20240915preview:getBrokerAuthentication', __args__, opts=opts, typ=GetBrokerAuthenticationResult).value
...
def get_broker_authentication_output(authentication_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations/v20240915preview:getBrokerAuthentication', __args__, opts=opts, typ=GetBrokerAuthenticationResult)
