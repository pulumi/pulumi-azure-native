...
class BrokerAuthorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:BrokerAuthorization"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerAuthorization")])
