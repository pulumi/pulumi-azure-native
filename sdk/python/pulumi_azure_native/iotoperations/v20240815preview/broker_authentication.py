...
class BrokerAuthentication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerAuthentication"), pulumi.Alias(type_="azure-native:iotoperations:BrokerAuthentication")])
