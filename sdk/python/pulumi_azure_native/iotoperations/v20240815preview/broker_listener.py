...
class BrokerListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:BrokerListener"), pulumi.Alias(type_="azure-native:iotoperations:BrokerListener")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerListener, __self__).__init__(
            'azure-native:iotoperations/v20240815preview:BrokerListener',
            resource_name,
            __props__,
            opts)
