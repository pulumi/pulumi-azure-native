...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:Instance"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:Instance"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:Instance"), pulumi.Alias(type_="azure-native:iotoperations/v20250401:Instance"), pulumi.Alias(type_="azure-native:iotoperations:Instance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Instance, __self__).__init__(
            'azure-native:iotoperations/v20240815preview:Instance',
            resource_name,
            __props__,
            opts)
