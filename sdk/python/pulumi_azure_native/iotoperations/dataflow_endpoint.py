...
class DataflowEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20240701preview:DataFlowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240815preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20240915preview:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations/v20241101:DataflowEndpoint"), pulumi.Alias(type_="azure-native:iotoperations:DataFlowEndpoint"), pulumi.Alias(type_="azure-native_iotoperations_v20240701preview:iotoperations:DataflowEndpoint"), pulumi.Alias(type_="azure-native_iotoperations_v20240815preview:iotoperations:DataflowEndpoint"), pulumi.Alias(type_="azure-native_iotoperations_v20240915preview:iotoperations:DataflowEndpoint"), pulumi.Alias(type_="azure-native_iotoperations_v20241101:iotoperations:DataflowEndpoint"), pulumi.Alias(type_="azure-native_iotoperations_v20250401:iotoperations:DataflowEndpoint")])
