...
class RegistryEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] registry_endpoint_name: Name of RegistryEndpoint resource
        """
    ...
    def registry_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def registry_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegistryEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20250701preview:RegistryEndpoint")])
