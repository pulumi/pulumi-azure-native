...
class AkriConnectorTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperations/v20250701preview:AkriConnectorTemplate"), pulumi.Alias(type_="azure-native:iotoperations/v20251001:AkriConnectorTemplate"), pulumi.Alias(type_="azure-native:iotoperations/v20260301:AkriConnectorTemplate")])
