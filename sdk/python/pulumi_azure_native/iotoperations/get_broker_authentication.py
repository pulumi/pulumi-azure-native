...
def get_broker_authentication(authentication_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str authentication_name: Name of Instance broker authentication resource
...
def get_broker_authentication_output(authentication_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
