...
def get_broker_authentication(authentication_name: Optional[builtins.str] = None,
    ...
    :param builtins.str authentication_name: Name of Instance broker authentication resource
...
def get_broker_authentication_output(authentication_name: Optional[pulumi.Input[builtins.str]] = None,
