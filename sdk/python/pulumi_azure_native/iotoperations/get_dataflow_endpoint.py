...
def get_dataflow_endpoint(dataflow_endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dataflow_endpoint_name: Name of Instance dataflowEndpoint resource
...
def get_dataflow_endpoint_output(dataflow_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
