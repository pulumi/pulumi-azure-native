...
def get_dataflow_endpoint(dataflow_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dataflow_endpoint_name: Name of Instance dataflowEndpoint resource
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperations:getDataflowEndpoint', __args__, opts=opts, typ=GetDataflowEndpointResult).value
...
def get_dataflow_endpoint_output(dataflow_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperations:getDataflowEndpoint', __args__, opts=opts, typ=GetDataflowEndpointResult)
