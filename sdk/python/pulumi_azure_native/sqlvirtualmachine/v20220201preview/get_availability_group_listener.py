...
def get_availability_group_listener(availability_group_listener_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_group_listener is deprecated: azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener to guarantee forwards compatibility.""")
    __args__ = dict()
