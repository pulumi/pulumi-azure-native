...
warnings.warn("""azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener to guarantee forwards compatibility.""", DeprecationWarning)
...
class AvailabilityGroupListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sql_virtual_machine_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AvailabilityGroupListener is deprecated: azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener to guarantee forwards compatibility.""")
