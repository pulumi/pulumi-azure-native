...
def get_sql_virtual_machine_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_virtual_machine_group is deprecated: azure-native:sqlvirtualmachine/v20220201preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup to guarantee forwards compatibility.""")
    __args__ = dict()
