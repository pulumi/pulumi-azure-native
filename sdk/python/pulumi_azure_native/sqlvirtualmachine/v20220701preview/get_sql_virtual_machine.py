...
warnings.warn("""azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_virtual_machine is deprecated: azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
