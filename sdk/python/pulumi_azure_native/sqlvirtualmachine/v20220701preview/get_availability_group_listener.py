...
def get_availability_group_listener(availability_group_listener_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_availability_group_listener is deprecated: azure-native:sqlvirtualmachine/v20220701preview:AvailabilityGroupListener is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sqlvirtualmachine/v20220701preview:getAvailabilityGroupListener', __args__, opts=opts, typ=GetAvailabilityGroupListenerResult).value
