...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 wsfc_static_ip: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlVirtualMachine is deprecated: azure-native:sqlvirtualmachine/v20220701preview:SqlVirtualMachine is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine to guarantee forwards compatibility.""")
