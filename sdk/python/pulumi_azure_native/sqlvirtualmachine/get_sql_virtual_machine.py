...
class GetSqlVirtualMachineResult:
    ...
    def additional_vm_patch(self) -> builtins.str:
        """
    ...
    def least_privilege_mode(self) -> Optional[builtins.str]:
        """
    ...
    def sql_management(self) -> Optional[builtins.str]:
        """
    ...
    def sql_virtual_machine_group_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def virtual_machine_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def wsfc_static_ip(self) -> Optional[builtins.str]:
        """
        Domain credentials for setting up Windows Server Failover Cluster for SQL availability group.
        """
...
def get_sql_virtual_machine(expand: Optional[builtins.str] = None,
                            resource_group_name: Optional[builtins.str] = None,
                            sql_virtual_machine_name: Optional[builtins.str] = None,
...
def get_sql_virtual_machine_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sqlvirtualmachine:getSqlVirtualMachine', __args__, opts=opts, typ=GetSqlVirtualMachineResult)
