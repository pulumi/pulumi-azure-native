...
def get_sql_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_virtual_machine is deprecated: azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachine is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
