...
class AdditionalFeaturesServerConfigurationsArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'isRServicesEnabled' in kwargs:
...
class AgReplicaArgs:
    ...
    def _configure(
        ...
        if 'sqlVirtualMachineInstanceId' in kwargs:
...
class AutoBackupSettingsArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'backupScheduleType' in kwargs:
            backup_schedule_type = kwargs['backupScheduleType']
        if 'backupSystemDbs' in kwargs:
        ...
        if 'fullBackupStartTime' in kwargs:
            full_backup_start_time = kwargs['fullBackupStartTime']
        if 'fullBackupWindowHours' in kwargs:
...
class AutoPatchingSettingsArgs:
    ...
    def _configure(
        ...
        if 'maintenanceWindowDuration' in kwargs:
...
class LoadBalancerConfigurationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'loadBalancerResourceId' in kwargs:
        ...
        if 'publicIpAddressResourceId' in kwargs:
            public_ip_address_resource_id = kwargs['publicIpAddressResourceId']
        if 'sqlVirtualMachineInstances' in kwargs:
...
class MultiSubnetIpConfigurationArgs:
    ...
    def _configure(
        ...
        if 'privateIpAddress' in kwargs:
            private_ip_address = kwargs['privateIpAddress']
        if 'sqlVirtualMachineInstance' in kwargs:
...
class SQLInstanceSettingsArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'isIfiEnabled' in kwargs:
            is_ifi_enabled = kwargs['isIfiEnabled']
        if 'isLpimEnabled' in kwargs:
            is_lpim_enabled = kwargs['isLpimEnabled']
        if 'isOptimizeForAdHocWorkloadsEnabled' in kwargs:
...
class SqlConnectivityUpdateSettingsArgs:
    ...
    def _configure(
        ...
        if 'sqlAuthUpdatePassword' in kwargs:
            sql_auth_update_password = kwargs['sqlAuthUpdatePassword']
        if 'sqlAuthUpdateUserName' in kwargs:
...
class WsfcDomainProfileArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'clusterBootstrapAccount' in kwargs:
            cluster_bootstrap_account = kwargs['clusterBootstrapAccount']
        if 'clusterOperatorAccount' in kwargs:
