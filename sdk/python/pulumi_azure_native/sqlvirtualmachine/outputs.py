...
class AgReplicaResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 readable_secondary: Optional[_builtins.str] = None,
        ...
        :param _builtins.str role: Replica Role in availability group.
        :param _builtins.str sql_virtual_machine_instance_id: Sql VirtualMachine Instance Id.
        """
...
class AutoBackupSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 backup_schedule_type: Optional[_builtins.str] = None,
                 backup_system_dbs: Optional[_builtins.bool] = None,
                 days_of_week: Optional[Sequence[_builtins.str]] = None,
                 enable: Optional[_builtins.bool] = None,
                 enable_encryption: Optional[_builtins.bool] = None,
                 full_backup_frequency: Optional[_builtins.str] = None,
                 full_backup_start_time: Optional[_builtins.int] = None,
                 full_backup_window_hours: Optional[_builtins.int] = None,
                 log_backup_frequency: Optional[_builtins.int] = None,
        ...
        :param _builtins.bool enable: Enable or disable autobackup on SQL virtual machine.
        :param _builtins.bool enable_encryption: Enable or disable encryption for backup on SQL virtual machine.
        :param _builtins.str full_backup_frequency: Frequency of full backups. In both cases, full backups begin during the next scheduled time window.
        :param _builtins.int full_backup_start_time: Start time of a given day during which full backups can take place. 0-23 hours.
        :param _builtins.int full_backup_window_hours: Duration of the time window of a given day during which full backups can take place. 1-23 hours.
        :param _builtins.int log_backup_frequency: Frequency of log backups. 5-60 minutes.
        :param _builtins.int retention_period: Retention period of backup: 1-90 days.
        :param _builtins.str storage_account_url: Storage account url where backup will be taken to.
        :param _builtins.str storage_container_name: Storage container name where backup will be taken to.
        """
...
class AutoPatchingSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 additional_vm_patch: Optional[_builtins.str] = None,
                 day_of_week: Optional[_builtins.str] = None,
                 enable: Optional[_builtins.bool] = None,
                 maintenance_window_duration: Optional[_builtins.int] = None,
        ...
        :param _builtins.int maintenance_window_duration: Duration of patching.
        :param _builtins.int maintenance_window_starting_hour: Hour of the day when patching is initiated. Local VM time.
        """
...
class KeyVaultCredentialSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_key_vault_url: Optional[_builtins.str] = None,
        ...
        :param _builtins.str service_principal_name: Service principal name to access key vault.
        """
...
class LoadBalancerConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 load_balancer_resource_id: Optional[_builtins.str] = None,
                 private_ip_address: Optional['outputs.PrivateIPAddressResponse'] = None,
                 probe_port: Optional[_builtins.int] = None,
                 public_ip_address_resource_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str public_ip_address_resource_id: Resource id of the public IP.
        :param Sequence[_builtins.str] sql_virtual_machine_instances: List of the SQL virtual machine instance resource id's that are enrolled into the availability group listener.
        """
...
class SQLInstanceSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_ifi_enabled: Optional[_builtins.bool] = None,
                 is_lpim_enabled: Optional[_builtins.bool] = None,
                 is_optimize_for_ad_hoc_workloads_enabled: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool is_optimize_for_ad_hoc_workloads_enabled: SQL Server Optimize for Adhoc workloads.
        :param _builtins.int max_dop: SQL Server MAXDOP.
        :param _builtins.int max_server_memory_mb: SQL Server maximum memory.
        :param _builtins.int min_server_memory_mb: SQL Server minimum memory.
        """
...
class SQLStorageSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 default_file_path: Optional[_builtins.str] = None,
                 luns: Optional[Sequence[_builtins.int]] = None,
...
class SQLTempDbSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_file_size: Optional[_builtins.int] = None,
                 data_growth: Optional[_builtins.int] = None,
                 default_file_path: Optional[_builtins.str] = None,
                 log_file_size: Optional[_builtins.int] = None,
                 log_growth: Optional[_builtins.int] = None,
                 luns: Optional[Sequence[_builtins.int]] = None,
                 persist_folder: Optional[_builtins.bool] = None,
                 persist_folder_path: Optional[_builtins.str] = None,
                 use_storage_pool: Optional[_builtins.bool] = None):
        """
        Set tempDb storage settings for SQL Server.
        ...
        :param _builtins.str default_file_path: SQL Server default file path
        :param _builtins.int log_file_size: SQL Server tempdb log file size
        :param _builtins.int log_growth: SQL Server tempdb log file autoGrowth size
        :param Sequence[_builtins.int] luns: Logical Unit Numbers for the disks.
        :param _builtins.bool persist_folder: SQL Server tempdb persist folder choice
        :param _builtins.str persist_folder_path: SQL Server tempdb persist folder location
        :param _builtins.bool use_storage_pool: Use storage pool to build a drive if true or not provided
        """
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_time: Time of the day in HH:mm format. Eg. 17:30
        :param _builtins.int weekly_interval: Number of weeks to schedule between 2 assessment runs. Takes value from 1-6
        """
        if day_of_week is not None:
            pulumi.set(__self__, "day_of_week", day_of_week)
        if enable is not None:
...
class SqlStorageUpdateSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 disk_configuration_type: Optional[_builtins.str] = None,
...
class StorageConfigurationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sql_system_db_on_data_disk: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool sql_system_db_on_data_disk: SQL Server SystemDb Storage on DataPool if true.
        :param 'SQLTempDbSettingsResponse' sql_temp_db_settings: SQL Server TempDb Storage Settings.
        :param _builtins.str storage_workload_type: Storage workload type.
        """
        if disk_configuration_type is not None:
            pulumi.set(__self__, "disk_configuration_type", disk_configuration_type)
...
class TroubleshootingStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str root_cause: Root cause of the issue
        :param _builtins.str start_time_utc: Start time in UTC timezone.
        :param _builtins.str troubleshooting_scenario: SQL VM troubleshooting scenario.
        """
...
class WsfcDomainCredentialsResponse(dict):
    ...
    def __init__(__self__, *,
                 cluster_bootstrap_account_password: Optional[_builtins.str] = None,
                 cluster_operator_account_password: Optional[_builtins.str] = None,
...
class WsfcDomainProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 cluster_bootstrap_account: Optional[_builtins.str] = None,
                 cluster_operator_account: Optional[_builtins.str] = None,
                 cluster_subnet_type: Optional[_builtins.str] = None,
                 domain_fqdn: Optional[_builtins.str] = None,
                 file_share_witness_path: Optional[_builtins.str] = None,
                 is_sql_service_account_gmsa: Optional[_builtins.bool] = None,
                 ou_path: Optional[_builtins.str] = None,
                 sql_service_account: Optional[_builtins.str] = None,
                 storage_account_url: Optional[_builtins.str] = None):
        """
        Active Directory account details to operate Windows Server Failover Cluster.
        ...
        :param _builtins.str domain_fqdn: Fully qualified name of the domain.
        :param _builtins.str file_share_witness_path: Optional path for fileshare witness.
        :param _builtins.bool is_sql_service_account_gmsa: The flag to check if SQL service account is GMSA.
        :param _builtins.str ou_path: Organizational Unit path in which the nodes and cluster will be present.
        :param _builtins.str sql_service_account: Account name under which SQL service will run on all participating SQL virtual machines in the cluster.
        :param _builtins.str storage_account_url: Fully qualified ARM resource id of the witness storage account.
        """
