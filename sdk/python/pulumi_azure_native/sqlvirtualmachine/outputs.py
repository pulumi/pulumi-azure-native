...
class AgConfigurationResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 replicas: Sequence['outputs.AgReplicaResponse']):
        """
        Availability group configuration.
    ...
    @property
    @pulumi.getter
    def replicas(self) -> Sequence['outputs.AgReplicaResponse']:
        """
...
class SQLInstanceSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "isOptimizeForAdHocWorkloadsEnabled":
...
class SQLTempDbSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 luns: Optional[Sequence[int]] = None):
        """
        :param int data_file_count: SQL Server default file count
        :param int data_file_size: SQL Server default file size
        :param int data_growth: SQL Server default file autoGrowth size
        :param str default_file_path: SQL Server default file path
        :param int log_file_size: SQL Server default file size
        :param int log_growth: SQL Server default file autoGrowth size
        :param Sequence[int] luns: Logical Unit Numbers for the disks.
        """
