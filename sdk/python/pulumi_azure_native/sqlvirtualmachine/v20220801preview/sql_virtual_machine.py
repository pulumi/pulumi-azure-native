...
warnings.warn("""azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachine to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 wsfc_static_ip: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlVirtualMachine is deprecated: azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachine to guarantee forwards compatibility.""")
