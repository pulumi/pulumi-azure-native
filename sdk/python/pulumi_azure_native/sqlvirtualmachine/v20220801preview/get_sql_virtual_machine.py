...
def get_sql_virtual_machine_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sqlvirtualmachine/v20220801preview:getSqlVirtualMachine', __args__, opts=opts, typ=GetSqlVirtualMachineResult)
