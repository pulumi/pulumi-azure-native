...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(assessment_settings, AssessmentSettingsArgs):
            ...
            if not isinstance(auto_backup_settings, AutoBackupSettingsArgs):
            ...
            if not isinstance(auto_patching_settings, AutoPatchingSettingsArgs):
            ...
            if not isinstance(key_vault_credential_settings, KeyVaultCredentialSettingsArgs):
            ...
            if not isinstance(server_configurations_management_settings, ServerConfigurationsManagementSettingsArgs):
            ...
            if not isinstance(storage_configuration_settings, StorageConfigurationSettingsArgs):
            ...
            if not isinstance(wsfc_domain_credentials, WsfcDomainCredentialsArgs):
