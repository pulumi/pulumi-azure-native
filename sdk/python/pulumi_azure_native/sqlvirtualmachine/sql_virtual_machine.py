...
class SqlVirtualMachineArgs:
    ...
    def _configure(
        ...
        if assessment_settings is None and 'assessmentSettings' in kwargs:
            assessment_settings = kwargs['assessmentSettings']
        if auto_backup_settings is None and 'autoBackupSettings' in kwargs:
            auto_backup_settings = kwargs['autoBackupSettings']
        if auto_patching_settings is None and 'autoPatchingSettings' in kwargs:
            auto_patching_settings = kwargs['autoPatchingSettings']
        if key_vault_credential_settings is None and 'keyVaultCredentialSettings' in kwargs:
            key_vault_credential_settings = kwargs['keyVaultCredentialSettings']
        if server_configurations_management_settings is None and 'serverConfigurationsManagementSettings' in kwargs:
            server_configurations_management_settings = kwargs['serverConfigurationsManagementSettings']
        ...
        if sql_management is None and 'sqlManagement' in kwargs:
            sql_management = kwargs['sqlManagement']
        if sql_server_license_type is None and 'sqlServerLicenseType' in kwargs:
            sql_server_license_type = kwargs['sqlServerLicenseType']
        if sql_virtual_machine_group_resource_id is None and 'sqlVirtualMachineGroupResourceId' in kwargs:
            sql_virtual_machine_group_resource_id = kwargs['sqlVirtualMachineGroupResourceId']
        if sql_virtual_machine_name is None and 'sqlVirtualMachineName' in kwargs:
            sql_virtual_machine_name = kwargs['sqlVirtualMachineName']
        if storage_configuration_settings is None and 'storageConfigurationSettings' in kwargs:
            storage_configuration_settings = kwargs['storageConfigurationSettings']
        if virtual_machine_resource_id is None and 'virtualMachineResourceId' in kwargs:
            virtual_machine_resource_id = kwargs['virtualMachineResourceId']
        if wsfc_domain_credentials is None and 'wsfcDomainCredentials' in kwargs:
            wsfc_domain_credentials = kwargs['wsfcDomainCredentials']
        if wsfc_static_ip is None and 'wsfcStaticIp' in kwargs:
            wsfc_static_ip = kwargs['wsfcStaticIp']
...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            assessment_settings = _utilities.configure(assessment_settings, AssessmentSettingsArgs, True)
            __props__.__dict__["assessment_settings"] = assessment_settings
            auto_backup_settings = _utilities.configure(auto_backup_settings, AutoBackupSettingsArgs, True)
            __props__.__dict__["auto_backup_settings"] = auto_backup_settings
            auto_patching_settings = _utilities.configure(auto_patching_settings, AutoPatchingSettingsArgs, True)
            ...
            key_vault_credential_settings = _utilities.configure(key_vault_credential_settings, KeyVaultCredentialSettingsArgs, True)
            __props__.__dict__["key_vault_credential_settings"] = key_vault_credential_settings
            __props__.__dict__["location"] = location
            if resource_group_name is None and not opts.urn:
                raise TypeError("Missing required property 'resource_group_name'")
            __props__.__dict__["resource_group_name"] = resource_group_name
            server_configurations_management_settings = _utilities.configure(server_configurations_management_settings, ServerConfigurationsManagementSettingsArgs, True)
            ...
            storage_configuration_settings = _utilities.configure(storage_configuration_settings, StorageConfigurationSettingsArgs, True)
            ...
            wsfc_domain_credentials = _utilities.configure(wsfc_domain_credentials, WsfcDomainCredentialsArgs, True)
