...
class GetAvailabilityGroupListenerResult:
    ...
    """
    def __init__(__self__, availability_group_configuration=None, availability_group_name=None, create_default_availability_group_if_not_exist=None, id=None, load_balancer_configurations=None, name=None, port=None, provisioning_state=None, system_data=None, type=None):
