...
class GetAvailabilityGroupListenerResult:
    ...
    def create_default_availability_group_if_not_exist(self) -> Optional[_builtins.bool]:
        """
...
def get_availability_group_listener(availability_group_listener_name: Optional[_builtins.str] = None,
                                    expand: Optional[_builtins.str] = None,
                                    resource_group_name: Optional[_builtins.str] = None,
                                    sql_virtual_machine_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sqlvirtualmachine:getAvailabilityGroupListener', __args__, opts=opts, typ=GetAvailabilityGroupListenerResult).value
...
def get_availability_group_listener_output(availability_group_listener_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
