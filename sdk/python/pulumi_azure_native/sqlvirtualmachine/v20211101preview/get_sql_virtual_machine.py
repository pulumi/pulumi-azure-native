...
def get_sql_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_virtual_machine is deprecated: azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachine is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachine to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['sqlVirtualMachineName'] = sql_virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sqlvirtualmachine/v20211101preview:getSqlVirtualMachine', __args__, opts=opts, typ=GetSqlVirtualMachineResult).value
