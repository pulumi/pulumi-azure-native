...
warnings.warn("""azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener to guarantee forwards compatibility.""", DeprecationWarning)
