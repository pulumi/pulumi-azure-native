...
class SQLTempDbSettingsArgs:
    def __init__(__self__, *,
                 ...
                 luns: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        :param pulumi.Input[int] data_file_count: SQL Server default file count
        :param pulumi.Input[int] data_file_size: SQL Server default file size
        :param pulumi.Input[int] data_growth: SQL Server default file autoGrowth size
        :param pulumi.Input[str] default_file_path: SQL Server default file path
        :param pulumi.Input[int] log_file_size: SQL Server default file size
        :param pulumi.Input[int] log_growth: SQL Server default file autoGrowth size
        :param pulumi.Input[Sequence[pulumi.Input[int]]] luns: Logical Unit Numbers for the disks.
        """
