...
warnings.warn("""azure-native:sqlvirtualmachine/v20211101preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sqlvirtualmachine/v20220801preview:SqlVirtualMachineGroup to guarantee forwards compatibility.""", DeprecationWarning)
