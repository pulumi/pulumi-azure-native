...
class AvailabilityGroupListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20211101preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20220201:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20220201preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20220701preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20220801preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine/v20230101preview:AvailabilityGroupListener"), pulumi.Alias(type_="azure-native:sqlvirtualmachine:AvailabilityGroupListener")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvailabilityGroupListener, __self__).__init__(
            'azure-native:sqlvirtualmachine/v20231001:AvailabilityGroupListener',
            resource_name,
            __props__,
            opts)
