...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 virtual_machine_identity_settings: Optional[pulumi.Input[pulumi.InputType['VirtualMachineIdentityArgs']]] = None,
                 virtual_machine_resource_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] enable_automatic_upgrade: Enable automatic upgrade of Sql IaaS extension Agent.
        :param pulumi.Input[pulumi.InputType['ResourceIdentityArgs']] identity: DO NOT USE. This value will be deprecated. Azure Active Directory identity of the server.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[pulumi.InputType['VirtualMachineIdentityArgs']] virtual_machine_identity_settings: Virtual Machine Identity details used for Sql IaaS extension configurations.
        :param pulumi.Input[str] virtual_machine_resource_id: ARM Resource id of underlying virtual machine created from SQL marketplace image.
