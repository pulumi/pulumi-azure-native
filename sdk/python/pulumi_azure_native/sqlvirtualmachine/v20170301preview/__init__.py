...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:sqlvirtualmachine/v20170301preview:AvailabilityGroupListener":
                return AvailabilityGroupListener(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachine":
                return SqlVirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "sqlvirtualmachine/v20170301preview", _module_instance)
