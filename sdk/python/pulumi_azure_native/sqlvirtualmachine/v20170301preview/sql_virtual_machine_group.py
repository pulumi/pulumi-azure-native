...
warnings.warn("""azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlVirtualMachineGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 wsfc_domain_profile: Optional[pulumi.Input[pulumi.InputType['WsfcDomainProfileArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlVirtualMachineGroup is deprecated: azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachineGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sqlvirtualmachine/v20230101preview:SqlVirtualMachineGroup to guarantee forwards compatibility.""")
