...
class SqlVirtualMachineGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_virtual_machine_group = azure_native.sqlvirtualmachine.v20170301preview.SqlVirtualMachineGroup("sqlVirtualMachineGroup",
            ...
            wsfc_domain_profile=azure_native.sqlvirtualmachine.v20170301preview.WsfcDomainProfileArgs(
