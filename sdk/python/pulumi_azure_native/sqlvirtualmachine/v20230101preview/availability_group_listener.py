...
class AvailabilityGroupListenerArgs:
    ...
    def _configure(
        ...
        if sql_virtual_machine_group_name is None:
            raise TypeError("Missing 'sql_virtual_machine_group_name' argument")
        if availability_group_configuration is None and 'availabilityGroupConfiguration' in kwargs:
            availability_group_configuration = kwargs['availabilityGroupConfiguration']
        if availability_group_listener_name is None and 'availabilityGroupListenerName' in kwargs:
            availability_group_listener_name = kwargs['availabilityGroupListenerName']
        ...
        if create_default_availability_group_if_not_exist is None and 'createDefaultAvailabilityGroupIfNotExist' in kwargs:
            create_default_availability_group_if_not_exist = kwargs['createDefaultAvailabilityGroupIfNotExist']
...
class AvailabilityGroupListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            availability_group_configuration = _utilities.configure(availability_group_configuration, AgConfigurationArgs, True)
