...
class AvailabilityGroupListenerArgs:
    ...
    def _configure(
        ...
        if 'availabilityGroupConfiguration' in kwargs:
            availability_group_configuration = kwargs['availabilityGroupConfiguration']
        if 'availabilityGroupListenerName' in kwargs:
        ...
        if 'createDefaultAvailabilityGroupIfNotExist' in kwargs:
...
class AvailabilityGroupListener(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if availability_group_configuration is not None and not isinstance(availability_group_configuration, AgConfigurationArgs):
