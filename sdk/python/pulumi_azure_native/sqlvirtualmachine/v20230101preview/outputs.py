...
class AutoPatchingSettingsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'additionalVmPatch' in kwargs:
...
class ServerConfigurationsManagementSettingsResponse(dict):
    ...
    def _configure(
        ...
        if 'azureAdAuthenticationSettings' in kwargs:
...
class TroubleshootingAdditionalPropertiesResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'unhealthyReplicaInfo' in kwargs:
...
class WsfcDomainProfileResponse(dict):
    ...
    def _configure(
        ...
        if 'isSqlServiceAccountGmsa' in kwargs:
