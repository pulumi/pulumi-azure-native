...
def get_sql_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachine', __args__, opts=opts, typ=GetSqlVirtualMachineResult).value
...
def get_sql_virtual_machine_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['sqlVirtualMachineName'] = sql_virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sqlvirtualmachine/v20230101preview:getSqlVirtualMachine', __args__, opts=opts, typ=GetSqlVirtualMachineResult)
