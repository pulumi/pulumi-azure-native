...
class ConnectedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connected_cluster = azure_native.kubernetes.v20221001preview.ConnectedCluster("connectedCluster",
            ...
            identity=azure_native.kubernetes.v20221001preview.ConnectedClusterIdentityArgs(
                type=azure_native.kubernetes/v20221001preview.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="East US",
