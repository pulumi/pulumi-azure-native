...
def list_connected_cluster_user_credential(authentication_method: Optional[Union[str, 'AuthenticationMethod']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetes/v20221001preview:listConnectedClusterUserCredential', __args__, opts=opts, typ=ListConnectedClusterUserCredentialResult).value
