...
class ConnectedClusterArgs:
    def __init__(__self__, *,
                 agent_public_key_certificate: pulumi.Input[builtins.str],
                 ...
                 azure_hybrid_benefit: Optional[pulumi.Input[Union[builtins.str, 'AzureHybridBenefit']]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 distribution: Optional[pulumi.Input[builtins.str]] = None,
                 distribution_version: Optional[pulumi.Input[builtins.str]] = None,
                 infrastructure: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input[Union[builtins.str, 'ConnectedClusterKind']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_scope_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_state: Optional[pulumi.Input[Union[builtins.str, 'PrivateLinkState']]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_public_key_certificate: Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
        ...
        :param pulumi.Input[Union[builtins.str, 'AzureHybridBenefit']] azure_hybrid_benefit: Indicates whether Azure Hybrid Benefit is opted in
        :param pulumi.Input[builtins.str] cluster_name: The name of the Kubernetes cluster on which get is called.
        :param pulumi.Input[builtins.str] distribution: The Kubernetes distribution running on this connected cluster.
        :param pulumi.Input[builtins.str] distribution_version: The Kubernetes distribution version on this connected cluster.
        :param pulumi.Input[builtins.str] infrastructure: The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
        :param pulumi.Input[Union[builtins.str, 'ConnectedClusterKind']] kind: The kind of connected cluster.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] private_link_scope_resource_id: The resource id of the private link scope this connected cluster is assigned to, if any.
        :param pulumi.Input[Union[builtins.str, 'PrivateLinkState']] private_link_state: Property which describes the state of private link on a connected cluster resource.
        :param pulumi.Input[Union[builtins.str, 'ProvisioningState']] provisioning_state: Provisioning state of the connected cluster resource.
    ...
    def agent_public_key_certificate(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def agent_public_key_certificate(self, value: pulumi.Input[builtins.str]):
    ...
    def azure_hybrid_benefit(self) -> Optional[pulumi.Input[Union[builtins.str, 'AzureHybridBenefit']]]:
        """
    ...
    def azure_hybrid_benefit(self, value: Optional[pulumi.Input[Union[builtins.str, 'AzureHybridBenefit']]]):
    ...
    def distribution_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def distribution_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def kind(self) -> Optional[pulumi.Input[Union[builtins.str, 'ConnectedClusterKind']]]:
        """
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[builtins.str, 'ConnectedClusterKind']]]):
    ...
    def private_link_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'PrivateLinkState']]]:
        """
    ...
    def private_link_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'PrivateLinkState']]]):
...
class ConnectedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 agent_public_key_certificate: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="agentPublicKeyCertificate")
    def agent_public_key_certificate(self) -> pulumi.Output[builtins.str]:
        """
        Base64 encoded public certificate used by the agent to do the initial handshake to the backend services in Azure.
        """
        return pulumi.get(self, "agent_public_key_certificate")
    ...
    @property
    @pulumi.getter(name="azureHybridBenefit")
    def azure_hybrid_benefit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether Azure Hybrid Benefit is opted in
        """
        return pulumi.get(self, "azure_hybrid_benefit")
    ...
    @property
    @pulumi.getter(name="distributionVersion")
    def distribution_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Kubernetes distribution version on this connected cluster.
        """
        return pulumi.get(self, "distribution_version")
    ...
    @property
    @pulumi.getter
    def infrastructure(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The infrastructure on which the Kubernetes cluster represented by this connected cluster is running on.
        """
        return pulumi.get(self, "infrastructure")
    ...
    def last_connectivity_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def managed_identity_certificate_expiration_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def miscellaneous_properties(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="privateLinkState")
    def private_link_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Property which describes the state of private link on a connected cluster resource.
        """
        return pulumi.get(self, "private_link_state")
