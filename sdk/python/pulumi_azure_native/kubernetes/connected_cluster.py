...
class ConnectedClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ConnectedClusterKind']] kind: The kind of connected cluster.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] private_link_scope_resource_id: The resource id of the private link scope this connected cluster is assigned to, if any.
        :param pulumi.Input[Union[_builtins.str, 'PrivateLinkState']] private_link_state: Property which describes the state of private link on a connected cluster resource.
        :param pulumi.Input[Union[_builtins.str, 'ProvisioningState']] provisioning_state: Provisioning state of the connected cluster resource.
