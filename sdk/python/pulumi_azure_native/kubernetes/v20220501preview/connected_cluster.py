...
class ConnectedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectedCluster is deprecated: azure-native:kubernetes/v20220501preview:ConnectedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetes/v20221001preview:ConnectedCluster to guarantee forwards compatibility.""")
