...
class AgentErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str time: The timestamp of error occured (UTC).
        """
...
class ArcAgentProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 desired_agent_version: Optional[_builtins.str] = None,
...
class HybridConnectionConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str token: Sender access token
        """
...
class SystemComponentResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 major_version: Optional[_builtins.int] = None,
                 type: Optional[_builtins.str] = None,
        ...
        :param _builtins.str user_specified_version: Version of the system extension to be installed on the cluster resource.
        """
