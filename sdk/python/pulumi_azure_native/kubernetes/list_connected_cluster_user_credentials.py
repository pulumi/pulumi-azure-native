...
def list_connected_cluster_user_credentials(authentication_method: Optional[Union[_builtins.str, 'AuthenticationMethod']] = None,
                                            client_proxy: Optional[_builtins.bool] = None,
