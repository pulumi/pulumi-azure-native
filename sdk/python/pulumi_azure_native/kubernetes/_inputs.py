...
if not MYPY:
    class ArcAgentProfileArgsDict(TypedDict):
        ...
        """
        desired_agent_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ArcAgentProfileArgs:
    def __init__(__self__, *,
                 ...
                 desired_agent_version: Optional[pulumi.Input[builtins.str]] = None,
                 system_components: Optional[pulumi.Input[Sequence[pulumi.Input['SystemComponentArgs']]]] = None):
        """
        Defines the Arc Agent properties for the clusters.
        :param pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']] agent_auto_upgrade: Indicates whether the Arc agents on the be upgraded automatically to the latest version. Defaults to Enabled.
        :param pulumi.Input[builtins.str] desired_agent_version: Version of the Arc agents to be installed on the cluster resource
    ...
    def desired_agent_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version of the Arc agents to be installed on the cluster resource
        """
    ...
    def desired_agent_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SystemComponentArgsDict(TypedDict):
        ...
        """
        major_version: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        user_specified_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SystemComponentArgs:
    def __init__(__self__, *,
                 major_version: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_specified_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        System Extension and its desired versions to be installed on the cluster resource.
        :param pulumi.Input[builtins.int] major_version: Major Version of the system extension to be installed on the cluster resource.
        :param pulumi.Input[builtins.str] type: Type of the system extension
        :param pulumi.Input[builtins.str] user_specified_version: Version of the system extension to be installed on the cluster resource.
        """
    ...
    def major_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Major Version of the system extension to be installed on the cluster resource.
        """
    ...
    def major_version(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def user_specified_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version of the system extension to be installed on the cluster resource.
        """
    ...
    def user_specified_version(self, value: Optional[pulumi.Input[builtins.str]]):
