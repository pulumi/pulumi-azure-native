...
class ConnectedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connected_cluster = azure_native.kubernetes.v20210301.ConnectedCluster("connectedCluster",
            ...
            identity=azure_native.kubernetes.v20210301.ConnectedClusterIdentityArgs(
                type=azure_native.kubernetes/v20210301.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="East US",
        ...
        ```sh
        $ pulumi import azure-native:kubernetes/v20210301:ConnectedCluster connectedCluster1 /subscriptions/1bfbb5d0-917e-4346-9026-1d3b344417f5/resourceGroups/akkeshar/providers/Microsoft.Kubernetes/connectedClusters/connectedCluster1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetes:ConnectedCluster"), pulumi.Alias(type_="azure-native:kubernetes/v20200101preview:ConnectedCluster"), pulumi.Alias(type_="azure-native:kubernetes/v20210401preview:ConnectedCluster"), pulumi.Alias(type_="azure-native:kubernetes/v20211001:ConnectedCluster"), pulumi.Alias(type_="azure-native:kubernetes/v20220501preview:ConnectedCluster"), pulumi.Alias(type_="azure-native:kubernetes/v20221001preview:ConnectedCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedCluster, __self__).__init__(
            'azure-native:kubernetes/v20210301:ConnectedCluster',
            resource_name,
            __props__,
            opts)
