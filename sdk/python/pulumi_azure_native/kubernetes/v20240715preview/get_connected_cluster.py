...
def get_connected_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetes/v20240715preview:getConnectedCluster', __args__, opts=opts, typ=GetConnectedClusterResult).value
...
def get_connected_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetes/v20240715preview:getConnectedCluster', __args__, opts=opts, typ=GetConnectedClusterResult)
