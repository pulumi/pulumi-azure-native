...
warnings.warn("""azure-native:kubernetes/v20211001:ConnectedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kubernetes/v20221001preview:ConnectedCluster to guarantee forwards compatibility.""", DeprecationWarning)
