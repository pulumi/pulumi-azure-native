...
def get_connected_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connected_cluster is deprecated: azure-native:kubernetes/v20211001:ConnectedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:kubernetes/v20221001preview:ConnectedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
