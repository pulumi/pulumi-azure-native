...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kubernetes:getConnectedCluster'.""", DeprecationWarning)
...
def get_connected_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetes/latest:getConnectedCluster', __args__, opts=opts, typ=GetConnectedClusterResult).value
