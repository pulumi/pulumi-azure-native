...
def list_artifact_store_private_end_points(artifact_store_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork:listArtifactStorePrivateEndPoints', __args__, opts=opts, typ=ListArtifactStorePrivateEndPointsResult).value

    return AwaitableListArtifactStorePrivateEndPointsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_artifact_store_private_end_points_output(artifact_store_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork:listArtifactStorePrivateEndPoints', __args__, opts=opts, typ=ListArtifactStorePrivateEndPointsResult)
