...
def list_artifact_store_private_end_points(artifact_store_name: Optional[builtins.str] = None,
...
def list_artifact_store_private_end_points_output(artifact_store_name: Optional[pulumi.Input[builtins.str]] = None,
