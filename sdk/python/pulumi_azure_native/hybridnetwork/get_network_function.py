...
def get_network_function(network_function_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_function_name: The name of the network function resource.
...
def get_network_function_output(network_function_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
