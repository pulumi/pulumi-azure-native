...
def get_network_function(network_function_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_function_name: The name of the network function resource.
...
def get_network_function_output(network_function_name: Optional[pulumi.Input[builtins.str]] = None,
