...
warnings.warn("""azure-native:hybridnetwork/v20210501:NetworkFunction is being removed in the next major version of this provider. Please upgrade to azure-native:hybridnetwork/v20220101preview:NetworkFunction to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_function(network_function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_function is deprecated: azure-native:hybridnetwork/v20210501:NetworkFunction is being removed in the next major version of this provider. Please upgrade to azure-native:hybridnetwork/v20220101preview:NetworkFunction to guarantee forwards compatibility.""")
    __args__ = dict()
