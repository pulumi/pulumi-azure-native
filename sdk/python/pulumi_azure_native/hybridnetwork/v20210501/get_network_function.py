...
def get_network_function_output(network_function_name: Optional[pulumi.Input[str]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkFunctionResult]:
    """
    Gets information about the specified network function resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20210501:getNetworkFunction', __args__, opts=opts, typ=GetNetworkFunctionResult)
