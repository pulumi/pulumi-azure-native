...
class VendorSkus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:VendorSkus"), pulumi.Alias(type_="azure-native:hybridnetwork/v20200101preview:VendorSkus"), pulumi.Alias(type_="azure-native:hybridnetwork/v20220101preview:VendorSkus")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VendorSkus, __self__).__init__(
            'azure-native:hybridnetwork/v20210501:VendorSkus',
            resource_name,
            __props__,
            opts)
