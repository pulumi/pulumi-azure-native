...
warnings.warn("""azure-native:hybridnetwork/v20210501:VendorSkus is being removed in the next major version of this provider. Please upgrade to azure-native:hybridnetwork/v20220101preview:VendorSkus to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vendor_skus(sku_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vendor_skus is deprecated: azure-native:hybridnetwork/v20210501:VendorSkus is being removed in the next major version of this provider. Please upgrade to azure-native:hybridnetwork/v20220101preview:VendorSkus to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['skuName'] = sku_name
    __args__['vendorName'] = vendor_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20210501:getVendorSkus', __args__, opts=opts, typ=GetVendorSkusResult).value
