...
def list_device_registration_key_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20210501:listDeviceRegistrationKey', __args__, opts=opts, typ=ListDeviceRegistrationKeyResult)
