...
class NetworkServiceDesignVersionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['NetworkServiceDesignVersionPropertiesFormatArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['NetworkServiceDesignVersionPropertiesFormatArgs']]):
...
class NetworkServiceDesignVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_service_design_version_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['NetworkServiceDesignVersionPropertiesFormatArgs', 'NetworkServiceDesignVersionPropertiesFormatArgsDict']]] = None,
