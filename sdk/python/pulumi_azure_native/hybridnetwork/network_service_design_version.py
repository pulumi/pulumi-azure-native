...
class NetworkServiceDesignVersionArgs:
    ...
    def network_service_design_version_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def network_service_design_version_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class NetworkServiceDesignVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 network_service_design_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                 network_service_design_version_name: Optional[pulumi.Input[_builtins.str]] = None,
