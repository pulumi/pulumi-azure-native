...
class GetSiteResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.SitePropertiesFormatResponse':
        """
        Site properties.
        """
...
def get_site(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str site_name: The name of the network service site.
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork:getSite', __args__, opts=opts, typ=GetSiteResult)
