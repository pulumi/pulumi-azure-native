...
class ArtifactManifestArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ArtifactManifestPropertiesFormatArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ArtifactManifestPropertiesFormatArgs']]):
...
class ArtifactManifest(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ArtifactManifestPropertiesFormatArgs', 'ArtifactManifestPropertiesFormatArgsDict']]] = None,
