...
class VendorSkuPreview(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork/v20220101preview:VendorSkuPreview"), pulumi.Alias(type_="azure-native_hybridnetwork_v20200101preview:hybridnetwork:VendorSkuPreview"), pulumi.Alias(type_="azure-native_hybridnetwork_v20210501:hybridnetwork:VendorSkuPreview"), pulumi.Alias(type_="azure-native_hybridnetwork_v20220101preview:hybridnetwork:VendorSkuPreview")])
