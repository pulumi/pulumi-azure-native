...
class SiteNetworkServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] site_network_service_name: The name of the site network service.
    ...
    def site_network_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def site_network_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SiteNetworkService(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:hybridnetwork:SiteNetworkService"
