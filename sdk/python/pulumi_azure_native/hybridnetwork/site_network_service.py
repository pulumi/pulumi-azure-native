...
class SiteNetworkServiceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['SiteNetworkServicePropertiesFormatArgs']]:
        """
...
class SiteNetworkService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['SiteNetworkServicePropertiesFormatArgs', 'SiteNetworkServicePropertiesFormatArgsDict']]] = None,
