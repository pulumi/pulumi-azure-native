...
class ArmResourceDefinitionResourceElementTemplateDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Name of the resource element template.
        """
...
class ArtifactStorePropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 backing_resource_public_network_access: Optional[_builtins.str] = None,
        ...
        :param _builtins.str replication_strategy: The replication strategy.
        :param _builtins.str store_type: The artifact store type.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class ArtifactStorePropertiesFormatResponseManagedResourceGroupConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[_builtins.str] = None):
        """
        :param _builtins.str location: The managed resource group location.
        :param _builtins.str name: The managed resource group name.
        """
...
class AzureArcK8sClusterNFVIDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Name of the nfvi.
        """
...
class AzureArcKubernetesDeployMappingRuleProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 application_enablement: Optional[_builtins.str] = None,
...
class AzureArcKubernetesHelmApplicationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the network function application.
        """
...
class ConfigurationGroupSchemaPropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str schema_definition: Name and value pairs that define the configuration value. It can be a well formed escaped JSON string.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class ConfigurationValueWithSecretsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: The provisioning state of the site resource.
        :param _builtins.str publisher_name: The publisher name for the configuration group schema.
        :param _builtins.str publisher_scope: The scope of the publisher.
...
class ConfigurationValueWithoutSecretsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str publisher_scope: The scope of the publisher.
        :param Union['OpenDeploymentResourceReferenceResponse', 'SecretDeploymentResourceReferenceResponse'] configuration_group_schema_resource_reference: The configuration group schema resource reference.
        :param _builtins.str configuration_value: Name and value pairs that define the configuration value. It can be a well formed escaped JSON string.
        """
        pulumi.set(__self__, "configuration_group_schema_name", configuration_group_schema_name)
        pulumi.set(__self__, "configuration_group_schema_offering_location", configuration_group_schema_offering_location)
...
class ContainerizedNetworkFunctionDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: _builtins.str,
                 version_state: _builtins.str,
                 deploy_parameters: Optional[_builtins.str] = None,
                 description: Optional[_builtins.str] = None,
        ...
        :param _builtins.str version_state: The network function definition version state.
        :param _builtins.str deploy_parameters: The deployment parameters of the network function definition version.
        :param _builtins.str description: The network function definition version description.
...
class DependsOnProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 install_depends_on: Optional[Sequence[_builtins.str]] = None,
                 uninstall_depends_on: Optional[Sequence[_builtins.str]] = None,
...
class HelmArtifactProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 helm_package_name: Optional[_builtins.str] = None,
                 helm_package_version_range: Optional[_builtins.str] = None,
                 image_pull_secrets_values_paths: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] registry_values_paths: The registry values path list.
        """
...
class HelmInstallOptionsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 atomic: Optional[_builtins.str] = None,
...
class HelmMappingRuleProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 helm_package_version: Optional[_builtins.str] = None,
        ...
        :param _builtins.str release_namespace: Helm release namespace.
        :param _builtins.str values: Helm release values.
        """
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 exact_version: Optional[_builtins.str] = None,
        ...
        :param _builtins.str version: Specifies the version of the image used to create the virtual machine. The allowed formats are Major.Minor.Build or 'latest'. Major, Minor, and Build are decimal numbers. Specify 'latest' to use the latest version of an image available at deploy time. Even if you use 'latest', the VM image will not automatically update after deploy time even if a new version becomes available.
        """
...
class NetworkFunctionRoleConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str role_name: The name of the network function role.
        ...
        :param _builtins.str virtual_machine_size: The size of the virtual machine.
        """
...
class NetworkFunctionValueWithSecretsResponse(dict):
    ...
    def __init__(__self__, *,
                 configuration_type: _builtins.str,
                 provisioning_state: _builtins.str,
                 allow_software_update: Optional[_builtins.bool] = None,
                 network_function_definition_group_name: Optional[_builtins.str] = None,
                 network_function_definition_offering_location: Optional[_builtins.str] = None,
                 network_function_definition_version: Optional[_builtins.str] = None,
                 network_function_definition_version_resource_reference: Optional[Any] = None,
                 nfvi_id: Optional[_builtins.str] = None,
                 nfvi_type: Optional[_builtins.str] = None,
                 publisher_name: Optional[_builtins.str] = None,
                 publisher_scope: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool allow_software_update: Indicates if software updates are allowed during deployment.
        :param _builtins.str network_function_definition_group_name: The network function definition group name for the network function.
        :param _builtins.str network_function_definition_offering_location: The location of the network function definition offering.
        :param _builtins.str network_function_definition_version: The network function definition version for the network function.
        ...
        :param _builtins.str nfvi_id: The nfviId for the network function.
        :param _builtins.str nfvi_type: The nfvi type for the network function.
        :param _builtins.str publisher_name: The publisher name for the network function.
        :param _builtins.str publisher_scope: The scope of the publisher.
        :param Sequence[_builtins.str] role_override_values: The role configuration override values from the user.
        """
        pulumi.set(__self__, "configuration_type", 'Secret')
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class NetworkFunctionValueWithoutSecretsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: _builtins.str,
                 allow_software_update: Optional[_builtins.bool] = None,
                 deployment_values: Optional[_builtins.str] = None,
                 network_function_definition_group_name: Optional[_builtins.str] = None,
                 network_function_definition_offering_location: Optional[_builtins.str] = None,
                 network_function_definition_version: Optional[_builtins.str] = None,
                 network_function_definition_version_resource_reference: Optional[Any] = None,
        ...
        :param _builtins.str provisioning_state: The provisioning state of the network function resource.
        :param _builtins.bool allow_software_update: Indicates if software updates are allowed during deployment.
        :param _builtins.str deployment_values: The JSON-serialized deployment values from the user.
        :param _builtins.str network_function_definition_group_name: The network function definition group name for the network function.
        :param _builtins.str network_function_definition_offering_location: The location of the network function definition offering.
        :param _builtins.str network_function_definition_version: The network function definition version for the network function.
        :param Union['OpenDeploymentResourceReferenceResponse', 'SecretDeploymentResourceReferenceResponse'] network_function_definition_version_resource_reference: The network function definition version resource reference.
...
class NetworkInterfaceIPConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str ip_allocation_method: IP address allocation method.
        :param _builtins.str ip_version: IP address version.
        :param _builtins.str subnet: The value of the subnet.
        """
...
class NetworkInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str vm_switch_type: The type of the VM switch.
        """
...
class NetworkServiceDesignVersionPropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str description: The network service design version description.
...
class OsProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_data_required: Optional[_builtins.bool] = None,
...
class SiteNetworkServicePropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str network_service_design_version_name: The network service design version for the site network service.
        :param _builtins.str network_service_design_version_offering_location: The location of the network service design offering.
        :param _builtins.str provisioning_state: The provisioning state of the site network service resource.
        :param _builtins.str publisher_name: The publisher name for the site network service.
        :param _builtins.str publisher_scope: The scope of the publisher.
