...
def get_configuration_group_value(configuration_group_value_name: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_group_value_name: The name of the configuration group value.
...
def get_configuration_group_value_output(configuration_group_value_name: Optional[pulumi.Input[builtins.str]] = None,
