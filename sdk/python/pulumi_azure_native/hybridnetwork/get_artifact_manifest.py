...
def get_artifact_manifest(artifact_manifest_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork:getArtifactManifest', __args__, opts=opts, typ=GetArtifactManifestResult).value

    return AwaitableGetArtifactManifestResult(
...
def get_artifact_manifest_output(artifact_manifest_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork:getArtifactManifest', __args__, opts=opts, typ=GetArtifactManifestResult)
