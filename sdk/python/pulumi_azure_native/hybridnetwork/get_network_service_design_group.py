...
def get_network_service_design_group(network_service_design_group_name: Optional[_builtins.str] = None,
...
def get_network_service_design_group_output(network_service_design_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
