...
def get_network_service_design_group(network_service_design_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_service_design_group_name: The name of the network service design group.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork:getNetworkServiceDesignGroup', __args__, opts=opts, typ=GetNetworkServiceDesignGroupResult).value

    return AwaitableGetNetworkServiceDesignGroupResult(
...
def get_network_service_design_group_output(network_service_design_group_name: Optional[pulumi.Input[builtins.str]] = None,
