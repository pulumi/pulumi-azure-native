...
def get_network_service_design_version(network_service_design_group_name: Optional[builtins.str] = None,
                                       network_service_design_version_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_service_design_version_name: The name of the network service design version. The name should conform to the SemVer 2.0.0 specification: https://semver.org/spec/v2.0.0.html.
...
def get_network_service_design_version_output(network_service_design_group_name: Optional[pulumi.Input[builtins.str]] = None,
