...
class NetworkFunctionDefinitionVersionArgs:
    def __init__(__self__, *,
                 network_function_definition_group_name: pulumi.Input[str],
        ...
        :param pulumi.Input[str] network_function_definition_version_name: The name of the network function definition version. The name should conform to the SemVer 2.0.0 specification: https://semver.org/spec/v2.0.0.html.
    ...
    def network_function_definition_group_name(self) -> pulumi.Input[str]:
        """
    ...
    def network_function_definition_group_name(self, value: pulumi.Input[str]):
    ...
    def network_function_definition_version_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def network_function_definition_version_name(self, value: Optional[pulumi.Input[str]]):
...
class NetworkFunctionDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:NetworkFunctionDefinitionVersion"), pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkFunctionDefinitionVersion, __self__).__init__(
            'azure-native:hybridnetwork/v20240415:NetworkFunctionDefinitionVersion',
            resource_name,
            __props__,
            opts)
