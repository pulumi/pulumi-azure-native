...
__all__ = [
    ...
    'AwaitableGetNetworkFunctionDefinitionVersionResult',
    'get_network_function_definition_version',
    'get_network_function_definition_version_output',
]

@pulumi.output_type
class GetNetworkFunctionDefinitionVersionResult:
    """
...
class AwaitableGetNetworkFunctionDefinitionVersionResult(GetNetworkFunctionDefinitionVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkFunctionDefinitionVersionResult(
            id=self.id,
...
def get_network_function_definition_version(network_function_definition_group_name: Optional[str] = None,
    ...
    """
    __args__ = dict()
    __args__['networkFunctionDefinitionGroupName'] = network_function_definition_group_name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20240415:getNetworkFunctionDefinitionVersion', __args__, opts=opts, typ=GetNetworkFunctionDefinitionVersionResult).value

    return AwaitableGetNetworkFunctionDefinitionVersionResult(
...
def get_network_function_definition_version_output(network_function_definition_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20240415:getNetworkFunctionDefinitionVersion', __args__, opts=opts, typ=GetNetworkFunctionDefinitionVersionResult)
