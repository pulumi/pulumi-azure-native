...
class NetworkFunctionDefinitionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:NetworkFunctionDefinitionGroup"), pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkFunctionDefinitionGroup, __self__).__init__(
            'azure-native:hybridnetwork/v20240415:NetworkFunctionDefinitionGroup',
            resource_name,
            __props__,
            opts)
