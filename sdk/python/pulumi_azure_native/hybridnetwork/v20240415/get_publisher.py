...
def get_publisher(publisher_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20240415:getPublisher', __args__, opts=opts, typ=GetPublisherResult).value
...
def get_publisher_output(publisher_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20240415:getPublisher', __args__, opts=opts, typ=GetPublisherResult)
