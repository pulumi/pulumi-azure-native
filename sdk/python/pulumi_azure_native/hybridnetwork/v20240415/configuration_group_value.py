...
class ConfigurationGroupValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:ConfigurationGroupValue"), pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:ConfigurationGroupValue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationGroupValue, __self__).__init__(
            'azure-native:hybridnetwork/v20240415:ConfigurationGroupValue',
            resource_name,
            __props__,
            opts)
