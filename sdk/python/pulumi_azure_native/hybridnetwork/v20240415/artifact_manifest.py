...
class ArtifactManifest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:ArtifactManifest"), pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:ArtifactManifest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArtifactManifest, __self__).__init__(
            'azure-native:hybridnetwork/v20240415:ArtifactManifest',
            resource_name,
            __props__,
            opts)
