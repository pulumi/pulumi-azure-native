...
class ArtifactManifest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:ArtifactManifest"), pulumi.Alias(type_="azure-native:hybridnetwork:ArtifactManifest")])
