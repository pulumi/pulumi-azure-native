...
def get_artifact_store(artifact_store_name: Optional[str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactStoreResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20240415:getArtifactStore', __args__, opts=opts, typ=GetArtifactStoreResult).value

    return AwaitableGetArtifactStoreResult(
...
def get_artifact_store_output(artifact_store_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20240415:getArtifactStore', __args__, opts=opts, typ=GetArtifactStoreResult)
