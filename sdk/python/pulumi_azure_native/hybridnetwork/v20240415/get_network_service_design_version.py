...
def get_network_service_design_version(network_service_design_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20240415:getNetworkServiceDesignVersion', __args__, opts=opts, typ=GetNetworkServiceDesignVersionResult).value
...
def get_network_service_design_version_output(network_service_design_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20240415:getNetworkServiceDesignVersion', __args__, opts=opts, typ=GetNetworkServiceDesignVersionResult)
