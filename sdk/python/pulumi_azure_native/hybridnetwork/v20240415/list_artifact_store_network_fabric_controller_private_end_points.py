...
def list_artifact_store_network_fabric_controller_private_end_points(artifact_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20240415:listArtifactStoreNetworkFabricControllerPrivateEndPoints', __args__, opts=opts, typ=ListArtifactStoreNetworkFabricControllerPrivateEndPointsResult).value
...
def list_artifact_store_network_fabric_controller_private_end_points_output(artifact_store_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20240415:listArtifactStoreNetworkFabricControllerPrivateEndPoints', __args__, opts=opts, typ=ListArtifactStoreNetworkFabricControllerPrivateEndPointsResult)
