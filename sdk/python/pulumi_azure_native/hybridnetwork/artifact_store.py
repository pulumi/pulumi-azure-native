...
class ArtifactStoreArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ArtifactStorePropertiesFormatArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ArtifactStorePropertiesFormatArgs']]):
...
class ArtifactStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 artifact_store_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ArtifactStorePropertiesFormatArgs', 'ArtifactStorePropertiesFormatArgsDict']]] = None,
