...
def list_vendor_skus_credential_output(sku_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vendorName'] = vendor_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20220101preview:listVendorSkusCredential', __args__, opts=opts, typ=ListVendorSkusCredentialResult)
