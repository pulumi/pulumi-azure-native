...
class NetworkFunctionArgs:
    ...
    def _configure(
        ...
        if network_function_container_configurations is None and 'networkFunctionContainerConfigurations' in kwargs:
        ...
        if network_function_user_configurations is None and 'networkFunctionUserConfigurations' in kwargs:
...
class NetworkFunction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            device = _utilities.configure(device, SubResourceArgs, True)
