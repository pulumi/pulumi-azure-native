...
class VendorSkus(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vendor_skus = azure_native.hybridnetwork.v20220101preview.VendorSkus("vendorSkus",
            deployment_mode="PrivateEdgeZone",
            managed_application_template={},
            network_function_template=azure_native.hybridnetwork.v20220101preview.NetworkFunctionTemplateResponseArgs(
                network_function_role_configurations=[{
                    "customProfile": azure_native.hybridnetwork.v20220101preview.CustomProfileArgs(
                    ...
                    "osProfile": {
                        ...
                        "linuxConfiguration": {
                            "ssh": {
                                "publicKeys": [azure_native.hybridnetwork.v20220101preview.SshPublicKeyArgs(
                    ...
                    "storageProfile": {
                        "dataDisks": [azure_native.hybridnetwork.v20220101preview.DataDiskArgs(
                            create_option="Empty",
                            disk_size_gb=10,
                            name="DataDisk1",
                        )],
                        "imageReference": azure_native.hybridnetwork.v20220101preview.ImageReferenceArgs(
                            offer="UbuntuServer",
                            publisher="Canonical",
                            sku="18.04-LTS",
                        ...
                        "osDisk": {
                            ...
                            "name": "vhdName",
                            "osType": "Linux",
                            "vhd": azure_native.hybridnetwork.v20220101preview.VirtualHardDiskArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:VendorSkus"), pulumi.Alias(type_="azure-native:hybridnetwork/v20200101preview:VendorSkus"), pulumi.Alias(type_="azure-native:hybridnetwork/v20210501:VendorSkus")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VendorSkus, __self__).__init__(
            'azure-native:hybridnetwork/v20220101preview:VendorSkus',
            resource_name,
            __props__,
            opts)
