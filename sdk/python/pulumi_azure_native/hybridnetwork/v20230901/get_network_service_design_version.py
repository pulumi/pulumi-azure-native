...
def get_network_service_design_version(network_service_design_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20230901:getNetworkServiceDesignVersion', __args__, opts=opts, typ=GetNetworkServiceDesignVersionResult).value
...
@_utilities.lift_output_func(get_network_service_design_version)
