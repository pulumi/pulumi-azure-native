...
def get_artifact_manifest(artifact_manifest_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20230901:getArtifactManifest', __args__, opts=opts, typ=GetArtifactManifestResult).value
...
def get_artifact_manifest_output(artifact_manifest_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20230901:getArtifactManifest', __args__, opts=opts, typ=GetArtifactManifestResult)
