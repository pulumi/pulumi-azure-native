...
def get_network_service_design_group(network_service_design_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20230901:getNetworkServiceDesignGroup', __args__, opts=opts, typ=GetNetworkServiceDesignGroupResult).value
