...
def get_configuration_group_value(configuration_group_value_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20230901:getConfigurationGroupValue', __args__, opts=opts, typ=GetConfigurationGroupValueResult).value
...
def get_configuration_group_value_output(configuration_group_value_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork/v20230901:getConfigurationGroupValue', __args__, opts=opts, typ=GetConfigurationGroupValueResult)
