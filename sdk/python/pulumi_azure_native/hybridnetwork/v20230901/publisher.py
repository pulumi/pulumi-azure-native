...
class Publisher(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:Publisher"), pulumi.Alias(type_="azure-native:hybridnetwork/v20240415:Publisher")])
