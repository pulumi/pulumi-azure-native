...
class CustomProfileArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if metadata_configuration_path is None and 'metadataConfigurationPath' in kwargs:
...
class NetworkFunctionRoleConfigurationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if custom_profile is None and 'customProfile' in kwargs:
        ...
        if user_data_parameters is None and 'userDataParameters' in kwargs:
            user_data_parameters = kwargs['userDataParameters']
        if user_data_template is None and 'userDataTemplate' in kwargs:
...
class NetworkFunctionTemplateArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if network_function_role_configurations is None and 'networkFunctionRoleConfigurations' in kwargs:
...
class NetworkInterfaceArgs:
    ...
    def _configure(
        ...
        if vm_switch_type is None and 'vmSwitchType' in kwargs:
...
class OsProfileArgs:
    ...
    def _configure(
        ...
        if custom_data is None and 'customData' in kwargs:
            custom_data = kwargs['customData']
        if custom_data_required is None and 'customDataRequired' in kwargs:
