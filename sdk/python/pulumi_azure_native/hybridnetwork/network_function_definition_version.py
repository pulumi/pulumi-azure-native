...
class NetworkFunctionDefinitionVersionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional[Union['ContainerizedNetworkFunctionDefinitionVersionArgs', 'VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs']]]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional[Union['ContainerizedNetworkFunctionDefinitionVersionArgs', 'VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs']]]):
...
class NetworkFunctionDefinitionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_function_definition_version_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union[Union['ContainerizedNetworkFunctionDefinitionVersionArgs', 'ContainerizedNetworkFunctionDefinitionVersionArgsDict'], Union['VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs', 'VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgsDict']]]] = None,
