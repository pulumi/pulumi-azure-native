...
class NetworkFunctionDefinitionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_function_definition_version_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union[pulumi.InputType['ContainerizedNetworkFunctionDefinitionVersionArgs'], pulumi.InputType['VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs']]]] = None,
        ...
        :param pulumi.Input[str] network_function_definition_group_name: The name of the network function definition group.
        :param pulumi.Input[str] network_function_definition_version_name: The name of the network function definition version. The name should conform to the SemVer 2.0.0 specification: https://semver.org/spec/v2.0.0.html.
        :param pulumi.Input[Union[pulumi.InputType['ContainerizedNetworkFunctionDefinitionVersionArgs'], pulumi.InputType['VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs']]] properties: Network function definition version properties.
        :param pulumi.Input[str] publisher_name: The name of the publisher.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
