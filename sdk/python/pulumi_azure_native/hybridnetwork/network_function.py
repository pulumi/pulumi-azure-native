...
class NetworkFunctionArgs:
    def __init__(__self__, *,
                 ...
                 network_function_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] network_function_name: Resource name for the network function resource.
    ...
    def network_function_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_function_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkFunction(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:hybridnetwork:NetworkFunction"
