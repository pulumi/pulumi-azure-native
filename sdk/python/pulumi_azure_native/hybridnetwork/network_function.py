...
class NetworkFunctionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional[Union['NetworkFunctionValueWithSecretsArgs', 'NetworkFunctionValueWithoutSecretsArgs']]]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional[Union['NetworkFunctionValueWithSecretsArgs', 'NetworkFunctionValueWithoutSecretsArgs']]]):
...
class NetworkFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 network_function_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union[Union['NetworkFunctionValueWithSecretsArgs', 'NetworkFunctionValueWithSecretsArgsDict'], Union['NetworkFunctionValueWithoutSecretsArgs', 'NetworkFunctionValueWithoutSecretsArgsDict']]]] = None,
