...
class Vendor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vendor = azure_native.hybridnetwork.v20200101preview.Vendor("vendor", vendor_name="TestVendor")
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:Vendor"), pulumi.Alias(type_="azure-native:hybridnetwork/v20210501:Vendor"), pulumi.Alias(type_="azure-native:hybridnetwork/v20220101preview:Vendor")])
