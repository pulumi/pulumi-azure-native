...
warnings.warn("""azure-native:hybridnetwork/v20200101preview:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:Device to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_device(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device is deprecated: azure-native:hybridnetwork/v20200101preview:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:Device to guarantee forwards compatibility.""")
    __args__ = dict()
