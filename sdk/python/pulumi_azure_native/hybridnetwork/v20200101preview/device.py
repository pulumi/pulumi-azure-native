...
class Device(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:Device"), pulumi.Alias(type_="azure-native:hybridnetwork/v20210501:Device")])
