...
class NetworkFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_function = azure_native.hybridnetwork.v20200101preview.NetworkFunction("networkFunction",
            device=azure_native.hybridnetwork.v20200101preview.SubResourceArgs(
