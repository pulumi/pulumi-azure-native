...
warnings.warn("""azure-native:hybridnetwork/v20200101preview:Vendor is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:Vendor to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vendor(vendor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vendor is deprecated: azure-native:hybridnetwork/v20200101preview:Vendor is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:Vendor to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['vendorName'] = vendor_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20200101preview:getVendor', __args__, opts=opts, typ=GetVendorResult).value
