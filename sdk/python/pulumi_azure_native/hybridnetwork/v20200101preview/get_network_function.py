...
def get_network_function(network_function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_function is deprecated: azure-native:hybridnetwork/v20200101preview:NetworkFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridnetwork/v20220101preview:NetworkFunction to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkFunctionName'] = network_function_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridnetwork/v20200101preview:getNetworkFunction', __args__, opts=opts, typ=GetNetworkFunctionResult).value
