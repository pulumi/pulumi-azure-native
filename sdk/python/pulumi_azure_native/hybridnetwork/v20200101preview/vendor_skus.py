...
class VendorSkus(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vendor_skus = azure_native.hybridnetwork.v20200101preview.VendorSkus("vendorSkus",
            deployment_mode="PrivateEdgeZone",
            managed_application_template={},
            network_function_template=azure_native.hybridnetwork.v20200101preview.NetworkFunctionTemplateResponseArgs(
                network_function_role_configurations=[{
                    "customProfile": azure_native.hybridnetwork.v20200101preview.CustomProfileArgs(
                        metadata_configuration_path="/var/logs/network.cfg",
                    ),
                    "networkInterfaces": [
                        {
                            "ipConfigurations": [azure_native.hybridnetwork.v20200101preview.NetworkInterfaceIPConfigurationArgs(
                                gateway="",
                                ip_address="",
                    ...
                    "osProfile": {
                        ...
                        "linuxConfiguration": {
                            "ssh": {
                                "publicKeys": [azure_native.hybridnetwork.v20200101preview.SshPublicKeyArgs(
                    ...
                    "storageProfile": {
                        "dataDisks": [azure_native.hybridnetwork.v20200101preview.DataDiskArgs(
                            create_option="Empty",
                            disk_size_gb=10,
                            name="DataDisk1",
                        )],
                        "imageReference": azure_native.hybridnetwork.v20200101preview.ImageReferenceArgs(
                            offer="UbuntuServer",
                            publisher="Canonical",
                            sku="18.04-LTS",
                        ...
                        "osDisk": {
                            ...
                            "name": "vhdName",
                            "osType": "Linux",
                            "vhd": azure_native.hybridnetwork.v20200101preview.VirtualHardDiskArgs(
