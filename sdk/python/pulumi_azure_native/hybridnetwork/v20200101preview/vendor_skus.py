...
class VendorSkus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork:VendorSkus"), pulumi.Alias(type_="azure-native:hybridnetwork/v20220101preview:VendorSkus")])
