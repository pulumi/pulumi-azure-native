...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybridnetwork/v20200101preview:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork/v20200101preview:NetworkFunction":
                return NetworkFunction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork/v20200101preview:Vendor":
                return Vendor(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork/v20200101preview:VendorSkuPreview":
                return VendorSkuPreview(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork/v20200101preview:VendorSkus":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybridnetwork/v20200101preview", _module_instance)
