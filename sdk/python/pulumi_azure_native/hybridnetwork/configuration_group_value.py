...
class ConfigurationGroupValueArgs:
    def __init__(__self__, *,
                 ...
                 configuration_group_value_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] configuration_group_value_name: The name of the configuration group value.
    ...
    def configuration_group_value_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def configuration_group_value_name(self, value: Optional[pulumi.Input[str]]):
...
class ConfigurationGroupValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridnetwork/v20230901:ConfigurationGroupValue"), pulumi.Alias(type_="azure-native:hybridnetwork/v20240415:ConfigurationGroupValue"), pulumi.Alias(type_="azure-native_hybridnetwork_v20230901:hybridnetwork:ConfigurationGroupValue"), pulumi.Alias(type_="azure-native_hybridnetwork_v20240415:hybridnetwork:ConfigurationGroupValue")])
