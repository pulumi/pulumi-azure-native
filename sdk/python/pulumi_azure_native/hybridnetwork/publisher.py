...
class PublisherArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['PublisherPropertiesFormatArgs']]:
        """
...
class Publisher(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['PublisherPropertiesFormatArgs', 'PublisherPropertiesFormatArgsDict']]] = None,
                 publisher_name: pulumi.Input[Optional[_builtins.str]] = None,
