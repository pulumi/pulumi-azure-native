...
class GetVendorResult:
    ...
    Vendor resource.
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, provisioning_state=None, skus=None, system_data=None, type=None):
...
def get_vendor(vendor_name: Optional[_builtins.str] = None,
...
def get_vendor_output(vendor_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
