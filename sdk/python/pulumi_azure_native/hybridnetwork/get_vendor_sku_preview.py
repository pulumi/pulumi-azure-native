...
def get_vendor_sku_preview(preview_subscription: Optional[builtins.str] = None,
    ...
    :param builtins.str preview_subscription: Preview subscription ID.
    :param builtins.str sku_name: The name of the vendor sku.
...
def get_vendor_sku_preview_output(preview_subscription: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridnetwork:getVendorSkuPreview', __args__, opts=opts, typ=GetVendorSkuPreviewResult)
