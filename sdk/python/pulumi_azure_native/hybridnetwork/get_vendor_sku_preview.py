...
def get_vendor_sku_preview(preview_subscription: Optional[_builtins.str] = None,
    ...
    :param _builtins.str preview_subscription: Preview subscription ID.
    :param _builtins.str sku_name: The name of the vendor sku.
...
def get_vendor_sku_preview_output(preview_subscription: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
