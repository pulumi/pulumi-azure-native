...
class VendorSkusArgs:
    ...
    def _configure(
        ...
        if 'managedApplicationTemplate' in kwargs:
            managed_application_template = kwargs['managedApplicationTemplate']
        if 'networkFunctionTemplate' in kwargs:
...
class VendorSkus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if network_function_template is not None and not isinstance(network_function_template, NetworkFunctionTemplateArgs):
                network_function_template = network_function_template or {}
                def _setter(key, value):
                    network_function_template[key] = value
                NetworkFunctionTemplateArgs._configure(_setter, **network_function_template)
