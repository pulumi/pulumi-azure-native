...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybridnetwork:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork:NetworkFunction":
                return NetworkFunction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork:Vendor":
                return Vendor(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork:VendorSkuPreview":
                return VendorSkuPreview(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridnetwork:VendorSkus":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybridnetwork", _module_instance)
