...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus/v20170401:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20211101:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20220101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20240101:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus:DisasterRecoveryConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DisasterRecoveryConfig, __self__).__init__(
            'azure-native:servicebus/v20230101preview:DisasterRecoveryConfig',
            resource_name,
            __props__,
            opts)
