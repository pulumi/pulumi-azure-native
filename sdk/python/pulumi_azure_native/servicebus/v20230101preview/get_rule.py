...
def get_rule(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20230101preview:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20230101preview:getRule', __args__, opts=opts, typ=GetRuleResult)
