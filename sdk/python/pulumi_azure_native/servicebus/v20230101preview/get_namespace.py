...
class GetNamespaceResult:
    ...
    """
    def __init__(__self__, alternate_name=None, created_at=None, disable_local_auth=None, encryption=None, geo_data_replication=None, id=None, identity=None, location=None, metric_id=None, minimum_tls_version=None, name=None, premium_messaging_partitions=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, service_bus_endpoint=None, sku=None, status=None, system_data=None, tags=None, type=None, updated_at=None, zone_redundant=None):
...
def get_namespace(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20230101preview:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20230101preview:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
