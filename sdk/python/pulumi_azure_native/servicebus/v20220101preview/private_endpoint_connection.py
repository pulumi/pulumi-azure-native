...
warnings.warn("""azure-native:servicebus/v20220101preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:servicebus/v20220101preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20211101:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:servicebus/v20220101preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
