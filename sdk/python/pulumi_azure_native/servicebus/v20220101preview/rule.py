...
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rule = azure_native.servicebus.v20220101preview.Rule("rule",
            correlation_filter=azure_native.servicebus.v20220101preview.CorrelationFilterArgs(
                properties={
                    "topicHint": "Crop",
                },
            ),
        ...
        rule = azure_native.servicebus.v20220101preview.Rule("rule",
            ...
            resource_group_name="resourceGroupName",
            rule_name="sdk-Rules-6571",
            sql_filter=azure_native.servicebus.v20220101preview.SqlFilterArgs(
        ...
        ```sh
        $ pulumi import azure-native:servicebus/v20220101preview:Rule sdk-Rules-6571 /subscriptions/subscriptionId/resourceGroups/resourceGroupName/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-1319/topics/sdk-Topics-2081/subscriptions/sdk-Subscriptions-8691/rules/sdk-Rules-6571 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20170401:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20211101:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:Rule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'azure-native:servicebus/v20220101preview:Rule',
            resource_name,
            __props__,
            opts)
