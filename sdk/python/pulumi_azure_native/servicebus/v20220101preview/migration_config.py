...
warnings.warn("""azure-native:servicebus/v20220101preview:MigrationConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:MigrationConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
class MigrationConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_namespace: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MigrationConfig is deprecated: azure-native:servicebus/v20220101preview:MigrationConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:MigrationConfig to guarantee forwards compatibility.""")
