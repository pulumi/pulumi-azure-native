...
warnings.warn("""azure-native:servicebus/v20220101preview:Topic is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Topic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_topic(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic is deprecated: azure-native:servicebus/v20220101preview:Topic is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Topic to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['namespaceName'] = namespace_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20220101preview:getTopic', __args__, opts=opts, typ=GetTopicResult).value
