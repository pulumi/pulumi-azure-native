...
def get_topic_authorization_rule(authorization_rule_name: Optional[_builtins.str] = None,
...
def get_topic_authorization_rule_output(authorization_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
