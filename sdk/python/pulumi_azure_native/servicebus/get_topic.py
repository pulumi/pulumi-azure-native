...
class GetTopicResult:
    ...
    def subscription_count(self) -> builtins.int:
        """
    ...
    def support_ordering(self) -> Optional[builtins.bool]:
        """
...
def get_topic(namespace_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus:getTopic', __args__, opts=opts, typ=GetTopicResult).value
...
def get_topic_output(namespace_name: Optional[pulumi.Input[builtins.str]] = None,
