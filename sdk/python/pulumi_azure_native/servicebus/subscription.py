...
class SubscriptionArgs:
    ...
    def _configure(
        ...
        if client_affine_properties is None and 'clientAffineProperties' in kwargs:
            client_affine_properties = kwargs['clientAffineProperties']
        if dead_lettering_on_filter_evaluation_exceptions is None and 'deadLetteringOnFilterEvaluationExceptions' in kwargs:
            dead_lettering_on_filter_evaluation_exceptions = kwargs['deadLetteringOnFilterEvaluationExceptions']
        ...
        if is_client_affine is None and 'isClientAffine' in kwargs:
            is_client_affine = kwargs['isClientAffine']
...
class Subscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            client_affine_properties = _utilities.configure(client_affine_properties, SBClientAffinePropertiesArgs, True)
