...
class SubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 dead_lettering_on_filter_evaluation_exceptions: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 is_client_affine: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] dead_lettering_on_filter_evaluation_exceptions: Value that indicates whether a subscription has dead letter support on filter evaluation exceptions.
        :param pulumi.Input[_builtins.bool] dead_lettering_on_message_expiration: Value that indicates whether a subscription has dead letter support when a message expires.
        :param pulumi.Input[_builtins.str] default_message_time_to_live: ISO 8061 Default message timespan to live value. This is the duration after which the message expires, starting from when the message is sent to Service Bus. This is the default value used when TimeToLive is not set on a message itself.
        :param pulumi.Input[_builtins.str] duplicate_detection_history_time_window: ISO 8601 timeSpan structure that defines the duration of the duplicate detection history. The default value is 10 minutes.
        :param pulumi.Input[_builtins.bool] enable_batched_operations: Value that indicates whether server-side batched operations are enabled.
        :param pulumi.Input[_builtins.str] forward_dead_lettered_messages_to: Queue/Topic name to forward the Dead Letter message
        :param pulumi.Input[_builtins.str] forward_to: Queue/Topic name to forward the messages
        :param pulumi.Input[_builtins.bool] is_client_affine: Value that indicates whether the subscription has an affinity to the client id.
        :param pulumi.Input[_builtins.str] lock_duration: ISO 8061 lock duration timespan for the subscription. The default value is 1 minute.
    ...
    def client_affine_properties(self) -> pulumi.Input[Optional['SBClientAffinePropertiesArgs']]:
        """
    ...
    def client_affine_properties(self, value: pulumi.Input[Optional['SBClientAffinePropertiesArgs']]):
        pulumi.set(self, "client_affine_properties", value)

    @_builtins.property
    @pulumi.getter(name="deadLetteringOnFilterEvaluationExceptions")
    def dead_lettering_on_filter_evaluation_exceptions(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def dead_lettering_on_filter_evaluation_exceptions(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def is_client_affine(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_client_affine(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class Subscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_delete_on_idle: pulumi.Input[Optional[_builtins.str]] = None,
                 client_affine_properties: pulumi.Input[Optional[Union['SBClientAffinePropertiesArgs', 'SBClientAffinePropertiesArgsDict']]] = None,
                 dead_lettering_on_filter_evaluation_exceptions: pulumi.Input[Optional[_builtins.bool]] = None,
                 dead_lettering_on_message_expiration: pulumi.Input[Optional[_builtins.bool]] = None,
                 default_message_time_to_live: pulumi.Input[Optional[_builtins.str]] = None,
                 duplicate_detection_history_time_window: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="deadLetteringOnFilterEvaluationExceptions")
    def dead_lettering_on_filter_evaluation_exceptions(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Value that indicates whether a subscription has dead letter support on filter evaluation exceptions.
        """
        return pulumi.get(self, "dead_lettering_on_filter_evaluation_exceptions")
