...
class SubscriptionArgs:
    ...
    def _configure(
        ...
        if 'clientAffineProperties' in kwargs:
            client_affine_properties = kwargs['clientAffineProperties']
        if 'deadLetteringOnFilterEvaluationExceptions' in kwargs:
...
class Subscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if client_affine_properties is not None and not isinstance(client_affine_properties, SBClientAffinePropertiesArgs):
