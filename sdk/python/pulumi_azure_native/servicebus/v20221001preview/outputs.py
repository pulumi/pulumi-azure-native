...
class MessageCountDetailsResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             active_message_count: Optional[float] = None,
             dead_letter_message_count: Optional[float] = None,
             scheduled_message_count: Optional[float] = None,
             transfer_dead_letter_message_count: Optional[float] = None,
             transfer_message_count: Optional[float] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if active_message_count is None and 'activeMessageCount' in kwargs:
            active_message_count = kwargs['activeMessageCount']
        if active_message_count is None:
            raise TypeError("Missing 'active_message_count' argument")
        if dead_letter_message_count is None and 'deadLetterMessageCount' in kwargs:
            dead_letter_message_count = kwargs['deadLetterMessageCount']
        if dead_letter_message_count is None:
            raise TypeError("Missing 'dead_letter_message_count' argument")
        if scheduled_message_count is None and 'scheduledMessageCount' in kwargs:
            scheduled_message_count = kwargs['scheduledMessageCount']
        if scheduled_message_count is None:
            raise TypeError("Missing 'scheduled_message_count' argument")
        if transfer_dead_letter_message_count is None and 'transferDeadLetterMessageCount' in kwargs:
            transfer_dead_letter_message_count = kwargs['transferDeadLetterMessageCount']
        if transfer_dead_letter_message_count is None:
            raise TypeError("Missing 'transfer_dead_letter_message_count' argument")
        if transfer_message_count is None and 'transferMessageCount' in kwargs:
            transfer_message_count = kwargs['transferMessageCount']
        if transfer_message_count is None:
            raise TypeError("Missing 'transfer_message_count' argument")
