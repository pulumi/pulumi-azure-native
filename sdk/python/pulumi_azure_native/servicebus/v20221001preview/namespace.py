...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if premium_messaging_partitions is None and 'premiumMessagingPartitions' in kwargs:
            premium_messaging_partitions = kwargs['premiumMessagingPartitions']
        ...
        if premium_messaging_partitions is not None:
            _setter("premium_messaging_partitions", premium_messaging_partitions)
