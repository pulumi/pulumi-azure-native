...
class ActionArgs:
    ...
    def _configure(
        ...
        if requires_preprocessing is None and 'requiresPreprocessing' in kwargs:
            requires_preprocessing = kwargs['requiresPreprocessing']
...
class CorrelationFilterArgs:
    def __init__(__self__, *,
        ...
        """
        CorrelationFilterArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class SBClientAffinePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        SBClientAffinePropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            client_id=client_id,
    ...
    def _configure(
        ...
        if is_durable is None and 'isDurable' in kwargs:
            is_durable = kwargs['isDurable']
