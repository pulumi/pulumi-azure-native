...
class ActionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 requires_preprocessing: Optional[_builtins.bool] = None,
...
class CorrelationFilterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] properties: dictionary object for custom filters
...
class MessageCountDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float transfer_dead_letter_message_count: Number of messages transferred into dead letters.
        :param _builtins.float transfer_message_count: Number of messages transferred to another queue, topic, or subscription.
        """
...
class SBClientAffinePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_durable: Optional[_builtins.bool] = None,
