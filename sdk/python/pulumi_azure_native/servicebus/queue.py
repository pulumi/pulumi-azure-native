...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus/v20220101preview:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20230101preview:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20240101:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20140901:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20150801:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20170401:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20180101preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20210101preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20210601preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20211101:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20220101preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20221001preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20230101preview:servicebus:Queue"), pulumi.Alias(type_="azure-native_servicebus_v20240101:servicebus:Queue")])
