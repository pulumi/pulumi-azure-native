...
def get_queue_authorization_rule(authorization_rule_name: Optional[_builtins.str] = None,
...
def get_queue_authorization_rule_output(authorization_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus:getQueueAuthorizationRule', __args__, opts=opts, typ=GetQueueAuthorizationRuleResult)
