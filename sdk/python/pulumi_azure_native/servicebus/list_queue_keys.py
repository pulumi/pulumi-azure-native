...
def list_queue_keys(authorization_rule_name: Optional[builtins.str] = None,
...
def list_queue_keys_output(authorization_rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus:listQueueKeys', __args__, opts=opts, typ=ListQueueKeysResult)
    return __ret__.apply(lambda __response__: ListQueueKeysResult(
