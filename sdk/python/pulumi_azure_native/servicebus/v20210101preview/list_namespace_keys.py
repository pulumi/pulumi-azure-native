...
def list_namespace_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20210101preview:listNamespaceKeys', __args__, opts=opts, typ=ListNamespaceKeysResult).value
...
def list_namespace_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20210101preview:listNamespaceKeys', __args__, opts=opts, typ=ListNamespaceKeysResult)
