...
warnings.warn("""azure-native:servicebus/v20210101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DisasterRecoveryConfig is deprecated: azure-native:servicebus/v20210101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20170401:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20211101:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20220101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:DisasterRecoveryConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DisasterRecoveryConfig, __self__).__init__(
            'azure-native:servicebus/v20210101preview:DisasterRecoveryConfig',
            resource_name,
            __props__,
            opts)
