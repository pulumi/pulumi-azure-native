...
def get_disaster_recovery_config(alias: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disaster_recovery_config is deprecated: azure-native:servicebus/v20210101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['alias'] = alias
    __args__['namespaceName'] = namespace_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20210101preview:getDisasterRecoveryConfig', __args__, opts=opts, typ=GetDisasterRecoveryConfigResult).value
