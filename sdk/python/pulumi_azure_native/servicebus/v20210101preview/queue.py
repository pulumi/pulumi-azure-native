...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input['EntityStatus']] = None,
                 __props__=None):
        pulumi.log.warn("""Queue is deprecated: azure-native:servicebus/v20210101preview:Queue is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility.""")
