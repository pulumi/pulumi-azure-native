...
warnings.warn("""azure-native:servicebus/v20210101preview:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subscription(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription is deprecated: azure-native:servicebus/v20210101preview:Subscription is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20210101preview:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
