...
@pulumi.output_type
class DictionaryValueResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DictionaryValueResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DictionaryValueResponse.__key_warning(key)
        return super().__getitem__(key)
...
class IdentityResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_assigned_identities: Optional[Mapping[str, 'outputs.DictionaryValueResponse']] = None):
        """
        Properties to configure User Assigned Identities for Bring your Own Keys
    ...
    def user_assigned_identities(self) -> Optional[Mapping[str, 'outputs.DictionaryValueResponse']]:
        """
