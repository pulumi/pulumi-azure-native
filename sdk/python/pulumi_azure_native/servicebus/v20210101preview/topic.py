...
class Topic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 topic_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Topic is deprecated: azure-native:servicebus/v20210101preview:Topic is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Topic to guarantee forwards compatibility.""")
