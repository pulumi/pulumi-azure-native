...
warnings.warn("""azure-native:servicebus/v20210101preview:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.""", DeprecationWarning)
