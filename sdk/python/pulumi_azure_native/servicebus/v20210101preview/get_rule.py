...
class GetRuleResult:
    ...
    """
    def __init__(__self__, action=None, correlation_filter=None, filter_type=None, id=None, name=None, sql_filter=None, system_data=None, type=None):
...
def get_rule(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rule is deprecated: azure-native:servicebus/v20210101preview:Rule is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20220101preview:Rule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20210101preview:getRule', __args__, opts=opts, typ=GetRuleResult).value
