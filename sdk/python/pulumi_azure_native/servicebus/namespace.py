...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 premium_messaging_partitions: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] alternate_name: Alternate name for namespace
        :param pulumi.Input[builtins.bool] disable_local_auth: This property disables SAS authentication for the Service Bus namespace.
        ...
        :param pulumi.Input[builtins.int] premium_messaging_partitions: The number of partitions of a Service Bus namespace. This property is only applicable to Premium SKU namespaces. The default value is 1 and possible values are 1, 2 and 4
    ...
    def premium_messaging_partitions(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def premium_messaging_partitions(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Namespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sku: Optional[pulumi.Input[Union['SBSkuArgs', 'SBSkuArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 zone_redundant: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus/v20140901:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20150801:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20170401:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20211101:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20220101preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20230101preview:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20240101:Namespace"), pulumi.Alias(type_="azure-native:servicebus/v20250501preview:Namespace")])
    ...
    @property
    @pulumi.getter(name="premiumMessagingPartitions")
    def premium_messaging_partitions(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of partitions of a Service Bus namespace. This property is only applicable to Premium SKU namespaces. The default value is 1 and possible values are 1, 2 and 4
        """
        return pulumi.get(self, "premium_messaging_partitions")
