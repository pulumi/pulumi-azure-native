...
class DisasterRecoveryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] alternate_name: Primary/Secondary eventhub namespace name, which is part of GEO DR pairing
