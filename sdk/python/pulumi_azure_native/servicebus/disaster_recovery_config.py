...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus/v20220101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20230101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20240101:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20170401:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20180101preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20210101preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20210601preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20211101:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20220101preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20221001preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20230101preview:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native_servicebus_v20240101:servicebus:DisasterRecoveryConfig")])
