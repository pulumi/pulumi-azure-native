...
class DisasterRecoveryConfigArgs:
    def __init__(__self__, *,
                 ...
                 partner_namespace: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] alias: The Disaster Recovery configuration name
        :param pulumi.Input[builtins.str] alternate_name: Primary/Secondary eventhub namespace name, which is part of GEO DR pairing
        :param pulumi.Input[builtins.str] partner_namespace: ARM Id of the Primary/Secondary eventhub namespace name, which is part of GEO DR pairing
        """
    ...
    def partner_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partner_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partner_namespace", value)


class DisasterRecoveryConfig(pulumi.CustomResource):

    pulumi_type = "azure-native:servicebus:DisasterRecoveryConfig"
    ...
    @property
    @pulumi.getter(name="partnerNamespace")
    def partner_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM Id of the Primary/Secondary eventhub namespace name, which is part of GEO DR pairing
        """
        return pulumi.get(self, "partner_namespace")
