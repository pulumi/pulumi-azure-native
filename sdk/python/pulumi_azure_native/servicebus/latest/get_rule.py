...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getRule'.""", DeprecationWarning)
...
def get_rule(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:getRule', __args__, opts=opts, typ=GetRuleResult).value
