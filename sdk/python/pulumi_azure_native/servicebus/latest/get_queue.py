...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getQueue'.""", DeprecationWarning)
...
def get_queue(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:getQueue', __args__, opts=opts, typ=GetQueueResult).value
