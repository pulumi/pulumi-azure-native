...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:listDisasterRecoveryConfigKeys'.""", DeprecationWarning)
...
def list_disaster_recovery_config_keys(alias: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_disaster_recovery_config_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:listDisasterRecoveryConfigKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:listDisasterRecoveryConfigKeys', __args__, opts=opts, typ=ListDisasterRecoveryConfigKeysResult).value
