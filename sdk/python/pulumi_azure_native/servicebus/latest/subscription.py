...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:servicebus:Subscription'.""", DeprecationWarning)
...
class Subscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(Subscription, __self__).__init__(
            'azure-native:servicebus/latest:Subscription',
            resource_name,
            __props__,
            opts)
