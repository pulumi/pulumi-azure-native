...
def get_migration_config(config_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str config_name: The configuration name. Should always be "$default".
...
def get_migration_config_output(config_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
