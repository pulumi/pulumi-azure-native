...
class NamespaceVirtualNetworkRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus/v20180101preview:NamespaceVirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:NamespaceVirtualNetworkRule")])
