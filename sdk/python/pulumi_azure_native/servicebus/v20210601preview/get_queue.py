...
def get_queue(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue is deprecated: azure-native:servicebus/v20210601preview:Queue is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Queue to guarantee forwards compatibility.""")
    __args__ = dict()
