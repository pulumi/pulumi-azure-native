...
warnings.warn("""azure-native:servicebus/v20210601preview:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subscription(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription is deprecated: azure-native:servicebus/v20210601preview:Subscription is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Subscription to guarantee forwards compatibility.""")
    __args__ = dict()
