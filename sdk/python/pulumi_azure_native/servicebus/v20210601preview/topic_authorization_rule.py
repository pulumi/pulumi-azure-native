...
class TopicAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 topic_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TopicAuthorizationRule is deprecated: azure-native:servicebus/v20210601preview:TopicAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:TopicAuthorizationRule to guarantee forwards compatibility.""")
