...
warnings.warn("""azure-native:servicebus/v20210601preview:TopicAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:TopicAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_topic_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic_authorization_rule is deprecated: azure-native:servicebus/v20210601preview:TopicAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:TopicAuthorizationRule to guarantee forwards compatibility.""")
    __args__ = dict()
