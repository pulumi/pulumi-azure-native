...
def list_topic_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20210601preview:listTopicKeys', __args__, opts=opts, typ=ListTopicKeysResult).value
...
def list_topic_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20210601preview:listTopicKeys', __args__, opts=opts, typ=ListTopicKeysResult)
