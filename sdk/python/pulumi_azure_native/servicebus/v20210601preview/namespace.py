...
warnings.warn("""azure-native:servicebus/v20210601preview:Namespace is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:Namespace to guarantee forwards compatibility.""", DeprecationWarning)
