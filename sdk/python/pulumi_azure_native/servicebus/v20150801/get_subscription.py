...
def get_subscription(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription is deprecated: Version 2015-08-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20150801:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
