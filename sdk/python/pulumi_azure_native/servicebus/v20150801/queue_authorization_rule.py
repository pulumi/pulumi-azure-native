...
class QueueAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rights: Optional[pulumi.Input[Sequence[pulumi.Input['AccessRights']]]] = None,
                 __props__=None):
        pulumi.log.warn("""QueueAuthorizationRule is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20140901:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20170401:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20211101:QueueAuthorizationRule")])
