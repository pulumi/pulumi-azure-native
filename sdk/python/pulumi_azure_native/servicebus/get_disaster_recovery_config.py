...
def get_disaster_recovery_config(alias: Optional[_builtins.str] = None,
    ...
    :param _builtins.str alias: The Disaster Recovery configuration name
...
def get_disaster_recovery_config_output(alias: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus:getDisasterRecoveryConfig', __args__, opts=opts, typ=GetDisasterRecoveryConfigResult)
