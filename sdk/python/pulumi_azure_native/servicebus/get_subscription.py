...
class GetSubscriptionResult:
    ...
    def dead_lettering_on_filter_evaluation_exceptions(self) -> Optional[_builtins.bool]:
        """
...
def get_subscription(namespace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str subscription_name: The subscription name.
    :param _builtins.str topic_name: The topic name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
...
def get_subscription_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult)
