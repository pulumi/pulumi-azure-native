...
def get_migration_config(config_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20170401:getMigrationConfig', __args__, opts=opts, typ=GetMigrationConfigResult).value
...
def get_migration_config_output(config_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20170401:getMigrationConfig', __args__, opts=opts, typ=GetMigrationConfigResult)
