...
warnings.warn("""azure-native:servicebus/v20170401:QueueAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_queue_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue_authorization_rule is deprecated: azure-native:servicebus/v20170401:QueueAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20170401:getQueueAuthorizationRule', __args__, opts=opts, typ=GetQueueAuthorizationRuleResult).value
