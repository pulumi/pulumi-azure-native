...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        disaster_recovery_config = azure_native.servicebus.v20170401.DisasterRecoveryConfig("disasterRecoveryConfig",
