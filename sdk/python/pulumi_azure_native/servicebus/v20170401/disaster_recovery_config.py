...
class DisasterRecoveryConfig(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['role'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/latest:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus/latest:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:DisasterRecoveryConfig")])
