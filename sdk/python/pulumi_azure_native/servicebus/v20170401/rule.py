...
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rule = azure_native.servicebus.v20170401.Rule("rule",
            correlation_filter=azure_native.servicebus.v20170401.CorrelationFilterArgs(
                properties={
                    "topicHint": "Crop",
                },
            ),
            filter_type=azure_native.servicebus/v20170401.FilterType.CORRELATION_FILTER,
        ...
        rule = azure_native.servicebus.v20170401.Rule("rule",
            filter_type=azure_native.servicebus/v20170401.FilterType.SQL_FILTER,
            namespace_name="sdk-Namespace-1319",
            resource_group_name="resourceGroupName",
            rule_name="sdk-Rules-6571",
            sql_filter=azure_native.servicebus.v20170401.SqlFilterArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicebus:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20210601preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20211101:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20220101preview:Rule"), pulumi.Alias(type_="azure-native:servicebus/v20221001preview:Rule")])
