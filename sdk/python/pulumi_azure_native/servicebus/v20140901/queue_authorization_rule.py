...
class QueueAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 secondary_key: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""QueueAuthorizationRule is deprecated: Version v20140901 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
        if opts is None:
