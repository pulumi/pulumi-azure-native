...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:servicebus/v20180101preview:DisasterRecoveryConfig":
                return DisasterRecoveryConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:MigrationConfig":
                return MigrationConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:NamespaceIpFilterRule":
                return NamespaceIpFilterRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:NamespaceNetworkRuleSet":
                return NamespaceNetworkRuleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:NamespaceVirtualNetworkRule":
                return NamespaceVirtualNetworkRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:QueueAuthorizationRule":
                return QueueAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:Rule":
                return Rule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:Subscription":
                return Subscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:Topic":
                return Topic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20180101preview:TopicAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "servicebus/v20180101preview", _module_instance)
