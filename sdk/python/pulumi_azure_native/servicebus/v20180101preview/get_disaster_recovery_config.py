...
warnings.warn("""azure-native:servicebus/v20180101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disaster_recovery_config(alias: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disaster_recovery_config is deprecated: azure-native:servicebus/v20180101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""")
    __args__ = dict()
