...
def list_queue_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/v20180101preview:listQueueKeys', __args__, opts=opts, typ=ListQueueKeysResult).value
...
def list_queue_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicebus/v20180101preview:listQueueKeys', __args__, opts=opts, typ=ListQueueKeysResult)
