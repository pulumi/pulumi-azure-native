...
warnings.warn("""azure-native:servicebus/v20211101:NamespaceAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:NamespaceAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
