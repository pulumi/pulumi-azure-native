...
warnings.warn("""azure-native:servicebus/v20211101:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_queue_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue_authorization_rule is deprecated: azure-native:servicebus/v20211101:QueueAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:servicebus/v20220101preview:QueueAuthorizationRule to guarantee forwards compatibility.""")
    __args__ = dict()
