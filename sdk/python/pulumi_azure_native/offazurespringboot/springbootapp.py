...
class SpringbootappArgs:
    ...
    def springbootapps_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def springbootapps_name(self, value: Optional[pulumi.Input[str]]):
...
class Springbootapp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot:springbootapp"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:Springbootapp"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:springbootapp")])
