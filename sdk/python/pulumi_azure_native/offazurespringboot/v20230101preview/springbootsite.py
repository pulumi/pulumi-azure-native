...
class Springbootsite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot:Springbootsite"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:Springbootsite")])
