...
def get_springbootserver_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['springbootserversName'] = springbootservers_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazurespringboot/v20230101preview:getSpringbootserver', __args__, opts=opts, typ=GetSpringbootserverResult)
