...
def get_springbootapp(resource_group_name: Optional[_builtins.str] = None,
                      site_name: Optional[_builtins.str] = None,
                      springbootapps_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str springbootapps_name: The springbootapps name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazurespringboot:getSpringbootapp', __args__, opts=opts, typ=GetSpringbootappResult).value
...
def get_springbootapp_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
