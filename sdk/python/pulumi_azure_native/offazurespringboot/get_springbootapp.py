...
def get_springbootapp(resource_group_name: Optional[builtins.str] = None,
                      site_name: Optional[builtins.str] = None,
                      springbootapps_name: Optional[builtins.str] = None,
    ...
    :param builtins.str springbootapps_name: The springbootapps name.
    """
    __args__ = dict()
...
def get_springbootapp_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
