...
class ErrorResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 possible_causes: Optional[_builtins.str] = None,
        ...
        :param _builtins.str possible_causes: The error possible causes.
        :param _builtins.str recommended_action: The error recommended action
        :param _builtins.str run_as_account_id: The account ID used to login.
        :param _builtins.str severity: The error severity
...
class SpringbootappsPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 binding_ports: Optional[Sequence[_builtins.int]] = None,
                 build_jdk_version: Optional[_builtins.str] = None,
                 certificates: Optional[Sequence[_builtins.str]] = None,
                 checksum: Optional[_builtins.str] = None,
                 connection_strings: Optional[Sequence[_builtins.str]] = None,
                 ...
                 jar_file_location: Optional[_builtins.str] = None,
                 jvm_memory_in_mb: Optional[_builtins.int] = None,
                 jvm_options: Optional[Sequence[_builtins.str]] = None,
                 labels: Optional[Mapping[str, _builtins.str]] = None,
                 last_modified_time: Optional[_builtins.str] = None,
                 last_updated_time: Optional[_builtins.str] = None,
                 machine_arm_ids: Optional[Sequence[_builtins.str]] = None,
                 miscs: Optional[Sequence['outputs.SpringbootappsPropertiesResponseMiscs']] = None,
                 runtime_jdk_version: Optional[_builtins.str] = None,
                 servers: Optional[Sequence[_builtins.str]] = None,
                 spring_boot_version: Optional[_builtins.str] = None,
        ...
        :param _builtins.str app_type: The application type, whether it is a SpringBoot app.
        ...
        :param _builtins.str artifact_name: The artifact name of SpringBootApp.
        :param Sequence[_builtins.int] binding_ports: The application binding port list.
        :param _builtins.str build_jdk_version: The jdk version in build.
        :param Sequence[_builtins.str] certificates: The certificate file list.
        :param _builtins.str checksum: The checksum of jar file.
        :param Sequence[_builtins.str] connection_strings: The connection string list.
        :param Sequence[_builtins.str] dependencies: The dependency list.
        :param Sequence[_builtins.str] environments: The environment variable list.
        :param Sequence['ErrorResponse'] errors: The list of errors.
        :param _builtins.int instance_count: The total instance count the app deployed.
        ...
        :param _builtins.str jar_file_location: The jar file location on the server.
        :param _builtins.int jvm_memory_in_mb: The jvm heap memory allocated.
        :param Sequence[_builtins.str] jvm_options: The jvm options.
        :param Mapping[str, _builtins.str] labels: Resource labels
        :param _builtins.str last_modified_time: Time when this springbootapps jar file was last modified.
        :param _builtins.str last_updated_time: Time when this springbootapps instance was last refreshed.
        :param Sequence[_builtins.str] machine_arm_ids: The machine ARM id list the app belongs to.
        :param Sequence['SpringbootappsPropertiesResponseMiscs'] miscs: The other types of date collected.
        :param _builtins.str runtime_jdk_version: The jdk version installed on server
        :param Sequence[_builtins.str] servers: The server list the app installed
        :param _builtins.str spring_boot_version: The spring boot version.
        :param Sequence[_builtins.str] static_content_locations: The static content location list.
        """
...
class SpringbootappsPropertiesResponseApplicationConfigurations(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: The application config file name.
        :param _builtins.str value: The application config file content, only contains config keys.
        """
...
class SpringbootappsPropertiesResponseInstances(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jvm_memory_in_mb: Optional[_builtins.int] = None):
        """
        :param _builtins.str machine_arm_id: The machine ARM resource Id of this app instance
        :param _builtins.int instance_count: The instance count of this app instance
        :param _builtins.int jvm_memory_in_mb: The jvm heap memory allocated of this app instance
        """
...
class SpringbootappsPropertiesResponseMiscs(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: The miscs. key.
        :param _builtins.str value: The miscs. value.
        """
        pulumi.set(__self__, "key", key)
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class SpringbootserversPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 errors: Optional[Sequence['outputs.ErrorResponse']] = None,
                 fqdn_and_ip_address_list: Optional[Sequence[_builtins.str]] = None,
                 labels: Optional[Mapping[str, _builtins.str]] = None,
                 machine_arm_id: Optional[_builtins.str] = None,
                 port: Optional[_builtins.int] = None,
                 provisioning_state: Optional[_builtins.str] = None,
                 spring_boot_apps: Optional[_builtins.int] = None,
        ...
        :param Mapping[str, _builtins.str] labels: Resource labels
        :param _builtins.str machine_arm_id: The machine Id from ARM
        :param _builtins.int port: Target server port for remote login
        :param _builtins.str provisioning_state: The resource provisioning state.
        :param _builtins.int spring_boot_apps: The total number of spring boot apps been discovered
        :param _builtins.int total_apps: The total number of apps been discovered
        """
...
class SpringbootsitesPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 master_site_id: Optional[_builtins.str] = None,
                 migrate_project_id: Optional[_builtins.str] = None,
                 provisioning_state: Optional[_builtins.str] = None):
        """
        The springbootsites resource definition.
