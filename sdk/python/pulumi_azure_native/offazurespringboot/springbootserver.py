...
class Springbootserver(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['SpringbootserversPropertiesArgs', 'SpringbootserversPropertiesArgsDict']] properties: The springbootservers resource definition.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] site_name: The springbootsites name.
        :param pulumi.Input[str] springbootservers_name: The springbootservers name.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:springbootserver")])
