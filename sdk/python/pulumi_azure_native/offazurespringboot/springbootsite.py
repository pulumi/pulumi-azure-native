...
class SpringbootsiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] springbootsites_name: The springbootsites name.
    ...
    def springbootsites_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def springbootsites_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Springbootsite(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:offazurespringboot:Springbootsite"
