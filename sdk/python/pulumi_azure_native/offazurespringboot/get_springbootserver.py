...
def get_springbootserver(resource_group_name: Optional[builtins.str] = None,
                         site_name: Optional[builtins.str] = None,
                         springbootservers_name: Optional[builtins.str] = None,
    ...
    :param builtins.str site_name: The springbootsites name.
    :param builtins.str springbootservers_name: The springbootservers name.
    """
    __args__ = dict()
...
def get_springbootserver_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
