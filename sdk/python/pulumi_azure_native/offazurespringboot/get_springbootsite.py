...
def get_springbootsite(resource_group_name: Optional[_builtins.str] = None,
                       springbootsites_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str springbootsites_name: The springbootsites name.
    """
    __args__ = dict()
...
def get_springbootsite_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                              springbootsites_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazurespringboot:getSpringbootsite', __args__, opts=opts, typ=GetSpringbootsiteResult)
