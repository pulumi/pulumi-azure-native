...
def get_springbootsite_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                              springbootsites_name: Optional[pulumi.Input[_builtins.str]] = None,
