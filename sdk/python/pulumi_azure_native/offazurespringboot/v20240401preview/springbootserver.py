...
class Springbootserver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot:springbootserver")])
