...
class Springbootserver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot:springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:Springbootserver"), pulumi.Alias(type_="azure-native:offazurespringboot/v20230101preview:springbootserver")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Springbootserver, __self__).__init__(
            'azure-native:offazurespringboot/v20240401preview:Springbootserver',
            resource_name,
            __props__,
            opts)
