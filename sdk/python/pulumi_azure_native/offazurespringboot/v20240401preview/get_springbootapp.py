...
def get_springbootapp(resource_group_name: Optional[str] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSpringbootappResult:
    """
    ...
    :param str springbootapps_name: The springbootapps name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazurespringboot/v20240401preview:getSpringbootapp', __args__, opts=opts, typ=GetSpringbootappResult).value

    return AwaitableGetSpringbootappResult(
...
def get_springbootapp_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['springbootappsName'] = springbootapps_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazurespringboot/v20240401preview:getSpringbootapp', __args__, opts=opts, typ=GetSpringbootappResult)
