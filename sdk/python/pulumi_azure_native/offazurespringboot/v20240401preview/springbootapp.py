...
class Springbootapp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazurespringboot/v20240401preview:springbootapp"), pulumi.Alias(type_="azure-native:offazurespringboot:Springbootapp"), pulumi.Alias(type_="azure-native:offazurespringboot:springbootapp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Springbootapp, __self__).__init__(
            'azure-native:offazurespringboot/v20240401preview:Springbootapp',
            resource_name,
            __props__,
            opts)
