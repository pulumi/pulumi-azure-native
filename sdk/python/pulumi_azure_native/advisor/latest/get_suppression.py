...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:advisor:getSuppression'.""", DeprecationWarning)
...
def get_suppression(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:advisor/latest:getSuppression', __args__, opts=opts, typ=GetSuppressionResult).value
