...
def get_suppression(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:advisor/v20250101:getSuppression', __args__, opts=opts, typ=GetSuppressionResult).value
...
def get_suppression_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:advisor/v20250101:getSuppression', __args__, opts=opts, typ=GetSuppressionResult)
