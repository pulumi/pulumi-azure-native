...
def get_suppression(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_suppression is deprecated: azure-native:advisor/v20200101:Suppression is being removed in the next major version of this provider. Upgrade to at least azure-native:advisor/v20230101:Suppression to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
