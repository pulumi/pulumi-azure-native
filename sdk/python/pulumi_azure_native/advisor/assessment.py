...
class Assessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:advisor/v20230901preview:Assessment"), pulumi.Alias(type_="azure-native:advisor/v20241118preview:Assessment"), pulumi.Alias(type_="azure-native:advisor/v20250501preview:Assessment")])
