...
warnings.warn("""azure-native:advisor/v20220901:Suppression is being removed in the next major version of this provider. Upgrade to at least azure-native:advisor/v20221001:Suppression to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_suppression(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_suppression is deprecated: azure-native:advisor/v20220901:Suppression is being removed in the next major version of this provider. Upgrade to at least azure-native:advisor/v20221001:Suppression to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['recommendationId'] = recommendation_id
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:advisor/v20220901:getSuppression', __args__, opts=opts, typ=GetSuppressionResult).value
