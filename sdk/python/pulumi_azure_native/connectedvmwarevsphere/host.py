...
class HostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host_name: Name of the host.
        :param pulumi.Input[builtins.str] inventory_item_id: Gets or sets the inventory Item ID for the host.
        ...
        :param pulumi.Input[builtins.str] mo_ref_id: Gets or sets the vCenter MoRef (Managed Object Reference) ID for the host.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Gets or sets the Resource tags.
        :param pulumi.Input[builtins.str] v_center_id: Gets or sets the ARM Id of the vCenter resource in which this host resides.
        """
...
class Host(pulumi.CustomResource):
    ...
    def cpu_mhz(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def memory_size_gb(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def overall_cpu_usage_m_hz(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def overall_memory_usage_gb(self) -> pulumi.Output[builtins.float]:
        """
