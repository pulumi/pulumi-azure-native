...
def get_guest_agent(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the GuestAgent.
...
def get_guest_agent_output(name: Optional[pulumi.Input[builtins.str]] = None,
