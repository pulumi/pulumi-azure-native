...
class VirtualMachineTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] inventory_item_id: Gets or sets the inventory Item ID for the virtual machine template.
        ...
        :param pulumi.Input[_builtins.str] virtual_machine_template_name: Name of the virtual machine template resource.
        """
    ...
    def virtual_machine_template_name(self, value: Optional[pulumi.Input[_builtins.str]]):
