...
class GetDatastoreResult:
    ...
    def free_space_gb(self) -> builtins.float:
        """
...
def get_datastore(datastore_name: Optional[builtins.str] = None,
    ...
    :param builtins.str datastore_name: Name of the datastore.
...
def get_datastore_output(datastore_name: Optional[pulumi.Input[builtins.str]] = None,
