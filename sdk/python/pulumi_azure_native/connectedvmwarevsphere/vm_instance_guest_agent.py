...
class VMInstanceGuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231201:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:VMInstanceGuestAgent")])
