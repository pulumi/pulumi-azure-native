...
def get_machine_extension(extension_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str virtual_machine_name: The name of the machine containing the extension.
    """
    __args__ = dict()
...
def get_machine_extension_output(extension_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult)
