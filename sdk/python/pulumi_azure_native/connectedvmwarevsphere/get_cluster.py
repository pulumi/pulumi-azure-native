...
class GetClusterResult:
    ...
    Define the cluster.
    """
    def __init__(__self__, azure_api_version=None, custom_resource_name=None, datastore_ids=None, extended_location=None, id=None, inventory_item_id=None, kind=None, location=None, mo_name=None, mo_ref_id=None, name=None, network_ids=None, provisioning_state=None, statuses=None, system_data=None, tags=None, total_cpu_m_hz=None, total_memory_gb=None, type=None, used_cpu_m_hz=None, used_memory_gb=None, uuid=None, v_center_id=None):
    ...
    def total_cpu_m_hz(self) -> builtins.float:
        """
    ...
    def used_cpu_m_hz(self) -> builtins.float:
        """
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere:getCluster', __args__, opts=opts, typ=GetClusterResult)
