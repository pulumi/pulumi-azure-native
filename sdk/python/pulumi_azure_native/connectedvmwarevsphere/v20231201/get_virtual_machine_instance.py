...
def get_virtual_machine_instance(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20231201:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult).value
...
def get_virtual_machine_instance_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20231201:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult)
