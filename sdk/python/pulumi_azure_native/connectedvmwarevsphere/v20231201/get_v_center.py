...
def get_v_center(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20231201:getVCenter', __args__, opts=opts, typ=GetVCenterResult).value
...
def get_v_center_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20231201:getVCenter', __args__, opts=opts, typ=GetVCenterResult)
