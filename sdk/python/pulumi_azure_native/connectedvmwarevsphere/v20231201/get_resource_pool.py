...
class GetResourcePoolResult:
    ...
    """
    def __init__(__self__, cpu_capacity_m_hz=None, cpu_limit_m_hz=None, cpu_overall_usage_m_hz=None, cpu_reservation_m_hz=None, cpu_shares_level=None, custom_resource_name=None, datastore_ids=None, extended_location=None, id=None, inventory_item_id=None, kind=None, location=None, mem_capacity_gb=None, mem_limit_mb=None, mem_overall_usage_gb=None, mem_reservation_mb=None, mem_shares_level=None, mo_name=None, mo_ref_id=None, name=None, network_ids=None, provisioning_state=None, statuses=None, system_data=None, tags=None, type=None, uuid=None, v_center_id=None):
...
def get_resource_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20231201:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult).value
...
def get_resource_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourcePoolName'] = resource_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20231201:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult)
