...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cluster = azure_native.connectedvmwarevsphere.v20201001preview.Cluster("cluster",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:Cluster")])
