...
warnings.warn("""azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualMachineTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_machine_template_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachineTemplate is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate to guarantee forwards compatibility.""")
