...
class VCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vcenter_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VCenter is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:VCenter")])
