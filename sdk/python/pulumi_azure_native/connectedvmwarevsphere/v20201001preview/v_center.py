...
class VCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        v_center = azure_native.connectedvmwarevsphere.v20201001preview.VCenter("vCenter",
            credentials=azure_native.connectedvmwarevsphere.v20201001preview.VICredentialArgs(
                password="<password>",
                username="tempuser",
            ),
