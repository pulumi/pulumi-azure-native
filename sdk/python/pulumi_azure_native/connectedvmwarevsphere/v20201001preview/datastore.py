...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_center_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Datastore is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:Datastore"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:Datastore")])
