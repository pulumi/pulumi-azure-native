...
warnings.warn("""azure-native:connectedvmwarevsphere/v20201001preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.""", DeprecationWarning)
...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_center_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Datastore is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.""")
        ...
        super(Datastore, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20201001preview:Datastore',
            resource_name,
            __props__,
            opts)
