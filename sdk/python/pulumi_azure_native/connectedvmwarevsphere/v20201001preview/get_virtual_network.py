...
def get_virtual_network_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20201001preview:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult)
