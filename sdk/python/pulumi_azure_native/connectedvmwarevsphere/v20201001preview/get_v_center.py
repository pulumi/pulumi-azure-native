...
def get_v_center(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_v_center is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:VCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VCenter to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20201001preview:getVCenter', __args__, opts=opts, typ=GetVCenterResult).value
