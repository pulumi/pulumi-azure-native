...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine = azure_native.connectedvmwarevsphere.v20201001preview.VirtualMachine("virtualMachine",
            extended_location=azure_native.connectedvmwarevsphere.v20201001preview.ExtendedLocationArgs(
                name="/subscriptions/a5015e1c-867f-4533-8541-85cd470d0cfb/resourceGroups/demoRG/providers/Microsoft.ExtendedLocation/customLocations/contoso",
                type="customLocation",
            ),
            hardware_profile=azure_native.connectedvmwarevsphere.v20201001preview.HardwareProfileArgs(
                memory_size_mb=4196,
                num_cpus=4,
            ),
            location="East US",
