...
warnings.warn("""azure-native:connectedvmwarevsphere/v20201001preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.""", DeprecationWarning)
...
class Host(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_center_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Host is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:Host"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:Host"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:Host")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Host, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20201001preview:Host',
            resource_name,
            __props__,
            opts)
