...
def get_virtual_machine_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20201001preview:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult)
