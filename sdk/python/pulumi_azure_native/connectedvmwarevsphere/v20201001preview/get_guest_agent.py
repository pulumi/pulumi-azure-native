...
warnings.warn("""azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_guest_agent(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_agent is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualMachineName'] = virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20201001preview:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult).value
