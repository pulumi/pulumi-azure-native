...
class GuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_machine_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GuestAgent is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestAgent, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent',
            resource_name,
            __props__,
            opts)
