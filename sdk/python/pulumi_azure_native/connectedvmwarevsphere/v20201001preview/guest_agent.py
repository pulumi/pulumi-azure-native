...
class GuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent")])
