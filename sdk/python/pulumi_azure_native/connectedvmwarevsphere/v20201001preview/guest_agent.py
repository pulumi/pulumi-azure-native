...
class GuestAgent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        guest_agent = azure_native.connectedvmwarevsphere.v20201001preview.GuestAgent("guestAgent",
            credentials=azure_native.connectedvmwarevsphere.v20201001preview.GuestCredentialArgs(
                password="<password>",
                username="tempuser",
            ),
            http_proxy_config=azure_native.connectedvmwarevsphere.v20201001preview.HttpProxyConfigurationArgs(
