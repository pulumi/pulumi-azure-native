...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HybridIdentityMetadatum is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
        if opts is None:
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:HybridIdentityMetadatum")])
