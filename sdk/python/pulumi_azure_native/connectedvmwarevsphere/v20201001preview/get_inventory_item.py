...
def get_inventory_item(inventory_item_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_inventory_item is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:InventoryItem is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:InventoryItem to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['inventoryItemName'] = inventory_item_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20201001preview:getInventoryItem', __args__, opts=opts, typ=GetInventoryItemResult).value
