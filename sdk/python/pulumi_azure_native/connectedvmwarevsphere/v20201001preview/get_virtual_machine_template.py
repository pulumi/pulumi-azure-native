...
def get_virtual_machine_template(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_template is deprecated: azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachineTemplate is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate to guarantee forwards compatibility.""")
    __args__ = dict()
