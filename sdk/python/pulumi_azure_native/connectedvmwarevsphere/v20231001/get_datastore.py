...
def get_datastore(datastore_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20231001:getDatastore', __args__, opts=opts, typ=GetDatastoreResult).value
    ...
    return AwaitableGetDatastoreResult(
        ...
        free_space_gb=pulumi.get(__ret__, 'free_space_gb'),
...
def get_datastore_output(datastore_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20231001:getDatastore', __args__, opts=opts, typ=GetDatastoreResult)
    return __ret__.apply(lambda __response__: GetDatastoreResult(
        ...
        free_space_gb=pulumi.get(__response__, 'free_space_gb'),
