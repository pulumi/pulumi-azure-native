...
class VCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231201:VCenter"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VCenter")])
