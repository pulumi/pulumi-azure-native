...
def get_resource_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20231001:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult).value
...
def get_resource_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourcePoolName'] = resource_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20231001:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult)
