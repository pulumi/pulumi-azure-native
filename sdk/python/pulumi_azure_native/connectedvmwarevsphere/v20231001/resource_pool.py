...
class ResourcePoolArgs:
    ...
    def _configure(
        ...
        if resource_pool_name is None and 'resourcePoolName' in kwargs:
            resource_pool_name = kwargs['resourcePoolName']
        ...
        if resource_pool_name is not None:
            _setter("resource_pool_name", resource_pool_name)
        if tags is not None:
            _setter("tags", tags)
