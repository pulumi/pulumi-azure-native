...
class ResourcePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231201:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere:ResourcePool")])
