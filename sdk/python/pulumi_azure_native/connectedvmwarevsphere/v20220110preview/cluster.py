...
warnings.warn("""azure-native:connectedvmwarevsphere/v20220110preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_center_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Cluster is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:Cluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cluster, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20220110preview:Cluster',
            resource_name,
            __props__,
            opts)
