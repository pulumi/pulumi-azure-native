...
def get_v_center(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20220110preview:getVCenter', __args__, opts=opts, typ=GetVCenterResult).value
...
def get_v_center_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20220110preview:getVCenter', __args__, opts=opts, typ=GetVCenterResult)
