...
warnings.warn("""azure-native:connectedvmwarevsphere/v20220110preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_host(host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Host is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Host to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['hostName'] = host_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20220110preview:getHost', __args__, opts=opts, typ=GetHostResult).value
