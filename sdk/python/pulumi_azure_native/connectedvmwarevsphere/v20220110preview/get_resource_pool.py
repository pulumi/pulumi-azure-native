...
warnings.warn("""azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool is being removed in the next major version of this provider. Please upgrade to azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_resource_pool(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_pool is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool is being removed in the next major version of this provider. Please upgrade to azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourcePoolName'] = resource_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20220110preview:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult).value
