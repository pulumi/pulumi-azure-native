...
warnings.warn("""azure-native:connectedvmwarevsphere/v20220110preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_datastore(datastore_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_datastore is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:connectedvmwarevsphere/v20220715preview:Datastore to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['datastoreName'] = datastore_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20220110preview:getDatastore', __args__, opts=opts, typ=GetDatastoreResult).value
