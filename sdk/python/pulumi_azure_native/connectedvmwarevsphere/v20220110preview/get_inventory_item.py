...
def get_inventory_item_output(inventory_item_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20220110preview:getInventoryItem', __args__, opts=opts, typ=GetInventoryItemResult)
