...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: azure-native:connectedvmwarevsphere/v20220110preview:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:connectedvmwarevsphere/v20220715preview:Cluster to guarantee forwards compatibility.""")
    __args__ = dict()
