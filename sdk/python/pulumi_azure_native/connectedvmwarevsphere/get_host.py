...
class GetHostResult:
    ...
    Define the host.
    """
    def __init__(__self__, azure_api_version=None, cpu_mhz=None, custom_resource_name=None, datastore_ids=None, extended_location=None, id=None, inventory_item_id=None, kind=None, location=None, memory_size_gb=None, mo_name=None, mo_ref_id=None, name=None, network_ids=None, overall_cpu_usage_m_hz=None, overall_memory_usage_gb=None, provisioning_state=None, statuses=None, system_data=None, tags=None, type=None, uuid=None, v_center_id=None):
    ...
    def cpu_mhz(self) -> builtins.float:
        """
    ...
    def overall_cpu_usage_m_hz(self) -> builtins.float:
        """
    ...
    def overall_memory_usage_gb(self) -> builtins.float:
        """
...
def get_host(host_name: Optional[builtins.str] = None,
    ...
    :param builtins.str host_name: Name of the host.
...
def get_host_output(host_name: Optional[pulumi.Input[builtins.str]] = None,
