...
def get_host(host_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str host_name: Name of the host.
...
def get_host_output(host_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
