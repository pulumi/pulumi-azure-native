...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231001:Cluster"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231201:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:Cluster"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:Cluster")])
