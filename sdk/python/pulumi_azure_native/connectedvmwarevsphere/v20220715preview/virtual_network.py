...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network = azure_native.connectedvmwarevsphere.v20220715preview.VirtualNetwork("virtualNetwork",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VirtualNetwork"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:VirtualNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetwork, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20220715preview:VirtualNetwork',
            resource_name,
            __props__,
            opts)
