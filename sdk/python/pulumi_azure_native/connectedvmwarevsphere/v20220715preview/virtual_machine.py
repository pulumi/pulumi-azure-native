...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine = azure_native.connectedvmwarevsphere.v20220715preview.VirtualMachine("virtualMachine",
            extended_location=azure_native.connectedvmwarevsphere.v20220715preview.ExtendedLocationArgs(
                name="/subscriptions/a5015e1c-867f-4533-8541-85cd470d0cfb/resourceGroups/demoRG/providers/Microsoft.ExtendedLocation/customLocations/contoso",
                type="customLocation",
            ),
            hardware_profile=azure_native.connectedvmwarevsphere.v20220715preview.HardwareProfileArgs(
                memory_size_mb=4196,
                num_cpus=4,
            ),
            location="East US",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:VirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachine, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachine',
            resource_name,
            __props__,
            opts)
