...
class VirtualMachineTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_template = azure_native.connectedvmwarevsphere.v20220715preview.VirtualMachineTemplate("virtualMachineTemplate",
    ...
    def _internal_init(__self__,
        ...
        super(VirtualMachineTemplate, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate',
            resource_name,
            __props__,
            opts)
