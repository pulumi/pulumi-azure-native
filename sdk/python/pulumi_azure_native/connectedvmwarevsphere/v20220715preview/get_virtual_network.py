...
def get_virtual_network(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20220715preview:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
