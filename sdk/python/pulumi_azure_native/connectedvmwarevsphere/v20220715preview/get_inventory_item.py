...
def get_inventory_item_output(inventory_item_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20220715preview:getInventoryItem', __args__, opts=opts, typ=GetInventoryItemResult)
