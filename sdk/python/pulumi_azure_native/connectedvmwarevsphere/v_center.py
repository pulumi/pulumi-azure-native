...
class VCenterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: Gets or sets the FQDN/IPAddress of the vCenter.
        ...
        :param pulumi.Input[builtins.int] port: Gets or sets the port of the vCenter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Gets or sets the Resource tags.
        :param pulumi.Input[builtins.str] vcenter_name: Name of the vCenter.
        """
    ...
    def vcenter_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the vCenter.
        """
    ...
    @vcenter_name.setter
    def vcenter_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vcenter_name", value)


class VCenter(pulumi.CustomResource):

    pulumi_type = "azure-native:connectedvmwarevsphere:VCenter"
    ...
    def instance_uuid(self) -> pulumi.Output[builtins.str]:
        """
