...
class GuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:GuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:GuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:GuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:GuestAgent"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:GuestAgent")])
