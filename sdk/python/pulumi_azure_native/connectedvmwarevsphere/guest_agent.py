...
class GuestAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the guestAgents.
...
class GuestAgent(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:connectedvmwarevsphere:GuestAgent"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:GuestAgent")])
