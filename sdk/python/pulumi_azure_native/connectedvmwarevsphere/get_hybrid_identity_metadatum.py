...
class GetHybridIdentityMetadatumResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, identity=None, name=None, provisioning_state=None, public_key=None, system_data=None, type=None, vm_id=None):
