...
class DatastoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] inventory_item_id: Gets or sets the inventory Item ID for the datastore.
        ...
        :param pulumi.Input[builtins.str] mo_ref_id: Gets or sets the vCenter MoRef (Managed Object Reference) ID for the datastore.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Gets or sets the Resource tags.
        :param pulumi.Input[builtins.str] v_center_id: Gets or sets the ARM Id of the vCenter resource in which this datastore resides.
        """
...
class Datastore(pulumi.CustomResource):
    ...
    def capacity_gb(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def free_space_gb(self) -> pulumi.Output[builtins.float]:
        """
