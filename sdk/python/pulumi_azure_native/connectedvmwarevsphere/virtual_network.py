...
class VirtualNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] inventory_item_id: Gets or sets the inventory Item ID for the virtual network.
        ...
        :param pulumi.Input[builtins.str] mo_ref_id: Gets or sets the vCenter MoRef (Managed Object Reference) ID for the virtual network.
        ...
        :param pulumi.Input[builtins.str] virtual_network_name: Name of the virtual network resource.
        """
...
class VirtualNetwork(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:connectedvmwarevsphere:VirtualNetwork"
