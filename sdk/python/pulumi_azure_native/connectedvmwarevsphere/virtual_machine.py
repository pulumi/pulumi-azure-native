...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachine"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:VirtualMachine"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:VirtualMachine"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:VirtualMachine"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:VirtualMachine")])
