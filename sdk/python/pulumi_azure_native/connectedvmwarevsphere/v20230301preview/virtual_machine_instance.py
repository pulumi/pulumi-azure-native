...
class VirtualMachineInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231001:VirtualMachineInstance")])
