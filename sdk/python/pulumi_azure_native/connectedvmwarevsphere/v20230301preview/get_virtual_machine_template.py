...
def get_virtual_machine_template(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20230301preview:getVirtualMachineTemplate', __args__, opts=opts, typ=GetVirtualMachineTemplateResult).value
...
def get_virtual_machine_template_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualMachineTemplateName'] = virtual_machine_template_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:connectedvmwarevsphere/v20230301preview:getVirtualMachineTemplate', __args__, opts=opts, typ=GetVirtualMachineTemplateResult)
