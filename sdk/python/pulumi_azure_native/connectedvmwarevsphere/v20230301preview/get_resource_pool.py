...
def get_resource_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20230301preview:getResourcePool', __args__, opts=opts, typ=GetResourcePoolResult).value

    return AwaitableGetResourcePoolResult(
        cpu_capacity_m_hz=__ret__.cpu_capacity_m_hz,
        cpu_limit_m_hz=__ret__.cpu_limit_m_hz,
        cpu_overall_usage_m_hz=__ret__.cpu_overall_usage_m_hz,
        ...
        mem_capacity_gb=__ret__.mem_capacity_gb,
        mem_limit_mb=__ret__.mem_limit_mb,
        mem_overall_usage_gb=__ret__.mem_overall_usage_gb,
