...
class VirtualMachineArgs:
    ...
    def _configure(
        ...
        if guest_agent_profile is None and 'guestAgentProfile' in kwargs:
        ...
        if smbios_uuid is None and 'smbiosUuid' in kwargs:
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            guest_agent_profile = _utilities.configure(guest_agent_profile, GuestAgentProfileArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:VirtualMachine"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachine, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachine',
            resource_name,
            __props__,
            opts)
