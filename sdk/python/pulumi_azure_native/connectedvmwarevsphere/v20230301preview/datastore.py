...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere:Datastore"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20201001preview:Datastore"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220110preview:Datastore"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:Datastore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Datastore, __self__).__init__(
            'azure-native:connectedvmwarevsphere/v20230301preview:Datastore',
            resource_name,
            __props__,
            opts)
