...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedvmwarevsphere/v20230301preview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
    ...
    return AwaitableGetClusterResult(
        ...
        tags=__ret__.tags,
        total_cpu_m_hz=__ret__.total_cpu_m_hz,
        total_memory_gb=__ret__.total_memory_gb,
        type=__ret__.type,
        used_cpu_m_hz=__ret__.used_cpu_m_hz,
        used_memory_gb=__ret__.used_memory_gb,
        uuid=__ret__.uuid,
