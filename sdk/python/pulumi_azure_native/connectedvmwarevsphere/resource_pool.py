...
class ResourcePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20220715preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20230301preview:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231001:ResourcePool"), pulumi.Alias(type_="azure-native:connectedvmwarevsphere/v20231201:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20201001preview:connectedvmwarevsphere:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220110preview:connectedvmwarevsphere:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20220715preview:connectedvmwarevsphere:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20230301preview:connectedvmwarevsphere:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231001:connectedvmwarevsphere:ResourcePool"), pulumi.Alias(type_="azure-native_connectedvmwarevsphere_v20231201:connectedvmwarevsphere:ResourcePool")])
