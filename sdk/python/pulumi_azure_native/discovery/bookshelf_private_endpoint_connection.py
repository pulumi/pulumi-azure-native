...
@pulumi.type_token("azure-native:discovery:BookshelfPrivateEndpointConnection")
class BookshelfPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BookshelfPrivateEndpointConnectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BookshelfPrivateEndpointConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BookshelfPrivateEndpointConnectionArgs.__new__(BookshelfPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:discovery/v20260201preview:BookshelfPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:discovery/v20260601:BookshelfPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BookshelfPrivateEndpointConnection, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BookshelfPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BookshelfPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
