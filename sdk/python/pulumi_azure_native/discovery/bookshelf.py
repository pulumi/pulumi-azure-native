...
class BookshelfArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['BookshelfPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['BookshelfPropertiesArgs']]):
...
class Bookshelf(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bookshelf_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['BookshelfPropertiesArgs', 'BookshelfPropertiesArgsDict']]] = None,
