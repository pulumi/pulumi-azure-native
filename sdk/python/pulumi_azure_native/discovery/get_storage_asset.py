...
def get_storage_asset(resource_group_name: Optional[_builtins.str] = None,
                      storage_asset_name: Optional[_builtins.str] = None,
                      storage_container_name: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStorageAssetResult:
    """
    Get a StorageAsset
    ...
    __args__['storageAssetName'] = storage_asset_name
    __args__['storageContainerName'] = storage_container_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:discovery:getStorageAsset', __args__, opts=opts, typ=GetStorageAssetResult).value

    return AwaitableGetStorageAssetResult(
...
def get_storage_asset_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                             storage_asset_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:discovery:getStorageAsset', __args__, opts=opts, typ=GetStorageAssetResult)
    return __ret__.apply(lambda __response__: GetStorageAssetResult(
