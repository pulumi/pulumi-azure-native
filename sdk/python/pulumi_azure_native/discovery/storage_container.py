...
class StorageContainerArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['StorageContainerPropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['StorageContainerPropertiesArgs']]):
...
class StorageContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['StorageContainerPropertiesArgs', 'StorageContainerPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['StorageContainerPropertiesArgs', 'StorageContainerPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] storage_container_name: The name of the StorageContainer
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:discovery/v20260201preview:StorageContainer"), pulumi.Alias(type_="azure-native:discovery/v20260601:StorageContainer")])
