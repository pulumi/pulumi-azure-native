...
class GetStorageContainerResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.StorageContainerPropertiesResponse':
        """
...
def get_storage_container(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:discovery:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult).value
...
def get_storage_container_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:discovery:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult)
