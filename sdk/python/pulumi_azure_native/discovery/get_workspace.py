...
def get_workspace(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:discovery:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
...
def get_workspace_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:discovery:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
