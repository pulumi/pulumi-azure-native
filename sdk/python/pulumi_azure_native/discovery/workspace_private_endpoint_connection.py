...
@pulumi.type_token("azure-native:discovery:WorkspacePrivateEndpointConnection")
class WorkspacePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:discovery/v20260201preview:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:discovery/v20260601:WorkspacePrivateEndpointConnection")])
