...
__all__ = [
    'GetClusterInstanceAgentPoolResult',
    'AwaitableGetClusterInstanceAgentPoolResult',
    'get_cluster_instance_agent_pool',
    'get_cluster_instance_agent_pool_output',
]

@pulumi.output_type
class GetClusterInstanceAgentPoolResult:
    """
...
class AwaitableGetClusterInstanceAgentPoolResult(GetClusterInstanceAgentPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClusterInstanceAgentPoolResult(
...
def get_cluster_instance_agent_pool(agent_pool_name: Optional[str] = None,
                                    connected_cluster_resource_uri: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClusterInstanceAgentPoolResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceAgentPool', __args__, opts=opts, typ=GetClusterInstanceAgentPoolResult).value

    return AwaitableGetClusterInstanceAgentPoolResult(
...
def get_cluster_instance_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
                                           connected_cluster_resource_uri: Optional[pulumi.Input[str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClusterInstanceAgentPoolResult]:
    """
    Gets the agent pool in the Hybrid AKS provisioned cluster instance
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceAgentPool', __args__, opts=opts, typ=GetClusterInstanceAgentPoolResult)
    return __ret__.apply(lambda __response__: GetClusterInstanceAgentPoolResult(
