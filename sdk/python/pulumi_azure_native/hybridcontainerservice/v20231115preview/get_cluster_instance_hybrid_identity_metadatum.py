...
__all__ = [
    ...
    'get_cluster_instance_hybrid_identity_metadatum_output',
]
...
class AwaitableGetClusterInstanceHybridIdentityMetadatumResult(GetClusterInstanceHybridIdentityMetadatumResult):
...
def get_cluster_instance_hybrid_identity_metadatum(connected_cluster_resource_uri: Optional[str] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClusterInstanceHybridIdentityMetadatumResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceHybridIdentityMetadatum', __args__, opts=opts, typ=GetClusterInstanceHybridIdentityMetadatumResult).value

    return AwaitableGetClusterInstanceHybridIdentityMetadatumResult(
...
def get_cluster_instance_hybrid_identity_metadatum_output(connected_cluster_resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20231115preview:getClusterInstanceHybridIdentityMetadatum', __args__, opts=opts, typ=GetClusterInstanceHybridIdentityMetadatumResult)
    return __ret__.apply(lambda __response__: GetClusterInstanceHybridIdentityMetadatumResult(
