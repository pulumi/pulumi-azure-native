...
class VirtualNetworkRetrieveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualNetworkPropertiesArgs'] properties: HybridAKSNetworkSpec defines the desired state of HybridAKSNetwork
...
class VirtualNetworkRetrieve(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['VirtualNetworkPropertiesArgs', 'VirtualNetworkPropertiesArgsDict']] properties: HybridAKSNetworkSpec defines the desired state of HybridAKSNetwork
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] virtual_network_name: Parameter for the name of the virtual network
        """
    ...
    def _internal_init(__self__,
        ...
        super(VirtualNetworkRetrieve, __self__).__init__(
            'azure-native:hybridcontainerservice/v20231115preview:VirtualNetworkRetrieve',
            resource_name,
            __props__,
            opts)
