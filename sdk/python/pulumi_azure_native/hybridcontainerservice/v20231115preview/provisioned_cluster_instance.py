...
class ProvisionedClusterInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProvisionedClusterPropertiesArgs'] properties: All properties of the provisioned cluster
        """
...
class ProvisionedClusterInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:provisionedClusterInstance"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20240101:provisionedClusterInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProvisionedClusterInstance, __self__).__init__(
            'azure-native:hybridcontainerservice/v20231115preview:ProvisionedClusterInstance',
            resource_name,
            __props__,
            opts)
