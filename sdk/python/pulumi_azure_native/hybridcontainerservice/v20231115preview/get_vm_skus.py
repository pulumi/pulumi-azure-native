...
class GetVMSkusResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.VmSkuProfileResponseProperties':
...
class AwaitableGetVMSkusResult(GetVMSkusResult):
...
def get_vm_skus(custom_location_resource_uri: Optional[str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVMSkusResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20231115preview:getVMSkus', __args__, opts=opts, typ=GetVMSkusResult).value

    return AwaitableGetVMSkusResult(
...
def get_vm_skus_output(custom_location_resource_uri: Optional[pulumi.Input[str]] = None,
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVMSkusResult]:
    """
    Gets the supported VM skus from the underlying custom location
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20231115preview:getVMSkus', __args__, opts=opts, typ=GetVMSkusResult)
