...
def get_kubernetes_versions(custom_location_resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20231115preview:getKubernetesVersions', __args__, opts=opts, typ=GetKubernetesVersionsResult).value
