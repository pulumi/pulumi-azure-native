...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hybrid_identity_metadatum = azure_native.hybridcontainerservice.v20220901preview.HybridIdentityMetadatum("hybridIdentityMetadatum",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220501preview:HybridIdentityMetadatum")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridIdentityMetadatum, __self__).__init__(
            'azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum',
            resource_name,
            __props__,
            opts)
