...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220501preview:AgentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220501preview:agentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:agentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice:AgentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice:agentPool")])
