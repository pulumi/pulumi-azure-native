...
def get_storage_space_retrieve(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20220901preview:getStorageSpaceRetrieve', __args__, opts=opts, typ=GetStorageSpaceRetrieveResult).value
