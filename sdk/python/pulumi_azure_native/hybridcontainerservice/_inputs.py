...
class AADProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] client_app_id: The client AAD application ID.
        ...
        :param pulumi.Input[_builtins.str] server_app_id: The server AAD application ID.
        :param pulumi.Input[_builtins.str] server_app_secret: The server AAD application secret.
...
class AddonProfilesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] config: Config - Key-value pairs for configuring an add-on.
        :param pulumi.Input[_builtins.bool] enabled: Enabled - Whether the add-on is enabled or not.
        """
...
class AgentPoolProvisioningStatusProvisioningStatusArgsDict(TypedDict):
    ...
    """
    error: NotRequired[pulumi.Input[Optional['AgentPoolProvisioningStatusErrorArgs']]]
...
class AgentPoolProvisioningStatusProvisioningStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] phase: Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
        """
...
class AgentPoolProvisioningStatusStatusArgsDict(TypedDict):
    ...
    """
    provisioning_status: NotRequired[pulumi.Input[Optional['AgentPoolProvisioningStatusProvisioningStatusArgs']]]
    """
    Contains Provisioning errors
    """
...
class AgentPoolProvisioningStatusStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] error_message: ErrorMessage - Error messages during creation of cluster
        :param pulumi.Input['AgentPoolProvisioningStatusProvisioningStatusArgs'] provisioning_status: Contains Provisioning errors
        :param pulumi.Input[_builtins.int] ready_replicas: Total number of ready machines targeted by this deployment.
        :param pulumi.Input[_builtins.int] replicas: Total number of non-terminated machines targeted by this deployment
        """
...
class ArcAgentProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'AutoUpgradeOptions']] agent_auto_upgrade: Indicates whether the Arc agents on the provisioned clusters be upgraded automatically to the latest version. Defaults to Enabled.
        :param pulumi.Input[_builtins.str] agent_version: Version of the Arc agents to be installed on the provisioned Provisioned cluster resource
        """
...
class CloudProviderProfileInfraNetworkProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vnet_subnet_ids: Array of references to azure resource corresponding to the new HybridAKSNetwork object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/virtualNetworks/{virtualNetworkName}
        """
...
class CloudProviderProfileInfraStorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] storage_space_ids: Reference to azure resource corresponding to the new HybridAKSStorage object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/storageSpaces/{storageSpaceName}
        """
...
class CloudProviderProfileArgsDict(TypedDict):
    ...
    """
    infra_network_profile: NotRequired[pulumi.Input[Optional['CloudProviderProfileInfraNetworkProfileArgs']]]
    """
    InfraNetworkProfile - List of infra network profiles for the provisioned cluster
    """
    infra_storage_profile: NotRequired[pulumi.Input[Optional['CloudProviderProfileInfraStorageProfileArgs']]]
    """
    InfraStorageProfile - List of infra storage profiles for the provisioned cluster
    """
...
class ControlPlaneEndpointProfileControlPlaneEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host_ip: Host IP address for API server
        :param pulumi.Input[_builtins.str] port: Port for the API server
        """
...
class ControlPlaneProfileArgsDict(TypedDict):
    ...
    """
    cloud_provider_profile: NotRequired[pulumi.Input[Optional['CloudProviderProfileArgs']]]
    """
    The underlying cloud infra provider properties.
    """
    control_plane_endpoint: NotRequired[pulumi.Input[Optional['ControlPlaneEndpointProfileControlPlaneEndpointArgs']]]
    """
    API server endpoint for the control plane
    """
    ...
    """
    linux_profile: NotRequired[pulumi.Input[Optional['LinuxProfilePropertiesArgs']]]
    """
...
class ControlPlaneProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Unique name of the agent pool profile in the context of the subscription and resource group.
...
class HttpProxyConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] password: Password to use for connecting to proxy server
        :param pulumi.Input[_builtins.str] trusted_ca: Alternative CA cert to use for connecting to proxy servers.
        :param pulumi.Input[_builtins.str] username: Username to use for connecting to proxy server
        """
...
class LinuxProfilePropertiesSshArgsDict(TypedDict):
    ...
    """
    public_keys: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LinuxProfilePropertiesPublicKeysArgs']]]]]
    """
...
class LinuxProfilePropertiesArgsDict(TypedDict):
    ...
    """
    ssh: NotRequired[pulumi.Input[Optional['LinuxProfilePropertiesSshArgs']]]
    """
    SSH - SSH configuration for Linux-based VMs running on Azure.
    """
...
class LinuxProfilePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] admin_username: AdminUsername - The administrator username to use for Linux VMs.
...
class NetworkProfileArgsDict(TypedDict):
    ...
    """
    load_balancer_profile: NotRequired[pulumi.Input[Optional['LoadBalancerProfileArgs']]]
    """
    LoadBalancerProfile - Profile of the cluster load balancer.
    """
...
class NetworkProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dns_service_ip: DNSServiceIP - An IP address assigned to the Kubernetes DNS service. It must be within the Kubernetes service address range specified in serviceCidr.
        ...
        :param pulumi.Input[Union[_builtins.str, 'LoadBalancerSku']] load_balancer_sku: LoadBalancerSku - The load balancer sku for the provisioned cluster. Possible values: 'unstacked-haproxy', 'stacked-kube-vip', 'stacked-metallb', 'unmanaged'. The default is 'unmanaged'.
        :param pulumi.Input[Union[_builtins.str, 'NetworkPolicy']] network_policy: NetworkPolicy - Network policy used for building Kubernetes network. Possible values include: 'calico', 'flannel'. Default is 'calico'
        :param pulumi.Input[_builtins.str] pod_cidr: PodCidr - A CIDR notation IP range from which to assign pod IPs when kubenet is used.
        ...
        :param pulumi.Input[_builtins.str] service_cidr: ServiceCidr - A CIDR notation IP range from which to assign service cluster IPs. It must not overlap with any Subnet IP ranges.
...
class ProvisionedClustersAllPropertiesArgsDict(TypedDict):
    ...
    """
    aad_profile: NotRequired[pulumi.Input[Optional['AADProfileArgs']]]
    """
    AAD profile for the provisioned cluster.
    """
    addon_profiles: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['AddonProfilesArgs']]]]]
    """
    AddonProfiles - Profile of managed cluster add-on.
    """
    agent_pool_profiles: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamedAgentPoolProfileArgs']]]]]
    """
    ...
    The underlying cloud infra provider properties.
    """
    control_plane: NotRequired[pulumi.Input[Optional['ControlPlaneProfileArgs']]]
    """
    ...
    """
    features: NotRequired[pulumi.Input[Optional['ProvisionedClustersCommonPropertiesFeaturesArgs']]]
    """
    Additional features specs like Arc Agent Onboarding.
    """
    http_proxy_config: NotRequired[pulumi.Input[Optional['HttpProxyConfigArgs']]]
    """
    ...
    """
    network_profile: NotRequired[pulumi.Input[Optional['NetworkProfileArgs']]]
    """
    NetworkProfile - Profile of network configuration.
    """
    ...
    """
    windows_profile: NotRequired[pulumi.Input[Optional['WindowsProfileArgs']]]
    """
...
class ProvisionedClustersAllPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_rbac: EnableRBAC - Whether to enable Kubernetes Role-Based Access Control.
        ...
        :param pulumi.Input[_builtins.str] kubernetes_version: KubernetesVersion - Version of Kubernetes specified when creating the managed cluster.
        ...
        :param pulumi.Input[_builtins.str] node_resource_group: NodeResourceGroup - Name of the resource group containing agent pool nodes.
...
class ProvisionedClustersCommonPropertiesFeaturesArgsDict(TypedDict):
    ...
    Additional features specs like Arc Agent Onboarding.
    """
    arc_agent_profile: NotRequired[pulumi.Input[Optional['ArcAgentProfileArgs']]]
    """
...
class StorageSpacesPropertiesHciStorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] moc_storage_container: Name of the storage container in MOC(Microsoft On-premises Cloud)
        """
...
class StorageSpacesPropertiesProvisioningStatusArgsDict(TypedDict):
    ...
    Contains Provisioning errors
    """
    error: NotRequired[pulumi.Input[Optional['StorageSpacesPropertiesErrorArgs']]]
    operation_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    phase: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
...
class StorageSpacesPropertiesStatusArgsDict(TypedDict):
    ...
    """
    provisioning_status: NotRequired[pulumi.Input[Optional['StorageSpacesPropertiesProvisioningStatusArgs']]]
    """
    Contains Provisioning errors
    """
...
class StorageSpacesPropertiesVmwareStorageProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] folder: Name of the folder in VSphere
        :param pulumi.Input[_builtins.str] resource_pool: Name of the resource pool in VSphere
        """
...
class StorageSpacesPropertiesArgsDict(TypedDict):
    ...
    """
    hci_storage_profile: NotRequired[pulumi.Input[Optional['StorageSpacesPropertiesHciStorageProfileArgs']]]
    status: NotRequired[pulumi.Input[Optional['StorageSpacesPropertiesStatusArgs']]]
    """
    HybridAKSStorageStatus defines the observed state of HybridAKSStorage
    """
    vmware_storage_profile: NotRequired[pulumi.Input[Optional['StorageSpacesPropertiesVmwareStorageProfileArgs']]]
...
class VirtualNetworksPropertiesInfraVnetProfileArgsDict(TypedDict):
    hci: NotRequired[pulumi.Input[Optional['VirtualNetworksPropertiesHciArgs']]]
    """
    Infra network profile for HCI platform
    """
    network_cloud: NotRequired[pulumi.Input[Optional['VirtualNetworksPropertiesNetworkCloudArgs']]]
    """
    Infra network profile for the NetworkCloud platform
    """
    vmware: NotRequired[pulumi.Input[Optional['VirtualNetworksPropertiesVmwareArgs']]]
    """
...
class VirtualNetworksPropertiesNetworkCloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] network_id: The ARM ID of Network Cloud Network Resource to Associate with this VirtualNetwork
        """
...
class VirtualNetworksPropertiesVmwareArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] segment_name: Name of the network segment in VSphere
        """
...
class VirtualNetworksPropertiesArgsDict(TypedDict):
    ...
    """
    infra_vnet_profile: NotRequired[pulumi.Input[Optional['VirtualNetworksPropertiesInfraVnetProfileArgs']]]
    ip_address_prefix: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    IP Address Prefix of the network
    """
    vip_pool: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['VirtualNetworksPropertiesVipPoolArgs']]]]]
    """
    Virtual IP Pool for Kubernetes
    """
    vmip_pool: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['VirtualNetworksPropertiesVmipPoolArgs']]]]]
    """
...
class VirtualNetworksPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_servers: Address of the DNS servers associated with the network
        :param pulumi.Input[_builtins.str] gateway: Address of the Gateway associated with the network
...
class WindowsProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] admin_password: AdminPassword - Specifies the password of the administrator account. <br><br> **Minimum-length:** 8 characters <br><br> **Max-length:** 123 characters <br><br> **Complexity requirements:** 3 out of 4 conditions below need to be fulfilled <br> Has lower characters <br>Has upper characters <br> Has a digit <br> Has a special character (Regex match [\\W_]) <br><br> **Disallowed values:** "abc@123", "P@$$w0rd", "P@ssw0rd", "P@ssword123", "Pa$$word", "pass@word1", "Password!", "Password1", "Password22", "iloveyou!"
        :param pulumi.Input[_builtins.str] admin_username: AdminUsername - Specifies the name of the administrator account. <br><br> **restriction:** Cannot end in "." <br><br> **Disallowed values:** "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3", "admin1", "1", "123", "a", "actuser", "adm", "admin2", "aspnet", "backup", "console", "david", "guest", "john", "owner", "root", "server", "sql", "support", "support_388945a0", "sys", "test2", "test3", "user4", "user5". <br><br> **Minimum-length:** 1 character <br><br> **Max-length:** 20 characters
        :param pulumi.Input[_builtins.bool] enable_csi_proxy: EnableCSIProxy - Whether to enable CSI proxy.
        :param pulumi.Input[Union[_builtins.str, 'LicenseType']] license_type: LicenseType - The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. Possible values include: 'None', 'Windows_Server'
        """
