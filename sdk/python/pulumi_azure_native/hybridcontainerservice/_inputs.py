...
class AADProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_app_id: The client AAD application ID.
        ...
        :param pulumi.Input[builtins.str] server_app_id: The server AAD application ID.
        :param pulumi.Input[builtins.str] server_app_secret: The server AAD application secret.
...
class AddonProfilesArgs:
    def __init__(__self__, *,
        ...
        """
        Addon configurations
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config: Config - Key-value pairs for configuring an add-on.
        :param pulumi.Input[builtins.bool] enabled: Enabled - Whether the add-on is enabled or not.
        """
...
if not MYPY:
    class AgentPoolProvisioningStatusProvisioningStatusArgsDict(TypedDict):
        ...
        operation_id: NotRequired[pulumi.Input[builtins.str]]
...
class AgentPoolProvisioningStatusProvisioningStatusArgs:
    def __init__(__self__, *,
        ...
        """
        Contains Provisioning errors
        :param pulumi.Input[builtins.str] phase: Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
        """
...
class AgentPoolProvisioningStatusStatusArgs:
    def __init__(__self__, *,
        ...
        """
        HybridAKSNodePoolStatus defines the observed state of HybridAKSNodePool
        :param pulumi.Input[builtins.str] error_message: ErrorMessage - Error messages during creation of cluster
        :param pulumi.Input['AgentPoolProvisioningStatusProvisioningStatusArgs'] provisioning_status: Contains Provisioning errors
        :param pulumi.Input[builtins.int] ready_replicas: Total number of ready machines targeted by this deployment.
        :param pulumi.Input[builtins.int] replicas: Total number of non-terminated machines targeted by this deployment
        """
...
if not MYPY:
    class ArcAgentProfileArgsDict(TypedDict):
        ...
        """
        agent_auto_upgrade: NotRequired[pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']]]
        """
        ...
        """
        agent_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ArcAgentProfileArgs:
    def __init__(__self__, *,
                 agent_auto_upgrade: Optional[pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']]] = None,
                 agent_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Defines the Arc Agent properties for the Provisioned clusters.
        :param pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']] agent_auto_upgrade: Indicates whether the Arc agents on the provisioned clusters be upgraded automatically to the latest version. Defaults to Enabled.
        :param pulumi.Input[builtins.str] agent_version: Version of the Arc agents to be installed on the provisioned Provisioned cluster resource
        """
    ...
    def agent_auto_upgrade(self) -> Optional[pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']]]:
        """
        Indicates whether the Arc agents on the provisioned clusters be upgraded automatically to the latest version. Defaults to Enabled.
        """
    ...
    def agent_auto_upgrade(self, value: Optional[pulumi.Input[Union[builtins.str, 'AutoUpgradeOptions']]]):
...
if not MYPY:
    class CloudProviderProfileInfraNetworkProfileArgsDict(TypedDict):
        ...
        """
        vnet_subnet_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CloudProviderProfileInfraNetworkProfileArgs:
    def __init__(__self__, *,
        ...
        """
        InfraNetworkProfile - List of infra network profiles for the provisioned cluster
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vnet_subnet_ids: Array of references to azure resource corresponding to the new HybridAKSNetwork object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/virtualNetworks/{virtualNetworkName}
        """
...
if not MYPY:
    class CloudProviderProfileInfraStorageProfileArgsDict(TypedDict):
        ...
        """
        storage_space_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CloudProviderProfileInfraStorageProfileArgs:
    def __init__(__self__, *,
                 storage_space_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        InfraStorageProfile - List of infra storage profiles for the provisioned cluster
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] storage_space_ids: Reference to azure resource corresponding to the new HybridAKSStorage object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/storageSpaces/{storageSpaceName}
        """
    ...
    def storage_space_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Reference to azure resource corresponding to the new HybridAKSStorage object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/storageSpaces/{storageSpaceName}
        """
    ...
    def storage_space_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ControlPlaneEndpointProfileControlPlaneEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        API server endpoint for the control plane
        :param pulumi.Input[builtins.str] host_ip: Host IP address for API server
        :param pulumi.Input[builtins.str] port: Port for the API server
        """
...
if not MYPY:
    class ControlPlaneProfileArgsDict(TypedDict):
        ...
        """
        node_image_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ControlPlaneProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Unique name of the agent pool profile in the context of the subscription and resource group.
...
class HttpProxyConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: Password to use for connecting to proxy server
        :param pulumi.Input[builtins.str] trusted_ca: Alternative CA cert to use for connecting to proxy servers.
        :param pulumi.Input[builtins.str] username: Username to use for connecting to proxy server
        """
...
class LinuxProfilePropertiesPublicKeysArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_data: KeyData - Certificate public key used to authenticate with VMs through SSH. The certificate must be in PEM format with or without headers.
        """
...
class LinuxProfilePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        LinuxProfile - Profile for Linux VMs in the container service cluster.
        :param pulumi.Input[builtins.str] admin_username: AdminUsername - The administrator username to use for Linux VMs.
...
class NetworkProfileArgs:
    def __init__(__self__, *,
        ...
        """
        NetworkProfile - Profile of network configuration.
        :param pulumi.Input[builtins.str] dns_service_ip: DNSServiceIP - An IP address assigned to the Kubernetes DNS service. It must be within the Kubernetes service address range specified in serviceCidr.
        ...
        :param pulumi.Input[Union[builtins.str, 'LoadBalancerSku']] load_balancer_sku: LoadBalancerSku - The load balancer sku for the provisioned cluster. Possible values: 'unstacked-haproxy', 'stacked-kube-vip', 'stacked-metallb', 'unmanaged'. The default is 'unmanaged'.
        :param pulumi.Input[Union[builtins.str, 'NetworkPolicy']] network_policy: NetworkPolicy - Network policy used for building Kubernetes network. Possible values include: 'calico', 'flannel'. Default is 'calico'
        :param pulumi.Input[builtins.str] pod_cidr: PodCidr - A CIDR notation IP range from which to assign pod IPs when kubenet is used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pod_cidrs: The CIDR notation IP ranges from which to assign pod IPs. One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking.
        :param pulumi.Input[builtins.str] service_cidr: ServiceCidr - A CIDR notation IP range from which to assign service cluster IPs. It must not overlap with any Subnet IP ranges.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_cidrs: The CIDR notation IP ranges from which to assign service cluster IPs. One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking. They must not overlap with any Subnet IP ranges.
        """
...
if not MYPY:
    class ProvisionedClustersAllPropertiesArgsDict(TypedDict):
        ...
        """
        enable_rbac: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        NetworkProfile - Profile of network configuration.
        """
        node_resource_group: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProvisionedClustersAllPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 node_resource_group: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_rbac: EnableRBAC - Whether to enable Kubernetes Role-Based Access Control.
        ...
        :param pulumi.Input[builtins.str] kubernetes_version: KubernetesVersion - Version of Kubernetes specified when creating the managed cluster.
        ...
        :param pulumi.Input[builtins.str] node_resource_group: NodeResourceGroup - Name of the resource group containing agent pool nodes.
    ...
    def node_resource_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        NodeResourceGroup - Name of the resource group containing agent pool nodes.
        """
    ...
    def node_resource_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class StorageSpacesPropertiesHciStorageProfileArgsDict(TypedDict):
        moc_group: NotRequired[pulumi.Input[builtins.str]]
        """
        Resource group in MOC(Microsoft On-premises Cloud)
        """
        moc_location: NotRequired[pulumi.Input[builtins.str]]
        """
        Location in MOC(Microsoft On-premises Cloud)
        """
        moc_storage_container: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StorageSpacesPropertiesHciStorageProfileArgs:
    def __init__(__self__, *,
                 moc_group: Optional[pulumi.Input[builtins.str]] = None,
                 moc_location: Optional[pulumi.Input[builtins.str]] = None,
                 moc_storage_container: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] moc_group: Resource group in MOC(Microsoft On-premises Cloud)
        :param pulumi.Input[builtins.str] moc_location: Location in MOC(Microsoft On-premises Cloud)
        :param pulumi.Input[builtins.str] moc_storage_container: Name of the storage container in MOC(Microsoft On-premises Cloud)
        """
    ...
    def moc_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource group in MOC(Microsoft On-premises Cloud)
        """
    ...
    @moc_group.setter
    def moc_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "moc_group", value)

    @property
    @pulumi.getter(name="mocLocation")
    def moc_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Location in MOC(Microsoft On-premises Cloud)
        """
    ...
    @moc_location.setter
    def moc_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "moc_location", value)

    @property
    @pulumi.getter(name="mocStorageContainer")
    def moc_storage_container(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the storage container in MOC(Microsoft On-premises Cloud)
        """
    ...
    def moc_storage_container(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class StorageSpacesPropertiesVmwareStorageProfileArgsDict(TypedDict):
        ...
        """
        datastore: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the datastore in VSphere
        """
        folder: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StorageSpacesPropertiesVmwareStorageProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] datacenter: Name of the datacenter in VSphere
        :param pulumi.Input[builtins.str] datastore: Name of the datastore in VSphere
        :param pulumi.Input[builtins.str] folder: Name of the folder in VSphere
        :param pulumi.Input[builtins.str] resource_pool: Name of the resource pool in VSphere
        """
...
if not MYPY:
    class VirtualNetworksPropertiesHciArgsDict(TypedDict):
        ...
        Location in MOC(Microsoft On-premises Cloud)
        """
        moc_vnet_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworksPropertiesHciArgs:
    def __init__(__self__, *,
                 moc_group: Optional[pulumi.Input[builtins.str]] = None,
                 moc_location: Optional[pulumi.Input[builtins.str]] = None,
                 moc_vnet_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Infra network profile for HCI platform
        :param pulumi.Input[builtins.str] moc_group: Resource group in MOC(Microsoft On-premises Cloud)
        :param pulumi.Input[builtins.str] moc_location: Location in MOC(Microsoft On-premises Cloud)
        :param pulumi.Input[builtins.str] moc_vnet_name: Virtual Network name in MOC(Microsoft On-premises Cloud)
        """
        if moc_group is not None:
            pulumi.set(__self__, "moc_group", moc_group)
        if moc_location is not None:
    ...
    def moc_vnet_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Virtual Network name in MOC(Microsoft On-premises Cloud)
        """
    ...
    def moc_vnet_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualNetworksPropertiesNetworkCloudArgs:
    def __init__(__self__, *,
        ...
        """
        Infra network profile for the NetworkCloud platform
        :param pulumi.Input[builtins.str] network_id: The ARM ID of Network Cloud Network Resource to Associate with this VirtualNetwork
        """
...
if not MYPY:
    class VirtualNetworksPropertiesVipPoolArgsDict(TypedDict):
        end_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        Ending IP address for the IP Pool
        """
        start_ip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworksPropertiesVipPoolArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] end_ip: Ending IP address for the IP Pool
        :param pulumi.Input[builtins.str] start_ip: Starting IP address for the IP Pool
        """
...
if not MYPY:
    class VirtualNetworksPropertiesVmwareArgsDict(TypedDict):
        ...
        Infra network profile for VMware platform
        """
        segment_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworksPropertiesVmwareArgs:
    def __init__(__self__, *,
        ...
        """
        Infra network profile for VMware platform
        :param pulumi.Input[builtins.str] segment_name: Name of the network segment in VSphere
        """
...
if not MYPY:
    class VirtualNetworksPropertiesArgsDict(TypedDict):
        ...
        ip_address_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworksPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 ip_address_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        HybridAKSNetworkSpec defines the desired state of HybridAKSNetwork
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: Address of the DNS servers associated with the network
        :param pulumi.Input[builtins.str] gateway: Address of the Gateway associated with the network
        :param pulumi.Input[builtins.str] ip_address_prefix: IP Address Prefix of the network
    ...
    def ip_address_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IP Address Prefix of the network
        """
    ...
    def ip_address_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WindowsProfileArgs:
    def __init__(__self__, *,
        ...
        """
        WindowsProfile - Profile for Windows VMs in the container service cluster.
        :param pulumi.Input[builtins.str] admin_password: AdminPassword - Specifies the password of the administrator account. <br><br> **Minimum-length:** 8 characters <br><br> **Max-length:** 123 characters <br><br> **Complexity requirements:** 3 out of 4 conditions below need to be fulfilled <br> Has lower characters <br>Has upper characters <br> Has a digit <br> Has a special character (Regex match [\\W_]) <br><br> **Disallowed values:** "abc@123", "P@$$w0rd", "P@ssw0rd", "P@ssword123", "Pa$$word", "pass@word1", "Password!", "Password1", "Password22", "iloveyou!"
        :param pulumi.Input[builtins.str] admin_username: AdminUsername - Specifies the name of the administrator account. <br><br> **restriction:** Cannot end in "." <br><br> **Disallowed values:** "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3", "admin1", "1", "123", "a", "actuser", "adm", "admin2", "aspnet", "backup", "console", "david", "guest", "john", "owner", "root", "server", "sql", "support", "support_388945a0", "sys", "test2", "test3", "user4", "user5". <br><br> **Minimum-length:** 1 character <br><br> **Max-length:** 20 characters
        :param pulumi.Input[builtins.bool] enable_csi_proxy: EnableCSIProxy - Whether to enable CSI proxy.
        :param pulumi.Input[Union[builtins.str, 'LicenseType']] license_type: LicenseType - The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. Possible values include: 'None', 'Windows_Server'
        """
