...
def get_storage_space_retrieve(resource_group_name: Optional[builtins.str] = None,
                               storage_spaces_name: Optional[builtins.str] = None,
    ...
    :param builtins.str storage_spaces_name: Parameter for the name of the storage object
    """
    __args__ = dict()
...
def get_storage_space_retrieve_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
