...
def get_hybrid_identity_metadatum(hybrid_identity_metadata_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hybrid_identity_metadata_resource_name: Parameter for the name of the hybrid identity metadata resource.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str resource_name: Parameter for the name of the provisioned cluster
    """
    __args__ = dict()
...
def get_hybrid_identity_metadatum_output(hybrid_identity_metadata_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
