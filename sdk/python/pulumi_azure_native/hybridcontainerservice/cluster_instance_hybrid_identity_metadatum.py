...
__all__ = ['ClusterInstanceHybridIdentityMetadatumArgs', 'ClusterInstanceHybridIdentityMetadatum']

@pulumi.input_type
class ClusterInstanceHybridIdentityMetadatumArgs:
    def __init__(__self__, *,
                 connected_cluster_resource_uri: pulumi.Input[builtins.str],
                 public_key: Optional[pulumi.Input[builtins.str]] = None,
                 resource_uid: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClusterInstanceHybridIdentityMetadatum resource.
        :param pulumi.Input[builtins.str] connected_cluster_resource_uri: The fully qualified Azure Resource Manager identifier of the connected cluster resource.
        :param pulumi.Input[builtins.str] public_key: Onboarding public key for provisioning the Managed identity for the connected cluster.
        :param pulumi.Input[builtins.str] resource_uid: Unique id of the parent provisioned cluster resource.
        """
    ...
    def connected_cluster_resource_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connected_cluster_resource_uri(self, value: pulumi.Input[builtins.str]):
    ...
    def resource_uid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @resource_uid.setter
    def resource_uid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_uid", value)


@pulumi.type_token("azure-native:hybridcontainerservice:ClusterInstanceHybridIdentityMetadatum")
class ClusterInstanceHybridIdentityMetadatum(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 connected_cluster_resource_uri: Optional[pulumi.Input[builtins.str]] = None,
                 public_key: Optional[pulumi.Input[builtins.str]] = None,
                 resource_uid: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClusterInstanceHybridIdentityMetadatumArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClusterInstanceHybridIdentityMetadatumArgs.__new__(ClusterInstanceHybridIdentityMetadatumArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterInstanceHybridIdentityMetadatum':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ClusterInstanceHybridIdentityMetadatum(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="resourceUid")
    def resource_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Unique id of the parent provisioned cluster resource.
        """
        return pulumi.get(self, "resource_uid")
