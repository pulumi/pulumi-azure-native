...
def get_virtual_network_retrieve(resource_group_name: Optional[builtins.str] = None,
                                 virtual_networks_name: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_networks_name: Parameter for the name of the virtual network
    """
    __args__ = dict()
...
def get_virtual_network_retrieve_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                        virtual_networks_name: Optional[pulumi.Input[builtins.str]] = None,
