...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] hybrid_identity_metadata_resource_name: Parameter for the name of the hybrid identity metadata resource.
        :param pulumi.Input[Union['ProvisionedClusterIdentityArgs', 'ProvisionedClusterIdentityArgsDict']] identity: The identity of the provisioned cluster.
        :param pulumi.Input[str] provisioned_clusters_name: Parameter for the name of the provisioned cluster
        :param pulumi.Input[str] public_key: Onboarding public key for provisioning the Managed identity for the HybridAKS cluster.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] resource_uid: Unique id of the parent provisioned cluster resource.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20240101:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice:HybridIdentityMetadatum")])
