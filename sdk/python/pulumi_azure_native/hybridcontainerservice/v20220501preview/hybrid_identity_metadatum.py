...
class HybridIdentityMetadatumArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if provisioned_clusters_name is None and 'provisionedClustersName' in kwargs:
            provisioned_clusters_name = kwargs['provisionedClustersName']
        if provisioned_clusters_name is None:
            raise TypeError("Missing 'provisioned_clusters_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if hybrid_identity_metadata_resource_name is None and 'hybridIdentityMetadataResourceName' in kwargs:
...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum")])
