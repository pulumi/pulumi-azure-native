...
class StorageSpaceRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220501preview:storageSpaceRetrieve"), pulumi.Alias(type_="azure-native:hybridcontainerservice:StorageSpaceRetrieve"), pulumi.Alias(type_="azure-native:hybridcontainerservice:storageSpaceRetrieve"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:StorageSpaceRetrieve"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:storageSpaceRetrieve")])
