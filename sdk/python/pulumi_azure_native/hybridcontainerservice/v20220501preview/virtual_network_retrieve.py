...
class VirtualNetworkRetrieve(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_retrieve = azure_native.hybridcontainerservice.v20220501preview.VirtualNetworkRetrieve("virtualNetworkRetrieve",
            extended_location=azure_native.hybridcontainerservice.v20220501preview.VirtualNetworksExtendedLocationArgs(
                name="/subscriptions/a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b/resourcegroups/test-arcappliance-resgrp/providers/microsoft.extendedlocation/customlocations/testcustomlocation",
                type="CustomLocation",
            ),
            location="westus",
            properties=azure_native.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesResponseArgs(
                infra_vnet_profile={
                    "hci": azure_native.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesHciArgs(
                        moc_group="target-group",
                        moc_location="MocLocation",
                        moc_vnet_name="test-vnet",
                    ),
                },
                vip_pool=[azure_native.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesVipPoolArgs(
                    end_ip="192.168.0.50",
                    start_ip="192.168.0.10",
                )],
                vmip_pool=[azure_native.hybridcontainerservice.v20220501preview.VirtualNetworksPropertiesVmipPoolArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice:virtualNetworkRetrieve"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:virtualNetworkRetrieve")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRetrieve, __self__).__init__(
            'azure-native:hybridcontainerservice/v20220501preview:virtualNetworkRetrieve',
            resource_name,
            __props__,
            opts)
