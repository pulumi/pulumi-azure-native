...
def get_storage_space_retrieve_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20220501preview:getStorageSpaceRetrieve', __args__, opts=opts, typ=GetStorageSpaceRetrieveResult)
