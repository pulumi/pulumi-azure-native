...
def get_virtual_network_retrieve_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20220501preview:getVirtualNetworkRetrieve', __args__, opts=opts, typ=GetVirtualNetworkRetrieveResult)
