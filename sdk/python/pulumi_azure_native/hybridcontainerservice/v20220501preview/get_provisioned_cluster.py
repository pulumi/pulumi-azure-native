...
def get_provisioned_cluster(provisioned_clusters_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20220501preview:getProvisionedCluster', __args__, opts=opts, typ=GetProvisionedClusterResult).value
