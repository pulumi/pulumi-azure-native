...
__all__ = [
    ...
    'VirtualNetworksPropertiesKubevirtArgsDict',
...
if not MYPY:
    class VirtualNetworksPropertiesInfraVnetProfileArgsDict(TypedDict):
        ...
        Infra network profile for HCI platform
        """
        kubevirt: NotRequired[pulumi.Input['VirtualNetworksPropertiesKubevirtArgsDict']]
        """
...
if not MYPY:
    class VirtualNetworksPropertiesKubevirtArgsDict(TypedDict):
        """
        Infra network profile for KubeVirt platform
        """
    ...
    VirtualNetworksPropertiesKubevirtArgsDict: TypeAlias = Mapping[str, Any]
