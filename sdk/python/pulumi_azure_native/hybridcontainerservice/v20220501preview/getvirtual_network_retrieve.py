...
__all__ = [
    ...
    'getvirtual_network_retrieve',
    'getvirtual_network_retrieve_output',
]
...
def getvirtual_network_retrieve(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20220501preview:getvirtualNetworkRetrieve', __args__, opts=opts, typ=GetvirtualNetworkRetrieveResult).value
...
@_utilities.lift_output_func(getvirtual_network_retrieve)
def getvirtual_network_retrieve_output(resource_group_name: Optional[pulumi.Input[str]] = None,
