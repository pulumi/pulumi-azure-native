...
class AADProfileResponseResponse(dict):
    ...
    def __init__(__self__, *,
                 admin_group_object_ids: Optional[Sequence[builtins.str]] = None,
                 client_app_id: Optional[builtins.str] = None,
                 enable_azure_rbac: Optional[builtins.bool] = None,
                 managed: Optional[builtins.bool] = None,
                 server_app_id: Optional[builtins.str] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        AAD Profile specifies attributes for Azure Active Directory integration.
        :param Sequence[builtins.str] admin_group_object_ids: The list of AAD group object IDs that will have admin role of the cluster.
        :param builtins.str client_app_id: The client AAD application ID.
        :param builtins.bool enable_azure_rbac: Whether to enable Azure RBAC for Kubernetes authorization.
        :param builtins.bool managed: Whether to enable managed AAD.
        :param builtins.str server_app_id: The server AAD application ID.
        :param builtins.str tenant_id: The AAD tenant ID to use for authentication. If not specified, will use the tenant of the deployment subscription.
        """
    ...
    def admin_group_object_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enable_azure_rbac(self) -> Optional[builtins.bool]:
        """
    ...
    def server_app_id(self) -> Optional[builtins.str]:
        """
...
class AddonProfilesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Addon configurations
        :param Mapping[str, builtins.str] config: Config - Key-value pairs for configuring an add-on.
        :param builtins.bool enabled: Enabled - Whether the add-on is enabled or not.
        """
...
class AddonStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Status of the addon
        :param builtins.str error_message: ErrorMessage will be set in the event that there is a terminal problem reconciling the AddOn and will contain a more verbose string suitable for logging and human consumption.
        :param builtins.str phase: Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
        """
...
class AgentPoolProvisioningStatusResponseStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        HybridAKSNodePoolStatus defines the observed state of HybridAKSNodePool
        :param builtins.str error_message: ErrorMessage - Error messages during creation of cluster
        :param 'AgentPoolProvisioningStatusResponseProvisioningStatus' provisioning_status: Contains Provisioning errors
        :param builtins.int ready_replicas: Total number of ready machines targeted by this deployment.
        :param builtins.int replicas: Total number of non-terminated machines targeted by this deployment
        """
        if error_message is not None:
            pulumi.set(__self__, "error_message", error_message)
...
class ArcAgentProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 agent_auto_upgrade: Optional[builtins.str] = None,
                 agent_version: Optional[builtins.str] = None):
        """
        Defines the Arc Agent properties for the Provisioned clusters.
        :param builtins.str agent_auto_upgrade: Indicates whether the Arc agents on the provisioned clusters be upgraded automatically to the latest version. Defaults to Enabled.
        :param builtins.str agent_version: Version of the Arc agents to be installed on the provisioned Provisioned cluster resource
        """
    ...
    def agent_auto_upgrade(self) -> Optional[builtins.str]:
        """
...
class ArcAgentStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 agent_version: Optional[builtins.str] = None,
                 core_count: Optional[builtins.float] = None,
                 deployment_state: Optional[builtins.str] = None,
                 error_message: Optional[builtins.str] = None,
                 last_connectivity_time: Optional[builtins.str] = None,
                 managed_identity_certificate_expiration_time: Optional[builtins.str] = None,
                 onboarding_public_key: Optional[builtins.str] = None):
        """
        Defines the observed Arc Agent status that is resourceSynced back to the ARM resource.
        :param builtins.str agent_version: Version of the Arc agents currently running on the Provisioned cluster resource.
        :param builtins.float core_count: Number of CPU cores present in the Provisioned cluster resource
        :param builtins.str deployment_state: Observed deployment state of the Arc Agents on the target cluster. Possible values include: 'pending', 'provisioning', 'provisioned', 'deleting', 'failed', 'upgrading'
        :param builtins.str error_message: Error messages while onboarding/upgrading/uninstalling the Arc agents
        :param builtins.str last_connectivity_time: Last connected timestamp of the Provisioned cluster resource.
        :param builtins.str managed_identity_certificate_expiration_time: ManagedIdentity certificate expiration time (ValidUntil).
        :param builtins.str onboarding_public_key: Onboarding public key for provisioning the Managed identity for the HybridAKS cluster. Will be used to create the hybridIdentityMetadata proxy resource and will not be persisted.
        """
        if agent_version is not None:
            pulumi.set(__self__, "agent_version", agent_version)
    ...
    def core_count(self) -> Optional[builtins.float]:
        """
    ...
    def last_connectivity_time(self) -> Optional[builtins.str]:
        """
    ...
    def managed_identity_certificate_expiration_time(self) -> Optional[builtins.str]:
        """
    ...
    def onboarding_public_key(self) -> Optional[builtins.str]:
        """
...
class CloudProviderProfileResponseInfraNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 vnet_subnet_ids: Optional[Sequence[builtins.str]] = None):
        """
        InfraNetworkProfile - List of infra network profiles for the provisioned cluster
        :param Sequence[builtins.str] vnet_subnet_ids: Array of references to azure resource corresponding to the new HybridAKSNetwork object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/virtualNetworks/{virtualNetworkName}
        """
    ...
    def vnet_subnet_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CloudProviderProfileResponseInfraStorageProfile(dict):
    ...
    def __init__(__self__, *,
                 storage_space_ids: Optional[Sequence[builtins.str]] = None):
        """
        InfraStorageProfile - List of infra storage profiles for the provisioned cluster
        :param Sequence[builtins.str] storage_space_ids: Reference to azure resource corresponding to the new HybridAKSStorage object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/storageSpaces/{storageSpaceName}
        """
    ...
    def storage_space_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ControlPlaneEndpointProfileResponseControlPlaneEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        API server endpoint for the control plane
        :param builtins.str host_ip: Host IP address for API server
        :param builtins.str port: Port for the API server
        """
...
class ControlPlaneProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 node_image_version: Optional[builtins.str] = None,
                 node_labels: Optional[Mapping[str, builtins.str]] = None,
                 node_taints: Optional[Sequence[builtins.str]] = None,
                 os_type: Optional[builtins.str] = None,
                 vm_size: Optional[builtins.str] = None):
        """
        ControlPlaneProfile - The control plane properties for the provisioned cluster.
        :param Sequence[builtins.str] availability_zones: AvailabilityZones - The list of Availability zones to use for nodes. Datacenter racks modelled as zones
        ...
        :param builtins.int count: Count - Number of agents to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
        :param 'LinuxProfilePropertiesResponse' linux_profile: Profile for Linux VMs in the container service cluster.
        :param builtins.int max_count: The maximum number of nodes for auto-scaling
        :param builtins.int max_pods: The maximum number of pods that can run on a node.
        :param builtins.int min_count: The minimum number of nodes for auto-scaling
        :param builtins.str mode: Mode - AgentPoolMode represents mode of an agent pool. Possible values include: 'System', 'LB', 'User'. Default is 'User'
        :param builtins.str name: Unique name of the agent pool profile in the context of the subscription and resource group.
        :param builtins.str node_image_version: The version of node image
        :param Mapping[str, builtins.str] node_labels: NodeLabels - Agent pool node labels to be persisted across all nodes in agent pool.
        :param Sequence[builtins.str] node_taints: NodeTaints - Taints added to new nodes during node pool create and scale. For example, key=value:NoSchedule.
        :param builtins.str os_type: OsType - OsType to be used to specify os type. Choose from Linux and Windows. Default to Linux. Possible values include: 'Linux', 'Windows'
        :param builtins.str vm_size: VmSize - The size of the agent pool VMs.
        """
    ...
    def node_image_version(self) -> Optional[builtins.str]:
        """
    ...
    def node_labels(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def node_taints(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CredentialResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The credential result response.
        :param builtins.str name: The name of the credential.
        :param builtins.str value: Base64-encoded Kubernetes configuration file.
        """
        pulumi.set(__self__, "name", name)
...
class HttpProxyConfigResponseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str username: Username to use for connecting to proxy server
        """
...
class LinuxProfilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        LinuxProfile - Profile for Linux VMs in the container service cluster.
        :param builtins.str admin_username: AdminUsername - The administrator username to use for Linux VMs.
...
class LinuxProfilePropertiesResponsePublicKeys(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_data: KeyData - Certificate public key used to authenticate with VMs through SSH. The certificate must be in PEM format with or without headers.
        """
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        NetworkProfile - Profile of network configuration.
        :param builtins.str dns_service_ip: DNSServiceIP - An IP address assigned to the Kubernetes DNS service. It must be within the Kubernetes service address range specified in serviceCidr.
        :param 'LoadBalancerProfileResponse' load_balancer_profile: LoadBalancerProfile - Profile of the cluster load balancer.
        :param builtins.str load_balancer_sku: LoadBalancerSku - The load balancer sku for the provisioned cluster. Possible values: 'unstacked-haproxy', 'stacked-kube-vip', 'stacked-metallb', 'unmanaged'. The default is 'unmanaged'.
        :param builtins.str network_policy: NetworkPolicy - Network policy used for building Kubernetes network. Possible values include: 'calico', 'flannel'. Default is 'calico'
        :param builtins.str pod_cidr: PodCidr - A CIDR notation IP range from which to assign pod IPs when kubenet is used.
        :param Sequence[builtins.str] pod_cidrs: The CIDR notation IP ranges from which to assign pod IPs. One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking.
        :param builtins.str service_cidr: ServiceCidr - A CIDR notation IP range from which to assign service cluster IPs. It must not overlap with any Subnet IP ranges.
        :param Sequence[builtins.str] service_cidrs: The CIDR notation IP ranges from which to assign service cluster IPs. One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking. They must not overlap with any Subnet IP ranges.
        """
...
class ProvisionedClusterIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the Provisioned cluster.
        :param builtins.str principal_id: The principal id of provisioned cluster identity. This property will only be provided for a system assigned identity.
        :param builtins.str tenant_id: The tenant id associated with the provisioned cluster. This property will only be provided for a system assigned identity.
        :param builtins.str type: The type of identity used for the provisioned cluster. The type SystemAssigned, includes a system created identity. The type None means no identity is assigned to the provisioned cluster.
        """
...
class ProvisionedClustersResponsePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_rbac: Optional[builtins.bool] = None,
        ...
        :param builtins.bool enable_rbac: EnableRBAC - Whether to enable Kubernetes Role-Based Access Control.
        ...
        :param builtins.str kubernetes_version: KubernetesVersion - Version of Kubernetes specified when creating the managed cluster.
        ...
        :param builtins.str node_resource_group: NodeResourceGroup - Name of the resource group containing agent pool nodes.
    ...
    def enable_rbac(self) -> Optional[builtins.bool]:
        """
...
class StorageSpacesPropertiesResponseHciStorageProfile(dict):
    ...
    def __init__(__self__, *,
                 moc_group: Optional[builtins.str] = None,
                 moc_location: Optional[builtins.str] = None,
                 moc_storage_container: Optional[builtins.str] = None):
        """
        :param builtins.str moc_group: Resource group in MOC(Microsoft On-premises Cloud)
        :param builtins.str moc_location: Location in MOC(Microsoft On-premises Cloud)
        :param builtins.str moc_storage_container: Name of the storage container in MOC(Microsoft On-premises Cloud)
        """
    ...
    def moc_group(self) -> Optional[builtins.str]:
        """
    ...
    def moc_location(self) -> Optional[builtins.str]:
        """
    ...
    def moc_storage_container(self) -> Optional[builtins.str]:
        """
...
class StorageSpacesPropertiesResponseVmwareStorageProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str datacenter: Name of the datacenter in VSphere
        :param builtins.str datastore: Name of the datastore in VSphere
        :param builtins.str folder: Name of the folder in VSphere
        :param builtins.str resource_pool: Name of the resource pool in VSphere
        """
...
class VirtualNetworksPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 dhcp_servers: Sequence[builtins.str],
                 provisioning_state: builtins.str,
                 ...
                 ip_address_prefix: Optional[builtins.str] = None,
        ...
        """
        HybridAKSNetworkSpec defines the desired state of HybridAKSNetwork
        :param Sequence[builtins.str] dhcp_servers: Address of the DHCP servers associated with the network
        ...
        :param builtins.str vlan_id: VLAN Id used by the network
        :param Sequence[builtins.str] dns_servers: Address of the DNS servers associated with the network
        :param builtins.str gateway: Address of the Gateway associated with the network
        :param builtins.str ip_address_prefix: IP Address Prefix of the network
    ...
    def dhcp_servers(self) -> Sequence[builtins.str]:
        """
    ...
    def ip_address_prefix(self) -> Optional[builtins.str]:
        """
...
class VirtualNetworksPropertiesResponseHci(dict):
    ...
    def __init__(__self__, *,
                 moc_group: Optional[builtins.str] = None,
                 moc_location: Optional[builtins.str] = None,
                 moc_vnet_name: Optional[builtins.str] = None):
        """
        Infra network profile for HCI platform
        :param builtins.str moc_group: Resource group in MOC(Microsoft On-premises Cloud)
        :param builtins.str moc_location: Location in MOC(Microsoft On-premises Cloud)
        :param builtins.str moc_vnet_name: Virtual Network name in MOC(Microsoft On-premises Cloud)
        """
        if moc_group is not None:
            pulumi.set(__self__, "moc_group", moc_group)
        if moc_location is not None:
    ...
    def moc_vnet_name(self) -> Optional[builtins.str]:
        """
...
class VirtualNetworksPropertiesResponseNetworkCloud(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Infra network profile for the NetworkCloud platform
        :param builtins.str network_id: The ARM ID of Network Cloud Network Resource to Associate with this VirtualNetwork
        """
...
class VirtualNetworksPropertiesResponseVipPool(dict):
    ...
    def __init__(__self__, *,
                 end_ip: Optional[builtins.str] = None,
                 start_ip: Optional[builtins.str] = None):
        """
        :param builtins.str end_ip: Ending IP address for the IP Pool
        :param builtins.str start_ip: Starting IP address for the IP Pool
        """
    ...
    def end_ip(self) -> Optional[builtins.str]:
        """
    ...
    def start_ip(self) -> Optional[builtins.str]:
        """
...
class VirtualNetworksPropertiesResponseVmware(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Infra network profile for VMware platform
        :param builtins.str segment_name: Name of the network segment in VSphere
        """
...
class WindowsProfileResponseResponse(dict):
    ...
    def __init__(__self__, *,
                 admin_username: Optional[builtins.str] = None,
                 enable_csi_proxy: Optional[builtins.bool] = None,
                 license_type: Optional[builtins.str] = None):
        """
        Profile for Windows VMs in the container service cluster.
        :param builtins.str admin_username: AdminUsername - Specifies the name of the administrator account. <br><br> **restriction:** Cannot end in "." <br><br> **Disallowed values:** "administrator", "admin", "user", "user1", "test", "user2", "test1", "user3", "admin1", "1", "123", "a", "actuser", "adm", "admin2", "aspnet", "backup", "console", "david", "guest", "john", "owner", "root", "server", "sql", "support", "support_388945a0", "sys", "test2", "test3", "user4", "user5". <br><br> **Minimum-length:** 1 character <br><br> **Max-length:** 20 characters
        :param builtins.bool enable_csi_proxy: EnableCSIProxy - Whether to enable CSI proxy.
        :param builtins.str license_type: LicenseType - The licenseType to use for Windows VMs. Windows_Server is used to enable Azure Hybrid User Benefits for Windows VMs. Possible values include: 'None', 'Windows_Server'
        """
        if admin_username is not None:
            pulumi.set(__self__, "admin_username", admin_username)
    ...
    def enable_csi_proxy(self) -> Optional[builtins.bool]:
        """
