...
__all__ = [
    ...
    'getstorage_space_retrieve',
    'getstorage_space_retrieve_output',
]
...
class GetstorageSpaceRetrieveResult:
    ...
    def extended_location(self) -> Optional['outputs.StorageSpacesResponseExtendedLocation']:
...
def getstorage_space_retrieve(resource_group_name: Optional[str] = None,
...
@_utilities.lift_output_func(getstorage_space_retrieve)
def getstorage_space_retrieve_output(resource_group_name: Optional[pulumi.Input[str]] = None,
