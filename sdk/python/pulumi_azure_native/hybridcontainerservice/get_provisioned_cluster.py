...
def get_provisioned_cluster(resource_group_name: Optional[builtins.str] = None,
...
def get_provisioned_cluster_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
