...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220501preview:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native_hybridcontainerservice_v20220501preview:hybridcontainerservice:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native_hybridcontainerservice_v20220901preview:hybridcontainerservice:HybridIdentityMetadatum")])
