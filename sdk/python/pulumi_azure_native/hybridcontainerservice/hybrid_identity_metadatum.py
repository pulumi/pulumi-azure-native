...
class HybridIdentityMetadatumArgs:
    def __init__(__self__, *,
                 ...
                 hybrid_identity_metadata_resource_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] hybrid_identity_metadata_resource_name: Parameter for the name of the hybrid identity metadata resource.
        :param pulumi.Input['ProvisionedClusterIdentityArgs'] identity: The identity of the provisioned cluster.
        :param pulumi.Input[builtins.str] public_key: Onboarding public key for provisioning the Managed identity for the HybridAKS cluster.
    ...
    def hybrid_identity_metadata_resource_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hybrid_identity_metadata_resource_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:hybridcontainerservice:HybridIdentityMetadatum")
