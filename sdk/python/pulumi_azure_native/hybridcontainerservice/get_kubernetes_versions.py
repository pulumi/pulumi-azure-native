...
def get_kubernetes_versions(custom_location_resource_uri: Optional[builtins.str] = None,
...
def get_kubernetes_versions_output(custom_location_resource_uri: Optional[pulumi.Input[builtins.str]] = None,
