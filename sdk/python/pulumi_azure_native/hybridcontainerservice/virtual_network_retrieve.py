...
class VirtualNetworkRetrieveArgs:
    ...
    def _configure(
        ...
        if virtual_networks_name is None and 'virtualNetworksName' in kwargs:
...
class VirtualNetworkRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            extended_location = _utilities.configure(extended_location, VirtualNetworksExtendedLocationArgs, True)
            __props__.__dict__["extended_location"] = extended_location
            __props__.__dict__["location"] = location
            properties = _utilities.configure(properties, VirtualNetworksPropertiesArgs, True)
