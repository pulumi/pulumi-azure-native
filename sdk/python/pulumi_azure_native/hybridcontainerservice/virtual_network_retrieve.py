...
class VirtualNetworkRetrieveArgs:
    ...
    def _configure(
        ...
        if 'virtualNetworksName' in kwargs:
            virtual_networks_name = kwargs['virtualNetworksName']
        ...
        if virtual_networks_name is not None:
            _setter("virtual_networks_name", virtual_networks_name)
...
class VirtualNetworkRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if extended_location is not None and not isinstance(extended_location, VirtualNetworksExtendedLocationArgs):
                extended_location = extended_location or {}
                def _setter(key, value):
                    extended_location[key] = value
                VirtualNetworksExtendedLocationArgs._configure(_setter, **extended_location)
            __props__.__dict__["extended_location"] = extended_location
            __props__.__dict__["location"] = location
            if properties is not None and not isinstance(properties, VirtualNetworksPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                VirtualNetworksPropertiesArgs._configure(_setter, **properties)
