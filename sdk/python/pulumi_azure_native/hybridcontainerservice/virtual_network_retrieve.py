...
class VirtualNetworkRetrieveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_networks_name: Parameter for the name of the virtual network
        """
    ...
    def virtual_networks_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_networks_name(self, value: Optional[pulumi.Input[builtins.str]]):
