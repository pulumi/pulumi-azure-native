...
def get_cluster_instance_hybrid_identity_metadatum(connected_cluster_resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20240101:getClusterInstanceHybridIdentityMetadatum', __args__, opts=opts, typ=GetClusterInstanceHybridIdentityMetadatumResult).value
...
def get_cluster_instance_hybrid_identity_metadatum_output(connected_cluster_resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20240101:getClusterInstanceHybridIdentityMetadatum', __args__, opts=opts, typ=GetClusterInstanceHybridIdentityMetadatumResult)
