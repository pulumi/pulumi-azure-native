...
class KubernetesVersions(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:KubernetesVersions")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KubernetesVersions, __self__).__init__(
            'azure-native:hybridcontainerservice/v20240101:KubernetesVersions',
            resource_name,
            __props__,
            opts)
