...
__all__ = ['ClusterInstanceAgentPoolArgs', 'ClusterInstanceAgentPool']

@pulumi.input_type
class ClusterInstanceAgentPoolArgs:
...
class ClusterInstanceAgentPool(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ClusterInstanceAgentPoolArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The agentPool resource definition

        :param str resource_name: The name of the resource.
        :param ClusterInstanceAgentPoolArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClusterInstanceAgentPoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClusterInstanceAgentPoolArgs.__new__(ClusterInstanceAgentPoolArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:AgentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:ClusterInstanceAgentPool"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20240101:AgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterInstanceAgentPool, __self__).__init__(
            'azure-native:hybridcontainerservice/v20240101:ClusterInstanceAgentPool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterInstanceAgentPool':
        """
        ...
        return ClusterInstanceAgentPool(resource_name, opts=opts, __props__=__props__)
