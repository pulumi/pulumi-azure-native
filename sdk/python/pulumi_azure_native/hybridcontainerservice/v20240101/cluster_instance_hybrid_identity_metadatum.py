...
class ClusterInstanceHybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:ClusterInstanceHybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice:ClusterInstanceHybridIdentityMetadatum")])
