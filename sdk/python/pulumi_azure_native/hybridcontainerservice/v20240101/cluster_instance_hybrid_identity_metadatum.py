...
class ClusterInstanceHybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice:ClusterInstanceHybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:ClusterInstanceHybridIdentityMetadatum")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterInstanceHybridIdentityMetadatum, __self__).__init__(
            'azure-native:hybridcontainerservice/v20240101:ClusterInstanceHybridIdentityMetadatum',
            resource_name,
            __props__,
            opts)
