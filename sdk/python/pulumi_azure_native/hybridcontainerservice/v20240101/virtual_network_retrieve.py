...
class VirtualNetworkRetrieveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] virtual_network_name: Parameter for the name of the virtual network
        """
...
class VirtualNetworkRetrieve(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 extended_location: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkExtendedLocationArgs']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['VirtualNetworkExtendedLocationArgs']] extended_location: Extended location pointing to the underlying infrastructure
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['VirtualNetworkPropertiesArgs']] properties: Properties of the virtual network resource
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] virtual_network_name: Parameter for the name of the virtual network
        """
