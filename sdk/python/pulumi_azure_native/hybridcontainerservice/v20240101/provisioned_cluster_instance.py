...
__all__ = ['ProvisionedClusterInstanceArgs', 'ProvisionedClusterInstance']

@pulumi.input_type
class ProvisionedClusterInstanceArgs:
    def __init__(__self__, *,
                 connected_cluster_resource_uri: pulumi.Input[str],
                 extended_location: Optional[pulumi.Input['ExtendedLocationArgs']] = None,
                 properties: Optional[pulumi.Input['ProvisionedClusterPropertiesArgs']] = None):
        """
        ...
        :param pulumi.Input['ProvisionedClusterPropertiesArgs'] properties: Properties of the provisioned cluster.
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['ProvisionedClusterPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ProvisionedClusterPropertiesArgs']]):
        pulumi.set(self, "properties", value)


class ProvisionedClusterInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[Union['ProvisionedClusterPropertiesArgs', 'ProvisionedClusterPropertiesArgsDict']] properties: Properties of the provisioned cluster.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: ProvisionedClusterInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The provisioned cluster resource definition.

        :param str resource_name: The name of the resource.
        :param ProvisionedClusterInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProvisionedClusterInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProvisionedClusterInstanceArgs.__new__(ProvisionedClusterInstanceArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcontainerservice/v20231115preview:ProvisionedClusterInstance")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProvisionedClusterInstance':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ProvisionedClusterInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ProvisionedClusterPropertiesResponse']:
        """
        Properties of the provisioned cluster.
        """
        return pulumi.get(self, "properties")
