...
def get_cluster_instance_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool', __args__, opts=opts, typ=GetClusterInstanceAgentPoolResult).value
...
def get_cluster_instance_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcontainerservice/v20240101:getClusterInstanceAgentPool', __args__, opts=opts, typ=GetClusterInstanceAgentPoolResult)
