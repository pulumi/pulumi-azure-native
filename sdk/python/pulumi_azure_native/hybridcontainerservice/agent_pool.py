...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cloud_provider_profile, CloudProviderProfileArgs):
            ...
            if not isinstance(extended_location, AgentPoolExtendedLocationArgs):
            ...
            if not isinstance(status, AgentPoolProvisioningStatusStatusArgs):
                status = status or {}
                def _setter(key, value):
                    status[key] = value
