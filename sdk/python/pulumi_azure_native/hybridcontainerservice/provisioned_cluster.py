...
class ProvisionedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            extended_location = _utilities.configure(extended_location, ProvisionedClustersExtendedLocationArgs, True)
            __props__.__dict__["extended_location"] = extended_location
            identity = _utilities.configure(identity, ProvisionedClusterIdentityArgs, True)
            __props__.__dict__["identity"] = identity
            __props__.__dict__["location"] = location
            properties = _utilities.configure(properties, ProvisionedClustersAllPropertiesArgs, True)
