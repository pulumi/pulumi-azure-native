...
class ProvisionedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(extended_location, ProvisionedClustersExtendedLocationArgs):
            ...
            if not isinstance(identity, ProvisionedClusterIdentityArgs):
            ...
            if not isinstance(properties, ProvisionedClustersAllPropertiesArgs):
