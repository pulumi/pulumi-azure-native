...
class GetSimResult:
    ...
    def integrated_circuit_card_identifier(self) -> Optional[_builtins.str]:
        """
...
def get_sim(resource_group_name: Optional[_builtins.str] = None,
            sim_group_name: Optional[_builtins.str] = None,
            sim_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sim_name: The name of the SIM.
    """
    __args__ = dict()
...
def get_sim_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                   sim_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                   sim_name: Optional[pulumi.Input[_builtins.str]] = None,
