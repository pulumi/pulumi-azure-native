...
class SiteArgs:
    ...
    def _configure(
        ...
        if network_functions is None and 'networkFunctions' in kwargs:
            network_functions = kwargs['networkFunctions']
        ...
        if network_functions is not None:
            _setter("network_functions", network_functions)
...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Site")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'azure-native:mobilenetwork/v20220401preview:Site',
            resource_name,
            __props__,
            opts)
