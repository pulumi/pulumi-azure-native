...
class Slice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Slice")])
