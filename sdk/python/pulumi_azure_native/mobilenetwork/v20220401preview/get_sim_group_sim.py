...
__all__ = [
    'GetSimGroupSimResult',
    'AwaitableGetSimGroupSimResult',
    'get_sim_group_sim',
    'get_sim_group_sim_output',
]

@pulumi.output_type
class GetSimGroupSimResult:
    """
    SIM resource.
    """
...
class AwaitableGetSimGroupSimResult(GetSimGroupSimResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSimGroupSimResult(
...
def get_sim_group_sim(resource_group_name: Optional[str] = None,
                      sim_group_name: Optional[str] = None,
                      sim_name: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSimGroupSimResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20220401preview:getSimGroupSim', __args__, opts=opts, typ=GetSimGroupSimResult).value

    return AwaitableGetSimGroupSimResult(
...
def get_sim_group_sim_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                             sim_group_name: Optional[pulumi.Input[str]] = None,
                             sim_name: Optional[pulumi.Input[str]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSimGroupSimResult]:
    """
    Gets information about the specified SIM.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20220401preview:getSimGroupSim', __args__, opts=opts, typ=GetSimGroupSimResult)
    return __ret__.apply(lambda __response__: GetSimGroupSimResult(
