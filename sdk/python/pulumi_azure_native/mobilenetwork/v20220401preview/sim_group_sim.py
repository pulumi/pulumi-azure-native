...
class SimGroupSim(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] sim_group_name: The name of the SIM Group.
        :param pulumi.Input[str] sim_name: The name of the SIM.
        :param pulumi.Input[Union['SimPolicyResourceIdArgs', 'SimPolicyResourceIdArgsDict']] sim_policy: The SIM policy used by this SIM.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork:SimGroupSim")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SimGroupSim, __self__).__init__(
            'azure-native:mobilenetwork/v20220401preview:SimGroupSim',
            resource_name,
            __props__,
            opts)
