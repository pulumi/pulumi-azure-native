...
class DataNetworkArgs:
    ...
    def _configure(
        ...
        if data_network_name is None and 'dataNetworkName' in kwargs:
            data_network_name = kwargs['dataNetworkName']
        ...
        if data_network_name is not None:
            _setter("data_network_name", data_network_name)
...
class DataNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataNetworkArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:DataNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataNetwork, __self__).__init__(
            'azure-native:mobilenetwork/v20220401preview:DataNetwork',
            resource_name,
            __props__,
            opts)
