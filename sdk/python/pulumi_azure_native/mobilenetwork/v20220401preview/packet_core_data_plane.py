...
class PacketCoreDataPlane(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        packet_core_data_plane = azure_native.mobilenetwork.v20220401preview.PacketCoreDataPlane("packetCoreDataPlane",
            location="eastus",
            packet_core_control_plane_name="testPacketCoreCP",
            packet_core_data_plane_name="testPacketCoreDP",
            resource_group_name="rg1",
            user_plane_access_interface=azure_native.mobilenetwork.v20220401preview.InterfacePropertiesArgs(
                name="N3",
            ))
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:PacketCoreDataPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:PacketCoreDataPlane")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PacketCoreDataPlane, __self__).__init__(
            'azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane',
            resource_name,
            __props__,
            opts)
