...
class MobileNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        MobileNetworkArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            public_land_mobile_network_identifier=public_land_mobile_network_identifier,
    ...
    def _configure(
             ...
             public_land_mobile_network_identifier: Optional[pulumi.Input['PlmnIdArgs']] = None,
             ...
             **kwargs):
        if public_land_mobile_network_identifier is None and 'publicLandMobileNetworkIdentifier' in kwargs:
            public_land_mobile_network_identifier = kwargs['publicLandMobileNetworkIdentifier']
        if public_land_mobile_network_identifier is None:
            raise TypeError("Missing 'public_land_mobile_network_identifier' argument")
        ...
        _setter("public_land_mobile_network_identifier", public_land_mobile_network_identifier)
...
class MobileNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MobileNetworkArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            public_land_mobile_network_identifier = _utilities.configure(public_land_mobile_network_identifier, PlmnIdArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:MobileNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MobileNetwork, __self__).__init__(
            'azure-native:mobilenetwork/v20220401preview:MobileNetwork',
            resource_name,
            __props__,
            opts)
