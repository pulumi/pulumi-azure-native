...
class PacketCoreControlPlane(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:PacketCoreControlPlane"), pulumi.Alias(type_="azure-native:mobilenetwork:PacketCoreControlPlane")])
