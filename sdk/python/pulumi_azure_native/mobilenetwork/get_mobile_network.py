...
def get_mobile_network(mobile_network_name: Optional[_builtins.str] = None,
...
def get_mobile_network_output(mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
