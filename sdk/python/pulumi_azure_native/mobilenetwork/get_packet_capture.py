...
class GetPacketCaptureResult:
    ...
    def bytes_to_capture_per_packet(self) -> Optional[builtins.float]:
        """
    ...
    def capture_start_time(self) -> builtins.str:
        """
    ...
    def network_interfaces(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def output_files(self) -> Sequence[builtins.str]:
        """
    ...
    def time_limit_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def total_bytes_per_session(self) -> Optional[builtins.float]:
        """
...
def get_packet_capture(packet_capture_name: Optional[builtins.str] = None,
    ...
    :param builtins.str packet_capture_name: The name of the packet capture session.
...
def get_packet_capture_output(packet_capture_name: Optional[pulumi.Input[builtins.str]] = None,
