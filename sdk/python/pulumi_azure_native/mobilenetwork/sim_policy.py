...
class SimPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if default_slice is not None and not isinstance(default_slice, SliceResourceIdArgs):
                default_slice = default_slice or {}
                def _setter(key, value):
                    default_slice[key] = value
                SliceResourceIdArgs._configure(_setter, **default_slice)
            ...
            if ue_ambr is not None and not isinstance(ue_ambr, AmbrArgs):
                ue_ambr = ue_ambr or {}
                def _setter(key, value):
                    ue_ambr[key] = value
                AmbrArgs._configure(_setter, **ue_ambr)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:SimPolicy")])
