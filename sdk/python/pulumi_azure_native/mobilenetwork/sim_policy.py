...
class SimPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20220301preview:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20220401preview:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20221101:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20230601:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20230901:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20240201:mobilenetwork:SimPolicy"), pulumi.Alias(type_="azure-native_mobilenetwork_v20240401:mobilenetwork:SimPolicy")])
