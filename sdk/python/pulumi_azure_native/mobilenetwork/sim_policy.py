...
class SimPolicyArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['SimPolicyPropertiesFormatArgs'],
        ...
        :param pulumi.Input['SimPolicyPropertiesFormatArgs'] properties: SIM policy Properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['SimPolicyPropertiesFormatArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['SimPolicyPropertiesFormatArgs']):
...
class SimPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['SimPolicyPropertiesFormatArgs']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] mobile_network_name: The name of the mobile network.
        :param pulumi.Input[pulumi.InputType['SimPolicyPropertiesFormatArgs']] properties: SIM policy Properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] sim_policy_name: The name of the SIM policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimPolicy"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimPolicy")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SimPolicyPropertiesFormatResponse']:
        """
        SIM policy Properties.
        """
        return pulumi.get(self, "properties")
