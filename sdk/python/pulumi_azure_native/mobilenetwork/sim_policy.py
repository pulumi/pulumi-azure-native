...
class SimPolicyArgs:
    def __init__(__self__, *,
                 ...
                 registration_timer: Optional[pulumi.Input[builtins.int]] = None,
                 rfsp_index: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] registration_timer: UE periodic registration update timer (5G) or UE periodic tracking area update timer (4G), in seconds.
        :param pulumi.Input[builtins.int] rfsp_index: RAT/Frequency Selection Priority Index, defined in 3GPP TS 36.413. This is an optional setting and by default is unspecified.
        :param pulumi.Input[builtins.str] sim_policy_name: The name of the SIM policy.
    ...
    def registration_timer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def registration_timer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "registration_timer", value)

    @property
    @pulumi.getter(name="rfspIndex")
    def rfsp_index(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @rfsp_index.setter
    def rfsp_index(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rfsp_index", value)

    @property
    @pulumi.getter(name="simPolicyName")
    def sim_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sim_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SimPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="registrationTimer")
    def registration_timer(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        UE periodic registration update timer (5G) or UE periodic tracking area update timer (4G), in seconds.
        """
        return pulumi.get(self, "registration_timer")
    ...
    @property
    @pulumi.getter(name="rfspIndex")
    def rfsp_index(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        RAT/Frequency Selection Priority Index, defined in 3GPP TS 36.413. This is an optional setting and by default is unspecified.
        """
        return pulumi.get(self, "rfsp_index")
    ...
    def site_provisioning_state(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
