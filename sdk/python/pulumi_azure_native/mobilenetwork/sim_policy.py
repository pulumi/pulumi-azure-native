...
class SimPolicyArgs:
    def __init__(__self__, *,
                 ...
                 mobile_network_name: pulumi.Input[_builtins.str],
                 ...
                 registration_timer: Optional[pulumi.Input[_builtins.int]] = None,
                 rfsp_index: Optional[pulumi.Input[_builtins.int]] = None,
                 sim_policy_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] mobile_network_name: The name of the mobile network.
        ...
        :param pulumi.Input[_builtins.int] registration_timer: UE periodic registration update timer (5G) or UE periodic tracking area update timer (4G), in seconds.
        :param pulumi.Input[_builtins.int] rfsp_index: RAT/Frequency Selection Priority Index, defined in 3GPP TS 36.413. This is an optional setting and by default is unspecified.
        :param pulumi.Input[_builtins.str] sim_policy_name: The name of the SIM policy.
    ...
    def mobile_network_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def mobile_network_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def registration_timer(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def registration_timer(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "registration_timer", value)

    @_builtins.property
    @pulumi.getter(name="rfspIndex")
    def rfsp_index(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @rfsp_index.setter
    def rfsp_index(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "rfsp_index", value)

    @_builtins.property
    @pulumi.getter(name="simPolicyName")
    def sim_policy_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def sim_policy_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class SimPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
                 registration_timer: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="registrationTimer")
    def registration_timer(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        UE periodic registration update timer (5G) or UE periodic tracking area update timer (4G), in seconds.
        """
        return pulumi.get(self, "registration_timer")
    ...
    @_builtins.property
    @pulumi.getter(name="rfspIndex")
    def rfsp_index(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        RAT/Frequency Selection Priority Index, defined in 3GPP TS 36.413. This is an optional setting and by default is unspecified.
        """
        return pulumi.get(self, "rfsp_index")
    ...
    def site_provisioning_state(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
