...
def get_service(mobile_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str mobile_network_name: The name of the mobile network.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str service_name: The name of the service. You must not use any of the following reserved strings - `default`, `requested` or `service`
    """
    __args__ = dict()
...
def get_service_output(mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
