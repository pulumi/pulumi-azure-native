...
class Slice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20220301preview:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20220401preview:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20221101:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20230601:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20230901:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20240201:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native_mobilenetwork_v20240401:mobilenetwork:Slice")])
