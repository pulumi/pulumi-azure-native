...
def get_sim_group(resource_group_name: Optional[_builtins.str] = None,
                  sim_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sim_group_name: The name of the SIM Group.
    """
    __args__ = dict()
...
def get_sim_group_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
