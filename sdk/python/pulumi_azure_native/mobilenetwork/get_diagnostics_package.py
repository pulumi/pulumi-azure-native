...
def get_diagnostics_package(diagnostics_package_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str diagnostics_package_name: The name of the diagnostics package.
...
def get_diagnostics_package_output(diagnostics_package_name: Optional[pulumi.Input[_builtins.str]] = None,
