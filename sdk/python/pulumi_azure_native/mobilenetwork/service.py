...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 service_precedence: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] service_precedence: A precedence value that is used to decide between services when identifying the QoS values to use for a particular SIM. A lower value means a higher priority. This value should be unique among all services configured in the mobile network.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] service_name: The name of the service. You must not use any of the following reserved strings - `default`, `requested` or `service`
    ...
    def service_precedence(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def service_precedence(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("azure-native:mobilenetwork:Service")
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_name: Optional[pulumi.Input[_builtins.str]] = None,
                 service_precedence: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:Service")])
    ...
    @_builtins.property
    @pulumi.getter(name="servicePrecedence")
    def service_precedence(self) -> pulumi.Output[_builtins.int]:
        """
        A precedence value that is used to decide between services when identifying the QoS values to use for a particular SIM. A lower value means a higher priority. This value should be unique among all services configured in the mobile network.
        """
        return pulumi.get(self, "service_precedence")
