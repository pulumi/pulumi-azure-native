...
class GetAttachedDataNetworkResult:
    ...
    def user_equipment_address_pool_prefix(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def user_equipment_static_address_pool_prefix(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_attached_data_network(attached_data_network_name: Optional[_builtins.str] = None,
                              packet_core_control_plane_name: Optional[_builtins.str] = None,
                              packet_core_data_plane_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str attached_data_network_name: The name of the attached data network.
    :param _builtins.str packet_core_control_plane_name: The name of the packet core control plane.
    :param _builtins.str packet_core_data_plane_name: The name of the packet core data plane.
...
def get_attached_data_network_output(attached_data_network_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetAttachedDataNetworkResult(
        ...
        napt_configuration=pulumi.get(__response__, 'napt_configuration'),
        provisioning_state=pulumi.get(__response__, 'provisioning_state'),
        system_data=pulumi.get(__response__, 'system_data'),
        tags=pulumi.get(__response__, 'tags'),
        type=pulumi.get(__response__, 'type'),
        user_equipment_address_pool_prefix=pulumi.get(__response__, 'user_equipment_address_pool_prefix'),
        user_equipment_static_address_pool_prefix=pulumi.get(__response__, 'user_equipment_static_address_pool_prefix'),
        user_plane_data_interface=pulumi.get(__response__, 'user_plane_data_interface')))
