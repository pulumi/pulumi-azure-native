...
def get_data_network(data_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20221101:getDataNetwork', __args__, opts=opts, typ=GetDataNetworkResult).value
...
def get_data_network_output(data_network_name: Optional[pulumi.Input[str]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataNetworkResult]:
    """
    Gets information about the specified data network.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20221101:getDataNetwork', __args__, opts=opts, typ=GetDataNetworkResult)
    return __ret__.apply(lambda __response__: GetDataNetworkResult(
