...
class DataNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:DataNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataNetwork, __self__).__init__(
            'azure-native:mobilenetwork/v20221101:DataNetwork',
            resource_name,
            __props__,
            opts)
