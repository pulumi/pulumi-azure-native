...
class PacketCoreControlPlane(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        packet_core_control_plane = azure_native.mobilenetwork.v20221101.PacketCoreControlPlane("packetCoreControlPlane",
            control_plane_access_interface=azure_native.mobilenetwork.v20221101.InterfacePropertiesArgs(
                name="N2",
            ),
            core_network_technology="5GC",
            local_diagnostics_access=azure_native.mobilenetwork.v20221101.LocalDiagnosticsAccessConfigurationArgs(
                authentication_type="AAD",
                https_server_certificate=azure_native.mobilenetwork.v20221101.HttpsServerCertificateArgs(
                    certificate_url="https://contosovault.vault.azure.net/certificates/ingress",
                ),
            ),
            location="eastus",
            packet_core_control_plane_name="TestPacketCoreCP",
            platform=azure_native.mobilenetwork.v20221101.PlatformConfigurationArgs(
                azure_stack_edge_device=azure_native.mobilenetwork.v20221101.AzureStackEdgeDeviceResourceIdArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/TestAzureStackEdgeDevice",
                ),
                connected_cluster=azure_native.mobilenetwork.v20221101.ConnectedClusterResourceIdArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Kubernetes/connectedClusters/TestConnectedCluster",
                ),
                custom_location=azure_native.mobilenetwork.v20221101.CustomLocationResourceIdArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ExtendedLocation/customLocations/TestCustomLocation",
                ),
                type="AKS-HCI",
            ),
            resource_group_name="rg1",
            sites=[azure_native.mobilenetwork.v20221101.SiteResourceIdArgs(
