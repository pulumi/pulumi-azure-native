...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service = azure_native.mobilenetwork.v20221101.Service("service",
            location="eastus",
            mobile_network_name="testMobileNetwork",
            pcc_rules=[{
                "ruleName": "default-rule",
                "rulePrecedence": 255,
                "ruleQosPolicy": azure_native.mobilenetwork.v20221101.PccRuleQosPolicyArgs(
                    allocation_and_retention_priority_level=9,
                    five_qi=9,
                    maximum_bit_rate=azure_native.mobilenetwork.v20221101.AmbrArgs(
                        downlink="1 Gbps",
                        uplink="500 Mbps",
                    ),
                ...
                "serviceDataFlowTemplates": [azure_native.mobilenetwork.v20221101.ServiceDataFlowTemplateArgs(
                    direction="Uplink",
                    ports=[],
                    protocol=["ip"],
            ...
            service_qos_policy=azure_native.mobilenetwork.v20221101.QosPolicyResponseArgs(
                allocation_and_retention_priority_level=9,
                five_qi=9,
                maximum_bit_rate={
                    "downlink": "1 Gbps",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:mobilenetwork/v20221101:Service',
            resource_name,
            __props__,
            opts)
