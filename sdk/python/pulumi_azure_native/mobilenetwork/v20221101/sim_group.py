...
class SimGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:SimGroup")])
