...
class Slice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if snssai is not None and not isinstance(snssai, SnssaiArgs):
                snssai = snssai or {}
                def _setter(key, value):
                    snssai[key] = value
                SnssaiArgs._configure(_setter, **snssai)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Slice"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Slice")])
