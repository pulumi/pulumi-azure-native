...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Site"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:Site")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'azure-native:mobilenetwork/v20221101:Site',
            resource_name,
            __props__,
            opts)
