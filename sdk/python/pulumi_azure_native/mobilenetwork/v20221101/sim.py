...
class SimArgs:
    ...
    def _configure(
        ...
        if sim_group_name is None:
            raise TypeError("Missing 'sim_group_name' argument")
...
class Sim(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Sim")])
