...
class Sim(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sim = azure_native.mobilenetwork.v20221101.Sim("sim",
            ...
            sim_name="testSim",
            sim_policy=azure_native.mobilenetwork.v20221101.SimPolicyResourceIdResponseArgs(
            ...
            static_ip_configuration=[{
                "attachedDataNetwork": azure_native.mobilenetwork.v20221101.AttachedDataNetworkResourceIdArgs(
                ...
                "slice": azure_native.mobilenetwork.v20221101.SliceResourceIdArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.MobileNetwork/mobileNetworks/testMobileNetwork/slices/testSlice",
                ),
                "staticIp": azure_native.mobilenetwork.v20221101.SimStaticIpPropertiesStaticIpArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Sim")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Sim, __self__).__init__(
            'azure-native:mobilenetwork/v20221101:Sim',
            resource_name,
            __props__,
            opts)
