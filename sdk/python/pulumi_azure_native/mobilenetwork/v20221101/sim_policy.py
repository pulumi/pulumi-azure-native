...
class SimPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sim_policy = azure_native.mobilenetwork.v20221101.SimPolicy("simPolicy",
            default_slice=azure_native.mobilenetwork.v20221101.SliceResourceIdArgs(
            ...
            slice_configurations=[{
                "dataNetworkConfigurations": [azure_native.mobilenetwork.v20221101.DataNetworkConfigurationArgs(
                    additional_allowed_session_types=[],
                    allocation_and_retention_priority_level=9,
                    allowed_services=[azure_native.mobilenetwork.v20221101.ServiceResourceIdArgs(
                    ...
                    data_network=azure_native.mobilenetwork.v20221101.DataNetworkResourceIdArgs(
                    ...
                    session_ambr=azure_native.mobilenetwork.v20221101.AmbrArgs(
                        downlink="1 Gbps",
                        uplink="500 Mbps",
                    ),
                )],
                "defaultDataNetwork": azure_native.mobilenetwork.v20221101.DataNetworkResourceIdArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.MobileNetwork/mobileNetworks/testMobileNetwork/dataNetworks/testdataNetwork",
                ),
            ...
            ue_ambr=azure_native.mobilenetwork.v20221101.AmbrArgs(
                downlink="1 Gbps",
                uplink="500 Mbps",
            ))
