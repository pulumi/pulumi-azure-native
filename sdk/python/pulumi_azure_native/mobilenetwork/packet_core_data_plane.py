...
class PacketCoreDataPlaneArgs:
    def __init__(__self__, *,
                 packet_core_control_plane_name: pulumi.Input[builtins.str],
                 ...
                 user_plane_access_virtual_ipv4_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a PacketCoreDataPlane resource.
        :param pulumi.Input[builtins.str] packet_core_control_plane_name: The name of the packet core control plane.
        ...
        :param pulumi.Input[builtins.str] packet_core_data_plane_name: The name of the packet core data plane.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_plane_access_virtual_ipv4_addresses: The virtual IP address(es) for the user plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to forward traffic for this address to the control plane access interface on the active or standby node. In non-HA system this list should be omitted or empty.
        """
    ...
    def packet_core_control_plane_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def packet_core_control_plane_name(self, value: pulumi.Input[builtins.str]):
    ...
    def packet_core_data_plane_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def packet_core_data_plane_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_plane_access_virtual_ipv4_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_plane_access_virtual_ipv4_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PacketCoreDataPlane(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="userPlaneAccessVirtualIpv4Addresses")
    def user_plane_access_virtual_ipv4_addresses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The virtual IP address(es) for the user plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to forward traffic for this address to the control plane access interface on the active or standby node. In non-HA system this list should be omitted or empty.
        """
        return pulumi.get(self, "user_plane_access_virtual_ipv4_addresses")
