...
def get_attached_data_network_output(attached_data_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20220301preview:getAttachedDataNetwork', __args__, opts=opts, typ=GetAttachedDataNetworkResult)
