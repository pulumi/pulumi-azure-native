...
def get_attached_data_network(attached_data_network_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attached_data_network is deprecated: azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:mobilenetwork/v20220401preview:AttachedDataNetwork to guarantee forwards compatibility.""")
    __args__ = dict()
