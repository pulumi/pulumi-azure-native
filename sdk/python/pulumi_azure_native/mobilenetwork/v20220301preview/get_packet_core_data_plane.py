...
def get_packet_core_data_plane(packet_core_control_plane_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20220301preview:getPacketCoreDataPlane', __args__, opts=opts, typ=GetPacketCoreDataPlaneResult).value
...
def get_packet_core_data_plane_output(packet_core_control_plane_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20220301preview:getPacketCoreDataPlane', __args__, opts=opts, typ=GetPacketCoreDataPlaneResult)
