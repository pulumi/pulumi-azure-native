...
warnings.warn("""azure-native:mobilenetwork/v20220301preview:Slice is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:Slice to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_slice(mobile_network_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_slice is deprecated: azure-native:mobilenetwork/v20220301preview:Slice is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:Slice to guarantee forwards compatibility.""")
    __args__ = dict()
