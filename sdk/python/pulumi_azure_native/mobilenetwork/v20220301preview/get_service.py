...
def get_service(mobile_network_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: azure-native:mobilenetwork/v20220301preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:Service to guarantee forwards compatibility.""")
    __args__ = dict()
