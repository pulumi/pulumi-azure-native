...
def get_data_network(data_network_name: Optional[str] = None,
    ...
    :param str data_network_name: The name of the mobile network dataNetwork.
    :param str mobile_network_name: The name of the mobile network.
    :param str resource_group_name: The name of the resource group. The name is case insensitive.
    """
    pulumi.log.warn("""get_data_network is deprecated: azure-native:mobilenetwork/v20220301preview:DataNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:mobilenetwork/v20220401preview:DataNetwork to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataNetworkName'] = data_network_name
    __args__['mobileNetworkName'] = mobile_network_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20220301preview:getDataNetwork', __args__, opts=opts, typ=GetDataNetworkResult).value
