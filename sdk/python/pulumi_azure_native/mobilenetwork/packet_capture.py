...
class PacketCaptureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] bytes_to_capture_per_packet: Number of bytes captured per packet, the remaining bytes are truncated. The default "0" means the entire packet is captured.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] network_interfaces: List of network interfaces to capture on.
...
@pulumi.type_token("azure-native:mobilenetwork:PacketCapture")
class PacketCapture(pulumi.CustomResource):
    ...
    def capture_start_time(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def output_files(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
