...
class PacketCaptureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] bytes_to_capture_per_packet: Number of bytes captured per packet, the remaining bytes are truncated. The default "0" means the entire packet is captured.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_interfaces: List of network interfaces to capture on.
...
class PacketCapture(pulumi.CustomResource):
    ...
    def capture_start_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def output_files(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
