...
class PacketCoreControlPlaneArgs:
    def __init__(__self__, *,
                 ...
                 sku: pulumi.Input[Union[builtins.str, 'BillingSku']],
                 control_plane_access_virtual_ipv4_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 core_network_technology: Optional[pulumi.Input[Union[builtins.str, 'CoreNetworkType']]] = None,
                 ...
                 ue_mtu: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'BillingSku']] sku: The SKU defining the throughput and SIM allowances for this packet core control plane deployment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] control_plane_access_virtual_ipv4_addresses: The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
        :param pulumi.Input[Union[builtins.str, 'CoreNetworkType']] core_network_technology: The core network technology generation (5G core or EPC / 4G core).
        ...
        :param pulumi.Input[builtins.int] ue_mtu: The MTU (in bytes) signaled to the UE. The same MTU is set on the user plane data links for all data networks. The MTU set on the user plane access link is calculated to be 60 bytes greater than this value to allow for GTP encapsulation.
        :param pulumi.Input['UserConsentConfigurationArgs'] user_consent: The user consent configuration for the packet core.
        :param pulumi.Input[builtins.str] version: The desired version of the packet core software.
        """
    ...
    @property
    @pulumi.getter
    def sku(self) -> pulumi.Input[Union[builtins.str, 'BillingSku']]:
        """
    ...
    @sku.setter
    def sku(self, value: pulumi.Input[Union[builtins.str, 'BillingSku']]):
        pulumi.set(self, "sku", value)

    @property
    @pulumi.getter(name="controlPlaneAccessVirtualIpv4Addresses")
    def control_plane_access_virtual_ipv4_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
        """
    ...
    def control_plane_access_virtual_ipv4_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "control_plane_access_virtual_ipv4_addresses", value)

    @property
    @pulumi.getter(name="coreNetworkTechnology")
    def core_network_technology(self) -> Optional[pulumi.Input[Union[builtins.str, 'CoreNetworkType']]]:
        """
    ...
    def core_network_technology(self, value: Optional[pulumi.Input[Union[builtins.str, 'CoreNetworkType']]]):
    ...
    def packet_core_control_plane_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def packet_core_control_plane_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ue_mtu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @ue_mtu.setter
    def ue_mtu(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PacketCoreControlPlane(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sku: Optional[pulumi.Input[Union[builtins.str, 'BillingSku']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ue_mtu: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="controlPlaneAccessVirtualIpv4Addresses")
    def control_plane_access_virtual_ipv4_addresses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The virtual IP address(es) for the control plane on the access network in a High Availability (HA) system. In an HA deployment the access network router should be configured to anycast traffic for this address to the control plane access interfaces on the active and standby nodes. In non-HA system this list should be omitted or empty.
        """
        return pulumi.get(self, "control_plane_access_virtual_ipv4_addresses")
    ...
    @property
    @pulumi.getter(name="coreNetworkTechnology")
    def core_network_technology(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The core network technology generation (5G core or EPC / 4G core).
        """
        return pulumi.get(self, "core_network_technology")
    ...
    def installed_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def rollback_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="ueMtu")
    def ue_mtu(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The MTU (in bytes) signaled to the UE. The same MTU is set on the user plane data links for all data networks. The MTU set on the user plane access link is calculated to be 60 bytes greater than this value to allow for GTP encapsulation.
        """
        return pulumi.get(self, "ue_mtu")
