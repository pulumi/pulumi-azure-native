...
class MobileNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:MobileNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:MobileNetwork")])
