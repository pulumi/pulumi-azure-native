...
class AsyncOperationIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an Azure Async Operation ID.
        :param _builtins.str id: Azure Async Operation ID.
        """
...
class AttachedDataNetworkResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an attached data network resource.
        :param _builtins.str id: Attached data network resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class AzureStackEdgeDeviceResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an Azure Stack Edge device resource.
        :param _builtins.str id: Azure Stack Edge device resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class AzureStackHCIClusterResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an Azure Stack HCI cluster resource.
        :param _builtins.str id: Azure Stack HCI cluster resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class CertificateProvisioningResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Certificate provisioning state
        :param _builtins.str reason: Reason for certificate provisioning failure.
        :param _builtins.str state: The certificate's provisioning state
        """
...
class ConnectedClusterResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an Azure Arc custom location resource.
        :param _builtins.str id: Azure Arc connected cluster resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class CustomLocationResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to an Azure Arc custom location resource.
        :param _builtins.str id: Azure Arc custom location resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class DataNetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 five_qi: Optional[_builtins.int] = None,
                 maximum_number_of_buffered_packets: Optional[_builtins.int] = None,
        ...
        :param Sequence[_builtins.str] additional_allowed_session_types: Allowed session types in addition to the default session type. Must not duplicate the default session type.
        ...
        :param _builtins.int five_qi: Default 5G QoS Flow Indicator value. The 5QI identifies a specific QoS forwarding treatment to be provided to a flow. See 3GPP TS23.501 section 5.7.2.1 for a full description of the 5QI parameter, and table 5.7.4-1 for the definition the 5QI values.
        :param _builtins.int maximum_number_of_buffered_packets: The maximum number of downlink packets to buffer at the user plane for High Latency Communication - Extended Buffering. See 3GPP TS29.272 v15.10.0 section 7.3.188 for a full description. This maximum is not guaranteed because there is a internal limit on buffered packets across all PDU sessions.
        :param _builtins.str preemption_capability: Default QoS Flow preemption capability. The preemption capability of a QoS Flow controls whether it can preempt another QoS Flow with a lower priority level. See 3GPP TS23.501 section 5.7.2.2 for a full description of the ARP parameters.
        :param _builtins.str preemption_vulnerability: Default QoS Flow preemption vulnerability. The preemption vulnerability of a QoS Flow controls whether it can be preempted by a QoS Flow with a higher priority level. See 3GPP TS23.501 section 5.7.2.2 for a full description of the ARP parameters.
        """
    ...
    def five_qi(self) -> Optional[_builtins.int]:
        """
    ...
    def maximum_number_of_buffered_packets(self) -> Optional[_builtins.int]:
        """
...
class DataNetworkResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a data network resource.
        :param _builtins.str id: Data network resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class DiagnosticsUploadConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 storage_account_container_url: _builtins.str):
        """
        Configuration for uploading packet core diagnostics.
        :param _builtins.str storage_account_container_url: The Storage Account Container URL to upload diagnostics to.
        """
...
class EventHubConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 id: _builtins.str,
                 reporting_interval: Optional[_builtins.int] = None):
        """
        Configuration for sending packet core events to Azure Event Hub.
        :param _builtins.str id: Resource ID  of Azure Event Hub to send packet core events to.
        :param _builtins.int reporting_interval: The duration (in seconds) between UE usage reports.
        """
        pulumi.set(__self__, "id", id)
    ...
    def reporting_interval(self) -> Optional[_builtins.int]:
        """
...
class HomeNetworkPrivateKeysProvisioningResponse(dict):
    def __init__(__self__, *,
                 state: _builtins.str):
        """
        :param _builtins.str state: The provisioning state of the private keys for SUPI concealment.
        """
        pulumi.set(__self__, "state", state)
...
class HomeNetworkPublicKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A key used for SUPI concealment.
        :param _builtins.int id: The Home Network Public Key Identifier determines which public key was used to generate the SUCI sent to the AMF. See TS 23.003 Section 2.2B Section 5.
        :param _builtins.str url: The URL of Azure Key Vault secret containing the private key, versioned or unversioned. For example: https://contosovault.vault.azure.net/secrets/mySuciPrivateKey/562a4bb76b524a1493a6afe8e536ee78.
        """
        pulumi.set(__self__, "id", id)
        if url is not None:
...
class HttpsServerCertificateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        HTTPS server certificate configuration.
        :param _builtins.str certificate_url: The certificate URL, unversioned. For example: https://contosovault.vault.azure.net/certificates/ingress.
...
class InstallationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reasons: Sequence[_builtins.str],
                 reinstall_required: _builtins.str,
                 state: _builtins.str,
        ...
        :param Sequence[_builtins.str] reasons: Reason(s) for the current installation state of the packet core.
        :param _builtins.str reinstall_required: Whether a reinstall of the packet core is required to pick up the latest configuration changes.
        :param _builtins.str state: Installation state
        :param _builtins.str desired_state: The desired installation state
        """
    ...
    @_builtins.property
    @pulumi.getter
    def reasons(self) -> Sequence[_builtins.str]:
        """
    ...
    def reinstall_required(self) -> _builtins.str:
        """
...
class InterfacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 bfd_ipv4_endpoints: Optional[Sequence[_builtins.str]] = None,
                 ipv4_address: Optional[_builtins.str] = None,
                 ipv4_address_list: Optional[Sequence[_builtins.str]] = None,
                 ipv4_gateway: Optional[_builtins.str] = None,
                 ipv4_subnet: Optional[_builtins.str] = None,
                 name: Optional[_builtins.str] = None,
                 vlan_id: Optional[_builtins.int] = None):
        """
        Interface properties
        :param Sequence[_builtins.str] bfd_ipv4_endpoints: The IPv4 addresses of the endpoints to send BFD probes to.
        :param _builtins.str ipv4_address: The IPv4 address.
        :param Sequence[_builtins.str] ipv4_address_list: The list of IPv4 addresses, for a multi-node system.
        :param _builtins.str ipv4_gateway: The default IPv4 gateway (router).
        :param _builtins.str ipv4_subnet: The IPv4 subnet.
        :param _builtins.str name: The logical name for this interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        :param _builtins.int vlan_id: VLAN identifier of the network interface. Example: 501.
        """
    ...
    def bfd_ipv4_endpoints(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def ipv4_address_list(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def ipv4_subnet(self) -> Optional[_builtins.str]:
        """
        The IPv4 subnet.
        """
...
class KeyVaultKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An Azure key vault key.
        :param _builtins.str key_url: The key URL, unversioned. For example: https://contosovault.vault.azure.net/keys/azureKey.
        """
...
class ManagedServiceIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Managed service identity (User assigned identity)
        :param _builtins.str type: Type of managed service identity (currently only UserAssigned allowed).
...
class MobileNetworkResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a mobile network resource.
        :param _builtins.str id: Mobile network resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class NASRerouteConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 macro_mme_group_id: _builtins.int):
        """
        Configuration enabling NAS reroute.
        :param _builtins.int macro_mme_group_id: The macro network's MME group ID. This is where unknown UEs are sent to via NAS reroute.
        """
        pulumi.set(__self__, "macro_mme_group_id", macro_mme_group_id)

    @_builtins.property
    @pulumi.getter(name="macroMmeGroupId")
    def macro_mme_group_id(self) -> _builtins.int:
        """
...
class NaptConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pinhole_limits: Optional[_builtins.int] = None,
        ...
        """
        The network address and port translation settings to use for the attached data network.
        :param _builtins.str enabled: Whether NAPT is enabled for connections to this attached data network.
        :param _builtins.int pinhole_limits: Maximum number of UDP and TCP pinholes that can be open simultaneously on the core interface. For 5G networks, this is the N6 interface. For 4G networks, this is the SGi interface.
    ...
    def pinhole_limits(self) -> Optional[_builtins.int]:
        """
...
class PccRuleConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 traffic_control: Optional[_builtins.str] = None):
        """
        Data flow policy rule configuration
        :param _builtins.str rule_name: The name of the rule. This must be unique within the parent service. You must not use any of the following reserved strings - `default`, `requested` or `service`.
        :param _builtins.int rule_precedence: A precedence value that is used to decide between data flow policy rules when identifying the QoS values to use for a particular SIM. A lower value means a higher priority. This value should be unique among all data flow policy rules configured in the mobile network.
        ...
        :param _builtins.str traffic_control: Determines whether flows that match this data flow policy rule are permitted.
        """
    ...
    def rule_precedence(self) -> _builtins.int:
        """
    ...
    def traffic_control(self) -> Optional[_builtins.str]:
        """
...
class PccRuleQosPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int five_qi: 5G QoS Flow Indicator value. The 5QI identifies a specific QoS forwarding treatment to be provided to a flow. See 3GPP TS23.501 section 5.7.2.1 for a full description of the 5QI parameter, and table 5.7.4-1 for the definition the 5QI values.
        ...
        :param _builtins.str preemption_capability: QoS Flow preemption capability. The preemption capability of a QoS Flow controls whether it can preempt another QoS Flow with a lower priority level. See 3GPP TS23.501 section 5.7.2.2 for a full description of the ARP parameters.
        :param _builtins.str preemption_vulnerability: QoS Flow preemption vulnerability. The preemption vulnerability of a QoS Flow controls whether it can be preempted by a QoS Flow with a higher priority level. See 3GPP TS23.501 section 5.7.2.2 for a full description of the ARP parameters.
        """
...
class PinholeTimeoutsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 icmp: Optional[_builtins.int] = None,
                 tcp: Optional[_builtins.int] = None,
                 udp: Optional[_builtins.int] = None):
        """
        Expiry times of inactive NAPT pinholes, in seconds. All timers must be at least 1 second.
        :param _builtins.int icmp: Pinhole timeout for ICMP pinholes in seconds. Default for ICMP Echo is 30 seconds.
        :param _builtins.int tcp: Pinhole timeout for TCP pinholes in seconds. Default for TCP is 3 minutes.
        :param _builtins.int udp: Pinhole timeout for UDP pinholes in seconds. Default for UDP is 30 seconds.
        """
        if icmp is None:
            icmp = 30
        if icmp is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def icmp(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tcp(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def udp(self) -> Optional[_builtins.int]:
        """
...
class PlatformConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The platform type where packet core is deployed.
...
class PlmnIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Public land mobile network (PLMN) ID. This is made up of the mobile country code and mobile network code, as defined in https://www.itu.int/rec/T-REC-E.212. The values 001-01 and 001-001 can be used for testing and the values 999-99 and 999-999 can be used on internal private networks.
        :param _builtins.str mcc: Mobile country code (MCC).
        :param _builtins.str mnc: Mobile network code (MNC).
        """
...
class PortRangeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        If not specified and NAPT is enabled, this range defaults to 1,024 - 49,999.
        (Ports under 1,024 should not be used because these are special purpose ports reserved by IANA. Ports 50,000 and above are reserved for non-NAPT use.)
        :param _builtins.int max_port: The maximum port number
        :param _builtins.int min_port: The minimum port number
        """
        if max_port is None:
            max_port = 49999
...
class PortReuseHoldTimesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The minimum time (in seconds) that will pass before a port that was used by a closed pinhole can be recycled for use by another pinhole. All hold times must be minimum 1 second.
        :param _builtins.int tcp: Minimum time in seconds that will pass before a TCP port that was used by a closed pinhole can be reused. Default for TCP is 2 minutes.
        :param _builtins.int udp: Minimum time in seconds that will pass before a UDP port that was used by a closed pinhole can be reused. Default for UDP is 1 minute.
        """
        if tcp is None:
            tcp = 120
        if tcp is not None:
...
class ServiceDataFlowTemplateResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 protocol: Sequence[_builtins.str],
                 remote_ip_list: Sequence[_builtins.str],
                 template_name: _builtins.str,
                 ports: Optional[Sequence[_builtins.str]] = None):
        """
        Data flow template
        :param _builtins.str direction: The direction of this flow.
        :param Sequence[_builtins.str] protocol: A list of the allowed protocol(s) for this flow. If you want this flow to be able to use any protocol within the internet protocol suite, use the value `ip`. If you only want to allow a selection of protocols, you must use the corresponding IANA Assigned Internet Protocol Number for each protocol, as described in https://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml. For example, for UDP, you must use 17. If you use the value `ip` then you must leave the field `port` unspecified.
        :param Sequence[_builtins.str] remote_ip_list: The remote IP address(es) to which UEs will connect for this flow. If you want to allow connections on any IP address, use the value `any`. Otherwise, you must provide each of the remote IP addresses to which the packet core instance will connect for this flow. You must provide each IP address in CIDR notation, including the netmask (for example, 192.0.2.54/24).
        :param _builtins.str template_name: The name of the data flow template. This must be unique within the parent data flow policy rule. You must not use any of the following reserved strings - `default`, `requested` or `service`.
        :param Sequence[_builtins.str] ports: The port(s) to which UEs will connect for this flow. You can specify zero or more ports or port ranges. If you specify one or more ports or port ranges then you must specify a value other than `ip` in the `protocol` field. This is an optional setting. If you do not specify it then connections will be allowed on all ports. Port ranges must be specified as <FirstPort>-<LastPort>. For example: [`8080`, `8082-8085`].
        """
    ...
    @_builtins.property
    @pulumi.getter
    def protocol(self) -> Sequence[_builtins.str]:
        """
    ...
    def remote_ip_list(self) -> Sequence[_builtins.str]:
        """
...
class ServiceResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a service resource.
        :param _builtins.str id: Service resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class SignalingConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 nas_encryption: Optional[Sequence[_builtins.str]] = None,
                 nas_reroute: Optional['outputs.NASRerouteConfigurationResponse'] = None):
        """
        Signaling configuration for the packet core.
        :param Sequence[_builtins.str] nas_encryption: An ordered list of NAS encryption algorithms, used to encrypt control plane traffic between the UE and packet core, in order from most to least preferred. If not specified, the packet core will use a built-in default ordering.
    ...
    def nas_encryption(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class SimGroupResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: The provisioning state of the SIM group resource.
...
class SimPolicyResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a SIM policy resource.
        :param _builtins.str id: SIM policy resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class SimStaticIpPropertiesResponseStaticIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The static IP configuration for the SIM to use at the defined network scope.
        :param _builtins.str ipv4_address: The IPv4 address assigned to the SIM at this network scope. This address must be in the userEquipmentStaticAddressPoolPrefix defined in the attached data network.
        """
        if ipv4_address is not None:
            pulumi.set(__self__, "ipv4_address", ipv4_address)
...
class SiteResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a site resource.
        :param _builtins.str id: Site resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class SliceResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to a slice resource.
        :param _builtins.str id: Slice resource ID.
        """
        pulumi.set(__self__, "id", id)
...
class SnssaiResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Single-network slice selection assistance information (S-NSSAI).
        :param _builtins.int sst: Slice/service type (SST).
        :param _builtins.str sd: Slice differentiator (SD).
        """
...
class UserConsentConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_support_telemetry_access: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_support_telemetry_access: Allow Microsoft to access non-PII telemetry information from the packet core.
        """
    ...
    def allow_support_telemetry_access(self) -> Optional[_builtins.bool]:
        """
