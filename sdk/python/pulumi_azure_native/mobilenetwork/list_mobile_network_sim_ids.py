...
def list_mobile_network_sim_ids(mobile_network_name: Optional[builtins.str] = None,
...
def list_mobile_network_sim_ids_output(mobile_network_name: Optional[pulumi.Input[builtins.str]] = None,
