...
def list_mobile_network_sim_groups(mobile_network_name: Optional[_builtins.str] = None,
...
def list_mobile_network_sim_groups_output(mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
