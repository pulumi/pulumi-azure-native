...
class SimGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sim_group_name: The name of the SIM Group.
    ...
    def sim_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sim_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
