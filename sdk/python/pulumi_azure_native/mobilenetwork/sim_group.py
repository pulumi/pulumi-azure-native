...
class SimGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption_key is not None and not isinstance(encryption_key, KeyVaultKeyArgs):
                encryption_key = encryption_key or {}
                def _setter(key, value):
                    encryption_key[key] = value
                KeyVaultKeyArgs._configure(_setter, **encryption_key)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimGroup"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimGroup")])
