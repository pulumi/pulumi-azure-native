...
def list_mobile_network_sim_ids(mobile_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20220101preview:listMobileNetworkSimIds', __args__, opts=opts, typ=ListMobileNetworkSimIdsResult).value
