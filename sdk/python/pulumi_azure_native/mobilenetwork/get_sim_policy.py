...
class GetSimPolicyResult:
    ...
    def registration_timer(self) -> Optional[_builtins.int]:
        """
    ...
    def rfsp_index(self) -> Optional[_builtins.int]:
        """
    ...
    def site_provisioning_state(self) -> Mapping[str, _builtins.str]:
        """
...
def get_sim_policy(mobile_network_name: Optional[_builtins.str] = None,
                   resource_group_name: Optional[_builtins.str] = None,
                   sim_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sim_policy_name: The name of the SIM policy.
    """
    __args__ = dict()
...
def get_sim_policy_output(mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
