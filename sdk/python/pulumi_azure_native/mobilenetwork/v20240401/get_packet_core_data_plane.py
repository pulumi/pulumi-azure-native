...
def get_packet_core_data_plane(packet_core_control_plane_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20240401:getPacketCoreDataPlane', __args__, opts=opts, typ=GetPacketCoreDataPlaneResult).value
...
def get_packet_core_data_plane_output(packet_core_control_plane_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20240401:getPacketCoreDataPlane', __args__, opts=opts, typ=GetPacketCoreDataPlaneResult)
