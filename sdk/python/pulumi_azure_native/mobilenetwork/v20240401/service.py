...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Service"), pulumi.Alias(type_="azure-native:mobilenetwork:Service")])
