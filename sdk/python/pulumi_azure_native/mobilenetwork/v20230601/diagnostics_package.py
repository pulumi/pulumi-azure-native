...
class DiagnosticsPackage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:DiagnosticsPackage"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:DiagnosticsPackage"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:DiagnosticsPackage"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:DiagnosticsPackage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiagnosticsPackage, __self__).__init__(
            'azure-native:mobilenetwork/v20230601:DiagnosticsPackage',
            resource_name,
            __props__,
            opts)
