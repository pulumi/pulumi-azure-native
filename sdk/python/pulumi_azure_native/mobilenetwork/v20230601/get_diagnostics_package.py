...
def get_diagnostics_package(diagnostics_package_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230601:getDiagnosticsPackage', __args__, opts=opts, typ=GetDiagnosticsPackageResult).value
...
def get_diagnostics_package_output(diagnostics_package_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230601:getDiagnosticsPackage', __args__, opts=opts, typ=GetDiagnosticsPackageResult)
