...
def get_sim_group_sim(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230601:getSimGroupSim', __args__, opts=opts, typ=GetSimGroupSimResult).value
...
def get_sim_group_sim_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230601:getSimGroupSim', __args__, opts=opts, typ=GetSimGroupSimResult)
