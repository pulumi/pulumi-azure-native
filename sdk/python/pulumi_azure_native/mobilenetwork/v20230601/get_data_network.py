...
def get_data_network(data_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230601:getDataNetwork', __args__, opts=opts, typ=GetDataNetworkResult).value
...
def get_data_network_output(data_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230601:getDataNetwork', __args__, opts=opts, typ=GetDataNetworkResult)
