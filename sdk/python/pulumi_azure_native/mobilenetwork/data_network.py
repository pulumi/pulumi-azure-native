...
class DataNetworkArgs:
    def __init__(__self__, *,
                 ...
                 data_network_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] data_network_name: The name of the data network.
        :param pulumi.Input[builtins.str] description: An optional description for this data network.
    ...
    def data_network_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_network_name(self, value: Optional[pulumi.Input[builtins.str]]):
