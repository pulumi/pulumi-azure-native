...
class DataNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:DataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:DataNetwork")])
