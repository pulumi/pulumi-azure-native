...
class DiagnosticsPackageArgs:
    def __init__(__self__, *,
        ...
        """
        DiagnosticsPackageArgs._configure(
    ...
    def _configure(
        ...
        if diagnostics_package_name is None and 'diagnosticsPackageName' in kwargs:
            diagnostics_package_name = kwargs['diagnosticsPackageName']

        _setter("packet_core_control_plane_name", packet_core_control_plane_name)
        _setter("resource_group_name", resource_group_name)
        if diagnostics_package_name is not None:
            _setter("diagnostics_package_name", diagnostics_package_name)
...
class DiagnosticsPackage(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DiagnosticsPackageArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:DiagnosticsPackage"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:DiagnosticsPackage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiagnosticsPackage, __self__).__init__(
            'azure-native:mobilenetwork/v20230901:DiagnosticsPackage',
            resource_name,
            __props__,
            opts)
