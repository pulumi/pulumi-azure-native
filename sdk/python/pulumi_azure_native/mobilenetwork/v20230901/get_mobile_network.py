...
def get_mobile_network(mobile_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230901:getMobileNetwork', __args__, opts=opts, typ=GetMobileNetworkResult).value
...
def get_mobile_network_output(mobile_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230901:getMobileNetwork', __args__, opts=opts, typ=GetMobileNetworkResult)
