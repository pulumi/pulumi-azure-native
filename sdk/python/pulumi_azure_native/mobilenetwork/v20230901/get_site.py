...
def get_site(mobile_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230901:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(mobile_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230901:getSite', __args__, opts=opts, typ=GetSiteResult)
