...
class Sim(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:Sim"), pulumi.Alias(type_="azure-native:mobilenetwork:Sim")])
