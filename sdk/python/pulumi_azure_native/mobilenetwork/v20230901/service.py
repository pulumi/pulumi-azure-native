...
class ServiceArgs:
    ...
    def _configure(
             ...
             pcc_rules: Optional[pulumi.Input[Sequence[pulumi.Input['PccRuleConfigurationArgs']]]] = None,
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            service_qos_policy = _utilities.configure(service_qos_policy, QosPolicyArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:Service"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:Service")])
