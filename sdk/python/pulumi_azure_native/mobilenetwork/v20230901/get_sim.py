...
def get_sim(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20230901:getSim', __args__, opts=opts, typ=GetSimResult).value
...
def get_sim_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['simName'] = sim_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20230901:getSim', __args__, opts=opts, typ=GetSimResult)
