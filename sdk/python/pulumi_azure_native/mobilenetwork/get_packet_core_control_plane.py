...
class GetPacketCoreControlPlaneResult:
    ...
    def control_plane_access_virtual_ipv4_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def core_network_technology(self) -> Optional[_builtins.str]:
        """
    ...
    def rollback_version(self) -> _builtins.str:
        """
    ...
    def ue_mtu(self) -> Optional[_builtins.int]:
        """
...
def get_packet_core_control_plane(packet_core_control_plane_name: Optional[_builtins.str] = None,
...
def get_packet_core_control_plane_output(packet_core_control_plane_name: Optional[pulumi.Input[_builtins.str]] = None,
