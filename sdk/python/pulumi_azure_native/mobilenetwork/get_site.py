...
class GetSiteResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, network_functions=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_site(mobile_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str site_name: The name of the mobile network site.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(mobile_network_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork:getSite', __args__, opts=opts, typ=GetSiteResult)
