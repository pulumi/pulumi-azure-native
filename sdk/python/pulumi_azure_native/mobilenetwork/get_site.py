...
def get_site(mobile_network_name: Optional[builtins.str] = None,
    ...
    :param builtins.str site_name: The name of the mobile network site.
    """
    __args__ = dict()
...
def get_site_output(mobile_network_name: Optional[pulumi.Input[builtins.str]] = None,
