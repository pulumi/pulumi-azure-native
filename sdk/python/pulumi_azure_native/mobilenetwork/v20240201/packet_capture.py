...
class PacketCapture(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:PacketCapture"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:PacketCapture"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:PacketCapture"), pulumi.Alias(type_="azure-native:mobilenetwork:PacketCapture")])
