...
def get_sim_policy(mobile_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilenetwork/v20240201:getSimPolicy', __args__, opts=opts, typ=GetSimPolicyResult).value
...
def get_sim_policy_output(mobile_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['simPolicyName'] = sim_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilenetwork/v20240201:getSimPolicy', __args__, opts=opts, typ=GetSimPolicyResult)
