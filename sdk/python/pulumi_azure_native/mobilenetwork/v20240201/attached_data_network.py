...
class AttachedDataNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:AttachedDataNetwork"), pulumi.Alias(type_="azure-native:mobilenetwork:AttachedDataNetwork")])
