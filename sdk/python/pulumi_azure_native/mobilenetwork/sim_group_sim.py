...
class SimGroupSim(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilenetwork/v20220401preview:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20221101:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230601:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20230901:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240201:SimGroupSim"), pulumi.Alias(type_="azure-native:mobilenetwork/v20240401:SimGroupSim")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SimGroupSim, __self__).__init__(
            'azure-native:mobilenetwork:SimGroupSim',
            resource_name,
            __props__,
            opts)
