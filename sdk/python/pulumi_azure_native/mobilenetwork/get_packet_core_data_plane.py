...
class GetPacketCoreDataPlaneResult:
    ...
    def user_plane_access_virtual_ipv4_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_packet_core_data_plane(packet_core_control_plane_name: Optional[_builtins.str] = None,
...
def get_packet_core_data_plane_output(packet_core_control_plane_name: Optional[pulumi.Input[_builtins.str]] = None,
