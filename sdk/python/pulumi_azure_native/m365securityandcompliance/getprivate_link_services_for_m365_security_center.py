...
def getprivate_link_services_for_m365_security_center(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:m365securityandcompliance:getprivateLinkServicesForM365SecurityCenter', __args__, opts=opts, typ=GetprivateLinkServicesForM365SecurityCenterResult).value
