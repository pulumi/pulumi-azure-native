...
def getprivate_link_services_for_m365_compliance_center(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:m365securityandcompliance/v20210325preview:getprivateLinkServicesForM365ComplianceCenter', __args__, opts=opts, typ=GetprivateLinkServicesForM365ComplianceCenterResult).value
