...
class PrivateLinkServicesForEDMUpload(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_services_for_edm_upload = azure_native.m365securityandcompliance.v20210325preview.PrivateLinkServicesForEDMUpload("privateLinkServicesForEDMUpload",
        ...
        ```sh
        $ pulumi import azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForEDMUpload service2 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForEDMUpload/service2 
        ```
