...
class PrivateLinkServicesForSCCPowershellArgs:
    def __init__(__self__, *,
        ...
        """
        PrivateLinkServicesForSCCPowershellArgs._configure(
...
class PrivateLinkServicesForSCCPowershell(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PrivateLinkServicesForSCCPowershellArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if identity is not None and not isinstance(identity, ServicesResourceIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                ServicesResourceIdentityArgs._configure(_setter, **identity)
            __props__.__dict__["identity"] = identity
            if kind is None and not opts.urn:
                raise TypeError("Missing required property 'kind'")
            __props__.__dict__["kind"] = kind
            __props__.__dict__["location"] = location
            if properties is not None and not isinstance(properties, ServicesPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ServicesPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:m365securityandcompliance:PrivateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:m365securityandcompliance:privateLinkServicesForSCCPowershell")])
