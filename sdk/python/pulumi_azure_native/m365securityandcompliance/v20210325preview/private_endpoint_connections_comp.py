...
class PrivateEndpointConnectionsComp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connections_comp = azure_native.m365securityandcompliance.v20210325preview.PrivateEndpointConnectionsComp("privateEndpointConnectionsComp",
        ...
        ```sh
        $ pulumi import azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp myConnection /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter/service1/privateEndpointConnections/myConnection 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:m365securityandcompliance:PrivateEndpointConnectionsComp")])
