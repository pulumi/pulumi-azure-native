...
def getprivate_link_services_for_o365_management_activity_api(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:m365securityandcompliance:getprivateLinkServicesForO365ManagementActivityAPI', __args__, opts=opts, typ=GetprivateLinkServicesForO365ManagementActivityAPIResult).value
