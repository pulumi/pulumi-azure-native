...
class PrivateLinkServicesForEDMUpload(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:m365securityandcompliance:privateLinkServicesForEDMUpload")])
