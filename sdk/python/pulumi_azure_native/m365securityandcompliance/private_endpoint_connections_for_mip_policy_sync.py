...
class PrivateEndpointConnectionsForMIPPolicySyncArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_name: The name of the service instance.
...
@pulumi.type_token("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync")
class PrivateEndpointConnectionsForMIPPolicySync(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group that contains the service instance.
        :param pulumi.Input[builtins.str] resource_name_: The name of the service instance.
        """
        ...
    @overload
    def __init__(__self__,
