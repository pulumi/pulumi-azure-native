...
class ServiceAccessPolicyEntryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An access policy entry.
        :param builtins.str object_id: An Azure AD object ID (User or Apps) that is allowed access to the FHIR service.
        """
...
class ServiceAuthenticationConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Authentication configuration information
        :param builtins.str audience: The audience url for the service
        :param builtins.str authority: The authority url for the service
        :param builtins.bool smart_proxy_enabled: If the SMART on FHIR proxy is enabled
        """
...
class ServiceCorsConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_age: Optional[builtins.float] = None,
                 methods: Optional[Sequence[builtins.str]] = None,
                 origins: Optional[Sequence[builtins.str]] = None):
        """
        The settings for the CORS configuration of the service instance.
        :param builtins.bool allow_credentials: If credentials are allowed via CORS.
        :param Sequence[builtins.str] headers: The headers to be allowed via CORS.
        :param builtins.float max_age: The max age to be allowed via CORS.
        :param Sequence[builtins.str] methods: The methods to be allowed via CORS.
        :param Sequence[builtins.str] origins: The origins to be allowed via CORS.
        """
    ...
    def max_age(self) -> Optional[builtins.float]:
        """
...
class ServiceCosmosDbConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 offer_throughput: Optional[builtins.float] = None):
        """
        The settings for the Cosmos DB database backing the service.
        :param builtins.str key_vault_key_uri: The URI of the customer-managed key for the backing database.
        :param builtins.float offer_throughput: The provisioned throughput for the backing database.
        """
    ...
    def offer_throughput(self) -> Optional[builtins.float]:
        """
...
class ServiceExportConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Export operation configuration information
        :param builtins.str storage_account_name: The name of the default export storage account.
        """
...
class ServicesPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str public_network_access: Control permission for data plane traffic coming from public networks while private endpoint is enabled.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class ServicesResourceResponseIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Setting indicating whether the service has a managed identity associated with it.
        :param builtins.str principal_id: The principal ID of the resource identity.
        :param builtins.str tenant_id: The tenant ID of the resource.
        :param builtins.str type: Type of identity being specified, currently SystemAssigned and None are allowed.
        """
