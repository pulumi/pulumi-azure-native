...
class ServiceCorsConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_age: Optional[_builtins.float] = None,
        ...
        :param Sequence[_builtins.str] methods: The methods to be allowed via CORS.
        :param Sequence[_builtins.str] origins: The origins to be allowed via CORS.
        """
