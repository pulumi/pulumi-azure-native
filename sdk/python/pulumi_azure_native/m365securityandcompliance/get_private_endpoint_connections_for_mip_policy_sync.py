...
__all__ = [
    ...
    'AwaitableGetPrivateEndpointConnectionsForMIPPolicySyncResult',
    'get_private_endpoint_connections_for_mip_policy_sync',
    'get_private_endpoint_connections_for_mip_policy_sync_output',
]

@pulumi.output_type
class GetPrivateEndpointConnectionsForMIPPolicySyncResult:
    """
...
class AwaitableGetPrivateEndpointConnectionsForMIPPolicySyncResult(GetPrivateEndpointConnectionsForMIPPolicySyncResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPrivateEndpointConnectionsForMIPPolicySyncResult(
...
def get_private_endpoint_connections_for_mip_policy_sync(private_endpoint_connection_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:m365securityandcompliance:getPrivateEndpointConnectionsForMIPPolicySync', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForMIPPolicySyncResult).value
...
def get_private_endpoint_connections_for_mip_policy_sync_output(private_endpoint_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:m365securityandcompliance:getPrivateEndpointConnectionsForMIPPolicySync', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForMIPPolicySyncResult)
