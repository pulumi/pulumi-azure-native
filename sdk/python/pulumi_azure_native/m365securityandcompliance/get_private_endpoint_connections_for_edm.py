...
def get_private_endpoint_connections_for_edm(private_endpoint_connection_name: Optional[_builtins.str] = None,
...
def get_private_endpoint_connections_for_edm_output(private_endpoint_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
