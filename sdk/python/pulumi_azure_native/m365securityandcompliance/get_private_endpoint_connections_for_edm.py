...
def get_private_endpoint_connections_for_edm(private_endpoint_connection_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:m365securityandcompliance:getPrivateEndpointConnectionsForEDM', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForEDMResult).value
...
def get_private_endpoint_connections_for_edm_output(private_endpoint_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                                                    resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                                    resource_name: Optional[pulumi.Input[builtins.str]] = None,
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPrivateEndpointConnectionsForEDMResult]:
    """
    Gets the specified private endpoint connection associated with the service.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:m365securityandcompliance:getPrivateEndpointConnectionsForEDM', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForEDMResult)
    return __ret__.apply(lambda __response__: GetPrivateEndpointConnectionsForEDMResult(
