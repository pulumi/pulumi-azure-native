...
class EnterpriseKnowledgeGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:enterpriseknowledgegraph:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-native:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-nextgen:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph")])
