...
class EnterpriseKnowledgeGraphPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The parameters to provide for the EnterpriseKnowledgeGraph.
        :param pulumi.Input[builtins.str] description: The description of the EnterpriseKnowledgeGraph
        :param Any metadata: Specifies the metadata  of the resource.
        :param pulumi.Input[builtins.str] provisioning_state: The state of EnterpriseKnowledgeGraph provisioning
        """
