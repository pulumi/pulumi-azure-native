...
class EnterpriseKnowledgeGraphArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource_name: The name of the EnterpriseKnowledgeGraph resource.
        ...
        """
        EnterpriseKnowledgeGraphArgs._configure(
...
class EnterpriseKnowledgeGraph(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EnterpriseKnowledgeGraphArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, EnterpriseKnowledgeGraphPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                EnterpriseKnowledgeGraphPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:enterpriseknowledgegraph:EnterpriseKnowledgeGraph")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseKnowledgeGraph, __self__).__init__(
            'azure-native:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph',
            resource_name,
            __props__,
            opts)
