...
class EnterpriseKnowledgeGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:enterpriseknowledgegraph/v20181203:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-native:enterpriseknowledgegraph:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-nextgen:enterpriseknowledgegraph:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-native:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph"), pulumi.Alias(type_="azure-nextgen:enterpriseknowledgegraph/latest:EnterpriseKnowledgeGraph")])
