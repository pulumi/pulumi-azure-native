...
def list_storage_account_sas_tokens(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/v20161101:listStorageAccountSasTokens', __args__, opts=opts, typ=ListStorageAccountSasTokensResult).value
...
def list_storage_account_sas_tokens_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datalakeanalytics/v20161101:listStorageAccountSasTokens', __args__, opts=opts, typ=ListStorageAccountSasTokensResult)
