...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_rule = azure_native.datalakeanalytics.v20161101.FirewallRule("firewallRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datalakeanalytics:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20151001preview:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20191101preview:FirewallRule")])
