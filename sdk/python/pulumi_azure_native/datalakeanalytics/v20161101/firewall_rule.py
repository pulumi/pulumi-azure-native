...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datalakeanalytics:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/latest:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20151001preview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule")])
