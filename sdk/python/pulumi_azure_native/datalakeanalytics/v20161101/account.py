...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account = azure_native.datalakeanalytics.v20161101.Account("account",
            ...
            data_lake_store_accounts=[azure_native.datalakeanalytics.v20161101.AddDataLakeStoreWithAccountParametersArgs(
                name="test_adls",
                suffix="test_suffix",
            )],
            default_data_lake_store_account="test_adls",
            firewall_allow_azure_ips=azure_native.datalakeanalytics/v20161101.FirewallAllowAzureIpsState.ENABLED,
            firewall_rules=[{
                "endIpAddress": "2.2.2.2",
                "name": "test_rule",
                "startIpAddress": "1.1.1.1",
            }],
            firewall_state=azure_native.datalakeanalytics/v20161101.FirewallState.ENABLED,
            location="eastus2",
            max_degree_of_parallelism=30,
            max_degree_of_parallelism_per_job=1,
            max_job_count=3,
            min_priority_per_job=1,
            new_tier=azure_native.datalakeanalytics/v20161101.TierType.CONSUMPTION,
            query_store_retention=30,
