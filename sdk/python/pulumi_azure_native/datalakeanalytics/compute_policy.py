...
class ComputePolicyArgs:
    def __init__(__self__, *,
                 ...
                 object_type: pulumi.Input[Union[builtins.str, 'AADObjectType']],
        ...
        :param pulumi.Input[builtins.str] object_id: The AAD object identifier for the entity to create a policy for.
        :param pulumi.Input[Union[builtins.str, 'AADObjectType']] object_type: The type of AAD object the object identifier refers to.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Azure resource group.
        :param pulumi.Input[builtins.str] compute_policy_name: The name of the compute policy to create or update.
        :param pulumi.Input[builtins.int] max_degree_of_parallelism_per_job: The maximum degree of parallelism per job this user can use to submit jobs. This property, the min priority per job property, or both must be passed.
        :param pulumi.Input[builtins.int] min_priority_per_job: The minimum priority per job this user can use to submit jobs. This property, the max degree of parallelism per job property, or both must be passed.
        """
    ...
    def object_type(self) -> pulumi.Input[Union[builtins.str, 'AADObjectType']]:
        """
    ...
    @object_type.setter
    def object_type(self, value: pulumi.Input[Union[builtins.str, 'AADObjectType']]):
    ...
    def compute_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compute_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComputePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 object_type: Optional[pulumi.Input[Union[builtins.str, 'AADObjectType']]] = None,
    ...
    @property
    @pulumi.getter(name="maxDegreeOfParallelismPerJob")
    def max_degree_of_parallelism_per_job(self) -> pulumi.Output[builtins.int]:
        """
