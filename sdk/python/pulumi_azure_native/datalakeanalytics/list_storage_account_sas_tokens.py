...
def list_storage_account_sas_tokens(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str storage_account_name: The name of the Azure storage account for which the SAS token is being requested.
    """
    __args__ = dict()
