...
class ComputePolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.str,
                 max_degree_of_parallelism_per_job: builtins.int,
                 min_priority_per_job: builtins.int,
                 name: builtins.str,
        ...
        :param builtins.int max_degree_of_parallelism_per_job: The maximum degree of parallelism per job this user can use to submit jobs.
        :param builtins.int min_priority_per_job: The minimum priority per job this user can use to submit jobs.
        :param builtins.str name: The resource name.
        :param builtins.str object_id: The AAD object identifier for the entity to create a policy for.
        :param builtins.str object_type: The type of AAD object the object identifier refers to.
...
class DataLakeStoreAccountInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: The resource identifier.
        :param builtins.str name: The resource name.
        :param builtins.str suffix: The optional suffix for the Data Lake Store account.
        :param builtins.str type: The resource type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class HiveMetastoreResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 name: builtins.str,
                 nested_resource_provisioning_state: builtins.str,
                 password: builtins.str,
                 runtime_version: builtins.str,
                 server_uri: builtins.str,
                 type: builtins.str,
                 user_name: builtins.str):
        """
        :param builtins.str database_name: The databaseName for the Hive MetaStore
        :param builtins.str id: The resource identifier.
        :param builtins.str name: The resource name.
        :param builtins.str nested_resource_provisioning_state: The current state of the NestedResource
        :param builtins.str password: The password for the Hive MetaStore
        :param builtins.str runtime_version: The runtimeVersion for the Hive MetaStore
        :param builtins.str server_uri: The serverUri for the Hive MetaStore
        :param builtins.str type: The resource type.
        :param builtins.str user_name: The userName for the Hive MetaStore
        """
    ...
    def nested_resource_provisioning_state(self) -> builtins.str:
        """
    ...
    def server_uri(self) -> builtins.str:
        """
...
class SasTokenInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SAS token information.
        :param builtins.str access_token: The access token for the associated Azure Storage Container.
        """
...
class StorageAccountInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: The resource identifier.
        :param builtins.str name: The resource name.
        :param builtins.str suffix: The optional suffix for the storage account.
        :param builtins.str type: The resource type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class VirtualNetworkRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 virtual_network_rule_state: builtins.str):
        """
        Data Lake Analytics  VirtualNetwork Rule information.
        :param builtins.str id: The resource identifier.
        :param builtins.str name: The resource name.
        ...
        :param builtins.str type: The resource type.
        :param builtins.str virtual_network_rule_state: The current state of the VirtualNetwork Rule
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
    ...
    def virtual_network_rule_state(self) -> builtins.str:
        """
