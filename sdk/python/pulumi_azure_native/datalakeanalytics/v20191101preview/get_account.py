...
class GetAccountResult:
    ...
    def max_queued_job_count_per_user(self) -> int:
        """
...
def get_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/v20191101preview:getAccount', __args__, opts=opts, typ=GetAccountResult).value
