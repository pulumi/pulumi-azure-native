...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account = azure_native.datalakeanalytics.v20191101preview.Account("account",
            ...
            data_lake_store_accounts=[azure_native.datalakeanalytics.v20191101preview.AddDataLakeStoreWithAccountParametersArgs(
                name="test_adls",
                suffix="test_suffix",
            )],
            default_data_lake_store_account="test_adls",
            firewall_allow_azure_ips=azure_native.datalakeanalytics/v20191101preview.FirewallAllowAzureIpsState.ENABLED,
            firewall_rules=[{
                "endIpAddress": "2.2.2.2",
                "name": "test_rule",
                "startIpAddress": "1.1.1.1",
            }],
            firewall_state=azure_native.datalakeanalytics/v20191101preview.FirewallState.ENABLED,
            location="eastus2",
            max_degree_of_parallelism=30,
            max_degree_of_parallelism_per_job=1,
            max_job_count=3,
            min_priority_per_job=1,
            new_tier=azure_native.datalakeanalytics/v20191101preview.TierType.CONSUMPTION,
            query_store_retention=30,
        ...
        ```sh
        $ pulumi import azure-native:datalakeanalytics/v20191101preview:Account test_account /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rgaba12041/providers/Microsoft.DataLakeAnalytics/accounts/testaba15818 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datalakeanalytics:Account"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20151001preview:Account"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20161101:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:datalakeanalytics/v20191101preview:Account',
            resource_name,
            __props__,
            opts)
