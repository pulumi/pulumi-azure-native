...
@pulumi.input_type
class AddStorageAccountPropertiesArgs:
    def __init__(__self__, *,
...
class AddStorageAccountWithAccountParametersArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[str],
                 properties: pulumi.Input['AddStorageAccountPropertiesArgs']):
        """
        The parameters used to add a new Azure Storage account while creating a new Data Lake Analytics account.
        :param pulumi.Input[str] name: The unique name of the Azure Storage account to add.
        :param pulumi.Input['AddStorageAccountPropertiesArgs'] properties: The Azure Storage account properties to use when adding a new Azure Storage account.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['AddStorageAccountPropertiesArgs']:
        """
        The Azure Storage account properties to use when adding a new Azure Storage account.
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['AddStorageAccountPropertiesArgs']):
