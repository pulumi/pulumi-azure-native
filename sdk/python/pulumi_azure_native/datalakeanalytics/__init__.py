...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datalakeanalytics:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datalakeanalytics:ComputePolicy":
                return ComputePolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datalakeanalytics:FirewallRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datalakeanalytics", _module_instance)
