...
def get_compute_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_compute_policy is deprecated: Version v20151001preview will be removed in the next major version of the provider. Upgrade to version v20161101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/v20151001preview:getComputePolicy', __args__, opts=opts, typ=GetComputePolicyResult).value
