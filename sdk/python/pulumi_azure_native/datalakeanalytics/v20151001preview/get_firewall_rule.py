...
def get_firewall_rule(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: Version 2015-10-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['firewallRuleName'] = firewall_rule_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/v20151001preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
