...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datalakeanalytics:getAccount'.""", DeprecationWarning)
...
def get_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/latest:getAccount', __args__, opts=opts, typ=GetAccountResult).value
