...
class MediaGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media/v20190901preview:MediaGraph"), pulumi.Alias(type_="azure-nextgen:media/v20190901preview:MediaGraph"), pulumi.Alias(type_="azure-native:media/v20200201preview:MediaGraph"), pulumi.Alias(type_="azure-nextgen:media/v20200201preview:MediaGraph")])
