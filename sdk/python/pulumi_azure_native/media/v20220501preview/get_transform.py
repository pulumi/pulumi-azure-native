...
warnings.warn("""azure-native:media/v20220501preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_transform(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transform is deprecated: azure-native:media/v20220501preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['transformName'] = transform_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20220501preview:getTransform', __args__, opts=opts, typ=GetTransformResult).value
