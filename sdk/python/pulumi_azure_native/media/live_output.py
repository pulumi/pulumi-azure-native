...
class LiveOutputArgs:
    def __init__(__self__, *,
                 ...
                 archive_window_length: pulumi.Input[builtins.str],
                 asset_name: pulumi.Input[builtins.str],
                 live_event_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 hls: Optional[pulumi.Input['HlsArgs']] = None,
                 live_output_name: Optional[pulumi.Input[builtins.str]] = None,
                 manifest_name: Optional[pulumi.Input[builtins.str]] = None,
                 output_snap_time: Optional[pulumi.Input[builtins.float]] = None,
                 rewind_window_length: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] archive_window_length: ISO 8601 time between 1 minute to 25 hours to indicate the maximum content length that can be archived in the asset for this live output. This also sets the maximum content length for the rewind window. For example, use PT1H30M to indicate 1 hour and 30 minutes of archive window.
        :param pulumi.Input[builtins.str] asset_name: The asset that the live output will write to.
        ...
        :param pulumi.Input[builtins.str] description: The description of the live output.
        :param pulumi.Input['HlsArgs'] hls: HTTP Live Streaming (HLS) packing setting for the live output.
        :param pulumi.Input[builtins.str] live_output_name: The name of the live output.
        :param pulumi.Input[builtins.str] manifest_name: The manifest file name. If not provided, the service will generate one automatically.
        :param pulumi.Input[builtins.float] output_snap_time: The initial timestamp that the live output will start at, any content before this value will not be archived.
        :param pulumi.Input[builtins.str] rewind_window_length: ISO 8601 time between 1 minute to the duration of archiveWindowLength to control seek-able window length during Live. The service won't use this property once LiveOutput stops. The archived VOD will have full content with original ArchiveWindowLength. For example, use PT1H30M to indicate 1 hour and 30 minutes of rewind window length. Service will use implicit default value 30m only if Live Event enables LL.
        """
    ...
    def archive_window_length(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def archive_window_length(self, value: pulumi.Input[builtins.str]):
    ...
    def live_event_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def live_event_name(self, value: pulumi.Input[builtins.str]):
    ...
    def live_output_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def live_output_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "live_output_name", value)

    @property
    @pulumi.getter(name="manifestName")
    def manifest_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def manifest_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "manifest_name", value)

    @property
    @pulumi.getter(name="outputSnapTime")
    def output_snap_time(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def output_snap_time(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "output_snap_time", value)

    @property
    @pulumi.getter(name="rewindWindowLength")
    def rewind_window_length(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rewind_window_length(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LiveOutput(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 archive_window_length: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="archiveWindowLength")
    def archive_window_length(self) -> pulumi.Output[builtins.str]:
        """
        ISO 8601 time between 1 minute to 25 hours to indicate the maximum content length that can be archived in the asset for this live output. This also sets the maximum content length for the rewind window. For example, use PT1H30M to indicate 1 hour and 30 minutes of archive window.
        """
        return pulumi.get(self, "archive_window_length")
    ...
    @property
    @pulumi.getter(name="manifestName")
    def manifest_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The manifest file name. If not provided, the service will generate one automatically.
        """
        return pulumi.get(self, "manifest_name")
    ...
    @property
    @pulumi.getter(name="outputSnapTime")
    def output_snap_time(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The initial timestamp that the live output will start at, any content before this value will not be archived.
        """
        return pulumi.get(self, "output_snap_time")
    ...
    @property
    @pulumi.getter(name="rewindWindowLength")
    def rewind_window_length(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ISO 8601 time between 1 minute to the duration of archiveWindowLength to control seek-able window length during Live. The service won't use this property once LiveOutput stops. The archived VOD will have full content with original ArchiveWindowLength. For example, use PT1H30M to indicate 1 hour and 30 minutes of rewind window length. Service will use implicit default value 30m only if Live Event enables LL.
        """
        return pulumi.get(self, "rewind_window_length")
