...
def get_media_service(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_media_service is deprecated: azure-native:media/v20210501:MediaService is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:MediaService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20210501:getMediaService', __args__, opts=opts, typ=GetMediaServiceResult).value
