...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:media/v20210501:MediaService":
                return MediaService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20210501:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "media/v20210501", _module_instance)
