...
def get_content_key_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_key_policy is deprecated: azure-native:media/v20220801:ContentKeyPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:ContentKeyPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
