...
warnings.warn("""azure-native:media/v20220801:AccountFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
class AccountFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tracks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FilterTrackSelectionArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AccountFilter is deprecated: azure-native:media/v20220801:AccountFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20210601:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20211101:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20230101:AccountFilter")])
