...
def get_track(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_track is deprecated: azure-native:media/v20220801:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.""")
    __args__ = dict()
