...
def get_asset_filter(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20220801:getAssetFilter', __args__, opts=opts, typ=GetAssetFilterResult).value
...
def get_asset_filter_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20220801:getAssetFilter', __args__, opts=opts, typ=GetAssetFilterResult)
