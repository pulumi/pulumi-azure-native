...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 streaming_policy_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StreamingPolicy is deprecated: azure-native:media/v20220801:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""")
