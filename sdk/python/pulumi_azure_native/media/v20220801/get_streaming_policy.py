...
warnings.warn("""azure-native:media/v20220801:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_streaming_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_policy is deprecated: azure-native:media/v20220801:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['streamingPolicyName'] = streaming_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20220801:getStreamingPolicy', __args__, opts=opts, typ=GetStreamingPolicyResult).value
