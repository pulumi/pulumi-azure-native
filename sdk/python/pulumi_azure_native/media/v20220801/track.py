...
warnings.warn("""azure-native:media/v20220801:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.""", DeprecationWarning)
...
class Track(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 track_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Track is deprecated: azure-native:media/v20220801:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:Track"), pulumi.Alias(type_="azure-native:media/v20211101:Track"), pulumi.Alias(type_="azure-native:media/v20230101:Track")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Track, __self__).__init__(
            'azure-native:media/v20220801:Track',
            resource_name,
            __props__,
            opts)
