...
def get_content_key_policy_properties_with_secrets(account_name: Optional[builtins.str] = None,
...
def get_content_key_policy_properties_with_secrets_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
