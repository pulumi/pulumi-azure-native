...
warnings.warn("""azure-native:media/v20211101:MediaService is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:MediaService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_media_service(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_media_service is deprecated: azure-native:media/v20211101:MediaService is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:MediaService to guarantee forwards compatibility.""")
    __args__ = dict()
