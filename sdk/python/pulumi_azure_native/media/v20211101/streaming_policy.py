...
warnings.warn("""azure-native:media/v20211101:StreamingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 streaming_policy_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StreamingPolicy is deprecated: azure-native:media/v20211101:StreamingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""")
