...
warnings.warn("""azure-native:media/v20211101:Transform is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20220701:Transform to guarantee forwards compatibility.""", DeprecationWarning)
...
class Transform(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 transform_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Transform is deprecated: azure-native:media/v20211101:Transform is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20220701:Transform to guarantee forwards compatibility.""")
