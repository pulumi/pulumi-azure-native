...
warnings.warn("""azure-native:media/v20211101:AccountFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_account_filter(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account_filter is deprecated: azure-native:media/v20211101:AccountFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['filterName'] = filter_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20211101:getAccountFilter', __args__, opts=opts, typ=GetAccountFilterResult).value
