...
warnings.warn("""azure-native:media/v20211101:AccountFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_account_filter(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account_filter is deprecated: azure-native:media/v20211101:AccountFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AccountFilter to guarantee forwards compatibility.""")
    __args__ = dict()
