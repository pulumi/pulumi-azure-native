...
def get_live_output(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_live_output is deprecated: azure-native:media/v20211101:LiveOutput is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveOutput to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20211101:getLiveOutput', __args__, opts=opts, typ=GetLiveOutputResult).value
