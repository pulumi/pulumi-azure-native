...
warnings.warn("""azure-native:media/v20211101:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_streaming_endpoint(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_endpoint is deprecated: azure-native:media/v20211101:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20221101:StreamingEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
