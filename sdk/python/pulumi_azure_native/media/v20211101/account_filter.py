...
class AccountFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20210601:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20220801:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20230101:AccountFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccountFilter, __self__).__init__(
            'azure-native:media/v20211101:AccountFilter',
            resource_name,
            __props__,
            opts)
