...
warnings.warn("""azure-native:media/v20211101:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_track(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_track is deprecated: azure-native:media/v20211101:Track is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Track to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20211101:getTrack', __args__, opts=opts, typ=GetTrackResult).value
