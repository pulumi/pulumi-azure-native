...
def list_asset_streaming_locators(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20211101:listAssetStreamingLocators', __args__, opts=opts, typ=ListAssetStreamingLocatorsResult).value
...
def list_asset_streaming_locators_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20211101:listAssetStreamingLocators', __args__, opts=opts, typ=ListAssetStreamingLocatorsResult)
