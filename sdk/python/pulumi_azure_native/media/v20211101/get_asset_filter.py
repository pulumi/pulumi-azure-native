...
def get_asset_filter(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asset_filter is deprecated: azure-native:media/v20211101:AssetFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20211101:getAssetFilter', __args__, opts=opts, typ=GetAssetFilterResult).value
