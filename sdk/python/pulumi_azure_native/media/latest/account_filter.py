...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:media:AccountFilter'.""", DeprecationWarning)
...
class AccountFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:media/latest:AccountFilter"), pulumi.Alias(type_="azure-native:media:AccountFilter"), pulumi.Alias(type_="azure-nextgen:media:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AccountFilter"), pulumi.Alias(type_="azure-nextgen:media/v20180701:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AccountFilter"), pulumi.Alias(type_="azure-nextgen:media/v20200501:AccountFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccountFilter, __self__).__init__(
            'azure-native:media/latest:AccountFilter',
            resource_name,
            __props__,
            opts)
