...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAssetEncryptionKey'.""", DeprecationWarning)
...
def get_asset_encryption_key(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getAssetEncryptionKey', __args__, opts=opts, typ=GetAssetEncryptionKeyResult).value
