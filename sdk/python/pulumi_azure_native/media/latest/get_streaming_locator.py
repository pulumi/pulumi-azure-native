...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getStreamingLocator'.""", DeprecationWarning)
...
def get_streaming_locator(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_locator is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getStreamingLocator'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getStreamingLocator', __args__, opts=opts, typ=GetStreamingLocatorResult).value
