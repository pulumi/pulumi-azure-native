...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getStreamingPolicy'.""", DeprecationWarning)
...
def get_streaming_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getStreamingPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getStreamingPolicy', __args__, opts=opts, typ=GetStreamingPolicyResult).value
