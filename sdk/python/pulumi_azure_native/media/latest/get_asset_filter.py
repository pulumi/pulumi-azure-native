...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAssetFilter'.""", DeprecationWarning)
...
def get_asset_filter(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getAssetFilter', __args__, opts=opts, typ=GetAssetFilterResult).value
