...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getLiveEvent'.""", DeprecationWarning)
...
def get_live_event(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_live_event is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getLiveEvent'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getLiveEvent', __args__, opts=opts, typ=GetLiveEventResult).value
