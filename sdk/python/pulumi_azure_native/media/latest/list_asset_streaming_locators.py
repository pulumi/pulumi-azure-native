...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listAssetStreamingLocators'.""", DeprecationWarning)
...
def list_asset_streaming_locators(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_asset_streaming_locators is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listAssetStreamingLocators'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:listAssetStreamingLocators', __args__, opts=opts, typ=ListAssetStreamingLocatorsResult).value
