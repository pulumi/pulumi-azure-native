...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getJob'.""", DeprecationWarning)
...
def get_job(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getJob'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getJob', __args__, opts=opts, typ=GetJobResult).value
