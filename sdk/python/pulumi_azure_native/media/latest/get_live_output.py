...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getLiveOutput'.""", DeprecationWarning)
...
def get_live_output(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_live_output is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getLiveOutput'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getLiveOutput', __args__, opts=opts, typ=GetLiveOutputResult).value
