...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        streaming_policy = azure_native.media.v20200501.StreamingPolicy("streamingPolicy",
            account_name="contosomedia",
            no_encryption=azure_native.media.v20200501.NoEncryptionArgs(
                enabled_protocols=azure_native.media.v20200501.EnabledProtocolsArgs(
                    dash=True,
                    download=True,
                    hls=True,
        ...
        streaming_policy = azure_native.media.v20200501.StreamingPolicy("streamingPolicy",
            account_name="contosomedia",
            common_encryption_cbcs=azure_native.media.v20200501.CommonEncryptionCbcsResponseArgs(
                content_keys={
                    "defaultKey": azure_native.media.v20200501.DefaultKeyArgs(
                        label="cbcsDefaultKey",
                    ),
                },
                drm={
                    "fairPlay": azure_native.media.v20200501.StreamingPolicyFairPlayConfigurationArgs(
        ...
        streaming_policy = azure_native.media.v20200501.StreamingPolicy("streamingPolicy",
            account_name="contosomedia",
            common_encryption_cenc=azure_native.media.v20200501.CommonEncryptionCencResponseArgs(
                clear_tracks=[{
                    "trackSelections": [azure_native.media.v20200501.TrackPropertyConditionArgs(
                        operation="Equal",
                        property="FourCC",
                        value="hev1",
                    )],
                ...
                drm={
                    "playReady": azure_native.media.v20200501.StreamingPolicyPlayReadyConfigurationArgs(
                    ...
                    "widevine": azure_native.media.v20200501.StreamingPolicyWidevineConfigurationArgs(
        ...
        streaming_policy = azure_native.media.v20200501.StreamingPolicy("streamingPolicy",
            ...
            envelope_encryption=azure_native.media.v20200501.EnvelopeEncryptionResponseArgs(
                content_keys={
                    "defaultKey": azure_native.media.v20200501.DefaultKeyArgs(
                        label="aesDefaultKey",
                    ),
