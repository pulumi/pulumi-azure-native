...
class StreamingEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        streaming_endpoint = azure_native.media.v20200501.StreamingEndpoint("streamingEndpoint",
            access_control=azure_native.media.v20200501.StreamingEndpointAccessControlResponseArgs(
                akamai={
                    "akamaiSignatureHeaderAuthenticationKeyList": [
                        azure_native.media.v20200501.AkamaiSignatureHeaderAuthenticationKeyArgs(
                ...
                ip={
                    "allow": [azure_native.media.v20200501.IPRangeArgs(
                        address="192.168.1.1",
                        name="AllowedIp",
                    )],
                },
        ...
        ```sh
        $ pulumi import azure-native:media/v20200501:StreamingEndpoint myStreamingEndpoint1 /subscriptions/0a6ec948-5a62-437d-b9df-934dc7c1b722/resourceGroups/mediaresources/providers/Microsoft.Media/mediaservices/slitestmedia10/streamingendpoints/myStreamingEndpoint1 
        ```
