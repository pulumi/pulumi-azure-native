...
warnings.warn("""azure-native:media/v20200501:ContentKeyPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:ContentKeyPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_content_key_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_key_policy is deprecated: azure-native:media/v20200501:ContentKeyPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:ContentKeyPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['contentKeyPolicyName'] = content_key_policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20200501:getContentKeyPolicy', __args__, opts=opts, typ=GetContentKeyPolicyResult).value
