...
class ContentKeyPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        content_key_policy = azure_native.media.v20200501.ContentKeyPolicy("contentKeyPolicy",
            account_name="contosomedia",
            content_key_policy_name="PolicyWithClearKeyOptionAndSwtTokenRestriction",
            description="ArmPolicyDescription",
            options=[azure_native.media.v20200501.ContentKeyPolicyOptionArgs(
                configuration=azure_native.media.v20200501.ContentKeyPolicyClearKeyConfigurationArgs(
                    odata_type="#Microsoft.Media.ContentKeyPolicyClearKeyConfiguration",
                ),
                name="ClearKeyOption",
                restriction=azure_native.media.v20200501.ContentKeyPolicyTokenRestrictionArgs(
                    audience="urn:audience",
                    issuer="urn:issuer",
                    odata_type="#Microsoft.Media.ContentKeyPolicyTokenRestriction",
                    primary_verification_key=azure_native.media.v20200501.ContentKeyPolicySymmetricTokenKeyArgs(
        ...
        content_key_policy = azure_native.media.v20200501.ContentKeyPolicy("contentKeyPolicy",
            ...
            description="ArmPolicyDescription",
            options=[azure_native.media.v20200501.ContentKeyPolicyOptionArgs(
                configuration=azure_native.media.v20200501.ContentKeyPolicyPlayReadyConfigurationArgs(
                    licenses=[azure_native.media.v20200501.ContentKeyPolicyPlayReadyLicenseArgs(
                        allow_test_devices=True,
                        begin_date="2017-10-16T18:22:53.46Z",
                        content_key_location=azure_native.media.v20200501.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeaderArgs(
                        ...
                        play_right=azure_native.media.v20200501.ContentKeyPolicyPlayReadyPlayRightArgs(
                ...
                restriction=azure_native.media.v20200501.ContentKeyPolicyOpenRestrictionArgs(
        ...
        content_key_policy = azure_native.media.v20200501.ContentKeyPolicy("contentKeyPolicy",
            ...
            description="ArmPolicyDescription",
            options=[azure_native.media.v20200501.ContentKeyPolicyOptionArgs(
                configuration=azure_native.media.v20200501.ContentKeyPolicyWidevineConfigurationArgs(
                ...
                name="widevineoption",
                restriction=azure_native.media.v20200501.ContentKeyPolicyTokenRestrictionArgs(
                    alternate_verification_keys=[azure_native.media.v20200501.ContentKeyPolicySymmetricTokenKeyArgs(
                        key_value="AAAAAAAAAAAAAAAAAAAAAA==",
                        odata_type="#Microsoft.Media.ContentKeyPolicySymmetricTokenKey",
                    )],
                    audience="urn:audience",
                    issuer="urn:issuer",
                    odata_type="#Microsoft.Media.ContentKeyPolicyTokenRestriction",
                    primary_verification_key=azure_native.media.v20200501.ContentKeyPolicyRsaTokenKeyArgs(
                        exponent="AQAB",
                        modulus="AQAD",
        ...
        content_key_policy = azure_native.media.v20200501.ContentKeyPolicy("contentKeyPolicy",
            ...
            description="ArmPolicyDescription",
            options=[
                azure_native.media.v20200501.ContentKeyPolicyOptionArgs(
                    configuration=azure_native.media.v20200501.ContentKeyPolicyClearKeyConfigurationArgs(
                        odata_type="#Microsoft.Media.ContentKeyPolicyClearKeyConfiguration",
                    ),
                    name="ClearKeyOption",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20180330preview:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20180601preview:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20180701:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20210601:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20211101:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20220801:ContentKeyPolicy"), pulumi.Alias(type_="azure-native:media/v20230101:ContentKeyPolicy")])
