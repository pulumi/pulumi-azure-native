...
warnings.warn("""azure-native:media/v20200501:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveEvent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_live_event(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_live_event is deprecated: azure-native:media/v20200501:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveEvent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['liveEventName'] = live_event_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20200501:getLiveEvent', __args__, opts=opts, typ=GetLiveEventResult).value
