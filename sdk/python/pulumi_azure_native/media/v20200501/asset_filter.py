...
class AssetFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        asset_filter = azure_native.media.v20200501.AssetFilter("assetFilter",
            account_name="contosomedia",
            asset_name="ClimbingMountRainer",
            filter_name="newAssetFilter",
            first_quality=azure_native.media.v20200501.FirstQualityResponseArgs(
                bitrate=128000,
            ),
            presentation_time_range=azure_native.media.v20200501.PresentationTimeRangeArgs(
