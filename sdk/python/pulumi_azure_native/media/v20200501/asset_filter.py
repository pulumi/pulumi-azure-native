...
warnings.warn("""azure-native:media/v20200501:AssetFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
class AssetFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20210601:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20211101:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20220801:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20230101:AssetFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssetFilter, __self__).__init__(
            'azure-native:media/v20200501:AssetFilter',
            resource_name,
            __props__,
            opts)
