...
def get_asset(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asset is deprecated: azure-native:media/v20200501:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.""")
    __args__ = dict()
