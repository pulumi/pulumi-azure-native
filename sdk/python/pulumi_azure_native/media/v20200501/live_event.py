...
class LiveEvent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        live_event = azure_native.media.v20200501.LiveEvent("liveEvent",
            account_name="slitestmedia10",
            description="test event 1",
            input=azure_native.media.v20200501.LiveEventInputResponseArgs(
                access_control={
                    "ip": {
            ...
            location="West US",
            preview=azure_native.media.v20200501.LiveEventPreviewResponseArgs(
                access_control={
                    "ip": {
                        "allow": [azure_native.media.v20200501.IPRangeArgs(
                            address="0.0.0.0",
