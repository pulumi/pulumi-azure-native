...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.media.v20200501.PrivateEndpointConnection("privateEndpointConnection",
            account_name="contososports",
            name="connectionName1",
            private_link_service_connection_state=azure_native.media.v20200501.PrivateLinkServiceConnectionStateArgs(
