...
warnings.warn("""azure-native:media/v20210601:AssetFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
class AssetFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tracks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FilterTrackSelectionArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AssetFilter is deprecated: azure-native:media/v20210601:AssetFilter is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:AssetFilter to guarantee forwards compatibility.""")
