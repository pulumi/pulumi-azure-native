...
class AssetFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:media/v20210601:AssetFilter"), pulumi.Alias(type_="azure-native:media:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media/v20180701:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media/v20200501:AssetFilter")])
