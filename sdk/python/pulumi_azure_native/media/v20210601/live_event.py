...
warnings.warn("""azure-native:media/v20210601:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveEvent to guarantee forwards compatibility.""", DeprecationWarning)
...
class LiveEvent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 use_static_hostname: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""LiveEvent is deprecated: azure-native:media/v20210601:LiveEvent is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20221101:LiveEvent to guarantee forwards compatibility.""")
