...
warnings.warn("""azure-native:media/v20210601:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.""", DeprecationWarning)
...
class Asset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_account_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Asset is deprecated: azure-native:media/v20210601:Asset is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:Asset to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:Asset"), pulumi.Alias(type_="azure-native:media/v20180330preview:Asset"), pulumi.Alias(type_="azure-native:media/v20180601preview:Asset"), pulumi.Alias(type_="azure-native:media/v20180701:Asset"), pulumi.Alias(type_="azure-native:media/v20200501:Asset"), pulumi.Alias(type_="azure-native:media/v20211101:Asset"), pulumi.Alias(type_="azure-native:media/v20220801:Asset"), pulumi.Alias(type_="azure-native:media/v20230101:Asset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Asset, __self__).__init__(
            'azure-native:media/v20210601:Asset',
            resource_name,
            __props__,
            opts)
