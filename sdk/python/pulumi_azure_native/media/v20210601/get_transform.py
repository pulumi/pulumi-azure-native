...
def get_transform(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transform is deprecated: azure-native:media/v20210601:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.""")
    __args__ = dict()
