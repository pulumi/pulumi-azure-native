...
warnings.warn("""azure-native:media/v20180601preview:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_streaming_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_policy is deprecated: azure-native:media/v20180601preview:StreamingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20230101:StreamingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
