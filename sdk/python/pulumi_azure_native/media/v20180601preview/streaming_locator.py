...
class StreamingLocator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 streaming_policy_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StreamingLocator is deprecated: azure-native:media/v20180601preview:StreamingLocator is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.""")
