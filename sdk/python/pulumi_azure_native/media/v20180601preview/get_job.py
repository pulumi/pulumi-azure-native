...
warnings.warn("""azure-native:media/v20180601preview:Job is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20220701:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:media/v20180601preview:Job is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20220701:Job to guarantee forwards compatibility.""")
    __args__ = dict()
