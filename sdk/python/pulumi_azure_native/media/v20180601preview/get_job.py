...
warnings.warn("""azure-native:media/v20180601preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:media/v20180601preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Job to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20180601preview:getJob', __args__, opts=opts, typ=GetJobResult).value
