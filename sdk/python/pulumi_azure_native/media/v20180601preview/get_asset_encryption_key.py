...
def get_asset_encryption_key(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20180601preview:getAssetEncryptionKey', __args__, opts=opts, typ=GetAssetEncryptionKeyResult).value

    return AwaitableGetAssetEncryptionKeyResult(
        storage_encryption_key=pulumi.get(__ret__, 'storage_encryption_key'))
def get_asset_encryption_key_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20180601preview:getAssetEncryptionKey', __args__, opts=opts, typ=GetAssetEncryptionKeyResult)
    return __ret__.apply(lambda __response__: GetAssetEncryptionKeyResult(
        storage_encryption_key=pulumi.get(__response__, 'storage_encryption_key')))
