...
class LiveEvent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        live_event = azure_native.media.v20190501preview.LiveEvent("liveEvent",
            account_name="slitestmedia10",
            description="test event 1",
            input=azure_native.media.v20190501preview.LiveEventInputArgs(
                key_frame_interval_duration="PT2S",
                streaming_protocol="RTMP",
            ),
            live_event_name="myLiveEvent1",
            location="West US",
            preview=azure_native.media.v20190501preview.LiveEventPreviewResponseArgs(
                access_control={
                    "ip": {
                        "allow": [azure_native.media.v20190501preview.IPRangeArgs(
                            address="0.0.0.0",
                            name="AllowAll",
                        )],
                    },
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20180330preview:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20180601preview:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20180701:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20200501:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20210601:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20211101:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20220801:LiveEvent"), pulumi.Alias(type_="azure-native:media/v20221101:LiveEvent")])
