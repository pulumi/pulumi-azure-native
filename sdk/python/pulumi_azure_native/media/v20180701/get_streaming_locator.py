...
warnings.warn("""azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_streaming_locator(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_streaming_locator is deprecated: azure-native:media/v20180701:StreamingLocator is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:StreamingLocator to guarantee forwards compatibility.""")
    __args__ = dict()
