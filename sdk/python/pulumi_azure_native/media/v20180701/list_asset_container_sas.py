...
def list_asset_container_sas(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20180701:listAssetContainerSas', __args__, opts=opts, typ=ListAssetContainerSasResult).value
...
def list_asset_container_sas_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20180701:listAssetContainerSas', __args__, opts=opts, typ=ListAssetContainerSasResult)
