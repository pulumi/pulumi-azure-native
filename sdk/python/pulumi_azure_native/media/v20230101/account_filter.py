...
class AccountFilterArgs:
    ...
    def _configure(
        ...
        if first_quality is None and 'firstQuality' in kwargs:
...
class AccountFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            first_quality = _utilities.configure(first_quality, FirstQualityArgs, True)
            __props__.__dict__["first_quality"] = first_quality
            presentation_time_range = _utilities.configure(presentation_time_range, PresentationTimeRangeArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20210601:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20211101:AccountFilter"), pulumi.Alias(type_="azure-native:media/v20220801:AccountFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccountFilter, __self__).__init__(
            'azure-native:media/v20230101:AccountFilter',
            resource_name,
            __props__,
            opts)
