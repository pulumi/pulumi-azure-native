...
class AccountFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account_filter = azure_native.media.v20230101.AccountFilter("accountFilter",
            account_name="contosomedia",
            filter_name="newAccountFilter",
            first_quality=azure_native.media.v20230101.FirstQualityResponseArgs(
                bitrate=128000,
            ),
            presentation_time_range=azure_native.media.v20230101.PresentationTimeRangeArgs(
