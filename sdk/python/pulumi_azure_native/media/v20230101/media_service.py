...
class MediaService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        media_service = azure_native.media.v20230101.MediaService("mediaService",
        ...
        media_service = azure_native.media.v20230101.MediaService("mediaService",
            account_name="contososports",
            encryption=azure_native.media.v20230101.AccountEncryptionResponseArgs(
                identity=azure_native.media.v20230101.ResourceIdentityArgs(
            ...
            identity=azure_native.media.v20230101.MediaServiceIdentityResponseArgs(
                type="UserAssigned",
            ...
            key_delivery=azure_native.media.v20230101.KeyDeliveryResponseArgs(
                access_control=azure_native.media.v20230101.AccessControlArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:MediaService"), pulumi.Alias(type_="azure-native:media/v20151001:MediaService"), pulumi.Alias(type_="azure-native:media/v20180330preview:MediaService"), pulumi.Alias(type_="azure-native:media/v20180601preview:MediaService"), pulumi.Alias(type_="azure-native:media/v20180701:MediaService"), pulumi.Alias(type_="azure-native:media/v20200501:MediaService"), pulumi.Alias(type_="azure-native:media/v20210501:MediaService"), pulumi.Alias(type_="azure-native:media/v20210601:MediaService"), pulumi.Alias(type_="azure-native:media/v20211101:MediaService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MediaService, __self__).__init__(
            'azure-native:media/v20230101:MediaService',
            resource_name,
            __props__,
            opts)
