...
def get_content_key_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20230101:getContentKeyPolicy', __args__, opts=opts, typ=GetContentKeyPolicyResult).value
...
def get_content_key_policy_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20230101:getContentKeyPolicy', __args__, opts=opts, typ=GetContentKeyPolicyResult)
