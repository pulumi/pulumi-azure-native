...
class AssetArgs:
    def __init__(__self__, *,
                 ...
                 alternate_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alternate_id: The alternate ID of the Asset.
        :param pulumi.Input[builtins.str] asset_name: The Asset name.
        :param pulumi.Input[builtins.str] container: The name of the asset blob container.
        :param pulumi.Input[builtins.str] description: The Asset description.
        :param pulumi.Input[builtins.str] encryption_scope: The Asset container encryption scope in the storage account.
    ...
    def alternate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @alternate_id.setter
    def alternate_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Asset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media/v20180330preview:Asset"), pulumi.Alias(type_="azure-native:media/v20180601preview:Asset"), pulumi.Alias(type_="azure-native:media/v20180701:Asset"), pulumi.Alias(type_="azure-native:media/v20200501:Asset"), pulumi.Alias(type_="azure-native:media/v20210601:Asset"), pulumi.Alias(type_="azure-native:media/v20211101:Asset"), pulumi.Alias(type_="azure-native:media/v20220801:Asset"), pulumi.Alias(type_="azure-native:media/v20230101:Asset")])
    ...
    @property
    @pulumi.getter(name="alternateId")
    def alternate_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alternate ID of the Asset.
        """
        return pulumi.get(self, "alternate_id")
    ...
    @property
    @pulumi.getter
    def container(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the asset blob container.
        """
        return pulumi.get(self, "container")
    ...
    def storage_encryption_format(self) -> pulumi.Output[builtins.str]:
        """
