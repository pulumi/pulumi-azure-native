...
def get_media_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/v20190901preview:getMediaGraph', __args__, opts=opts, typ=GetMediaGraphResult).value
...
def get_media_graph_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20190901preview:getMediaGraph', __args__, opts=opts, typ=GetMediaGraphResult)
