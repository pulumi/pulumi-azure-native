...
__all__ = [
    ...
    'MediaGraphUserCredentialsArgsDict',
]
...
if not MYPY:
    class MediaGraphRtspSourceArgsDict(TypedDict):
        ...
        RTSP URL
        """
        credentials: NotRequired[pulumi.Input['MediaGraphUserCredentialsArgsDict']]
        """
        RTSP Credentials
        """
elif False:
...
if not MYPY:
    class MediaGraphUserCredentialsArgsDict(TypedDict):
        """
    ...
    MediaGraphUserCredentialsArgsDict: TypeAlias = Mapping[str, Any]
