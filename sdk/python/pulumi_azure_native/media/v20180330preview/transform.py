...
class Transform(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 transform_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Transform is deprecated: azure-native:media/v20180330preview:Transform is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Transform to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:Transform"), pulumi.Alias(type_="azure-native:media/v20180601preview:Transform"), pulumi.Alias(type_="azure-native:media/v20180701:Transform"), pulumi.Alias(type_="azure-native:media/v20200501:Transform"), pulumi.Alias(type_="azure-native:media/v20210601:Transform"), pulumi.Alias(type_="azure-native:media/v20211101:Transform"), pulumi.Alias(type_="azure-native:media/v20220501preview:Transform"), pulumi.Alias(type_="azure-native:media/v20220701:Transform")])
