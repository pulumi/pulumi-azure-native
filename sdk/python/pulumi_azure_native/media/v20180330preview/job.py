...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 input: Optional[pulumi.Input[Union[Union['JobInputAssetArgs', 'JobInputAssetArgsDict'], Union['JobInputClipArgs', 'JobInputClipArgsDict'], Union['JobInputHttpArgs', 'JobInputHttpArgsDict'], Union['JobInputsArgs', 'JobInputsArgsDict']]]] = None,
                 job_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] account_name: The Media Services account name.
        :param pulumi.Input[str] description: Optional customer supplied description of the Job.
        :param pulumi.Input[Union[Union['JobInputAssetArgs', 'JobInputAssetArgsDict'], Union['JobInputClipArgs', 'JobInputClipArgsDict'], Union['JobInputHttpArgs', 'JobInputHttpArgsDict'], Union['JobInputsArgs', 'JobInputsArgsDict']]] input: The inputs for the Job.
        :param pulumi.Input[str] job_name: The Job name.
