...
warnings.warn("""azure-native:media/v20180330preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 transform_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Job is deprecated: azure-native:media/v20180330preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:media/v20220701:Job to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media:Job"), pulumi.Alias(type_="azure-native:media/v20180601preview:Job"), pulumi.Alias(type_="azure-native:media/v20180701:Job"), pulumi.Alias(type_="azure-native:media/v20200501:Job"), pulumi.Alias(type_="azure-native:media/v20210601:Job"), pulumi.Alias(type_="azure-native:media/v20211101:Job"), pulumi.Alias(type_="azure-native:media/v20220501preview:Job"), pulumi.Alias(type_="azure-native:media/v20220701:Job")])
