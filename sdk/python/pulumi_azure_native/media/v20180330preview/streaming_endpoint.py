...
warnings.warn("""azure-native:media/v20180330preview:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20180601preview:StreamingEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
class StreamingEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""StreamingEndpoint is deprecated: azure-native:media/v20180330preview:StreamingEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20180601preview:StreamingEndpoint to guarantee forwards compatibility.""")
