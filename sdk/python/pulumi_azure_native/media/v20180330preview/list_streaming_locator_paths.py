...
def list_streaming_locator_paths_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:media/v20180330preview:listStreamingLocatorPaths', __args__, opts=opts, typ=ListStreamingLocatorPathsResult)
