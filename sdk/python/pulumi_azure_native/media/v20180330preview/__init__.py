...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:media/v20180330preview:Asset":
                return Asset(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:ContentKeyPolicy":
                return ContentKeyPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:LiveEvent":
                return LiveEvent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:LiveOutput":
                return LiveOutput(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:MediaService":
                return MediaService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:StreamingEndpoint":
                return StreamingEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:StreamingLocator":
                return StreamingLocator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:StreamingPolicy":
                return StreamingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:media/v20180330preview:Transform":
    ...
    pulumi.runtime.register_resource_module("azure-native", "media/v20180330preview", _module_instance)
