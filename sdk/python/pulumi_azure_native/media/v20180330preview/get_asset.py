...
def get_asset(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asset is deprecated: azure-native:media/v20180330preview:Asset is being removed in the next major version of this provider. Please upgrade to azure-native:media/v20230101:Asset to guarantee forwards compatibility.""")
    __args__ = dict()
