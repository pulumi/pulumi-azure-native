...
class JobArgs:
    def __init__(__self__, *,
                 ...
                 transform_name: pulumi.Input[builtins.str],
                 correlation_data: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] correlation_data: Customer provided key, value pairs that will be returned in Job and JobOutput state events.
        :param pulumi.Input[builtins.str] description: Optional customer supplied description of the Job.
        :param pulumi.Input[builtins.str] job_name: The Job name.
        :param pulumi.Input[Union[builtins.str, 'Priority']] priority: Priority with which the job should be processed. Higher priority jobs are processed before lower priority jobs. If not set, the default is normal.
        """
    ...
    def transform_name(self) -> pulumi.Input[builtins.str]:
        """
        The Transform name.
        """
    ...
    def transform_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "transform_name", value)

    @property
    @pulumi.getter(name="correlationData")
    def correlation_data(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def correlation_data(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("azure-native:media:Job")
class Job(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="correlationData")
    def correlation_data(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Customer provided key, value pairs that will be returned in Job and JobOutput state events.
        """
        return pulumi.get(self, "correlation_data")
