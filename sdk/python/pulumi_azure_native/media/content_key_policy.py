...
class ContentKeyPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_key_policy_name: The Content Key Policy name.
    ...
    def content_key_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_key_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:media:ContentKeyPolicy")
