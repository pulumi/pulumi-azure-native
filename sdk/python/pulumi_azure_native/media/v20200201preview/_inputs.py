...
class MediaGraphAssetSinkArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphAssetSinkArgs._configure(
    ...
    def _configure(
             ...
             odata_type: Optional[pulumi.Input[str]] = None,
...
class MediaGraphClearEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphClearEndpointArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            odata_type=odata_type,
            url=url,
...
class MediaGraphPemCertificateListArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphPemCertificateListArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class MediaGraphRtspSourceArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphRtspSourceArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            endpoint=endpoint,
            name=name,
            odata_type=odata_type,
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             endpoint: Optional[pulumi.Input[Union['MediaGraphClearEndpointArgs', 'MediaGraphTlsEndpointArgs']]] = None,
             name: Optional[pulumi.Input[str]] = None,
             odata_type: Optional[pulumi.Input[str]] = None,
             transport: Optional[pulumi.Input[Union[str, 'MediaGraphRtspTransport']]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if endpoint is None:
...
class MediaGraphTlsEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphTlsEndpointArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            odata_type=odata_type,
            url=url,
            credentials=credentials,
...
class MediaGraphTlsValidationOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphTlsValidationOptionsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             ignore_hostname: Optional[pulumi.Input[bool]] = None,
             ignore_signature: Optional[pulumi.Input[bool]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class MediaGraphUsernamePasswordCredentialsArgs:
    def __init__(__self__, *,
        ...
        """
        MediaGraphUsernamePasswordCredentialsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            odata_type=odata_type,
            password=password,
            username=username,
