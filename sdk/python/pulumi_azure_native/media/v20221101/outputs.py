...
class AkamaiAccessControlResponse(dict):
    ...
    def _configure(
             ...
             **kwargs):
        if 'akamaiSignatureHeaderAuthenticationKeyList' in kwargs:
...
class HlsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'fragmentsPerTsSegment' in kwargs:
...
class LiveEventIngestionResponse(dict):
    ...
    def _configure(
        ...
        if 'ingestInterruptions' in kwargs:
...
class LiveEventInputResponse(dict):
    ...
    def _configure(
        ...
        if 'timedMetadataEndpoints' in kwargs:
...
class LiveEventStatusResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'healthDescriptions' in kwargs:
...
class LiveEventTrackStatusResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'expectedBitrate' in kwargs:
            expected_bitrate = kwargs['expectedBitrate']
        if 'incomingBitrate' in kwargs:
            incoming_bitrate = kwargs['incomingBitrate']
        if 'ingestDrift' in kwargs:
            ingest_drift = kwargs['ingestDrift']
        if 'requestReceived' in kwargs:
            request_received = kwargs['requestReceived']
        if 'requestSucceeded' in kwargs:
...
class LiveEventTranscriptionResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'inputTrackSelection' in kwargs:
            input_track_selection = kwargs['inputTrackSelection']
        if 'outputTranscriptionTrack' in kwargs:
