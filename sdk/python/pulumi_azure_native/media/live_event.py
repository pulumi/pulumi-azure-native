...
class LiveEventArgs:
    ...
    def _configure(
        ...
        if transcriptions is not None:
            _setter("transcriptions", transcriptions)
...
class LiveEvent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(encoding, LiveEventEncodingArgs):
            ...
            if not isinstance(input, LiveEventInputArgs):
                input = input or {}
                def _setter(key, value):
                    input[key] = value
            ...
            if not isinstance(preview, LiveEventPreviewArgs):
                preview = preview or {}
                def _setter(key, value):
                    preview[key] = value
