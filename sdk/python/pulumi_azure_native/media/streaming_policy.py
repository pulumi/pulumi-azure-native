...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(common_encryption_cbcs, CommonEncryptionCbcsArgs):
            ...
            if not isinstance(common_encryption_cenc, CommonEncryptionCencArgs):
            ...
            if not isinstance(envelope_encryption, EnvelopeEncryptionArgs):
            ...
            if not isinstance(no_encryption, NoEncryptionArgs):
