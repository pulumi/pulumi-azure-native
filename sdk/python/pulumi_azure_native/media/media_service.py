...
class MediaService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:media/v20151001:MediaService"), pulumi.Alias(type_="azure-native:media/v20230101:MediaService"), pulumi.Alias(type_="azure-native_media_v20151001:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20180330preview:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20180601preview:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20180701:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20200501:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20210501:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20210601:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20211101:media:MediaService"), pulumi.Alias(type_="azure-native_media_v20230101:media:MediaService")])
