...
class MediaServiceArgs:
    def __init__(__self__, *,
                 ...
                 storage_authentication: Optional[pulumi.Input[Union[builtins.str, 'StorageAuthentication']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'MinimumTlsVersion']] minimum_tls_version: The minimum TLS version allowed for this account's requests. This is an optional property. If unspecified, a secure default value will be used.
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Whether or not public network access is allowed for resources under the Media Services account.
    ...
    def storage_authentication(self) -> Optional[pulumi.Input[Union[builtins.str, 'StorageAuthentication']]]:
        return pulumi.get(self, "storage_authentication")

    @storage_authentication.setter
    def storage_authentication(self, value: Optional[pulumi.Input[Union[builtins.str, 'StorageAuthentication']]]):
...
class MediaService(pulumi.CustomResource):
    ...
    def media_service_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="storageAuthentication")
    def storage_authentication(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "storage_authentication")
