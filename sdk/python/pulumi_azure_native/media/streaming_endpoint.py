...
class StreamingEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(access_control, StreamingEndpointAccessControlArgs):
            ...
            if not isinstance(cross_site_access_policies, CrossSiteAccessPoliciesArgs):
            ...
            if not isinstance(sku, ArmStreamingEndpointCurrentSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
