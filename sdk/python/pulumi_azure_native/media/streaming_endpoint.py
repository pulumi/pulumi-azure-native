...
class StreamingEndpointArgs:
    def __init__(__self__, *,
                 ...
                 scale_units: pulumi.Input[builtins.int],
                 ...
                 availability_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cdn_profile: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_provider: Optional[pulumi.Input[builtins.str]] = None,
                 cross_site_access_policies: Optional[pulumi.Input['CrossSiteAccessPoliciesArgs']] = None,
                 custom_host_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 max_cache_age: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.int] scale_units: The number of scale units. Use the Scale operation to adjust this value.
        ...
        :param pulumi.Input[builtins.bool] auto_start: The flag indicates if the resource should be automatically started on creation.
        :param pulumi.Input[builtins.str] availability_set_name: This feature is deprecated, do not set a value for this property.
        :param pulumi.Input[builtins.bool] cdn_enabled: The CDN enabled flag.
        :param pulumi.Input[builtins.str] cdn_profile: The CDN profile name.
        :param pulumi.Input[builtins.str] cdn_provider: The CDN provider name.
        :param pulumi.Input['CrossSiteAccessPoliciesArgs'] cross_site_access_policies: The streaming endpoint access policies.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_host_names: The custom host names of the streaming endpoint
        :param pulumi.Input[builtins.str] description: The streaming endpoint description.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.float] max_cache_age: Max cache age
        :param pulumi.Input['ArmStreamingEndpointCurrentSkuArgs'] sku: The streaming endpoint sku.
        :param pulumi.Input[builtins.str] streaming_endpoint_name: The name of the streaming endpoint, maximum length is 24.
    ...
    def scale_units(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @scale_units.setter
    def scale_units(self, value: pulumi.Input[builtins.int]):
    ...
    def availability_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def availability_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "availability_set_name", value)

    @property
    @pulumi.getter(name="cdnEnabled")
    def cdn_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @cdn_enabled.setter
    def cdn_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "cdn_enabled", value)

    @property
    @pulumi.getter(name="cdnProfile")
    def cdn_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cdn_profile.setter
    def cdn_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdn_profile", value)

    @property
    @pulumi.getter(name="cdnProvider")
    def cdn_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cdn_provider.setter
    def cdn_provider(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def custom_host_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def custom_host_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_cache_age(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Max cache age
        """
    ...
    def max_cache_age(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def streaming_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def streaming_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamingEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 scale_units: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="availabilitySetName")
    def availability_set_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This feature is deprecated, do not set a value for this property.
        """
        return pulumi.get(self, "availability_set_name")
    ...
    @property
    @pulumi.getter(name="cdnEnabled")
    def cdn_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The CDN enabled flag.
        """
        return pulumi.get(self, "cdn_enabled")
    ...
    @property
    @pulumi.getter(name="cdnProfile")
    def cdn_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The CDN profile name.
        """
        return pulumi.get(self, "cdn_profile")
    ...
    @property
    @pulumi.getter(name="cdnProvider")
    def cdn_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The CDN provider name.
        """
        return pulumi.get(self, "cdn_provider")
    ...
    @property
    @pulumi.getter(name="customHostNames")
    def custom_host_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The custom host names of the streaming endpoint
        """
        return pulumi.get(self, "custom_host_names")
    ...
    def free_trial_end_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maxCacheAge")
    def max_cache_age(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Max cache age
        """
        return pulumi.get(self, "max_cache_age")
    ...
    @property
    @pulumi.getter(name="scaleUnits")
    def scale_units(self) -> pulumi.Output[builtins.int]:
        """
        The number of scale units. Use the Scale operation to adjust this value.
        """
        return pulumi.get(self, "scale_units")
