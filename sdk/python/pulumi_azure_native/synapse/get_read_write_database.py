...
def get_read_write_database(database_name: Optional[builtins.str] = None,
...
def get_read_write_database_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
