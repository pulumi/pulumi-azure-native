...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getIntegrationRuntime'.""", DeprecationWarning)
...
def get_integration_runtime(integration_runtime_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getIntegrationRuntime'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
