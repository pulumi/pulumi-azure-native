...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getSqlPool'.""", DeprecationWarning)
...
def get_sql_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getSqlPool', __args__, opts=opts, typ=GetSqlPoolResult).value
