...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getPrivateLinkHub'.""", DeprecationWarning)
...
def get_private_link_hub(private_link_hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getPrivateLinkHub', __args__, opts=opts, typ=GetPrivateLinkHubResult).value
