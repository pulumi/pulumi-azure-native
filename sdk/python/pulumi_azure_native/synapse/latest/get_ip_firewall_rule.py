...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getIpFirewallRule'.""", DeprecationWarning)
...
def get_ip_firewall_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getIpFirewallRule', __args__, opts=opts, typ=GetIpFirewallRuleResult).value
