...
def get_kusto_pool_principal_assignment(kusto_pool_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse:getKustoPoolPrincipalAssignment', __args__, opts=opts, typ=GetKustoPoolPrincipalAssignmentResult).value
...
def get_kusto_pool_principal_assignment_output(kusto_pool_name: Optional[pulumi.Input[_builtins.str]] = None,
