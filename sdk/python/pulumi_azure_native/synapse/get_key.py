...
def get_key(key_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key_name: The name of the workspace key
...
def get_key_output(key_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
