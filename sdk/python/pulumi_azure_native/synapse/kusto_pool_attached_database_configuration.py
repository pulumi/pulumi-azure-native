...
class KustoPoolAttachedDatabaseConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 kusto_pool_resource_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] kusto_pool_resource_id: The resource id of the kusto pool where the databases you would like to attach reside.
    ...
    def kusto_pool_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def kusto_pool_resource_id(self, value: pulumi.Input[builtins.str]):
...
class KustoPoolAttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kusto_pool_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601preview:KustoPoolAttachedDatabaseConfiguration")])
    ...
    @property
    @pulumi.getter(name="kustoPoolResourceId")
    def kusto_pool_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource id of the kusto pool where the databases you would like to attach reside.
        """
        return pulumi.get(self, "kusto_pool_resource_id")
