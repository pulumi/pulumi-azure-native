...
def get_integration_runtime_connection_info(integration_runtime_name: Optional[builtins.str] = None,
...
def get_integration_runtime_connection_info_output(integration_runtime_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse:getIntegrationRuntimeConnectionInfo', __args__, opts=opts, typ=GetIntegrationRuntimeConnectionInfoResult)
