...
def get_sql_pool_workload_classifier(resource_group_name: Optional[builtins.str] = None,
...
def get_sql_pool_workload_classifier_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
