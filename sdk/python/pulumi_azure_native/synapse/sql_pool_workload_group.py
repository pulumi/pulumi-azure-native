...
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20190601preview:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20201201:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20210301:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20210501:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20210601:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:SqlPoolWorkloadGroup")])
