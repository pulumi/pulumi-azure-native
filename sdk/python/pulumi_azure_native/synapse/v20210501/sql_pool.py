...
class SqlPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_pool = azure_native.synapse.v20210501.SqlPool("sqlPool",
            collation="",
            create_mode="",
            ...
            sku=azure_native.synapse.v20210501.SkuArgs(
                name="",
                tier="",
            ),
            source_database_id="",
