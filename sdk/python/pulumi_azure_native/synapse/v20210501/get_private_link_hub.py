...
warnings.warn("""azure-native:synapse/v20210501:PrivateLinkHub is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_link_hub(private_link_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_hub is deprecated: azure-native:synapse/v20210501:PrivateLinkHub is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.""")
    __args__ = dict()
