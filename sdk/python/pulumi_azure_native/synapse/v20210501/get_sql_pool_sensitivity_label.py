...
warnings.warn("""azure-native:synapse/v20210501:SqlPoolSensitivityLabel is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_pool_sensitivity_label(column_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool_sensitivity_label is deprecated: azure-native:synapse/v20210501:SqlPoolSensitivityLabel is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel to guarantee forwards compatibility.""")
    __args__ = dict()
