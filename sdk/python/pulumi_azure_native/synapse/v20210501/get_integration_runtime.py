...
warnings.warn("""azure-native:synapse/v20210501:IntegrationRuntime is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IntegrationRuntime to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_integration_runtime(integration_runtime_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime is deprecated: azure-native:synapse/v20210501:IntegrationRuntime is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IntegrationRuntime to guarantee forwards compatibility.""")
    __args__ = dict()
