...
warnings.warn("""azure-native:synapse/v20210501:SqlPoolWorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_pool_workload_classifier(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool_workload_classifier is deprecated: azure-native:synapse/v20210501:SqlPoolWorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210501:getSqlPoolWorkloadClassifier', __args__, opts=opts, typ=GetSqlPoolWorkloadClassifierResult).value
