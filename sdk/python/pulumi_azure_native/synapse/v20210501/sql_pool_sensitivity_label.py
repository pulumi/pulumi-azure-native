...
class SqlPoolSensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlPoolSensitivityLabel is deprecated: azure-native:synapse/v20210501:SqlPoolSensitivityLabel is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel to guarantee forwards compatibility.""")
