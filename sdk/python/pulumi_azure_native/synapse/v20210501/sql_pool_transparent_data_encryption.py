...
class SqlPoolTransparentDataEncryption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210501:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:SqlPoolTransparentDataEncryption")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolTransparentDataEncryption, __self__).__init__(
            'azure-native:synapse/v20210501:SqlPoolTransparentDataEncryption',
            resource_name,
            __props__,
            opts)
