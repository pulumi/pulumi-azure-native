...
warnings.warn("""azure-native:synapse/v20210501:Key is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""", DeprecationWarning)
