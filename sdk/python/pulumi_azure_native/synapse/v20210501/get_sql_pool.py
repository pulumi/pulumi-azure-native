...
def get_sql_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210501:getSqlPool', __args__, opts=opts, typ=GetSqlPoolResult).value
...
def get_sql_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210501:getSqlPool', __args__, opts=opts, typ=GetSqlPoolResult)
