...
class IpFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210501:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20201201:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210301:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210601:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:IpFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpFirewallRule, __self__).__init__(
            'azure-native:synapse/v20210501:IpFirewallRule',
            resource_name,
            __props__,
            opts)
