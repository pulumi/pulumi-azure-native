...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace = azure_native.synapse.v20210501.Workspace("workspace",
            csp_workspace_admin_properties=azure_native.synapse.v20210501.CspWorkspaceAdminPropertiesArgs(
                initial_workspace_admin_object_id="6c20646f-8050-49ec-b3b1-80a0e58e454d",
            ),
            default_data_lake_storage=azure_native.synapse.v20210501.DataLakeStorageAccountDetailsArgs(
                account_url="https://accountname.dfs.core.windows.net",
                filesystem="default",
            ),
            encryption=azure_native.synapse.v20210501.EncryptionDetailsResponseArgs(
                cmk={
                    "kekIdentity": azure_native.synapse.v20210501.KekIdentityPropertiesArgs(
                    ...
                    "key": azure_native.synapse.v20210501.WorkspaceKeyDetailsArgs(
                        key_vault_url="https://vault.azure.net/keys/key1",
                        name="default",
                    ),
                },
            ),
            identity=azure_native.synapse.v20210501.ManagedIdentityArgs(
                type=azure_native.synapse/v20210501.ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED,
            ...
            managed_virtual_network_settings=azure_native.synapse.v20210501.ManagedVirtualNetworkSettingsArgs(
            ...
            purview_configuration=azure_native.synapse.v20210501.PurviewConfigurationArgs(
            ...
            workspace_repository_configuration=azure_native.synapse.v20210501.WorkspaceRepositoryConfigurationArgs(
