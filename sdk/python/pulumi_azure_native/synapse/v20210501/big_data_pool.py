...
class BigDataPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spark_config_properties is not None and not isinstance(spark_config_properties, LibraryRequirementsArgs):
                spark_config_properties = spark_config_properties or {}
                def _setter(key, value):
                    spark_config_properties[key] = value
                LibraryRequirementsArgs._configure(_setter, **spark_config_properties)
