...
class IpFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_ip_address: The end IP address of the firewall rule. Must be IPv4 format. Must be greater than or equal to startIpAddress
        :param pulumi.Input[builtins.str] rule_name: The IP firewall rule name
        :param pulumi.Input[builtins.str] start_ip_address: The start IP address of the firewall rule. Must be IPv4 format
        """
...
class IpFirewallRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endIpAddress")
    def end_ip_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end IP address of the firewall rule. Must be IPv4 format. Must be greater than or equal to startIpAddress
        """
        return pulumi.get(self, "end_ip_address")
    ...
    @property
    @pulumi.getter(name="startIpAddress")
    def start_ip_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The start IP address of the firewall rule. Must be IPv4 format
        """
        return pulumi.get(self, "start_ip_address")
