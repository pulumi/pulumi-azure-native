...
class WorkspaceAadAdminArgs:
    def __init__(__self__, *,
                 ...
                 administrator_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_type: Workspace active directory administrator type
        :param pulumi.Input[builtins.str] login: Login of the workspace active directory administrator
        :param pulumi.Input[builtins.str] sid: Object ID of the workspace active directory administrator
        :param pulumi.Input[builtins.str] tenant_id: Tenant ID of the workspace active directory administrator
        """
    ...
    def administrator_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def administrator_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:synapse:WorkspaceAadAdmin")
class WorkspaceAadAdmin(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="administratorType")
    def administrator_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Workspace active directory administrator type
        """
        return pulumi.get(self, "administrator_type")
