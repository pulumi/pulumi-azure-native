...
__all__ = ['WorkspaceAadAdminArgs', 'WorkspaceAadAdmin']
...
class WorkspaceAadAdmin(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceAadAdminArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkspaceAadAdminArgs.__new__(WorkspaceAadAdminArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20201201:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210301:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210501:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210501:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210601:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:WorkspaceAadAdmin")])
