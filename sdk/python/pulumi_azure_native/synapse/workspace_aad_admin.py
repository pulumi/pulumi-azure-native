...
class WorkspaceAadAdminArgs:
    def __init__(__self__, *,
                 ...
                 administrator_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] login: Login of the workspace active directory administrator
        :param pulumi.Input[_builtins.str] sid: Object ID of the workspace active directory administrator
        :param pulumi.Input[_builtins.str] tenant_id: Tenant ID of the workspace active directory administrator
        """
    ...
    def administrator_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def administrator_type(self, value: pulumi.Input[Optional[_builtins.str]]):
