...
class PrivateLinkHubArgs:
    def __init__(__self__, *,
                 ...
                 private_link_hub_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] private_link_hub_name: Name of the privateLinkHub
        :param pulumi.Input[builtins.str] provisioning_state: PrivateLinkHub provisioning state
    ...
    def private_link_hub_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_link_hub_name(self, value: Optional[pulumi.Input[builtins.str]]):
