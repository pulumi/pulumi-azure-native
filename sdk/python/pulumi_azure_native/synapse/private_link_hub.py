...
class PrivateLinkHubArgs:
    ...
    def _configure(
        ...
        if private_link_hub_name is None and 'privateLinkHubName' in kwargs:
            private_link_hub_name = kwargs['privateLinkHubName']
        ...
        if private_link_hub_name is not None:
            _setter("private_link_hub_name", private_link_hub_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PrivateLinkHubArgs._configure(_setter, **kwargs)
