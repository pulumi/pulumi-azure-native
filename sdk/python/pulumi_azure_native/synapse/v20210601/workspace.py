...
warnings.warn("""azure-native:synapse/v20210601:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
