...
warnings.warn("""azure-native:synapse/v20210601:WorkspaceAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workspace_aad_admin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_aad_admin is deprecated: azure-native:synapse/v20210601:WorkspaceAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601:getWorkspaceAadAdmin', __args__, opts=opts, typ=GetWorkspaceAadAdminResult).value
