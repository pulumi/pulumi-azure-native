...
def get_sql_pool_workload_classifier(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool_workload_classifier is deprecated: azure-native:synapse/v20210601:SqlPoolWorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier to guarantee forwards compatibility.""")
    __args__ = dict()
