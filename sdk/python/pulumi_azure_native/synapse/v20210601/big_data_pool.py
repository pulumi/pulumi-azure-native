...
class BigDataPoolArgs:
    ...
    def _configure(
        ...
        if 'isComputeIsolationEnabled' in kwargs:
            is_compute_isolation_enabled = kwargs['isComputeIsolationEnabled']
        if 'libraryRequirements' in kwargs:
        ...
        if 'sparkConfigProperties' in kwargs:
...
class BigDataPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auto_pause is not None and not isinstance(auto_pause, AutoPausePropertiesArgs):
            ...
            if auto_scale is not None and not isinstance(auto_scale, AutoScalePropertiesArgs):
            ...
            if dynamic_executor_allocation is not None and not isinstance(dynamic_executor_allocation, DynamicExecutorAllocationArgs):
            ...
            if library_requirements is not None and not isinstance(library_requirements, LibraryRequirementsArgs):
            ...
            if spark_config_properties is not None and not isinstance(spark_config_properties, SparkConfigPropertiesArgs):
