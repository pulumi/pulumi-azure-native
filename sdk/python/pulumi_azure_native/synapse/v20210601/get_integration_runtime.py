...
def get_integration_runtime(integration_runtime_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime is deprecated: azure-native:synapse/v20210601:IntegrationRuntime is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IntegrationRuntime to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['integrationRuntimeName'] = integration_runtime_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
