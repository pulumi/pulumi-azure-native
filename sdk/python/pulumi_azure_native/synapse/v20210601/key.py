...
warnings.warn("""azure-native:synapse/v20210601:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""", DeprecationWarning)
...
class Key(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Key is deprecated: azure-native:synapse/v20210601:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""")
