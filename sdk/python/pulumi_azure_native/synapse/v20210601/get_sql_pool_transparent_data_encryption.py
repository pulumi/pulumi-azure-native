...
warnings.warn("""azure-native:synapse/v20210601:SqlPoolTransparentDataEncryption is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_pool_transparent_data_encryption(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool_transparent_data_encryption is deprecated: azure-native:synapse/v20210601:SqlPoolTransparentDataEncryption is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601:getSqlPoolTransparentDataEncryption', __args__, opts=opts, typ=GetSqlPoolTransparentDataEncryptionResult).value
