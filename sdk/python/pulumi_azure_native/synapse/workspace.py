...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(csp_workspace_admin_properties, CspWorkspaceAdminPropertiesArgs):
            ...
            if not isinstance(default_data_lake_storage, DataLakeStorageAccountDetailsArgs):
            ...
            if not isinstance(encryption, EncryptionDetailsArgs):
            ...
            if not isinstance(managed_virtual_network_settings, ManagedVirtualNetworkSettingsArgs):
            ...
            if not isinstance(virtual_network_profile, VirtualNetworkProfileArgs):
            ...
            if not isinstance(workspace_repository_configuration, WorkspaceRepositoryConfigurationArgs):
