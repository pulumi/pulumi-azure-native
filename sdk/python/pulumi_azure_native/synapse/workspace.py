...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 managed_virtual_network: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 public_network_access: Optional[pulumi.Input[Union[builtins.str, 'WorkspacePublicNetworkAccess']]] = None,
                 ...
                 trusted_service_bypass_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] azure_ad_only_authentication: Enable or Disable AzureADOnlyAuthentication on All Workspace subresource
        ...
        :param pulumi.Input[builtins.str] managed_resource_group_name: Workspace managed resource group. The resource group name uniquely identifies the resource group within the user subscriptionId. The resource group name must be no longer than 90 characters long, and must be alphanumeric characters (Char.IsLetterOrDigit()) and '-', '_', '(', ')' and'.'. Note that the name cannot end with '.'
        :param pulumi.Input[builtins.str] managed_virtual_network: Setting this to 'default' will ensure that all compute for this workspace is in a virtual network managed on behalf of the user.
        ...
        :param pulumi.Input[Union[builtins.str, 'WorkspacePublicNetworkAccess']] public_network_access: Enable or Disable public network access to workspace
        :param pulumi.Input['PurviewConfigurationArgs'] purview_configuration: Purview Configuration
        :param pulumi.Input[builtins.str] sql_administrator_login: Login for workspace SQL active directory administrator
        :param pulumi.Input[builtins.str] sql_administrator_login_password: SQL administrator login password
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.bool] trusted_service_bypass_enabled: Is trustedServiceBypassEnabled for the workspace
    ...
    def managed_virtual_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_virtual_network(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def public_network_access(self) -> Optional[pulumi.Input[Union[builtins.str, 'WorkspacePublicNetworkAccess']]]:
        """
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[builtins.str, 'WorkspacePublicNetworkAccess']]]):
    ...
    def trusted_service_bypass_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def trusted_service_bypass_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.bool] azure_ad_only_authentication: Enable or Disable AzureADOnlyAuthentication on All Workspace subresource
        :param pulumi.Input[Union['CspWorkspaceAdminPropertiesArgs', 'CspWorkspaceAdminPropertiesArgsDict']] csp_workspace_admin_properties: Initial workspace AAD admin properties for a CSP subscription
    ...
    def adla_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="managedVirtualNetwork")
    def managed_virtual_network(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Setting this to 'default' will ensure that all compute for this workspace is in a virtual network managed on behalf of the user.
        """
        return pulumi.get(self, "managed_virtual_network")
    ...
    @property
    @pulumi.getter(name="trustedServiceBypassEnabled")
    def trusted_service_bypass_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is trustedServiceBypassEnabled for the workspace
        """
        return pulumi.get(self, "trusted_service_bypass_enabled")
    ...
    def workspace_uid(self) -> pulumi.Output[builtins.str]:
        """
