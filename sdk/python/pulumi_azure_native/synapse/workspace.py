...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if 'cspWorkspaceAdminProperties' in kwargs:
            csp_workspace_admin_properties = kwargs['cspWorkspaceAdminProperties']
        if 'defaultDataLakeStorage' in kwargs:
        ...
        if 'managedVirtualNetwork' in kwargs:
            managed_virtual_network = kwargs['managedVirtualNetwork']
        if 'managedVirtualNetworkSettings' in kwargs:
        ...
        if 'trustedServiceBypassEnabled' in kwargs:
            trusted_service_bypass_enabled = kwargs['trustedServiceBypassEnabled']
        if 'virtualNetworkProfile' in kwargs:
            virtual_network_profile = kwargs['virtualNetworkProfile']
        if 'workspaceName' in kwargs:
            workspace_name = kwargs['workspaceName']
        if 'workspaceRepositoryConfiguration' in kwargs:
