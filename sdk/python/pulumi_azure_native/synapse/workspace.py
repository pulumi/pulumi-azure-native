...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] managed_resource_group_name: Workspace managed resource group. The resource group name uniquely identifies the resource group within the user subscriptionId. The resource group name must be no longer than 90 characters long, and must be alphanumeric characters (Char.IsLetterOrDigit()) and '-', '_', '(', ')' and'.'. Note that the name cannot end with '.'
        :param pulumi.Input[_builtins.str] managed_virtual_network: Setting this to 'default' will ensure that all compute for this workspace is in a virtual network managed on behalf of the user.
        ...
        :param pulumi.Input[Union[_builtins.str, 'WorkspacePublicNetworkAccess']] public_network_access: Enable or Disable public network access to workspace
        :param pulumi.Input['PurviewConfigurationArgs'] purview_configuration: Purview Configuration
        :param pulumi.Input[_builtins.str] sql_administrator_login: Login for workspace SQL active directory administrator
        :param pulumi.Input[_builtins.str] sql_administrator_login_password: SQL administrator login password
