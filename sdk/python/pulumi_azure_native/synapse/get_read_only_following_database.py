...
def get_read_only_following_database(database_name: Optional[_builtins.str] = None,
...
def get_read_only_following_database_output(database_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
