...
class SqlPoolSensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20190601preview:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20201201:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20210301:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20210501:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20210601:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:SqlPoolSensitivityLabel")])
