...
class IpFirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ip_firewall_rule = azure_native.synapse.v20210301.IpFirewallRule("ipFirewallRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20201201:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210501:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210601:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:IpFirewallRule")])
