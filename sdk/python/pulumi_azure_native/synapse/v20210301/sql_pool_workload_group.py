...
warnings.warn("""azure-native:synapse/v20210301:SqlPoolWorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlPoolWorkloadGroup is deprecated: azure-native:synapse/v20210301:SqlPoolWorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210501:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolWorkloadGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolWorkloadGroup, __self__).__init__(
            'azure-native:synapse/v20210301:SqlPoolWorkloadGroup',
            resource_name,
            __props__,
            opts)
