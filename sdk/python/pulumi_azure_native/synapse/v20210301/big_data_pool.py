...
class BigDataPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        big_data_pool = azure_native.synapse.v20210301.BigDataPool("bigDataPool",
            auto_pause=azure_native.synapse.v20210301.AutoPausePropertiesArgs(
                delay_in_minutes=15,
                enabled=True,
            ),
            auto_scale=azure_native.synapse.v20210301.AutoScalePropertiesArgs(
                enabled=True,
                max_node_count=50,
                min_node_count=3,
            ),
            ...
            library_requirements=azure_native.synapse.v20210301.LibraryRequirementsArgs(
                content="",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20201201:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20210501:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20210601:BigDataPool"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:BigDataPool")])
