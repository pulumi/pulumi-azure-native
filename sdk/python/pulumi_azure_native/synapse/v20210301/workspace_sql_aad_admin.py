...
class WorkspaceSqlAadAdmin(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace_sql_aad_admin = azure_native.synapse.v20210301.WorkspaceSqlAadAdmin("workspaceSqlAadAdmin",
        ...
        ```sh
        $ pulumi import azure-native:synapse/v20210301:WorkspaceSqlAadAdmin activeDirectory /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/resourceGroup1/providers/Microsoft.Synapse/workspaces/workspace1/administrators/activeDirectory 
        ```
