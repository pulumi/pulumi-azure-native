...
class KustoPoolDatabasePrincipalAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210401preview:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:KustoPoolDatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native:synapse:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:KustoPoolDatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:KustoPoolDatabasePrincipalAssignment")])
