...
azure-native:synapse/v20190601preview:Key is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key is deprecated: Version 2019-06-01-preview will be removed in v2 of the provider.
azure-native:synapse/v20190601preview:Key is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['keyName'] = key_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20190601preview:getKey', __args__, opts=opts, typ=GetKeyResult).value
