...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:synapse/v20190601preview:BigDataPool":
                return BigDataPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:IntegrationRuntime":
                return IntegrationRuntime(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:IpFirewallRule":
                return IpFirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:Key":
                return Key(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:PrivateLinkHub":
                return PrivateLinkHub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPool":
                return SqlPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolSensitivityLabel":
                return SqlPoolSensitivityLabel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolTransparentDataEncryption":
                return SqlPoolTransparentDataEncryption(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolVulnerabilityAssessment":
                return SqlPoolVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolVulnerabilityAssessmentRuleBaseline":
                return SqlPoolVulnerabilityAssessmentRuleBaseline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolWorkloadClassifier":
                return SqlPoolWorkloadClassifier(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:SqlPoolWorkloadGroup":
                return SqlPoolWorkloadGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:Workspace":
                return Workspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:WorkspaceAadAdmin":
                return WorkspaceAadAdmin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:WorkspaceManagedSqlServerVulnerabilityAssessment":
                return WorkspaceManagedSqlServerVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:synapse/v20190601preview:WorkspaceSqlAadAdmin":
    ...
    pulumi.runtime.register_resource_module("azure-native", "synapse/v20190601preview", _module_instance)
