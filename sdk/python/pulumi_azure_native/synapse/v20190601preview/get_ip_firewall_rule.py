...
def get_ip_firewall_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_firewall_rule is deprecated: Version v20190601preview will be removed in the next major version of the provider. Upgrade to version v20210301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20190601preview:getIpFirewallRule', __args__, opts=opts, typ=GetIpFirewallRuleResult).value
