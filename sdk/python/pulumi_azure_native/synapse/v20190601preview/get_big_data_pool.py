...
azure-native:synapse/v20190601preview:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_big_data_pool(big_data_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_big_data_pool is deprecated: Version 2019-06-01-preview will be removed in v2 of the provider.
azure-native:synapse/v20190601preview:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20190601preview:getBigDataPool', __args__, opts=opts, typ=GetBigDataPoolResult).value
