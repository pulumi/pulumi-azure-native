...
def get_workspace_aad_admin(resource_group_name: Optional[_builtins.str] = None,
...
def get_workspace_aad_admin_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
