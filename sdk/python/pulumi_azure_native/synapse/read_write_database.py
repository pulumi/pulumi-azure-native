...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601preview:ReadOnlyFollowingDatabase"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:ReadWriteDatabase"), pulumi.Alias(type_="azure-native:synapse:ReadOnlyFollowingDatabase"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:ReadWriteDatabase"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:ReadWriteDatabase")])
