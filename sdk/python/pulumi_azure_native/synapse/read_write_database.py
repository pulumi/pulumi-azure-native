...
class ReadWriteDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 soft_delete_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] soft_delete_period: The time the data should be kept before it stops being accessible to queries in TimeSpan.
        """
    ...
    def soft_delete_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def soft_delete_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def is_followed(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="softDeletePeriod")
    def soft_delete_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time the data should be kept before it stops being accessible to queries in TimeSpan.
        """
        return pulumi.get(self, "soft_delete_period")
