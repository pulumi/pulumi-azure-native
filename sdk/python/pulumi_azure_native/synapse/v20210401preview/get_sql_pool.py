...
def get_sql_pool(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool is deprecated: azure-native:synapse/v20210401preview:SqlPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:SqlPool to guarantee forwards compatibility.""")
    __args__ = dict()
