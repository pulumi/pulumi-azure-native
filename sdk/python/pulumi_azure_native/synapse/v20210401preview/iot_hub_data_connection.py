...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:IotHubDataConnection"), pulumi.Alias(type_="azure-native:synapse:IotHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:IotHubDataConnection"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:IotHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:IotHubDataConnection")])
