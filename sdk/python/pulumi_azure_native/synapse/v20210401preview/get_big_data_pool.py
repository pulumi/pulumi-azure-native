...
warnings.warn("""azure-native:synapse/v20210401preview:BigDataPool is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_big_data_pool(big_data_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_big_data_pool is deprecated: azure-native:synapse/v20210401preview:BigDataPool is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""")
    __args__ = dict()
