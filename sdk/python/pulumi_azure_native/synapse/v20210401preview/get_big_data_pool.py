...
warnings.warn("""azure-native:synapse/v20210401preview:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_big_data_pool(big_data_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_big_data_pool is deprecated: azure-native:synapse/v20210401preview:BigDataPool is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210501:BigDataPool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['bigDataPoolName'] = big_data_pool_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getBigDataPool', __args__, opts=opts, typ=GetBigDataPoolResult).value
