...
def get_data_connection(data_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getDataConnection', __args__, opts=opts, typ=GetDataConnectionResult).value
...
def get_data_connection_output(data_connection_name: Optional[pulumi.Input[str]] = None,
