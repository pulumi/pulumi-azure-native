...
def get_workspace_aad_admin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_aad_admin is deprecated: azure-native:synapse/v20210401preview:WorkspaceAadAdmin is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:WorkspaceAadAdmin to guarantee forwards compatibility.""")
    __args__ = dict()
