...
def get_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key is deprecated: azure-native:synapse/v20210401preview:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""")
    __args__ = dict()
