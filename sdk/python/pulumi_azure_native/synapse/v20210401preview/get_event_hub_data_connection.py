...
def get_event_hub_data_connection(data_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub_data_connection is deprecated: azure-native:synapse/v20210401preview:EventHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:EventHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getEventHubDataConnection', __args__, opts=opts, typ=GetEventHubDataConnectionResult).value
