...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:ReadWriteDatabase"), pulumi.Alias(type_="azure-native:synapse:ReadWriteDatabase"), pulumi.Alias(type_="azure-nextgen:synapse:ReadWriteDatabase"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:ReadWriteDatabase"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:ReadWriteDatabase")])
