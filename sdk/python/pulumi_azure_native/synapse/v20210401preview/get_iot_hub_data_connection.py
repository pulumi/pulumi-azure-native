...
warnings.warn("""azure-native:synapse/v20210401preview:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IotHubDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_iot_hub_data_connection(data_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_data_connection is deprecated: azure-native:synapse/v20210401preview:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IotHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getIotHubDataConnection', __args__, opts=opts, typ=GetIotHubDataConnectionResult).value
