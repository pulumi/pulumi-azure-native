...
def get_event_grid_data_connection(data_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getEventGridDataConnection', __args__, opts=opts, typ=GetEventGridDataConnectionResult).value
...
def get_event_grid_data_connection_output(data_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210401preview:getEventGridDataConnection', __args__, opts=opts, typ=GetEventGridDataConnectionResult)
