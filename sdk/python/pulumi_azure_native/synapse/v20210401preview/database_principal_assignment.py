...
class DatabasePrincipalAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_principal_assignment = azure_native.synapse.v20210401preview.DatabasePrincipalAssignment("databasePrincipalAssignment",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601preview:DatabasePrincipalAssignment")])
