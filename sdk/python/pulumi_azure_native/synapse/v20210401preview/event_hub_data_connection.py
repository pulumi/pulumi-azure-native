...
class EventHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:EventHubDataConnection"), pulumi.Alias(type_="azure-native:synapse:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:EventHubDataConnection"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:EventHubDataConnection")])
