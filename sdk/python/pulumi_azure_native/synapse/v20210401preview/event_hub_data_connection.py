...
class EventHubDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_hub_data_connection = azure_native.synapse.v20210401preview.EventHubDataConnection("eventHubDataConnection",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601preview:EventHubDataConnection")])
