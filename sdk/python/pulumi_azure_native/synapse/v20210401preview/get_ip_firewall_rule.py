...
warnings.warn("""azure-native:synapse/v20210401preview:IpFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ip_firewall_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_firewall_rule is deprecated: azure-native:synapse/v20210401preview:IpFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['ruleName'] = rule_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getIpFirewallRule', __args__, opts=opts, typ=GetIpFirewallRuleResult).value
