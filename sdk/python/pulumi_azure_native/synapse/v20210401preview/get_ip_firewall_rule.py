...
warnings.warn("""azure-native:synapse/v20210401preview:IpFirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ip_firewall_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_firewall_rule is deprecated: azure-native:synapse/v20210401preview:IpFirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:synapse/v20210601preview:IpFirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
