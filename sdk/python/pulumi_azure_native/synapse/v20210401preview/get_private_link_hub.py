...
warnings.warn("""azure-native:synapse/v20210401preview:PrivateLinkHub is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_link_hub(private_link_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_hub is deprecated: azure-native:synapse/v20210401preview:PrivateLinkHub is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:PrivateLinkHub to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['privateLinkHubName'] = private_link_hub_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getPrivateLinkHub', __args__, opts=opts, typ=GetPrivateLinkHubResult).value
