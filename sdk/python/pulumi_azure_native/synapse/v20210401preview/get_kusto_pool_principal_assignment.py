...
def get_kusto_pool_principal_assignment(kusto_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210401preview:getKustoPoolPrincipalAssignment', __args__, opts=opts, typ=GetKustoPoolPrincipalAssignmentResult).value
...
def get_kusto_pool_principal_assignment_output(kusto_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210401preview:getKustoPoolPrincipalAssignment', __args__, opts=opts, typ=GetKustoPoolPrincipalAssignmentResult)
