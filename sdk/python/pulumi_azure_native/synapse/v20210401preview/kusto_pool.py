...
class KustoPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:kustoPool"), pulumi.Alias(type_="azure-native:synapse:kustoPool"), pulumi.Alias(type_="azure-nextgen:synapse:kustoPool")])
