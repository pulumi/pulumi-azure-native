...
class PrivateLinkHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_hub = azure_native.synapse.v20210601preview.PrivateLinkHub("privateLinkHub",
            location="East US",
