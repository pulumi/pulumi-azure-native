...
class AttachedDatabaseConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_resource_id: The resource id of the kusto pool where the databases you would like to attach reside.
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azure-native:synapse:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azure-nextgen:synapse:AttachedDatabaseConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttachedDatabaseConfiguration, __self__).__init__(
            'azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration',
            resource_name,
            __props__,
            opts)
