...
class SqlPoolSensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20210501:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse:SqlPoolSensitivityLabel")])
