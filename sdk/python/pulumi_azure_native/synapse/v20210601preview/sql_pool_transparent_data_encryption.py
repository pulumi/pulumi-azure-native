...
class SqlPoolTransparentDataEncryption(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_pool_transparent_data_encryption = azure_native.synapse.v20210601preview.SqlPoolTransparentDataEncryption("sqlPoolTransparentDataEncryption",
