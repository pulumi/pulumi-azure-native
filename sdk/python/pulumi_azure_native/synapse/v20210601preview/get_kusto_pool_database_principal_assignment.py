...
def get_kusto_pool_database_principal_assignment_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210601preview:getKustoPoolDatabasePrincipalAssignment', __args__, opts=opts, typ=GetKustoPoolDatabasePrincipalAssignmentResult)
