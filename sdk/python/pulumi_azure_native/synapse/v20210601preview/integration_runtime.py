...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        integration_runtime = azure_native.synapse.v20210601preview.IntegrationRuntime("integrationRuntime",
            integration_runtime_name="exampleIntegrationRuntime",
            properties=azure_native.synapse.v20210601preview.SelfHostedIntegrationRuntimeArgs(
