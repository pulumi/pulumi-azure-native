...
class KustoPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_pool = azure_native.synapse.v20210601preview.KustoPool("kustoPool",
            enable_purge=True,
            enable_streaming_ingest=True,
            kusto_pool_name="kustoclusterrptest4",
            location="westus",
            resource_group_name="kustorptest",
            sku=azure_native.synapse.v20210601preview.AzureSkuArgs(
                capacity=2,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210401preview:KustoPool")])
