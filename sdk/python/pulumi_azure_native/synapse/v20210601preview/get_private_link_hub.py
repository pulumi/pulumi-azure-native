...
def get_private_link_hub(private_link_hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601preview:getPrivateLinkHub', __args__, opts=opts, typ=GetPrivateLinkHubResult).value
...
def get_private_link_hub_output(private_link_hub_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210601preview:getPrivateLinkHub', __args__, opts=opts, typ=GetPrivateLinkHubResult)
