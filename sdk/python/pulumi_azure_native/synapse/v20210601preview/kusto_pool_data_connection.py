...
__all__ = ['KustoPoolDataConnectionArgs', 'KustoPoolDataConnection']

@pulumi.input_type
class KustoPoolDataConnectionArgs:
...
class KustoPoolDataConnection(pulumi.CustomResource):
    warnings.warn("""Please use one of the variants: EventGridDataConnection, EventHubDataConnection, IotHubDataConnection.""", DeprecationWarning)
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: KustoPoolDataConnectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Class representing a data connection.

        :param str resource_name: The name of the resource.
        :param KustoPoolDataConnectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KustoPoolDataConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoPoolDataConnection is deprecated: Please use one of the variants: EventGridDataConnection, EventHubDataConnection, IotHubDataConnection.""")
        if opts is None:
        ...
        if opts.id is None:
            ...
            __props__ = KustoPoolDataConnectionArgs.__new__(KustoPoolDataConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:KustoPoolDataConnection"), pulumi.Alias(type_="azure-native:synapse:KustoPoolDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:KustoPoolDataConnection"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:KustoPoolDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:KustoPoolDataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KustoPoolDataConnection, __self__).__init__(
            'azure-native:synapse/v20210601preview:KustoPoolDataConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'KustoPoolDataConnection':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return KustoPoolDataConnection(resource_name, opts=opts, __props__=__props__)
