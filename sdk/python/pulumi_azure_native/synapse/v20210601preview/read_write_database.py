...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        read_write_database = azure_native.synapse.v20210601preview.ReadWriteDatabase("readWriteDatabase",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210401preview:ReadWriteDatabase")])
