...
class WorkspaceSqlAadAdmin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20201201:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210301:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210501:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210501:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210601:WorkspaceSqlAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601:WorkspaceSqlAadAdmin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceSqlAadAdmin, __self__).__init__(
            'azure-native:synapse/v20210601preview:WorkspaceSqlAadAdmin',
            resource_name,
            __props__,
            opts)
