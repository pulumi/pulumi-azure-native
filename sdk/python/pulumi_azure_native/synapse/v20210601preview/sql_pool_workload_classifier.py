...
class SqlPoolWorkloadClassifier(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_pool_workload_classifier = azure_native.synapse.v20210601preview.SqlPoolWorkloadClassifier("sqlPoolWorkloadClassifier",
