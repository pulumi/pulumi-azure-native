...
class DatabasePrincipalAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native:synapse:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-nextgen:synapse:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:DatabasePrincipalAssignment"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:DatabasePrincipalAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabasePrincipalAssignment, __self__).__init__(
            'azure-native:synapse/v20210601preview:DatabasePrincipalAssignment',
            resource_name,
            __props__,
            opts)
