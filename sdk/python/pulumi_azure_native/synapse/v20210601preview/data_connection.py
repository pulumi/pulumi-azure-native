...
class DataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:DataConnection"), pulumi.Alias(type_="azure-native:synapse:DataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:DataConnection"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:DataConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:DataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataConnection, __self__).__init__(
            'azure-native:synapse/v20210601preview:DataConnection',
            resource_name,
            __props__,
            opts)
