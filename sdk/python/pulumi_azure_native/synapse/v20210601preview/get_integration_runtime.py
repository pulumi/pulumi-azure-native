...
def get_integration_runtime(integration_runtime_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601preview:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
...
def get_integration_runtime_output(integration_runtime_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210601preview:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult)
