...
class GetIotHubDataConnectionResult:
    ...
    """
    def __init__(__self__, consumer_group=None, data_format=None, event_system_properties=None, id=None, iot_hub_resource_id=None, kind=None, location=None, mapping_rule_name=None, name=None, provisioning_state=None, shared_access_policy_name=None, system_data=None, table_name=None, type=None):
...
def get_iot_hub_data_connection(data_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20210601preview:getIotHubDataConnection', __args__, opts=opts, typ=GetIotHubDataConnectionResult).value
...
def get_iot_hub_data_connection_output(data_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse/v20210601preview:getIotHubDataConnection', __args__, opts=opts, typ=GetIotHubDataConnectionResult)
