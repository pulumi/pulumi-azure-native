...
class BigDataPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        big_data_pool = azure_native.synapse.v20210601preview.BigDataPool("bigDataPool",
            auto_pause=azure_native.synapse.v20210601preview.AutoPausePropertiesArgs(
                delay_in_minutes=15,
                enabled=True,
            ),
            auto_scale=azure_native.synapse.v20210601preview.AutoScalePropertiesArgs(
                enabled=True,
                max_node_count=50,
                min_node_count=3,
            ),
            ...
            library_requirements=azure_native.synapse.v20210601preview.LibraryRequirementsArgs(
                content="",
