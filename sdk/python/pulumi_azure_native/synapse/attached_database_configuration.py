...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:AttachedDatabaseConfiguration"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:AttachedDatabaseConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttachedDatabaseConfiguration, __self__).__init__(
            'azure-native:synapse:AttachedDatabaseConfiguration',
            resource_name,
            __props__,
            opts)
