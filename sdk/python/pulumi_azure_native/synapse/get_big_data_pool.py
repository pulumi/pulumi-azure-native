...
def get_big_data_pool(big_data_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str big_data_pool_name: Big Data pool name
...
def get_big_data_pool_output(big_data_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
