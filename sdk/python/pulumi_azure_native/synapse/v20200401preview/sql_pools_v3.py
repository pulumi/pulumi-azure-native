...
class SqlPoolsV3(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20210501:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolsV3"), pulumi.Alias(type_="azure-native:synapse/v20230501:SqlPoolsV3")])
