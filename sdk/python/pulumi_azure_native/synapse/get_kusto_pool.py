...
def get_kusto_pool(kusto_pool_name: Optional[_builtins.str] = None,
...
def get_kusto_pool_output(kusto_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
