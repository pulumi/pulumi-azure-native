...
class GetKustoPoolResult:
    ...
    def enable_purge(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_streaming_ingest(self) -> Optional[builtins.bool]:
        """
    ...
    def workspace_uid(self) -> Optional[builtins.str]:
        """
...
def get_kusto_pool(kusto_pool_name: Optional[builtins.str] = None,
...
def get_kusto_pool_output(kusto_pool_name: Optional[pulumi.Input[builtins.str]] = None,
