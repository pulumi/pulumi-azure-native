...
def get_iot_hub_data_connection(data_connection_name: Optional[builtins.str] = None,
...
def get_iot_hub_data_connection_output(data_connection_name: Optional[pulumi.Input[builtins.str]] = None,
