...
class SqlPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] collation: Collation mode
        :param pulumi.Input[Union[builtins.str, 'CreateMode']] create_mode: Specifies the mode of sql pool creation.
        ...
        :param pulumi.Input[builtins.float] max_size_bytes: Maximum size in bytes
        :param pulumi.Input[builtins.str] provisioning_state: Resource state
        :param pulumi.Input[builtins.str] recoverable_database_id: Backup database to restore from
        :param pulumi.Input[builtins.str] restore_point_in_time: Snapshot time to restore
        :param pulumi.Input['SkuArgs'] sku: SQL pool SKU
        :param pulumi.Input[builtins.str] source_database_deletion_date: Specifies the time that the sql pool was deleted
        :param pulumi.Input[builtins.str] source_database_id: Source database to create from
        :param pulumi.Input[builtins.str] sql_pool_name: SQL pool name
        :param pulumi.Input[Union[builtins.str, 'StorageAccountType']] storage_account_type: The storage account type used to store backups for this sql pool.
    ...
    def sql_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SQL pool name
        """
    ...
    def sql_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SqlPool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="recoverableDatabaseId")
    def recoverable_database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Backup database to restore from
        """
        return pulumi.get(self, "recoverable_database_id")
    ...
    @property
    @pulumi.getter(name="sourceDatabaseDeletionDate")
    def source_database_deletion_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the time that the sql pool was deleted
        """
        return pulumi.get(self, "source_database_deletion_date")
