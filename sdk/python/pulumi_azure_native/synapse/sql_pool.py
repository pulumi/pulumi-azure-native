...
class SqlPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210501:SqlPool"), pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPool"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20190601preview:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20200401preview:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20201201:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20210301:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20210501:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20210601:synapse:SqlPool"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:SqlPool")])
