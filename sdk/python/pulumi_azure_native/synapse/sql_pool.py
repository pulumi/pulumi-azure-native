...
class SqlPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] max_size_bytes: Maximum size in bytes
        :param pulumi.Input[_builtins.str] provisioning_state: Resource state
        :param pulumi.Input[_builtins.str] recoverable_database_id: Backup database to restore from
        :param pulumi.Input[_builtins.str] restore_point_in_time: Snapshot time to restore
