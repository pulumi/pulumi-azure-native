...
class SqlPoolWorkloadClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20210601:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20190601preview:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20201201:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20210301:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20210401preview:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20210501:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20210601:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native_synapse_v20210601preview:synapse:SqlPoolWorkloadClassifier")])
