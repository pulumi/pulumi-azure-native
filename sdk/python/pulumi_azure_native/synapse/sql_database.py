...
class SqlDatabase(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse/v20200401preview:SqlDatabase"), pulumi.Alias(type_="azure-nextgen:synapse/v20200401preview:SqlDatabase")])
