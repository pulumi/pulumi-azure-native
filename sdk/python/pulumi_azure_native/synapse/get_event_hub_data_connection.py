...
def get_event_hub_data_connection(data_connection_name: Optional[_builtins.str] = None,
...
def get_event_hub_data_connection_output(data_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
