...
def get_integration_runtime(integration_runtime_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime is deprecated: Version v20201201 will be removed in the next major version of the provider. Upgrade to version v20210301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20201201:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
