...
class Key(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:Key"), pulumi.Alias(type_="azure-nextgen:synapse:Key"), pulumi.Alias(type_="azure-native:synapse/latest:Key"), pulumi.Alias(type_="azure-nextgen:synapse/latest:Key"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:Key"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:Key")])
