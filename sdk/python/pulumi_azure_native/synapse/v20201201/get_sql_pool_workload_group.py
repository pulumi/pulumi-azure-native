...
def get_sql_pool_workload_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool_workload_group is deprecated: Version v20201201 will be removed in the next major version of the provider. Upgrade to version v20210301 or later.""")
    __args__ = dict()
