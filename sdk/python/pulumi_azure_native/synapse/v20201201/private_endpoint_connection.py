...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20210301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20210501:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210501:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20210601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210601preview:PrivateEndpointConnection")])
