...
def get_sql_pool(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_pool is deprecated: Version v20201201 will be removed in the next major version of the provider. Upgrade to version v20210301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20201201:getSqlPool', __args__, opts=opts, typ=GetSqlPoolResult).value
