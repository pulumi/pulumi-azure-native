...
def get_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key is deprecated: Version 2020-12-01 will be removed in v2 of the provider.
azure-native:synapse/v20201201:Key is being removed in the next major version of this provider. Upgrade to at least azure-native:synapse/v20210601preview:Key to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/v20201201:getKey', __args__, opts=opts, typ=GetKeyResult).value
