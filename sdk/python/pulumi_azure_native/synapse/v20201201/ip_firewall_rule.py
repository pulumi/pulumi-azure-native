...
class IpFirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/latest:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/latest:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:IpFirewallRule")])
