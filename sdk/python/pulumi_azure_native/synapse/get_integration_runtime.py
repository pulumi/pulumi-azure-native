...
def get_integration_runtime(integration_runtime_name: Optional[builtins.str] = None,
...
def get_integration_runtime_output(integration_runtime_name: Optional[pulumi.Input[builtins.str]] = None,
