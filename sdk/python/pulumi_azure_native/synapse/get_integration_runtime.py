...
def get_integration_runtime(integration_runtime_name: Optional[_builtins.str] = None,
...
def get_integration_runtime_output(integration_runtime_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:synapse:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult)
