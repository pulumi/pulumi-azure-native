...
class PartnerNamespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid:PartnerNamespace")])
