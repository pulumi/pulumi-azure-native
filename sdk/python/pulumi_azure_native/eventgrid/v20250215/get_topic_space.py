...
def get_topic_space(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20250215:getTopicSpace', __args__, opts=opts, typ=GetTopicSpaceResult).value
...
def get_topic_space_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20250215:getTopicSpace', __args__, opts=opts, typ=GetTopicSpaceResult)
