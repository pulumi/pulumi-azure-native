...
def get_domain_topic_event_subscription_full_url(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20250215:getDomainTopicEventSubscriptionFullUrl', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionFullUrlResult).value
...
def get_domain_topic_event_subscription_full_url_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20250215:getDomainTopicEventSubscriptionFullUrl', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionFullUrlResult)
