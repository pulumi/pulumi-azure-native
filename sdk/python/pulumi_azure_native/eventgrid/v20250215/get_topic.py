...
def get_topic(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20250215:getTopic', __args__, opts=opts, typ=GetTopicResult).value
...
def get_topic_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20250215:getTopic', __args__, opts=opts, typ=GetTopicResult)
