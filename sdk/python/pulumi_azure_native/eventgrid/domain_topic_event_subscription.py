...
class DomainTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20211015preview:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20220615:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:DomainTopicEventSubscription")])
