...
class DomainTopicEventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain_name: Name of the top level domain.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group within the user's subscription.
        :param pulumi.Input[_builtins.str] topic_name: Name of the domain topic.
...
@pulumi.type_token("azure-native:eventgrid:DomainTopicEventSubscription")
class DomainTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20250715preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20251115preview:DomainTopicEventSubscription")])
