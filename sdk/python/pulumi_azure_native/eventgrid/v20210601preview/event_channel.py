...
class EventChannel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_channel = azure_native.eventgrid.v20210601preview.EventChannel("eventChannel",
            destination=azure_native.eventgrid.v20210601preview.EventChannelDestinationArgs(
            ...
            source=azure_native.eventgrid.v20210601preview.EventChannelSourceArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:EventChannel")])
