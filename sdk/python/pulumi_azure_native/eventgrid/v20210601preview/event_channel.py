...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventChannel")])
