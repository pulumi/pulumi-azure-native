...
def get_event_channel(event_channel_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_channel is deprecated: azure-native:eventgrid/v20210601preview:EventChannel is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['eventChannelName'] = event_channel_name
    __args__['partnerNamespaceName'] = partner_namespace_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20210601preview:getEventChannel', __args__, opts=opts, typ=GetEventChannelResult).value
