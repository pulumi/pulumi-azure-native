...
def get_partner_topic_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_topic_event_subscription is deprecated: azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopicEventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20210601preview:getPartnerTopicEventSubscription', __args__, opts=opts, typ=GetPartnerTopicEventSubscriptionResult).value
