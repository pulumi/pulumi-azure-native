...
def list_domain_shared_access_keys(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20211201:listDomainSharedAccessKeys', __args__, opts=opts, typ=ListDomainSharedAccessKeysResult).value
...
def list_domain_shared_access_keys_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20211201:listDomainSharedAccessKeys', __args__, opts=opts, typ=ListDomainSharedAccessKeysResult)
