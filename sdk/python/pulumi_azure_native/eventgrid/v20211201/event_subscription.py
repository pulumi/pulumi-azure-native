...
class EventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EventSubscription is deprecated: azure-native:eventgrid/v20211201:EventSubscription is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:EventSubscription to guarantee forwards compatibility.""")
