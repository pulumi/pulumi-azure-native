...
warnings.warn("""azure-native:eventgrid/v20211201:SystemTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription to guarantee forwards compatibility.""", DeprecationWarning)
