...
def get_partner_destination(partner_destination_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str partner_destination_name: Name of the partner destination.
...
def get_partner_destination_output(partner_destination_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
