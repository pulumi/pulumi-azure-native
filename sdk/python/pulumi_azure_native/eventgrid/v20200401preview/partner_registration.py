...
class PartnerRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerRegistration")])
