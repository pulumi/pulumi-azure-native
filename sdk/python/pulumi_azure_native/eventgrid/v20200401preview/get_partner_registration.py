...
warnings.warn("""azure-native:eventgrid/v20200401preview:PartnerRegistration is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:PartnerRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_partner_registration(partner_registration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_registration is deprecated: azure-native:eventgrid/v20200401preview:PartnerRegistration is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:PartnerRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
