...
warnings.warn("""azure-native:eventgrid/v20200401preview:EventChannel is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source: Optional[pulumi.Input[pulumi.InputType['EventChannelSourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""EventChannel is deprecated: azure-native:eventgrid/v20200401preview:EventChannel is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:EventChannel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventChannel, __self__).__init__(
            'azure-native:eventgrid/v20200401preview:EventChannel',
            resource_name,
            __props__,
            opts)
