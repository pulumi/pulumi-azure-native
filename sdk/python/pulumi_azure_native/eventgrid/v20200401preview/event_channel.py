...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source: Optional[pulumi.Input[pulumi.InputType['EventChannelSourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""EventChannel is deprecated: Version 2020-04-01-preview will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:EventChannel")])
