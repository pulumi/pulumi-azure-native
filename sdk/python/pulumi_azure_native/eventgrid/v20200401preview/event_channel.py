...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source: Optional[pulumi.Input[pulumi.InputType['EventChannelSourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""EventChannel is deprecated: azure-native:eventgrid/v20200401preview:EventChannel is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20211015preview:EventChannel to guarantee forwards compatibility.""")
