...
class SystemTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 system_topic_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SystemTopicEventSubscription is deprecated: azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:SystemTopicEventSubscription to guarantee forwards compatibility.""")
