...
class SystemTopicEventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        system_topic_event_subscription = azure_native.eventgrid.v20200401preview.SystemTopicEventSubscription("systemTopicEventSubscription",
            destination=azure_native.eventgrid.v20200401preview.WebHookEventSubscriptionDestinationArgs(
                endpoint_type="WebHook",
                endpoint_url="https://requestb.in/15ksip71",
            ),
            event_subscription_name="exampleEventSubscriptionName1",
            filter=azure_native.eventgrid.v20200401preview.EventSubscriptionFilterArgs(
