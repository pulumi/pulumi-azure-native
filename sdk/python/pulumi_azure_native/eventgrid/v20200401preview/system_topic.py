...
warnings.warn("""azure-native:eventgrid/v20200401preview:SystemTopic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:SystemTopic to guarantee forwards compatibility.""", DeprecationWarning)
...
class SystemTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 topic_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SystemTopic is deprecated: azure-native:eventgrid/v20200401preview:SystemTopic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:SystemTopic to guarantee forwards compatibility.""")
