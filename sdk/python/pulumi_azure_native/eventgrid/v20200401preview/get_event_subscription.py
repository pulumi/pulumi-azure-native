...
warnings.warn("""azure-native:eventgrid/v20200401preview:EventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20220615:EventSubscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_subscription is deprecated: azure-native:eventgrid/v20200401preview:EventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20220615:EventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
