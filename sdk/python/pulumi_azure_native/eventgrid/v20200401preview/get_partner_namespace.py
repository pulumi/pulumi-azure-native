...
warnings.warn("""azure-native:eventgrid/v20200401preview:PartnerNamespace is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:PartnerNamespace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_partner_namespace(partner_namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_namespace is deprecated: azure-native:eventgrid/v20200401preview:PartnerNamespace is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:PartnerNamespace to guarantee forwards compatibility.""")
    __args__ = dict()
