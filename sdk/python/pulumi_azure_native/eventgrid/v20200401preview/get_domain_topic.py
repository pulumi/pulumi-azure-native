...
warnings.warn("""azure-native:eventgrid/v20200401preview:DomainTopic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:DomainTopic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic is deprecated: azure-native:eventgrid/v20200401preview:DomainTopic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20220615:DomainTopic to guarantee forwards compatibility.""")
    __args__ = dict()
