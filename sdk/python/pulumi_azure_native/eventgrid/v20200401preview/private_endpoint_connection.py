...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventgrid/v20200401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventgrid:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventgrid:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventgrid/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20201015preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20210601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventgrid/v20211201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20211201:PrivateEndpointConnection")])
