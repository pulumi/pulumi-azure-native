...
def get_topic_event_subscription_full_url(event_subscription_name: Optional[builtins.str] = None,
    ...
    :param builtins.str topic_name: Name of the domain topic.
    """
    __args__ = dict()
...
def get_topic_event_subscription_full_url_output(event_subscription_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid:getTopicEventSubscriptionFullUrl', __args__, opts=opts, typ=GetTopicEventSubscriptionFullUrlResult)
    return __ret__.apply(lambda __response__: GetTopicEventSubscriptionFullUrlResult(
