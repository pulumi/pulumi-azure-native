...
def get_channel_full_url(channel_name: Optional[builtins.str] = None,
...
def get_channel_full_url_output(channel_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid:getChannelFullUrl', __args__, opts=opts, typ=GetChannelFullUrlResult)
