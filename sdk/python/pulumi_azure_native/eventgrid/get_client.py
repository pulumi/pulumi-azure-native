...
def get_client(client_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str client_name: Name of the client.
...
def get_client_output(client_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
