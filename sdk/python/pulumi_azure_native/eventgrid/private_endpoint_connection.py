...
class PrivateEndpointConnectionInitArgs:
    def __init__(__self__, *,
                 parent_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] parent_name: The name of the parent resource (namely, either, the topic name, domain name, or partner namespace name or namespace name).
        :param pulumi.Input[builtins.str] parent_type: The type of the parent resource. This can be either \\'topics\\', \\'domains\\', or \\'partnerNamespaces\\' or \\'namespaces\\'.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_connection_name: The name of the private endpoint connection connection.
    ...
    def parent_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @parent_name.setter
    def parent_name(self, value: pulumi.Input[builtins.str]):
