...
class EventChannel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        Event Channel.
        Azure REST API version: 2021-10-15-preview. Prior API version in Azure Native 1.x: 2021-06-01-preview
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:EventChannel")])
