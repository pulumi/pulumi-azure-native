...
def get_topic_event_subscription(event_subscription_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str event_subscription_name: Name of the event subscription to be found.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid:getTopicEventSubscription', __args__, opts=opts, typ=GetTopicEventSubscriptionResult).value
...
def get_topic_event_subscription_output(event_subscription_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid:getTopicEventSubscription', __args__, opts=opts, typ=GetTopicEventSubscriptionResult)
