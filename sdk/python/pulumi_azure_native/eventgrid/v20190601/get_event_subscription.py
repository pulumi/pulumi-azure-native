...
class GetEventSubscriptionResult:
    ...
    Event Subscription
    """
    def __init__(__self__, dead_letter_destination=None, destination=None, expiration_time_utc=None, filter=None, id=None, labels=None, name=None, provisioning_state=None, retry_policy=None, topic=None, type=None):
...
def get_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_subscription is deprecated: Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20190601:getEventSubscription', __args__, opts=opts, typ=GetEventSubscriptionResult).value
