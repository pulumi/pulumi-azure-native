...
azure-native:eventgrid/v20190601:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic is deprecated: Version 2019-06-01 will be removed in v2 of the provider.
azure-native:eventgrid/v20190601:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20190601:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult).value
