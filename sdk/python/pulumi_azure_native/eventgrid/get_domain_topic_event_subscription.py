...
def get_domain_topic_event_subscription(domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_name: Name of the top level domain.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid:getDomainTopicEventSubscription', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionResult).value
...
def get_domain_topic_event_subscription_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
