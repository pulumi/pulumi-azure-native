...
class SystemTopicEventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        system_topic_event_subscription = azure_native.eventgrid.v20220615.SystemTopicEventSubscription("systemTopicEventSubscription",
            destination=azure_native.eventgrid.v20220615.WebHookEventSubscriptionDestinationArgs(
                endpoint_type="WebHook",
                endpoint_url="https://requestb.in/15ksip71",
            ),
            event_subscription_name="exampleEventSubscriptionName1",
            filter=azure_native.eventgrid.v20220615.EventSubscriptionFilterArgs(
        ...
        ```sh
        $ pulumi import azure-native:eventgrid/v20220615:SystemTopicEventSubscription exampleEventSubscriptionName1 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/resourceGroups/examplerg/providers/Microsoft.EventGrid/systemTopics/exampleSystemTopic1/eventSubscriptions/exampleEventSubscriptionName1 
        ```
