...
def get_partner_registration(partner_registration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_registration is deprecated: azure-native:eventgrid/v20220615:PartnerRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
