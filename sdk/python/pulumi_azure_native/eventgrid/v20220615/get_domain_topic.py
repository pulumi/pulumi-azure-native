...
warnings.warn("""azure-native:eventgrid/v20220615:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic is deprecated: azure-native:eventgrid/v20220615:DomainTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopic to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['domainName'] = domain_name
    __args__['domainTopicName'] = domain_topic_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20220615:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult).value
