...
def get_domain_event_subscription(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_event_subscription is deprecated: azure-native:eventgrid/v20220615:DomainEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainEventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['domainName'] = domain_name
    __args__['eventSubscriptionName'] = event_subscription_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20220615:getDomainEventSubscription', __args__, opts=opts, typ=GetDomainEventSubscriptionResult).value
