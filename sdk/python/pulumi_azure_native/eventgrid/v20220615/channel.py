...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if partner_topic_info is not None and not isinstance(partner_topic_info, PartnerTopicInfoArgs):
                partner_topic_info = partner_topic_info or {}
                def _setter(key, value):
                    partner_topic_info[key] = value
                PartnerTopicInfoArgs._configure(_setter, **partner_topic_info)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Channel")])
