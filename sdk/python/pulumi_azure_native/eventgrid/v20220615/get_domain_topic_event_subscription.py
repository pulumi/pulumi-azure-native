...
def get_domain_topic_event_subscription(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic_event_subscription is deprecated: azure-native:eventgrid/v20220615:DomainTopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainTopicEventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
