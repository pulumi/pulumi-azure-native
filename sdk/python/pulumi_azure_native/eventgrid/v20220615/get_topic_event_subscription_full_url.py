...
def get_topic_event_subscription_full_url(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20220615:getTopicEventSubscriptionFullUrl', __args__, opts=opts, typ=GetTopicEventSubscriptionFullUrlResult).value
...
def get_topic_event_subscription_full_url_output(event_subscription_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20220615:getTopicEventSubscriptionFullUrl', __args__, opts=opts, typ=GetTopicEventSubscriptionFullUrlResult)
