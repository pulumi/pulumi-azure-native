...
def get_domain_topic_event_subscription_delivery_attributes(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20220615:getDomainTopicEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionDeliveryAttributesResult).value
...
def get_domain_topic_event_subscription_delivery_attributes_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20220615:getDomainTopicEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionDeliveryAttributesResult)
