...
warnings.warn("""azure-native:eventgrid/v20220615:PartnerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_partner_configuration(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_configuration is deprecated: azure-native:eventgrid/v20220615:PartnerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20220615:getPartnerConfiguration', __args__, opts=opts, typ=GetPartnerConfigurationResult).value

    return AwaitableGetPartnerConfigurationResult(
        id=__ret__.id,
        location=__ret__.location,
        name=__ret__.name,
        partner_authorization=__ret__.partner_authorization,
