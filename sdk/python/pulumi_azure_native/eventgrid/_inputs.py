...
class AzureFunctionEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the azure function destination for an event subscription.
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'AzureFunction'.
        ...
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource Id that represents the endpoint of the Azure Function destination of an event subscription.
        """
...
if not MYPY:
    class BoolEqualsAdvancedFilterArgsDict(TypedDict):
        ...
        """
        operator_type: pulumi.Input[builtins.str]
        """
...
class BoolEqualsAdvancedFilterArgs:
    def __init__(__self__, *,
        ...
        """
        BoolEquals Advanced Filter.
        :param pulumi.Input[builtins.str] operator_type: The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
               Expected value is 'BoolEquals'.
        :param pulumi.Input[builtins.str] key: The field/property in the event based on which you want to filter.
        :param pulumi.Input[builtins.bool] value: The boolean filter value.
        """
    ...
    def operator_type(self) -> pulumi.Input[builtins.str]:
        """
        The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
        Expected value is 'BoolEquals'.
        """
    ...
    def operator_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClientCertificateAuthenticationArgsDict(TypedDict):
        ...
        """
        allowed_thumbprints: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of thumbprints that are allowed during client authentication. This property is required only if the validationScheme is 'ThumbprintMatch'.
        """
        validation_scheme: NotRequired[pulumi.Input[Union[builtins.str, 'ClientCertificateValidationScheme']]]
        """
...
class ClientCertificateAuthenticationArgs:
    def __init__(__self__, *,
                 allowed_thumbprints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 validation_scheme: Optional[pulumi.Input[Union[builtins.str, 'ClientCertificateValidationScheme']]] = None):
        """
        The certificate authentication properties for the client.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_thumbprints: The list of thumbprints that are allowed during client authentication. This property is required only if the validationScheme is 'ThumbprintMatch'.
        :param pulumi.Input[Union[builtins.str, 'ClientCertificateValidationScheme']] validation_scheme: The validation scheme used to authenticate the client. Default value is SubjectMatchesAuthenticationName.
        """
    ...
    def allowed_thumbprints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of thumbprints that are allowed during client authentication. This property is required only if the validationScheme is 'ThumbprintMatch'.
        """
    ...
    def allowed_thumbprints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_thumbprints", value)

    @property
    @pulumi.getter(name="validationScheme")
    def validation_scheme(self) -> Optional[pulumi.Input[Union[builtins.str, 'ClientCertificateValidationScheme']]]:
        """
        The validation scheme used to authenticate the client. Default value is SubjectMatchesAuthenticationName.
        """
    ...
    def validation_scheme(self, value: Optional[pulumi.Input[Union[builtins.str, 'ClientCertificateValidationScheme']]]):
...
if not MYPY:
    class CustomDomainConfigurationArgsDict(TypedDict):
        ...
        """
        fully_qualified_domain_name: pulumi.Input[builtins.str]
        """
        ...
        """
        expected_txt_record_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        expected_txt_record_value: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        validation_state: NotRequired[pulumi.Input[Union[builtins.str, 'CustomDomainValidationState']]]
        """
...
class CustomDomainConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 expected_txt_record_name: Optional[pulumi.Input[builtins.str]] = None,
                 expected_txt_record_value: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['CustomDomainIdentityArgs']] = None,
                 validation_state: Optional[pulumi.Input[Union[builtins.str, 'CustomDomainValidationState']]] = None):
        """
        A custom domain configuration that allows users to publish to their own domain name.
        :param pulumi.Input[builtins.str] fully_qualified_domain_name: Fully Qualified Domain Name (FQDN) for the custom domain.
        :param pulumi.Input[builtins.str] certificate_url: The URL for the certificate that is used for publishing to the custom domain. We currently support certificates stored in Azure Key Vault only. While certificate URL can be either
               versioned URL of the following format https://{key-vault-name}.vault.azure.net/certificates/{certificate-name}/{version-id}, or unversioned URL of the following format (e.g.,
               https://contosovault.vault.azure.net/certificates/contosocert, we support unversioned certificate URL only (e.g., https://contosovault.vault.azure.net/certificates/contosocert)
        :param pulumi.Input[builtins.str] expected_txt_record_name: Expected DNS TXT record name. Event Grid will check for a TXT record with this name in the DNS record set of the custom domain name to prove ownership over the domain.
               The values under this TXT record must contain the expected TXT record value.
        :param pulumi.Input[builtins.str] expected_txt_record_value: Expected DNS TXT record value. Event Grid will check for a TXT record with this value in the DNS record set of the custom domain name to prove ownership over the domain.
        ...
        :param pulumi.Input[Union[builtins.str, 'CustomDomainValidationState']] validation_state: Validation state for the custom domain. This is a read only property and is initially set to 'Pending' and will be updated to 'Approved' by Event Grid only after ownership of the domain name has been successfully validated.
        """
    ...
    def fully_qualified_domain_name(self) -> pulumi.Input[builtins.str]:
        """
        Fully Qualified Domain Name (FQDN) for the custom domain.
        """
    ...
    def fully_qualified_domain_name(self, value: pulumi.Input[builtins.str]):
    ...
    def expected_txt_record_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Expected DNS TXT record name. Event Grid will check for a TXT record with this name in the DNS record set of the custom domain name to prove ownership over the domain.
        The values under this TXT record must contain the expected TXT record value.
        """
    ...
    def expected_txt_record_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expected_txt_record_name", value)

    @property
    @pulumi.getter(name="expectedTxtRecordValue")
    def expected_txt_record_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Expected DNS TXT record value. Event Grid will check for a TXT record with this value in the DNS record set of the custom domain name to prove ownership over the domain.
        """
    ...
    def expected_txt_record_value(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validation_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'CustomDomainValidationState']]]:
        """
        Validation state for the custom domain. This is a read only property and is initially set to 'Pending' and will be updated to 'Approved' by Event Grid only after ownership of the domain name has been successfully validated.
        """
    ...
    def validation_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'CustomDomainValidationState']]]):
...
if not MYPY:
    class CustomDomainIdentityArgsDict(TypedDict):
        ...
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'CustomDomainIdentityType']]]
        """
...
class CustomDomainIdentityArgs:
    def __init__(__self__, *,
                 type: Optional[pulumi.Input[Union[builtins.str, 'CustomDomainIdentityType']]] = None,
                 user_assigned_identity: Optional[pulumi.Input[builtins.str]] = None):
        """
        The identity information for retrieving the certificate for the custom domain.
        :param pulumi.Input[Union[builtins.str, 'CustomDomainIdentityType']] type: The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'.
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'CustomDomainIdentityType']]]:
        """
        The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'.
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'CustomDomainIdentityType']]]):
...
if not MYPY:
    class DeliveryConfigurationArgsDict(TypedDict):
        ...
        """
        delivery_mode: NotRequired[pulumi.Input[Union[builtins.str, 'DeliveryMode']]]
        """
...
class DeliveryConfigurationArgs:
    def __init__(__self__, *,
                 delivery_mode: Optional[pulumi.Input[Union[builtins.str, 'DeliveryMode']]] = None,
                 push: Optional[pulumi.Input['PushInfoArgs']] = None,
                 queue: Optional[pulumi.Input['QueueInfoArgs']] = None):
        """
        Properties of the delivery configuration information of the event subscription.
        :param pulumi.Input[Union[builtins.str, 'DeliveryMode']] delivery_mode: Delivery mode of the event subscription.
    ...
    def delivery_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'DeliveryMode']]]:
        """
        Delivery mode of the event subscription.
        """
    ...
    def delivery_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeliveryMode']]]):
...
class DynamicDeliveryAttributeMappingArgs:
    def __init__(__self__, *,
        ...
        """
        Dynamic delivery attribute mapping details.
        :param pulumi.Input[builtins.str] type: Type of the delivery attribute or header name.
               Expected value is 'Dynamic'.
        :param pulumi.Input[builtins.str] name: Name of the delivery attribute or header.
        :param pulumi.Input[builtins.str] source_field: JSON path in the event which contains attribute value.
        """
...
class DynamicRoutingEnrichmentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Dynamic routing enrichment key.
        :param pulumi.Input[builtins.str] value: Dynamic routing enrichment value.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class EventHubEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'EventHub'.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]] delivery_attribute_mappings: Delivery attribute details.
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource Id that represents the endpoint of an Event Hub destination of an event subscription.
        """
...
if not MYPY:
    class EventSubscriptionFilterArgsDict(TypedDict):
        ...
        """
        enable_advanced_filtering_on_arrays: NotRequired[pulumi.Input[builtins.bool]]
        """
        Allows advanced filters to be evaluated against an array of values instead of expecting a singular value.
        """
        included_event_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of applicable event types that need to be part of the event subscription. If it is desired to subscribe to all default event types, set the IncludedEventTypes to null.
        """
        is_subject_case_sensitive: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EventSubscriptionFilterArgs:
    def __init__(__self__, *,
                 ...
                 enable_advanced_filtering_on_arrays: Optional[pulumi.Input[builtins.bool]] = None,
                 included_event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_subject_case_sensitive: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_advanced_filtering_on_arrays: Allows advanced filters to be evaluated against an array of values instead of expecting a singular value.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_event_types: A list of applicable event types that need to be part of the event subscription. If it is desired to subscribe to all default event types, set the IncludedEventTypes to null.
        :param pulumi.Input[builtins.bool] is_subject_case_sensitive: Specifies if the SubjectBeginsWith and SubjectEndsWith properties of the filter
               should be compared in a case sensitive manner.
        :param pulumi.Input[builtins.str] subject_begins_with: An optional string to filter events for an event subscription based on a resource path prefix.
               The format of this depends on the publisher of the events.
               Wildcard characters are not supported in this path.
        :param pulumi.Input[builtins.str] subject_ends_with: An optional string to filter events for an event subscription based on a resource path suffix.
               Wildcard characters are not supported in this path.
        """
    ...
    def enable_advanced_filtering_on_arrays(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allows advanced filters to be evaluated against an array of values instead of expecting a singular value.
        """
    ...
    def enable_advanced_filtering_on_arrays(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_subject_case_sensitive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies if the SubjectBeginsWith and SubjectEndsWith properties of the filter
        should be compared in a case sensitive manner.
        """
    ...
    def is_subject_case_sensitive(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class EventSubscriptionIdentityArgsDict(TypedDict):
        ...
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'EventSubscriptionIdentityType']]]
        """
        The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'.
        """
        user_assigned_identity: NotRequired[pulumi.Input[builtins.str]]
...
class EventSubscriptionIdentityArgs:
    def __init__(__self__, *,
                 type: Optional[pulumi.Input[Union[builtins.str, 'EventSubscriptionIdentityType']]] = None,
                 user_assigned_identity: Optional[pulumi.Input[builtins.str]] = None):
        """
        The identity information with the event subscription.
        :param pulumi.Input[Union[builtins.str, 'EventSubscriptionIdentityType']] type: The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'.
        :param pulumi.Input[builtins.str] user_assigned_identity: The user identity associated with the resource.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'EventSubscriptionIdentityType']]]:
        """
        The type of managed identity used. Can be either 'SystemAssigned' or 'UserAssigned'.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'EventSubscriptionIdentityType']]]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class EventTypeInfoArgsDict(TypedDict):
        ...
        """
        kind: NotRequired[pulumi.Input[Union[builtins.str, 'EventDefinitionKind']]]
        """
...
class EventTypeInfoArgs:
    def __init__(__self__, *,
                 ...
                 kind: Optional[pulumi.Input[Union[builtins.str, 'EventDefinitionKind']]] = None):
        """
        The event type information for Channels.
        :param pulumi.Input[Mapping[str, pulumi.Input['InlineEventPropertiesArgs']]] inline_event_types: A collection of inline event types for the resource. The inline event type keys are of type string which represents the name of the event.
               An example of a valid inline event name is "Contoso.OrderCreated".
               The inline event type values are of type InlineEventProperties and will contain additional information for every inline event type.
        :param pulumi.Input[Union[builtins.str, 'EventDefinitionKind']] kind: The kind of event type used.
        """
    ...
    @property
    @pulumi.getter
    def kind(self) -> Optional[pulumi.Input[Union[builtins.str, 'EventDefinitionKind']]]:
        """
        The kind of event type used.
        """
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[builtins.str, 'EventDefinitionKind']]]):
...
class HybridConnectionEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'HybridConnection'.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]] delivery_attribute_mappings: Delivery attribute details.
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource ID of an hybrid connection that is the destination of an event subscription.
        """
...
class IdentityInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'IdentityType']] type: The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identity.
...
if not MYPY:
    class InboundIpRuleArgsDict(TypedDict):
        action: NotRequired[pulumi.Input[Union[builtins.str, 'IpActionType']]]
        """
...
class InboundIpRuleArgs:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[Union[builtins.str, 'IpActionType']]] = None,
                 ip_mask: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Union[builtins.str, 'IpActionType']] action: Action to perform based on the match or no match of the IpMask.
        :param pulumi.Input[builtins.str] ip_mask: IP Address in CIDR notation e.g., 10.0.0.0/8.
        """
    ...
    @property
    @pulumi.getter
    def action(self) -> Optional[pulumi.Input[Union[builtins.str, 'IpActionType']]]:
        """
        Action to perform based on the match or no match of the IpMask.
        """
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Union[builtins.str, 'IpActionType']]]):
...
if not MYPY:
    class InlineEventPropertiesArgsDict(TypedDict):
        ...
        """
        data_schema_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InlineEventPropertiesArgs:
    def __init__(__self__, *,
                 data_schema_url: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 documentation_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        Additional information about every inline event.
        :param pulumi.Input[builtins.str] data_schema_url: The dataSchemaUrl for the inline event.
        :param pulumi.Input[builtins.str] description: The description for the inline event.
        :param pulumi.Input[builtins.str] display_name: The displayName for the inline event.
        :param pulumi.Input[builtins.str] documentation_url: The documentationUrl for the inline event.
        """
    ...
    def data_schema_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The dataSchemaUrl for the inline event.
        """
    ...
    def data_schema_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JsonFieldWithDefaultArgs:
    def __init__(__self__, *,
        ...
        'eventtype' and 'dataversion' properties. This represents a field in the input event schema
        along with a default value to be used, and at least one of these two properties should be provided.
        :param pulumi.Input[builtins.str] default_value: The default value to be used for mapping when a SourceField is not provided or if there's no property with the specified name in the published JSON event payload.
        :param pulumi.Input[builtins.str] source_field: Name of a field in the input event schema that's to be used as the source of a mapping.
        """
...
if not MYPY:
    class JsonInputSchemaMappingArgsDict(TypedDict):
        ...
        """
        input_schema_mapping_type: pulumi.Input[builtins.str]
        """
...
class JsonInputSchemaMappingArgs:
    def __init__(__self__, *,
        ...
        """
        This enables publishing to Event Grid using a custom input schema. This can be used to map properties from a custom input JSON schema to the Event Grid event schema.
        :param pulumi.Input[builtins.str] input_schema_mapping_type: Type of the custom mapping
               Expected value is 'Json'.
    ...
    def input_schema_mapping_type(self) -> pulumi.Input[builtins.str]:
        """
        Type of the custom mapping
        Expected value is 'Json'.
        """
    ...
    def input_schema_mapping_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MonitorAlertEventSubscriptionDestinationArgsDict(TypedDict):
        ...
        """
        severity: NotRequired[pulumi.Input[Union[builtins.str, 'MonitorAlertSeverity']]]
        """
...
class MonitorAlertEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 severity: Optional[pulumi.Input[Union[builtins.str, 'MonitorAlertSeverity']]] = None):
        """
        Information about the Monitor Alert destination for an event subscription.
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'MonitorAlert'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] action_groups: The list of ARM Ids of Action Groups that will be triggered on every Alert fired through this event subscription.
               Each resource ARM Id should follow this pattern: /subscriptions/{AzureSubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Insights/actionGroups/{ActionGroupName}.
        :param pulumi.Input[builtins.str] description: The description that will be attached to every Alert fired through this event subscription.
        :param pulumi.Input[Union[builtins.str, 'MonitorAlertSeverity']] severity: The severity that will be attached to every Alert fired through this event subscription.
               This field must be provided.
        """
    ...
    @property
    @pulumi.getter
    def severity(self) -> Optional[pulumi.Input[Union[builtins.str, 'MonitorAlertSeverity']]]:
        """
        The severity that will be attached to every Alert fired through this event subscription.
        This field must be provided.
        """
    ...
    @severity.setter
    def severity(self, value: Optional[pulumi.Input[Union[builtins.str, 'MonitorAlertSeverity']]]):
...
class NamespaceSkuArgs:
    def __init__(__self__, *,
        ...
        """
        Represents available Sku pricing tiers.
        :param pulumi.Input[builtins.int] capacity: Specifies the number of Throughput Units that defines the capacity for the namespace. The property default value is
               1 which signifies 1 Throughput Unit = 1MB/s ingress and 2MB/s egress per namespace. Min capacity is 1 and
               max allowed capacity is 20.
        :param pulumi.Input[Union[builtins.str, 'SkuName']] name: The name of the SKU.
        """
...
class NamespaceTopicEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'NamespaceTopic'.
        :param pulumi.Input[builtins.str] resource_id: The Azure resource Id that represents the endpoint of the Event Grid Namespace Topic destination of an event subscription.
               This field is required and the Namespace Topic resource listed must already exist.
               The resource ARM Id should follow this pattern: /subscriptions/{AzureSubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.EventGrid/namespaces/{NamespaceName}/topics/{TopicName}.
        """
...
class NumberGreaterThanAdvancedFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator_type: The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
               Expected value is 'NumberGreaterThan'.
        :param pulumi.Input[builtins.str] key: The field/property in the event based on which you want to filter.
        :param pulumi.Input[builtins.float] value: The filter value.
        """
...
class NumberInAdvancedFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator_type: The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
               Expected value is 'NumberIn'.
        :param pulumi.Input[builtins.str] key: The field/property in the event based on which you want to filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.float]]] values: The set of filter values.
        """
...
if not MYPY:
    class NumberInRangeAdvancedFilterArgsDict(TypedDict):
        ...
        The field/property in the event based on which you want to filter.
        """
        values: NotRequired[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]]
        """
        The set of filter values.
        """
elif False:
...
class NumberInRangeAdvancedFilterArgs:
    def __init__(__self__, *,
                 operator_type: pulumi.Input[builtins.str],
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]] = None):
        """
        NumberInRange Advanced Filter.
        :param pulumi.Input[builtins.str] operator_type: The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
               Expected value is 'NumberInRange'.
        :param pulumi.Input[builtins.str] key: The field/property in the event based on which you want to filter.
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]] values: The set of filter values.
        """
    ...
    @property
    @pulumi.getter
    def values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]]:
        """
        The set of filter values.
        """
        return pulumi.get(self, "values")
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]]]):
        pulumi.set(self, "values", value)
...
if not MYPY:
    class PartnerAuthorizationArgsDict(TypedDict):
        ...
        """
        default_maximum_expiration_time_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PartnerAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] default_maximum_expiration_time_in_days: Time used to validate the authorization expiration time for each authorized partner. If DefaultMaximumExpirationTimeInDays is
               not specified, the default is 7 days. Otherwise, allowed values are between 1 and 365 days.
        """
...
class PartnerTopicInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Properties of the corresponding partner topic of a Channel.
        :param pulumi.Input[builtins.str] azure_subscription_id: Azure subscription ID of the subscriber. The partner topic associated with the channel will be
               created under this Azure subscription.
        :param pulumi.Input['EventTypeInfoArgs'] event_type_info: Event Type Information for the partner topic. This information is provided by the publisher and can be used by the 
               subscriber to view different types of events that are published.
        :param pulumi.Input[builtins.str] name: Name of the partner topic associated with the channel.
        :param pulumi.Input[builtins.str] resource_group_name: Azure Resource Group of the subscriber. The partner topic associated with the channel will be
               created under this resource group.
        :param pulumi.Input[builtins.str] source: The source information is provided by the publisher to determine the scope or context from which the events
               are originating. This information can be used by the subscriber during the approval process of the
               created partner topic.
        """
...
if not MYPY:
    class PartnerArgsDict(TypedDict):
        ...
        """
        partner_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The partner name.
        """
        partner_registration_immutable_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PartnerArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the partner.
        :param pulumi.Input[builtins.str] authorization_expiration_time_in_utc: Expiration time of the partner authorization. If this timer expires, any request from this partner to create, update or delete resources in subscriber's
               context will fail. If specified, the allowed values are between 1 to the value of defaultMaximumExpirationTimeInDays specified in PartnerConfiguration.
               If not specified, the default value will be the value of defaultMaximumExpirationTimeInDays specified in PartnerConfiguration or 7 if this value is not specified.
...
if not MYPY:
    class PushInfoArgsDict(TypedDict):
        ...
        """
        event_time_to_live: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PushInfoArgs:
    def __init__(__self__, *,
                 ...
                 destination: Optional[pulumi.Input[Union['AzureFunctionEventSubscriptionDestinationArgs', 'EventHubEventSubscriptionDestinationArgs', 'HybridConnectionEventSubscriptionDestinationArgs', 'MonitorAlertEventSubscriptionDestinationArgs', 'NamespaceTopicEventSubscriptionDestinationArgs', 'ServiceBusQueueEventSubscriptionDestinationArgs', 'ServiceBusTopicEventSubscriptionDestinationArgs', 'StorageQueueEventSubscriptionDestinationArgs', 'WebHookEventSubscriptionDestinationArgs']]] = None,
                 event_time_to_live: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union['AzureFunctionEventSubscriptionDestinationArgs', 'EventHubEventSubscriptionDestinationArgs', 'HybridConnectionEventSubscriptionDestinationArgs', 'MonitorAlertEventSubscriptionDestinationArgs', 'NamespaceTopicEventSubscriptionDestinationArgs', 'ServiceBusQueueEventSubscriptionDestinationArgs', 'ServiceBusTopicEventSubscriptionDestinationArgs', 'StorageQueueEventSubscriptionDestinationArgs', 'WebHookEventSubscriptionDestinationArgs']] destination: Information about the destination where events have to be delivered for the event subscription.
               Uses Azure Event Grid's identity to acquire the authentication tokens being used during delivery.
        :param pulumi.Input[builtins.str] event_time_to_live: Time span duration in ISO 8601 format that determines how long messages are available to the subscription from the time the message was published.
               This duration value is expressed using the following format: \\'P(n)Y(n)M(n)DT(n)H(n)M(n)S\\', where:
                   - (n) is replaced by the value of each time element that follows the (n).
                   - P is the duration (or Period) designator and is always placed at the beginning of the duration.
                   - Y is the year designator, and it follows the value for the number of years.
               ...
               by topic’s EventRetentionInDays value. The followings are examples of valid values:
                   - \\'P0DT23H12M\\' or \\'PT23H12M\\': for duration of 23 hours and 12 minutes.
                   - \\'P1D\\' or \\'P1DT0H0M0S\\': for duration of 1 day.
        :param pulumi.Input[builtins.int] max_delivery_count: The maximum delivery count of the events.
        """
    ...
    def event_time_to_live(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Time span duration in ISO 8601 format that determines how long messages are available to the subscription from the time the message was published.
        This duration value is expressed using the following format: \\'P(n)Y(n)M(n)DT(n)H(n)M(n)S\\', where:
            - (n) is replaced by the value of each time element that follows the (n).
    ...
    def event_time_to_live(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class QueueInfoArgsDict(TypedDict):
        ...
        The maximum delivery count of the events.
        """
        receive_lock_duration_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class QueueInfoArgs:
    def __init__(__self__, *,
                 ...
                 event_time_to_live: Optional[pulumi.Input[builtins.str]] = None,
                 max_delivery_count: Optional[pulumi.Input[builtins.int]] = None,
                 receive_lock_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        Properties of the Queue info for event subscription.
        :param pulumi.Input['DeadLetterWithResourceIdentityArgs'] dead_letter_destination_with_resource_identity: The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to the dead letter destination.
               Uses the managed identity setup on the parent resource (namely, topic) to acquire the authentication tokens being used during delivery / dead-lettering.
        :param pulumi.Input[builtins.str] event_time_to_live: Time span duration in ISO 8601 format that determines how long messages are available to the subscription from the time the message was published.
               ...
               by topic’s EventRetentionInDays value. The followings are examples of valid values:
                   ...
                   - \\'P1D\\' or \\'P1DT0H0M0S\\': for duration of 1 day.
        :param pulumi.Input[builtins.int] max_delivery_count: The maximum delivery count of the events.
        :param pulumi.Input[builtins.int] receive_lock_duration_in_seconds: Maximum period in seconds in which once the message is in received (by the client) state and waiting to be accepted, released or rejected.
               If this time elapsed after a message has been received by the client and not transitioned into accepted (not processed), released or rejected,
               the message is available for redelivery. This is an optional field, where default is 60 seconds, minimum is 60 seconds and maximum is 300 seconds.
        """
        if dead_letter_destination_with_resource_identity is not None:
    ...
    def receive_lock_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum period in seconds in which once the message is in received (by the client) state and waiting to be accepted, released or rejected.
        If this time elapsed after a message has been received by the client and not transitioned into accepted (not processed), released or rejected,
        the message is available for redelivery. This is an optional field, where default is 60 seconds, minimum is 60 seconds and maximum is 300 seconds.
    ...
    def receive_lock_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class RetryPolicyArgsDict(TypedDict):
        ...
        """
        event_time_to_live_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RetryPolicyArgs:
    def __init__(__self__, *,
                 event_time_to_live_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 max_delivery_attempts: Optional[pulumi.Input[builtins.int]] = None):
        """
        Information about the retry policy for an event subscription.
        :param pulumi.Input[builtins.int] event_time_to_live_in_minutes: Time To Live (in minutes) for events.
        :param pulumi.Input[builtins.int] max_delivery_attempts: Maximum number of delivery retry attempts for events.
        """
    ...
    def event_time_to_live_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Time To Live (in minutes) for events.
        """
    ...
    def event_time_to_live_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class RoutingIdentityInfoArgsDict(TypedDict):
        ...
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'RoutingIdentityType']]]
        """
...
class RoutingIdentityInfoArgs:
    def __init__(__self__, *,
                 type: Optional[pulumi.Input[Union[builtins.str, 'RoutingIdentityType']]] = None,
                 user_assigned_identity: Optional[pulumi.Input[builtins.str]] = None):
        """
        Routing identity info for topic spaces configuration.
        :param pulumi.Input[Union[builtins.str, 'RoutingIdentityType']] type: Routing identity type for topic spaces configuration.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if user_assigned_identity is not None:
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'RoutingIdentityType']]]:
        """
        Routing identity type for topic spaces configuration.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'RoutingIdentityType']]]):
        pulumi.set(self, "type", value)
...
class ServiceBusQueueEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'ServiceBusQueue'.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]] delivery_attribute_mappings: Delivery attribute details.
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource Id that represents the endpoint of the Service Bus destination of an event subscription.
        """
...
class ServiceBusTopicEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'ServiceBusTopic'.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]] delivery_attribute_mappings: Delivery attribute details.
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource Id that represents the endpoint of the Service Bus Topic destination of an event subscription.
        """
...
class StaticDeliveryAttributeMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of the delivery attribute or header name.
               Expected value is 'Static'.
        :param pulumi.Input[builtins.bool] is_secret: Boolean flag to tell if the attribute contains sensitive information .
        :param pulumi.Input[builtins.str] name: Name of the delivery attribute or header.
        :param pulumi.Input[builtins.str] value: Value of the delivery attribute.
        """
...
class StaticStringRoutingEnrichmentArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] value_type: Static routing enrichment value type. For e.g. this property value can be 'String'.
               Expected value is 'String'.
        :param pulumi.Input[builtins.str] key: Static routing enrichment key.
        :param pulumi.Input[builtins.str] value: String type routing enrichment value.
        """
...
class StorageBlobDeadLetterDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        Information about the storage blob based dead letter destination.
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the dead letter destination
               Expected value is 'StorageBlob'.
        :param pulumi.Input[builtins.str] blob_container_name: The name of the Storage blob container that is the destination of the deadletter events
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource ID of the storage account that is the destination of the deadletter events
        """
...
if not MYPY:
    class StorageQueueEventSubscriptionDestinationArgsDict(TypedDict):
        ...
        """
        queue_message_time_to_live_in_seconds: NotRequired[pulumi.Input[builtins.float]]
        """
...
class StorageQueueEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
                 endpoint_type: pulumi.Input[builtins.str],
                 queue_message_time_to_live_in_seconds: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'StorageQueue'.
        :param pulumi.Input[builtins.float] queue_message_time_to_live_in_seconds: Storage queue message time to live in seconds. This value cannot be zero or negative with the exception of using -1 to indicate that the Time To Live of the message is Infinite.
        :param pulumi.Input[builtins.str] queue_name: The name of the Storage queue under a storage account that is the destination of an event subscription.
        :param pulumi.Input[builtins.str] resource_id: The Azure Resource ID of the storage account that contains the queue that is the destination of an event subscription.
        """
    ...
    def queue_message_time_to_live_in_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Storage queue message time to live in seconds. This value cannot be zero or negative with the exception of using -1 to indicate that the Time To Live of the message is Infinite.
        """
    ...
    def queue_message_time_to_live_in_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
...
class StringBeginsWithAdvancedFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator_type: The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
               Expected value is 'StringBeginsWith'.
        :param pulumi.Input[builtins.str] key: The field/property in the event based on which you want to filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The set of filter values.
        """
...
if not MYPY:
    class TopicSpacesConfigurationArgsDict(TypedDict):
        ...
        """
        route_topic_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Routing identity info for topic spaces configuration.
        """
        state: NotRequired[pulumi.Input[Union[builtins.str, 'TopicSpacesConfigurationState']]]
        """
...
class TopicSpacesConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 route_topic_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'TopicSpacesConfigurationState']]] = None):
        """
        Properties of the Topic Spaces Configuration.
        ...
        :param pulumi.Input[builtins.int] maximum_client_sessions_per_authentication_name: The maximum number of sessions per authentication name. The property default value is 1.
               Min allowed value is 1 and max allowed value is 100.
        :param pulumi.Input[builtins.int] maximum_session_expiry_in_hours: The maximum session expiry in hours. The property default value is 1 hour.
               Min allowed value is 1 hour and max allowed value is 8 hours.
        :param pulumi.Input[builtins.str] route_topic_resource_id: Fully qualified Azure Resource Id for the Event Grid Topic to which events will be routed to from TopicSpaces under a namespace.
               This property should be in the following format '/subscriptions/{subId}/resourcegroups/{resourceGroupName}/providers/microsoft.EventGrid/topics/{topicName}'.
               This topic should reside in the same region where namespace is located.
        ...
        :param pulumi.Input[Union[builtins.str, 'TopicSpacesConfigurationState']] state: Indicate if Topic Spaces Configuration is enabled for the namespace. Default is Disabled.
        """
    ...
    def route_topic_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Fully qualified Azure Resource Id for the Event Grid Topic to which events will be routed to from TopicSpaces under a namespace.
        This property should be in the following format '/subscriptions/{subId}/resourcegroups/{resourceGroupName}/providers/microsoft.EventGrid/topics/{topicName}'.
        This topic should reside in the same region where namespace is located.
    ...
    def route_topic_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'TopicSpacesConfigurationState']]]:
        """
        Indicate if Topic Spaces Configuration is enabled for the namespace. Default is Disabled.
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'TopicSpacesConfigurationState']]]):
...
if not MYPY:
    class WebHookEventSubscriptionDestinationArgsDict(TypedDict):
        ...
        """
        azure_active_directory_application_id_or_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in delivery requests.
        """
        azure_active_directory_tenant_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Maximum number of events per batch.
        """
        minimum_tls_version_allowed: NotRequired[pulumi.Input[Union[builtins.str, 'TlsVersion']]]
        """
...
class WebHookEventSubscriptionDestinationArgs:
    def __init__(__self__, *,
                 endpoint_type: pulumi.Input[builtins.str],
                 azure_active_directory_application_id_or_uri: Optional[pulumi.Input[builtins.str]] = None,
                 azure_active_directory_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_attribute_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint for the event subscription destination.
               Expected value is 'WebHook'.
        :param pulumi.Input[builtins.str] azure_active_directory_application_id_or_uri: The Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in delivery requests.
        :param pulumi.Input[builtins.str] azure_active_directory_tenant_id: The Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery requests.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DynamicDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgs']]]] delivery_attribute_mappings: Delivery attribute details.
        :param pulumi.Input[builtins.str] endpoint_url: The URL that represents the endpoint of the destination of an event subscription.
        :param pulumi.Input[builtins.int] max_events_per_batch: Maximum number of events per batch.
        :param pulumi.Input[Union[builtins.str, 'TlsVersion']] minimum_tls_version_allowed: Minimum TLS version that should be supported by webhook endpoint
        :param pulumi.Input[builtins.int] preferred_batch_size_in_kilobytes: Preferred batch size in Kilobytes.
        """
    ...
    def azure_active_directory_application_id_or_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in delivery requests.
        """
    ...
    def azure_active_directory_application_id_or_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_active_directory_application_id_or_uri", value)

    @property
    @pulumi.getter(name="azureActiveDirectoryTenantId")
    def azure_active_directory_tenant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery requests.
        """
    ...
    def azure_active_directory_tenant_id(self, value: Optional[pulumi.Input[builtins.str]]):
