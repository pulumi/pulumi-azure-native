...
class PartnerTopicArgs:
    def __init__(__self__, *,
                 ...
                 activation_state: Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicActivationState']]] = None,
                 ...
                 partner_topic_friendly_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'PartnerTopicActivationState']] activation_state: Activation state of the partner topic.
        :param pulumi.Input['EventTypeInfoArgs'] event_type_info: Event Type information from the corresponding event channel.
        :param pulumi.Input[builtins.str] expiration_time_if_not_activated_utc: Expiration time of the partner topic. If this timer expires while the partner topic is still never activated,
        ...
        :param pulumi.Input[builtins.str] partner_topic_friendly_description: Friendly description about the topic. This can be set by the publisher/partner to show custom description for the customer partner topic.
               This will be helpful to remove any ambiguity of the origin of creation of the partner topic for the customer.
        :param pulumi.Input[builtins.str] partner_topic_name: Name of the partner topic.
        :param pulumi.Input[builtins.str] source: Source associated with this partner topic. This represents a unique partner resource.
    ...
    def activation_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicActivationState']]]:
        """
    ...
    def activation_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicActivationState']]]):
    ...
    def partner_topic_friendly_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partner_topic_friendly_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partner_topic_friendly_description", value)

    @property
    @pulumi.getter(name="partnerTopicName")
    def partner_topic_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partner_topic_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PartnerTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:PartnerTopic")])
    ...
    @property
    @pulumi.getter(name="partnerTopicFriendlyDescription")
    def partner_topic_friendly_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Friendly description about the topic. This can be set by the publisher/partner to show custom description for the customer partner topic.
        This will be helpful to remove any ambiguity of the origin of creation of the partner topic for the customer.
        """
