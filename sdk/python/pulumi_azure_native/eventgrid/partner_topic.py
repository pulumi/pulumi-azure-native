...
class PartnerTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20211015preview:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20220615:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:PartnerTopic"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:PartnerTopic")])
