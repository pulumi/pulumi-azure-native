...
warnings.warn("""azure-native:eventgrid/v20211015preview:TopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:TopicEventSubscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_topic_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic_event_subscription is deprecated: azure-native:eventgrid/v20211015preview:TopicEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:TopicEventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['eventSubscriptionName'] = event_subscription_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20211015preview:getTopicEventSubscription', __args__, opts=opts, typ=GetTopicEventSubscriptionResult).value
