...
class PartnerRegistrationArgs:
    ...
    def _configure(
        ...
        if authorized_azure_subscription_ids is None and 'authorizedAzureSubscriptionIds' in kwargs:
            authorized_azure_subscription_ids = kwargs['authorizedAzureSubscriptionIds']
        if customer_service_uri is None and 'customerServiceUri' in kwargs:
            customer_service_uri = kwargs['customerServiceUri']
        ...
        if partner_customer_service_extension is None and 'partnerCustomerServiceExtension' in kwargs:
            partner_customer_service_extension = kwargs['partnerCustomerServiceExtension']
        if partner_customer_service_number is None and 'partnerCustomerServiceNumber' in kwargs:
            partner_customer_service_number = kwargs['partnerCustomerServiceNumber']
        ...
        if partner_resource_type_description is None and 'partnerResourceTypeDescription' in kwargs:
            partner_resource_type_description = kwargs['partnerResourceTypeDescription']
        if partner_resource_type_display_name is None and 'partnerResourceTypeDisplayName' in kwargs:
            partner_resource_type_display_name = kwargs['partnerResourceTypeDisplayName']
        if partner_resource_type_name is None and 'partnerResourceTypeName' in kwargs:
            partner_resource_type_name = kwargs['partnerResourceTypeName']
        if setup_uri is None and 'setupUri' in kwargs:
            setup_uri = kwargs['setupUri']
...
class PartnerRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerRegistration"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerRegistration")])
