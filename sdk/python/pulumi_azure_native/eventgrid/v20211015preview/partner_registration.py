...
class PartnerRegistrationArgs:
    ...
    def _configure(
        ...
        if 'authorizedAzureSubscriptionIds' in kwargs:
            authorized_azure_subscription_ids = kwargs['authorizedAzureSubscriptionIds']
        if 'customerServiceUri' in kwargs:
        ...
        if 'partnerCustomerServiceExtension' in kwargs:
            partner_customer_service_extension = kwargs['partnerCustomerServiceExtension']
        if 'partnerCustomerServiceNumber' in kwargs:
