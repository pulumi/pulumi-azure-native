...
class DomainTopicEventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        domain_topic_event_subscription = azure_native.eventgrid.v20211015preview.DomainTopicEventSubscription("domainTopicEventSubscription",
