...
class DomainEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 retry_policy: Optional[pulumi.Input[pulumi.InputType['RetryPolicyArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""DomainEventSubscription is deprecated: azure-native:eventgrid/v20211015preview:DomainEventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:DomainEventSubscription to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainEventSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DomainEventSubscription, __self__).__init__(
            'azure-native:eventgrid/v20211015preview:DomainEventSubscription',
            resource_name,
            __props__,
            opts)
