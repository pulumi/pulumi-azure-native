...
warnings.warn("""azure-native:eventgrid/v20211015preview:PartnerTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopic to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_partner_topic(partner_topic_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_topic is deprecated: azure-native:eventgrid/v20211015preview:PartnerTopic is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:PartnerTopic to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['partnerTopicName'] = partner_topic_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20211015preview:getPartnerTopic', __args__, opts=opts, typ=GetPartnerTopicResult).value
