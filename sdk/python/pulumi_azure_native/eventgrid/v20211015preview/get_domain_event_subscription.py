...
def get_domain_event_subscription(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20211015preview:getDomainEventSubscription', __args__, opts=opts, typ=GetDomainEventSubscriptionResult).value
...
def get_domain_event_subscription_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20211015preview:getDomainEventSubscription', __args__, opts=opts, typ=GetDomainEventSubscriptionResult)
