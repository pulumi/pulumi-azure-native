...
def get_partner_registration(partner_registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20211015preview:getPartnerRegistration', __args__, opts=opts, typ=GetPartnerRegistrationResult).value

    return AwaitableGetPartnerRegistrationResult(
        authorized_azure_subscription_ids=pulumi.get(__ret__, 'authorized_azure_subscription_ids'),
        customer_service_uri=pulumi.get(__ret__, 'customer_service_uri'),
        id=pulumi.get(__ret__, 'id'),
        location=pulumi.get(__ret__, 'location'),
        logo_uri=pulumi.get(__ret__, 'logo_uri'),
        long_description=pulumi.get(__ret__, 'long_description'),
        name=pulumi.get(__ret__, 'name'),
        partner_customer_service_extension=pulumi.get(__ret__, 'partner_customer_service_extension'),
        partner_customer_service_number=pulumi.get(__ret__, 'partner_customer_service_number'),
        ...
        partner_resource_type_description=pulumi.get(__ret__, 'partner_resource_type_description'),
        partner_resource_type_display_name=pulumi.get(__ret__, 'partner_resource_type_display_name'),
        partner_resource_type_name=pulumi.get(__ret__, 'partner_resource_type_name'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        setup_uri=pulumi.get(__ret__, 'setup_uri'),
