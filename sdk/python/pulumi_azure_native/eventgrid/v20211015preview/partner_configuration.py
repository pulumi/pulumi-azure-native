...
class PartnerConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        partner_configuration = azure_native.eventgrid.v20211015preview.PartnerConfiguration("partnerConfiguration",
            partner_authorization=azure_native.eventgrid.v20211015preview.PartnerAuthorizationResponseArgs(
                authorized_partners_list=[
                    azure_native.eventgrid.v20211015preview.PartnerArgs(
