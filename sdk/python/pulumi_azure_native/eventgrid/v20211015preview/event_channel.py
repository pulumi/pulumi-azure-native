...
class EventChannelArgs:
    ...
    def _configure(
        ...
        if event_channel_name is None and 'eventChannelName' in kwargs:
...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            destination = _utilities.configure(destination, EventChannelDestinationArgs, True)
            ...
            filter = _utilities.configure(filter, EventChannelFilterArgs, True)
            ...
            source = _utilities.configure(source, EventChannelSourceArgs, True)
