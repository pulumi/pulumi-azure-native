...
class EventChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(destination, EventChannelDestinationArgs):
            ...
            if not isinstance(filter, EventChannelFilterArgs):
                filter = filter or {}
                def _setter(key, value):
                    filter[key] = value
            ...
            if not isinstance(source, EventChannelSourceArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
