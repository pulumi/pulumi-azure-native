...
warnings.warn("""azure-native:eventgrid/v20211015preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20220615:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_endpoint_connection(parent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection is deprecated: azure-native:eventgrid/v20211015preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20220615:PrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
