...
class PartnerDestinationArgs:
    ...
    def _configure(
        ...
        if endpoint_base_url is None and 'endpointBaseUrl' in kwargs:
            endpoint_base_url = kwargs['endpointBaseUrl']
        if endpoint_service_context is None and 'endpointServiceContext' in kwargs:
        ...
        if partner_destination_name is None and 'partnerDestinationName' in kwargs:
...
class PartnerDestination(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:PartnerDestination"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerDestination")])
