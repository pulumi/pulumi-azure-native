...
def get_domain_topic(domain_name: Optional[_builtins.str] = None,
                     domain_topic_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_topic_name: Name of the topic.
