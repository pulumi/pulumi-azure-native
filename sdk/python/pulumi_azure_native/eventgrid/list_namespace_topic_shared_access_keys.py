...
def list_namespace_topic_shared_access_keys(namespace_name: Optional[_builtins.str] = None,
...
def list_namespace_topic_shared_access_keys_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
