...
def get_ca_certificate(ca_certificate_name: Optional[_builtins.str] = None,
...
def get_ca_certificate_output(ca_certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
