...
def get_domain_topic_event_subscription_full_url(domain_name: Optional[builtins.str] = None,
...
def get_domain_topic_event_subscription_full_url_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
