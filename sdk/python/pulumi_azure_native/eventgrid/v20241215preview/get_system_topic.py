...
def get_system_topic(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getSystemTopic', __args__, opts=opts, typ=GetSystemTopicResult).value
...
def get_system_topic_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getSystemTopic', __args__, opts=opts, typ=GetSystemTopicResult)
