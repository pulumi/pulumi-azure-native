...
def get_namespace(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
