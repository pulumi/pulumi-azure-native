...
def get_partner_topic(partner_topic_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getPartnerTopic', __args__, opts=opts, typ=GetPartnerTopicResult).value
...
def get_partner_topic_output(partner_topic_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getPartnerTopic', __args__, opts=opts, typ=GetPartnerTopicResult)
