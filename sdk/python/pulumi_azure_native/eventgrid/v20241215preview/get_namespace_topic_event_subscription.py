...
class GetNamespaceTopicEventSubscriptionResult:
    ...
    Event Subscription.
    """
    def __init__(__self__, delivery_configuration=None, event_delivery_schema=None, expiration_time_utc=None, filters_configuration=None, id=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_namespace_topic_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getNamespaceTopicEventSubscription', __args__, opts=opts, typ=GetNamespaceTopicEventSubscriptionResult).value
...
def get_namespace_topic_event_subscription_output(event_subscription_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getNamespaceTopicEventSubscription', __args__, opts=opts, typ=GetNamespaceTopicEventSubscriptionResult)
