...
def get_permission_binding(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getPermissionBinding', __args__, opts=opts, typ=GetPermissionBindingResult).value
...
def get_permission_binding_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getPermissionBinding', __args__, opts=opts, typ=GetPermissionBindingResult)
