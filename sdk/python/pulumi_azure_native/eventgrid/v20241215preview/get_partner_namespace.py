...
def get_partner_namespace(partner_namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getPartnerNamespace', __args__, opts=opts, typ=GetPartnerNamespaceResult).value
...
def get_partner_namespace_output(partner_namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getPartnerNamespace', __args__, opts=opts, typ=GetPartnerNamespaceResult)
