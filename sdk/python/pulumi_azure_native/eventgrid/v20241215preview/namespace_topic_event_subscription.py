...
class NamespaceTopicEventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Tags relating to Event Subscription resource.
        """
...
class NamespaceTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid:NamespaceTopicEventSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceTopicEventSubscription, __self__).__init__(
            'azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription',
            resource_name,
            __props__,
            opts)
