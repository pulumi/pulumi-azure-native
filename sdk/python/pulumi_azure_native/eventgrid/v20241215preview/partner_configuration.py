...
class PartnerConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerConfiguration"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerConfiguration"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerConfiguration"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerConfiguration"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerConfiguration"), pulumi.Alias(type_="azure-native:eventgrid:PartnerConfiguration")])
