...
def get_domain_event_subscription_full_url(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getDomainEventSubscriptionFullUrl', __args__, opts=opts, typ=GetDomainEventSubscriptionFullUrlResult).value
...
def get_domain_event_subscription_full_url_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getDomainEventSubscriptionFullUrl', __args__, opts=opts, typ=GetDomainEventSubscriptionFullUrlResult)
