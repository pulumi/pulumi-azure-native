...
def get_channel_full_url(channel_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getChannelFullUrl', __args__, opts=opts, typ=GetChannelFullUrlResult).value
...
def get_channel_full_url_output(channel_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getChannelFullUrl', __args__, opts=opts, typ=GetChannelFullUrlResult)
