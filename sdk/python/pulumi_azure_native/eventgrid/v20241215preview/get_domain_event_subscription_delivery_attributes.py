...
def get_domain_event_subscription_delivery_attributes(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getDomainEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetDomainEventSubscriptionDeliveryAttributesResult).value
...
def get_domain_event_subscription_delivery_attributes_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getDomainEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetDomainEventSubscriptionDeliveryAttributesResult)
