...
class TopicSpace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid:TopicSpace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TopicSpace, __self__).__init__(
            'azure-native:eventgrid/v20241215preview:TopicSpace',
            resource_name,
            __props__,
            opts)
