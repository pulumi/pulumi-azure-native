...
def get_client_group(client_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getClientGroup', __args__, opts=opts, typ=GetClientGroupResult).value
...
def get_client_group_output(client_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getClientGroup', __args__, opts=opts, typ=GetClientGroupResult)
