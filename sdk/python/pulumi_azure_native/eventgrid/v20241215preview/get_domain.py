...
def get_domain(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getDomain', __args__, opts=opts, typ=GetDomainResult)
