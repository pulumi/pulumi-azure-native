...
def get_partner_destination(partner_destination_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getPartnerDestination', __args__, opts=opts, typ=GetPartnerDestinationResult).value
...
def get_partner_destination_output(partner_destination_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getPartnerDestination', __args__, opts=opts, typ=GetPartnerDestinationResult)
