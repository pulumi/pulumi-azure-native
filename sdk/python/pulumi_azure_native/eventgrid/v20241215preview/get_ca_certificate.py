...
def get_ca_certificate(ca_certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getCaCertificate', __args__, opts=opts, typ=GetCaCertificateResult).value
...
def get_ca_certificate_output(ca_certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getCaCertificate', __args__, opts=opts, typ=GetCaCertificateResult)
