...
def get_channel(channel_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getChannel', __args__, opts=opts, typ=GetChannelResult).value
...
def get_channel_output(channel_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getChannel', __args__, opts=opts, typ=GetChannelResult)
