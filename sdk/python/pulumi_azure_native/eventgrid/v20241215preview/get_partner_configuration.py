...
def get_partner_configuration(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20241215preview:getPartnerConfiguration', __args__, opts=opts, typ=GetPartnerConfigurationResult).value
...
def get_partner_configuration_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20241215preview:getPartnerConfiguration', __args__, opts=opts, typ=GetPartnerConfigurationResult)
