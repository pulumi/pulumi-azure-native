...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic is deprecated: Version v20200101preview will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20200101preview:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult).value
