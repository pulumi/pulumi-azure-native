...
def get_namespace_topic_event_subscription(event_subscription_name: Optional[_builtins.str] = None,
...
def get_namespace_topic_event_subscription_output(event_subscription_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
