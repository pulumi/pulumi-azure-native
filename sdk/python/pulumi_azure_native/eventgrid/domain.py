...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 data_residency_boundary: Optional[pulumi.Input[Union[builtins.str, 'DataResidencyBoundary']]] = None,
                 ...
                 input_schema: Optional[pulumi.Input[Union[builtins.str, 'InputSchema']]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_create_topic_with_first_subscription: This Boolean is used to specify the creation mechanism for 'all' the Event Grid Domain Topics associated with this Event Grid Domain resource.
        ...
        :param pulumi.Input[builtins.bool] auto_delete_topic_with_last_subscription: This Boolean is used to specify the deletion mechanism for 'all' the Event Grid Domain Topics associated with this Event Grid Domain resource.
        ...
        :param pulumi.Input[Union[builtins.str, 'DataResidencyBoundary']] data_residency_boundary: Data Residency Boundary of the resource.
        :param pulumi.Input[builtins.bool] disable_local_auth: This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the domain.
        ...
        :param pulumi.Input[Union[builtins.str, 'InputSchema']] input_schema: This determines the format that Event Grid should expect for incoming events published to the Event Grid Domain Resource.
        ...
        :param pulumi.Input[Union[builtins.str, 'TlsVersion']] minimum_tls_version_allowed: Minimum TLS version of the publisher allowed to publish to this domain
    ...
    def data_residency_boundary(self) -> Optional[pulumi.Input[Union[builtins.str, 'DataResidencyBoundary']]]:
        """
    ...
    def data_residency_boundary(self, value: Optional[pulumi.Input[Union[builtins.str, 'DataResidencyBoundary']]]):
    ...
    def input_schema(self) -> Optional[pulumi.Input[Union[builtins.str, 'InputSchema']]]:
        """
    ...
    @input_schema.setter
    def input_schema(self, value: Optional[pulumi.Input[Union[builtins.str, 'InputSchema']]]):
...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20180915preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20190201preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20190601:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20200101preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20200601:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20211201:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:Domain"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:Domain")])
    ...
    @property
    @pulumi.getter(name="dataResidencyBoundary")
    def data_residency_boundary(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Data Residency Boundary of the resource.
        """
        return pulumi.get(self, "data_residency_boundary")
