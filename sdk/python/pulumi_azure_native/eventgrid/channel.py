...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20220615:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20211015preview:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20220615:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:Channel"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:Channel")])
