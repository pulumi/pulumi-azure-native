...
class ClientGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20250715preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20251115preview:ClientGroup")])
