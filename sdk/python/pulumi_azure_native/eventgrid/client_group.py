...
class ClientGroupArgs:
    def __init__(__self__, *,
                 ...
                 client_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] client_group_name: The client group name.
        :param pulumi.Input[builtins.str] description: Description for the Client Group resource.
        :param pulumi.Input[builtins.str] query: The grouping query for the clients.
    ...
    def client_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClientGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:ClientGroup")])
