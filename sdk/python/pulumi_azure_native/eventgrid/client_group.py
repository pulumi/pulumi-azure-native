...
class ClientGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:ClientGroup"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:ClientGroup"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:ClientGroup"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:ClientGroup"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:ClientGroup"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:ClientGroup"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:ClientGroup")])
