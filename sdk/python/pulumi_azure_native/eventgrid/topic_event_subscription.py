...
class TopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20220615:TopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:TopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:TopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:TopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20211015preview:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20220615:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:TopicEventSubscription"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:TopicEventSubscription")])
