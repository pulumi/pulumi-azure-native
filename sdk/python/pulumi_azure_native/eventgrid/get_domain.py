...
class GetDomainResult:
    ...
    def auto_create_topic_with_first_subscription(self) -> Optional[builtins.bool]:
        """
    ...
    def auto_delete_topic_with_last_subscription(self) -> Optional[builtins.bool]:
        """
...
def get_domain_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid:getDomain', __args__, opts=opts, typ=GetDomainResult)
