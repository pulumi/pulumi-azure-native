...
class PartnerTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(dead_letter_destination, StorageBlobDeadLetterDestinationArgs):
            ...
            if not isinstance(dead_letter_with_resource_identity, DeadLetterWithResourceIdentityArgs):
            ...
            if not isinstance(delivery_with_resource_identity, DeliveryWithResourceIdentityArgs):
            ...
            if not isinstance(filter, EventSubscriptionFilterArgs):
                filter = filter or {}
                def _setter(key, value):
                    filter[key] = value
            ...
            if not isinstance(retry_policy, RetryPolicyArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerTopicEventSubscription")])
