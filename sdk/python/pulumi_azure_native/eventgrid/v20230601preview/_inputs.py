...
class AzureADPartnerClientAuthenticationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if client_authentication_type is None and 'clientAuthenticationType' in kwargs:
            client_authentication_type = kwargs['clientAuthenticationType']
...
class ClientAuthenticationSettingsArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if alternative_authentication_name_sources is None and 'alternativeAuthenticationNameSources' in kwargs:
...
class ClientAuthenticationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if certificate_subject is None and 'certificateSubject' in kwargs:
...
class ClientCertificateAuthenticationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if allowed_thumbprints is None and 'allowedThumbprints' in kwargs:
            allowed_thumbprints = kwargs['allowedThumbprints']
        if validation_scheme is None and 'validationScheme' in kwargs:
...
class DeliveryConfigurationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if delivery_mode is None and 'deliveryMode' in kwargs:
...
class QueueInfoArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if dead_letter_destination_with_resource_identity is None and 'deadLetterDestinationWithResourceIdentity' in kwargs:
        ...
        if receive_lock_duration_in_seconds is None and 'receiveLockDurationInSeconds' in kwargs:
...
class ResourceMoveChangeHistoryArgs:
    ...
    def _configure(
        ...
        if azure_subscription_id is None and 'azureSubscriptionId' in kwargs:
            azure_subscription_id = kwargs['azureSubscriptionId']
        if changed_time_utc is None and 'changedTimeUtc' in kwargs:
            changed_time_utc = kwargs['changedTimeUtc']
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
...
class TopicSpacesConfigurationArgs:
    ...
    def _configure(
        ...
        if maximum_client_sessions_per_authentication_name is None and 'maximumClientSessionsPerAuthenticationName' in kwargs:
            maximum_client_sessions_per_authentication_name = kwargs['maximumClientSessionsPerAuthenticationName']
        if maximum_session_expiry_in_hours is None and 'maximumSessionExpiryInHours' in kwargs:
            maximum_session_expiry_in_hours = kwargs['maximumSessionExpiryInHours']
        if route_topic_resource_id is None and 'routeTopicResourceId' in kwargs:
            route_topic_resource_id = kwargs['routeTopicResourceId']
        if routing_enrichments is None and 'routingEnrichments' in kwargs:
            routing_enrichments = kwargs['routingEnrichments']
        if routing_identity_info is None and 'routingIdentityInfo' in kwargs:
...
class WebhookPartnerDestinationInfoArgs:
    ...
    def _configure(
        ...
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_move_change_history is None and 'resourceMoveChangeHistory' in kwargs:
            resource_move_change_history = kwargs['resourceMoveChangeHistory']
