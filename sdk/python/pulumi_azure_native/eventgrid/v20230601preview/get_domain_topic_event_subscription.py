...
def get_domain_topic_event_subscription(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20230601preview:getDomainTopicEventSubscription', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionResult).value
...
def get_domain_topic_event_subscription_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20230601preview:getDomainTopicEventSubscription', __args__, opts=opts, typ=GetDomainTopicEventSubscriptionResult)
