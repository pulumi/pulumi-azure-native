...
class DomainEventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        """
        DomainEventSubscriptionArgs._configure(
...
class DomainEventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DomainEventSubscriptionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainEventSubscription")])
