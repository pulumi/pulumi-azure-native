...
class DomainEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:DomainEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid:DomainEventSubscription")])
