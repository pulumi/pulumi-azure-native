...
class ChannelArgs:
    ...
    def _configure(
        ...
        if partner_destination_info is None and 'partnerDestinationInfo' in kwargs:
...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            partner_destination_info = _utilities.configure(partner_destination_info, WebhookPartnerDestinationInfoArgs, True)
