...
class ChannelArgs:
    ...
    def _configure(
        ...
        if 'partnerDestinationInfo' in kwargs:
            partner_destination_info = kwargs['partnerDestinationInfo']
        ...
        if partner_destination_info is not None:
            _setter("partner_destination_info", partner_destination_info)
...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if partner_destination_info is not None and not isinstance(partner_destination_info, WebhookPartnerDestinationInfoArgs):
                partner_destination_info = partner_destination_info or {}
                def _setter(key, value):
                    partner_destination_info[key] = value
                WebhookPartnerDestinationInfoArgs._configure(_setter, **partner_destination_info)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:Channel"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:Channel")])
