...
class PermissionBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PermissionBinding"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PermissionBinding"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PermissionBinding"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:PermissionBinding"), pulumi.Alias(type_="azure-native:eventgrid:PermissionBinding")])
