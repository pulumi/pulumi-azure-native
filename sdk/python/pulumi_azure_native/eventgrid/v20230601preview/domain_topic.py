...
class DomainTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20190201preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20190601:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20200101preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20200601:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20211201:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:DomainTopic"), pulumi.Alias(type_="azure-native:eventgrid:DomainTopic")])
