...
class NamespaceTopicArgs:
    ...
    def _configure(
        ...
        if event_retention_in_days is None and 'eventRetentionInDays' in kwargs:
            event_retention_in_days = kwargs['eventRetentionInDays']
        if input_schema is None and 'inputSchema' in kwargs:
            input_schema = kwargs['inputSchema']
        if publisher_type is None and 'publisherType' in kwargs:
            publisher_type = kwargs['publisherType']
