...
def get_partner_topic(partner_topic_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20230601preview:getPartnerTopic', __args__, opts=opts, typ=GetPartnerTopicResult).value
...
def get_partner_topic_output(partner_topic_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20230601preview:getPartnerTopic', __args__, opts=opts, typ=GetPartnerTopicResult)
