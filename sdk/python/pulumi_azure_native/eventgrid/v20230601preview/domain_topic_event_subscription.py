...
class DomainTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:DomainTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:DomainTopicEventSubscription")])
