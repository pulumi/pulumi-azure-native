...
def get_permission_binding(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20230601preview:getPermissionBinding', __args__, opts=opts, typ=GetPermissionBindingResult).value
...
def get_permission_binding_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20230601preview:getPermissionBinding', __args__, opts=opts, typ=GetPermissionBindingResult)
