...
class TopicSpace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:TopicSpace"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:TopicSpace")])
