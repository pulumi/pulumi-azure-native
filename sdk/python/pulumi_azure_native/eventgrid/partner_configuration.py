...
class PartnerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'PartnerConfigurationProvisioningState']] provisioning_state: Provisioning state of the partner configuration.
