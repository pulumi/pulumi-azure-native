...
def list_namespace_shared_access_keys(namespace_name: Optional[str] = None,
...
def list_namespace_shared_access_keys_output(namespace_name: Optional[pulumi.Input[str]] = None,
