...
__all__ = [
    ...
    'AwaitableListNamespaceSharedAccessKeysResult',
    'list_namespace_shared_access_keys',
    'list_namespace_shared_access_keys_output',
]
...
def list_namespace_shared_access_keys(namespace_name: Optional[_builtins.str] = None,
                                      resource_group_name: Optional[_builtins.str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListNamespaceSharedAccessKeysResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid:listNamespaceSharedAccessKeys', __args__, opts=opts, typ=ListNamespaceSharedAccessKeysResult).value

    return AwaitableListNamespaceSharedAccessKeysResult(
        key1=pulumi.get(__ret__, 'key1'),
        key2=pulumi.get(__ret__, 'key2'))
def list_namespace_shared_access_keys_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
                                             resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListNamespaceSharedAccessKeysResult]:
    """
    List the two keys used to publish to a namespace.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid:listNamespaceSharedAccessKeys', __args__, opts=opts, typ=ListNamespaceSharedAccessKeysResult)
    return __ret__.apply(lambda __response__: ListNamespaceSharedAccessKeysResult(
