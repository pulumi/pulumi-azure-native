...
def get_private_endpoint_connection(parent_name: Optional[builtins.str] = None,
    ...
    :param builtins.str parent_name: The name of the parent resource (namely, either, the topic name, domain name, or partner namespace name or namespace name).
    :param builtins.str parent_type: The type of the parent resource. This can be either \\'topics\\', \\'domains\\', or \\'partnerNamespaces\\' or \\'namespaces\\'.
    :param builtins.str private_endpoint_connection_name: The name of the private endpoint connection connection.
...
def get_private_endpoint_connection_output(parent_name: Optional[pulumi.Input[builtins.str]] = None,
                                           parent_type: Optional[pulumi.Input[builtins.str]] = None,
