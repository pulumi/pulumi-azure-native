...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_zone_redundant: This is an optional property and it allows the user to specify if the namespace resource supports zone-redundancy capability or not. If this
