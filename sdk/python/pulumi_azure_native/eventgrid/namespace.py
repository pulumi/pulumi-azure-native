...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if topic_spaces_configuration is None and 'topicSpacesConfiguration' in kwargs:
...
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            sku = _utilities.configure(sku, NamespaceSkuArgs, True)
            __props__.__dict__["sku"] = sku
            __props__.__dict__["tags"] = tags
            topic_spaces_configuration = _utilities.configure(topic_spaces_configuration, TopicSpacesConfigurationArgs, True)
