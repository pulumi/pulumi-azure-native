...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if 'topicSpacesConfiguration' in kwargs:
            topic_spaces_configuration = kwargs['topicSpacesConfiguration']
        ...
        if topic_spaces_configuration is not None:
            _setter("topic_spaces_configuration", topic_spaces_configuration)
...
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if sku is not None and not isinstance(sku, NamespaceSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                NamespaceSkuArgs._configure(_setter, **sku)
            __props__.__dict__["sku"] = sku
            __props__.__dict__["tags"] = tags
            if topic_spaces_configuration is not None and not isinstance(topic_spaces_configuration, TopicSpacesConfigurationArgs):
                topic_spaces_configuration = topic_spaces_configuration or {}
                def _setter(key, value):
                    topic_spaces_configuration[key] = value
                TopicSpacesConfigurationArgs._configure(_setter, **topic_spaces_configuration)
