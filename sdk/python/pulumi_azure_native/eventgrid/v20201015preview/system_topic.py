...
class SystemTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20211201:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:SystemTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:SystemTopic")])
