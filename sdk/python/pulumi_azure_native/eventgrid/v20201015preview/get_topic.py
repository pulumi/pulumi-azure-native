...
def get_topic(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic is deprecated: azure-native:eventgrid/v20201015preview:Topic is being removed in the next major version of this provider. Please upgrade to azure-native:eventgrid/v20211015preview:Topic to guarantee forwards compatibility.""")
    __args__ = dict()
