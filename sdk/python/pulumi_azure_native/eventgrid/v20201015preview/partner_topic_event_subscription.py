...
class PartnerTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerTopicEventSubscription")])
