...
warnings.warn("""azure-native:eventgrid/v20201015preview:PartnerRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20211015preview:PartnerRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_partner_registration(partner_registration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_partner_registration is deprecated: azure-native:eventgrid/v20201015preview:PartnerRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20211015preview:PartnerRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['partnerRegistrationName'] = partner_registration_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20201015preview:getPartnerRegistration', __args__, opts=opts, typ=GetPartnerRegistrationResult).value
