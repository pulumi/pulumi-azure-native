...
class EventChannel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:EventChannel"), pulumi.Alias(type_="azure-nextgen:eventgrid:EventChannel"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:EventChannel"), pulumi.Alias(type_="azure-nextgen:eventgrid/v20200401preview:EventChannel")])
    ...
    def get(resource_name: str,
        ...
        __props__["expiration_time_if_not_activated_utc"] = None
        __props__["filter"] = None
        __props__["name"] = None
        __props__["partner_topic_friendly_description"] = None
        __props__["partner_topic_readiness_state"] = None
        __props__["provisioning_state"] = None
