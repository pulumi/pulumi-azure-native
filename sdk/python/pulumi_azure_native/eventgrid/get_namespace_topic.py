...
def get_namespace_topic(namespace_name: Optional[_builtins.str] = None,
...
def get_namespace_topic_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
