...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20200601:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult).value
...
def get_domain_topic_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20200601:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult)
