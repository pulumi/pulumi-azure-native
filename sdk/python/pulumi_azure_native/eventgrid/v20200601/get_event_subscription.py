...
def get_event_subscription(event_subscription_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_subscription is deprecated: azure-native:eventgrid/v20200601:EventSubscription is being removed in the next major version of this provider. Upgrade to at least azure-native:eventgrid/v20230601preview:EventSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['eventSubscriptionName'] = event_subscription_name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20200601:getEventSubscription', __args__, opts=opts, typ=GetEventSubscriptionResult).value
