...
class EventSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_subscription = azure_native.eventgrid.v20200601.EventSubscription("eventSubscription",
            dead_letter_destination=azure_native.eventgrid.v20200601.StorageBlobDeadLetterDestinationResponseArgs(
            ...
            destination=azure_native.eventgrid.v20200601.EventHubEventSubscriptionDestinationArgs(
            ...
            filter=azure_native.eventgrid.v20200601.EventSubscriptionFilterArgs(
        ...
        event_subscription = azure_native.eventgrid.v20200601.EventSubscription("eventSubscription",
            ...
            destination=azure_native.eventgrid.v20200601.HybridConnectionEventSubscriptionDestinationArgs(
        ...
        event_subscription = azure_native.eventgrid.v20200601.EventSubscription("eventSubscription",
            ...
            destination=azure_native.eventgrid.v20200601.StorageQueueEventSubscriptionDestinationArgs(
        ...
        event_subscription = azure_native.eventgrid.v20200601.EventSubscription("eventSubscription",
            destination=azure_native.eventgrid.v20200601.WebHookEventSubscriptionDestinationArgs(
        ...
        ```sh
        $ pulumi import azure-native:eventgrid/v20200601:EventSubscription examplesubscription3 /subscriptions/5b4b650e-28b9-4790-b3ab-ddbd88d727c4/providers/Microsoft.EventGrid/eventSubscriptions/examplesubscription3 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20170615preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20170915preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20180101:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20180501preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20180915preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20190101:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20190201preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20190601:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20200101preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20211201:EventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:EventSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventSubscription, __self__).__init__(
            'azure-native:eventgrid/v20200601:EventSubscription',
            resource_name,
            __props__,
            opts)
