...
class Namespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 topics_configuration: Optional[pulumi.Input[pulumi.InputType['TopicsConfigurationArgs']]] = None,
                 __props__=None):
        """
        Namespace resource.
        ...
        :param pulumi.Input[pulumi.InputType['TopicsConfigurationArgs']] topics_configuration: Topics configuration information for the namespace resource
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:Namespace"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Namespace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:Namespace")])
