...
def list_namespace_topic_shared_access_keys(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20240601preview:listNamespaceTopicSharedAccessKeys', __args__, opts=opts, typ=ListNamespaceTopicSharedAccessKeysResult).value
...
def list_namespace_topic_shared_access_keys_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20240601preview:listNamespaceTopicSharedAccessKeys', __args__, opts=opts, typ=ListNamespaceTopicSharedAccessKeysResult)
