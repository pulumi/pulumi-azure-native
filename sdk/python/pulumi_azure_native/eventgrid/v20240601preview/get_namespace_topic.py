...
def get_namespace_topic(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20240601preview:getNamespaceTopic', __args__, opts=opts, typ=GetNamespaceTopicResult).value
...
def get_namespace_topic_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20240601preview:getNamespaceTopic', __args__, opts=opts, typ=GetNamespaceTopicResult)
