...
class Client(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:Client"), pulumi.Alias(type_="azure-native:eventgrid:Client")])
