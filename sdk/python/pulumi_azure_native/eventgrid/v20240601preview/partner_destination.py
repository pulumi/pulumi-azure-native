...
class PartnerDestination(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerDestination"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerDestination"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerDestination"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerDestination"), pulumi.Alias(type_="azure-native:eventgrid:PartnerDestination")])
