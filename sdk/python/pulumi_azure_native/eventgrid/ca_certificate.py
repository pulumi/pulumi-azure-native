...
class CaCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:CaCertificate"), pulumi.Alias(type_="azure-native:eventgrid/v20250715preview:CaCertificate")])
