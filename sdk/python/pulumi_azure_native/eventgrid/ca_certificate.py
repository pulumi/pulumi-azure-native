...
class CaCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ca_certificate_name: The CA certificate name.
        :param pulumi.Input[builtins.str] description: Description for the CA Certificate resource.
        :param pulumi.Input[builtins.str] encoded_certificate: Base64 encoded PEM (Privacy Enhanced Mail) format certificate data.
        """
...
class CaCertificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="encodedCertificate")
    def encoded_certificate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Base64 encoded PEM (Privacy Enhanced Mail) format certificate data.
        """
        return pulumi.get(self, "encoded_certificate")
    ...
    def expiry_time_in_utc(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def issue_time_in_utc(self) -> pulumi.Output[builtins.str]:
        """
