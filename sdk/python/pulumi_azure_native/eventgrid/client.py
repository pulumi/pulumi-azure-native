...
class ClientArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'ClientState']]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] authentication_name: The name presented by the client for authentication. The default value is the name of the resource.
        ...
        :param pulumi.Input[builtins.str] client_name: The client name.
        :param pulumi.Input[builtins.str] description: Description for the Client resource.
        :param pulumi.Input[Union[builtins.str, 'ClientState']] state: Indicates if the client is enabled or not. Default value is Enabled.
        """
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'ClientState']]]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'ClientState']]]):
...
class Client(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:Client"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:Client")])
    ...
    @property
    @pulumi.getter(name="authenticationName")
    def authentication_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name presented by the client for authentication. The default value is the name of the resource.
        """
        return pulumi.get(self, "authentication_name")
