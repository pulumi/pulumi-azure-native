...
def get_topic(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic is deprecated: Version v20180915preview will be removed in the next major version of the provider. Upgrade to version v20200401preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20180915preview:getTopic', __args__, opts=opts, typ=GetTopicResult).value
