...
class NamespaceTopicEventSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription")])
