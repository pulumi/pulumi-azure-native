...
def get_system_topic(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20231215preview:getSystemTopic', __args__, opts=opts, typ=GetSystemTopicResult).value
...
def get_system_topic_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['systemTopicName'] = system_topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20231215preview:getSystemTopic', __args__, opts=opts, typ=GetSystemTopicResult)
