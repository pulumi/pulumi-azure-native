...
def get_topic_space(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20231215preview:getTopicSpace', __args__, opts=opts, typ=GetTopicSpaceResult).value
...
def get_topic_space_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicSpaceName'] = topic_space_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20231215preview:getTopicSpace', __args__, opts=opts, typ=GetTopicSpaceResult)
