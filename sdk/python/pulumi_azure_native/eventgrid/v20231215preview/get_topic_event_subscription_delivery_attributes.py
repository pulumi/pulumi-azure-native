...
def get_topic_event_subscription_delivery_attributes(event_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/v20231215preview:getTopicEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetTopicEventSubscriptionDeliveryAttributesResult).value
...
def get_topic_event_subscription_delivery_attributes_output(event_subscription_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicName'] = topic_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventgrid/v20231215preview:getTopicEventSubscriptionDeliveryAttributes', __args__, opts=opts, typ=GetTopicEventSubscriptionDeliveryAttributesResult)
