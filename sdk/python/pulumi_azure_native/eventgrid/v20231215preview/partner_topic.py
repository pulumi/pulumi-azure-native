...
class PartnerTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:PartnerTopic"), pulumi.Alias(type_="azure-native:eventgrid:PartnerTopic")])
