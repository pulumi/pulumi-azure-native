...
class NamespaceTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:NamespaceTopic")])
