...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:eventgrid/v20190201preview:Domain":
                return Domain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20190201preview:DomainTopic":
                return DomainTopic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20190201preview:EventSubscription":
                return EventSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20190201preview:Topic":
    ...
    pulumi.runtime.register_resource_module("azure-native", "eventgrid/v20190201preview", _module_instance)
