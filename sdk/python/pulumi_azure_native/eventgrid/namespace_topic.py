...
class NamespaceTopicArgs:
    def __init__(__self__, *,
                 ...
                 event_retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 input_schema: Optional[pulumi.Input[Union[builtins.str, 'EventInputSchema']]] = None,
                 publisher_type: Optional[pulumi.Input[Union[builtins.str, 'PublisherType']]] = None,
        ...
        :param pulumi.Input[builtins.int] event_retention_in_days: Event retention for the namespace topic expressed in days. The property default value is 1 day.
               Min event retention duration value is 1 day and max event retention duration value is 1 day.
        :param pulumi.Input[Union[builtins.str, 'EventInputSchema']] input_schema: This determines the format that is expected for incoming events published to the topic.
        :param pulumi.Input[Union[builtins.str, 'PublisherType']] publisher_type: Publisher type of the namespace topic.
        :param pulumi.Input[builtins.str] topic_name: Name of the namespace topic.
        """
    ...
    def event_retention_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def event_retention_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "event_retention_in_days", value)

    @property
    @pulumi.getter(name="inputSchema")
    def input_schema(self) -> Optional[pulumi.Input[Union[builtins.str, 'EventInputSchema']]]:
        """
    ...
    @input_schema.setter
    def input_schema(self, value: Optional[pulumi.Input[Union[builtins.str, 'EventInputSchema']]]):
        pulumi.set(self, "input_schema", value)

    @property
    @pulumi.getter(name="publisherType")
    def publisher_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'PublisherType']]]:
        """
    ...
    def publisher_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'PublisherType']]]):
...
class NamespaceTopic(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:NamespaceTopic"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:NamespaceTopic")])
    ...
    @property
    @pulumi.getter(name="eventRetentionInDays")
    def event_retention_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Event retention for the namespace topic expressed in days. The property default value is 1 day.
        Min event retention duration value is 1 day and max event retention duration value is 1 day.
        """
    ...
    @property
    @pulumi.getter(name="publisherType")
    def publisher_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Publisher type of the namespace topic.
        """
        return pulumi.get(self, "publisher_type")
