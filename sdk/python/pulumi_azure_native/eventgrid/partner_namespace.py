...
class PartnerNamespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20200401preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20201015preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20210601preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20211015preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20220615:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20230601preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20231215preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20240601preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20241215preview:eventgrid:PartnerNamespace"), pulumi.Alias(type_="azure-native_eventgrid_v20250215:eventgrid:PartnerNamespace")])
