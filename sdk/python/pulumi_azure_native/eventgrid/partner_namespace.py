...
class PartnerNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 partner_registration_fully_qualified_id: Optional[pulumi.Input[builtins.str]] = None,
                 partner_topic_routing_mode: Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicRoutingMode']]] = None,
        ...
        :param pulumi.Input[builtins.bool] disable_local_auth: This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the partner namespace.
        ...
        :param pulumi.Input[Union[builtins.str, 'TlsVersion']] minimum_tls_version_allowed: Minimum TLS version of the publisher allowed to publish to this partner namespace
        :param pulumi.Input[builtins.str] partner_namespace_name: Name of the partner namespace.
        :param pulumi.Input[builtins.str] partner_registration_fully_qualified_id: The fully qualified ARM Id of the partner registration that should be associated with this partner namespace. This takes the following format:
               /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerRegistrations/{partnerRegistrationName}.
        :param pulumi.Input[Union[builtins.str, 'PartnerTopicRoutingMode']] partner_topic_routing_mode: This determines if events published to this partner namespace should use the source attribute in the event payload
    ...
    def partner_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partner_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partner_namespace_name", value)

    @property
    @pulumi.getter(name="partnerRegistrationFullyQualifiedId")
    def partner_registration_fully_qualified_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partner_registration_fully_qualified_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partner_registration_fully_qualified_id", value)

    @property
    @pulumi.getter(name="partnerTopicRoutingMode")
    def partner_topic_routing_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicRoutingMode']]]:
        """
    ...
    def partner_topic_routing_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'PartnerTopicRoutingMode']]]):
...
class PartnerNamespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventgrid/v20200401preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20201015preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20210601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20211015preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20220615:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20230601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20231215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20240601preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20241215preview:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20250215:PartnerNamespace"), pulumi.Alias(type_="azure-native:eventgrid/v20250401preview:PartnerNamespace")])
    ...
    @property
    @pulumi.getter(name="partnerRegistrationFullyQualifiedId")
    def partner_registration_fully_qualified_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The fully qualified ARM Id of the partner registration that should be associated with this partner namespace. This takes the following format:
        /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/partnerRegistrations/{partnerRegistrationName}.
        """
    ...
    @property
    @pulumi.getter(name="partnerTopicRoutingMode")
    def partner_topic_routing_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This determines if events published to this partner namespace should use the source attribute in the event payload
        or use the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will be used to match the partner topic.
        """
