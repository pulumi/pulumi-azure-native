...
def get_domain_event_subscription_full_url(domain_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_name: Name of the domain topic.
...
def get_domain_event_subscription_full_url_output(domain_name: Optional[pulumi.Input[_builtins.str]] = None,
