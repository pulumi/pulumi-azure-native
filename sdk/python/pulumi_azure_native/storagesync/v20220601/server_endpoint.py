...
class ServerEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_endpoint = azure_native.storagesync.v20220601.ServerEndpoint("serverEndpoint",
            cloud_tiering="off",
            initial_download_policy="NamespaceThenModifiedFiles",
