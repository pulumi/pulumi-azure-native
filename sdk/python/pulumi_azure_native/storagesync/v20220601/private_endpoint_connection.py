...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagesync:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200901:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20220901:PrivateEndpointConnection")])
