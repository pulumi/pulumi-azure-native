...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20220601:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
...
def get_cloud_endpoint_output(cloud_endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['syncGroupName'] = sync_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagesync/v20220601:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult)
