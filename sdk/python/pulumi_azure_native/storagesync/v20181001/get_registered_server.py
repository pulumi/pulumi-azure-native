...
azure-native:storagesync/v20181001:RegisteredServer is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:RegisteredServer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registered_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_server is deprecated: Version 2018-10-01 will be removed in v2 of the provider.
azure-native:storagesync/v20181001:RegisteredServer is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:RegisteredServer to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20181001:getRegisteredServer', __args__, opts=opts, typ=GetRegisteredServerResult).value
