...
def get_registered_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_server is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
