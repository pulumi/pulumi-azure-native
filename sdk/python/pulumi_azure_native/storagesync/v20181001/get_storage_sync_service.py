...
def get_storage_sync_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_sync_service is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
