...
class ServerEndpointArgs:
    def __init__(__self__, *,
                 ...
                 sync_group_name: pulumi.Input[builtins.str],
                 cloud_tiering: Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 initial_download_policy: Optional[pulumi.Input[Union[builtins.str, 'InitialDownloadPolicy']]] = None,
                 initial_upload_policy: Optional[pulumi.Input[Union[builtins.str, 'InitialUploadPolicy']]] = None,
                 local_cache_mode: Optional[pulumi.Input[Union[builtins.str, 'LocalCacheMode']]] = None,
                 offline_data_transfer: Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]] = None,
                 offline_data_transfer_share_name: Optional[pulumi.Input[builtins.str]] = None,
                 server_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 server_local_path: Optional[pulumi.Input[builtins.str]] = None,
                 server_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'FeatureStatus']] cloud_tiering: Cloud Tiering.
        :param pulumi.Input[builtins.str] friendly_name: Friendly Name
        :param pulumi.Input[Union[builtins.str, 'InitialDownloadPolicy']] initial_download_policy: Policy for how namespace and files are recalled during FastDr.
        :param pulumi.Input[Union[builtins.str, 'InitialUploadPolicy']] initial_upload_policy: Policy for how the initial upload sync session is performed.
        :param pulumi.Input[Union[builtins.str, 'LocalCacheMode']] local_cache_mode: Policy for enabling follow-the-sun business models: link local cache to cloud behavior to pre-populate before local access.
        :param pulumi.Input[Union[builtins.str, 'FeatureStatus']] offline_data_transfer: Offline data transfer
        :param pulumi.Input[builtins.str] offline_data_transfer_share_name: Offline data transfer share name
        :param pulumi.Input[builtins.str] server_endpoint_name: Name of Server Endpoint object.
        :param pulumi.Input[builtins.str] server_local_path: Server Local path.
        :param pulumi.Input[builtins.str] server_resource_id: Server Resource Id.
        :param pulumi.Input[builtins.int] tier_files_older_than_days: Tier files older than days.
        :param pulumi.Input[builtins.int] volume_free_space_percent: Level of free space to be maintained by Cloud Tiering if it is enabled.
        """
    ...
    def sync_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sync_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sync_group_name", value)

    @property
    @pulumi.getter(name="cloudTiering")
    def cloud_tiering(self) -> Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]]:
        """
        Cloud Tiering.
        """
    ...
    def cloud_tiering(self, value: Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]]):
    ...
    def initial_download_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'InitialDownloadPolicy']]]:
        """
    ...
    def initial_download_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'InitialDownloadPolicy']]]):
        pulumi.set(self, "initial_download_policy", value)

    @property
    @pulumi.getter(name="initialUploadPolicy")
    def initial_upload_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'InitialUploadPolicy']]]:
        """
    ...
    def initial_upload_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'InitialUploadPolicy']]]):
        pulumi.set(self, "initial_upload_policy", value)

    @property
    @pulumi.getter(name="localCacheMode")
    def local_cache_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'LocalCacheMode']]]:
        """
    ...
    def local_cache_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'LocalCacheMode']]]):
        pulumi.set(self, "local_cache_mode", value)

    @property
    @pulumi.getter(name="offlineDataTransfer")
    def offline_data_transfer(self) -> Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]]:
        """
    ...
    def offline_data_transfer(self, value: Optional[pulumi.Input[Union[builtins.str, 'FeatureStatus']]]):
        pulumi.set(self, "offline_data_transfer", value)

    @property
    @pulumi.getter(name="offlineDataTransferShareName")
    def offline_data_transfer_share_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def offline_data_transfer_share_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "offline_data_transfer_share_name", value)

    @property
    @pulumi.getter(name="serverEndpointName")
    def server_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def server_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Server Resource Id.
        """
    ...
    def server_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServerEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cloudTiering")
    def cloud_tiering(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud Tiering.
        """
        return pulumi.get(self, "cloud_tiering")
    ...
    @property
    @pulumi.getter(name="initialUploadPolicy")
    def initial_upload_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Policy for how the initial upload sync session is performed.
        """
        return pulumi.get(self, "initial_upload_policy")
    ...
    @property
    @pulumi.getter(name="offlineDataTransfer")
    def offline_data_transfer(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Offline data transfer
        """
        return pulumi.get(self, "offline_data_transfer")
    ...
    @property
    @pulumi.getter(name="offlineDataTransferShareName")
    def offline_data_transfer_share_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Offline data transfer share name
        """
        return pulumi.get(self, "offline_data_transfer_share_name")
    ...
    def offline_data_transfer_storage_account_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def offline_data_transfer_storage_account_tenant_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="serverLocalPath")
    def server_local_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Server Local path.
        """
        return pulumi.get(self, "server_local_path")
    ...
    @property
    @pulumi.getter(name="serverResourceId")
    def server_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Server Resource Id.
        """
        return pulumi.get(self, "server_resource_id")
