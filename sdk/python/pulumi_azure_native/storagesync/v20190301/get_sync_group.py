...
def get_sync_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: Version v20190301 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20190301:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
