...
class ServerEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_endpoint = azure_native.storagesync.v20191001.ServerEndpoint("serverEndpoint",
            cloud_tiering="off",
