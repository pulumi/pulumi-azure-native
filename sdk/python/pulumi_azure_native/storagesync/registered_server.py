...
class RegisteredServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_id: Registered Server clusterId
        :param pulumi.Input[_builtins.str] cluster_name: Registered Server clusterName
...
class RegisteredServer(pulumi.CustomResource):
    ...
    def server_management_error_code(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
