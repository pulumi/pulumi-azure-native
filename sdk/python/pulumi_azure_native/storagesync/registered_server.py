...
class RegisteredServerArgs:
    def __init__(__self__, *,
                 ...
                 identity: Optional[pulumi.Input[builtins.bool]] = None,
                 last_heart_beat: Optional[pulumi.Input[builtins.str]] = None,
                 server_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 server_id: Optional[pulumi.Input[builtins.str]] = None,
                 server_os_version: Optional[pulumi.Input[builtins.str]] = None,
                 server_role: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] agent_version: Registered Server Agent Version
        :param pulumi.Input[builtins.str] application_id: Server ServicePrincipal Id
        :param pulumi.Input[builtins.str] cluster_id: Registered Server clusterId
        :param pulumi.Input[builtins.str] cluster_name: Registered Server clusterName
        :param pulumi.Input[builtins.str] friendly_name: Friendly Name
        :param pulumi.Input[builtins.bool] identity: Apply server with newly discovered ApplicationId if available.
        :param pulumi.Input[builtins.str] last_heart_beat: Registered Server last heart beat
        :param pulumi.Input[builtins.str] server_certificate: Registered Server Certificate
        :param pulumi.Input[builtins.str] server_id: Registered Server serverId
        :param pulumi.Input[builtins.str] server_os_version: Registered Server OS Version
        :param pulumi.Input[builtins.str] server_role: Registered Server serverRole
        """
    ...
    @property
    @pulumi.getter
    def identity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "identity", value)

    @property
    @pulumi.getter(name="lastHeartBeat")
    def last_heart_beat(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_heart_beat(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def server_os_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_os_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "server_os_version", value)

    @property
    @pulumi.getter(name="serverRole")
    def server_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @server_role.setter
    def server_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegisteredServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagesync/v20170605preview:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20180402:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20180701:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20181001:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20190201:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20190301:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20190601:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20191001:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20200301:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20200901:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20220601:RegisteredServer"), pulumi.Alias(type_="azure-native:storagesync/v20220901:RegisteredServer")])
    ...
    def active_auth_type(self) -> pulumi.Output[builtins.str]:
        """
        Server auth type.
        """
    ...
    def agent_version_expiration_date(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def agent_version_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def discovery_endpoint_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def identity(self) -> pulumi.Output[builtins.bool]:
        """
        Apply server with newly discovered ApplicationId if available.
        """
        return pulumi.get(self, "identity")
    ...
    @property
    @pulumi.getter(name="lastHeartBeat")
    def last_heart_beat(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Registered Server last heart beat
        """
        return pulumi.get(self, "last_heart_beat")
    ...
    def last_operation_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def last_workflow_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def latest_application_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def management_endpoint_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def monitoring_configuration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def monitoring_endpoint_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def resource_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource Location
        """
    ...
    def server_management_error_code(self) -> pulumi.Output[Optional[builtins.int]]:
        """
    ...
    @property
    @pulumi.getter(name="serverOSVersion")
    def server_os_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Registered Server OS Version
        """
        return pulumi.get(self, "server_os_version")
    ...
    @property
    @pulumi.getter(name="serverRole")
    def server_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Registered Server serverRole
        """
        return pulumi.get(self, "server_role")
    ...
    def service_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Service Location
        """
    ...
    def storage_sync_service_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
