...
class CloudEndpointChangeEnumerationActivityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operation_state: Change enumeration operation state
        :param _builtins.float processed_directories_count: Count of directories processed
        :param _builtins.float processed_files_count: Count of files processed
        :param _builtins.int progress_percent: Progress percentage for change enumeration run, excluding processing of deletes
        :param _builtins.str started_timestamp: Timestamp when change enumeration started
        :param _builtins.int status_code: When non-zero, indicates an issue that is delaying change enumeration
        :param _builtins.str total_counts_state: Change enumeration total counts state
        :param _builtins.float total_directories_count: Total count of directories enumerated
        :param _builtins.float total_files_count: Total count of files enumerated
        :param _builtins.float total_size_bytes: Total enumerated size in bytes
        """
...
class CloudEndpointLastChangeEnumerationStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float namespace_size_bytes: Namespace size in bytes
        :param _builtins.str next_run_timestamp: Timestamp of when change enumeration is expected to run again
        :param _builtins.str started_timestamp: Timestamp when change enumeration started
        """
...
class CloudTieringSpaceSavingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int space_savings_percent: Percentage of cached size over total size
        :param _builtins.float total_size_cloud_bytes: Total size of content in the azure file share
        :param _builtins.float volume_size_bytes: Volume size
        """
...
class ServerEndpointBackgroundDataDownloadActivityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str timestamp: Timestamp when properties were updated
        """
...
class ServerEndpointCloudTieringStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str health: Cloud tiering health state.
        :param _builtins.str health_last_updated_timestamp: The last updated timestamp of health state
        :param _builtins.int last_cloud_tiering_result: Last cloud tiering result (HResult)
        :param _builtins.str last_success_timestamp: Last cloud tiering success timestamp
        :param _builtins.str last_updated_timestamp: Last updated timestamp
...
class ServerEndpointProvisioningStepStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int minutes_left: Estimated completion time of the provisioning step in minutes
        :param _builtins.str name: Name of the provisioning step
        :param _builtins.int progress_percentage: Estimated progress percentage
        :param _builtins.str start_time: Start time of the provisioning step
        :param _builtins.str status: Status of the provisioning step
        """
...
class ServerEndpointSyncActivityStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int session_minutes_remaining: Session minutes remaining (if available)
        :param _builtins.str sync_mode: Sync mode
        :param _builtins.str timestamp: Timestamp when properties were updated
        :param _builtins.float total_bytes: Total bytes (if available)
        :param _builtins.float total_item_count: Total item count (if available)
        """
...
class ServerEndpointSyncSessionStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int last_sync_result: Last sync result (HResult)
        :param _builtins.str last_sync_success_timestamp: Last sync success timestamp
        :param _builtins.str last_sync_timestamp: Last sync timestamp
        :param _builtins.float persistent_files_not_syncing_count: Count of persistent files not syncing.
        :param _builtins.float transient_files_not_syncing_count: Count of transient files not syncing.
        """
...
class ServerEndpointSyncStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str download_health: Download Health Status.
        :param 'ServerEndpointSyncSessionStatusResponse' download_status: Download Status
        :param _builtins.str last_updated_timestamp: Last Updated Timestamp
        :param _builtins.str offline_data_transfer_status: Offline Data Transfer State
        :param _builtins.str sync_activity: Sync activity
        :param _builtins.float total_persistent_files_not_syncing_count: Total count of persistent files not syncing (combined upload + download).
        :param 'ServerEndpointSyncActivityStatusResponse' upload_activity: Upload sync activity
        :param _builtins.str upload_health: Upload Health Status.
