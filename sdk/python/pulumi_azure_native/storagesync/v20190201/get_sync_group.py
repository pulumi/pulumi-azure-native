...
azure-native:storagesync/v20190201:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: Version 2019-02-01 will be removed in v2 of the provider.
