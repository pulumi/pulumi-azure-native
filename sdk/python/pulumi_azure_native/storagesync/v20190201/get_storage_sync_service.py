...
azure-native:storagesync/v20190201:StorageSyncService is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20191001:StorageSyncService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_storage_sync_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_sync_service is deprecated: Version 2019-02-01 will be removed in v2 of the provider.
azure-native:storagesync/v20190201:StorageSyncService is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20191001:StorageSyncService to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20190201:getStorageSyncService', __args__, opts=opts, typ=GetStorageSyncServiceResult).value
