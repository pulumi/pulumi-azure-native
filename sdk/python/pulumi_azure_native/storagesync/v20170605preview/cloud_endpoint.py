...
class CloudEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cloud_endpoint = azure_native.storagesync.v20170605preview.CloudEndpoint("cloudEndpoint",
