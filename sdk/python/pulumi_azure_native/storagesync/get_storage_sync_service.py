...
class GetStorageSyncServiceResult:
    ...
    def incoming_traffic_policy(self) -> Optional[builtins.str]:
        """
    ...
    def last_workflow_id(self) -> builtins.str:
        """
    ...
    def storage_sync_service_status(self) -> builtins.int:
        """
    ...
    def storage_sync_service_uid(self) -> builtins.str:
        """
    ...
    def use_identity(self) -> builtins.bool:
        """
...
def get_storage_sync_service(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync:getStorageSyncService', __args__, opts=opts, typ=GetStorageSyncServiceResult).value
...
def get_storage_sync_service_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
