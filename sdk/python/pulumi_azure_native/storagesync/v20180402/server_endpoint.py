...
class ServerEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_endpoint = azure_native.storagesync.v20180402.ServerEndpoint("serverEndpoint",
            cloud_tiering="off",
