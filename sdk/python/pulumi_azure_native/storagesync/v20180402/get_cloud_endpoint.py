...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_endpoint is deprecated: Version v20180402 will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20180402:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
