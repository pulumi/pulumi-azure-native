...
warnings.warn("""azure-native:storagesync/v20200901:StorageSyncService is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:StorageSyncService to guarantee forwards compatibility.""", DeprecationWarning)
...
class StorageSyncService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""StorageSyncService is deprecated: azure-native:storagesync/v20200901:StorageSyncService is being removed in the next major version of this provider. Please upgrade to azure-native:storagesync/v20220601:StorageSyncService to guarantee forwards compatibility.""")
