...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_endpoint is deprecated: azure-native:storagesync/v20200901:CloudEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20200901:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
