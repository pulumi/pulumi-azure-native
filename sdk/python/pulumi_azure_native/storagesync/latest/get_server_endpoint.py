...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getServerEndpoint'.""", DeprecationWarning)
...
def get_server_endpoint(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_endpoint is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getServerEndpoint'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/latest:getServerEndpoint', __args__, opts=opts, typ=GetServerEndpointResult).value
