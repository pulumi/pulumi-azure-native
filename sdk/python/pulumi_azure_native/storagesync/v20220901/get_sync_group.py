...
def get_sync_group(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20220901:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
...
def get_sync_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['syncGroupName'] = sync_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagesync/v20220901:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult)
