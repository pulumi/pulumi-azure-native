...
class ServerEndpointProvisioningStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServerEndpointProvisioningStatusResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            provisioning_status=provisioning_status,
            provisioning_step_statuses=provisioning_step_statuses,
    ...
    def _configure(
             ...
             provisioning_step_statuses: Optional[Sequence['outputs.ServerEndpointProvisioningStepStatusResponse']] = None,
        ...
        if provisioning_step_statuses is None and 'provisioningStepStatuses' in kwargs:
            provisioning_step_statuses = kwargs['provisioningStepStatuses']
        if provisioning_step_statuses is None:
            raise TypeError("Missing 'provisioning_step_statuses' argument")
        ...
        if provisioning_type is None:
            raise TypeError("Missing 'provisioning_type' argument")

        _setter("provisioning_status", provisioning_status)
        _setter("provisioning_step_statuses", provisioning_step_statuses)
...
class ServerEndpointProvisioningStepStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServerEndpointProvisioningStepStatusResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             additional_information: Optional[Mapping[str, str]] = None,
        ...
        if error_code is None:
            raise TypeError("Missing 'error_code' argument")
        if minutes_left is None and 'minutesLeft' in kwargs:
            minutes_left = kwargs['minutesLeft']
        if minutes_left is None:
            raise TypeError("Missing 'minutes_left' argument")
        if name is None:
            raise TypeError("Missing 'name' argument")
        if progress_percentage is None and 'progressPercentage' in kwargs:
            progress_percentage = kwargs['progressPercentage']
        if progress_percentage is None:
            raise TypeError("Missing 'progress_percentage' argument")
        ...
        _setter("error_code", error_code)
        _setter("minutes_left", minutes_left)
        _setter("name", name)
