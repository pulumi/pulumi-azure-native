...
def get_registered_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20220901:getRegisteredServer', __args__, opts=opts, typ=GetRegisteredServerResult).value
...
def get_registered_server_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageSyncServiceName'] = storage_sync_service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagesync/v20220901:getRegisteredServer', __args__, opts=opts, typ=GetRegisteredServerResult)
