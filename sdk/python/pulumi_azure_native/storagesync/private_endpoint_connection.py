...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagesync/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200901:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/v20200901:PrivateEndpointConnection")])
