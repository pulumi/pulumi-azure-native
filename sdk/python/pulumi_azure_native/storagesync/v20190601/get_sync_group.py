...
azure-native:storagesync/v20190601:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: Version 2019-06-01 will be removed in v2 of the provider.
azure-native:storagesync/v20190601:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20190601:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
