...
azure-native:storagesync/v20190601:CloudEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_endpoint is deprecated: Version 2019-06-01 will be removed in v2 of the provider.
azure-native:storagesync/v20190601:CloudEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:CloudEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20190601:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
