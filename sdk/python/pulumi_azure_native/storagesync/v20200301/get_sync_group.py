...
warnings.warn("""azure-native:storagesync/v20200301:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: azure-native:storagesync/v20200301:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:SyncGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['storageSyncServiceName'] = storage_sync_service_name
    __args__['syncGroupName'] = sync_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20200301:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
