...
def get_registered_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_server is deprecated: azure-native:storagesync/v20200301:RegisteredServer is being removed in the next major version of this provider. Upgrade to at least azure-native:storagesync/v20220601:RegisteredServer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverId'] = server_id
    __args__['storageSyncServiceName'] = storage_sync_service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/v20200301:getRegisteredServer', __args__, opts=opts, typ=GetRegisteredServerResult).value
