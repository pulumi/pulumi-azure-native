...
warnings.warn("""azure-native:networkfunction/v20220801:CollectorPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:networkfunction/v20221101:CollectorPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class CollectorPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CollectorPolicy is deprecated: azure-native:networkfunction/v20220801:CollectorPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:networkfunction/v20221101:CollectorPolicy to guarantee forwards compatibility.""")
