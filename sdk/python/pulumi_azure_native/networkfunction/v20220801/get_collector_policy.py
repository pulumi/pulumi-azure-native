...
def get_collector_policy(azure_traffic_collector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_collector_policy is deprecated: azure-native:networkfunction/v20220801:CollectorPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:networkfunction/v20221101:CollectorPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
