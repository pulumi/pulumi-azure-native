...
class AzureTrafficCollector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        azure_traffic_collector = azure_native.networkfunction.v20220801.AzureTrafficCollector("azureTrafficCollector",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkfunction:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20210901preview:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20220501:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20221101:AzureTrafficCollector")])
