...
def get_azure_traffic_collector(azure_traffic_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkfunction/v20210901preview:getAzureTrafficCollector', __args__, opts=opts, typ=GetAzureTrafficCollectorResult).value
...
def get_azure_traffic_collector_output(azure_traffic_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkfunction/v20210901preview:getAzureTrafficCollector', __args__, opts=opts, typ=GetAzureTrafficCollectorResult)
