...
class AzureTrafficCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AzureTrafficCollector is deprecated: azure-native:networkfunction/v20210901preview:AzureTrafficCollector is being removed in the next major version of this provider. Upgrade to at least azure-native:networkfunction/v20220801:AzureTrafficCollector to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkfunction:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20220501:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20220801:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20221101:AzureTrafficCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureTrafficCollector, __self__).__init__(
            'azure-native:networkfunction/v20210901preview:AzureTrafficCollector',
            resource_name,
            __props__,
            opts)
