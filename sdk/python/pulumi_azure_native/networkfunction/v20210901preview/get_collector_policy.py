...
def get_collector_policy(azure_traffic_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkfunction/v20210901preview:getCollectorPolicy', __args__, opts=opts, typ=GetCollectorPolicyResult).value
...
def get_collector_policy_output(azure_traffic_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkfunction/v20210901preview:getCollectorPolicy', __args__, opts=opts, typ=GetCollectorPolicyResult)
