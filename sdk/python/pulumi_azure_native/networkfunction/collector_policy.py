...
class CollectorPolicyArgs:
    def __init__(__self__, *,
                 azure_traffic_collector_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] collector_policy_name: Collector Policy Name
    ...
    def azure_traffic_collector_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def azure_traffic_collector_name(self, value: pulumi.Input[builtins.str]):
    ...
    def collector_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def collector_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CollectorPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:networkfunction:CollectorPolicy"
