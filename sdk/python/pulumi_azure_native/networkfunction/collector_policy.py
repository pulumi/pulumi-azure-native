...
class CollectorPolicyArgs:
    ...
    def _configure(
        ...
        if azure_traffic_collector_name is None:
            raise TypeError("Missing 'azure_traffic_collector_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if collector_policy_name is None and 'collectorPolicyName' in kwargs:
            collector_policy_name = kwargs['collectorPolicyName']
...
class CollectorPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            ingestion_policy = _utilities.configure(ingestion_policy, IngestionPolicyPropertiesFormatArgs, True)
