...
def get_azure_traffic_collector(azure_traffic_collector_name: Optional[_builtins.str] = None,
...
def get_azure_traffic_collector_output(azure_traffic_collector_name: Optional[pulumi.Input[_builtins.str]] = None,
