...
class AzureTrafficCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkfunction:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20210901preview:AzureTrafficCollector")])
