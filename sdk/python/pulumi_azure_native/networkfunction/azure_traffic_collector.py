...
class AzureTrafficCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkfunction/v20220501:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20220801:AzureTrafficCollector"), pulumi.Alias(type_="azure-native:networkfunction/v20221101:AzureTrafficCollector")])
