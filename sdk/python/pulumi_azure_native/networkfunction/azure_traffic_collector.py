...
class AzureTrafficCollectorArgs:
    ...
    def azure_traffic_collector_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def azure_traffic_collector_name(self, value: Optional[pulumi.Input[_builtins.str]]):
