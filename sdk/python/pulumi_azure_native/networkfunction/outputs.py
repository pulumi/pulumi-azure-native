...
class CollectorPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 system_data: 'outputs.CollectorPolicyResponseSystemData',
                 type: str,
        ...
        :param 'CollectorPolicyResponseSystemData' system_data: Metadata pertaining to creation and last modification of the resource.
