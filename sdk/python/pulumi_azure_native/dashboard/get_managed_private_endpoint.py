...
class GetManagedPrivateEndpointResult:
    ...
    def private_link_service_private_ip(self) -> _builtins.str:
        """
    ...
    def private_link_service_url(self) -> Optional[_builtins.str]:
        """
...
def get_managed_private_endpoint(managed_private_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_private_endpoint_name: The managed private endpoint name of Azure Managed Grafana.
...
def get_managed_private_endpoint_output(managed_private_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
