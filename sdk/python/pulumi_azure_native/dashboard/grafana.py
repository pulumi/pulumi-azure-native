...
class GrafanaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The geo-location where the grafana resource lives
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags for grafana resource.
