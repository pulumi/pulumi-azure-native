...
class Dashboard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard/v20241101preview:Dashboard"), pulumi.Alias(type_="azure-native:dashboard/v20250801:Dashboard"), pulumi.Alias(type_="azure-native:dashboard/v20250901preview:Dashboard")])
