...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] group_ids: The private endpoint connection group ids.
        :param pulumi.Input[_builtins.str] private_endpoint_connection_name: The private endpoint connection name of Azure Managed Grafana.
        """
