...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard/v20220801:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dashboard/v20221001preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dashboard/v20230901:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dashboard/v20231001preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dashboard/v20241001:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20220501preview:dashboard:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20220801:dashboard:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20221001preview:dashboard:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20230901:dashboard:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20231001preview:dashboard:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_dashboard_v20241001:dashboard:PrivateEndpointConnection")])
