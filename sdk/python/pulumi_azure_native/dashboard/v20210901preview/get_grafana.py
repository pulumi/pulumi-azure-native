...
warnings.warn("""Version v20210901preview will be removed in the next major version of the provider. Upgrade to version v20220501preview or later.""", DeprecationWarning)
...
def get_grafana(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_grafana is deprecated: Version v20210901preview will be removed in the next major version of the provider. Upgrade to version v20220501preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dashboard/v20210901preview:getGrafana', __args__, opts=opts, typ=GetGrafanaResult).value
