...
class Grafana(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ManagedIdentityArgs', 'ManagedIdentityArgsDict']] identity: The managed identity of the grafana resource.
        :param pulumi.Input[str] location: The geo-location where the grafana resource lives
