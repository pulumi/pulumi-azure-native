...
class Grafana(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        grafana = azure_native.dashboard.v20220501preview.Grafana("grafana",
            identity=azure_native.dashboard.v20220501preview.ManagedServiceIdentityResponseArgs(
                type="SystemAssigned",
            ),
            location="West US",
            properties=azure_native.dashboard.v20220501preview.ManagedGrafanaPropertiesArgs(
                api_key="Enabled",
            ...
            sku=azure_native.dashboard.v20220501preview.ResourceSkuResponseArgs(
                name="Standard",
            ),
            tags={
                "Environment": "Dev",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard:Grafana"), pulumi.Alias(type_="azure-native:dashboard/v20210901preview:Grafana"), pulumi.Alias(type_="azure-native:dashboard/v20220801:Grafana")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Grafana, __self__).__init__(
            'azure-native:dashboard/v20220501preview:Grafana',
            resource_name,
            __props__,
            opts)
