...
class ManagedPrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_ids: The group Ids of the managed private endpoint.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] managed_private_endpoint_name: The managed private endpoint name of Azure Managed Grafana.
        :param pulumi.Input[builtins.str] private_link_resource_id: The ARM resource ID of the resource for which the managed private endpoint is pointing to.
        :param pulumi.Input[builtins.str] private_link_resource_region: The region of the resource to which the managed private endpoint is pointing to.
        :param pulumi.Input[builtins.str] private_link_service_url: The URL of the data store behind the private link service. It would be the URL in the Grafana data source configuration page without the protocol and port.
        :param pulumi.Input[builtins.str] request_message: User input request message of the managed private endpoint.
...
class ManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def private_link_service_private_ip(self) -> pulumi.Output[builtins.str]:
        """
