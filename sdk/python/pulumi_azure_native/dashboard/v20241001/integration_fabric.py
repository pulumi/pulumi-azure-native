...
class IntegrationFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard/v20231001preview:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard:IntegrationFabric")])
