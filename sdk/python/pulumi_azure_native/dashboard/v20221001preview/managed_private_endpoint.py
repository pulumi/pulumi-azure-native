...
class ManagedPrivateEndpointArgs:
    ...
    def _configure(
        ...
        if 'managedPrivateEndpointName' in kwargs:
        ...
        if 'privateLinkServiceUrl' in kwargs:
            private_link_service_url = kwargs['privateLinkServiceUrl']
        ...
        if private_link_service_url is not None:
            _setter("private_link_service_url", private_link_service_url)
