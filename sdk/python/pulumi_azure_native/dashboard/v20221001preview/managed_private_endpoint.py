...
class ManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard:ManagedPrivateEndpoint"), pulumi.Alias(type_="azure-native:dashboard/v20230901:ManagedPrivateEndpoint"), pulumi.Alias(type_="azure-native:dashboard/v20231001preview:ManagedPrivateEndpoint")])
