...
def get_integration_fabric(integration_fabric_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str integration_fabric_name: The integration fabric name of Azure Managed Grafana.
...
def get_integration_fabric_output(integration_fabric_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
