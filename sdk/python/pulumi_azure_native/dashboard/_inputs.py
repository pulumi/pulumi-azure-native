...
class GrafanaConfigurationsArgsDict(TypedDict):
    ...
    """
    security: NotRequired[pulumi.Input[Optional['SecurityArgs']]]
    """
    Grafana security settings
    """
    smtp: NotRequired[pulumi.Input[Optional['SmtpArgs']]]
    """
    Email server settings.
    https://grafana.com/docs/grafana/v9.0/setup-grafana/configure-grafana/#smtp
    """
    snapshots: NotRequired[pulumi.Input[Optional['SnapshotsArgs']]]
    """
    Grafana Snapshots settings
    """
    users: NotRequired[pulumi.Input[Optional['UsersArgs']]]
    """
...
class GrafanaIntegrationsArgsDict(TypedDict):
    ...
    """
    azure_monitor_workspace_integrations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AzureMonitorWorkspaceIntegrationArgs']]]]]
...
class ManagedGrafanaPropertiesArgsDict(TypedDict):
    ...
    """
    enterprise_configurations: NotRequired[pulumi.Input[Optional['EnterpriseConfigurationsArgs']]]
    """
    Enterprise settings of a Grafana instance
    """
    grafana_configurations: NotRequired[pulumi.Input[Optional['GrafanaConfigurationsArgs']]]
    """
    Server configurations of a Grafana instance
    """
    grafana_integrations: NotRequired[pulumi.Input[Optional['GrafanaIntegrationsArgs']]]
    """
    GrafanaIntegrations is a bundled observability experience (e.g. pre-configured data source, tailored Grafana dashboards, alerting defaults) for common monitoring scenarios.
    """
