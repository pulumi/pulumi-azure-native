...
def get_grafana(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dashboard/v20220801:getGrafana', __args__, opts=opts, typ=GetGrafanaResult).value
...
def get_grafana_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dashboard/v20220801:getGrafana', __args__, opts=opts, typ=GetGrafanaResult)
