...
def get_private_endpoint_connection(private_endpoint_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_endpoint_connection_name: The private endpoint connection name of Azure Managed Grafana.
...
def get_private_endpoint_connection_output(private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dashboard:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult)
