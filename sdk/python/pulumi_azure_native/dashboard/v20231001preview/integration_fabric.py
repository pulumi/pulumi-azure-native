...
class IntegrationFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard/v20241001:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard:IntegrationFabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationFabric, __self__).__init__(
            'azure-native:dashboard/v20231001preview:IntegrationFabric',
            resource_name,
            __props__,
            opts)
