...
def get_integration_fabric(integration_fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dashboard/v20231001preview:getIntegrationFabric', __args__, opts=opts, typ=GetIntegrationFabricResult).value
...
def get_integration_fabric_output(integration_fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dashboard/v20231001preview:getIntegrationFabric', __args__, opts=opts, typ=GetIntegrationFabricResult)
