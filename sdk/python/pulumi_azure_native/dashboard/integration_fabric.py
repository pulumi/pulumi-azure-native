...
class IntegrationFabricArgs:
    def __init__(__self__, *,
                 integration_fabric_name: pulumi.Input[_builtins.str],
                 resource_group_name: pulumi.Input[_builtins.str],
                 workspace_name: pulumi.Input[_builtins.str],
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional['IntegrationFabricPropertiesArgs']] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a IntegrationFabric resource.

        :param pulumi.Input[_builtins.str] integration_fabric_name: The integration fabric name of Azure Managed Grafana.
    ...
    def integration_fabric_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def integration_fabric_name(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['IntegrationFabricPropertiesArgs']]:
        return pulumi.get(self, "properties")

    @properties.setter
    def properties(self, value: pulumi.Input[Optional['IntegrationFabricPropertiesArgs']]):
...
class IntegrationFabric(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 integration_fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['IntegrationFabricPropertiesArgs', 'IntegrationFabricPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if integration_fabric_name is None and not opts.urn:
                raise TypeError("Missing required property 'integration_fabric_name'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dashboard/v20231001preview:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard/v20241001:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard/v20241101preview:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard/v20250801:IntegrationFabric"), pulumi.Alias(type_="azure-native:dashboard/v20250901preview:IntegrationFabric")])
