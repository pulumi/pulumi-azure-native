...
class PolicyAssignmentArtifact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blueprint/v20181101preview:PolicyAssignmentArtifact"), pulumi.Alias(type_="azure-native:blueprint/v20181101preview:RoleAssignmentArtifact"), pulumi.Alias(type_="azure-native:blueprint/v20181101preview:TemplateArtifact"), pulumi.Alias(type_="azure-native:blueprint:RoleAssignmentArtifact"), pulumi.Alias(type_="azure-native:blueprint:TemplateArtifact"), pulumi.Alias(type_="azure-native_blueprint_v20181101preview:blueprint:PolicyAssignmentArtifact")])
