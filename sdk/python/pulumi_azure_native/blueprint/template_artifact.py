...
class TemplateArtifactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group: If applicable, the name of the resource group placeholder to which the Resource Manager template blueprint artifact will be deployed.
        """
