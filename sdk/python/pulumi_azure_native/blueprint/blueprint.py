...
class BlueprintArgs:
    def __init__(__self__, *,
                 ...
                 target_scope: pulumi.Input[Union[builtins.str, 'BlueprintTargetScope']],
    ...
    def target_scope(self) -> pulumi.Input[Union[builtins.str, 'BlueprintTargetScope']]:
        """
    ...
    @target_scope.setter
    def target_scope(self, value: pulumi.Input[Union[builtins.str, 'BlueprintTargetScope']]):
...
class Blueprint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="targetScope")
    def target_scope(self) -> pulumi.Output[builtins.str]:
        """
        The scope where this blueprint definition can be assigned.
        """
        return pulumi.get(self, "target_scope")
