...
class Blueprint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blueprint/v20181101preview:Blueprint"), pulumi.Alias(type_="azure-native_blueprint_v20181101preview:blueprint:Blueprint")])
