...
class ParameterDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] strong_type: StrongType for UI to render rich experience during blueprint assignment. Supported strong types are resourceType, principalId and location.
        """
        pulumi.set(__self__, "type", type)
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'TemplateParameterType']]):
        pulumi.set(self, "type", value)
...
class ParameterValueArgsDict(TypedDict):
    ...
    """
    reference: NotRequired[pulumi.Input[Optional['SecretValueReferenceArgs']]]
    """
...
class ResourceGroupDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of this parameter/resourceGroup.
        :param pulumi.Input[_builtins.str] display_name: DisplayName of this parameter/resourceGroup.
        :param pulumi.Input[_builtins.str] location: Location of this resourceGroup. Leave empty if the resource group location will be specified during the blueprint assignment.
        :param pulumi.Input[_builtins.str] name: Name of this resourceGroup. Leave empty if the resource group name will be specified during the blueprint assignment.
        :param pulumi.Input[_builtins.str] strong_type: StrongType for UI to render rich experience during blueprint assignment. Supported strong types are resourceType, principalId and location.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tags to be assigned to this resource group.
        """
