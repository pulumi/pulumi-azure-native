...
class ParameterDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str strong_type: StrongType for UI to render rich experience during blueprint assignment. Supported strong types are resourceType, principalId and location.
        """
        pulumi.set(__self__, "type", type)
...
class ResourceGroupDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str description: Description of this parameter/resourceGroup.
        :param _builtins.str display_name: DisplayName of this parameter/resourceGroup.
        :param _builtins.str location: Location of this resourceGroup. Leave empty if the resource group location will be specified during the blueprint assignment.
        :param _builtins.str name: Name of this resourceGroup. Leave empty if the resource group name will be specified during the blueprint assignment.
        :param _builtins.str strong_type: StrongType for UI to render rich experience during blueprint assignment. Supported strong types are resourceType, principalId and location.
        :param Mapping[str, _builtins.str] tags: Tags to be assigned to this resource group.
        """
