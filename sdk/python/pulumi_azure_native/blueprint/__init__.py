...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:blueprint:Artifact":
                return Artifact(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint:Assignment":
                return Assignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint:Blueprint":
                return Blueprint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint:PublishedBlueprint":
    ...
    pulumi.runtime.register_resource_module("azure-native", "blueprint", _module_instance)
