...
class PolicyAssignmentArtifact(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] kind: Specifies the kind of Blueprint artifact.
               Expected value is 'policyAssignment'.
        :param pulumi.Input[str] management_group_name: ManagementGroup where blueprint stores.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['ParameterValueBaseArgs']]]] parameters: Parameter values for the policy definition.
        :param pulumi.Input[str] policy_definition_id: Azure resource ID of the policy definition.
        :param pulumi.Input[str] resource_group: Name of the resource group placeholder to which the policy will be assigned.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:blueprint/v20171111preview:PolicyAssignmentArtifact")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyAssignmentArtifact, __self__).__init__(
            'azure-native:blueprint/v20171111preview:PolicyAssignmentArtifact',
            resource_name,
            __props__,
            opts)
