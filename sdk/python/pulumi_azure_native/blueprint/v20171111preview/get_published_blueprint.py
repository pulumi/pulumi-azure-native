...
def get_published_blueprint(blueprint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_published_blueprint is deprecated: Version v20171111preview will be removed in the next major version of the provider. Upgrade to version v20181101preview or later.""")
    __args__ = dict()
