...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:blueprint/v20171111preview:Artifact":
                return Artifact(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint/v20171111preview:Assignment":
                return Assignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint/v20171111preview:Blueprint":
                return Blueprint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blueprint/v20171111preview:PublishedBlueprint":
    ...
    pulumi.runtime.register_resource_module("azure-native", "blueprint/v20171111preview", _module_instance)
