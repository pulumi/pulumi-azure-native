...
def get_policy_assignment_artifact(artifact_name: Optional[_builtins.str] = None,
...
def get_policy_assignment_artifact_output(artifact_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
