...
def get_template_artifact(artifact_name: Optional[builtins.str] = None,
...
def get_template_artifact_output(artifact_name: Optional[pulumi.Input[builtins.str]] = None,
