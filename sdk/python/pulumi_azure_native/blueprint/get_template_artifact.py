...
class GetTemplateArtifactResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, depends_on=None, description=None, display_name=None, id=None, kind=None, name=None, parameters=None, resource_group=None, template=None, type=None):
...
def get_template_artifact(artifact_name: Optional[_builtins.str] = None,
                          blueprint_name: Optional[_builtins.str] = None,
...
def get_template_artifact_output(artifact_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:blueprint:getTemplateArtifact', __args__, opts=opts, typ=GetTemplateArtifactResult)
