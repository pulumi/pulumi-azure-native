...
def get_role_assignment_artifact(artifact_name: Optional[_builtins.str] = None,
...
def get_role_assignment_artifact_output(artifact_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
