...
class Blueprint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blueprint = azure_native.blueprint.v20181101preview.Blueprint("blueprint",
            blueprint_name="simpleBlueprint",
            description="blueprint contains all artifact kinds {'template', 'rbac', 'policy'}",
            parameters={
                "costCenter": azure_native.blueprint.v20181101preview.ParameterDefinitionArgs(
                    display_name="force cost center tag for all resources under given subscription.",
                    type="string",
                ),
                "owners": azure_native.blueprint.v20181101preview.ParameterDefinitionArgs(
                    display_name="assign owners to subscription along with blueprint assignment.",
                    type="array",
                ),
                "storageAccountType": azure_native.blueprint.v20181101preview.ParameterDefinitionArgs(
                    display_name="storage account type.",
                    type="string",
                ),
            },
            resource_groups={
                "storageRG": azure_native.blueprint.v20181101preview.ResourceGroupDefinitionArgs(
        ...
        blueprint = azure_native.blueprint.v20181101preview.Blueprint("blueprint",
            ...
            resource_groups={
                "myRGName": azure_native.blueprint.v20181101preview.ResourceGroupDefinitionArgs(
