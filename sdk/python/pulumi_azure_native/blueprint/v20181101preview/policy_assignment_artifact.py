...
class PolicyAssignmentArtifactArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['PolicyAssignmentArtifactPropertiesArgs'],
        ...
        :param pulumi.Input['PolicyAssignmentArtifactPropertiesArgs'] properties: properties for policyAssignment Artifact
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['PolicyAssignmentArtifactPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['PolicyAssignmentArtifactPropertiesArgs']):
...
class PolicyAssignmentArtifact(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['PolicyAssignmentArtifactPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Specifies the kind of blueprint artifact.
               Expected value is 'policyAssignment'.
        :param pulumi.Input[pulumi.InputType['PolicyAssignmentArtifactPropertiesArgs']] properties: properties for policyAssignment Artifact
        :param pulumi.Input[str] resource_scope: The scope of the resource. Valid scopes are: management group (format: '/providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: '/subscriptions/{subscriptionId}').
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blueprint:PolicyAssignmentArtifact")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.PolicyAssignmentArtifactPropertiesResponse']:
        """
        properties for policyAssignment Artifact
        """
        return pulumi.get(self, "properties")
