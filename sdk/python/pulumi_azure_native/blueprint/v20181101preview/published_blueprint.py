...
class PublishedBlueprint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:blueprint/v20181101preview:PublishedBlueprint"), pulumi.Alias(type_="azure-native:blueprint:PublishedBlueprint"), pulumi.Alias(type_="azure-nextgen:blueprint:PublishedBlueprint")])
