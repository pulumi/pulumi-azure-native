...
class TemplateArtifact(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        template_artifact = azure_native.blueprint.v20181101preview.TemplateArtifact("templateArtifact",
            artifact_name="storageTemplate",
            blueprint_name="simpleBlueprint",
            kind="template",
            parameters={
                "storageAccountType": azure_native.blueprint.v20181101preview.ParameterValueArgs(
