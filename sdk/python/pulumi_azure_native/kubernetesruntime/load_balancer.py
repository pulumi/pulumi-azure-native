...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 bgp_peers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] bgp_peers: The list of BGP peers it should advertise to. Null or empty means to advertise to all peers.
    ...
    def bgp_peers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @bgp_peers.setter
    def bgp_peers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesruntime/v20231001preview:LoadBalancer"), pulumi.Alias(type_="azure-native:kubernetesruntime/v20240301:LoadBalancer"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20231001preview:kubernetesruntime:LoadBalancer"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20240301:kubernetesruntime:LoadBalancer")])
    ...
    @property
    @pulumi.getter(name="bgpPeers")
    def bgp_peers(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        The list of BGP peers it should advertise to. Null or empty means to advertise to all peers.
        """
        return pulumi.get(self, "bgp_peers")
