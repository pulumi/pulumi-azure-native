...
class StorageClass(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesruntime/v20231001preview:StorageClass"), pulumi.Alias(type_="azure-native:kubernetesruntime/v20240301:StorageClass"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20231001preview:kubernetesruntime:StorageClass"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20240301:kubernetesruntime:StorageClass")])
