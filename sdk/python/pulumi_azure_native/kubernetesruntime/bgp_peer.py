...
class BgpPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] my_asn: My ASN
        :param pulumi.Input[str] peer_address: Peer Address
        ...
        :param pulumi.Input[str] bgp_peer_name: The name of the BgpPeer
        """
    ...
    def my_asn(self) -> pulumi.Input[int]:
        """
        My ASN
        """
    ...
    @my_asn.setter
    def my_asn(self, value: pulumi.Input[int]):
...
class BgpPeer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bgp_peer_name: Optional[pulumi.Input[str]] = None,
                 my_asn: Optional[pulumi.Input[int]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesruntime/v20231001preview:BgpPeer"), pulumi.Alias(type_="azure-native:kubernetesruntime/v20240301:BgpPeer"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20231001preview:kubernetesruntime:BgpPeer"), pulumi.Alias(type_="azure-native_kubernetesruntime_v20240301:kubernetesruntime:BgpPeer")])
    ...
    @property
    @pulumi.getter(name="myAsn")
    def my_asn(self) -> pulumi.Output[int]:
        """
        My ASN
        """
        return pulumi.get(self, "my_asn")
