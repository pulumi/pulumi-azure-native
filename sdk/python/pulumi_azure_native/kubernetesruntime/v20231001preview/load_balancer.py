...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesruntime/v20240301:LoadBalancer"), pulumi.Alias(type_="azure-native:kubernetesruntime:LoadBalancer")])
