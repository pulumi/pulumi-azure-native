...
def get_storage_class(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesruntime/v20231001preview:getStorageClass', __args__, opts=opts, typ=GetStorageClassResult).value
...
def get_storage_class_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageClassName'] = storage_class_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesruntime/v20231001preview:getStorageClass', __args__, opts=opts, typ=GetStorageClassResult)
