...
def get_bgp_peer(bgp_peer_name: Optional[builtins.str] = None,
    ...
    :param builtins.str bgp_peer_name: The name of the BgpPeer
...
def get_bgp_peer_output(bgp_peer_name: Optional[pulumi.Input[builtins.str]] = None,
