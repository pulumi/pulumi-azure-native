...
class GetLoadBalancerResult:
    ...
    def bgp_peers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def service_selector(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_load_balancer(load_balancer_name: Optional[builtins.str] = None,
    ...
    :param builtins.str load_balancer_name: The name of the LoadBalancer
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesruntime:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
...
def get_load_balancer_output(load_balancer_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kubernetesruntime:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult)
