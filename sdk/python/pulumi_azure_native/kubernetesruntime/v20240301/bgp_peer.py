...
class BgpPeer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kubernetesruntime:BgpPeer"), pulumi.Alias(type_="azure-native:kubernetesruntime/v20231001preview:BgpPeer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BgpPeer, __self__).__init__(
            'azure-native:kubernetesruntime/v20240301:BgpPeer',
            resource_name,
            __props__,
            opts)
