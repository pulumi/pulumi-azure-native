...
def get_open_shift_managed_cluster_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20190430:getOpenShiftManagedCluster', __args__, opts=opts, typ=GetOpenShiftManagedClusterResult)
