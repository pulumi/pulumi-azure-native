...
class OpenShiftManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        open_shift_managed_cluster = azure_native.containerservice.v20190430.OpenShiftManagedCluster("openShiftManagedCluster",
            agent_pool_profiles=[
                {
                    "count": 2,
                    "name": "infra",
            ...
            auth_profile=azure_native.containerservice.v20190430.OpenShiftManagedClusterAuthProfileResponseArgs(
                identity_providers=[{
                    "name": "Azure AD",
                    "provider": azure_native.containerservice.v20190430.OpenShiftManagedClusterAADIdentityProviderResponseArgs(
                        client_id="clientId",
            ...
            location="location1",
            master_pool_profile=azure_native.containerservice.v20190430.OpenShiftManagedClusterMasterPoolProfileResponseArgs(
                count=3,
                name="master",
                os_type="Linux",
            ...
            network_profile=azure_native.containerservice.v20190430.NetworkProfileArgs(
                vnet_cidr="10.0.0.0/8",
            ),
            open_shift_version="v3.11",
            resource_group_name="rg1",
            resource_name_="clustername1",
            router_profiles=[azure_native.containerservice.v20190430.OpenShiftRouterProfileArgs(
                name="default",
            )],
            tags={
                "archv2": "",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20180930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20190930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20191027preview:OpenShiftManagedCluster")])
