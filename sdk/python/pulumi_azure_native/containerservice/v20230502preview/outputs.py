...
class AbsoluteMonthlyScheduleResponse(dict):
    ...
    def _configure(
        ...
        if interval_months is None and 'intervalMonths' in kwargs:
            interval_months = kwargs['intervalMonths']
        if interval_months is None:
            raise TypeError("Missing 'interval_months' argument")
...
class AgentPoolNetworkProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if allowed_host_ports is None and 'allowedHostPorts' in kwargs:
        ...
        if node_public_ip_tags is None and 'nodePublicIPTags' in kwargs:
...
class AgentPoolWindowsProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if disable_outbound_nat is None and 'disableOutboundNat' in kwargs:
...
class AzureKeyVaultKmsResponse(dict):
    ...
    def _configure(
        ...
        if key_id is None and 'keyId' in kwargs:
            key_id = kwargs['keyId']
        if key_vault_network_access is None and 'keyVaultNetworkAccess' in kwargs:
...
class ClusterUpgradeSettingsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if override_settings is None and 'overrideSettings' in kwargs:
...
class ContainerServiceLinuxProfileResponse(dict):
    ...
    def _configure(
             ...
             ssh: Optional['outputs.ContainerServiceSshConfigurationResponse'] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        ...
        if ssh is None:
            raise TypeError("Missing 'ssh' argument")
...
class ContainerServiceNetworkProfileResponse(dict):
    ...
    def _configure(
        ...
        if ip_families is None and 'ipFamilies' in kwargs:
            ip_families = kwargs['ipFamilies']
        if kube_proxy_config is None and 'kubeProxyConfig' in kwargs:
        ...
        if nat_gateway_profile is None and 'natGatewayProfile' in kwargs:
            nat_gateway_profile = kwargs['natGatewayProfile']
        if network_dataplane is None and 'networkDataplane' in kwargs:
        ...
        if network_plugin_mode is None and 'networkPluginMode' in kwargs:
...
class ContainerServiceNetworkProfileResponseIpvsConfig(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if tcp_fin_timeout_seconds is None and 'tcpFinTimeoutSeconds' in kwargs:
            tcp_fin_timeout_seconds = kwargs['tcpFinTimeoutSeconds']
        if tcp_timeout_seconds is None and 'tcpTimeoutSeconds' in kwargs:
            tcp_timeout_seconds = kwargs['tcpTimeoutSeconds']
        if udp_timeout_seconds is None and 'udpTimeoutSeconds' in kwargs:
...
class ContainerServiceNetworkProfileResponseKubeProxyConfig(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if ipvs_config is None and 'ipvsConfig' in kwargs:
...
class GuardrailsProfileResponse(dict):
    ...
    def _configure(
             ...
             system_excluded_namespaces: Optional[Sequence[str]] = None,
        ...
        if system_excluded_namespaces is None and 'systemExcludedNamespaces' in kwargs:
            system_excluded_namespaces = kwargs['systemExcludedNamespaces']
        if system_excluded_namespaces is None:
            raise TypeError("Missing 'system_excluded_namespaces' argument")
        if version is None:
...
class IstioComponentsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if ingress_gateways is None and 'ingressGateways' in kwargs:
...
class MaintenanceWindowResponse(dict):
    ...
    def _configure(
        ...
        if not_allowed_dates is None and 'notAllowedDates' in kwargs:
            not_allowed_dates = kwargs['notAllowedDates']
        if start_date is None and 'startDate' in kwargs:
            start_date = kwargs['startDate']
        if utc_offset is None and 'utcOffset' in kwargs:
...
class ManagedClusterAADProfileResponse(dict):
    ...
    def _configure(
        ...
        if server_app_secret is None and 'serverAppSecret' in kwargs:
...
class ManagedClusterAPIServerAccessProfileResponse(dict):
    ...
    def _configure(
        ...
        if disable_run_command is None and 'disableRunCommand' in kwargs:
        ...
        if enable_private_cluster_public_fqdn is None and 'enablePrivateClusterPublicFQDN' in kwargs:
        ...
        if private_dns_zone is None and 'privateDNSZone' in kwargs:
...
class ManagedClusterAddonProfileResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             enabled: Optional[bool] = None,
             identity: Optional['outputs.ManagedClusterAddonProfileResponseIdentity'] = None,
             config: Optional[Mapping[str, str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if enabled is None:
...
class ManagedClusterAgentPoolProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if current_orchestrator_version is None and 'currentOrchestratorVersion' in kwargs:
            current_orchestrator_version = kwargs['currentOrchestratorVersion']
        if current_orchestrator_version is None:
            raise TypeError("Missing 'current_orchestrator_version' argument")
        if name is None:
            raise TypeError("Missing 'name' argument")
        if node_image_version is None and 'nodeImageVersion' in kwargs:
            node_image_version = kwargs['nodeImageVersion']
        if node_image_version is None:
            raise TypeError("Missing 'node_image_version' argument")
        ...
        if enable_custom_ca_trust is None and 'enableCustomCATrust' in kwargs:
            enable_custom_ca_trust = kwargs['enableCustomCATrust']
        if enable_encryption_at_host is None and 'enableEncryptionAtHost' in kwargs:
        ...
        if enable_ultra_ssd is None and 'enableUltraSSD' in kwargs:
            enable_ultra_ssd = kwargs['enableUltraSSD']
        if gpu_instance_profile is None and 'gpuInstanceProfile' in kwargs:
        ...
        if scale_set_eviction_policy is None and 'scaleSetEvictionPolicy' in kwargs:
            scale_set_eviction_policy = kwargs['scaleSetEvictionPolicy']
        if scale_set_priority is None and 'scaleSetPriority' in kwargs:
...
class ManagedClusterAutoUpgradeProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if node_os_upgrade_channel is None and 'nodeOSUpgradeChannel' in kwargs:
            node_os_upgrade_channel = kwargs['nodeOSUpgradeChannel']
        if upgrade_channel is None and 'upgradeChannel' in kwargs:
...
class ManagedClusterAzureMonitorProfileKubeStateMetricsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if metric_annotations_allow_list is None and 'metricAnnotationsAllowList' in kwargs:
            metric_annotations_allow_list = kwargs['metricAnnotationsAllowList']
        if metric_labels_allowlist is None and 'metricLabelsAllowlist' in kwargs:
...
class ManagedClusterAzureMonitorProfileMetricsResponse(dict):
    ...
    def _configure(
        ...
        if enabled is None:
            raise TypeError("Missing 'enabled' argument")
        if kube_state_metrics is None and 'kubeStateMetrics' in kwargs:
...
class ManagedClusterHTTPProxyConfigResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             effective_no_proxy: Optional[Sequence[str]] = None,
             http_proxy: Optional[str] = None,
             https_proxy: Optional[str] = None,
             no_proxy: Optional[Sequence[str]] = None,
             trusted_ca: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if effective_no_proxy is None and 'effectiveNoProxy' in kwargs:
            effective_no_proxy = kwargs['effectiveNoProxy']
        if effective_no_proxy is None:
            raise TypeError("Missing 'effective_no_proxy' argument")
...
class ManagedClusterIngressProfileWebAppRoutingResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "dnsZoneResourceId":
            suggest = "dns_zone_resource_id"
    ...
    def __init__(__self__, *,
        ...
        :param str dns_zone_resource_id: Resource ID of the DNS Zone to be associated with the web app. Used only when Web App Routing is enabled.
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             identity: Optional['outputs.UserAssignedIdentityResponse'] = None,
             dns_zone_resource_id: Optional[str] = None,
             enabled: Optional[bool] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if identity is None:
            raise TypeError("Missing 'identity' argument")
        if dns_zone_resource_id is None and 'dnsZoneResourceId' in kwargs:
            dns_zone_resource_id = kwargs['dnsZoneResourceId']

        _setter("identity", identity)
        if dns_zone_resource_id is not None:
            _setter("dns_zone_resource_id", dns_zone_resource_id)
        if enabled is not None:
            _setter("enabled", enabled)
    ...
    def dns_zone_resource_id(self) -> Optional[str]:
        """
...
class ManagedClusterLoadBalancerProfileResponse(dict):
    ...
    def _configure(
        ...
        if backend_pool_type is None and 'backendPoolType' in kwargs:
            backend_pool_type = kwargs['backendPoolType']
        if effective_outbound_ips is None and 'effectiveOutboundIPs' in kwargs:
            effective_outbound_ips = kwargs['effectiveOutboundIPs']
        if enable_multiple_standard_load_balancers is None and 'enableMultipleStandardLoadBalancers' in kwargs:
        ...
        if managed_outbound_ips is None and 'managedOutboundIPs' in kwargs:
            managed_outbound_ips = kwargs['managedOutboundIPs']
        if outbound_ip_prefixes is None and 'outboundIPPrefixes' in kwargs:
            outbound_ip_prefixes = kwargs['outboundIPPrefixes']
        if outbound_ips is None and 'outboundIPs' in kwargs:
...
class ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if count_i_pv6 is None and 'countIPv6' in kwargs:
...
class ManagedClusterNATGatewayProfileResponse(dict):
    ...
    def _configure(
        ...
        if idle_timeout_in_minutes is None and 'idleTimeoutInMinutes' in kwargs:
            idle_timeout_in_minutes = kwargs['idleTimeoutInMinutes']
        if managed_outbound_ip_profile is None and 'managedOutboundIPProfile' in kwargs:
...
class ManagedClusterNodeResourceGroupProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if restriction_level is None and 'restrictionLevel' in kwargs:
...
class ManagedClusterPodIdentityExceptionResponse(dict):
    ...
    def _configure(
        ...
        if pod_labels is None and 'podLabels' in kwargs:
            pod_labels = kwargs['podLabels']
        if pod_labels is None:
            raise TypeError("Missing 'pod_labels' argument")
...
class ManagedClusterPodIdentityProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if allow_network_plugin_kubenet is None and 'allowNetworkPluginKubenet' in kwargs:
            allow_network_plugin_kubenet = kwargs['allowNetworkPluginKubenet']
        if user_assigned_identities is None and 'userAssignedIdentities' in kwargs:
            user_assigned_identities = kwargs['userAssignedIdentities']
        if user_assigned_identity_exceptions is None and 'userAssignedIdentityExceptions' in kwargs:
...
class ManagedClusterPodIdentityResponse(dict):
    ...
    def _configure(
             ...
             name: Optional[str] = None,
             namespace: Optional[str] = None,
             provisioning_info: Optional['outputs.ManagedClusterPodIdentityResponseProvisioningInfo'] = None,
             provisioning_state: Optional[str] = None,
             binding_selector: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        ...
        if namespace is None:
            raise TypeError("Missing 'namespace' argument")
        if provisioning_info is None and 'provisioningInfo' in kwargs:
            provisioning_info = kwargs['provisioningInfo']
        if provisioning_info is None:
            raise TypeError("Missing 'provisioning_info' argument")
        if provisioning_state is None and 'provisioningState' in kwargs:
            provisioning_state = kwargs['provisioningState']
        if provisioning_state is None:
            raise TypeError("Missing 'provisioning_state' argument")
        if binding_selector is None and 'bindingSelector' in kwargs:
...
class ManagedClusterPropertiesForSnapshotResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             network_profile: Optional['outputs.NetworkProfileForSnapshotResponse'] = None,
             enable_rbac: Optional[bool] = None,
             kubernetes_version: Optional[str] = None,
             sku: Optional['outputs.ManagedClusterSKUResponse'] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class ManagedClusterPropertiesResponseAutoScalerProfile(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if balance_similar_node_groups is None and 'balanceSimilarNodeGroups' in kwargs:
            balance_similar_node_groups = kwargs['balanceSimilarNodeGroups']
        if max_empty_bulk_delete is None and 'maxEmptyBulkDelete' in kwargs:
        ...
        if max_node_provision_time is None and 'maxNodeProvisionTime' in kwargs:
            max_node_provision_time = kwargs['maxNodeProvisionTime']
        if max_total_unready_percentage is None and 'maxTotalUnreadyPercentage' in kwargs:
            max_total_unready_percentage = kwargs['maxTotalUnreadyPercentage']
        if new_pod_scale_up_delay is None and 'newPodScaleUpDelay' in kwargs:
            new_pod_scale_up_delay = kwargs['newPodScaleUpDelay']
        if ok_total_unready_count is None and 'okTotalUnreadyCount' in kwargs:
            ok_total_unready_count = kwargs['okTotalUnreadyCount']
        if scale_down_delay_after_add is None and 'scaleDownDelayAfterAdd' in kwargs:
            scale_down_delay_after_add = kwargs['scaleDownDelayAfterAdd']
        if scale_down_delay_after_delete is None and 'scaleDownDelayAfterDelete' in kwargs:
            scale_down_delay_after_delete = kwargs['scaleDownDelayAfterDelete']
        if scale_down_delay_after_failure is None and 'scaleDownDelayAfterFailure' in kwargs:
            scale_down_delay_after_failure = kwargs['scaleDownDelayAfterFailure']
        if scale_down_unneeded_time is None and 'scaleDownUnneededTime' in kwargs:
            scale_down_unneeded_time = kwargs['scaleDownUnneededTime']
        if scale_down_unready_time is None and 'scaleDownUnreadyTime' in kwargs:
            scale_down_unready_time = kwargs['scaleDownUnreadyTime']
        if scale_down_utilization_threshold is None and 'scaleDownUtilizationThreshold' in kwargs:
...
class ManagedClusterSecurityProfileDefenderResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if log_analytics_workspace_resource_id is None and 'logAnalyticsWorkspaceResourceId' in kwargs:
            log_analytics_workspace_resource_id = kwargs['logAnalyticsWorkspaceResourceId']
        if security_monitoring is None and 'securityMonitoring' in kwargs:
...
class ManagedClusterSecurityProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if azure_key_vault_kms is None and 'azureKeyVaultKms' in kwargs:
            azure_key_vault_kms = kwargs['azureKeyVaultKms']
        if custom_ca_trust_certificates is None and 'customCATrustCertificates' in kwargs:
            custom_ca_trust_certificates = kwargs['customCATrustCertificates']
        if image_cleaner is None and 'imageCleaner' in kwargs:
            image_cleaner = kwargs['imageCleaner']
        if node_restriction is None and 'nodeRestriction' in kwargs:
            node_restriction = kwargs['nodeRestriction']
        if workload_identity is None and 'workloadIdentity' in kwargs:
...
class ManagedClusterStorageProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if blob_csi_driver is None and 'blobCSIDriver' in kwargs:
            blob_csi_driver = kwargs['blobCSIDriver']
        if disk_csi_driver is None and 'diskCSIDriver' in kwargs:
            disk_csi_driver = kwargs['diskCSIDriver']
        if file_csi_driver is None and 'fileCSIDriver' in kwargs:
            file_csi_driver = kwargs['fileCSIDriver']
        if snapshot_controller is None and 'snapshotController' in kwargs:
...
class ManagedClusterWindowsProfileResponse(dict):
    ...
    def _configure(
        ...
        if gmsa_profile is None and 'gmsaProfile' in kwargs:
...
class ManagedClusterWorkloadAutoScalerProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if vertical_pod_autoscaler is None and 'verticalPodAutoscaler' in kwargs:
...
class ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "controlledValues":
            suggest = "controlled_values"
        elif key == "updateMode":
            suggest = "update_mode"
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if controlled_values is None and 'controlledValues' in kwargs:
            controlled_values = kwargs['controlledValues']
        ...
        _setter("controlled_values", controlled_values)
        if enabled is None:
            enabled = False
        _setter("enabled", enabled)
    ...
    def controlled_values(self) -> str:
        """
...
class PortRangeResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if port_end is None and 'portEnd' in kwargs:
            port_end = kwargs['portEnd']
        if port_start is None and 'portStart' in kwargs:
...
class PrivateLinkResourceResponse(dict):
    ...
    def _configure(
        ...
        if private_link_service_id is None:
            raise TypeError("Missing 'private_link_service_id' argument")
        if group_id is None and 'groupId' in kwargs:
            group_id = kwargs['groupId']
        if required_members is None and 'requiredMembers' in kwargs:
...
class RelativeMonthlyScheduleResponse(dict):
    ...
    def _configure(
        ...
        if interval_months is None:
            raise TypeError("Missing 'interval_months' argument")
        if week_index is None and 'weekIndex' in kwargs:
            week_index = kwargs['weekIndex']
        if week_index is None:
            raise TypeError("Missing 'week_index' argument")
...
class ScheduleResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if absolute_monthly is None and 'absoluteMonthly' in kwargs:
            absolute_monthly = kwargs['absoluteMonthly']
        if relative_monthly is None and 'relativeMonthly' in kwargs:
...
class TimeInWeekResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if hour_slots is None and 'hourSlots' in kwargs:
...
class UpgradeOverrideSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "controlPlaneOverrides":
            suggest = "control_plane_overrides"
    ...
    def __init__(__self__, *,
                 control_plane_overrides: Optional[Sequence[str]] = None,
                 until: Optional[str] = None):
        """
        Settings for overrides when upgrading a cluster.
        :param Sequence[str] control_plane_overrides: List of upgrade overrides when upgrading a cluster's control plane.
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if control_plane_overrides is None and 'controlPlaneOverrides' in kwargs:
            control_plane_overrides = kwargs['controlPlaneOverrides']

        if control_plane_overrides is not None:
            _setter("control_plane_overrides", control_plane_overrides)
        if until is not None:
            _setter("until", until)

    @property
    @pulumi.getter(name="controlPlaneOverrides")
    def control_plane_overrides(self) -> Optional[Sequence[str]]:
        """
        List of upgrade overrides when upgrading a cluster's control plane.
        """
        return pulumi.get(self, "control_plane_overrides")
...
class WindowsGmsaProfileResponse(dict):
    ...
    def _configure(
        ...
        if root_domain_name is None and 'rootDomainName' in kwargs:
