...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 identity_profile: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union['ManagedClusterPropertiesIdentityProfileArgs', 'ManagedClusterPropertiesIdentityProfileArgsDict']]]]] = None,
                 kubernetes_version: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['ManagedClusterAPIServerAccessProfileArgs', 'ManagedClusterAPIServerAccessProfileArgsDict']] api_server_access_profile: Access profile for managed cluster API server.
        ...
        :param pulumi.Input[Union['ManagedClusterAutoUpgradeProfileArgs', 'ManagedClusterAutoUpgradeProfileArgsDict']] auto_upgrade_profile: Profile of auto upgrade configuration.
        :param pulumi.Input[str] disk_encryption_set_id: ResourceId of the disk encryption set to use for enabling encryption at rest.
        :param pulumi.Input[str] dns_prefix: DNS prefix specified when creating the managed cluster.
        :param pulumi.Input[bool] enable_pod_security_policy: (DEPRECATING) Whether to enable Kubernetes pod security policy (preview). This feature is set for removal on October 15th, 2020. Learn more at aka.ms/aks/azpodpolicy.
        :param pulumi.Input[bool] enable_rbac: Whether to enable Kubernetes Role-Based Access Control.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['ManagedClusterPropertiesIdentityProfileArgs', 'ManagedClusterPropertiesIdentityProfileArgsDict']]]] identity_profile: Identities associated with the cluster.
        :param pulumi.Input[str] kubernetes_version: Version of Kubernetes specified when creating the managed cluster.
        ...
        :param pulumi.Input[str] node_resource_group: Name of the resource group containing agent pool nodes.
        :param pulumi.Input[Union['ManagedClusterPodIdentityProfileArgs', 'ManagedClusterPodIdentityProfileArgsDict']] pod_identity_profile: Profile of managed cluster pod identity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
