...
def get_namespace(namespace_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(namespace_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
