...
__all__ = [
    ...
    'ContainerServiceNetworkProfileIpvsConfigArgsDict',
    'ContainerServiceNetworkProfileKubeProxyConfigArgs',
    'ContainerServiceNetworkProfileKubeProxyConfigArgsDict',
    ...
    'ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs',
    'ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgsDict',
    'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs',
    'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgsDict',
    'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs',
    'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgsDict',
    'ManagedClusterAzureMonitorProfileAppMonitoringArgs',
    'ManagedClusterAzureMonitorProfileAppMonitoringArgsDict',
    'ManagedClusterAzureMonitorProfileContainerInsightsArgs',
    'ManagedClusterAzureMonitorProfileContainerInsightsArgsDict',
    ...
    'ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs',
    'ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgsDict',
    'ManagedClusterSecurityProfileDefenderSecurityGatingArgs',
    'ManagedClusterSecurityProfileDefenderSecurityGatingArgsDict',
    ...
    'ManagedClusterSecurityProfileImageIntegrityArgsDict',
    'ManagedClusterSecurityProfileNodeRestrictionArgs',
    'ManagedClusterSecurityProfileNodeRestrictionArgsDict',
    ...
    'SafeguardsProfileArgs',
    'SafeguardsProfileArgsDict',
    'ScaleProfileArgs',
...
class AdvancedNetworkingObservabilityArgs:
    def __init__(__self__, *,
        ...
        """
        Observability profile to enable advanced network metrics and flow logs with historical contexts.
        :param pulumi.Input[bool] enabled: Indicates the enablement of Advanced Networking observability functionalities on clusters.
        """
...
class AdvancedNetworkingSecurityArgs:
    def __init__(__self__, *,
        ...
        """
        Security profile to enable security features on cilium based cluster.
        :param pulumi.Input[bool] enabled: This feature allows user to configure network policy based on DNS (FQDN) names. It can be enabled only on cilium based clusters. If not specified, the default is false.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class AdvancedNetworkingArgs:
    def __init__(__self__, *,
        ...
        """
        Advanced Networking profile for enabling observability and security feature suite on a cluster. For more information see aka.ms/aksadvancednetworking.
        :param pulumi.Input[bool] enabled: Indicates the enablement of Advanced Networking functionalities of observability and security on AKS clusters. When this is set to true, all observability and security features will be set to enabled unless explicitly disabled. If not specified, the default is false.
    ...
    @property
    @pulumi.getter
    def observability(self) -> Optional[pulumi.Input['AdvancedNetworkingObservabilityArgs']]:
        """
        Observability profile to enable advanced network metrics and flow logs with historical contexts.
        """
    ...
    def observability(self, value: Optional[pulumi.Input['AdvancedNetworkingObservabilityArgs']]):
    ...
    @security.setter
    def security(self, value: Optional[pulumi.Input['AdvancedNetworkingSecurityArgs']]):
...
if not MYPY:
    ...
    AgentPoolArtifactStreamingProfileArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class AgentPoolGPUProfileArgsDict(TypedDict):
        driver_type: NotRequired[pulumi.Input[Union[str, 'DriverType']]]
        """
        ...
        """
        install_gpu_driver: NotRequired[pulumi.Input[bool]]
        """
    ...
    AgentPoolGPUProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class AgentPoolGPUProfileArgs:
    def __init__(__self__, *,
                 driver_type: Optional[pulumi.Input[Union[str, 'DriverType']]] = None,
                 install_gpu_driver: Optional[pulumi.Input[bool]] = None):
        """
        :param pulumi.Input[Union[str, 'DriverType']] driver_type: Specify the type of GPU driver to install when creating Windows agent pools. If not provided, AKS selects the driver based on system compatibility. This cannot be changed once the AgentPool has been created. This cannot be set on Linux AgentPools. For Linux AgentPools, the driver is selected based on system compatibility.
        ...
        if driver_type is not None:
            pulumi.set(__self__, "driver_type", driver_type)
        if install_gpu_driver is not None:
            pulumi.set(__self__, "install_gpu_driver", install_gpu_driver)

    @property
    @pulumi.getter(name="driverType")
    def driver_type(self) -> Optional[pulumi.Input[Union[str, 'DriverType']]]:
        """
        Specify the type of GPU driver to install when creating Windows agent pools. If not provided, AKS selects the driver based on system compatibility. This cannot be changed once the AgentPool has been created. This cannot be set on Linux AgentPools. For Linux AgentPools, the driver is selected based on system compatibility.
        """
        return pulumi.get(self, "driver_type")

    @driver_type.setter
    def driver_type(self, value: Optional[pulumi.Input[Union[str, 'DriverType']]]):
        pulumi.set(self, "driver_type", value)
...
if not MYPY:
    class AgentPoolGatewayProfileArgsDict(TypedDict):
        ...
        """
        public_ip_prefix_size: NotRequired[pulumi.Input[int]]
        """
...
class AgentPoolGatewayProfileArgs:
    def __init__(__self__, *,
                 public_ip_prefix_size: Optional[pulumi.Input[int]] = None):
        """
        Profile of the managed cluster gateway agent pool.
        :param pulumi.Input[int] public_ip_prefix_size: The Gateway agent pool associates one public IPPrefix for each static egress gateway to provide public egress. The size of Public IPPrefix should be selected by the user. Each node in the agent pool is assigned with one IP from the IPPrefix. The IPPrefix size thus serves as a cap on the size of the Gateway agent pool. Due to Azure public IPPrefix size limitation, the valid value range is [28, 31] (/31 = 2 nodes/IPs, /30 = 4 nodes/IPs, /29 = 8 nodes/IPs, /28 = 16 nodes/IPs). The default value is 31.
        """
    ...
    def public_ip_prefix_size(self) -> Optional[pulumi.Input[int]]:
        """
        The Gateway agent pool associates one public IPPrefix for each static egress gateway to provide public egress. The size of Public IPPrefix should be selected by the user. Each node in the agent pool is assigned with one IP from the IPPrefix. The IPPrefix size thus serves as a cap on the size of the Gateway agent pool. Due to Azure public IPPrefix size limitation, the valid value range is [28, 31] (/31 = 2 nodes/IPs, /30 = 4 nodes/IPs, /29 = 8 nodes/IPs, /28 = 16 nodes/IPs). The default value is 31.
        """
    ...
    def public_ip_prefix_size(self, value: Optional[pulumi.Input[int]]):
...
if not MYPY:
    class AgentPoolSecurityProfileArgsDict(TypedDict):
        ...
        """
        ssh_access: NotRequired[pulumi.Input[Union[str, 'AgentPoolSSHAccess']]]
        """
...
class AgentPoolSecurityProfileArgs:
    def __init__(__self__, *,
        ...
        """
        The security settings of an agent pool.
        :param pulumi.Input[bool] enable_secure_boot: Secure Boot is a feature of Trusted Launch which ensures that only signed operating systems and drivers can boot. For more details, see aka.ms/aks/trustedlaunch.  If not specified, the default is false.
        :param pulumi.Input[bool] enable_vtpm: vTPM is a Trusted Launch feature for configuring a dedicated secure vault for keys and measurements held locally on the node. For more details, see aka.ms/aks/trustedlaunch. If not specified, the default is false.
...
if not MYPY:
    class AgentPoolUpgradeSettingsArgsDict(TypedDict):
        ...
        """
        max_blocked_nodes: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        undrainable_node_behavior: NotRequired[pulumi.Input[Union[str, 'UndrainableNodeBehavior']]]
        """
...
class AgentPoolUpgradeSettingsArgs:
    def __init__(__self__, *,
                 ...
                 max_blocked_nodes: Optional[pulumi.Input[str]] = None,
                 ...
                 undrainable_node_behavior: Optional[pulumi.Input[Union[str, 'UndrainableNodeBehavior']]] = None):
        """
        Settings for upgrading an agentpool
        ...
        :param pulumi.Input[str] max_blocked_nodes: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be greater than or equal to maxSurge. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster
        :param pulumi.Input[str] max_surge: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is 10%. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster
        ...
        :param pulumi.Input[Union[str, 'UndrainableNodeBehavior']] undrainable_node_behavior: Defines the behavior for undrainable nodes during upgrade. The most common cause of undrainable nodes is Pod Disruption Budgets (PDBs), but other issues, such as pod termination grace period is exceeding the remaining per-node drain timeout or pod is still being in a running state, can also cause undrainable nodes.
        """
        if drain_timeout_in_minutes is not None:
            pulumi.set(__self__, "drain_timeout_in_minutes", drain_timeout_in_minutes)
        if max_blocked_nodes is not None:
            pulumi.set(__self__, "max_blocked_nodes", max_blocked_nodes)
    ...
    @property
    @pulumi.getter(name="maxBlockedNodes")
    def max_blocked_nodes(self) -> Optional[pulumi.Input[str]]:
        """
        This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be greater than or equal to maxSurge. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster
        """
        return pulumi.get(self, "max_blocked_nodes")

    @max_blocked_nodes.setter
    def max_blocked_nodes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "max_blocked_nodes", value)
    ...
    def undrainable_node_behavior(self) -> Optional[pulumi.Input[Union[str, 'UndrainableNodeBehavior']]]:
        """
        Defines the behavior for undrainable nodes during upgrade. The most common cause of undrainable nodes is Pod Disruption Budgets (PDBs), but other issues, such as pod termination grace period is exceeding the remaining per-node drain timeout or pod is still being in a running state, can also cause undrainable nodes.
        """
    ...
    def undrainable_node_behavior(self, value: Optional[pulumi.Input[Union[str, 'UndrainableNodeBehavior']]]):
...
if not MYPY:
    class AutoScaleProfileArgsDict(TypedDict):
        ...
        """
        sizes: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
...
class AutoScaleProfileArgs:
    def __init__(__self__, *,
        ...
        """
        Specifications on auto-scaling.
        :param pulumi.Input[int] max_count: The maximum number of nodes of the specified sizes.
        :param pulumi.Input[int] min_count: The minimum number of nodes of the specified sizes.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] sizes: The list of allowed vm sizes e.g. ['Standard_E4s_v3', 'Standard_E16s_v3', 'Standard_D16s_v5']. AKS will use the first available one when auto scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size.
        """
...
if not MYPY:
    class ContainerServiceNetworkProfileKubeProxyConfigArgsDict(TypedDict):
        """
        ...
        """
        ipvs_config: NotRequired[pulumi.Input['ContainerServiceNetworkProfileIpvsConfigArgsDict']]
        """
        Holds configuration customizations for IPVS. May only be specified if 'mode' is set to 'IPVS'.
        """
    ...
    ContainerServiceNetworkProfileKubeProxyConfigArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ContainerServiceNetworkProfileArgsDict(TypedDict):
        ...
        """
        kube_proxy_config: NotRequired[pulumi.Input['ContainerServiceNetworkProfileKubeProxyConfigArgsDict']]
        """
        Holds configuration customizations for kube-proxy. Any values not defined will use the kube-proxy defaulting behavior. See https://v<version>.docs.kubernetes.io/docs/reference/command-line-tools-reference/kube-proxy/ where <version> is represented by a <major version>-<minor version> string. Kubernetes version 1.23 would be '1-23'.
        """
        ...
        """
        pod_link_local_access: NotRequired[pulumi.Input[Union[str, 'PodLinkLocalAccess']]]
        """
...
class ContainerServiceNetworkProfileArgs:
    def __init__(__self__, *,
                 advanced_networking: Optional[pulumi.Input['AdvancedNetworkingArgs']] = None,
                 ...
                 pod_link_local_access: Optional[pulumi.Input[Union[str, 'PodLinkLocalAccess']]] = None,
        ...
        :param pulumi.Input[Union[str, 'PodLinkLocalAccess']] pod_link_local_access: Defines access to special link local addresses (Azure Instance Metadata Service, aka IMDS) for pods with hostNetwork=false. if not specified, the default is 'IMDS'.
        ...
        :param pulumi.Input['ManagedClusterStaticEgressGatewayProfileArgs'] static_egress_gateway_profile: The profile for Static Egress Gateway addon. For more details about Static Egress Gateway, see https://aka.ms/aks/static-egress-gateway.
        """
        ...
        if pod_link_local_access is not None:
            pulumi.set(__self__, "pod_link_local_access", pod_link_local_access)
    ...
    def advanced_networking(self, value: Optional[pulumi.Input['AdvancedNetworkingArgs']]):
    ...
    @property
    @pulumi.getter(name="podLinkLocalAccess")
    def pod_link_local_access(self) -> Optional[pulumi.Input[Union[str, 'PodLinkLocalAccess']]]:
        """
        Defines access to special link local addresses (Azure Instance Metadata Service, aka IMDS) for pods with hostNetwork=false. if not specified, the default is 'IMDS'.
        """
        return pulumi.get(self, "pod_link_local_access")

    @pod_link_local_access.setter
    def pod_link_local_access(self, value: Optional[pulumi.Input[Union[str, 'PodLinkLocalAccess']]]):
        pulumi.set(self, "pod_link_local_access", value)
    ...
    def static_egress_gateway_profile(self) -> Optional[pulumi.Input['ManagedClusterStaticEgressGatewayProfileArgs']]:
        """
        The profile for Static Egress Gateway addon. For more details about Static Egress Gateway, see https://aka.ms/aks/static-egress-gateway.
        """
    ...
    def static_egress_gateway_profile(self, value: Optional[pulumi.Input['ManagedClusterStaticEgressGatewayProfileArgs']]):
...
if not MYPY:
    class IstioEgressGatewayArgsDict(TypedDict):
        ...
        """
        gateway_configuration_name: NotRequired[pulumi.Input[str]]
        """
...
class IstioEgressGatewayArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[bool],
                 name: pulumi.Input[str],
                 gateway_configuration_name: Optional[pulumi.Input[str]] = None,
                 namespace: Optional[pulumi.Input[str]] = None):
        """
        Istio egress gateway configuration.
        :param pulumi.Input[bool] enabled: Whether to enable the egress gateway.
        :param pulumi.Input[str] name: Name of the Istio add-on egress gateway.
        :param pulumi.Input[str] gateway_configuration_name: Name of the gateway configuration custom resource for the Istio add-on egress gateway. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in.
        :param pulumi.Input[str] namespace: Namespace that the Istio add-on egress gateway should be deployed in. If unspecified, the default is aks-istio-egress.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "name", name)
        if gateway_configuration_name is not None:
            pulumi.set(__self__, "gateway_configuration_name", gateway_configuration_name)
    ...
    def gateway_configuration_name(self) -> Optional[pulumi.Input[str]]:
        """
        Name of the gateway configuration custom resource for the Istio add-on egress gateway. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in.
        """
        return pulumi.get(self, "gateway_configuration_name")

    @gateway_configuration_name.setter
    def gateway_configuration_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "gateway_configuration_name", value)
...
if not MYPY:
    class KubeletConfigArgsDict(TypedDict):
        ...
        """
        seccomp_default: NotRequired[pulumi.Input[Union[str, 'SeccompDefault']]]
        """
...
class KubeletConfigArgs:
    def __init__(__self__, *,
                 ...
                 seccomp_default: Optional[pulumi.Input[Union[str, 'SeccompDefault']]] = None,
        ...
        :param pulumi.Input[Union[str, 'SeccompDefault']] seccomp_default: Specifies the default seccomp profile applied to all workloads. If not specified, 'Unconfined' will be used by default.
        ...
        if seccomp_default is not None:
            pulumi.set(__self__, "seccomp_default", seccomp_default)
    ...
    @property
    @pulumi.getter(name="seccompDefault")
    def seccomp_default(self) -> Optional[pulumi.Input[Union[str, 'SeccompDefault']]]:
        """
        Specifies the default seccomp profile applied to all workloads. If not specified, 'Unconfined' will be used by default.
        """
        return pulumi.get(self, "seccomp_default")

    @seccomp_default.setter
    def seccomp_default(self, value: Optional[pulumi.Input[Union[str, 'SeccompDefault']]]):
        pulumi.set(self, "seccomp_default", value)
...
if not MYPY:
    class ManagedClusterAPIServerAccessProfileArgsDict(TypedDict):
        ...
        """
        enable_vnet_integration: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class ManagedClusterAgentPoolProfileArgsDict(TypedDict):
        ...
        """
        artifact_streaming_profile: NotRequired[pulumi.Input['AgentPoolArtifactStreamingProfileArgsDict']]
        """
        ...
        """
        enable_custom_ca_trust: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        gpu_profile: NotRequired[pulumi.Input['AgentPoolGPUProfileArgsDict']]
        """
        ...
        """
        node_initialization_taints: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        pod_ip_allocation_mode: NotRequired[pulumi.Input[Union[str, 'PodIPAllocationMode']]]
        """
...
if not MYPY:
    class ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgsDict(TypedDict):
        """
    ...
    ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None):
        """
        Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param pulumi.Input[bool] enabled: Indicates if Application Monitoring Auto Instrumentation is enabled or not.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgsDict(TypedDict):
        """
    ...
    ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 port: Optional[pulumi.Input[float]] = None):
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param pulumi.Input[bool] enabled: Indicates if Application Monitoring Open Telemetry Logs and traces is enabled or not.
        :param pulumi.Input[float] port: The Open Telemetry host port for Open Telemetry logs and traces. If not specified, the default port is 28331.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if port is not None:
...
if not MYPY:
    class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgsDict(TypedDict):
        """
    ...
    ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgsDict: TypeAlias = Mapping[str, Any]
...
class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] port: The Open Telemetry host port for Open Telemetry metrics. If not specified, the default port is 28333.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if port is not None:
...
if not MYPY:
    class ManagedClusterAzureMonitorProfileAppMonitoringArgsDict(TypedDict):
        """
        ...
        """
        auto_instrumentation: NotRequired[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgsDict']]
        """
        Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        open_telemetry_logs: NotRequired[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgsDict']]
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        open_telemetry_metrics: NotRequired[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgsDict']]
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Metrics. Collects OpenTelemetry metrics of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
elif False:
    ManagedClusterAzureMonitorProfileAppMonitoringArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterAzureMonitorProfileAppMonitoringArgs:
    def __init__(__self__, *,
                 auto_instrumentation: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs']] = None,
                 open_telemetry_logs: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs']] = None,
                 open_telemetry_metrics: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs']] = None):
        """
        Application Monitoring Profile for Kubernetes Application Container. Collects application logs, metrics and traces through auto-instrumentation of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs'] auto_instrumentation: Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs'] open_telemetry_logs: Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs'] open_telemetry_metrics: Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Metrics. Collects OpenTelemetry metrics of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        if auto_instrumentation is not None:
            pulumi.set(__self__, "auto_instrumentation", auto_instrumentation)
        if open_telemetry_logs is not None:
            pulumi.set(__self__, "open_telemetry_logs", open_telemetry_logs)
        if open_telemetry_metrics is not None:
            pulumi.set(__self__, "open_telemetry_metrics", open_telemetry_metrics)

    @property
    @pulumi.getter(name="autoInstrumentation")
    def auto_instrumentation(self) -> Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs']]:
        """
        Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        return pulumi.get(self, "auto_instrumentation")

    @auto_instrumentation.setter
    def auto_instrumentation(self, value: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationArgs']]):
        pulumi.set(self, "auto_instrumentation", value)

    @property
    @pulumi.getter(name="openTelemetryLogs")
    def open_telemetry_logs(self) -> Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs']]:
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        return pulumi.get(self, "open_telemetry_logs")

    @open_telemetry_logs.setter
    def open_telemetry_logs(self, value: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsArgs']]):
        pulumi.set(self, "open_telemetry_logs", value)

    @property
    @pulumi.getter(name="openTelemetryMetrics")
    def open_telemetry_metrics(self) -> Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs']]:
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Metrics. Collects OpenTelemetry metrics of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        return pulumi.get(self, "open_telemetry_metrics")

    @open_telemetry_metrics.setter
    def open_telemetry_metrics(self, value: Optional[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsArgs']]):
        pulumi.set(self, "open_telemetry_metrics", value)


if not MYPY:
    class ManagedClusterAzureMonitorProfileContainerInsightsArgsDict(TypedDict):
        """
        ...
        """
        disable_custom_metrics: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        disable_prometheus_metrics_scraping: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        syslog_port: NotRequired[pulumi.Input[float]]
        """
        The syslog host port. If not specified, the default port is 28330.
        """
elif False:
    ManagedClusterAzureMonitorProfileContainerInsightsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterAzureMonitorProfileContainerInsightsArgs:
    def __init__(__self__, *,
                 disable_custom_metrics: Optional[pulumi.Input[bool]] = None,
                 disable_prometheus_metrics_scraping: Optional[pulumi.Input[bool]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 log_analytics_workspace_resource_id: Optional[pulumi.Input[str]] = None,
                 syslog_port: Optional[pulumi.Input[float]] = None):
        """
        Azure Monitor Container Insights Profile for Kubernetes Events, Inventory and Container stdout & stderr logs etc. See aka.ms/AzureMonitorContainerInsights for an overview.
        :param pulumi.Input[bool] disable_custom_metrics: Indicates whether custom metrics collection has to be disabled or not. If not specified the default is false. No custom metrics will be emitted if this field is false but the container insights enabled field is false
        :param pulumi.Input[bool] disable_prometheus_metrics_scraping: Indicates whether prometheus metrics scraping is disabled or not. If not specified the default is false. No prometheus metrics will be emitted if this field is false but the container insights enabled field is false
        ...
        :param pulumi.Input[float] syslog_port: The syslog host port. If not specified, the default port is 28330.
        """
        if disable_custom_metrics is not None:
            pulumi.set(__self__, "disable_custom_metrics", disable_custom_metrics)
        if disable_prometheus_metrics_scraping is not None:
            pulumi.set(__self__, "disable_prometheus_metrics_scraping", disable_prometheus_metrics_scraping)
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        ...
        if syslog_port is not None:
            pulumi.set(__self__, "syslog_port", syslog_port)

    @property
    @pulumi.getter(name="disableCustomMetrics")
    def disable_custom_metrics(self) -> Optional[pulumi.Input[bool]]:
        """
        Indicates whether custom metrics collection has to be disabled or not. If not specified the default is false. No custom metrics will be emitted if this field is false but the container insights enabled field is false
        """
        return pulumi.get(self, "disable_custom_metrics")

    @disable_custom_metrics.setter
    def disable_custom_metrics(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "disable_custom_metrics", value)

    @property
    @pulumi.getter(name="disablePrometheusMetricsScraping")
    def disable_prometheus_metrics_scraping(self) -> Optional[pulumi.Input[bool]]:
        """
        Indicates whether prometheus metrics scraping is disabled or not. If not specified the default is false. No prometheus metrics will be emitted if this field is false but the container insights enabled field is false
        """
        return pulumi.get(self, "disable_prometheus_metrics_scraping")

    @disable_prometheus_metrics_scraping.setter
    def disable_prometheus_metrics_scraping(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "disable_prometheus_metrics_scraping", value)
    ...
    @property
    @pulumi.getter(name="syslogPort")
    def syslog_port(self) -> Optional[pulumi.Input[float]]:
        """
        The syslog host port. If not specified, the default port is 28330.
        """
        return pulumi.get(self, "syslog_port")

    @syslog_port.setter
    def syslog_port(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "syslog_port", value)
...
if not MYPY:
    class ManagedClusterAzureMonitorProfileArgsDict(TypedDict):
        ...
        """
        app_monitoring: NotRequired[pulumi.Input['ManagedClusterAzureMonitorProfileAppMonitoringArgsDict']]
        """
        Application Monitoring Profile for Kubernetes Application Container. Collects application logs, metrics and traces through auto-instrumentation of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
        container_insights: NotRequired[pulumi.Input['ManagedClusterAzureMonitorProfileContainerInsightsArgsDict']]
        """
        Azure Monitor Container Insights Profile for Kubernetes Events, Inventory and Container stdout & stderr logs etc. See aka.ms/AzureMonitorContainerInsights for an overview.
        """
...
if not MYPY:
    class ManagedClusterBootstrapProfileArgsDict(TypedDict):
        ...
        """
        artifact_source: NotRequired[pulumi.Input[Union[str, 'ArtifactSource']]]
        """
        The source where the artifacts are downloaded from.
        """
        container_registry_id: NotRequired[pulumi.Input[str]]
        """
...
class ManagedClusterBootstrapProfileArgs:
    def __init__(__self__, *,
                 artifact_source: Optional[pulumi.Input[Union[str, 'ArtifactSource']]] = None,
                 container_registry_id: Optional[pulumi.Input[str]] = None):
        """
        The bootstrap profile.
        :param pulumi.Input[Union[str, 'ArtifactSource']] artifact_source: The source where the artifacts are downloaded from.
        :param pulumi.Input[str] container_registry_id: The resource Id of Azure Container Registry. The registry must have private network access, premium SKU and zone redundancy.
        """
    ...
    def artifact_source(self) -> Optional[pulumi.Input[Union[str, 'ArtifactSource']]]:
        """
        The source where the artifacts are downloaded from.
        """
    ...
    def artifact_source(self, value: Optional[pulumi.Input[Union[str, 'ArtifactSource']]]):
...
if not MYPY:
    class ManagedClusterIngressProfileNginxArgsDict(TypedDict):
        default_ingress_controller_type: NotRequired[pulumi.Input[Union[str, 'NginxIngressControllerType']]]
        """
...
class ManagedClusterIngressProfileNginxArgs:
    def __init__(__self__, *,
                 default_ingress_controller_type: Optional[pulumi.Input[Union[str, 'NginxIngressControllerType']]] = None):
        """
        :param pulumi.Input[Union[str, 'NginxIngressControllerType']] default_ingress_controller_type: Ingress type for the default NginxIngressController custom resource
        """
    ...
    def default_ingress_controller_type(self) -> Optional[pulumi.Input[Union[str, 'NginxIngressControllerType']]]:
        """
        Ingress type for the default NginxIngressController custom resource
        """
    ...
    def default_ingress_controller_type(self, value: Optional[pulumi.Input[Union[str, 'NginxIngressControllerType']]]):
...
class ManagedClusterIngressProfileWebAppRoutingArgs:
    ...
    @property
    @pulumi.getter
    def nginx(self) -> Optional[pulumi.Input['ManagedClusterIngressProfileNginxArgs']]:
        """
        Configuration for the default NginxIngressController. See more at https://learn.microsoft.com/en-us/azure/aks/app-routing-nginx-configuration#the-default-nginx-ingress-controller.
        """
    ...
    @nginx.setter
    def nginx(self, value: Optional[pulumi.Input['ManagedClusterIngressProfileNginxArgs']]):
...
if not MYPY:
    class ManagedClusterLoadBalancerProfileArgsDict(TypedDict):
        ...
        """
        cluster_service_load_balancer_health_probe_mode: NotRequired[pulumi.Input[Union[str, 'ClusterServiceLoadBalancerHealthProbeMode']]]
        """
...
class ManagedClusterLoadBalancerProfileArgs:
    def __init__(__self__, *,
                 ...
                 cluster_service_load_balancer_health_probe_mode: Optional[pulumi.Input[Union[str, 'ClusterServiceLoadBalancerHealthProbeMode']]] = None,
        ...
        :param pulumi.Input[Union[str, 'ClusterServiceLoadBalancerHealthProbeMode']] cluster_service_load_balancer_health_probe_mode: The health probing behavior for External Traffic Policy Cluster services.
        ...
        if cluster_service_load_balancer_health_probe_mode is None:
            cluster_service_load_balancer_health_probe_mode = 'ServiceNodePort'
        if cluster_service_load_balancer_health_probe_mode is not None:
            pulumi.set(__self__, "cluster_service_load_balancer_health_probe_mode", cluster_service_load_balancer_health_probe_mode)
    ...
    @property
    @pulumi.getter(name="clusterServiceLoadBalancerHealthProbeMode")
    def cluster_service_load_balancer_health_probe_mode(self) -> Optional[pulumi.Input[Union[str, 'ClusterServiceLoadBalancerHealthProbeMode']]]:
        """
        The health probing behavior for External Traffic Policy Cluster services.
        """
        return pulumi.get(self, "cluster_service_load_balancer_health_probe_mode")

    @cluster_service_load_balancer_health_probe_mode.setter
    def cluster_service_load_balancer_health_probe_mode(self, value: Optional[pulumi.Input[Union[str, 'ClusterServiceLoadBalancerHealthProbeMode']]]):
        pulumi.set(self, "cluster_service_load_balancer_health_probe_mode", value)
...
if not MYPY:
    class ManagedClusterNodeProvisioningProfileArgsDict(TypedDict):
        mode: NotRequired[pulumi.Input[Union[str, 'NodeProvisioningMode']]]
        """
...
if not MYPY:
    class ManagedClusterNodeResourceGroupProfileArgsDict(TypedDict):
        ...
        """
        restriction_level: NotRequired[pulumi.Input[Union[str, 'RestrictionLevel']]]
        """
...
if not MYPY:
    class ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgsDict(TypedDict):
        azure_container_registry: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        identity: NotRequired[pulumi.Input['UserAssignedIdentityArgsDict']]
        """
        The identity object used to access the registry
        """
elif False:
    ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs:
    def __init__(__self__, *,
                 azure_container_registry: Optional[pulumi.Input[str]] = None,
                 identity: Optional[pulumi.Input['UserAssignedIdentityArgs']] = None):
        """
        :param pulumi.Input[str] azure_container_registry: The container registry for which the identity will be used; the identity specified here should have a federated identity credential attached to it.
        :param pulumi.Input['UserAssignedIdentityArgs'] identity: The identity object used to access the registry
        """
    ...
    def azure_container_registry(self) -> Optional[pulumi.Input[str]]:
        """
        The container registry for which the identity will be used; the identity specified here should have a federated identity credential attached to it.
        """
    ...
    def azure_container_registry(self, value: Optional[pulumi.Input[str]]):
...
if not MYPY:
    class ManagedClusterSecurityProfileDefenderSecurityGatingArgsDict(TypedDict):
        """
        ...
        """
        allow_secret_access: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        identities: NotRequired[pulumi.Input[Sequence[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgsDict']]]]
        """
    ...
    ManagedClusterSecurityProfileDefenderSecurityGatingArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ManagedClusterSecurityProfileDefenderSecurityGatingArgs:
    def __init__(__self__, *,
                 allow_secret_access: Optional[pulumi.Input[bool]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 identities: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs']]]] = None):
        """
        Microsoft Defender settings for security gating, validates container images eligibility for deployment based on Defender for Containers security findings. Using Admission Controller, it either audits or prevents the deployment of images that do not meet security standards.
        :param pulumi.Input[bool] allow_secret_access: In use only while registry access granted by secret rather than managed identity. Set whether to grant the Defender gating agent access to the cluster's secrets for pulling images from registries. If secret access is denied and the registry requires pull secrets, the add-on will not perform any image validation. Default value is false.
        :param pulumi.Input[bool] enabled: Whether to enable Defender security gating. When enabled, the gating feature will scan container images and audit or block the deployment of images that do not meet security standards according to the configured security rules.
        :param pulumi.Input[Sequence[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs']]] identities: List of identities that the admission controller will make use of in order to pull security artifacts from the registry. These are the same identities used by the cluster to pull container images. Each identity provided should have federated identity credential attached to it.
        """
        if allow_secret_access is not None:
            pulumi.set(__self__, "allow_secret_access", allow_secret_access)
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    @property
    @pulumi.getter(name="allowSecretAccess")
    def allow_secret_access(self) -> Optional[pulumi.Input[bool]]:
        """
        In use only while registry access granted by secret rather than managed identity. Set whether to grant the Defender gating agent access to the cluster's secrets for pulling images from registries. If secret access is denied and the registry requires pull secrets, the add-on will not perform any image validation. Default value is false.
        """
        return pulumi.get(self, "allow_secret_access")

    @allow_secret_access.setter
    def allow_secret_access(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "allow_secret_access", value)
    ...
    @property
    @pulumi.getter
    def identities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs']]]]:
        """
        List of identities that the admission controller will make use of in order to pull security artifacts from the registry. These are the same identities used by the cluster to pull container images. Each identity provided should have federated identity credential attached to it.
        """
    ...
    @identities.setter
    def identities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingIdentitiesArgs']]]]):
...
if not MYPY:
    class ManagedClusterSecurityProfileDefenderArgsDict(TypedDict):
        ...
        """
        security_gating: NotRequired[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingArgsDict']]
        """
        Microsoft Defender settings for security gating, validates container images eligibility for deployment based on Defender for Containers security findings. Using Admission Controller, it either audits or prevents the deployment of images that do not meet security standards.
        """
...
class ManagedClusterSecurityProfileDefenderArgs:
    def __init__(__self__, *,
                 log_analytics_workspace_resource_id: Optional[pulumi.Input[str]] = None,
                 security_gating: Optional[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingArgs']] = None,
        ...
        if log_analytics_workspace_resource_id is not None:
            pulumi.set(__self__, "log_analytics_workspace_resource_id", log_analytics_workspace_resource_id)
        if security_gating is not None:
            pulumi.set(__self__, "security_gating", security_gating)
    ...
    @property
    @pulumi.getter(name="securityGating")
    def security_gating(self) -> Optional[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingArgs']]:
        """
        Microsoft Defender settings for security gating, validates container images eligibility for deployment based on Defender for Containers security findings. Using Admission Controller, it either audits or prevents the deployment of images that do not meet security standards.
        """
        return pulumi.get(self, "security_gating")

    @security_gating.setter
    def security_gating(self, value: Optional[pulumi.Input['ManagedClusterSecurityProfileDefenderSecurityGatingArgs']]):
        pulumi.set(self, "security_gating", value)
...
if not MYPY:
    class ManagedClusterSecurityProfileImageIntegrityArgsDict(TypedDict):
        """
    ...
    ManagedClusterSecurityProfileImageIntegrityArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ManagedClusterSecurityProfileNodeRestrictionArgsDict(TypedDict):
        """
    ...
    ManagedClusterSecurityProfileNodeRestrictionArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ManagedClusterSecurityProfileArgsDict(TypedDict):
        ...
        """
        custom_ca_trust_certificates: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        image_integrity: NotRequired[pulumi.Input['ManagedClusterSecurityProfileImageIntegrityArgsDict']]
        """
        ...
        """
        node_restriction: NotRequired[pulumi.Input['ManagedClusterSecurityProfileNodeRestrictionArgsDict']]
        """
...
class ManagedClusterSecurityProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] custom_ca_trust_certificates: A list of up to 10 base64 encoded CAs that will be added to the trust store on all nodes in the cluster. For more information see [Custom CA Trust Certificates](https://learn.microsoft.com/en-us/azure/aks/custom-certificate-authority).
...
class ManagedClusterStaticEgressGatewayProfileArgs:
    def __init__(__self__, *,
        ...
        """
        The Static Egress Gateway addon configuration for the cluster.
        :param pulumi.Input[bool] enabled: Indicates if Static Egress Gateway addon is enabled or not.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerArgsDict(TypedDict):
        ...
        """
        addon_autoscaling: NotRequired[pulumi.Input[Union[str, 'AddonAutoscaling']]]
        """
...
class ManualScaleProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] os_disk_size_gb: OS Disk Size in GB to be used to specify the disk size for every machine in the master/agent pool. If you specify 0, it will apply the default osDisk size according to the vmSize specified.
        :param pulumi.Input[Union[str, 'OSDiskType']] os_disk_type: The default is 'Ephemeral' if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] sizes: The list of allowed vm sizes e.g. ['Standard_E4s_v3', 'Standard_E16s_v3', 'Standard_D16s_v5']. AKS will use the first available one when scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if os_disk_size_gb is not None:
...
if not MYPY:
    class SafeguardsProfileArgsDict(TypedDict):
        """
    ...
    SafeguardsProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class SafeguardsProfileArgs:
    def __init__(__self__, *,
                 level: pulumi.Input[Union[str, 'Level']],
        ...
        """
        The Safeguards profile.
        :param pulumi.Input[Union[str, 'Level']] level: The Safeguards level to be used. By default, Safeguards is enabled for all namespaces except those that AKS excludes via systemExcludedNamespaces
        :param pulumi.Input[Sequence[pulumi.Input[str]]] excluded_namespaces: List of namespaces excluded from Safeguards checks
...
if not MYPY:
    class ScaleProfileArgsDict(TypedDict):
        ...
        """
        autoscale: NotRequired[pulumi.Input[Sequence[pulumi.Input['AutoScaleProfileArgsDict']]]]
        """
...
class ScaleProfileArgs:
    def __init__(__self__, *,
                 autoscale: Optional[pulumi.Input[Sequence[pulumi.Input['AutoScaleProfileArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def autoscale(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AutoScaleProfileArgs']]]]:
        """
        Specifications on how to auto-scale the VirtualMachines agent pool within a predefined size range. Currently, at most one AutoScaleProfile is allowed.
        """
    ...
    @autoscale.setter
    def autoscale(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AutoScaleProfileArgs']]]]):
