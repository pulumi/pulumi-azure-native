...
__all__ = [
    ...
    'ManagedClusterSecurityProfileDefenderSecurityGatingResponse',
    'ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities',
...
class AgentPoolStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 provisioning_error: 'outputs.CloudErrorBodyResponse'):
        """
        Contains read-only information about the Agent Pool.
        :param 'CloudErrorBodyResponse' provisioning_error: Preserves the detailed info of failure. If there was no error, this field is omitted.
        """
        pulumi.set(__self__, "provisioning_error", provisioning_error)

    @property
    @pulumi.getter(name="provisioningError")
    def provisioning_error(self) -> 'outputs.CloudErrorBodyResponse':
        """
...
class AgentPoolUpgradeSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "maxBlockedNodes":
            suggest = "max_blocked_nodes"
        elif key == "maxSurge":
            suggest = "max_surge"
    ...
    def __init__(__self__, *,
        ...
        :param str max_blocked_nodes: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be greater than or equal to maxSurge. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster
        :param str max_surge: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is 10%. For more information, including best practices, see: https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster
    ...
    def max_blocked_nodes(self) -> Optional[str]:
        """
...
class IstioEgressGatewayResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "gatewayConfigurationName":
            suggest = "gateway_configuration_name"
    ...
    def __init__(__self__, *,
        ...
        :param str name: Name of the Istio add-on egress gateway.
        :param str gateway_configuration_name: Name of the gateway configuration custom resource for the Istio add-on egress gateway. Must be specified when enabling the Istio egress gateway. Must be deployed in the same namespace that the Istio egress gateway will be deployed in.
        :param str namespace: Namespace that the Istio add-on egress gateway should be deployed in. If unspecified, the default is aks-istio-egress.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "name", name)
    ...
    def gateway_configuration_name(self) -> Optional[str]:
        """
...
class KubeletConfigResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "seccompDefault":
            suggest = "seccomp_default"
    ...
    def __init__(__self__, *,
                 ...
                 seccomp_default: Optional[str] = None,
        ...
        :param str seccomp_default: Specifies the default seccomp profile applied to all workloads. If not specified, 'Unconfined' will be used by default.
    ...
    def seccomp_default(self) -> Optional[str]:
        """
...
class ManagedClusterSecurityProfileDefenderResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "logAnalyticsWorkspaceResourceId":
            suggest = "log_analytics_workspace_resource_id"
        elif key == "securityGating":
            suggest = "security_gating"
    ...
    def __init__(__self__, *,
                 log_analytics_workspace_resource_id: Optional[str] = None,
                 security_gating: Optional['outputs.ManagedClusterSecurityProfileDefenderSecurityGatingResponse'] = None,
    ...
    def security_gating(self) -> Optional['outputs.ManagedClusterSecurityProfileDefenderSecurityGatingResponse']:
        """
...
@pulumi.output_type
class ManagedClusterSecurityProfileDefenderSecurityGatingResponse(dict):
    """
    Microsoft Defender settings for security gating, validates container images eligibility for deployment based on Defender for Containers security findings. Using Admission Controller, it either audits or prevents the deployment of images that do not meet security standards.
    """
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "allowSecretAccess":
            suggest = "allow_secret_access"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedClusterSecurityProfileDefenderSecurityGatingResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedClusterSecurityProfileDefenderSecurityGatingResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[bool] = None,
                 identities: Optional[Sequence['outputs.ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities']] = None):
        """
        Microsoft Defender settings for security gating, validates container images eligibility for deployment based on Defender for Containers security findings. Using Admission Controller, it either audits or prevents the deployment of images that do not meet security standards.
        :param bool allow_secret_access: In use only while registry access granted by secret rather than managed identity. Set whether to grant the Defender gating agent access to the cluster's secrets for pulling images from registries. If secret access is denied and the registry requires pull secrets, the add-on will not perform any image validation. Default value is false.
        :param bool enabled: Whether to enable Defender security gating. When enabled, the gating feature will scan container images and audit or block the deployment of images that do not meet security standards according to the configured security rules.
        :param Sequence['ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities'] identities: List of identities that the admission controller will make use of in order to pull security artifacts from the registry. These are the same identities used by the cluster to pull container images. Each identity provided should have federated identity credential attached to it.
        """
    ...
    def allow_secret_access(self) -> Optional[bool]:
        """
    ...
    @property
    @pulumi.getter
    def identities(self) -> Optional[Sequence['outputs.ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities']]:
        """
...
@pulumi.output_type
class ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "azureContainerRegistry":
            suggest = "azure_container_registry"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedClusterSecurityProfileDefenderSecurityGatingResponseIdentities.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param str azure_container_registry: The container registry for which the identity will be used; the identity specified here should have a federated identity credential attached to it.
        :param 'UserAssignedIdentityResponse' identity: The identity object used to access the registry
        """
    ...
    def azure_container_registry(self) -> Optional[str]:
        """
...
class ManagedClusterSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] custom_ca_trust_certificates: A list of up to 10 base64 encoded CAs that will be added to the trust store on all nodes in the cluster. For more information see [Custom CA Trust Certificates](https://learn.microsoft.com/en-us/azure/aks/custom-certificate-authority).
...
class ManualScaleProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManualScaleProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManualScaleProfileResponse.__key_warning(key)
        return super().__getitem__(key)
