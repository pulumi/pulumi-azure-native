...
class NodeCustomizationArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['NodeCustomizationPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['NodeCustomizationPropertiesArgs']]):
...
class NodeCustomization(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['NodeCustomizationPropertiesArgs', 'NodeCustomizationPropertiesArgsDict']]] = None,
