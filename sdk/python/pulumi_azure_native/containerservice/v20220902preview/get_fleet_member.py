...
class GetFleetMemberResult:
    ...
    """
    def __init__(__self__, cluster_resource_id=None, e_tag=None, id=None, name=None, provisioning_state=None, system_data=None, type=None):
...
def get_fleet_member_output(fleet_member_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20220902preview:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult)
