...
def get_fleet(fleet_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fleet is deprecated: azure-native:containerservice/v20220902preview:Fleet is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230315preview:Fleet to guarantee forwards compatibility.""")
    __args__ = dict()
