...
def list_fleet_credentials(fleet_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20220902preview:listFleetCredentials', __args__, opts=opts, typ=ListFleetCredentialsResult).value
...
def list_fleet_credentials_output(fleet_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20220902preview:listFleetCredentials', __args__, opts=opts, typ=ListFleetCredentialsResult)
