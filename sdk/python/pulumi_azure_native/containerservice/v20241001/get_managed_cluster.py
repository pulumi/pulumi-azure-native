...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20241001:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
...
def get_managed_cluster_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20241001:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult)
