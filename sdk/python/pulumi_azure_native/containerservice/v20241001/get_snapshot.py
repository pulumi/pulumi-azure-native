...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20241001:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
...
def get_snapshot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20241001:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult)
