...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(api_server_access_profile, ManagedClusterAPIServerAccessProfileArgs):
            ...
            if not isinstance(auto_scaler_profile, ManagedClusterPropertiesAutoScalerProfileArgs):
            ...
            if not isinstance(auto_upgrade_profile, ManagedClusterAutoUpgradeProfileArgs):
            ...
            if not isinstance(azure_monitor_profile, ManagedClusterAzureMonitorProfileArgs):
            ...
            if not isinstance(http_proxy_config, ManagedClusterHTTPProxyConfigArgs):
            ...
            if not isinstance(oidc_issuer_profile, ManagedClusterOIDCIssuerProfileArgs):
            ...
            if not isinstance(pod_identity_profile, ManagedClusterPodIdentityProfileArgs):
            ...
            if not isinstance(security_profile, ManagedClusterSecurityProfileArgs):
            ...
            if not isinstance(sku, ManagedClusterSKUArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                ManagedClusterSKUArgs._configure(_setter, **sku)
            __props__.__dict__["sku"] = sku
            if not isinstance(storage_profile, ManagedClusterStorageProfileArgs):
            ...
            if not isinstance(workload_auto_scaler_profile, ManagedClusterWorkloadAutoScalerProfileArgs):
