...
class ManagedClusterPropertiesResponseAutoScalerProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        ManagedClusterPropertiesResponseAutoScalerProfile._configure(
            ...
            daemonset_eviction_for_empty_nodes=daemonset_eviction_for_empty_nodes,
            daemonset_eviction_for_occupied_nodes=daemonset_eviction_for_occupied_nodes,
            expander=expander,
            expanders=expanders,
    ...
    def _configure(
        ...
        if daemonset_eviction_for_empty_nodes is None and 'daemonsetEvictionForEmptyNodes' in kwargs:
            daemonset_eviction_for_empty_nodes = kwargs['daemonsetEvictionForEmptyNodes']
        if daemonset_eviction_for_occupied_nodes is None and 'daemonsetEvictionForOccupiedNodes' in kwargs:
            daemonset_eviction_for_occupied_nodes = kwargs['daemonsetEvictionForOccupiedNodes']
        if ignore_daemonsets_utilization is None and 'ignoreDaemonsetsUtilization' in kwargs:
        ...
        if daemonset_eviction_for_empty_nodes is not None:
            _setter("daemonset_eviction_for_empty_nodes", daemonset_eviction_for_empty_nodes)
        if daemonset_eviction_for_occupied_nodes is not None:
            _setter("daemonset_eviction_for_occupied_nodes", daemonset_eviction_for_occupied_nodes)
...
class ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            enabled=enabled,
            addon_autoscaling=addon_autoscaling,
        )
    @staticmethod
    def _configure(
             _setter: Callable[[Any, Any], None],
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if addon_autoscaling is None and 'addonAutoscaling' in kwargs:
            addon_autoscaling = kwargs['addonAutoscaling']
        ...
        if addon_autoscaling is not None:
            _setter("addon_autoscaling", addon_autoscaling)
