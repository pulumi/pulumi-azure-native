...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 fqdn_subdomain: Optional[pulumi.Input[str]] = None,
                 guardrails_profile: Optional[pulumi.Input[Union['GuardrailsProfileArgs', 'GuardrailsProfileArgsDict']]] = None,
        ...
        :param pulumi.Input[str] fqdn_subdomain: This cannot be updated once the Managed Cluster has been created.
        :param pulumi.Input[Union['GuardrailsProfileArgs', 'GuardrailsProfileArgsDict']] guardrails_profile: The guardrails profile holds all the guardrails information for a given cluster
