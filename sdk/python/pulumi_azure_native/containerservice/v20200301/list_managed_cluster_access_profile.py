...
def list_managed_cluster_access_profile(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20200301:listManagedClusterAccessProfile', __args__, opts=opts, typ=ListManagedClusterAccessProfileResult).value
...
def list_managed_cluster_access_profile_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['roleName'] = role_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20200301:listManagedClusterAccessProfile', __args__, opts=opts, typ=ListManagedClusterAccessProfileResult)
