...
warnings.warn("""azure-native:containerservice/v20200301:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20210501:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 windows_profile: Optional[pulumi.Input[pulumi.InputType['ManagedClusterWindowsProfileArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedCluster is deprecated: azure-native:containerservice/v20200301:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20210501:ManagedCluster to guarantee forwards compatibility.""")
