...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.containerservice.v20230202preview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="privateendpointconnection1",
            private_link_service_connection_state=azure_native.containerservice.v20230202preview.PrivateLinkServiceConnectionStateArgs(
                status="Approved",
            ),
        ...
        ```sh
        $ pulumi import azure-native:containerservice/v20230202preview:PrivateEndpointConnection privateendpointconnection1 /subscriptions/subid1/resourceGroups/rg1/providers/Microsoft.ContainerService/managedCluster/clustername1/privateEndpointConnections/privateendpointconnection1 
        ```
