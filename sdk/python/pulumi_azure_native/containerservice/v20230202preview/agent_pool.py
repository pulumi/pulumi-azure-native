...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent_pool = azure_native.containerservice.v20230202preview.AgentPool("agentPool",
        ...
        agent_pool = azure_native.containerservice.v20230202preview.AgentPool("agentPool",
            ...
            kubelet_config=azure_native.containerservice.v20230202preview.KubeletConfigArgs(
            ...
            linux_os_config=azure_native.containerservice.v20230202preview.LinuxOSConfigResponseArgs(
                swap_file_size_mb=1500,
                sysctls=azure_native.containerservice.v20230202preview.SysctlConfigArgs(
        ...
        agent_pool = azure_native.containerservice.v20230202preview.AgentPool("agentPool",
            ...
            resource_name_="clustername1",
            vm_size="Standard_D4s_v3",
            windows_profile=azure_native.containerservice.v20230202preview.AgentPoolWindowsProfileArgs(
        ...
        agent_pool = azure_native.containerservice.v20230202preview.AgentPool("agentPool",
            agent_pool_name="agentpool1",
            power_state=azure_native.containerservice.v20230202preview.PowerStateArgs(
                code="Running",
            ),
            resource_group_name="rg1",
            resource_name_="clustername1")
