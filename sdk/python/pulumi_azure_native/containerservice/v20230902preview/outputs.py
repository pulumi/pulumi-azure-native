...
class ManagedClusterPropertiesResponseAutoScalerProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expanders: Optional[Sequence[str]] = None,
        ...
        :param Sequence[str] expanders: Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured, they will be considered in the order in which they are listed, with the first one being considered first.
    ...
    @property
    @pulumi.getter
    def expanders(self) -> Optional[Sequence[str]]:
        """
