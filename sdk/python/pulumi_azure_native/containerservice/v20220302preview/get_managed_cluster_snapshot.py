...
def get_managed_cluster_snapshot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20220302preview:getManagedClusterSnapshot', __args__, opts=opts, typ=GetManagedClusterSnapshotResult)
