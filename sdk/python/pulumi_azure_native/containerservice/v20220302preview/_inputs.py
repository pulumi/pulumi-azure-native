...
if not MYPY:
    class ManagedClusterAgentPoolProfileArgsDict(TypedDict):
        ...
        """
        current_orchestrator_version: NotRequired[pulumi.Input[str]]
        """
...
class ManagedClusterAgentPoolProfileArgs:
    def __init__(__self__, *,
                 ...
                 current_orchestrator_version: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] current_orchestrator_version: If orchestratorVersion was a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion was <major.minor>, this field will contain the full <major.minor.patch> version being used.
        ...
        if current_orchestrator_version is not None:
    ...
    def current_orchestrator_version(self) -> Optional[pulumi.Input[str]]:
        """
        If orchestratorVersion was a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion was <major.minor>, this field will contain the full <major.minor.patch> version being used.
        """
        return pulumi.get(self, "current_orchestrator_version")

    @current_orchestrator_version.setter
    def current_orchestrator_version(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "current_orchestrator_version", value)
