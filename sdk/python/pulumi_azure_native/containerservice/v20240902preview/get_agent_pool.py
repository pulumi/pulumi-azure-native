...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20240902preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20240902preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
