...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent_pool = azure_native.containerservice.v20190201.AgentPool("agentPool",
