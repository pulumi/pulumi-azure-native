...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_agent_pool is deprecated: Version 2019-02-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['agentPoolName'] = agent_pool_name
    __args__['managedClusterName'] = managed_cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20190201:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
