...
class GetUpdateRunResult:
    ...
    def update_strategy_id(self) -> Optional[builtins.str]:
        """
...
def get_update_run(fleet_name: Optional[builtins.str] = None,
    ...
    :param builtins.str update_run_name: The name of the UpdateRun resource.
    """
    __args__ = dict()
...
def get_update_run_output(fleet_name: Optional[pulumi.Input[builtins.str]] = None,
