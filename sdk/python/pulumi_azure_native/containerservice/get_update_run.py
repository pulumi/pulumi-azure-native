...
def get_update_run(fleet_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str update_run_name: The name of the UpdateRun resource.
    """
    __args__ = dict()
...
def get_update_run_output(fleet_name: Optional[pulumi.Input[_builtins.str]] = None,
