...
class ManagedClusterSnapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_cluster_snapshot = azure_native.containerservice.v20230102preview.ManagedClusterSnapshot("managedClusterSnapshot",
            creation_data=azure_native.containerservice.v20230102preview.CreationDataArgs(
