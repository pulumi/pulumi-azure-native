...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        snapshot = azure_native.containerservice.v20230102preview.Snapshot("snapshot",
