...
warnings.warn("""azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""", DeprecationWarning)
...
class TrustedAccessRoleBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trusted_access_role_binding_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TrustedAccessRoleBinding is deprecated: azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""")
