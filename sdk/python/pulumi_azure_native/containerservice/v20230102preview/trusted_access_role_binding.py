...
class TrustedAccessRoleBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        trusted_access_role_binding = azure_native.containerservice.v20230102preview.TrustedAccessRoleBinding("trustedAccessRoleBinding",
