...
def get_managed_cluster_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20230102preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult)
    return __ret__.apply(lambda __response__: GetManagedClusterResult(
        ...
        guardrails_profile=pulumi.get(__response__, 'guardrails_profile'),
