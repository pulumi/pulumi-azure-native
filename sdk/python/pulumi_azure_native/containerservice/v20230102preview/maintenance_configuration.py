...
class MaintenanceConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        maintenance_configuration = azure_native.containerservice.v20230102preview.MaintenanceConfiguration("maintenanceConfiguration",
            config_name="default",
            not_allowed_time=[azure_native.containerservice.v20230102preview.TimeSpanArgs(
                end="2020-11-30T12:00:00Z",
                start="2020-11-26T03:00:00Z",
            )],
            resource_group_name="rg1",
            resource_name_="clustername1",
            time_in_week=[azure_native.containerservice.v20230102preview.TimeInWeekArgs(
                day="Monday",
                hour_slots=[
                    1,
                    2,
        ...
        maintenance_configuration = azure_native.containerservice.v20230102preview.MaintenanceConfiguration("maintenanceConfiguration",
            ...
            maintenance_window=azure_native.containerservice.v20230102preview.MaintenanceWindowResponseArgs(
                duration_hours=10,
                not_allowed_dates=[
                    azure_native.containerservice.v20230102preview.DateSpanArgs(
                        end="2023-02-25",
                        start="2023-02-18",
                    ),
                    azure_native.containerservice.v20230102preview.DateSpanArgs(
                ...
                schedule=azure_native.containerservice.v20230102preview.ScheduleArgs(
                    relative_monthly=azure_native.containerservice.v20230102preview.RelativeMonthlyScheduleArgs(
                        day_of_week="Monday",
                        interval_months=3,
                        week_index="First",
                    ),
        ...
        ```sh
        $ pulumi import azure-native:containerservice/v20230102preview:MaintenanceConfiguration aksManagedAutoUpgradeSchedule /subscriptions/subid1/resourcegroups/rg1/providers/Microsoft.ContainerService/managedClusters/clustername1/maintenanceConfigurations/default 
        ```
