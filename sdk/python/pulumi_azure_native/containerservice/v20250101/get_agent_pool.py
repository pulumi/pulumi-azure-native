...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20250101:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20250101:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
    return __ret__.apply(lambda __response__: GetAgentPoolResult(
        ...
        gpu_profile=pulumi.get(__response__, 'gpu_profile'),
