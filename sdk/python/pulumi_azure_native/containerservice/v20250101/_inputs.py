...
if not MYPY:
    class GPUProfileArgsDict(TypedDict):
        ...
        """
        driver: NotRequired[pulumi.Input[Union[str, 'GPUDriver']]]
        """
...
class GPUProfileArgs:
    def __init__(__self__, *,
                 driver: Optional[pulumi.Input[Union[str, 'GPUDriver']]] = None):
        """
        GPU settings for the Agent Pool.
        :param pulumi.Input[Union[str, 'GPUDriver']] driver: Whether to install GPU drivers. When it's not specified, default is Install.
        """
    ...
    @property
    @pulumi.getter
    def driver(self) -> Optional[pulumi.Input[Union[str, 'GPUDriver']]]:
        """
        Whether to install GPU drivers. When it's not specified, default is Install.
        """
    ...
    @driver.setter
    def driver(self, value: Optional[pulumi.Input[Union[str, 'GPUDriver']]]):
