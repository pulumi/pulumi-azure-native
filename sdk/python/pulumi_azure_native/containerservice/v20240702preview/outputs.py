...
__all__ = [
    ...
    'AdvancedNetworkingFQDNPolicyResponse',
...
@pulumi.output_type
class AdvancedNetworkingFQDNPolicyResponse(dict):
    """
...
class AdvancedNetworkingObservabilityResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "tlsManagement":
            suggest = "tls_management"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AdvancedNetworkingObservabilityResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AdvancedNetworkingObservabilityResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 enabled: Optional[bool] = None,
                 tls_management: Optional[str] = None):
        """
        Observability profile to enable advanced network metrics and flow logs with historical contexts.
        :param bool enabled: Indicates the enablement of Advanced Networking observability functionalities on clusters.
        :param str tls_management: Management of TLS certificates for querying network flow logs via the flow log endpoint for Advanced Networking observability clusters. If not specified, the default is Managed. For more information see aka.ms/acnstls.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def tls_management(self) -> Optional[str]:
        """
...
class AdvancedNetworkingSecurityResponse(dict):
    ...
    def __init__(__self__, *,
                 fqdn_policy: Optional['outputs.AdvancedNetworkingFQDNPolicyResponse'] = None):
        """
        Security profile to enable security features on cilium based cluster.
        :param 'AdvancedNetworkingFQDNPolicyResponse' fqdn_policy: FQDNFiltering profile to enable FQDN Policy filtering on cilium based cluster.
        """
    ...
    def fqdn_policy(self) -> Optional['outputs.AdvancedNetworkingFQDNPolicyResponse']:
        """
        FQDNFiltering profile to enable FQDN Policy filtering on cilium based cluster.
        """
...
class ManagedClusterIngressProfileNginxResponse(dict):
    ...
    def __init__(__self__, *,
                 default_ingress_controller_type: Optional[str] = None):
        """
        :param str default_ingress_controller_type: Ingress type for the default NginxIngressController custom resource
        """
    ...
    def default_ingress_controller_type(self) -> Optional[str]:
        """
