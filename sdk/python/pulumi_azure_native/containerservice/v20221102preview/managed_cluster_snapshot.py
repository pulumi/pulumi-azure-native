...
warnings.warn("""azure-native:containerservice/v20221102preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.""", DeprecationWarning)
