...
def get_managed_cluster_snapshot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster_snapshot is deprecated: azure-native:containerservice/v20221102preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.""")
    __args__ = dict()
