...
def list_fleet_credentials(fleet_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20230615preview:listFleetCredentials', __args__, opts=opts, typ=ListFleetCredentialsResult).value
...
def list_fleet_credentials_output(fleet_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20230615preview:listFleetCredentials', __args__, opts=opts, typ=ListFleetCredentialsResult)
