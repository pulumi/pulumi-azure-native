...
warnings.warn("""azure-native:containerservice/v20221101:MaintenanceConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:MaintenanceConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class MaintenanceConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_in_week: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TimeInWeekArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""MaintenanceConfiguration is deprecated: azure-native:containerservice/v20221101:MaintenanceConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:MaintenanceConfiguration to guarantee forwards compatibility.""")
