...
warnings.warn("""azure-native:containerservice/v20221101:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_agent_pool is deprecated: azure-native:containerservice/v20221101:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility.""")
    __args__ = dict()
