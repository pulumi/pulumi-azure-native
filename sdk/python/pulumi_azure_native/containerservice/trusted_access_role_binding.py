...
class TrustedAccessRoleBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A list of roles to bind, each item is a resource type qualified role name. For example: 'Microsoft.MachineLearningServices/workspaces/reader'.
        :param pulumi.Input[builtins.str] source_resource_id: The ARM resource ID of source resource that trusted access is configured for.
        :param pulumi.Input[builtins.str] trusted_access_role_binding_name: The name of trusted access role binding.
        """
    ...
    def trusted_access_role_binding_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trusted_access_role_binding_name(self, value: Optional[pulumi.Input[builtins.str]]):
