...
warnings.warn("""azure-native:containerservice/v20220802preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_trusted_access_role_binding(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_trusted_access_role_binding is deprecated: azure-native:containerservice/v20220802preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""")
    __args__ = dict()
