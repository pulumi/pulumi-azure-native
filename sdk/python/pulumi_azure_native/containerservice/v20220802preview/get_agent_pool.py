...
warnings.warn("""azure-native:containerservice/v20220802preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:AgentPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_agent_pool is deprecated: azure-native:containerservice/v20220802preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:AgentPool to guarantee forwards compatibility.""")
    __args__ = dict()
