...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ManagedClusterWorkloadAutoScalerProfileArgs', 'ManagedClusterWorkloadAutoScalerProfileArgsDict']] workload_auto_scaler_profile: Workload Auto-scaler profile for the container service cluster.
        """
        ...
    @overload
    def __init__(__self__,
