...
warnings.warn("""azure-native:containerservice/v20220301:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ManagedCluster, __self__).__init__(
            'azure-native:containerservice/v20220301:ManagedCluster',
            resource_name,
            __props__,
            opts)
