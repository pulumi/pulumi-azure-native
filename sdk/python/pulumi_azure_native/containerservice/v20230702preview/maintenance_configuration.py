...
class MaintenanceConfigurationArgs:
    ...
    def _configure(
        ...
        if 'notAllowedTime' in kwargs:
            not_allowed_time = kwargs['notAllowedTime']
        if 'timeInWeek' in kwargs:
