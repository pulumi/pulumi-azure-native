...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(guardrails_profile, GuardrailsProfileArgs):
            ...
            if not isinstance(ingress_profile, ManagedClusterIngressProfileArgs):
            ...
            if not isinstance(metrics_profile, ManagedClusterMetricsProfileArgs):
            ...
            if not isinstance(node_resource_group_profile, ManagedClusterNodeResourceGroupProfileArgs):
            ...
            if not isinstance(service_mesh_profile, ServiceMeshProfileArgs):
