...
def get_load_balancer(load_balancer_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20240302preview:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
...
def get_load_balancer_output(load_balancer_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20240302preview:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult)
