...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_agent_pool is deprecated: azure-native:containerservice/v20220201:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.""")
    __args__ = dict()
