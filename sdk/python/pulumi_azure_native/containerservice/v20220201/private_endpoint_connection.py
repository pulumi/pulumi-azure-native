...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:containerservice/v20220201:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:containerservice/v20220201:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
