...
__all__ = ['ManagedNamespaceArgs', 'ManagedNamespace']
...
class ManagedNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 managed_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] managed_namespace_name: The name of the managed namespace.
    ...
    def managed_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:containerservice:ManagedNamespace")
class ManagedNamespace(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagedNamespaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20250302preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250402preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250502preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250602preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250702preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250802preview:ManagedNamespace"), pulumi.Alias(type_="azure-native:containerservice/v20250901:ManagedNamespace")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ManagedNamespace':
        """
        ...
        __props__.__dict__["type"] = None
        return ManagedNamespace(resource_name, opts=opts, __props__=__props__)
