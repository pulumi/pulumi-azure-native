...
def list_managed_cluster_admin_credentials(resource_group_name: Optional[_builtins.str] = None,
...
def list_managed_cluster_admin_credentials_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
