...
class ManualScaleProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] sizes: The list of allowed vm sizes. AKS will use the first available one when scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
