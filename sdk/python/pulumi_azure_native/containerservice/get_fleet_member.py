...
def get_fleet_member(fleet_member_name: Optional[builtins.str] = None,
    ...
    :param builtins.str fleet_member_name: The name of the Fleet member resource.
...
def get_fleet_member_output(fleet_member_name: Optional[pulumi.Input[builtins.str]] = None,
