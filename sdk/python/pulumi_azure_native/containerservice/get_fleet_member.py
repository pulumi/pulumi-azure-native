...
class GetFleetMemberResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, cluster_resource_id=None, e_tag=None, group=None, id=None, name=None, provisioning_state=None, system_data=None, type=None):
...
def get_fleet_member(fleet_member_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fleet_member_name: The name of the Fleet member resource.
...
def get_fleet_member_output(fleet_member_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult)
