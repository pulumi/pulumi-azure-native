...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent_pool = azure_native.containerservice.v20220402preview.AgentPool("agentPool",
        ...
        agent_pool = azure_native.containerservice.v20220402preview.AgentPool("agentPool",
            agent_pool_name="agentpool1",
            count=3,
            creation_data=azure_native.containerservice.v20220402preview.CreationDataArgs(
        ...
        agent_pool = azure_native.containerservice.v20220402preview.AgentPool("agentPool",
            ...
            kubelet_config=azure_native.containerservice.v20220402preview.KubeletConfigArgs(
            ...
            linux_os_config=azure_native.containerservice.v20220402preview.LinuxOSConfigResponseArgs(
                swap_file_size_mb=1500,
                sysctls=azure_native.containerservice.v20220402preview.SysctlConfigArgs(
        ...
        agent_pool = azure_native.containerservice.v20220402preview.AgentPool("agentPool",
            agent_pool_name="agentpool1",
            power_state=azure_native.containerservice.v20220402preview.PowerStateArgs(
                code="Running",
            ),
            resource_group_name="rg1",
            resource_name_="clustername1")
