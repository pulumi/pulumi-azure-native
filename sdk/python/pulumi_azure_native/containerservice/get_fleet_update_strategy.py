...
class GetFleetUpdateStrategyResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, e_tag=None, id=None, name=None, provisioning_state=None, strategy=None, system_data=None, type=None):
...
def get_fleet_update_strategy(fleet_name: Optional[builtins.str] = None,
                              resource_group_name: Optional[builtins.str] = None,
                              update_strategy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str update_strategy_name: The name of the UpdateStrategy resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice:getFleetUpdateStrategy', __args__, opts=opts, typ=GetFleetUpdateStrategyResult).value
...
def get_fleet_update_strategy_output(fleet_name: Optional[pulumi.Input[builtins.str]] = None,
                                     resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                     update_strategy_name: Optional[pulumi.Input[builtins.str]] = None,
