...
class OpenShiftManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(auth_profile, OpenShiftManagedClusterAuthProfileArgs):
            ...
            if not isinstance(master_pool_profile, OpenShiftManagedClusterMasterPoolProfileArgs):
            ...
            if not isinstance(monitor_profile, OpenShiftManagedClusterMonitorProfileArgs):
            ...
            if not isinstance(plan, PurchasePlanArgs):
                plan = plan or {}
                def _setter(key, value):
                    plan[key] = value
