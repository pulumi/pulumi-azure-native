...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_runtime: Optional[pulumi.Input[Union[str, 'WorkloadRuntime']]] = None,
                 __props__=None):
        pulumi.log.warn("""AgentPool is deprecated: azure-native:containerservice/v20220702preview:AgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:AgentPool to guarantee forwards compatibility.""")
