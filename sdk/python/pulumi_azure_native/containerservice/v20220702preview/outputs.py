...
class ManagedClusterAgentPoolProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool enable_custom_ca_trust: When set to true, AKS deploys a daemonset and host services to sync custom certificate authorities from a user-provided config map into node trust stores. Defaults to false.
...
class ManagedClusterSecurityProfileImageCleanerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ImageCleaner removes unused images from nodes, freeing up disk space and helping to reduce attack surface area. Here are settings for the security profile.
        :param bool enabled: Whether to enable ImageCleaner on AKS cluster.
        :param int interval_hours: ImageCleaner scanning interval.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ManagedClusterSecurityProfileImageCleanerResponse' image_cleaner: ImageCleaner settings for the security profile.
        ...
        :param 'ManagedClusterSecurityProfileWorkloadIdentityResponse' workload_identity: [Workload Identity](https://azure.github.io/azure-workload-identity/docs/) settings for the security profile.
        """
