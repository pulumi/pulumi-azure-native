...
def get_fleet_member(fleet_member_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fleet_member is deprecated: azure-native:containerservice/v20220702preview:FleetMember is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220902preview:FleetMember to guarantee forwards compatibility.""")
    __args__ = dict()
