...
def get_container_service(container_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_service is deprecated: Version v20160930 will be removed in the next major version of the provider. Upgrade to version v20190430 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20160930:getContainerService', __args__, opts=opts, typ=GetContainerServiceResult).value
