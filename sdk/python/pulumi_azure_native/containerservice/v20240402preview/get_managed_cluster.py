...
class GetManagedClusterResult:
    ...
    Managed cluster.
    """
    def __init__(__self__, aad_profile=None, addon_profiles=None, agent_pool_profiles=None, ai_toolchain_operator_profile=None, api_server_access_profile=None, auto_scaler_profile=None, auto_upgrade_profile=None, azure_monitor_profile=None, azure_portal_fqdn=None, bootstrap_profile=None, creation_data=None, current_kubernetes_version=None, disable_local_accounts=None, disk_encryption_set_id=None, dns_prefix=None, e_tag=None, enable_namespace_resources=None, enable_pod_security_policy=None, enable_rbac=None, extended_location=None, fqdn=None, fqdn_subdomain=None, http_proxy_config=None, id=None, identity=None, identity_profile=None, ingress_profile=None, kind=None, kubernetes_version=None, linux_profile=None, location=None, max_agent_pools=None, metrics_profile=None, name=None, network_profile=None, node_provisioning_profile=None, node_resource_group=None, node_resource_group_profile=None, oidc_issuer_profile=None, pod_identity_profile=None, power_state=None, private_fqdn=None, private_link_resources=None, provisioning_state=None, public_network_access=None, resource_uid=None, safeguards_profile=None, security_profile=None, service_mesh_profile=None, service_principal_profile=None, sku=None, storage_profile=None, support_plan=None, system_data=None, tags=None, type=None, upgrade_settings=None, windows_profile=None, workload_auto_scaler_profile=None):
        ...
        if safeguards_profile and not isinstance(safeguards_profile, dict):
            raise TypeError("Expected argument 'safeguards_profile' to be a dict")
        pulumi.set(__self__, "safeguards_profile", safeguards_profile)
    ...
    @property
    @pulumi.getter(name="safeguardsProfile")
    def safeguards_profile(self) -> Optional['outputs.SafeguardsProfileResponse']:
        """
        The Safeguards profile holds all the safeguards information for a given cluster
        """
        return pulumi.get(self, "safeguards_profile")
...
class AwaitableGetManagedClusterResult(GetManagedClusterResult):
    ...
    def __await__(self):
        ...
        return GetManagedClusterResult(
            ...
            safeguards_profile=self.safeguards_profile,
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20240402preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
    ...
    return AwaitableGetManagedClusterResult(
        ...
        safeguards_profile=pulumi.get(__ret__, 'safeguards_profile'),
