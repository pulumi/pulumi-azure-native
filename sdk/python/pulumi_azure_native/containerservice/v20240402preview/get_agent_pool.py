...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20240402preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20240402preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
    return __ret__.apply(lambda __response__: GetAgentPoolResult(
        artifact_streaming_profile=pulumi.get(__response__, 'artifact_streaming_profile'),
        ...
        gateway_profile=pulumi.get(__response__, 'gateway_profile'),
        ...
        node_initialization_taints=pulumi.get(__response__, 'node_initialization_taints'),
        ...
        pod_ip_allocation_mode=pulumi.get(__response__, 'pod_ip_allocation_mode'),
        ...
        virtual_machine_nodes_status=pulumi.get(__response__, 'virtual_machine_nodes_status'),
        virtual_machines_profile=pulumi.get(__response__, 'virtual_machines_profile'),
