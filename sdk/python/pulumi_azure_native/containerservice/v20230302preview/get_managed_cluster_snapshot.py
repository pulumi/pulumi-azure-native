...
def get_managed_cluster_snapshot(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20230302preview:getManagedClusterSnapshot', __args__, opts=opts, typ=GetManagedClusterSnapshotResult).value
...
def get_managed_cluster_snapshot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20230302preview:getManagedClusterSnapshot', __args__, opts=opts, typ=GetManagedClusterSnapshotResult)
