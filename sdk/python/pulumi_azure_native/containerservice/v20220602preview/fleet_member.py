...
warnings.warn("""azure-native:containerservice/v20220602preview:FleetMember is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220702preview:FleetMember to guarantee forwards compatibility.""", DeprecationWarning)
...
class FleetMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FleetMember is deprecated: azure-native:containerservice/v20220602preview:FleetMember is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220702preview:FleetMember to guarantee forwards compatibility.""")
