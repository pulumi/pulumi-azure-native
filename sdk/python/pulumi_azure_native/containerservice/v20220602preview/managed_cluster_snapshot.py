...
warnings.warn("""azure-native:containerservice/v20220602preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedClusterSnapshot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedClusterSnapshot is deprecated: azure-native:containerservice/v20220602preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedClusterSnapshot to guarantee forwards compatibility.""")
