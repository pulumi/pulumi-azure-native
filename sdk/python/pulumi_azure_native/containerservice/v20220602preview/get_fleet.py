...
def get_fleet(fleet_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fleet is deprecated: azure-native:containerservice/v20220602preview:Fleet is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220902preview:Fleet to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['fleetName'] = fleet_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20220602preview:getFleet', __args__, opts=opts, typ=GetFleetResult).value
