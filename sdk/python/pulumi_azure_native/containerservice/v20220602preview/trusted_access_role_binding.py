...
warnings.warn("""azure-native:containerservice/v20220602preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""", DeprecationWarning)
...
class TrustedAccessRoleBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(TrustedAccessRoleBinding, __self__).__init__(
            'azure-native:containerservice/v20220602preview:TrustedAccessRoleBinding',
            resource_name,
            __props__,
            opts)
