...
warnings.warn("""azure-native:containerservice/v20220602preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetManagedClusterResult:
    ...
    Managed cluster.
    """
    def __init__(__self__, aad_profile=None, addon_profiles=None, agent_pool_profiles=None, api_server_access_profile=None, auto_scaler_profile=None, auto_upgrade_profile=None, azure_portal_fqdn=None, creation_data=None, current_kubernetes_version=None, disable_local_accounts=None, disk_encryption_set_id=None, dns_prefix=None, enable_namespace_resources=None, enable_pod_security_policy=None, enable_rbac=None, extended_location=None, fqdn=None, fqdn_subdomain=None, http_proxy_config=None, id=None, identity=None, identity_profile=None, ingress_profile=None, kubernetes_version=None, linux_profile=None, location=None, max_agent_pools=None, name=None, network_profile=None, node_resource_group=None, oidc_issuer_profile=None, pod_identity_profile=None, power_state=None, private_fqdn=None, private_link_resources=None, provisioning_state=None, public_network_access=None, security_profile=None, service_principal_profile=None, sku=None, storage_profile=None, system_data=None, tags=None, type=None, windows_profile=None, workload_auto_scaler_profile=None):
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster is deprecated: azure-native:containerservice/v20220602preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20220602preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
    ...
    return AwaitableGetManagedClusterResult(
        ...
        current_kubernetes_version=__ret__.current_kubernetes_version,
        ...
        enable_namespace_resources=__ret__.enable_namespace_resources,
        ...
        ingress_profile=__ret__.ingress_profile,
        ...
        oidc_issuer_profile=__ret__.oidc_issuer_profile,
        ...
        workload_auto_scaler_profile=__ret__.workload_auto_scaler_profile)
