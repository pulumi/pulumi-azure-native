...
class UpdateRunArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] update_run_name: The name of the UpdateRun resource.
        :param pulumi.Input[builtins.str] update_strategy_id: The resource id of the FleetUpdateStrategy resource to reference.
