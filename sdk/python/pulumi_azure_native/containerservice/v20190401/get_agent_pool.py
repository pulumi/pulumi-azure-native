...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_agent_pool is deprecated: Version v20190401 will be removed in the next major version of the provider. Upgrade to version v20190430 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20190401:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
