...
class FleetManagedNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['FleetManagedNamespacePropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['FleetManagedNamespacePropertiesArgs']]):
...
class FleetManagedNamespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 managed_namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['FleetManagedNamespacePropertiesArgs', 'FleetManagedNamespacePropertiesArgsDict']]] = None,
