...
def list_managed_cluster_user_credentials(format: Optional[_builtins.str] = None,
    ...
    :param _builtins.str format: Only apply to AAD clusters, specifies the format of returned kubeconfig. Format 'azure' will return azure auth-provider kubeconfig; format 'exec' will return exec format kubeconfig, which requires kubelogin binary in the path.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str resource_name: The name of the managed cluster resource.
    :param _builtins.str server_fqdn: server fqdn type for credentials to be returned
    """
    __args__ = dict()
