...
class JWTAuthenticator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] jwt_authenticator_name: The name of the JWT authenticator.
        :param pulumi.Input[Union['JWTAuthenticatorPropertiesArgs', 'JWTAuthenticatorPropertiesArgsDict']] properties: The properties of JWTAuthenticator. For details on how to configure the properties of a JWT authenticator, please refer to the Kubernetes documentation: https://kubernetes.io/docs/reference/access-authn-authz/authentication/#using-authentication-configuration. Please note that not all fields available in the Kubernetes documentation are supported by AKS. For troubleshooting, please see https://aka.ms/aks-external-issuers-docs.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20250702preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20250802preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20250902preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20251002preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20260102preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20260202preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20260302preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20260402preview:JWTAuthenticator"), pulumi.Alias(type_="azure-native:containerservice/v20260502preview:JWTAuthenticator")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'JWTAuthenticator':
        """
