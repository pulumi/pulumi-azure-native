...
class AutoUpgradeProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20240502preview:AutoUpgradeProfile"), pulumi.Alias(type_="azure-native:containerservice/v20250301:AutoUpgradeProfile"), pulumi.Alias(type_="azure-native:containerservice/v20250401preview:AutoUpgradeProfile")])
