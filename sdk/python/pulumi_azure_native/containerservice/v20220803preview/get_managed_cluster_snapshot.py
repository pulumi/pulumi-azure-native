...
warnings.warn("""azure-native:containerservice/v20220803preview:ManagedClusterSnapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:ManagedClusterSnapshot to guarantee forwards compatibility.""", DeprecationWarning)
