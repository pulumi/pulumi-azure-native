...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster is deprecated: azure-native:containerservice/v20200101:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20210501:ManagedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
