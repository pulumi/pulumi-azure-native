...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 primary_agent_pool_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 resource_name: pulumi.Input[builtins.str],
                 allow_service_placement: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def primary_agent_pool_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def primary_agent_pool_name(self, value: pulumi.Input[builtins.str]):
    ...
    def allow_service_placement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_service_placement(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 primary_agent_pool_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20240302preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240402preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240502preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240602preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240702preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240902preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20241002preview:LoadBalancer")])
    ...
    @property
    @pulumi.getter(name="allowServicePlacement")
    def allow_service_placement(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to automatically place services on the load balancer. If not supplied, the default value is true. If set to false manually, both of the external and the internal load balancer will not be selected for services unless they explicitly target it.
        """
        return pulumi.get(self, "allow_service_placement")
    ...
    @property
    @pulumi.getter(name="primaryAgentPoolName")
    def primary_agent_pool_name(self) -> pulumi.Output[builtins.str]:
        """
        Required field. A string value that must specify the ID of an existing agent pool. All nodes in the given pool will always be added to this load balancer. This agent pool must have at least one node and minCount>=1 for autoscaling operations. An agent pool can only be the primary pool for a single load balancer.
        """
        return pulumi.get(self, "primary_agent_pool_name")
