...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20240302preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240402preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240502preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240602preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240702preview:LoadBalancer"), pulumi.Alias(type_="azure-native:containerservice/v20240902preview:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240302preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240402preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240502preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240602preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240702preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20240902preview:containerservice:LoadBalancer"), pulumi.Alias(type_="azure-native_containerservice_v20241002preview:containerservice:LoadBalancer")])
