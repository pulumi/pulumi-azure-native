...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        snapshot = azure_native.containerservice.v20230201.Snapshot("snapshot",
            creation_data=azure_native.containerservice.v20230201.CreationDataArgs(
