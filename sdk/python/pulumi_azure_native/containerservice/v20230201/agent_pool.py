...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent_pool = azure_native.containerservice.v20230201.AgentPool("agentPool",
        ...
        agent_pool = azure_native.containerservice.v20230201.AgentPool("agentPool",
            ...
            kubelet_config=azure_native.containerservice.v20230201.KubeletConfigArgs(
            ...
            linux_os_config=azure_native.containerservice.v20230201.LinuxOSConfigResponseArgs(
                swap_file_size_mb=1500,
                sysctls=azure_native.containerservice.v20230201.SysctlConfigArgs(
        ...
        agent_pool = azure_native.containerservice.v20230201.AgentPool("agentPool",
            agent_pool_name="agentpool1",
            power_state=azure_native.containerservice.v20230201.PowerStateArgs(
                code="Running",
            ),
            resource_group_name="rg1",
            resource_name_="clustername1")
