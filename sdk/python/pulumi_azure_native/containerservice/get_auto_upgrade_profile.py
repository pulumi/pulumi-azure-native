...
def get_auto_upgrade_profile(auto_upgrade_profile_name: Optional[_builtins.str] = None,
...
def get_auto_upgrade_profile_output(auto_upgrade_profile_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
