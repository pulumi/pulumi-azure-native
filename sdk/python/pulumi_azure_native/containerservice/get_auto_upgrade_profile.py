...
def get_auto_upgrade_profile(auto_upgrade_profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str auto_upgrade_profile_name: The name of the AutoUpgradeProfile resource.
...
def get_auto_upgrade_profile_output(auto_upgrade_profile_name: Optional[pulumi.Input[builtins.str]] = None,
