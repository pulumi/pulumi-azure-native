...
class UpdateRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(managed_cluster_update, ManagedClusterUpdateArgs):
            ...
            if not isinstance(strategy, UpdateRunStrategyArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20230615preview:UpdateRun")])
