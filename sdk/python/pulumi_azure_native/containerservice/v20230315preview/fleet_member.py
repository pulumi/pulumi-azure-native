...
class FleetMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20220902preview:FleetMember")])
