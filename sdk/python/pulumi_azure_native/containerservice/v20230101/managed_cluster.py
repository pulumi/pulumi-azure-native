...
warnings.warn("""azure-native:containerservice/v20230101:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_auto_scaler_profile: Optional[pulumi.Input[pulumi.InputType['ManagedClusterWorkloadAutoScalerProfileArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedCluster is deprecated: azure-native:containerservice/v20230101:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:ManagedCluster to guarantee forwards compatibility.""")
