...
warnings.warn("""azure-native:containerservice/v20230101:MaintenanceConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:MaintenanceConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_maintenance_configuration(config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_maintenance_configuration is deprecated: azure-native:containerservice/v20230101:MaintenanceConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:MaintenanceConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
