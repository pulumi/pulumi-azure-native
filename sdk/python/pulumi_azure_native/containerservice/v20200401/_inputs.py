...
__all__ = [
    ...
    'ManagedClusterPropertiesIdentityProfileArgsDict',
...
if not MYPY:
    class ManagedClusterPropertiesIdentityProfileArgsDict(TypedDict):
    ...
    ManagedClusterPropertiesIdentityProfileArgsDict: TypeAlias = Mapping[str, Any]
