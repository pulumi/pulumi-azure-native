...
warnings.warn("""azure-native:containerservice/v20200401:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.""", DeprecationWarning)
...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vnet_subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AgentPool is deprecated: azure-native:containerservice/v20200401:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20200601:AgentPool to guarantee forwards compatibility.""")
