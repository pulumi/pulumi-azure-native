...
def get_maintenance_configuration(config_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20241002preview:getMaintenanceConfiguration', __args__, opts=opts, typ=GetMaintenanceConfigurationResult).value
...
def get_maintenance_configuration_output(config_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20241002preview:getMaintenanceConfiguration', __args__, opts=opts, typ=GetMaintenanceConfigurationResult)
