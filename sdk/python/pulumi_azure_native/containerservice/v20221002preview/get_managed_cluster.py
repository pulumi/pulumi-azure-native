...
warnings.warn("""azure-native:containerservice/v20221002preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster is deprecated: azure-native:containerservice/v20221002preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230102preview:ManagedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20221002preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
