...
warnings.warn("""azure-native:containerservice/v20221002preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""", DeprecationWarning)
...
class TrustedAccessRoleBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trusted_access_role_binding_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TrustedAccessRoleBinding is deprecated: azure-native:containerservice/v20221002preview:TrustedAccessRoleBinding is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:TrustedAccessRoleBinding to guarantee forwards compatibility.""")
