...
class ContainerServiceNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ebpf_dataplane: Optional[str] = None,
        ...
        :param str ebpf_dataplane: The eBPF dataplane used for building the Kubernetes network.
    ...
    def ebpf_dataplane(self) -> Optional[str]:
        """
