...
warnings.warn("""azure-native:containerservice/v20221002preview:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:Snapshot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot is deprecated: azure-native:containerservice/v20221002preview:Snapshot is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20230502preview:Snapshot to guarantee forwards compatibility.""")
    __args__ = dict()
