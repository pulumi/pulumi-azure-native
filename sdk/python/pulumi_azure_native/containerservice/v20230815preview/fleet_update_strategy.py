...
class FleetUpdateStrategyArgs:
    ...
    def _configure(
        ...
        if update_strategy_name is None and 'updateStrategyName' in kwargs:
            update_strategy_name = kwargs['updateStrategyName']
...
class FleetUpdateStrategy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] fleet_name: The name of the Fleet resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[pulumi.InputType['UpdateRunStrategyArgs']] strategy: Defines the update sequence of the clusters.
        :param pulumi.Input[str] update_strategy_name: The name of the UpdateStrategy resource.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:FleetUpdateStrategy"), pulumi.Alias(type_="azure-native:containerservice/v20231015:FleetUpdateStrategy")])
