...
class FleetUpdateStrategy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:FleetUpdateStrategy"), pulumi.Alias(type_="azure-native:containerservice/v20231015:FleetUpdateStrategy"), pulumi.Alias(type_="azure-native:containerservice/v20240202preview:FleetUpdateStrategy")])
