...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(kubelet_config, KubeletConfigArgs):
            ...
            if not isinstance(linux_os_config, LinuxOSConfigArgs):
            ...
            if not isinstance(network_profile, AgentPoolNetworkProfileArgs):
            ...
            if not isinstance(power_state, PowerStateArgs):
            ...
            if not isinstance(security_profile, AgentPoolSecurityProfileArgs):
                security_profile = security_profile or {}
                def _setter(key, value):
                    security_profile[key] = value
                AgentPoolSecurityProfileArgs._configure(_setter, **security_profile)
            __props__.__dict__["security_profile"] = security_profile
            __props__.__dict__["spot_max_price"] = spot_max_price
            __props__.__dict__["tags"] = tags
            __props__.__dict__["type"] = type
            if not isinstance(upgrade_settings, AgentPoolUpgradeSettingsArgs):
            ...
            if not isinstance(windows_profile, AgentPoolWindowsProfileArgs):
