...
def get_fleet_update_strategy_output(fleet_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['updateStrategyName'] = update_strategy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20240502preview:getFleetUpdateStrategy', __args__, opts=opts, typ=GetFleetUpdateStrategyResult)
