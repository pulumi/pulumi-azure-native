...
__all__ = [
    ...
    'ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationResponse',
    'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsResponse',
...
class AdvancedNetworkingObservabilityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Observability profile to enable advanced network metrics and flow logs with historical contexts.
        :param bool enabled: Indicates the enablement of Advanced Networking observability functionalities on clusters.
        """
...
class AgentPoolArtifactStreamingProfileResponse(dict):
    def __init__(__self__, *,
                 enabled: Optional[bool] = None):
        """
        :param bool enabled: Artifact streaming speeds up the cold-start of containers on a node through on-demand image loading. To use this feature, container images must also enable artifact streaming on ACR. If not specified, the default is false.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
@pulumi.output_type
class AgentPoolGPUProfileResponse(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "installGPUDriver":
            suggest = "install_gpu_driver"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AgentPoolGPUProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AgentPoolGPUProfileResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param bool install_gpu_driver: The default value is true when the vmSize of the agent pool contains a GPU, false otherwise. GPU Driver Installation can only be set true when VM has an associated GPU resource. Setting this field to false prevents automatic GPU driver installation. In that case, in order for the GPU to be usable, the user must perform GPU driver installation themselves.
        """
...
class AgentPoolGatewayProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile of the managed cluster gateway agent pool.
        :param int public_ip_prefix_size: The Gateway agent pool associates one public IPPrefix for each static egress gateway to provide public egress. The size of Public IPPrefix should be selected by the user. Each node in the agent pool is assigned with one IP from the IPPrefix. The IPPrefix size thus serves as a cap on the size of the Gateway agent pool. Due to Azure public IPPrefix size limitation, the valid value range is [28, 31] (/31 = 2 nodes/IPs, /30 = 4 nodes/IPs, /29 = 8 nodes/IPs, /28 = 16 nodes/IPs). The default value is 31.
        """
    ...
    def public_ip_prefix_size(self) -> Optional[int]:
        """
...
class AgentPoolSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The security settings of an agent pool.
        :param bool enable_secure_boot: Secure Boot is a feature of Trusted Launch which ensures that only signed operating systems and drivers can boot. For more details, see aka.ms/aks/trustedlaunch.  If not specified, the default is false.
        :param bool enable_vtpm: vTPM is a Trusted Launch feature for configuring a dedicated secure vault for keys and measurements held locally on the node. For more details, see aka.ms/aks/trustedlaunch. If not specified, the default is false.
...
class AgentPoolUpgradeSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 undrainable_node_behavior: Optional[str] = None):
        """
        Settings for upgrading an agentpool
        ...
        :param int node_soak_duration_in_minutes: The amount of time (in minutes) to wait after draining a node and before reimaging it and moving on to next node. If not specified, the default is 0 minutes.
        :param str undrainable_node_behavior: Defines the behavior for undrainable nodes during upgrade. The most common cause of undrainable nodes is Pod Disruption Budgets (PDBs), but other issues, such as pod termination grace period is exceeding the remaining per-node drain timeout or pod is still being in a running state, can also cause undrainable nodes.
        """
    ...
    def undrainable_node_behavior(self) -> Optional[str]:
        """
        Defines the behavior for undrainable nodes during upgrade. The most common cause of undrainable nodes is Pod Disruption Budgets (PDBs), but other issues, such as pod termination grace period is exceeding the remaining per-node drain timeout or pod is still being in a running state, can also cause undrainable nodes.
        """
...
class AutoScaleProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifications on auto-scaling.
        :param int max_count: The maximum number of nodes of the specified sizes.
        :param int min_count: The minimum number of nodes of the specified sizes.
        :param Sequence[str] sizes: The list of allowed vm sizes e.g. ['Standard_E4s_v3', 'Standard_E16s_v3', 'Standard_D16s_v5']. AKS will use the first available one when auto scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size.
        """
...
class ContainerServiceNetworkProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "advancedNetworking":
            ...
            suggest = "pod_cidrs"
        elif key == "podLinkLocalAccess":
            suggest = "pod_link_local_access"
    ...
    def __init__(__self__, *,
                 ...
                 pod_link_local_access: Optional[str] = None,
        ...
        :param str pod_link_local_access: Defines access to special link local addresses (Azure Instance Metadata Service, aka IMDS) for pods with hostNetwork=false. if not specified, the default is 'IMDS'.
    ...
    def pod_link_local_access(self) -> Optional[str]:
        """
...
class ManagedClusterAIToolchainOperatorProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        When enabling the operator, a set of AKS managed CRDs and controllers will be installed in the cluster. The operator automates the deployment of OSS models for inference and/or training purposes. It provides a set of preset models and enables distributed inference against them.
        :param bool enabled: Indicates if AI toolchain operator  enabled or not.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterAgentPoolProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "artifactStreamingProfile":
            suggest = "artifact_streaming_profile"
        ...
        elif key == "nodeInitializationTaints":
            suggest = "node_initialization_taints"
        elif key == "nodeLabels":
            suggest = "node_labels"
    ...
    def __init__(__self__, *,
                 ...
                 artifact_streaming_profile: Optional['outputs.AgentPoolArtifactStreamingProfileResponse'] = None,
                 ...
                 gpu_profile: Optional['outputs.AgentPoolGPUProfileResponse'] = None,
                 ...
                 node_initialization_taints: Optional[Sequence[str]] = None,
                 ...
                 pod_ip_allocation_mode: Optional[str] = None,
        ...
        :param str e_tag: Unique read-only string used to implement optimistic concurrency. The eTag value will change when the resource is updated. Specify an if-match or if-none-match header with the eTag value for a subsequent request to enable optimistic concurrency per the normal etag convention.
        ...
        :param 'AgentPoolArtifactStreamingProfileResponse' artifact_streaming_profile: Configuration for using artifact streaming on AKS.
        ...
        :param 'AgentPoolGPUProfileResponse' gpu_profile: The GPU settings of an agent pool.
        ...
        :param str pod_ip_allocation_mode: The IP allocation mode for pods in the agent pool. Must be used with podSubnetId. The default is 'DynamicIndividual'.
...
@pulumi.output_type
class ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param bool enabled: Indicates if Application Monitoring Auto Instrumentation is enabled or not.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
@pulumi.output_type
class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param bool enabled: Indicates if Application Monitoring Open Telemetry Logs and traces is enabled or not.
        :param float port: The Open Telemetry host port for Open Telemetry logs and traces. If not specified, the default port is 28331.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if port is not None:
...
class ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float port: The Open Telemetry host port for Open Telemetry metrics. If not specified, the default port is 28333.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if port is not None:
...
class ManagedClusterAzureMonitorProfileAppMonitoringResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "autoInstrumentation":
            suggest = "auto_instrumentation"
        elif key == "openTelemetryLogs":
            suggest = "open_telemetry_logs"
        elif key == "openTelemetryMetrics":
            suggest = "open_telemetry_metrics"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedClusterAzureMonitorProfileAppMonitoringResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedClusterAzureMonitorProfileAppMonitoringResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 auto_instrumentation: Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationResponse'] = None,
                 open_telemetry_logs: Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsResponse'] = None,
                 open_telemetry_metrics: Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsResponse'] = None):
        """
        Application Monitoring Profile for Kubernetes Application Container. Collects application logs, metrics and traces through auto-instrumentation of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param 'ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationResponse' auto_instrumentation: Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        :param 'ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsResponse' open_telemetry_logs: Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
    ...
    def auto_instrumentation(self) -> Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentationResponse']:
        """
        Application Monitoring Auto Instrumentation for Kubernetes Application Container. Deploys web hook to auto-instrument Azure Monitor OpenTelemetry based SDKs to collect OpenTelemetry metrics, logs and traces of the application. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
    ...
    def open_telemetry_logs(self) -> Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryLogsResponse']:
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Logs and Traces. Collects OpenTelemetry logs and traces of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
    ...
    def open_telemetry_metrics(self) -> Optional['outputs.ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetricsResponse']:
        """
        Application Monitoring Open Telemetry Metrics Profile for Kubernetes Application Container Metrics. Collects OpenTelemetry metrics of the application using Azure Monitor OpenTelemetry based SDKs. See aka.ms/AzureMonitorApplicationMonitoring for an overview.
        """
...
class ManagedClusterAzureMonitorProfileContainerInsightsResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "disableCustomMetrics":
            suggest = "disable_custom_metrics"
        elif key == "disablePrometheusMetricsScraping":
            suggest = "disable_prometheus_metrics_scraping"
    ...
    def __init__(__self__, *,
                 ...
                 syslog_port: Optional[float] = None):
        """
        Azure Monitor Container Insights Profile for Kubernetes Events, Inventory and Container stdout & stderr logs etc. See aka.ms/AzureMonitorContainerInsights for an overview.
        :param bool disable_custom_metrics: Indicates whether custom metrics collection has to be disabled or not. If not specified the default is false. No custom metrics will be emitted if this field is false but the container insights enabled field is false
        :param bool disable_prometheus_metrics_scraping: Indicates whether prometheus metrics scraping is disabled or not. If not specified the default is false. No prometheus metrics will be emitted if this field is false but the container insights enabled field is false
        ...
        :param float syslog_port: The syslog host port. If not specified, the default port is 28330.
        """
    ...
    def disable_custom_metrics(self) -> Optional[bool]:
        """
    ...
    def disable_prometheus_metrics_scraping(self) -> Optional[bool]:
        """
    ...
    def syslog_port(self) -> Optional[float]:
        """
...
class ManagedClusterAzureMonitorProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedClusterAzureMonitorProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedClusterAzureMonitorProfileResponse.__key_warning(key)
        return super().__getitem__(key)
...
class ManagedClusterBootstrapProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The bootstrap profile.
        :param str artifact_source: The source where the artifacts are downloaded from.
        :param str container_registry_id: The resource Id of Azure Container Registry. The registry must have private network access, premium SKU and zone redundancy.
        """
    ...
    def artifact_source(self) -> Optional[str]:
        """
...
class ManagedClusterHTTPProxyConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "effective_no_proxy", effective_no_proxy)
...
class ManagedClusterLoadBalancerProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "clusterServiceLoadBalancerHealthProbeMode":
            suggest = "cluster_service_load_balancer_health_probe_mode"
    ...
    def __init__(__self__, *,
                 ...
                 cluster_service_load_balancer_health_probe_mode: Optional[str] = None,
        ...
        :param str cluster_service_load_balancer_health_probe_mode: The health probing behavior for External Traffic Policy Cluster services.
    ...
    def cluster_service_load_balancer_health_probe_mode(self) -> Optional[str]:
        """
...
class ManagedClusterNodeProvisioningProfileResponse(dict):
    def __init__(__self__, *,
                 mode: Optional[str] = None):
        """
        :param str mode: Once the mode it set to Auto, it cannot be changed back to Manual.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
...
class ManagedClusterPropertiesResponseAutoScalerProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool daemonset_eviction_for_empty_nodes: If set to true, all daemonset pods on empty nodes will be evicted before deletion of the node. If the daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be deleted without ensuring that daemonset pods are deleted or evicted.
        :param bool daemonset_eviction_for_occupied_nodes: If set to true, all daemonset pods on occupied nodes will be evicted before deletion of the node. If the daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be deleted without ensuring that daemonset pods are deleted or evicted.
        :param str expander: Available values are: 'least-waste', 'most-pods', 'priority', 'random'.
        :param bool ignore_daemonsets_utilization: If set to true, the resources used by daemonset will be taken into account when making scaling down decisions.
    ...
    def daemonset_eviction_for_empty_nodes(self) -> Optional[bool]:
        """
    ...
    def daemonset_eviction_for_occupied_nodes(self) -> Optional[bool]:
        """
...
class ManagedClusterStaticEgressGatewayProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Static Egress Gateway addon configuration for the cluster.
        :param bool enabled: Indicates if Static Egress Gateway addon is enabled or not.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "addonAutoscaling":
            suggest = "addon_autoscaling"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 enabled: Optional[bool] = None,
                 addon_autoscaling: Optional[str] = None):
        """
        :param bool enabled: Whether to enable VPA add-on in cluster. Default value is false.
        :param str addon_autoscaling: Whether VPA add-on is enabled and configured to scale AKS-managed add-ons.
        """
        if enabled is None:
            enabled = False
        pulumi.set(__self__, "enabled", enabled)
    ...
    def addon_autoscaling(self) -> Optional[str]:
        """
...
class ManualScaleProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] sizes: The list of allowed vm sizes e.g. ['Standard_E4s_v3', 'Standard_E16s_v3', 'Standard_D16s_v5']. AKS will use the first available one when scaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS will use the next size.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if sizes is not None:
...
@pulumi.output_type
class SafeguardsProfileResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SafeguardsProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SafeguardsProfileResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The Safeguards profile.
        :param str level: The Safeguards level to be used. By default, Safeguards is enabled for all namespaces except those that AKS excludes via systemExcludedNamespaces
        :param Sequence[str] system_excluded_namespaces: List of namespaces specified by AKS to be excluded from Safeguards
        :param Sequence[str] excluded_namespaces: List of namespaces excluded from Safeguards checks
...
class ScaleProfileResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 autoscale: Optional[Sequence['outputs.AutoScaleProfileResponse']] = None,
    ...
    @property
    @pulumi.getter
    def autoscale(self) -> Optional[Sequence['outputs.AutoScaleProfileResponse']]:
        """
...
class VirtualMachineNodesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Current status on a group of nodes of the same vm size.
        :param int count: Number of nodes.
        :param str size: The VM size of the agents used to host this group of nodes.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if size is not None:
