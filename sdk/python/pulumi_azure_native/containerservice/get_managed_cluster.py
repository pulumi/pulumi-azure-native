...
class GetManagedClusterResult:
    ...
    def identity_profile(self) -> Optional[Mapping[str, 'outputs.UserAssignedIdentityManagedClusterResponse']]:
        """
...
def get_managed_cluster(resource_group_name: Optional[_builtins.str] = None,
