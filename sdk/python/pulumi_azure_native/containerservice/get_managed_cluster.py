...
class GetManagedClusterResult:
    ...
    def azure_portal_fqdn(self) -> builtins.str:
        """
    ...
    def disable_local_accounts(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_pod_security_policy(self) -> Optional[builtins.bool]:
        """
    ...
    def fqdn_subdomain(self) -> Optional[builtins.str]:
        """
        This cannot be updated once the Managed Cluster has been created.
        """
    ...
    def max_agent_pools(self) -> builtins.int:
        """
    ...
    def resource_uid(self) -> builtins.str:
        """
    ...
    def support_plan(self) -> Optional[builtins.str]:
        """
...
def get_managed_cluster(resource_group_name: Optional[builtins.str] = None,
...
def get_managed_cluster_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult)
