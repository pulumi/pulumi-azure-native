...
class ManagedClusterArgs:
    def __init__(__self__, *,
                 ...
                 disable_local_accounts: Optional[pulumi.Input[builtins.bool]] = None,
                 disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 dns_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 enable_pod_security_policy: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_rbac: Optional[pulumi.Input[builtins.bool]] = None,
                 extended_location: Optional[pulumi.Input['ExtendedLocationArgs']] = None,
                 fqdn_subdomain: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 support_plan: Optional[pulumi.Input[Union[builtins.str, 'KubernetesSupportPlan']]] = None,
        ...
        :param pulumi.Input[builtins.bool] disable_local_accounts: If set to true, getting static credentials will be disabled for this cluster. This must only be used on Managed Clusters that are AAD enabled. For more details see [disable local accounts](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts-preview).
        :param pulumi.Input[builtins.str] disk_encryption_set_id: This is of the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/diskEncryptionSets/{encryptionSetName}'
        :param pulumi.Input[builtins.str] dns_prefix: This cannot be updated once the Managed Cluster has been created.
        :param pulumi.Input[builtins.bool] enable_pod_security_policy: (DEPRECATED) Whether to enable Kubernetes pod security policy (preview). PodSecurityPolicy was deprecated in Kubernetes v1.21, and removed from Kubernetes in v1.25. Learn more at https://aka.ms/k8s/psp and https://aka.ms/aks/psp.
        :param pulumi.Input[builtins.bool] enable_rbac: Whether to enable Kubernetes Role-Based Access Control.
        :param pulumi.Input['ExtendedLocationArgs'] extended_location: The extended location of the Virtual Machine.
        :param pulumi.Input[builtins.str] fqdn_subdomain: This cannot be updated once the Managed Cluster has been created.
        ...
        :param pulumi.Input[builtins.str] kubernetes_version: Both patch version <major.minor.patch> (e.g. 1.20.13) and <major.minor> (e.g. 1.20) are supported. When <major.minor> is specified, the latest supported GA patch version is chosen automatically. Updating the cluster with the same <major.minor> once it has been created (e.g. 1.14.x -> 1.14) will not trigger an upgrade, even if a newer patch version is available. When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be performed sequentially by major version number. For example, upgrades between 1.14.x -> 1.15.x or 1.15.x -> 1.16.x are allowed, however 1.14.x -> 1.16.x is not allowed. See [upgrading an AKS cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details.
        ...
        :param pulumi.Input[builtins.str] node_resource_group: The name of the resource group containing agent pool nodes.
        ...
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Allow or deny public network access for AKS
        ...
        :param pulumi.Input[Union[builtins.str, 'KubernetesSupportPlan']] support_plan: The support plan for the Managed Cluster. If unspecified, the default is 'KubernetesOfficial'.
    ...
    def disable_local_accounts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_local_accounts(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_pod_security_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_pod_security_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def fqdn_subdomain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This cannot be updated once the Managed Cluster has been created.
        """
    ...
    def fqdn_subdomain(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def support_plan(self) -> Optional[pulumi.Input[Union[builtins.str, 'KubernetesSupportPlan']]]:
        """
    ...
    @support_plan.setter
    def support_plan(self, value: Optional[pulumi.Input[Union[builtins.str, 'KubernetesSupportPlan']]]):
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def azure_portal_fqdn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def current_kubernetes_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="disableLocalAccounts")
    def disable_local_accounts(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to true, getting static credentials will be disabled for this cluster. This must only be used on Managed Clusters that are AAD enabled. For more details see [disable local accounts](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts-preview).
        """
        return pulumi.get(self, "disable_local_accounts")
    ...
    @property
    @pulumi.getter(name="diskEncryptionSetID")
    def disk_encryption_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This is of the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/diskEncryptionSets/{encryptionSetName}'
        """
        return pulumi.get(self, "disk_encryption_set_id")
    ...
    @property
    @pulumi.getter(name="dnsPrefix")
    def dns_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This cannot be updated once the Managed Cluster has been created.
        """
        return pulumi.get(self, "dns_prefix")
    ...
    @property
    @pulumi.getter(name="enablePodSecurityPolicy")
    def enable_pod_security_policy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (DEPRECATED) Whether to enable Kubernetes pod security policy (preview). PodSecurityPolicy was deprecated in Kubernetes v1.21, and removed from Kubernetes in v1.25. Learn more at https://aka.ms/k8s/psp and https://aka.ms/aks/psp.
        """
        return pulumi.get(self, "enable_pod_security_policy")
    ...
    @property
    @pulumi.getter(name="fqdnSubdomain")
    def fqdn_subdomain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This cannot be updated once the Managed Cluster has been created.
        """
        return pulumi.get(self, "fqdn_subdomain")
    ...
    def max_agent_pools(self) -> pulumi.Output[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="nodeResourceGroup")
    def node_resource_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource group containing agent pool nodes.
        """
        return pulumi.get(self, "node_resource_group")
    ...
    def private_fqdn(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def resource_uid(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="supportPlan")
    def support_plan(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The support plan for the Managed Cluster. If unspecified, the default is 'KubernetesOfficial'.
        """
        return pulumi.get(self, "support_plan")
