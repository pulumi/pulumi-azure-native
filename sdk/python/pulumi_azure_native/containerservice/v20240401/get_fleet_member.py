...
def get_fleet_member(fleet_member_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20240401:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult).value
...
def get_fleet_member_output(fleet_member_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20240401:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult)
