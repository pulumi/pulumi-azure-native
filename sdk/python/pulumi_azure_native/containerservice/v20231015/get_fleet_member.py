...
def get_fleet_member(fleet_member_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20231015:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult).value
...
def get_fleet_member_output(fleet_member_name: Optional[pulumi.Input[str]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFleetMemberResult]:
    """
    Get a FleetMember
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20231015:getFleetMember', __args__, opts=opts, typ=GetFleetMemberResult)
    return __ret__.apply(lambda __response__: GetFleetMemberResult(
