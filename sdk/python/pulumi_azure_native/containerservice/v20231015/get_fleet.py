...
class GetFleetResult:
    ...
    The Fleet resource.
    """
    def __init__(__self__, e_tag=None, id=None, identity=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_fleet(fleet_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20231015:getFleet', __args__, opts=opts, typ=GetFleetResult).value
...
def get_fleet_output(fleet_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20231015:getFleet', __args__, opts=opts, typ=GetFleetResult)
