...
class AgentPoolUpgradeSettingsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if drain_timeout_in_minutes is None and 'drainTimeoutInMinutes' in kwargs:
...
class DelegatedResourceResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if referral_resource is None and 'referralResource' in kwargs:
...
class ManagedClusterIdentityResponse(dict):
    ...
    def _configure(
        ...
        if delegated_resources is None and 'delegatedResources' in kwargs:
