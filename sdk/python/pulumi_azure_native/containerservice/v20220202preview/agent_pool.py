...
warnings.warn("""azure-native:containerservice/v20220202preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.""", DeprecationWarning)
...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_runtime: Optional[pulumi.Input[Union[str, 'WorkloadRuntime']]] = None,
                 __props__=None):
        pulumi.log.warn("""AgentPool is deprecated: azure-native:containerservice/v20220202preview:AgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:containerservice/v20220402preview:AgentPool to guarantee forwards compatibility.""")
