...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot is deprecated: azure-native:containerservice/v20220202preview:Snapshot is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:Snapshot to guarantee forwards compatibility.""")
    __args__ = dict()
