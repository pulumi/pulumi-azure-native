...
class UpdateRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20230315preview:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20230615preview:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20230815preview:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20231015:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20240401:UpdateRun"), pulumi.Alias(type_="azure-native:containerservice/v20240502preview:UpdateRun")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UpdateRun, __self__).__init__(
            'azure-native:containerservice/v20240202preview:UpdateRun',
            resource_name,
            __props__,
            opts)
