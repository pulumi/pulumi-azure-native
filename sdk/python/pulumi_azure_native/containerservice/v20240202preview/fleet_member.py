...
class FleetMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20220602preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20220702preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20220902preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20230315preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20230615preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20230815preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20231015:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20240401:FleetMember"), pulumi.Alias(type_="azure-native:containerservice/v20240502preview:FleetMember"), pulumi.Alias(type_="azure-native:containerservice:FleetMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FleetMember, __self__).__init__(
            'azure-native:containerservice/v20240202preview:FleetMember',
            resource_name,
            __props__,
            opts)
