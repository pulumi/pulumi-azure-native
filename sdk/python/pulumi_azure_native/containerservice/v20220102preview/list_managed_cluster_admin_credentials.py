...
def list_managed_cluster_admin_credentials(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20220102preview:listManagedClusterAdminCredentials', __args__, opts=opts, typ=ListManagedClusterAdminCredentialsResult).value

    return AwaitableListManagedClusterAdminCredentialsResult(
        kubeconfigs=pulumi.get(__ret__, 'kubeconfigs'))
def list_managed_cluster_admin_credentials_output(format: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerservice/v20220102preview:listManagedClusterAdminCredentials', __args__, opts=opts, typ=ListManagedClusterAdminCredentialsResult)
