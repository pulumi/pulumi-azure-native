...
class IdentityBindingArgs:
    def __init__(__self__, *,
                 ...
                 identity_binding_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def identity_binding_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_binding_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IdentityBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerservice/v20250602preview:IdentityBinding"), pulumi.Alias(type_="azure-native:containerservice/v20250702preview:IdentityBinding"), pulumi.Alias(type_="azure-native:containerservice/v20250802preview:IdentityBinding")])
