...
def get_maintenance_configuration(config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_maintenance_configuration is deprecated: azure-native:containerservice/v20210901:MaintenanceConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:containerservice/v20230102preview:MaintenanceConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
