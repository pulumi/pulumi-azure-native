...
class ManagedClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'PublicNetworkAccess']] public_network_access: Default value is 'Enabled' (case insensitive). Could be set to 'Disabled' to enable private cluster
