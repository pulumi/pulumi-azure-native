...
warnings.warn("""Version v20180930preview will be removed in the next major version of the provider. Upgrade to version v20190430 or later.""", DeprecationWarning)
...
class GetOpenShiftManagedClusterResult:
    ...
    """
    def __init__(__self__, agent_pool_profiles=None, auth_profile=None, fqdn=None, id=None, location=None, master_pool_profile=None, name=None, network_profile=None, open_shift_version=None, plan=None, provisioning_state=None, public_hostname=None, router_profiles=None, tags=None, type=None):
...
def get_open_shift_managed_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_managed_cluster is deprecated: Version v20180930preview will be removed in the next major version of the provider. Upgrade to version v20190430 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/v20180930preview:getOpenShiftManagedCluster', __args__, opts=opts, typ=GetOpenShiftManagedClusterResult).value
