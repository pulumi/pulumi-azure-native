...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agent_pool = azure_native.containerservice.v20210201.AgentPool("agentPool",
        ...
        agent_pool = azure_native.containerservice.v20210201.AgentPool("agentPool",
            agent_pool_name="agentpool1",
            count=3,
            kubelet_config=azure_native.containerservice.v20210201.KubeletConfigArgs(
            ...
            linux_os_config=azure_native.containerservice.v20210201.LinuxOSConfigResponseArgs(
                swap_file_size_mb=1500,
                sysctls=azure_native.containerservice.v20210201.SysctlConfigArgs(
