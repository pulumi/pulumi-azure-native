...
class FleetManagedNamespacePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "managedNamespaceProperties":
            suggest = "managed_namespace_properties"
        elif key == "propagationPolicy":
            suggest = "propagation_policy"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FleetManagedNamespacePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FleetManagedNamespacePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 managed_namespace_properties: Optional['outputs.ManagedNamespacePropertiesResponse'] = None,
        ...
        :param 'FleetManagedNamespaceStatusResponse' status: Status information of the last operation for fleet managed namespace.
        :param 'ManagedNamespacePropertiesResponse' managed_namespace_properties: The namespace properties for the fleet managed namespace.
        :param 'PropagationPolicyResponse' propagation_policy: The profile of the propagation to create the namespace.
        """
...
class FleetManagedNamespaceStatusResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "lastOperationError":
            suggest = "last_operation_error"
        elif key == "lastOperationId":
            suggest = "last_operation_id"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FleetManagedNamespaceStatusResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FleetManagedNamespaceStatusResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def last_operation_error(self) -> 'outputs.ErrorDetailResponse':
        ...
        """
        return pulumi.get(self, "last_operation_error")
...
class IstioEgressGatewayResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str,
                 gateway_configuration_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str namespace: Namespace that the Istio add-on egress gateway should be deployed in. If unspecified, the default is aks-istio-egress.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "name", name)
...
class LocalDNSOverrideResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LocalDNSOverrideResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LocalDNSOverrideResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int max_concurrent: Maximum number of concurrent queries. See [forward plugin](https://coredns.io/plugins/forward) for more information.
        :param _builtins.str protocol: Enforce TCP or prefer UDP protocol for connections from localDNS to upstream DNS server.
        :param _builtins.str query_logging: Log level for DNS queries in localDNS.
        :param _builtins.str serve_stale: Policy for serving stale data. See [cache plugin](https://coredns.io/plugins/cache) for more information.
        :param _builtins.int serve_stale_duration_in_seconds: Serve stale duration in seconds. See [cache plugin](https://coredns.io/plugins/cache) for more information.
        """
...
class LocalDNSProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LocalDNSProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LocalDNSProfileResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 state: _builtins.str,
                 kube_dns_overrides: Optional[Mapping[str, 'outputs.LocalDNSOverrideResponse']] = None,
        ...
        :param Mapping[str, 'LocalDNSOverrideResponse'] vnet_dns_overrides: VnetDNS overrides apply to DNS traffic from pods with dnsPolicy:default or kubelet (referred to as VnetDNS traffic).
        """
...
class ManagedClusterAgentPoolProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "localDNSProfile":
            suggest = "local_dns_profile"
        elif key == "maxCount":
            suggest = "max_count"
        elif key == "maxPods":
            suggest = "max_pods"
    ...
    def __init__(__self__, *,
                 ...
                 local_dns_profile: Optional['outputs.LocalDNSProfileResponse'] = None,
        ...
        :param 'LocalDNSProfileResponse' local_dns_profile: Configures the per-node local DNS, with VnetDNS and KubeDNS overrides. LocalDNS helps improve performance and reliability of DNS resolution in an AKS cluster. For more details see aka.ms/aks/localdns.
...
class ManagedNamespacePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "defaultNetworkPolicy":
            suggest = "default_network_policy"
        elif key == "defaultResourceQuota":
            suggest = "default_resource_quota"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ManagedNamespacePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ManagedNamespacePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 default_network_policy: Optional['outputs.NetworkPolicyResponse'] = None,
        ...
        :param Mapping[str, _builtins.str] labels: The labels for the fleet managed namespace.
        """
...
class PropagationPolicyResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "placementProfile":
            suggest = "placement_profile"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PropagationPolicyResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PropagationPolicyResponse.__key_warning(key)
        return super().__getitem__(key)
