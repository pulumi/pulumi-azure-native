...
class APIServerAccessProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_private_cluster: Optional[builtins.bool] = None,
                 enable_vnet_integration: Optional[builtins.bool] = None,
                 subnet_id: Optional[builtins.str] = None):
        """
        Access profile for the Fleet hub API server.
        :param builtins.bool enable_private_cluster: Whether to create the Fleet hub as a private cluster or not.
        :param builtins.bool enable_vnet_integration: Whether to enable apiserver vnet integration for the Fleet hub or not.
        :param builtins.str subnet_id: The subnet to be used when apiserver vnet integration is enabled. It is required when creating a new Fleet with BYO vnet.
        """
    ...
    def enable_private_cluster(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_vnet_integration(self) -> Optional[builtins.bool]:
        """
...
class AbsoluteMonthlyScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 interval_months: builtins.int):
        """
        For schedules like: 'recur every month on the 15th' or 'recur every 3 months on the 20th'.
        :param builtins.int day_of_month: The date of the month.
        :param builtins.int interval_months: Specifies the number of months between each set of occurrences.
        """
    ...
    def interval_months(self) -> builtins.int:
        """
...
class AdvancedNetworkingObservabilityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Observability profile to enable advanced network metrics and flow logs with historical contexts.
        :param builtins.bool enabled: Indicates the enablement of Advanced Networking observability functionalities on clusters.
        """
...
class AdvancedNetworkingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Advanced Networking profile for enabling observability and security feature suite on a cluster. For more information see aka.ms/aksadvancednetworking.
        :param builtins.bool enabled: Indicates the enablement of Advanced Networking functionalities of observability and security on AKS clusters. When this is set to true, all observability and security features will be set to enabled unless explicitly disabled. If not specified, the default is false.
...
class AdvancedNetworkingSecurityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Security profile to enable security features on cilium based cluster.
        :param builtins.bool enabled: This feature allows user to configure network policy based on DNS (FQDN) names. It can be enabled only on cilium based clusters. If not specified, the default is false.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class AgentPoolNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 application_security_groups: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] application_security_groups: The IDs of the application security groups which agent pool will associate when created.
    ...
    def application_security_groups(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AgentPoolSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The security settings of an agent pool.
        :param builtins.bool enable_secure_boot: Secure Boot is a feature of Trusted Launch which ensures that only signed operating systems and drivers can boot. For more details, see aka.ms/aks/trustedlaunch.  If not specified, the default is false.
        :param builtins.bool enable_vtpm: vTPM is a Trusted Launch feature for configuring a dedicated secure vault for keys and measurements held locally on the node. For more details, see aka.ms/aks/trustedlaunch. If not specified, the default is false.
        """
...
class AgentPoolUpgradeSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings for upgrading an agentpool
        :param builtins.int drain_timeout_in_minutes: The amount of time (in minutes) to wait on eviction of pods and graceful termination per node. This eviction wait time honors waiting on pod disruption budgets. If this time is exceeded, the upgrade fails. If not specified, the default is 30 minutes.
        :param builtins.str max_surge: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are rounded up. If not specified, the default is 10%. For more information, including best practices, see: https://docs.microsoft.com/azure/aks/upgrade-cluster#customize-node-surge-upgrade
        :param builtins.int node_soak_duration_in_minutes: The amount of time (in minutes) to wait after draining a node and before reimaging it and moving on to next node. If not specified, the default is 0 minutes.
        """
...
class AgentPoolWindowsProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 disable_outbound_nat: Optional[builtins.bool] = None):
        """
        The Windows agent pool's specific profile.
        :param builtins.bool disable_outbound_nat: The default value is false. Outbound NAT can only be disabled if the cluster outboundType is NAT Gateway and the Windows agent pool does not have node public IP enabled.
        """
    ...
    def disable_outbound_nat(self) -> Optional[builtins.bool]:
        """
...
class AgentProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Agent profile for the Fleet hub.
        :param builtins.str subnet_id: The ID of the subnet which the Fleet hub node will join on startup. If this is not specified, a vnet and subnet will be generated and used.
        :param builtins.str vm_size: The virtual machine size of the Fleet hub.
        """
        if subnet_id is not None:
            pulumi.set(__self__, "subnet_id", subnet_id)
...
class AutoUpgradeNodeImageSelectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The node image upgrade to be applied to the target clusters in auto upgrade.
        :param builtins.str type: The node image upgrade type.
        """
...
class AzureKeyVaultKmsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure Key Vault key management service settings for the security profile.
        :param builtins.bool enabled: Whether to enable Azure Key Vault key management service. The default is false.
        :param builtins.str key_id: Identifier of Azure Key Vault key. See [key identifier format](https://docs.microsoft.com/en-us/azure/key-vault/general/about-keys-secrets-certificates#vault-name-and-object-name) for more details. When Azure Key Vault key management service is enabled, this field is required and must be a valid key identifier. When Azure Key Vault key management service is disabled, leave the field empty.
        :param builtins.str key_vault_network_access: Network access of key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link. The default value is `Public`.
        :param builtins.str key_vault_resource_id: Resource ID of key vault. When keyVaultNetworkAccess is `Private`, this field is required and must be a valid resource ID. When keyVaultNetworkAccess is `Public`, leave the field empty.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ContainerServiceLinuxProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile for Linux VMs in the container service cluster.
        :param builtins.str admin_username: The administrator username to use for Linux VMs.
...
class ContainerServiceNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 network_dataplane: Optional[builtins.str] = None,
        ...
        :param Sequence[builtins.str] ip_families: IP families are used to determine single-stack or dual-stack clusters. For single-stack, the expected value is IPv4. For dual-stack, the expected values are IPv4 and IPv6.
        :param 'ManagedClusterLoadBalancerProfileResponse' load_balancer_profile: Profile of the cluster load balancer.
        :param builtins.str load_balancer_sku: The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus) for more information about the differences between load balancer SKUs.
        :param 'ManagedClusterNATGatewayProfileResponse' nat_gateway_profile: Profile of the cluster NAT gateway.
        :param builtins.str network_dataplane: Network dataplane used in the Kubernetes cluster.
        :param builtins.str network_mode: This cannot be specified if networkPlugin is anything other than 'azure'.
        :param builtins.str network_plugin: Network plugin used for building the Kubernetes network.
        :param builtins.str network_plugin_mode: The mode the network plugin should use.
        :param builtins.str network_policy: Network policy used for building the Kubernetes network.
        :param builtins.str outbound_type: This can only be set at cluster creation time and cannot be changed later. For more information see [egress outbound type](https://docs.microsoft.com/azure/aks/egress-outboundtype).
        :param builtins.str pod_cidr: A CIDR notation IP range from which to assign pod IPs when kubenet is used.
        :param Sequence[builtins.str] pod_cidrs: One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking.
        ...
        :param Sequence[builtins.str] service_cidrs: One IPv4 CIDR is expected for single-stack networking. Two CIDRs, one for each IP family (IPv4/IPv6), is expected for dual-stack networking. They must not overlap with any Subnet IP ranges.
        """
    ...
    def network_dataplane(self) -> Optional[builtins.str]:
        """
...
class ContainerServiceSshPublicKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains information about SSH certificate public key data.
        :param builtins.str key_data: Certificate public key used to authenticate with VMs through SSH. The certificate must be in PEM format with or without headers.
        """
...
class CreationDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Data used when creating a target resource from a source resource.
        :param builtins.str source_resource_id: This is the ARM ID of the source object to be used to create the target object.
        """
...
class DailyScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 interval_days: builtins.int):
        """
        For schedules like: 'recur every day' or 'recur every 3 days'.
        :param builtins.int interval_days: Specifies the number of days between each set of occurrences.
        """
        pulumi.set(__self__, "interval_days", interval_days)

    @property
    @pulumi.getter(name="intervalDays")
    def interval_days(self) -> builtins.int:
        """
...
class DateSpanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        For example, between '2022-12-23' and '2023-01-05'.
        :param builtins.str end: The end date of the date span.
        :param builtins.str start: The start date of the date span.
        """
...
class DelegatedResourceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 referral_resource: Optional[builtins.str] = None,
                 resource_id: Optional[builtins.str] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        Delegated resource properties - internal use only.
        :param builtins.str location: The source resource location - internal use only.
        :param builtins.str referral_resource: The delegation id of the referral delegation (optional) - internal use only.
        :param builtins.str resource_id: The ARM resource id of the delegated resource - internal use only.
        :param builtins.str tenant_id: The tenant id of the delegated resource - internal use only.
        """
    ...
    def referral_resource(self) -> Optional[builtins.str]:
        """
...
class FleetHubProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The FleetHubProfile configures the fleet hub.
        :param builtins.str fqdn: The FQDN of the Fleet hub.
        :param builtins.str kubernetes_version: The Kubernetes version of the Fleet hub.
        :param builtins.str portal_fqdn: The Azure Portal FQDN of the Fleet hub.
        ...
        :param builtins.str dns_prefix: DNS prefix used to create the FQDN for the Fleet hub.
        """
...
class IPTagResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Contains the IPTag associated with the object.
        :param builtins.str ip_tag_type: The IP tag type. Example: RoutingPreference.
        :param builtins.str tag: The value of the IP tag associated with the public IP. Example: Internet.
        """
...
class IstioEgressGatewayResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Istio egress gateway configuration.
        :param builtins.bool enabled: Whether to enable the egress gateway.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class IstioIngressGatewayResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Istio ingress gateway configuration. For now, we support up to one external ingress gateway named `aks-istio-ingressgateway-external` and one internal ingress gateway named `aks-istio-ingressgateway-internal`.
        :param builtins.bool enabled: Whether to enable the ingress gateway.
        :param builtins.str mode: Mode of an ingress gateway.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class IstioPluginCertificateAuthorityResponse(dict):
    ...
    def __init__(__self__, *,
                 cert_chain_object_name: Optional[builtins.str] = None,
                 cert_object_name: Optional[builtins.str] = None,
                 key_object_name: Optional[builtins.str] = None,
                 key_vault_id: Optional[builtins.str] = None,
                 root_cert_object_name: Optional[builtins.str] = None):
        """
        Plugin certificates information for Service Mesh.
        :param builtins.str cert_chain_object_name: Certificate chain object name in Azure Key Vault.
        :param builtins.str cert_object_name: Intermediate certificate object name in Azure Key Vault.
        :param builtins.str key_object_name: Intermediate certificate private key object name in Azure Key Vault.
        :param builtins.str key_vault_id: The resource ID of the Key Vault.
        :param builtins.str root_cert_object_name: Root certificate object name in Azure Key Vault.
        """
    ...
    def cert_chain_object_name(self) -> Optional[builtins.str]:
        """
    ...
    def cert_object_name(self) -> Optional[builtins.str]:
        """
    ...
    def key_object_name(self) -> Optional[builtins.str]:
        """
    ...
    def root_cert_object_name(self) -> Optional[builtins.str]:
        """
...
class IstioServiceMeshResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 revisions: Optional[Sequence[builtins.str]] = None):
        """
        Istio service mesh configuration.
        ...
        :param Sequence[builtins.str] revisions: The list of revisions of the Istio control plane. When an upgrade is not in progress, this holds one value. When canary upgrade is in progress, this can only hold two consecutive values. For more information, see: https://learn.microsoft.com/en-us/azure/aks/istio-upgrade
        """
    ...
    @property
    @pulumi.getter
    def revisions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class KubeletConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_log_max_files: Optional[builtins.int] = None,
                 container_log_max_size_mb: Optional[builtins.int] = None,
                 cpu_cfs_quota: Optional[builtins.bool] = None,
                 ...
                 pod_max_pids: Optional[builtins.int] = None,
                 topology_manager_policy: Optional[builtins.str] = None):
        """
        See [AKS custom node configuration](https://docs.microsoft.com/azure/aks/custom-node-configuration) for more details.
        :param Sequence[builtins.str] allowed_unsafe_sysctls: Allowed list of unsafe sysctls or unsafe sysctl patterns (ending in `*`).
        :param builtins.int container_log_max_files: The maximum number of container log files that can be present for a container. The number must be ≥ 2.
        :param builtins.int container_log_max_size_mb: The maximum size (e.g. 10Mi) of container log file before it is rotated.
        :param builtins.bool cpu_cfs_quota: The default is true.
        :param builtins.str cpu_cfs_quota_period: The default is '100ms.' Valid values are a sequence of decimal numbers with an optional fraction and a unit suffix. For example: '300ms', '2h45m'. Supported units are 'ns', 'us', 'ms', 's', 'm', and 'h'.
        :param builtins.str cpu_manager_policy: The default is 'none'. See [Kubernetes CPU management policies](https://kubernetes.io/docs/tasks/administer-cluster/cpu-management-policies/#cpu-management-policies) for more information. Allowed values are 'none' and 'static'.
        :param builtins.bool fail_swap_on: If set to true it will make the Kubelet fail to start if swap is enabled on the node.
        :param builtins.int image_gc_high_threshold: To disable image garbage collection, set to 100. The default is 85%
        :param builtins.int image_gc_low_threshold: This cannot be set higher than imageGcHighThreshold. The default is 80%
        :param builtins.int pod_max_pids: The maximum number of processes per pod.
        :param builtins.str topology_manager_policy: For more information see [Kubernetes Topology Manager](https://kubernetes.io/docs/tasks/administer-cluster/topology-manager). The default is 'none'. Allowed values are 'none', 'best-effort', 'restricted', and 'single-numa-node'.
        """
    ...
    def container_log_max_files(self) -> Optional[builtins.int]:
        """
    ...
    def cpu_cfs_quota(self) -> Optional[builtins.bool]:
        """
        The default is true.
        """
    ...
    def pod_max_pids(self) -> Optional[builtins.int]:
        """
...
class LabelSelectorRequirementResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str operator: operator represents a key's relationship to a set of values. Valid operators are In and NotIn
        :param Sequence[builtins.str] values: values is an array of string values, the values array must be non-empty.
        """
        if key is not None:
...
class LabelSelectorResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 match_labels: Optional[Sequence[builtins.str]] = None):
        """
        A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
        ...
        :param Sequence[builtins.str] match_labels: matchLabels is an array of {key=value} pairs. A single {key=value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is `key`, the operator is `In`, and the values array contains only `value`. The requirements are ANDed.
        """
    ...
    def match_labels(self) -> Optional[Sequence[builtins.str]]:
        """
...
class LinuxOSConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        See [AKS custom node configuration](https://docs.microsoft.com/azure/aks/custom-node-configuration) for more details.
        :param builtins.int swap_file_size_mb: The size in MB of a swap file that will be created on each node.
        :param 'SysctlConfigResponse' sysctls: Sysctl settings for Linux agent nodes.
        :param builtins.str transparent_huge_page_defrag: Valid values are 'always', 'defer', 'defer+madvise', 'madvise' and 'never'. The default is 'madvise'. For more information see [Transparent Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
        :param builtins.str transparent_huge_page_enabled: Valid values are 'always', 'madvise', and 'never'. The default is 'always'. For more information see [Transparent Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
        """
...
class MaintenanceWindowResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Maintenance window used to configure scheduled auto-upgrade for a Managed Cluster.
        :param builtins.int duration_hours: Length of maintenance window range from 4 to 24 hours.
        :param 'ScheduleResponse' schedule: Recurrence schedule for the maintenance window.
        :param builtins.str start_time: The start time of the maintenance window. Accepted values are from '00:00' to '23:59'. 'utcOffset' applies to this field. For example: '02:00' with 'utcOffset: +02:00' means UTC time '00:00'.
        ...
        :param builtins.str start_date: The date the maintenance window activates. If the current date is before this date, the maintenance window is inactive and will not be used for upgrades. If not specified, the maintenance window will be active right away.
        :param builtins.str utc_offset: The UTC offset in format +/-HH:mm. For example, '+05:30' for IST and '-07:00' for PST. If not specified, the default is '+00:00'.
        """
...
class ManagedClusterAADProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 server_app_secret: Optional[builtins.str] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        For more details see [managed AAD on AKS](https://docs.microsoft.com/azure/aks/managed-aad).
        ...
        :param builtins.str client_app_id: (DEPRECATED) The client AAD application ID. Learn more at https://aka.ms/aks/aad-legacy.
        ...
        :param builtins.str server_app_id: (DEPRECATED) The server AAD application ID. Learn more at https://aka.ms/aks/aad-legacy.
        :param builtins.str server_app_secret: (DEPRECATED) The server AAD application secret. Learn more at https://aka.ms/aks/aad-legacy.
    ...
    def server_app_secret(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterAPIServerAccessProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_run_command: Optional[builtins.bool] = None,
                 enable_private_cluster: Optional[builtins.bool] = None,
                 enable_private_cluster_public_fqdn: Optional[builtins.bool] = None,
                 private_dns_zone: Optional[builtins.str] = None):
        """
        Access profile for managed cluster API server.
        :param Sequence[builtins.str] authorized_ip_ranges: IP ranges are specified in CIDR format, e.g. 137.117.106.88/29. This feature is not compatible with clusters that use Public IP Per Node, or clusters that are using a Basic Load Balancer. For more information see [API server authorized IP ranges](https://docs.microsoft.com/azure/aks/api-server-authorized-ip-ranges).
        :param builtins.bool disable_run_command: Whether to disable run command for the cluster or not.
        :param builtins.bool enable_private_cluster: For more details, see [Creating a private AKS cluster](https://docs.microsoft.com/azure/aks/private-clusters).
        :param builtins.bool enable_private_cluster_public_fqdn: Whether to create additional public FQDN for private cluster or not.
        :param builtins.str private_dns_zone: The default is System. For more details see [configure private DNS zone](https://docs.microsoft.com/azure/aks/private-clusters#configure-private-dns-zone). Allowed values are 'system' and 'none'.
        """
    ...
    def disable_run_command(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_private_cluster_public_fqdn(self) -> Optional[builtins.bool]:
        """
    ...
    def private_dns_zone(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterAddonProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Kubernetes add-on profile for a managed cluster.
        :param builtins.bool enabled: Whether the add-on is enabled or not.
        :param 'ManagedClusterAddonProfileResponseIdentity' identity: Information of user assigned identity used by this add-on.
        :param Mapping[str, builtins.str] config: Key-value pairs for configuring an add-on.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterAgentPoolProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 current_orchestrator_version: builtins.str,
                 e_tag: builtins.str,
                 name: builtins.str,
                 node_image_version: builtins.str,
                 ...
                 enable_encryption_at_host: Optional[builtins.bool] = None,
                 enable_fips: Optional[builtins.bool] = None,
                 enable_node_public_ip: Optional[builtins.bool] = None,
                 enable_ultra_ssd: Optional[builtins.bool] = None,
                 gpu_instance_profile: Optional[builtins.str] = None,
                 ...
                 message_of_the_day: Optional[builtins.str] = None,
                 ...
                 scale_set_eviction_policy: Optional[builtins.str] = None,
                 scale_set_priority: Optional[builtins.str] = None,
                 security_profile: Optional['outputs.AgentPoolSecurityProfileResponse'] = None,
                 spot_max_price: Optional[builtins.float] = None,
        ...
        """
        Profile for the container service agent pool.
        :param builtins.str current_orchestrator_version: If orchestratorVersion is a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion is <major.minor>, this field will contain the full <major.minor.patch> version being used.
        :param builtins.str e_tag: Unique read-only string used to implement optimistic concurrency. The eTag value will change when the resource is updated. Specify an if-match or if-none-match header with the eTag value for a subsequent request to enable optimistic concurrency per the normal etag convention.
        :param builtins.str name: Windows agent pool names must be 6 characters or less.
        :param builtins.str node_image_version: The version of node image
        :param builtins.str provisioning_state: The current deployment or provisioning state.
        :param Sequence[builtins.str] availability_zones: The list of Availability zones to use for nodes. This can only be specified if the AgentPoolType property is 'VirtualMachineScaleSets'.
        :param builtins.str capacity_reservation_group_id: AKS will associate the specified agent pool with the Capacity Reservation Group.
        :param builtins.int count: Number of agents (VMs) to host docker containers. Allowed values must be in the range of 0 to 1000 (inclusive) for user pools and in the range of 1 to 1000 (inclusive) for system pools. The default value is 1.
        ...
        :param builtins.bool enable_auto_scaling: Whether to enable auto-scaler
        :param builtins.bool enable_encryption_at_host: This is only supported on certain VM sizes and in certain Azure regions. For more information, see: https://docs.microsoft.com/azure/aks/enable-host-encryption
        :param builtins.bool enable_fips: See [Add a FIPS-enabled node pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#add-a-fips-enabled-node-pool-preview) for more details.
        :param builtins.bool enable_node_public_ip: Some scenarios may require nodes in a node pool to receive their own dedicated public IP addresses. A common scenario is for gaming workloads, where a console needs to make a direct connection to a cloud virtual machine to minimize hops. For more information see [assigning a public IP per node](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#assign-a-public-ip-per-node-for-your-node-pools). The default is false.
        :param builtins.bool enable_ultra_ssd: Whether to enable UltraSSD
        :param builtins.str gpu_instance_profile: GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
        :param builtins.str host_group_id: This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
        :param 'KubeletConfigResponse' kubelet_config: The Kubelet configuration on the agent pool nodes.
        :param builtins.str kubelet_disk_type: Determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage.
        ...
        :param builtins.str message_of_the_day: A base64-encoded string which will be written to /etc/motd after decoding. This allows customization of the message of the day for Linux nodes. It must not be specified for Windows nodes. It must be a static string (i.e., will be printed raw and not be executed as a script).
        :param builtins.int min_count: The minimum number of nodes for auto-scaling
        :param builtins.str mode: A cluster must have at least one 'System' Agent Pool at all times. For additional information on agent pool restrictions and best practices, see: https://docs.microsoft.com/azure/aks/use-system-pools
        :param 'AgentPoolNetworkProfileResponse' network_profile: Network-related settings of an agent pool.
        :param Mapping[str, builtins.str] node_labels: The node labels to be persisted across all nodes in agent pool.
        :param builtins.str node_public_ip_prefix_id: This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPPrefixes/{publicIPPrefixName}
        :param Sequence[builtins.str] node_taints: The taints added to new nodes during node pool create and scale. For example, key=value:NoSchedule.
        :param builtins.str orchestrator_version: Both patch version <major.minor.patch> (e.g. 1.20.13) and <major.minor> (e.g. 1.20) are supported. When <major.minor> is specified, the latest supported GA patch version is chosen automatically. Updating the cluster with the same <major.minor> once it has been created (e.g. 1.14.x -> 1.14) will not trigger an upgrade, even if a newer patch version is available. As a best practice, you should upgrade all node pools in an AKS cluster to the same Kubernetes version. The node pool version must have the same major version as the control plane. The node pool minor version must be within two minor versions of the control plane version. The node pool version cannot be greater than the control plane version. For more information see [upgrading a node pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#upgrade-a-node-pool).
        :param builtins.int os_disk_size_gb: OS Disk Size in GB to be used to specify the disk size for every machine in the master/agent pool. If you specify 0, it will apply the default osDisk size according to the vmSize specified.
        :param builtins.str os_disk_type: The default is 'Ephemeral' if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os).
        :param builtins.str os_sku: Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
        :param builtins.str os_type: The operating system type. The default is Linux.
        :param builtins.str pod_subnet_id: If omitted, pod IPs are statically assigned on the node subnet (see vnetSubnetID for more details). This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
        ...
        :param builtins.str proximity_placement_group_id: The ID for Proximity Placement Group.
        :param builtins.str scale_down_mode: This also effects the cluster autoscaler behavior. If not specified, it defaults to Delete.
        :param builtins.str scale_set_eviction_policy: This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
        :param builtins.str scale_set_priority: The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
        :param 'AgentPoolSecurityProfileResponse' security_profile: The security settings of an agent pool.
        :param builtins.float spot_max_price: Possible values are any decimal value greater than zero or -1 which indicates the willingness to pay any on-demand price. For more details on spot pricing, see [spot VMs pricing](https://docs.microsoft.com/azure/virtual-machines/spot-vms#pricing)
        :param Mapping[str, builtins.str] tags: The tags to be persisted on the agent pool virtual machine scale set.
        :param builtins.str type: The type of Agent Pool.
        :param 'AgentPoolUpgradeSettingsResponse' upgrade_settings: Settings for upgrading the agentpool
        :param builtins.str vm_size: VM size availability varies by region. If a node contains insufficient compute resources (memory, cpu, etc) pods might fail to run correctly. If this field is not specified, AKS will attempt to find an appropriate VM SKU for your pool, based on quota and capacity. For more details on restricted VM sizes, see: https://docs.microsoft.com/azure/aks/quotas-skus-regions
        :param builtins.str vnet_subnet_id: If this is not specified, a VNET and subnet will be generated and used. If no podSubnetID is specified, this applies to nodes and pods, otherwise it applies to just nodes. This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
        :param 'AgentPoolWindowsProfileResponse' windows_profile: The Windows agent pool's specific profile.
        :param builtins.str workload_runtime: Determines the type of workload a node can run.
        """
...
class ManagedClusterAutoUpgradeProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 node_os_upgrade_channel: Optional[builtins.str] = None,
                 upgrade_channel: Optional[builtins.str] = None):
        """
        Auto upgrade profile for a managed cluster.
        :param builtins.str node_os_upgrade_channel: Manner in which the OS on your nodes is updated. The default is NodeImage.
        :param builtins.str upgrade_channel: For more information see [setting the AKS cluster auto-upgrade channel](https://docs.microsoft.com/azure/aks/upgrade-cluster#set-auto-upgrade-channel).
        """
    ...
    def node_os_upgrade_channel(self) -> Optional[builtins.str]:
        """
    ...
    def upgrade_channel(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterAzureMonitorProfileKubeStateMetricsResponse(dict):
    ...
    def __init__(__self__, *,
                 metric_annotations_allow_list: Optional[builtins.str] = None,
                 metric_labels_allowlist: Optional[builtins.str] = None):
        """
        Kube State Metrics profile for the Azure Managed Prometheus addon. These optional settings are for the kube-state-metrics pod that is deployed with the addon. See aka.ms/AzureManagedPrometheus-optional-parameters for details.
        :param builtins.str metric_annotations_allow_list: Comma-separated list of Kubernetes annotation keys that will be used in the resource's labels metric (Example: 'namespaces=[kubernetes.io/team,...],pods=[kubernetes.io/team],...'). By default the metric contains only resource name and namespace labels.
        :param builtins.str metric_labels_allowlist: Comma-separated list of additional Kubernetes label keys that will be used in the resource's labels metric (Example: 'namespaces=[k8s-label-1,k8s-label-n,...],pods=[app],...'). By default the metric contains only resource name and namespace labels.
        """
    ...
    def metric_annotations_allow_list(self) -> Optional[builtins.str]:
        """
    ...
    def metric_labels_allowlist(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterAzureMonitorProfileMetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Metrics profile for the Azure Monitor managed service for Prometheus addon. Collect out-of-the-box Kubernetes infrastructure metrics to send to an Azure Monitor Workspace and configure additional scraping for custom targets. See aka.ms/AzureManagedPrometheus for an overview.
        :param builtins.bool enabled: Whether to enable or disable the Azure Managed Prometheus addon for Prometheus monitoring. See aka.ms/AzureManagedPrometheus-aks-enable for details on enabling and disabling.
...
class ManagedClusterIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the managed cluster.
        :param builtins.str principal_id: The principal id of the system assigned identity which is used by master components.
        :param builtins.str tenant_id: The tenant id of the system assigned identity which is used by master components.
        ...
        :param builtins.str type: For more information see [use managed identities in AKS](https://docs.microsoft.com/azure/aks/use-managed-identity).
...
class ManagedClusterIngressProfileWebAppRoutingResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dns_zone_resource_ids: Optional[Sequence[builtins.str]] = None,
                 enabled: Optional[builtins.bool] = None):
        """
        Application Routing add-on settings for the ingress profile.
        ...
        :param Sequence[builtins.str] dns_zone_resource_ids: Resource IDs of the DNS zones to be associated with the Application Routing add-on. Used only when Application Routing add-on is enabled. Public and private DNS zones can be in different resource groups, but all public DNS zones must be in the same resource group and all private DNS zones must be in the same resource group.
        :param builtins.bool enabled: Whether to enable the Application Routing add-on.
        """
        pulumi.set(__self__, "identity", identity)
    ...
    def dns_zone_resource_ids(self) -> Optional[Sequence[builtins.str]]:
        """
        Resource IDs of the DNS zones to be associated with the Application Routing add-on. Used only when Application Routing add-on is enabled. Public and private DNS zones can be in different resource groups, but all public DNS zones must be in the same resource group and all private DNS zones must be in the same resource group.
        """
...
class ManagedClusterLoadBalancerProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 allocated_outbound_ports: Optional[builtins.int] = None,
                 ...
                 enable_multiple_standard_load_balancers: Optional[builtins.bool] = None,
        ...
        """
        Profile of the managed cluster load balancer.
        :param builtins.int allocated_outbound_ports: The desired number of allocated SNAT ports per VM. Allowed values are in the range of 0 to 64000 (inclusive). The default value is 0 which results in Azure dynamically allocating ports.
        :param builtins.str backend_pool_type: The type of the managed inbound Load Balancer BackendPool.
        ...
        :param builtins.bool enable_multiple_standard_load_balancers: Enable multiple standard load balancers per AKS cluster or not.
        :param builtins.int idle_timeout_in_minutes: Desired outbound flow idle timeout in minutes. Allowed values are in the range of 4 to 120 (inclusive). The default value is 30 minutes.
    ...
    def allocated_outbound_ports(self) -> Optional[builtins.int]:
        """
    ...
    def enable_multiple_standard_load_balancers(self) -> Optional[builtins.bool]:
        """
...
class ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs(dict):
    ...
    def __init__(__self__, *,
                 count: Optional[builtins.int] = None,
                 count_i_pv6: Optional[builtins.int] = None):
        """
        Desired managed outbound IPs for the cluster load balancer.
        :param builtins.int count: The desired number of IPv4 outbound IPs created/managed by Azure for the cluster load balancer. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1. 
        :param builtins.int count_i_pv6: The desired number of IPv6 outbound IPs created/managed by Azure for the cluster load balancer. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 0 for single-stack and 1 for dual-stack. 
        """
        if count is None:
            count = 1
        if count is not None:
    ...
    def count_i_pv6(self) -> Optional[builtins.int]:
        """
...
class ManagedClusterManagedOutboundIPProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile of the managed outbound IP resources of the managed cluster.
        :param builtins.int count: The desired number of outbound IPs created/managed by Azure. Allowed values must be in the range of 1 to 16 (inclusive). The default value is 1. 
        """
        if count is None:
            count = 1
        if count is not None:
...
class ManagedClusterNATGatewayProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int idle_timeout_in_minutes: Desired outbound flow idle timeout in minutes. Allowed values are in the range of 4 to 120 (inclusive). The default value is 4 minutes.
...
class ManagedClusterNodeResourceGroupProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 restriction_level: Optional[builtins.str] = None):
        """
        Node resource group lockdown profile for a managed cluster.
        :param builtins.str restriction_level: The restriction level applied to the cluster's node resource group. If not specified, the default is 'Unrestricted'
        """
    ...
    def restriction_level(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterOIDCIssuerProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The OIDC issuer profile of the Managed Cluster.
        :param builtins.str issuer_url: The OIDC issuer url of the Managed Cluster.
        :param builtins.bool enabled: Whether the OIDC issuer is enabled.
        """
...
class ManagedClusterPodIdentityExceptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pod_labels: Mapping[str, builtins.str]):
        """
        See [disable AAD Pod Identity for a specific Pod/Application](https://azure.github.io/aad-pod-identity/docs/configure/application_exception/) for more details.
        :param builtins.str name: The name of the pod identity exception.
        :param builtins.str namespace: The namespace of the pod identity exception.
        :param Mapping[str, builtins.str] pod_labels: The pod labels to match.
        """
        pulumi.set(__self__, "name", name)
    ...
    def pod_labels(self) -> Mapping[str, builtins.str]:
        """
...
class ManagedClusterPodIdentityProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_network_plugin_kubenet: Optional[builtins.bool] = None,
                 enabled: Optional[builtins.bool] = None,
    ...
    def allow_network_plugin_kubenet(self) -> Optional[builtins.bool]:
        """
...
class ManagedClusterPodIdentityResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: builtins.str,
                 binding_selector: Optional[builtins.str] = None):
        """
        Details about the pod identity assigned to the Managed Cluster.
        :param 'UserAssignedIdentityResponse' identity: The user assigned identity details.
        :param builtins.str name: The name of the pod identity.
        :param builtins.str namespace: The namespace of the pod identity.
        :param builtins.str provisioning_state: The current provisioning state of the pod identity.
        :param builtins.str binding_selector: The binding selector to use for the AzureIdentityBinding resource.
        """
        pulumi.set(__self__, "identity", identity)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "namespace", namespace)
    ...
    def binding_selector(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterPropertiesForSnapshotResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enable_rbac: Whether the cluster has enabled Kubernetes Role-Based Access Control or not.
        :param builtins.str kubernetes_version: The current kubernetes version.
...
class ManagedClusterPropertiesResponseAutoScalerProfile(dict):
    ...
    def __init__(__self__, *,
                 balance_similar_node_groups: Optional[builtins.str] = None,
                 daemonset_eviction_for_empty_nodes: Optional[builtins.bool] = None,
                 daemonset_eviction_for_occupied_nodes: Optional[builtins.bool] = None,
                 expander: Optional[builtins.str] = None,
                 ignore_daemonsets_utilization: Optional[builtins.bool] = None,
                 max_empty_bulk_delete: Optional[builtins.str] = None,
                 max_graceful_termination_sec: Optional[builtins.str] = None,
                 max_node_provision_time: Optional[builtins.str] = None,
                 max_total_unready_percentage: Optional[builtins.str] = None,
                 new_pod_scale_up_delay: Optional[builtins.str] = None,
                 ok_total_unready_count: Optional[builtins.str] = None,
                 ...
                 scale_down_unready_time: Optional[builtins.str] = None,
                 scale_down_utilization_threshold: Optional[builtins.str] = None,
                 scan_interval: Optional[builtins.str] = None,
                 skip_nodes_with_local_storage: Optional[builtins.str] = None,
                 skip_nodes_with_system_pods: Optional[builtins.str] = None):
        """
        Parameters to be applied to the cluster-autoscaler when enabled
        :param builtins.str balance_similar_node_groups: Valid values are 'true' and 'false'
        :param builtins.bool daemonset_eviction_for_empty_nodes: If set to true, all daemonset pods on empty nodes will be evicted before deletion of the node. If the daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be deleted without ensuring that daemonset pods are deleted or evicted.
        :param builtins.bool daemonset_eviction_for_occupied_nodes: If set to true, all daemonset pods on occupied nodes will be evicted before deletion of the node. If the daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be deleted without ensuring that daemonset pods are deleted or evicted.
        :param builtins.str expander: If not specified, the default is 'random'. See [expanders](https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/FAQ.md#what-are-expanders) for more information.
        :param builtins.bool ignore_daemonsets_utilization: If set to true, the resources used by daemonset will be taken into account when making scaling down decisions.
        :param builtins.str max_empty_bulk_delete: The default is 10.
        :param builtins.str max_graceful_termination_sec: The default is 600.
        :param builtins.str max_node_provision_time: The default is '15m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str max_total_unready_percentage: The default is 45. The maximum is 100 and the minimum is 0.
        :param builtins.str new_pod_scale_up_delay: For scenarios like burst/batch scale where you don't want CA to act before the kubernetes scheduler could schedule all the pods, you can tell CA to ignore unscheduled pods before they're a certain age. The default is '0s'. Values must be an integer followed by a unit ('s' for seconds, 'm' for minutes, 'h' for hours, etc).
        :param builtins.str ok_total_unready_count: This must be an integer. The default is 3.
        :param builtins.str scale_down_delay_after_add: The default is '10m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str scale_down_delay_after_delete: The default is the scan-interval. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str scale_down_delay_after_failure: The default is '3m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str scale_down_unneeded_time: The default is '10m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str scale_down_unready_time: The default is '20m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is supported.
        :param builtins.str scale_down_utilization_threshold: The default is '0.5'.
        :param builtins.str scan_interval: The default is '10'. Values must be an integer number of seconds.
        :param builtins.str skip_nodes_with_local_storage: The default is true.
        :param builtins.str skip_nodes_with_system_pods: The default is true.
        """
    ...
    def balance_similar_node_groups(self) -> Optional[builtins.str]:
        """
    ...
    def daemonset_eviction_for_empty_nodes(self) -> Optional[builtins.bool]:
        """
    ...
    def daemonset_eviction_for_occupied_nodes(self) -> Optional[builtins.bool]:
        """
    ...
    def max_empty_bulk_delete(self) -> Optional[builtins.str]:
        """
        The default is 10.
        """
    ...
    def max_node_provision_time(self) -> Optional[builtins.str]:
        """
    ...
    def max_total_unready_percentage(self) -> Optional[builtins.str]:
        """
    ...
    def ok_total_unready_count(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_unready_time(self) -> Optional[builtins.str]:
        """
    ...
    def skip_nodes_with_local_storage(self) -> Optional[builtins.str]:
        """
        The default is true.
        """
    ...
    def skip_nodes_with_system_pods(self) -> Optional[builtins.str]:
        """
        The default is true.
        """
...
class ManagedClusterSKUResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The SKU of a Managed Cluster.
        :param builtins.str name: The name of a managed cluster SKU.
        :param builtins.str tier: If not specified, the default is 'Free'. See [AKS Pricing Tier](https://learn.microsoft.com/azure/aks/free-standard-pricing-tiers) for more details.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if tier is not None:
...
class ManagedClusterSecurityProfileDefenderResponse(dict):
    ...
    def __init__(__self__, *,
                 log_analytics_workspace_resource_id: Optional[builtins.str] = None,
                 security_monitoring: Optional['outputs.ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse'] = None):
        """
        Microsoft Defender settings for the security profile.
        :param builtins.str log_analytics_workspace_resource_id: Resource ID of the Log Analytics workspace to be associated with Microsoft Defender. When Microsoft Defender is enabled, this field is required and must be a valid workspace resource ID. When Microsoft Defender is disabled, leave the field empty.
    ...
    def log_analytics_workspace_resource_id(self) -> Optional[builtins.str]:
        """
...
class ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Microsoft Defender settings for the security profile threat detection.
        :param builtins.bool enabled: Whether to enable Defender threat detection
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterSecurityProfileImageCleanerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Image Cleaner removes unused images from nodes, freeing up disk space and helping to reduce attack surface area. Here are settings for the security profile.
        :param builtins.bool enabled: Whether to enable Image Cleaner on AKS cluster.
        :param builtins.int interval_hours: Image Cleaner scanning interval in hours.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterSecurityProfileWorkloadIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Workload identity settings for the security profile.
        :param builtins.bool enabled: Whether to enable workload identity.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterServicePrincipalProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about a service principal identity for the cluster to use for manipulating Azure APIs.
        :param builtins.str client_id: The ID for the service principal.
        :param builtins.str secret: The secret password associated with the service principal in plain text.
        """
        pulumi.set(__self__, "client_id", client_id)
...
class ManagedClusterStorageProfileBlobCSIDriverResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        AzureBlob CSI Driver settings for the storage profile.
        :param builtins.bool enabled: Whether to enable AzureBlob CSI Driver. The default value is false.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterStorageProfileDiskCSIDriverResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        AzureDisk CSI Driver settings for the storage profile.
        :param builtins.bool enabled: Whether to enable AzureDisk CSI Driver. The default value is true.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterStorageProfileFileCSIDriverResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        AzureFile CSI Driver settings for the storage profile.
        :param builtins.bool enabled: Whether to enable AzureFile CSI Driver. The default value is true.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterStorageProfileSnapshotControllerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Snapshot Controller settings for the storage profile.
        :param builtins.bool enabled: Whether to enable Snapshot Controller. The default value is true.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterUpgradeSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The upgrade to apply to a ManagedCluster.
        :param builtins.str type: ManagedClusterUpgradeType is the type of upgrade to be applied.
        :param builtins.str kubernetes_version: The Kubernetes version to upgrade the member clusters to.
        """
        pulumi.set(__self__, "type", type)
        if kubernetes_version is not None:
            pulumi.set(__self__, "kubernetes_version", kubernetes_version)
...
class ManagedClusterWindowsProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enable_csi_proxy: For more details on CSI proxy, see the [CSI proxy GitHub repo](https://github.com/kubernetes-csi/csi-proxy).
        :param 'WindowsGmsaProfileResponse' gmsa_profile: The Windows gMSA Profile in the Managed Cluster.
        :param builtins.str license_type: The license type to use for Windows VMs. See [Azure Hybrid User Benefits](https://azure.microsoft.com/pricing/hybrid-benefit/faq/) for more details.
        """
        pulumi.set(__self__, "admin_username", admin_username)
...
class ManagedClusterWorkloadAutoScalerProfileKedaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile.
        :param builtins.bool enabled: Whether to enable KEDA.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VPA (Vertical Pod Autoscaler) settings for the workload auto-scaler profile.
        :param builtins.bool enabled: Whether to enable VPA. Default value is false.
        """
        if enabled is None:
            enabled = False
        pulumi.set(__self__, "enabled", enabled)
...
class MemberUpdateStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The status of a member update operation.
        :param builtins.str cluster_resource_id: The Azure resource id of the target Kubernetes cluster.
        :param builtins.str message: The status message after processing the member update operation.
        :param builtins.str name: The name of the FleetMember.
        :param builtins.str operation_id: The operation resource id of the latest attempt to perform the operation.
...
class NamespacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: builtins.str,
                 adoption_policy: Optional[builtins.str] = None,
                 ...
                 delete_policy: Optional[builtins.str] = None,
                 labels: Optional[Mapping[str, builtins.str]] = None):
        """
        Properties of a namespace managed by ARM
        :param builtins.str provisioning_state: The current provisioning state of the namespace.
        :param builtins.str adoption_policy: Action if Kubernetes namespace with same name already exists.
        :param Mapping[str, builtins.str] annotations: The annotations of managed namespace.
        ...
        :param builtins.str delete_policy: Delete options of a namespace.
        :param Mapping[str, builtins.str] labels: The labels of managed namespace.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
    ...
    def adoption_policy(self) -> Optional[builtins.str]:
        """
    ...
    def delete_policy(self) -> Optional[builtins.str]:
        """
...
class NetworkPoliciesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ingress: Optional[builtins.str] = None):
        """
        Default network policy of the namespace, specifying ingress and egress rules.
        :param builtins.str egress: Egress policy for the network.
        :param builtins.str ingress: Ingress policy for the network.
        """
        if egress is None:
            egress = 'AllowAll'
    ...
    @property
    @pulumi.getter
    def ingress(self) -> Optional[builtins.str]:
        """
...
class NetworkProfileForSnapshotResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        network profile for managed cluster snapshot, these properties are read only.
        :param builtins.str load_balancer_sku: loadBalancerSku for managed cluster snapshot.
        :param builtins.str network_mode: networkMode for managed cluster snapshot.
        :param builtins.str network_plugin: networkPlugin for managed cluster snapshot.
        :param builtins.str network_plugin_mode: NetworkPluginMode for managed cluster snapshot.
        :param builtins.str network_policy: networkPolicy for managed cluster snapshot.
        """
        if load_balancer_sku is not None:
            pulumi.set(__self__, "load_balancer_sku", load_balancer_sku)
        if network_mode is not None:
...
class NodeImageVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The node upgrade image version.
        :param builtins.str version: The image version to upgrade the nodes to (e.g., 'AKSUbuntu-1804gen2containerd-2022.12.13').
        """
...
class PortRangeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The port range.
        :param builtins.int port_end: The maximum port that is included in the range. It should be ranged from 1 to 65535, and be greater than or equal to portStart.
        :param builtins.int port_start: The minimum port that is included in the range. It should be ranged from 1 to 65535, and be less than or equal to portEnd.
        :param builtins.str protocol: The network protocol of the port.
        """
...
class PowerStateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the Power State of the cluster
        :param builtins.str code: Tells whether the cluster is Running or Stopped
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class PrivateEndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Private endpoint which a connection belongs to.
        :param builtins.str id: The resource ID of the private endpoint
        """
        if id is not None:
...
class PrivateLinkResourceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 required_members: Optional[Sequence[builtins.str]] = None,
                 type: Optional[builtins.str] = None):
        """
        A private link resource
        :param builtins.str private_link_service_id: The private link service ID of the resource, this field is exposed only to NRP internally.
        :param builtins.str group_id: The group ID of the resource.
        :param builtins.str id: The ID of the private link resource.
        :param builtins.str name: The name of the private link resource.
        :param Sequence[builtins.str] required_members: The RequiredMembers of the resource
    ...
    def required_members(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RelativeMonthlyScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 interval_months: builtins.int,
                 week_index: builtins.str):
        """
        For schedules like: 'recur every month on the first Monday' or 'recur every 3 months on last Friday'.
        :param builtins.str day_of_week: Specifies on which day of the week the maintenance occurs.
        :param builtins.int interval_months: Specifies the number of months between each set of occurrences.
        :param builtins.str week_index: Specifies on which week of the month the dayOfWeek applies.
        """
...
class ResourceQuotaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Resource quota for the namespace.
        :param builtins.str cpu_limit: CPU limit of the namespace in one-thousandth CPU form. See [CPU resource units](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu) for more details.
        :param builtins.str cpu_request: CPU request of the namespace in one-thousandth CPU form. See [CPU resource units](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-cpu) for more details.
        :param builtins.str memory_limit: Memory limit of the namespace in the power-of-two equivalents form: Ei, Pi, Ti, Gi, Mi, Ki. See [Memory resource units](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-memory) for more details.
        :param builtins.str memory_request: Memory request of the namespace in the power-of-two equivalents form: Ei, Pi, Ti, Gi, Mi, Ki. See [Memory resource units](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-memory) for more details.
        """
...
class ResourceReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A reference to an Azure resource.
        :param builtins.str id: The fully qualified Azure resource id.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class ServiceMeshProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Service mesh profile for a managed cluster.
        :param builtins.str mode: Mode of the service mesh.
...
class SysctlConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 net_ipv4_ip_local_port_range: Optional[builtins.str] = None,
                 ...
                 net_ipv4_tcpkeepalive_intvl: Optional[builtins.int] = None,
        ...
        """
        Sysctl settings for Linux agent nodes.
        :param builtins.int fs_aio_max_nr: Sysctl setting fs.aio-max-nr.
        :param builtins.int fs_file_max: Sysctl setting fs.file-max.
        :param builtins.int fs_inotify_max_user_watches: Sysctl setting fs.inotify.max_user_watches.
        :param builtins.int fs_nr_open: Sysctl setting fs.nr_open.
        :param builtins.int kernel_threads_max: Sysctl setting kernel.threads-max.
        :param builtins.int net_core_netdev_max_backlog: Sysctl setting net.core.netdev_max_backlog.
        :param builtins.int net_core_optmem_max: Sysctl setting net.core.optmem_max.
        :param builtins.int net_core_rmem_default: Sysctl setting net.core.rmem_default.
        :param builtins.int net_core_rmem_max: Sysctl setting net.core.rmem_max.
        :param builtins.int net_core_somaxconn: Sysctl setting net.core.somaxconn.
        :param builtins.int net_core_wmem_default: Sysctl setting net.core.wmem_default.
        :param builtins.int net_core_wmem_max: Sysctl setting net.core.wmem_max.
        :param builtins.str net_ipv4_ip_local_port_range: Sysctl setting net.ipv4.ip_local_port_range.
        :param builtins.int net_ipv4_neigh_default_gc_thresh1: Sysctl setting net.ipv4.neigh.default.gc_thresh1.
        :param builtins.int net_ipv4_neigh_default_gc_thresh2: Sysctl setting net.ipv4.neigh.default.gc_thresh2.
        :param builtins.int net_ipv4_neigh_default_gc_thresh3: Sysctl setting net.ipv4.neigh.default.gc_thresh3.
        :param builtins.int net_ipv4_tcp_fin_timeout: Sysctl setting net.ipv4.tcp_fin_timeout.
        :param builtins.int net_ipv4_tcp_keepalive_probes: Sysctl setting net.ipv4.tcp_keepalive_probes.
        :param builtins.int net_ipv4_tcp_keepalive_time: Sysctl setting net.ipv4.tcp_keepalive_time.
        :param builtins.int net_ipv4_tcp_max_syn_backlog: Sysctl setting net.ipv4.tcp_max_syn_backlog.
        :param builtins.int net_ipv4_tcp_max_tw_buckets: Sysctl setting net.ipv4.tcp_max_tw_buckets.
        :param builtins.bool net_ipv4_tcp_tw_reuse: Sysctl setting net.ipv4.tcp_tw_reuse.
        :param builtins.int net_ipv4_tcpkeepalive_intvl: Sysctl setting net.ipv4.tcp_keepalive_intvl.
        :param builtins.int net_netfilter_nf_conntrack_buckets: Sysctl setting net.netfilter.nf_conntrack_buckets.
        :param builtins.int net_netfilter_nf_conntrack_max: Sysctl setting net.netfilter.nf_conntrack_max.
        :param builtins.int vm_max_map_count: Sysctl setting vm.max_map_count.
        :param builtins.int vm_swappiness: Sysctl setting vm.swappiness.
        :param builtins.int vm_vfs_cache_pressure: Sysctl setting vm.vfs_cache_pressure.
        """
    ...
    def net_ipv4_ip_local_port_range(self) -> Optional[builtins.str]:
        """
    ...
    def net_ipv4_tcpkeepalive_intvl(self) -> Optional[builtins.int]:
        """
...
class TimeInWeekResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hour_slots: Optional[Sequence[builtins.int]] = None):
        """
        Time in a week.
        :param builtins.str day: The day of the week.
        :param Sequence[builtins.int] hour_slots: Each integer hour represents a time range beginning at 0m after the hour ending at the next hour (non-inclusive). 0 corresponds to 00:00 UTC, 23 corresponds to 23:00 UTC. Specifying [0, 1] means the 00:00 - 02:00 UTC time range.
        """
        if day is not None:
    ...
    def hour_slots(self) -> Optional[Sequence[builtins.int]]:
        """
...
class TimeSpanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        For example, between 2021-05-25T13:00:00Z and 2021-05-25T14:00:00Z.
        :param builtins.str end: The end of a time span
        :param builtins.str start: The start of a time span
        """
        if end is not None:
            pulumi.set(__self__, "end", end)
...
class UpdateGroupStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the UpdateGroup.
...
class UpdateStageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a stage which contains the groups to update and the steps to take (e.g., wait for a time period) before starting the next stage.
        :param builtins.str name: The name of the stage. Must be unique within the UpdateRun.
        :param builtins.int after_stage_wait_in_seconds: The time in seconds to wait at the end of this stage before starting the next one. Defaults to 0 seconds if unspecified.
...
class UpdateStageStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the UpdateStage.
...
class UpdateStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 completed_time: builtins.str,
                 error: 'outputs.ErrorDetailResponse',
                 start_time: builtins.str,
                 state: builtins.str):
        """
        The status for an operation or group of operations.
        :param builtins.str completed_time: The time the operation or group was completed.
        :param 'ErrorDetailResponse' error: The error details when a failure is encountered.
        :param builtins.str start_time: The time the operation or group was started.
        :param builtins.str state: The State of the operation or group.
        """
...
class UpgradeOverrideSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 force_upgrade: Optional[builtins.bool] = None,
                 until: Optional[builtins.str] = None):
        """
        Settings for overrides when upgrading a cluster.
        :param builtins.bool force_upgrade: Whether to force upgrade the cluster. Note that this option instructs upgrade operation to bypass upgrade protections such as checking for deprecated API usage. Enable this option only with caution.
        :param builtins.str until: Until when the overrides are effective. Note that this only matches the start time of an upgrade, and the effectiveness won't change once an upgrade starts even if the `until` expires as upgrade proceeds. This field is not set by default. It must be set for the overrides to take effect.
        """
    ...
    def force_upgrade(self) -> Optional[builtins.bool]:
        """
...
class WaitStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 status: 'outputs.UpdateStatusResponse',
                 wait_duration_in_seconds: builtins.int):
        """
        The status of the wait duration.
        :param 'UpdateStatusResponse' status: The status of the wait duration.
        :param builtins.int wait_duration_in_seconds: The wait duration configured in seconds.
        """
        pulumi.set(__self__, "status", status)
    ...
    def wait_duration_in_seconds(self) -> builtins.int:
        """
...
class WeeklyScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 day_of_week: builtins.str,
                 interval_weeks: builtins.int):
        """
        For schedules like: 'recur every Monday' or 'recur every 3 weeks on Wednesday'.
        :param builtins.str day_of_week: Specifies on which day of the week the maintenance occurs.
        :param builtins.int interval_weeks: Specifies the number of weeks between each set of occurrences.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
    ...
    def interval_weeks(self) -> builtins.int:
        """
...
class WindowsGmsaProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None,
                 root_domain_name: Optional[builtins.str] = None):
        """
        Windows gMSA Profile in the managed cluster.
        :param builtins.str dns_server: Specifies the DNS server for Windows gMSA. <br><br> Set it to empty if you have configured the DNS server in the vnet which is used to create the managed cluster.
        :param builtins.bool enabled: Specifies whether to enable Windows gMSA in the managed cluster.
        :param builtins.str root_domain_name: Specifies the root domain name for Windows gMSA. <br><br> Set it to empty if you have configured the DNS server in the vnet which is used to create the managed cluster.
        """
    ...
    def root_domain_name(self) -> Optional[builtins.str]:
        """
