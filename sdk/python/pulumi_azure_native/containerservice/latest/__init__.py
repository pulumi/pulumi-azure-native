...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:containerservice/latest:OpenShiftManagedCluster":
                return OpenShiftManagedCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerservice/latest:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerservice/latest", _module_instance)
