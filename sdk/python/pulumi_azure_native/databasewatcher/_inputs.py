...
class DatastoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] adx_cluster_resource_id: The ARM ResourceId of an Azure Data Explorer cluster.
...
class VaultSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] akv_resource_id: The ARM ResourceId of the Key Vault instance storing database authentication secrets.
