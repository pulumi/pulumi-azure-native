...
if not MYPY:
    class DatastoreArgsDict(TypedDict):
        ...
        """
        kusto_cluster_uri: pulumi.Input[builtins.str]
        """
        The Kusto cluster URI.
        """
        kusto_data_ingestion_uri: pulumi.Input[builtins.str]
        """
        ...
        """
        kusto_management_url: pulumi.Input[builtins.str]
        """
        The Kusto management URL.
        """
        kusto_offering_type: pulumi.Input[Union[builtins.str, 'KustoOfferingType']]
        """
        The type of a Kusto offering.
        """
        adx_cluster_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The Azure resource ID of an Azure Data Explorer cluster.
        """
        kusto_cluster_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatastoreArgs:
    def __init__(__self__, *,
                 ...
                 kusto_management_url: pulumi.Input[builtins.str],
                 kusto_offering_type: pulumi.Input[Union[builtins.str, 'KustoOfferingType']],
                 adx_cluster_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 kusto_cluster_display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The properties of a data store.
        :param pulumi.Input[builtins.str] kusto_cluster_uri: The Kusto cluster URI.
        :param pulumi.Input[builtins.str] kusto_data_ingestion_uri: The Kusto data ingestion URI.
        :param pulumi.Input[builtins.str] kusto_database_name: The name of a Kusto database.
        :param pulumi.Input[builtins.str] kusto_management_url: The Kusto management URL.
        :param pulumi.Input[Union[builtins.str, 'KustoOfferingType']] kusto_offering_type: The type of a Kusto offering.
        :param pulumi.Input[builtins.str] adx_cluster_resource_id: The Azure resource ID of an Azure Data Explorer cluster.
        :param pulumi.Input[builtins.str] kusto_cluster_display_name: The Kusto cluster display name.
        """
    ...
    def kusto_cluster_uri(self) -> pulumi.Input[builtins.str]:
        """
        The Kusto cluster URI.
        """
    ...
    def kusto_cluster_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "kusto_cluster_uri", value)

    @property
    @pulumi.getter(name="kustoDataIngestionUri")
    def kusto_data_ingestion_uri(self) -> pulumi.Input[builtins.str]:
        """
        The Kusto data ingestion URI.
        """
    ...
    def kusto_data_ingestion_uri(self, value: pulumi.Input[builtins.str]):
    ...
    def kusto_management_url(self) -> pulumi.Input[builtins.str]:
        """
        The Kusto management URL.
        """
    ...
    def kusto_management_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "kusto_management_url", value)

    @property
    @pulumi.getter(name="kustoOfferingType")
    def kusto_offering_type(self) -> pulumi.Input[Union[builtins.str, 'KustoOfferingType']]:
        """
        The type of a Kusto offering.
        """
    ...
    def kusto_offering_type(self, value: pulumi.Input[Union[builtins.str, 'KustoOfferingType']]):
        pulumi.set(self, "kusto_offering_type", value)

    @property
    @pulumi.getter(name="adxClusterResourceId")
    def adx_cluster_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Azure resource ID of an Azure Data Explorer cluster.
        """
    ...
    def adx_cluster_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "adx_cluster_resource_id", value)

    @property
    @pulumi.getter(name="kustoClusterDisplayName")
    def kusto_cluster_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Kusto cluster display name.
        """
    ...
    def kusto_cluster_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VaultSecretArgs:
    def __init__(__self__, *,
                 akv_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 akv_target_password: Optional[pulumi.Input[builtins.str]] = None,
                 akv_target_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        The vault specific details required if using SQL authentication to connect to a target.
        :param pulumi.Input[builtins.str] akv_resource_id: The Azure resource ID of the Key Vault instance storing database authentication secrets.
        :param pulumi.Input[builtins.str] akv_target_password: The path to the Key Vault secret storing the password for authentication to a target.
        :param pulumi.Input[builtins.str] akv_target_user: The path to the Key Vault secret storing the login name (aka user name, aka account name) for authentication to a target.
        """
    ...
    def akv_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Azure resource ID of the Key Vault instance storing database authentication secrets.
        """
    ...
    def akv_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "akv_resource_id", value)

    @property
    @pulumi.getter(name="akvTargetPassword")
    def akv_target_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The path to the Key Vault secret storing the password for authentication to a target.
        """
    ...
    def akv_target_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "akv_target_password", value)

    @property
    @pulumi.getter(name="akvTargetUser")
    def akv_target_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The path to the Key Vault secret storing the login name (aka user name, aka account name) for authentication to a target.
        """
    ...
    def akv_target_user(self, value: Optional[pulumi.Input[builtins.str]]):
