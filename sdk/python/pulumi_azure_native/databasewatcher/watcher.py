...
class WatcherArgs:
    def __init__(__self__, *,
                 ...
                 default_alert_rule_identity_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_alert_rule_identity_resource_id: The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.
    ...
    def default_alert_rule_identity_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_alert_rule_identity_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Watcher(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultAlertRuleIdentityResourceId")
    def default_alert_rule_identity_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.
        """
        return pulumi.get(self, "default_alert_rule_identity_resource_id")
