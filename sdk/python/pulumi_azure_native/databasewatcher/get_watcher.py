...
def get_watcher(resource_group_name: Optional[_builtins.str] = None,
                watcher_name: Optional[_builtins.str] = None,
...
def get_watcher_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                       watcher_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
