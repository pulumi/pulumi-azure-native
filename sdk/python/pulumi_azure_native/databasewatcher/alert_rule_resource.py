...
class AlertRuleResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasewatcher/v20240719preview:AlertRuleResource"), pulumi.Alias(type_="azure-native:databasewatcher/v20241001preview:AlertRuleResource"), pulumi.Alias(type_="azure-native:databasewatcher/v20250102:AlertRuleResource"), pulumi.Alias(type_="azure-native_databasewatcher_v20240719preview:databasewatcher:AlertRuleResource"), pulumi.Alias(type_="azure-native_databasewatcher_v20241001preview:databasewatcher:AlertRuleResource"), pulumi.Alias(type_="azure-native_databasewatcher_v20250102:databasewatcher:AlertRuleResource")])
