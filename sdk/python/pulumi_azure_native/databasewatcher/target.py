...
class TargetArgs:
    def __init__(__self__, *,
                 connection_server_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 target_authentication_type: pulumi.Input[Union[builtins.str, 'TargetAuthenticationType']],
        ...
        :param pulumi.Input[builtins.str] connection_server_name: The FQDN host name of the server to use in the connection string when connecting to a target. For example, for an Azure SQL logical server in the Azure commercial cloud, the value might be 'sql-logical-server-22092780.database.windows.net'; for an Azure SQL managed instance in the Azure commercial cloud, the value might be 'sql-mi-39441134.767d5869f605.database.windows.net'. Port number and instance name must be specified separately.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union[builtins.str, 'TargetAuthenticationType']] target_authentication_type: The type of authentication to use when connecting to a target.
        :param pulumi.Input[builtins.str] target_type: Discriminator property for TargetProperties.
        :param pulumi.Input[builtins.str] watcher_name: The database watcher name.
        :param pulumi.Input[builtins.str] target_name: The target resource name.
    ...
    def connection_server_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connection_server_name(self, value: pulumi.Input[builtins.str]):
    ...
    def target_authentication_type(self) -> pulumi.Input[Union[builtins.str, 'TargetAuthenticationType']]:
        """
    ...
    def target_authentication_type(self, value: pulumi.Input[Union[builtins.str, 'TargetAuthenticationType']]):
...
class Target(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connection_server_name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_authentication_type: Optional[pulumi.Input[Union[builtins.str, 'TargetAuthenticationType']]] = None,
                 target_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="connectionServerName")
    def connection_server_name(self) -> pulumi.Output[builtins.str]:
        """
        The FQDN host name of the server to use in the connection string when connecting to a target. For example, for an Azure SQL logical server in the Azure commercial cloud, the value might be 'sql-logical-server-22092780.database.windows.net'; for an Azure SQL managed instance in the Azure commercial cloud, the value might be 'sql-mi-39441134.767d5869f605.database.windows.net'. Port number and instance name must be specified separately.
        """
        return pulumi.get(self, "connection_server_name")
    ...
    @property
    @pulumi.getter(name="targetAuthenticationType")
    def target_authentication_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of authentication to use when connecting to a target.
        """
        return pulumi.get(self, "target_authentication_type")
