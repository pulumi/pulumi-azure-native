...
def get_alert_rule_resource(alert_rule_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str alert_rule_resource_name: The alert rule proxy resource name.
...
def get_alert_rule_resource_output(alert_rule_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
