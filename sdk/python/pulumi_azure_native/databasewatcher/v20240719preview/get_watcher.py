...
def get_watcher(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasewatcher/v20240719preview:getWatcher', __args__, opts=opts, typ=GetWatcherResult).value
...
def get_watcher_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['watcherName'] = watcher_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasewatcher/v20240719preview:getWatcher', __args__, opts=opts, typ=GetWatcherResult)
