...
class Target(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databasewatcher:Target"), pulumi.Alias(type_="azure-native:databasewatcher/v20230901preview:Target")])
