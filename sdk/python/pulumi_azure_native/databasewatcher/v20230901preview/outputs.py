...
class DatastoreResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str adx_cluster_resource_id: The ARM ResourceId of an Azure Data Explorer cluster.
...
class VaultSecretResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The vault specific details required if using SQL authentication to connect to a target.
        :param str akv_resource_id: The ARM ResourceId of the Key Vault instance storing database authentication secrets.
