...
class SharedPrivateLinkResourceArgs:
    def __init__(__self__, *,
                 ...
                 request_message: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dns_zone: The DNS zone segment to be included in the DNS name of the shared private link. Value is required for Azure Data Explorer clusters and SQL managed instances, and must be omitted for SQL logical servers and key vaults. The value is the second segment of the host FQDN name of the resource that the shared private link resource is for. For example: if the host name is 'adx-cluster-21187695.eastus.kusto.windows.net', then the value is 'eastus'; if the host name is 'sql-mi-23961134.767d5869f605.database.windows.net', then the value is '767d5869f605'.
        :param pulumi.Input[builtins.str] shared_private_link_resource_name: The Shared Private Link resource name.
        """
    ...
    def request_message(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def request_message(self, value: pulumi.Input[builtins.str]):
...
class SharedPrivateLinkResource(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:databasewatcher:SharedPrivateLinkResource"
    ...
    @property
    @pulumi.getter(name="dnsZone")
    def dns_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The DNS zone segment to be included in the DNS name of the shared private link. Value is required for Azure Data Explorer clusters and SQL managed instances, and must be omitted for SQL logical servers and key vaults. The value is the second segment of the host FQDN name of the resource that the shared private link resource is for. For example: if the host name is 'adx-cluster-21187695.eastus.kusto.windows.net', then the value is 'eastus'; if the host name is 'sql-mi-23961134.767d5869f605.database.windows.net', then the value is '767d5869f605'.
        """
        return pulumi.get(self, "dns_zone")
    ...
    @property
    @pulumi.getter(name="requestMessage")
    def request_message(self) -> pulumi.Output[builtins.str]:
        """
        The request message for requesting approval of the shared private link resource.
        """
        return pulumi.get(self, "request_message")
