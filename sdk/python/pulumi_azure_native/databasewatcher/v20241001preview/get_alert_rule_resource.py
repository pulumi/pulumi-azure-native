...
def get_alert_rule_resource(alert_rule_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databasewatcher/v20241001preview:getAlertRuleResource', __args__, opts=opts, typ=GetAlertRuleResourceResult).value
...
def get_alert_rule_resource_output(alert_rule_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['watcherName'] = watcher_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databasewatcher/v20241001preview:getAlertRuleResource', __args__, opts=opts, typ=GetAlertRuleResourceResult)
