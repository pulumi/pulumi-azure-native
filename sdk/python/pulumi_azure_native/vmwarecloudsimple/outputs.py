...
class GuestOSNICCustomizationResponse(dict):
    ...
    def _configure(
        ...
        if 'primaryWinsServer' in kwargs:
            primary_wins_server = kwargs['primaryWinsServer']
        if 'secondaryWinsServer' in kwargs:
