...
class DedicatedCloudServiceArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if gateway_subnet is None and 'gatewaySubnet' in kwargs:
            gateway_subnet = kwargs['gatewaySubnet']
        if gateway_subnet is None:
            raise TypeError("Missing 'gateway_subnet' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if dedicated_cloud_service_name is None and 'dedicatedCloudServiceName' in kwargs:
            dedicated_cloud_service_name = kwargs['dedicatedCloudServiceName']
