...
def get_dedicated_cloud_service(dedicated_cloud_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dedicated_cloud_service_name: dedicated cloud Service name
...
def get_dedicated_cloud_service_output(dedicated_cloud_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
