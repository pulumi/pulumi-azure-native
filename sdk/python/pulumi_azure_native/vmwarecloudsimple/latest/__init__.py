...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:vmwarecloudsimple/latest:DedicatedCloudNode":
                return DedicatedCloudNode(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:vmwarecloudsimple/latest:DedicatedCloudService":
                return DedicatedCloudService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:vmwarecloudsimple/latest:VirtualMachine":
    ...
    pulumi.runtime.register_resource_module("azure-native", "vmwarecloudsimple/latest", _module_instance)
