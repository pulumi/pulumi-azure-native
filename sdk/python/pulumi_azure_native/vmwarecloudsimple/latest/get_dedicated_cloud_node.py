...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:vmwarecloudsimple:getDedicatedCloudNode'.""", DeprecationWarning)
...
def get_dedicated_cloud_node(dedicated_cloud_node_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:vmwarecloudsimple/latest:getDedicatedCloudNode', __args__, opts=opts, typ=GetDedicatedCloudNodeResult).value
