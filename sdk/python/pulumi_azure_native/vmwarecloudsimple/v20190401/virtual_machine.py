...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine = azure_native.vmwarecloudsimple.v20190401.VirtualMachine("virtualMachine",
            amount_of_ram=4096,
            disks=[{
                "controllerId": "1000",
            ...
            resource_pool=azure_native.vmwarecloudsimple.v20190401.ResourcePoolResponseArgs(
