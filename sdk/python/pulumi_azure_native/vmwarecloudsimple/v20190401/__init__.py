...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:vmwarecloudsimple/v20190401:DedicatedCloudNode":
                return DedicatedCloudNode(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:vmwarecloudsimple/v20190401:DedicatedCloudService":
                return DedicatedCloudService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:vmwarecloudsimple/v20190401:VirtualMachine":
    ...
    pulumi.runtime.register_resource_module("azure-native", "vmwarecloudsimple/v20190401", _module_instance)
