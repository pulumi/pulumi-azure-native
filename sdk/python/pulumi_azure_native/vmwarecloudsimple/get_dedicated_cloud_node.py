...
def get_dedicated_cloud_node(dedicated_cloud_node_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dedicated_cloud_node_name: dedicated cloud node name
...
def get_dedicated_cloud_node_output(dedicated_cloud_node_name: Optional[pulumi.Input[_builtins.str]] = None,
