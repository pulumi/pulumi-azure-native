...
def get_frontends_interface(frontend_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str frontend_name: Frontends
...
def get_frontends_interface_output(frontend_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
