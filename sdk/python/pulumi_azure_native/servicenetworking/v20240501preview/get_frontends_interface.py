...
def get_frontends_interface(frontend_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20240501preview:getFrontendsInterface', __args__, opts=opts, typ=GetFrontendsInterfaceResult).value
...
def get_frontends_interface_output(frontend_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['trafficControllerName'] = traffic_controller_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicenetworking/v20240501preview:getFrontendsInterface', __args__, opts=opts, typ=GetFrontendsInterfaceResult)
