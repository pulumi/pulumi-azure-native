...
def get_traffic_controller_interface(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20240501preview:getTrafficControllerInterface', __args__, opts=opts, typ=GetTrafficControllerInterfaceResult).value
