...
class FrontendsInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20221001preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20230501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20231101:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250101:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20221001preview:servicenetworking:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20230501preview:servicenetworking:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20231101:servicenetworking:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20240501preview:servicenetworking:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20250101:servicenetworking:FrontendsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20250301preview:servicenetworking:FrontendsInterface")])
