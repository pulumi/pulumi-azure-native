...
class SecurityPoliciesInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 ip_access_rules_policy: Optional[pulumi.Input['IpAccessRulesPolicyArgs']] = None,
        ...
        :param pulumi.Input['IpAccessRulesPolicyArgs'] ip_access_rules_policy: Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
        ...
        if ip_access_rules_policy is not None:
    ...
    def ip_access_rules_policy(self) -> Optional[pulumi.Input['IpAccessRulesPolicyArgs']]:
        """
    ...
    @ip_access_rules_policy.setter
    def ip_access_rules_policy(self, value: Optional[pulumi.Input['IpAccessRulesPolicyArgs']]):
        pulumi.set(self, "ip_access_rules_policy", value)
...
class SecurityPoliciesInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ip_access_rules_policy: Optional[pulumi.Input[Union['IpAccessRulesPolicyArgs', 'IpAccessRulesPolicyArgsDict']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['IpAccessRulesPolicyArgs', 'IpAccessRulesPolicyArgsDict']] ip_access_rules_policy: Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] security_policy_name: SecurityPolicy
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["ip_access_rules_policy"] = ip_access_rules_policy
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:SecurityPoliciesInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250101:SecurityPoliciesInterface"), pulumi.Alias(type_="azure-native:servicenetworking:SecurityPoliciesInterface")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityPoliciesInterface, __self__).__init__(
            'azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["ip_access_rules_policy"] = None
    ...
    @property
    @pulumi.getter(name="ipAccessRulesPolicy")
    def ip_access_rules_policy(self) -> pulumi.Output[Optional['outputs.IpAccessRulesPolicyResponse']]:
        """
        Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
        """
        return pulumi.get(self, "ip_access_rules_policy")
