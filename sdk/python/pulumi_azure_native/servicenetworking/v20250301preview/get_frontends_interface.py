...
class GetFrontendsInterfaceResult:
    ...
    """
    def __init__(__self__, fqdn=None, id=None, location=None, name=None, provisioning_state=None, security_policy_configurations=None, system_data=None, tags=None, type=None):
...
def get_frontends_interface(frontend_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20250301preview:getFrontendsInterface', __args__, opts=opts, typ=GetFrontendsInterfaceResult).value
...
def get_frontends_interface_output(frontend_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicenetworking/v20250301preview:getFrontendsInterface', __args__, opts=opts, typ=GetFrontendsInterfaceResult)
