...
class GetSecurityPoliciesInterfaceResult:
    ...
    """
    def __init__(__self__, id=None, ip_access_rules_policy=None, location=None, name=None, policy_type=None, provisioning_state=None, system_data=None, tags=None, type=None, waf_policy=None):
        if id and not isinstance(id, str):
            raise TypeError("Expected argument 'id' to be a str")
        pulumi.set(__self__, "id", id)
        if ip_access_rules_policy and not isinstance(ip_access_rules_policy, dict):
            raise TypeError("Expected argument 'ip_access_rules_policy' to be a dict")
        pulumi.set(__self__, "ip_access_rules_policy", ip_access_rules_policy)
    ...
    @property
    @pulumi.getter(name="ipAccessRulesPolicy")
    def ip_access_rules_policy(self) -> Optional['outputs.IpAccessRulesPolicyResponse']:
        """
        Ip Access Policy of the Traffic Controller Security Policy. Single Security Policy can have only one policy type set.
        """
        return pulumi.get(self, "ip_access_rules_policy")
...
class AwaitableGetSecurityPoliciesInterfaceResult(GetSecurityPoliciesInterfaceResult):
    ...
    def __await__(self):
        ...
        return GetSecurityPoliciesInterfaceResult(
            id=self.id,
            ip_access_rules_policy=self.ip_access_rules_policy,
...
def get_security_policies_interface(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20250301preview:getSecurityPoliciesInterface', __args__, opts=opts, typ=GetSecurityPoliciesInterfaceResult).value

    return AwaitableGetSecurityPoliciesInterfaceResult(
        id=pulumi.get(__ret__, 'id'),
        ip_access_rules_policy=pulumi.get(__ret__, 'ip_access_rules_policy'),
...
def get_security_policies_interface_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicenetworking/v20250301preview:getSecurityPoliciesInterface', __args__, opts=opts, typ=GetSecurityPoliciesInterfaceResult)
    return __ret__.apply(lambda __response__: GetSecurityPoliciesInterfaceResult(
        id=pulumi.get(__response__, 'id'),
        ip_access_rules_policy=pulumi.get(__response__, 'ip_access_rules_policy'),
