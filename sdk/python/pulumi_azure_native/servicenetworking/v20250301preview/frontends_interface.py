...
class FrontendsInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SecurityPolicyConfigurationsArgs'] security_policy_configurations: Frontend Security Policy Configuration
...
class FrontendsInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union['SecurityPolicyConfigurationsArgs', 'SecurityPolicyConfigurationsArgsDict']] security_policy_configurations: Frontend Security Policy Configuration
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] traffic_controller_name: traffic controller name for path
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20221001preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20230501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20231101:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250101:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking:FrontendsInterface")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FrontendsInterface, __self__).__init__(
            'azure-native:servicenetworking/v20250301preview:FrontendsInterface',
            resource_name,
            __props__,
            opts)
