...
def get_associations_interface(association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20250301preview:getAssociationsInterface', __args__, opts=opts, typ=GetAssociationsInterfaceResult).value
...
def get_associations_interface_output(association_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicenetworking/v20250301preview:getAssociationsInterface', __args__, opts=opts, typ=GetAssociationsInterfaceResult)
