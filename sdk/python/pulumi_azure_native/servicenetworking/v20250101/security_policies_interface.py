...
class SecurityPoliciesInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:SecurityPoliciesInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250301preview:SecurityPoliciesInterface"), pulumi.Alias(type_="azure-native:servicenetworking:SecurityPoliciesInterface")])
