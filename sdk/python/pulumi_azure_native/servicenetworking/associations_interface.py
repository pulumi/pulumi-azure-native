...
class AssociationsInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20221001preview:AssociationsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20230501preview:AssociationsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20231101:AssociationsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:AssociationsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250101:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20221001preview:servicenetworking:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20230501preview:servicenetworking:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20231101:servicenetworking:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20240501preview:servicenetworking:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20250101:servicenetworking:AssociationsInterface"), pulumi.Alias(type_="azure-native_servicenetworking_v20250301preview:servicenetworking:AssociationsInterface")])
