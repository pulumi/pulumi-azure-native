...
def get_frontends_interface(frontend_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20230501preview:getFrontendsInterface', __args__, opts=opts, typ=GetFrontendsInterfaceResult).value
