...
def get_traffic_controller_interface(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking/v20221001preview:getTrafficControllerInterface', __args__, opts=opts, typ=GetTrafficControllerInterfaceResult).value
...
def get_traffic_controller_interface_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['trafficControllerName'] = traffic_controller_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicenetworking/v20221001preview:getTrafficControllerInterface', __args__, opts=opts, typ=GetTrafficControllerInterfaceResult)
