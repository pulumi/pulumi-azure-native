...
class FrontendsInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 mode: Optional[pulumi.Input['FrontendMode']] = None,
                 public_ip_address: Optional[pulumi.Input[Union['FrontendPropertiesIPAddressArgs', 'FrontendPropertiesIPAddressArgsDict']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input['FrontendMode'] mode: Frontend Mode (Optional).
        :param pulumi.Input[Union['FrontendPropertiesIPAddressArgs', 'FrontendPropertiesIPAddressArgsDict']] public_ip_address: Frontend Public IP Address (Optional).
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] traffic_controller_name: traffic controller name for path
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking/v20230501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20231101:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20240501preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250101:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking/v20250301preview:FrontendsInterface"), pulumi.Alias(type_="azure-native:servicenetworking:FrontendsInterface")])
