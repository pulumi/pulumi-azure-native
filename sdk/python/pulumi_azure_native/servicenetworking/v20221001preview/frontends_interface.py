...
class FrontendsInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        frontends_interface = azure_native.servicenetworking.v20221001preview.FrontendsInterface("frontendsInterface",
            frontend_name="fe1",
            ip_address_version=azure_native.servicenetworking/v20221001preview.FrontendIPAddressVersion.I_PV4,
            location="NorthCentralUS",
            mode=azure_native.servicenetworking/v20221001preview.FrontendMode.PUBLIC,
            public_ip_address=azure_native.servicenetworking.v20221001preview.FrontendPropertiesIPAddressResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicenetworking:FrontendsInterface")])
