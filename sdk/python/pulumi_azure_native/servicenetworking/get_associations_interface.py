...
def get_associations_interface(association_name: Optional[builtins.str] = None,
    ...
    :param builtins.str association_name: Name of Association
...
def get_associations_interface_output(association_name: Optional[pulumi.Input[builtins.str]] = None,
