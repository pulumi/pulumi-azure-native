...
def get_associations_interface(association_name: Optional[_builtins.str] = None,
                               resource_group_name: Optional[_builtins.str] = None,
                               traffic_controller_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str association_name: Name of Association
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicenetworking:getAssociationsInterface', __args__, opts=opts, typ=GetAssociationsInterfaceResult).value
...
def get_associations_interface_output(association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
