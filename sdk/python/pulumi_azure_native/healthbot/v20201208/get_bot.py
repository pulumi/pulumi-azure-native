...
warnings.warn("""Version 2020-12-08 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_bot(bot_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: Version 2020-12-08 will be removed in v2 of the provider.""")
    __args__ = dict()
