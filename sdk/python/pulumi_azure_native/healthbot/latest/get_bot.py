...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:healthbot:getBot'.""", DeprecationWarning)
...
def get_bot(bot_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthbot/latest:getBot', __args__, opts=opts, typ=GetBotResult).value
