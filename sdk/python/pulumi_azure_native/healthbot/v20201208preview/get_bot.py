...
warnings.warn("""Version 2020-12-08-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_bot(bot_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: Version 2020-12-08-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['botName'] = bot_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:healthbot/v20201208preview:getBot', __args__, opts=opts, typ=GetBotResult).value
