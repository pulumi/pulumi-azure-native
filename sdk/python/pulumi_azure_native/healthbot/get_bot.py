...
def get_bot(bot_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The name of the Bot resource group in the user subscription.
    """
    __args__ = dict()
...
def get_bot_output(bot_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
