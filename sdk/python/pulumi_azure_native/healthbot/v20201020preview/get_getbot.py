...
def get_getbot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_getbot is deprecated: Version 2020-10-20-preview will be removed in v2 of the provider.""")
    __args__ = dict()
...
@_utilities.lift_output_func(get_getbot)
def get_getbot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
