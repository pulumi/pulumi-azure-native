...
__all__ = [
    'GetgetbotResult',
    'AwaitableGetgetbotResult',
    'getgetbot',
    'getgetbot_output',
]

warnings.warn("""Version 2020-10-20-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class AwaitableGetgetbotResult(GetgetbotResult):
...
def getgetbot(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthbot/v20201020preview:getgetbot', __args__, opts=opts, typ=GetgetbotResult).value
...
@_utilities.lift_output_func(getgetbot)
def getgetbot_output(resource_group_name: Optional[pulumi.Input[str]] = None,
