...
def list_bot_secrets(bot_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthbot/v20240201:listBotSecrets', __args__, opts=opts, typ=ListBotSecretsResult).value
...
def list_bot_secrets_output(bot_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthbot/v20240201:listBotSecrets', __args__, opts=opts, typ=ListBotSecretsResult)
