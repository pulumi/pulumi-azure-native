...
def get_bot(bot_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: azure-native:healthbot/v20210824:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:healthbot/v20230501:Bot to guarantee forwards compatibility.""")
    __args__ = dict()
