...
def get_bot(bot_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: azure-native:healthbot/v20210824:Bot is being removed in the next major version of this provider. Please upgrade to azure-native:healthbot/v20220808:Bot to guarantee forwards compatibility.""")
    __args__ = dict()
