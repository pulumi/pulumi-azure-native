...
class HealthBotPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 bot_management_portal_link: builtins.str,
                 provisioning_state: builtins.str,
                 key_vault_properties: Optional['outputs.KeyVaultPropertiesResponse'] = None):
        """
        The properties of a Azure Health Bot. The Health Bot Service is a cloud platform that empowers developers in Healthcare organizations to build and deploy their compliant, AI-powered virtual health assistants and health bots, that help them improve processes and reduce costs.
        :param builtins.str bot_management_portal_link: The link.
        :param builtins.str provisioning_state: The provisioning state of the Azure Health Bot resource.
    ...
    def bot_management_portal_link(self) -> builtins.str:
        """
        The link.
        """
...
class IdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the resource.
        :param builtins.str principal_id: The principal ID of resource identity. This property will only be provided for a system assigned identity.
        :param builtins.str tenant_id: The tenant ID of resource. This property will only be provided for a system assigned identity.
        :param builtins.str type: The identity type. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the Azure Health Bot
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The resource model definition representing SKU
        :param builtins.str name: The name of the Azure Health Bot SKU
        """
