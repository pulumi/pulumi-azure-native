...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:dbforpostgresql:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql:ServerAdministrator":
    ...
    pulumi.runtime.register_resource_module("azure-native", "dbforpostgresql", _module_instance)
