...
class GetServerGroupRoleResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, object_id=None, principal_type=None, provisioning_state=None, role_type=None, system_data=None, tenant_id=None, type=None):
...
def get_server_group_role(cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str role_name: The name of the cluster role.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getServerGroupRole', __args__, opts=opts, typ=GetServerGroupRoleResult).value
...
def get_server_group_role_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql:getServerGroupRole', __args__, opts=opts, typ=GetServerGroupRoleResult)
