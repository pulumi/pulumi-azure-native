...
__all__ = [
    ...
    'AwaitableGetServerGroupFirewallRuleResult',
    'get_server_group_firewall_rule',
    'get_server_group_firewall_rule_output',
]
...
class AwaitableGetServerGroupFirewallRuleResult(GetServerGroupFirewallRuleResult):
...
def get_server_group_firewall_rule(cluster_name: Optional[str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServerGroupFirewallRuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20221108:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult).value

    return AwaitableGetServerGroupFirewallRuleResult(
...
def get_server_group_firewall_rule_output(cluster_name: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServerGroupFirewallRuleResult]:
    """
    Gets information about a cluster firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20221108:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult)
    return __ret__.apply(lambda __response__: GetServerGroupFirewallRuleResult(
