...
class ServerGroupCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerGroupCluster"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20201005privatepreview:ServerGroupCluster"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerGroupCluster, __self__).__init__(
            'azure-native:dbforpostgresql/v20221108:ServerGroupCluster',
            resource_name,
            __props__,
            opts)
