...
def get_server_group_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20221108:getServerGroupCluster', __args__, opts=opts, typ=GetServerGroupClusterResult).value
...
def get_server_group_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20221108:getServerGroupCluster', __args__, opts=opts, typ=GetServerGroupClusterResult)
