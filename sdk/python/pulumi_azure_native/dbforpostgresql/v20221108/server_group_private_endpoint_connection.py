...
class ServerGroupPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerGroupPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroupPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerGroupPrivateEndpointConnection, __self__).__init__(
            'azure-native:dbforpostgresql/v20221108:ServerGroupPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
