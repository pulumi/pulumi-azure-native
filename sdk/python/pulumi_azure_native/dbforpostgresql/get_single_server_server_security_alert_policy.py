...
class GetSingleServerServerSecurityAlertPolicyResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, disabled_alerts=None, email_account_admins=None, email_addresses=None, id=None, name=None, retention_days=None, state=None, storage_account_access_key=None, storage_endpoint=None, type=None):
...
def get_single_server_server_security_alert_policy(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getSingleServerServerSecurityAlertPolicy', __args__, opts=opts, typ=GetSingleServerServerSecurityAlertPolicyResult).value
...
def get_single_server_server_security_alert_policy_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql:getSingleServerServerSecurityAlertPolicy', __args__, opts=opts, typ=GetSingleServerServerSecurityAlertPolicyResult)
