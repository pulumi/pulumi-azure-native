...
def get_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20231201preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20231201preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
