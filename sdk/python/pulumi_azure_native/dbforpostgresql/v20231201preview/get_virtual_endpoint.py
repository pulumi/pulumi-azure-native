...
def get_virtual_endpoint(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20231201preview:getVirtualEndpoint', __args__, opts=opts, typ=GetVirtualEndpointResult).value
...
def get_virtual_endpoint_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualEndpointName'] = virtual_endpoint_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20231201preview:getVirtualEndpoint', __args__, opts=opts, typ=GetVirtualEndpointResult)
