...
def get_migration(migration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20241101preview:getMigration', __args__, opts=opts, typ=GetMigrationResult).value
...
def get_migration_output(migration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetDbServerName'] = target_db_server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20241101preview:getMigration', __args__, opts=opts, typ=GetMigrationResult)
