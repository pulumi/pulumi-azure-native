...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        """
        Cluster properties of a server.
        :param pulumi.Input[int] cluster_size: The node count for the cluster.
        """
...
class StorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] iops: Storage tier IOPS quantity. This property is required to be set for storage Type PremiumV2_LRS and UltraSSD_LRS.
        :param pulumi.Input[int] storage_size_gb: Max storage allowed for a server.
        :param pulumi.Input[int] throughput: Storage throughput for the server. This is required to be set for storage Type PremiumV2_LRS and UltraSSD_LRS.
        :param pulumi.Input[Union[str, 'AzureManagedDiskPerformanceTiers']] tier: Name of storage tier for IOPS.
        :param pulumi.Input[Union[str, 'StorageType']] type: Storage type for the server. Allowed values are Premium_LRS, PremiumV2_LRS, and UltraSSD_LRS. Default is Premium_LRS if not specified
        """
