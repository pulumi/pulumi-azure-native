...
class MigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'SourceType']] source_type: migration source server type : OnPremises, AWS, GCP, AzureVM, PostgreSQLSingleServer, AWS_RDS, AWS_AURORA, AWS_EC2, GCP_CloudSQL, GCP_AlloyDB, GCP_Compute, EDB, EDB_Oracle_Server, EDB_PostgreSQL, PostgreSQLFlexibleServer, PostgreSQLCosmosDB, Huawei_RDS, Huawei_Compute, Heroku_PostgreSQL, Crunchy_PostgreSQL, ApsaraDB_RDS, Digital_Ocean_Droplets, Digital_Ocean_PostgreSQL, or Supabase_PostgreSQL
...
class Migration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Migration, __self__).__init__(
            'azure-native:dbforpostgresql/v20241101preview:Migration',
            resource_name,
            __props__,
            opts)
