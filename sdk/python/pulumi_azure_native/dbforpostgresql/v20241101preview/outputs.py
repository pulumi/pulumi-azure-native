...
class ClusterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster properties of a server.
        :param int cluster_size: The node count for the cluster.
        """
...
class StorageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int iops: Storage tier IOPS quantity. This property is required to be set for storage Type PremiumV2_LRS and UltraSSD_LRS.
        :param int storage_size_gb: Max storage allowed for a server.
        :param int throughput: Storage throughput for the server. This is required to be set for storage Type PremiumV2_LRS and UltraSSD_LRS.
        :param str tier: Name of storage tier for IOPS.
        :param str type: Storage type for the server. Allowed values are Premium_LRS, PremiumV2_LRS, and UltraSSD_LRS. Default is Premium_LRS if not specified
        """
