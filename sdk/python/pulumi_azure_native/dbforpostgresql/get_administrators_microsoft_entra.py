...
def get_administrators_microsoft_entra(object_id: Optional[_builtins.str] = None,
                                       resource_group_name: Optional[_builtins.str] = None,
                                       server_name: Optional[_builtins.str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAdministratorsMicrosoftEntraResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getAdministratorsMicrosoftEntra', __args__, opts=opts, typ=GetAdministratorsMicrosoftEntraResult).value

    return AwaitableGetAdministratorsMicrosoftEntraResult(
...
def get_administrators_microsoft_entra_output(object_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql:getAdministratorsMicrosoftEntra', __args__, opts=opts, typ=GetAdministratorsMicrosoftEntraResult)
    return __ret__.apply(lambda __response__: GetAdministratorsMicrosoftEntraResult(
