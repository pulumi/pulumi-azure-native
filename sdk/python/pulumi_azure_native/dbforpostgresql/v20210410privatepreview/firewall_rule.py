...
warnings.warn("""azure-native:dbforpostgresql/v20210410privatepreview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20221108:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 start_ip_address: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallRule is deprecated: azure-native:dbforpostgresql/v20210410privatepreview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20221108:FirewallRule to guarantee forwards compatibility.""")
