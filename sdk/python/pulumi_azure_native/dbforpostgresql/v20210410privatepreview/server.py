...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(delegated_subnet_arguments, ServerPropertiesDelegatedSubnetArgumentsArgs):
            ...
            if not isinstance(private_dns_zone_arguments, ServerPropertiesPrivateDnsZoneArgumentsArgs):
