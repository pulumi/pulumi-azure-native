...
class GetConfigurationResult:
    ...
    def is_config_pending_restart(self) -> builtins.bool:
        """
    ...
    def is_dynamic_config(self) -> builtins.bool:
        """
...
def get_configuration(configuration_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult).value
...
def get_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetConfigurationResult(
        ...
        is_config_pending_restart=pulumi.get(__response__, 'is_config_pending_restart'),
        is_dynamic_config=pulumi.get(__response__, 'is_dynamic_config'),
