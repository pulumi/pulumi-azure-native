...
def get_configuration(configuration_name: Optional[_builtins.str] = None,
...
def get_configuration_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
