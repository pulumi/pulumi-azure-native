...
warnings.warn("""azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy")])
