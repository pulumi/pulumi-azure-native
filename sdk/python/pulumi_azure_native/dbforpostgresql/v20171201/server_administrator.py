...
class ServerAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_administrator = azure_native.dbforpostgresql.v20171201.ServerAdministrator("serverAdministrator",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:ServerAdministrator")])
