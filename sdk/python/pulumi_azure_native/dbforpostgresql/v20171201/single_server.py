...
class SingleServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:SingleServer"), pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServer, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201:SingleServer',
            resource_name,
            __props__,
            opts)
