...
class SingleServerVirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:SingleServerVirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServerVirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerVirtualNetworkRule, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201:SingleServerVirtualNetworkRule',
            resource_name,
            __props__,
            opts)
