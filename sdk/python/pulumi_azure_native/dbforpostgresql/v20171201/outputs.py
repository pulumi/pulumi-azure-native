...
class ServerPrivateEndpointConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServerPrivateEndpointConnectionPropertiesResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class ServerPrivateEndpointConnectionResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             id: Optional[str] = None,
             properties: Optional['outputs.ServerPrivateEndpointConnectionPropertiesResponse'] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if id is None:
...
class ServerPrivateLinkServiceConnectionStatePropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServerPrivateLinkServiceConnectionStatePropertyResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
