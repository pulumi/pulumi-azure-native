...
def get_single_server_firewall_rule(firewall_rule_name: Optional[str] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSingleServerFirewallRuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20171201:getSingleServerFirewallRule', __args__, opts=opts, typ=GetSingleServerFirewallRuleResult).value

    return AwaitableGetSingleServerFirewallRuleResult(
...
def get_single_server_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSingleServerFirewallRuleResult]:
    """
    Gets information about a server firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20171201:getSingleServerFirewallRule', __args__, opts=opts, typ=GetSingleServerFirewallRuleResult)
    return __ret__.apply(lambda __response__: GetSingleServerFirewallRuleResult(
