...
__all__ = [
    ...
    'get_single_server_server_security_alert_policy_output',
]
...
class AwaitableGetSingleServerServerSecurityAlertPolicyResult(GetSingleServerServerSecurityAlertPolicyResult):
...
def get_single_server_server_security_alert_policy(resource_group_name: Optional[str] = None,
                                                   ...
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSingleServerServerSecurityAlertPolicyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20171201:getSingleServerServerSecurityAlertPolicy', __args__, opts=opts, typ=GetSingleServerServerSecurityAlertPolicyResult).value

    return AwaitableGetSingleServerServerSecurityAlertPolicyResult(
...
def get_single_server_server_security_alert_policy_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20171201:getSingleServerServerSecurityAlertPolicy', __args__, opts=opts, typ=GetSingleServerServerSecurityAlertPolicyResult)
    return __ret__.apply(lambda __response__: GetSingleServerServerSecurityAlertPolicyResult(
