...
def get_single_server_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20171201:getSingleServerDatabase', __args__, opts=opts, typ=GetSingleServerDatabaseResult).value
...
def get_single_server_database_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20171201:getSingleServerDatabase', __args__, opts=opts, typ=GetSingleServerDatabaseResult)
