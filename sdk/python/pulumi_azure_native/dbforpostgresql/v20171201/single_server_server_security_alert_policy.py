...
__all__ = ['SingleServerServerSecurityAlertPolicyArgs', 'SingleServerServerSecurityAlertPolicy']
...
class SingleServerServerSecurityAlertPolicyArgs:
    def __init__(__self__, *,
                 ...
                 state: pulumi.Input['ServerSecurityAlertPolicyState'],
    ...
    @property
    @pulumi.getter
    def state(self) -> pulumi.Input['ServerSecurityAlertPolicyState']:
        """
    ...
    @state.setter
    def state(self, value: pulumi.Input['ServerSecurityAlertPolicyState']):
...
class SingleServerServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 state: Optional[pulumi.Input['ServerSecurityAlertPolicyState']] = None,
                 storage_account_access_key: Optional[pulumi.Input[str]] = None,
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SingleServerServerSecurityAlertPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SingleServerServerSecurityAlertPolicyArgs.__new__(SingleServerServerSecurityAlertPolicyArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:SingleServerServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServerServerSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerServerSecurityAlertPolicy, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201:SingleServerServerSecurityAlertPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SingleServerServerSecurityAlertPolicy':
        """
        ...
        __props__.__dict__["type"] = None
        return SingleServerServerSecurityAlertPolicy(resource_name, opts=opts, __props__=__props__)
