...
def get_server_administrator(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_administrator is deprecated: azure-native:dbforpostgresql/v20171201:ServerAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20171201preview:ServerAdministrator to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20171201:getServerAdministrator', __args__, opts=opts, typ=GetServerAdministratorResult).value
