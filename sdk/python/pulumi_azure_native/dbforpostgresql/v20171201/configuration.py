...
class Configuration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration = azure_native.dbforpostgresql.v20171201.Configuration("configuration",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:Configuration")])
