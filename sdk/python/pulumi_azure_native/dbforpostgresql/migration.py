...
class MigrationArgs:
    ...
    def _configure(
        ...
        if dbs_to_cancel_migration_on is None and 'dbsToCancelMigrationOn' in kwargs:
            dbs_to_cancel_migration_on = kwargs['dbsToCancelMigrationOn']
        if dbs_to_migrate is None and 'dbsToMigrate' in kwargs:
            dbs_to_migrate = kwargs['dbsToMigrate']
        if dbs_to_trigger_cutover_on is None and 'dbsToTriggerCutoverOn' in kwargs:
        ...
        if migration_window_end_time_in_utc is None and 'migrationWindowEndTimeInUtc' in kwargs:
        ...
        if source_db_server_fully_qualified_domain_name is None and 'sourceDbServerFullyQualifiedDomainName' in kwargs:
        ...
        if target_db_server_fully_qualified_domain_name is None and 'targetDbServerFullyQualifiedDomainName' in kwargs:
