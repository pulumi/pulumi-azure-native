...
class GetMigrationResult:
    ...
    """
    def __init__(__self__, cancel=None, current_status=None, d_bs_to_cancel_migration_on=None, d_bs_to_migrate=None, d_bs_to_tigger_cutover_on=None, id=None, location=None, migration_details_level=None, migration_id=None, migration_mode=None, migration_window_start_time_in_utc=None, name=None, overwrite_dbs_in_target=None, setup_logical_replication_on_source_db_if_needed=None, source_db_server_fully_qualified_domain_name=None, source_db_server_metadata=None, source_db_server_resource_id=None, start_data_migration=None, system_data=None, tags=None, target_db_server_fully_qualified_domain_name=None, target_db_server_metadata=None, target_db_server_resource_id=None, trigger_cutover=None, type=None):
        if cancel and not isinstance(cancel, bool):
            raise TypeError("Expected argument 'cancel' to be a bool")
        ...
        if d_bs_to_cancel_migration_on and not isinstance(d_bs_to_cancel_migration_on, list):
            raise TypeError("Expected argument 'd_bs_to_cancel_migration_on' to be a list")
        ...
        if d_bs_to_tigger_cutover_on and not isinstance(d_bs_to_tigger_cutover_on, list):
            raise TypeError("Expected argument 'd_bs_to_tigger_cutover_on' to be a list")
    ...
    def d_bs_to_cancel_migration_on(self) -> Optional[Sequence[str]]:
        """
    ...
    def d_bs_to_tigger_cutover_on(self) -> Optional[Sequence[str]]:
        """
...
class AwaitableGetMigrationResult(GetMigrationResult):
    ...
    def __await__(self):
        ...
        return GetMigrationResult(
            ...
            d_bs_to_cancel_migration_on=self.d_bs_to_cancel_migration_on,
            d_bs_to_migrate=self.d_bs_to_migrate,
            d_bs_to_tigger_cutover_on=self.d_bs_to_tigger_cutover_on,
            id=self.id,
...
def get_migration(migration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20220501preview:getMigration', __args__, opts=opts, typ=GetMigrationResult).value

    return AwaitableGetMigrationResult(
        cancel=pulumi.get(__ret__, 'cancel'),
        current_status=pulumi.get(__ret__, 'current_status'),
        d_bs_to_cancel_migration_on=pulumi.get(__ret__, 'd_bs_to_cancel_migration_on'),
        d_bs_to_migrate=pulumi.get(__ret__, 'd_bs_to_migrate'),
        d_bs_to_tigger_cutover_on=pulumi.get(__ret__, 'd_bs_to_tigger_cutover_on'),
        id=pulumi.get(__ret__, 'id'),
        location=pulumi.get(__ret__, 'location'),
        migration_details_level=pulumi.get(__ret__, 'migration_details_level'),
...
def get_migration_output(migration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetDBServerName'] = target_db_server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20220501preview:getMigration', __args__, opts=opts, typ=GetMigrationResult)
    return __ret__.apply(lambda __response__: GetMigrationResult(
        ...
        d_bs_to_cancel_migration_on=pulumi.get(__response__, 'd_bs_to_cancel_migration_on'),
        d_bs_to_migrate=pulumi.get(__response__, 'd_bs_to_migrate'),
        d_bs_to_tigger_cutover_on=pulumi.get(__response__, 'd_bs_to_tigger_cutover_on'),
