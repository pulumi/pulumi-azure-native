...
warnings.warn("""azure-native:dbforpostgresql/v20180601:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20180601privatepreview:PrivateEndpointConnection")])
