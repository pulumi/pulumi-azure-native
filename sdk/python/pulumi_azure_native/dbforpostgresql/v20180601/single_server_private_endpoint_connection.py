...
__all__ = ['SingleServerPrivateEndpointConnectionArgs', 'SingleServerPrivateEndpointConnection']

@pulumi.input_type
class SingleServerPrivateEndpointConnectionArgs:
...
class SingleServerPrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SingleServerPrivateEndpointConnectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        A private endpoint connection

        :param str resource_name: The name of the resource.
        :param SingleServerPrivateEndpointConnectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SingleServerPrivateEndpointConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SingleServerPrivateEndpointConnectionArgs.__new__(SingleServerPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20180601privatepreview:SingleServerPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerPrivateEndpointConnection, __self__).__init__(
            'azure-native:dbforpostgresql/v20180601:SingleServerPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SingleServerPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return SingleServerPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
