...
class ServerGroupFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_ip_address: The start IP address of the cluster firewall rule. Must be IPv4 format.
        :param pulumi.Input[_builtins.str] firewall_rule_name: The name of the cluster firewall rule.
        """
