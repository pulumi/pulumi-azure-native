...
class ServerGroupFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_ip_address: The end IP address of the cluster firewall rule. Must be IPv4 format.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] start_ip_address: The start IP address of the cluster firewall rule. Must be IPv4 format.
        :param pulumi.Input[builtins.str] firewall_rule_name: The name of the cluster firewall rule.
        """
...
@pulumi.type_token("azure-native:dbforpostgresql:ServerGroupFirewallRule")
