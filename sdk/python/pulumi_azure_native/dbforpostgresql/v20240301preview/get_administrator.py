...
def get_administrator(object_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20240301preview:getAdministrator', __args__, opts=opts, typ=GetAdministratorResult).value
...
def get_administrator_output(object_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20240301preview:getAdministrator', __args__, opts=opts, typ=GetAdministratorResult)
