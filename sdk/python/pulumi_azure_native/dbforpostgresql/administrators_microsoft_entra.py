...
@pulumi.type_token("azure-native:dbforpostgresql:AdministratorsMicrosoftEntra")
class AdministratorsMicrosoftEntra(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AdministratorsMicrosoftEntraArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20220308preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20221201:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20221201:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230301preview:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230301preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230601preview:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230601preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20231201preview:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20231201preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20240301preview:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20240301preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20240801:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20240801:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20241101preview:Administrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20241101preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20250101preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20250601preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20250801:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20260101preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20260401preview:AdministratorsMicrosoftEntra"), pulumi.Alias(type_="azure-native:dbforpostgresql:Administrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AdministratorsMicrosoftEntra, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AdministratorsMicrosoftEntra':
        """
        ...
        __props__.__dict__["type"] = None
        return AdministratorsMicrosoftEntra(resource_name, opts=opts, __props__=__props__)
