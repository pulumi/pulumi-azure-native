...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbforpostgresql:Server'.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""Server is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbforpostgresql:Server'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:Server"), pulumi.Alias(type_="azure-native:dbforpostgresql:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:Server"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:Server"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:Server"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:Server")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Server, __self__).__init__(
            'azure-native:dbforpostgresql/latest:Server',
            resource_name,
            __props__,
            opts)
