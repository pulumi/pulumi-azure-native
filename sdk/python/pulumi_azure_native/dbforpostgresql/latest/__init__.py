...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:dbforpostgresql/latest:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:ServerAdministrator":
                return ServerAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:ServerKey":
                return ServerKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/latest:VirtualNetworkRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "dbforpostgresql/latest", _module_instance)
