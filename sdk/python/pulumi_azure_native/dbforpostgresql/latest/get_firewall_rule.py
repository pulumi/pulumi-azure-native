...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getFirewallRule'.""", DeprecationWarning)
...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getFirewallRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/latest:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
