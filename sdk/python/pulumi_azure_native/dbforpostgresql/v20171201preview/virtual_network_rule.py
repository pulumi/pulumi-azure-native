...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbforpostgresql:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:VirtualNetworkRule")])
