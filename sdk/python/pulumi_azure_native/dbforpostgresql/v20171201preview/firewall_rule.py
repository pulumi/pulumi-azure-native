...
class FirewallRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:FirewallRule")])
