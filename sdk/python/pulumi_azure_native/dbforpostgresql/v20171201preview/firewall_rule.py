...
warnings.warn("""azure-native:dbforpostgresql/v20171201preview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20201005privatepreview:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
