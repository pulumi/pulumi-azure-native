...
warnings.warn("""azure-native:dbforpostgresql/v20171201preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20201005privatepreview:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
