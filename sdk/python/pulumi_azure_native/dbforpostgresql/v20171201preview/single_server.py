...
class SingleServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SingleServerSkuArgs'] sku: The SKU (pricing tier) of the server.
...
class SingleServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] server_name: The name of the server.
        :param pulumi.Input[Union['SingleServerSkuArgs', 'SingleServerSkuArgsDict']] sku: The SKU (pricing tier) of the server.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Application-specific metadata in the form of key-value pairs.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:SingleServer"), pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServer, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:SingleServer',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def sku(self) -> pulumi.Output[Optional['outputs.SingleServerSkuResponse']]:
        """
        The SKU (pricing tier) of the server.
        """
        return pulumi.get(self, "sku")
