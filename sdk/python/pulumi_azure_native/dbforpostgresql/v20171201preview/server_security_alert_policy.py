...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_security_alert_policy = azure_native.dbforpostgresql.v20171201preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy",
            disabled_alerts=[
                "Access_Anomaly",
                "Usage_Anomaly",
            ],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy")])
