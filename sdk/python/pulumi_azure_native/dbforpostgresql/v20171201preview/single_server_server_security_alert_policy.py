...
class SingleServerServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:SingleServerServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:SingleServerServerSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SingleServerServerSecurityAlertPolicy, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:SingleServerServerSecurityAlertPolicy',
            resource_name,
            __props__,
            opts)
