...
def get_single_server_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20171201preview:getSingleServerVirtualNetworkRule', __args__, opts=opts, typ=GetSingleServerVirtualNetworkRuleResult).value
...
def get_single_server_virtual_network_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20171201preview:getSingleServerVirtualNetworkRule', __args__, opts=opts, typ=GetSingleServerVirtualNetworkRuleResult)
