...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:dbforpostgresql/v20171201preview:Configuration":
                return Configuration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/v20171201preview:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/v20171201preview:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:dbforpostgresql/v20171201preview:Server":
    ...
    pulumi.runtime.register_resource_module("azure-native", "dbforpostgresql/v20171201preview", _module_instance)
