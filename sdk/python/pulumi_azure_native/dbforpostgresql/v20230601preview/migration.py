...
class MigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'SourceType']] source_type: migration source server type : OnPremises, AWS, GCP, AzureVM or PostgreSQLSingleServer
