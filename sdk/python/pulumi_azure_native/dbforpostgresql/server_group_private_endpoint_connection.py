...
__all__ = ['ServerGroupPrivateEndpointConnectionArgs', 'ServerGroupPrivateEndpointConnection']
...
class ServerGroupPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ServerGroupPrivateEndpointConnectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The private endpoint connection resource.
        Azure REST API version: 2023-03-02-preview.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServerGroupPrivateEndpointConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServerGroupPrivateEndpointConnectionArgs.__new__(ServerGroupPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:ServerGroupPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroupPrivateEndpointConnection")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServerGroupPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ServerGroupPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
