...
warnings.warn("""azure-native:dbforpostgresql/v20200214privatepreview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210410privatepreview:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[Union[str, 'ServerVersion']]] = None,
                 __props__=None):
        pulumi.log.warn("""Server is deprecated: azure-native:dbforpostgresql/v20200214privatepreview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210410privatepreview:Server to guarantee forwards compatibility.""")
        ...
        super(Server, __self__).__init__(
            'azure-native:dbforpostgresql/v20200214privatepreview:Server',
            resource_name,
            __props__,
            opts)
