...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.dbforpostgresql.v20180601privatepreview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="private-endpoint-connection-name",
            private_link_service_connection_state=azure_native.dbforpostgresql.v20180601privatepreview.PrivateLinkServiceConnectionStatePropertyResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20180601:PrivateEndpointConnection")])
