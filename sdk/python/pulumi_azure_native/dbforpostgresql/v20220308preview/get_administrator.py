...
warnings.warn("""azure-native:dbforpostgresql/v20220308preview:Administrator is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Administrator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_administrator(object_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_administrator is deprecated: azure-native:dbforpostgresql/v20220308preview:Administrator is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Administrator to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['objectId'] = object_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20220308preview:getAdministrator', __args__, opts=opts, typ=GetAdministratorResult).value
