...
class ServerArgs:
    def __init__(__self__, *,
                 ...
                 sku: Optional[pulumi.Input['PostgreSqlSkuArgs']] = None,
        ...
        :param pulumi.Input['PostgreSqlSkuArgs'] sku: The SKU (pricing tier) of the server.
    ...
    @property
    @pulumi.getter
    def sku(self) -> Optional[pulumi.Input['PostgreSqlSkuArgs']]:
        """
    ...
    @sku.setter
    def sku(self, value: Optional[pulumi.Input['PostgreSqlSkuArgs']]):
...
class Server(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 sku: Optional[pulumi.Input[pulumi.InputType['PostgreSqlSkuArgs']]] = None,
                 source_server_resource_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] server_name: The name of the server.
        :param pulumi.Input[pulumi.InputType['PostgreSqlSkuArgs']] sku: The SKU (pricing tier) of the server.
        :param pulumi.Input[str] source_server_resource_id: The source server resource ID to restore from. It's required when 'createMode' is 'PointInTimeRestore' or 'GeoRestore' or 'Replica'.
    ...
    def _internal_init(__self__,
        ...
        super(Server, __self__).__init__(
            'azure-native:dbforpostgresql/v20220308preview:Server',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def sku(self) -> pulumi.Output[Optional['outputs.PostgreSqlSkuResponse']]:
        """
        The SKU (pricing tier) of the server.
        """
        return pulumi.get(self, "sku")
