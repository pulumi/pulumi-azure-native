...
warnings.warn("""azure-native:dbforpostgresql/v20220308preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20230301preview:Configuration to guarantee forwards compatibility.""", DeprecationWarning)
...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 value: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Configuration is deprecated: azure-native:dbforpostgresql/v20220308preview:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20230301preview:Configuration to guarantee forwards compatibility.""")
        ...
        super(Configuration, __self__).__init__(
            'azure-native:dbforpostgresql/v20220308preview:Configuration',
            resource_name,
            __props__,
            opts)
