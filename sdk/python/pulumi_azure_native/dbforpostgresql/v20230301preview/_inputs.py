...
class AuthConfigArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'activeDirectoryAuth' in kwargs:
            active_directory_auth = kwargs['activeDirectoryAuth']
        if 'passwordAuth' in kwargs:
...
class DataEncryptionArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'geoBackupEncryptionKeyStatus' in kwargs:
        ...
        if 'primaryEncryptionKeyStatus' in kwargs:
...
class MigrationSecretParametersArgs:
    ...
    def _configure(
        ...
        if 'sourceServerUsername' in kwargs:
            source_server_username = kwargs['sourceServerUsername']
        if 'targetServerUsername' in kwargs:
