...
def get_migration(migration_name: Optional[str] = None,
    ...
    return AwaitableGetMigrationResult(
        ...
        dbs_to_cancel_migration_on=__ret__.dbs_to_cancel_migration_on,
        dbs_to_migrate=__ret__.dbs_to_migrate,
        dbs_to_trigger_cutover_on=__ret__.dbs_to_trigger_cutover_on,
        id=__ret__.id,
        location=__ret__.location,
        migration_id=__ret__.migration_id,
        migration_mode=__ret__.migration_mode,
        migration_window_end_time_in_utc=__ret__.migration_window_end_time_in_utc,
