...
class FirewallRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of a server group firewall rule.
        :param str end_ip_address: The end IP address of the server group firewall rule. Must be IPv4 format.
        :param str start_ip_address: The start IP address of the server group firewall rule. Must be IPv4 format.
        """
