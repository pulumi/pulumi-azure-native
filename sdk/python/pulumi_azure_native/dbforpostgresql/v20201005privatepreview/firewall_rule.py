...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_rule = azure_native.dbforpostgresql.v20201005privatepreview.FirewallRule("firewallRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:FirewallRule")])
