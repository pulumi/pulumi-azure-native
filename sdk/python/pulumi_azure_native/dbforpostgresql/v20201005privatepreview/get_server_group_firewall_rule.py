...
def get_server_group_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20201005privatepreview:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult).value
...
def get_server_group_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20201005privatepreview:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult)
