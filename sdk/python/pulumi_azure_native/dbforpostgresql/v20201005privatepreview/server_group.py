...
class ServerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerGroup"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:ServerGroup"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroup")])
