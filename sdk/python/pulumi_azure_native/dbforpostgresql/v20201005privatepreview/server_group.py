...
class ServerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(delegated_subnet_arguments, ServerGroupPropertiesDelegatedSubnetArgumentsArgs):
            ...
            if not isinstance(private_dns_zone_arguments, ServerGroupPropertiesPrivateDnsZoneArgumentsArgs):
