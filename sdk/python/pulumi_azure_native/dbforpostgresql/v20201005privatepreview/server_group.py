...
class ServerGroupArgs:
    ...
    def _configure(
        ...
        if enable_mx is None and 'enableMx' in kwargs:
            enable_mx = kwargs['enableMx']
        ...
        if enable_zfs is None and 'enableZfs' in kwargs:
            enable_zfs = kwargs['enableZfs']
        ...
        if private_dns_zone_arguments is None and 'privateDnsZoneArguments' in kwargs:
            private_dns_zone_arguments = kwargs['privateDnsZoneArguments']
        if server_group_name is None and 'serverGroupName' in kwargs:
            server_group_name = kwargs['serverGroupName']
        if server_role_groups is None and 'serverRoleGroups' in kwargs:
            server_role_groups = kwargs['serverRoleGroups']
        if source_location is None and 'sourceLocation' in kwargs:
            source_location = kwargs['sourceLocation']
        if source_resource_group_name is None and 'sourceResourceGroupName' in kwargs:
            source_resource_group_name = kwargs['sourceResourceGroupName']
        if source_server_group_name is None and 'sourceServerGroupName' in kwargs:
            source_server_group_name = kwargs['sourceServerGroupName']
        if source_subscription_id is None and 'sourceSubscriptionId' in kwargs:
            source_subscription_id = kwargs['sourceSubscriptionId']
...
class ServerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            delegated_subnet_arguments = _utilities.configure(delegated_subnet_arguments, ServerGroupPropertiesDelegatedSubnetArgumentsArgs, True)
            ...
            private_dns_zone_arguments = _utilities.configure(private_dns_zone_arguments, ServerGroupPropertiesPrivateDnsZoneArgumentsArgs, True)
