...
class ServerGroupFirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServerGroupFirewallRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServerGroupFirewallRuleArgs.__new__(ServerGroupFirewallRuleArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:ServerGroupFirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroupFirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql:ServerGroupFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerGroupFirewallRule, __self__).__init__(
            'azure-native:dbforpostgresql/v20201005privatepreview:ServerGroupFirewallRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServerGroupFirewallRule':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ServerGroupFirewallRule(resource_name, opts=opts, __props__=__props__)
