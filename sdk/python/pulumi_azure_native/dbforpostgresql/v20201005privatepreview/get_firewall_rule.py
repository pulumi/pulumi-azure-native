...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    :param str firewall_rule_name: The name of the server group firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20201005privatepreview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
...
def get_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverGroupName'] = server_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20201005privatepreview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult)
