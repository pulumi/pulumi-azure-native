...
def get_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration is deprecated: azure-native:dbforpostgresql/v20221201:Configuration is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20230301preview:Configuration to guarantee forwards compatibility.""")
    __args__ = dict()
