...
class ServerKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql:ServerKey"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20200101:ServerKey")])
