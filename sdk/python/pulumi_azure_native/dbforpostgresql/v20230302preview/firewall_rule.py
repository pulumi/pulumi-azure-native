...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] end_ip_address: The end IP address of the cluster firewall rule. Must be IPv4 format.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] start_ip_address: The start IP address of the cluster firewall rule. Must be IPv4 format.
        :param pulumi.Input[str] firewall_rule_name: The name of the cluster firewall rule.
        """
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20201005privatepreview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbforpostgresql/v20230302preview:FirewallRule',
            resource_name,
            __props__,
            opts)
