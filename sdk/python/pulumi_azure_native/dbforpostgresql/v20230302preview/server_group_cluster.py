...
class ServerGroupCluster(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServerGroupClusterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServerGroupClusterArgs.__new__(ServerGroupClusterArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20201005privatepreview:ServerGroupCluster"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:ServerGroupCluster"), pulumi.Alias(type_="azure-native:dbforpostgresql:ServerGroupCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerGroupCluster, __self__).__init__(
            'azure-native:dbforpostgresql/v20230302preview:ServerGroupCluster',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ServerGroupCluster':
        """
        ...
        __props__.__dict__["type"] = None
        return ServerGroupCluster(resource_name, opts=opts, __props__=__props__)
