...
def get_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:dbforpostgresql/v20220120preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Server to guarantee forwards compatibility.""")
    __args__ = dict()
