...
warnings.warn("""azure-native:dbforpostgresql/v20220120preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20220308preview:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[Union[str, 'ServerVersion']]] = None,
                 __props__=None):
        pulumi.log.warn("""Server is deprecated: azure-native:dbforpostgresql/v20220120preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20220308preview:Server to guarantee forwards compatibility.""")
