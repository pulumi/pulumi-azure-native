...
warnings.warn("""azure-native:dbforpostgresql/v20220120preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20230301preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Database, __self__).__init__(
            'azure-native:dbforpostgresql/v20220120preview:Database',
            resource_name,
            __props__,
            opts)
