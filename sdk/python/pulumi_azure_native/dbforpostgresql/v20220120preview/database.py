...
warnings.warn("""azure-native:dbforpostgresql/v20220120preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Database to guarantee forwards compatibility.""", DeprecationWarning)
