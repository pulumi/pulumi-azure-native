...
class ServerArgs:
    def __init__(__self__, *,
        ...
        ServerArgs._configure(
            ...
            identity=identity,
            location=location,
            log_backup_storage_sku=log_backup_storage_sku,
    ...
    def _configure(
        ...
        if log_backup_storage_sku is None and 'logBackupStorageSku' in kwargs:
            log_backup_storage_sku = kwargs['logBackupStorageSku']
        ...
        if standby_count is None and 'standbyCount' in kwargs:
            standby_count = kwargs['standbyCount']
        ...
        if log_backup_storage_sku is not None:
            _setter("log_backup_storage_sku", log_backup_storage_sku)
        ...
        if standby_count is not None:
            _setter("standby_count", standby_count)
