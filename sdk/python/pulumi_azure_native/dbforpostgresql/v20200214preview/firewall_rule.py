...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20200214preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20200214privatepreview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20200214privatepreview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20210410privatepreview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20210410privatepreview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20210601:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20210601:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20210601preview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20210601preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20210615privatepreview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20210615privatepreview:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbforpostgresql/v20200214preview:FirewallRule',
            resource_name,
            __props__,
            opts)
