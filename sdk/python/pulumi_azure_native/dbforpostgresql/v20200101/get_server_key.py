...
warnings.warn("""azure-native:dbforpostgresql/v20200101:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20200214privatepreview:ServerKey to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_key is deprecated: azure-native:dbforpostgresql/v20200101:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20200214privatepreview:ServerKey to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['keyName'] = key_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/v20200101:getServerKey', __args__, opts=opts, typ=GetServerKeyResult).value
