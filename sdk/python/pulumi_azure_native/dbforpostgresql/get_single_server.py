...
def get_single_server(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getSingleServer', __args__, opts=opts, typ=GetSingleServerResult).value
...
def get_single_server_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql:getSingleServer', __args__, opts=opts, typ=GetSingleServerResult)
