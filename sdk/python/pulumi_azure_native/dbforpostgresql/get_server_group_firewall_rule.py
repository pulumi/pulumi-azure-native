...
def get_server_group_firewall_rule(cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str firewall_rule_name: The name of the cluster firewall rule.
...
def get_server_group_firewall_rule_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
