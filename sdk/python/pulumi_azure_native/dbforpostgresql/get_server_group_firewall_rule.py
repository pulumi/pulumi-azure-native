...
def get_server_group_firewall_rule(cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str firewall_rule_name: The name of the cluster firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult).value
...
def get_server_group_firewall_rule_output(cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                          firewall_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql:getServerGroupFirewallRule', __args__, opts=opts, typ=GetServerGroupFirewallRuleResult)
