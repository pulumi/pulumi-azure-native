...
warnings.warn("""azure-native:dbforpostgresql/v20210601preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210615privatepreview:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Server, __self__).__init__(
            'azure-native:dbforpostgresql/v20210601preview:Server',
            resource_name,
            __props__,
            opts)
