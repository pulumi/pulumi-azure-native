...
def get_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:dbforpostgresql/v20210601preview:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20210615privatepreview:Server to guarantee forwards compatibility.""")
    __args__ = dict()
