...
class ClusterArgs:
    ...
    def _configure(
        ...
        if coordinator_enable_public_ip_access is None and 'coordinatorEnablePublicIpAccess' in kwargs:
        ...
        if coordinator_v_cores is None and 'coordinatorVCores' in kwargs:
            coordinator_v_cores = kwargs['coordinatorVCores']
        if enable_ha is None and 'enableHa' in kwargs:
            enable_ha = kwargs['enableHa']
        if enable_shards_on_coordinator is None and 'enableShardsOnCoordinator' in kwargs:
        ...
        if node_enable_public_ip_access is None and 'nodeEnablePublicIpAccess' in kwargs:
        ...
        if node_v_cores is None and 'nodeVCores' in kwargs:
        ...
        if postgresql_version is None and 'postgresqlVersion' in kwargs:
