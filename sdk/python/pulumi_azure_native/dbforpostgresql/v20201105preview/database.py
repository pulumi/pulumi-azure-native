...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Database is deprecated: azure-native:dbforpostgresql/v20201105preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:dbforpostgresql/v20221201:Database to guarantee forwards compatibility.""")
