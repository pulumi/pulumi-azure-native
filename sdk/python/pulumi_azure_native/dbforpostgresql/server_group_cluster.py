...
class ServerGroupClusterArgs:
    def __init__(__self__, *,
                 ...
                 coordinator_enable_public_ip_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 coordinator_v_cores: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 enable_geo_backup: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_ha: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_shards_on_coordinator: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 node_enable_public_ip_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 node_v_cores: Optional[pulumi.Input[builtins.int]] = None,
                 point_in_time_utc: Optional[pulumi.Input[builtins.str]] = None,
                 postgresql_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_login_password: The password of the administrator login. Required for creation.
        :param pulumi.Input['ServerGroupClusterAuthConfigArgs'] auth_config: Authentication configuration of a cluster.
        :param pulumi.Input[builtins.str] citus_version: The Citus extension version on all cluster servers.
        :param pulumi.Input[builtins.str] cluster_name: The name of the cluster.
        :param pulumi.Input[builtins.bool] coordinator_enable_public_ip_access: If public access is enabled on coordinator.
        :param pulumi.Input[builtins.str] coordinator_server_edition: The edition of a coordinator server (default: GeneralPurpose). Required for creation.
        :param pulumi.Input[builtins.int] coordinator_storage_quota_in_mb: The storage of a server in MB. Required for creation. See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        :param pulumi.Input[builtins.int] coordinator_v_cores: The vCores count of a server (max: 96). Required for creation. See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        :param pulumi.Input['ServerGroupClusterDataEncryptionArgs'] data_encryption: The data encryption properties of a cluster.
        :param pulumi.Input[builtins.str] database_name: The database name of the cluster. Only one database per cluster is supported.
        :param pulumi.Input[builtins.bool] enable_geo_backup: If cluster backup is stored in another Azure region in addition to the copy of the backup stored in the cluster's region. Enabled only at the time of cluster creation.
        :param pulumi.Input[builtins.bool] enable_ha: If high availability (HA) is enabled or not for the cluster.
        :param pulumi.Input[builtins.bool] enable_shards_on_coordinator: If distributed tables are placed on coordinator or not. Should be set to 'true' on single node clusters. Requires shard rebalancing after value is changed.
        ...
        :param pulumi.Input[builtins.int] node_count: Worker node count of the cluster. When node count is 0, it represents a single node configuration with the ability to create distributed tables on that node. 2 or more worker nodes represent multi-node configuration. Node count value cannot be 1. Required for creation.
        :param pulumi.Input[builtins.bool] node_enable_public_ip_access: If public access is enabled on worker nodes.
        :param pulumi.Input[builtins.str] node_server_edition: The edition of a node server (default: MemoryOptimized).
        :param pulumi.Input[builtins.int] node_storage_quota_in_mb: The storage in MB on each worker node. See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        :param pulumi.Input[builtins.int] node_v_cores: The compute in vCores on each worker node (max: 104). See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        :param pulumi.Input[builtins.str] point_in_time_utc: Date and time in UTC (ISO8601 format) for cluster restore.
        :param pulumi.Input[builtins.str] postgresql_version: The major PostgreSQL version on all cluster servers.
        :param pulumi.Input[builtins.str] preferred_primary_zone: Preferred primary availability zone (AZ) for all cluster servers.
        :param pulumi.Input[builtins.str] source_location: The Azure region of source cluster for read replica clusters.
        :param pulumi.Input[builtins.str] source_resource_id: The resource id of source cluster for read replica clusters.
    ...
    def coordinator_enable_public_ip_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def coordinator_enable_public_ip_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def coordinator_v_cores(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def coordinator_v_cores(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_geo_backup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_geo_backup(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_shards_on_coordinator(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_shards_on_coordinator(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_enable_public_ip_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def node_enable_public_ip_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_v_cores(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @node_v_cores.setter
    def node_v_cores(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def postgresql_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def postgresql_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServerGroupCluster(pulumi.CustomResource):
    ...
    def aad_auth_enabled(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="citusVersion")
    def citus_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Citus extension version on all cluster servers.
        """
        return pulumi.get(self, "citus_version")
    ...
    @property
    @pulumi.getter(name="coordinatorEnablePublicIpAccess")
    def coordinator_enable_public_ip_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If public access is enabled on coordinator.
        """
        return pulumi.get(self, "coordinator_enable_public_ip_access")
    ...
    @property
    @pulumi.getter(name="coordinatorVCores")
    def coordinator_v_cores(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The vCores count of a server (max: 96). Required for creation. See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        """
        return pulumi.get(self, "coordinator_v_cores")
    ...
    @property
    @pulumi.getter(name="enableGeoBackup")
    def enable_geo_backup(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If cluster backup is stored in another Azure region in addition to the copy of the backup stored in the cluster's region. Enabled only at the time of cluster creation.
        """
        return pulumi.get(self, "enable_geo_backup")
    ...
    @property
    @pulumi.getter(name="enableHa")
    def enable_ha(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If high availability (HA) is enabled or not for the cluster.
        """
        return pulumi.get(self, "enable_ha")
    ...
    @property
    @pulumi.getter(name="enableShardsOnCoordinator")
    def enable_shards_on_coordinator(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If distributed tables are placed on coordinator or not. Should be set to 'true' on single node clusters. Requires shard rebalancing after value is changed.
        """
        return pulumi.get(self, "enable_shards_on_coordinator")
    ...
    @property
    @pulumi.getter(name="nodeEnablePublicIpAccess")
    def node_enable_public_ip_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If public access is enabled on worker nodes.
        """
        return pulumi.get(self, "node_enable_public_ip_access")
    ...
    @property
    @pulumi.getter(name="nodeStorageQuotaInMb")
    def node_storage_quota_in_mb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The storage in MB on each worker node. See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        """
        return pulumi.get(self, "node_storage_quota_in_mb")
    ...
    @property
    @pulumi.getter(name="nodeVCores")
    def node_v_cores(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The compute in vCores on each worker node (max: 104). See https://learn.microsoft.com/azure/cosmos-db/postgresql/resources-compute for more information.
        """
        return pulumi.get(self, "node_v_cores")
    ...
    def password_enabled(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="pointInTimeUTC")
    def point_in_time_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Date and time in UTC (ISO8601 format) for cluster restore.
        """
        return pulumi.get(self, "point_in_time_utc")
    ...
    @property
    @pulumi.getter(name="postgresqlVersion")
    def postgresql_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The major PostgreSQL version on all cluster servers.
        """
        return pulumi.get(self, "postgresql_version")
    ...
    def read_replicas(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
