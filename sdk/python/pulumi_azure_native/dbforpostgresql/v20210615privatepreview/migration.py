...
class MigrationArgs:
    ...
    def _configure(
        ...
        if 'targetDBServerResourceGroupName' in kwargs:
            target_db_server_resource_group_name = kwargs['targetDBServerResourceGroupName']
        if 'targetDBServerSubscriptionId' in kwargs:
        ...
        if 'migrationResourceGroup' in kwargs:
...
class Migration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if migration_resource_group is not None and not isinstance(migration_resource_group, MigrationResourceGroupArgs):
                migration_resource_group = migration_resource_group or {}
                def _setter(key, value):
                    migration_resource_group[key] = value
                MigrationResourceGroupArgs._configure(_setter, **migration_resource_group)
