...
def get_migration(migration_name: Optional[str] = None,
    ...
    return AwaitableGetMigrationResult(
        ...
        migration_name=pulumi.get(__ret__, 'migration_name'),
        migration_resource_group=pulumi.get(__ret__, 'migration_resource_group'),
        ...
        secret_parameters=pulumi.get(__ret__, 'secret_parameters'),
