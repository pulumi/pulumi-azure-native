...
def get_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration is deprecated: azure-native:dbforpostgresql/v20210615privatepreview:Configuration is being removed in the next major version of this provider. Please upgrade to azure-native:dbforpostgresql/v20221201:Configuration to guarantee forwards compatibility.""")
    __args__ = dict()
