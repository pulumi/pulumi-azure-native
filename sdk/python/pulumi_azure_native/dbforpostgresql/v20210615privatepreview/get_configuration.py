...
def get_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dbforpostgresql/v20210615privatepreview:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult)
