...
class ServerGroupRoleArgs:
    def __init__(__self__, *,
                 ...
                 role_type: Optional[pulumi.Input[Union[str, 'RoleType']]] = None,
                 tenant_id: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a ServerGroupRole resource.
        :param pulumi.Input[str] cluster_name: The name of the cluster.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] password: The password of the cluster role. If an identity is used, password will not be required.
    ...
    def role_type(self) -> Optional[pulumi.Input[Union[str, 'RoleType']]]:
        return pulumi.get(self, "role_type")

    @role_type.setter
    def role_type(self, value: Optional[pulumi.Input[Union[str, 'RoleType']]]):
...
class ServerGroupRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dbforpostgresql/v20221108:ServerGroupRole"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20230302preview:ServerGroupRole")])
