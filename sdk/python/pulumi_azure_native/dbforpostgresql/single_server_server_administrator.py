...
class SingleServerServerAdministratorArgs:
    def __init__(__self__, *,
                 administrator_type: pulumi.Input[Union[_builtins.str, 'AdministratorType']],
        ...
        :param pulumi.Input[_builtins.str] sid: The server administrator Sid (Secure ID).
        :param pulumi.Input[_builtins.str] tenant_id: The server Active Directory Administrator tenant id.
        """
    ...
    def administrator_type(self, value: pulumi.Input[Union[_builtins.str, 'AdministratorType']]):
...
@pulumi.type_token("azure-native:dbforpostgresql:SingleServerServerAdministrator")
