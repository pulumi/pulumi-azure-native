...
class GetWorkloadResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, provisioning_state=None, resource_group_collection=None, system_data=None, tags=None, type=None):
