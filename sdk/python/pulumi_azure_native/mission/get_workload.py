...
class GetWorkloadResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, managed_on_behalf_of_configuration=None, name=None, provisioning_state=None, resource_group_collection=None, system_data=None, tags=None, type=None):
        ...
        if resource_group_collection and not isinstance(resource_group_collection, list):
            raise TypeError("Expected argument 'resource_group_collection' to be a list")
...
class AwaitableGetWorkloadResult(GetWorkloadResult):
    ...
    def __await__(self):
        ...
        return GetWorkloadResult(
            ...
            resource_group_collection=self.resource_group_collection,
            system_data=self.system_data,
            tags=self.tags,
            type=self.type)


def get_workload(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workload_name: The name of the workloadResource Resource
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualEnclaveName'] = virtual_enclave_name
    __args__['workloadName'] = workload_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mission:getWorkload', __args__, opts=opts, typ=GetWorkloadResult).value
    ...
    return AwaitableGetWorkloadResult(
        ...
        resource_group_collection=pulumi.get(__ret__, 'resource_group_collection'),
        system_data=pulumi.get(__ret__, 'system_data'),
        tags=pulumi.get(__ret__, 'tags'),
        type=pulumi.get(__ret__, 'type'))
def get_workload_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mission:getWorkload', __args__, opts=opts, typ=GetWorkloadResult)
    return __ret__.apply(lambda __response__: GetWorkloadResult(
        ...
        resource_group_collection=pulumi.get(__response__, 'resource_group_collection'),
