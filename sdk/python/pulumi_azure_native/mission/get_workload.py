...
class GetWorkloadResult:
    ...
    def resource_group_collection(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_workload(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str workload_name: The name of the workloadResource Resource
    """
    __args__ = dict()
...
def get_workload_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
