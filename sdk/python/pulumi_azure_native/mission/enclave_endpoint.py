...
class EnclaveEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rule_collection: pulumi.Input[Optional[Sequence[pulumi.Input[Union['EnclaveEndpointDestinationRuleArgs', 'EnclaveEndpointDestinationRuleArgsDict']]]]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mission/v20240601preview:EnclaveEndpoint"), pulumi.Alias(type_="azure-native:mission/v20241201preview:EnclaveEndpoint"), pulumi.Alias(type_="azure-native:mission/v20250501preview:EnclaveEndpoint"), pulumi.Alias(type_="azure-native:mission/v20251101preview:EnclaveEndpoint"), pulumi.Alias(type_="azure-native:mission/v20260301preview:EnclaveEndpoint")])
