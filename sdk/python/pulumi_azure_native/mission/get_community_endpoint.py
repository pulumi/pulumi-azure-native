...
def get_community_endpoint(community_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str community_endpoint_name: The name of the Community Endpoint Resource
...
def get_community_endpoint_output(community_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
