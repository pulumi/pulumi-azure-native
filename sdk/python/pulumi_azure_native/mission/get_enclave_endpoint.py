...
def get_enclave_endpoint(enclave_endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str enclave_endpoint_name: The name of the Enclave Endpoint Resource
...
def get_enclave_endpoint_output(enclave_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
