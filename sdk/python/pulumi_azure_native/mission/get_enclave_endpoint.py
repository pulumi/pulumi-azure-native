...
class AwaitableGetEnclaveEndpointResult(GetEnclaveEndpointResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetEnclaveEndpointResult(
...
def get_enclave_endpoint(enclave_endpoint_name: Optional[_builtins.str] = None,
                         resource_group_name: Optional[_builtins.str] = None,
                         virtual_enclave_name: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnclaveEndpointResult:
    """
    ...
    :param _builtins.str enclave_endpoint_name: The name of the Enclave Endpoint Resource
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str virtual_enclave_name: The name of the enclaveResource Resource
    """
    __args__ = dict()
    __args__['enclaveEndpointName'] = enclave_endpoint_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualEnclaveName'] = virtual_enclave_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mission:getEnclaveEndpoint', __args__, opts=opts, typ=GetEnclaveEndpointResult).value

    return AwaitableGetEnclaveEndpointResult(
...
def get_enclave_endpoint_output(enclave_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                virtual_enclave_name: pulumi.Input[Optional[_builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnclaveEndpointResult]:
    """
    Get a EnclaveEndpointResource
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mission:getEnclaveEndpoint', __args__, opts=opts, typ=GetEnclaveEndpointResult)
    return __ret__.apply(lambda __response__: GetEnclaveEndpointResult(
