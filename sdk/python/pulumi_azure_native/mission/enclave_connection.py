...
class EnclaveConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mission/v20240601preview:EnclaveConnection"), pulumi.Alias(type_="azure-native:mission/v20241201preview:EnclaveConnection"), pulumi.Alias(type_="azure-native:mission/v20250501preview:EnclaveConnection"), pulumi.Alias(type_="azure-native:mission/v20251101preview:EnclaveConnection"), pulumi.Alias(type_="azure-native:mission/v20260301preview:EnclaveConnection")])
