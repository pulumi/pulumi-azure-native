...
class EnclaveConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip_group: Source IP group Resource Id.
    ...
    def ip_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class EnclaveConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["ip_group"] = None
    ...
    @property
    @pulumi.getter(name="ipGroup")
    def ip_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Source IP group Resource Id.
        """
        return pulumi.get(self, "ip_group")
