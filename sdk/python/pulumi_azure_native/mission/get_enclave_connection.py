...
class GetEnclaveConnectionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, community_resource_id=None, destination_endpoint_id=None, id=None, ip_group=None, location=None, name=None, provisioning_state=None, resource_collection=None, source_cidr=None, source_resource_id=None, state=None, system_data=None, tags=None, type=None):
        ...
        if ip_group and not isinstance(ip_group, str):
            raise TypeError("Expected argument 'ip_group' to be a str")
    ...
    def ip_group(self) -> Optional[builtins.str]:
        """
