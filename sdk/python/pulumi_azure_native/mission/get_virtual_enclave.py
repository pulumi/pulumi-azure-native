...
class GetVirtualEnclaveResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, bastion_enabled=None, community_resource_id=None, enclave_address_spaces=None, enclave_default_settings=None, enclave_role_assignments=None, enclave_virtual_network=None, id=None, identity=None, location=None, maintenance_mode_configuration=None, managed_resource_group_configuration=None, name=None, provisioning_state=None, resource_collection=None, system_data=None, tags=None, type=None, workload_role_assignments=None):
