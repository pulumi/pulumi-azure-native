...
class GetApprovalResult:
    ...
    """
    def __init__(__self__, approvers=None, azure_api_version=None, created_at=None, id=None, name=None, parent1=None, parent2=None, provisioning_state=None, request_metadata=None, state_changed_at=None, system_data=None, ticket_id=None, type=None):
        ...
        if parent1 and not isinstance(parent1, str):
            raise TypeError("Expected argument 'parent1' to be a str")
        pulumi.set(__self__, "parent1", parent1)
        if parent2 and not isinstance(parent2, str):
            raise TypeError("Expected argument 'parent2' to be a str")
        pulumi.set(__self__, "parent2", parent2)
    ...
    @property
    @pulumi.getter
    def parent1(self) -> Optional[builtins.str]:
        """
        Parameter for optimizing query results
        """
        return pulumi.get(self, "parent1")

    @property
    @pulumi.getter
    def parent2(self) -> Optional[builtins.str]:
        """
        Parameter for optimizing query results
        """
        return pulumi.get(self, "parent2")
...
def get_approval(approval_name: Optional[builtins.str] = None,
    ...
    return AwaitableGetApprovalResult(
        ...
        parent1=pulumi.get(__ret__, 'parent1'),
        parent2=pulumi.get(__ret__, 'parent2'),
...
def get_approval_output(approval_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetApprovalResult(
        ...
        parent1=pulumi.get(__response__, 'parent1'),
        parent2=pulumi.get(__response__, 'parent2'),
