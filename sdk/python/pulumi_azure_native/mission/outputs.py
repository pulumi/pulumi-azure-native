...
class CommunityEndpointDestinationRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Endpoint Rule Name.
        :param builtins.str port: Port. Can include multiple ports separated by commas or a range indicated by a hyphen.
...
class EnclaveVirtualNetworkModelResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "connectToAzureServices":
            suggest = "connect_to_azure_services"
    ...
    def __init__(__self__, *,
                 ...
                 connect_to_azure_services: Optional[builtins.bool] = None,
        ...
        :param builtins.bool connect_to_azure_services: Connect to Azure Services (True or False).
    ...
    def connect_to_azure_services(self) -> Optional[builtins.bool]:
        """
...
class GovernedServiceItemResponse(dict):
    ...
    def audit_only(self) -> Optional[builtins.bool]:
        """
...
class ManagedResourceGroupConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of managed resource group
        """
...
class RoleAssignmentItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Role assignment item that indicates which principals should be assigned this role definition
        :param builtins.str id: Role definition identifier
...
class SubnetConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: Subnet Resource ID.
        :param builtins.str name: Subnet name.
        :param builtins.int network_prefix_size: Network prefix size.
        :param builtins.str network_security_group_id: Network security group ID.
