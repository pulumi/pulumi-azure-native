...
class CommunityEndpointDestinationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Endpoint Rule Name.
        :param pulumi.Input[builtins.str] port: Port. Can include multiple ports separated by commas or a range indicated by a hyphen.
...
if not MYPY:
    class EnclaveVirtualNetworkModelArgsDict(TypedDict):
        ...
        """
        connect_to_azure_services: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EnclaveVirtualNetworkModelArgs:
    def __init__(__self__, *,
                 ...
                 connect_to_azure_services: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] connect_to_azure_services: Connect to Azure Services (True or False).
        ...
        if connect_to_azure_services is None:
            connect_to_azure_services = False
        if connect_to_azure_services is not None:
            pulumi.set(__self__, "connect_to_azure_services", connect_to_azure_services)
    ...
    @property
    @pulumi.getter(name="connectToAzureServices")
    def connect_to_azure_services(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Connect to Azure Services (True or False).
        """
        return pulumi.get(self, "connect_to_azure_services")

    @connect_to_azure_services.setter
    def connect_to_azure_services(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "connect_to_azure_services", value)
...
if not MYPY:
    class GovernedServiceItemArgsDict(TypedDict):
        ...
        """
        id: pulumi.Input[Union[builtins.str, 'ServiceIdentifier']]
        """
        Service ID
        """
        audit_only: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class GovernedServiceItemArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[Union[builtins.str, 'ServiceIdentifier']],
                 audit_only: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        GovernedServiceItem Properties
        :param pulumi.Input[Union[builtins.str, 'ServiceIdentifier']] id: Service ID
        :param pulumi.Input[builtins.bool] audit_only: Policies set to auditOnly (True or False).
        ...
        if audit_only is not None:
            pulumi.set(__self__, "audit_only", audit_only)
    ...
    @property
    @pulumi.getter
    def id(self) -> pulumi.Input[Union[builtins.str, 'ServiceIdentifier']]:
        """
        Service ID
        """
    ...
    @id.setter
    def id(self, value: pulumi.Input[Union[builtins.str, 'ServiceIdentifier']]):
        pulumi.set(self, "id", value)

    @property
    @pulumi.getter(name="auditOnly")
    def audit_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Policies set to auditOnly (True or False).
        """
        return pulumi.get(self, "audit_only")

    @audit_only.setter
    def audit_only(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "audit_only", value)
...
class RoleAssignmentItemArgs:
    def __init__(__self__, *,
        ...
        """
        Role assignment item that indicates which principals should be assigned this role definition
        :param pulumi.Input[builtins.str] id: Role definition identifier
