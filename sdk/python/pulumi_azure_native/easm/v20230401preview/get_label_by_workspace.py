...
def get_label_by_workspace(label_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:easm/v20230401preview:getLabelByWorkspace', __args__, opts=opts, typ=GetLabelByWorkspaceResult).value
...
def get_label_by_workspace_output(label_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:easm/v20230401preview:getLabelByWorkspace', __args__, opts=opts, typ=GetLabelByWorkspaceResult)
