...
class LabelByWorkspaceArgs:
    def __init__(__self__, *,
        ...
        """
        LabelByWorkspaceArgs._configure(
...
class LabelByWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LabelByWorkspaceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:easm:LabelByWorkspace"), pulumi.Alias(type_="azure-native:easm/v20220401preview:LabelByWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LabelByWorkspace, __self__).__init__(
            'azure-native:easm/v20230401preview:LabelByWorkspace',
            resource_name,
            __props__,
            opts)
