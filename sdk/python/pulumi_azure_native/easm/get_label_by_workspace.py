...
def get_label_by_workspace(label_name: Optional[_builtins.str] = None,
...
def get_label_by_workspace_output(label_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
