...
class ReadOnlyFollowingDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        read_only_following_database = azure_native.kusto.v20221229.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase",
    ...
    def _internal_init(__self__,
        ...
        super(ReadOnlyFollowingDatabase, __self__).__init__(
            'azure-native:kusto/v20221229:ReadOnlyFollowingDatabase',
            resource_name,
            __props__,
            opts)
