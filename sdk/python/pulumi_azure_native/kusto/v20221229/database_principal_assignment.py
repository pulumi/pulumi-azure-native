...
class DatabasePrincipalAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_principal_assignment = azure_native.kusto.v20221229.DatabasePrincipalAssignment("databasePrincipalAssignment",
    ...
    def _internal_init(__self__,
        ...
        super(DatabasePrincipalAssignment, __self__).__init__(
            'azure-native:kusto/v20221229:DatabasePrincipalAssignment',
            resource_name,
            __props__,
            opts)
