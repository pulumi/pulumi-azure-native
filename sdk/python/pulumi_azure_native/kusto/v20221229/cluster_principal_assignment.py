...
class ClusterPrincipalAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cluster_principal_assignment = azure_native.kusto.v20221229.ClusterPrincipalAssignment("clusterPrincipalAssignment",
    ...
    def _internal_init(__self__,
        ...
        super(ClusterPrincipalAssignment, __self__).__init__(
            'azure-native:kusto/v20221229:ClusterPrincipalAssignment',
            resource_name,
            __props__,
            opts)
