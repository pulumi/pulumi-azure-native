...
class AttachedDatabaseConfigurationArgs:
    ...
    def _configure(
        ...
        if database_name_override is None and 'databaseNameOverride' in kwargs:
            database_name_override = kwargs['databaseNameOverride']
        if database_name_prefix is None and 'databaseNamePrefix' in kwargs:
            database_name_prefix = kwargs['databaseNamePrefix']
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(AttachedDatabaseConfiguration, __self__).__init__(
            'azure-native:kusto/v20221229:AttachedDatabaseConfiguration',
            resource_name,
            __props__,
            opts)
