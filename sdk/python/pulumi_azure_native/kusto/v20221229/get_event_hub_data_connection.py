...
def get_event_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20221229:getEventHubDataConnection', __args__, opts=opts, typ=GetEventHubDataConnectionResult).value
...
def get_event_hub_data_connection_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20221229:getEventHubDataConnection', __args__, opts=opts, typ=GetEventHubDataConnectionResult)
