...
class GetScriptResult:
    ...
    """
    def __init__(__self__, continue_on_errors=None, force_update_tag=None, id=None, name=None, principal_permissions_action=None, provisioning_state=None, script_level=None, script_url=None, system_data=None, type=None):
...
def get_script(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20240413:getScript', __args__, opts=opts, typ=GetScriptResult).value
...
def get_script_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scriptName'] = script_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20240413:getScript', __args__, opts=opts, typ=GetScriptResult)
