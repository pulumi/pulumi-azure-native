...
class GetSandboxCustomImageResult:
    ...
    """
    def __init__(__self__, base_image_name=None, id=None, language=None, language_version=None, name=None, provisioning_state=None, requirements_file_content=None, type=None):
...
def get_sandbox_custom_image(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20240413:getSandboxCustomImage', __args__, opts=opts, typ=GetSandboxCustomImageResult).value
