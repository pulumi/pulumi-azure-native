...
class CosmosDbDataConnectionArgs:
    def __init__(__self__, *,
                 ...
                 cosmos_db_account_resource_id: pulumi.Input[builtins.str],
                 cosmos_db_container: pulumi.Input[builtins.str],
                 cosmos_db_database: pulumi.Input[builtins.str],
                 database_name: pulumi.Input[builtins.str],
                 kind: pulumi.Input[builtins.str],
                 managed_identity_resource_id: pulumi.Input[builtins.str],
                 ...
                 retrieval_start_date: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cosmos_db_account_resource_id: The resource ID of the Cosmos DB account used to create the data connection.
        :param pulumi.Input[builtins.str] cosmos_db_container: The name of an existing container in the Cosmos DB database.
        :param pulumi.Input[builtins.str] cosmos_db_database: The name of an existing database in the Cosmos DB account.
        ...
        :param pulumi.Input[builtins.str] managed_identity_resource_id: The resource ID of a managed system or user-assigned identity. The identity is used to authenticate with Cosmos DB.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] table_name: The case-sensitive name of the existing target table in your cluster. Retrieved data is ingested into this table.
        ...
        :param pulumi.Input[builtins.str] mapping_rule_name: The name of an existing mapping rule to use when ingesting the retrieved data.
        :param pulumi.Input[builtins.str] retrieval_start_date: Optional. If defined, the data connection retrieves Cosmos DB documents created or updated after the specified retrieval start date.
        """
    ...
    def cosmos_db_account_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cosmos_db_account_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cosmos_db_account_resource_id", value)

    @property
    @pulumi.getter(name="cosmosDbContainer")
    def cosmos_db_container(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cosmos_db_container(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cosmos_db_container", value)

    @property
    @pulumi.getter(name="cosmosDbDatabase")
    def cosmos_db_database(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cosmos_db_database(self, value: pulumi.Input[builtins.str]):
    ...
    def managed_identity_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def managed_identity_resource_id(self, value: pulumi.Input[builtins.str]):
    ...
    def retrieval_start_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def retrieval_start_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CosmosDbDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cosmos_db_account_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 cosmos_db_container: Optional[pulumi.Input[builtins.str]] = None,
                 cosmos_db_database: Optional[pulumi.Input[builtins.str]] = None,
                 data_connection_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="cosmosDbAccountResourceId")
    def cosmos_db_account_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Cosmos DB account used to create the data connection.
        """
        return pulumi.get(self, "cosmos_db_account_resource_id")
    ...
    @property
    @pulumi.getter(name="cosmosDbContainer")
    def cosmos_db_container(self) -> pulumi.Output[builtins.str]:
        """
        The name of an existing container in the Cosmos DB database.
        """
        return pulumi.get(self, "cosmos_db_container")
    ...
    @property
    @pulumi.getter(name="cosmosDbDatabase")
    def cosmos_db_database(self) -> pulumi.Output[builtins.str]:
        """
        The name of an existing database in the Cosmos DB account.
        """
        return pulumi.get(self, "cosmos_db_database")
    ...
    def managed_identity_object_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="retrievalStartDate")
    def retrieval_start_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional. If defined, the data connection retrieves Cosmos DB documents created or updated after the specified retrieval start date.
        """
        return pulumi.get(self, "retrieval_start_date")
