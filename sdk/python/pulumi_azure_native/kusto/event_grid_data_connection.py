...
class EventGridDataConnectionArgs:
    def __init__(__self__, *,
                 ...
                 blob_storage_event_type: Optional[pulumi.Input[Union[builtins.str, 'BlobStorageEventType']]] = None,
                 data_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 data_format: Optional[pulumi.Input[Union[builtins.str, 'EventGridDataFormat']]] = None,
                 database_routing: Optional[pulumi.Input[Union[builtins.str, 'DatabaseRouting']]] = None,
                 event_grid_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_first_record: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] event_hub_resource_id: The resource ID where the event grid is configured to send events.
        :param pulumi.Input[builtins.str] kind: Kind of the endpoint for the data connection
               Expected value is 'EventGrid'.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] storage_account_resource_id: The resource ID of the storage account where the data resides.
        :param pulumi.Input[Union[builtins.str, 'BlobStorageEventType']] blob_storage_event_type: The name of blob storage event type to process.
        :param pulumi.Input[builtins.str] data_connection_name: The name of the data connection.
        :param pulumi.Input[Union[builtins.str, 'EventGridDataFormat']] data_format: The data format of the message. Optionally the data format can be added to each message.
        ...
        :param pulumi.Input[builtins.str] event_grid_resource_id: The resource ID of the event grid that is subscribed to the storage account events.
        :param pulumi.Input[builtins.bool] ignore_first_record: A Boolean value that, if set to true, indicates that ingestion should ignore the first record of every file
        :param pulumi.Input[builtins.str] location: Resource location.
        :param pulumi.Input[builtins.str] managed_identity_resource_id: The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub and storage account.
    ...
    def blob_storage_event_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'BlobStorageEventType']]]:
        """
    ...
    def blob_storage_event_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'BlobStorageEventType']]]):
    ...
    def data_format(self) -> Optional[pulumi.Input[Union[builtins.str, 'EventGridDataFormat']]]:
        """
    ...
    @data_format.setter
    def data_format(self, value: Optional[pulumi.Input[Union[builtins.str, 'EventGridDataFormat']]]):
    ...
    def event_grid_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_grid_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_grid_resource_id", value)

    @property
    @pulumi.getter(name="ignoreFirstRecord")
    def ignore_first_record(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_first_record(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="eventGridResourceId")
    def event_grid_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of the event grid that is subscribed to the storage account events.
        """
        return pulumi.get(self, "event_grid_resource_id")
    ...
    @property
    @pulumi.getter(name="ignoreFirstRecord")
    def ignore_first_record(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A Boolean value that, if set to true, indicates that ingestion should ignore the first record of every file
        """
        return pulumi.get(self, "ignore_first_record")
    ...
    @property
    @pulumi.getter(name="storageAccountResourceId")
    def storage_account_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the storage account where the data resides.
        """
        return pulumi.get(self, "storage_account_resource_id")
