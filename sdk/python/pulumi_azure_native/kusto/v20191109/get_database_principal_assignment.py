...
def get_database_principal_assignment(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_principal_assignment is deprecated: azure-native:kusto/v20191109:DatabasePrincipalAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:DatabasePrincipalAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20191109:getDatabasePrincipalAssignment', __args__, opts=opts, typ=GetDatabasePrincipalAssignmentResult).value
