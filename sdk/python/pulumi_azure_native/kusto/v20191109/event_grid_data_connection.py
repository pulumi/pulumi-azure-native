...
warnings.warn("""azure-native:kusto/v20191109:EventGridDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20200215:EventGridDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EventGridDataConnection is deprecated: azure-native:kusto/v20191109:EventGridDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20200215:EventGridDataConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190121:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190515:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190907:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200215:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200614:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200918:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20210101:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20210827:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20220201:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20220707:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20221111:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20221229:EventGridDataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventGridDataConnection, __self__).__init__(
            'azure-native:kusto/v20191109:EventGridDataConnection',
            resource_name,
            __props__,
            opts)
