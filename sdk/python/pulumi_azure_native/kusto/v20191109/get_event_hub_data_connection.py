...
warnings.warn("""azure-native:kusto/v20191109:EventHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_event_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub_data_connection is deprecated: azure-native:kusto/v20191109:EventHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
