...
def get_event_grid_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_grid_data_connection is deprecated: azure-native:kusto/v20191109:EventGridDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20200215:EventGridDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
