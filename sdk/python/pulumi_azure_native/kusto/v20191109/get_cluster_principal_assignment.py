...
def get_cluster_principal_assignment(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster_principal_assignment is deprecated: azure-native:kusto/v20191109:ClusterPrincipalAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
