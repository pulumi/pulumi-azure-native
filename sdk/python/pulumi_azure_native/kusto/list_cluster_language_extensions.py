...
def list_cluster_language_extensions(cluster_name: Optional[builtins.str] = None,
...
def list_cluster_language_extensions_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto:listClusterLanguageExtensions', __args__, opts=opts, typ=ListClusterLanguageExtensionsResult)
