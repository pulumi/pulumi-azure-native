...
warnings.warn("""azure-native:kusto/v20220201:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_attached_database_configuration(attached_database_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attached_database_configuration is deprecated: azure-native:kusto/v20220201:AttachedDatabaseConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:AttachedDatabaseConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
