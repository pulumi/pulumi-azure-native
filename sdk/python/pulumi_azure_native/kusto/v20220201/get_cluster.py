...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: azure-native:kusto/v20220201:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20220707:Cluster to guarantee forwards compatibility.""")
    __args__ = dict()
