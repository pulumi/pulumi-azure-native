...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:kusto/v20210827:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:kusto/v20220707:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:kusto/v20221111:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:kusto/v20220201:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
