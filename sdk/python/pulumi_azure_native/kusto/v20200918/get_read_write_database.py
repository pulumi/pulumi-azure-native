...
def get_read_write_database(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_read_write_database is deprecated: azure-native:kusto/v20200918:ReadWriteDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['databaseName'] = database_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20200918:getReadWriteDatabase', __args__, opts=opts, typ=GetReadWriteDatabaseResult).value
