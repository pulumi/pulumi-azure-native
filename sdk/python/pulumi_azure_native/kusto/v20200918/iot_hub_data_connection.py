...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_data_connection = azure_native.kusto.v20200918.IotHubDataConnection("iotHubDataConnection",
        ...
        ```sh
        $ pulumi import azure-native:kusto/v20200918:IotHubDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
        ```
