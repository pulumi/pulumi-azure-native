...
warnings.warn("""azure-native:kusto/v20200918:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.""", DeprecationWarning)
...
class ClusterPrincipalAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ClusterPrincipalAssignment is deprecated: azure-native:kusto/v20200918:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20191109:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20200215:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20200614:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20210101:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20210827:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20220201:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20220707:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20221111:ClusterPrincipalAssignment"), pulumi.Alias(type_="azure-native:kusto/v20221229:ClusterPrincipalAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterPrincipalAssignment, __self__).__init__(
            'azure-native:kusto/v20200918:ClusterPrincipalAssignment',
            resource_name,
            __props__,
            opts)
