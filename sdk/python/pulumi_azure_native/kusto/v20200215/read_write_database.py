...
warnings.warn("""azure-native:kusto/v20200215:ReadWriteDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 soft_delete_period: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReadWriteDatabase is deprecated: azure-native:kusto/v20200215:ReadWriteDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.""")
