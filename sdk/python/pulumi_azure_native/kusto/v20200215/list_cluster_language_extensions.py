...
def list_cluster_language_extensions(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20200215:listClusterLanguageExtensions', __args__, opts=opts, typ=ListClusterLanguageExtensionsResult).value
...
def list_cluster_language_extensions_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20200215:listClusterLanguageExtensions', __args__, opts=opts, typ=ListClusterLanguageExtensionsResult)
