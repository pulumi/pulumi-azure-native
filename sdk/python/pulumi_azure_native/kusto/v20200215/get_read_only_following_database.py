...
def get_read_only_following_database(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_read_only_following_database is deprecated: azure-native:kusto/v20200215:ReadOnlyFollowingDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadOnlyFollowingDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
