...
class AttachedDatabaseConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_name_override: Overrides the original database name. Relevant only when attaching to a specific database.
    ...
    def default_principals_modification_kind(self, value: pulumi.Input[Union[_builtins.str, 'DefaultPrincipalsModificationKind']]):
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="databaseNameOverride")
    def database_name_override(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Overrides the original database name. Relevant only when attaching to a specific database.
        """
        return pulumi.get(self, "database_name_override")
    ...
    @_builtins.property
    @pulumi.getter(name="databaseNamePrefix")
    def database_name_prefix(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Adds a prefix to the attached databases name. When following an entire cluster, that prefix would be added to all of the databases original names from leader cluster.
        """
        return pulumi.get(self, "database_name_prefix")
