...
class AttachedDatabaseConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 default_principals_modification_kind: pulumi.Input[Union[builtins.str, 'DefaultPrincipalsModificationKind']],
                 resource_group_name: pulumi.Input[builtins.str],
                 attached_database_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 database_name_override: Optional[pulumi.Input[builtins.str]] = None,
                 database_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_resource_id: The resource id of the cluster where the databases you would like to attach reside.
        :param pulumi.Input[builtins.str] database_name: The name of the database which you would like to attach, use * if you want to follow all current and future databases.
        :param pulumi.Input[Union[builtins.str, 'DefaultPrincipalsModificationKind']] default_principals_modification_kind: The default principals modification kind
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] attached_database_configuration_name: The name of the attached database configuration.
        :param pulumi.Input[builtins.str] database_name_override: Overrides the original database name. Relevant only when attaching to a specific database.
        :param pulumi.Input[builtins.str] database_name_prefix: Adds a prefix to the attached databases name. When following an entire cluster, that prefix would be added to all of the databases original names from leader cluster.
    ...
    def default_principals_modification_kind(self) -> pulumi.Input[Union[builtins.str, 'DefaultPrincipalsModificationKind']]:
        """
    ...
    def default_principals_modification_kind(self, value: pulumi.Input[Union[builtins.str, 'DefaultPrincipalsModificationKind']]):
    ...
    def attached_database_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attached_database_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "attached_database_configuration_name", value)

    @property
    @pulumi.getter(name="databaseNameOverride")
    def database_name_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_name_override(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_name_override", value)

    @property
    @pulumi.getter(name="databaseNamePrefix")
    def database_name_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_name_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 database_name_override: Optional[pulumi.Input[builtins.str]] = None,
                 database_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 default_principals_modification_kind: Optional[pulumi.Input[Union[builtins.str, 'DefaultPrincipalsModificationKind']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def attached_database_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="databaseNameOverride")
    def database_name_override(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Overrides the original database name. Relevant only when attaching to a specific database.
        """
        return pulumi.get(self, "database_name_override")
    ...
    @property
    @pulumi.getter(name="databaseNamePrefix")
    def database_name_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Adds a prefix to the attached databases name. When following an entire cluster, that prefix would be added to all of the databases original names from leader cluster.
        """
        return pulumi.get(self, "database_name_prefix")
    ...
    @property
    @pulumi.getter(name="defaultPrincipalsModificationKind")
    def default_principals_modification_kind(self) -> pulumi.Output[builtins.str]:
        """
        The default principals modification kind
        """
        return pulumi.get(self, "default_principals_modification_kind")
