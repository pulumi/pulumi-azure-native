...
def get_event_grid_data_connection(cluster_name: Optional[_builtins.str] = None,
                                   data_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_connection_name: The name of the data connection.
...
def get_event_grid_data_connection_output(cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                          data_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
