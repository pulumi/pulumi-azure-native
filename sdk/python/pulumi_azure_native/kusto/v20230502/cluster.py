...
class ClusterArgs:
    ...
    def _configure(
        ...
        if 'virtualClusterGraduationProperties' in kwargs:
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if key_vault_properties is not None and not isinstance(key_vault_properties, KeyVaultPropertiesArgs):
            ...
            if language_extensions is not None and not isinstance(language_extensions, LanguageExtensionsListArgs):
            ...
            if optimized_autoscale is not None and not isinstance(optimized_autoscale, OptimizedAutoscaleArgs):
            ...
            if sku is not None and not isinstance(sku, AzureSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
