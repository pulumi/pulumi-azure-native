...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20230502:getCluster', __args__, opts=opts, typ=GetClusterResult).value
    ...
    return AwaitableGetClusterResult(
        ...
        migration_cluster=__ret__.migration_cluster,
        name=__ret__.name,
