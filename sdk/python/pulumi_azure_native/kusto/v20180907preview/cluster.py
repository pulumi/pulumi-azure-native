...
warnings.warn("""Version 2018-09-07-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trusted_external_tenants: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TrustedExternalTenantArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Cluster is deprecated: Version 2018-09-07-preview will be removed in v2 of the provider.""")
