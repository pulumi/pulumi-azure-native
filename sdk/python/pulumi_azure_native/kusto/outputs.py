...
class AcceptedAudiencesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents an accepted audience trusted by the cluster.
        :param builtins.str value: GUID or valid URL representing an accepted audience.
        """
...
class AzureSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str tier: SKU tier.
...
class CalloutPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 callout_id: builtins.str,
                 callout_type: Optional[builtins.str] = None,
                 callout_uri_regex: Optional[builtins.str] = None,
                 outbound_access: Optional[builtins.str] = None):
        """
        Configuration for external callout policies, including URI patterns, access types, and service types.
        :param builtins.str callout_id: Unique identifier for the callout configuration.
        :param builtins.str callout_type: Type of the callout service, specifying the kind of external resource or service being accessed.
        :param builtins.str callout_uri_regex: Regular expression or FQDN pattern for the callout URI.
        :param builtins.str outbound_access: Indicates whether outbound access is permitted for the specified URI pattern.
        """
    ...
    def callout_id(self) -> builtins.str:
        """
    ...
    def callout_type(self) -> Optional[builtins.str]:
        """
    ...
    def callout_uri_regex(self) -> Optional[builtins.str]:
        """
    ...
    def outbound_access(self) -> Optional[builtins.str]:
        """
...
class DatabasePrincipalResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fqn: Optional[builtins.str] = None):
        """
        A class representing database principal entity.
        :param builtins.str name: Database principal name.
        :param builtins.str role: Database principal role.
        :param builtins.str tenant_name: The tenant name of the principal
        :param builtins.str type: Database principal type.
        :param builtins.str app_id: Application id - relevant only for application principal type.
        :param builtins.str email: Database principal email if exists.
        :param builtins.str fqn: Database principal fully qualified name.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def fqn(self) -> Optional[builtins.str]:
        """
...
class FollowerDatabaseDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 database_share_origin: builtins.str,
        ...
        :param builtins.str cluster_resource_id: Resource id of the cluster that follows a database owned by this cluster.
        ...
        :param builtins.str database_share_origin: The origin of the following setup.
...
class IdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove all identities.
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_identity: Optional[builtins.str] = None):
        """
        Properties of the key vault.
        :param builtins.str key_name: The name of the key vault key.
        :param builtins.str key_vault_uri: The Uri of the key vault.
        :param builtins.str key_version: The version of the key vault key.
        :param builtins.str user_identity: The user assigned identity (ARM resource id) that has access to the key.
        """
    ...
    def user_identity(self) -> Optional[builtins.str]:
        """
...
class LanguageExtensionResponse(dict):
    ...
    def __init__(__self__, *,
                 language_extension_custom_image_name: Optional[builtins.str] = None,
                 language_extension_image_name: Optional[builtins.str] = None,
                 language_extension_name: Optional[builtins.str] = None):
        """
        The language extension object.
        :param builtins.str language_extension_custom_image_name: The language extension custom image name.
        :param builtins.str language_extension_image_name: The language extension image name.
    ...
    def language_extension_custom_image_name(self) -> Optional[builtins.str]:
        """
    ...
    def language_extension_image_name(self) -> Optional[builtins.str]:
        """
...
class MigrationClusterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a properties of a cluster that is part of a migration.
        :param builtins.str data_ingestion_uri: The public data ingestion URL of the cluster.
        :param builtins.str id: The resource ID of the cluster.
        :param builtins.str role: The role of the cluster in the migration process.
        :param builtins.str uri: The public URL of the cluster.
        """
...
class SuspensionDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 suspension_start_date: Optional[builtins.str] = None):
        """
        The database suspension details. If the database is suspended, this object contains information related to the database's suspension state.
        :param builtins.str suspension_start_date: The starting date and time of the suspension state.
        """
    ...
    def suspension_start_date(self) -> Optional[builtins.str]:
        """
...
class TableLevelSharingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 functions_to_exclude: Optional[Sequence[builtins.str]] = None,
                 functions_to_include: Optional[Sequence[builtins.str]] = None,
        ...
        """
        Tables that will be included and excluded in the follower database
        :param Sequence[builtins.str] external_tables_to_exclude: List of external tables to exclude from the follower database
        :param Sequence[builtins.str] external_tables_to_include: List of external tables to include in the follower database
        :param Sequence[builtins.str] functions_to_exclude: List of functions to exclude from the follower database
        :param Sequence[builtins.str] functions_to_include: List of functions to include in the follower database
        :param Sequence[builtins.str] materialized_views_to_exclude: List of materialized views to exclude from the follower database
    ...
    def functions_to_exclude(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def functions_to_include(self) -> Optional[Sequence[builtins.str]]:
        """
...
class TrustedExternalTenantResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a tenant ID that is trusted by the cluster.
        :param builtins.str value: GUID representing an external tenant.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class VirtualNetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A class that contains virtual network definition.
        :param builtins.str data_management_public_ip_id: Data management's service public IP address resource id.
        :param builtins.str engine_public_ip_id: Engine service's public IP address resource id.
        :param builtins.str subnet_id: The subnet resource id.
        :param builtins.str state: When enabled, the cluster is deployed into the configured subnet, when disabled it will be removed from the subnet.
        """
