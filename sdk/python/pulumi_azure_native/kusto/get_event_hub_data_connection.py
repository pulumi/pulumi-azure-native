...
def get_event_hub_data_connection(cluster_name: Optional[builtins.str] = None,
...
def get_event_hub_data_connection_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
