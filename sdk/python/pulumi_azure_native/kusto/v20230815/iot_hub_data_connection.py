...
class IotHubDataConnectionArgs:
    ...
    def _configure(
        ...
        if iot_hub_resource_id is None and 'iotHubResourceId' in kwargs:
            iot_hub_resource_id = kwargs['iotHubResourceId']
        if iot_hub_resource_id is None:
            raise TypeError("Missing 'iot_hub_resource_id' argument")
        if kind is None:
