...
def get_script(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20230815:getScript', __args__, opts=opts, typ=GetScriptResult).value
...
def get_script_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scriptName'] = script_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20230815:getScript', __args__, opts=opts, typ=GetScriptResult)
