...
class EventGridDataConnectionArgs:
    ...
    def _configure(
        ...
        if event_grid_resource_id is None and 'eventGridResourceId' in kwargs:
            event_grid_resource_id = kwargs['eventGridResourceId']
        ...
        if event_grid_resource_id is not None:
            _setter("event_grid_resource_id", event_grid_resource_id)
