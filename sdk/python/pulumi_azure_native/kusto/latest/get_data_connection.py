...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:getDataConnection'.""", DeprecationWarning)
...
def get_data_connection(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/latest:getDataConnection', __args__, opts=opts, typ=GetDataConnectionResult).value
