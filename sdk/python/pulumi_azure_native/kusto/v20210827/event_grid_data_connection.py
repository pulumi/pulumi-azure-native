...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_grid_data_connection = azure_native.kusto.v20210827.EventGridDataConnection("eventGridDataConnection",
        ...
        ```sh
        $ pulumi import azure-native:kusto/v20210827:EventGridDataConnection KustoClusterRPTest4/KustoDatabase8/DataConnections8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/KustoClusterRPTest4/Databases/KustoDatabase8/DataConnections/DataConnections8 
        ```
