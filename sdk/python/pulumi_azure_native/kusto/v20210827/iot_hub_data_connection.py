...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_hub_data_connection = azure_native.kusto.v20210827.IotHubDataConnection("iotHubDataConnection",
