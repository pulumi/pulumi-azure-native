...
def get_managed_private_endpoint(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_private_endpoint is deprecated: azure-native:kusto/v20210827:ManagedPrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ManagedPrivateEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
