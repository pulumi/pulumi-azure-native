...
def get_event_grid_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_grid_data_connection is deprecated: azure-native:kusto/v20210827:EventGridDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:EventGridDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20210827:getEventGridDataConnection', __args__, opts=opts, typ=GetEventGridDataConnectionResult).value
