...
def get_iot_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_data_connection is deprecated: azure-native:kusto/v20210827:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20210827:getIotHubDataConnection', __args__, opts=opts, typ=GetIotHubDataConnectionResult).value
