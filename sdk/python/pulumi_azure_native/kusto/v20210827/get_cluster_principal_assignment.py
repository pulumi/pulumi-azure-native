...
warnings.warn("""azure-native:kusto/v20210827:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster_principal_assignment(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster_principal_assignment is deprecated: azure-native:kusto/v20210827:ClusterPrincipalAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:ClusterPrincipalAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['principalAssignmentName'] = principal_assignment_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20210827:getClusterPrincipalAssignment', __args__, opts=opts, typ=GetClusterPrincipalAssignmentResult).value
