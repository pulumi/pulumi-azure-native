...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'EngineType']] engine_type: The engine type
        ...
        :param pulumi.Input[Union[_builtins.str, 'PublicIPType']] public_ip_type: Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6)
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
        :param pulumi.Input[Union[_builtins.str, 'ClusterNetworkAccessFlag']] restrict_outbound_network_access: Whether or not to restrict outbound network access.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
        ...
        :param pulumi.Input[_builtins.str] virtual_cluster_graduation_properties: Virtual Cluster graduation properties
