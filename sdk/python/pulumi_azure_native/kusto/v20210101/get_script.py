...
warnings.warn("""azure-native:kusto/v20210101:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20210827:Script to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_script(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_script is deprecated: azure-native:kusto/v20210101:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20210827:Script to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20210101:getScript', __args__, opts=opts, typ=GetScriptResult).value
