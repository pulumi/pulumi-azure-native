...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        attached_database_configuration = azure_native.kusto.v20210101.AttachedDatabaseConfiguration("attachedDatabaseConfiguration",
            ...
            table_level_sharing_properties=azure_native.kusto.v20210101.TableLevelSharingPropertiesArgs(
