...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        enable_double_encryption=pulumi.get(__ret__, 'enable_double_encryption'),
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20210101:getCluster', __args__, opts=opts, typ=GetClusterResult)
