...
def get_event_hub_connection(cluster_name: Optional[_builtins.str] = None,
                             database_name: Optional[_builtins.str] = None,
                             event_hub_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The name of the resource group containing the Kusto cluster.
    """
    __args__ = dict()
...
def get_event_hub_connection_output(cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                    ...
                                    event_hub_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
