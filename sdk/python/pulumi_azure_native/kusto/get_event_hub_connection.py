...
def get_event_hub_connection(cluster_name: Optional[builtins.str] = None,
                             database_name: Optional[builtins.str] = None,
                             event_hub_connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str event_hub_connection_name: The name of the event hub connection.
    :param builtins.str resource_group_name: The name of the resource group containing the Kusto cluster.
    """
    __args__ = dict()
...
def get_event_hub_connection_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
