...
def get_read_write_database(cluster_name: Optional[_builtins.str] = None,
...
def get_read_write_database_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
