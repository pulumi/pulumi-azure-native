...
class ReadOnlyFollowingDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 caller_role: Optional[pulumi.Input[builtins.str]] = None,
                 database_name: Optional[pulumi.Input[builtins.str]] = None,
                 hot_cache_period: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kind: Kind of the database
               Expected value is 'ReadOnlyFollowing'.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] caller_role: By default, any user who run operation on a database become an Admin on it. This property allows the caller to exclude the caller from Admins list.
        :param pulumi.Input[builtins.str] database_name: The name of the database in the Kusto cluster.
        :param pulumi.Input[builtins.str] hot_cache_period: The time the data should be kept in cache for fast queries in TimeSpan.
    ...
    def caller_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @caller_role.setter
    def caller_role(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hot_cache_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hot_cache_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReadOnlyFollowingDatabase(pulumi.CustomResource):
    ...
    def attached_database_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def database_share_origin(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="hotCachePeriod")
    def hot_cache_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time the data should be kept in cache for fast queries in TimeSpan.
        """
        return pulumi.get(self, "hot_cache_period")
    ...
    def leader_cluster_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def original_database_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def principals_modification_kind(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def soft_delete_period(self) -> pulumi.Output[builtins.str]:
        """
