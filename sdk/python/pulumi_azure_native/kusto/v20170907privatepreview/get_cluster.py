...
azure-native:kusto/v20170907privatepreview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20220707:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: Version 2017-09-07-privatepreview will be removed in v2 of the provider.
azure-native:kusto/v20170907privatepreview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20220707:Cluster to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20170907privatepreview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
