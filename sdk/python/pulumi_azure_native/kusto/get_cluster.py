...
class GetClusterResult:
    ...
    def allowed_ip_range_list(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enable_auto_stop(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_disk_encryption(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_double_encryption(self) -> Optional[builtins.bool]:
        """
    ...
    def public_ip_type(self) -> Optional[builtins.str]:
        """
    ...
    def restrict_outbound_network_access(self) -> Optional[builtins.str]:
        """
...
def get_cluster(cluster_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto:getCluster', __args__, opts=opts, typ=GetClusterResult).value
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto:getCluster', __args__, opts=opts, typ=GetClusterResult)
