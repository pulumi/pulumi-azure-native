...
warnings.warn("""azure-native:kusto/v20220707:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_iot_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_data_connection is deprecated: azure-native:kusto/v20220707:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
