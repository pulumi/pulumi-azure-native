...
def get_read_write_database(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20220707:getReadWriteDatabase', __args__, opts=opts, typ=GetReadWriteDatabaseResult).value
...
def get_read_write_database_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20220707:getReadWriteDatabase', __args__, opts=opts, typ=GetReadWriteDatabaseResult)
