...
def get_event_grid_data_connection(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20220707:getEventGridDataConnection', __args__, opts=opts, typ=GetEventGridDataConnectionResult).value
...
def get_event_grid_data_connection_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20220707:getEventGridDataConnection', __args__, opts=opts, typ=GetEventGridDataConnectionResult)
