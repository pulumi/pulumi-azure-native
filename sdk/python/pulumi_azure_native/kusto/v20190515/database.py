...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:Database"), pulumi.Alias(type_="azure-native:kusto/v20180907preview:Database"), pulumi.Alias(type_="azure-native:kusto/v20190121:Database"), pulumi.Alias(type_="azure-native:kusto/v20190907:Database"), pulumi.Alias(type_="azure-native:kusto/v20191109:Database"), pulumi.Alias(type_="azure-native:kusto/v20200215:Database"), pulumi.Alias(type_="azure-native:kusto/v20200614:Database"), pulumi.Alias(type_="azure-native:kusto/v20200918:Database"), pulumi.Alias(type_="azure-native:kusto/v20210101:Database"), pulumi.Alias(type_="azure-native:kusto/v20210827:Database"), pulumi.Alias(type_="azure-native:kusto/v20220201:Database"), pulumi.Alias(type_="azure-native:kusto/v20220707:Database"), pulumi.Alias(type_="azure-native:kusto/v20221111:Database"), pulumi.Alias(type_="azure-native:kusto/v20221229:Database")])
