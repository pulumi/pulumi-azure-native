...
warnings.warn("""azure-native:kusto/v20190515:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IotHubDataConnection is deprecated: azure-native:kusto/v20190515:IotHubDataConnection is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""")
