...
class DatabasePrincipalAssignmentArgs:
    ...
    def principal_type(self, value: pulumi.Input[Union[_builtins.str, 'PrincipalType']]):
    ...
    @role.setter
    def role(self, value: pulumi.Input[Union[_builtins.str, 'DatabasePrincipalRole']]):
