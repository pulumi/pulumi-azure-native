...
class IotHubDataConnectionArgs:
    def __init__(__self__, *,
                 ...
                 database_routing: Optional[pulumi.Input[Union[builtins.str, 'DatabaseRouting']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'DatabaseRouting']] database_routing: Indication for database routing information from the data connection, by default only database routing information is allowed
        ...
        :param pulumi.Input[builtins.str] retrieval_start_date: When defined, the data connection retrieves existing Event hub events created since the Retrieval start date. It can only retrieve events retained by the Event hub, based on its retention period.
    ...
    def database_routing(self) -> Optional[pulumi.Input[Union[builtins.str, 'DatabaseRouting']]]:
        """
    ...
    def database_routing(self, value: Optional[pulumi.Input[Union[builtins.str, 'DatabaseRouting']]]):
...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="databaseRouting")
    def database_routing(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indication for database routing information from the data connection, by default only database routing information is allowed
        """
        return pulumi.get(self, "database_routing")
