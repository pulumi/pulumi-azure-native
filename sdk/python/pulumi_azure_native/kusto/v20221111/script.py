...
warnings.warn("""azure-native:kusto/v20221111:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:Script to guarantee forwards compatibility.""", DeprecationWarning)
...
class Script(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 script_url_sas_token: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Script is deprecated: azure-native:kusto/v20221111:Script is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:Script to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:Script"), pulumi.Alias(type_="azure-native:kusto/v20210101:Script"), pulumi.Alias(type_="azure-native:kusto/v20210827:Script"), pulumi.Alias(type_="azure-native:kusto/v20220201:Script"), pulumi.Alias(type_="azure-native:kusto/v20220707:Script"), pulumi.Alias(type_="azure-native:kusto/v20221229:Script")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Script, __self__).__init__(
            'azure-native:kusto/v20221111:Script',
            resource_name,
            __props__,
            opts)
