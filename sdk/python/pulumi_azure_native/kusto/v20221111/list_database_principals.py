...
def list_database_principals(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20221111:listDatabasePrincipals', __args__, opts=opts, typ=ListDatabasePrincipalsResult).value
...
def list_database_principals_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto/v20221111:listDatabasePrincipals', __args__, opts=opts, typ=ListDatabasePrincipalsResult)
