...
class ReadWriteDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        read_write_database = azure_native.kusto.v20221111.ReadWriteDatabase("readWriteDatabase",
        ...
        ```sh
        $ pulumi import azure-native:kusto/v20221111:ReadWriteDatabase kustoCluster/KustoDatabase8 /subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/Databases/KustoDatabase8 
        ```
