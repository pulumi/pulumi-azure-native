...
warnings.warn("""azure-native:kusto/v20221111:CosmosDbDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:CosmosDbDataConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cosmos_db_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cosmos_db_data_connection is deprecated: azure-native:kusto/v20221111:CosmosDbDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:CosmosDbDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20221111:getCosmosDbDataConnection', __args__, opts=opts, typ=GetCosmosDbDataConnectionResult).value
