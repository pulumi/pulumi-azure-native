...
def get_read_write_database(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_read_write_database is deprecated: azure-native:kusto/v20221111:ReadWriteDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:ReadWriteDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
