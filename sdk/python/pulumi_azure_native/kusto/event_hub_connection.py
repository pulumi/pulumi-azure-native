...
class EventHubConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:kusto:EventHubConnection"), pulumi.Alias(type_="azure-native:kusto/v20170907privatepreview:EventHubConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20170907privatepreview:EventHubConnection"), pulumi.Alias(type_="azure-native:kusto/v20180907preview:EventHubConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20180907preview:EventHubConnection")])
