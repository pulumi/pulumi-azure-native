...
class EventHubConnectionArgs:
    def __init__(__self__, *,
                 ...
                 data_format: Optional[pulumi.Input[Union[builtins.str, 'DataFormat']]] = None,
                 event_hub_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group containing the Kusto cluster.
        :param pulumi.Input[Union[builtins.str, 'DataFormat']] data_format: The data format of the message. Optionally the data format can be added to each message.
        :param pulumi.Input[builtins.str] event_hub_connection_name: The name of the event hub connection.
    ...
    def data_format(self) -> Optional[pulumi.Input[Union[builtins.str, 'DataFormat']]]:
        """
    ...
    @data_format.setter
    def data_format(self, value: Optional[pulumi.Input[Union[builtins.str, 'DataFormat']]]):
        pulumi.set(self, "data_format", value)

    @property
    @pulumi.getter(name="eventHubConnectionName")
    def event_hub_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventHubConnection(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:kusto:EventHubConnection"
