...
warnings.warn("""Version 2020-06-14 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: Version 2020-06-14 will be removed in v2 of the provider.""")
    __args__ = dict()
