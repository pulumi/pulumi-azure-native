...
warnings.warn("""azure-native:kusto/v20200614:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20220707:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: azure-native:kusto/v20200614:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20220707:Cluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20200614:getCluster', __args__, opts=opts, typ=GetClusterResult).value
