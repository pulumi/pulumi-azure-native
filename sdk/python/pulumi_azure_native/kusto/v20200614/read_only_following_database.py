...
class ReadOnlyFollowingDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        read_only_following_database = azure_native.kusto.v20200614.ReadOnlyFollowingDatabase("readOnlyFollowingDatabase",
