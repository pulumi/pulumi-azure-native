...
warnings.warn("""azure-native:kusto/v20200614:DatabasePrincipalAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:DatabasePrincipalAssignment to guarantee forwards compatibility.""", DeprecationWarning)
...
class DatabasePrincipalAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabasePrincipalAssignment is deprecated: azure-native:kusto/v20200614:DatabasePrincipalAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:kusto/v20221229:DatabasePrincipalAssignment to guarantee forwards compatibility.""")
