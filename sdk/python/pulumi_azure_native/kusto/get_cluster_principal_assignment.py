...
def get_cluster_principal_assignment(cluster_name: Optional[_builtins.str] = None,
                                     principal_assignment_name: Optional[_builtins.str] = None,
...
def get_cluster_principal_assignment_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:kusto:getClusterPrincipalAssignment', __args__, opts=opts, typ=GetClusterPrincipalAssignmentResult)
