...
def get_cluster_principal_assignment(cluster_name: Optional[builtins.str] = None,
...
def get_cluster_principal_assignment_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
