...
def get_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_connection is deprecated: Version 2019-09-07 will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20190907:getDataConnection', __args__, opts=opts, typ=GetDataConnectionResult).value
