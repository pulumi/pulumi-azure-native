...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_grid_data_connection = azure_native.kusto.v20190907.EventGridDataConnection("eventGridDataConnection",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:kusto:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190121:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190515:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20191109:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200215:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200614:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200918:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20210101:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20210827:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20220201:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20220707:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20221111:EventGridDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20221229:EventGridDataConnection")])
