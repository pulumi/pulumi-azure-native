...
class GetIotHubDataConnectionResult:
    ...
    """
    def __init__(__self__, consumer_group=None, data_format=None, event_system_properties=None, id=None, iot_hub_resource_id=None, kind=None, location=None, mapping_rule_name=None, name=None, shared_access_policy_name=None, table_name=None, type=None):
...
def get_iot_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_data_connection is deprecated: azure-native:kusto/v20190907:IotHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:IotHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20190907:getIotHubDataConnection', __args__, opts=opts, typ=GetIotHubDataConnectionResult).value
