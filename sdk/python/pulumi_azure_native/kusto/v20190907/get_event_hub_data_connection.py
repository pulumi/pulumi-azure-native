...
class GetEventHubDataConnectionResult:
    ...
    """
    def __init__(__self__, consumer_group=None, data_format=None, event_hub_resource_id=None, event_system_properties=None, id=None, kind=None, location=None, mapping_rule_name=None, name=None, table_name=None, type=None):
...
def get_event_hub_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub_data_connection is deprecated: azure-native:kusto/v20190907:EventHubDataConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:kusto/v20221229:EventHubDataConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20190907:getEventHubDataConnection', __args__, opts=opts, typ=GetEventHubDataConnectionResult).value
