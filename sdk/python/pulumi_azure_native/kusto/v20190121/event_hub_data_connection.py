...
class EventHubDataConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_hub_data_connection = azure_native.kusto.v20190121.EventHubDataConnection("eventHubDataConnection",
