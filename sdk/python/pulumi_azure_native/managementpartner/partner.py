...
class Partner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managementpartner:Partner"), pulumi.Alias(type_="azure-native:managementpartner/latest:Partner"), pulumi.Alias(type_="azure-nextgen:managementpartner/latest:Partner"), pulumi.Alias(type_="azure-native:managementpartner/v20180201:Partner"), pulumi.Alias(type_="azure-nextgen:managementpartner/v20180201:Partner")])
