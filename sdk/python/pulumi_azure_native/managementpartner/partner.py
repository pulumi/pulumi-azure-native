...
class Partner(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managementpartner/v20180201:Partner"), pulumi.Alias(type_="azure-native_managementpartner_v20180201:managementpartner:Partner")])
