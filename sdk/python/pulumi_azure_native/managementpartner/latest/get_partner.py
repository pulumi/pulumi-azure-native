...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:managementpartner:getPartner'.""", DeprecationWarning)
...
def get_partner(partner_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managementpartner/latest:getPartner', __args__, opts=opts, typ=GetPartnerResult).value
