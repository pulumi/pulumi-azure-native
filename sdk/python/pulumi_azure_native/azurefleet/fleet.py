...
class FleetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fleet_name: The name of the Compute Fleet
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Zones in which the Compute Fleet is available
        """
