...
class AdditionalCapabilitiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool ultra_ssd_enabled: The flag that enables or disables a capability to have one or more managed data disks with UltraSSD_LRS storage account type on the VM or VMSS.
...
class AdditionalUnattendContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Unattend.xml file, which is used by Windows Setup. Contents are defined by
        setting name, component name, and the pass in which the content is applied.
        :param _builtins.str component_name: The component name. Currently, the only allowable value is
               Microsoft-Windows-Shell-Setup.
        :param _builtins.str pass_name: The pass name. Currently, the only allowable value is OobeSystem.
        :param _builtins.str setting_name: Specifies the name of the setting to which the content applies. Possible values
...
class ApiEntityReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The API entity reference.
        :param _builtins.str id: The ARM resource id in the form of
...
class BaseVirtualMachineProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the base virtual machine profile for fleet
        :param _builtins.str time_created: Specifies the time in which this VM profile for the Virtual Machine Scale Set
        ...
        :param _builtins.str license_type: Specifies that the image or disk that is being used was licensed on-premises.
        ...
        :param _builtins.str user_data: UserData for the virtual machines in the scale set, which must be base-64
...
class BootDiagnosticsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str storage_uri: Uri of the storage account to use for placing the console output and
...
class ComputeProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 platform_fault_domain_count: Optional[_builtins.int] = None):
        """
        Compute Profile to use for running user's workloads.
        ...
        :param _builtins.str compute_api_version: Specifies the Microsoft.Compute API version to use when creating underlying Virtual Machine scale sets and Virtual Machines.
               The default value will be the latest supported computeApiVersion by Compute Fleet.
        :param _builtins.int platform_fault_domain_count: Specifies the number of fault domains to use when creating the underlying VMSS.
...
class DiffDiskSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str placement: Specifies the ephemeral disk placement for operating system disk. Possible
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        machine image, but is not used in other creation operations. NOTE: Image
        reference publisher and offer can only be set when you create the scale set.
        :param _builtins.str exact_version: Specifies in decimal numbers, the version of platform image or marketplace
        ...
        :param _builtins.str community_gallery_image_id: Specified the community gallery image unique id for vm deployment. This can be
               fetched from community gallery image GET call.
        :param _builtins.str id: Resource Id
        :param _builtins.str offer: Specifies the offer of the platform image or marketplace image used to create
               the virtual machine.
        :param _builtins.str publisher: The image publisher.
        :param _builtins.str shared_gallery_image_id: Specified the shared gallery image unique id for vm deployment. This can be
               fetched from shared gallery image GET call.
        :param _builtins.str sku: The image SKU.
        :param _builtins.str version: Specifies the version of the platform image or marketplace image used to create
...
class LinuxConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is enabled for the Linux virtual
        ...
        :param _builtins.bool provision_vm_agent: Indicates whether virtual machine agent should be provisioned on the virtual
...
class LinuxPatchSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies settings related to VM Guest Patching on Linux.
        :param _builtins.str assessment_mode: Specifies the mode of VM Guest Patch Assessment for the IaaS virtual
        ...
        :param 'LinuxVMGuestPatchAutomaticByPlatformSettingsResponse' automatic_by_platform_settings: Specifies additional settings for patch mode AutomaticByPlatform in VM Guest
               Patching on Linux.
        :param _builtins.str patch_mode: Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual
...
class LinuxVMGuestPatchAutomaticByPlatformSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str reboot_setting: Specifies the reboot setting for all AutomaticByPlatform patch installation
               operations.
        """
...
class LocationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the profile for a single additional location in the Fleet. The location and the virtualMachineProfileOverride (optional).
        :param _builtins.str location: The ARM location name of the additional region. If LocationProfile is specified, then location is required.
...
class OSImageNotificationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str not_before_timeout: Length of time a Virtual Machine being reimaged or having its OS upgraded will
...
class PatchSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'WindowsVMGuestPatchAutomaticByPlatformSettingsResponse' automatic_by_platform_settings: Specifies additional settings for patch mode AutomaticByPlatform in VM Guest
               Patching on Windows.
        :param _builtins.bool enable_hotpatching: Enables customers to patch their Azure VMs without requiring a reboot. For
...
class ProxyAgentSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies ProxyAgent settings while creating the virtual machine. Minimum
        api-version: 2023-09-01.
        :param _builtins.bool enabled: Specifies whether ProxyAgent feature should be enabled on the virtual machine
               or virtual machine scale set.
        :param _builtins.int key_incarnation_id: Increase the value of this property allows user to reset the key used for
               securing communication channel between guest and host.
        :param _builtins.str mode: Specifies the mode that ProxyAgent will execute on if the feature is enabled.
...
class RegularPriorityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration Options for Regular instances in Compute Fleet.
        :param _builtins.str allocation_strategy: Allocation strategy to follow when determining the VM sizes distribution for Regular VMs.
        :param _builtins.int capacity: Total capacity to achieve. It is currently in terms of number of VMs.
        :param _builtins.int min_capacity: Minimum capacity to achieve which cannot be updated. If we will not be able to "guarantee" minimum capacity, we will reject the request in the sync path itself.
        """
...
class SecurityPostureReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the security posture to be used for all virtual machines in the scale
        set. Minimum api-version: 2023-03-01
        :param Sequence[_builtins.str] exclude_extensions: List of virtual machine extension names to exclude when applying the security
               posture.
        :param _builtins.str id: The security posture reference id in the form of
...
class SecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the Security profile settings for the virtual machine or virtual
        machine scale set.
        :param _builtins.bool encryption_at_host: This property can be used by user in the request to enable or disable the Host
        ...
        :param 'ProxyAgentSettingsResponse' proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine. Minimum
               api-version: 2023-09-01.
        :param _builtins.str security_type: Specifies the SecurityType of the virtual machine. It has to be set to any
...
class ServiceArtifactReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        all virtual machines in the scale set when using 'latest' image version.
        Minimum api-version: 2022-11-01
        :param _builtins.str id: The service artifact reference id in the form of
...
class SpotPriorityProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maintain: Optional[_builtins.bool] = None,
                 max_price_per_vm: Optional[_builtins.float] = None,
                 min_capacity: Optional[_builtins.int] = None):
        """
        Configuration Options for Spot instances in Compute Fleet.
        :param _builtins.str allocation_strategy: Allocation strategy to follow when determining the VM sizes distribution for Spot VMs.
        :param _builtins.int capacity: Total capacity to achieve. It is currently in terms of number of VMs.
        :param _builtins.str eviction_policy: Eviction Policy to follow when evicting Spot VMs.
        :param _builtins.bool maintain: Flag to enable/disable continuous goal seeking for the desired capacity and restoration of evicted Spot VMs.
...
class SshPublicKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Contains information about SSH certificate public key and the path on the Linux
        VM where the public key is placed.
        :param _builtins.str key_data: SSH public key certificate used to authenticate with the VM through ssh. The
               key needs to be at least 2048-bit and in ssh-rsa format. For creating ssh keys,
               see [Create SSH keys on Linux and Mac for Linux VMs in
               Azure]https://learn.microsoft.com/azure/virtual-machines/linux/create-ssh-keys-detailed).
        :param _builtins.str path: Specifies the full path on the created VM where ssh public key is stored. If
...
class TerminateNotificationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str not_before_timeout: Configurable length of time a Virtual Machine being deleted will have to
...
class UefiSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the security settings like secure boot and vTPM used while creating
        the virtual machine. Minimum api-version: 2020-12-01.
        :param _builtins.bool secure_boot_enabled: Specifies whether secure boot should be enabled on the virtual machine. Minimum
               api-version: 2020-12-01.
        :param _builtins.bool v_tpm_enabled: Specifies whether vTPM should be enabled on the virtual machine. Minimum
               api-version: 2020-12-01.
        """
...
class VMAttributeMinMaxDoubleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        VMAttributes using double values.
        :param _builtins.float max: Maximum value. Double.MaxValue(1.7976931348623157E+308)
        :param _builtins.float min: Minimum value. default 0. Double.MinValue()
        """
        if max is not None:
...
class VMAttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] accelerator_manufacturers: The accelerator manufacturers specified as a list. 
               acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute. 
               If acceleratorSupport is "Excluded", this VMAttribute can not be used.
        :param _builtins.str accelerator_support: Specifies whether the VMSize supporting accelerator should be used to build Fleet or not.
               acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute. 
               If acceleratorSupport is "Excluded", this VMAttribute can not be used.
        :param Sequence[_builtins.str] accelerator_types: The accelerator types specified as a list. acceleratorSupport should be set to "Included" or "Required" to use this VMAttribute. 
               If acceleratorSupport is "Excluded", this VMAttribute can not be used.
        :param Sequence[_builtins.str] architecture_types: The VM architecture types specified as a list. Optional parameter.
        :param _builtins.str burstable_support: Specifies whether the VMSize supporting burstable capability should be used to build Fleet or not.
        ...
        :param Sequence[_builtins.str] excluded_vm_sizes: Specifies which VMSizes should be excluded while building Fleet. Optional parameter.
        ...
        :param 'VMAttributeMinMaxDoubleResponse' local_storage_in_gi_b: LocalStorageSupport should be set to "Included" or "Required" to use this VMAttribute. 
               If localStorageSupport is "Excluded", this VMAttribute can not be used.
        :param _builtins.str local_storage_support: Specifies whether the VMSize supporting local storage should be used to build Fleet or not.
        ...
        :param _builtins.str rdma_support: Specifies whether the VMSize supporting RDMA (Remote Direct Memory Access) should be used to build Fleet or not.
...
class VMDiskSecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DiskEncryptionSetParametersResponse' disk_encryption_set: Specifies the customer managed disk encryption set resource id for the managed
               ...
               VMGuest blob.
        :param _builtins.str security_encryption_type: Specifies the EncryptionType of the managed disk. It is set to
...
class VMGalleryApplicationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Specifies the required information to reference a compute gallery application
        version
        :param _builtins.str package_reference_id: Specifies the GalleryApplicationVersion resource id on the form of
               /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{application}/versions/{version}
        :param _builtins.str configuration_reference: Optional, Specifies the uri to an azure blob that will replace the default
               configuration for the package if provided
        :param _builtins.bool enable_automatic_upgrade: If set to true, when a new Gallery Application version is available in PIR/SIG,
        ...
        :param _builtins.bool treat_failure_as_deployment_failure: Optional, If true, any failure for any operation in the VmApplication will fail
               the deployment
        """
...
class VMSizePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies VM Size Property settings on the virtual machine.
        :param _builtins.int v_cpus_available: Specifies the number of vCPUs available for the VM. When this property is not
               specified in the request body the default behavior is to set it to the value of
               vCPUs available for that VM size exposed in api response of [List all available
               virtual machine sizes in a
               region](https://learn.microsoft.com/en-us/rest/api/compute/resource-skus/list).
        :param _builtins.int v_cpus_per_core: Specifies the vCPU to physical core ratio. When this property is not specified
...
class VaultCertificateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Describes a single certificate reference in a Key Vault, and where the
        certificate should reside on the VM.
        :param _builtins.str certificate_store: For Windows VMs, specifies the certificate store on the Virtual Machine to
               ...
               formatted.
        :param _builtins.str certificate_url: This is the URL of a certificate that has been uploaded to Key Vault as a
...
class VirtualMachineScaleSetDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str caching: Specifies the caching requirements. Possible values are: **None,**
               **ReadOnly,** **ReadWrite.** The default values are: **None for Standard
               storage. ReadOnly for Premium storage.**
        :param _builtins.str delete_option: Specifies whether data disk should be deleted or detached upon VMSS Flex
        ...
        :param _builtins.float disk_iops_read_write: Specifies the Read-Write IOPS for the managed disk. Should be used only when
               StorageAccountType is UltraSSD_LRS. If not specified, a default value would be
               assigned based on diskSizeGB.
        :param _builtins.float disk_m_bps_read_write: Specifies the bandwidth in MB per second for the managed disk. Should be used
               only when StorageAccountType is UltraSSD_LRS. If not specified, a default value
               would be assigned based on diskSizeGB.
        :param _builtins.int disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be used
...
class VirtualMachineScaleSetExtensionProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str extensions_time_budget: Specifies the time alloted for all extensions to start. The time duration
...
class VirtualMachineScaleSetExtensionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool auto_upgrade_minor_version: Indicates whether the extension should use a newer minor version if one is
               available at deployment time. Once deployed, however, the extension will not
               upgrade minor versions unless redeployed, even with this property set to true.
        :param _builtins.bool enable_automatic_upgrade: Indicates whether the extension should be automatically upgraded by the
               platform if there is a newer version of the extension available.
        :param _builtins.str force_update_tag: If a value is provided and is different from the previous value, the extension
        ...
        :param 'KeyVaultSecretReferenceResponse' protected_settings_from_key_vault: The extensions protected settings that are passed by reference, and consumed
               from key vault
        :param Sequence[_builtins.str] provision_after_extensions: Collection of extension names after which this extension needs to be
               provisioned.
        :param _builtins.str publisher: The name of the extension handler publisher.
        :param Any settings: Json formatted public settings for the extension.
        :param _builtins.bool suppress_failures: Indicates whether failures stemming from the extension will be suppressed
...
class VirtualMachineScaleSetIPConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool primary: Specifies the primary network interface in case the virtual machine has more
               than 1 network interface.
        :param _builtins.str private_ip_address_version: Available from Api-Version 2017-03-30 onwards, it represents whether the
...
class VirtualMachineScaleSetManagedDiskParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str storage_account_type: Specifies the storage account type for the managed disk. NOTE: UltraSSD_LRS can
...
class VirtualMachineScaleSetNetworkConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auxiliary_mode: Specifies whether the Auxiliary mode is enabled for the Network Interface
               resource.
        :param _builtins.str auxiliary_sku: Specifies whether the Auxiliary sku is enabled for the Network Interface
               resource.
...
class VirtualMachineScaleSetNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str network_api_version: specifies the Microsoft.Network API version used when creating networking
...
class VirtualMachineScaleSetOSDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machine scale set operating system disk.
        :param _builtins.str create_option: Specifies how the virtual machines in the scale set should be created. The only
        ...
        :param _builtins.str caching: Specifies the caching requirements. Possible values are: **None,**
               **ReadOnly,** **ReadWrite.** The default values are: **None for Standard
               storage. ReadOnly for Premium storage.**
        :param _builtins.str delete_option: Specifies whether OS Disk should be deleted or detached upon VMSS Flex deletion
        ...
        :param 'VirtualMachineScaleSetManagedDiskParametersResponse' managed_disk: The managed disk parameters.
        :param _builtins.str name: The disk name.
        :param _builtins.str os_type: This property allows you to specify the type of the OS that is included in the
               disk if creating a VM from user-image or a specialized VHD. Possible values
               are: **Windows,** **Linux.**
        :param Sequence[_builtins.str] vhd_containers: Specifies the container urls that are used to store operating system disks for
               the scale set.
        :param _builtins.bool write_accelerator_enabled: Specifies whether writeAccelerator should be enabled or disabled on the disk.
        """
        pulumi.set(__self__, "create_option", create_option)
...
class VirtualMachineScaleSetOSProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machine scale set OS profile.
        :param _builtins.str admin_username: Specifies the name of the administrator account. <br><br> **Windows-only
        ...
        :param _builtins.bool allow_extension_operations: Specifies whether extension operations should be allowed on the virtual machine
               scale set. This may only be set to False when no extensions are present on the
               virtual machine scale set.
        :param _builtins.str computer_name_prefix: Specifies the computer name prefix for all of the virtual machines in the scale
...
class VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a virtual machines scale sets network configuration's DNS settings.
        :param _builtins.str domain_name_label: The Domain name label.The concatenation of the domain name label and vm index
               will be the domain name labels of the PublicIPAddress resources that will be
               created
        :param _builtins.str domain_name_label_scope: The Domain name label scope.The concatenation of the hashed domain name label
...
class VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str public_ip_address_version: Available from Api-Version 2019-07-01 onwards, it represents whether the
               specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible
               values are: 'IPv4' and 'IPv6'.
...
class VmSizeProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int rank: The rank of the VM size. This is used with 'RegularPriorityAllocationStrategy.Prioritized'
...
class WinRMListenerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str certificate_url: This is the URL of a certificate that has been uploaded to Key Vault as a
               ...
               or the [Azure Key Vault virtual machine extension for
               Windows](https://learn.microsoft.com/azure/virtual-machines/extensions/key-vault-windows).
        :param _builtins.str protocol: Specifies the protocol of WinRM listener. Possible values are: **http,**
               **https.**
        """
        if certificate_url is not None:
            pulumi.set(__self__, "certificate_url", certificate_url)
...
class WindowsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enable_automatic_updates: Indicates whether Automatic Updates is enabled for the Windows virtual machine.
        ...
        :param _builtins.bool enable_vm_agent_platform_updates: Indicates whether VMAgent Platform Updates is enabled for the Windows virtual
               machine. Default value is false.
        ...
        :param _builtins.str time_zone: Specifies the time zone of the virtual machine. e.g. "Pacific Standard Time".
