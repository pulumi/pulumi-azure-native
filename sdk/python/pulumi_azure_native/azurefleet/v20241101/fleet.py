...
class Fleet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurefleet:Fleet"), pulumi.Alias(type_="azure-native:azurefleet/v20231101preview:Fleet"), pulumi.Alias(type_="azure-native:azurefleet/v20240501preview:Fleet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Fleet, __self__).__init__(
            'azure-native:azurefleet/v20241101:Fleet',
            resource_name,
            __props__,
            opts)
