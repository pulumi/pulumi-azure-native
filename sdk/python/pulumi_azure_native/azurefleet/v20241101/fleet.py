...
class Fleet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurefleet/v20231101preview:Fleet"), pulumi.Alias(type_="azure-native:azurefleet/v20240501preview:Fleet"), pulumi.Alias(type_="azure-native:azurefleet:Fleet")])
