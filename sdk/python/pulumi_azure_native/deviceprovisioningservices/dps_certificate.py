...
class DpsCertificateArgs:
    def __init__(__self__, *,
                 provisioning_service_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] provisioning_service_name: The name of the provisioning service.
        :param pulumi.Input[builtins.str] resource_group_name: Resource group identifier.
        :param pulumi.Input[builtins.str] certificate_name: The name of the certificate create or update.
    ...
    def provisioning_service_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provisioning_service_name(self, value: pulumi.Input[builtins.str]):
