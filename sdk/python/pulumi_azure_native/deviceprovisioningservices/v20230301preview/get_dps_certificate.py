...
def get_dps_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceprovisioningservices/v20230301preview:getDpsCertificate', __args__, opts=opts, typ=GetDpsCertificateResult).value
...
def get_dps_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:deviceprovisioningservices/v20230301preview:getDpsCertificate', __args__, opts=opts, typ=GetDpsCertificateResult)
