...
def get_iot_dps_resource(provisioning_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceprovisioningservices/v20230301preview:getIotDpsResource', __args__, opts=opts, typ=GetIotDpsResourceResult).value
...
def get_iot_dps_resource_output(provisioning_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:deviceprovisioningservices/v20230301preview:getIotDpsResource', __args__, opts=opts, typ=GetIotDpsResourceResult)
