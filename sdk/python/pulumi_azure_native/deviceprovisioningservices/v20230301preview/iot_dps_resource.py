...
class IotDpsResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20170821preview:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20171115:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20180122:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200101:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200301:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200901preview:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20211015:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20220205:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20221212:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20250201preview:IotDpsResource"), pulumi.Alias(type_="azure-native:deviceprovisioningservices:IotDpsResource"), pulumi.Alias(type_="azure-native:devices/v20200901preview:IotDpsResource"), pulumi.Alias(type_="azure-native:devices/v20221212:IotDpsResource"), pulumi.Alias(type_="azure-native:devices/v20230301preview:IotDpsResource"), pulumi.Alias(type_="azure-native:devices/v20250201preview:IotDpsResource"), pulumi.Alias(type_="azure-native:devices:IotDpsResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotDpsResource, __self__).__init__(
            'azure-native:deviceprovisioningservices/v20230301preview:IotDpsResource',
            resource_name,
            __props__,
            opts)
