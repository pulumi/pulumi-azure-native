...
class DpsCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20170821preview:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20171115:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20180122:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200101:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200301:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20200901preview:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20220205:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20221212:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20230301preview:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices/v20250201preview:DpsCertificate"), pulumi.Alias(type_="azure-native:deviceprovisioningservices:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20211015:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20221212:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20230301preview:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20250201preview:DpsCertificate"), pulumi.Alias(type_="azure-native:devices:DpsCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DpsCertificate, __self__).__init__(
            'azure-native:deviceprovisioningservices/v20211015:DpsCertificate',
            resource_name,
            __props__,
            opts)
