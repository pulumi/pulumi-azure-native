...
class IotDpsPropertiesDescriptionArgsDict(TypedDict):
    ...
    """
    authorization_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArgs']]]]]
    """
    ...
    """
    iot_hubs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IotHubDefinitionDescriptionArgs']]]]]
    """
...
class IotDpsPropertiesDescriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] portal_operations_host_name: Portal endpoint to enable CORS for this provisioning service.
        ...
        :param pulumi.Input[_builtins.str] provisioning_state: The ARM provisioning state of the provisioning service.
        ...
        :param pulumi.Input[Union[_builtins.str, 'State']] state: Current state of the provisioning service.
        """
...
class IotHubDefinitionDescriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] apply_allocation_policy: flag for applying allocationPolicy or not for a given iot hub.
        """
...
class SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secondary_key: Secondary SAS key value.
        """
    ...
    @rights.setter
    def rights(self, value: pulumi.Input[Union[_builtins.str, 'AccessRightsDescription']]):
