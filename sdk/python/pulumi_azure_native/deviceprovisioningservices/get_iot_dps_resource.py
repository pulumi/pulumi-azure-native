...
def get_iot_dps_resource(provisioning_service_name: Optional[_builtins.str] = None,
...
def get_iot_dps_resource_output(provisioning_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
