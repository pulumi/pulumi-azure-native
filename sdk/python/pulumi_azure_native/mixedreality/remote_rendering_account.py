...
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mixedreality/v20210101:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native:mixedreality/v20210301preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native_mixedreality_v20191202preview:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native_mixedreality_v20200406preview:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native_mixedreality_v20210101:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native_mixedreality_v20210301preview:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native_mixedreality_v20250101:mixedreality:RemoteRenderingAccount")])
