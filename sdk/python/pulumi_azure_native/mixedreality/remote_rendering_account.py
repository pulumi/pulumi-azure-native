...
class RemoteRenderingAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_name: Name of an Mixed Reality Account.
        ...
        :param pulumi.Input[_builtins.str] storage_account_name: The name of the storage account associated with this accountId
...
@pulumi.type_token("azure-native:mixedreality:RemoteRenderingAccount")
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def account_domain(self) -> pulumi.Output[_builtins.str]:
        """
