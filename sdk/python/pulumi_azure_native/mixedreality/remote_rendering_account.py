...
class RemoteRenderingAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: Name of an Mixed Reality Account.
        ...
        :param pulumi.Input[builtins.str] storage_account_name: The name of the storage account associated with this accountId
...
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def account_domain(self) -> pulumi.Output[builtins.str]:
        """
