...
class RemoteRenderingAccountArgs:
    def __init__(__self__, *,
        ...
        """
        RemoteRenderingAccountArgs._configure(
...
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteRenderingAccountArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            kind = _utilities.configure(kind, SkuArgs, True)
            __props__.__dict__["kind"] = kind
            __props__.__dict__["location"] = location
            plan = _utilities.configure(plan, IdentityArgs, True)
