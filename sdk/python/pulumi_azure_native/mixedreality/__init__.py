...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:mixedreality:ObjectAnchorsAccount":
                return ObjectAnchorsAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality:RemoteRenderingAccount":
                return RemoteRenderingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality:SpatialAnchorsAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "mixedreality", _module_instance)
