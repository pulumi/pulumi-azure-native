...
class SpatialAnchorsAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        spatial_anchors_account = azure_native.mixedreality.v20210101.SpatialAnchorsAccount("spatialAnchorsAccount",
        ...
        ```sh
        $ pulumi import azure-native:mixedreality/v20210101:SpatialAnchorsAccount MyAccount /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/MyResourceGroup/providers/Microsoft.MixedReality/spatialAnchorsAccounts/MyAccount 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(SpatialAnchorsAccount, __self__).__init__(
            'azure-native:mixedreality/v20210101:SpatialAnchorsAccount',
            resource_name,
            __props__,
            opts)
