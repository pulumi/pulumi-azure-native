...
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        remote_rendering_account = azure_native.mixedreality.v20210101.RemoteRenderingAccount("remoteRenderingAccount",
            account_name="MyAccount",
            identity=azure_native.mixedreality.v20210101.IdentityArgs(
                type=azure_native.mixedreality/v20210101.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
