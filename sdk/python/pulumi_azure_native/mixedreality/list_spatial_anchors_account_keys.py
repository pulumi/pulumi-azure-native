...
def list_spatial_anchors_account_keys(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_name: Name of an Mixed Reality Account.
...
def list_spatial_anchors_account_keys_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
                                             resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListSpatialAnchorsAccountKeysResult]:
    """
    > [!NOTE]
    > 
    > **Mixed Reality retirement**
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mixedreality:listSpatialAnchorsAccountKeys', __args__, opts=opts, typ=ListSpatialAnchorsAccountKeysResult)
