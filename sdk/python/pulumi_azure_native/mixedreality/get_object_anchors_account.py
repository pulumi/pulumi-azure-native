...
def get_object_anchors_account(account_name: Optional[_builtins.str] = None,
...
def get_object_anchors_account_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
