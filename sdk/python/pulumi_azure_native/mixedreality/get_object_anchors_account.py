...
def get_object_anchors_account(account_name: Optional[builtins.str] = None,
...
def get_object_anchors_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mixedreality:getObjectAnchorsAccount', __args__, opts=opts, typ=GetObjectAnchorsAccountResult)
