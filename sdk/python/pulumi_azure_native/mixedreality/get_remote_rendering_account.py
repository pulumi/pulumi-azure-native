...
def get_remote_rendering_account(account_name: Optional[_builtins.str] = None,
...
def get_remote_rendering_account_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
