...
def get_spatial_anchors_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_spatial_anchors_account is deprecated: Version v20191202preview will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
