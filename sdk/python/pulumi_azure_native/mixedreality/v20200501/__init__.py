...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:mixedreality/v20200501:SpatialAnchorsAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "mixedreality/v20200501", _module_instance)
