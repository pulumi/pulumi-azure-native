...
def get_spatial_anchors_account(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mixedreality:getSpatialAnchorsAccount', __args__, opts=opts, typ=GetSpatialAnchorsAccountResult).value
...
def get_spatial_anchors_account_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mixedreality:getSpatialAnchorsAccount', __args__, opts=opts, typ=GetSpatialAnchorsAccountResult)
