...
def get_spatial_anchors_account(account_name: Optional[builtins.str] = None,
...
def get_spatial_anchors_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
