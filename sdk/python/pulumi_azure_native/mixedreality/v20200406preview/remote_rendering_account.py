...
__all__ = ['RemoteRenderingAccountArgs', 'RemoteRenderingAccount']

@pulumi.input_type
class RemoteRenderingAccountArgs:
...
class RemoteRenderingAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RemoteRenderingAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RemoteRenderingAccountArgs.__new__(RemoteRenderingAccountArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:mixedreality/v20200406preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native:mixedreality/v20191202preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20191202preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native:mixedreality/v20210101:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20210101:RemoteRenderingAccount"), pulumi.Alias(type_="azure-native:mixedreality/v20210301preview:RemoteRenderingAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality/v20210301preview:RemoteRenderingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemoteRenderingAccount, __self__).__init__(
            'azure-native:mixedreality/v20200406preview:RemoteRenderingAccount',
            resource_name,
            __props__,
            opts)
