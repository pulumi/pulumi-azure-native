...
def get_object_anchors_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mixedreality/v20210301preview:getObjectAnchorsAccount', __args__, opts=opts, typ=GetObjectAnchorsAccountResult).value
