...
@pulumi.input_type
class ObjectAnchorsAccountArgs:
    def __init__(__self__, *,
        ...
        """
        ObjectAnchorsAccountArgs._configure(
    ...
    @property
    @pulumi.getter
    def identity(self) -> Optional[pulumi.Input['ObjectAnchorsAccountIdentityArgs']]:
        return pulumi.get(self, "identity")

    @identity.setter
    def identity(self, value: Optional[pulumi.Input['ObjectAnchorsAccountIdentityArgs']]):
...
class ObjectAnchorsAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ObjectAnchorsAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ObjectAnchorsAccountArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ObjectAnchorsAccountArgs.__new__(ObjectAnchorsAccountArgs)

            __props__.__dict__["account_name"] = account_name
            if identity is not None and not isinstance(identity, ObjectAnchorsAccountIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                ObjectAnchorsAccountIdentityArgs._configure(_setter, **identity)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mixedreality:ObjectAnchorsAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ObjectAnchorsAccount, __self__).__init__(
            'azure-native:mixedreality/v20210301preview:ObjectAnchorsAccount',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ObjectAnchorsAccount':
        """
    ...
    @property
    @pulumi.getter
    def identity(self) -> pulumi.Output[Optional['outputs.ObjectAnchorsAccountResponseIdentity']]:
        return pulumi.get(self, "identity")
