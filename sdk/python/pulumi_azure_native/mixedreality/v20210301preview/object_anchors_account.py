...
class ObjectAnchorsAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:mixedreality/v20210301preview:ObjectAnchorsAccount"), pulumi.Alias(type_="azure-native:mixedreality:ObjectAnchorsAccount"), pulumi.Alias(type_="azure-nextgen:mixedreality:ObjectAnchorsAccount")])
