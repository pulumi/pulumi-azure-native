...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:getRemoteRenderingAccount'.""", DeprecationWarning)
...
def get_remote_rendering_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_remote_rendering_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:getRemoteRenderingAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mixedreality/latest:getRemoteRenderingAccount', __args__, opts=opts, typ=GetRemoteRenderingAccountResult).value
