...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:listSpatialAnchorsAccountKeys'.""", DeprecationWarning)
...
def list_spatial_anchors_account_keys(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_spatial_anchors_account_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:listSpatialAnchorsAccountKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mixedreality/latest:listSpatialAnchorsAccountKeys', __args__, opts=opts, typ=ListSpatialAnchorsAccountKeysResult).value
