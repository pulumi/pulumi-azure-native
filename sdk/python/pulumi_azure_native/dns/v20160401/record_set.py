...
class RecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dns/v20150504preview:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20170901:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20171001:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20180301preview:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20180501:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20230701preview:RecordSet"), pulumi.Alias(type_="azure-native:dns:RecordSet"), pulumi.Alias(type_="azure-native:network/v20150504preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20160401:RecordSet"), pulumi.Alias(type_="azure-native:network/v20170901:RecordSet"), pulumi.Alias(type_="azure-native:network/v20171001:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180301preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180501:RecordSet"), pulumi.Alias(type_="azure-native:network/v20230701preview:RecordSet"), pulumi.Alias(type_="azure-native:network:RecordSet")])
