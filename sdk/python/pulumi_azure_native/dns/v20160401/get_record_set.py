...
class GetRecordSetResult:
    ...
    """
    def __init__(__self__, a_records=None, aaaa_records=None, cname_record=None, etag=None, fqdn=None, id=None, metadata=None, mx_records=None, name=None, ns_records=None, ptr_records=None, soa_record=None, srv_records=None, ttl=None, txt_records=None, type=None):
...
def get_record_set(record_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20160401:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
...
def get_record_set_output(record_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20160401:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
