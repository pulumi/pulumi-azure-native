...
class GetZoneResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, location=None, max_number_of_record_sets=None, max_number_of_records_per_record_set=None, name=None, name_servers=None, number_of_record_sets=None, registration_virtual_networks=None, resolution_virtual_networks=None, signing_keys=None, system_data=None, tags=None, type=None, zone_type=None):
    ...
    def max_number_of_records_per_record_set(self) -> builtins.float:
        """
    ...
    def zone_type(self) -> Optional[builtins.str]:
        """
...
def get_zone(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns:getZone', __args__, opts=opts, typ=GetZoneResult).value
...
def get_zone_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns:getZone', __args__, opts=opts, typ=GetZoneResult)
