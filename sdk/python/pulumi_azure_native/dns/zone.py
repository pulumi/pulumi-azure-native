...
class Zone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20180501:Zone"), pulumi.Alias(type_="azure-native:network/v20230701preview:Zone"), pulumi.Alias(type_="azure-native:network:Zone"), pulumi.Alias(type_="azure-native_dns_v20150504preview:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20160401:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20170901:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20171001:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20180301preview:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20180501:dns:Zone"), pulumi.Alias(type_="azure-native_dns_v20230701preview:dns:Zone")])
