...
def get_record_set(record_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20180301preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
...
def get_record_set_output(record_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20180301preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
