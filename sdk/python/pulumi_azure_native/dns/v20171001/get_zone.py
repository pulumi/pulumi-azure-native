...
def get_zone(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20171001:getZone', __args__, opts=opts, typ=GetZoneResult).value
...
def get_zone_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20171001:getZone', __args__, opts=opts, typ=GetZoneResult)
