...
if not MYPY:
    class ZonePropertiesArgsDict(TypedDict):
        """
        Represents the properties of the zone.
        """
        max_number_of_record_sets: NotRequired[pulumi.Input[float]]
        """
        Gets or sets the maximum number of record sets that can be created in this zone.
        """
        number_of_record_sets: NotRequired[pulumi.Input[float]]
        """
        Gets or sets the current number of record sets in this zone.
        """
elif False:
    ZonePropertiesArgsDict: TypeAlias = Mapping[str, Any]
