...
class RecordSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 a_aaa_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AaaaRecordArgs', 'AaaaRecordArgsDict']]]]] = None,
                 a_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ARecordArgs', 'ARecordArgsDict']]]]] = None,
                 c_name_record: Optional[pulumi.Input[Union['CnameRecordArgs', 'CnameRecordArgsDict']]] = None,
                 m_x_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MxRecordArgs', 'MxRecordArgsDict']]]]] = None,
                 n_s_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NsRecordArgs', 'NsRecordArgsDict']]]]] = None,
                 p_tr_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PtrRecordArgs', 'PtrRecordArgsDict']]]]] = None,
                 record_type: Optional[pulumi.Input[str]] = None,
                 relative_record_set_name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 s_oa_record: Optional[pulumi.Input[Union['SoaRecordArgs', 'SoaRecordArgsDict']]] = None,
                 s_rv_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SrvRecordArgs', 'SrvRecordArgsDict']]]]] = None,
                 t_xt_records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TxtRecordArgs', 'TxtRecordArgsDict']]]]] = None,
                 ttl: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AaaaRecordArgs', 'AaaaRecordArgsDict']]]] a_aaa_records: Gets or sets the list of AAAA records in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ARecordArgs', 'ARecordArgsDict']]]] a_records: Gets or sets the list of A records in the RecordSet.
        :param pulumi.Input[Union['CnameRecordArgs', 'CnameRecordArgsDict']] c_name_record: Gets or sets the CNAME record in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MxRecordArgs', 'MxRecordArgsDict']]]] m_x_records: Gets or sets the list of MX records in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NsRecordArgs', 'NsRecordArgsDict']]]] n_s_records: Gets or sets the list of NS records in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PtrRecordArgs', 'PtrRecordArgsDict']]]] p_tr_records: Gets or sets the list of PTR records in the RecordSet.
        :param pulumi.Input[str] record_type: The type of DNS record.
        :param pulumi.Input[str] relative_record_set_name: The name of the RecordSet, relative to the name of the zone.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union['SoaRecordArgs', 'SoaRecordArgsDict']] s_oa_record: Gets or sets the SOA record in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SrvRecordArgs', 'SrvRecordArgsDict']]]] s_rv_records: Gets or sets the list of SRV records in the RecordSet.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TxtRecordArgs', 'TxtRecordArgsDict']]]] t_xt_records: Gets or sets the list of TXT records in the RecordSet.
        :param pulumi.Input[float] ttl: Gets or sets the TTL of the records in the RecordSet.
        :param pulumi.Input[str] zone_name: The name of the zone without a terminating dot.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20150504preview:RecordSet"), pulumi.Alias(type_="azure-native:dns:RecordSet"), pulumi.Alias(type_="azure-native:network:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20160401:RecordSet"), pulumi.Alias(type_="azure-native:network/v20160401:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20170901:RecordSet"), pulumi.Alias(type_="azure-native:network/v20170901:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20171001:RecordSet"), pulumi.Alias(type_="azure-native:network/v20171001:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20180301preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180301preview:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20180501:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180501:RecordSet"), pulumi.Alias(type_="azure-native:dns/v20230701preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20230701preview:RecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RecordSet, __self__).__init__(
            'azure-native:dns/v20150504preview:RecordSet',
            resource_name,
            __props__,
            opts)
