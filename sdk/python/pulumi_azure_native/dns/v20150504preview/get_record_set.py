...
def get_record_set(record_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20150504preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value

    return AwaitableGetRecordSetResult(
        a_aaa_records=pulumi.get(__ret__, 'a_aaa_records'),
        a_records=pulumi.get(__ret__, 'a_records'),
        c_name_record=pulumi.get(__ret__, 'c_name_record'),
        etag=pulumi.get(__ret__, 'etag'),
        fqdn=pulumi.get(__ret__, 'fqdn'),
        id=pulumi.get(__ret__, 'id'),
        m_x_records=pulumi.get(__ret__, 'm_x_records'),
        n_s_records=pulumi.get(__ret__, 'n_s_records'),
        name=pulumi.get(__ret__, 'name'),
        p_tr_records=pulumi.get(__ret__, 'p_tr_records'),
        s_oa_record=pulumi.get(__ret__, 's_oa_record'),
        s_rv_records=pulumi.get(__ret__, 's_rv_records'),
        t_xt_records=pulumi.get(__ret__, 't_xt_records'),
...
def get_record_set_output(record_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20150504preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
    return __ret__.apply(lambda __response__: GetRecordSetResult(
        a_aaa_records=pulumi.get(__response__, 'a_aaa_records'),
        a_records=pulumi.get(__response__, 'a_records'),
        c_name_record=pulumi.get(__response__, 'c_name_record'),
        etag=pulumi.get(__response__, 'etag'),
        fqdn=pulumi.get(__response__, 'fqdn'),
        id=pulumi.get(__response__, 'id'),
        m_x_records=pulumi.get(__response__, 'm_x_records'),
        n_s_records=pulumi.get(__response__, 'n_s_records'),
        name=pulumi.get(__response__, 'name'),
        p_tr_records=pulumi.get(__response__, 'p_tr_records'),
        s_oa_record=pulumi.get(__response__, 's_oa_record'),
        s_rv_records=pulumi.get(__response__, 's_rv_records'),
        t_xt_records=pulumi.get(__response__, 't_xt_records'),
