...
class DnssecConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230701preview:DnssecConfig"), pulumi.Alias(type_="azure-native:network:DnssecConfig"), pulumi.Alias(type_="azure-native_dns_v20230701preview:dns:DnssecConfig")])
