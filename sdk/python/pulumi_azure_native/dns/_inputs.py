...
class DsRecordArgsDict(TypedDict):
    ...
    """
    digest: NotRequired[pulumi.Input[Optional['DigestArgs']]]
    """
    The digest entity.
    """
...
class NaptrRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] regexp: The regular expression that the DDDS application uses to convert an input value into an output value. For example: an IP phone system might use a regular expression to convert a phone number that is entered by a user into a SIP URI. Enclose the regular expression in quotation marks. Specify either a value for 'regexp' or a value for 'replacement'.
        :param pulumi.Input[_builtins.str] replacement: The replacement is a fully qualified domain name (FQDN) of the next domain name that you want the DDDS application to submit a DNS query for. The DDDS application replaces the input value with the value specified for replacement. Specify either a value for 'regexp' or a value for 'replacement'. If you specify a value for 'regexp', specify a dot (.) for 'replacement'.
        :param pulumi.Input[_builtins.str] services: The services specific to DDDS applications. Enclose Services in quotation marks.
        """
        if flags is not None:
            pulumi.set(__self__, "flags", flags)
...
class SoaRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] minimum_ttl: The minimum value for this SOA record. By convention this is used to determine the negative caching duration.
        :param pulumi.Input[_builtins.float] refresh_time: The refresh value for this SOA record.
        :param pulumi.Input[_builtins.float] retry_time: The retry time for this SOA record.
        :param pulumi.Input[_builtins.float] serial_number: The serial number for this SOA record.
        """
...
class SrvRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] weight: The weight value for this SRV record.
        """
        if port is not None:
...
class TlsaRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] usage: The usage specifies the provided association that will be used to match the certificate presented in the TLS handshake.
        """
