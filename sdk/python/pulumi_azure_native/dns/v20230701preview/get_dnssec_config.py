...
def get_dnssec_config(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20230701preview:getDnssecConfig', __args__, opts=opts, typ=GetDnssecConfigResult).value
...
def get_dnssec_config_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20230701preview:getDnssecConfig', __args__, opts=opts, typ=GetDnssecConfigResult)
