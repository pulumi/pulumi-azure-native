...
class DnssecConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dns:DnssecConfig"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnssecConfig"), pulumi.Alias(type_="azure-native:network:DnssecConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnssecConfig, __self__).__init__(
            'azure-native:dns/v20230701preview:DnssecConfig',
            resource_name,
            __props__,
            opts)
