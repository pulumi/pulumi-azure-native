...
def get_record_set(record_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dns/v20170901:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
...
def get_record_set_output(record_type: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns/v20170901:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
