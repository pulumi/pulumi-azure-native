...
class GetDnssecConfigResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, name=None, provisioning_state=None, signing_keys=None, system_data=None, type=None):
...
def get_dnssec_config(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str zone_name: The name of the DNS zone (without a terminating dot).
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['zoneName'] = zone_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dns:getDnssecConfig', __args__, opts=opts, typ=GetDnssecConfigResult).value
...
def get_dnssec_config_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dns:getDnssecConfig', __args__, opts=opts, typ=GetDnssecConfigResult)
