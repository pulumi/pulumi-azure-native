...
class CertSyncRecordResponse(dict):
    ...
    def __init__(__self__, *,
                 certification_status: Optional[builtins.str] = None,
                 controls: Optional[Sequence['outputs.ControlSyncRecordResponse']] = None,
                 ingestion_status: Optional[builtins.str] = None,
                 offer_guid: Optional[builtins.str] = None):
        """
        A class represent the certification record synchronized from app compliance.
        :param builtins.str certification_status: Indicates the status of certification process.
        :param Sequence['ControlSyncRecordResponse'] controls: The control records list to be synchronized.
        :param builtins.str ingestion_status: Indicates the status of compliance process.
        :param builtins.str offer_guid: The offerGuid which mapping to the reports.
        """
    ...
    def certification_status(self) -> Optional[builtins.str]:
        """
    ...
    def ingestion_status(self) -> Optional[builtins.str]:
        """
...
class ControlSyncRecordResponse(dict):
    ...
    def __init__(__self__, *,
                 control_id: Optional[builtins.str] = None,
                 control_status: Optional[builtins.str] = None):
        """
        A class represent the control record synchronized from app compliance.
        :param builtins.str control_id: The Id of the control. e.g. "Operational_Security_10"
        :param builtins.str control_status: Control status synchronized from app compliance.
        """
    ...
    def control_status(self) -> Optional[builtins.str]:
        """
...
class OverviewStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 manual_count: builtins.int,
                 not_applicable_count: builtins.int,
                 passed_count: builtins.int,
                 pending_count: builtins.int):
        """
        The overview of the compliance result for one report.
        :param builtins.int failed_count: The count of all failed control.
        :param builtins.int manual_count: The count of all manual control.
        :param builtins.int not_applicable_count: The count of all not applicable control.
        :param builtins.int passed_count: The count of all passed control.
        :param builtins.int pending_count: The count of all pending for approval control.
        """
    ...
    def manual_count(self) -> builtins.int:
        """
    ...
    def not_applicable_count(self) -> builtins.int:
        """
    ...
    def passed_count(self) -> builtins.int:
        """
...
class ResourceMetadataResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_kind: Optional[builtins.str] = None,
                 resource_origin: Optional[builtins.str] = None,
                 resource_type: Optional[builtins.str] = None):
        """
        Single resource Id's metadata.
        :param builtins.str resource_id: Resource Id - e.g. "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/vm1".
        :param builtins.str account_id: Account Id. For example - the AWS account id.
        :param builtins.str resource_kind: Resource kind.
        :param builtins.str resource_origin: Resource Origin.
        :param builtins.str resource_type: Resource type. e.g. "Microsoft.Compute/virtualMachines"
        """
    ...
    def resource_kind(self) -> Optional[builtins.str]:
        """
        Resource kind.
        """
    ...
    def resource_origin(self) -> Optional[builtins.str]:
        """
        Resource Origin.
        """
...
class ScopingAnswerResponse(dict):
    ...
    def __init__(__self__, *,
                 answers: Sequence[builtins.str],
                 question_id: builtins.str):
        """
        Scoping answer.
        :param Sequence[builtins.str] answers: Question answer value list.
        :param builtins.str question_id: Question id.
        """
    ...
    @property
    @pulumi.getter
    def answers(self) -> Sequence[builtins.str]:
        """
    ...
    def question_id(self) -> builtins.str:
        """
        Question id.
        """
...
class ScopingQuestionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 option_ids: Sequence[builtins.str],
                 question_id: builtins.str,
                 rules: Sequence[builtins.str],
                 show_sub_questions_value: builtins.str,
                 superior_question_id: builtins.str):
        """
        The definition of a scoping question.
        :param builtins.str input_type: Input type of the question answer.
        :param Sequence[builtins.str] option_ids: Option id list.
        :param builtins.str question_id: Question id.
        :param Sequence[builtins.str] rules: The rule of the question.
        :param builtins.str show_sub_questions_value: The answer value to show the sub questions.
        :param builtins.str superior_question_id: Superior question id.
        """
    ...
    def show_sub_questions_value(self) -> builtins.str:
        """
    ...
    def superior_question_id(self) -> builtins.str:
        """
...
class StatusItemResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 status_name: Optional[builtins.str] = None,
                 status_value: Optional[builtins.str] = None):
        """
        Single status.
        :param builtins.str status_name: Status name - e.g. "Active", "Failed".
        :param builtins.str status_value: Status value. e.g. "100", or "100%".
        """
    ...
    def status_name(self) -> Optional[builtins.str]:
        """
    ...
    def status_value(self) -> Optional[builtins.str]:
        """
...
class StorageInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The information of 'bring your own storage' account binding to the report
        :param builtins.str account_name: 'bring your own storage' account name
        :param builtins.str location: The region of 'bring your own storage' account
        :param builtins.str resource_group: The resourceGroup which 'bring your own storage' account belongs to
        :param builtins.str subscription_id: The subscription id which 'bring your own storage' account belongs to
        """
