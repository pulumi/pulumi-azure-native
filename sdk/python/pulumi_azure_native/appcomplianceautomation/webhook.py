...
class WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] payload_url: webhook payload url
        :param pulumi.Input[Union[_builtins.str, 'SendAllEvents']] send_all_events: whether to send notification under any event.
