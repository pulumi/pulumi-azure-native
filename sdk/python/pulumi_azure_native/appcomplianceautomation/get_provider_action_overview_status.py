...
def get_provider_action_overview_status(type: Optional[builtins.str] = None,
...
def get_provider_action_overview_status_output(type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appcomplianceautomation:getProviderActionOverviewStatus', __args__, opts=opts, typ=GetProviderActionOverviewStatusResult)
