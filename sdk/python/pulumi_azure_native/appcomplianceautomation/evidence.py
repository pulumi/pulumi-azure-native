...
class Evidence(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appcomplianceautomation/v20240627:Evidence"), pulumi.Alias(type_="azure-native_appcomplianceautomation_v20240627:appcomplianceautomation:Evidence")])
