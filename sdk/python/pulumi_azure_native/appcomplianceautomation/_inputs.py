...
class ResourceMetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ResourceOrigin']] resource_origin: Resource Origin.
        :param pulumi.Input[_builtins.str] resource_type: Resource type. e.g. "Microsoft.Compute/virtualMachines"
        """
...
class StorageInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subscription_id: The subscription id which 'bring your own storage' account belongs to
        """
