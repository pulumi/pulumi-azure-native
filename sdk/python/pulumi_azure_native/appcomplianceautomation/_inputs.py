...
if not MYPY:
    class ResourceMetadataArgsDict(TypedDict):
        ...
        """
        resource_kind: NotRequired[pulumi.Input[builtins.str]]
        """
        Resource kind.
        """
        resource_origin: NotRequired[pulumi.Input[Union[builtins.str, 'ResourceOrigin']]]
        """
        Resource Origin.
        """
...
class ResourceMetadataArgs:
    def __init__(__self__, *,
                 ...
                 resource_kind: Optional[pulumi.Input[builtins.str]] = None,
                 resource_origin: Optional[pulumi.Input[Union[builtins.str, 'ResourceOrigin']]] = None,
                 resource_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Single resource Id's metadata.
        :param pulumi.Input[builtins.str] resource_id: Resource Id - e.g. "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Compute/virtualMachines/vm1".
        :param pulumi.Input[builtins.str] account_id: Account Id. For example - the AWS account id.
        :param pulumi.Input[builtins.str] resource_kind: Resource kind.
        :param pulumi.Input[Union[builtins.str, 'ResourceOrigin']] resource_origin: Resource Origin.
        :param pulumi.Input[builtins.str] resource_type: Resource type. e.g. "Microsoft.Compute/virtualMachines"
        """
    ...
    def resource_kind(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource kind.
        """
    ...
    def resource_kind(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_kind", value)

    @property
    @pulumi.getter(name="resourceOrigin")
    def resource_origin(self) -> Optional[pulumi.Input[Union[builtins.str, 'ResourceOrigin']]]:
        """
        Resource Origin.
        """
    ...
    def resource_origin(self, value: Optional[pulumi.Input[Union[builtins.str, 'ResourceOrigin']]]):
...
if not MYPY:
    class ScopingAnswerArgsDict(TypedDict):
        ...
        Scoping answer.
        """
        answers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Question answer value list.
        """
        question_id: pulumi.Input[builtins.str]
        """
        Question id.
        """
elif False:
...
class ScopingAnswerArgs:
    def __init__(__self__, *,
        ...
        """
        Scoping answer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] answers: Question answer value list.
        :param pulumi.Input[builtins.str] question_id: Question id.
        """
    ...
    @property
    @pulumi.getter
    def answers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Question answer value list.
        """
    ...
    @answers.setter
    def answers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "answers", value)

    @property
    @pulumi.getter(name="questionId")
    def question_id(self) -> pulumi.Input[builtins.str]:
        """
        Question id.
        """
    ...
    @question_id.setter
    def question_id(self, value: pulumi.Input[builtins.str]):
...
class StorageInfoArgs:
    def __init__(__self__, *,
        ...
        """
        The information of 'bring your own storage' account binding to the report
        :param pulumi.Input[builtins.str] account_name: 'bring your own storage' account name
        :param pulumi.Input[builtins.str] location: The region of 'bring your own storage' account
        :param pulumi.Input[builtins.str] resource_group: The resourceGroup which 'bring your own storage' account belongs to
        :param pulumi.Input[builtins.str] subscription_id: The subscription id which 'bring your own storage' account belongs to
        """
