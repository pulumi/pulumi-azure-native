...
def get_webhook(report_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str webhook_name: Webhook Name.
    """
    __args__ = dict()
...
def get_webhook_output(report_name: Optional[pulumi.Input[_builtins.str]] = None,
