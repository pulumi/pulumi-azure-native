...
def get_fluid_relay_server(fluid_relay_server_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fluid_relay_server is deprecated: azure-native:fluidrelay/v20210910preview:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['fluidRelayServerName'] = fluid_relay_server_name
    __args__['resourceGroup'] = resource_group
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:fluidrelay/v20210910preview:getFluidRelayServer', __args__, opts=opts, typ=GetFluidRelayServerResult).value
