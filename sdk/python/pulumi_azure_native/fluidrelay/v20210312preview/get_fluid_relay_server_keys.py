...
def get_fluid_relay_server_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay/v20210312preview:getFluidRelayServerKeys', __args__, opts=opts, typ=GetFluidRelayServerKeysResult)
