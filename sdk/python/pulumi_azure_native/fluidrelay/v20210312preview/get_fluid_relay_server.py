...
def get_fluid_relay_server(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:fluidrelay/v20210312preview:getFluidRelayServer', __args__, opts=opts, typ=GetFluidRelayServerResult).value
...
def get_fluid_relay_server_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay/v20210312preview:getFluidRelayServer', __args__, opts=opts, typ=GetFluidRelayServerResult)
