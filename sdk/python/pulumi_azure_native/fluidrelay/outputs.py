...
class CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
        :param builtins.str identity_type: Values can be SystemAssigned or UserAssigned
...
class FluidRelayEndpointsResponse(dict):
    ...
    def __init__(__self__, *,
                 orderer_endpoints: Sequence[builtins.str],
                 service_endpoints: Sequence[builtins.str],
                 storage_endpoints: Sequence[builtins.str]):
        """
        The Fluid Relay endpoints for this server
        :param Sequence[builtins.str] orderer_endpoints: The Fluid Relay Orderer endpoints.
        :param Sequence[builtins.str] service_endpoints: The Fluid Relay service endpoints.
        :param Sequence[builtins.str] storage_endpoints: The Fluid Relay storage endpoints.
        """
    ...
    def orderer_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def service_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def storage_endpoints(self) -> Sequence[builtins.str]:
        """
