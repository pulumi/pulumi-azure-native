...
class FluidRelayPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 fluid_relay_server_name: pulumi.Input[builtins.str],
    ...
    def fluid_relay_server_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fluid_relay_server_name(self, value: pulumi.Input[builtins.str]):
...
class FluidRelayPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FluidRelayPrivateEndpointConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FluidRelayPrivateEndpointConnectionArgs.__new__(FluidRelayPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:fluidrelay/v20250620preview:FluidRelayPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FluidRelayPrivateEndpointConnection, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FluidRelayPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return FluidRelayPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
