...
def get_fluid_relay_server_keys(fluid_relay_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:fluidrelay/v20210830preview:getFluidRelayServerKeys', __args__, opts=opts, typ=GetFluidRelayServerKeysResult).value
...
def get_fluid_relay_server_keys_output(fluid_relay_server_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay/v20210830preview:getFluidRelayServerKeys', __args__, opts=opts, typ=GetFluidRelayServerKeysResult)
