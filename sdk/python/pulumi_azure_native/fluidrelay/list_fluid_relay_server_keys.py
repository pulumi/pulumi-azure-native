...
def list_fluid_relay_server_keys(fluid_relay_server_name: Optional[builtins.str] = None,
...
def list_fluid_relay_server_keys_output(fluid_relay_server_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay:listFluidRelayServerKeys', __args__, opts=opts, typ=ListFluidRelayServerKeysResult)
