...
def get_fluid_relay_private_endpoint_connection(fluid_relay_server_name: Optional[builtins.str] = None,
                                                private_endpoint_connection_name: Optional[builtins.str] = None,
                                                resource_group: Optional[builtins.str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFluidRelayPrivateEndpointConnectionResult:
    """
    The private endpoint connection resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:fluidrelay:getFluidRelayPrivateEndpointConnection', __args__, opts=opts, typ=GetFluidRelayPrivateEndpointConnectionResult).value

    return AwaitableGetFluidRelayPrivateEndpointConnectionResult(
...
def get_fluid_relay_private_endpoint_connection_output(fluid_relay_server_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay:getFluidRelayPrivateEndpointConnection', __args__, opts=opts, typ=GetFluidRelayPrivateEndpointConnectionResult)
    return __ret__.apply(lambda __response__: GetFluidRelayPrivateEndpointConnectionResult(
