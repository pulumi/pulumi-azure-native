...
class CustomerManagedKeyEncryptionPropertiesArgsDict(TypedDict):
    ...
    """
    key_encryption_key_identity: NotRequired[pulumi.Input[Optional['CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityArgs']]]
    """
    All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
    """
...
class EncryptionPropertiesArgsDict(TypedDict):
    ...
    """
    customer_managed_key_encryption: NotRequired[pulumi.Input[Optional['CustomerManagedKeyEncryptionPropertiesArgs']]]
    """
    All Customer-managed key encryption properties for the resource.
    """
