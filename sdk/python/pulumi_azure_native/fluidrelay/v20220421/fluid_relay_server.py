...
warnings.warn("""azure-native:fluidrelay/v20220421:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.""", DeprecationWarning)
...
class FluidRelayServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FluidRelayServer is deprecated: azure-native:fluidrelay/v20220421:FluidRelayServer is being removed in the next major version of this provider. Upgrade to at least azure-native:fluidrelay/v20220601:FluidRelayServer to guarantee forwards compatibility.""")
        ...
        super(FluidRelayServer, __self__).__init__(
            'azure-native:fluidrelay/v20220421:FluidRelayServer',
            resource_name,
            __props__,
            opts)
