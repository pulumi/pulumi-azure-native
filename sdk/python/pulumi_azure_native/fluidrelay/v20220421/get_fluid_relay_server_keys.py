...
def get_fluid_relay_server_keys(fluid_relay_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:fluidrelay/v20220421:getFluidRelayServerKeys', __args__, opts=opts, typ=GetFluidRelayServerKeysResult).value
...
def get_fluid_relay_server_keys_output(fluid_relay_server_name: Optional[pulumi.Input[str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFluidRelayServerKeysResult]:
    """
    The set of available keys for this server.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fluidrelay/v20220421:getFluidRelayServerKeys', __args__, opts=opts, typ=GetFluidRelayServerKeysResult)
