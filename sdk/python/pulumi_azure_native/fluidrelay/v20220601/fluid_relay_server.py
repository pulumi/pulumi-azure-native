...
class FluidRelayServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fluid_relay_server = azure_native.fluidrelay.v20220601.FluidRelayServer("fluidRelayServer",
            fluid_relay_server_name="myFluidRelayServer",
            identity=azure_native.fluidrelay.v20220601.IdentityArgs(
                type=azure_native.fluidrelay/v20220601.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="west-us",
        ...
        fluid_relay_server = azure_native.fluidrelay.v20220601.FluidRelayServer("fluidRelayServer",
            fluid_relay_server_name="myFluidRelayServer",
            identity=azure_native.fluidrelay.v20220601.IdentityArgs(
                type=azure_native.fluidrelay/v20220601.ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED,
        ...
        fluid_relay_server = azure_native.fluidrelay.v20220601.FluidRelayServer("fluidRelayServer",
            encryption=azure_native.fluidrelay.v20220601.EncryptionPropertiesResponseArgs(
                customer_managed_key_encryption={
                    "keyEncryptionKeyIdentity": azure_native.fluidrelay.v20220601.CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityArgs(
                        identity_type=azure_native.fluidrelay/v20220601.CmkIdentityType.USER_ASSIGNED,
            ...
            fluid_relay_server_name="myFluidRelayServer",
            identity=azure_native.fluidrelay.v20220601.IdentityArgs(
                type=azure_native.fluidrelay/v20220601.ResourceIdentityType.USER_ASSIGNED,
                user_assigned_identities={
