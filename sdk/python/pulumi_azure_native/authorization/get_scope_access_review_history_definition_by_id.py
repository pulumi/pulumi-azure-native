...
def get_scope_access_review_history_definition_by_id(history_definition_id: Optional[_builtins.str] = None,
...
def get_scope_access_review_history_definition_by_id_output(history_definition_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
