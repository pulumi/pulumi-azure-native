...
class PolicySetDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_set_definition_name: The name of the policy set definition to create.
        :param pulumi.Input[Union[builtins.str, 'PolicyType']] policy_type: The type of policy set definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
        :param pulumi.Input[builtins.str] version: The policy set definition version in #.#.# format.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] versions: A list of available versions for this policy set definition.
        """
    ...
    def policy_set_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_set_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
