...
def get_management_lock_at_resource_group_level(lock_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_group_name: The name of the locked resource group.
    """
    __args__ = dict()
    __args__['lockName'] = lock_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization:getManagementLockAtResourceGroupLevel', __args__, opts=opts, typ=GetManagementLockAtResourceGroupLevelResult).value
...
def get_management_lock_at_resource_group_level_output(lock_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization:getManagementLockAtResourceGroupLevel', __args__, opts=opts, typ=GetManagementLockAtResourceGroupLevelResult)
    return __ret__.apply(lambda __response__: GetManagementLockAtResourceGroupLevelResult(
