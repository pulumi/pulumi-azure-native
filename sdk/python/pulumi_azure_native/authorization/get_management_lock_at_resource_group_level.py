...
def get_management_lock_at_resource_group_level(lock_name: Optional[_builtins.str] = None,
...
def get_management_lock_at_resource_group_level_output(lock_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
