...
__all__ = [
    'GetRoleEligibilityScheduleRequestResult',
    'AwaitableGetRoleEligibilityScheduleRequestResult',
    'get_role_eligibility_schedule_request',
    'get_role_eligibility_schedule_request_output',
]

@pulumi.output_type
class GetRoleEligibilityScheduleRequestResult:
    """
...
class AwaitableGetRoleEligibilityScheduleRequestResult(GetRoleEligibilityScheduleRequestResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRoleEligibilityScheduleRequestResult(
...
def get_role_eligibility_schedule_request(role_eligibility_schedule_request_name: Optional[str] = None,
                                          scope: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRoleEligibilityScheduleRequestResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20201001preview:getRoleEligibilityScheduleRequest', __args__, opts=opts, typ=GetRoleEligibilityScheduleRequestResult).value

    return AwaitableGetRoleEligibilityScheduleRequestResult(
...
def get_role_eligibility_schedule_request_output(role_eligibility_schedule_request_name: Optional[pulumi.Input[str]] = None,
                                                 scope: Optional[pulumi.Input[str]] = None,
                                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRoleEligibilityScheduleRequestResult]:
    """
    Get the specified role eligibility schedule request.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20201001preview:getRoleEligibilityScheduleRequest', __args__, opts=opts, typ=GetRoleEligibilityScheduleRequestResult)
    return __ret__.apply(lambda __response__: GetRoleEligibilityScheduleRequestResult(
