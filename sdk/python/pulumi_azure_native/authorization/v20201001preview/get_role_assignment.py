...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_role_assignment is deprecated: azure-native:authorization/v20201001preview:RoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220401:RoleAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
