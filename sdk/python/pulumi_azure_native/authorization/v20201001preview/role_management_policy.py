...
class RoleManagementPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20201001preview:RoleManagementPolicy"), pulumi.Alias(type_="azure-native:authorization:RoleManagementPolicy"), pulumi.Alias(type_="azure-nextgen:authorization:RoleManagementPolicy")])
    ...
    def get(resource_name: str,
        ...
        __props__["effective_rules"] = None
        __props__["is_organization_default"] = None
        __props__["last_updated_date_time"] = None
        __props__["name"] = None
