...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20240501:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
...
def get_policy_definition_output(policy_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['policyDefinitionName'] = policy_definition_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20240501:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult)
