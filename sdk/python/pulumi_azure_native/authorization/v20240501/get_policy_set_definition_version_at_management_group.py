...
def get_policy_set_definition_version_at_management_group(management_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20240501:getPolicySetDefinitionVersionAtManagementGroup', __args__, opts=opts, typ=GetPolicySetDefinitionVersionAtManagementGroupResult).value
