...
class GetPolicyAssignmentResult:
    ...
    """
    def __init__(__self__, assignment_type=None, definition_version=None, description=None, display_name=None, enforcement_mode=None, id=None, identity=None, location=None, metadata=None, name=None, non_compliance_messages=None, not_scopes=None, overrides=None, parameters=None, policy_definition_id=None, resource_selectors=None, scope=None, system_data=None, type=None):
...
def get_policy_assignment(policy_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20240501:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult).value
...
def get_policy_assignment_output(policy_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20240501:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult)
