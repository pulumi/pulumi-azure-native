...
def list_policy_definition_version_all(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPolicyDefinitionVersionAllResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20240501:listPolicyDefinitionVersionAll', __args__, opts=opts, typ=ListPolicyDefinitionVersionAllResult).value
...
def list_policy_definition_version_all_output(opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ListPolicyDefinitionVersionAllResult]:
    ...
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20240501:listPolicyDefinitionVersionAll', __args__, opts=opts, typ=ListPolicyDefinitionVersionAllResult)
