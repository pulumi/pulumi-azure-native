...
def get_pim_role_eligibility_schedule(role_eligibility_schedule_request_name: Optional[_builtins.str] = None,
...
def get_pim_role_eligibility_schedule_output(role_eligibility_schedule_request_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
