...
__all__ = [
    'ExternalEvaluationEndpointSettingsResponse',
    'ExternalEvaluationEnforcementSettingsResponse',
    'IdentityResponse',
...
@pulumi.output_type
class ExternalEvaluationEndpointSettingsResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        The settings of an external endpoint providing evaluation results.
        :param Any details: The details of the endpoint.
        :param str kind: The kind of the endpoint.
        """
...
@pulumi.output_type
class ExternalEvaluationEnforcementSettingsResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "endpointSettings":
            suggest = "endpoint_settings"
        elif key == "missingTokenAction":
            suggest = "missing_token_action"
        elif key == "resultLifespan":
            suggest = "result_lifespan"
        elif key == "roleDefinitionIds":
            suggest = "role_definition_ids"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExternalEvaluationEnforcementSettingsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExternalEvaluationEnforcementSettingsResponse.__key_warning(key)
    ...
    def __init__(__self__, *,
                 endpoint_settings: Optional['outputs.ExternalEvaluationEndpointSettingsResponse'] = None,
                 missing_token_action: Optional[str] = None,
                 result_lifespan: Optional[str] = None,
                 role_definition_ids: Optional[Sequence[str]] = None):
        """
        The details of the source of external evaluation results required by the policy during enforcement evaluation.
        :param 'ExternalEvaluationEndpointSettingsResponse' endpoint_settings: The settings of an external endpoint providing evaluation results.
        :param str missing_token_action: What to do when evaluating an enforcement policy that requires an external evaluation and the token is missing. Possible values are Audit and Deny.
        :param str result_lifespan: The lifespan of the endpoint invocation result after which it's no longer valid. Value is expected to follow the ISO 8601 duration format.
        :param Sequence[str] role_definition_ids: An array of the role definition Ids the assignment's MSI will need in order to invoke the endpoint.
        """
        if endpoint_settings is not None:
            pulumi.set(__self__, "endpoint_settings", endpoint_settings)
        if missing_token_action is not None:
            pulumi.set(__self__, "missing_token_action", missing_token_action)
        if result_lifespan is not None:
            pulumi.set(__self__, "result_lifespan", result_lifespan)
    ...
    def endpoint_settings(self) -> Optional['outputs.ExternalEvaluationEndpointSettingsResponse']:
        """
        The settings of an external endpoint providing evaluation results.
        """
    ...
    @property
    @pulumi.getter(name="missingTokenAction")
    def missing_token_action(self) -> Optional[str]:
        """
        ...
        """
        return pulumi.get(self, "missing_token_action")

    @property
    @pulumi.getter(name="resultLifespan")
    def result_lifespan(self) -> Optional[str]:
        """
        ...
        """
        return pulumi.get(self, "result_lifespan")

    @property
    @pulumi.getter(name="roleDefinitionIds")
    def role_definition_ids(self) -> Optional[Sequence[str]]:
        """
...
class PolicyDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[str] = None,
                 display_name: Optional[str] = None,
                 external_evaluation_enforcement_settings: Optional['outputs.ExternalEvaluationEnforcementSettingsResponse'] = None,
        ...
        :param 'ExternalEvaluationEnforcementSettingsResponse' external_evaluation_enforcement_settings: The details of the source of external evaluation results required by the policy during enforcement evaluation.
    ...
    def external_evaluation_enforcement_settings(self) -> Optional['outputs.ExternalEvaluationEnforcementSettingsResponse']:
        """
        The details of the source of external evaluation results required by the policy during enforcement evaluation.
        """
