...
def get_policy_assignment(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250301:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult).value
...
def get_policy_assignment_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250301:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult)
