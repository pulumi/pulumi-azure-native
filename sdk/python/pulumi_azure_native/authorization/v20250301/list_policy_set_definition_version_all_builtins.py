...
def list_policy_set_definition_version_all_builtins(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPolicySetDefinitionVersionAllBuiltinsResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250301:listPolicySetDefinitionVersionAllBuiltins', __args__, opts=opts, typ=ListPolicySetDefinitionVersionAllBuiltinsResult).value
...
def list_policy_set_definition_version_all_builtins_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListPolicySetDefinitionVersionAllBuiltinsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250301:listPolicySetDefinitionVersionAllBuiltins', __args__, opts=opts, typ=ListPolicySetDefinitionVersionAllBuiltinsResult)
