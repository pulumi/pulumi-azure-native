...
def list_policy_definition_version_all(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPolicyDefinitionVersionAllResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250301:listPolicyDefinitionVersionAll', __args__, opts=opts, typ=ListPolicyDefinitionVersionAllResult).value
...
def list_policy_definition_version_all_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListPolicyDefinitionVersionAllResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250301:listPolicyDefinitionVersionAll', __args__, opts=opts, typ=ListPolicyDefinitionVersionAllResult)
