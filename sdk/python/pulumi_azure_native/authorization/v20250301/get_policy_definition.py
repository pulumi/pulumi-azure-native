...
class GetPolicyDefinitionResult:
    ...
    """
    def __init__(__self__, description=None, display_name=None, external_evaluation_enforcement_settings=None, id=None, metadata=None, mode=None, name=None, parameters=None, policy_rule=None, policy_type=None, system_data=None, type=None, version=None, versions=None):
...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250301:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
...
def get_policy_definition_output(policy_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250301:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult)
