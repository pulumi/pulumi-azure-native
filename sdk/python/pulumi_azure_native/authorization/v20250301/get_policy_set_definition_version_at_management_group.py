...
def get_policy_set_definition_version_at_management_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250301:getPolicySetDefinitionVersionAtManagementGroup', __args__, opts=opts, typ=GetPolicySetDefinitionVersionAtManagementGroupResult).value
...
def get_policy_set_definition_version_at_management_group_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250301:getPolicySetDefinitionVersionAtManagementGroup', __args__, opts=opts, typ=GetPolicySetDefinitionVersionAtManagementGroupResult)
