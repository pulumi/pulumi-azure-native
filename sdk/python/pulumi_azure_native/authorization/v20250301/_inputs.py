...
__all__ = [
    ...
    'ExternalEvaluationEndpointSettingsArgsDict',
    'ExternalEvaluationEnforcementSettingsArgs',
    'ExternalEvaluationEnforcementSettingsArgsDict',
    'IdentityArgs',
    'IdentityArgsDict',
...
if not MYPY:
    class ExternalEvaluationEndpointSettingsArgsDict(TypedDict):
        """
    ...
    ExternalEvaluationEndpointSettingsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ExternalEvaluationEndpointSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] kind: The kind of the endpoint.
        """
...
if not MYPY:
    class ExternalEvaluationEnforcementSettingsArgsDict(TypedDict):
        """
        The details of the source of external evaluation results required by the policy during enforcement evaluation.
        """
        endpoint_settings: NotRequired[pulumi.Input['ExternalEvaluationEndpointSettingsArgsDict']]
        """
        The settings of an external endpoint providing evaluation results.
        """
        missing_token_action: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        result_lifespan: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        role_definition_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        An array of the role definition Ids the assignment's MSI will need in order to invoke the endpoint.
        """
elif False:
    ExternalEvaluationEnforcementSettingsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ExternalEvaluationEnforcementSettingsArgs:
    def __init__(__self__, *,
                 endpoint_settings: Optional[pulumi.Input['ExternalEvaluationEndpointSettingsArgs']] = None,
                 missing_token_action: Optional[pulumi.Input[str]] = None,
                 result_lifespan: Optional[pulumi.Input[str]] = None,
                 role_definition_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        The details of the source of external evaluation results required by the policy during enforcement evaluation.
        :param pulumi.Input['ExternalEvaluationEndpointSettingsArgs'] endpoint_settings: The settings of an external endpoint providing evaluation results.
        :param pulumi.Input[str] missing_token_action: What to do when evaluating an enforcement policy that requires an external evaluation and the token is missing. Possible values are Audit and Deny.
        :param pulumi.Input[str] result_lifespan: The lifespan of the endpoint invocation result after which it's no longer valid. Value is expected to follow the ISO 8601 duration format.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] role_definition_ids: An array of the role definition Ids the assignment's MSI will need in order to invoke the endpoint.
        """
    ...
    def endpoint_settings(self) -> Optional[pulumi.Input['ExternalEvaluationEndpointSettingsArgs']]:
        """
        The settings of an external endpoint providing evaluation results.
        """
    ...
    def endpoint_settings(self, value: Optional[pulumi.Input['ExternalEvaluationEndpointSettingsArgs']]):
        pulumi.set(self, "endpoint_settings", value)

    @property
    @pulumi.getter(name="missingTokenAction")
    def missing_token_action(self) -> Optional[pulumi.Input[str]]:
        """
        What to do when evaluating an enforcement policy that requires an external evaluation and the token is missing. Possible values are Audit and Deny.
        """
        return pulumi.get(self, "missing_token_action")

    @missing_token_action.setter
    def missing_token_action(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "missing_token_action", value)

    @property
    @pulumi.getter(name="resultLifespan")
    def result_lifespan(self) -> Optional[pulumi.Input[str]]:
        """
        The lifespan of the endpoint invocation result after which it's no longer valid. Value is expected to follow the ISO 8601 duration format.
        """
        return pulumi.get(self, "result_lifespan")

    @result_lifespan.setter
    def result_lifespan(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "result_lifespan", value)
