...
class GetRoleAssignmentResult:
    ...
    Role Assignments
    """
    def __init__(__self__, can_delegate=None, id=None, name=None, principal_id=None, principal_type=None, role_definition_id=None, scope=None, type=None):
...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_role_assignment is deprecated: azure-native:authorization/v20180901preview:RoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20200301preview:RoleAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['roleAssignmentName'] = role_assignment_name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20180901preview:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
