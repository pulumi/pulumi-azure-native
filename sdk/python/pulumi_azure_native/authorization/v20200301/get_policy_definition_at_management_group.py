...
warnings.warn("""azure-native:authorization/v20200301:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_policy_definition_at_management_group(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition_at_management_group is deprecated: azure-native:authorization/v20200301:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['managementGroupId'] = management_group_id
    __args__['policyDefinitionName'] = policy_definition_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20200301:getPolicyDefinitionAtManagementGroup', __args__, opts=opts, typ=GetPolicyDefinitionAtManagementGroupResult).value
