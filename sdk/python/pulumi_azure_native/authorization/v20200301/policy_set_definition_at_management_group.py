...
warnings.warn("""azure-native:authorization/v20200301:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 policy_type: Optional[pulumi.Input[Union[str, 'PolicyType']]] = None,
                 __props__=None):
        pulumi.log.warn("""PolicySetDefinitionAtManagementGroup is deprecated: azure-native:authorization/v20200301:PolicySetDefinitionAtManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20210601:PolicySetDefinitionAtManagementGroup to guarantee forwards compatibility.""")
