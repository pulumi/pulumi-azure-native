...
class PolicyAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        policy_assignment = azure_native.authorization.v20200301.PolicyAssignment("policyAssignment",
            ...
            parameters={
                "prefix": azure_native.authorization.v20200301.ParameterValuesValueArgs(
                    value="DeptA",
                ),
                "suffix": azure_native.authorization.v20200301.ParameterValuesValueArgs(
                    value="-LC",
                ),
            },
        ...
        policy_assignment = azure_native.authorization.v20200301.PolicyAssignment("policyAssignment",
            ...
            identity=azure_native.authorization.v20200301.IdentityArgs(
                type=azure_native.authorization/v20200301.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="eastus",
            metadata={
                "assignedBy": "Foo Bar",
