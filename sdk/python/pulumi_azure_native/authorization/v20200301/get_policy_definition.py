...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition is deprecated: azure-native:authorization/v20200301:PolicyDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyDefinitionName'] = policy_definition_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20200301:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
