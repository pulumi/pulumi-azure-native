...
class RoleManagementPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native_authorization_v20201001:authorization:RoleManagementPolicy"), pulumi.Alias(type_="azure-native_authorization_v20201001preview:authorization:RoleManagementPolicy"), pulumi.Alias(type_="azure-native_authorization_v20240201preview:authorization:RoleManagementPolicy"), pulumi.Alias(type_="azure-native_authorization_v20240901preview:authorization:RoleManagementPolicy")])
