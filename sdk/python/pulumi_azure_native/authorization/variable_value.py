...
class VariableValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:VariableValue"), pulumi.Alias(type_="azure-native:authorization/v20241201preview:VariableValue"), pulumi.Alias(type_="azure-native:authorization/v20251201preview:VariableValue"), pulumi.Alias(type_="azure-native:authorization/v20260101preview:VariableValue")])
