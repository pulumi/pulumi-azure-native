...
class PolicySetDefinitionVersionAtManagementGroupArgs:
    def __init__(__self__, *,
                 management_group_name: pulumi.Input[builtins.str],
                 policy_definitions: pulumi.Input[Sequence[pulumi.Input['PolicyDefinitionReferenceArgs']]],
                 policy_set_definition_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] management_group_name: The name of the management group. The name is case insensitive.
        ...
        :param pulumi.Input[builtins.str] policy_set_definition_name: The name of the policy set definition.
        :param pulumi.Input[builtins.str] description: The policy set definition description.
        ...
        :param pulumi.Input[builtins.str] policy_definition_version: The policy set definition version.  The format is x.y.z where x is the major version number, y is the minor version number, and z is the patch number
        ...
        :param pulumi.Input[builtins.str] version: The policy set definition version in #.#.# format.
        """
    ...
    def management_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def management_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def policy_set_definition_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def policy_set_definition_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:authorization:PolicySetDefinitionVersionAtManagementGroup")
class PolicySetDefinitionVersionAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20230401:PolicySetDefinitionVersionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20240501:PolicySetDefinitionVersionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20250101:PolicySetDefinitionVersionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20250301:PolicySetDefinitionVersionAtManagementGroup")])
