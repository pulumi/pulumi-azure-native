...
class PolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 enforcement_mode: Optional[pulumi.Input[Union[builtins.str, 'EnforcementMode']]] = None,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of the policy assignment. Valid scopes are: management group (format: '/providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: '/subscriptions/{subscriptionId}'), resource group (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}', or resource (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/[{parentResourcePath}/]{resourceType}/{resourceName}'
        :param pulumi.Input[Union[builtins.str, 'AssignmentType']] assignment_type: The type of policy assignment. Possible values are NotSpecified, System, SystemHidden, and Custom. Immutable.
        :param pulumi.Input[builtins.str] definition_version: The version of the policy definition to use.
        :param pulumi.Input[builtins.str] description: This message will be part of response in case of policy violation.
        :param pulumi.Input[builtins.str] display_name: The display name of the policy assignment.
        :param pulumi.Input[Union[builtins.str, 'EnforcementMode']] enforcement_mode: The policy assignment enforcement mode. Possible values are Default, DoNotEnforce, and Enroll
        :param pulumi.Input['IdentityArgs'] identity: The managed identity associated with the policy assignment.
        :param pulumi.Input[builtins.str] location: The location of the policy assignment. Only required when utilizing managed identity.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_scopes: The policy's excluded scopes.
        ...
        :param pulumi.Input[builtins.str] policy_assignment_name: The name of the policy assignment.
        :param pulumi.Input[builtins.str] policy_definition_id: The ID of the policy definition or policy set definition being assigned.
    ...
    def enforcement_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'EnforcementMode']]]:
        """
    ...
    def enforcement_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'EnforcementMode']]]):
    ...
    def policy_assignment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_assignment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyAssignment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assignmentType")
    def assignment_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of policy assignment. Possible values are NotSpecified, System, SystemHidden, and Custom. Immutable.
        """
        return pulumi.get(self, "assignment_type")
    ...
    @property
    @pulumi.getter(name="definitionVersion")
    def definition_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the policy definition to use.
        """
        return pulumi.get(self, "definition_version")
    ...
    def effective_definition_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def latest_definition_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="policyDefinitionId")
    def policy_definition_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the policy definition or policy set definition being assigned.
        """
        return pulumi.get(self, "policy_definition_id")
