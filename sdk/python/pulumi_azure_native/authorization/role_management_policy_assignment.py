...
class RoleManagementPolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 role_management_policy_assignment_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] policy_id: The policy id role management policy assignment.
        :param pulumi.Input[builtins.str] role_definition_id: The role definition of management policy assignment.
        :param pulumi.Input[builtins.str] role_management_policy_assignment_name: The name of format {guid_guid} the role management policy assignment to upsert.
        """
    ...
    def role_management_policy_assignment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def role_management_policy_assignment_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "role_management_policy_assignment_name", value)


class RoleManagementPolicyAssignment(pulumi.CustomResource):

    pulumi_type = "azure-native:authorization:RoleManagementPolicyAssignment"
