...
class ManagementLockAtSubscriptionLevel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20200501:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native_authorization_v20150101:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native_authorization_v20160901:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native_authorization_v20170401:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native_authorization_v20200501:authorization:ManagementLockAtSubscriptionLevel")])
