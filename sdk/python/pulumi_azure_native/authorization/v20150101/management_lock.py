...
class ManagementLock(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20150101:ManagementLock"), pulumi.Alias(type_="azure-native:authorization:ManagementLock"), pulumi.Alias(type_="azure-nextgen:authorization:ManagementLock"), pulumi.Alias(type_="azure-native:authorization/latest:ManagementLock"), pulumi.Alias(type_="azure-nextgen:authorization/latest:ManagementLock"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLock"), pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLock")])
