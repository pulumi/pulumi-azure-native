...
class ManagementLock(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20150101:ManagementLock"), pulumi.Alias(type_="azure-native:authorization:ManagementLock"), pulumi.Alias(type_="azure-nextgen:authorization:ManagementLock"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLock"), pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLock")])
