...
class Variable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:Variable"), pulumi.Alias(type_="azure-native:authorization/v20241201preview:Variable"), pulumi.Alias(type_="azure-native:authorization/v20251201preview:Variable"), pulumi.Alias(type_="azure-native:authorization/v20260101preview:Variable")])
