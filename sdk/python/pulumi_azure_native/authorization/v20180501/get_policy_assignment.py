...
def get_policy_assignment(policy_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_assignment is deprecated: azure-native:authorization/v20180501:PolicyAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20190601:PolicyAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyAssignmentName'] = policy_assignment_name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20180501:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult).value
