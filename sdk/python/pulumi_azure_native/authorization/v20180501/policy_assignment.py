...
warnings.warn("""azure-native:authorization/v20180501:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicyAssignment to guarantee forwards compatibility.""", DeprecationWarning)
...
class PolicyAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[pulumi.InputType['PolicySkuArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""PolicyAssignment is deprecated: azure-native:authorization/v20180501:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicyAssignment to guarantee forwards compatibility.""")
