...
@pulumi.type_token("azure-native:authorization:VariableAtManagementGroup")
class VariableAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:VariableAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20241201preview:VariableAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20251201preview:VariableAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20260101preview:VariableAtManagementGroup")])
