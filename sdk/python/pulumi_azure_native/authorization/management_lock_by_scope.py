...
class ManagementLockByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20200501:ManagementLockByScope"), pulumi.Alias(type_="azure-native_authorization_v20160901:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native_authorization_v20170401:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native_authorization_v20200501:authorization:ManagementLockByScope")])
