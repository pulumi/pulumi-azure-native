...
class ManagementLockAtResourceGroupLevelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group to lock.
        :param pulumi.Input[builtins.str] lock_name: The lock name. The lock name can be a maximum of 260 characters. It cannot contain <, > %, &, :, \\, ?, /, or any control characters.
...
@pulumi.type_token("azure-native:authorization:ManagementLockAtResourceGroupLevel")
