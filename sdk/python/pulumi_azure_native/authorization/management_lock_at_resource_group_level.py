...
class ManagementLockAtResourceGroupLevel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20200501:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native_authorization_v20150101:authorization:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native_authorization_v20160901:authorization:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native_authorization_v20170401:authorization:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native_authorization_v20200501:authorization:ManagementLockAtResourceGroupLevel")])
