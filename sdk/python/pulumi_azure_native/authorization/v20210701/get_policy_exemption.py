...
def get_policy_exemption(policy_exemption_name: Optional[str] = None,
    ...
    :param str policy_exemption_name: The name of the policy exemption.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20210701:getPolicyExemption', __args__, opts=opts, typ=GetPolicyExemptionResult).value
