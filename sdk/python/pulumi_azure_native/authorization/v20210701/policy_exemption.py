...
class PolicyExemptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] policy_exemption_name: The name of the policy exemption.
        """
...
class PolicyExemption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20210701:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization:PolicyExemption"), pulumi.Alias(type_="azure-nextgen:authorization:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization/v20200701preview:PolicyExemption"), pulumi.Alias(type_="azure-nextgen:authorization/v20200701preview:PolicyExemption")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyExemption, __self__).__init__(
            'azure-native:authorization/v20210701:PolicyExemption',
            resource_name,
            __props__,
            opts)
