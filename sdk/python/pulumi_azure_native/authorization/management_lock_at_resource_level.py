...
class ManagementLockAtResourceLevelArgs:
    def __init__(__self__, *,
                 ...
                 level: pulumi.Input[Union[builtins.str, 'LockLevel']],
                 parent_resource_path: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] api_version: The API version to use for this operation.
        :param pulumi.Input[Union[builtins.str, 'LockLevel']] level: The level of the lock. Possible values are: NotSpecified, CanNotDelete, ReadOnly. CanNotDelete means authorized users are able to read and modify the resources, but not delete. ReadOnly means authorized users can only read from a resource, but they can't modify or delete it.
        :param pulumi.Input[builtins.str] parent_resource_path: The parent resource identity.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group containing the resource to lock. 
        :param pulumi.Input[builtins.str] resource_name: The name of the resource to lock.
        :param pulumi.Input[builtins.str] resource_provider_namespace: The resource provider namespace of the resource to lock.
        :param pulumi.Input[builtins.str] resource_type: The resource type of the resource to lock.
        :param pulumi.Input[builtins.str] lock_name: The name of lock. The lock name can be a maximum of 260 characters. It cannot contain <, > %, &, :, \\, ?, /, or any control characters.
        :param pulumi.Input[builtins.str] notes: Notes about the lock. Maximum of 512 characters.
    ...
    @property
    @pulumi.getter
    def level(self) -> pulumi.Input[Union[builtins.str, 'LockLevel']]:
        """
    ...
    @level.setter
    def level(self, value: pulumi.Input[Union[builtins.str, 'LockLevel']]):
        pulumi.set(self, "level", value)

    @property
    @pulumi.getter(name="parentResourcePath")
    def parent_resource_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parent_resource_path(self, value: pulumi.Input[builtins.str]):
    ...
    def lock_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @lock_name.setter
    def lock_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagementLockAtResourceLevel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 level: Optional[pulumi.Input[Union[builtins.str, 'LockLevel']]] = None,
                 lock_name: Optional[pulumi.Input[builtins.str]] = None,
                 notes: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] parent_resource_path: The parent resource identity.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group containing the resource to lock. 
        :param pulumi.Input[builtins.str] resource_name_: The name of the resource to lock.
        :param pulumi.Input[builtins.str] resource_provider_namespace: The resource provider namespace of the resource to lock.
        :param pulumi.Input[builtins.str] resource_type: The resource type of the resource to lock.
        """
        ...
