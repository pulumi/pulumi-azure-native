...
def get_management_lock_at_subscription_level(lock_name: Optional[builtins.str] = None,
    ...
    :param builtins.str lock_name: The name of the lock to get.
    """
    __args__ = dict()
...
def get_management_lock_at_subscription_level_output(lock_name: Optional[pulumi.Input[builtins.str]] = None,
