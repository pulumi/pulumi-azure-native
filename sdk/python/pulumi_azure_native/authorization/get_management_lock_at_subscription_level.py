...
def get_management_lock_at_subscription_level(lock_name: Optional[_builtins.str] = None,
...
def get_management_lock_at_subscription_level_output(lock_name: pulumi.Input[Optional[_builtins.str]] = None,
