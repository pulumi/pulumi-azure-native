...
def get_policy_set_definition_output(policy_set_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20170601preview:getPolicySetDefinition', __args__, opts=opts, typ=GetPolicySetDefinitionResult)
