...
warnings.warn("""azure-native:authorization/v20170601preview:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicyAssignment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_policy_assignment(policy_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_assignment is deprecated: azure-native:authorization/v20170601preview:PolicyAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicyAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
