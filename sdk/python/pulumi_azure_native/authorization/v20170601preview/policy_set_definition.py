...
warnings.warn("""azure-native:authorization/v20170601preview:PolicySetDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class PolicySetDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 policy_type: Optional[pulumi.Input[Union[str, 'PolicyType']]] = None,
                 __props__=None):
        pulumi.log.warn("""PolicySetDefinition is deprecated: azure-native:authorization/v20170601preview:PolicySetDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinition to guarantee forwards compatibility.""")
