...
def get_pim_role_eligibility_schedule(role_eligibility_schedule_request_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20240201preview:getPimRoleEligibilitySchedule', __args__, opts=opts, typ=GetPimRoleEligibilityScheduleResult).value
...
def get_pim_role_eligibility_schedule_output(role_eligibility_schedule_request_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20240201preview:getPimRoleEligibilitySchedule', __args__, opts=opts, typ=GetPimRoleEligibilityScheduleResult)
