...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        policy_set_definition_at_management_group = azure_native.authorization.v20200901.PolicySetDefinitionAtManagementGroup("policySetDefinitionAtManagementGroup",
            ...
            policy_definitions=[
                {
                    "parameters": {
                        "listOfAllowedSKUs": azure_native.authorization.v20200901.ParameterValuesValueArgs(
                            value=[
                                "Standard_GRS",
                                "Standard_LRS",
                            ],
                ...
                {
                    "parameters": {
                        "prefix": azure_native.authorization.v20200901.ParameterValuesValueArgs(
                            value="DeptA",
                        ),
                        "suffix": azure_native.authorization.v20200901.ParameterValuesValueArgs(
                            value="-LC",
                        ),
                    },
