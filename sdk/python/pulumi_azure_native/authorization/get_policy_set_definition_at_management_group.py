...
def get_policy_set_definition_at_management_group(expand: Optional[builtins.str] = None,
...
def get_policy_set_definition_at_management_group_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
