...
class AccessReviewHistoryInstanceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fulfilled_date_time: Optional[builtins.str] = None,
                 review_history_period_end_date_time: Optional[builtins.str] = None,
                 review_history_period_start_date_time: Optional[builtins.str] = None,
                 run_date_time: Optional[builtins.str] = None):
        """
        Access Review History Definition Instance.
        :param builtins.str download_uri: Uri which can be used to retrieve review history data. To generate this Uri, generateDownloadUri() must be called for a specific accessReviewHistoryDefinitionInstance. The link expires after a 24 hour period. Callers can see the expiration date time by looking at the 'se' parameter in the generated uri.
        :param builtins.str id: The access review history definition instance id.
        :param builtins.str name: The access review history definition instance unique id.
        :param builtins.str status: Status of the requested review history instance data. This is either requested, in-progress, done or error. The state transitions are as follows - Requested -> InProgress -> Done -> Expired
        :param builtins.str type: The resource type.
        :param builtins.str display_name: The display name for the parent history definition.
        :param builtins.str expiration: Date time when history data report expires and the associated data is deleted.
        :param builtins.str fulfilled_date_time: Date time when the history data report is scheduled to be generated.
        :param builtins.str review_history_period_end_date_time: Date time used when selecting review data, all reviews included in data end on or before this date. For use only with one-time/non-recurring reports.
        :param builtins.str review_history_period_start_date_time: Date time used when selecting review data, all reviews included in data start on or after this date. For use only with one-time/non-recurring reports.
        :param builtins.str run_date_time: Date time when the history data report is scheduled to be generated.
        """
    ...
    def fulfilled_date_time(self) -> Optional[builtins.str]:
        """
    ...
    def review_history_period_end_date_time(self) -> Optional[builtins.str]:
        """
    ...
    def review_history_period_start_date_time(self) -> Optional[builtins.str]:
        """
    ...
    def run_date_time(self) -> Optional[builtins.str]:
        """
        Date time when the history data report is scheduled to be generated.
        """
...
class AccessReviewInstanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Access Review Instance.
        :param builtins.str id: The access review instance id.
        :param builtins.str name: The access review instance name.
        :param builtins.str reviewers_type: This field specifies the type of reviewers for a review. Usually for a review, reviewers are explicitly assigned. However, in some cases, the reviewers may not be assigned and instead be chosen dynamically. For example managers review or self review.
        :param builtins.str status: This read-only field specifies the status of an access review instance.
        :param builtins.str type: The resource type.
        :param Sequence['AccessReviewReviewerResponse'] backup_reviewers: This is the collection of backup reviewers.
        :param builtins.str end_date_time: The DateTime when the review instance is scheduled to end.
        :param Sequence['AccessReviewReviewerResponse'] reviewers: This is the collection of reviewers.
        :param builtins.str start_date_time: The DateTime when the review instance is scheduled to be start.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class AccessReviewRecurrenceRangeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number_of_occurrences: Optional[builtins.int] = None,
                 start_date: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        Recurrence Range of an Access Review Schedule Definition.
        :param builtins.str end_date: The DateTime when the review is scheduled to end. Required if type is endDate
        :param builtins.int number_of_occurrences: The number of times to repeat the access review. Required and must be positive if type is numbered.
        :param builtins.str start_date: The DateTime when the review is scheduled to be start. This could be a date in the future. Required on create.
        :param builtins.str type: The recurrence range type. The possible values are: endDate, noEnd, numbered.
        """
    ...
    def number_of_occurrences(self) -> Optional[builtins.int]:
        """
...
class AccessReviewReviewerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Descriptor for what needs to be reviewed
        :param builtins.str principal_type: The identity type : user/servicePrincipal
        :param builtins.str principal_id: The id of the reviewer(user/servicePrincipal)
        """
...
class AccessReviewScopeResponse(dict):
    ...
    def __init__(__self__, *,
                 assignment_state: builtins.str,
                 principal_type: builtins.str,
                 resource_id: builtins.str,
                 role_definition_id: builtins.str,
                 exclude_resource_id: Optional[builtins.str] = None,
                 exclude_role_definition_id: Optional[builtins.str] = None,
                 expand_nested_memberships: Optional[builtins.bool] = None,
                 inactive_duration: Optional[builtins.str] = None,
                 include_access_below_resource: Optional[builtins.bool] = None,
                 include_inherited_access: Optional[builtins.bool] = None):
        """
        Descriptor for what needs to be reviewed
        :param builtins.str assignment_state: The role assignment state eligible/active to review
        :param builtins.str principal_type: The identity type user/servicePrincipal to review
        :param builtins.str resource_id: ResourceId in which this review is getting created
        :param builtins.str role_definition_id: This is used to indicate the role being reviewed
        :param builtins.str exclude_resource_id: This is used to indicate the resource id(s) to exclude
        :param builtins.str exclude_role_definition_id: This is used to indicate the role definition id(s) to exclude
        :param builtins.bool expand_nested_memberships: Flag to indicate whether to expand nested memberships or not.
        :param builtins.str inactive_duration: Duration users are inactive for. The value should be in ISO  8601 format (http://en.wikipedia.org/wiki/ISO_8601#Durations).This code can be used to convert TimeSpan to a valid interval string: XmlConvert.ToString(new TimeSpan(hours, minutes, seconds))
        :param builtins.bool include_access_below_resource: Flag to indicate whether to expand nested memberships or not.
        :param builtins.bool include_inherited_access: Flag to indicate whether to expand nested memberships or not.
        """
    ...
    def assignment_state(self) -> builtins.str:
        """
    ...
    def exclude_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def exclude_role_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def expand_nested_memberships(self) -> Optional[builtins.bool]:
        """
    ...
    def inactive_duration(self) -> Optional[builtins.str]:
        """
    ...
    def include_access_below_resource(self) -> Optional[builtins.bool]:
        """
        Flag to indicate whether to expand nested memberships or not.
        """
    ...
    def include_inherited_access(self) -> Optional[builtins.bool]:
        """
        Flag to indicate whether to expand nested memberships or not.
        """
...
class ApprovalSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_approval_required: Optional[builtins.bool] = None,
                 is_approval_required_for_extension: Optional[builtins.bool] = None,
                 is_requestor_justification_required: Optional[builtins.bool] = None):
        """
        The approval settings.
        :param builtins.str approval_mode: The type of rule
        :param Sequence['ApprovalStageResponse'] approval_stages: The approval stages of the request.
        :param builtins.bool is_approval_required: Determines whether approval is required or not.
        :param builtins.bool is_approval_required_for_extension: Determines whether approval is required for assignment extension.
        :param builtins.bool is_requestor_justification_required: Determine whether requestor justification is required.
        """
    ...
    def is_approval_required(self) -> Optional[builtins.bool]:
        """
    ...
    def is_approval_required_for_extension(self) -> Optional[builtins.bool]:
        """
    ...
    def is_requestor_justification_required(self) -> Optional[builtins.bool]:
        """
...
class ApprovalStageResponse(dict):
    ...
    def __init__(__self__, *,
                 approval_stage_time_out_in_days: Optional[builtins.int] = None,
                 escalation_approvers: Optional[Sequence['outputs.UserSetResponse']] = None,
                 escalation_time_in_minutes: Optional[builtins.int] = None,
                 is_approver_justification_required: Optional[builtins.bool] = None,
                 is_escalation_enabled: Optional[builtins.bool] = None,
                 primary_approvers: Optional[Sequence['outputs.UserSetResponse']] = None):
        """
        The approval stage.
        :param builtins.int approval_stage_time_out_in_days: The time in days when approval request would be timed out
        :param Sequence['UserSetResponse'] escalation_approvers: The escalation approver of the request.
        :param builtins.int escalation_time_in_minutes: The time in minutes when the approval request would be escalated if the primary approver does not approve
        :param builtins.bool is_approver_justification_required: Determines whether approver need to provide justification for his decision.
        :param builtins.bool is_escalation_enabled: The value determine whether escalation feature is enabled.
    ...
    def approval_stage_time_out_in_days(self) -> Optional[builtins.int]:
        """
    ...
    def escalation_time_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def is_approver_justification_required(self) -> Optional[builtins.bool]:
        """
    ...
    def is_escalation_enabled(self) -> Optional[builtins.bool]:
        """
...
class ExpandedPropertiesResponsePrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of the principal
        :param builtins.str display_name: Display name of the principal
        :param builtins.str email: Email id of the principal
        :param builtins.str id: Id of the principal
        :param builtins.str type: Type of the principal
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
...
class ExpandedPropertiesResponseRoleDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of role definition
        :param builtins.str display_name: Display name of the role definition
        :param builtins.str id: Id of the role definition
        :param builtins.str type: Type of the role definition
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if id is not None:
...
class ExpandedPropertiesResponseScope(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of the resource scope
        :param builtins.str display_name: Display name of the resource
        :param builtins.str id: Scope id of the resource
...
class IdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the resource.  Policy assignments support a maximum of one identity.  That is either a system assigned identity or a single user assigned identity.
        :param builtins.str principal_id: The principal ID of the resource identity.  This property will only be provided for a system assigned identity
        :param builtins.str tenant_id: The tenant ID of the resource identity.  This property will only be provided for a system assigned identity
        :param builtins.str type: The identity type. This is the only required field when adding a system or user assigned identity to a resource.
...
class ManagementLockOwnerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Lock owner properties.
        :param builtins.str application_id: The application ID of the lock owner.
        """
...
class NonComplianceMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A message that describes why a resource is non-compliant with the policy. This is shown in 'deny' error messages and on resource's non-compliant compliance results.
        :param builtins.str message: A message that describes why a resource is non-compliant with the policy. This is shown in 'deny' error messages and on resource's non-compliant compliance results.
        :param builtins.str policy_definition_reference_id: The policy definition reference ID within a policy set definition the message is intended for. This is only applicable if the policy assignment assigns a policy set definition. If this is not provided the message applies to all policies assigned by this policy assignment.
        """
...
class OverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The policy property value override.
        :param builtins.str kind: The override kind.
        :param Sequence['SelectorResponse'] selectors: The list of the selector expressions.
        :param builtins.str value: The value to override the policy property.
        """
        if kind is not None:
...
class PIMOnlyModeSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 excluded_assignment_types: Optional[Sequence[builtins.str]] = None,
                 excludes: Optional[Sequence['outputs.UsersOrServicePrincipalSetResponse']] = None,
                 mode: Optional[builtins.str] = None):
        """
        The PIM Only Mode settings.
        :param Sequence[builtins.str] excluded_assignment_types: The list of excluded assignment types allowed.
        :param Sequence['UsersOrServicePrincipalSetResponse'] excludes: The list of excluded entities that the rule does not apply to.
        :param builtins.str mode: Determines whether the setting is enabled, disabled or report only.
        """
    ...
    def excluded_assignment_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ParameterDefinitionsValueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The data type of the parameter.
        """
...
class ParameterDefinitionsValueResponseMetadata(dict):
    ...
    def __init__(__self__, *,
                 assign_permissions: Optional[builtins.bool] = None,
                 description: Optional[builtins.str] = None,
                 display_name: Optional[builtins.str] = None,
                 strong_type: Optional[builtins.str] = None):
        """
        General metadata for the parameter.
        :param builtins.bool assign_permissions: Set to true to have Azure portal create role assignments on the resource ID or resource scope value of this parameter during policy assignment. This property is useful in case you wish to assign permissions outside the assignment scope.
        :param builtins.str description: The description of the parameter.
        :param builtins.str display_name: The display name for the parameter.
        :param builtins.str strong_type: Used when assigning the policy definition through the portal. Provides a context aware list of values for the user to choose from.
        """
    ...
    def assign_permissions(self) -> Optional[builtins.bool]:
        """
...
class PermissionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Role definition permissions.
        :param builtins.str condition: The conditions on the role definition. This limits the resources it can be assigned to. e.g.: @Resource[Microsoft.Storage/storageAccounts/blobServices/containers:ContainerName] StringEqualsIgnoreCase 'foo_storage_container'
        :param builtins.str condition_version: Version of the condition. Currently the only accepted value is '2.0'
        :param Sequence[builtins.str] actions: Allowed actions.
        :param Sequence[builtins.str] data_actions: Allowed Data actions.
        :param Sequence[builtins.str] not_actions: Denied actions.
        :param Sequence[builtins.str] not_data_actions: Denied Data actions.
        """
...
class PolicyAssignmentPropertiesResponsePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 last_modified_date_time: Optional[builtins.str] = None):
        """
        Details of the policy
        :param 'PrincipalResponse' last_modified_by: The name of the entity last modified it
        :param builtins.str id: Id of the policy
        :param builtins.str last_modified_date_time: The last modified date time.
        """
    ...
    def last_modified_date_time(self) -> Optional[builtins.str]:
        """
...
class PolicyDefinitionGroupResponse(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 additional_metadata_id: Optional[builtins.str] = None,
        ...
        :param builtins.str additional_metadata_id: A resource ID of a resource that contains additional metadata about the group.
        :param builtins.str category: The group's category.
        :param builtins.str description: The group's description.
        :param builtins.str display_name: The group's display name.
        """
        pulumi.set(__self__, "name", name)
    ...
    def additional_metadata_id(self) -> Optional[builtins.str]:
        """
...
class PolicyDefinitionReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 effective_definition_version: builtins.str,
                 latest_definition_version: builtins.str,
                 policy_definition_id: builtins.str,
                 definition_version: Optional[builtins.str] = None,
                 group_names: Optional[Sequence[builtins.str]] = None,
                 parameters: Optional[Mapping[str, 'outputs.ParameterValuesValueResponse']] = None,
                 policy_definition_reference_id: Optional[builtins.str] = None):
        """
        The policy definition reference.
        :param builtins.str effective_definition_version: The effective version of the policy definition in use. This is only present if requested via the $expand query parameter.
        :param builtins.str latest_definition_version: The latest version of the policy definition available. This is only present if requested via the $expand query parameter.
        :param builtins.str policy_definition_id: The ID of the policy definition or policy set definition.
        :param builtins.str definition_version: The version of the policy definition to use.
        :param Sequence[builtins.str] group_names: The name of the groups that this policy definition reference belongs to.
        ...
        :param builtins.str policy_definition_reference_id: A unique id (within the policy set definition) for this policy definition reference.
        """
    ...
    def group_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PolicyDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The ID of the policy definition version.
        :param builtins.str id: The ID of the policy definition version.
        :param builtins.str name: The name of the policy definition version.
        :param 'SystemDataResponse' system_data: The system metadata relating to this resource.
        :param builtins.str type: The type of the resource (Microsoft.Authorization/policyDefinitions/versions).
        :param builtins.str description: The policy definition description.
        :param builtins.str display_name: The display name of the policy definition.
        ...
        :param builtins.str mode: The policy definition mode. Some examples are All, Indexed, Microsoft.KeyVault.Data.
        ...
        :param builtins.str policy_type: The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
        :param builtins.str version: The policy definition version in #.#.# format.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class PolicySetDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The policy set definition version.
        :param builtins.str id: The ID of the policy set definition version.
        :param builtins.str name: The name of the policy set definition version.
        :param Sequence['PolicyDefinitionReferenceResponse'] policy_definitions: An array of policy definition references.
        :param 'SystemDataResponse' system_data: The system metadata relating to this resource.
        :param builtins.str type: The type of the resource (Microsoft.Authorization/policySetDefinitions/versions).
        :param builtins.str description: The policy set definition description.
        :param builtins.str display_name: The display name of the policy set definition.
        ...
        :param builtins.str policy_type: The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
        :param builtins.str version: The policy set definition version in #.#.# format.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class PolicyVariableColumnResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The variable column.
        :param builtins.str column_name: The name of this policy variable column.
        """
...
class PolicyVariableValueColumnValueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The name value tuple for this variable value column.
        :param builtins.str column_name: Column name for the variable value
...
class PrincipalResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The name of the entity last modified it
        :param builtins.str display_name: The name of the principal made changes
        :param builtins.str email: Email of principal
        :param builtins.str id: The id of the principal made changes
        :param builtins.str type: Type of principal such as user , group etc
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if email is not None:
...
class PrivateLinkAssociationPropertiesExpandedResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Private Link Association Properties.
        :param builtins.str private_link: The rmpl Resource ID.
        :param builtins.str scope: The scope of the private link association.
...
class ResourceManagementPrivateLinkEndpointConnectionsResponse(dict):
    ...
    def __init__(__self__, *,
                 private_endpoint_connections: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] private_endpoint_connections: The private endpoint connections.
        """
    ...
    def private_endpoint_connections(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResourceSelectorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The resource selector to filter policies by resource properties.
        :param builtins.str name: The name of the resource selector.
        :param Sequence['SelectorResponse'] selectors: The list of the selector expressions.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class RoleEligibilityScheduleRequestPropertiesResponseExpiration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Expiration of the role eligibility schedule
        :param builtins.str duration: Duration of the role eligibility schedule in TimeSpan.
        :param builtins.str end_date_time: End DateTime of the role eligibility schedule.
        :param builtins.str type: Type of the role eligibility schedule expiration
        """
...
class RoleEligibilityScheduleRequestPropertiesResponseScheduleInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str start_date_time: Start DateTime of the role eligibility schedule.
        """
        if expiration is not None:
            pulumi.set(__self__, "expiration", expiration)
        if start_date_time is not None:
...
class RoleEligibilityScheduleRequestPropertiesResponseTicketInfo(dict):
    ...
    def __init__(__self__, *,
                 ticket_number: Optional[builtins.str] = None,
                 ticket_system: Optional[builtins.str] = None):
        """
        Ticket Info of the role eligibility
        :param builtins.str ticket_number: Ticket number for the role eligibility
        :param builtins.str ticket_system: Ticket system name for the role eligibility
        """
    ...
    def ticket_number(self) -> Optional[builtins.str]:
        """
    ...
    def ticket_system(self) -> Optional[builtins.str]:
        """
...
class RoleManagementPolicyAuthenticationContextRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str claim_value: The claim value.
        :param builtins.str id: The id of the rule.
        :param builtins.bool is_enabled: The value indicating if rule is enabled.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
...
class RoleManagementPolicyEnablementRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_type: builtins.str,
                 enabled_rules: Optional[Sequence[builtins.str]] = None,
                 id: Optional[builtins.str] = None,
                 target: Optional['outputs.RoleManagementPolicyRuleTargetResponse'] = None):
        """
        The role management policy enablement rule.
        ...
        :param Sequence[builtins.str] enabled_rules: The list of enabled rules.
        :param builtins.str id: The id of the rule.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
    ...
    def enabled_rules(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RoleManagementPolicyExpirationRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 is_expiration_required: Optional[builtins.bool] = None,
        ...
        :param builtins.str id: The id of the rule.
        :param builtins.bool is_expiration_required: The value indicating whether expiration is required.
        :param builtins.str maximum_duration: The maximum duration of expiration in timespan.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
    ...
    def is_expiration_required(self) -> Optional[builtins.bool]:
        """
...
class RoleManagementPolicyNotificationRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_type: builtins.str,
                 id: Optional[builtins.str] = None,
                 is_default_recipients_enabled: Optional[builtins.bool] = None,
                 notification_level: Optional[builtins.str] = None,
                 notification_recipients: Optional[Sequence[builtins.str]] = None,
                 notification_type: Optional[builtins.str] = None,
                 recipient_type: Optional[builtins.str] = None,
                 target: Optional['outputs.RoleManagementPolicyRuleTargetResponse'] = None):
        """
        The role management policy notification rule.
        :param builtins.str rule_type: The type of rule
        ...
        :param builtins.str id: The id of the rule.
        :param builtins.bool is_default_recipients_enabled: Determines if the notification will be sent to the recipient type specified in the policy rule.
        :param builtins.str notification_level: The notification level.
        :param Sequence[builtins.str] notification_recipients: The list of notification recipients.
        :param builtins.str notification_type: The type of notification.
        :param builtins.str recipient_type: The recipient type.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
    ...
    def is_default_recipients_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def notification_level(self) -> Optional[builtins.str]:
        """
    ...
    def notification_recipients(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def recipient_type(self) -> Optional[builtins.str]:
        """
        The recipient type.
        """
...
class RoleManagementPolicyRuleTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enforced_settings: Optional[Sequence[builtins.str]] = None,
                 inheritable_settings: Optional[Sequence[builtins.str]] = None,
                 level: Optional[builtins.str] = None,
                 operations: Optional[Sequence[builtins.str]] = None,
                 target_objects: Optional[Sequence[builtins.str]] = None):
        """
        The role management policy rule target.
        :param builtins.str caller: The caller of the setting.
        :param Sequence[builtins.str] enforced_settings: The list of enforced settings.
        :param Sequence[builtins.str] inheritable_settings: The list of inheritable settings.
        :param builtins.str level: The assignment level to which rule is applied.
        :param Sequence[builtins.str] operations: The type of operation.
        :param Sequence[builtins.str] target_objects: The list of target objects.
        """
    ...
    def enforced_settings(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def inheritable_settings(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def target_objects(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SelectorResponse(dict):
    ...
    def __init__(__self__, *,
                 in_: Optional[Sequence[builtins.str]] = None,
                 kind: Optional[builtins.str] = None,
                 not_in: Optional[Sequence[builtins.str]] = None):
        """
        The selector expression.
        :param Sequence[builtins.str] in_: The list of values to filter in.
        :param builtins.str kind: The selector kind.
        :param Sequence[builtins.str] not_in: The list of values to filter out.
        """
        if in_ is not None:
    ...
    def in_(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_in(self) -> Optional[Sequence[builtins.str]]:
        """
...
class UserSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The detail of a user.
        :param builtins.str description: The description of the user.
        :param builtins.str id: The object id of the user.
        :param builtins.bool is_backup: The value indicating whether the user is a backup fallback approver
        :param builtins.str user_type: The type of user.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if id is not None:
...
class UsersOrServicePrincipalSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The detail of a subject.
        :param builtins.str display_name: The display Name of the entity.
        :param builtins.str id: The object id of the entity.
        :param builtins.str type: The type of user.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if id is not None:
