...
class AccessReviewHistoryInstanceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fulfilled_date_time: Optional[_builtins.str] = None,
                 review_history_period_end_date_time: Optional[_builtins.str] = None,
                 review_history_period_start_date_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str status: Status of the requested review history instance data. This is either requested, in-progress, done or error. The state transitions are as follows - Requested -> InProgress -> Done -> Expired
        :param _builtins.str type: The resource type.
        :param _builtins.str display_name: The display name for the parent history definition.
        :param _builtins.str expiration: Date time when history data report expires and the associated data is deleted.
        :param _builtins.str fulfilled_date_time: Date time when the history data report is scheduled to be generated.
        :param _builtins.str review_history_period_end_date_time: Date time used when selecting review data, all reviews included in data end on or before this date. For use only with one-time/non-recurring reports.
        :param _builtins.str review_history_period_start_date_time: Date time used when selecting review data, all reviews included in data start on or after this date. For use only with one-time/non-recurring reports.
        :param _builtins.str run_date_time: Date time when the history data report is scheduled to be generated.
        """
...
class AccessReviewInstanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_date_time: The DateTime when the review instance is scheduled to be start.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class AccessReviewRecurrenceRangeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number_of_occurrences: Optional[_builtins.int] = None,
        ...
        :param _builtins.str type: The recurrence range type. The possible values are: endDate, noEnd, numbered.
        """
...
class AccessReviewScopeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclude_resource_id: Optional[_builtins.str] = None,
                 exclude_role_definition_id: Optional[_builtins.str] = None,
                 expand_nested_memberships: Optional[_builtins.bool] = None,
                 inactive_duration: Optional[_builtins.str] = None,
                 include_access_below_resource: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str role_definition_id: This is used to indicate the role being reviewed
        :param _builtins.str exclude_resource_id: This is used to indicate the resource id(s) to exclude
        :param _builtins.str exclude_role_definition_id: This is used to indicate the role definition id(s) to exclude
        :param _builtins.bool expand_nested_memberships: Flag to indicate whether to expand nested memberships or not.
        :param _builtins.str inactive_duration: Duration users are inactive for. The value should be in ISO  8601 format (http://en.wikipedia.org/wiki/ISO_8601#Durations).This code can be used to convert TimeSpan to a valid interval string: XmlConvert.ToString(new TimeSpan(hours, minutes, seconds))
        :param _builtins.bool include_access_below_resource: Flag to indicate whether to expand nested memberships or not.
        :param _builtins.bool include_inherited_access: Flag to indicate whether to expand nested memberships or not.
        """
...
class ApprovalSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_approval_required: Optional[_builtins.bool] = None,
                 is_approval_required_for_extension: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool is_approval_required_for_extension: Determines whether approval is required for assignment extension.
        :param _builtins.bool is_requestor_justification_required: Determine whether requestor justification is required.
        """
...
class ApprovalStageResponse(dict):
    ...
    def __init__(__self__, *,
                 approval_stage_time_out_in_days: Optional[_builtins.int] = None,
                 escalation_approvers: Optional[Sequence['outputs.UserSetResponse']] = None,
                 escalation_time_in_minutes: Optional[_builtins.int] = None,
                 is_approver_justification_required: Optional[_builtins.bool] = None,
                 is_escalation_enabled: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool is_approver_justification_required: Determines whether approver need to provide justification for his decision.
        :param _builtins.bool is_escalation_enabled: The value determine whether escalation feature is enabled.
...
class ExpandedPropertiesResponsePrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: Type of the principal
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
...
class PIMOnlyModeSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 excluded_assignment_types: Optional[Sequence[_builtins.str]] = None,
...
class ParameterDefinitionsValueResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The data type of the parameter.
        """
...
class ParameterDefinitionsValueResponseMetadata(dict):
    ...
    def __init__(__self__, *,
                 assign_permissions: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str strong_type: Used when assigning the policy definition through the portal. Provides a context aware list of values for the user to choose from.
        """
...
class PermissionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] data_actions: Allowed Data actions.
        :param Sequence[_builtins.str] not_actions: Denied actions.
        :param Sequence[_builtins.str] not_data_actions: Denied Data actions.
        """
...
class PolicyDefinitionGroupResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 additional_metadata_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str description: The group's description.
        :param _builtins.str display_name: The group's display name.
        """
        pulumi.set(__self__, "name", name)
...
class PolicyDefinitionReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 group_names: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.str definition_version: The version of the policy definition to use.
        :param Sequence[_builtins.str] group_names: The name of the groups that this policy definition reference belongs to.
        ...
        :param _builtins.str policy_definition_reference_id: A unique id (within the policy set definition) for this policy definition reference.
        """
...
class PolicyDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param '_commontypesv5.SystemDataResponse' system_data: The system metadata relating to this resource.
        :param _builtins.str type: The type of the resource (Microsoft.Authorization/policyDefinitions/versions).
        :param _builtins.str description: The policy definition description.
        :param _builtins.str display_name: The display name of the policy definition.
        ...
        :param _builtins.str mode: The policy definition mode. Some examples are All, Indexed, Microsoft.KeyVault.Data.
        ...
        :param _builtins.str policy_type: The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
        :param _builtins.str version: The policy definition version in #.#.# format.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class PolicySetDefinitionVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param '_commontypesv5.SystemDataResponse' system_data: The system metadata relating to this resource.
        :param _builtins.str type: The type of the resource (Microsoft.Authorization/policySetDefinitions/versions).
        :param _builtins.str description: The policy set definition description.
        :param _builtins.str display_name: The display name of the policy set definition.
        ...
        :param _builtins.str policy_type: The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
        :param _builtins.str version: The policy set definition version in #.#.# format.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class ResourceManagementPrivateLinkEndpointConnectionsResponse(dict):
    ...
    def __init__(__self__, *,
                 private_endpoint_connections: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] private_endpoint_connections: The private endpoint connections.
        """
...
class RoleEligibilityScheduleRequestPropertiesResponseTicketInfo(dict):
    ...
    def __init__(__self__, *,
                 ticket_number: Optional[_builtins.str] = None,
...
class RoleManagementPolicyAuthenticationContextRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_type: _builtins.str,
                 claim_value: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str id: The id of the rule.
        :param _builtins.bool is_enabled: The value indicating if rule is enabled.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
...
class RoleManagementPolicyEnablementRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_type: _builtins.str,
                 enabled_rules: Optional[Sequence[_builtins.str]] = None,
                 id: Optional[_builtins.str] = None,
                 target: Optional['outputs.RoleManagementPolicyRuleTargetResponse'] = None):
        """
        The role management policy enablement rule.
...
class RoleManagementPolicyExpirationRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None,
                 is_expiration_required: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str id: The id of the rule.
        :param _builtins.bool is_expiration_required: The value indicating whether expiration is required.
        :param _builtins.str maximum_duration: The maximum duration of expiration in timespan.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
...
class RoleManagementPolicyNotificationRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_type: _builtins.str,
                 id: Optional[_builtins.str] = None,
                 is_default_recipients_enabled: Optional[_builtins.bool] = None,
                 notification_level: Optional[_builtins.str] = None,
                 notification_recipients: Optional[Sequence[_builtins.str]] = None,
                 notification_type: Optional[_builtins.str] = None,
                 recipient_type: Optional[_builtins.str] = None,
                 target: Optional['outputs.RoleManagementPolicyRuleTargetResponse'] = None):
        """
        The role management policy notification rule.
        ...
        :param _builtins.str id: The id of the rule.
        :param _builtins.bool is_default_recipients_enabled: Determines if the notification will be sent to the recipient type specified in the policy rule.
        :param _builtins.str notification_level: The notification level.
        :param Sequence[_builtins.str] notification_recipients: The list of notification recipients.
        :param _builtins.str notification_type: The type of notification.
        :param _builtins.str recipient_type: The recipient type.
        :param 'RoleManagementPolicyRuleTargetResponse' target: The target of the current rule.
        """
...
class RoleManagementPolicyRuleTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enforced_settings: Optional[Sequence[_builtins.str]] = None,
                 inheritable_settings: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.str level: The assignment level to which rule is applied.
        :param Sequence[_builtins.str] operations: The type of operation.
        :param Sequence[_builtins.str] target_objects: The list of target objects.
        """
...
class UserSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str user_type: The type of user.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if id is not None:
