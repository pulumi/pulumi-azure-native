...
def get_policy_definition_version_at_management_group(management_group_name: Optional[builtins.str] = None,
...
def get_policy_definition_version_at_management_group_output(management_group_name: Optional[pulumi.Input[builtins.str]] = None,
