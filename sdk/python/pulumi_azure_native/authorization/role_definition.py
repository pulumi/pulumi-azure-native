...
class RoleDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220501preview:RoleDefinition"), pulumi.Alias(type_="azure-native_authorization_v20150701:authorization:RoleDefinition"), pulumi.Alias(type_="azure-native_authorization_v20180101preview:authorization:RoleDefinition"), pulumi.Alias(type_="azure-native_authorization_v20220401:authorization:RoleDefinition"), pulumi.Alias(type_="azure-native_authorization_v20220501preview:authorization:RoleDefinition")])
