...
class AccessReviewScheduleDefinitionById(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-nextgen:authorization/v20180501preview:AccessReviewScheduleDefinitionById")])
