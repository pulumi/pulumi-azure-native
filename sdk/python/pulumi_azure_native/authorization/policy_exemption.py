...
class PolicyExemption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization/v20200701preview:PolicyExemption"), pulumi.Alias(type_="azure-nextgen:authorization/v20200701preview:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization/v20210701:PolicyExemption"), pulumi.Alias(type_="azure-nextgen:authorization/v20210701:PolicyExemption")])
