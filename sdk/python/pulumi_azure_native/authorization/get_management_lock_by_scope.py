...
def get_management_lock_by_scope(lock_name: Optional[_builtins.str] = None,
...
def get_management_lock_by_scope_output(lock_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
