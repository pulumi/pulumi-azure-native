...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition is deprecated: azure-native:authorization/v20190901:PolicyDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20210601:PolicyDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
