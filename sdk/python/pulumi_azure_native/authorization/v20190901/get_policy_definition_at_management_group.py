...
def get_policy_definition_at_management_group(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition_at_management_group is deprecated: azure-native:authorization/v20190901:PolicyDefinitionAtManagementGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20210601:PolicyDefinitionAtManagementGroup to guarantee forwards compatibility.""")
    __args__ = dict()
