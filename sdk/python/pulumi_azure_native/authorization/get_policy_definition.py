...
def get_policy_definition(policy_definition_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
...
def get_policy_definition_output(policy_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
