...
def get_policy_definition(policy_definition_name: Optional[builtins.str] = None,
...
def get_policy_definition_output(policy_definition_name: Optional[pulumi.Input[builtins.str]] = None,
