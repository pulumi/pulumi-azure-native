...
class RoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RoleAssignment is deprecated: Version 2020-04-01-preview will be removed in v2 of the provider.""")
