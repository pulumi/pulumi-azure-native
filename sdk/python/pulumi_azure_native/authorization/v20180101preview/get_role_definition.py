...
def get_role_definition(role_definition_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20180101preview:getRoleDefinition', __args__, opts=opts, typ=GetRoleDefinitionResult).value
...
def get_role_definition_output(role_definition_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20180101preview:getRoleDefinition', __args__, opts=opts, typ=GetRoleDefinitionResult)
