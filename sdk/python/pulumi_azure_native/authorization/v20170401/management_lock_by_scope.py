...
class ManagementLockByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20170401:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20200501:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization/v20200501:ManagementLockByScope")])
