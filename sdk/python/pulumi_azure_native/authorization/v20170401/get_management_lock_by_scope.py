...
def get_management_lock_by_scope_output(lock_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20170401:getManagementLockByScope', __args__, opts=opts, typ=GetManagementLockByScopeResult)
