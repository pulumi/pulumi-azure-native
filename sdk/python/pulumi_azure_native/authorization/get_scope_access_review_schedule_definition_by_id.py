...
def get_scope_access_review_schedule_definition_by_id(schedule_definition_id: Optional[_builtins.str] = None,
...
def get_scope_access_review_schedule_definition_by_id_output(schedule_definition_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
