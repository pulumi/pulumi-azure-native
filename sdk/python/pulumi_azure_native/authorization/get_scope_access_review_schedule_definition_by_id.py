...
def get_scope_access_review_schedule_definition_by_id(schedule_definition_id: Optional[builtins.str] = None,
...
def get_scope_access_review_schedule_definition_by_id_output(schedule_definition_id: Optional[pulumi.Input[builtins.str]] = None,
