...
class ScopeAccessReviewScheduleDefinitionByIdArgs:
    ...
    def _configure(
        ...
        if auto_apply_decisions_enabled is None and 'autoApplyDecisionsEnabled' in kwargs:
            auto_apply_decisions_enabled = kwargs['autoApplyDecisionsEnabled']
        if backup_reviewers is None and 'backupReviewers' in kwargs:
            backup_reviewers = kwargs['backupReviewers']
        if default_decision is None and 'defaultDecision' in kwargs:
            default_decision = kwargs['defaultDecision']
        if default_decision_enabled is None and 'defaultDecisionEnabled' in kwargs:
            default_decision_enabled = kwargs['defaultDecisionEnabled']
        if description_for_admins is None and 'descriptionForAdmins' in kwargs:
            description_for_admins = kwargs['descriptionForAdmins']
        if description_for_reviewers is None and 'descriptionForReviewers' in kwargs:
            description_for_reviewers = kwargs['descriptionForReviewers']
        ...
        if instance_duration_in_days is None and 'instanceDurationInDays' in kwargs:
            instance_duration_in_days = kwargs['instanceDurationInDays']
        if justification_required_on_approval is None and 'justificationRequiredOnApproval' in kwargs:
            justification_required_on_approval = kwargs['justificationRequiredOnApproval']
        if mail_notifications_enabled is None and 'mailNotificationsEnabled' in kwargs:
            mail_notifications_enabled = kwargs['mailNotificationsEnabled']
        if number_of_occurrences is None and 'numberOfOccurrences' in kwargs:
            number_of_occurrences = kwargs['numberOfOccurrences']
        if recommendation_look_back_duration is None and 'recommendationLookBackDuration' in kwargs:
            recommendation_look_back_duration = kwargs['recommendationLookBackDuration']
        ...
        if reminder_notifications_enabled is None and 'reminderNotificationsEnabled' in kwargs:
            reminder_notifications_enabled = kwargs['reminderNotificationsEnabled']
        if schedule_definition_id is None and 'scheduleDefinitionId' in kwargs:
            schedule_definition_id = kwargs['scheduleDefinitionId']
