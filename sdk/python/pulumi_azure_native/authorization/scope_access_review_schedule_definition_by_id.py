...
class ScopeAccessReviewScheduleDefinitionByIdArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'autoApplyDecisionsEnabled' in kwargs:
        ...
        if 'recommendationLookBackDuration' in kwargs:
        ...
        if 'reminderNotificationsEnabled' in kwargs:
            reminder_notifications_enabled = kwargs['reminderNotificationsEnabled']
        if 'scheduleDefinitionId' in kwargs:
