...
def get_private_link_association(group_id: Optional[_builtins.str] = None,
                                 pla_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pla_id: The ID of the PLA
    """
    __args__ = dict()
...
def get_private_link_association_output(group_id: pulumi.Input[Optional[_builtins.str]] = None,
                                        pla_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
