...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition is deprecated: Version 2016-04-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['policyDefinitionName'] = policy_definition_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20160401:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
