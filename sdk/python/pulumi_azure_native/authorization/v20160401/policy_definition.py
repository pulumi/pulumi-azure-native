...
class PolicyDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 policy_type: Optional[pulumi.Input[Union[str, 'PolicyType']]] = None,
                 __props__=None):
        pulumi.log.warn("""PolicyDefinition is deprecated: Version v20160401 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
        if opts is None:
