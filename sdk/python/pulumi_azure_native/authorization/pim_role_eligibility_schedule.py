...
class PimRoleEligibilityScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] condition_version: Version of the condition. Currently accepted value is '2.0'
        :param pulumi.Input[_builtins.str] justification: Justification for the role eligibility
        ...
        :param pulumi.Input[_builtins.str] target_role_eligibility_schedule_id: The resultant role eligibility schedule id or the role eligibility schedule id being updated
        :param pulumi.Input[_builtins.str] target_role_eligibility_schedule_instance_id: The role eligibility schedule instance id being updated
