...
def get_role_definition(role_definition_id: Optional[_builtins.str] = None,
...
def get_role_definition_output(role_definition_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
