...
class GetPolicyAssignmentResult:
    ...
    """
    def __init__(__self__, description=None, display_name=None, id=None, name=None, parameters=None, policy_definition_id=None, scope=None, type=None):
...
def get_policy_assignment(policy_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_assignment is deprecated: Version v20161201 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20161201:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult).value
