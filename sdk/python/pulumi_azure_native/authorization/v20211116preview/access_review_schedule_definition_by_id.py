...
warnings.warn("""azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.""", DeprecationWarning)
...
class AccessReviewScheduleDefinitionById(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[Union[str, 'AccessReviewRecurrenceRangeType']]] = None,
                 __props__=None):
        pulumi.log.warn("""AccessReviewScheduleDefinitionById is deprecated: azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20210701preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessReviewScheduleDefinitionById, __self__).__init__(
            'azure-native:authorization/v20211116preview:AccessReviewScheduleDefinitionById',
            resource_name,
            __props__,
            opts)
