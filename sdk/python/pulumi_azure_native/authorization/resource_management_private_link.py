...
class ResourceManagementPrivateLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization:ResourceManagementPrivateLink"), pulumi.Alias(type_="azure-native:authorization/v20200501:ResourceManagementPrivateLink"), pulumi.Alias(type_="azure-nextgen:authorization/v20200501:ResourceManagementPrivateLink")])
