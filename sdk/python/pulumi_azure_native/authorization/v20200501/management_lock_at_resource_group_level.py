...
class ManagementLockAtResourceGroupLevel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_lock_at_resource_group_level = azure_native.authorization.v20200501.ManagementLockAtResourceGroupLevel("managementLockAtResourceGroupLevel",
            level="ReadOnly",
            lock_name="testlock",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native:authorization/v20150101:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockAtResourceGroupLevel"), pulumi.Alias(type_="azure-native:authorization/v20170401:ManagementLockAtResourceGroupLevel")])
