...
class ResourceManagementPrivateLinkArgs:
    ...
    def rmpl_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @rmpl_name.setter
    def rmpl_name(self, value: Optional[pulumi.Input[str]]):
...
class ResourceManagementPrivateLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ResourceManagementPrivateLink resource with the given unique name, props, and options.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceManagementPrivateLinkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceManagementPrivateLinkArgs.__new__(ResourceManagementPrivateLinkArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20200501:ResourceManagementPrivateLink"), pulumi.Alias(type_="azure-native:authorization:ResourceManagementPrivateLink"), pulumi.Alias(type_="azure-nextgen:authorization:ResourceManagementPrivateLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ResourceManagementPrivateLink, __self__).__init__(
            'azure-native:authorization/v20200501:ResourceManagementPrivateLink',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ResourceManagementPrivateLink':
        """
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return ResourceManagementPrivateLink(resource_name, opts=opts, __props__=__props__)
