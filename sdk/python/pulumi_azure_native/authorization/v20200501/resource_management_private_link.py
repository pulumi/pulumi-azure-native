...
class ResourceManagementPrivateLinkArgs:
    ...
    def _configure(
        ...
        if rmpl_name is None and 'rmplName' in kwargs:
            rmpl_name = kwargs['rmplName']
...
class ResourceManagementPrivateLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:ResourceManagementPrivateLink")])
