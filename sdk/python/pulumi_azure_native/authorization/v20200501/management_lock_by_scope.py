...
class ManagementLockByScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_lock_by_scope = azure_native.authorization.v20200501.ManagementLockByScope("managementLockByScope",
            level="ReadOnly",
            lock_name="testlock",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20170401:ManagementLockByScope")])
