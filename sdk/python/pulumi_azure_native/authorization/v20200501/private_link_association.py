...
class PrivateLinkAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_association = azure_native.authorization.v20200501.PrivateLinkAssociation("privateLinkAssociation",
            group_id="my-management-group",
            pla_id="00000000-0000-0000-0000-000000000000",
            properties=azure_native.authorization.v20200501.PrivateLinkAssociationPropertiesArgs(
