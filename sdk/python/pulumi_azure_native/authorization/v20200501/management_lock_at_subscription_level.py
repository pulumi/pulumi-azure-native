...
class ManagementLockAtSubscriptionLevel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_lock_at_subscription_level = azure_native.authorization.v20200501.ManagementLockAtSubscriptionLevel("managementLockAtSubscriptionLevel",
            level="ReadOnly",
            lock_name="testlock")
        ...
        ```sh
        $ pulumi import azure-native:authorization/v20200501:ManagementLockAtSubscriptionLevel testlock /subscriptions/subscriptionId/resourceGroups/resourcegroupname/providers/Microsoft.Authorization/locks/testlock 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization/v20150101:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization/v20170401:ManagementLockAtSubscriptionLevel")])
