...
class PolicyExemptionArgs:
    ...
    def _configure(
        ...
        if assignment_scope_validation is None and 'assignmentScopeValidation' in kwargs:
            assignment_scope_validation = kwargs['assignmentScopeValidation']
        ...
        if policy_exemption_name is None and 'policyExemptionName' in kwargs:
            policy_exemption_name = kwargs['policyExemptionName']
