...
class PolicySetDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        policy_set_definition = azure_native.authorization.v20210601.PolicySetDefinition("policySetDefinition",
            ...
            parameters={
                "namePrefix": azure_native.authorization.v20210601.ParameterDefinitionsValueArgs(
        ...
        ```sh
        $ pulumi import azure-native:authorization/v20210601:PolicySetDefinition CostManagement /subscriptions/ae640e6b-ba3e-4256-9d62-2993eecfa6f2/providers/Microsoft.Authorization/policySetDefinitions/CostManagement 
        ```
