...
class PrivateLinkAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pla_id: The ID of the PLA
    ...
    def pla_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the PLA
        """
    ...
    @pla_id.setter
    def pla_id(self, value: Optional[pulumi.Input[builtins.str]]):
