...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getRoleAssignment'.""", DeprecationWarning)
...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
