...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getPolicyAssignment'.""", DeprecationWarning)
...
def get_policy_assignment(policy_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_assignment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getPolicyAssignment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getPolicyAssignment', __args__, opts=opts, typ=GetPolicyAssignmentResult).value
