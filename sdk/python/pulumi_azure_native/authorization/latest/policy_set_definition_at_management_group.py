...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:authorization:PolicySetDefinitionAtManagementGroup'.""", DeprecationWarning)
...
class PolicySetDefinitionAtManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""PolicySetDefinitionAtManagementGroup is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:authorization:PolicySetDefinitionAtManagementGroup'.""")
