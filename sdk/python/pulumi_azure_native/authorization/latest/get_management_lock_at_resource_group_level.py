...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getManagementLockAtResourceGroupLevel'.""", DeprecationWarning)
...
def get_management_lock_at_resource_group_level(lock_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_lock_at_resource_group_level is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getManagementLockAtResourceGroupLevel'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getManagementLockAtResourceGroupLevel', __args__, opts=opts, typ=GetManagementLockAtResourceGroupLevelResult).value
