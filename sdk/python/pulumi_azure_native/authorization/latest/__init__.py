...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:authorization/latest:ManagementLockAtResourceGroupLevel":
                return ManagementLockAtResourceGroupLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:ManagementLockAtResourceLevel":
                return ManagementLockAtResourceLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:ManagementLockAtSubscriptionLevel":
                return ManagementLockAtSubscriptionLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:ManagementLockByScope":
                return ManagementLockByScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:PolicyAssignment":
                return PolicyAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:PolicyDefinition":
                return PolicyDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:PolicyDefinitionAtManagementGroup":
                return PolicyDefinitionAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:PolicySetDefinition":
                return PolicySetDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:PolicySetDefinitionAtManagementGroup":
                return PolicySetDefinitionAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:RoleAssignment":
                return RoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/latest:RoleDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "authorization/latest", _module_instance)
