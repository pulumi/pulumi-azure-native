...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getPolicyDefinition'.""", DeprecationWarning)
...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
