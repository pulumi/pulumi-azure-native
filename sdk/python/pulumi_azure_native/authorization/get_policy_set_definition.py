...
def get_policy_set_definition(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_set_definition_name: The name of the policy set definition to get.
    """
    __args__ = dict()
    __args__['expand'] = expand
    __args__['policySetDefinitionName'] = policy_set_definition_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization:getPolicySetDefinition', __args__, opts=opts, typ=GetPolicySetDefinitionResult).value
...
def get_policy_set_definition_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
