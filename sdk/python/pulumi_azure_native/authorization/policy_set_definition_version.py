...
@pulumi.type_token("azure-native:authorization:PolicySetDefinitionVersion")
class PolicySetDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20230401:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20240501:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20250101:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20250301:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20251101:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20251201preview:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260101preview:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260601:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260701:PolicySetDefinitionVersion")])
