...
def list_policy_definition_version_all(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPolicyDefinitionVersionAllResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20230401:listPolicyDefinitionVersionAll', __args__, opts=opts, typ=ListPolicyDefinitionVersionAllResult).value
