...
class PolicyDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20240501:PolicyDefinitionVersion")])
