...
def get_policy_definition_version(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20230401:getPolicyDefinitionVersion', __args__, opts=opts, typ=GetPolicyDefinitionVersionResult).value
...
def get_policy_definition_version_output(policy_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['policyDefinitionVersion'] = policy_definition_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20230401:getPolicyDefinitionVersion', __args__, opts=opts, typ=GetPolicyDefinitionVersionResult)
