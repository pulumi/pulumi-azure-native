...
class AccessReviewScheduleDefinitionById(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20210701preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-nextgen:authorization:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-nextgen:authorization/v20180501preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-native:authorization/v20210301preview:AccessReviewScheduleDefinitionById"), pulumi.Alias(type_="azure-nextgen:authorization/v20210301preview:AccessReviewScheduleDefinitionById")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessReviewScheduleDefinitionById, __self__).__init__(
            'azure-native:authorization/v20210701preview:AccessReviewScheduleDefinitionById',
            resource_name,
            __props__,
            opts)
