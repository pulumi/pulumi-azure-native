...
warnings.warn("""azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_access_review_schedule_definition_by_id(schedule_definition_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_access_review_schedule_definition_by_id is deprecated: azure-native:authorization/v20180501preview:AccessReviewScheduleDefinitionById is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20211201preview:AccessReviewScheduleDefinitionById to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['scheduleDefinitionId'] = schedule_definition_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20180501preview:getAccessReviewScheduleDefinitionById', __args__, opts=opts, typ=GetAccessReviewScheduleDefinitionByIdResult).value
