...
class ScopeAccessReviewHistoryDefinitionByIdArgs:
    def __init__(__self__, *,
        ...
        """
        ScopeAccessReviewHistoryDefinitionByIdArgs._configure(
    ...
    def _configure(
        ...
        if 'historyDefinitionId' in kwargs:
            history_definition_id = kwargs['historyDefinitionId']
        if 'numberOfOccurrences' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ScopeAccessReviewHistoryDefinitionByIdArgs._configure(_setter, **kwargs)
