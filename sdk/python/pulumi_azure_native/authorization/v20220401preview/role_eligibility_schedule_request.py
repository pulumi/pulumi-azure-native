...
class RoleEligibilityScheduleRequest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20201001:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization:RoleEligibilityScheduleRequest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleEligibilityScheduleRequest, __self__).__init__(
            'azure-native:authorization/v20220401preview:RoleEligibilityScheduleRequest',
            resource_name,
            __props__,
            opts)
