...
def get_variable(variable_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20241201preview:getVariable', __args__, opts=opts, typ=GetVariableResult).value
...
def get_variable_output(variable_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20241201preview:getVariable', __args__, opts=opts, typ=GetVariableResult)
