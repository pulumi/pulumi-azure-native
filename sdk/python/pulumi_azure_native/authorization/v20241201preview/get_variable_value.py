...
def get_variable_value(variable_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20241201preview:getVariableValue', __args__, opts=opts, typ=GetVariableValueResult).value
...
def get_variable_value_output(variable_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20241201preview:getVariableValue', __args__, opts=opts, typ=GetVariableValueResult)
