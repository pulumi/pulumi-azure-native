...
class VariableValueAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:VariableValueAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization:VariableValueAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VariableValueAtManagementGroup, __self__).__init__(
            'azure-native:authorization/v20241201preview:VariableValueAtManagementGroup',
            resource_name,
            __props__,
            opts)
