...
class VariableAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:VariableAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization:VariableAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VariableAtManagementGroup, __self__).__init__(
            'azure-native:authorization/v20241201preview:VariableAtManagementGroup',
            resource_name,
            __props__,
            opts)
