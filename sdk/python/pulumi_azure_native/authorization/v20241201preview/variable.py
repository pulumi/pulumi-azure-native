...
class Variable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20220801preview:Variable"), pulumi.Alias(type_="azure-native:authorization:Variable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Variable, __self__).__init__(
            'azure-native:authorization/v20241201preview:Variable',
            resource_name,
            __props__,
            opts)
