...
def get_policy_exemption(policy_exemption_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20241201preview:getPolicyExemption', __args__, opts=opts, typ=GetPolicyExemptionResult).value
...
def get_policy_exemption_output(policy_exemption_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20241201preview:getPolicyExemption', __args__, opts=opts, typ=GetPolicyExemptionResult)
