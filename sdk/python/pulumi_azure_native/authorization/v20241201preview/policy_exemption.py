...
class PolicyExemption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20200701preview:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization/v20220701preview:PolicyExemption"), pulumi.Alias(type_="azure-native:authorization:PolicyExemption")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyExemption, __self__).__init__(
            'azure-native:authorization/v20241201preview:PolicyExemption',
            resource_name,
            __props__,
            opts)
