...
warnings.warn("""azure-native:authorization/v20180301:PolicySetDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_policy_set_definition(policy_set_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_set_definition is deprecated: azure-native:authorization/v20180301:PolicySetDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:authorization/v20190601:PolicySetDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
