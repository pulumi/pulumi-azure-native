...
def get_policy_definition(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20180301:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult).value
...
def get_policy_definition_output(policy_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20180301:getPolicyDefinition', __args__, opts=opts, typ=GetPolicyDefinitionResult)
