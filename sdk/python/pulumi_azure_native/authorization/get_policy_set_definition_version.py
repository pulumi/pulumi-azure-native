...
def get_policy_set_definition_version(expand: Optional[builtins.str] = None,
...
def get_policy_set_definition_version_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
