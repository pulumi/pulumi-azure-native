...
def get_policy_set_definition_version(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_set_definition_name: The name of the policy set definition.
    """
    __args__ = dict()
...
def get_policy_set_definition_version_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
