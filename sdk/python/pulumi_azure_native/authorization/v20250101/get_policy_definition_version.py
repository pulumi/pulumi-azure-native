...
def get_policy_definition_version(policy_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250101:getPolicyDefinitionVersion', __args__, opts=opts, typ=GetPolicyDefinitionVersionResult).value
...
def get_policy_definition_version_output(policy_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250101:getPolicyDefinitionVersion', __args__, opts=opts, typ=GetPolicyDefinitionVersionResult)
