...
def get_policy_set_definition_version(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250101:getPolicySetDefinitionVersion', __args__, opts=opts, typ=GetPolicySetDefinitionVersionResult).value
...
def get_policy_set_definition_version_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250101:getPolicySetDefinitionVersion', __args__, opts=opts, typ=GetPolicySetDefinitionVersionResult)
