...
def list_policy_set_definition_version_all(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPolicySetDefinitionVersionAllResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20250101:listPolicySetDefinitionVersionAll', __args__, opts=opts, typ=ListPolicySetDefinitionVersionAllResult).value
...
def list_policy_set_definition_version_all_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListPolicySetDefinitionVersionAllResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20250101:listPolicySetDefinitionVersionAll', __args__, opts=opts, typ=ListPolicySetDefinitionVersionAllResult)
