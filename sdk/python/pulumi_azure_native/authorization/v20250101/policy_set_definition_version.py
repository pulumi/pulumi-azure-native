...
__all__ = ['PolicySetDefinitionVersionArgs', 'PolicySetDefinitionVersion']
...
class PolicySetDefinitionVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PolicySetDefinitionVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PolicySetDefinitionVersionArgs.__new__(PolicySetDefinitionVersionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20230401:PolicySetDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20240501:PolicySetDefinitionVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicySetDefinitionVersion, __self__).__init__(
            'azure-native:authorization/v20250101:PolicySetDefinitionVersion',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PolicySetDefinitionVersion':
        """
        ...
        return PolicySetDefinitionVersion(resource_name, opts=opts, __props__=__props__)
