...
class ManagementLockAtSubscriptionLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-nextgen:authorization:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization/latest:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-nextgen:authorization/latest:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-native:authorization/v20150101:ManagementLockAtSubscriptionLevel"), pulumi.Alias(type_="azure-nextgen:authorization/v20150101:ManagementLockAtSubscriptionLevel")])
