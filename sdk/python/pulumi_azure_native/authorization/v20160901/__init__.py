...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:authorization/v20160901:ManagementLockAtResourceGroupLevel":
                return ManagementLockAtResourceGroupLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20160901:ManagementLockAtResourceLevel":
                return ManagementLockAtResourceLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20160901:ManagementLockAtSubscriptionLevel":
                return ManagementLockAtSubscriptionLevel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20160901:ManagementLockByScope":
    ...
    pulumi.runtime.register_resource_module("azure-native", "authorization/v20160901", _module_instance)
