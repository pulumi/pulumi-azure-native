...
class PolicyDefinitionVersionArgs:
    def __init__(__self__, *,
                 policy_definition_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] policy_definition_name: The name of the policy definition.
        ...
        :param pulumi.Input[builtins.str] policy_definition_version: The policy definition version.  The format is x.y.z where x is the major version number, y is the minor version number, and z is the patch number
    ...
    def policy_definition_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def policy_definition_name(self, value: pulumi.Input[builtins.str]):
    ...
    def policy_definition_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_definition_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyDefinitionVersion(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:authorization:PolicyDefinitionVersion"
