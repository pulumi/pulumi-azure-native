...
class PolicyDefinitionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20230401:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20240501:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20250101:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20250301:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20251101:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20251201preview:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260101preview:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260601:PolicyDefinitionVersion"), pulumi.Alias(type_="azure-native:authorization/v20260701:PolicyDefinitionVersion")])
