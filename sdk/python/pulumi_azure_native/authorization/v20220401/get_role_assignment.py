...
def get_role_assignment(role_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/v20220401:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
...
def get_role_assignment_output(role_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['tenantId'] = tenant_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization/v20220401:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult)
