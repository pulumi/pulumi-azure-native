...
warnings.warn("""azure-native:authorization/v20220401:RoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220501preview:RoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_role_definition(role_definition_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_role_definition is deprecated: azure-native:authorization/v20220401:RoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:authorization/v20220501preview:RoleDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
