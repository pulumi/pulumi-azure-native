...
def get_role_eligibility_schedule_request(role_eligibility_schedule_request_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization:getRoleEligibilityScheduleRequest', __args__, opts=opts, typ=GetRoleEligibilityScheduleRequestResult).value
...
def get_role_eligibility_schedule_request_output(role_eligibility_schedule_request_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:authorization:getRoleEligibilityScheduleRequest', __args__, opts=opts, typ=GetRoleEligibilityScheduleRequestResult)
