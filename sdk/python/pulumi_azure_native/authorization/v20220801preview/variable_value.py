...
class VariableValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20241201preview:VariableValue"), pulumi.Alias(type_="azure-native:authorization:VariableValue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VariableValue, __self__).__init__(
            'azure-native:authorization/v20220801preview:VariableValue',
            resource_name,
            __props__,
            opts)
