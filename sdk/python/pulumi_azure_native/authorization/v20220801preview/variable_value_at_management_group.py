...
class VariableValueAtManagementGroupArgs:
    def __init__(__self__, *,
        ...
        """
        VariableValueAtManagementGroupArgs._configure(
    ...
    def _configure(
             ...
             values: Optional[pulumi.Input[Sequence[pulumi.Input['PolicyVariableValueColumnValueArgs']]]] = None,
        ...
        if variable_value_name is None and 'variableValueName' in kwargs:
            variable_value_name = kwargs['variableValueName']

        _setter("management_group_id", management_group_id)
        _setter("values", values)
        _setter("variable_name", variable_name)
        if variable_value_name is not None:
            _setter("variable_value_name", variable_value_name)
...
class VariableValueAtManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VariableValueAtManagementGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            VariableValueAtManagementGroupArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VariableValueAtManagementGroupArgs.__new__(VariableValueAtManagementGroupArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization:VariableValueAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VariableValueAtManagementGroup, __self__).__init__(
            'azure-native:authorization/v20220801preview:VariableValueAtManagementGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VariableValueAtManagementGroup':
        """
        ...
        return VariableValueAtManagementGroup(resource_name, opts=opts, __props__=__props__)
