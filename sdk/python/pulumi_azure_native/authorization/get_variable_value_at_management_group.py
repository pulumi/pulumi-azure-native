...
def get_variable_value_at_management_group(management_group_id: Optional[_builtins.str] = None,
                                           variable_name: Optional[_builtins.str] = None,
                                           variable_value_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str management_group_id: The ID of the management group.
    :param _builtins.str variable_name: The name of the variable to operate on.
    :param _builtins.str variable_value_name: The name of the variable value to operate on.
    """
    __args__ = dict()
...
def get_variable_value_at_management_group_output(management_group_id: Optional[pulumi.Input[_builtins.str]] = None,
