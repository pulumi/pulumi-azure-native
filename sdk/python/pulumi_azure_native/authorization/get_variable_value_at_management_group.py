...
def get_variable_value_at_management_group(management_group_id: Optional[builtins.str] = None,
...
def get_variable_value_at_management_group_output(management_group_id: Optional[pulumi.Input[builtins.str]] = None,
