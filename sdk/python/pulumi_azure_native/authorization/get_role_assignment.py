...
class GetRoleAssignmentResult:
    ...
    def delegated_managed_identity_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_role_assignment(role_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str role_assignment_name: The name of the role assignment. It can be any valid GUID.
    :param builtins.str scope: The scope of the operation or resource. Valid scopes are: subscription (format: '/subscriptions/{subscriptionId}'), resource group (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}', or resource (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/[{parentResourcePath}/]{resourceType}/{resourceName}'
    :param builtins.str tenant_id: Tenant ID for cross-tenant request
    """
    __args__ = dict()
...
def get_role_assignment_output(role_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
