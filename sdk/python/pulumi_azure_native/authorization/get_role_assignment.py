...
def get_role_assignment(role_assignment_name: Optional[_builtins.str] = None,
...
def get_role_assignment_output(role_assignment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
