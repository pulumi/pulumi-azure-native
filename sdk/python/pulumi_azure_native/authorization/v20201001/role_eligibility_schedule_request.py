...
__all__ = ['RoleEligibilityScheduleRequestArgs', 'RoleEligibilityScheduleRequest']

@pulumi.input_type
class RoleEligibilityScheduleRequestArgs:
...
class RoleEligibilityScheduleRequest(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RoleEligibilityScheduleRequestArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Role Eligibility schedule request

        :param str resource_name: The name of the resource.
        :param RoleEligibilityScheduleRequestArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RoleEligibilityScheduleRequestArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RoleEligibilityScheduleRequestArgs.__new__(RoleEligibilityScheduleRequestArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:authorization/v20201001preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20220401preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20240201preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization/v20240901preview:RoleEligibilityScheduleRequest"), pulumi.Alias(type_="azure-native:authorization:RoleEligibilityScheduleRequest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleEligibilityScheduleRequest, __self__).__init__(
            'azure-native:authorization/v20201001:RoleEligibilityScheduleRequest',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'RoleEligibilityScheduleRequest':
        """
        ...
        __props__.__dict__["type"] = None
        return RoleEligibilityScheduleRequest(resource_name, opts=opts, __props__=__props__)
