...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:batch/v20190801:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20190801:ApplicationPackage":
                return ApplicationPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20190801:BatchAccount":
                return BatchAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20190801:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20190801:Pool":
    ...
    pulumi.runtime.register_resource_module("azure-native", "batch/v20190801", _module_instance)
