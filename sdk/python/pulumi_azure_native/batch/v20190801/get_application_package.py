...
def get_application_package(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_package is deprecated: Version v20190801 will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
