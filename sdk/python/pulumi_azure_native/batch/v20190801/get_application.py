...
azure-native:batch/v20190801:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20221001:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version 2019-08-01 will be removed in v2 of the provider.
azure-native:batch/v20190801:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20221001:Application to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20190801:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
