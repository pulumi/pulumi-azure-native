...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_size: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Pool is deprecated: azure-native:batch/v20210101:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:Pool to guarantee forwards compatibility.""")
