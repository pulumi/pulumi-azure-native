...
class ApplicationPackage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_package = azure_native.batch.v20210101.ApplicationPackage("applicationPackage",
