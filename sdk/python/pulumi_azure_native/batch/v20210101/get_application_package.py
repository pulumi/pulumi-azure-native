...
def get_application_package(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20210101:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult).value
...
def get_application_package_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch/v20210101:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult)
