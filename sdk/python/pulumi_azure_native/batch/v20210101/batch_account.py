...
class BatchAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        batch_account = azure_native.batch.v20210101.BatchAccount("batchAccount",
            account_name="sampleacct",
            auto_storage=azure_native.batch.v20210101.AutoStoragePropertiesResponseArgs(
            ...
            key_vault_reference=azure_native.batch.v20210101.KeyVaultReferenceResponseArgs(
                id="/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample",
                url="http://sample.vault.azure.net/",
            ),
            location="japaneast",
            pool_allocation_mode=azure_native.batch/v20210101.PoolAllocationMode.USER_SUBSCRIPTION,
        ...
        batch_account = azure_native.batch.v20210101.BatchAccount("batchAccount",
            ...
            identity=azure_native.batch.v20210101.BatchAccountIdentityResponseArgs(
                type=azure_native.batch/v20210101.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="japaneast",
            resource_group_name="default-azurebatch-japaneast")
        ...
        batch_account = azure_native.batch.v20210101.BatchAccount("batchAccount",
            ...
            identity=azure_native.batch.v20210101.BatchAccountIdentityResponseArgs(
                type=azure_native.batch/v20210101.ResourceIdentityType.USER_ASSIGNED,
        ...
        batch_account = azure_native.batch.v20210101.BatchAccount("batchAccount",
            ...
            location="japaneast",
            public_network_access=azure_native.batch/v20210101.PublicNetworkAccessType.DISABLED,
            resource_group_name="default-azurebatch-japaneast")
