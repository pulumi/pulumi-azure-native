...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:batch/v20210601:Certificate"), pulumi.Alias(type_="azure-native:batch/v20220101:Certificate"), pulumi.Alias(type_="azure-native:batch/v20220601:Certificate")])
