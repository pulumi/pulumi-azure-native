...
class BatchAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        batch_account = azure_native.batch.v20170101.BatchAccount("batchAccount",
            account_name="sampleacct",
            auto_storage=azure_native.batch.v20170101.AutoStoragePropertiesResponseArgs(
            ...
            key_vault_reference=azure_native.batch.v20170101.KeyVaultReferenceResponseArgs(
                id="/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample",
                url="http://sample.vault.azure.net/",
            ),
            location="japaneast",
            pool_allocation_mode=azure_native.batch/v20170101.PoolAllocationMode.USER_SUBSCRIPTION,
