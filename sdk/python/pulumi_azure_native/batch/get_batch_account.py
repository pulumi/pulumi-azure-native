...
def get_batch_account(account_name: Optional[_builtins.str] = None,
...
def get_batch_account_output(account_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
