...
class GetBatchAccountResult:
    ...
    def active_job_and_job_schedule_quota(self) -> builtins.int:
        return pulumi.get(self, "active_job_and_job_schedule_quota")

    @property
    @pulumi.getter(name="allowedAuthenticationModes")
    def allowed_authentication_modes(self) -> Sequence[builtins.str]:
        """
    ...
    def dedicated_core_quota(self) -> builtins.int:
        """
    ...
    def dedicated_core_quota_per_vm_family_enforced(self) -> builtins.bool:
        """
    ...
    def low_priority_core_quota(self) -> builtins.int:
        """
        For accounts with PoolAllocationMode set to UserSubscription, quota is managed on the subscription so this value is not returned.
        """
    ...
    def node_management_endpoint(self) -> builtins.str:
        """
    ...
    def pool_quota(self) -> builtins.int:
...
def get_batch_account(account_name: Optional[builtins.str] = None,
...
def get_batch_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch:getBatchAccount', __args__, opts=opts, typ=GetBatchAccountResult)
