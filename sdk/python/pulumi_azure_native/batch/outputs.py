...
class AutomaticOSUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool use_rolling_upgrade_policy: Indicates whether rolling upgrade policy should be used during Auto OS Upgrade. Auto OS Upgrade will fallback to the default policy if no policy is defined on the VMSS.
        """
...
class AzureBlobFileSystemConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str account_key: This property is mutually exclusive with both sasKey and identity; exactly one must be specified.
        :param _builtins.str blobfuse_options: These are 'net use' options in Windows and 'mount' options in Linux.
        ...
        :param _builtins.str sas_key: This property is mutually exclusive with both accountKey and identity; exactly one must be specified.
        """
...
class CertificateReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 id: _builtins.str,
                 store_location: Optional[_builtins.str] = None,
        ...
        :param Sequence[_builtins.str] visibility: Which user accounts on the compute node should have access to the private data of the certificate.
        """
        pulumi.set(__self__, "id", id)
...
class ContainerRegistryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str user_name: The user name to log into the registry server.
        """
        if identity_reference is not None:
            pulumi.set(__self__, "identity_reference", identity_reference)
...
class DataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str storage_account_type: If omitted, the default is "Standard_LRS". Values are:
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str publisher: For example, Canonical or MicrosoftWindowsServer.
        :param _builtins.str shared_gallery_image_id: This property is mutually exclusive with other properties and can be fetched from shared gallery image GET call.
        :param _builtins.str sku: For example, 18.04-LTS or 2022-datacenter.
        :param _builtins.str version: A value of 'latest' can be specified to select the latest version of an image. If omitted, the default is 'latest'.
        """
...
class InboundNatPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name must be unique within a Batch pool, can contain letters, numbers, underscores, periods, and hyphens. Names must start with a letter or number, must end with a letter, number, or underscore, and cannot exceed 77 characters.  If any invalid values are provided the request fails with HTTP status code 400.
...
class NetworkSecurityGroupRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] source_port_ranges: Valid values are '*' (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. 100-200). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be *.
        """
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: The provisioning state of the private endpoint connection.
...
class PublicIPAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ip_address_ids: Optional[Sequence[_builtins.str]] = None,
...
class ResizeOperationStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 node_deallocation_option: Optional[_builtins.str] = None,
                 resize_timeout: Optional[_builtins.str] = None,
        ...
        :param _builtins.str node_deallocation_option: The default value is requeue.
        ...
        :param _builtins.int target_dedicated_nodes: The desired number of dedicated compute nodes in the pool.
        :param _builtins.int target_low_priority_nodes: The desired number of Spot/low-priority compute nodes in the pool.
        """
    ...
    def node_deallocation_option(self) -> Optional[_builtins.str]:
        """
...
class ResourceFileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str file_path: If the httpUrl property is specified, the filePath is required and describes the path which the file will be downloaded to, including the filename. Otherwise, if the autoStorageContainerName or storageContainerUrl property is specified, filePath is optional and is the directory to download the files to. In the case where filePath is used as a directory, any directory structure already associated with the input data will be retained in full and appended to the specified filePath directory. The specified relative path cannot break out of the task's working directory (for example by using '..').
        :param _builtins.str http_url: The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified. If the URL points to Azure Blob Storage, it must be readable from compute nodes. There are three ways to get such a URL for a blob in Azure storage: include a Shared Access Signature (SAS) granting read permissions on the blob, use a managed identity with read permission, or set the ACL for the blob or its container to allow public access.
        :param 'ComputeNodeIdentityReferenceResponse' identity_reference: The reference to a user assigned identity associated with the Batch pool which a compute node will use.
        :param _builtins.str storage_container_url: The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified. This URL must be readable and listable from compute nodes. There are three ways to get such a URL for a container in Azure storage: include a Shared Access Signature (SAS) granting read and list permissions on the container, use a managed identity with read and list permissions, or set the ACL for the container to allow public access.
        """
...
class StartTaskResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_task_retry_count: Optional[_builtins.int] = None,
        ...
        :param _builtins.int max_task_retry_count: The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit. Default is 0
        :param Sequence['ResourceFileResponse'] resource_files: A list of files that the Batch service will download to the compute node before running the command line.
        :param 'UserIdentityResponse' user_identity: If omitted, the task runs as a non-administrative user unique to the task.
        :param _builtins.bool wait_for_success: If true and the start task fails on a compute node, the Batch service retries the start task up to its maximum retry count (maxTaskRetryCount). If the task has still not completed successfully after all retries, then the Batch service marks the compute node unusable, and will not schedule tasks to it. This condition can be detected via the node state and scheduling error detail. If false, the Batch service will not wait for the start task to complete. In this case, other tasks can start executing on the compute node while the start task is still running; and even if the start task fails, new tasks will continue to be scheduled on the node. The default is true.
        """
...
class TaskContainerSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_run_options: Optional[_builtins.str] = None,
        ...
        :param _builtins.str working_directory: A flag to indicate where the container task working directory is. The default is 'taskWorkingDirectory'.
        """
...
class VirtualMachineConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 node_agent_sku_id: _builtins.str,
        ...
        :param _builtins.str license_type: This only applies to images that contain the Windows operating system, and should only be used when you hold valid on-premises licenses for the nodes which will be deployed. If omitted, no on-premises licensing discount is applied. Values are:
