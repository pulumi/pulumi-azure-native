...
warnings.warn("""azure-native:batch/v20210601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:Pool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: azure-native:batch/v20210601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:Pool to guarantee forwards compatibility.""")
    __args__ = dict()
