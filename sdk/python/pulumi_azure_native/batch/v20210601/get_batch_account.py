...
warnings.warn("""azure-native:batch/v20210601:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_batch_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_account is deprecated: azure-native:batch/v20210601:BatchAccount is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.""")
    __args__ = dict()
