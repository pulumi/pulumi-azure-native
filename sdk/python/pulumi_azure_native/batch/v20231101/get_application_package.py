...
def get_application_package(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20231101:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult).value
...
def get_application_package_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['versionName'] = version_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch/v20231101:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult)
