...
class BatchAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: A name for the Batch account which must be unique within the region. Batch account names must be between 3 and 24 characters in length and must use only numbers and lowercase letters. This name is used as part of the DNS name that is used to access the Batch service in the region in which the account is created. For example: http://accountname.region.batch.azure.com/.
        ...
        :param pulumi.Input[builtins.str] location: The region in which to create the account.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The user-specified tags associated with the account.
        """
...
class BatchAccount(pulumi.CustomResource):
    ...
    def active_job_and_job_schedule_quota(self) -> pulumi.Output[builtins.int]:
    ...
    def dedicated_core_quota(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def dedicated_core_quota_per_vm_family_enforced(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def low_priority_core_quota(self) -> pulumi.Output[builtins.int]:
        """
        For accounts with PoolAllocationMode set to UserSubscription, quota is managed on the subscription so this value is not returned.
        """
    ...
    def node_management_endpoint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="poolAllocationMode")
    def pool_allocation_mode(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def pool_quota(self) -> pulumi.Output[builtins.int]:
