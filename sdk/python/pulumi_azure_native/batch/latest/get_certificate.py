...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getCertificate'.""", DeprecationWarning)
...
def get_certificate(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getCertificate'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/latest:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
