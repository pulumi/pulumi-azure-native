...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:listBatchAccountKeys'.""", DeprecationWarning)
...
def list_batch_account_keys(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_batch_account_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:listBatchAccountKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/latest:listBatchAccountKeys', __args__, opts=opts, typ=ListBatchAccountKeysResult).value
