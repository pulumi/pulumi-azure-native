...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getPool'.""", DeprecationWarning)
...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getPool'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/latest:getPool', __args__, opts=opts, typ=GetPoolResult).value
