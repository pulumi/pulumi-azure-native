...
class ApplicationPackageReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] version: If this is omitted, and no default version is specified for this application, the request fails with the error code InvalidApplicationPackageReferences. If you are calling the REST API directly, the HTTP status code is 409.
        """
...
class AutoScaleSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] evaluation_interval: If omitted, the default value is 15 minutes (PT15M).
        """
...
class AutoStorageBasePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The properties related to the auto-storage account.
        :param pulumi.Input[builtins.str] storage_account_id: The resource ID of the storage account to be used for auto-storage account.
...
class AutomaticOSUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration parameters used for performing automatic OS upgrade.
        :param pulumi.Input[builtins.bool] disable_automatic_rollback: Whether OS image rollback feature should be disabled.
        :param pulumi.Input[builtins.bool] enable_automatic_os_upgrade: Indicates whether OS upgrades should automatically be applied to scale set instances in a rolling fashion when a newer version of the OS image becomes available. <br /><br /> If this is set to true for Windows based pools, [WindowsConfiguration.enableAutomaticUpdates](https://learn.microsoft.com/rest/api/batchmanagement/pool/create?tabs=HTTP#windowsconfiguration) cannot be set to true.
        :param pulumi.Input[builtins.bool] os_rolling_upgrade_deferral: Defer OS upgrades on the TVMs if they are running tasks.
        :param pulumi.Input[builtins.bool] use_rolling_upgrade_policy: Indicates whether rolling upgrade policy should be used during Auto OS Upgrade. Auto OS Upgrade will fallback to the default policy if no policy is defined on the VMSS.
        """
...
class AzureBlobFileSystemConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] relative_mount_path: All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable.
        :param pulumi.Input[builtins.str] account_key: This property is mutually exclusive with both sasKey and identity; exactly one must be specified.
        :param pulumi.Input[builtins.str] blobfuse_options: These are 'net use' options in Windows and 'mount' options in Linux.
        ...
        :param pulumi.Input[builtins.str] sas_key: This property is mutually exclusive with both accountKey and identity; exactly one must be specified.
        """
...
class AzureFileShareConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] azure_file_url: This is of the form 'https://{account}.file.core.windows.net/'.
        :param pulumi.Input[builtins.str] relative_mount_path: All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable.
        :param pulumi.Input[builtins.str] mount_options: These are 'net use' options in Windows and 'mount' options in Linux.
        """
        pulumi.set(__self__, "account_key", account_key)
        pulumi.set(__self__, "account_name", account_name)
...
class BatchAccountIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['UserAssignedIdentitiesArgs']]] user_assigned_identities: The list of user identities associated with the Batch account.
        """
...
class BatchPoolIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['UserAssignedIdentitiesArgs']]] user_assigned_identities: The list of user identities associated with the Batch pool.
        """
        pulumi.set(__self__, "type", type)
        if user_assigned_identities is not None:
            pulumi.set(__self__, "user_assigned_identities", user_assigned_identities)
...
class CertificateReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] store_name: This property is applicable only for pools configured with Windows compute nodes. Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My.
        """
        pulumi.set(__self__, "id", id)
...
class ComputeNodeIdentityReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        The reference to a user assigned identity associated with the Batch pool which a compute node will use.
        :param pulumi.Input[builtins.str] resource_id: The ARM resource id of the user assigned identity.
        """
...
if not MYPY:
    class ContainerConfigurationArgsDict(TypedDict):
        type: pulumi.Input[Union[builtins.str, 'ContainerType']]
...
class ContainerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_image_names: This is the full image reference, as would be specified to "docker pull". An image will be sourced from the default Docker registry unless the image is fully qualified with an alternative registry.
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'ContainerType']]:
        return pulumi.get(self, "type")

    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'ContainerType']]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class ContainerHostBatchBindMountEntryArgsDict(TypedDict):
        ...
        """
        source: NotRequired[pulumi.Input[Union[builtins.str, 'ContainerHostDataPath']]]
elif False:
...
class ContainerHostBatchBindMountEntryArgs:
    def __init__(__self__, *,
                 ...
                 source: Optional[pulumi.Input[Union[builtins.str, 'ContainerHostDataPath']]] = None):
        """
        :param pulumi.Input[builtins.bool] is_read_only: For Linux, if you mount this path as a read/write mode, this does not mean that all users in container have the read/write access for the path, it depends on the access in host VM. If this path is mounted read-only, all users within the container will not be able to modify the path.
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> Optional[pulumi.Input[Union[builtins.str, 'ContainerHostDataPath']]]:
        return pulumi.get(self, "source")

    @source.setter
    def source(self, value: Optional[pulumi.Input[Union[builtins.str, 'ContainerHostDataPath']]]):
        pulumi.set(self, "source", value)
...
if not MYPY:
    class ContainerRegistryArgsDict(TypedDict):
        ...
        registry_server: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ContainerRegistryArgs:
    def __init__(__self__, *,
                 ...
                 registry_server: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] registry_server: If omitted, the default is "docker.io".
        """
        if identity_reference is not None:
            pulumi.set(__self__, "identity_reference", identity_reference)
    ...
    def registry_server(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If omitted, the default is "docker.io".
        """
    ...
    def registry_server(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FixedScaleSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resize_timeout: The default value is 15 minutes. Timeout values use ISO 8601 format. For example, use PT10M for 10 minutes. The minimum value is 5 minutes. If you specify a value less than 5 minutes, the Batch service rejects the request with an error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request).
        :param pulumi.Input[builtins.int] target_dedicated_nodes: At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
        :param pulumi.Input[builtins.int] target_low_priority_nodes: At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.
        """
...
class IPRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: IPv4 address, or IPv4 address range in CIDR format.
        """
...
class ImageReferenceArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] community_gallery_image_id: This property is mutually exclusive with other properties and can be fetched from community gallery image GET call.
        :param pulumi.Input[builtins.str] id: This property is mutually exclusive with other properties. The Azure Compute Gallery Image must have replicas in the same region as the Azure Batch account. For information about the firewall settings for the Batch node agent to communicate with the Batch service see https://learn.microsoft.com/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration.
        :param pulumi.Input[builtins.str] offer: For example, UbuntuServer or WindowsServer.
        :param pulumi.Input[builtins.str] publisher: For example, Canonical or MicrosoftWindowsServer.
        :param pulumi.Input[builtins.str] shared_gallery_image_id: This property is mutually exclusive with other properties and can be fetched from shared gallery image GET call.
        :param pulumi.Input[builtins.str] sku: For example, 18.04-LTS or 2022-datacenter.
        :param pulumi.Input[builtins.str] version: A value of 'latest' can be specified to select the latest version of an image. If omitted, the default is 'latest'.
        """
...
if not MYPY:
    class InboundNatPoolArgsDict(TypedDict):
        ...
        """
        frontend_port_range_end: pulumi.Input[builtins.int]
        """
        Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved by the Batch service. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.
        """
        frontend_port_range_start: pulumi.Input[builtins.int]
        """
...
class InboundNatPoolArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] backend_port: This must be unique within a Batch pool. Acceptable values are between 1 and 65535 except for 29876 and 29877 as these are reserved. If any reserved values are provided the request fails with HTTP status code 400.
        :param pulumi.Input[builtins.int] frontend_port_range_end: Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved by the Batch service. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.
        ...
        :param pulumi.Input[builtins.str] name: The name must be unique within a Batch pool, can contain letters, numbers, underscores, periods, and hyphens. Names must start with a letter or number, must end with a letter, number, or underscore, and cannot exceed 77 characters.  If any invalid values are provided the request fails with HTTP status code 400.
    ...
    def frontend_port_range_end(self) -> pulumi.Input[builtins.int]:
        """
        Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved by the Batch service. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.
        """
    ...
    def frontend_port_range_end(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "frontend_port_range_end", value)

    @property
    @pulumi.getter(name="frontendPortRangeStart")
    def frontend_port_range_start(self) -> pulumi.Input[builtins.int]:
        """
        Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.
        """
    ...
    def frontend_port_range_start(self, value: pulumi.Input[builtins.int]):
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        KeyVault configuration when using an encryption KeySource of Microsoft.KeyVault.
        :param pulumi.Input[builtins.str] key_identifier: Full path to the secret with or without version. Example https://mykeyvault.vault.azure.net/keys/testkey/6e34a81fef704045975661e297a4c053. or https://mykeyvault.vault.azure.net/keys/testkey. To be usable the following prerequisites must be met:
...
class KeyVaultReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        Identifies the Azure key vault associated with a Batch account.
        :param pulumi.Input[builtins.str] id: The resource ID of the Azure key vault associated with the Batch account.
        :param pulumi.Input[builtins.str] url: The URL of the Azure key vault associated with the Batch account.
        """
        pulumi.set(__self__, "id", id)
...
class LinuxUserConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] gid: The uid and gid properties must be specified together or not at all. If not specified the underlying operating system picks the gid.
        :param pulumi.Input[builtins.str] ssh_private_key: The private key must not be password protected. The private key is used to automatically configure asymmetric-key based authentication for SSH between nodes in a Linux pool when the pool's enableInterNodeCommunication property is true (it is ignored if enableInterNodeCommunication is false). It does this by placing the key pair into the user's .ssh directory. If not specified, password-less SSH is not configured between nodes (no modification of the user's .ssh directory is done).
        :param pulumi.Input[builtins.int] uid: The uid and gid properties must be specified together or not at all. If not specified the underlying operating system picks the uid.
        """
        if gid is not None:
...
class NetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The network configuration for a pool.
        :param pulumi.Input[builtins.bool] enable_accelerated_networking: Accelerated networking enables single root I/O virtualization (SR-IOV) to a VM, which may lead to improved networking performance. For more details, see: https://learn.microsoft.com/azure/virtual-network/accelerated-networking-overview.
...
class NetworkSecurityGroupRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] priority: Priorities within a pool must be unique and are evaluated in order of priority. The lower the number the higher the priority. For example, rules could be specified with order numbers of 150, 250, and 350. The rule with the order number of 150 takes precedence over the rule that has an order of 250. Allowed priorities are 150 to 4096. If any reserved or duplicate values are provided the request fails with HTTP status code 400.
        :param pulumi.Input[builtins.str] source_address_prefix: Valid values are a single IP address (i.e. 10.10.10.10), IP subnet (i.e. 192.168.1.0/24), default tag, or * (for all addresses).  If any other values are provided the request fails with HTTP status code 400.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_port_ranges: Valid values are '*' (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. 100-200). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be *.
        """
...
if not MYPY:
    class PublicIPAddressConfigurationArgsDict(TypedDict):
        ...
        The public IP Address configuration of the networking configuration of a Pool.
        """
        ip_address_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PublicIPAddressConfigurationArgs:
    def __init__(__self__, *,
                 ip_address_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 provision: Optional[pulumi.Input['IPAddressProvisioningType']] = None):
        """
        The public IP Address configuration of the networking configuration of a Pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_address_ids: The number of IPs specified here limits the maximum size of the Pool - 100 dedicated nodes or 100 Spot/low-priority nodes can be allocated for each public IP. For example, a pool needing 250 dedicated VMs would need at least 3 public IPs specified. Each element of this collection is of the form: /subscriptions/{subscription}/resourceGroups/{group}/providers/Microsoft.Network/publicIPAddresses/{ip}.
    ...
    def ip_address_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The number of IPs specified here limits the maximum size of the Pool - 100 dedicated nodes or 100 Spot/low-priority nodes can be allocated for each public IP. For example, a pool needing 250 dedicated VMs would need at least 3 public IPs specified. Each element of this collection is of the form: /subscriptions/{subscription}/resourceGroups/{group}/providers/Microsoft.Network/publicIPAddresses/{ip}.
        """
    ...
    def ip_address_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ResourceFileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] auto_storage_container_name: The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified.
        :param pulumi.Input[builtins.str] blob_prefix: The property is valid only when autoStorageContainerName or storageContainerUrl is used. This prefix can be a partial filename or a subdirectory. If a prefix is not specified, all the files in the container will be downloaded.
        :param pulumi.Input[builtins.str] file_mode: This property applies only to files being downloaded to Linux compute nodes. It will be ignored if it is specified for a resourceFile which will be downloaded to a Windows node. If this property is not specified for a Linux node, then a default value of 0770 is applied to the file.
        :param pulumi.Input[builtins.str] file_path: If the httpUrl property is specified, the filePath is required and describes the path which the file will be downloaded to, including the filename. Otherwise, if the autoStorageContainerName or storageContainerUrl property is specified, filePath is optional and is the directory to download the files to. In the case where filePath is used as a directory, any directory structure already associated with the input data will be retained in full and appended to the specified filePath directory. The specified relative path cannot break out of the task's working directory (for example by using '..').
        :param pulumi.Input[builtins.str] http_url: The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified. If the URL points to Azure Blob Storage, it must be readable from compute nodes. There are three ways to get such a URL for a blob in Azure storage: include a Shared Access Signature (SAS) granting read permissions on the blob, use a managed identity with read permission, or set the ACL for the blob or its container to allow public access.
        :param pulumi.Input['ComputeNodeIdentityReferenceArgs'] identity_reference: The reference to a user assigned identity associated with the Batch pool which a compute node will use.
        :param pulumi.Input[builtins.str] storage_container_url: The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified. This URL must be readable and listable from compute nodes. There are three ways to get such a URL for a container in Azure storage: include a Shared Access Signature (SAS) granting read and list permissions on the container, use a managed identity with read and list permissions, or set the ACL for the container to allow public access.
        """
...
class RollingUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration parameters used while performing a rolling upgrade.
        :param pulumi.Input[builtins.bool] enable_cross_zone_upgrade: Allow VMSS to ignore AZ boundaries when constructing upgrade batches. Take into consideration the Update Domain and maxBatchInstancePercent to determine the batch size. If this field is not set, Azure Azure Batch will not set its default value. The value of enableCrossZoneUpgrade on the created VirtualMachineScaleSet will be decided by the default configurations on VirtualMachineScaleSet. This field is able to be set to true or false only when using NodePlacementConfiguration as Zonal.
...
class SecurityProfileArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies the security profile settings for the virtual machine or virtual machine scale set.
        :param pulumi.Input[builtins.bool] encryption_at_host: This property can be used by user in the request to enable or disable the Host Encryption for the virtual machine or virtual machine scale set. This will enable the encryption for all the disks including Resource/Temp disk at host itself.
...
if not MYPY:
    class StartTaskArgsDict(TypedDict):
        ...
        """
        command_line: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        max_task_retry_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class StartTaskArgs:
    def __init__(__self__, *,
                 ...
                 max_task_retry_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        In some cases the start task may be re-run even though the node was not rebooted. Due to this, start tasks should be idempotent and exit gracefully if the setup they're performing has already been done. Special care should be taken to avoid start tasks which create breakaway process or install/launch services from the start task working directory, as this will block Batch from being able to re-run the start task.
        :param pulumi.Input[builtins.str] command_line: The command line does not run under a shell, and therefore cannot take advantage of shell features such as environment variable expansion. If you want to take advantage of such features, you should invoke the shell in the command line, for example using "cmd /c MyCommand" in Windows or "/bin/sh -c MyCommand" in Linux. Required if any other properties of the startTask are specified.
        ...
        :param pulumi.Input[builtins.int] max_task_retry_count: The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit. Default is 0
        ...
        :param pulumi.Input[builtins.bool] wait_for_success: If true and the start task fails on a compute node, the Batch service retries the start task up to its maximum retry count (maxTaskRetryCount). If the task has still not completed successfully after all retries, then the Batch service marks the compute node unusable, and will not schedule tasks to it. This condition can be detected via the node state and scheduling error detail. If false, the Batch service will not wait for the start task to complete. In this case, other tasks can start executing on the compute node while the start task is still running; and even if the start task fails, new tasks will continue to be scheduled on the node. The default is true.
        """
    ...
    def max_task_retry_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit. Default is 0
        """
    ...
    def max_task_retry_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class TaskContainerSettingsArgsDict(TypedDict):
        ...
        """
        container_run_options: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TaskContainerSettingsArgs:
    def __init__(__self__, *,
                 ...
                 container_run_options: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] image_name: This is the full image reference, as would be specified to "docker pull". If no tag is provided as part of the image name, the tag ":latest" is used as a default.
        ...
        :param pulumi.Input[builtins.str] container_run_options: These additional options are supplied as arguments to the "docker create" command, in addition to those controlled by the Batch Service.
    ...
    def container_run_options(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        These additional options are supplied as arguments to the "docker create" command, in addition to those controlled by the Batch Service.
        """
    ...
    def container_run_options(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UefiSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] v_tpm_enabled: Specifies whether vTPM should be enabled on the virtual machine.
        """
...
class UserIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_name: The userName and autoUser properties are mutually exclusive; you must specify one but not both.
        """
...
if not MYPY:
    class VirtualMachineConfigurationArgsDict(TypedDict):
        ...
        node_agent_sku_id: pulumi.Input[builtins.str]
        """
...
class VirtualMachineConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] node_agent_sku_id: The Batch node agent is a program that runs on each node in the pool, and provides the command-and-control interface between the node and the Batch service. There are different implementations of the node agent, known as SKUs, for different operating systems. You must specify a node agent SKU which matches the selected image reference. To get the list of supported node agent SKUs along with their list of verified image references, see the 'List supported node agent SKUs' operation.
        ...
        :param pulumi.Input[builtins.str] license_type: This only applies to images that contain the Windows operating system, and should only be used when you hold valid on-premises licenses for the nodes which will be deployed. If omitted, no on-premises licensing discount is applied. Values are:
    ...
    def node_agent_sku_id(self) -> pulumi.Input[builtins.str]:
        """
        The Batch node agent is a program that runs on each node in the pool, and provides the command-and-control interface between the node and the Batch service. There are different implementations of the node agent, known as SKUs, for different operating systems. You must specify a node agent SKU which matches the selected image reference. To get the list of supported node agent SKUs along with their list of verified image references, see the 'List supported node agent SKUs' operation.
        """
    ...
    def node_agent_sku_id(self, value: pulumi.Input[builtins.str]):
...
class WindowsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_automatic_updates: If omitted, the default value is true.
        """
