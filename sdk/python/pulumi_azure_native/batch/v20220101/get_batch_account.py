...
def get_batch_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20220101:getBatchAccount', __args__, opts=opts, typ=GetBatchAccountResult).value
...
def get_batch_account_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch/v20220101:getBatchAccount', __args__, opts=opts, typ=GetBatchAccountResult)
