...
azure-native:batch/v20200301:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_batch_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_account is deprecated: Version 2020-03-01 will be removed in v2 of the provider.
azure-native:batch/v20200301:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220101:BatchAccount to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20200301:getBatchAccount', __args__, opts=opts, typ=GetBatchAccountResult).value
