...
azure-native:batch/v20190401:ApplicationPackage is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_package(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_package is deprecated: Version 2019-04-01 will be removed in v2 of the provider.
azure-native:batch/v20190401:ApplicationPackage is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:ApplicationPackage to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20190401:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult).value
