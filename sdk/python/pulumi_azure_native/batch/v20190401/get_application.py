...
azure-native:batch/v20190401:Application is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version 2019-04-01 will be removed in v2 of the provider.
azure-native:batch/v20190401:Application is being removed in the next major version of this provider. Please upgrade to azure-native:batch/v20221001:Application to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['applicationName'] = application_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20190401:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
