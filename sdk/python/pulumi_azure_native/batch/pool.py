...
class PoolArgs:
    def __init__(__self__, *,
                 ...
                 application_licenses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 task_slots_per_node: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_licenses: The list of application licenses must be a subset of available Batch service application licenses. If a license is requested which is not supported, pool creation will fail.
        ...
        :param pulumi.Input[builtins.str] display_name: The display name need not be unique and can contain any Unicode characters up to a maximum length of 1024.
        ...
        :param pulumi.Input[builtins.str] pool_name: The pool name. This must be unique within the account.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_tags: The user-defined tags to be associated with the Azure Batch Pool. When specified, these tags are propagated to the backing Azure resources associated with the pool. This property can only be specified when the Batch account was created with the poolAllocationMode property set to 'UserSubscription'.
    ...
    def application_licenses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def application_licenses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def task_slots_per_node(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def task_slots_per_node(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Pool(pulumi.CustomResource):
    ...
    def allocation_state(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "allocation_state")

    @property
    @pulumi.getter(name="allocationStateTransitionTime")
    def allocation_state_transition_time(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "allocation_state_transition_time")

    @property
    @pulumi.getter(name="applicationLicenses")
    def application_licenses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of application licenses must be a subset of available Batch service application licenses. If a license is requested which is not supported, pool creation will fail.
        """
        return pulumi.get(self, "application_licenses")
    ...
    def current_dedicated_nodes(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "current_dedicated_nodes")

    @property
    @pulumi.getter(name="currentLowPriorityNodes")
    def current_low_priority_nodes(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "current_low_priority_nodes")

    @property
    @pulumi.getter(name="currentNodeCommunicationMode")
    def current_node_communication_mode(self) -> pulumi.Output[builtins.str]:
    ...
    @property
    @pulumi.getter(name="interNodeCommunication")
    def inter_node_communication(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This imposes restrictions on which nodes can be assigned to the pool. Enabling this value can reduce the chance of the requested number of nodes to be allocated in the pool. If not specified, this value defaults to 'Disabled'.
        """
        return pulumi.get(self, "inter_node_communication")
    ...
    def provisioning_state_transition_time(self) -> pulumi.Output[builtins.str]:
    ...
    @property
    @pulumi.getter(name="targetNodeCommunicationMode")
    def target_node_communication_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If omitted, the default value is Default.
        """
        return pulumi.get(self, "target_node_communication_mode")
    ...
    @property
    @pulumi.getter(name="taskSlotsPerNode")
    def task_slots_per_node(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The default value is 1. The maximum value is the smaller of 4 times the number of cores of the vmSize of the pool or 256.
        """
        return pulumi.get(self, "task_slots_per_node")
