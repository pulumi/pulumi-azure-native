...
class PoolArgs:
    ...
    def _configure(
        ...
        if 'applicationLicenses' in kwargs:
            application_licenses = kwargs['applicationLicenses']
        if 'applicationPackages' in kwargs:
        ...
        if 'mountConfiguration' in kwargs:
        ...
        if 'taskSchedulingPolicy' in kwargs:
            task_scheduling_policy = kwargs['taskSchedulingPolicy']
        if 'taskSlotsPerNode' in kwargs:
...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if deployment_configuration is not None and not isinstance(deployment_configuration, DeploymentConfigurationArgs):
                deployment_configuration = deployment_configuration or {}
                def _setter(key, value):
                    deployment_configuration[key] = value
                DeploymentConfigurationArgs._configure(_setter, **deployment_configuration)
            __props__.__dict__["deployment_configuration"] = deployment_configuration
            __props__.__dict__["display_name"] = display_name
            if identity is not None and not isinstance(identity, BatchPoolIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                BatchPoolIdentityArgs._configure(_setter, **identity)
            ...
            if network_configuration is not None and not isinstance(network_configuration, NetworkConfigurationArgs):
            ...
            if scale_settings is not None and not isinstance(scale_settings, ScaleSettingsArgs):
                scale_settings = scale_settings or {}
                def _setter(key, value):
                    scale_settings[key] = value
                ScaleSettingsArgs._configure(_setter, **scale_settings)
            __props__.__dict__["scale_settings"] = scale_settings
            if start_task is not None and not isinstance(start_task, StartTaskArgs):
                start_task = start_task or {}
                def _setter(key, value):
                    start_task[key] = value
                StartTaskArgs._configure(_setter, **start_task)
            __props__.__dict__["start_task"] = start_task
            __props__.__dict__["target_node_communication_mode"] = target_node_communication_mode
            if task_scheduling_policy is not None and not isinstance(task_scheduling_policy, TaskSchedulingPolicyArgs):
                task_scheduling_policy = task_scheduling_policy or {}
                def _setter(key, value):
                    task_scheduling_policy[key] = value
                TaskSchedulingPolicyArgs._configure(_setter, **task_scheduling_policy)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:batch:Pool"), pulumi.Alias(type_="azure-native:batch/v20170901:Pool"), pulumi.Alias(type_="azure-native:batch/v20181201:Pool"), pulumi.Alias(type_="azure-native:batch/v20190401:Pool"), pulumi.Alias(type_="azure-native:batch/v20190801:Pool"), pulumi.Alias(type_="azure-native:batch/v20200301:Pool"), pulumi.Alias(type_="azure-native:batch/v20200501:Pool"), pulumi.Alias(type_="azure-native:batch/v20200901:Pool"), pulumi.Alias(type_="azure-native:batch/v20210101:Pool"), pulumi.Alias(type_="azure-native:batch/v20210601:Pool"), pulumi.Alias(type_="azure-native:batch/v20220101:Pool"), pulumi.Alias(type_="azure-native:batch/v20220601:Pool"), pulumi.Alias(type_="azure-native:batch/v20221001:Pool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pool, __self__).__init__(
            'azure-native:batch/v20230501:Pool',
            resource_name,
            __props__,
            opts)
