...
def list_batch_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20240201:listBatchAccountKeys', __args__, opts=opts, typ=ListBatchAccountKeysResult).value
...
def list_batch_account_keys_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch/v20240201:listBatchAccountKeys', __args__, opts=opts, typ=ListBatchAccountKeysResult)
