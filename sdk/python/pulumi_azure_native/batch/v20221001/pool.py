...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            account_name="sampleacct",
            deployment_configuration=azure_native.batch.v20221001.DeploymentConfigurationResponseArgs(
                virtual_machine_configuration={
                    "imageReference": azure_native.batch.v20221001.ImageReferenceArgs(
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            ...
            certificates=[{
                ...
                "storeLocation": azure_native.batch/v20221001.CertificateStoreLocation.LOCAL_MACHINE,
                "storeName": "MY",
                "visibility": [azure_native.batch/v20221001.CertificateVisibility.REMOTE_USER],
            }],
            deployment_configuration=azure_native.batch.v20221001.DeploymentConfigurationResponseArgs(
                cloud_service_configuration=azure_native.batch.v20221001.CloudServiceConfigurationArgs(
                    os_family="4",
                    os_version="WA-GUEST-OS-4.45_201708-01",
                ),
            ),
            display_name="my-pool-name",
            inter_node_communication=azure_native.batch/v20221001.InterNodeCommunicationState.ENABLED,
            metadata=[
                {
                    "name": "metadata-1",
                    "value": "value-1",
            ...
            network_configuration=azure_native.batch.v20221001.NetworkConfigurationResponseArgs(
                public_ip_address_configuration=azure_native.batch.v20221001.PublicIPAddressConfigurationArgs(
                    ip_address_ids=[
                        "/subscriptions/subid1/resourceGroups/rg13/providers/Microsoft.Network/publicIPAddresses/ip135",
                        "/subscriptions/subid2/resourceGroups/rg24/providers/Microsoft.Network/publicIPAddresses/ip268",
                    ],
                    provision=azure_native.batch/v20221001.IPAddressProvisioningType.USER_MANAGED,
                ),
            ...
            pool_name="testpool",
            resource_group_name="default-azurebatch-japaneast",
            scale_settings=azure_native.batch.v20221001.ScaleSettingsResponseArgs(
                fixed_scale=azure_native.batch.v20221001.FixedScaleSettingsArgs(
                    node_deallocation_option=azure_native.batch/v20221001.ComputeNodeDeallocationOption.TASK_COMPLETION,
                    resize_timeout="PT8M",
                    target_dedicated_nodes=6,
                    target_low_priority_nodes=28,
                ),
            ),
            start_task=azure_native.batch.v20221001.StartTaskResponseArgs(
                command_line="cmd /c SET",
                environment_settings=[azure_native.batch.v20221001.EnvironmentSettingArgs(
                    name="MYSET",
                    value="1234",
                )],
                max_task_retry_count=6,
                resource_files=[azure_native.batch.v20221001.ResourceFileArgs(
                    file_mode="777",
                    file_path="c:\\\\temp\\\\gohere",
                    http_url="https://testaccount.blob.core.windows.net/example-blob-file",
                )],
                user_identity={
                    "autoUser": azure_native.batch.v20221001.AutoUserSpecificationArgs(
                        elevation_level=azure_native.batch/v20221001.ElevationLevel.ADMIN,
                        scope=azure_native.batch/v20221001.AutoUserScope.POOL,
                    ),
                },
                wait_for_success=True,
            ),
            task_scheduling_policy=azure_native.batch.v20221001.TaskSchedulingPolicyResponseArgs(
                node_fill_type=azure_native.batch/v20221001.ComputeNodeFillType.PACK,
            ),
            task_slots_per_node=13,
            user_accounts=[{
                "elevationLevel": azure_native.batch/v20221001.ElevationLevel.ADMIN,
                "linuxUserConfiguration": azure_native.batch.v20221001.LinuxUserConfigurationArgs(
                    gid=4567,
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            ...
            deployment_configuration=azure_native.batch.v20221001.DeploymentConfigurationResponseArgs(
                virtual_machine_configuration={
                    "dataDisks": [
                        azure_native.batch.v20221001.DataDiskArgs(
                            caching=azure_native.batch/v20221001.CachingType.READ_WRITE,
                            disk_size_gb=30,
                            lun=0,
                            storage_account_type=azure_native.batch/v20221001.StorageAccountType.PREMIUM_LRS,
                        ),
                        azure_native.batch.v20221001.DataDiskArgs(
                            caching=azure_native.batch/v20221001.CachingType.NONE,
                            disk_size_gb=200,
                            lun=1,
                            storage_account_type=azure_native.batch/v20221001.StorageAccountType.STANDARD_LRS,
                        ),
                    ],
                    "diskEncryptionConfiguration": azure_native.batch.v20221001.DiskEncryptionConfigurationArgs(
                        targets=[
                            azure_native.batch/v20221001.DiskEncryptionTarget.OS_DISK,
                            azure_native.batch/v20221001.DiskEncryptionTarget.TEMPORARY_DISK,
                        ],
                    ),
                    "imageReference": azure_native.batch.v20221001.ImageReferenceArgs(
                        offer="WindowsServer",
                    ...
                    "nodePlacementConfiguration": azure_native.batch.v20221001.NodePlacementConfigurationArgs(
                        policy=azure_native.batch/v20221001.NodePlacementPolicyType.ZONAL,
                    ),
                    "osDisk": {
                        "ephemeralOSDiskSettings": azure_native.batch.v20221001.DiffDiskSettingsArgs(
                            placement=azure_native.batch/v20221001.DiffDiskPlacement.CACHE_DISK,
                        ),
                    },
                    "windowsConfiguration": azure_native.batch.v20221001.WindowsConfigurationArgs(
                ...
                endpoint_configuration={
                    "inboundNatPools": [{
                        ...
                        "networkSecurityGroupRules": [
                            azure_native.batch.v20221001.NetworkSecurityGroupRuleArgs(
                                access=azure_native.batch/v20221001.NetworkSecurityGroupRuleAccess.ALLOW,
                                priority=150,
                            ...
                            azure_native.batch.v20221001.NetworkSecurityGroupRuleArgs(
                                access=azure_native.batch/v20221001.NetworkSecurityGroupRuleAccess.DENY,
                                priority=3500,
                                source_address_prefix="*",
                                source_port_ranges=["*"],
                            ),
                        ],
                        "protocol": azure_native.batch/v20221001.InboundEndpointProtocol.TCP,
                    }],
                },
            ),
            pool_name="testpool",
            resource_group_name="default-azurebatch-japaneast",
            scale_settings=azure_native.batch.v20221001.ScaleSettingsResponseArgs(
                auto_scale=azure_native.batch.v20221001.AutoScaleSettingsArgs(
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            ...
            network_configuration=azure_native.batch.v20221001.NetworkConfigurationResponseArgs(
                public_ip_address_configuration=azure_native.batch.v20221001.PublicIPAddressConfigurationArgs(
                    provision=azure_native.batch/v20221001.IPAddressProvisioningType.NO_PUBLIC_IP_ADDRESSES,
                ),
                subnet_id="/subscriptions/subid/resourceGroups/rg1234/providers/Microsoft.Network/virtualNetworks/network1234/subnets/subnet123",
            ),
            pool_name="testpool",
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            ...
            identity=azure_native.batch.v20221001.BatchPoolIdentityResponseArgs(
                type=azure_native.batch/v20221001.PoolIdentityType.USER_ASSIGNED,
        ...
        pool = azure_native.batch.v20221001.Pool("pool",
            ...
            deployment_configuration=azure_native.batch.v20221001.DeploymentConfigurationResponseArgs(
                virtual_machine_configuration={
                    "extensions": [azure_native.batch.v20221001.VMExtensionArgs(
            ...
            target_node_communication_mode=azure_native.batch/v20221001.NodeCommunicationMode.DEFAULT,
            vm_size="STANDARD_D4")
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:batch:Pool"), pulumi.Alias(type_="azure-native:batch/v20170901:Pool"), pulumi.Alias(type_="azure-native:batch/v20181201:Pool"), pulumi.Alias(type_="azure-native:batch/v20190401:Pool"), pulumi.Alias(type_="azure-native:batch/v20190801:Pool"), pulumi.Alias(type_="azure-native:batch/v20200301:Pool"), pulumi.Alias(type_="azure-native:batch/v20200501:Pool"), pulumi.Alias(type_="azure-native:batch/v20200901:Pool"), pulumi.Alias(type_="azure-native:batch/v20210101:Pool"), pulumi.Alias(type_="azure-native:batch/v20210601:Pool"), pulumi.Alias(type_="azure-native:batch/v20220101:Pool"), pulumi.Alias(type_="azure-native:batch/v20220601:Pool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pool, __self__).__init__(
            'azure-native:batch/v20221001:Pool',
            resource_name,
            __props__,
            opts)
