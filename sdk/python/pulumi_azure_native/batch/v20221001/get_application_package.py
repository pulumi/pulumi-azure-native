...
def get_application_package(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_package is deprecated: azure-native:batch/v20221001:ApplicationPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:ApplicationPackage to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20221001:getApplicationPackage', __args__, opts=opts, typ=GetApplicationPackageResult).value
