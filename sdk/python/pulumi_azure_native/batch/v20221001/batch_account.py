...
warnings.warn("""azure-native:batch/v20221001:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:BatchAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
class BatchAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""BatchAccount is deprecated: azure-native:batch/v20221001:BatchAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20230501:BatchAccount to guarantee forwards compatibility.""")
