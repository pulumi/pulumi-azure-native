...
class GetPoolResult:
    ...
    def application_licenses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def inter_node_communication(self) -> Optional[builtins.str]:
        """
    ...
    def provisioning_state_transition_time(self) -> builtins.str:
    ...
    def target_node_communication_mode(self) -> Optional[builtins.str]:
        """
    ...
    def task_slots_per_node(self) -> Optional[builtins.int]:
        """
...
def get_pool(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pool_name: The pool name. This must be unique within the account.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:batch:getPool', __args__, opts=opts, typ=GetPoolResult)
