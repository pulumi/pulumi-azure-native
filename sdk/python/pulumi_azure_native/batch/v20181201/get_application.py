...
def get_application(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20181201 will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
