...
azure-native:batch/v20181201:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220601:Certificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_certificate(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: Version 2018-12-01 will be removed in v2 of the provider.
azure-native:batch/v20181201:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:batch/v20220601:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['certificateName'] = certificate_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:batch/v20181201:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
