...
def get_secret_sync(resource_group_name: Optional[_builtins.str] = None,
                    secret_sync_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str secret_sync_name: The name of the SecretSync
    """
    __args__ = dict()
...
def get_secret_sync_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                           secret_sync_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
