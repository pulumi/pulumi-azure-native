...
class AzureKeyVaultSecretProviderClass(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:secretsynccontroller/v20240821preview:AzureKeyVaultSecretProviderClass"), pulumi.Alias(type_="azure-native_secretsynccontroller_v20240821preview:secretsynccontroller:AzureKeyVaultSecretProviderClass")])
