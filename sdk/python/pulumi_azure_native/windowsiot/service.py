...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:windowsiot/v20190601:Service"), pulumi.Alias(type_="azure-native_windowsiot_v20180216preview:windowsiot:Service"), pulumi.Alias(type_="azure-native_windowsiot_v20190601:windowsiot:Service")])
