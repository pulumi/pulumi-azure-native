...
class Service(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:windowsiot:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot:Service"), pulumi.Alias(type_="azure-native:windowsiot/latest:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/latest:Service"), pulumi.Alias(type_="azure-native:windowsiot/v20190601:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/v20190601:Service")])
