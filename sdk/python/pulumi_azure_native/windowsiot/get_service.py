...
class GetServiceResult:
    ...
    def admin_domain_name(self) -> Optional[builtins.str]:
        """
    ...
    def billing_domain_name(self) -> Optional[builtins.str]:
        """
...
def get_service(device_name: Optional[builtins.str] = None,
    ...
    :param builtins.str device_name: The name of the Windows IoT Device Service.
    :param builtins.str resource_group_name: The name of the resource group that contains the Windows IoT Device Service.
    """
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:windowsiot:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(device_name: Optional[pulumi.Input[builtins.str]] = None,
