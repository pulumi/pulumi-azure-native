...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:attestation:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:attestation:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:attestation/v20201001:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:attestation/v20201001:PrivateEndpointConnection")])
