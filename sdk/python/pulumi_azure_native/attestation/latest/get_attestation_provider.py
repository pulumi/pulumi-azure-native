...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:attestation:getAttestationProvider'.""", DeprecationWarning)
...
def get_attestation_provider(provider_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attestation_provider is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:attestation:getAttestationProvider'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:attestation/latest:getAttestationProvider', __args__, opts=opts, typ=GetAttestationProviderResult).value
