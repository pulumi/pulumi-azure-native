...
class AttestationProviderArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['AttestationServiceCreationSpecificParamsArgs']] = None,
...
class AttestationProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, AttestationServiceCreationSpecificParamsArgs, True)
