...
class AttestationProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The supported Azure location where the attestation provider should be created.
        :param pulumi.Input[builtins.str] provider_name: Name of the attestation provider.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags that will be assigned to the attestation provider.
        """
...
class AttestationProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['AttestationServiceCreationSpecificParamsArgs', 'AttestationServiceCreationSpecificParamsArgsDict']]] = None,
                 provider_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The supported Azure location where the attestation provider should be created.
        :param pulumi.Input[Union['AttestationServiceCreationSpecificParamsArgs', 'AttestationServiceCreationSpecificParamsArgsDict']] properties: Properties of the attestation provider
        :param pulumi.Input[builtins.str] provider_name: Name of the attestation provider.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags that will be assigned to the attestation provider.
        """
    ...
    def attest_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def tpm_attestation_authentication(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def trust_model(self) -> pulumi.Output[Optional[builtins.str]]:
        """
