...
class AttestationProviderArgs:
    def __init__(__self__, *,
        ...
        """
        AttestationProviderArgs._configure(
...
class AttestationProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AttestationProviderArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, AttestationServiceCreationSpecificParamsArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                AttestationServiceCreationSpecificParamsArgs._configure(_setter, **properties)
