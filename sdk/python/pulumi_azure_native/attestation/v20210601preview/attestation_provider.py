...
class AttestationProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:attestation:AttestationProvider"), pulumi.Alias(type_="azure-native:attestation/v20201001:AttestationProvider")])
