...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.attestation.v20210601preview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="{privateEndpointConnectionName}",
            private_link_service_connection_state=azure_native.attestation.v20210601preview.PrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:attestation:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:attestation/v20201001:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:attestation/v20210601preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
