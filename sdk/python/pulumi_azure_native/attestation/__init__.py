...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:attestation:AttestationProvider":
                return AttestationProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:attestation:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "attestation", _module_instance)
