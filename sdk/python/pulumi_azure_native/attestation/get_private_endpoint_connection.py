...
class GetPrivateEndpointConnectionResult:
    ...
    def private_endpoint(self) -> Optional['_commontypesv3.outputs.PrivateEndpointResponse']:
        """
    ...
    def private_link_service_connection_state(self) -> '_commontypesv3.outputs.PrivateLinkServiceConnectionStateResponse':
        """
...
def get_private_endpoint_connection(private_endpoint_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str provider_name: Name of the attestation provider.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:attestation:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:attestation:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult)
