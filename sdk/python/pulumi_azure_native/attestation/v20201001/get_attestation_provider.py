...
warnings.warn("""azure-native:attestation/v20201001:AttestationProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:attestation/v20210601:AttestationProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_attestation_provider(provider_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attestation_provider is deprecated: azure-native:attestation/v20201001:AttestationProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:attestation/v20210601:AttestationProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['providerName'] = provider_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:attestation/v20201001:getAttestationProvider', __args__, opts=opts, typ=GetAttestationProviderResult).value
