...
class AttestationProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:attestation/v20201001:AttestationProvider"), pulumi.Alias(type_="azure-native:attestation:AttestationProvider"), pulumi.Alias(type_="azure-nextgen:attestation:AttestationProvider"), pulumi.Alias(type_="azure-native:attestation/v20180901preview:AttestationProvider"), pulumi.Alias(type_="azure-nextgen:attestation/v20180901preview:AttestationProvider"), pulumi.Alias(type_="azure-native:attestation/v20210601preview:AttestationProvider"), pulumi.Alias(type_="azure-nextgen:attestation/v20210601preview:AttestationProvider")])
