...
def get_attestation_provider(provider_name: Optional[_builtins.str] = None,
...
def get_attestation_provider_output(provider_name: pulumi.Input[Optional[_builtins.str]] = None,
