...
class AttestationServiceCreationSpecificParamsArgs:
    def __init__(__self__, *,
        ...
        AttestationServiceCreationSpecificParamsArgs._configure(
            ...
            tpm_attestation_authentication=tpm_attestation_authentication,
        )
    @staticmethod
    def _configure(
        ...
        if tpm_attestation_authentication is None and 'tpmAttestationAuthentication' in kwargs:
            tpm_attestation_authentication = kwargs['tpmAttestationAuthentication']
        ...
        if tpm_attestation_authentication is not None:
            _setter("tpm_attestation_authentication", tpm_attestation_authentication)
