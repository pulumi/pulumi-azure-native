...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provider_name: The name of the attestation provider.
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:attestation:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:attestation/v20201001:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:attestation/v20210601preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:attestation/v20210601:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
