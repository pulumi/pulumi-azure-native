...
__all__ = ['LocationSiteArgs', 'LocationSite']

@pulumi.input_type
class LocationSiteArgs:
...
class LocationSite(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LocationSiteArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        IoT site model

        :param str resource_name: The name of the resource.
        :param LocationSiteArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LocationSiteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LocationSiteArgs.__new__(LocationSiteArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210901preview:LocationSite"), pulumi.Alias(type_="azure-native:iotsecurity:LocationSite"), pulumi.Alias(type_="azure-nextgen:iotsecurity:LocationSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LocationSite, __self__).__init__(
            'azure-native:iotsecurity/v20210901preview:LocationSite',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LocationSite':
        """
        ...
        __props__.__dict__["type"] = None
        return LocationSite(resource_name, opts=opts, __props__=__props__)
