...
class Sensor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210901preview:Sensor"), pulumi.Alias(type_="azure-native:iotsecurity:Sensor"), pulumi.Alias(type_="azure-nextgen:iotsecurity:Sensor"), pulumi.Alias(type_="azure-native:iotsecurity/v20210201preview:Sensor"), pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210201preview:Sensor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Sensor, __self__).__init__(
            'azure-native:iotsecurity/v20210901preview:Sensor',
            resource_name,
            __props__,
            opts)
