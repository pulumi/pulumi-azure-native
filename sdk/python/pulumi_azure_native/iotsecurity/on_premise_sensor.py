...
class OnPremiseSensorArgs:
    def __init__(__self__, *,
        ...
        """
        OnPremiseSensorArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            on_premise_sensor_name=on_premise_sensor_name,
        )
    @staticmethod
    def _configure(
        ...
        if on_premise_sensor_name is not None:
            _setter("on_premise_sensor_name", on_premise_sensor_name)
...
class OnPremiseSensor(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OnPremiseSensorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotsecurity/v20210201preview:OnPremiseSensor")])
