...
class LocationSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotsecurity:LocationSite"), pulumi.Alias(type_="azure-native:iotsecurity/v20210901preview:LocationSite"), pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210901preview:LocationSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LocationSite, __self__).__init__(
            'azure-native:iotsecurity:LocationSite',
            resource_name,
            __props__,
            opts)
