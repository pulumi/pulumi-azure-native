...
def get_retention_policy(resource_group_name: Optional[builtins.str] = None,
...
def get_retention_policy_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
