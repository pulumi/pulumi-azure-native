...
def get_task_hub(resource_group_name: Optional[_builtins.str] = None,
                 scheduler_name: Optional[_builtins.str] = None,
                 task_hub_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str task_hub_name: The name of the TaskHub
    """
    __args__ = dict()
...
def get_task_hub_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                        scheduler_name: pulumi.Input[Optional[_builtins.str]] = None,
                        task_hub_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
