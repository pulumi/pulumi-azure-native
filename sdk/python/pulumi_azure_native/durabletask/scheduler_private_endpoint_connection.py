...
__all__ = ['SchedulerPrivateEndpointConnectionArgs', 'SchedulerPrivateEndpointConnection']

@pulumi.input_type
class SchedulerPrivateEndpointConnectionArgs:
...
@pulumi.type_token("azure-native:durabletask:SchedulerPrivateEndpointConnection")
class SchedulerPrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SchedulerPrivateEndpointConnectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The private endpoint connection resource.
        ...
        :param str resource_name: The name of the resource.
        :param SchedulerPrivateEndpointConnectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SchedulerPrivateEndpointConnectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SchedulerPrivateEndpointConnectionArgs.__new__(SchedulerPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:durabletask/v20260201:SchedulerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:durabletask/v20260501preview:SchedulerPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SchedulerPrivateEndpointConnection, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SchedulerPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SchedulerPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
