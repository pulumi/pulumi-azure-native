...
def get_scheduler(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:durabletask:getScheduler', __args__, opts=opts, typ=GetSchedulerResult).value
...
def get_scheduler_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
