...
class TaskHubArgs:
    def __init__(__self__, *,
                 ...
                 scheduler_name: pulumi.Input[str],
                 task_hub_name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a TaskHub resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] scheduler_name: The name of the Scheduler
        :param pulumi.Input[str] task_hub_name: The name of the TaskHub
        """
    ...
    def scheduler_name(self) -> pulumi.Input[str]:
        """
    ...
    def scheduler_name(self, value: pulumi.Input[str]):
        pulumi.set(self, "scheduler_name", value)

    @property
    @pulumi.getter(name="taskHubName")
    def task_hub_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def task_hub_name(self, value: Optional[pulumi.Input[str]]):
...
class TaskHub(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TaskHubArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TaskHubArgs.__new__(TaskHubArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:durabletask:TaskHub")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TaskHub, __self__).__init__(
            'azure-native:durabletask/v20241001preview:TaskHub',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TaskHub':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return TaskHub(resource_name, opts=opts, __props__=__props__)
