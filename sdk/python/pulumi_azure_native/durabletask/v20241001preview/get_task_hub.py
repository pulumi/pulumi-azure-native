...
def get_task_hub(resource_group_name: Optional[str] = None,
    ...
    :param str task_hub_name: The name of the TaskHub
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:durabletask/v20241001preview:getTaskHub', __args__, opts=opts, typ=GetTaskHubResult).value

    return AwaitableGetTaskHubResult(
