...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedidentity/v20150831preview:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20181130:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20210930preview:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20220131preview:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20230131:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20241130:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20250131preview:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity:UserAssignedIdentity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserAssignedIdentity, __self__).__init__(
            'azure-native:managedidentity/v20230731preview:UserAssignedIdentity',
            resource_name,
            __props__,
            opts)
