...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_assigned_identity is deprecated: azure-native:managedidentity/v20210930preview:UserAssignedIdentity is being removed in the next major version of this provider. Upgrade to at least azure-native:managedidentity/v20230131:UserAssignedIdentity to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/v20210930preview:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult).value
