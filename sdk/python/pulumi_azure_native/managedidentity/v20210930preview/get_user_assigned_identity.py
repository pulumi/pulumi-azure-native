...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_assigned_identity is deprecated: azure-native:managedidentity/v20210930preview:UserAssignedIdentity is being removed in the next major version of this provider. Please upgrade to azure-native:managedidentity/v20230131:UserAssignedIdentity to guarantee forwards compatibility.""")
    __args__ = dict()
