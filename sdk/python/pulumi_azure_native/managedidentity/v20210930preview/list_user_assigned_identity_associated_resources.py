...
def list_user_assigned_identity_associated_resources(filter: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/v20210930preview:listUserAssignedIdentityAssociatedResources', __args__, opts=opts, typ=ListUserAssignedIdentityAssociatedResourcesResult).value
...
def list_user_assigned_identity_associated_resources_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managedidentity/v20210930preview:listUserAssignedIdentityAssociatedResources', __args__, opts=opts, typ=ListUserAssignedIdentityAssociatedResourcesResult)
