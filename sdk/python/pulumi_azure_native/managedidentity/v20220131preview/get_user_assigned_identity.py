...
def get_user_assigned_identity_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managedidentity/v20220131preview:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult)
