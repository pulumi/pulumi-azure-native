...
class FederatedIdentityCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedidentity:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20230131:FederatedIdentityCredential")])
