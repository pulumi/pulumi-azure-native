...
warnings.warn("""Version 2018-11-30 will be removed in v2 of the provider.""", DeprecationWarning)
...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""UserAssignedIdentity is deprecated: Version 2018-11-30 will be removed in v2 of the provider.""")
