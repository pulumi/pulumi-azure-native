...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_assigned_identity is deprecated: Version 2015-08-31-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/v20150831preview:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult).value
