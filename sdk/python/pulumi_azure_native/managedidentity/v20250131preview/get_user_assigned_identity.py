...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/v20250131preview:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult).value
...
def get_user_assigned_identity_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managedidentity/v20250131preview:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult)
