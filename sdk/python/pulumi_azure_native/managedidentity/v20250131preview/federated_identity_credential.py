...
class FederatedIdentityCredentialArgs:
    def __init__(__self__, *,
                 ...
                 claims_matching_expression: Optional[pulumi.Input['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs']] = None,
        ...
        :param pulumi.Input['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs'] claims_matching_expression: Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
        ...
        :param pulumi.Input[str] subject: The identifier of the external identity. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
        """
    ...
    def claims_matching_expression(self) -> Optional[pulumi.Input['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs']]:
        """
    ...
    def claims_matching_expression(self, value: Optional[pulumi.Input['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs']]):
...
class FederatedIdentityCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 claims_matching_expression: Optional[pulumi.Input[Union['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs', 'FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgsDict']]] = None,
                 federated_identity_credential_resource_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] audiences: The list of audiences that can appear in the issued token.
        :param pulumi.Input[Union['FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgs', 'FederatedIdentityCredentialPropertiesClaimsMatchingExpressionArgsDict']] claims_matching_expression: Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
        :param pulumi.Input[str] federated_identity_credential_resource_name: The name of the federated identity credential resource.
        :param pulumi.Input[str] issuer: The URL of the issuer to be trusted.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedidentity/v20220131preview:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20230131:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20230731preview:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20241130:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity:FederatedIdentityCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FederatedIdentityCredential, __self__).__init__(
            'azure-native:managedidentity/v20250131preview:FederatedIdentityCredential',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["claims_matching_expression"] = None
    ...
    @property
    @pulumi.getter(name="claimsMatchingExpression")
    def claims_matching_expression(self) -> pulumi.Output[Optional['outputs.FederatedIdentityCredentialPropertiesResponseClaimsMatchingExpression']]:
        """
        Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both.
        """
        return pulumi.get(self, "claims_matching_expression")
