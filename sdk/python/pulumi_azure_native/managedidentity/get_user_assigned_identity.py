...
def get_user_assigned_identity(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group to which the identity belongs.
...
def get_user_assigned_identity_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
