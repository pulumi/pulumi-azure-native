...
class FederatedIdentityCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        federated_identity_credential = azure_native.managedidentity.v20230131.FederatedIdentityCredential("federatedIdentityCredential",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedidentity:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20220131preview:FederatedIdentityCredential")])
