...
class FederatedIdentityCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:managedidentity/v20220131preview:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20230731preview:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20241130:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity/v20250131preview:FederatedIdentityCredential"), pulumi.Alias(type_="azure-native:managedidentity:FederatedIdentityCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FederatedIdentityCredential, __self__).__init__(
            'azure-native:managedidentity/v20230131:FederatedIdentityCredential',
            resource_name,
            __props__,
            opts)
