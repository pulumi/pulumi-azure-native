...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user_assigned_identity = azure_native.managedidentity.v20230131.UserAssignedIdentity("userAssignedIdentity",
            location="eastus",
