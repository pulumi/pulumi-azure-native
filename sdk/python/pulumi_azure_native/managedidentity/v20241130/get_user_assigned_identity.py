...
class GetUserAssignedIdentityResult:
    ...
    """
    def __init__(__self__, client_id=None, id=None, isolation_scope=None, location=None, name=None, principal_id=None, system_data=None, tags=None, tenant_id=None, type=None):
    ...
    def isolation_scope(self) -> Optional[str]:
        """
...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/v20241130:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult).value
...
def get_user_assigned_identity_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managedidentity/v20241130:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult)
