...
class Alias(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:subscription:Alias"), pulumi.Alias(type_="azure-nextgen:subscription:Alias"), pulumi.Alias(type_="azure-native:subscription/latest:Alias"), pulumi.Alias(type_="azure-nextgen:subscription/latest:Alias"), pulumi.Alias(type_="azure-native:subscription/v20191001preview:Alias"), pulumi.Alias(type_="azure-nextgen:subscription/v20191001preview:Alias")])
