...
class Alias(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 alias_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['PutAliasRequestPropertiesArgs', 'PutAliasRequestPropertiesArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] alias_name: Name for this subscription creation request also known as alias. Note that this is not the same as subscription name and this doesn’t have any other lifecycle need beyond the request for subscription creation.
        :param pulumi.Input[Union['PutAliasRequestPropertiesArgs', 'PutAliasRequestPropertiesArgsDict']] properties: Put alias request properties.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:subscription/v20191001preview:Alias"), pulumi.Alias(type_="azure-native:subscription/v20211001:Alias"), pulumi.Alias(type_="azure-native:subscription/v20240801preview:Alias"), pulumi.Alias(type_="azure-native:subscription:Alias")])
