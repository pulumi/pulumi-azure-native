...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:subscription:getAlias'.""", DeprecationWarning)
...
def get_alias(alias_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:subscription/latest:getAlias', __args__, opts=opts, typ=GetAliasResult).value
