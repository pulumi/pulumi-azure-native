...
class SubscriptionTarDirectory(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:subscription/v20240801preview:SubscriptionTarDirectory"), pulumi.Alias(type_="azure-native:subscription/v20251101preview:SubscriptionTarDirectory")])
