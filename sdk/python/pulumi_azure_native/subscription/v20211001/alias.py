...
class Alias(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias = azure_native.subscription.v20211001.Alias("alias",
            alias_name="aliasForNewSub",
            properties=azure_native.subscription.v20211001.SubscriptionAliasResponsePropertiesResponseArgs(
                additional_properties=azure_native.subscription.v20211001.PutAliasRequestAdditionalPropertiesArgs(
