...
class SubscriptionAlias(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:subscription:SubscriptionAlias"), pulumi.Alias(type_="azure-nextgen:subscription:SubscriptionAlias"), pulumi.Alias(type_="azure-native:subscription/latest:SubscriptionAlias"), pulumi.Alias(type_="azure-nextgen:subscription/latest:SubscriptionAlias"), pulumi.Alias(type_="azure-native:subscription/v20200901:SubscriptionAlias"), pulumi.Alias(type_="azure-nextgen:subscription/v20200901:SubscriptionAlias")])
