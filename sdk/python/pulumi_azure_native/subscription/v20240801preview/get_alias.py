...
def get_alias(alias_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:subscription/v20240801preview:getAlias', __args__, opts=opts, typ=GetAliasResult).value
...
def get_alias_output(alias_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['aliasName'] = alias_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:subscription/v20240801preview:getAlias', __args__, opts=opts, typ=GetAliasResult)
