...
def get_subscription_tar_directory(subscription_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:subscription/v20240801preview:getSubscriptionTarDirectory', __args__, opts=opts, typ=GetSubscriptionTarDirectoryResult).value
