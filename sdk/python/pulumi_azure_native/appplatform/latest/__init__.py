...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:appplatform/latest:App":
                return App(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/latest:Binding":
                return Binding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/latest:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/latest:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/latest:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/latest:Service":
    ...
    pulumi.runtime.register_resource_module("azure-native", "appplatform/latest", _module_instance)
