...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getBinding'.""", DeprecationWarning)
...
def get_binding(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:getBinding', __args__, opts=opts, typ=GetBindingResult).value
