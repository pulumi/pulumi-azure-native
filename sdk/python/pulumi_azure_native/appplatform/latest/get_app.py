...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getApp'.""", DeprecationWarning)
...
def get_app(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:getApp', __args__, opts=opts, typ=GetAppResult).value
