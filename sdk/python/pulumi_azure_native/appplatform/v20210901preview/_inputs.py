...
__all__ = [
    ...
    'DeploymentSettingsContainerProbeSettingsArgsDict',
...
if not MYPY:
    class DeploymentSettingsContainerProbeSettingsArgsDict(TypedDict):
        """
    ...
    DeploymentSettingsContainerProbeSettingsArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class DeploymentSettingsArgsDict(TypedDict):
        ...
        """
        container_probe_settings: NotRequired[pulumi.Input['DeploymentSettingsContainerProbeSettingsArgsDict']]
        """
        Container liveness and readiness probe settings
        """
