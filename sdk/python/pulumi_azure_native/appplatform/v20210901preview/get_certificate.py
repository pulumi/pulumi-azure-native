...
def get_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:appplatform/v20210901preview:Certificate is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
