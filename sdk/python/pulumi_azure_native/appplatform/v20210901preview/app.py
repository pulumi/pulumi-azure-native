...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:App"), pulumi.Alias(type_="azure-native:appplatform/v20200701:App"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220401:App"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20221201:App"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20231201:App"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:App")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(App, __self__).__init__(
            'azure-native:appplatform/v20210901preview:App',
            resource_name,
            __props__,
            opts)
