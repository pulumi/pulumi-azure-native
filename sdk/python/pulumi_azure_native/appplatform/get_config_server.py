...
def get_config_server(resource_group_name: Optional[builtins.str] = None,
...
def get_config_server_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
