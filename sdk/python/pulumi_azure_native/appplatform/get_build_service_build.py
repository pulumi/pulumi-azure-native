...
def get_build_service_build(build_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult).value
...
def get_build_service_build_output(build_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult)
