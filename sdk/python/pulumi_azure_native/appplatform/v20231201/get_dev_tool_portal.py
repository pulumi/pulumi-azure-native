...
def get_dev_tool_portal(dev_tool_portal_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20231201:getDevToolPortal', __args__, opts=opts, typ=GetDevToolPortalResult).value
...
def get_dev_tool_portal_output(dev_tool_portal_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20231201:getDevToolPortal', __args__, opts=opts, typ=GetDevToolPortalResult)
