...
def get_dev_tool_portal(dev_tool_portal_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dev_tool_portal_name: The name of Dev Tool Portal.
...
def get_dev_tool_portal_output(dev_tool_portal_name: Optional[pulumi.Input[builtins.str]] = None,
