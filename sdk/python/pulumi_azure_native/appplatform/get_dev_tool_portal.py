...
def get_dev_tool_portal(dev_tool_portal_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dev_tool_portal_name: The name of Dev Tool Portal.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getDevToolPortal', __args__, opts=opts, typ=GetDevToolPortalResult).value
...
def get_dev_tool_portal_output(dev_tool_portal_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getDevToolPortal', __args__, opts=opts, typ=GetDevToolPortalResult)
