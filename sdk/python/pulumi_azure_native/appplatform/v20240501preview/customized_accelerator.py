...
class CustomizedAccelerator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] application_accelerator_name: The name of the application accelerator.
        :param pulumi.Input[str] customized_accelerator_name: The name of the customized accelerator.
        :param pulumi.Input[Union['CustomizedAcceleratorPropertiesArgs', 'CustomizedAcceleratorPropertiesArgsDict']] properties: Customized accelerator properties payload
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        :param pulumi.Input[Union['SkuArgs', 'SkuArgsDict']] sku: Sku of the customized accelerator resource
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20231201:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform:CustomizedAccelerator")])
