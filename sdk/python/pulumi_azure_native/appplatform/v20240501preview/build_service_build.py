...
__all__ = ['BuildServiceBuildArgs', 'BuildServiceBuild']
...
class BuildServiceBuild(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[str] build_name: The name of the build resource.
        :param pulumi.Input[str] build_service_name: The name of the build service resource.
        :param pulumi.Input[Union['BuildPropertiesArgs', 'BuildPropertiesArgsDict']] properties: Properties of the build resource
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BuildServiceBuildArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20231201:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuild")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceBuild, __self__).__init__(
            'azure-native:appplatform/v20240501preview:BuildServiceBuild',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BuildServiceBuild':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BuildServiceBuild(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BuildPropertiesResponse']:
        """
        Properties of the build resource
        """
        return pulumi.get(self, "properties")
