...
__all__ = [
    ...
    'ConfigServerInstanceResponse',
    'ConfigServerPropertiesResponse',
    'ConfigServerResourceRequestsResponse',
...
class ApiPortalPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: str,
                 api_try_out_enabled_state: Optional[str] = None,
        ...
        :param str api_try_out_enabled_state: Indicates whether the API try-out feature is enabled or disabled. When enabled, users can try out the API by sending requests and viewing responses in API portal. When disabled, users cannot try out the API.
    ...
    def api_try_out_enabled_state(self) -> Optional[str]:
        """
...
class AppResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 test_endpoint_auth_state: Optional[str] = None,
        ...
        :param str test_endpoint_auth_state: State of test endpoint auth.
    ...
    def test_endpoint_auth_state(self) -> Optional[str]:
        """
...
class BuildpackPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Buildpack properties payload
        :param str version: Version of the buildpack
...
@pulumi.output_type
class ConfigServerInstanceResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Collection of instances belong to the Config Server, only available in Enterprise Plan.
        :param str name: Name of the Config Server instance
        :param str status: Status of the Config Server instance
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "status", status)
...
class ConfigServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 instances: Sequence['outputs.ConfigServerInstanceResponse'],
                 provisioning_state: str,
                 resource_requests: 'outputs.ConfigServerResourceRequestsResponse',
        ...
        """
        Config server git properties payload
        :param Sequence['ConfigServerInstanceResponse'] instances: Collection of instances belong to Config Server, only available in Enterprise Plan.
        :param str provisioning_state: State of the config server.
        :param 'ConfigServerResourceRequestsResponse' resource_requests: The requested resource quantity for required CPU and Memory, only available in Enterprise Plan.
    ...
    @property
    @pulumi.getter
    def instances(self) -> Sequence['outputs.ConfigServerInstanceResponse']:
        """
    ...
    @property
    @pulumi.getter(name="resourceRequests")
    def resource_requests(self) -> 'outputs.ConfigServerResourceRequestsResponse':
        """
...
@pulumi.output_type
class ConfigServerResourceRequestsResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ConfigServerResourceRequestsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ConfigServerResourceRequestsResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Resource request payload of Config Server, only available in Enterprise Plan.
        :param str cpu: CPU allocated to each Config Server instance
        :param int instance_count: Instance count of the Config Server
        :param str memory: Memory allocated to each Config Server instance
        """
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "instance_count", instance_count)
        pulumi.set(__self__, "memory", memory)
...
class ConfigurationServiceSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int refresh_interval_in_seconds: How often (in seconds) to check repository updates. Minimum value is 0.
        """
        if git_property is not None:
            pulumi.set(__self__, "git_property", git_property)
    ...
    def refresh_interval_in_seconds(self) -> Optional[int]:
        """
...
class GatewayLocalResponseCachePerInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 response_cache_type: str,
                 size: Optional[str] = None,
                 time_to_live: Optional[str] = None):
        """
        Spring Cloud Gateway local response cache per instance properties.
        :param str response_cache_type: The type of the response cache.
               Expected value is 'LocalCachePerInstance'.
        :param str size: Maximum size of cache (10MB, 900KB, 1GB...) to determine if the cache needs to evict some entries
        :param str time_to_live: Time before a cached entry is expired (300s, 5m, 1h...)
        """
    ...
    def response_cache_type(self) -> str:
        """
...
class ServiceVNetAddonsResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "privateStorageAccess":
            suggest = "private_storage_access"
    ...
    def __init__(__self__, *,
                 ...
                 private_storage_access: Optional[str] = None):
        """
        Additional Service settings in vnet injection instance
        ...
        :param str private_dns_zone_id: Fully qualified resource Id of the Private DNS zone to link with the customer virtual network.
        :param str private_storage_access: Indicates whether the vnet injection service enables private links for backend storage account and container registry.
        """
        ...
        if private_storage_access is not None:
            pulumi.set(__self__, "private_storage_access", private_storage_access)
    ...
    @property
    @pulumi.getter(name="privateStorageAccess")
    def private_storage_access(self) -> Optional[str]:
        """
        Indicates whether the vnet injection service enables private links for backend storage account and container registry.
        """
        return pulumi.get(self, "private_storage_access")
...
class TriggeredBuildResultResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_transition_status: Optional[str] = None,
                 last_transition_time: Optional[str] = None):
        """
        The build result triggered by a build
        :param str provisioning_state: The provisioning state of this build result
        :param str id: The unique build id of this build result
        :param str image: The container image of this build result
        :param str last_transition_reason: The last transition reason of this build result
        :param str last_transition_status: The last transition status of this build result
        :param str last_transition_time: The last transition time of this build result
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
        if id is not None:
            pulumi.set(__self__, "id", id)
    ...
    def last_transition_status(self) -> Optional[str]:
        """
