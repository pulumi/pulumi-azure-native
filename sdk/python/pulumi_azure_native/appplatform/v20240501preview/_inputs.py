...
class EnvVarArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret_value: secret environment variable value.
...
class JobExecutionTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        Job's execution template, containing configuration for an execution
        :param pulumi.Input[Sequence[pulumi.Input[str]]] args: Arguments for the Job execution.
...
class JobResourceRequestsArgs:
    def __init__(__self__, *,
        ...
        """
        Job resource request payload
        :param pulumi.Input[str] cpu: CPU allocated to each job execution instance.
        :param pulumi.Input[str] memory: Memory allocated to each job execution instance.
        """
        if cpu is None:
            cpu = '1'
        if cpu is not None:
...
class ManagedComponentReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        A reference to the managed component like Config Server.
        :param pulumi.Input[str] resource_id: Resource Id of the managed component
        """
        pulumi.set(__self__, "resource_id", resource_id)
...
class ManualJobTriggerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration for manual triggered job
        :param pulumi.Input[str] trigger_type: Type of job trigger
               Expected value is 'Manual'.
        :param pulumi.Input[int] parallelism: Number of parallel replicas of a job execution can run.
        :param pulumi.Input[int] retry_limit: Maximum number of retries before failing the job.
        :param pulumi.Input[int] timeout_in_seconds: Maximum number of seconds an execution is allowed to run.
        """
...
if not MYPY:
    class ServiceVNetAddonsArgsDict(TypedDict):
        ...
        """
        private_storage_access: NotRequired[pulumi.Input[Union[str, 'PrivateStorageAccess']]]
        """
...
class ServiceVNetAddonsArgs:
    def __init__(__self__, *,
                 ...
                 private_storage_access: Optional[pulumi.Input[Union[str, 'PrivateStorageAccess']]] = None):
        """
        Additional Service settings in vnet injection instance
        ...
        :param pulumi.Input[str] private_dns_zone_id: Fully qualified resource Id of the Private DNS zone to link with the customer virtual network.
        :param pulumi.Input[Union[str, 'PrivateStorageAccess']] private_storage_access: Indicates whether the vnet injection service enables private links for backend storage account and container registry.
        """
    ...
    def private_storage_access(self) -> Optional[pulumi.Input[Union[str, 'PrivateStorageAccess']]]:
        """
        Indicates whether the vnet injection service enables private links for backend storage account and container registry.
        """
        return pulumi.get(self, "private_storage_access")

    @private_storage_access.setter
    def private_storage_access(self, value: Optional[pulumi.Input[Union[str, 'PrivateStorageAccess']]]):
        pulumi.set(self, "private_storage_access", value)
