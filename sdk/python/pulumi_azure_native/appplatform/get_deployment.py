...
def get_deployment(app_name: Optional[_builtins.str] = None,
...
def get_deployment_output(app_name: pulumi.Input[Optional[_builtins.str]] = None,
                          deployment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
