...
warnings.warn("""azure-native:appplatform/v20220901preview:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Gateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[pulumi.InputType['SkuArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Gateway is deprecated: azure-native:appplatform/v20220901preview:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Gateway to guarantee forwards compatibility.""")
