...
def get_app_resource_upload_url(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220901preview:getAppResourceUploadUrl', __args__, opts=opts, typ=GetAppResourceUploadUrlResult).value
...
def get_app_resource_upload_url_output(app_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20220901preview:getAppResourceUploadUrl', __args__, opts=opts, typ=GetAppResourceUploadUrlResult)
