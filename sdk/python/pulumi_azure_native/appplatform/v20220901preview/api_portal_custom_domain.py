...
warnings.warn("""azure-native:appplatform/v20220901preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortalCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApiPortalCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiPortalCustomDomain is deprecated: azure-native:appplatform/v20220901preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortalCustomDomain to guarantee forwards compatibility.""")
