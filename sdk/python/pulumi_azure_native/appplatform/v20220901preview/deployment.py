...
warnings.warn("""azure-native:appplatform/v20220901preview:Deployment is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Deployment to guarantee forwards compatibility.""", DeprecationWarning)
...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[pulumi.InputType['SkuArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Deployment is deprecated: azure-native:appplatform/v20220901preview:Deployment is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Deployment to guarantee forwards compatibility.""")
