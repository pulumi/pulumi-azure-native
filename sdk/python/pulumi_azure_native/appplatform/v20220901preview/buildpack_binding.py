...
warnings.warn("""azure-native:appplatform/v20220901preview:BuildpackBinding is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildpackBinding to guarantee forwards compatibility.""", DeprecationWarning)
