...
def list_service_test_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220901preview:listServiceTestKeys', __args__, opts=opts, typ=ListServiceTestKeysResult).value
...
def list_service_test_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20220901preview:listServiceTestKeys', __args__, opts=opts, typ=ListServiceTestKeysResult)
