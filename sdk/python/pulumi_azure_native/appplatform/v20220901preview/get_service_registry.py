...
warnings.warn("""azure-native:appplatform/v20220901preview:ServiceRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service_registry(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_registry is deprecated: azure-native:appplatform/v20220901preview:ServiceRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.""")
    __args__ = dict()
