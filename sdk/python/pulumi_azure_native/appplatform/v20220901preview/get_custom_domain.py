...
warnings.warn("""azure-native:appplatform/v20220901preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_domain(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: azure-native:appplatform/v20220901preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
