...
warnings.warn("""azure-native:appplatform/v20220901preview:BuildServiceAgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.""", DeprecationWarning)
...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BuildServiceAgentPool is deprecated: azure-native:appplatform/v20220901preview:BuildServiceAgentPool is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.""")
