...
class ConfigurationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220401:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ConfigurationService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationService, __self__).__init__(
            'azure-native:appplatform/v20220901preview:ConfigurationService',
            resource_name,
            __props__,
            opts)
