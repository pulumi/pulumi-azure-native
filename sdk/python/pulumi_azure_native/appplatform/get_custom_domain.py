...
def get_custom_domain(app_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_name: The name of the custom domain resource.
...
def get_custom_domain_output(app_name: Optional[pulumi.Input[_builtins.str]] = None,
