...
def get_container_registry(container_registry_name: Optional[builtins.str] = None,
    ...
    :param builtins.str container_registry_name: The name of the container registry.
...
def get_container_registry_output(container_registry_name: Optional[pulumi.Input[builtins.str]] = None,
