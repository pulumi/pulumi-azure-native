...
def get_container_registry(container_registry_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str container_registry_name: The name of the container registry.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getContainerRegistry', __args__, opts=opts, typ=GetContainerRegistryResult).value
...
def get_container_registry_output(container_registry_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getContainerRegistry', __args__, opts=opts, typ=GetContainerRegistryResult)
