...
def get_binding(app_name: Optional[_builtins.str] = None,
                binding_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str binding_name: The name of the Binding resource.
...
def get_binding_output(app_name: pulumi.Input[Optional[_builtins.str]] = None,
                       binding_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getBinding', __args__, opts=opts, typ=GetBindingResult)
