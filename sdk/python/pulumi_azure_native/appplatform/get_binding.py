...
def get_binding(app_name: Optional[builtins.str] = None,
                binding_name: Optional[builtins.str] = None,
    ...
    :param builtins.str binding_name: The name of the Binding resource.
...
def get_binding_output(app_name: Optional[pulumi.Input[builtins.str]] = None,
