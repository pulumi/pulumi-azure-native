...
class GatewayRouteConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] route_config_name: The name of the Spring Cloud Gateway route config.
        """
    ...
    def route_config_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def route_config_name(self, value: Optional[pulumi.Input[builtins.str]]):
