...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        build_service_agent_pool = azure_native.appplatform.v20230301preview.BuildServiceAgentPool("buildServiceAgentPool",
            agent_pool_name="default",
            build_service_name="default",
            properties=azure_native.appplatform.v20230301preview.BuildServiceAgentPoolPropertiesResponseArgs(
                pool_size=azure_native.appplatform.v20230301preview.BuildServiceAgentPoolSizePropertiesArgs(
                    name="S3",
                ),
            ),
        ...
        ```sh
        $ pulumi import azure-native:appplatform/v20230301preview:BuildServiceAgentPool default /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/buildServices/default/agentPools/default 
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BuildServiceAgentPoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BuildServiceAgentPoolArgs.__new__(BuildServiceAgentPoolArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceAgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceAgentPool, __self__).__init__(
            'azure-native:appplatform/v20230301preview:BuildServiceAgentPool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BuildServiceAgentPool':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BuildServiceAgentPool(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BuildServiceAgentPoolPropertiesResponse']:
        """
        build service agent pool properties
        """
        return pulumi.get(self, "properties")
