...
class BuildServiceBuilder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceBuilder")])
