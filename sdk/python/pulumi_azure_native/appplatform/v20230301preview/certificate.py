...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Certificate")])
