...
class ApplicationAccelerator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_accelerator = azure_native.appplatform.v20230301preview.ApplicationAccelerator("applicationAccelerator",
            application_accelerator_name="default",
            resource_group_name="myResourceGroup",
            service_name="myservice",
            sku=azure_native.appplatform.v20230301preview.SkuArgs(
                capacity=2,
                name="E0",
                tier="Enterprise",
            ))
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApplicationAccelerator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationAccelerator, __self__).__init__(
            'azure-native:appplatform/v20230301preview:ApplicationAccelerator',
            resource_name,
            __props__,
            opts)
