...
def get_binding(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230301preview:getBinding', __args__, opts=opts, typ=GetBindingResult).value
...
def get_binding_output(app_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230301preview:getBinding', __args__, opts=opts, typ=GetBindingResult)
