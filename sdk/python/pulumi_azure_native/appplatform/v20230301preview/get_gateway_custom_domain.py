...
def get_gateway_custom_domain(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230301preview:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult).value
...
def get_gateway_custom_domain_output(domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230301preview:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult)
