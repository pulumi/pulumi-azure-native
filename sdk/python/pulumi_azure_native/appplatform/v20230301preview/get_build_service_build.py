...
def get_build_service_build(build_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230301preview:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult).value
...
def get_build_service_build_output(build_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230301preview:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult)
