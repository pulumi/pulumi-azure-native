...
class Deployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        deployment = azure_native.appplatform.v20230301preview.Deployment("deployment",
            app_name="myapp",
            deployment_name="mydeployment",
            properties=azure_native.appplatform.v20230301preview.DeploymentResourcePropertiesResponseArgs(
                deployment_settings={
                    "addonConfigs": {
                    ...
                    "livenessProbe": azure_native.appplatform.v20230301preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                        probe_action=azure_native.appplatform.v20230301preview.HTTPGetActionArgs(
                            path="/health",
                            scheme="HTTP",
                            type="HTTPGetAction",
                        ),
                    ),
                    "readinessProbe": azure_native.appplatform.v20230301preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                    ...
                    "resourceRequests": azure_native.appplatform.v20230301preview.ResourceRequestsArgs(
                        cpu="1000m",
                        memory="3Gi",
                    ),
                    "terminationGracePeriodSeconds": 30,
                },
                source=azure_native.appplatform.v20230301preview.SourceUploadedUserSourceInfoArgs(
        ...
        deployment = azure_native.appplatform.v20230301preview.Deployment("deployment",
            ...
            deployment_name="mydeployment",
            properties=azure_native.appplatform.v20230301preview.DeploymentResourcePropertiesResponseArgs(
                deployment_settings=azure_native.appplatform.v20230301preview.DeploymentSettingsArgs(
                    environment_variables={
                        "env": "test",
                    },
                    liveness_probe=azure_native.appplatform.v20230301preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                    ...
                    readiness_probe=azure_native.appplatform.v20230301preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                    ...
                    resource_requests=azure_native.appplatform.v20230301preview.ResourceRequestsArgs(
                        cpu="1000m",
                        memory="3Gi",
                    ),
                    termination_grace_period_seconds=30,
                ),
                source=azure_native.appplatform.v20230301preview.CustomContainerUserSourceInfoArgs(
                    custom_container=azure_native.appplatform.v20230301preview.CustomContainerArgs(
                        args=[
                            "-c",
                        ...
                        image_registry_credential=azure_native.appplatform.v20230301preview.ImageRegistryCredentialArgs(
                            password="myPassword",
                            username="myUsername",
                        ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azure-native:appplatform/v20230301preview:Deployment',
            resource_name,
            __props__,
            opts)
