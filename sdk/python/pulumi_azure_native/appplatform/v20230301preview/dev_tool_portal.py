...
class DevToolPortal(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20231201:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:DevToolPortal")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DevToolPortal, __self__).__init__(
            'azure-native:appplatform/v20230301preview:DevToolPortal',
            resource_name,
            __props__,
            opts)
