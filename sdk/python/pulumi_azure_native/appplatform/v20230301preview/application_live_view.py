...
class ApplicationLiveView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ApplicationLiveView")])
