...
class ApiPortalCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_portal_custom_domain = azure_native.appplatform.v20230301preview.ApiPortalCustomDomain("apiPortalCustomDomain",
            api_portal_name="default",
            domain_name="myDomainName",
            properties=azure_native.appplatform.v20230301preview.ApiPortalCustomDomainPropertiesArgs(
                thumbprint="*",
            ),
        ...
        ```sh
        $ pulumi import azure-native:appplatform/v20230301preview:ApiPortalCustomDomain myDomainName /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/apiPortals/default/domains/myDomainName 
        ```
