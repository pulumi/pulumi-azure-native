...
class CustomizedAccelerator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        customized_accelerator = azure_native.appplatform.v20230301preview.CustomizedAccelerator("customizedAccelerator",
            application_accelerator_name="default",
            customized_accelerator_name="acc-name",
            properties=azure_native.appplatform.v20230301preview.CustomizedAcceleratorPropertiesResponseArgs(
                accelerator_tags=[
                    "tag-a",
                    "tag-b",
                ],
                ...
                git_repository={
                    "authSetting": azure_native.appplatform.v20230301preview.AcceleratorSshSettingArgs(
                        auth_type="SSH",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:CustomizedAccelerator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomizedAccelerator, __self__).__init__(
            'azure-native:appplatform/v20230301preview:CustomizedAccelerator',
            resource_name,
            __props__,
            opts)
