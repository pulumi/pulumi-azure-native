...
class BuildServiceBuild(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceBuild")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceBuild, __self__).__init__(
            'azure-native:appplatform/v20230301preview:BuildServiceBuild',
            resource_name,
            __props__,
            opts)
