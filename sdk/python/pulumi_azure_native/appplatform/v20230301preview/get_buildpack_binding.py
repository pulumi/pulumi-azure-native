...
def get_buildpack_binding(build_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230301preview:getBuildpackBinding', __args__, opts=opts, typ=GetBuildpackBindingResult).value
...
def get_buildpack_binding_output(build_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230301preview:getBuildpackBinding', __args__, opts=opts, typ=GetBuildpackBindingResult)
