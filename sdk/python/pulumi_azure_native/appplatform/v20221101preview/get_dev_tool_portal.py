...
def get_dev_tool_portal(dev_tool_portal_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_tool_portal is deprecated: azure-native:appplatform/v20221101preview:DevToolPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:DevToolPortal to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['devToolPortalName'] = dev_tool_portal_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20221101preview:getDevToolPortal', __args__, opts=opts, typ=GetDevToolPortalResult).value
