...
def get_dev_tool_portal(dev_tool_portal_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_tool_portal is deprecated: azure-native:appplatform/v20221101preview:DevToolPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:DevToolPortal to guarantee forwards compatibility.""")
    __args__ = dict()
