...
def get_storage(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage is deprecated: azure-native:appplatform/v20221101preview:Storage is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Storage to guarantee forwards compatibility.""")
    __args__ = dict()
