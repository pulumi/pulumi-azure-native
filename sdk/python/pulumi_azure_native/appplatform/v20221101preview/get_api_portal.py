...
warnings.warn("""azure-native:appplatform/v20221101preview:ApiPortal is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ApiPortal to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_api_portal(api_portal_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_portal is deprecated: azure-native:appplatform/v20221101preview:ApiPortal is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ApiPortal to guarantee forwards compatibility.""")
    __args__ = dict()
