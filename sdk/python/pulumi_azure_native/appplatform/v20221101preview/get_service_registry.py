...
def get_service_registry(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_registry is deprecated: azure-native:appplatform/v20221101preview:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ServiceRegistry to guarantee forwards compatibility.""")
    __args__ = dict()
