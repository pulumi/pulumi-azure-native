...
def get_gateway_custom_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_custom_domain is deprecated: azure-native:appplatform/v20221101preview:GatewayCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:GatewayCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
