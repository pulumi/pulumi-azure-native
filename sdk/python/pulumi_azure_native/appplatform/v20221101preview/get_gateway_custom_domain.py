...
def get_gateway_custom_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_custom_domain is deprecated: azure-native:appplatform/v20221101preview:GatewayCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:GatewayCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20221101preview:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult).value
