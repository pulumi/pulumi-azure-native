...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:Gateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gateway, __self__).__init__(
            'azure-native:appplatform/v20221101preview:Gateway',
            resource_name,
            __props__,
            opts)
