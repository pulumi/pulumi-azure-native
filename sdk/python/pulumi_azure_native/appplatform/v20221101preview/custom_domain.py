...
class CustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 domain_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['CustomDomainPropertiesArgs', 'CustomDomainPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] app_name: The name of the App resource.
        :param pulumi.Input[str] domain_name: The name of the custom domain resource.
        :param pulumi.Input[Union['CustomDomainPropertiesArgs', 'CustomDomainPropertiesArgsDict']] properties: Properties of the custom domain resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20200701:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220401:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221201:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231201:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:CustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomDomain, __self__).__init__(
            'azure-native:appplatform/v20221101preview:CustomDomain',
            resource_name,
            __props__,
            opts)
