...
warnings.warn("""azure-native:appplatform/v20221101preview:ApiPortalCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ApiPortalCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
