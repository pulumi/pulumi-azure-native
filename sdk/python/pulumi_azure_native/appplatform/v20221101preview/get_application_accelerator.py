...
def get_application_accelerator_output(application_accelerator_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20221101preview:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult)
