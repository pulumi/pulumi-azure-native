...
def get_application_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_accelerator is deprecated: azure-native:appplatform/v20221101preview:ApplicationAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApplicationAccelerator to guarantee forwards compatibility.""")
    __args__ = dict()
