...
warnings.warn("""azure-native:appplatform/v20221101preview:ApplicationAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApplicationAccelerator to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApplicationAccelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[pulumi.InputType['SkuArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationAccelerator is deprecated: azure-native:appplatform/v20221101preview:ApplicationAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApplicationAccelerator to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApplicationAccelerator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationAccelerator, __self__).__init__(
            'azure-native:appplatform/v20221101preview:ApplicationAccelerator',
            resource_name,
            __props__,
            opts)
