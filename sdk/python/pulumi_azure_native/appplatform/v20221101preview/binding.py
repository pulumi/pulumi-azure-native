...
class Binding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 binding_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['BindingResourcePropertiesArgs', 'BindingResourcePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] app_name: The name of the App resource.
        :param pulumi.Input[str] binding_name: The name of the Binding resource.
        :param pulumi.Input[Union['BindingResourcePropertiesArgs', 'BindingResourcePropertiesArgsDict']] properties: Properties of the Binding resource
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:Binding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Binding, __self__).__init__(
            'azure-native:appplatform/v20221101preview:Binding',
            resource_name,
            __props__,
            opts)
