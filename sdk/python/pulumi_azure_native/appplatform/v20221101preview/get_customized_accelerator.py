...
warnings.warn("""azure-native:appplatform/v20221101preview:CustomizedAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:CustomizedAccelerator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_customized_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_customized_accelerator is deprecated: azure-native:appplatform/v20221101preview:CustomizedAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:CustomizedAccelerator to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20221101preview:getCustomizedAccelerator', __args__, opts=opts, typ=GetCustomizedAcceleratorResult).value
