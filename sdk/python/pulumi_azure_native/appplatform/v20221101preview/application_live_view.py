...
warnings.warn("""azure-native:appplatform/v20221101preview:ApplicationLiveView is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ApplicationLiveView to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApplicationLiveView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationLiveView is deprecated: azure-native:appplatform/v20221101preview:ApplicationLiveView is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ApplicationLiveView to guarantee forwards compatibility.""")
