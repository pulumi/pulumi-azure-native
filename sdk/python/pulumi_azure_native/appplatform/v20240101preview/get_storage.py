...
def get_storage(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20240101preview:getStorage', __args__, opts=opts, typ=GetStorageResult).value
...
def get_storage_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageName'] = storage_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20240101preview:getStorage', __args__, opts=opts, typ=GetStorageResult)
