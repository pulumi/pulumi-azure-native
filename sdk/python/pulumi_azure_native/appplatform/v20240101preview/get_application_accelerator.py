...
def get_application_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20240101preview:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult).value
...
def get_application_accelerator_output(application_accelerator_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20240101preview:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult)
