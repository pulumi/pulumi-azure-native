...
def get_build_service_build(build_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20240101preview:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult).value
...
def get_build_service_build_output(build_name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBuildServiceBuildResult]:
    """
    Get a KPack build.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20240101preview:getBuildServiceBuild', __args__, opts=opts, typ=GetBuildServiceBuildResult)
    return __ret__.apply(lambda __response__: GetBuildServiceBuildResult(
