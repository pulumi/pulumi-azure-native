...
def get_configuration_service(configuration_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20240101preview:getConfigurationService', __args__, opts=opts, typ=GetConfigurationServiceResult).value
...
def get_configuration_service_output(configuration_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20240101preview:getConfigurationService', __args__, opts=opts, typ=GetConfigurationServiceResult)
