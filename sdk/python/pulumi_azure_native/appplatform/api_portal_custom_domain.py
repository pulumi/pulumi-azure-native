...
class ApiPortalCustomDomainArgs:
    def __init__(__self__, *,
                 api_portal_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] domain_name: The name of the API portal custom domain.
    ...
    def api_portal_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def api_portal_name(self, value: pulumi.Input[builtins.str]):
