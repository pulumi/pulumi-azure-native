...
def get_api_portal(api_portal_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult).value
...
def get_api_portal_output(api_portal_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230901preview:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult)
