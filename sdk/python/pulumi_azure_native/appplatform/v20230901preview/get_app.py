...
def get_app(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:getApp', __args__, opts=opts, typ=GetAppResult).value
...
def get_app_output(app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['syncStatus'] = sync_status
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230901preview:getApp', __args__, opts=opts, typ=GetAppResult)
