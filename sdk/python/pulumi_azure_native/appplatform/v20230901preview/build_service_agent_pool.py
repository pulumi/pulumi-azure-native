...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20231201:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform:BuildServiceAgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceAgentPool, __self__).__init__(
            'azure-native:appplatform/v20230901preview:BuildServiceAgentPool',
            resource_name,
            __props__,
            opts)
