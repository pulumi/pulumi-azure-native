...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, BuildServiceAgentPoolPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                BuildServiceAgentPoolPropertiesArgs._configure(_setter, **properties)
