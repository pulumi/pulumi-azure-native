...
def get_service_registry(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:getServiceRegistry', __args__, opts=opts, typ=GetServiceRegistryResult).value
...
def get_service_registry_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceRegistryName'] = service_registry_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230901preview:getServiceRegistry', __args__, opts=opts, typ=GetServiceRegistryResult)
