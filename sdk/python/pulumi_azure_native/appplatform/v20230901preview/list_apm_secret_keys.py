...
def list_apm_secret_keys(apm_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:listApmSecretKeys', __args__, opts=opts, typ=ListApmSecretKeysResult).value
...
def list_apm_secret_keys_output(apm_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230901preview:listApmSecretKeys', __args__, opts=opts, typ=ListApmSecretKeysResult)
