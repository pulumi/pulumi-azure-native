...
def get_gateway_route_config(gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:getGatewayRouteConfig', __args__, opts=opts, typ=GetGatewayRouteConfigResult).value
