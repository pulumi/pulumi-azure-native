...
class Apm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Apm")])
