...
class ApmArgs:
    ...
    def _configure(
        ...
        if apm_name is None and 'apmName' in kwargs:
            apm_name = kwargs['apmName']

        _setter("resource_group_name", resource_group_name)
        _setter("service_name", service_name)
        if apm_name is not None:
            _setter("apm_name", apm_name)
...
class Apm(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ApmArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ApmPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Apm")])
