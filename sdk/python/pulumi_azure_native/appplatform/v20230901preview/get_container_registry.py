...
def get_container_registry(container_registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230901preview:getContainerRegistry', __args__, opts=opts, typ=GetContainerRegistryResult).value
...
def get_container_registry_output(container_registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230901preview:getContainerRegistry', __args__, opts=opts, typ=GetContainerRegistryResult)
