...
class ApplicationAccelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform:ApplicationAccelerator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationAccelerator, __self__).__init__(
            'azure-native:appplatform/v20230901preview:ApplicationAccelerator',
            resource_name,
            __props__,
            opts)
