...
def list_job_execution_env_secrets(job_execution_name: Optional[builtins.str] = None,
    ...
    :param builtins.str job_execution_name: The name of the Job execution.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:listJobExecutionEnvSecrets', __args__, opts=opts, typ=ListJobExecutionEnvSecretsResult).value

    return AwaitableListJobExecutionEnvSecretsResult(
        value=pulumi.get(__ret__, 'value'))
def list_job_execution_env_secrets_output(job_execution_name: Optional[pulumi.Input[builtins.str]] = None,
