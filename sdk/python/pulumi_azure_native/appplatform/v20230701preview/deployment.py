...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Deployment")])
