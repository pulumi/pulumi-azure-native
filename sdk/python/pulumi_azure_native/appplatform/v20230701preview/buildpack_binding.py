...
class BuildpackBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20231201:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform:BuildpackBinding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildpackBinding, __self__).__init__(
            'azure-native:appplatform/v20230701preview:BuildpackBinding',
            resource_name,
            __props__,
            opts)
