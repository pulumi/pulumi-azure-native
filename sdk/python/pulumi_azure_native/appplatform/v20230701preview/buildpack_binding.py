...
class BuildpackBindingArgs:
    ...
    def _configure(
        ...
        if builder_name is None:
            raise TypeError("Missing 'builder_name' argument")
        ...
        if buildpack_binding_name is None and 'buildpackBindingName' in kwargs:
            buildpack_binding_name = kwargs['buildpackBindingName']
...
class BuildpackBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, BuildpackBindingPropertiesArgs, True)
