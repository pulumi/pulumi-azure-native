...
class BindingArgs:
    ...
    def _configure(
        ...
        if binding_name is None and 'bindingName' in kwargs:
            binding_name = kwargs['bindingName']

        _setter("app_name", app_name)
        _setter("resource_group_name", resource_group_name)
        _setter("service_name", service_name)
        if binding_name is not None:
            _setter("binding_name", binding_name)
...
class Binding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, BindingResourcePropertiesArgs, True)
