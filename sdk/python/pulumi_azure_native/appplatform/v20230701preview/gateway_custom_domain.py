...
class GatewayCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221201:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231201:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform:GatewayCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayCustomDomain, __self__).__init__(
            'azure-native:appplatform/v20230701preview:GatewayCustomDomain',
            resource_name,
            __props__,
            opts)
