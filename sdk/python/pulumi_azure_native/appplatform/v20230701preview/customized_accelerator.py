...
class CustomizedAcceleratorArgs:
    ...
    def _configure(
        ...
        if 'customizedAcceleratorName' in kwargs:
...
class CustomizedAccelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, CustomizedAcceleratorPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                CustomizedAcceleratorPropertiesArgs._configure(_setter, **properties)
