...
class DevToolPortalArgs:
    ...
    def _configure(
        ...
        if dev_tool_portal_name is None and 'devToolPortalName' in kwargs:
            dev_tool_portal_name = kwargs['devToolPortalName']
...
class DevToolPortal(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, DevToolPortalPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:DevToolPortal")])
