...
class Apm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Apm"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:Apm")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Apm, __self__).__init__(
            'azure-native:appplatform/v20230701preview:Apm',
            resource_name,
            __props__,
            opts)
