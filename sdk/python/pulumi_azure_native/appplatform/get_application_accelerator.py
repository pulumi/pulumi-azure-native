...
def get_application_accelerator(application_accelerator_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult).value
...
def get_application_accelerator_output(application_accelerator_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult)
    return __ret__.apply(lambda __response__: GetApplicationAcceleratorResult(
