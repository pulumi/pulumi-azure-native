...
def get_application_accelerator(application_accelerator_name: Optional[builtins.str] = None,
...
def get_application_accelerator_output(application_accelerator_name: Optional[pulumi.Input[builtins.str]] = None,
