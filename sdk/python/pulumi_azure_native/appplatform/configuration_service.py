...
class ConfigurationServiceArgs:
    def __init__(__self__, *,
                 ...
                 configuration_service_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] configuration_service_name: The name of Application Configuration Service.
    ...
    def configuration_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConfigurationService(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:appplatform:ConfigurationService"
