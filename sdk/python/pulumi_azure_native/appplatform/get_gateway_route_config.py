...
def get_gateway_route_config(gateway_name: Optional[_builtins.str] = None,
                             resource_group_name: Optional[_builtins.str] = None,
                             route_config_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str route_config_name: The name of the Spring Cloud Gateway route config.
