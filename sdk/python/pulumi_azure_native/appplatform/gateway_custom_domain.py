...
class GatewayCustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] gateway_name: The name of Spring Cloud Gateway.
        ...
        :param pulumi.Input[builtins.str] domain_name: The name of the Spring Cloud Gateway custom domain.
