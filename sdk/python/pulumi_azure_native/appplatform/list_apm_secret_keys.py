...
def list_apm_secret_keys(apm_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:listApmSecretKeys', __args__, opts=opts, typ=ListApmSecretKeysResult).value

    return AwaitableListApmSecretKeysResult(
        value=pulumi.get(__ret__, 'value'))
def list_apm_secret_keys_output(apm_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:listApmSecretKeys', __args__, opts=opts, typ=ListApmSecretKeysResult)
