...
def get_storage(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str storage_name: The name of the storage resource.
    """
    __args__ = dict()
...
def get_storage_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
