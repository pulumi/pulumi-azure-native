...
def get_storage(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str storage_name: The name of the storage resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getStorage', __args__, opts=opts, typ=GetStorageResult).value
...
def get_storage_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getStorage', __args__, opts=opts, typ=GetStorageResult)
