...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BuildServiceAgentPool is deprecated: azure-native:appplatform/v20220301preview:BuildServiceAgentPool is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:BuildServiceAgentPool to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceAgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceAgentPool, __self__).__init__(
            'azure-native:appplatform/v20220301preview:BuildServiceAgentPool',
            resource_name,
            __props__,
            opts)
