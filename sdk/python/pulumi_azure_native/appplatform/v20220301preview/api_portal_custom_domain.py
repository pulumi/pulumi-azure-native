...
class ApiPortalCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ApiPortalCustomDomain")])
