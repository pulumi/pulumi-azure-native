...
def get_binding(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_binding is deprecated: azure-native:appplatform/v20220301preview:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Binding to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220301preview:getBinding', __args__, opts=opts, typ=GetBindingResult).value
