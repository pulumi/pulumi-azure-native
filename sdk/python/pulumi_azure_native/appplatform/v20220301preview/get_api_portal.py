...
def get_api_portal(api_portal_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_portal is deprecated: azure-native:appplatform/v20220301preview:ApiPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortal to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['apiPortalName'] = api_portal_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220301preview:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult).value
