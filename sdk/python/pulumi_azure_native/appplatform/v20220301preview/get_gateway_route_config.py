...
warnings.warn("""azure-native:appplatform/v20220301preview:GatewayRouteConfig is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:GatewayRouteConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_gateway_route_config(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_route_config is deprecated: azure-native:appplatform/v20220301preview:GatewayRouteConfig is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:GatewayRouteConfig to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220301preview:getGatewayRouteConfig', __args__, opts=opts, typ=GetGatewayRouteConfigResult).value
