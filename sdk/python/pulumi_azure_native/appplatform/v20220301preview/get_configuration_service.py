...
def get_configuration_service_output(configuration_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20220301preview:getConfigurationService', __args__, opts=opts, typ=GetConfigurationServiceResult)
