...
if not MYPY:
    class AppResourcePropertiesArgsDict(TypedDict):
        ...
        """
        active_deployment_name: NotRequired[pulumi.Input[str]]
        """
...
if not MYPY:
    class BindingResourcePropertiesArgsDict(TypedDict):
        ...
        """
        binding_parameters: NotRequired[pulumi.Input[Mapping[str, Any]]]
        """
...
if not MYPY:
    class DeploymentResourcePropertiesArgsDict(TypedDict):
        ...
        """
        source: NotRequired[pulumi.Input['UserSourceInfoArgsDict']]
        """
...
if not MYPY:
    class DeploymentSettingsArgsDict(TypedDict):
        ...
        JVM parameter
        """
        memory_in_gb: NotRequired[pulumi.Input[int]]
        """
        ...
        """
        runtime_version: NotRequired[pulumi.Input[Union[str, 'RuntimeVersion']]]
        """
        Runtime version
        """
elif False:
...
if not MYPY:
    class UserSourceInfoArgsDict(TypedDict):
        """
        ...
        """
        type: NotRequired[pulumi.Input[Union[str, 'UserSourceType']]]
        """
    ...
    UserSourceInfoArgsDict: TypeAlias = Mapping[str, Any]
