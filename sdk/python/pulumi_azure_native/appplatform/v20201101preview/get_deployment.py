...
warnings.warn("""Version 2020-11-01-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_deployment(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment is deprecated: Version 2020-11-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
