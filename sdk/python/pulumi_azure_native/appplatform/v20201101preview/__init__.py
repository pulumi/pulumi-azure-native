...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:appplatform/v20201101preview:App":
                return App(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/v20201101preview:Binding":
                return Binding(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/v20201101preview:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/v20201101preview:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/v20201101preview:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appplatform/v20201101preview:Service":
    ...
    pulumi.runtime.register_resource_module("azure-native", "appplatform/v20201101preview", _module_instance)
