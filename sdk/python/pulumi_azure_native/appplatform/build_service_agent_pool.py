...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceAgentPool")])
