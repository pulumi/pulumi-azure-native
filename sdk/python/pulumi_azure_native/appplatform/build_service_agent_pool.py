...
class BuildServiceAgentPoolArgs:
    def __init__(__self__, *,
                 build_service_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] build_service_name: The name of the build service resource.
        ...
        :param pulumi.Input[builtins.str] agent_pool_name: The name of the build service agent pool resource.
    ...
    def build_service_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def build_service_name(self, value: pulumi.Input[builtins.str]):
