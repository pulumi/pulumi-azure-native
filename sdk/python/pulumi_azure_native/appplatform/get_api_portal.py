...
def get_api_portal(api_portal_name: Optional[builtins.str] = None,
    ...
    :param builtins.str api_portal_name: The name of API portal.
...
def get_api_portal_output(api_portal_name: Optional[pulumi.Input[builtins.str]] = None,
