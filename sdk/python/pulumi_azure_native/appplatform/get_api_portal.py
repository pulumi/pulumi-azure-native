...
def get_api_portal(api_portal_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str api_portal_name: The name of API portal.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult).value
...
def get_api_portal_output(api_portal_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult)
