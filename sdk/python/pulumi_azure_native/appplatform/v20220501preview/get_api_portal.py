...
def get_api_portal_output(api_portal_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20220501preview:getApiPortal', __args__, opts=opts, typ=GetApiPortalResult)
    return __ret__.apply(lambda __response__: GetApiPortalResult(
