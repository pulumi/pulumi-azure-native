...
warnings.warn("""azure-native:appplatform/v20220501preview:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service_registry(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_registry is deprecated: azure-native:appplatform/v20220501preview:ServiceRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ServiceRegistry to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    __args__['serviceRegistryName'] = service_registry_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220501preview:getServiceRegistry', __args__, opts=opts, typ=GetServiceRegistryResult).value
