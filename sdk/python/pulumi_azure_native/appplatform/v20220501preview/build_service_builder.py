...
class BuildServiceBuilder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BuildServiceBuilder is deprecated: azure-native:appplatform/v20220501preview:BuildServiceBuilder is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:BuildServiceBuilder to guarantee forwards compatibility.""")
