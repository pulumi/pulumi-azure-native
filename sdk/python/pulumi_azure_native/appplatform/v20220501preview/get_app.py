...
def get_app(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app is deprecated: azure-native:appplatform/v20220501preview:App is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:App to guarantee forwards compatibility.""")
    __args__ = dict()
