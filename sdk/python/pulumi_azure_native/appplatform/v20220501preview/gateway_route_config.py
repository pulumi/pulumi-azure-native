...
warnings.warn("""azure-native:appplatform/v20220501preview:GatewayRouteConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:GatewayRouteConfig to guarantee forwards compatibility.""", DeprecationWarning)
