...
class GatewayRouteConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20221201:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20231201:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:GatewayRouteConfig")])
