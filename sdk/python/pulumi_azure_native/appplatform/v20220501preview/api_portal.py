...
class ApiPortal(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[pulumi.InputType['SkuArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ApiPortal is deprecated: azure-native:appplatform/v20220501preview:ApiPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ApiPortal to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApiPortal")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiPortal, __self__).__init__(
            'azure-native:appplatform/v20220501preview:ApiPortal',
            resource_name,
            __props__,
            opts)
