...
class BuildpackBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] buildpack_binding_name: The name of the Buildpack Binding Name
    ...
    def buildpack_binding_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def buildpack_binding_name(self, value: Optional[pulumi.Input[builtins.str]]):
