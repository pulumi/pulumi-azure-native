...
def get_gateway_custom_domain(domain_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_name: The name of the Spring Cloud Gateway custom domain.
    :param _builtins.str gateway_name: The name of Spring Cloud Gateway.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult).value
...
def get_gateway_custom_domain_output(domain_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult)
