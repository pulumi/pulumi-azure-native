...
def get_gateway_custom_domain(domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_name: The name of the Spring Cloud Gateway custom domain.
    :param builtins.str gateway_name: The name of Spring Cloud Gateway.
...
def get_gateway_custom_domain_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
