...
warnings.warn("""azure-native:appplatform/v20221201:Gateway is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Gateway to guarantee forwards compatibility.""", DeprecationWarning)
