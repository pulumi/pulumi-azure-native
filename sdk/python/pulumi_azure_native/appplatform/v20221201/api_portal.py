...
class ApiPortal(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApiPortal")])
