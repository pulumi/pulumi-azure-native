...
def get_api_portal(api_portal_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_portal is deprecated: azure-native:appplatform/v20221201:ApiPortal is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApiPortal to guarantee forwards compatibility.""")
    __args__ = dict()
