...
def get_binding(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_binding is deprecated: azure-native:appplatform/v20221201:Binding is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:Binding to guarantee forwards compatibility.""")
    __args__ = dict()
