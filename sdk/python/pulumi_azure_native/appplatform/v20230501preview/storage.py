...
class StorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] storage_name: The name of the storage resource.
        """
...
class Storage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['StorageAccountArgs', 'StorageAccountArgsDict']] properties: Properties of the storage resource payload.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        :param pulumi.Input[str] storage_name: The name of the storage resource.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:Storage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Storage, __self__).__init__(
            'azure-native:appplatform/v20230501preview:Storage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Storage':
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StorageAccountResponse']:
        """
        Properties of the storage resource payload.
        """
        return pulumi.get(self, "properties")
