...
class ConfigurationServiceArgs:
    def __init__(__self__, *,
        ...
        """
        ConfigurationServiceArgs._configure(
    ...
    def _configure(
        ...
        if configuration_service_name is None and 'configurationServiceName' in kwargs:
            configuration_service_name = kwargs['configurationServiceName']

        _setter("resource_group_name", resource_group_name)
        _setter("service_name", service_name)
        if configuration_service_name is not None:
            _setter("configuration_service_name", configuration_service_name)
...
class ConfigurationService(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ConfigurationServiceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ConfigurationServicePropertiesArgs, True)
