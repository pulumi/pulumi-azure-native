...
class ConfigurationServiceArgs:
    ...
    def _configure(
        ...
        if 'configurationServiceName' in kwargs:
...
class ConfigurationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ConfigurationServicePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ConfigurationServicePropertiesArgs._configure(_setter, **properties)
