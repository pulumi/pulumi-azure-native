...
class GatewayRouteConfigArgs:
    ...
    def _configure(
        ...
        if route_config_name is None and 'routeConfigName' in kwargs:
            route_config_name = kwargs['routeConfigName']
...
class GatewayRouteConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, GatewayRouteConfigPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20221201:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:GatewayRouteConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayRouteConfig, __self__).__init__(
            'azure-native:appplatform/v20230501preview:GatewayRouteConfig',
            resource_name,
            __props__,
            opts)
