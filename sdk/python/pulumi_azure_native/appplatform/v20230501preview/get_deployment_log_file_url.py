...
def get_deployment_log_file_url(app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230501preview:getDeploymentLogFileUrl', __args__, opts=opts, typ=GetDeploymentLogFileUrlResult).value
...
def get_deployment_log_file_url_output(app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20230501preview:getDeploymentLogFileUrl', __args__, opts=opts, typ=GetDeploymentLogFileUrlResult)
