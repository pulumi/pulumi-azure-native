...
class ApiPortalCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ApiPortalCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ApiPortalCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiPortalCustomDomain, __self__).__init__(
            'azure-native:appplatform/v20230501preview:ApiPortalCustomDomain',
            resource_name,
            __props__,
            opts)
