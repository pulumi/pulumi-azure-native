...
class BuildServiceBuild(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, BuildPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                BuildPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:BuildServiceBuild")])
