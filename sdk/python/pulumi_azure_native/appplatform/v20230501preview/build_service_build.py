...
class BuildServiceBuildArgs:
    def __init__(__self__, *,
        ...
        """
        BuildServiceBuildArgs._configure(
    ...
    def _configure(
        ...
        if build_name is None and 'buildName' in kwargs:
            build_name = kwargs['buildName']

        _setter("build_service_name", build_service_name)
        _setter("resource_group_name", resource_group_name)
        _setter("service_name", service_name)
        if build_name is not None:
            _setter("build_name", build_name)
...
class BuildServiceBuild(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BuildServiceBuildArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, BuildPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:BuildServiceBuild"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:BuildServiceBuild")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceBuild, __self__).__init__(
            'azure-native:appplatform/v20230501preview:BuildServiceBuild',
            resource_name,
            __props__,
            opts)
