...
class ApplicationLiveView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform:ApplicationLiveView")])
