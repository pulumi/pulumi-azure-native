...
def get_custom_domain(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: azure-native:appplatform/v20220401:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:CustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
