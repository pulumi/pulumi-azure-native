...
class ConfigurationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationService is deprecated: azure-native:appplatform/v20220401:ConfigurationService is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ConfigurationService to guarantee forwards compatibility.""")
