...
class ConfigurationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationService is deprecated: azure-native:appplatform/v20220401:ConfigurationService is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:ConfigurationService to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ConfigurationService"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ConfigurationService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationService, __self__).__init__(
            'azure-native:appplatform/v20220401:ConfigurationService',
            resource_name,
            __props__,
            opts)
