...
class ConfigurationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationService is deprecated: azure-native:appplatform/v20220401:ConfigurationService is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:ConfigurationService to guarantee forwards compatibility.""")
