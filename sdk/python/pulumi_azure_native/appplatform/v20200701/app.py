...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:App"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220401:App"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20221201:App"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:App")])
