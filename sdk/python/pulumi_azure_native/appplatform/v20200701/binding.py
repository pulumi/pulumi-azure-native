...
class Binding(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform:Binding"), pulumi.Alias(type_="azure-native:appplatform/latest:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:Binding")])
