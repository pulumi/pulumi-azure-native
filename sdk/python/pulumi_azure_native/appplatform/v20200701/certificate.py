...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate = azure_native.appplatform.v20200701.Certificate("certificate",
            certificate_name="mycertificate",
            properties=azure_native.appplatform.v20200701.CertificatePropertiesResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Certificate"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Certificate")])
