...
class CustomDomain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/latest:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:CustomDomain")])
