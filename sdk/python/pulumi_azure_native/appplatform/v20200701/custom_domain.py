...
class CustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20210601preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20210901preview:CustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomDomain, __self__).__init__(
            'azure-native:appplatform/v20200701:CustomDomain',
            resource_name,
            __props__,
            opts)
