...
class CustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:CustomDomain")])
