...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service = azure_native.appplatform.v20200701.Service("service",
            location="eastus",
            properties=azure_native.appplatform.v20200701.ClusterResourcePropertiesArgs(),
            resource_group_name="myResourceGroup",
            service_name="myservice",
            sku=azure_native.appplatform.v20200701.SkuArgs(
                name="S0",
                tier="Standard",
            ),
            tags={
        ...
        service = azure_native.appplatform.v20200701.Service("service",
            location="eastus",
            properties=azure_native.appplatform.v20200701.ClusterResourcePropertiesResponseArgs(
                network_profile=azure_native.appplatform.v20200701.NetworkProfileArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Service"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Service"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Service")])
