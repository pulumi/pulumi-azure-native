...
class MonitoringSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20200701:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20220401:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20221201:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20231201:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:MonitoringSetting"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:MonitoringSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MonitoringSetting, __self__).__init__(
            'azure-native:appplatform/v20220101preview:MonitoringSetting',
            resource_name,
            __props__,
            opts)
