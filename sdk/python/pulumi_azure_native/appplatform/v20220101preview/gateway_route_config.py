...
class GatewayRouteConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway_route_config = azure_native.appplatform.v20220101preview.GatewayRouteConfig("gatewayRouteConfig",
            gateway_name="default",
            properties=azure_native.appplatform.v20220101preview.GatewayRouteConfigPropertiesResponseArgs(
                ...
                routes=[azure_native.appplatform.v20220101preview.GatewayApiRouteArgs(
                    filters=[
                        "StripPrefix=2",
                        "RateLimit=1,1s",
                    ],
        ...
        ```sh
        $ pulumi import azure-native:appplatform/v20220101preview:GatewayRouteConfig myRouteConfig /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/gateways/default/routeConfigs/myRouteConfig 
        ```
