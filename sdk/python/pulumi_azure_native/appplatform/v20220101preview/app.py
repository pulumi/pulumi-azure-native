...
warnings.warn("""azure-native:appplatform/v20220101preview:App is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:App to guarantee forwards compatibility.""", DeprecationWarning)
...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""App is deprecated: azure-native:appplatform/v20220101preview:App is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:App to guarantee forwards compatibility.""")
