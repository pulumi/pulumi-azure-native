...
class ConfigurationService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_service = azure_native.appplatform.v20220101preview.ConfigurationService("configurationService",
            configuration_service_name="default",
            properties=azure_native.appplatform.v20220101preview.ConfigurationServicePropertiesResponseArgs(
                settings={
                    "gitProperty": {
                        "repositories": [azure_native.appplatform.v20220101preview.ConfigurationServiceGitRepositoryArgs(
                            label="master",
                            name="fake",
                            patterns=["app/dev"],
