...
class BuildServiceAgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        build_service_agent_pool = azure_native.appplatform.v20220101preview.BuildServiceAgentPool("buildServiceAgentPool",
            agent_pool_name="default",
            build_service_name="default",
            properties=azure_native.appplatform.v20220101preview.BuildServiceAgentPoolPropertiesResponseArgs(
                pool_size=azure_native.appplatform.v20220101preview.BuildServiceAgentPoolSizePropertiesArgs(
                    name="S3",
                ),
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceAgentPool"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceAgentPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceAgentPool, __self__).__init__(
            'azure-native:appplatform/v20220101preview:BuildServiceAgentPool',
            resource_name,
            __props__,
            opts)
