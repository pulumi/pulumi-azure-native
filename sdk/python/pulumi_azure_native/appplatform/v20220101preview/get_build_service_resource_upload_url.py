...
def get_build_service_resource_upload_url(build_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20220101preview:getBuildServiceResourceUploadUrl', __args__, opts=opts, typ=GetBuildServiceResourceUploadUrlResult).value
...
def get_build_service_resource_upload_url_output(build_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20220101preview:getBuildServiceResourceUploadUrl', __args__, opts=opts, typ=GetBuildServiceResourceUploadUrlResult)
