...
warnings.warn("""azure-native:appplatform/v20220101preview:Storage is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Storage to guarantee forwards compatibility.""", DeprecationWarning)
...
class Storage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Storage is deprecated: azure-native:appplatform/v20220101preview:Storage is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230101preview:Storage to guarantee forwards compatibility.""")
