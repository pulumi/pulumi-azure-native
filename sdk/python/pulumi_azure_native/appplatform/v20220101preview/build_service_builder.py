...
class BuildServiceBuilder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:BuildServiceBuilder")])
