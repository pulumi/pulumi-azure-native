...
class BuildServiceBuilder(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        build_service_builder = azure_native.appplatform.v20220101preview.BuildServiceBuilder("buildServiceBuilder",
            build_service_name="default",
            builder_name="mybuilder",
            properties=azure_native.appplatform.v20220101preview.BuilderPropertiesResponseArgs(
                buildpack_groups=[{
                    "buildpacks": [azure_native.appplatform.v20220101preview.BuildpackPropertiesArgs(
                        id="tanzu-buildpacks/java-azure",
                    )],
                    "name": "mix",
                }],
                stack=azure_native.appplatform.v20220101preview.StackPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:BuildServiceBuilder"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildServiceBuilder")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildServiceBuilder, __self__).__init__(
            'azure-native:appplatform/v20220101preview:BuildServiceBuilder',
            resource_name,
            __props__,
            opts)
