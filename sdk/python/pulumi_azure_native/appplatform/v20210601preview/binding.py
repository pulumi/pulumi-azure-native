...
warnings.warn("""azure-native:appplatform/v20210601preview:Binding is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Binding to guarantee forwards compatibility.""", DeprecationWarning)
...
class Binding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Binding is deprecated: azure-native:appplatform/v20210601preview:Binding is being removed in the next major version of this provider. Please upgrade to azure-native:appplatform/v20230101preview:Binding to guarantee forwards compatibility.""")
