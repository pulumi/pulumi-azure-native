...
class ServiceRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service_registry = azure_native.appplatform.v20230101preview.ServiceRegistry("serviceRegistry",
