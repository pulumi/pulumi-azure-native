...
class GatewayCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway_custom_domain = azure_native.appplatform.v20230101preview.GatewayCustomDomain("gatewayCustomDomain",
            domain_name="myDomainName",
            gateway_name="default",
            properties=azure_native.appplatform.v20230101preview.GatewayCustomDomainPropertiesArgs(
                thumbprint="*",
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20221201:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayCustomDomain")])
