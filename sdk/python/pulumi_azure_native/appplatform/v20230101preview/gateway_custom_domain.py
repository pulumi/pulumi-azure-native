...
class GatewayCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayCustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:GatewayCustomDomain")])
