...
class ApiPortalCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_portal_custom_domain = azure_native.appplatform.v20230101preview.ApiPortalCustomDomain("apiPortalCustomDomain",
            api_portal_name="default",
            domain_name="myDomainName",
            properties=azure_native.appplatform.v20230101preview.ApiPortalCustomDomainPropertiesArgs(
                thumbprint="*",
            ),
