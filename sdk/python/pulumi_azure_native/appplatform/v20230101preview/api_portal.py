...
class ApiPortal(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_portal = azure_native.appplatform.v20230101preview.ApiPortal("apiPortal",
            api_portal_name="default",
            properties=azure_native.appplatform.v20230101preview.ApiPortalPropertiesArgs(
