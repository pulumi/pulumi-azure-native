...
class GatewayRouteConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:GatewayRouteConfig"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:GatewayRouteConfig")])
