...
class GatewayRouteConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway_route_config = azure_native.appplatform.v20230101preview.GatewayRouteConfig("gatewayRouteConfig",
            gateway_name="default",
            properties=azure_native.appplatform.v20230101preview.GatewayRouteConfigPropertiesResponseArgs(
                ...
                open_api=azure_native.appplatform.v20230101preview.GatewayRouteConfigOpenApiPropertiesArgs(
                    uri="https://raw.githubusercontent.com/OAI/OpenAPI-Specification/main/examples/v3.0/petstore.json",
                ),
                protocol="HTTPS",
                routes=[azure_native.appplatform.v20230101preview.GatewayApiRouteArgs(
                    filters=[
                        "StripPrefix=2",
                        "RateLimit=1,1s",
                    ],
