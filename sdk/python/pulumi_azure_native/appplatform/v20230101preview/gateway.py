...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Gateway")])
