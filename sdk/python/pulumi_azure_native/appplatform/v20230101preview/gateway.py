...
class Gateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gateway = azure_native.appplatform.v20230101preview.Gateway("gateway",
            gateway_name="default",
            properties=azure_native.appplatform.v20230101preview.GatewayPropertiesResponseArgs(
                public=True,
                resource_requests=azure_native.appplatform.v20230101preview.GatewayResourceRequestsArgs(
                    cpu="1",
                    memory="1G",
                ),
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Gateway"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Gateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gateway, __self__).__init__(
            'azure-native:appplatform/v20230101preview:Gateway',
            resource_name,
            __props__,
            opts)
