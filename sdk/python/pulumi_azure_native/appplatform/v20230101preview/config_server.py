...
class ConfigServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20200701:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20220401:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20231101preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ConfigServer"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ConfigServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigServer, __self__).__init__(
            'azure-native:appplatform/v20230101preview:ConfigServer',
            resource_name,
            __props__,
            opts)
