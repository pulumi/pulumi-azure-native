...
def get_application_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_accelerator is deprecated: azure-native:appplatform/v20230101preview:ApplicationAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:ApplicationAccelerator to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['applicationAcceleratorName'] = application_accelerator_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230101preview:getApplicationAccelerator', __args__, opts=opts, typ=GetApplicationAcceleratorResult).value
