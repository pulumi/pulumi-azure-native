...
class DevToolPortal(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dev_tool_portal = azure_native.appplatform.v20230101preview.DevToolPortal("devToolPortal",
            dev_tool_portal_name="default",
            properties=azure_native.appplatform.v20230101preview.DevToolPortalPropertiesResponseArgs(
                features={
                    "applicationAccelerator": azure_native.appplatform.v20230101preview.DevToolPortalFeatureDetailArgs(
                        state="Enabled",
                    ),
                    "applicationLiveView": azure_native.appplatform.v20230101preview.DevToolPortalFeatureDetailArgs(
                        state="Enabled",
                    ),
                },
                public=True,
                sso_properties=azure_native.appplatform.v20230101preview.DevToolPortalSsoPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:DevToolPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:DevToolPortal")])
