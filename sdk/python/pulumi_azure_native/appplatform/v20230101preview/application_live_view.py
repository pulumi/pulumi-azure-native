...
class ApplicationLiveView(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_live_view = azure_native.appplatform.v20230101preview.ApplicationLiveView("applicationLiveView",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApplicationLiveView"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApplicationLiveView")])
