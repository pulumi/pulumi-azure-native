...
class ApplicationAccelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApplicationAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ApplicationAccelerator")])
