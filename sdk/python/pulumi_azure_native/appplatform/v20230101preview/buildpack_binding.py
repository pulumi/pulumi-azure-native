...
class BuildpackBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        buildpack_binding = azure_native.appplatform.v20230101preview.BuildpackBinding("buildpackBinding",
            build_service_name="default",
            builder_name="default",
            buildpack_binding_name="myBuildpackBinding",
            properties=azure_native.appplatform.v20230101preview.BuildpackBindingPropertiesResponseArgs(
                binding_type="ApplicationInsights",
                launch_properties=azure_native.appplatform.v20230101preview.BuildpackBindingLaunchPropertiesArgs(
                    properties={
                        "abc": "def",
        ...
        ```sh
        $ pulumi import azure-native:appplatform/v20230101preview:BuildpackBinding myBuildpackBinding /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.AppPlatform/Spring/myservice/buildServices/default/builders/default/buildpackBindings/myBuildpackBinding 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220401:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20221201:BuildpackBinding"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:BuildpackBinding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BuildpackBinding, __self__).__init__(
            'azure-native:appplatform/v20230101preview:BuildpackBinding',
            resource_name,
            __props__,
            opts)
