...
warnings.warn("""azure-native:appplatform/v20230101preview:CustomizedAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomizedAccelerator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_customized_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    :param str customized_accelerator_name: The name of the customized accelerator.
    :param str resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
    :param str service_name: The name of the Service resource.
    """
    pulumi.log.warn("""get_customized_accelerator is deprecated: azure-native:appplatform/v20230101preview:CustomizedAccelerator is being removed in the next major version of this provider. Upgrade to at least azure-native:appplatform/v20230501preview:CustomizedAccelerator to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20230101preview:getCustomizedAccelerator', __args__, opts=opts, typ=GetCustomizedAcceleratorResult).value
...
@_utilities.lift_output_func(get_customized_accelerator)
