...
class Storage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage = azure_native.appplatform.v20230101preview.Storage("storage",
            properties=azure_native.appplatform.v20230101preview.StorageAccountResponseArgs(
