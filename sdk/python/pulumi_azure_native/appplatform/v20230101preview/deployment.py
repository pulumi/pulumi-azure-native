...
class Deployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        deployment = azure_native.appplatform.v20230101preview.Deployment("deployment",
            app_name="myapp",
            deployment_name="mydeployment",
            properties=azure_native.appplatform.v20230101preview.DeploymentResourcePropertiesResponseArgs(
                deployment_settings={
                    "addonConfigs": {
                    ...
                    "livenessProbe": azure_native.appplatform.v20230101preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                        probe_action=azure_native.appplatform.v20230101preview.HTTPGetActionArgs(
                            path="/health",
                            scheme="HTTP",
                            type="HTTPGetAction",
                        ),
                    ),
                    "readinessProbe": azure_native.appplatform.v20230101preview.ProbeArgs(
                        disable_probe=False,
                        failure_threshold=3,
                        initial_delay_seconds=30,
                        period_seconds=10,
                    ...
                    "resourceRequests": azure_native.appplatform.v20230101preview.ResourceRequestsArgs(
                        cpu="1000m",
                        memory="3Gi",
                    ),
                    "terminationGracePeriodSeconds": 30,
                },
                source=azure_native.appplatform.v20230101preview.SourceUploadedUserSourceInfoArgs(
        ...
        deployment = azure_native.appplatform.v20230101preview.Deployment("deployment",
            ...
            properties=azure_native.appplatform.v20230101preview.DeploymentResourcePropertiesResponseArgs(
                ...
                source=azure_native.appplatform.v20230101preview.CustomContainerUserSourceInfoArgs(
                    custom_container=azure_native.appplatform.v20230101preview.CustomContainerArgs(
                        args=[
                            "-c",
                        ...
                        image_registry_credential=azure_native.appplatform.v20230101preview.ImageRegistryCredentialArgs(
                            password="myPassword",
                            username="myUsername",
                        ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azure-native:appplatform/v20230101preview:Deployment',
            resource_name,
            __props__,
            opts)
