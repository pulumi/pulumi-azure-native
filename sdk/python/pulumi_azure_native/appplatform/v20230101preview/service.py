...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service = azure_native.appplatform.v20230101preview.Service("service",
            location="eastus",
            properties=azure_native.appplatform.v20230101preview.ClusterResourcePropertiesArgs(),
        ...
        service = azure_native.appplatform.v20230101preview.Service("service",
            location="eastus",
            properties=azure_native.appplatform.v20230101preview.ClusterResourcePropertiesResponseArgs(
                marketplace_resource=azure_native.appplatform.v20230101preview.MarketplaceResourceArgs(
        ...
        service = azure_native.appplatform.v20230101preview.Service("service",
            ...
            properties=azure_native.appplatform.v20230101preview.ClusterResourcePropertiesResponseArgs(
                network_profile={
                    ...
                    "ingressConfig": azure_native.appplatform.v20230101preview.IngressConfigArgs(
                ...
                vnet_addons=azure_native.appplatform.v20230101preview.ServiceVNetAddonsArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:Service"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Service"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220401:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Service"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:appplatform/v20230101preview:Service',
            resource_name,
            __props__,
            opts)
