...
class MonitoringSettingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str app_insights_instrumentation_key: Target application insight instrumentation key
        :param 'ErrorResponse' error: Error when apply Monitoring Setting changes.
        :param bool trace_enabled: Indicates whether enable the trace functionality
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
