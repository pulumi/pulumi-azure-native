...
class ServiceRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20220401:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ServiceRegistry"), pulumi.Alias(type_="azure-native:appplatform:ServiceRegistry")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceRegistry, __self__).__init__(
            'azure-native:appplatform/v20231101preview:ServiceRegistry',
            resource_name,
            __props__,
            opts)
