...
def get_gateway_custom_domain(domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20231101preview:getGatewayCustomDomain', __args__, opts=opts, typ=GetGatewayCustomDomainResult).value
