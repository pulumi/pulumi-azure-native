...
class ContainerRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ContainerRegistry")])
