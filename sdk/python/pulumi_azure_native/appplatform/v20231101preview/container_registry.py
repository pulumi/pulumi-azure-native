...
class ContainerRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] container_registry_name: The name of the container registry.
        :param pulumi.Input[Union['ContainerRegistryPropertiesArgs', 'ContainerRegistryPropertiesArgsDict']] properties: Properties of the container registry resource payload.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] service_name: The name of the Service resource.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ContainerRegistry"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ContainerRegistry")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerRegistry, __self__).__init__(
            'azure-native:appplatform/v20231101preview:ContainerRegistry',
            resource_name,
            __props__,
            opts)
