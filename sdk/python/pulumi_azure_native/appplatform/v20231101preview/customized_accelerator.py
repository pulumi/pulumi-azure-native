...
class CustomizedAccelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20221101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20231201:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:CustomizedAccelerator"), pulumi.Alias(type_="azure-native:appplatform:CustomizedAccelerator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomizedAccelerator, __self__).__init__(
            'azure-native:appplatform/v20231101preview:CustomizedAccelerator',
            resource_name,
            __props__,
            opts)
