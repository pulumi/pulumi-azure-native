...
def get_customized_accelerator(application_accelerator_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20231101preview:getCustomizedAccelerator', __args__, opts=opts, typ=GetCustomizedAcceleratorResult).value
...
def get_customized_accelerator_output(application_accelerator_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appplatform/v20231101preview:getCustomizedAccelerator', __args__, opts=opts, typ=GetCustomizedAcceleratorResult)
