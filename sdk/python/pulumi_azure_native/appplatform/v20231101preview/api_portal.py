...
class ApiPortal(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20220101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20221201:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20231201:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:ApiPortal"), pulumi.Alias(type_="azure-native:appplatform:ApiPortal")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiPortal, __self__).__init__(
            'azure-native:appplatform/v20231101preview:ApiPortal',
            resource_name,
            __props__,
            opts)
