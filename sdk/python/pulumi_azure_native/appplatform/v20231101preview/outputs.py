...
class GatewayLocalResponseCachePerInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GatewayLocalResponseCachePerInstancePropertiesResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             response_cache_type: Optional[str] = None,
             size: Optional[str] = None,
             time_to_live: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class GatewayLocalResponseCachePerRoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str time_to_live: Time before a cached entry is expired (300s, 5m, 1h...)
        """
        GatewayLocalResponseCachePerRoutePropertiesResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            response_cache_type=response_cache_type,
            size=size,
            time_to_live=time_to_live,
...
class TriggeredBuildResultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        TriggeredBuildResultResponse._configure(
            ...
            last_transition_status=last_transition_status,
    ...
    def _configure(
        ...
        if provisioning_state is None:
            raise TypeError("Missing 'provisioning_state' argument")
        if last_transition_reason is None and 'lastTransitionReason' in kwargs:
            last_transition_reason = kwargs['lastTransitionReason']
        if last_transition_status is None and 'lastTransitionStatus' in kwargs:
            last_transition_status = kwargs['lastTransitionStatus']
        ...
        if last_transition_reason is not None:
            _setter("last_transition_reason", last_transition_reason)
        if last_transition_status is not None:
            _setter("last_transition_status", last_transition_status)
