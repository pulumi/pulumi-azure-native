...
def list_service_globally_enabled_apms(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/v20231101preview:listServiceGloballyEnabledApms', __args__, opts=opts, typ=ListServiceGloballyEnabledApmsResult).value
