...
class ApiPortalPropertiesArgs:
    def __init__(__self__, *,
        ...
        ApiPortalPropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            api_try_out_enabled_state=api_try_out_enabled_state,
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if api_try_out_enabled_state is None and 'apiTryOutEnabledState' in kwargs:
            api_try_out_enabled_state = kwargs['apiTryOutEnabledState']
        ...
        if api_try_out_enabled_state is not None:
            _setter("api_try_out_enabled_state", api_try_out_enabled_state)
...
class GatewayLocalResponseCachePerInstancePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        GatewayLocalResponseCachePerInstancePropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            response_cache_type=response_cache_type,
            size=size,
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             response_cache_type: Optional[pulumi.Input[str]] = None,
             size: Optional[pulumi.Input[str]] = None,
             time_to_live: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if response_cache_type is None and 'responseCacheType' in kwargs:
            response_cache_type = kwargs['responseCacheType']
        if response_cache_type is None:
            raise TypeError("Missing 'response_cache_type' argument")
        if time_to_live is None and 'timeToLive' in kwargs:
            time_to_live = kwargs['timeToLive']

        _setter("response_cache_type", 'LocalCachePerInstance')
        if size is not None:
            _setter("size", size)
...
class GatewayLocalResponseCachePerRoutePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] time_to_live: Time before a cached entry is expired (300s, 5m, 1h...)
        """
        GatewayLocalResponseCachePerRoutePropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            response_cache_type=response_cache_type,
            size=size,
            time_to_live=time_to_live,
    ...
    def _configure(
        ...
        _setter("response_cache_type", 'LocalCachePerRoute')
        if size is not None:
            _setter("size", size)
        if time_to_live is not None:
            _setter("time_to_live", time_to_live)
...
class GatewayPropertiesArgs:
    def __init__(__self__, *,
        ...
        GatewayPropertiesArgs._configure(
            ...
            public=public,
            resource_requests=resource_requests,
            response_cache_properties=response_cache_properties,
            sso_properties=sso_properties,
        )
    @staticmethod
    def _configure(
        ...
        if resource_requests is None and 'resourceRequests' in kwargs:
            resource_requests = kwargs['resourceRequests']
        if response_cache_properties is None and 'responseCacheProperties' in kwargs:
            response_cache_properties = kwargs['responseCacheProperties']
        if sso_properties is None and 'ssoProperties' in kwargs:
            sso_properties = kwargs['ssoProperties']
        ...
        if response_cache_properties is not None:
            _setter("response_cache_properties", response_cache_properties)
        if sso_properties is not None:
            _setter("sso_properties", sso_properties)
...
class WarUploadedUserSourceInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] jvm_options: JVM parameter
        :param pulumi.Input[str] relative_path: Relative path of the storage which stores the source
        :param pulumi.Input[str] runtime_version: Runtime version of the war file
        :param pulumi.Input[str] server_version: Server version, currently only Apache Tomcat is supported
        :param pulumi.Input[str] version: Version of the source
        """
        WarUploadedUserSourceInfoArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            type=type,
            jvm_options=jvm_options,
            relative_path=relative_path,
...
class WeeklyMaintenanceScheduleConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        WeeklyMaintenanceScheduleConfigurationArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            day=day,
            frequency=frequency,
            hour=hour,
