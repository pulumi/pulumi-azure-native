...
class Storage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appplatform/v20210901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220301preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220501preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20220901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20221101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20221201:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230301preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230501preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230701preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20230901preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20231201:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20240101preview:Storage"), pulumi.Alias(type_="azure-native:appplatform/v20240501preview:Storage"), pulumi.Alias(type_="azure-native:appplatform:Storage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Storage, __self__).__init__(
            'azure-native:appplatform/v20231101preview:Storage',
            resource_name,
            __props__,
            opts)
