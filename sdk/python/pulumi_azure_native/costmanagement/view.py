...
class ViewArgs:
    def __init__(__self__, *,
                 timeframe: pulumi.Input[Union[builtins.str, 'ReportTimeframeType']],
                 type: pulumi.Input[Union[builtins.str, 'ReportType']],
                 accumulated: Optional[pulumi.Input[Union[builtins.str, 'AccumulatedType']]] = None,
                 chart: Optional[pulumi.Input[Union[builtins.str, 'ChartType']]] = None,
                 data_set: Optional[pulumi.Input['ReportConfigDatasetArgs']] = None,
                 date_range: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 e_tag: Optional[pulumi.Input[builtins.str]] = None,
                 include_monetary_commitment: Optional[pulumi.Input[builtins.bool]] = None,
                 kpis: Optional[pulumi.Input[Sequence[pulumi.Input['KpiPropertiesArgs']]]] = None,
                 metric: Optional[pulumi.Input[Union[builtins.str, 'MetricType']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ReportTimeframeType']] timeframe: The time frame for pulling data for the report. If custom, then a specific time period must be provided.
        :param pulumi.Input[Union[builtins.str, 'ReportType']] type: The type of the report. Usage represents actual usage, forecast represents forecasted data and UsageAndForecast represents both usage and forecasted data. Actual usage and forecasted data can be differentiated based on dates.
        :param pulumi.Input[Union[builtins.str, 'AccumulatedType']] accumulated: Show costs accumulated over time.
        :param pulumi.Input[Union[builtins.str, 'ChartType']] chart: Chart type of the main view in Cost Analysis. Required.
        :param pulumi.Input['ReportConfigDatasetArgs'] data_set: Has definition for data in this report config.
        :param pulumi.Input[builtins.str] date_range: Date range of the current view.
        :param pulumi.Input[builtins.str] display_name: User input name of the view. Required.
    ...
    @property
    @pulumi.getter
    def timeframe(self) -> pulumi.Input[Union[builtins.str, 'ReportTimeframeType']]:
        """
    ...
    @timeframe.setter
    def timeframe(self, value: pulumi.Input[Union[builtins.str, 'ReportTimeframeType']]):
        pulumi.set(self, "timeframe", value)

    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'ReportType']]:
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'ReportType']]):
        pulumi.set(self, "type", value)

    @property
    @pulumi.getter
    def accumulated(self) -> Optional[pulumi.Input[Union[builtins.str, 'AccumulatedType']]]:
        """
    ...
    @accumulated.setter
    def accumulated(self, value: Optional[pulumi.Input[Union[builtins.str, 'AccumulatedType']]]):
        pulumi.set(self, "accumulated", value)

    @property
    @pulumi.getter
    def chart(self) -> Optional[pulumi.Input[Union[builtins.str, 'ChartType']]]:
        """
    ...
    @chart.setter
    def chart(self, value: Optional[pulumi.Input[Union[builtins.str, 'ChartType']]]):
    ...
    def date_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @date_range.setter
    def date_range(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def include_monetary_commitment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_monetary_commitment(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def metric(self) -> Optional[pulumi.Input[Union[builtins.str, 'MetricType']]]:
        """
    ...
    @metric.setter
    def metric(self, value: Optional[pulumi.Input[Union[builtins.str, 'MetricType']]]):
...
class View(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 timeframe: Optional[pulumi.Input[Union[builtins.str, 'ReportTimeframeType']]] = None,
                 type: Optional[pulumi.Input[Union[builtins.str, 'ReportType']]] = None,
                 view_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20190401preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:View"), pulumi.Alias(type_="azure-native:costmanagement/v20200601:View"), pulumi.Alias(type_="azure-native:costmanagement/v20211001:View"), pulumi.Alias(type_="azure-native:costmanagement/v20220801preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221005preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230701preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:View"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:View"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:View"), pulumi.Alias(type_="azure-native:costmanagement/v20241001preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20250301:View")])
    ...
    @property
    @pulumi.getter
    def accumulated(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Show costs accumulated over time.
        """
        return pulumi.get(self, "accumulated")
    ...
    @property
    @pulumi.getter
    def chart(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Chart type of the main view in Cost Analysis. Required.
        """
        return pulumi.get(self, "chart")
    ...
    @property
    @pulumi.getter(name="dateRange")
    def date_range(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Date range of the current view.
        """
        return pulumi.get(self, "date_range")
    ...
    @property
    @pulumi.getter(name="includeMonetaryCommitment")
    def include_monetary_commitment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, report includes monetary commitment.
        """
        return pulumi.get(self, "include_monetary_commitment")
    ...
    @property
    @pulumi.getter(name="modifiedOn")
    def modified_on(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Date when the user last modified this view.
        """
        return pulumi.get(self, "modified_on")
    ...
    @property
    @pulumi.getter
    def timeframe(self) -> pulumi.Output[builtins.str]:
        """
        The time frame for pulling data for the report. If custom, then a specific time period must be provided.
        """
        return pulumi.get(self, "timeframe")
