...
def get_view(view_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20221001preview:getView', __args__, opts=opts, typ=GetViewResult).value
...
def get_view_output(view_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20221001preview:getView', __args__, opts=opts, typ=GetViewResult)
