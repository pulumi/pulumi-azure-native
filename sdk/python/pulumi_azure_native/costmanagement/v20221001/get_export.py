...
def get_export(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_export is deprecated: azure-native:costmanagement/v20221001:Export is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:Export to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['exportName'] = export_name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20221001:getExport', __args__, opts=opts, typ=GetExportResult).value
