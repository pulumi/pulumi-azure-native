...
warnings.warn("""azure-native:costmanagement/v20221001:ScheduledActionByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:ScheduledActionByScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scheduled_action_by_scope(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_action_by_scope is deprecated: azure-native:costmanagement/v20221001:ScheduledActionByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:ScheduledActionByScope to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20221001:getScheduledActionByScope', __args__, opts=opts, typ=GetScheduledActionByScopeResult).value
