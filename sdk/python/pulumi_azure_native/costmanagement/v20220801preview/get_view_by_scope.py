...
warnings.warn("""azure-native:costmanagement/v20220801preview:ViewByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:ViewByScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_view_by_scope(scope: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view_by_scope is deprecated: azure-native:costmanagement/v20220801preview:ViewByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:ViewByScope to guarantee forwards compatibility.""")
    __args__ = dict()
