...
def get_scheduled_action(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20230801:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult).value
...
def get_scheduled_action_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230801:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult)
