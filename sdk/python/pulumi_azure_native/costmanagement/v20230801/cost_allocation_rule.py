...
class CostAllocationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20200301preview:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement/v20241001preview:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement:CostAllocationRule")])
