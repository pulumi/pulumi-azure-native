...
def get_tag_inheritance_setting_output(scope: Optional[pulumi.Input[str]] = None,
    ...
    __args__['type'] = type
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230801:getTagInheritanceSetting', __args__, opts=opts, typ=GetTagInheritanceSettingResult)
