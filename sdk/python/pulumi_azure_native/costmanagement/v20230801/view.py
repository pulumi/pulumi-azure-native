...
class ViewArgs:
    def __init__(__self__, *,
        ...
        ViewArgs._configure(
            ...
            e_tag=e_tag,
            include_monetary_commitment=include_monetary_commitment,
            kpis=kpis,
            metric=metric,
    ...
    def _configure(
        ...
        if e_tag is None and 'eTag' in kwargs:
            e_tag = kwargs['eTag']
        if include_monetary_commitment is None and 'includeMonetaryCommitment' in kwargs:
            include_monetary_commitment = kwargs['includeMonetaryCommitment']
        ...
        if include_monetary_commitment is not None:
            _setter("include_monetary_commitment", include_monetary_commitment)
        if kpis is not None:
            _setter("kpis", kpis)
...
class View(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            data_set = _utilities.configure(data_set, ReportConfigDatasetArgs, True)
            ...
            time_period = _utilities.configure(time_period, ReportConfigTimePeriodArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:View"), pulumi.Alias(type_="azure-native:costmanagement/v20190401preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:View"), pulumi.Alias(type_="azure-native:costmanagement/v20200601:View"), pulumi.Alias(type_="azure-native:costmanagement/v20211001:View"), pulumi.Alias(type_="azure-native:costmanagement/v20220801preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221005preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:View"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:View")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(View, __self__).__init__(
            'azure-native:costmanagement/v20230801:View',
            resource_name,
            __props__,
            opts)
