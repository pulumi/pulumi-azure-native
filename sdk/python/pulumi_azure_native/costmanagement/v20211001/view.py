...
warnings.warn("""azure-native:costmanagement/v20211001:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:View to guarantee forwards compatibility.""", DeprecationWarning)
...
class View(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 view_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""View is deprecated: azure-native:costmanagement/v20211001:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:View to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:View"), pulumi.Alias(type_="azure-native:costmanagement/v20190401preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:View"), pulumi.Alias(type_="azure-native:costmanagement/v20200601:View"), pulumi.Alias(type_="azure-native:costmanagement/v20220801preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221001preview:View"), pulumi.Alias(type_="azure-native:costmanagement/v20221005preview:View")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(View, __self__).__init__(
            'azure-native:costmanagement/v20211001:View',
            resource_name,
            __props__,
            opts)
