...
def get_view(view_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view is deprecated: azure-native:costmanagement/v20211001:View is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221005preview:View to guarantee forwards compatibility.""")
    __args__ = dict()
