...
def get_view(view_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view is deprecated: azure-native:costmanagement/v20211001:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221005preview:View to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['viewName'] = view_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20211001:getView', __args__, opts=opts, typ=GetViewResult).value
