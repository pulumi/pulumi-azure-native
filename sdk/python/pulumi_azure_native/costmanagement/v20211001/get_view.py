...
def get_view(view_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view is deprecated: azure-native:costmanagement/v20211001:View is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20221001:View to guarantee forwards compatibility.""")
    __args__ = dict()
