...
warnings.warn("""azure-native:costmanagement/v20211001:ViewByScope is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221005preview:ViewByScope to guarantee forwards compatibility.""", DeprecationWarning)
...
class ViewByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 view_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ViewByScope is deprecated: azure-native:costmanagement/v20211001:ViewByScope is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221005preview:ViewByScope to guarantee forwards compatibility.""")
