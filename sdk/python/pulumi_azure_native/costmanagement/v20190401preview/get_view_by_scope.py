...
def get_view_by_scope(scope: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view_by_scope is deprecated: azure-native:costmanagement/v20190401preview:ViewByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20191101:ViewByScope to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['scope'] = scope
    __args__['viewName'] = view_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20190401preview:getViewByScope', __args__, opts=opts, typ=GetViewByScopeResult).value
