...
class Budget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 e_tag: Optional[pulumi.Input[str]] = None,
                 filter: Optional[pulumi.Input[pulumi.InputType['ReportConfigFilterArgs']]] = None,
        ...
        :param pulumi.Input[Union[str, 'CategoryType']] category: The category of the budget, whether the budget tracks cost or usage.
        :param pulumi.Input[str] e_tag: eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
        :param pulumi.Input[pulumi.InputType['ReportConfigFilterArgs']] filter: May be used to filter budgets.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if filter is not None and not isinstance(filter, ReportConfigFilterArgs):
                filter = filter or {}
                def _setter(key, value):
                    filter[key] = value
                ReportConfigFilterArgs._configure(_setter, **filter)
            ...
            if time_period is not None and not isinstance(time_period, BudgetTimePeriodArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:Budget")])
