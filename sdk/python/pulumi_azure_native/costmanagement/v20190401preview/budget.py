...
class BudgetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ReportConfigFilterArgs'] filter: May be used to filter budgets.
...
class Budget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 e_tag: Optional[pulumi.Input[str]] = None,
                 filter: Optional[pulumi.Input[Union['ReportConfigFilterArgs', 'ReportConfigFilterArgsDict']]] = None,
        ...
        :param pulumi.Input[Union[str, 'CategoryType']] category: The category of the budget, whether the budget tracks cost or usage.
        :param pulumi.Input[str] e_tag: eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
        :param pulumi.Input[Union['ReportConfigFilterArgs', 'ReportConfigFilterArgsDict']] filter: May be used to filter budgets.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:Budget")])
    ...
    @property
    @pulumi.getter
    def filter(self) -> pulumi.Output[Optional['outputs.ReportConfigFilterResponse']]:
        """
        May be used to filter budgets.
        """
        return pulumi.get(self, "filter")
