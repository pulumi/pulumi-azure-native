...
class ReportConfigByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-nextgen:costmanagement:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-native:costmanagement/latest:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-nextgen:costmanagement/latest:ReportConfigByResourceGroupName")])
