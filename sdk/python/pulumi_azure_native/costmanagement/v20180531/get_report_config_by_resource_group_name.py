...
def get_report_config_by_resource_group_name(report_config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_report_config_by_resource_group_name is deprecated: Version 2018-05-31 will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['reportConfigName'] = report_config_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20180531:getReportConfigByResourceGroupName', __args__, opts=opts, typ=GetReportConfigByResourceGroupNameResult).value
