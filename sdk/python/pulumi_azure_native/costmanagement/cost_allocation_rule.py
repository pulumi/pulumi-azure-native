...
class CostAllocationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule_name: Cost allocation rule name. The name cannot include spaces or any non alphanumeric characters other than '_' and '-'. The max length is 260 characters.
        """
