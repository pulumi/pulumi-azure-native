...
def get_setting(setting_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str setting_name: Name of the setting. Allowed values: myscope
    """
    __args__ = dict()
...
def get_setting_output(setting_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
