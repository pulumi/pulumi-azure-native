...
def get_report_by_resource_group_name(report_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_report_by_resource_group_name is deprecated: Version 2018-08-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['reportName'] = report_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20180801preview:getReportByResourceGroupName', __args__, opts=opts, typ=GetReportByResourceGroupNameResult).value
...
@_utilities.lift_output_func(get_report_by_resource_group_name)
