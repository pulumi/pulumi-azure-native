...
def get_cost_allocation_rule(billing_account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20230901:getCostAllocationRule', __args__, opts=opts, typ=GetCostAllocationRuleResult).value
...
def get_cost_allocation_rule_output(billing_account_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230901:getCostAllocationRule', __args__, opts=opts, typ=GetCostAllocationRuleResult)
