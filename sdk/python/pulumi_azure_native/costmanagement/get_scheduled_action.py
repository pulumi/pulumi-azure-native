...
def get_scheduled_action(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Scheduled action name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_scheduled_action_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
