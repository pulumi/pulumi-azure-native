...
class ScheduledActionByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20220401preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:ScheduledActionByScope")])
