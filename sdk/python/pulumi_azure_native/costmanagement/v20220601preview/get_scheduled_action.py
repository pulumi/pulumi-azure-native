...
def get_scheduled_action(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_action is deprecated: azure-native:costmanagement/v20220601preview:ScheduledAction is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221001:ScheduledAction to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20220601preview:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult).value
