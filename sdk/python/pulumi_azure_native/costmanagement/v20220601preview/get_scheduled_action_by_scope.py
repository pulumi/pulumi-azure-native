...
warnings.warn("""azure-native:costmanagement/v20220601preview:ScheduledActionByScope is being removed in the next major version of this provider. Upgrade to at least azure-native:costmanagement/v20230401preview:ScheduledActionByScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scheduled_action_by_scope(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20220601preview:getScheduledActionByScope', __args__, opts=opts, typ=GetScheduledActionByScopeResult).value
