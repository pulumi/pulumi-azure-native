...
class ScheduledAction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20220401preview:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20230701preview:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:ScheduledAction"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:ScheduledAction")])
