...
def get_export_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230701preview:getExport', __args__, opts=opts, typ=GetExportResult)
    return __ret__.apply(lambda __response__: GetExportResult(
        compression_mode=pulumi.get(__response__, 'compression_mode'),
        data_overwrite_behavior=pulumi.get(__response__, 'data_overwrite_behavior'),
        definition=pulumi.get(__response__, 'definition'),
        delivery_info=pulumi.get(__response__, 'delivery_info'),
        e_tag=pulumi.get(__response__, 'e_tag'),
        export_description=pulumi.get(__response__, 'export_description'),
        ...
        system_suspension_context=pulumi.get(__response__, 'system_suspension_context'),
