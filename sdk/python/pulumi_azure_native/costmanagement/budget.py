...
class Budget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20190401preview:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:Budget"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20190401preview:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20230401preview:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20230801:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20230901:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20231101:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20240801:costmanagement:Budget"), pulumi.Alias(type_="azure-native_costmanagement_v20241001preview:costmanagement:Budget")])
