...
def get_scheduled_action_by_scope_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230301:getScheduledActionByScope', __args__, opts=opts, typ=GetScheduledActionByScopeResult)
