...
def get_report_by_department(department_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str department_id: Department ID
...
def get_report_by_department_output(department_id: Optional[pulumi.Input[_builtins.str]] = None,
