...
class CloudConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20180801preview:Connector"), pulumi.Alias(type_="azure-native:costmanagement/v20190301preview:CloudConnector"), pulumi.Alias(type_="azure-native:costmanagement:Connector"), pulumi.Alias(type_="azure-native_costmanagement_v20180801preview:costmanagement:CloudConnector"), pulumi.Alias(type_="azure-native_costmanagement_v20190301preview:costmanagement:CloudConnector")])
