...
class CloudConnector(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20190301preview:CloudConnector"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20190301preview:CloudConnector")])
