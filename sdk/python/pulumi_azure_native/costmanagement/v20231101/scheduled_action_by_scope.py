...
class ScheduledActionByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20220401preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20220601preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230701preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20240801:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20241001preview:ScheduledActionByScope"), pulumi.Alias(type_="azure-native:costmanagement:ScheduledActionByScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledActionByScope, __self__).__init__(
            'azure-native:costmanagement/v20231101:ScheduledActionByScope',
            resource_name,
            __props__,
            opts)
