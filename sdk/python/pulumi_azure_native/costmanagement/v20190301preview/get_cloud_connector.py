...
def get_cloud_connector(connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_connector is deprecated: Version 2019-03-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['connectorName'] = connector_name
    __args__['expand'] = expand
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20190301preview:getCloudConnector', __args__, opts=opts, typ=GetCloudConnectorResult).value
