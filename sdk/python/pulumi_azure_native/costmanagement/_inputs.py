...
class BudgetTimePeriodArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] start_date: The start date for the budget.
               ...
               - Constraints for **CategoryType: ReservationUtilization** - Must be on or after the current date and less than the end date.
        :param pulumi.Input[builtins.str] end_date: The end date for the budget.
...
class CostAllocationProportionArgs:
    def __init__(__self__, *,
        ...
        """
        Target resources and allocation
        :param pulumi.Input[builtins.str] name: Target resource for cost allocation
        :param pulumi.Input[builtins.float] percentage: Percentage of source cost to allocate to this resource. This value can be specified to two decimal places and the total percentage of all resources in this rule must sum to 100.00.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class CostAllocationRulePropertiesArgsDict(TypedDict):
        ...
        """
        status: pulumi.Input[Union[builtins.str, 'RuleStatus']]
        """
        Status of the rule
        """
...
class CostAllocationRulePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'RuleStatus']] status: Status of the rule
        :param pulumi.Input[builtins.str] description: Description of a cost allocation rule.
        """
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Input[Union[builtins.str, 'RuleStatus']]:
        """
        Status of the rule
        """
    ...
    @status.setter
    def status(self, value: pulumi.Input[Union[builtins.str, 'RuleStatus']]):
...
if not MYPY:
    class CustomerMetadataArgsDict(TypedDict):
        ...
        """
        billing_profile_id: pulumi.Input[builtins.str]
        """
...
class CustomerMetadataArgs:
    def __init__(__self__, *,
        ...
        """
        The customer billing metadata
        :param pulumi.Input[builtins.str] billing_account_id: Customer billing account id
        :param pulumi.Input[builtins.str] billing_profile_id: Customer billing profile id
        """
    ...
    def billing_profile_id(self) -> pulumi.Input[builtins.str]:
        """
        Customer billing profile id
        """
    ...
    def billing_profile_id(self, value: pulumi.Input[builtins.str]):
...
class ExportDatasetConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The export dataset configuration. Allows columns to be selected for the export. If not provided then the export will include all available columns.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] columns: Array of column names to be included in the export. If not provided then the export will include all available columns. The available columns can vary by customer channel (see examples).
        """
...
if not MYPY:
    class ExportDatasetArgsDict(TypedDict):
        ...
        """
        granularity: NotRequired[pulumi.Input[Union[builtins.str, 'GranularityType']]]
        """
...
class ExportDatasetArgs:
    def __init__(__self__, *,
                 ...
                 granularity: Optional[pulumi.Input[Union[builtins.str, 'GranularityType']]] = None):
        """
        The definition for data in the export.
        :param pulumi.Input['ExportDatasetConfigurationArgs'] configuration: The export dataset configuration.
        :param pulumi.Input[Union[builtins.str, 'GranularityType']] granularity: The granularity of rows in the export. Currently only 'Daily' is supported.
        """
    ...
    @property
    @pulumi.getter
    def granularity(self) -> Optional[pulumi.Input[Union[builtins.str, 'GranularityType']]]:
        """
        The granularity of rows in the export. Currently only 'Daily' is supported.
        """
    ...
    @granularity.setter
    def granularity(self, value: Optional[pulumi.Input[Union[builtins.str, 'GranularityType']]]):
...
if not MYPY:
    class ExportDefinitionArgsDict(TypedDict):
        ...
        """
        timeframe: pulumi.Input[Union[builtins.str, 'TimeframeType']]
        """
        The time frame for pulling data for the export. If custom, then a specific time period must be provided.
        """
        type: pulumi.Input[Union[builtins.str, 'ExportType']]
        """
...
class ExportDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        The definition of an export.
        :param pulumi.Input[Union[builtins.str, 'TimeframeType']] timeframe: The time frame for pulling data for the export. If custom, then a specific time period must be provided.
        :param pulumi.Input[Union[builtins.str, 'ExportType']] type: The type of the export. Note that 'Usage' is equivalent to 'ActualCost' and is applicable to exports that do not yet provide data for charges or amortization for service reservations.
    ...
    @property
    @pulumi.getter
    def timeframe(self) -> pulumi.Input[Union[builtins.str, 'TimeframeType']]:
        """
        The time frame for pulling data for the export. If custom, then a specific time period must be provided.
        """
    ...
    @timeframe.setter
    def timeframe(self, value: pulumi.Input[Union[builtins.str, 'TimeframeType']]):
        pulumi.set(self, "timeframe", value)

    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'ExportType']]:
        """
        The type of the export. Note that 'Usage' is equivalent to 'ActualCost' and is applicable to exports that do not yet provide data for charges or amortization for service reservations.
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'ExportType']]):
...
if not MYPY:
    class ExportDeliveryDestinationArgsDict(TypedDict):
        ...
        """
        root_folder_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExportDeliveryDestinationArgs:
    def __init__(__self__, *,
                 ...
                 root_folder_path: Optional[pulumi.Input[builtins.str]] = None,
                 sas_token: Optional[pulumi.Input[builtins.str]] = None,
                 storage_account: Optional[pulumi.Input[builtins.str]] = None):
        """
        This represents the blob storage account location where exports of costs will be delivered. There are two ways to configure the destination. The approach recommended for most customers is to specify the resourceId of the storage account. This requires a one-time registration of the account's subscription with the Microsoft.CostManagementExports resource provider in order to give Cost Management services access to the storage. When creating an export in the Azure portal this registration is performed automatically but API users may need to register the subscription explicitly (for more information see https://docs.microsoft.com/en-us/azure/azure-resource-manager/resource-manager-supported-services ). Another way to configure the destination is available ONLY to Partners with a Microsoft Partner Agreement plan who are global admins of their billing account. These Partners, instead of specifying the resourceId of a storage account, can specify the storage account name along with a SAS token for the account. This allows exports of costs to a storage account in any tenant. The SAS token should be created for the blob service with Service/Container/Object resource types and with Read/Write/Delete/List/Add/Create permissions (for more information see https://docs.microsoft.com/en-us/azure/cost-management-billing/costs/export-cost-data-storage-account-sas-key ).
        :param pulumi.Input[builtins.str] container: The name of the container where exports will be uploaded. If the container does not exist it will be created.
        :param pulumi.Input[builtins.str] resource_id: The resource id of the storage account where exports will be delivered. This is not required if a sasToken and storageAccount are specified.
        :param pulumi.Input[builtins.str] root_folder_path: The name of the directory where exports will be uploaded.
        :param pulumi.Input[builtins.str] sas_token: A SAS token for the storage account. For a restricted set of Azure customers this together with storageAccount can be specified instead of resourceId. Note: the value returned by the API for this property will always be obfuscated. Returning this same obfuscated value will not result in the SAS token being updated. To update this value a new SAS token must be specified.
        :param pulumi.Input[builtins.str] storage_account: The storage account where exports will be uploaded. For a restricted set of Azure customers this together with sasToken can be specified instead of resourceId.
        """
    ...
    def root_folder_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the directory where exports will be uploaded.
        """
    ...
    def root_folder_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExportRecurrencePeriodArgs:
    def __init__(__self__, *,
        ...
        """
        The start and end date for recurrence schedule.
        :param pulumi.Input[builtins.str] from_: The start date of recurrence.
        :param pulumi.Input[builtins.str] to: The end date of recurrence.
        """
...
if not MYPY:
    class ExportScheduleArgsDict(TypedDict):
        ...
        """
        recurrence: NotRequired[pulumi.Input[Union[builtins.str, 'RecurrenceType']]]
        """
        ...
        """
        status: NotRequired[pulumi.Input[Union[builtins.str, 'StatusType']]]
        """
...
class ExportScheduleArgs:
    def __init__(__self__, *,
                 recurrence: Optional[pulumi.Input[Union[builtins.str, 'RecurrenceType']]] = None,
                 recurrence_period: Optional[pulumi.Input['ExportRecurrencePeriodArgs']] = None,
                 status: Optional[pulumi.Input[Union[builtins.str, 'StatusType']]] = None):
        """
        The schedule associated with the export.
        :param pulumi.Input[Union[builtins.str, 'RecurrenceType']] recurrence: The schedule recurrence.
        ...
        :param pulumi.Input[Union[builtins.str, 'StatusType']] status: The status of the export's schedule. If 'Inactive', the export's schedule is paused.
        """
    ...
    @property
    @pulumi.getter
    def recurrence(self) -> Optional[pulumi.Input[Union[builtins.str, 'RecurrenceType']]]:
        """
        The schedule recurrence.
        """
    ...
    @recurrence.setter
    def recurrence(self, value: Optional[pulumi.Input[Union[builtins.str, 'RecurrenceType']]]):
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input[Union[builtins.str, 'StatusType']]]:
        """
        The status of the export's schedule. If 'Inactive', the export's schedule is paused.
        """
        return pulumi.get(self, "status")
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[builtins.str, 'StatusType']]]):
        pulumi.set(self, "status", value)
...
class ExportTimePeriodArgs:
    def __init__(__self__, *,
        ...
        """
        The date range for data in the export. This should only be specified with timeFrame set to 'Custom'. The maximum date range is 3 months.
        :param pulumi.Input[builtins.str] from_: The start date for export data.
        :param pulumi.Input[builtins.str] to: The end date for export data.
        """
        pulumi.set(__self__, "from_", from_)
        pulumi.set(__self__, "to", to)
...
if not MYPY:
    class FileDestinationArgsDict(TypedDict):
        ...
        """
        file_formats: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'FileFormat']]]]]
        """
...
class FileDestinationArgs:
    def __init__(__self__, *,
                 file_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'FileFormat']]]]] = None):
        """
        Destination of the view data. This is optional. Currently only CSV format is supported.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'FileFormat']]]] file_formats: Destination of the view data. Currently only CSV format is supported.
        """
    ...
    def file_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'FileFormat']]]]]:
        """
        Destination of the view data. Currently only CSV format is supported.
        """
    ...
    @file_formats.setter
    def file_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'FileFormat']]]]]):
...
if not MYPY:
    class KpiPropertiesArgsDict(TypedDict):
        ...
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'KpiTypeType']]]
        """
...
class KpiPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[Union[builtins.str, 'KpiTypeType']]] = None):
        """
        Each KPI must contain a 'type' and 'enabled' key.
        :param pulumi.Input[builtins.bool] enabled: show the KPI in the UI?
        :param pulumi.Input[builtins.str] id: ID of resource related to metric (budget).
        :param pulumi.Input[Union[builtins.str, 'KpiTypeType']] type: KPI type (Forecast, Budget).
        """
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'KpiTypeType']]]:
        """
        KPI type (Forecast, Budget).
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'KpiTypeType']]]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class NotificationPropertiesArgsDict(TypedDict):
        ...
        """
        to: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        regional_format: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NotificationPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 regional_format: Optional[pulumi.Input[builtins.str]] = None):
        """
        The properties of the scheduled action notification.
        :param pulumi.Input[builtins.str] subject: Subject of the email. Length is limited to 70 characters.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] to: Array of email addresses.
        :param pulumi.Input[builtins.str] language: Locale of the email.
        :param pulumi.Input[builtins.str] message: Optional message to be added in the email. Length is limited to 250 characters.
        :param pulumi.Input[builtins.str] regional_format: Regional format used for formatting date/time and currency values in the email.
        """
    ...
    @property
    @pulumi.getter
    def to(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Array of email addresses.
        """
        return pulumi.get(self, "to")
    ...
    @to.setter
    def to(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "to", value)
    ...
    def regional_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Regional format used for formatting date/time and currency values in the email.
        """
    ...
    def regional_format(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class NotificationArgsDict(TypedDict):
        ...
        The notification is enabled or not.
         ...
         Supported for CategoryType(s): Cost, ReservationUtilization.
        """
        operator: pulumi.Input[Union[builtins.str, 'BudgetNotificationOperatorType']]
        """
        ...
        Subscription or Resource Group scopes only. Contact roles to send the notification to when the threshold is breached.
         ...
         Supported for CategoryType(s): Cost.
        """
        frequency: NotRequired[pulumi.Input[Union[builtins.str, 'Frequency']]]
        """
...
class NotificationArgs:
    def __init__(__self__, *,
                 ...
                 frequency: Optional[pulumi.Input[Union[builtins.str, 'Frequency']]] = None,
        ...
        :param pulumi.Input[builtins.bool] enabled: The notification is enabled or not.
                ...
                Supported for CategoryType(s): Cost, ReservationUtilization.
        :param pulumi.Input[Union[builtins.str, 'BudgetNotificationOperatorType']] operator: The comparison operator.
               ...
               - GreaterThanOrEqualTo
                ...
                Supported operators for **CategoryType: ReservationUtilization**
               - LessThan
        :param pulumi.Input[builtins.float] threshold: Threshold value associated with a notification. It is always percent with a maximum of 2 decimal places.
                ...
                **CategoryType: ReservationUtilization** - Must be between 0 and 100. Notification is sent when a reservation has a utilization percentage below the threshold.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_groups: Subscription or Resource Group scopes only. Action groups to send the notification to when the threshold is exceeded. Must be provided as a fully qualified Azure resource id.
               
                Supported for CategoryType(s): Cost.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_roles: Subscription or Resource Group scopes only. Contact roles to send the notification to when the threshold is breached.
               
                Supported for CategoryType(s): Cost.
        :param pulumi.Input[Union[builtins.str, 'Frequency']] frequency: Frequency of a notification. Represents how long the notification will be silent after triggering an alert for a threshold breach. If not specified, the frequency will be set by default based on the timeGrain (Weekly when timeGrain: Last7Days, Monthly when timeGrain: Last30Days).
    ...
    @property
    @pulumi.getter
    def operator(self) -> pulumi.Input[Union[builtins.str, 'BudgetNotificationOperatorType']]:
        """
        The comparison operator.
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[builtins.str, 'BudgetNotificationOperatorType']]):
        pulumi.set(self, "operator", value)
    ...
    @property
    @pulumi.getter
    def frequency(self) -> Optional[pulumi.Input[Union[builtins.str, 'Frequency']]]:
        """
        Frequency of a notification. Represents how long the notification will be silent after triggering an alert for a threshold breach. If not specified, the frequency will be set by default based on the timeGrain (Weekly when timeGrain: Last7Days, Monthly when timeGrain: Last30Days).
    ...
    @frequency.setter
    def frequency(self, value: Optional[pulumi.Input[Union[builtins.str, 'Frequency']]]):
...
if not MYPY:
    class PivotPropertiesArgsDict(TypedDict):
        ...
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'PivotTypeType']]]
        """
...
class PivotPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[Union[builtins.str, 'PivotTypeType']]] = None):
        """
        Each pivot must contain a 'type' and 'name'.
        :param pulumi.Input[builtins.str] name: Data field to show in view.
        :param pulumi.Input[Union[builtins.str, 'PivotTypeType']] type: Data type to show in view.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if type is not None:
    ...
    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'PivotTypeType']]]:
        """
        Data type to show in view.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'PivotTypeType']]]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class ReportAggregationArgsDict(TypedDict):
        ...
        """
        function: pulumi.Input[Union[builtins.str, 'FunctionType']]
        """
...
class ReportAggregationArgs:
    def __init__(__self__, *,
        ...
        """
        The aggregation expression to be used in the report.
        :param pulumi.Input[Union[builtins.str, 'FunctionType']] function: The name of the aggregation function to use.
        :param pulumi.Input[builtins.str] name: The name of the column to aggregate.
        """
    ...
    @property
    @pulumi.getter
    def function(self) -> pulumi.Input[Union[builtins.str, 'FunctionType']]:
        """
        The name of the aggregation function to use.
        """
    ...
    @function.setter
    def function(self, value: pulumi.Input[Union[builtins.str, 'FunctionType']]):
...
class ReportComparisonExpressionArgs:
    def __init__(__self__, *,
        ...
        The comparison expression to be used in the report.
        :param pulumi.Input[builtins.str] name: The name of the column to use in comparison.
        :param pulumi.Input[Union[builtins.str, 'OperatorType']] operator: The operator to use for comparison.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Array of values to use for comparison
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
...
class ReportConfigDatasetConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration of dataset in the report.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] columns: Array of column names to be included in the report. Any valid report column name is allowed. If not provided, then report includes all columns.
        """
        if columns is not None:
            pulumi.set(__self__, "columns", columns)
...
if not MYPY:
    class ReportConfigDatasetArgsDict(TypedDict):
        ...
        """
        granularity: NotRequired[pulumi.Input[Union[builtins.str, 'ReportGranularityType']]]
        """
...
class ReportConfigDatasetArgs:
    def __init__(__self__, *,
                 ...
                 granularity: Optional[pulumi.Input[Union[builtins.str, 'ReportGranularityType']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ReportGranularityType']] granularity: The granularity of rows in the report.
    ...
    @property
    @pulumi.getter
    def granularity(self) -> Optional[pulumi.Input[Union[builtins.str, 'ReportGranularityType']]]:
        """
        The granularity of rows in the report.
        """
        return pulumi.get(self, "granularity")
    ...
    @granularity.setter
    def granularity(self, value: Optional[pulumi.Input[Union[builtins.str, 'ReportGranularityType']]]):
        pulumi.set(self, "granularity", value)
...
if not MYPY:
    class ReportConfigGroupingArgsDict(TypedDict):
        ...
        """
        type: pulumi.Input[Union[builtins.str, 'QueryColumnType']]
        """
...
class ReportConfigGroupingArgs:
    def __init__(__self__, *,
        ...
        """
        The group by expression to be used in the report.
        :param pulumi.Input[builtins.str] name: The name of the column to group. This version supports subscription lowest possible grain.
        :param pulumi.Input[Union[builtins.str, 'QueryColumnType']] type: Has type of the column to group.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'QueryColumnType']]:
        """
        Has type of the column to group.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'QueryColumnType']]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class ReportConfigSortingArgsDict(TypedDict):
        ...
        """
        direction: NotRequired[pulumi.Input[Union[builtins.str, 'ReportConfigSortingType']]]
        """
        Direction of sort.
        """
elif False:
...
class ReportConfigSortingArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 direction: Optional[pulumi.Input[Union[builtins.str, 'ReportConfigSortingType']]] = None):
        """
        The order by expression to be used in the report.
        :param pulumi.Input[builtins.str] name: The name of the column to sort.
        :param pulumi.Input[Union[builtins.str, 'ReportConfigSortingType']] direction: Direction of sort.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def direction(self) -> Optional[pulumi.Input[Union[builtins.str, 'ReportConfigSortingType']]]:
        """
        Direction of sort.
        """
    ...
    @direction.setter
    def direction(self, value: Optional[pulumi.Input[Union[builtins.str, 'ReportConfigSortingType']]]):
...
class ReportConfigTimePeriodArgs:
    def __init__(__self__, *,
        ...
        """
        The start and end date for pulling data for the report.
        :param pulumi.Input[builtins.str] from_: The start date to pull data from.
        :param pulumi.Input[builtins.str] to: The end date to pull data to.
        """
        pulumi.set(__self__, "from_", from_)
        pulumi.set(__self__, "to", to)
...
class ReportDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'GranularityType']] granularity: The granularity of rows in the report.
...
class ReportDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        The definition of a report.
        :param pulumi.Input[Union[builtins.str, 'TimeframeType']] timeframe: The time frame for pulling data for the report. If custom, then a specific time period must be provided.
        :param pulumi.Input[Union[builtins.str, 'ReportType']] type: The type of the report.
...
class ReportDeliveryDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        The destination information for the delivery of the report.
        :param pulumi.Input[builtins.str] container: The name of the container where reports will be uploaded.
        :param pulumi.Input[builtins.str] resource_id: The resource id of the storage account where reports will be delivered.
        :param pulumi.Input[builtins.str] root_folder_path: The name of the directory where reports will be uploaded.
        """
        pulumi.set(__self__, "container", container)
        pulumi.set(__self__, "resource_id", resource_id)
        if root_folder_path is not None:
...
if not MYPY:
    class ReportGroupingArgsDict(TypedDict):
        ...
        """
        type: pulumi.Input[Union[builtins.str, 'ReportColumnType']]
        """
        Has type of the column to group.
        """
elif False:
...
class ReportGroupingArgs:
    def __init__(__self__, *,
        ...
        """
        The group by expression to be used in the report.
        :param pulumi.Input[builtins.str] name: The name of the column to group.
        :param pulumi.Input[Union[builtins.str, 'ReportColumnType']] type: Has type of the column to group.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'ReportColumnType']]:
        """
        Has type of the column to group.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'ReportColumnType']]):
        pulumi.set(self, "type", value)
...
if not MYPY:
    class ReportScheduleArgsDict(TypedDict):
        ...
        """
        recurrence: pulumi.Input[Union[builtins.str, 'RecurrenceType']]
        """
        The schedule recurrence.
        """
...
class ReportScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'StatusType']] status: The status of the schedule. Whether active or not. If inactive, the report's scheduled execution is paused.
        """
        pulumi.set(__self__, "recurrence", recurrence)
        if recurrence_period is not None:
            pulumi.set(__self__, "recurrence_period", recurrence_period)
    ...
    @property
    @pulumi.getter
    def recurrence(self) -> pulumi.Input[Union[builtins.str, 'RecurrenceType']]:
        """
        The schedule recurrence.
        """
        return pulumi.get(self, "recurrence")
    ...
    @recurrence.setter
    def recurrence(self, value: pulumi.Input[Union[builtins.str, 'RecurrenceType']]):
        pulumi.set(self, "recurrence", value)
...
if not MYPY:
    class SchedulePropertiesArgsDict(TypedDict):
        ...
        """
        days_of_week: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DaysOfWeek']]]]]
        """
        ...
        """
        weeks_of_month: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'WeeksOfMonth']]]]]
        """
...
class SchedulePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 days_of_week: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DaysOfWeek']]]]] = None,
                 hour_of_day: Optional[pulumi.Input[builtins.int]] = None,
                 weeks_of_month: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'WeeksOfMonth']]]]] = None):
        """
        The properties of the schedule.
        :param pulumi.Input[builtins.str] end_date: The end date and time of the scheduled action (UTC).
        :param pulumi.Input[Union[builtins.str, 'ScheduleFrequency']] frequency: Frequency of the schedule.
        :param pulumi.Input[builtins.str] start_date: The start date and time of the scheduled action (UTC).
        :param pulumi.Input[builtins.int] day_of_month: UTC day on which cost analysis data will be emailed. Must be between 1 and 31. This property is applicable when frequency is Monthly and overrides weeksOfMonth or daysOfWeek.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DaysOfWeek']]]] days_of_week: Day names in english on which cost analysis data will be emailed. This property is applicable when frequency is Weekly or Monthly.
        :param pulumi.Input[builtins.int] hour_of_day: UTC time at which cost analysis data will be emailed.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'WeeksOfMonth']]]] weeks_of_month: Weeks in which cost analysis data will be emailed. This property is applicable when frequency is Monthly and used in combination with daysOfWeek.
        """
        pulumi.set(__self__, "end_date", end_date)
        pulumi.set(__self__, "frequency", frequency)
        pulumi.set(__self__, "start_date", start_date)
    ...
    def days_of_week(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DaysOfWeek']]]]]:
        """
        Day names in english on which cost analysis data will be emailed. This property is applicable when frequency is Weekly or Monthly.
        """
    ...
    @days_of_week.setter
    def days_of_week(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DaysOfWeek']]]]]):
    ...
    def weeks_of_month(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'WeeksOfMonth']]]]]:
        """
        Weeks in which cost analysis data will be emailed. This property is applicable when frequency is Monthly and used in combination with daysOfWeek.
        """
    ...
    def weeks_of_month(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'WeeksOfMonth']]]]]):
...
if not MYPY:
    class SettingsPropertiesCacheArgsDict(TypedDict):
        ...
        """
        subchannel: pulumi.Input[builtins.str]
        """
...
class SettingsPropertiesCacheArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] channel: Indicates the account type. Allowed values include: EA, PAYG, Modern, Internal, Unknown.
        :param pulumi.Input[builtins.str] id: Resource ID used by Resource Manager to uniquely identify the scope.
        :param pulumi.Input[builtins.str] name: Display name for the scope.
        :param pulumi.Input[builtins.str] subchannel: Indicates the type of modern account. Allowed values include: Individual, Enterprise, Partner, Indirect, NotApplicable
        :param pulumi.Input[builtins.str] parent: Resource ID of the parent scope. For instance, subscription's resource ID for a resource group or a management group resource ID for a subscription.
        :param pulumi.Input[builtins.str] status: Indicates the status of the scope. Status only applies to subscriptions and billing accounts.
        """
    ...
    @property
    @pulumi.getter
    def subchannel(self) -> pulumi.Input[builtins.str]:
        """
        Indicates the type of modern account. Allowed values include: Individual, Enterprise, Partner, Indirect, NotApplicable
        """
    ...
    @subchannel.setter
    def subchannel(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class SourceCostAllocationResourceArgsDict(TypedDict):
        ...
        """
        resource_type: pulumi.Input[Union[builtins.str, 'CostAllocationResourceType']]
        """
...
class SourceCostAllocationResourceArgs:
    def __init__(__self__, *,
        ...
        """
        Source resources for cost allocation
        :param pulumi.Input[builtins.str] name: If resource type is dimension, this must be either ResourceGroupName or SubscriptionId. If resource type is tag, this must be a valid Azure tag
        :param pulumi.Input[Union[builtins.str, 'CostAllocationResourceType']] resource_type: Type of resources contained in this cost allocation rule
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Source Resources for cost allocation. This list cannot contain more than 25 values.
        """
        pulumi.set(__self__, "name", name)
    ...
    def resource_type(self) -> pulumi.Input[Union[builtins.str, 'CostAllocationResourceType']]:
        """
        Type of resources contained in this cost allocation rule
        """
    ...
    def resource_type(self, value: pulumi.Input[Union[builtins.str, 'CostAllocationResourceType']]):
...
if not MYPY:
    class TagInheritancePropertiesArgsDict(TypedDict):
        ...
        """
        prefer_container_tags: pulumi.Input[builtins.bool]
        """
...
class TagInheritancePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The properties of the tag inheritance setting.
        :param pulumi.Input[builtins.bool] prefer_container_tags: This property defines the behavior when an inherited tag being applied matches a lower scope tag (Eg. Subscription tag matches the resource tag). If set to true - when tags match, the highest scope tags will be applied. Billing profile is the highest scope,  followed by invoice sections, subscriptions and resource groups (allows overriding of lower scope tag values). If set to false - when tags match, the lowest scope tags will be applied. So, if a resource has the same tag as a subscription tag, the resource tag will be applied (does not allow overriding of lower scope tag values).
        """
        pulumi.set(__self__, "prefer_container_tags", prefer_container_tags)

    @property
    @pulumi.getter(name="preferContainerTags")
    def prefer_container_tags(self) -> pulumi.Input[builtins.bool]:
        """
        This property defines the behavior when an inherited tag being applied matches a lower scope tag (Eg. Subscription tag matches the resource tag). If set to true - when tags match, the highest scope tags will be applied. Billing profile is the highest scope,  followed by invoice sections, subscriptions and resource groups (allows overriding of lower scope tag values). If set to false - when tags match, the lowest scope tags will be applied. So, if a resource has the same tag as a subscription tag, the resource tag will be applied (does not allow overriding of lower scope tag values).
        """
    ...
    def prefer_container_tags(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class TargetCostAllocationResourceArgsDict(TypedDict):
        ...
        If resource type is dimension, this must be either ResourceGroupName or SubscriptionId. If resource type is tag, this must be a valid Azure tag
        """
        policy_type: pulumi.Input[Union[builtins.str, 'CostAllocationPolicyType']]
        """
...
class TargetCostAllocationResourceArgs:
    def __init__(__self__, *,
        ...
        Target resources for cost allocation.
        :param pulumi.Input[builtins.str] name: If resource type is dimension, this must be either ResourceGroupName or SubscriptionId. If resource type is tag, this must be a valid Azure tag
        :param pulumi.Input[Union[builtins.str, 'CostAllocationPolicyType']] policy_type: Method of cost allocation for the rule
        :param pulumi.Input[Union[builtins.str, 'CostAllocationResourceType']] resource_type: Type of resources contained in this cost allocation rule
    ...
    def policy_type(self) -> pulumi.Input[Union[builtins.str, 'CostAllocationPolicyType']]:
        """
        Method of cost allocation for the rule
        """
    ...
    @policy_type.setter
    def policy_type(self, value: pulumi.Input[Union[builtins.str, 'CostAllocationPolicyType']]):
