...
def get_report_by_resource_group_name(report_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement:getReportByResourceGroupName', __args__, opts=opts, typ=GetReportByResourceGroupNameResult).value
...
def get_report_by_resource_group_name_output(report_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement:getReportByResourceGroupName', __args__, opts=opts, typ=GetReportByResourceGroupNameResult)
