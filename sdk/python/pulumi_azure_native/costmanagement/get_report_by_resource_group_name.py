...
def get_report_by_resource_group_name(report_name: Optional[_builtins.str] = None,
...
def get_report_by_resource_group_name_output(report_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
