...
class ReportByBillingAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] billing_account_id: BillingAccount ID
...
class ReportByBillingAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20180801preview:ReportByBillingAccount")])
