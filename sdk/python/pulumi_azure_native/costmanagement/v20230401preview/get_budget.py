...
def get_budget(budget_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20230401preview:getBudget', __args__, opts=opts, typ=GetBudgetResult).value
...
def get_budget_output(budget_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230401preview:getBudget', __args__, opts=opts, typ=GetBudgetResult)
