...
class ExportArgs:
    ...
    def _configure(
             ...
             definition: Optional[pulumi.Input['ExportDefinitionArgs']] = None,
        ...
        if partition_data is None and 'partitionData' in kwargs:
...
class Export(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            definition = _utilities.configure(definition, ExportDefinitionArgs, True)
            ...
            identity = _utilities.configure(identity, SystemAssignedServiceIdentityArgs, True)
