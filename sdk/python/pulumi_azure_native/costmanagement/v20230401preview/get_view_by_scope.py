...
def get_view_by_scope(scope: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20230401preview:getViewByScope', __args__, opts=opts, typ=GetViewByScopeResult).value
...
def get_view_by_scope_output(scope: Optional[pulumi.Input[str]] = None,
    ...
    __args__['viewName'] = view_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230401preview:getViewByScope', __args__, opts=opts, typ=GetViewByScopeResult)
