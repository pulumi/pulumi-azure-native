...
def get_export(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20230401preview:getExport', __args__, opts=opts, typ=GetExportResult).value
...
def get_export_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20230401preview:getExport', __args__, opts=opts, typ=GetExportResult)
