...
class ReportByDepartmentArgs:
    def __init__(__self__, *,
        ...
        """
        ReportByDepartmentArgs._configure(
    ...
    def _configure(
        ...
        if department_id is None and 'departmentId' in kwargs:
            department_id = kwargs['departmentId']
        if department_id is None:
            raise TypeError("Missing 'department_id' argument")
        if report_name is None and 'reportName' in kwargs:
            report_name = kwargs['reportName']

        _setter("definition", definition)
        _setter("delivery_info", delivery_info)
        _setter("department_id", department_id)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ReportByDepartmentArgs._configure(_setter, **kwargs)
