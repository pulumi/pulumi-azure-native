...
class GetViewResult:
    ...
    @property
    @pulumi.getter
    def accumulated(self) -> Optional[builtins.str]:
        """
    ...
    def date_range(self) -> Optional[builtins.str]:
        """
    ...
    def include_monetary_commitment(self) -> Optional[builtins.bool]:
        """
...
def get_view(view_name: Optional[builtins.str] = None,
    ...
    :param builtins.str view_name: View name
    """
    __args__ = dict()
    __args__['viewName'] = view_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement:getView', __args__, opts=opts, typ=GetViewResult).value
...
def get_view_output(view_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement:getView', __args__, opts=opts, typ=GetViewResult)
