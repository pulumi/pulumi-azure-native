...
class ReportByResourceGroupName(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20180801preview:ReportByResourceGroupName"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20180801preview:ReportByResourceGroupName")])
