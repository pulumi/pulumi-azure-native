...
def get_report_by_billing_account(billing_account_id: Optional[builtins.str] = None,
...
def get_report_by_billing_account_output(billing_account_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement:getReportByBillingAccount', __args__, opts=opts, typ=GetReportByBillingAccountResult)
