...
class MarkupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] billing_profile_id: BillingProfile ID
        :param pulumi.Input['CustomerMetadataArgs'] customer_details: Customer information for the markup rule.
        :param pulumi.Input[builtins.float] percentage: The markup percentage of the rule.
        :param pulumi.Input[builtins.str] start_date: Starting date of the markup rule.
        :param pulumi.Input[builtins.str] description: The description of the markup rule.
        ...
        :param pulumi.Input[builtins.str] end_date: Ending date of the markup rule.
        :param pulumi.Input[builtins.str] name: Markup rule name.
        """
