...
class TagInheritanceSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20221001preview:TagInheritanceSetting"), pulumi.Alias(type_="azure-native:costmanagement/v20221005preview:TagInheritanceSetting"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:TagInheritanceSetting"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:TagInheritanceSetting"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:TagInheritanceSetting"), pulumi.Alias(type_="azure-native:costmanagement:TagInheritanceSetting")])
