...
class Export(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement/v20190101:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20190901:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20191001:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20200601:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20201201preview:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20210101:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20211001:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20221001:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20230301:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20230401preview:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20230701preview:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20230801:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20230901:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20231101:Export"), pulumi.Alias(type_="azure-native:costmanagement/v20241001preview:Export"), pulumi.Alias(type_="azure-native:costmanagement:Export")])
