...
class ConnectorCollectionErrorInfoResponse(dict):
    ...
    def _configure(
        ...
        if 'errorStartTime' in kwargs:
            error_start_time = kwargs['errorStartTime']
        if 'errorInnerMessage' in kwargs:
    ...
    def error_inner_message(self) -> Optional[str]:
        """
...
class CustomerMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CustomerMetadataResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
