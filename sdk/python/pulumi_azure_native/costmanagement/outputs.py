...
class CommonExportPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 partition_data: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str format: The format of the export being delivered. Currently only 'Csv' is supported.
        :param _builtins.bool partition_data: If set to true, exported data will be partitioned by size and placed in a blob directory together with a manifest file. Note: this option is currently available only for Microsoft Customer Agreement commerce scopes.
...
class ConnectorCollectionErrorInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str error_code: Short error code
        :param _builtins.str error_inner_message: External Provider error message
        :param _builtins.str error_message: Detailed error message
        :param _builtins.str error_start_time: Time the error started occurring (Last time error occurred in lastChecked)
        """
        pulumi.set(__self__, "error_code", error_code)
...
class ConnectorCollectionInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_checked: Last time the data acquisition process initiated connecting to the external provider
        :param _builtins.str last_updated: Last time the external data was updated into Azure
        :param _builtins.str source_last_updated: Source timestamp of external data currently available in Azure (eg AWS last processed CUR file timestamp)
...
class CostAllocationRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str updated_date: Time at which the rule was last updated.
        :param _builtins.str description: Description of a cost allocation rule.
        """
...
class ExportDeliveryDestinationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sas_token: A SAS token for the storage account. For a restricted set of Azure customers this together with storageAccount can be specified instead of resourceId. Note: the value returned by the API for this property will always be obfuscated. Returning this same obfuscated value will not result in the SAS token being updated. To update this value a new SAS token must be specified.
        :param _builtins.str storage_account: The storage account where exports will be uploaded. For a restricted set of Azure customers this together with sasToken can be specified instead of resourceId.
        """
...
class ExportRunResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 processing_end_time: Optional[_builtins.str] = None,
                 processing_start_time: Optional[_builtins.str] = None,
                 run_settings: Optional['outputs.CommonExportPropertiesResponse'] = None,
                 status: Optional[_builtins.str] = None,
                 submitted_by: Optional[_builtins.str] = None,
        ...
        :param _builtins.str e_tag: eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
        :param 'ErrorDetailsResponse' error: The details of any error.
        :param _builtins.str execution_type: The type of the export run.
        :param _builtins.str file_name: The name of the exported file.
        :param _builtins.str processing_end_time: The time when the export run finished.
        :param _builtins.str processing_start_time: The time when export was picked up to be run.
        :param 'CommonExportPropertiesResponse' run_settings: The export settings that were in effect for this run.
        :param _builtins.str status: The last known status of the export run.
        :param _builtins.str submitted_by: The identifier for the entity that triggered the export. For on-demand runs it is the user email. For scheduled runs it is 'System'.
        :param _builtins.str submitted_time: The time when export was queued to be run.
        """
...
class NotificationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str message: Optional message to be added in the email. Length is limited to 250 characters.
        :param _builtins.str regional_format: Regional format used for formatting date/time and currency values in the email.
        """
...
class NotificationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: The comparison operator.
               ...
               - LessThan
        :param _builtins.float threshold: Threshold value associated with a notification. It is always percent with a maximum of 2 decimal places.
        ...
        :param Sequence[_builtins.str] contact_groups: Subscription or Resource Group scopes only. Action groups to send the notification to when the threshold is exceeded. Must be provided as a fully qualified Azure resource id.
               
                Supported for CategoryType(s): Cost.
        :param Sequence[_builtins.str] contact_roles: Subscription or Resource Group scopes only. Contact roles to send the notification to when the threshold is breached.
...
class ReportConfigDatasetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str granularity: The granularity of rows in the report.
...
class SchedulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int day_of_month: UTC day on which cost analysis data will be emailed. Must be between 1 and 31. This property is applicable when frequency is Monthly and overrides weeksOfMonth or daysOfWeek.
        :param Sequence[_builtins.str] days_of_week: Day names in english on which cost analysis data will be emailed. This property is applicable when frequency is Weekly or Monthly.
        :param _builtins.int hour_of_day: UTC time at which cost analysis data will be emailed.
        :param Sequence[_builtins.str] weeks_of_month: Weeks in which cost analysis data will be emailed. This property is applicable when frequency is Monthly and used in combination with daysOfWeek.
        """
        pulumi.set(__self__, "end_date", end_date)
        pulumi.set(__self__, "frequency", frequency)
        pulumi.set(__self__, "start_date", start_date)
...
class SettingsPropertiesResponseCache(dict):
    def __init__(__self__, *,
                 ...
                 status: Optional[_builtins.str] = None):
        """
        :param _builtins.str channel: Indicates the account type. Allowed values include: EA, PAYG, Modern, Internal, Unknown.
        :param _builtins.str id: Resource ID used by Resource Manager to uniquely identify the scope.
        :param _builtins.str name: Display name for the scope.
        :param _builtins.str subchannel: Indicates the type of modern account. Allowed values include: Individual, Enterprise, Partner, Indirect, NotApplicable
        :param _builtins.str parent: Resource ID of the parent scope. For instance, subscription's resource ID for a resource group or a management group resource ID for a subscription.
        :param _builtins.str status: Indicates the status of the scope. Status only applies to subscriptions and billing accounts.
        """
