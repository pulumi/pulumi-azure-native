...
class SettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: Sets the default scope the current user will see when they sign into Azure Cost Management in the Azure portal.
        ...
        :param pulumi.Input[builtins.str] setting_name: Name of the setting. Allowed values: myscope
        :param pulumi.Input[builtins.str] start_on: Indicates what scope Cost Management in the Azure portal should default to. Allowed values: LastUsed.
        """
...
class Setting(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="startOn")
    def start_on(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates what scope Cost Management in the Azure portal should default to. Allowed values: LastUsed.
        """
        return pulumi.get(self, "start_on")
