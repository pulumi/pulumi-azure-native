...
def get_budget(budget_name: Optional[builtins.str] = None,
    ...
    :param builtins.str budget_name: Budget Name.
    :param builtins.str scope: The scope associated with budget operations.
...
def get_budget_output(budget_name: Optional[pulumi.Input[builtins.str]] = None,
