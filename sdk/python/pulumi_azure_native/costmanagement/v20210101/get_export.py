...
def get_export(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_export is deprecated: azure-native:costmanagement/v20210101:Export is being removed in the next major version of this provider. Please upgrade to azure-native:costmanagement/v20221001:Export to guarantee forwards compatibility.""")
    __args__ = dict()
