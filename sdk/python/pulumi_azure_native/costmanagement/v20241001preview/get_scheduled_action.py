...
def get_scheduled_action(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20241001preview:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult).value
...
def get_scheduled_action_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20241001preview:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult)
