...
def get_cost_allocation_rule(billing_account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/v20241001preview:getCostAllocationRule', __args__, opts=opts, typ=GetCostAllocationRuleResult).value
...
def get_cost_allocation_rule_output(billing_account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:costmanagement/v20241001preview:getCostAllocationRule', __args__, opts=opts, typ=GetCostAllocationRuleResult)
