...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getSetting'.""", DeprecationWarning)
...
def get_setting(setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_setting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getSetting'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getSetting', __args__, opts=opts, typ=GetSettingResult).value
