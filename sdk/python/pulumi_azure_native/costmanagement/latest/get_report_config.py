...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getReportConfig'.""", DeprecationWarning)
...
def get_report_config(report_config_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getReportConfig', __args__, opts=opts, typ=GetReportConfigResult).value
