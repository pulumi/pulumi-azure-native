...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:costmanagement:ReportConfig'.""", DeprecationWarning)
...
class ReportConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement/latest:ReportConfig"), pulumi.Alias(type_="azure-native:costmanagement:ReportConfig"), pulumi.Alias(type_="azure-nextgen:costmanagement:ReportConfig"), pulumi.Alias(type_="azure-native:costmanagement/v20180531:ReportConfig"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20180531:ReportConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportConfig, __self__).__init__(
            'azure-native:costmanagement/latest:ReportConfig',
            resource_name,
            __props__,
            opts)
