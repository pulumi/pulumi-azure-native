...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getView'.""", DeprecationWarning)
...
def get_view(view_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getView', __args__, opts=opts, typ=GetViewResult).value
