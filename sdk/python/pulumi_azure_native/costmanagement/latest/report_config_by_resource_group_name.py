...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:costmanagement:ReportConfigByResourceGroupName'.""", DeprecationWarning)
...
class ReportConfigByResourceGroupName(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:costmanagement:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-nextgen:costmanagement:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-native:costmanagement/v20180531:ReportConfigByResourceGroupName"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20180531:ReportConfigByResourceGroupName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportConfigByResourceGroupName, __self__).__init__(
            'azure-native:costmanagement/latest:ReportConfigByResourceGroupName',
            resource_name,
            __props__,
            opts)
