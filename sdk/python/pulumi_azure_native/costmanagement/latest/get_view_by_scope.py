...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getViewByScope'.""", DeprecationWarning)
...
def get_view_by_scope(scope: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view_by_scope is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getViewByScope'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getViewByScope', __args__, opts=opts, typ=GetViewByScopeResult).value
