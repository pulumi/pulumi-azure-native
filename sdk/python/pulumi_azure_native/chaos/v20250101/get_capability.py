...
class GetCapabilityResult:
    ...
    """
    def __init__(__self__, description=None, id=None, name=None, parameters_schema=None, publisher=None, system_data=None, target_type=None, type=None, urn=None):
...
def get_capability(capability_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20250101:getCapability', __args__, opts=opts, typ=GetCapabilityResult).value
...
def get_capability_output(capability_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20250101:getCapability', __args__, opts=opts, typ=GetCapabilityResult)
