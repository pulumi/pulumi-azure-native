...
class GetExperimentResult:
    ...
    """
    def __init__(__self__, id=None, identity=None, location=None, name=None, provisioning_state=None, selectors=None, steps=None, system_data=None, tags=None, type=None):
...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20250101:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value
...
def get_experiment_output(experiment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20250101:getExperiment', __args__, opts=opts, typ=GetExperimentResult)
