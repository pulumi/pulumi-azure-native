...
class TargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] parent_provider_namespace: The parent resource provider namespace.
        :param pulumi.Input[str] parent_resource_name: The parent resource name.
        :param pulumi.Input[str] parent_resource_type: The parent resource type.
