...
class GetExperimentResult:
    ...
    """
    def __init__(__self__, customer_data_storage=None, id=None, identity=None, location=None, name=None, provisioning_state=None, selectors=None, steps=None, system_data=None, tags=None, type=None):
        if customer_data_storage and not isinstance(customer_data_storage, dict):
            raise TypeError("Expected argument 'customer_data_storage' to be a dict")
        ...
        if selectors and not isinstance(selectors, list):
            raise TypeError("Expected argument 'selectors' to be a list")
    ...
    @property
    @pulumi.getter
    def steps(self) -> Sequence['outputs.ChaosExperimentStepResponse']:
        """
        List of steps.
        """
...
class AwaitableGetExperimentResult(GetExperimentResult):
    ...
    def __await__(self):
        ...
        return GetExperimentResult(
            customer_data_storage=self.customer_data_storage,
            id=self.id,
...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20241101preview:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value

    return AwaitableGetExperimentResult(
        customer_data_storage=pulumi.get(__ret__, 'customer_data_storage'),
        id=pulumi.get(__ret__, 'id'),
        identity=pulumi.get(__ret__, 'identity'),
        location=pulumi.get(__ret__, 'location'),
        name=pulumi.get(__ret__, 'name'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        selectors=pulumi.get(__ret__, 'selectors'),
...
def get_experiment_output(experiment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20241101preview:getExperiment', __args__, opts=opts, typ=GetExperimentResult)
    return __ret__.apply(lambda __response__: GetExperimentResult(
        customer_data_storage=pulumi.get(__response__, 'customer_data_storage'),
        id=pulumi.get(__response__, 'id'),
        identity=pulumi.get(__response__, 'identity'),
        location=pulumi.get(__response__, 'location'),
        name=pulumi.get(__response__, 'name'),
        provisioning_state=pulumi.get(__response__, 'provisioning_state'),
        selectors=pulumi.get(__response__, 'selectors'),
