...
class PrivateAccess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20231027preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20240322preview:PrivateAccess")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateAccess, __self__).__init__(
            'azure-native:chaos/v20241101preview:PrivateAccess',
            resource_name,
            __props__,
            opts)
