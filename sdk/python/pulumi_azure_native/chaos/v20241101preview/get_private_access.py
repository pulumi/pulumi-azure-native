...
def get_private_access(private_access_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20241101preview:getPrivateAccess', __args__, opts=opts, typ=GetPrivateAccessResult).value
...
def get_private_access_output(private_access_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20241101preview:getPrivateAccess', __args__, opts=opts, typ=GetPrivateAccessResult)
    return __ret__.apply(lambda __response__: GetPrivateAccessResult(
