...
def get_target(parent_provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20241101preview:getTarget', __args__, opts=opts, typ=GetTargetResult).value
...
def get_target_output(parent_provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20241101preview:getTarget', __args__, opts=opts, typ=GetTargetResult)
