...
def get_capability(capability_name: Optional[builtins.str] = None,
                   parent_provider_namespace: Optional[builtins.str] = None,
    ...
    :param builtins.str capability_name: String that represents a Capability resource name.
...
def get_capability_output(capability_name: Optional[pulumi.Input[builtins.str]] = None,
