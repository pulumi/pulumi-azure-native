...
def get_capability(capability_name: Optional[_builtins.str] = None,
                   parent_provider_namespace: Optional[_builtins.str] = None,
                   parent_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str parent_resource_type: String that represents a resource type.
    :param _builtins.str resource_group_name: String that represents an Azure resource group.
    :param _builtins.str target_name: String that represents a Target resource name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos:getCapability', __args__, opts=opts, typ=GetCapabilityResult).value
...
def get_capability_output(capability_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
