...
class BranchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: String of the branch name.
        """
...
if not MYPY:
    class ContinuousActionArgsDict(TypedDict):
        ...
        """
        selector_id: pulumi.Input[builtins.str]
        """
...
class ContinuousActionArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents a continuous action.
        :param pulumi.Input[builtins.str] duration: ISO8601 formatted string that represents a duration.
        :param pulumi.Input[builtins.str] name: String that represents a Capability URN.
        :param pulumi.Input[Sequence[pulumi.Input['KeyValuePairArgs']]] parameters: List of key value pairs.
        :param pulumi.Input[builtins.str] selector_id: String that represents a selector.
        :param pulumi.Input[builtins.str] type: Enum that discriminates between action models.
               Expected value is 'continuous'.
        """
    ...
    def selector_id(self) -> pulumi.Input[builtins.str]:
        """
        String that represents a selector.
        """
    ...
    @selector_id.setter
    def selector_id(self, value: pulumi.Input[builtins.str]):
...
class CustomerDataStoragePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents the Customer Managed Storage for an Experiment.
        :param pulumi.Input[builtins.str] blob_container_name: Name of the Azure Blob Storage container to use or create.
        :param pulumi.Input[builtins.str] storage_account_resource_id: ARM Resource ID of the Storage account to use for Customer Data storage.
        """
...
class KeyValuePairArgs:
    def __init__(__self__, *,
        ...
        """
        A map to describe the settings of an action.
        :param pulumi.Input[builtins.str] key: The name of the setting for the action.
        :param pulumi.Input[builtins.str] value: The value of the setting for the action.
        """
...
class ListSelectorArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents a list selector.
        :param pulumi.Input[builtins.str] id: String of the selector ID.
        :param pulumi.Input[Sequence[pulumi.Input['TargetReferenceArgs']]] targets: List of Target references.
        :param pulumi.Input[builtins.str] type: Enum of the selector type.
               Expected value is 'List'.
...
if not MYPY:
    class QuerySelectorArgsDict(TypedDict):
        ...
        """
        subscription_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class QuerySelectorArgs:
    def __init__(__self__, *,
        ...
        Model that represents a query selector.
        :param pulumi.Input[builtins.str] id: String of the selector ID.
        :param pulumi.Input[builtins.str] query_string: Azure Resource Graph (ARG) Query Language query for target resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscription_ids: Subscription id list to scope resource query.
        :param pulumi.Input[builtins.str] type: Enum of the selector type.
               Expected value is 'Query'.
        :param pulumi.Input['SimpleFilterArgs'] filter: Model that represents available filter types that can be applied to a targets list.
        """
    ...
    def subscription_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Subscription id list to scope resource query.
        """
    ...
    def subscription_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class SimpleFilterParametersArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents the Simple filter parameters.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: List of Azure availability zones to filter targets by.
        """
...
class SimpleFilterArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents a simple target filter.
        :param pulumi.Input[builtins.str] type: Enum that discriminates between filter types. Currently only `Simple` type is supported.
               Expected value is 'Simple'.
...
class StepArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: String of the step name.
        """
...
if not MYPY:
    class TargetReferenceArgsDict(TypedDict):
        ...
        """
        type: pulumi.Input[Union[builtins.str, 'TargetReferenceType']]
        """
...
class TargetReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        Model that represents a reference to a Target in the selector.
        :param pulumi.Input[builtins.str] id: String of the resource ID of a Target resource.
        :param pulumi.Input[Union[builtins.str, 'TargetReferenceType']] type: Enum of the Target reference type.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[builtins.str, 'TargetReferenceType']]:
        """
        Enum of the Target reference type.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[builtins.str, 'TargetReferenceType']]):
        pulumi.set(self, "type", value)
