...
class CapabilityArgs:
    def __init__(__self__, *,
                 parent_provider_namespace: pulumi.Input[builtins.str],
                 parent_resource_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] parent_provider_namespace: String that represents a resource provider namespace.
        :param pulumi.Input[builtins.str] parent_resource_name: String that represents a resource name.
        :param pulumi.Input[builtins.str] parent_resource_type: String that represents a resource type.
        :param pulumi.Input[builtins.str] resource_group_name: String that represents an Azure resource group.
        :param pulumi.Input[builtins.str] target_name: String that represents a Target resource name.
        :param pulumi.Input[builtins.str] capability_name: String that represents a Capability resource name.
        """
    ...
    def parent_provider_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parent_provider_namespace(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "parent_provider_namespace", value)

    @property
    @pulumi.getter(name="parentResourceName")
    def parent_resource_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parent_resource_name(self, value: pulumi.Input[builtins.str]):
...
class Capability(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 capability_name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_provider_namespace: Optional[pulumi.Input[builtins.str]] = None,
