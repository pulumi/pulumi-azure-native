...
warnings.warn("""azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.""", DeprecationWarning)
...
class Target(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Target is deprecated: azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos:Target"), pulumi.Alias(type_="azure-native:chaos/v20210915preview:Target"), pulumi.Alias(type_="azure-native:chaos/v20221001preview:Target"), pulumi.Alias(type_="azure-native:chaos/v20230401preview:Target")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Target, __self__).__init__(
            'azure-native:chaos/v20220701preview:Target',
            resource_name,
            __props__,
            opts)
