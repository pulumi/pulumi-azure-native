...
warnings.warn("""azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.""", DeprecationWarning)
...
class Target(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Target is deprecated: azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.""")
