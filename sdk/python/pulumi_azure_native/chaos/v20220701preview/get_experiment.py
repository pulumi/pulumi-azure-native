...
warnings.warn("""azure-native:chaos/v20220701preview:Experiment is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Experiment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_experiment is deprecated: azure-native:chaos/v20220701preview:Experiment is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Experiment to guarantee forwards compatibility.""")
    __args__ = dict()
