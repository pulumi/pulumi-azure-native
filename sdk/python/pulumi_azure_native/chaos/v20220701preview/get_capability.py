...
def get_capability(capability_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_capability is deprecated: azure-native:chaos/v20220701preview:Capability is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Capability to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20220701preview:getCapability', __args__, opts=opts, typ=GetCapabilityResult).value
