...
def get_target(parent_provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_target is deprecated: azure-native:chaos/v20220701preview:Target is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Target to guarantee forwards compatibility.""")
    __args__ = dict()
