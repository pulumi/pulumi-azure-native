...
warnings.warn("""azure-native:chaos/v20220701preview:Capability is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Capability to guarantee forwards compatibility.""", DeprecationWarning)
...
class Capability(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Capability is deprecated: azure-native:chaos/v20220701preview:Capability is being removed in the next major version of this provider. Please upgrade to azure-native:chaos/v20230401preview:Capability to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos:Capability"), pulumi.Alias(type_="azure-native:chaos/v20210915preview:Capability"), pulumi.Alias(type_="azure-native:chaos/v20221001preview:Capability"), pulumi.Alias(type_="azure-native:chaos/v20230401preview:Capability")])
