...
class PrivateAccessArgs:
    ...
    def public_network_access(self) -> pulumi.Input[Optional[Union[_builtins.str, 'PublicNetworkAccessOption']]]:
        """
    ...
    def public_network_access(self, value: pulumi.Input[Optional[Union[_builtins.str, 'PublicNetworkAccessOption']]]):
...
class PrivateAccess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos/v20231027preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20240322preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20241101preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20260501preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20260801preview:PrivateAccess")])
