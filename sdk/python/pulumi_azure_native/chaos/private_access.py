...
class PrivateAccess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos/v20231027preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20240322preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20241101preview:PrivateAccess"), pulumi.Alias(type_="azure-native_chaos_v20231027preview:chaos:PrivateAccess"), pulumi.Alias(type_="azure-native_chaos_v20240322preview:chaos:PrivateAccess"), pulumi.Alias(type_="azure-native_chaos_v20241101preview:chaos:PrivateAccess")])
