...
class PrivateAccessArgs:
    def __init__(__self__, *,
                 ...
                 private_access_name: Optional[pulumi.Input[_builtins.str]] = None,
                 public_network_access: Optional[pulumi.Input[Union[_builtins.str, 'PublicNetworkAccessOption']]] = None,
    ...
    def public_network_access(self) -> Optional[pulumi.Input[Union[_builtins.str, 'PublicNetworkAccessOption']]]:
        """
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[_builtins.str, 'PublicNetworkAccessOption']]]):
...
class PrivateAccess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:chaos/v20231027preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20240322preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20241101preview:PrivateAccess"), pulumi.Alias(type_="azure-native:chaos/v20260501preview:PrivateAccess")])
