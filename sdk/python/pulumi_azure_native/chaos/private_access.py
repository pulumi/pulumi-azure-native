...
class PrivateAccessArgs:
    def __init__(__self__, *,
                 ...
                 private_access_name: Optional[pulumi.Input[builtins.str]] = None,
                 public_network_access: Optional[pulumi.Input[Union[builtins.str, 'PublicNetworkAccessOption']]] = None,
        ...
        :param pulumi.Input[builtins.str] private_access_name: The name of the private access resource that is being created. Supported characters for the name are a-z, A-Z, 0-9, _ and -. The maximum name length is 80 characters.
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccessOption']] public_network_access: Public Network Access Control for PrivateAccess resource.
    ...
    def private_access_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_access_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_access_name", value)

    @property
    @pulumi.getter(name="publicNetworkAccess")
    def public_network_access(self) -> Optional[pulumi.Input[Union[builtins.str, 'PublicNetworkAccessOption']]]:
        """
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[builtins.str, 'PublicNetworkAccessOption']]]):
...
class PrivateAccess(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:chaos:PrivateAccess"
