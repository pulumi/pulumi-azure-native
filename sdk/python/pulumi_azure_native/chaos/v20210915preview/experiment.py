...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:chaos/v20210915preview:Experiment"), pulumi.Alias(type_="azure-native:chaos:Experiment"), pulumi.Alias(type_="azure-nextgen:chaos:Experiment")])
