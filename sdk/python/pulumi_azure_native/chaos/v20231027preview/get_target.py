...
def get_target(parent_provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20231027preview:getTarget', __args__, opts=opts, typ=GetTargetResult).value
...
def get_target_output(parent_provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetName'] = target_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20231027preview:getTarget', __args__, opts=opts, typ=GetTargetResult)
