...
def get_private_access(private_access_name: Optional[_builtins.str] = None,
...
def get_private_access_output(private_access_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
