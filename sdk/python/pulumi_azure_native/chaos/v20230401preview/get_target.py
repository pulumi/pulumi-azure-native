...
def get_target(parent_provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_target is deprecated: azure-native:chaos/v20230401preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20230401preview:getTarget', __args__, opts=opts, typ=GetTargetResult).value
