...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20230415preview:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value
...
def get_experiment_output(experiment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20230415preview:getExperiment', __args__, opts=opts, typ=GetExperimentResult)
