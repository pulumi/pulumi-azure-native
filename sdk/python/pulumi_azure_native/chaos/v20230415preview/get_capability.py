...
def get_capability(capability_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:chaos/v20230415preview:getCapability', __args__, opts=opts, typ=GetCapabilityResult).value
...
def get_capability_output(capability_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetName'] = target_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:chaos/v20230415preview:getCapability', __args__, opts=opts, typ=GetCapabilityResult)
