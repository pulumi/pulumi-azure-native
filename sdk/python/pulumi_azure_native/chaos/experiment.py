...
class ExperimentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] experiment_name: String that represents a Experiment resource name.
