...
def get_capability(capability_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_capability is deprecated: azure-native:chaos/v20221001preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.""")
    __args__ = dict()
