...
def get_target(parent_provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_target is deprecated: azure-native:chaos/v20221001preview:Target is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Target to guarantee forwards compatibility.""")
    __args__ = dict()
