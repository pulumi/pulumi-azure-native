...
warnings.warn("""azure-native:chaos/v20221001preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.""", DeprecationWarning)
...
class Capability(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Capability is deprecated: azure-native:chaos/v20221001preview:Capability is being removed in the next major version of this provider. Upgrade to at least azure-native:chaos/v20230415preview:Capability to guarantee forwards compatibility.""")
