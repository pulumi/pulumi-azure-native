...
class AgriServiceResourcePropertiesArgsDict(TypedDict):
    ...
    """
    data_connector_credentials: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DataConnectorCredentialMapArgs']]]]]
    """
    Data connector credentials of AgriService instance.
    """
    installed_solutions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InstalledSolutionMapArgs']]]]]
    """
