...
def get_agri_service(agri_service_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:agricultureplatform/v20240601preview:getAgriService', __args__, opts=opts, typ=GetAgriServiceResult).value
...
def get_agri_service_output(agri_service_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:agricultureplatform/v20240601preview:getAgriService', __args__, opts=opts, typ=GetAgriServiceResult)
