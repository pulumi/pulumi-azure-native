...
class CapacityDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ResourceSkuArgs'] sku: The SKU of the PowerBI Dedicated resource.
...
class CapacityDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        capacity_details = azure_native.powerbidedicated.v20171001.CapacityDetails("capacityDetails",
            administration=azure_native.powerbidedicated.v20171001.DedicatedCapacityAdministratorsArgs(
                members=[
            ...
            sku=azure_native.powerbidedicated.v20171001.ResourceSkuArgs(
                name="A1",
                tier="PBIE_Azure",
            ),
            tags={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbidedicated:CapacityDetails"), pulumi.Alias(type_="azure-native:powerbidedicated/v20210101:CapacityDetails")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityDetails, __self__).__init__(
            'azure-native:powerbidedicated/v20171001:CapacityDetails',
            resource_name,
            __props__,
            opts)
