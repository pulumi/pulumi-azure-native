...
class CapacityDetailsArgs:
    ...
    def _configure(
        ...
        if dedicated_capacity_name is None and 'dedicatedCapacityName' in kwargs:
            dedicated_capacity_name = kwargs['dedicatedCapacityName']
...
class CapacityDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            administration = _utilities.configure(administration, DedicatedCapacityAdministratorsArgs, True)
            ...
            sku = _utilities.configure(sku, CapacitySkuArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbidedicated:CapacityDetails"), pulumi.Alias(type_="azure-native:powerbidedicated/v20171001:CapacityDetails")])
