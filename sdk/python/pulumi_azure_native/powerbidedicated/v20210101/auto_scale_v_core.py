...
class AutoScaleVCoreArgs:
    ...
    def _configure(
             ...
             sku: Optional[pulumi.Input['AutoScaleVCoreSkuArgs']] = None,
             capacity_limit: Optional[pulumi.Input[int]] = None,
             capacity_object_id: Optional[pulumi.Input[str]] = None,
             location: Optional[pulumi.Input[str]] = None,
             system_data: Optional[pulumi.Input['SystemDataArgs']] = None,
        ...
        if capacity_limit is None and 'capacityLimit' in kwargs:
            capacity_limit = kwargs['capacityLimit']
        if capacity_object_id is None and 'capacityObjectId' in kwargs:
            capacity_object_id = kwargs['capacityObjectId']
        if system_data is None and 'systemData' in kwargs:
            system_data = kwargs['systemData']
        if vcore_name is None and 'vcoreName' in kwargs:
            vcore_name = kwargs['vcoreName']
...
class AutoScaleVCore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            sku = _utilities.configure(sku, AutoScaleVCoreSkuArgs, True)
            if sku is None and not opts.urn:
                raise TypeError("Missing required property 'sku'")
            __props__.__dict__["sku"] = sku
            system_data = _utilities.configure(system_data, SystemDataArgs, True)
