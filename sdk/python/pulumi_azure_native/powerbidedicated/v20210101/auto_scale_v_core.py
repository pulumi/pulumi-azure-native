...
class AutoScaleVCore(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbidedicated:AutoScaleVCore"), pulumi.Alias(type_="azure-nextgen:powerbidedicated:AutoScaleVCore"), pulumi.Alias(type_="azure-native:powerbidedicated/latest:AutoScaleVCore"), pulumi.Alias(type_="azure-nextgen:powerbidedicated/latest:AutoScaleVCore")])
