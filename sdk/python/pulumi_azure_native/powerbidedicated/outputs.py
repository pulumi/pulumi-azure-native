...
class AutoScaleVCoreSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents the SKU name and Azure pricing tier for auto scale v-core resource.
        :param builtins.str name: Name of the SKU level.
        :param builtins.int capacity: The capacity of an auto scale v-core resource.
        :param builtins.str tier: The name of the Azure pricing tier to which the SKU applies.
        """
...
class CapacitySkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Represents the SKU name and Azure pricing tier for PowerBI Dedicated capacity resource.
        :param builtins.str name: Name of the SKU level.
        :param builtins.int capacity: The capacity of the SKU.
        :param builtins.str tier: The name of the Azure pricing tier to which the SKU applies.
        """
        pulumi.set(__self__, "name", name)
        if capacity is not None:
