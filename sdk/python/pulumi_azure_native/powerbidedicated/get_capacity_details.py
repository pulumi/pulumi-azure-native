...
def get_capacity_details(dedicated_capacity_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dedicated_capacity_name: The name of the dedicated capacity. It must be a minimum of 3 characters, and a maximum of 63.
...
def get_capacity_details_output(dedicated_capacity_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
