...
class AutoScaleVCoreArgs:
    ...
    def capacity_object_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def capacity_object_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcore_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vcore_name.setter
    def vcore_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutoScaleVCore(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="capacityLimit")
    def capacity_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum capacity of an auto scale v-core resource.
        """
        return pulumi.get(self, "capacity_limit")
    ...
    @property
    @pulumi.getter(name="capacityObjectId")
    def capacity_object_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The object ID of the capacity resource associated with the auto scale v-core resource.
        """
        return pulumi.get(self, "capacity_object_id")
