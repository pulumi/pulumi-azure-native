...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:powerbidedicated:getCapacityDetails'.""", DeprecationWarning)
...
def get_capacity_details(dedicated_capacity_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_capacity_details is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:powerbidedicated:getCapacityDetails'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:powerbidedicated/latest:getCapacityDetails', __args__, opts=opts, typ=GetCapacityDetailsResult).value
