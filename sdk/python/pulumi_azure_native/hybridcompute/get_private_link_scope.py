...
def get_private_link_scope(resource_group_name: Optional[_builtins.str] = None,
                           scope_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scope_name: The name of the Azure Arc PrivateLinkScope resource.
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['scopeName'] = scope_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult).value
...
def get_private_link_scope_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                  scope_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult)
