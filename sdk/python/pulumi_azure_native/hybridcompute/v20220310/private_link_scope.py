...
warnings.warn("""azure-native:hybridcompute/v20220310:PrivateLinkScope is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20221227preview:PrivateLinkScope to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateLinkScope is deprecated: azure-native:hybridcompute/v20220310:PrivateLinkScope is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20221227preview:PrivateLinkScope to guarantee forwards compatibility.""")
