...
def get_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20241110preview:getMachine', __args__, opts=opts, typ=GetMachineResult).value
...
def get_machine_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20241110preview:getMachine', __args__, opts=opts, typ=GetMachineResult)
