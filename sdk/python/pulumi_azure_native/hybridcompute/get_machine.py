...
def get_machine(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str machine_name: The name of the hybrid machine.
...
def get_machine_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
