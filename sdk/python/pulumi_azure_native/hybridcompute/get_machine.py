...
class GetMachineResult:
    ...
    def client_public_key(self) -> Optional[builtins.str]:
        """
    ...
    def detected_properties(self) -> Mapping[str, builtins.str]:
        """
    ...
    def mssql_discovered(self) -> Optional[builtins.str]:
        """
    ...
    def os_edition(self) -> builtins.str:
        """
    ...
    def parent_cluster_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_machine(expand: Optional[builtins.str] = None,
...
def get_machine_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute:getMachine', __args__, opts=opts, typ=GetMachineResult)
