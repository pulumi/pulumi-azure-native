...
def get_license_profile(license_profile_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str license_profile_name: The name of the license profile.
...
def get_license_profile_output(license_profile_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
