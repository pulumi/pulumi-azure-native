...
def get_machine_run_command(machine_name: Optional[builtins.str] = None,
    ...
    :param builtins.str run_command_name: The name of the run command.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute:getMachineRunCommand', __args__, opts=opts, typ=GetMachineRunCommandResult).value
...
def get_machine_run_command_output(machine_name: Optional[pulumi.Input[builtins.str]] = None,
