...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:Gateway"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:Gateway"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:Gateway"), pulumi.Alias(type_="azure-native:hybridcompute/v20240910preview:Gateway"), pulumi.Alias(type_="azure-native:hybridcompute/v20241110preview:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20240331preview:hybridcompute:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20240520preview:hybridcompute:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20240731preview:hybridcompute:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20240910preview:hybridcompute:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20241110preview:hybridcompute:Gateway"), pulumi.Alias(type_="azure-native_hybridcompute_v20250113:hybridcompute:Gateway")])
