...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.hybridcompute.v20221227preview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="private-endpoint-connection-name",
            properties=azure_native.hybridcompute.v20221227preview.PrivateEndpointConnectionPropertiesArgs(
                private_link_service_connection_state=azure_native.hybridcompute.v20221227preview.PrivateLinkServiceConnectionStatePropertyArgs(
