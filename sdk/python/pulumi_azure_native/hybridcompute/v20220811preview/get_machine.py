...
warnings.warn("""azure-native:hybridcompute/v20220811preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20221227preview:Machine to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine is deprecated: azure-native:hybridcompute/v20220811preview:Machine is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20221227preview:Machine to guarantee forwards compatibility.""")
    __args__ = dict()
