...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybridcompute/v20210325preview:Machine":
                return Machine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20210325preview:MachineExtension":
                return MachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20210325preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20210325preview:PrivateLinkScope":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybridcompute/v20210325preview", _module_instance)
