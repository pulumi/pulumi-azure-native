...
warnings.warn("""azure-native:hybridcompute/v20210128preview:Machine is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.""", DeprecationWarning)
