...
warnings.warn("""azure-native:hybridcompute/v20210128preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_extension is deprecated: azure-native:hybridcompute/v20210128preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['extensionName'] = extension_name
    __args__['machineName'] = machine_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20210128preview:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
