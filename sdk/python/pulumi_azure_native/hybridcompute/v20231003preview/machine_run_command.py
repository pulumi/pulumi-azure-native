...
class MachineRunCommand(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:MachineRunCommand")])
