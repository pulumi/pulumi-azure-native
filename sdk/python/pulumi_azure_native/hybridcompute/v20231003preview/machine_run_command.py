...
class MachineRunCommand(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:MachineRunCommand")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineRunCommand, __self__).__init__(
            'azure-native:hybridcompute/v20231003preview:MachineRunCommand',
            resource_name,
            __props__,
            opts)
