...
class MachineExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['MachineExtensionPropertiesArgs', 'MachineExtensionPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] machine_name: The name of the machine where the extension should be created or updated.
        :param pulumi.Input[Union['MachineExtensionPropertiesArgs', 'MachineExtensionPropertiesArgsDict']] properties: Describes Machine Extension Properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
