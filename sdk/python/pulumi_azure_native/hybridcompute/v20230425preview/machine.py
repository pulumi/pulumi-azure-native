...
class MachineArgs:
    def __init__(__self__, *,
                 ...
                 kind: Optional[pulumi.Input[Union[str, 'PrivateCloudKind']]] = None,
        ...
        :param pulumi.Input[Union[str, 'PrivateCloudKind']] kind: Indicates which kind of VM fabric the instance is an instance of, such as HCI or SCVMM etc.
    ...
    @property
    @pulumi.getter
    def kind(self) -> Optional[pulumi.Input[Union[str, 'PrivateCloudKind']]]:
        """
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[str, 'PrivateCloudKind']]]):
...
class Machine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20200802:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20200815preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210325preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20220510preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20221227:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20221227preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20230315preview:Machine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Machine, __self__).__init__(
            'azure-native:hybridcompute/v20230425preview:Machine',
            resource_name,
            __props__,
            opts)
