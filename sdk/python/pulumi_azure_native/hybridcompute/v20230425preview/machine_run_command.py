...
class MachineRunCommand(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute:MachineRunCommand")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineRunCommand, __self__).__init__(
            'azure-native:hybridcompute/v20230425preview:MachineRunCommand',
            resource_name,
            __props__,
            opts)
