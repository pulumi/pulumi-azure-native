...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybridcompute:getMachineExtension'.""", DeprecationWarning)
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/latest:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
