...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_extension is deprecated: Version 2019-08-02-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['extensionName'] = extension_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20190802preview:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
