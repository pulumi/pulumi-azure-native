...
class Machine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        machine = azure_native.hybridcompute.v20200815preview.Machine("machine",
            client_public_key="string",
            identity=azure_native.hybridcompute.v20200815preview.MachineIdentityArgs(
                type="SystemAssigned",
            ),
            location="eastus2euap",
            location_data=azure_native.hybridcompute.v20200815preview.LocationDataResponseArgs(
                name="Redmond",
            ),
            name="myMachine",
