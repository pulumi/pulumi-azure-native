...
class MachineExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if instance_view is not None and not isinstance(instance_view, MachineExtensionPropertiesInstanceViewArgs):
                instance_view = instance_view or {}
                def _setter(key, value):
                    instance_view[key] = value
                MachineExtensionPropertiesInstanceViewArgs._configure(_setter, **instance_view)
