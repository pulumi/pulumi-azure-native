...
warnings.warn("""Version 2020-08-15-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine is deprecated: Version 2020-08-15-preview will be removed in v2 of the provider.""")
    __args__ = dict()
