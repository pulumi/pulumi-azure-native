...
def get_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine is deprecated: Version v20200730preview will be removed in the next major version of the provider. Upgrade to version v20200802 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20200730preview:getMachine', __args__, opts=opts, typ=GetMachineResult).value
