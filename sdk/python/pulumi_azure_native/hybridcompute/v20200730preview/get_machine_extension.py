...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_extension is deprecated: Version v20200730preview will be removed in the next major version of the provider. Upgrade to version v20200802 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20200730preview:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
