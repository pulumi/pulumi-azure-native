...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20240710:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
...
def get_machine_extension_output(extension_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20240710:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult)
