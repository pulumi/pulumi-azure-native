...
class GetMachineResult:
    ...
    """
    def __init__(__self__, ad_fqdn=None, agent_configuration=None, agent_upgrade=None, agent_version=None, client_public_key=None, cloud_metadata=None, detected_properties=None, display_name=None, dns_fqdn=None, domain_name=None, error_details=None, extensions=None, firmware_profile=None, hardware_profile=None, id=None, identity=None, kind=None, last_status_change=None, license_profile=None, location=None, location_data=None, machine_fqdn=None, mssql_discovered=None, name=None, network_profile=None, os_edition=None, os_name=None, os_profile=None, os_sku=None, os_type=None, os_version=None, parent_cluster_resource_id=None, private_link_scope_resource_id=None, provisioning_state=None, resources=None, service_statuses=None, status=None, storage_profile=None, system_data=None, tags=None, type=None, vm_id=None, vm_uuid=None):
        ...
        if firmware_profile and not isinstance(firmware_profile, dict):
            raise TypeError("Expected argument 'firmware_profile' to be a dict")
        pulumi.set(__self__, "firmware_profile", firmware_profile)
    ...
    def firmware_profile(self) -> 'outputs.FirmwareProfileResponse':
        """
...
def get_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20240910preview:getMachine', __args__, opts=opts, typ=GetMachineResult).value
    ...
    return AwaitableGetMachineResult(
        ...
        firmware_profile=pulumi.get(__ret__, 'firmware_profile'),
...
def get_machine_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20240910preview:getMachine', __args__, opts=opts, typ=GetMachineResult)
    return __ret__.apply(lambda __response__: GetMachineResult(
        ...
        firmware_profile=pulumi.get(__response__, 'firmware_profile'),
