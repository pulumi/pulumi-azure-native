...
class MachineRunCommand(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 run_as_user: Optional[pulumi.Input[str]] = None,
                 run_command_name: Optional[pulumi.Input[str]] = None,
                 source: Optional[pulumi.Input[Union['MachineRunCommandScriptSourceArgs', 'MachineRunCommandScriptSourceArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 timeout_in_seconds: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] run_as_user: Specifies the user account on the machine when executing the run command.
        :param pulumi.Input[str] run_command_name: The name of the run command.
        :param pulumi.Input[Union['MachineRunCommandScriptSourceArgs', 'MachineRunCommandScriptSourceArgsDict']] source: The source of the run command script.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[int] timeout_in_seconds: The timeout in seconds to execute the run command.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute/v20231003preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20240910preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute/v20241110preview:MachineRunCommand"), pulumi.Alias(type_="azure-native:hybridcompute:MachineRunCommand")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineRunCommand, __self__).__init__(
            'azure-native:hybridcompute/v20250113:MachineRunCommand',
            resource_name,
            __props__,
            opts)
