...
def get_license_profile(license_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20250113:getLicenseProfile', __args__, opts=opts, typ=GetLicenseProfileResult).value
...
def get_license_profile_output(license_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20250113:getLicenseProfile', __args__, opts=opts, typ=GetLicenseProfileResult)
