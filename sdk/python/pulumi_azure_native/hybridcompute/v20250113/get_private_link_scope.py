...
def get_private_link_scope(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20250113:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult).value
...
def get_private_link_scope_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20250113:getPrivateLinkScope', __args__, opts=opts, typ=GetPrivateLinkScopeResult)
