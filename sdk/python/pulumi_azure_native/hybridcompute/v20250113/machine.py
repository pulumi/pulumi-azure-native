...
class MachineArgs:
    def __init__(__self__, *,
                 ...
                 identity_key_store: Optional[pulumi.Input[Union[str, 'IdentityKeyStore']]] = None,
                 ...
                 tpm_ek_certificate: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union[str, 'IdentityKeyStore']] identity_key_store: Specifies the identity key store a machine is using.
        ...
        :param pulumi.Input[str] tpm_ek_certificate: Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
        ...
        if identity_key_store is not None:
        ...
        if tpm_ek_certificate is not None:
    ...
    def identity_key_store(self) -> Optional[pulumi.Input[Union[str, 'IdentityKeyStore']]]:
        """
        Specifies the identity key store a machine is using.
        """
        return pulumi.get(self, "identity_key_store")

    @identity_key_store.setter
    def identity_key_store(self, value: Optional[pulumi.Input[Union[str, 'IdentityKeyStore']]]):
        pulumi.set(self, "identity_key_store", value)
    ...
    def tpm_ek_certificate(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @tpm_ek_certificate.setter
    def tpm_ek_certificate(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "tpm_ek_certificate", value)
...
class Machine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["identity_key_store"] = identity_key_store
            ...
            __props__.__dict__["tpm_ek_certificate"] = tpm_ek_certificate
        ...
        super(Machine, __self__).__init__(
            'azure-native:hybridcompute/v20250113:Machine',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["identity_key_store"] = None
        ...
        __props__.__dict__["tpm_ek_certificate"] = None
        __props__.__dict__["type"] = None
    ...
    @property
    @pulumi.getter(name="identityKeyStore")
    def identity_key_store(self) -> pulumi.Output[Optional[str]]:
        """
        Specifies the identity key store a machine is using.
        """
        return pulumi.get(self, "identity_key_store")
    ...
    @property
    @pulumi.getter(name="tpmEkCertificate")
    def tpm_ek_certificate(self) -> pulumi.Output[Optional[str]]:
        """
        Endorsement Key Certificate of the Trusted Platform Module (TPM) that the client provides to be used during initial resource onboarding.
        """
        return pulumi.get(self, "tpm_ek_certificate")
