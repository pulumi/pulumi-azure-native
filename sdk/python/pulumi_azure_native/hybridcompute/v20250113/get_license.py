...
def get_license(license_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20250113:getLicense', __args__, opts=opts, typ=GetLicenseResult).value
...
def get_license_output(license_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20250113:getLicense', __args__, opts=opts, typ=GetLicenseResult)
