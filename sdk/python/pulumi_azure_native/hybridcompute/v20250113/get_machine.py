...
class GetMachineResult:
    ...
    """
    def __init__(__self__, ad_fqdn=None, agent_configuration=None, agent_upgrade=None, agent_version=None, client_public_key=None, cloud_metadata=None, detected_properties=None, display_name=None, dns_fqdn=None, domain_name=None, error_details=None, extensions=None, firmware_profile=None, hardware_profile=None, id=None, identity=None, identity_key_store=None, kind=None, last_status_change=None, license_profile=None, location=None, location_data=None, machine_fqdn=None, mssql_discovered=None, name=None, network_profile=None, os_edition=None, os_name=None, os_profile=None, os_sku=None, os_type=None, os_version=None, parent_cluster_resource_id=None, private_link_scope_resource_id=None, provisioning_state=None, resources=None, service_statuses=None, status=None, storage_profile=None, system_data=None, tags=None, tpm_ek_certificate=None, type=None, vm_id=None, vm_uuid=None):
        ...
        if identity_key_store and not isinstance(identity_key_store, str):
            raise TypeError("Expected argument 'identity_key_store' to be a str")
        pulumi.set(__self__, "identity_key_store", identity_key_store)
        ...
        if tpm_ek_certificate and not isinstance(tpm_ek_certificate, str):
            raise TypeError("Expected argument 'tpm_ek_certificate' to be a str")
        pulumi.set(__self__, "tpm_ek_certificate", tpm_ek_certificate)
    ...
    @property
    @pulumi.getter(name="identityKeyStore")
    def identity_key_store(self) -> Optional[str]:
        """
        Specifies the identity key store a machine is using.
        """
        return pulumi.get(self, "identity_key_store")
    ...
    @property
    @pulumi.getter(name="tpmEkCertificate")
    def tpm_ek_certificate(self) -> Optional[str]:
        """
        ...
        """
        return pulumi.get(self, "tpm_ek_certificate")
...
class AwaitableGetMachineResult(GetMachineResult):
    ...
    def __await__(self):
        ...
        return GetMachineResult(
            ...
            identity_key_store=self.identity_key_store,
            kind=self.kind,
            ...
            tags=self.tags,
            tpm_ek_certificate=self.tpm_ek_certificate,
            type=self.type,
            vm_id=self.vm_id,
...
def get_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20250113:getMachine', __args__, opts=opts, typ=GetMachineResult).value
    ...
    return AwaitableGetMachineResult(
        ...
        identity_key_store=pulumi.get(__ret__, 'identity_key_store'),
        ...
        tpm_ek_certificate=pulumi.get(__ret__, 'tpm_ek_certificate'),
...
def get_machine_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20250113:getMachine', __args__, opts=opts, typ=GetMachineResult)
    return __ret__.apply(lambda __response__: GetMachineResult(
        ...
        identity_key_store=pulumi.get(__response__, 'identity_key_store'),
        ...
        tpm_ek_certificate=pulumi.get(__response__, 'tpm_ek_certificate'),
