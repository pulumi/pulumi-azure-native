...
def get_machine_run_command(machine_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/v20250113:getMachineRunCommand', __args__, opts=opts, typ=GetMachineRunCommandResult).value
...
def get_machine_run_command_output(machine_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridcompute/v20250113:getMachineRunCommand', __args__, opts=opts, typ=GetMachineRunCommandResult)
