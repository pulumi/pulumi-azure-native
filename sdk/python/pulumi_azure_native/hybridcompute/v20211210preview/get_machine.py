...
def get_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine is deprecated: azure-native:hybridcompute/v20211210preview:Machine is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.""")
    __args__ = dict()
