...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_extension is deprecated: azure-native:hybridcompute/v20211210preview:MachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.""")
    __args__ = dict()
