...
class LicenseProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20231003preview:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20240710:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20240910preview:LicenseProfile"), pulumi.Alias(type_="azure-native:hybridcompute/v20241110preview:LicenseProfile")])
