...
class MachineArgs:
    ...
    def _configure(
        ...
        if 'licenseProfile' in kwargs:
            license_profile = kwargs['licenseProfile']
        ...
        if license_profile is not None:
            _setter("license_profile", license_profile)
...
class Machine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if license_profile is not None and not isinstance(license_profile, LicenseProfileMachineInstanceViewArgs):
                license_profile = license_profile or {}
                def _setter(key, value):
                    license_profile[key] = value
                LicenseProfileMachineInstanceViewArgs._configure(_setter, **license_profile)
