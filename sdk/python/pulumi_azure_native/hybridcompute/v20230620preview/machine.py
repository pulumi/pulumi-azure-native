...
class MachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LicenseProfileMachineInstanceViewArgs'] license_profile: Specifies the ESU related properties for a machine.
...
class Machine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union[str, 'ArcKindEnum']] kind: Indicates which kind of Arc machine placement on-premises, such as HCI, SCVMM or VMware etc.
        :param pulumi.Input[Union['LicenseProfileMachineInstanceViewArgs', 'LicenseProfileMachineInstanceViewArgsDict']] license_profile: Specifies the ESU related properties for a machine.
        :param pulumi.Input[str] location: The geo-location where the resource lives
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute/v20190318preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20190802preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20191212:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20200730preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20200802:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20200815preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210128preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210325preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210422preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210517preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210520:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20210610preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20211210preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20220310:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20220510preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20220811preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20221110:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20221227:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20221227preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20230315preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20231003preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20240710:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20240910preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20241110preview:Machine"), pulumi.Alias(type_="azure-native:hybridcompute/v20250113:Machine"), pulumi.Alias(type_="azure-native:hybridcompute:Machine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Machine, __self__).__init__(
            'azure-native:hybridcompute/v20230620preview:Machine',
            resource_name,
            __props__,
            opts)
