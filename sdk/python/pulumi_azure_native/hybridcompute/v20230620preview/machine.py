...
class MachineArgs:
    ...
    def _configure(
        ...
        if license_profile is None and 'licenseProfile' in kwargs:
...
class Machine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            license_profile = _utilities.configure(license_profile, LicenseProfileMachineInstanceViewArgs, True)
