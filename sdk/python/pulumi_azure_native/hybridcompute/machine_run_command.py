...
class MachineRunCommandArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] async_execution: Optional. If set to true, provisioning will complete as soon as script starts and will not wait for script to complete.
        ...
        :param pulumi.Input[builtins.str] run_as_password: Specifies the user account password on the machine when executing the run command.
        :param pulumi.Input[builtins.str] run_as_user: Specifies the user account on the machine when executing the run command.
        :param pulumi.Input[builtins.str] run_command_name: The name of the run command.
