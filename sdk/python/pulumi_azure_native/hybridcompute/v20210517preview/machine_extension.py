...
warnings.warn("""azure-native:hybridcompute/v20210517preview:MachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
class MachineExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""MachineExtension is deprecated: azure-native:hybridcompute/v20210517preview:MachineExtension is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:MachineExtension to guarantee forwards compatibility.""")
