...
def get_private_link_scope(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_scope is deprecated: azure-native:hybridcompute/v20210517preview:PrivateLinkScope is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20221227preview:PrivateLinkScope to guarantee forwards compatibility.""")
    __args__ = dict()
