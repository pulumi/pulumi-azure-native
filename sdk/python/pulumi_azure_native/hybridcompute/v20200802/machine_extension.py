...
class MachineExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        machine_extension = azure_native.hybridcompute.v20200802.MachineExtension("machineExtension",
