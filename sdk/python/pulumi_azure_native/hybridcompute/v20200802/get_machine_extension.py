...
warnings.warn("""Version 2020-08-02 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_machine_extension(extension_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_extension is deprecated: Version 2020-08-02 will be removed in v2 of the provider.""")
    __args__ = dict()
