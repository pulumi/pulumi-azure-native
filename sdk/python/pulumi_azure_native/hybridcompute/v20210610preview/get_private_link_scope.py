...
def get_private_link_scope(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_scope is deprecated: azure-native:hybridcompute/v20210610preview:PrivateLinkScope is being removed in the next major version of this provider. Upgrade to at least azure-native:hybridcompute/v20230425preview:PrivateLinkScope to guarantee forwards compatibility.""")
    __args__ = dict()
