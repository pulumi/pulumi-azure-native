...
class Machine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Machine is deprecated: azure-native:hybridcompute/v20210610preview:Machine is being removed in the next major version of this provider. Please upgrade to azure-native:hybridcompute/v20220510preview:Machine to guarantee forwards compatibility.""")
