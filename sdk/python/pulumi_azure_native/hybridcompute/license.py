...
class License(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcompute/v20230620preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20231003preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20240331preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20240520preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20240710:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20240731preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20240910preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20241110preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20250113:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20250219preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20250601:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20250821preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20250916preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20260212preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20260604preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20260616preview:License"), pulumi.Alias(type_="azure-native:hybridcompute/v20260715:License")])
