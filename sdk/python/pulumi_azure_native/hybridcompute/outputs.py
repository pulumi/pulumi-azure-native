...
class AgentConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extensions_enabled: _builtins.str,
                 guest_configuration_enabled: _builtins.str,
                 incoming_connections_ports: Sequence[_builtins.str],
                 proxy_bypass: Sequence[_builtins.str],
        ...
        :param _builtins.str extensions_enabled: Specifies whether the extension service is enabled or disabled.
        :param _builtins.str guest_configuration_enabled: Specified whether the guest configuration service is enabled or disabled.
        ...
        :param Sequence[_builtins.str] proxy_bypass: List of service names which should not use the specified proxy server.
...
class AgentUpgradeResponse(dict):
    ...
    def __init__(__self__, *,
                 last_attempt_desired_version: _builtins.str,
                 last_attempt_message: _builtins.str,
                 last_attempt_status: _builtins.str,
                 last_attempt_timestamp: _builtins.str,
                 correlation_id: Optional[_builtins.str] = None,
                 desired_version: Optional[_builtins.str] = None,
        ...
        :param _builtins.str last_attempt_timestamp: Timestamp of last upgrade attempt
        :param _builtins.str correlation_id: The correlation ID passed in from RSM per upgrade.
        :param _builtins.str desired_version: Specifies the version info w.r.t AgentUpgrade for the machine.
        :param _builtins.bool enable_automatic_upgrade: Specifies if RSM should try to upgrade this machine
        """
...
class EsuKeyResponse(dict):
    ...
    def __init__(__self__, *,
                 license_status: Optional[_builtins.int] = None,
...
class LicenseDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 assigned_licenses: _builtins.int,
                 immutable_id: _builtins.str,
        ...
        :param _builtins.int processors: Describes the number of processors.
        :param _builtins.str state: Describes the state of the license.
        :param _builtins.str target: Describes the license target server.
        :param _builtins.str type: Describes the license core type (pCore or vCore).
...
class LicenseProfileMachineInstanceViewEsuPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 assigned_license_immutable_id: _builtins.str,
                 esu_eligibility: _builtins.str,
                 esu_key_state: _builtins.str,
        ...
        :param _builtins.str server_type: The type of the Esu servers.
        :param 'LicenseResponse' assigned_license: The assigned license resource.
        :param _builtins.str license_assignment_state: Describes the license assignment state (Assigned or NotAssigned).
        """
...
class LicenseProfileMachineInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
                 billing_end_date: _builtins.str,
                 ...
                 software_assurance_customer: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str product_type: Indicates the product type of the license.
        :param _builtins.bool software_assurance_customer: Specifies if this machine is licensed as part of a Software Assurance agreement.
        :param _builtins.str subscription_status: Indicates the subscription status of the product.
        """
...
class LicenseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tenant_id: Describes the tenant id.
        """
...
class ServiceStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 startup_type: Optional[_builtins.str] = None,
...
class VolumeLicenseDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 program_year: Optional[_builtins.str] = None):
        """
        :param _builtins.str invoice_id: The invoice id for the volume license.
        :param _builtins.str program_year: Describes the program year the volume license is for.
        """
