...
class AgentConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extensions_enabled: builtins.str,
                 guest_configuration_enabled: builtins.str,
                 incoming_connections_ports: Sequence[builtins.str],
                 proxy_bypass: Sequence[builtins.str],
                 proxy_url: builtins.str):
        """
        Configurable properties that the user can set locally via the azcmagent config command, or remotely via ARM.
        :param builtins.str config_mode: Name of configuration mode to use. Modes are pre-defined configurations of security controls, extension allowlists and guest configuration, maintained by Microsoft.
        ...
        :param builtins.str extensions_enabled: Specifies whether the extension service is enabled or disabled.
        :param builtins.str guest_configuration_enabled: Specified whether the guest configuration service is enabled or disabled.
        ...
        :param Sequence[builtins.str] proxy_bypass: List of service names which should not use the specified proxy server.
    ...
    def config_mode(self) -> builtins.str:
        """
    ...
    def extensions_enabled(self) -> builtins.str:
        """
    ...
    def guest_configuration_enabled(self) -> builtins.str:
        """
    ...
    def proxy_bypass(self) -> Sequence[builtins.str]:
        """
...
class AgentUpgradeResponse(dict):
    ...
    def __init__(__self__, *,
                 last_attempt_desired_version: builtins.str,
                 last_attempt_message: builtins.str,
                 last_attempt_status: builtins.str,
                 last_attempt_timestamp: builtins.str,
                 correlation_id: Optional[builtins.str] = None,
                 desired_version: Optional[builtins.str] = None,
                 enable_automatic_upgrade: Optional[builtins.bool] = None):
        """
        The info w.r.t Agent Upgrade.
        :param builtins.str last_attempt_desired_version: Specifies the version of the last attempt
        :param builtins.str last_attempt_message: Failure message of last upgrade attempt if any.
        :param builtins.str last_attempt_status: Specifies the status of Agent Upgrade.
        :param builtins.str last_attempt_timestamp: Timestamp of last upgrade attempt
        :param builtins.str correlation_id: The correlation ID passed in from RSM per upgrade.
        :param builtins.str desired_version: Specifies the version info w.r.t AgentUpgrade for the machine.
        :param builtins.bool enable_automatic_upgrade: Specifies if RSM should try to upgrade this machine
        """
    ...
    def last_attempt_desired_version(self) -> builtins.str:
        """
    ...
    def last_attempt_message(self) -> builtins.str:
        """
    ...
    def last_attempt_status(self) -> builtins.str:
        """
    ...
    def last_attempt_timestamp(self) -> builtins.str:
        """
    ...
    def desired_version(self) -> Optional[builtins.str]:
        """
...
class CloudMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The metadata of the cloud environment (Azure/GCP/AWS/OCI...).
        :param builtins.str provider: Specifies the cloud provider (Azure/AWS/GCP...).
        """
...
class ConfigurationExtensionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Type of the extension.
        """
...
class EsuKeyResponse(dict):
    ...
    def __init__(__self__, *,
                 license_status: Optional[builtins.int] = None,
                 sku: Optional[builtins.str] = None):
        """
        ESU key
        :param builtins.int license_status: The current status of the license profile key. Represented by the same integer value that is presented on the machine itself when querying the license key status.
        :param builtins.str sku: SKU number.
        """
    ...
    def license_status(self) -> Optional[builtins.int]:
        """
...
class IpAddressResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_address_version: Optional[builtins.str] = None):
        """
        Describes properties of the IP address.
        :param 'SubnetResponse' subnet: The subnet to which this IP address belongs.
        :param builtins.str address: Represents the IP Address.
        :param builtins.str ip_address_version: Represents the Ip Address Version.
        """
    ...
    def ip_address_version(self) -> Optional[builtins.str]:
        """
...
class LicenseDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 assigned_licenses: builtins.int,
                 immutable_id: builtins.str,
        ...
        """
        Describes the properties of a License.
        :param builtins.int assigned_licenses: Describes the number of assigned licenses.
        :param builtins.str immutable_id: Describes the immutable id.
        :param builtins.str edition: Describes the edition of the license. The values are either Standard or Datacenter.
        :param builtins.int processors: Describes the number of processors.
        :param builtins.str state: Describes the state of the license.
        :param builtins.str target: Describes the license target server.
        :param builtins.str type: Describes the license core type (pCore or vCore).
    ...
    def assigned_licenses(self) -> builtins.int:
        """
...
class LicenseProfileMachineInstanceViewEsuPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 assigned_license_immutable_id: builtins.str,
                 esu_eligibility: builtins.str,
                 esu_key_state: builtins.str,
                 esu_keys: Sequence['outputs.EsuKeyResponse'],
                 server_type: builtins.str,
                 assigned_license: Optional['outputs.LicenseResponse'] = None,
                 license_assignment_state: Optional[builtins.str] = None):
        """
        Properties for the Machine ESU profile.
        :param builtins.str assigned_license_immutable_id: The guid id of the license.
        :param builtins.str esu_eligibility: Indicates the eligibility state of Esu.
        :param builtins.str esu_key_state: Indicates whether there is an ESU Key currently active for the machine.
        :param Sequence['EsuKeyResponse'] esu_keys: The list of ESU keys.
        :param builtins.str server_type: The type of the Esu servers.
        :param 'LicenseResponse' assigned_license: The assigned license resource.
        :param builtins.str license_assignment_state: Describes the license assignment state (Assigned or NotAssigned).
        """
    ...
    def license_assignment_state(self) -> Optional[builtins.str]:
        """
...
class LicenseProfileMachineInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
                 billing_end_date: builtins.str,
                 billing_start_date: builtins.str,
                 disenrollment_date: builtins.str,
                 enrollment_date: builtins.str,
                 error: 'outputs.ErrorDetailResponse',
                 license_channel: builtins.str,
                 license_status: builtins.str,
                 ...
                 software_assurance_customer: Optional[builtins.bool] = None,
                 subscription_status: Optional[builtins.str] = None):
        """
        License Profile Instance View in Machine Properties.
        :param builtins.str billing_end_date: The timestamp in UTC when the billing ends.
        :param builtins.str billing_start_date: The timestamp in UTC when the billing starts.
        :param builtins.str disenrollment_date: The timestamp in UTC when the user disenrolled the feature.
        :param builtins.str enrollment_date: The timestamp in UTC when the user enrolls the feature.
        :param 'ErrorDetailResponse' error: The errors that were encountered during the feature enrollment or disenrollment.
        :param builtins.str license_channel: Indicates the license channel.
        :param builtins.str license_status: Indicates the license status of the OS.
        ...
        :param builtins.str product_type: Indicates the product type of the license.
        :param builtins.bool software_assurance_customer: Specifies if this machine is licensed as part of a Software Assurance agreement.
        :param builtins.str subscription_status: Indicates the subscription status of the product.
        """
    ...
    def license_channel(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="licenseStatus")
    def license_status(self) -> builtins.str:
        """
...
class LicenseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str license_type: The type of the license resource.
        :param Mapping[str, builtins.str] tags: Resource tags.
        :param builtins.str tenant_id: Describes the tenant id.
        """
...
class MachineExtensionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enable_automatic_upgrade: Indicates whether the extension should be automatically upgraded by the platform if there is a newer version available.
...
class MachineRunCommandScriptSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the script sources for run command. Use only one of script, scriptUri, commandId.
        :param builtins.str command_id: Specifies the commandId of predefined built-in script.
        :param builtins.str script: Specifies the script content to be executed on the machine.
...
class OSProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the operating system settings for the hybrid machine.
        :param builtins.str computer_name: Specifies the host OS name of the hybrid machine.
...
class OSProfileResponseLinuxConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enable_hotpatching: Captures the hotpatch capability enrollment intent of the customers, which enables customers to patch their Windows machines without requiring a reboot.
...
class PatchSettingsResponseStatus(dict):
    ...
    def __init__(__self__, *,
                 error: 'outputs.ErrorDetailResponse',
                 hotpatch_enablement_status: Optional[builtins.str] = None):
        """
        Status of the hotpatch capability enrollment or disenrollment.
        ...
        :param builtins.str hotpatch_enablement_status: Indicates the current status of the hotpatch being enabled or disabled.
        """
        pulumi.set(__self__, "error", error)
    ...
    def hotpatch_enablement_status(self) -> Optional[builtins.str]:
        """
...
class PrivateEndpointConnectionDataModelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Data Model for a Private Endpoint Connection associated with a Private Link Scope
        :param builtins.str id: The ARM Resource Id of the Private Endpoint.
        :param builtins.str name: The Name of the Private Endpoint.
        :param builtins.str type: Azure resource type
...
class ProductFeatureResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str enrollment_date: The timestamp in UTC when the user enrolls the feature.
        :param 'ErrorDetailResponse' error: The errors that were encountered during the feature enrollment or disenrollment.
        :param builtins.str name: Product feature name.
        :param builtins.str subscription_status: Indicates the current status of the product features.
        """
        pulumi.set(__self__, "billing_end_date", billing_end_date)
        pulumi.set(__self__, "billing_start_date", billing_start_date)
        pulumi.set(__self__, "disenrollment_date", disenrollment_date)
...
class ServiceStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 startup_type: Optional[builtins.str] = None,
    ...
    def startup_type(self) -> Optional[builtins.str]:
        """
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the subnet.
        :param builtins.str address_prefix: Represents address prefix.
        """
...
class VolumeLicenseDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 invoice_id: Optional[builtins.str] = None,
                 program_year: Optional[builtins.str] = None):
        """
        :param builtins.str invoice_id: The invoice id for the volume license.
        :param builtins.str program_year: Describes the program year the volume license is for.
        """
    ...
    def invoice_id(self) -> Optional[builtins.str]:
        """
    ...
    def program_year(self) -> Optional[builtins.str]:
        """
