...
def get_private_link_scoped_resource(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the scoped resource object.
...
def get_private_link_scoped_resource_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
