...
class MultipleActivationKeyArgs:
    def __init__(__self__, *,
                 ...
                 agreement_number: Optional[pulumi.Input[builtins.str]] = None,
                 installed_server_number: Optional[pulumi.Input[builtins.int]] = None,
                 is_eligible: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 multiple_activation_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 os_type: Optional[pulumi.Input[Union[builtins.str, 'OsType']]] = None,
                 support_type: Optional[pulumi.Input[Union[builtins.str, 'SupportType']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a MultipleActivationKey resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] agreement_number: Agreement number under which the key is requested.
        :param pulumi.Input[builtins.int] installed_server_number: Number of activations/servers using the MAK key.
        :param pulumi.Input[builtins.bool] is_eligible: <code> true </code> if user has eligible on-premises Windows physical or virtual machines, and that the requested key will only be used in their organization; <code> false </code> otherwise.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] multiple_activation_key_name: The name of the MAK key.
        :param pulumi.Input[Union[builtins.str, 'OsType']] os_type: Type of OS for which the key is requested.
        :param pulumi.Input[Union[builtins.str, 'SupportType']] support_type: Type of support
    ...
    def agreement_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def agreement_number(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agreement_number", value)

    @property
    @pulumi.getter(name="installedServerNumber")
    def installed_server_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def installed_server_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "installed_server_number", value)

    @property
    @pulumi.getter(name="isEligible")
    def is_eligible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_eligible.setter
    def is_eligible(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def multiple_activation_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def multiple_activation_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def support_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'SupportType']]]:
        """
        Type of support
        """
    ...
    @support_type.setter
    def support_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'SupportType']]]):
...
class MultipleActivationKey(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="agreementNumber")
    def agreement_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Agreement number under which the key is requested.
        """
        return pulumi.get(self, "agreement_number")
    ...
    @property
    @pulumi.getter(name="installedServerNumber")
    def installed_server_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of activations/servers using the MAK key.
        """
        return pulumi.get(self, "installed_server_number")
    ...
    @property
    @pulumi.getter(name="isEligible")
    def is_eligible(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code> true </code> if user has eligible on-premises Windows physical or virtual machines, and that the requested key will only be used in their organization; <code> false </code> otherwise.
        """
        return pulumi.get(self, "is_eligible")
    ...
    def multiple_activation_key(self) -> pulumi.Output[builtins.str]:
        """
        MAK 5x5 key.
        """
    ...
    @property
    @pulumi.getter(name="supportType")
    def support_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of support
        """
        return pulumi.get(self, "support_type")
