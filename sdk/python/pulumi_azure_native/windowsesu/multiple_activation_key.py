...
class MultipleActivationKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:windowsesu/v20190916preview:MultipleActivationKey"), pulumi.Alias(type_="azure-native_windowsesu_v20190916preview:windowsesu:MultipleActivationKey")])
