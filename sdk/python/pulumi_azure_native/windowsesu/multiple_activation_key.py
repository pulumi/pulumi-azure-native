...
class MultipleActivationKeyArgs:
    ...
    def _configure(
        ...
        if agreement_number is None and 'agreementNumber' in kwargs:
            agreement_number = kwargs['agreementNumber']
        if installed_server_number is None and 'installedServerNumber' in kwargs:
            installed_server_number = kwargs['installedServerNumber']
        if is_eligible is None and 'isEligible' in kwargs:
            is_eligible = kwargs['isEligible']
        if multiple_activation_key_name is None and 'multipleActivationKeyName' in kwargs:
