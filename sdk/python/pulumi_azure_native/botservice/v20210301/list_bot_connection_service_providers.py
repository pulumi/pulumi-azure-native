...
def list_bot_connection_service_providers(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListBotConnectionServiceProvidersResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20210301:listBotConnectionServiceProviders', __args__, opts=opts, typ=ListBotConnectionServiceProvidersResult).value
...
def list_bot_connection_service_providers_output(opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ListBotConnectionServiceProvidersResult]:
    ...
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:botservice/v20210301:listBotConnectionServiceProviders', __args__, opts=opts, typ=ListBotConnectionServiceProvidersResult)
