...
class BotConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bot_connection = azure_native.botservice.v20210301.BotConnection("botConnection",
            connection_name="sampleConnection",
            location="West US",
            properties=azure_native.botservice.v20210301.ConnectionSettingPropertiesResponseArgs(
                client_id="sampleclientid",
                client_secret="samplesecret",
                parameters=[
                    azure_native.botservice.v20210301.ConnectionSettingParameterArgs(
                        key="key1",
                        value="value1",
                    ),
                    azure_native.botservice.v20210301.ConnectionSettingParameterArgs(
