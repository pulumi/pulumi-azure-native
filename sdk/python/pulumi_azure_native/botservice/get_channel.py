...
def get_channel(channel_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str channel_name: The name of the Bot resource.
...
def get_channel_output(channel_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:botservice:getChannel', __args__, opts=opts, typ=GetChannelResult)
