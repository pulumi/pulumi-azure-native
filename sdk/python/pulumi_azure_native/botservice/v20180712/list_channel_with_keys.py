...
def list_channel_with_keys(channel_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20180712:listChannelWithKeys', __args__, opts=opts, typ=ListChannelWithKeysResult).value
...
def list_channel_with_keys_output(channel_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:botservice/v20180712:listChannelWithKeys', __args__, opts=opts, typ=ListChannelWithKeysResult)
