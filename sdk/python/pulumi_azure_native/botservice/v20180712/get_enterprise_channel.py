...
def get_enterprise_channel(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20180712:getEnterpriseChannel', __args__, opts=opts, typ=GetEnterpriseChannelResult).value
...
@_utilities.lift_output_func(get_enterprise_channel)
