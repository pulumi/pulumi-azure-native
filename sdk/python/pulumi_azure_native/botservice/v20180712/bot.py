...
class Bot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:botservice:Bot"), pulumi.Alias(type_="azure-native:botservice/v20171201:Bot"), pulumi.Alias(type_="azure-native:botservice/v20200602:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210301:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210501preview:Bot"), pulumi.Alias(type_="azure-native:botservice/v20220615preview:Bot"), pulumi.Alias(type_="azure-native:botservice/v20220915:Bot")])
