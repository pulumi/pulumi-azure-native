...
class BotArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['BotPropertiesArgs']] = None,
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['BotPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['BotPropertiesArgs']]):
...
warnings.warn("""azure-native:botservice/v20200602:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.""", DeprecationWarning)
...
class Bot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Bot is deprecated: azure-native:botservice/v20200602:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:botservice:Bot"), pulumi.Alias(type_="azure-native:botservice/v20171201:Bot"), pulumi.Alias(type_="azure-native:botservice/v20180712:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210301:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210501preview:Bot"), pulumi.Alias(type_="azure-native:botservice/v20220615preview:Bot"), pulumi.Alias(type_="azure-native:botservice/v20220915:Bot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Bot, __self__).__init__(
            'azure-native:botservice/v20200602:Bot',
            resource_name,
            __props__,
            opts)
