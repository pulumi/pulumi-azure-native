...
class BotArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['BotPropertiesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['BotPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['BotPropertiesArgs']]):
...
@pulumi.type_token("azure-native:botservice:Bot")
class Bot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: pulumi.Input[Optional[Union[_builtins.str, 'Kind']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['BotPropertiesArgs', 'BotPropertiesArgsDict']]] = None,
