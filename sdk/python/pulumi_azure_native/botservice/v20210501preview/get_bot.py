...
def get_bot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: azure-native:botservice/v20210501preview:Bot is being removed in the next major version of this provider. Please upgrade to azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.""")
    __args__ = dict()
