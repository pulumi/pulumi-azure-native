...
class ListChannelWithKeysResult:
    ...
    def entity_tag(self) -> Optional[builtins.str]:
        """
...
def list_channel_with_keys(channel_name: Optional[builtins.str] = None,
    ...
    :param builtins.str channel_name: The name of the Channel resource.
...
def list_channel_with_keys_output(channel_name: Optional[pulumi.Input[builtins.str]] = None,
