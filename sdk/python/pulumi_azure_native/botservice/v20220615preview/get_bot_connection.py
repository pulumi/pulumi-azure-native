...
warnings.warn("""azure-native:botservice/v20220615preview:BotConnection is being removed in the next major version of this provider. Please upgrade to azure-native:botservice/v20220915:BotConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bot_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot_connection is deprecated: azure-native:botservice/v20220615preview:BotConnection is being removed in the next major version of this provider. Please upgrade to azure-native:botservice/v20220915:BotConnection to guarantee forwards compatibility.""")
    __args__ = dict()
