...
warnings.warn("""azure-native:botservice/v20220615preview:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: azure-native:botservice/v20220615preview:Bot is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Bot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20220615preview:getBot', __args__, opts=opts, typ=GetBotResult).value
