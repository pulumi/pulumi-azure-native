...
warnings.warn("""azure-native:botservice/v20220615preview:Channel is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Channel to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_channel(channel_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_channel is deprecated: azure-native:botservice/v20220615preview:Channel is being removed in the next major version of this provider. Upgrade to at least azure-native:botservice/v20220915:Channel to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['channelName'] = channel_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20220615preview:getChannel', __args__, opts=opts, typ=GetChannelResult).value
