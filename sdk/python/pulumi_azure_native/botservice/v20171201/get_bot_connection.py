...
def get_bot_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot_connection is deprecated: Version v20171201 will be removed in the next major version of the provider. Upgrade to version v20180712 or later.""")
    __args__ = dict()
