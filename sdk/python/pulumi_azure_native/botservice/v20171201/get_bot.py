...
def get_bot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: Version v20171201 will be removed in the next major version of the provider. Upgrade to version v20180712 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/v20171201:getBot', __args__, opts=opts, typ=GetBotResult).value
