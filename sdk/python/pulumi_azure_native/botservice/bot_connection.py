...
class BotConnectionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ConnectionSettingPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ConnectionSettingPropertiesArgs']]):
...
class BotConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: pulumi.Input[Optional[Union[_builtins.str, 'Kind']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ConnectionSettingPropertiesArgs', 'ConnectionSettingPropertiesArgsDict']]] = None,
