...
def list_bot_connection_with_secrets(connection_name: Optional[builtins.str] = None,
...
def list_bot_connection_with_secrets_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
