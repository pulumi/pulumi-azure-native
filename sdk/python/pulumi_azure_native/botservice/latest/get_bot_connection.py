...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getBotConnection'.""", DeprecationWarning)
...
def get_bot_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getBotConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/latest:getBotConnection', __args__, opts=opts, typ=GetBotConnectionResult).value
