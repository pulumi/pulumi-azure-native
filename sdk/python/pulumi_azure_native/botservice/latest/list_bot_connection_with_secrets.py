...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:listBotConnectionWithSecrets'.""", DeprecationWarning)
...
def list_bot_connection_with_secrets(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/latest:listBotConnectionWithSecrets', __args__, opts=opts, typ=ListBotConnectionWithSecretsResult).value
