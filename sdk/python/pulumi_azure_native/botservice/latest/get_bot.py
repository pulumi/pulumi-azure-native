...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getBot'.""", DeprecationWarning)
...
def get_bot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getBot'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/latest:getBot', __args__, opts=opts, typ=GetBotResult).value
