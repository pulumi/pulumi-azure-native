...
@pulumi.output_type
class InstanceResponseProperties(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        elif key == "diagnosticStorageProperties":
            suggest = "diagnostic_storage_properties"
        elif key == "enableDiagnostics":
            suggest = "enable_diagnostics"
        elif key == "iotHubs":
            suggest = "iot_hubs"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in InstanceResponseProperties. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        InstanceResponseProperties.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 diagnostic_storage_properties: Optional['outputs.DiagnosticStoragePropertiesResponse'] = None,
                 enable_diagnostics: Optional[bool] = None,
                 iot_hubs: Optional[Sequence['outputs.IotHubSettingsResponse']] = None):
        """
        Device Update instance properties.
        :param str account_name: Parent Device Update Account name which Instance belongs to.
        :param str provisioning_state: Provisioning state.
        :param 'DiagnosticStoragePropertiesResponse' diagnostic_storage_properties: Customer-initiated diagnostic log collection storage properties
        :param bool enable_diagnostics: Enables or Disables the diagnostic logs collection
        :param Sequence['IotHubSettingsResponse'] iot_hubs: List of IoT Hubs associated with the account.
        """
