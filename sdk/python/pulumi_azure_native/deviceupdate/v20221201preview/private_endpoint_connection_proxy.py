...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection_proxy = azure_native.deviceupdate.v20221201preview.PrivateEndpointConnectionProxy("privateEndpointConnectionProxy",
            account_name="contoso",
            private_endpoint_connection_proxy_id="peexample01",
            remote_private_endpoint=azure_native.deviceupdate.v20221201preview.RemotePrivateEndpointResponseArgs(
                ...
                location="westus2",
                manual_private_link_service_connections=[azure_native.deviceupdate.v20221201preview.PrivateLinkServiceConnectionArgs(
    ...
    def _internal_init(__self__,
        ...
        super(PrivateEndpointConnectionProxy, __self__).__init__(
            'azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy',
            resource_name,
            __props__,
            opts)
