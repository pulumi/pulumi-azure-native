...
class InstanceArgs:
    ...
    def _configure(
        ...
        if diagnostic_storage_properties is None and 'diagnosticStorageProperties' in kwargs:
            diagnostic_storage_properties = kwargs['diagnosticStorageProperties']
        if enable_diagnostics is None and 'enableDiagnostics' in kwargs:
            enable_diagnostics = kwargs['enableDiagnostics']
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            diagnostic_storage_properties = _utilities.configure(diagnostic_storage_properties, DiagnosticStoragePropertiesArgs, True)
