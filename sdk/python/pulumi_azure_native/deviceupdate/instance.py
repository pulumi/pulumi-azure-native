...
class InstanceArgs:
    ...
    def _configure(
        ...
        if 'diagnosticStorageProperties' in kwargs:
            diagnostic_storage_properties = kwargs['diagnosticStorageProperties']
        if 'enableDiagnostics' in kwargs:
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if diagnostic_storage_properties is not None and not isinstance(diagnostic_storage_properties, DiagnosticStoragePropertiesArgs):
