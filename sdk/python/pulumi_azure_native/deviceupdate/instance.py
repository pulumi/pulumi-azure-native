...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 enable_diagnostics: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_diagnostics: Enables or Disables the diagnostic logs collection
    ...
    def enable_diagnostics(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_diagnostics(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableDiagnostics")
    def enable_diagnostics(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables or Disables the diagnostic logs collection
        """
        return pulumi.get(self, "enable_diagnostics")
