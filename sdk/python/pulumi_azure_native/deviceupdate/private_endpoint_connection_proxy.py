...
class PrivateEndpointConnectionProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] private_endpoint_connection_proxy_id: The ID of the private endpoint connection proxy object.
    ...
    def private_endpoint_connection_proxy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_endpoint_connection_proxy_id(self, value: Optional[pulumi.Input[builtins.str]]):
