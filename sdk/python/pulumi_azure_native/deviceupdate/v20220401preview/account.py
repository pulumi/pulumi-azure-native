...
warnings.warn("""azure-native:deviceupdate/v20220401preview:Account is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:Account to guarantee forwards compatibility.""", DeprecationWarning)
...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Account is deprecated: azure-native:deviceupdate/v20220401preview:Account is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:Account to guarantee forwards compatibility.""")
