...
def get_instance(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_instance is deprecated: azure-native:deviceupdate/v20220401preview:Instance is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:Instance to guarantee forwards compatibility.""")
    __args__ = dict()
