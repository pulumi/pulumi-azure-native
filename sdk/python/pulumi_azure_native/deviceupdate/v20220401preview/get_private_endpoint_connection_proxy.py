...
def get_private_endpoint_connection_proxy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection_proxy is deprecated: azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy to guarantee forwards compatibility.""")
    __args__ = dict()
