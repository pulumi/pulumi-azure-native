...
warnings.warn("""azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnectionProxy is deprecated: azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy is being removed in the next major version of this provider. Please upgrade to azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy to guarantee forwards compatibility.""")
