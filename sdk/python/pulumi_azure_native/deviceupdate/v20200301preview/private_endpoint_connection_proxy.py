...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection_proxy = azure_native.deviceupdate.v20200301preview.PrivateEndpointConnectionProxy("privateEndpointConnectionProxy",
            account_name="contoso",
            private_endpoint_connection_proxy_id="peexample01",
            remote_private_endpoint=azure_native.deviceupdate.v20200301preview.RemotePrivateEndpointResponseArgs(
                ...
                location="westus2",
                manual_private_link_service_connections=[azure_native.deviceupdate.v20200301preview.PrivateLinkServiceConnectionArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceupdate:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20221001:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionProxy, __self__).__init__(
            'azure-native:deviceupdate/v20200301preview:PrivateEndpointConnectionProxy',
            resource_name,
            __props__,
            opts)
