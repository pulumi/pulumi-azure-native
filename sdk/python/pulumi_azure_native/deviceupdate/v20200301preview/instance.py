...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        instance = azure_native.deviceupdate.v20200301preview.Instance("instance",
            account_name="contoso",
            diagnostic_storage_properties=azure_native.deviceupdate.v20200301preview.DiagnosticStoragePropertiesResponseArgs(
