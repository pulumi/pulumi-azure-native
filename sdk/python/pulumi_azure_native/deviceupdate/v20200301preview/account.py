...
warnings.warn("""azure-native:deviceupdate/v20200301preview:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:Account to guarantee forwards compatibility.""", DeprecationWarning)
...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Account is deprecated: azure-native:deviceupdate/v20200301preview:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:Account to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceupdate:Account"), pulumi.Alias(type_="azure-native:deviceupdate/v20220401preview:Account"), pulumi.Alias(type_="azure-native:deviceupdate/v20221001:Account"), pulumi.Alias(type_="azure-native:deviceupdate/v20221201preview:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:deviceupdate/v20200301preview:Account',
            resource_name,
            __props__,
            opts)
