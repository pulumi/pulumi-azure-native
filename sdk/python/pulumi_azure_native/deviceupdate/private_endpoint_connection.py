...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deviceupdate:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:deviceupdate/v20200301preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:deviceupdate/v20200301preview:PrivateEndpointConnection")])
