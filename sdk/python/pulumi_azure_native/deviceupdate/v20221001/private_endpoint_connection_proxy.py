...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceupdate:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20200301preview:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20220401preview:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20221201preview:PrivateEndpointConnectionProxy"), pulumi.Alias(type_="azure-native:deviceupdate/v20230701:PrivateEndpointConnectionProxy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionProxy, __self__).__init__(
            'azure-native:deviceupdate/v20221001:PrivateEndpointConnectionProxy',
            resource_name,
            __props__,
            opts)
