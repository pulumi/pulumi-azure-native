...
warnings.warn("""azure-native:deviceupdate/v20221001:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_endpoint_connection(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection is deprecated: azure-native:deviceupdate/v20221001:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:deviceupdate/v20230701:PrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
