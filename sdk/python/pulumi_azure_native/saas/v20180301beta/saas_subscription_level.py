...
class SaasSubscriptionLevel(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:saas:SaasSubscriptionLevel"), pulumi.Alias(type_="azure-nextgen:saas:SaasSubscriptionLevel")])
