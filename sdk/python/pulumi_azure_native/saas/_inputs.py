...
class SaasCreationPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        properties for creation saas
        :param pulumi.Input[_builtins.bool] auto_renew: Whether the SaaS subscription will auto renew upon term end.
        :param pulumi.Input[_builtins.str] offer_id: The offer id.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] payment_channel_metadata: The metadata about the SaaS subscription such as the AzureSubscriptionId and ResourceUri.
        :param pulumi.Input[Union[_builtins.str, 'PaymentChannelType']] payment_channel_type: The Payment channel for the SaasSubscription.
        :param pulumi.Input[_builtins.str] publisher_id: The publisher id.
        :param pulumi.Input[_builtins.str] publisher_test_environment: The environment in the publisher side for this resource.
        :param pulumi.Input[_builtins.float] quantity: The seat count.
        :param pulumi.Input[_builtins.str] saas_resource_name: The SaaS resource name.
        :param pulumi.Input[_builtins.str] saas_session_id: The saas session id used for dev service migration request.
        :param pulumi.Input[_builtins.str] saas_subscription_id: The saas subscription id used for tenant to subscription level migration request.
        :param pulumi.Input[_builtins.str] sku_id: The plan id.
        :param pulumi.Input[_builtins.str] term_id: The current Term id.
        """
