...
if not MYPY:
    class SaasCreationPropertiesArgsDict(TypedDict):
        ...
        The offer id.
        """
        payment_channel_metadata: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        The metadata about the SaaS subscription such as the AzureSubscriptionId and ResourceUri.
        """
        payment_channel_type: NotRequired[pulumi.Input[Union[builtins.str, 'PaymentChannelType']]]
        """
        ...
        The publisher id.
        """
        publisher_test_environment: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The seat count.
        """
        saas_resource_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The SaaS resource name.
        """
        saas_session_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SaasCreationPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 payment_channel_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 payment_channel_type: Optional[pulumi.Input[Union[builtins.str, 'PaymentChannelType']]] = None,
                 publisher_id: Optional[pulumi.Input[builtins.str]] = None,
                 publisher_test_environment: Optional[pulumi.Input[builtins.str]] = None,
                 quantity: Optional[pulumi.Input[builtins.float]] = None,
                 saas_resource_name: Optional[pulumi.Input[builtins.str]] = None,
                 saas_session_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        properties for creation saas
        :param pulumi.Input[builtins.bool] auto_renew: Whether the SaaS subscription will auto renew upon term end.
        :param pulumi.Input[builtins.str] offer_id: The offer id.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] payment_channel_metadata: The metadata about the SaaS subscription such as the AzureSubscriptionId and ResourceUri.
        :param pulumi.Input[Union[builtins.str, 'PaymentChannelType']] payment_channel_type: The Payment channel for the SaasSubscription.
        :param pulumi.Input[builtins.str] publisher_id: The publisher id.
        :param pulumi.Input[builtins.str] publisher_test_environment: The environment in the publisher side for this resource.
        :param pulumi.Input[builtins.float] quantity: The seat count.
        :param pulumi.Input[builtins.str] saas_resource_name: The SaaS resource name.
        :param pulumi.Input[builtins.str] saas_session_id: The saas session id used for dev service migration request.
        :param pulumi.Input[builtins.str] saas_subscription_id: The saas subscription id used for tenant to subscription level migration request.
        :param pulumi.Input[builtins.str] sku_id: The plan id.
        :param pulumi.Input[builtins.str] term_id: The current Term id.
        """
    ...
    def payment_channel_metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The metadata about the SaaS subscription such as the AzureSubscriptionId and ResourceUri.
        """
    ...
    def payment_channel_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "payment_channel_metadata", value)

    @property
    @pulumi.getter(name="paymentChannelType")
    def payment_channel_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'PaymentChannelType']]]:
        """
        The Payment channel for the SaasSubscription.
        """
    ...
    def payment_channel_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'PaymentChannelType']]]):
    ...
    def publisher_test_environment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The environment in the publisher side for this resource.
        """
    ...
    def publisher_test_environment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def saas_resource_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SaaS resource name.
        """
    ...
    def saas_resource_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "saas_resource_name", value)

    @property
    @pulumi.getter(name="saasSessionId")
    def saas_session_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The saas session id used for dev service migration request.
        """
    ...
    def saas_session_id(self, value: Optional[pulumi.Input[builtins.str]]):
