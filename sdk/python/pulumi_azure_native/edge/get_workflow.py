...
def get_workflow(context_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult).value
...
def get_workflow_output(context_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult)
