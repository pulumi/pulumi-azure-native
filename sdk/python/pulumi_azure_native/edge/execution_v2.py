...
__all__ = ['ExecutionV2Args', 'ExecutionV2']
...
class ExecutionV2Args:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['ExecutionV2PropertiesArgs']] = None):
        """
        The set of arguments for constructing a ExecutionV2 resource.

        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] version_name: The name of the WorkflowVersionV2.
        :param pulumi.Input[_builtins.str] workflow_name: Name of the workflow
        :param pulumi.Input[_builtins.str] execution_name: The name of the ExecutionV2.
        ...
        :param pulumi.Input['ExecutionV2PropertiesArgs'] properties: The resource-specific properties for this resource.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['ExecutionV2PropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ExecutionV2PropertiesArgs']]):
        pulumi.set(self, "properties", value)


@pulumi.type_token("azure-native:edge:ExecutionV2")
class ExecutionV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 properties: Optional[pulumi.Input[Union['ExecutionV2PropertiesArgs', 'ExecutionV2PropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['ExecutionV2PropertiesArgs', 'ExecutionV2PropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] version_name: The name of the WorkflowVersionV2.
        :param pulumi.Input[_builtins.str] workflow_name: Name of the workflow
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ExecutionV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ExecutionV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ExecutionV2Args.__new__(ExecutionV2Args)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250815preview:ExecutionV2")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExecutionV2, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ExecutionV2':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ExecutionV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ExecutionV2PropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
