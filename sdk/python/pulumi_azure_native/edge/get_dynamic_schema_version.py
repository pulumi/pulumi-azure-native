...
def get_dynamic_schema_version(dynamic_schema_name: Optional[_builtins.str] = None,
                               dynamic_schema_version_name: Optional[_builtins.str] = None,
    ...
    return AwaitableGetDynamicSchemaVersionResult(
