...
class ExecutionPropertiesArgsDict(TypedDict):
    ...
    """
    specification: NotRequired[Optional[Any]]
    """
...
class InstancePropertiesArgsDict(TypedDict):
    ...
    State of instance
    """
    reconciliation_policy: NotRequired[pulumi.Input[Optional['ReconciliationPolicyPropertiesArgs']]]
    """
...
class SitePropertiesArgsDict(TypedDict):
    ...
    """
    site_address: NotRequired[pulumi.Input[Optional['SiteAddressPropertiesArgs']]]
    """
...
class StageSpecArgsDict(TypedDict):
    ...
    Stage specification
    """
    task_option: NotRequired[pulumi.Input[Optional['TaskOptionArgs']]]
    """
    Task option for the stage
    """
    tasks: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TaskSpecArgs']]]]]
    """
...
class TaskOptionArgsDict(TypedDict):
    ...
    """
    error_action: NotRequired[pulumi.Input[Optional['ErrorActionArgs']]]
    """
