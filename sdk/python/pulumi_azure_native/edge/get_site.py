...
def get_site(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str site_name: Name of Site resource
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSite', __args__, opts=opts, typ=GetSiteResult)
