...
__all__ = ['WorkflowVersionV2Args', 'WorkflowVersionV2']
...
class WorkflowVersionV2Args:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['WorkflowVersionV2PropertiesArgs']] = None,
        ...
        :param pulumi.Input['WorkflowVersionV2PropertiesArgs'] properties: The resource-specific properties for this resource.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['WorkflowVersionV2PropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['WorkflowVersionV2PropertiesArgs']]):
...
@pulumi.type_token("azure-native:edge:WorkflowVersionV2")
class WorkflowVersionV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 properties: pulumi.Input[Optional[Union['WorkflowVersionV2PropertiesArgs', 'WorkflowVersionV2PropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['WorkflowVersionV2PropertiesArgs', 'WorkflowVersionV2PropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] version_name: The name of the WorkflowVersionV2.
        :param pulumi.Input[_builtins.str] workflow_name: Name of the workflow
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowVersionV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowVersionV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowVersionV2Args.__new__(WorkflowVersionV2Args)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250815preview:WorkflowVersionV2")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkflowVersionV2, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkflowVersionV2':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return WorkflowVersionV2(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WorkflowVersionV2PropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
