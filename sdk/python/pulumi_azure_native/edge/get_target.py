...
def get_target(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str target_name: Name of the target
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['targetName'] = target_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getTarget', __args__, opts=opts, typ=GetTargetResult).value
...
def get_target_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getTarget', __args__, opts=opts, typ=GetTargetResult)
