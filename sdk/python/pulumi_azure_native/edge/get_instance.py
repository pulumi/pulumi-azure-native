...
def get_instance(instance_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getInstance', __args__, opts=opts, typ=GetInstanceResult).value
...
def get_instance_output(instance_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getInstance', __args__, opts=opts, typ=GetInstanceResult)
