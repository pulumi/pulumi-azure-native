...
__all__ = ['DynamicSchemaVersionArgs', 'DynamicSchemaVersion']
...
class DynamicSchemaVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dynamic_schema_version_name: The name of the DynamicSchemaVersion
    ...
    def dynamic_schema_version_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def dynamic_schema_version_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class DynamicSchemaVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dynamic_schema_version_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['SchemaVersionPropertiesArgs', 'SchemaVersionPropertiesArgsDict']]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DynamicSchemaVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DynamicSchemaVersionArgs.__new__(DynamicSchemaVersionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:DynamicSchemaVersion"), pulumi.Alias(type_="azure-native:edge/v20250801:DynamicSchemaVersion"), pulumi.Alias(type_="azure-native:edge/v20250815preview:DynamicSchemaVersion"), pulumi.Alias(type_="azure-native:edge/v20260301:DynamicSchemaVersion")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DynamicSchemaVersion':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DynamicSchemaVersion(resource_name, opts=opts, __props__=__props__)
