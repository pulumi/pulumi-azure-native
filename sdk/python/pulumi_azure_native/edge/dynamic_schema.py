...
__all__ = ['DynamicSchemaArgs', 'DynamicSchema']
...
class DynamicSchemaArgs:
    ...
    def dynamic_schema_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dynamic_schema_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dynamic_schema_name", value)


@pulumi.type_token("azure-native:edge:DynamicSchema")
class DynamicSchema(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DynamicSchemaArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:DynamicSchema"), pulumi.Alias(type_="azure-native:edge/v20250801:DynamicSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DynamicSchema, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DynamicSchema':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DynamicSchema(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DynamicSchemaPropertiesResponse']:
        """
