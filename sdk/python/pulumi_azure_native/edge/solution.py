...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Solution"), pulumi.Alias(type_="azure-native:edge/v20250801:Solution"), pulumi.Alias(type_="azure-native:edge/v20250815preview:Solution"), pulumi.Alias(type_="azure-native:edge/v20260301:Solution")])
