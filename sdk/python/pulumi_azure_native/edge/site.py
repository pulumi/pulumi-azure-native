...
class SiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] site_name: Name of Site resource
        """
...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20240201preview:Site"), pulumi.Alias(type_="azure-native:edge/v20250301preview:Site"), pulumi.Alias(type_="azure-native:edge/v20250601:Site")])
