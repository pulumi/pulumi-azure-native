...
class DynamicConfigurationArgs:
    ...
    def dynamic_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dynamic_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DynamicConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] configuration_name: Name of the Configuration
        :param pulumi.Input[builtins.str] dynamic_configuration_name: Name of the dynamic configuration
        :param pulumi.Input[Union['DynamicConfigurationPropertiesArgs', 'DynamicConfigurationPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DynamicConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DynamicConfigurationArgs.__new__(DynamicConfigurationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:DynamicConfiguration"), pulumi.Alias(type_="azure-native:edge/v20250801:DynamicConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DynamicConfiguration, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DynamicConfiguration':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DynamicConfiguration(resource_name, opts=opts, __props__=__props__)
