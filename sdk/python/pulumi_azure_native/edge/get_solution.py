...
def get_solution(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str solution_name: Name of the solution
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSolution', __args__, opts=opts, typ=GetSolutionResult).value
...
def get_solution_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSolution', __args__, opts=opts, typ=GetSolutionResult)
