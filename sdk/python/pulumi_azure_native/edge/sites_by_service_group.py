...
class SitesByServiceGroupArgs:
    def __init__(__self__, *,
                 servicegroup_name: pulumi.Input[builtins.str],
    ...
    def servicegroup_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the service group
        """
        return pulumi.get(self, "servicegroup_name")

    @servicegroup_name.setter
    def servicegroup_name(self, value: pulumi.Input[builtins.str]):
...
class SitesByServiceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 servicegroup_name: Optional[pulumi.Input[builtins.str]] = None,
                 site_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SitesByServiceGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SitesByServiceGroupArgs.__new__(SitesByServiceGroupArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250301preview:SitesByServiceGroup"), pulumi.Alias(type_="azure-native:edge/v20250601:SitesByServiceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SitesByServiceGroup, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SitesByServiceGroup':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SitesByServiceGroup(resource_name, opts=opts, __props__=__props__)
