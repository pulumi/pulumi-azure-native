...
class GetSchemaResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.SchemaPropertiesResponse':
        """
...
def get_schema(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSchema', __args__, opts=opts, typ=GetSchemaResult).value
...
def get_schema_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSchema', __args__, opts=opts, typ=GetSchemaResult)
