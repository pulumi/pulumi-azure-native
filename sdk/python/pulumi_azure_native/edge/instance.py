...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 solution_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] solution_name: Name of the solution
        :param pulumi.Input[builtins.str] target_name: Name of the target
    ...
    def solution_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def solution_name(self, value: pulumi.Input[builtins.str]):
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Instance"), pulumi.Alias(type_="azure-native:edge/v20250801:Instance")])
