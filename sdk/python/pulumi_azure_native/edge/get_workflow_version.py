...
def get_workflow_version(context_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str version_name: The name of the workflowVersion.
...
def get_workflow_version_output(context_name: Optional[pulumi.Input[_builtins.str]] = None,
