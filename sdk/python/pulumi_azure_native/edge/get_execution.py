...
def get_execution(context_name: Optional[builtins.str] = None,
                  execution_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getExecution', __args__, opts=opts, typ=GetExecutionResult).value
...
def get_execution_output(context_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getExecution', __args__, opts=opts, typ=GetExecutionResult)
    return __ret__.apply(lambda __response__: GetExecutionResult(
