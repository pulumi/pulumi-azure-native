...
class TargetArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['TargetPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['TargetPropertiesArgs']]):
...
class Target(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['TargetPropertiesArgs', 'TargetPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['TargetPropertiesArgs', 'TargetPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        :param pulumi.Input[_builtins.str] target_name: Name of the target
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Target"), pulumi.Alias(type_="azure-native:edge/v20250801:Target"), pulumi.Alias(type_="azure-native:edge/v20250815preview:Target"), pulumi.Alias(type_="azure-native:edge/v20260301:Target")])
