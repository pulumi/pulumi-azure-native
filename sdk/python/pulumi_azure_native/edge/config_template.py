...
class ConfigTemplateArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['ConfigTemplatePropertiesArgs']] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a ConfigTemplate resource.

        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] config_template_name: The name of the ConfigTemplate
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input['ConfigTemplatePropertiesArgs'] properties: The resource-specific properties for this resource.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ConfigTemplatePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ConfigTemplatePropertiesArgs']]):
...
class ConfigTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 config_template_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ConfigTemplatePropertiesArgs', 'ConfigTemplatePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] config_template_name: The name of the ConfigTemplate
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['ConfigTemplatePropertiesArgs', 'ConfigTemplatePropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:ConfigTemplate"), pulumi.Alias(type_="azure-native:edge/v20250801:ConfigTemplate"), pulumi.Alias(type_="azure-native:edge/v20250815preview:ConfigTemplate"), pulumi.Alias(type_="azure-native:edge/v20260301:ConfigTemplate")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ConfigTemplate':
        """
