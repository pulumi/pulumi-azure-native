...
class ConfigTemplateArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['ConfigTemplatePropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ConfigTemplatePropertiesArgs']]):
...
class ConfigTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 config_template_name: Optional[pulumi.Input[_builtins.str]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['ConfigTemplatePropertiesArgs', 'ConfigTemplatePropertiesArgsDict']]] = None,
