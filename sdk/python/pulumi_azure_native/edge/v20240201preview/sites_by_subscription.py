...
class SitesBySubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge:SitesBySubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SitesBySubscription, __self__).__init__(
            'azure-native:edge/v20240201preview:SitesBySubscription',
            resource_name,
            __props__,
            opts)
