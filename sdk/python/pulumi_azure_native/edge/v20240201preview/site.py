...
class SiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] site_name: Name of Site resource
        """
...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge:Site")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'azure-native:edge/v20240201preview:Site',
            resource_name,
            __props__,
            opts)
