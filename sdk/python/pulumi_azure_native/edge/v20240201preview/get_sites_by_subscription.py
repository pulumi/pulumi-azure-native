...
def get_sites_by_subscription(site_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge/v20240201preview:getSitesBySubscription', __args__, opts=opts, typ=GetSitesBySubscriptionResult).value

    return AwaitableGetSitesBySubscriptionResult(
