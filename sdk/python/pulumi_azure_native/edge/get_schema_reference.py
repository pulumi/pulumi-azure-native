...
def get_schema_reference(resource_uri: Optional[_builtins.str] = None,
                         schema_reference_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str schema_reference_name: The name of the SchemaReference
    """
    __args__ = dict()
...
def get_schema_reference_output(resource_uri: pulumi.Input[Optional[_builtins.str]] = None,
                                schema_reference_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
