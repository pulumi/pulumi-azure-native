...
class ContextArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['ContextPropertiesArgs']] = None,
        ...
        :param pulumi.Input['ContextPropertiesArgs'] properties: The resource-specific properties for this resource.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ContextPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ContextPropertiesArgs']]):
...
class Context(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 context_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ContextPropertiesArgs', 'ContextPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] context_name: The name of the Context.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['ContextPropertiesArgs', 'ContextPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Context"), pulumi.Alias(type_="azure-native:edge/v20250801:Context"), pulumi.Alias(type_="azure-native:edge/v20250815preview:Context"), pulumi.Alias(type_="azure-native:edge/v20260301:Context")])
