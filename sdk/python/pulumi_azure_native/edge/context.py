...
class Context(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Context"), pulumi.Alias(type_="azure-native:edge/v20250801:Context")])
