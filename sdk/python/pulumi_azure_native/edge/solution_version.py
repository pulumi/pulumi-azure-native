...
class SolutionVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] solution_version_name: Name of the solution version
        """
    ...
    def solution_version_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def solution_version_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SolutionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['SolutionVersionPropertiesArgs', 'SolutionVersionPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] solution_name: Name of the solution
        :param pulumi.Input[builtins.str] solution_version_name: Name of the solution version
        :param pulumi.Input[builtins.str] target_name: Name of the target
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SolutionVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SolutionVersionArgs.__new__(SolutionVersionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:SolutionVersion"), pulumi.Alias(type_="azure-native:edge/v20250801:SolutionVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SolutionVersion, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SolutionVersion':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SolutionVersion(resource_name, opts=opts, __props__=__props__)
