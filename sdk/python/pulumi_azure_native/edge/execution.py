...
class ExecutionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ExecutionPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ExecutionPropertiesArgs']]):
...
class Execution(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['ExecutionPropertiesArgs', 'ExecutionPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:Execution"), pulumi.Alias(type_="azure-native:edge/v20250801:Execution"), pulumi.Alias(type_="azure-native:edge/v20250815preview:Execution"), pulumi.Alias(type_="azure-native:edge/v20260301:Execution")])
