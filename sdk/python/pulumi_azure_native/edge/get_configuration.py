...
def get_configuration(configuration_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult).value
...
def get_configuration_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult)
