...
class SchemaReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] schema_reference_name: The name of the SchemaReference
        """
    ...
    def schema_reference_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schema_reference_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SchemaReference(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SchemaReferenceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SchemaReferenceArgs.__new__(SchemaReferenceArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:SchemaReference"), pulumi.Alias(type_="azure-native:edge/v20250801:SchemaReference")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SchemaReference, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SchemaReference':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SchemaReference(resource_name, opts=opts, __props__=__props__)
