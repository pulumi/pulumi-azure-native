...
class WorkflowVersionArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['WorkflowVersionPropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['WorkflowVersionPropertiesArgs']]):
...
class WorkflowVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['WorkflowVersionPropertiesArgs', 'WorkflowVersionPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['WorkflowVersionPropertiesArgs', 'WorkflowVersionPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] version_name: The name of the workflowVersion.
        :param pulumi.Input[_builtins.str] workflow_name: Name of the workflow
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20250601:WorkflowVersion"), pulumi.Alias(type_="azure-native:edge/v20250801:WorkflowVersion"), pulumi.Alias(type_="azure-native:edge/v20250815preview:WorkflowVersion"), pulumi.Alias(type_="azure-native:edge/v20260301:WorkflowVersion")])
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.WorkflowVersionPropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
