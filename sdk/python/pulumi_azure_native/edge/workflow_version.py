...
class WorkflowVersionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['WorkflowVersionPropertiesArgs']]:
        """
...
class WorkflowVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['WorkflowVersionPropertiesArgs', 'WorkflowVersionPropertiesArgsDict']]] = None,
