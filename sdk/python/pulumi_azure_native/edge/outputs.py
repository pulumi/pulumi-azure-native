...
class ConfigTemplatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str unique_identifier: A unique identifier for the config template, generated by the system
        """
        pulumi.set(__self__, "description", description)
...
class SolutionTemplatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str provisioning_state: Provisioning state of resource
        :param builtins.str unique_identifier: A unique identifier for the solution template, generated by the system
