...
class ConfigTemplatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str unique_identifier: A unique identifier for the config template, generated by the system
        """
        pulumi.set(__self__, "description", description)
...
class SolutionTemplatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: Provisioning state of resource
        :param _builtins.str unique_identifier: A unique identifier for the solution template, generated by the system
...
class SolutionVersionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_details: '_commontypesv5.outputs.ErrorDetailResponse',
        ...
        :param '_commontypesv5.ErrorDetailResponse' error_details: Error Details if any failure is there
    ...
    def error_details(self) -> '_commontypesv5.outputs.ErrorDetailResponse':
        """
