...
def get_sites_by_subscription(site_name: Optional[builtins.str] = None,
...
def get_sites_by_subscription_output(site_name: Optional[pulumi.Input[builtins.str]] = None,
