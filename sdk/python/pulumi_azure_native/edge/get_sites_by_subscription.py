...
def get_sites_by_subscription(site_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSitesBySubscription', __args__, opts=opts, typ=GetSitesBySubscriptionResult).value
...
def get_sites_by_subscription_output(site_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSitesBySubscription', __args__, opts=opts, typ=GetSitesBySubscriptionResult)
