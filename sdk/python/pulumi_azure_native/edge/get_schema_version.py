...
def get_schema_version(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str schema_version_name: The name of the SchemaVersion
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSchemaVersion', __args__, opts=opts, typ=GetSchemaVersionResult).value
...
def get_schema_version_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSchemaVersion', __args__, opts=opts, typ=GetSchemaVersionResult)
