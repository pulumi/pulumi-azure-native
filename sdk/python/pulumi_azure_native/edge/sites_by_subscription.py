...
class SitesBySubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SitesBySubscriptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edge/v20240201preview:SitesBySubscription"), pulumi.Alias(type_="azure-native:edge/v20250301preview:SitesBySubscription"), pulumi.Alias(type_="azure-native:edge/v20250601:SitesBySubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SitesBySubscription, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SitesBySubscription':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SitesBySubscription(resource_name, opts=opts, __props__=__props__)
