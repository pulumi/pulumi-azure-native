...
def get_sites_by_service_group(servicegroup_name: Optional[builtins.str] = None,
...
def get_sites_by_service_group_output(servicegroup_name: Optional[pulumi.Input[builtins.str]] = None,
