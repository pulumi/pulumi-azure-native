...
def get_sites_by_service_group(servicegroup_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str servicegroup_name: The name of the service group
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edge:getSitesByServiceGroup', __args__, opts=opts, typ=GetSitesByServiceGroupResult).value

    return AwaitableGetSitesByServiceGroupResult(
...
def get_sites_by_service_group_output(servicegroup_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:edge:getSitesByServiceGroup', __args__, opts=opts, typ=GetSitesByServiceGroupResult)
    return __ret__.apply(lambda __response__: GetSitesByServiceGroupResult(
