...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datacatalog:getADCCatalog'.""", DeprecationWarning)
...
def get_adc_catalog(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datacatalog/latest:getADCCatalog', __args__, opts=opts, typ=GetADCCatalogResult).value
