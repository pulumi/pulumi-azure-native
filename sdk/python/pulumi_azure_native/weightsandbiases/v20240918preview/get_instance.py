...
def get_instance(instancename: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:weightsandbiases/v20240918preview:getInstance', __args__, opts=opts, typ=GetInstanceResult).value
...
def get_instance_output(instancename: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:weightsandbiases/v20240918preview:getInstance', __args__, opts=opts, typ=GetInstanceResult)
