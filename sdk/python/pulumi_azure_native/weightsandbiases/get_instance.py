...
def get_instance(instancename: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instancename: Name of the Instance resource
...
def get_instance_output(instancename: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
