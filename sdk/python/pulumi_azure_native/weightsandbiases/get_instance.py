...
def get_instance(instancename: Optional[builtins.str] = None,
    ...
    :param builtins.str instancename: Name of the Instance resource
...
def get_instance_output(instancename: Optional[pulumi.Input[builtins.str]] = None,
