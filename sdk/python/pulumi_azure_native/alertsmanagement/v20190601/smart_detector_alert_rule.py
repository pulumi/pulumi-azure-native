...
class SmartDetectorAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        smart_detector_alert_rule = azure_native.alertsmanagement.v20190601.SmartDetectorAlertRule("smartDetectorAlertRule",
            action_groups=azure_native.alertsmanagement.v20190601.ActionGroupsInformationArgs(
            ...
            detector=azure_native.alertsmanagement.v20190601.DetectorArgs(
                id="VMMemoryLeak",
            ),
            frequency="PT5M",
            ...
            severity="Sev3",
            state="Enabled",
            throttling=azure_native.alertsmanagement.v20190601.ThrottlingInformationArgs(
                duration="PT20M",
            ))
        ...
        ```sh
        $ pulumi import azure-native:alertsmanagement/v20190601:SmartDetectorAlertRule MyAlertRule /subscriptions/b368ca2f-e298-46b7-b0ab-012281956afa/resourceGroups/MyAlertRules/providers/microsoft.alertsManagement/smartDetectorAlertRules/MyAlertRule 
        ```
