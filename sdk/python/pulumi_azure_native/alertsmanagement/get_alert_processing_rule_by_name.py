...
def get_alert_processing_rule_by_name(alert_processing_rule_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_processing_rule_name: The name of the alert processing rule that needs to be fetched.
...
def get_alert_processing_rule_by_name_output(alert_processing_rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:alertsmanagement:getAlertProcessingRuleByName', __args__, opts=opts, typ=GetAlertProcessingRuleByNameResult)
