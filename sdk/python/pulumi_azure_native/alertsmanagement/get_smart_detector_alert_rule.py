...
class GetSmartDetectorAlertRuleResult:
    ...
    @property
    @pulumi.getter
    def scope(self) -> Sequence[builtins.str]:
        """
...
def get_smart_detector_alert_rule(alert_rule_name: Optional[builtins.str] = None,
                                  expand_detector: Optional[builtins.bool] = None,
    ...
    :param builtins.str alert_rule_name: The name of the alert rule.
    :param builtins.bool expand_detector: Indicates if Smart Detector should be expanded.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:alertsmanagement:getSmartDetectorAlertRule', __args__, opts=opts, typ=GetSmartDetectorAlertRuleResult).value
...
def get_smart_detector_alert_rule_output(alert_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                                         expand_detector: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
