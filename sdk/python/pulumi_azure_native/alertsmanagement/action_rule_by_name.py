...
class ActionRuleByNameArgs:
    def __init__(__self__, *,
                 ...
                 action_rule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Resource group name where the resource is created.
        :param pulumi.Input[builtins.str] action_rule_name: The name of action rule that needs to be created/updated
    ...
    def action_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def action_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
