...
warnings.warn("""Version 2019-05-05-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_action_rule_by_name(action_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action_rule_by_name is deprecated: Version 2019-05-05-preview will be removed in v2 of the provider.""")
    __args__ = dict()
