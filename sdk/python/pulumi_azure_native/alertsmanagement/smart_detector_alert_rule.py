...
class SmartDetectorAlertRuleArgs:
    def __init__(__self__, *,
                 ...
                 scope: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 severity: pulumi.Input[Union[builtins.str, 'Severity']],
                 state: pulumi.Input[Union[builtins.str, 'AlertRuleState']],
                 alert_rule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] frequency: The alert rule frequency in ISO8601 format. The time granularity must be in minutes and minimum value is 1 minute, depending on the detector.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope: The alert rule resources scope.
        :param pulumi.Input[Union[builtins.str, 'Severity']] severity: The alert rule severity.
        :param pulumi.Input[Union[builtins.str, 'AlertRuleState']] state: The alert rule state.
        :param pulumi.Input[builtins.str] alert_rule_name: The name of the alert rule.
    ...
    @property
    @pulumi.getter
    def scope(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @scope.setter
    def scope(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    @property
    @pulumi.getter
    def state(self) -> pulumi.Input[Union[builtins.str, 'AlertRuleState']]:
        """
    ...
    @state.setter
    def state(self, value: pulumi.Input[Union[builtins.str, 'AlertRuleState']]):
        pulumi.set(self, "state", value)

    @property
    @pulumi.getter(name="alertRuleName")
    def alert_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:alertsmanagement:SmartDetectorAlertRule")
class SmartDetectorAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'AlertRuleState']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter
    def scope(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The alert rule resources scope.
        """
        return pulumi.get(self, "scope")
