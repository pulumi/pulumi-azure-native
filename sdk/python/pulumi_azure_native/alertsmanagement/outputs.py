...
class ActionGroupResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_modified_by: Last modified by user name.
        :param _builtins.str type: Indicates type of action rule
               Expected value is 'ActionGroup'.
        :param 'ConditionsResponse' conditions: conditions on which alerts will be filtered
        :param _builtins.str description: Description of action rule
        :param 'ScopeResponse' scope: scope on which action rule will apply
        :param _builtins.str status: Indicates if the given action rule is enabled or disabled
        """
...
class ActionGroupsInformationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_email_subject: Optional[_builtins.str] = None,
...
class DetectorParameterDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The detector parameter name.
        :param _builtins.str type: The detector parameter type.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class DetectorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The Smart Detector name.
        :param Sequence['DetectorParameterDefinitionResponse'] parameter_definitions: The Smart Detector parameters definitions.'
        :param Sequence[_builtins.int] supported_cadences: The Smart Detector supported cadences.
        :param Sequence[_builtins.str] supported_resource_types: The Smart Detector supported resource types.
...
class PrometheusRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] annotations: The annotations clause specifies a set of informational labels that can be used to store longer additional information such as alert descriptions or runbook links. The annotation values can be templated.
        :param _builtins.bool enabled: Enable/disable rule.
        :param _builtins.str for_: The amount of time alert must be active before firing.
        :param Mapping[str, _builtins.str] labels: Labels to add or overwrite before storing the result.
        :param _builtins.str record: Recorded metrics name.
        ...
        :param _builtins.int severity: The severity of the alerts fired by the rule. Must be between 0 and 4.
        """
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str time_zone: Scheduling time zone.
        """
...
class SuppressionScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 end_time: Optional[_builtins.str] = None,
                 recurrence_values: Optional[Sequence[_builtins.int]] = None,
        ...
        :param _builtins.str start_date: Start date for suppression
        :param _builtins.str start_time: Start time for suppression
        """
