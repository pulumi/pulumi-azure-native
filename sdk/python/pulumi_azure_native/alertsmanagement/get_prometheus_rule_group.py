...
class GetPrometheusRuleGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, cluster_name=None, description=None, enabled=None, id=None, interval=None, location=None, name=None, rules=None, scopes=None, system_data=None, tags=None, type=None):
...
def get_prometheus_rule_group(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_group_name: The name of the rule group.
    """
    __args__ = dict()
...
def get_prometheus_rule_group_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
