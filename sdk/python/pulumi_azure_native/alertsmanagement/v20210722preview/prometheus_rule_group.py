...
class PrometheusRuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:alertsmanagement:PrometheusRuleGroup"), pulumi.Alias(type_="azure-native:alertsmanagement/v20230301:PrometheusRuleGroup")])
