...
class PrometheusRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['PrometheusRuleGroupActionResponse'] actions: the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
        :param str alert: the name of the alert rule.
        :param Mapping[str, str] annotations: annotations for rule group
        ...
        :param Mapping[str, str] labels: labels for rule group
        :param str record: the name of the recording rule.
        :param 'PrometheusRuleResolveConfigurationResponse' resolve_configuration: defines the configuration for resolving fired alerts.
        :param int severity: the severity of the alerts fired by the rule.
        """
