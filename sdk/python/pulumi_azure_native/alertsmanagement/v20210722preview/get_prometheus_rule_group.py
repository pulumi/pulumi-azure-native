...
def get_prometheus_rule_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:alertsmanagement/v20210722preview:getPrometheusRuleGroup', __args__, opts=opts, typ=GetPrometheusRuleGroupResult)
