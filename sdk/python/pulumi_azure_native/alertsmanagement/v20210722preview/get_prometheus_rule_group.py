...
def get_prometheus_rule_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_prometheus_rule_group is deprecated: azure-native:alertsmanagement/v20210722preview:PrometheusRuleGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:alertsmanagement/v20230301:PrometheusRuleGroup to guarantee forwards compatibility.""")
    __args__ = dict()
