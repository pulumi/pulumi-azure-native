...
class PrometheusRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['PrometheusRuleGroupActionArgs']]] actions: the array of actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
        :param pulumi.Input[str] alert: the name of the alert rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: annotations for rule group
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: labels for rule group
        :param pulumi.Input[str] record: the name of the recording rule.
        :param pulumi.Input['PrometheusRuleResolveConfigurationArgs'] resolve_configuration: defines the configuration for resolving fired alerts.
        :param pulumi.Input[int] severity: the severity of the alerts fired by the rule.
        """
