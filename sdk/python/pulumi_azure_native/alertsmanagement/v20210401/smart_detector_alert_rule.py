...
class SmartDetectorAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if action_groups is not None and not isinstance(action_groups, ActionGroupsInformationArgs):
            ...
            if detector is not None and not isinstance(detector, DetectorArgs):
            ...
            if throttling is not None and not isinstance(throttling, ThrottlingInformationArgs):
