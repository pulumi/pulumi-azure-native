...
class HealthAlert(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:alertsmanagement/v20200804preview:HealthAlert"), pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20200804preview:HealthAlert")])
