...
class PrometheusRuleGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] interval: the interval in which to run the Prometheus rule group represented in ISO 8601 duration format.
...
class PrometheusRuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:alertsmanagement/v20210722preview:PrometheusRuleGroup")])
