...
class PrometheusRuleGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Target Azure Monitor workspaces resource ids. This api-version is currently limited to creating with one scope. This may change in future.
        :param pulumi.Input[builtins.str] cluster_name: Apply rule to data from a specific cluster.
        :param pulumi.Input[builtins.str] description: Rule group description.
        :param pulumi.Input[builtins.bool] enabled: Enable/disable rule group.
        :param pulumi.Input[builtins.str] interval: The interval in which to run the Prometheus rule group represented in ISO 8601 duration format. Should be between 1 and 15 minutes
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] rule_group_name: The name of the rule group.
    ...
    def rule_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rule_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrometheusRuleGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rule_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PrometheusRuleArgs', 'PrometheusRuleArgsDict']]]]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] rule_group_name: The name of the rule group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PrometheusRuleArgs', 'PrometheusRuleArgsDict']]]] rules: Defines the rules in the Prometheus rule group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Target Azure Monitor workspaces resource ids. This api-version is currently limited to creating with one scope. This may change in future.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        """
        ...
