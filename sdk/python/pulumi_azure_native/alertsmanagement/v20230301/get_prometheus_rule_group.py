...
def get_prometheus_rule_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleGroupName'] = rule_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:alertsmanagement/v20230301:getPrometheusRuleGroup', __args__, opts=opts, typ=GetPrometheusRuleGroupResult)
