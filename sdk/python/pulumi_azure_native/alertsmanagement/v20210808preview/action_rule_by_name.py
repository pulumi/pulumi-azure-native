...
class ActionRuleByNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action_rule_name: The name of the action rule that needs to be created/updated
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input['ActionRulePropertiesArgs'] properties: Action rule properties
...
class ActionRuleByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20210808preview:ActionRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement:ActionRuleByName"), pulumi.Alias(type_="azure-nextgen:alertsmanagement:ActionRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName"), pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20181102privatepreview:ActionRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20190505preview:ActionRuleByName"), pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20190505preview:ActionRuleByName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ActionRuleByName, __self__).__init__(
            'azure-native:alertsmanagement/v20210808preview:ActionRuleByName',
            resource_name,
            __props__,
            opts)
