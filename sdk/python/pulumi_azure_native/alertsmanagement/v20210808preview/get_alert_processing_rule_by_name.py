...
warnings.warn("""azure-native:alertsmanagement/v20210808preview:AlertProcessingRuleByName is being removed in the next major version of this provider. Upgrade to at least azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_alert_processing_rule_by_name(alert_processing_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_alert_processing_rule_by_name is deprecated: azure-native:alertsmanagement/v20210808preview:AlertProcessingRuleByName is being removed in the next major version of this provider. Upgrade to at least azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['alertProcessingRuleName'] = alert_processing_rule_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:alertsmanagement/v20210808preview:getAlertProcessingRuleByName', __args__, opts=opts, typ=GetAlertProcessingRuleByNameResult).value
