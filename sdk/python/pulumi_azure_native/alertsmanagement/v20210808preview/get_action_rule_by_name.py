...
def get_action_rule_by_name(action_rule_name: Optional[str] = None,
    ...
    :param str action_rule_name: The name of the action rule that needs to be fetched
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:alertsmanagement/v20210808preview:getActionRuleByName', __args__, opts=opts, typ=GetActionRuleByNameResult).value
