...
class AlertProcessingRuleByNameArgs:
    def __init__(__self__, *,
                 ...
                 alert_processing_rule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alert_processing_rule_name: The name of the alert processing rule that needs to be created/updated.
    ...
    def alert_processing_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_processing_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
