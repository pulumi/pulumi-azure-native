...
def list_issue_resources(filter: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:alertsmanagement:listIssueResources', __args__, opts=opts, typ=ListIssueResourcesResult).value

    return AwaitableListIssueResourcesResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_issue_resources_output(filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:alertsmanagement:listIssueResources', __args__, opts=opts, typ=ListIssueResourcesResult)
