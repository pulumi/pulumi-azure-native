...
__all__ = ['TenantActivityLogAlertArgs', 'TenantActivityLogAlert']

@pulumi.input_type
class TenantActivityLogAlertArgs:
...
class TenantActivityLogAlert(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TenantActivityLogAlertArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        A Tenant Activity Log Alert rule resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TenantActivityLogAlertArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if actions is not None and not isinstance(actions, ActionListArgs):
                actions = actions or {}
                def _setter(key, value):
                    actions[key] = value
                ActionListArgs._configure(_setter, **actions)
            if actions is None and not opts.urn:
                raise TypeError("Missing required property 'actions'")
            __props__.__dict__["actions"] = actions
            __props__.__dict__["alert_rule_name"] = alert_rule_name
            if condition is not None and not isinstance(condition, AlertRuleAllOfConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                AlertRuleAllOfConditionArgs._configure(_setter, **condition)
        ...
        super(TenantActivityLogAlert, __self__).__init__(
            'azure-native:alertsmanagement/v20230401preview:TenantActivityLogAlert',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TenantActivityLogAlert':
        """
        ...
        __props__.__dict__["type"] = None
        return TenantActivityLogAlert(resource_name, opts=opts, __props__=__props__)
