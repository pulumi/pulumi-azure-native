...
class AlertProcessingRuleByNameArgs:
    def __init__(__self__, *,
        ...
        """
        AlertProcessingRuleByNameArgs._configure(
    ...
    def _configure(
        ...
        if 'alertProcessingRuleName' in kwargs:
            alert_processing_rule_name = kwargs['alertProcessingRuleName']

        _setter("resource_group_name", resource_group_name)
        if alert_processing_rule_name is not None:
            _setter("alert_processing_rule_name", alert_processing_rule_name)
...
class AlertProcessingRuleByName(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AlertProcessingRuleByNameArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, AlertProcessingRulePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                AlertProcessingRulePropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:alertsmanagement:AlertProcessingRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20181102privatepreview:AlertProcessingRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20190505preview:AlertProcessingRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20210808:AlertProcessingRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20210808preview:AlertProcessingRuleByName")])
