...
class AlertProcessingRuleByNameArgs:
    ...
    def _configure(
        ...
        if alert_processing_rule_name is None and 'alertProcessingRuleName' in kwargs:
...
class AlertProcessingRuleByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, AlertProcessingRulePropertiesArgs, True)
