...
def get_enterprise_policy(enterprise_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str enterprise_policy_name: The EnterprisePolicy name.
...
def get_enterprise_policy_output(enterprise_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnterprisePolicyResult]:
    """
    Get information about an EnterprisePolicy
