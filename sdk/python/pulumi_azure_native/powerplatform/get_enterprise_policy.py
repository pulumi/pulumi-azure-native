...
def get_enterprise_policy(enterprise_policy_name: Optional[_builtins.str] = None,
...
def get_enterprise_policy_output(enterprise_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
