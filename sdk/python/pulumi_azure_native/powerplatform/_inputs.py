...
if not MYPY:
    class VirtualNetworkPropertiesListArgsDict(TypedDict):
        ...
        """
        next_link: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworkPropertiesListArgs:
    def __init__(__self__, *,
                 next_link: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualNetworkPropertiesArgs']]]] = None):
        """
        A list of private link resources
        :param pulumi.Input[builtins.str] next_link: Next page link if any.
    ...
    def next_link(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Next page link if any.
        """
    ...
    @next_link.setter
    def next_link(self, value: Optional[pulumi.Input[builtins.str]]):
