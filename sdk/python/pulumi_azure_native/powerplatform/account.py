...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: Name of the account.
        :param pulumi.Input[builtins.str] description: The description of the account.
...
class Account(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:powerplatform:Account"
