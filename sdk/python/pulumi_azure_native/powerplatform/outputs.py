...
class EnterprisePolicyIdentityResponse(dict):
    ...
    def _configure(
             ...
             **kwargs):
        if system_assigned_identity_principal_id is None and 'systemAssignedIdentityPrincipalId' in kwargs:
            system_assigned_identity_principal_id = kwargs['systemAssignedIdentityPrincipalId']
        if system_assigned_identity_principal_id is None:
            raise TypeError("Missing 'system_assigned_identity_principal_id' argument")
