...
class EnterprisePolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(encryption, PropertiesEncryptionArgs):
            ...
            if not isinstance(identity, EnterprisePolicyIdentityArgs):
            ...
            if not isinstance(lockbox, PropertiesLockboxArgs):
                lockbox = lockbox or {}
                def _setter(key, value):
                    lockbox[key] = value
                PropertiesLockboxArgs._configure(_setter, **lockbox)
            __props__.__dict__["lockbox"] = lockbox
            if not isinstance(network_injection, PropertiesNetworkInjectionArgs):
