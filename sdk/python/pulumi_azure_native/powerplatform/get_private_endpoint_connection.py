...
class GetPrivateEndpointConnectionResult:
    ...
    def private_endpoint(self) -> Optional['_commontypesv1.outputs.PrivateEndpointResponse']:
        """
    ...
    def private_link_service_connection_state(self) -> '_commontypesv1.outputs.PrivateLinkServiceConnectionStateResponse':
        """
...
def get_private_endpoint_connection(enterprise_policy_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:powerplatform:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(enterprise_policy_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:powerplatform:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult)
