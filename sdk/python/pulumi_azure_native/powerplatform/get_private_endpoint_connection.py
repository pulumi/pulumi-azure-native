...
def get_private_endpoint_connection(enterprise_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str enterprise_policy_name: EnterprisePolicy for the Microsoft Azure subscription.
...
def get_private_endpoint_connection_output(enterprise_policy_name: Optional[pulumi.Input[builtins.str]] = None,
