...
def list_private_store_subscriptions_context(private_store_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:marketplace/v20220901:listPrivateStoreSubscriptionsContext', __args__, opts=opts, typ=ListPrivateStoreSubscriptionsContextResult).value
...
def list_private_store_subscriptions_context_output(private_store_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['privateStoreId'] = private_store_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:marketplace/v20220901:listPrivateStoreSubscriptionsContext', __args__, opts=opts, typ=ListPrivateStoreSubscriptionsContextResult)
