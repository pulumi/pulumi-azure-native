...
def get_private_store_collection_output(collection_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:marketplace/v20220901:getPrivateStoreCollection', __args__, opts=opts, typ=GetPrivateStoreCollectionResult)
