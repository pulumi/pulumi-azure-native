...
def get_private_store_collection_offer(collection_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_store_collection_offer is deprecated: azure-native:marketplace/v20220901:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['collectionId'] = collection_id
    __args__['offerId'] = offer_id
    __args__['privateStoreId'] = private_store_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:marketplace/v20220901:getPrivateStoreCollectionOffer', __args__, opts=opts, typ=GetPrivateStoreCollectionOfferResult).value
