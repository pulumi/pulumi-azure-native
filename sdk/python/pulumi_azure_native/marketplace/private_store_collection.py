...
class PrivateStoreCollectionArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if private_store_id is None and 'privateStoreId' in kwargs:
            private_store_id = kwargs['privateStoreId']
        if private_store_id is None:
            raise TypeError("Missing 'private_store_id' argument")
        if all_subscriptions is None and 'allSubscriptions' in kwargs:
            all_subscriptions = kwargs['allSubscriptions']
        ...
        if subscriptions_list is None and 'subscriptionsList' in kwargs:
            subscriptions_list = kwargs['subscriptionsList']
...
class PrivateStoreCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:marketplace/v20210601:PrivateStoreCollection"), pulumi.Alias(type_="azure-native:marketplace/v20211201:PrivateStoreCollection"), pulumi.Alias(type_="azure-native:marketplace/v20220301:PrivateStoreCollection"), pulumi.Alias(type_="azure-native:marketplace/v20220901:PrivateStoreCollection"), pulumi.Alias(type_="azure-native:marketplace/v20230101:PrivateStoreCollection")])
    ...
    def approve_all_items(self) -> pulumi.Output[bool]:
        """
    ...
    def approve_all_items_modified_at(self) -> pulumi.Output[str]:
        """
