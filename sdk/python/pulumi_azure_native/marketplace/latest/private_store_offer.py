...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:marketplace:PrivateStoreOffer'.""", DeprecationWarning)
...
class PrivateStoreOffer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:marketplace/latest:PrivateStoreOffer"), pulumi.Alias(type_="azure-native:marketplace:PrivateStoreOffer"), pulumi.Alias(type_="azure-nextgen:marketplace:PrivateStoreOffer"), pulumi.Alias(type_="azure-native:marketplace/v20200101:PrivateStoreOffer"), pulumi.Alias(type_="azure-nextgen:marketplace/v20200101:PrivateStoreOffer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateStoreOffer, __self__).__init__(
            'azure-native:marketplace/latest:PrivateStoreOffer',
            resource_name,
            __props__,
            opts)
