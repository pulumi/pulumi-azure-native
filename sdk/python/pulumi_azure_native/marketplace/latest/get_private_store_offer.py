...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:marketplace:getPrivateStoreOffer'.""", DeprecationWarning)
...
def get_private_store_offer(offer_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:marketplace/latest:getPrivateStoreOffer', __args__, opts=opts, typ=GetPrivateStoreOfferResult).value
