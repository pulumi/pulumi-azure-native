...
def get_private_store_collection(collection_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_store_collection is deprecated: azure-native:marketplace/v20211201:PrivateStoreCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['collectionId'] = collection_id
    __args__['privateStoreId'] = private_store_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:marketplace/v20211201:getPrivateStoreCollection', __args__, opts=opts, typ=GetPrivateStoreCollectionResult).value
