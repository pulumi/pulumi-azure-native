...
class PrivateStoreCollectionOffer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 update_suppressed_due_idempotence: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateStoreCollectionOffer is deprecated: azure-native:marketplace/v20211201:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:marketplace:PrivateStoreCollectionOffer"), pulumi.Alias(type_="azure-native:marketplace/v20210601:PrivateStoreCollectionOffer"), pulumi.Alias(type_="azure-native:marketplace/v20220301:PrivateStoreCollectionOffer"), pulumi.Alias(type_="azure-native:marketplace/v20220901:PrivateStoreCollectionOffer"), pulumi.Alias(type_="azure-native:marketplace/v20230101:PrivateStoreCollectionOffer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateStoreCollectionOffer, __self__).__init__(
            'azure-native:marketplace/v20211201:PrivateStoreCollectionOffer',
            resource_name,
            __props__,
            opts)
