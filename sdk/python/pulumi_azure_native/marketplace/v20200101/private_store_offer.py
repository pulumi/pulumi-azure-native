...
class PrivateStoreOffer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:marketplace:PrivateStoreOffer"), pulumi.Alias(type_="azure-nextgen:marketplace:PrivateStoreOffer"), pulumi.Alias(type_="azure-native:marketplace/latest:PrivateStoreOffer"), pulumi.Alias(type_="azure-nextgen:marketplace/latest:PrivateStoreOffer")])
