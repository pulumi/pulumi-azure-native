...
class PrivateStoreCollectionOfferArgs:
    def __init__(__self__, *,
                 ...
                 icon_file_uris: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 offer_id: Optional[pulumi.Input[builtins.str]] = None,
                 plans: Optional[pulumi.Input[Sequence[pulumi.Input['PlanArgs']]]] = None,
                 specific_plan_ids_limitation: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 update_suppressed_due_idempotence: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] e_tag: Identifier for purposes of race condition
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] icon_file_uris: Icon File Uris
        :param pulumi.Input[builtins.str] offer_id: The offer ID to update or delete
        :param pulumi.Input[Sequence[pulumi.Input['PlanArgs']]] plans: Offer plans
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] specific_plan_ids_limitation: Plan ids limitation for this offer
        :param pulumi.Input[builtins.bool] update_suppressed_due_idempotence: Indicating whether the offer was not updated to db (true = not updated). If the allow list is identical to the existed one in db, the offer would not be updated.
        """
    ...
    def icon_file_uris(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Icon File Uris
        """
    ...
    def icon_file_uris(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def specific_plan_ids_limitation(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def specific_plan_ids_limitation(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "specific_plan_ids_limitation", value)

    @property
    @pulumi.getter(name="updateSuppressedDueIdempotence")
    def update_suppressed_due_idempotence(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def update_suppressed_due_idempotence(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PrivateStoreCollectionOffer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="iconFileUris")
    def icon_file_uris(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Icon File Uris
        """
        return pulumi.get(self, "icon_file_uris")
    ...
    def offer_display_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="privateStoreId")
    def private_store_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def publisher_display_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="specificPlanIdsLimitation")
    def specific_plan_ids_limitation(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Plan ids limitation for this offer
        """
        return pulumi.get(self, "specific_plan_ids_limitation")
    ...
    def unique_offer_id(self) -> pulumi.Output[builtins.str]:
        """
        Offers unique id
        """
    ...
    @property
    @pulumi.getter(name="updateSuppressedDueIdempotence")
    def update_suppressed_due_idempotence(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicating whether the offer was not updated to db (true = not updated). If the allow list is identical to the existed one in db, the offer would not be updated.
        """
        return pulumi.get(self, "update_suppressed_due_idempotence")
