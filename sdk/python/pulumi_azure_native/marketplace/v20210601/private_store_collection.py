...
class PrivateStoreCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:marketplace/v20210601:PrivateStoreCollection"), pulumi.Alias(type_="azure-native:marketplace:PrivateStoreCollection"), pulumi.Alias(type_="azure-nextgen:marketplace:PrivateStoreCollection")])
