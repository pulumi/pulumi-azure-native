...
def get_private_store_collection_offer(collection_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_store_collection_offer is deprecated: azure-native:marketplace/v20210601:PrivateStoreCollectionOffer is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollectionOffer to guarantee forwards compatibility.""")
    __args__ = dict()
