...
warnings.warn("""azure-native:marketplace/v20210601:PrivateStoreCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_store_collection(collection_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_store_collection is deprecated: azure-native:marketplace/v20210601:PrivateStoreCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:marketplace/v20230101:PrivateStoreCollection to guarantee forwards compatibility.""")
    __args__ = dict()
