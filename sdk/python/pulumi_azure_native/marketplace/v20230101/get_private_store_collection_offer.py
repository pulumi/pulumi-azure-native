...
def get_private_store_collection_offer(collection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:marketplace/v20230101:getPrivateStoreCollectionOffer', __args__, opts=opts, typ=GetPrivateStoreCollectionOfferResult).value
