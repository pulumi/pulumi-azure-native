...
def get_instance_details(instance_name: Optional[_builtins.str] = None,
...
def get_instance_details_output(instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
