...
class InstanceDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dynamics365fraudprotection/v20210201preview:InstanceDetails"), pulumi.Alias(type_="azure-native_dynamics365fraudprotection_v20210201preview:dynamics365fraudprotection:InstanceDetails")])
