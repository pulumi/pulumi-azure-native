...
class InstanceDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Azure Resource group of which a given DFP instance is part. This name must be at least 1 character in length, and no more than 90.
        :param pulumi.Input['DFPInstanceAdministratorsArgs'] administration: A collection of DFP instance administrators
        :param pulumi.Input[builtins.str] instance_name: The name of the DFP instances. It must be a minimum of 3 characters, and a maximum of 63.
        :param pulumi.Input[builtins.str] location: Location of the DFP resource.
