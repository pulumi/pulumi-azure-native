...
def get_communications_gateway(communications_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:voiceservices/v20230403:getCommunicationsGateway', __args__, opts=opts, typ=GetCommunicationsGatewayResult).value

    return AwaitableGetCommunicationsGatewayResult(
        api_bridge=__ret__.api_bridge,
        auto_generated_domain_name_label=__ret__.auto_generated_domain_name_label,
        ...
        tags=__ret__.tags,
        teams_voicemail_pilot_number=__ret__.teams_voicemail_pilot_number,
        type=__ret__.type)
