...
class CommunicationsGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 teams_voicemail_pilot_number: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CommunicationsGateway is deprecated: azure-native:voiceservices/v20230131:CommunicationsGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:voiceservices/v20230403:CommunicationsGateway to guarantee forwards compatibility.""")
