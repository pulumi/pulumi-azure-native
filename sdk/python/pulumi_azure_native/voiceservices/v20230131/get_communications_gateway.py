...
def get_communications_gateway(communications_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:voiceservices/v20230131:getCommunicationsGateway', __args__, opts=opts, typ=GetCommunicationsGatewayResult).value
...
def get_communications_gateway_output(communications_gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:voiceservices/v20230131:getCommunicationsGateway', __args__, opts=opts, typ=GetCommunicationsGatewayResult)
