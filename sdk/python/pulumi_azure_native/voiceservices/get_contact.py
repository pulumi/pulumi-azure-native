...
def get_contact(communications_gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str contact_name: Unique identifier for this contact
...
def get_contact_output(communications_gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
