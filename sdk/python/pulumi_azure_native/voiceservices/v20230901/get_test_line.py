...
def get_test_line(communications_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:voiceservices/v20230901:getTestLine', __args__, opts=opts, typ=GetTestLineResult).value
...
def get_test_line_output(communications_gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testLineName'] = test_line_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:voiceservices/v20230901:getTestLine', __args__, opts=opts, typ=GetTestLineResult)
