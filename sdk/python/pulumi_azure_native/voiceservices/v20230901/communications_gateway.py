...
class CommunicationsGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_bridge: Optional[pulumi.Input[pulumi.InputType['ApiBridgePropertiesArgs']]] = None,
                 auto_generated_domain_name_label_scope: Optional[pulumi.Input[Union[str, 'AutoGeneratedDomainNameLabelScope']]] = None,
                 ...
                 custom_sip_headers: Optional[pulumi.Input[pulumi.InputType['CustomSipHeadersPropertiesArgs']]] = None,
                 dns_delegations: Optional[pulumi.Input[pulumi.InputType['DnsDelegationsPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ApiBridgePropertiesArgs']] api_bridge: Details of API bridge functionality, if required
        :param pulumi.Input[Union[str, 'AutoGeneratedDomainNameLabelScope']] auto_generated_domain_name_label_scope: The scope at which the auto-generated domain name can be re-used
        :param pulumi.Input[Sequence[pulumi.Input[Union[str, 'TeamsCodecs']]]] codecs: Voice codecs to support
        :param pulumi.Input[str] communications_gateway_name: Unique identifier for this deployment
        :param pulumi.Input[Union[str, 'Connectivity']] connectivity: How to connect back to the operator network, e.g. MAPS
        :param pulumi.Input[pulumi.InputType['CustomSipHeadersPropertiesArgs']] custom_sip_headers: Custom SIP Header to add to any subscriber with a custom_header value, if required.
        :param pulumi.Input[pulumi.InputType['DnsDelegationsPropertiesArgs']] dns_delegations: Details of DNS Domains to delegate to the Communications Gateway.
        :param pulumi.Input[Union[str, 'E911Type']] e911_type: How to handle 911 calls
        :param pulumi.Input[Sequence[pulumi.Input[str]]] emergency_dial_strings: A list of dial strings used for emergency calling.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:voiceservices:CommunicationsGateway"), pulumi.Alias(type_="azure-native:voiceservices/v20221201preview:CommunicationsGateway"), pulumi.Alias(type_="azure-native:voiceservices/v20230131:CommunicationsGateway"), pulumi.Alias(type_="azure-native:voiceservices/v20230403:CommunicationsGateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommunicationsGateway, __self__).__init__(
            'azure-native:voiceservices/v20230901:CommunicationsGateway',
            resource_name,
            __props__,
            opts)
