...
@pulumi.type_token("azure-native:voiceservices:ApiBridgeActivationState")
...
@pulumi.type_token("azure-native:voiceservices:AutoGeneratedDomainNameLabelScope")
...
@pulumi.type_token("azure-native:voiceservices:ManagedServiceIdentityType")
