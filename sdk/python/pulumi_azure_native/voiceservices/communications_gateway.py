...
class CommunicationsGatewayArgs:
    def __init__(__self__, *,
        ...
        """
        CommunicationsGatewayArgs._configure(
            ...
            identity=identity,
            integrated_mcp_enabled=integrated_mcp_enabled,
            location=location,
            on_prem_mcp_enabled=on_prem_mcp_enabled,
            tags=tags,
            teams_voicemail_pilot_number=teams_voicemail_pilot_number,
        )
    @staticmethod
    def _configure(
             ...
             service_locations: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceRegionPropertiesArgs']]]] = None,
             api_bridge: Optional[Any] = None,
             auto_generated_domain_name_label_scope: Optional[pulumi.Input[Union[str, 'AutoGeneratedDomainNameLabelScope']]] = None,
             communications_gateway_name: Optional[pulumi.Input[str]] = None,
             emergency_dial_strings: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        if e911_type is None and 'e911Type' in kwargs:
            e911_type = kwargs['e911Type']
        if e911_type is None:
            raise TypeError("Missing 'e911_type' argument")
        ...
        if service_locations is None and 'serviceLocations' in kwargs:
            service_locations = kwargs['serviceLocations']
        if service_locations is None:
            raise TypeError("Missing 'service_locations' argument")
        if api_bridge is None and 'apiBridge' in kwargs:
            api_bridge = kwargs['apiBridge']
        ...
        if emergency_dial_strings is None and 'emergencyDialStrings' in kwargs:
            emergency_dial_strings = kwargs['emergencyDialStrings']
        if integrated_mcp_enabled is None and 'integratedMcpEnabled' in kwargs:
            integrated_mcp_enabled = kwargs['integratedMcpEnabled']
        if on_prem_mcp_enabled is None and 'onPremMcpEnabled' in kwargs:
            on_prem_mcp_enabled = kwargs['onPremMcpEnabled']
        if teams_voicemail_pilot_number is None and 'teamsVoicemailPilotNumber' in kwargs:
            teams_voicemail_pilot_number = kwargs['teamsVoicemailPilotNumber']
        ...
        if integrated_mcp_enabled is not None:
            _setter("integrated_mcp_enabled", integrated_mcp_enabled)
        ...
        if teams_voicemail_pilot_number is not None:
            _setter("teams_voicemail_pilot_number", teams_voicemail_pilot_number)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CommunicationsGatewayArgs._configure(_setter, **kwargs)
