...
class GetTestLineResult:
    ...
    A TestLine resource
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, phone_number=None, provisioning_state=None, purpose=None, system_data=None, tags=None, type=None):
...
def get_test_line(communications_gateway_name: Optional[_builtins.str] = None,
                  resource_group_name: Optional[_builtins.str] = None,
                  test_line_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str test_line_name: Unique identifier for this test line
    """
    __args__ = dict()
...
def get_test_line_output(communications_gateway_name: pulumi.Input[Optional[_builtins.str]] = None,
                         resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                         test_line_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:voiceservices:getTestLine', __args__, opts=opts, typ=GetTestLineResult)
