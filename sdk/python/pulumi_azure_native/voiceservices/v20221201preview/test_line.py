...
class TestLine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_line = azure_native.voiceservices.v20221201preview.TestLine("testLine",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:voiceservices:TestLine"), pulumi.Alias(type_="azure-native:voiceservices/v20230131:TestLine")])
