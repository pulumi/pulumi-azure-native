...
def get_communications_gateway_output(communications_gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:voiceservices/v20221201preview:getCommunicationsGateway', __args__, opts=opts, typ=GetCommunicationsGatewayResult)
