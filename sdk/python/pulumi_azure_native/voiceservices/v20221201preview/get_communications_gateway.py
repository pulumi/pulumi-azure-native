...
def get_communications_gateway(communications_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_communications_gateway is deprecated: azure-native:voiceservices/v20221201preview:CommunicationsGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:voiceservices/v20230403:CommunicationsGateway to guarantee forwards compatibility.""")
    __args__ = dict()
