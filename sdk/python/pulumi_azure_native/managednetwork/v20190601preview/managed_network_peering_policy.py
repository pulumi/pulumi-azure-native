...
class ManagedNetworkPeeringPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managednetwork/v20190601preview:ManagedNetworkPeeringPolicy"), pulumi.Alias(type_="azure-native:managednetwork:ManagedNetworkPeeringPolicy"), pulumi.Alias(type_="azure-nextgen:managednetwork:ManagedNetworkPeeringPolicy")])
