...
class ManagedNetworkPeeringPolicyArgs:
    ...
    def _configure(
        ...
        if managed_network_name is None:
            raise TypeError("Missing 'managed_network_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if managed_network_peering_policy_name is None and 'managedNetworkPeeringPolicyName' in kwargs:
...
class ManagedNetworkPeeringPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ManagedNetworkPeeringPolicyPropertiesArgs, True)
