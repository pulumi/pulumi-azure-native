...
class ManagedNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_network = azure_native.managednetwork.v20190601preview.ManagedNetwork("managedNetwork",
            location="eastus",
            managed_network_name="myManagedNetwork",
            resource_group_name="myResourceGroup",
            scope=azure_native.managednetwork.v20190601preview.ScopeResponseArgs(
                management_groups=[
                    azure_native.managednetwork.v20190601preview.ResourceIdArgs(
