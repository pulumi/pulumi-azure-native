...
class ManagedNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managednetwork/v20190601preview:ManagedNetwork"), pulumi.Alias(type_="azure-native:managednetwork:ManagedNetwork"), pulumi.Alias(type_="azure-nextgen:managednetwork:ManagedNetwork")])
