...
class ManagedNetworkGroupArgs:
    def __init__(__self__, *,
        ...
        """
        ManagedNetworkGroupArgs._configure(
    ...
    def _configure(
        ...
        if managed_network_group_name is None and 'managedNetworkGroupName' in kwargs:
            managed_network_group_name = kwargs['managedNetworkGroupName']
        ...
        if managed_network_group_name is not None:
            _setter("managed_network_group_name", managed_network_group_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ManagedNetworkGroupArgs._configure(_setter, **kwargs)
