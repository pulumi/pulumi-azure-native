...
class ScopeAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 assigned_managed_network: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] scope: The base resource of the scope assignment to create. The scope can be any REST resource instance. For example, use 'subscriptions/{subscription-id}' for a subscription, 'subscriptions/{subscription-id}/resourceGroups/{resource-group-name}' for a resource group, and 'subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/{resource-provider}/{resource-type}/{resource-name}' for a resource.
        :param pulumi.Input[builtins.str] assigned_managed_network: The managed network ID with scope will be assigned to.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] scope_assignment_name: The name of the scope assignment to create.
        """
    ...
    def assigned_managed_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assigned_managed_network(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scope_assignment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scope_assignment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScopeAssignment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assignedManagedNetwork")
    def assigned_managed_network(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The managed network ID with scope will be assigned to.
        """
        return pulumi.get(self, "assigned_managed_network")
