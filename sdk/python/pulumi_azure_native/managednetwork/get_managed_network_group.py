...
def get_managed_network_group(managed_network_group_name: Optional[_builtins.str] = None,
...
def get_managed_network_group_output(managed_network_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
