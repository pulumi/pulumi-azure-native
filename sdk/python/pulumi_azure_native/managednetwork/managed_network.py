...
class ManagedNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_network_name: The name of the Managed Network.
    ...
    def managed_network_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_network_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:managednetwork:ManagedNetwork")
class ManagedNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] managed_network_name: The name of the Managed Network.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Union['ScopeArgs', 'ScopeArgsDict']] scope: The collection of management groups, subscriptions, virtual networks, and subnets by the Managed Network. This is a read-only property that is reflective of all ScopeAssignments for this Managed Network
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags
        """
        ...
    @overload
