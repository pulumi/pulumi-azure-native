...
def get_managed_network(managed_network_name: Optional[_builtins.str] = None,
...
def get_managed_network_output(managed_network_name: Optional[pulumi.Input[_builtins.str]] = None,
