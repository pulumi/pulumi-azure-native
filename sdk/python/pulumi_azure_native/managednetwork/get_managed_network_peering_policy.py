...
def get_managed_network_peering_policy(managed_network_name: Optional[builtins.str] = None,
                                       managed_network_peering_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_network_peering_policy_name: The name of the Managed Network Peering Policy.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managednetwork:getManagedNetworkPeeringPolicy', __args__, opts=opts, typ=GetManagedNetworkPeeringPolicyResult).value
...
def get_managed_network_peering_policy_output(managed_network_name: Optional[pulumi.Input[builtins.str]] = None,
                                              managed_network_peering_policy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:managednetwork:getManagedNetworkPeeringPolicy', __args__, opts=opts, typ=GetManagedNetworkPeeringPolicyResult)
    return __ret__.apply(lambda __response__: GetManagedNetworkPeeringPolicyResult(
