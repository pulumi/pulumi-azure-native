...
def get_managed_network_peering_policy(managed_network_name: Optional[_builtins.str] = None,
                                       managed_network_peering_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_network_peering_policy_name: The name of the Managed Network Peering Policy.
