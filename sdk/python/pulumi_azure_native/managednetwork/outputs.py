...
class ConnectivityCollectionResponse(dict):
    ...
    def _configure(
             ...
             groups: Optional[Sequence['outputs.ManagedNetworkGroupResponse']] = None,
             peerings: Optional[Sequence['outputs.ManagedNetworkPeeringPolicyResponse']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if groups is None:
            raise TypeError("Missing 'groups' argument")
        if peerings is None:
            raise TypeError("Missing 'peerings' argument")
