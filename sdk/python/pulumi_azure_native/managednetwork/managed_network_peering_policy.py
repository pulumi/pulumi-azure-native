...
class ManagedNetworkPeeringPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_network_peering_policy_name: The name of the Managed Network Peering Policy.
    ...
    def managed_network_peering_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_network_peering_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
