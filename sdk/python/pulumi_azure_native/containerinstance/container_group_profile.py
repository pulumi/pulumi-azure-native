...
class ContainerGroupProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance/v20240501preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:CGProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20250901:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20260601preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20260701:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20260801preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance:CGProfile")])
