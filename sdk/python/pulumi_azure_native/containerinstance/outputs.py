...
class ApplicationGatewayBackendAddressPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        NGroups application gateway backend address pool
        :param builtins.str resource: The application gateway backend address pool ARM resource Id.
        """
...
class ApplicationGatewayResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str resource: The Application Gateway ARM resource Id.
        """
...
class AzureFileVolumeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_account_key_reference: Optional[builtins.str] = None):
        """
        The properties of the Azure File volume. Azure File shares are mounted as volumes.
        :param builtins.str share_name: The name of the Azure File share to be mounted as a volume.
        :param builtins.str storage_account_name: The name of the storage account that contains the Azure File share.
        :param builtins.bool read_only: The flag indicating whether the Azure File shared mounted as a volume is read-only.
        :param builtins.str storage_account_key: The storage account access key used to access the Azure File share.
        :param builtins.str storage_account_key_reference: The reference to the storage account access key used to access the Azure File share.
        """
    ...
    def storage_account_key_reference(self) -> Optional[builtins.str]:
        """
...
class ConfidentialComputePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 cce_policy: Optional[builtins.str] = None):
        """
        The properties for confidential container group
        :param builtins.str cce_policy: The base64 encoded confidential compute enforcement policy
        """
    ...
    def cce_policy(self) -> Optional[builtins.str]:
        """
...
class ConfigMapResponse(dict):
    ...
    def __init__(__self__, *,
                 key_value_pairs: Optional[Mapping[str, builtins.str]] = None):
        """
        The container config map.
        :param Mapping[str, builtins.str] key_value_pairs: The key value pairs dictionary in the config map.
        """
    ...
    def key_value_pairs(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ContainerExecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container execution command, for liveness or readiness probe
        :param Sequence[builtins.str] command: The commands to execute within the container.
        """
...
class ContainerGroupIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the container group.
        :param builtins.str principal_id: The principal id of the container group identity. This property will only be provided for a system assigned identity.
        :param builtins.str tenant_id: The tenant id associated with the container group. This property will only be provided for a system assigned identity.
        :param builtins.str type: The type of identity used for the container group. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the container group.
...
class ContainerGroupProfileReferenceDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container group profile reference.
        :param builtins.str id: The container group profile reference id.This will be an ARM resource id in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerInstance/containerGroupProfiles/{containerGroupProfileName}'.
        :param builtins.int revision: The container group profile reference revision.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class ContainerGroupProfileStubResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int revision: The revision of the CG profile is an optional property. If customer does not to provide a revision then NGroups will pickup the latest revision of CGProfile.
...
class ContainerGroupPropertiesResponseInstanceView(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str state: The state of the container group. Only valid in response.
        """
...
class ContainerGroupSubnetIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container group subnet information.
        :param builtins.str id: Resource ID of virtual network and subnet.
...
class ContainerHttpGetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container Http Get settings, for liveness or readiness probe
        :param builtins.int port: The port number to probe.
        :param Sequence['HttpHeaderResponse'] http_headers: The HTTP headers.
        :param builtins.str path: The path to probe.
        :param builtins.str scheme: The scheme.
        """
...
class ContainerPortResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The port exposed on the container instance.
        :param builtins.int port: The port number exposed within the container group.
        :param builtins.str protocol: The protocol associated with the port.
        """
        pulumi.set(__self__, "port", port)
...
class ContainerProbeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int failure_threshold: The failure threshold.
        :param 'ContainerHttpGetResponse' http_get: The Http Get settings to probe
        :param builtins.int initial_delay_seconds: The initial delay seconds.
        :param builtins.int period_seconds: The period seconds.
        :param builtins.int success_threshold: The success threshold.
        :param builtins.int timeout_seconds: The timeout seconds.
        """
...
class ContainerPropertiesResponseInstanceView(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int restart_count: The number of times that the container instance has been restarted.
        """
...
class ContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The user-provided name of the container instance.
        :param Sequence[builtins.str] command: The commands to execute within the container instance in exec form.
        ...
        :param builtins.str image: The name of the image used to create the container instance.
...
class ContainerStateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container instance state.
        :param builtins.str detail_status: The human-readable status of the container instance state.
        :param builtins.int exit_code: The container instance exit codes correspond to those from the `docker run` command.
        :param builtins.str finish_time: The date-time when the container instance state finished.
        :param builtins.str start_time: The date-time when the container instance state started.
        :param builtins.str state: The state of the container instance.
        """
    ...
    def detail_status(self) -> builtins.str:
        """
...
class DeploymentExtensionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Extension sidecars to be added to the deployment.
        :param builtins.str extension_type: Type of extension to be added.
        :param builtins.str name: Name of the extension.
        :param builtins.str version: Version of the extension being used.
...
class DnsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 search_domains: Optional[builtins.str] = None):
        """
        DNS configuration for the container group.
        :param Sequence[builtins.str] name_servers: The DNS servers for the container group.
        :param builtins.str options: The DNS options for the container group.
        :param builtins.str search_domains: The DNS search domains for hostname lookup in the container group.
        """
    ...
    def search_domains(self) -> Optional[builtins.str]:
        """
...
class ElasticProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maintain_desired_count: Optional[builtins.bool] = None):
        """
        Describes the elastic profile of the NGroup
        ...
        :param builtins.bool maintain_desired_count: Flag that indicates whether desiredCount should be maintained when customer deletes SPECIFIC container groups (CGs) from the NGroups. In this case, new CGs will be created by NGroup to compensate for the specific deleted ones.
        """
    ...
    def maintain_desired_count(self) -> Optional[builtins.bool]:
        """
...
class ElasticProfileResponseGuidNamingPolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str prefix: The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
        """
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The container group encryption properties.
        :param builtins.str key_name: The encryption key name.
        :param builtins.str key_version: The encryption key version.
        :param builtins.str vault_base_url: The keyvault base url.
        :param builtins.str identity: The keyvault managed identity.
        """
...
class EnvironmentVariableResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secure_value_reference: Optional[builtins.str] = None,
        ...
        :param builtins.str secure_value_reference: The reference of the secure environment variable.
    ...
    def secure_value_reference(self) -> Optional[builtins.str]:
        """
...
class EventResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A container group or container instance event.
        :param builtins.int count: The count of the event.
        :param builtins.str first_timestamp: The date-time of the earliest logged event.
        :param builtins.str last_timestamp: The date-time of the latest logged event.
        :param builtins.str message: The event message.
...
class FileShareResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 share_access_tier: Optional[builtins.str] = None,
                 share_access_type: Optional[builtins.str] = None):
        """
        :param builtins.str share_access_tier: Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium. Learn more at: https://learn.microsoft.com/en-us/rest/api/storagerp/file-shares/create?tabs=HTTP#shareaccesstier
        :param builtins.str share_access_type:  Specifies how Container Groups can access the Azure file share i.e. all CG will share same Azure file share or going to have exclusive file share.
        """
    ...
    def share_access_tier(self) -> Optional[builtins.str]:
        """
    ...
    def share_access_type(self) -> Optional[builtins.str]:
        """
...
class GitRepoVolumeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Represents a volume that is populated with the contents of a git repository
        :param builtins.str repository: Repository URL
        :param builtins.str directory: Target directory name. Must not contain or start with '..'.  If '.' is supplied, the volume directory will be the git repository.  Otherwise, if specified, the volume will contain the git repository in the subdirectory with the given name.
        :param builtins.str revision: Commit hash for the specified revision.
        """
...
class GpuResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The GPU resource.
        :param builtins.int count: The count of the GPU resource.
        :param builtins.str sku: The SKU of the GPU resource.
        """
        pulumi.set(__self__, "count", count)
...
class ImageRegistryCredentialResponse(dict):
    ...
    def __init__(__self__, *,
                 server: builtins.str,
                 identity: Optional[builtins.str] = None,
                 identity_url: Optional[builtins.str] = None,
                 password: Optional[builtins.str] = None,
                 password_reference: Optional[builtins.str] = None,
                 username: Optional[builtins.str] = None):
        """
        Image registry credential.
        :param builtins.str server: The Docker image registry server without a protocol such as "http" and "https".
        :param builtins.str identity: The identity for the private registry.
        :param builtins.str identity_url: The identity URL for the private registry.
        :param builtins.str password: The password for the private registry.
        :param builtins.str password_reference: The reference for the private registry password.
        :param builtins.str username: The username for the private registry.
        """
    ...
    def identity_url(self) -> Optional[builtins.str]:
        """
    ...
    def password_reference(self) -> Optional[builtins.str]:
        """
...
class InitContainerDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name for the init container.
        :param Sequence[builtins.str] command: The command to execute within the init container in exec form.
        :param Sequence['EnvironmentVariableResponse'] environment_variables: The environment variables to set in the init container.
        :param builtins.str image: The image of the init container.
        :param 'SecurityContextDefinitionResponse' security_context: The container security properties.
...
class InitContainerPropertiesDefinitionResponseInstanceView(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int restart_count: The number of times that the init container has been restarted.
        """
        pulumi.set(__self__, "current_state", current_state)
        pulumi.set(__self__, "events", events)
        pulumi.set(__self__, "previous_state", previous_state)
...
class IpAddressResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dns_name_label: Optional[builtins.str] = None,
                 ip: Optional[builtins.str] = None):
        """
        IP address for the container group.
        :param builtins.str fqdn: The FQDN for the IP.
        :param Sequence['PortResponse'] ports: The list of ports exposed on the container group.
        :param builtins.str type: Specifies if the IP is exposed to the public internet or private VNET.
        :param builtins.str auto_generated_domain_name_label_scope: The value representing the security enum. The 'Unsecure' value is the default value if not selected and means the object's domain name label is not secured against subdomain takeover. The 'TenantReuse' value is the default value if selected and means the object's domain name label can be reused within the same tenant. The 'SubscriptionReuse' value means the object's domain name label can be reused within the same subscription. The 'ResourceGroupReuse' value means the object's domain name label can be reused within the same resource group. The 'NoReuse' value means the object's domain name label cannot be reused within the same resource group, subscription, or tenant.
        :param builtins.str dns_name_label: The Dns name label for the IP.
        :param builtins.str ip: The IP exposed to the public internet.
        """
    ...
    def dns_name_label(self) -> Optional[builtins.str]:
        """
...
class LoadBalancerBackendAddressPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        NGroups load balancer backend address pool
        :param builtins.str resource: The Load Balancer backend address pool ARM resource Id.
        """
        if resource is not None:
            pulumi.set(__self__, "resource", resource)
...
class LogAnalyticsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container group log analytics information.
        :param builtins.str workspace_id: The workspace id for log analytics
        :param builtins.str workspace_key: The workspace key for log analytics
        :param builtins.str log_type: The log type to be used.
        :param Mapping[str, builtins.str] metadata: Metadata for log analytics.
        :param builtins.str workspace_resource_id: The workspace resource id for log analytics
        """
...
class NGroupIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for the NGroup.
        :param builtins.str principal_id: The principal id of the NGroup identity. This property will only be provided for a system assigned identity.
        :param builtins.str tenant_id: The tenant id associated with the NGroup. This property will only be provided for a system assigned identity.
        :param builtins.str type: The type of identity used for the NGroup. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the NGroup.
...
class PlacementProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 fault_domain_count: Optional[builtins.int] = None):
        """
        Provides options w.r.t allocation and management w.r.t certain placement policies. These utilize capabilities provided by the underlying Azure infrastructure. They are typically used for high availability scenarios. E.g., distributing CGs across fault domains.
        :param builtins.int fault_domain_count: The number of fault domains to be used to spread CGs in the NGroups resource. This can only be specified during NGroup creation and is immutable after that.
        """
    ...
    def fault_domain_count(self) -> Optional[builtins.int]:
        """
...
class ResourceLimitsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 memory_in_gb: Optional[builtins.float] = None):
        """
        The resource limits.
        :param builtins.float cpu: The CPU limit of this container instance.
        :param 'GpuResourceResponse' gpu: The GPU limit of this container instance.
        :param builtins.float memory_in_gb: The memory limit in GB of this container instance.
        """
        if cpu is not None:
    ...
    def memory_in_gb(self) -> Optional[builtins.float]:
        """
...
class ResourceRequestsResponse(dict):
    ...
    def __init__(__self__, *,
                 cpu: builtins.float,
                 memory_in_gb: builtins.float,
                 gpu: Optional['outputs.GpuResourceResponse'] = None):
        """
        The resource requests.
        :param builtins.float cpu: The CPU request of this container instance.
        :param builtins.float memory_in_gb: The memory request in GB of this container instance.
    ...
    @property
    @pulumi.getter(name="memoryInGB")
    def memory_in_gb(self) -> builtins.float:
        """
...
class SecurityContextCapabilitiesDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The capabilities to add or drop from a container.
        :param Sequence[builtins.str] add: The capabilities to add to the container.
        :param Sequence[builtins.str] drop: The capabilities to drop from the container.
        """
        if add is not None:
...
class SecurityContextDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 seccomp_profile: Optional[builtins.str] = None):
        """
        The security context for the container.
        :param builtins.bool allow_privilege_escalation: A boolean value indicating whether the init process can elevate its privileges
        :param 'SecurityContextCapabilitiesDefinitionResponse' capabilities: The capabilities to add or drop from a container.
        :param builtins.bool privileged: The flag to determine if the container permissions is elevated to Privileged.
        :param builtins.int run_as_group: Sets the User GID for the container.
        :param builtins.int run_as_user: Sets the User UID for the container.
        :param builtins.str seccomp_profile: a base64 encoded string containing the contents of the JSON in the seccomp profile
        """
    ...
    def seccomp_profile(self) -> Optional[builtins.str]:
        """
...
class StandbyPoolProfileDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 fail_container_group_create_on_reuse_failure: Optional[builtins.bool] = None,
                 id: Optional[builtins.str] = None):
        """
        The standby pool profile reference.
        :param builtins.bool fail_container_group_create_on_reuse_failure: The flag to determine whether ACI should fail the create request if the container group can not be obtained from standby pool.
        :param builtins.str id: The standby pool profile reference id.This will be an ARM resource id in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StandbyPool/standbyContainerGroupPools/{standbyPoolName}'.
        """
    ...
    def fail_container_group_create_on_reuse_failure(self) -> Optional[builtins.bool]:
        """
...
class UpdateProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 update_mode: Optional[builtins.str] = None):
        """
        Used by the customer to specify the way to update the Container Groups in NGroup.
    ...
    def update_mode(self) -> Optional[builtins.str]:
...
class UpdateProfileResponseRollingUpdateProfile(dict):
    ...
    def __init__(__self__, *,
                 in_place_update: Optional[builtins.bool] = None,
                 max_batch_percent: Optional[builtins.int] = None,
                 max_unhealthy_percent: Optional[builtins.int] = None,
                 pause_time_between_batches: Optional[builtins.str] = None):
        """
        This profile allows the customers to customize the rolling update.
        :param builtins.bool in_place_update: Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
        :param builtins.int max_batch_percent: Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
        :param builtins.int max_unhealthy_percent: Maximum percentage of the updated Container Groups which can be in unhealthy state after each batch is updated.
        :param builtins.str pause_time_between_batches: The wait time between batches after completing the one batch of the rolling update and starting the next batch. The time duration should be specified in ISO 8601 format for duration.
        """
    ...
    def in_place_update(self) -> Optional[builtins.bool]:
        """
    ...
    def max_batch_percent(self) -> Optional[builtins.int]:
        """
    ...
    def max_unhealthy_percent(self) -> Optional[builtins.int]:
        """
...
class VolumeMountResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of the volume mount.
        :param builtins.str mount_path: The path within the container where the volume should be mounted. Must not contain colon (:).
        :param builtins.str name: The name of the volume mount.
        :param builtins.bool read_only: The flag indicating whether the volume mount is read-only.
        """
...
class VolumeResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret: Optional[Mapping[str, builtins.str]] = None,
                 secret_reference: Optional[Mapping[str, builtins.str]] = None):
        """
        The properties of the volume.
        :param builtins.str name: The name of the volume.
        :param 'AzureFileVolumeResponse' azure_file: The Azure File volume.
        ...
        :param Mapping[str, builtins.str] secret: The secret volume.
        :param Mapping[str, builtins.str] secret_reference: The secret reference volume.
        """
        pulumi.set(__self__, "name", name)
        if azure_file is not None:
            pulumi.set(__self__, "azure_file", azure_file)
    ...
    def secret_reference(self) -> Optional[Mapping[str, builtins.str]]:
        """
