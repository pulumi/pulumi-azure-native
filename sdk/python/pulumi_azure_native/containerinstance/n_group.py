...
class NGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance/v20240901preview:NGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:NGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20250901:NGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20260601preview:NGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20260701:NGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20260801preview:NGroup")])
