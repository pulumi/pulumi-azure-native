...
class ContainerGroupArgs:
    ...
    def _configure(
        ...
        if confidential_compute_properties is None and 'confidentialComputeProperties' in kwargs:
...
class ContainerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            confidential_compute_properties = _utilities.configure(confidential_compute_properties, ConfidentialComputePropertiesArgs, True)
