...
class ApplicationGatewayArgsDict(TypedDict):
    ...
    """
    backend_address_pools: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ApplicationGatewayBackendAddressPoolArgs']]]]]
    """
...
class ContainerGroupDiagnosticsArgsDict(TypedDict):
    ...
    """
    log_analytics: NotRequired[pulumi.Input[Optional['LogAnalyticsArgs']]]
    """
...
class ContainerGroupProfileStubArgsDict(TypedDict):
    ...
    """
    container_group_properties: NotRequired[pulumi.Input[Optional['NGroupContainerGroupPropertiesArgs']]]
    """
    ...
    """
    resource: NotRequired[pulumi.Input[Optional['ApiEntityReferenceArgs']]]
    """
...
class ContainerProbeArgsDict(TypedDict):
    ...
    """
    exec_: NotRequired[pulumi.Input[Optional['ContainerExecArgs']]]
    """
    ...
    """
    http_get: NotRequired[pulumi.Input[Optional['ContainerHttpGetArgs']]]
    """
...
class ContainerArgsDict(TypedDict):
    ...
    """
    config_map: NotRequired[pulumi.Input[Optional['ConfigMapArgs']]]
    """
    The config map.
    """
    ...
    """
    liveness_probe: NotRequired[pulumi.Input[Optional['ContainerProbeArgs']]]
    """
    The liveness probe.
    """
    ...
    """
    readiness_probe: NotRequired[pulumi.Input[Optional['ContainerProbeArgs']]]
    """
    The readiness probe.
    """
    ...
    """
    security_context: NotRequired[pulumi.Input[Optional['SecurityContextDefinitionArgs']]]
    """
...
class ElasticProfileContainerGroupNamingPolicyArgsDict(TypedDict):
    ...
    """
    guid_naming_policy: NotRequired[pulumi.Input[Optional['ElasticProfileGuidNamingPolicyArgs']]]
...
class ElasticProfileArgsDict(TypedDict):
    ...
    """
    container_group_naming_policy: NotRequired[pulumi.Input[Optional['ElasticProfileContainerGroupNamingPolicyArgs']]]
    """
    Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
    """
...
class FileShareArgsDict(TypedDict):
    ...
    """
    name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    properties: NotRequired[pulumi.Input[Optional['FileSharePropertiesArgs']]]
...
class LoadBalancerArgsDict(TypedDict):
    ...
    """
    backend_address_pools: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerBackendAddressPoolArgs']]]]]
    """
...
class NGroupCGPropertyContainerArgsDict(TypedDict):
    ...
    container name
    """
    properties: NotRequired[pulumi.Input[Optional['NGroupCGPropertyContainerPropertiesArgs']]]
    """
    container properties
    """
...
class NGroupCGPropertyVolumeArgsDict(TypedDict):
    ...
    """
    azure_file: NotRequired[pulumi.Input[Optional['AzureFileVolumeArgs']]]
    """
...
class NGroupContainerGroupPropertiesArgsDict(TypedDict):
    ...
    Container Group properties which can be set while creating or updating the NGroups.
    """
    containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NGroupCGPropertyContainerArgs']]]]]
    """
    ...
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NGroupCGPropertyVolumeArgs']]]]]
    """
    Contains information about the volumes that can be mounted by Containers in the Container Groups.
    """
...
class NetworkProfileArgsDict(TypedDict):
    ...
    """
    application_gateway: NotRequired[pulumi.Input[Optional['ApplicationGatewayArgs']]]
    """
    Application Gateway the CG profile will use to interact with CGs in a backend pool
    """
    load_balancer: NotRequired[pulumi.Input[Optional['LoadBalancerArgs']]]
    """
    LoadBalancer the CG profile will use to interact with CGs in a backend pool
    """
...
class ResourceLimitsArgsDict(TypedDict):
    ...
    """
    gpu: NotRequired[pulumi.Input[Optional['GpuResourceArgs']]]
    """
...
class SecurityContextDefinitionArgsDict(TypedDict):
    ...
    """
    capabilities: NotRequired[pulumi.Input[Optional['SecurityContextCapabilitiesDefinitionArgs']]]
    """
    The capabilities to add or drop from a container.
    """
...
class StorageProfileArgsDict(TypedDict):
    ...
    Storage profile for storage related settings of a container group profile.
    """
    file_shares: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['FileShareArgs']]]]]
...
class UpdateProfileArgsDict(TypedDict):
    ...
    """
    rolling_update_profile: NotRequired[pulumi.Input[Optional['UpdateProfileRollingUpdateProfileArgs']]]
    """
    This profile allows the customers to customize the rolling update.
    """
...
class VolumeArgsDict(TypedDict):
    ...
    The Azure File volume.
    """
    empty_dir: NotRequired[Optional[Any]]
    """
    The empty directory volume.
    """
    git_repo: NotRequired[pulumi.Input[Optional['GitRepoVolumeArgs']]]
    """
    The git repo volume.
    """
