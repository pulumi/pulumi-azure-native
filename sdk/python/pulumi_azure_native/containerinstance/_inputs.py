...
class ElasticProfileContainerGroupNamingPolicyArgsDict(TypedDict):
    ...
    """
    guid_naming_policy: NotRequired[pulumi.Input[Optional['ElasticProfileGuidNamingPolicyArgsDict']]]

@pulumi.input_type
class ElasticProfileContainerGroupNamingPolicyArgs:
    def __init__(__self__, *,
                 guid_naming_policy: pulumi.Input[Optional['ElasticProfileGuidNamingPolicyArgs']] = None):
        """
        Container Groups are named on a generic guid based naming scheme/policy. Customer can modify naming policy to add prefix to CG names during scale out operation.
        """
    ...
    def guid_naming_policy(self) -> pulumi.Input[Optional['ElasticProfileGuidNamingPolicyArgs']]:
        return pulumi.get(self, "guid_naming_policy")

    @guid_naming_policy.setter
    def guid_naming_policy(self, value: pulumi.Input[Optional['ElasticProfileGuidNamingPolicyArgs']]):
