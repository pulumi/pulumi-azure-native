...
class CGProfileArgs:
    def __init__(__self__, *,
                 ...
                 registered_revisions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]] = None,
                 ...
                 use_krypton: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.float]]] registered_revisions: Registered revisions are calculated at request time based off the records in the table logs.
        :param pulumi.Input[Union[_builtins.str, 'ContainerGroupRestartPolicy']] restart_policy: Restart policy for all containers within the container group. 
               ...
               - `Never` Never restart
        :param pulumi.Input[_builtins.float] revision: Container group profile current revision number
    ...
    def registered_revisions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]:
        """
    ...
    def registered_revisions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]):
...
class CGProfile(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="registeredRevisions")
    def registered_revisions(self) -> pulumi.Output[Optional[Sequence[_builtins.float]]]:
        """
        Registered revisions are calculated at request time based off the records in the table logs.
        """
        return pulumi.get(self, "registered_revisions")
