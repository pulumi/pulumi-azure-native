...
class ContainerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_group = azure_native.containerinstance.ContainerGroup("containerGroup",
            ...
            encryption_properties=azure_native.containerinstance.EncryptionPropertiesResponseArgs(
            ...
            identity=azure_native.containerinstance.ContainerGroupIdentityArgs(
                type=azure_native.containerinstance.ResourceIdentityType.USER_ASSIGNED,
        ...
        container_group = azure_native.containerinstance.ContainerGroup("containerGroup",
            ...
            dns_config=azure_native.containerinstance.DnsConfigurationResponseArgs(
