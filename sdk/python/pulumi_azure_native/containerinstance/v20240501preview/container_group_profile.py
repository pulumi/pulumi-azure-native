...
class ContainerGroupProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance:ContainerGroupProfile")])
