...
class ContainerGroupProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] container_group_profile_name: The name of the container group profile.
...
class ContainerGroupProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:CGProfile"), pulumi.Alias(type_="azure-native:containerinstance/v20241101preview:ContainerGroupProfile"), pulumi.Alias(type_="azure-native:containerinstance:CGProfile"), pulumi.Alias(type_="azure-native:containerinstance:ContainerGroupProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerGroupProfile, __self__).__init__(
            'azure-native:containerinstance/v20240501preview:ContainerGroupProfile',
            resource_name,
            __props__,
            opts)
