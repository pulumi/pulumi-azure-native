...
class ContainerGroupResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str state: The current state of the container group. This is only valid for the response.
        ...
        :param str restart_policy: Restart policy for all containers within the container group. Currently the only available option is `always`.
