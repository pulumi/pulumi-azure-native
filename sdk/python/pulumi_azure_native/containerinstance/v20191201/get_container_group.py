...
azure-native:containerinstance/v20191201:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20210301:ContainerGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: Version 2019-12-01 will be removed in v2 of the provider.
azure-native:containerinstance/v20191201:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20210301:ContainerGroup to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20191201:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
