...
class GetContainerGroupResult:
    ...
    def is_created_from_standby_pool(self) -> builtins.bool:
        """
...
def get_container_group(container_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str container_group_name: The name of the container group.
...
def get_container_group_output(container_group_name: Optional[pulumi.Input[builtins.str]] = None,
