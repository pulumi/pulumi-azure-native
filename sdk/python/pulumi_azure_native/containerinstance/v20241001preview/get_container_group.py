...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20241001preview:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
...
def get_container_group_output(container_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerinstance/v20241001preview:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult)
