...
def get_container_group_profile(container_group_profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str container_group_profile_name: The name of the container group profile.
...
def get_container_group_profile_output(container_group_profile_name: Optional[pulumi.Input[builtins.str]] = None,
