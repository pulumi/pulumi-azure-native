...
warnings.warn("""azure-native:containerinstance/v20210901:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230201preview:ContainerGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: azure-native:containerinstance/v20210901:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230201preview:ContainerGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['containerGroupName'] = container_group_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20210901:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
