...
class ContainerGroupPropertiesResponseProperties(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "confidentialComputeProperties":
            suggest = "confidential_compute_properties"
        elif key == "dnsConfig":
            suggest = "dns_config"
    ...
    def __init__(__self__, *,
                 ...
                 confidential_compute_properties: Optional['outputs.ConfidentialComputePropertiesResponse'] = None,
        ...
        :param 'ConfidentialComputePropertiesResponse' confidential_compute_properties: The properties for confidential container group
        ...
        :param str priority: The priority of the container group.
