...
class ContainerGroupArgs:
    def __init__(__self__, *,
                 ...
                 provisioning_timeout_in_seconds: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] provisioning_timeout_in_seconds: Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
        ...
        if provisioning_timeout_in_seconds is not None:
            pulumi.set(__self__, "provisioning_timeout_in_seconds", provisioning_timeout_in_seconds)
    ...
    @property
    @pulumi.getter(name="provisioningTimeoutInSeconds")
    def provisioning_timeout_in_seconds(self) -> Optional[pulumi.Input[int]]:
        """
        ...
        """
        return pulumi.get(self, "provisioning_timeout_in_seconds")

    @provisioning_timeout_in_seconds.setter
    def provisioning_timeout_in_seconds(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "provisioning_timeout_in_seconds", value)
...
class ContainerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_group = azure_native.containerinstance.v20230201preview.ContainerGroup("containerGroup",
            ...
            containers=[{
                ...
                "image": "nginx",
                "name": "demo1",
                "ports": [azure_native.containerinstance.v20230201preview.ContainerPortArgs(
                    port=80,
                )],
                "resources": {
                    "requests": azure_native.containerinstance.v20230201preview.ResourceRequestsArgs(
                        cpu=1,
                        memory_in_gb=1.5,
                    ),
                },
            ...
            ip_address=azure_native.containerinstance.v20230201preview.IpAddressResponseArgs(
                ports=[{
                    "port": 80,
                    "protocol": "TCP",
                }],
        ...
        container_group = azure_native.containerinstance.v20230201preview.ContainerGroup("containerGroup",
            ...
            encryption_properties=azure_native.containerinstance.v20230201preview.EncryptionPropertiesResponseArgs(
            ...
            identity=azure_native.containerinstance.v20230201preview.ContainerGroupIdentityArgs(
                type=azure_native.containerinstance/v20230201preview.ResourceIdentityType.USER_ASSIGNED,
        ...
        container_group = azure_native.containerinstance.v20230201preview.ContainerGroup("containerGroup",
            ...
            containers=[{
                ...
                "resources": {
                    "requests": azure_native.containerinstance.v20230201preview.ResourceRequestsArgs(
                        cpu=1,
                        gpu=azure_native.containerinstance.v20230201preview.GpuResourceArgs(
                            count=1,
                            sku="K80",
                        ),
                        memory_in_gb=1.5,
                ...
                "volumeMounts": [
                    azure_native.containerinstance.v20230201preview.VolumeMountArgs(
            ...
            diagnostics=azure_native.containerinstance.v20230201preview.ContainerGroupDiagnosticsResponseArgs(
                log_analytics=azure_native.containerinstance.v20230201preview.LogAnalyticsArgs(
            ...
            dns_config=azure_native.containerinstance.v20230201preview.DnsConfigurationResponseArgs(
                name_servers=["1.1.1.1"],
                options="ndots:2",
                search_domains="cluster.local svc.cluster.local",
            ),
            identity=azure_native.containerinstance.v20230201preview.ContainerGroupIdentityArgs(
                type=azure_native.containerinstance/v20230201preview.ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED,
                user_assigned_identities={
            ...
            location="west us",
            os_type="Linux",
            provisioning_timeout_in_seconds=600,
            resource_group_name="demo",
            subnet_ids=[{
            ...
            volumes=[
                {
                    "azureFile": azure_native.containerinstance.v20230201preview.AzureFileVolumeArgs(
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["provisioning_timeout_in_seconds"] = provisioning_timeout_in_seconds
            ...
            __props__.__dict__["is_custom_provisioning_timeout"] = None
        ...
        super(ContainerGroup, __self__).__init__(
            'azure-native:containerinstance/v20230201preview:ContainerGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["provisioning_timeout_in_seconds"] = None
    ...
    @property
    @pulumi.getter(name="isCustomProvisioningTimeout")
    def is_custom_provisioning_timeout(self) -> pulumi.Output[str]:
        """
        Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property
        """
        return pulumi.get(self, "is_custom_provisioning_timeout")
    ...
    @property
    @pulumi.getter(name="provisioningTimeoutInSeconds")
    def provisioning_timeout_in_seconds(self) -> pulumi.Output[Optional[int]]:
        """
        Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum value by default.
        """
        return pulumi.get(self, "provisioning_timeout_in_seconds")
