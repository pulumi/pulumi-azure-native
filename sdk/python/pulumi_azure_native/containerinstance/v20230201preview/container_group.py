...
class ContainerGroupArgs:
    ...
    def _configure(
        ...
        if provisioning_timeout_in_seconds is None and 'provisioningTimeoutInSeconds' in kwargs:
            provisioning_timeout_in_seconds = kwargs['provisioningTimeoutInSeconds']
        ...
        if provisioning_timeout_in_seconds is not None:
            _setter("provisioning_timeout_in_seconds", provisioning_timeout_in_seconds)
