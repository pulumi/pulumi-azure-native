...
class GetNGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, container_group_profiles=None, elastic_profile=None, id=None, identity=None, location=None, name=None, placement_profile=None, provisioning_state=None, system_data=None, tags=None, type=None, update_profile=None, zones=None):
...
def get_n_group(ngroups_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ngroups_name: The NGroups name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance:getNGroup', __args__, opts=opts, typ=GetNGroupResult).value
...
def get_n_group_output(ngroups_name: Optional[pulumi.Input[builtins.str]] = None,
