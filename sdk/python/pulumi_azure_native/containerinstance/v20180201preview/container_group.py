...
warnings.warn("""Version 2018-02-01-preview will be removed in v2 of the provider.
azure-native:containerinstance/v20180201preview:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20210301:ContainerGroup to guarantee forwards compatibility.""", DeprecationWarning)
