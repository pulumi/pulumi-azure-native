...
__all__ = [
    ...
    'ContainerGroupNetworkProfileArgsDict',
...
if not MYPY:
    class ContainerGroupNetworkProfileArgsDict(TypedDict):
        """
    ...
    ContainerGroupNetworkProfileArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class LogAnalyticsArgsDict(TypedDict):
        ...
        """
        workspace_resource_id: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[str]]]]
        """
