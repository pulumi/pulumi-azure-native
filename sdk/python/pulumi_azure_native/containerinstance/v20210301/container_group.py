...
class ContainerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(identity, ContainerGroupIdentityArgs):
            ...
            if not isinstance(ip_address, IpAddressArgs):
            ...
            if not isinstance(network_profile, ContainerGroupNetworkProfileArgs):
                network_profile = network_profile or {}
                def _setter(key, value):
                    network_profile[key] = value
                ContainerGroupNetworkProfileArgs._configure(_setter, **network_profile)
