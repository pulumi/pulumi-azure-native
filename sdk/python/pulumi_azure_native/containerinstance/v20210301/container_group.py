...
class ContainerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_group = azure_native.containerinstance.v20210301.ContainerGroup("containerGroup",
            ...
            containers=[{
                ...
                "image": "nginx",
                "name": "demo1",
                "ports": [azure_native.containerinstance.v20210301.ContainerPortArgs(
                    port=80,
                )],
                "resources": {
                    "requests": azure_native.containerinstance.v20210301.ResourceRequestsArgs(
                        cpu=1,
                        gpu=azure_native.containerinstance.v20210301.GpuResourceArgs(
                            count=1,
                            sku="K80",
                        ),
                        memory_in_gb=1.5,
                ...
                "volumeMounts": [
                    azure_native.containerinstance.v20210301.VolumeMountArgs(
            ...
            diagnostics=azure_native.containerinstance.v20210301.ContainerGroupDiagnosticsResponseArgs(
                log_analytics=azure_native.containerinstance.v20210301.LogAnalyticsArgs(
            ...
            dns_config=azure_native.containerinstance.v20210301.DnsConfigurationResponseArgs(
                name_servers=["1.1.1.1"],
                options="ndots:2",
                search_domains="cluster.local svc.cluster.local",
            ),
            identity=azure_native.containerinstance.v20210301.ContainerGroupIdentityArgs(
                type=azure_native.containerinstance/v20210301.ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED,
                user_assigned_identities={
                    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-name": {},
                },
            ),
            image_registry_credentials=[],
            ip_address=azure_native.containerinstance.v20210301.IpAddressResponseArgs(
            ...
            location="west us",
            network_profile=azure_native.containerinstance.v20210301.ContainerGroupNetworkProfileResponseArgs(
            ...
            volumes=[
                {
                    "azureFile": azure_native.containerinstance.v20210301.AzureFileVolumeArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20170801preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20171001preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20171201preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20180201preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20180401:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20180601:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20180901:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20181001:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20191201:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20201101:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20210701:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20210901:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20211001:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20220901:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20221001preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20230201preview:ContainerGroup"), pulumi.Alias(type_="azure-native:containerinstance/v20230501:ContainerGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerGroup, __self__).__init__(
            'azure-native:containerinstance/v20210301:ContainerGroup',
            resource_name,
            __props__,
            opts)
