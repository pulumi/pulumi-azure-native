...
class GetContainerGroupResult:
    ...
    A container group.
    """
    def __init__(__self__, containers=None, diagnostics=None, id=None, image_registry_credentials=None, instance_view=None, ip_address=None, location=None, name=None, network_profile=None, os_type=None, provisioning_state=None, restart_policy=None, tags=None, type=None, volumes=None):
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: Version 2018-09-01 will be removed in v2 of the provider.
azure-native:containerinstance/v20180901:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20210301:ContainerGroup to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20180901:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
