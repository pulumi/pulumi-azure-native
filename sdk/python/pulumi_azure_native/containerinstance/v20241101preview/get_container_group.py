...
class GetContainerGroupResult:
    ...
    A container group.
    """
    def __init__(__self__, confidential_compute_properties=None, containers=None, diagnostics=None, dns_config=None, encryption_properties=None, extensions=None, id=None, identity=None, identity_acls=None, image_registry_credentials=None, init_containers=None, instance_view=None, ip_address=None, location=None, name=None, os_type=None, priority=None, provisioning_state=None, restart_policy=None, secret_references=None, sku=None, subnet_ids=None, tags=None, type=None, volumes=None, zones=None):
        ...
        if identity_acls and not isinstance(identity_acls, dict):
            raise TypeError("Expected argument 'identity_acls' to be a dict")
        pulumi.set(__self__, "identity_acls", identity_acls)
    ...
    @property
    @pulumi.getter(name="identityAcls")
    def identity_acls(self) -> Optional['outputs.IdentityAclsResponse']:
        """
        The access control levels of the identities.
        """
        return pulumi.get(self, "identity_acls")
...
class AwaitableGetContainerGroupResult(GetContainerGroupResult):
    ...
    def __await__(self):
        ...
        return GetContainerGroupResult(
            ...
            identity_acls=self.identity_acls,
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20241101preview:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
    ...
    return AwaitableGetContainerGroupResult(
        ...
        identity_acls=pulumi.get(__ret__, 'identity_acls'),
...
def get_container_group_output(container_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerinstance/v20241101preview:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult)
    return __ret__.apply(lambda __response__: GetContainerGroupResult(
        ...
        identity_acls=pulumi.get(__response__, 'identity_acls'),
