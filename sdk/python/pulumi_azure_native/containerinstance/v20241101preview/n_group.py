...
class NGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerinstance/v20240901preview:NGroup"), pulumi.Alias(type_="azure-native:containerinstance:NGroup")])
