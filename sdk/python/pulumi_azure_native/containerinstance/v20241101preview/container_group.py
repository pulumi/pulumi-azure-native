...
class ContainerGroupArgs:
    def __init__(__self__, *,
                 ...
                 identity_acls: Optional[pulumi.Input['IdentityAclsArgs']] = None,
        ...
        :param pulumi.Input['IdentityAclsArgs'] identity_acls: The access control levels of the identities.
    ...
    def identity_acls(self) -> Optional[pulumi.Input['IdentityAclsArgs']]:
        """
        The access control levels of the identities.
        """
        return pulumi.get(self, "identity_acls")

    @identity_acls.setter
    def identity_acls(self, value: Optional[pulumi.Input['IdentityAclsArgs']]):
        pulumi.set(self, "identity_acls", value)
...
class ContainerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 identity_acls: Optional[pulumi.Input[Union['IdentityAclsArgs', 'IdentityAclsArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['IdentityAclsArgs', 'IdentityAclsArgsDict']] identity_acls: The access control levels of the identities.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["identity_acls"] = identity_acls
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["identity_acls"] = None
    ...
    @property
    @pulumi.getter(name="identityAcls")
    def identity_acls(self) -> pulumi.Output[Optional['outputs.IdentityAclsResponse']]:
        """
        The access control levels of the identities.
        """
        return pulumi.get(self, "identity_acls")
