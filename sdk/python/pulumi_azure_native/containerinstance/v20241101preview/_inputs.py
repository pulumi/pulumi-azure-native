...
__all__ = [
    ...
    'IdentityAccessControlArgsDict',
    'IdentityAclsArgs',
    'IdentityAclsArgsDict',
...
class ApplicationGatewayBackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        """
        NGroups application gateway backend address pool
        :param pulumi.Input[str] resource: The application gateway backend address pool ARM resource Id.
        """
...
class ApplicationGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource: The Application Gateway ARM resource Id.
        """
...
class ContainerGroupProfileStubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] revision: The revision of the CG profile is an optional property. If customer does not to provide a revision then NGroups will pickup the latest revision of CGProfile.
...
class ElasticProfileGuidNamingPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] prefix: The prefix can be used when there are tooling limitations (e.g. on the Azure portal where CGs from multiple NGroups exist in the same RG). The prefix with the suffixed resource name must still follow Azure resource naming guidelines.
        """
...
if not MYPY:
    class ElasticProfileArgsDict(TypedDict):
        ...
        maintain_desired_count: NotRequired[pulumi.Input[bool]]
        """
...
class ElasticProfileArgs:
    def __init__(__self__, *,
                 ...
                 maintain_desired_count: Optional[pulumi.Input[bool]] = None):
        """
        Describes the elastic profile of the NGroup
        ...
        :param pulumi.Input[bool] maintain_desired_count: Flag that indicates whether desiredCount should be maintained when customer deletes SPECIFIC container groups (CGs) from the NGroups. In this case, new CGs will be created by NGroup to compensate for the specific deleted ones.
        """
    ...
    def maintain_desired_count(self) -> Optional[pulumi.Input[bool]]:
        """
        Flag that indicates whether desiredCount should be maintained when customer deletes SPECIFIC container groups (CGs) from the NGroups. In this case, new CGs will be created by NGroup to compensate for the specific deleted ones.
        """
    ...
    def maintain_desired_count(self, value: Optional[pulumi.Input[bool]]):
...
if not MYPY:
    class IdentityAccessControlArgsDict(TypedDict):
        """
        The access control for an identity
        """
        access: NotRequired[pulumi.Input[Union[str, 'IdentityAccessLevel']]]
        """
    ...
    IdentityAccessControlArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class IdentityAccessControlArgs:
    def __init__(__self__, *,
                 access: Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]] = None,
                 identity: Optional[pulumi.Input[str]] = None):
        """
        The access control for an identity
        :param pulumi.Input[Union[str, 'IdentityAccessLevel']] access: The access level of the identity.
        :param pulumi.Input[str] identity: An identity.
        """
    ...
    @property
    @pulumi.getter
    def access(self) -> Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]]:
        """
        The access level of the identity.
        """
    ...
    @access.setter
    def access(self, value: Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]]):
...
if not MYPY:
    class IdentityAclsArgsDict(TypedDict):
        """
        The access control levels of the identities.
        """
        acls: NotRequired[pulumi.Input[Sequence[pulumi.Input['IdentityAccessControlArgsDict']]]]
        """
        The access control levels for each identity.
        """
        default_access: NotRequired[pulumi.Input[Union[str, 'IdentityAccessLevel']]]
        """
        The default access level.
        """
elif False:
    IdentityAclsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class IdentityAclsArgs:
    def __init__(__self__, *,
                 acls: Optional[pulumi.Input[Sequence[pulumi.Input['IdentityAccessControlArgs']]]] = None,
                 default_access: Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]] = None):
        """
        The access control levels of the identities.
        :param pulumi.Input[Sequence[pulumi.Input['IdentityAccessControlArgs']]] acls: The access control levels for each identity.
        :param pulumi.Input[Union[str, 'IdentityAccessLevel']] default_access: The default access level.
        """
        if acls is not None:
    ...
    @property
    @pulumi.getter
    def acls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['IdentityAccessControlArgs']]]]:
        """
        The access control levels for each identity.
        """
    ...
    @acls.setter
    def acls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['IdentityAccessControlArgs']]]]):
        pulumi.set(self, "acls", value)

    @property
    @pulumi.getter(name="defaultAccess")
    def default_access(self) -> Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]]:
        """
        The default access level.
        """
    ...
    def default_access(self, value: Optional[pulumi.Input[Union[str, 'IdentityAccessLevel']]]):
...
class LoadBalancerBackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        """
        NGroups load balancer backend address pool
        :param pulumi.Input[str] resource: The Load Balancer backend address pool ARM resource Id.
        """
        if resource is not None:
            pulumi.set(__self__, "resource", resource)
...
class NGroupIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] user_assigned_identities: The list of user identities associated with the NGroup.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if user_assigned_identities is not None:
...
if not MYPY:
    class PlacementProfileArgsDict(TypedDict):
        ...
        """
        fault_domain_count: NotRequired[pulumi.Input[int]]
        """
...
class PlacementProfileArgs:
    def __init__(__self__, *,
                 fault_domain_count: Optional[pulumi.Input[int]] = None):
        """
        Provides options w.r.t allocation and management w.r.t certain placement policies. These utilize capabilities provided by the underlying Azure infrastructure. They are typically used for high availability scenarios. E.g., distributing CGs across fault domains.
        :param pulumi.Input[int] fault_domain_count: The number of fault domains to be used to spread CGs in the NGroups resource. This can only be specified during NGroup creation and is immutable after that.
        """
    ...
    def fault_domain_count(self) -> Optional[pulumi.Input[int]]:
        """
        The number of fault domains to be used to spread CGs in the NGroups resource. This can only be specified during NGroup creation and is immutable after that.
        """
    ...
    def fault_domain_count(self, value: Optional[pulumi.Input[int]]):
...
class UpdateProfileRollingUpdateProfileArgs:
    def __init__(__self__, *,
                 in_place_update: Optional[pulumi.Input[bool]] = None,
                 max_batch_percent: Optional[pulumi.Input[int]] = None,
                 max_unhealthy_percent: Optional[pulumi.Input[int]] = None,
                 pause_time_between_batches: Optional[pulumi.Input[str]] = None):
        """
        This profile allows the customers to customize the rolling update.
        :param pulumi.Input[bool] in_place_update: Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
        :param pulumi.Input[int] max_batch_percent: Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
        :param pulumi.Input[int] max_unhealthy_percent: Maximum percentage of the updated Container Groups which can be in unhealthy state after each batch is updated.
        :param pulumi.Input[str] pause_time_between_batches: The wait time between batches after completing the one batch of the rolling update and starting the next batch. The time duration should be specified in ISO 8601 format for duration.
        """
    ...
    def in_place_update(self) -> Optional[pulumi.Input[bool]]:
        """
        Default is false. If set to true, the CGs will be updated in-place instead of creating new CG and deleting old ones.
        """
    ...
    def in_place_update(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "in_place_update", value)

    @property
    @pulumi.getter(name="maxBatchPercent")
    def max_batch_percent(self) -> Optional[pulumi.Input[int]]:
        """
        Maximum percentage of total Container Groups which can be updated simultaneously by rolling update in one batch.
        """
    ...
    def max_batch_percent(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "max_batch_percent", value)

    @property
    @pulumi.getter(name="maxUnhealthyPercent")
    def max_unhealthy_percent(self) -> Optional[pulumi.Input[int]]:
        """
        Maximum percentage of the updated Container Groups which can be in unhealthy state after each batch is updated.
        """
    ...
    def max_unhealthy_percent(self, value: Optional[pulumi.Input[int]]):
...
if not MYPY:
    class UpdateProfileArgsDict(TypedDict):
        ...
        This profile allows the customers to customize the rolling update.
        """
        update_mode: NotRequired[pulumi.Input[Union[str, 'NGroupUpdateMode']]]
elif False:
...
class UpdateProfileArgs:
    def __init__(__self__, *,
                 ...
                 update_mode: Optional[pulumi.Input[Union[str, 'NGroupUpdateMode']]] = None):
        """
        Used by the customer to specify the way to update the Container Groups in NGroup.
    ...
    def update_mode(self) -> Optional[pulumi.Input[Union[str, 'NGroupUpdateMode']]]:
        return pulumi.get(self, "update_mode")

    @update_mode.setter
    def update_mode(self, value: Optional[pulumi.Input[Union[str, 'NGroupUpdateMode']]]):
