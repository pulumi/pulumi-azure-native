...
warnings.warn("""azure-native:containerinstance/v20211001:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230501:ContainerGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: azure-native:containerinstance/v20211001:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230501:ContainerGroup to guarantee forwards compatibility.""")
    __args__ = dict()
