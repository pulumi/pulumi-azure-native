...
warnings.warn("""azure-native:containerinstance/v20211001:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230201preview:ContainerGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetContainerGroupResult:
    ...
    A container group.
    """
    def __init__(__self__, containers=None, diagnostics=None, dns_config=None, encryption_properties=None, id=None, identity=None, image_registry_credentials=None, init_containers=None, instance_view=None, ip_address=None, location=None, name=None, os_type=None, provisioning_state=None, restart_policy=None, sku=None, subnet_ids=None, tags=None, type=None, volumes=None, zones=None):
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: azure-native:containerinstance/v20211001:ContainerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:containerinstance/v20230201preview:ContainerGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['containerGroupName'] = container_group_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/v20211001:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
