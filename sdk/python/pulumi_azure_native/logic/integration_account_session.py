...
class IntegrationAccountSession(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20160601:Session"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountSession"), pulumi.Alias(type_="azure-native_logic_v20160601:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native_logic_v20180701preview:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native_logic_v20190501:logic:IntegrationAccountSession")])
