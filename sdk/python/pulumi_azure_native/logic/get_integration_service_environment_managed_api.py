...
class GetIntegrationServiceEnvironmentManagedApiResult:
    ...
    def runtime_urls(self) -> Sequence[builtins.str]:
        """
        The runtime urls.
        """
...
def get_integration_service_environment_managed_api(api_name: Optional[builtins.str] = None,
                                                    integration_service_environment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str api_name: The api name.
    :param builtins.str integration_service_environment_name: The integration service environment name.
    :param builtins.str resource_group: The resource group name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic:getIntegrationServiceEnvironmentManagedApi', __args__, opts=opts, typ=GetIntegrationServiceEnvironmentManagedApiResult).value
...
def get_integration_service_environment_managed_api_output(api_name: Optional[pulumi.Input[builtins.str]] = None,
                                                           integration_service_environment_name: Optional[pulumi.Input[builtins.str]] = None,
