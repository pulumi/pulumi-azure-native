...
def get_integration_service_environment_managed_api(api_name: Optional[_builtins.str] = None,
                                                    integration_service_environment_name: Optional[_builtins.str] = None,
