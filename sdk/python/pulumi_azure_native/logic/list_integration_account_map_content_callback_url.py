...
__all__ = [
    ...
    'list_integration_account_map_content_callback_url_output',
]
...
def list_integration_account_map_content_callback_url(integration_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str map_name: The integration account map name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic:listIntegrationAccountMapContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountMapContentCallbackUrlResult).value
...
def list_integration_account_map_content_callback_url_output(integration_account_name: Optional[pulumi.Input[builtins.str]] = None,
