...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[builtins.str] = None,
...
def list_integration_account_assembly_content_callback_url_output(assembly_artifact_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult)
