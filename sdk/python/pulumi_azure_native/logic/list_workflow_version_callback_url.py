...
def list_workflow_version_callback_url(key_type: Optional['KeyType'] = None,
    ...
    :param _builtins.str version_id: The workflow versionId.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic:listWorkflowVersionCallbackUrl', __args__, opts=opts, typ=ListWorkflowVersionCallbackUrlResult).value
...
def list_workflow_version_callback_url_output(key_type: Optional[pulumi.Input[Optional['KeyType']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic:listWorkflowVersionCallbackUrl', __args__, opts=opts, typ=ListWorkflowVersionCallbackUrlResult)
