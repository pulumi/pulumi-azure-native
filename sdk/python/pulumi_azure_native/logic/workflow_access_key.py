...
class WorkflowAccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] workflow_name: The workflow name.
        :param pulumi.Input[builtins.str] access_key_name: The workflow access key name.
        :param pulumi.Input[builtins.str] id: Gets or sets the resource id.
        :param pulumi.Input[builtins.str] not_after: Gets or sets the not-after time.
        :param pulumi.Input[builtins.str] not_before: Gets or sets the not-before time.
        """
