...
def get_integration_account_agreement(agreement_name: Optional[_builtins.str] = None,
...
def get_integration_account_agreement_output(agreement_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
