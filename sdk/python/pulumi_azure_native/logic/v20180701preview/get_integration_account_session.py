...
def get_integration_account_session(integration_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_session is deprecated: azure-native:logic/v20180701preview:IntegrationAccountSession is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccountSession to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['integrationAccountName'] = integration_account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['sessionName'] = session_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20180701preview:getIntegrationAccountSession', __args__, opts=opts, typ=GetIntegrationAccountSessionResult).value
