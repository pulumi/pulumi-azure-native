...
warnings.warn("""azure-native:logic/v20180701preview:IntegrationAccount is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
class IntegrationAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""IntegrationAccount is deprecated: azure-native:logic/v20180701preview:IntegrationAccount is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccount to guarantee forwards compatibility.""")
