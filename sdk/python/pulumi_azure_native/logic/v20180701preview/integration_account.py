...
class IntegrationAccount(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:IntegrationAccount"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccount"), pulumi.Alias(type_="azure-native:logic/latest:IntegrationAccount"), pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccount"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccount"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccount"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccount"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccount"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccount"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccount")])
