...
warnings.warn("""azure-native:logic/v20180701preview:IntegrationAccountMap is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountMap to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_integration_account_map(integration_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_map is deprecated: azure-native:logic/v20180701preview:IntegrationAccountMap is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountMap to guarantee forwards compatibility.""")
    __args__ = dict()
