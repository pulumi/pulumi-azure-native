...
warnings.warn("""azure-native:logic/v20180701preview:IntegrationAccountAgreement is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAgreement to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_integration_account_agreement(agreement_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_agreement is deprecated: azure-native:logic/v20180701preview:IntegrationAccountAgreement is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAgreement to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['agreementName'] = agreement_name
    __args__['integrationAccountName'] = integration_account_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20180701preview:getIntegrationAccountAgreement', __args__, opts=opts, typ=GetIntegrationAccountAgreementResult).value
