...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20180701preview:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult).value
...
def list_integration_account_assembly_content_callback_url_output(assembly_artifact_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20180701preview:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult)
