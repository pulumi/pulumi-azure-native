...
warnings.warn("""azure-native:logic/v20180701preview:IntegrationAccountAssembly is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_integration_account_assembly(assembly_artifact_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_assembly is deprecated: azure-native:logic/v20180701preview:IntegrationAccountAssembly is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.""")
    __args__ = dict()
