...
class IntegrationServiceEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group: The resource group.
    ...
    def integration_service_environment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def integration_service_environment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IntegrationServiceEnvironment(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:logic:IntegrationServiceEnvironment"
