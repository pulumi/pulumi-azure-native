...
class IntegrationAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccount"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccount"), pulumi.Alias(type_="azure-native_logic_v20150801preview:logic:IntegrationAccount"), pulumi.Alias(type_="azure-native_logic_v20160601:logic:IntegrationAccount"), pulumi.Alias(type_="azure-native_logic_v20180701preview:logic:IntegrationAccount"), pulumi.Alias(type_="azure-native_logic_v20190501:logic:IntegrationAccount")])
