...
def get_workflow_access_key(access_key_name: Optional[builtins.str] = None,
...
def get_workflow_access_key_output(access_key_name: Optional[pulumi.Input[builtins.str]] = None,
