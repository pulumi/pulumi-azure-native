...
class IntegrationAccountSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] document_name: The document name.
        ...
        :param pulumi.Input[builtins.str] schema_name: The integration account schema name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The resource tags.
        :param pulumi.Input[builtins.str] target_namespace: The target namespace of the schema.
        """
...
class IntegrationAccountSchema(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="documentName")
    def document_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The document name.
        """
        return pulumi.get(self, "document_name")
    ...
    @property
    @pulumi.getter(name="targetNamespace")
    def target_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target namespace of the schema.
        """
        return pulumi.get(self, "target_namespace")
