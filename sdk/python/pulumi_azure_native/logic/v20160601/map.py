...
class Map(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Map"), pulumi.Alias(type_="azure-native:logic:Map"), pulumi.Alias(type_="azure-nextgen:logic:Map"), pulumi.Alias(type_="azure-native:logic/latest:Map"), pulumi.Alias(type_="azure-nextgen:logic/latest:Map"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Map"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Map"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Map"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Map"), pulumi.Alias(type_="azure-native:logic/v20190501:Map"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Map")])
    ...
    def get(resource_name: str,
        ...
        __props__["map_type"] = None
        __props__["metadata"] = None
        __props__["name"] = None
        __props__["parameters_schema"] = None
        __props__["tags"] = None
        __props__["type"] = None
