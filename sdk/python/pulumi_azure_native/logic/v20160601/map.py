...
class Map(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Map"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Map"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20190501:Map"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic:Map")])
