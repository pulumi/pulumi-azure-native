...
class Session(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20180701preview:Session"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20190501:Session"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic:Session")])
