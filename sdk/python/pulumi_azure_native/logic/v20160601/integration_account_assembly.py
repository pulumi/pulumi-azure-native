...
class IntegrationAccountAssembly(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""IntegrationAccountAssembly is deprecated: azure-native:logic/v20160601:IntegrationAccountAssembly is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.""")
