...
def list_workflow_callback_url(key_type: Optional['KeyType'] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20160601:listWorkflowCallbackUrl', __args__, opts=opts, typ=ListWorkflowCallbackUrlResult).value
...
def list_workflow_callback_url_output(key_type: Optional[pulumi.Input[Optional['KeyType']]] = None,
    ...
    __args__['workflowName'] = workflow_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20160601:listWorkflowCallbackUrl', __args__, opts=opts, typ=ListWorkflowCallbackUrlResult)
