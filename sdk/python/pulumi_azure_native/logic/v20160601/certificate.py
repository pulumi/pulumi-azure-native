...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20150801preview:Certificate"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Certificate"), pulumi.Alias(type_="azure-native:logic/v20190501:Certificate"), pulumi.Alias(type_="azure-native:logic:Certificate")])
