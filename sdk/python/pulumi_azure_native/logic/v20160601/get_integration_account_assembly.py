...
def get_integration_account_assembly(assembly_artifact_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_assembly is deprecated: azure-native:logic/v20160601:IntegrationAccountAssembly is being removed in the next major version of this provider. Upgrade to at least azure-native:logic/v20190501:IntegrationAccountAssembly to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['assemblyArtifactName'] = assembly_artifact_name
    __args__['integrationAccountName'] = integration_account_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20160601:getIntegrationAccountAssembly', __args__, opts=opts, typ=GetIntegrationAccountAssemblyResult).value
