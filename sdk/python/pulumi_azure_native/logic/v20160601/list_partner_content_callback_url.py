...
__all__ = [
    ...
    'list_partner_content_callback_url_output',
]
...
def list_partner_content_callback_url(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20160601:listPartnerContentCallbackUrl', __args__, opts=opts, typ=ListPartnerContentCallbackUrlResult).value
...
def list_partner_content_callback_url_output(integration_account_name: Optional[pulumi.Input[str]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListPartnerContentCallbackUrlResult]:
    """
    Get the content callback url.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20160601:listPartnerContentCallbackUrl', __args__, opts=opts, typ=ListPartnerContentCallbackUrlResult)
    return __ret__.apply(lambda __response__: ListPartnerContentCallbackUrlResult(
