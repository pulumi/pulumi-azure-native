...
def list_map_content_callback_url_output(integration_account_name: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListMapContentCallbackUrlResult]:
    """
    Get the content callback url.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20160601:listMapContentCallbackUrl', __args__, opts=opts, typ=ListMapContentCallbackUrlResult)
    return __ret__.apply(lambda __response__: ListMapContentCallbackUrlResult(
