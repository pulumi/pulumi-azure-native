...
__all__ = [
    'ListAgreementContentCallbackUrlResult',
    'AwaitableListAgreementContentCallbackUrlResult',
    'list_agreement_content_callback_url',
    'list_agreement_content_callback_url_output',
]

@pulumi.output_type
class ListAgreementContentCallbackUrlResult:
    """
...
class AwaitableListAgreementContentCallbackUrlResult(ListAgreementContentCallbackUrlResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListAgreementContentCallbackUrlResult(
...
def list_agreement_content_callback_url(agreement_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20160601:listAgreementContentCallbackUrl', __args__, opts=opts, typ=ListAgreementContentCallbackUrlResult).value

    return AwaitableListAgreementContentCallbackUrlResult(
...
def list_agreement_content_callback_url_output(agreement_name: Optional[pulumi.Input[str]] = None,
                                               ...
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListAgreementContentCallbackUrlResult]:
    """
    Get the content callback url.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20160601:listAgreementContentCallbackUrl', __args__, opts=opts, typ=ListAgreementContentCallbackUrlResult)
    return __ret__.apply(lambda __response__: ListAgreementContentCallbackUrlResult(
