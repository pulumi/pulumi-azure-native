...
class Partner(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20150801preview:Partner"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Partner"), pulumi.Alias(type_="azure-native:logic/v20190501:Partner"), pulumi.Alias(type_="azure-native:logic:Partner")])
