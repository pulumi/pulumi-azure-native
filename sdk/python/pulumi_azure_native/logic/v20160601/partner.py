...
class Partner(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Partner"), pulumi.Alias(type_="azure-native:logic:Partner"), pulumi.Alias(type_="azure-nextgen:logic:Partner"), pulumi.Alias(type_="azure-native:logic/latest:Partner"), pulumi.Alias(type_="azure-nextgen:logic/latest:Partner"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Partner"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Partner"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Partner"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Partner"), pulumi.Alias(type_="azure-native:logic/v20190501:Partner"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Partner")])
