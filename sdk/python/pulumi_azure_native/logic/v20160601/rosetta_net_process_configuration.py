...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rosetta_net_process_configuration = azure_native.logic.v20160601.RosettaNetProcessConfiguration("rosettaNetProcessConfiguration",
            activity_settings=azure_native.logic.v20160601.RosettaNetPipActivitySettingsArgs(
                acknowledgment_of_receipt_settings=azure_native.logic.v20160601.RosettaNetPipAcknowledgmentOfReceiptSettingsArgs(
                    is_non_repudiation_required=False,
                    time_to_acknowledge_in_seconds=600,
                ),
                activity_behavior=azure_native.logic.v20160601.RosettaNetPipActivityBehaviorArgs(
                    action_type=azure_native.logic/v20160601.RosettaNetActionType.DOUBLE_ACTION,
                    is_authorization_required=False,
                    is_secured_transport_required=False,
                    non_repudiation_of_origin_and_content=False,
                    persistent_confidentiality_scope=azure_native.logic/v20160601.RosettaNetPipConfidentialityScope.NONE,
                    response_type=azure_native.logic/v20160601.RosettaNetResponseType.ASYNC_,
                    retry_count=2,
                    time_to_perform_in_seconds=7200,
                ),
                activity_type=azure_native.logic/v20160601.RosettaNetPipActivityType.REQUEST_RESPONSE,
            ),
            description="Test description",
            initiator_role_settings=azure_native.logic.v20160601.RosettaNetPipRoleSettingsResponseArgs(
                action="Purchase Order Request",
                business_document=azure_native.logic.v20160601.RosettaNetPipBusinessDocumentArgs(
                ...
                role="Buyer",
                role_type=azure_native.logic/v20160601.RosettaNetPipRoleType.FUNCTIONAL,
            ...
            responder_role_settings=azure_native.logic.v20160601.RosettaNetPipRoleSettingsResponseArgs(
                ...
                role="Seller",
                role_type=azure_native.logic/v20160601.RosettaNetPipRoleType.ORGANIZATIONAL,
