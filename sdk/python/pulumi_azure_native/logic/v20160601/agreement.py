...
class Agreement(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        agreement = azure_native.logic.v20160601.Agreement("agreement",
            agreement_name="testAgreement",
            agreement_type=azure_native.logic/v20160601.AgreementType.AS2,
            content=azure_native.logic.v20160601.AgreementContentResponseArgs(
                a_s2={
                    "receiveAgreement": {
                        "protocolSettings": {
                            "acknowledgementConnectionSettings": azure_native.logic.v20160601.AS2AcknowledgementConnectionSettingsArgs(
                            ...
                            "envelopeSettings": azure_native.logic.v20160601.AS2EnvelopeSettingsArgs(
                            ...
                            "errorSettings": azure_native.logic.v20160601.AS2ErrorSettingsArgs(
                                resend_if_mdn_not_received=True,
                                suspend_duplicate_message=True,
                            ),
                            "mdnSettings": azure_native.logic.v20160601.AS2MdnSettingsArgs(
                                disposition_notification_to="http://tempuri.org",
                                mdn_text="Sample",
                                mic_hashing_algorithm=azure_native.logic/v20160601.HashingAlgorithm.SHA1,
                                need_mdn=True,
                            ...
                            "messageConnectionSettings": azure_native.logic.v20160601.AS2MessageConnectionSettingsArgs(
                                ignore_certificate_name_mismatch=True,
                                keep_http_connection_alive=True,
                                support_http_status_code_continue=True,
                                unfold_http_headers=True,
                            ),
                            "securitySettings": azure_native.logic.v20160601.AS2SecuritySettingsArgs(
                            ...
                            "validationSettings": azure_native.logic.v20160601.AS2ValidationSettingsArgs(
                                ...
                                encryption_algorithm=azure_native.logic/v20160601.EncryptionAlgorithm.AES128,
                                interchange_duplicates_validity_days=100,
                                override_message_properties=True,
                                sign_message=False,
                            ),
                        },
                        "receiverBusinessIdentity": azure_native.logic.v20160601.BusinessIdentityArgs(
                            qualifier="ZZ",
                            value="ZZ",
                        ),
                        "senderBusinessIdentity": azure_native.logic.v20160601.BusinessIdentityArgs(
                            qualifier="AA",
                            value="AA",
                        ),
                    },
            ...
            guest_identity=azure_native.logic.v20160601.BusinessIdentityArgs(
                qualifier="AA",
                value="AA",
            ),
            guest_partner="GuestPartner",
            host_identity=azure_native.logic.v20160601.BusinessIdentityArgs(
                qualifier="ZZ",
                value="ZZ",
            ),
