...
warnings.warn("""azure-native:logic/v20160601:IntegrationAccountBatchConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountBatchConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_integration_account_batch_configuration(batch_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_batch_configuration is deprecated: azure-native:logic/v20160601:IntegrationAccountBatchConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:logic/v20190501:IntegrationAccountBatchConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
