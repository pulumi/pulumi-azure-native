...
__all__ = [
    ...
    'list_schema_content_callback_url_output',
]
...
def list_schema_content_callback_url(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/v20160601:listSchemaContentCallbackUrl', __args__, opts=opts, typ=ListSchemaContentCallbackUrlResult).value
...
def list_schema_content_callback_url_output(integration_account_name: Optional[pulumi.Input[str]] = None,
                                            key_type: Optional[pulumi.Input[Optional['KeyType']]] = None,
                                            not_after: Optional[pulumi.Input[Optional[str]]] = None,
                                            resource_group_name: Optional[pulumi.Input[str]] = None,
                                            schema_name: Optional[pulumi.Input[str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListSchemaContentCallbackUrlResult]:
    """
    Get the content callback url.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic/v20160601:listSchemaContentCallbackUrl', __args__, opts=opts, typ=ListSchemaContentCallbackUrlResult)
    return __ret__.apply(lambda __response__: ListSchemaContentCallbackUrlResult(
