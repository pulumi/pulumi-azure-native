...
class AS2SecuritySettingsArgs:
    ...
    def _configure(
        ...
        if 'sha2AlgorithmFormat' in kwargs:
...
class RosettaNetPipAcknowledgmentOfReceiptSettingsArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'isNonRepudiationRequired' in kwargs:
            is_non_repudiation_required = kwargs['isNonRepudiationRequired']
        if 'timeToAcknowledgeInSeconds' in kwargs:
...
class RosettaNetPipActivityBehaviorArgs:
    ...
    def _configure(
        ...
        if 'timeToPerformInSeconds' in kwargs:
