...
class Schema(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        schema = azure_native.logic.v20160601.Schema("schema",
        ...
        <xs:schema xmlns:b="http://schemas.microsoft.com/BizTalk/2003" xmlns="http://Inbound_EDI.OrderFile" targetNamespace="http://Inbound_EDI.OrderFile" xmlns:xs="http://www.w3.org/2001/XMLSchema">
          ...
          <xs:element name="OrderFile">
            ...
            schema_type=azure_native.logic/v20160601.SchemaType.XML,
            tags={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:Schema"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Schema"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Schema"), pulumi.Alias(type_="azure-native:logic/v20190501:Schema")])
