...
class Workflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workflow = azure_native.logic.v20160601.Workflow("workflow",
            definition={
            ...
            parameters={
                "$connections": azure_native.logic.v20160601.WorkflowParameterArgs(
                    value={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:Workflow"), pulumi.Alias(type_="azure-native:logic/v20150201preview:Workflow"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Workflow"), pulumi.Alias(type_="azure-native:logic/v20190501:Workflow")])
