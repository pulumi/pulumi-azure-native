...
def list_workflow_trigger_callback_url(resource_group_name: Optional[builtins.str] = None,
...
def list_workflow_trigger_callback_url_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic:listWorkflowTriggerCallbackUrl', __args__, opts=opts, typ=ListWorkflowTriggerCallbackUrlResult)
