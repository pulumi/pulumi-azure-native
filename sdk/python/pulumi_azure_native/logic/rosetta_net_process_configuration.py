...
class RosettaNetProcessConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 process_code: pulumi.Input[builtins.str],
                 process_name: pulumi.Input[builtins.str],
                 process_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] process_code: The integration account RosettaNet process code.
        :param pulumi.Input[builtins.str] process_name: The integration account RosettaNet process name.
        :param pulumi.Input[builtins.str] process_version: The integration account RosettaNet process version.
        ...
        :param pulumi.Input[builtins.str] description: The integration account RosettaNet ProcessConfiguration properties.
        :param pulumi.Input[builtins.str] location: The resource location.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The metadata.
        :param pulumi.Input[builtins.str] rosetta_net_process_configuration_name: The integration account RosettaNet ProcessConfiguration name.
    ...
    def process_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @process_code.setter
    def process_code(self, value: pulumi.Input[builtins.str]):
    ...
    def process_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def process_version(self, value: pulumi.Input[builtins.str]):
    ...
    def rosetta_net_process_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rosetta_net_process_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 process_code: Optional[pulumi.Input[builtins.str]] = None,
                 process_name: Optional[pulumi.Input[builtins.str]] = None,
                 process_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="processCode")
    def process_code(self) -> pulumi.Output[builtins.str]:
        """
        The integration account RosettaNet process code.
        """
        return pulumi.get(self, "process_code")
    ...
    @property
    @pulumi.getter(name="processName")
    def process_name(self) -> pulumi.Output[builtins.str]:
        """
        The integration account RosettaNet process name.
        """
        return pulumi.get(self, "process_name")
    ...
    @property
    @pulumi.getter(name="processVersion")
    def process_version(self) -> pulumi.Output[builtins.str]:
        """
        The integration account RosettaNet process version.
        """
        return pulumi.get(self, "process_version")
