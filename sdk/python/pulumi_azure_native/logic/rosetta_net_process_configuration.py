...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(activity_settings, RosettaNetPipActivitySettingsArgs):
            ...
            if not isinstance(initiator_role_settings, RosettaNetPipRoleSettingsArgs):
            ...
            if not isinstance(responder_role_settings, RosettaNetPipRoleSettingsArgs):
