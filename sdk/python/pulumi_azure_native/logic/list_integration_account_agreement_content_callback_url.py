...
class AwaitableListIntegrationAccountAgreementContentCallbackUrlResult(ListIntegrationAccountAgreementContentCallbackUrlResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListIntegrationAccountAgreementContentCallbackUrlResult(
...
def list_integration_account_agreement_content_callback_url(agreement_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic:listIntegrationAccountAgreementContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAgreementContentCallbackUrlResult).value

    return AwaitableListIntegrationAccountAgreementContentCallbackUrlResult(
...
def list_integration_account_agreement_content_callback_url_output(agreement_name: Optional[pulumi.Input[builtins.str]] = None,
