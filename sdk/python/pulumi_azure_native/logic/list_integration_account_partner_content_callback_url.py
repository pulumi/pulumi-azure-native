...
def list_integration_account_partner_content_callback_url(integration_account_name: Optional[_builtins.str] = None,
                                                          key_type: Optional[Union[_builtins.str, 'KeyType']] = None,
                                                          not_after: Optional[_builtins.str] = None,
                                                          partner_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str partner_name: The integration account partner name.
...
def list_integration_account_partner_content_callback_url_output(integration_account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logic:listIntegrationAccountPartnerContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountPartnerContentCallbackUrlResult)
