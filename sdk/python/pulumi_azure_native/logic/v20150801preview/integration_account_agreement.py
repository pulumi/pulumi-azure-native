...
class IntegrationAccountAgreement(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['BusinessIdentityArgs', 'BusinessIdentityArgsDict']] guest_identity: The guest identity.
        :param pulumi.Input[str] guest_partner: The guest partner.
        :param pulumi.Input[Union['BusinessIdentityArgs', 'BusinessIdentityArgsDict']] host_identity: The host identity.
        :param pulumi.Input[str] host_partner: The host partner.
        :param pulumi.Input[str] id: The resource id.
        :param pulumi.Input[str] integration_account_name: The integration account name.
        :param pulumi.Input[str] location: The resource location.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20160601:Agreement"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountAgreement")])
