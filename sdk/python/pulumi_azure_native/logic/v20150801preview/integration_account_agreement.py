...
class IntegrationAccountAgreement(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(content, AgreementContentArgs):
                content = content or {}
                def _setter(key, value):
                    content[key] = value
                AgreementContentArgs._configure(_setter, **content)
            __props__.__dict__["content"] = content
            if not isinstance(guest_identity, BusinessIdentityArgs):
            ...
            if not isinstance(host_identity, BusinessIdentityArgs):
