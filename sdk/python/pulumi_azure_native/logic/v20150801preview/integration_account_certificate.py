...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import azure-native:logic/v20150801preview:IntegrationAccountCertificate myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/certificates/{certificateName} 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountCertificate")])
