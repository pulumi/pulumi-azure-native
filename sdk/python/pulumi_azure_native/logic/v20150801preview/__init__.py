...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:logic/v20150801preview:IntegrationAccount":
                return IntegrationAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20150801preview:IntegrationAccountAgreement":
                return IntegrationAccountAgreement(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20150801preview:IntegrationAccountCertificate":
                return IntegrationAccountCertificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20150801preview:IntegrationAccountMap":
                return IntegrationAccountMap(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20150801preview:IntegrationAccountPartner":
                return IntegrationAccountPartner(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20150801preview:IntegrationAccountSchema":
    ...
    pulumi.runtime.register_resource_module("azure-native", "logic/v20150801preview", _module_instance)
