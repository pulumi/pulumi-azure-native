...
class WorkflowArgs:
    ...
    def _configure(
        ...
        if definition_link is None and 'definitionLink' in kwargs:
            definition_link = kwargs['definitionLink']
...
class Workflow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            definition_link = _utilities.configure(definition_link, ContentLinkArgs, True)
            __props__.__dict__["definition_link"] = definition_link
            __props__.__dict__["id"] = id
            __props__.__dict__["location"] = location
            __props__.__dict__["name"] = name
            __props__.__dict__["parameters"] = parameters
            parameters_link = _utilities.configure(parameters_link, ContentLinkArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:Workflow"), pulumi.Alias(type_="azure-native:logic/v20160601:Workflow"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Workflow"), pulumi.Alias(type_="azure-native:logic/v20190501:Workflow")])
