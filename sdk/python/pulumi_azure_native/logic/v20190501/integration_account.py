...
class IntegrationAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(integration_service_environment, ResourceReferenceArgs):
            ...
            if not isinstance(sku, IntegrationAccountSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                IntegrationAccountSkuArgs._configure(_setter, **sku)
