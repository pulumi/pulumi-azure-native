...
class IntegrationAccountMap(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        integration_account_map = azure_native.logic.v20190501.IntegrationAccountMap("integrationAccountMap",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountMap")])
