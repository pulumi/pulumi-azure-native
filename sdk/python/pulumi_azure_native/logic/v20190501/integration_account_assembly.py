...
class IntegrationAccountAssemblyArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['AssemblyPropertiesArgs']] = None,
        ...
        if assembly_artifact_name is None and 'assemblyArtifactName' in kwargs:
            assembly_artifact_name = kwargs['assemblyArtifactName']

        _setter("integration_account_name", integration_account_name)
        _setter("properties", properties)
        _setter("resource_group_name", resource_group_name)
        if assembly_artifact_name is not None:
            _setter("assembly_artifact_name", assembly_artifact_name)
...
class IntegrationAccountAssembly(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, AssemblyPropertiesArgs, True)
