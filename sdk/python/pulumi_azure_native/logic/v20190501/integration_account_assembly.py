...
class IntegrationAccountAssemblyArgs:
    ...
    def _configure(
        ...
        if 'assemblyArtifactName' in kwargs:
...
class IntegrationAccountAssembly(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, AssemblyPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                AssemblyPropertiesArgs._configure(_setter, **properties)
