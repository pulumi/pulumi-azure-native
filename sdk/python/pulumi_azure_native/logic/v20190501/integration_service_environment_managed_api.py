...
class IntegrationServiceEnvironmentManagedApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        integration_service_environment_managed_api = azure_native.logic.v20190501.IntegrationServiceEnvironmentManagedApi("integrationServiceEnvironmentManagedApi",
            api_name="servicebus",
