...
class IntegrationServiceEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, IntegrationServiceEnvironmentPropertiesArgs, True)
            __props__.__dict__["properties"] = properties
            if resource_group is None and not opts.urn:
                raise TypeError("Missing required property 'resource_group'")
            __props__.__dict__["resource_group"] = resource_group
            sku = _utilities.configure(sku, IntegrationServiceEnvironmentSkuArgs, True)
