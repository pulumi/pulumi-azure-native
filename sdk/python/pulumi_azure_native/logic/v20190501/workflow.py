...
class WorkflowArgs:
    ...
    def _configure(
        ...
        if integration_account is None and 'integrationAccount' in kwargs:
...
class Workflow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            access_control = _utilities.configure(access_control, FlowAccessControlConfigurationArgs, True)
            __props__.__dict__["access_control"] = access_control
            __props__.__dict__["definition"] = definition
            endpoints_configuration = _utilities.configure(endpoints_configuration, FlowEndpointsConfigurationArgs, True)
            ...
            integration_account = _utilities.configure(integration_account, ResourceReferenceArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:Workflow"), pulumi.Alias(type_="azure-native:logic/v20150201preview:Workflow"), pulumi.Alias(type_="azure-native:logic/v20160601:Workflow"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Workflow")])
