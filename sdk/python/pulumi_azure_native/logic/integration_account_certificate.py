...
class IntegrationAccountCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_name: The integration account certificate name.
        ...
        :param pulumi.Input[builtins.str] public_certificate: The public certificate.
...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="publicCertificate")
    def public_certificate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The public certificate.
        """
        return pulumi.get(self, "public_certificate")
