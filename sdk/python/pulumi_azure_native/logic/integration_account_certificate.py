...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20160601:Certificate"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native_logic_v20150801preview:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native_logic_v20160601:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native_logic_v20180701preview:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native_logic_v20190501:logic:IntegrationAccountCertificate")])
