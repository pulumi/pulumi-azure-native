...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getWorkflow'.""", DeprecationWarning)
...
def get_workflow(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workflow is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getWorkflow'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult).value
