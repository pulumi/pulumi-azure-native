...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountPartner'.""", DeprecationWarning)
...
def get_integration_account_partner(integration_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_partner is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountPartner'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getIntegrationAccountPartner', __args__, opts=opts, typ=GetIntegrationAccountPartnerResult).value
