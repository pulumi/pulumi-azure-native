...
class IntegrationServiceEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationServiceEnvironment")])
