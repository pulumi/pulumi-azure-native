...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:logic:IntegrationServiceEnvironment'.""", DeprecationWarning)
...
class IntegrationServiceEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-native:logic:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationServiceEnvironment"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationServiceEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationServiceEnvironment, __self__).__init__(
            'azure-native:logic/latest:IntegrationServiceEnvironment',
            resource_name,
            __props__,
            opts)
