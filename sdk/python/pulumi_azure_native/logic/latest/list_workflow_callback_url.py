...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listWorkflowCallbackUrl'.""", DeprecationWarning)
...
def list_workflow_callback_url(key_type: Optional[Union[str, 'KeyType']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listWorkflowCallbackUrl', __args__, opts=opts, typ=ListWorkflowCallbackUrlResult).value
