...
class RosettaNetProcessConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/latest:RosettaNetProcessConfiguration"), pulumi.Alias(type_="azure-native:logic:RosettaNetProcessConfiguration"), pulumi.Alias(type_="azure-nextgen:logic:RosettaNetProcessConfiguration"), pulumi.Alias(type_="azure-native:logic/v20160601:RosettaNetProcessConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:RosettaNetProcessConfiguration")])
