...
class IntegrationAccountBatchConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logic:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountBatchConfiguration"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountBatchConfiguration")])
