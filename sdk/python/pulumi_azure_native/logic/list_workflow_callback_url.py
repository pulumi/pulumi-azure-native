...
def list_workflow_callback_url(key_type: Optional[Union[_builtins.str, 'KeyType']] = None,
...
def list_workflow_callback_url_output(key_type: Optional[pulumi.Input[Optional[Union[_builtins.str, 'KeyType']]]] = None,
