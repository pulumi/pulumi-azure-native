...
def get_integration_account(integration_account_name: Optional[builtins.str] = None,
...
def get_integration_account_output(integration_account_name: Optional[pulumi.Input[builtins.str]] = None,
