...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datadog:getMonitor'.""", DeprecationWarning)
...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitor is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datadog:getMonitor'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/latest:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value
