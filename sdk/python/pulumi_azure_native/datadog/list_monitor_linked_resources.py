...
def list_monitor_linked_resources(monitor_name: Optional[_builtins.str] = None,
...
def list_monitor_linked_resources_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog:listMonitorLinkedResources', __args__, opts=opts, typ=ListMonitorLinkedResourcesResult)
