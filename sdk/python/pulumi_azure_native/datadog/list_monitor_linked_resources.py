...
def list_monitor_linked_resources(monitor_name: Optional[builtins.str] = None,
...
def list_monitor_linked_resources_output(monitor_name: Optional[pulumi.Input[builtins.str]] = None,
