...
class DatadogApiKeyResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: The value of the API key.
        :param _builtins.str created: The time of creation of the API key.
        :param _builtins.str created_by: The user that created the API key.
        :param _builtins.str name: The name of the API key.
        """
...
class DatadogHostResponse(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] aliases: The aliases for the host installed via the Datadog agent.
        :param Sequence[_builtins.str] apps: The Datadog integrations reporting metrics for the host.
        :param _builtins.str name: The name of the host.
        """
...
class DatadogInstallMethodResponse(dict):
    def __init__(__self__, *,
                 installer_version: Optional[_builtins.str] = None,
                 tool: Optional[_builtins.str] = None,
                 tool_version: Optional[_builtins.str] = None):
        """
        :param _builtins.str installer_version: The installer version.
        :param _builtins.str tool: The tool.
        :param _builtins.str tool_version: The tool version.
        """
...
class DatadogLogsAgentResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str transport: The transport.
        """
...
class DatadogOrganizationPropertiesResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 cspm: Optional[_builtins.bool] = None,
...
class LogRulesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 send_resource_logs: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool send_subscription_logs: Flag specifying if Azure subscription logs should be sent for the Monitor resource.
        """
...
class MarketplaceSaaSInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 marketplace_subscription_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str marketplace_subscription_id: Marketplace Subscription Id. This is a GUID-formatted string.
...
class MonitoredResourceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reason_for_metrics_status: Optional[_builtins.str] = None,
                 sending_logs: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool sending_logs: Flag indicating if resource is sending logs to Datadog.
        :param _builtins.bool sending_metrics: Flag indicating if resource is sending metrics to Datadog.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class MonitoringTagRulesPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 provisioning_state: _builtins.str,
                 automuting: Optional[_builtins.bool] = None,
                 custom_metrics: Optional[_builtins.bool] = None,
...
class ResourceSkuResponse(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: Name of the SKU in {PlanId} format. For Terraform, the only allowed value is 'Linked'.
        """
        pulumi.set(__self__, "name", name)
