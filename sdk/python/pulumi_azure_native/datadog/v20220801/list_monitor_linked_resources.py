...
def list_monitor_linked_resources(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20220801:listMonitorLinkedResources', __args__, opts=opts, typ=ListMonitorLinkedResourcesResult).value
...
@_utilities.lift_output_func(list_monitor_linked_resources)
