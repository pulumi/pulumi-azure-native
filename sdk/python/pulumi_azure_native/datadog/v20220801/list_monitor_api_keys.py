...
def list_monitor_api_keys(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20220801:listMonitorApiKeys', __args__, opts=opts, typ=ListMonitorApiKeysResult).value
...
def list_monitor_api_keys_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20220801:listMonitorApiKeys', __args__, opts=opts, typ=ListMonitorApiKeysResult)
