...
class DatadogHostMetadataResponse(dict):
    ...
    def _configure(
        ...
        if install_method is None and 'installMethod' in kwargs:
            install_method = kwargs['installMethod']
        if logs_agent is None and 'logsAgent' in kwargs:
...
class DatadogInstallMethodResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if installer_version is None and 'installerVersion' in kwargs:
            installer_version = kwargs['installerVersion']
        if tool_version is None and 'toolVersion' in kwargs:
...
class MonitorPropertiesResponse(dict):
    ...
    def _configure(
        ...
        if marketplace_subscription_status is None:
            raise TypeError("Missing 'marketplace_subscription_status' argument")
...
class MonitoredResourceResponse(dict):
    ...
    def _configure(
        ...
        if reason_for_metrics_status is None and 'reasonForMetricsStatus' in kwargs:
        ...
        if sending_metrics is None and 'sendingMetrics' in kwargs:
