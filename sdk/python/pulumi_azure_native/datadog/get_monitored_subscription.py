...
def get_monitored_subscription(configuration_name: Optional[_builtins.str] = None,
...
def get_monitored_subscription_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
