...
def list_monitor_hosts(monitor_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog:listMonitorHosts', __args__, opts=opts, typ=ListMonitorHostsResult).value

    return AwaitableListMonitorHostsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_monitor_hosts_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
