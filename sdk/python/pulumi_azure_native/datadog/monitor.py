...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datadog/v20200201preview:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20210301:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20220601:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20220801:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20230101:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20230707:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20231020:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20240301:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20250107:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20250611:Monitor"), pulumi.Alias(type_="azure-native:datadog/v20251103preview:Monitor")])
