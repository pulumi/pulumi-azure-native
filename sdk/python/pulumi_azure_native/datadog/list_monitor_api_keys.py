...
def list_monitor_api_keys(monitor_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog:listMonitorApiKeys', __args__, opts=opts, typ=ListMonitorApiKeysResult).value

    return AwaitableListMonitorApiKeysResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_monitor_api_keys_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog:listMonitorApiKeys', __args__, opts=opts, typ=ListMonitorApiKeysResult)
