...
def list_monitor_api_keys(monitor_name: Optional[builtins.str] = None,
...
def list_monitor_api_keys_output(monitor_name: Optional[pulumi.Input[builtins.str]] = None,
