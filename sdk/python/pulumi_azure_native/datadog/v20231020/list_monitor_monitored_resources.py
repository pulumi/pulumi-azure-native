...
def list_monitor_monitored_resources(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:listMonitorMonitoredResources', __args__, opts=opts, typ=ListMonitorMonitoredResourcesResult).value
...
def list_monitor_monitored_resources_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:listMonitorMonitoredResources', __args__, opts=opts, typ=ListMonitorMonitoredResourcesResult)
