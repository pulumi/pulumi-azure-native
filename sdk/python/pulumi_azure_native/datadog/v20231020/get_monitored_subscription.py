...
def get_monitored_subscription(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:getMonitoredSubscription', __args__, opts=opts, typ=GetMonitoredSubscriptionResult).value
...
def get_monitored_subscription_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:getMonitoredSubscription', __args__, opts=opts, typ=GetMonitoredSubscriptionResult)
