...
def get_monitor_default_key(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:getMonitorDefaultKey', __args__, opts=opts, typ=GetMonitorDefaultKeyResult).value
...
def get_monitor_default_key_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:getMonitorDefaultKey', __args__, opts=opts, typ=GetMonitorDefaultKeyResult)
