...
def get_billing_info(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:getBillingInfo', __args__, opts=opts, typ=GetBillingInfoResult).value
...
def get_billing_info_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:getBillingInfo', __args__, opts=opts, typ=GetBillingInfoResult)
