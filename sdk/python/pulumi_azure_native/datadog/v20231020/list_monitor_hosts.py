...
def list_monitor_hosts(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:listMonitorHosts', __args__, opts=opts, typ=ListMonitorHostsResult).value
...
def list_monitor_hosts_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:listMonitorHosts', __args__, opts=opts, typ=ListMonitorHostsResult)
