...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20231020:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value
...
def get_monitor_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datadog/v20231020:getMonitor', __args__, opts=opts, typ=GetMonitorResult)
