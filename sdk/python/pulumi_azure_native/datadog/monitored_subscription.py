...
class MonitoredSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datadog/v20230101:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20230707:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20231020:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20240301:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20250107:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20250611:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20251103preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:datadog/v20251226preview:MonitoredSubscription")])
