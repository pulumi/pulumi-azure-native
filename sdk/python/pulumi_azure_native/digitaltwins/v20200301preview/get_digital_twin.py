...
def get_digital_twin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_digital_twin is deprecated: Version v20200301preview will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
