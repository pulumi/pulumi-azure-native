...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        digital_twins_endpoint = azure_native.digitaltwins.v20201201.DigitalTwinsEndpoint("digitalTwinsEndpoint",
            endpoint_name="myServiceBus",
            properties=azure_native.digitaltwins.v20201201.ServiceBusArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint")])
