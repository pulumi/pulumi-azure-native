...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.digitaltwins.v20201201.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="myPrivateConnection",
            properties=azure_native.digitaltwins.v20201201.PrivateEndpointConnectionResponsePropertiesArgs(
                private_link_service_connection_state=azure_native.digitaltwins.v20201201.ConnectionPropertiesPrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20210630preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20220531:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:digitaltwins/v20201201:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
