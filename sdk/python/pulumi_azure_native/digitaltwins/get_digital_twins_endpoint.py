...
def get_digital_twins_endpoint(endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint_name: Name of Endpoint Resource.
    :param _builtins.str resource_group_name: The name of the resource group that contains the DigitalTwinsInstance.
    :param _builtins.str resource_name: The name of the DigitalTwinsInstance.
    """
    __args__ = dict()
...
def get_digital_twins_endpoint_output(endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:digitaltwins:getDigitalTwinsEndpoint', __args__, opts=opts, typ=GetDigitalTwinsEndpointResult)
