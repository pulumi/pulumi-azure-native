...
def get_digital_twins_endpoint(endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_name: Name of Endpoint Resource.
...
def get_digital_twins_endpoint_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
