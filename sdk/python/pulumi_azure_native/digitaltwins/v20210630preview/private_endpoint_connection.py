...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:digitaltwins/v20210630preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20220531:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:digitaltwins/v20210630preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
