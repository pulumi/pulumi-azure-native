...
def get_time_series_database_connection(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_time_series_database_connection is deprecated: azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    __args__['timeSeriesDatabaseConnectionName'] = time_series_database_connection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:digitaltwins/v20210630preview:getTimeSeriesDatabaseConnection', __args__, opts=opts, typ=GetTimeSeriesDatabaseConnectionResult).value
