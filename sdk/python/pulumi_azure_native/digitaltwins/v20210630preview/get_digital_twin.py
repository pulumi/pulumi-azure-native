...
def get_digital_twin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_digital_twin is deprecated: Version v20210630preview will be removed in the next major version of the provider. Upgrade to version v20220531 or later.""")
    __args__ = dict()
