...
def get_digital_twin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_digital_twin is deprecated: azure-native:digitaltwins/v20210630preview:DigitalTwin is being removed in the next major version of this provider. Please upgrade to azure-native:digitaltwins/v20230131:DigitalTwin to guarantee forwards compatibility.""")
    __args__ = dict()
