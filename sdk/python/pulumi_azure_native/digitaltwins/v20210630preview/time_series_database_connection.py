...
warnings.warn("""azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection to guarantee forwards compatibility.""", DeprecationWarning)
