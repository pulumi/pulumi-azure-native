...
class TimeSeriesDatabaseConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:TimeSeriesDatabaseConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection")])
