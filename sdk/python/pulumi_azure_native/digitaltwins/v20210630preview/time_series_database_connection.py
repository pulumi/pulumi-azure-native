...
class TimeSeriesDatabaseConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        time_series_database_connection = azure_native.digitaltwins.v20210630preview.TimeSeriesDatabaseConnection("timeSeriesDatabaseConnection",
            properties=azure_native.digitaltwins.v20210630preview.AzureDataExplorerConnectionPropertiesResponseArgs(
