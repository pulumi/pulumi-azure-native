...
def get_digital_twins_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:digitaltwins/v20210630preview:getDigitalTwinsEndpoint', __args__, opts=opts, typ=GetDigitalTwinsEndpointResult)
    return __ret__.apply(lambda __response__: GetDigitalTwinsEndpointResult(
