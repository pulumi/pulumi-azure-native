...
class DigitalTwinArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group that contains the DigitalTwinsInstance.
        ...
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Public network access for the DigitalTwinsInstance.
        :param pulumi.Input[builtins.str] resource_name: The name of the DigitalTwinsInstance.
...
class DigitalTwin(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Public network access for the DigitalTwinsInstance.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group that contains the DigitalTwinsInstance.
        :param pulumi.Input[builtins.str] resource_name_: The name of the DigitalTwinsInstance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The resource tags.
        """
        ...
    @overload
