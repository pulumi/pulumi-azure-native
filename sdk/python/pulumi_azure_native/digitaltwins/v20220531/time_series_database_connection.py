...
warnings.warn("""azure-native:digitaltwins/v20220531:TimeSeriesDatabaseConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class TimeSeriesDatabaseConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:TimeSeriesDatabaseConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20210630preview:TimeSeriesDatabaseConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:TimeSeriesDatabaseConnection"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:TimeSeriesDatabaseConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TimeSeriesDatabaseConnection, __self__).__init__(
            'azure-native:digitaltwins/v20220531:TimeSeriesDatabaseConnection',
            resource_name,
            __props__,
            opts)
