...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DigitalTwinsEndpoint is deprecated: azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint to guarantee forwards compatibility.""")
