...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DigitalTwinsEndpoint is deprecated: azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DigitalTwinsEndpoint, __self__).__init__(
            'azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint',
            resource_name,
            __props__,
            opts)
