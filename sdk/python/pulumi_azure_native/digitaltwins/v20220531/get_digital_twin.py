...
def get_digital_twin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_digital_twin is deprecated: azure-native:digitaltwins/v20220531:DigitalTwin is being removed in the next major version of this provider. Upgrade to at least azure-native:digitaltwins/v20230131:DigitalTwin to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:digitaltwins/v20220531:getDigitalTwin', __args__, opts=opts, typ=GetDigitalTwinResult).value
