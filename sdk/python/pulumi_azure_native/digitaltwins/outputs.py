...
class AzureDataExplorerConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 adx_database_name: builtins.str,
                 adx_endpoint_uri: builtins.str,
                 adx_resource_id: builtins.str,
                 connection_type: builtins.str,
                 event_hub_endpoint_uri: builtins.str,
                 event_hub_entity_path: builtins.str,
                 event_hub_namespace_resource_id: builtins.str,
                 provisioning_state: builtins.str,
                 adx_relationship_lifecycle_events_table_name: Optional[builtins.str] = None,
                 adx_table_name: Optional[builtins.str] = None,
                 adx_twin_lifecycle_events_table_name: Optional[builtins.str] = None,
                 event_hub_consumer_group: Optional[builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityReferenceResponse'] = None,
                 record_property_and_item_removals: Optional[builtins.str] = None):
        """
        Properties of a time series database connection to Azure Data Explorer with data being sent via an EventHub.
        :param builtins.str adx_database_name: The name of the Azure Data Explorer database.
        :param builtins.str adx_endpoint_uri: The URI of the Azure Data Explorer endpoint.
        :param builtins.str adx_resource_id: The resource ID of the Azure Data Explorer cluster.
        :param builtins.str connection_type: The type of time series connection resource.
               Expected value is 'AzureDataExplorer'.
        :param builtins.str event_hub_endpoint_uri: The URL of the EventHub namespace for identity-based authentication. It must include the protocol sb://
        :param builtins.str event_hub_entity_path: The EventHub name in the EventHub namespace for identity-based authentication.
        :param builtins.str event_hub_namespace_resource_id: The resource ID of the EventHub namespace.
        :param builtins.str provisioning_state: The provisioning state.
        :param builtins.str adx_relationship_lifecycle_events_table_name: The name of the Azure Data Explorer table used for recording relationship lifecycle events. The table will not be created if this property is left unspecified.
        :param builtins.str adx_table_name: The name of the Azure Data Explorer table used for storing updates to properties of twins and relationships. Defaults to AdtPropertyEvents.
        :param builtins.str adx_twin_lifecycle_events_table_name: The name of the Azure Data Explorer table used for recording twin lifecycle events. The table will not be created if this property is left unspecified.
        :param builtins.str event_hub_consumer_group: The EventHub consumer group to use when ADX reads from EventHub. Defaults to $Default.
    ...
    def adx_database_name(self) -> builtins.str:
        """
    ...
    def adx_endpoint_uri(self) -> builtins.str:
        """
    ...
    def adx_resource_id(self) -> builtins.str:
        """
    ...
    def event_hub_endpoint_uri(self) -> builtins.str:
        """
    ...
    def event_hub_entity_path(self) -> builtins.str:
        """
    ...
    def event_hub_namespace_resource_id(self) -> builtins.str:
        """
    ...
    def adx_relationship_lifecycle_events_table_name(self) -> Optional[builtins.str]:
        """
    ...
    def adx_table_name(self) -> Optional[builtins.str]:
        """
    ...
    def adx_twin_lifecycle_events_table_name(self) -> Optional[builtins.str]:
        """
    ...
    def event_hub_consumer_group(self) -> Optional[builtins.str]:
        """
    ...
    def record_property_and_item_removals(self) -> Optional[builtins.str]:
        """
        Specifies whether or not to record twin / relationship property and item removals, including removals of indexed or keyed values (such as map entries, array elements, etc.). This feature is de-activated unless explicitly set to 'true'. Setting this property to 'true' will generate an additional column in the property events table in ADX.
        """
...
class ConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        The properties of a private endpoint connection.
        :param builtins.str provisioning_state: The provisioning state.
        :param Sequence[builtins.str] group_ids: The list of group ids for the private endpoint connection.
...
class DigitalTwinsIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of Managed Identity used by the DigitalTwinsInstance.
...
class EventGridResponse(dict):
    ...
    def __init__(__self__, *,
                 access_key1: builtins.str,
                 created_time: builtins.str,
                 endpoint_type: builtins.str,
                 provisioning_state: builtins.str,
                 topic_endpoint: builtins.str,
                 access_key2: Optional[builtins.str] = None,
                 authentication_type: Optional[builtins.str] = None,
                 dead_letter_secret: Optional[builtins.str] = None,
                 dead_letter_uri: Optional[builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityReferenceResponse'] = None):
        """
        Properties related to EventGrid.
        :param builtins.str access_key1: EventGrid secondary accesskey. Will be obfuscated during read.
        :param builtins.str created_time: Time when the Endpoint was added to DigitalTwinsInstance.
        :param builtins.str endpoint_type: The type of Digital Twins endpoint
               Expected value is 'EventGrid'.
        :param builtins.str provisioning_state: The provisioning state.
        :param builtins.str topic_endpoint: EventGrid Topic Endpoint.
        :param builtins.str access_key2: EventGrid secondary accesskey. Will be obfuscated during read.
        :param builtins.str authentication_type: Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified.
        :param builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
    ...
    def access_key1(self) -> builtins.str:
        """
    ...
    def topic_endpoint(self) -> builtins.str:
        """
    ...
    def access_key2(self) -> Optional[builtins.str]:
        """
        EventGrid secondary accesskey. Will be obfuscated during read.
        """
    ...
    def dead_letter_secret(self) -> Optional[builtins.str]:
        """
    ...
    def dead_letter_uri(self) -> Optional[builtins.str]:
        """
...
class EventHubResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: builtins.str,
                 authentication_type: Optional[builtins.str] = None,
                 connection_string_primary_key: Optional[builtins.str] = None,
                 connection_string_secondary_key: Optional[builtins.str] = None,
                 dead_letter_secret: Optional[builtins.str] = None,
                 dead_letter_uri: Optional[builtins.str] = None,
        ...
        :param builtins.str provisioning_state: The provisioning state.
        :param builtins.str authentication_type: Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified.
        :param builtins.str connection_string_primary_key: PrimaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param builtins.str connection_string_secondary_key: SecondaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
        :param builtins.str endpoint_uri: The URL of the EventHub namespace for identity-based authentication. It must include the protocol 'sb://'.
        :param builtins.str entity_path: The EventHub name in the EventHub namespace for identity-based authentication.
        :param 'ManagedIdentityReferenceResponse' identity: Managed identity properties for the endpoint.
        """
        pulumi.set(__self__, "created_time", created_time)
    ...
    def connection_string_primary_key(self) -> Optional[builtins.str]:
        """
    ...
    def connection_string_secondary_key(self) -> Optional[builtins.str]:
        """
...
class ManagedIdentityReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of the Managed Identity.
        :param builtins.str type: The type of managed identity used.
        :param builtins.str user_assigned_identity: The user identity ARM resource id if the managed identity type is 'UserAssigned'.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class ServiceBusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 entity_path: Optional[builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityReferenceResponse'] = None,
                 primary_connection_string: Optional[builtins.str] = None,
                 secondary_connection_string: Optional[builtins.str] = None):
        """
        Properties related to ServiceBus.
        :param builtins.str created_time: Time when the Endpoint was added to DigitalTwinsInstance.
        :param builtins.str endpoint_type: The type of Digital Twins endpoint
        ...
        :param builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
        :param builtins.str endpoint_uri: The URL of the ServiceBus namespace for identity-based authentication. It must include the protocol 'sb://'.
        :param builtins.str entity_path: The ServiceBus Topic name for identity-based authentication.
        :param 'ManagedIdentityReferenceResponse' identity: Managed identity properties for the endpoint.
        :param builtins.str primary_connection_string: PrimaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param builtins.str secondary_connection_string: SecondaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        """
        pulumi.set(__self__, "created_time", created_time)
...
class UserAssignedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The information about the user assigned identity.
        :param builtins.str client_id: The client id of the User Assigned Identity Resource.
        :param builtins.str principal_id: The object id of the User Assigned Identity Resource.
        """
