...
class AzureDataExplorerConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 adx_relationship_lifecycle_events_table_name: Optional[_builtins.str] = None,
                 adx_table_name: Optional[_builtins.str] = None,
                 adx_twin_lifecycle_events_table_name: Optional[_builtins.str] = None,
                 event_hub_consumer_group: Optional[_builtins.str] = None,
        ...
        :param _builtins.str connection_type: The type of time series connection resource.
               Expected value is 'AzureDataExplorer'.
        :param _builtins.str event_hub_endpoint_uri: The URL of the EventHub namespace for identity-based authentication. It must include the protocol sb://
        :param _builtins.str event_hub_entity_path: The EventHub name in the EventHub namespace for identity-based authentication.
        :param _builtins.str event_hub_namespace_resource_id: The resource ID of the EventHub namespace.
        :param _builtins.str provisioning_state: The provisioning state.
        :param _builtins.str adx_relationship_lifecycle_events_table_name: The name of the Azure Data Explorer table used for recording relationship lifecycle events. The table will not be created if this property is left unspecified.
        :param _builtins.str adx_table_name: The name of the Azure Data Explorer table used for storing updates to properties of twins and relationships. Defaults to AdtPropertyEvents.
        :param _builtins.str adx_twin_lifecycle_events_table_name: The name of the Azure Data Explorer table used for recording twin lifecycle events. The table will not be created if this property is left unspecified.
        :param _builtins.str event_hub_consumer_group: The EventHub consumer group to use when ADX reads from EventHub. Defaults to $Default.
    ...
    def adx_relationship_lifecycle_events_table_name(self) -> Optional[_builtins.str]:
        """
...
class EventGridResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 access_key2: Optional[_builtins.str] = None,
                 authentication_type: Optional[_builtins.str] = None,
                 dead_letter_secret: Optional[_builtins.str] = None,
                 dead_letter_uri: Optional[_builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityReferenceResponse'] = None):
        """
        Properties related to EventGrid.
        ...
        :param _builtins.str provisioning_state: The provisioning state.
        :param _builtins.str topic_endpoint: EventGrid Topic Endpoint.
        :param _builtins.str access_key2: EventGrid secondary accesskey. Will be obfuscated during read.
        :param _builtins.str authentication_type: Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified.
        :param _builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param _builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
...
class EventHubResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: _builtins.str,
                 authentication_type: Optional[_builtins.str] = None,
                 connection_string_primary_key: Optional[_builtins.str] = None,
                 connection_string_secondary_key: Optional[_builtins.str] = None,
                 dead_letter_secret: Optional[_builtins.str] = None,
                 dead_letter_uri: Optional[_builtins.str] = None,
        ...
        :param _builtins.str provisioning_state: The provisioning state.
        :param _builtins.str authentication_type: Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified.
        :param _builtins.str connection_string_primary_key: PrimaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param _builtins.str connection_string_secondary_key: SecondaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param _builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param _builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
        :param _builtins.str endpoint_uri: The URL of the EventHub namespace for identity-based authentication. It must include the protocol 'sb://'.
        :param _builtins.str entity_path: The EventHub name in the EventHub namespace for identity-based authentication.
        :param 'ManagedIdentityReferenceResponse' identity: Managed identity properties for the endpoint.
        """
        pulumi.set(__self__, "created_time", created_time)
...
class ServiceBusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 entity_path: Optional[_builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityReferenceResponse'] = None,
                 primary_connection_string: Optional[_builtins.str] = None,
        ...
        :param _builtins.str dead_letter_secret: Dead letter storage secret for key-based authentication. Will be obfuscated during read.
        :param _builtins.str dead_letter_uri: Dead letter storage URL for identity-based authentication.
        :param _builtins.str endpoint_uri: The URL of the ServiceBus namespace for identity-based authentication. It must include the protocol 'sb://'.
        :param _builtins.str entity_path: The ServiceBus Topic name for identity-based authentication.
        :param 'ManagedIdentityReferenceResponse' identity: Managed identity properties for the endpoint.
        :param _builtins.str primary_connection_string: PrimaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        :param _builtins.str secondary_connection_string: SecondaryConnectionString of the endpoint for key-based authentication. Will be obfuscated during read.
        """
        pulumi.set(__self__, "created_time", created_time)
