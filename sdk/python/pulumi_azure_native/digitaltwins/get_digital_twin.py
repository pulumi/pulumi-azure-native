...
def get_digital_twin(resource_group_name: Optional[_builtins.str] = None,
...
def get_digital_twin_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
