...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins/latest:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-nextgen:digitaltwins/latest:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-nextgen:digitaltwins/v20200301preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-nextgen:digitaltwins/v20201031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-nextgen:digitaltwins/v20201201:DigitalTwinsEndpoint")])
