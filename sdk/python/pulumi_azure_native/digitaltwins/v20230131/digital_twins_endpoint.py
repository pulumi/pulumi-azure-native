...
class DigitalTwinsEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 endpoint_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union[Union['EventGridArgs', 'EventGridArgsDict'], Union['EventHubArgs', 'EventHubArgsDict'], Union['ServiceBusArgs', 'ServiceBusArgsDict']]]] = None,
        ...
        :param pulumi.Input[str] endpoint_name: Name of Endpoint Resource.
        :param pulumi.Input[Union[Union['EventGridArgs', 'EventGridArgsDict'], Union['EventHubArgs', 'EventHubArgsDict'], Union['ServiceBusArgs', 'ServiceBusArgsDict']]] properties: DigitalTwinsInstance endpoint resource properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the DigitalTwinsInstance.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint"), pulumi.Alias(type_="azure-native:digitaltwins:DigitalTwinsEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DigitalTwinsEndpoint, __self__).__init__(
            'azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint',
            resource_name,
            __props__,
            opts)
