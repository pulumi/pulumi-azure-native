...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:digitaltwins:getDigitalTwin'.""", DeprecationWarning)
...
def get_digital_twin(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_digital_twin is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:digitaltwins:getDigitalTwin'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:digitaltwins/latest:getDigitalTwin', __args__, opts=opts, typ=GetDigitalTwinResult).value
