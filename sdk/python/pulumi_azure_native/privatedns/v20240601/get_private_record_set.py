...
def get_private_record_set(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:privatedns/v20240601:getPrivateRecordSet', __args__, opts=opts, typ=GetPrivateRecordSetResult).value
...
def get_private_record_set_output(private_zone_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:privatedns/v20240601:getPrivateRecordSet', __args__, opts=opts, typ=GetPrivateRecordSetResult)
