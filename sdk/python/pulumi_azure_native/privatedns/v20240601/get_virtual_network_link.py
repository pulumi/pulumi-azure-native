...
def get_virtual_network_link(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:privatedns/v20240601:getVirtualNetworkLink', __args__, opts=opts, typ=GetVirtualNetworkLinkResult).value
...
def get_virtual_network_link_output(private_zone_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:privatedns/v20240601:getVirtualNetworkLink', __args__, opts=opts, typ=GetVirtualNetworkLinkResult)
