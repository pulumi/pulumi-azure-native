...
class PrivateZone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240601:PrivateZone"), pulumi.Alias(type_="azure-native:privatedns:PrivateZone"), pulumi.Alias(type_="azure-native:network:PrivateZone"), pulumi.Alias(type_="azure-native:privatedns/v20180901:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20180901:PrivateZone"), pulumi.Alias(type_="azure-native:privatedns/v20200101:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20200101:PrivateZone"), pulumi.Alias(type_="azure-native:privatedns/v20200601:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20200601:PrivateZone")])
