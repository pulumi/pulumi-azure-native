...
class PrivateRecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240601:PrivateRecordSet"), pulumi.Alias(type_="azure-native:privatedns:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network:PrivateRecordSet"), pulumi.Alias(type_="azure-native:privatedns/v20180901:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network/v20180901:PrivateRecordSet"), pulumi.Alias(type_="azure-native:privatedns/v20200101:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network/v20200101:PrivateRecordSet"), pulumi.Alias(type_="azure-native:privatedns/v20200601:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network/v20200601:PrivateRecordSet")])
