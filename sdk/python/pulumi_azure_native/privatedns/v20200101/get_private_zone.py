...
def get_private_zone(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:privatedns/v20200101:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult).value
...
def get_private_zone_output(private_zone_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:privatedns/v20200101:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult)
