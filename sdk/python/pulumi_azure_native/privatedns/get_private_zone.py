...
def get_private_zone(private_zone_name: Optional[_builtins.str] = None,
...
def get_private_zone_output(private_zone_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
