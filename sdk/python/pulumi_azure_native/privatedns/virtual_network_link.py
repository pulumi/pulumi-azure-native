...
class VirtualNetworkLinkArgs:
    def __init__(__self__, *,
                 private_zone_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 registration_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 resolution_policy: Optional[pulumi.Input[Union[builtins.str, 'ResolutionPolicy']]] = None,
    ...
    def private_zone_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def private_zone_name(self, value: pulumi.Input[builtins.str]):
    ...
    def resolution_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'ResolutionPolicy']]]:
        """
    ...
    def resolution_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'ResolutionPolicy']]]):
...
class VirtualNetworkLink(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:privatedns:VirtualNetworkLink"
    ...
    @property
    @pulumi.getter(name="resolutionPolicy")
    def resolution_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resolution policy on the virtual network link. Only applicable for virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure DNS resolver falls back to public resolution if private dns query resolution results in non-existent domain response.
        """
        return pulumi.get(self, "resolution_policy")
    ...
    def virtual_network_link_state(self) -> pulumi.Output[builtins.str]:
        """
