...
class VirtualNetworkLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:privatedns/v20180901:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20180901:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:privatedns/v20200101:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20200101:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:privatedns/v20200601:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20200601:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:privatedns/v20240601:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20240601:VirtualNetworkLink")])
