...
class PrivateZone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200601:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20240601:PrivateZone"), pulumi.Alias(type_="azure-native:network:PrivateZone"), pulumi.Alias(type_="azure-native_privatedns_v20180901:privatedns:PrivateZone"), pulumi.Alias(type_="azure-native_privatedns_v20200101:privatedns:PrivateZone"), pulumi.Alias(type_="azure-native_privatedns_v20200601:privatedns:PrivateZone"), pulumi.Alias(type_="azure-native_privatedns_v20240601:privatedns:PrivateZone")])
