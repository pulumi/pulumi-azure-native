...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureplaywrightservice:Account"), pulumi.Alias(type_="azure-native:azureplaywrightservice/v20231001preview:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:azureplaywrightservice/v20240201:Account',
            resource_name,
            __props__,
            opts)
