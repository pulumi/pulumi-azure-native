...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureplaywrightservice/v20231001preview:Account"), pulumi.Alias(type_="azure-native:azureplaywrightservice/v20240201preview:Account"), pulumi.Alias(type_="azure-native:azureplaywrightservice/v20240801preview:Account"), pulumi.Alias(type_="azure-native:azureplaywrightservice/v20241201:Account"), pulumi.Alias(type_="azure-native_azureplaywrightservice_v20231001preview:azureplaywrightservice:Account"), pulumi.Alias(type_="azure-native_azureplaywrightservice_v20240201preview:azureplaywrightservice:Account"), pulumi.Alias(type_="azure-native_azureplaywrightservice_v20240801preview:azureplaywrightservice:Account"), pulumi.Alias(type_="azure-native_azureplaywrightservice_v20241201:azureplaywrightservice:Account")])
