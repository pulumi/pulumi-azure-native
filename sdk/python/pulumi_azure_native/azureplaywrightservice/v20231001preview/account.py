...
class AccountArgs:
    ...
    def _configure(
        ...
        if regional_affinity is None and 'regionalAffinity' in kwargs:
            regional_affinity = kwargs['regionalAffinity']
        if scalable_execution is None and 'scalableExecution' in kwargs:
            scalable_execution = kwargs['scalableExecution']
