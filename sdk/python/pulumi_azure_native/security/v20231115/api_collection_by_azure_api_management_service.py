...
class APICollectionByAzureApiManagementServiceArgs:
    def __init__(__self__, *,
        ...
        """
        APICollectionByAzureApiManagementServiceArgs._configure(
...
class APICollectionByAzureApiManagementService(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            APICollectionByAzureApiManagementServiceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:APICollectionByAzureApiManagementService"), pulumi.Alias(type_="azure-native:security/v20221120preview:APICollectionByAzureApiManagementService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(APICollectionByAzureApiManagementService, __self__).__init__(
            'azure-native:security/v20231115:APICollectionByAzureApiManagementService',
            resource_name,
            __props__,
            opts)
