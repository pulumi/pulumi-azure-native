...
class DeviceSecurityGroupArgs:
    ...
    def _configure(
        ...
        if allowlist_rules is None and 'allowlistRules' in kwargs:
            allowlist_rules = kwargs['allowlistRules']
        if denylist_rules is None and 'denylistRules' in kwargs:
            denylist_rules = kwargs['denylistRules']
        if device_security_group_name is None and 'deviceSecurityGroupName' in kwargs:
        ...
        if time_window_rules is None and 'timeWindowRules' in kwargs:
