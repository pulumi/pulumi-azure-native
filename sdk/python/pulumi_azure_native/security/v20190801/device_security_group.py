...
class DeviceSecurityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        device_security_group = azure_native.security.v20190801.DeviceSecurityGroup("deviceSecurityGroup",
            ...
            time_window_rules=[azure_native.security.v20190801.TimeWindowCustomAlertRuleArgs()])
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:DeviceSecurityGroup"), pulumi.Alias(type_="azure-native:security/v20170801preview:DeviceSecurityGroup")])
