...
__all__ = [
    ...
    'DefenderCspmGcpOfferingConfigurationArgsDict',
...
if not MYPY:
    class DefenderCspmGcpOfferingConfigurationArgsDict(TypedDict):
        """
        configuration for Microsoft Defender for Server VM scanning
        """
        exclusion_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[str]]]]
    ...
    DefenderCspmGcpOfferingConfigurationArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class DefenderCspmGcpOfferingVmScannersArgsDict(TypedDict):
        ...
        The Microsoft Defender for Server VM scanning configuration
        """
        configuration: NotRequired[pulumi.Input['DefenderCspmGcpOfferingConfigurationArgsDict']]
        """
        configuration for Microsoft Defender for Server VM scanning
        """
        enabled: NotRequired[pulumi.Input[bool]]
