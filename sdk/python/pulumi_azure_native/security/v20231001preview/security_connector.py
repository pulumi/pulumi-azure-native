...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_data: Optional[pulumi.Input[Union[Union['AwsEnvironmentDataArgs', 'AwsEnvironmentDataArgsDict'], Union['AzureDevOpsScopeEnvironmentDataArgs', 'AzureDevOpsScopeEnvironmentDataArgsDict'], Union['GcpProjectEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgsDict'], Union['GithubScopeEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgsDict'], Union['GitlabScopeEnvironmentDataArgs', 'GitlabScopeEnvironmentDataArgsDict']]]] = None,
                 environment_name: Optional[pulumi.Input[Union[str, 'CloudName']]] = None,
                 hierarchy_identifier: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 offerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorAwsOfferingArgsDict'], Union['CspmMonitorAzureDevOpsOfferingArgs', 'CspmMonitorAzureDevOpsOfferingArgsDict'], Union['CspmMonitorGcpOfferingArgs', 'CspmMonitorGcpOfferingArgsDict'], Union['CspmMonitorGitLabOfferingArgs', 'CspmMonitorGitLabOfferingArgsDict'], Union['CspmMonitorGithubOfferingArgs', 'CspmMonitorGithubOfferingArgsDict'], Union['DefenderCspmAwsOfferingArgs', 'DefenderCspmAwsOfferingArgsDict'], Union['DefenderCspmGcpOfferingArgs', 'DefenderCspmGcpOfferingArgsDict'], Union['DefenderFoDatabasesAwsOfferingArgs', 'DefenderFoDatabasesAwsOfferingArgsDict'], Union['DefenderForContainersAwsOfferingArgs', 'DefenderForContainersAwsOfferingArgsDict'], Union['DefenderForContainersGcpOfferingArgs', 'DefenderForContainersGcpOfferingArgsDict'], Union['DefenderForDatabasesGcpOfferingArgs', 'DefenderForDatabasesGcpOfferingArgsDict'], Union['DefenderForDevOpsAzureDevOpsOfferingArgs', 'DefenderForDevOpsAzureDevOpsOfferingArgsDict'], Union['DefenderForDevOpsGitLabOfferingArgs', 'DefenderForDevOpsGitLabOfferingArgsDict'], Union['DefenderForDevOpsGithubOfferingArgs', 'DefenderForDevOpsGithubOfferingArgsDict'], Union['DefenderForServersAwsOfferingArgs', 'DefenderForServersAwsOfferingArgsDict'], Union['DefenderForServersGcpOfferingArgs', 'DefenderForServersGcpOfferingArgsDict'], Union['InformationProtectionAwsOfferingArgs', 'InformationProtectionAwsOfferingArgsDict']]]]]] = None,
