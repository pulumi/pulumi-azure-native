...
class APICollectionArgs:
    def __init__(__self__, *,
                 ...
                 api_collection_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] api_collection_id: A string representing the apiCollections resource within the Microsoft.Security provider namespace. This string matches the Azure API Management API name.
        """
    ...
    def api_collection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_collection_id(self, value: Optional[pulumi.Input[builtins.str]]):
