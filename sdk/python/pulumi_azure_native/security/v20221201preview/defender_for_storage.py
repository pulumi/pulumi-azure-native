...
class DefenderForStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DefenderForStorageSettingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DefenderForStorageSettingPropertiesArgs']] properties: Defender for Storage resource properties.
        :param pulumi.Input[str] resource_id: The identifier of the resource.
        :param pulumi.Input[str] setting_name: Defender for Storage setting name.
        """
        ...
