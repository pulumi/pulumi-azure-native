...
class Assignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20210801preview:Assignment"), pulumi.Alias(type_="azure-native:security:Assignment"), pulumi.Alias(type_="azure-nextgen:security:Assignment")])
