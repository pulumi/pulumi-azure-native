...
class Assignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(additional_data, AssignmentPropertiesAdditionalDataArgs):
            ...
            if not isinstance(assigned_component, AssignedComponentItemArgs):
            ...
            if not isinstance(assigned_standard, AssignedStandardItemArgs):
