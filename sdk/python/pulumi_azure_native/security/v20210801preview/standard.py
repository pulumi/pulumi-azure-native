...
class Standard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20210801preview:Standard"), pulumi.Alias(type_="azure-native:security:Standard"), pulumi.Alias(type_="azure-nextgen:security:Standard")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Standard, __self__).__init__(
            'azure-native:security/v20210801preview:Standard',
            resource_name,
            __props__,
            opts)
