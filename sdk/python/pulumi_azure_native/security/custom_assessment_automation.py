...
class CustomAssessmentAutomationArgs:
    def __init__(__self__, *,
                 ...
                 compressed_query: Optional[pulumi.Input[builtins.str]] = None,
                 custom_assessment_automation_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 supported_cloud: Optional[pulumi.Input[Union[builtins.str, 'SupportedCloudEnum']]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] compressed_query: Base 64 encoded KQL query representing the assessment automation results required.
        :param pulumi.Input[builtins.str] custom_assessment_automation_name: Name of the Custom Assessment Automation.
        :param pulumi.Input[builtins.str] description: The description to relate to the assessments generated by this assessment automation.
        :param pulumi.Input[builtins.str] display_name: The display name of the assessments generated by this assessment automation.
        :param pulumi.Input[builtins.str] remediation_description: The remediation description to relate to the assessments generated by this assessment automation.
        :param pulumi.Input[Union[builtins.str, 'SeverityEnum']] severity: The severity to relate to the assessments generated by this assessment automation.
        :param pulumi.Input[Union[builtins.str, 'SupportedCloudEnum']] supported_cloud: Relevant cloud for the custom assessment automation.
        """
    ...
    def compressed_query(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compressed_query(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compressed_query", value)

    @property
    @pulumi.getter(name="customAssessmentAutomationName")
    def custom_assessment_automation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_assessment_automation_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def supported_cloud(self) -> Optional[pulumi.Input[Union[builtins.str, 'SupportedCloudEnum']]]:
        """
    ...
    def supported_cloud(self, value: Optional[pulumi.Input[Union[builtins.str, 'SupportedCloudEnum']]]):
...
class CustomAssessmentAutomation(pulumi.CustomResource):
    ...
    def assessment_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="compressedQuery")
    def compressed_query(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="supportedCloud")
    def supported_cloud(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Relevant cloud for the custom assessment automation.
        """
        return pulumi.get(self, "supported_cloud")
