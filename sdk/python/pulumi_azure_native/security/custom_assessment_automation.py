...
class CustomAssessmentAutomation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security/v20210701preview:CustomAssessmentAutomation"), pulumi.Alias(type_="azure-native_security_v20210701preview:security:CustomAssessmentAutomation")])
