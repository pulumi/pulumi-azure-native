...
def list_azure_dev_ops_org_available(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20250301:listAzureDevOpsOrgAvailable', __args__, opts=opts, typ=ListAzureDevOpsOrgAvailableResult).value
...
def list_azure_dev_ops_org_available_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20250301:listAzureDevOpsOrgAvailable', __args__, opts=opts, typ=ListAzureDevOpsOrgAvailableResult)
