...
def list_git_hub_owner_available(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20250301:listGitHubOwnerAvailable', __args__, opts=opts, typ=ListGitHubOwnerAvailableResult).value
...
def list_git_hub_owner_available_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20250301:listGitHubOwnerAvailable', __args__, opts=opts, typ=ListGitHubOwnerAvailableResult)
