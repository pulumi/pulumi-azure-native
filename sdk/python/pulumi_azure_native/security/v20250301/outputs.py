...
__all__ = [
    ...
    'AgentlessConfigurationResponse',
...
@pulumi.output_type
class AgentlessConfigurationResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "agentlessAutoDiscovery":
            suggest = "agentless_auto_discovery"
        elif key == "agentlessEnabled":
            suggest = "agentless_enabled"
        elif key == "inventoryList":
            suggest = "inventory_list"
        elif key == "inventoryListType":
            suggest = "inventory_list_type"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AgentlessConfigurationResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AgentlessConfigurationResponse.__key_warning(key)
    ...
    def __init__(__self__, *,
                 agentless_auto_discovery: Optional[str] = None,
                 agentless_enabled: Optional[str] = None,
                 inventory_list: Optional[Sequence['outputs.InventoryListResponse']] = None,
                 inventory_list_type: Optional[str] = None,
                 scanners: Optional[Sequence[str]] = None):
        """
        Details about Agentless configuration.
        :param str agentless_auto_discovery: AutoDiscovery states.
        :param str agentless_enabled: Agentless Enablement states.
        :param Sequence['InventoryListResponse'] inventory_list: Gets or sets the inventory list for inclusion or exclusion from Agentless.
               Will be ignored if agentless auto-discovery is enabled.
        :param str inventory_list_type: Types for inventory list.
        :param Sequence[str] scanners: Gets or sets the scanners for the connector.
        """
    ...
    def agentless_auto_discovery(self) -> Optional[str]:
        """
    ...
    def agentless_enabled(self) -> Optional[str]:
        """
    ...
    def inventory_list(self) -> Optional[Sequence['outputs.InventoryListResponse']]:
        """
    ...
    def inventory_list_type(self) -> Optional[str]:
        """
    ...
    @property
    @pulumi.getter
    def scanners(self) -> Optional[Sequence[str]]:
        """
...
class DevOpsConfigurationPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "agentlessConfiguration":
            suggest = "agentless_configuration"
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_status_message: str,
                 provisioning_status_update_time_utc: str,
                 agentless_configuration: Optional['outputs.AgentlessConfigurationResponse'] = None,
        ...
        :param str provisioning_status_message: Gets the resource status message.
        :param str provisioning_status_update_time_utc: Gets the time when resource was last checked.
        :param 'AgentlessConfigurationResponse' agentless_configuration: Details about Agentless configuration.
    ...
    def agentless_configuration(self) -> Optional['outputs.AgentlessConfigurationResponse']:
        """
        Details about Agentless configuration.
        """
...
@pulumi.output_type
class InventoryListResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "inventoryKind":
            suggest = "inventory_kind"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in InventoryListResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        InventoryListResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 inventory_kind: Optional[str] = None,
                 value: Optional[str] = None):
        """
        Model for inventory to be included or excluded from Agentless.
        :param str inventory_kind: Types for inventory kind.
        :param str value: Gets or sets the value for inventory type.
        """
    ...
    def inventory_kind(self) -> Optional[str]:
        """
