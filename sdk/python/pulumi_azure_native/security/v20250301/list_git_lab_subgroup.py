...
def list_git_lab_subgroup(group_fq_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20250301:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult).value
...
def list_git_lab_subgroup_output(group_fq_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20250301:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult)
