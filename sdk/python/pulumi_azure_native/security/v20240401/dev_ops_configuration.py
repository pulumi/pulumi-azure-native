...
class DevOpsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:DevOpsConfiguration"), pulumi.Alias(type_="azure-native:security/v20230901preview:DevOpsConfiguration"), pulumi.Alias(type_="azure-native:security/v20240515preview:DevOpsConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DevOpsConfiguration, __self__).__init__(
            'azure-native:security/v20240401:DevOpsConfiguration',
            resource_name,
            __props__,
            opts)
