...
class GetAPICollectionByAzureApiManagementServiceResult:
    ...
    def discovered_via(self) -> builtins.str:
        """
    ...
    def number_of_api_endpoints(self) -> builtins.float:
        """
    ...
    def number_of_api_endpoints_with_sensitive_data_exposed(self) -> builtins.float:
        """
    ...
    def number_of_external_api_endpoints(self) -> builtins.float:
        """
    ...
    def number_of_inactive_api_endpoints(self) -> builtins.float:
        """
    ...
    def number_of_unauthenticated_api_endpoints(self) -> builtins.float:
        """
    ...
    def sensitivity_label(self) -> builtins.str:
        """
...
def get_api_collection_by_azure_api_management_service(api_id: Optional[builtins.str] = None,
    ...
    :param builtins.str api_id: API revision identifier. Must be unique in the API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.
...
def get_api_collection_by_azure_api_management_service_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
