...
class DefenderForStorage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:DefenderForStorage"), pulumi.Alias(type_="azure-native:security/v20221201preview:DefenderForStorage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DefenderForStorage, __self__).__init__(
            'azure-native:security/v20241001preview:DefenderForStorage',
            resource_name,
            __props__,
            opts)
