...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union[Union['AwsEnvironmentDataArgs', 'AwsEnvironmentDataArgsDict'], Union['AzureDevOpsScopeEnvironmentDataArgs', 'AzureDevOpsScopeEnvironmentDataArgsDict'], Union['GcpProjectEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgsDict'], Union['GithubScopeEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgsDict']]] environment_data: The security connector environment data.
        :param pulumi.Input[Union[str, 'CloudName']] environment_name: The multi cloud resource's cloud name.
        :param pulumi.Input[str] hierarchy_identifier: The multi cloud resource identifier (account id in case of AWS connector, project number in case of GCP connector).
        :param pulumi.Input[str] kind: Kind of the resource
        :param pulumi.Input[str] location: Location where the resource is stored
    ...
    def _internal_init(__self__,
        ...
        super(SecurityConnector, __self__).__init__(
            'azure-native:security/v20220801preview:SecurityConnector',
            resource_name,
            __props__,
            opts)
