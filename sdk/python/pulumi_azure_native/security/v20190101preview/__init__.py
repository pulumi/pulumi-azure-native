...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:security/v20190101preview:AlertsSuppressionRule":
                return AlertsSuppressionRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20190101preview:Assessment":
                return Assessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20190101preview:AssessmentsMetadataSubscription":
                return AssessmentsMetadataSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20190101preview:Automation":
    ...
    pulumi.runtime.register_resource_module("azure-native", "security/v20190101preview", _module_instance)
