...
class AssessmentsMetadataSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        assessments_metadata_subscription = azure_native.security.v20190101preview.AssessmentsMetadataSubscription("assessmentsMetadataSubscription",
        ...
        ```sh
        $ pulumi import azure-native:security/v20190101preview:AssessmentsMetadataSubscription ca039e75-a276-4175-aebc-bcd41e4b14b7 /providers/Microsoft.Security/assessmentMetadata/ca039e75-a276-4175-aebc-bcd41e4b14b7 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-native:security/v20200101:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-native:security/v20210601:AssessmentsMetadataSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentsMetadataSubscription, __self__).__init__(
            'azure-native:security/v20190101preview:AssessmentsMetadataSubscription',
            resource_name,
            __props__,
            opts)
