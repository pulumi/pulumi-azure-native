...
class AssessmentsMetadataSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20190101preview:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-native:security:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-nextgen:security:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-native:security/v20200101:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-nextgen:security/v20200101:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-native:security/v20210601:AssessmentsMetadataSubscription"), pulumi.Alias(type_="azure-nextgen:security/v20210601:AssessmentsMetadataSubscription")])
