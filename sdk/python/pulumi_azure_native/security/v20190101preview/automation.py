...
class Automation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:Automation"), pulumi.Alias(type_="azure-native:security/v20231201preview:Automation")])
