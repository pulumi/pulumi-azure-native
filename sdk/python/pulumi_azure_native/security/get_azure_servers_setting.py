...
def get_azure_servers_setting(setting_kind: Optional[_builtins.str] = None,
...
def get_azure_servers_setting_output(setting_kind: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
