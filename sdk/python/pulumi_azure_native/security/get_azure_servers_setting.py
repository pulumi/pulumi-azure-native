...
class GetAzureServersSettingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, kind=None, name=None, selected_provider=None, system_data=None, type=None):
    ...
    def selected_provider(self) -> builtins.str:
        """
...
def get_azure_servers_setting(setting_kind: Optional[builtins.str] = None,
    ...
    :param builtins.str setting_kind: The kind of the server vulnerability assessments setting
    """
    __args__ = dict()
...
def get_azure_servers_setting_output(setting_kind: Optional[pulumi.Input[builtins.str]] = None,
