...
def list_git_hub_owner_available(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:listGitHubOwnerAvailable', __args__, opts=opts, typ=ListGitHubOwnerAvailableResult).value

    return AwaitableListGitHubOwnerAvailableResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_git_hub_owner_available_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security:listGitHubOwnerAvailable', __args__, opts=opts, typ=ListGitHubOwnerAvailableResult)
