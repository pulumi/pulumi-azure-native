...
def get_dev_ops_configuration(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:getDevOpsConfiguration', __args__, opts=opts, typ=GetDevOpsConfigurationResult).value
...
def get_dev_ops_configuration_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security:getDevOpsConfiguration', __args__, opts=opts, typ=GetDevOpsConfigurationResult)
