...
def get_dev_ops_configuration(resource_group_name: Optional[builtins.str] = None,
...
def get_dev_ops_configuration_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
