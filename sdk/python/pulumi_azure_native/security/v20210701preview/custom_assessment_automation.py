...
class CustomAssessmentAutomationArgs:
    def __init__(__self__, *,
        ...
        """
        CustomAssessmentAutomationArgs._configure(
    ...
    def _configure(
        ...
        if compressed_query is None and 'compressedQuery' in kwargs:
            compressed_query = kwargs['compressedQuery']
        if custom_assessment_automation_name is None and 'customAssessmentAutomationName' in kwargs:
            custom_assessment_automation_name = kwargs['customAssessmentAutomationName']
        ...
        if supported_cloud is None and 'supportedCloud' in kwargs:
            supported_cloud = kwargs['supportedCloud']

        _setter("resource_group_name", resource_group_name)
        if compressed_query is not None:
            _setter("compressed_query", compressed_query)
        if custom_assessment_automation_name is not None:
            _setter("custom_assessment_automation_name", custom_assessment_automation_name)
        ...
        if supported_cloud is not None:
            _setter("supported_cloud", supported_cloud)
...
class CustomAssessmentAutomation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CustomAssessmentAutomationArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:CustomAssessmentAutomation")])
