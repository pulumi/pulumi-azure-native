...
class SecurityConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20210701preview:SecurityConnector"), pulumi.Alias(type_="azure-native:security:SecurityConnector"), pulumi.Alias(type_="azure-nextgen:security:SecurityConnector")])
