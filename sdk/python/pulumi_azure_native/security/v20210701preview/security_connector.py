...
class SecurityConnectorArgs:
    ...
    def _configure(
        ...
        if hierarchy_identifier is None and 'hierarchyIdentifier' in kwargs:
...
class SecurityConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            organizational_data = _utilities.configure(organizational_data, SecurityConnectorPropertiesOrganizationalDataArgs, True)
