...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        security_connector = azure_native.security.v20210701preview.SecurityConnector("securityConnector",
            cloud_name="AWS",
            hierarchy_identifier="exampleHierarchyId",
            location="Central US",
            offerings=[azure_native.security.v20210701preview.CspmMonitorAwsOfferingArgs(
                native_cloud_connection=azure_native.security.v20210701preview.CspmMonitorAwsOfferingNativeCloudConnectionArgs(
