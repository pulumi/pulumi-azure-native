...
class CustomEntityStoreAssignmentArgs:
    ...
    def _configure(
        ...
        if custom_entity_store_assignment_name is None and 'customEntityStoreAssignmentName' in kwargs:
...
class CustomEntityStoreAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:CustomEntityStoreAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomEntityStoreAssignment, __self__).__init__(
            'azure-native:security/v20210701preview:CustomEntityStoreAssignment',
            resource_name,
            __props__,
            opts)
