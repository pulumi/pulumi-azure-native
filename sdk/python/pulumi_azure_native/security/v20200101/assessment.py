...
class Assessment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        assessment = azure_native.security.v20200101.Assessment("assessment",
            assessment_name="8bb8be0a-6010-4789-812f-e4d661c4ed0e",
            resource_details=azure_native.security.v20200101.AzureResourceDetailsArgs(
                source="Azure",
            ),
            ...
            status=azure_native.security.v20200101.AssessmentStatusArgs(
                code="Healthy",
            ))
