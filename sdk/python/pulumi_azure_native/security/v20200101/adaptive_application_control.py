...
class AdaptiveApplicationControlArgs:
    ...
    def _configure(
        ...
        if path_recommendations is None and 'pathRecommendations' in kwargs:
            path_recommendations = kwargs['pathRecommendations']
        if protection_mode is None and 'protectionMode' in kwargs:
            protection_mode = kwargs['protectionMode']
        if vm_recommendations is None and 'vmRecommendations' in kwargs:
            vm_recommendations = kwargs['vmRecommendations']
...
class AdaptiveApplicationControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            protection_mode = _utilities.configure(protection_mode, ProtectionModeArgs, True)
