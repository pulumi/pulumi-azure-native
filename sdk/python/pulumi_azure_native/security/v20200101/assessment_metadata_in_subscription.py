...
class AssessmentMetadataInSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        assessment_metadata_in_subscription = azure_native.security.v20200101.AssessmentMetadataInSubscription("assessmentMetadataInSubscription",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-native:security/v20190101preview:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-native:security/v20210601:AssessmentMetadataInSubscription")])
