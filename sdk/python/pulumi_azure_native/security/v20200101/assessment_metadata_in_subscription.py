...
class AssessmentMetadataInSubscription(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20200101:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-native:security:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-nextgen:security:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-native:security/latest:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-nextgen:security/latest:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-native:security/v20190101preview:AssessmentMetadataInSubscription"), pulumi.Alias(type_="azure-nextgen:security/v20190101preview:AssessmentMetadataInSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentMetadataInSubscription, __self__).__init__(
            'azure-native:security/v20200101:AssessmentMetadataInSubscription',
            resource_name,
            __props__,
            opts)
