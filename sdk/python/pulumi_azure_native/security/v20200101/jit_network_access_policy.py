...
class JitNetworkAccessPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        jit_network_access_policy = azure_native.security.v20200101.JitNetworkAccessPolicy("jitNetworkAccessPolicy",
            ...
            virtual_machines=[{
                "id": "/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/myRg1/providers/Microsoft.Compute/virtualMachines/vm1",
                "ports": [
                    azure_native.security.v20200101.JitNetworkAccessPortRuleArgs(
