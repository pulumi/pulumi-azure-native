...
def get_assessment(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20200101:getAssessment', __args__, opts=opts, typ=GetAssessmentResult).value
...
def get_assessment_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceId'] = resource_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20200101:getAssessment', __args__, opts=opts, typ=GetAssessmentResult)
