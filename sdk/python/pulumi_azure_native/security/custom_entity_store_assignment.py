...
class CustomEntityStoreAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 custom_entity_store_assignment_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def custom_entity_store_assignment_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def custom_entity_store_assignment_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class CustomEntityStoreAssignment(pulumi.CustomResource):
    ...
    def entity_store_database_link(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
