...
class CustomEntityStoreAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 custom_entity_store_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_entity_store_assignment_name: Name of the custom entity store assignment. Generated name is GUID.
        :param pulumi.Input[builtins.str] principal: The principal assigned with entity store. If not provided, will use caller principal. Format of principal is: [AAD type]=[PrincipalObjectId];[TenantId]
        """
    ...
    def custom_entity_store_assignment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_entity_store_assignment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomEntityStoreAssignment(pulumi.CustomResource):
    ...
    def entity_store_database_link(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def principal(self) -> pulumi.Output[Optional[builtins.str]]:
        """
