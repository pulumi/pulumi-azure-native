...
class DefenderCspmAwsOfferingCiemArgsDict(TypedDict):
    ...
    """
    ciem_discovery: NotRequired[pulumi.Input[Optional['DefenderCspmAwsOfferingCiemDiscoveryArgsDict']]]
    """
    Defender CSPM Permissions Management discovery configuration
    """
    ciem_oidc: NotRequired[pulumi.Input[Optional['DefenderCspmAwsOfferingCiemOidcArgsDict']]]
    """
    AWS Defender CSPM Permissions Management OIDC (open id connect) connection configurations
    """
...
class DefenderCspmAwsOfferingArgsDict(TypedDict):
    ...
    The databases DSPM configuration
    """
    mdc_containers_agentless_discovery_k8s: NotRequired[pulumi.Input[Optional['DefenderCspmAwsOfferingMdcContainersAgentlessDiscoveryK8sArgsDict']]]
    """
    The Microsoft Defender container agentless discovery K8s configuration
    """
...
class DefenderCspmGcpOfferingArgsDict(TypedDict):
    ...
    The Microsoft Defender Data Sensitivity discovery configuration
    """
    mdc_containers_agentless_discovery_k8s: NotRequired[pulumi.Input[Optional['DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8sArgsDict']]]
    """
    The Microsoft Defender Container agentless discovery configuration
    """
...
class DefenderForContainersAwsOfferingArgsDict(TypedDict):
    ...
    The kubernetes service connection configuration
    """
    mdc_containers_agentless_discovery_k8s: NotRequired[pulumi.Input[Optional['DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8sArgsDict']]]
    """
    The Microsoft Defender container agentless discovery K8s configuration
    """
...
class DefenderForContainersGcpOfferingArgsDict(TypedDict):
    ...
    Is Policy Kubernetes agent auto provisioning enabled
    """
    mdc_containers_agentless_discovery_k8s: NotRequired[pulumi.Input[Optional['DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8sArgsDict']]]
    """
    The Microsoft Defender Container agentless discovery configuration
    """
...
class DefenderForServersAwsOfferingVaAutoProvisioningArgsDict(TypedDict):
    ...
    """
    configuration: NotRequired[pulumi.Input[Optional['DefenderForServersAwsOfferingConfigurationArgsDict']]]
    """
    configuration for Vulnerability Assessment autoprovisioning
    """
    enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
...
class DefenderForServersGcpOfferingVaAutoProvisioningArgsDict(TypedDict):
    ...
    The Vulnerability Assessment autoprovisioning configuration
    """
    configuration: NotRequired[pulumi.Input[Optional['DefenderForServersGcpOfferingConfigurationArgsDict']]]
    """
    configuration for Vulnerability Assessment autoprovisioning
    """
    enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
