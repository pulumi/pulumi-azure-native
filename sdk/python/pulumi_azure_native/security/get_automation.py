...
def get_automation(automation_name: Optional[_builtins.str] = None,
...
def get_automation_output(automation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
