...
def get_automation(automation_name: Optional[builtins.str] = None,
    ...
    :param builtins.str automation_name: The security automation name.
...
def get_automation_output(automation_name: Optional[pulumi.Input[builtins.str]] = None,
