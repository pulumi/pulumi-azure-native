...
class GetGovernanceAssignmentResult:
    ...
    def is_grace_period(self) -> Optional[builtins.bool]:
        """
    ...
    def remediation_due_date(self) -> builtins.str:
        """
...
def get_governance_assignment(assessment_name: Optional[builtins.str] = None,
                              assignment_key: Optional[builtins.str] = None,
    ...
    :param builtins.str assessment_name: The Assessment Key - A unique key for the assessment type
    :param builtins.str assignment_key: The governance assignment key - the assessment key of the required governance assignment
    :param builtins.str scope: The scope of the Governance assignments. Valid scopes are: subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'
    """
    __args__ = dict()
...
def get_governance_assignment_output(assessment_name: Optional[pulumi.Input[builtins.str]] = None,
