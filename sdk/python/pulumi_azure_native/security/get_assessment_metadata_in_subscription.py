...
class GetAssessmentMetadataInSubscriptionResult:
    ...
    """
    def __init__(__self__, assessment_type=None, azure_api_version=None, categories=None, description=None, display_name=None, id=None, implementation_effort=None, name=None, partner_data=None, planned_deprecation_date=None, policy_definition_id=None, preview=None, publish_dates=None, remediation_description=None, severity=None, tactics=None, techniques=None, threats=None, type=None, user_impact=None):
    ...
    def planned_deprecation_date(self) -> Optional[builtins.str]:
...
def get_assessment_metadata_in_subscription(assessment_metadata_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:getAssessmentMetadataInSubscription', __args__, opts=opts, typ=GetAssessmentMetadataInSubscriptionResult).value
...
def get_assessment_metadata_in_subscription_output(assessment_metadata_name: Optional[pulumi.Input[builtins.str]] = None,
