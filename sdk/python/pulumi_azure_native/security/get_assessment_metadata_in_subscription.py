...
def get_assessment_metadata_in_subscription(assessment_metadata_name: Optional[_builtins.str] = None,
...
def get_assessment_metadata_in_subscription_output(assessment_metadata_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
