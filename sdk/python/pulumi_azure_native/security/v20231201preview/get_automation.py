...
def get_automation(automation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20231201preview:getAutomation', __args__, opts=opts, typ=GetAutomationResult).value
...
def get_automation_output(automation_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20231201preview:getAutomation', __args__, opts=opts, typ=GetAutomationResult)
