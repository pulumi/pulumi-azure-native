...
def list_git_lab_subgroup(group_fq_name: Optional[builtins.str] = None,
    ...
    :param builtins.str group_fq_name: The GitLab group fully-qualified name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult).value

    return AwaitableListGitLabSubgroupResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_git_lab_subgroup_output(group_fq_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult)
