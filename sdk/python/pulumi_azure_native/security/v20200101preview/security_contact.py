...
class SecurityContact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(alert_notifications, SecurityContactPropertiesAlertNotificationsArgs):
            ...
            if not isinstance(notifications_by_role, SecurityContactPropertiesNotificationsByRoleArgs):
