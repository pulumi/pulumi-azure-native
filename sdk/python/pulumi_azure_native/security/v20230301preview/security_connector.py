...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        security_connector = azure_native.security.v20230301preview.SecurityConnector("securityConnector",
            environment_data=azure_native.security.v20230301preview.AwsEnvironmentDataArgs(
                environment_type="AwsAccount",
            ),
            environment_name="AWS",
            hierarchy_identifier="exampleHierarchyId",
            location="Central US",
            offerings=[azure_native.security.v20230301preview.CspmMonitorAwsOfferingArgs(
                native_cloud_connection=azure_native.security.v20230301preview.CspmMonitorAwsOfferingNativeCloudConnectionArgs(
    ...
    def _internal_init(__self__,
        ...
        super(SecurityConnector, __self__).__init__(
            'azure-native:security/v20230301preview:SecurityConnector',
            resource_name,
            __props__,
            opts)
