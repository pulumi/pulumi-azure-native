...
class DevOpsConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['DevOpsConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['DevOpsConfigurationPropertiesArgs']] properties: DevOps Configuration properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] security_connector_name: The security connector name.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, DevOpsConfigurationPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                DevOpsConfigurationPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:DevOpsConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DevOpsConfiguration, __self__).__init__(
            'azure-native:security/v20230901preview:DevOpsConfiguration',
            resource_name,
            __props__,
            opts)
