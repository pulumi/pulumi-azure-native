...
class AzureServersSettingArgs:
    ...
    def _configure(
        ...
        if selected_provider is None and 'selectedProvider' in kwargs:
            selected_provider = kwargs['selectedProvider']
        if selected_provider is None:
            raise TypeError("Missing 'selected_provider' argument")
        if setting_kind is None and 'settingKind' in kwargs:
            setting_kind = kwargs['settingKind']
