...
class AzureServersSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] setting_kind: The kind of the server vulnerability assessments setting
        """
    ...
    def selected_provider(self, value: pulumi.Input[Union[_builtins.str, 'ServerVulnerabilityAssessmentsAzureSettingSelectedProvider']]):
