...
class APICollectionByAzureApiManagementServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: API revision identifier. Must be unique in the API Management service instance. Non-current revision has ;rev=n as a suffix where n is the revision number.
        """
...
class APICollectionByAzureApiManagementService(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:security:APICollectionByAzureApiManagementService"
    ...
    def discovered_via(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def number_of_api_endpoints(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def number_of_api_endpoints_with_sensitive_data_exposed(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def number_of_external_api_endpoints(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def number_of_inactive_api_endpoints(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def number_of_unauthenticated_api_endpoints(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def sensitivity_label(self) -> pulumi.Output[builtins.str]:
        """
