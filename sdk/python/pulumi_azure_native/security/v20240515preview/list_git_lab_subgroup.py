...
def list_git_lab_subgroup(group_fq_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20240515preview:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult).value
...
def list_git_lab_subgroup_output(group_fq_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['securityConnectorName'] = security_connector_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20240515preview:listGitLabSubgroup', __args__, opts=opts, typ=ListGitLabSubgroupResult)
