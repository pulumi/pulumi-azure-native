...
def get_dev_ops_configuration(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20240515preview:getDevOpsConfiguration', __args__, opts=opts, typ=GetDevOpsConfigurationResult).value
...
def get_dev_ops_configuration_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['securityConnectorName'] = security_connector_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20240515preview:getDevOpsConfiguration', __args__, opts=opts, typ=GetDevOpsConfigurationResult)
