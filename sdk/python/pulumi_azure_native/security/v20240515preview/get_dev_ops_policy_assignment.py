...
def get_dev_ops_policy_assignment(policy_assignment_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20240515preview:getDevOpsPolicyAssignment', __args__, opts=opts, typ=GetDevOpsPolicyAssignmentResult).value
