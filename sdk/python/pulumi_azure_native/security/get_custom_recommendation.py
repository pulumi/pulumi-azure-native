...
def get_custom_recommendation(custom_recommendation_name: Optional[_builtins.str] = None,
...
def get_custom_recommendation_output(custom_recommendation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
