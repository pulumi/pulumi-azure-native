...
class AssessmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_data: Additional data regarding the assessment
        :param pulumi.Input[builtins.str] assessment_name: The Assessment Key - Unique key for the assessment type
