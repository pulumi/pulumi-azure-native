...
class APICollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        api_collection = azure_native.security.v20221120preview.APICollection("apiCollection",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:APICollection")])
