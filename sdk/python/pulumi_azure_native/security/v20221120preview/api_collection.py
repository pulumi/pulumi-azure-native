...
class APICollectionArgs:
    ...
    def _configure(
        ...
        if api_collection_id is None and 'apiCollectionId' in kwargs:
            api_collection_id = kwargs['apiCollectionId']

        _setter("resource_group_name", resource_group_name)
        _setter("service_name", service_name)
        if api_collection_id is not None:
            _setter("api_collection_id", api_collection_id)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            APICollectionArgs._configure(_setter, **kwargs)
