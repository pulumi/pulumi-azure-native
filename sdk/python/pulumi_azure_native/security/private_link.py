...
class PrivateLinkArgs:
    ...
    def private_link_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_link_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PrivateLink':
        """
