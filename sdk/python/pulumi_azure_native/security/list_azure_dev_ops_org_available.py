...
def list_azure_dev_ops_org_available(resource_group_name: Optional[builtins.str] = None,
...
def list_azure_dev_ops_org_available_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
