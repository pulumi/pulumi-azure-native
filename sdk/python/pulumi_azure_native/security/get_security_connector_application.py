...
def get_security_connector_application(application_id: Optional[builtins.str] = None,
...
def get_security_connector_application_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
