...
def get_security_connector(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_connector is deprecated: azure-native:security/v20211201preview:SecurityConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:security/v20220801preview:SecurityConnector to guarantee forwards compatibility.""")
    __args__ = dict()
