...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_data: Optional[pulumi.Input[Union[Union['AWSEnvironmentDataArgs', 'AWSEnvironmentDataArgsDict'], Union['GcpProjectEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgsDict'], Union['GithubScopeEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgsDict']]]] = None,
                 environment_name: Optional[pulumi.Input[Union[str, 'CloudName']]] = None,
                 hierarchy_identifier: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 offerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorAwsOfferingArgsDict'], Union['CspmMonitorGcpOfferingArgs', 'CspmMonitorGcpOfferingArgsDict'], Union['CspmMonitorGithubOfferingArgs', 'CspmMonitorGithubOfferingArgsDict'], Union['DefenderForContainersAwsOfferingArgs', 'DefenderForContainersAwsOfferingArgsDict'], Union['DefenderForContainersGcpOfferingArgs', 'DefenderForContainersGcpOfferingArgsDict'], Union['DefenderForServersAwsOfferingArgs', 'DefenderForServersAwsOfferingArgsDict'], Union['DefenderForServersGcpOfferingArgs', 'DefenderForServersGcpOfferingArgsDict'], Union['InformationProtectionAwsOfferingArgs', 'InformationProtectionAwsOfferingArgsDict']]]]]] = None,
        ...
        :param pulumi.Input[Union[Union['AWSEnvironmentDataArgs', 'AWSEnvironmentDataArgsDict'], Union['GcpProjectEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgsDict'], Union['GithubScopeEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgsDict']]] environment_data: The security connector environment data.
        :param pulumi.Input[Union[str, 'CloudName']] environment_name: The multi cloud resource's cloud name.
        :param pulumi.Input[str] hierarchy_identifier: The multi cloud resource identifier (account id in case of AWS connector, project number in case of GCP connector).
        :param pulumi.Input[str] kind: Kind of the resource
        :param pulumi.Input[str] location: Location where the resource is stored
