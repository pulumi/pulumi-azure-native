...
class SecurityConnectorArgs:
    def __init__(__self__, *,
                 ...
                 environment_data: Optional[pulumi.Input[Union['AWSEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs']]] = None,
                 ...
                 offerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]]] = None,
        ...
        :param pulumi.Input[Union['AWSEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs']] environment_data: The security connector environment data.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]] offerings: A collection of offerings for the security connector.
    ...
    def environment_data(self) -> Optional[pulumi.Input[Union['AWSEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs']]]:
        """
    ...
    def environment_data(self, value: Optional[pulumi.Input[Union['AWSEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs']]]):
    ...
    @property
    @pulumi.getter
    def offerings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]]]:
        """
    ...
    @offerings.setter
    def offerings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]]]):
...
warnings.warn("""azure-native:security/v20211201preview:SecurityConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:security/v20220801preview:SecurityConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class SecurityConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_data: Optional[pulumi.Input[Union[pulumi.InputType['AWSEnvironmentDataArgs'], pulumi.InputType['GcpProjectEnvironmentDataArgs'], pulumi.InputType['GithubScopeEnvironmentDataArgs']]]] = None,
                 environment_name: Optional[pulumi.Input[Union[str, 'CloudName']]] = None,
                 hierarchy_identifier: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 offerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[pulumi.InputType['CspmMonitorAwsOfferingArgs'], pulumi.InputType['CspmMonitorGcpOfferingArgs'], pulumi.InputType['CspmMonitorGithubOfferingArgs'], pulumi.InputType['DefenderForContainersAwsOfferingArgs'], pulumi.InputType['DefenderForContainersGcpOfferingArgs'], pulumi.InputType['DefenderForServersAwsOfferingArgs'], pulumi.InputType['DefenderForServersGcpOfferingArgs'], pulumi.InputType['InformationProtectionAwsOfferingArgs']]]]]] = None,
        ...
        :param pulumi.Input[Union[pulumi.InputType['AWSEnvironmentDataArgs'], pulumi.InputType['GcpProjectEnvironmentDataArgs'], pulumi.InputType['GithubScopeEnvironmentDataArgs']]] environment_data: The security connector environment data.
        :param pulumi.Input[Union[str, 'CloudName']] environment_name: The multi cloud resource's cloud name.
        :param pulumi.Input[str] hierarchy_identifier: The multi cloud resource identifier (account id in case of AWS connector, project number in case of GCP connector).
        :param pulumi.Input[str] kind: Kind of the resource
        :param pulumi.Input[str] location: Location where the resource is stored
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityConnector is deprecated: azure-native:security/v20211201preview:SecurityConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:security/v20220801preview:SecurityConnector to guarantee forwards compatibility.""")
        ...
        super(SecurityConnector, __self__).__init__(
            'azure-native:security/v20211201preview:SecurityConnector',
            resource_name,
            __props__,
            opts)
