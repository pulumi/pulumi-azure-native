...
class GetPricingResult:
    ...
    def enablement_time(self) -> builtins.str:
        """
    ...
    def free_trial_remaining_time(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def inherited(self) -> builtins.str:
        """
    ...
    def replaced_by(self) -> Sequence[builtins.str]:
        """
    ...
    def resources_coverage_status(self) -> builtins.str:
        """
    ...
    def sub_plan(self) -> Optional[builtins.str]:
        """
...
def get_pricing(pricing_name: Optional[builtins.str] = None,
    ...
    :param builtins.str scope_id: The scope id of the pricing. Valid scopes are: subscription (format: 'subscriptions/{subscriptionId}'), or a specific resource (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}) - Supported resources are (VirtualMachines)
    """
    __args__ = dict()
...
def get_pricing_output(pricing_name: Optional[pulumi.Input[builtins.str]] = None,
