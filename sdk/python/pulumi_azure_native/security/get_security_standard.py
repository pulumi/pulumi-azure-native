...
class GetSecurityStandardResult:
    ...
    def policy_set_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def standard_type(self) -> builtins.str:
        """
...
def get_security_standard(scope: Optional[builtins.str] = None,
                          standard_id: Optional[builtins.str] = None,
    ...
    :param builtins.str scope: The scope of the security standard. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'
    :param builtins.str standard_id: The Security Standard key - unique key for the standard type
    """
    __args__ = dict()
...
def get_security_standard_output(scope: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security:getSecurityStandard', __args__, opts=opts, typ=GetSecurityStandardResult)
