...
def get_assignment(assignment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str assignment_id: The security assignment key - unique key for the standard assignment
...
def get_assignment_output(assignment_id: Optional[pulumi.Input[builtins.str]] = None,
