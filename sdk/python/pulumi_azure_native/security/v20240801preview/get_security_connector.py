...
def get_security_connector(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20240801preview:getSecurityConnector', __args__, opts=opts, typ=GetSecurityConnectorResult).value
...
def get_security_connector_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20240801preview:getSecurityConnector', __args__, opts=opts, typ=GetSecurityConnectorResult)
