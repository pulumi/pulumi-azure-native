...
def get_assessments_metadata_subscription(assessment_metadata_name: Optional[_builtins.str] = None,
...
def get_assessments_metadata_subscription_output(assessment_metadata_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
