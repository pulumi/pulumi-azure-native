...
class AdvancedThreatProtection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security:AdvancedThreatProtection"), pulumi.Alias(type_="azure-native:security/v20170801preview:AdvancedThreatProtection"), pulumi.Alias(type_="azure-nextgen:security/v20170801preview:AdvancedThreatProtection"), pulumi.Alias(type_="azure-native:security/v20190101:AdvancedThreatProtection"), pulumi.Alias(type_="azure-nextgen:security/v20190101:AdvancedThreatProtection")])
