...
def get_security_connector_governance_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:getSecurityConnectorGovernanceRule', __args__, opts=opts, typ=GetSecurityConnectorGovernanceRuleResult).value
