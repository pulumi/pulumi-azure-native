...
def get_security_operator(pricing_name: Optional[_builtins.str] = None,
                          security_operator_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_operator_name: name of the securityOperator
    """
    __args__ = dict()
