...
class GetCustomEntityStoreAssignmentResult:
    ...
    def entity_store_database_link(self) -> Optional[_builtins.str]:
        """
...
def get_custom_entity_store_assignment(custom_entity_store_assignment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str custom_entity_store_assignment_name: Name of the custom entity store assignment. Generated name is GUID.
...
def get_custom_entity_store_assignment_output(custom_entity_store_assignment_name: Optional[pulumi.Input[_builtins.str]] = None,
