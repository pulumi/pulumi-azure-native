...
class GovernanceAssignmentArgs:
    def __init__(__self__, *,
                 assessment_name: pulumi.Input[builtins.str],
                 remediation_due_date: pulumi.Input[builtins.str],
                 scope: pulumi.Input[builtins.str],
                 additional_data: Optional[pulumi.Input['GovernanceAssignmentAdditionalDataArgs']] = None,
                 assignment_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] assessment_name: The Assessment Key - A unique key for the assessment type
        :param pulumi.Input[builtins.str] remediation_due_date: The remediation due-date - after this date Secure Score will be affected (in case of  active grace-period)
        :param pulumi.Input[builtins.str] scope: The scope of the Governance assignments. Valid scopes are: subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'
        ...
        :param pulumi.Input[builtins.str] assignment_key: The governance assignment key - the assessment key of the required governance assignment
        ...
        :param pulumi.Input[builtins.bool] is_grace_period: Defines whether there is a grace period on the governance assignment
        :param pulumi.Input[builtins.str] owner: The Owner for the governance assignment - e.g. user@contoso.com - see example
    ...
    def assessment_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assessment_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "assessment_name", value)

    @property
    @pulumi.getter(name="remediationDueDate")
    def remediation_due_date(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remediation_due_date(self, value: pulumi.Input[builtins.str]):
    ...
    def assignment_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assignment_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GovernanceAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_grace_period: Optional[pulumi.Input[builtins.bool]] = None,
                 owner: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_due_date: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="remediationDueDate")
    def remediation_due_date(self) -> pulumi.Output[builtins.str]:
        """
        The remediation due-date - after this date Secure Score will be affected (in case of  active grace-period)
        """
        return pulumi.get(self, "remediation_due_date")
