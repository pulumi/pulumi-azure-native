...
class GovernanceAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(additional_data, GovernanceAssignmentAdditionalDataArgs):
            ...
            if not isinstance(governance_email_notification, GovernanceEmailNotificationArgs):
            ...
            if not isinstance(remediation_eta, RemediationEtaArgs):
