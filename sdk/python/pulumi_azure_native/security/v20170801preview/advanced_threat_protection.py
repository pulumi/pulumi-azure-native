...
class AdvancedThreatProtection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 setting_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AdvancedThreatProtection is deprecated: azure-native:security/v20170801preview:AdvancedThreatProtection is being removed in the next major version of this provider. Upgrade to at least azure-native:security/v20190101:AdvancedThreatProtection to guarantee forwards compatibility.""")
