...
class WorkspaceSettingArgs:
    def __init__(__self__, *,
        ...
        """
        WorkspaceSettingArgs._configure(
    ...
    def _configure(
        ...
        if workspace_setting_name is None and 'workspaceSettingName' in kwargs:
            workspace_setting_name = kwargs['workspaceSettingName']

        _setter("scope", scope)
        _setter("workspace_id", workspace_id)
        if workspace_setting_name is not None:
            _setter("workspace_setting_name", workspace_setting_name)
...
class WorkspaceSetting(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WorkspaceSettingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:WorkspaceSetting")])
