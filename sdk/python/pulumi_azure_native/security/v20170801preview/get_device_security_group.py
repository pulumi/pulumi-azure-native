...
def get_device_security_group(device_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20170801preview:getDeviceSecurityGroup', __args__, opts=opts, typ=GetDeviceSecurityGroupResult).value
...
def get_device_security_group_output(device_security_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security/v20170801preview:getDeviceSecurityGroup', __args__, opts=opts, typ=GetDeviceSecurityGroupResult)
