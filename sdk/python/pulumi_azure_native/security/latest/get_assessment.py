...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:security:getAssessment'.""", DeprecationWarning)
...
def get_assessment(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/latest:getAssessment', __args__, opts=opts, typ=GetAssessmentResult).value
