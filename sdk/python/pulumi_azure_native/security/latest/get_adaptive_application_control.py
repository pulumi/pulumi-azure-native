...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:security:getAdaptiveApplicationControl'.""", DeprecationWarning)
...
def get_adaptive_application_control(asc_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/latest:getAdaptiveApplicationControl', __args__, opts=opts, typ=GetAdaptiveApplicationControlResult).value
