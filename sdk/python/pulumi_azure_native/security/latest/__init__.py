...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:security/latest:AdaptiveApplicationControl":
                return AdaptiveApplicationControl(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:Assessment":
                return Assessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:AssessmentMetadataInSubscription":
                return AssessmentMetadataInSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:DeviceSecurityGroup":
                return DeviceSecurityGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:IotSecuritySolution":
                return IotSecuritySolution(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:JitNetworkAccessPolicy":
                return JitNetworkAccessPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/latest:ServerVulnerabilityAssessment":
    ...
    pulumi.runtime.register_resource_module("azure-native", "security/latest", _module_instance)
