...
class GetCustomAssessmentAutomationResult:
    ...
    """
    def __init__(__self__, compressed_query=None, description=None, id=None, name=None, remediation_description=None, severity=None, supported_cloud=None, type=None):
