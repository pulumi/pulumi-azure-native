...
class GetCustomAssessmentAutomationResult:
    ...
    def compressed_query(self) -> Optional[_builtins.str]:
        """
    ...
    def supported_cloud(self) -> Optional[_builtins.str]:
        """
...
def get_custom_assessment_automation(custom_assessment_automation_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str custom_assessment_automation_name: Name of the Custom Assessment Automation.
...
def get_custom_assessment_automation_output(custom_assessment_automation_name: Optional[pulumi.Input[_builtins.str]] = None,
