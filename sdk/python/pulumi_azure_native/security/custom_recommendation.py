...
class CustomRecommendationArgs:
    def __init__(__self__, *,
                 ...
                 cloud_providers: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'RecommendationSupportedClouds']]]]] = None,
                 custom_recommendation_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 security_issue: Optional[pulumi.Input[Union[builtins.str, 'SecurityIssue']]] = None,
                 severity: Optional[pulumi.Input[Union[builtins.str, 'SeverityEnum']]] = None):
        """
        The set of arguments for constructing a CustomRecommendation resource.
        :param pulumi.Input[builtins.str] scope: The scope of the custom recommendation. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'RecommendationSupportedClouds']]]] cloud_providers: List of all standard supported clouds.
        :param pulumi.Input[builtins.str] custom_recommendation_name: Name of the Custom Recommendation.
        :param pulumi.Input[builtins.str] description: The description to relate to the assessments generated by this Recommendation.
        :param pulumi.Input[builtins.str] display_name: The display name of the assessments generated by this Recommendation.
        :param pulumi.Input[builtins.str] query: KQL query representing the Recommendation results required.
        :param pulumi.Input[builtins.str] remediation_description: The remediation description to relate to the assessments generated by this Recommendation.
        :param pulumi.Input[Union[builtins.str, 'SecurityIssue']] security_issue: The severity to relate to the assessments generated by this Recommendation.
        :param pulumi.Input[Union[builtins.str, 'SeverityEnum']] severity: The severity to relate to the assessments generated by this Recommendation.
        """
    ...
    def cloud_providers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'RecommendationSupportedClouds']]]]]:
        """
    ...
    def cloud_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'RecommendationSupportedClouds']]]]]):
        pulumi.set(self, "cloud_providers", value)

    @property
    @pulumi.getter(name="customRecommendationName")
    def custom_recommendation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_recommendation_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_issue(self) -> Optional[pulumi.Input[Union[builtins.str, 'SecurityIssue']]]:
        """
    ...
    def security_issue(self, value: Optional[pulumi.Input[Union[builtins.str, 'SecurityIssue']]]):
        pulumi.set(self, "security_issue", value)

    @property
    @pulumi.getter
    def severity(self) -> Optional[pulumi.Input[Union[builtins.str, 'SeverityEnum']]]:
        """
        The severity to relate to the assessments generated by this Recommendation.
        """
    ...
    @severity.setter
    def severity(self, value: Optional[pulumi.Input[Union[builtins.str, 'SeverityEnum']]]):
...
class CustomRecommendation(pulumi.CustomResource):
    ...
    def assessment_key(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="securityIssue")
    def security_issue(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The severity to relate to the assessments generated by this Recommendation.
        """
        return pulumi.get(self, "security_issue")
