...
class CustomRecommendationArgs:
    ...
    def custom_recommendation_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def custom_recommendation_name(self, value: pulumi.Input[Optional[_builtins.str]]):
