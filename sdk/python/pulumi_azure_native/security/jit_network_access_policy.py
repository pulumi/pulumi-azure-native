...
class JitNetworkAccessPolicyArgs:
    def __init__(__self__, *,
                 asc_location: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] asc_location: The location where ASC stores the data of the subscription. can be retrieved from Get locations
        ...
        :param pulumi.Input[builtins.str] jit_network_access_policy_name: Name of a Just-in-Time access configuration policy.
    ...
    def asc_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @asc_location.setter
    def asc_location(self, value: pulumi.Input[builtins.str]):
    ...
    def jit_network_access_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def jit_network_access_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JitNetworkAccessPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 asc_location: Optional[pulumi.Input[builtins.str]] = None,
                 jit_network_access_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input[builtins.str]] = None,
