...
class PricingArgs:
    def __init__(__self__, *,
                 ...
                 enforce: Optional[pulumi.Input[Union[builtins.str, 'Enforce']]] = None,
                 ...
                 sub_plan: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Pricing resource.
        :param pulumi.Input[Union[builtins.str, 'PricingTier']] pricing_tier: Indicates whether the Defender plan is enabled on the selected scope. Microsoft Defender for Cloud is provided in two pricing tiers: free and standard. The standard tier offers advanced security capabilities, while the free tier offers basic security features.
        :param pulumi.Input[builtins.str] scope_id: The scope id of the pricing. Valid scopes are: subscription (format: 'subscriptions/{subscriptionId}'), or a specific resource (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}) - Supported resources are (VirtualMachines)
        :param pulumi.Input[Union[builtins.str, 'Enforce']] enforce: If set to "False", it allows the descendants of this scope to override the pricing configuration set on this scope (allows setting inherited="False"). If set to "True", it prevents overrides and forces this pricing configuration on all the descendants of this scope. This field is only available for subscription-level pricing.
    ...
    @property
    @pulumi.getter
    def enforce(self) -> Optional[pulumi.Input[Union[builtins.str, 'Enforce']]]:
        """
    ...
    @enforce.setter
    def enforce(self, value: Optional[pulumi.Input[Union[builtins.str, 'Enforce']]]):
    ...
    def pricing_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pricing_name.setter
    def pricing_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pricing_name", value)

    @property
    @pulumi.getter(name="subPlan")
    def sub_plan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sub_plan.setter
    def sub_plan(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Pricing(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 pricing_name: Optional[pulumi.Input[builtins.str]] = None,
                 pricing_tier: Optional[pulumi.Input[Union[builtins.str, 'PricingTier']]] = None,
    ...
    def enablement_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def enforce(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If set to "False", it allows the descendants of this scope to override the pricing configuration set on this scope (allows setting inherited="False"). If set to "True", it prevents overrides and forces this pricing configuration on all the descendants of this scope. This field is only available for subscription-level pricing.
        """
        return pulumi.get(self, "enforce")
    ...
    def free_trial_remaining_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def inherited(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def replaced_by(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def resources_coverage_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="subPlan")
    def sub_plan(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sub-plan selected for a Standard pricing configuration, when more than one sub-plan is available. Each sub-plan enables a set of security features. When not specified, full plan is applied. For VirtualMachines plan, available sub plans are 'P1' & 'P2', where for resource level only 'P1' sub plan is supported.
        """
        return pulumi.get(self, "sub_plan")
