...
class WorkspaceSettingArgs:
    def __init__(__self__, *,
                 ...
                 workspace_setting_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WorkspaceSetting resource.
        :param pulumi.Input[builtins.str] scope: All the VMs in this scope will send their security data to the mentioned workspace unless overridden by a setting with more specific scope
        :param pulumi.Input[builtins.str] workspace_id: The full Azure ID of the workspace to save the data in
        :param pulumi.Input[builtins.str] workspace_setting_name: Name of the security setting
        """
    ...
    def workspace_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def workspace_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
