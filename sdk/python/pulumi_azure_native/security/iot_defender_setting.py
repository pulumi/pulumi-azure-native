...
__all__ = ['IotDefenderSettingArgs', 'IotDefenderSetting']

@pulumi.input_type
class IotDefenderSettingArgs:
...
class IotDefenderSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param IotDefenderSettingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IotDefenderSettingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security:IotDefenderSetting"), pulumi.Alias(type_="azure-native:security/v20200806preview:IotDefenderSetting"), pulumi.Alias(type_="azure-nextgen:security/v20200806preview:IotDefenderSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotDefenderSetting, __self__).__init__(
            'azure-native:security:IotDefenderSetting',
            resource_name,
            __props__,
            opts)
