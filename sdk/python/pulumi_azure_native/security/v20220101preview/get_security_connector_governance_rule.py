...
__all__ = [
    'GetSecurityConnectorGovernanceRuleResult',
    'AwaitableGetSecurityConnectorGovernanceRuleResult',
    'get_security_connector_governance_rule',
    'get_security_connector_governance_rule_output',
]

@pulumi.output_type
class GetSecurityConnectorGovernanceRuleResult:
    """
...
class AwaitableGetSecurityConnectorGovernanceRuleResult(GetSecurityConnectorGovernanceRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSecurityConnectorGovernanceRuleResult(
...
def get_security_connector_governance_rule(resource_group_name: Optional[str] = None,
                                           rule_id: Optional[str] = None,
                                           security_connector_name: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSecurityConnectorGovernanceRuleResult:
    """
    Governance rule over a given scope
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20220101preview:getSecurityConnectorGovernanceRule', __args__, opts=opts, typ=GetSecurityConnectorGovernanceRuleResult).value

    return AwaitableGetSecurityConnectorGovernanceRuleResult(
...
@_utilities.lift_output_func(get_security_connector_governance_rule)
def get_security_connector_governance_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                                                  rule_id: Optional[pulumi.Input[str]] = None,
                                                  security_connector_name: Optional[pulumi.Input[str]] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSecurityConnectorGovernanceRuleResult]:
    """
    Governance rule over a given scope
