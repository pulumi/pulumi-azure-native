...
__all__ = [
    'GetmanagementGroupGovernanceRuleResult',
    'AwaitableGetmanagementGroupGovernanceRuleResult',
    'getmanagement_group_governance_rule',
    'getmanagement_group_governance_rule_output',
]

@pulumi.output_type
class GetmanagementGroupGovernanceRuleResult:
    """
...
class AwaitableGetmanagementGroupGovernanceRuleResult(GetmanagementGroupGovernanceRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetmanagementGroupGovernanceRuleResult(
...
def getmanagement_group_governance_rule(management_group_id: Optional[str] = None,
                                        rule_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetmanagementGroupGovernanceRuleResult:
    """
    Governance rule over a given scope


    :param str management_group_id: Azure Management Group ID
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/v20220101preview:getmanagementGroupGovernanceRule', __args__, opts=opts, typ=GetmanagementGroupGovernanceRuleResult).value

    return AwaitableGetmanagementGroupGovernanceRuleResult(
...
@_utilities.lift_output_func(getmanagement_group_governance_rule)
def getmanagement_group_governance_rule_output(management_group_id: Optional[pulumi.Input[str]] = None,
                                               rule_id: Optional[pulumi.Input[str]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetmanagementGroupGovernanceRuleResult]:
    """
    Governance rule over a given scope
