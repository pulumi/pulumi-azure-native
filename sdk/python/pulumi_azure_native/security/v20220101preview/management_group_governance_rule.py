...
__all__ = ['ManagementGroupGovernanceRuleArgs', 'ManagementGroupGovernanceRule']

@pulumi.input_type
class ManagementGroupGovernanceRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] management_group_id: Azure Management Group ID
...
class ManagementGroupGovernanceRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ManagementGroupGovernanceRuleArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Governance rule over a given scope

        :param str resource_name: The name of the resource.
        :param ManagementGroupGovernanceRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagementGroupGovernanceRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ManagementGroupGovernanceRuleArgs.__new__(ManagementGroupGovernanceRuleArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ManagementGroupGovernanceRule':
        """
        Get an existing ManagementGroupGovernanceRule resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["tenant_id"] = None
        __props__.__dict__["type"] = None
        return ManagementGroupGovernanceRule(resource_name, opts=opts, __props__=__props__)
