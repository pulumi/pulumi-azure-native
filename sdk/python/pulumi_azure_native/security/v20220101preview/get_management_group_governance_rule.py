...
__all__ = [
    ...
    'get_management_group_governance_rule',
    'get_management_group_governance_rule_output',
]
...
def get_management_group_governance_rule(management_group_id: Optional[str] = None,
...
@_utilities.lift_output_func(get_management_group_governance_rule)
def get_management_group_governance_rule_output(management_group_id: Optional[pulumi.Input[str]] = None,
