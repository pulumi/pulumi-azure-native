...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:security/v20150601preview:AdaptiveApplicationControl":
                return AdaptiveApplicationControl(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20150601preview:JitNetworkAccessPolicy":
    ...
    pulumi.runtime.register_resource_module("azure-native", "security/v20150601preview", _module_instance)
