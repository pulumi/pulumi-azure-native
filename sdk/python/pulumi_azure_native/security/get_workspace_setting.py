...
def get_workspace_setting(workspace_setting_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workspace_setting_name: Name of the security setting
    """
    __args__ = dict()
...
def get_workspace_setting_output(workspace_setting_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
