...
class SecurityConnectorArgs:
    def __init__(__self__, *,
                 ...
                 environment_data: Optional[pulumi.Input[Union['AwsEnvironmentDataArgs', 'AzureDevOpsScopeEnvironmentDataArgs', 'DockerHubEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs', 'GitlabScopeEnvironmentDataArgs', 'JFrogEnvironmentDataArgs']]] = None,
                 environment_name: Optional[pulumi.Input[Union[builtins.str, 'CloudName']]] = None,
                 hierarchy_identifier: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'CloudName']] environment_name: The multi cloud resource's cloud name.
        :param pulumi.Input[builtins.str] hierarchy_identifier: The multi cloud resource identifier (account id in case of AWS connector, project number in case of GCP connector).
    ...
    def environment_data(self, value: Optional[pulumi.Input[Union['AwsEnvironmentDataArgs', 'AzureDevOpsScopeEnvironmentDataArgs', 'DockerHubEnvironmentDataArgs', 'GcpProjectEnvironmentDataArgs', 'GithubScopeEnvironmentDataArgs', 'GitlabScopeEnvironmentDataArgs', 'JFrogEnvironmentDataArgs']]]):
        pulumi.set(self, "environment_data", value)

    @property
    @pulumi.getter(name="environmentName")
    def environment_name(self) -> Optional[pulumi.Input[Union[builtins.str, 'CloudName']]]:
        """
    ...
    def environment_name(self, value: Optional[pulumi.Input[Union[builtins.str, 'CloudName']]]):
        pulumi.set(self, "environment_name", value)

    @property
    @pulumi.getter(name="hierarchyIdentifier")
    def hierarchy_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hierarchy_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_connector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_connector_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityConnector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hierarchyIdentifier")
    def hierarchy_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multi cloud resource identifier (account id in case of AWS connector, project number in case of GCP connector).
        """
        return pulumi.get(self, "hierarchy_identifier")
    ...
    def hierarchy_identifier_trial_end_date(self) -> pulumi.Output[builtins.str]:
        """
