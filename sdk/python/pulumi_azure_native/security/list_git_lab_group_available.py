...
def list_git_lab_group_available(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security:listGitLabGroupAvailable', __args__, opts=opts, typ=ListGitLabGroupAvailableResult).value

    return AwaitableListGitLabGroupAvailableResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_git_lab_group_available_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:security:listGitLabGroupAvailable', __args__, opts=opts, typ=ListGitLabGroupAvailableResult)
