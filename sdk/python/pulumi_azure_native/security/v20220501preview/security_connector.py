...
class SecurityConnectorArgs:
    def __init__(__self__, *,
                 ...
                 offerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorAzureDevOpsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderFoDatabasesAwsOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForDatabasesGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorAzureDevOpsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderFoDatabasesAwsOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForDatabasesGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]] offerings: A collection of offerings for the security connector.
    ...
    @property
    @pulumi.getter
    def offerings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union['CspmMonitorAwsOfferingArgs', 'CspmMonitorAzureDevOpsOfferingArgs', 'CspmMonitorGcpOfferingArgs', 'CspmMonitorGithubOfferingArgs', 'DefenderFoDatabasesAwsOfferingArgs', 'DefenderForContainersAwsOfferingArgs', 'DefenderForContainersGcpOfferingArgs', 'DefenderForDatabasesGcpOfferingArgs', 'DefenderForServersAwsOfferingArgs', 'DefenderForServersGcpOfferingArgs', 'InformationProtectionAwsOfferingArgs']]]]]:
        """
...
class SecurityConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:security:SecurityConnector"), pulumi.Alias(type_="azure-native:security/v20210701preview:SecurityConnector"), pulumi.Alias(type_="azure-native:security/v20211201preview:SecurityConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityConnector, __self__).__init__(
            'azure-native:security/v20220501preview:SecurityConnector',
            resource_name,
            __props__,
            opts)
