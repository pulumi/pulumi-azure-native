...
__all__ = [
    ...
    'DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata',
...
class DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "cloudRoleArn":
            suggest = "cloud_role_arn"
        elif key == "servicePrincipalSecretMetadata":
    ...
    def __init__(__self__, *,
                 ...
                 service_principal_secret_metadata: Optional['outputs.DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata'] = None):
        """
        The ARC autoprovisioning configuration
        :param str cloud_role_arn: The cloud role ARN in AWS for this feature
        :param bool enabled: Is arc auto provisioning enabled
        :param 'DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata' service_principal_secret_metadata: Metadata of Service Principal secret for autoprovisioning
        """
        if cloud_role_arn is not None:
            pulumi.set(__self__, "cloud_role_arn", cloud_role_arn)
    ...
    def service_principal_secret_metadata(self) -> Optional['outputs.DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata']:
        """
...
@pulumi.output_type
class DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata(dict):
    """
    Metadata of Service Principal secret for autoprovisioning
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DefenderFoDatabasesAwsOfferingResponseServicePrincipalSecretMetadata.__key_warning(key)
        return super().__getitem__(key)
...
class DefenderForDatabasesGcpOfferingResponseArcAutoProvisioning(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The ARC autoprovisioning configuration
        :param 'DefenderForDatabasesGcpOfferingResponseConfiguration' configuration: Configuration for ARC autoprovisioning
        :param bool enabled: Is arc auto provisioning enabled
        """
...
class DefenderForServersAwsOfferingResponseConfigurationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 cloud_role_arn: Optional[str] = None,
                 exclusion_tags: Optional[Any] = None,
                 scanning_mode: Optional[str] = None):
        """
        configuration for Microsoft Defender for Server VM scanning
        :param str cloud_role_arn: The cloud role ARN in AWS for this feature
        :param Any exclusion_tags: VM tags that indicates that VM should not be scanned
    ...
    def exclusion_tags(self) -> Optional[Any]:
        """
