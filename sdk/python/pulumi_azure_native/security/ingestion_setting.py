...
class IngestionSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security:IngestionSetting"), pulumi.Alias(type_="azure-native:security/v20210115preview:IngestionSetting"), pulumi.Alias(type_="azure-nextgen:security/v20210115preview:IngestionSetting")])
