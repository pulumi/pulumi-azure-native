...
def get_security_contact(security_contact_name: Optional[_builtins.str] = None,
...
def get_security_contact_output(security_contact_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
