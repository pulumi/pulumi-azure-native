...
class AssessmentMetadataInSubscriptionArgs:
    ...
    def _configure(
        ...
        if 'assessmentMetadataName' in kwargs:
        ...
        if 'plannedDeprecationDate' in kwargs:
            planned_deprecation_date = kwargs['plannedDeprecationDate']
        if 'publishDates' in kwargs:
...
class AssessmentMetadataInSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if partner_data is not None and not isinstance(partner_data, SecurityAssessmentMetadataPartnerDataArgs):
            ...
            if publish_dates is not None and not isinstance(publish_dates, SecurityAssessmentMetadataPropertiesResponsePublishDatesArgs):
