...
class SecurityOperatorArgs:
    def __init__(__self__, *,
                 pricing_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] pricing_name: name of the pricing configuration
        :param pulumi.Input[builtins.str] security_operator_name: name of the securityOperator
        """
    ...
    def pricing_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pricing_name.setter
    def pricing_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pricing_name", value)

    @property
    @pulumi.getter(name="securityOperatorName")
    def security_operator_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_operator_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityOperator(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 pricing_name: Optional[pulumi.Input[builtins.str]] = None,
                 security_operator_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
