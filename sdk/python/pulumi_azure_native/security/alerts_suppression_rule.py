...
class AlertsSuppressionRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if suppression_alerts_scope is not None and not isinstance(suppression_alerts_scope, SuppressionAlertsScopeArgs):
