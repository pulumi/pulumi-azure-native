...
class AlertsSuppressionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RuleState'] state: Possible states of the rule
    ...
    @_builtins.property
    @pulumi.getter
    def state(self) -> pulumi.Input['RuleState']:
        """
    ...
    @state.setter
    def state(self, value: pulumi.Input['RuleState']):
