...
class GetGovernanceRuleResult:
    ...
    def include_member_scopes(self) -> Optional[builtins.bool]:
        """
    ...
    def remediation_timeframe(self) -> Optional[builtins.str]:
        """
    ...
    def rule_priority(self) -> builtins.int:
        """
...
def get_governance_rule(rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_id: The governance rule key - unique key for the standard governance rule (GUID)
    :param builtins.str scope: The scope of the Governance rules. Valid scopes are: management group (format: 'providers/Microsoft.Management/managementGroups/{managementGroup}'), subscription (format: 'subscriptions/{subscriptionId}'), or security connector (format: 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName})'
    """
    __args__ = dict()
...
def get_governance_rule_output(rule_id: Optional[pulumi.Input[builtins.str]] = None,
