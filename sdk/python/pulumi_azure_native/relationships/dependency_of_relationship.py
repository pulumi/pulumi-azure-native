...
__all__ = ['DependencyOfRelationshipArgs', 'DependencyOfRelationship']
...
class DependencyOfRelationshipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of dependencyOf relationship.
...
class DependencyOfRelationship(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] name: Name of dependencyOf relationship.
        :param pulumi.Input[Union['DependencyOfRelationshipPropertiesArgs', 'DependencyOfRelationshipPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_uri: The fully qualified Azure Resource manager identifier of the resource.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DependencyOfRelationshipArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relationships/v20230901preview:DependencyOfRelationship")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DependencyOfRelationship, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DependencyOfRelationship':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DependencyOfRelationship(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DependencyOfRelationshipPropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
