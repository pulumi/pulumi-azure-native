...
class GuestSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GuestSubscriptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:computelimit/v20250815:GuestSubscription"), pulumi.Alias(type_="azure-native:computelimit/v20260320:GuestSubscription"), pulumi.Alias(type_="azure-native:computelimit/v20260430:GuestSubscription"), pulumi.Alias(type_="azure-native:computelimit/v20260601:GuestSubscription"), pulumi.Alias(type_="azure-native:computelimit/v20260701:GuestSubscription"), pulumi.Alias(type_="azure-native:computelimit/v20260731:GuestSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestSubscription, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GuestSubscription':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return GuestSubscription(resource_name, opts=opts, __props__=__props__)
