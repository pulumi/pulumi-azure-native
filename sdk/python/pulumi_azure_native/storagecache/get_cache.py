...
class GetCacheResult:
    ...
    def cache_size_gb(self) -> Optional[builtins.int]:
        """
    ...
    def mount_addresses(self) -> Sequence[builtins.str]:
        """
...
def get_cache(cache_name: Optional[builtins.str] = None,
...
def get_cache_output(cache_name: Optional[pulumi.Input[builtins.str]] = None,
