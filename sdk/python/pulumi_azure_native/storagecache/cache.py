...
class CacheArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Region name string.
        ...
        :param pulumi.Input[_builtins.str] subnet: Subnet used for the cache.
