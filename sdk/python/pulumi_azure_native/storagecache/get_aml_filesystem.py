...
class GetAmlFilesystemResult:
    ...
    def filesystem_subnet(self) -> builtins.str:
        """
    ...
    def storage_capacity_ti_b(self) -> builtins.float:
        """
    ...
    def throughput_provisioned_m_bps(self) -> builtins.int:
        """
...
def get_aml_filesystem(aml_filesystem_name: Optional[builtins.str] = None,
...
def get_aml_filesystem_output(aml_filesystem_name: Optional[pulumi.Input[builtins.str]] = None,
