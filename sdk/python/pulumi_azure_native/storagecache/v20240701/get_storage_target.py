...
def get_storage_target(cache_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20240701:getStorageTarget', __args__, opts=opts, typ=GetStorageTargetResult).value
...
def get_storage_target_output(cache_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagecache/v20240701:getStorageTarget', __args__, opts=opts, typ=GetStorageTargetResult)
