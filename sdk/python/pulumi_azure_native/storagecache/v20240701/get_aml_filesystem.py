...
def get_aml_filesystem(aml_filesystem_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20240701:getAmlFilesystem', __args__, opts=opts, typ=GetAmlFilesystemResult).value
...
def get_aml_filesystem_output(aml_filesystem_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagecache/v20240701:getAmlFilesystem', __args__, opts=opts, typ=GetAmlFilesystemResult)
