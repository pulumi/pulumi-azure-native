...
class GetImportJobResult:
    ...
    """
    def __init__(__self__, admin_status=None, blobs_imported_per_second=None, blobs_walked_per_second=None, conflict_resolution_mode=None, id=None, import_prefixes=None, imported_directories=None, imported_files=None, imported_symlinks=None, last_completion_time=None, last_started_time=None, location=None, maximum_errors=None, name=None, preexisting_directories=None, preexisting_files=None, preexisting_symlinks=None, provisioning_state=None, state=None, status_message=None, system_data=None, tags=None, total_blobs_imported=None, total_blobs_walked=None, total_conflicts=None, total_errors=None, type=None):
    ...
    def imported_directories(self) -> float:
        """
    ...
    def imported_symlinks(self) -> float:
        """
    ...
    def preexisting_directories(self) -> float:
        """
    ...
    def preexisting_files(self) -> float:
        """
    ...
    def preexisting_symlinks(self) -> float:
        """
...
def get_import_job(aml_filesystem_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20240701:getImportJob', __args__, opts=opts, typ=GetImportJobResult).value
...
def get_import_job_output(aml_filesystem_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagecache/v20240701:getImportJob', __args__, opts=opts, typ=GetImportJobResult)
