...
def get_storage_target(cache_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20231101preview:getStorageTarget', __args__, opts=opts, typ=GetStorageTargetResult).value
...
def get_storage_target_output(cache_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageTargetName'] = storage_target_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagecache/v20231101preview:getStorageTarget', __args__, opts=opts, typ=GetStorageTargetResult)
