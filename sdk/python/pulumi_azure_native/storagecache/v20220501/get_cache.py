...
def get_cache(cache_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cache is deprecated: azure-native:storagecache/v20220501:Cache is being removed in the next major version of this provider. Please upgrade to azure-native:storagecache/v20230301preview:Cache to guarantee forwards compatibility.""")
    __args__ = dict()
