...
class GetImportJobResult:
    ...
    def blobs_imported_per_second(self) -> builtins.float:
        """
    ...
    def blobs_walked_per_second(self) -> builtins.float:
        """
    ...
    def import_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def maximum_errors(self) -> Optional[builtins.int]:
        """
    ...
    def total_conflicts(self) -> builtins.int:
        """
    ...
    def total_errors(self) -> builtins.int:
        """
...
def get_import_job(aml_filesystem_name: Optional[builtins.str] = None,
                   import_job_name: Optional[builtins.str] = None,
    ...
    :param builtins.str import_job_name: Name for the import job. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric.
...
def get_import_job_output(aml_filesystem_name: Optional[pulumi.Input[builtins.str]] = None,
                          import_job_name: Optional[pulumi.Input[builtins.str]] = None,
