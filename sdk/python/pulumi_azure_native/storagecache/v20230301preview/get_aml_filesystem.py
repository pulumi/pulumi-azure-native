...
def get_aml_filesystem(aml_filesystem_name: Optional[str] = None,
    ...
    return AwaitableGetAmlFilesystemResult(
        ...
        lustre_version=pulumi.get(__ret__, 'lustre_version'),
        maintenance_window=pulumi.get(__ret__, 'maintenance_window'),
        mgs_address=pulumi.get(__ret__, 'mgs_address'),
        mount_command=pulumi.get(__ret__, 'mount_command'),
...
def get_aml_filesystem_output(aml_filesystem_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storagecache/v20230301preview:getAmlFilesystem', __args__, opts=opts, typ=GetAmlFilesystemResult)
    return __ret__.apply(lambda __response__: GetAmlFilesystemResult(
        ...
        lustre_version=pulumi.get(__response__, 'lustre_version'),
        maintenance_window=pulumi.get(__response__, 'maintenance_window'),
        mgs_address=pulumi.get(__response__, 'mgs_address'),
        mount_command=pulumi.get(__response__, 'mount_command'),
