...
class AmlFilesystem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagecache:AmlFilesystem"), pulumi.Alias(type_="azure-native:storagecache/v20230501:AmlFilesystem"), pulumi.Alias(type_="azure-native:storagecache/v20231101preview:AmlFilesystem"), pulumi.Alias(type_="azure-native:storagecache/v20240301:AmlFilesystem")])
