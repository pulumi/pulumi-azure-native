...
class Cache(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(directory_services_settings, CacheDirectorySettingsArgs):
            ...
            if not isinstance(encryption_settings, CacheEncryptionSettingsArgs):
            ...
            if not isinstance(identity, CacheIdentityArgs):
            ...
            if not isinstance(network_settings, CacheNetworkSettingsArgs):
            ...
            if not isinstance(security_settings, CacheSecuritySettingsArgs):
            ...
            if not isinstance(sku, CacheSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
            ...
            if not isinstance(upgrade_settings, CacheUpgradeSettingsArgs):
