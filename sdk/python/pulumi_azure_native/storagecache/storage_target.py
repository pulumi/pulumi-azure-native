...
class StorageTargetArgs:
    def __init__(__self__, *,
                 ...
                 target_type: pulumi.Input[Union[builtins.str, 'StorageTargetType']],
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'OperationalStateType']]] = None,
        ...
        :param pulumi.Input[builtins.str] cache_name: Name of cache. Length of name must not be greater than 80 and chars must be from the [-0-9a-zA-Z_] char class.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union[builtins.str, 'StorageTargetType']] target_type: Type of the Storage Target.
        ...
        :param pulumi.Input[Union[builtins.str, 'OperationalStateType']] state: Storage target operational state.
        :param pulumi.Input[builtins.str] storage_target_name: Name of Storage Target.
    ...
    def target_type(self) -> pulumi.Input[Union[builtins.str, 'StorageTargetType']]:
        """
    ...
    @target_type.setter
    def target_type(self, value: pulumi.Input[Union[builtins.str, 'StorageTargetType']]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'OperationalStateType']]]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'OperationalStateType']]]):
        pulumi.set(self, "state", value)

    @property
    @pulumi.getter(name="storageTargetName")
    def storage_target_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_target_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageTarget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'OperationalStateType']]] = None,
                 storage_target_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_type: Optional[pulumi.Input[Union[builtins.str, 'StorageTargetType']]] = None,
    ...
    def allocation_percentage(self) -> pulumi.Output[builtins.int]:
        """
