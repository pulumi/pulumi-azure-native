...
class StorageTarget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(blob_nfs, BlobNfsTargetArgs):
            ...
            if not isinstance(clfs, ClfsTargetArgs):
                clfs = clfs or {}
                def _setter(key, value):
                    clfs[key] = value
            ...
            if not isinstance(nfs3, Nfs3TargetArgs):
                nfs3 = nfs3 or {}
                def _setter(key, value):
                    nfs3[key] = value
            ...
            if not isinstance(unknown, UnknownTargetArgs):
                unknown = unknown or {}
                def _setter(key, value):
                    unknown[key] = value
