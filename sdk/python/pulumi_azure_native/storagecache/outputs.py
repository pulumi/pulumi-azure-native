...
class AmlFilesystemArchiveResponseStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_started_time: The time the latest archive operation started
        :param _builtins.int percent_complete: The completion percentage of the archive operation
        :param _builtins.str state: The state of the archive operation
        """
...
class AmlFilesystemClientInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str mount_command: Recommended command to mount the AML file system
        """
...
class AmlFilesystemRootSquashSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 no_squash_nid_lists: Optional[_builtins.str] = None,
                 squash_gid: Optional[_builtins.float] = None,
        ...
        :param _builtins.float squash_gid: Group ID to squash to.
        :param _builtins.float squash_uid: User ID to squash to.
        """
        pulumi.set(__self__, "status", status)
        if mode is not None:
...
class AutoImportJobResponseBlobSyncEvents(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float imported_symlinks: Number of symlinks imported during auto import.
        :param _builtins.str last_change_feed_event_consumed_time: Date and time of the last Change Feed event consumed.
        :param _builtins.str last_time_fully_synchronized: Date and time when last fully synchronized.
        :param _builtins.float preexisting_directories: Number of preexisting directories during auto import.
        :param _builtins.float preexisting_files: Number of preexisting files during auto import.
        :param _builtins.float preexisting_symlinks: Number of preexisting symlinks during auto import.
        :param _builtins.float rate_of_blob_import: Rate of blob import per second during auto import.
        :param _builtins.float total_blobs_imported: Total number of blobs imported during auto import.
        :param _builtins.float total_conflicts: Total conflicts encountered during auto import.
        :param _builtins.float total_errors: Total errors encountered during auto import.
        """
...
class BlobNfsTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 verification_timer: Optional[_builtins.int] = None,
        ...
        :param _builtins.int write_back_timer: Amount of time (in seconds) the cache waits after the last file change before it copies the changed file to back-end storage.
        """
...
class CacheActiveDirectorySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str domain_net_bios_name: The Active Directory domain's NetBIOS name.
        :param _builtins.str primary_dns_ip_address: Primary DNS IP address used to resolve the Active Directory domain controller's fully qualified domain name.
        ...
        :param _builtins.str secondary_dns_ip_address: Secondary DNS IP address used to resolve the Active Directory domain controller's fully qualified domain name.
        """
...
class CacheNetworkSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dns_search_domain: Optional[_builtins.str] = None,
        ...
        :param _builtins.int mtu: The IPv4 maximum transmission unit configured for the subnet.
        :param _builtins.str ntp_server: NTP server IP Address or FQDN for the cache to use. The default is time.windows.com.
        """
...
class CacheUpgradeStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_firmware_update: Time of the last successful firmware update.
        :param _builtins.str pending_firmware_version: When firmwareUpdateAvailable is true, this field holds the version string for the update.
        """
...
class CacheUsernameDownloadSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_download_certificate: Optional[_builtins.bool] = None,
                 ca_certificate_uri: Optional[_builtins.str] = None,
                 credentials: Optional['outputs.CacheUsernameDownloadSettingsResponseCredentials'] = None,
                 encrypt_ldap_connection: Optional[_builtins.bool] = None,
                 extended_groups: Optional[_builtins.bool] = None,
                 group_file_uri: Optional[_builtins.str] = None,
                 ldap_base_dn: Optional[_builtins.str] = None,
                 ldap_server: Optional[_builtins.str] = None,
                 require_valid_certificate: Optional[_builtins.bool] = None,
                 user_file_uri: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool encrypt_ldap_connection: Whether or not the LDAP connection should be encrypted.
        :param _builtins.bool extended_groups: Whether or not Extended Groups is enabled.
        :param _builtins.str group_file_uri: The URI of the file containing group information (in /etc/group file format). This field must be populated when 'usernameSource' is set to 'File'.
        :param _builtins.str ldap_base_dn: The base distinguished name for the LDAP domain.
        :param _builtins.str ldap_server: The fully qualified domain name or IP address of the LDAP server to use.
        :param _builtins.bool require_valid_certificate: Determines if the certificates must be validated by a certificate authority. When true, caCertificateURI must be provided.
        :param _builtins.str user_file_uri: The URI of the file containing user information (in /etc/passwd file format). This field must be populated when 'usernameSource' is set to 'File'.
        :param _builtins.str username_source: This setting determines how the cache gets username and group names for clients.
        """
...
class NamespaceJunctionResponse(dict):
    ...
    def __init__(__self__, *,
                 namespace_path: Optional[_builtins.str] = None,
                 nfs_access_policy: Optional[_builtins.str] = None,
                 nfs_export: Optional[_builtins.str] = None,
        ...
        :param _builtins.str target_path: Path in Storage Target to which namespacePath points.
        """
...
class NfsAccessRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scope: _builtins.str,
                 anonymous_gid: Optional[_builtins.str] = None,
                 anonymous_uid: Optional[_builtins.str] = None,
                 filter: Optional[_builtins.str] = None,
                 root_squash: Optional[_builtins.bool] = None,
                 submount_access: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str anonymous_uid: UID value that replaces 0 when rootSquash is true. 65534 will be used if not provided.
        :param _builtins.str filter: Filter applied to the scope for this rule. The filter's format depends on its scope. 'default' scope matches all clients and has no filter value. 'network' scope takes a filter in CIDR format (for example, 10.99.1.0/24). 'host' takes an IP address or fully qualified domain name as filter. If a client does not match any filter rule and there is no default rule, access is denied.
        :param _builtins.bool root_squash: Map root accesses to anonymousUID and anonymousGID.
        :param _builtins.bool submount_access: For the default policy, allow access to subdirectories under the root export. If this is set to no, clients can only mount the path '/'. If set to yes, clients can mount a deeper path, like '/a/b'.
        :param _builtins.bool suid: Allow SUID semantics.
        """
...
class PrimingJobResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float priming_job_percent_complete: The current progress of the priming job, as a percentage.
        :param _builtins.str priming_job_state: The state of the priming operation.
        :param _builtins.str priming_job_status: The status code of the priming job.
        """
...
class StorageTargetSpaceAllocationResponse(dict):
    ...
    def __init__(__self__, *,
                 allocation_percentage: Optional[_builtins.int] = None,
                 name: Optional[_builtins.str] = None):
        """
        Storage Target space allocation properties.
