...
class AmlFilesystemArchiveResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Information about the AML file system archive
        :param builtins.str filesystem_path: Lustre file system path to archive relative to the file system root.  Specify '/' to archive all modified data.
...
class AmlFilesystemArchiveResponseStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_completion_time: builtins.str,
                 last_started_time: builtins.str,
                 percent_complete: builtins.int,
                 state: builtins.str):
        """
        The status of the archive
        :param builtins.str error_code: Server-defined error code for the archive operation
        :param builtins.str error_message: Server-defined error message for the archive operation
        :param builtins.str last_completion_time: The time of the last completed archive operation
        :param builtins.str last_started_time: The time the latest archive operation started
        :param builtins.int percent_complete: The completion percentage of the archive operation
        :param builtins.str state: The state of the archive operation
        """
    ...
    def last_completion_time(self) -> builtins.str:
        """
    ...
    def last_started_time(self) -> builtins.str:
        """
...
class AmlFilesystemClientInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lustre_version: builtins.str,
                 mgs_address: builtins.str,
                 mount_command: builtins.str):
        """
        AML file system client information
        ...
        :param builtins.str lustre_version: The version of Lustre running in the AML file system
        :param builtins.str mgs_address: The IPv4 address used by clients to mount the AML file system's Lustre Management Service (MGS).
        :param builtins.str mount_command: Recommended command to mount the AML file system
        """
    ...
    def lustre_version(self) -> builtins.str:
        """
    ...
    def mount_command(self) -> builtins.str:
        """
...
class AmlFilesystemContainerStorageInterfaceResponse(dict):
    ...
    def __init__(__self__, *,
                 persistent_volume: builtins.str,
                 persistent_volume_claim: builtins.str,
                 storage_class: builtins.str):
        """
        AML file system container storage interface information
        :param builtins.str persistent_volume: Recommended AKS Persistent Volume for the CSI driver, in Base64 encoded YAML
        :param builtins.str persistent_volume_claim: Recommended AKS Persistent Volume Claim for the CSI driver, in Base64 encoded YAML
        :param builtins.str storage_class: Recommended AKS Storage Class for the CSI driver, in Base64 encoded YAML
        """
    ...
    def persistent_volume(self) -> builtins.str:
        """
    ...
    def persistent_volume_claim(self) -> builtins.str:
        """
...
class AmlFilesystemHealthResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status_description: Optional[builtins.str] = None):
        """
        An indication of AML file system health. Gives more information about health than just that related to provisioning.
        :param builtins.str state: List of AML file system health states.
        :param builtins.str status_code: Server-defined error code for the AML file system health
        :param builtins.str status_description: Describes the health state.
        """
...
class AmlFilesystemHsmSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 logging_container: builtins.str,
                 import_prefix: Optional[builtins.str] = None,
                 import_prefixes_initial: Optional[Sequence[builtins.str]] = None):
        """
        AML file system HSM settings.
        :param builtins.str container: Resource ID of storage container used for hydrating the namespace and archiving from the namespace. The resource provider must have permission to create SAS tokens on the storage account.
        :param builtins.str logging_container: Resource ID of storage container used for logging events and errors.  Must be a separate container in the same storage account as the hydration and archive container. The resource provider must have permission to create SAS tokens on the storage account.
        :param builtins.str import_prefix: Only blobs in the non-logging container that start with this path/prefix get imported into the cluster namespace. This is only used during initial creation of the AML file system. It automatically creates an import job resource that can be deleted.
        :param Sequence[builtins.str] import_prefixes_initial: Only blobs in the non-logging container that start with one of the paths/prefixes in this array get imported into the cluster namespace. This is only used during initial creation of the AML file system and has '/' as the default value. It automatically creates an import job resource that can be deleted.
        """
    ...
    def logging_container(self) -> builtins.str:
        """
    ...
    def import_prefixes_initial(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AmlFilesystemIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Managed Identity properties.
        :param builtins.str principal_id: The principal ID for the user-assigned identity of the resource.
        :param builtins.str tenant_id: The tenant ID associated with the resource.
...
class AmlFilesystemResponseMaintenanceWindow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_of_day_utc: Optional[builtins.str] = None):
        """
        Start time of a 30-minute weekly maintenance window.
        :param builtins.str day_of_week: Day of the week on which the maintenance window will occur.
        :param builtins.str time_of_day_utc: The time of day (in UTC) to start the maintenance window.
        """
    ...
    def time_of_day_utc(self) -> Optional[builtins.str]:
        """
...
class AmlFilesystemRootSquashSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 no_squash_nid_lists: Optional[builtins.str] = None,
                 squash_gid: Optional[builtins.float] = None,
                 squash_uid: Optional[builtins.float] = None):
        """
        AML file system squash settings.
        :param builtins.str status: AML file system squash status.
        :param builtins.str mode: Squash mode of the AML file system. 'All': User and Group IDs on files will be squashed to the provided values for all users on non-trusted systems. 'RootOnly': User and Group IDs on files will be squashed to provided values for solely the root user on non-trusted systems. 'None': No squashing of User and Group IDs is performed for any users on any systems.
        :param builtins.str no_squash_nid_lists: Semicolon separated NID IP Address list(s) to be added to the TrustedSystems.
        :param builtins.float squash_gid: Group ID to squash to.
        :param builtins.float squash_uid: User ID to squash to.
        """
        pulumi.set(__self__, "status", status)
        if mode is not None:
    ...
    def no_squash_nid_lists(self) -> Optional[builtins.str]:
        """
    ...
    def squash_gid(self) -> Optional[builtins.float]:
        """
    ...
    def squash_uid(self) -> Optional[builtins.float]:
        """
...
class BlobNfsTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 verification_timer: Optional[builtins.int] = None,
                 write_back_timer: Optional[builtins.int] = None):
        """
        Properties pertaining to the BlobNfsTarget.
        :param builtins.str target: Resource ID of the storage container.
        :param builtins.str usage_model: Identifies the StorageCache usage model to be used for this storage target.
        :param builtins.int verification_timer: Amount of time (in seconds) the cache waits before it checks the back-end storage for file updates.
        :param builtins.int write_back_timer: Amount of time (in seconds) the cache waits after the last file change before it copies the changed file to back-end storage.
        """
    ...
    def verification_timer(self) -> Optional[builtins.int]:
        """
    ...
    def write_back_timer(self) -> Optional[builtins.int]:
        """
...
class CacheActiveDirectorySettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 cache_net_bios_name: builtins.str,
                 domain_joined: builtins.str,
                 domain_name: builtins.str,
                 domain_net_bios_name: builtins.str,
                 primary_dns_ip_address: builtins.str,
                 credentials: Optional['outputs.CacheActiveDirectorySettingsResponseCredentials'] = None,
                 secondary_dns_ip_address: Optional[builtins.str] = None):
        """
        Active Directory settings used to join a cache to a domain.
        :param builtins.str cache_net_bios_name: The NetBIOS name to assign to the HPC Cache when it joins the Active Directory domain as a server. Length must 1-15 characters from the class [-0-9a-zA-Z].
        :param builtins.str domain_joined: True if the HPC Cache is joined to the Active Directory domain.
        :param builtins.str domain_name: The fully qualified domain name of the Active Directory domain controller.
        :param builtins.str domain_net_bios_name: The Active Directory domain's NetBIOS name.
        :param builtins.str primary_dns_ip_address: Primary DNS IP address used to resolve the Active Directory domain controller's fully qualified domain name.
        ...
        :param builtins.str secondary_dns_ip_address: Secondary DNS IP address used to resolve the Active Directory domain controller's fully qualified domain name.
        """
    ...
    def cache_net_bios_name(self) -> builtins.str:
        """
    ...
    def domain_joined(self) -> builtins.str:
        """
    ...
    def domain_net_bios_name(self) -> builtins.str:
        """
    ...
    def primary_dns_ip_address(self) -> builtins.str:
        """
    ...
    def secondary_dns_ip_address(self) -> Optional[builtins.str]:
        """
...
class CacheActiveDirectorySettingsResponseCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Active Directory admin credentials used to join the HPC Cache to a domain.
        :param builtins.str username: Username of the Active Directory domain administrator. This value is stored encrypted and not returned on response.
        :param builtins.str password: Plain text password of the Active Directory domain administrator. This value is stored encrypted and not returned on response.
        """
...
class CacheEncryptionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 key_encryption_key: Optional['outputs.KeyVaultKeyReferenceResponse'] = None,
                 rotation_to_latest_key_version_enabled: Optional[builtins.bool] = None):
        """
        Cache encryption settings.
        :param 'KeyVaultKeyReferenceResponse' key_encryption_key: Specifies the location of the key encryption key in key vault.
        :param builtins.bool rotation_to_latest_key_version_enabled: Specifies whether the service will automatically rotate to the newest version of the key in the key vault.
        """
        if key_encryption_key is not None:
            pulumi.set(__self__, "key_encryption_key", key_encryption_key)
    ...
    def rotation_to_latest_key_version_enabled(self) -> Optional[builtins.bool]:
        """
...
class CacheHealthResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str state: List of cache health states. Down is when the cluster is not responding.  Degraded is when its functioning but has some alerts. Transitioning when it is creating or deleting. Unknown will be returned in old api versions when a new value is added in future versions. WaitingForKey is when the create is waiting for the system assigned identity to be given access to the encryption key in the encryption settings.
        :param builtins.str status_description: Describes explanation of state.
        """
...
class CacheIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cache identity properties.
        :param builtins.str principal_id: The principal ID for the system-assigned identity of the cache.
        :param builtins.str tenant_id: The tenant ID associated with the cache.
        :param builtins.str type: The type of identity used for the cache
...
class CacheNetworkSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 utility_addresses: Sequence[builtins.str],
                 dns_search_domain: Optional[builtins.str] = None,
                 dns_servers: Optional[Sequence[builtins.str]] = None,
                 mtu: Optional[builtins.int] = None,
                 ntp_server: Optional[builtins.str] = None):
        """
        Cache network settings.
        :param Sequence[builtins.str] utility_addresses: Array of additional IP addresses used by this cache.
        :param builtins.str dns_search_domain: DNS search domain
        :param Sequence[builtins.str] dns_servers: DNS servers for the cache to use.  It will be set from the network configuration if no value is provided.
        :param builtins.int mtu: The IPv4 maximum transmission unit configured for the subnet.
        :param builtins.str ntp_server: NTP server IP Address or FQDN for the cache to use. The default is time.windows.com.
        """
    ...
    def utility_addresses(self) -> Sequence[builtins.str]:
        """
    ...
    def dns_search_domain(self) -> Optional[builtins.str]:
        """
        DNS search domain
        """
    ...
    def ntp_server(self) -> Optional[builtins.str]:
        """
...
class CacheResponseSku(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SKU for the cache.
        :param builtins.str name: SKU name for this cache.
        """
        if name is not None:
...
class CacheUpgradeSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 scheduled_time: Optional[builtins.str] = None,
                 upgrade_schedule_enabled: Optional[builtins.bool] = None):
        """
        Cache Upgrade Settings.
        :param builtins.str scheduled_time: When upgradeScheduleEnabled is true, this field holds the user-chosen upgrade time. At the user-chosen time, the firmware update will automatically be installed on the cache.
        :param builtins.bool upgrade_schedule_enabled: True if the user chooses to select an installation time between now and firmwareUpdateDeadline. Else the firmware will automatically be installed after firmwareUpdateDeadline if not triggered earlier via the upgrade operation.
        """
    ...
    def scheduled_time(self) -> Optional[builtins.str]:
        """
    ...
    def upgrade_schedule_enabled(self) -> Optional[builtins.bool]:
        """
...
class CacheUpgradeStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 current_firmware_version: builtins.str,
                 firmware_update_deadline: builtins.str,
                 firmware_update_status: builtins.str,
                 last_firmware_update: builtins.str,
                 pending_firmware_version: builtins.str):
        """
        Properties describing the software upgrade state of the cache.
        :param builtins.str current_firmware_version: Version string of the firmware currently installed on this cache.
        :param builtins.str firmware_update_deadline: Time at which the pending firmware update will automatically be installed on the cache.
        :param builtins.str firmware_update_status: True if there is a firmware update ready to install on this cache. The firmware will automatically be installed after firmwareUpdateDeadline if not triggered earlier via the upgrade operation.
        :param builtins.str last_firmware_update: Time of the last successful firmware update.
        :param builtins.str pending_firmware_version: When firmwareUpdateAvailable is true, this field holds the version string for the update.
        """
    ...
    def current_firmware_version(self) -> builtins.str:
        """
    ...
    def firmware_update_deadline(self) -> builtins.str:
        """
    ...
    def firmware_update_status(self) -> builtins.str:
        """
    ...
    def last_firmware_update(self) -> builtins.str:
        """
    ...
    def pending_firmware_version(self) -> builtins.str:
        """
...
class CacheUsernameDownloadSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 username_downloaded: builtins.str,
                 auto_download_certificate: Optional[builtins.bool] = None,
                 ca_certificate_uri: Optional[builtins.str] = None,
                 credentials: Optional['outputs.CacheUsernameDownloadSettingsResponseCredentials'] = None,
                 encrypt_ldap_connection: Optional[builtins.bool] = None,
                 extended_groups: Optional[builtins.bool] = None,
                 group_file_uri: Optional[builtins.str] = None,
                 ldap_base_dn: Optional[builtins.str] = None,
                 ldap_server: Optional[builtins.str] = None,
                 require_valid_certificate: Optional[builtins.bool] = None,
                 user_file_uri: Optional[builtins.str] = None,
                 username_source: Optional[builtins.str] = None):
        """
        Settings for Extended Groups username and group download.
        :param builtins.str username_downloaded: Indicates whether or not the HPC Cache has performed the username download successfully.
        :param builtins.bool auto_download_certificate: Determines if the certificate should be automatically downloaded. This applies to 'caCertificateURI' only if 'requireValidCertificate' is true.
        :param builtins.str ca_certificate_uri: The URI of the CA certificate to validate the LDAP secure connection. This field must be populated when 'requireValidCertificate' is set to true.
        ...
        :param builtins.bool encrypt_ldap_connection: Whether or not the LDAP connection should be encrypted.
        :param builtins.bool extended_groups: Whether or not Extended Groups is enabled.
        :param builtins.str group_file_uri: The URI of the file containing group information (in /etc/group file format). This field must be populated when 'usernameSource' is set to 'File'.
        :param builtins.str ldap_base_dn: The base distinguished name for the LDAP domain.
        :param builtins.str ldap_server: The fully qualified domain name or IP address of the LDAP server to use.
        :param builtins.bool require_valid_certificate: Determines if the certificates must be validated by a certificate authority. When true, caCertificateURI must be provided.
        :param builtins.str user_file_uri: The URI of the file containing user information (in /etc/passwd file format). This field must be populated when 'usernameSource' is set to 'File'.
        :param builtins.str username_source: This setting determines how the cache gets username and group names for clients.
        """
    ...
    def username_downloaded(self) -> builtins.str:
        """
    ...
    def auto_download_certificate(self) -> Optional[builtins.bool]:
        """
    ...
    def ca_certificate_uri(self) -> Optional[builtins.str]:
        """
    ...
    def encrypt_ldap_connection(self) -> Optional[builtins.bool]:
        """
    ...
    def extended_groups(self) -> Optional[builtins.bool]:
        """
    ...
    def group_file_uri(self) -> Optional[builtins.str]:
        """
    ...
    def ldap_base_dn(self) -> Optional[builtins.str]:
        """
    ...
    def ldap_server(self) -> Optional[builtins.str]:
        """
    ...
    def require_valid_certificate(self) -> Optional[builtins.bool]:
        """
    ...
    def user_file_uri(self) -> Optional[builtins.str]:
        """
    ...
    def username_source(self) -> Optional[builtins.str]:
        """
...
class CacheUsernameDownloadSettingsResponseCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        When present, these are the credentials for the secure LDAP connection.
        :param builtins.str bind_dn: The Bind Distinguished Name identity to be used in the secure LDAP connection. This value is stored encrypted and not returned on response.
        :param builtins.str bind_password: The Bind password to be used in the secure LDAP connection. This value is stored encrypted and not returned on response.
        """
...
class ClfsTargetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties pertaining to the ClfsTarget
        :param builtins.str target: Resource ID of storage container.
        """
        if target is not None:
            pulumi.set(__self__, "target", target)
...
class ConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Outstanding conditions that will need to be resolved.
        :param builtins.str message: The issue requiring attention.
        :param builtins.str timestamp: The time when the condition was raised.
        """
...
class NamespaceJunctionResponse(dict):
    ...
    def __init__(__self__, *,
                 namespace_path: Optional[builtins.str] = None,
                 nfs_access_policy: Optional[builtins.str] = None,
                 nfs_export: Optional[builtins.str] = None,
                 target_path: Optional[builtins.str] = None):
        """
        A namespace junction.
        :param builtins.str namespace_path: Namespace path on a cache for a Storage Target.
        :param builtins.str nfs_access_policy: Name of the access policy applied to this junction.
        :param builtins.str nfs_export: NFS export where targetPath exists.
        :param builtins.str target_path: Path in Storage Target to which namespacePath points.
        """
    ...
    def namespace_path(self) -> Optional[builtins.str]:
        """
    ...
    def nfs_access_policy(self) -> Optional[builtins.str]:
        """
    ...
    def nfs_export(self) -> Optional[builtins.str]:
        """
...
class Nfs3TargetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties pertaining to the Nfs3Target
        :param builtins.str target: IP address or host name of an NFSv3 host (e.g., 10.0.44.44).
        :param builtins.str usage_model: Identifies the StorageCache usage model to be used for this storage target.
        :param builtins.int verification_timer: Amount of time (in seconds) the cache waits before it checks the back-end storage for file updates.
        :param builtins.int write_back_timer: Amount of time (in seconds) the cache waits after the last file change before it copies the changed file to back-end storage.
        """
...
class NfsAccessPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name identifying this policy. Access Policy names are not case sensitive.
        """
...
class NfsAccessRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 root_squash: Optional[builtins.bool] = None,
                 submount_access: Optional[builtins.bool] = None,
                 suid: Optional[builtins.bool] = None):
        """
        Rule to place restrictions on portions of the cache namespace being presented to clients.
        :param builtins.str access: Access allowed by this rule.
        :param builtins.str scope: Scope for this rule. The scope and filter determine which clients match the rule.
        :param builtins.str anonymous_gid: GID value that replaces 0 when rootSquash is true. This will use the value of anonymousUID if not provided.
        :param builtins.str anonymous_uid: UID value that replaces 0 when rootSquash is true. 65534 will be used if not provided.
        :param builtins.str filter: Filter applied to the scope for this rule. The filter's format depends on its scope. 'default' scope matches all clients and has no filter value. 'network' scope takes a filter in CIDR format (for example, 10.99.1.0/24). 'host' takes an IP address or fully qualified domain name as filter. If a client does not match any filter rule and there is no default rule, access is denied.
        :param builtins.bool root_squash: Map root accesses to anonymousUID and anonymousGID.
        :param builtins.bool submount_access: For the default policy, allow access to subdirectories under the root export. If this is set to no, clients can only mount the path '/'. If set to yes, clients can mount a deeper path, like '/a/b'.
        :param builtins.bool suid: Allow SUID semantics.
        """
    ...
    def root_squash(self) -> Optional[builtins.bool]:
        """
    ...
    def submount_access(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def suid(self) -> Optional[builtins.bool]:
        """
...
class PrimingJobResponse(dict):
    ...
    def __init__(__self__, *,
                 priming_job_details: builtins.str,
                 priming_job_id: builtins.str,
                 priming_job_name: builtins.str,
                 priming_job_percent_complete: builtins.float,
                 priming_job_state: builtins.str,
                 priming_job_status: builtins.str):
        """
        A priming job instance.
        :param builtins.str priming_job_details: The job details or error information if any.
        :param builtins.str priming_job_id: The unique identifier of the priming job.
        :param builtins.str priming_job_name: The priming job name.
        :param builtins.float priming_job_percent_complete: The current progress of the priming job, as a percentage.
        :param builtins.str priming_job_state: The state of the priming operation.
        :param builtins.str priming_job_status: The status code of the priming job.
        """
    ...
    def priming_job_details(self) -> builtins.str:
        """
    ...
    def priming_job_id(self) -> builtins.str:
        """
    ...
    def priming_job_name(self) -> builtins.str:
        """
    ...
    def priming_job_percent_complete(self) -> builtins.float:
        """
    ...
    def priming_job_state(self) -> builtins.str:
        """
    ...
    def priming_job_status(self) -> builtins.str:
        """
...
class StorageTargetSpaceAllocationResponse(dict):
    ...
    def __init__(__self__, *,
                 allocation_percentage: Optional[builtins.int] = None,
                 name: Optional[builtins.str] = None):
        """
        Storage Target space allocation properties.
        :param builtins.int allocation_percentage: The percentage of cache space allocated for this storage target
        :param builtins.str name: Name of the storage target.
        """
    ...
    def allocation_percentage(self) -> Optional[builtins.int]:
        """
...
class UnknownTargetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties pertaining to the UnknownTarget
        :param Mapping[str, builtins.str] attributes: Dictionary of string->string pairs containing information about the Storage Target.
        """
