...
class ImportJobArgs:
    def __init__(__self__, *,
                 ...
                 import_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_errors: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ConflictResolutionMode']] conflict_resolution_mode: How the import job will handle conflicts. For example, if the import job is trying to bring in a directory, but a file is at that path, how it handles it. Fail indicates that the import job should stop immediately and not do anything with the conflict. Skip indicates that it should pass over the conflict. OverwriteIfDirty causes the import job to delete and re-import the file or directory if it is a conflicting type, is dirty, or was not previously imported. OverwriteAlways extends OverwriteIfDirty to include releasing files that had been restored but were not dirty. Please reference https://learn.microsoft.com/en-us/azure/azure-managed-lustre/ for a thorough explanation of these resolution modes.
        :param pulumi.Input[builtins.str] import_job_name: Name for the import job. Allows alphanumerics, underscores, and hyphens. Start and end with alphanumeric.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] import_prefixes: An array of blob paths/prefixes that get imported into the cluster namespace. It has '/' as the default value.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.int] maximum_errors: Total non-conflict oriented errors the import job will tolerate before exiting with failure. -1 means infinite. 0 means exit immediately and is the default.
    ...
    def import_job_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def import_job_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "import_job_name", value)

    @property
    @pulumi.getter(name="importPrefixes")
    def import_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def import_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def maximum_errors(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_errors(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ImportJob(pulumi.CustomResource):
    ...
    def blobs_imported_per_second(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def blobs_walked_per_second(self) -> pulumi.Output[builtins.float]:
        """
    ...
    @property
    @pulumi.getter(name="importPrefixes")
    def import_prefixes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of blob paths/prefixes that get imported into the cluster namespace. It has '/' as the default value.
        """
        return pulumi.get(self, "import_prefixes")
    ...
    def last_completion_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def last_started_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maximumErrors")
    def maximum_errors(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Total non-conflict oriented errors the import job will tolerate before exiting with failure. -1 means infinite. 0 means exit immediately and is the default.
        """
        return pulumi.get(self, "maximum_errors")
    ...
    def total_conflicts(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def total_errors(self) -> pulumi.Output[builtins.int]:
        """
