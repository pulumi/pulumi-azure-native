...
class AmlFilesystemArgs:
    def __init__(__self__, *,
                 filesystem_subnet: pulumi.Input[builtins.str],
                 maintenance_window: pulumi.Input['AmlFilesystemMaintenanceWindowArgs'],
                 resource_group_name: pulumi.Input[builtins.str],
                 storage_capacity_ti_b: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.str] filesystem_subnet: Subnet used for managing the AML file system and for client-facing operations. This subnet should have at least a /24 subnet mask within the VNET's address space.
        ...
        :param pulumi.Input[builtins.float] storage_capacity_ti_b: The size of the AML file system, in TiB. This might be rounded up.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Availability zones for resources. This field should only contain a single element in the array.
        """
    ...
    def filesystem_subnet(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def filesystem_subnet(self, value: pulumi.Input[builtins.str]):
    ...
    def storage_capacity_ti_b(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def storage_capacity_ti_b(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "storage_capacity_ti_b", value)

    @property
    @pulumi.getter(name="amlFilesystemName")
    def aml_filesystem_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aml_filesystem_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AmlFilesystem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 filesystem_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 storage_capacity_ti_b: Optional[pulumi.Input[builtins.float]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="filesystemSubnet")
    def filesystem_subnet(self) -> pulumi.Output[builtins.str]:
        """
        Subnet used for managing the AML file system and for client-facing operations. This subnet should have at least a /24 subnet mask within the VNET's address space.
        """
        return pulumi.get(self, "filesystem_subnet")
    ...
    @property
    @pulumi.getter(name="storageCapacityTiB")
    def storage_capacity_ti_b(self) -> pulumi.Output[builtins.float]:
        """
        The size of the AML file system, in TiB. This might be rounded up.
        """
        return pulumi.get(self, "storage_capacity_ti_b")
    ...
    def throughput_provisioned_m_bps(self) -> pulumi.Output[builtins.int]:
        """
