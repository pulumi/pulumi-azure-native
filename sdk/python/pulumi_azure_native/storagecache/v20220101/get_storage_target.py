...
def get_storage_target(cache_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_target is deprecated: azure-native:storagecache/v20220101:StorageTarget is being removed in the next major version of this provider. Upgrade to at least azure-native:storagecache/v20230301preview:StorageTarget to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['cacheName'] = cache_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['storageTargetName'] = storage_target_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20220101:getStorageTarget', __args__, opts=opts, typ=GetStorageTargetResult).value
