...
def get_storage_target(cache_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_target is deprecated: azure-native:storagecache/v20210901:StorageTarget is being removed in the next major version of this provider. Please upgrade to azure-native:storagecache/v20230301preview:StorageTarget to guarantee forwards compatibility.""")
    __args__ = dict()
