...
def get_cache(cache_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cache is deprecated: azure-native:storagecache/v20210901:Cache is being removed in the next major version of this provider. Upgrade to at least azure-native:storagecache/v20230301preview:Cache to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['cacheName'] = cache_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:storagecache/v20210901:getCache', __args__, opts=opts, typ=GetCacheResult).value
