...
class AutoExportJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagecache/v20240701:AutoExportJob"), pulumi.Alias(type_="azure-native:storagecache/v20240701:autoExportJob"), pulumi.Alias(type_="azure-native:storagecache:autoExportJob")])
