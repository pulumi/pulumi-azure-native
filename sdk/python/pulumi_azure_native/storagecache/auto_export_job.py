...
class AutoExportJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagecache/v20240701:AutoExportJob"), pulumi.Alias(type_="azure-native:storagecache/v20250701:AutoExportJob"), pulumi.Alias(type_="azure-native:storagecache/v20260101:AutoExportJob")])
    ...
    @_builtins.property
    @pulumi.getter(name="autoExportPrefixes")
    def auto_export_prefixes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        An array of blob paths/prefixes that get auto exported to the cluster namespace. It has '/' as the default value. Number of maximum allowed paths for now is 1.
        """
        return pulumi.get(self, "auto_export_prefixes")
    ...
    def last_successful_iteration_completion_time_utc(self) -> pulumi.Output[_builtins.str]:
        """
