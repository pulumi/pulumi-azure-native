...
class GetCapacityPoolVolumeQuotaRuleResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, provisioning_state=None, quota_size_in_ki_bs=None, quota_target=None, quota_type=None, system_data=None, tags=None, type=None):
    ...
    def quota_size_in_ki_bs(self) -> Optional[builtins.float]:
        """
        Size of quota
        """
...
def get_capacity_pool_volume_quota_rule(account_name: Optional[builtins.str] = None,
                                        pool_name: Optional[builtins.str] = None,
                                        resource_group_name: Optional[builtins.str] = None,
                                        volume_name: Optional[builtins.str] = None,
                                        volume_quota_rule_name: Optional[builtins.str] = None,
    ...
    :param builtins.str volume_quota_rule_name: The name of volume quota rule
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult).value
...
def get_capacity_pool_volume_quota_rule_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult)
