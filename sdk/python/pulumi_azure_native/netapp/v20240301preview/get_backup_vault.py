...
def get_backup_vault(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240301preview:getBackupVault', __args__, opts=opts, typ=GetBackupVaultResult).value
...
def get_backup_vault_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240301preview:getBackupVault', __args__, opts=opts, typ=GetBackupVaultResult)
