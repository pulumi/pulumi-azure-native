...
def get_volume_group(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240301preview:getVolumeGroup', __args__, opts=opts, typ=GetVolumeGroupResult).value
...
def get_volume_group_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['volumeGroupName'] = volume_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240301preview:getVolumeGroup', __args__, opts=opts, typ=GetVolumeGroupResult)
