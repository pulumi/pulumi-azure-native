...
class GetCapacityPoolCacheResult:
    ...
    Cache resource
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, location=None, name=None, properties=None, system_data=None, tags=None, type=None, zones=None):
...
def get_capacity_pool_cache(account_name: Optional[_builtins.str] = None,
                            cache_name: Optional[_builtins.str] = None,
                            pool_name: Optional[_builtins.str] = None,
                            resource_group_name: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCapacityPoolCacheResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp:getCapacityPoolCache', __args__, opts=opts, typ=GetCapacityPoolCacheResult).value

    return AwaitableGetCapacityPoolCacheResult(
...
def get_capacity_pool_cache_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                   cache_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp:getCapacityPoolCache', __args__, opts=opts, typ=GetCapacityPoolCacheResult)
    return __ret__.apply(lambda __response__: GetCapacityPoolCacheResult(
