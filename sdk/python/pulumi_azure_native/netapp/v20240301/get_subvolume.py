...
def get_subvolume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240301:getSubvolume', __args__, opts=opts, typ=GetSubvolumeResult).value
...
def get_subvolume_output(account_name: Optional[pulumi.Input[str]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSubvolumeResult]:
    """
    Returns the path associated with the subvolumeName provided
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240301:getSubvolume', __args__, opts=opts, typ=GetSubvolumeResult)
