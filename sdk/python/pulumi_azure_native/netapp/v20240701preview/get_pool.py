...
class GetPoolResult:
    ...
    """
    def __init__(__self__, cool_access=None, custom_throughput_mibps=None, encryption_type=None, etag=None, id=None, location=None, name=None, pool_id=None, provisioning_state=None, qos_type=None, service_level=None, size=None, system_data=None, tags=None, total_throughput_mibps=None, type=None, utilized_throughput_mibps=None):
        ...
        if custom_throughput_mibps and not isinstance(custom_throughput_mibps, float):
            raise TypeError("Expected argument 'custom_throughput_mibps' to be a float")
    ...
    def custom_throughput_mibps(self) -> Optional[float]:
...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240701preview:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240701preview:getPool', __args__, opts=opts, typ=GetPoolResult)
