...
def get_capacity_pool_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240701preview:getCapacityPoolPool', __args__, opts=opts, typ=GetCapacityPoolPoolResult).value
...
def get_capacity_pool_pool_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240701preview:getCapacityPoolPool', __args__, opts=opts, typ=GetCapacityPoolPoolResult)
