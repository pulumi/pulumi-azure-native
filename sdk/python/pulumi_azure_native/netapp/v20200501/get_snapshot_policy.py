...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot_policy is deprecated: Version v20200501 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
