...
class CapacityPoolSubvolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] parent_path: parent path to the subvolume
        :param pulumi.Input[builtins.str] path: Path to the subvolume
        :param pulumi.Input[builtins.float] size: Truncate subvolume to the provided size in bytes
        :param pulumi.Input[builtins.str] subvolume_name: The name of the subvolume.
        """
    ...
    def subvolume_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subvolume_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CapacityPoolSubvolume(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def size(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Truncate subvolume to the provided size in bytes
        """
        return pulumi.get(self, "size")
