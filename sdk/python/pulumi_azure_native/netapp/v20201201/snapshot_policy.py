...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20210401:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20210401preview:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20211001:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20220101:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20220501:SnapshotPolicy"), pulumi.Alias(type_="azure-native:netapp/v20220901:SnapshotPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SnapshotPolicy, __self__).__init__(
            'azure-native:netapp/v20201201:SnapshotPolicy',
            resource_name,
            __props__,
            opts)
