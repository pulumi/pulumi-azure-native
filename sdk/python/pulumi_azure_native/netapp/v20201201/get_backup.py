...
def get_backup(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup is deprecated: azure-native:netapp/v20201201:Backup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Backup to guarantee forwards compatibility.""")
    __args__ = dict()
