...
class BackupVault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20221101preview:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:BackupVault")])
