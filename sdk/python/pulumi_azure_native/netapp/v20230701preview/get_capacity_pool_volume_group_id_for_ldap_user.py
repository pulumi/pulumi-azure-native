...
def get_capacity_pool_volume_group_id_for_ldap_user(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230701preview:getCapacityPoolVolumeGroupIdForLdapUser', __args__, opts=opts, typ=GetCapacityPoolVolumeGroupIdForLdapUserResult).value
...
def get_capacity_pool_volume_group_id_for_ldap_user_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230701preview:getCapacityPoolVolumeGroupIdForLdapUser', __args__, opts=opts, typ=GetCapacityPoolVolumeGroupIdForLdapUserResult)
