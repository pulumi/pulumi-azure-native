...
def get_subvolume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230701preview:getSubvolume', __args__, opts=opts, typ=GetSubvolumeResult).value
...
def get_subvolume_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['volumeName'] = volume_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230701preview:getSubvolume', __args__, opts=opts, typ=GetSubvolumeResult)
