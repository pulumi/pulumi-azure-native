...
class Backup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volume_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Backup is deprecated: azure-native:netapp/v20211001:Backup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Backup to guarantee forwards compatibility.""")
