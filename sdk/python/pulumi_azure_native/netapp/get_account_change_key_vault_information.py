...
def get_account_change_key_vault_information(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp:getAccountChangeKeyVaultInformation', __args__, opts=opts, typ=GetAccountChangeKeyVaultInformationResult).value
...
def get_account_change_key_vault_information_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp:getAccountChangeKeyVaultInformation', __args__, opts=opts, typ=GetAccountChangeKeyVaultInformationResult)
