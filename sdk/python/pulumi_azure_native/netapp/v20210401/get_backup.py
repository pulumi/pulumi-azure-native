...
def get_backup(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup is deprecated: azure-native:netapp/v20210401:Backup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Backup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20210401:getBackup', __args__, opts=opts, typ=GetBackupResult).value
