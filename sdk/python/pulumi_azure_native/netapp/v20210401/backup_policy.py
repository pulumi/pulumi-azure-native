...
class BackupPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_policy = azure_native.netapp.v20210401.BackupPolicy("backupPolicy",
