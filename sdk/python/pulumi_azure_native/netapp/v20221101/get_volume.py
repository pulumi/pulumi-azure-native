...
def get_volume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20221101:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
    ...
    return AwaitableGetVolumeResult(
        ...
        data_store_resource_id=__ret__.data_store_resource_id,
        ...
        delete_base_snapshot=__ret__.delete_base_snapshot,
        ...
        smb_access_based_enumeration=__ret__.smb_access_based_enumeration,
        smb_continuously_available=__ret__.smb_continuously_available,
        smb_encryption=__ret__.smb_encryption,
        smb_non_browsable=__ret__.smb_non_browsable,
