...
class VolumeGroupArgs:
    ...
    def _configure(
        ...
        if group_meta_data is None and 'groupMetaData' in kwargs:
...
class VolumeGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            group_meta_data = _utilities.configure(group_meta_data, VolumeGroupMetaDataArgs, True)
