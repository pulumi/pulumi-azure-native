...
def get_backup_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20221101:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult).value
...
def get_backup_policy_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20221101:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult)
