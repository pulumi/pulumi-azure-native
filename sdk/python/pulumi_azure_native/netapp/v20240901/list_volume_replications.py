...
def list_volume_replications(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240901:listVolumeReplications', __args__, opts=opts, typ=ListVolumeReplicationsResult).value
...
def list_volume_replications_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240901:listVolumeReplications', __args__, opts=opts, typ=ListVolumeReplicationsResult)
