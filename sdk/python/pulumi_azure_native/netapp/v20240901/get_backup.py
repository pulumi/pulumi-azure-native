...
def get_backup(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240901:getBackup', __args__, opts=opts, typ=GetBackupResult).value
...
def get_backup_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240901:getBackup', __args__, opts=opts, typ=GetBackupResult)
