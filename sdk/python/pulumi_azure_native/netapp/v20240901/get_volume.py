...
def get_volume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240901:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
...
def get_volume_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240901:getVolume', __args__, opts=opts, typ=GetVolumeResult)
