...
warnings.warn("""azure-native:netapp/v20210601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: azure-native:netapp/v20210601:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['poolName'] = pool_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20210601:getPool', __args__, opts=opts, typ=GetPoolResult).value
