...
def get_capacity_pool_snapshot(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20210601:getCapacityPoolSnapshot', __args__, opts=opts, typ=GetCapacityPoolSnapshotResult).value
...
def get_capacity_pool_snapshot_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20210601:getCapacityPoolSnapshot', __args__, opts=opts, typ=GetCapacityPoolSnapshotResult)
