...
def get_volume(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume is deprecated: azure-native:netapp/v20210601:Volume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.""")
    __args__ = dict()
