...
warnings.warn("""azure-native:netapp/v20220901:Subvolume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Subvolume to guarantee forwards compatibility.""", DeprecationWarning)
...
class Subvolume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20211001:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220101:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220301:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220501:Subvolume")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Subvolume, __self__).__init__(
            'azure-native:netapp/v20220901:Subvolume',
            resource_name,
            __props__,
            opts)
