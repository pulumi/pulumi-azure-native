...
def get_subvolume(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subvolume is deprecated: azure-native:netapp/v20220901:Subvolume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Subvolume to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20220901:getSubvolume', __args__, opts=opts, typ=GetSubvolumeResult).value
