...
def get_capacity_pool_backup(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20220901:getCapacityPoolBackup', __args__, opts=opts, typ=GetCapacityPoolBackupResult).value
...
def get_capacity_pool_backup_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20220901:getCapacityPoolBackup', __args__, opts=opts, typ=GetCapacityPoolBackupResult)
