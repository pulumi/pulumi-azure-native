...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        snapshot_policy = azure_native.netapp.v20220901.SnapshotPolicy("snapshotPolicy",
            account_name="account1",
            daily_schedule=azure_native.netapp.v20220901.DailyScheduleArgs(
                hour=14,
                minute=30,
                snapshots_to_keep=4,
            ),
            enabled=True,
            hourly_schedule=azure_native.netapp.v20220901.HourlyScheduleArgs(
                minute=50,
                snapshots_to_keep=2,
            ),
            location="eastus",
            monthly_schedule=azure_native.netapp.v20220901.MonthlyScheduleArgs(
            ...
            weekly_schedule=azure_native.netapp.v20220901.WeeklyScheduleArgs(
                day="Wednesday",
                hour=14,
                minute=45,
                snapshots_to_keep=3,
