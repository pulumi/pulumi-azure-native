...
class ElasticCapacityPoolArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ElasticCapacityPoolPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ElasticCapacityPoolPropertiesArgs']]):
...
class ElasticCapacityPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 pool_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ElasticCapacityPoolPropertiesArgs', 'ElasticCapacityPoolPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] pool_name: The name of the ElasticCapacityPool
        :param pulumi.Input[Union['ElasticCapacityPoolPropertiesArgs', 'ElasticCapacityPoolPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zones: The availability zones.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ElasticCapacityPoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ElasticCapacityPoolArgs.__new__(ElasticCapacityPoolArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250901preview:ElasticCapacityPool"), pulumi.Alias(type_="azure-native:netapp/v20251215preview:ElasticCapacityPool"), pulumi.Alias(type_="azure-native:netapp/v20260115preview:ElasticCapacityPool"), pulumi.Alias(type_="azure-native:netapp/v20260315preview:ElasticCapacityPool"), pulumi.Alias(type_="azure-native:netapp/v20260415preview:ElasticCapacityPool"), pulumi.Alias(type_="azure-native:netapp/v20260515preview:ElasticCapacityPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ElasticCapacityPool, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ElasticCapacityPool':
        """
        ...
        return ElasticCapacityPool(resource_name, opts=opts, __props__=__props__)
