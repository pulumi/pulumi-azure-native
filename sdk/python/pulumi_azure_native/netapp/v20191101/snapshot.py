...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        snapshot = azure_native.netapp.v20191101.Snapshot("snapshot",
        ...
        ```sh
        $ pulumi import azure-native:netapp/v20191101:Snapshot account1/pool1/volume1/snapshot1 /subscriptions/D633CC2E-722B-4AE1-B636-BBD9E4C60ED9/resourceGroups/myRG/providers/Microsoft.NetApp/netAppAccounts/account1/capacityPools/pool1/volumes/volume1/snapshots/snapshot1 
        ```
    ...
    def _internal_init(__self__,
                 ...
                 volume_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Snapshot is deprecated: Version 2019-11-01 will be removed in v2 of the provider.""")
