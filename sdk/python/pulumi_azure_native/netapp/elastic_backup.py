...
class ElasticBackup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250901preview:ElasticBackup"), pulumi.Alias(type_="azure-native:netapp/v20251215preview:ElasticBackup"), pulumi.Alias(type_="azure-native:netapp/v20260115preview:ElasticBackup"), pulumi.Alias(type_="azure-native:netapp/v20260315preview:ElasticBackup"), pulumi.Alias(type_="azure-native:netapp/v20260415preview:ElasticBackup"), pulumi.Alias(type_="azure-native:netapp/v20260515preview:ElasticBackup")])
