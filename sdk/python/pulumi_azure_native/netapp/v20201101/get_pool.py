...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: Version 2020-11-01 will be removed in v2 of the provider.
azure-native:netapp/v20201101:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20201101:getPool', __args__, opts=opts, typ=GetPoolResult).value
