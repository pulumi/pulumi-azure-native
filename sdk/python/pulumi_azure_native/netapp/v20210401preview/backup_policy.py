...
class BackupPolicyArgs:
    ...
    def _configure(
        ...
        if volume_backups is None and 'volumeBackups' in kwargs:
            volume_backups = kwargs['volumeBackups']
        if volumes_assigned is None and 'volumesAssigned' in kwargs:
            volumes_assigned = kwargs['volumesAssigned']
        if weekly_backups_to_keep is None and 'weeklyBackupsToKeep' in kwargs:
            weekly_backups_to_keep = kwargs['weeklyBackupsToKeep']
        if yearly_backups_to_keep is None and 'yearlyBackupsToKeep' in kwargs:
            yearly_backups_to_keep = kwargs['yearlyBackupsToKeep']
