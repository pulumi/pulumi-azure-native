...
def get_capacity_pool_volume_quota_rule(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20231101preview:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult).value
...
def get_capacity_pool_volume_quota_rule_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20231101preview:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult)
