...
warnings.warn("""azure-native:netapp/v20220301:Backup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Backup to guarantee forwards compatibility.""", DeprecationWarning)
...
class Backup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Backup, __self__).__init__(
            'azure-native:netapp/v20220301:Backup',
            resource_name,
            __props__,
            opts)
