...
warnings.warn("""azure-native:netapp/v20220301:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot_policy is deprecated: azure-native:netapp/v20220301:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
