...
warnings.warn("""azure-native:netapp/v20220301:Pool is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: azure-native:netapp/v20220301:Pool is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Pool to guarantee forwards compatibility.""")
    __args__ = dict()
