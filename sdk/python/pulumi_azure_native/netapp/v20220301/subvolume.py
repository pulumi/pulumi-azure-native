...
class Subvolume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volume_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Subvolume is deprecated: azure-native:netapp/v20220301:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.""")
