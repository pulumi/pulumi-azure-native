...
class VolumeQuotaRuleArgs:
    ...
    def _configure(
        ...
        if quota_size_in_ki_bs is None and 'quotaSizeInKiBs' in kwargs:
            quota_size_in_ki_bs = kwargs['quotaSizeInKiBs']
        ...
        if volume_quota_rule_name is None and 'volumeQuotaRuleName' in kwargs:
            volume_quota_rule_name = kwargs['volumeQuotaRuleName']
