...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot_policy is deprecated: Version 2020-06-01 will be removed in v2 of the provider.
azure-native:netapp/v20200601:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:SnapshotPolicy to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20200601:getSnapshotPolicy', __args__, opts=opts, typ=GetSnapshotPolicyResult).value
