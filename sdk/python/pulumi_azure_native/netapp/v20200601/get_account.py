...
def get_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account is deprecated: Version v20200601 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
