...
class GetBackupResult:
    ...
    """
    def __init__(__self__, backup_id=None, backup_type=None, creation_date=None, failure_reason=None, id=None, label=None, name=None, provisioning_state=None, size=None, snapshot_name=None, system_data=None, type=None, use_existing_snapshot=None, volume_resource_id=None):
...
def get_backup(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20221101preview:getBackup', __args__, opts=opts, typ=GetBackupResult).value
...
def get_backup_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20221101preview:getBackup', __args__, opts=opts, typ=GetBackupResult)
