...
class CapacityPoolVolumeQuotaRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220101:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220301:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220501:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220901:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20221101:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230501:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230701:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230701preview:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20231101:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20231101preview:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240101:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240301:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240301preview:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240501:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240501preview:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240701:CapacityPoolVolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240701preview:CapacityPoolVolumeQuotaRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityPoolVolumeQuotaRule, __self__).__init__(
            'azure-native:netapp/v20221101preview:CapacityPoolVolumeQuotaRule',
            resource_name,
            __props__,
            opts)
