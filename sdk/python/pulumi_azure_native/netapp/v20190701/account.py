...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[Any] = None,
                 __props__=None):
        pulumi.log.warn("""Account is deprecated: Version 2019-07-01 will be removed in v2 of the provider.""")
