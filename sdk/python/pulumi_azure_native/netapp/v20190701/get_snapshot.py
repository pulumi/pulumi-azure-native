...
def get_snapshot(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot is deprecated: Version v20190701 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
