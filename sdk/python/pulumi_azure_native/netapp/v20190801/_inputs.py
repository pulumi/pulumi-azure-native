...
class VolumePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 mount_targets: Optional[pulumi.Input[Sequence[pulumi.Input['MountTargetPropertiesArgs']]]] = None,
        ...
        :param pulumi.Input['VolumePropertiesDataProtectionArgs'] data_protection: DataProtection volume, can have a replication object
        :param pulumi.Input['VolumePropertiesExportPolicyArgs'] export_policy: Set of export policy rules
        :param pulumi.Input[Sequence[pulumi.Input['MountTargetPropertiesArgs']]] mount_targets: List of mount targets
    ...
    def mount_targets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MountTargetPropertiesArgs']]]]:
        """
    ...
    def mount_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MountTargetPropertiesArgs']]]]):
