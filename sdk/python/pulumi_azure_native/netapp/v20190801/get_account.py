...
azure-native:netapp/v20190801:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220501:Account to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account is deprecated: Version 2019-08-01 will be removed in v2 of the provider.
azure-native:netapp/v20190801:Account is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220501:Account to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20190801:getAccount', __args__, opts=opts, typ=GetAccountResult).value
