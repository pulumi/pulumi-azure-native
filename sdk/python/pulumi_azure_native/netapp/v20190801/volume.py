...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        volume = azure_native.netapp.v20190801.Volume("volume",
        ...
        ```sh
        $ pulumi import azure-native:netapp/v20190801:Volume account1/pool1/volume1 /subscriptions/D633CC2E-722B-4AE1-B636-BBD9E4C60ED9/resourceGroups/myRG/providers/Microsoft.NetApp/netAppAccounts/account1/capacityPools/pool1/volumes/volume1 
        ```
    ...
    def _internal_init(__self__,
                 ...
                 volume_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Volume is deprecated: Version 2019-08-01 will be removed in v2 of the provider.""")
