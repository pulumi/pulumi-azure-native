...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:netapp:getSnapshotPolicy'.""", DeprecationWarning)
...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:netapp:getSnapshotPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/latest:getSnapshotPolicy', __args__, opts=opts, typ=GetSnapshotPolicyResult).value
