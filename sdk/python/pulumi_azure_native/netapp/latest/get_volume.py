...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:netapp:getVolume'.""", DeprecationWarning)
...
def get_volume(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:netapp:getVolume'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/latest:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
