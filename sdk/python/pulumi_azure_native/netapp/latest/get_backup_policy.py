...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:netapp:getBackupPolicy'.""", DeprecationWarning)
...
def get_backup_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/latest:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult).value
