...
warnings.warn("""azure-native:netapp/v20220101:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class VolumeGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volumes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VolumeGroupVolumePropertiesArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""VolumeGroup is deprecated: azure-native:netapp/v20220101:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:VolumeGroup"), pulumi.Alias(type_="azure-native:netapp/v20210801:VolumeGroup"), pulumi.Alias(type_="azure-native:netapp/v20211001:VolumeGroup"), pulumi.Alias(type_="azure-native:netapp/v20220301:VolumeGroup"), pulumi.Alias(type_="azure-native:netapp/v20220501:VolumeGroup"), pulumi.Alias(type_="azure-native:netapp/v20220901:VolumeGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeGroup, __self__).__init__(
            'azure-native:netapp/v20220101:VolumeGroup',
            resource_name,
            __props__,
            opts)
