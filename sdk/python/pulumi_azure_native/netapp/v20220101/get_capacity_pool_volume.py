...
def get_capacity_pool_volume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20220101:getCapacityPoolVolume', __args__, opts=opts, typ=GetCapacityPoolVolumeResult).value
...
def get_capacity_pool_volume_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20220101:getCapacityPoolVolume', __args__, opts=opts, typ=GetCapacityPoolVolumeResult)
