...
warnings.warn("""azure-native:netapp/v20220101:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subvolume(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subvolume is deprecated: azure-native:netapp/v20220101:Subvolume is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:Subvolume to guarantee forwards compatibility.""")
    __args__ = dict()
