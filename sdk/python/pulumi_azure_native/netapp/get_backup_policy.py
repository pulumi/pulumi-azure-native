...
class GetBackupPolicyResult:
    ...
    def daily_backups_to_keep(self) -> Optional[builtins.int]:
        """
    ...
    def monthly_backups_to_keep(self) -> Optional[builtins.int]:
        """
    ...
    def volumes_assigned(self) -> builtins.int:
        """
    ...
    def weekly_backups_to_keep(self) -> Optional[builtins.int]:
        """
...
def get_backup_policy(account_name: Optional[builtins.str] = None,
                      backup_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str backup_policy_name: Backup policy Name which uniquely identify backup policy.
...
def get_backup_policy_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
