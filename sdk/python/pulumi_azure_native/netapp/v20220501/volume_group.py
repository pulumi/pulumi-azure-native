...
class VolumeGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volumes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VolumeGroupVolumePropertiesArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""VolumeGroup is deprecated: azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.""")
