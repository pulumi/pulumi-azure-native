...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: azure-native:netapp/v20220501:Pool is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:Pool to guarantee forwards compatibility.""")
    __args__ = dict()
