...
warnings.warn("""azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_volume_group(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume_group is deprecated: azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:VolumeGroup to guarantee forwards compatibility.""")
    __args__ = dict()
