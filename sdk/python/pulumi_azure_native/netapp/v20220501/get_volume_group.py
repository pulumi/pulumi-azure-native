...
warnings.warn("""azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:VolumeGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_volume_group(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume_group is deprecated: azure-native:netapp/v20220501:VolumeGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20221101:VolumeGroup to guarantee forwards compatibility.""")
    __args__ = dict()
