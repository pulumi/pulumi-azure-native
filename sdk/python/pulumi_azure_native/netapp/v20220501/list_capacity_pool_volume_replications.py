...
def list_capacity_pool_volume_replications(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20220501:listCapacityPoolVolumeReplications', __args__, opts=opts, typ=ListCapacityPoolVolumeReplicationsResult).value
...
def list_capacity_pool_volume_replications_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20220501:listCapacityPoolVolumeReplications', __args__, opts=opts, typ=ListCapacityPoolVolumeReplicationsResult)
