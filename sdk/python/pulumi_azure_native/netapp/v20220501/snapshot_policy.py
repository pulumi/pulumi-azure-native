...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 weekly_schedule: Optional[pulumi.Input[pulumi.InputType['WeeklyScheduleArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""SnapshotPolicy is deprecated: azure-native:netapp/v20220501:SnapshotPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.""")
