...
def get_capacity_pool_subvolume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20220501:getCapacityPoolSubvolume', __args__, opts=opts, typ=GetCapacityPoolSubvolumeResult).value
...
def get_capacity_pool_subvolume_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20220501:getCapacityPoolSubvolume', __args__, opts=opts, typ=GetCapacityPoolSubvolumeResult)
