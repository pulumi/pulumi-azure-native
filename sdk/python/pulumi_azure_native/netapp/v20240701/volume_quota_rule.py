...
class VolumeQuotaRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220101:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220301:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220501:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20220901:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20221101:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20221101preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230501:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230701:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20230701preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20231101:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20231101preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240101:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240301:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240301preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240501:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240501preview:VolumeQuotaRule"), pulumi.Alias(type_="azure-native:netapp/v20240701preview:VolumeQuotaRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeQuotaRule, __self__).__init__(
            'azure-native:netapp/v20240701:VolumeQuotaRule',
            resource_name,
            __props__,
            opts)
