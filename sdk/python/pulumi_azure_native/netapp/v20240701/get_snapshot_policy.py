...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240701:getSnapshotPolicy', __args__, opts=opts, typ=GetSnapshotPolicyResult).value
...
def get_snapshot_policy_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['snapshotPolicyName'] = snapshot_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240701:getSnapshotPolicy', __args__, opts=opts, typ=GetSnapshotPolicyResult)
