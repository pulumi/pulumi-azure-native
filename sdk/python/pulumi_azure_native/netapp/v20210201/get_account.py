...
warnings.warn("""azure-native:netapp/v20210201:Account is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220501:Account to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account is deprecated: azure-native:netapp/v20210201:Account is being removed in the next major version of this provider. Please upgrade to azure-native:netapp/v20220501:Account to guarantee forwards compatibility.""")
    __args__ = dict()
