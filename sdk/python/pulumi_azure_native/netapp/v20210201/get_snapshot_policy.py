...
warnings.warn("""azure-native:netapp/v20210201:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_snapshot_policy(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot_policy is deprecated: azure-native:netapp/v20210201:SnapshotPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20220901:SnapshotPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['snapshotPolicyName'] = snapshot_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20210201:getSnapshotPolicy', __args__, opts=opts, typ=GetSnapshotPolicyResult).value
