...
warnings.warn("""azure-native:netapp/v20210201:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_volume(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume is deprecated: azure-native:netapp/v20210201:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:netapp/v20211001:Volume to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20210201:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
