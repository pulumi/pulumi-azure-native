...
class CapacityPoolCache(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250901preview:CapacityPoolCache"), pulumi.Alias(type_="azure-native:netapp/v20251215preview:CapacityPoolCache")])
