...
class ElasticBackupVault(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ElasticBackupVaultArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ElasticBackupVaultArgs.__new__(ElasticBackupVaultArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250901preview:ElasticBackupVault"), pulumi.Alias(type_="azure-native:netapp/v20251215preview:ElasticBackupVault")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ElasticBackupVault':
        """
        ...
        __props__.__dict__["type"] = None
        return ElasticBackupVault(resource_name, opts=opts, __props__=__props__)
