...
class SnapshotPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] snapshot_policy_name: The name of the snapshot policy
    ...
    def snapshot_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def snapshot_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
