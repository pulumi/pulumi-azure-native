...
def get_capacity_pool_subvolume_metadata(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230701:getCapacityPoolSubvolumeMetadata', __args__, opts=opts, typ=GetCapacityPoolSubvolumeMetadataResult).value
...
def get_capacity_pool_subvolume_metadata_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230701:getCapacityPoolSubvolumeMetadata', __args__, opts=opts, typ=GetCapacityPoolSubvolumeMetadataResult)
