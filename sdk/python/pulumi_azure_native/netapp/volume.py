    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            if ldap_enabled is None:
                ldap_enabled = False
            __props__['ldap_enabled'] = ldap_enabled
