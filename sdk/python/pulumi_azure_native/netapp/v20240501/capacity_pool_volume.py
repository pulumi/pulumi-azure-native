...
class CapacityPoolVolume(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CapacityPoolVolumeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CapacityPoolVolumeArgs.__new__(CapacityPoolVolumeArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CapacityPoolVolume':
        """
        ...
        return CapacityPoolVolume(resource_name, opts=opts, __props__=__props__)
