...
def get_capacity_pool_volume_group_id_for_ldap_user(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str username: username is required to fetch the group to which user is part of
