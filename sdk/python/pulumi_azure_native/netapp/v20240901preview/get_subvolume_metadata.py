...
def get_subvolume_metadata(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240901preview:getSubvolumeMetadata', __args__, opts=opts, typ=GetSubvolumeMetadataResult).value
...
def get_subvolume_metadata_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240901preview:getSubvolumeMetadata', __args__, opts=opts, typ=GetSubvolumeMetadataResult)
