...
class GetVolumeResult:
    ...
    def __init__(__self__, accept_grow_capacity_pool_for_short_term_clone_split=None, actual_throughput_mibps=None, avs_data_store=None, backup_id=None, baremetal_tenant_id=None, capacity_pool_resource_id=None, clone_progress=None, cool_access=None, cool_access_retrieval_policy=None, cool_access_tiering_policy=None, coolness_period=None, creation_token=None, data_protection=None, data_store_resource_id=None, default_group_quota_in_ki_bs=None, default_user_quota_in_ki_bs=None, delete_base_snapshot=None, effective_network_features=None, enable_subvolumes=None, encrypted=None, encryption_key_source=None, etag=None, export_policy=None, file_access_logs=None, file_system_id=None, id=None, inherited_size_in_bytes=None, is_default_quota_enabled=None, is_large_volume=None, is_restoring=None, kerberos_enabled=None, key_vault_private_endpoint_resource_id=None, language=None, ldap_enabled=None, location=None, maximum_number_of_files=None, mount_targets=None, name=None, network_features=None, network_sibling_set_id=None, originating_resource_id=None, placement_rules=None, protocol_types=None, provisioned_availability_zone=None, provisioning_state=None, proximity_placement_group=None, security_style=None, service_level=None, smb_access_based_enumeration=None, smb_continuously_available=None, smb_encryption=None, smb_non_browsable=None, snapshot_directory_visible=None, snapshot_id=None, storage_to_network_proximity=None, subnet_id=None, system_data=None, t2_network=None, tags=None, throughput_mibps=None, type=None, unix_permissions=None, usage_threshold=None, volume_group_name=None, volume_spec_name=None, volume_type=None, zones=None):
        ...
        if effective_network_features and not isinstance(effective_network_features, str):
            raise TypeError("Expected argument 'effective_network_features' to be a str")
...
class AwaitableGetVolumeResult(GetVolumeResult):
    ...
    def __await__(self):
        ...
        return GetVolumeResult(
            ...
            effective_network_features=self.effective_network_features,
...
def get_volume(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20240901preview:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
    ...
    return AwaitableGetVolumeResult(
        ...
        effective_network_features=pulumi.get(__ret__, 'effective_network_features'),
...
def get_volume_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20240901preview:getVolume', __args__, opts=opts, typ=GetVolumeResult)
    return __ret__.apply(lambda __response__: GetVolumeResult(
        ...
        effective_network_features=pulumi.get(__response__, 'effective_network_features'),
        ...
        inherited_size_in_bytes=pulumi.get(__response__, 'inherited_size_in_bytes'),
