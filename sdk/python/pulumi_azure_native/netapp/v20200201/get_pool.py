...
def get_pool(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: Version v20200201 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20200201:getPool', __args__, opts=opts, typ=GetPoolResult).value
