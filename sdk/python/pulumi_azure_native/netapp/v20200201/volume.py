...
class VolumeArgs:
    ...
    def service_level(self) -> Optional[pulumi.Input[Union[str, 'VolumeServiceLevel']]]:
        """
    ...
    def service_level(self, value: Optional[pulumi.Input[Union[str, 'VolumeServiceLevel']]]):
