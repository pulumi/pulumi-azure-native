...
class CapacityPoolBucket(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Other available API versions: 2025-03-01-preview, 2025-07-01-preview, 2025-08-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native netapp [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250101preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250301preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250701preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250801preview:CapacityPoolBucket")])
