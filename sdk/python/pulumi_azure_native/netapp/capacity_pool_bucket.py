...
class CapacityPoolBucket(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250101preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250301preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250701preview:CapacityPoolBucket")])
