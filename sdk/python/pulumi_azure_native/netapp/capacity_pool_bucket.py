...
class CapacityPoolBucket(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20250101preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250301preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250701preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250801preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20250901preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20251215preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260101:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260115preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260301:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260315preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260401:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260415preview:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260501:CapacityPoolBucket"), pulumi.Alias(type_="azure-native:netapp/v20260515preview:CapacityPoolBucket")])
