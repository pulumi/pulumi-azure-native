...
def get_capacity_pool_snapshot(account_name: Optional[_builtins.str] = None,
...
def get_capacity_pool_snapshot_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
