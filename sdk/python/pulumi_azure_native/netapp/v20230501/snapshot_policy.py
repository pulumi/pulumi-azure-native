...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(daily_schedule, DailyScheduleArgs):
            ...
            if not isinstance(hourly_schedule, HourlyScheduleArgs):
            ...
            if not isinstance(monthly_schedule, MonthlyScheduleArgs):
            ...
            if not isinstance(weekly_schedule, WeeklyScheduleArgs):
