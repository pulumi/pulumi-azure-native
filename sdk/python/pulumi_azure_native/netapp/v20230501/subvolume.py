...
class Subvolume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20211001:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220101:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220301:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220501:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20220901:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20221101:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20221101preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20230701:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20230701preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20231101:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20231101preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240101:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240301:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240301preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240501:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240501preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240701:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240701preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240901:Subvolume"), pulumi.Alias(type_="azure-native:netapp/v20240901preview:Subvolume"), pulumi.Alias(type_="azure-native:netapp:Subvolume")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Subvolume, __self__).__init__(
            'azure-native:netapp/v20230501:Subvolume',
            resource_name,
            __props__,
            opts)
