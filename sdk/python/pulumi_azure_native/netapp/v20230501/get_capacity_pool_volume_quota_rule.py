...
__all__ = [
    ...
    'AwaitableGetCapacityPoolVolumeQuotaRuleResult',
    'get_capacity_pool_volume_quota_rule',
    'get_capacity_pool_volume_quota_rule_output',
]
...
def get_capacity_pool_volume_quota_rule(account_name: Optional[str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCapacityPoolVolumeQuotaRuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230501:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult).value

    return AwaitableGetCapacityPoolVolumeQuotaRuleResult(
        id=pulumi.get(__ret__, 'id'),
        location=pulumi.get(__ret__, 'location'),
        name=pulumi.get(__ret__, 'name'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        quota_size_in_ki_bs=pulumi.get(__ret__, 'quota_size_in_ki_bs'),
...
def get_capacity_pool_volume_quota_rule_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230501:getCapacityPoolVolumeQuotaRule', __args__, opts=opts, typ=GetCapacityPoolVolumeQuotaRuleResult)
    return __ret__.apply(lambda __response__: GetCapacityPoolVolumeQuotaRuleResult(
