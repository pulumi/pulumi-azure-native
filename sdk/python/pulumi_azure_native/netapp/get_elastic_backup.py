...
__all__ = [
    'GetElasticBackupResult',
    'AwaitableGetElasticBackupResult',
    'get_elastic_backup',
    'get_elastic_backup_output',
]
...
def get_elastic_backup(account_name: Optional[_builtins.str] = None,
                       backup_name: Optional[_builtins.str] = None,
                       backup_vault_name: Optional[_builtins.str] = None,
                       resource_group_name: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetElasticBackupResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp:getElasticBackup', __args__, opts=opts, typ=GetElasticBackupResult).value

    return AwaitableGetElasticBackupResult(
...
def get_elastic_backup_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp:getElasticBackup', __args__, opts=opts, typ=GetElasticBackupResult)
    return __ret__.apply(lambda __response__: GetElasticBackupResult(
