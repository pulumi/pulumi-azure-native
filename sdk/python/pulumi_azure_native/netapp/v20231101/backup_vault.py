...
class BackupVault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20221101preview:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20230701preview:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20231101preview:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20240301:BackupVault"), pulumi.Alias(type_="azure-native:netapp/v20240301preview:BackupVault")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupVault, __self__).__init__(
            'azure-native:netapp/v20231101:BackupVault',
            resource_name,
            __props__,
            opts)
