...
class Backup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:netapp/v20221101preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20230501preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20230701preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20231101preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240101:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240301:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240301preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240501:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240501preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240701:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240701preview:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240901:Backup"), pulumi.Alias(type_="azure-native:netapp/v20240901preview:Backup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Backup, __self__).__init__(
            'azure-native:netapp/v20231101:Backup',
            resource_name,
            __props__,
            opts)
