...
def get_volume_quota_rule(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230501preview:getVolumeQuotaRule', __args__, opts=opts, typ=GetVolumeQuotaRuleResult).value
...
def get_volume_quota_rule_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['volumeQuotaRuleName'] = volume_quota_rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230501preview:getVolumeQuotaRule', __args__, opts=opts, typ=GetVolumeQuotaRuleResult)
