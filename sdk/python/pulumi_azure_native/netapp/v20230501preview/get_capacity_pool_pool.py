...
__all__ = [
    'GetCapacityPoolPoolResult',
    'AwaitableGetCapacityPoolPoolResult',
    'get_capacity_pool_pool',
    'get_capacity_pool_pool_output',
]

@pulumi.output_type
class GetCapacityPoolPoolResult:
    """
...
class AwaitableGetCapacityPoolPoolResult(GetCapacityPoolPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCapacityPoolPoolResult(
...
def get_capacity_pool_pool(account_name: Optional[str] = None,
                           pool_name: Optional[str] = None,
                           resource_group_name: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCapacityPoolPoolResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:netapp/v20230501preview:getCapacityPoolPool', __args__, opts=opts, typ=GetCapacityPoolPoolResult).value

    return AwaitableGetCapacityPoolPoolResult(
...
def get_capacity_pool_pool_output(account_name: Optional[pulumi.Input[str]] = None,
                                  pool_name: Optional[pulumi.Input[str]] = None,
                                  resource_group_name: Optional[pulumi.Input[str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCapacityPoolPoolResult]:
    """
    Get details of the specified capacity pool
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:netapp/v20230501preview:getCapacityPoolPool', __args__, opts=opts, typ=GetCapacityPoolPoolResult)
    return __ret__.apply(lambda __response__: GetCapacityPoolPoolResult(
