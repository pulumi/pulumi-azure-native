...
class HostPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_template: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HostPool is deprecated: azure-native:desktopvirtualization/v20210201preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:HostPool to guarantee forwards compatibility.""")
