...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application = azure_native.desktopvirtualization.v20210201preview.Application("application",
