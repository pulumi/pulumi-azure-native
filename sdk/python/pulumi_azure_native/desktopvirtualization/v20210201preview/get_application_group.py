...
def get_application_group_output(application_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20210201preview:getApplicationGroup', __args__, opts=opts, typ=GetApplicationGroupResult)
