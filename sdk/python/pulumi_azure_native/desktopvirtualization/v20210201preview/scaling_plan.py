...
class ScalingPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        scaling_plan = azure_native.desktopvirtualization.v20210201preview.ScalingPlan("scalingPlan",
            description="des1",
            exclusion_tag="value",
            friendly_name="friendly",
            host_pool_references=[azure_native.desktopvirtualization.v20210201preview.ScalingHostPoolReferenceArgs(
            ...
            schedules=[azure_native.desktopvirtualization.v20210201preview.ScalingScheduleArgs(
                days_of_week=[
                    "Monday",
                    "Tuesday",
                    "Wednesday",
