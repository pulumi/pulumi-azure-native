...
warnings.warn("""azure-native:desktopvirtualization/v20210201preview:MSIXPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_msix_package(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_msix_package is deprecated: azure-native:desktopvirtualization/v20210201preview:MSIXPackage is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['hostPoolName'] = host_pool_name
    __args__['msixPackageFullName'] = msix_package_full_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20210201preview:getMSIXPackage', __args__, opts=opts, typ=GetMSIXPackageResult).value
