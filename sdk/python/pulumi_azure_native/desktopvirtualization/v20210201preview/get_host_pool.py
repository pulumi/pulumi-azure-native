...
warnings.warn("""azure-native:desktopvirtualization/v20210201preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:HostPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host_pool is deprecated: azure-native:desktopvirtualization/v20210201preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:HostPool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['hostPoolName'] = host_pool_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20210201preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
