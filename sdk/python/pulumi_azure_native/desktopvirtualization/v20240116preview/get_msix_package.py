...
def get_msix_package(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20240116preview:getMSIXPackage', __args__, opts=opts, typ=GetMSIXPackageResult).value
...
def get_msix_package_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20240116preview:getMSIXPackage', __args__, opts=opts, typ=GetMSIXPackageResult)
