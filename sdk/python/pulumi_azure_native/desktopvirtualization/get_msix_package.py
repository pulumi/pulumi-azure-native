...
class GetMSIXPackageResult:
    ...
    def is_regular_registration(self) -> Optional[builtins.bool]:
        """
    ...
    def package_family_name(self) -> Optional[builtins.str]:
        """
    ...
    def package_relative_path(self) -> Optional[builtins.str]:
        """
...
def get_msix_package(host_pool_name: Optional[builtins.str] = None,
                     msix_package_full_name: Optional[builtins.str] = None,
    ...
    :param builtins.str msix_package_full_name: The version specific package full name of the MSIX package within specified hostpool
...
def get_msix_package_output(host_pool_name: Optional[pulumi.Input[builtins.str]] = None,
