...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host_pool is deprecated: Version v20191210preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20191210preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
