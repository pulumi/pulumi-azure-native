...
class PrivateEndpointConnectionByHostPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:desktopvirtualization:PrivateEndpointConnectionByHostPool"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByHostPool"), pulumi.Alias(type_="azure-nextgen:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByHostPool"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByHostPool"), pulumi.Alias(type_="azure-nextgen:desktopvirtualization/v20210513preview:PrivateEndpointConnectionByHostPool")])
