...
def get_scaling_plan(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20231004preview:getScalingPlan', __args__, opts=opts, typ=GetScalingPlanResult).value
...
def get_scaling_plan_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scalingPlanName'] = scaling_plan_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20231004preview:getScalingPlan', __args__, opts=opts, typ=GetScalingPlanResult)
