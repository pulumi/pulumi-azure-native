...
azure-native:desktopvirtualization/v20190123preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20201102preview:HostPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host_pool is deprecated: Version 2019-01-23-preview will be removed in v2 of the provider.
azure-native:desktopvirtualization/v20190123preview:HostPool is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20201102preview:HostPool to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20190123preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
