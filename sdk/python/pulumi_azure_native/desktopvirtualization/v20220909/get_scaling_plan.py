...
def get_scaling_plan(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scaling_plan is deprecated: azure-native:desktopvirtualization/v20220909:ScalingPlan is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:ScalingPlan to guarantee forwards compatibility.""")
    __args__ = dict()
