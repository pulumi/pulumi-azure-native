...
warnings.warn("""azure-native:desktopvirtualization/v20220909:ScalingPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
class ScalingPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_zone: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScalingPlan is deprecated: azure-native:desktopvirtualization/v20220909:ScalingPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlan to guarantee forwards compatibility.""")
