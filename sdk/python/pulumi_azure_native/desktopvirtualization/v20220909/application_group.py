...
warnings.warn("""azure-native:desktopvirtualization/v20220909:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:ApplicationGroup to guarantee forwards compatibility.""", DeprecationWarning)
