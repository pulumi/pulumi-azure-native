...
class AgentUpdatePropertiesArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'maintenanceWindowTimeZone' in kwargs:
        ...
        if 'useSessionHostLocalTime' in kwargs:
...
class MsixPackageApplicationsArgs:
    def __init__(__self__, *,
        ...
        """
        MsixPackageApplicationsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_id=app_id,
...
class MsixPackageDependenciesArgs:
    def __init__(__self__, *,
        ...
        """
        MsixPackageDependenciesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class RegistrationInfoArgs:
    ...
    def _configure(
        ...
        if 'registrationTokenOperation' in kwargs:
...
class ScalingHostPoolReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        ScalingHostPoolReferenceArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class ScalingScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        ScalingScheduleArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
