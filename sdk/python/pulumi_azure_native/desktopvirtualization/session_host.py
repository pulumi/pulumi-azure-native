...
class SessionHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:desktopvirtualization/v20260101preview:SessionHost"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20260301preview:SessionHost"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20260401preview:SessionHost")])
