...
class PrivateEndpointConnectionByHostPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection_by_host_pool = azure_native.desktopvirtualization.v20210401preview.PrivateEndpointConnectionByHostPool("privateEndpointConnectionByHostPool",
            host_pool_name="hostPool1",
            private_endpoint_connection_name="hostPool1.377103f1-5179-4bdf-8556-4cdd3207cc5b",
            private_link_service_connection_state=azure_native.desktopvirtualization.v20210401preview.PrivateLinkServiceConnectionStateArgs(
