...
warnings.warn("""azure-native:desktopvirtualization/v20210401preview:ApplicationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:ApplicationGroup to guarantee forwards compatibility.""", DeprecationWarning)
