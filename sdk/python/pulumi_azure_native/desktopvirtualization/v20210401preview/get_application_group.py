...
def get_application_group(application_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_group is deprecated: azure-native:desktopvirtualization/v20210401preview:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20220401preview:ApplicationGroup to guarantee forwards compatibility.""")
    __args__ = dict()
