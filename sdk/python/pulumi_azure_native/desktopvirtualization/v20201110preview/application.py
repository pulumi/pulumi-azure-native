...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 show_in_portal: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""Application is deprecated: Version v20201110preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
        if opts is None:
