...
class HostPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        host_pool = azure_native.desktopvirtualization.v20201110preview.HostPool("hostPool",
            description="des1",
            ...
            registration_info=azure_native.desktopvirtualization.v20201110preview.RegistrationInfoArgs(
