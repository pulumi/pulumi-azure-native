...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_group = azure_native.desktopvirtualization.v20201110preview.ApplicationGroup("applicationGroup",
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationGroup is deprecated: Version 2020-11-10-preview will be removed in v2 of the provider.""")
