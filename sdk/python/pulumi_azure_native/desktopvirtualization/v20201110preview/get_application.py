...
warnings.warn("""Version 2020-11-10-preview will be removed in v2 of the provider.
azure-native:desktopvirtualization/v20201110preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:desktopvirtualization/v20201110preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.""")
    __args__ = dict()
