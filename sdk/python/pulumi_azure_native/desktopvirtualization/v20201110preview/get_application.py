...
def get_application(application_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20201110preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
    __args__ = dict()
