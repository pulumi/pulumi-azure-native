...
class GetScalingPlanResult:
    ...
    def exclusion_tag(self) -> Optional[builtins.str]:
        """
    ...
    def host_pool_type(self) -> Optional[builtins.str]:
        """
...
def get_scaling_plan(resource_group_name: Optional[builtins.str] = None,
...
def get_scaling_plan_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
