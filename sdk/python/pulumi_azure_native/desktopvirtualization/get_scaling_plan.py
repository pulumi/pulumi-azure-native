...
def get_scaling_plan(resource_group_name: Optional[_builtins.str] = None,
...
def get_scaling_plan_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
