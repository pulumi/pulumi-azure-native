...
azure-native:desktopvirtualization/v20200921preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application(application_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version 2020-09-21-preview will be removed in v2 of the provider.
azure-native:desktopvirtualization/v20200921preview:Application is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20200921preview:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
