...
azure-native:desktopvirtualization/v20200921preview:ApplicationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20201110preview:ApplicationGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_group(application_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_group is deprecated: Version 2020-09-21-preview will be removed in v2 of the provider.
azure-native:desktopvirtualization/v20200921preview:ApplicationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20201110preview:ApplicationGroup to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20200921preview:getApplicationGroup', __args__, opts=opts, typ=GetApplicationGroupResult).value
