...
def get_private_endpoint_connection_by_host_pool_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20220401preview:getPrivateEndpointConnectionByHostPool', __args__, opts=opts, typ=GetPrivateEndpointConnectionByHostPoolResult)
