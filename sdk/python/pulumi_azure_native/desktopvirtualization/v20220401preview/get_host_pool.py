...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20220401preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
...
def get_host_pool_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20220401preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult)
