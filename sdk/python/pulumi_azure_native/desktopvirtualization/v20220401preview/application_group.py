...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_group = azure_native.desktopvirtualization.v20220401preview.ApplicationGroup("applicationGroup",
