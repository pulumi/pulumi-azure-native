...
warnings.warn("""azure-native:desktopvirtualization/v20220401preview:Application is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:Application to guarantee forwards compatibility.""", DeprecationWarning)
