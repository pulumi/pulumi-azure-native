...
warnings.warn("""azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule to guarantee forwards compatibility.""", DeprecationWarning)
...
class ScalingPlanPooledSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scaling_plan_schedule_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScalingPlanPooledSchedule is deprecated: azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:desktopvirtualization:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20220909:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScalingPlanPooledSchedule, __self__).__init__(
            'azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule',
            resource_name,
            __props__,
            opts)
