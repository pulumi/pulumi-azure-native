...
class HostPoolArgs:
    ...
    def _configure(
        ...
        if 'agentUpdate' in kwargs:
            agent_update = kwargs['agentUpdate']
        if 'customRdpProperty' in kwargs:
        ...
        if 'maxSessionLimit' in kwargs:
            max_session_limit = kwargs['maxSessionLimit']
        if 'migrationRequest' in kwargs:
...
class HostPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if migration_request is not None and not isinstance(migration_request, MigrationRequestPropertiesArgs):
                migration_request = migration_request or {}
                def _setter(key, value):
                    migration_request[key] = value
                MigrationRequestPropertiesArgs._configure(_setter, **migration_request)
