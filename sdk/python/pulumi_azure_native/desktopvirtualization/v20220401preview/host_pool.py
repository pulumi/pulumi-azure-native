...
class HostPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(agent_update, AgentUpdatePropertiesArgs):
            ...
            if not isinstance(identity, ResourceModelWithAllowedPropertySetIdentityArgs):
            ...
            if not isinstance(migration_request, MigrationRequestPropertiesArgs):
            ...
            if not isinstance(plan, ResourceModelWithAllowedPropertySetPlanArgs):
                plan = plan or {}
                def _setter(key, value):
                    plan[key] = value
            ...
            if not isinstance(registration_info, RegistrationInfoArgs):
            ...
            if not isinstance(sku, ResourceModelWithAllowedPropertySetSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
