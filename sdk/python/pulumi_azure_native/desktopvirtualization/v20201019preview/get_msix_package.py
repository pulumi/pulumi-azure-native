...
def get_msix_package(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_msix_package is deprecated: Version v20201019preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20201019preview:getMSIXPackage', __args__, opts=opts, typ=GetMSIXPackageResult).value
