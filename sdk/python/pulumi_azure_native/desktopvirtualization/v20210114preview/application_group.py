...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationGroup is deprecated: azure-native:desktopvirtualization/v20210114preview:ApplicationGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:desktopvirtualization/v20220401preview:ApplicationGroup to guarantee forwards compatibility.""")
        ...
        super(ApplicationGroup, __self__).__init__(
            'azure-native:desktopvirtualization/v20210114preview:ApplicationGroup',
            resource_name,
            __props__,
            opts)
