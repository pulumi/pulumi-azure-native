...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host_pool is deprecated: azure-native:desktopvirtualization/v20210114preview:HostPool is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20220401preview:HostPool to guarantee forwards compatibility.""")
    __args__ = dict()
