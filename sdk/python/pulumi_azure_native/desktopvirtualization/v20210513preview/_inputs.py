...
@pulumi.input_type
class SecondaryWindowPropertiesArgs:
    def __init__(__self__, *,
                 days_of_week: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 hour: Optional[pulumi.Input[int]] = None):
        """
...
@pulumi.input_type
class SessionHostComponentUpdateConfigurationPropertiesArgs:
    def __init__(__self__, *,
                 maintenance_type: Optional[pulumi.Input[Union[str, 'SessionHostComponentUpdateType']]] = None,
                 maintenance_window_time_zone: Optional[pulumi.Input[str]] = None,
                 primary_window: Optional[pulumi.Input['MaintenanceWindowPropertiesArgs']] = None,
                 secondary_window: Optional[pulumi.Input['SecondaryWindowPropertiesArgs']] = None,
                 use_session_host_local_time: Optional[pulumi.Input[bool]] = None):
        """
        The session host configuration for updating agent, monitoring agent, and stack component.
        :param pulumi.Input[Union[str, 'SessionHostComponentUpdateType']] maintenance_type: The type of maintenance for session host components.
        ...
        :param pulumi.Input['MaintenanceWindowPropertiesArgs'] primary_window: Primary Window of the maintenance. Maintenance windows are 2 hours long. We try to push component update in this window first.
        :param pulumi.Input['SecondaryWindowPropertiesArgs'] secondary_window: Secondary maintenance windows. Maintenance windows are 2 hours long. We try to exercise this only when the primary window update fails.
    ...
    def maintenance_type(self) -> Optional[pulumi.Input[Union[str, 'SessionHostComponentUpdateType']]]:
        """
    ...
    def maintenance_type(self, value: Optional[pulumi.Input[Union[str, 'SessionHostComponentUpdateType']]]):
    ...
    def primary_window(self) -> Optional[pulumi.Input['MaintenanceWindowPropertiesArgs']]:
        """
    ...
    def primary_window(self, value: Optional[pulumi.Input['MaintenanceWindowPropertiesArgs']]):
        pulumi.set(self, "primary_window", value)

    @property
    @pulumi.getter(name="secondaryWindow")
    def secondary_window(self) -> Optional[pulumi.Input['SecondaryWindowPropertiesArgs']]:
        """
    ...
    def secondary_window(self, value: Optional[pulumi.Input['SecondaryWindowPropertiesArgs']]):
        pulumi.set(self, "secondary_window", value)
