...
class GetHostPoolResult:
    ...
    def __init__(__self__, application_group_references=None, cloud_pc_resource=None, custom_rdp_property=None, description=None, etag=None, friendly_name=None, host_pool_type=None, id=None, identity=None, kind=None, load_balancer_type=None, location=None, managed_by=None, max_session_limit=None, migration_request=None, name=None, object_id=None, personal_desktop_assignment_type=None, plan=None, preferred_app_group_type=None, public_network_access=None, registration_info=None, ring=None, session_host_component_update_configuration=None, sku=None, sso_client_id=None, sso_client_secret_key_vault_path=None, sso_secret_type=None, ssoadfs_authority=None, start_vm_on_connect=None, system_data=None, tags=None, type=None, validation_environment=None, vm_template=None):
        ...
        if session_host_component_update_configuration and not isinstance(session_host_component_update_configuration, dict):
            raise TypeError("Expected argument 'session_host_component_update_configuration' to be a dict")
    ...
    def session_host_component_update_configuration(self) -> Optional['outputs.SessionHostComponentUpdateConfigurationPropertiesResponse']:
        """
...
class AwaitableGetHostPoolResult(GetHostPoolResult):
    ...
    def __await__(self):
        ...
        return GetHostPoolResult(
            ...
            ring=self.ring,
            session_host_component_update_configuration=self.session_host_component_update_configuration,
            sku=self.sku,
...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20210513preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
    ...
    return AwaitableGetHostPoolResult(
        ...
        ring=__ret__.ring,
        session_host_component_update_configuration=__ret__.session_host_component_update_configuration,
        sku=__ret__.sku,
