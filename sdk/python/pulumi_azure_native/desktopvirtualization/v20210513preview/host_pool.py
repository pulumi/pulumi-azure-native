...
class HostPoolArgs:
    def __init__(__self__, *,
                 ...
                 session_host_component_update_configuration: Optional[pulumi.Input['SessionHostComponentUpdateConfigurationPropertiesArgs']] = None,
        ...
        :param pulumi.Input['SessionHostComponentUpdateConfigurationPropertiesArgs'] session_host_component_update_configuration: The session host configuration for updating agent, monitoring agent, and stack component.
        ...
        if session_host_component_update_configuration is not None:
            pulumi.set(__self__, "session_host_component_update_configuration", session_host_component_update_configuration)
        if sku is not None:
    ...
    @property
    @pulumi.getter(name="sessionHostComponentUpdateConfiguration")
    def session_host_component_update_configuration(self) -> Optional[pulumi.Input['SessionHostComponentUpdateConfigurationPropertiesArgs']]:
        """
        The session host configuration for updating agent, monitoring agent, and stack component.
        """
        return pulumi.get(self, "session_host_component_update_configuration")

    @session_host_component_update_configuration.setter
    def session_host_component_update_configuration(self, value: Optional[pulumi.Input['SessionHostComponentUpdateConfigurationPropertiesArgs']]):
        pulumi.set(self, "session_host_component_update_configuration", value)
...
class HostPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ring: Optional[pulumi.Input[int]] = None,
                 session_host_component_update_configuration: Optional[pulumi.Input[pulumi.InputType['SessionHostComponentUpdateConfigurationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[int] ring: The ring number of HostPool.
        :param pulumi.Input[pulumi.InputType['SessionHostComponentUpdateConfigurationPropertiesArgs']] session_host_component_update_configuration: The session host configuration for updating agent, monitoring agent, and stack component.
        :param pulumi.Input[str] sso_client_id: ClientId for the registered Relying Party used to issue WVD SSO certificates.
        :param pulumi.Input[str] sso_client_secret_key_vault_path: Path to Azure KeyVault storing the secret used for communication to ADFS.
        :param pulumi.Input[Union[str, 'SSOSecretType']] sso_secret_type: The type of single sign on Secret Type.
        :param pulumi.Input[str] ssoadfs_authority: URL to customer ADFS server for signing WVD SSO certificates.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["session_host_component_update_configuration"] = session_host_component_update_configuration
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["session_host_component_update_configuration"] = None
    ...
    @property
    @pulumi.getter(name="sessionHostComponentUpdateConfiguration")
    def session_host_component_update_configuration(self) -> pulumi.Output[Optional['outputs.SessionHostComponentUpdateConfigurationPropertiesResponse']]:
        """
        The session host configuration for updating agent, monitoring agent, and stack component.
        """
        return pulumi.get(self, "session_host_component_update_configuration")
