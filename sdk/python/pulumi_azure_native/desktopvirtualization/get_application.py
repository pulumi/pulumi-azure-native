...
def get_application(application_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_name: The name of the application within the specified application group
...
def get_application_output(application_group_name: Optional[pulumi.Input[_builtins.str]] = None,
