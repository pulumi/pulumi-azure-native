...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_path: Specifies a path for the executable file for the application.
        :param pulumi.Input[_builtins.str] friendly_name: Friendly name of Application.
        :param pulumi.Input[_builtins.int] icon_index: Index of the icon.
        :param pulumi.Input[_builtins.str] icon_path: Path to icon.
        :param pulumi.Input[_builtins.str] msix_package_application_id: Specifies the package application Id for MSIX applications
        :param pulumi.Input[_builtins.str] msix_package_family_name: Specifies the package family name for MSIX applications
    ...
    def command_line_setting(self, value: pulumi.Input[Union[_builtins.str, 'CommandLineSetting']]):
