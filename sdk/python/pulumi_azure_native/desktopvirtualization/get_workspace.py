...
class GetWorkspaceResult:
    ...
    def application_group_references(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_workspace(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
...
def get_workspace_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
