...
class ScalingPlanPersonalScheduleArgs:
    def __init__(__self__, *,
                 ...
                 off_peak_action_on_disconnect: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 off_peak_action_on_logoff: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 off_peak_minutes_to_wait_on_disconnect: Optional[pulumi.Input[builtins.int]] = None,
                 off_peak_minutes_to_wait_on_logoff: Optional[pulumi.Input[builtins.int]] = None,
                 off_peak_start_time: Optional[pulumi.Input['TimeArgs']] = None,
                 off_peak_start_vm_on_connect: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]] = None,
                 peak_action_on_disconnect: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 peak_action_on_logoff: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 peak_minutes_to_wait_on_disconnect: Optional[pulumi.Input[builtins.int]] = None,
                 peak_minutes_to_wait_on_logoff: Optional[pulumi.Input[builtins.int]] = None,
                 peak_start_time: Optional[pulumi.Input['TimeArgs']] = None,
                 peak_start_vm_on_connect: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]] = None,
                 ramp_down_action_on_disconnect: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 ramp_down_action_on_logoff: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 ramp_down_minutes_to_wait_on_disconnect: Optional[pulumi.Input[builtins.int]] = None,
                 ramp_down_minutes_to_wait_on_logoff: Optional[pulumi.Input[builtins.int]] = None,
                 ramp_down_start_time: Optional[pulumi.Input['TimeArgs']] = None,
                 ramp_down_start_vm_on_connect: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]] = None,
                 ramp_up_action_on_disconnect: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 ramp_up_action_on_logoff: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]] = None,
                 ramp_up_auto_start_hosts: Optional[pulumi.Input[Union[builtins.str, 'StartupBehavior']]] = None,
                 ramp_up_minutes_to_wait_on_disconnect: Optional[pulumi.Input[builtins.int]] = None,
                 ramp_up_minutes_to_wait_on_logoff: Optional[pulumi.Input[builtins.int]] = None,
                 ramp_up_start_time: Optional[pulumi.Input['TimeArgs']] = None,
                 ramp_up_start_vm_on_connect: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] off_peak_action_on_disconnect: Action to be taken after a user disconnect during the off-peak period.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] off_peak_action_on_logoff: Action to be taken after a logoff during the off-peak period.
        :param pulumi.Input[builtins.int] off_peak_minutes_to_wait_on_disconnect: The time in minutes to wait before performing the desired session handling action when a user disconnects during the off-peak period.
        :param pulumi.Input[builtins.int] off_peak_minutes_to_wait_on_logoff: The time in minutes to wait before performing the desired session handling action when a user logs off during the off-peak period.
        :param pulumi.Input['TimeArgs'] off_peak_start_time: Starting time for off-peak period.
        :param pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']] off_peak_start_vm_on_connect: The desired configuration of Start VM On Connect for the hostpool during the off-peak phase.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] peak_action_on_disconnect: Action to be taken after a user disconnect during the peak period.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] peak_action_on_logoff: Action to be taken after a logoff during the peak period.
        :param pulumi.Input[builtins.int] peak_minutes_to_wait_on_disconnect: The time in minutes to wait before performing the desired session handling action when a user disconnects during the peak period.
        :param pulumi.Input[builtins.int] peak_minutes_to_wait_on_logoff: The time in minutes to wait before performing the desired session handling action when a user logs off during the peak period.
        :param pulumi.Input['TimeArgs'] peak_start_time: Starting time for peak period.
        :param pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']] peak_start_vm_on_connect: The desired configuration of Start VM On Connect for the hostpool during the peak phase.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] ramp_down_action_on_disconnect: Action to be taken after a user disconnect during the ramp down period.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] ramp_down_action_on_logoff: Action to be taken after a logoff during the ramp down period.
        :param pulumi.Input[builtins.int] ramp_down_minutes_to_wait_on_disconnect: The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp down period.
        :param pulumi.Input[builtins.int] ramp_down_minutes_to_wait_on_logoff: The time in minutes to wait before performing the desired session handling action when a user logs off during the ramp down period.
        :param pulumi.Input['TimeArgs'] ramp_down_start_time: Starting time for ramp down period.
        :param pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']] ramp_down_start_vm_on_connect: The desired configuration of Start VM On Connect for the hostpool during the ramp down phase.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] ramp_up_action_on_disconnect: Action to be taken after a user disconnect during the ramp up period.
        :param pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']] ramp_up_action_on_logoff: Action to be taken after a logoff during the ramp up period.
        :param pulumi.Input[Union[builtins.str, 'StartupBehavior']] ramp_up_auto_start_hosts: The desired startup behavior during the ramp up period for personal vms in the hostpool.
        :param pulumi.Input[builtins.int] ramp_up_minutes_to_wait_on_disconnect: The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp up period.
        :param pulumi.Input[builtins.int] ramp_up_minutes_to_wait_on_logoff: The time in minutes to wait before performing the desired session handling action when a user logs off during the ramp up period.
        :param pulumi.Input['TimeArgs'] ramp_up_start_time: Starting time for ramp up period.
        :param pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']] ramp_up_start_vm_on_connect: The desired configuration of Start VM On Connect for the hostpool during the ramp up phase. If this is disabled, session hosts must be turned on using rampUpAutoStartHosts or by turning them on manually.
    ...
    def off_peak_action_on_disconnect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def off_peak_action_on_disconnect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "off_peak_action_on_disconnect", value)

    @property
    @pulumi.getter(name="offPeakActionOnLogoff")
    def off_peak_action_on_logoff(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def off_peak_action_on_logoff(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "off_peak_action_on_logoff", value)

    @property
    @pulumi.getter(name="offPeakMinutesToWaitOnDisconnect")
    def off_peak_minutes_to_wait_on_disconnect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def off_peak_minutes_to_wait_on_disconnect(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "off_peak_minutes_to_wait_on_disconnect", value)

    @property
    @pulumi.getter(name="offPeakMinutesToWaitOnLogoff")
    def off_peak_minutes_to_wait_on_logoff(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def off_peak_minutes_to_wait_on_logoff(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def off_peak_start_vm_on_connect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]:
        """
    ...
    def off_peak_start_vm_on_connect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]):
        pulumi.set(self, "off_peak_start_vm_on_connect", value)

    @property
    @pulumi.getter(name="peakActionOnDisconnect")
    def peak_action_on_disconnect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def peak_action_on_disconnect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "peak_action_on_disconnect", value)

    @property
    @pulumi.getter(name="peakActionOnLogoff")
    def peak_action_on_logoff(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def peak_action_on_logoff(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "peak_action_on_logoff", value)

    @property
    @pulumi.getter(name="peakMinutesToWaitOnDisconnect")
    def peak_minutes_to_wait_on_disconnect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def peak_minutes_to_wait_on_disconnect(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "peak_minutes_to_wait_on_disconnect", value)

    @property
    @pulumi.getter(name="peakMinutesToWaitOnLogoff")
    def peak_minutes_to_wait_on_logoff(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def peak_minutes_to_wait_on_logoff(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def peak_start_vm_on_connect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]:
        """
    ...
    def peak_start_vm_on_connect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]):
        pulumi.set(self, "peak_start_vm_on_connect", value)

    @property
    @pulumi.getter(name="rampDownActionOnDisconnect")
    def ramp_down_action_on_disconnect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def ramp_down_action_on_disconnect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "ramp_down_action_on_disconnect", value)

    @property
    @pulumi.getter(name="rampDownActionOnLogoff")
    def ramp_down_action_on_logoff(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def ramp_down_action_on_logoff(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "ramp_down_action_on_logoff", value)

    @property
    @pulumi.getter(name="rampDownMinutesToWaitOnDisconnect")
    def ramp_down_minutes_to_wait_on_disconnect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ramp_down_minutes_to_wait_on_disconnect(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ramp_down_minutes_to_wait_on_disconnect", value)

    @property
    @pulumi.getter(name="rampDownMinutesToWaitOnLogoff")
    def ramp_down_minutes_to_wait_on_logoff(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ramp_down_minutes_to_wait_on_logoff(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ramp_down_start_vm_on_connect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]:
        """
    ...
    def ramp_down_start_vm_on_connect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]):
        pulumi.set(self, "ramp_down_start_vm_on_connect", value)

    @property
    @pulumi.getter(name="rampUpActionOnDisconnect")
    def ramp_up_action_on_disconnect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def ramp_up_action_on_disconnect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "ramp_up_action_on_disconnect", value)

    @property
    @pulumi.getter(name="rampUpActionOnLogoff")
    def ramp_up_action_on_logoff(self) -> Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]:
        """
    ...
    def ramp_up_action_on_logoff(self, value: Optional[pulumi.Input[Union[builtins.str, 'SessionHandlingOperation']]]):
        pulumi.set(self, "ramp_up_action_on_logoff", value)

    @property
    @pulumi.getter(name="rampUpAutoStartHosts")
    def ramp_up_auto_start_hosts(self) -> Optional[pulumi.Input[Union[builtins.str, 'StartupBehavior']]]:
        """
    ...
    def ramp_up_auto_start_hosts(self, value: Optional[pulumi.Input[Union[builtins.str, 'StartupBehavior']]]):
        pulumi.set(self, "ramp_up_auto_start_hosts", value)

    @property
    @pulumi.getter(name="rampUpMinutesToWaitOnDisconnect")
    def ramp_up_minutes_to_wait_on_disconnect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ramp_up_minutes_to_wait_on_disconnect(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ramp_up_minutes_to_wait_on_disconnect", value)

    @property
    @pulumi.getter(name="rampUpMinutesToWaitOnLogoff")
    def ramp_up_minutes_to_wait_on_logoff(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ramp_up_minutes_to_wait_on_logoff(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ramp_up_start_vm_on_connect(self) -> Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]:
        """
    ...
    def ramp_up_start_vm_on_connect(self, value: Optional[pulumi.Input[Union[builtins.str, 'SetStartVMOnConnect']]]):
...
class ScalingPlanPersonalSchedule(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:desktopvirtualization:ScalingPlanPersonalSchedule"
    ...
    @property
    @pulumi.getter(name="offPeakActionOnDisconnect")
    def off_peak_action_on_disconnect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a user disconnect during the off-peak period.
        """
        return pulumi.get(self, "off_peak_action_on_disconnect")
    ...
    @property
    @pulumi.getter(name="offPeakActionOnLogoff")
    def off_peak_action_on_logoff(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a logoff during the off-peak period.
        """
        return pulumi.get(self, "off_peak_action_on_logoff")
    ...
    @property
    @pulumi.getter(name="offPeakMinutesToWaitOnDisconnect")
    def off_peak_minutes_to_wait_on_disconnect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user disconnects during the off-peak period.
        """
        return pulumi.get(self, "off_peak_minutes_to_wait_on_disconnect")
    ...
    @property
    @pulumi.getter(name="offPeakMinutesToWaitOnLogoff")
    def off_peak_minutes_to_wait_on_logoff(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user logs off during the off-peak period.
        """
        return pulumi.get(self, "off_peak_minutes_to_wait_on_logoff")
    ...
    @property
    @pulumi.getter(name="offPeakStartVMOnConnect")
    def off_peak_start_vm_on_connect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The desired configuration of Start VM On Connect for the hostpool during the off-peak phase.
        """
        return pulumi.get(self, "off_peak_start_vm_on_connect")
    ...
    @property
    @pulumi.getter(name="peakActionOnDisconnect")
    def peak_action_on_disconnect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a user disconnect during the peak period.
        """
        return pulumi.get(self, "peak_action_on_disconnect")
    ...
    @property
    @pulumi.getter(name="peakActionOnLogoff")
    def peak_action_on_logoff(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a logoff during the peak period.
        """
        return pulumi.get(self, "peak_action_on_logoff")
    ...
    @property
    @pulumi.getter(name="peakMinutesToWaitOnDisconnect")
    def peak_minutes_to_wait_on_disconnect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user disconnects during the peak period.
        """
        return pulumi.get(self, "peak_minutes_to_wait_on_disconnect")
    ...
    @property
    @pulumi.getter(name="peakMinutesToWaitOnLogoff")
    def peak_minutes_to_wait_on_logoff(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user logs off during the peak period.
        """
        return pulumi.get(self, "peak_minutes_to_wait_on_logoff")
    ...
    @property
    @pulumi.getter(name="peakStartVMOnConnect")
    def peak_start_vm_on_connect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The desired configuration of Start VM On Connect for the hostpool during the peak phase.
        """
        return pulumi.get(self, "peak_start_vm_on_connect")
    ...
    @property
    @pulumi.getter(name="rampDownActionOnDisconnect")
    def ramp_down_action_on_disconnect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a user disconnect during the ramp down period.
        """
        return pulumi.get(self, "ramp_down_action_on_disconnect")
    ...
    @property
    @pulumi.getter(name="rampDownActionOnLogoff")
    def ramp_down_action_on_logoff(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a logoff during the ramp down period.
        """
        return pulumi.get(self, "ramp_down_action_on_logoff")
    ...
    @property
    @pulumi.getter(name="rampDownMinutesToWaitOnDisconnect")
    def ramp_down_minutes_to_wait_on_disconnect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp down period.
        """
        return pulumi.get(self, "ramp_down_minutes_to_wait_on_disconnect")
    ...
    @property
    @pulumi.getter(name="rampDownMinutesToWaitOnLogoff")
    def ramp_down_minutes_to_wait_on_logoff(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user logs off during the ramp down period.
        """
        return pulumi.get(self, "ramp_down_minutes_to_wait_on_logoff")
    ...
    @property
    @pulumi.getter(name="rampDownStartVMOnConnect")
    def ramp_down_start_vm_on_connect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The desired configuration of Start VM On Connect for the hostpool during the ramp down phase.
        """
        return pulumi.get(self, "ramp_down_start_vm_on_connect")
    ...
    @property
    @pulumi.getter(name="rampUpActionOnDisconnect")
    def ramp_up_action_on_disconnect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a user disconnect during the ramp up period.
        """
        return pulumi.get(self, "ramp_up_action_on_disconnect")
    ...
    @property
    @pulumi.getter(name="rampUpActionOnLogoff")
    def ramp_up_action_on_logoff(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Action to be taken after a logoff during the ramp up period.
        """
        return pulumi.get(self, "ramp_up_action_on_logoff")
    ...
    @property
    @pulumi.getter(name="rampUpAutoStartHosts")
    def ramp_up_auto_start_hosts(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The desired startup behavior during the ramp up period for personal vms in the hostpool.
        """
        return pulumi.get(self, "ramp_up_auto_start_hosts")
    ...
    @property
    @pulumi.getter(name="rampUpMinutesToWaitOnDisconnect")
    def ramp_up_minutes_to_wait_on_disconnect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp up period.
        """
        return pulumi.get(self, "ramp_up_minutes_to_wait_on_disconnect")
    ...
    @property
    @pulumi.getter(name="rampUpMinutesToWaitOnLogoff")
    def ramp_up_minutes_to_wait_on_logoff(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in minutes to wait before performing the desired session handling action when a user logs off during the ramp up period.
        """
        return pulumi.get(self, "ramp_up_minutes_to_wait_on_logoff")
    ...
    @property
    @pulumi.getter(name="rampUpStartVMOnConnect")
    def ramp_up_start_vm_on_connect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The desired configuration of Start VM On Connect for the hostpool during the ramp up phase. If this is disabled, session hosts must be turned on using rampUpAutoStartHosts or by turning them on manually.
        """
        return pulumi.get(self, "ramp_up_start_vm_on_connect")
