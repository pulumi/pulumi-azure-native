...
def get_application(application_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20201102preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20201102preview:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
