...
warnings.warn("""Version 2020-11-02-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class HostPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        host_pool = azure_native.desktopvirtualization.v20201102preview.HostPool("hostPool",
            description="des1",
            ...
            registration_info=azure_native.desktopvirtualization.v20201102preview.RegistrationInfoArgs(
    ...
    def _internal_init(__self__,
                 ...
                 vm_template: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HostPool is deprecated: Version 2020-11-02-preview will be removed in v2 of the provider.""")
