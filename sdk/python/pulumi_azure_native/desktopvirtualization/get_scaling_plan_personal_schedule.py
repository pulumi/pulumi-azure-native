...
def get_scaling_plan_personal_schedule(resource_group_name: Optional[str] = None,
    ...
    return AwaitableGetScalingPlanPersonalScheduleResult(
        ...
        id=__ret__.id,
        name=__ret__.name,
        off_peak_action_on_disconnect=__ret__.off_peak_action_on_disconnect,
        off_peak_action_on_logoff=__ret__.off_peak_action_on_logoff,
        off_peak_minutes_to_wait_on_disconnect=__ret__.off_peak_minutes_to_wait_on_disconnect,
        off_peak_minutes_to_wait_on_logoff=__ret__.off_peak_minutes_to_wait_on_logoff,
        off_peak_start_time=__ret__.off_peak_start_time,
        off_peak_start_vm_on_connect=__ret__.off_peak_start_vm_on_connect,
        peak_action_on_disconnect=__ret__.peak_action_on_disconnect,
        peak_action_on_logoff=__ret__.peak_action_on_logoff,
        peak_minutes_to_wait_on_disconnect=__ret__.peak_minutes_to_wait_on_disconnect,
        peak_minutes_to_wait_on_logoff=__ret__.peak_minutes_to_wait_on_logoff,
        peak_start_time=__ret__.peak_start_time,
        peak_start_vm_on_connect=__ret__.peak_start_vm_on_connect,
        ramp_down_action_on_disconnect=__ret__.ramp_down_action_on_disconnect,
        ramp_down_action_on_logoff=__ret__.ramp_down_action_on_logoff,
        ramp_down_minutes_to_wait_on_disconnect=__ret__.ramp_down_minutes_to_wait_on_disconnect,
        ramp_down_minutes_to_wait_on_logoff=__ret__.ramp_down_minutes_to_wait_on_logoff,
        ramp_down_start_time=__ret__.ramp_down_start_time,
        ramp_down_start_vm_on_connect=__ret__.ramp_down_start_vm_on_connect,
        ramp_up_action_on_disconnect=__ret__.ramp_up_action_on_disconnect,
        ramp_up_action_on_logoff=__ret__.ramp_up_action_on_logoff,
        ramp_up_auto_start_hosts=__ret__.ramp_up_auto_start_hosts,
        ramp_up_minutes_to_wait_on_disconnect=__ret__.ramp_up_minutes_to_wait_on_disconnect,
        ramp_up_minutes_to_wait_on_logoff=__ret__.ramp_up_minutes_to_wait_on_logoff,
        ramp_up_start_time=__ret__.ramp_up_start_time,
        ramp_up_start_vm_on_connect=__ret__.ramp_up_start_vm_on_connect,
