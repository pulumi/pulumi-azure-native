...
class GetScalingPlanPersonalScheduleResult:
    ...
    def off_peak_action_on_disconnect(self) -> Optional[builtins.str]:
        """
    ...
    def off_peak_action_on_logoff(self) -> Optional[builtins.str]:
        """
    ...
    def off_peak_minutes_to_wait_on_disconnect(self) -> Optional[builtins.int]:
        """
    ...
    def off_peak_minutes_to_wait_on_logoff(self) -> Optional[builtins.int]:
        """
    ...
    def off_peak_start_vm_on_connect(self) -> Optional[builtins.str]:
        """
    ...
    def peak_action_on_disconnect(self) -> Optional[builtins.str]:
        """
    ...
    def peak_action_on_logoff(self) -> Optional[builtins.str]:
        """
    ...
    def peak_minutes_to_wait_on_disconnect(self) -> Optional[builtins.int]:
        """
    ...
    def peak_minutes_to_wait_on_logoff(self) -> Optional[builtins.int]:
        """
    ...
    def peak_start_vm_on_connect(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_down_action_on_disconnect(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_down_action_on_logoff(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_down_minutes_to_wait_on_disconnect(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_down_minutes_to_wait_on_logoff(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_down_start_vm_on_connect(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_up_action_on_disconnect(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_up_action_on_logoff(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_up_auto_start_hosts(self) -> Optional[builtins.str]:
        """
    ...
    def ramp_up_minutes_to_wait_on_disconnect(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_up_minutes_to_wait_on_logoff(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_up_start_vm_on_connect(self) -> Optional[builtins.str]:
        """
...
def get_scaling_plan_personal_schedule(resource_group_name: Optional[builtins.str] = None,
...
def get_scaling_plan_personal_schedule_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
