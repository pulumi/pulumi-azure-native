...
class AgentUpdatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 maintenance_window_time_zone: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool use_session_host_local_time: Whether to use localTime of the virtual machine.
        """
...
class AppAttachPackageInfoPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_package_timestamped: Optional[_builtins.str] = None,
                 is_regular_registration: Optional[_builtins.bool] = None,
                 last_updated: Optional[_builtins.str] = None,
                 package_alias: Optional[_builtins.str] = None,
                 ...
                 package_family_name: Optional[_builtins.str] = None,
                 package_full_name: Optional[_builtins.str] = None,
                 package_name: Optional[_builtins.str] = None,
                 package_relative_path: Optional[_builtins.str] = None,
...
class AppAttachPackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fail_health_check_on_staging_failure: Optional[_builtins.str] = None,
                 host_pool_references: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.str key_vault_url: URL path to certificate name located in keyVault
        """
...
class MsixPackageApplicationsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 app_user_model_id: Optional[_builtins.str] = None,
                 description: Optional[_builtins.str] = None,
                 friendly_name: Optional[_builtins.str] = None,
                 icon_image_name: Optional[_builtins.str] = None,
                 raw_icon: Optional[_builtins.str] = None,
        ...
        :param _builtins.str friendly_name: User friendly name.
        :param _builtins.str icon_image_name: User friendly name.
        :param _builtins.str raw_icon: the icon a 64 bit string as a byte array.
        :param _builtins.str raw_png: the icon a 64 bit string as a byte array.
        """
...
class MsixPackageDependenciesResponse(dict):
    ...
    def __init__(__self__, *,
                 dependency_name: Optional[_builtins.str] = None,
...
class RegistrationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 registration_token_operation: Optional[_builtins.str] = None,
...
class ScalingHostPoolReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 host_pool_arm_path: Optional[_builtins.str] = None,
...
class ScalingScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 off_peak_load_balancing_algorithm: Optional[_builtins.str] = None,
                 off_peak_start_time: Optional['outputs.TimeResponse'] = None,
                 peak_load_balancing_algorithm: Optional[_builtins.str] = None,
                 peak_start_time: Optional['outputs.TimeResponse'] = None,
                 ramp_down_capacity_threshold_pct: Optional[_builtins.int] = None,
                 ramp_down_force_logoff_users: Optional[_builtins.bool] = None,
                 ramp_down_load_balancing_algorithm: Optional[_builtins.str] = None,
                 ramp_down_minimum_hosts_pct: Optional[_builtins.int] = None,
                 ramp_down_notification_message: Optional[_builtins.str] = None,
                 ramp_down_start_time: Optional['outputs.TimeResponse'] = None,
                 ramp_down_stop_hosts_when: Optional[_builtins.str] = None,
                 ramp_down_wait_time_minutes: Optional[_builtins.int] = None,
                 ramp_up_capacity_threshold_pct: Optional[_builtins.int] = None,
                 ramp_up_load_balancing_algorithm: Optional[_builtins.str] = None,
                 ramp_up_minimum_hosts_pct: Optional[_builtins.int] = None,
        ...
        :param _builtins.str peak_load_balancing_algorithm: Load balancing algorithm for peak period.
        :param 'TimeResponse' peak_start_time: Starting time for peak period.
        :param _builtins.int ramp_down_capacity_threshold_pct: Capacity threshold for ramp down period.
        :param _builtins.bool ramp_down_force_logoff_users: Should users be logged off forcefully from hosts.
        :param _builtins.str ramp_down_load_balancing_algorithm: Load balancing algorithm for ramp down period.
        :param _builtins.int ramp_down_minimum_hosts_pct: Minimum host percentage for ramp down period.
        :param _builtins.str ramp_down_notification_message: Notification message for users during ramp down period.
        :param 'TimeResponse' ramp_down_start_time: Starting time for ramp down period.
        :param _builtins.str ramp_down_stop_hosts_when: Specifies when to stop hosts during ramp down period.
        :param _builtins.int ramp_down_wait_time_minutes: Number of minutes to wait to stop hosts during ramp down period.
        :param _builtins.int ramp_up_capacity_threshold_pct: Capacity threshold for ramp up period.
        :param _builtins.str ramp_up_load_balancing_algorithm: Load balancing algorithm for ramp up period.
        :param _builtins.int ramp_up_minimum_hosts_pct: Minimum host percentage for ramp up period.
