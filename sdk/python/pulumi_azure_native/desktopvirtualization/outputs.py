...
class AgentUpdatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 maintenance_window_time_zone: Optional[builtins.str] = None,
                 maintenance_windows: Optional[Sequence['outputs.MaintenanceWindowPropertiesResponse']] = None,
                 type: Optional[builtins.str] = None,
                 use_session_host_local_time: Optional[builtins.bool] = None):
        """
        The session host configuration for updating agent, monitoring agent, and stack component.
        :param builtins.str maintenance_window_time_zone: Time zone for maintenance as defined in https://docs.microsoft.com/en-us/dotnet/api/system.timezoneinfo.findsystemtimezonebyid?view=net-5.0. Must be set if useLocalTime is true.
        ...
        :param builtins.str type: The type of maintenance for session host components.
        :param builtins.bool use_session_host_local_time: Whether to use localTime of the virtual machine.
        """
    ...
    def maintenance_window_time_zone(self) -> Optional[builtins.str]:
        """
    ...
    def use_session_host_local_time(self) -> Optional[builtins.bool]:
        """
...
class AppAttachPackageInfoPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_package_timestamped: Optional[builtins.str] = None,
                 is_regular_registration: Optional[builtins.bool] = None,
                 last_updated: Optional[builtins.str] = None,
                 package_alias: Optional[builtins.str] = None,
                 ...
                 package_family_name: Optional[builtins.str] = None,
                 package_full_name: Optional[builtins.str] = None,
                 package_name: Optional[builtins.str] = None,
                 package_relative_path: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        Schema for Import Package Information properties.
        :param builtins.str certificate_expiry: Date certificate expires, found in the appxmanifest.xml. 
        :param builtins.str certificate_name: Certificate name found in the appxmanifest.xml. 
        :param builtins.str display_name: User friendly Name to be displayed in the portal. 
        :param builtins.str image_path: VHD/CIM image path on Network Share.
        :param builtins.bool is_active: Make this version of the package the active one across the hostpool. 
        :param builtins.str is_package_timestamped: Is package timestamped so it can ignore the certificate expiry date
        :param builtins.bool is_regular_registration: Specifies how to register Package in feed.
        :param builtins.str last_updated: Date Package was last updated, found in the appxmanifest.xml. 
        :param builtins.str package_alias: Alias of App Attach Package. Assigned at import time
        ...
        :param builtins.str package_family_name: Package Family Name from appxmanifest.xml. Contains Package Name and Publisher name. 
        :param builtins.str package_full_name: Package Full Name from appxmanifest.xml. 
        :param builtins.str package_name: Package Name from appxmanifest.xml. 
        :param builtins.str package_relative_path: Relative Path to the package inside the image. 
        :param builtins.str version: Package version found in the appxmanifest.xml. 
        """
    ...
    def is_package_timestamped(self) -> Optional[builtins.str]:
        """
    ...
    def package_alias(self) -> Optional[builtins.str]:
        """
    ...
    def package_full_name(self) -> Optional[builtins.str]:
        """
...
class AppAttachPackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fail_health_check_on_staging_failure: Optional[builtins.str] = None,
                 host_pool_references: Optional[Sequence[builtins.str]] = None,
                 image: Optional['outputs.AppAttachPackageInfoPropertiesResponse'] = None,
                 key_vault_url: Optional[builtins.str] = None):
        """
        Schema for App Attach Package properties.
        :param builtins.str provisioning_state: The provisioning state of the App Attach Package.
        :param builtins.str fail_health_check_on_staging_failure: Parameter indicating how the health check should behave if this package fails staging
        :param Sequence[builtins.str] host_pool_references: List of Hostpool resource Ids.
        :param 'AppAttachPackageInfoPropertiesResponse' image: Detailed properties for App Attach Package
        :param builtins.str key_vault_url: URL path to certificate name located in keyVault
        """
    ...
    def fail_health_check_on_staging_failure(self) -> Optional[builtins.str]:
        """
    ...
    def host_pool_references(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MaintenanceWindowPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int hour: The update start hour of the day. (0 - 23)
        """
...
class MsixPackageApplicationsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 app_user_model_id: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 friendly_name: Optional[builtins.str] = None,
                 icon_image_name: Optional[builtins.str] = None,
                 raw_icon: Optional[builtins.str] = None,
                 raw_png: Optional[builtins.str] = None):
        """
        Schema for MSIX Package Application properties.
        :param builtins.str app_id: Package Application Id, found in appxmanifest.xml.
        :param builtins.str app_user_model_id: Used to activate Package Application. Consists of Package Name and ApplicationID. Found in appxmanifest.xml.
        :param builtins.str description: Description of Package Application.
        :param builtins.str friendly_name: User friendly name.
        :param builtins.str icon_image_name: User friendly name.
        :param builtins.str raw_icon: the icon a 64 bit string as a byte array.
        :param builtins.str raw_png: the icon a 64 bit string as a byte array.
        """
    ...
    def app_user_model_id(self) -> Optional[builtins.str]:
        """
    ...
    def icon_image_name(self) -> Optional[builtins.str]:
        """
        User friendly name.
        """
    ...
    def raw_icon(self) -> Optional[builtins.str]:
        """
    ...
    def raw_png(self) -> Optional[builtins.str]:
        """
        the icon a 64 bit string as a byte array.
        """
...
class MsixPackageDependenciesResponse(dict):
    ...
    def __init__(__self__, *,
                 dependency_name: Optional[builtins.str] = None,
                 min_version: Optional[builtins.str] = None,
                 publisher: Optional[builtins.str] = None):
        """
        Schema for MSIX Package Dependencies properties.
        :param builtins.str dependency_name: Name of package dependency.
        :param builtins.str min_version: Dependency version required.
        :param builtins.str publisher: Name of dependency publisher.
        """
    ...
    def dependency_name(self) -> Optional[builtins.str]:
        """
...
class RegistrationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 registration_token_operation: Optional[builtins.str] = None,
                 token: Optional[builtins.str] = None):
        """
        Represents a RegistrationInfo definition.
        :param builtins.str expiration_time: Expiration time of registration token.
        :param builtins.str registration_token_operation: The type of resetting the token.
        :param builtins.str token: The registration token base64 encoded string.
        """
...
class ScalingHostPoolReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 host_pool_arm_path: Optional[builtins.str] = None,
                 scaling_plan_enabled: Optional[builtins.bool] = None):
        """
        Scaling plan reference to hostpool.
        :param builtins.str host_pool_arm_path: Arm path of referenced hostpool.
        :param builtins.bool scaling_plan_enabled: Is the scaling plan enabled for this hostpool.
        """
    ...
    def host_pool_arm_path(self) -> Optional[builtins.str]:
        """
    ...
    def scaling_plan_enabled(self) -> Optional[builtins.bool]:
        """
...
class ScalingScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 off_peak_load_balancing_algorithm: Optional[builtins.str] = None,
                 off_peak_start_time: Optional['outputs.TimeResponse'] = None,
                 peak_load_balancing_algorithm: Optional[builtins.str] = None,
                 peak_start_time: Optional['outputs.TimeResponse'] = None,
                 ramp_down_capacity_threshold_pct: Optional[builtins.int] = None,
                 ramp_down_force_logoff_users: Optional[builtins.bool] = None,
                 ramp_down_load_balancing_algorithm: Optional[builtins.str] = None,
                 ramp_down_minimum_hosts_pct: Optional[builtins.int] = None,
                 ramp_down_notification_message: Optional[builtins.str] = None,
                 ramp_down_start_time: Optional['outputs.TimeResponse'] = None,
                 ramp_down_stop_hosts_when: Optional[builtins.str] = None,
                 ramp_down_wait_time_minutes: Optional[builtins.int] = None,
                 ramp_up_capacity_threshold_pct: Optional[builtins.int] = None,
                 ramp_up_load_balancing_algorithm: Optional[builtins.str] = None,
                 ramp_up_minimum_hosts_pct: Optional[builtins.int] = None,
                 ramp_up_start_time: Optional['outputs.TimeResponse'] = None):
        """
        A ScalingPlanPooledSchedule.
        :param Sequence[builtins.str] days_of_week: Set of days of the week on which this schedule is active.
        :param builtins.str name: Name of the ScalingPlanPooledSchedule.
        :param builtins.str off_peak_load_balancing_algorithm: Load balancing algorithm for off-peak period.
        :param 'TimeResponse' off_peak_start_time: Starting time for off-peak period.
        :param builtins.str peak_load_balancing_algorithm: Load balancing algorithm for peak period.
        :param 'TimeResponse' peak_start_time: Starting time for peak period.
        :param builtins.int ramp_down_capacity_threshold_pct: Capacity threshold for ramp down period.
        :param builtins.bool ramp_down_force_logoff_users: Should users be logged off forcefully from hosts.
        :param builtins.str ramp_down_load_balancing_algorithm: Load balancing algorithm for ramp down period.
        :param builtins.int ramp_down_minimum_hosts_pct: Minimum host percentage for ramp down period.
        :param builtins.str ramp_down_notification_message: Notification message for users during ramp down period.
        :param 'TimeResponse' ramp_down_start_time: Starting time for ramp down period.
        :param builtins.str ramp_down_stop_hosts_when: Specifies when to stop hosts during ramp down period.
        :param builtins.int ramp_down_wait_time_minutes: Number of minutes to wait to stop hosts during ramp down period.
        :param builtins.int ramp_up_capacity_threshold_pct: Capacity threshold for ramp up period.
        :param builtins.str ramp_up_load_balancing_algorithm: Load balancing algorithm for ramp up period.
        :param builtins.int ramp_up_minimum_hosts_pct: Minimum host percentage for ramp up period.
...
class TimeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The time for a scaling action to occur.
        :param builtins.int hour: The hour.
        :param builtins.int minute: The minute.
        """
        pulumi.set(__self__, "hour", hour)
