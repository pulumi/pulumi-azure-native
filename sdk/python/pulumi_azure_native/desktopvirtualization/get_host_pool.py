...
class GetHostPoolResult:
    ...
    def app_attach_package_references(self) -> Sequence[builtins.str]:
        """
    ...
    def application_group_references(self) -> Sequence[builtins.str]:
        """
    ...
    def custom_rdp_property(self) -> Optional[builtins.str]:
        """
    ...
    def host_pool_type(self) -> builtins.str:
        """
    ...
    def max_session_limit(self) -> Optional[builtins.int]:
        """
    ...
    def personal_desktop_assignment_type(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def ring(self) -> Optional[builtins.int]:
        """
    ...
    def sso_client_secret_key_vault_path(self) -> Optional[builtins.str]:
        """
    ...
    def sso_secret_type(self) -> Optional[builtins.str]:
        """
    ...
    def ssoadfs_authority(self) -> Optional[builtins.str]:
        """
    ...
    def start_vm_on_connect(self) -> Optional[builtins.bool]:
        """
    ...
    def validation_environment(self) -> Optional[builtins.bool]:
        """
    ...
    def vm_template(self) -> Optional[builtins.str]:
        """
...
def get_host_pool(host_pool_name: Optional[builtins.str] = None,
...
def get_host_pool_output(host_pool_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization:getHostPool', __args__, opts=opts, typ=GetHostPoolResult)
