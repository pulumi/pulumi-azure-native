...
class ScalingPlanPooledScheduleArgs:
    def __init__(__self__, *,
                 ...
                 ramp_up_capacity_threshold_pct: pulumi.Input[int],
    ...
    def ramp_down_capacity_threshold_pct(self) -> pulumi.Input[int]:
        """
    ...
    def ramp_down_capacity_threshold_pct(self, value: pulumi.Input[int]):
    ...
    def ramp_up_capacity_threshold_pct(self) -> pulumi.Input[int]:
        """
    ...
    def ramp_up_capacity_threshold_pct(self, value: pulumi.Input[int]):
...
class ScalingPlanPooledSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if ramp_down_capacity_threshold_pct is None and not opts.urn:
                raise TypeError("Missing required property 'ramp_down_capacity_threshold_pct'")
            ...
            if ramp_up_capacity_threshold_pct is None and not opts.urn:
                raise TypeError("Missing required property 'ramp_up_capacity_threshold_pct'")
    ...
    @property
    @pulumi.getter(name="rampDownCapacityThresholdPct")
    def ramp_down_capacity_threshold_pct(self) -> pulumi.Output[int]:
        """
        Capacity threshold for ramp down period.
        """
        return pulumi.get(self, "ramp_down_capacity_threshold_pct")
    ...
    @property
    @pulumi.getter(name="rampUpCapacityThresholdPct")
    def ramp_up_capacity_threshold_pct(self) -> pulumi.Output[int]:
        """
        Capacity threshold for ramp up period.
        """
        return pulumi.get(self, "ramp_up_capacity_threshold_pct")
