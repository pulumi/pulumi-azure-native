...
def get_private_endpoint_connection_by_host_pool(host_pool_name: Optional[builtins.str] = None,
...
def get_private_endpoint_connection_by_host_pool_output(host_pool_name: Optional[pulumi.Input[builtins.str]] = None,
