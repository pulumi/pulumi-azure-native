...
def list_host_pool_registration_tokens_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20240408preview:listHostPoolRegistrationTokens', __args__, opts=opts, typ=ListHostPoolRegistrationTokensResult)
