...
class PrivateEndpointConnectionByWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection_by_workspace = azure_native.desktopvirtualization.v20221014preview.PrivateEndpointConnectionByWorkspace("privateEndpointConnectionByWorkspace",
