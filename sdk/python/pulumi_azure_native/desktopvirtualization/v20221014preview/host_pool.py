...
class HostPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        host_pool = azure_native.desktopvirtualization.v20221014preview.HostPool("hostPool",
            agent_update=azure_native.desktopvirtualization.v20221014preview.AgentUpdatePropertiesResponseArgs(
                maintenance_window_time_zone="Alaskan Standard Time",
                maintenance_windows=[
                    azure_native.desktopvirtualization.v20221014preview.MaintenanceWindowPropertiesArgs(
                        day_of_week=azure_native.desktopvirtualization/v20221014preview.DayOfWeek.FRIDAY,
                        hour=7,
                    ),
                    azure_native.desktopvirtualization.v20221014preview.MaintenanceWindowPropertiesArgs(
                        day_of_week=azure_native.desktopvirtualization/v20221014preview.DayOfWeek.SATURDAY,
                        hour=8,
                    ),
                ],
                type="Scheduled",
            ...
            registration_info=azure_native.desktopvirtualization.v20221014preview.RegistrationInfoArgs(
