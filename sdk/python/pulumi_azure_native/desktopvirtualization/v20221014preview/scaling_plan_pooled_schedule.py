...
class ScalingPlanPooledSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(off_peak_start_time, TimeArgs):
            ...
            if not isinstance(peak_start_time, TimeArgs):
            ...
            if not isinstance(ramp_down_start_time, TimeArgs):
            ...
            if not isinstance(ramp_up_start_time, TimeArgs):
