...
class ApplicationArgs:
    ...
    def _configure(
        ...
        if 'commandLineSetting' in kwargs:
        ...
        if 'msixPackageApplicationId' in kwargs:
            msix_package_application_id = kwargs['msixPackageApplicationId']
        if 'msixPackageFamilyName' in kwargs:
