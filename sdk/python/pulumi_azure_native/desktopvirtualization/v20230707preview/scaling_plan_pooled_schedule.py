...
class ScalingPlanPooledScheduleArgs:
    ...
    def _configure(
        ...
        if scaling_plan_name is None and 'scalingPlanName' in kwargs:
            scaling_plan_name = kwargs['scalingPlanName']
        if scaling_plan_name is None:
            raise TypeError("Missing 'scaling_plan_name' argument")
        ...
        if scaling_plan_schedule_name is None and 'scalingPlanScheduleName' in kwargs:
            scaling_plan_schedule_name = kwargs['scalingPlanScheduleName']
...
class ScalingPlanPooledSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            off_peak_start_time = _utilities.configure(off_peak_start_time, TimeArgs, True)
            ...
            peak_start_time = _utilities.configure(peak_start_time, TimeArgs, True)
            ...
            ramp_down_start_time = _utilities.configure(ramp_down_start_time, TimeArgs, True)
            ...
            ramp_up_start_time = _utilities.configure(ramp_up_start_time, TimeArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:desktopvirtualization:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20220909:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule"), pulumi.Alias(type_="azure-native:desktopvirtualization/v20230905:ScalingPlanPooledSchedule")])
