...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: azure-native:desktopvirtualization/v20210309preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:Workspace to guarantee forwards compatibility.""")
    __args__ = dict()
