...
warnings.warn("""azure-native:desktopvirtualization/v20210309preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Workspace is deprecated: azure-native:desktopvirtualization/v20210309preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:Workspace to guarantee forwards compatibility.""")
