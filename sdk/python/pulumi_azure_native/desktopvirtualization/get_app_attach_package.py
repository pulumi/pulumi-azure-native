...
def get_app_attach_package(app_attach_package_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str app_attach_package_name: The name of the App Attach package
...
def get_app_attach_package_output(app_attach_package_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
