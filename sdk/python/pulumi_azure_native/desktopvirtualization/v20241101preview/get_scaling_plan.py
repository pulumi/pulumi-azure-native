...
def get_scaling_plan(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20241101preview:getScalingPlan', __args__, opts=opts, typ=GetScalingPlanResult).value
...
def get_scaling_plan_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20241101preview:getScalingPlan', __args__, opts=opts, typ=GetScalingPlanResult)
