...
class GetScalingPlanPooledScheduleResult:
    ...
    def __init__(__self__, create_delete=None, days_of_week=None, id=None, name=None, off_peak_load_balancing_algorithm=None, off_peak_start_time=None, peak_load_balancing_algorithm=None, peak_start_time=None, ramp_down_capacity_threshold_pct=None, ramp_down_force_logoff_users=None, ramp_down_load_balancing_algorithm=None, ramp_down_minimum_hosts_pct=None, ramp_down_notification_message=None, ramp_down_start_time=None, ramp_down_stop_hosts_when=None, ramp_down_wait_time_minutes=None, ramp_up_capacity_threshold_pct=None, ramp_up_load_balancing_algorithm=None, ramp_up_minimum_hosts_pct=None, ramp_up_start_time=None, scaling_method=None, system_data=None, type=None):
        ...
        if scaling_method and not isinstance(scaling_method, str):
            raise TypeError("Expected argument 'scaling_method' to be a str")
        pulumi.set(__self__, "scaling_method", scaling_method)
    ...
    @property
    @pulumi.getter(name="createDelete")
    def create_delete(self) -> Optional['outputs.CreateDeletePropertiesResponse']:
        """
        The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
        """
        return pulumi.get(self, "create_delete")
    ...
    def ramp_down_capacity_threshold_pct(self) -> int:
        """
    ...
    def ramp_up_capacity_threshold_pct(self) -> int:
        """
...
class AwaitableGetScalingPlanPooledScheduleResult(GetScalingPlanPooledScheduleResult):
    ...
    def __await__(self):
        ...
        return GetScalingPlanPooledScheduleResult(
            create_delete=self.create_delete,
...
def get_scaling_plan_pooled_schedule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20241101preview:getScalingPlanPooledSchedule', __args__, opts=opts, typ=GetScalingPlanPooledScheduleResult).value

    return AwaitableGetScalingPlanPooledScheduleResult(
        create_delete=pulumi.get(__ret__, 'create_delete'),
        ...
        scaling_method=pulumi.get(__ret__, 'scaling_method'),
...
def get_scaling_plan_pooled_schedule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20241101preview:getScalingPlanPooledSchedule', __args__, opts=opts, typ=GetScalingPlanPooledScheduleResult)
    return __ret__.apply(lambda __response__: GetScalingPlanPooledScheduleResult(
        create_delete=pulumi.get(__response__, 'create_delete'),
        ...
        scaling_method=pulumi.get(__response__, 'scaling_method'),
