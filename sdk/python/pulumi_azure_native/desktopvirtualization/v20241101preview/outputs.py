...
__all__ = [
    ...
    'CreateDeletePropertiesResponse',
...
@pulumi.output_type
class CreateDeletePropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "rampDownMaximumHostPoolSize":
            suggest = "ramp_down_maximum_host_pool_size"
        elif key == "rampDownMinimumHostPoolSize":
            suggest = "ramp_down_minimum_host_pool_size"
        elif key == "rampUpMaximumHostPoolSize":
            suggest = "ramp_up_maximum_host_pool_size"
        elif key == "rampUpMinimumHostPoolSize":
            suggest = "ramp_up_minimum_host_pool_size"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CreateDeletePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CreateDeletePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
        :param int ramp_down_maximum_host_pool_size: Maximum number of session hosts that may be created by the Scaling Service. This requires the assigned hostpool to have a session host config property.
        :param int ramp_down_minimum_host_pool_size: Minimum number of session hosts that will be be created by the Scaling Service. Scaling will not delete any hosts when this limit is met. This requires the assigned hostpool to have a session host config property.
        :param int ramp_up_maximum_host_pool_size: Maximum number of session hosts that may be created by the Scaling Service. This requires the assigned hostpool to have a session host config property.
        :param int ramp_up_minimum_host_pool_size: Minimum number of session hosts that will be be created by the Scaling Service. Scaling will not delete any hosts when this limit is met. This requires the assigned hostpool to have a session host config property.
        """
        if ramp_down_maximum_host_pool_size is not None:
            pulumi.set(__self__, "ramp_down_maximum_host_pool_size", ramp_down_maximum_host_pool_size)
        if ramp_down_minimum_host_pool_size is not None:
            pulumi.set(__self__, "ramp_down_minimum_host_pool_size", ramp_down_minimum_host_pool_size)
        if ramp_up_maximum_host_pool_size is not None:
            pulumi.set(__self__, "ramp_up_maximum_host_pool_size", ramp_up_maximum_host_pool_size)
        if ramp_up_minimum_host_pool_size is not None:
            pulumi.set(__self__, "ramp_up_minimum_host_pool_size", ramp_up_minimum_host_pool_size)

    @property
    @pulumi.getter(name="rampDownMaximumHostPoolSize")
    def ramp_down_maximum_host_pool_size(self) -> Optional[int]:
        """
        ...
        """
        return pulumi.get(self, "ramp_down_maximum_host_pool_size")

    @property
    @pulumi.getter(name="rampDownMinimumHostPoolSize")
    def ramp_down_minimum_host_pool_size(self) -> Optional[int]:
        """
        ...
        """
        return pulumi.get(self, "ramp_down_minimum_host_pool_size")

    @property
    @pulumi.getter(name="rampUpMaximumHostPoolSize")
    def ramp_up_maximum_host_pool_size(self) -> Optional[int]:
        """
        Maximum number of session hosts that may be created by the Scaling Service. This requires the assigned hostpool to have a session host config property.
        """
        return pulumi.get(self, "ramp_up_maximum_host_pool_size")

    @property
    @pulumi.getter(name="rampUpMinimumHostPoolSize")
    def ramp_up_minimum_host_pool_size(self) -> Optional[int]:
        """
        Minimum number of session hosts that will be be created by the Scaling Service. Scaling will not delete any hosts when this limit is met. This requires the assigned hostpool to have a session host config property.
        """
        return pulumi.get(self, "ramp_up_minimum_host_pool_size")
...
class ScalingScheduleResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "scalingMethod":
            suggest = "scaling_method"
    ...
    def __init__(__self__, *,
                 create_delete: Optional['outputs.CreateDeletePropertiesResponse'] = None,
        ...
        """
        A ScalingPlanPooledSchedule.
        :param 'CreateDeletePropertiesResponse' create_delete: The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
        ...
        :param str scaling_method: The desired scaling method to be used to scale the hosts in the assigned host pool.
        """
