...
class ScalingPlanPooledSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 create_delete: Optional[pulumi.Input[Union['CreateDeletePropertiesArgs', 'CreateDeletePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['CreateDeletePropertiesArgs', 'CreateDeletePropertiesArgsDict']] create_delete: The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
        :param pulumi.Input[Sequence[pulumi.Input[Union[str, 'DayOfWeek']]]] days_of_week: Set of days of the week on which this schedule is active.
        :param pulumi.Input[Union[str, 'SessionHostLoadBalancingAlgorithm']] off_peak_load_balancing_algorithm: Load balancing algorithm for off-peak period.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["create_delete"] = create_delete
            ...
            __props__.__dict__["scaling_method"] = scaling_method
        ...
        super(ScalingPlanPooledSchedule, __self__).__init__(
            'azure-native:desktopvirtualization/v20241101preview:ScalingPlanPooledSchedule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["create_delete"] = None
        ...
        __props__.__dict__["scaling_method"] = None
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
    ...
    @property
    @pulumi.getter(name="createDelete")
    def create_delete(self) -> pulumi.Output[Optional['outputs.CreateDeletePropertiesResponse']]:
        """
        The properties that control how Scaling will manage the size of the hostpool by creating and deleting hosts.
        """
        return pulumi.get(self, "create_delete")
    ...
    @property
    @pulumi.getter(name="scalingMethod")
    def scaling_method(self) -> pulumi.Output[Optional[str]]:
        """
        The desired scaling method to be used to scale the hosts in the assigned host pool.
        """
        return pulumi.get(self, "scaling_method")
