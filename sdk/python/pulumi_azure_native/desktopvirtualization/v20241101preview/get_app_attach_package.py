...
def get_app_attach_package(app_attach_package_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20241101preview:getAppAttachPackage', __args__, opts=opts, typ=GetAppAttachPackageResult).value
...
def get_app_attach_package_output(app_attach_package_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20241101preview:getAppAttachPackage', __args__, opts=opts, typ=GetAppAttachPackageResult)
