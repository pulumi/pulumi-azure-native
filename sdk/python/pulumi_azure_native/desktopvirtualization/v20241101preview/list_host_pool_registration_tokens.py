...
def list_host_pool_registration_tokens(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20241101preview:listHostPoolRegistrationTokens', __args__, opts=opts, typ=ListHostPoolRegistrationTokensResult).value
...
def list_host_pool_registration_tokens_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20241101preview:listHostPoolRegistrationTokens', __args__, opts=opts, typ=ListHostPoolRegistrationTokensResult)
