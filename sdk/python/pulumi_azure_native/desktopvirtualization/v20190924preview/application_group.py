...
azure-native:desktopvirtualization/v20190924preview:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20201110preview:ApplicationGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:desktopvirtualization/v20190924preview:ApplicationGroup is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20201110preview:ApplicationGroup to guarantee forwards compatibility.""")
