...
class HostPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_template: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HostPool is deprecated: Version v20190924preview will be removed in the next major version of the provider. Upgrade to version v20210201preview or later.""")
        if opts is None:
