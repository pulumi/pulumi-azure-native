...
def get_host_pool_registration_token(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20210712:getHostPoolRegistrationToken', __args__, opts=opts, typ=GetHostPoolRegistrationTokenResult).value
...
def get_host_pool_registration_token_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20210712:getHostPoolRegistrationToken', __args__, opts=opts, typ=GetHostPoolRegistrationTokenResult)
