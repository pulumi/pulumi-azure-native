...
class GetHostPoolResult:
    ...
    """
    def __init__(__self__, agent_update=None, app_attach_package_references=None, application_group_references=None, cloud_pc_resource=None, custom_rdp_property=None, description=None, direct_udp=None, etag=None, friendly_name=None, host_pool_type=None, id=None, identity=None, kind=None, load_balancer_type=None, location=None, managed_by=None, managed_private_udp=None, management_type=None, max_session_limit=None, name=None, object_id=None, personal_desktop_assignment_type=None, plan=None, preferred_app_group_type=None, private_endpoint_connections=None, public_network_access=None, public_udp=None, registration_info=None, relay_udp=None, ring=None, sku=None, sso_client_id=None, sso_client_secret_key_vault_path=None, sso_secret_type=None, ssoadfs_authority=None, start_vm_on_connect=None, system_data=None, tags=None, type=None, validation_environment=None, vm_template=None):
        ...
        if direct_udp and not isinstance(direct_udp, str):
            raise TypeError("Expected argument 'direct_udp' to be a str")
        ...
        if managed_private_udp and not isinstance(managed_private_udp, str):
            raise TypeError("Expected argument 'managed_private_udp' to be a str")
        pulumi.set(__self__, "managed_private_udp", managed_private_udp)
        if management_type and not isinstance(management_type, str):
            raise TypeError("Expected argument 'management_type' to be a str")
        ...
        if public_udp and not isinstance(public_udp, str):
            raise TypeError("Expected argument 'public_udp' to be a str")
        ...
        if relay_udp and not isinstance(relay_udp, str):
            raise TypeError("Expected argument 'relay_udp' to be a str")
    ...
    def direct_udp(self) -> Optional[str]:
        """
    ...
    def managed_private_udp(self) -> Optional[str]:
        """
        Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
        """
    ...
    def public_udp(self) -> Optional[str]:
        """
        Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
        """
    ...
    def relay_udp(self) -> Optional[str]:
        """
        Default: AVD-wide settings are used to determine connection availability, Enabled: UDP will attempt this connection type when making connections. This means that this connection is possible, but is not guaranteed, as there are other factors that may prevent this connection type, Disabled: UDP will not attempt this connection type when making connections
        """
...
class AwaitableGetHostPoolResult(GetHostPoolResult):
    ...
    def __await__(self):
        ...
        return GetHostPoolResult(
            ...
            managed_private_udp=self.managed_private_udp,
            ...
            public_udp=self.public_udp,
            registration_info=self.registration_info,
            relay_udp=self.relay_udp,
            ring=self.ring,
            sku=self.sku,
...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:desktopvirtualization/v20240306preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult).value
    ...
    return AwaitableGetHostPoolResult(
        ...
        direct_udp=pulumi.get(__ret__, 'direct_udp'),
        ...
        managed_private_udp=pulumi.get(__ret__, 'managed_private_udp'),
        management_type=pulumi.get(__ret__, 'management_type'),
        ...
        public_udp=pulumi.get(__ret__, 'public_udp'),
        registration_info=pulumi.get(__ret__, 'registration_info'),
        relay_udp=pulumi.get(__ret__, 'relay_udp'),
...
def get_host_pool_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetHostPoolResult(
        ...
        direct_udp=pulumi.get(__response__, 'direct_udp'),
        ...
        managed_private_udp=pulumi.get(__response__, 'managed_private_udp'),
        management_type=pulumi.get(__response__, 'management_type'),
        ...
        public_udp=pulumi.get(__response__, 'public_udp'),
        registration_info=pulumi.get(__response__, 'registration_info'),
        relay_udp=pulumi.get(__response__, 'relay_udp'),
