...
def get_host_pool(host_pool_name: Optional[str] = None,
    ...
    return AwaitableGetHostPoolResult(
        ...
        migration_request=pulumi.get(__ret__, 'migration_request'),
...
def get_host_pool_output(host_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:desktopvirtualization/v20210903preview:getHostPool', __args__, opts=opts, typ=GetHostPoolResult)
    return __ret__.apply(lambda __response__: GetHostPoolResult(
        ...
        migration_request=pulumi.get(__response__, 'migration_request'),
