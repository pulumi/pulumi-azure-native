...
warnings.warn("""azure-native:desktopvirtualization/v20210903preview:MSIXPackage is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_msix_package(host_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_msix_package is deprecated: azure-native:desktopvirtualization/v20210903preview:MSIXPackage is being removed in the next major version of this provider. Please upgrade to azure-native:desktopvirtualization/v20221014preview:MSIXPackage to guarantee forwards compatibility.""")
    __args__ = dict()
