...
class TagRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:elastic/v20200701preview:TagRule"), pulumi.Alias(type_="azure-native:elastic:TagRule"), pulumi.Alias(type_="azure-nextgen:elastic:TagRule"), pulumi.Alias(type_="azure-native:elastic/v20200701:TagRule"), pulumi.Alias(type_="azure-nextgen:elastic/v20200701:TagRule")])
