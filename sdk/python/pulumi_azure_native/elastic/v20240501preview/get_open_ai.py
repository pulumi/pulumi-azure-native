...
def get_open_ai(integration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20240501preview:getOpenAI', __args__, opts=opts, typ=GetOpenAIResult).value
...
def get_open_ai_output(integration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20240501preview:getOpenAI', __args__, opts=opts, typ=GetOpenAIResult)
