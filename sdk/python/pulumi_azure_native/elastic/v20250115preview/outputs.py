...
class ConnectedPartnerResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Connected Partner Resource Properties
        :param str azure_resource_id: The azure resource Id of the resource.
        :param str location: The location of the resource.
        :param str partner_deployment_name: Elastic resource name
        :param str partner_deployment_uri: URL of the resource in Elastic cloud.
        :param str type: The hosting type of the resource.
        """
...
class MonitorPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "hostingType":
            suggest = "hosting_type"
    ...
    def __init__(__self__, *,
                 ...
                 project_details: Optional['outputs.ProjectDetailsResponse'] = None,
        ...
        :param str hosting_type: Hosting type of the monitor resource - either Hosted deployments OR Serverless Projects.
        ...
        :param 'ProjectDetailsResponse' project_details: Project details of the monitor resource IF it belongs to Serverless offer kind.
    ...
    def hosting_type(self) -> Optional[str]:
        """
    ...
    def project_details(self) -> Optional['outputs.ProjectDetailsResponse']:
        """
...
@pulumi.output_type
class ProjectDetailsResponse(dict):
    """
    Project details of the monitor resource IF it belongs to Serverless offer kind.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if key == "configurationType":
            ...
            suggest = "project_type"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProjectDetailsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProjectDetailsResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Project details of the monitor resource IF it belongs to Serverless offer kind.
        :param str configuration_type: Configuration type of the Elasticsearch project
        :param str project_type: Project type; ex: Elasticsearch / Observability / Security
        """
