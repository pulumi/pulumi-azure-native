...
class ListDeploymentInfoResult:
    ...
    """
    def __init__(__self__, configuration_type=None, deployment_url=None, disk_capacity=None, elasticsearch_end_point=None, marketplace_saas_info=None, memory_capacity=None, project_type=None, status=None, version=None):
        ...
        if project_type and not isinstance(project_type, str):
            raise TypeError("Expected argument 'project_type' to be a str")
...
def list_deployment_info(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20250115preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult).value
    ...
    return AwaitableListDeploymentInfoResult(
        ...
        project_type=pulumi.get(__ret__, 'project_type'),
...
def list_deployment_info_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20250115preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult)
    return __ret__.apply(lambda __response__: ListDeploymentInfoResult(
        ...
        project_type=pulumi.get(__response__, 'project_type'),
