...
def get_open_ai_status(integration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20250115preview:getOpenAIStatus', __args__, opts=opts, typ=GetOpenAIStatusResult).value
...
def get_open_ai_status_output(integration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20250115preview:getOpenAIStatus', __args__, opts=opts, typ=GetOpenAIStatusResult)
