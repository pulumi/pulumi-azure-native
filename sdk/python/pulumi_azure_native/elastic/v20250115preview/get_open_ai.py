...
def get_open_ai(integration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20250115preview:getOpenAI', __args__, opts=opts, typ=GetOpenAIResult).value
...
def get_open_ai_output(integration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20250115preview:getOpenAI', __args__, opts=opts, typ=GetOpenAIResult)
