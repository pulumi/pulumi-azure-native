...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitor is deprecated: azure-native:elastic/v20220505preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:Monitor to guarantee forwards compatibility.""")
    __args__ = dict()
