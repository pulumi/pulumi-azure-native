...
def listlist_associated_traffic_filter(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20220505preview:listlistAssociatedTrafficFilter', __args__, opts=opts, typ=ListlistAssociatedTrafficFilterResult).value
