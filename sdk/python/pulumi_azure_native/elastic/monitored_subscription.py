...
class MonitoredSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic/v20240501preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic/v20240615preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic/v20241001preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native_elastic_v20240501preview:elastic:MonitoredSubscription"), pulumi.Alias(type_="azure-native_elastic_v20240615preview:elastic:MonitoredSubscription"), pulumi.Alias(type_="azure-native_elastic_v20241001preview:elastic:MonitoredSubscription"), pulumi.Alias(type_="azure-native_elastic_v20250115preview:elastic:MonitoredSubscription")])
