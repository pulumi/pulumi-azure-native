...
def list_deployment_info(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230501preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult).value
...
def list_deployment_info_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20230501preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult)
