...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230501preview:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value
...
def get_monitor_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20230501preview:getMonitor', __args__, opts=opts, typ=GetMonitorResult)
