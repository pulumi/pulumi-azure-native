...
def get_tag_rule(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_rule is deprecated: azure-native:elastic/v20220701preview:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:TagRule to guarantee forwards compatibility.""")
    __args__ = dict()
