...
warnings.warn("""azure-native:elastic/v20220701preview:Monitor is being removed in the next major version of this provider. Please upgrade to azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitor is deprecated: azure-native:elastic/v20220701preview:Monitor is being removed in the next major version of this provider. Please upgrade to azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.""")
    __args__ = dict()
