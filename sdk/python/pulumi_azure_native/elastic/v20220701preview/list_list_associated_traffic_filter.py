...
def list_list_associated_traffic_filter_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20220701preview:listListAssociatedTrafficFilter', __args__, opts=opts, typ=ListListAssociatedTrafficFilterResult)
