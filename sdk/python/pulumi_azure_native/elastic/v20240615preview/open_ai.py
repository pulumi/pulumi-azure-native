...
class OpenAI(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic/v20240101preview:OpenAI"), pulumi.Alias(type_="azure-native:elastic/v20240301:OpenAI"), pulumi.Alias(type_="azure-native:elastic/v20240501preview:OpenAI"), pulumi.Alias(type_="azure-native:elastic/v20241001preview:OpenAI"), pulumi.Alias(type_="azure-native:elastic/v20250115preview:OpenAI"), pulumi.Alias(type_="azure-native:elastic:OpenAI")])
