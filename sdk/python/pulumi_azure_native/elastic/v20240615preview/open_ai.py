...
class OpenAI(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['OpenAIIntegrationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] integration_name: OpenAI Integration name
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[pulumi.InputType['OpenAIIntegrationPropertiesArgs']] properties: Open AI Integration details.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
