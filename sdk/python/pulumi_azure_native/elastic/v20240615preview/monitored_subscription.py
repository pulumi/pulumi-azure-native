...
class MonitoredSubscriptionInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SubscriptionListArgs'] properties: The request to update subscriptions needed to be monitored by the Elastic monitor resource.
        """
...
class MonitoredSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] configuration_name: The configuration name. Only 'default' value is supported.
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[Union['SubscriptionListArgs', 'SubscriptionListArgsDict']] properties: The request to update subscriptions needed to be monitored by the Elastic monitor resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic/v20240501preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic/v20241001preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic:MonitoredSubscription")])
