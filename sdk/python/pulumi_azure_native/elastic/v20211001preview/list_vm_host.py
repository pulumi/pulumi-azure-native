...
def list_vm_host(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20211001preview:listVMHost', __args__, opts=opts, typ=ListVMHostResult).value
...
def list_vm_host_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20211001preview:listVMHost', __args__, opts=opts, typ=ListVMHostResult)
