...
def list_monitored_resource(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20211001preview:listMonitoredResource', __args__, opts=opts, typ=ListMonitoredResourceResult).value
...
def list_monitored_resource_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20211001preview:listMonitoredResource', __args__, opts=opts, typ=ListMonitoredResourceResult)
