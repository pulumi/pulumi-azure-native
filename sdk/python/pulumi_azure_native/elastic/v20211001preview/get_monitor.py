...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitor is deprecated: azure-native:elastic/v20211001preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['monitorName'] = monitor_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20211001preview:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value
