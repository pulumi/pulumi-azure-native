...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MonitorPropertiesArgs'] properties: Properties of the monitor resource.
...
warnings.warn("""azure-native:elastic/v20211001preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.""", DeprecationWarning)
...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The location of the monitor resource
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[pulumi.InputType['MonitorPropertiesArgs']] properties: Properties of the monitor resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group to which the Elastic resource belongs.
        :param pulumi.Input[pulumi.InputType['ResourceSkuArgs']] sku: SKU of the monitor resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: The tags of the monitor resource.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Monitor is deprecated: azure-native:elastic/v20211001preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20220901preview:Monitor to guarantee forwards compatibility.""")
