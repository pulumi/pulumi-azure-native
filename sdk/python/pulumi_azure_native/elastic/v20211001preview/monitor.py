...
warnings.warn("""azure-native:elastic/v20211001preview:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:elastic/v20230615preview:Monitor to guarantee forwards compatibility.""", DeprecationWarning)
