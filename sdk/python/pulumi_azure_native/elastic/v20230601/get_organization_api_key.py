...
def get_organization_api_key(email_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230601:getOrganizationApiKey', __args__, opts=opts, typ=GetOrganizationApiKeyResult).value
...
def get_organization_api_key_output(email_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['emailId'] = email_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20230601:getOrganizationApiKey', __args__, opts=opts, typ=GetOrganizationApiKeyResult)
