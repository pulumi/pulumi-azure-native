...
def get_tag_rule(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230601:getTagRule', __args__, opts=opts, typ=GetTagRuleResult).value
...
def get_tag_rule_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleSetName'] = rule_set_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20230601:getTagRule', __args__, opts=opts, typ=GetTagRuleResult)
