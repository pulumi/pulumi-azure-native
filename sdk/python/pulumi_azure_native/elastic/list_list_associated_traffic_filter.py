...
def list_list_associated_traffic_filter(monitor_name: Optional[_builtins.str] = None,
...
def list_list_associated_traffic_filter_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
