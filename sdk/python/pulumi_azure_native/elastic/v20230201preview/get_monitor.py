...
class GetMonitorResult:
    ...
    Monitor resource.
    """
    def __init__(__self__, generate_api_key=None, id=None, identity=None, location=None, name=None, properties=None, sku=None, system_data=None, tags=None, type=None):
        if generate_api_key and not isinstance(generate_api_key, bool):
            raise TypeError("Expected argument 'generate_api_key' to be a bool")
...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230201preview:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value

    return AwaitableGetMonitorResult(
        generate_api_key=__ret__.generate_api_key,
        id=__ret__.id,
