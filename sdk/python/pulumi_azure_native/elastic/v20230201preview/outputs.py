...
class MarketplaceSaaSInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Marketplace SAAS Info of the resource.
        :param str marketplace_name: Subscription Details: Marketplace SAAS Name
        :param str marketplace_resource_id: Subscription Details: Marketplace Resource URI
        :param 'MarketplaceSaaSInfoResponseMarketplaceSubscription' marketplace_subscription: Marketplace Subscription Id
        """
