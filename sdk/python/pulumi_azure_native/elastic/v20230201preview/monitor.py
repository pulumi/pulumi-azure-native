...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['IdentityPropertiesArgs', 'IdentityPropertiesArgsDict']] identity: Identity properties of the monitor resource.
        :param pulumi.Input[str] location: The location of the monitor resource
        :param pulumi.Input[str] monitor_name: Monitor resource name
