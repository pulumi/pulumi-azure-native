...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        monitor = azure_native.elastic.v20230201preview.Monitor("monitor",
        ...
        ```sh
        $ pulumi import azure-native:elastic/v20230201preview:Monitor myMonitor /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/monitors/myMonitor 
        ```
