...
def get_tag_rule(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20230201preview:getTagRule', __args__, opts=opts, typ=GetTagRuleResult).value
...
def get_tag_rule_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20230201preview:getTagRule', __args__, opts=opts, typ=GetTagRuleResult)
