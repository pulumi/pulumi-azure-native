...
def get_open_ai(integration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str integration_name: OpenAI Integration name
...
def get_open_ai_output(integration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
