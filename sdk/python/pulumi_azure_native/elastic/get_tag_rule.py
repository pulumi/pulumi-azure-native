...
class GetTagRuleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.MonitoringTagRulesPropertiesTagRuleResponse':
        """
...
def get_tag_rule(monitor_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rule_set_name: Tag Rule Set resource name
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic:getTagRule', __args__, opts=opts, typ=GetTagRuleResult).value
...
def get_tag_rule_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic:getTagRule', __args__, opts=opts, typ=GetTagRuleResult)
