...
def get_tag_rule(monitor_name: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_set_name: Tag Rule Set resource name
    """
    __args__ = dict()
...
def get_tag_rule_output(monitor_name: Optional[pulumi.Input[builtins.str]] = None,
