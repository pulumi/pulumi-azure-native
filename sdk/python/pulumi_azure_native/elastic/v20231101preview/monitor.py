...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic/v20200701:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20200701preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20210901preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20211001preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20220505preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20220701preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20220901preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230201preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230501preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230601:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230615preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230701preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20231001preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20240101preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20240301:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20240501preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20240615preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20241001preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20250115preview:Monitor"), pulumi.Alias(type_="azure-native:elastic:Monitor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Monitor, __self__).__init__(
            'azure-native:elastic/v20231101preview:Monitor',
            resource_name,
            __props__,
            opts)
