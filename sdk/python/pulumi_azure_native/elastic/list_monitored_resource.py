...
def list_monitored_resource(monitor_name: Optional[_builtins.str] = None,
...
def list_monitored_resource_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
