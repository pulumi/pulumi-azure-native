...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20200701:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230201preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230501preview:Monitor"), pulumi.Alias(type_="azure-native:elastic/v20230601:Monitor")])
