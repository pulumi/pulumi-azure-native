...
class ListDeploymentInfoResult:
    ...
    """
    def __init__(__self__, deployment_url=None, disk_capacity=None, memory_capacity=None, status=None, version=None):
...
def list_deployment_info(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20220901preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult).value
...
def list_deployment_info_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20220901preview:listDeploymentInfo', __args__, opts=opts, typ=ListDeploymentInfoResult)
