...
def list_all_traffic_filter(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20220901preview:listAllTrafficFilter', __args__, opts=opts, typ=ListAllTrafficFilterResult).value
...
def list_all_traffic_filter_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20220901preview:listAllTrafficFilter', __args__, opts=opts, typ=ListAllTrafficFilterResult)
