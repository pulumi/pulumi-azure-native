...
def get_billing_info(monitor_name: Optional[_builtins.str] = None,
...
def get_billing_info_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic:getBillingInfo', __args__, opts=opts, typ=GetBillingInfoResult)
