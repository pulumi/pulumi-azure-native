...
class MonitoredSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:elastic/v20240501preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic/v20240615preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic/v20250115preview:MonitoredSubscription"), pulumi.Alias(type_="azure-native:elastic:MonitoredSubscription")])
