...
def get_monitored_subscription(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20241001preview:getMonitoredSubscription', __args__, opts=opts, typ=GetMonitoredSubscriptionResult).value
...
def get_monitored_subscription_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20241001preview:getMonitoredSubscription', __args__, opts=opts, typ=GetMonitoredSubscriptionResult)
