...
def list_connected_partner_resource_output(monitor_name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListConnectedPartnerResourceResult]:
    """
     List of all active elastic deployments.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20241001preview:listConnectedPartnerResource', __args__, opts=opts, typ=ListConnectedPartnerResourceResult)
    return __ret__.apply(lambda __response__: ListConnectedPartnerResourceResult(
