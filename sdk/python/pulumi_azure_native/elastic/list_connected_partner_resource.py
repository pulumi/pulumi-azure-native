...
def list_connected_partner_resource(monitor_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic:listConnectedPartnerResource', __args__, opts=opts, typ=ListConnectedPartnerResourceResult).value

    return AwaitableListConnectedPartnerResourceResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_connected_partner_resource_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic:listConnectedPartnerResource', __args__, opts=opts, typ=ListConnectedPartnerResourceResult)
