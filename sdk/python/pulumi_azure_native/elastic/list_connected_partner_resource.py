...
def list_connected_partner_resource(monitor_name: Optional[builtins.str] = None,
...
def list_connected_partner_resource_output(monitor_name: Optional[pulumi.Input[builtins.str]] = None,
