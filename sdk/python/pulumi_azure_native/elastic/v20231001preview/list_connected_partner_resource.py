...
def list_connected_partner_resource(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:elastic/v20231001preview:listConnectedPartnerResource', __args__, opts=opts, typ=ListConnectedPartnerResourceResult).value
...
def list_connected_partner_resource_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:elastic/v20231001preview:listConnectedPartnerResource', __args__, opts=opts, typ=ListConnectedPartnerResourceResult)
