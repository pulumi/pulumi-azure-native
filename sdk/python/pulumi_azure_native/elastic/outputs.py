...
class ConnectedPartnerResourcePropertiesResponse(dict):
    ...
    def _configure(
        ...
        if partner_deployment_name is None and 'partnerDeploymentName' in kwargs:
            partner_deployment_name = kwargs['partnerDeploymentName']
        if partner_deployment_uri is None and 'partnerDeploymentUri' in kwargs:
...
class PartnerBillingEntityResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if partner_entity_uri is None and 'partnerEntityUri' in kwargs:
