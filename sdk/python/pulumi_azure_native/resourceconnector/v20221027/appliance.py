...
class Appliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        appliance = azure_native.resourceconnector.v20221027.Appliance("appliance",
            distro="AKSEdge",
            infrastructure_config=azure_native.resourceconnector.v20221027.AppliancePropertiesInfrastructureConfigArgs(
                provider="VMWare",
            ),
            location="West US",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resourceconnector:Appliance"), pulumi.Alias(type_="azure-native:resourceconnector/v20211031preview:Appliance"), pulumi.Alias(type_="azure-native:resourceconnector/v20220415preview:Appliance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Appliance, __self__).__init__(
            'azure-native:resourceconnector/v20221027:Appliance',
            resource_name,
            __props__,
            opts)
