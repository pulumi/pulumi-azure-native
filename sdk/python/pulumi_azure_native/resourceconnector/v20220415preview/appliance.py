...
class Appliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resourceconnector:Appliance"), pulumi.Alias(type_="azure-native:resourceconnector/v20211031preview:Appliance")])
