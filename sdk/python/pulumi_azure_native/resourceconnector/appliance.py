...
class Appliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resourceconnector/v20211031preview:Appliance"), pulumi.Alias(type_="azure-native:resourceconnector/v20221027:Appliance"), pulumi.Alias(type_="azure-native_resourceconnector_v20211031preview:resourceconnector:Appliance"), pulumi.Alias(type_="azure-native_resourceconnector_v20220415preview:resourceconnector:Appliance"), pulumi.Alias(type_="azure-native_resourceconnector_v20221027:resourceconnector:Appliance")])
