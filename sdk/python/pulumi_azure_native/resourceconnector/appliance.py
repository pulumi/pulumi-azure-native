...
class ApplianceArgs:
    ...
    def _configure(
        ...
        if 'infrastructureConfig' in kwargs:
...
class Appliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if infrastructure_config is not None and not isinstance(infrastructure_config, AppliancePropertiesInfrastructureConfigArgs):
