...
class ApplianceArgs:
    def __init__(__self__, *,
                 ...
                 distro: Optional[pulumi.Input[Union[builtins.str, 'Distro']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'Distro']] distro: Represents a supported Fabric/Infra. (AKSEdge etc...).
        ...
        :param pulumi.Input[builtins.str] public_key: Certificates pair used to download MSI certificate from HIS. Can only be set once.
        :param pulumi.Input[builtins.str] resource_name: Appliances name.
    ...
    @property
    @pulumi.getter
    def distro(self) -> Optional[pulumi.Input[Union[builtins.str, 'Distro']]]:
        """
    ...
    @distro.setter
    def distro(self, value: Optional[pulumi.Input[Union[builtins.str, 'Distro']]]):
...
class Appliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] public_key: Certificates pair used to download MSI certificate from HIS. Can only be set once.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] resource_name_: Appliances name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.str] version: Version of the Appliance
        """
        ...
    ...
    @property
    @pulumi.getter
    def distro(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Represents a supported Fabric/Infra. (AKSEdge etc...).
        """
        return pulumi.get(self, "distro")
