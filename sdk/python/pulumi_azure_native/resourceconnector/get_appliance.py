...
class GetApplianceResult:
    ...
    @property
    @pulumi.getter
    def distro(self) -> Optional[builtins.str]:
        """
...
def get_appliance(resource_group_name: Optional[builtins.str] = None,
...
def get_appliance_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
