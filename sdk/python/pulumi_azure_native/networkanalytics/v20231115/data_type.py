...
class DataTypeArgs:
    ...
    def _configure(
        ...
        if data_product_name is None:
            raise TypeError("Missing 'data_product_name' argument")
        ...
        if database_cache_retention is None and 'databaseCacheRetention' in kwargs:
            database_cache_retention = kwargs['databaseCacheRetention']
        if database_retention is None and 'databaseRetention' in kwargs:
            database_retention = kwargs['databaseRetention']
        if storage_output_retention is None and 'storageOutputRetention' in kwargs:
