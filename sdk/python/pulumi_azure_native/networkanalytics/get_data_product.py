...
def get_data_product(data_product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkanalytics:getDataProduct', __args__, opts=opts, typ=GetDataProductResult).value
...
def get_data_product_output(data_product_name: Optional[pulumi.Input[str]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataProductResult]:
    """
    Retrieve data product resource.
    Azure REST API version: 2023-11-15.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkanalytics:getDataProduct', __args__, opts=opts, typ=GetDataProductResult)
