...
def list_data_product_roles_assignments(data_product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkanalytics:listDataProductRolesAssignments', __args__, opts=opts, typ=ListDataProductRolesAssignmentsResult).value
...
def list_data_product_roles_assignments_output(data_product_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkanalytics:listDataProductRolesAssignments', __args__, opts=opts, typ=ListDataProductRolesAssignmentsResult)
