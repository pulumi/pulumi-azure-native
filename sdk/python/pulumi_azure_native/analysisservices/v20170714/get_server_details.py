...
def get_server_details(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_details is deprecated: Version v20170714 will be removed in the next major version of the provider. Upgrade to version v20170801 or later.""")
    __args__ = dict()
