...
class GetServerDetailsResult:
    ...
    def backup_blob_container_uri(self) -> Optional[builtins.str]:
        """
    ...
    def managed_mode(self) -> Optional[builtins.int]:
        """
    ...
    def querypool_connection_mode(self) -> Optional[builtins.str]:
        """
    ...
    def server_monitor_mode(self) -> Optional[builtins.int]:
        """
...
def get_server_details(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str server_name: The name of the Analysis Services server. It must be a minimum of 3 characters, and a maximum of 63.
    """
    __args__ = dict()
...
def get_server_details_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
