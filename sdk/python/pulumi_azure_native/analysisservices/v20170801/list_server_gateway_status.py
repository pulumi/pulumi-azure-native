...
def list_server_gateway_status(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:analysisservices/v20170801:listServerGatewayStatus', __args__, opts=opts, typ=ListServerGatewayStatusResult).value
