...
class ServerDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(as_administrators, ServerAdministratorsArgs):
            ...
            if not isinstance(gateway_details, GatewayDetailsArgs):
            ...
            if not isinstance(ip_v4_firewall_settings, IPv4FirewallSettingsArgs):
