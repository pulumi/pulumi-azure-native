...
class ServerDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_details = azure_native.analysisservices.v20170801.ServerDetails("serverDetails",
            as_administrators=azure_native.analysisservices.v20170801.ServerAdministratorsArgs(
                members=[
            ...
            sku=azure_native.analysisservices.v20170801.ResourceSkuArgs(
                capacity=1,
                name="S1",
                tier="Standard",
            ),
