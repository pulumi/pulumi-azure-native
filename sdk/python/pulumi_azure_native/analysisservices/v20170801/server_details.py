...
class ServerDetailsArgs:
    ...
    def _configure(
        ...
        if 'serverMonitorMode' in kwargs:
...
class ServerDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if as_administrators is not None and not isinstance(as_administrators, ServerAdministratorsArgs):
                as_administrators = as_administrators or {}
                def _setter(key, value):
                    as_administrators[key] = value
                ServerAdministratorsArgs._configure(_setter, **as_administrators)
            ...
            if gateway_details is not None and not isinstance(gateway_details, GatewayDetailsArgs):
                gateway_details = gateway_details or {}
                def _setter(key, value):
                    gateway_details[key] = value
                GatewayDetailsArgs._configure(_setter, **gateway_details)
            __props__.__dict__["gateway_details"] = gateway_details
            if ip_v4_firewall_settings is not None and not isinstance(ip_v4_firewall_settings, IPv4FirewallSettingsArgs):
                ip_v4_firewall_settings = ip_v4_firewall_settings or {}
                def _setter(key, value):
                    ip_v4_firewall_settings[key] = value
                IPv4FirewallSettingsArgs._configure(_setter, **ip_v4_firewall_settings)
        ...
        super(ServerDetails, __self__).__init__(
            'azure-native:analysisservices/v20170801:ServerDetails',
            resource_name,
            __props__,
            opts)
