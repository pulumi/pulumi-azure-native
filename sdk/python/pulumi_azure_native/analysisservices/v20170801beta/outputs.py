...
class GatewayDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GatewayDetailsResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            dmts_cluster_uri=dmts_cluster_uri,
    ...
    def _configure(
             ...
             dmts_cluster_uri: Optional[str] = None,
             gateway_object_id: Optional[str] = None,
             gateway_resource_id: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if dmts_cluster_uri is None and 'dmtsClusterUri' in kwargs:
            dmts_cluster_uri = kwargs['dmtsClusterUri']
        if dmts_cluster_uri is None:
            raise TypeError("Missing 'dmts_cluster_uri' argument")
        if gateway_object_id is None and 'gatewayObjectId' in kwargs:
            gateway_object_id = kwargs['gatewayObjectId']
        if gateway_object_id is None:
            raise TypeError("Missing 'gateway_object_id' argument")
        if gateway_resource_id is None and 'gatewayResourceId' in kwargs:
            gateway_resource_id = kwargs['gatewayResourceId']

        _setter("dmts_cluster_uri", dmts_cluster_uri)
        _setter("gateway_object_id", gateway_object_id)
...
class IPv4FirewallRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IPv4FirewallRuleResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class IPv4FirewallSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IPv4FirewallSettingsResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class ServerAdministratorsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServerAdministratorsResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            members=members,
        )
    @staticmethod
