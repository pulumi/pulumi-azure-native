...
def get_server_details(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:analysisservices/v20170801beta:getServerDetails', __args__, opts=opts, typ=GetServerDetailsResult).value
...
def get_server_details_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:analysisservices/v20170801beta:getServerDetails', __args__, opts=opts, typ=GetServerDetailsResult)
