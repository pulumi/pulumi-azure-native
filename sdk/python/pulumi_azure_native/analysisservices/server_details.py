...
class ServerDetailsArgs:
    def __init__(__self__, *,
                 ...
                 backup_blob_container_uri: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 managed_mode: Optional[pulumi.Input[builtins.int]] = None,
                 querypool_connection_mode: Optional[pulumi.Input['ConnectionMode']] = None,
                 server_monitor_mode: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Azure Resource group of which a given Analysis Services server is part. This name must be at least 1 character in length, and no more than 90.
        ...
        :param pulumi.Input[builtins.str] backup_blob_container_uri: The SAS container URI to the backup container.
        ...
        :param pulumi.Input[builtins.str] location: Location of the Analysis Services resource.
        :param pulumi.Input[builtins.int] managed_mode: The managed mode of the server (0 = not managed, 1 = managed).
        ...
        :param pulumi.Input[builtins.int] server_monitor_mode: The server monitor mode for AS server
        :param pulumi.Input[builtins.str] server_name: The name of the Analysis Services server. It must be a minimum of 3 characters, and a maximum of 63.
    ...
    def backup_blob_container_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_blob_container_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def managed_mode(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @managed_mode.setter
    def managed_mode(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def server_monitor_mode(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def server_monitor_mode(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ServerDetails(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupBlobContainerUri")
    def backup_blob_container_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SAS container URI to the backup container.
        """
        return pulumi.get(self, "backup_blob_container_uri")
    ...
    @property
    @pulumi.getter(name="managedMode")
    def managed_mode(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The managed mode of the server (0 = not managed, 1 = managed).
        """
        return pulumi.get(self, "managed_mode")
    ...
    @property
    @pulumi.getter(name="querypoolConnectionMode")
    def querypool_connection_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        How the read-write server's participation in the query pool is controlled.<br/>It can have the following values: <ul><li>readOnly - indicates that the read-write server is intended not to participate in query operations</li><li>all - indicates that the read-write server can participate in query operations</li></ul>Specifying readOnly when capacity is 1 results in error.
        """
        return pulumi.get(self, "querypool_connection_mode")
    ...
    def server_full_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="serverMonitorMode")
    def server_monitor_mode(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The server monitor mode for AS server
        """
        return pulumi.get(self, "server_monitor_mode")
