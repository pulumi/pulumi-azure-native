...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:analysisservices:getServerDetails'.""", DeprecationWarning)
...
def get_server_details(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:analysisservices/latest:getServerDetails', __args__, opts=opts, typ=GetServerDetailsResult).value
