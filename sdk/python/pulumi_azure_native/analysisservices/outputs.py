...
class GatewayDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 dmts_cluster_uri: builtins.str,
                 gateway_object_id: builtins.str,
                 gateway_resource_id: Optional[builtins.str] = None):
        """
        The gateway details.
        :param builtins.str dmts_cluster_uri: Uri of the DMTS cluster.
        :param builtins.str gateway_object_id: Gateway object id from in the DMTS cluster for the gateway resource.
        :param builtins.str gateway_resource_id: Gateway resource to be associated with the server.
        """
    ...
    def dmts_cluster_uri(self) -> builtins.str:
        """
    ...
    def gateway_object_id(self) -> builtins.str:
        """
    ...
    def gateway_resource_id(self) -> Optional[builtins.str]:
        """
...
class IPv4FirewallRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 range_end: Optional[builtins.str] = None,
                 range_start: Optional[builtins.str] = None):
        """
        The detail of firewall rule.
        :param builtins.str firewall_rule_name: The rule name.
        :param builtins.str range_end: The end range of IPv4.
        :param builtins.str range_start: The start range of IPv4.
        """
    ...
    def firewall_rule_name(self) -> Optional[builtins.str]:
        """
        The rule name.
        """
    ...
    def range_end(self) -> Optional[builtins.str]:
        """
    ...
    def range_start(self) -> Optional[builtins.str]:
        """
...
class IPv4FirewallSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_power_bi_service: Optional[builtins.bool] = None,
                 firewall_rules: Optional[Sequence['outputs.IPv4FirewallRuleResponse']] = None):
        """
        An array of firewall rules.
        :param builtins.bool enable_power_bi_service: The indicator of enabling PBI service.
    ...
    def enable_power_bi_service(self) -> Optional[builtins.bool]:
        """
...
class ResourceSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int capacity: The number of instances in the read only query pool.
