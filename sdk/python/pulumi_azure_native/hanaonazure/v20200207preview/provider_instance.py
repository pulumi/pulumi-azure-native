...
class ProviderInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hanaonazure:ProviderInstance"), pulumi.Alias(type_="azure-nextgen:hanaonazure:ProviderInstance")])
