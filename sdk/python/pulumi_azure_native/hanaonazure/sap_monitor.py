...
class SapMonitorArgs:
    ...
    def _configure(
        ...
        if 'enableCustomerAnalytics' in kwargs:
        ...
        if 'logAnalyticsWorkspaceSharedKey' in kwargs:
...
class SapMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hanaonazure/v20200207preview:SapMonitor")])
