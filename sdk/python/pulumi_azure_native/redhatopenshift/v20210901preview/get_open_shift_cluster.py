...
def get_open_shift_cluster_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redhatopenshift/v20210901preview:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult)
