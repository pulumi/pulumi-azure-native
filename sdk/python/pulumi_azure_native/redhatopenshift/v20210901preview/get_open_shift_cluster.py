...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_cluster is deprecated: azure-native:redhatopenshift/v20210901preview:OpenShiftCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:redhatopenshift/v20220904:OpenShiftCluster to guarantee forwards compatibility.""")
    __args__ = dict()
