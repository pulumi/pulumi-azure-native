...
def get_machine_pool(child_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str child_resource_name: The name of the MachinePool resource.
...
def get_machine_pool_output(child_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
