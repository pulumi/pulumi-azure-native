...
def get_machine_pool(child_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str child_resource_name: The name of the MachinePool resource.
...
def get_machine_pool_output(child_resource_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redhatopenshift:getMachinePool', __args__, opts=opts, typ=GetMachinePoolResult)
