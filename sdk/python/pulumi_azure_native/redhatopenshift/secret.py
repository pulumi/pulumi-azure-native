...
class SecretArgs:
    ...
    def _configure(
        ...
        if secret_resources is None and 'secretResources' in kwargs:
            secret_resources = kwargs['secretResources']
