...
def get_sync_set(child_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str child_resource_name: The name of the SyncSet resource.
...
def get_sync_set_output(child_resource_name: Optional[pulumi.Input[builtins.str]] = None,
