...
def get_sync_set(child_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str child_resource_name: The name of the SyncSet resource.
...
def get_sync_set_output(child_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
