...
class APIServerProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        APIServerProfile represents an API server profile.
        :param builtins.str ip: The IP of the cluster API server.
        :param builtins.str url: The URL to access the cluster API server.
        :param builtins.str visibility: API server visibility.
        """
...
class ClusterProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fips_validated_modules: Optional[builtins.str] = None,
                 pull_secret: Optional[builtins.str] = None,
                 resource_group_id: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        ClusterProfile represents a cluster profile.
        :param builtins.str domain: The domain for the cluster.
        :param builtins.str fips_validated_modules: If FIPS validated crypto modules are used
        :param builtins.str pull_secret: The pull secret for the cluster.
        :param builtins.str resource_group_id: The ID of the cluster resource group.
        :param builtins.str version: The version of the cluster.
        """
    ...
    def fips_validated_modules(self) -> Optional[builtins.str]:
        """
...
class ConsoleProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ConsoleProfile represents a console profile.
        :param builtins.str url: The URL to access the cluster console.
        """
        pulumi.set(__self__, "url", url)
...
class EffectiveOutboundIPResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        EffectiveOutboundIP represents an effective outbound IP resource of the cluster public load balancer.
        :param builtins.str id: The fully qualified Azure resource id of an IP address resource.
        """
        if id is not None:
...
class IngressProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IngressProfile represents an ingress profile.
        :param builtins.str ip: The IP of the ingress.
        :param builtins.str name: The ingress profile name.
        :param builtins.str visibility: Ingress visibility.
        """
        pulumi.set(__self__, "ip", ip)
        if name is not None:
...
class ManagedOutboundIPsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ManagedOutboundIPs represents the desired managed outbound IPs for the cluster public load balancer.
        :param builtins.int count: Count represents the desired number of IPv4 outbound IPs created and managed by Azure for the cluster public load balancer.  Allowed values are in the range of 1 - 20.  The default value is 1.
        """
...
class MasterProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encryption_at_host: Optional[builtins.str] = None,
                 subnet_id: Optional[builtins.str] = None,
                 vm_size: Optional[builtins.str] = None):
        """
        MasterProfile represents a master profile.
        :param builtins.str disk_encryption_set_id: The resource ID of an associated DiskEncryptionSet, if applicable.
        :param builtins.str encryption_at_host: Whether master virtual machines are encrypted at host.
        :param builtins.str subnet_id: The Azure resource ID of the master subnet.
        :param builtins.str vm_size: The size of the master VMs.
        """
    ...
    def encryption_at_host(self) -> Optional[builtins.str]:
        """
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preconfigured_nsg: Optional[builtins.str] = None,
        ...
        :param builtins.str outbound_type: The OutboundType used for egress traffic.
        :param builtins.str pod_cidr: The CIDR used for OpenShift/Kubernetes Pods.
        :param builtins.str preconfigured_nsg: Specifies whether subnets are pre-attached with an NSG
        :param builtins.str service_cidr: The CIDR used for OpenShift/Kubernetes Services.
        """
    ...
    def preconfigured_nsg(self) -> Optional[builtins.str]:
        """
...
class ServicePrincipalProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServicePrincipalProfile represents a service principal profile.
        :param builtins.str client_id: The client ID used for the cluster.
        :param builtins.str client_secret: The client secret used for the cluster.
        """
...
class WorkerProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        WorkerProfile represents a worker profile.
        :param builtins.int count: The number of worker VMs.
        :param builtins.str disk_encryption_set_id: The resource ID of an associated DiskEncryptionSet, if applicable.
        :param builtins.int disk_size_gb: The disk size of the worker VMs.
        :param builtins.str encryption_at_host: Whether master virtual machines are encrypted at host.
        :param builtins.str name: The worker profile name.
        :param builtins.str subnet_id: The Azure resource ID of the worker subnet.
        :param builtins.str vm_size: The size of the worker VMs.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if disk_encryption_set_id is not None:
