...
class OpenShiftCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        open_shift_cluster = azure_native.redhatopenshift.v20200430.OpenShiftCluster("openShiftCluster",
            apiserver_profile=azure_native.redhatopenshift.v20200430.APIServerProfileArgs(
                visibility="Public",
            ),
            cluster_profile=azure_native.redhatopenshift.v20200430.ClusterProfileArgs(
            ...
            console_profile=azure_native.redhatopenshift.v20200430.ConsoleProfileArgs(),
            ingress_profiles=[azure_native.redhatopenshift.v20200430.IngressProfileArgs(
                name="default",
                visibility="Public",
            )],
            location="location",
            master_profile=azure_native.redhatopenshift.v20200430.MasterProfileArgs(
            ...
            network_profile=azure_native.redhatopenshift.v20200430.NetworkProfileArgs(
                pod_cidr="10.128.0.0/14",
                service_cidr="172.30.0.0/16",
            ),
            resource_group_name="resourceGroup",
            resource_name_="resourceName",
            service_principal_profile=azure_native.redhatopenshift.v20200430.ServicePrincipalProfileArgs(
                client_id="clientId",
            ...
            worker_profiles=[azure_native.redhatopenshift.v20200430.WorkerProfileArgs(
                count=3,
                disk_size_gb=128,
                name="worker",
