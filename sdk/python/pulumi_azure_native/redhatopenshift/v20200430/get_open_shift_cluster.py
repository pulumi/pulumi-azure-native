...
warnings.warn("""Version 2020-04-30 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_cluster is deprecated: Version 2020-04-30 will be removed in v2 of the provider.""")
    __args__ = dict()
