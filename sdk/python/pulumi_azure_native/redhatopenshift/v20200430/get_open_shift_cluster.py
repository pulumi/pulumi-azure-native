...
warnings.warn("""Version v20200430 will be removed in the next major version of the provider. Upgrade to version v20220401 or later.""", DeprecationWarning)
...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_cluster is deprecated: Version v20200430 will be removed in the next major version of the provider. Upgrade to version v20220401 or later.""")
    __args__ = dict()
