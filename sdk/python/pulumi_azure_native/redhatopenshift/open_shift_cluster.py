...
class OpenShiftClusterArgs:
    ...
    def _configure(
        ...
        if apiserver_profile is None and 'apiserverProfile' in kwargs:
            apiserver_profile = kwargs['apiserverProfile']
        if cluster_profile is None and 'clusterProfile' in kwargs:
            cluster_profile = kwargs['clusterProfile']
        if console_profile is None and 'consoleProfile' in kwargs:
            console_profile = kwargs['consoleProfile']
        if ingress_profiles is None and 'ingressProfiles' in kwargs:
            ingress_profiles = kwargs['ingressProfiles']
        if master_profile is None and 'masterProfile' in kwargs:
            master_profile = kwargs['masterProfile']
        ...
        if worker_profiles is None and 'workerProfiles' in kwargs:
            worker_profiles = kwargs['workerProfiles']
...
class OpenShiftCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            apiserver_profile = _utilities.configure(apiserver_profile, APIServerProfileArgs, True)
            ...
            console_profile = _utilities.configure(console_profile, ConsoleProfileArgs, True)
            __props__.__dict__["console_profile"] = console_profile
            __props__.__dict__["ingress_profiles"] = ingress_profiles
            __props__.__dict__["location"] = location
            master_profile = _utilities.configure(master_profile, MasterProfileArgs, True)
            ...
            service_principal_profile = _utilities.configure(service_principal_profile, ServicePrincipalProfileArgs, True)
