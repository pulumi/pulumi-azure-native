...
def get_secret(child_resource_name: Optional[_builtins.str] = None,
...
def get_secret_output(child_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
