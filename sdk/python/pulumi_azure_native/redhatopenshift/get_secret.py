...
class GetSecretResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, secret_resources=None, system_data=None, type=None):
    ...
    def secret_resources(self) -> Optional[builtins.str]:
        """
...
def get_secret(child_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str child_resource_name: The name of the Secret resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift:getSecret', __args__, opts=opts, typ=GetSecretResult).value
...
def get_secret_output(child_resource_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redhatopenshift:getSecret', __args__, opts=opts, typ=GetSecretResult)
