...
def get_machine_pool(child_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift/v20230701preview:getMachinePool', __args__, opts=opts, typ=GetMachinePoolResult).value
...
def get_machine_pool_output(child_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:redhatopenshift/v20230701preview:getMachinePool', __args__, opts=opts, typ=GetMachinePoolResult)
