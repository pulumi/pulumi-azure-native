...
if not MYPY:
    class LoadBalancerProfileArgsDict(TypedDict):
        ...
        """
        outbound_ip_prefixes: NotRequired[pulumi.Input[Sequence[pulumi.Input['OutboundIPPrefixArgsDict']]]]
        """
        The desired outbound IP Prefix resources for the cluster load balancer.
        """
        outbound_ips: NotRequired[pulumi.Input[Sequence[pulumi.Input['OutboundIPArgsDict']]]]
        """
...
class LoadBalancerProfileArgs:
    def __init__(__self__, *,
                 ...
                 outbound_ip_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPPrefixArgs']]]] = None,
                 outbound_ips: Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPArgs']]]] = None):
        """
        LoadBalancerProfile represents the profile of the cluster public load balancer.
        :param pulumi.Input[int] allocated_outbound_ports: The desired number of allocated SNAT ports per VM. Allowed values are in the range of 0 to 64000 (inclusive). The default value is 1024.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OutboundIPPrefixArgs']]] outbound_ip_prefixes: The desired outbound IP Prefix resources for the cluster load balancer.
        :param pulumi.Input[Sequence[pulumi.Input['OutboundIPArgs']]] outbound_ips: The desired outbound IP resources for the cluster load balancer.
        """
    ...
    def outbound_ip_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPPrefixArgs']]]]:
        """
        The desired outbound IP Prefix resources for the cluster load balancer.
        """
    ...
    def outbound_ip_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPPrefixArgs']]]]):
        pulumi.set(self, "outbound_ip_prefixes", value)

    @property
    @pulumi.getter(name="outboundIps")
    def outbound_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPArgs']]]]:
        """
        The desired outbound IP resources for the cluster load balancer.
        """
    ...
    @outbound_ips.setter
    def outbound_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OutboundIPArgs']]]]):
...
if not MYPY:
    class OutboundIPPrefixArgsDict(TypedDict):
        """
    ...
    OutboundIPPrefixArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class OutboundIPPrefixArgs:
    def __init__(__self__, *,
                 id: Optional[pulumi.Input[str]] = None):
        """
        OutboundIPPrefix represents a desired outbound IP Prefix resource for the cluster load balancer.
        :param pulumi.Input[str] id: The fully qualified Azure resource id of an IP Prefix resource.
        """
        if id is not None:
...
if not MYPY:
    class OutboundIPArgsDict(TypedDict):
        """
    ...
    OutboundIPArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class OutboundIPArgs:
    def __init__(__self__, *,
                 id: Optional[pulumi.Input[str]] = None):
        """
        OutboundIP represents a desired outbound IP resource for the cluster load balancer.
        :param pulumi.Input[str] id: The fully qualified Azure resource id of the IP address resource.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
