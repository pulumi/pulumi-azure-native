...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift/v20230904:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
...
def get_open_shift_cluster_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:redhatopenshift/v20230904:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult)
