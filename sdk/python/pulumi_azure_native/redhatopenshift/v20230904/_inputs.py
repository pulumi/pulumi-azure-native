...
class NetworkProfileArgs:
    def __init__(__self__, *,
        ...
        NetworkProfileArgs._configure(
            ...
            pod_cidr=pod_cidr,
            preconfigured_nsg=preconfigured_nsg,
    ...
    def _configure(
        ...
        if preconfigured_nsg is None and 'preconfiguredNSG' in kwargs:
            preconfigured_nsg = kwargs['preconfiguredNSG']
        ...
        if preconfigured_nsg is not None:
            _setter("preconfigured_nsg", preconfigured_nsg)
