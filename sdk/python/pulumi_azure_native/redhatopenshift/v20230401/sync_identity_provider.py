...
class SyncIdentityProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:redhatopenshift:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20220904:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230701preview:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230904:SyncIdentityProvider")])
