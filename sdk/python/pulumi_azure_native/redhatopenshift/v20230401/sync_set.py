...
class SyncSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:redhatopenshift/v20220904:SyncSet"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230701preview:SyncSet"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230904:SyncSet"), pulumi.Alias(type_="azure-native:redhatopenshift/v20231122:SyncSet"), pulumi.Alias(type_="azure-native:redhatopenshift:SyncSet")])
