...
warnings.warn("""azure-native:redhatopenshift/v20220401:OpenShiftCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:redhatopenshift/v20220904:OpenShiftCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_cluster is deprecated: azure-native:redhatopenshift/v20220401:OpenShiftCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:redhatopenshift/v20220904:OpenShiftCluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift/v20220401:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
