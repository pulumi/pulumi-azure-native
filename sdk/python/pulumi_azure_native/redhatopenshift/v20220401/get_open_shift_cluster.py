...
warnings.warn("""azure-native:redhatopenshift/v20220401:OpenShiftCluster is being removed in the next major version of this provider. Please upgrade to azure-native:redhatopenshift/v20220904:OpenShiftCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_open_shift_cluster is deprecated: azure-native:redhatopenshift/v20220401:OpenShiftCluster is being removed in the next major version of this provider. Please upgrade to azure-native:redhatopenshift/v20220904:OpenShiftCluster to guarantee forwards compatibility.""")
    __args__ = dict()
