...
def get_sync_identity_provider(child_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str child_resource_name: The name of the SyncIdentityProvider resource.
...
def get_sync_identity_provider_output(child_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
