...
def get_sync_identity_provider(child_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str child_resource_name: The name of the SyncIdentityProvider resource.
...
def get_sync_identity_provider_output(child_resource_name: Optional[pulumi.Input[builtins.str]] = None,
