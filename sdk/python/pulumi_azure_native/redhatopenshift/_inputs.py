...
class ClusterProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the cluster resource group.
        :param pulumi.Input[_builtins.str] version: The version of the cluster.
        """
...
class LoadBalancerProfileArgsDict(TypedDict):
    ...
    """
    managed_outbound_ips: NotRequired[pulumi.Input[Optional['ManagedOutboundIPsArgs']]]
    """
...
class MasterProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vm_size: The size of the master VMs.
        """
...
class NetworkProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'PreconfiguredNSG']] preconfigured_nsg: Specifies whether subnets are pre-attached with an NSG
        :param pulumi.Input[_builtins.str] service_cidr: The CIDR used for OpenShift/Kubernetes Services.
        """
...
class WorkerProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'EncryptionAtHost']] encryption_at_host: Whether master virtual machines are encrypted at host.
        :param pulumi.Input[_builtins.str] name: The worker profile name.
        :param pulumi.Input[_builtins.str] subnet_id: The Azure resource ID of the worker subnet.
        :param pulumi.Input[_builtins.str] vm_size: The size of the worker VMs.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if disk_encryption_set_id is not None:
