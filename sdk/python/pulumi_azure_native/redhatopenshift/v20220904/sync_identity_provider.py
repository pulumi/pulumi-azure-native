...
class SyncIdentityProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sync_identity_provider = azure_native.redhatopenshift.v20220904.SyncIdentityProvider("syncIdentityProvider",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:redhatopenshift:SyncIdentityProvider")])
