...
class SyncIdentityProviderArgs:
    def __init__(__self__, *,
        ...
        """
        SyncIdentityProviderArgs._configure(
    ...
    def _configure(
        ...
        if child_resource_name is None and 'childResourceName' in kwargs:
...
class SyncIdentityProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SyncIdentityProviderArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:redhatopenshift:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230401:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230701preview:SyncIdentityProvider"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230904:SyncIdentityProvider")])
