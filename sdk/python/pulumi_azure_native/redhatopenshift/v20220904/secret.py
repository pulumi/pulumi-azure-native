...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:redhatopenshift:Secret"), pulumi.Alias(type_="azure-native:redhatopenshift/v20230401:Secret")])
