...
def get_open_shift_cluster(resource_group_name: Optional[builtins.str] = None,
...
def get_open_shift_cluster_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
