...
def get_open_shift_cluster(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
...
def get_open_shift_cluster_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
