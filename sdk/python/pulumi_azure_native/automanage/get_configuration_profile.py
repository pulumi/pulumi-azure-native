...
def get_configuration_profile(configuration_profile_name: Optional[builtins.str] = None,
...
def get_configuration_profile_output(configuration_profile_name: Optional[pulumi.Input[builtins.str]] = None,
