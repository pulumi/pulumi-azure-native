...
class ConfigurationProfileArgs:
    ...
    def _configure(
        ...
        if configuration_profile_name is None and 'configurationProfileName' in kwargs:
            configuration_profile_name = kwargs['configurationProfileName']
    ...
    def configuration_profile_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def configuration_profile_name(self, value: Optional[pulumi.Input[str]]):
...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ConfigurationProfilePropertiesArgs, True)
