...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automanage:ConfigurationProfile"), pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfile"), pulumi.Alias(type_="azure-nextgen:automanage/v20210430preview:ConfigurationProfile")])
