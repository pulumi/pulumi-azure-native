...
class ConfigurationProfileAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_profile_assignment = azure_native.automanage.v20200630preview.ConfigurationProfileAssignment("configurationProfileAssignment",
            configuration_profile_assignment_name="default",
            properties=azure_native.automanage.v20200630preview.ConfigurationProfileAssignmentPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfileAssignment")])
