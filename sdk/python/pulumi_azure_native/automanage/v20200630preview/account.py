...
warnings.warn("""Version 2020-06-30-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Account is deprecated: Version 2020-06-30-preview will be removed in v2 of the provider.""")
