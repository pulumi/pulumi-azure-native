...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:automanage/v20200630preview:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automanage/v20200630preview:ConfigurationProfileAssignment":
                return ConfigurationProfileAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automanage/v20200630preview:ConfigurationProfilePreference":
    ...
    pulumi.runtime.register_resource_module("azure-native", "automanage/v20200630preview", _module_instance)
