...
def get_configuration_profile_assignment_output(configuration_profile_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage/v20200630preview:getConfigurationProfileAssignment', __args__, opts=opts, typ=GetConfigurationProfileAssignmentResult)
    return __ret__.apply(lambda __response__: GetConfigurationProfileAssignmentResult(
