...
class ConfigurationProfileAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 configuration_profile: Optional[builtins.str] = None):
        """
        Automanage configuration profile assignment properties.
        :param builtins.str status: The status of onboarding, which only appears in the response.
        :param builtins.str target_id: The target VM resource URI
        :param builtins.str configuration_profile: The Automanage configurationProfile ARM Resource URI.
        """
    ...
    def configuration_profile(self) -> Optional[builtins.str]:
        """
