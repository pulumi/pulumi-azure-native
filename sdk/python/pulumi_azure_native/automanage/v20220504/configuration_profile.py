...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_profile = azure_native.automanage.v20220504.ConfigurationProfile("configurationProfile",
            configuration_profile_name="customConfigurationProfile",
            location="East US",
            properties=azure_native.automanage.v20220504.ConfigurationProfilePropertiesArgs(
                configuration={
        ...
        ```sh
        $ pulumi import azure-native:automanage/v20220504:ConfigurationProfile customConfigurationProfile /subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Automanage/configurationProfiles/customConfigurationProfile 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage:ConfigurationProfile"), pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfile, __self__).__init__(
            'azure-native:automanage/v20220504:ConfigurationProfile',
            resource_name,
            __props__,
            opts)
