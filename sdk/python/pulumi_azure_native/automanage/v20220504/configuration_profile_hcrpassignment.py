...
class ConfigurationProfileHCRPAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_profile_hcrpassignment = azure_native.automanage.v20220504.ConfigurationProfileHCRPAssignment("configurationProfileHCRPAssignment",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage:ConfigurationProfileHCRPAssignment"), pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfileHCRPAssignment, __self__).__init__(
            'azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment',
            resource_name,
            __props__,
            opts)
