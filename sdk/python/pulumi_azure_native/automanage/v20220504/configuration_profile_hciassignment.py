...
class ConfigurationProfileHCIAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage:ConfigurationProfileHCIAssignment"), pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfileHCIAssignment")])
