...
def get_configuration_profile(configuration_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automanage/v20220504:getConfigurationProfile', __args__, opts=opts, typ=GetConfigurationProfileResult).value
...
def get_configuration_profile_output(configuration_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage/v20220504:getConfigurationProfile', __args__, opts=opts, typ=GetConfigurationProfileResult)
