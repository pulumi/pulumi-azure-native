...
def get_configuration_profile_hciassignment(cluster_name: Optional[builtins.str] = None,
                                            configuration_profile_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_name: The name of the Arc machine.
...
def get_configuration_profile_hciassignment_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
