...
def get_configuration_profile_hciassignment(cluster_name: Optional[_builtins.str] = None,
                                            configuration_profile_assignment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_name: The name of the Arc machine.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automanage:getConfigurationProfileHCIAssignment', __args__, opts=opts, typ=GetConfigurationProfileHCIAssignmentResult).value
...
def get_configuration_profile_hciassignment_output(cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                                   configuration_profile_assignment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage:getConfigurationProfileHCIAssignment', __args__, opts=opts, typ=GetConfigurationProfileHCIAssignmentResult)
