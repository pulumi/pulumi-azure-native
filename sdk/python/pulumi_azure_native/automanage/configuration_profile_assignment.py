...
class ConfigurationProfileAssignmentArgs:
    def __init__(__self__, *,
        ...
        """
        ConfigurationProfileAssignmentArgs._configure(
    ...
    def _configure(
        ...
        if 'configurationProfileAssignmentName' in kwargs:
...
class ConfigurationProfileAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ConfigurationProfileAssignmentArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ConfigurationProfileAssignmentPropertiesArgs):
