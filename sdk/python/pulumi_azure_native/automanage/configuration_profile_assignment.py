...
class ConfigurationProfileAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native_automanage_v20200630preview:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native_automanage_v20210430preview:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native_automanage_v20220504:automanage:ConfigurationProfileAssignment")])
