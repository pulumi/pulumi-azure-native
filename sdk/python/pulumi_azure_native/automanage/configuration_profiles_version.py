...
class ConfigurationProfilesVersionArgs:
    def __init__(__self__, *,
                 configuration_profile_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] version_name: The configuration profile version name.
        """
    ...
    def configuration_profile_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def configuration_profile_name(self, value: pulumi.Input[builtins.str]):
...
class ConfigurationProfilesVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfilesVersion"), pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfilesVersion")])
