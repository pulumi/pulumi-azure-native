...
__all__ = ['ConfigurationProfileHCRPAssignmentArgs', 'ConfigurationProfileHCRPAssignment']
...
class ConfigurationProfileHCRPAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ConfigurationProfileHCRPAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ConfigurationProfileHCRPAssignmentArgs.__new__(ConfigurationProfileHCRPAssignmentArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment"), pulumi.Alias(type_="azure-native_automanage_v20210430preview:automanage:ConfigurationProfileHCRPAssignment"), pulumi.Alias(type_="azure-native_automanage_v20220504:automanage:ConfigurationProfileHCRPAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfileHCRPAssignment, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ConfigurationProfileHCRPAssignment':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ConfigurationProfileHCRPAssignment(resource_name, opts=opts, __props__=__props__)
