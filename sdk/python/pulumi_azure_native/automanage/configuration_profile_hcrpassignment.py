...
@pulumi.type_token("azure-native:automanage:ConfigurationProfileHCRPAssignment")
class ConfigurationProfileHCRPAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment"), pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment")])
