...
def get_configuration_profile_assignment(configuration_profile_assignment_name: Optional[builtins.str] = None,
...
def get_configuration_profile_assignment_output(configuration_profile_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
