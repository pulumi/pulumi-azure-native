...
def get_configuration_profile_assignment(configuration_profile_assignment_name: Optional[_builtins.str] = None,
...
def get_configuration_profile_assignment_output(configuration_profile_assignment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage:getConfigurationProfileAssignment', __args__, opts=opts, typ=GetConfigurationProfileAssignmentResult)
