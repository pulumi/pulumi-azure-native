...
class ConfigurationProfilePreference(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration_profile_preference_name: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['ConfigurationProfilePreferencePropertiesArgs', 'ConfigurationProfilePreferencePropertiesArgsDict']]] = None,
        ...
        Uses Azure REST API version 2020-06-30-preview. In version 1.x of the Azure Native provider, it used API version 2020-06-30-preview.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] configuration_profile_preference_name: Name of the configuration profile preference.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['ConfigurationProfilePreferencePropertiesArgs', 'ConfigurationProfilePreferencePropertiesArgsDict']] properties: Properties of the configuration profile preference.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage/v20200630preview:ConfigurationProfilePreference")])
