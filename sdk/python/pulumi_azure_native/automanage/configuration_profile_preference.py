...
class ConfigurationProfilePreferenceArgs:
    ...
    def _configure(
        ...
        if 'configurationProfilePreferenceName' in kwargs:
...
class ConfigurationProfilePreference(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ConfigurationProfilePreferencePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ConfigurationProfilePreferencePropertiesArgs._configure(_setter, **properties)
