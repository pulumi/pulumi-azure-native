...
class GetConfigurationProfileHCRPAssignmentResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, managed_by=None, name=None, properties=None, system_data=None, type=None):
...
def get_configuration_profile_hcrpassignment(configuration_profile_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_profile_assignment_name: The configuration profile assignment name.
    :param builtins.str machine_name: The name of the Arc machine.
...
def get_configuration_profile_hcrpassignment_output(configuration_profile_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage:getConfigurationProfileHCRPAssignment', __args__, opts=opts, typ=GetConfigurationProfileHCRPAssignmentResult)
    return __ret__.apply(lambda __response__: GetConfigurationProfileHCRPAssignmentResult(
