...
class ConfigurationProfileHCRPAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationProfileHCRPAssignment is deprecated: azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:automanage/v20220504:ConfigurationProfileHCRPAssignment to guarantee forwards compatibility.""")
        ...
        super(ConfigurationProfileHCRPAssignment, __self__).__init__(
            'azure-native:automanage/v20210430preview:ConfigurationProfileHCRPAssignment',
            resource_name,
            __props__,
            opts)
