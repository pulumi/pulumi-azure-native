...
def get_configuration_profile_output(configuration_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automanage/v20210430preview:getConfigurationProfile', __args__, opts=opts, typ=GetConfigurationProfileResult)
