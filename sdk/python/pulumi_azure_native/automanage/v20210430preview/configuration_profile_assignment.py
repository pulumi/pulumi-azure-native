...
class ConfigurationProfileAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automanage/v20210430preview:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-nextgen:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native:automanage/v20200630preview:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-nextgen:automanage/v20200630preview:ConfigurationProfileAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfileAssignment, __self__).__init__(
            'azure-native:automanage/v20210430preview:ConfigurationProfileAssignment',
            resource_name,
            __props__,
            opts)
