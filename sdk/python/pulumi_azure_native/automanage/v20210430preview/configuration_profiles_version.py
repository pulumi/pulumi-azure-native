...
class ConfigurationProfilesVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automanage:ConfigurationProfilesVersion"), pulumi.Alias(type_="azure-native:automanage/v20220504:ConfigurationProfilesVersion")])
