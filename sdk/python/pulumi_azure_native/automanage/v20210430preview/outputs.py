...
class ConfigurationProfileAssignmentPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "configurationProfile":
            suggest = "configuration_profile"
        elif key == "profileOverrides":
            suggest = "profile_overrides"
        elif key == "targetId":
            suggest = "target_id"
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, Any] profile_overrides: The profileOverrides setting for the configuration profile assignment.
    ...
    def profile_overrides(self) -> Optional[Mapping[str, Any]]:
        """
...
class ConfigurationProfilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[Any] overrides: overrides of the configuration profile.
        """
    ...
    @property
    @pulumi.getter
    def overrides(self) -> Optional[Sequence[Any]]:
        """
