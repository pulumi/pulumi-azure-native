...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automanage/v20210430preview:ConfigurationProfile"), pulumi.Alias(type_="azure-native:automanage:ConfigurationProfile"), pulumi.Alias(type_="azure-nextgen:automanage:ConfigurationProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfile, __self__).__init__(
            'azure-native:automanage/v20210430preview:ConfigurationProfile',
            resource_name,
            __props__,
            opts)
