...
class GetDnsResolverDomainListResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, domains=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, system_data=None, tags=None, type=None):
...
def get_dns_resolver_domain_list(dns_resolver_domain_list_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dns_resolver_domain_list_name: The name of the DNS resolver domain list.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver:getDnsResolverDomainList', __args__, opts=opts, typ=GetDnsResolverDomainListResult).value
...
def get_dns_resolver_domain_list_output(dns_resolver_domain_list_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver:getDnsResolverDomainList', __args__, opts=opts, typ=GetDnsResolverDomainListResult)
