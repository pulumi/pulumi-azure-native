...
def get_dns_resolver_domain_list(dns_resolver_domain_list_name: Optional[builtins.str] = None,
...
def get_dns_resolver_domain_list_output(dns_resolver_domain_list_name: Optional[pulumi.Input[builtins.str]] = None,
