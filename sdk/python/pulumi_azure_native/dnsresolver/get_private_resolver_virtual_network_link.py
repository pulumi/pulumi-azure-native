...
class GetPrivateResolverVirtualNetworkLinkResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, metadata=None, name=None, provisioning_state=None, system_data=None, type=None, virtual_network=None):
...
def get_private_resolver_virtual_network_link(dns_forwarding_ruleset_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver:getPrivateResolverVirtualNetworkLink', __args__, opts=opts, typ=GetPrivateResolverVirtualNetworkLinkResult).value
...
def get_private_resolver_virtual_network_link_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver:getPrivateResolverVirtualNetworkLink', __args__, opts=opts, typ=GetPrivateResolverVirtualNetworkLinkResult)
