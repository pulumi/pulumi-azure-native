...
class DnsResolverPolicyArgs:
    ...
    def dns_resolver_policy_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def dns_resolver_policy_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class DnsResolverPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:dnsresolver/v20250501:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:dnsresolver/v20251001preview:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:network:DnsResolverPolicy")])
