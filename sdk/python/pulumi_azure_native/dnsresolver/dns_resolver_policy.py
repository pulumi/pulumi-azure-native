...
class DnsResolverPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:DnsResolverPolicy"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverPolicy")])
