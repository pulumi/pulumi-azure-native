...
class OutboundEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] outbound_endpoint_name: The name of the outbound endpoint for the DNS resolver.
    ...
    def outbound_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def outbound_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OutboundEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OutboundEndpointArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OutboundEndpointArgs.__new__(OutboundEndpointArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20250501:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20251001preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20200401preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20220701:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20230701preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network:OutboundEndpoint")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'OutboundEndpoint':
        """
        ...
        __props__.__dict__["type"] = None
        return OutboundEndpoint(resource_name, opts=opts, __props__=__props__)
