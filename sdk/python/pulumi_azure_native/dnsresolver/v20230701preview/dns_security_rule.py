...
class DnsSecurityRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver:DnsSecurityRule"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsSecurityRule"), pulumi.Alias(type_="azure-native:network:DnsSecurityRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsSecurityRule, __self__).__init__(
            'azure-native:dnsresolver/v20230701preview:DnsSecurityRule',
            resource_name,
            __props__,
            opts)
