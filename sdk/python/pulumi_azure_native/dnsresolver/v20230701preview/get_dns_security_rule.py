...
def get_dns_security_rule(dns_resolver_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20230701preview:getDnsSecurityRule', __args__, opts=opts, typ=GetDnsSecurityRuleResult).value
...
def get_dns_security_rule_output(dns_resolver_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20230701preview:getDnsSecurityRule', __args__, opts=opts, typ=GetDnsSecurityRuleResult)
