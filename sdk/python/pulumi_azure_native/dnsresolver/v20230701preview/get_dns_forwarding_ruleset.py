...
def get_dns_forwarding_ruleset(dns_forwarding_ruleset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20230701preview:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult).value
...
def get_dns_forwarding_ruleset_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20230701preview:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult)
