...
class DnsResolverDomainList(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverDomainList"), pulumi.Alias(type_="azure-native:dnsresolver:DnsResolverDomainList"), pulumi.Alias(type_="azure-native:network:DnsResolverDomainList")])
