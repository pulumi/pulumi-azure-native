...
__all__ = ['DnsResolverDomainListArgs', 'DnsResolverDomainList']
...
class DnsResolverDomainListArgs:
    def __init__(__self__, *,
                 ...
                 dns_resolver_domain_list_name: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        The set of arguments for constructing a DnsResolverDomainList resource.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] domains: The domains in the domain list.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] dns_resolver_domain_list_name: The name of the DNS resolver domain list.
    ...
    def dns_resolver_domain_list_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def dns_resolver_domain_list_name(self, value: Optional[pulumi.Input[str]]):
...
class DnsResolverDomainList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DnsResolverDomainListArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Describes a DNS resolver domain list.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsResolverDomainListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver:DnsResolverDomainList"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverDomainList"), pulumi.Alias(type_="azure-native:network:DnsResolverDomainList")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsResolverDomainList, __self__).__init__(
            'azure-native:dnsresolver/v20230701preview:DnsResolverDomainList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DnsResolverDomainList':
        """
        ...
        __props__.__dict__["type"] = None
        return DnsResolverDomainList(resource_name, opts=opts, __props__=__props__)
