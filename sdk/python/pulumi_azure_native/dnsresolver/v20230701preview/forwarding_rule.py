...
class ForwardingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20200401preview:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20220701:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20230701preview:ForwardingRule"), pulumi.Alias(type_="azure-native:network:ForwardingRule")])
