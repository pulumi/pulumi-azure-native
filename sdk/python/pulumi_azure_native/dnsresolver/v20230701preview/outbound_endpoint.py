...
class OutboundEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:OutboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20200401preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20220701:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20230701preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network:OutboundEndpoint")])
