...
class GetDnsResolverDomainListResult:
    ...
    """
    def __init__(__self__, domains=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, system_data=None, tags=None, type=None):
...
class AwaitableGetDnsResolverDomainListResult(GetDnsResolverDomainListResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetDnsResolverDomainListResult(
...
def get_dns_resolver_domain_list(dns_resolver_domain_list_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20230701preview:getDnsResolverDomainList', __args__, opts=opts, typ=GetDnsResolverDomainListResult).value

    return AwaitableGetDnsResolverDomainListResult(
...
def get_dns_resolver_domain_list_output(dns_resolver_domain_list_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20230701preview:getDnsResolverDomainList', __args__, opts=opts, typ=GetDnsResolverDomainListResult)
