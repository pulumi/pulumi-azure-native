...
class DnsResolver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver:DnsResolver"), pulumi.Alias(type_="azure-native:network/v20220701:DnsResolver"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolver"), pulumi.Alias(type_="azure-native:network:DnsResolver")])
