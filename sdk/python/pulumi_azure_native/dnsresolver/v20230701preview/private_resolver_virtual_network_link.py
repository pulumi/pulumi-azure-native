...
class PrivateResolverVirtualNetworkLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:dnsresolver:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20200401preview:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20220701:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20230701preview:PrivateResolverVirtualNetworkLink"), pulumi.Alias(type_="azure-native:network:PrivateResolverVirtualNetworkLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateResolverVirtualNetworkLink, __self__).__init__(
            'azure-native:dnsresolver/v20230701preview:PrivateResolverVirtualNetworkLink',
            resource_name,
            __props__,
            opts)
