...
def list_dns_resolver_policy_by_virtual_network(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20230701preview:listDnsResolverPolicyByVirtualNetwork', __args__, opts=opts, typ=ListDnsResolverPolicyByVirtualNetworkResult).value
...
def list_dns_resolver_policy_by_virtual_network_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20230701preview:listDnsResolverPolicyByVirtualNetwork', __args__, opts=opts, typ=ListDnsResolverPolicyByVirtualNetworkResult)
