...
class DnsForwardingRuleset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dns_forwarding_ruleset_name: Optional[pulumi.Input[str]] = None,
                 dns_resolver_outbound_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SubResourceArgs', 'SubResourceArgsDict']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] dns_forwarding_ruleset_name: The name of the DNS forwarding ruleset.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SubResourceArgs', 'SubResourceArgsDict']]]] dns_resolver_outbound_endpoints: The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:dnsresolver:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20200401preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20220701:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network:DnsForwardingRuleset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsForwardingRuleset, __self__).__init__(
            'azure-native:dnsresolver/v20230701preview:DnsForwardingRuleset',
            resource_name,
            __props__,
            opts)
