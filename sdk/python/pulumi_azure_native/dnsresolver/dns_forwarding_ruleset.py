...
class DnsForwardingRuleset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20200401preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20220701:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsForwardingRuleset")])
