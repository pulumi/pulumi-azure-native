...
class ForwardingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220701:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20230701preview:ForwardingRule"), pulumi.Alias(type_="azure-native:network:ForwardingRule"), pulumi.Alias(type_="azure-native_dnsresolver_v20200401preview:dnsresolver:ForwardingRule"), pulumi.Alias(type_="azure-native_dnsresolver_v20220701:dnsresolver:ForwardingRule"), pulumi.Alias(type_="azure-native_dnsresolver_v20230701preview:dnsresolver:ForwardingRule")])
