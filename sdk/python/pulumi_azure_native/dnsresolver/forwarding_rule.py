...
class ForwardingRuleArgs:
    def __init__(__self__, *,
                 ...
                 forwarding_rule_state: Optional[pulumi.Input[Union[builtins.str, 'ForwardingRuleState']]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_name: The domain name for the forwarding rule.
        ...
        :param pulumi.Input[builtins.str] forwarding_rule_name: The name of the forwarding rule.
        :param pulumi.Input[Union[builtins.str, 'ForwardingRuleState']] forwarding_rule_state: The state of forwarding rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata attached to the forwarding rule.
        """
    ...
    def forwarding_rule_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'ForwardingRuleState']]]:
        """
    ...
    def forwarding_rule_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'ForwardingRuleState']]]):
...
class ForwardingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20250501:ForwardingRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20251001preview:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20220701:ForwardingRule"), pulumi.Alias(type_="azure-native:network/v20230701preview:ForwardingRule"), pulumi.Alias(type_="azure-native:network:ForwardingRule")])
    ...
    @property
    @pulumi.getter(name="forwardingRuleState")
    def forwarding_rule_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The state of forwarding rule.
        """
        return pulumi.get(self, "forwarding_rule_state")
