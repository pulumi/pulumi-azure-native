...
def get_forwarding_rule(dns_forwarding_ruleset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20220701:getForwardingRule', __args__, opts=opts, typ=GetForwardingRuleResult).value
...
def get_forwarding_rule_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20220701:getForwardingRule', __args__, opts=opts, typ=GetForwardingRuleResult)
