...
def get_inbound_endpoint(dns_resolver_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20220701:getInboundEndpoint', __args__, opts=opts, typ=GetInboundEndpointResult).value
...
def get_inbound_endpoint_output(dns_resolver_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20220701:getInboundEndpoint', __args__, opts=opts, typ=GetInboundEndpointResult)
