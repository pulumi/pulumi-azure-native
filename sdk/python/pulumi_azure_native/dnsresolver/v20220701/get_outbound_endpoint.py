...
def get_outbound_endpoint(dns_resolver_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20220701:getOutboundEndpoint', __args__, opts=opts, typ=GetOutboundEndpointResult).value
...
def get_outbound_endpoint_output(dns_resolver_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20220701:getOutboundEndpoint', __args__, opts=opts, typ=GetOutboundEndpointResult)
