...
def get_private_resolver_virtual_network_link(dns_forwarding_ruleset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20220701:getPrivateResolverVirtualNetworkLink', __args__, opts=opts, typ=GetPrivateResolverVirtualNetworkLinkResult).value
...
def get_private_resolver_virtual_network_link_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20220701:getPrivateResolverVirtualNetworkLink', __args__, opts=opts, typ=GetPrivateResolverVirtualNetworkLinkResult)
