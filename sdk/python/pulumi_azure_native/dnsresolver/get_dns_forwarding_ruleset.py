...
def get_dns_forwarding_ruleset(dns_forwarding_ruleset_name: Optional[builtins.str] = None,
...
def get_dns_forwarding_ruleset_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[builtins.str]] = None,
