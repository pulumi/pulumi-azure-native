...
class GetDnsForwardingRulesetResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, dns_resolver_outbound_endpoints=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, system_data=None, tags=None, type=None):
...
def get_dns_forwarding_ruleset(dns_forwarding_ruleset_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult).value
...
def get_dns_forwarding_ruleset_output(dns_forwarding_ruleset_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult)
