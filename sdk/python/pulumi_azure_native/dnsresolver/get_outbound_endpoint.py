...
def get_outbound_endpoint(dns_resolver_name: Optional[_builtins.str] = None,
                          outbound_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str outbound_endpoint_name: The name of the outbound endpoint for the DNS resolver.
...
def get_outbound_endpoint_output(dns_resolver_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 outbound_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
