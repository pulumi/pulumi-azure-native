...
def get_dns_resolver(dns_resolver_name: Optional[builtins.str] = None,
...
def get_dns_resolver_output(dns_resolver_name: Optional[pulumi.Input[builtins.str]] = None,
