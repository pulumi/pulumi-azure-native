...
class GetDnsResolverResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, dns_resolver_state=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, system_data=None, tags=None, type=None, virtual_network=None):
...
def get_dns_resolver(dns_resolver_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver:getDnsResolver', __args__, opts=opts, typ=GetDnsResolverResult).value
...
def get_dns_resolver_output(dns_resolver_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver:getDnsResolver', __args__, opts=opts, typ=GetDnsResolverResult)
