...
class InboundEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20220701:InboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:InboundEndpoint"), pulumi.Alias(type_="azure-native:dnsresolver:InboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20200401preview:InboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20220701:InboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20230701preview:InboundEndpoint"), pulumi.Alias(type_="azure-native:network:InboundEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(InboundEndpoint, __self__).__init__(
            'azure-native:dnsresolver/v20200401preview:InboundEndpoint',
            resource_name,
            __props__,
            opts)
