...
def get_dns_resolver(dns_resolver_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20200401preview:getDnsResolver', __args__, opts=opts, typ=GetDnsResolverResult).value
...
def get_dns_resolver_output(dns_resolver_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20200401preview:getDnsResolver', __args__, opts=opts, typ=GetDnsResolverResult)
