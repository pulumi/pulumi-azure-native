...
def list_dns_resolver_by_virtual_network(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver/v20200401preview:listDnsResolverByVirtualNetwork', __args__, opts=opts, typ=ListDnsResolverByVirtualNetworkResult).value
...
def list_dns_resolver_by_virtual_network_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver/v20200401preview:listDnsResolverByVirtualNetwork', __args__, opts=opts, typ=ListDnsResolverByVirtualNetworkResult)
