...
class DnsSecurityRuleArgs:
    def __init__(__self__, *,
                 ...
                 dns_resolver_policy_name: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int],
                 resource_group_name: pulumi.Input[builtins.str],
                 dns_security_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_security_rule_state: Optional[pulumi.Input[Union[builtins.str, 'DnsSecurityRuleState']]] = None,
        ...
        :param pulumi.Input[builtins.str] dns_resolver_policy_name: The name of the DNS resolver policy.
        :param pulumi.Input[builtins.int] priority: The priority of the DNS security rule.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] dns_security_rule_name: The name of the DNS security rule.
        :param pulumi.Input[Union[builtins.str, 'DnsSecurityRuleState']] dns_security_rule_state: The state of DNS security rule.
    ...
    def dns_resolver_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dns_resolver_policy_name(self, value: pulumi.Input[builtins.str]):
    ...
    def dns_security_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_security_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_security_rule_name", value)

    @property
    @pulumi.getter(name="dnsSecurityRuleState")
    def dns_security_rule_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'DnsSecurityRuleState']]]:
        """
    ...
    def dns_security_rule_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'DnsSecurityRuleState']]]):
...
class DnsSecurityRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dns_resolver_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_security_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_security_rule_state: Optional[pulumi.Input[Union[builtins.str, 'DnsSecurityRuleState']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dnsSecurityRuleState")
    def dns_security_rule_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The state of DNS security rule.
        """
        return pulumi.get(self, "dns_security_rule_state")
