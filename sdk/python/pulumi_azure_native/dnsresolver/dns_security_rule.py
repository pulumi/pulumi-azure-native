...
class DnsSecurityRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsSecurityRule"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:DnsSecurityRule"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsSecurityRule")])
