...
class DnsResolverArgs:
    def __init__(__self__, *,
                 ...
                 dns_resolver_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def dns_resolver_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def dns_resolver_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("azure-native:dnsresolver:DnsResolver")
class DnsResolver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dnsresolver/v20200401preview:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver/v20220701:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver/v20230701preview:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver/v20250501:DnsResolver"), pulumi.Alias(type_="azure-native:dnsresolver/v20251001preview:DnsResolver"), pulumi.Alias(type_="azure-native:network/v20220701:DnsResolver"), pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolver"), pulumi.Alias(type_="azure-native:network:DnsResolver")])
    ...
    def dns_resolver_state(self) -> pulumi.Output[_builtins.str]:
        """
