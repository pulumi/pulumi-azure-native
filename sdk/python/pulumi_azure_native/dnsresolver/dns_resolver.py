...
class DnsResolverArgs:
    ...
    def dns_resolver_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_resolver_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DnsResolver(pulumi.CustomResource):
    ...
    def dns_resolver_state(self) -> pulumi.Output[builtins.str]:
        """
