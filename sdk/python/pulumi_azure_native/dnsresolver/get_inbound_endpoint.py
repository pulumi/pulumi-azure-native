...
def get_inbound_endpoint(dns_resolver_name: Optional[_builtins.str] = None,
                         inbound_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str inbound_endpoint_name: The name of the inbound endpoint for the DNS resolver.
...
def get_inbound_endpoint_output(dns_resolver_name: pulumi.Input[Optional[_builtins.str]] = None,
                                inbound_endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
