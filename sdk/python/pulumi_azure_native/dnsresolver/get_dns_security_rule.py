...
class GetDnsSecurityRuleResult:
    ...
    """
    def __init__(__self__, action=None, azure_api_version=None, dns_resolver_domain_lists=None, dns_security_rule_state=None, etag=None, id=None, location=None, name=None, priority=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_dns_security_rule(dns_resolver_policy_name: Optional[_builtins.str] = None,
                          dns_security_rule_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dns_security_rule_name: The name of the DNS security rule.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dnsresolver:getDnsSecurityRule', __args__, opts=opts, typ=GetDnsSecurityRuleResult).value
...
def get_dns_security_rule_output(dns_resolver_policy_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 dns_security_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dnsresolver:getDnsSecurityRule', __args__, opts=opts, typ=GetDnsSecurityRuleResult)
