...
warnings.warn("""azure-native:webpubsub/v20210901preview:WebPubSubSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230201:WebPubSubSharedPrivateLinkResource to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebPubSubSharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 shared_private_link_resource_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebPubSubSharedPrivateLinkResource is deprecated: azure-native:webpubsub/v20210901preview:WebPubSubSharedPrivateLinkResource is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230201:WebPubSubSharedPrivateLinkResource to guarantee forwards compatibility.""")
