...
def get_web_pub_sub_hub(hub_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hub_name: The hub name.
...
def get_web_pub_sub_hub_output(hub_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
