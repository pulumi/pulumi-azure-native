...
class WebPubSubHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub_hub = azure_native.webpubsub.v20230301preview.WebPubSubHub("webPubSubHub",
            hub_name="exampleHub",
            properties=azure_native.webpubsub.v20230301preview.WebPubSubHubPropertiesResponseArgs(
                anonymous_connect_policy="allow",
                event_handlers=[{
                    "auth": {
                        "managedIdentity": azure_native.webpubsub.v20230301preview.ManagedIdentitySettingsArgs(
                            resource="abc",
                        ),
                ...
                event_listeners=[{
                    "endpoint": azure_native.webpubsub.v20230301preview.EventHubEndpointResponseArgs(
                        event_hub_name="eventHubName1",
                        fully_qualified_namespace="example.servicebus.windows.net",
                        type="EventHub",
                    ),
                    "filter": azure_native.webpubsub.v20230301preview.EventNameFilterResponseArgs(
                        system_events=[
                            "connected",
                            "disconnected",
                        ],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20211001:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubHub")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubHub, __self__).__init__(
            'azure-native:webpubsub/v20230301preview:WebPubSubHub',
            resource_name,
            __props__,
            opts)
