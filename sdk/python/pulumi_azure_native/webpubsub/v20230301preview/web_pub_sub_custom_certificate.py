...
class WebPubSubCustomCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub_custom_certificate = azure_native.webpubsub.v20230301preview.WebPubSubCustomCertificate("webPubSubCustomCertificate",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubCustomCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubCustomCertificate, __self__).__init__(
            'azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate',
            resource_name,
            __props__,
            opts)
