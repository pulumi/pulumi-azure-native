...
def get_web_pub_sub_custom_domain(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20240401preview:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult).value
...
def get_web_pub_sub_custom_domain_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20240401preview:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult)
