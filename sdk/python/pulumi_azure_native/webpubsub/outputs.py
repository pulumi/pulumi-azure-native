...
class EventHandlerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] system_events: Gets or sets the list of system events.
        :param _builtins.str user_event_pattern: Gets or sets the matching pattern for event names.
...
class LiveTraceCategoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str enabled: Indicates whether or the live trace category is enabled.
               ...
               Case insensitive.
        :param _builtins.str name: Gets or sets the live trace category's name.
...
class ManagedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tenant_id: Get the tenant id for the system assigned identity.
               Only be used in response
        :param _builtins.str type: Represents the identity type: systemAssigned, userAssigned, None
...
class NetworkACLResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 allow: Optional[Sequence[_builtins.str]] = None,
...
class ResourceLogCategoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str enabled: Indicates whether or the resource log category is enabled.
               Available values: true, false.
               Case insensitive.
        :param _builtins.str name: Gets or sets the resource log category's name.
               Available values: ConnectivityLogs, MessagingLogs.
               Case insensitive.
        """
        if enabled is not None:
...
class ResourceSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str size: Not used. Retained for future use.
        :param _builtins.int capacity: Optional, integer. The unit count of the resource.
...
class SharedPrivateLinkResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: Provisioning state of the resource.
        :param _builtins.str status: Status of the shared private link resource
        :param 'SystemDataResponse' system_data: Azure Resource Manager metadata containing createdBy and modifiedBy information.
        :param _builtins.str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
...
class WebPubSubHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 anonymous_connect_policy: Optional[_builtins.str] = None,
        ...
        :param _builtins.int web_socket_keep_alive_interval_in_seconds: The settings for configuring the WebSocket ping-pong interval in seconds for all clients in the hub. Valid range: 1 to 120. Default to 20 seconds.
        """
