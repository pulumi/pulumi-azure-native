...
class WebPubSubCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_certificate: pulumi.Input[Optional[Union['ResourceReferenceArgs', 'ResourceReferenceArgsDict']]] = None,
