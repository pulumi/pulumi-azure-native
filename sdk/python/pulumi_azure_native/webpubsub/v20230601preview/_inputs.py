...
class EventHubEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        EventHubEndpointArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             fully_qualified_namespace: Optional[pulumi.Input[str]] = None,
        ...
        if fully_qualified_namespace is None and 'fullyQualifiedNamespace' in kwargs:
            fully_qualified_namespace = kwargs['fullyQualifiedNamespace']
        if fully_qualified_namespace is None:
            raise TypeError("Missing 'fully_qualified_namespace' argument")
        if type is None:
...
class EventListenerArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             endpoint: Optional[pulumi.Input['EventHubEndpointArgs']] = None,
             filter: Optional[pulumi.Input['EventNameFilterArgs']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if endpoint is None:
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_event_pattern: Gets or sets a matching pattern for event names.
               There are 3 kinds of patterns supported:
                   ...
                   3. A single event name, for example, "event1", it matches "event1"
        """
        EventNameFilterArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            type=type,
            system_events=system_events,
            user_event_pattern=user_event_pattern,
...
class WebPubSubHubPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        WebPubSubHubPropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if anonymous_connect_policy is None and 'anonymousConnectPolicy' in kwargs:
            anonymous_connect_policy = kwargs['anonymousConnectPolicy']
...
class WebPubSubNetworkACLsArgs:
    def __init__(__self__, *,
        ...
        """
        WebPubSubNetworkACLsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class WebPubSubTlsSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        WebPubSubTlsSettingsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
