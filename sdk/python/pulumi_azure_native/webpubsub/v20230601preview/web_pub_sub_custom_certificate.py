...
__all__ = ['WebPubSubCustomCertificateArgs', 'WebPubSubCustomCertificate']

@pulumi.input_type
class WebPubSubCustomCertificateArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if key_vault_base_uri is None and 'keyVaultBaseUri' in kwargs:
            key_vault_base_uri = kwargs['keyVaultBaseUri']
        if key_vault_base_uri is None:
            raise TypeError("Missing 'key_vault_base_uri' argument")
        if key_vault_secret_name is None and 'keyVaultSecretName' in kwargs:
            key_vault_secret_name = kwargs['keyVaultSecretName']
        if key_vault_secret_name is None:
            raise TypeError("Missing 'key_vault_secret_name' argument")
        ...
        if key_vault_secret_version is None and 'keyVaultSecretVersion' in kwargs:
            key_vault_secret_version = kwargs['keyVaultSecretVersion']
...
class WebPubSubCustomCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebPubSubCustomCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebPubSubCustomCertificateArgs.__new__(WebPubSubCustomCertificateArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230801preview:WebPubSubCustomCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubCustomCertificate, __self__).__init__(
            'azure-native:webpubsub/v20230601preview:WebPubSubCustomCertificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WebPubSubCustomCertificate':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return WebPubSubCustomCertificate(resource_name, opts=opts, __props__=__props__)
