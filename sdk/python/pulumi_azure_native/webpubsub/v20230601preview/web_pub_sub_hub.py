...
class WebPubSubHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub/v20211001:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240101preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240301:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240401preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20241001preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub:WebPubSubHub")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubHub, __self__).__init__(
            'azure-native:webpubsub/v20230601preview:WebPubSubHub',
            resource_name,
            __props__,
            opts)
