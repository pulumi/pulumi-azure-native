...
class WebPubSubCustomCertificateArgs:
    def __init__(__self__, *,
                 key_vault_base_uri: pulumi.Input[builtins.str],
                 key_vault_secret_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 resource_name: pulumi.Input[builtins.str],
                 certificate_name: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault_secret_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WebPubSubCustomCertificate resource.
        :param pulumi.Input[builtins.str] key_vault_base_uri: Base uri of the KeyVault that stores certificate.
        :param pulumi.Input[builtins.str] key_vault_secret_name: Certificate secret name.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] resource_name: The name of the resource.
        :param pulumi.Input[builtins.str] certificate_name: Custom certificate name
        :param pulumi.Input[builtins.str] key_vault_secret_version: Certificate secret version.
        """
    ...
    def key_vault_base_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def key_vault_base_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "key_vault_base_uri", value)

    @property
    @pulumi.getter(name="keyVaultSecretName")
    def key_vault_secret_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def key_vault_secret_name(self, value: pulumi.Input[builtins.str]):
    ...
    def key_vault_secret_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_vault_secret_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebPubSubCustomCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 certificate_name: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault_base_uri: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="keyVaultBaseUri")
    def key_vault_base_uri(self) -> pulumi.Output[builtins.str]:
        """
        Base uri of the KeyVault that stores certificate.
        """
        return pulumi.get(self, "key_vault_base_uri")
    ...
    @property
    @pulumi.getter(name="keyVaultSecretName")
    def key_vault_secret_name(self) -> pulumi.Output[builtins.str]:
        """
        Certificate secret name.
        """
        return pulumi.get(self, "key_vault_secret_name")
    ...
    @property
    @pulumi.getter(name="keyVaultSecretVersion")
    def key_vault_secret_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Certificate secret version.
        """
        return pulumi.get(self, "key_vault_secret_version")
