...
def get_web_pub_sub_custom_domain(name: Optional[builtins.str] = None,
...
def get_web_pub_sub_custom_domain_output(name: Optional[pulumi.Input[builtins.str]] = None,
