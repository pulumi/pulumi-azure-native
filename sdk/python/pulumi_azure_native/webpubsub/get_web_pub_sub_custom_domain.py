...
def get_web_pub_sub_custom_domain(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult).value
...
def get_web_pub_sub_custom_domain_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult)
