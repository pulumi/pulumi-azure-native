...
class WebPubSubCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if custom_certificate is not None and not isinstance(custom_certificate, ResourceReferenceArgs):
                custom_certificate = custom_certificate or {}
                def _setter(key, value):
                    custom_certificate[key] = value
                ResourceReferenceArgs._configure(_setter, **custom_certificate)
