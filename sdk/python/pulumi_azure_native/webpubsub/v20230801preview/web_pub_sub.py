...
class WebPubSub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            network_acls = _utilities.configure(network_acls, WebPubSubNetworkACLsArgs, True)
            ...
            tls = _utilities.configure(tls, WebPubSubTlsSettingsArgs, True)
        ...
        super(WebPubSub, __self__).__init__(
            'azure-native:webpubsub/v20230801preview:WebPubSub',
            resource_name,
            __props__,
            opts)
