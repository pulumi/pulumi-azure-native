...
def get_web_pub_sub_shared_private_link_resource(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20230801preview:getWebPubSubSharedPrivateLinkResource', __args__, opts=opts, typ=GetWebPubSubSharedPrivateLinkResourceResult).value
...
def get_web_pub_sub_shared_private_link_resource_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sharedPrivateLinkResourceName'] = shared_private_link_resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20230801preview:getWebPubSubSharedPrivateLinkResource', __args__, opts=opts, typ=GetWebPubSubSharedPrivateLinkResourceResult)
