...
class WebPubSubCustomCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20230601preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20240301:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20240401preview:WebPubSubCustomCertificate"), pulumi.Alias(type_="azure-native:webpubsub/v20240801preview:WebPubSubCustomCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubCustomCertificate, __self__).__init__(
            'azure-native:webpubsub/v20230801preview:WebPubSubCustomCertificate',
            resource_name,
            __props__,
            opts)
