...
def get_web_pub_sub_custom_certificate(certificate_name: Optional[_builtins.str] = None,
...
def get_web_pub_sub_custom_certificate_output(certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
