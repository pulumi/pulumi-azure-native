...
class DiagnosticConfigurationResponse(dict):
    ...
    def _configure(
             ...
             **kwargs):
        if enable_connectivity_logs is None and 'enableConnectivityLogs' in kwargs:
            enable_connectivity_logs = kwargs['enableConnectivityLogs']
        if enable_live_trace is None and 'enableLiveTrace' in kwargs:
            enable_live_trace = kwargs['enableLiveTrace']
        if enable_messaging_logs is None and 'enableMessagingLogs' in kwargs:
