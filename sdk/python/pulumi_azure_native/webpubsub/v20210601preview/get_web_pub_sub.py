...
def get_web_pub_sub(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20210601preview:getWebPubSub', __args__, opts=opts, typ=GetWebPubSubResult).value

    return AwaitableGetWebPubSubResult(
        diagnostic_configuration=pulumi.get(__ret__, 'diagnostic_configuration'),
...
def get_web_pub_sub_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20210601preview:getWebPubSub', __args__, opts=opts, typ=GetWebPubSubResult)
    return __ret__.apply(lambda __response__: GetWebPubSubResult(
        diagnostic_configuration=pulumi.get(__response__, 'diagnostic_configuration'),
