...
class WebPubSub(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 diagnostic_configuration: Optional[pulumi.Input[Union['DiagnosticConfigurationArgs', 'DiagnosticConfigurationArgsDict']]] = None,
                 disable_aad_auth: Optional[pulumi.Input[bool]] = None,
                 disable_local_auth: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[Union['DiagnosticConfigurationArgs', 'DiagnosticConfigurationArgsDict']] diagnostic_configuration: Diagnostic configuration of a Microsoft.SignalRService resource. Used together with Azure monitor DiagnosticSettings.
        :param pulumi.Input[bool] disable_aad_auth: DisableLocalAuth
               Enable or disable aad auth
               When set as true, connection with AuthType=aad won't work.
        :param pulumi.Input[bool] disable_local_auth: DisableLocalAuth
