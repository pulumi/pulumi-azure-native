...
class WebPubSubArgs:
    ...
    def _configure(
        ...
        if diagnostic_configuration is None and 'diagnosticConfiguration' in kwargs:
...
class WebPubSub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            diagnostic_configuration = _utilities.configure(diagnostic_configuration, DiagnosticConfigurationArgs, True)
