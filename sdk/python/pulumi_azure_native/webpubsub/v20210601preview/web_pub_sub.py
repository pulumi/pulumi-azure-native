...
class WebPubSub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub = azure_native.webpubsub.v20210601preview.WebPubSub("webPubSub",
            diagnostic_configuration=azure_native.webpubsub.v20210601preview.DiagnosticConfigurationArgs(
                enable_connectivity_logs="Disabled",
                enable_live_trace="Disabled",
                enable_messaging_logs="Disabled",
            ),
            disable_aad_auth=False,
            disable_local_auth=False,
            event_handler=azure_native.webpubsub.v20210601preview.EventHandlerSettingsResponseArgs(
                items={
                    "hub1": [azure_native.webpubsub.v20210601preview.EventHandlerTemplateArgs(
                        url_template="https://example.com/chat/api/hub1",
                        user_event_pattern="*",
                    )],
                    "hub2": [
                        azure_native.webpubsub.v20210601preview.EventHandlerTemplateArgs(
            ...
            identity=azure_native.webpubsub.v20210601preview.ManagedIdentityArgs(
                type="SystemAssigned",
            ),
            location="eastus",
            network_acls=azure_native.webpubsub.v20210601preview.WebPubSubNetworkACLsResponseArgs(
                default_action="Deny",
                private_endpoints=[azure_native.webpubsub.v20210601preview.PrivateEndpointACLArgs(
                    allow=["ServerConnection"],
                    name="mywebpubsubservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
                )],
                public_network=azure_native.webpubsub.v20210601preview.NetworkACLArgs(
            ...
            sku=azure_native.webpubsub.v20210601preview.ResourceSkuResponseArgs(
                capacity=1,
                name="Standard_S1",
                tier="Standard",
            ),
            ...
            tls=azure_native.webpubsub.v20210601preview.WebPubSubTlsSettingsArgs(
