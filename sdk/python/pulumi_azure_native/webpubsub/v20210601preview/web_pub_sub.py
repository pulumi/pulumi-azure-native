...
class WebPubSubArgs:
    ...
    def _configure(
        ...
        if 'diagnosticConfiguration' in kwargs:
            diagnostic_configuration = kwargs['diagnosticConfiguration']
        ...
        if diagnostic_configuration is not None:
            _setter("diagnostic_configuration", diagnostic_configuration)
...
class WebPubSub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if diagnostic_configuration is not None and not isinstance(diagnostic_configuration, DiagnosticConfigurationArgs):
                diagnostic_configuration = diagnostic_configuration or {}
                def _setter(key, value):
                    diagnostic_configuration[key] = value
                DiagnosticConfigurationArgs._configure(_setter, **diagnostic_configuration)
