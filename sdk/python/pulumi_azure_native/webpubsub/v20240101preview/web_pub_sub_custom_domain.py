...
class WebPubSubCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230601preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20240301:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20240401preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20240801preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20241001preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub:WebPubSubCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubCustomDomain, __self__).__init__(
            'azure-native:webpubsub/v20240101preview:WebPubSubCustomDomain',
            resource_name,
            __props__,
            opts)
