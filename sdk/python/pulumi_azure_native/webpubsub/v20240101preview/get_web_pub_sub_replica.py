...
def get_web_pub_sub_replica(replica_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20240101preview:getWebPubSubReplica', __args__, opts=opts, typ=GetWebPubSubReplicaResult).value
...
def get_web_pub_sub_replica_output(replica_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20240101preview:getWebPubSubReplica', __args__, opts=opts, typ=GetWebPubSubReplicaResult)
