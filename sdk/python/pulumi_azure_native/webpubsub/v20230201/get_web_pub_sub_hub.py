...
def get_web_pub_sub_hub(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_pub_sub_hub is deprecated: azure-native:webpubsub/v20230201:WebPubSubHub is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubHub to guarantee forwards compatibility.""")
    __args__ = dict()
