...
def get_web_pub_sub_custom_domain(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_pub_sub_custom_domain is deprecated: azure-native:webpubsub/v20230201:WebPubSubCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20230201:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult).value
