...
class WebPubSubCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230601preview:WebPubSubCustomDomain"), pulumi.Alias(type_="azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain")])
