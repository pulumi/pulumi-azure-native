...
class WebPubSub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub = azure_native.webpubsub.v20230201.WebPubSub("webPubSub",
            disable_aad_auth=False,
            disable_local_auth=False,
            identity=azure_native.webpubsub.v20230201.ManagedIdentityArgs(
                type="SystemAssigned",
            ),
            live_trace_configuration=azure_native.webpubsub.v20230201.LiveTraceConfigurationResponseArgs(
                categories=[azure_native.webpubsub.v20230201.LiveTraceCategoryArgs(
                    enabled="true",
            ...
            location="eastus",
            network_acls=azure_native.webpubsub.v20230201.WebPubSubNetworkACLsResponseArgs(
                default_action="Deny",
                private_endpoints=[azure_native.webpubsub.v20230201.PrivateEndpointACLArgs(
                    allow=["ServerConnection"],
                    name="mywebpubsubservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
                )],
                public_network=azure_native.webpubsub.v20230201.NetworkACLArgs(
            ...
            sku=azure_native.webpubsub.v20230201.ResourceSkuResponseArgs(
                capacity=1,
                name="Premium_P1",
                tier="Premium",
            ),
            ...
            tls=azure_native.webpubsub.v20230201.WebPubSubTlsSettingsArgs(
