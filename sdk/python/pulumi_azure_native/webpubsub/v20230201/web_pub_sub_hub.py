...
class WebPubSubHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub_hub = azure_native.webpubsub.v20230201.WebPubSubHub("webPubSubHub",
            hub_name="exampleHub",
            properties=azure_native.webpubsub.v20230201.WebPubSubHubPropertiesResponseArgs(
                anonymous_connect_policy="allow",
                event_handlers=[{
                    "auth": {
                        "managedIdentity": azure_native.webpubsub.v20230201.ManagedIdentitySettingsArgs(
                            resource="abc",
                        ),
                ...
                event_listeners=[{
                    "endpoint": azure_native.webpubsub.v20230201.EventHubEndpointResponseArgs(
                        event_hub_name="eventHubName1",
                        fully_qualified_namespace="example.servicebus.windows.net",
                        type="EventHub",
                    ),
                    "filter": azure_native.webpubsub.v20230201.EventNameFilterResponseArgs(
                        system_events=[
                            "connected",
                            "disconnected",
                        ],
