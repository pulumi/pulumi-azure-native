...
class WebPubSub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub = azure_native.webpubsub.v20210401preview.WebPubSub("webPubSub",
            event_handler=azure_native.webpubsub.v20210401preview.EventHandlerSettingsResponseArgs(
                items={
                    "hub1": [azure_native.webpubsub.v20210401preview.EventHandlerTemplateArgs(
                        url_template="https://example.com/chat/api/hub1",
                        user_event_pattern="*",
                    )],
                    "hub2": [
                        azure_native.webpubsub.v20210401preview.EventHandlerTemplateArgs(
            ...
            identity=azure_native.webpubsub.v20210401preview.ManagedIdentityArgs(
                type="SystemAssigned",
            ),
            location="eastus",
            network_acls=azure_native.webpubsub.v20210401preview.WebPubSubNetworkACLsResponseArgs(
                default_action="Deny",
                private_endpoints=[azure_native.webpubsub.v20210401preview.PrivateEndpointACLArgs(
                    allow=["ServerConnection"],
                    name="mywebpubsubservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
                )],
                public_network=azure_native.webpubsub.v20210401preview.NetworkACLArgs(
                    allow=["ClientConnection"],
                ),
            ),
            resource_group_name="myResourceGroup",
            resource_name_="myWebPubSubService",
            sku=azure_native.webpubsub.v20210401preview.ResourceSkuResponseArgs(
                capacity=1,
                name="Standard_S1",
                tier="Standard",
            ),
            ...
            tls=azure_native.webpubsub.v20210401preview.WebPubSubTlsSettingsArgs(
