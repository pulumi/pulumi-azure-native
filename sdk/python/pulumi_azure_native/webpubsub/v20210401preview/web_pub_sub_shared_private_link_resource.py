...
class WebPubSubSharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_pub_sub_shared_private_link_resource = azure_native.webpubsub.v20210401preview.WebPubSubSharedPrivateLinkResource("webPubSubSharedPrivateLinkResource",
            group_id="sites",
        ...
        ```sh
        $ pulumi import azure-native:webpubsub/v20210401preview:WebPubSubSharedPrivateLinkResource upstream /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/WebPubSub/myWebPubSubService/privateEndpointConnections/upstream 
        ```
