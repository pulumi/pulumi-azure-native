...
class WebPubSubSharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:webpubsub/v20210401preview:WebPubSubSharedPrivateLinkResource"), pulumi.Alias(type_="azure-native:webpubsub:WebPubSubSharedPrivateLinkResource"), pulumi.Alias(type_="azure-nextgen:webpubsub:WebPubSubSharedPrivateLinkResource")])
