...
def get_web_pub_sub_custom_domain_output(name: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWebPubSubCustomDomainResult]:
    """
    Get a custom domain.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20220801preview:getWebPubSubCustomDomain', __args__, opts=opts, typ=GetWebPubSubCustomDomainResult)
