...
def get_web_pub_sub_custom_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20220801preview:getWebPubSubCustomCertificate', __args__, opts=opts, typ=GetWebPubSubCustomCertificateResult)
