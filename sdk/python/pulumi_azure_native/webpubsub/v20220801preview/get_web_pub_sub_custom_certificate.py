...
def get_web_pub_sub_custom_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_pub_sub_custom_certificate is deprecated: azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:webpubsub/v20230201:WebPubSubCustomCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
