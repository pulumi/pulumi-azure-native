...
def get_web_pub_sub_custom_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_pub_sub_custom_certificate is deprecated: azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230201:WebPubSubCustomCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
