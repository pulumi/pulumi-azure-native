...
warnings.warn("""azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebPubSubCustomCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubCustomCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubCustomCertificate, __self__).__init__(
            'azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate',
            resource_name,
            __props__,
            opts)
