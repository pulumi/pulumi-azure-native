...
def get_web_pub_sub(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_pub_sub is deprecated: azure-native:webpubsub/v20211001:WebPubSub is being removed in the next major version of this provider. Please upgrade to azure-native:webpubsub/v20230201:WebPubSub to guarantee forwards compatibility.""")
    __args__ = dict()
