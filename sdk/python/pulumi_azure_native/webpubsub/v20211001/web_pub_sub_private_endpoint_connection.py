...
class WebPubSubPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:webpubsub/v20211001:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub/v20210401preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub/v20210401preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub/v20210601preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub/v20210601preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub/v20210901preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub/v20210901preview:WebPubSubPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebPubSubPrivateEndpointConnection, __self__).__init__(
            'azure-native:webpubsub/v20211001:WebPubSubPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
