...
def list_web_pub_sub_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:webpubsub/v20211001:listWebPubSubKeys', __args__, opts=opts, typ=ListWebPubSubKeysResult).value
...
def list_web_pub_sub_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:webpubsub/v20211001:listWebPubSubKeys', __args__, opts=opts, typ=ListWebPubSubKeysResult)
