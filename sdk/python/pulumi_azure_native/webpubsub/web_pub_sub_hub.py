...
class WebPubSubHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 hub_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['WebPubSubHubPropertiesArgs', 'WebPubSubHubPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:webpubsub/v20211001:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20220801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230201:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230301preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230601preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20230801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240101preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240301:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240401preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20240801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20241001preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20250101preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20250801preview:WebPubSubHub"), pulumi.Alias(type_="azure-native:webpubsub/v20251201preview:WebPubSubHub")])
