...
def get_web_pub_sub_shared_private_link_resource(resource_group_name: Optional[_builtins.str] = None,
                                                 resource_name: Optional[_builtins.str] = None,
                                                 shared_private_link_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str shared_private_link_resource_name: The name of the shared private link resource.
    """
    __args__ = dict()
