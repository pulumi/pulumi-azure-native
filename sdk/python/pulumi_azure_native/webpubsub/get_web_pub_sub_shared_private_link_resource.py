...
def get_web_pub_sub_shared_private_link_resource(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str shared_private_link_resource_name: The name of the shared private link resource.
    """
    __args__ = dict()
...
def get_web_pub_sub_shared_private_link_resource_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
