...
class GetFirmwareResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.FirmwarePropertiesResponse':
        """
...
def get_firmware(firmware_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotfirmwaredefense/v20250401preview:getFirmware', __args__, opts=opts, typ=GetFirmwareResult).value
...
def get_firmware_output(firmware_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotfirmwaredefense/v20250401preview:getFirmware', __args__, opts=opts, typ=GetFirmwareResult)
