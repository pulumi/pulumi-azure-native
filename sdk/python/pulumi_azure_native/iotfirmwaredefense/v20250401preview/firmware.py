...
class FirmwareArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['FirmwarePropertiesArgs']] = None):
        """
        ...
        :param pulumi.Input['FirmwarePropertiesArgs'] properties: The resource-specific properties for this resource.
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['FirmwarePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['FirmwarePropertiesArgs']]):
...
class Firmware(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 firmware_id: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['FirmwarePropertiesArgs', 'FirmwarePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] firmware_id: The id of the firmware.
        :param pulumi.Input[Union['FirmwarePropertiesArgs', 'FirmwarePropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: The name of the firmware analysis workspace.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotfirmwaredefense/v20230208preview:Firmware"), pulumi.Alias(type_="azure-native:iotfirmwaredefense/v20240110:Firmware"), pulumi.Alias(type_="azure-native:iotfirmwaredefense:Firmware")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Firmware, __self__).__init__(
            'azure-native:iotfirmwaredefense/v20250401preview:Firmware',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FirmwarePropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
