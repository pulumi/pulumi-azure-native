...
def get_firmware(firmware_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotfirmwaredefense/v20240110:getFirmware', __args__, opts=opts, typ=GetFirmwareResult).value
...
def get_firmware_output(firmware_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotfirmwaredefense/v20240110:getFirmware', __args__, opts=opts, typ=GetFirmwareResult)
