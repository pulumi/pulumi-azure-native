...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if friendly_name is None:
            raise TypeError("Missing 'friendly_name' argument")
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningexperimentation/v20170501preview:Workspace")])
