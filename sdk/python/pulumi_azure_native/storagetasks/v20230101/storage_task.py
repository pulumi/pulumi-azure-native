...
class StorageTask(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(action, StorageTaskActionArgs):
                action = action or {}
                def _setter(key, value):
                    action[key] = value
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storagetasks:StorageTask")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageTask, __self__).__init__(
            'azure-native:storagetasks/v20230101:StorageTask',
            resource_name,
            __props__,
            opts)
