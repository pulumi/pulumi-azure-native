...
class TunnelPolicyArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_type: Optional[pulumi.Input[Union[builtins.str, 'TunnelType']]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] tunnel_policy_name: Name of the Tunnel Policy under the profile.
        :param pulumi.Input[Union[builtins.str, 'TunnelType']] tunnel_type: Protocol this tunnel will use for allowing traffic to backends.
        """
    ...
    def tunnel_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tunnel_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tunnel_policy_name", value)

    @property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'TunnelType']]]:
        """
    ...
    @tunnel_type.setter
    def tunnel_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'TunnelType']]]):
...
class TunnelPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Protocol this tunnel will use for allowing traffic to backends.
        """
        return pulumi.get(self, "tunnel_type")
