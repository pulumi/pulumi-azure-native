...
class TunnelPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20240601preview:TunnelPolicy"), pulumi.Alias(type_="azure-native_cdn_v20240601preview:cdn:TunnelPolicy")])
