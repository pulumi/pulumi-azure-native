...
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rule = azure_native.cdn.v20200901.Rule("rule",
            actions=[azure_native.cdn.v20200901.DeliveryRuleResponseHeaderActionArgs(
            ...
            conditions=[azure_native.cdn.v20200901.DeliveryRuleRequestMethodConditionArgs(
                name="RequestMethod",
                parameters=azure_native.cdn.v20200901.RequestMethodMatchConditionParametersArgs(
                    match_values=["GET"],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/v20210601:Rule"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Rule")])
