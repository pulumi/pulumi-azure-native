...
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[Union['DeliveryRuleCookiesConditionArgs', 'DeliveryRuleCookiesConditionArgsDict'], Union['DeliveryRuleHttpVersionConditionArgs', 'DeliveryRuleHttpVersionConditionArgsDict'], Union['DeliveryRuleIsDeviceConditionArgs', 'DeliveryRuleIsDeviceConditionArgsDict'], Union['DeliveryRulePostArgsConditionArgs', 'DeliveryRulePostArgsConditionArgsDict'], Union['DeliveryRuleQueryStringConditionArgs', 'DeliveryRuleQueryStringConditionArgsDict'], Union['DeliveryRuleRemoteAddressConditionArgs', 'DeliveryRuleRemoteAddressConditionArgsDict'], Union['DeliveryRuleRequestBodyConditionArgs', 'DeliveryRuleRequestBodyConditionArgsDict'], Union['DeliveryRuleRequestHeaderConditionArgs', 'DeliveryRuleRequestHeaderConditionArgsDict'], Union['DeliveryRuleRequestMethodConditionArgs', 'DeliveryRuleRequestMethodConditionArgsDict'], Union['DeliveryRuleRequestSchemeConditionArgs', 'DeliveryRuleRequestSchemeConditionArgsDict'], Union['DeliveryRuleRequestUriConditionArgs', 'DeliveryRuleRequestUriConditionArgsDict'], Union['DeliveryRuleUrlFileExtensionConditionArgs', 'DeliveryRuleUrlFileExtensionConditionArgsDict'], Union['DeliveryRuleUrlFileNameConditionArgs', 'DeliveryRuleUrlFileNameConditionArgsDict'], Union['DeliveryRuleUrlPathConditionArgs', 'DeliveryRuleUrlPathConditionArgsDict']]]]] conditions: A list of conditions that must be matched for the actions to be executed
        :param pulumi.Input[Union[str, 'MatchProcessingBehavior']] match_processing_behavior: If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue.
        :param pulumi.Input[int] order: The order in which the rules are applied for the endpoint. Possible values {0,1,2,3,………}. A rule with a lesser order will be applied before a rule with a greater order. Rule with order 0 is a special rule. It does not require any condition and actions listed in it will always be applied.
        :param pulumi.Input[str] profile_name: Name of the CDN profile which is unique within the resource group.
        :param pulumi.Input[str] resource_group_name: Name of the Resource group within the Azure subscription.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/v20210601:Rule"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20230501:Rule"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20240201:Rule"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:Rule"), pulumi.Alias(type_="azure-native:cdn/v20240901:Rule")])
