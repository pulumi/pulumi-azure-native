...
class Rule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-nextgen:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/latest:Rule"), pulumi.Alias(type_="azure-nextgen:cdn/latest:Rule")])
