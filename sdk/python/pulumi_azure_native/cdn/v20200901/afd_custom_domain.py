...
warnings.warn("""azure-native:cdn/v20200901:AFDCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDCustomDomain")])
