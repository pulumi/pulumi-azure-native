...
class AFDCustomDomain(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-nextgen:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/latest:AFDCustomDomain"), pulumi.Alias(type_="azure-nextgen:cdn/latest:AFDCustomDomain")])
