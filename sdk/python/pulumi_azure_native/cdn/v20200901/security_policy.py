...
class SecurityPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:SecurityPolicy"), pulumi.Alias(type_="azure-nextgen:cdn:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/latest:SecurityPolicy"), pulumi.Alias(type_="azure-nextgen:cdn/latest:SecurityPolicy")])
