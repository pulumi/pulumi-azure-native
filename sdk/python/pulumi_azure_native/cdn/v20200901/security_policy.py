...
warnings.warn("""azure-native:cdn/v20200901:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:SecurityPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class SecurityPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 security_policy_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityPolicy is deprecated: azure-native:cdn/v20200901:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:SecurityPolicy to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/v20210601:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:SecurityPolicy")])
