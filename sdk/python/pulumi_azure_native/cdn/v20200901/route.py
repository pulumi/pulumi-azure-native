...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if compression_settings is not None and not isinstance(compression_settings, CompressionSettingsArgs):
                compression_settings = compression_settings or {}
                def _setter(key, value):
                    compression_settings[key] = value
                CompressionSettingsArgs._configure(_setter, **compression_settings)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Route"), pulumi.Alias(type_="azure-native:cdn/v20210601:Route"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20230501:Route"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Route")])
