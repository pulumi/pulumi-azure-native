...
class AFDOriginGroupArgs:
    ...
    def _configure(
        ...
        if 'responseBasedAfdOriginErrorDetectionSettings' in kwargs:
            response_based_afd_origin_error_detection_settings = kwargs['responseBasedAfdOriginErrorDetectionSettings']
...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if response_based_afd_origin_error_detection_settings is not None and not isinstance(response_based_afd_origin_error_detection_settings, ResponseBasedOriginErrorDetectionParametersArgs):
