...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        afd_origin_group = azure_native.cdn.v20200901.AFDOriginGroup("afdOriginGroup",
            health_probe_settings=azure_native.cdn.v20200901.HealthProbeParametersArgs(
                probe_interval_in_seconds=10,
                probe_path="/path2",
                probe_protocol=azure_native.cdn/v20200901.ProbeProtocol.NOT_SET,
                probe_request_type=azure_native.cdn/v20200901.HealthProbeRequestType.NOT_SET,
            ),
            load_balancing_settings=azure_native.cdn.v20200901.LoadBalancingSettingsParametersArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDOriginGroup")])
