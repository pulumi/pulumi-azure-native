...
class AFDOriginGroupArgs:
    ...
    def _configure(
        ...
        if response_based_afd_origin_error_detection_settings is None and 'responseBasedAfdOriginErrorDetectionSettings' in kwargs:
...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            response_based_afd_origin_error_detection_settings = _utilities.configure(response_based_afd_origin_error_detection_settings, ResponseBasedOriginErrorDetectionParametersArgs, True)
