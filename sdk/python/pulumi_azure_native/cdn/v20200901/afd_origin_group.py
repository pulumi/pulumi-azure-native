...
class AFDOriginGroupArgs:
    def __init__(__self__, *,
        ...
        AFDOriginGroupArgs._configure(
            ...
            response_based_afd_origin_error_detection_settings=response_based_afd_origin_error_detection_settings,
    ...
    def _configure(
        ...
        if response_based_afd_origin_error_detection_settings is not None:
            _setter("response_based_afd_origin_error_detection_settings", response_based_afd_origin_error_detection_settings)
...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(response_based_afd_origin_error_detection_settings, ResponseBasedOriginErrorDetectionParametersArgs):
                response_based_afd_origin_error_detection_settings = response_based_afd_origin_error_detection_settings or {}
                def _setter(key, value):
                    response_based_afd_origin_error_detection_settings[key] = value
                ResponseBasedOriginErrorDetectionParametersArgs._configure(_setter, **response_based_afd_origin_error_detection_settings)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230501:AFDOriginGroup")])
