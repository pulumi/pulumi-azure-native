...
def get_security_policy(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_policy is deprecated: azure-native:cdn/v20200901:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:SecurityPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
