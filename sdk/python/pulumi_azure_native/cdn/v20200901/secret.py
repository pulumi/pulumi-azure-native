...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200901:Secret"), pulumi.Alias(type_="azure-native:cdn:Secret"), pulumi.Alias(type_="azure-nextgen:cdn:Secret")])
