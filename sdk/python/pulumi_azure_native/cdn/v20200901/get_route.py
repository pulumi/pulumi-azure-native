...
def get_route_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['routeName'] = route_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20200901:getRoute', __args__, opts=opts, typ=GetRouteResult)
    return __ret__.apply(lambda __response__: GetRouteResult(
        compression_settings=pulumi.get(__response__, 'compression_settings'),
