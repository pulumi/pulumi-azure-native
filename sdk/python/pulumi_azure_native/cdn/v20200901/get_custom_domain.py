...
def get_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: azure-native:cdn/v20200901:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:CustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
