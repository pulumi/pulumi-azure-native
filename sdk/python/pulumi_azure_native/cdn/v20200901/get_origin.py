...
warnings.warn("""azure-native:cdn/v20200901:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Origin to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin is deprecated: azure-native:cdn/v20200901:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Origin to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200901:getOrigin', __args__, opts=opts, typ=GetOriginResult).value
