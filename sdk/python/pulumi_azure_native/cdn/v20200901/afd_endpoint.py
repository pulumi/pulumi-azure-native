...
class AFDEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AFDEndpoint is deprecated: Version 2020-09-01 will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDEndpoint")])
