...
class AFDEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20230501:AFDEndpoint")])
