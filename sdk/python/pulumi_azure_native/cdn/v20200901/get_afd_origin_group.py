...
def get_afd_origin_group_output(origin_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20200901:getAFDOriginGroup', __args__, opts=opts, typ=GetAFDOriginGroupResult)
    return __ret__.apply(lambda __response__: GetAFDOriginGroupResult(
        ...
        response_based_afd_origin_error_detection_settings=pulumi.get(__response__, 'response_based_afd_origin_error_detection_settings'),
