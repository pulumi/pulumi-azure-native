...
def get_afd_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_custom_domain is deprecated: azure-native:cdn/v20200901:AFDCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:AFDCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['customDomainName'] = custom_domain_name
    __args__['profileName'] = profile_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200901:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult).value
