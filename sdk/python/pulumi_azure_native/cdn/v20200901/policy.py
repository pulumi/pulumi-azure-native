...
class Policy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        policy = azure_native.cdn.v20200901.Policy("policy",
            custom_rules=azure_native.cdn.v20200901.CustomRuleListResponseArgs(
                rules=[{
                    "action": "Block",
                    "enabledState": "Enabled",
                    "matchConditions": [
                        azure_native.cdn.v20200901.MatchConditionArgs(
                            match_value=["CH"],
            ...
            location="WestUs",
            managed_rules=azure_native.cdn.v20200901.ManagedRuleSetListResponseArgs(
                managed_rule_sets=[{
                    "ruleGroupOverrides": [{
                        "ruleGroupName": "Group1",
                        "rules": [
                            azure_native.cdn.v20200901.ManagedRuleOverrideArgs(
                                action="Redirect",
            ...
            policy_settings=azure_native.cdn.v20200901.PolicySettingsArgs(
            ...
            rate_limit_rules=azure_native.cdn.v20200901.RateLimitRuleListResponseArgs(
                rules=[{
                    "action": "Block",
                    "enabledState": "Enabled",
                    "matchConditions": [azure_native.cdn.v20200901.MatchConditionArgs(
                        match_value=[
                            "192.168.1.0/24",
                            "10.0.0.0/24",
                        ],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Policy"), pulumi.Alias(type_="azure-native:cdn/v20190615:Policy"), pulumi.Alias(type_="azure-native:cdn/v20190615preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20200331:Policy"), pulumi.Alias(type_="azure-native:cdn/v20200415:Policy"), pulumi.Alias(type_="azure-native:cdn/v20210601:Policy"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Policy")])
