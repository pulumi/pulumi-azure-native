...
__all__ = [
    ...
    'AfdSecretMtlsCertificateChainResponse',
...
@pulumi.output_type
class AfdSecretMtlsCertificateChainResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AfdSecretMtlsCertificateChainResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AfdSecretMtlsCertificateChainResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Server-side certificate used for mTLS validation
        :param str expiration_date: Soonest expiration date among certificates in customer's certificate chain in ISO 8601 compliant format yyyy-MM-ddTHH:mm:ss.fffffffK in UTC
...
class ProfileLogScrubbingResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProfileLogScrubbingResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProfileLogScrubbingResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 scrubbing_rules: Optional[Sequence['outputs.ProfileScrubbingRulesResponse']] = None,
    ...
    def scrubbing_rules(self) -> Optional[Sequence['outputs.ProfileScrubbingRulesResponse']]:
        """
...
class ProfileScrubbingRulesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProfileScrubbingRulesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProfileScrubbingRulesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param str state: Defines the state of a log scrubbing rule. Default value is enabled.
        """
        pulumi.set(__self__, "match_variable", match_variable)
