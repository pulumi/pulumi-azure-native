...
def get_afd_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240501preview:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult).value
...
def get_afd_custom_domain_output(custom_domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240501preview:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult)
    return __ret__.apply(lambda __response__: GetAFDCustomDomainResult(
        ...
        mtls_settings=pulumi.get(__response__, 'mtls_settings'),
        ...
        referenced_route_paths=pulumi.get(__response__, 'referenced_route_paths'),
