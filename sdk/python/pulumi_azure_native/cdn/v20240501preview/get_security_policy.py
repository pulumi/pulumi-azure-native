...
def get_security_policy(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240501preview:getSecurityPolicy', __args__, opts=opts, typ=GetSecurityPolicyResult).value
...
def get_security_policy_output(profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['securityPolicyName'] = security_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240501preview:getSecurityPolicy', __args__, opts=opts, typ=GetSecurityPolicyResult)
