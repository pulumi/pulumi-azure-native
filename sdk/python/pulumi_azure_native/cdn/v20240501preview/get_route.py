...
def get_route(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240501preview:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['routeName'] = route_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240501preview:getRoute', __args__, opts=opts, typ=GetRouteResult)
    return __ret__.apply(lambda __response__: GetRouteResult(
        ...
        grpc_state=pulumi.get(__response__, 'grpc_state'),
