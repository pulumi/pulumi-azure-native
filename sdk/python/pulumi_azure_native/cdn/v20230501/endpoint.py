...
class EndpointArgs:
    ...
    def _configure(
        ...
        if 'defaultOriginGroup' in kwargs:
        ...
        if 'urlSigningKeys' in kwargs:
            url_signing_keys = kwargs['urlSigningKeys']
        if 'webApplicationFirewallPolicyLink' in kwargs:
...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if default_origin_group is not None and not isinstance(default_origin_group, ResourceReferenceArgs):
                default_origin_group = default_origin_group or {}
                def _setter(key, value):
                    default_origin_group[key] = value
                ResourceReferenceArgs._configure(_setter, **default_origin_group)
            __props__.__dict__["default_origin_group"] = default_origin_group
            if delivery_policy is not None and not isinstance(delivery_policy, EndpointPropertiesUpdateParametersDeliveryPolicyArgs):
                delivery_policy = delivery_policy or {}
                def _setter(key, value):
                    delivery_policy[key] = value
                EndpointPropertiesUpdateParametersDeliveryPolicyArgs._configure(_setter, **delivery_policy)
            ...
            if web_application_firewall_policy_link is not None and not isinstance(web_application_firewall_policy_link, EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs):
                web_application_firewall_policy_link = web_application_firewall_policy_link or {}
                def _setter(key, value):
                    web_application_firewall_policy_link[key] = value
                EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs._configure(_setter, **web_application_firewall_policy_link)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20150601:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20160402:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20161002:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20170402:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20171012:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20190415:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20190615:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20190615preview:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20191231:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20200331:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20200415:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20200901:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20210601:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Endpoint"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Endpoint")])
