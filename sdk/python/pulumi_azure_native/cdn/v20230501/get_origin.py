...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20230501:getOrigin', __args__, opts=opts, typ=GetOriginResult).value
...
def get_origin_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20230501:getOrigin', __args__, opts=opts, typ=GetOriginResult)
