...
class AFDOriginArgs:
    ...
    def _configure(
        ...
        if origin_group_name is None:
            raise TypeError("Missing 'origin_group_name' argument")
        ...
        if azure_origin is None and 'azureOrigin' in kwargs:
        ...
        if shared_private_link_resource is None and 'sharedPrivateLinkResource' in kwargs:
...
class AFDOrigin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            azure_origin = _utilities.configure(azure_origin, ResourceReferenceArgs, True)
            ...
            shared_private_link_resource = _utilities.configure(shared_private_link_resource, SharedPrivateLinkResourcePropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:AFDOrigin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AFDOrigin, __self__).__init__(
            'azure-native:cdn/v20230501:AFDOrigin',
            resource_name,
            __props__,
            opts)
