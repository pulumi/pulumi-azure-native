...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(azure_dns_zone, ResourceReferenceArgs):
            ...
            if not isinstance(pre_validated_custom_domain_resource_id, ResourceReferenceArgs):
            ...
            if not isinstance(tls_settings, AFDDomainHttpsParametersArgs):
