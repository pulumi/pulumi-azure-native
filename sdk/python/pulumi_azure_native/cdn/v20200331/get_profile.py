...
def get_profile(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_profile is deprecated: Version v20200331 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200331:getProfile', __args__, opts=opts, typ=GetProfileResult).value
