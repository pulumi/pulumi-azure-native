...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:cdn/v20200331:CustomDomain":
                return CustomDomain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cdn/v20200331:Endpoint":
                return Endpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cdn/v20200331:Origin":
                return Origin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cdn/v20200331:OriginGroup":
                return OriginGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cdn/v20200331:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cdn/v20200331:Profile":
    ...
    pulumi.runtime.register_resource_module("azure-native", "cdn/v20200331", _module_instance)
