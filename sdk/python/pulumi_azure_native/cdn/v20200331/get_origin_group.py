...
azure-native:cdn/v20200331:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_origin_group(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin_group is deprecated: Version 2020-03-31 will be removed in v2 of the provider.
azure-native:cdn/v20200331:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200331:getOriginGroup', __args__, opts=opts, typ=GetOriginGroupResult).value
