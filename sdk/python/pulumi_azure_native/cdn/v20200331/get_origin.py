...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin is deprecated: Version v20200331 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200331:getOrigin', __args__, opts=opts, typ=GetOriginResult).value
