...
class EdgeActionArgs:
    ...
    def edge_action_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def edge_action_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class EdgeAction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20240722preview:EdgeAction"), pulumi.Alias(type_="azure-native:cdn/v20250901preview:EdgeAction"), pulumi.Alias(type_="azure-native:cdn/v20251201preview:EdgeAction")])
