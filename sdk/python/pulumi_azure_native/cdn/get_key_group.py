...
def get_key_group(key_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str key_group_name: Name of the KeyGroup under the profile.
...
def get_key_group_output(key_group_name: Optional[pulumi.Input[builtins.str]] = None,
