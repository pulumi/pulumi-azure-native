...
class GetAFDCustomDomainResult:
    ...
    def domain_validation_state(self) -> builtins.str:
        """
    ...
    def extended_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
def get_afd_custom_domain(custom_domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str custom_domain_name: Name of the domain under the profile which is unique globally.
...
def get_afd_custom_domain_output(custom_domain_name: Optional[pulumi.Input[builtins.str]] = None,
