...
def get_afd_custom_domain(custom_domain_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str custom_domain_name: Name of the domain under the profile which is unique globally.
    :param _builtins.str profile_name: Name of the Azure Front Door Standard or Azure Front Door Premium profile which is unique within the resource group.
