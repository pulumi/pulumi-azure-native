...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_endpoint is deprecated: Version v20161002 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20161002:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
