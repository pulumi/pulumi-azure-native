...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_custom_block_response_status_code: Optional[_builtins.int] = None,
        ...
        :param _builtins.int default_custom_block_response_status_code: If the action type is block, this field defines the default customer overridable http response status code.
    ...
    def default_custom_block_response_status_code(self) -> Optional[_builtins.int]:
        """
