...
class ActivatedResourceReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Reference to another resource along with its state.
        :param builtins.bool is_active: Whether the resource is active or inactive
...
class AfdRouteCacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query_parameters: Optional[builtins.str] = None,
                 query_string_caching_behavior: Optional[builtins.str] = None):
        """
        Caching settings for a caching-type route. To disable caching, do not provide a cacheConfiguration object.
        :param 'CompressionSettingsResponse' compression_settings: compression settings.
        :param builtins.str query_parameters: query parameters to include or exclude (comma separated).
        :param builtins.str query_string_caching_behavior: Defines how Frontdoor caches requests that include query strings. You can ignore any query strings when caching, ignore specific query strings, cache every request with a unique URL, or cache specific query strings.
        """
    ...
    def query_parameters(self) -> Optional[builtins.str]:
        """
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 cache_behavior: Optional[builtins.str] = None,
                 cache_duration: Optional[builtins.str] = None,
                 is_compression_enabled: Optional[builtins.str] = None,
                 query_parameters: Optional[builtins.str] = None,
                 query_string_caching_behavior: Optional[builtins.str] = None):
        """
        Caching settings for a caching-type route. To disable caching, do not provide a cacheConfiguration object.
        :param builtins.str cache_behavior: Caching behavior for the requests
        :param builtins.str cache_duration: The duration for which the content needs to be cached. Allowed format is [d.]hh:mm:ss
        :param builtins.str is_compression_enabled: Indicates whether content compression is enabled. If compression is enabled, content will be served as compressed if user requests for a compressed version. Content won't be compressed on AzureFrontDoor when requested content is smaller than 1 byte or larger than 1 MB.
        :param builtins.str query_parameters: query parameters to include or exclude (comma separated).
        :param builtins.str query_string_caching_behavior: Defines how Frontdoor caches requests that include query strings. You can ignore any query strings when caching, ignore specific query strings, cache every request with a unique URL, or cache specific query strings.
        """
    ...
    def cache_behavior(self) -> Optional[builtins.str]:
        """
    ...
    def cache_duration(self) -> Optional[builtins.str]:
        """
    ...
    def is_compression_enabled(self) -> Optional[builtins.str]:
        """
...
class CacheExpirationActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the parameters for the cache expiration action.
        :param builtins.str cache_behavior: Caching behavior for the requests
        :param builtins.str cache_type: The level at which the content needs to be cached.
...
class CacheKeyQueryStringActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the parameters for the cache-key query string action.
        :param builtins.str query_string_behavior: Caching behavior for the requests
        :param builtins.str type_name: 
...
class CdnCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the parameters for using CDN managed certificate for securing custom domain.
        :param builtins.str certificate_type: Type of certificate used
        :param builtins.str type_name: 
               Expected value is 'CdnCertificateSourceParameters'.
        """
        pulumi.set(__self__, "certificate_type", certificate_type)
        pulumi.set(__self__, "type_name", 'CdnCertificateSourceParameters')
...
class CdnEndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the ARM Resource ID for the linked endpoints
        :param builtins.str id: ARM Resource ID string.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class CdnManagedHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the certificate source parameters using CDN managed certificate for enabling SSL.
        :param builtins.str certificate_source: Defines the source of the SSL certificate.
        ...
        :param builtins.str protocol_type: Defines the TLS extension protocol that is used for secure delivery.
...
class ClientPortMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type_name: builtins.str,
                 match_values: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] match_values: The match value for the condition of the delivery rule
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[builtins.str] transforms: List of transforms
        """
    ...
    def match_values(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def negate_condition(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def transforms(self) -> Optional[Sequence[builtins.str]]:
        """
        List of transforms
        """
...
class CompressionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 content_types_to_compress: Optional[Sequence[builtins.str]] = None,
                 is_compression_enabled: Optional[builtins.bool] = None):
        """
        settings for compression.
        :param Sequence[builtins.str] content_types_to_compress: List of content types on which compression applies. The value should be a valid MIME type.
        :param builtins.bool is_compression_enabled: Indicates whether content compression is enabled on AzureFrontDoor. Default value is false. If compression is enabled, content will be served as compressed if user requests for a compressed version. Content won't be compressed on AzureFrontDoor when requested content is smaller than 1 byte or larger than 1 MB.
        """
...
class CookiesMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] match_values: The match value for the condition of the delivery rule
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param builtins.str selector: Name of Cookies to be matched
        :param Sequence[builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the common attributes for a custom rule that can be included in a waf policy
        :param builtins.str action: Describes what action to be applied when rule matches
        :param Sequence['MatchConditionResponse'] match_conditions: List of match conditions.
        :param builtins.str name: Defines the name of the custom rule
        :param builtins.int priority: Defines in what order this rule be evaluated in the overall list of custom rules
        :param builtins.str enabled_state: Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        """
...
class DeepCreatedCustomDomainResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 validation_data: Optional[builtins.str] = None):
        """
        Custom domains created on the CDN endpoint.
        :param builtins.str host_name: The host name of the custom domain. Must be a domain name.
        :param builtins.str name: Custom domain name.
        :param builtins.str validation_data: Special validation or data may be required when delivering CDN to some regions due to local compliance reasons. E.g. ICP license number of a custom domain is required to deliver content in China.
        """
...
class DeepCreatedOriginGroupResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[builtins.int] = None):
        """
        The origin group for CDN content which is added when creating a CDN endpoint. Traffic is sent to the origins within the origin group based on origin health.
        :param builtins.str name: Origin group name which must be unique within the endpoint.
        ...
        :param builtins.int traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
        """
        pulumi.set(__self__, "name", name)
...
class DeepCreatedOriginResponse(dict):
    ...
    def __init__(__self__, *,
                 host_name: builtins.str,
                 name: builtins.str,
                 private_endpoint_status: builtins.str,
                 enabled: Optional[builtins.bool] = None,
                 http_port: Optional[builtins.int] = None,
                 https_port: Optional[builtins.int] = None,
                 origin_host_header: Optional[builtins.str] = None,
                 priority: Optional[builtins.int] = None,
                 private_link_alias: Optional[builtins.str] = None,
                 private_link_approval_message: Optional[builtins.str] = None,
                 private_link_location: Optional[builtins.str] = None,
        ...
        :param builtins.int https_port: The value of the HTTPS port. Must be between 1 and 65535.
        :param builtins.str origin_host_header: The host header value sent to the origin with each request. If you leave this blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by default.
        :param builtins.int priority: Priority of origin in given origin group for load balancing. Higher priorities will not be used for load balancing if any lower priority origin is healthy.Must be between 1 and 5.
        :param builtins.str private_link_alias: The Alias of the Private Link resource. Populating this optional field indicates that this origin is 'Private'
        :param builtins.str private_link_approval_message: A custom message to be included in the approval request to connect to the Private Link.
        :param builtins.str private_link_location: The location of the Private Link resource. Required only if 'privateLinkResourceId' is populated
        :param builtins.str private_link_resource_id: The Resource Id of the Private Link resource. Populating this optional field indicates that this backend is 'Private'
        :param builtins.int weight: Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
        """
        pulumi.set(__self__, "host_name", host_name)
        pulumi.set(__self__, "name", name)
...
class DeliveryRuleCacheExpirationActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the cache expiration action for the delivery rule.
        :param builtins.str name: The name of the action for the delivery rule.
...
class DomainValidationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 expiration_date: builtins.str,
                 validation_token: builtins.str):
        """
        The JSON object that contains the properties to validate a domain.
        :param builtins.str expiration_date: The date time that the token expires
        :param builtins.str validation_token: Challenge used for DNS TXT record or file based validation
        """
        pulumi.set(__self__, "expiration_date", expiration_date)
...
class EdgeActionAttachmentResponse(dict):
    ...
    def __init__(__self__, *,
                 attached_resource_id: builtins.str,
                 id: builtins.str):
        """
        :param builtins.str attached_resource_id: The attached resource Id
        :param builtins.str id: The edge action attachment id
        """
    ...
    def attached_resource_id(self) -> builtins.str:
        """
...
class EndpointPropertiesUpdateParametersDeliveryPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: User-friendly description of the policy.
        """
        pulumi.set(__self__, "rules", rules)
...
class GeoFilterResponse(dict):
    ...
    def __init__(__self__, *,
                 action: builtins.str,
                 country_codes: Sequence[builtins.str],
                 relative_path: builtins.str):
        """
        Rules defining user's geo access within a CDN endpoint.
        :param builtins.str action: Action of the geo filter, i.e. allow or block access.
        :param Sequence[builtins.str] country_codes: Two letter country or region codes defining user country or region access in a geo filter, e.g. AU, MX, US.
        :param builtins.str relative_path: Relative path applicable to geo filter. (e.g. '/mypictures', '/mypicture/kitty.jpg', and etc.)
        """
        pulumi.set(__self__, "action", action)
    ...
    def country_codes(self) -> Sequence[builtins.str]:
        """
...
class HeaderActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the parameters for the request header action.
        :param builtins.str header_action: Action to perform
        :param builtins.str header_name: Name of the header to modify
        :param builtins.str type_name: 
               Expected value is 'DeliveryRuleHeaderActionParameters'.
        :param builtins.str value: Value for the specified action
        """
...
class HealthProbeParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 probe_interval_in_seconds: Optional[builtins.int] = None,
                 probe_path: Optional[builtins.str] = None,
                 probe_protocol: Optional[builtins.str] = None,
                 probe_request_type: Optional[builtins.str] = None):
        """
        The JSON object that contains the properties to send health probes to origin.
        :param builtins.int probe_interval_in_seconds: The number of seconds between health probes.Default is 240sec.
        :param builtins.str probe_path: The path relative to the origin that is used to determine the health of the origin.
        :param builtins.str probe_protocol: Protocol to use for health probe.
        :param builtins.str probe_request_type: The type of health probe request that is made.
        """
    ...
    def probe_interval_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def probe_protocol(self) -> Optional[builtins.str]:
        """
    ...
    def probe_request_type(self) -> Optional[builtins.str]:
        """
...
class HttpErrorRangeParametersResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 begin: Optional[builtins.int] = None,
                 end: Optional[builtins.int] = None):
        """
        The JSON object that represents the range for http status codes
        :param builtins.int begin: The inclusive start of the http status code range.
        :param builtins.int end: The inclusive end of the http status code range.
        """
    ...
    @property
    @pulumi.getter
    def begin(self) -> Optional[builtins.int]:
        """
...
class KeyVaultCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type_name: builtins.str,
                 update_rule: builtins.str,
                 vault_name: builtins.str,
                 secret_version: Optional[builtins.str] = None):
        """
        Describes the parameters for using a user's KeyVault certificate for securing custom domain.
        :param builtins.str delete_rule: Describes the action that shall be taken when the certificate is removed from Key Vault.
        :param builtins.str resource_group_name: Resource group of the user's Key Vault containing the SSL certificate
        :param builtins.str secret_name: The name of Key Vault Secret (representing the full certificate PFX) in Key Vault.
        :param builtins.str subscription_id: Subscription Id of the user's Key Vault containing the SSL certificate
        :param builtins.str type_name: 
               Expected value is 'KeyVaultCertificateSourceParameters'.
        :param builtins.str update_rule: Describes the action that shall be taken when the certificate is updated in Key Vault.
        :param builtins.str vault_name: The name of the user's Key Vault containing the SSL certificate
        :param builtins.str secret_version: The version(GUID) of Key Vault Secret in Key Vault.
        """
        pulumi.set(__self__, "delete_rule", delete_rule)
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        pulumi.set(__self__, "secret_name", secret_name)
        pulumi.set(__self__, "subscription_id", subscription_id)
        pulumi.set(__self__, "type_name", 'KeyVaultCertificateSourceParameters')
    ...
    def update_rule(self) -> builtins.str:
        """
...
class KeyVaultSigningKeyParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the parameters for using a user's KeyVault for URL Signing Key.
        :param builtins.str resource_group_name: Resource group of the user's Key Vault containing the secret
        :param builtins.str secret_name: The name of secret in Key Vault.
        :param builtins.str secret_version: The version(GUID) of secret in Key Vault.
        :param builtins.str subscription_id: Subscription Id of the user's Key Vault containing the secret
        :param builtins.str vault_name: The name of the user's Key Vault containing the secret
        """
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        pulumi.set(__self__, "secret_name", secret_name)
        pulumi.set(__self__, "secret_version", secret_version)
...
class LoadBalancingSettingsParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 additional_latency_in_milliseconds: Optional[builtins.int] = None,
                 sample_size: Optional[builtins.int] = None,
                 successful_samples_required: Optional[builtins.int] = None):
        """
        Round-Robin load balancing settings for a backend pool
        :param builtins.int additional_latency_in_milliseconds: The additional latency in milliseconds for probes to fall into the lowest latency bucket
        :param builtins.int sample_size: The number of samples to consider for load balancing decisions
        :param builtins.int successful_samples_required: The number of samples within the sample period that must succeed
        """
    ...
    def additional_latency_in_milliseconds(self) -> Optional[builtins.int]:
        """
    ...
    def successful_samples_required(self) -> Optional[builtins.int]:
        """
...
class ManagedRuleGroupOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a managed rule group override setting.
        :param builtins.str rule_group_name: Describes the managed rule group within the rule set to override
...
class ManagedRuleOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a managed rule group override setting.
        :param builtins.str rule_id: Identifier for the managed rule.
        :param builtins.str action: Describes the override action to be applied when rule matches.
        :param builtins.str enabled_state: Describes if the managed rule is in enabled or disabled state. Defaults to Disabled if not specified.
        """
...
class ManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 anomaly_score: Optional[builtins.int] = None,
                 rule_group_overrides: Optional[Sequence['outputs.ManagedRuleGroupOverrideResponse']] = None):
        """
        Defines a managed rule set.
        :param builtins.str rule_set_type: Defines the rule set type to use.
        :param builtins.str rule_set_version: Defines the version of the rule set to use.
        :param builtins.int anomaly_score: Verizon only : If the rule set supports anomaly detection mode, this describes the threshold for blocking requests.
    ...
    def anomaly_score(self) -> Optional[builtins.int]:
        """
...
class MatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
                 match_value: Sequence[builtins.str],
        ...
        """
        Define match conditions
        :param Sequence[builtins.str] match_value: List of possible match values.
        :param builtins.str match_variable: Match variable to compare against.
        :param builtins.str operator: Describes operator to be matched
        :param builtins.bool negate_condition: Describes if the result of this condition should be negated.
        :param builtins.str selector: Selector can used to match a specific key for QueryString, Cookies, RequestHeader or PostArgs.
        :param Sequence[builtins.str] transforms: List of transforms.
        """
    ...
    def match_value(self) -> Sequence[builtins.str]:
        """
...
class OriginGroupOverrideResponse(dict):
    ...
    def __init__(__self__, *,
                 forwarding_protocol: Optional[builtins.str] = None,
                 origin_group: Optional['outputs.ResourceReferenceResponse'] = None):
        """
        Defines the parameters for the origin group override configuration.
        :param builtins.str forwarding_protocol: Protocol this rule will use when forwarding traffic to backends.
    ...
    def forwarding_protocol(self) -> Optional[builtins.str]:
        """
...
class PolicySettingsResponse(dict):
    ...
    def default_custom_block_response_body(self) -> Optional[builtins.str]:
        """
    ...
    def default_redirect_url(self) -> Optional[builtins.str]:
        """
...
class PostArgsMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] match_values: The match value for the condition of the delivery rule
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param builtins.str selector: Name of PostArg to be matched
        :param Sequence[builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class ProfileLogScrubbingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str state: State of the log scrubbing config. Default value is Enabled.
        """
...
class ProfileScrubbingRulesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the contents of the log scrubbing rules.
        :param builtins.str match_variable: The variable to be scrubbed from the logs.
        :param builtins.str selector_match_operator: When matchVariable is a collection, operate on the selector to specify which elements in the collection this rule applies to.
        :param builtins.str selector: When matchVariable is a collection, operator used to specify which elements in the collection this rule applies to.
        :param builtins.str state: Defines the state of a log scrubbing rule. Default value is enabled.
        """
        pulumi.set(__self__, "match_variable", match_variable)
...
class RateLimitRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Defines the name of the custom rule
        :param builtins.int priority: Defines in what order this rule be evaluated in the overall list of custom rules
        :param builtins.int rate_limit_duration_in_minutes: Defines rate limit duration. Default is 1 minute.
        :param builtins.int rate_limit_threshold: Defines rate limit threshold.
        :param builtins.str enabled_state: Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "match_conditions", match_conditions)
    ...
    def rate_limit_duration_in_minutes(self) -> builtins.int:
        """
    ...
    def rate_limit_threshold(self) -> builtins.int:
        """
...
class RemoteAddressMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] match_values: Match values to match against. The operator will apply to each value in here with OR semantics. If any of them match the variable with the given operator this match condition is considered a match.
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class RequestHeaderMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] match_values: The match value for the condition of the delivery rule
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param builtins.str selector: Name of Header to be matched
        :param Sequence[builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class ResponseBasedOriginErrorDetectionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 response_based_detected_error_types: Optional[builtins.str] = None,
                 response_based_failover_threshold_percentage: Optional[builtins.int] = None):
        """
        The JSON object that contains the properties to determine origin health using real requests/responses.
        ...
        :param builtins.str response_based_detected_error_types: Type of response errors for real user requests for which origin will be deemed unhealthy
        :param builtins.int response_based_failover_threshold_percentage: The percentage of failed requests in the sample where failover should trigger.
        """
    ...
    def response_based_detected_error_types(self) -> Optional[builtins.str]:
        """
    ...
    def response_based_failover_threshold_percentage(self) -> Optional[builtins.int]:
        """
...
class SecurityPolicyWebApplicationFirewallAssociationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 patterns_to_match: Optional[Sequence[builtins.str]] = None):
        """
        settings for security policy patterns to match
        :param Sequence['ActivatedResourceReferenceResponse'] domains: List of domains.
        :param Sequence[builtins.str] patterns_to_match: List of paths
        """
    ...
    def patterns_to_match(self) -> Optional[Sequence[builtins.str]]:
        """
        List of paths
        """
...
class SecurityPolicyWebApplicationFirewallParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The json object containing security policy waf parameters
        :param builtins.str type: The type of the Security policy to create.
...
class SharedPrivateLinkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str private_link_location: The location of the shared private link resource
        :param builtins.str request_message: The request message for requesting approval of the shared private link resource.
        :param builtins.str status: Status of the shared private link resource. Can be Pending, Approved, Rejected, Disconnected, or Timeout.
        """
...
class SkuTypeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sku of edge actions.
        :param builtins.str name: The name of the SKU for the EdgeAction.
        :param builtins.str tier: The pricing tier associated with the SKU.
        """
        pulumi.set(__self__, "name", name)
...
class TargetEndpointResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_fqdn: Optional[builtins.str] = None):
        """
        TargetEndpoint object that forms a traffic endpoint.
        :param Sequence[builtins.int] ports: The Ports to be allowed for the FQDN.
        :param builtins.str target_fqdn: The FQDN for traffic endpoint.
        """
    ...
    def target_fqdn(self) -> Optional[builtins.str]:
        """
...
class UrlRedirectActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type_name: builtins.str,
                 custom_fragment: Optional[builtins.str] = None,
                 custom_hostname: Optional[builtins.str] = None,
                 custom_path: Optional[builtins.str] = None,
                 custom_query_string: Optional[builtins.str] = None,
                 destination_protocol: Optional[builtins.str] = None):
        """
        Defines the parameters for the url redirect action.
        :param builtins.str redirect_type: The redirect type the rule will use when redirecting traffic.
        :param builtins.str type_name: 
               Expected value is 'DeliveryRuleUrlRedirectActionParameters'.
        :param builtins.str custom_fragment: Fragment to add to the redirect URL. Fragment is the part of the URL that comes after #. Do not include the #.
        :param builtins.str custom_hostname: Host to redirect. Leave empty to use the incoming host as the destination host.
        :param builtins.str custom_path: The full path to redirect. Path cannot be empty and must start with /. Leave empty to use the incoming path as destination path.
        :param builtins.str custom_query_string: The set of query strings to be placed in the redirect URL. Setting this value would replace any existing query string; leave empty to preserve the incoming query string. Query string must be in <key>=<value> format. ? and & will be added automatically so do not include them.
        :param builtins.str destination_protocol: Protocol to use for the redirect. The default value is MatchRequest
        """
    ...
    def custom_fragment(self) -> Optional[builtins.str]:
        """
    ...
    def custom_hostname(self) -> Optional[builtins.str]:
        """
    ...
    def custom_path(self) -> Optional[builtins.str]:
        """
    ...
    def custom_query_string(self) -> Optional[builtins.str]:
        """
    ...
    def destination_protocol(self) -> Optional[builtins.str]:
        """
...
class UrlRewriteActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type_name: builtins.str,
                 preserve_unmatched_path: Optional[builtins.bool] = None):
        """
        Defines the parameters for the url rewrite action.
        :param builtins.str destination: Define the relative URL to which the above requests will be rewritten by.
        :param builtins.str source_pattern: define a request URI pattern that identifies the type of requests that may be rewritten. If value is blank, all strings are matched.
        :param builtins.str type_name: 
               Expected value is 'DeliveryRuleUrlRewriteActionParameters'.
        :param builtins.bool preserve_unmatched_path: Whether to preserve unmatched path. Default value is true.
        """
    ...
    def preserve_unmatched_path(self) -> Optional[builtins.bool]:
        """
...
class UrlSigningKeyParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Url signing key parameters
        :param builtins.str key_id: Defines the customer defined key Id. This id will exist in the incoming request to indicate the key used to form the hash.
...
class UrlSigningParamIdentifierResponse(dict):
    ...
    def __init__(__self__, *,
                 param_indicator: builtins.str,
                 param_name: builtins.str):
        """
        Defines how to identify a parameter for a specific purpose e.g. expires
        :param builtins.str param_indicator: Indicates the purpose of the parameter
    ...
    def param_indicator(self) -> builtins.str:
        """
