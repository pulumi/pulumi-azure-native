...
class AFDDomainHttpsCustomizedCipherSuiteSetResponse(dict):
    ...
    def __init__(__self__, *,
                 cipher_suite_set_for_tls12: Optional[Sequence[_builtins.str]] = None,
...
class AFDDomainHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cipher_suite_set_type: Optional[_builtins.str] = None,
        ...
        :param _builtins.str minimum_tls_version: TLS protocol version that will be used for Https when cipherSuiteSetType is Customized.
...
class AzureFirstPartyManagedCertificateParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] subject_alternative_names: The list of SANs.
        """
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 cache_behavior: Optional[_builtins.str] = None,
                 cache_duration: Optional[_builtins.str] = None,
                 is_compression_enabled: Optional[_builtins.str] = None,
                 query_parameters: Optional[_builtins.str] = None,
                 query_string_caching_behavior: Optional[_builtins.str] = None):
        """
        Caching settings for a caching-type route. To disable caching, do not provide a cacheConfiguration object.
...
class CacheExpirationActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleCacheExpirationActionParameters'.
        :param _builtins.str cache_duration: The duration for which the content needs to be cached. Allowed format is [d.]hh:mm:ss
        """
        pulumi.set(__self__, "cache_behavior", cache_behavior)
...
class CacheKeyQueryStringActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleCacheKeyQueryStringBehaviorActionParameters'.
        :param _builtins.str query_parameters: query parameters to include or exclude (comma separated).
        """
...
class CdnCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'CdnCertificateSourceParameters'.
        """
        pulumi.set(__self__, "certificate_type", certificate_type)
...
class CdnManagedHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str minimum_tls_version: TLS protocol version that will be used for Https
        """
...
class ClientPortMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleClientPortConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
...
class CompressionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 content_types_to_compress: Optional[Sequence[_builtins.str]] = None,
...
class CookiesMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleCookiesConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param _builtins.str selector: Name of Cookies to be matched
        :param Sequence[_builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int priority: Defines in what order this rule be evaluated in the overall list of custom rules
...
class CustomerCertificateParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool use_latest_version: Whether to use the latest version for the certificate
        """
        pulumi.set(__self__, "certificate_authority", certificate_authority)
        pulumi.set(__self__, "expiration_date", expiration_date)
        pulumi.set(__self__, "secret_source", secret_source)
...
class DeepCreatedOriginGroupResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Time in minutes to shift the traffic to the endpoint gradually when an unhealthy endpoint comes healthy or a new endpoint is added. Default is 10 mins. This property is currently not supported.
        """
        pulumi.set(__self__, "name", name)
...
class DeepCreatedOriginResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 origin_host_header: Optional[_builtins.str] = None,
                 priority: Optional[_builtins.int] = None,
                 private_link_alias: Optional[_builtins.str] = None,
                 private_link_approval_message: Optional[_builtins.str] = None,
                 private_link_location: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool enabled: Origin is enabled for load balancing or not. By default, origin is always enabled.
        :param _builtins.int http_port: The value of the HTTP port. Must be between 1 and 65535.
        :param _builtins.int https_port: The value of the HTTPS port. Must be between 1 and 65535.
        :param _builtins.str origin_host_header: The host header value sent to the origin with each request. If you leave this blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by default.
        :param _builtins.int priority: Priority of origin in given origin group for load balancing. Higher priorities will not be used for load balancing if any lower priority origin is healthy.Must be between 1 and 5.
        :param _builtins.str private_link_alias: The Alias of the Private Link resource. Populating this optional field indicates that this origin is 'Private'
        :param _builtins.str private_link_approval_message: A custom message to be included in the approval request to connect to the Private Link.
        :param _builtins.str private_link_location: The location of the Private Link resource. Required only if 'privateLinkResourceId' is populated
        :param _builtins.str private_link_resource_id: The Resource Id of the Private Link resource. Populating this optional field indicates that this backend is 'Private'
        :param _builtins.int weight: Weight of the origin in given origin group for load balancing. Must be between 1 and 1000
        """
        pulumi.set(__self__, "host_name", host_name)
        pulumi.set(__self__, "name", name)
...
class HeaderActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleHeaderActionParameters'.
        :param _builtins.str value: Value for the specified action
        """
...
class HealthProbeParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 probe_interval_in_seconds: Optional[_builtins.int] = None,
                 probe_path: Optional[_builtins.str] = None,
                 probe_protocol: Optional[_builtins.str] = None,
        ...
        :param _builtins.str probe_request_type: The type of health probe request that is made.
        """
...
class HostNameMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleHostNameConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class HttpErrorRangeParametersResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 begin: Optional[_builtins.int] = None,
...
class HttpVersionMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleHttpVersionConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class IsDeviceMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleIsDeviceConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class KeyVaultCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str subscription_id: Subscription Id of the user's Key Vault containing the SSL certificate
        :param _builtins.str type_name: Expected value is 'KeyVaultCertificateSourceParameters'.
        :param _builtins.str update_rule: Describes the action that shall be taken when the certificate is updated in Key Vault.
        :param _builtins.str vault_name: The name of the user's Key Vault containing the SSL certificate
        :param _builtins.str secret_version: The version(GUID) of Key Vault Secret in Key Vault.
        """
...
class KeyVaultSigningKeyParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str subscription_id: Subscription Id of the user's Key Vault containing the secret
        :param _builtins.str vault_name: The name of the user's Key Vault containing the secret
        """
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        pulumi.set(__self__, "secret_name", secret_name)
        pulumi.set(__self__, "secret_version", secret_version)
...
class LoadBalancingSettingsParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 additional_latency_in_milliseconds: Optional[_builtins.int] = None,
...
class ManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 anomaly_score: Optional[_builtins.int] = None,
...
class MatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str selector: Selector can used to match a specific key for QueryString, Cookies, RequestHeader or PostArgs.
        :param Sequence[_builtins.str] transforms: List of transforms.
        """
...
class OriginGroupOverrideActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleOriginGroupOverrideActionParameters'.
        """
...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 default_custom_block_response_body: Optional[_builtins.str] = None,
                 default_custom_block_response_status_code: Optional[_builtins.float] = None,
                 default_redirect_url: Optional[_builtins.str] = None,
                 enabled_state: Optional[_builtins.str] = None,
        ...
        :param _builtins.str enabled_state: describes if the policy is in enabled state or disabled state
    ...
    def default_custom_block_response_status_code(self) -> Optional[_builtins.float]:
        """
...
class PostArgsMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRulePostArgsConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param _builtins.str selector: Name of PostArg to be matched
        :param Sequence[_builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class QueryStringMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleQueryStringConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class RateLimitRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Defines the name of the custom rule
        :param _builtins.int priority: Defines in what order this rule be evaluated in the overall list of custom rules
        :param _builtins.int rate_limit_duration_in_minutes: Defines rate limit duration. Default is 1 minute.
        :param _builtins.int rate_limit_threshold: Defines rate limit threshold.
        :param _builtins.str enabled_state: Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "match_conditions", match_conditions)
...
class RemoteAddressMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRemoteAddressConditionParameters'.
        :param Sequence[_builtins.str] match_values: Match values to match against. The operator will apply to each value in here with OR semantics. If any of them match the variable with the given operator this match condition is considered a match.
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class RequestBodyMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRequestBodyConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class RequestHeaderMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRequestHeaderConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param _builtins.str selector: Name of Header to be matched
        :param Sequence[_builtins.str] transforms: List of transforms
        """
        pulumi.set(__self__, "operator", operator)
...
class RequestMethodMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRequestMethodConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class RequestSchemeMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRequestSchemeConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class RequestUriMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRequestUriConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class ResponseBasedOriginErrorDetectionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 response_based_detected_error_types: Optional[_builtins.str] = None,
    ...
    def response_based_failover_threshold_percentage(self) -> Optional[_builtins.int]:
        """
...
class RouteConfigurationOverrideActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleRouteConfigurationOverrideActionParameters'.
...
class ServerPortMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleServerPortConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class SharedPrivateLinkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str request_message: The request message for requesting approval of the shared private link resource.
        :param _builtins.str status: Status of the shared private link resource. Can be Pending, Approved, Rejected, Disconnected, or Timeout.
        """
...
class SocketAddrMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleSocketAddrConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class SslProtocolMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleSslProtocolConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class UrlFileExtensionMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlFileExtensionMatchConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class UrlFileNameMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlFilenameConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class UrlPathMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Describes operator to be matched
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlPathMatchConditionParameters'.
        :param Sequence[_builtins.str] match_values: The match value for the condition of the delivery rule
        :param _builtins.bool negate_condition: Describes if this is negate condition or not
        :param Sequence[_builtins.str] transforms: List of transforms
        """
...
class UrlRedirectActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_hostname: Optional[_builtins.str] = None,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlRedirectActionParameters'.
        ...
        :param _builtins.str custom_hostname: Host to redirect. Leave empty to use the incoming host as the destination host.
        :param _builtins.str custom_path: The full path to redirect. Path cannot be empty and must start with /. Leave empty to use the incoming path as destination path.
        :param _builtins.str custom_query_string: The set of query strings to be placed in the redirect URL. Setting this value would replace any existing query string; leave empty to preserve the incoming query string. Query string must be in <key>=<value> format. ? and & will be added automatically so do not include them.
        :param _builtins.str destination_protocol: Protocol to use for the redirect. The default value is MatchRequest
        """
...
class UrlRewriteActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlRewriteActionParameters'.
        :param _builtins.bool preserve_unmatched_path: Whether to preserve unmatched path. Default value is true.
        """
...
class UrlSigningActionParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type_name: Expected value is 'DeliveryRuleUrlSigningActionParameters'.
