...
class GetEdgeActionExecutionFilterResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, execution_filter_identifier_header_name=None, execution_filter_identifier_header_value=None, id=None, last_update_time=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, version_id=None):
    ...
    def execution_filter_identifier_header_name(self) -> builtins.str:
        """
    ...
    def execution_filter_identifier_header_value(self) -> builtins.str:
        """
...
def get_edge_action_execution_filter(edge_action_name: Optional[builtins.str] = None,
                                     execution_filter: Optional[builtins.str] = None,
    ...
    :param builtins.str execution_filter: The name of the execution filter
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn:getEdgeActionExecutionFilter', __args__, opts=opts, typ=GetEdgeActionExecutionFilterResult).value
...
def get_edge_action_execution_filter_output(edge_action_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn:getEdgeActionExecutionFilter', __args__, opts=opts, typ=GetEdgeActionExecutionFilterResult)
