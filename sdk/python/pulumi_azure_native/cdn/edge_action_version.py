...
class EdgeActionVersionArgs:
    def __init__(__self__, *,
                 deployment_type: pulumi.Input[Union[builtins.str, 'EdgeActionVersionDeploymentType']],
                 edge_action_name: pulumi.Input[builtins.str],
                 is_default_version: pulumi.Input[Union[builtins.str, 'EdgeActionIsDefaultVersion']],
        ...
        :param pulumi.Input[Union[builtins.str, 'EdgeActionVersionDeploymentType']] deployment_type: The deployment type
        :param pulumi.Input[builtins.str] edge_action_name: The name of the Edge Action
        :param pulumi.Input[Union[builtins.str, 'EdgeActionIsDefaultVersion']] is_default_version: The active state
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.str] version: The name of the Edge Action version
        """
    ...
    def deployment_type(self) -> pulumi.Input[Union[builtins.str, 'EdgeActionVersionDeploymentType']]:
        """
        The deployment type
        """
    ...
    def deployment_type(self, value: pulumi.Input[Union[builtins.str, 'EdgeActionVersionDeploymentType']]):
    ...
    def is_default_version(self) -> pulumi.Input[Union[builtins.str, 'EdgeActionIsDefaultVersion']]:
        """
        The active state
        """
    ...
    def is_default_version(self, value: pulumi.Input[Union[builtins.str, 'EdgeActionIsDefaultVersion']]):
...
class EdgeActionVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deployment_type: Optional[pulumi.Input[Union[builtins.str, 'EdgeActionVersionDeploymentType']]] = None,
                 edge_action_name: Optional[pulumi.Input[builtins.str]] = None,
                 is_default_version: Optional[pulumi.Input[Union[builtins.str, 'EdgeActionIsDefaultVersion']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20240722preview:EdgeActionVersion")])
    ...
    @property
    @pulumi.getter(name="isDefaultVersion")
    def is_default_version(self) -> pulumi.Output[builtins.str]:
        """
        The active state
        """
        return pulumi.get(self, "is_default_version")
    ...
    def last_package_update_time(self) -> pulumi.Output[builtins.str]:
        """
