...
class EdgeActionVersionArgs:
    def __init__(__self__, *,
                 deployment_type: pulumi.Input[Union[_builtins.str, 'EdgeActionVersionDeploymentType']],
        ...
        :param pulumi.Input[Union[_builtins.str, 'EdgeActionVersionDeploymentType']] deployment_type: The deployment type
    ...
    def deployment_type(self, value: pulumi.Input[Union[_builtins.str, 'EdgeActionVersionDeploymentType']]):
    ...
    def is_default_version(self, value: pulumi.Input[Union[_builtins.str, 'EdgeActionIsDefaultVersion']]):
...
class EdgeActionVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20240722preview:EdgeActionVersion"), pulumi.Alias(type_="azure-native:cdn/v20250901preview:EdgeActionVersion"), pulumi.Alias(type_="azure-native:cdn/v20251201preview:EdgeActionVersion")])
