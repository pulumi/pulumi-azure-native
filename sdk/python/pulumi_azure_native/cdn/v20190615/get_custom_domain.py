...
azure-native:cdn/v20190615:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:CustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: Version 2019-06-15 will be removed in v2 of the provider.
azure-native:cdn/v20190615:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:CustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20190615:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult).value
