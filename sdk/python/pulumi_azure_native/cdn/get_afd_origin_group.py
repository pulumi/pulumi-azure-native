...
def get_afd_origin_group(origin_group_name: Optional[_builtins.str] = None,
...
def get_afd_origin_group_output(origin_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
