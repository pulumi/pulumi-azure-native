...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 optimization_type: Optional[pulumi.Input[Union[builtins.str, 'OptimizationType']]] = None,
    ...
    def optimization_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'OptimizationType']]]:
        """
    ...
    def optimization_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'OptimizationType']]]):
...
class Endpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contentTypesToCompress")
    def content_types_to_compress(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of content types on which compression applies. The value should be a valid MIME type.
        """
        return pulumi.get(self, "content_types_to_compress")
    ...
    @property
    @pulumi.getter(name="queryStringCachingBehavior")
    def query_string_caching_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines how CDN caches requests that include query strings. You can ignore any query strings when caching, bypass caching to prevent requests that contain query strings from being cached, or cache every request with a unique URL.
        """
        return pulumi.get(self, "query_string_caching_behavior")
