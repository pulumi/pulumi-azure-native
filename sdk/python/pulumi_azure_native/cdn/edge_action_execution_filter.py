...
class EdgeActionExecutionFilterArgs:
    def __init__(__self__, *,
                 edge_action_name: pulumi.Input[builtins.str],
                 execution_filter_identifier_header_name: pulumi.Input[builtins.str],
                 execution_filter_identifier_header_value: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 version_id: pulumi.Input[builtins.str],
                 execution_filter: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] execution_filter_identifier_header_name: Custom Header Key associated with the execution filter
        :param pulumi.Input[builtins.str] execution_filter_identifier_header_value: Custom Header Value associated with the execution filter
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] version_id: The referenced versionId of the edgeAction version
        :param pulumi.Input[builtins.str] execution_filter: The name of the execution filter
    ...
    def edge_action_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def edge_action_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "edge_action_name", value)

    @property
    @pulumi.getter(name="executionFilterIdentifierHeaderName")
    def execution_filter_identifier_header_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def execution_filter_identifier_header_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "execution_filter_identifier_header_name", value)

    @property
    @pulumi.getter(name="executionFilterIdentifierHeaderValue")
    def execution_filter_identifier_header_value(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def execution_filter_identifier_header_value(self, value: pulumi.Input[builtins.str]):
    ...
    def execution_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def execution_filter(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EdgeActionExecutionFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 execution_filter: Optional[pulumi.Input[builtins.str]] = None,
                 execution_filter_identifier_header_name: Optional[pulumi.Input[builtins.str]] = None,
                 execution_filter_identifier_header_value: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20240722preview:EdgeActionExecutionFilter")])
    ...
    @property
    @pulumi.getter(name="executionFilterIdentifierHeaderName")
    def execution_filter_identifier_header_name(self) -> pulumi.Output[builtins.str]:
        """
        Custom Header Key associated with the execution filter
        """
        return pulumi.get(self, "execution_filter_identifier_header_name")
    ...
    @property
    @pulumi.getter(name="executionFilterIdentifierHeaderValue")
    def execution_filter_identifier_header_value(self) -> pulumi.Output[builtins.str]:
        """
        Custom Header Value associated with the execution filter
        """
        return pulumi.get(self, "execution_filter_identifier_header_value")
