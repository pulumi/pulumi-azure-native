...
warnings.warn("""azure-native:cdn/v20221101preview:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Secret to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_secret(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_secret is deprecated: azure-native:cdn/v20221101preview:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Secret to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['profileName'] = profile_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['secretName'] = secret_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20221101preview:getSecret', __args__, opts=opts, typ=GetSecretResult).value
