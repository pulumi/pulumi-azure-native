...
class OriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""OriginGroup is deprecated: azure-native:cdn/v20221101preview:OriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:OriginGroup to guarantee forwards compatibility.""")
