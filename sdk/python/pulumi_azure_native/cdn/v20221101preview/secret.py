...
class Secret(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        secret = azure_native.cdn.v20221101preview.Secret("secret",
            parameters=azure_native.cdn.v20221101preview.CustomerCertificateParametersArgs(
                secret_source=azure_native.cdn.v20221101preview.ResourceReferenceArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Secret"), pulumi.Alias(type_="azure-native:cdn/v20200901:Secret"), pulumi.Alias(type_="azure-native:cdn/v20210601:Secret"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Secret")])
