...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        afd_custom_domain = azure_native.cdn.v20221101preview.AFDCustomDomain("afdCustomDomain",
            azure_dns_zone=azure_native.cdn.v20221101preview.ResourceReferenceArgs(
                id="",
            ),
            ...
            tls_settings=azure_native.cdn.v20221101preview.AFDDomainHttpsParametersResponseArgs(
                certificate_type="ManagedCertificate",
                minimum_tls_version=azure_native.cdn/v20221101preview.AfdMinimumTlsVersion.TLS12,
            ))
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDCustomDomain")])
