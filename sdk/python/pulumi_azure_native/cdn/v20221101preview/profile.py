...
warnings.warn("""azure-native:cdn/v20221101preview:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Profile to guarantee forwards compatibility.""", DeprecationWarning)
...
class Profile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Profile is deprecated: azure-native:cdn/v20221101preview:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Profile to guarantee forwards compatibility.""")
        ...
        super(Profile, __self__).__init__(
            'azure-native:cdn/v20221101preview:Profile',
            resource_name,
            __props__,
            opts)
