...
class Rule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rule = azure_native.cdn.v20221101preview.Rule("rule",
            actions=[azure_native.cdn.v20221101preview.DeliveryRuleResponseHeaderActionArgs(
            ...
            conditions=[azure_native.cdn.v20221101preview.DeliveryRuleRequestMethodConditionArgs(
                name="RequestMethod",
                parameters=azure_native.cdn.v20221101preview.RequestMethodMatchConditionParametersArgs(
                    match_values=["GET"],
