...
warnings.warn("""azure-native:cdn/v20221101preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:CustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class CustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CustomDomain is deprecated: azure-native:cdn/v20221101preview:CustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:CustomDomain to guarantee forwards compatibility.""")
        ...
        super(CustomDomain, __self__).__init__(
            'azure-native:cdn/v20221101preview:CustomDomain',
            resource_name,
            __props__,
            opts)
