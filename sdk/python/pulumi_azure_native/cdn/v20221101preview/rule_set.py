...
class RuleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RuleSet is deprecated: azure-native:cdn/v20221101preview:RuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:RuleSet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:RuleSet"), pulumi.Alias(type_="azure-native:cdn/v20200901:RuleSet"), pulumi.Alias(type_="azure-native:cdn/v20210601:RuleSet"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:RuleSet")])
