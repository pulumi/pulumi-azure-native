...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230501:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240201:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240901:AFDOriginGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AFDOriginGroup, __self__).__init__(
            'azure-native:cdn/v20221101preview:AFDOriginGroup',
            resource_name,
            __props__,
            opts)
