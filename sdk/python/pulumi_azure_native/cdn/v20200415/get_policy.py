...
azure-native:cdn/v20200415:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Policy to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetPolicyResult:
    ...
    """
    def __init__(__self__, custom_rules=None, endpoint_links=None, etag=None, id=None, location=None, managed_rules=None, name=None, policy_settings=None, provisioning_state=None, rate_limit_rules=None, resource_state=None, sku=None, tags=None, type=None):
...
def get_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy is deprecated: Version 2020-04-15 will be removed in v2 of the provider.
azure-native:cdn/v20200415:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Policy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyName'] = policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20200415:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
