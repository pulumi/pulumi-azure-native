...
azure-native:cdn/v20171012:Endpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Endpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_endpoint is deprecated: Version 2017-10-12 will be removed in v2 of the provider.
