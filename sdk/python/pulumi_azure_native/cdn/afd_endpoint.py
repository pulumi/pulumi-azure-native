...
class AFDEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'AutoGeneratedDomainNameLabelScope']] auto_generated_domain_name_label_scope: Indicates the endpoint name reuse scope. The default value is TenantReuse.
