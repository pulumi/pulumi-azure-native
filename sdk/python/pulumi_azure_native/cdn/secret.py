...
class SecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secret_name: Name of the Secret under the profile.
        """
...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20200901:Secret"), pulumi.Alias(type_="azure-native:cdn/v20210601:Secret"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20230501:Secret"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20240201:Secret"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20240901:Secret"), pulumi.Alias(type_="azure-native:cdn/v20250101preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20250415:Secret"), pulumi.Alias(type_="azure-native:cdn/v20250601:Secret"), pulumi.Alias(type_="azure-native:cdn/v20250701preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20250901preview:Secret"), pulumi.Alias(type_="azure-native:cdn/v20251201:Secret"), pulumi.Alias(type_="azure-native:cdn/v20260401preview:Secret")])
