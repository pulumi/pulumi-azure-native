...
class KeyGroupArgs:
    def __init__(__self__, *,
                 ...
                 key_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] key_group_name: Name of the KeyGroup under the profile.
    ...
    def key_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KeyGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20230701preview:KeyGroup"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:KeyGroup"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:KeyGroup"), pulumi.Alias(type_="azure-native:cdn/v20250901preview:KeyGroup")])
