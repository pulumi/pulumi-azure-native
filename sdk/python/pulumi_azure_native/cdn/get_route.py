...
def get_route(endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str route_name: Name of the routing rule.
    """
    __args__ = dict()
...
def get_route_output(endpoint_name: Optional[pulumi.Input[_builtins.str]] = None,
