...
class GetRouteResult:
    ...
    def https_redirect(self) -> Optional[builtins.str]:
        """
    ...
    def link_to_default_domain(self) -> Optional[builtins.str]:
        """
    ...
    def supported_protocols(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_route(endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str route_name: Name of the routing rule.
    """
    __args__ = dict()
...
def get_route_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
