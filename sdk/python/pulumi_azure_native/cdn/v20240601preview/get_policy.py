...
def get_policy(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240601preview:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240601preview:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
