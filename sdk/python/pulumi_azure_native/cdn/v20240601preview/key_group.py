...
class KeyGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:KeyGroup"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:KeyGroup"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:KeyGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KeyGroup, __self__).__init__(
            'azure-native:cdn/v20240601preview:KeyGroup',
            resource_name,
            __props__,
            opts)
