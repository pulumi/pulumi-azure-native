...
class RouteArgs:
    def __init__(__self__, *,
                 ...
                 grpc_state: Optional[pulumi.Input[Union[str, 'AFDRouteGrpcState']]] = None,
        ...
        :param pulumi.Input[Union[str, 'AFDRouteGrpcState']] grpc_state: Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
    ...
    def grpc_state(self) -> Optional[pulumi.Input[Union[str, 'AFDRouteGrpcState']]]:
        """
    ...
    @grpc_state.setter
    def grpc_state(self, value: Optional[pulumi.Input[Union[str, 'AFDRouteGrpcState']]]):
        pulumi.set(self, "grpc_state", value)
...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["grpc_state"] = grpc_state
            if https_redirect is None:
                https_redirect = 'Disabled'
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20200901:Route"), pulumi.Alias(type_="azure-native:cdn/v20210601:Route"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20230501:Route"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20240201:Route"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20240901:Route"), pulumi.Alias(type_="azure-native:cdn/v20250415:Route"), pulumi.Alias(type_="azure-native:cdn:Route")])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["grpc_state"] = None
    ...
    @property
    @pulumi.getter(name="grpcState")
    def grpc_state(self) -> pulumi.Output[Optional[str]]:
        """
        Whether or not gRPC is enabled on this route. Permitted values are 'Enabled' or 'Disabled'
        """
        return pulumi.get(self, "grpc_state")
