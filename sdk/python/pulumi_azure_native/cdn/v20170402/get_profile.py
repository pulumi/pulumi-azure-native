...
azure-native:cdn/v20170402:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20200901:Profile to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_profile(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_profile is deprecated: Version 2017-04-02 will be removed in v2 of the provider.
azure-native:cdn/v20170402:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20200901:Profile to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20170402:getProfile', __args__, opts=opts, typ=GetProfileResult).value
