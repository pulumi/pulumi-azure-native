...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20190615:Policy"), pulumi.Alias(type_="azure-native:cdn/v20190615preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20200331:Policy"), pulumi.Alias(type_="azure-native:cdn/v20200415:Policy"), pulumi.Alias(type_="azure-native:cdn/v20200901:Policy"), pulumi.Alias(type_="azure-native:cdn/v20210601:Policy"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20230501:Policy"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:Policy"), pulumi.Alias(type_="azure-native:cdn/v20240901:Policy"), pulumi.Alias(type_="azure-native:cdn/v20250415:Policy"), pulumi.Alias(type_="azure-native:cdn:Policy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Policy, __self__).__init__(
            'azure-native:cdn/v20240201:Policy',
            resource_name,
            __props__,
            opts)
