...
def get_afd_origin(origin_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240201:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult).value
...
def get_afd_origin_output(origin_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240201:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult)
