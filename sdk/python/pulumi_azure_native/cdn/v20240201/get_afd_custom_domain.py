...
def get_afd_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20240201:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult).value
...
def get_afd_custom_domain_output(custom_domain_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20240201:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult)
