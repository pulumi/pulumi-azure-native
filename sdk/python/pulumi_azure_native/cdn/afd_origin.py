...
class AFDOriginArgs:
    ...
    def origin_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def enabled_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'EnabledState']]]:
        """
    ...
    def enabled_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'EnabledState']]]):
        pulumi.set(self, "enabled_state", value)

    @property
    @pulumi.getter(name="enforceCertificateNameCheck")
    def enforce_certificate_name_check(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enforce_certificate_name_check(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AFDOrigin(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enforceCertificateNameCheck")
    def enforce_certificate_name_check(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable certificate name check at origin level
        """
        return pulumi.get(self, "enforce_certificate_name_check")
    ...
    @property
    @pulumi.getter(name="originGroupName")
    def origin_group_name(self) -> pulumi.Output[builtins.str]:
        """
