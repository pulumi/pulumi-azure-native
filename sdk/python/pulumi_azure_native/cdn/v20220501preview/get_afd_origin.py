...
warnings.warn("""azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_afd_origin(origin_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_origin is deprecated: azure-native:cdn/v20220501preview:AFDOrigin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDOrigin to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20220501preview:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult).value
