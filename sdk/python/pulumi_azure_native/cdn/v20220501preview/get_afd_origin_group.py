...
warnings.warn("""azure-native:cdn/v20220501preview:AFDOriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDOriginGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_afd_origin_group(origin_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_origin_group is deprecated: azure-native:cdn/v20220501preview:AFDOriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDOriginGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['originGroupName'] = origin_group_name
    __args__['profileName'] = profile_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20220501preview:getAFDOriginGroup', __args__, opts=opts, typ=GetAFDOriginGroupResult).value
