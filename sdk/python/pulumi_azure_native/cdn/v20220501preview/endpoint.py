...
warnings.warn("""azure-native:cdn/v20220501preview:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Endpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 web_application_firewall_policy_link: Optional[pulumi.Input[pulumi.InputType['EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Endpoint is deprecated: azure-native:cdn/v20220501preview:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Endpoint to guarantee forwards compatibility.""")
