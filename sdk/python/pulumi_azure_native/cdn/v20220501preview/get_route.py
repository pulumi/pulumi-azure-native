...
def get_route(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: azure-native:cdn/v20220501preview:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Route to guarantee forwards compatibility.""")
    __args__ = dict()
