...
def get_secret(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_secret is deprecated: azure-native:cdn/v20220501preview:Secret is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Secret to guarantee forwards compatibility.""")
    __args__ = dict()
