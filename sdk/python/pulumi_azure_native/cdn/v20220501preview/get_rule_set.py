...
def get_rule_set(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rule_set is deprecated: azure-native:cdn/v20220501preview:RuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:RuleSet to guarantee forwards compatibility.""")
    __args__ = dict()
