...
warnings.warn("""azure-native:cdn/v20220501preview:Rule is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Rule to guarantee forwards compatibility.""", DeprecationWarning)
...
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Rule is deprecated: azure-native:cdn/v20220501preview:Rule is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Rule to guarantee forwards compatibility.""")
