...
warnings.warn("""azure-native:cdn/v20220501preview:Rule is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Rule to guarantee forwards compatibility.""", DeprecationWarning)
...
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Rule is deprecated: azure-native:cdn/v20220501preview:Rule is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Rule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/v20200901:Rule"), pulumi.Alias(type_="azure-native:cdn/v20210601:Rule"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Rule")])
