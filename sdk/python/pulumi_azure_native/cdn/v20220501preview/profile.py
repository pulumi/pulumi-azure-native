...
warnings.warn("""azure-native:cdn/v20220501preview:Profile is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:Profile to guarantee forwards compatibility.""", DeprecationWarning)
