...
class Origin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 weight: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""Origin is deprecated: azure-native:cdn/v20220501preview:Origin is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Origin to guarantee forwards compatibility.""")
