...
warnings.warn("""azure-native:cdn/v20220501preview:AFDCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tls_settings: Optional[pulumi.Input[pulumi.InputType['AFDDomainHttpsParametersArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""AFDCustomDomain is deprecated: azure-native:cdn/v20220501preview:AFDCustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:AFDCustomDomain to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20210601:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDCustomDomain")])
