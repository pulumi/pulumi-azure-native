...
def get_rule(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rule is deprecated: azure-native:cdn/v20220501preview:Rule is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Rule to guarantee forwards compatibility.""")
    __args__ = dict()
