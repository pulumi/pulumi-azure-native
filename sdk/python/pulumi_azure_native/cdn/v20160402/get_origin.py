...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin is deprecated: Version v20160402 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
