...
def get_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: Version 2016-04-02 will be removed in v2 of the provider.
azure-native:cdn/v20160402:CustomDomain is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20161002:CustomDomain to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20160402:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult).value
