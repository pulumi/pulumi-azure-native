...
class OriginGroupArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ResourceReferenceArgs']]]]:
        """
    ...
    @origins.setter
    def origins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ResourceReferenceArgs']]]]):
...
class OriginGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 origin_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 origins: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourceReferenceArgs', 'ResourceReferenceArgsDict']]]]] = None,
                 profile_name: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 response_based_origin_error_detection_settings: pulumi.Input[Optional[Union['ResponseBasedOriginErrorDetectionParametersArgs', 'ResponseBasedOriginErrorDetectionParametersArgsDict']]] = None,
                 traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20191231:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200331:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200415:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200901:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20210601:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230501:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240201:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20240901:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20250101preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20250415:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20250601:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20250701preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20250901preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20251201:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20260401preview:OriginGroup")])
