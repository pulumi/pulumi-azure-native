...
warnings.warn("""azure-native:cdn/v20210601:Route is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Route to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: azure-native:cdn/v20210601:Route is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Route to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20210601:getRoute', __args__, opts=opts, typ=GetRouteResult).value
