...
def get_origin_group(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin_group is deprecated: azure-native:cdn/v20210601:OriginGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20210601:getOriginGroup', __args__, opts=opts, typ=GetOriginGroupResult).value
