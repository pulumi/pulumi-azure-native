...
def get_security_policy(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_policy is deprecated: azure-native:cdn/v20210601:SecurityPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:SecurityPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
