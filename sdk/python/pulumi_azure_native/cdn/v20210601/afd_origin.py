...
class AFDOrigin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20230501:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20230701preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20240201:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:AFDOrigin"), pulumi.Alias(type_="azure-native:cdn/v20240901:AFDOrigin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AFDOrigin, __self__).__init__(
            'azure-native:cdn/v20210601:AFDOrigin',
            resource_name,
            __props__,
            opts)
