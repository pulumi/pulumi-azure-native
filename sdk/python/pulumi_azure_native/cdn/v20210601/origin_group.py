...
warnings.warn("""azure-native:cdn/v20210601:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class OriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""OriginGroup is deprecated: azure-native:cdn/v20210601:OriginGroup is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:OriginGroup to guarantee forwards compatibility.""")
