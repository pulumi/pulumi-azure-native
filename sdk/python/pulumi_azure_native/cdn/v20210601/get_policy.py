...
def get_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy is deprecated: azure-native:cdn/v20210601:Policy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:Policy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyName'] = policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20210601:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
