...
warnings.warn("""azure-native:cdn/v20210601:SecurityPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20230501:SecurityPolicy to guarantee forwards compatibility.""", DeprecationWarning)
