...
def get_secret(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_secret is deprecated: azure-native:cdn/v20210601:Secret is being removed in the next major version of this provider. Please upgrade to azure-native:cdn/v20221101preview:Secret to guarantee forwards compatibility.""")
    __args__ = dict()
