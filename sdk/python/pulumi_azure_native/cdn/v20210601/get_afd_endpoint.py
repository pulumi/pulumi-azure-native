...
def get_afd_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_endpoint is deprecated: azure-native:cdn/v20210601:AFDEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:cdn/v20221101preview:AFDEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['endpointName'] = endpoint_name
    __args__['profileName'] = profile_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20210601:getAFDEndpoint', __args__, opts=opts, typ=GetAFDEndpointResult).value
