...
def get_key_group(key_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20230701preview:getKeyGroup', __args__, opts=opts, typ=GetKeyGroupResult).value
...
def get_key_group_output(key_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20230701preview:getKeyGroup', __args__, opts=opts, typ=GetKeyGroupResult)
