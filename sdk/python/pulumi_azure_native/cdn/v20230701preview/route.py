...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn/v20200901:Route"), pulumi.Alias(type_="azure-native:cdn/v20210601:Route"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20230501:Route"), pulumi.Alias(type_="azure-native:cdn/v20240201:Route"), pulumi.Alias(type_="azure-native:cdn/v20240501preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20240601preview:Route"), pulumi.Alias(type_="azure-native:cdn/v20240901:Route"), pulumi.Alias(type_="azure-native:cdn/v20250415:Route"), pulumi.Alias(type_="azure-native:cdn:Route")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Route, __self__).__init__(
            'azure-native:cdn/v20230701preview:Route',
            resource_name,
            __props__,
            opts)
