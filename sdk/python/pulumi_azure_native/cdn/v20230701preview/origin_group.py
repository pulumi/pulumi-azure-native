...
class OriginGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OriginGroupArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if health_probe_settings is not None and not isinstance(health_probe_settings, HealthProbeParametersArgs):
            ...
            if response_based_origin_error_detection_settings is not None and not isinstance(response_based_origin_error_detection_settings, ResponseBasedOriginErrorDetectionParametersArgs):
                response_based_origin_error_detection_settings = response_based_origin_error_detection_settings or {}
                def _setter(key, value):
                    response_based_origin_error_detection_settings[key] = value
                ResponseBasedOriginErrorDetectionParametersArgs._configure(_setter, **response_based_origin_error_detection_settings)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cdn:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20191231:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200331:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200415:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200901:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20210601:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20220501preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20221101preview:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20230501:OriginGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OriginGroup, __self__).__init__(
            'azure-native:cdn/v20230701preview:OriginGroup',
            resource_name,
            __props__,
            opts)
