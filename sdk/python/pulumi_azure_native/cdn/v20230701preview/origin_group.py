...
class OriginGroupArgs:
    ...
    def _configure(
        ...
        if origin_group_name is None and 'originGroupName' in kwargs:
...
class OriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            health_probe_settings = _utilities.configure(health_probe_settings, HealthProbeParametersArgs, True)
            ...
            response_based_origin_error_detection_settings = _utilities.configure(response_based_origin_error_detection_settings, ResponseBasedOriginErrorDetectionParametersArgs, True)
