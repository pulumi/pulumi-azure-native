...
class AFDOriginGroupArgs:
    ...
    def _configure(
        ...
        if session_affinity_state is None and 'sessionAffinityState' in kwargs:
...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            load_balancing_settings = _utilities.configure(load_balancing_settings, LoadBalancingSettingsParametersArgs, True)
