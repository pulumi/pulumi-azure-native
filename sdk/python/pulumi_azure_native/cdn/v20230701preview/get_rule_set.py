...
def get_rule_set(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20230701preview:getRuleSet', __args__, opts=opts, typ=GetRuleSetResult).value
...
def get_rule_set_output(profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleSetName'] = rule_set_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20230701preview:getRuleSet', __args__, opts=opts, typ=GetRuleSetResult)
