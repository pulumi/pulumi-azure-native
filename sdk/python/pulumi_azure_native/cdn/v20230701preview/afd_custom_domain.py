...
class AFDCustomDomainArgs:
    ...
    def _configure(
        ...
        if azure_dns_zone is None and 'azureDnsZone' in kwargs:
            azure_dns_zone = kwargs['azureDnsZone']
        ...
        if pre_validated_custom_domain_resource_id is None and 'preValidatedCustomDomainResourceId' in kwargs:
            pre_validated_custom_domain_resource_id = kwargs['preValidatedCustomDomainResourceId']
        if tls_settings is None and 'tlsSettings' in kwargs:
            tls_settings = kwargs['tlsSettings']
...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            azure_dns_zone = _utilities.configure(azure_dns_zone, ResourceReferenceArgs, True)
            ...
            pre_validated_custom_domain_resource_id = _utilities.configure(pre_validated_custom_domain_resource_id, ResourceReferenceArgs, True)
            ...
            tls_settings = _utilities.configure(tls_settings, AFDDomainHttpsParametersArgs, True)
        ...
        super(AFDCustomDomain, __self__).__init__(
            'azure-native:cdn/v20230701preview:AFDCustomDomain',
            resource_name,
            __props__,
            opts)
