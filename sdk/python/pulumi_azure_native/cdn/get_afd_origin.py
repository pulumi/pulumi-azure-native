...
class GetAFDOriginResult:
    ...
    def enforce_certificate_name_check(self) -> Optional[builtins.bool]:
        """
    ...
    def origin_group_name(self) -> builtins.str:
        """
...
def get_afd_origin(origin_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str origin_group_name: Name of the origin group which is unique within the profile.
    :param builtins.str origin_name: Name of the origin which is unique within the profile.
...
def get_afd_origin_output(origin_group_name: Optional[pulumi.Input[builtins.str]] = None,
