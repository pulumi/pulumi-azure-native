...
def get_route(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getRoute', __args__, opts=opts, typ=GetRouteResult)
