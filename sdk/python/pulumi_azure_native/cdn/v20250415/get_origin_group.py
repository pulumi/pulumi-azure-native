...
def get_origin_group(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getOriginGroup', __args__, opts=opts, typ=GetOriginGroupResult).value
...
def get_origin_group_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getOriginGroup', __args__, opts=opts, typ=GetOriginGroupResult)
