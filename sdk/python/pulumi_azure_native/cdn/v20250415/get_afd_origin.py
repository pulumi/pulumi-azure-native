...
def get_afd_origin(origin_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult).value
...
def get_afd_origin_output(origin_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult)
