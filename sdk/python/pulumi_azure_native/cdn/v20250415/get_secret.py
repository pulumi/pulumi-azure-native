...
def get_secret(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getSecret', __args__, opts=opts, typ=GetSecretResult).value
...
def get_secret_output(profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getSecret', __args__, opts=opts, typ=GetSecretResult)
