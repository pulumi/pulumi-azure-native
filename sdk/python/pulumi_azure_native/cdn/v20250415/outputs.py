...
class AFDDomainHttpsCustomizedCipherSuiteSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Customized cipher suite set object that will be used for Https when cipherSuiteSetType is Customized.
        :param Sequence[str] cipher_suite_set_for_tls12: Cipher suites for TLS 1.2. Required at least one in minimumTlsVersion TLS 1.2.
        :param Sequence[str] cipher_suite_set_for_tls13: Cipher suites for TLS 1.3. Required at least one in minimumTlsVersion TLS 1.2, TLS 1.3.
        """
