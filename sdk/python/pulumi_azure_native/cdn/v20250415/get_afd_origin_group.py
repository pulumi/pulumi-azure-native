...
def get_afd_origin_group(origin_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getAFDOriginGroup', __args__, opts=opts, typ=GetAFDOriginGroupResult).value
...
def get_afd_origin_group_output(origin_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getAFDOriginGroup', __args__, opts=opts, typ=GetAFDOriginGroupResult)
