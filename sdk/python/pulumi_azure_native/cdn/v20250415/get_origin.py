...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/v20250415:getOrigin', __args__, opts=opts, typ=GetOriginResult).value
...
def get_origin_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cdn/v20250415:getOrigin', __args__, opts=opts, typ=GetOriginResult)
