...
class AFDDomainHttpsParametersArgsDict(TypedDict):
    ...
    """
    customized_cipher_suite_set: NotRequired[pulumi.Input[Optional['AFDDomainHttpsCustomizedCipherSuiteSetArgs']]]
    """
    ...
    """
    secret: NotRequired[pulumi.Input[Optional['ResourceReferenceArgs']]]
    """
...
class AFDDomainHttpsParametersArgs:
    ...
    def certificate_type(self, value: pulumi.Input[Union[_builtins.str, 'AfdCertificateType']]):
...
class AfdRouteCacheConfigurationArgsDict(TypedDict):
    ...
    """
    compression_settings: NotRequired[pulumi.Input[Optional['CompressionSettingsArgs']]]
    """
...
class AgentPathArgs:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'AgentPathType']]):
...
class CacheExpirationActionParametersArgs:
    ...
    @cache_behavior.setter
    def cache_behavior(self, value: pulumi.Input[Union[_builtins.str, 'CacheBehavior']]):
        pulumi.set(self, "cache_behavior", value)
    ...
    @cache_type.setter
    def cache_type(self, value: pulumi.Input[Union[_builtins.str, 'CacheType']]):
...
class CacheKeyQueryStringActionParametersArgs:
    ...
    def query_string_behavior(self, value: pulumi.Input[Union[_builtins.str, 'QueryStringBehavior']]):
...
class ClientPortMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'ClientPortOperator']]):
...
class CookiesMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'CookiesOperator']]):
        pulumi.set(self, "operator", value)
...
class CustomRuleListArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CustomRuleArgs']]]]]
    """
    List of rules
    """
...
class CustomRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] priority: Defines in what order this rule be evaluated in the overall list of custom rules
...
class CustomerCertificateParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] use_latest_version: Whether to use the latest version for the certificate
        """
...
class DeepCreatedOriginGroupArgsDict(TypedDict):
    ...
    """
    health_probe_settings: NotRequired[pulumi.Input[Optional['HealthProbeParametersArgs']]]
    """
    Health probe settings to the origin that is used to determine the health of the origin.
    """
    response_based_origin_error_detection_settings: NotRequired[pulumi.Input[Optional['ResponseBasedOriginErrorDetectionParametersArgs']]]
    """
...
class HeaderActionParametersArgs:
    ...
    def header_action(self, value: pulumi.Input[Union[_builtins.str, 'HeaderAction']]):
...
class HostNameMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'HostNameOperator']]):
        pulumi.set(self, "operator", value)
...
class HttpVersionMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'HttpVersionOperator']]):
        pulumi.set(self, "operator", value)
...
class IsDeviceMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'IsDeviceOperator']]):
        pulumi.set(self, "operator", value)
...
class KeyVaultSigningKeyParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subscription_id: Subscription Id of the user's Key Vault containing the secret
        :param pulumi.Input[_builtins.str] vault_name: The name of the user's Key Vault containing the secret
        """
    ...
    @type_name.setter
    def type_name(self, value: pulumi.Input[Union[_builtins.str, 'KeyVaultSigningKeyParametersType']]):
        pulumi.set(self, "type_name", value)
...
class ManagedRuleGroupOverrideArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ManagedRuleOverrideArgs']]]]]
    """
...
class ManagedRuleSetListArgsDict(TypedDict):
    ...
    """
    managed_rule_sets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ManagedRuleSetArgs']]]]]
    """
    List of rule sets.
    """
...
class ManagedRuleSetArgsDict(TypedDict):
    ...
    """
    rule_group_overrides: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ManagedRuleGroupOverrideArgs']]]]]
    """
...
class MatchConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] selector: Selector can used to match a specific key for QueryString, Cookies, RequestHeader or PostArgs.
    ...
    def match_variable(self, value: pulumi.Input[Union[_builtins.str, 'WafMatchVariable']]):
...
class OriginAuthenticationPropertiesArgsDict(TypedDict):
    ...
    """
    user_assigned_identity: NotRequired[pulumi.Input[Optional['ResourceReferenceArgs']]]
    """
...
class OriginGroupOverrideArgsDict(TypedDict):
    ...
    """
    origin_group: NotRequired[pulumi.Input[Optional['ResourceReferenceArgs']]]
    """
...
class PolicySettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'PolicyEnabledState']] enabled_state: describes if the policy is in enabled state or disabled state
...
class PostArgsMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'PostArgsOperator']]):
        pulumi.set(self, "operator", value)
...
class ProfileLogScrubbingArgsDict(TypedDict):
    ...
    """
    scrubbing_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ProfileScrubbingRulesArgs']]]]]
    """
...
class QueryStringMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'QueryStringOperator']]):
        pulumi.set(self, "operator", value)
...
class RateLimitRuleListArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RateLimitRuleArgs']]]]]
    """
    List of rules
    """
...
class RateLimitRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Defines the name of the custom rule
        :param pulumi.Input[_builtins.int] priority: Defines in what order this rule be evaluated in the overall list of custom rules
        :param pulumi.Input[_builtins.int] rate_limit_duration_in_minutes: Defines rate limit duration. Default is 1 minute.
        :param pulumi.Input[_builtins.int] rate_limit_threshold: Defines rate limit threshold.
        :param pulumi.Input[Union[_builtins.str, 'CustomRuleEnabledState']] enabled_state: Describes if the custom rule is in enabled or disabled state. Defaults to Enabled if not specified.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "match_conditions", match_conditions)
    ...
    def rate_limit_duration_in_minutes(self, value: pulumi.Input[_builtins.int]):
    ...
    def rate_limit_threshold(self, value: pulumi.Input[_builtins.int]):
...
class RemoteAddressMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RemoteAddressOperator']]):
        pulumi.set(self, "operator", value)
...
class RequestBodyMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RequestBodyOperator']]):
        pulumi.set(self, "operator", value)
...
class RequestHeaderMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RequestHeaderOperator']]):
        pulumi.set(self, "operator", value)
...
class RequestMethodMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RequestMethodOperator']]):
        pulumi.set(self, "operator", value)
...
class RequestSchemeMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RequestSchemeMatchConditionParametersOperator']]):
        pulumi.set(self, "operator", value)
...
class RequestUriMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'RequestUriOperator']]):
        pulumi.set(self, "operator", value)
...
class ResponseBasedOriginErrorDetectionParametersArgsDict(TypedDict):
    ...
    """
    http_error_ranges: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['HttpErrorRangeParametersArgs']]]]]
    """
...
class RouteConfigurationOverrideActionParametersArgsDict(TypedDict):
    ...
    """
    cache_configuration: NotRequired[pulumi.Input[Optional['CacheConfigurationArgs']]]
    """
    The caching configuration associated with this rule. To disable caching, do not provide a cacheConfiguration object.
    """
    origin_group_override: NotRequired[pulumi.Input[Optional['OriginGroupOverrideArgs']]]
    """
...
class SecurityPolicyWebApplicationFirewallAssociationArgsDict(TypedDict):
    ...
    """
    domains: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ActivatedResourceReferenceArgs']]]]]
    """
    List of domains.
    """
...
class SecurityPolicyWebApplicationFirewallParametersArgsDict(TypedDict):
    ...
    """
    associations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SecurityPolicyWebApplicationFirewallAssociationArgs']]]]]
    """
    Waf associations
    """
    waf_policy: NotRequired[pulumi.Input[Optional['ResourceReferenceArgs']]]
    """
    Resource ID.
    """
...
class ServerPortMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'ServerPortOperator']]):
        pulumi.set(self, "operator", value)
...
class SharedPrivateLinkResourcePropertiesArgsDict(TypedDict):
    ...
    """
    private_link: NotRequired[pulumi.Input[Optional['ResourceReferenceArgs']]]
    """
...
class SocketAddrMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'SocketAddrOperator']]):
        pulumi.set(self, "operator", value)
...
class SslProtocolMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'SslProtocolOperator']]):
        pulumi.set(self, "operator", value)
...
class UrlFileExtensionMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'UrlFileExtensionOperator']]):
        pulumi.set(self, "operator", value)
...
class UrlFileNameMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'UrlFileNameOperator']]):
        pulumi.set(self, "operator", value)
...
class UrlPathMatchConditionParametersArgs:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, 'UrlPathOperator']]):
        pulumi.set(self, "operator", value)
...
class UrlSigningActionParametersArgsDict(TypedDict):
    ...
    """
    parameter_name_override: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['UrlSigningParamIdentifierArgs']]]]]
    """
...
class UrlSigningParamIdentifierArgs:
    ...
    def param_indicator(self, value: pulumi.Input[Union[_builtins.str, 'ParamIndicator']]):
