...
def get_afd_endpoint(endpoint_name: Optional[_builtins.str] = None,
...
def get_afd_endpoint_output(endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
