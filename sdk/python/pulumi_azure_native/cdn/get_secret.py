...
def get_secret(profile_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str secret_name: Name of the Secret under the profile.
    """
    __args__ = dict()
...
def get_secret_output(profile_name: Optional[pulumi.Input[_builtins.str]] = None,
