...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] rule_name: Name of the delivery rule which is unique within the endpoint.
        """
