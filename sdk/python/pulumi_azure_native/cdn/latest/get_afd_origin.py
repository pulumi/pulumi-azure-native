...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDOrigin'.""", DeprecationWarning)
...
def get_afd_origin(origin_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getAFDOrigin', __args__, opts=opts, typ=GetAFDOriginResult).value
