...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getProfileSupportedOptimizationTypes'.""", DeprecationWarning)
...
def get_profile_supported_optimization_types(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_profile_supported_optimization_types is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getProfileSupportedOptimizationTypes'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getProfileSupportedOptimizationTypes', __args__, opts=opts, typ=GetProfileSupportedOptimizationTypesResult).value
