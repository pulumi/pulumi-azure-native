...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getEndpoint'.""", DeprecationWarning)
...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_endpoint is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getEndpoint'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
