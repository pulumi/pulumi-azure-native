...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getSecret'.""", DeprecationWarning)
...
def get_secret(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getSecret', __args__, opts=opts, typ=GetSecretResult).value
