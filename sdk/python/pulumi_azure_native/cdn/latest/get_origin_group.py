...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getOriginGroup'.""", DeprecationWarning)
...
def get_origin_group(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_origin_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getOriginGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getOriginGroup', __args__, opts=opts, typ=GetOriginGroupResult).value
