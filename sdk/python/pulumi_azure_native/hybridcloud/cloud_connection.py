...
class CloudConnectionArgs:
    ...
    def _configure(
        ...
        if cloud_connection_name is None and 'cloudConnectionName' in kwargs:
            cloud_connection_name = kwargs['cloudConnectionName']
        if cloud_connector is None and 'cloudConnector' in kwargs:
            cloud_connector = kwargs['cloudConnector']
        if remote_resource_id is None and 'remoteResourceId' in kwargs:
            remote_resource_id = kwargs['remoteResourceId']
...
class CloudConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cloud_connector = _utilities.configure(cloud_connector, ResourceReferenceArgs, True)
            ...
            virtual_hub = _utilities.configure(virtual_hub, ResourceReferenceArgs, True)
