...
def get_cloud_connector(cloud_connector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_connector_name: The name of the cloud connector resource
...
def get_cloud_connector_output(cloud_connector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
