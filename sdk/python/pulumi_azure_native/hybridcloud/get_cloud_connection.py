...
def get_cloud_connection(cloud_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_connection_name: The name of the cloud connection resource
...
def get_cloud_connection_output(cloud_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
