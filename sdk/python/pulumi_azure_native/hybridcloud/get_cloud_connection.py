...
class GetCloudConnectionResult:
    ...
    def remote_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_cloud_connection(cloud_connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_connection_name: The name of the cloud connection resource
...
def get_cloud_connection_output(cloud_connection_name: Optional[pulumi.Input[builtins.str]] = None,
