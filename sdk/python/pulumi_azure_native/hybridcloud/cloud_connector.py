...
class CloudConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hybridcloud/v20230101preview:CloudConnector"), pulumi.Alias(type_="azure-native_hybridcloud_v20230101preview:hybridcloud:CloudConnector")])
