...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:purview/v20210701:Account"), pulumi.Alias(type_="azure-native:purview:Account"), pulumi.Alias(type_="azure-nextgen:purview:Account"), pulumi.Alias(type_="azure-native:purview/v20201201preview:Account"), pulumi.Alias(type_="azure-nextgen:purview/v20201201preview:Account")])
