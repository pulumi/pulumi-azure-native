...
def get_kafka_configuration(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:purview/v20230501preview:getKafkaConfiguration', __args__, opts=opts, typ=GetKafkaConfigurationResult).value
...
def get_kafka_configuration_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:purview/v20230501preview:getKafkaConfiguration', __args__, opts=opts, typ=GetKafkaConfigurationResult)
