...
class GetAccountResult:
    ...
    Account resource
    """
    def __init__(__self__, account_status=None, cloud_connectors=None, created_at=None, created_by=None, created_by_object_id=None, endpoints=None, friendly_name=None, id=None, identity=None, ingestion_storage=None, location=None, managed_event_hub_state=None, managed_resource_group_name=None, managed_resources=None, managed_resources_public_network_access=None, name=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, sku=None, system_data=None, tags=None, type=None):
...
def get_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:purview/v20230501preview:getAccount', __args__, opts=opts, typ=GetAccountResult).value
...
def get_account_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:purview/v20230501preview:getAccount', __args__, opts=opts, typ=GetAccountResult)
