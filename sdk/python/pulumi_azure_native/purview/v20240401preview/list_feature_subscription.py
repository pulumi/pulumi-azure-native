...
def list_feature_subscription(features: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:purview/v20240401preview:listFeatureSubscription', __args__, opts=opts, typ=ListFeatureSubscriptionResult).value
...
def list_feature_subscription_output(features: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __args__['locations'] = locations
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:purview/v20240401preview:listFeatureSubscription', __args__, opts=opts, typ=ListFeatureSubscriptionResult)
