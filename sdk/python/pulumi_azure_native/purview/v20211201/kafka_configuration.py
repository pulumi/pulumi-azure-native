...
class KafkaConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:purview:KafkaConfiguration"), pulumi.Alias(type_="azure-native:purview/v20230501preview:KafkaConfiguration")])
