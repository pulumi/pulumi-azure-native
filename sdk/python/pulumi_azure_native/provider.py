...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] environment: The Cloud Environment which should be used. Possible values are public, usgovernment, and china. Defaults to public.
