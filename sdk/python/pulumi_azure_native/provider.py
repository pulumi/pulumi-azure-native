...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] auxiliary_tenant_ids: Any additional Tenant IDs which should be used for authentication.
        :param pulumi.Input[builtins.str] client_certificate_password: The password associated with the Client Certificate. For use when authenticating as a Service Principal using a Client Certificate
        ...
        :param pulumi.Input[builtins.str] oidc_request_token: Your cloud service or provider’s bearer token to exchange for an OIDC ID token.
        :param pulumi.Input[builtins.str] oidc_request_url: The URL to initiate the `oidcRequestToken` OIDC token exchange.
        :param pulumi.Input[builtins.str] oidc_token: The OIDC token to exchange for an Azure token.
    ...
    def disable_pulumi_partner_id(self, value: Optional[pulumi.Input[builtins.bool]]):
