...
class OperatorApiConnectionArgs:
    def __init__(__self__, *,
                 account_type: pulumi.Input[Union[builtins.str, 'AccountType']],
                 gateway_id: pulumi.Input[builtins.str],
                 operator_api_plan_id: pulumi.Input[builtins.str],
                 ...
                 operator_api_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'AccountType']] account_type: Type of the account the user has with the Operator's Network API infrastructure. AzureManaged | UserManaged.
        :param pulumi.Input[builtins.str] gateway_id: Reference to the APC Gateway resource ID.
        :param pulumi.Input[builtins.str] operator_api_plan_id: Reference to the Operator API Plan Resource ID.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] app_id: Application ID of the App Developer that is registered with the Operator in a specific country/region.
        :param pulumi.Input[builtins.str] app_secret: Application secret linked to the 'appId'. This should be stored securely and is not returned back when the resource information is read.
        ...
        :param pulumi.Input[builtins.str] operator_api_connection_name: Azure Programmable Connectivity (APC) Operator API Connection Name.
    ...
    def account_type(self) -> pulumi.Input[Union[builtins.str, 'AccountType']]:
        """
    ...
    @account_type.setter
    def account_type(self, value: pulumi.Input[Union[builtins.str, 'AccountType']]):
    ...
    def operator_api_plan_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def operator_api_plan_id(self, value: pulumi.Input[builtins.str]):
    ...
    def operator_api_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operator_api_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OperatorApiConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_type: Optional[pulumi.Input[Union[builtins.str, 'AccountType']]] = None,
                 app_id: Optional[pulumi.Input[builtins.str]] = None,
                 app_secret: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 operator_api_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 operator_api_plan_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:programmableconnectivity/v20240115preview:OperatorApiConnection"), pulumi.Alias(type_="azure-native:programmableconnectivity/v20250330preview:OperatorApiConnection")])
    ...
    def camara_api_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="operatorApiPlanId")
    def operator_api_plan_id(self) -> pulumi.Output[builtins.str]:
        """
        Reference to the Operator API Plan Resource ID.
        """
        return pulumi.get(self, "operator_api_plan_id")
    ...
    def operator_name(self) -> pulumi.Output[builtins.str]:
        """
