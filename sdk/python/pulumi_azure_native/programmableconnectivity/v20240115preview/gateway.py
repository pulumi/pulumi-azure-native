...
class GatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] gateway_name: Azure Programmable Connectivity Gateway Name
...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:programmableconnectivity:Gateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gateway, __self__).__init__(
            'azure-native:programmableconnectivity/v20240115preview:Gateway',
            resource_name,
            __props__,
            opts)
    ...
    def gateway_base_url(self) -> pulumi.Output[str]:
        """
    ...
    def operator_api_connections(self) -> pulumi.Output[Sequence[str]]:
        """
