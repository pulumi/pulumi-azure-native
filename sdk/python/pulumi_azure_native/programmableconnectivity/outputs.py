...
class ApplicationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about the Application that would use the Operator's Network APIs.
        :param str application_description: Description of the application.
        :param str application_type: The category that describes the application.
        :param str legal_name: Legal name of the organization owning the application.
        :param str name: Name of the application. Example: Contoso App.
        :param str organization_description: A description of the organization owning the application.
        :param str privacy_contact_email_address: Email address of the Privacy contact or Data Protection officer of the organization.
        :param str tax_number: Unique Tax Number for the user's organization in the country/region the APC Gateway is being purchased.
        """
    ...
    def legal_name(self) -> Optional[str]:
        """
    ...
    def organization_description(self) -> Optional[str]:
        """
    ...
    def privacy_contact_email_address(self) -> Optional[str]:
        """
    ...
    def tax_number(self) -> Optional[str]:
        """
...
class SaasPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details about the SaaS offer purchased from the marketplace.
        :param str saas_resource_id: Resource ID of the SaaS offer purchased from the marketplace.
        :param str saas_subscription_id: Subscription ID of the SaaS offer purchased from the marketplace.
        """
    ...
    def saas_resource_id(self) -> Optional[str]:
        """
...
class StatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Description of the current status of the OperatorApiConnection resource.
        :param str reason: Explanation of the current state of the OperatorApiConnection resource.
        :param str state: Current state of the OperatorApiConnection resource.
        """
