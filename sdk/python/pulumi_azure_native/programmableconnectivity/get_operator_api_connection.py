...
def get_operator_api_connection(operator_api_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str operator_api_connection_name: Azure Programmable Connectivity (APC) Operator API Connection Name.
...
def get_operator_api_connection_output(operator_api_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
