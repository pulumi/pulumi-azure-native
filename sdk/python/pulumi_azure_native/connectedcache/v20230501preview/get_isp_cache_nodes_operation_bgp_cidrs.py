...
def get_isp_cache_nodes_operation_bgp_cidrs(cache_node_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedcache/v20230501preview:getIspCacheNodesOperationBgpCidrs', __args__, opts=opts, typ=GetIspCacheNodesOperationBgpCidrsResult).value
