...
def get_isp_cache_nodes_operation_cache_node_install_details(cache_node_resource_name: Optional[_builtins.str] = None,
                                                             customer_resource_name: Optional[_builtins.str] = None,
