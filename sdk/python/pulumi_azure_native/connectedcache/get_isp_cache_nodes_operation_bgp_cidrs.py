...
def get_isp_cache_nodes_operation_bgp_cidrs(cache_node_resource_name: Optional[builtins.str] = None,
...
def get_isp_cache_nodes_operation_bgp_cidrs_output(cache_node_resource_name: Optional[pulumi.Input[builtins.str]] = None,
