...
def get_enterprise_mcc_cache_nodes_operation(cache_node_resource_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:connectedcache:getEnterpriseMccCacheNodesOperation', __args__, opts=opts, typ=GetEnterpriseMccCacheNodesOperationResult).value
...
def get_enterprise_mcc_cache_nodes_operation_output(cache_node_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
