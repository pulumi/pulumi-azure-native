...
class AdditionalCacheNodePropertiesArgsDict(TypedDict):
    ...
    """
    bgp_configuration: NotRequired[pulumi.Input[Optional['BgpConfigurationArgs']]]
    """
    ...
    """
    drive_configuration: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CacheNodeDriveConfigurationArgs']]]]]
    """
    ...
    """
    proxy_url_configuration: NotRequired[pulumi.Input[Optional['ProxyUrlConfigurationArgs']]]
    """
...
class AdditionalCacheNodePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ProxyRequired']] is_proxy_required: Cache node resource requires a proxy
        :param pulumi.Input[_builtins.str] optional_property1: Optional property #1 of Mcc response object
        :param pulumi.Input[_builtins.str] optional_property2: Optional property #2 of Mcc response object
        :param pulumi.Input[_builtins.str] optional_property3: Optional property #3 of Mcc response object
        :param pulumi.Input[_builtins.str] optional_property4: Optional property #4 of Mcc response object
        :param pulumi.Input[_builtins.str] optional_property5: Optional property #5 of Mcc response object
        :param pulumi.Input[Union[_builtins.str, 'OsType']] os_type: Operating system of the cache node
        :param pulumi.Input[_builtins.str] proxy_url: Cache node resource Mcc proxy Url
        :param pulumi.Input['ProxyUrlConfigurationArgs'] proxy_url_configuration: proxyUrl configuration of the cache node
        :param pulumi.Input[Union[_builtins.str, 'CycleType']] update_cycle_type: Update Cycle Type
        :param pulumi.Input[_builtins.str] update_info_details: Update related information details
        :param pulumi.Input[_builtins.str] update_requested_date_time: customer requested date time for mcc install of update cycle
        """
...
class AdditionalCustomerPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] customer_entitlement_sku_guid: Customer resource entitlement Sku Guid.
        :param pulumi.Input[_builtins.str] customer_entitlement_sku_id: Customer resource entitlement Sku Id.
        :param pulumi.Input[_builtins.str] customer_entitlement_sku_name: Customer resource entitlement Sku name.
        :param pulumi.Input[_builtins.str] customer_transit_asn: Customer resource transit Asn (autonomous system number).
        :param pulumi.Input[Union[_builtins.str, 'CustomerTransitState']] customer_transit_state: Customer resource transit state.
        :param pulumi.Input[_builtins.str] optional_property1: Optional property #1 of Mcc response object.
        :param pulumi.Input[_builtins.str] optional_property2: Optional property #2 of Mcc response object.
        :param pulumi.Input[_builtins.str] optional_property3: Optional property #3 of Mcc response object.
        :param pulumi.Input[_builtins.str] optional_property4: Optional property #4 of Mcc response object.
...
class CacheNodeDriveConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] size_in_gb: physical size of the drive used for caching content
        """
...
class CacheNodeEntityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'AutoUpdateRingType']] auto_update_ring_type: Auto Update Ring Type which is slow or fast etc.
        :param pulumi.Input[_builtins.str] cache_node_id: Cache node resource identifier of the cache node
        :param pulumi.Input[_builtins.str] cache_node_name: Cache node resource name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cidr_csv: Cache node resource comma separated values of Cidrs.
        :param pulumi.Input[_builtins.int] cidr_selection_type: Cache node resource current Cidr range precedence selection type.
        :param pulumi.Input[_builtins.int] customer_asn: Cache node resource customer resource Asn (autonomous system number)
        :param pulumi.Input[_builtins.str] customer_index: Cache node resource customer index as string.
        :param pulumi.Input[_builtins.str] customer_name: Cache node resource customer resource name.
        :param pulumi.Input[_builtins.str] fully_qualified_domain_name: FQDN(fully qualified domain name) value of the mcc cache node
        :param pulumi.Input[_builtins.str] fully_qualified_resource_id: Cache node resource Azure fully qualified resource Id.
        :param pulumi.Input[_builtins.str] ip_address: Cache node resource Ip address.
        :param pulumi.Input[_builtins.bool] is_enabled: Cache node resource flag for indicating if cache node is enabled.
        :param pulumi.Input[_builtins.bool] is_enterprise_managed: Cache node resource flag for determining if managed by enterprise as boolean.
        :param pulumi.Input[_builtins.int] max_allowable_egress_in_mbps: Cache node resource maximum allowed egress in Mbps.
        :param pulumi.Input[_builtins.bool] should_migrate: Cache node resource flag for determining if customer will be migrated.
        """
...
class CacheNodePropertyArgsDict(TypedDict):
    ...
    """
    additional_cache_node_properties: NotRequired[pulumi.Input[Optional['AdditionalCacheNodePropertiesArgs']]]
    """
    Mcc cache node resource additional properties.
    """
    cache_node: NotRequired[pulumi.Input[Optional['CacheNodeEntityArgs']]]
    """
...
class CacheNodePropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status_details: Mcc response status details for retrieving response inner details.
        :param pulumi.Input[_builtins.str] status_text: Mcc response status text as string for retrieving status details.
        """
...
class CustomerEntityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] contact_phone: Customer resource contact phone.
        :param pulumi.Input[_builtins.str] customer_name: Customer resource name.
        :param pulumi.Input[_builtins.str] fully_qualified_resource_id: Customer resource Azure fully qualified resource Id.
        :param pulumi.Input[_builtins.bool] is_enterprise_managed: Customer resource flag for enterprise management as boolean.
        :param pulumi.Input[_builtins.bool] is_entitled: Customer resource entitlement flag as boolean.
        :param pulumi.Input[_builtins.int] release_version: Customer resource Mcc release version.
        :param pulumi.Input[_builtins.bool] resend_signup_code: Customer resource flag for resending signup code as boolean.
        :param pulumi.Input[_builtins.bool] should_migrate: Customer resource flag for migration.
        :param pulumi.Input[_builtins.bool] verify_signup_code: Customer resource flag for requiring verification of signup code as boolean.
        :param pulumi.Input[_builtins.str] verify_signup_phrase: Customer resource phrase for verifying signup.
        """
...
class CustomerPropertyArgsDict(TypedDict):
    ...
    """
    additional_customer_properties: NotRequired[pulumi.Input[Optional['AdditionalCustomerPropertiesArgs']]]
    """
    Mcc customer resource additional properties.
    """
    customer: NotRequired[pulumi.Input[Optional['CustomerEntityArgs']]]
    """
