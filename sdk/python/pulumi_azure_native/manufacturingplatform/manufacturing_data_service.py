...
class ManufacturingDataServiceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['MdsResourcePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['MdsResourcePropertiesArgs']]):
...
class ManufacturingDataService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 mds_resource_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['MdsResourcePropertiesArgs', 'MdsResourcePropertiesArgsDict']]] = None,
