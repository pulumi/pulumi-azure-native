...
def list_manufacturing_data_service_available_versions(mds_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:manufacturingplatform/v20250301:listManufacturingDataServiceAvailableVersions', __args__, opts=opts, typ=ListManufacturingDataServiceAvailableVersionsResult).value
...
def list_manufacturing_data_service_available_versions_output(mds_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:manufacturingplatform/v20250301:listManufacturingDataServiceAvailableVersions', __args__, opts=opts, typ=ListManufacturingDataServiceAvailableVersionsResult)
