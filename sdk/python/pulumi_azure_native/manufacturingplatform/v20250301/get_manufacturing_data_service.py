...
def get_manufacturing_data_service(mds_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:manufacturingplatform/v20250301:getManufacturingDataService', __args__, opts=opts, typ=GetManufacturingDataServiceResult).value
...
def get_manufacturing_data_service_output(mds_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:manufacturingplatform/v20250301:getManufacturingDataService', __args__, opts=opts, typ=GetManufacturingDataServiceResult)
