...
def get_manufacturing_data_service(mds_resource_name: Optional[builtins.str] = None,
...
def get_manufacturing_data_service_output(mds_resource_name: Optional[pulumi.Input[builtins.str]] = None,
