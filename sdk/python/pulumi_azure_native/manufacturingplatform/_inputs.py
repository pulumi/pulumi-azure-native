...
class CmkProfileArgs:
    ...
    @key_uri.setter
    def key_uri(self, value: pulumi.Input[_builtins.str]):
...
class FabricProfileArgs:
    ...
    def one_lake_path(self, value: pulumi.Input[_builtins.str]):
    ...
    @one_lake_uri.setter
    def one_lake_uri(self, value: pulumi.Input[_builtins.str]):
...
class MdsResourcePropertiesArgsDict(TypedDict):
    ...
    AKS Admin Group Id.
    """
    cmk_profile: NotRequired[pulumi.Input[Optional['CmkProfileArgs']]]
    """
    Profile of CMK Settings.
    """
    deny_assignment_exclusions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DenyAssignmentExclusionArgs']]]]]
    """
    ...
    """
    fabric_profile: NotRequired[pulumi.Input[Optional['FabricProfileArgs']]]
    """
    Profile of Fabric resources.
    """
    open_ai_profile: NotRequired[pulumi.Input[Optional['OpenAIProfileArgs']]]
    """
    ...
    """
    user_managed_open_ai_profile: NotRequired[pulumi.Input[Optional['UserManagedOpenAIProfileArgs']]]
    """
...
class MdsResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_copilot: Enable Copilot.
        :param pulumi.Input[_builtins.bool] enable_diagnostic_settings: Enable Diagnostic Settings.
        ...
        :param pulumi.Input[Union[_builtins.str, 'RedundancyState']] redundancy_state: Zone redundancy state for resources
        :param pulumi.Input[Union[_builtins.str, 'ResourceState']] resource_state: State of the resource
        :param pulumi.Input['UserManagedOpenAIProfileArgs'] user_managed_open_ai_profile: Profile of User Managed OpenAI Resource.
        :param pulumi.Input[_builtins.str] version: Mds Resource Version.
        """
    ...
    def aad_application_id(self, value: pulumi.Input[_builtins.str]):
...
class OpenAIProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] embedding_model_version: Embedding Model Version
        :param pulumi.Input[_builtins.int] gpt_model_capacity: GPT Model Capacity
        :param pulumi.Input[_builtins.str] gpt_model_name: GPT Model Name
        :param pulumi.Input[_builtins.str] gpt_model_sku_name: GPT Model SKU Name
        :param pulumi.Input[_builtins.str] gpt_model_version: GPT Model Version
        """
...
class UserManagedOpenAIProfileArgs:
    ...
    def embedding_model_deployment_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def gpt_model_deployment_name(self, value: pulumi.Input[_builtins.str]):
