...
class JobCollectionArgs:
    def __init__(__self__, *,
                 ...
                 job_collection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] job_collection_name: The job collection name.
        :param pulumi.Input[builtins.str] location: Gets or sets the storage account location.
        :param pulumi.Input[builtins.str] name: Gets or sets the job collection resource name.
        :param pulumi.Input['JobCollectionPropertiesArgs'] properties: Gets or sets the job collection properties.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Gets or sets the tags.
        """
    ...
    def job_collection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def job_collection_name(self, value: Optional[pulumi.Input[builtins.str]]):
