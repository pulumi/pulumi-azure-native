...
def get_job_collection(job_collection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_collection is deprecated: Version 2014-08-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['jobCollectionName'] = job_collection_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:scheduler/v20140801preview:getJobCollection', __args__, opts=opts, typ=GetJobCollectionResult).value
