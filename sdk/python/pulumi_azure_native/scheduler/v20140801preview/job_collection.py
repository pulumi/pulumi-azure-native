...
warnings.warn("""Version 2014-08-01-preview will be removed in v2 of the provider.
azure-native:scheduler/v20140801preview:JobCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:scheduler/v20160301:JobCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:scheduler/v20140801preview:JobCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:scheduler/v20160301:JobCollection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scheduler:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20160101:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20160301:JobCollection")])
