...
class BasicAuthenticationResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Gets or sets the HTTP authentication type.
               Expected value is 'Basic'.
        :param builtins.str password: Gets or sets the password, return value will always be empty.
        :param builtins.str username: Gets or sets the username.
        """
...
class ClientCertAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 certificate_expiration_date: Optional[builtins.str] = None,
                 certificate_subject_name: Optional[builtins.str] = None,
                 certificate_thumbprint: Optional[builtins.str] = None,
                 password: Optional[builtins.str] = None,
                 pfx: Optional[builtins.str] = None):
        """
        :param builtins.str type: Gets or sets the HTTP authentication type.
               Expected value is 'ClientCertificate'.
        :param builtins.str certificate_expiration_date: Gets or sets the certificate expiration date.
        :param builtins.str certificate_subject_name: Gets or sets the certificate subject name.
        :param builtins.str certificate_thumbprint: Gets or sets the certificate thumbprint.
        :param builtins.str password: Gets or sets the certificate password, return value will always be empty.
        :param builtins.str pfx: Gets or sets the pfx certificate. Accepts certification in base64 encoding, return value will always be empty.
        """
    ...
    def certificate_expiration_date(self) -> Optional[builtins.str]:
        """
    ...
    def certificate_subject_name(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def pfx(self) -> Optional[builtins.str]:
        """
...
class HttpRequestResponse(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str body: Gets or sets the request body.
        :param Mapping[str, builtins.str] headers: Gets or sets the headers.
        :param builtins.str method: Gets or sets the method of the request.
        :param builtins.str uri: Gets or sets the URI of the request.
        """
...
class JobActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Gets or sets the job action type.
        """
...
class JobCollectionPropertiesResponse(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str state: Gets or sets the state.
        """
...
class JobCollectionQuotaResponse(dict):
    ...
    def __init__(__self__, *,
                 max_job_count: Optional[builtins.int] = None,
                 max_job_occurrence: Optional[builtins.int] = None,
                 max_recurrence: Optional['outputs.JobMaxRecurrenceResponse'] = None):
        """
        :param builtins.int max_job_count: Gets or set the maximum job count.
        :param builtins.int max_job_occurrence: Gets or sets the maximum job occurrence.
    ...
    def max_job_occurrence(self) -> Optional[builtins.int]:
        """
...
class JobErrorActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ServiceBusQueueMessageResponse' service_bus_queue_message: Gets or sets the service bus queue message.
        :param 'ServiceBusTopicMessageResponse' service_bus_topic_message: Gets or sets the service bus topic message.
        :param builtins.str type: Gets or sets the job error action type.
        """
        if queue_message is not None:
            pulumi.set(__self__, "queue_message", queue_message)
        if request is not None:
...
class JobMaxRecurrenceResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str frequency: Gets or sets the frequency of recurrence (second, minute, hour, day, week, month).
        :param builtins.int interval: Gets or sets the interval between retries.
        """
...
class JobPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str start_time: Gets or sets the job start time.
        :param builtins.str state: Gets or set the job state.
        """
...
class JobRecurrenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: Gets or sets the maximum number of times that the job should run.
        :param builtins.str end_time: Gets or sets the time at which the job will complete.
        :param builtins.str frequency: Gets or sets the frequency of recurrence (second, minute, hour, day, week, month).
        :param builtins.int interval: Gets or sets the interval between retries.
        """
...
class JobRecurrenceScheduleMonthlyOccurrenceResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day: Gets or sets the day. Must be one of monday, tuesday, wednesday, thursday, friday, saturday, sunday.
        :param builtins.int occurrence: Gets or sets the occurrence. Must be between -5 and 5.
        """
        if day is not None:
...
class JobRecurrenceScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.int] hours: Gets or sets the hours of the day that the job should execute at.
        :param Sequence[builtins.int] minutes: Gets or sets the minutes of the hour that the job should execute at.
        :param Sequence[builtins.int] month_days: Gets or sets the days of the month that the job should execute on. Must be between 1 and 31.
        ...
        :param Sequence[builtins.str] week_days: Gets or sets the days of the week that the job should execute on.
        """
...
class JobStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 faulted_count: builtins.int,
                 last_execution_time: builtins.str,
                 next_execution_time: builtins.str):
        """
        :param builtins.int execution_count: Gets the number of times this job has executed.
        :param builtins.int failure_count: Gets the number of times this job has failed.
        :param builtins.int faulted_count: Gets the number of faulted occurrences (occurrences that were retried and failed as many times as the retry policy states).
        :param builtins.str last_execution_time: Gets the time the last occurrence executed in ISO-8601 format.  Could be empty if job has not run yet.
        :param builtins.str next_execution_time: Gets the time of the next occurrence in ISO-8601 format. Could be empty if the job is completed.
        """
    ...
    def faulted_count(self) -> builtins.int:
        """
...
class OAuthAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str audience: Gets or sets the audience.
        :param builtins.str client_id: Gets or sets the client identifier.
        :param builtins.str secret: Gets or sets the secret, return value will always be empty.
        :param builtins.str tenant: Gets or sets the tenant.
        """
...
class RetryPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retry_interval: Optional[builtins.str] = None,
                 retry_type: Optional[builtins.str] = None):
        """
        :param builtins.int retry_count: Gets or sets the number of times a retry should be attempted.
        :param builtins.str retry_interval: Gets or sets the retry interval between retries, specify duration in ISO 8601 format.
        :param builtins.str retry_type: Gets or sets the retry strategy to be used.
        """
    ...
    def retry_interval(self) -> Optional[builtins.str]:
        """
    ...
    def retry_type(self) -> Optional[builtins.str]:
        """
...
class ServiceBusAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str sas_key: Gets or sets the SAS key.
        :param builtins.str sas_key_name: Gets or sets the SAS key name.
        :param builtins.str type: Gets or sets the authentication type.
        """
...
class ServiceBusBrokeredMessagePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 force_persistence: Optional[builtins.bool] = None,
                 ...
                 scheduled_enqueue_time_utc: Optional[builtins.str] = None,
                 session_id: Optional[builtins.str] = None,
                 time_to_live: Optional[builtins.str] = None,
                 to: Optional[builtins.str] = None,
                 via_partition_key: Optional[builtins.str] = None):
        """
        :param builtins.str content_type: Gets or sets the content type.
        :param builtins.str correlation_id: Gets or sets the correlation ID.
        :param builtins.bool force_persistence: Gets or sets the force persistence.
        :param builtins.str label: Gets or sets the label.
        :param builtins.str message_id: Gets or sets the message ID.
        :param builtins.str partition_key: Gets or sets the partition key.
        :param builtins.str reply_to: Gets or sets the reply to.
        :param builtins.str reply_to_session_id: Gets or sets the reply to session ID.
        :param builtins.str scheduled_enqueue_time_utc: Gets or sets the scheduled enqueue time UTC.
        :param builtins.str session_id: Gets or sets the session ID.
        :param builtins.str time_to_live: Gets or sets the time to live.
        :param builtins.str to: Gets or sets the to.
        :param builtins.str via_partition_key: Gets or sets the via partition key.
        """
    ...
    def force_persistence(self) -> Optional[builtins.bool]:
        """
    ...
    def scheduled_enqueue_time_utc(self) -> Optional[builtins.str]:
        """
    ...
    def via_partition_key(self) -> Optional[builtins.str]:
        """
...
class ServiceBusQueueMessageResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_message_properties: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param Mapping[str, builtins.str] custom_message_properties: Gets or sets the custom message properties.
        :param builtins.str message: Gets or sets the message.
        :param builtins.str namespace: Gets or sets the namespace.
        :param builtins.str queue_name: Gets or sets the queue name.
        :param builtins.str transport_type: Gets or sets the transport type.
        """
        if authentication is not None:
            pulumi.set(__self__, "authentication", authentication)
    ...
    def custom_message_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ServiceBusTopicMessageResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 message: Optional[builtins.str] = None,
                 namespace: Optional[builtins.str] = None,
                 topic_path: Optional[builtins.str] = None,
                 transport_type: Optional[builtins.str] = None):
        """
        :param 'ServiceBusAuthenticationResponse' authentication: Gets or sets the Service Bus authentication.
        :param 'ServiceBusBrokeredMessagePropertiesResponse' brokered_message_properties: Gets or sets the brokered message properties.
        ...
        :param builtins.str message: Gets or sets the message.
        :param builtins.str namespace: Gets or sets the namespace.
        :param builtins.str topic_path: Gets or sets the topic path.
        :param builtins.str transport_type: Gets or sets the transport type.
        """
        if authentication is not None:
            pulumi.set(__self__, "authentication", authentication)
    ...
    def topic_path(self) -> Optional[builtins.str]:
        """
...
class SkuResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Gets or set the SKU.
        """
        if name is not None:
...
class StorageQueueMessageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str message: Gets or sets the message.
        :param builtins.str queue_name: Gets or sets the queue name.
        :param builtins.str sas_token: Gets or sets the SAS key.
        :param builtins.str storage_account: Gets or sets the storage account name.
        """
        if message is not None:
            pulumi.set(__self__, "message", message)
        if queue_name is not None:
