...
def get_job_collection(job_collection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_collection is deprecated: Version v20160101 will be removed in the next major version of the provider. Upgrade to version v20160301 or later.""")
    __args__ = dict()
