...
azure-native:scheduler/v20160101:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:scheduler/v20160301:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(job_collection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: Version 2016-01-01 will be removed in v2 of the provider.
azure-native:scheduler/v20160101:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:scheduler/v20160301:Job to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scheduler/v20160101:getJob', __args__, opts=opts, typ=GetJobResult).value
