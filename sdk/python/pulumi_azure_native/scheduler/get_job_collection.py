...
def get_job_collection(job_collection_name: Optional[_builtins.str] = None,
...
def get_job_collection_output(job_collection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
