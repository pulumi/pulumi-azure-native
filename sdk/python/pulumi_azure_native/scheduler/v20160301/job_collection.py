...
class JobCollectionArgs:
    ...
    def _configure(
        ...
        if job_collection_name is None and 'jobCollectionName' in kwargs:
            job_collection_name = kwargs['jobCollectionName']
...
class JobCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, JobCollectionPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scheduler:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20140801preview:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20160101:JobCollection")])
