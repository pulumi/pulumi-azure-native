...
class JobArgs:
    def __init__(__self__, *,
                 job_collection_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] job_name: The job name.
    ...
    def job_collection_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def job_collection_name(self, value: pulumi.Input[builtins.str]):
...
class Job(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:scheduler:Job"
