...
warnings.warn("""azure-native:signalrservice/v20200701preview:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r is deprecated: azure-native:signalrservice/v20200701preview:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.""")
    __args__ = dict()
