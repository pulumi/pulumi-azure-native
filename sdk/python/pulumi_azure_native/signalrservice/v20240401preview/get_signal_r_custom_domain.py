...
def get_signal_r_custom_domain(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/v20240401preview:getSignalRCustomDomain', __args__, opts=opts, typ=GetSignalRCustomDomainResult).value
...
def get_signal_r_custom_domain_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice/v20240401preview:getSignalRCustomDomain', __args__, opts=opts, typ=GetSignalRCustomDomainResult)
