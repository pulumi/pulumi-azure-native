...
def get_signal_r_custom_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/v20240401preview:getSignalRCustomCertificate', __args__, opts=opts, typ=GetSignalRCustomCertificateResult).value
...
def get_signal_r_custom_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice/v20240401preview:getSignalRCustomCertificate', __args__, opts=opts, typ=GetSignalRCustomCertificateResult)
