...
def get_signal_r_shared_private_link_resource(resource_group_name: Optional[_builtins.str] = None,
...
def get_signal_r_shared_private_link_resource_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice:getSignalRSharedPrivateLinkResource', __args__, opts=opts, typ=GetSignalRSharedPrivateLinkResourceResult)
