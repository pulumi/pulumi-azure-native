...
def get_signal_r_shared_private_link_resource(resource_group_name: Optional[builtins.str] = None,
...
def get_signal_r_shared_private_link_resource_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
