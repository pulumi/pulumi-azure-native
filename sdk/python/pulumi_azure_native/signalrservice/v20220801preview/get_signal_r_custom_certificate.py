...
def get_signal_r_custom_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice/v20220801preview:getSignalRCustomCertificate', __args__, opts=opts, typ=GetSignalRCustomCertificateResult)
