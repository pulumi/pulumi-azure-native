...
warnings.warn("""azure-native:signalrservice/v20220801preview:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230201:SignalRCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class SignalRCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SignalRCustomDomain is deprecated: azure-native:signalrservice/v20220801preview:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230201:SignalRCustomDomain to guarantee forwards compatibility.""")
