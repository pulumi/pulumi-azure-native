...
warnings.warn("""azure-native:signalrservice/v20220801preview:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
class SignalRCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SignalRCustomDomain is deprecated: azure-native:signalrservice/v20220801preview:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomDomain to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20220201:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20230201:SignalRCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SignalRCustomDomain, __self__).__init__(
            'azure-native:signalrservice/v20220801preview:SignalRCustomDomain',
            resource_name,
            __props__,
            opts)
