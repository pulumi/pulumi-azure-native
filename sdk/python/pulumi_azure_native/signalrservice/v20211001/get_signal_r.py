...
warnings.warn("""azure-native:signalrservice/v20211001:SignalR is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalR to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r is deprecated: azure-native:signalrservice/v20211001:SignalR is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalR to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/v20211001:getSignalR', __args__, opts=opts, typ=GetSignalRResult).value
