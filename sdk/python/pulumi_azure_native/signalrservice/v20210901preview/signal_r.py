...
warnings.warn("""azure-native:signalrservice/v20210901preview:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.""", DeprecationWarning)
...
class SignalR(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 upstream: Optional[pulumi.Input[pulumi.InputType['ServerlessUpstreamSettingsArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""SignalR is deprecated: azure-native:signalrservice/v20210901preview:SignalR is being removed in the next major version of this provider. Please upgrade to azure-native:signalrservice/v20230201:SignalR to guarantee forwards compatibility.""")
