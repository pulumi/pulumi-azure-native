...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/v20240801preview:getSignalR', __args__, opts=opts, typ=GetSignalRResult).value
...
def get_signal_r_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice/v20240801preview:getSignalR', __args__, opts=opts, typ=GetSignalRResult)
