...
def get_signal_r_custom_domain(name: Optional[_builtins.str] = None,
...
def get_signal_r_custom_domain_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
