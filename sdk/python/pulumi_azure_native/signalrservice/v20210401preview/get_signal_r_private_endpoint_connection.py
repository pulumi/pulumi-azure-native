...
def get_signal_r_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r_private_endpoint_connection is deprecated: azure-native:signalrservice/v20210401preview:SignalRPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230201:SignalRPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
