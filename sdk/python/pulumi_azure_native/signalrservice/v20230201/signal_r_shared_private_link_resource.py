...
class SignalRSharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        signal_r_shared_private_link_resource = azure_native.signalrservice.v20230201.SignalRSharedPrivateLinkResource("signalRSharedPrivateLinkResource",
            group_id="sites",
        ...
        ```sh
        $ pulumi import azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource upstream /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService/privateEndpointConnections/upstream 
        ```
