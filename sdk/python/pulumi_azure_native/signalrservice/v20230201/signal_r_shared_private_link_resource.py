...
class SignalRSharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice:SignalRSharedPrivateLinkResource"), pulumi.Alias(type_="azure-native:signalrservice/v20210401preview:SignalRSharedPrivateLinkResource"), pulumi.Alias(type_="azure-native:signalrservice/v20220201:SignalRSharedPrivateLinkResource"), pulumi.Alias(type_="azure-native:signalrservice/v20230301preview:SignalRSharedPrivateLinkResource")])
