...
class SignalRArgs:
    ...
    def _configure(
        ...
        if disable_aad_auth is None and 'disableAadAuth' in kwargs:
            disable_aad_auth = kwargs['disableAadAuth']
        if disable_local_auth is None and 'disableLocalAuth' in kwargs:
            disable_local_auth = kwargs['disableLocalAuth']
        if live_trace_configuration is None and 'liveTraceConfiguration' in kwargs:
            live_trace_configuration = kwargs['liveTraceConfiguration']
        ...
        if resource_log_configuration is None and 'resourceLogConfiguration' in kwargs:
            resource_log_configuration = kwargs['resourceLogConfiguration']
...
class SignalR(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cors = _utilities.configure(cors, SignalRCorsSettingsArgs, True)
            ...
            live_trace_configuration = _utilities.configure(live_trace_configuration, LiveTraceConfigurationArgs, True)
            __props__.__dict__["live_trace_configuration"] = live_trace_configuration
            __props__.__dict__["location"] = location
            network_acls = _utilities.configure(network_acls, SignalRNetworkACLsArgs, True)
            ...
            resource_log_configuration = _utilities.configure(resource_log_configuration, ResourceLogConfigurationArgs, True)
            __props__.__dict__["resource_log_configuration"] = resource_log_configuration
            __props__.__dict__["resource_name"] = resource_name_
            serverless = _utilities.configure(serverless, ServerlessSettingsArgs, True)
            __props__.__dict__["serverless"] = serverless
            sku = _utilities.configure(sku, ResourceSkuArgs, True)
            __props__.__dict__["sku"] = sku
            __props__.__dict__["tags"] = tags
            tls = _utilities.configure(tls, SignalRTlsSettingsArgs, True)
            __props__.__dict__["tls"] = tls
            upstream = _utilities.configure(upstream, ServerlessUpstreamSettingsArgs, True)
