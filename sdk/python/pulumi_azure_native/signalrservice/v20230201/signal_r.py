...
class SignalR(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 serverless: Optional[pulumi.Input[pulumi.InputType['ServerlessSettingsArgs']]] = None,
        ...
        signal_r = azure_native.signalrservice.v20230201.SignalR("signalR",
            cors=azure_native.signalrservice.v20230201.SignalRCorsSettingsArgs(
                allowed_origins=[
                    "https://foo.com",
                    "https://bar.com",
                ],
            ...
            identity=azure_native.signalrservice.v20230201.ManagedIdentityArgs(
                type="SystemAssigned",
            ),
            kind="SignalR",
            live_trace_configuration=azure_native.signalrservice.v20230201.LiveTraceConfigurationResponseArgs(
                categories=[azure_native.signalrservice.v20230201.LiveTraceCategoryArgs(
                    enabled="true",
            ...
            location="eastus",
            network_acls=azure_native.signalrservice.v20230201.SignalRNetworkACLsResponseArgs(
                default_action="Deny",
                private_endpoints=[azure_native.signalrservice.v20230201.PrivateEndpointACLArgs(
                    allow=["ServerConnection"],
                    name="mysignalrservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
                )],
                public_network=azure_native.signalrservice.v20230201.NetworkACLArgs(
            ...
            serverless=azure_native.signalrservice.v20230201.ServerlessSettingsArgs(
                connection_timeout_in_seconds=5,
            ),
            sku=azure_native.signalrservice.v20230201.ResourceSkuResponseArgs(
                capacity=1,
                name="Premium_P1",
                tier="Premium",
            ),
            ...
            tls=azure_native.signalrservice.v20230201.SignalRTlsSettingsArgs(
                client_cert_enabled=False,
            ),
            upstream=azure_native.signalrservice.v20230201.ServerlessUpstreamSettingsResponseArgs(
                templates=[{
                    "auth": {
                        "managedIdentity": azure_native.signalrservice.v20230201.ManagedIdentitySettingsArgs(
        ...
        ```sh
        $ pulumi import azure-native:signalrservice/v20230201:SignalR mySignalRService /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService 
        ```
        ...
        :param pulumi.Input[pulumi.InputType['ServerlessSettingsArgs']] serverless: Serverless settings.
