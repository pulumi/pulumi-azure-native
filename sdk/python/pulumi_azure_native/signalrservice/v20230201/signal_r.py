...
class SignalR(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cors, SignalRCorsSettingsArgs):
                cors = cors or {}
                def _setter(key, value):
                    cors[key] = value
            ...
            if not isinstance(identity, ManagedIdentityArgs):
            ...
            if not isinstance(live_trace_configuration, LiveTraceConfigurationArgs):
            ...
            if not isinstance(network_acls, SignalRNetworkACLsArgs):
            ...
            if not isinstance(resource_log_configuration, ResourceLogConfigurationArgs):
            ...
            if not isinstance(serverless, ServerlessSettingsArgs):
            ...
            if not isinstance(tls, SignalRTlsSettingsArgs):
                tls = tls or {}
                def _setter(key, value):
                    tls[key] = value
                SignalRTlsSettingsArgs._configure(_setter, **tls)
            __props__.__dict__["tls"] = tls
            if not isinstance(upstream, ServerlessUpstreamSettingsArgs):
