...
class SignalRCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        signal_r_custom_domain = azure_native.signalrservice.v20230201.SignalRCustomDomain("signalRCustomDomain",
            custom_certificate=azure_native.signalrservice.v20230201.ResourceReferenceArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20220201:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20220801preview:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20230301preview:SignalRCustomDomain")])
