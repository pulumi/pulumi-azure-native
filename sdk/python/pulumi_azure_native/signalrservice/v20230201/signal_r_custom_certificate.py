...
class SignalRCustomCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        signal_r_custom_certificate = azure_native.signalrservice.v20230201.SignalRCustomCertificate("signalRCustomCertificate",
        ...
        ```sh
        $ pulumi import azure-native:signalrservice/v20230201:SignalRCustomCertificate myCert /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService/customCertificates/myCert 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice:SignalRCustomCertificate"), pulumi.Alias(type_="azure-native:signalrservice/v20220201:SignalRCustomCertificate"), pulumi.Alias(type_="azure-native:signalrservice/v20220801preview:SignalRCustomCertificate"), pulumi.Alias(type_="azure-native:signalrservice/v20230301preview:SignalRCustomCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SignalRCustomCertificate, __self__).__init__(
            'azure-native:signalrservice/v20230201:SignalRCustomCertificate',
            resource_name,
            __props__,
            opts)
