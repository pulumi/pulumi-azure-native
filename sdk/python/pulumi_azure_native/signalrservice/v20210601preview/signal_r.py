...
class SignalR(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ServerlessUpstreamSettingsArgs', 'ServerlessUpstreamSettingsArgsDict']] upstream: Upstream settings when the service is in server-less mode.
        """
        ...
    @overload
    def __init__(__self__,
