...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r is deprecated: azure-native:signalrservice/v20210601preview:SignalR is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalR to guarantee forwards compatibility.""")
    __args__ = dict()
