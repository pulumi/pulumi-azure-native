...
warnings.warn("""azure-native:signalrservice/v20220201:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomDomain to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_signal_r_custom_domain(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r_custom_domain is deprecated: azure-native:signalrservice/v20220201:SignalRCustomDomain is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomDomain to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
