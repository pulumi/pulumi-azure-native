...
warnings.warn("""azure-native:signalrservice/v20220201:SignalRCustomCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:signalrservice/v20230301preview:SignalRCustomCertificate to guarantee forwards compatibility.""", DeprecationWarning)
