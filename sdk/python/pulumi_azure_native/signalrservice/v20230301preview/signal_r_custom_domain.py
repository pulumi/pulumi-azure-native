...
class SignalRCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20220201:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20220801preview:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20230201:SignalRCustomDomain"), pulumi.Alias(type_="azure-native:signalrservice/v20230601preview:SignalRCustomDomain")])
