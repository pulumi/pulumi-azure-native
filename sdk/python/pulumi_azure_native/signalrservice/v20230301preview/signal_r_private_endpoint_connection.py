...
class SignalRPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        signal_r_private_endpoint_connection = azure_native.signalrservice.v20230301preview.SignalRPrivateEndpointConnection("signalRPrivateEndpointConnection",
            private_endpoint=azure_native.signalrservice.v20230301preview.PrivateEndpointArgs(),
            private_endpoint_connection_name="mysignalrservice.1fa229cd-bf3f-47f0-8c49-afb36723997e",
            private_link_service_connection_state=azure_native.signalrservice.v20230301preview.PrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        super(SignalRPrivateEndpointConnection, __self__).__init__(
            'azure-native:signalrservice/v20230301preview:SignalRPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
