...
def get_signal_r_custom_certificate(certificate_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_name: Custom certificate name
...
def get_signal_r_custom_certificate_output(certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice:getSignalRCustomCertificate', __args__, opts=opts, typ=GetSignalRCustomCertificateResult)
