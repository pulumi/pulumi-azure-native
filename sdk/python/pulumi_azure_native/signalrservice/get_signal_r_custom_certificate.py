...
def get_signal_r_custom_certificate(certificate_name: Optional[builtins.str] = None,
...
def get_signal_r_custom_certificate_output(certificate_name: Optional[pulumi.Input[builtins.str]] = None,
