...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:getSignalR'.""", DeprecationWarning)
...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:getSignalR'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/latest:getSignalR', __args__, opts=opts, typ=GetSignalRResult).value
