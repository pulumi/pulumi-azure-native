...
def get_signal_r(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20200501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/v20181001:getSignalR', __args__, opts=opts, typ=GetSignalRResult).value
