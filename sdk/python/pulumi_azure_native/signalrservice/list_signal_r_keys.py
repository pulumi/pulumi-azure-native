...
def list_signal_r_keys(resource_group_name: Optional[builtins.str] = None,
...
def list_signal_r_keys_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
