...
def list_signal_r_keys(resource_group_name: Optional[_builtins.str] = None,
...
def list_signal_r_keys_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice:listSignalRKeys', __args__, opts=opts, typ=ListSignalRKeysResult)
