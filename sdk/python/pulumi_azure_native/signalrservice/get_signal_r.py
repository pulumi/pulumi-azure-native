...
def get_signal_r(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice:getSignalR', __args__, opts=opts, typ=GetSignalRResult).value
...
def get_signal_r_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:signalrservice:getSignalR', __args__, opts=opts, typ=GetSignalRResult)
