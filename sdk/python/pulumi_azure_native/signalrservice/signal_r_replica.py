...
class SignalRReplica(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:signalrservice/v20230301preview:SignalRReplica"), pulumi.Alias(type_="azure-native:signalrservice/v20230601preview:SignalRReplica")])
