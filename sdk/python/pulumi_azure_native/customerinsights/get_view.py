...
class GetViewResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, changed=None, created=None, definition=None, display_name=None, id=None, name=None, tenant_id=None, type=None, user_id=None, view_name=None):
...
def get_view(hub_name: Optional[builtins.str] = None,
    ...
    :param builtins.str user_id: The user ID. Use * to retrieve hub level view.
    :param builtins.str view_name: The name of the view.
    """
    __args__ = dict()
...
def get_view_output(hub_name: Optional[pulumi.Input[builtins.str]] = None,
