...
class Relationship(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Relationship"), pulumi.Alias(type_="azure-native:customerinsights:Relationship"), pulumi.Alias(type_="azure-nextgen:customerinsights:Relationship"), pulumi.Alias(type_="azure-native:customerinsights/latest:Relationship"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Relationship"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Relationship"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Relationship")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Relationship, __self__).__init__(
            'azure-native:customerinsights/v20170101:Relationship',
            resource_name,
            __props__,
            opts)
