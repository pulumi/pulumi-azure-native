...
def get_image_upload_url_for_data(entity_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/v20170101:getImageUploadUrlForData', __args__, opts=opts, typ=GetImageUploadUrlForDataResult).value
