...
class Link(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Link"), pulumi.Alias(type_="azure-native:customerinsights:Link"), pulumi.Alias(type_="azure-nextgen:customerinsights:Link"), pulumi.Alias(type_="azure-native:customerinsights/latest:Link"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Link"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Link"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Link")])
    ...
    def get(resource_name: str,
        ...
        __props__["source_interaction_type"] = None
        __props__["target_profile_type"] = None
        __props__["tenant_id"] = None
        __props__["type"] = None
