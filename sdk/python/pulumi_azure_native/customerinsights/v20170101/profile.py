...
class Profile(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Profile"), pulumi.Alias(type_="azure-native:customerinsights:Profile"), pulumi.Alias(type_="azure-nextgen:customerinsights:Profile"), pulumi.Alias(type_="azure-native:customerinsights/latest:Profile"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Profile"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Profile"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Profile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Profile, __self__).__init__(
            'azure-native:customerinsights/v20170101:Profile',
            resource_name,
            __props__,
            opts)
