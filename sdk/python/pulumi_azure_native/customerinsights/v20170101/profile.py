...
class Profile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Profile"), pulumi.Alias(type_="azure-native:customerinsights:Profile"), pulumi.Alias(type_="azure-nextgen:customerinsights:Profile"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Profile"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Profile")])
