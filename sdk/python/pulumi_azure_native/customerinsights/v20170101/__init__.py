...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:customerinsights/v20170101:Connector":
                return Connector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:ConnectorMapping":
                return ConnectorMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:Hub":
                return Hub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:Kpi":
                return Kpi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:Link":
                return Link(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:Profile":
                return Profile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:Relationship":
                return Relationship(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:RelationshipLink":
                return RelationshipLink(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:RoleAssignment":
                return RoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170101:View":
    ...
    pulumi.runtime.register_resource_module("azure-native", "customerinsights/v20170101", _module_instance)
