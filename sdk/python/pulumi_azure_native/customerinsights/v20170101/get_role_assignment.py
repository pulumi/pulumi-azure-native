...
def get_role_assignment(assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_role_assignment is deprecated: Version 2017-01-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['assignmentName'] = assignment_name
    __args__['hubName'] = hub_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/v20170101:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
