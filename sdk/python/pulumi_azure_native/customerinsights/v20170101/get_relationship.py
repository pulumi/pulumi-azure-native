...
def get_relationship(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_relationship is deprecated: Version v20170101 will be removed in the next major version of the provider. Upgrade to version v20170426 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/v20170101:getRelationship', __args__, opts=opts, typ=GetRelationshipResult).value
