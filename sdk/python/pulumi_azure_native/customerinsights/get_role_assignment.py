...
def get_role_assignment(assignment_name: Optional[_builtins.str] = None,
...
def get_role_assignment_output(assignment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
