...
def get_relationship_link(hub_name: Optional[_builtins.str] = None,
                          relationship_link_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str relationship_link_name: The name of the relationship link.
...
def get_relationship_link_output(hub_name: Optional[pulumi.Input[_builtins.str]] = None,
