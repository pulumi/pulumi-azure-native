...
class PredictionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] score_label: Score label.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] description: Description of the prediction.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] display_name: Display name of the prediction.
