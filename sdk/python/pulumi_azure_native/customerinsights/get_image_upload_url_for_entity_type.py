...
def get_image_upload_url_for_entity_type(entity_type: Optional[_builtins.str] = None,
...
def get_image_upload_url_for_entity_type_output(entity_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
