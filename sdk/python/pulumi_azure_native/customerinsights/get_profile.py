...
class GetProfileResult:
    ...
    def api_entity_set_name(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Optional[Mapping[str, Sequence[builtins.str]]]:
        """
    ...
    def instances_count(self) -> Optional[builtins.int]:
        """
        The instance count.
        """
    ...
    def large_image(self) -> Optional[builtins.str]:
        """
    ...
    def last_changed_utc(self) -> builtins.str:
        """
    ...
    def localized_attributes(self) -> Optional[Mapping[str, Mapping[str, builtins.str]]]:
        """
    ...
    def medium_image(self) -> Optional[builtins.str]:
        """
    ...
    def schema_item_type_link(self) -> Optional[builtins.str]:
        """
    ...
    def small_image(self) -> Optional[builtins.str]:
        """
    ...
    def timestamp_field_name(self) -> Optional[builtins.str]:
        """
...
def get_profile(hub_name: Optional[builtins.str] = None,
                locale_code: Optional[builtins.str] = None,
    ...
    :param builtins.str locale_code: Locale of profile to retrieve, default is en-us.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(hub_name: Optional[pulumi.Input[builtins.str]] = None,
                       locale_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:customerinsights:getProfile', __args__, opts=opts, typ=GetProfileResult)
