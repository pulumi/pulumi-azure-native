...
class ViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] definition: View definition.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] display_name: Localized display name for the view.
        :param pulumi.Input[builtins.str] user_id: the user ID.
        :param pulumi.Input[builtins.str] view_name: The name of the view.
        """
...
class View(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights/v20170101:View"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:View")])
    ...
    @property
    @pulumi.getter
    def changed(self) -> pulumi.Output[builtins.str]:
        """
