...
class Hub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hub = azure_native.customerinsights.v20170426.Hub("hub",
            hub_billing_info=azure_native.customerinsights.v20170426.HubBillingInfoFormatArgs(
                max_units=5,
                min_units=1,
                sku_name="B0",
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights:Hub"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Hub")])
