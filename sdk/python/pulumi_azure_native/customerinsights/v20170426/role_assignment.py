...
class RoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        role_assignment = azure_native.customerinsights.v20170426.RoleAssignment("roleAssignment",
            assignment_name="assignmentName8976",
            hub_name="sdkTestHub",
            principals=[
                azure_native.customerinsights.v20170426.AssignmentPrincipalArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RoleAssignment")])
