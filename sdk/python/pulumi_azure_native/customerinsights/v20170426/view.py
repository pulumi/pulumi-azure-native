...
class View(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        view = azure_native.customerinsights.v20170426.View("view",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights:View"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:View")])
