...
class ConnectorMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connector_mapping = azure_native.customerinsights.v20170426.ConnectorMapping("connectorMapping",
            connector_name="testConnector8858",
            description="Test mapping",
            display_name="testMapping12491",
            entity_type=azure_native.customerinsights/v20170426.EntityTypes.INTERACTION,
            entity_type_name="TestInteractionType2967",
            hub_name="sdkTestHub",
            mapping_name="testMapping12491",
            mapping_properties=azure_native.customerinsights.v20170426.ConnectorMappingPropertiesResponseArgs(
                availability=azure_native.customerinsights.v20170426.ConnectorMappingAvailabilityArgs(
                    frequency=azure_native.customerinsights/v20170426.FrequencyTypes.HOUR,
                    interval=5,
                ),
                complete_operation=azure_native.customerinsights.v20170426.ConnectorMappingCompleteOperationArgs(
                    completion_operation_type=azure_native.customerinsights/v20170426.CompletionOperationTypes.DELETE_FILE,
                    destination_folder="fakePath",
                ),
                error_management=azure_native.customerinsights.v20170426.ConnectorMappingErrorManagementArgs(
                    error_limit=10,
                    error_management_type=azure_native.customerinsights/v20170426.ErrorManagementTypes.STOP_IMPORT,
                ),
                file_filter="unknown",
                folder_path="http://sample.dne/file",
                format=azure_native.customerinsights.v20170426.ConnectorMappingFormatArgs(
                    column_delimiter="|",
                    format_type=azure_native.customerinsights/v20170426.FormatTypes.TEXT_FORMAT,
                ),
                has_header=False,
                structure=[
                    azure_native.customerinsights.v20170426.ConnectorMappingStructureArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:ConnectorMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectorMapping, __self__).__init__(
            'azure-native:customerinsights/v20170426:ConnectorMapping',
            resource_name,
            __props__,
            opts)
