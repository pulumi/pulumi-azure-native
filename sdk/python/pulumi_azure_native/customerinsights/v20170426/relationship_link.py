...
class RelationshipLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        relationship_link = azure_native.customerinsights.v20170426.RelationshipLink("relationshipLink",
            description={
            ...
            profile_property_references=[azure_native.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs(
                interaction_property_name="profile1",
                profile_property_name="ProfileId",
            )],
            related_profile_property_references=[azure_native.customerinsights.v20170426.ParticipantProfilePropertyReferenceArgs(
                interaction_property_name="profile1",
                profile_property_name="ProfileId",
            )],
