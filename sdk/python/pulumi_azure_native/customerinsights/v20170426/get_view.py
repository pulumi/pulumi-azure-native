...
def get_view(hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/v20170426:getView', __args__, opts=opts, typ=GetViewResult).value
...
def get_view_output(hub_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['viewName'] = view_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:customerinsights/v20170426:getView', __args__, opts=opts, typ=GetViewResult)
