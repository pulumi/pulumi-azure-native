...
class Kpi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kpi = azure_native.customerinsights.v20170426.Kpi("kpi",
            aliases=[{
                "aliasName": "alias",
                "expression": "Id+4",
            }],
            calculation_window=azure_native.customerinsights/v20170426.CalculationWindowTypes.DAY,
            description={
            ...
            entity_type=azure_native.customerinsights/v20170426.EntityTypes.PROFILE,
            ...
            thres_holds=azure_native.customerinsights.v20170426.KpiThresholdsResponseArgs(
                increasing_kpi=True,
                lower_limit=5,
                upper_limit=50,
            ),
