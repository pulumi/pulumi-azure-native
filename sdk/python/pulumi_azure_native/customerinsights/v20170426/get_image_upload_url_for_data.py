...
def get_image_upload_url_for_data(entity_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/v20170426:getImageUploadUrlForData', __args__, opts=opts, typ=GetImageUploadUrlForDataResult).value
...
def get_image_upload_url_for_data_output(entity_type: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:customerinsights/v20170426:getImageUploadUrlForData', __args__, opts=opts, typ=GetImageUploadUrlForDataResult)
