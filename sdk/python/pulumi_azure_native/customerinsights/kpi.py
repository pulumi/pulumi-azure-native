...
class KpiArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'calculationWindow' in kwargs:
...
class Kpi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if thres_holds is not None and not isinstance(thres_holds, KpiThresholdsArgs):
