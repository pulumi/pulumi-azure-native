...
class KpiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] description: Localized description for the KPI.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] display_name: Localized display name for the KPI.
