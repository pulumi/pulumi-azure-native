...
def get_image_upload_url_for_data(entity_type: Optional[_builtins.str] = None,
                                  entity_type_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str entity_type: Type of entity. Can be Profile or Interaction.
    :param _builtins.str entity_type_name: Name of the entity type.
    :param _builtins.str hub_name: The name of the hub.
    :param _builtins.str relative_path: Relative path of the image.
