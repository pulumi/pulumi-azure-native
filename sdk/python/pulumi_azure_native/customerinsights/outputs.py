...
class CanonicalProfileDefinitionResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 canonical_profile_id: Optional[_builtins.int] = None,
...
class CanonicalProfileDefinitionResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 profile_property_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str type: Type of canonical property value.
        :param _builtins.str value: Value of the canonical property.
        """
...
class ConnectorMappingCompleteOperationResponse(dict):
    ...
    def __init__(__self__, *,
                 completion_operation_type: Optional[_builtins.str] = None,
...
class ConnectorMappingFormatResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 accept_language: Optional[_builtins.str] = None,
                 array_separator: Optional[_builtins.str] = None,
        ...
        :param _builtins.str column_delimiter: The character that signifies a break between columns.
        :param _builtins.str quote_character: Quote character, used to indicate enquoted fields.
        :param _builtins.str quote_escape_character: Escape character for quotes, can be the same as the quoteCharacter.
        """
...
class ConnectorMappingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_filter: Optional[_builtins.str] = None,
        ...
        :param _builtins.str file_filter: The file filter for the mapping.
        :param _builtins.str folder_path: The folder path for the mapping.
        :param _builtins.bool has_header: If the file contains a header or not.
        """
...
class ConnectorMappingStructureResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_format_specifier: Optional[_builtins.str] = None,
        ...
        :param _builtins.bool is_encrypted: Indicates if the column is encrypted.
        """
...
class DataSourcePrecedenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The data source name
        :param _builtins.str status: The data source status.
        :param _builtins.int precedence: the precedence value.
        """
...
class HubBillingInfoFormatResponse(dict):
    ...
    def __init__(__self__, *,
                 max_units: Optional[_builtins.int] = None,
                 min_units: Optional[_builtins.int] = None,
...
class PredictionDistributionDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 total_negatives: Optional[_builtins.float] = None,
...
class PredictionDistributionDefinitionResponseDistributions(dict):
    ...
    """
    def __init__(__self__, *,
                 negatives: Optional[_builtins.float] = None,
                 negatives_above_threshold: Optional[_builtins.float] = None,
                 positives: Optional[_builtins.float] = None,
                 positives_above_threshold: Optional[_builtins.float] = None,
        ...
        :param _builtins.float positives_above_threshold: Number of positives above threshold.
        :param _builtins.int score_threshold: Score threshold.
        """
...
class PredictionResponseGrades(dict):
    ...
    def __init__(__self__, *,
                 grade_name: Optional[_builtins.str] = None,
                 max_score_threshold: Optional[_builtins.int] = None,
...
class PredictionResponseSystemGeneratedEntities(dict):
    ...
    def __init__(__self__, *,
                 generated_interaction_types: Optional[Sequence[_builtins.str]] = None,
                 generated_kpis: Optional[Mapping[str, _builtins.str]] = None,
...
class ProfileEnumValidValuesFormatResponse(dict):
    ...
    def __init__(__self__, *,
                 localized_value_names: Optional[Mapping[str, _builtins.str]] = None,
...
class PropertyDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 array_value_separator: Optional[_builtins.str] = None,
                 ...
                 is_available_in_graph: Optional[_builtins.bool] = None,
                 is_enum: Optional[_builtins.bool] = None,
                 is_flag_enum: Optional[_builtins.bool] = None,
                 is_image: Optional[_builtins.bool] = None,
                 is_localized_string: Optional[_builtins.bool] = None,
                 is_name: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str array_value_separator: Array value separator for properties with isArray set.
        :param Sequence['ProfileEnumValidValuesFormatResponse'] enum_valid_values: Describes valid values for an enum property.
        :param _builtins.bool is_array: Indicates if the property is actually an array of the fieldType above on the data api.
        :param _builtins.bool is_available_in_graph: Whether property is available in graph or not.
        :param _builtins.bool is_enum: Indicates if the property is an enum.
        :param _builtins.bool is_flag_enum: Indicates if the property is an flag enum.
        :param _builtins.bool is_image: Whether the property is an Image.
        :param _builtins.bool is_localized_string: Whether the property is a localized string.
        :param _builtins.bool is_name: Whether the property is a name or a part of name.
        :param _builtins.bool is_required: Whether property value is required on instances, IsRequired field only for Interaction. Profile Instance will not check for required field.
        :param _builtins.int max_length: Max length of string. Used only if type is string.
        :param _builtins.str property_id: The ID associated with the property.
        :param _builtins.str schema_item_prop_link: URL encoded schema.org item prop link for the property.
        """
...
class StrongIdResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[Mapping[str, _builtins.str]] = None,
                 display_name: Optional[Mapping[str, _builtins.str]] = None):
        """
        Property/Properties which represent a unique ID.
        ...
        :param Mapping[str, _builtins.str] display_name: Localized display name.
        """
