...
class Hub(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:Hub"), pulumi.Alias(type_="azure-native:customerinsights/latest:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Hub"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Hub"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Hub")])
