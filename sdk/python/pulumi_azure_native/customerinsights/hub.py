...
class HubArgs:
    def __init__(__self__, *,
                 ...
                 tenant_features: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] tenant_features: The bit flags for enabled hub features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set to 0.
        """
    ...
    def tenant_features(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def tenant_features(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Hub(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['HubBillingInfoFormatArgs', 'HubBillingInfoFormatArgsDict']] hub_billing_info: Billing settings of the hub.
        :param pulumi.Input[builtins.str] hub_name: The name of the Hub.
        :param pulumi.Input[builtins.str] location: Resource location.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights/v20170101:Hub"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Hub")])
    ...
    @property
    @pulumi.getter(name="tenantFeatures")
    def tenant_features(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The bit flags for enabled hub features. Bit 0 is set to 1 indicates graph is enabled, or disabled if set to 0. Bit 1 is set to 1 indicates the hub is disabled, or enabled if set to 0.
        """
        return pulumi.get(self, "tenant_features")
    ...
    def web_endpoint(self) -> pulumi.Output[builtins.str]:
        """
