...
class HubArgs:
    ...
    def _configure(
        ...
        if hub_billing_info is None and 'hubBillingInfo' in kwargs:
            hub_billing_info = kwargs['hubBillingInfo']
        if hub_name is None and 'hubName' in kwargs:
            hub_name = kwargs['hubName']
        if tenant_features is None and 'tenantFeatures' in kwargs:
...
class Hub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            hub_billing_info = _utilities.configure(hub_billing_info, HubBillingInfoFormatArgs, True)
