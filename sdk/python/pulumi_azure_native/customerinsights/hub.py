...
class Hub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights/v20170426:Hub"), pulumi.Alias(type_="azure-native_customerinsights_v20170101:customerinsights:Hub"), pulumi.Alias(type_="azure-native_customerinsights_v20170426:customerinsights:Hub")])
