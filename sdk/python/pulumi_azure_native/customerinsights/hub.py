...
class HubArgs:
    def __init__(__self__, *,
        ...
        HubArgs._configure(
            ...
            hub_billing_info=hub_billing_info,
            hub_name=hub_name,
            location=location,
            tags=tags,
    ...
    def _configure(
        ...
        if 'hubBillingInfo' in kwargs:
            hub_billing_info = kwargs['hubBillingInfo']
        if 'hubName' in kwargs:
            hub_name = kwargs['hubName']
        if 'tenantFeatures' in kwargs:
            tenant_features = kwargs['tenantFeatures']

        _setter("resource_group_name", resource_group_name)
        if hub_billing_info is not None:
            _setter("hub_billing_info", hub_billing_info)
        ...
        if tenant_features is not None:
            _setter("tenant_features", tenant_features)
...
class Hub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if hub_billing_info is not None and not isinstance(hub_billing_info, HubBillingInfoFormatArgs):
                hub_billing_info = hub_billing_info or {}
                def _setter(key, value):
                    hub_billing_info[key] = value
                HubBillingInfoFormatArgs._configure(_setter, **hub_billing_info)
