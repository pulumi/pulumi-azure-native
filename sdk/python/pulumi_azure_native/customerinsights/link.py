...
class Link(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customerinsights/v20170426:Link"), pulumi.Alias(type_="azure-native_customerinsights_v20170101:customerinsights:Link"), pulumi.Alias(type_="azure-native_customerinsights_v20170426:customerinsights:Link")])
