...
class LinkArgs:
    def __init__(__self__, *,
                 ...
                 source_entity_type_name: pulumi.Input[builtins.str],
                 target_entity_type: pulumi.Input['EntityType'],
                 target_entity_type_name: pulumi.Input[builtins.str],
                 ...
                 reference_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] source_entity_type_name: Name of the source Entity Type.
        :param pulumi.Input['EntityType'] target_entity_type: Type of target entity.
        :param pulumi.Input[builtins.str] target_entity_type_name: Name of the target Entity Type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] description: Localized descriptions for the Link.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] display_name: Localized display name for the Link.
        :param pulumi.Input[builtins.str] link_name: The name of the link.
        ...
        :param pulumi.Input[builtins.bool] reference_only: Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
        """
    ...
    def source_entity_type_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_entity_type_name(self, value: pulumi.Input[builtins.str]):
    ...
    def target_entity_type_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_entity_type_name(self, value: pulumi.Input[builtins.str]):
    ...
    def reference_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reference_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Link(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 source_entity_type_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_entity_type: Optional[pulumi.Input['EntityType']] = None,
                 target_entity_type_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="referenceOnly")
    def reference_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicating whether the link is reference only link. This flag is ignored if the Mappings are defined. If the mappings are not defined and it is set to true, links processing will not create or update profiles.
        """
        return pulumi.get(self, "reference_only")
    ...
    @property
    @pulumi.getter(name="sourceEntityType")
    def source_entity_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of source entity.
        """
        return pulumi.get(self, "source_entity_type")
    ...
    @property
    @pulumi.getter(name="sourceEntityTypeName")
    def source_entity_type_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the source Entity Type.
        """
        return pulumi.get(self, "source_entity_type_name")
    ...
    @property
    @pulumi.getter(name="targetEntityType")
    def target_entity_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of target entity.
        """
        return pulumi.get(self, "target_entity_type")
    ...
    @property
    @pulumi.getter(name="targetEntityTypeName")
    def target_entity_type_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the target Entity Type.
        """
        return pulumi.get(self, "target_entity_type_name")
