...
class RoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] assignment_name: The assignment name
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] description: Localized description for the metadata.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] display_name: Localized display names for the metadata.
...
class RoleAssignment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assignmentName")
    def assignment_name(self) -> pulumi.Output[builtins.str]:
        """
