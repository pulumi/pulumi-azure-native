...
class RoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(conflation_policies, ResourceSetDescriptionArgs):
            ...
            if not isinstance(connectors, ResourceSetDescriptionArgs):
            ...
            if not isinstance(interactions, ResourceSetDescriptionArgs):
            ...
            if not isinstance(kpis, ResourceSetDescriptionArgs):
                kpis = kpis or {}
                def _setter(key, value):
                    kpis[key] = value
                ResourceSetDescriptionArgs._configure(_setter, **kpis)
            __props__.__dict__["kpis"] = kpis
            if not isinstance(links, ResourceSetDescriptionArgs):
                links = links or {}
                def _setter(key, value):
                    links[key] = value
            ...
            if not isinstance(profiles, ResourceSetDescriptionArgs):
                profiles = profiles or {}
                def _setter(key, value):
                    profiles[key] = value
                ResourceSetDescriptionArgs._configure(_setter, **profiles)
            __props__.__dict__["profiles"] = profiles
            if not isinstance(relationship_links, ResourceSetDescriptionArgs):
            ...
            if not isinstance(relationships, ResourceSetDescriptionArgs):
            ...
            if not isinstance(role_assignments, ResourceSetDescriptionArgs):
            ...
            if not isinstance(sas_policies, ResourceSetDescriptionArgs):
