...
def get_relationship(hub_name: Optional[_builtins.str] = None,
                     relationship_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str relationship_name: The name of the relationship.
...
def get_relationship_output(hub_name: Optional[pulumi.Input[_builtins.str]] = None,
