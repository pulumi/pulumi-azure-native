...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getRoleAssignment'.""", DeprecationWarning)
...
def get_role_assignment(assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getRoleAssignment', __args__, opts=opts, typ=GetRoleAssignmentResult).value
