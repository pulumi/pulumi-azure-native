...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:customerinsights/latest:Connector":
                return Connector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:ConnectorMapping":
                return ConnectorMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Hub":
                return Hub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Kpi":
                return Kpi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Link":
                return Link(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Prediction":
                return Prediction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Profile":
                return Profile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:Relationship":
                return Relationship(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:RelationshipLink":
                return RelationshipLink(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:RoleAssignment":
                return RoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/latest:View":
    ...
    pulumi.runtime.register_resource_module("azure-native", "customerinsights/latest", _module_instance)
