...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getPrediction'.""", DeprecationWarning)
...
def get_prediction(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_prediction is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getPrediction'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getPrediction', __args__, opts=opts, typ=GetPredictionResult).value
