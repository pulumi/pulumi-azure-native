...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getView'.""", DeprecationWarning)
...
def get_view(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_view is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getView'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getView', __args__, opts=opts, typ=GetViewResult).value
