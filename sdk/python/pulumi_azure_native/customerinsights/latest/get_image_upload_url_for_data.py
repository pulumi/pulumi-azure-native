...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getImageUploadUrlForData'.""", DeprecationWarning)
...
def get_image_upload_url_for_data(entity_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getImageUploadUrlForData', __args__, opts=opts, typ=GetImageUploadUrlForDataResult).value
