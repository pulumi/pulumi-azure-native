...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getConnector'.""", DeprecationWarning)
...
def get_connector(connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connector is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getConnector'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getConnector', __args__, opts=opts, typ=GetConnectorResult).value
