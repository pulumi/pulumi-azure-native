...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datalakestore:Account'.""", DeprecationWarning)
...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore/latest:Account"), pulumi.Alias(type_="azure-native:datalakestore:Account"), pulumi.Alias(type_="azure-nextgen:datalakestore:Account"), pulumi.Alias(type_="azure-native:datalakestore/v20161101:Account"), pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:datalakestore/latest:Account',
            resource_name,
            __props__,
            opts)
