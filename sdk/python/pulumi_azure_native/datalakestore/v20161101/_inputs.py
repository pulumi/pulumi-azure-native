...
class EncryptionConfigArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             type: Optional[pulumi.Input['EncryptionConfigType']] = None,
             key_vault_meta_info: Optional[pulumi.Input['KeyVaultMetaInfoArgs']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if type is None:
...
class EncryptionIdentityArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             type: Optional[pulumi.Input['EncryptionIdentityType']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if type is None:
            raise TypeError("Missing 'type' argument")
...
class KeyVaultMetaInfoArgs:
    ...
    def _configure(
             ...
             encryption_key_version: Optional[pulumi.Input[str]] = None,
