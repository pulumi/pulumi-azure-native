...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        account = azure_native.datalakestore.v20161101.Account("account",
            account_name="contosoadla",
            default_group="test_default_group",
            encryption_config=azure_native.datalakestore.v20161101.EncryptionConfigResponseArgs(
                key_vault_meta_info=azure_native.datalakestore.v20161101.KeyVaultMetaInfoArgs(
                    encryption_key_name="test_encryption_key_name",
                    encryption_key_version="encryption_key_version",
                    key_vault_resource_id="34adfa4f-cedf-4dc0-ba29-b6d1a69ab345",
                ),
                type=azure_native.datalakestore/v20161101.EncryptionConfigType.USER_MANAGED,
            ),
            encryption_state=azure_native.datalakestore/v20161101.EncryptionState.ENABLED,
            firewall_allow_azure_ips=azure_native.datalakestore/v20161101.FirewallAllowAzureIpsState.ENABLED,
            firewall_rules=[{
                "endIpAddress": "2.2.2.2",
                "name": "test_rule",
                "startIpAddress": "1.1.1.1",
            }],
            firewall_state=azure_native.datalakestore/v20161101.FirewallState.ENABLED,
            identity=azure_native.datalakestore.v20161101.EncryptionIdentityResponseArgs(
                type=azure_native.datalakestore/v20161101.EncryptionIdentityType.SYSTEM_ASSIGNED,
            ),
            location="eastus2",
            new_tier=azure_native.datalakestore/v20161101.TierType.CONSUMPTION,
            resource_group_name="contosorg",
            tags={
                "test_key": "test_value",
            },
            trusted_id_provider_state=azure_native.datalakestore/v20161101.TrustedIdProviderState.ENABLED,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datalakestore:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:datalakestore/v20161101:Account',
            resource_name,
            __props__,
            opts)
