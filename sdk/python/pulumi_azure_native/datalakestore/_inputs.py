...
class CreateFirewallRuleWithAccountParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the firewall rule to create.
...
class CreateTrustedIdProviderWithAccountParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the trusted identity provider to create.
        """
...
class CreateVirtualNetworkRuleWithAccountParametersArgs:
    def __init__(__self__, *,
        ...
        """
        The parameters used to create a new virtual network rule while creating a new Data Lake Store account.
        :param pulumi.Input[builtins.str] name: The unique name of the virtual network rule to create.
        :param pulumi.Input[builtins.str] subnet_id: The resource identifier for the subnet.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class KeyVaultMetaInfoArgsDict(TypedDict):
        ...
        """
        encryption_key_name: pulumi.Input[builtins.str]
        """
        The name of the user managed encryption key.
        """
        encryption_key_version: pulumi.Input[builtins.str]
        """
...
class KeyVaultMetaInfoArgs:
    def __init__(__self__, *,
        ...
        """
        Metadata information used by account encryption.
        :param pulumi.Input[builtins.str] encryption_key_name: The name of the user managed encryption key.
        :param pulumi.Input[builtins.str] encryption_key_version: The version of the user managed encryption key.
        :param pulumi.Input[builtins.str] key_vault_resource_id: The resource identifier for the user managed Key Vault being used to encrypt.
        """
    ...
    def encryption_key_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the user managed encryption key.
        """
    ...
    def encryption_key_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "encryption_key_name", value)

    @property
    @pulumi.getter(name="encryptionKeyVersion")
    def encryption_key_version(self) -> pulumi.Input[builtins.str]:
        """
        The version of the user managed encryption key.
        """
    ...
    def encryption_key_version(self, value: pulumi.Input[builtins.str]):
