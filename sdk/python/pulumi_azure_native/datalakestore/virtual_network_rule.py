...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_network_rule_name: The name of the virtual network rule to create or update.
        """
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:datalakestore:VirtualNetworkRule"
