...
def get_virtual_network_rule(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_network_rule_name: The name of the virtual network rule to retrieve.
    """
    __args__ = dict()
...
def get_virtual_network_rule_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
