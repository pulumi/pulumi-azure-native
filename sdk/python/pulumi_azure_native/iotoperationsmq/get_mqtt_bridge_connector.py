...
class GetMqttBridgeConnectorResult:
    ...
    def bridge_instances(self) -> Optional[builtins.int]:
        """
...
def get_mqtt_bridge_connector(mq_name: Optional[builtins.str] = None,
...
def get_mqtt_bridge_connector_output(mq_name: Optional[pulumi.Input[builtins.str]] = None,
