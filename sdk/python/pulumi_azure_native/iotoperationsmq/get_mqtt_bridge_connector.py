...
def get_mqtt_bridge_connector(mq_name: Optional[_builtins.str] = None,
                              mqtt_bridge_connector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str mqtt_bridge_connector_name: Name of MQ mqttBridgeConnector resource
...
def get_mqtt_bridge_connector_output(mq_name: Optional[pulumi.Input[_builtins.str]] = None,
