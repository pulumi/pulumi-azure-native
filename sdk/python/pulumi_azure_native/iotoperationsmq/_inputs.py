...
class AuthorizationConfigArgsDict(TypedDict):
    ...
    """
    rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AuthorizationBasicRuleArgsDict']]]]]
    """
...
class AutomaticCertMethodArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] renew_before: When to begin renewing automatically-managed certificate.
        :param pulumi.Input['SanForCertArgs'] san: Additional SANs to include in the certificate.
        :param pulumi.Input[_builtins.str] secret_name: Secret for storing server certificate. Any existing data will be overwritten.
        :param pulumi.Input[_builtins.str] secret_namespace: Certificate K8S namespace. Omit to use default namespace.
        """
...
class BackendChainArgsDict(TypedDict):
    ...
    """
    temporary_resource_limits: NotRequired[pulumi.Input[Optional['TemporaryResourceLimitsConfigArgsDict']]]
    """
...
class BackendChainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] temporary_disk_transfer_high_watermark_percent: Defines the percentage usage of buffer pool above which disk transfer will start.
        :param pulumi.Input[_builtins.int] temporary_disk_transfer_low_watermark_percent: Defines the percentage usage of buffer pool below which disk transfer will stop.
        :param pulumi.Input[_builtins.int] temporary_max_backend_mem_usage_percent: Defines the limits for memory usage percent of the backend instances of the MQTT broker.
        ...
        :param pulumi.Input[_builtins.int] workers: Number of logical backend workers per pod.
        """
...
class BrokerAuthenticatorCustomAuthX509ArgsDict(TypedDict):
    ...
    """
    key_vault: NotRequired[pulumi.Input[Optional['KeyVaultCertificatePropertiesArgsDict']]]
    """
...
class BrokerAuthenticatorMethodCustomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] headers: Configuration Headers to use.
        """
...
class BrokerAuthenticatorMethodUsernamePasswordArgsDict(TypedDict):
    ...
    """
    key_vault: NotRequired[pulumi.Input[Optional['KeyVaultSecretPropertiesArgsDict']]]
    """
...
class BrokerAuthenticatorMethodX509ArgsDict(TypedDict):
    ...
    """
    attributes: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodX509AttributesArgsDict']]]
    """
...
class BrokerAuthenticatorMethodsArgsDict(TypedDict):
    ...
    """
    custom: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodCustomArgsDict']]]
    """
    Custom Authentication Method.
    """
    sat: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodSatArgsDict']]]
    """
    Service Account Token Method.
    """
    svid: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodSvidArgsDict']]]
    """
    Service Account Token Method.
    """
    username_password: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodUsernamePasswordArgsDict']]]
    """
    UsernamePassword Method.
    """
    x509: NotRequired[pulumi.Input[Optional['BrokerAuthenticatorMethodX509ArgsDict']]]
    """
    X509 Method.
    """
...
class BrokerDiagnosticsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_self_tracing: Enable self tracing on the Broker so that every selfCheckFrequencySeconds a random message is traced even if it didn't have trace context.
        :param pulumi.Input[_builtins.bool] enable_tracing: Knob to enable/disable entire tracing infrastructure.
        :param pulumi.Input[_builtins.str] log_format: Format for the logs generated.
        :param pulumi.Input[_builtins.str] log_level: Log level for the Broker.
        :param pulumi.Input[_builtins.float] max_cell_map_lifetime: Maximum time for the CellMap to live.
        :param pulumi.Input[_builtins.float] metric_update_frequency_seconds: Metric update frequency in seconds.
        :param pulumi.Input[_builtins.str] probe_image: Probe Image to run.
        :param pulumi.Input[_builtins.float] self_check_frequency_seconds: Frequency for the self check to run.
        :param pulumi.Input[_builtins.float] self_check_timeout_seconds: Time out period of the self check.
        :param pulumi.Input[_builtins.float] self_trace_frequency_seconds: The frequency at which selfTrace should run.
        :param pulumi.Input[_builtins.float] span_channel_capacity: The number of the spans generated by the Tracing.
        """
...
class ContainerImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] pull_secrets: Image pull secrets.
        """
...
class DataLakeConnectorMapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] message_payload_type: Message payload type.
        :param pulumi.Input[_builtins.str] mqtt_source_topic: Mqtt source topic.
        :param pulumi.Input['DeltaTableArgs'] table: Delta table properties to use.
        :param pulumi.Input[_builtins.int] qos: Quality of Service.
        """
...
class DataLakeFabricStorageArgsDict(TypedDict):
    ...
    """
    guids: NotRequired[pulumi.Input[Optional['FabricGuidsArgsDict']]]
    """
    Fabric one lake Guids.
    """
    names: NotRequired[pulumi.Input[Optional['FabricNamesArgsDict']]]
    """
...
class DataLakeFabricStorageArgs:
    ...
    @fabric_path.setter
    def fabric_path(self, value: pulumi.Input[Union[_builtins.str, 'FabricPathType']]):
...
class DataLakeServiceStorageAuthenticationArgsDict(TypedDict):
    ...
    """
    system_assigned_managed_identity: NotRequired[pulumi.Input[Optional['ManagedIdentityAuthenticationArgsDict']]]
    """
    Configuration for managed identity authentication.
    """
...
class DataLakeTargetStorageArgsDict(TypedDict):
    ...
    """
    datalake_storage: NotRequired[pulumi.Input[Optional['DataLakeServiceStorageArgsDict']]]
    """
    DataLake service storage details.
    """
    fabric_one_lake: NotRequired[pulumi.Input[Optional['DataLakeFabricStorageArgsDict']]]
    """
    Fabric one lake storage details.
    """
    local_storage: NotRequired[pulumi.Input[Optional['DataLakeLocalStorageArgsDict']]]
    """
...
class DeltaTableSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] optional: Delta table schema optional.
        """
    ...
    @format.setter
    def format(self, value: pulumi.Input[Union[_builtins.str, 'DeltaTableFormatEnum']]):
...
class KafkaRemoteBrokerAuthenticationPropertiesArgsDict(TypedDict):
    ...
    """
    auth_type: NotRequired[pulumi.Input[Optional['KafkaRemoteBrokerAuthenticationTypesArgsDict']]]
    """
...
class KafkaRemoteBrokerAuthenticationTypesArgsDict(TypedDict):
    ...
    """
    sasl: NotRequired[pulumi.Input[Optional['SaslRemoteBrokerBasicAuthenticationArgsDict']]]
    """
    ...
    """
    x509: NotRequired[pulumi.Input[Optional['KafkaX509AuthenticationArgsDict']]]
    """
...
class KafkaRoutesArgsDict(TypedDict):
    ...
    """
    kafka_to_mqtt: NotRequired[pulumi.Input[Optional['KafkaToMqttRoutesArgsDict']]]
    """
    Kafka to Mqtt route.
    """
    mqtt_to_kafka: NotRequired[pulumi.Input[Optional['MqttToKafkaRoutesArgsDict']]]
    """
    Mqtt to Kafka route.
    """
...
class KafkaToMqttRoutesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] consumer_group_id: The consumer group id to use.
        :param pulumi.Input[_builtins.int] qos: The qos to use for mqtt.
        """
...
class KafkaTopicMapBatchingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] max_messages: The maximum messages to send in a batch.
        """
        if enabled is None:
            enabled = False
...
class KeyVaultCertificatePropertiesArgsDict(TypedDict):
    ...
    """
    vault_ca_chain_secret: NotRequired[pulumi.Input[Optional['KeyVaultSecretObjectArgsDict']]]
    """
...
class KeyVaultCredentialsPropertiesArgs:
    ...
    def service_principal_local_secret_name(self, value: pulumi.Input[_builtins.str]):
...
class LocalBrokerConnectionSpecArgsDict(TypedDict):
    ...
    """
    authentication: NotRequired[pulumi.Input[Optional['LocalBrokerAuthenticationMethodsArgsDict']]]
    """
    ...
    """
    tls: NotRequired[pulumi.Input[Optional['LocalBrokerConnectionTlsArgsDict']]]
    """
...
class MqttBridgeRemoteBrokerAuthenticationMethodsArgsDict(TypedDict):
    ...
    Managed identity remote broker authentication method.
    """
    x509: NotRequired[pulumi.Input[Optional['MqttBridgeRemoteBrokerX509AuthenticationArgsDict']]]
    """
    X509 remote broker authentication method.
    """
...
class MqttBridgeRemoteBrokerConnectionSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'MqttBridgeRemoteBrokerProtocol']] protocol: Protocol for remote connection.
        """
        pulumi.set(__self__, "authentication", authentication)
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "tls", tls)
...
class MqttBridgeRoutesArgsDict(TypedDict):
    ...
    """
    shared_subscription: NotRequired[pulumi.Input[Optional['MqttBridgeRouteSharedSubscriptionArgsDict']]]
    """
...
class MqttBridgeRoutesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] qos: Qos for MQTT connection.
        :param pulumi.Input['MqttBridgeRouteSharedSubscriptionArgs'] shared_subscription: Shared subscription topic details.
        :param pulumi.Input[_builtins.str] target: Target topic of the route. Ignore if same as source
        """
    ...
    @_builtins.property
    @pulumi.getter
    def direction(self) -> pulumi.Input[Union[_builtins.str, 'MqttBridgeRouteDirection']]:
        """
        Direction of the route.
        """
    ...
    @direction.setter
    def direction(self, value: pulumi.Input[Union[_builtins.str, 'MqttBridgeRouteDirection']]):
...
class MqttToKafkaRoutesArgsDict(TypedDict):
    ...
    The qos to use for mqtt.
    """
    shared_subscription: NotRequired[pulumi.Input[Optional['KafkaSharedSubscriptionPropertiesArgsDict']]]
    """
...
class ResourceInfoDefinitionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def method(self) -> pulumi.Input[Union[_builtins.str, 'ResourceInfoDefinitionMethods']]:
        """
        The type of action that the clients can perform on the broker: Connect, Publish or Subscribe.
        """
    ...
    @method.setter
    def method(self, value: pulumi.Input[Union[_builtins.str, 'ResourceInfoDefinitionMethods']]):
...
class SaslRemoteBrokerBasicAuthenticationTokenArgsDict(TypedDict):
    ...
    """
    key_vault: NotRequired[pulumi.Input[Optional['KafkaTokenKeyVaultPropertiesArgsDict']]]
    """
...
class TemporaryResourceLimitsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] max_queued_messages: Maximum receive for external clients.
        :param pulumi.Input[_builtins.float] max_queued_qos0_messages: Maximum receive QoS0 for external clients.
        :param pulumi.Input[_builtins.float] max_session_expiry_secs: Maximum session expiry interval, in seconds.
        :param pulumi.Input[_builtins.float] max_message_expiry_secs: Maximum message expiry interval, in seconds.
        """
...
class TlsCertMethodArgsDict(TypedDict):
    ...
    """
    automatic: NotRequired[pulumi.Input[Optional['AutomaticCertMethodArgsDict']]]
    """
    ...
    """
    manual: NotRequired[pulumi.Input[Optional['ManualCertMethodArgsDict']]]
    """
...
class VolumeClaimSpecArgsDict(TypedDict):
    ...
    """
    data_source: NotRequired[pulumi.Input[Optional['VolumeClaimDataSourceArgsDict']]]
    """
    This field can be used to specify either: * An existing VolumeSnapshot object (snapshot.storage.k8s.io/VolumeSnapshot) * An existing PVC (PersistentVolumeClaim) If the provisioner or an external controller can support the specified data source, it will create a new volume based on the contents of the specified data source. If the AnyVolumeDataSource feature gate is enabled, this field will always have the same contents as the DataSourceRef field.
    """
    data_source_ref: NotRequired[pulumi.Input[Optional['VolumeClaimDataSourceRefArgsDict']]]
    """
