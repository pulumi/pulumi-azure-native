...
class DiagnosticServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] max_data_storage_size: The maximum data stored in MiB.
        :param pulumi.Input[_builtins.int] metrics_port: The port at which metrics is exposed.
        :param pulumi.Input[_builtins.str] open_telemetry_traces_collector_addr: The destination to collect traces. Diagnostic service will push traces to this endpoint
