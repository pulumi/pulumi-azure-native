...
def get_diagnostic_service(diagnostic_service_name: Optional[_builtins.str] = None,
...
def get_diagnostic_service_output(diagnostic_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
