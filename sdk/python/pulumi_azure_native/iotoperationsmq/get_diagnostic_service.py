...
class GetDiagnosticServiceResult:
    ...
    def data_export_frequency_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def max_data_storage_size(self) -> Optional[builtins.float]:
        """
    ...
    def metrics_port(self) -> Optional[builtins.int]:
        """
    ...
    def open_telemetry_traces_collector_addr(self) -> Optional[builtins.str]:
        """
    ...
    def stale_data_timeout_seconds(self) -> Optional[builtins.int]:
        """
...
def get_diagnostic_service(diagnostic_service_name: Optional[builtins.str] = None,
    ...
    :param builtins.str diagnostic_service_name: Name of MQ diagnostic resource
...
def get_diagnostic_service_output(diagnostic_service_name: Optional[pulumi.Input[builtins.str]] = None,
