...
class MqttBridgeConnectorArgs:
    def __init__(__self__, *,
                 ...
                 bridge_instances: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] bridge_instances: The number of instances to deploy for a bridge rollout.
        :param pulumi.Input[builtins.str] client_id_prefix: The client id prefix of the dynamically generated client ids.
        ...
        :param pulumi.Input[builtins.str] log_level: The log level of the Bridge Connector instances.
    ...
    def bridge_instances(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def bridge_instances(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def mqtt_bridge_connector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mqtt_bridge_connector_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MqttBridgeConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq/v20231004preview:MqttBridgeConnector")])
    ...
    @property
    @pulumi.getter(name="bridgeInstances")
    def bridge_instances(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of instances to deploy for a bridge rollout.
        """
        return pulumi.get(self, "bridge_instances")
    ...
    @property
    @pulumi.getter(name="clientIdPrefix")
    def client_id_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The client id prefix of the dynamically generated client ids.
        """
        return pulumi.get(self, "client_id_prefix")
