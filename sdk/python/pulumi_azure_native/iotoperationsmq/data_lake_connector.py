...
class DataLakeConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] log_level: The log level of the DataLake Connector instances.
    ...
    def database_format(self, value: pulumi.Input[Union[_builtins.str, 'DataLakeDatabaseFormat']]):
