...
def get_data_lake_connector(data_lake_connector_name: Optional[_builtins.str] = None,
...
def get_data_lake_connector_output(data_lake_connector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
