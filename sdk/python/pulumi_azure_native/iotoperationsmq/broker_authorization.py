...
class BrokerAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authorization_name: Name of MQ broker/authorization resource
...
class BrokerAuthorization(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:iotoperationsmq:BrokerAuthorization"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq/v20231004preview:BrokerAuthorization")])
