...
def get_kafka_connector(kafka_connector_name: Optional[builtins.str] = None,
...
def get_kafka_connector_output(kafka_connector_name: Optional[pulumi.Input[builtins.str]] = None,
