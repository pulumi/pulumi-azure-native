...
class GetKafkaConnectorTopicMapResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, batching=None, compression=None, copy_mqtt_properties=None, extended_location=None, id=None, kafka_connector_ref=None, location=None, name=None, partition_key_property=None, partition_strategy=None, provisioning_state=None, routes=None, system_data=None, tags=None, type=None):
    ...
    def kafka_connector_ref(self) -> builtins.str:
        """
    ...
    def partition_key_property(self) -> Optional[builtins.str]:
        """
...
def get_kafka_connector_topic_map(kafka_connector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str kafka_connector_name: Name of MQ kafkaConnector resource
    :param builtins.str mq_name: Name of MQ resource
    :param builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param builtins.str topic_map_name: Name of MQ kafka/topicMap resource
    """
    __args__ = dict()
...
def get_kafka_connector_topic_map_output(kafka_connector_name: Optional[pulumi.Input[builtins.str]] = None,
