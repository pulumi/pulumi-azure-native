...
class AuthorizationConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_cache: Optional[builtins.bool] = None,
                 rules: Optional[Sequence['outputs.AuthorizationBasicRuleResponse']] = None):
        """
        Broker AuthorizationConfig properties
        :param builtins.bool enable_cache: Enable caching of the authorization rules.
    ...
    def enable_cache(self) -> Optional[builtins.bool]:
        """
...
class AutomaticCertMethodResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_namespace: Optional[builtins.str] = None):
        """
        Automatic TLS server certificate management with cert-manager
        :param 'CertManagerIssuerRefResponse' issuer_ref: cert-manager issuerRef.
        :param builtins.str duration: Lifetime of automatically-managed certificate.
        :param 'CertManagerPrivateKeyResponse' private_key: Cert Manager private key.
        :param builtins.str renew_before: When to begin renewing automatically-managed certificate.
        :param 'SanForCertResponse' san: Additional SANs to include in the certificate.
        :param builtins.str secret_name: Secret for storing server certificate. Any existing data will be overwritten.
        :param builtins.str secret_namespace: Certificate K8S namespace. Omit to use default namespace.
        """
    ...
    def secret_namespace(self) -> Optional[builtins.str]:
        """
...
class BackendChainResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 temporary_disk_transfer_enabled: Optional[builtins.bool] = None,
                 temporary_disk_transfer_high_watermark_percent: Optional[builtins.int] = None,
                 temporary_disk_transfer_low_watermark_percent: Optional[builtins.int] = None,
                 temporary_max_backend_mem_usage_percent: Optional[builtins.int] = None,
                 temporary_resource_limits: Optional['outputs.TemporaryResourceLimitsConfigResponse'] = None,
                 workers: Optional[builtins.int] = None):
        """
        Desired properties of the Frontend Instances of the DMQTT Broker
        :param builtins.int partitions: Partitions is desired number of physical backend chains of the given distributed MQTT broker.
        :param builtins.int redundancy_factor: Redundancy Factor is desired numbers of broker instances in one chain.
        :param builtins.bool temporary_disk_transfer_enabled: Defines whether disk transfer is enabled or not.
        :param builtins.int temporary_disk_transfer_high_watermark_percent: Defines the percentage usage of buffer pool above which disk transfer will start.
        :param builtins.int temporary_disk_transfer_low_watermark_percent: Defines the percentage usage of buffer pool below which disk transfer will stop.
        :param builtins.int temporary_max_backend_mem_usage_percent: Defines the limits for memory usage percent of the backend instances of the MQTT broker.
        ...
        :param builtins.int workers: Number of logical backend workers per pod.
        """
    ...
    def temporary_disk_transfer_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def temporary_disk_transfer_high_watermark_percent(self) -> Optional[builtins.int]:
        """
    ...
    def temporary_disk_transfer_low_watermark_percent(self) -> Optional[builtins.int]:
        """
    ...
    def temporary_max_backend_mem_usage_percent(self) -> Optional[builtins.int]:
        """
...
class BrokerAuthenticatorCustomAuthX509Response(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_name: Secret where cert details are stored.
        """
...
class BrokerAuthenticatorMethodCustomResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Custom method for BrokerAuthentication
        :param builtins.str endpoint: Endpoint to connect to.
        :param 'BrokerAuthenticatorCustomAuthResponse' auth: Custom Broker Authentication Method.
        :param builtins.str ca_cert_config_map: CA cert config map to use.
        :param Mapping[str, builtins.str] headers: Configuration Headers to use.
        """
...
class BrokerAuthenticatorMethodSvidResponse(dict):
    ...
    def __init__(__self__, *,
                 agent_socket_path: builtins.str,
                 identity_max_retry: Optional[builtins.float] = None,
                 identity_wait_retry_ms: Optional[builtins.float] = None):
        """
        SVID for BrokerAuthentication
        :param builtins.str agent_socket_path: Mounted socket path for spiffe agent.
        :param builtins.float identity_max_retry: Maximum number of re-tries to fetch identity.
        :param builtins.float identity_wait_retry_ms: Maximum time to wait before fetching identity again.
        """
    ...
    def agent_socket_path(self) -> builtins.str:
        """
    ...
    def identity_max_retry(self) -> Optional[builtins.float]:
        """
    ...
    def identity_wait_retry_ms(self) -> Optional[builtins.float]:
        """
...
class BrokerAuthenticatorMethodUsernamePasswordResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_name: Secret where username and password are stored.
        """
        if key_vault is not None:
            pulumi.set(__self__, "key_vault", key_vault)
        if secret_name is not None:
...
class BrokerAuthenticatorMethodX509AttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_name: Secret where x509 attributes are stored.
        """
        if key_vault is not None:
            pulumi.set(__self__, "key_vault", key_vault)
        if secret_name is not None:
...
class BrokerAuthenticatorMethodX509Response(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trusted_client_ca_cert_config_map: Optional[builtins.str] = None):
        """
        X509 for BrokerAuthentication.
        :param 'BrokerAuthenticatorMethodX509AttributesResponse' attributes: K8S Secret name to mount for username and password.
        :param builtins.str trusted_client_ca_cert_config_map: Trusted client ca cert config map.
        """
    ...
    def trusted_client_ca_cert_config_map(self) -> Optional[builtins.str]:
        """
...
class BrokerDiagnosticsResponse(dict):
    ...
    def __init__(__self__, *,
                 diagnostic_service_endpoint: Optional[builtins.str] = None,
                 enable_metrics: Optional[builtins.bool] = None,
                 enable_self_check: Optional[builtins.bool] = None,
                 enable_self_tracing: Optional[builtins.bool] = None,
                 enable_tracing: Optional[builtins.bool] = None,
                 log_format: Optional[builtins.str] = None,
                 log_level: Optional[builtins.str] = None,
                 max_cell_map_lifetime: Optional[builtins.float] = None,
                 metric_update_frequency_seconds: Optional[builtins.float] = None,
                 probe_image: Optional[builtins.str] = None,
                 self_check_frequency_seconds: Optional[builtins.float] = None,
                 self_check_timeout_seconds: Optional[builtins.float] = None,
                 self_trace_frequency_seconds: Optional[builtins.float] = None,
                 span_channel_capacity: Optional[builtins.float] = None):
        """
        Diagnostics setting specific to Broker
        :param builtins.str diagnostic_service_endpoint: Diagnostic Service endpoint
        :param builtins.bool enable_metrics: Knob to enable/disable metrics. Default = true
        :param builtins.bool enable_self_check: Enable self check on Broker via Probe.
        :param builtins.bool enable_self_tracing: Enable self tracing on the Broker so that every selfCheckFrequencySeconds a random message is traced even if it didn't have trace context.
        :param builtins.bool enable_tracing: Knob to enable/disable entire tracing infrastructure.
        :param builtins.str log_format: Format for the logs generated.
        :param builtins.str log_level: Log level for the Broker.
        :param builtins.float max_cell_map_lifetime: Maximum time for the CellMap to live.
        :param builtins.float metric_update_frequency_seconds: Metric update frequency in seconds.
        :param builtins.str probe_image: Probe Image to run.
        :param builtins.float self_check_frequency_seconds: Frequency for the self check to run.
        :param builtins.float self_check_timeout_seconds: Time out period of the self check.
        :param builtins.float self_trace_frequency_seconds: The frequency at which selfTrace should run.
        :param builtins.float span_channel_capacity: The number of the spans generated by the Tracing.
        """
    ...
    def diagnostic_service_endpoint(self) -> Optional[builtins.str]:
        """
    ...
    def enable_self_check(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_self_tracing(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_tracing(self) -> Optional[builtins.bool]:
        """
    ...
    def max_cell_map_lifetime(self) -> Optional[builtins.float]:
        """
    ...
    def metric_update_frequency_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def probe_image(self) -> Optional[builtins.str]:
        """
        Probe Image to run.
        """
    ...
    def self_check_frequency_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def self_check_timeout_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def self_trace_frequency_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def span_channel_capacity(self) -> Optional[builtins.float]:
        """
...
class CertManagerCertOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cert Manager CA Cert properties
        :param builtins.str duration: Duration of CA cert.
        :param 'CertManagerPrivateKeyResponse' private_key: Cert Manager private key.
        :param builtins.str renew_before: Renew before time of CA cert.
        """
        if duration is None:
            duration = '720h'
        pulumi.set(__self__, "duration", duration)
...
class CertManagerPrivateKeyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rotation_policy: Optional[builtins.str] = None,
                 size: Optional[builtins.int] = None):
        """
        Cert Manager private key properties
        :param builtins.str algorithm: algorithm for private key.
        :param builtins.str rotation_policy: cert-manager rotationPolicy.
        :param builtins.int size: size of private key.
        """
...
class ContainerImageResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pull_secrets: Optional[builtins.str] = None):
        """
        Defines the Docker image details
        :param builtins.str repository: The Docker image name.
        :param builtins.str tag: The Docker  image tag.
        :param builtins.str pull_policy: Image pull policy.
        :param builtins.str pull_secrets: Image pull secrets.
        """
    ...
    def pull_secrets(self) -> Optional[builtins.str]:
        """
        Image pull secrets.
        """
...
class DataLakeConnectorMapResponse(dict):
    ...
    def __init__(__self__, *,
                 allowed_latency_secs: builtins.int,
                 client_id: builtins.str,
                 max_messages_per_batch: builtins.float,
                 message_payload_type: builtins.str,
                 mqtt_source_topic: builtins.str,
                 table: 'outputs.DeltaTableResponse',
                 qos: Optional[builtins.int] = None):
        """
        DataLake connector map route properties
        :param builtins.int allowed_latency_secs: Allowed latency for transferring data.
        :param builtins.str client_id: Client Id to use.
        :param builtins.float max_messages_per_batch: Maximum messages to send per Batch.
        :param builtins.str message_payload_type: Message payload type.
        :param builtins.str mqtt_source_topic: Mqtt source topic.
        :param 'DeltaTableResponse' table: Delta table properties to use.
        :param builtins.int qos: Quality of Service.
        """
    ...
    def allowed_latency_secs(self) -> builtins.int:
        """
    ...
    def max_messages_per_batch(self) -> builtins.float:
        """
    ...
    def message_payload_type(self) -> builtins.str:
        """
    ...
    def mqtt_source_topic(self) -> builtins.str:
        """
        Mqtt source topic.
        """
...
class DataLakeFabricStorageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str endpoint: DataLake fabric storage endpoint to use.
        :param builtins.str fabric_path: Fabric path type to use.
    ...
    def fabric_path(self) -> builtins.str:
        """
...
class DataLakeLocalStorageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        DataLake Local Storage details.
        :param builtins.str volume_name: Volume name to write to.
        """
...
class DataLakeServiceStorageAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 access_token_secret_name: Optional[builtins.str] = None,
                 system_assigned_managed_identity: Optional['outputs.ManagedIdentityAuthenticationResponse'] = None):
        """
        DataLake Service Storage authentication details. NOTE - Enum only one method is supported.
        :param builtins.str access_token_secret_name: Access token secret name.
        :param 'ManagedIdentityAuthenticationResponse' system_assigned_managed_identity: Configuration for managed identity authentication.
        """
    ...
    def access_token_secret_name(self) -> Optional[builtins.str]:
        """
...
class DataLakeServiceStorageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str endpoint: DataLake service storage endpoint to use.
        """
        pulumi.set(__self__, "authentication", authentication)
        pulumi.set(__self__, "endpoint", endpoint)
...
class DeltaTableResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 table_path: Optional[builtins.str] = None):
        """
        Delta table properties
        :param Sequence['DeltaTableSchemaResponse'] schema: Schema list supported.
        :param builtins.str table_name: Delta table name.
        :param builtins.str table_path: Delta table path.
        """
    ...
    def table_path(self) -> Optional[builtins.str]:
        """
        Delta table path.
        """
...
class DeltaTableSchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Delta table schema properties
        :param builtins.str format: Delta table format supported.
        :param builtins.str mapping: Delta table schema mapping.
        :param builtins.str name: Delta table schema name.
        :param builtins.bool optional: Delta table schema optional.
        """
...
class FabricGuidsResponse(dict):
    ...
    def __init__(__self__, *,
                 lakehouse_guid: builtins.str,
                 workspace_guid: builtins.str):
        """
        Fabric one lake guids.
        :param builtins.str lakehouse_guid: Fabric one lake house guid.
        :param builtins.str workspace_guid: Fabric one lake workspace guid.
        """
...
class FabricNamesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Fabric one lake names.
        :param builtins.str lakehouse_name: Fabric one lake house name.
        :param builtins.str workspace_name: Fabric one lake workspace name.
        """
...
class FrontendResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Desired properties of the Frontend Instances of the DMQTT Broker
        :param builtins.int replicas: Replicas is desired number of frontend replicas of the given distributed MQTT broker.
        ...
        :param builtins.int workers: Number of logical frontend workers per pod.
        """
...
class KafkaRemoteBrokerAuthenticationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Kafka RemoteBrokerConnection Authentication methods
        :param builtins.bool enabled: If authentication is enabled for Kafka remote broker.
...
class KafkaRemoteBrokerConnectionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str endpoint: The endpoint of remote broker to connect to.
...
class KafkaRemoteBrokerConnectionTlsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trusted_ca_certificate_config_map: Optional[builtins.str] = None):
        """
        Kafka RemoteBrokerConnection TLS details
        :param builtins.bool tls_enabled: Tls Enabled on Remote Broker Connection.
        :param builtins.str trusted_ca_certificate_config_map: Trusted CA certificate name for Remote Broker.
        """
    ...
    def trusted_ca_certificate_config_map(self) -> Optional[builtins.str]:
        """
...
class KafkaSharedSubscriptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 group_minimum_share_number: builtins.int,
                 group_name: builtins.str):
        """
        Kafka Shared Subscription properties
        :param builtins.int group_minimum_share_number: The minimum number to use in a group for subscription.
        :param builtins.str group_name: The name of the shared subscription.
        """
    ...
    def group_minimum_share_number(self) -> builtins.int:
        """
...
class KafkaToMqttRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Kafka to Mqtt route properties
        :param builtins.str kafka_topic: The kafka topic to pull from.
        :param builtins.str mqtt_topic: The mqtt topic to publish to.
        :param builtins.str name: The name of the route.
        :param builtins.str consumer_group_id: The consumer group id to use.
        :param builtins.int qos: The qos to use for mqtt.
        """
...
class KafkaTokenKeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str username: Username to connect with.
        """
...
class KafkaTopicMapBatchingResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_bytes: Optional[builtins.float] = None,
                 max_messages: Optional[builtins.float] = None):
        """
        Kafka TopicMap Batching properties
        :param builtins.bool enabled: The setting to enable or disable batching.
        :param builtins.int latency_ms: The latency of message batching.
        :param builtins.float max_bytes: The maximum bytes to send in a batch.
        :param builtins.float max_messages: The maximum messages to send in a batch.
        """
        if enabled is None:
            enabled = False
    ...
    def max_bytes(self) -> Optional[builtins.float]:
        """
    ...
    def max_messages(self) -> Optional[builtins.float]:
        """
...
class KeyVaultConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str directory_id: KeyVault directoryId.
        :param builtins.str name: KeyVault name.
        """
...
class KeyVaultCredentialsPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 service_principal_local_secret_name: builtins.str):
        """
        KeyVault credentials properties. NOTE - Future this will be ENUM.
        :param builtins.str service_principal_local_secret_name: KeyVault service principal local secret name.
        """
    ...
    def service_principal_local_secret_name(self) -> builtins.str:
        """
...
class KeyVaultSecretObjectResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        KeyVault secret object properties
        :param builtins.str name: KeyVault secret name.
        :param builtins.str version: KeyVault secret version.
        """
        pulumi.set(__self__, "name", name)
...
class LocalBrokerConnectionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str endpoint: The endpoint of local broker to connect to.
...
class LocalBrokerConnectionTlsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Mqtt Local Broker Connection TLS details
        :param builtins.bool tls_enabled: Tls Enabled on Local Broker Connection.
        :param builtins.str trusted_ca_certificate_config_map: Trusted CA certificate config map name for Local Broker.
        """
...
class LocalBrokerKubernetesAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 secret_path: Optional[builtins.str] = None,
                 service_account_token_name: Optional[builtins.str] = None):
        """
        Local Broker Kubernetes Authentication
        :param builtins.str secret_path: Secret Path where SAT is mounted.
        :param builtins.str service_account_token_name: Token name where SAT is mounted on secret path.
        """
    ...
    def secret_path(self) -> Optional[builtins.str]:
        """
    ...
    def service_account_token_name(self) -> Optional[builtins.str]:
        """
...
class ManagedIdentityAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Managed identity authentication details.
        :param builtins.str audience: Token audience.
        :param builtins.str extension_name: Arc Extension name.
        """
    ...
    def extension_name(self) -> Optional[builtins.str]:
        """
        Arc Extension name.
        """
...
class ManualCertMethodResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Manual TLS server certificate management through a defined secret
        :param builtins.str secret_name: secret containing TLS cert.
        :param builtins.str secret_namespace: namespace of secret; omit to use default namespace.
        """
        pulumi.set(__self__, "secret_name", secret_name)
        if secret_namespace is not None:
            pulumi.set(__self__, "secret_namespace", secret_namespace)
...
class MqttBridgeRemoteBrokerConnectionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str protocol: Protocol for remote connection.
        """
        pulumi.set(__self__, "authentication", authentication)
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "tls", tls)
...
class MqttBridgeRouteSharedSubscriptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        MqttBridgeRoute Shared subscription properties
        :param builtins.int group_minimum_share_number: The group shared subscription minimum share number.
        :param builtins.str group_name: The group name for Shared subscription.
        """
        pulumi.set(__self__, "group_minimum_share_number", group_minimum_share_number)
        pulumi.set(__self__, "group_name", group_name)
...
class MqttBridgeRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        MqttBridgeTopicMap route properties
        :param builtins.str direction: Direction of the route.
        :param builtins.str name: Name of the route.
        :param builtins.str source: Source topic of the route.
        :param builtins.int qos: Qos for MQTT connection.
        :param 'MqttBridgeRouteSharedSubscriptionResponse' shared_subscription: Shared subscription topic details.
        :param builtins.str target: Target topic of the route. Ignore if same as source
        """
...
class MqttToKafkaRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Mqtt to Kafka route properties
        :param builtins.str kafka_acks: The kafka acks to use.
        :param builtins.str kafka_topic: The kafka topic to publish to.
        :param builtins.str mqtt_topic: The mqtt topic to pull from.
        :param builtins.str name: The name of the route.
        :param builtins.int qos: The qos to use for mqtt.
    ...
    def kafka_acks(self) -> builtins.str:
        """
...
class NodeTolerationsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the Node Tolerations details
        :param builtins.str effect: Toleration effect.
        :param builtins.str key: Toleration key.
        :param builtins.str operator: Toleration operator like 'Exists', 'Equal' etc.
        :param builtins.str value: Toleration Value.
        """
...
class PrincipalDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 clientids: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] clientids: A list of client IDs that match the clients. The client IDs are case-sensitive and must match the client IDs provided by the clients during connection.
    ...
    @property
    @pulumi.getter
    def clientids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResourceInfoDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ResourceInfoDefinition properties of Basic Rule. This defines the objects that represent the actions or topics, such as - method.Connect, method.Publish, etc.
        :param builtins.str method: The type of action that the clients can perform on the broker: Connect, Publish or Subscribe.
...
class SaslRemoteBrokerBasicAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Kafka RemoteBrokerConnection Sasl Authentication properties.
        :param builtins.str sasl_type: Sasl Mechanism for remote broker authentication.
...
class TemporaryResourceLimitsConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 max_inflight_messages: builtins.int,
                 max_inflight_patches: builtins.int,
                 max_inflight_patches_per_client: builtins.int,
                 max_queued_messages: builtins.float,
                 max_queued_qos0_messages: builtins.float,
                 max_session_expiry_secs: builtins.float,
                 max_message_expiry_secs: Optional[builtins.float] = None):
        """
        Internal knobs of Resource Limits for FE and BE
        :param builtins.int max_inflight_messages: Maximum number of messages a client can have inflight.
        :param builtins.int max_inflight_patches: Maximum number of patch inflight per node.
        :param builtins.int max_inflight_patches_per_client: Maximum number of patch a client can have in flight.
        :param builtins.float max_queued_messages: Maximum receive for external clients.
        :param builtins.float max_queued_qos0_messages: Maximum receive QoS0 for external clients.
        :param builtins.float max_session_expiry_secs: Maximum session expiry interval, in seconds.
        :param builtins.float max_message_expiry_secs: Maximum message expiry interval, in seconds.
        """
    ...
    def max_inflight_messages(self) -> builtins.int:
        """
    ...
    def max_inflight_patches(self) -> builtins.int:
        """
    ...
    def max_inflight_patches_per_client(self) -> builtins.int:
        """
    ...
    def max_queued_messages(self) -> builtins.float:
        """
    ...
    def max_queued_qos0_messages(self) -> builtins.float:
        """
    ...
    def max_session_expiry_secs(self) -> builtins.float:
        """
    ...
    def max_message_expiry_secs(self) -> Optional[builtins.float]:
        """
