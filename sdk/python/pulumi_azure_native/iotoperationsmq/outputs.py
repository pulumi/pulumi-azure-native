...
class AuthorizationConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_cache: Optional[_builtins.bool] = None,
...
class AutomaticCertMethodResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str renew_before: When to begin renewing automatically-managed certificate.
        :param 'SanForCertResponse' san: Additional SANs to include in the certificate.
        :param _builtins.str secret_name: Secret for storing server certificate. Any existing data will be overwritten.
        :param _builtins.str secret_namespace: Certificate K8S namespace. Omit to use default namespace.
        """
...
class BackendChainResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 temporary_disk_transfer_enabled: Optional[_builtins.bool] = None,
                 temporary_disk_transfer_high_watermark_percent: Optional[_builtins.int] = None,
                 temporary_disk_transfer_low_watermark_percent: Optional[_builtins.int] = None,
                 temporary_max_backend_mem_usage_percent: Optional[_builtins.int] = None,
        ...
        :param _builtins.int temporary_disk_transfer_high_watermark_percent: Defines the percentage usage of buffer pool above which disk transfer will start.
        :param _builtins.int temporary_disk_transfer_low_watermark_percent: Defines the percentage usage of buffer pool below which disk transfer will stop.
        :param _builtins.int temporary_max_backend_mem_usage_percent: Defines the limits for memory usage percent of the backend instances of the MQTT broker.
        ...
        :param _builtins.int workers: Number of logical backend workers per pod.
        """
...
class BrokerAuthenticatorMethodCustomResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] headers: Configuration Headers to use.
        """
...
class BrokerAuthenticatorMethodSvidResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 identity_max_retry: Optional[_builtins.float] = None,
...
class BrokerDiagnosticsResponse(dict):
    ...
    def __init__(__self__, *,
                 diagnostic_service_endpoint: Optional[_builtins.str] = None,
                 enable_metrics: Optional[_builtins.bool] = None,
                 enable_self_check: Optional[_builtins.bool] = None,
                 enable_self_tracing: Optional[_builtins.bool] = None,
                 enable_tracing: Optional[_builtins.bool] = None,
                 log_format: Optional[_builtins.str] = None,
                 log_level: Optional[_builtins.str] = None,
                 max_cell_map_lifetime: Optional[_builtins.float] = None,
                 metric_update_frequency_seconds: Optional[_builtins.float] = None,
                 probe_image: Optional[_builtins.str] = None,
                 self_check_frequency_seconds: Optional[_builtins.float] = None,
                 self_check_timeout_seconds: Optional[_builtins.float] = None,
                 self_trace_frequency_seconds: Optional[_builtins.float] = None,
        ...
        :param _builtins.bool enable_self_tracing: Enable self tracing on the Broker so that every selfCheckFrequencySeconds a random message is traced even if it didn't have trace context.
        :param _builtins.bool enable_tracing: Knob to enable/disable entire tracing infrastructure.
        :param _builtins.str log_format: Format for the logs generated.
        :param _builtins.str log_level: Log level for the Broker.
        :param _builtins.float max_cell_map_lifetime: Maximum time for the CellMap to live.
        :param _builtins.float metric_update_frequency_seconds: Metric update frequency in seconds.
        :param _builtins.str probe_image: Probe Image to run.
        :param _builtins.float self_check_frequency_seconds: Frequency for the self check to run.
        :param _builtins.float self_check_timeout_seconds: Time out period of the self check.
        :param _builtins.float self_trace_frequency_seconds: The frequency at which selfTrace should run.
        :param _builtins.float span_channel_capacity: The number of the spans generated by the Tracing.
        """
...
class CertManagerPrivateKeyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rotation_policy: Optional[_builtins.str] = None,
...
class ContainerImageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str pull_secrets: Image pull secrets.
        """
...
class DataLakeConnectorMapResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str message_payload_type: Message payload type.
        :param _builtins.str mqtt_source_topic: Mqtt source topic.
        :param 'DeltaTableResponse' table: Delta table properties to use.
        :param _builtins.int qos: Quality of Service.
        """
...
class DataLakeServiceStorageAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
                 access_token_secret_name: Optional[_builtins.str] = None,
...
class DeltaTableSchemaResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool optional: Delta table schema optional.
        """
...
class KafkaToMqttRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str consumer_group_id: The consumer group id to use.
        :param _builtins.int qos: The qos to use for mqtt.
        """
...
class KafkaTopicMapBatchingResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_bytes: Optional[_builtins.float] = None,
        ...
        :param _builtins.float max_messages: The maximum messages to send in a batch.
        """
        if enabled is None:
            enabled = False
...
class MqttBridgeRemoteBrokerConnectionSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str protocol: Protocol for remote connection.
        """
        pulumi.set(__self__, "authentication", authentication)
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "tls", tls)
...
class MqttBridgeRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int qos: Qos for MQTT connection.
        :param 'MqttBridgeRouteSharedSubscriptionResponse' shared_subscription: Shared subscription topic details.
        :param _builtins.str target: Target topic of the route. Ignore if same as source
        """
...
class PrincipalDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 clientids: Optional[Sequence[_builtins.str]] = None,
...
class TemporaryResourceLimitsConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float max_queued_messages: Maximum receive for external clients.
        :param _builtins.float max_queued_qos0_messages: Maximum receive QoS0 for external clients.
        :param _builtins.float max_session_expiry_secs: Maximum session expiry interval, in seconds.
        :param _builtins.float max_message_expiry_secs: Maximum message expiry interval, in seconds.
        """
