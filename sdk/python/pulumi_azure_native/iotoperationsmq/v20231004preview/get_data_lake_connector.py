...
def get_data_lake_connector(data_lake_connector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperationsmq/v20231004preview:getDataLakeConnector', __args__, opts=opts, typ=GetDataLakeConnectorResult).value
