...
class KafkaConnectorTopicMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq:KafkaConnectorTopicMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KafkaConnectorTopicMap, __self__).__init__(
            'azure-native:iotoperationsmq/v20231004preview:KafkaConnectorTopicMap',
            resource_name,
            __props__,
            opts)
