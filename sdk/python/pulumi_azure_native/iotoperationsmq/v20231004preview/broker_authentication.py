...
class BrokerAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 listener_ref: pulumi.Input[Sequence[pulumi.Input[str]]],
    ...
    def listener_ref(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    @listener_ref.setter
    def listener_ref(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
        pulumi.set(self, "listener_ref", value)
...
class BrokerAuthentication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if listener_ref is None and not opts.urn:
                raise TypeError("Missing required property 'listener_ref'")
            __props__.__dict__["listener_ref"] = listener_ref
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq:BrokerAuthentication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerAuthentication, __self__).__init__(
            'azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="authenticationMethods")
    def authentication_methods(self) -> pulumi.Output[Sequence['outputs.BrokerAuthenticatorMethodsResponse']]:
        """
        The list of authentication methods supported by the Authentication Resource. For each array element, NOTE - Enum only authenticator type supported.
        """
        return pulumi.get(self, "authentication_methods")
    ...
    @property
    @pulumi.getter(name="listenerRef")
    def listener_ref(self) -> pulumi.Output[Sequence[str]]:
        """
        The array of listener Resources it supports.
        """
        return pulumi.get(self, "listener_ref")
