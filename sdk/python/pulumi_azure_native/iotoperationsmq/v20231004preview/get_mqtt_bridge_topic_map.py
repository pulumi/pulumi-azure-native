...
class GetMqttBridgeTopicMapResult:
    ...
    def mqtt_bridge_connector_ref(self) -> str:
        """
...
def get_mqtt_bridge_topic_map(mq_name: Optional[str] = None,
    ...
    :param str topic_map_name: Name of MQ mqttBridgeTopicMap resource
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperationsmq/v20231004preview:getMqttBridgeTopicMap', __args__, opts=opts, typ=GetMqttBridgeTopicMapResult).value
...
@_utilities.lift_output_func(get_mqtt_bridge_topic_map)
