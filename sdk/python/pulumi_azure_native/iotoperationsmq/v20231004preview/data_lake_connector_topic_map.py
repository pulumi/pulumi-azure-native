...
class DataLakeConnectorTopicMapArgs:
    def __init__(__self__, *,
                 data_lake_connector_name: pulumi.Input[str],
                 data_lake_connector_ref: pulumi.Input[str],
        ...
        :param pulumi.Input[str] topic_map_name: Name of MQ dataLakeConnector/topicMap resource
        """
    ...
    def data_lake_connector_name(self) -> pulumi.Input[str]:
        """
    ...
    def data_lake_connector_name(self, value: pulumi.Input[str]):
        pulumi.set(self, "data_lake_connector_name", value)

    @property
    @pulumi.getter(name="dataLakeConnectorRef")
    def data_lake_connector_ref(self) -> pulumi.Input[str]:
        """
    ...
    def data_lake_connector_ref(self, value: pulumi.Input[str]):
        pulumi.set(self, "data_lake_connector_ref", value)
...
class DataLakeConnectorTopicMap(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataLakeConnectorTopicMapArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataLakeConnectorTopicMapArgs.__new__(DataLakeConnectorTopicMapArgs)
            ...
            if data_lake_connector_ref is None and not opts.urn:
                raise TypeError("Missing required property 'data_lake_connector_ref'")
            __props__.__dict__["data_lake_connector_ref"] = data_lake_connector_ref
            if extended_location is None and not opts.urn:
                raise TypeError("Missing required property 'extended_location'")
            __props__.__dict__["extended_location"] = extended_location
            __props__.__dict__["location"] = location
            if mapping is None and not opts.urn:
                raise TypeError("Missing required property 'mapping'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq:DataLakeConnectorTopicMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataLakeConnectorTopicMap, __self__).__init__(
            'azure-native:iotoperationsmq/v20231004preview:DataLakeConnectorTopicMap',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DataLakeConnectorTopicMap':
        """
        ...
        __props__.__dict__["data_lake_connector_ref"] = None
        ...
        __props__.__dict__["type"] = None
        return DataLakeConnectorTopicMap(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="dataLakeConnectorRef")
    def data_lake_connector_ref(self) -> pulumi.Output[str]:
        """
        DataLake Connector CRD to use.
        """
        return pulumi.get(self, "data_lake_connector_ref")
