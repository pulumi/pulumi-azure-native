...
class BrokerAuthorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["authorization_policies"] = authorization_policies
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq:BrokerAuthorization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BrokerAuthorization, __self__).__init__(
            'azure-native:iotoperationsmq/v20231004preview:BrokerAuthorization',
            resource_name,
            __props__,
            opts)
