...
def get_kafka_connector_topic_map(kafka_connector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperationsmq/v20231004preview:getKafkaConnectorTopicMap', __args__, opts=opts, typ=GetKafkaConnectorTopicMapResult).value
...
def get_kafka_connector_topic_map_output(kafka_connector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['topicMapName'] = topic_map_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperationsmq/v20231004preview:getKafkaConnectorTopicMap', __args__, opts=opts, typ=GetKafkaConnectorTopicMapResult)
