...
def get_mqtt_bridge_connector(mq_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperationsmq/v20231004preview:getMqttBridgeConnector', __args__, opts=opts, typ=GetMqttBridgeConnectorResult).value
...
def get_mqtt_bridge_connector_output(mq_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperationsmq/v20231004preview:getMqttBridgeConnector', __args__, opts=opts, typ=GetMqttBridgeConnectorResult)
