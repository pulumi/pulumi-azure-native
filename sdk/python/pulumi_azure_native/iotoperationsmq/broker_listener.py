...
class BrokerListenerArgs:
    def __init__(__self__, *,
                 ...
                 broker_ref: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] broker_ref: The k8s cr/resource reference of mq/broker.
        ...
        :param pulumi.Input[builtins.int] port: The port to start Listening for connections on.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.bool] authentication_enabled: The flag for enabling Authentication rules on Listener Port.
        :param pulumi.Input[builtins.bool] authorization_enabled: The flag for enabling Authorization policies on Listener Port. false - AllowAll, true - Use Authorization resource rules if present.
        :param pulumi.Input[builtins.str] listener_name: Name of MQ broker/listener resource
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.int] node_port: The node port to use on the Host node.
        :param pulumi.Input[builtins.str] service_name: The service name to expose Listener port on.
        :param pulumi.Input[Union[builtins.str, 'ServiceType']] service_type: The Kubernetes Service type to deploy for Listener.
    ...
    def broker_ref(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @broker_ref.setter
    def broker_ref(self, value: pulumi.Input[builtins.str]):
...
class BrokerListener(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:iotoperationsmq:BrokerListener"
    ...
    def __init__(__self__,
                 ...
                 broker_ref: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="authenticationEnabled")
    def authentication_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The flag for enabling Authentication rules on Listener Port.
        """
        return pulumi.get(self, "authentication_enabled")
    ...
    @property
    @pulumi.getter(name="authorizationEnabled")
    def authorization_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The flag for enabling Authorization policies on Listener Port. false - AllowAll, true - Use Authorization resource rules if present.
        """
        return pulumi.get(self, "authorization_enabled")
    ...
    @property
    @pulumi.getter(name="brokerRef")
    def broker_ref(self) -> pulumi.Output[builtins.str]:
        """
        The k8s cr/resource reference of mq/broker.
        """
        return pulumi.get(self, "broker_ref")
    ...
    @property
    @pulumi.getter(name="nodePort")
    def node_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The node port to use on the Host node.
        """
        return pulumi.get(self, "node_port")
