...
class KafkaConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] instances: The number of KafkaConnector pods to spin up.
    ...
    def kafka_connector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kafka_connector_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KafkaConnector(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:iotoperationsmq:KafkaConnector"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsmq/v20231004preview:KafkaConnector")])
