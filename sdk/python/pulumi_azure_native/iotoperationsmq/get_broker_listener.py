...
class GetBrokerListenerResult:
    ...
    def authorization_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def broker_ref(self) -> builtins.str:
        """
...
def get_broker_listener(broker_name: Optional[builtins.str] = None,
    ...
    :param builtins.str listener_name: Name of MQ broker/listener resource
...
def get_broker_listener_output(broker_name: Optional[pulumi.Input[builtins.str]] = None,
