...
warnings.warn("""Version 2019-05-13 will be removed in v2 of the provider.""", DeprecationWarning)
...
class ProtectedItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ProtectedItem is deprecated: Version 2019-05-13 will be removed in v2 of the provider.""")
