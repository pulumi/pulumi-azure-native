...
warnings.warn("""azure-native:recoveryservices/v20211001:ReplicationFabric is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_fabric(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_fabric is deprecated: azure-native:recoveryservices/v20211001:ReplicationFabric is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.""")
    __args__ = dict()
