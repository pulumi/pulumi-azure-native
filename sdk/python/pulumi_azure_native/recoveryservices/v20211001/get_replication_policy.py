...
def get_replication_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_policy is deprecated: azure-native:recoveryservices/v20211001:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
