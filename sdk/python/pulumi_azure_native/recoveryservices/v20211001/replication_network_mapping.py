...
warnings.warn("""azure-native:recoveryservices/v20211001:ReplicationNetworkMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationNetworkMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationNetworkMapping is deprecated: azure-native:recoveryservices/v20211001:ReplicationNetworkMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.""")
