...
warnings.warn("""azure-native:recoveryservices/v20211001:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_recovery_plan(recovery_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_recovery_plan is deprecated: azure-native:recoveryservices/v20211001:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['recoveryPlanName'] = recovery_plan_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20211001:getReplicationRecoveryPlan', __args__, opts=opts, typ=GetReplicationRecoveryPlanResult).value
