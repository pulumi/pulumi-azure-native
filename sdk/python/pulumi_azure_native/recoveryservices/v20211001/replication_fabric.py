...
class ReplicationFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationFabric is deprecated: azure-native:recoveryservices/v20211001:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.""")
        ...
        super(ReplicationFabric, __self__).__init__(
            'azure-native:recoveryservices/v20211001:ReplicationFabric',
            resource_name,
            __props__,
            opts)
