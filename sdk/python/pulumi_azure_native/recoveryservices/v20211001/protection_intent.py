...
warnings.warn("""azure-native:recoveryservices/v20211001:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.""", DeprecationWarning)
...
class ProtectionIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ProtectionIntent, __self__).__init__(
            'azure-native:recoveryservices/v20211001:ProtectionIntent',
            resource_name,
            __props__,
            opts)
