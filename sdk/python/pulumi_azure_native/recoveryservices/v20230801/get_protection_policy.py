...
def get_protection_policy(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20230801:getProtectionPolicy', __args__, opts=opts, typ=GetProtectionPolicyResult).value
...
def get_protection_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20230801:getProtectionPolicy', __args__, opts=opts, typ=GetProtectionPolicyResult)
