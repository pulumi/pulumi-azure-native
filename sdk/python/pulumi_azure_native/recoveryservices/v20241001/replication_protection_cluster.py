...
class ReplicationProtectionCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:ReplicationProtectionCluster"), pulumi.Alias(type_="azure-native:recoveryservices/v20240201:ReplicationProtectionCluster"), pulumi.Alias(type_="azure-native:recoveryservices/v20240401:ReplicationProtectionCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationProtectionCluster, __self__).__init__(
            'azure-native:recoveryservices/v20241001:ReplicationProtectionCluster',
            resource_name,
            __props__,
            opts)
