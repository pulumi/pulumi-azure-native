...
def get_resource_guard_proxy(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20241101preview:getResourceGuardProxy', __args__, opts=opts, typ=GetResourceGuardProxyResult).value
...
def get_resource_guard_proxy_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20241101preview:getResourceGuardProxy', __args__, opts=opts, typ=GetResourceGuardProxyResult)
