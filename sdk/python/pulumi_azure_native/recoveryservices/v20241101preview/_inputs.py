...
if not MYPY:
    class AzureVmWorkloadProtectionPolicyArgsDict(TypedDict):
        ...
        """
        vm_workload_policy_type: NotRequired[pulumi.Input[Union[str, 'VMWorkloadPolicyType']]]
        """
        Type of workload for the backup management
        """
        work_load_type: NotRequired[pulumi.Input[Union[str, 'WorkloadType']]]
...
class AzureVmWorkloadProtectionPolicyArgs:
    def __init__(__self__, *,
                 ...
                 vm_workload_policy_type: Optional[pulumi.Input[Union[str, 'VMWorkloadPolicyType']]] = None,
                 work_load_type: Optional[pulumi.Input[Union[str, 'WorkloadType']]] = None):
        """
        Azure VM (Mercury) workload-specific backup policy.
        :param pulumi.Input[str] backup_management_type: This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
        ...
        :param pulumi.Input[Union[str, 'VMWorkloadPolicyType']] vm_workload_policy_type: Type of workload for the backup management
        :param pulumi.Input[Union[str, 'WorkloadType']] work_load_type: Type of workload for the backup management
        """
    ...
    def vm_workload_policy_type(self) -> Optional[pulumi.Input[Union[str, 'VMWorkloadPolicyType']]]:
        """
        Type of workload for the backup management
        """
        return pulumi.get(self, "vm_workload_policy_type")

    @vm_workload_policy_type.setter
    def vm_workload_policy_type(self, value: Optional[pulumi.Input[Union[str, 'VMWorkloadPolicyType']]]):
        pulumi.set(self, "vm_workload_policy_type", value)
