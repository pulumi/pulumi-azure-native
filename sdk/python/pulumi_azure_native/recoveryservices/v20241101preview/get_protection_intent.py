...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20241101preview:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult).value
...
def get_protection_intent_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20241101preview:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult)
