...
class AzureVmWorkloadProtectionPolicyResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "vmWorkloadPolicyType":
            suggest = "vm_workload_policy_type"
        elif key == "workLoadType":
            suggest = "work_load_type"
    ...
    def __init__(__self__, *,
                 ...
                 vm_workload_policy_type: Optional[str] = None,
                 work_load_type: Optional[str] = None):
        """
        Azure VM (Mercury) workload-specific backup policy.
        :param str backup_management_type: This property will be used as the discriminator for deciding the specific types in the polymorphic chain of types.
        ...
        :param str vm_workload_policy_type: Type of workload for the backup management
        :param str work_load_type: Type of workload for the backup management
        """
        ...
        if vm_workload_policy_type is not None:
            pulumi.set(__self__, "vm_workload_policy_type", vm_workload_policy_type)
        if work_load_type is not None:
            pulumi.set(__self__, "work_load_type", work_load_type)
    ...
    @property
    @pulumi.getter(name="vmWorkloadPolicyType")
    def vm_workload_policy_type(self) -> Optional[str]:
        """
        Type of workload for the backup management
        """
        return pulumi.get(self, "vm_workload_policy_type")
