...
class ProtectionContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        protection_container = azure_native.recoveryservices.v20230201.ProtectionContainer("protectionContainer",
            container_name="StorageContainer;Storage;SwaggerTestRg;swaggertestsa",
            fabric_name="Azure",
            properties=azure_native.recoveryservices.v20230201.AzureStorageContainerArgs(
