...
class ReplicationNetworkMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_network_mapping = azure_native.recoveryservices.v20230201.ReplicationNetworkMapping("replicationNetworkMapping",
            ...
            properties=azure_native.recoveryservices.v20230201.NetworkMappingPropertiesResponseArgs(
                fabric_specific_details=azure_native.recoveryservices.v20230201.VmmToAzureCreateNetworkMappingInputArgs(
