...
class ReplicationMigrationItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_migration_item = azure_native.recoveryservices.v20230201.ReplicationMigrationItem("replicationMigrationItem",
            fabric_name="vmwarefabric1",
            migration_item_name="virtualmachine1",
            properties=azure_native.recoveryservices.v20230201.MigrationItemPropertiesResponseArgs(
                ...
                provider_specific_details=azure_native.recoveryservices.v20230201.VMwareCbtMigrationDetailsResponseArgs(
                    ...
                    disks_to_include=[azure_native.recoveryservices.v20230201.VMwareCbtDiskInputArgs(
                        disk_id="disk1",
                        is_os_disk="true",
