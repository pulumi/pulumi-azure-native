...
warnings.warn("""azure-native:recoveryservices/v20230201:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationProtectedItem is deprecated: azure-native:recoveryservices/v20230201:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.""")
        ...
        super(ReplicationProtectedItem, __self__).__init__(
            'azure-native:recoveryservices/v20230201:ReplicationProtectedItem',
            resource_name,
            __props__,
            opts)
