...
def get_replication_storage_classification_mapping(fabric_name: Optional[builtins.str] = None,
                                                   resource_group_name: Optional[builtins.str] = None,
                                                   resource_name: Optional[builtins.str] = None,
                                                   storage_classification_mapping_name: Optional[builtins.str] = None,
                                                   storage_classification_name: Optional[builtins.str] = None,
    ...
    :param builtins.str storage_classification_mapping_name: Storage classification mapping name.
    :param builtins.str storage_classification_name: Storage classification name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices:getReplicationStorageClassificationMapping', __args__, opts=opts, typ=GetReplicationStorageClassificationMappingResult).value
...
def get_replication_storage_classification_mapping_output(fabric_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationStorageClassificationMapping', __args__, opts=opts, typ=GetReplicationStorageClassificationMappingResult)
