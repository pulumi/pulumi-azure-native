...
def get_protection_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_policy is deprecated: azure-native:recoveryservices/v20201201:ProtectionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
