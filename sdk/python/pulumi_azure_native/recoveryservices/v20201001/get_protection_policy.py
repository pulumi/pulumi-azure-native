...
warnings.warn("""azure-native:recoveryservices/v20201001:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_protection_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_policy is deprecated: azure-native:recoveryservices/v20201001:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
