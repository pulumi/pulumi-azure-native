...
warnings.warn("""azure-native:recoveryservices/v20210701:ProtectionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ProtectionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ProtectionPolicy is deprecated: azure-native:recoveryservices/v20210701:ProtectionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.""")
