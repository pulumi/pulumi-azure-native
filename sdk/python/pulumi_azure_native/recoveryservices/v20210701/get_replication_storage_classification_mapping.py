...
def get_replication_storage_classification_mapping(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210701:getReplicationStorageClassificationMapping', __args__, opts=opts, typ=GetReplicationStorageClassificationMappingResult).value
...
def get_replication_storage_classification_mapping_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20210701:getReplicationStorageClassificationMapping', __args__, opts=opts, typ=GetReplicationStorageClassificationMappingResult)
