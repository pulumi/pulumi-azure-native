...
def get_protection_container(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_container is deprecated: azure-native:recoveryservices/v20210701:ProtectionContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210701:getProtectionContainer', __args__, opts=opts, typ=GetProtectionContainerResult).value
