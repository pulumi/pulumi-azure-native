...
class ResourceGuardProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:ResourceGuardProxy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201preview:ResourceGuardProxy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210801:ResourceGuardProxy"), pulumi.Alias(type_="azure-native:recoveryservices/v20211001:ResourceGuardProxy")])
