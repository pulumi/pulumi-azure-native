...
warnings.warn("""azure-native:recoveryservices/v20210701:ProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_protected_item(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protected_item is deprecated: azure-native:recoveryservices/v20210701:ProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210701:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult).value
