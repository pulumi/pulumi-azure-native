...
def get_protected_item(container_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20240401:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult).value
...
def get_protected_item_output(container_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20240401:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult)
