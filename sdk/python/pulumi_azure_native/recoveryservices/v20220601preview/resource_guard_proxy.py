...
warnings.warn("""azure-native:recoveryservices/v20220601preview:ResourceGuardProxy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ResourceGuardProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ResourceGuardProxy is deprecated: azure-native:recoveryservices/v20220601preview:ResourceGuardProxy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.""")
