...
def get_resource_guard_proxy(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_guard_proxy is deprecated: azure-native:recoveryservices/v20220601preview:ResourceGuardProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceGuardProxyName'] = resource_guard_proxy_name
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20220601preview:getResourceGuardProxy', __args__, opts=opts, typ=GetResourceGuardProxyResult).value
