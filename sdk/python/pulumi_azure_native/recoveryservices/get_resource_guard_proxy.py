...
def get_resource_guard_proxy(resource_group_name: Optional[builtins.str] = None,
...
def get_resource_guard_proxy_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
