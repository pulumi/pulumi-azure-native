...
class ProtectionIntent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        protection_intent = azure_native.recoveryservices.v20210201.ProtectionIntent("protectionIntent",
            fabric_name="Azure",
            intent_object_name="vm;iaasvmcontainerv2;chamsrgtest;chamscandel",
            properties=azure_native.recoveryservices.v20210201.AzureResourceProtectionIntentArgs(
