...
class ProtectedItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        protected_item = azure_native.recoveryservices.v20210201.ProtectedItem("protectedItem",
            container_name="IaasVMContainer;iaasvmcontainerv2;netsdktestrg;netvmtestv2vm1",
            fabric_name="Azure",
            properties=azure_native.recoveryservices.v20210201.AzureIaaSComputeVMProtectedItemArgs(
