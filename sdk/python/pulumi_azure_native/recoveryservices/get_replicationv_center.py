...
def get_replicationv_center(fabric_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vcenter_name: vcenter name.
    """
    __args__ = dict()
...
def get_replicationv_center_output(fabric_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationvCenter', __args__, opts=opts, typ=GetReplicationvCenterResult)
