...
def get_protection_container(container_name: Optional[builtins.str] = None,
    ...
    :param builtins.str container_name: Name of the container whose details need to be fetched.
    :param builtins.str fabric_name: Name of the fabric where the container belongs.
...
def get_protection_container_output(container_name: Optional[pulumi.Input[builtins.str]] = None,
