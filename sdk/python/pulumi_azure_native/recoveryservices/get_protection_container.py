...
def get_protection_container(container_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str container_name: Name of the container whose details need to be fetched.
    :param _builtins.str fabric_name: Name of the fabric where the container belongs.
...
def get_protection_container_output(container_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
