...
azure-native:recoveryservices/v20160810:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_policy is deprecated: Version 2016-08-10 will be removed in v2 of the provider.
azure-native:recoveryservices/v20160810:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20160810:getReplicationPolicy', __args__, opts=opts, typ=GetReplicationPolicyResult).value
