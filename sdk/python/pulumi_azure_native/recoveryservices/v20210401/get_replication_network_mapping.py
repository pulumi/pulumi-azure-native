...
warnings.warn("""azure-native:recoveryservices/v20210401:ReplicationNetworkMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_network_mapping(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_network_mapping is deprecated: azure-native:recoveryservices/v20210401:ReplicationNetworkMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationNetworkMapping to guarantee forwards compatibility.""")
    __args__ = dict()
