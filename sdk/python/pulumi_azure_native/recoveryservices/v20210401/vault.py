...
class Vault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Vault is deprecated: azure-native:recoveryservices/v20210401:Vault is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:Vault to guarantee forwards compatibility.""")
