...
warnings.warn("""azure-native:recoveryservices/v20210401:ReplicationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_policy is deprecated: azure-native:recoveryservices/v20210401:ReplicationPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
