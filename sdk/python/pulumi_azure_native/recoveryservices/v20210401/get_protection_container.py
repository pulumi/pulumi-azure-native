...
def get_protection_container_output(container_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20210401:getProtectionContainer', __args__, opts=opts, typ=GetProtectionContainerResult)
