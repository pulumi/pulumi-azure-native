...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationPolicy is deprecated: azure-native:recoveryservices/v20210401:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationPolicy to guarantee forwards compatibility.""")
