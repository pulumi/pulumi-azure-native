...
warnings.warn("""azure-native:recoveryservices/v20210401:ProtectedItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.""", DeprecationWarning)
