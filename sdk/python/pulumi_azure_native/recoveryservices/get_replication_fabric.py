...
def get_replication_fabric(fabric_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str filter: OData filter options.
...
def get_replication_fabric_output(fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
