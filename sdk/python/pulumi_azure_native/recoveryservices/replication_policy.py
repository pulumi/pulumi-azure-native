...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20230201:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20230401:ReplicationPolicy")])
