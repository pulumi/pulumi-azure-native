...
def get_replication_migration_item(fabric_name: Optional[builtins.str] = None,
                                   migration_item_name: Optional[builtins.str] = None,
    ...
    :param builtins.str migration_item_name: Migration item name.
...
def get_replication_migration_item_output(fabric_name: Optional[pulumi.Input[builtins.str]] = None,
