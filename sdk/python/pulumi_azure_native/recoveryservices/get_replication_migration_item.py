...
def get_replication_migration_item(fabric_name: Optional[_builtins.str] = None,
                                   migration_item_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str migration_item_name: Migration item name.
...
def get_replication_migration_item_output(fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
                                          migration_item_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult)
