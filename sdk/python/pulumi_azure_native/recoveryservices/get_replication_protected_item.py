...
def get_replication_protected_item(fabric_name: Optional[builtins.str] = None,
                                   protection_container_name: Optional[builtins.str] = None,
                                   replicated_protected_item_name: Optional[builtins.str] = None,
    ...
    :param builtins.str fabric_name: Fabric unique name.
    :param builtins.str protection_container_name: Protection container name.
    :param builtins.str replicated_protected_item_name: Replication protected item name.
...
def get_replication_protected_item_output(fabric_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult)
