...
def get_replication_recovery_services_provider(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_recovery_services_provider is deprecated: azure-native:recoveryservices/v20220201:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.""")
    __args__ = dict()
