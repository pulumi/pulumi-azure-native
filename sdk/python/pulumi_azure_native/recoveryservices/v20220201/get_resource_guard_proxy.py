...
def get_resource_guard_proxy(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_guard_proxy is deprecated: azure-native:recoveryservices/v20220201:ResourceGuardProxy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ResourceGuardProxy to guarantee forwards compatibility.""")
    __args__ = dict()
