...
def get_replication_policy(policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_name: Replication policy name.
...
def get_replication_policy_output(policy_name: Optional[pulumi.Input[builtins.str]] = None,
