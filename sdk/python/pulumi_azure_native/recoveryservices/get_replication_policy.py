...
def get_replication_policy(policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_name: Replication policy name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices:getReplicationPolicy', __args__, opts=opts, typ=GetReplicationPolicyResult).value
...
def get_replication_policy_output(policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationPolicy', __args__, opts=opts, typ=GetReplicationPolicyResult)
