...
warnings.warn("""azure-native:recoveryservices/v20220101:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationStorageClassificationMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_classification_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationStorageClassificationMapping is deprecated: azure-native:recoveryservices/v20220101:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.""")
