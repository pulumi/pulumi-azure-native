...
class ReplicationProtectionContainerMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_protection_container_mapping = azure_native.recoveryservices.v20180710.ReplicationProtectionContainerMapping("replicationProtectionContainerMapping",
            fabric_name="cloud1",
            mapping_name="cloud1protectionprofile1",
            properties=azure_native.recoveryservices.v20180710.ProtectionContainerMappingPropertiesResponseArgs(
