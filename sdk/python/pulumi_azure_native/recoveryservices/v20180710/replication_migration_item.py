...
class ReplicationMigrationItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20230201:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20230401:ReplicationMigrationItem")])
