...
warnings.warn("""azure-native:recoveryservices/v20180710:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationRecoveryPlan is deprecated: azure-native:recoveryservices/v20180710:ReplicationRecoveryPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan to guarantee forwards compatibility.""")
