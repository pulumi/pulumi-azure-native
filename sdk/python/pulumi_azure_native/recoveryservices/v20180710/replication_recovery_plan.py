...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_recovery_plan = azure_native.recoveryservices.v20180710.ReplicationRecoveryPlan("replicationRecoveryPlan",
            properties=azure_native.recoveryservices.v20180710.RecoveryPlanPropertiesResponseArgs(
                failover_deployment_model="ResourceManager",
                groups=[{
                    "endGroupActions": [],
                    "groupType": "Boot",
                    "replicationProtectedItems": [azure_native.recoveryservices.v20180710.RecoveryPlanProtectedItemArgs(
