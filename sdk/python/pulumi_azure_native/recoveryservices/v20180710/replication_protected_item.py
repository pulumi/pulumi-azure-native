...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_protected_item = azure_native.recoveryservices.v20180710.ReplicationProtectedItem("replicationProtectedItem",
            fabric_name="cloud1",
            properties=azure_native.recoveryservices.v20180710.ReplicationProtectedItemPropertiesResponseArgs(
                ...
                provider_specific_details=azure_native.recoveryservices.v20180710.HyperVReplicaAzureEnableProtectionInputArgs(
