...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20230201:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20230401:ReplicationProtectedItem")])
