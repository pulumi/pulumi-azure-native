...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ReplicationProtectedItem")])
