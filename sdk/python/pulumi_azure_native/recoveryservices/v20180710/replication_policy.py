...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_policy = azure_native.recoveryservices.v20180710.ReplicationPolicy("replicationPolicy",
            policy_name="protectionprofile1",
            properties=azure_native.recoveryservices.v20180710.PolicyPropertiesResponseArgs(
                provider_specific_input=azure_native.recoveryservices.v20180710.HyperVReplicaAzurePolicyInputArgs(
