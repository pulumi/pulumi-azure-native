...
class ReplicationRecoveryServicesProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_recovery_services_provider = azure_native.recoveryservices.v20180710.ReplicationRecoveryServicesProvider("replicationRecoveryServicesProvider",
            fabric_name="vmwarefabric1",
            properties=azure_native.recoveryservices.v20180710.AddRecoveryServicesProviderInputPropertiesArgs(
                authentication_identity_input=azure_native.recoveryservices.v20180710.IdentityProviderInputArgs(
                ...
                resource_access_identity_input=azure_native.recoveryservices.v20180710.IdentityProviderInputArgs(
                    aad_authority="https://login.microsoftonline.com",
                    application_id="f66fce08-c0c6-47a1-beeb-0ede5ea94f90",
                    audience="https://microsoft.onmicrosoft.com/cf19e349-644c-4c6a-bcae-9c8f35357874",
                    object_id="141360b8-5686-4240-a027-5e24e6affeba",
