...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/v20180710:ReplicationFabric":
                return ReplicationFabric(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationMigrationItem":
                return ReplicationMigrationItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationNetworkMapping":
                return ReplicationNetworkMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationPolicy":
                return ReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationProtectedItem":
                return ReplicationProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationProtectionContainerMapping":
                return ReplicationProtectionContainerMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationRecoveryPlan":
                return ReplicationRecoveryPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationRecoveryServicesProvider":
                return ReplicationRecoveryServicesProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationStorageClassificationMapping":
                return ReplicationStorageClassificationMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180710:ReplicationvCenter":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/v20180710", _module_instance)
