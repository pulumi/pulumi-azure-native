...
warnings.warn("""azure-native:recoveryservices/v20221001:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_protection_container_mapping(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_protection_container_mapping is deprecated: azure-native:recoveryservices/v20221001:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20221001:getReplicationProtectionContainerMapping', __args__, opts=opts, typ=GetReplicationProtectionContainerMappingResult).value
