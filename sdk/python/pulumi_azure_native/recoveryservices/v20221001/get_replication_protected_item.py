...
def get_replication_protected_item_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20221001:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult)
