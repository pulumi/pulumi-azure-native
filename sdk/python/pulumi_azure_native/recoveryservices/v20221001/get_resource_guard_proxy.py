...
def get_resource_guard_proxy(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_guard_proxy is deprecated: azure-native:recoveryservices/v20221001:ResourceGuardProxy is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ResourceGuardProxy to guarantee forwards compatibility.""")
    __args__ = dict()
