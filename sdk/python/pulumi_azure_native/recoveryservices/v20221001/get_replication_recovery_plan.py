...
def get_replication_recovery_plan_output(recovery_plan_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20221001:getReplicationRecoveryPlan', __args__, opts=opts, typ=GetReplicationRecoveryPlanResult)
