...
class ReplicationMigrationItemArgs:
    ...
    def _configure(
        ...
        if 'migrationItemName' in kwargs:
...
class ReplicationMigrationItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, EnableMigrationInputPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                EnableMigrationInputPropertiesArgs._configure(_setter, **properties)
