...
class ReplicationRecoveryServicesProviderArgs:
    def __init__(__self__, *,
        ...
        """
        ReplicationRecoveryServicesProviderArgs._configure(
...
class ReplicationRecoveryServicesProvider(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ReplicationRecoveryServicesProviderArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, AddRecoveryServicesProviderInputPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                AddRecoveryServicesProviderInputPropertiesArgs._configure(_setter, **properties)
        ...
        super(ReplicationRecoveryServicesProvider, __self__).__init__(
            'azure-native:recoveryservices/v20230601:ReplicationRecoveryServicesProvider',
            resource_name,
            __props__,
            opts)
