...
def get_replication_network_mapping(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20230601:getReplicationNetworkMapping', __args__, opts=opts, typ=GetReplicationNetworkMappingResult).value
...
def get_replication_network_mapping_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20230601:getReplicationNetworkMapping', __args__, opts=opts, typ=GetReplicationNetworkMappingResult)
