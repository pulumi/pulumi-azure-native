...
def get_replication_migration_item(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20230601:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult).value
