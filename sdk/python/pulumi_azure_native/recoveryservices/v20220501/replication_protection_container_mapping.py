...
warnings.warn("""azure-native:recoveryservices/v20220501:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationProtectionContainerMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ReplicationProtectionContainerMapping, __self__).__init__(
            'azure-native:recoveryservices/v20220501:ReplicationProtectionContainerMapping',
            resource_name,
            __props__,
            opts)
