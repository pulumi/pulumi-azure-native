...
def get_replication_protected_item(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20230101:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult).value
...
def get_replication_protected_item_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20230101:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult)
