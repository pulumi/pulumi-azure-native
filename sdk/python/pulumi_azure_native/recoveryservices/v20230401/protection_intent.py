...
class ProtectionIntentArgs:
    def __init__(__self__, *,
        ...
        """
        ProtectionIntentArgs._configure(
    ...
    def _configure(
        ...
        if e_tag is None and 'eTag' in kwargs:
            e_tag = kwargs['eTag']
        if intent_object_name is None and 'intentObjectName' in kwargs:
            intent_object_name = kwargs['intentObjectName']
        ...
        if intent_object_name is not None:
            _setter("intent_object_name", intent_object_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ProtectionIntentArgs._configure(_setter, **kwargs)
