...
class ReplicationRecoveryPlanArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['CreateRecoveryPlanInputPropertiesArgs']] = None,
        ...
        if recovery_plan_name is None and 'recoveryPlanName' in kwargs:
            recovery_plan_name = kwargs['recoveryPlanName']
...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, CreateRecoveryPlanInputPropertiesArgs, True)
