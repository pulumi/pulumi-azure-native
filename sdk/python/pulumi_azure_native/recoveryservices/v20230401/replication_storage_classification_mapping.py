...
class ReplicationStorageClassificationMappingArgs:
    ...
    def _configure(
        ...
        if 'storageClassificationName' in kwargs:
            storage_classification_name = kwargs['storageClassificationName']
        if 'storageClassificationMappingName' in kwargs:
...
class ReplicationStorageClassificationMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, StorageMappingInputPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                StorageMappingInputPropertiesArgs._configure(_setter, **properties)
