...
warnings.warn("""azure-native:recoveryservices/v20210210:ReplicationMigrationItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_migration_item(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_migration_item is deprecated: azure-native:recoveryservices/v20210210:ReplicationMigrationItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.""")
    __args__ = dict()
