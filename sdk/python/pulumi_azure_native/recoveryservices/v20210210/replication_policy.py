...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210401:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210401:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210601:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210601:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210701:ReplicationPolicy"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210701:ReplicationPolicy")])
