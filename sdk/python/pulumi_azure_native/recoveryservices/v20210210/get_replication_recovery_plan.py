...
def get_replication_recovery_plan(recovery_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_recovery_plan is deprecated: azure-native:recoveryservices/v20210210:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.""")
    __args__ = dict()
