...
warnings.warn("""azure-native:recoveryservices/v20210210:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectionContainerMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_protection_container_mapping(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_protection_container_mapping is deprecated: azure-native:recoveryservices/v20210210:ReplicationProtectionContainerMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectionContainerMapping to guarantee forwards compatibility.""")
    __args__ = dict()
