...
def get_replication_protected_item(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_protected_item is deprecated: azure-native:recoveryservices/v20210210:ReplicationProtectedItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationProtectedItem to guarantee forwards compatibility.""")
    __args__ = dict()
