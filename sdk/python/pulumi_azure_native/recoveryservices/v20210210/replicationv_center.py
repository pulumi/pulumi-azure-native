...
class ReplicationvCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vcenter_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationvCenter is deprecated: azure-native:recoveryservices/v20210210:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20210301:ReplicationvCenter to guarantee forwards compatibility.""")
