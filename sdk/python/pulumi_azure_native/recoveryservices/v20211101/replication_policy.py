...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210401:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210601:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210701:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20210801:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20211001:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20211201:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20220101:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20220201:ReplicationPolicy"), pulumi.Alias(type_="azure-native:recoveryservices/v20220301:ReplicationPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationPolicy, __self__).__init__(
            'azure-native:recoveryservices/v20211101:ReplicationPolicy',
            resource_name,
            __props__,
            opts)
