...
class ReplicationNetworkMappingArgs:
    ...
    def _configure(
        ...
        if 'networkMappingName' in kwargs:
...
class ReplicationNetworkMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, CreateNetworkMappingInputPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                CreateNetworkMappingInputPropertiesArgs._configure(_setter, **properties)
