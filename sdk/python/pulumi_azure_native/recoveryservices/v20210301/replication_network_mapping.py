...
class ReplicationNetworkMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replication_network_mapping = azure_native.recoveryservices.v20210301.ReplicationNetworkMapping("replicationNetworkMapping",
            ...
            properties=azure_native.recoveryservices.v20210301.NetworkMappingPropertiesResponseArgs(
                fabric_specific_details=azure_native.recoveryservices.v20210301.VmmToAzureCreateNetworkMappingInputArgs(
