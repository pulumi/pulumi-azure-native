...
def get_protection_container(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_container is deprecated: azure-native:recoveryservices/v20210301:ProtectionContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionContainer to guarantee forwards compatibility.""")
    __args__ = dict()
