...
class ReplicationvCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        replicationv_center = azure_native.recoveryservices.v20210301.ReplicationvCenter("replicationvCenter",
            fabric_name="MadhaviFabric",
            properties=azure_native.recoveryservices.v20210301.AddVCenterRequestPropertiesArgs(
