...
def get_replication_recovery_services_provider(fabric_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str provider_name: Recovery services provider name.
