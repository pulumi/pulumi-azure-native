...
def get_replication_recovery_services_provider(fabric_name: Optional[builtins.str] = None,
    ...
    :param builtins.str provider_name: Recovery services provider name.
...
def get_replication_recovery_services_provider_output(fabric_name: Optional[pulumi.Input[builtins.str]] = None,
