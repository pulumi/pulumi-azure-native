...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ProtectedItem":
                return ProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ProtectionContainer":
                return ProtectionContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ProtectionIntent":
                return ProtectionIntent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ProtectionPolicy":
                return ProtectionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationFabric":
                return ReplicationFabric(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationMigrationItem":
                return ReplicationMigrationItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationNetworkMapping":
                return ReplicationNetworkMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationPolicy":
                return ReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationProtectedItem":
                return ReplicationProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationProtectionContainerMapping":
                return ReplicationProtectionContainerMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationRecoveryPlan":
                return ReplicationRecoveryPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationRecoveryServicesProvider":
                return ReplicationRecoveryServicesProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationStorageClassificationMapping":
                return ReplicationStorageClassificationMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:ReplicationvCenter":
                return ReplicationvCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/latest:Vault":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/latest", _module_instance)
