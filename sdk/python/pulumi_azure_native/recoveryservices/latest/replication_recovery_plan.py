...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationRecoveryPlan'.""", DeprecationWarning)
...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""ReplicationRecoveryPlan is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationRecoveryPlan'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationRecoveryPlan"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationRecoveryPlan")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationRecoveryPlan, __self__).__init__(
            'azure-native:recoveryservices/latest:ReplicationRecoveryPlan',
            resource_name,
            __props__,
            opts)
