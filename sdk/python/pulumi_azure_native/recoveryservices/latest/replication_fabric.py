...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationFabric'.""", DeprecationWarning)
...
class ReplicationFabric(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationFabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationFabric, __self__).__init__(
            'azure-native:recoveryservices/latest:ReplicationFabric',
            resource_name,
            __props__,
            opts)
