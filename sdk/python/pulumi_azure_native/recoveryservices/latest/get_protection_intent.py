...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectionIntent'.""", DeprecationWarning)
...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_intent is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectionIntent'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult).value
