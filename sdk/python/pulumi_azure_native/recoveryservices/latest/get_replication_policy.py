...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationPolicy'.""", DeprecationWarning)
...
def get_replication_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getReplicationPolicy', __args__, opts=opts, typ=GetReplicationPolicyResult).value
