...
class ProtectedItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_name: Container name associated with the backup item.
        :param pulumi.Input[builtins.str] fabric_name: Fabric name associated with the backup item.
        ...
        :param pulumi.Input[builtins.str] protected_item_name: Item name to be backed up.
