...
class ReplicationProtectionContainerMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20230201:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20230401:ReplicationProtectionContainerMapping")])
