...
def get_replication_protection_container_mapping(fabric_name: Optional[builtins.str] = None,
    ...
    :param builtins.str mapping_name: Protection Container mapping name.
...
def get_replication_protection_container_mapping_output(fabric_name: Optional[pulumi.Input[builtins.str]] = None,
