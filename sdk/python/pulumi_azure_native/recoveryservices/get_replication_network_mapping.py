...
def get_replication_network_mapping(fabric_name: Optional[_builtins.str] = None,
                                    network_mapping_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fabric_name: Primary fabric name.
    :param _builtins.str network_mapping_name: Network mapping name.
    :param _builtins.str network_name: Primary network name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices:getReplicationNetworkMapping', __args__, opts=opts, typ=GetReplicationNetworkMappingResult).value
...
def get_replication_network_mapping_output(fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
                                           network_mapping_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices:getReplicationNetworkMapping', __args__, opts=opts, typ=GetReplicationNetworkMappingResult)
