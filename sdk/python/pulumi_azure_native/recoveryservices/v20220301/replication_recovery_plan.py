...
class ReplicationRecoveryPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_name_: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationRecoveryPlan is deprecated: azure-native:recoveryservices/v20220301:ReplicationRecoveryPlan is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationRecoveryPlan to guarantee forwards compatibility.""")
