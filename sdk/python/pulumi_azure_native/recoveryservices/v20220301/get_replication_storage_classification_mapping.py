...
warnings.warn("""azure-native:recoveryservices/v20220301:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication_storage_classification_mapping(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_storage_classification_mapping is deprecated: azure-native:recoveryservices/v20220301:ReplicationStorageClassificationMapping is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationStorageClassificationMapping to guarantee forwards compatibility.""")
    __args__ = dict()
