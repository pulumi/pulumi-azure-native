...
def get_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vault is deprecated: azure-native:recoveryservices/v20220301:Vault is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:Vault to guarantee forwards compatibility.""")
    __args__ = dict()
