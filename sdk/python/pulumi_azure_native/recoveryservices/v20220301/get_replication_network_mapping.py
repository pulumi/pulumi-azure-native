...
def get_replication_network_mapping_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20220301:getReplicationNetworkMapping', __args__, opts=opts, typ=GetReplicationNetworkMappingResult)
