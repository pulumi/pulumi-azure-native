...
def get_replicationv_center(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20240101:getReplicationvCenter', __args__, opts=opts, typ=GetReplicationvCenterResult).value
...
def get_replicationv_center_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20240101:getReplicationvCenter', __args__, opts=opts, typ=GetReplicationvCenterResult)
