...
def get_replicationv_center(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replicationv_center is deprecated: azure-native:recoveryservices/v20211201:ReplicationvCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationvCenter to guarantee forwards compatibility.""")
    __args__ = dict()
