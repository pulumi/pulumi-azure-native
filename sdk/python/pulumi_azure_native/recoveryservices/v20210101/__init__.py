...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/v20210101:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210101:ProtectedItem":
                return ProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210101:ProtectionContainer":
                return ProtectionContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210101:ProtectionPolicy":
                return ProtectionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210101:Vault":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/v20210101", _module_instance)
