...
def get_replication_fabric(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_fabric is deprecated: Version v20180110 will be removed in the next major version of the provider. Upgrade to version v20180710 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20180110:getReplicationFabric', __args__, opts=opts, typ=GetReplicationFabricResult).value
