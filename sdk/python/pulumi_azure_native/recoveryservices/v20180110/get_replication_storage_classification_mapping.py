...
def get_replication_storage_classification_mapping(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_storage_classification_mapping is deprecated: Version v20180110 will be removed in the next major version of the provider. Upgrade to version v20180710 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20180110:getReplicationStorageClassificationMapping', __args__, opts=opts, typ=GetReplicationStorageClassificationMappingResult).value
