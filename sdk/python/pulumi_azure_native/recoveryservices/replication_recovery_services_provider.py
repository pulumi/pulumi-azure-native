...
class ReplicationRecoveryServicesProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] provider_name: Recovery services provider name.
        """
