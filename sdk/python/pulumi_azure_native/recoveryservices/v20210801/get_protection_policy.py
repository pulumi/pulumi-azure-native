...
warnings.warn("""azure-native:recoveryservices/v20210801:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_protection_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_policy is deprecated: azure-native:recoveryservices/v20210801:ProtectionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyName'] = policy_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210801:getProtectionPolicy', __args__, opts=opts, typ=GetProtectionPolicyResult).value
