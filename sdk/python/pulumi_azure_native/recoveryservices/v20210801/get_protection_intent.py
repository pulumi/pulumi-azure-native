...
warnings.warn("""azure-native:recoveryservices/v20210801:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_intent is deprecated: azure-native:recoveryservices/v20210801:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210801:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult).value
