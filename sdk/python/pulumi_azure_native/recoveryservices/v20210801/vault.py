...
class Vault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:recoveryservices:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20200202:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20201001:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210101:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210401:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210601:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210701:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20211101preview:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20211201:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20220101:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20220131preview:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20220201:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20220301:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20220401:Vault")])
