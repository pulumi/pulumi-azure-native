...
warnings.warn("""azure-native:recoveryservices/v20210801:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationvCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vcenter_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ReplicationvCenter is deprecated: azure-native:recoveryservices/v20210801:ReplicationvCenter is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ReplicationvCenter to guarantee forwards compatibility.""")
