...
warnings.warn("""azure-native:recoveryservices/v20210801:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:Vault to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vault is deprecated: azure-native:recoveryservices/v20210801:Vault is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:Vault to guarantee forwards compatibility.""")
    __args__ = dict()
