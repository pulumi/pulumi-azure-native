...
def get_replication_recovery_plan(recovery_plan_name: Optional[builtins.str] = None,
    ...
    :param builtins.str recovery_plan_name: Name of the recovery plan.
...
def get_replication_recovery_plan_output(recovery_plan_name: Optional[pulumi.Input[builtins.str]] = None,
