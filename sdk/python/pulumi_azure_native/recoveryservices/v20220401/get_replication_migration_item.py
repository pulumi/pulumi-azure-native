...
def get_replication_migration_item(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_migration_item is deprecated: azure-native:recoveryservices/v20220401:ReplicationMigrationItem is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationMigrationItem to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20220401:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult).value
