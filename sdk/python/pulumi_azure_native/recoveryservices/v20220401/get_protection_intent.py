...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_intent is deprecated: azure-native:recoveryservices/v20220401:ProtectionIntent is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectionIntent to guarantee forwards compatibility.""")
    __args__ = dict()
