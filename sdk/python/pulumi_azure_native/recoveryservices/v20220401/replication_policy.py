...
warnings.warn("""azure-native:recoveryservices/v20220401:ReplicationPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ReplicationPolicy, __self__).__init__(
            'azure-native:recoveryservices/v20220401:ReplicationPolicy',
            resource_name,
            __props__,
            opts)
