...
def get_protected_item(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protected_item is deprecated: azure-native:recoveryservices/v20220401:ProtectedItem is being removed in the next major version of this provider. Please upgrade to azure-native:recoveryservices/v20230201:ProtectedItem to guarantee forwards compatibility.""")
    __args__ = dict()
