...
def get_replication_recovery_services_provider(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_recovery_services_provider is deprecated: azure-native:recoveryservices/v20220910:ReplicationRecoveryServicesProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ReplicationRecoveryServicesProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20220910:getReplicationRecoveryServicesProvider', __args__, opts=opts, typ=GetReplicationRecoveryServicesProviderResult).value
