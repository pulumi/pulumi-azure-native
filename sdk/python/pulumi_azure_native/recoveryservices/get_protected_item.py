...
def get_protected_item(container_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str container_name: Container name associated with the backed up item.
    :param _builtins.str fabric_name: Fabric name associated with the backed up item.
    :param _builtins.str filter: OData filter options.
    :param _builtins.str protected_item_name: Backed up item name whose details are to be fetched.
...
def get_protected_item_output(container_name: pulumi.Input[Optional[_builtins.str]] = None,
                              ...
                              protected_item_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
