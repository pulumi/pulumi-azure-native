...
def get_protection_policy(policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_name: Backup policy information to be fetched.
...
def get_protection_policy_output(policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
