...
def get_protection_policy(policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_name: Backup policy information to be fetched.
...
def get_protection_policy_output(policy_name: Optional[pulumi.Input[builtins.str]] = None,
