...
def get_resource_guard_proxy(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20240201:getResourceGuardProxy', __args__, opts=opts, typ=GetResourceGuardProxyResult).value
...
def get_resource_guard_proxy_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20240201:getResourceGuardProxy', __args__, opts=opts, typ=GetResourceGuardProxyResult)
