...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20240201:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult).value
...
def get_protection_intent_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20240201:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult)
