...
def get_replication_migration_item_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20240201:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult)
