...
def get_protection_intent(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_intent is deprecated: azure-native:recoveryservices/v20220901preview:ProtectionIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230401:ProtectionIntent to guarantee forwards compatibility.""")
    __args__ = dict()
