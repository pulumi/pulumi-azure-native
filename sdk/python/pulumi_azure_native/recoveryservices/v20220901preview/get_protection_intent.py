...
def get_protection_intent_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20220901preview:getProtectionIntent', __args__, opts=opts, typ=GetProtectionIntentResult)
