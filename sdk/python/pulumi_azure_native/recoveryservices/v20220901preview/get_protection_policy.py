...
def get_protection_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20220901preview:getProtectionPolicy', __args__, opts=opts, typ=GetProtectionPolicyResult)
