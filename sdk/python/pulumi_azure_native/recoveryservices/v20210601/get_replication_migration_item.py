...
def get_replication_migration_item_output(fabric_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:recoveryservices/v20210601:getReplicationMigrationItem', __args__, opts=opts, typ=GetReplicationMigrationItemResult)
