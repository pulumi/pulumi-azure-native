...
def get_replication_fabric(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_fabric is deprecated: azure-native:recoveryservices/v20210601:ReplicationFabric is being removed in the next major version of this provider. Upgrade to at least azure-native:recoveryservices/v20230201:ReplicationFabric to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/v20210601:getReplicationFabric', __args__, opts=opts, typ=GetReplicationFabricResult).value
