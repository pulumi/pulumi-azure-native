...
def get_ec2_instance(resource_uri: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getEc2Instance', __args__, opts=opts, typ=GetEc2InstanceResult).value
...
def get_ec2_instance_output(resource_uri: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getEc2Instance', __args__, opts=opts, typ=GetEc2InstanceResult)
