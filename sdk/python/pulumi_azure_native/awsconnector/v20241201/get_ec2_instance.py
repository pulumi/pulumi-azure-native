...
__all__ = [
    ...
    'AwaitableGetEc2InstanceResult',
    'get_ec2_instance',
    'get_ec2_instance_output',
]
...
def get_ec2_instance(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getEc2Instance', __args__, opts=opts, typ=GetEc2InstanceResult).value

    return AwaitableGetEc2InstanceResult(
...
@_utilities.lift_output_func(get_ec2_instance)
