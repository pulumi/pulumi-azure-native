...
def get_s3_bucket_policy(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getS3BucketPolicy', __args__, opts=opts, typ=GetS3BucketPolicyResult).value
...
def get_s3_bucket_policy_output(name: Optional[pulumi.Input[str]] = None,
                                resource_group_name: Optional[pulumi.Input[str]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetS3BucketPolicyResult]:
    """
    Get a S3BucketPolicy
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getS3BucketPolicy', __args__, opts=opts, typ=GetS3BucketPolicyResult)
