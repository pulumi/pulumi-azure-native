...
class GetS3BucketResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.S3BucketPropertiesResponse':
        """
...
def get_s3_bucket(name: Optional[str] = None,
    ...
    :param str name: Name of S3Bucket
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getS3Bucket', __args__, opts=opts, typ=GetS3BucketResult).value
...
def get_s3_bucket_output(name: Optional[pulumi.Input[str]] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetS3BucketResult]:
    """
    Get a S3Bucket
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getS3Bucket', __args__, opts=opts, typ=GetS3BucketResult)
