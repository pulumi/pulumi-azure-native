...
def get_ecr_repository(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getEcrRepository', __args__, opts=opts, typ=GetEcrRepositoryResult).value
...
def get_ecr_repository_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getEcrRepository', __args__, opts=opts, typ=GetEcrRepositoryResult)
