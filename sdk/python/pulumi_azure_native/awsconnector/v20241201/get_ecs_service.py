...
def get_ecs_service(name: Optional[str] = None,
    ...
    :param str name: Name of EcsService
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getEcsService', __args__, opts=opts, typ=GetEcsServiceResult).value
...
def get_ecs_service_output(name: Optional[pulumi.Input[str]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEcsServiceResult]:
    """
    Get a EcsService
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getEcsService', __args__, opts=opts, typ=GetEcsServiceResult)
