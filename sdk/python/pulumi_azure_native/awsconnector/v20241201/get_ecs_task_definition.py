...
class GetEcsTaskDefinitionResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.EcsTaskDefinitionPropertiesResponse':
        """
...
def get_ecs_task_definition(name: Optional[str] = None,
    ...
    :param str name: Name of EcsTaskDefinition
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getEcsTaskDefinition', __args__, opts=opts, typ=GetEcsTaskDefinitionResult).value
...
def get_ecs_task_definition_output(name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEcsTaskDefinitionResult]:
    """
    Get a EcsTaskDefinition
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getEcsTaskDefinition', __args__, opts=opts, typ=GetEcsTaskDefinitionResult)
