...
def get_iam_group(name: Optional[str] = None,
    ...
    :param str name: Name of IamGroup
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getIamGroup', __args__, opts=opts, typ=GetIamGroupResult).value
...
def get_iam_group_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getIamGroup', __args__, opts=opts, typ=GetIamGroupResult)
