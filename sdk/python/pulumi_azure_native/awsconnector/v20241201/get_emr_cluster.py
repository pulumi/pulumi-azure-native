...
def get_emr_cluster(name: Optional[str] = None,
    ...
    :param str name: Name of EmrCluster
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getEmrCluster', __args__, opts=opts, typ=GetEmrClusterResult).value
...
@_utilities.lift_output_func(get_emr_cluster)
