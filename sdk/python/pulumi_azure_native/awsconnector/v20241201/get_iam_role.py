...
class GetIamRoleResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.IamRolePropertiesResponse':
        """
...
def get_iam_role(name: Optional[str] = None,
    ...
    :param str name: Name of IamRole
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector/v20241201:getIamRole', __args__, opts=opts, typ=GetIamRoleResult).value
...
def get_iam_role_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector/v20241201:getIamRole', __args__, opts=opts, typ=GetIamRoleResult)
