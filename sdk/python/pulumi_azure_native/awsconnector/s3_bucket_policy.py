...
class S3BucketPolicyArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['S3BucketPolicyPropertiesArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['S3BucketPolicyPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['S3BucketPolicyPropertiesArgs']]):
...
class S3BucketPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['S3BucketPolicyPropertiesArgs', 'S3BucketPolicyPropertiesArgsDict']]] = None,
