...
def get_s3_bucket(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of S3Bucket
...
def get_s3_bucket_output(name: Optional[pulumi.Input[builtins.str]] = None,
