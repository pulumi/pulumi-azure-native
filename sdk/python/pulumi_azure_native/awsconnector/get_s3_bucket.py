...
def get_s3_bucket(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of S3Bucket
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getS3Bucket', __args__, opts=opts, typ=GetS3BucketResult).value
...
def get_s3_bucket_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getS3Bucket', __args__, opts=opts, typ=GetS3BucketResult)
