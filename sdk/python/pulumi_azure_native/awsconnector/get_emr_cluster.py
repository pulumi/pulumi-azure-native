...
def get_emr_cluster(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of EmrCluster
...
def get_emr_cluster_output(name: Optional[pulumi.Input[builtins.str]] = None,
