...
def get_emr_cluster(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of EmrCluster
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getEmrCluster', __args__, opts=opts, typ=GetEmrClusterResult).value
...
def get_emr_cluster_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getEmrCluster', __args__, opts=opts, typ=GetEmrClusterResult)
