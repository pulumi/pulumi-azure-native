...
def get_s3_bucket_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of S3BucketPolicy
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getS3BucketPolicy', __args__, opts=opts, typ=GetS3BucketPolicyResult).value
...
def get_s3_bucket_policy_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getS3BucketPolicy', __args__, opts=opts, typ=GetS3BucketPolicyResult)
