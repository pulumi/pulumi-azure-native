...
def get_s3_bucket_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of S3BucketPolicy
...
def get_s3_bucket_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
