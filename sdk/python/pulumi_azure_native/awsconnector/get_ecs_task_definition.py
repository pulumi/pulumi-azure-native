...
def get_ecs_task_definition(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of EcsTaskDefinition
...
def get_ecs_task_definition_output(name: Optional[pulumi.Input[builtins.str]] = None,
