...
def get_ecs_task_definition(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of EcsTaskDefinition
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getEcsTaskDefinition', __args__, opts=opts, typ=GetEcsTaskDefinitionResult).value
...
def get_ecs_task_definition_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getEcsTaskDefinition', __args__, opts=opts, typ=GetEcsTaskDefinitionResult)
