...
def get_ecs_service(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of EcsService
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getEcsService', __args__, opts=opts, typ=GetEcsServiceResult).value
...
def get_ecs_service_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getEcsService', __args__, opts=opts, typ=GetEcsServiceResult)
