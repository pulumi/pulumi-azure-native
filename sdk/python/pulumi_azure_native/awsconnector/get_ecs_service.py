...
def get_ecs_service(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of EcsService
...
def get_ecs_service_output(name: Optional[pulumi.Input[builtins.str]] = None,
