...
def get_iam_role(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of IamRole
...
def get_iam_role_output(name: Optional[pulumi.Input[builtins.str]] = None,
