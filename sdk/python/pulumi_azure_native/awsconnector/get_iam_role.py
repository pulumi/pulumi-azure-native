...
def get_iam_role(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of IamRole
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getIamRole', __args__, opts=opts, typ=GetIamRoleResult).value
...
def get_iam_role_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getIamRole', __args__, opts=opts, typ=GetIamRoleResult)
