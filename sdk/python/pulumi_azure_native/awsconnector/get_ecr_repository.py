...
def get_ecr_repository(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of EcrRepository
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getEcrRepository', __args__, opts=opts, typ=GetEcrRepositoryResult).value
...
def get_ecr_repository_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getEcrRepository', __args__, opts=opts, typ=GetEcrRepositoryResult)
