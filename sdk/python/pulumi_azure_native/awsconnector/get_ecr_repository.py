...
def get_ecr_repository(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of EcrRepository
...
def get_ecr_repository_output(name: Optional[pulumi.Input[builtins.str]] = None,
