...
def get_iam_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of IamGroup
...
def get_iam_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
