...
def get_iam_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of IamGroup
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:awsconnector:getIamGroup', __args__, opts=opts, typ=GetIamGroupResult).value
...
def get_iam_group_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:awsconnector:getIamGroup', __args__, opts=opts, typ=GetIamGroupResult)
