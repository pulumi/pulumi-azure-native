...
class CopilotSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portalservices/v20240401preview:CopilotSetting"), pulumi.Alias(type_="azure-native:portalservices:CopilotSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CopilotSetting, __self__).__init__(
            'azure-native:portalservices/v20240401:CopilotSetting',
            resource_name,
            __props__,
            opts)
