...
def get_copilot_setting(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCopilotSettingResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portalservices/v20240401:getCopilotSetting', __args__, opts=opts, typ=GetCopilotSettingResult).value
...
def get_copilot_setting_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCopilotSettingResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portalservices/v20240401:getCopilotSetting', __args__, opts=opts, typ=GetCopilotSettingResult)
