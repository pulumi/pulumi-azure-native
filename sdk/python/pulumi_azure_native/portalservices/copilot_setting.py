...
class CopilotSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portalservices/v20240401preview:CopilotSetting"), pulumi.Alias(type_="azure-native_portalservices_v20240401:portalservices:CopilotSetting"), pulumi.Alias(type_="azure-native_portalservices_v20240401preview:portalservices:CopilotSetting")])
