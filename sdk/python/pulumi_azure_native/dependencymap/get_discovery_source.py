...
__all__ = [
    ...
    'AwaitableGetDiscoverySourceResult',
    'get_discovery_source',
    'get_discovery_source_output',
]

@pulumi.output_type
class GetDiscoverySourceResult:
    """
...
class AwaitableGetDiscoverySourceResult(GetDiscoverySourceResult):
...
def get_discovery_source(map_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str source_name: discovery source resource
    """
    __args__ = dict()
...
def get_discovery_source_output(map_name: Optional[pulumi.Input[_builtins.str]] = None,
