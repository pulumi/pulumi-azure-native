...
class DiscoverySourceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['OffAzureDiscoverySourceResourcePropertiesArgs']]:
        """
...
class DiscoverySource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['OffAzureDiscoverySourceResourcePropertiesArgs', 'OffAzureDiscoverySourceResourcePropertiesArgsDict']]] = None,
