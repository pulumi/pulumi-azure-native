...
def get_map(map_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dependencymap:getMap', __args__, opts=opts, typ=GetMapResult).value
...
def get_map_output(map_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dependencymap:getMap', __args__, opts=opts, typ=GetMapResult)
