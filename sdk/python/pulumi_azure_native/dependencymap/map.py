...
class Map(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dependencymap/v20250131preview:Map"), pulumi.Alias(type_="azure-native:dependencymap/v20250501preview:Map"), pulumi.Alias(type_="azure-native:dependencymap/v20250701preview:Map")])
