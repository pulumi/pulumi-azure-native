...
class DiscoverySource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dependencymap:DiscoverySource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiscoverySource, __self__).__init__(
            'azure-native:dependencymap/v20250131preview:DiscoverySource',
            resource_name,
            __props__,
            opts)
