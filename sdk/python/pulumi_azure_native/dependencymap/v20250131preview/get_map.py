...
def get_map(map_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dependencymap/v20250131preview:getMap', __args__, opts=opts, typ=GetMapResult).value
...
def get_map_output(map_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dependencymap/v20250131preview:getMap', __args__, opts=opts, typ=GetMapResult)
