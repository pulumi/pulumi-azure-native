...
def get_discovery_source(map_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dependencymap/v20250131preview:getDiscoverySource', __args__, opts=opts, typ=GetDiscoverySourceResult).value
...
def get_discovery_source_output(map_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dependencymap/v20250131preview:getDiscoverySource', __args__, opts=opts, typ=GetDiscoverySourceResult)
