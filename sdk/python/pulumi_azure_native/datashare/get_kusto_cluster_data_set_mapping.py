...
def get_kusto_cluster_data_set_mapping(account_name: Optional[builtins.str] = None,
...
def get_kusto_cluster_data_set_mapping_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
