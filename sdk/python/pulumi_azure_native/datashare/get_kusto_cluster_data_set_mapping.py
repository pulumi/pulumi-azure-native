...
def get_kusto_cluster_data_set_mapping_output(account_name: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKustoClusterDataSetMappingResult]:
    """
    Get a DataSetMapping in a shareSubscription
    Azure REST API version: 2021-08-01.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getKustoClusterDataSetMapping', __args__, opts=opts, typ=GetKustoClusterDataSetMappingResult)
    return __ret__.apply(lambda __response__: GetKustoClusterDataSetMappingResult(
