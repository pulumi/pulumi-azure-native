...
def get_adls_gen2_file_system_data_set(account_name: Optional[builtins.str] = None,
...
def get_adls_gen2_file_system_data_set_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
