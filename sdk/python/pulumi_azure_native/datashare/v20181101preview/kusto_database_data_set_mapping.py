...
warnings.warn("""azure-native:datashare/v20181101preview:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class KustoDatabaseDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_subscription_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoDatabaseDataSetMapping is deprecated: azure-native:datashare/v20181101preview:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.""")
