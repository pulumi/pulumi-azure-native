...
warnings.warn("""azure-native:datashare/v20181101preview:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetKustoClusterDataSetMappingResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_set_mapping_status=None, id=None, kind=None, kusto_cluster_resource_id=None, location=None, name=None, provisioning_state=None, type=None):
...
def get_kusto_cluster_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kusto_cluster_data_set_mapping is deprecated: azure-native:datashare/v20181101preview:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getKustoClusterDataSetMapping', __args__, opts=opts, typ=GetKustoClusterDataSetMappingResult).value
