...
warnings.warn("""azure-native:datashare/v20181101preview:BlobContainerDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobContainerDataSetMapping is deprecated: azure-native:datashare/v20181101preview:BlobContainerDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobContainerDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobContainerDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20181101preview:BlobContainerDataSetMapping',
            resource_name,
            __props__,
            opts)
