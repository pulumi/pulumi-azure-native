...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datashare/v20181101preview:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:DataSet":
                return DataSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:DataSetMapping":
                return DataSetMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:Invitation":
                return Invitation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:ShareSubscription":
                return ShareSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:SynchronizationSetting":
                return SynchronizationSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20181101preview:Trigger":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datashare/v20181101preview", _module_instance)
