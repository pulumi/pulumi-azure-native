...
warnings.warn("""azure-native:datashare/v20181101preview:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class KustoClusterDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoClusterDataSet is deprecated: azure-native:datashare/v20181101preview:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""")
