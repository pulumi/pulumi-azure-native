...
class KustoClusterDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare:KustoClusterDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoClusterDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoClusterDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:KustoClusterDataSet")])
