...
class ADLSGen2FileDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['ADLSGen2FileDataSetMappingPropertiesArgs'],
        ...
        :param pulumi.Input['ADLSGen2FileDataSetMappingPropertiesArgs'] properties: ADLS Gen2 file data set mapping properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['ADLSGen2FileDataSetMappingPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['ADLSGen2FileDataSetMappingPropertiesArgs']):
...
class ADLSGen2FileDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ADLSGen2FileDataSetMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Kind of data set mapping.
               Expected value is 'AdlsGen2File'.
        :param pulumi.Input[pulumi.InputType['ADLSGen2FileDataSetMappingPropertiesArgs']] properties: ADLS Gen2 file data set mapping properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[str] share_subscription_name: The name of the share subscription which will hold the data set sink.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ADLSGen2FileDataSetMappingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ADLSGen2FileDataSetMappingArgs.__new__(ADLSGen2FileDataSetMappingArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ADLSGen2FileDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ADLSGen2FileDataSetMapping':
        """
        ...
        __props__.__dict__["type"] = None
        return ADLSGen2FileDataSetMapping(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ADLSGen2FileDataSetMappingPropertiesResponse']:
        """
        ADLS Gen2 file data set mapping properties.
        """
        return pulumi.get(self, "properties")
