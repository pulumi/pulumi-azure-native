...
class BlobFolderDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_folder_data_set_mapping = azure_native.datashare.v20181101preview.BlobFolderDataSetMapping("blobFolderDataSetMapping",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20181101preview:BlobFolderDataSetMapping DatasetMapping1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shareSubscriptions/ShareSubscription1/dataSetMappings/DatasetMapping1 
        ```
