...
warnings.warn("""azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_adls_gen2_file_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_data_set_mapping is deprecated: azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
