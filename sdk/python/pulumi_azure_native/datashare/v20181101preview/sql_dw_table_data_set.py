...
warnings.warn("""azure-native:datashare/v20181101preview:SqlDWTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlDWTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDWTableDataSet")])
