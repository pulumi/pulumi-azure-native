...
warnings.warn("""azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlDBTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDBTableDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDBTableDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping',
            resource_name,
            __props__,
            opts)
