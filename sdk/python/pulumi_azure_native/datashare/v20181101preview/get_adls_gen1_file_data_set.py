...
warnings.warn("""azure-native:datashare/v20181101preview:ADLSGen1FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen1FileDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetADLSGen1FileDataSetResult:
    ...
    """
    def __init__(__self__, account_name=None, data_set_id=None, file_name=None, folder_path=None, id=None, kind=None, name=None, resource_group=None, subscription_id=None, type=None):
...
def get_adls_gen1_file_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen1_file_data_set is deprecated: azure-native:datashare/v20181101preview:ADLSGen1FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen1FileDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getADLSGen1FileDataSet', __args__, opts=opts, typ=GetADLSGen1FileDataSetResult).value
