...
warnings.warn("""azure-native:datashare/v20181101preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetBlobDataSetResult:
    ...
    """
    def __init__(__self__, container_name=None, data_set_id=None, file_path=None, id=None, kind=None, name=None, resource_group=None, storage_account_name=None, subscription_id=None, type=None):
...
def get_blob_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_data_set is deprecated: azure-native:datashare/v20181101preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getBlobDataSet', __args__, opts=opts, typ=GetBlobDataSetResult).value
