...
warnings.warn("""azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetADLSGen2FileSystemDataSetMappingResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_set_mapping_status=None, file_system=None, id=None, kind=None, name=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, type=None):
...
def get_adls_gen2_file_system_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_system_data_set_mapping is deprecated: azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getADLSGen2FileSystemDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetMappingResult).value
