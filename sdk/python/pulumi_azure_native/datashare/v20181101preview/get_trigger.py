...
def get_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_trigger is deprecated: Version v20181101preview will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getTrigger', __args__, opts=opts, typ=GetTriggerResult).value
