...
def get_share_subscription(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share_subscription is deprecated: Version 2018-11-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['shareSubscriptionName'] = share_subscription_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getShareSubscription', __args__, opts=opts, typ=GetShareSubscriptionResult).value
