...
azure-native:datashare/v20181101preview:Invitation is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Invitation to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:datashare/v20181101preview:Invitation is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Invitation to guarantee forwards compatibility.""")
        ...
        super(Invitation, __self__).__init__(
            'azure-native:datashare/v20181101preview:Invitation',
            resource_name,
            __props__,
            opts)
