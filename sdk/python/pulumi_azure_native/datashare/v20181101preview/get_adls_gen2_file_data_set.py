...
def get_adls_gen2_file_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_data_set is deprecated: azure-native:datashare/v20181101preview:ADLSGen2FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
