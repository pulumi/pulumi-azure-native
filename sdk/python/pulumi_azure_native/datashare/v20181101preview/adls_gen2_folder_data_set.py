...
warnings.warn("""azure-native:datashare/v20181101preview:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class ADLSGen2FolderDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ADLSGen2FolderDataSet is deprecated: azure-native:datashare/v20181101preview:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.""")
