...
class ADLSGen2FolderDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping")])
