...
def get_adls_gen2_file_system_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_system_data_set is deprecated: azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
