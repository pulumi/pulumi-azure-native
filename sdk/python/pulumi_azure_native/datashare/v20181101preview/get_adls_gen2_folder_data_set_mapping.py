...
warnings.warn("""azure-native:datashare/v20181101preview:ADLSGen2FolderDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetADLSGen2FolderDataSetMappingResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_set_mapping_status=None, file_system=None, folder_path=None, id=None, kind=None, name=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, type=None):
...
def get_adls_gen2_folder_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getADLSGen2FolderDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FolderDataSetMappingResult).value
