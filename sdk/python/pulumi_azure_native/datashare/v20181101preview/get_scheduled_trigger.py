...
warnings.warn("""azure-native:datashare/v20181101preview:ScheduledTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ScheduledTrigger to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scheduled_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_trigger is deprecated: azure-native:datashare/v20181101preview:ScheduledTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ScheduledTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20181101preview:getScheduledTrigger', __args__, opts=opts, typ=GetScheduledTriggerResult).value
