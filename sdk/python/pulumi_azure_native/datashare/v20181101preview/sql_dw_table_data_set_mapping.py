...
warnings.warn("""azure-native:datashare/v20181101preview:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlDWTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlDWTableDataSetMapping is deprecated: azure-native:datashare/v20181101preview:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.""")
