...
class GetSynapseWorkspaceSqlPoolTableDataSetMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, data_set_mapping_status=None, id=None, kind=None, name=None, provisioning_state=None, synapse_workspace_sql_pool_table_resource_id=None, system_data=None, type=None):
    ...
    def synapse_workspace_sql_pool_table_resource_id(self) -> builtins.str:
        """
...
def get_synapse_workspace_sql_pool_table_data_set_mapping(account_name: Optional[builtins.str] = None,
...
def get_synapse_workspace_sql_pool_table_data_set_mapping_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
