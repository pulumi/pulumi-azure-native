...
class ADLSGen2FolderDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 file_system: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] file_system: File system to which the folder belongs.
        :param pulumi.Input[builtins.str] folder_path: Folder path within the file system.
    ...
    def file_system(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @file_system.setter
    def file_system(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:datashare:ADLSGen2FolderDataSetMapping")
class ADLSGen2FolderDataSetMapping(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="fileSystem")
    def file_system(self) -> pulumi.Output[builtins.str]:
        """
        File system to which the folder belongs.
        """
        return pulumi.get(self, "file_system")
