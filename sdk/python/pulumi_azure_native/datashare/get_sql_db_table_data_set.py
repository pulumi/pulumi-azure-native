...
def get_sql_db_table_data_set(account_name: Optional[builtins.str] = None,
...
def get_sql_db_table_data_set_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
