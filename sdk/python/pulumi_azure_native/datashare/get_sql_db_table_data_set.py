...
class GetSqlDBTableDataSetResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, database_name=None, id=None, kind=None, name=None, schema_name=None, sql_server_resource_id=None, system_data=None, table_name=None, type=None):
...
def get_sql_db_table_data_set(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare:getSqlDBTableDataSet', __args__, opts=opts, typ=GetSqlDBTableDataSetResult).value
...
def get_sql_db_table_data_set_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getSqlDBTableDataSet', __args__, opts=opts, typ=GetSqlDBTableDataSetResult)
