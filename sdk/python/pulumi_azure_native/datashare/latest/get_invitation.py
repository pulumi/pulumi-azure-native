...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getInvitation'.""", DeprecationWarning)
...
def get_invitation(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_invitation is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getInvitation'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getInvitation', __args__, opts=opts, typ=GetInvitationResult).value
