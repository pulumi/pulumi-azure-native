...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getShare'.""", DeprecationWarning)
...
def get_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getShare'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getShare', __args__, opts=opts, typ=GetShareResult).value
