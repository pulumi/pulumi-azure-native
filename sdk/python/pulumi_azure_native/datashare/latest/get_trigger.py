...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getTrigger'.""", DeprecationWarning)
...
def get_trigger(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getTrigger', __args__, opts=opts, typ=GetTriggerResult).value
