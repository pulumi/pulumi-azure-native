...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getDataSet'.""", DeprecationWarning)
...
def get_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getDataSet', __args__, opts=opts, typ=GetDataSetResult).value
