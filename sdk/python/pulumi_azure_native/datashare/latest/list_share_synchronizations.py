...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:listShareSynchronizations'.""", DeprecationWarning)
...
def list_share_synchronizations(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_share_synchronizations is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:listShareSynchronizations'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult).value
