...
def get_blob_data_set_mapping(account_name: Optional[_builtins.str] = None,
...
def get_blob_data_set_mapping_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
