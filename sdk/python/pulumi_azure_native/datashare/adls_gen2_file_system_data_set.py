...
class ADLSGen2FileSystemDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet")])
