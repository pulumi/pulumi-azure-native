...
class ADLSGen1FileDataSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: The ADLS account name.
        :param pulumi.Input[builtins.str] file_name: The file name in the ADLS account.
        :param pulumi.Input[builtins.str] folder_path: The folder path within the ADLS account.
        :param pulumi.Input[builtins.str] kind: Kind of data set.
               Expected value is 'AdlsGen1File'.
        :param pulumi.Input[builtins.str] resource_group: Resource group of ADLS account.
        ...
        :param pulumi.Input[builtins.str] subscription_id: Subscription id of ADLS account.
...
class ADLSGen1FileDataSet(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:datashare:ADLSGen1FileDataSet"
