...
class SqlDBTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDBTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:SqlDBTableDataSetMapping")])
