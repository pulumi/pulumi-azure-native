...
class SqlDBTableDataSetMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_name: DatabaseName name of the sink data set
        ...
        :param pulumi.Input[_builtins.str] table_name: SQL DB table name.
...
@pulumi.type_token("azure-native:datashare:SqlDBTableDataSetMapping")
