...
class BlobFolderDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobFolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobFolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobFolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobFolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobFolderDataSet")])
