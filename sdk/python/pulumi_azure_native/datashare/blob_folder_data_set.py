...
class BlobFolderDataSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_name: Container that has the file path.
        :param pulumi.Input[builtins.str] kind: Kind of data set.
               Expected value is 'BlobFolder'.
        :param pulumi.Input[builtins.str] prefix: Prefix for blob folder
        :param pulumi.Input[builtins.str] resource_group: Resource group of storage account
        ...
        :param pulumi.Input[builtins.str] storage_account_name: Storage account name of the source data set
        :param pulumi.Input[builtins.str] subscription_id: Subscription id of storage account
...
class BlobFolderDataSet(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:datashare:BlobFolderDataSet"
