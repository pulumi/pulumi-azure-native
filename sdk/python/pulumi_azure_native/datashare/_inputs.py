...
class TableLevelSharingPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] materialized_views_to_include: Materialized views to be included in the data set
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tables_to_exclude: Tables to be excluded in the data set
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tables_to_include: Tables to be included in the data set
        """
