...
class IdentityArgs:
    def __init__(__self__, *,
        ...
        """
        Identity of resource
        :param pulumi.Input[Union[builtins.str, 'Type']] type: Identity Type
        """
        if type is not None:
...
class TableLevelSharingPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Table level sharing properties dto for kusto data set properties
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_tables_to_exclude: External tables to be excluded in the data set
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_tables_to_include: External tables to be included in the data set
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] materialized_views_to_exclude: Materialized views to be excluded in the data set
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] materialized_views_to_include: Materialized views to be included in the data set
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables_to_exclude: Tables to be excluded in the data set
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables_to_include: Tables to be included in the data set
        """
