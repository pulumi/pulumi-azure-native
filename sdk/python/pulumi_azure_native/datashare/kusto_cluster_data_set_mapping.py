...
class KustoClusterDataSetMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kusto_cluster_resource_id: Resource id of the sink kusto cluster.
...
class KustoClusterDataSetMapping(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:datashare:KustoClusterDataSetMapping"
