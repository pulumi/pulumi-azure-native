...
class ScheduledSourceSynchronizationSettingResponse(dict):
    ...
    def __init__(__self__, *,
                 kind: _builtins.str,
                 recurrence_interval: Optional[_builtins.str] = None,
        ...
        :param _builtins.str synchronization_time: Synchronization time
        """
...
class SynchronizationDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str end_time: End time of data set level copy
        :param _builtins.float files_read: The number of files read from the source data set
        :param _builtins.float files_written: The number of files written into the sink data set
        :param _builtins.str message: Error message if any
        :param _builtins.str name: Name of the data set
        :param _builtins.float rows_copied: The number of files copied into the sink data set
        :param _builtins.float rows_read: The number of rows read from the source data set.
        :param _builtins.float size_read: The size of the data read from the source data set in bytes
        :param _builtins.float size_written: The size of the data written into the sink data set in bytes
        :param _builtins.str start_time: Start time of data set level copy
        :param _builtins.str status: Raw Status
        :param _builtins.float v_core: The vCore units consumed for the data set synchronization
        """
...
class TableLevelSharingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] materialized_views_to_include: Materialized views to be included in the data set
        :param Sequence[_builtins.str] tables_to_exclude: Tables to be excluded in the data set
        :param Sequence[_builtins.str] tables_to_include: Tables to be included in the data set
        """
