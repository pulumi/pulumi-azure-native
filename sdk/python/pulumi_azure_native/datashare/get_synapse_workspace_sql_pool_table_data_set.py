...
def get_synapse_workspace_sql_pool_table_data_set(account_name: Optional[_builtins.str] = None,
...
def get_synapse_workspace_sql_pool_table_data_set_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
