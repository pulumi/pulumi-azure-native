...
def list_share_synchronizations(account_name: Optional[_builtins.str] = None,
...
def list_share_synchronizations_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult)
