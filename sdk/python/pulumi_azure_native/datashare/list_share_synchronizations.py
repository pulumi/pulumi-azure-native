...
def list_share_synchronizations(account_name: Optional[builtins.str] = None,
...
def list_share_synchronizations_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
