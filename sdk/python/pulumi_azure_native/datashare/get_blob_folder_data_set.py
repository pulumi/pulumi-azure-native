...
class GetBlobFolderDataSetResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, container_name=None, data_set_id=None, id=None, kind=None, name=None, prefix=None, resource_group=None, storage_account_name=None, subscription_id=None, system_data=None, type=None):
...
def get_blob_folder_data_set(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare:getBlobFolderDataSet', __args__, opts=opts, typ=GetBlobFolderDataSetResult).value
...
def get_blob_folder_data_set_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getBlobFolderDataSet', __args__, opts=opts, typ=GetBlobFolderDataSetResult)
    return __ret__.apply(lambda __response__: GetBlobFolderDataSetResult(
