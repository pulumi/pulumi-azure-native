...
def get_adls_gen1_file_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getADLSGen1FileDataSet', __args__, opts=opts, typ=GetADLSGen1FileDataSetResult)
