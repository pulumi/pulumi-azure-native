...
def get_adls_gen1_file_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen1_file_data_set is deprecated: azure-native:datashare/v20201001preview:ADLSGen1FileDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen1FileDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
