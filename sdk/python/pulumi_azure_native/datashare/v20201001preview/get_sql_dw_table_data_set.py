...
warnings.warn("""azure-native:datashare/v20201001preview:SqlDWTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_dw_table_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_dw_table_data_set is deprecated: azure-native:datashare/v20201001preview:SqlDWTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
