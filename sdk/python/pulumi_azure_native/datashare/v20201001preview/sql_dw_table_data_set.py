...
class SqlDWTableDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_dw_table_data_set = azure_native.datashare.v20201001preview.SqlDWTableDataSet("sqlDWTableDataSet",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDWTableDataSet")])
