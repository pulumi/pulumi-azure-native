...
class ADLSGen1FileDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        adls_gen1_file_data_set = azure_native.datashare.v20201001preview.ADLSGen1FileDataSet("adlsGen1FileDataSet",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20201001preview:ADLSGen1FileDataSet dataset1 /subscriptions/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/sourceAccount/shares/share1/dataSets/dataset1 
        ```
