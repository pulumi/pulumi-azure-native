...
class ADLSGen2FileDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        adls_gen2_file_data_set_mapping = azure_native.datashare.v20201001preview.ADLSGen2FileDataSetMapping("adlsGen2FileDataSetMapping",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping")])
