...
def get_adls_gen2_folder_data_set_mapping_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getADLSGen2FolderDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FolderDataSetMappingResult)
    return __ret__.apply(lambda __response__: GetADLSGen2FolderDataSetMappingResult(
