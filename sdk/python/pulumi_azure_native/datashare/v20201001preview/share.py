...
warnings.warn("""azure-native:datashare/v20201001preview:Share is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:Share to guarantee forwards compatibility.""", DeprecationWarning)
...
class Share(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 terms: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Share is deprecated: azure-native:datashare/v20201001preview:Share is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:Share to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:Share"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Share"), pulumi.Alias(type_="azure-native:datashare/v20191101:Share"), pulumi.Alias(type_="azure-native:datashare/v20200901:Share"), pulumi.Alias(type_="azure-native:datashare/v20210801:Share")])
