...
def get_blob_folder_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_folder_data_set is deprecated: azure-native:datashare/v20201001preview:BlobFolderDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobFolderDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
