...
def get_blob_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_data_set is deprecated: azure-native:datashare/v20201001preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
