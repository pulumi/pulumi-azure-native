...
def get_adls_gen2_folder_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getADLSGen2FolderDataSet', __args__, opts=opts, typ=GetADLSGen2FolderDataSetResult)
