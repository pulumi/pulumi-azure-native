...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_container_data_set_mapping = azure_native.datashare.v20201001preview.BlobContainerDataSetMapping("blobContainerDataSetMapping",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobContainerDataSetMapping")])
