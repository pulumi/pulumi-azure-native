...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobContainerDataSetMapping")])
