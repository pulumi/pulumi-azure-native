...
def get_kusto_cluster_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getKustoClusterDataSet', __args__, opts=opts, typ=GetKustoClusterDataSetResult)
