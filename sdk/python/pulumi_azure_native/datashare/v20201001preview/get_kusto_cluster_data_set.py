...
warnings.warn("""azure-native:datashare/v20201001preview:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_kusto_cluster_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kusto_cluster_data_set is deprecated: azure-native:datashare/v20201001preview:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20201001preview:getKustoClusterDataSet', __args__, opts=opts, typ=GetKustoClusterDataSetResult).value
