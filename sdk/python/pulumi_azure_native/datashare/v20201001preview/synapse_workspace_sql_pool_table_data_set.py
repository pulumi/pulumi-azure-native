...
class SynapseWorkspaceSqlPoolTableDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        synapse_workspace_sql_pool_table_data_set = azure_native.datashare.v20201001preview.SynapseWorkspaceSqlPoolTableDataSet("synapseWorkspaceSqlPoolTableDataSet",
