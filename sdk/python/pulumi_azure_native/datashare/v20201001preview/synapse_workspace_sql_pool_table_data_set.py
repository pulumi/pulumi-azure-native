...
warnings.warn("""azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class SynapseWorkspaceSqlPoolTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 synapse_workspace_sql_pool_table_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SynapseWorkspaceSqlPoolTableDataSet is deprecated: azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSet to guarantee forwards compatibility.""")
