...
__all__ = ['BlobDataSetArgs', 'BlobDataSet']
...
warnings.warn("""azure-native:datashare/v20201001preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class BlobDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlobDataSetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobDataSet is deprecated: azure-native:datashare/v20201001preview:BlobDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobDataSet to guarantee forwards compatibility.""")
        ...
        if opts.id is None:
            ...
            __props__ = BlobDataSetArgs.__new__(BlobDataSetArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobDataSet, __self__).__init__(
            'azure-native:datashare/v20201001preview:BlobDataSet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BlobDataSet':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BlobDataSet(resource_name, opts=opts, __props__=__props__)
