...
class SqlDWTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:SqlDWTableDataSetMapping")])
