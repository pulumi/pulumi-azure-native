...
def get_kusto_database_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getKustoDatabaseDataSet', __args__, opts=opts, typ=GetKustoDatabaseDataSetResult)
