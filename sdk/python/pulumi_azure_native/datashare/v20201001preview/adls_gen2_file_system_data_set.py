...
class ADLSGen2FileSystemDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        adls_gen2_file_system_data_set = azure_native.datashare.v20201001preview.ADLSGen2FileSystemDataSet("adlsGen2FileSystemDataSet",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet")])
