...
def get_adls_gen2_file_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20201001preview:getADLSGen2FileDataSet', __args__, opts=opts, typ=GetADLSGen2FileDataSetResult)
