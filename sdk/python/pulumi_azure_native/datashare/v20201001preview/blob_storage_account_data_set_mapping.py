...
class BlobStorageAccountDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['BlobStorageAccountDataSetMappingPropertiesArgs'],
        ...
        :param pulumi.Input['BlobStorageAccountDataSetMappingPropertiesArgs'] properties: Blob Storage account data set mapping properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['BlobStorageAccountDataSetMappingPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['BlobStorageAccountDataSetMappingPropertiesArgs']):
...
class BlobStorageAccountDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BlobStorageAccountDataSetMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Kind of data set mapping.
               Expected value is 'BlobStorageAccount'.
        :param pulumi.Input[pulumi.InputType['BlobStorageAccountDataSetMappingPropertiesArgs']] properties: Blob Storage account data set mapping properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[str] share_subscription_name: The name of the share subscription which will hold the data set sink.
        """
        ...
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BlobStorageAccountDataSetMappingPropertiesResponse']:
        """
        Blob Storage account data set mapping properties.
        """
        return pulumi.get(self, "properties")
