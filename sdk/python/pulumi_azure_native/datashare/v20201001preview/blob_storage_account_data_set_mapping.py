...
class BlobStorageAccountDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobStorageAccountDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobStorageAccountDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobStorageAccountDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobStorageAccountDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:BlobStorageAccountDataSetMapping")])
