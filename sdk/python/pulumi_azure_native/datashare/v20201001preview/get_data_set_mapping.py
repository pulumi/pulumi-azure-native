...
def get_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_set_mapping is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20201001preview:getDataSetMapping', __args__, opts=opts, typ=GetDataSetMappingResult).value
