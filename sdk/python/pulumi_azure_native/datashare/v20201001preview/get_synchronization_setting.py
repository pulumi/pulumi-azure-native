...
def get_synchronization_setting(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_synchronization_setting is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20201001preview:getSynchronizationSetting', __args__, opts=opts, typ=GetSynchronizationSettingResult).value
