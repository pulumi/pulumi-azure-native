...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datashare/v20201001preview:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:DataSet":
                return DataSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:DataSetMapping":
                return DataSetMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:Invitation":
                return Invitation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:ShareSubscription":
                return ShareSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:SynchronizationSetting":
                return SynchronizationSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20201001preview:Trigger":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datashare/v20201001preview", _module_instance)
