...
warnings.warn("""azure-native:datashare/v20201001preview:SqlDBTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlDBTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlDBTableDataSet is deprecated: azure-native:datashare/v20201001preview:SqlDBTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDBTableDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDBTableDataSet, __self__).__init__(
            'azure-native:datashare/v20201001preview:SqlDBTableDataSet',
            resource_name,
            __props__,
            opts)
