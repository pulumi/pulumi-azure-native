...
__all__ = [
    ...
    'ADLSGen2StorageAccountDataSetMappingPropertiesResponse',
    'ADLSGen2StorageAccountDataSetPropertiesResponse',
    ...
    'BlobStorageAccountDataSetMappingPropertiesResponse',
    'BlobStorageAccountDataSetPropertiesResponse',
...
@pulumi.output_type
class ADLSGen2StorageAccountDataSetMappingPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ADLSGen2StorageAccountDataSetMappingPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ADLSGen2StorageAccountDataSetMappingPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of the ADLSGen2 storage account data set.
        :param str container_name: Gets or sets the container name.
        :param str data_set_id: The id of the source data set.
        :param str data_set_mapping_status: Gets the status of the data set mapping.
        :param str folder: Gets or sets the path to folder within the container.
        :param str location: Location of the sink storage account.
        :param str provisioning_state: Provisioning state of the data set mapping.
        :param str storage_account_resource_id: Resource id of the sink storage account
        :param str mount_path: Gets or sets the mount path
        """
...
@pulumi.output_type
class ADLSGen2StorageAccountDataSetPropertiesResponse(dict):
    """
    Properties of the ADLSGen2 storage account data set.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ADLSGen2StorageAccountDataSetPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ADLSGen2StorageAccountDataSetPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 data_set_id: str,
                 location: str,
                 paths: Sequence['outputs.ADLSGen2StorageAccountPathResponse'],
                 storage_account_resource_id: str):
        """
        Properties of the ADLSGen2 storage account data set.
        :param str data_set_id: Unique id for identifying a data set resource
        :param str location: Location of the ADLSGen2 storage account.
        :param Sequence['ADLSGen2StorageAccountPathResponse'] paths: A list of ADLSGen2 storage account paths.
        :param str storage_account_resource_id: Resource id of the ADLSGen2 storage account.
        """
        pulumi.set(__self__, "data_set_id", data_set_id)
        pulumi.set(__self__, "location", location)
...
@pulumi.output_type
class BlobStorageAccountDataSetMappingPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BlobStorageAccountDataSetMappingPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BlobStorageAccountDataSetMappingPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param str provisioning_state: Provisioning state of the data set mapping.
        :param str storage_account_resource_id: Resource id of the sink storage account
        :param str mount_path: Gets or sets the mount path on the consumer side where the dataset is to be mapped.
        """
        pulumi.set(__self__, "container_name", container_name)
        pulumi.set(__self__, "data_set_id", data_set_id)
        pulumi.set(__self__, "data_set_mapping_status", data_set_mapping_status)
...
@pulumi.output_type
class BlobStorageAccountDataSetPropertiesResponse(dict):
    """
    Properties of the blob storage account data set.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in BlobStorageAccountDataSetPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        BlobStorageAccountDataSetPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 data_set_id: str,
                 location: str,
                 paths: Sequence['outputs.BlobStorageAccountPathResponse'],
                 storage_account_resource_id: str):
        """
        Properties of the blob storage account data set.
        :param str data_set_id: Unique id for identifying a data set resource
        :param str location: Location of the storage account.
        :param Sequence['BlobStorageAccountPathResponse'] paths: A list of storage account paths.
        :param str storage_account_resource_id: Resource id of the storage account.
        """
        pulumi.set(__self__, "data_set_id", data_set_id)
        pulumi.set(__self__, "location", location)
        pulumi.set(__self__, "paths", paths)
