...
class ADLSGen2FileDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        adls_gen2_file_data_set = azure_native.datashare.v20201001preview.ADLSGen2FileDataSet("adlsGen2FileDataSet",
