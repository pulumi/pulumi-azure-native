...
warnings.warn("""azure-native:datashare/v20201001preview:BlobFolderDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobFolderDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
