...
warnings.warn("""azure-native:datashare/v20201001preview:ShareSubscription is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ShareSubscription to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_share_subscription(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share_subscription is deprecated: azure-native:datashare/v20201001preview:ShareSubscription is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ShareSubscription to guarantee forwards compatibility.""")
    __args__ = dict()
