...
class BlobStorageAccountDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-native:datashare:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobStorageAccountDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:BlobStorageAccountDataSet")])
