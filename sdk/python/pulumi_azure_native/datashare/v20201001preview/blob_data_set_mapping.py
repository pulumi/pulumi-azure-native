...
warnings.warn("""azure-native:datashare/v20201001preview:BlobDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class BlobDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobDataSetMapping is deprecated: azure-native:datashare/v20201001preview:BlobDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobDataSetMapping to guarantee forwards compatibility.""")
