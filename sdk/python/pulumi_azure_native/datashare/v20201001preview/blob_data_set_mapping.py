...
class BlobDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_data_set_mapping = azure_native.datashare.v20201001preview.BlobDataSetMapping("blobDataSetMapping",
