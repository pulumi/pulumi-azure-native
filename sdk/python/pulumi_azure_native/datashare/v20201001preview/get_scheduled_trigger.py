...
def get_scheduled_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_trigger is deprecated: azure-native:datashare/v20201001preview:ScheduledTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ScheduledTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
