...
def get_blob_folder_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_folder_data_set_mapping is deprecated: azure-native:datashare/v20201001preview:BlobFolderDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
