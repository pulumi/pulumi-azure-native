...
class ScheduledSynchronizationSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kind: Kind of synchronization setting.
        ...
        :param pulumi.Input[builtins.str] share_name: The name of the share to add the synchronization setting to.
        :param pulumi.Input[builtins.str] synchronization_time: Synchronization time
        :param pulumi.Input[builtins.str] synchronization_setting_name: The name of the synchronizationSetting.
        """
    ...
    def synchronization_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def synchronization_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScheduledSynchronizationSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare/v20181101preview:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20191101:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20200901:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20210801:ScheduledSynchronizationSetting")])
