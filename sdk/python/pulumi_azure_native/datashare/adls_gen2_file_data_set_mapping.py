...
class ADLSGen2FileDataSetMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_path: File path within the file system.
        :param pulumi.Input[builtins.str] file_system: File system to which the file belongs.
        ...
        :param pulumi.Input[Union[builtins.str, 'OutputType']] output_type: Type of output file
        """
