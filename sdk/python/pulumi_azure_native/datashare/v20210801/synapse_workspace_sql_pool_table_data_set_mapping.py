...
class SynapseWorkspaceSqlPoolTableDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        synapse_workspace_sql_pool_table_data_set_mapping = azure_native.datashare.v20210801.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMapping",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SynapseWorkspaceSqlPoolTableDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20210801:SynapseWorkspaceSqlPoolTableDataSetMapping',
            resource_name,
            __props__,
            opts)
