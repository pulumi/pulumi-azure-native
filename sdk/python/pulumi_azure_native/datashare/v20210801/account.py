...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:Account"), pulumi.Alias(type_="azure-native:datashare/v20200901:Account"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Account")])
