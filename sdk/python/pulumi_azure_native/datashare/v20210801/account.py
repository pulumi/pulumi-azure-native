...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] account_name: The name of the share account.
        :param pulumi.Input[Union['IdentityArgs', 'IdentityArgsDict']] identity: Identity Info on the Account
        :param pulumi.Input[str] location: Location of the azure resource.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Tags on the azure resource.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:Account"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Account"), pulumi.Alias(type_="azure-native:datashare/v20191101:Account"), pulumi.Alias(type_="azure-native:datashare/v20200901:Account"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Account")])
