...
class KustoTableDataSetArgs:
    def __init__(__self__, *,
        ...
        """
        KustoTableDataSetArgs._configure(
    ...
    def _configure(
        ...
        if 'kustoDatabaseResourceId' in kwargs:
...
class KustoTableDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            KustoTableDataSetArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if table_level_sharing_properties is not None and not isinstance(table_level_sharing_properties, TableLevelSharingPropertiesArgs):
