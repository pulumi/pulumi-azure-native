...
def get_blob_folder_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getBlobFolderDataSet', __args__, opts=opts, typ=GetBlobFolderDataSetResult).value
...
def get_blob_folder_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['shareName'] = share_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getBlobFolderDataSet', __args__, opts=opts, typ=GetBlobFolderDataSetResult)
