...
class KustoDatabaseDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_database_data_set_mapping = azure_native.datashare.v20210801.KustoDatabaseDataSetMapping("kustoDatabaseDataSetMapping",
