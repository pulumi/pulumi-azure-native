...
class KustoClusterDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_cluster_data_set = azure_native.datashare.v20210801.KustoClusterDataSet("kustoClusterDataSet",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoClusterDataSet")])
