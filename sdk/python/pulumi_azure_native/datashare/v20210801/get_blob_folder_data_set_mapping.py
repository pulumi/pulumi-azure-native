...
def get_blob_folder_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getBlobFolderDataSetMapping', __args__, opts=opts, typ=GetBlobFolderDataSetMappingResult).value
...
def get_blob_folder_data_set_mapping_output(account_name: Optional[pulumi.Input[str]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBlobFolderDataSetMappingResult]:
    """
    Get a DataSetMapping in a shareSubscription
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getBlobFolderDataSetMapping', __args__, opts=opts, typ=GetBlobFolderDataSetMappingResult)
