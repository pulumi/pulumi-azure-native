...
def get_adls_gen2_file_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getADLSGen2FileDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileDataSetMappingResult).value
