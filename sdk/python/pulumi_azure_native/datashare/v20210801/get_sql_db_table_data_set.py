...
def get_sql_db_table_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getSqlDBTableDataSet', __args__, opts=opts, typ=GetSqlDBTableDataSetResult).value
...
def get_sql_db_table_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSqlDBTableDataSetResult]:
    """
    Get a DataSet in a share
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getSqlDBTableDataSet', __args__, opts=opts, typ=GetSqlDBTableDataSetResult)
    return __ret__.apply(lambda __response__: GetSqlDBTableDataSetResult(
