...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20210801:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobContainerDataSetMapping")])
