...
__all__ = ['BlobContainerDataSetMappingArgs', 'BlobContainerDataSetMapping']
...
class BlobContainerDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['BlobContainerMappingPropertiesArgs'],
        ...
        :param pulumi.Input['BlobContainerMappingPropertiesArgs'] properties: Blob container data set mapping properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['BlobContainerMappingPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['BlobContainerMappingPropertiesArgs']):
...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['BlobContainerMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Kind of data set mapping.
               Expected value is 'Container'.
        :param pulumi.Input[pulumi.InputType['BlobContainerMappingPropertiesArgs']] properties: Blob container data set mapping properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[str] share_subscription_name: The name of the share subscription which will hold the data set sink.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlobContainerDataSetMappingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BlobContainerDataSetMappingArgs.__new__(BlobContainerDataSetMappingArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobContainerDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20210801:BlobContainerDataSetMapping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BlobContainerDataSetMapping':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BlobContainerDataSetMapping(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BlobContainerMappingPropertiesResponse']:
        """
        Blob container data set mapping properties.
        """
        return pulumi.get(self, "properties")
