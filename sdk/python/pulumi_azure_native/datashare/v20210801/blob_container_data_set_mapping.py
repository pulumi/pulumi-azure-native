...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_container_data_set_mapping = azure_native.datashare.v20210801.BlobContainerDataSetMapping("blobContainerDataSetMapping",
