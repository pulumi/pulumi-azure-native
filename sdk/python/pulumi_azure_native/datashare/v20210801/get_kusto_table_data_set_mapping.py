...
def get_kusto_table_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getKustoTableDataSetMapping', __args__, opts=opts, typ=GetKustoTableDataSetMappingResult).value
...
def get_kusto_table_data_set_mapping_output(account_name: Optional[pulumi.Input[str]] = None,
                                            data_set_mapping_name: Optional[pulumi.Input[str]] = None,
                                            resource_group_name: Optional[pulumi.Input[str]] = None,
                                            share_subscription_name: Optional[pulumi.Input[str]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKustoTableDataSetMappingResult]:
    """
    Get a DataSetMapping in a shareSubscription
    ...
    __args__['shareSubscriptionName'] = share_subscription_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getKustoTableDataSetMapping', __args__, opts=opts, typ=GetKustoTableDataSetMappingResult)
