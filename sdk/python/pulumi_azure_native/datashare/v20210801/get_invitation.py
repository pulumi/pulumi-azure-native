...
def get_invitation(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getInvitation', __args__, opts=opts, typ=GetInvitationResult).value
...
def get_invitation_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['shareName'] = share_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getInvitation', __args__, opts=opts, typ=GetInvitationResult)
