...
__all__ = [
    ...
    'KustoTableDataSetMappingPropertiesResponse',
    'KustoTableDataSetPropertiesResponse',
...
@pulumi.output_type
class KustoTableDataSetMappingPropertiesResponse(dict):
    """
    Properties of the Kusto database data set mapping
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KustoTableDataSetMappingPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KustoTableDataSetMappingPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class KustoTableDataSetPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if key == "dataSetId":
            ...
            suggest = "provisioning_state"
        elif key == "tableLevelSharingProperties":
            suggest = "table_level_sharing_properties"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KustoTableDataSetPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KustoTableDataSetPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param str kusto_database_resource_id: Resource id of the kusto database.
        :param str location: Location of the kusto cluster.
        :param str provisioning_state: Provisioning state of the kusto table data set.
        :param 'TableLevelSharingPropertiesResponse' table_level_sharing_properties: Table level sharing properties for kusto database
        """
        pulumi.set(__self__, "data_set_id", data_set_id)
        pulumi.set(__self__, "kusto_database_resource_id", kusto_database_resource_id)
        pulumi.set(__self__, "location", location)
