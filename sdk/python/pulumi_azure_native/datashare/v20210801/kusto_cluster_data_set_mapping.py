...
class KustoClusterDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_cluster_data_set_mapping = azure_native.datashare.v20210801.KustoClusterDataSetMapping("kustoClusterDataSetMapping",
