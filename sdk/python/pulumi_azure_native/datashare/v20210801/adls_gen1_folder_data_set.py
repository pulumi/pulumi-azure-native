...
class ADLSGen1FolderDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet")])
