...
class ADLSGen2FileDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        adls_gen2_file_data_set_mapping = azure_native.datashare.v20210801.ADLSGen2FileDataSetMapping("adlsGen2FileDataSetMapping",
