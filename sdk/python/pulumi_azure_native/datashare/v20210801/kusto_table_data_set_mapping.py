...
class KustoTableDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['KustoTableDataSetMappingPropertiesArgs'],
        ...
        :param pulumi.Input['KustoTableDataSetMappingPropertiesArgs'] properties: Kusto database data set mapping properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['KustoTableDataSetMappingPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['KustoTableDataSetMappingPropertiesArgs']):
...
class KustoTableDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['KustoTableDataSetMappingPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Kind of data set mapping.
               Expected value is 'KustoTable'.
        :param pulumi.Input[pulumi.InputType['KustoTableDataSetMappingPropertiesArgs']] properties: Kusto database data set mapping properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[str] share_subscription_name: The name of the share subscription which will hold the data set sink.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:KustoTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoTableDataSetMapping")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.KustoTableDataSetMappingPropertiesResponse']:
        """
        Kusto database data set mapping properties.
        """
        return pulumi.get(self, "properties")
