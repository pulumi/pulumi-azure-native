...
def get_kusto_cluster_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getKustoClusterDataSet', __args__, opts=opts, typ=GetKustoClusterDataSetResult).value
...
def get_kusto_cluster_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKustoClusterDataSetResult]:
    """
    Get a DataSet in a share
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getKustoClusterDataSet', __args__, opts=opts, typ=GetKustoClusterDataSetResult)
    return __ret__.apply(lambda __response__: GetKustoClusterDataSetResult(
