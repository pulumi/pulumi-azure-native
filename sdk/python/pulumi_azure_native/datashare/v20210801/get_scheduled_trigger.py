...
def get_scheduled_trigger(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getScheduledTrigger', __args__, opts=opts, typ=GetScheduledTriggerResult).value
...
def get_scheduled_trigger_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['triggerName'] = trigger_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getScheduledTrigger', __args__, opts=opts, typ=GetScheduledTriggerResult)
    return __ret__.apply(lambda __response__: GetScheduledTriggerResult(
        ...
        trigger_status=pulumi.get(__response__, 'trigger_status'),
