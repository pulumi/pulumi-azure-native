...
def get_sql_dw_table_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getSqlDWTableDataSet', __args__, opts=opts, typ=GetSqlDWTableDataSetResult).value
...
def get_sql_dw_table_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['shareName'] = share_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getSqlDWTableDataSet', __args__, opts=opts, typ=GetSqlDWTableDataSetResult)
