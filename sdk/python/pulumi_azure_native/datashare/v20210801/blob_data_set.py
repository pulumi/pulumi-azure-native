...
class BlobDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobDataSet")])
