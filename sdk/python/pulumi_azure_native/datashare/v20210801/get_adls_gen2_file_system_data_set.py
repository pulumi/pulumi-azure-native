...
def get_adls_gen2_file_system_data_set(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20210801:getADLSGen2FileSystemDataSet', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetResult).value
...
def get_adls_gen2_file_system_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetADLSGen2FileSystemDataSetResult]:
    """
    Get a DataSet in a share
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20210801:getADLSGen2FileSystemDataSet', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetResult)
