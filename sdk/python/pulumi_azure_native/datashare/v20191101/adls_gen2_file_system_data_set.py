...
class ADLSGen2FileSystemDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ADLSGen2FileSystemDataSet is deprecated: azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.""")
