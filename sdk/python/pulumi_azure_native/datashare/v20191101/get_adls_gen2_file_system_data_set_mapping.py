...
warnings.warn("""azure-native:datashare/v20191101:ADLSGen2FileSystemDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_adls_gen2_file_system_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getADLSGen2FileSystemDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetMappingResult).value
