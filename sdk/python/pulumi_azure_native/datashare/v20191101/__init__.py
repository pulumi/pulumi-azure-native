...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datashare/v20191101:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:DataSet":
                return DataSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:DataSetMapping":
                return DataSetMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:Invitation":
                return Invitation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:ShareSubscription":
                return ShareSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:SynchronizationSetting":
                return SynchronizationSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datashare/v20191101:Trigger":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datashare/v20191101", _module_instance)
