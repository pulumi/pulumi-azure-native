...
class ADLSGen2FileDataSetArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['ADLSGen2FilePropertiesArgs'],
        ...
        :param pulumi.Input['ADLSGen2FilePropertiesArgs'] properties: ADLS Gen 2 file data set properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['ADLSGen2FilePropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['ADLSGen2FilePropertiesArgs']):
...
class ADLSGen2FileDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['ADLSGen2FilePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Kind of data set.
               Expected value is 'AdlsGen2File'.
        :param pulumi.Input[pulumi.InputType['ADLSGen2FilePropertiesArgs']] properties: ADLS Gen 2 file data set properties.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        :param pulumi.Input[str] share_name: The name of the share to add the data set to.
        """
        ...
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ADLSGen2FilePropertiesResponse']:
        """
        ADLS Gen 2 file data set properties.
        """
        return pulumi.get(self, "properties")
