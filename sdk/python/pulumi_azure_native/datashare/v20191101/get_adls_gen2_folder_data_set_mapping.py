...
def get_adls_gen2_folder_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_folder_data_set_mapping is deprecated: azure-native:datashare/v20191101:ADLSGen2FolderDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
