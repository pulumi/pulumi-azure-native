...
class GetSqlDBTableDataSetMappingResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_set_mapping_status=None, database_name=None, id=None, kind=None, name=None, provisioning_state=None, schema_name=None, sql_server_resource_id=None, table_name=None, type=None):
...
def get_sql_db_table_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_db_table_data_set_mapping is deprecated: azure-native:datashare/v20191101:SqlDBTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDBTableDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getSqlDBTableDataSetMapping', __args__, opts=opts, typ=GetSqlDBTableDataSetMappingResult).value
