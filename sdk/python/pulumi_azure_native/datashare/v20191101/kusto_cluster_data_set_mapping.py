...
warnings.warn("""azure-native:datashare/v20191101:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class KustoClusterDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_subscription_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoClusterDataSetMapping is deprecated: azure-native:datashare/v20191101:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""")
