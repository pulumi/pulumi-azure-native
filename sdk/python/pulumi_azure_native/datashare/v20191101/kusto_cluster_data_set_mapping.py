...
class KustoClusterDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_cluster_data_set_mapping = azure_native.datashare.v20191101.KustoClusterDataSetMapping("kustoClusterDataSetMapping",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20191101:KustoClusterDataSetMapping DatasetMapping1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shareSubscriptions/ShareSubscription1/dataSetMappings/DatasetMapping1 
        ```
