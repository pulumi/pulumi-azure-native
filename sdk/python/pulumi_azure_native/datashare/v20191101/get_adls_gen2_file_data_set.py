...
__all__ = [
    ...
    'get_adls_gen2_file_data_set_output',
]

warnings.warn("""azure-native:datashare/v20191101:ADLSGen2FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_adls_gen2_file_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_data_set is deprecated: azure-native:datashare/v20191101:ADLSGen2FileDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getADLSGen2FileDataSet', __args__, opts=opts, typ=GetADLSGen2FileDataSetResult).value
...
@_utilities.lift_output_func(get_adls_gen2_file_data_set)
def get_adls_gen2_file_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
                                       data_set_name: Optional[pulumi.Input[str]] = None,
                                       resource_group_name: Optional[pulumi.Input[str]] = None,
                                       share_name: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetADLSGen2FileDataSetResult]:
    """
    Get a DataSet in a share
