...
class GetSqlDWTableDataSetResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_warehouse_name=None, id=None, kind=None, name=None, schema_name=None, sql_server_resource_id=None, table_name=None, type=None):
...
def get_sql_dw_table_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_dw_table_data_set is deprecated: azure-native:datashare/v20191101:SqlDWTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getSqlDWTableDataSet', __args__, opts=opts, typ=GetSqlDWTableDataSetResult).value
