...
class SqlDBTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:SqlDBTableDataSet")])
