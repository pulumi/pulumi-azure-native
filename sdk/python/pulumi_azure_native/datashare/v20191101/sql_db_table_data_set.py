...
class SqlDBTableDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_db_table_data_set = azure_native.datashare.v20191101.SqlDBTableDataSet("sqlDBTableDataSet",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20191101:SqlDBTableDataSet Dataset1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shares/Share1/datasets/Dataset1 
        ```
