...
def get_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_set_mapping is deprecated: Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200901 or later.""")
    __args__ = dict()
