...
warnings.warn("""azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_adls_gen2_file_system_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_system_data_set is deprecated: azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FileSystemDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getADLSGen2FileSystemDataSet', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetResult).value
