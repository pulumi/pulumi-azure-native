...
warnings.warn("""azure-native:datashare/v20191101:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetKustoClusterDataSetResult:
    ...
    """
    def __init__(__self__, data_set_id=None, id=None, kind=None, kusto_cluster_resource_id=None, location=None, name=None, provisioning_state=None, type=None):
...
def get_kusto_cluster_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kusto_cluster_data_set is deprecated: azure-native:datashare/v20191101:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getKustoClusterDataSet', __args__, opts=opts, typ=GetKustoClusterDataSetResult).value
