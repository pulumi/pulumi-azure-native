...
class KustoDatabaseDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_database_data_set_mapping = azure_native.datashare.v20191101.KustoDatabaseDataSetMapping("kustoDatabaseDataSetMapping",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:KustoDatabaseDataSetMapping")])
