...
azure-native:datashare/v20191101:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Share to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share is deprecated: Version 2019-11-01 will be removed in v2 of the provider.
azure-native:datashare/v20191101:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Share to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getShare', __args__, opts=opts, typ=GetShareResult).value
