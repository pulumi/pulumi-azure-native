...
class GetADLSGen2FileDataSetMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, data_set_mapping_status=None, file_path=None, file_system=None, id=None, kind=None, name=None, output_type=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, system_data=None, type=None):
...
def get_adls_gen2_file_data_set_mapping(account_name: Optional[_builtins.str] = None,
                                        data_set_mapping_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare:getADLSGen2FileDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileDataSetMappingResult).value
...
def get_adls_gen2_file_data_set_mapping_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                               data_set_mapping_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getADLSGen2FileDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileDataSetMappingResult)
