...
class KustoClusterDataSetArgs:
    def __init__(__self__, *,
        ...
        """
        KustoClusterDataSetArgs._configure(
...
class KustoClusterDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            KustoClusterDataSetArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:KustoClusterDataSet")])
