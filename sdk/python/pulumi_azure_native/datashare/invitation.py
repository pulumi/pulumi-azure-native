...
class InvitationArgs:
    def __init__(__self__, *,
                 ...
                 target_active_directory_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_email: Optional[pulumi.Input[builtins.str]] = None,
                 target_object_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] share_name: The name of the share to send the invitation for.
        :param pulumi.Input[builtins.str] expiration_date: The expiration date for the invitation and share subscription.
        :param pulumi.Input[builtins.str] invitation_name: The name of the invitation.
        :param pulumi.Input[builtins.str] target_active_directory_id: The target Azure AD Id. Can't be combined with email.
        :param pulumi.Input[builtins.str] target_email: The email the invitation is directed to.
        :param pulumi.Input[builtins.str] target_object_id: The target user or application Id that invitation is being sent to.
    ...
    def invitation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def invitation_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "invitation_name", value)

    @property
    @pulumi.getter(name="targetActiveDirectoryId")
    def target_active_directory_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_active_directory_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_active_directory_id", value)

    @property
    @pulumi.getter(name="targetEmail")
    def target_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @target_email.setter
    def target_email(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_email", value)

    @property
    @pulumi.getter(name="targetObjectId")
    def target_object_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_object_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Invitation(pulumi.CustomResource):
    ...
    def invitation_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def responded_at(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def sent_at(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="targetActiveDirectoryId")
    def target_active_directory_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target Azure AD Id. Can't be combined with email.
        """
        return pulumi.get(self, "target_active_directory_id")
    ...
    @property
    @pulumi.getter(name="targetEmail")
    def target_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The email the invitation is directed to.
        """
        return pulumi.get(self, "target_email")
    ...
    @property
    @pulumi.getter(name="targetObjectId")
    def target_object_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target user or application Id that invitation is being sent to.
        Must be specified along TargetActiveDirectoryId. This enables sending
        invitations to specific users or applications in an AD tenant.
