...
class KustoTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:KustoTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:KustoTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:KustoTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:KustoTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:KustoTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:KustoTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:KustoTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:KustoTableDataSet")])
