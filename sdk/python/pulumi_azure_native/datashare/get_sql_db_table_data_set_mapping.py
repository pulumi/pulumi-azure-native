...
class GetSqlDBTableDataSetMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, data_set_mapping_status=None, database_name=None, id=None, kind=None, name=None, provisioning_state=None, schema_name=None, sql_server_resource_id=None, system_data=None, table_name=None, type=None):
...
def get_sql_db_table_data_set_mapping(account_name: Optional[builtins.str] = None,
...
def get_sql_db_table_data_set_mapping_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getSqlDBTableDataSetMapping', __args__, opts=opts, typ=GetSqlDBTableDataSetMappingResult)
