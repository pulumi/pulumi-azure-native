...
class GetSqlDWTableDataSetResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, data_warehouse_name=None, id=None, kind=None, name=None, schema_name=None, sql_server_resource_id=None, system_data=None, table_name=None, type=None):
...
def get_sql_dw_table_data_set(account_name: Optional[builtins.str] = None,
...
def get_sql_dw_table_data_set_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getSqlDWTableDataSet', __args__, opts=opts, typ=GetSqlDWTableDataSetResult)
