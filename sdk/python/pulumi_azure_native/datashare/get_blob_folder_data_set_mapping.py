...
class GetBlobFolderDataSetMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, container_name=None, data_set_id=None, data_set_mapping_status=None, id=None, kind=None, name=None, prefix=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, system_data=None, type=None):
...
def get_blob_folder_data_set_mapping(account_name: Optional[_builtins.str] = None,
...
def get_blob_folder_data_set_mapping_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
