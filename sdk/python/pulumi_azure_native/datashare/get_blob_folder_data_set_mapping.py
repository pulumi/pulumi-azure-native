...
def get_blob_folder_data_set_mapping(account_name: Optional[builtins.str] = None,
...
def get_blob_folder_data_set_mapping_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
