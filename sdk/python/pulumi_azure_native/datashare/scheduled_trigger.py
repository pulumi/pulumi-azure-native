...
class ScheduledTriggerArgs:
    def __init__(__self__, *,
                 ...
                 recurrence_interval: pulumi.Input[Union[builtins.str, 'RecurrenceInterval']],
                 resource_group_name: pulumi.Input[builtins.str],
                 share_subscription_name: pulumi.Input[builtins.str],
                 synchronization_time: pulumi.Input[builtins.str],
                 synchronization_mode: Optional[pulumi.Input[Union[builtins.str, 'SynchronizationMode']]] = None,
        ...
        :param pulumi.Input[builtins.str] kind: Kind of synchronization on trigger.
               Expected value is 'ScheduleBased'.
        :param pulumi.Input[Union[builtins.str, 'RecurrenceInterval']] recurrence_interval: Recurrence Interval
        ...
        :param pulumi.Input[builtins.str] synchronization_time: Synchronization time
        :param pulumi.Input[Union[builtins.str, 'SynchronizationMode']] synchronization_mode: Synchronization mode
        :param pulumi.Input[builtins.str] trigger_name: The name of the trigger.
        """
    ...
    def recurrence_interval(self) -> pulumi.Input[Union[builtins.str, 'RecurrenceInterval']]:
        """
        Recurrence Interval
        """
    ...
    def recurrence_interval(self, value: pulumi.Input[Union[builtins.str, 'RecurrenceInterval']]):
    ...
    def synchronization_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def synchronization_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "synchronization_time", value)

    @property
    @pulumi.getter(name="synchronizationMode")
    def synchronization_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'SynchronizationMode']]]:
        """
    ...
    def synchronization_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'SynchronizationMode']]]):
...
class ScheduledTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 recurrence_interval: Optional[pulumi.Input[Union[builtins.str, 'RecurrenceInterval']]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 share_subscription_name: Optional[pulumi.Input[builtins.str]] = None,
                 synchronization_mode: Optional[pulumi.Input[Union[builtins.str, 'SynchronizationMode']]] = None,
                 synchronization_time: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="recurrenceInterval")
    def recurrence_interval(self) -> pulumi.Output[builtins.str]:
        """
        Recurrence Interval
        """
        return pulumi.get(self, "recurrence_interval")
    ...
    @property
    @pulumi.getter(name="synchronizationMode")
    def synchronization_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Synchronization mode
        """
        return pulumi.get(self, "synchronization_mode")
    ...
    @property
    @pulumi.getter(name="synchronizationTime")
    def synchronization_time(self) -> pulumi.Output[builtins.str]:
        """
        Synchronization time
        """
        return pulumi.get(self, "synchronization_time")
    ...
    def trigger_status(self) -> pulumi.Output[builtins.str]:
        """
