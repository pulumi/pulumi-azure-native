...
class ScheduledTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare/v20210801:ScheduledTrigger"), pulumi.Alias(type_="azure-native_datashare_v20181101preview:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-native_datashare_v20191101:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-native_datashare_v20200901:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-native_datashare_v20201001preview:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-native_datashare_v20210801:datashare:ScheduledTrigger")])
