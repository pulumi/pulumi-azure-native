...
class SqlDWTableDataSetMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schema_name: Schema of the table. Default value is dbo.
    ...
    def data_warehouse_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def data_warehouse_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def sql_server_resource_id(self, value: pulumi.Input[_builtins.str]):
...
class SqlDWTableDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_set_mapping_name: Optional[pulumi.Input[_builtins.str]] = None,
                 data_warehouse_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dataWarehouseName")
    def data_warehouse_name(self) -> pulumi.Output[_builtins.str]:
        """
        DataWarehouse name of the source data set
        """
        return pulumi.get(self, "data_warehouse_name")
