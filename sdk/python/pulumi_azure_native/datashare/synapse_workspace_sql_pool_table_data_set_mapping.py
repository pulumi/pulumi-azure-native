...
class SynapseWorkspaceSqlPoolTableDataSetMappingArgs:
    def __init__(__self__, *,
                 ...
                 share_subscription_name: pulumi.Input[builtins.str],
                 synapse_workspace_sql_pool_table_resource_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] data_set_id: The id of the source data set.
        :param pulumi.Input[builtins.str] kind: Kind of data set mapping.
               Expected value is 'SynapseWorkspaceSqlPoolTable'.
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name.
        :param pulumi.Input[builtins.str] share_subscription_name: The name of the share subscription which will hold the data set sink.
        :param pulumi.Input[builtins.str] synapse_workspace_sql_pool_table_resource_id: Resource id of the Synapse Workspace SQL Pool Table
        :param pulumi.Input[builtins.str] data_set_mapping_name: The name of the data set mapping to be created.
        """
    ...
    def share_subscription_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def share_subscription_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "share_subscription_name", value)

    @property
    @pulumi.getter(name="synapseWorkspaceSqlPoolTableResourceId")
    def synapse_workspace_sql_pool_table_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def synapse_workspace_sql_pool_table_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "synapse_workspace_sql_pool_table_resource_id", value)

    @property
    @pulumi.getter(name="dataSetMappingName")
    def data_set_mapping_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_set_mapping_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_set_mapping_name", value)


@pulumi.type_token("azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping")
class SynapseWorkspaceSqlPoolTableDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 synapse_workspace_sql_pool_table_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SynapseWorkspaceSqlPoolTableDataSetMappingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        A Synapse Workspace Sql Pool Table data set mapping
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SynapseWorkspaceSqlPoolTableDataSetMappingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SynapseWorkspaceSqlPoolTableDataSetMappingArgs.__new__(SynapseWorkspaceSqlPoolTableDataSetMappingArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SynapseWorkspaceSqlPoolTableDataSetMapping':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return SynapseWorkspaceSqlPoolTableDataSetMapping(resource_name, opts=opts, __props__=__props__)
    ...
    def data_set_mapping_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="synapseWorkspaceSqlPoolTableResourceId")
    def synapse_workspace_sql_pool_table_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Resource id of the Synapse Workspace SQL Pool Table
        """
        return pulumi.get(self, "synapse_workspace_sql_pool_table_resource_id")
