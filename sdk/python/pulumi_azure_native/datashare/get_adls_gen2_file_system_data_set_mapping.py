...
class GetADLSGen2FileSystemDataSetMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_set_id=None, data_set_mapping_status=None, file_system=None, id=None, kind=None, name=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, system_data=None, type=None):
...
def get_adls_gen2_file_system_data_set_mapping(account_name: Optional[_builtins.str] = None,
...
def get_adls_gen2_file_system_data_set_mapping_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
                                                      ...
                                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetADLSGen2FileSystemDataSetMappingResult]:
    """
    Get a DataSetMapping in a shareSubscription
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getADLSGen2FileSystemDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileSystemDataSetMappingResult)
    return __ret__.apply(lambda __response__: GetADLSGen2FileSystemDataSetMappingResult(
