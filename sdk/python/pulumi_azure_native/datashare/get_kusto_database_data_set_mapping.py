...
def get_kusto_database_data_set_mapping(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare:getKustoDatabaseDataSetMapping', __args__, opts=opts, typ=GetKustoDatabaseDataSetMappingResult).value
...
def get_kusto_database_data_set_mapping_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare:getKustoDatabaseDataSetMapping', __args__, opts=opts, typ=GetKustoDatabaseDataSetMappingResult)
