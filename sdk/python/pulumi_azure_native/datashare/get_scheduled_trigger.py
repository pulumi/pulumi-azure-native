...
class GetScheduledTriggerResult:
    ...
    def synchronization_mode(self) -> Optional[builtins.str]:
        """
    ...
    def trigger_status(self) -> builtins.str:
        """
...
def get_scheduled_trigger(account_name: Optional[builtins.str] = None,
...
def get_scheduled_trigger_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
