...
warnings.warn("""azure-native:datashare/v20200901:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_adls_gen2_folder_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_folder_data_set is deprecated: azure-native:datashare/v20200901:ADLSGen2FolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FolderDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getADLSGen2FolderDataSet', __args__, opts=opts, typ=GetADLSGen2FolderDataSetResult).value
