...
class SynapseWorkspaceSqlPoolTableDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        synapse_workspace_sql_pool_table_data_set_mapping = azure_native.datashare.v20200901.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMapping",
