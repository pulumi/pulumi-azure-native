...
warnings.warn("""azure-native:datashare/v20200901:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class KustoClusterDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_subscription_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoClusterDataSetMapping is deprecated: azure-native:datashare/v20200901:KustoClusterDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSetMapping to guarantee forwards compatibility.""")
        ...
        super(KustoClusterDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:KustoClusterDataSetMapping',
            resource_name,
            __props__,
            opts)
