...
def get_scheduled_synchronization_setting(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_synchronization_setting is deprecated: azure-native:datashare/v20200901:ScheduledSynchronizationSetting is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ScheduledSynchronizationSetting to guarantee forwards compatibility.""")
    __args__ = dict()
