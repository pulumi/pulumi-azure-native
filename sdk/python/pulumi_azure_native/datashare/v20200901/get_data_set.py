...
def get_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_set is deprecated: Version 2020-09-01 will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getDataSet', __args__, opts=opts, typ=GetDataSetResult).value
