...
warnings.warn("""azure-native:datashare/v20200901:Invitation is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Invitation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_invitation(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_invitation is deprecated: azure-native:datashare/v20200901:Invitation is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Invitation to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getInvitation', __args__, opts=opts, typ=GetInvitationResult).value
