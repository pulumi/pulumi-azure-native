...
class KustoDatabaseDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kusto_database_data_set = azure_native.datashare.v20200901.KustoDatabaseDataSet("kustoDatabaseDataSet",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20200901:KustoDatabaseDataSet dataset1 /subscriptions/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/sourceAccount/shares/share1/dataSets/dataset1 
        ```
