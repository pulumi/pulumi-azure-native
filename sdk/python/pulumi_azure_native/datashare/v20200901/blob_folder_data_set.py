...
warnings.warn("""azure-native:datashare/v20200901:BlobFolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class BlobFolderDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlobFolderDataSetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobFolderDataSet is deprecated: azure-native:datashare/v20200901:BlobFolderDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobFolderDataSet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobFolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobFolderDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobFolderDataSet, __self__).__init__(
            'azure-native:datashare/v20200901:BlobFolderDataSet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BlobFolderDataSet':
        """
