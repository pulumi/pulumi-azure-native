...
warnings.warn("""azure-native:datashare/v20200901:BlobContainerDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_blob_container_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_blob_container_data_set_mapping is deprecated: azure-native:datashare/v20200901:BlobContainerDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:BlobContainerDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getBlobContainerDataSetMapping', __args__, opts=opts, typ=GetBlobContainerDataSetMappingResult).value
