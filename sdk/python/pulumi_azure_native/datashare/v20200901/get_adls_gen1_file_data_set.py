...
def get_adls_gen1_file_data_set_output(account_name: Optional[pulumi.Input[str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetADLSGen1FileDataSetResult]:
    """
    Get a DataSet in a share
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20200901:getADLSGen1FileDataSet', __args__, opts=opts, typ=GetADLSGen1FileDataSetResult)
