...
def list_share_synchronizations_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datashare/v20200901:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult)
