...
warnings.warn("""azure-native:datashare/v20200901:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlDWTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlDWTableDataSetMapping is deprecated: azure-native:datashare/v20200901:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:SqlDWTableDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDWTableDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:SqlDWTableDataSetMapping',
            resource_name,
            __props__,
            opts)
