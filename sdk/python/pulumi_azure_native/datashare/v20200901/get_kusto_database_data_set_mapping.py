...
warnings.warn("""azure-native:datashare/v20200901:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_kusto_database_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kusto_database_data_set_mapping is deprecated: azure-native:datashare/v20200901:KustoDatabaseDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:KustoDatabaseDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
