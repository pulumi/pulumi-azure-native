...
def get_sql_dw_table_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_dw_table_data_set is deprecated: azure-native:datashare/v20200901:SqlDWTableDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getSqlDWTableDataSet', __args__, opts=opts, typ=GetSqlDWTableDataSetResult).value
