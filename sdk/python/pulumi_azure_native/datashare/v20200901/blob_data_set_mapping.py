...
class BlobDataSetMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_data_set_mapping = azure_native.datashare.v20200901.BlobDataSetMapping("blobDataSetMapping",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20200901:BlobDataSetMapping datasetMappingName /subscriptions/4e745bb7-c420-479b-b0d6-a0f92d48a227/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/consumerAccount/shareSubscriptions/ShareSubscription1/dataSetMappings/datasetMappingName1 
        ```
