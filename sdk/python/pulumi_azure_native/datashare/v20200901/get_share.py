...
def get_share(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share is deprecated: azure-native:datashare/v20200901:Share is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:Share to guarantee forwards compatibility.""")
    __args__ = dict()
