...
warnings.warn("""azure-native:datashare/v20200901:SqlDBTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_db_table_data_set(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_db_table_data_set is deprecated: azure-native:datashare/v20200901:SqlDBTableDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:SqlDBTableDataSet to guarantee forwards compatibility.""")
    __args__ = dict()
