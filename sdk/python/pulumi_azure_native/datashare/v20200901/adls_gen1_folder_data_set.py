...
class ADLSGen1FolderDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen1FolderDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20210801:ADLSGen1FolderDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ADLSGen1FolderDataSet, __self__).__init__(
            'azure-native:datashare/v20200901:ADLSGen1FolderDataSet',
            resource_name,
            __props__,
            opts)
