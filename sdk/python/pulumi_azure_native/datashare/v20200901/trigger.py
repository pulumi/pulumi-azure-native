...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20210801:Trigger")])
