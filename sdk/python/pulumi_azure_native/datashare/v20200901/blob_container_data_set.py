...
class BlobContainerDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BlobContainerDataSet is deprecated: azure-native:datashare/v20200901:BlobContainerDataSet is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:BlobContainerDataSet to guarantee forwards compatibility.""")
