...
class BlobContainerDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        blob_container_data_set = azure_native.datashare.v20200901.BlobContainerDataSet("blobContainerDataSet",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20200901:BlobContainerDataSet dataset1 /subscriptions/0f3dcfc3-18f8-4099-b381-8353e19d43a7/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/sourceAccount/shares/share1/dataSets/dataset1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:BlobContainerDataSet")])
