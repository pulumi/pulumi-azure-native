...
def get_sql_dw_table_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_dw_table_data_set_mapping is deprecated: azure-native:datashare/v20200901:SqlDWTableDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:SqlDWTableDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getSqlDWTableDataSetMapping', __args__, opts=opts, typ=GetSqlDWTableDataSetMappingResult).value
