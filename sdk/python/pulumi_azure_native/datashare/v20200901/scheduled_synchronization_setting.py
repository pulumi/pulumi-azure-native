...
class ScheduledSynchronizationSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        scheduled_synchronization_setting = azure_native.datashare.v20200901.ScheduledSynchronizationSetting("scheduledSynchronizationSetting",
        ...
        ```sh
        $ pulumi import azure-native:datashare/v20200901:ScheduledSynchronizationSetting SynchronizationSetting1 /subscriptions/433a8dfd-e5d5-4e77-ad86-90acdc75eb1a/resourceGroups/SampleResourceGroup/providers/Microsoft.DataShare/accounts/Account1/shares/Share1/synchronizationSettings/SynchronizationSetting1 
        ```
