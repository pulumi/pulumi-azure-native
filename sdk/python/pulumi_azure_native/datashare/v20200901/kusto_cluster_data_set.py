...
warnings.warn("""azure-native:datashare/v20200901:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""", DeprecationWarning)
...
class KustoClusterDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""KustoClusterDataSet is deprecated: azure-native:datashare/v20200901:KustoClusterDataSet is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:KustoClusterDataSet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoClusterDataSet"), pulumi.Alias(type_="azure-native:datashare/v20210801:KustoClusterDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KustoClusterDataSet, __self__).__init__(
            'azure-native:datashare/v20200901:KustoClusterDataSet',
            resource_name,
            __props__,
            opts)
