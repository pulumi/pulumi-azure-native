...
warnings.warn("""azure-native:datashare/v20200901:ADLSGen2FolderDataSetMapping is being removed in the next major version of this provider. Upgrade to at least azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class ADLSGen2FolderDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datashare:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping")])
