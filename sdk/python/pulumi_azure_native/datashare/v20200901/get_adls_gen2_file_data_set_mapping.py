...
warnings.warn("""azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetADLSGen2FileDataSetMappingResult:
    ...
    """
    def __init__(__self__, data_set_id=None, data_set_mapping_status=None, file_path=None, file_system=None, id=None, kind=None, name=None, output_type=None, provisioning_state=None, resource_group=None, storage_account_name=None, subscription_id=None, system_data=None, type=None):
...
def get_adls_gen2_file_data_set_mapping(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_adls_gen2_file_data_set_mapping is deprecated: azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping is being removed in the next major version of this provider. Please upgrade to azure-native:datashare/v20210801:ADLSGen2FileDataSetMapping to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20200901:getADLSGen2FileDataSetMapping', __args__, opts=opts, typ=GetADLSGen2FileDataSetMappingResult).value
