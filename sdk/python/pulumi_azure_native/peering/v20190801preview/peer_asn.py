...
class PeerAsnArgs:
    def __init__(__self__, *,
                 ...
                 peer_contact_info: Optional[pulumi.Input['ContactInfoArgs']] = None,
        ...
        :param pulumi.Input['ContactInfoArgs'] peer_contact_info: The contact information of the peer.
        ...
        if peer_contact_info is not None:
    ...
    def peer_contact_info(self) -> Optional[pulumi.Input['ContactInfoArgs']]:
        """
    ...
    def peer_contact_info(self, value: Optional[pulumi.Input['ContactInfoArgs']]):
        pulumi.set(self, "peer_contact_info", value)
...
azure-native:peering/v20190801preview:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20190901preview:PeerAsn to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:peering/v20190801preview:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20190901preview:PeerAsn to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 validation_state: Optional[pulumi.Input[Union[str, 'ValidationState']]] = None,
                 __props__=None):
        pulumi.log.warn("""PeerAsn is deprecated: Version 2019-08-01-preview will be removed in v2 of the provider.
azure-native:peering/v20190801preview:PeerAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20190901preview:PeerAsn to guarantee forwards compatibility.""")
        ...
        if opts.id is None:
            ...
            __props__.__dict__["peer_contact_info"] = peer_contact_info
            __props__.__dict__["peer_name"] = peer_name
            __props__.__dict__["validation_state"] = validation_state
            __props__.__dict__["name"] = None
            __props__.__dict__["type"] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:peering:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20190901preview:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20200101preview:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20200401:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20201001:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20210101:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20210601:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20220101:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20220601:PeerAsn"), pulumi.Alias(type_="azure-native:peering/v20221001:PeerAsn")])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["peer_contact_info"] = None
