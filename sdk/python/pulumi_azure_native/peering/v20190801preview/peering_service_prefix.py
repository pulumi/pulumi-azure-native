...
class PeeringServicePrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:peering/v20190801preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20190901preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20190901preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20200101preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20200101preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20200401:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20200401:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20201001:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20201001:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20210101:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20210101:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20210601:PeeringServicePrefix"), pulumi.Alias(type_="azure-nextgen:peering/v20210601:PeeringServicePrefix")])
