...
class PeeringServicePrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        peering_service_prefix = azure_native.peering.v20190801preview.PeeringServicePrefix("peeringServicePrefix",
        ...
        ```sh
        $ pulumi import azure-native:peering/v20190801preview:PeeringServicePrefix MyPeeringServicePrefix /subscriptions/subId/resourceGroups/MyResourceGroup/providers/Microsoft.Peering/peeringServices/MyPeeringService/prefixes/MyPeeringServicePrefix 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:peering:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20190901preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20200101preview:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20200401:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20201001:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20210101:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20210601:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20220101:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20220601:PeeringServicePrefix"), pulumi.Alias(type_="azure-native:peering/v20221001:PeeringServicePrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PeeringServicePrefix, __self__).__init__(
            'azure-native:peering/v20190801preview:PeeringServicePrefix',
            resource_name,
            __props__,
            opts)
