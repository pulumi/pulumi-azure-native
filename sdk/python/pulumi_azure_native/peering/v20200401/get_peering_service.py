...
def get_peering_service(peering_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peering_service is deprecated: Version 2020-04-01 will be removed in v2 of the provider.
azure-native:peering/v20200401:PeeringService is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeeringService to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20200401:getPeeringService', __args__, opts=opts, typ=GetPeeringServiceResult).value
