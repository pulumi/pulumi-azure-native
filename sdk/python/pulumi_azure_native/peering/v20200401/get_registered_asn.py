...
azure-native:peering/v20200401:RegisteredAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registered_asn(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_asn is deprecated: Version 2020-04-01 will be removed in v2 of the provider.
