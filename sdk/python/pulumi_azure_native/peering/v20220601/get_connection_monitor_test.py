...
warnings.warn("""azure-native:peering/v20220601:ConnectionMonitorTest is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_connection_monitor_test(connection_monitor_test_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection_monitor_test is deprecated: azure-native:peering/v20220601:ConnectionMonitorTest is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.""")
    __args__ = dict()
