...
class RegisteredPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RegisteredPrefix is deprecated: azure-native:peering/v20220601:RegisteredPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""")
