...
warnings.warn("""azure-native:peering/v20220601:Peering is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:Peering to guarantee forwards compatibility.""", DeprecationWarning)
...
class Peering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Peering is deprecated: azure-native:peering/v20220601:Peering is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:Peering to guarantee forwards compatibility.""")
