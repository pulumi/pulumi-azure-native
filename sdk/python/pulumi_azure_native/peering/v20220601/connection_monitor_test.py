...
class ConnectionMonitorTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:peering:ConnectionMonitorTest"), pulumi.Alias(type_="azure-native:peering/v20210601:ConnectionMonitorTest"), pulumi.Alias(type_="azure-native:peering/v20220101:ConnectionMonitorTest"), pulumi.Alias(type_="azure-native:peering/v20221001:ConnectionMonitorTest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectionMonitorTest, __self__).__init__(
            'azure-native:peering/v20220601:ConnectionMonitorTest',
            resource_name,
            __props__,
            opts)
