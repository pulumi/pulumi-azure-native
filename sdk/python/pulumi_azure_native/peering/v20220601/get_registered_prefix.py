...
warnings.warn("""azure-native:peering/v20220601:RegisteredPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registered_prefix(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_prefix is deprecated: azure-native:peering/v20220601:RegisteredPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
