...
class RegisteredAsn(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:peering/v20210101:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20210601:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20221001:RegisteredAsn")])
