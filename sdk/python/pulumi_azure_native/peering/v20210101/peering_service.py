...
class PeeringService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        peering_service = azure_native.peering.v20210101.PeeringService("peeringService",
            location="eastus",
