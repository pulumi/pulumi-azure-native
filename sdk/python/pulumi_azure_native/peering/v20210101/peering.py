...
class Peering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        peering = azure_native.peering.v20210101.Peering("peering",
            direct=azure_native.peering.v20210101.PeeringPropertiesDirectResponseArgs(
                connections=[
                    {
                        "bandwidthInMbps": 10000,
                        "bgpSession": azure_native.peering.v20210101.BgpSessionArgs(
                    ...
                    azure_native.peering.v20210101.DirectConnectionArgs(
                ...
                peer_asn=azure_native.peering.v20210101.SubResourceArgs(
            ...
            sku=azure_native.peering.v20210101.PeeringSkuArgs(
        ...
        peering = azure_native.peering.v20210101.Peering("peering",
            exchange=azure_native.peering.v20210101.PeeringPropertiesExchangeResponseArgs(
                connections=[
                    {
                        "bgpSession": azure_native.peering.v20210101.BgpSessionArgs(
                            max_prefixes_advertised_v4=1000,
