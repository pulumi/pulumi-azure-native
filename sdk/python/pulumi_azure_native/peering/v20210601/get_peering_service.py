...
def get_peering_service(peering_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peering_service is deprecated: azure-native:peering/v20210601:PeeringService is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:PeeringService to guarantee forwards compatibility.""")
    __args__ = dict()
