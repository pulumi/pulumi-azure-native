...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20210601:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
...
def get_peer_asn_output(peer_asn_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:peering/v20210601:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult)
