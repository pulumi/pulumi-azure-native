...
warnings.warn("""azure-native:peering/v20210601:ConnectionMonitorTest is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConnectionMonitorTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_frequency_in_sec: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectionMonitorTest is deprecated: azure-native:peering/v20210601:ConnectionMonitorTest is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:ConnectionMonitorTest to guarantee forwards compatibility.""")
