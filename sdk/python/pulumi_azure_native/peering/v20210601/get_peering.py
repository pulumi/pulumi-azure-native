...
def get_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peering is deprecated: azure-native:peering/v20210601:Peering is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:Peering to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['peeringName'] = peering_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20210601:getPeering', __args__, opts=opts, typ=GetPeeringResult).value
