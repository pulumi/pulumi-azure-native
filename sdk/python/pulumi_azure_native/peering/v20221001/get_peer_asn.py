...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20221001:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
...
def get_peer_asn_output(peer_asn_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['peerAsnName'] = peer_asn_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:peering/v20221001:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult)
