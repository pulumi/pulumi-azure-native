...
class ConnectionMonitorTestArgs:
    ...
    def _configure(
        ...
        if connection_monitor_test_name is None and 'connectionMonitorTestName' in kwargs:
            connection_monitor_test_name = kwargs['connectionMonitorTestName']
        if destination_port is None and 'destinationPort' in kwargs:
            destination_port = kwargs['destinationPort']
        if source_agent is None and 'sourceAgent' in kwargs:
            source_agent = kwargs['sourceAgent']
        if test_frequency_in_sec is None and 'testFrequencyInSec' in kwargs:
            test_frequency_in_sec = kwargs['testFrequencyInSec']
