...
def get_registered_prefix(peering_name: Optional[_builtins.str] = None,
                          registered_prefix_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str registered_prefix_name: The name of the registered prefix.
