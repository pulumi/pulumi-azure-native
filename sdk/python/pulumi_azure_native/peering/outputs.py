...
class BgpSessionResponse(dict):
    ...
    def __init__(__self__, *,
                 session_state_v4: builtins.str,
                 session_state_v6: builtins.str,
                 max_prefixes_advertised_v4: Optional[builtins.int] = None,
                 max_prefixes_advertised_v6: Optional[builtins.int] = None,
                 md5_authentication_key: Optional[builtins.str] = None,
                 microsoft_session_i_pv4_address: Optional[builtins.str] = None,
                 microsoft_session_i_pv6_address: Optional[builtins.str] = None,
                 peer_session_i_pv4_address: Optional[builtins.str] = None,
                 peer_session_i_pv6_address: Optional[builtins.str] = None,
                 session_prefix_v4: Optional[builtins.str] = None,
                 session_prefix_v6: Optional[builtins.str] = None):
        """
        The properties that define a BGP session.
        :param builtins.str session_state_v4: The state of the IPv4 session.
        :param builtins.str session_state_v6: The state of the IPv6 session.
        :param builtins.int max_prefixes_advertised_v4: The maximum number of prefixes advertised over the IPv4 session.
        :param builtins.int max_prefixes_advertised_v6: The maximum number of prefixes advertised over the IPv6 session.
        :param builtins.str md5_authentication_key: The MD5 authentication key of the session.
        :param builtins.str microsoft_session_i_pv4_address: The IPv4 session address on Microsoft's end.
        :param builtins.str microsoft_session_i_pv6_address: The IPv6 session address on Microsoft's end.
        :param builtins.str peer_session_i_pv4_address: The IPv4 session address on peer's end.
        :param builtins.str peer_session_i_pv6_address: The IPv6 session address on peer's end.
        :param builtins.str session_prefix_v4: The IPv4 prefix that contains both ends' IPv4 addresses.
        :param builtins.str session_prefix_v6: The IPv6 prefix that contains both ends' IPv6 addresses.
        """
    ...
    def session_state_v4(self) -> builtins.str:
        """
    ...
    def session_state_v6(self) -> builtins.str:
        """
    ...
    def max_prefixes_advertised_v4(self) -> Optional[builtins.int]:
        """
    ...
    def max_prefixes_advertised_v6(self) -> Optional[builtins.int]:
        """
    ...
    def md5_authentication_key(self) -> Optional[builtins.str]:
        """
    ...
    def microsoft_session_i_pv4_address(self) -> Optional[builtins.str]:
        """
    ...
    def microsoft_session_i_pv6_address(self) -> Optional[builtins.str]:
        """
    ...
    def peer_session_i_pv4_address(self) -> Optional[builtins.str]:
        """
    ...
    def peer_session_i_pv6_address(self) -> Optional[builtins.str]:
        """
    ...
    def session_prefix_v4(self) -> Optional[builtins.str]:
        """
    ...
    def session_prefix_v6(self) -> Optional[builtins.str]:
        """
...
class ContactDetailResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The contact detail class.
        :param builtins.str email: The e-mail address of the contact.
        :param builtins.str phone: The phone number of the contact.
        :param builtins.str role: The role of the contact.
        """
...
class DirectConnectionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 microsoft_tracking_id: builtins.str,
                 provisioned_bandwidth_in_mbps: builtins.int,
                 bandwidth_in_mbps: Optional[builtins.int] = None,
                 bgp_session: Optional['outputs.BgpSessionResponse'] = None,
                 connection_identifier: Optional[builtins.str] = None,
                 peering_db_facility_id: Optional[builtins.int] = None,
                 session_address_provider: Optional[builtins.str] = None,
                 use_for_peering_service: Optional[builtins.bool] = None):
        """
        The properties that define a direct connection.
        :param builtins.str connection_state: The state of the connection.
        :param builtins.str error_message: The error message related to the connection state, if any.
        :param builtins.str microsoft_tracking_id: The ID used within Microsoft's peering provisioning system to track the connection
        :param builtins.int provisioned_bandwidth_in_mbps: The bandwidth that is actually provisioned.
        :param builtins.int bandwidth_in_mbps: The bandwidth of the connection.
        :param 'BgpSessionResponse' bgp_session: The BGP session associated with the connection.
        :param builtins.str connection_identifier: The unique identifier (GUID) for the connection.
        :param builtins.int peering_db_facility_id: The PeeringDB.com ID of the facility at which the connection has to be set up.
        :param builtins.str session_address_provider: The field indicating if Microsoft provides session ip addresses.
        :param builtins.bool use_for_peering_service: The flag that indicates whether or not the connection is used for peering service.
        """
    ...
    def microsoft_tracking_id(self) -> builtins.str:
        """
    ...
    def provisioned_bandwidth_in_mbps(self) -> builtins.int:
        """
    ...
    def bandwidth_in_mbps(self) -> Optional[builtins.int]:
        """
    ...
    def connection_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def peering_db_facility_id(self) -> Optional[builtins.int]:
        """
    ...
    def session_address_provider(self) -> Optional[builtins.str]:
        """
    ...
    def use_for_peering_service(self) -> Optional[builtins.bool]:
        """
...
class LogAnalyticsWorkspacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 connected_agents: Sequence[builtins.str],
                 key: builtins.str,
                 workspace_id: builtins.str):
        """
        The properties that define a Log Analytics Workspace.
        :param Sequence[builtins.str] connected_agents: The list of connected agents.
        :param builtins.str key: The Workspace Key.
    ...
    def connected_agents(self) -> Sequence[builtins.str]:
        """
...
class PeeringPropertiesDirectResponse(dict):
    ...
    def __init__(__self__, *,
                 use_for_peering_service: builtins.bool,
                 connections: Optional[Sequence['outputs.DirectConnectionResponse']] = None,
                 direct_peering_type: Optional[builtins.str] = None,
                 peer_asn: Optional['outputs.SubResourceResponse'] = None):
        """
        The properties that define a direct peering.
        :param builtins.bool use_for_peering_service: The flag that indicates whether or not the peering is used for peering service.
        :param Sequence['DirectConnectionResponse'] connections: The set of connections that constitute a direct peering.
        :param builtins.str direct_peering_type: The type of direct peering.
    ...
    @property
    @pulumi.getter(name="useForPeeringService")
    def use_for_peering_service(self) -> builtins.bool:
        """
    ...
    def direct_peering_type(self) -> Optional[builtins.str]:
        """
...
class PeeringServicePrefixEventResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 event_level: builtins.str,
                 event_summary: builtins.str,
                 event_timestamp: builtins.str,
                 event_type: builtins.str):
        """
        The details of the event associated with a prefix.
        :param builtins.str event_description: The description of the event associated with a prefix.
        :param builtins.str event_level: The level of the event associated with a prefix.
        :param builtins.str event_summary: The summary of the event associated with a prefix.
        :param builtins.str event_timestamp: The timestamp of the event associated with a prefix.
        :param builtins.str event_type: The type of the event associated with a prefix.
        """
    ...
    def event_description(self) -> builtins.str:
        """
    ...
    def event_timestamp(self) -> builtins.str:
        """
...
class PeeringServiceSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The SKU that defines the type of the peering service.
        :param builtins.str name: The name of the peering service SKU.
        """
        if name is not None:
...
class PeeringSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The SKU that defines the tier and kind of the peering.
        :param builtins.str family: The family of the peering SKU.
        :param builtins.str size: The size of the peering SKU.
        :param builtins.str tier: The tier of the peering SKU.
        :param builtins.str name: The name of the peering SKU.
        """
...
class SubResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The sub resource.
        :param builtins.str id: The identifier of the referenced resource.
        """
        if id is not None:
