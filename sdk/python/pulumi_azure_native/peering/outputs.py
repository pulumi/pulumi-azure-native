...
class BgpSessionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_prefixes_advertised_v4: Optional[_builtins.int] = None,
                 max_prefixes_advertised_v6: Optional[_builtins.int] = None,
                 md5_authentication_key: Optional[_builtins.str] = None,
                 microsoft_session_i_pv4_address: Optional[_builtins.str] = None,
                 microsoft_session_i_pv6_address: Optional[_builtins.str] = None,
                 peer_session_i_pv4_address: Optional[_builtins.str] = None,
                 peer_session_i_pv6_address: Optional[_builtins.str] = None,
                 session_prefix_v4: Optional[_builtins.str] = None,
        ...
        :param _builtins.int max_prefixes_advertised_v6: The maximum number of prefixes advertised over the IPv6 session.
        :param _builtins.str md5_authentication_key: The MD5 authentication key of the session.
        :param _builtins.str microsoft_session_i_pv4_address: The IPv4 session address on Microsoft's end.
        :param _builtins.str microsoft_session_i_pv6_address: The IPv6 session address on Microsoft's end.
        :param _builtins.str peer_session_i_pv4_address: The IPv4 session address on peer's end.
        :param _builtins.str peer_session_i_pv6_address: The IPv6 session address on peer's end.
        :param _builtins.str session_prefix_v4: The IPv4 prefix that contains both ends' IPv4 addresses.
        :param _builtins.str session_prefix_v6: The IPv6 prefix that contains both ends' IPv6 addresses.
        """
...
class DirectConnectionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bandwidth_in_mbps: Optional[_builtins.int] = None,
                 ...
                 session_address_provider: Optional[_builtins.str] = None,
        ...
        :param _builtins.int provisioned_bandwidth_in_mbps: The bandwidth that is actually provisioned.
        :param _builtins.int bandwidth_in_mbps: The bandwidth of the connection.
        :param 'BgpSessionResponse' bgp_session: The BGP session associated with the connection.
        :param _builtins.str connection_identifier: The unique identifier (GUID) for the connection.
        :param _builtins.int peering_db_facility_id: The PeeringDB.com ID of the facility at which the connection has to be set up.
        :param _builtins.str session_address_provider: The field indicating if Microsoft provides session ip addresses.
        :param _builtins.bool use_for_peering_service: The flag that indicates whether or not the connection is used for peering service.
        """
...
class PeeringPropertiesDirectResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 direct_peering_type: Optional[_builtins.str] = None,
...
class PeeringServicePrefixEventResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str event_timestamp: The timestamp of the event associated with a prefix.
        :param _builtins.str event_type: The type of the event associated with a prefix.
        """
...
class PeeringSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the peering SKU.
        """
