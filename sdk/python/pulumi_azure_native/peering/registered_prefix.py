...
class RegisteredPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:peering/v20210101:RegisteredPrefix"), pulumi.Alias(type_="azure-native:peering/v20210601:RegisteredPrefix"), pulumi.Alias(type_="azure-native:peering/v20220101:RegisteredPrefix")])
