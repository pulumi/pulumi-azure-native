...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peer_asn is deprecated: Version v20190901preview will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20190901preview:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
