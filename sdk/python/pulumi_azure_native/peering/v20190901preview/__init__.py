...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:peering/v20190901preview:PeerAsn":
                return PeerAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20190901preview:Peering":
                return Peering(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20190901preview:PeeringService":
                return PeeringService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20190901preview:Prefix":
    ...
    pulumi.runtime.register_resource_module("azure-native", "peering/v20190901preview", _module_instance)
