...
warnings.warn("""azure-native:peering/v20220101:RegisteredPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
class RegisteredPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RegisteredPrefix is deprecated: azure-native:peering/v20220101:RegisteredPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""")
        ...
        super(RegisteredPrefix, __self__).__init__(
            'azure-native:peering/v20220101:RegisteredPrefix',
            resource_name,
            __props__,
            opts)
