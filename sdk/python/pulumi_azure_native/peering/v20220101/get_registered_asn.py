...
warnings.warn("""azure-native:peering/v20220101:RegisteredAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registered_asn(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_asn is deprecated: azure-native:peering/v20220101:RegisteredAsn is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:RegisteredAsn to guarantee forwards compatibility.""")
    __args__ = dict()
