...
warnings.warn("""azure-native:peering/v20220101:Prefix is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:Prefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_prefix(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_prefix is deprecated: azure-native:peering/v20220101:Prefix is being removed in the next major version of this provider. Please upgrade to azure-native:peering/v20221001:Prefix to guarantee forwards compatibility.""")
    __args__ = dict()
