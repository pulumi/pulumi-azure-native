...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peer_asn is deprecated: azure-native:peering/v20220101:PeerAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:PeerAsn to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['peerAsnName'] = peer_asn_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20220101:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
