...
def get_registered_asn(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_asn is deprecated: Version v20201001 will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20201001:getRegisteredAsn', __args__, opts=opts, typ=GetRegisteredAsnResult).value
