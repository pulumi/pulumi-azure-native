...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getPrefix'.""", DeprecationWarning)
...
def get_prefix(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/latest:getPrefix', __args__, opts=opts, typ=GetPrefixResult).value
