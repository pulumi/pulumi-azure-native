...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getPeerAsn'.""", DeprecationWarning)
...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/latest:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
