...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getRegisteredAsn'.""", DeprecationWarning)
...
def get_registered_asn(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/latest:getRegisteredAsn', __args__, opts=opts, typ=GetRegisteredAsnResult).value
