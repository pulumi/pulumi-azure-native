...
class PeeringServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] peering_service_location: The location (state/province) of the customer.
        :param pulumi.Input[_builtins.str] peering_service_name: The name of the peering service.
        :param pulumi.Input[_builtins.str] peering_service_provider: The name of the service provider.
        :param pulumi.Input[_builtins.str] provider_backup_peering_location: The backup peering (Microsoft/service provider) location to be used for customer traffic.
        :param pulumi.Input[_builtins.str] provider_primary_peering_location: The primary peering (Microsoft/service provider) location to be used for customer traffic.
...
class PeeringService(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="peeringServiceLocation")
    def peering_service_location(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The location (state/province) of the customer.
        """
        return pulumi.get(self, "peering_service_location")
    ...
    @_builtins.property
    @pulumi.getter(name="peeringServiceProvider")
    def peering_service_provider(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the service provider.
        """
        return pulumi.get(self, "peering_service_provider")
    ...
    @_builtins.property
    @pulumi.getter(name="providerBackupPeeringLocation")
    def provider_backup_peering_location(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The backup peering (Microsoft/service provider) location to be used for customer traffic.
        """
        return pulumi.get(self, "provider_backup_peering_location")
    ...
    @_builtins.property
    @pulumi.getter(name="providerPrimaryPeeringLocation")
    def provider_primary_peering_location(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The primary peering (Microsoft/service provider) location to be used for customer traffic.
        """
        return pulumi.get(self, "provider_primary_peering_location")
