...
class PeeringServiceArgs:
    def __init__(__self__, *,
                 ...
                 peering_service_location: Optional[pulumi.Input[builtins.str]] = None,
                 peering_service_name: Optional[pulumi.Input[builtins.str]] = None,
                 peering_service_provider: Optional[pulumi.Input[builtins.str]] = None,
                 provider_backup_peering_location: Optional[pulumi.Input[builtins.str]] = None,
                 provider_primary_peering_location: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] peering_service_location: The location (state/province) of the customer.
        :param pulumi.Input[builtins.str] peering_service_name: The name of the peering service.
        :param pulumi.Input[builtins.str] peering_service_provider: The name of the service provider.
        :param pulumi.Input[builtins.str] provider_backup_peering_location: The backup peering (Microsoft/service provider) location to be used for customer traffic.
        :param pulumi.Input[builtins.str] provider_primary_peering_location: The primary peering (Microsoft/service provider) location to be used for customer traffic.
    ...
    def peering_service_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peering_service_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peering_service_location", value)

    @property
    @pulumi.getter(name="peeringServiceName")
    def peering_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peering_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peering_service_name", value)

    @property
    @pulumi.getter(name="peeringServiceProvider")
    def peering_service_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peering_service_provider(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peering_service_provider", value)

    @property
    @pulumi.getter(name="providerBackupPeeringLocation")
    def provider_backup_peering_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_backup_peering_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_backup_peering_location", value)

    @property
    @pulumi.getter(name="providerPrimaryPeeringLocation")
    def provider_primary_peering_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_primary_peering_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PeeringService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="peeringServiceLocation")
    def peering_service_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The location (state/province) of the customer.
        """
        return pulumi.get(self, "peering_service_location")
    ...
    @property
    @pulumi.getter(name="peeringServiceProvider")
    def peering_service_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the service provider.
        """
        return pulumi.get(self, "peering_service_provider")
    ...
    @property
    @pulumi.getter(name="providerBackupPeeringLocation")
    def provider_backup_peering_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backup peering (Microsoft/service provider) location to be used for customer traffic.
        """
        return pulumi.get(self, "provider_backup_peering_location")
    ...
    @property
    @pulumi.getter(name="providerPrimaryPeeringLocation")
    def provider_primary_peering_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The primary peering (Microsoft/service provider) location to be used for customer traffic.
        """
        return pulumi.get(self, "provider_primary_peering_location")
