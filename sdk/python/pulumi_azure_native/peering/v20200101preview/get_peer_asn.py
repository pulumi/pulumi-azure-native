...
azure-native:peering/v20200101preview:PeerAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20210101:PeerAsn to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_peer_asn(peer_asn_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peer_asn is deprecated: Version 2020-01-01-preview will be removed in v2 of the provider.
azure-native:peering/v20200101preview:PeerAsn is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20210101:PeerAsn to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20200101preview:getPeerAsn', __args__, opts=opts, typ=GetPeerAsnResult).value
