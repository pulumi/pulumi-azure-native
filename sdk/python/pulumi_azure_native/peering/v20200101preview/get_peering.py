...
def get_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_peering is deprecated: Version v20200101preview will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20200101preview:getPeering', __args__, opts=opts, typ=GetPeeringResult).value
