...
azure-native:peering/v20200101preview:RegisteredPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:peering/v20200101preview:RegisteredPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RegisteredPrefix is deprecated: Version 2020-01-01-preview will be removed in v2 of the provider.
azure-native:peering/v20200101preview:RegisteredPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:peering/v20221001:RegisteredPrefix to guarantee forwards compatibility.""")
        ...
        super(RegisteredPrefix, __self__).__init__(
            'azure-native:peering/v20200101preview:RegisteredPrefix',
            resource_name,
            __props__,
            opts)
