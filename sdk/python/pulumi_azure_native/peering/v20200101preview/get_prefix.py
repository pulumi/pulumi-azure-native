...
def get_prefix(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_prefix is deprecated: Version v20200101preview will be removed in the next major version of the provider. Upgrade to version v20210101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/v20200101preview:getPrefix', __args__, opts=opts, typ=GetPrefixResult).value
