...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20180801:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native:network:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20151101:Endpoint"), pulumi.Alias(type_="azure-native:network/v20151101:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20170301:Endpoint"), pulumi.Alias(type_="azure-native:network/v20170301:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20170501:Endpoint"), pulumi.Alias(type_="azure-native:network/v20170501:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20180201:Endpoint"), pulumi.Alias(type_="azure-native:network/v20180201:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20180301:Endpoint"), pulumi.Alias(type_="azure-native:network/v20180301:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20180401:Endpoint"), pulumi.Alias(type_="azure-native:network/v20180401:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20220401:Endpoint"), pulumi.Alias(type_="azure-native:network/v20220401:Endpoint"), pulumi.Alias(type_="azure-native:trafficmanager/v20220401preview:Endpoint"), pulumi.Alias(type_="azure-native:network/v20220401preview:Endpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Endpoint, __self__).__init__(
            'azure-native:trafficmanager/v20180801:Endpoint',
            resource_name,
            __props__,
            opts)
