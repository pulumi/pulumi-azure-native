...
class EndpointArgsDict(TypedDict):
    ...
    """
    custom_headers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPropertiesCustomHeadersItemArgs']]]]]
    """
    ...
    """
    subnets: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EndpointPropertiesSubnetsItemArgs']]]]]
    """
...
class MonitorConfigArgsDict(TypedDict):
    ...
    """
    custom_headers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MonitorConfigCustomHeadersItemArgs']]]]]
    """
    List of custom headers.
    """
    expected_status_code_ranges: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MonitorConfigExpectedStatusCodeRangesItemArgs']]]]]
    """
