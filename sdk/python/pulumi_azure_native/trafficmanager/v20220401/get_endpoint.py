...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:trafficmanager/v20220401:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
...
def get_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:trafficmanager/v20220401:getEndpoint', __args__, opts=opts, typ=GetEndpointResult)
