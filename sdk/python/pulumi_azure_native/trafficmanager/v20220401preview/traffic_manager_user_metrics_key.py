...
class TrafficManagerUserMetricsKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220401preview:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:trafficmanager:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:network:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:trafficmanager/v20180401:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:network/v20180401:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:trafficmanager/v20180801:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:network/v20180801:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:trafficmanager/v20220401:TrafficManagerUserMetricsKey"), pulumi.Alias(type_="azure-native:network/v20220401:TrafficManagerUserMetricsKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TrafficManagerUserMetricsKey, __self__).__init__(
            'azure-native:trafficmanager/v20220401preview:TrafficManagerUserMetricsKey',
            resource_name,
            __props__,
            opts)
