...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220401:Endpoint"), pulumi.Alias(type_="azure-native:network/v20220401preview:Endpoint"), pulumi.Alias(type_="azure-native:network:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20151101:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20170301:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20170501:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20180201:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20180301:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20180401:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20180801:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20220401:trafficmanager:Endpoint"), pulumi.Alias(type_="azure-native_trafficmanager_v20220401preview:trafficmanager:Endpoint")])
