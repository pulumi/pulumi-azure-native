...
def get_profile(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:trafficmanager/v20180301:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:trafficmanager/v20180301:getProfile', __args__, opts=opts, typ=GetProfileResult)
