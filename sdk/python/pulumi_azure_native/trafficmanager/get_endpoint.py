...
def get_endpoint(endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_name: The name of the Traffic Manager endpoint.
    :param builtins.str endpoint_type: The type of the Traffic Manager endpoint.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:trafficmanager:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
...
def get_endpoint_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:trafficmanager:getEndpoint', __args__, opts=opts, typ=GetEndpointResult)
