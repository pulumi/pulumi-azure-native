...
class GetProfileResult:
    ...
    """
    def __init__(__self__, allowed_endpoint_record_types=None, azure_api_version=None, dns_config=None, endpoints=None, id=None, location=None, max_return=None, monitor_config=None, name=None, profile_status=None, tags=None, traffic_routing_method=None, traffic_view_enrollment_status=None, type=None):
    ...
    def allowed_endpoint_record_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def max_return(self) -> Optional[builtins.float]:
        """
    ...
    def profile_status(self) -> Optional[builtins.str]:
        """
    ...
    def traffic_routing_method(self) -> Optional[builtins.str]:
        """
    ...
    def traffic_view_enrollment_status(self) -> Optional[builtins.str]:
        """
...
def get_profile(profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str profile_name: The name of the Traffic Manager profile.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:trafficmanager:getProfile', __args__, opts=opts, typ=GetProfileResult).value
...
def get_profile_output(profile_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:trafficmanager:getProfile', __args__, opts=opts, typ=GetProfileResult)
