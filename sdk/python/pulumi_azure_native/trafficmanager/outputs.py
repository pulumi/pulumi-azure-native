...
class DnsConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 fqdn: _builtins.str,
                 relative_name: Optional[_builtins.str] = None,
...
class EndpointResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 geo_mapping: Optional[Sequence[_builtins.str]] = None,
                 id: Optional[_builtins.str] = None,
                 min_child_endpoints: Optional[_builtins.float] = None,
                 min_child_endpoints_i_pv4: Optional[_builtins.float] = None,
        ...
        :param Sequence[_builtins.str] geo_mapping: The list of countries/regions mapped to this endpoint when using the 'Geographic' traffic routing method. Please consult Traffic Manager Geographic documentation for a full list of accepted values.
        :param _builtins.str id: Fully qualified resource Id for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/trafficManagerProfiles/{resourceName}
        :param _builtins.float min_child_endpoints: The minimum number of endpoints that must be available in the child profile in order for the parent profile to be considered available. Only applicable to endpoint of type 'NestedEndpoints'.
        :param _builtins.float min_child_endpoints_i_pv4: The minimum number of IPv4 (DNS record type A) endpoints that must be available in the child profile in order for the parent profile to be considered available. Only applicable to endpoint of type 'NestedEndpoints'.
        ...
        :param _builtins.float weight: The weight of this endpoint when using the 'Weighted' traffic routing method. Possible values are from 1 to 1000.
        """
...
class MonitorConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 profile_monitor_status: Optional[_builtins.str] = None,
                 protocol: Optional[_builtins.str] = None,
                 timeout_in_seconds: Optional[_builtins.float] = None,
        ...
        :param _builtins.str profile_monitor_status: The profile-level monitoring status of the Traffic Manager profile.
        :param _builtins.str protocol: The protocol (HTTP, HTTPS or TCP) used to probe for endpoint health.
        :param _builtins.float timeout_in_seconds: The monitor timeout for endpoints in this profile. This is the time that Traffic Manager allows endpoints in this profile to response to the health check.
        :param _builtins.float tolerated_number_of_failures: The number of consecutive failed health check that Traffic Manager tolerates before declaring an endpoint in this profile Degraded after the next failed health check.
        """
        if custom_headers is not None:
            pulumi.set(__self__, "custom_headers", custom_headers)
