...
class GetAzureLargeInstanceResult:
    ...
    def azure_large_instance_id(self) -> Optional[builtins.str]:
        """
    ...
    def hw_revision(self) -> Optional[builtins.str]:
        """
...
def get_azure_large_instance(azure_large_instance_name: Optional[builtins.str] = None,
    ...
    :param builtins.str azure_large_instance_name: Name of the AzureLargeInstance.
...
def get_azure_large_instance_output(azure_large_instance_name: Optional[pulumi.Input[builtins.str]] = None,
