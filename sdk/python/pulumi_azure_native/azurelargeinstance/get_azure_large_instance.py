...
def get_azure_large_instance(azure_large_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str azure_large_instance_name: Name of the AzureLargeInstance.
...
def get_azure_large_instance_output(azure_large_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
