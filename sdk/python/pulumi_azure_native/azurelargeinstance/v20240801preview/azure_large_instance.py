...
class AzureLargeInstanceArgs:
    def __init__(__self__, *,
                 ...
                 azure_large_instance_id: Optional[pulumi.Input[str]] = None,
                 azure_large_instance_name: Optional[pulumi.Input[str]] = None,
                 ...
                 power_state: Optional[pulumi.Input[Union[str, 'AzureLargeInstancePowerStateEnum']]] = None,
        ...
        :param pulumi.Input[str] azure_large_instance_id: Specifies the Azure Large Instance unique ID.
        :param pulumi.Input[str] azure_large_instance_name: Name of the AzureLargeInstance.
        :param pulumi.Input['HardwareProfileArgs'] hardware_profile: Specifies the hardware settings for the Azure Large Instance.
        :param pulumi.Input[str] hw_revision: Hardware revision of an Azure Large Instance
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input['NetworkProfileArgs'] network_profile: Specifies the network settings for the Azure Large Instance.
        :param pulumi.Input['OsProfileArgs'] os_profile: Specifies the operating system settings for the Azure Large Instance.
        :param pulumi.Input[Union[str, 'AzureLargeInstancePowerStateEnum']] power_state: Resource power state
    ...
    def azure_large_instance_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def azure_large_instance_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "azure_large_instance_id", value)

    @property
    @pulumi.getter(name="azureLargeInstanceName")
    def azure_large_instance_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def azure_large_instance_name(self, value: Optional[pulumi.Input[str]]):
    ...
    def power_state(self) -> Optional[pulumi.Input[Union[str, 'AzureLargeInstancePowerStateEnum']]]:
        """
    ...
    @power_state.setter
    def power_state(self, value: Optional[pulumi.Input[Union[str, 'AzureLargeInstancePowerStateEnum']]]):
...
class AzureLargeInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] azure_large_instance_id: Specifies the Azure Large Instance unique ID.
        :param pulumi.Input[str] azure_large_instance_name: Name of the AzureLargeInstance.
        :param pulumi.Input[Union['HardwareProfileArgs', 'HardwareProfileArgsDict']] hardware_profile: Specifies the hardware settings for the Azure Large Instance.
        :param pulumi.Input[str] hw_revision: Hardware revision of an Azure Large Instance
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['NetworkProfileArgs', 'NetworkProfileArgsDict']] network_profile: Specifies the network settings for the Azure Large Instance.
        :param pulumi.Input[Union['OsProfileArgs', 'OsProfileArgsDict']] os_profile: Specifies the operating system settings for the Azure Large Instance.
        :param pulumi.Input[Union[str, 'AzureLargeInstancePowerStateEnum']] power_state: Resource power state
        :param pulumi.Input[str] proximity_placement_group: Resource proximity placement group
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union['StorageProfileArgs', 'StorageProfileArgsDict']] storage_profile: Specifies the storage settings for the Azure Large Instance disks.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AzureLargeInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurelargeinstance:AzureLargeInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureLargeInstance, __self__).__init__(
            'azure-native:azurelargeinstance/v20240801preview:AzureLargeInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AzureLargeInstance':
        """
    ...
    @property
    @pulumi.getter(name="azureLargeInstanceId")
    def azure_large_instance_id(self) -> pulumi.Output[Optional[str]]:
        """
        Specifies the Azure Large Instance unique ID.
        """
        return pulumi.get(self, "azure_large_instance_id")
