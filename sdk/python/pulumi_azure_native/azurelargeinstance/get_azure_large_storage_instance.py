...
def get_azure_large_storage_instance(azure_large_storage_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str azure_large_storage_instance_name: Name of the AzureLargeStorageInstance.
...
def get_azure_large_storage_instance_output(azure_large_storage_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
