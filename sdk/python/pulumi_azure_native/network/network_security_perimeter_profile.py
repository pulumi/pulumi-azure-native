...
class NetworkSecurityPerimeterProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NspProfile"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspProfile"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspProfile"), pulumi.Alias(type_="azure-native:network:NspProfile"), pulumi.Alias(type_="azure-native_network_v20210201preview:network:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native_network_v20230701preview:network:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native_network_v20230801preview:network:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native_network_v20240601preview:network:NetworkSecurityPerimeterProfile")])
