...
class NetworkSecurityPerimeterProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20210201preview:NspProfile"), pulumi.Alias(type_="azure-native:network/v20230701preview:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspProfile"), pulumi.Alias(type_="azure-native:network/v20230801preview:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspProfile"), pulumi.Alias(type_="azure-native:network/v20240601preview:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkSecurityPerimeterProfile"), pulumi.Alias(type_="azure-native:network:NspProfile")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkSecurityPerimeterProfile':
        """
