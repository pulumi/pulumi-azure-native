...
def list_effective_virtual_network_by_network_manager(conditional_members: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220201preview:listEffectiveVirtualNetworkByNetworkManager', __args__, opts=opts, typ=ListEffectiveVirtualNetworkByNetworkManagerResult).value
...
def list_effective_virtual_network_by_network_manager_output(conditional_members: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220201preview:listEffectiveVirtualNetworkByNetworkManager', __args__, opts=opts, typ=ListEffectiveVirtualNetworkByNetworkManagerResult)
