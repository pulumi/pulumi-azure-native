...
class SubscriptionNetworkManagerConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20210501preview:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220101:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220501:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220701:SubscriptionNetworkManagerConnection")])
