...
warnings.warn("""azure-native:network/v20220201preview:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectivityConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
