...
warnings.warn("""azure-native:network/v20220201preview:DefaultAdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DefaultAdminRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class DefaultAdminRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DefaultAdminRule is deprecated: azure-native:network/v20220201preview:DefaultAdminRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DefaultAdminRule to guarantee forwards compatibility.""")
