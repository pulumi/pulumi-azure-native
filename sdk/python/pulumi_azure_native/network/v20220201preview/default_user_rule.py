...
class DefaultUserRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20210201preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20210501preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20220401preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20240301:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20240501:DefaultUserRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DefaultUserRule, __self__).__init__(
            'azure-native:network/v20220201preview:DefaultUserRule',
            resource_name,
            __props__,
            opts)
