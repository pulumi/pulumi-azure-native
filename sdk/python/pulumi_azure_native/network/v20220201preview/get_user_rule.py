...
warnings.warn("""azure-native:network/v20220201preview:UserRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:UserRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_user_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_rule is deprecated: azure-native:network/v20220201preview:UserRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220401preview:UserRule to guarantee forwards compatibility.""")
    __args__ = dict()
