...
def get_user_rule_collection(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_rule_collection is deprecated: azure-native:network/v20220201preview:UserRuleCollection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:UserRuleCollection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220201preview:getUserRuleCollection', __args__, opts=opts, typ=GetUserRuleCollectionResult).value
