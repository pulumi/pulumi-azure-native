...
def get_connectivity_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220201preview:getConnectivityConfiguration', __args__, opts=opts, typ=GetConnectivityConfigurationResult)
