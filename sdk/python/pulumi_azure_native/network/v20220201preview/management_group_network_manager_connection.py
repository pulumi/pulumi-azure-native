...
warnings.warn("""azure-native:network/v20220201preview:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.""", DeprecationWarning)
