...
warnings.warn("""azure-native:network/v20220201preview:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
class AdminRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_collection_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AdminRuleCollection is deprecated: azure-native:network/v20220201preview:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210201preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210501preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220501:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220701:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220901:AdminRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AdminRuleCollection, __self__).__init__(
            'azure-native:network/v20220201preview:AdminRuleCollection',
            resource_name,
            __props__,
            opts)
