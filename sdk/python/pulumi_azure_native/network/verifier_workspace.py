...
class VerifierWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240101preview:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20240501:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20240701:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20241001:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20250101:VerifierWorkspace")])
