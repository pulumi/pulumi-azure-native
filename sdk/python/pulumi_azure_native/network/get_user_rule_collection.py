...
def get_user_rule_collection(configuration_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getUserRuleCollection', __args__, opts=opts, typ=GetUserRuleCollectionResult).value
...
def get_user_rule_collection_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
