...
def get_vpn_connection(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the VpnGateway.
    """
    __args__ = dict()
...
def get_vpn_connection_output(connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
