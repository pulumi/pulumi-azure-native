...
class RoutingRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230301preview:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240301:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240701:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240901preview:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20241001:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20250101:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20250301:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20250501:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20250701:RoutingRuleCollection")])
    ...
    @_builtins.property
    @pulumi.getter(name="disableBgpRoutePropagation")
    def disable_bgp_route_propagation(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Determines whether BGP route propagation is enabled. Defaults to true.
        """
        return pulumi.get(self, "disable_bgp_route_propagation")
