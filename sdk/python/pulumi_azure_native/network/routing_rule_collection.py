...
class RoutingRuleCollectionArgs:
    def __init__(__self__, *,
                 ...
                 disable_bgp_route_propagation: Optional[pulumi.Input[Union[str, 'DisableBgpRoutePropagation']]] = None,
        ...
        :param pulumi.Input[str] description: A description of the routing rule collection.
        :param pulumi.Input[Union[str, 'DisableBgpRoutePropagation']] disable_bgp_route_propagation: Determines whether BGP route propagation is enabled. Defaults to true.
    ...
    def disable_bgp_route_propagation(self) -> Optional[pulumi.Input[Union[str, 'DisableBgpRoutePropagation']]]:
        """
    ...
    def disable_bgp_route_propagation(self, value: Optional[pulumi.Input[Union[str, 'DisableBgpRoutePropagation']]]):
...
class RoutingRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240301:RoutingRuleCollection")])
    ...
    @property
    @pulumi.getter(name="disableBgpRoutePropagation")
    def disable_bgp_route_propagation(self) -> pulumi.Output[Optional[str]]:
        """
        Determines whether BGP route propagation is enabled. Defaults to true.
        """
        return pulumi.get(self, "disable_bgp_route_propagation")
