...
class ZoneArgs:
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['ZonePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ZonePropertiesArgs']]):
...
class Zone(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20150504preview:Zone"), pulumi.Alias(type_="azure-native:network:Zone"), pulumi.Alias(type_="azure-nextgen:network:Zone"), pulumi.Alias(type_="azure-native:network/v20160401:Zone"), pulumi.Alias(type_="azure-nextgen:network/v20160401:Zone"), pulumi.Alias(type_="azure-native:network/v20170901:Zone"), pulumi.Alias(type_="azure-nextgen:network/v20170901:Zone"), pulumi.Alias(type_="azure-native:network/v20171001:Zone"), pulumi.Alias(type_="azure-nextgen:network/v20171001:Zone"), pulumi.Alias(type_="azure-native:network/v20180301preview:Zone"), pulumi.Alias(type_="azure-nextgen:network/v20180301preview:Zone"), pulumi.Alias(type_="azure-native:network/v20180501:Zone"), pulumi.Alias(type_="azure-nextgen:network/v20180501:Zone")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ZonePropertiesResponse']:
        """
        Gets or sets the properties of the zone.
        """
        return pulumi.get(self, "properties")
