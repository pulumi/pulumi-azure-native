...
def get_zone(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_zone is deprecated: Version v20150504preview will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20150504preview:getZone', __args__, opts=opts, typ=GetZoneResult).value
