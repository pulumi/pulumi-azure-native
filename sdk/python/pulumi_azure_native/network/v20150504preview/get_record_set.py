...
warnings.warn("""Version v20150504preview will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""", DeprecationWarning)
...
def get_record_set(record_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_record_set is deprecated: Version v20150504preview will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
