...
def get_express_route_circuit_authorization(authorization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_authorization is deprecated: Version v20150615 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20150615:getExpressRouteCircuitAuthorization', __args__, opts=opts, typ=GetExpressRouteCircuitAuthorizationResult).value
