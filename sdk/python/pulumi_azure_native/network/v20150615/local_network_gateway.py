...
azure-native:network/v20150615:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20160601:LocalNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
