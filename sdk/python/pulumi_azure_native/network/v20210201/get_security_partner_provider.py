...
warnings.warn("""azure-native:network/v20210201:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityPartnerProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_security_partner_provider(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_partner_provider is deprecated: azure-native:network/v20210201:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityPartnerProvider to guarantee forwards compatibility.""")
    __args__ = dict()
