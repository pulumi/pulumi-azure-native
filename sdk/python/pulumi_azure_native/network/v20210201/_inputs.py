...
class FrontendIPConfigurationArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'gatewayLoadBalancer' in kwargs:
...
class PrivateLinkServiceConnectionArgs:
    ...
    def _configure(
        ...
        if 'resolvedPrivateLinkServiceLocation' in kwargs:
...
class SubnetArgs:
    ...
    def _configure(
        ...
        if 'applicationGatewayIpConfigurations' in kwargs:
