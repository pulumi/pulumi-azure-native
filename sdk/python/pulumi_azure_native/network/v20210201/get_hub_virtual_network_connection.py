...
warnings.warn("""azure-native:network/v20210201:HubVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubVirtualNetworkConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_hub_virtual_network_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hub_virtual_network_connection is deprecated: azure-native:network/v20210201:HubVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubVirtualNetworkConnection to guarantee forwards compatibility.""")
    __args__ = dict()
