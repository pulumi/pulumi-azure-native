...
warnings.warn("""azure-native:network/v20210201:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_azure_firewall is deprecated: azure-native:network/v20210201:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['azureFirewallName'] = azure_firewall_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult).value
