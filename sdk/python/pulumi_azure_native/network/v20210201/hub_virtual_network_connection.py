...
class HubVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HubVirtualNetworkConnection is deprecated: azure-native:network/v20210201:HubVirtualNetworkConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubVirtualNetworkConnection to guarantee forwards compatibility.""")
