...
def get_network_virtual_appliance(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_virtual_appliance is deprecated: azure-native:network/v20210201:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkVirtualAppliance to guarantee forwards compatibility.""")
    __args__ = dict()
