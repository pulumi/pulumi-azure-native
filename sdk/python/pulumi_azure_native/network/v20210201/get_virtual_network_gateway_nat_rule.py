...
def get_virtual_network_gateway_nat_rule(nat_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_gateway_nat_rule is deprecated: azure-native:network/v20210201:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['natRuleName'] = nat_rule_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualNetworkGatewayName'] = virtual_network_gateway_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201:getVirtualNetworkGatewayNatRule', __args__, opts=opts, typ=GetVirtualNetworkGatewayNatRuleResult).value
