...
warnings.warn("""azure-native:network/v20210201:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_gateway_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkGatewayNatRule is deprecated: azure-native:network/v20210201:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""")
