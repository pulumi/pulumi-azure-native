...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20210201:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-nextgen:network:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20210301:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-nextgen:network/v20210301:VirtualNetworkGatewayNatRule")])
