...
def get_ddos_custom_policy_output(ddos_custom_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210201:getDdosCustomPolicy', __args__, opts=opts, typ=GetDdosCustomPolicyResult)
    return __ret__.apply(lambda __response__: GetDdosCustomPolicyResult(
        etag=pulumi.get(__response__, 'etag'),
        id=pulumi.get(__response__, 'id'),
        location=pulumi.get(__response__, 'location'),
        name=pulumi.get(__response__, 'name'),
        protocol_custom_settings=pulumi.get(__response__, 'protocol_custom_settings'),
