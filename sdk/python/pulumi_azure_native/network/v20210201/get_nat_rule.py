...
warnings.warn("""azure-native:network/v20210201:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_nat_rule(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_rule is deprecated: azure-native:network/v20210201:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['gatewayName'] = gateway_name
    __args__['natRuleName'] = nat_rule_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201:getNatRule', __args__, opts=opts, typ=GetNatRuleResult).value
