...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint = azure_native.network.v20210201.PrivateEndpoint("privateEndpoint",
            location="eastus2euap",
            private_endpoint_name="testPe",
            private_link_service_connections=[azure_native.network.v20210201.PrivateLinkServiceConnectionArgs(
        ...
        private_endpoint = azure_native.network.v20210201.PrivateEndpoint("privateEndpoint",
            location="eastus",
            manual_private_link_service_connections=[azure_native.network.v20210201.PrivateLinkServiceConnectionArgs(
                group_ids=["groupIdFromResource"],
                private_link_service_id="/subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/privateLinkServices/testPls",
