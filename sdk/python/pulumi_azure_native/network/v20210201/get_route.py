...
warnings.warn("""azure-native:network/v20210201:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: azure-native:network/v20210201:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.""")
    __args__ = dict()
