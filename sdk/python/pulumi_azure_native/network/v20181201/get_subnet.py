...
warnings.warn("""azure-native:network/v20181201:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subnet(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subnet is deprecated: azure-native:network/v20181201:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181201:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
