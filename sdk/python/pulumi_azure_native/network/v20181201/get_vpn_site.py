...
warnings.warn("""azure-native:network/v20181201:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnSite to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vpn_site(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_site is deprecated: azure-native:network/v20181201:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnSite to guarantee forwards compatibility.""")
    __args__ = dict()
