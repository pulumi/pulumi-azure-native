...
class GetExpressRouteCircuitResult:
    ...
    """
    def __init__(__self__, allow_classic_operations=None, allow_global_reach=None, authorizations=None, bandwidth_in_gbps=None, circuit_provisioning_state=None, etag=None, express_route_port=None, gateway_manager_etag=None, global_reach_enabled=None, id=None, location=None, name=None, peerings=None, provisioning_state=None, service_key=None, service_provider_notes=None, service_provider_properties=None, service_provider_provisioning_state=None, sku=None, stag=None, tags=None, type=None):
...
def get_express_route_circuit(circuit_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181201:getExpressRouteCircuit', __args__, opts=opts, typ=GetExpressRouteCircuitResult).value

    return AwaitableGetExpressRouteCircuitResult(
        allow_classic_operations=pulumi.get(__ret__, 'allow_classic_operations'),
        allow_global_reach=pulumi.get(__ret__, 'allow_global_reach'),
...
def get_express_route_circuit_output(circuit_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20181201:getExpressRouteCircuit', __args__, opts=opts, typ=GetExpressRouteCircuitResult)
    return __ret__.apply(lambda __response__: GetExpressRouteCircuitResult(
        ...
        allow_global_reach=pulumi.get(__response__, 'allow_global_reach'),
