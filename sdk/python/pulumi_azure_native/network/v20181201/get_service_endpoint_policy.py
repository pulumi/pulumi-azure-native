...
warnings.warn("""azure-native:network/v20181201:ServiceEndpointPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service_endpoint_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_endpoint_policy is deprecated: azure-native:network/v20181201:ServiceEndpointPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
