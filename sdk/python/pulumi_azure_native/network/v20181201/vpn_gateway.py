...
class VpnGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_gateway_scale_unit: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnGateway is deprecated: azure-native:network/v20181201:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.""")
