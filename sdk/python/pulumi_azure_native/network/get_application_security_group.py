...
class GetApplicationSecurityGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, etag=None, id=None, location=None, name=None, provisioning_state=None, resource_guid=None, tags=None, type=None):
...
def get_application_security_group(application_security_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_security_group_name: The name of the application security group.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getApplicationSecurityGroup', __args__, opts=opts, typ=GetApplicationSecurityGroupResult).value
...
def get_application_security_group_output(application_security_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getApplicationSecurityGroup', __args__, opts=opts, typ=GetApplicationSecurityGroupResult)
