...
warnings.warn("""azure-native:network/v20180601:VirtualWAN is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VirtualWAN to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_wan(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_wan is deprecated: azure-native:network/v20180601:VirtualWAN is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VirtualWAN to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualWANName'] = virtual_wan_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180601:getVirtualWAN', __args__, opts=opts, typ=GetVirtualWANResult).value
