...
class BackendAddressPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        BackendAddressPoolResponse._configure(
            ...
            outbound_nat_rule=outbound_nat_rule,
            etag=etag,
            id=id,
            name=name,
            provisioning_state=provisioning_state,
    ...
    def _configure(
        ...
        if outbound_nat_rule is None and 'outboundNatRule' in kwargs:
            outbound_nat_rule = kwargs['outboundNatRule']
        if outbound_nat_rule is None:
            raise TypeError("Missing 'outbound_nat_rule' argument")
        if provisioning_state is None and 'provisioningState' in kwargs:
            provisioning_state = kwargs['provisioningState']

        _setter("backend_ip_configurations", backend_ip_configurations)
        _setter("load_balancing_rules", load_balancing_rules)
        _setter("outbound_nat_rule", outbound_nat_rule)
        if etag is not None:
            _setter("etag", etag)
        if id is not None:
            _setter("id", id)
...
class FrontendIPConfigurationResponse(dict):
    ...
    def _configure(
        ...
        if outbound_nat_rules is None:
            raise TypeError("Missing 'outbound_nat_rules' argument")
...
class InboundNatPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        InboundNatPoolResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
        ...
        if frontend_port_range_end is None:
            raise TypeError("Missing 'frontend_port_range_end' argument")
        ...
        if frontend_port_range_start is None:
            raise TypeError("Missing 'frontend_port_range_start' argument")
        if protocol is None:
...
class LoadBalancerSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        LoadBalancerSkuResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            name=name,
        )
    @staticmethod
...
class OutboundNatRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str provisioning_state: Gets the provisioning state of the PublicIP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
        """
        OutboundNatRuleResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            backend_address_pool=backend_address_pool,
    ...
    def _configure(
        ...
        if backend_address_pool is None:
            raise TypeError("Missing 'backend_address_pool' argument")
