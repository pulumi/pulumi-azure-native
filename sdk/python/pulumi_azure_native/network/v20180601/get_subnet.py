...
warnings.warn("""azure-native:network/v20180601:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_subnet(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subnet is deprecated: azure-native:network/v20180601:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""")
    __args__ = dict()
