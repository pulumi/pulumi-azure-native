...
warnings.warn("""azure-native:network/v20180601:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VpnSite to guarantee forwards compatibility.""", DeprecationWarning)
...
class VpnSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VpnSite, __self__).__init__(
            'azure-native:network/v20180601:VpnSite',
            resource_name,
            __props__,
            opts)
