...
def get_express_route_circuit_peering(circuit_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_peering is deprecated: azure-native:network/v20180601:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:ExpressRouteCircuitPeering to guarantee forwards compatibility.""")
    __args__ = dict()
