...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_balancer = azure_native.network.v20180601.LoadBalancer("loadBalancer",
            backend_address_pools=[azure_native.network.v20180601.BackendAddressPoolArgs(
                name="be-lb",
            )],
            frontend_ip_configurations=[{
                "name": "fe-lb",
                "subnet": azure_native.network.v20180601.SubnetArgs(
            ...
            inbound_nat_rules=[{
                ...
                "frontendIPConfiguration": azure_native.network.v20180601.SubResourceArgs(
            ...
            load_balancing_rules=[{
                "backendAddressPool": azure_native.network.v20180601.SubResourceArgs(
                ...
                "name": "rulelb",
                "probe": azure_native.network.v20180601.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20180601.LoadBalancer("loadBalancer",
            ...
            resource_group_name="rg1",
            sku=azure_native.network.v20180601.LoadBalancerSkuArgs(
                name="Standard",
            ))
