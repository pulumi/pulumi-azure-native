...
warnings.warn("""azure-native:network/v20180601:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class VpnGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnGateway is deprecated: azure-native:network/v20180601:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.""")
