...
def get_nsp_access_rule(access_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230801preview:getNspAccessRule', __args__, opts=opts, typ=GetNspAccessRuleResult).value
...
def get_nsp_access_rule_output(access_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230801preview:getNspAccessRule', __args__, opts=opts, typ=GetNspAccessRuleResult)
