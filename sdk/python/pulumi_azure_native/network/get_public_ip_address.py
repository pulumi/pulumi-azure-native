...
def get_public_ip_address(expand: Optional[_builtins.str] = None,
                          public_ip_address_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str public_ip_address_name: The name of the public IP address.
...
def get_public_ip_address_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 public_ip_address_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
