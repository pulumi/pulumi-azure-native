...
warnings.warn("""azure-native:network/v20210301:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_endpoint(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint is deprecated: azure-native:network/v20210301:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
