...
def get_packet_capture(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_packet_capture is deprecated: azure-native:network/v20210301:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PacketCapture to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkWatcherName'] = network_watcher_name
    __args__['packetCaptureName'] = packet_capture_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210301:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult).value
