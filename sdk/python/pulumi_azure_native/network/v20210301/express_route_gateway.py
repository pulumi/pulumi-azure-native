...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_gateway = azure_native.network.v20210301.ExpressRouteGateway("expressRouteGateway",
            auto_scale_configuration=azure_native.network.v20210301.ExpressRouteGatewayPropertiesResponseAutoScaleConfigurationArgs(
                bounds=azure_native.network.v20210301.ExpressRouteGatewayPropertiesBoundsArgs(
                    min=3,
                ),
            ),
            ...
            virtual_hub=azure_native.network.v20210301.VirtualHubIdArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20210301:ExpressRouteGateway gateway-2 /subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.Network/expressRouteGateways/gateway-2 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteGateway, __self__).__init__(
            'azure-native:network/v20210301:ExpressRouteGateway',
            resource_name,
            __props__,
            opts)
