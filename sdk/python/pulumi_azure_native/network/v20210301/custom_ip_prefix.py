...
class CustomIPPrefixArgs:
    ...
    def _configure(
        ...
        if authorization_message is None and 'authorizationMessage' in kwargs:
            authorization_message = kwargs['authorizationMessage']
        if commissioned_state is None and 'commissionedState' in kwargs:
            commissioned_state = kwargs['commissionedState']
        if custom_ip_prefix_name is None and 'customIpPrefixName' in kwargs:
            custom_ip_prefix_name = kwargs['customIpPrefixName']
        if custom_ip_prefix_parent is None and 'customIpPrefixParent' in kwargs:
        ...
        if signed_message is None and 'signedMessage' in kwargs:
...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 commissioned_state: Optional[pulumi.Input[Union[str, 'CommissionedState']]] = None,
                 custom_ip_prefix_name: Optional[pulumi.Input[str]] = None,
                 custom_ip_prefix_parent: Optional[pulumi.Input[pulumi.InputType['CustomIpPrefixArgs']]] = None,
        ...
        :param pulumi.Input[Union[str, 'CommissionedState']] commissioned_state: The commissioned state of the Custom IP Prefix.
        :param pulumi.Input[str] custom_ip_prefix_name: The name of the custom IP prefix.
        :param pulumi.Input[pulumi.InputType['CustomIpPrefixArgs']] custom_ip_prefix_parent: The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            custom_ip_prefix_parent = _utilities.configure(custom_ip_prefix_parent, CustomIpPrefixArgs, True)
