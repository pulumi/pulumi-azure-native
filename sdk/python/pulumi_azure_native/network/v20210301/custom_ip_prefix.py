...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 commissioned_state: Optional[pulumi.Input[Union[str, 'CommissionedState']]] = None,
                 custom_ip_prefix_name: Optional[pulumi.Input[str]] = None,
                 custom_ip_prefix_parent: Optional[pulumi.Input[Union['CustomIpPrefixArgs', 'CustomIpPrefixArgsDict']]] = None,
        ...
        :param pulumi.Input[Union[str, 'CommissionedState']] commissioned_state: The commissioned state of the Custom IP Prefix.
        :param pulumi.Input[str] custom_ip_prefix_name: The name of the custom IP prefix.
        :param pulumi.Input[Union['CustomIpPrefixArgs', 'CustomIpPrefixArgsDict']] custom_ip_prefix_parent: The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20201101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220901:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20221101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230401:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230901:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20231101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network:CustomIPPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomIPPrefix, __self__).__init__(
            'azure-native:network/v20210301:CustomIPPrefix',
            resource_name,
            __props__,
            opts)
    ...
    def child_custom_ip_prefixes(self) -> pulumi.Output[Sequence['outputs.CustomIpPrefixResponse']]:
        """
    ...
    @property
    @pulumi.getter(name="customIpPrefixParent")
    def custom_ip_prefix_parent(self) -> pulumi.Output[Optional['outputs.CustomIpPrefixResponse']]:
        """
        The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
        """
        return pulumi.get(self, "custom_ip_prefix_parent")
