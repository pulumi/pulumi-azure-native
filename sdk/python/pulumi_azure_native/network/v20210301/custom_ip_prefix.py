...
class CustomIPPrefixArgs:
    ...
    def _configure(
        ...
        if 'customIpPrefixName' in kwargs:
...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if custom_ip_prefix_parent is not None and not isinstance(custom_ip_prefix_parent, CustomIpPrefixArgs):
                custom_ip_prefix_parent = custom_ip_prefix_parent or {}
                def _setter(key, value):
                    custom_ip_prefix_parent[key] = value
                CustomIpPrefixArgs._configure(_setter, **custom_ip_prefix_parent)
