...
warnings.warn("""azure-native:network/v20210301:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkSecurityGroup is deprecated: azure-native:network/v20210301:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""")
