...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_gateway_nat_rule = azure_native.network.v20210301.VirtualNetworkGatewayNatRule("virtualNetworkGatewayNatRule",
            external_mappings=[azure_native.network.v20210301.VpnNatRuleMappingArgs(
                address_space="192.168.21.0/24",
            )],
            internal_mappings=[azure_native.network.v20210301.VpnNatRuleMappingArgs(
