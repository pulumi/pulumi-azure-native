...
warnings.warn("""azure-native:network/v20210301:VpnConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vpn_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_connection is deprecated: azure-native:network/v20210301:VpnConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.""")
    __args__ = dict()
