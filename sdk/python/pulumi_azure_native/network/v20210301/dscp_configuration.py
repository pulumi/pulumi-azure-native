...
warnings.warn("""azure-native:network/v20210301:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class DscpConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DscpConfiguration is deprecated: azure-native:network/v20210301:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20200601:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20200701:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20200801:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20201101:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20210201:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20210501:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20210801:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20220101:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20220501:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20220701:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20220901:DscpConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DscpConfiguration, __self__).__init__(
            'azure-native:network/v20210301:DscpConfiguration',
            resource_name,
            __props__,
            opts)
