...
warnings.warn("""azure-native:network/v20210301:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class DscpConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DscpConfiguration is deprecated: azure-native:network/v20210301:DscpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:DscpConfiguration to guarantee forwards compatibility.""")
