...
warnings.warn("""azure-native:network/v20210301:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_type: Optional[pulumi.Input[Union[str, 'VpnType']]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkGateway is deprecated: azure-native:network/v20210301:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualNetworkGateway to guarantee forwards compatibility.""")
