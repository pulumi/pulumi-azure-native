...
warnings.warn("""azure-native:network/v20210301:DdosProtectionPlan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ddos_protection_plan is deprecated: azure-native:network/v20210301:DdosProtectionPlan is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""")
    __args__ = dict()
