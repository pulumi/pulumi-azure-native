...
warnings.warn("""azure-native:network/v20210301:NatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class NatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[Union[str, 'VpnNatRuleType']]] = None,
                 __props__=None):
        pulumi.log.warn("""NatRule is deprecated: azure-native:network/v20210301:NatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NatRule to guarantee forwards compatibility.""")
