...
class InterfaceEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: A first-party service's FQDN that is mapped to the private IP allocated via this interface endpoint.
        :param pulumi.Input[builtins.str] id: Resource ID.
        :param pulumi.Input[builtins.str] interface_endpoint_name: The name of the interface endpoint.
...
class InterfaceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 endpoint_service: Optional[pulumi.Input[Union['EndpointServiceArgs', 'EndpointServiceArgsDict']]] = None,
                 fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 interface_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
