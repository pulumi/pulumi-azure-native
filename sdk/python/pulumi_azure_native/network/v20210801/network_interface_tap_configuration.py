...
warnings.warn("""azure-native:network/v20210801:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
