...
warnings.warn("""azure-native:network/v20210801:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteCrossConnectionPeering, __self__).__init__(
            'azure-native:network/v20210801:ExpressRouteCrossConnectionPeering',
            resource_name,
            __props__,
            opts)
