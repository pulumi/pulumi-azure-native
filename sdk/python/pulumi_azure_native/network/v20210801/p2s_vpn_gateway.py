...
warnings.warn("""azure-native:network/v20210801:P2sVpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:P2sVpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class P2sVpnGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_server_configuration: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""P2sVpnGateway is deprecated: azure-native:network/v20210801:P2sVpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:P2sVpnGateway to guarantee forwards compatibility.""")
