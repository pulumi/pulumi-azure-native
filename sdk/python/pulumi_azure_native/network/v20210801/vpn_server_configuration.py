...
warnings.warn("""azure-native:network/v20210801:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnServerConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class VpnServerConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_server_configuration_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnServerConfiguration is deprecated: azure-native:network/v20210801:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnServerConfiguration to guarantee forwards compatibility.""")
