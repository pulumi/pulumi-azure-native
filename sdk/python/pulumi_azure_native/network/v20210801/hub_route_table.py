...
warnings.warn("""azure-native:network/v20210801:HubRouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubRouteTable to guarantee forwards compatibility.""", DeprecationWarning)
...
class HubRouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HubRouteTable is deprecated: azure-native:network/v20210801:HubRouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:HubRouteTable to guarantee forwards compatibility.""")
