...
class DnsSettingsResponse(dict):
    ...
    def _configure(
             ...
             **kwargs):
        if 'enableProxy' in kwargs:
            enable_proxy = kwargs['enableProxy']
        if 'requireProxyForNetworkRules' in kwargs:
...
class ExplicitProxySettingsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'enableExplicitProxy' in kwargs:
...
class FirewallPolicyInsightsResponse(dict):
    ...
    def _configure(
        ...
        if 'logAnalyticsResources' in kwargs:
...
class FirewallPolicyIntrusionDetectionConfigurationResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'bypassTrafficSettings' in kwargs:
...
class FirewallPolicyLogAnalyticsResourcesResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'defaultWorkspaceId' in kwargs:
