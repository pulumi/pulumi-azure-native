...
def get_express_route_port_authorization(authorization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_port_authorization is deprecated: azure-native:network/v20210801:ExpressRoutePortAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRoutePortAuthorization to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210801:getExpressRoutePortAuthorization', __args__, opts=opts, typ=GetExpressRoutePortAuthorizationResult).value
