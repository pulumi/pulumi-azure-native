...
warnings.warn("""azure-native:network/v20210801:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AzureFirewall to guarantee forwards compatibility.""", DeprecationWarning)
