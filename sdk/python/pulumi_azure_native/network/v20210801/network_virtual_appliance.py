...
warnings.warn("""azure-native:network/v20210801:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkVirtualAppliance is deprecated: azure-native:network/v20210801:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""")
