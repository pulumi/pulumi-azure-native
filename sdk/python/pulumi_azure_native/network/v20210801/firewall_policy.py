...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_policy = azure_native.network.v20210801.FirewallPolicy("firewallPolicy",
            dns_settings=azure_native.network.v20210801.DnsSettingsArgs(
                enable_proxy=True,
                require_proxy_for_network_rules=False,
                servers=["30.3.4.5"],
            ),
            explicit_proxy_settings=azure_native.network.v20210801.ExplicitProxySettingsArgs(
            ...
            insights=azure_native.network.v20210801.FirewallPolicyInsightsResponseArgs(
                is_enabled=True,
                log_analytics_resources={
                    "defaultWorkspaceId": azure_native.network.v20210801.SubResourceArgs(
                        id="/subscriptions/subid/resourcegroups/rg1/providers/microsoft.operationalinsights/workspaces/defaultWorkspace",
                    ),
                    "workspaces": [
                        {
                            "region": "westus",
                            "workspaceId": azure_native.network.v20210801.SubResourceArgs(
            ...
            intrusion_detection=azure_native.network.v20210801.FirewallPolicyIntrusionDetectionResponseArgs(
                configuration={
                    "bypassTrafficSettings": [azure_native.network.v20210801.FirewallPolicyIntrusionDetectionBypassTrafficSpecificationsArgs(
                        description="Rule 1",
                    ...
                    "signatureOverrides": [azure_native.network.v20210801.FirewallPolicyIntrusionDetectionSignatureSpecificationArgs(
                        id="2525004",
                        mode="Deny",
                    )],
                },
            ...
            sku=azure_native.network.v20210801.FirewallPolicySkuArgs(
                tier="Premium",
            ),
            snat=azure_native.network.v20210801.FirewallPolicySNATArgs(
                private_ranges=["IANAPrivateRanges"],
            ),
            sql=azure_native.network.v20210801.FirewallPolicySQLArgs(
            ...
            threat_intel_whitelist=azure_native.network.v20210801.FirewallPolicyThreatIntelWhitelistArgs(
                fqdns=["*.microsoft.com"],
                ip_addresses=["20.3.4.5"],
            ),
            transport_security=azure_native.network.v20210801.FirewallPolicyTransportSecurityResponseArgs(
                certificate_authority=azure_native.network.v20210801.FirewallPolicyCertificateAuthorityArgs(
