...
class FirewallPolicyArgs:
    ...
    def _configure(
        ...
        if 'explicitProxySettings' in kwargs:
...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if explicit_proxy_settings is not None and not isinstance(explicit_proxy_settings, ExplicitProxySettingsArgs):
                explicit_proxy_settings = explicit_proxy_settings or {}
                def _setter(key, value):
                    explicit_proxy_settings[key] = value
                ExplicitProxySettingsArgs._configure(_setter, **explicit_proxy_settings)
