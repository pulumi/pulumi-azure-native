...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 explicit_proxy_settings: Optional[pulumi.Input[Union['ExplicitProxySettingsArgs', 'ExplicitProxySettingsArgsDict']]] = None,
                 firewall_policy_name: Optional[pulumi.Input[str]] = None,
                 id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['ExplicitProxySettingsArgs', 'ExplicitProxySettingsArgsDict']] explicit_proxy_settings: Explicit Proxy Settings definition.
        :param pulumi.Input[str] firewall_policy_name: The name of the Firewall Policy.
        :param pulumi.Input[str] id: Resource ID.
