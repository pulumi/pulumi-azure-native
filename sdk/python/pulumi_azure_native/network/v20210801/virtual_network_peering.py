...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_peering_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkPeering is deprecated: azure-native:network/v20210801:VirtualNetworkPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkPeering to guarantee forwards compatibility.""")
