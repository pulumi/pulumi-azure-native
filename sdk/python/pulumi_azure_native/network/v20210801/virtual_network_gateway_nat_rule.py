...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20210201:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20210301:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20210501:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20220101:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20220501:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20220701:VirtualNetworkGatewayNatRule"), pulumi.Alias(type_="azure-native:network/v20220901:VirtualNetworkGatewayNatRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkGatewayNatRule, __self__).__init__(
            'azure-native:network/v20210801:VirtualNetworkGatewayNatRule',
            resource_name,
            __props__,
            opts)
