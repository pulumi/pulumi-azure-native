...
warnings.warn("""azure-native:network/v20210801:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_gateway is deprecated: azure-native:network/v20210801:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.""")
    __args__ = dict()
