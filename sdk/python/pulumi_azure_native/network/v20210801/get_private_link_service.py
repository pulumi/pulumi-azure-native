...
def get_private_link_service(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_service is deprecated: azure-native:network/v20210801:PrivateLinkService is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateLinkService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210801:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult).value
