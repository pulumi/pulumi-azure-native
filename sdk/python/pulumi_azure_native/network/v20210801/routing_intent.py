...
class RoutingIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20210501:RoutingIntent")])
