...
def get_record_set(record_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_record_set is deprecated: Version v20160401 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20160401:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
