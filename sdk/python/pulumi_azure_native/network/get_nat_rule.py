...
def get_nat_rule(gateway_name: Optional[_builtins.str] = None,
                 nat_rule_name: Optional[_builtins.str] = None,
...
def get_nat_rule_output(gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
