...
azure-native:network/v20180201:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_network_gateway is deprecated: Version 2018-02-01 will be removed in v2 of the provider.
azure-native:network/v20180201:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:LocalNetworkGateway to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180201:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult).value
