...
def get_express_route_circuit_peering(circuit_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_peering is deprecated: Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
