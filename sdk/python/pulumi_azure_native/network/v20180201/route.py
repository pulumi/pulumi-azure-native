...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 route_table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Route is deprecated: Version 2018-02-01 will be removed in v2 of the provider.""")
