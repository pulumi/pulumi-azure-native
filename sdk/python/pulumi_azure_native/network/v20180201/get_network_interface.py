...
def get_network_interface(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_interface is deprecated: Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180201:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult).value
