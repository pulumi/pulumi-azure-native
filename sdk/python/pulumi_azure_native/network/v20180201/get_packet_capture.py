...
def get_packet_capture(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_packet_capture is deprecated: Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180201:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult).value
