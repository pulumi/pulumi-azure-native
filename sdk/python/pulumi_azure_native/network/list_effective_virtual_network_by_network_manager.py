...
def list_effective_virtual_network_by_network_manager(conditional_members: Optional[_builtins.str] = None,
    ...
    :param _builtins.str skip_token: Continuation token for pagination, capturing the next page size and offset, as well as the context of the query.
