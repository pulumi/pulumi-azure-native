...
class InboundNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if backend_address_pool is not None and not isinstance(backend_address_pool, SubResourceArgs):
                backend_address_pool = backend_address_pool or {}
                def _setter(key, value):
                    backend_address_pool[key] = value
                SubResourceArgs._configure(_setter, **backend_address_pool)
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/v20230501:InboundNatRule',
            resource_name,
            __props__,
            opts)
