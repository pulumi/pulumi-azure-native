...
class AdminRuleCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A description of the admin rule collection.
...
class AdminRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210201preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210501preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220201preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220501:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220701:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220901:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20221101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20230201:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20230401:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20230601:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20230901:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20231101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240101preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240301:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:AdminRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AdminRuleCollection, __self__).__init__(
            'azure-native:network/v20230501:AdminRuleCollection',
            resource_name,
            __props__,
            opts)
