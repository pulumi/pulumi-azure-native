...
class ApplicationGatewayPrivateEndpointConnectionArgs:
    ...
    def _configure(
        ...
        if application_gateway_name is None:
            raise TypeError("Missing 'application_gateway_name' argument")
