...
class ScopeConnectionArgs:
    ...
    def _configure(
        ...
        if scope_connection_name is None and 'scopeConnectionName' in kwargs:
            scope_connection_name = kwargs['scopeConnectionName']
