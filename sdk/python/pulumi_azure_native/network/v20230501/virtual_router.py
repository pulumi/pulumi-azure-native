...
class VirtualRouterArgs:
    ...
    def _configure(
        ...
        if 'hostedGateway' in kwargs:
            hosted_gateway = kwargs['hostedGateway']
        if 'hostedSubnet' in kwargs:
...
class VirtualRouter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if hosted_gateway is not None and not isinstance(hosted_gateway, SubResourceArgs):
            ...
            if hosted_subnet is not None and not isinstance(hosted_subnet, SubResourceArgs):
