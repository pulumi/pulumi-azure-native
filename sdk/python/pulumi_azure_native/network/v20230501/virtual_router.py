...
class VirtualRouterArgs:
    ...
    def _configure(
        ...
        if hosted_gateway is None and 'hostedGateway' in kwargs:
            hosted_gateway = kwargs['hostedGateway']
        if hosted_subnet is None and 'hostedSubnet' in kwargs:
            hosted_subnet = kwargs['hostedSubnet']
...
class VirtualRouter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            hosted_gateway = _utilities.configure(hosted_gateway, SubResourceArgs, True)
            __props__.__dict__["hosted_gateway"] = hosted_gateway
            hosted_subnet = _utilities.configure(hosted_subnet, SubResourceArgs, True)
