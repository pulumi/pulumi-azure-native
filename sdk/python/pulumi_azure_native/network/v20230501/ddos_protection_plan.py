...
class DdosProtectionPlanArgs:
    def __init__(__self__, *,
        ...
        """
        DdosProtectionPlanArgs._configure(
    ...
    def _configure(
        ...
        if ddos_protection_plan_name is None and 'ddosProtectionPlanName' in kwargs:
            ddos_protection_plan_name = kwargs['ddosProtectionPlanName']

        _setter("resource_group_name", resource_group_name)
        if ddos_protection_plan_name is not None:
            _setter("ddos_protection_plan_name", ddos_protection_plan_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DdosProtectionPlanArgs._configure(_setter, **kwargs)
