...
class VpnSiteArgs:
    ...
    def _configure(
        ...
        if 'vpnSiteLinks' in kwargs:
            vpn_site_links = kwargs['vpnSiteLinks']
        if 'vpnSiteName' in kwargs:
...
class VpnSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if address_space is not None and not isinstance(address_space, AddressSpaceArgs):
            ...
            if bgp_properties is not None and not isinstance(bgp_properties, BgpSettingsArgs):
            ...
            if device_properties is not None and not isinstance(device_properties, DevicePropertiesArgs):
            ...
            if o365_policy is not None and not isinstance(o365_policy, O365PolicyPropertiesArgs):
