...
class VirtualNetworkGatewayInitArgs:
    ...
    def _configure(
        ...
        if 'allowRemoteVnetTraffic' in kwargs:
            allow_remote_vnet_traffic = kwargs['allowRemoteVnetTraffic']
        if 'allowVirtualWanTraffic' in kwargs:
        ...
        if 'disableIPSecReplayProtection' in kwargs:
        ...
        if 'enablePrivateIpAddress' in kwargs:
        ...
        if 'vNetExtendedLocationResourceId' in kwargs:
        ...
        if 'virtualNetworkGatewayPolicyGroups' in kwargs:
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auto_scale_configuration is not None and not isinstance(auto_scale_configuration, VirtualNetworkGatewayAutoScaleConfigurationArgs):
                auto_scale_configuration = auto_scale_configuration or {}
                def _setter(key, value):
                    auto_scale_configuration[key] = value
                VirtualNetworkGatewayAutoScaleConfigurationArgs._configure(_setter, **auto_scale_configuration)
            ...
            if gateway_default_site is not None and not isinstance(gateway_default_site, SubResourceArgs):
                gateway_default_site = gateway_default_site or {}
                def _setter(key, value):
                    gateway_default_site[key] = value
                SubResourceArgs._configure(_setter, **gateway_default_site)
            ...
            if sku is not None and not isinstance(sku, VirtualNetworkGatewaySkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                VirtualNetworkGatewaySkuArgs._configure(_setter, **sku)
            ...
            if vpn_client_configuration is not None and not isinstance(vpn_client_configuration, VpnClientConfigurationArgs):
                vpn_client_configuration = vpn_client_configuration or {}
                def _setter(key, value):
                    vpn_client_configuration[key] = value
                VpnClientConfigurationArgs._configure(_setter, **vpn_client_configuration)
