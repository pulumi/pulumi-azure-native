...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(auto_scale_configuration, VirtualNetworkGatewayAutoScaleConfigurationArgs):
            ...
            if not isinstance(gateway_default_site, SubResourceArgs):
            ...
            if not isinstance(sku, VirtualNetworkGatewaySkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
            ...
            if not isinstance(vpn_client_configuration, VpnClientConfigurationArgs):
