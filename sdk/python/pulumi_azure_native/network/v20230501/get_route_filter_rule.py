...
def get_route_filter_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230501:getRouteFilterRule', __args__, opts=opts, typ=GetRouteFilterRuleResult).value
...
def get_route_filter_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230501:getRouteFilterRule', __args__, opts=opts, typ=GetRouteFilterRuleResult)
