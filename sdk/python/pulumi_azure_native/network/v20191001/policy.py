...
class Policy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20191001:Policy"), pulumi.Alias(type_="azure-native:network:Policy"), pulumi.Alias(type_="azure-nextgen:network:Policy"), pulumi.Alias(type_="azure-native:network/latest:Policy"), pulumi.Alias(type_="azure-nextgen:network/latest:Policy"), pulumi.Alias(type_="azure-native:network/v20180801:Policy"), pulumi.Alias(type_="azure-nextgen:network/v20180801:Policy"), pulumi.Alias(type_="azure-native:network/v20190301:Policy"), pulumi.Alias(type_="azure-nextgen:network/v20190301:Policy"), pulumi.Alias(type_="azure-native:network/v20200401:Policy"), pulumi.Alias(type_="azure-nextgen:network/v20200401:Policy"), pulumi.Alias(type_="azure-native:network/v20201101:Policy"), pulumi.Alias(type_="azure-nextgen:network/v20201101:Policy")])
