...
warnings.warn("""azure-native:network/v20191001:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:Policy to guarantee forwards compatibility.""", DeprecationWarning)
...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Policy is deprecated: azure-native:network/v20191001:Policy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:Policy to guarantee forwards compatibility.""")
