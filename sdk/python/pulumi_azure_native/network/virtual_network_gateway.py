...
class VirtualNetworkGatewayInitArgs:
    def __init__(__self__, *,
                 ...
                 resiliency_model: Optional[pulumi.Input[Union[builtins.str, 'ResiliencyModel']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ResiliencyModel']] resiliency_model: Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
    ...
    def resiliency_model(self) -> Optional[pulumi.Input[Union[builtins.str, 'ResiliencyModel']]]:
        """
    ...
    def resiliency_model(self, value: Optional[pulumi.Input[Union[builtins.str, 'ResiliencyModel']]]):
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="resiliencyModel")
    def resiliency_model(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
        """
        return pulumi.get(self, "resiliency_model")
