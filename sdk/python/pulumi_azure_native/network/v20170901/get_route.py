...
def get_route(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: Version v20170901 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
