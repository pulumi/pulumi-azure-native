...
azure-native:network/v20170901:RecordSet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230701preview:RecordSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_record_set(record_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_record_set is deprecated: Version 2017-09-01 will be removed in v2 of the provider.
