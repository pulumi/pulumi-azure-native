...
warnings.warn("""azure-native:network/v20191201:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:LoadBalancer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_load_balancer(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_load_balancer is deprecated: azure-native:network/v20191201:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:LoadBalancer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['loadBalancerName'] = load_balancer_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20191201:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
