...
warnings.warn("""azure-native:network/v20191201:FirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.""", DeprecationWarning)
