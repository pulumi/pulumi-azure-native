...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_gateway is deprecated: azure-native:network/v20191201:NatGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NatGateway to guarantee forwards compatibility.""")
    __args__ = dict()
