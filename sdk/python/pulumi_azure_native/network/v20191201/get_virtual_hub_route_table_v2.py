...
def get_virtual_hub_route_table_v2(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_route_table_v2 is deprecated: azure-native:network/v20191201:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubRouteTableV2 to guarantee forwards compatibility.""")
    __args__ = dict()
