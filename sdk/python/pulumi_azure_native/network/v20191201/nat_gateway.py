...
warnings.warn("""azure-native:network/v20191201:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class NatGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NatGateway is deprecated: azure-native:network/v20191201:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NatGateway to guarantee forwards compatibility.""")
        ...
        super(NatGateway, __self__).__init__(
            'azure-native:network/v20191201:NatGateway',
            resource_name,
            __props__,
            opts)
