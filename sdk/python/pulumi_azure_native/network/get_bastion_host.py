...
def get_bastion_host(bastion_host_name: Optional[_builtins.str] = None,
...
def get_bastion_host_output(bastion_host_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
