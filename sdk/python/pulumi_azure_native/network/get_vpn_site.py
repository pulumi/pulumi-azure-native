...
def get_vpn_site(resource_group_name: Optional[_builtins.str] = None,
                 vpn_site_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the VpnSite.
    :param _builtins.str vpn_site_name: The name of the VpnSite being retrieved.
    """
    __args__ = dict()
...
def get_vpn_site_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                        vpn_site_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
