...
def get_p2s_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getP2sVpnGateway', __args__, opts=opts, typ=GetP2sVpnGatewayResult).value
...
def get_p2s_vpn_gateway_output(gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getP2sVpnGateway', __args__, opts=opts, typ=GetP2sVpnGatewayResult)
