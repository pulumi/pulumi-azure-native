...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
    ...
    return AwaitableGetPublicIPAddressResult(
        ...
        ip_configuration=pulumi.get(__ret__, 'ip_configuration'),
        ip_tags=pulumi.get(__ret__, 'ip_tags'),
        linked_public_ip_address=pulumi.get(__ret__, 'linked_public_ip_address'),
        location=pulumi.get(__ret__, 'location'),
        migration_phase=pulumi.get(__ret__, 'migration_phase'),
        ...
        public_ip_allocation_method=pulumi.get(__ret__, 'public_ip_allocation_method'),
        public_ip_prefix=pulumi.get(__ret__, 'public_ip_prefix'),
        resource_guid=pulumi.get(__ret__, 'resource_guid'),
        service_public_ip_address=pulumi.get(__ret__, 'service_public_ip_address'),
...
def get_public_ip_address_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult)
    return __ret__.apply(lambda __response__: GetPublicIPAddressResult(
        ...
        ip_configuration=pulumi.get(__response__, 'ip_configuration'),
        ip_tags=pulumi.get(__response__, 'ip_tags'),
        linked_public_ip_address=pulumi.get(__response__, 'linked_public_ip_address'),
        ...
        public_ip_address_version=pulumi.get(__response__, 'public_ip_address_version'),
        public_ip_allocation_method=pulumi.get(__response__, 'public_ip_allocation_method'),
        public_ip_prefix=pulumi.get(__response__, 'public_ip_prefix'),
        resource_guid=pulumi.get(__response__, 'resource_guid'),
        service_public_ip_address=pulumi.get(__response__, 'service_public_ip_address'),
