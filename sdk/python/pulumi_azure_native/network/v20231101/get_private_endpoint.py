...
def get_private_endpoint(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult).value
...
def get_private_endpoint_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult)
