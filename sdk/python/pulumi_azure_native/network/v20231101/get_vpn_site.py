...
def get_vpn_site(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getVpnSite', __args__, opts=opts, typ=GetVpnSiteResult).value
...
def get_vpn_site_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vpnSiteName'] = vpn_site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getVpnSite', __args__, opts=opts, typ=GetVpnSiteResult)
