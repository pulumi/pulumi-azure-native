...
def get_virtual_hub(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult).value
...
def get_virtual_hub_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualHubName'] = virtual_hub_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult)
