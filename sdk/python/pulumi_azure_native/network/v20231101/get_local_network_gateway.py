...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult).value
...
def get_local_network_gateway_output(local_network_gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult)
