...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20231101:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
...
def get_nat_gateway_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20231101:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult)
