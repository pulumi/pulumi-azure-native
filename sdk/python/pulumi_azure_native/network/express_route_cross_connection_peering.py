...
class ExpressRouteCrossConnectionPeeringArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if cross_connection_name is None and 'crossConnectionName' in kwargs:
            cross_connection_name = kwargs['crossConnectionName']
        if cross_connection_name is None:
            raise TypeError("Missing 'cross_connection_name' argument")
