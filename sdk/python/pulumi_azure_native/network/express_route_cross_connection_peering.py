...
class ExpressRouteCrossConnectionPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] shared_key: The shared key.
        :param pulumi.Input[Union[_builtins.str, 'ExpressRoutePeeringState']] state: The peering state.
