...
class VirtualNetworkGatewayInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualNetworkGatewayPropertiesFormatArgs'] properties: VirtualNetworkGateway properties
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[pulumi.InputType['VirtualNetworkGatewayPropertiesFormatArgs']] properties: VirtualNetworkGateway properties
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] virtual_network_gateway_name: The name of the virtual network gateway.
        """
