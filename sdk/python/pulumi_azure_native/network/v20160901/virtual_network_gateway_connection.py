...
class VirtualNetworkGatewayConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VirtualNetworkGatewayConnectionPropertiesFormatArgs'] properties: VirtualNetworkGatewayConnection properties
...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[pulumi.InputType['VirtualNetworkGatewayConnectionPropertiesFormatArgs']] properties: VirtualNetworkGatewayConnection properties
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] virtual_network_gateway_connection_name: The name of the virtual network gateway connection.
        """
