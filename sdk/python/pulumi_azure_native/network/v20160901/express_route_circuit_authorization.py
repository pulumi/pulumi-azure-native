...
azure-native:network/v20160901:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCircuitAuthorization is deprecated: Version 2016-09-01 will be removed in v2 of the provider.
azure-native:network/v20160901:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.""")
        ...
        super(ExpressRouteCircuitAuthorization, __self__).__init__(
            'azure-native:network/v20160901:ExpressRouteCircuitAuthorization',
            resource_name,
            __props__,
            opts)
