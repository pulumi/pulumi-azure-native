...
class SecurityUserConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description of the security user configuration.
        """
...
class SecurityUserConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20210501preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220401preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20240301:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20240501:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20240701:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20241001:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20250101:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20250301:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20250501:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20250701:SecurityUserConfiguration")])
