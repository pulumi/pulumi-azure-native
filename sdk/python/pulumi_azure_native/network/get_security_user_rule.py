...
def get_security_user_rule(configuration_name: Optional[_builtins.str] = None,
...
def get_security_user_rule_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
