...
def get_network_security_perimeter_logging_configuration(logging_configuration_name: Optional[builtins.str] = None,
...
def get_network_security_perimeter_logging_configuration_output(logging_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
