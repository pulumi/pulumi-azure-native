...
def get_network_security_perimeter_logging_configuration(logging_configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str logging_configuration_name: The name of the NSP logging configuration. Accepts 'instance' as name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getNetworkSecurityPerimeterLoggingConfiguration', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLoggingConfigurationResult).value
...
def get_network_security_perimeter_logging_configuration_output(logging_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getNetworkSecurityPerimeterLoggingConfiguration', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLoggingConfigurationResult)
