...
class CommitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] commit_name: The name of the commit.
        :param pulumi.Input['CommitPropertiesArgs'] properties: The Commit properties
        """
        pulumi.set(__self__, "network_manager_name", network_manager_name)
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        if commit_name is not None:
            pulumi.set(__self__, "commit_name", commit_name)
...
@pulumi.type_token("azure-native:network:Commit")
class Commit(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] commit_name: The name of the commit.
        :param pulumi.Input[_builtins.str] network_manager_name: The name of the network manager.
        :param pulumi.Input[Union['CommitPropertiesArgs', 'CommitPropertiesArgsDict']] properties: The Commit properties
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CommitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CommitArgs.__new__(CommitArgs)

            __props__.__dict__["commit_name"] = commit_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20250701:Commit")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Commit, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Commit':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return Commit(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CommitPropertiesResponse']:
        """
        The Commit properties
        """
        return pulumi.get(self, "properties")
