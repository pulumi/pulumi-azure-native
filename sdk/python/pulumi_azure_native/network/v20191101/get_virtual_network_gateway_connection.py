...
def get_virtual_network_gateway_connection(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_gateway_connection is deprecated: azure-native:network/v20191101:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayConnection to guarantee forwards compatibility.""")
    __args__ = dict()
