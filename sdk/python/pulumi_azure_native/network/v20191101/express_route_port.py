...
warnings.warn("""azure-native:network/v20191101:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.""", DeprecationWarning)
