...
warnings.warn("""azure-native:network/v20191101:FirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_firewall_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_policy is deprecated: azure-native:network/v20191101:FirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['firewallPolicyName'] = firewall_policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20191101:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult).value
