...
class Experiment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:Experiment"), pulumi.Alias(type_="azure-nextgen:network:Experiment"), pulumi.Alias(type_="azure-native:network/latest:Experiment"), pulumi.Alias(type_="azure-nextgen:network/latest:Experiment")])
    ...
    def get(resource_name: str,
        ...
        __props__["endpoint_a"] = None
        __props__["endpoint_b"] = None
