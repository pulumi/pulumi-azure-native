...
class ExperimentArgs:
    ...
    def _configure(
        ...
        if 'endpointA' in kwargs:
            endpoint_a = kwargs['endpointA']
        if 'endpointB' in kwargs:
...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if endpoint_a is not None and not isinstance(endpoint_a, ExperimentEndpointArgs):
            ...
            if endpoint_b is not None and not isinstance(endpoint_b, ExperimentEndpointArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:Experiment")])
