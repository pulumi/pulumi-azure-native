...
def get_network_security_perimeter_association(association_name: Optional[_builtins.str] = None,
...
def get_network_security_perimeter_association_output(association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
