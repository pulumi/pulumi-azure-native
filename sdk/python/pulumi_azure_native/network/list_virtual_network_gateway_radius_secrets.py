...
def list_virtual_network_gateway_radius_secrets(resource_group_name: Optional[builtins.str] = None,
...
def list_virtual_network_gateway_radius_secrets_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
