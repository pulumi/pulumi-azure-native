...
class SecurityConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:SecurityConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20210201preview:SecurityConfiguration")])
