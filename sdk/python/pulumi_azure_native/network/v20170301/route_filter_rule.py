...
class RouteFilterRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route_filter_rule = azure_native.network.v20170301.RouteFilterRule("routeFilterRule",
            access="Allow",
            communities=[
                "12076:5030",
                "12076:5040",
