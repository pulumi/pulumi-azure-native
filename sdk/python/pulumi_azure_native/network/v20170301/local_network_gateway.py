...
class LocalNetworkGatewayInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LocalNetworkGatewayPropertiesFormatArgs'] properties: LocalNetworkGateway properties
...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] local_network_gateway_name: The name of the local network gateway.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[pulumi.InputType['LocalNetworkGatewayPropertiesFormatArgs']] properties: LocalNetworkGateway properties
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
