...
azure-native:network/v20170301:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ApplicationGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_gateway(application_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_gateway is deprecated: Version 2017-03-01 will be removed in v2 of the provider.
azure-native:network/v20170301:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ApplicationGateway to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['applicationGatewayName'] = application_gateway_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170301:getApplicationGateway', __args__, opts=opts, typ=GetApplicationGatewayResult).value
