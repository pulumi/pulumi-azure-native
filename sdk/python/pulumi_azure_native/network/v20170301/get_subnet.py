...
azure-native:network/v20170301:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetSubnetResult:
    ...
    """
    def __init__(__self__, address_prefix=None, etag=None, id=None, ip_configurations=None, name=None, network_security_group=None, provisioning_state=None, resource_navigation_links=None, route_table=None):
...
def get_subnet(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subnet is deprecated: Version 2017-03-01 will be removed in v2 of the provider.
azure-native:network/v20170301:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170301:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
