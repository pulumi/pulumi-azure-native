...
azure-native:network/v20170301:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:RouteFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route_filter(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter is deprecated: Version 2017-03-01 will be removed in v2 of the provider.
