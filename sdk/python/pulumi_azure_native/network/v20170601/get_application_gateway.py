...
def get_application_gateway(application_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_gateway is deprecated: Version v20170601 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
