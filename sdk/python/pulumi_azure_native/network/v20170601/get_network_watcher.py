...
azure-native:network/v20170601:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:NetworkWatcher to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_watcher(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_watcher is deprecated: Version 2017-06-01 will be removed in v2 of the provider.
azure-native:network/v20170601:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180101:NetworkWatcher to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170601:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult).value
