...
azure-native:network/v20170601:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_gateway(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_gateway is deprecated: Version 2017-06-01 will be removed in v2 of the provider.
azure-native:network/v20170601:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:VirtualNetworkGateway to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170601:getVirtualNetworkGateway', __args__, opts=opts, typ=GetVirtualNetworkGatewayResult).value
