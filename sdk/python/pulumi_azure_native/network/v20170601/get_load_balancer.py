...
azure-native:network/v20170601:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180601:LoadBalancer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_load_balancer(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_load_balancer is deprecated: Version 2017-06-01 will be removed in v2 of the provider.
azure-native:network/v20170601:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20180601:LoadBalancer to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170601:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
