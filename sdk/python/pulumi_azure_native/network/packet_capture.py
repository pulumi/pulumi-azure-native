...
class PacketCaptureArgs:
    def __init__(__self__, *,
                 ...
                 time_limit_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 total_bytes_per_session: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a PacketCapture resource.
        :param pulumi.Input[builtins.str] network_watcher_name: The name of the network watcher.
        ...
        :param pulumi.Input[builtins.str] target: The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
        :param pulumi.Input[builtins.float] bytes_to_capture_per_packet: Number of bytes captured per packet, the remaining bytes are truncated.
        ...
        :param pulumi.Input[builtins.bool] continuous_capture: This continuous capture is a nullable boolean, which can hold 'null', 'true' or 'false' value. If we do not pass this parameter, it would be consider as 'null', default value is 'null'.
        :param pulumi.Input[Sequence[pulumi.Input['PacketCaptureFilterArgs']]] filters: A list of packet capture filters.
        :param pulumi.Input[builtins.str] packet_capture_name: The name of the packet capture session.
        ...
        :param pulumi.Input[builtins.int] time_limit_in_seconds: Maximum duration of the capture session in seconds.
        :param pulumi.Input[builtins.float] total_bytes_per_session: Maximum size of the capture output.
        """
    ...
    def network_watcher_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_watcher_name(self, value: pulumi.Input[builtins.str]):
    ...
    def bytes_to_capture_per_packet(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def bytes_to_capture_per_packet(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def continuous_capture(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def continuous_capture(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def packet_capture_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def packet_capture_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_limit_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def time_limit_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "time_limit_in_seconds", value)

    @property
    @pulumi.getter(name="totalBytesPerSession")
    def total_bytes_per_session(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def total_bytes_per_session(self, value: Optional[pulumi.Input[builtins.float]]):
...
class PacketCapture(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bytesToCapturePerPacket")
    def bytes_to_capture_per_packet(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Number of bytes captured per packet, the remaining bytes are truncated.
        """
        return pulumi.get(self, "bytes_to_capture_per_packet")
    ...
    @property
    @pulumi.getter(name="continuousCapture")
    def continuous_capture(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This continuous capture is a nullable boolean, which can hold 'null', 'true' or 'false' value. If we do not pass this parameter, it would be consider as 'null', default value is 'null'.
        """
        return pulumi.get(self, "continuous_capture")
    ...
    @property
    @pulumi.getter(name="timeLimitInSeconds")
    def time_limit_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum duration of the capture session in seconds.
        """
        return pulumi.get(self, "time_limit_in_seconds")
    ...
    @property
    @pulumi.getter(name="totalBytesPerSession")
    def total_bytes_per_session(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Maximum size of the capture output.
        """
        return pulumi.get(self, "total_bytes_per_session")
