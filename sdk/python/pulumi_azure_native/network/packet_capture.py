...
class PacketCapture(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(scope, PacketCaptureMachineScopeArgs):
                scope = scope or {}
                def _setter(key, value):
                    scope[key] = value
                PacketCaptureMachineScopeArgs._configure(_setter, **scope)
            __props__.__dict__["scope"] = scope
            if not isinstance(storage_location, PacketCaptureStorageLocationArgs):
