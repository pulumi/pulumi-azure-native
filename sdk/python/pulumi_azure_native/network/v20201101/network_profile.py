...
class NetworkProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_profile = azure_native.network.v20201101.NetworkProfile("networkProfile",
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:NetworkProfile networkProfile1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkProfiles/networkProfile1 
        ```
