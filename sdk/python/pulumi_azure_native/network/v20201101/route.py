...
class Route(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route = azure_native.network.v20201101.Route("route",
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:Route route1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/routeTables/testrt/routes/route1 
        ```
