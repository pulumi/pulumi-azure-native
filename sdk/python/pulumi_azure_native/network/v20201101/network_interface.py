...
class NetworkInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_interface = azure_native.network.v20201101.NetworkInterface("networkInterface",
            enable_accelerated_networking=True,
            ip_configurations=[azure_native.network.v20201101.NetworkInterfaceIPConfigurationArgs(
                name="ipconfig1",
                public_ip_address=azure_native.network.v20201101.PublicIPAddressArgs(
