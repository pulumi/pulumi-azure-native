...
warnings.warn("""azure-native:network/v20201101:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""", DeprecationWarning)
