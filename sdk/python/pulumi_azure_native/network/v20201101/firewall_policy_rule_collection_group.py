...
class FirewallPolicyRuleCollectionGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_policy_rule_collection_group = azure_native.network.v20201101.FirewallPolicyRuleCollectionGroup("firewallPolicyRuleCollectionGroup",
            firewall_policy_name="firewallPolicy",
            priority=100,
            resource_group_name="rg1",
            rule_collection_group_name="ruleCollectionGroup1",
            rule_collections=[azure_native.network.v20201101.FirewallPolicyNatRuleCollectionArgs(
                action=azure_native.network.v20201101.FirewallPolicyNatRuleCollectionActionArgs(
                    type="DNAT",
                ),
                name="Example-Nat-Rule-Collection",
                priority=100,
                rule_collection_type="FirewallPolicyNatRuleCollection",
                rules=[azure_native.network.v20201101.NatRuleArgs(
        ...
        firewall_policy_rule_collection_group = azure_native.network.v20201101.FirewallPolicyRuleCollectionGroup("firewallPolicyRuleCollectionGroup",
            ...
            resource_group_name="rg1",
            rule_collection_group_name="ruleCollectionGroup1",
            rule_collections=[azure_native.network.v20201101.FirewallPolicyFilterRuleCollectionArgs(
                action=azure_native.network.v20201101.FirewallPolicyFilterRuleCollectionActionArgs(
                    type="Deny",
                ),
                name="Example-Filter-Rule-Collection",
                priority=100,
                rule_collection_type="FirewallPolicyFilterRuleCollection",
                rules=[azure_native.network.v20201101.NetworkRuleArgs(
        ...
        firewall_policy_rule_collection_group = azure_native.network.v20201101.FirewallPolicyRuleCollectionGroup("firewallPolicyRuleCollectionGroup",
            ...
            rule_collections=[azure_native.network.v20201101.FirewallPolicyFilterRuleCollectionArgs(
                ...
                name="Example-Filter-Rule-Collection",
                rule_collection_type="FirewallPolicyFilterRuleCollection",
                rules=[azure_native.network.v20201101.ApplicationRuleArgs(
                    description="Deny inbound rule",
                    name="rule1",
                    protocols=[azure_native.network.v20201101.FirewallPolicyRuleApplicationProtocolArgs(
                        port=443,
                        protocol_type="Https",
                    )],
