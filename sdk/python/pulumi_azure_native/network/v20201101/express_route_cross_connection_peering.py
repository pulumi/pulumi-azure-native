...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_cross_connection_peering = azure_native.network.v20201101.ExpressRouteCrossConnectionPeering("expressRouteCrossConnectionPeering",
            cross_connection_name="<circuitServiceKey>",
            ipv6_peering_config=azure_native.network.v20201101.Ipv6ExpressRouteCircuitPeeringConfigArgs(
