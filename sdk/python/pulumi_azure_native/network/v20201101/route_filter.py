...
class RouteFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route_filter = azure_native.network.v20201101.RouteFilter("routeFilter",
            location="West US",
