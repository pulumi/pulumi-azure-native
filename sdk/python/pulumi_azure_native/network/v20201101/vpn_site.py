...
class VpnSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vpn_site = azure_native.network.v20201101.VpnSite("vpnSite",
            address_space=azure_native.network.v20201101.AddressSpaceArgs(
                address_prefixes=["10.0.0.0/16"],
            ),
            is_security_site=False,
            location="West US",
            o365_policy=azure_native.network.v20201101.O365PolicyPropertiesResponseArgs(
                break_out_categories=azure_native.network.v20201101.O365BreakOutCategoryPoliciesArgs(
                    allow=True,
                    default=False,
                    optimize=True,
                ),
            ...
            vpn_site_links=[{
                "bgpProperties": azure_native.network.v20201101.VpnLinkBgpSettingsArgs(
                    asn=1234,
                    bgp_peering_address="192.168.0.0",
                ),
                "fqdn": "link1.vpnsite1.contoso.com",
                "ipAddress": "50.50.50.56",
                "linkProperties": azure_native.network.v20201101.VpnLinkProviderPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        super(VpnSite, __self__).__init__(
            'azure-native:network/v20201101:VpnSite',
            resource_name,
            __props__,
            opts)
