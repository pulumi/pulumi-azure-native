...
class PrivateDnsZoneGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_dns_zone_group = azure_native.network.v20201101.PrivateDnsZoneGroup("privateDnsZoneGroup",
            private_dns_zone_configs=[azure_native.network.v20201101.PrivateDnsZoneConfigArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:PrivateDnsZoneGroup testPdnsgroup /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/privateLinkServices/testPe/privateDnsZoneGroups/testPdnsgroup 
        ```
