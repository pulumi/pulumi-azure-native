...
class ApplicationGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_gateway = azure_native.network.v20201101.ApplicationGateway("applicationGateway",
            application_gateway_name="appgw",
            backend_address_pools=[{
                "backendAddresses": [
                    azure_native.network.v20201101.ApplicationGatewayBackendAddressArgs(
                        ip_address="10.0.1.1",
                    ),
                    azure_native.network.v20201101.ApplicationGatewayBackendAddressArgs(
                        ip_address="10.0.1.2",
            ...
            backend_http_settings_collection=[azure_native.network.v20201101.ApplicationGatewayBackendHttpSettingsArgs(
            ...
            frontend_ports=[
                azure_native.network.v20201101.ApplicationGatewayFrontendPortArgs(
                    name="appgwfp",
                    port=443,
                ),
                azure_native.network.v20201101.ApplicationGatewayFrontendPortArgs(
            ...
            http_listeners=[
                {
                    ...
                    "frontendPort": azure_native.network.v20201101.SubResourceArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/frontendPorts/appgwfp",
                    ),
                    "name": "appgwhl",
                    "protocol": "Https",
                    "requireServerNameIndication": False,
                    "sslCertificate": azure_native.network.v20201101.SubResourceArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/sslCertificates/sslcert",
                    ),
                    "sslProfile": azure_native.network.v20201101.SubResourceArgs(
            ...
            identity=azure_native.network.v20201101.ManagedServiceIdentityArgs(
                type=azure_native.network/v20201101.ResourceIdentityType.USER_ASSIGNED,
            ...
            request_routing_rules=[
                {
                    ...
                    "backendHttpSettings": azure_native.network.v20201101.SubResourceArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendHttpSettingsCollection/appgwbhs",
                    ),
                    "httpListener": azure_native.network.v20201101.SubResourceArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/httpListeners/appgwhl",
                    ),
                    "name": "appgwrule",
                    "priority": 10,
                    "rewriteRuleSet": azure_native.network.v20201101.SubResourceArgs(
                ...
                },
                {
                    ...
                    "urlPathMap": azure_native.network.v20201101.SubResourceArgs(
            ...
            rewrite_rule_sets=[{
                ...
                "rewriteRules": [{
                    "actionSet": {
                        "requestHeaderConfigurations": [azure_native.network.v20201101.ApplicationGatewayHeaderConfigurationArgs(
                            header_name="X-Forwarded-For",
                            header_value="{var_add_x_forwarded_for_proxy}",
                        )],
                        "responseHeaderConfigurations": [azure_native.network.v20201101.ApplicationGatewayHeaderConfigurationArgs(
                            header_name="Strict-Transport-Security",
                            header_value="max-age=31536000",
                        )],
                        "urlConfiguration": azure_native.network.v20201101.ApplicationGatewayUrlConfigurationArgs(
                            modified_path="/abc",
                        ),
                    },
                    "conditions": [azure_native.network.v20201101.ApplicationGatewayRewriteRuleConditionArgs(
                        ignore_case=True,
                        negate=False,
                        pattern="^Bearer",
            ...
            sku=azure_native.network.v20201101.ApplicationGatewaySkuArgs(
                capacity=3,
                name="Standard_v2",
                tier="Standard_v2",
            ),
            ssl_certificates=[
                azure_native.network.v20201101.ApplicationGatewaySslCertificateArgs(
                    data="****",
                    name="sslcert",
                    password="****",
                ),
            ...
            ssl_profiles=[{
                "clientAuthConfiguration": azure_native.network.v20201101.ApplicationGatewayClientAuthConfigurationArgs(
                    verify_client_cert_issuer_dn=True,
                ),
                "name": "sslProfile1",
                "sslPolicy": azure_native.network.v20201101.ApplicationGatewaySslPolicyArgs(
                    cipher_suites=["TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"],
                    min_protocol_version="TLSv1_1",
                    policy_type="Custom",
                ),
                "trustedClientCertificates": [azure_native.network.v20201101.SubResourceArgs(
            ...
            trusted_client_certificates=[azure_native.network.v20201101.ApplicationGatewayTrustedClientCertificateArgs(
                data="****",
                name="clientcert",
            )],
            trusted_root_certificates=[
                azure_native.network.v20201101.ApplicationGatewayTrustedRootCertificateArgs(
                    data="****",
                    name="rootcert",
                ),
                azure_native.network.v20201101.ApplicationGatewayTrustedRootCertificateArgs(
            ...
            url_path_maps=[{
                "defaultBackendAddressPool": azure_native.network.v20201101.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool",
                ),
                "defaultBackendHttpSettings": azure_native.network.v20201101.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendHttpSettingsCollection/appgwbhs",
                ),
                "defaultRewriteRuleSet": azure_native.network.v20201101.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/rewriteRuleSets/rewriteRuleSet1",
                ),
                "name": "pathMap1",
                "pathRules": [{
