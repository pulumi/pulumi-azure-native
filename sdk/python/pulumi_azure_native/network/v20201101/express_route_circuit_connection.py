...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_circuit_connection = azure_native.network.v20201101.ExpressRouteCircuitConnection("expressRouteCircuitConnection",
            ...
            express_route_circuit_peering=azure_native.network.v20201101.SubResourceArgs(
            ...
            ipv6_circuit_connection_config=azure_native.network.v20201101.Ipv6CircuitConnectionConfigArgs(
                address_prefix="aa:bb::/125",
            ),
            peer_express_route_circuit_peering=azure_native.network.v20201101.SubResourceArgs(
