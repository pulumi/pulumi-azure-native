...
class NatGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        nat_gateway = azure_native.network.v20201101.NatGateway("natGateway",
            location="westus",
            nat_gateway_name="test-natgateway",
            public_ip_addresses=[azure_native.network.v20201101.SubResourceArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPAddresses/PublicIpAddress1",
            )],
            public_ip_prefixes=[azure_native.network.v20201101.SubResourceArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPPrefixes/PublicIpPrefix1",
            )],
            resource_group_name="rg1",
            sku=azure_native.network.v20201101.NatGatewaySkuArgs(
                name="Standard",
            ))
