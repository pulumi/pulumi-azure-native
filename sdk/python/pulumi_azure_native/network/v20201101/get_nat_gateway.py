...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_gateway is deprecated: azure-native:network/v20201101:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatGateway to guarantee forwards compatibility.""")
    __args__ = dict()
