...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_balancer = azure_native.network.v20201101.LoadBalancer("loadBalancer",
            backend_address_pools=[azure_native.network.v20201101.BackendAddressPoolArgs(
                name="be-lb",
            )],
            ...
            inbound_nat_rules=[{
                ...
                "frontendIPConfiguration": azure_native.network.v20201101.SubResourceArgs(
            ...
            load_balancing_rules=[{
                "backendAddressPool": azure_native.network.v20201101.SubResourceArgs(
                ...
                "name": "rulelb",
                "probe": azure_native.network.v20201101.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20201101.LoadBalancer("loadBalancer",
            ...
            resource_group_name="rg1",
            sku=azure_native.network.v20201101.LoadBalancerSkuArgs(
                name="Standard",
            ))
        ...
        load_balancer = azure_native.network.v20201101.LoadBalancer("loadBalancer",
            backend_address_pools=[{
                "loadBalancerBackendAddresses": [{
                    "loadBalancerFrontendIPConfiguration": azure_native.network.v20201101.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20201101.LoadBalancer("loadBalancer",
            ...
            frontend_ip_configurations=[{
                "name": "fe-lb",
                "publicIPAddress": azure_native.network.v20201101.PublicIPAddressArgs(
            ...
            outbound_rules=[{
                ...
                "frontendIPConfigurations": [azure_native.network.v20201101.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
                )],
                "name": "rule1",
                "protocol": "All",
