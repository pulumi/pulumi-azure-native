...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connection_monitor = azure_native.network.v20201101.ConnectionMonitor("connectionMonitor",
            ...
            test_configurations=[{
                "name": "tcp",
                "protocol": "Tcp",
                "tcpConfiguration": azure_native.network.v20201101.ConnectionMonitorTcpConfigurationArgs(
                    port=80,
                ),
                "testFrequencySec": 60,
            }],
        ...
        connection_monitor = azure_native.network.v20201101.ConnectionMonitor("connectionMonitor",
            ...
            endpoints=[
                ...
                {
                    "filter": {
                        "items": [azure_native.network.v20201101.ConnectionMonitorEndpointFilterItemArgs(
                            address="npmuser",
                            type="AgentAddress",
                        )],
                        "type": "Include",
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:ConnectionMonitor cm1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkWatchers/nw1/connectionMonitors/cm1 
        ```
