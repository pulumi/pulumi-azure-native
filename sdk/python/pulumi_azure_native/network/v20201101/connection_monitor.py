...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectionMonitorTestGroupArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectionMonitor is deprecated: azure-native:network/v20201101:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectionMonitor to guarantee forwards compatibility.""")
