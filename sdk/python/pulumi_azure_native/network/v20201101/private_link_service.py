...
class PrivateLinkService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_service = azure_native.network.v20201101.PrivateLinkService("privateLinkService",
            auto_approval=azure_native.network.v20201101.PrivateLinkServicePropertiesAutoApprovalArgs(
                subscriptions=[
                    "subscription1",
                    "subscription2",
                ],
            ...
            load_balancer_frontend_ip_configurations=[azure_native.network.v20201101.FrontendIPConfigurationArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
            )],
            location="eastus",
            resource_group_name="rg1",
            service_name="testPls",
            visibility=azure_native.network.v20201101.PrivateLinkServicePropertiesVisibilityArgs(
                subscriptions=[
                    "subscription1",
                    "subscription2",
                    "subscription3",
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:PrivateLinkService testPls /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/privateLinkServices/testPls 
        ```
