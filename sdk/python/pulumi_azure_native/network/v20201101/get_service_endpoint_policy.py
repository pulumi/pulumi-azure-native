...
def get_service_endpoint_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_endpoint_policy is deprecated: azure-native:network/v20201101:ServiceEndpointPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ServiceEndpointPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['serviceEndpointPolicyName'] = service_endpoint_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20201101:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult).value
