...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ddos_protection_plan = azure_native.network.v20201101.DdosProtectionPlan("ddosProtectionPlan",
