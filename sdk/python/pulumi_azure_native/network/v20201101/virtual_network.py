...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network = azure_native.network.v20201101.VirtualNetwork("virtualNetwork",
        ...
        virtual_network = azure_native.network.v20201101.VirtualNetwork("virtualNetwork",
            ...
            bgp_communities=azure_native.network.v20201101.VirtualNetworkBgpCommunitiesResponseArgs(
                virtual_network_community="12076:20000",
            ),
            location="eastus",
            resource_group_name="rg1",
            subnets=[azure_native.network.v20201101.SubnetArgs(
        ...
        virtual_network = azure_native.network.v20201101.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "delegations": [azure_native.network.v20201101.DelegationArgs(
                    name="myDelegation",
        ...
        virtual_network = azure_native.network.v20201101.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "name": "test-1",
                "serviceEndpoints": [azure_native.network.v20201101.ServiceEndpointPropertiesFormatArgs(
        ...
        virtual_network = azure_native.network.v20201101.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                "addressPrefix": "10.0.0.0/16",
                "name": "test-1",
                "serviceEndpointPolicies": [azure_native.network.v20201101.ServiceEndpointPolicyArgs(
