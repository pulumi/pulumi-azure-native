...
class DdosCustomPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ddos_custom_policy = azure_native.network.v20201101.DdosCustomPolicy("ddosCustomPolicy",
            ddos_custom_policy_name="test-ddos-custom-policy",
            location="centraluseuap",
            protocol_custom_settings=[azure_native.network.v20201101.ProtocolCustomSettingsFormatArgs(
                protocol="Tcp",
            )],
