...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        custom_ip_prefix = azure_native.network.v20201101.CustomIPPrefix("customIPPrefix",
            cidr="0.0.0.0/24",
