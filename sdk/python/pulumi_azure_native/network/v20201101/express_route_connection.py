...
class ExpressRouteConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_connection = azure_native.network.v20201101.ExpressRouteConnection("expressRouteConnection",
            authorization_key="authorizationKey",
            connection_name="connectionName",
            express_route_circuit_peering=azure_native.network.v20201101.ExpressRouteCircuitPeeringIdArgs(
