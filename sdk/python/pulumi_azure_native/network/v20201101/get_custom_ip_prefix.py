...
warnings.warn("""azure-native:network/v20201101:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_ip_prefix is deprecated: azure-native:network/v20201101:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:CustomIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['customIpPrefixName'] = custom_ip_prefix_name
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20201101:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult).value
