...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_hub_route_table_v2 = azure_native.network.v20201101.VirtualHubRouteTableV2("virtualHubRouteTableV2",
            attached_connections=["All_Vnets"],
            resource_group_name="rg1",
            route_table_name="virtualHubRouteTable1a",
            routes=[
                azure_native.network.v20201101.VirtualHubRouteV2Args(
