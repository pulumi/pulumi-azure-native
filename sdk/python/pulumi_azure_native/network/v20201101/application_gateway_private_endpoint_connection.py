...
class ApplicationGatewayPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_gateway_private_endpoint_connection = azure_native.network.v20201101.ApplicationGatewayPrivateEndpointConnection("applicationGatewayPrivateEndpointConnection",
