...
warnings.warn("""azure-native:network/v20201101:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_dscp_configuration(dscp_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dscp_configuration is deprecated: azure-native:network/v20201101:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dscpConfigurationName'] = dscp_configuration_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20201101:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult).value
