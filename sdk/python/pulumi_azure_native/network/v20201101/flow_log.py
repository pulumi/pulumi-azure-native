...
class FlowLog(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        flow_log = azure_native.network.v20201101.FlowLog("flowLog",
            enabled=True,
            flow_log_name="fl",
            format=azure_native.network.v20201101.FlowLogFormatParametersArgs(
                type="JSON",
                version=1,
            ),
