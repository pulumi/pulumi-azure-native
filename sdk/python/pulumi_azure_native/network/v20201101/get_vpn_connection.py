...
warnings.warn("""azure-native:network/v20201101:VpnConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vpn_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_connection is deprecated: azure-native:network/v20201101:VpnConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['connectionName'] = connection_name
    __args__['gatewayName'] = gateway_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20201101:getVpnConnection', __args__, opts=opts, typ=GetVpnConnectionResult).value
