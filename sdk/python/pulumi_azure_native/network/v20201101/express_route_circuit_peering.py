...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_circuit_peering = azure_native.network.v20201101.ExpressRouteCircuitPeering("expressRouteCircuitPeering",
        ...
        ```sh
        $ pulumi import azure-native:network/v20201101:ExpressRouteCircuitPeering AzurePrivatePeering /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/expressRouteCircuits/circuitName/peerings/AzurePrivatePeering 
        ```
