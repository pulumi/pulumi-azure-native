...
class HubVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hub_virtual_network_connection = azure_native.network.v20201101.HubVirtualNetworkConnection("hubVirtualNetworkConnection",
            ...
            routing_configuration=azure_native.network.v20201101.RoutingConfigurationResponseArgs(
                associated_route_table=azure_native.network.v20201101.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1",
                ),
                propagated_route_tables={
                    "ids": [azure_native.network.v20201101.SubResourceArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1",
                    )],
                    "labels": [
                        "label1",
                ...
                vnet_routes={
                    "staticRoutes": [
                        azure_native.network.v20201101.StaticRouteArgs(
                            address_prefixes=[
                                "10.1.0.0/16",
                                "10.2.0.0/16",
                            ],
