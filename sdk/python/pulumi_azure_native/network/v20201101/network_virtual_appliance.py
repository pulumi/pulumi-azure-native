...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_virtual_appliance = azure_native.network.v20201101.NetworkVirtualAppliance("networkVirtualAppliance",
            ...
            nva_sku=azure_native.network.v20201101.VirtualApplianceSkuPropertiesArgs(
