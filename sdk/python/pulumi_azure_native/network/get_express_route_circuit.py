...
class GetExpressRouteCircuitResult:
    ...
    def allow_classic_operations(self) -> Optional[builtins.bool]:
        """
    ...
    def authorization_status(self) -> builtins.str:
        """
    ...
    def bandwidth_in_gbps(self) -> Optional[builtins.float]:
        """
    ...
    def circuit_provisioning_state(self) -> Optional[builtins.str]:
        """
    ...
    def enable_direct_port_rate_limit(self) -> Optional[builtins.bool]:
        """
    ...
    def global_reach_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def service_provider_notes(self) -> Optional[builtins.str]:
        """
    ...
    def service_provider_provisioning_state(self) -> Optional[builtins.str]:
        """
...
def get_express_route_circuit(circuit_name: Optional[builtins.str] = None,
    ...
    :param builtins.str circuit_name: The name of express route circuit.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getExpressRouteCircuit', __args__, opts=opts, typ=GetExpressRouteCircuitResult).value
...
def get_express_route_circuit_output(circuit_name: Optional[pulumi.Input[builtins.str]] = None,
