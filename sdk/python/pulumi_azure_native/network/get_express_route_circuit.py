...
def get_express_route_circuit(circuit_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str circuit_name: The name of express route circuit.
...
def get_express_route_circuit_output(circuit_name: pulumi.Input[Optional[_builtins.str]] = None,
