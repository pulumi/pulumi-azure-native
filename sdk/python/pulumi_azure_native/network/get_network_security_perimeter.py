...
def get_network_security_perimeter(network_security_perimeter_name: Optional[_builtins.str] = None,
...
def get_network_security_perimeter_output(network_security_perimeter_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
