...
class NspAssociationsProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NspAssociationsProxy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NspAssociationsProxy, __self__).__init__(
            'azure-native:network:NspAssociationsProxy',
            resource_name,
            __props__,
            opts)
