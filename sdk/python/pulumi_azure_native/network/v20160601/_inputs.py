...
class ApplicationGatewayAuthenticationCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: Provisioning state of the authentication certificate resource Updating/Deleting/Failed
        """
        if data is not None:
...
class ApplicationGatewayBackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkInterfaceIPConfigurationArgs']]] backend_ip_configurations: Collection of references to IPs defined in NICs
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[str] provisioning_state: Provisioning state of the backend address pool resource Updating/Deleting/Failed
        """
...
class ApplicationGatewayBackendAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] fqdn: Dns name
...
class ApplicationGatewayBackendHttpSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'ApplicationGatewayCookieBasedAffinity']] cookie_based_affinity: Cookie affinity
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[int] port: Port
        :param pulumi.Input['SubResourceArgs'] probe: Probe resource of application gateway 
        :param pulumi.Input[Union[str, 'ApplicationGatewayProtocol']] protocol: Protocol
        :param pulumi.Input[str] provisioning_state: Provisioning state of the backend http settings resource Updating/Deleting/Failed
...
class ApplicationGatewayFrontendIPConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'IPAllocationMethod']] private_ip_allocation_method: PrivateIP allocation method (Static/Dynamic)
...
class ApplicationGatewayFrontendPortArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: Provisioning state of the frontend port resource Updating/Deleting/Failed
        """
        if etag is not None:
            pulumi.set(__self__, "etag", etag)
        if id is not None:
...
class ApplicationGatewayHttpListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input['SubResourceArgs'] frontend_ip_configuration: Frontend IP configuration resource of application gateway 
        :param pulumi.Input['SubResourceArgs'] frontend_port: Frontend port resource of application gateway 
        :param pulumi.Input[str] host_name: Host name of http listener 
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[Union[str, 'ApplicationGatewayProtocol']] protocol: Protocol
        :param pulumi.Input[str] provisioning_state: Provisioning state of the http listener resource Updating/Deleting/Failed
        :param pulumi.Input[bool] require_server_name_indication: RequireServerNameIndication of http listener 
        :param pulumi.Input['SubResourceArgs'] ssl_certificate: Ssl certificate resource of application gateway 
        """
        if etag is not None:
            pulumi.set(__self__, "etag", etag)
...
class ApplicationGatewayIPConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[str] provisioning_state: Provisioning state of the application gateway subnet resource Updating/Deleting/Failed
...
class ApplicationGatewayPathRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: Path rule of URL path map resource Updating/Deleting/Failed
        """
...
class ApplicationGatewayProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] host: Host to send probe to 
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[int] interval: Probing interval in seconds 
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[str] path: Relative path of probe 
        :param pulumi.Input[Union[str, 'ApplicationGatewayProtocol']] protocol: Protocol
        :param pulumi.Input[str] provisioning_state: Provisioning state of the backend http settings resource Updating/Deleting/Failed
        :param pulumi.Input[int] timeout: Probing timeout in seconds 
        :param pulumi.Input[int] unhealthy_threshold: Probing unhealthy threshold 
        """
        if etag is not None:
            pulumi.set(__self__, "etag", etag)
        if host is not None:
...
class ApplicationGatewayRequestRoutingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SubResourceArgs'] backend_address_pool: Backend address pool resource of application gateway 
        :param pulumi.Input['SubResourceArgs'] backend_http_settings: Frontend port resource of application gateway 
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input['SubResourceArgs'] http_listener: Http listener resource of application gateway 
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[str] provisioning_state: Provisioning state of the request routing rule resource Updating/Deleting/Failed
        :param pulumi.Input[Union[str, 'ApplicationGatewayRequestRoutingRuleType']] rule_type: Rule type
        :param pulumi.Input['SubResourceArgs'] url_path_map: Url path map resource of application gateway 
        """
        if backend_address_pool is not None:
            pulumi.set(__self__, "backend_address_pool", backend_address_pool)
        if backend_http_settings is not None:
...
class ApplicationGatewaySkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] capacity: Capacity (instance count) of application gateway
        :param pulumi.Input[Union[str, 'ApplicationGatewaySkuName']] name: Name of application gateway SKU
        :param pulumi.Input[Union[str, 'ApplicationGatewayTier']] tier: Tier of application gateway
        """
...
class ApplicationGatewaySslCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] data: SSL Certificate data 
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[str] password: SSL Certificate password 
        :param pulumi.Input[str] provisioning_state: Provisioning state of the ssl certificate resource Updating/Deleting/Failed
        :param pulumi.Input[str] public_cert_data: SSL Certificate public data 
        """
        if data is not None:
            pulumi.set(__self__, "data", data)
        if etag is not None:
...
class BackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] provisioning_state: Get provisioning state of the PublicIP resource Updating/Deleting/Failed
        """
        if etag is not None:
            pulumi.set(__self__, "etag", etag)
        if id is not None:
...
class InboundNatPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'TransportProtocol']] protocol: Gets or sets the transport protocol for the endpoint. Possible values are Udp or Tcp
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
...
class NetworkSecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SecurityRuleArgs']]] default_security_rules: Gets or default security rules of network security group
        :param pulumi.Input[str] etag: Gets a unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[str] provisioning_state: Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Gets or sets the name of the resource that is unique within a resource group. This name can be used to access the resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ResourceNavigationLinkArgs']]] resource_navigation_links: Gets array of references to the external resources using subnet
...
class VirtualNetworkPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] allow_forwarded_traffic: Gets or sets whether the forwarded traffic from the VMs in the remote virtual network will be allowed/disallowed
        :param pulumi.Input[bool] allow_gateway_transit: Gets or sets if gatewayLinks can be used in remote virtual network’s link to this virtual network
        :param pulumi.Input[bool] allow_virtual_network_access: Gets or sets whether the VMs in the linked virtual network space would be able to access all the VMs in local Virtual network space
        :param pulumi.Input[str] etag: A unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] name: Gets or sets the name of the resource that is unique within a resource group. This name can be used to access the resource
        :param pulumi.Input[Union[str, 'VirtualNetworkPeeringState']] peering_state: Gets the status of the virtual network peering
        :param pulumi.Input[str] provisioning_state: Gets provisioning state of the resource
        :param pulumi.Input['SubResourceArgs'] remote_virtual_network: Gets or sets the reference of the remote virtual network
        :param pulumi.Input[bool] use_remote_gateways: Gets or sets if remote gateways can be used on this virtual network. If the flag is set to true, and allowGatewayTransit on remote peering is also true, virtual network will use gateways of remote virtual network for transit. Only 1 peering can have this flag set to true. This flag cannot be set if virtual network already has a gateway.
        """
