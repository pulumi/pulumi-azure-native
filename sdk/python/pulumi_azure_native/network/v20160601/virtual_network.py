...
class VirtualNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AddressSpaceArgs'] address_space: Gets or sets AddressSpace that contains an array of IP address ranges that can be used by subnets
        :param pulumi.Input['DhcpOptionsArgs'] dhcp_options: Gets or sets DHCPOptions that contains an array of DNS servers available to VMs deployed in the virtual network
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SubnetArgs']]] subnets: Gets or sets list of subnets in a VirtualNetwork
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags
        :param pulumi.Input[str] virtual_network_name: The name of the virtual network.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualNetworkPeeringArgs']]] virtual_network_peerings: Gets or sets list of peerings in a VirtualNetwork
        """
...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['AddressSpaceArgs']] address_space: Gets or sets AddressSpace that contains an array of IP address ranges that can be used by subnets
        :param pulumi.Input[pulumi.InputType['DhcpOptionsArgs']] dhcp_options: Gets or sets DHCPOptions that contains an array of DNS servers available to VMs deployed in the virtual network
        :param pulumi.Input[str] etag: Gets a unique read-only string that changes whenever the resource is updated
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[str] provisioning_state: Gets provisioning state of the PublicIP resource Updating/Deleting/Failed
