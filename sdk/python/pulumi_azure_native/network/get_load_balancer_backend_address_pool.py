...
def get_load_balancer_backend_address_pool(backend_address_pool_name: Optional[_builtins.str] = None,
...
def get_load_balancer_backend_address_pool_output(backend_address_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
