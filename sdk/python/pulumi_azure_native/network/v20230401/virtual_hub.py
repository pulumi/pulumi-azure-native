...
class VirtualHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(azure_firewall, SubResourceArgs):
            ...
            if not isinstance(express_route_gateway, SubResourceArgs):
            ...
            if not isinstance(p2_s_vpn_gateway, SubResourceArgs):
            ...
            if not isinstance(route_table, VirtualHubRouteTableArgs):
            ...
            if not isinstance(security_partner_provider, SubResourceArgs):
            ...
            if not isinstance(virtual_router_auto_scale_configuration, VirtualRouterAutoScaleConfigurationArgs):
            ...
            if not isinstance(vpn_gateway, SubResourceArgs):
