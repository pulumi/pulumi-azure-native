...
class VirtualHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 virtual_router_asn: Optional[pulumi.Input[float]] = None,
                 virtual_router_auto_scale_configuration: Optional[pulumi.Input[Union['VirtualRouterAutoScaleConfigurationArgs', 'VirtualRouterAutoScaleConfigurationArgsDict']]] = None,
                 virtual_router_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['VirtualHubRouteTableV2Args', 'VirtualHubRouteTableV2ArgsDict']]]] virtual_hub_route_table_v2s: List of all virtual hub route table v2s associated with this VirtualHub.
               These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
        :param pulumi.Input[float] virtual_router_asn: VirtualRouter ASN.
        :param pulumi.Input[Union['VirtualRouterAutoScaleConfigurationArgs', 'VirtualRouterAutoScaleConfigurationArgsDict']] virtual_router_auto_scale_configuration: The VirtualHub Router autoscale configuration.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] virtual_router_ips: VirtualRouter IPs.
