...
def get_hub_route_table(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230401:getHubRouteTable', __args__, opts=opts, typ=GetHubRouteTableResult).value
...
def get_hub_route_table_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualHubName'] = virtual_hub_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230401:getHubRouteTable', __args__, opts=opts, typ=GetHubRouteTableResult)
