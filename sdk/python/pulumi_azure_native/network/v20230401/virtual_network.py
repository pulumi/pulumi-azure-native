...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(bgp_communities, VirtualNetworkBgpCommunitiesArgs):
            ...
            if not isinstance(ddos_protection_plan, SubResourceArgs):
            ...
            if not isinstance(dhcp_options, DhcpOptionsArgs):
            ...
            if not isinstance(encryption, VirtualNetworkEncryptionArgs):
