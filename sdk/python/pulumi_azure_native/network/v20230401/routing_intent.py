...
class RoutingIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20210801:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220701:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220901:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20221101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230201:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230501:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230601:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20230901:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20231101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240301:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20240501:RoutingIntent"), pulumi.Alias(type_="azure-native:network:RoutingIntent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoutingIntent, __self__).__init__(
            'azure-native:network/v20230401:RoutingIntent',
            resource_name,
            __props__,
            opts)
