...
class NetworkVirtualApplianceConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkVirtualApplianceConnection"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkVirtualApplianceConnection"), pulumi.Alias(type_="azure-native:network/v20230201:NetworkVirtualApplianceConnection")])
