...
class FirewallPolicyRuleCollectionGroupArgs:
    ...
    def _configure(
        ...
        if 'ruleCollectionGroupName' in kwargs:
            rule_collection_group_name = kwargs['ruleCollectionGroupName']
        if 'ruleCollections' in kwargs:
