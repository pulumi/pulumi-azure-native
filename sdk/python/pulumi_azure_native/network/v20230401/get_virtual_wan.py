...
def get_virtual_wan(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230401:getVirtualWan', __args__, opts=opts, typ=GetVirtualWanResult).value
...
def get_virtual_wan_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualWANName'] = virtual_wan_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230401:getVirtualWan', __args__, opts=opts, typ=GetVirtualWanResult)
