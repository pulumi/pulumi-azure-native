...
def get_virtual_router_peering(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230401:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult).value
...
def get_virtual_router_peering_output(peering_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualRouterName'] = virtual_router_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230401:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult)
