...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(ipv6_peering_config, Ipv6ExpressRouteCircuitPeeringConfigArgs):
            ...
            if not isinstance(microsoft_peering_config, ExpressRouteCircuitPeeringConfigArgs):
            ...
            if not isinstance(route_filter, SubResourceArgs):
            ...
            if not isinstance(stats, ExpressRouteCircuitStatsArgs):
                stats = stats or {}
                def _setter(key, value):
                    stats[key] = value
