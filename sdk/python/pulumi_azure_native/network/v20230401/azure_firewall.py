...
class AzureFirewall(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(hub_ip_addresses, HubIPAddressesArgs):
            ...
            if not isinstance(management_ip_configuration, AzureFirewallIPConfigurationArgs):
            ...
            if not isinstance(sku, AzureFirewallSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
