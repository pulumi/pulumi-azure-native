...
class AzureFirewallArgs:
    ...
    def _configure(
        ...
        if hub_ip_addresses is None and 'hubIPAddresses' in kwargs:
...
class AzureFirewall(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            hub_ip_addresses = _utilities.configure(hub_ip_addresses, HubIPAddressesArgs, True)
            __props__.__dict__["hub_ip_addresses"] = hub_ip_addresses
            __props__.__dict__["id"] = id
            __props__.__dict__["ip_configurations"] = ip_configurations
            __props__.__dict__["location"] = location
            management_ip_configuration = _utilities.configure(management_ip_configuration, AzureFirewallIPConfigurationArgs, True)
            ...
            sku = _utilities.configure(sku, AzureFirewallSkuArgs, True)
