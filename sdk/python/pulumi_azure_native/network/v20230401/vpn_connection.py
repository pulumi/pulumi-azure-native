...
class VpnConnectionInitArgs:
    ...
    def _configure(
        ...
        if 'connectionBandwidth' in kwargs:
        ...
        if 'enableRateLimiting' in kwargs:
        ...
        if 'vpnConnectionProtocolType' in kwargs:
            vpn_connection_protocol_type = kwargs['vpnConnectionProtocolType']
        if 'vpnLinkConnections' in kwargs:
...
class VpnConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if remote_vpn_site is not None and not isinstance(remote_vpn_site, SubResourceArgs):
                remote_vpn_site = remote_vpn_site or {}
                def _setter(key, value):
                    remote_vpn_site[key] = value
                SubResourceArgs._configure(_setter, **remote_vpn_site)
