...
class ExpressRoutePortAuthorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20210801:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20220101:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20220501:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20220701:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20220901:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20221101:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20230201:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20230501:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20230601:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20230901:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20231101:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20240101:ExpressRoutePortAuthorization"), pulumi.Alias(type_="azure-native:network/v20240301:ExpressRoutePortAuthorization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExpressRoutePortAuthorization, __self__).__init__(
            'azure-native:network/v20230401:ExpressRoutePortAuthorization',
            resource_name,
            __props__,
            opts)
