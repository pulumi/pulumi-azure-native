...
class NetworkInterfaceTapConfigurationArgs:
    ...
    def _configure(
        ...
        if tap_configuration_name is None and 'tapConfigurationName' in kwargs:
            tap_configuration_name = kwargs['tapConfigurationName']
