...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[str] tap_configuration_name: The name of the tap configuration.
        :param pulumi.Input[Union['VirtualNetworkTapArgs', 'VirtualNetworkTapArgsDict']] virtual_network_tap: The reference to the Virtual Network Tap resource.
        """
        ...
    @overload
    def __init__(__self__,
