...
class IpAllocationArgs:
    ...
    def _configure(
        ...
        if allocation_tags is None and 'allocationTags' in kwargs:
            allocation_tags = kwargs['allocationTags']
        if ip_allocation_name is None and 'ipAllocationName' in kwargs:
            ip_allocation_name = kwargs['ipAllocationName']
        if ipam_allocation_id is None and 'ipamAllocationId' in kwargs:
