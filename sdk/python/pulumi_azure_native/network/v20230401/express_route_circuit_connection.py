...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(express_route_circuit_peering, SubResourceArgs):
            ...
            if not isinstance(ipv6_circuit_connection_config, Ipv6CircuitConnectionConfigArgs):
            ...
            if not isinstance(peer_express_route_circuit_peering, SubResourceArgs):
