...
def get_virtual_network_gateway_bgp_peer_status(peer: Optional[_builtins.str] = None,
    ...
    :param _builtins.str peer: The IP address of the peer to retrieve the status of.
