...
def get_virtual_network_gateway_bgp_peer_status(peer: Optional[builtins.str] = None,
    ...
    :param builtins.str peer: The IP address of the peer to retrieve the status of.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getVirtualNetworkGatewayBgpPeerStatus', __args__, opts=opts, typ=GetVirtualNetworkGatewayBgpPeerStatusResult).value

    return AwaitableGetVirtualNetworkGatewayBgpPeerStatusResult(
        value=pulumi.get(__ret__, 'value'))
def get_virtual_network_gateway_bgp_peer_status_output(peer: Optional[pulumi.Input[Optional[builtins.str]]] = None,
