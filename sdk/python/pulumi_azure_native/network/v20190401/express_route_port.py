...
warnings.warn("""azure-native:network/v20190401:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:ExpressRoutePort to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRoutePort(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRoutePort is deprecated: azure-native:network/v20190401:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:ExpressRoutePort to guarantee forwards compatibility.""")
