...
class VirtualHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_gateway: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualHub is deprecated: azure-native:network/v20190401:VirtualHub is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:VirtualHub to guarantee forwards compatibility.""")
