...
warnings.warn("""azure-native:network/v20190401:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:NatGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_gateway is deprecated: azure-native:network/v20190401:NatGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:NatGateway to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['natGatewayName'] = nat_gateway_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190401:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
