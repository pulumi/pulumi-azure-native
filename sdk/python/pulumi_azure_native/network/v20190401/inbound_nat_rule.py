...
class InboundNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""InboundNatRule is deprecated: azure-native:network/v20190401:InboundNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.""")
