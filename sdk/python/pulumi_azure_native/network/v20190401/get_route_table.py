...
def get_route_table(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_table is deprecated: azure-native:network/v20190401:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:RouteTable to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['routeTableName'] = route_table_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190401:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
