...
def get_front_door(front_door_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_front_door is deprecated: azure-native:network/v20190401:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.""")
    __args__ = dict()
