...
warnings.warn("""azure-native:network/v20180901:VirtualNetworkLink is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401preview:VirtualNetworkLink to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_link(private_zone_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_link is deprecated: azure-native:network/v20180901:VirtualNetworkLink is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401preview:VirtualNetworkLink to guarantee forwards compatibility.""")
    __args__ = dict()
