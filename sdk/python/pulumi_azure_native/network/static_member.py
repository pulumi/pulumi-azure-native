...
class StaticMemberArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if network_group_name is None and 'networkGroupName' in kwargs:
            network_group_name = kwargs['networkGroupName']
        if network_group_name is None:
            raise TypeError("Missing 'network_group_name' argument")
        ...
        if static_member_name is None and 'staticMemberName' in kwargs:
