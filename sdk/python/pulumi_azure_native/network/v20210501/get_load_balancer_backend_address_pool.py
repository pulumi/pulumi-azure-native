...
warnings.warn("""azure-native:network/v20210501:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LoadBalancerBackendAddressPool to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetLoadBalancerBackendAddressPoolResult:
    ...
    """
    def __init__(__self__, backend_ip_configurations=None, etag=None, id=None, inbound_nat_rules=None, load_balancer_backend_addresses=None, load_balancing_rules=None, location=None, name=None, outbound_rule=None, outbound_rules=None, provisioning_state=None, tunnel_interfaces=None, type=None):
...
def get_load_balancer_backend_address_pool(backend_address_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_load_balancer_backend_address_pool is deprecated: azure-native:network/v20210501:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LoadBalancerBackendAddressPool to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501:getLoadBalancerBackendAddressPool', __args__, opts=opts, typ=GetLoadBalancerBackendAddressPoolResult).value
