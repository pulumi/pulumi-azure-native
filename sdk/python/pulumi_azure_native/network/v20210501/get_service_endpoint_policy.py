...
def get_service_endpoint_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_endpoint_policy is deprecated: azure-native:network/v20210501:ServiceEndpointPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ServiceEndpointPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
