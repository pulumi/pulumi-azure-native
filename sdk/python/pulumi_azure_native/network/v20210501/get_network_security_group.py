...
warnings.warn("""azure-native:network/v20210501:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_security_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_security_group is deprecated: azure-native:network/v20210501:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['networkSecurityGroupName'] = network_security_group_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501:getNetworkSecurityGroup', __args__, opts=opts, typ=GetNetworkSecurityGroupResult).value
