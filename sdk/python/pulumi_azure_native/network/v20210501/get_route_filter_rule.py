...
def get_route_filter_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter_rule is deprecated: azure-native:network/v20210501:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilterRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['routeFilterName'] = route_filter_name
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501:getRouteFilterRule', __args__, opts=opts, typ=GetRouteFilterRuleResult).value
