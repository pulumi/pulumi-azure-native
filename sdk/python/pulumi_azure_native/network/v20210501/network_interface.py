...
warnings.warn("""azure-native:network/v20210501:NetworkInterface is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(NetworkInterface, __self__).__init__(
            'azure-native:network/v20210501:NetworkInterface',
            resource_name,
            __props__,
            opts)
