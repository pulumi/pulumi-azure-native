...
warnings.warn("""azure-native:network/v20210501:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubRouteTableV2 to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualHubRouteTableV2, __self__).__init__(
            'azure-native:network/v20210501:VirtualHubRouteTableV2',
            resource_name,
            __props__,
            opts)
