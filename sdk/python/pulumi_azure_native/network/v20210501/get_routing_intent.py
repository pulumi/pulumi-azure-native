...
def get_routing_intent(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_routing_intent is deprecated: azure-native:network/v20210501:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RoutingIntent to guarantee forwards compatibility.""")
    __args__ = dict()
