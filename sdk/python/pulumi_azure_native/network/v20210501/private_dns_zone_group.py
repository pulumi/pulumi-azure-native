...
warnings.warn("""azure-native:network/v20210501:PrivateDnsZoneGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PrivateDnsZoneGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateDnsZoneGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateDnsZoneGroup is deprecated: azure-native:network/v20210501:PrivateDnsZoneGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PrivateDnsZoneGroup to guarantee forwards compatibility.""")
