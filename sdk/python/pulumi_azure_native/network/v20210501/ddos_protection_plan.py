...
warnings.warn("""azure-native:network/v20210501:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DdosProtectionPlan is deprecated: azure-native:network/v20210501:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""")
