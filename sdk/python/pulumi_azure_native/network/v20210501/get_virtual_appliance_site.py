...
def get_virtual_appliance_site(network_virtual_appliance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_appliance_site is deprecated: azure-native:network/v20210501:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkVirtualApplianceName'] = network_virtual_appliance_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501:getVirtualApplianceSite', __args__, opts=opts, typ=GetVirtualApplianceSiteResult).value
