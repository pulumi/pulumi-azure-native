...
warnings.warn("""azure-native:network/v20210501:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualApplianceSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualApplianceSite, __self__).__init__(
            'azure-native:network/v20210501:VirtualApplianceSite',
            resource_name,
            __props__,
            opts)
