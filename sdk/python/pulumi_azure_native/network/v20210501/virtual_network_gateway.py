...
warnings.warn("""azure-native:network/v20210501:VirtualNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualNetworkGateway, __self__).__init__(
            'azure-native:network/v20210501:VirtualNetworkGateway',
            resource_name,
            __props__,
            opts)
