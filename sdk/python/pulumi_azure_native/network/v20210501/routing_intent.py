...
class RoutingIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20210801:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220101:RoutingIntent"), pulumi.Alias(type_="azure-native:network/v20220501:RoutingIntent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoutingIntent, __self__).__init__(
            'azure-native:network/v20210501:RoutingIntent',
            resource_name,
            __props__,
            opts)
