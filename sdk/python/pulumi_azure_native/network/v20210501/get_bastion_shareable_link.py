...
def get_bastion_shareable_link(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501:getBastionShareableLink', __args__, opts=opts, typ=GetBastionShareableLinkResult).value
...
def get_bastion_shareable_link_output(bastion_host_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210501:getBastionShareableLink', __args__, opts=opts, typ=GetBastionShareableLinkResult)
