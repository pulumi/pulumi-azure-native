...
warnings.warn("""azure-native:network/v20210501:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualHubBgpConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualHubBgpConnection is deprecated: azure-native:network/v20210501:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20200501:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20200601:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20200701:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20200801:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20201101:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20210201:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20210301:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20210801:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20220101:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20220501:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20220701:VirtualHubBgpConnection"), pulumi.Alias(type_="azure-native:network/v20220901:VirtualHubBgpConnection")])
