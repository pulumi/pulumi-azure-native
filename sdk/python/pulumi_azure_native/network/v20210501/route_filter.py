...
warnings.warn("""azure-native:network/v20210501:RouteFilter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
class RouteFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(RouteFilter, __self__).__init__(
            'azure-native:network/v20210501:RouteFilter',
            resource_name,
            __props__,
            opts)
