...
class VirtualNetworkGatewayNatRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource_group_name: The resource group name of the Virtual Network Gateway.
        :param pulumi.Input[str] virtual_network_gateway_name: The name of the gateway.
    ...
    def virtual_network_gateway_name(self) -> pulumi.Input[str]:
        """
    ...
    def virtual_network_gateway_name(self, value: pulumi.Input[str]):
...
warnings.warn("""azure-native:network/v20210501:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_gateway_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkGatewayNatRule is deprecated: azure-native:network/v20210501:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""")
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VirtualNetworkGatewayNatRule':
        """
