...
def get_firewall_policy(expand: Optional[str] = None,
    ...
    return AwaitableGetFirewallPolicyResult(
        ...
        explicit_proxy_settings=pulumi.get(__ret__, 'explicit_proxy_settings'),
...
def get_firewall_policy_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210501:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult)
    return __ret__.apply(lambda __response__: GetFirewallPolicyResult(
        ...
        explicit_proxy_settings=pulumi.get(__response__, 'explicit_proxy_settings'),
