...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_network_gateway is deprecated: azure-native:network/v20210501:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LocalNetworkGateway to guarantee forwards compatibility.""")
    __args__ = dict()
