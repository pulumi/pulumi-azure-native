...
def get_virtual_hub_route_table_v2(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_route_table_v2 is deprecated: azure-native:network/v20210501:VirtualHubRouteTableV2 is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubRouteTableV2 to guarantee forwards compatibility.""")
    __args__ = dict()
