...
def get_virtual_wan(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_wan is deprecated: azure-native:network/v20210501:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualWan to guarantee forwards compatibility.""")
    __args__ = dict()
