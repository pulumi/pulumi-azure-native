...
class NetworkSecurityPerimeterAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20210201preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230701preview:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230801preview:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20240601preview:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkSecurityPerimeterAssociation"), pulumi.Alias(type_="azure-native:network:NspAssociation")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkSecurityPerimeterAssociation':
        """
