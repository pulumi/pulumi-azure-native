...
class GetPrivateLinkServiceResult:
    ...
    """
    def __init__(__self__, alias=None, auto_approval=None, azure_api_version=None, destination_ip_address=None, enable_proxy_protocol=None, etag=None, extended_location=None, fqdns=None, id=None, ip_configurations=None, load_balancer_frontend_ip_configurations=None, location=None, name=None, network_interfaces=None, private_endpoint_connections=None, provisioning_state=None, tags=None, type=None, visibility=None):
...
def get_private_link_service(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_name: The name of the private link service.
    """
    __args__ = dict()
...
def get_private_link_service_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
