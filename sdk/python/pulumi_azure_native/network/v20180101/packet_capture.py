...
class PacketCapture(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        packet_capture = azure_native.network.v20180101.PacketCapture("packetCapture",
            bytes_to_capture_per_packet=10000,
            filters=[azure_native.network.v20180101.PacketCaptureFilterArgs(
            ...
            storage_location=azure_native.network.v20180101.PacketCaptureStorageLocationArgs(
