...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if route_filter is not None and not isinstance(route_filter, RouteFilterArgs):
                route_filter = route_filter or {}
                def _setter(key, value):
                    route_filter[key] = value
                RouteFilterArgs._configure(_setter, **route_filter)
