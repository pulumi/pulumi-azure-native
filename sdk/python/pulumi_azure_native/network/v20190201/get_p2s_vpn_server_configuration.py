...
def get_p2s_vpn_server_configuration(p2_s_vpn_server_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_p2s_vpn_server_configuration is deprecated: azure-native:network/v20190201:P2sVpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
