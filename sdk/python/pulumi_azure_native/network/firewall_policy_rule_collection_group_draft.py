...
class FirewallPolicyRuleCollectionGroupDraftArgs:
    def __init__(__self__, *,
                 ...
                 rule_collection_group_name: pulumi.Input[builtins.str],
    ...
    def rule_collection_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rule_collection_group_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:network:FirewallPolicyRuleCollectionGroupDraft")
