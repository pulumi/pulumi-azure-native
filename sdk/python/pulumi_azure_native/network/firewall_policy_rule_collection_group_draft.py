...
class FirewallPolicyRuleCollectionGroupDraft(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20231101:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20240101:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20240301:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20240501:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20240701:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20241001:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20250101:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20250301:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20250501:FirewallPolicyRuleCollectionGroupDraft"), pulumi.Alias(type_="azure-native:network/v20250701:FirewallPolicyRuleCollectionGroupDraft")])
