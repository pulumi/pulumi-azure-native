...
class RulesEngineArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if front_door_name is None and 'frontDoorName' in kwargs:
            front_door_name = kwargs['frontDoorName']
        if front_door_name is None:
            raise TypeError("Missing 'front_door_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if rules_engine_name is None and 'rulesEngineName' in kwargs:
...
class RulesEngine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200401:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200501:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20210601:RulesEngine")])
