...
def get_application_gateway(application_gateway_name: Optional[_builtins.str] = None,
...
def get_application_gateway_output(application_gateway_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getApplicationGateway', __args__, opts=opts, typ=GetApplicationGatewayResult)
