...
warnings.warn("""azure-native:network/v20200401:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteTable to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route_table(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_table is deprecated: azure-native:network/v20200401:RouteTable is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteTable to guarantee forwards compatibility.""")
    __args__ = dict()
