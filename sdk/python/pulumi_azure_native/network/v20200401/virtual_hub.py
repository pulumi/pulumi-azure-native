...
class VirtualHubArgs:
    def __init__(__self__, *,
        ...
        VirtualHubArgs._configure(
            ...
            virtual_network_connections=virtual_network_connections,
    ...
    def _configure(
        ...
        if virtual_network_connections is None and 'virtualNetworkConnections' in kwargs:
            virtual_network_connections = kwargs['virtualNetworkConnections']
        ...
        if virtual_network_connections is not None:
            _setter("virtual_network_connections", virtual_network_connections)
