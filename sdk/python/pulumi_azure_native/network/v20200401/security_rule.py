...
warnings.warn("""azure-native:network/v20200401:SecurityRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class SecurityRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityRule is deprecated: azure-native:network/v20200401:SecurityRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""")
