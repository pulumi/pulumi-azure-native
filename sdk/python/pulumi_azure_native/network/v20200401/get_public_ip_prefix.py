...
warnings.warn("""azure-native:network/v20200401:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_public_ip_prefix(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_prefix is deprecated: azure-native:network/v20200401:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['publicIpPrefixName'] = public_ip_prefix_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200401:getPublicIPPrefix', __args__, opts=opts, typ=GetPublicIPPrefixResult).value
