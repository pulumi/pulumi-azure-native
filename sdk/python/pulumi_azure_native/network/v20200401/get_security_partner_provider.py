...
def get_security_partner_provider(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_partner_provider is deprecated: azure-native:network/v20200401:SecurityPartnerProvider is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:SecurityPartnerProvider to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['securityPartnerProviderName'] = security_partner_provider_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200401:getSecurityPartnerProvider', __args__, opts=opts, typ=GetSecurityPartnerProviderResult).value
