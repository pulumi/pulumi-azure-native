...
warnings.warn("""azure-native:network/v20200401:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.""", DeprecationWarning)
...
class FlowLog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FlowLog is deprecated: azure-native:network/v20200401:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.""")
