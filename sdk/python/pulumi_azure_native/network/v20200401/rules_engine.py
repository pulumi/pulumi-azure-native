...
class RulesEngine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rules_engine_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RulesEngine is deprecated: azure-native:network/v20200401:RulesEngine is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:RulesEngine to guarantee forwards compatibility.""")
