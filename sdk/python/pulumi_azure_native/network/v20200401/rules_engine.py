...
class RulesEngine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rules_engine_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RulesEngine is deprecated: azure-native:network/v20200401:RulesEngine is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210601:RulesEngine to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200501:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20210601:RulesEngine")])
