...
class AzureFirewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        azure_firewall = azure_native.network.v20200401.AzureFirewall("azureFirewall",
            application_rule_collections=[{
                "action": azure_native.network.v20200401.AzureFirewallRCActionArgs(
                    type="Deny",
                ),
                "name": "apprulecoll",
                "priority": 110,
                "rules": [{
                    ...
                    "name": "rule1",
                    "protocols": [azure_native.network.v20200401.AzureFirewallApplicationRuleProtocolArgs(
                        port=443,
                        protocol_type="Https",
                    )],
                    "sourceAddresses": [
            ...
            ip_configurations=[{
                ...
                "publicIPAddress": azure_native.network.v20200401.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPAddresses/pipName",
                ),
                "subnet": azure_native.network.v20200401.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/vnet2/subnets/AzureFirewallSubnet",
                ),
            }],
            location="West US",
            nat_rule_collections=[{
                "action": azure_native.network.v20200401.AzureFirewallNatRCActionArgs(
                    type="Dnat",
                ),
                "name": "natrulecoll",
                "priority": 112,
                "rules": [
                    azure_native.network.v20200401.AzureFirewallNatRuleArgs(
            ...
            network_rule_collections=[{
                ...
                "priority": 112,
                "rules": [
                    azure_native.network.v20200401.AzureFirewallNetworkRuleArgs(
            ...
            sku=azure_native.network.v20200401.AzureFirewallSkuArgs(
                name="AZFW_VNet",
                tier="Standard",
            ),
            tags={
        ...
        azure_firewall = azure_native.network.v20200401.AzureFirewall("azureFirewall",
            ...
            location="West US",
            management_ip_configuration=azure_native.network.v20200401.AzureFirewallIPConfigurationResponseArgs(
                name="azureFirewallMgmtIpConfiguration",
                public_ip_address=azure_native.network.v20200401.SubResourceArgs(
        ...
        azure_firewall = azure_native.network.v20200401.AzureFirewall("azureFirewall",
            azure_firewall_name="azurefirewall",
            firewall_policy=azure_native.network.v20200401.SubResourceArgs(
