...
warnings.warn("""azure-native:network/v20200401:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.""", DeprecationWarning)
