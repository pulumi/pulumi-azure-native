...
class RouteFilter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""RouteFilter is deprecated: azure-native:network/v20200401:RouteFilter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.""")
