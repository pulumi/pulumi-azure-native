...
class ExpressRouteConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 routing_weight: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteConnection is deprecated: azure-native:network/v20200401:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.""")
