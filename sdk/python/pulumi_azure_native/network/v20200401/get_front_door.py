...
def get_front_door(front_door_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_front_door is deprecated: azure-native:network/v20200401:FrontDoor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['frontDoorName'] = front_door_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200401:getFrontDoor', __args__, opts=opts, typ=GetFrontDoorResult).value
