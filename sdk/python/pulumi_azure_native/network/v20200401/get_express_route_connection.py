...
warnings.warn("""azure-native:network/v20200401:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_connection is deprecated: azure-native:network/v20200401:ExpressRouteConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteConnection to guarantee forwards compatibility.""")
    __args__ = dict()
