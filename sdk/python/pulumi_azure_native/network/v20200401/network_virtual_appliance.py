...
class NetworkVirtualApplianceArgs:
    ...
    def _configure(
        ...
        if boot_strap_configuration_blob is None and 'bootStrapConfigurationBlob' in kwargs:
            boot_strap_configuration_blob = kwargs['bootStrapConfigurationBlob']
        if cloud_init_configuration_blob is None and 'cloudInitConfigurationBlob' in kwargs:
...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            sku = _utilities.configure(sku, VirtualApplianceSkuPropertiesArgs, True)
