...
warnings.warn("""azure-native:network/v20200401:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:InboundNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class InboundNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/v20200401:InboundNatRule',
            resource_name,
            __props__,
            opts)
