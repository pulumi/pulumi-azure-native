...
warnings.warn("""azure-native:network/v20200401:LoadBalancer is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LoadBalancer to guarantee forwards compatibility.""", DeprecationWarning)
