...
def get_routing_intent(resource_group_name: Optional[_builtins.str] = None,
                       routing_intent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the RoutingIntent.
    :param _builtins.str routing_intent_name: The name of the RoutingIntent.
