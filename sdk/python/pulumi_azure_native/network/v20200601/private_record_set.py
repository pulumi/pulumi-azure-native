...
class PrivateRecordSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            a_records=[azure_native.network.v20200601.ARecordArgs(
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            aaaa_records=[azure_native.network.v20200601.AaaaRecordArgs(
                ipv6_address="::1",
            )],
            metadata={
                "key1": "value1",
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            cname_record=azure_native.network.v20200601.CnameRecordArgs(
                cname="contoso.com",
            ),
            metadata={
                "key1": "value1",
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            ...
            mx_records=[azure_native.network.v20200601.MxRecordArgs(
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            ...
            ptr_records=[azure_native.network.v20200601.PtrRecordArgs(
                ptrdname="localhost",
            )],
            record_type="PTR",
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            ...
            resource_group_name="resourceGroup1",
            soa_record=azure_native.network.v20200601.SoaRecordArgs(
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            ...
            resource_group_name="resourceGroup1",
            srv_records=[azure_native.network.v20200601.SrvRecordArgs(
                port=80,
                priority=0,
                target="contoso.com",
                weight=10,
        ...
        private_record_set = azure_native.network.v20200601.PrivateRecordSet("privateRecordSet",
            ...
            resource_group_name="resourceGroup1",
            ttl=3600,
            txt_records=[azure_native.network.v20200601.TxtRecordArgs(
                value=[
                    "string1",
                    "string2",
                ],
