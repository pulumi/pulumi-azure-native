...
warnings.warn("""azure-native:network/v20200601:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.""", DeprecationWarning)
...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 route_table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Route is deprecated: azure-native:network/v20200601:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:Route to guarantee forwards compatibility.""")
