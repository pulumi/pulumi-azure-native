...
def get_ddos_custom_policy(ddos_custom_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ddos_custom_policy is deprecated: azure-native:network/v20200601:DdosCustomPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220101:DdosCustomPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['ddosCustomPolicyName'] = ddos_custom_policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200601:getDdosCustomPolicy', __args__, opts=opts, typ=GetDdosCustomPolicyResult).value
