...
def get_packet_capture(network_watcher_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200601:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult).value
...
def get_packet_capture_output(network_watcher_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20200601:getPacketCapture', __args__, opts=opts, typ=GetPacketCaptureResult)
