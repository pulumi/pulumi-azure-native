...
warnings.warn("""azure-native:network/v20200601:SecurityPartnerProvider is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SecurityPartnerProvider to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_security_partner_provider(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_partner_provider is deprecated: azure-native:network/v20200601:SecurityPartnerProvider is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SecurityPartnerProvider to guarantee forwards compatibility.""")
    __args__ = dict()
