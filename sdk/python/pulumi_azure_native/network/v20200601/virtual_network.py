...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_peerings: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualNetworkPeeringArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetwork is deprecated: azure-native:network/v20200601:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.""")
