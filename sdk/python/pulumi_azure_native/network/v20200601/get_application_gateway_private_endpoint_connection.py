...
def get_application_gateway_private_endpoint_connection(application_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_gateway_private_endpoint_connection is deprecated: azure-native:network/v20200601:ApplicationGatewayPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ApplicationGatewayPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
