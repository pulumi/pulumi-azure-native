...
warnings.warn("""azure-native:network/v20200601:VirtualRouterPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouterPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_router_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_router_peering is deprecated: azure-native:network/v20200601:VirtualRouterPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouterPeering to guarantee forwards compatibility.""")
    __args__ = dict()
