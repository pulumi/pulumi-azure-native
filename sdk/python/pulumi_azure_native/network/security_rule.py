...
class SecurityRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_port_range: The destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
        ...
        :param pulumi.Input[builtins.str] security_rule_name: The name of the security rule.
