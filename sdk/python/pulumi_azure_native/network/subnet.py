...
class SubnetInitArgs:
    def __init__(__self__, *,
                 ...
                 default_outbound_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 sharing_scope: Optional[pulumi.Input[Union[builtins.str, 'SharingScope']]] = None,
        ...
        :param pulumi.Input[builtins.bool] default_outbound_access: Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IpamPoolPrefixAllocationArgs']]] ipam_pool_prefix_allocations: A list of IPAM Pools for allocating IP address prefixes.
        ...
        :param pulumi.Input[Union[builtins.str, 'SharingScope']] sharing_scope: Set this property to Tenant to allow sharing subnet with other subscriptions in your AAD tenant. This property can only be set if defaultOutboundAccess is set to false, both properties can only be set if subnet is empty.
    ...
    def default_outbound_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_outbound_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sharing_scope(self) -> Optional[pulumi.Input[Union[builtins.str, 'SharingScope']]]:
        """
    ...
    def sharing_scope(self, value: Optional[pulumi.Input[Union[builtins.str, 'SharingScope']]]):
...
class Subnet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['IpamPoolPrefixAllocationArgs', 'IpamPoolPrefixAllocationArgsDict']]]] ipam_pool_prefix_allocations: A list of IPAM Pools for allocating IP address prefixes.
        :param pulumi.Input[builtins.str] name: The name of the resource that is unique within a resource group. This name can be used to access the resource.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["ipam_pool_prefix_allocations"] = ipam_pool_prefix_allocations
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["ip_configuration_profiles"] = None
        __props__.__dict__["ip_configurations"] = None
        __props__.__dict__["ipam_pool_prefix_allocations"] = None
    ...
    @property
    @pulumi.getter(name="defaultOutboundAccess")
    def default_outbound_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
        """
        return pulumi.get(self, "default_outbound_access")
    ...
    @property
    @pulumi.getter(name="sharingScope")
    def sharing_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Set this property to Tenant to allow sharing subnet with other subscriptions in your AAD tenant. This property can only be set if defaultOutboundAccess is set to false, both properties can only be set if subnet is empty.
        """
        return pulumi.get(self, "sharing_scope")
