...
def get_security_user_configuration(configuration_name: Optional[builtins.str] = None,
...
def get_security_user_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
