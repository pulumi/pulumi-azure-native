...
class GetSecurityUserConfigurationResult:
    ...
    """
    def __init__(__self__, apply_on_network_intent_policy_based_services=None, delete_existing_nsgs=None, description=None, display_name=None, etag=None, id=None, name=None, provisioning_state=None, security_type=None, system_data=None, type=None):
