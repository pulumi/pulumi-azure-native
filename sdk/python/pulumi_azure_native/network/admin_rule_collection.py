...
class AdminRuleCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description of the admin rule collection.
...
@pulumi.type_token("azure-native:network:AdminRuleCollection")
