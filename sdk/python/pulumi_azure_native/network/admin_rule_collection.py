...
class AdminRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210201preview:AdminRuleCollection"), pulumi.Alias(type_="azure-nextgen:network/v20210201preview:AdminRuleCollection")])
