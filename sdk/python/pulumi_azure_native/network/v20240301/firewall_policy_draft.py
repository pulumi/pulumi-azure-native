...
class FirewallPolicyDraft(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20231101:FirewallPolicyDraft"), pulumi.Alias(type_="azure-native:network/v20240101:FirewallPolicyDraft"), pulumi.Alias(type_="azure-native:network/v20240501:FirewallPolicyDraft"), pulumi.Alias(type_="azure-native:network:FirewallPolicyDraft")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallPolicyDraft, __self__).__init__(
            'azure-native:network/v20240301:FirewallPolicyDraft',
            resource_name,
            __props__,
            opts)
