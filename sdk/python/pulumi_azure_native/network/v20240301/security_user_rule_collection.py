...
class SecurityUserRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210201preview:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210501preview:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220201preview:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:SecurityUserRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityUserRuleCollection, __self__).__init__(
            'azure-native:network/v20240301:SecurityUserRuleCollection',
            resource_name,
            __props__,
            opts)
