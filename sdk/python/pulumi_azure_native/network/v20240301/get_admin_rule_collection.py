...
def get_admin_rule_collection(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240301:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult).value
...
def get_admin_rule_collection_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleCollectionName'] = rule_collection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240301:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult)
