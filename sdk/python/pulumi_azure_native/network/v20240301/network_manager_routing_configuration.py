...
class NetworkManagerRoutingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A description of the routing configuration.
        """
...
class NetworkManagerRoutingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkManagerRoutingConfiguration")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NetworkManagerRoutingConfiguration':
        """
