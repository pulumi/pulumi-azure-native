...
__all__ = [
    ...
    'AwaitableGetSecurityUserRuleResult',
    'get_security_user_rule',
    'get_security_user_rule_output',
]
...
def get_security_user_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240301:getSecurityUserRule', __args__, opts=opts, typ=GetSecurityUserRuleResult).value
...
def get_security_user_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSecurityUserRuleResult]:
    """
    Gets a security user rule.
