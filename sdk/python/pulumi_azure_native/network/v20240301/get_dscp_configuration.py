...
def get_dscp_configuration(dscp_configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240301:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult).value
...
def get_dscp_configuration_output(dscp_configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240301:getDscpConfiguration', __args__, opts=opts, typ=GetDscpConfigurationResult)
