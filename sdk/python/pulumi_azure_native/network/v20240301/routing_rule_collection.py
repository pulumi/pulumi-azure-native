...
class RoutingRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RoutingRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:RoutingRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoutingRuleCollection, __self__).__init__(
            'azure-native:network/v20240301:RoutingRuleCollection',
            resource_name,
            __props__,
            opts)
