...
def get_virtual_hub_bgp_connection(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: The name of the connection.
...
def get_virtual_hub_bgp_connection_output(connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
