...
def get_connectivity_configuration(configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str configuration_name: The name of the network manager connectivity configuration.
...
def get_connectivity_configuration_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
