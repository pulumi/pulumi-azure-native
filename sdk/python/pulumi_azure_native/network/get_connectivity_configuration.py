...
class GetConnectivityConfigurationResult:
    ...
    def delete_existing_peering(self) -> Optional[builtins.str]:
        """
    ...
    def is_global(self) -> Optional[builtins.str]:
        """
...
def get_connectivity_configuration(configuration_name: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_name: The name of the network manager connectivity configuration.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getConnectivityConfiguration', __args__, opts=opts, typ=GetConnectivityConfigurationResult).value
...
def get_connectivity_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
