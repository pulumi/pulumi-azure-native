...
class ExpressRouteCircuitArgs:
    ...
    def _configure(
        ...
        if circuit_provisioning_state is None and 'circuitProvisioningState' in kwargs:
            circuit_provisioning_state = kwargs['circuitProvisioningState']
        if express_route_port is None and 'expressRoutePort' in kwargs:
            express_route_port = kwargs['expressRoutePort']
        if gateway_manager_etag is None and 'gatewayManagerEtag' in kwargs:
            gateway_manager_etag = kwargs['gatewayManagerEtag']
        if global_reach_enabled is None and 'globalReachEnabled' in kwargs:
            global_reach_enabled = kwargs['globalReachEnabled']
        if service_key is None and 'serviceKey' in kwargs:
            service_key = kwargs['serviceKey']
        if service_provider_notes is None and 'serviceProviderNotes' in kwargs:
            service_provider_notes = kwargs['serviceProviderNotes']
        if service_provider_properties is None and 'serviceProviderProperties' in kwargs:
            service_provider_properties = kwargs['serviceProviderProperties']
...
class ExpressRouteCircuit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            express_route_port = _utilities.configure(express_route_port, SubResourceArgs, True)
            ...
            service_provider_properties = _utilities.configure(service_provider_properties, ExpressRouteCircuitServiceProviderPropertiesArgs, True)
