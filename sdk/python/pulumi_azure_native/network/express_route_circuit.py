...
class ExpressRouteCircuit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(express_route_port, SubResourceArgs):
            ...
            if not isinstance(service_provider_properties, ExpressRouteCircuitServiceProviderPropertiesArgs):
            ...
            if not isinstance(sku, ExpressRouteCircuitSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
