...
def get_public_ip_prefix(expand: Optional[_builtins.str] = None,
                         public_ip_prefix_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str public_ip_prefix_name: The name of the public IP prefix.
