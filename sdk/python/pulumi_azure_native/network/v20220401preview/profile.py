...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        profile = azure_native.network.v20220401preview.Profile("profile",
            dns_config=azure_native.network.v20220401preview.DnsConfigArgs(
                relative_name="azsmnet6386",
                ttl=35,
            ),
            location="global",
            max_return=2,
            monitor_config=azure_native.network.v20220401preview.MonitorConfigArgs(
                path="/testpath.aspx",
                port=80,
                protocol="HTTP",
            ),
        ...
        profile = azure_native.network.v20220401preview.Profile("profile",
            ...
            endpoints=[azure_native.network.v20220401preview.EndpointArgs(
        ...
        profile = azure_native.network.v20220401preview.Profile("profile",
            ...
            endpoints=[{
                "customHeaders": [azure_native.network.v20220401preview.EndpointPropertiesCustomHeadersArgs(
                    name="header-2",
            ...
            location="global",
            monitor_config=azure_native.network.v20220401preview.MonitorConfigResponseArgs(
                custom_headers=[
                    azure_native.network.v20220401preview.MonitorConfigCustomHeadersArgs(
                        name="header-1",
                        value="value-1",
                    ),
                    azure_native.network.v20220401preview.MonitorConfigCustomHeadersArgs(
                ...
                expected_status_code_ranges=[
                    azure_native.network.v20220401preview.MonitorConfigExpectedStatusCodeRangesArgs(
                        max=205,
                        min=200,
                    ),
                    azure_native.network.v20220401preview.MonitorConfigExpectedStatusCodeRangesArgs(
        ...
        profile = azure_native.network.v20220401preview.Profile("profile",
            ...
            endpoints=[
                azure_native.network.v20220401preview.EndpointArgs(
                    endpoint_status="Enabled",
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'azure-native:network/v20220401preview:Profile',
            resource_name,
            __props__,
            opts)
