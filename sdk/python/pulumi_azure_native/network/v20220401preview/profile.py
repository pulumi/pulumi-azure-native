...
class ProfileArgs:
    ...
    def _configure(
        ...
        if allowed_endpoint_record_types is None and 'allowedEndpointRecordTypes' in kwargs:
            allowed_endpoint_record_types = kwargs['allowedEndpointRecordTypes']
        ...
        if traffic_view_enrollment_status is None and 'trafficViewEnrollmentStatus' in kwargs:
            traffic_view_enrollment_status = kwargs['trafficViewEnrollmentStatus']
...
class Profile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            dns_config = _utilities.configure(dns_config, DnsConfigArgs, True)
            __props__.__dict__["dns_config"] = dns_config
            __props__.__dict__["endpoints"] = endpoints
            __props__.__dict__["id"] = id
            __props__.__dict__["location"] = location
            __props__.__dict__["max_return"] = max_return
            monitor_config = _utilities.configure(monitor_config, MonitorConfigArgs, True)
