...
warnings.warn("""azure-native:network/v20220401preview:AdminRuleCollection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_admin_rule_collection(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_admin_rule_collection is deprecated: azure-native:network/v20220401preview:AdminRuleCollection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:AdminRuleCollection to guarantee forwards compatibility.""")
    __args__ = dict()
