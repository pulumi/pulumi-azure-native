...
class DefaultUserRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20210501preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20210501preview:UserRule"), pulumi.Alias(type_="azure-native:network/v20220201preview:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20220401preview:UserRule"), pulumi.Alias(type_="azure-native:network/v20240301:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20240301:SecurityUserRule"), pulumi.Alias(type_="azure-native:network/v20240501:DefaultUserRule"), pulumi.Alias(type_="azure-native:network/v20240501:SecurityUserRule"), pulumi.Alias(type_="azure-native:network:DefaultUserRule"), pulumi.Alias(type_="azure-native:network:SecurityUserRule"), pulumi.Alias(type_="azure-native:network:UserRule")])
