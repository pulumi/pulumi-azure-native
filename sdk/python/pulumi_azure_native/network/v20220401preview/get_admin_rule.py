...
def get_admin_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_admin_rule is deprecated: azure-native:network/v20220401preview:AdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AdminRule to guarantee forwards compatibility.""")
    __args__ = dict()
