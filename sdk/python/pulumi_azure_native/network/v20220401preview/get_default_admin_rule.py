...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_default_admin_rule is deprecated: azure-native:network/v20220401preview:DefaultAdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:DefaultAdminRule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220401preview:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
