...
warnings.warn("""azure-native:network/v20220401preview:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ScopeConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scope_connection(network_manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scope_connection is deprecated: azure-native:network/v20220401preview:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ScopeConnection to guarantee forwards compatibility.""")
    __args__ = dict()
