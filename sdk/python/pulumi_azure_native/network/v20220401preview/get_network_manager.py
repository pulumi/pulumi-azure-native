...
warnings.warn("""azure-native:network/v20220401preview:NetworkManager is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_manager(network_manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_manager is deprecated: azure-native:network/v20220401preview:NetworkManager is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.""")
    __args__ = dict()
