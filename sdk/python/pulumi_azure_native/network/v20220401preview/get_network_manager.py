...
warnings.warn("""azure-native:network/v20220401preview:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_manager(network_manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_manager is deprecated: azure-native:network/v20220401preview:NetworkManager is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkManagerName'] = network_manager_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220401preview:getNetworkManager', __args__, opts=opts, typ=GetNetworkManagerResult).value
