...
class NetworkVirtualApplianceConnectionArgs:
    ...
    def routing_configuration(self) -> Optional[pulumi.Input['RoutingConfigurationNfvArgs']]:
        """
    ...
    def routing_configuration(self, value: Optional[pulumi.Input['RoutingConfigurationNfvArgs']]):
...
class NetworkVirtualApplianceConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 routing_configuration: Optional[pulumi.Input[pulumi.InputType['RoutingConfigurationNfvArgs']]] = None,
                 tunnel_identifier: Optional[pulumi.Input[float]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] network_virtual_appliance_name: The name of the Network Virtual Appliance.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[pulumi.InputType['RoutingConfigurationNfvArgs']] routing_configuration: The Routing Configuration indicating the associated and propagated route tables on this connection.
        :param pulumi.Input[float] tunnel_identifier: Unique identifier for the connection.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if routing_configuration is not None and not isinstance(routing_configuration, RoutingConfigurationNfvArgs):
                routing_configuration = routing_configuration or {}
                def _setter(key, value):
                    routing_configuration[key] = value
                RoutingConfigurationNfvArgs._configure(_setter, **routing_configuration)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20221101:NetworkVirtualApplianceConnection"), pulumi.Alias(type_="azure-native:network/v20230201:NetworkVirtualApplianceConnection"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkVirtualApplianceConnection"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkVirtualApplianceConnection")])
    ...
    @property
    @pulumi.getter(name="routingConfiguration")
    def routing_configuration(self) -> pulumi.Output[Optional['outputs.RoutingConfigurationNfvResponse']]:
        """
        The Routing Configuration indicating the associated and propagated route tables on this connection.
        """
        return pulumi.get(self, "routing_configuration")
