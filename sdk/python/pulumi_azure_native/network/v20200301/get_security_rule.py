...
warnings.warn("""azure-native:network/v20200301:SecurityRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_security_rule(network_security_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_rule is deprecated: azure-native:network/v20200301:SecurityRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""")
    __args__ = dict()
