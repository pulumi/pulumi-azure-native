...
warnings.warn("""azure-native:network/v20200301:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:Route to guarantee forwards compatibility.""", DeprecationWarning)
