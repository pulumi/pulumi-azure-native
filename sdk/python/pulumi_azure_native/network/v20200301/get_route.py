...
def get_route(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: azure-native:network/v20200301:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:Route to guarantee forwards compatibility.""")
    __args__ = dict()
