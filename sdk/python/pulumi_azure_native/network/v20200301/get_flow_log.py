...
warnings.warn("""azure-native:network/v20200301:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_flow_log(flow_log_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_flow_log is deprecated: azure-native:network/v20200301:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['flowLogName'] = flow_log_name
    __args__['networkWatcherName'] = network_watcher_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200301:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult).value
