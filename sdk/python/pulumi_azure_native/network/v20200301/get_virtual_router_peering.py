...
def get_virtual_router_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_router_peering is deprecated: azure-native:network/v20200301:VirtualRouterPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouterPeering to guarantee forwards compatibility.""")
    __args__ = dict()
