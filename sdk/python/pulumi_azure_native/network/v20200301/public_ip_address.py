...
warnings.warn("""azure-native:network/v20200301:PublicIPAddress is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.""", DeprecationWarning)
...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PublicIPAddress is deprecated: azure-native:network/v20200301:PublicIPAddress is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.""")
