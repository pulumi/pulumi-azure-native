...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 threat_intel_mode: Optional[pulumi.Input[Union[str, 'AzureFirewallThreatIntelMode']]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallPolicy is deprecated: azure-native:network/v20200301:FirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:FirewallPolicy to guarantee forwards compatibility.""")
