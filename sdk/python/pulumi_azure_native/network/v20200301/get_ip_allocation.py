...
warnings.warn("""azure-native:network/v20200301:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpAllocation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ip_allocation(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_allocation is deprecated: azure-native:network/v20200301:IpAllocation is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpAllocation to guarantee forwards compatibility.""")
    __args__ = dict()
