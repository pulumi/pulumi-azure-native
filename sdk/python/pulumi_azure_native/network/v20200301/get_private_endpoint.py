...
warnings.warn("""azure-native:network/v20200301:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_endpoint(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint is deprecated: azure-native:network/v20200301:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210201:PrivateEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['privateEndpointName'] = private_endpoint_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200301:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult).value
