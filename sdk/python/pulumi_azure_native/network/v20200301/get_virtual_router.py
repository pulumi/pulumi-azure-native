...
warnings.warn("""azure-native:network/v20200301:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_router(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_router is deprecated: azure-native:network/v20200301:VirtualRouter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualRouter to guarantee forwards compatibility.""")
    __args__ = dict()
