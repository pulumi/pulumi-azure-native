...
warnings.warn("""azure-native:network/v20200301:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ddos_protection_plan is deprecated: azure-native:network/v20200301:DdosProtectionPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:DdosProtectionPlan to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['ddosProtectionPlanName'] = ddos_protection_plan_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200301:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult).value
