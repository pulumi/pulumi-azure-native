...
def get_virtual_network(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network is deprecated: azure-native:network/v20200301:VirtualNetwork is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.""")
    __args__ = dict()
