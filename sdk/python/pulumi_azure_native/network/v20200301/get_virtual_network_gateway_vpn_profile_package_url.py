...
def get_virtual_network_gateway_vpn_profile_package_url(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200301:getVirtualNetworkGatewayVpnProfilePackageUrl', __args__, opts=opts, typ=GetVirtualNetworkGatewayVpnProfilePackageUrlResult).value
...
def get_virtual_network_gateway_vpn_profile_package_url_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20200301:getVirtualNetworkGatewayVpnProfilePackageUrl', __args__, opts=opts, typ=GetVirtualNetworkGatewayVpnProfilePackageUrlResult)
