...
warnings.warn("""azure-native:network/v20200301:PrivateLinkServicePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateLinkServicePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateLinkServicePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateLinkServicePrivateEndpointConnection is deprecated: azure-native:network/v20200301:PrivateLinkServicePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PrivateLinkServicePrivateEndpointConnection to guarantee forwards compatibility.""")
