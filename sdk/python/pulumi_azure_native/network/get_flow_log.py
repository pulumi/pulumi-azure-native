...
def get_flow_log(flow_log_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str flow_log_name: The name of the flow log resource.
...
def get_flow_log_output(flow_log_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
