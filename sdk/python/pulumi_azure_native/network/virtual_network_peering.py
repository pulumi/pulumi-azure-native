...
class VirtualNetworkPeeringInitArgs:
    def __init__(__self__, *,
                 ...
                 do_not_verify_remote_gateways: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_only_i_pv6_peering: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 peer_complete_vnets: Optional[pulumi.Input[builtins.bool]] = None,
                 peering_state: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringState']]] = None,
                 peering_sync_level: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringLevel']]] = None,
                 ...
                 sync_remote_address_space: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 use_remote_gateways: Optional[pulumi.Input[builtins.bool]] = None,
                 virtual_network_peering_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VirtualNetworkPeering resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[builtins.str] virtual_network_name: The name of the virtual network.
        :param pulumi.Input[builtins.bool] allow_forwarded_traffic: Whether the forwarded traffic from the VMs in the local virtual network will be allowed/disallowed in remote virtual network.
        :param pulumi.Input[builtins.bool] allow_gateway_transit: If gateway links can be used in remote virtual networking to link to this virtual network.
        :param pulumi.Input[builtins.bool] allow_virtual_network_access: Whether the VMs in the local virtual network space would be able to access the VMs in remote virtual network space.
        :param pulumi.Input[builtins.bool] do_not_verify_remote_gateways: If we need to verify the provisioning state of the remote gateway.
        :param pulumi.Input[builtins.bool] enable_only_i_pv6_peering: Whether only Ipv6 address space is peered for subnet peering.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_subnet_names: List of local subnet names that are subnet peered with remote virtual network.
        ...
        :param pulumi.Input[builtins.bool] peer_complete_vnets: Whether complete virtual network address space is peered.
        :param pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringState']] peering_state: The status of the virtual network peering.
        :param pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringLevel']] peering_sync_level: The peering sync status of the virtual network peering.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remote_subnet_names: List of remote subnet names from remote virtual network that are subnet peered.
        ...
        :param pulumi.Input[builtins.str] sync_remote_address_space: Parameter indicates the intention to sync the peering with the current address space on the remote vNet after it's updated.
        :param pulumi.Input[builtins.str] type: Resource type.
        :param pulumi.Input[builtins.bool] use_remote_gateways: If remote gateways can be used on this virtual network. If the flag is set to true, and allowGatewayTransit on remote peering is also true, virtual network will use gateways of remote virtual network for transit. Only one peering can have this flag set to true. This flag cannot be set if virtual network already has a gateway.
        :param pulumi.Input[builtins.str] virtual_network_peering_name: The name of the peering.
        """
    ...
    def do_not_verify_remote_gateways(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def do_not_verify_remote_gateways(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "do_not_verify_remote_gateways", value)

    @property
    @pulumi.getter(name="enableOnlyIPv6Peering")
    def enable_only_i_pv6_peering(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_only_i_pv6_peering(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def peer_complete_vnets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def peer_complete_vnets(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "peer_complete_vnets", value)

    @property
    @pulumi.getter(name="peeringState")
    def peering_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringState']]]:
        """
    ...
    def peering_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringState']]]):
        pulumi.set(self, "peering_state", value)

    @property
    @pulumi.getter(name="peeringSyncLevel")
    def peering_sync_level(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringLevel']]]:
        """
    ...
    def peering_sync_level(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkPeeringLevel']]]):
    ...
    def sync_remote_address_space(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_remote_address_space(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def virtual_network_peering_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_network_peering_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="doNotVerifyRemoteGateways")
    def do_not_verify_remote_gateways(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If we need to verify the provisioning state of the remote gateway.
        """
        return pulumi.get(self, "do_not_verify_remote_gateways")
    ...
    @property
    @pulumi.getter(name="enableOnlyIPv6Peering")
    def enable_only_i_pv6_peering(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether only Ipv6 address space is peered for subnet peering.
        """
        return pulumi.get(self, "enable_only_i_pv6_peering")
    ...
    @property
    @pulumi.getter(name="peerCompleteVnets")
    def peer_complete_vnets(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether complete virtual network address space is peered.
        """
        return pulumi.get(self, "peer_complete_vnets")
    ...
    @property
    @pulumi.getter(name="peeringState")
    def peering_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The status of the virtual network peering.
        """
        return pulumi.get(self, "peering_state")
    ...
    @property
    @pulumi.getter(name="peeringSyncLevel")
    def peering_sync_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The peering sync status of the virtual network peering.
        """
        return pulumi.get(self, "peering_sync_level")
