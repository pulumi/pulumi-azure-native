...
def get_nsp_access_rule(access_rule_name: Optional[_builtins.str] = None,
...
def get_nsp_access_rule_output(access_rule_name: pulumi.Input[Optional[_builtins.str]] = None,
