...
def get_nsp_access_rule(access_rule_name: Optional[builtins.str] = None,
...
def get_nsp_access_rule_output(access_rule_name: Optional[pulumi.Input[builtins.str]] = None,
