...
def get_network_security_perimeter_link(link_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240601preview:getNetworkSecurityPerimeterLink', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLinkResult).value
...
def get_network_security_perimeter_link_output(link_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240601preview:getNetworkSecurityPerimeterLink', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLinkResult)
