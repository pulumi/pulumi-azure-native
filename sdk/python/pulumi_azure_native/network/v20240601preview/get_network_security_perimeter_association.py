...
def get_network_security_perimeter_association(association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240601preview:getNetworkSecurityPerimeterAssociation', __args__, opts=opts, typ=GetNetworkSecurityPerimeterAssociationResult).value
...
def get_network_security_perimeter_association_output(association_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240601preview:getNetworkSecurityPerimeterAssociation', __args__, opts=opts, typ=GetNetworkSecurityPerimeterAssociationResult)
