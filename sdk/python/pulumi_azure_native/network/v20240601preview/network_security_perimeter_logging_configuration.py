...
class NetworkSecurityPerimeterLoggingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 logging_configuration_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] logging_configuration_name: The name of the NSP logging configuration. Accepts 'instance' as name.
    ...
    def logging_configuration_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def logging_configuration_name(self, value: Optional[pulumi.Input[str]]):
...
class NetworkSecurityPerimeterLoggingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkSecurityPerimeterLoggingConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkSecurityPerimeterLoggingConfiguration, __self__).__init__(
            'azure-native:network/v20240601preview:NetworkSecurityPerimeterLoggingConfiguration',
            resource_name,
            __props__,
            opts)
