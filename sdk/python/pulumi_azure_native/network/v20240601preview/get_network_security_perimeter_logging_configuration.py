...
__all__ = [
    ...
    'AwaitableGetNetworkSecurityPerimeterLoggingConfigurationResult',
    'get_network_security_perimeter_logging_configuration',
    'get_network_security_perimeter_logging_configuration_output',
]
...
def get_network_security_perimeter_logging_configuration(logging_configuration_name: Optional[str] = None,
    ...
    """
    __args__ = dict()
    __args__['loggingConfigurationName'] = logging_configuration_name
    __args__['networkSecurityPerimeterName'] = network_security_perimeter_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240601preview:getNetworkSecurityPerimeterLoggingConfiguration', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLoggingConfigurationResult).value

    return AwaitableGetNetworkSecurityPerimeterLoggingConfigurationResult(
...
def get_network_security_perimeter_logging_configuration_output(logging_configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240601preview:getNetworkSecurityPerimeterLoggingConfiguration', __args__, opts=opts, typ=GetNetworkSecurityPerimeterLoggingConfigurationResult)
    return __ret__.apply(lambda __response__: GetNetworkSecurityPerimeterLoggingConfigurationResult(
