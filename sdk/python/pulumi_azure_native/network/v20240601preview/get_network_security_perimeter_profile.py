...
def get_network_security_perimeter_profile(network_security_perimeter_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240601preview:getNetworkSecurityPerimeterProfile', __args__, opts=opts, typ=GetNetworkSecurityPerimeterProfileResult).value
...
def get_network_security_perimeter_profile_output(network_security_perimeter_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240601preview:getNetworkSecurityPerimeterProfile', __args__, opts=opts, typ=GetNetworkSecurityPerimeterProfileResult)
