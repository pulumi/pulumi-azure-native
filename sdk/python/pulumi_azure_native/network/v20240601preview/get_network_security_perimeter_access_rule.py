...
def get_network_security_perimeter_access_rule(access_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240601preview:getNetworkSecurityPerimeterAccessRule', __args__, opts=opts, typ=GetNetworkSecurityPerimeterAccessRuleResult).value
...
def get_network_security_perimeter_access_rule_output(access_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240601preview:getNetworkSecurityPerimeterAccessRule', __args__, opts=opts, typ=GetNetworkSecurityPerimeterAccessRuleResult)
