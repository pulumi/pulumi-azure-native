...
class ReachabilityAnalysisIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240101preview:ReachabilityAnalysisIntent"), pulumi.Alias(type_="azure-native:network/v20240501:ReachabilityAnalysisIntent"), pulumi.Alias(type_="azure-native:network/v20240701:ReachabilityAnalysisIntent"), pulumi.Alias(type_="azure-native:network/v20241001:ReachabilityAnalysisIntent"), pulumi.Alias(type_="azure-native:network/v20250101:ReachabilityAnalysisIntent")])
