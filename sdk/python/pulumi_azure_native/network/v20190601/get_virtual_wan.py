...
def get_virtual_wan_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20190601:getVirtualWan', __args__, opts=opts, typ=GetVirtualWanResult)
    return __ret__.apply(lambda __response__: GetVirtualWanResult(
        ...
        p2_s_vpn_server_configurations=pulumi.get(__response__, 'p2_s_vpn_server_configurations'),
