...
class Subnet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        subnet = azure_native.network.v20190601.Subnet("subnet",
        ...
        subnet = azure_native.network.v20190601.Subnet("subnet",
            address_prefix="10.0.0.0/16",
            resource_group_name="subnet-test",
            service_endpoints=[azure_native.network.v20190601.ServiceEndpointPropertiesFormatArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20190601:Subnet subnet1 /subscriptions/subid/resourceGroups/subnet-test/providers/Microsoft.Network/virtualNetworks/vnetname/subnets/subnet1 
        ```
