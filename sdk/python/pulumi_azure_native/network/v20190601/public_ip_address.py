...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        public_ip_address = azure_native.network.v20190601.PublicIPAddress("publicIPAddress",
            dns_settings=azure_native.network.v20190601.PublicIPAddressDnsSettingsArgs(
        ...
        public_ip_address = azure_native.network.v20190601.PublicIPAddress("publicIPAddress",
            ...
            public_ip_address_name="test-ip",
            resource_group_name="rg1",
            sku=azure_native.network.v20190601.PublicIPAddressSkuArgs(
                name="Standard",
            ))
