...
class SecurityRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        security_rule = azure_native.network.v20190601.SecurityRule("securityRule",
            access="Deny",
        ...
        ```sh
        $ pulumi import azure-native:network/v20190601:SecurityRule rule1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkSecurityGroups/testnsg/securityRules/rule1 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(SecurityRule, __self__).__init__(
            'azure-native:network/v20190601:SecurityRule',
            resource_name,
            __props__,
            opts)
