...
warnings.warn("""azure-native:network/v20190601:ConnectionMonitor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190901:ConnectionMonitor to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectionMonitor is deprecated: azure-native:network/v20190601:ConnectionMonitor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190901:ConnectionMonitor to guarantee forwards compatibility.""")
