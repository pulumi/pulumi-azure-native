...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network = azure_native.network.v20190601.VirtualNetwork("virtualNetwork",
            address_space=azure_native.network.v20190601.AddressSpaceArgs(
        ...
        virtual_network = azure_native.network.v20190601.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "delegations": [azure_native.network.v20190601.DelegationArgs(
                    name="myDelegation",
        ...
        virtual_network = azure_native.network.v20190601.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "name": "test-1",
                "serviceEndpoints": [azure_native.network.v20190601.ServiceEndpointPropertiesFormatArgs(
        ...
        virtual_network = azure_native.network.v20190601.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                "addressPrefix": "10.0.0.0/16",
                "name": "test-1",
                "serviceEndpointPolicies": [azure_native.network.v20190601.ServiceEndpointPolicyArgs(
        ...
        virtual_network = azure_native.network.v20190601.VirtualNetwork("virtualNetwork",
            ...
            location="eastus",
            resource_group_name="rg1",
            subnets=[azure_native.network.v20190601.SubnetArgs(
