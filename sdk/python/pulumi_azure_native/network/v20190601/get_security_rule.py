...
def get_security_rule(network_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190601:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult).value
...
def get_security_rule_output(network_security_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['securityRuleName'] = security_rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20190601:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult)
