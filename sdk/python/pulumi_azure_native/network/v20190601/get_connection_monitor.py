...
def get_connection_monitor(connection_monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection_monitor is deprecated: azure-native:network/v20190601:ConnectionMonitor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190901:ConnectionMonitor to guarantee forwards compatibility.""")
    __args__ = dict()
