...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_security_group = azure_native.network.v20190601.NetworkSecurityGroup("networkSecurityGroup",
            location="eastus",
        ...
        ```sh
        $ pulumi import azure-native:network/v20190601:NetworkSecurityGroup testnsg /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkSecurityGroups/testnsg 
        ```
