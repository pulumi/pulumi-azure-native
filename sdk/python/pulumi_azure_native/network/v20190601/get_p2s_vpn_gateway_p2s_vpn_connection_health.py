...
def get_p2s_vpn_gateway_p2s_vpn_connection_health(gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190601:getP2sVpnGatewayP2sVpnConnectionHealth', __args__, opts=opts, typ=GetP2sVpnGatewayP2sVpnConnectionHealthResult).value
    ...
    return AwaitableGetP2sVpnGatewayP2sVpnConnectionHealthResult(
        ...
        p2_s_vpn_server_configuration=pulumi.get(__ret__, 'p2_s_vpn_server_configuration'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        tags=pulumi.get(__ret__, 'tags'),
        type=pulumi.get(__ret__, 'type'),
        virtual_hub=pulumi.get(__ret__, 'virtual_hub'),
        vpn_client_address_pool=pulumi.get(__ret__, 'vpn_client_address_pool'),
...
def get_p2s_vpn_gateway_p2s_vpn_connection_health_output(gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20190601:getP2sVpnGatewayP2sVpnConnectionHealth', __args__, opts=opts, typ=GetP2sVpnGatewayP2sVpnConnectionHealthResult)
    return __ret__.apply(lambda __response__: GetP2sVpnGatewayP2sVpnConnectionHealthResult(
        ...
        p2_s_vpn_server_configuration=pulumi.get(__response__, 'p2_s_vpn_server_configuration'),
        provisioning_state=pulumi.get(__response__, 'provisioning_state'),
        tags=pulumi.get(__response__, 'tags'),
        type=pulumi.get(__response__, 'type'),
        virtual_hub=pulumi.get(__response__, 'virtual_hub'),
        vpn_client_address_pool=pulumi.get(__response__, 'vpn_client_address_pool'),
