...
class InboundNatRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        inbound_nat_rule = azure_native.network.v20190601.InboundNatRule("inboundNatRule",
            backend_port=3389,
            enable_floating_ip=False,
            enable_tcp_reset=False,
            frontend_ip_configuration=azure_native.network.v20190601.SubResourceArgs(
    ...
    def _internal_init(__self__,
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/v20190601:InboundNatRule',
            resource_name,
            __props__,
            opts)
