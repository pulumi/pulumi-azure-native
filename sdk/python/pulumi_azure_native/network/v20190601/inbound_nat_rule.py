...
class InboundNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if frontend_ip_configuration is not None and not isinstance(frontend_ip_configuration, SubResourceArgs):
                frontend_ip_configuration = frontend_ip_configuration or {}
                def _setter(key, value):
                    frontend_ip_configuration[key] = value
                SubResourceArgs._configure(_setter, **frontend_ip_configuration)
