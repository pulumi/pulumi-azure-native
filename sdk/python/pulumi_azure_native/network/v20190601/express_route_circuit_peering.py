...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_circuit_peering = azure_native.network.v20190601.ExpressRouteCircuitPeering("expressRouteCircuitPeering",
            azure_asn=12076,
