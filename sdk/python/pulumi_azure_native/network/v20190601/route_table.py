...
class RouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route_table = azure_native.network.v20190601.RouteTable("routeTable",
            location="westus",
        ...
        ```sh
        $ pulumi import azure-native:network/v20190601:RouteTable testrt /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/routeTables/testrt 
        ```
