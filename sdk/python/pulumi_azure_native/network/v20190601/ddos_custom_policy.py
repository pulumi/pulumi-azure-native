...
warnings.warn("""azure-native:network/v20190601:DdosCustomPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220101:DdosCustomPolicy to guarantee forwards compatibility.""", DeprecationWarning)
