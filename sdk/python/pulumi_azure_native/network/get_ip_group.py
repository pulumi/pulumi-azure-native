...
def get_ip_group(expand: Optional[_builtins.str] = None,
                 ip_groups_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expand: Expands resourceIds (of Firewalls/Network Security Groups etc.) back referenced by the IpGroups resource.
    :param _builtins.str ip_groups_name: The name of the ipGroups.
...
def get_ip_group_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        ip_groups_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
