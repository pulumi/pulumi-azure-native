...
class GetInterfaceEndpointResult:
    ...
    def network_interfaces(self) -> Sequence['outputs.NetworkInterfaceInterfaceEndpointResponse']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subnet(self) -> Optional['outputs.SubnetInterfaceEndpointResponse']:
        """
...
def get_interface_endpoint(expand: Optional[_builtins.str] = None,
                           interface_endpoint_name: Optional[_builtins.str] = None,
