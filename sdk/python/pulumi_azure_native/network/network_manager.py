...
class NetworkManagerArgs:
    ...
    def network_manager_scope_accesses(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[Union[_builtins.str, 'ConfigurationType']]]]]:
        """
        Scope Access.
        """
    ...
    def network_manager_scope_accesses(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[Union[_builtins.str, 'ConfigurationType']]]]]):
...
class NetworkManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_manager_name: pulumi.Input[Optional[_builtins.str]] = None,
                 network_manager_scope_accesses: pulumi.Input[Optional[Sequence[pulumi.Input[Union[_builtins.str, 'ConfigurationType']]]]] = None,
                 network_manager_scopes: pulumi.Input[Optional[Union['NetworkManagerPropertiesNetworkManagerScopesArgs', 'NetworkManagerPropertiesNetworkManagerScopesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20210501preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220401preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220701:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230201:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230601:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20231101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkManager")])
