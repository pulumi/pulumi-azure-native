...
def get_virtual_network_gateway_vpnclient_ipsec_parameters(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str virtual_network_gateway_name: The virtual network gateway name.
    """
    __args__ = dict()
