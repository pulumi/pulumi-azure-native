...
class NspAccessRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NspAccessRule"), pulumi.Alias(type_="azure-native:network/v20210201preview:NspAccessRule"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspAccessRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NspAccessRule, __self__).__init__(
            'azure-native:network/v20230701preview:NspAccessRule',
            resource_name,
            __props__,
            opts)
