...
class RecordSetArgs:
    ...
    def _configure(
        ...
        if ds_records is None and 'dsRecords' in kwargs:
            ds_records = kwargs['dsRecords']
        if mx_records is None and 'mxRecords' in kwargs:
            mx_records = kwargs['mxRecords']
        if naptr_records is None and 'naptrRecords' in kwargs:
            naptr_records = kwargs['naptrRecords']
        ...
        if tlsa_records is None and 'tlsaRecords' in kwargs:
            tlsa_records = kwargs['tlsaRecords']
        ...
        if tlsa_records is not None:
            _setter("tlsa_records", tlsa_records)
        if ttl is not None:
            _setter("ttl", ttl)
...
class RecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RecordSet"), pulumi.Alias(type_="azure-native:network/v20150504preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20160401:RecordSet"), pulumi.Alias(type_="azure-native:network/v20170901:RecordSet"), pulumi.Alias(type_="azure-native:network/v20171001:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180301preview:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180501:RecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RecordSet, __self__).__init__(
            'azure-native:network/v20230701preview:RecordSet',
            resource_name,
            __props__,
            opts)
