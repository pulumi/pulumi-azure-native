...
__all__ = ['DnsResolverPolicyVirtualNetworkLinkArgs', 'DnsResolverPolicyVirtualNetworkLink']
...
class DnsResolverPolicyVirtualNetworkLinkArgs:
    def __init__(__self__, *,
                 ...
                 dns_resolver_policy_virtual_network_link_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] dns_resolver_policy_virtual_network_link_name: The name of the DNS resolver policy virtual network link for the DNS resolver policy.
    ...
    def dns_resolver_policy_virtual_network_link_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def dns_resolver_policy_virtual_network_link_name(self, value: Optional[pulumi.Input[str]]):
...
class DnsResolverPolicyVirtualNetworkLink(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsResolverPolicyVirtualNetworkLinkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnsResolverPolicyVirtualNetworkLinkArgs.__new__(DnsResolverPolicyVirtualNetworkLinkArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsResolverPolicyVirtualNetworkLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsResolverPolicyVirtualNetworkLink, __self__).__init__(
            'azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DnsResolverPolicyVirtualNetworkLink':
        """
        ...
        return DnsResolverPolicyVirtualNetworkLink(resource_name, opts=opts, __props__=__props__)
