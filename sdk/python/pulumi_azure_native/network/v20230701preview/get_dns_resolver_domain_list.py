...
def get_dns_resolver_domain_list(dns_resolver_domain_list_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230701preview:getDnsResolverDomainList', __args__, opts=opts, typ=GetDnsResolverDomainListResult).value
