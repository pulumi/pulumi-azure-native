...
def get_dns_forwarding_ruleset(dns_forwarding_ruleset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230701preview:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult).value
