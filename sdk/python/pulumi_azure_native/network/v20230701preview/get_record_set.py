...
def get_record_set(record_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230701preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
...
def get_record_set_output(record_type: Optional[pulumi.Input[str]] = None,
    ...
    __args__['zoneName'] = zone_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230701preview:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult)
