...
class DnsResolverPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsResolverPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsResolverPolicy, __self__).__init__(
            'azure-native:network/v20230701preview:DnsResolverPolicy',
            resource_name,
            __props__,
            opts)
