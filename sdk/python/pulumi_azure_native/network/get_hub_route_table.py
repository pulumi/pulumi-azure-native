...
def get_hub_route_table(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the VirtualHub.
    :param _builtins.str route_table_name: The name of the RouteTable.
