...
def get_reachability_analysis_run(network_manager_name: Optional[_builtins.str] = None,
                                  reachability_analysis_run_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str reachability_analysis_run_name: Reachability Analysis Run name.
...
def get_reachability_analysis_run_output(network_manager_name: pulumi.Input[Optional[_builtins.str]] = None,
                                         reachability_analysis_run_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getReachabilityAnalysisRun', __args__, opts=opts, typ=GetReachabilityAnalysisRunResult)
    return __ret__.apply(lambda __response__: GetReachabilityAnalysisRunResult(
