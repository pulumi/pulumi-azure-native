...
def get_web_application_firewall_policy(policy_name: Optional[_builtins.str] = None,
...
def get_web_application_firewall_policy_output(policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
