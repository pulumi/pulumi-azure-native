...
class GetExpressRouteCircuitPeeringResult:
    ...
    """
    def __init__(__self__, azure_asn=None, azure_api_version=None, connections=None, etag=None, express_route_connection=None, gateway_manager_etag=None, id=None, ipv6_peering_config=None, last_modified_by=None, microsoft_peering_config=None, name=None, peer_asn=None, peered_connections=None, peering_type=None, primary_azure_port=None, primary_peer_address_prefix=None, provisioning_state=None, route_filter=None, secondary_azure_port=None, secondary_peer_address_prefix=None, shared_key=None, state=None, stats=None, type=None, vlan_id=None):
    ...
    def azure_asn(self) -> Optional[builtins.int]:
        """
        The Azure ASN.
        """
    ...
    def primary_azure_port(self) -> Optional[builtins.str]:
        """
        The primary port.
        """
    ...
    def secondary_azure_port(self) -> Optional[builtins.str]:
        """
        The secondary port.
        """
...
def get_express_route_circuit_peering(circuit_name: Optional[builtins.str] = None,
...
def get_express_route_circuit_peering_output(circuit_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getExpressRouteCircuitPeering', __args__, opts=opts, typ=GetExpressRouteCircuitPeeringResult)
