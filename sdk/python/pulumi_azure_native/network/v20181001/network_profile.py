...
warnings.warn("""azure-native:network/v20181001:NetworkProfile is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:NetworkProfile to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkProfile is deprecated: azure-native:network/v20181001:NetworkProfile is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:NetworkProfile to guarantee forwards compatibility.""")
