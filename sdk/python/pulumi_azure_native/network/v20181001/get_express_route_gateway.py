...
def get_express_route_gateway(express_route_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_gateway is deprecated: azure-native:network/v20181001:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expressRouteGatewayName'] = express_route_gateway_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181001:getExpressRouteGateway', __args__, opts=opts, typ=GetExpressRouteGatewayResult).value
