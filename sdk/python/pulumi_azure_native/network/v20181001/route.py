...
warnings.warn("""azure-native:network/v20181001:Route is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:Route to guarantee forwards compatibility.""", DeprecationWarning)
