...
warnings.warn("""azure-native:network/v20181001:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class VpnGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_gateway_scale_unit: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnGateway is deprecated: azure-native:network/v20181001:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.""")
