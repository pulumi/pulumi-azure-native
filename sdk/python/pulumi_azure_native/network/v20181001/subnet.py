...
warnings.warn("""azure-native:network/v20181001:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""", DeprecationWarning)
...
class Subnet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Subnet is deprecated: azure-native:network/v20181001:Subnet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:Subnet to guarantee forwards compatibility.""")
