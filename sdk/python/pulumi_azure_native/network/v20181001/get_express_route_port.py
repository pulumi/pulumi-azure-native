...
def get_express_route_port(express_route_port_name: Optional[str] = None,
    ...
    return AwaitableGetExpressRoutePortResult(
        ...
        provisioned_bandwidth_in_gbps=pulumi.get(__ret__, 'provisioned_bandwidth_in_gbps'),
...
def get_express_route_port_output(express_route_port_name: Optional[pulumi.Input[str]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetExpressRoutePortResult]:
    """
    Retrieves the requested ExpressRoutePort resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20181001:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult)
