...
warnings.warn("""azure-native:network/v20181001:RouteFilterRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilterRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route_filter_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter_rule is deprecated: azure-native:network/v20181001:RouteFilterRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:RouteFilterRule to guarantee forwards compatibility.""")
    __args__ = dict()
