...
class InterfaceEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__["endpoint_service"] = None
        __props__["etag"] = None
        __props__["fqdn"] = None
