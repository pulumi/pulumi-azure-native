...
class InterfaceEndpoint(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network:InterfaceEndpoint"), pulumi.Alias(type_="azure-native:network/latest:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network/latest:InterfaceEndpoint"), pulumi.Alias(type_="azure-native:network/v20180801:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network/v20180801:InterfaceEndpoint"), pulumi.Alias(type_="azure-native:network/v20181101:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network/v20181101:InterfaceEndpoint"), pulumi.Alias(type_="azure-native:network/v20181201:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network/v20181201:InterfaceEndpoint"), pulumi.Alias(type_="azure-native:network/v20190201:InterfaceEndpoint"), pulumi.Alias(type_="azure-nextgen:network/v20190201:InterfaceEndpoint")])
