...
def get_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_gateway is deprecated: azure-native:network/v20181001:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.""")
    __args__ = dict()
