...
def get_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_gateway is deprecated: azure-native:network/v20181001:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnGateway to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['gatewayName'] = gateway_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181001:getVpnGateway', __args__, opts=opts, typ=GetVpnGatewayResult).value
