...
warnings.warn("""azure-native:network/v20181001:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
