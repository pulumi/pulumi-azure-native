...
def get_security_admin_configuration(configuration_name: Optional[_builtins.str] = None,
...
def get_security_admin_configuration_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
