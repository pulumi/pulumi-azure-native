...
def get_application_gateway_backend_health_on_demand(application_gateway_name: Optional[_builtins.str] = None,
                                                     ...
                                                     pick_host_name_from_backend_http_settings: Optional[_builtins.bool] = None,
                                                     protocol: Optional[Union[_builtins.str, 'ApplicationGatewayProtocol']] = None,
    ...
    :param _builtins.str expand: Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
    :param _builtins.str host: Host name to send the probe to.
    ...
    :param _builtins.str path: Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
    :param _builtins.bool pick_host_name_from_backend_http_settings: Whether the host header should be picked from the backend http settings. Default value is false.
    :param Union[_builtins.str, 'ApplicationGatewayProtocol'] protocol: The protocol used for the probe.
    :param _builtins.str resource_group_name: The name of the resource group.
    :param _builtins.int timeout: The probe timeout in seconds. Probe marked as failed if valid response is not received with this timeout period. Acceptable values are from 1 second to 86400 seconds.
    """
    __args__ = dict()
