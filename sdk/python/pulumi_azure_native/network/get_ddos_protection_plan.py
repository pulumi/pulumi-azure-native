...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ddos_protection_plan_name: The name of the DDoS protection plan.
...
def get_ddos_protection_plan_output(ddos_protection_plan_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
