...
class FlowLogArgs:
    def __init__(__self__, *,
                 ...
                 enabled_filtering_criteria: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] enabled_filtering_criteria: Optional field to filter network traffic logs based on SrcIP, SrcPort, DstIP, DstPort, Protocol, Encryption, Direction and Action. If not specified, all network traffic will be logged.
    ...
    def enabled_filtering_criteria(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enabled_filtering_criteria(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowLog(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enabledFilteringCriteria")
    def enabled_filtering_criteria(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional field to filter network traffic logs based on SrcIP, SrcPort, DstIP, DstPort, Protocol, Encryption, Direction and Action. If not specified, all network traffic will be logged.
        """
        return pulumi.get(self, "enabled_filtering_criteria")
