...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230601:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
...
def get_public_ip_address_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230601:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult)
