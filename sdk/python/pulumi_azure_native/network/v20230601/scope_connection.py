...
class ScopeConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210501preview:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220101:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220201preview:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220401preview:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220501:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220701:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20220901:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20221101:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20230201:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20230401:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20230501:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20230901:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20231101:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20240101:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20240301:ScopeConnection"), pulumi.Alias(type_="azure-native:network/v20240501:ScopeConnection"), pulumi.Alias(type_="azure-native:network:ScopeConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScopeConnection, __self__).__init__(
            'azure-native:network/v20230601:ScopeConnection',
            resource_name,
            __props__,
            opts)
