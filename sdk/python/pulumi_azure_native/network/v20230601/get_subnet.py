...
def get_subnet(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230601:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
...
def get_subnet_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['virtualNetworkName'] = virtual_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230601:getSubnet', __args__, opts=opts, typ=GetSubnetResult)
