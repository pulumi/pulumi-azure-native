...
class NetworkVirtualApplianceConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['NetworkVirtualApplianceConnectionPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] name: The name of the resource.
        :param pulumi.Input[str] network_virtual_appliance_name: The name of the Network Virtual Appliance.
        :param pulumi.Input[pulumi.InputType['NetworkVirtualApplianceConnectionPropertiesArgs']] properties: Properties of the express route connection.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        """
        ...
    @overload
