...
def get_virtual_router(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230601:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult).value
...
def get_virtual_router_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['virtualRouterName'] = virtual_router_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230601:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult)
