...
class ManagementGroupNetworkManagerConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220101:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220201preview:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220501:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220701:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220901:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20221101:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20230201:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20230401:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20230501:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20230901:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20231101:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20240101:ManagementGroupNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20240301:ManagementGroupNetworkManagerConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementGroupNetworkManagerConnection, __self__).__init__(
            'azure-native:network/v20230601:ManagementGroupNetworkManagerConnection',
            resource_name,
            __props__,
            opts)
