...
def get_flow_log(flow_log_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230601:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult).value
...
def get_flow_log_output(flow_log_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230601:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult)
