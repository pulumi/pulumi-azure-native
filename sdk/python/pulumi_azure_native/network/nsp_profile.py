...
class NspProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the profile resource that is unique within a perimeter. This name can be used to access the resource.
