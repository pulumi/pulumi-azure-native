...
def list_effective_configuration_by_subnet(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:listEffectiveConfigurationBySubnet', __args__, opts=opts, typ=ListEffectiveConfigurationBySubnetResult).value
