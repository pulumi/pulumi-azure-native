...
class NetworkSecurityPerimeterLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspLink"), pulumi.Alias(type_="azure-native:network:NspLink"), pulumi.Alias(type_="azure-native_network_v20210201preview:network:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native_network_v20230701preview:network:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native_network_v20230801preview:network:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native_network_v20240601preview:network:NetworkSecurityPerimeterLink")])
