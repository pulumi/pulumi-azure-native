...
class NetworkSecurityPerimeterLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auto_approved_remote_perimeter_resource_id: Perimeter ARM Id for the remote NSP with which the link gets created in Auto-approval mode. It should be used when the NSP admin have Microsoft.Network/networkSecurityPerimeters/linkPerimeter/action permission on the remote NSP resource.
        :param pulumi.Input[_builtins.str] description: A message passed to the owner of the remote NSP link resource with this connection request. In case of Auto-approved flow, it is default to 'Auto Approved'. Restricted to 140 chars.
        :param pulumi.Input[_builtins.str] link_name: The name of the NSP link.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] local_inbound_profiles: Local Inbound profile names to which Inbound is allowed. Use ['*'] to allow inbound to all profiles.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] remote_inbound_profiles: Remote Inbound profile names to which Inbound is allowed. Use ['*'] to allow inbound to all profiles. This property can only be updated in auto-approval mode.
        """
...
class NetworkSecurityPerimeterLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20210201preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20230701preview:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20230801preview:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20240601preview:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkSecurityPerimeterLink"), pulumi.Alias(type_="azure-native:network:NspLink")])
    ...
    @_builtins.property
    @pulumi.getter(name="autoApprovedRemotePerimeterResourceId")
    def auto_approved_remote_perimeter_resource_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Perimeter ARM Id for the remote NSP with which the link gets created in Auto-approval mode. It should be used when the NSP admin have Microsoft.Network/networkSecurityPerimeters/linkPerimeter/action permission on the remote NSP resource.
        """
        return pulumi.get(self, "auto_approved_remote_perimeter_resource_id")
    ...
    @_builtins.property
    @pulumi.getter(name="localInboundProfiles")
    def local_inbound_profiles(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Local Inbound profile names to which Inbound is allowed. Use ['*'] to allow inbound to all profiles.
        """
        return pulumi.get(self, "local_inbound_profiles")
    ...
    @_builtins.property
    @pulumi.getter(name="remoteInboundProfiles")
    def remote_inbound_profiles(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Remote Inbound profile names to which Inbound is allowed. Use ['*'] to allow inbound to all profiles. This property can only be updated in auto-approval mode.
        """
        return pulumi.get(self, "remote_inbound_profiles")
