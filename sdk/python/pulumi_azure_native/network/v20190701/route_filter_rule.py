...
warnings.warn("""azure-native:network/v20190701:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilterRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class RouteFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RouteFilterRule is deprecated: azure-native:network/v20190701:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilterRule to guarantee forwards compatibility.""")
