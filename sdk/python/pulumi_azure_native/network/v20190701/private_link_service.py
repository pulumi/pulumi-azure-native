...
warnings.warn("""azure-native:network/v20190701:PrivateLinkService is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:PrivateLinkService to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateLinkService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 visibility: Optional[pulumi.Input[pulumi.InputType['PrivateLinkServicePropertiesVisibilityArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateLinkService is deprecated: azure-native:network/v20190701:PrivateLinkService is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190801:PrivateLinkService to guarantee forwards compatibility.""")
