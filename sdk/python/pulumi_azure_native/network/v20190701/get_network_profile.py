...
warnings.warn("""azure-native:network/v20190701:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:NetworkProfile to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_profile(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_profile is deprecated: azure-native:network/v20190701:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:NetworkProfile to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['networkProfileName'] = network_profile_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190701:getNetworkProfile', __args__, opts=opts, typ=GetNetworkProfileResult).value
