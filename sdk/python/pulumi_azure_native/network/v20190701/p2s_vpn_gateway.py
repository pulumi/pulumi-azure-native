...
class P2sVpnGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(custom_routes, AddressSpaceArgs):
            ...
            if not isinstance(p2_s_vpn_server_configuration, SubResourceArgs):
            ...
            if not isinstance(vpn_client_address_pool, AddressSpaceArgs):
