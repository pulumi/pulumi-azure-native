...
class Subnet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] private_link_service_network_policies: Enable or Disable apply network policies on private link service in the subnet.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResourceNavigationLinkArgs', 'ResourceNavigationLinkArgsDict']]]] resource_navigation_links: An array of references to the external resources using subnet.
        :param pulumi.Input[Union['RouteTableArgs', 'RouteTableArgsDict']] route_table: The reference of the RouteTable resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceAssociationLinkArgs', 'ServiceAssociationLinkArgsDict']]]] service_association_links: An array of references to services injecting into this subnet.
