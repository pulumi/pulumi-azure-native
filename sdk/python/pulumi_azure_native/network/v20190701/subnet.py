...
class SubnetInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ResourceNavigationLinkArgs']]] resource_navigation_links: An array of references to the external resources using subnet.
        :param pulumi.Input['RouteTableArgs'] route_table: The reference of the RouteTable resource.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceAssociationLinkArgs']]] service_association_links: An array of references to services injecting into this subnet.
...
warnings.warn("""azure-native:network/v20190701:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:Subnet to guarantee forwards compatibility.""", DeprecationWarning)
...
class Subnet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Subnet is deprecated: azure-native:network/v20190701:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:Subnet to guarantee forwards compatibility.""")
        ...
        super(Subnet, __self__).__init__(
            'azure-native:network/v20190701:Subnet',
            resource_name,
            __props__,
            opts)
