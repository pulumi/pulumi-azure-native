...
class DnsForwardingRulesetArgs:
    ...
    def _configure(
        ...
        if 'dnsResolverOutboundEndpoints' in kwargs:
...
class DnsForwardingRuleset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:DnsForwardingRuleset"), pulumi.Alias(type_="azure-native:network/v20220701:DnsForwardingRuleset")])
