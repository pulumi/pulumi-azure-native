...
class VirtualNetworkLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_link = azure_native.network.v20200401preview.VirtualNetworkLink("virtualNetworkLink",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VirtualNetworkLink"), pulumi.Alias(type_="azure-native:network/v20220701:VirtualNetworkLink")])
