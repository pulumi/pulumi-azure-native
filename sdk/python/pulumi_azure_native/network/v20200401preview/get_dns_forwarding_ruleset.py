...
def get_dns_forwarding_ruleset(dns_forwarding_ruleset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200401preview:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult).value
...
def get_dns_forwarding_ruleset_output(dns_forwarding_ruleset_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20200401preview:getDnsForwardingRuleset', __args__, opts=opts, typ=GetDnsForwardingRulesetResult)
