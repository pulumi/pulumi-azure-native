...
class InboundEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220701:InboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20230701preview:InboundEndpoint"), pulumi.Alias(type_="azure-native:network:InboundEndpoint")])
