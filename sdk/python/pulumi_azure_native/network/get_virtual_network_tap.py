...
def get_virtual_network_tap(resource_group_name: Optional[_builtins.str] = None,
                            tap_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str tap_name: The name of virtual network tap.
    """
    __args__ = dict()
...
def get_virtual_network_tap_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                   tap_name: Optional[pulumi.Input[_builtins.str]] = None,
