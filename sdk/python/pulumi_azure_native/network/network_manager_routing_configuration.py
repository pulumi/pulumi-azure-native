...
class NetworkManagerRoutingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240301:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240501:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240901preview:NetworkManagerRoutingConfiguration")])
