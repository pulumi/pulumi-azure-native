...
class NetworkManagerRoutingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230301preview:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240501:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240901preview:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkManagerRoutingConfiguration")])
