...
def get_web_application_firewall_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_application_firewall_policy is deprecated: azure-native:network/v20190801:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:WebApplicationFirewallPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
