...
class VpnSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_site_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnSite is deprecated: azure-native:network/v20190801:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnSite to guarantee forwards compatibility.""")
