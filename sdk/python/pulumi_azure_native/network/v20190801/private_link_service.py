...
class PrivateLinkService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_service = azure_native.network.v20190801.PrivateLinkService("privateLinkService",
            auto_approval=azure_native.network.v20190801.PrivateLinkServicePropertiesAutoApprovalArgs(
                subscriptions=[
                    "subscription1",
                    "subscription2",
                ],
            ...
            load_balancer_frontend_ip_configurations=[azure_native.network.v20190801.FrontendIPConfigurationArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
            )],
            location="eastus",
            resource_group_name="rg1",
            service_name="testPls",
            visibility=azure_native.network.v20190801.PrivateLinkServicePropertiesVisibilityArgs(
                subscriptions=[
                    "subscription1",
                    "subscription2",
                    "subscription3",
