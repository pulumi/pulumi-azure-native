...
def get_private_link_service(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20190801:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult).value
...
def get_private_link_service_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20190801:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult)
