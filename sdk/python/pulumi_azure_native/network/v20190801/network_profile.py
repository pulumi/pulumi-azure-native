...
class NetworkProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_profile = azure_native.network.v20190801.NetworkProfile("networkProfile",
            container_network_interface_configurations=[{
                "ipConfigurations": [{
                    "name": "ipconfig1",
                    "subnet": azure_native.network.v20190801.SubnetArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20190801:NetworkProfile networkProfile1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkProfiles/networkProfile1 
        ```
