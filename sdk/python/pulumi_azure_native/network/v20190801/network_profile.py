...
class NetworkProfileArgs:
    ...
    def _configure(
        ...
        if container_network_interface_configurations is None and 'containerNetworkInterfaceConfigurations' in kwargs:
            container_network_interface_configurations = kwargs['containerNetworkInterfaceConfigurations']
        if container_network_interfaces is None and 'containerNetworkInterfaces' in kwargs:
            container_network_interfaces = kwargs['containerNetworkInterfaces']
        if network_profile_name is None and 'networkProfileName' in kwargs:
            network_profile_name = kwargs['networkProfileName']

        _setter("resource_group_name", resource_group_name)
        if container_network_interface_configurations is not None:
            _setter("container_network_interface_configurations", container_network_interface_configurations)
        if container_network_interfaces is not None:
            _setter("container_network_interfaces", container_network_interfaces)
        if id is not None:
            _setter("id", id)
        if location is not None:
            _setter("location", location)
        if network_profile_name is not None:
            _setter("network_profile_name", network_profile_name)
        if tags is not None:
            _setter("tags", tags)
...
class NetworkProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20180801:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20181001:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20181101:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20181201:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20190201:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20190401:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20190601:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20190701:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20190901:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20191101:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20191201:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200301:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200401:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200501:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200601:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200701:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20200801:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20201101:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20210201:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20210301:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20210501:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20210801:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20220101:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20220501:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20220701:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20220901:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20230201:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkProfile"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkProfile")])
