...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_balancer = azure_native.network.v20190801.LoadBalancer("loadBalancer",
            backend_address_pools=[azure_native.network.v20190801.BackendAddressPoolArgs(
                name="be-lb",
            )],
            ...
            load_balancing_rules=[{
                ...
                "name": "rulelb",
                "probe": azure_native.network.v20190801.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20190801.LoadBalancer("loadBalancer",
            ...
            resource_group_name="rg1",
            sku=azure_native.network.v20190801.LoadBalancerSkuArgs(
                name="Standard",
            ))
        ...
        load_balancer = azure_native.network.v20190801.LoadBalancer("loadBalancer",
            ...
            outbound_rules=[{
                ...
                "frontendIPConfigurations": [azure_native.network.v20190801.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
                )],
                "name": "rule1",
                "protocol": "All",
