...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_gateway_connection = azure_native.network.v20190801.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection",
            connection_protocol="IKEv2",
            connection_type="IPsec",
            enable_bgp=False,
            ipsec_policies=[],
            local_network_gateway2=azure_native.network.v20190801.LocalNetworkGatewayResponseArgs(
            ...
            virtual_network_gateway1=azure_native.network.v20190801.VirtualNetworkGatewayResponseArgs(
                active_active=False,
                bgp_settings=azure_native.network.v20190801.BgpSettingsArgs(
                    asn=65514,
                ...
                location="centralus",
                sku=azure_native.network.v20190801.VirtualNetworkGatewaySkuArgs(
                    capacity=2,
                    name="VpnGw1",
                    tier="VpnGw1",
                ),
