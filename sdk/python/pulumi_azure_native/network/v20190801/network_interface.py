...
class NetworkInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_interface = azure_native.network.v20190801.NetworkInterface("networkInterface",
            enable_accelerated_networking=True,
            ip_configurations=[{
                "name": "ipconfig1",
                "publicIPAddress": azure_native.network.v20190801.PublicIPAddressArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20190801:NetworkInterface test-nic /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/test-nic 
        ```
