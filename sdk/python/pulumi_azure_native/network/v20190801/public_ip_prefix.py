...
class PublicIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        public_ip_prefix = azure_native.network.v20190801.PublicIPPrefix("publicIPPrefix",
            location="westus",
            prefix_length=30,
            public_ip_address_version="IPv4",
            public_ip_prefix_name="test-ipprefix",
            resource_group_name="rg1",
            sku=azure_native.network.v20190801.PublicIPPrefixSkuArgs(
                name="Standard",
            ))
        ...
        ```sh
        $ pulumi import azure-native:network/v20190801:PublicIPPrefix test-ipprefix /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/publicIPPrefixes/test-ipprefix 
        ```
