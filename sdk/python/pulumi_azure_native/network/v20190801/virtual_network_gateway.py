...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_gateway = azure_native.network.v20190801.VirtualNetworkGateway("virtualNetworkGateway",
            active_active=False,
            ...
            custom_routes=azure_native.network.v20190801.AddressSpaceArgs(
