...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        local_network_gateway = azure_native.network.v20190801.LocalNetworkGateway("localNetworkGateway",
            gateway_ip_address="11.12.13.14",
            local_network_address_space=azure_native.network.v20190801.AddressSpaceArgs(
