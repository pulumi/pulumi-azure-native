...
class AdminRuleArgs:
    def __init__(__self__, *,
                 access: pulumi.Input[Union[builtins.str, 'SecurityConfigurationRuleAccess']],
        ...
        :param pulumi.Input[Union[builtins.str, 'SecurityConfigurationRuleAccess']] access: Indicates the access allowed for this particular rule
        ...
        :param pulumi.Input[builtins.int] priority: The priority of the rule. The value can be between 1 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
    ...
    @property
    @pulumi.getter
    def access(self) -> pulumi.Input[Union[builtins.str, 'SecurityConfigurationRuleAccess']]:
        """
    ...
    @access.setter
    def access(self, value: pulumi.Input[Union[builtins.str, 'SecurityConfigurationRuleAccess']]):
...
class AdminRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 access: Optional[pulumi.Input[Union[builtins.str, 'SecurityConfigurationRuleAccess']]] = None,
