...
class NetworkSecurityPerimeterLoggingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240601preview:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240701:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20241001:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250101:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250301:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250501:NetworkSecurityPerimeterLoggingConfiguration"), pulumi.Alias(type_="azure-native:network/v20250701:NetworkSecurityPerimeterLoggingConfiguration")])
