...
def list_active_security_admin_rule(network_manager_name: Optional[_builtins.str] = None,
                                    regions: Optional[Sequence[_builtins.str]] = None,
                                    resource_group_name: Optional[_builtins.str] = None,
                                    skip_token: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListActiveSecurityAdminRuleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:listActiveSecurityAdminRule', __args__, opts=opts, typ=ListActiveSecurityAdminRuleResult).value

    return AwaitableListActiveSecurityAdminRuleResult(
        skip_token=pulumi.get(__ret__, 'skip_token'),
        value=pulumi.get(__ret__, 'value'))
def list_active_security_admin_rule_output(network_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListActiveSecurityAdminRuleResult]:
    """
    Lists active security admin rules in a network manager.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:listActiveSecurityAdminRule', __args__, opts=opts, typ=ListActiveSecurityAdminRuleResult)
    return __ret__.apply(lambda __response__: ListActiveSecurityAdminRuleResult(
