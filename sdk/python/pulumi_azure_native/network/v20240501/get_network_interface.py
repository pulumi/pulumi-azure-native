...
def get_network_interface(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult).value
...
def get_network_interface_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
