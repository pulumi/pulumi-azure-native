...
def get_vpn_site(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getVpnSite', __args__, opts=opts, typ=GetVpnSiteResult).value
...
def get_vpn_site_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getVpnSite', __args__, opts=opts, typ=GetVpnSiteResult)
