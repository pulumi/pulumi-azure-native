...
def get_route_filter(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult).value
...
def get_route_filter_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult)
