...
def get_ipam_pool(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getIpamPool', __args__, opts=opts, typ=GetIpamPoolResult).value
...
def get_ipam_pool_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getIpamPool', __args__, opts=opts, typ=GetIpamPoolResult)
