...
class VerifierWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['VerifierWorkspacePropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['VerifierWorkspacePropertiesArgs']]):
...
class VerifierWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['VerifierWorkspacePropertiesArgs', 'VerifierWorkspacePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] network_manager_name: The name of the network manager.
        :param pulumi.Input[Union['VerifierWorkspacePropertiesArgs', 'VerifierWorkspacePropertiesArgsDict']] properties: Properties of Verifier Workspace resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] workspace_name: Workspace name.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VerifierWorkspaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VerifierWorkspaceArgs.__new__(VerifierWorkspaceArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20240101preview:VerifierWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VerifierWorkspace, __self__).__init__(
            'azure-native:network/v20240501:VerifierWorkspace',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VerifierWorkspace':
        """
        ...
        __props__.__dict__["type"] = None
        return VerifierWorkspace(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VerifierWorkspacePropertiesResponse']:
        """
        Properties of Verifier Workspace resource.
        """
        return pulumi.get(self, "properties")
