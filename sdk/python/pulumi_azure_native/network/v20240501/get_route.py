...
def get_route(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getRoute', __args__, opts=opts, typ=GetRouteResult)
