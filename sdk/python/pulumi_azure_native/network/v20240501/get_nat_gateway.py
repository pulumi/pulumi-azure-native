...
def get_nat_gateway(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
...
def get_nat_gateway_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult)
