...
class NetworkManager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20210501preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220201preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220401preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220701:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20220901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20221101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230201:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230401:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230501:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230601:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20230901:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20231101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240101preview:NetworkManager"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkManager"), pulumi.Alias(type_="azure-native:network:NetworkManager")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkManager, __self__).__init__(
            'azure-native:network/v20240501:NetworkManager',
            resource_name,
            __props__,
            opts)
