...
def get_reachability_analysis_run(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getReachabilityAnalysisRun', __args__, opts=opts, typ=GetReachabilityAnalysisRunResult).value
...
def get_reachability_analysis_run_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getReachabilityAnalysisRun', __args__, opts=opts, typ=GetReachabilityAnalysisRunResult)
