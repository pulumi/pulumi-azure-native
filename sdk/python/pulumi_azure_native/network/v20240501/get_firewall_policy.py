...
def get_firewall_policy(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult).value
...
def get_firewall_policy_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult)
