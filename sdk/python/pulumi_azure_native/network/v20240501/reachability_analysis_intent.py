...
class ReachabilityAnalysisIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:ReachabilityAnalysisIntent"), pulumi.Alias(type_="azure-native:network/v20240101preview:ReachabilityAnalysisIntent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReachabilityAnalysisIntent, __self__).__init__(
            'azure-native:network/v20240501:ReachabilityAnalysisIntent',
            resource_name,
            __props__,
            opts)
