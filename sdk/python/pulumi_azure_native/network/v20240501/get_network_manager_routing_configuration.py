...
def get_network_manager_routing_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getNetworkManagerRoutingConfiguration', __args__, opts=opts, typ=GetNetworkManagerRoutingConfigurationResult).value
...
def get_network_manager_routing_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getNetworkManagerRoutingConfiguration', __args__, opts=opts, typ=GetNetworkManagerRoutingConfigurationResult)
