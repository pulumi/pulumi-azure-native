...
def get_reachability_analysis_intent(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getReachabilityAnalysisIntent', __args__, opts=opts, typ=GetReachabilityAnalysisIntentResult).value
...
def get_reachability_analysis_intent_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getReachabilityAnalysisIntent', __args__, opts=opts, typ=GetReachabilityAnalysisIntentResult)
