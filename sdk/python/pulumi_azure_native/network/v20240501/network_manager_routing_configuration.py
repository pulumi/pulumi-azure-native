...
class NetworkManagerRoutingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkManagerRoutingConfiguration"), pulumi.Alias(type_="azure-native:network/v20240301:NetworkManagerRoutingConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkManagerRoutingConfiguration, __self__).__init__(
            'azure-native:network/v20240501:NetworkManagerRoutingConfiguration',
            resource_name,
            __props__,
            opts)
