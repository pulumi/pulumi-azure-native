...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult).value
...
def get_ddos_protection_plan_output(ddos_protection_plan_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult)
