...
def get_security_user_rule_collection(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getSecurityUserRuleCollection', __args__, opts=opts, typ=GetSecurityUserRuleCollectionResult).value
...
def get_security_user_rule_collection_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getSecurityUserRuleCollection', __args__, opts=opts, typ=GetSecurityUserRuleCollectionResult)
