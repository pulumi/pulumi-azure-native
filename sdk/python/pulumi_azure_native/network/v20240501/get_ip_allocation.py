...
def get_ip_allocation(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getIpAllocation', __args__, opts=opts, typ=GetIpAllocationResult).value
...
def get_ip_allocation_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getIpAllocation', __args__, opts=opts, typ=GetIpAllocationResult)
