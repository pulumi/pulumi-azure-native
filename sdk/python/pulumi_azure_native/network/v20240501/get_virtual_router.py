...
def get_virtual_router(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult).value
...
def get_virtual_router_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult)
