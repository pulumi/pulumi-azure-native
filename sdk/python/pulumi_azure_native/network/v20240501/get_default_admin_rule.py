...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
...
def get_default_admin_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult)
