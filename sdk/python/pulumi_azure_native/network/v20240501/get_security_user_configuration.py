...
def get_security_user_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240501:getSecurityUserConfiguration', __args__, opts=opts, typ=GetSecurityUserConfigurationResult).value
...
def get_security_user_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240501:getSecurityUserConfiguration', __args__, opts=opts, typ=GetSecurityUserConfigurationResult)
