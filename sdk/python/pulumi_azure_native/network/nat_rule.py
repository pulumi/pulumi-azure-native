...
class NatRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the VpnGateway.
