...
class NatRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/latest:NatRule"), pulumi.Alias(type_="azure-nextgen:network/latest:NatRule"), pulumi.Alias(type_="azure-native:network/v20200801:NatRule"), pulumi.Alias(type_="azure-nextgen:network/v20200801:NatRule")])
