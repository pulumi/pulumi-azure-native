...
def get_nsp_association(association_name: Optional[builtins.str] = None,
...
def get_nsp_association_output(association_name: Optional[pulumi.Input[builtins.str]] = None,
