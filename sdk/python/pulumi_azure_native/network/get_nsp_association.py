...
def get_nsp_association(association_name: Optional[_builtins.str] = None,
                        network_security_perimeter_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str association_name: The name of the NSP association.
...
def get_nsp_association_output(association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
