...
def get_network_interface(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_interface is deprecated: azure-native:network/v20220101:NetworkInterface is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterface to guarantee forwards compatibility.""")
    __args__ = dict()
