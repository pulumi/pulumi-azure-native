...
warnings.warn("""azure-native:network/v20220101:NetworkGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:NetworkGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_group(network_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_group is deprecated: azure-native:network/v20220101:NetworkGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:NetworkGroup to guarantee forwards compatibility.""")
    __args__ = dict()
