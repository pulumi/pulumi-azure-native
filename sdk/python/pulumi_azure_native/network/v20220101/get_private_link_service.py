...
def get_private_link_service(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_service is deprecated: azure-native:network/v20220101:PrivateLinkService is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:PrivateLinkService to guarantee forwards compatibility.""")
    __args__ = dict()
