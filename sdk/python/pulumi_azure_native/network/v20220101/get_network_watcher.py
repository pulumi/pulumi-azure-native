...
def get_network_watcher(network_watcher_name: Optional[str] = None,
    ...
    return AwaitableGetNetworkWatcherResult(
        ...
        running_operation_ids=pulumi.get(__ret__, 'running_operation_ids'),
        tags=pulumi.get(__ret__, 'tags'),
        type=pulumi.get(__ret__, 'type'))
def get_network_watcher_output(network_watcher_name: Optional[pulumi.Input[str]] = None,
                               resource_group_name: Optional[pulumi.Input[str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkWatcherResult]:
    """
    Gets the specified network watcher by resource group.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220101:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult)
    return __ret__.apply(lambda __response__: GetNetworkWatcherResult(
        ...
        running_operation_ids=pulumi.get(__response__, 'running_operation_ids'),
