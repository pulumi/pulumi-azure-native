...
warnings.warn("""azure-native:network/v20220101:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_gateway_connection_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkGatewayConnection is deprecated: azure-native:network/v20220101:VirtualNetworkGatewayConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkGatewayConnection to guarantee forwards compatibility.""")
