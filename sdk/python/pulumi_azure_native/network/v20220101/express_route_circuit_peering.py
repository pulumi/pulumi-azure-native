...
warnings.warn("""azure-native:network/v20220101:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vlan_id: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCircuitPeering is deprecated: azure-native:network/v20220101:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitPeering to guarantee forwards compatibility.""")
