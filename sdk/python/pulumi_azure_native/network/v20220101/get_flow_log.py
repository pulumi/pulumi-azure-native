...
def get_flow_log(flow_log_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_flow_log is deprecated: azure-native:network/v20220101:FlowLog is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FlowLog to guarantee forwards compatibility.""")
    __args__ = dict()
