...
warnings.warn("""azure-native:network/v20220101:NetworkManager is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkManager to guarantee forwards compatibility.""", DeprecationWarning)
