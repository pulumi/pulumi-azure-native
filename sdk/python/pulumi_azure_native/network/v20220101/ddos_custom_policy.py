...
class DdosCustomPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 id: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 protocol_custom_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ProtocolCustomSettingsFormatArgs', 'ProtocolCustomSettingsFormatArgsDict']]]]] = None,
        ...
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ProtocolCustomSettingsFormatArgs', 'ProtocolCustomSettingsFormatArgsDict']]]] protocol_custom_settings: The protocol-specific DDoS policy customization parameters.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
