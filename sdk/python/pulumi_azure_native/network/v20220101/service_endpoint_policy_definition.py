...
warnings.warn("""azure-native:network/v20220101:ServiceEndpointPolicyDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicyDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServiceEndpointPolicyDefinition is deprecated: azure-native:network/v20220101:ServiceEndpointPolicyDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ServiceEndpointPolicyDefinition to guarantee forwards compatibility.""")
