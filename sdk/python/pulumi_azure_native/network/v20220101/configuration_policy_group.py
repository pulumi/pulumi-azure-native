...
class ConfigurationPolicyGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_server_configuration_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationPolicyGroup is deprecated: azure-native:network/v20220101:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConfigurationPolicyGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:ConfigurationPolicyGroup"), pulumi.Alias(type_="azure-native:network/v20210801:ConfigurationPolicyGroup"), pulumi.Alias(type_="azure-native:network/v20220501:ConfigurationPolicyGroup"), pulumi.Alias(type_="azure-native:network/v20220701:ConfigurationPolicyGroup"), pulumi.Alias(type_="azure-native:network/v20220901:ConfigurationPolicyGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationPolicyGroup, __self__).__init__(
            'azure-native:network/v20220101:ConfigurationPolicyGroup',
            resource_name,
            __props__,
            opts)
