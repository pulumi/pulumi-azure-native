...
warnings.warn("""azure-native:network/v20220101:NetworkInterface is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterface to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkInterface is deprecated: azure-native:network/v20220101:NetworkInterface is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterface to guarantee forwards compatibility.""")
