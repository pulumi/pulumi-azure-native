...
warnings.warn("""azure-native:network/v20220101:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetCustomIPPrefixResult:
    ...
    """
    def __init__(__self__, authorization_message=None, child_custom_ip_prefixes=None, cidr=None, commissioned_state=None, custom_ip_prefix_parent=None, etag=None, extended_location=None, failed_reason=None, id=None, location=None, name=None, no_internet_advertise=None, provisioning_state=None, public_ip_prefixes=None, resource_guid=None, signed_message=None, tags=None, type=None, zones=None):
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_ip_prefix is deprecated: azure-native:network/v20220101:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['customIpPrefixName'] = custom_ip_prefix_name
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220101:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult).value
