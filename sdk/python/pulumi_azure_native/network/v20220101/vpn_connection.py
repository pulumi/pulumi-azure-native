...
class VpnConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_link_connections: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VpnSiteLinkConnectionArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnConnection is deprecated: azure-native:network/v20220101:VpnConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.""")
