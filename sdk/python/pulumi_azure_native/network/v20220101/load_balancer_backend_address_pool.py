...
class LoadBalancerBackendAddressPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tunnel_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['GatewayLoadBalancerTunnelInterfaceArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""LoadBalancerBackendAddressPool is deprecated: azure-native:network/v20220101:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:LoadBalancerBackendAddressPool to guarantee forwards compatibility.""")
