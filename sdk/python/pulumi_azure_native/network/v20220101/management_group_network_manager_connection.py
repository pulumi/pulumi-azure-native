...
warnings.warn("""azure-native:network/v20220101:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagementGroupNetworkManagerConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 network_manager_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagementGroupNetworkManagerConnection is deprecated: azure-native:network/v20220101:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.""")
