...
class SubscriptionNetworkManagerConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20210501preview:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220201preview:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220401preview:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220501:SubscriptionNetworkManagerConnection"), pulumi.Alias(type_="azure-native:network/v20220701:SubscriptionNetworkManagerConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubscriptionNetworkManagerConnection, __self__).__init__(
            'azure-native:network/v20220101:SubscriptionNetworkManagerConnection',
            resource_name,
            __props__,
            opts)
