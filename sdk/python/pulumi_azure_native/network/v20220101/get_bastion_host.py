...
def get_bastion_host(bastion_host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bastion_host is deprecated: azure-native:network/v20220101:BastionHost is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:BastionHost to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['bastionHostName'] = bastion_host_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220101:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult).value
