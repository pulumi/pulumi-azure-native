...
warnings.warn("""azure-native:network/v20220101:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
class AdminRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_collection_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AdminRuleCollection is deprecated: azure-native:network/v20220101:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.""")
