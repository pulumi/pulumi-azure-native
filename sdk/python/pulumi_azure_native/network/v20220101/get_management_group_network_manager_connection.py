...
def get_management_group_network_manager_connection(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_group_network_manager_connection is deprecated: azure-native:network/v20220101:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['managementGroupId'] = management_group_id
    __args__['networkManagerConnectionName'] = network_manager_connection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220101:getManagementGroupNetworkManagerConnection', __args__, opts=opts, typ=GetManagementGroupNetworkManagerConnectionResult).value
