...
def get_express_route_circuit_connection(circuit_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: The name of the express route circuit connection.
