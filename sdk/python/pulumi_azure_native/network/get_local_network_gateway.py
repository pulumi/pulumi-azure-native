...
def get_local_network_gateway(local_network_gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str local_network_gateway_name: The name of the local network gateway.
...
def get_local_network_gateway_output(local_network_gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
