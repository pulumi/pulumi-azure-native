...
def get_nsp_link(link_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getNspLink', __args__, opts=opts, typ=GetNspLinkResult).value
...
def get_nsp_link_output(link_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
