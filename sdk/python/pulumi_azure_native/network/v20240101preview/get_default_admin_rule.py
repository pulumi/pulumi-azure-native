...
class GetDefaultAdminRuleResult:
    ...
    """
    def __init__(__self__, access=None, description=None, destination_port_ranges=None, destinations=None, direction=None, flag=None, id=None, kind=None, name=None, priority=None, protocol=None, provisioning_state=None, resource_guid=None, source_port_ranges=None, sources=None, system_data=None, type=None):
...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101preview:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
...
def get_default_admin_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101preview:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult)
