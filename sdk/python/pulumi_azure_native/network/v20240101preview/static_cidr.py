...
class StaticCidr(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240501:StaticCidr"), pulumi.Alias(type_="azure-native:network:StaticCidr")])
