...
class IpamPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:IpamPool"), pulumi.Alias(type_="azure-native:network/v20240501:IpamPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpamPool, __self__).__init__(
            'azure-native:network/v20240101preview:IpamPool',
            resource_name,
            __props__,
            opts)
