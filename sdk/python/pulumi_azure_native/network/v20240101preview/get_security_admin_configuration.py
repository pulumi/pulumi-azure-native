...
class GetSecurityAdminConfigurationResult:
    ...
    """
    def __init__(__self__, apply_on_network_intent_policy_based_services=None, description=None, id=None, name=None, network_group_address_space_aggregation_option=None, provisioning_state=None, resource_guid=None, system_data=None, type=None):
...
def get_security_admin_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101preview:getSecurityAdminConfiguration', __args__, opts=opts, typ=GetSecurityAdminConfigurationResult).value
...
def get_security_admin_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101preview:getSecurityAdminConfiguration', __args__, opts=opts, typ=GetSecurityAdminConfigurationResult)
