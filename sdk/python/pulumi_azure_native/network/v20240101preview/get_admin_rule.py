...
class GetAdminRuleResult:
    ...
    Network admin rule.
    """
    def __init__(__self__, access=None, description=None, destination_port_ranges=None, destinations=None, direction=None, id=None, kind=None, name=None, priority=None, protocol=None, provisioning_state=None, resource_guid=None, source_port_ranges=None, sources=None, system_data=None, type=None):
...
def get_admin_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101preview:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult).value
...
def get_admin_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101preview:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult)
