...
class VerifierWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VerifierWorkspace"), pulumi.Alias(type_="azure-native:network/v20240501:VerifierWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VerifierWorkspace, __self__).__init__(
            'azure-native:network/v20240101preview:VerifierWorkspace',
            resource_name,
            __props__,
            opts)
