...
def get_static_cidr(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101preview:getStaticCidr', __args__, opts=opts, typ=GetStaticCidrResult).value
...
def get_static_cidr_output(network_manager_name: Optional[pulumi.Input[str]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStaticCidrResult]:
    """
    Instance of StaticCidr resource.
