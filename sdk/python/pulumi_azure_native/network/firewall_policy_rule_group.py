...
class FirewallPolicyRuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200401:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20190601:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20190701:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20190801:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20190901:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20191101:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20191201:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20200301:network:FirewallPolicyRuleGroup"), pulumi.Alias(type_="azure-native_network_v20200401:network:FirewallPolicyRuleGroup")])
