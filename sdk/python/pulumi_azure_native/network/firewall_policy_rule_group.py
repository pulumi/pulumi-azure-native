...
class FirewallPolicyRuleGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] priority: Priority of the Firewall Policy Rule Group resource.
        :param pulumi.Input[builtins.str] rule_group_name: The name of the FirewallPolicyRuleGroup.
