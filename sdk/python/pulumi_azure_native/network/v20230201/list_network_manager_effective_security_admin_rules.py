...
def list_network_manager_effective_security_admin_rules(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:listNetworkManagerEffectiveSecurityAdminRules', __args__, opts=opts, typ=ListNetworkManagerEffectiveSecurityAdminRulesResult).value
...
def list_network_manager_effective_security_admin_rules_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualNetworkName'] = virtual_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:listNetworkManagerEffectiveSecurityAdminRules', __args__, opts=opts, typ=ListNetworkManagerEffectiveSecurityAdminRulesResult)
