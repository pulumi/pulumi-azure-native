...
def get_route(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:getRoute', __args__, opts=opts, typ=GetRouteResult).value
...
def get_route_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['routeTableName'] = route_table_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:getRoute', __args__, opts=opts, typ=GetRouteResult)
