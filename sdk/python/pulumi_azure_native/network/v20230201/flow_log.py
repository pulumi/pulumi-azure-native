...
class FlowLog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if flow_analytics_configuration is not None and not isinstance(flow_analytics_configuration, TrafficAnalyticsPropertiesArgs):
            ...
            if format is not None and not isinstance(format, FlowLogFormatParametersArgs):
                format = format or {}
                def _setter(key, value):
                    format[key] = value
            ...
            if retention_policy is not None and not isinstance(retention_policy, RetentionPolicyParametersArgs):
