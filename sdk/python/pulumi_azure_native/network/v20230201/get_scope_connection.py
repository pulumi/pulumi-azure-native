...
def get_scope_connection(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:getScopeConnection', __args__, opts=opts, typ=GetScopeConnectionResult).value
...
def get_scope_connection_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scopeConnectionName'] = scope_connection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:getScopeConnection', __args__, opts=opts, typ=GetScopeConnectionResult)
