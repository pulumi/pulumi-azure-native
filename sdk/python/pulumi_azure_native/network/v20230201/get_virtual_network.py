...
def get_virtual_network(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
...
def get_virtual_network_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['virtualNetworkName'] = virtual_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult)
