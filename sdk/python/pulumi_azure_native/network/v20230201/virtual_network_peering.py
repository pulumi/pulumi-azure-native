...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(remote_address_space, AddressSpaceArgs):
            ...
            if not isinstance(remote_bgp_communities, VirtualNetworkBgpCommunitiesArgs):
            ...
            if not isinstance(remote_virtual_network, SubResourceArgs):
            ...
            if not isinstance(remote_virtual_network_address_space, AddressSpaceArgs):
