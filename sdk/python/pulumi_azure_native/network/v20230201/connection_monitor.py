...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(destination, ConnectionMonitorDestinationArgs):
            ...
            if not isinstance(source, ConnectionMonitorSourceArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
