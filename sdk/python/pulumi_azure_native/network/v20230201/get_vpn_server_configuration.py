...
def get_vpn_server_configuration(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:getVpnServerConfiguration', __args__, opts=opts, typ=GetVpnServerConfigurationResult).value

    return AwaitableGetVpnServerConfigurationResult(
        aad_authentication_parameters=pulumi.get(__ret__, 'aad_authentication_parameters'),
        configuration_policy_groups=pulumi.get(__ret__, 'configuration_policy_groups'),
        etag=pulumi.get(__ret__, 'etag'),
        id=pulumi.get(__ret__, 'id'),
        location=pulumi.get(__ret__, 'location'),
        name=pulumi.get(__ret__, 'name'),
        p2_s_vpn_gateways=pulumi.get(__ret__, 'p2_s_vpn_gateways'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        radius_client_root_certificates=pulumi.get(__ret__, 'radius_client_root_certificates'),
        radius_server_address=pulumi.get(__ret__, 'radius_server_address'),
        radius_server_root_certificates=pulumi.get(__ret__, 'radius_server_root_certificates'),
        radius_server_secret=pulumi.get(__ret__, 'radius_server_secret'),
        radius_servers=pulumi.get(__ret__, 'radius_servers'),
        tags=pulumi.get(__ret__, 'tags'),
        type=pulumi.get(__ret__, 'type'),
        vpn_authentication_types=pulumi.get(__ret__, 'vpn_authentication_types'),
        vpn_client_ipsec_policies=pulumi.get(__ret__, 'vpn_client_ipsec_policies'),
...
def get_vpn_server_configuration_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vpnServerConfigurationName'] = vpn_server_configuration_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:getVpnServerConfiguration', __args__, opts=opts, typ=GetVpnServerConfigurationResult)
