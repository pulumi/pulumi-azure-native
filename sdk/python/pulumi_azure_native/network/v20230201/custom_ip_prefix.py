...
class CustomIPPrefixArgs:
    ...
    def _configure(
        ...
        if express_route_advertise is None and 'expressRouteAdvertise' in kwargs:
            express_route_advertise = kwargs['expressRouteAdvertise']
        if extended_location is None and 'extendedLocation' in kwargs:
            extended_location = kwargs['extendedLocation']
        if no_internet_advertise is None and 'noInternetAdvertise' in kwargs:
            no_internet_advertise = kwargs['noInternetAdvertise']
...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            custom_ip_prefix_parent = _utilities.configure(custom_ip_prefix_parent, SubResourceArgs, True)
