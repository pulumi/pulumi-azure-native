...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(subnet, SubnetArgs):
                subnet = subnet or {}
                def _setter(key, value):
                    subnet[key] = value
