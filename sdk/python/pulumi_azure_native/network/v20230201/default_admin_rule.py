...
class DefaultAdminRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20210501preview:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220101:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220201preview:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220401preview:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220501:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220701:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20220901:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20221101:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20230401:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20230501:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20230601:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20230901:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20231101:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20240101:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20240101preview:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20240301:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network/v20240501:DefaultAdminRule"), pulumi.Alias(type_="azure-native:network:DefaultAdminRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DefaultAdminRule, __self__).__init__(
            'azure-native:network/v20230201:DefaultAdminRule',
            resource_name,
            __props__,
            opts)
