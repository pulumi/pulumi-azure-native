...
class ConfigurationPolicyGroupArgs:
    ...
    def _configure(
        ...
        if vpn_server_configuration_name is None:
            raise TypeError("Missing 'vpn_server_configuration_name' argument")
        if configuration_policy_group_name is None and 'configurationPolicyGroupName' in kwargs:
            configuration_policy_group_name = kwargs['configurationPolicyGroupName']
        if is_default is None and 'isDefault' in kwargs:
            is_default = kwargs['isDefault']
        if policy_members is None and 'policyMembers' in kwargs:
            policy_members = kwargs['policyMembers']
