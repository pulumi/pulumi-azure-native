...
def get_static_member(network_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230201:getStaticMember', __args__, opts=opts, typ=GetStaticMemberResult).value
...
def get_static_member_output(network_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['staticMemberName'] = static_member_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230201:getStaticMember', __args__, opts=opts, typ=GetStaticMemberResult)
