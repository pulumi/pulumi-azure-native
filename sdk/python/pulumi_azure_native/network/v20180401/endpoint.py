...
azure-native:network/v20180401:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:Endpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20180401:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:Endpoint to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 weight: Optional[pulumi.Input[float]] = None,
                 __props__=None):
        pulumi.log.warn("""Endpoint is deprecated: Version 2018-04-01 will be removed in v2 of the provider.
azure-native:network/v20180401:Endpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220401preview:Endpoint to guarantee forwards compatibility.""")
