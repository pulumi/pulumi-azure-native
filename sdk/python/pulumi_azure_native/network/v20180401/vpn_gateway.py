...
azure-native:network/v20180401:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20180401:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnGateway is deprecated: Version 2018-04-01 will be removed in v2 of the provider.
azure-native:network/v20180401:VpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180701:VpnGateway to guarantee forwards compatibility.""")
