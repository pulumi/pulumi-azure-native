...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_address is deprecated: Version 2018-04-01 will be removed in v2 of the provider.
azure-native:network/v20180401:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:PublicIPAddress to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180401:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
