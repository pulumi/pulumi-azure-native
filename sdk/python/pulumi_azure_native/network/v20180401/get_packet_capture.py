...
def get_packet_capture(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_packet_capture is deprecated: Version v20180401 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
