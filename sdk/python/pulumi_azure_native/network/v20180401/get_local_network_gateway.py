...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_network_gateway is deprecated: Version v20180401 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180401:getLocalNetworkGateway', __args__, opts=opts, typ=GetLocalNetworkGatewayResult).value
