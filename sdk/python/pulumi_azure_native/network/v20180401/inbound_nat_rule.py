...
azure-native:network/v20180401:InboundNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20180401:InboundNatRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:InboundNatRule to guarantee forwards compatibility.""")
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/v20180401:InboundNatRule',
            resource_name,
            __props__,
            opts)
