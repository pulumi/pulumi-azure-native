...
def get_virtual_hub_route_table_v2(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the VirtualHubRouteTableV2.
    :param _builtins.str route_table_name: The name of the VirtualHubRouteTableV2.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getVirtualHubRouteTableV2', __args__, opts=opts, typ=GetVirtualHubRouteTableV2Result).value
