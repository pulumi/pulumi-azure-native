...
def list_firewall_policy_idps_signature(filters: Optional[Sequence[Union['FilterItems', 'FilterItemsDict']]] = None,
    ...
    :param _builtins.int results_per_page: The number of the results to return in each page
    :param _builtins.str search: Search term in all columns
    :param _builtins.int skip: The number of records matching the filter to skip
    """
    __args__ = dict()
