...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_azure_firewall is deprecated: azure-native:network/v20190901:AzureFirewall is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:AzureFirewall to guarantee forwards compatibility.""")
    __args__ = dict()
