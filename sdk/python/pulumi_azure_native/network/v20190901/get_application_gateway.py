...
def get_application_gateway(application_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_gateway is deprecated: azure-native:network/v20190901:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationGateway to guarantee forwards compatibility.""")
    __args__ = dict()
