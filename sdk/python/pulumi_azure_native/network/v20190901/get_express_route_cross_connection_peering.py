...
warnings.warn("""azure-native:network/v20190901:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_cross_connection_peering(cross_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_cross_connection_peering is deprecated: azure-native:network/v20190901:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""")
    __args__ = dict()
