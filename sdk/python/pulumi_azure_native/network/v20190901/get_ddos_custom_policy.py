...
warnings.warn("""azure-native:network/v20190901:DdosCustomPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220101:DdosCustomPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ddos_custom_policy(ddos_custom_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ddos_custom_policy is deprecated: azure-native:network/v20190901:DdosCustomPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220101:DdosCustomPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
