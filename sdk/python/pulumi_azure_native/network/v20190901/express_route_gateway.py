...
warnings.warn("""azure-native:network/v20190901:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['VirtualHubIdArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteGateway is deprecated: azure-native:network/v20190901:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""")
        ...
        super(ExpressRouteGateway, __self__).__init__(
            'azure-native:network/v20190901:ExpressRouteGateway',
            resource_name,
            __props__,
            opts)
