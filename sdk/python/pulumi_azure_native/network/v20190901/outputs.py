...
class ApplicationGatewayHttpListenerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] hostnames: List of Host names for HTTP Listener that allows special wildcard characters as well.
        :param str id: Resource ID.
...
class ManagedRuleOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str state: Describes the state of the managed rule. Defaults to Disabled if not specified.
        """
...
class ManagedRulesDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Allow to exclude some variable satisfy the condition for the WAF check.
        :param Sequence['ManagedRuleSetResponse'] managed_rule_sets: Describes the ruleSets that are associated with the policy.
        :param Sequence['OwaspCrsExclusionEntryResponse'] exclusions: Describes the Exclusions that are applied on the policy.
        """
...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str state: Describes if the policy is in enabled state or disabled state.
        """
        if file_upload_limit_in_mb is not None:
            pulumi.set(__self__, "file_upload_limit_in_mb", file_upload_limit_in_mb)
        if max_request_body_size_in_kb is not None:
...
class VirtualNetworkGatewayConnectionPropertiesFormatResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "connectionStatus":
            ...
            suggest = "shared_key"
        elif key == "trafficSelectorPolicies":
            suggest = "traffic_selector_policies"
    ...
    def __init__(__self__, *,
        ...
        :param float egress_bytes_transferred: The egress bytes transferred in this connection.
        :param float ingress_bytes_transferred: The ingress bytes transferred in this connection.
        :param str provisioning_state: The provisioning state of the virtual network gateway connection resource.
        :param str resource_guid: The resource GUID property of the virtual network gateway connection resource.
