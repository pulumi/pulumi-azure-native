...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vlan_id: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCrossConnectionPeering is deprecated: azure-native:network/v20190901:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""")
