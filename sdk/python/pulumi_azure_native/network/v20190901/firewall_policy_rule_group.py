...
class FirewallPolicyRuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[pulumi.InputType['FirewallPolicyFilterRuleArgs'], pulumi.InputType['FirewallPolicyNatRuleArgs']]]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallPolicyRuleGroup is deprecated: azure-native:network/v20190901:FirewallPolicyRuleGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200401:FirewallPolicyRuleGroup to guarantee forwards compatibility.""")
