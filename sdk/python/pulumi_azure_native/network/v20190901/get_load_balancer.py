...
def get_load_balancer(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_load_balancer is deprecated: azure-native:network/v20190901:LoadBalancer is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LoadBalancer to guarantee forwards compatibility.""")
    __args__ = dict()
