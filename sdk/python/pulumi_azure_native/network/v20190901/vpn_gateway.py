...
warnings.warn("""azure-native:network/v20190901:VpnGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnGateway to guarantee forwards compatibility.""", DeprecationWarning)
