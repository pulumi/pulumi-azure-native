...
class VirtualHubBgpConnectionArgs:
    ...
    def _configure(
        ...
        if 'hubVirtualNetworkConnection' in kwargs:
...
class VirtualHubBgpConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if hub_virtual_network_connection is not None and not isinstance(hub_virtual_network_connection, SubResourceArgs):
                hub_virtual_network_connection = hub_virtual_network_connection or {}
                def _setter(key, value):
                    hub_virtual_network_connection[key] = value
                SubResourceArgs._configure(_setter, **hub_virtual_network_connection)
