...
warnings.warn("""azure-native:network/v20200801:LocalNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LocalNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_local_network_gateway(local_network_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_local_network_gateway is deprecated: azure-native:network/v20200801:LocalNetworkGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LocalNetworkGateway to guarantee forwards compatibility.""")
    __args__ = dict()
