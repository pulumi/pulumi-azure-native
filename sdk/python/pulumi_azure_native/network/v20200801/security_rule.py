...
warnings.warn("""azure-native:network/v20200801:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class SecurityRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityRule is deprecated: azure-native:network/v20200801:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:SecurityRule to guarantee forwards compatibility.""")
        ...
        super(SecurityRule, __self__).__init__(
            'azure-native:network/v20200801:SecurityRule',
            resource_name,
            __props__,
            opts)
