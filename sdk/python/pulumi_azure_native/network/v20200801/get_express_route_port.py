...
warnings.warn("""azure-native:network/v20200801:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_port(express_route_port_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_port is deprecated: azure-native:network/v20200801:ExpressRoutePort is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePort to guarantee forwards compatibility.""")
    __args__ = dict()
