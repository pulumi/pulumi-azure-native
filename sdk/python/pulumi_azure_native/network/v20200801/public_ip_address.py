...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['PublicIPAddressArgs', 'PublicIPAddressArgsDict']] linked_public_ip_address: The source Public IP Address (IPv6) that links to this address (IPv4).
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[Union[str, 'PublicIpAddressMigrationPhase']] migration_phase: Migration phase of Public IP Address.
