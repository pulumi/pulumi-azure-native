...
def get_virtual_network(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network is deprecated: azure-native:network/v20200801:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetwork to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualNetworkName'] = virtual_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200801:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
