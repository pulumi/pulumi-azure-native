...
warnings.warn("""azure-native:network/v20200801:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:IpGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ip_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_group is deprecated: azure-native:network/v20200801:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:IpGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['ipGroupsName'] = ip_groups_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200801:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult).value
