...
warnings.warn("""azure-native:network/v20200801:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LoadBalancerBackendAddressPool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_load_balancer_backend_address_pool(backend_address_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_load_balancer_backend_address_pool is deprecated: azure-native:network/v20200801:LoadBalancerBackendAddressPool is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:LoadBalancerBackendAddressPool to guarantee forwards compatibility.""")
    __args__ = dict()
