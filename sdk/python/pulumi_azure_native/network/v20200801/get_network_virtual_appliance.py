...
warnings.warn("""azure-native:network/v20200801:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_virtual_appliance(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_virtual_appliance is deprecated: azure-native:network/v20200801:NetworkVirtualAppliance is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['networkVirtualApplianceName'] = network_virtual_appliance_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200801:getNetworkVirtualAppliance', __args__, opts=opts, typ=GetNetworkVirtualApplianceResult).value
