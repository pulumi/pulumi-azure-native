...
warnings.warn("""azure-native:network/v20200801:VpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnServerConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_vpn_server_configuration(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_server_configuration is deprecated: azure-native:network/v20200801:VpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VpnServerConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
