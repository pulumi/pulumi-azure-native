...
warnings.warn("""azure-native:network/v20200801:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteGateway, __self__).__init__(
            'azure-native:network/v20200801:ExpressRouteGateway',
            resource_name,
            __props__,
            opts)
