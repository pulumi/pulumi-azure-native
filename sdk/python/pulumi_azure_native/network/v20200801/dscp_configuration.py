...
class DscpConfiguration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20200801:DscpConfiguration"), pulumi.Alias(type_="azure-native:network:DscpConfiguration"), pulumi.Alias(type_="azure-nextgen:network:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/latest:DscpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/latest:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20200601:DscpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200601:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20200701:DscpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20200701:DscpConfiguration"), pulumi.Alias(type_="azure-native:network/v20201101:DscpConfiguration"), pulumi.Alias(type_="azure-nextgen:network/v20201101:DscpConfiguration")])
    ...
    def get(resource_name: str,
        ...
        __props__["associated_network_interfaces"] = None
        __props__["destination_ip_ranges"] = None
        __props__["destination_port_ranges"] = None
        __props__["etag"] = None
        __props__["location"] = None
        __props__["markings"] = None
        __props__["name"] = None
        __props__["protocol"] = None
        __props__["provisioning_state"] = None
        __props__["qos_collection_id"] = None
        __props__["resource_guid"] = None
        __props__["source_ip_ranges"] = None
