...
def get_virtual_appliance_site(network_virtual_appliance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_appliance_site is deprecated: azure-native:network/v20200801:VirtualApplianceSite is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.""")
    __args__ = dict()
