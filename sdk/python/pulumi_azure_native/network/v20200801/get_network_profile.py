...
def get_network_profile(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_profile is deprecated: azure-native:network/v20200801:NetworkProfile is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkProfile to guarantee forwards compatibility.""")
    __args__ = dict()
