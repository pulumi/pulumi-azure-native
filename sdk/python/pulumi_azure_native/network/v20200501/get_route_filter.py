...
def get_route_filter(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter is deprecated: azure-native:network/v20200501:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteFilter to guarantee forwards compatibility.""")
    __args__ = dict()
