...
def get_firewall_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_policy is deprecated: azure-native:network/v20200501:FirewallPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210801:FirewallPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
