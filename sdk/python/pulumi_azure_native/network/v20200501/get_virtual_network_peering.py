...
warnings.warn("""azure-native:network/v20200501:VirtualNetworkPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_peering(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_peering is deprecated: azure-native:network/v20200501:VirtualNetworkPeering is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkPeering to guarantee forwards compatibility.""")
    __args__ = dict()
