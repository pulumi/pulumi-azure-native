...
def get_firewall_policy_rule_collection_group(firewall_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_policy_rule_collection_group is deprecated: azure-native:network/v20200501:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""")
    __args__ = dict()
