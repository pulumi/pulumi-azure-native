...
class RulesEngine(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rules_engine = azure_native.network.v20200501.RulesEngine("rulesEngine",
            front_door_name="frontDoor1",
            resource_group_name="rg1",
            rules=[
                {
                    "action": azure_native.network.v20200501.RulesEngineActionArgs(
                        route_configuration_override=azure_native.network.v20200501.RedirectConfigurationArgs(
                    ...
                    "matchConditions": [azure_native.network.v20200501.RulesEngineMatchConditionArgs(
                ...
                {
                    "action": {
                        "responseHeaderActions": [azure_native.network.v20200501.HeaderActionArgs(
                ...
                {
                    "action": azure_native.network.v20200501.RulesEngineActionArgs(
                        route_configuration_override=azure_native.network.v20200501.ForwardingConfigurationArgs(
                            backend_pool=azure_native.network.v20200501.SubResourceArgs(
                                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/backendPools/backendPool1",
                            ),
                            cache_configuration=azure_native.network.v20200501.CacheConfigurationArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20200501:RulesEngine rulesEngine1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/rulesEngines/rulesEngine1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200401:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20210601:RulesEngine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RulesEngine, __self__).__init__(
            'azure-native:network/v20200501:RulesEngine',
            resource_name,
            __props__,
            opts)
