...
def get_virtual_hub_bgp_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_bgp_connection is deprecated: azure-native:network/v20200501:VirtualHubBgpConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubBgpConnection to guarantee forwards compatibility.""")
    __args__ = dict()
