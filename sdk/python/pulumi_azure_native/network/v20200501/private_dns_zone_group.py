...
warnings.warn("""azure-native:network/v20200501:PrivateDnsZoneGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateDnsZoneGroup to guarantee forwards compatibility.""", DeprecationWarning)
