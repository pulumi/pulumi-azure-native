...
warnings.warn("""azure-native:network/v20200501:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualApplianceSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 site_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualApplianceSite is deprecated: azure-native:network/v20200501:VirtualApplianceSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualApplianceSite to guarantee forwards compatibility.""")
