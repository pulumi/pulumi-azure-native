...
class ExpressRouteCircuitAuthorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCircuitAuthorization is deprecated: azure-native:network/v20200501:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.""")
