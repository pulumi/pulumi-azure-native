...
warnings.warn("""azure-native:network/v20200501:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vlan_id: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCrossConnectionPeering is deprecated: azure-native:network/v20200501:ExpressRouteCrossConnectionPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteCrossConnectionPeering to guarantee forwards compatibility.""")
