...
warnings.warn("""azure-native:network/v20200501:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_tap: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkTapArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkInterfaceTapConfiguration is deprecated: azure-native:network/v20200501:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""")
