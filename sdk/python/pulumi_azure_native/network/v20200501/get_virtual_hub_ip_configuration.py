...
def get_virtual_hub_ip_configuration(ip_config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_ip_configuration is deprecated: azure-native:network/v20200501:VirtualHubIpConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubIpConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
