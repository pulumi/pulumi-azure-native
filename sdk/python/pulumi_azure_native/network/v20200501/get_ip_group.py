...
def get_ip_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_group is deprecated: azure-native:network/v20200501:IpGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:IpGroup to guarantee forwards compatibility.""")
    __args__ = dict()
