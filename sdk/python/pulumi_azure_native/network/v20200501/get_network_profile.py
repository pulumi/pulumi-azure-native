...
warnings.warn("""azure-native:network/v20200501:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_profile(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_profile is deprecated: azure-native:network/v20200501:NetworkProfile is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkProfile to guarantee forwards compatibility.""")
    __args__ = dict()
