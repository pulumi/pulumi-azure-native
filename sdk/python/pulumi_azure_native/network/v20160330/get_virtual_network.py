...
def get_virtual_network(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network is deprecated: Version v20160330 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20160330:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
