...
class ApplicationGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApplicationGatewayProbeArgs']]] probes: Gets or sets probes of application gateway resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApplicationGatewayUrlPathMapArgs']]] url_path_maps: Gets or sets URL path map of application gateway resource
        """
...
azure-native:network/v20160330:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ApplicationGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20160330:ApplicationGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:ApplicationGateway to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] id: Resource Id
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApplicationGatewayProbeArgs']]]] probes: Gets or sets probes of application gateway resource
        :param pulumi.Input[str] provisioning_state: Gets or sets Provisioning state of the ApplicationGateway resource Updating/Deleting/Failed
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApplicationGatewayUrlPathMapArgs']]]] url_path_maps: Gets or sets URL path map of application gateway resource
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
                 ...
                 url_path_maps: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApplicationGatewayUrlPathMapArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationGateway is deprecated: Version 2016-03-30 will be removed in v2 of the provider.
