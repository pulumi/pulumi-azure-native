...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_type: Optional[pulumi.Input[Union[str, 'VpnType']]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkGateway is deprecated: Version 2017-11-01 will be removed in v2 of the provider.""")
