...
azure-native:network/v20171101:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:SecurityRule to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20171101:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:SecurityRule to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityRule is deprecated: Version 2017-11-01 will be removed in v2 of the provider.
azure-native:network/v20171101:SecurityRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:SecurityRule to guarantee forwards compatibility.""")
        ...
        super(SecurityRule, __self__).__init__(
            'azure-native:network/v20171101:SecurityRule',
            resource_name,
            __props__,
            opts)
