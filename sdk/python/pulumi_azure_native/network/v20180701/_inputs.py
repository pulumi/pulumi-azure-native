...
__all__ = [
    ...
    'ApplicationGatewayAutoscaleBoundsArgsDict',
...
if not MYPY:
    class ApplicationGatewayAutoscaleBoundsArgsDict(TypedDict):
        """
    ...
    ApplicationGatewayAutoscaleBoundsArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ApplicationGatewayAutoscaleConfigurationArgsDict(TypedDict):
        ...
        """
        bounds: pulumi.Input['ApplicationGatewayAutoscaleBoundsArgsDict']
        """
        Autoscale bounds
        """
elif False:
...
if not MYPY:
    class AzureFirewallIPConfigurationArgsDict(TypedDict):
        ...
        Resource ID.
        """
        internal_public_ip_address: NotRequired[pulumi.Input['SubResourceArgsDict']]
        """
