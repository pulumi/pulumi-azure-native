...
class DevicePropertiesResponse(dict):
    ...
    def _configure(
        ...
        if link_speed_in_mbps is None and 'linkSpeedInMbps' in kwargs:
            link_speed_in_mbps = kwargs['linkSpeedInMbps']
...
class VpnConnectionResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if connection_bandwidth_in_mbps is None and 'connectionBandwidthInMbps' in kwargs:
            connection_bandwidth_in_mbps = kwargs['connectionBandwidthInMbps']
        if connection_bandwidth_in_mbps is None:
            raise TypeError("Missing 'connection_bandwidth_in_mbps' argument")
