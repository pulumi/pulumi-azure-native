...
warnings.warn("""azure-native:network/v20180701:ApplicationSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_security_group(application_security_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_security_group is deprecated: azure-native:network/v20180701:ApplicationSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ApplicationSecurityGroup to guarantee forwards compatibility.""")
    __args__ = dict()
