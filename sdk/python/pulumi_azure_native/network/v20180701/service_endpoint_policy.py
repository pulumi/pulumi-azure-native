...
class ServiceEndpointPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service_endpoint_policy = azure_native.network.v20180701.ServiceEndpointPolicy("serviceEndpointPolicy",
        ...
        service_endpoint_policy = azure_native.network.v20180701.ServiceEndpointPolicy("serviceEndpointPolicy",
            resource_group_name="rg1",
            service_endpoint_policy_definitions=[azure_native.network.v20180701.ServiceEndpointPolicyDefinitionArgs(
