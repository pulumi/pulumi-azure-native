...
class PacketCapture(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 total_bytes_per_session: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""PacketCapture is deprecated: azure-native:network/v20180701:PacketCapture is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PacketCapture to guarantee forwards compatibility.""")
