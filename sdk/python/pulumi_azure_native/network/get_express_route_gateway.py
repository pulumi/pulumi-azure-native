...
def get_express_route_gateway(express_route_gateway_name: Optional[_builtins.str] = None,
...
def get_express_route_gateway_output(express_route_gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
