...
def get_express_route_cross_connection_peering(cross_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cross_connection_name: The name of the ExpressRouteCrossConnection.
...
def get_express_route_cross_connection_peering_output(cross_connection_name: Optional[pulumi.Input[_builtins.str]] = None,
