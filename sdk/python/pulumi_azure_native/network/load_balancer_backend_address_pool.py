...
class LoadBalancerBackendAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the backend address pool.
        :param pulumi.Input[_builtins.str] name: The name of the resource that is unique within the set of backend address pools used by the load balancer. This name can be used to access the resource.
        :param pulumi.Input[Union[_builtins.str, 'SyncMode']] sync_mode: Backend address synchronous mode for the backend pool
