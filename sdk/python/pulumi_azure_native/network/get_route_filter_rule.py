...
def get_route_filter_rule(resource_group_name: Optional[_builtins.str] = None,
                          route_filter_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str route_filter_name: The name of the route filter.
