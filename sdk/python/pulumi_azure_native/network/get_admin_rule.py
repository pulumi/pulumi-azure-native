...
def get_admin_rule(configuration_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult).value
...
def get_admin_rule_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getAdminRule', __args__, opts=opts, typ=GetAdminRuleResult)
