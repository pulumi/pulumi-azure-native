...
class GetInboundNatRuleResult:
    ...
    def enable_floating_ip(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_tcp_reset(self) -> Optional[builtins.bool]:
        """
...
def get_inbound_nat_rule(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str inbound_nat_rule_name: The name of the inbound NAT rule.
...
def get_inbound_nat_rule_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult)
