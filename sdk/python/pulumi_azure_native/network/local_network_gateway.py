...
class LocalNetworkGatewayInitArgs:
    def __init__(__self__, *,
                 ...
                 local_network_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] fqdn: FQDN of local network gateway.
        :param pulumi.Input[builtins.str] gateway_ip_address: IP address of local network gateway.
        ...
        :param pulumi.Input[builtins.str] local_network_gateway_name: The name of the local network gateway.
    ...
    def local_network_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def local_network_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="gatewayIpAddress")
    def gateway_ip_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IP address of local network gateway.
        """
        return pulumi.get(self, "gateway_ip_address")
