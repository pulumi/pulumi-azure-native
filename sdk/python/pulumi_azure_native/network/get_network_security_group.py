...
def get_network_security_group(expand: Optional[_builtins.str] = None,
                               network_security_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_security_group_name: The name of the network security group.
...
def get_network_security_group_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                      network_security_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
