...
def get_security_rule(network_security_group_name: Optional[_builtins.str] = None,
                      resource_group_name: Optional[_builtins.str] = None,
                      security_rule_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_rule_name: The name of the security rule.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult).value
