...
azure-native:network/v20171001:Zone is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230701preview:Zone to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20171001:Zone is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230701preview:Zone to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20171001:getZone', __args__, opts=opts, typ=GetZoneResult).value
