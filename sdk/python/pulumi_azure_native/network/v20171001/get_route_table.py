...
def get_route_table(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_table is deprecated: Version v20171001 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20171001:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
