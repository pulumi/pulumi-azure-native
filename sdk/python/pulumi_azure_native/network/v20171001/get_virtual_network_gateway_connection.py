...
class GetVirtualNetworkGatewayConnectionResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.VirtualNetworkGatewayConnectionPropertiesFormatResponse':
        """
...
def get_virtual_network_gateway_connection(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_gateway_connection is deprecated: Version 2017-10-01 will be removed in v2 of the provider.""")
    __args__ = dict()
