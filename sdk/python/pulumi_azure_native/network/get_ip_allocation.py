...
def get_ip_allocation(expand: Optional[_builtins.str] = None,
                      ip_allocation_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip_allocation_name: The name of the IpAllocation.
...
def get_ip_allocation_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             ip_allocation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
