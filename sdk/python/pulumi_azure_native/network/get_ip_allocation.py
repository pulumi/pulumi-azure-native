...
class GetIpAllocationResult:
    ...
    def allocation_tags(self) -> Optional[Mapping[str, builtins.str]]:
        """
        IpAllocation tags.
        """
    ...
    def ipam_allocation_id(self) -> Optional[builtins.str]:
        """
...
def get_ip_allocation(expand: Optional[builtins.str] = None,
                      ip_allocation_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_allocation_name: The name of the IpAllocation.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getIpAllocation', __args__, opts=opts, typ=GetIpAllocationResult).value
...
def get_ip_allocation_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ip_allocation_name: Optional[pulumi.Input[builtins.str]] = None,
