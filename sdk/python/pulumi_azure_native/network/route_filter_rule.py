...
class RouteFilterRuleInitArgs:
    def __init__(__self__, *,
        ...
        """
        RouteFilterRuleInitArgs._configure(
    ...
    def _configure(
        ...
        if route_filter_name is None:
            raise TypeError("Missing 'route_filter_name' argument")
...
class RouteFilterRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Other available API versions: 2017-03-01, 2017-10-01, 2023-04-01, 2023-05-01.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RouteFilterRuleInitArgs._configure(_setter, **kwargs)
