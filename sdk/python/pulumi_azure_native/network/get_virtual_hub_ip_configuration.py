...
def get_virtual_hub_ip_configuration(ip_config_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip_config_name: The name of the ipconfig.
...
def get_virtual_hub_ip_configuration_output(ip_config_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
