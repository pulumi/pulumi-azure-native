...
class VirtualNetworkGatewayConnectionArgs:
    ...
    def _configure(
        ...
        if 'virtualNetworkGateway1' in kwargs:
        ...
        if 'useLocalAzureIpAddress' in kwargs:
        ...
        if 'virtualNetworkGateway2' in kwargs:
            virtual_network_gateway2 = kwargs['virtualNetworkGateway2']
        if 'virtualNetworkGatewayConnectionName' in kwargs:
...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if local_network_gateway2 is not None and not isinstance(local_network_gateway2, LocalNetworkGatewayArgs):
            ...
            if peer is not None and not isinstance(peer, SubResourceArgs):
                peer = peer or {}
                def _setter(key, value):
                    peer[key] = value
            ...
            if virtual_network_gateway1 is not None and not isinstance(virtual_network_gateway1, VirtualNetworkGatewayArgs):
            ...
            if virtual_network_gateway2 is not None and not isinstance(virtual_network_gateway2, VirtualNetworkGatewayArgs):
