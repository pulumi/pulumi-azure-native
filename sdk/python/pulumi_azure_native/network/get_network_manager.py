...
def get_network_manager(network_manager_name: Optional[_builtins.str] = None,
...
def get_network_manager_output(network_manager_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
