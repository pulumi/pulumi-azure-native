...
def get_network_manager_routing_configuration(configuration_name: Optional[_builtins.str] = None,
...
def get_network_manager_routing_configuration_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
