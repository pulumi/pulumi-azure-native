...
def get_network_manager_routing_configuration(configuration_name: Optional[builtins.str] = None,
...
def get_network_manager_routing_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
