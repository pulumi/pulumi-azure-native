...
def get_vpn_server_configuration(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vpn_server_configuration_name: The name of the VpnServerConfiguration being retrieved.
    """
    __args__ = dict()
...
def get_vpn_server_configuration_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
