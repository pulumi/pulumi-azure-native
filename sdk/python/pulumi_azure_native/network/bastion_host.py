...
class BastionHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20190601:BastionHost"), pulumi.Alias(type_="azure-native:network/v20190701:BastionHost"), pulumi.Alias(type_="azure-native:network/v20190801:BastionHost"), pulumi.Alias(type_="azure-native:network/v20190901:BastionHost"), pulumi.Alias(type_="azure-native:network/v20191101:BastionHost"), pulumi.Alias(type_="azure-native:network/v20200401:BastionHost"), pulumi.Alias(type_="azure-native:network/v20200501:BastionHost"), pulumi.Alias(type_="azure-native:network/v20200601:BastionHost"), pulumi.Alias(type_="azure-native:network/v20201101:BastionHost"), pulumi.Alias(type_="azure-native:network/v20210201:BastionHost"), pulumi.Alias(type_="azure-native:network/v20210301:BastionHost"), pulumi.Alias(type_="azure-native:network/v20210801:BastionHost"), pulumi.Alias(type_="azure-native:network/v20220101:BastionHost"), pulumi.Alias(type_="azure-native:network/v20220501:BastionHost"), pulumi.Alias(type_="azure-native:network/v20220701:BastionHost"), pulumi.Alias(type_="azure-native:network/v20220901:BastionHost"), pulumi.Alias(type_="azure-native:network/v20221101:BastionHost")])
