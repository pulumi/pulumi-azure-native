...
class BastionHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_ip_connect: Enable/Disable IP Connect feature of the Bastion Host resource.
        :param pulumi.Input[_builtins.bool] enable_kerberos: Enable/Disable Kerberos feature of the Bastion Host resource.
        :param pulumi.Input[_builtins.bool] enable_private_only_bastion: Enable/Disable Private Only feature of the Bastion Host resource.
        :param pulumi.Input[_builtins.bool] enable_session_recording: Enable/Disable Session Recording feature of the Bastion Host resource.
        :param pulumi.Input[_builtins.bool] enable_shareable_link: Enable/Disable Shareable Link of the Bastion Host resource.
        :param pulumi.Input[_builtins.bool] enable_tunneling: Enable/Disable Tunneling feature of the Bastion Host resource.
        ...
        :param pulumi.Input[_builtins.int] scale_units: The scale units for the Bastion Host resource.
