...
def get_network_profile(expand: Optional[_builtins.str] = None,
                        network_profile_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_profile_name: The name of the public IP prefix.
...
def get_network_profile_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
