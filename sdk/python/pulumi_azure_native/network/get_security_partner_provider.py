...
class GetSecurityPartnerProviderResult:
    ...
    def security_provider_name(self) -> Optional[builtins.str]:
        """
...
def get_security_partner_provider(resource_group_name: Optional[builtins.str] = None,
                                  security_partner_provider_name: Optional[builtins.str] = None,
    ...
    :param builtins.str security_partner_provider_name: The name of the Security Partner Provider.
    """
    __args__ = dict()
...
def get_security_partner_provider_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                         security_partner_provider_name: Optional[pulumi.Input[builtins.str]] = None,
