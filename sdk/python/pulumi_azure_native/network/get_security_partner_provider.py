...
def get_security_partner_provider(resource_group_name: Optional[_builtins.str] = None,
                                  security_partner_provider_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_partner_provider_name: The name of the Security Partner Provider.
    """
    __args__ = dict()
...
def get_security_partner_provider_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
