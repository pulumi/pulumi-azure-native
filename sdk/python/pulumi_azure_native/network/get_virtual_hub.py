...
def get_virtual_hub(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult).value
...
def get_virtual_hub_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult)
