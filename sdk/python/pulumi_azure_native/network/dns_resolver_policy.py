...
class DnsResolverPolicyArgs:
    def __init__(__self__, *,
        ...
        if dns_resolver_policy_name is not None:
    ...
    def dns_resolver_policy_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def dns_resolver_policy_name(self, value: Optional[pulumi.Input[str]]):
...
class DnsResolverPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsResolverPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnsResolverPolicyArgs.__new__(DnsResolverPolicyArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsResolverPolicy, __self__).__init__(
            'azure-native:network:DnsResolverPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DnsResolverPolicy':
        """
        ...
        __props__.__dict__["type"] = None
        return DnsResolverPolicy(resource_name, opts=opts, __props__=__props__)
