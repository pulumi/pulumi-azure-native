...
class NspAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspAssociation"), pulumi.Alias(type_="azure-native_network_v20210201preview:network:NspAssociation"), pulumi.Alias(type_="azure-native_network_v20230701preview:network:NspAssociation"), pulumi.Alias(type_="azure-native_network_v20230801preview:network:NspAssociation"), pulumi.Alias(type_="azure-native_network_v20240601preview:network:NspAssociation")])
