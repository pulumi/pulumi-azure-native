...
class NetworkVirtualApplianceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cloud_init_configuration: CloudInitConfiguration string in plain text.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cloud_init_configuration_blobs: CloudInitConfigurationBlob storage URLs.
