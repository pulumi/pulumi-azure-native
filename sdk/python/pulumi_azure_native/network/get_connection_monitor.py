...
class GetConnectionMonitorResult:
    ...
    def auto_start(self) -> Optional[builtins.bool]:
        """
    ...
    def connection_monitor_type(self) -> builtins.str:
        """
    ...
    def monitoring_interval_in_seconds(self) -> Optional[builtins.int]:
        """
...
def get_connection_monitor(connection_monitor_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_monitor_name: The name of the connection monitor.
    :param builtins.str network_watcher_name: The name of the Network Watcher resource.
    :param builtins.str resource_group_name: The name of the resource group containing Network Watcher.
    """
    __args__ = dict()
...
def get_connection_monitor_output(connection_monitor_name: Optional[pulumi.Input[builtins.str]] = None,
