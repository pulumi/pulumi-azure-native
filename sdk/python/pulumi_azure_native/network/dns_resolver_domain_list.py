...
class DnsResolverDomainList(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230701preview:DnsResolverDomainList")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DnsResolverDomainList, __self__).__init__(
            'azure-native:network:DnsResolverDomainList',
            resource_name,
            __props__,
            opts)
