...
def get_nsp_profile(network_security_perimeter_name: Optional[_builtins.str] = None,
...
def get_nsp_profile_output(network_security_perimeter_name: Optional[pulumi.Input[_builtins.str]] = None,
