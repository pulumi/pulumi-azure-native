...
def get_route_filter(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter is deprecated: Version 2017-08-01 will be removed in v2 of the provider.
azure-native:network/v20170801:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190801:RouteFilter to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170801:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult).value
