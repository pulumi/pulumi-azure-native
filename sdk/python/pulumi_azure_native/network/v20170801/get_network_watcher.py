...
def get_network_watcher(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_watcher is deprecated: Version v20170801 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170801:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult).value
