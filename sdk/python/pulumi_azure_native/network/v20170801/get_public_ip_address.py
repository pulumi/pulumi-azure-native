...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_address is deprecated: Version v20170801 will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
