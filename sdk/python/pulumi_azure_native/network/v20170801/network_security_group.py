...
azure-native:network/v20170801:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:network/v20170801:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkSecurityGroup is deprecated: Version 2017-08-01 will be removed in v2 of the provider.
azure-native:network/v20170801:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:NetworkSecurityGroup to guarantee forwards compatibility.""")
