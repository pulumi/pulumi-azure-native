...
warnings.warn("""azure-native:network/v20220501:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class FirewallPolicyRuleCollectionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_collections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[pulumi.InputType['FirewallPolicyFilterRuleCollectionArgs'], pulumi.InputType['FirewallPolicyNatRuleCollectionArgs']]]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallPolicyRuleCollectionGroup is deprecated: azure-native:network/v20220501:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""")
