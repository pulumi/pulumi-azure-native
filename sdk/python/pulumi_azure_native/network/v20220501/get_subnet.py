...
def get_subnet(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subnet is deprecated: azure-native:network/v20220501:Subnet is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220701:Subnet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220501:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
