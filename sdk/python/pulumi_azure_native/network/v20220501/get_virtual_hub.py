...
warnings.warn("""azure-native:network/v20220501:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHub to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_hub(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub is deprecated: azure-native:network/v20220501:VirtualHub is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHub to guarantee forwards compatibility.""")
    __args__ = dict()
