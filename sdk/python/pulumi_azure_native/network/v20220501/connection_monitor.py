...
warnings.warn("""azure-native:network/v20220501:ConnectionMonitor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConnectionMonitor to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 test_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConnectionMonitorTestGroupArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectionMonitor is deprecated: azure-native:network/v20220501:ConnectionMonitor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConnectionMonitor to guarantee forwards compatibility.""")
