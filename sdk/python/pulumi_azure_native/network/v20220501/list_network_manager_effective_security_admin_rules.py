...
def list_network_manager_effective_security_admin_rules(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220501:listNetworkManagerEffectiveSecurityAdminRules', __args__, opts=opts, typ=ListNetworkManagerEffectiveSecurityAdminRulesResult).value
...
def list_network_manager_effective_security_admin_rules_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220501:listNetworkManagerEffectiveSecurityAdminRules', __args__, opts=opts, typ=ListNetworkManagerEffectiveSecurityAdminRulesResult)
