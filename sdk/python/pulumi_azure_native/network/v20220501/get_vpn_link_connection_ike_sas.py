...
def get_vpn_link_connection_ike_sas(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220501:getVpnLinkConnectionIkeSas', __args__, opts=opts, typ=GetVpnLinkConnectionIkeSasResult).value
...
def get_vpn_link_connection_ike_sas_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220501:getVpnLinkConnectionIkeSas', __args__, opts=opts, typ=GetVpnLinkConnectionIkeSasResult)
