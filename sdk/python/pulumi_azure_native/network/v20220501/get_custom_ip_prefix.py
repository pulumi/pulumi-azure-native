...
warnings.warn("""azure-native:network/v20220501:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_ip_prefix is deprecated: azure-native:network/v20220501:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:CustomIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
