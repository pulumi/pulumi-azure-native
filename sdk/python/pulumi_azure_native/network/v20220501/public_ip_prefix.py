...
warnings.warn("""azure-native:network/v20220501:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
class PublicIPPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PublicIPPrefix is deprecated: azure-native:network/v20220501:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPPrefix to guarantee forwards compatibility.""")
