...
warnings.warn("""azure-native:network/v20220501:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:StaticMember to guarantee forwards compatibility.""", DeprecationWarning)
...
class StaticMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 static_member_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StaticMember is deprecated: azure-native:network/v20220501:StaticMember is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:StaticMember to guarantee forwards compatibility.""")
