...
def get_ip_allocation(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_allocation is deprecated: azure-native:network/v20220501:IpAllocation is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:IpAllocation to guarantee forwards compatibility.""")
    __args__ = dict()
