...
warnings.warn("""azure-native:network/v20220501:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_security_admin_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_admin_configuration is deprecated: azure-native:network/v20220501:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
