...
def get_network_interface(expand: Optional[str] = None,
    ...
    return AwaitableGetNetworkInterfaceResult(
        ...
        hosted_workloads=pulumi.get(__ret__, 'hosted_workloads'),
        ...
        private_link_service=pulumi.get(__ret__, 'private_link_service'),
...
def get_network_interface_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220501:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
