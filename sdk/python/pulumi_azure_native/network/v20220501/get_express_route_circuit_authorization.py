...
def get_express_route_circuit_authorization(authorization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_authorization is deprecated: azure-native:network/v20220501:ExpressRouteCircuitAuthorization is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteCircuitAuthorization to guarantee forwards compatibility.""")
    __args__ = dict()
