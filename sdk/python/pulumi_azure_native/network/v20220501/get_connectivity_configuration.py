...
def get_connectivity_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connectivity_configuration is deprecated: azure-native:network/v20220501:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConnectivityConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
