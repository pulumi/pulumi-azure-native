...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['VirtualHubIdArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteGateway is deprecated: azure-native:network/v20220501:ExpressRouteGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ExpressRouteGateway to guarantee forwards compatibility.""")
