...
def list_active_security_admin_rules(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220501:listActiveSecurityAdminRules', __args__, opts=opts, typ=ListActiveSecurityAdminRulesResult).value
...
def list_active_security_admin_rules_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20220501:listActiveSecurityAdminRules', __args__, opts=opts, typ=ListActiveSecurityAdminRulesResult)
