...
warnings.warn("""azure-native:network/v20220501:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bastion_host(bastion_host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bastion_host is deprecated: azure-native:network/v20220501:BastionHost is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:BastionHost to guarantee forwards compatibility.""")
    __args__ = dict()
