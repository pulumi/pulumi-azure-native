...
warnings.warn("""azure-native:network/v20220501:ExpressRoutePortAuthorization is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRoutePortAuthorization to guarantee forwards compatibility.""", DeprecationWarning)
