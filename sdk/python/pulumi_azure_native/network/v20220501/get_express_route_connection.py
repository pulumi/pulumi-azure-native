...
def get_express_route_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_connection is deprecated: azure-native:network/v20220501:ExpressRouteConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ExpressRouteConnection to guarantee forwards compatibility.""")
    __args__ = dict()
