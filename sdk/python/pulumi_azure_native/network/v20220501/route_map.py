...
class RouteMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220701:RouteMap"), pulumi.Alias(type_="azure-native:network/v20220901:RouteMap"), pulumi.Alias(type_="azure-native:network/v20221101:RouteMap")])
