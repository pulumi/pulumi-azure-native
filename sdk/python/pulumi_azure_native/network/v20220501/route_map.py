...
warnings.warn("""azure-native:network/v20220501:RouteMap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteMap to guarantee forwards compatibility.""", DeprecationWarning)
...
class RouteMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RouteMap is deprecated: azure-native:network/v20220501:RouteMap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteMap to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20220701:RouteMap"), pulumi.Alias(type_="azure-native:network/v20220901:RouteMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RouteMap, __self__).__init__(
            'azure-native:network/v20220501:RouteMap',
            resource_name,
            __props__,
            opts)
