...
warnings.warn("""azure-native:network/v20220501:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_nat_rule(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_rule is deprecated: azure-native:network/v20220501:NatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NatRule to guarantee forwards compatibility.""")
    __args__ = dict()
