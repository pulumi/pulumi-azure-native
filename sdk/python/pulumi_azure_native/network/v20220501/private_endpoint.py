...
warnings.warn("""azure-native:network/v20220501:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpoint is deprecated: azure-native:network/v20220501:PrivateEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateEndpoint to guarantee forwards compatibility.""")
