...
class InboundNatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""InboundNatRule is deprecated: azure-native:network/v20220501:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:InboundNatRule to guarantee forwards compatibility.""")
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/v20220501:InboundNatRule',
            resource_name,
            __props__,
            opts)
