...
def list_effective_security_user_rule_by_subnet(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:listEffectiveSecurityUserRuleBySubnet', __args__, opts=opts, typ=ListEffectiveSecurityUserRuleBySubnetResult).value
