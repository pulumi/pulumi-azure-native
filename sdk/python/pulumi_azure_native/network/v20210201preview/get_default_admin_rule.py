...
warnings.warn("""azure-native:network/v20210201preview:DefaultAdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:DefaultAdminRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetDefaultAdminRuleResult:
    ...
    """
    def __init__(__self__, access=None, description=None, destination_port_ranges=None, destinations=None, direction=None, display_name=None, etag=None, flag=None, id=None, kind=None, name=None, priority=None, protocol=None, provisioning_state=None, source_port_ranges=None, sources=None, system_data=None, type=None):
...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_default_admin_rule is deprecated: azure-native:network/v20210201preview:DefaultAdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:DefaultAdminRule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
