...
class NspAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspAssociation"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspAssociation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NspAssociation, __self__).__init__(
            'azure-native:network/v20210201preview:NspAssociation',
            resource_name,
            __props__,
            opts)
