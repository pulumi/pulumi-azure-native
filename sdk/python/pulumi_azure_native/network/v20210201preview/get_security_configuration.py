...
def get_security_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:getSecurityConfiguration', __args__, opts=opts, typ=GetSecurityConfigurationResult).value
