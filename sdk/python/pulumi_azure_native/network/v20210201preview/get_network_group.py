...
def get_network_group(network_group_name: Optional[str] = None,
    ...
    return AwaitableGetNetworkGroupResult(
        conditional_membership=pulumi.get(__ret__, 'conditional_membership'),
...
def get_network_group_output(network_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210201preview:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult)
    return __ret__.apply(lambda __response__: GetNetworkGroupResult(
        conditional_membership=pulumi.get(__response__, 'conditional_membership'),
