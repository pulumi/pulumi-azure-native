...
class NspLinkArgs:
    ...
    def _configure(
        ...
        if auto_approved_remote_perimeter_resource_id is None and 'autoApprovedRemotePerimeterResourceId' in kwargs:
        ...
        if local_inbound_profiles is None and 'localInboundProfiles' in kwargs:
            local_inbound_profiles = kwargs['localInboundProfiles']
        if remote_inbound_profiles is None and 'remoteInboundProfiles' in kwargs:
...
class NspLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NspLink"), pulumi.Alias(type_="azure-native:network/v20230701preview:NspLink"), pulumi.Alias(type_="azure-native:network/v20230801preview:NspLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NspLink, __self__).__init__(
            'azure-native:network/v20210201preview:NspLink',
            resource_name,
            __props__,
            opts)
