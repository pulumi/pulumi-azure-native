...
warnings.warn("""azure-native:network/v20210201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:SecurityUserConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_security_user_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_user_configuration is deprecated: azure-native:network/v20210201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:SecurityUserConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
