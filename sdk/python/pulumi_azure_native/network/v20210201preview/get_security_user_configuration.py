...
def get_security_user_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210201preview:getSecurityUserConfiguration', __args__, opts=opts, typ=GetSecurityUserConfigurationResult)
