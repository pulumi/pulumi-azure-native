...
__all__ = [
    'ListEffectiveConfigurationResult',
    'AwaitableListEffectiveConfigurationResult',
    'list_effective_configuration',
]

@pulumi.output_type
class ListEffectiveConfigurationResult:
    """
...
class AwaitableListEffectiveConfigurationResult(ListEffectiveConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListEffectiveConfigurationResult(
            skip_token=self.skip_token,
            value=self.value)


def list_effective_configuration(resource_group_name: Optional[str] = None,
                                 skip_token: Optional[str] = None,
                                 virtual_network_name: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListEffectiveConfigurationResult:
    """
    Result of the request to list networkManagerEffectiveConfiguration. It contains a list of groups and a URL link to get the next set of results.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:listEffectiveConfiguration', __args__, opts=opts, typ=ListEffectiveConfigurationResult).value

    return AwaitableListEffectiveConfigurationResult(
