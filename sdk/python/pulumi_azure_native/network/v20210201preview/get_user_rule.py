...
class GetUserRuleResult:
    ...
    """
    def __init__(__self__, description=None, destination_port_ranges=None, destinations=None, direction=None, display_name=None, etag=None, id=None, kind=None, name=None, protocol=None, provisioning_state=None, source_port_ranges=None, sources=None, system_data=None, type=None):
...
def get_user_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_rule is deprecated: azure-native:network/v20210201preview:UserRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:UserRule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:getUserRule', __args__, opts=opts, typ=GetUserRuleResult).value
