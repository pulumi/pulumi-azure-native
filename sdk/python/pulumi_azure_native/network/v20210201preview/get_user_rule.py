...
def get_user_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210201preview:getUserRule', __args__, opts=opts, typ=GetUserRuleResult)
    return __ret__.apply(lambda __response__: GetUserRuleResult(
