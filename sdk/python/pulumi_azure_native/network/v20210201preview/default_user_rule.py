...
warnings.warn("""azure-native:network/v20210201preview:DefaultUserRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210501preview:DefaultUserRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class DefaultUserRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DefaultUserRule is deprecated: azure-native:network/v20210201preview:DefaultUserRule is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210501preview:DefaultUserRule to guarantee forwards compatibility.""")
