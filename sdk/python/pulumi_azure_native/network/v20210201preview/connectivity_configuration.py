...
class ConnectivityConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connectivity_configuration = azure_native.network.v20210201preview.ConnectivityConfiguration("connectivityConfiguration",
            applies_to_groups=[azure_native.network.v20210201preview.ConnectivityGroupItemArgs(
            ...
            hubs=[azure_native.network.v20210201preview.HubArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20210201preview:ConnectivityConfiguration myTestConnectivityConfig subscriptions/subscriptionA/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkManagers/testNetworkManager/connectivityConfigurations/myTestConnectivityConfig 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20210501preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220101:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220201preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220401preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220501:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220701:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220901:ConnectivityConfiguration")])
