...
class SecurityUserConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 security_type: Optional[pulumi.Input[Union[str, 'SecurityType']]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityUserConfiguration is deprecated: azure-native:network/v20210201preview:SecurityUserConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210501preview:SecurityUserConfiguration to guarantee forwards compatibility.""")
