...
def list_active_configuration(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:listActiveConfiguration', __args__, opts=opts, typ=ListActiveConfigurationResult).value
