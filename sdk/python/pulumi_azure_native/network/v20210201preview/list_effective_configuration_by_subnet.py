...
__all__ = [
    'ListEffectiveConfigurationBySubnetResult',
    'AwaitableListEffectiveConfigurationBySubnetResult',
    'list_effective_configuration_by_subnet',
]

@pulumi.output_type
class ListEffectiveConfigurationBySubnetResult:
    """
...
class AwaitableListEffectiveConfigurationBySubnetResult(ListEffectiveConfigurationBySubnetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListEffectiveConfigurationBySubnetResult(
            skip_token=self.skip_token,
            value=self.value)


def list_effective_configuration_by_subnet(resource_group_name: Optional[str] = None,
                                           skip_token: Optional[str] = None,
                                           subnet_name: Optional[str] = None,
                                           virtual_network_name: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListEffectiveConfigurationBySubnetResult:
    """
    Result of the request to list networkManagerEffectiveConfiguration. It contains a list of groups and a URL link to get the next set of results.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210201preview:listEffectiveConfigurationBySubnet', __args__, opts=opts, typ=ListEffectiveConfigurationBySubnetResult).value

    return AwaitableListEffectiveConfigurationBySubnetResult(
