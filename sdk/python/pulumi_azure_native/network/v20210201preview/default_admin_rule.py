...
class DefaultAdminRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default_admin_rule = azure_native.network.v20210201preview.DefaultAdminRule("defaultAdminRule",
