...
class AdminRuleCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        admin_rule_collection = azure_native.network.v20210201preview.AdminRuleCollection("adminRuleCollection",
            applies_to_groups=[azure_native.network.v20210201preview.NetworkManagerSecurityGroupItemArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20210201preview:AdminRuleCollection myTestSecurityConfig /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/networkManager/testNetworkManager/securityAdminConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210501preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220101:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220201preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220501:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220701:AdminRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220901:AdminRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AdminRuleCollection, __self__).__init__(
            'azure-native:network/v20210201preview:AdminRuleCollection',
            resource_name,
            __props__,
            opts)
