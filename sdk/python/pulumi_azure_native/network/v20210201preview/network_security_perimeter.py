...
class NetworkSecurityPerimeter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210301preview:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-native:network/v20230701preview:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-native:network/v20230801preview:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-native:network/v20240601preview:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-native:network:NetworkSecurityPerimeter")])
