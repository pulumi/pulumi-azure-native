...
class UserRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210501preview:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220201preview:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240301:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240301:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20240501:UserRuleCollection"), pulumi.Alias(type_="azure-native:network:SecurityUserRuleCollection"), pulumi.Alias(type_="azure-native:network:UserRuleCollection")])
