...
class UserRuleCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user_rule_collection = azure_native.network.v20210201preview.UserRuleCollection("userRuleCollection",
        ...
        ```sh
        $ pulumi import azure-native:network/v20210201preview:UserRuleCollection myTestSecurityConfig /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/networkManager/testNetworkManager/securityUserConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210501preview:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220201preview:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20220401preview:UserRuleCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserRuleCollection, __self__).__init__(
            'azure-native:network/v20210201preview:UserRuleCollection',
            resource_name,
            __props__,
            opts)
