...
class UserRuleCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:UserRuleCollection"), pulumi.Alias(type_="azure-native:network/v20210501preview:UserRuleCollection")])
