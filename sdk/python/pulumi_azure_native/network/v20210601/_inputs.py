...
class HeaderActionArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             header_action_type: Optional[pulumi.Input[Union[str, 'HeaderActionType']]] = None,
...
class RulesEngineMatchConditionArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             rules_engine_match_value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
             rules_engine_match_variable: Optional[pulumi.Input[Union[str, 'RulesEngineMatchVariable']]] = None,
             rules_engine_operator: Optional[pulumi.Input[Union[str, 'RulesEngineOperator']]] = None,
             negate_condition: Optional[pulumi.Input[bool]] = None,
             selector: Optional[pulumi.Input[str]] = None,
             transforms: Optional[pulumi.Input[Sequence[pulumi.Input[Union[str, 'Transform']]]]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class RulesEngineRuleArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             action: Optional[pulumi.Input['RulesEngineActionArgs']] = None,
             name: Optional[pulumi.Input[str]] = None,
             priority: Optional[pulumi.Input[int]] = None,
             match_conditions: Optional[pulumi.Input[Sequence[pulumi.Input['RulesEngineMatchConditionArgs']]]] = None,
             match_processing_behavior: Optional[pulumi.Input[Union[str, 'MatchProcessingBehavior']]] = None,
