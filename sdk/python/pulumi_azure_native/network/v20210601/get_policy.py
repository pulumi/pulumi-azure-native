...
class GetPolicyResult:
    ...
    """
    def __init__(__self__, custom_rules=None, etag=None, extended_properties=None, frontend_endpoint_links=None, id=None, location=None, managed_rules=None, name=None, policy_settings=None, provisioning_state=None, resource_state=None, routing_rule_links=None, security_policy_links=None, sku=None, tags=None, type=None):
...
def get_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210601:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
