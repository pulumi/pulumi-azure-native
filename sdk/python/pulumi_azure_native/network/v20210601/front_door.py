...
class FrontDoor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        front_door = azure_native.network.v20210601.FrontDoor("frontDoor",
            backend_pools=[{
                "backends": [
                    azure_native.network.v20210601.BackendArgs(
                ...
                "healthProbeSettings": azure_native.network.v20210601.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/healthProbeSettings/healthProbeSettings1",
                ),
                "loadBalancingSettings": azure_native.network.v20210601.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/loadBalancingSettings/loadBalancingSettings1",
                ),
                "name": "backendPool1",
            }],
            backend_pools_settings=azure_native.network.v20210601.BackendPoolsSettingsArgs(
            ...
            frontend_endpoints=[
                {
                    ...
                    "webApplicationFirewallPolicyLink": azure_native.network.v20210601.FrontendEndpointUpdateParametersWebApplicationFirewallPolicyLinkArgs(
                        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoorWebApplicationFirewallPolicies/policy1",
                    ),
                },
                azure_native.network.v20210601.FrontendEndpointArgs(
                    host_name="frontDoor1.azurefd.net",
                    name="default",
                ),
            ],
            health_probe_settings=[azure_native.network.v20210601.HealthProbeSettingsModelArgs(
                enabled_state="Enabled",
            ...
            load_balancing_settings=[azure_native.network.v20210601.LoadBalancingSettingsModelArgs(
            ...
            routing_rules=[{
                ...
                "frontendEndpoints": [
                    azure_native.network.v20210601.SubResourceArgs(
                ...
                "name": "routingRule1",
                "patternsToMatch": ["/*"],
                "routeConfiguration": azure_native.network.v20210601.ForwardingConfigurationArgs(
                ...
                "rulesEngine": azure_native.network.v20210601.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1/rulesEngines/rulesEngine1",
                ),
                "webApplicationFirewallPolicyLink": azure_native.network.v20210601.RoutingRuleUpdateParametersWebApplicationFirewallPolicyLinkArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoorWebApplicationFirewallPolicies/policy1",
                ),
            }],
            tags={
        ...
        ```sh
        $ pulumi import azure-native:network/v20210601:FrontDoor frontDoor1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/frontDoors/frontDoor1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:FrontDoor"), pulumi.Alias(type_="azure-native:network/v20190401:FrontDoor"), pulumi.Alias(type_="azure-native:network/v20190501:FrontDoor"), pulumi.Alias(type_="azure-native:network/v20200101:FrontDoor"), pulumi.Alias(type_="azure-native:network/v20200401:FrontDoor"), pulumi.Alias(type_="azure-native:network/v20200501:FrontDoor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FrontDoor, __self__).__init__(
            'azure-native:network/v20210601:FrontDoor',
            resource_name,
            __props__,
            opts)
