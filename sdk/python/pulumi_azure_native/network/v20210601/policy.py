...
class Policy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        policy = azure_native.network.v20210601.Policy("policy",
            custom_rules=azure_native.network.v20210601.CustomRuleListResponseArgs(
                rules=[
                    {
                        "action": "Block",
                        "matchConditions": [azure_native.network.v20210601.FrontDoorMatchConditionArgs(
                            match_value=[
                                "192.168.1.0/24",
                                "10.0.0.0/24",
                            ],
                    ...
                    },
                    {
                        "action": "Block",
                        "matchConditions": [
                            azure_native.network.v20210601.FrontDoorMatchConditionArgs(
                                match_value=["CH"],
                                match_variable="RemoteAddr",
                                operator="GeoMatch",
                            ),
            ...
            managed_rules=azure_native.network.v20210601.ManagedRuleSetListResponseArgs(
                managed_rule_sets=[{
                    "exclusions": [azure_native.network.v20210601.ManagedRuleExclusionArgs(
                    ...
                    "ruleGroupOverrides": [{
                        ...
                        "ruleGroupName": "SQLI",
                        "rules": [
                            azure_native.network.v20210601.FrontDoorManagedRuleOverrideArgs(
                                action="Redirect",
            ...
            policy_name="Policy1",
            policy_settings=azure_native.network.v20210601.FrontDoorPolicySettingsArgs(
            ...
            sku=azure_native.network.v20210601.SkuArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:Policy"), pulumi.Alias(type_="azure-native:network/v20190301:Policy"), pulumi.Alias(type_="azure-native:network/v20191001:Policy"), pulumi.Alias(type_="azure-native:network/v20200401:Policy"), pulumi.Alias(type_="azure-native:network/v20201101:Policy"), pulumi.Alias(type_="azure-native:network/v20220501:Policy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Policy, __self__).__init__(
            'azure-native:network/v20210601:Policy',
            resource_name,
            __props__,
            opts)
