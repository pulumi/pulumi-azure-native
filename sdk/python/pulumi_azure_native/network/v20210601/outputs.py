...
class BackendPoolsSettingsResponse(dict):
    ...
    def _configure(
        ...
        if 'sendRecvTimeoutSeconds' in kwargs:
...
class BackendResponse(dict):
    ...
    def _configure(
        ...
        if 'backendHostHeader' in kwargs:
...
class CacheConfigurationResponse(dict):
    ...
    def _configure(
        ...
        if 'dynamicCompression' in kwargs:
            dynamic_compression = kwargs['dynamicCompression']
        if 'queryParameterStripDirective' in kwargs:
...
class HealthProbeSettingsModelResponse(dict):
    ...
    def _configure(
        ...
        if 'enabledState' in kwargs:
            enabled_state = kwargs['enabledState']
        if 'healthProbeMethod' in kwargs:
...
class RoutingRuleResponse(dict):
    ...
    def _configure(
        ...
        if 'routeConfiguration' in kwargs:
            route_configuration = kwargs['routeConfiguration']
        if 'rulesEngine' in kwargs:
...
class RulesEngineActionResponse(dict):
    ...
    def _configure(
        ...
        if 'routeConfigurationOverride' in kwargs:
