...
def get_management_group_network_manager_connection(management_group_id: Optional[_builtins.str] = None,
                                                    network_manager_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str management_group_id: The management group Id which uniquely identify the Microsoft Azure management group.
...
def get_management_group_network_manager_connection_output(management_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                           network_manager_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
