...
class GetExpressRoutePortAuthorizationResult:
    ...
    def circuit_resource_uri(self) -> builtins.str:
        """
...
def get_express_route_port_authorization(authorization_name: Optional[builtins.str] = None,
                                         express_route_port_name: Optional[builtins.str] = None,
    ...
    :param builtins.str express_route_port_name: The name of the express route port.
...
def get_express_route_port_authorization_output(authorization_name: Optional[pulumi.Input[builtins.str]] = None,
                                                express_route_port_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getExpressRoutePortAuthorization', __args__, opts=opts, typ=GetExpressRoutePortAuthorizationResult)
