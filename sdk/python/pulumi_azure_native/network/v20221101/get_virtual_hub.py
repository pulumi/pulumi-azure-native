...
def get_virtual_hub(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult).value
...
def get_virtual_hub_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult)
