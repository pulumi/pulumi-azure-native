...
def get_configuration_policy_group(configuration_policy_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getConfigurationPolicyGroup', __args__, opts=opts, typ=GetConfigurationPolicyGroupResult).value
...
def get_configuration_policy_group_output(configuration_policy_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getConfigurationPolicyGroup', __args__, opts=opts, typ=GetConfigurationPolicyGroupResult)
