...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult).value
...
def get_azure_firewall_output(azure_firewall_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult)
