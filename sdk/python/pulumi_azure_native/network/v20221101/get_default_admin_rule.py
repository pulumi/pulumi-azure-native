...
class GetDefaultAdminRuleResult:
    ...
    """
    def __init__(__self__, access=None, description=None, destination_port_ranges=None, destinations=None, direction=None, etag=None, flag=None, id=None, kind=None, name=None, priority=None, protocol=None, provisioning_state=None, source_port_ranges=None, sources=None, system_data=None, type=None):
...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
...
def get_default_admin_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult)
