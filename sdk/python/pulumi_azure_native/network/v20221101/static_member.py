...
class StaticMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:StaticMember"), pulumi.Alias(type_="azure-native:network/v20210501preview:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220101:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220201preview:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220401preview:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220501:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220701:StaticMember"), pulumi.Alias(type_="azure-native:network/v20220901:StaticMember"), pulumi.Alias(type_="azure-native:network/v20230201:StaticMember"), pulumi.Alias(type_="azure-native:network/v20230401:StaticMember"), pulumi.Alias(type_="azure-native:network/v20230501:StaticMember"), pulumi.Alias(type_="azure-native:network/v20230601:StaticMember"), pulumi.Alias(type_="azure-native:network/v20230901:StaticMember"), pulumi.Alias(type_="azure-native:network/v20231101:StaticMember"), pulumi.Alias(type_="azure-native:network/v20240101:StaticMember"), pulumi.Alias(type_="azure-native:network/v20240301:StaticMember"), pulumi.Alias(type_="azure-native:network/v20240501:StaticMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticMember, __self__).__init__(
            'azure-native:network/v20221101:StaticMember',
            resource_name,
            __props__,
            opts)
