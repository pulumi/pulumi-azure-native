...
def get_virtual_router_peering(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult).value
...
def get_virtual_router_peering_output(peering_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getVirtualRouterPeering', __args__, opts=opts, typ=GetVirtualRouterPeeringResult)
