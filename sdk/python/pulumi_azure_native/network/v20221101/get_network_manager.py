...
def get_network_manager(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getNetworkManager', __args__, opts=opts, typ=GetNetworkManagerResult).value
...
def get_network_manager_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getNetworkManager', __args__, opts=opts, typ=GetNetworkManagerResult)
