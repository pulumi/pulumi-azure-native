...
def list_firewall_policy_idps_signature(filters: Optional[Sequence[Union['FilterItems', 'FilterItemsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:listFirewallPolicyIdpsSignature', __args__, opts=opts, typ=ListFirewallPolicyIdpsSignatureResult).value
...
def list_firewall_policy_idps_signature_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['FilterItems', 'FilterItemsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:listFirewallPolicyIdpsSignature', __args__, opts=opts, typ=ListFirewallPolicyIdpsSignatureResult)
