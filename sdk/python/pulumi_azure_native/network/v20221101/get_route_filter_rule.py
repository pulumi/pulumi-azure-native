...
def get_route_filter_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getRouteFilterRule', __args__, opts=opts, typ=GetRouteFilterRuleResult).value
...
def get_route_filter_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getRouteFilterRule', __args__, opts=opts, typ=GetRouteFilterRuleResult)
