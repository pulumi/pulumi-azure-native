...
def get_virtual_network(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
...
def get_virtual_network_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult)
