...
def get_network_watcher(network_watcher_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult).value
...
def get_network_watcher_output(network_watcher_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult)
