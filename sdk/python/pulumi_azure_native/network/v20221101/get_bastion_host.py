...
def get_bastion_host(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult).value
...
def get_bastion_host_output(bastion_host_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult)
