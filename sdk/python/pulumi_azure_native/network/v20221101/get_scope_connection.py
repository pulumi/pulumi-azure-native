...
def get_scope_connection(network_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getScopeConnection', __args__, opts=opts, typ=GetScopeConnectionResult).value
...
def get_scope_connection_output(network_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getScopeConnection', __args__, opts=opts, typ=GetScopeConnectionResult)
