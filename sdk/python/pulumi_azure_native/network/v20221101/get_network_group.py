...
def get_network_group(network_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult).value
...
def get_network_group_output(network_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult)
