...
def get_connection_monitor(connection_monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult).value
...
def get_connection_monitor_output(connection_monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult)
