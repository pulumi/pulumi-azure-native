...
def get_route_table(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20221101:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
...
def get_route_table_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20221101:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult)
