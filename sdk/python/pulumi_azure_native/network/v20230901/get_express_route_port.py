...
def get_express_route_port(express_route_port_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230901:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult).value
...
def get_express_route_port_output(express_route_port_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230901:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult)
