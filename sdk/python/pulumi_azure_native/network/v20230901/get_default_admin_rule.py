...
def get_default_admin_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230901:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult).value
...
def get_default_admin_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230901:getDefaultAdminRule', __args__, opts=opts, typ=GetDefaultAdminRuleResult)
