...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230901:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult).value
...
def get_custom_ip_prefix_output(custom_ip_prefix_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230901:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult)
