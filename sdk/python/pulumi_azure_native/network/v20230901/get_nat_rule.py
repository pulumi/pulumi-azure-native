...
def get_nat_rule(gateway_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230901:getNatRule', __args__, opts=opts, typ=GetNatRuleResult).value
...
def get_nat_rule_output(gateway_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230901:getNatRule', __args__, opts=opts, typ=GetNatRuleResult)
