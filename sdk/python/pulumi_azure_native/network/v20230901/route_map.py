...
class RouteMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:RouteMap"), pulumi.Alias(type_="azure-native:network/v20220501:RouteMap"), pulumi.Alias(type_="azure-native:network/v20220701:RouteMap"), pulumi.Alias(type_="azure-native:network/v20220901:RouteMap"), pulumi.Alias(type_="azure-native:network/v20221101:RouteMap"), pulumi.Alias(type_="azure-native:network/v20230201:RouteMap"), pulumi.Alias(type_="azure-native:network/v20230401:RouteMap"), pulumi.Alias(type_="azure-native:network/v20230501:RouteMap"), pulumi.Alias(type_="azure-native:network/v20230601:RouteMap"), pulumi.Alias(type_="azure-native:network/v20231101:RouteMap")])
