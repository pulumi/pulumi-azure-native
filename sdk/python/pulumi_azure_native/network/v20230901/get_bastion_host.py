...
class GetBastionHostResult:
    ...
    """
    def __init__(__self__, disable_copy_paste=None, dns_name=None, enable_file_copy=None, enable_ip_connect=None, enable_kerberos=None, enable_shareable_link=None, enable_tunneling=None, etag=None, id=None, ip_configurations=None, location=None, name=None, network_acls=None, provisioning_state=None, scale_units=None, sku=None, tags=None, type=None, virtual_network=None, zones=None):
...
def get_bastion_host(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20230901:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult).value
...
def get_bastion_host_output(bastion_host_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20230901:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult)
