...
class ConnectivityConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20210501preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220101:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220201preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220401preview:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220501:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220701:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20220901:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20221101:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20230201:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20230401:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20230501:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20230601:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20231101:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20240101:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20240301:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network/v20240501:ConnectivityConfiguration"), pulumi.Alias(type_="azure-native:network:ConnectivityConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectivityConfiguration, __self__).__init__(
            'azure-native:network/v20230901:ConnectivityConfiguration',
            resource_name,
            __props__,
            opts)
