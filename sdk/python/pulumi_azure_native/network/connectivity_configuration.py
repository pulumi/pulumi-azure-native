...
class ConnectivityConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 connectivity_topology: pulumi.Input[Union[builtins.str, 'ConnectivityTopology']],
                 network_manager_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 delete_existing_peering: Optional[pulumi.Input[Union[builtins.str, 'DeleteExistingPeering']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 hubs: Optional[pulumi.Input[Sequence[pulumi.Input['HubArgs']]]] = None,
                 is_global: Optional[pulumi.Input[Union[builtins.str, 'IsGlobal']]] = None):
        """
        ...
        :param pulumi.Input[Union[builtins.str, 'ConnectivityTopology']] connectivity_topology: Connectivity topology type.
        ...
        :param pulumi.Input[builtins.str] configuration_name: The name of the network manager connectivity configuration.
        :param pulumi.Input[Union[builtins.str, 'DeleteExistingPeering']] delete_existing_peering: Flag if need to remove current existing peerings.
        :param pulumi.Input[builtins.str] description: A description of the connectivity configuration.
        :param pulumi.Input[Sequence[pulumi.Input['HubArgs']]] hubs: List of hubItems
        :param pulumi.Input[Union[builtins.str, 'IsGlobal']] is_global: Flag if global mesh is supported.
        """
    ...
    def connectivity_topology(self) -> pulumi.Input[Union[builtins.str, 'ConnectivityTopology']]:
        """
    ...
    def connectivity_topology(self, value: pulumi.Input[Union[builtins.str, 'ConnectivityTopology']]):
    ...
    def delete_existing_peering(self) -> Optional[pulumi.Input[Union[builtins.str, 'DeleteExistingPeering']]]:
        """
    ...
    def delete_existing_peering(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeleteExistingPeering']]]):
    ...
    def is_global(self) -> Optional[pulumi.Input[Union[builtins.str, 'IsGlobal']]]:
        """
    ...
    @is_global.setter
    def is_global(self, value: Optional[pulumi.Input[Union[builtins.str, 'IsGlobal']]]):
...
class ConnectivityConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 connectivity_topology: Optional[pulumi.Input[Union[builtins.str, 'ConnectivityTopology']]] = None,
                 delete_existing_peering: Optional[pulumi.Input[Union[builtins.str, 'DeleteExistingPeering']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        Other available API versions: 2021-02-01-preview, 2022-01-01, 2022-02-01-preview, 2022-04-01-preview, 2022-05-01, 2022-07-01, 2022-09-01, 2022-11-01, 2023-02-01, 2023-04-01, 2023-05-01, 2023-06-01, 2023-09-01, 2023-11-01, 2024-01-01, 2024-03-01, 2024-07-01, 2024-10-01, 2025-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native network [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    @property
    @pulumi.getter(name="connectivityTopology")
    def connectivity_topology(self) -> pulumi.Output[builtins.str]:
        """
        Connectivity topology type.
        """
        return pulumi.get(self, "connectivity_topology")
    ...
    @property
    @pulumi.getter(name="deleteExistingPeering")
    def delete_existing_peering(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag if need to remove current existing peerings.
        """
        return pulumi.get(self, "delete_existing_peering")
    ...
    @property
    @pulumi.getter(name="isGlobal")
    def is_global(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag if global mesh is supported.
        """
        return pulumi.get(self, "is_global")
