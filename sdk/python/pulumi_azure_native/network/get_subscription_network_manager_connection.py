...
def get_subscription_network_manager_connection(network_manager_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_manager_connection_name: Name for the network manager connection.
    """
    __args__ = dict()
...
def get_subscription_network_manager_connection_output(network_manager_connection_name: pulumi.Input[Optional[_builtins.str]] = None,
