...
def get_p2s_vpn_gateway_p2s_vpn_connection_health_detailed(gateway_name: Optional[_builtins.str] = None,
                                                           output_blob_sas_url: Optional[_builtins.str] = None,
                                                           resource_group_name: Optional[_builtins.str] = None,
                                                           vpn_user_names_filter: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str output_blob_sas_url: The sas-url to download the P2S Vpn connection health detail.
    :param _builtins.str resource_group_name: The name of the resource group.
    :param Sequence[_builtins.str] vpn_user_names_filter: The list of p2s vpn user names whose p2s vpn connection detailed health to retrieve for.
    """
    __args__ = dict()
