...
__all__ = [
    'ListActiveConfigurationResult',
    'AwaitableListActiveConfigurationResult',
    'list_active_configuration',
]

@pulumi.output_type
class ListActiveConfigurationResult:
    """
    ...
    @property
    @pulumi.getter
    def value(self) -> Optional[Sequence['outputs.ActiveConfigurationResponse']]:
        """
...
class AwaitableListActiveConfigurationResult(ListActiveConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListActiveConfigurationResult(
            skip_token=self.skip_token,
            value=self.value)


def list_active_configuration(network_manager_name: Optional[str] = None,
                              regions: Optional[Sequence[str]] = None,
                              resource_group_name: Optional[str] = None,
                              skip_token: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListActiveConfigurationResult:
    """
    Result of the request to list active configurations. It contains a list of active configurations and a URL link to get the next set of results.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:listActiveConfiguration', __args__, opts=opts, typ=ListActiveConfigurationResult).value

    return AwaitableListActiveConfigurationResult(
