...
class GetSubnetResult:
    ...
    def default_outbound_access(self) -> Optional[builtins.bool]:
        """
    ...
    def sharing_scope(self) -> Optional[builtins.str]:
        """
...
def get_subnet(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str subnet_name: The name of the subnet.
...
def get_subnet_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getSubnet', __args__, opts=opts, typ=GetSubnetResult)
