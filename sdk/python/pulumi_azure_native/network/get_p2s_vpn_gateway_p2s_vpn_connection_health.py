...
class GetP2sVpnGatewayP2sVpnConnectionHealthResult:
    ...
    def p2_s_connection_configurations(self) -> Optional[Sequence['outputs.P2SConnectionConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse']]:
        """
...
def get_p2s_vpn_gateway_p2s_vpn_connection_health(gateway_name: Optional[_builtins.str] = None,
