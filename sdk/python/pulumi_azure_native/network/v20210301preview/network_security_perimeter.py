...
class NetworkSecurityPerimeter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20210301preview:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-native:network:NetworkSecurityPerimeter"), pulumi.Alias(type_="azure-nextgen:network:NetworkSecurityPerimeter")])
