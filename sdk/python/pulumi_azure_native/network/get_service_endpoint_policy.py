...
def get_service_endpoint_policy(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_endpoint_policy_name: The name of the service endpoint policy.
    """
    __args__ = dict()
...
def get_service_endpoint_policy_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       ...
                                       service_endpoint_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult)
