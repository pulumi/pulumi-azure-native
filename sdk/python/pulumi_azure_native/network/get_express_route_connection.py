...
def get_express_route_connection(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: The name of the ExpressRoute connection.
...
def get_express_route_connection_output(connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
