...
class GetSecurityConfigurationResult:
    ...
    """
    def __init__(__self__, applies_to_groups=None, delete_existing_nsgs=None, description=None, display_name=None, etag=None, id=None, name=None, provisioning_state=None, security_type=None, system_data=None, type=None):
        ...
        if delete_existing_nsgs and not isinstance(delete_existing_nsgs, bool):
            raise TypeError("Expected argument 'delete_existing_nsgs' to be a bool")
    ...
    def delete_existing_nsgs(self) -> Optional[bool]:
        """
...
def get_security_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getSecurityConfiguration', __args__, opts=opts, typ=GetSecurityConfigurationResult).value
