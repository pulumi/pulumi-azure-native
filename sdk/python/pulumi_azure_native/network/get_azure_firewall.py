...
def get_azure_firewall(azure_firewall_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str azure_firewall_name: The name of the Azure Firewall.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult).value
...
def get_azure_firewall_output(azure_firewall_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult)
