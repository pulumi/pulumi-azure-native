...
def get_service_endpoint_policy(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult).value
...
def get_service_endpoint_policy_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['serviceEndpointPolicyName'] = service_endpoint_policy_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101:getServiceEndpointPolicy', __args__, opts=opts, typ=GetServiceEndpointPolicyResult)
