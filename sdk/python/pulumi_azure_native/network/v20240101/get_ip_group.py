...
def get_ip_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult).value
...
def get_ip_group_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult)
