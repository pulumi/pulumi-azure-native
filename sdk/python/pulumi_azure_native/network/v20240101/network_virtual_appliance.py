...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 internet_ingress_public_ips: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InternetIngressPublicIpsPropertiesArgs']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 network_profile: Optional[pulumi.Input[pulumi.InputType['NetworkVirtualAppliancePropertiesFormatNetworkProfileArgs']]] = None,
                 network_virtual_appliance_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InternetIngressPublicIpsPropertiesArgs']]]] internet_ingress_public_ips: List of Resource Uri of Public IPs for Internet Ingress Scenario.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[pulumi.InputType['NetworkVirtualAppliancePropertiesFormatNetworkProfileArgs']] network_profile: Network Profile containing configurations for Public and Private NIC.
        :param pulumi.Input[str] network_virtual_appliance_name: The name of Network Virtual Appliance.
