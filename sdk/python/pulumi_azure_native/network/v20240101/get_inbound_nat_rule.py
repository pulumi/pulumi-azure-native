...
def get_inbound_nat_rule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult).value
    ...
    return AwaitableGetInboundNatRuleResult(
        ...
        frontend_port_range_end=pulumi.get(__ret__, 'frontend_port_range_end'),
        frontend_port_range_start=pulumi.get(__ret__, 'frontend_port_range_start'),
...
def get_inbound_nat_rule_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult)
