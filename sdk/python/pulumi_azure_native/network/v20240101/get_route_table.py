...
def get_route_table(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
...
def get_route_table_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['routeTableName'] = route_table_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult)
