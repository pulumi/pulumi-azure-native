...
def get_active_sessions(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20240101:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult).value
...
def get_active_sessions_output(bastion_host_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20240101:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult)
