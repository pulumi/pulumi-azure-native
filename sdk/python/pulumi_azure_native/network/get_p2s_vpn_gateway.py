...
def get_p2s_vpn_gateway(gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The resource group name of the P2SVpnGateway.
    """
    __args__ = dict()
...
def get_p2s_vpn_gateway_output(gateway_name: pulumi.Input[Optional[_builtins.str]] = None,
