...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__["ipv6_circuit_connection_config"] = None
        __props__["name"] = None
