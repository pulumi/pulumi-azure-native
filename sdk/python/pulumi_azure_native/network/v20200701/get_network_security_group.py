...
warnings.warn("""azure-native:network/v20200701:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_security_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_security_group is deprecated: azure-native:network/v20200701:NetworkSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""")
    __args__ = dict()
