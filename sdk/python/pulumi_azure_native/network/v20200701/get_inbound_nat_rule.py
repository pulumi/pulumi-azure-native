...
warnings.warn("""azure-native:network/v20200701:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:InboundNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_inbound_nat_rule(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_inbound_nat_rule is deprecated: azure-native:network/v20200701:InboundNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:InboundNatRule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200701:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult).value
