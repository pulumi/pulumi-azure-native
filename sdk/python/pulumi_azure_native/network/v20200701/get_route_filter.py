...
warnings.warn("""azure-native:network/v20200701:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route_filter(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter is deprecated: azure-native:network/v20200701:RouteFilter is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteFilter to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['routeFilterName'] = route_filter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200701:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult).value
