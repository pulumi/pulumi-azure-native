...
warnings.warn("""azure-native:network/v20200701:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CustomIPPrefix is deprecated: azure-native:network/v20200701:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210301:CustomIPPrefix to guarantee forwards compatibility.""")
