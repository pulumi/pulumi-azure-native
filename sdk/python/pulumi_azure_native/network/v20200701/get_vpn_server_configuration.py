...
def get_vpn_server_configuration(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_server_configuration is deprecated: azure-native:network/v20200701:VpnServerConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VpnServerConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
