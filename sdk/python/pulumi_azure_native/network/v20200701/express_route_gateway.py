...
warnings.warn("""azure-native:network/v20200701:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub: Optional[pulumi.Input[pulumi.InputType['VirtualHubIdArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteGateway is deprecated: azure-native:network/v20200701:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""")
