...
def get_public_ip_prefix(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_prefix is deprecated: azure-native:network/v20200701:PublicIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
