...
warnings.warn("""azure-native:network/v20200701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitPeering to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_circuit_peering(circuit_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_peering is deprecated: azure-native:network/v20200701:ExpressRouteCircuitPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitPeering to guarantee forwards compatibility.""")
    __args__ = dict()
