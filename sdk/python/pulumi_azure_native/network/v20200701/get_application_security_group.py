...
def get_application_security_group(application_security_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_security_group is deprecated: azure-native:network/v20200701:ApplicationSecurityGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ApplicationSecurityGroup to guarantee forwards compatibility.""")
    __args__ = dict()
