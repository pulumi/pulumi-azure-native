...
def get_private_dns_zone_group(private_dns_zone_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_dns_zone_group is deprecated: azure-native:network/v20200701:PrivateDnsZoneGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210201:PrivateDnsZoneGroup to guarantee forwards compatibility.""")
    __args__ = dict()
