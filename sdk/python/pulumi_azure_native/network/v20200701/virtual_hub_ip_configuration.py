...
warnings.warn("""azure-native:network/v20200701:VirtualHubIpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubIpConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualHubIpConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_hub_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualHubIpConfiguration is deprecated: azure-native:network/v20200701:VirtualHubIpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualHubIpConfiguration to guarantee forwards compatibility.""")
