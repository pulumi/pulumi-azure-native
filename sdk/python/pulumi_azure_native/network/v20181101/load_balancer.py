...
warnings.warn("""azure-native:network/v20181101:LoadBalancer is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:LoadBalancer to guarantee forwards compatibility.""", DeprecationWarning)
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""LoadBalancer is deprecated: azure-native:network/v20181101:LoadBalancer is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:LoadBalancer to guarantee forwards compatibility.""")
