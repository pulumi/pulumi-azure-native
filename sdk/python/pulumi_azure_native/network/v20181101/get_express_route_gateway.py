...
warnings.warn("""azure-native:network/v20181101:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_gateway(express_route_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_gateway is deprecated: azure-native:network/v20181101:ExpressRouteGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210301:ExpressRouteGateway to guarantee forwards compatibility.""")
    __args__ = dict()
