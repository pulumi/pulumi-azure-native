...
warnings.warn("""azure-native:network/v20181101:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_tap: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkTapArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkInterfaceTapConfiguration is deprecated: azure-native:network/v20181101:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""")
