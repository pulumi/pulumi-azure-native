...
def get_network_interface(expand: Optional[str] = None,
    ...
    return AwaitableGetNetworkInterfaceResult(
        ...
        interface_endpoint=pulumi.get(__ret__, 'interface_endpoint'),
...
def get_network_interface_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20181101:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
    return __ret__.apply(lambda __response__: GetNetworkInterfaceResult(
        ...
        interface_endpoint=pulumi.get(__response__, 'interface_endpoint'),
