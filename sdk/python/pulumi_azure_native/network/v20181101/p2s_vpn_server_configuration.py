...
warnings.warn("""azure-native:network/v20181101:P2sVpnServerConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnServerConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
