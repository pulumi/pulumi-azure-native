...
def get_route_filter_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter_rule is deprecated: azure-native:network/v20181101:RouteFilterRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteFilterRule to guarantee forwards compatibility.""")
    __args__ = dict()
