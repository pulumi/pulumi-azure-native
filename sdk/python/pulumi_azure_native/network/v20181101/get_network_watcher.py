...
warnings.warn("""azure-native:network/v20181101:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:NetworkWatcher to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_watcher(network_watcher_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_watcher is deprecated: azure-native:network/v20181101:NetworkWatcher is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220501:NetworkWatcher to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkWatcherName'] = network_watcher_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181101:getNetworkWatcher', __args__, opts=opts, typ=GetNetworkWatcherResult).value
