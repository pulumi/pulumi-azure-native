...
def get_p2s_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_p2s_vpn_gateway is deprecated: azure-native:network/v20181101:P2sVpnGateway is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190701:P2sVpnGateway to guarantee forwards compatibility.""")
    __args__ = dict()
