...
def get_network_interface_tap_configuration(network_interface_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_interface_tap_configuration is deprecated: azure-native:network/v20181101:NetworkInterfaceTapConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkInterfaceTapConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20181101:getNetworkInterfaceTapConfiguration', __args__, opts=opts, typ=GetNetworkInterfaceTapConfigurationResult).value
