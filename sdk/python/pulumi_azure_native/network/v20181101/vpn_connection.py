...
class VpnConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_connection_protocol_type: Optional[pulumi.Input[Union[str, 'VirtualNetworkGatewayConnectionProtocol']]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnConnection is deprecated: azure-native:network/v20181101:VpnConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnConnection to guarantee forwards compatibility.""")
