...
def get_interface_endpoint(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_interface_endpoint is deprecated: azure-native:network/v20181101:InterfaceEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
