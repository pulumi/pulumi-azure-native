...
class VpnSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vpn_site_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VpnSite is deprecated: azure-native:network/v20180801:VpnSite is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VpnSite to guarantee forwards compatibility.""")
        ...
        super(VpnSite, __self__).__init__(
            'azure-native:network/v20180801:VpnSite',
            resource_name,
            __props__,
            opts)
