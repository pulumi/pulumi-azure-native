...
warnings.warn("""azure-native:network/v20180801:VirtualNetworkTap is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_tap(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_tap is deprecated: azure-native:network/v20180801:VirtualNetworkTap is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.""")
    __args__ = dict()
