...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:Endpoint"), pulumi.Alias(type_="azure-native:network/v20220401:Endpoint"), pulumi.Alias(type_="azure-native:network/v20220401preview:Endpoint")])
