...
class AzureManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
                 rule_set_type: str,
                 priority: Optional[int] = None,
                 rule_group_overrides: Optional[Sequence['outputs.AzureManagedOverrideRuleGroupResponse']] = None,
    ...
    def rule_group_overrides(self) -> Optional[Sequence['outputs.AzureManagedOverrideRuleGroupResponse']]:
        """
...
class ContainerNetworkInterfaceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['ContainerNetworkInterfaceResponseArgs'] container_network_interfaces: A list of container network interfaces created from this container network interface configuration.
        :param str etag: A unique read-only string that changes whenever the resource is updated.
        :param str id: Resource ID.
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int rate_limit_duration_in_minutes: Defines rate limit duration. Default - 1 minute
...
class ManagedRuleSetsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 rule_sets: Optional[Sequence['outputs.AzureManagedRuleSetResponse']] = None):
        """
        Defines ManagedRuleSets - array of managedRuleSet
        :param Sequence['AzureManagedRuleSetResponseArgs'] rule_sets: List of rules
        """
    ...
    def rule_sets(self) -> Optional[Sequence['outputs.AzureManagedRuleSetResponse']]:
        """
        List of rules
        """
...
class MatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Define match conditions
        :param Sequence[str] match_value: Match value
