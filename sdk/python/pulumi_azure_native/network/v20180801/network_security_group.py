...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 default_security_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SecurityRuleArgs', 'SecurityRuleArgsDict']]]]] = None,
                 id: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 network_security_group_name: Optional[pulumi.Input[str]] = None,
                 provisioning_state: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['SecurityRuleArgs', 'SecurityRuleArgsDict']]]] default_security_rules: The default security rules of network security group.
               These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
        :param pulumi.Input[str] id: Resource ID.
        :param pulumi.Input[str] location: Resource location.
        :param pulumi.Input[str] network_security_group_name: The name of the network security group.
