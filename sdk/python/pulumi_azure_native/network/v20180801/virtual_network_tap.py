...
class VirtualNetworkTap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tap_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkTap is deprecated: azure-native:network/v20180801:VirtualNetworkTap is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualNetworkTap to guarantee forwards compatibility.""")
