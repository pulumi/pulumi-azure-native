...
class ExpressRouteCircuitArgs:
    ...
    def allow_global_reach(self) -> Optional[pulumi.Input[bool]]:
        """
        Flag to enable Global Reach on the circuit.
        """
        return pulumi.get(self, "allow_global_reach")

    @allow_global_reach.setter
    def allow_global_reach(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "allow_global_reach", value)
...
warnings.warn("""azure-native:network/v20180801:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExpressRouteCircuit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ExpressRouteCircuit is deprecated: azure-native:network/v20180801:ExpressRouteCircuit is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20181201:ExpressRouteCircuit to guarantee forwards compatibility.""")
        ...
        if opts.id is None:
            ...
            __props__.__dict__["allow_global_reach"] = allow_global_reach
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["allow_global_reach"] = None
