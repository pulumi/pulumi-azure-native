...
warnings.warn("""azure-native:network/v20180801:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:RouteTable to guarantee forwards compatibility.""", DeprecationWarning)
...
class RouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""RouteTable is deprecated: azure-native:network/v20180801:RouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190601:RouteTable to guarantee forwards compatibility.""")
