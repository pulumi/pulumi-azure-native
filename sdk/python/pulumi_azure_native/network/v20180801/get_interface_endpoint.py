...
warnings.warn("""azure-native:network/v20180801:InterfaceEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_interface_endpoint(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_interface_endpoint is deprecated: azure-native:network/v20180801:InterfaceEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20190201:InterfaceEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['interfaceEndpointName'] = interface_endpoint_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20180801:getInterfaceEndpoint', __args__, opts=opts, typ=GetInterfaceEndpointResult).value
