...
class VirtualNetworkTap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(destination_load_balancer_front_end_ip_configuration, FrontendIPConfigurationArgs):
            ...
            if not isinstance(destination_network_interface_ip_configuration, NetworkInterfaceIPConfigurationArgs):
