...
def get_application_gateway_private_endpoint_connection(application_gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: The name of the application gateway private endpoint connection.
...
def get_application_gateway_private_endpoint_connection_output(application_gateway_name: Optional[pulumi.Input[_builtins.str]] = None,
