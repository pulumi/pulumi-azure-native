...
azure-native:network/v20161201:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:Route to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_route(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: Version 2016-12-01 will be removed in v2 of the provider.
azure-native:network/v20161201:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20190601:Route to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20161201:getRoute', __args__, opts=opts, typ=GetRouteResult).value
