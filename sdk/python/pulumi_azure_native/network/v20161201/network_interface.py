...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_machine: Optional[pulumi.Input[pulumi.InputType['SubResourceArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkInterface is deprecated: Version 2016-12-01 will be removed in v2 of the provider.""")
        ...
        super(NetworkInterface, __self__).__init__(
            'azure-native:network/v20161201:NetworkInterface',
            resource_name,
            __props__,
            opts)
