...
def get_express_route_port(express_route_port_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str express_route_port_name: The name of ExpressRoutePort.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getExpressRoutePort', __args__, opts=opts, typ=GetExpressRoutePortResult).value
...
def get_express_route_port_output(express_route_port_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
