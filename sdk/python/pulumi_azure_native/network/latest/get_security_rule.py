...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getSecurityRule'.""", DeprecationWarning)
...
def get_security_rule(network_security_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getSecurityRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult).value
