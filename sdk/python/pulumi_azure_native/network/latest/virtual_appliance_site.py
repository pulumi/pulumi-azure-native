...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualApplianceSite'.""", DeprecationWarning)
...
class VirtualApplianceSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(VirtualApplianceSite, __self__).__init__(
            'azure-native:network/latest:VirtualApplianceSite',
            resource_name,
            __props__,
            opts)
