...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:Route'.""", DeprecationWarning)
...
class Route(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['has_bgp_override'] = has_bgp_override
            __props__['id'] = id
            __props__['name'] = name
