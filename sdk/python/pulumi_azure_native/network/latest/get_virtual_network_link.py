...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualNetworkLink'.""", DeprecationWarning)
...
def get_virtual_network_link(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVirtualNetworkLink', __args__, opts=opts, typ=GetVirtualNetworkLinkResult).value
