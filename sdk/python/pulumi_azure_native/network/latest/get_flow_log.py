...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getFlowLog'.""", DeprecationWarning)
...
def get_flow_log(flow_log_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getFlowLog', __args__, opts=opts, typ=GetFlowLogResult).value
