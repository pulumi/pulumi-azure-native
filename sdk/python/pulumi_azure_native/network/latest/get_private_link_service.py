...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPrivateLinkService'.""", DeprecationWarning)
...
def get_private_link_service(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_link_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPrivateLinkService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getPrivateLinkService', __args__, opts=opts, typ=GetPrivateLinkServiceResult).value
