...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:NatGateway'.""", DeprecationWarning)
...
class NatGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""NatGateway is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:NatGateway'.""")
        ...
        super(NatGateway, __self__).__init__(
            'azure-native:network/latest:NatGateway',
            resource_name,
            __props__,
            opts)
