...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualRouter'.""", DeprecationWarning)
...
def get_virtual_router(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_router is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualRouter'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVirtualRouter', __args__, opts=opts, typ=GetVirtualRouterResult).value
