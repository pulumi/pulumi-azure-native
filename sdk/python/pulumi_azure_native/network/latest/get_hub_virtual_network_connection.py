...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getHubVirtualNetworkConnection'.""", DeprecationWarning)
...
def get_hub_virtual_network_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hub_virtual_network_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getHubVirtualNetworkConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getHubVirtualNetworkConnection', __args__, opts=opts, typ=GetHubVirtualNetworkConnectionResult).value
