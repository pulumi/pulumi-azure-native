...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualHubIpConfiguration'.""", DeprecationWarning)
...
def get_virtual_hub_ip_configuration(ip_config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_ip_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualHubIpConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVirtualHubIpConfiguration', __args__, opts=opts, typ=GetVirtualHubIpConfigurationResult).value
