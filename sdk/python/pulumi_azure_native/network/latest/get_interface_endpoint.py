...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getInterfaceEndpoint'.""", DeprecationWarning)
...
def get_interface_endpoint(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getInterfaceEndpoint', __args__, opts=opts, typ=GetInterfaceEndpointResult).value
