...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getIpAllocation'.""", DeprecationWarning)
...
def get_ip_allocation(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getIpAllocation', __args__, opts=opts, typ=GetIpAllocationResult).value
