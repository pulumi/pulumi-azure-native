...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNetworkExperimentProfile'.""", DeprecationWarning)
...
def get_network_experiment_profile(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_experiment_profile is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNetworkExperimentProfile'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getNetworkExperimentProfile', __args__, opts=opts, typ=GetNetworkExperimentProfileResult).value
