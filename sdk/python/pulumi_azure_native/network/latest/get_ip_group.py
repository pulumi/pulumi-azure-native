...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getIpGroup'.""", DeprecationWarning)
...
def get_ip_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getIpGroup', __args__, opts=opts, typ=GetIpGroupResult).value
