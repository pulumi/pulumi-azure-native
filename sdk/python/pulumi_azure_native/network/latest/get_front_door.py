...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getFrontDoor'.""", DeprecationWarning)
...
def get_front_door(front_door_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getFrontDoor', __args__, opts=opts, typ=GetFrontDoorResult).value
