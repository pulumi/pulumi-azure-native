...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:NetworkExperimentProfile'.""", DeprecationWarning)
...
class NetworkExperimentProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:NetworkExperimentProfile"), pulumi.Alias(type_="azure-nextgen:network:NetworkExperimentProfile"), pulumi.Alias(type_="azure-native:network/v20191101:NetworkExperimentProfile"), pulumi.Alias(type_="azure-nextgen:network/v20191101:NetworkExperimentProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkExperimentProfile, __self__).__init__(
            'azure-native:network/latest:NetworkExperimentProfile',
            resource_name,
            __props__,
            opts)
