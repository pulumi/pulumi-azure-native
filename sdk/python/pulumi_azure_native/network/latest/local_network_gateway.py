...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:LocalNetworkGateway'.""", DeprecationWarning)
...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("LocalNetworkGateway is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:LocalNetworkGateway'.")
