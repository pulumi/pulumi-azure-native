...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:DdosProtectionPlan'.""", DeprecationWarning)
...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("DdosProtectionPlan is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:DdosProtectionPlan'.")
