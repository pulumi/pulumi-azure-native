...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getP2sVpnServerConfiguration'.""", DeprecationWarning)
...
def get_p2s_vpn_server_configuration(p2_s_vpn_server_configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getP2sVpnServerConfiguration', __args__, opts=opts, typ=GetP2sVpnServerConfigurationResult).value
