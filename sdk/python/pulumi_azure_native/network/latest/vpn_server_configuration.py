...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VpnServerConfiguration'.""", DeprecationWarning)
...
class VpnServerConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""VpnServerConfiguration is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VpnServerConfiguration'.""")
        ...
        super(VpnServerConfiguration, __self__).__init__(
            'azure-native:network/latest:VpnServerConfiguration',
            resource_name,
            __props__,
            opts)
