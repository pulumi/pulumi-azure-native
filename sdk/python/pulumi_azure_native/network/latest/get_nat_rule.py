...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNatRule'.""", DeprecationWarning)
...
def get_nat_rule(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_nat_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNatRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getNatRule', __args__, opts=opts, typ=GetNatRuleResult).value
