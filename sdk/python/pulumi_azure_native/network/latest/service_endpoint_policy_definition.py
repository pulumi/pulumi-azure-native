...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ServiceEndpointPolicyDefinition'.""", DeprecationWarning)
...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(ServiceEndpointPolicyDefinition, __self__).__init__(
            'azure-native:network/latest:ServiceEndpointPolicyDefinition',
            resource_name,
            __props__,
            opts)
