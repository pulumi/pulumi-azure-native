...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getLoadBalancer'.""", DeprecationWarning)
...
def get_load_balancer(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
