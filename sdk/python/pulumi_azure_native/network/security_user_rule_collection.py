...
class SecurityUserRuleCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A description of the security user rule collection.
