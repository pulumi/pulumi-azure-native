...
def get_connection_monitor(connection_monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection_monitor is deprecated: azure-native:network/v20220701:ConnectionMonitor is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ConnectionMonitor to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult).value
