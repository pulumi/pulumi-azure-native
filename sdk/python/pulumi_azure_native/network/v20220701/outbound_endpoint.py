...
class OutboundEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20200401preview:OutboundEndpoint"), pulumi.Alias(type_="azure-native:network/v20230701preview:OutboundEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OutboundEndpoint, __self__).__init__(
            'azure-native:network/v20220701:OutboundEndpoint',
            resource_name,
            __props__,
            opts)
