...
def get_configuration_policy_group(configuration_policy_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_policy_group is deprecated: azure-native:network/v20220701:ConfigurationPolicyGroup is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:ConfigurationPolicyGroup to guarantee forwards compatibility.""")
    __args__ = dict()
