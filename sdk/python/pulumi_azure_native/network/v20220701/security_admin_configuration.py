...
warnings.warn("""azure-native:network/v20220701:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class SecurityAdminConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SecurityAdminConfiguration is deprecated: azure-native:network/v20220701:SecurityAdminConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:SecurityAdminConfiguration to guarantee forwards compatibility.""")
