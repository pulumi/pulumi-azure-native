...
def get_ip_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ip_group is deprecated: azure-native:network/v20220701:IpGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:IpGroup to guarantee forwards compatibility.""")
    __args__ = dict()
