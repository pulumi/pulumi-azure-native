...
warnings.warn("""azure-native:network/v20220701:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_ip_prefix is deprecated: azure-native:network/v20220701:CustomIPPrefix is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['customIpPrefixName'] = custom_ip_prefix_name
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult).value
    ...
    return AwaitableGetCustomIPPrefixResult(
        ...
        etag=__ret__.etag,
        express_route_advertise=__ret__.express_route_advertise,
        ...
        name=__ret__.name,
        no_internet_advertise=__ret__.no_internet_advertise,
