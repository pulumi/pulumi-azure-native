...
warnings.warn("""azure-native:network/v20220701:CustomIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_ip_prefix is deprecated: azure-native:network/v20220701:CustomIPPrefix is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:CustomIPPrefix to guarantee forwards compatibility.""")
    __args__ = dict()
