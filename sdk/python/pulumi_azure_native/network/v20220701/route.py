...
class Route(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Route is deprecated: azure-native:network/v20220701:Route is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:Route to guarantee forwards compatibility.""")
