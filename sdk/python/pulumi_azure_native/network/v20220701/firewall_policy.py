...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 transport_security: Optional[pulumi.Input[pulumi.InputType['FirewallPolicyTransportSecurityArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallPolicy is deprecated: azure-native:network/v20220701:FirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FirewallPolicy to guarantee forwards compatibility.""")
