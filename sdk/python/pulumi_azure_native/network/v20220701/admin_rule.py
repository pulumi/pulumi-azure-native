...
class AdminRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AddressPrefixItemArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""AdminRule is deprecated: azure-native:network/v20220701:AdminRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:AdminRule to guarantee forwards compatibility.""")
