...
warnings.warn("""azure-native:network/v20220701:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectivityConfiguration to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConnectivityConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConnectivityConfiguration is deprecated: azure-native:network/v20220701:ConnectivityConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConnectivityConfiguration to guarantee forwards compatibility.""")
