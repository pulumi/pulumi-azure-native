...
warnings.warn("""azure-native:network/v20220701:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_address is deprecated: azure-native:network/v20220701:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PublicIPAddress to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['publicIpAddressName'] = public_ip_address_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
