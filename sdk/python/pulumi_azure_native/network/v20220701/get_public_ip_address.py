...
warnings.warn("""azure-native:network/v20220701:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPAddress to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_public_ip_address(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_address is deprecated: azure-native:network/v20220701:PublicIPAddress is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:PublicIPAddress to guarantee forwards compatibility.""")
    __args__ = dict()
