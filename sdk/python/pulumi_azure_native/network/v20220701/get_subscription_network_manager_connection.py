...
def get_subscription_network_manager_connection(network_manager_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_subscription_network_manager_connection is deprecated: azure-native:network/v20220701:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.""")
    __args__ = dict()
