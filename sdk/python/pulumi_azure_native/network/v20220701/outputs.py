...
class LoadBalancerBackendAddressResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'inboundNatRulesPortMapping' in kwargs:
        ...
        if 'ipAddress' in kwargs:
            ip_address = kwargs['ipAddress']
        if 'loadBalancerFrontendIPConfiguration' in kwargs:
...
class NetworkInterfaceResponse(dict):
    ...
    def _configure(
        ...
        if 'vnetEncryptionSupported' in kwargs:
...
class VirtualNetworkDnsForwardingRulesetResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'virtualNetworkLink' in kwargs:
