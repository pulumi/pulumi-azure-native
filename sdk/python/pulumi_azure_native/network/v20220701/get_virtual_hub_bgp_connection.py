...
warnings.warn("""azure-native:network/v20220701:VirtualHubBgpConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_hub_bgp_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub_bgp_connection is deprecated: azure-native:network/v20220701:VirtualHubBgpConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualHubBgpConnection to guarantee forwards compatibility.""")
    __args__ = dict()
