...
warnings.warn("""azure-native:network/v20220701:NetworkSecurityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:NetworkSecurityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(NetworkSecurityGroup, __self__).__init__(
            'azure-native:network/v20220701:NetworkSecurityGroup',
            resource_name,
            __props__,
            opts)
