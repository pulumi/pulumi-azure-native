...
def get_route_map(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_map is deprecated: azure-native:network/v20220701:RouteMap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:RouteMap to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['routeMapName'] = route_map_name
    __args__['virtualHubName'] = virtual_hub_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getRouteMap', __args__, opts=opts, typ=GetRouteMapResult).value
