...
def get_route_map(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_map is deprecated: azure-native:network/v20220701:RouteMap is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RouteMap to guarantee forwards compatibility.""")
    __args__ = dict()
