...
warnings.warn("""azure-native:network/v20220701:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class SubscriptionNetworkManagerConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 network_manager_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SubscriptionNetworkManagerConnection is deprecated: azure-native:network/v20220701:SubscriptionNetworkManagerConnection is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SubscriptionNetworkManagerConnection to guarantee forwards compatibility.""")
