...
warnings.warn("""azure-native:network/v20220701:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_express_route_circuit_connection(circuit_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_circuit_connection is deprecated: azure-native:network/v20220701:ExpressRouteCircuitConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ExpressRouteCircuitConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getExpressRouteCircuitConnection', __args__, opts=opts, typ=GetExpressRouteCircuitConnectionResult).value
