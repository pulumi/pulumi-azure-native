...
def get_security_admin_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_admin_configuration is deprecated: azure-native:network/v20220701:SecurityAdminConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:SecurityAdminConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
