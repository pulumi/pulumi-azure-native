...
def get_virtual_router(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_router is deprecated: azure-native:network/v20220701:VirtualRouter is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:VirtualRouter to guarantee forwards compatibility.""")
    __args__ = dict()
