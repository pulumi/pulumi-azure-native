...
def get_web_application_firewall_policy(policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_application_firewall_policy is deprecated: azure-native:network/v20220701:WebApplicationFirewallPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:WebApplicationFirewallPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['policyName'] = policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getWebApplicationFirewallPolicy', __args__, opts=opts, typ=GetWebApplicationFirewallPolicyResult).value
