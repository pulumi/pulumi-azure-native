...
warnings.warn("""azure-native:network/v20220701:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AzureFirewall to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_azure_firewall is deprecated: azure-native:network/v20220701:AzureFirewall is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AzureFirewall to guarantee forwards compatibility.""")
    __args__ = dict()
