...
class FirewallPolicyRuleCollectionGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_collections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[pulumi.InputType['FirewallPolicyFilterRuleCollectionArgs'], pulumi.InputType['FirewallPolicyNatRuleCollectionArgs']]]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallPolicyRuleCollectionGroup is deprecated: azure-native:network/v20220701:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""")
