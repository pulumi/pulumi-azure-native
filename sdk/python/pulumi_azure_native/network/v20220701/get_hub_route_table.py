...
warnings.warn("""azure-native:network/v20220701:HubRouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubRouteTable to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_hub_route_table(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hub_route_table is deprecated: azure-native:network/v20220701:HubRouteTable is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:HubRouteTable to guarantee forwards compatibility.""")
    __args__ = dict()
