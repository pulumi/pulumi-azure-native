...
def get_dscp_configuration(dscp_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dscp_configuration is deprecated: azure-native:network/v20220701:DscpConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:DscpConfiguration to guarantee forwards compatibility.""")
    __args__ = dict()
