...
class SecurityRuleInitArgs:
    ...
    def _configure(
        ...
        if security_rule_name is None and 'securityRuleName' in kwargs:
            security_rule_name = kwargs['securityRuleName']
