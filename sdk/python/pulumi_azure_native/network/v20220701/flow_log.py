...
warnings.warn("""azure-native:network/v20220701:FlowLog is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.""", DeprecationWarning)
...
class FlowLog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FlowLog is deprecated: azure-native:network/v20220701:FlowLog is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:FlowLog to guarantee forwards compatibility.""")
