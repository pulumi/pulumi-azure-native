...
warnings.warn("""azure-native:network/v20220701:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_gateway_nat_rule(nat_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_gateway_nat_rule is deprecated: azure-native:network/v20220701:VirtualNetworkGatewayNatRule is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:VirtualNetworkGatewayNatRule to guarantee forwards compatibility.""")
    __args__ = dict()
