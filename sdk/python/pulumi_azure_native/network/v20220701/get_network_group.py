...
def get_network_group(network_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_group is deprecated: azure-native:network/v20220701:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkGroupName'] = network_group_name
    __args__['networkManagerName'] = network_manager_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult).value
