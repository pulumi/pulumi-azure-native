...
def get_management_group_network_manager_connection(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_group_network_manager_connection is deprecated: azure-native:network/v20220701:ManagementGroupNetworkManagerConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:ManagementGroupNetworkManagerConnection to guarantee forwards compatibility.""")
    __args__ = dict()
