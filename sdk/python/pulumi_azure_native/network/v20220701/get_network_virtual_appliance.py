...
warnings.warn("""azure-native:network/v20220701:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_virtual_appliance(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_virtual_appliance is deprecated: azure-native:network/v20220701:NetworkVirtualAppliance is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20220901:NetworkVirtualAppliance to guarantee forwards compatibility.""")
    __args__ = dict()
