...
def get_private_dns_zone_group(private_dns_zone_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_dns_zone_group is deprecated: azure-native:network/v20220701:PrivateDnsZoneGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20220901:PrivateDnsZoneGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220701:getPrivateDnsZoneGroup', __args__, opts=opts, typ=GetPrivateDnsZoneGroupResult).value
