...
def get_network_group(network_group_name: Optional[_builtins.str] = None,
...
def get_network_group_output(network_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
