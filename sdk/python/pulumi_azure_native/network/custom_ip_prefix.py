...
class CustomIPPrefixArgs:
    def __init__(__self__, *,
                 ...
                 authorization_message: pulumi.Input[Optional[_builtins.str]] = None,
                 cidr: pulumi.Input[Optional[_builtins.str]] = None,
                 commissioned_state: pulumi.Input[Optional[Union[_builtins.str, 'CommissionedState']]] = None,
                 custom_ip_prefix_name: pulumi.Input[Optional[_builtins.str]] = None,
                 custom_ip_prefix_parent: pulumi.Input[Optional['SubResourceArgs']] = None,
                 express_route_advertise: pulumi.Input[Optional[_builtins.bool]] = None,
                 extended_location: pulumi.Input[Optional['ExtendedLocationArgs']] = None,
                 geo: pulumi.Input[Optional[Union[_builtins.str, 'Geo']]] = None,
                 id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 no_internet_advertise: pulumi.Input[Optional[_builtins.bool]] = None,
                 prefix_type: pulumi.Input[Optional[Union[_builtins.str, 'CustomIpPrefixType']]] = None,
                 signed_message: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] asn: The ASN for CIDR advertising. Should be an integer as string.
        :param pulumi.Input[_builtins.str] authorization_message: Authorization message for WAN validation.
        :param pulumi.Input[_builtins.str] cidr: The prefix range in CIDR notation. Should include the start address and the prefix length.
        :param pulumi.Input[Union[_builtins.str, 'CommissionedState']] commissioned_state: The commissioned state of the Custom IP Prefix.
        :param pulumi.Input[_builtins.str] custom_ip_prefix_name: The name of the custom IP prefix.
        :param pulumi.Input['SubResourceArgs'] custom_ip_prefix_parent: The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
        :param pulumi.Input[_builtins.bool] express_route_advertise: Whether to do express route advertise.
        :param pulumi.Input['ExtendedLocationArgs'] extended_location: The extended location of the custom IP prefix.
        :param pulumi.Input[Union[_builtins.str, 'Geo']] geo: The Geo for CIDR advertising. Should be an Geo code.
        :param pulumi.Input[_builtins.str] id: Resource ID.
        :param pulumi.Input[_builtins.str] location: Resource location.
        :param pulumi.Input[_builtins.bool] no_internet_advertise: Whether to Advertise the range to Internet.
        :param pulumi.Input[Union[_builtins.str, 'CustomIpPrefixType']] prefix_type: Type of custom IP prefix. Should be Singular, Parent, or Child.
        :param pulumi.Input[_builtins.str] signed_message: Signed message for WAN validation.
    ...
    def authorization_message(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def authorization_message(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def commissioned_state(self) -> pulumi.Input[Optional[Union[_builtins.str, 'CommissionedState']]]:
        """
    ...
    def commissioned_state(self, value: pulumi.Input[Optional[Union[_builtins.str, 'CommissionedState']]]):
        pulumi.set(self, "commissioned_state", value)

    @_builtins.property
    @pulumi.getter(name="customIpPrefixName")
    def custom_ip_prefix_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def custom_ip_prefix_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "custom_ip_prefix_name", value)

    @_builtins.property
    @pulumi.getter(name="customIpPrefixParent")
    def custom_ip_prefix_parent(self) -> pulumi.Input[Optional['SubResourceArgs']]:
        """
    ...
    def custom_ip_prefix_parent(self, value: pulumi.Input[Optional['SubResourceArgs']]):
        pulumi.set(self, "custom_ip_prefix_parent", value)

    @_builtins.property
    @pulumi.getter(name="expressRouteAdvertise")
    def express_route_advertise(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def express_route_advertise(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    @_builtins.property
    @pulumi.getter
    def geo(self) -> pulumi.Input[Optional[Union[_builtins.str, 'Geo']]]:
        """
    ...
    @geo.setter
    def geo(self, value: pulumi.Input[Optional[Union[_builtins.str, 'Geo']]]):
    ...
    def no_internet_advertise(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def no_internet_advertise(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "no_internet_advertise", value)

    @_builtins.property
    @pulumi.getter(name="prefixType")
    def prefix_type(self) -> pulumi.Input[Optional[Union[_builtins.str, 'CustomIpPrefixType']]]:
        """
    ...
    @prefix_type.setter
    def prefix_type(self, value: pulumi.Input[Optional[Union[_builtins.str, 'CustomIpPrefixType']]]):
        pulumi.set(self, "prefix_type", value)

    @_builtins.property
    @pulumi.getter(name="signedMessage")
    def signed_message(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def signed_message(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 commissioned_state: pulumi.Input[Optional[Union[_builtins.str, 'CommissionedState']]] = None,
                 custom_ip_prefix_name: pulumi.Input[Optional[_builtins.str]] = None,
                 custom_ip_prefix_parent: pulumi.Input[Optional[Union['SubResourceArgs', 'SubResourceArgsDict']]] = None,
                 express_route_advertise: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20201101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220901:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20221101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230401:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230901:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20231101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20241001:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20250101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20250301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20250501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20250701:CustomIPPrefix")])
