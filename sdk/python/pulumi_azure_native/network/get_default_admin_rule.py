...
def get_default_admin_rule(configuration_name: Optional[_builtins.str] = None,
                           network_manager_name: Optional[_builtins.str] = None,
                           resource_group_name: Optional[_builtins.str] = None,
                           rule_collection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rule_collection_name: The name of the network manager security Configuration rule collection.
