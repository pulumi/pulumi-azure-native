...
class PrivateRecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 txt_records: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TxtRecordArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateRecordSet is deprecated: azure-native:network/v20200101:PrivateRecordSet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PrivateRecordSet to guarantee forwards compatibility.""")
