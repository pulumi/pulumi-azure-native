...
warnings.warn("""azure-native:network/v20200101:PrivateRecordSet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PrivateRecordSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_record_set(private_zone_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_record_set is deprecated: azure-native:network/v20200101:PrivateRecordSet is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20200601:PrivateRecordSet to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200101:getPrivateRecordSet', __args__, opts=opts, typ=GetPrivateRecordSetResult).value
