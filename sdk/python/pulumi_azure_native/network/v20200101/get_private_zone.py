...
warnings.warn("""azure-native:network/v20200101:PrivateZone is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PrivateZone to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_zone(private_zone_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_zone is deprecated: azure-native:network/v20200101:PrivateZone is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20200601:PrivateZone to guarantee forwards compatibility.""")
    __args__ = dict()
