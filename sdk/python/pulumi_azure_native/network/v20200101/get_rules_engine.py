...
def get_rules_engine(front_door_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rules_engine is deprecated: azure-native:network/v20200101:RulesEngine is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:RulesEngine to guarantee forwards compatibility.""")
    __args__ = dict()
