...
def get_rules_engine(front_door_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_rules_engine is deprecated: azure-native:network/v20200101:RulesEngine is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20210601:RulesEngine to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['frontDoorName'] = front_door_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['rulesEngineName'] = rules_engine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20200101:getRulesEngine', __args__, opts=opts, typ=GetRulesEngineResult).value
