...
warnings.warn("""azure-native:network/v20200101:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.""", DeprecationWarning)
...
class FrontDoor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FrontDoor is deprecated: azure-native:network/v20200101:FrontDoor is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20210601:FrontDoor to guarantee forwards compatibility.""")
