...
def get_private_dns_zone_group(private_dns_zone_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_dns_zone_group_name: The name of the private dns zone group.
...
def get_private_dns_zone_group_output(private_dns_zone_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
