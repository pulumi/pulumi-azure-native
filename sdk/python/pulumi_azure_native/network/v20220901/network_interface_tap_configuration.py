...
class NetworkInterfaceTapConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_interface_tap_configuration = azure_native.network.v20220901.NetworkInterfaceTapConfiguration("networkInterfaceTapConfiguration",
            network_interface_name="mynic",
            resource_group_name="testrg",
            tap_configuration_name="tapconfiguration1",
            virtual_network_tap=azure_native.network.v20220901.VirtualNetworkTapArgs(
