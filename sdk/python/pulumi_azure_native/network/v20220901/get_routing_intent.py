...
warnings.warn("""azure-native:network/v20220901:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RoutingIntent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_routing_intent(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_routing_intent is deprecated: azure-native:network/v20220901:RoutingIntent is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:RoutingIntent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['routingIntentName'] = routing_intent_name
    __args__['virtualHubName'] = virtual_hub_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220901:getRoutingIntent', __args__, opts=opts, typ=GetRoutingIntentResult).value
