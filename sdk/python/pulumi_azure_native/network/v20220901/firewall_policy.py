...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_policy = azure_native.network.v20220901.FirewallPolicy("firewallPolicy",
            dns_settings=azure_native.network.v20220901.DnsSettingsArgs(
                enable_proxy=True,
                require_proxy_for_network_rules=False,
                servers=["30.3.4.5"],
            ),
            explicit_proxy=azure_native.network.v20220901.ExplicitProxyArgs(
            ...
            insights=azure_native.network.v20220901.FirewallPolicyInsightsResponseArgs(
                is_enabled=True,
                log_analytics_resources={
                    "defaultWorkspaceId": azure_native.network.v20220901.SubResourceArgs(
                        id="/subscriptions/subid/resourcegroups/rg1/providers/microsoft.operationalinsights/workspaces/defaultWorkspace",
                    ),
                    "workspaces": [
                        {
                            "region": "westus",
                            "workspaceId": azure_native.network.v20220901.SubResourceArgs(
            ...
            intrusion_detection=azure_native.network.v20220901.FirewallPolicyIntrusionDetectionResponseArgs(
                configuration={
                    "bypassTrafficSettings": [azure_native.network.v20220901.FirewallPolicyIntrusionDetectionBypassTrafficSpecificationsArgs(
                        description="Rule 1",
                    ...
                    "signatureOverrides": [azure_native.network.v20220901.FirewallPolicyIntrusionDetectionSignatureSpecificationArgs(
                        id="2525004",
                        mode="Deny",
                    )],
                },
            ...
            sku=azure_native.network.v20220901.FirewallPolicySkuArgs(
                tier="Premium",
            ),
            snat=azure_native.network.v20220901.FirewallPolicySNATArgs(
                private_ranges=["IANAPrivateRanges"],
            ),
            sql=azure_native.network.v20220901.FirewallPolicySQLArgs(
            ...
            threat_intel_whitelist=azure_native.network.v20220901.FirewallPolicyThreatIntelWhitelistArgs(
                fqdns=["*.microsoft.com"],
                ip_addresses=["20.3.4.5"],
            ),
            transport_security=azure_native.network.v20220901.FirewallPolicyTransportSecurityResponseArgs(
                certificate_authority=azure_native.network.v20220901.FirewallPolicyCertificateAuthorityArgs(
    ...
    def _internal_init(__self__,
        ...
        super(FirewallPolicy, __self__).__init__(
            'azure-native:network/v20220901:FirewallPolicy',
            resource_name,
            __props__,
            opts)
