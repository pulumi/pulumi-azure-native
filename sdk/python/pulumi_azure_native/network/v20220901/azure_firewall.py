...
class AzureFirewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        azure_firewall = azure_native.network.v20220901.AzureFirewall("azureFirewall",
            application_rule_collections=[{
                "action": azure_native.network.v20220901.AzureFirewallRCActionArgs(
                    type="Deny",
                ),
                "name": "apprulecoll",
                "priority": 110,
                "rules": [{
                    ...
                    "name": "rule1",
                    "protocols": [azure_native.network.v20220901.AzureFirewallApplicationRuleProtocolArgs(
                        port=443,
                        protocol_type="Https",
                    )],
                    "sourceAddresses": [
            ...
            nat_rule_collections=[{
                "action": azure_native.network.v20220901.AzureFirewallNatRCActionArgs(
                    type="Dnat",
                ),
                "name": "natrulecoll",
                "priority": 112,
                "rules": [
                    azure_native.network.v20220901.AzureFirewallNatRuleArgs(
            ...
            network_rule_collections=[{
                ...
                "priority": 112,
                "rules": [
                    azure_native.network.v20220901.AzureFirewallNetworkRuleArgs(
            ...
            sku=azure_native.network.v20220901.AzureFirewallSkuArgs(
                name="AZFW_VNet",
                tier="Standard",
            ),
            tags={
        ...
        azure_firewall = azure_native.network.v20220901.AzureFirewall("azureFirewall",
            ...
            location="West US",
            management_ip_configuration=azure_native.network.v20220901.AzureFirewallIPConfigurationResponseArgs(
                name="azureFirewallMgmtIpConfiguration",
                public_ip_address=azure_native.network.v20220901.SubResourceArgs(
        ...
        azure_firewall = azure_native.network.v20220901.AzureFirewall("azureFirewall",
            azure_firewall_name="azurefirewall",
            firewall_policy=azure_native.network.v20220901.SubResourceArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/firewallPolicies/policy1",
            ),
            hub_ip_addresses=azure_native.network.v20220901.HubIPAddressesResponseArgs(
                public_ips={
                    "addresses": [],
                    "count": 1,
                },
    ...
    def _internal_init(__self__,
        ...
        super(AzureFirewall, __self__).__init__(
            'azure-native:network/v20220901:AzureFirewall',
            resource_name,
            __props__,
            opts)
