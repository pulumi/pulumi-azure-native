...
warnings.warn("""azure-native:network/v20220901:FirewallPolicyRuleCollectionGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:FirewallPolicyRuleCollectionGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_firewall_policy_rule_collection_group(firewall_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220901:getFirewallPolicyRuleCollectionGroup', __args__, opts=opts, typ=GetFirewallPolicyRuleCollectionGroupResult).value
