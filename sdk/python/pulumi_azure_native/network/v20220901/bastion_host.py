...
class BastionHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bastion_host = azure_native.network.v20220901.BastionHost("bastionHost",
        ...
        ```sh
        $ pulumi import azure-native:network/v20220901:BastionHost bastionhost /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/bastionHosts/bastionhosttenant' 
        ```
