...
class NetworkVirtualAppliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_virtual_appliance = azure_native.network.v20220901.NetworkVirtualAppliance("networkVirtualAppliance",
            ...
            identity=azure_native.network.v20220901.ManagedServiceIdentityArgs(
                type=azure_native.network/v20220901.ResourceIdentityType.USER_ASSIGNED,
            ...
            nva_sku=azure_native.network.v20220901.VirtualApplianceSkuPropertiesArgs(
        ...
        network_virtual_appliance = azure_native.network.v20220901.NetworkVirtualAppliance("networkVirtualAppliance",
            delegation=azure_native.network.v20220901.DelegationPropertiesArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20220901:NetworkVirtualAppliance nva /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/networkVirtualAppliances/nva 
        ```
