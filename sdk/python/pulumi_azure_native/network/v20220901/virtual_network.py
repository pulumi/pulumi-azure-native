...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
            ...
            bgp_communities=azure_native.network.v20220901.VirtualNetworkBgpCommunitiesResponseArgs(
                virtual_network_community="12076:20000",
            ),
            location="eastus",
            resource_group_name="rg1",
            subnets=[azure_native.network.v20220901.SubnetArgs(
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "delegations": [azure_native.network.v20220901.DelegationArgs(
                    name="myDelegation",
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
            ...
            encryption=azure_native.network.v20220901.VirtualNetworkEncryptionResponseArgs(
                enabled=True,
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                ...
                "name": "test-1",
                "serviceEndpoints": [azure_native.network.v20220901.ServiceEndpointPropertiesFormatArgs(
        ...
        virtual_network = azure_native.network.v20220901.VirtualNetwork("virtualNetwork",
            ...
            subnets=[{
                "addressPrefix": "10.0.0.0/16",
                "name": "test-1",
                "serviceEndpointPolicies": [azure_native.network.v20220901.ServiceEndpointPolicyArgs(
