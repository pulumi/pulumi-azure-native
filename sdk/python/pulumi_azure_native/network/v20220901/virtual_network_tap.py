...
class VirtualNetworkTap(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_tap = azure_native.network.v20220901.VirtualNetworkTap("virtualNetworkTap",
            destination_network_interface_ip_configuration=azure_native.network.v20220901.NetworkInterfaceIPConfigurationArgs(
