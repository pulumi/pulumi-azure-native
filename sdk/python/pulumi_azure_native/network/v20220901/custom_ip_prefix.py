...
class CustomIPPrefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20200801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20201101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20210801:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20220701:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20221101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230201:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230401:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230501:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230601:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20230901:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20231101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240101:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240301:CustomIPPrefix"), pulumi.Alias(type_="azure-native:network/v20240501:CustomIPPrefix")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomIPPrefix, __self__).__init__(
            'azure-native:network/v20220901:CustomIPPrefix',
            resource_name,
            __props__,
            opts)
