...
warnings.warn("""azure-native:network/v20220901:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ScopeConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class ScopeConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScopeConnection is deprecated: azure-native:network/v20220901:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ScopeConnection to guarantee forwards compatibility.""")
