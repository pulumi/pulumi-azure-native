...
class VirtualRouterPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20190701:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20190801:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20190901:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20191101:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20200401:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20200501:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20200601:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20201101:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20210201:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20210301:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20210801:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20220101:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20220501:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20220701:VirtualRouterPeering"), pulumi.Alias(type_="azure-native:network/v20221101:VirtualRouterPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualRouterPeering, __self__).__init__(
            'azure-native:network/v20220901:VirtualRouterPeering',
            resource_name,
            __props__,
            opts)
