...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            backend_address_pools=[azure_native.network.v20220901.BackendAddressPoolArgs(
                name="be-lb",
            )],
            ...
            inbound_nat_rules=[{
                ...
                "frontendIPConfiguration": azure_native.network.v20220901.SubResourceArgs(
            ...
            load_balancing_rules=[{
                "backendAddressPool": azure_native.network.v20220901.SubResourceArgs(
                ...
                "name": "rulelb",
                "probe": azure_native.network.v20220901.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            ...
            resource_group_name="rg1",
            sku=azure_native.network.v20220901.LoadBalancerSkuArgs(
                name="Standard",
            ))
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            ...
            frontend_ip_configurations=[{
                "gatewayLoadBalancer": azure_native.network.v20220901.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            backend_address_pools=[{
                "name": "be-lb",
                "tunnelInterfaces": [
                    azure_native.network.v20220901.GatewayLoadBalancerTunnelInterfaceArgs(
                        identifier=900,
                        port=15000,
                        protocol="VXLAN",
                        type="Internal",
            ...
            load_balancer_name="lb",
            load_balancing_rules=[{
                "backendAddressPools": [azure_native.network.v20220901.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/backendAddressPools/be-lb",
                )],
                "backendPort": 0,
                "enableFloatingIP": True,
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            backend_address_pools=[
                azure_native.network.v20220901.BackendAddressPoolArgs(
                    name="be-lb1",
                ),
                azure_native.network.v20220901.BackendAddressPoolArgs(
                    name="be-lb2",
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            backend_address_pools=[{
                "loadBalancerBackendAddresses": [{
                    "loadBalancerFrontendIPConfiguration": azure_native.network.v20220901.SubResourceArgs(
        ...
        load_balancer = azure_native.network.v20220901.LoadBalancer("loadBalancer",
            ...
            frontend_ip_configurations=[azure_native.network.v20220901.FrontendIPConfigurationArgs(
                name="fe-lb",
            ...
            outbound_rules=[{
                ...
                "frontendIPConfigurations": [azure_native.network.v20220901.SubResourceArgs(
                    id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
                )],
                "name": "rule1",
                "protocol": "All",
