...
class ConnectionMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connection_monitor = azure_native.network.v20220901.ConnectionMonitor("connectionMonitor",
            ...
            test_configurations=[{
                "name": "tcp",
                "protocol": "Tcp",
                "tcpConfiguration": azure_native.network.v20220901.ConnectionMonitorTcpConfigurationArgs(
                    port=80,
                ),
                "testFrequencySec": 60,
            }],
        ...
        connection_monitor = azure_native.network.v20220901.ConnectionMonitor("connectionMonitor",
            ...
            endpoints=[
                ...
                {
                    "filter": {
                        "items": [azure_native.network.v20220901.ConnectionMonitorEndpointFilterItemArgs(
                            address="npmuser",
                            type="AgentAddress",
                        )],
                        "type": "Include",
