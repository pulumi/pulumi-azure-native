...
class PrivateLinkServicePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_service_private_endpoint_connection = azure_native.network.v20220901.PrivateLinkServicePrivateEndpointConnection("privateLinkServicePrivateEndpointConnection",
