...
class AdminRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        admin_rule = azure_native.network.v20220901.AdminRule("adminRule",
        ...
        admin_rule = azure_native.network.v20220901.AdminRule("adminRule",
            ...
            destinations=[azure_native.network.v20220901.AddressPrefixItemArgs(
                address_prefix="*",
            ...
            sources=[azure_native.network.v20220901.AddressPrefixItemArgs(
