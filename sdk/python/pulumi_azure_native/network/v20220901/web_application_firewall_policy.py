...
class WebApplicationFirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        web_application_firewall_policy = azure_native.network.v20220901.WebApplicationFirewallPolicy("webApplicationFirewallPolicy",
            custom_rules=[
                {
                    "action": "Block",
                    "matchConditions": [{
            ...
            location="WestUs",
            managed_rules=azure_native.network.v20220901.ManagedRulesDefinitionResponseArgs(
                exclusions=[
                    {
                        "exclusionManagedRuleSets": [{
                            "ruleGroups": [
                                azure_native.network.v20220901.ExclusionManagedRuleGroupArgs(
                                    rule_group_name="REQUEST-930-APPLICATION-ATTACK-LFI",
                                    rules=[azure_native.network.v20220901.ExclusionManagedRuleArgs(
                                        rule_id="930120",
                                    )],
                                ),
                                azure_native.network.v20220901.ExclusionManagedRuleGroupArgs(
                    ...
                    azure_native.network.v20220901.OwaspCrsExclusionEntryArgs(
                ...
                managed_rule_sets=[{
                    "ruleGroupOverrides": [{
                        ...
                        "rules": [
                            azure_native.network.v20220901.ManagedRuleOverrideArgs(
                                action="Log",
                                rule_id="931120",
                                state="Enabled",
                            ),
