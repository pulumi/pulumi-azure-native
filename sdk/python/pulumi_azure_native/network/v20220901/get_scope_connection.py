...
def get_scope_connection(network_manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scope_connection is deprecated: azure-native:network/v20220901:ScopeConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ScopeConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkManagerName'] = network_manager_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['scopeConnectionName'] = scope_connection_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220901:getScopeConnection', __args__, opts=opts, typ=GetScopeConnectionResult).value
