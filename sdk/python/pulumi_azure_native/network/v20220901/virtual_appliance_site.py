...
class VirtualApplianceSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_appliance_site = azure_native.network.v20220901.VirtualApplianceSite("virtualApplianceSite",
            address_prefix="192.168.1.0/24",
            network_virtual_appliance_name="nva",
            o365_policy=azure_native.network.v20220901.Office365PolicyPropertiesResponseArgs(
                break_out_categories=azure_native.network.v20220901.BreakOutCategoryPoliciesArgs(
                    allow=True,
                    default=True,
                    optimize=True,
                ),
