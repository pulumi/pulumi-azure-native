...
class ExpressRouteCircuitAuthorization(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        express_route_circuit_authorization = azure_native.network.v20220901.ExpressRouteCircuitAuthorization("expressRouteCircuitAuthorization",
        ...
        ```sh
        $ pulumi import azure-native:network/v20220901:ExpressRouteCircuitAuthorization authorizationName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/expressRouteCircuits/circuitName/authorizations/authorizationName 
        ```
