...
warnings.warn("""azure-native:network/v20220901:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LocalNetworkGateway to guarantee forwards compatibility.""", DeprecationWarning)
...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""LocalNetworkGateway is deprecated: azure-native:network/v20220901:LocalNetworkGateway is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:LocalNetworkGateway to guarantee forwards compatibility.""")
        ...
        super(LocalNetworkGateway, __self__).__init__(
            'azure-native:network/v20220901:LocalNetworkGateway',
            resource_name,
            __props__,
            opts)
