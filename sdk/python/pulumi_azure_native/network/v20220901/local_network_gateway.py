...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        local_network_gateway = azure_native.network.v20220901.LocalNetworkGateway("localNetworkGateway",
            fqdn="site1.contoso.com",
            gateway_ip_address="11.12.13.14",
            local_network_address_space=azure_native.network.v20220901.AddressSpaceArgs(
