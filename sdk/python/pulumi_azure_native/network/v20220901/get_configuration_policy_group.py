...
warnings.warn("""azure-native:network/v20220901:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConfigurationPolicyGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_configuration_policy_group(configuration_policy_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_policy_group is deprecated: azure-native:network/v20220901:ConfigurationPolicyGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:ConfigurationPolicyGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220901:getConfigurationPolicyGroup', __args__, opts=opts, typ=GetConfigurationPolicyGroupResult).value
