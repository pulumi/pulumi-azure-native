...
warnings.warn("""azure-native:network/v20220901:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class NetworkGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NetworkGroup is deprecated: azure-native:network/v20220901:NetworkGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:NetworkGroup to guarantee forwards compatibility.""")
