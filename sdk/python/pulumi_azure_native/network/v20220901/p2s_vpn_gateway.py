...
class P2sVpnGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        p2s_vpn_gateway = azure_native.network.v20220901.P2sVpnGateway("p2sVpnGateway",
            custom_dns_servers=[
                "1.1.1.1",
                "2.2.2.2",
            ],
            ...
            p2_s_connection_configurations=[{
                ...
                "routingConfiguration": {
                    "associatedRouteTable": azure_native.network.v20220901.SubResourceArgs(
                ...
                "vpnClientAddressPool": azure_native.network.v20220901.AddressSpaceArgs(
            ...
            vpn_server_configuration=azure_native.network.v20220901.SubResourceArgs(
