...
class ServiceEndpointPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service_endpoint_policy = azure_native.network.v20220901.ServiceEndpointPolicy("serviceEndpointPolicy",
            location="westus",
        ...
        service_endpoint_policy = azure_native.network.v20220901.ServiceEndpointPolicy("serviceEndpointPolicy",
            location="westus",
            resource_group_name="rg1",
            service_endpoint_policy_definitions=[azure_native.network.v20220901.ServiceEndpointPolicyDefinitionArgs(
        ...
        ```sh
        $ pulumi import azure-native:network/v20220901:ServiceEndpointPolicy testnsg /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/ServiceEndpointPolicies/testpolicy 
        ```
