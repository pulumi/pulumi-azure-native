...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_gateway_connection = azure_native.network.v20220901.VirtualNetworkGatewayConnection("virtualNetworkGatewayConnection",
            connection_mode="Default",
            connection_protocol="IKEv2",
            connection_type="IPsec",
            dpd_timeout_seconds=30,
            egress_nat_rules=[azure_native.network.v20220901.SubResourceArgs(
            ...
            ingress_nat_rules=[azure_native.network.v20220901.SubResourceArgs(
                id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworkGateways/vpngw/natRules/natRule1",
            )],
            ipsec_policies=[],
            local_network_gateway2=azure_native.network.v20220901.LocalNetworkGatewayResponseArgs(
            ...
            virtual_network_gateway1=azure_native.network.v20220901.VirtualNetworkGatewayResponseArgs(
                active_active=False,
