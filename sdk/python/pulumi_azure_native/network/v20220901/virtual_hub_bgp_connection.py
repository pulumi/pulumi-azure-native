...
class VirtualHubBgpConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_hub_bgp_connection = azure_native.network.v20220901.VirtualHubBgpConnection("virtualHubBgpConnection",
            connection_name="conn1",
            hub_virtual_network_connection=azure_native.network.v20220901.SubResourceArgs(
