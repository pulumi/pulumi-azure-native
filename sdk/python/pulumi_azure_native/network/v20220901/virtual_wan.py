...
warnings.warn("""azure-native:network/v20220901:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualWan to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualWan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_wan_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualWan is deprecated: azure-native:network/v20220901:VirtualWan is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:VirtualWan to guarantee forwards compatibility.""")
