...
class HubRouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20200401:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20200501:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20200601:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20201101:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20210201:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20210301:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20210801:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20220101:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20220501:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20220701:HubRouteTable"), pulumi.Alias(type_="azure-native:network/v20221101:HubRouteTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HubRouteTable, __self__).__init__(
            'azure-native:network/v20220901:HubRouteTable',
            resource_name,
            __props__,
            opts)
