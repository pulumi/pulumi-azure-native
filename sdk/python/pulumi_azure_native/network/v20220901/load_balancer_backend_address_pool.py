...
class LoadBalancerBackendAddressPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_balancer_backend_address_pool = azure_native.network.v20220901.LoadBalancerBackendAddressPool("loadBalancerBackendAddressPool",
            backend_address_pool_name="backend",
            load_balancer_backend_addresses=[
                {
                    "ipAddress": "10.0.0.4",
                    "name": "address1",
                    "virtualNetwork": azure_native.network.v20220901.SubResourceArgs(
