...
warnings.warn("""azure-native:network/v20220901:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_admin_rule_collection(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_admin_rule_collection is deprecated: azure-native:network/v20220901:AdminRuleCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:network/v20230201:AdminRuleCollection to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20220901:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult).value
