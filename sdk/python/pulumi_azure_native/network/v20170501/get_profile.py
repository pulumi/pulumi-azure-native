...
azure-native:network/v20170501:Profile is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180201:Profile to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_profile(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_profile is deprecated: Version 2017-05-01 will be removed in v2 of the provider.
azure-native:network/v20170501:Profile is being removed in the next major version of this provider. Please upgrade to azure-native:network/v20180201:Profile to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20170501:getProfile', __args__, opts=opts, typ=GetProfileResult).value
