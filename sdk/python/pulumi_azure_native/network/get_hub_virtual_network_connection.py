...
def get_hub_virtual_network_connection(connection_name: Optional[_builtins.str] = None,
...
def get_hub_virtual_network_connection_output(connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
