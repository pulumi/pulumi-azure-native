...
def get_virtual_network_peering(resource_group_name: Optional[_builtins.str] = None,
                                virtual_network_name: Optional[_builtins.str] = None,
                                virtual_network_peering_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str virtual_network_peering_name: The name of the virtual network peering.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getVirtualNetworkPeering', __args__, opts=opts, typ=GetVirtualNetworkPeeringResult).value
...
def get_virtual_network_peering_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                       ...
                                       virtual_network_peering_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getVirtualNetworkPeering', __args__, opts=opts, typ=GetVirtualNetworkPeeringResult)
