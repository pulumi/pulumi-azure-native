...
class GetRoutingRuleCollectionResult:
    ...
    def disable_bgp_route_propagation(self) -> Optional[builtins.str]:
        """
...
def get_routing_rule_collection(configuration_name: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_collection_name: The name of the network manager routing Configuration rule collection.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getRoutingRuleCollection', __args__, opts=opts, typ=GetRoutingRuleCollectionResult).value
...
def get_routing_rule_collection_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
