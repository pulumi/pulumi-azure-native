...
def get_routing_rule_collection(configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rule_collection_name: The name of the network manager routing Configuration rule collection.
    """
    __args__ = dict()
