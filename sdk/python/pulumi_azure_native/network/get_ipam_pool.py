...
def get_ipam_pool(network_manager_name: Optional[_builtins.str] = None,
...
def get_ipam_pool_output(network_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
