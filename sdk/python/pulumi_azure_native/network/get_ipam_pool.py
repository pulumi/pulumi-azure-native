...
def get_ipam_pool(network_manager_name: Optional[builtins.str] = None,
...
def get_ipam_pool_output(network_manager_name: Optional[pulumi.Input[builtins.str]] = None,
