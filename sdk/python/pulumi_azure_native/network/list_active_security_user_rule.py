...
def list_active_security_user_rule(network_manager_name: Optional[builtins.str] = None,
...
def list_active_security_user_rule_output(network_manager_name: Optional[pulumi.Input[builtins.str]] = None,
