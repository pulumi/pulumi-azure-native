...
def list_active_security_user_rule(network_manager_name: Optional[_builtins.str] = None,
...
def list_active_security_user_rule_output(network_manager_name: Optional[pulumi.Input[_builtins.str]] = None,
