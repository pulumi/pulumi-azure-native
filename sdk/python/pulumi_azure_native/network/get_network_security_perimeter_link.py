...
def get_network_security_perimeter_link(link_name: Optional[_builtins.str] = None,
...
def get_network_security_perimeter_link_output(link_name: pulumi.Input[Optional[_builtins.str]] = None,
