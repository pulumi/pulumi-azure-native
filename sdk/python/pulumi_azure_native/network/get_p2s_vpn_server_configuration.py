...
def get_p2s_vpn_server_configuration(p2_s_vpn_server_configuration_name: Optional[_builtins.str] = None,
...
def get_p2s_vpn_server_configuration_output(p2_s_vpn_server_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
