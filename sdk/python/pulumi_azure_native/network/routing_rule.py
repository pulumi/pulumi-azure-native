...
class RoutingRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20230301preview:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20240301:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20240501:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20240701:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20240901preview:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20241001:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20250101:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20250301:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20250501:RoutingRule"), pulumi.Alias(type_="azure-native:network/v20250701:RoutingRule")])
