...
class GetNetworkGroupResult:
    ...
    """
    def __init__(__self__, description=None, display_name=None, etag=None, id=None, member_type=None, name=None, provisioning_state=None, system_data=None, type=None):
...
def get_network_group(network_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501preview:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult).value
...
def get_network_group_output(network_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210501preview:getNetworkGroup', __args__, opts=opts, typ=GetNetworkGroupResult)
