...
class ManagementGroupNetworkManagerConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_group_network_manager_connection = azure_native.network.v20210501preview.ManagementGroupNetworkManagerConnection("managementGroupNetworkManagerConnection",
