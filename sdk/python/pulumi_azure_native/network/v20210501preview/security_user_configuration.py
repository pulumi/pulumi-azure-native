...
class SecurityUserConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20210201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220401preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20240301:SecurityUserConfiguration")])
