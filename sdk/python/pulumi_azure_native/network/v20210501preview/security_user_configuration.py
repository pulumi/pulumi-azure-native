...
class SecurityUserConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        security_user_configuration = azure_native.network.v20210501preview.SecurityUserConfiguration("securityUserConfiguration",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220201preview:SecurityUserConfiguration"), pulumi.Alias(type_="azure-native:network/v20220401preview:SecurityUserConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityUserConfiguration, __self__).__init__(
            'azure-native:network/v20210501preview:SecurityUserConfiguration',
            resource_name,
            __props__,
            opts)
