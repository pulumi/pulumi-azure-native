...
class UserRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user_rule = azure_native.network.v20210501preview.UserRule("userRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20210201preview:UserRule"), pulumi.Alias(type_="azure-native:network/v20220201preview:UserRule"), pulumi.Alias(type_="azure-native:network/v20220401preview:UserRule")])
