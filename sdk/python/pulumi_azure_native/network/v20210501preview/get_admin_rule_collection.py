...
class AwaitableGetAdminRuleCollectionResult(GetAdminRuleCollectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAdminRuleCollectionResult(
...
def get_admin_rule_collection(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501preview:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult).value
...
def get_admin_rule_collection_output(configuration_name: Optional[pulumi.Input[str]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAdminRuleCollectionResult]:
    """
    Gets a network manager security admin configuration rule collection.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210501preview:getAdminRuleCollection', __args__, opts=opts, typ=GetAdminRuleCollectionResult)
