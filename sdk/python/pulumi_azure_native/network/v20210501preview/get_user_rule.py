...
def get_user_rule(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20210501preview:getUserRule', __args__, opts=opts, typ=GetUserRuleResult).value
...
def get_user_rule_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['ruleName'] = rule_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:network/v20210501preview:getUserRule', __args__, opts=opts, typ=GetUserRuleResult)
