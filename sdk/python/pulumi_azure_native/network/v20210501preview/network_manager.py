...
class NetworkManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_manager = azure_native.network.v20210501preview.NetworkManager("networkManager",
            description="My Test Network Manager",
            display_name="TestNetworkManager",
            network_manager_name="TestNetworkManager",
            network_manager_scope_accesses=["Connectivity"],
            network_manager_scopes=azure_native.network.v20210501preview.NetworkManagerPropertiesNetworkManagerScopesArgs(
