...
class NetworkManagerArgs:
    ...
    def _configure(
        ...
        if network_manager_scope_accesses is None:
            raise TypeError("Missing 'network_manager_scope_accesses' argument")
        if network_manager_scopes is None and 'networkManagerScopes' in kwargs:
            network_manager_scopes = kwargs['networkManagerScopes']
        if network_manager_scopes is None:
            raise TypeError("Missing 'network_manager_scopes' argument")
