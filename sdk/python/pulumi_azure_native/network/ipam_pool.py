...
class IpamPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 pool_name: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['IpamPoolPropertiesArgs', 'IpamPoolPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] network_manager_name: The name of the network manager.
        :param pulumi.Input[_builtins.str] pool_name: IP Address Manager Pool resource name.
        :param pulumi.Input[Union['IpamPoolPropertiesArgs', 'IpamPoolPropertiesArgsDict']] properties: Properties of IpamPool resource properties which are specific to the Pool resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240101preview:IpamPool"), pulumi.Alias(type_="azure-native:network/v20240501:IpamPool"), pulumi.Alias(type_="azure-native:network/v20240701:IpamPool"), pulumi.Alias(type_="azure-native:network/v20241001:IpamPool"), pulumi.Alias(type_="azure-native:network/v20250101:IpamPool"), pulumi.Alias(type_="azure-native:network/v20250301:IpamPool"), pulumi.Alias(type_="azure-native:network/v20250501:IpamPool"), pulumi.Alias(type_="azure-native:network/v20250701:IpamPool")])
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.IpamPoolPropertiesResponse']:
        """
        Properties of IpamPool resource properties which are specific to the Pool resource.
        """
        return pulumi.get(self, "properties")
