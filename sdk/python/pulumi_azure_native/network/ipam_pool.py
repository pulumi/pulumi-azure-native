...
class IpamPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20240101preview:IpamPool"), pulumi.Alias(type_="azure-native:network/v20240501:IpamPool"), pulumi.Alias(type_="azure-native:network/v20240701:IpamPool"), pulumi.Alias(type_="azure-native:network/v20241001:IpamPool")])
