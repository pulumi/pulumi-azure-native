...
def get_network_security_perimeter_profile(network_security_perimeter_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getNetworkSecurityPerimeterProfile', __args__, opts=opts, typ=GetNetworkSecurityPerimeterProfileResult).value
...
def get_network_security_perimeter_profile_output(network_security_perimeter_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getNetworkSecurityPerimeterProfile', __args__, opts=opts, typ=GetNetworkSecurityPerimeterProfileResult)
