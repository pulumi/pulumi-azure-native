...
def get_network_security_perimeter_profile(network_security_perimeter_name: Optional[builtins.str] = None,
...
def get_network_security_perimeter_profile_output(network_security_perimeter_name: Optional[pulumi.Input[builtins.str]] = None,
