...
def get_security_user_rule_collection(configuration_name: Optional[_builtins.str] = None,
...
def get_security_user_rule_collection_output(configuration_name: Optional[pulumi.Input[_builtins.str]] = None,
