...
__all__ = [
    'GetExpressRouteGatewayResiliencyInformationResult',
    'AwaitableGetExpressRouteGatewayResiliencyInformationResult',
    'get_express_route_gateway_resiliency_information',
    'get_express_route_gateway_resiliency_information_output',
]
...
class AwaitableGetExpressRouteGatewayResiliencyInformationResult(GetExpressRouteGatewayResiliencyInformationResult):
...
def get_express_route_gateway_resiliency_information(attempt_refresh: Optional[_builtins.bool] = None,
                                                     express_route_gateway_name: Optional[_builtins.str] = None,
                                                     resource_group_name: Optional[_builtins.str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetExpressRouteGatewayResiliencyInformationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getExpressRouteGatewayResiliencyInformation', __args__, opts=opts, typ=GetExpressRouteGatewayResiliencyInformationResult).value

    return AwaitableGetExpressRouteGatewayResiliencyInformationResult(
...
def get_express_route_gateway_resiliency_information_output(attempt_refresh: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getExpressRouteGatewayResiliencyInformation', __args__, opts=opts, typ=GetExpressRouteGatewayResiliencyInformationResult)
    return __ret__.apply(lambda __response__: GetExpressRouteGatewayResiliencyInformationResult(
