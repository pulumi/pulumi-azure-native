...
def get_network_interface_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
