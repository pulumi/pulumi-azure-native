...
def get_private_link_service_private_endpoint_connection(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pe_connection_name: The name of the private end point connection.
