...
def get_zone(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_zone is deprecated: Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20180501 or later.""")
    __args__ = dict()
