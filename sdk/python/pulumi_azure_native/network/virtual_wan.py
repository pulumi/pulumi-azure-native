...
class VirtualWanArgs:
    ...
    def allow_vnet_to_vnet_traffic(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def allow_vnet_to_vnet_traffic(self, value: pulumi.Input[Optional[_builtins.bool]]):
