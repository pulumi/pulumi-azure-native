...
def get_active_sessions(bastion_host_name: Optional[_builtins.str] = None,
...
def get_active_sessions_output(bastion_host_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:network:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult)
