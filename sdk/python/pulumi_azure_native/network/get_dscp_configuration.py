...
def get_dscp_configuration(dscp_configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dscp_configuration_name: The name of the resource.
...
def get_dscp_configuration_output(dscp_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
