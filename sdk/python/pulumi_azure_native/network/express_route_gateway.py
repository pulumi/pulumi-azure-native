...
class ExpressRouteGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_non_virtual_wan_traffic: Configures this gateway to accept traffic from non Virtual WAN networks.
    ...
    def express_route_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def express_route_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
