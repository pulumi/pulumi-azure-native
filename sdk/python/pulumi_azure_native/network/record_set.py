...
class RecordSet(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:RecordSet"), pulumi.Alias(type_="azure-native:network/latest:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/latest:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180901:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20180901:RecordSet"), pulumi.Alias(type_="azure-native:network/v20200101:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200101:RecordSet"), pulumi.Alias(type_="azure-native:network/v20200601:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200601:RecordSet")])
