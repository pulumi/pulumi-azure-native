...
class WorkloadImpact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:impact/v20240501preview:WorkloadImpact"), pulumi.Alias(type_="azure-native:impact/v20250101preview:WorkloadImpact"), pulumi.Alias(type_="azure-native:impact/v20260101preview:WorkloadImpact")])
