...
class InsightArgs:
    def __init__(__self__, *,
                 workload_impact_name: pulumi.Input[str],
                 insight_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input['InsightPropertiesArgs']] = None):
        """
        The set of arguments for constructing a Insight resource.
        :param pulumi.Input[str] workload_impact_name: workloadImpact resource 
        :param pulumi.Input[str] insight_name: Name of the insight
    ...
    def workload_impact_name(self) -> pulumi.Input[str]:
        """
    ...
    def workload_impact_name(self, value: pulumi.Input[str]):
        pulumi.set(self, "workload_impact_name", value)

    @property
    @pulumi.getter(name="insightName")
    def insight_name(self) -> Optional[pulumi.Input[str]]:
        """
        Name of the insight
        """
    ...
    @insight_name.setter
    def insight_name(self, value: Optional[pulumi.Input[str]]):
...
class Insight(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:impact/v20240501preview:Insight"), pulumi.Alias(type_="azure-native_impact_v20240501preview:impact:Insight")])
