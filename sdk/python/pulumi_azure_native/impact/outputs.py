...
class ClientIncidentDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 client_incident_id: Optional[_builtins.str] = None,
...
class ConnectorPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str tenant_id: tenant id of this connector
        """
...
class ImpactDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str end_time: Time at which impact was ended according to reported impact.
        """
...
class InsightPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str insight_unique_id: unique id of the insight.
        :param _builtins.str provisioning_state: Resource provisioning state.
        :param Any additional_details: additional details of the insight.
        :param _builtins.str event_id: Identifier of the event that has been correlated with this insight. This can be used to aggregate insights for the same event.
        :param _builtins.str event_time: Time of the event, which has been correlated the impact.
        :param _builtins.str group_id: Identifier that can be used to group similar insights.
        :param _builtins.str status: status of the insight. example resolved, repaired, other.
        """
...
class PerformanceResponse(dict):
    ...
    def __init__(__self__, *,
                 actual: Optional[_builtins.float] = None,
                 expected: Optional[_builtins.float] = None,
        ...
        :param _builtins.str metric_name: Name of the Metric examples:  Disk, IOPs, CPU, GPU, Memory, details can be found from /impactCategories API
        :param _builtins.str unit: Unit of the metric ex: Bytes, Percentage, Count, Seconds, Milliseconds, Bytes/Second, Count/Second, etc.., Other
        """
...
class WorkloadImpactPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 arm_correlation_ids: Optional[Sequence[_builtins.str]] = None,
                 ...
                 impact_description: Optional[_builtins.str] = None,
                 impact_group_id: Optional[_builtins.str] = None,
