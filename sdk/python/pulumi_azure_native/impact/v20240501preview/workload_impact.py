...
class WorkloadImpactArgs:
    ...
    def workload_impact_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def workload_impact_name(self, value: Optional[pulumi.Input[str]]):
...
class WorkloadImpact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:impact:WorkloadImpact")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadImpact, __self__).__init__(
            'azure-native:impact/v20240501preview:WorkloadImpact',
            resource_name,
            __props__,
            opts)
