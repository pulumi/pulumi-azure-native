...
def get_insight(insight_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:impact/v20240501preview:getInsight', __args__, opts=opts, typ=GetInsightResult).value
...
def get_insight_output(insight_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workloadImpactName'] = workload_impact_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:impact/v20240501preview:getInsight', __args__, opts=opts, typ=GetInsightResult)
