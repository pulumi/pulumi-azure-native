...
def get_workload_impact(workload_impact_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:impact:getWorkloadImpact', __args__, opts=opts, typ=GetWorkloadImpactResult).value
...
def get_workload_impact_output(workload_impact_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
