...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:impact/v20240501preview:Connector"), pulumi.Alias(type_="azure-native_impact_v20240501preview:impact:Connector")])
