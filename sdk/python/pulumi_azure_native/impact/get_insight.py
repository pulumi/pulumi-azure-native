...
def get_insight(insight_name: Optional[builtins.str] = None,
                workload_impact_name: Optional[builtins.str] = None,
    ...
    :param builtins.str insight_name: Name of the insight
    :param builtins.str workload_impact_name: workloadImpact resource 
    """
    __args__ = dict()
    __args__['insightName'] = insight_name
    __args__['workloadImpactName'] = workload_impact_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:impact:getInsight', __args__, opts=opts, typ=GetInsightResult).value
...
def get_insight_output(insight_name: Optional[pulumi.Input[builtins.str]] = None,
