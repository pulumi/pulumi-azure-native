...
class ConfigDiagnosticsResponse(dict):
    ...
    def __init__(__self__, *,
                 last_executed: Optional[_builtins.str] = None,
...
class ConfigDiagnosticsValidatorResultIssueResponse(dict):
    ...
    def __init__(__self__, *,
                 description_params: Optional[Sequence[_builtins.str]] = None,
...
class ConfigDiagnosticsValidatorResultResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replica_set_subnet_display_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str validator_id: Validator identifier
        """
...
class DomainSecuritySettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 channel_binding: Optional[_builtins.str] = None,
                 kerberos_armoring: Optional[_builtins.str] = None,
                 kerberos_rc4_encryption: Optional[_builtins.str] = None,
                 ldap_signing: Optional[_builtins.str] = None,
                 ntlm_v1: Optional[_builtins.str] = None,
                 sync_kerberos_passwords: Optional[_builtins.str] = None,
                 sync_ntlm_passwords: Optional[_builtins.str] = None,
                 sync_on_prem_passwords: Optional[_builtins.str] = None,
        ...
        :param _builtins.str ldap_signing: A flag to determine whether or not LdapSigning is enabled or disabled.
        :param _builtins.str ntlm_v1: A flag to determine whether or not NtlmV1 is enabled or disabled.
        :param _builtins.str sync_kerberos_passwords: A flag to determine whether or not SyncKerberosPasswords is enabled or disabled.
        :param _builtins.str sync_ntlm_passwords: A flag to determine whether or not SyncNtlmPasswords is enabled or disabled.
        :param _builtins.str sync_on_prem_passwords: A flag to determine whether or not SyncOnPremPasswords is enabled or disabled.
        :param _builtins.str tls_v1: A flag to determine whether or not TlsV1 is enabled or disabled.
        """
...
class ForestTrustResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 remote_dns_ips: Optional[_builtins.str] = None,
                 trust_direction: Optional[_builtins.str] = None,
                 trust_password: Optional[_builtins.str] = None,
        ...
        :param _builtins.str trust_password: Trust Password
        :param _builtins.str trusted_domain_fqdn: Trusted Domain FQDN
        """
...
class HealthAlertResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Health Alert Name
        :param _builtins.str raised: Health Alert Raised DateTime
        :param _builtins.str resolution_uri: Health Alert TSG Link
        :param _builtins.str severity: Health Alert Severity
        """
        pulumi.set(__self__, "id", id)
...
class LdapsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 external_access: Optional[_builtins.str] = None,
                 ldaps: Optional[_builtins.str] = None,
                 pfx_certificate: Optional[_builtins.str] = None,
        ...
        :param _builtins.str external_access: A flag to determine whether or not Secure LDAP access over the internet is enabled or disabled.
        :param _builtins.str ldaps: A flag to determine whether or not Secure LDAP is enabled or disabled.
        :param _builtins.str pfx_certificate: The certificate required to configure Secure LDAP. The parameter passed here should be a base64encoded representation of the certificate pfx file.
        :param _builtins.str pfx_certificate_password: The password to decrypt the provided Secure LDAP certificate pfx file.
        """
...
class MigrationProgressResponse(dict):
    ...
    def __init__(__self__, *,
                 completion_percentage: Optional[_builtins.float] = None,
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 notify_dc_admins: Optional[_builtins.str] = None,
...
class ReplicaSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str health_last_evaluated: Last domain evaluation run DateTime
        :param Sequence['HealthMonitorResponse'] health_monitors: List of Domain Health Monitors
        :param _builtins.str replica_set_id: ReplicaSet Id
        :param _builtins.str service_status: Status of Domain Service instance
        :param _builtins.str vnet_site_id: Virtual network site id
        :param _builtins.str location: Virtual network location
        :param _builtins.str subnet_id: The name of the virtual network that Domain Services will be deployed on. The id of the subnet that Domain Services will be deployed on. /virtualNetwork/vnetName/subnets/subnetName.
        """
...
class ResourceForestSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 resource_forest: Optional[_builtins.str] = None,
