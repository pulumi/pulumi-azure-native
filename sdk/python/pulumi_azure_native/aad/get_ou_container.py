...
def get_ou_container(domain_service_name: Optional[_builtins.str] = None,
                     ou_container_name: Optional[_builtins.str] = None,
...
def get_ou_container_output(domain_service_name: pulumi.Input[Optional[_builtins.str]] = None,
                            ou_container_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
