...
def get_ou_container(domain_service_name: Optional[builtins.str] = None,
                     ou_container_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ou_container_name: The name of the OuContainer.
...
def get_ou_container_output(domain_service_name: Optional[pulumi.Input[builtins.str]] = None,
