...
def get_domain_service(domain_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_service is deprecated: azure-native:aad/v20210501:DomainService is being removed in the next major version of this provider. Upgrade to at least azure-native:aad/v20221201:DomainService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['domainServiceName'] = domain_service_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:aad/v20210501:getDomainService', __args__, opts=opts, typ=GetDomainServiceResult).value
