...
class ConfigDiagnosticsResponse(dict):
    ...
    def _configure(
             ...
             **kwargs):
        if 'lastExecuted' in kwargs:
            last_executed = kwargs['lastExecuted']
        if 'validatorResults' in kwargs:
...
class ConfigDiagnosticsValidatorResultIssueResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'descriptionParams' in kwargs:
...
class DomainSecuritySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Domain Security Settings
        :param str channel_binding: A flag to determine whether or not ChannelBinding is enabled or disabled.
        ...
        :param str ldap_signing: A flag to determine whether or not LdapSigning is enabled or disabled.
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'channelBinding' in kwargs:
            channel_binding = kwargs['channelBinding']
        if 'kerberosArmoring' in kwargs:
            kerberos_armoring = kwargs['kerberosArmoring']
        if 'kerberosRc4Encryption' in kwargs:
    ...
    def ldap_signing(self) -> Optional[str]:
        """
...
class HealthAlertResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'lastDetected' in kwargs:
            last_detected = kwargs['lastDetected']
        if 'resolutionUri' in kwargs:
...
class LdapsSettingsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'certificateNotAfter' in kwargs:
...
class MigrationProgressResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'completionPercentage' in kwargs:
            completion_percentage = kwargs['completionPercentage']
        if 'progressMessage' in kwargs:
...
class MigrationPropertiesResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'migrationProgress' in kwargs:
            migration_progress = kwargs['migrationProgress']
        if 'oldSubnetId' in kwargs:
            old_subnet_id = kwargs['oldSubnetId']
        if 'oldVnetSiteId' in kwargs:
...
class ReplicaSetResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'domainControllerIpAddress' in kwargs:
