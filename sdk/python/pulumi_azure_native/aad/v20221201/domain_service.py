...
class DomainServiceArgs:
    ...
    def _configure(
        ...
        if 'configDiagnostics' in kwargs:
        ...
        if 'domainSecuritySettings' in kwargs:
        ...
        if 'filteredSync' in kwargs:
            filtered_sync = kwargs['filteredSync']
        if 'ldapsSettings' in kwargs:
        ...
        if 'resourceForestSettings' in kwargs:
