...
class DomainService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(config_diagnostics, ConfigDiagnosticsArgs):
            ...
            if not isinstance(domain_security_settings, DomainSecuritySettingsArgs):
            ...
            if not isinstance(ldaps_settings, LdapsSettingsArgs):
            ...
            if not isinstance(resource_forest_settings, ResourceForestSettingsArgs):
