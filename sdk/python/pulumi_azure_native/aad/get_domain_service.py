...
def get_domain_service(domain_service_name: Optional[_builtins.str] = None,
...
def get_domain_service_output(domain_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
