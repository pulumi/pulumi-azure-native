...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:aad:getDomainService'.""", DeprecationWarning)
...
def get_domain_service(domain_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:aad/latest:getDomainService', __args__, opts=opts, typ=GetDomainServiceResult).value
