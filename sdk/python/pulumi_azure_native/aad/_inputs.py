...
class ConfigDiagnosticsValidatorResultArgsDict(TypedDict):
    ...
    """
    issues: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConfigDiagnosticsValidatorResultIssueArgs']]]]]
    """
...
class ConfigDiagnosticsValidatorResultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] validator_id: Validator identifier
        """
...
class ConfigDiagnosticsArgsDict(TypedDict):
    ...
    """
    validator_results: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ConfigDiagnosticsValidatorResultArgs']]]]]
    """
...
class DomainSecuritySettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'LdapSigning']] ldap_signing: A flag to determine whether or not LdapSigning is enabled or disabled.
        :param pulumi.Input[Union[_builtins.str, 'NtlmV1']] ntlm_v1: A flag to determine whether or not NtlmV1 is enabled or disabled.
        :param pulumi.Input[Union[_builtins.str, 'SyncKerberosPasswords']] sync_kerberos_passwords: A flag to determine whether or not SyncKerberosPasswords is enabled or disabled.
        :param pulumi.Input[Union[_builtins.str, 'SyncNtlmPasswords']] sync_ntlm_passwords: A flag to determine whether or not SyncNtlmPasswords is enabled or disabled.
        :param pulumi.Input[Union[_builtins.str, 'SyncOnPremPasswords']] sync_on_prem_passwords: A flag to determine whether or not SyncOnPremPasswords is enabled or disabled.
        :param pulumi.Input[Union[_builtins.str, 'TlsV1']] tls_v1: A flag to determine whether or not TlsV1 is enabled or disabled.
        """
...
class ForestTrustArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] trust_password: Trust Password
        :param pulumi.Input[_builtins.str] trusted_domain_fqdn: Trusted Domain FQDN
        """
...
class LdapsSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] pfx_certificate_password: The password to decrypt the provided Secure LDAP certificate pfx file.
        """
...
class ResourceForestSettingsArgsDict(TypedDict):
    ...
    Resource Forest
    """
    settings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ForestTrustArgs']]]]]
    """
