...
class DomainServiceArgs:
    def __init__(__self__, *,
                 ...
                 filtered_sync: Optional[pulumi.Input[Union[builtins.str, 'FilteredSync']]] = None,
                 ...
                 sync_scope: Optional[pulumi.Input[Union[builtins.str, 'SyncScope']]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_configuration_type: Domain Configuration Type
        :param pulumi.Input[builtins.str] domain_name: The name of the Azure domain that the user would like to deploy Domain Services to.
        ...
        :param pulumi.Input[Union[builtins.str, 'FilteredSync']] filtered_sync: Enabled or Disabled flag to turn on Group-based filtered sync
        ...
        :param pulumi.Input[builtins.str] sku: Sku Type
        :param pulumi.Input[Union[builtins.str, 'SyncScope']] sync_scope: All or CloudOnly, All users in AAD are synced to AAD DS domain or only users actively syncing in the cloud
    ...
    def domain_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_service_name", value)

    @property
    @pulumi.getter(name="filteredSync")
    def filtered_sync(self) -> Optional[pulumi.Input[Union[builtins.str, 'FilteredSync']]]:
        """
    ...
    def filtered_sync(self, value: Optional[pulumi.Input[Union[builtins.str, 'FilteredSync']]]):
    ...
    def sync_scope(self) -> Optional[pulumi.Input[Union[builtins.str, 'SyncScope']]]:
        """
    ...
    @sync_scope.setter
    def sync_scope(self, value: Optional[pulumi.Input[Union[builtins.str, 'SyncScope']]]):
...
class DomainService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="filteredSync")
    def filtered_sync(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enabled or Disabled flag to turn on Group-based filtered sync
        """
        return pulumi.get(self, "filtered_sync")
    ...
    def sync_application_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="syncScope")
    def sync_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        All or CloudOnly, All users in AAD are synced to AAD DS domain or only users actively syncing in the cloud
        """
        return pulumi.get(self, "sync_scope")
