...
def get_domain_service(domain_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_service is deprecated: azure-native:aad/v20220901:DomainService is being removed in the next major version of this provider. Please upgrade to azure-native:aad/v20221201:DomainService to guarantee forwards compatibility.""")
    __args__ = dict()
