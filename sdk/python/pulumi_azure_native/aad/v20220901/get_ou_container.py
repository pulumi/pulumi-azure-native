...
warnings.warn("""azure-native:aad/v20220901:OuContainer is being removed in the next major version of this provider. Please upgrade to azure-native:aad/v20221201:OuContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ou_container(domain_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ou_container is deprecated: azure-native:aad/v20220901:OuContainer is being removed in the next major version of this provider. Please upgrade to azure-native:aad/v20221201:OuContainer to guarantee forwards compatibility.""")
    __args__ = dict()
