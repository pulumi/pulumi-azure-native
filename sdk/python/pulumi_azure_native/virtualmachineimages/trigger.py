...
class TriggerArgs:
    def __init__(__self__, *,
                 image_template_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] kind: The kind of trigger.
    ...
    def image_template_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def image_template_name(self, value: pulumi.Input[builtins.str]):
