...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:virtualmachineimages:Trigger"), pulumi.Alias(type_="azure-native:virtualmachineimages/v20220701:Trigger"), pulumi.Alias(type_="azure-native:virtualmachineimages/v20240201:Trigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Trigger, __self__).__init__(
            'azure-native:virtualmachineimages/v20230701:Trigger',
            resource_name,
            __props__,
            opts)
