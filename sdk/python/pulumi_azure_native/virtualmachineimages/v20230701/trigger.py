...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:virtualmachineimages:Trigger"), pulumi.Alias(type_="azure-native:virtualmachineimages/v20220701:Trigger")])
