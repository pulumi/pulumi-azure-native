...
def get_virtual_machine_image_template(image_template_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_image_template is deprecated: azure-native:virtualmachineimages/v20220214:VirtualMachineImageTemplate is being removed in the next major version of this provider. Please upgrade to azure-native:virtualmachineimages/v20220701:VirtualMachineImageTemplate to guarantee forwards compatibility.""")
    __args__ = dict()
