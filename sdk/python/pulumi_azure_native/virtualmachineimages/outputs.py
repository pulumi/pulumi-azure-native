...
class ImageTemplateFileCustomizerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sha256_checksum: SHA256 checksum of the file provided in the sourceUri field above
        :param _builtins.str source_uri: The URI of the file to be uploaded for customizing the VM. It can be a github link, SAS URI for Azure Storage, etc
        """
...
class ImageTemplateFileValidatorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of validation you want to use on the Image. For example, "Shell" can be shell validation
               Expected value is 'File'.
        :param _builtins.str destination: The absolute path to a file (with nested directory structures already created) where the file (from sourceUri) will be uploaded to in the VM
        :param _builtins.str name: Friendly Name to provide context on what this validation step does
        :param _builtins.str sha256_checksum: SHA256 checksum of the file provided in the sourceUri field above
        :param _builtins.str source_uri: The URI of the file to be uploaded to the VM for validation. It can be a github link, Azure Storage URI (authorized or SAS), etc
        """
        pulumi.set(__self__, "type", 'File')
        if destination is not None:
            pulumi.set(__self__, "destination", destination)
...
class ImageTemplateLastRunStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 run_state: Optional[_builtins.str] = None,
                 run_sub_state: Optional[_builtins.str] = None,
        ...
        :param _builtins.str run_sub_state: Sub-state of the last run
        :param _builtins.str start_time: Start time of the last run (UTC)
        """
...
class ImageTemplateManagedImageDistributorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        """
...
class ImageTemplatePlatformImageSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str offer: Image offer from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param 'PlatformImagePurchasePlanResponse' plan_info: Optional configuration of purchase plan for platform image.
        :param _builtins.str publisher: Image Publisher in [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param _builtins.str sku: Image sku from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param _builtins.str version: Image version from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages). If 'latest' is specified here, the version is evaluated when the image build takes place, not when the template is submitted.
        """
...
class ImageTemplatePowerShellCustomizerResponse(dict):
    ...
    def __init__(__self__, *,
                 type: _builtins.str,
                 inline: Optional[Sequence[_builtins.str]] = None,
                 name: Optional[_builtins.str] = None,
                 run_as_system: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str name: Friendly Name to provide context on what this customization step does
        :param _builtins.bool run_as_system: If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        :param _builtins.bool run_elevated: If specified, the PowerShell script will be run with elevated privileges
        :param _builtins.str script_uri: URI of the PowerShell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc
        :param _builtins.str sha256_checksum: SHA256 checksum of the power shell script provided in the scriptUri field above
        :param Sequence[_builtins.int] valid_exit_codes: Valid exit codes for the PowerShell script. [Default: 0]
        """
...
class ImageTemplatePowerShellValidatorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool run_as_system: If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        :param _builtins.bool run_elevated: If specified, the PowerShell script will be run with elevated privileges
        :param _builtins.str script_uri: URI of the PowerShell script to be run for validation. It can be a github link, Azure Storage URI, etc
        :param _builtins.str sha256_checksum: SHA256 checksum of the power shell script provided in the scriptUri field above
        :param Sequence[_builtins.int] valid_exit_codes: Valid exit codes for the PowerShell script. [Default: 0]
        """
        pulumi.set(__self__, "type", 'PowerShell')
...
class ImageTemplatePropertiesResponseErrorHandling(dict):
    ...
    def __init__(__self__, *,
                 on_customizer_error: Optional[_builtins.str] = None,
...
class ImageTemplatePropertiesResponseValidate(dict):
    ...
    def __init__(__self__, *,
                 continue_distribute_on_failure: Optional[_builtins.bool] = None,
...
class ImageTemplateRestartCustomizerResponse(dict):
    ...
    def __init__(__self__, *,
                 type: _builtins.str,
                 name: Optional[_builtins.str] = None,
                 restart_check_command: Optional[_builtins.str] = None,
                 restart_command: Optional[_builtins.str] = None,
        ...
        :param _builtins.str name: Friendly Name to provide context on what this customization step does
        :param _builtins.str restart_check_command: Command to check if restart succeeded [Default: '']
        :param _builtins.str restart_command: Command to execute the restart [Default: 'shutdown /r /f /t 0 /c "packer restart"']
        :param _builtins.str restart_timeout: Restart timeout specified as a string of magnitude and unit, e.g. '5m' (5 minutes) or '2h' (2 hours) [Default: '5m']
        """
...
class ImageTemplateSharedImageDistributorResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replication_regions: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Mapping[str, _builtins.str] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        :param _builtins.bool exclude_from_latest: Flag that indicates whether created image version should be excluded from latest. Omit to use the default (false).
        :param Sequence[_builtins.str] replication_regions: [Deprecated] A list of regions that the image will be replicated to. This list can be specified only if targetRegions is not specified. This field is deprecated - use targetRegions instead.
        :param _builtins.str storage_account_type: [Deprecated] Storage account type to be used to store the shared image. Omit to use the default (Standard_LRS). This field can be specified only if replicationRegions is specified. This field is deprecated - use targetRegions instead.
...
class ImageTemplateShellCustomizerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Friendly Name to provide context on what this customization step does
        :param _builtins.str script_uri: URI of the shell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc
        :param _builtins.str sha256_checksum: SHA256 checksum of the shell script provided in the scriptUri field
        """
...
class ImageTemplateShellValidatorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] inline: Array of shell commands to execute
        :param _builtins.str name: Friendly Name to provide context on what this validation step does
        :param _builtins.str script_uri: URI of the shell script to be run for validation. It can be a github link, Azure Storage URI, etc
        :param _builtins.str sha256_checksum: SHA256 checksum of the shell script provided in the scriptUri field
        """
        pulumi.set(__self__, "type", 'Shell')
        if inline is not None:
...
class ImageTemplateVhdDistributorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        :param _builtins.str uri: Optional Azure Storage URI for the distributed VHD blob. Omit to use the default (empty string) in which case VHD would be published to the storage account in the staging resource group.
        """
        pulumi.set(__self__, "run_output_name", run_output_name)
...
class ImageTemplateWindowsUpdateCustomizerResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[_builtins.str] = None,
                 search_criteria: Optional[_builtins.str] = None,
        ...
        :param _builtins.str name: Friendly Name to provide context on what this customization step does
        :param _builtins.str search_criteria: Criteria to search updates. Omit or specify empty string to use the default (search all). Refer to above link for examples and detailed description of this field.
        :param _builtins.int update_limit: Maximum number of updates to apply at a time. Omit or specify 0 to use the default (1000)
        """
...
class VirtualNetworkConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 container_instance_subnet_id: Optional[_builtins.str] = None,
                 proxy_vm_size: Optional[_builtins.str] = None,
