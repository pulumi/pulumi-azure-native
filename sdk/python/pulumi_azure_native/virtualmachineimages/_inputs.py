...
class DistributeVersionerLatestArgs:
    def __init__(__self__, *,
        ...
        """
        Generates version number that will be latest based on existing version numbers.
        :param pulumi.Input[builtins.str] scheme: Version numbering scheme to be used.
               Expected value is 'Latest'.
        :param pulumi.Input[builtins.int] major: Major version for the generated version number. Determine what is "latest" based on versions with this value as the major version. -1 is equivalent to leaving it unset.
        """
...
class ImageTemplateFileCustomizerArgs:
    def __init__(__self__, *,
        ...
        """
        Uploads files to VMs (Linux, Windows). Corresponds to Packer file provisioner
        :param pulumi.Input[builtins.str] type: The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
               Expected value is 'File'.
        :param pulumi.Input[builtins.str] destination: The absolute path to a file (with nested directory structures already created) where the file (from sourceUri) will be uploaded to in the VM
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this customization step does
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the file provided in the sourceUri field above
        :param pulumi.Input[builtins.str] source_uri: The URI of the file to be uploaded for customizing the VM. It can be a github link, SAS URI for Azure Storage, etc
        """
...
class ImageTemplateFileValidatorArgs:
    def __init__(__self__, *,
        ...
        """
        Uploads files required for validation to VMs (Linux, Windows). Corresponds to Packer file provisioner
        :param pulumi.Input[builtins.str] type: The type of validation you want to use on the Image. For example, "Shell" can be shell validation
               Expected value is 'File'.
        :param pulumi.Input[builtins.str] destination: The absolute path to a file (with nested directory structures already created) where the file (from sourceUri) will be uploaded to in the VM
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this validation step does
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the file provided in the sourceUri field above
        :param pulumi.Input[builtins.str] source_uri: The URI of the file to be uploaded to the VM for validation. It can be a github link, Azure Storage URI (authorized or SAS), etc
        """
        pulumi.set(__self__, "type", 'File')
        if destination is not None:
            pulumi.set(__self__, "destination", destination)
...
if not MYPY:
    class ImageTemplateManagedImageDistributorArgsDict(TypedDict):
        ...
        """
        run_output_name: pulumi.Input[builtins.str]
        """
        ...
        """
        artifact_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ImageTemplateManagedImageDistributorArgs:
    def __init__(__self__, *,
                 ...
                 run_output_name: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 artifact_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Distribute as a Managed Disk Image.
        :param pulumi.Input[builtins.str] image_id: Resource Id of the Managed Disk Image
        :param pulumi.Input[builtins.str] location: Azure location for the image, should match if image already exists
        :param pulumi.Input[builtins.str] run_output_name: The name to be used for the associated RunOutput.
        :param pulumi.Input[builtins.str] type: Type of distribution.
               Expected value is 'ManagedImage'.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        """
    ...
    def run_output_name(self) -> pulumi.Input[builtins.str]:
        """
        The name to be used for the associated RunOutput.
        """
    ...
    def run_output_name(self, value: pulumi.Input[builtins.str]):
    ...
    def artifact_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Tags that will be applied to the artifact once it has been created/updated by the distributor.
        """
    ...
    def artifact_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ImageTemplateManagedImageSourceArgs:
    def __init__(__self__, *,
        ...
        """
        Describes an image source that is a managed image in customer subscription. This image must reside in the same subscription and region as the Image Builder template.
        :param pulumi.Input[builtins.str] image_id: ARM resource id of the managed image in customer subscription
        :param pulumi.Input[builtins.str] type: Specifies the type of source image you want to start with.
               Expected value is 'ManagedImage'.
        """
        pulumi.set(__self__, "image_id", image_id)
        pulumi.set(__self__, "type", 'ManagedImage')
...
class ImageTemplatePlatformImageSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Specifies the type of source image you want to start with.
               Expected value is 'PlatformImage'.
        :param pulumi.Input[builtins.str] offer: Image offer from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param pulumi.Input['PlatformImagePurchasePlanArgs'] plan_info: Optional configuration of purchase plan for platform image.
        :param pulumi.Input[builtins.str] publisher: Image Publisher in [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param pulumi.Input[builtins.str] sku: Image sku from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages).
        :param pulumi.Input[builtins.str] version: Image version from the [Azure Gallery Images](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages). If 'latest' is specified here, the version is evaluated when the image build takes place, not when the template is submitted.
        """
...
if not MYPY:
    class ImageTemplatePowerShellCustomizerArgsDict(TypedDict):
        ...
        """
        inline: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        Friendly Name to provide context on what this customization step does
        """
        run_as_system: NotRequired[pulumi.Input[builtins.bool]]
        """
        If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        """
        run_elevated: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        valid_exit_codes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class ImageTemplatePowerShellCustomizerArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 inline: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 run_as_system: Optional[pulumi.Input[builtins.bool]] = None,
                 run_elevated: Optional[pulumi.Input[builtins.bool]] = None,
                 script_uri: Optional[pulumi.Input[builtins.str]] = None,
                 sha256_checksum: Optional[pulumi.Input[builtins.str]] = None,
                 valid_exit_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        Runs the specified PowerShell on the VM (Windows). Corresponds to Packer powershell provisioner. Exactly one of 'scriptUri' or 'inline' can be specified.
        :param pulumi.Input[builtins.str] type: The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
               Expected value is 'PowerShell'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inline: Array of PowerShell commands to execute
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this customization step does
        :param pulumi.Input[builtins.bool] run_as_system: If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        :param pulumi.Input[builtins.bool] run_elevated: If specified, the PowerShell script will be run with elevated privileges
        :param pulumi.Input[builtins.str] script_uri: URI of the PowerShell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the power shell script provided in the scriptUri field above
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] valid_exit_codes: Valid exit codes for the PowerShell script. [Default: 0]
        """
    ...
    @property
    @pulumi.getter
    def inline(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Array of PowerShell commands to execute
        """
    ...
    @inline.setter
    def inline(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def run_as_system(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        """
    ...
    def run_as_system(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "run_as_system", value)

    @property
    @pulumi.getter(name="runElevated")
    def run_elevated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If specified, the PowerShell script will be run with elevated privileges
        """
    ...
    @run_elevated.setter
    def run_elevated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def valid_exit_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        Valid exit codes for the PowerShell script. [Default: 0]
        """
    ...
    def valid_exit_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
class ImageTemplatePowerShellValidatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] run_as_system: If specified, the PowerShell script will be run with elevated privileges using the Local System user. Can only be true when the runElevated field above is set to true.
        :param pulumi.Input[builtins.bool] run_elevated: If specified, the PowerShell script will be run with elevated privileges
        :param pulumi.Input[builtins.str] script_uri: URI of the PowerShell script to be run for validation. It can be a github link, Azure Storage URI, etc
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the power shell script provided in the scriptUri field above
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] valid_exit_codes: Valid exit codes for the PowerShell script. [Default: 0]
        """
        pulumi.set(__self__, "type", 'PowerShell')
...
if not MYPY:
    class ImageTemplatePropertiesErrorHandlingArgsDict(TypedDict):
        ...
        """
        on_customizer_error: NotRequired[pulumi.Input[Union[builtins.str, 'OnBuildError']]]
        """
        ...
        """
        on_validation_error: NotRequired[pulumi.Input[Union[builtins.str, 'OnBuildError']]]
        """
...
class ImageTemplatePropertiesErrorHandlingArgs:
    ...
    def on_customizer_error(self) -> Optional[pulumi.Input[Union[builtins.str, 'OnBuildError']]]:
        """
        If there is a customizer error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up. This is the default behavior. If there is a customizer error and this field is set to 'abort', the build VM will be preserved.
        """
    ...
    def on_customizer_error(self, value: Optional[pulumi.Input[Union[builtins.str, 'OnBuildError']]]):
        pulumi.set(self, "on_customizer_error", value)

    @property
    @pulumi.getter(name="onValidationError")
    def on_validation_error(self) -> Optional[pulumi.Input[Union[builtins.str, 'OnBuildError']]]:
        """
        If there is a validation error and this field is set to 'cleanup', the build VM and associated network resources will be cleaned up. This is the default behavior. If there is a validation error and this field is set to 'abort', the build VM will be preserved.
        """
    ...
    def on_validation_error(self, value: Optional[pulumi.Input[Union[builtins.str, 'OnBuildError']]]):
...
if not MYPY:
    class ImageTemplatePropertiesValidateArgsDict(TypedDict):
        ...
        """
        continue_distribute_on_failure: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        source_validation_only: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ImageTemplatePropertiesValidateArgs:
    def __init__(__self__, *,
                 continue_distribute_on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 source_validation_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Configuration options and list of validations to be performed on the resulting image.
        :param pulumi.Input[builtins.bool] continue_distribute_on_failure: If validation fails and this field is set to false, output image(s) will not be distributed. This is the default behavior. If validation fails and this field is set to true, output image(s) will still be distributed. Please use this option with caution as it may result in bad images being distributed for use. In either case (true or false), the end to end image run will be reported as having failed in case of a validation failure. [Note: This field has no effect if validation succeeds.]
        ...
        :param pulumi.Input[builtins.bool] source_validation_only: If this field is set to true, the image specified in the 'source' section will directly be validated. No separate build will be run to generate and then validate a customized image.
        """
    ...
    def continue_distribute_on_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If validation fails and this field is set to false, output image(s) will not be distributed. This is the default behavior. If validation fails and this field is set to true, output image(s) will still be distributed. Please use this option with caution as it may result in bad images being distributed for use. In either case (true or false), the end to end image run will be reported as having failed in case of a validation failure. [Note: This field has no effect if validation succeeds.]
        """
    ...
    def continue_distribute_on_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def source_validation_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If this field is set to true, the image specified in the 'source' section will directly be validated. No separate build will be run to generate and then validate a customized image.
        """
    ...
    def source_validation_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ImageTemplateRestartCustomizerArgsDict(TypedDict):
        ...
        Friendly Name to provide context on what this customization step does
        """
        restart_check_command: NotRequired[pulumi.Input[builtins.str]]
        """
        Command to check if restart succeeded [Default: '']
        """
        restart_command: NotRequired[pulumi.Input[builtins.str]]
        """
        Command to execute the restart [Default: 'shutdown /r /f /t 0 /c "packer restart"']
        """
        restart_timeout: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImageTemplateRestartCustomizerArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 restart_check_command: Optional[pulumi.Input[builtins.str]] = None,
                 restart_command: Optional[pulumi.Input[builtins.str]] = None,
                 restart_timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        Reboots a VM and waits for it to come back online (Windows). Corresponds to Packer windows-restart provisioner
        :param pulumi.Input[builtins.str] type: The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
               Expected value is 'WindowsRestart'.
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this customization step does
        :param pulumi.Input[builtins.str] restart_check_command: Command to check if restart succeeded [Default: '']
        :param pulumi.Input[builtins.str] restart_command: Command to execute the restart [Default: 'shutdown /r /f /t 0 /c "packer restart"']
        :param pulumi.Input[builtins.str] restart_timeout: Restart timeout specified as a string of magnitude and unit, e.g. '5m' (5 minutes) or '2h' (2 hours) [Default: '5m']
        """
    ...
    def restart_check_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Command to check if restart succeeded [Default: '']
        """
    ...
    def restart_check_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restart_check_command", value)

    @property
    @pulumi.getter(name="restartCommand")
    def restart_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Command to execute the restart [Default: 'shutdown /r /f /t 0 /c "packer restart"']
        """
    ...
    def restart_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restart_command", value)

    @property
    @pulumi.getter(name="restartTimeout")
    def restart_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Restart timeout specified as a string of magnitude and unit, e.g. '5m' (5 minutes) or '2h' (2 hours) [Default: '5m']
        """
    ...
    def restart_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ImageTemplateSharedImageDistributorArgsDict(TypedDict):
        ...
        """
        gallery_image_id: pulumi.Input[builtins.str]
        """
        ...
        """
        replication_regions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        storage_account_type: NotRequired[pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']]]
        """
...
class ImageTemplateSharedImageDistributorArgs:
    def __init__(__self__, *,
                 ...
                 replication_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 storage_account_type: Optional[pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']]] = None,
        ...
        """
        Distribute via Azure Compute Gallery.
        :param pulumi.Input[builtins.str] gallery_image_id: Resource Id of the Azure Compute Gallery image
        :param pulumi.Input[builtins.str] run_output_name: The name to be used for the associated RunOutput.
        :param pulumi.Input[builtins.str] type: Type of distribution.
               Expected value is 'SharedImage'.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        :param pulumi.Input[builtins.bool] exclude_from_latest: Flag that indicates whether created image version should be excluded from latest. Omit to use the default (false).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] replication_regions: [Deprecated] A list of regions that the image will be replicated to. This list can be specified only if targetRegions is not specified. This field is deprecated - use targetRegions instead.
        :param pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']] storage_account_type: [Deprecated] Storage account type to be used to store the shared image. Omit to use the default (Standard_LRS). This field can be specified only if replicationRegions is specified. This field is deprecated - use targetRegions instead.
    ...
    def gallery_image_id(self) -> pulumi.Input[builtins.str]:
        """
        Resource Id of the Azure Compute Gallery image
        """
    ...
    def gallery_image_id(self, value: pulumi.Input[builtins.str]):
    ...
    def replication_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        [Deprecated] A list of regions that the image will be replicated to. This list can be specified only if targetRegions is not specified. This field is deprecated - use targetRegions instead.
        """
    ...
    def replication_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "replication_regions", value)

    @property
    @pulumi.getter(name="storageAccountType")
    def storage_account_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']]]:
        """
        [Deprecated] Storage account type to be used to store the shared image. Omit to use the default (Standard_LRS). This field can be specified only if replicationRegions is specified. This field is deprecated - use targetRegions instead.
        """
    ...
    def storage_account_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']]]):
...
if not MYPY:
    class ImageTemplateSharedImageVersionSourceArgsDict(TypedDict):
        ...
        """
        image_version_id: pulumi.Input[builtins.str]
        """
...
class ImageTemplateSharedImageVersionSourceArgs:
    def __init__(__self__, *,
        ...
        """
        Describes an image source that is an image version in an Azure Compute Gallery or a Direct Shared Gallery.
        :param pulumi.Input[builtins.str] image_version_id: ARM resource id of the image version. When image version name is 'latest', the version is evaluated when the image build takes place.
        :param pulumi.Input[builtins.str] type: Specifies the type of source image you want to start with.
               Expected value is 'SharedImageVersion'.
        """
    ...
    def image_version_id(self) -> pulumi.Input[builtins.str]:
        """
        ARM resource id of the image version. When image version name is 'latest', the version is evaluated when the image build takes place.
        """
    ...
    def image_version_id(self, value: pulumi.Input[builtins.str]):
...
class ImageTemplateShellCustomizerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
               Expected value is 'Shell'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inline: Array of shell commands to execute
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this customization step does
        :param pulumi.Input[builtins.str] script_uri: URI of the shell script to be run for customizing. It can be a github link, SAS URI for Azure Storage, etc
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the shell script provided in the scriptUri field
        """
...
class ImageTemplateShellValidatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inline: Array of shell commands to execute
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this validation step does
        :param pulumi.Input[builtins.str] script_uri: URI of the shell script to be run for validation. It can be a github link, Azure Storage URI, etc
        :param pulumi.Input[builtins.str] sha256_checksum: SHA256 checksum of the shell script provided in the scriptUri field
        """
        pulumi.set(__self__, "type", 'Shell')
        if inline is not None:
...
class ImageTemplateVhdDistributorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of distribution.
               Expected value is 'VHD'.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] artifact_tags: Tags that will be applied to the artifact once it has been created/updated by the distributor.
        :param pulumi.Input[builtins.str] uri: Optional Azure Storage URI for the distributed VHD blob. Omit to use the default (empty string) in which case VHD would be published to the storage account in the staging resource group.
        """
        pulumi.set(__self__, "run_output_name", run_output_name)
...
class ImageTemplateVmProfileArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the virtual machines used to build and validate images
        :param pulumi.Input[builtins.int] os_disk_size_gb: Size of the OS disk in GB. Omit or specify 0 to use Azure's default OS disk size.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_assigned_identities: Optional array of resource IDs of user assigned managed identities to be configured on the build VM and validation VM. This may include the identity of the image template.
        :param pulumi.Input[builtins.str] vm_size: Size of the virtual machine used to build, customize and capture images. Omit or specify empty string to use the default (Standard_D1_v2 for Gen1 images and Standard_D2ds_v4 for Gen2 images).
...
if not MYPY:
    class ImageTemplateWindowsUpdateCustomizerArgsDict(TypedDict):
        ...
        Friendly Name to provide context on what this customization step does
        """
        search_criteria: NotRequired[pulumi.Input[builtins.str]]
        """
        Criteria to search updates. Omit or specify empty string to use the default (search all). Refer to above link for examples and detailed description of this field.
        """
        update_limit: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ImageTemplateWindowsUpdateCustomizerArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 search_criteria: Optional[pulumi.Input[builtins.str]] = None,
                 update_limit: Optional[pulumi.Input[builtins.int]] = None):
        """
        Installs Windows Updates. Corresponds to Packer Windows Update Provisioner (https://github.com/rgl/packer-provisioner-windows-update)
        :param pulumi.Input[builtins.str] type: The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
               Expected value is 'WindowsUpdate'.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] filters: Array of filters to select updates to apply. Omit or specify empty array to use the default (no filter). Refer to above link for examples and detailed description of this field.
        :param pulumi.Input[builtins.str] name: Friendly Name to provide context on what this customization step does
        :param pulumi.Input[builtins.str] search_criteria: Criteria to search updates. Omit or specify empty string to use the default (search all). Refer to above link for examples and detailed description of this field.
        :param pulumi.Input[builtins.int] update_limit: Maximum number of updates to apply at a time. Omit or specify 0 to use the default (1000)
        """
    ...
    def search_criteria(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Criteria to search updates. Omit or specify empty string to use the default (search all). Refer to above link for examples and detailed description of this field.
        """
    ...
    def search_criteria(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "search_criteria", value)

    @property
    @pulumi.getter(name="updateLimit")
    def update_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of updates to apply at a time. Omit or specify 0 to use the default (1000)
        """
    ...
    @update_limit.setter
    def update_limit(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class PlatformImagePurchasePlanArgsDict(TypedDict):
        ...
        """
        plan_product: pulumi.Input[builtins.str]
        """
        Product of the purchase plan.
        """
        plan_publisher: pulumi.Input[builtins.str]
        """
...
class PlatformImagePurchasePlanArgs:
    def __init__(__self__, *,
        ...
        """
        Purchase plan configuration for platform image.
        :param pulumi.Input[builtins.str] plan_name: Name of the purchase plan.
        :param pulumi.Input[builtins.str] plan_product: Product of the purchase plan.
        :param pulumi.Input[builtins.str] plan_publisher: Publisher of the purchase plan.
        """
    ...
    def plan_product(self) -> pulumi.Input[builtins.str]:
        """
        Product of the purchase plan.
        """
    ...
    @plan_product.setter
    def plan_product(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "plan_product", value)

    @property
    @pulumi.getter(name="planPublisher")
    def plan_publisher(self) -> pulumi.Input[builtins.str]:
        """
        Publisher of the purchase plan.
        """
    ...
    def plan_publisher(self, value: pulumi.Input[builtins.str]):
...
class TargetRegionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] replica_count: The number of replicas of the Image Version to be created in this region. Omit to use the default (1).
        :param pulumi.Input[Union[builtins.str, 'SharedImageStorageAccountType']] storage_account_type: Specifies the storage account type to be used to store the image in this region. Omit to use the default (Standard_LRS).
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class VirtualNetworkConfigArgsDict(TypedDict):
        ...
        """
        container_instance_subnet_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        proxy_vm_size: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualNetworkConfigArgs:
    def __init__(__self__, *,
                 container_instance_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_vm_size: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Virtual Network configuration.
        :param pulumi.Input[builtins.str] container_instance_subnet_id: Resource id of a pre-existing subnet on which Azure Container Instance will be deployed for Isolated Builds. This field may be specified only if `subnetId` is also specified and must be on the same Virtual Network as the subnet specified in `subnetId`.
        :param pulumi.Input[builtins.str] proxy_vm_size: Size of the proxy virtual machine used to pass traffic to the build VM and validation VM. This must not be specified if `containerInstanceSubnetId` is specified because no proxy virtual machine is deployed in that case. Omit or specify empty string to use the default (Standard_A1_v2).
        :param pulumi.Input[builtins.str] subnet_id: Resource id of a pre-existing subnet on which the build VM and validation VM will be deployed
        """
    ...
    def container_instance_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource id of a pre-existing subnet on which Azure Container Instance will be deployed for Isolated Builds. This field may be specified only if `subnetId` is also specified and must be on the same Virtual Network as the subnet specified in `subnetId`.
        """
    ...
    def container_instance_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_instance_subnet_id", value)

    @property
    @pulumi.getter(name="proxyVmSize")
    def proxy_vm_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Size of the proxy virtual machine used to pass traffic to the build VM and validation VM. This must not be specified if `containerInstanceSubnetId` is specified because no proxy virtual machine is deployed in that case. Omit or specify empty string to use the default (Standard_A1_v2).
        """
    ...
    def proxy_vm_size(self, value: Optional[pulumi.Input[builtins.str]]):
