...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(identity, ImageTemplateIdentityArgs):
            ...
            if not isinstance(optimize, ImageTemplatePropertiesOptimizeArgs):
            ...
            if not isinstance(validate, ImageTemplatePropertiesValidateArgs):
                validate = validate or {}
                def _setter(key, value):
                    validate[key] = value
                ImageTemplatePropertiesValidateArgs._configure(_setter, **validate)
            __props__.__dict__["validate"] = validate
            if not isinstance(vm_profile, ImageTemplateVmProfileArgs):
