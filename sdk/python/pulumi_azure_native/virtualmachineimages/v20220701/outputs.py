...
class ImageTemplateLastRunStatusResponse(dict):
    ...
    def _configure(
        ...
        if run_state is None and 'runState' in kwargs:
            run_state = kwargs['runState']
        if run_sub_state is None and 'runSubState' in kwargs:
...
class ImageTemplateManagedImageDistributorResponse(dict):
    ...
    def _configure(
             ...
             run_output_name: Optional[str] = None,
             type: Optional[str] = None,
             artifact_tags: Optional[Mapping[str, str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        ...
        if run_output_name is None and 'runOutputName' in kwargs:
            run_output_name = kwargs['runOutputName']
        if run_output_name is None:
            raise TypeError("Missing 'run_output_name' argument")
        if type is None:
            raise TypeError("Missing 'type' argument")
        if artifact_tags is None and 'artifactTags' in kwargs:
...
class ImageTemplatePlatformImageSourceResponse(dict):
    ...
    def _configure(
        ...
        if type is None:
            raise TypeError("Missing 'type' argument")
        if plan_info is None and 'planInfo' in kwargs:
...
class ImageTemplatePowerShellCustomizerResponse(dict):
    ...
    def _configure(
        ...
        if type is None:
            raise TypeError("Missing 'type' argument")
        if run_as_system is None and 'runAsSystem' in kwargs:
        ...
        if sha256_checksum is None and 'sha256Checksum' in kwargs:
            sha256_checksum = kwargs['sha256Checksum']
        if valid_exit_codes is None and 'validExitCodes' in kwargs:
...
class ImageTemplatePropertiesResponseOptimize(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if vm_boot is None and 'vmBoot' in kwargs:
...
class ImageTemplatePropertiesResponseValidate(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if continue_distribute_on_failure is None and 'continueDistributeOnFailure' in kwargs:
            continue_distribute_on_failure = kwargs['continueDistributeOnFailure']
        if in_vm_validations is None and 'inVMValidations' in kwargs:
            in_vm_validations = kwargs['inVMValidations']
        if source_validation_only is None and 'sourceValidationOnly' in kwargs:
...
class ImageTemplateRestartCustomizerResponse(dict):
    ...
    def _configure(
        ...
        if type is None:
            raise TypeError("Missing 'type' argument")
        if restart_check_command is None and 'restartCheckCommand' in kwargs:
            restart_check_command = kwargs['restartCheckCommand']
        if restart_command is None and 'restartCommand' in kwargs:
            restart_command = kwargs['restartCommand']
        if restart_timeout is None and 'restartTimeout' in kwargs:
...
class ImageTemplateSharedImageDistributorResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if gallery_image_id is None and 'galleryImageId' in kwargs:
            gallery_image_id = kwargs['galleryImageId']
        if gallery_image_id is None:
            raise TypeError("Missing 'gallery_image_id' argument")
        if run_output_name is None and 'runOutputName' in kwargs:
            run_output_name = kwargs['runOutputName']
        if run_output_name is None:
            raise TypeError("Missing 'run_output_name' argument")
        ...
        if replication_regions is None and 'replicationRegions' in kwargs:
...
class ImageTemplateVmProfileResponse(dict):
    ...
    def _configure(
        ...
        if vnet_config is None and 'vnetConfig' in kwargs:
...
class ImageTemplateWindowsUpdateCustomizerResponse(dict):
    ...
    def _configure(
        ...
        if type is None:
            raise TypeError("Missing 'type' argument")
        if search_criteria is None and 'searchCriteria' in kwargs:
            search_criteria = kwargs['searchCriteria']
        if update_limit is None and 'updateLimit' in kwargs:
...
class PlatformImagePurchasePlanResponse(dict):
    ...
    def _configure(
        ...
        if plan_product is None and 'planProduct' in kwargs:
            plan_product = kwargs['planProduct']
        if plan_product is None:
            raise TypeError("Missing 'plan_product' argument")
        if plan_publisher is None and 'planPublisher' in kwargs:
            plan_publisher = kwargs['planPublisher']
        if plan_publisher is None:
            raise TypeError("Missing 'plan_publisher' argument")
...
class ProvisioningErrorResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if provisioning_error_code is None and 'provisioningErrorCode' in kwargs:
...
class VirtualNetworkConfigResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if proxy_vm_size is None and 'proxyVmSize' in kwargs:
