...
def get_virtual_machine_image_template(image_template_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_image_template is deprecated: Version v20190501preview will be removed in the next major version of the provider. Upgrade to version v20200214 or later.""")
    __args__ = dict()
