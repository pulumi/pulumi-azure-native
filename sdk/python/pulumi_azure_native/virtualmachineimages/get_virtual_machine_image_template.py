...
def get_virtual_machine_image_template(image_template_name: Optional[_builtins.str] = None,
...
def get_virtual_machine_image_template_output(image_template_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
