...
class NodeTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] computer_name_prefix: Specifies the computer name prefix. Limited to 9 characters. If specified, allows for a longer name to be specified for the node type name.
        :param pulumi.Input[_builtins.str] data_disk_letter: Managed data disk letter. It can not use the reserved letter C or D and it can not change after created.
        :param pulumi.Input[_builtins.int] data_disk_size_gb: Disk size for the managed disk attached to the vms on the node type in GBs.
        :param pulumi.Input[Union[_builtins.str, 'DiskType']] data_disk_type: Managed data disk type. Specifies the storage account type for the managed disk
        :param pulumi.Input[_builtins.str] dscp_configuration_id: Specifies the resource id of the DSCP configuration to apply to the node type network interface.
        ...
        :param pulumi.Input[_builtins.bool] enable_encryption_at_host: Enable or disable the Host Encryption for the virtual machines on the node type. This will enable the encryption for all the disks including Resource/Temp disk at host itself. Default: The Encryption at host will be disabled unless this property is set to true for the resource.
        :param pulumi.Input[_builtins.bool] enable_node_public_ip: Specifies whether each node is allocated its own public IPv4 address. This is only supported on secondary node types with custom Load Balancers.
        :param pulumi.Input[_builtins.bool] enable_node_public_i_pv6: Specifies whether each node is allocated its own public IPv6 address. This is only supported on secondary node types with custom Load Balancers.
        :param pulumi.Input[_builtins.bool] enable_over_provisioning: Specifies whether the node type should be overprovisioned. It is only allowed for stateless node types.
        ...
        :param pulumi.Input[Union[_builtins.str, 'EvictionPolicyType']] eviction_policy: Specifies the eviction policy for virtual machines in a SPOT node type. Default is Delete.
        ...
        :param pulumi.Input[_builtins.str] host_group_id: Specifies the full host group resource Id. This property is used for deploying on azure dedicated hosts.
        :param pulumi.Input[_builtins.bool] is_spot_vm: Indicates whether the node type will be Spot Virtual Machines. Azure will allocate the VMs if there is capacity available and the VMs can be evicted at any time.
        :param pulumi.Input[_builtins.bool] is_stateless: Indicates if the node type can only host Stateless workloads.
        :param pulumi.Input[_builtins.bool] multiple_placement_groups: Indicates if scale set associated with the node type can be composed of multiple placement groups.
        ...
        :param pulumi.Input[_builtins.str] service_artifact_reference_id: Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version.
        :param pulumi.Input['NodeTypeSkuArgs'] sku: The node type sku.
        :param pulumi.Input[_builtins.str] spot_restore_timeout: Indicates the time duration after which the platform will not try to restore the VMSS SPOT instances specified as ISO 8601.
        :param pulumi.Input[_builtins.str] subnet_id: Indicates the resource id of the subnet for the node type.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Azure resource tags.
        :param pulumi.Input[_builtins.bool] use_default_public_load_balancer: Specifies whether the use public load balancer. If not specified and the node type doesn't have its own frontend configuration, it will be attached to the default load balancer. If the node type uses its own Load balancer and useDefaultPublicLoadBalancer is true, then the frontend has to be an Internal Load Balancer. If the node type uses its own Load balancer and useDefaultPublicLoadBalancer is false or not set, then the custom load balancer must include a public load balancer to provide outbound connectivity.
        :param pulumi.Input[_builtins.bool] use_ephemeral_os_disk: Indicates whether to use ephemeral os disk. The sku selected on the vmSize property needs to support this feature.
        :param pulumi.Input[_builtins.bool] use_temp_data_disk: Specifies whether to use the temporary disk for the service fabric data root, in which case no managed data disk will be attached and the temporary disk will be used. It is only allowed for stateless node types.
        ...
        :param pulumi.Input[_builtins.str] vm_image_offer: The offer type of the Azure Virtual Machines Marketplace image. For example, UbuntuServer or WindowsServer.
        ...
        :param pulumi.Input[_builtins.str] vm_image_publisher: The publisher of the Azure Virtual Machines Marketplace image. For example, Canonical or MicrosoftWindowsServer.
        :param pulumi.Input[_builtins.str] vm_image_resource_id: Indicates the resource id of the vm image. This parameter is used for custom vm image.
        :param pulumi.Input[_builtins.str] vm_image_sku: The SKU of the Azure Virtual Machines Marketplace image. For example, 14.04.0-LTS or 2012-R2-Datacenter.
        :param pulumi.Input[_builtins.str] vm_image_version: The version of the Azure Virtual Machines Marketplace image. A value of 'latest' can be specified to select the latest version of an image. If omitted, the default is 'latest'.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'VmSetupAction']]]] vm_setup_actions: Specifies the actions to be performed on the vms before bootstrapping the service fabric runtime.
        :param pulumi.Input[_builtins.str] vm_shared_gallery_image_id: Indicates the resource id of the vm shared galleries image. This parameter is used for custom vm image.
        :param pulumi.Input[_builtins.str] vm_size: The size of virtual machines in the pool. All virtual machines in a pool are the same size. For example, Standard_D3.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zones: Specifies the availability zones where the node type would span across. If the cluster is not spanning across availability zones, initiates az migration for the cluster.
        """
...
class NodeType(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enableAcceleratedNetworking")
    def enable_accelerated_networking(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether the network interface is accelerated networking-enabled.
        """
        return pulumi.get(self, "enable_accelerated_networking")
    ...
    @_builtins.property
    @pulumi.getter(name="placementProperties")
    def placement_properties(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        The placement tags applied to nodes in the node type, which can be used to indicate where certain services (workload) should run.
        """
        return pulumi.get(self, "placement_properties")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceArtifactReferenceId")
    def service_artifact_reference_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the service artifact reference id used to set same image version for all virtual machines in the scale set when using 'latest' image version.
        """
        return pulumi.get(self, "service_artifact_reference_id")
    ...
    @_builtins.property
    @pulumi.getter(name="useDefaultPublicLoadBalancer")
    def use_default_public_load_balancer(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether the use public load balancer. If not specified and the node type doesn't have its own frontend configuration, it will be attached to the default load balancer. If the node type uses its own Load balancer and useDefaultPublicLoadBalancer is true, then the frontend has to be an Internal Load Balancer. If the node type uses its own Load balancer and useDefaultPublicLoadBalancer is false or not set, then the custom load balancer must include a public load balancer to provide outbound connectivity.
        """
        return pulumi.get(self, "use_default_public_load_balancer")
