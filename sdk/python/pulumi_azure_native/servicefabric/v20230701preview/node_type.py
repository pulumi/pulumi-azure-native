...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(application_ports, EndpointRangeDescriptionArgs):
            ...
            if not isinstance(ephemeral_ports, EndpointRangeDescriptionArgs):
            ...
            if not isinstance(sku, NodeTypeSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
            ...
            if not isinstance(vm_image_plan, VmImagePlanArgs):
            ...
            if not isinstance(vm_managed_identity, VmManagedIdentityArgs):
