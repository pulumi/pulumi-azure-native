...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_cluster = azure_native.servicefabric.v20221001preview.ManagedCluster("managedCluster",
            addon_features=[
                "DnsService",
            ...
            application_type_versions_cleanup_policy=azure_native.servicefabric.v20221001preview.ApplicationTypeVersionsCleanupPolicyResponseArgs(
            ...
            sku=azure_native.servicefabric.v20221001preview.SkuResponseArgs(
                name="Basic",
            ),
            tags={},
