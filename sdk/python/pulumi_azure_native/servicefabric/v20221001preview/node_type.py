...
warnings.warn("""azure-native:servicefabric/v20221001preview:NodeType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NodeType is deprecated: azure-native:servicefabric/v20221001preview:NodeType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.""")
