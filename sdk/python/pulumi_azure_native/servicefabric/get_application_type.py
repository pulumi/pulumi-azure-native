...
def get_application_type(application_type_name: Optional[_builtins.str] = None,
...
def get_application_type_output(application_type_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:getApplicationType', __args__, opts=opts, typ=GetApplicationTypeResult)
