...
def get_application_type(application_type_name: Optional[builtins.str] = None,
...
def get_application_type_output(application_type_name: Optional[pulumi.Input[builtins.str]] = None,
