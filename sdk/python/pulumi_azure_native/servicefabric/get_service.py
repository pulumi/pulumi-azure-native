...
def get_service(application_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(application_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:getService', __args__, opts=opts, typ=GetServiceResult)
