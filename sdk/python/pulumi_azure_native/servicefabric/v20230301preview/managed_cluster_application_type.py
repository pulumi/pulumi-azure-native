...
class ManagedClusterApplicationType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20210101preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20211101preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20220201preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20220601preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20220801preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:ManagedClusterApplicationType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedClusterApplicationType, __self__).__init__(
            'azure-native:servicefabric/v20230301preview:ManagedClusterApplicationType',
            resource_name,
            __props__,
            opts)
