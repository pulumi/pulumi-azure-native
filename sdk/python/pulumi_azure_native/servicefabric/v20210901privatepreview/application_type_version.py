...
class ApplicationTypeVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabric/v20210901privatepreview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210101preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210101preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:ApplicationTypeVersion"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210501:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210701preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20211101preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20211101preview:ApplicationTypeVersion")])
