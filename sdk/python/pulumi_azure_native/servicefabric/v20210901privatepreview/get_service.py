...
warnings.warn("""azure-native:servicefabric/v20210901privatepreview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: azure-native:servicefabric/v20210901privatepreview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:Service to guarantee forwards compatibility.""")
    __args__ = dict()
