...
def get_managed_cluster_application_type(application_type_name: Optional[_builtins.str] = None,
...
def get_managed_cluster_application_type_output(application_type_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:getManagedClusterApplicationType', __args__, opts=opts, typ=GetManagedClusterApplicationTypeResult)
