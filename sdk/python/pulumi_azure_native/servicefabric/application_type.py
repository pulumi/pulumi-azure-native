...
class ApplicationTypeArgs:
    def __init__(__self__, *,
                 ...
                 application_type_name: Optional[pulumi.Input[_builtins.str]] = None,
...
@pulumi.type_token("azure-native:servicefabric:ApplicationType")
