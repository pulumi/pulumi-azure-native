...
__all__ = [
    ...
    'AwaitableListManagedClusterFaultSimulationResult',
    'list_managed_cluster_fault_simulation',
    'list_managed_cluster_fault_simulation_output',
]
...
def list_managed_cluster_fault_simulation(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20241101preview:listManagedClusterFaultSimulation', __args__, opts=opts, typ=ListManagedClusterFaultSimulationResult).value

    return AwaitableListManagedClusterFaultSimulationResult(
...
def list_managed_cluster_fault_simulation_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20241101preview:listManagedClusterFaultSimulation', __args__, opts=opts, typ=ListManagedClusterFaultSimulationResult)
    return __ret__.apply(lambda __response__: ListManagedClusterFaultSimulationResult(
