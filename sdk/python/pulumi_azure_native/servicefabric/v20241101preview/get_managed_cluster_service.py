...
def get_managed_cluster_service(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20241101preview:getManagedClusterService', __args__, opts=opts, typ=GetManagedClusterServiceResult).value
...
def get_managed_cluster_service_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20241101preview:getManagedClusterService', __args__, opts=opts, typ=GetManagedClusterServiceResult)
