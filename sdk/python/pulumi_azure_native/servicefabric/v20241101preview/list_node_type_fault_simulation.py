...
def list_node_type_fault_simulation(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20241101preview:listNodeTypeFaultSimulation', __args__, opts=opts, typ=ListNodeTypeFaultSimulationResult).value
...
def list_node_type_fault_simulation_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20241101preview:listNodeTypeFaultSimulation', __args__, opts=opts, typ=ListNodeTypeFaultSimulationResult)
