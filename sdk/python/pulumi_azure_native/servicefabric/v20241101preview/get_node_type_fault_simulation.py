...
def get_node_type_fault_simulation(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20241101preview:getNodeTypeFaultSimulation', __args__, opts=opts, typ=GetNodeTypeFaultSimulationResult).value
...
def get_node_type_fault_simulation_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20241101preview:getNodeTypeFaultSimulation', __args__, opts=opts, typ=GetNodeTypeFaultSimulationResult)
