...
if not MYPY:
    class VmApplicationArgsDict(TypedDict):
        """
        ...
        """
        vm_gallery_tags: NotRequired[pulumi.Input[str]]
        """
    ...
    VmApplicationArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class VmApplicationArgs:
    def __init__(__self__, *,
                 package_reference_id: pulumi.Input[str],
                 ...
                 vm_gallery_tags: Optional[pulumi.Input[str]] = None):
        """
        Specifies the gallery application that should be made available to the underlying VMSS.
        ...
        :param pulumi.Input[bool] enable_automatic_upgrade: If set to true, when a new Gallery Application version is available in PIR/SIG, it will be automatically updated for the underlying VMSS.
        ...
        :param pulumi.Input[str] vm_gallery_tags: Optional, Specifies a passthrough value for more generic context. Accepts a JSON-formatted string e.g. '{"Tag1":"Value1","Tag2":"Value2"}'.
        """
    ...
    def vm_gallery_tags(self) -> Optional[pulumi.Input[str]]:
        """
        Optional, Specifies a passthrough value for more generic context. Accepts a JSON-formatted string e.g. '{"Tag1":"Value1","Tag2":"Value2"}'.
        """
        return pulumi.get(self, "vm_gallery_tags")

    @vm_gallery_tags.setter
    def vm_gallery_tags(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "vm_gallery_tags", value)
