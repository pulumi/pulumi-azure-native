...
def get_managed_cluster_fault_simulation(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20241101preview:getManagedClusterFaultSimulation', __args__, opts=opts, typ=GetManagedClusterFaultSimulationResult).value
...
def get_managed_cluster_fault_simulation_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20241101preview:getManagedClusterFaultSimulation', __args__, opts=opts, typ=GetManagedClusterFaultSimulationResult)
