...
class ManagedClusterApplicationTypeVersion(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:servicefabric:ManagedClusterApplicationTypeVersion"
