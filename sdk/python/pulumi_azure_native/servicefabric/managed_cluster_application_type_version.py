...
class ManagedClusterApplicationTypeVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric/v20220101:ManagedClusterApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:ManagedClusterApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:ManagedClusterApplicationTypeVersion")])
