...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicefabric:getService'.""", DeprecationWarning)
...
def get_service(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicefabric:getService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/latest:getService', __args__, opts=opts, typ=GetServiceResult).value
