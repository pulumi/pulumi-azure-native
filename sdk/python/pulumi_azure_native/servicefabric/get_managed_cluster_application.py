...
def get_managed_cluster_application(application_name: Optional[_builtins.str] = None,
...
def get_managed_cluster_application_output(application_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
