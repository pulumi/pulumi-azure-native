...
class ClusterArgs:
    ...
    def _configure(
             ...
             node_types: Optional[pulumi.Input[Sequence[pulumi.Input['NodeTypeDescriptionArgs']]]] = None,
        ...
        if diagnostics_storage_account_config is None and 'diagnosticsStorageAccountConfig' in kwargs:
            diagnostics_storage_account_config = kwargs['diagnosticsStorageAccountConfig']
        if event_store_service_enabled is None and 'eventStoreServiceEnabled' in kwargs:
        ...
        if upgrade_description is None and 'upgradeDescription' in kwargs:
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            certificate = _utilities.configure(certificate, CertificateDescriptionArgs, True)
            __props__.__dict__["certificate"] = certificate
            certificate_common_names = _utilities.configure(certificate_common_names, ServerCertificateCommonNamesArgs, True)
            ...
            diagnostics_storage_account_config = _utilities.configure(diagnostics_storage_account_config, DiagnosticsStorageAccountConfigArgs, True)
            ...
            reverse_proxy_certificate = _utilities.configure(reverse_proxy_certificate, CertificateDescriptionArgs, True)
            __props__.__dict__["reverse_proxy_certificate"] = reverse_proxy_certificate
            reverse_proxy_certificate_common_names = _utilities.configure(reverse_proxy_certificate_common_names, ServerCertificateCommonNamesArgs, True)
            __props__.__dict__["reverse_proxy_certificate_common_names"] = reverse_proxy_certificate_common_names
            __props__.__dict__["tags"] = tags
            upgrade_description = _utilities.configure(upgrade_description, ClusterUpgradePolicyArgs, True)
