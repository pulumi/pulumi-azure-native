...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(application_type_versions_cleanup_policy, ApplicationTypeVersionsCleanupPolicyArgs):
            ...
            if not isinstance(azure_active_directory, AzureActiveDirectoryArgs):
            ...
            if not isinstance(certificate, CertificateDescriptionArgs):
                certificate = certificate or {}
                def _setter(key, value):
                    certificate[key] = value
                CertificateDescriptionArgs._configure(_setter, **certificate)
            __props__.__dict__["certificate"] = certificate
            if not isinstance(certificate_common_names, ServerCertificateCommonNamesArgs):
            ...
            if not isinstance(diagnostics_storage_account_config, DiagnosticsStorageAccountConfigArgs):
            ...
            if not isinstance(reverse_proxy_certificate, CertificateDescriptionArgs):
            ...
            if not isinstance(reverse_proxy_certificate_common_names, ServerCertificateCommonNamesArgs):
            ...
            if not isinstance(upgrade_description, ClusterUpgradePolicyArgs):
