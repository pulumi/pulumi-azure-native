...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cluster = azure_native.servicefabric.v20201201preview.Cluster("cluster",
            add_on_features=[
                "RepairManager",
                "DnsService",
            ...
            application_type_versions_cleanup_policy=azure_native.servicefabric.v20201201preview.ApplicationTypeVersionsCleanupPolicyResponseArgs(
                max_unused_versions_to_keep=2,
            ),
            azure_active_directory=azure_native.servicefabric.v20201201preview.AzureActiveDirectoryArgs(
            ...
            certificate_common_names=azure_native.servicefabric.v20201201preview.ServerCertificateCommonNamesArgs(
                common_names=[azure_native.servicefabric.v20201201preview.ServerCertificateCommonNameArgs(
            ...
            diagnostics_storage_account_config=azure_native.servicefabric.v20201201preview.DiagnosticsStorageAccountConfigResponseArgs(
            ...
            node_types=[azure_native.servicefabric.v20201201preview.NodeTypeDescriptionArgs(
                application_ports=azure_native.servicefabric.v20201201preview.EndpointRangeDescriptionArgs(
                    end_port=30000,
                    start_port=20000,
                ),
                client_connection_endpoint_port=19000,
                durability_level="Bronze",
                ephemeral_ports=azure_native.servicefabric.v20201201preview.EndpointRangeDescriptionArgs(
                    end_port=64000,
                    start_port=49000,
                ),
            ...
            reverse_proxy_certificate_common_names=azure_native.servicefabric.v20201201preview.ServerCertificateCommonNamesArgs(
                common_names=[azure_native.servicefabric.v20201201preview.ServerCertificateCommonNameArgs(
                    certificate_common_name="abc.com",
                    certificate_issuer_thumbprint="12599211F8F14C90AFA9532AD79A6F2CA1C00622",
                )],
            ...
            tags={},
            upgrade_description=azure_native.servicefabric.v20201201preview.ClusterUpgradePolicyResponseArgs(
                delta_health_policy={
                    "applicationDeltaHealthPolicies": {
                        "fabric:/myApp1": azure_native.servicefabric.v20201201preview.ApplicationDeltaHealthPolicyArgs(
                            default_service_type_delta_health_policy=azure_native.servicefabric.v20201201preview.ServiceTypeDeltaHealthPolicyArgs(
                                max_percent_delta_unhealthy_services=0,
                            ),
                            service_type_delta_health_policies={
                                "myServiceType1": azure_native.servicefabric.v20201201preview.ServiceTypeDeltaHealthPolicyArgs(
                                    max_percent_delta_unhealthy_services=0,
                                ),
                            },
                        ),
                ...
                health_policy={
                    "applicationHealthPolicies": {
                        "fabric:/myApp1": azure_native.servicefabric.v20201201preview.ApplicationHealthPolicyArgs(
                            default_service_type_health_policy=azure_native.servicefabric.v20201201preview.ServiceTypeHealthPolicyArgs(
                                max_percent_unhealthy_services=0,
                            ),
                            service_type_health_policies={
                                "myServiceType1": azure_native.servicefabric.v20201201preview.ServiceTypeHealthPolicyArgs(
        ...
        ```sh
        $ pulumi import azure-native:servicefabric/v20201201preview:Cluster myCluster /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/resRg/providers/Microsoft.ServiceFabric/clusters/myCluster 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric/v20160901:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20170701preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20180201:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190301:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190301preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190601preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20191101preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20200301:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20210601:Cluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cluster, __self__).__init__(
            'azure-native:servicefabric/v20201201preview:Cluster',
            resource_name,
            __props__,
            opts)
