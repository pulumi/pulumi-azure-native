...
def get_application_type_version_output(application_type_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20201201preview:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult)
    return __ret__.apply(lambda __response__: GetApplicationTypeVersionResult(
        ...
        default_parameter_list=pulumi.get(__response__, 'default_parameter_list'),
