...
class GetApplicationTypeVersionResult:
    ...
    """
    def __init__(__self__, app_package_url=None, default_parameter_list=None, etag=None, id=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type_version is deprecated: azure-native:servicefabric/v20201201preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationTypeVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20201201preview:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
