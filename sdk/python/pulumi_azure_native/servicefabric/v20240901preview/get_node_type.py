...
class GetNodeTypeResult:
    ...
    def __init__(__self__, additional_data_disks=None, additional_network_interface_configurations=None, application_ports=None, capacities=None, computer_name_prefix=None, data_disk_letter=None, data_disk_size_gb=None, data_disk_type=None, dscp_configuration_id=None, enable_accelerated_networking=None, enable_encryption_at_host=None, enable_node_public_ip=None, enable_node_public_i_pv6=None, enable_over_provisioning=None, ephemeral_ports=None, eviction_policy=None, frontend_configurations=None, host_group_id=None, id=None, is_primary=None, is_spot_vm=None, is_stateless=None, multiple_placement_groups=None, name=None, nat_configurations=None, nat_gateway_id=None, network_security_rules=None, placement_properties=None, provisioning_state=None, secure_boot_enabled=None, security_type=None, service_artifact_reference_id=None, sku=None, spot_restore_timeout=None, subnet_id=None, system_data=None, tags=None, type=None, use_default_public_load_balancer=None, use_ephemeral_os_disk=None, use_temp_data_disk=None, vm_applications=None, vm_extensions=None, vm_image_offer=None, vm_image_plan=None, vm_image_publisher=None, vm_image_resource_id=None, vm_image_sku=None, vm_image_version=None, vm_instance_count=None, vm_managed_identity=None, vm_secrets=None, vm_setup_actions=None, vm_shared_gallery_image_id=None, vm_size=None, zones=None):
        ...
        if vm_applications and not isinstance(vm_applications, list):
            raise TypeError("Expected argument 'vm_applications' to be a list")
    ...
    def vm_applications(self) -> Optional[Sequence['outputs.VmApplicationResponse']]:
        """
...
class AwaitableGetNodeTypeResult(GetNodeTypeResult):
    ...
    def __await__(self):
        ...
        return GetNodeTypeResult(
            ...
            vm_applications=self.vm_applications,
...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20240901preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult).value
    ...
    return AwaitableGetNodeTypeResult(
        ...
        vm_applications=pulumi.get(__ret__, 'vm_applications'),
...
def get_node_type_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20240901preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult)
