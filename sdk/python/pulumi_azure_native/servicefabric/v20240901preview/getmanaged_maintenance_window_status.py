...
def getmanaged_maintenance_window_status(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20240901preview:getmanagedMaintenanceWindowStatus', __args__, opts=opts, typ=GetmanagedMaintenanceWindowStatusResult).value
...
def getmanaged_maintenance_window_status_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20240901preview:getmanagedMaintenanceWindowStatus', __args__, opts=opts, typ=GetmanagedMaintenanceWindowStatusResult)
