...
def get_application_type(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type is deprecated: Version v20191101preview will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20191101preview:getApplicationType', __args__, opts=opts, typ=GetApplicationTypeResult).value
