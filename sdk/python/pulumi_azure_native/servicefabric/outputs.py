...
class AddRemoveIncrementalNamedPartitionScalingMechanismResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int min_partition_count: Minimum number of named partitions of the service.
        :param _builtins.int scale_increment: The number of instances to add or remove during a scaling operation.
        """
...
class ApplicationUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 force_restart: Optional[_builtins.bool] = None,
                 instance_close_delay_duration: Optional[_builtins.float] = None,
                 recreate_application: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool recreate_application: Determines whether the application should be recreated on update. If value=true, the rest of the upgrade policy parameters are not allowed.
        ...
        :param _builtins.str upgrade_mode: The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
        :param _builtins.float upgrade_replica_set_check_timeout: The maximum amount of time to block processing of an upgrade domain and prevent loss of availability when there are unexpected issues. When this timeout expires, processing of the upgrade domain will proceed regardless of availability loss issues. The timeout is reset at the start of each upgrade domain. Valid values are between 0 and 42949672925 inclusive. (unsigned 32-bit integer).
        """
...
class ApplicationUserAssignedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The friendly name of user assigned identity.
...
class AveragePartitionLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str metric_name: The name of the metric for which usage should be tracked.
        :param _builtins.str scale_interval: The period in seconds on which a decision is made whether to scale or not. This property should come in ISO 8601 format "hh:mm:ss".
        :param _builtins.float upper_load_threshold: The upper limit of the load beyond which a scale out operation should be performed.
        """
...
class AverageServiceLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str scale_interval: The period in seconds on which a decision is made whether to scale or not. This property should come in ISO 8601 format "hh:mm:ss".
        :param _builtins.float upper_load_threshold: The upper limit of the load beyond which a scale out operation should be performed.
        :param _builtins.bool use_only_primary_load: Flag determines whether only the load of primary replica should be considered for scaling. If set to true, then trigger will only consider the load of primary replicas of stateful service. If set to false, trigger will consider load of all replicas. This parameter cannot be set to true for stateless service.
        """
...
class AzureActiveDirectoryResponse(dict):
    ...
    def __init__(__self__, *,
                 client_application: Optional[_builtins.str] = None,
                 cluster_application: Optional[_builtins.str] = None,
...
class ClusterHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 max_percent_unhealthy_applications: Optional[_builtins.int] = None,
        ...
        :param _builtins.int max_percent_unhealthy_nodes: The maximum allowed percentage of unhealthy nodes before reporting an error. For example, to allow 10% of nodes to be unhealthy, this value would be 10.
...
class ClusterMonitoringPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str upgrade_domain_timeout: The amount of time each upgrade domain has to complete before the upgrade rolls back. The timeout can be in either hh:mm:ss or in d.hh:mm:ss.ms format.
        :param _builtins.str upgrade_timeout: The amount of time the overall upgrade has to complete before the upgrade rolls back. The timeout can be in either hh:mm:ss or in d.hh:mm:ss.ms format.
        """
...
class ClusterUpgradeDeltaHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_percent_delta_unhealthy_applications: Optional[_builtins.int] = None,
        ...
        :param _builtins.int max_percent_delta_unhealthy_applications: The maximum allowed percentage of applications health degradation allowed during cluster upgrades.
        ...
        :param _builtins.int max_percent_upgrade_domain_delta_unhealthy_nodes: The maximum allowed percentage of upgrade domain nodes health degradation allowed during cluster upgrades.
...
class ClusterUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str upgrade_replica_set_check_timeout: The maximum amount of time to block processing of an upgrade domain and prevent loss of availability when there are unexpected issues.
...
class FaultSimulationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_time: The start time of the fault simulation.
        :param _builtins.str status: Fault simulation status
        """
...
class FrontendConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 application_gateway_backend_address_pool_id: Optional[_builtins.str] = None,
                 ip_address_type: Optional[_builtins.str] = None,
                 load_balancer_backend_address_pool_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str load_balancer_inbound_nat_pool_id: The resource Id of the Load Balancer inbound NAT pool that the VM instances of the node type are associated with. The format of the resource Id is '/subscriptions/<subscriptionId>/resourceGroups/<resourceGroupName>/providers/Microsoft.Network/loadBalancers/<loadBalancerName>/inboundNatPools/<inboundNatPoolName>'.
        """
...
class LoadBalancingRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str load_distribution: The load distribution policy for this rule.
        :param _builtins.int probe_port: The prob port used by the load balancing rule. Acceptable values are between 1 and 65535.
        :param _builtins.str probe_request_path: The probe request path. Only supported for HTTP/HTTPS probes.
        """
...
class NetworkSecurityRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_address_prefixes: Optional[Sequence[_builtins.str]] = None,
                 destination_port_range: Optional[_builtins.str] = None,
                 destination_port_ranges: Optional[Sequence[_builtins.str]] = None,
                 source_address_prefix: Optional[_builtins.str] = None,
                 source_address_prefixes: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.int priority: The priority of the rule. The value can be in the range 1000 to 3000. Values outside this range are reserved for Service Fabric ManagerCluster Resource Provider. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
        :param _builtins.str protocol: Network protocol this rule applies to.
        :param _builtins.str description: Network security rule description.
        :param _builtins.str destination_address_prefix: The destination address prefix. CIDR or destination IP range. Asterisk '*' can also be used to match all source IPs. Default tags such as 'VirtualNetwork', 'AzureLoadBalancer' and 'Internet' can also be used.
        :param Sequence[_builtins.str] destination_address_prefixes: The destination address prefixes. CIDR or destination IP ranges.
        :param _builtins.str destination_port_range: he destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
        ...
        :param Sequence[_builtins.str] source_port_ranges: The source port ranges.
        """
...
class NodeTypeNatConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 frontend_port_range_end: Optional[_builtins.int] = None,
...
class PartitionInstanceCountScaleMechanismResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int min_instance_count: Minimum number of instances of the partition.
        :param _builtins.int scale_increment: The number of instances to add or remove during a scaling operation.
        """
...
class ResourceAzStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_type: VM Size id.
        """
        pulumi.set(__self__, "details", details)
...
class RollingUpgradeMonitoringPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str health_check_wait_duration: The amount of time to wait after completing an upgrade domain before applying health policies. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        :param _builtins.str upgrade_domain_timeout: The amount of time each upgrade domain has to complete before FailureAction is executed. Cannot be larger than 12 hours. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        :param _builtins.str upgrade_timeout: The amount of time the overall upgrade has to complete before FailureAction is executed. Cannot be larger than 12 hours. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        """
...
class ServiceLoadMetricResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 default_load: Optional[_builtins.int] = None,
                 primary_default_load: Optional[_builtins.int] = None,
                 secondary_default_load: Optional[_builtins.int] = None,
        ...
        :param _builtins.int secondary_default_load: Used only for Stateful services. The default amount of load, as a number, that this service creates for this metric when it is a Secondary replica.
        :param _builtins.str weight: The service load metric relative weight, compared to other metrics configured for this service, as a number.
        """
        pulumi.set(__self__, "name", name)
...
class ServiceTypeHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int max_percent_unhealthy_replicas_per_partition: The maximum allowed percentage of unhealthy replicas per partition.
               
               The percentage represents the maximum tolerated percentage of replicas that can be unhealthy before the partition is considered in error.
               If the percentage is respected but there is at least one unhealthy replica, the health is evaluated as Warning.
               The percentage is calculated by dividing the number of unhealthy replicas over the total number of replicas in the partition.
               The computation rounds up to tolerate one failure on small numbers of replicas.
        :param _builtins.int max_percent_unhealthy_services: The maximum allowed percentage of unhealthy services.
...
class StatefulServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_move_cost: Optional[_builtins.str] = None,
                 has_persisted_state: Optional[_builtins.bool] = None,
                 min_replica_set_size: Optional[_builtins.int] = None,
                 placement_constraints: Optional[_builtins.str] = None,
                 quorum_loss_wait_duration: Optional[_builtins.str] = None,
                 replica_restart_wait_duration: Optional[_builtins.str] = None,
                 ...
                 service_package_activation_mode: Optional[_builtins.str] = None,
                 service_placement_policies: Optional[Sequence[Any]] = None,
                 service_placement_time_limit: Optional[_builtins.str] = None,
                 stand_by_replica_keep_duration: Optional[_builtins.str] = None,
        ...
        :param _builtins.str service_type_name: The name of the service type
        ...
        :param _builtins.str default_move_cost: Specifies the move cost for the service.
        :param _builtins.bool has_persisted_state: A flag indicating whether this is a persistent service which stores states on the local disk. If it is then the value of this property is true, if not it is false.
        :param _builtins.int min_replica_set_size: The minimum replica set size as a number.
        :param _builtins.str placement_constraints: The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
        :param _builtins.str quorum_loss_wait_duration: The maximum duration for which a partition is allowed to be in a state of quorum loss, represented in ISO 8601 format "hh:mm:ss".
        :param _builtins.str replica_restart_wait_duration: The duration between when a replica goes down and when a new replica is created, represented in ISO 8601 format "hh:mm:ss".
        :param Sequence['ScalingPolicyResponse'] scaling_policies: Scaling policies for this service.
        :param _builtins.str service_dns_name: Dns name used for the service. If this is specified, then the DNS name can be used to return the IP addresses of service endpoints for application layer protocols (e.g., HTTP).
        ...
        :param _builtins.str service_package_activation_mode: The activation Mode of the service package
        ...
        :param _builtins.str service_placement_time_limit: The duration for which replicas can stay InBuild before reporting that build is stuck, represented in ISO 8601 format "hh:mm:ss".
        :param _builtins.str stand_by_replica_keep_duration: The definition on how long StandBy replicas should be maintained before being removed, represented in ISO 8601 format "hh:mm:ss".
        :param _builtins.int target_replica_set_size: The target replica set size as a number.
        """
...
class StatelessServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 min_instance_percentage: Optional[_builtins.int] = None,
                 placement_constraints: Optional[_builtins.str] = None,
                 scaling_policies: Optional[Sequence['outputs.ScalingPolicyResponse']] = None,
                 service_dns_name: Optional[_builtins.str] = None,
                 service_load_metrics: Optional[Sequence['outputs.ServiceLoadMetricResponse']] = None,
        ...
        :param Sequence['ServiceCorrelationResponse'] correlation_scheme: A list that describes the correlation of the service with other services.
        :param _builtins.str default_move_cost: Specifies the move cost for the service.
        :param _builtins.int min_instance_count: MinInstanceCount is the minimum number of instances that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstanceCount computation -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.
        :param _builtins.int min_instance_percentage: MinInstancePercentage is the minimum percentage of InstanceCount that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstancePercentage computation, -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.
        :param _builtins.str placement_constraints: The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
        :param Sequence['ScalingPolicyResponse'] scaling_policies: Scaling policies for this service.
        :param _builtins.str service_dns_name: Dns name used for the service. If this is specified, then the DNS name can be used to return the IP addresses of service endpoints for application layer protocols (e.g., HTTP).
               When updating serviceDnsName, old name may be temporarily resolvable. However, rely on new name.
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_endpoint_network_policies: Optional[_builtins.str] = None,
        ...
        :param _builtins.str private_endpoint_network_policies: Enable or Disable apply network policies on private end point in the subnet.
        :param _builtins.str private_link_service_network_policies: Enable or Disable apply network policies on private link service in the subnet.
        """
        pulumi.set(__self__, "name", name)
...
class UniformInt64RangePartitionSchemeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float low_key: The lower bound of the partition key range that
               should be split between the partition ‘Count’
        :param _builtins.str partition_scheme: Enumerates the ways that a service can be partitioned.
...
class VMSSExtensionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] setup_order: Indicates the setup order for the extension.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "provisioning_state", provisioning_state)
...
class VmssDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int lun: Specifies the logical unit number of the data disk. This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM. Lun 0 is reserved for the service fabric data disk.
        """
...
class ZoneFaultSimulationContentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool force: Force the action to go through without any check on the cluster.
        :param Sequence[_builtins.str] zones: Indicates the zones of the fault simulation.
        """
