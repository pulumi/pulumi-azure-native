...
class ManagedClusterApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: Resource location depends on the parent resource.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: List of application parameters with overridden values from their default values specified in the application manifest.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Azure resource tags.
        :param pulumi.Input['ApplicationUpgradePolicyArgs'] upgrade_policy: Describes the policy for a monitored application upgrade.
        :param pulumi.Input[builtins.str] version: The version of the application type as defined in the application manifest.
