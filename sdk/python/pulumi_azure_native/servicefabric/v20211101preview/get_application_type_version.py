...
warnings.warn("""azure-native:servicefabric/v20211101preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type_version is deprecated: azure-native:servicefabric/v20211101preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.""")
    __args__ = dict()
