...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zonal_resiliency: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedCluster is deprecated: azure-native:servicefabric/v20211101preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20220101:ManagedCluster to guarantee forwards compatibility.""")
        ...
        super(ManagedCluster, __self__).__init__(
            'azure-native:servicefabric/v20211101preview:ManagedCluster',
            resource_name,
            __props__,
            opts)
