...
def get_managed_maintenance_window_status(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20240601preview:getManagedMaintenanceWindowStatus', __args__, opts=opts, typ=GetManagedMaintenanceWindowStatusResult).value
