...
class ManagedClusterArgs:
    def __init__(__self__, *,
                 ...
                 custom_fqdn: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] custom_fqdn: If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster.
    ...
    def custom_fqdn(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @custom_fqdn.setter
    def custom_fqdn(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "custom_fqdn", value)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["custom_fqdn"] = custom_fqdn
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["custom_fqdn"] = None
    ...
    @property
    @pulumi.getter(name="customFqdn")
    def custom_fqdn(self) -> pulumi.Output[Optional[str]]:
        """
        If using autoGeneratedDomainNameLabelScope, this is the fully qualified domain name using SFMC's domain, pointing to the public load balancer of the cluster.
        """
        return pulumi.get(self, "custom_fqdn")
