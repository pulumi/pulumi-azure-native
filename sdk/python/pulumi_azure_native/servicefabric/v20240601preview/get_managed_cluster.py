...
def get_managed_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20240601preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult)
    return __ret__.apply(lambda __response__: GetManagedClusterResult(
        ...
        custom_fqdn=pulumi.get(__response__, 'custom_fqdn'),
