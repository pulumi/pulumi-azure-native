...
class ManagedClusterApplicationType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:ManagedClusterApplicationType")])
