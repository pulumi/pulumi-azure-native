...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_cluster = azure_native.servicefabric.v20230201preview.ManagedCluster("managedCluster",
            addon_features=[
                "DnsService",
            ...
            application_type_versions_cleanup_policy=azure_native.servicefabric.v20230201preview.ApplicationTypeVersionsCleanupPolicyResponseArgs(
            ...
            sku=azure_native.servicefabric.v20230201preview.SkuArgs(
                name="Basic",
            ),
            tags={},
        ...
        ```sh
        $ pulumi import azure-native:servicefabric/v20230201preview:ManagedCluster myCluster /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/resRg/providers/Microsoft.ServiceFabric/managedClusters/myCluster 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(ManagedCluster, __self__).__init__(
            'azure-native:servicefabric/v20230201preview:ManagedCluster',
            resource_name,
            __props__,
            opts)
