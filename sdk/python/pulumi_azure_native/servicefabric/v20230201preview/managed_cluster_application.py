...
class ManagedClusterApplication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ManagedClusterApplication"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:ManagedClusterApplication"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterApplication"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:ManagedClusterApplication")])
