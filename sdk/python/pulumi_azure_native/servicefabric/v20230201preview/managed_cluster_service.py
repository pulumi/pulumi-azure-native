...
class ManagedClusterService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:ManagedClusterService")])
