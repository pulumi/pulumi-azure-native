...
warnings.warn("""azure-native:servicefabric/v20230201preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_node_type is deprecated: azure-native:servicefabric/v20230201preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['nodeTypeName'] = node_type_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20230201preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult).value
    ...
    return AwaitableGetNodeTypeResult(
        ...
        secure_boot_enabled=__ret__.secure_boot_enabled,
        security_type=__ret__.security_type,
        sku=__ret__.sku,
        spot_restore_timeout=__ret__.spot_restore_timeout,
        subnet_id=__ret__.subnet_id,
        system_data=__ret__.system_data,
        tags=__ret__.tags,
        type=__ret__.type,
        use_default_public_load_balancer=__ret__.use_default_public_load_balancer,
        use_ephemeral_os_disk=__ret__.use_ephemeral_os_disk,
        ...
        vm_setup_actions=__ret__.vm_setup_actions,
        vm_shared_gallery_image_id=__ret__.vm_shared_gallery_image_id,
