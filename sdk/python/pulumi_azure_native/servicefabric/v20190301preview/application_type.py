...
azure-native:servicefabric/v20190301preview:ApplicationType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationType to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:servicefabric/v20190301preview:ApplicationType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationType to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ApplicationType is deprecated: Version 2019-03-01-preview will be removed in v2 of the provider.
azure-native:servicefabric/v20190301preview:ApplicationType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:ApplicationType to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20170701preview:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20190301:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20190601preview:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20191101preview:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20200301:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20201201preview:ApplicationType"), pulumi.Alias(type_="azure-native:servicefabric/v20210601:ApplicationType")])
