...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type_version is deprecated: Version 2019-03-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20190301preview:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
