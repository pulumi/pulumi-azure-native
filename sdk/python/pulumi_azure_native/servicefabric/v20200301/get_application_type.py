...
def get_application_type(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type is deprecated: azure-native:servicefabric/v20200301:ApplicationType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210601:ApplicationType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['applicationTypeName'] = application_type_name
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20200301:getApplicationType', __args__, opts=opts, typ=GetApplicationTypeResult).value
