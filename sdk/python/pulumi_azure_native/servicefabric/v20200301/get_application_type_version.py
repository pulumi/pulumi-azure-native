...
def get_application_type_version_output(application_type_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20200301:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult)
