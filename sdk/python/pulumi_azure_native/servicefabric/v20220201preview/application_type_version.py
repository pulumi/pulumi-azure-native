...
warnings.warn("""azure-native:servicefabric/v20220201preview:ApplicationTypeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:ApplicationTypeVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
class ApplicationTypeVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric/v20210101preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20210901privatepreview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20211101preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20220601preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20220801preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ApplicationTypeVersion"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:ApplicationTypeVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationTypeVersion, __self__).__init__(
            'azure-native:servicefabric/v20220201preview:ApplicationTypeVersion',
            resource_name,
            __props__,
            opts)
