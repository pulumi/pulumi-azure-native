...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_node_type is deprecated: azure-native:servicefabric/v20220201preview:NodeType is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.""")
    __args__ = dict()
