...
warnings.warn("""azure-native:servicefabric/v20220201preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetNodeTypeResult:
    ...
    """
    def __init__(__self__, additional_data_disks=None, application_ports=None, capacities=None, data_disk_letter=None, data_disk_size_gb=None, data_disk_type=None, enable_accelerated_networking=None, enable_encryption_at_host=None, enable_over_provisioning=None, ephemeral_ports=None, frontend_configurations=None, id=None, is_primary=None, is_spot_vm=None, is_stateless=None, multiple_placement_groups=None, name=None, network_security_rules=None, placement_properties=None, provisioning_state=None, sku=None, system_data=None, tags=None, type=None, use_default_public_load_balancer=None, use_temp_data_disk=None, vm_extensions=None, vm_image_offer=None, vm_image_publisher=None, vm_image_sku=None, vm_image_version=None, vm_instance_count=None, vm_managed_identity=None, vm_secrets=None, vm_size=None, zones=None):
...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_node_type is deprecated: azure-native:servicefabric/v20220201preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['nodeTypeName'] = node_type_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20220201preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult).value
