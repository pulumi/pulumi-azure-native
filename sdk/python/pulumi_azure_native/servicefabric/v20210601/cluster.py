...
class ClusterArgs:
    ...
    def _configure(
        ...
        if infrastructure_service_manager is None and 'infrastructureServiceManager' in kwargs:
        ...
        if sf_zonal_upgrade_mode is None and 'sfZonalUpgradeMode' in kwargs:
        ...
        if upgrade_pause_end_timestamp_utc is None and 'upgradePauseEndTimestampUtc' in kwargs:
            upgrade_pause_end_timestamp_utc = kwargs['upgradePauseEndTimestampUtc']
        if upgrade_pause_start_timestamp_utc is None and 'upgradePauseStartTimestampUtc' in kwargs:
        ...
        if wave_upgrade_paused is None and 'waveUpgradePaused' in kwargs:
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric/v20160901:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20170701preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20180201:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190301:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190301preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20190601preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20191101preview:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20200301:Cluster"), pulumi.Alias(type_="azure-native:servicefabric/v20201201preview:Cluster")])
