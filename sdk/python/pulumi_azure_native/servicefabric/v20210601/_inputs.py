...
class ApplicationMetricDescriptionArgs:
    ...
    def _configure(
        ...
        if 'reservationCapacity' in kwargs:
            reservation_capacity = kwargs['reservationCapacity']
        if 'totalApplicationCapacity' in kwargs:
...
class ArmServiceTypeHealthPolicyArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'maxPercentUnhealthyPartitionsPerService' in kwargs:
            max_percent_unhealthy_partitions_per_service = kwargs['maxPercentUnhealthyPartitionsPerService']
        if 'maxPercentUnhealthyReplicasPerPartition' in kwargs:
...
class NotificationArgs:
    ...
    def _configure(
        ...
        if 'notificationCategory' in kwargs:
            notification_category = kwargs['notificationCategory']
        if 'notificationLevel' in kwargs:
...
class ServiceLoadMetricDescriptionArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'defaultLoad' in kwargs:
            default_load = kwargs['defaultLoad']
        if 'primaryDefaultLoad' in kwargs:
            primary_default_load = kwargs['primaryDefaultLoad']
        if 'secondaryDefaultLoad' in kwargs:
