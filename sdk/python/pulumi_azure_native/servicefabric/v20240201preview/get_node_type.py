...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20240201preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult).value
...
def get_node_type_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20240201preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult)
