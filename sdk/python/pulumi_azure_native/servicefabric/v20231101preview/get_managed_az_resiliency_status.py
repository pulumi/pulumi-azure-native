...
def get_managed_az_resiliency_status(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20231101preview:getManagedAzResiliencyStatus', __args__, opts=opts, typ=GetManagedAzResiliencyStatusResult).value
