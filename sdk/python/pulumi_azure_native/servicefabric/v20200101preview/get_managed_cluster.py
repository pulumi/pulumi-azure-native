...
def get_managed_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20200101preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
    ...
    return AwaitableGetManagedClusterResult(
        ...
        cluster_certificate_thumbprint=pulumi.get(__ret__, 'cluster_certificate_thumbprint'),
