...
class NodeType(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        node_type = azure_native.servicefabric.v20200101preview.NodeType("nodeType",
            capacities={
            ...
            vm_secrets=[{
                "sourceVault": azure_native.servicefabric.v20200101preview.SubResourceArgs(
