...
class GetApplicationTypeVersionResult:
    ...
    def app_package_url(self) -> builtins.str:
        """
...
def get_application_type_version(application_type_name: Optional[builtins.str] = None,
    ...
    :param builtins.str application_type_name: The name of the application type name resource.
    :param builtins.str cluster_name: The name of the cluster resource.
    :param builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param builtins.str version: The application type version.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
...
def get_application_type_version_output(application_type_name: Optional[pulumi.Input[builtins.str]] = None,
