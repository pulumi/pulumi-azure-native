...
def get_managed_cluster_service(application_name: Optional[builtins.str] = None,
    ...
    :param builtins.str service_name: The name of the service resource in the format of {applicationName}~{serviceName}.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric:getManagedClusterService', __args__, opts=opts, typ=GetManagedClusterServiceResult).value
...
def get_managed_cluster_service_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:getManagedClusterService', __args__, opts=opts, typ=GetManagedClusterServiceResult)
