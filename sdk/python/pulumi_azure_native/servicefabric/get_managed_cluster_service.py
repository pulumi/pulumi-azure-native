...
def get_managed_cluster_service(application_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_name: The name of the application resource.
    ...
    :param _builtins.str service_name: The name of the service resource in the format of {applicationName}~{serviceName}.
    """
    __args__ = dict()
