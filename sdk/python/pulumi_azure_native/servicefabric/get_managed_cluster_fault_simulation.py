...
def get_managed_cluster_fault_simulation(cluster_name: Optional[_builtins.str] = None,
...
def get_managed_cluster_fault_simulation_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
