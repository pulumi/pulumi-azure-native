...
class NodeTypeArgs:
    def __init__(__self__, *,
        ...
        NodeTypeArgs._configure(
            ...
            additional_network_interface_configurations=additional_network_interface_configurations,
            application_ports=application_ports,
            capacities=capacities,
            data_disk_letter=data_disk_letter,
            data_disk_size_gb=data_disk_size_gb,
            data_disk_type=data_disk_type,
            dscp_configuration_id=dscp_configuration_id,
            enable_accelerated_networking=enable_accelerated_networking,
            enable_encryption_at_host=enable_encryption_at_host,
            enable_node_public_ip=enable_node_public_ip,
            enable_node_public_i_pv6=enable_node_public_i_pv6,
            ...
            service_artifact_reference_id=service_artifact_reference_id,
            sku=sku,
    ...
    def _configure(
        ...
        if additional_data_disks is None and 'additionalDataDisks' in kwargs:
            additional_data_disks = kwargs['additionalDataDisks']
        if additional_network_interface_configurations is None and 'additionalNetworkInterfaceConfigurations' in kwargs:
            additional_network_interface_configurations = kwargs['additionalNetworkInterfaceConfigurations']
        if application_ports is None and 'applicationPorts' in kwargs:
            application_ports = kwargs['applicationPorts']
        if data_disk_letter is None and 'dataDiskLetter' in kwargs:
        ...
        if dscp_configuration_id is None and 'dscpConfigurationId' in kwargs:
            dscp_configuration_id = kwargs['dscpConfigurationId']
        ...
        if enable_node_public_i_pv6 is None and 'enableNodePublicIPv6' in kwargs:
            enable_node_public_i_pv6 = kwargs['enableNodePublicIPv6']
        if enable_over_provisioning is None and 'enableOverProvisioning' in kwargs:
        ...
        if frontend_configurations is None and 'frontendConfigurations' in kwargs:
        ...
        if is_spot_vm is None and 'isSpotVM' in kwargs:
            is_spot_vm = kwargs['isSpotVM']
        if is_stateless is None and 'isStateless' in kwargs:
            is_stateless = kwargs['isStateless']
        if multiple_placement_groups is None and 'multiplePlacementGroups' in kwargs:
        ...
        if node_type_name is None and 'nodeTypeName' in kwargs:
        ...
        if service_artifact_reference_id is None and 'serviceArtifactReferenceId' in kwargs:
            service_artifact_reference_id = kwargs['serviceArtifactReferenceId']
        if spot_restore_timeout is None and 'spotRestoreTimeout' in kwargs:
            spot_restore_timeout = kwargs['spotRestoreTimeout']
        if subnet_id is None and 'subnetId' in kwargs:
            subnet_id = kwargs['subnetId']
        if use_default_public_load_balancer is None and 'useDefaultPublicLoadBalancer' in kwargs:
            use_default_public_load_balancer = kwargs['useDefaultPublicLoadBalancer']
        if use_ephemeral_os_disk is None and 'useEphemeralOSDisk' in kwargs:
            use_ephemeral_os_disk = kwargs['useEphemeralOSDisk']
        if use_temp_data_disk is None and 'useTempDataDisk' in kwargs:
            use_temp_data_disk = kwargs['useTempDataDisk']
        if vm_extensions is None and 'vmExtensions' in kwargs:
            vm_extensions = kwargs['vmExtensions']
        if vm_image_offer is None and 'vmImageOffer' in kwargs:
            vm_image_offer = kwargs['vmImageOffer']
        if vm_image_plan is None and 'vmImagePlan' in kwargs:
        ...
        if vm_image_resource_id is None and 'vmImageResourceId' in kwargs:
        ...
        if vm_managed_identity is None and 'vmManagedIdentity' in kwargs:
            vm_managed_identity = kwargs['vmManagedIdentity']
        if vm_secrets is None and 'vmSecrets' in kwargs:
            vm_secrets = kwargs['vmSecrets']
        if vm_setup_actions is None and 'vmSetupActions' in kwargs:
            vm_setup_actions = kwargs['vmSetupActions']
        if vm_shared_gallery_image_id is None and 'vmSharedGalleryImageId' in kwargs:
        ...
        if additional_network_interface_configurations is not None:
            _setter("additional_network_interface_configurations", additional_network_interface_configurations)
        ...
        if dscp_configuration_id is not None:
            _setter("dscp_configuration_id", dscp_configuration_id)
        ...
        if enable_node_public_i_pv6 is not None:
            _setter("enable_node_public_i_pv6", enable_node_public_i_pv6)
        ...
        if service_artifact_reference_id is not None:
            _setter("service_artifact_reference_id", service_artifact_reference_id)
        if sku is not None:
            _setter("sku", sku)
...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            application_ports = _utilities.configure(application_ports, EndpointRangeDescriptionArgs, True)
            ...
            ephemeral_ports = _utilities.configure(ephemeral_ports, EndpointRangeDescriptionArgs, True)
            ...
            sku = _utilities.configure(sku, NodeTypeSkuArgs, True)
            ...
            vm_image_plan = _utilities.configure(vm_image_plan, VmImagePlanArgs, True)
            ...
            vm_managed_identity = _utilities.configure(vm_managed_identity, VmManagedIdentityArgs, True)
