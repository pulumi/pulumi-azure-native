...
class NodeTypeArgs:
    ...
    def _configure(
        ...
        if 'additionalNetworkInterfaceConfigurations' in kwargs:
        ...
        if 'dscpConfigurationId' in kwargs:
        ...
        if 'enableNodePublicIPv6' in kwargs:
        ...
        if 'serviceArtifactReferenceId' in kwargs:
