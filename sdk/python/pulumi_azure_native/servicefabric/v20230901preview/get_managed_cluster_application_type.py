...
def get_managed_cluster_application_type(application_type_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20230901preview:getManagedClusterApplicationType', __args__, opts=opts, typ=GetManagedClusterApplicationTypeResult).value
...
def get_managed_cluster_application_type_output(application_type_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20230901preview:getManagedClusterApplicationType', __args__, opts=opts, typ=GetManagedClusterApplicationTypeResult)
