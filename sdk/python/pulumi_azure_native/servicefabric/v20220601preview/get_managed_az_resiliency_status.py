...
def get_managed_az_resiliency_status(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20220601preview:getManagedAzResiliencyStatus', __args__, opts=opts, typ=GetManagedAzResiliencyStatusResult).value
...
def get_managed_az_resiliency_status_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20220601preview:getManagedAzResiliencyStatus', __args__, opts=opts, typ=GetManagedAzResiliencyStatusResult)
