...
warnings.warn("""azure-native:servicefabric/v20220601preview:Application is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:Application to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: azure-native:servicefabric/v20220601preview:Application is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20230201preview:Application to guarantee forwards compatibility.""")
    __args__ = dict()
