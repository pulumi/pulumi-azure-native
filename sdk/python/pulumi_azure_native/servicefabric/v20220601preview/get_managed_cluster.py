...
def get_managed_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster is deprecated: azure-native:servicefabric/v20220601preview:ManagedCluster is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20221001preview:ManagedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
