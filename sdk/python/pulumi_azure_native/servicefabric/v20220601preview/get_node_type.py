...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_node_type is deprecated: azure-native:servicefabric/v20220601preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230201preview:NodeType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['nodeTypeName'] = node_type_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20220601preview:getNodeType', __args__, opts=opts, typ=GetNodeTypeResult).value
