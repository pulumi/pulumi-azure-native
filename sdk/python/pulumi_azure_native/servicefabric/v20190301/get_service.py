...
def get_service(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20190301 will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""")
    __args__ = dict()
