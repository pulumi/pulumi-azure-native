...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type_version is deprecated: Version v20190301 will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""")
    __args__ = dict()
