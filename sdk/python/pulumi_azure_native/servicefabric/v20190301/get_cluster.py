...
azure-native:servicefabric/v20190301:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20201201preview:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: Version 2019-03-01 will be removed in v2 of the provider.
azure-native:servicefabric/v20190301:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20201201preview:Cluster to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20190301:getCluster', __args__, opts=opts, typ=GetClusterResult).value
