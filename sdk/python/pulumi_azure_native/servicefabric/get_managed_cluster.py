...
class GetManagedClusterResult:
    ...
    def addon_features(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def allow_rdp_access(self) -> Optional[builtins.bool]:
        """
    ...
    def client_connection_port(self) -> Optional[builtins.int]:
        """
    ...
    def cluster_certificate_thumbprints(self) -> Sequence[builtins.str]:
        """
    ...
    def cluster_code_version(self) -> Optional[builtins.str]:
        """
    ...
    def cluster_upgrade_cadence(self) -> Optional[builtins.str]:
        """
    ...
    def cluster_upgrade_mode(self) -> Optional[builtins.str]:
        """
    ...
    def ddos_protection_plan_id(self) -> Optional[builtins.str]:
        """
    ...
    def enable_auto_os_upgrade(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_http_gateway_exclusive_auth_mode(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_service_public_ip(self) -> Optional[builtins.bool]:
        """
    ...
    def http_gateway_connection_port(self) -> Optional[builtins.int]:
        """
    ...
    def http_gateway_token_auth_connection_port(self) -> Optional[builtins.int]:
        """
    ...
    def public_i_pv6_prefix_id(self) -> Optional[builtins.str]:
        """
    ...
    def use_custom_vnet(self) -> Optional[builtins.bool]:
        """
    ...
    def zonal_resiliency(self) -> Optional[builtins.bool]:
        """
    ...
    def zonal_update_mode(self) -> Optional[builtins.str]:
        """
...
def get_managed_cluster(cluster_name: Optional[builtins.str] = None,
...
def get_managed_cluster_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult)
