...
warnings.warn("""azure-native:servicefabric/v20210501:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210901privatepreview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_size: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NodeType is deprecated: azure-native:servicefabric/v20210501:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210901privatepreview:NodeType to guarantee forwards compatibility.""")
