...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: azure-native:servicefabric/v20210501:Application is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:Application to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['applicationName'] = application_name
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20210501:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
