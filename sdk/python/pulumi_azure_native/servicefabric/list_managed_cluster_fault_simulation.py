...
def list_managed_cluster_fault_simulation(cluster_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric:listManagedClusterFaultSimulation', __args__, opts=opts, typ=ListManagedClusterFaultSimulationResult).value

    return AwaitableListManagedClusterFaultSimulationResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_managed_cluster_fault_simulation_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric:listManagedClusterFaultSimulation', __args__, opts=opts, typ=ListManagedClusterFaultSimulationResult)
