...
warnings.warn("""Version v20170701preview will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""", DeprecationWarning)
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_image: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Cluster is deprecated: Version v20170701preview will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""")
        if opts is None:
