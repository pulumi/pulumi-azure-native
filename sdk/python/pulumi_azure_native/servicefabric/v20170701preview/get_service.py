...
azure-native:servicefabric/v20170701preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210601:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_service(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version 2017-07-01-preview will be removed in v2 of the provider.
azure-native:servicefabric/v20170701preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210601:Service to guarantee forwards compatibility.""")
    __args__ = dict()
