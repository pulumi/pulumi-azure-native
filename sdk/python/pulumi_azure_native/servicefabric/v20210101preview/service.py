...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabric/v20210101preview:Service"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:Service"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210501:Service"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:Service"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210701preview:Service"), pulumi.Alias(type_="azure-native:servicefabric/v20210901privatepreview:Service"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20210901privatepreview:Service")])
