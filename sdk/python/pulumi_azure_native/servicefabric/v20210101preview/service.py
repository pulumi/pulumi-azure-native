...
warnings.warn("""azure-native:servicefabric/v20210101preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Service is deprecated: azure-native:servicefabric/v20210101preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20210601:Service to guarantee forwards compatibility.""")
