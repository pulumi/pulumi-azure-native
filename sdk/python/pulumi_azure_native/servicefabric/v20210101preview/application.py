...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20210901privatepreview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20211101preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20220201preview:Application")])
