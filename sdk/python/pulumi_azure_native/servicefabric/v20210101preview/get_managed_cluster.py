...
warnings.warn("""azure-native:servicefabric/v20210101preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20220101:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetManagedClusterResult:
    ...
    """
    def __init__(__self__, addon_features=None, admin_password=None, admin_user_name=None, allow_rdp_access=None, application_type_versions_cleanup_policy=None, azure_active_directory=None, client_connection_port=None, clients=None, cluster_certificate_thumbprints=None, cluster_code_version=None, cluster_id=None, cluster_state=None, cluster_upgrade_cadence=None, dns_name=None, enable_auto_os_upgrade=None, etag=None, fabric_settings=None, fqdn=None, http_gateway_connection_port=None, id=None, ipv4_address=None, load_balancing_rules=None, location=None, name=None, network_security_rules=None, provisioning_state=None, sku=None, system_data=None, tags=None, type=None):
...
def get_managed_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_cluster is deprecated: azure-native:servicefabric/v20210101preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20220101:ManagedCluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20210101preview:getManagedCluster', __args__, opts=opts, typ=GetManagedClusterResult).value
