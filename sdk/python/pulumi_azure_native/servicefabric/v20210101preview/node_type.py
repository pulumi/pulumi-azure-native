...
warnings.warn("""azure-native:servicefabric/v20210101preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210901privatepreview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_size: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NodeType is deprecated: azure-native:servicefabric/v20210101preview:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20210901privatepreview:NodeType to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20200101preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20210501:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20210701preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20210901privatepreview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20211101preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20220101:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20220201preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20220601preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20220801preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:NodeType")])
