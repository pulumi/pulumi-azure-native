...
def get_managed_maintenance_window_status(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20240401:getManagedMaintenanceWindowStatus', __args__, opts=opts, typ=GetManagedMaintenanceWindowStatusResult).value
...
def get_managed_maintenance_window_status_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20240401:getManagedMaintenanceWindowStatus', __args__, opts=opts, typ=GetManagedMaintenanceWindowStatusResult)
