...
class ManagedClusterService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:ManagedClusterService"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:ManagedClusterService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedClusterService, __self__).__init__(
            'azure-native:servicefabric/v20220101:ManagedClusterService',
            resource_name,
            __props__,
            opts)
