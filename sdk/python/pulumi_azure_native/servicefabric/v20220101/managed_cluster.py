...
class ManagedCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_cluster = azure_native.servicefabric.v20220101.ManagedCluster("managedCluster",
            addon_features=[
                "DnsService",
            ...
            application_type_versions_cleanup_policy=azure_native.servicefabric.v20220101.ApplicationTypeVersionsCleanupPolicyResponseArgs(
            ...
            sku=azure_native.servicefabric.v20220101.SkuResponseArgs(
                name="Basic",
            ),
            tags={},
