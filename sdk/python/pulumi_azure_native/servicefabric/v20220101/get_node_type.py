...
warnings.warn("""azure-native:servicefabric/v20220101:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_node_type(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_node_type is deprecated: azure-native:servicefabric/v20220101:NodeType is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20230301preview:NodeType to guarantee forwards compatibility.""")
    __args__ = dict()
