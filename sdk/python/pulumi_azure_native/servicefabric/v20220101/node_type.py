...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabric:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20200101preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20221001preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20230201preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric/v20230301preview:NodeType")])
