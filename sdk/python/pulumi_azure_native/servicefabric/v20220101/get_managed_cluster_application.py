...
def get_managed_cluster_application(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20220101:getManagedClusterApplication', __args__, opts=opts, typ=GetManagedClusterApplicationResult).value
...
def get_managed_cluster_application_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicefabric/v20220101:getManagedClusterApplication', __args__, opts=opts, typ=GetManagedClusterApplicationResult)
