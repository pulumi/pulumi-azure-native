...
class AddRemoveIncrementalNamedPartitionScalingMechanismArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_partition_count: Minimum number of named partitions of the service.
        :param pulumi.Input[_builtins.int] scale_increment: The number of instances to add or remove during a scaling operation.
        """
...
class ApplicationHealthPolicyArgsDict(TypedDict):
    ...
    """
    default_service_type_health_policy: NotRequired[pulumi.Input[Optional['ServiceTypeHealthPolicyArgs']]]
    """
    The health policy used by default to evaluate the health of a service type.
    """
    service_type_health_policy_map: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['ServiceTypeHealthPolicyArgs']]]]]
    """
...
class ApplicationHealthPolicyArgs:
    ...
    def max_percent_unhealthy_deployed_applications(self) -> pulumi.Input[_builtins.int]:
        """
        The maximum allowed percentage of unhealthy deployed applications. Allowed values are Byte values from zero to 100.
        The percentage represents the maximum tolerated percentage of deployed applications that can be unhealthy before the application is considered in error.
        This is calculated by dividing the number of unhealthy deployed applications over the number of nodes where the application is currently deployed on in the cluster.
    ...
    def max_percent_unhealthy_deployed_applications(self, value: pulumi.Input[_builtins.int]):
...
class ApplicationUpgradePolicyArgsDict(TypedDict):
    ...
    """
    application_health_policy: NotRequired[pulumi.Input[Optional['ApplicationHealthPolicyArgs']]]
    """
    Defines a health policy used to evaluate the health of an application or one of its children entities.
    """
    ...
    """
    rolling_upgrade_monitoring_policy: NotRequired[pulumi.Input[Optional['RollingUpgradeMonitoringPolicyArgs']]]
    """
...
class ApplicationUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] recreate_application: Determines whether the application should be recreated on update. If value=true, the rest of the upgrade policy parameters are not allowed.
        ...
        :param pulumi.Input[Union[_builtins.str, 'RollingUpgradeMode']] upgrade_mode: The mode used to monitor health during a rolling upgrade. The values are Monitored, and UnmonitoredAuto.
        :param pulumi.Input[_builtins.float] upgrade_replica_set_check_timeout: The maximum amount of time to block processing of an upgrade domain and prevent loss of availability when there are unexpected issues. When this timeout expires, processing of the upgrade domain will proceed regardless of availability loss issues. The timeout is reset at the start of each upgrade domain. Valid values are between 0 and 42949672925 inclusive. (unsigned 32-bit integer).
        """
...
class ApplicationUserAssignedIdentityArgs:
    def __init__(__self__, *,
                 ...
                 principal_id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The friendly name of user assigned identity.
...
class AveragePartitionLoadScalingTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] metric_name: The name of the metric for which usage should be tracked.
        :param pulumi.Input[_builtins.str] scale_interval: The period in seconds on which a decision is made whether to scale or not. This property should come in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[_builtins.float] upper_load_threshold: The upper limit of the load beyond which a scale out operation should be performed.
        """
...
class AverageServiceLoadScalingTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] scale_interval: The period in seconds on which a decision is made whether to scale or not. This property should come in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[_builtins.float] upper_load_threshold: The upper limit of the load beyond which a scale out operation should be performed.
        :param pulumi.Input[_builtins.bool] use_only_primary_load: Flag determines whether only the load of primary replica should be considered for scaling. If set to true, then trigger will only consider the load of primary replicas of stateful service. If set to false, trigger will consider load of all replicas. This parameter cannot be set to true for stateless service.
        """
...
class ClusterHealthPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_percent_unhealthy_applications: The maximum allowed percentage of unhealthy applications before reporting an error. For example, to allow 10% of applications to be unhealthy, this value would be 10.
               ...
               This is calculated by dividing the number of unhealthy applications over the total number of application instances in the cluster, excluding applications of application types that are included in the ApplicationTypeHealthPolicyMap.
               The computation rounds up to tolerate one failure on small numbers of applications. Default percentage is zero.
        :param pulumi.Input[_builtins.int] max_percent_unhealthy_nodes: The maximum allowed percentage of unhealthy nodes before reporting an error. For example, to allow 10% of nodes to be unhealthy, this value would be 10.
    ...
    def max_percent_unhealthy_applications(self, value: pulumi.Input[_builtins.int]):
...
class ClusterMonitoringPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] upgrade_domain_timeout: The amount of time each upgrade domain has to complete before the upgrade rolls back. The timeout can be in either hh:mm:ss or in d.hh:mm:ss.ms format.
        :param pulumi.Input[_builtins.str] upgrade_timeout: The amount of time the overall upgrade has to complete before the upgrade rolls back. The timeout can be in either hh:mm:ss or in d.hh:mm:ss.ms format.
        """
...
class ClusterUpgradeDeltaHealthPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_percent_delta_unhealthy_nodes: The maximum allowed percentage of nodes health degradation allowed during cluster upgrades.
               The delta is measured between the state of the nodes at the beginning of upgrade and the state of the nodes at the time of the health evaluation.
               The check is performed after every upgrade domain upgrade completion to make sure the global state of the cluster is within tolerated limits.
        :param pulumi.Input[_builtins.int] max_percent_delta_unhealthy_applications: The maximum allowed percentage of applications health degradation allowed during cluster upgrades.
               The delta is measured between the state of the applications at the beginning of upgrade and the state of the applications at the time of the health evaluation.
               The check is performed after every upgrade domain upgrade completion to make sure the global state of the cluster is within tolerated limits. System services are not included in this.
               NOTE: This value will overwrite the value specified in properties.UpgradeDescription.HealthPolicy.MaxPercentUnhealthyApplications
        :param pulumi.Input[_builtins.int] max_percent_upgrade_domain_delta_unhealthy_nodes: The maximum allowed percentage of upgrade domain nodes health degradation allowed during cluster upgrades.
               The delta is measured between the state of the upgrade domain nodes at the beginning of upgrade and the state of the upgrade domain nodes at the time of the health evaluation.
               The check is performed after every upgrade domain upgrade completion for all completed upgrade domains to make sure the state of the upgrade domains is within tolerated limits.
        """
...
class ClusterUpgradePolicyArgsDict(TypedDict):
    ...
    """
    delta_health_policy: NotRequired[pulumi.Input[Optional['ClusterUpgradeDeltaHealthPolicyArgs']]]
    """
    ...
    If true, then processes are forcefully restarted during upgrade even when the code version has not changed (the upgrade only changes configuration or data).
    """
    health_policy: NotRequired[pulumi.Input[Optional['ClusterHealthPolicyArgs']]]
    """
    The cluster health policy defines a health policy used to evaluate the health of the cluster during a cluster upgrade.
    """
    monitoring_policy: NotRequired[pulumi.Input[Optional['ClusterMonitoringPolicyArgs']]]
    """
...
class ClusterUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] upgrade_replica_set_check_timeout: The maximum amount of time to block processing of an upgrade domain and prevent loss of availability when there are unexpected issues.
               When this timeout expires, processing of the upgrade domain will proceed regardless of availability loss issues.
               The timeout is reset at the start of each upgrade domain. The timeout can be in either hh:mm:ss or in d.hh:mm:ss.ms format.
               This value must be between 00:00:00 and 49710.06:28:15 (unsigned 32 bit integer for seconds)
        """
...
class FrontendConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] load_balancer_inbound_nat_pool_id: The resource Id of the Load Balancer inbound NAT pool that the VM instances of the node type are associated with. The format of the resource Id is '/subscriptions/<subscriptionId>/resourceGroups/<resourceGroupName>/providers/Microsoft.Network/loadBalancers/<loadBalancerName>/inboundNatPools/<inboundNatPoolName>'.
        """
...
class IpConfigurationPublicIPAddressConfigurationArgsDict(TypedDict):
    ...
    Name of the network interface.
    """
    ip_tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IpTagArgs']]]]]
    """
...
class IpConfigurationArgsDict(TypedDict):
    ...
    """
    load_balancer_inbound_nat_pools: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SubResourceArgs']]]]]
    """
    ...
    """
    public_ip_address_configuration: NotRequired[pulumi.Input[Optional['IpConfigurationPublicIPAddressConfigurationArgs']]]
    """
    The public IP address configuration of the network interface.
    """
...
class LoadBalancingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'Protocol']] protocol: The reference to the transport protocol used by the load balancing rule.
        :param pulumi.Input[_builtins.str] load_distribution: The load distribution policy for this rule.
        :param pulumi.Input[_builtins.int] probe_port: The prob port used by the load balancing rule. Acceptable values are between 1 and 65535.
        :param pulumi.Input[_builtins.str] probe_request_path: The probe request path. Only supported for HTTP/HTTPS probes.
        """
    ...
    def probe_protocol(self, value: pulumi.Input[Union[_builtins.str, 'ProbeProtocol']]):
...
class NetworkSecurityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] priority: The priority of the rule. The value can be in the range 1000 to 3000. Values outside this range are reserved for Service Fabric ManagerCluster Resource Provider. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
        :param pulumi.Input[Union[_builtins.str, 'NsgProtocol']] protocol: Network protocol this rule applies to.
        :param pulumi.Input[_builtins.str] description: Network security rule description.
        ...
        :param pulumi.Input[_builtins.str] destination_port_range: he destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
...
class PartitionInstanceCountScaleMechanismArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] min_instance_count: Minimum number of instances of the partition.
        :param pulumi.Input[_builtins.int] scale_increment: The number of instances to add or remove during a scaling operation.
        """
...
class RollingUpgradeMonitoringPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] health_check_wait_duration: The amount of time to wait after completing an upgrade domain before applying health policies. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        :param pulumi.Input[_builtins.str] upgrade_domain_timeout: The amount of time each upgrade domain has to complete before FailureAction is executed. Cannot be larger than 12 hours. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        :param pulumi.Input[_builtins.str] upgrade_timeout: The amount of time the overall upgrade has to complete before FailureAction is executed. Cannot be larger than 12 hours. It is interpreted as a string representing an ISO 8601 duration with following format "hh:mm:ss.fff".
        """
    ...
    def failure_action(self, value: pulumi.Input[Union[_builtins.str, 'FailureAction']]):
...
class ServiceCorrelationArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def scheme(self) -> pulumi.Input[Union[_builtins.str, 'ServiceCorrelationScheme']]:
        """
        The ServiceCorrelationScheme which describes the relationship between this service and the service specified via ServiceName.
        """
    ...
    @scheme.setter
    def scheme(self, value: pulumi.Input[Union[_builtins.str, 'ServiceCorrelationScheme']]):
...
class ServiceLoadMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] secondary_default_load: Used only for Stateful services. The default amount of load, as a number, that this service creates for this metric when it is a Secondary replica.
        :param pulumi.Input[Union[_builtins.str, 'ServiceLoadMetricWeight']] weight: The service load metric relative weight, compared to other metrics configured for this service, as a number.
        """
        pulumi.set(__self__, "name", name)
...
class ServiceTypeHealthPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_percent_unhealthy_partitions_per_service: The maximum allowed percentage of unhealthy partitions per service.
               ...
               The percentage is calculated by dividing the number of unhealthy partitions over the total number of partitions in the service.
               The computation rounds up to tolerate one failure on small numbers of partitions.
        :param pulumi.Input[_builtins.int] max_percent_unhealthy_replicas_per_partition: The maximum allowed percentage of unhealthy replicas per partition.
               
               The percentage represents the maximum tolerated percentage of replicas that can be unhealthy before the partition is considered in error.
               If the percentage is respected but there is at least one unhealthy replica, the health is evaluated as Warning.
               The percentage is calculated by dividing the number of unhealthy replicas over the total number of replicas in the partition.
               The computation rounds up to tolerate one failure on small numbers of replicas.
        :param pulumi.Input[_builtins.int] max_percent_unhealthy_services: The maximum allowed percentage of unhealthy services.
    ...
    def max_percent_unhealthy_partitions_per_service(self) -> pulumi.Input[_builtins.int]:
        """
        The maximum allowed percentage of unhealthy partitions per service.
    ...
    def max_percent_unhealthy_partitions_per_service(self, value: pulumi.Input[_builtins.int]):
    ...
    def max_percent_unhealthy_replicas_per_partition(self) -> pulumi.Input[_builtins.int]:
        """
        The maximum allowed percentage of unhealthy replicas per partition.
    ...
    def max_percent_unhealthy_replicas_per_partition(self, value: pulumi.Input[_builtins.int]):
...
class StatefulServicePropertiesArgsDict(TypedDict):
    ...
    """
    correlation_scheme: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceCorrelationArgs']]]]]
    """
    ...
    """
    scaling_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ScalingPolicyArgs']]]]]
    """
    ...
    """
    service_load_metrics: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceLoadMetricArgs']]]]]
    """
    ...
    """
    service_placement_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServicePlacementInvalidDomainPolicyArgs', 'ServicePlacementNonPartiallyPlaceServicePolicyArgs', 'ServicePlacementPreferPrimaryDomainPolicyArgs', 'ServicePlacementRequireDomainDistributionPolicyArgs', 'ServicePlacementRequiredDomainPolicyArgs']]]]]]
    """
    A list that describes the correlation of the service with other services.
    """
...
class StatefulServicePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_kind: The kind of service (Stateless or Stateful).
               Expected value is 'Stateful'.
        :param pulumi.Input[_builtins.str] service_type_name: The name of the service type
        ...
        :param pulumi.Input[Union[_builtins.str, 'MoveCost']] default_move_cost: Specifies the move cost for the service.
        :param pulumi.Input[_builtins.bool] has_persisted_state: A flag indicating whether this is a persistent service which stores states on the local disk. If it is then the value of this property is true, if not it is false.
        :param pulumi.Input[_builtins.int] min_replica_set_size: The minimum replica set size as a number.
        :param pulumi.Input[_builtins.str] placement_constraints: The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
        :param pulumi.Input[_builtins.str] quorum_loss_wait_duration: The maximum duration for which a partition is allowed to be in a state of quorum loss, represented in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[_builtins.str] replica_restart_wait_duration: The duration between when a replica goes down and when a new replica is created, represented in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[Sequence[pulumi.Input['ScalingPolicyArgs']]] scaling_policies: Scaling policies for this service.
        :param pulumi.Input[_builtins.str] service_dns_name: Dns name used for the service. If this is specified, then the DNS name can be used to return the IP addresses of service endpoints for application layer protocols (e.g., HTTP).
               When updating serviceDnsName, old name may be temporarily resolvable. However, rely on new name.
               When removing serviceDnsName, removed name may temporarily be resolvable. Do not rely on the name being unresolvable.
        ...
        :param pulumi.Input[Union[_builtins.str, 'ServicePackageActivationMode']] service_package_activation_mode: The activation Mode of the service package
        ...
        :param pulumi.Input[_builtins.str] service_placement_time_limit: The duration for which replicas can stay InBuild before reporting that build is stuck, represented in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[_builtins.str] stand_by_replica_keep_duration: The definition on how long StandBy replicas should be maintained before being removed, represented in ISO 8601 format "hh:mm:ss".
        :param pulumi.Input[_builtins.int] target_replica_set_size: The target replica set size as a number.
        """
...
class StatelessServicePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceCorrelationArgs']]] correlation_scheme: A list that describes the correlation of the service with other services.
        :param pulumi.Input[Union[_builtins.str, 'MoveCost']] default_move_cost: Specifies the move cost for the service.
        :param pulumi.Input[_builtins.int] min_instance_count: MinInstanceCount is the minimum number of instances that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstanceCount computation -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.
        :param pulumi.Input[_builtins.int] min_instance_percentage: MinInstancePercentage is the minimum percentage of InstanceCount that must be up to meet the EnsureAvailability safety check during operations like upgrade or deactivate node. The actual number that is used is max( MinInstanceCount, ceil( MinInstancePercentage/100.0 * InstanceCount) ). Note, if InstanceCount is set to -1, during MinInstancePercentage computation, -1 is first converted into the number of nodes on which the instances are allowed to be placed according to the placement constraints on the service.
        :param pulumi.Input[_builtins.str] placement_constraints: The placement constraints as a string. Placement constraints are boolean expressions on node properties and allow for restricting a service to particular nodes based on the service requirements. For example, to place a service on nodes where NodeType is blue specify the following: "NodeColor == blue)".
        :param pulumi.Input[Sequence[pulumi.Input['ScalingPolicyArgs']]] scaling_policies: Scaling policies for this service.
        :param pulumi.Input[_builtins.str] service_dns_name: Dns name used for the service. If this is specified, then the DNS name can be used to return the IP addresses of service endpoints for application layer protocols (e.g., HTTP).
               When updating serviceDnsName, old name may be temporarily resolvable. However, rely on new name.
...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'PrivateEndpointNetworkPolicies']] private_endpoint_network_policies: Enable or Disable apply network policies on private end point in the subnet.
        :param pulumi.Input[Union[_builtins.str, 'PrivateLinkServiceNetworkPolicies']] private_link_service_network_policies: Enable or Disable apply network policies on private link service in the subnet.
        """
        pulumi.set(__self__, "name", name)
...
class UniformInt64RangePartitionSchemeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] high_key: The upper bound of the partition key range that
               should be split between the partition ‘Count’
        :param pulumi.Input[_builtins.float] low_key: The lower bound of the partition key range that
               should be split between the partition ‘Count’
        :param pulumi.Input[_builtins.str] partition_scheme: Enumerates the ways that a service can be partitioned.
               Expected value is 'UniformInt64Range'.
        """
...
class VMSSExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'VmssExtensionSetupOrder']]]] setup_order: Indicates the setup order for the extension.
        """
        pulumi.set(__self__, "name", name)
...
class VmssDataDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] lun: Specifies the logical unit number of the data disk. This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM. Lun 0 is reserved for the service fabric data disk.
        """
