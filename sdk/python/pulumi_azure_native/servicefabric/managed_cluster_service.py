...
class ManagedClusterServiceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional[Union['StatefulServicePropertiesArgs', 'StatelessServicePropertiesArgs']]]:
        """
...
class ManagedClusterService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union[Union['StatefulServicePropertiesArgs', 'StatefulServicePropertiesArgsDict'], Union['StatelessServicePropertiesArgs', 'StatelessServicePropertiesArgsDict']]]] = None,
