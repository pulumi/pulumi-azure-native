...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application_type_version is deprecated: Version v20190601preview will be removed in the next major version of the provider. Upgrade to version v20200101preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20190601preview:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
