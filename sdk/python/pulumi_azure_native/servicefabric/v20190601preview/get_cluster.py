...
azure-native:servicefabric/v20190601preview:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20201201preview:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:servicefabric/v20190601preview:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:servicefabric/v20201201preview:Cluster to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/v20190601preview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
