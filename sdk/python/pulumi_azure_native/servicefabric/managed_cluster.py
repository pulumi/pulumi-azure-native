...
class ManagedClusterArgs:
    def __init__(__self__, *,
                 ...
                 addon_features: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ManagedClusterAddOnFeature']]]]] = None,
                 admin_password: Optional[pulumi.Input[builtins.str]] = None,
                 allow_rdp_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 cluster_upgrade_cadence: Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeCadence']]] = None,
                 cluster_upgrade_mode: Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeMode']]] = None,
                 ddos_protection_plan_id: Optional[pulumi.Input[builtins.str]] = None,
                 enable_auto_os_upgrade: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_http_gateway_exclusive_auth_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_service_public_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 fabric_settings: Optional[pulumi.Input[Sequence[pulumi.Input['SettingsSectionDescriptionArgs']]]] = None,
                 http_gateway_connection_port: Optional[pulumi.Input[builtins.int]] = None,
                 http_gateway_token_auth_connection_port: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 public_i_pv6_prefix_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 use_custom_vnet: Optional[pulumi.Input[builtins.bool]] = None,
                 zonal_resiliency: Optional[pulumi.Input[builtins.bool]] = None,
                 zonal_update_mode: Optional[pulumi.Input[Union[builtins.str, 'ZonalUpdateMode']]] = None):
        """
        The set of arguments for constructing a ManagedCluster resource.
        :param pulumi.Input[builtins.str] admin_user_name: VM admin user name.
        :param pulumi.Input[builtins.str] dns_name: The cluster dns name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ManagedClusterAddOnFeature']]]] addon_features: List of add-on features to enable on the cluster.
        :param pulumi.Input[builtins.str] admin_password: VM admin user password.
        :param pulumi.Input[builtins.bool] allow_rdp_access: Setting this to true enables RDP access to the VM. The default NSG rule opens RDP port to Internet which can be overridden with custom Network Security Rules. The default value for this setting is false.
        ...
        :param pulumi.Input[builtins.int] client_connection_port: The port used for client connections to the cluster.
        ...
        :param pulumi.Input[builtins.str] cluster_code_version: The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
        :param pulumi.Input[builtins.str] cluster_name: The name of the cluster resource.
        :param pulumi.Input[Union[builtins.str, 'ClusterUpgradeCadence']] cluster_upgrade_cadence: Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
        :param pulumi.Input[Union[builtins.str, 'ClusterUpgradeMode']] cluster_upgrade_mode: The upgrade mode of the cluster when new Service Fabric runtime version is available.
        :param pulumi.Input[builtins.str] ddos_protection_plan_id: Specify the resource id of a DDoS network protection plan that will be associated with the virtual network of the cluster.
        :param pulumi.Input[builtins.bool] enable_auto_os_upgrade: Setting this to true enables automatic OS upgrade for the node types that are created using any platform OS image with version 'latest'. The default value for this setting is false.
        :param pulumi.Input[builtins.bool] enable_http_gateway_exclusive_auth_mode: If true, token-based authentication is not allowed on the HttpGatewayEndpoint. This is required to support TLS versions 1.3 and above. If token-based authentication is used, HttpGatewayTokenAuthConnectionPort must be defined.
        :param pulumi.Input[builtins.bool] enable_ipv6: Setting this to true creates IPv6 address space for the default VNet used by the cluster. This setting cannot be changed once the cluster is created. The default value for this setting is false.
        :param pulumi.Input[builtins.bool] enable_service_public_ip: Setting this to true will link the IPv4 address as the ServicePublicIP of the IPv6 address. It can only be set to True if IPv6 is enabled on the cluster.
        ...
        :param pulumi.Input[builtins.int] http_gateway_connection_port: The port used for HTTP connections to the cluster.
        :param pulumi.Input[builtins.int] http_gateway_token_auth_connection_port: The port used for token-auth based HTTPS connections to the cluster. Cannot be set to the same port as HttpGatewayEndpoint.
        ...
        :param pulumi.Input[builtins.str] location: Azure resource location.
        ...
        :param pulumi.Input[builtins.str] public_ip_prefix_id: Specify the resource id of a public IPv4 prefix that the load balancer will allocate a public IPv4 address from. This setting cannot be changed once the cluster is created.
        :param pulumi.Input[builtins.str] public_i_pv6_prefix_id: Specify the resource id of a public IPv6 prefix that the load balancer will allocate a public IPv6 address from. This setting cannot be changed once the cluster is created.
        ...
        :param pulumi.Input[builtins.str] subnet_id: If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
        ...
        :param pulumi.Input[builtins.bool] use_custom_vnet: For new clusters, this parameter indicates that it uses Bring your own VNet, but the subnet is specified at node type level; and for such clusters, the subnetId property is required for node types.
        :param pulumi.Input[builtins.bool] zonal_resiliency: Indicates if the cluster has zone resiliency.
        :param pulumi.Input[Union[builtins.str, 'ZonalUpdateMode']] zonal_update_mode: Indicates the update mode for Cross Az clusters.
        """
    ...
    def addon_features(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ManagedClusterAddOnFeature']]]]]:
        """
    ...
    def addon_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'ManagedClusterAddOnFeature']]]]]):
    ...
    def allow_rdp_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_rdp_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cluster_upgrade_cadence(self) -> Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeCadence']]]:
        """
    ...
    def cluster_upgrade_cadence(self, value: Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeCadence']]]):
        pulumi.set(self, "cluster_upgrade_cadence", value)

    @property
    @pulumi.getter(name="clusterUpgradeMode")
    def cluster_upgrade_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeMode']]]:
        """
    ...
    def cluster_upgrade_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'ClusterUpgradeMode']]]):
    ...
    def enable_auto_os_upgrade(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_auto_os_upgrade(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_auto_os_upgrade", value)

    @property
    @pulumi.getter(name="enableHttpGatewayExclusiveAuthMode")
    def enable_http_gateway_exclusive_auth_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_http_gateway_exclusive_auth_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_service_public_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_service_public_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def http_gateway_connection_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_gateway_connection_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_gateway_connection_port", value)

    @property
    @pulumi.getter(name="httpGatewayTokenAuthConnectionPort")
    def http_gateway_token_auth_connection_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_gateway_token_auth_connection_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def public_i_pv6_prefix_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_i_pv6_prefix_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_custom_vnet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_custom_vnet(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_custom_vnet", value)

    @property
    @pulumi.getter(name="zonalResiliency")
    def zonal_resiliency(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def zonal_resiliency(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "zonal_resiliency", value)

    @property
    @pulumi.getter(name="zonalUpdateMode")
    def zonal_update_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'ZonalUpdateMode']]]:
        """
    ...
    def zonal_update_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'ZonalUpdateMode']]]):
...
class ManagedCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="addonFeatures")
    def addon_features(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of add-on features to enable on the cluster.
        """
        return pulumi.get(self, "addon_features")
    ...
    @property
    @pulumi.getter(name="allowRdpAccess")
    def allow_rdp_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Setting this to true enables RDP access to the VM. The default NSG rule opens RDP port to Internet which can be overridden with custom Network Security Rules. The default value for this setting is false.
        """
        return pulumi.get(self, "allow_rdp_access")
    ...
    @property
    @pulumi.getter(name="clientConnectionPort")
    def client_connection_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port used for client connections to the cluster.
        """
        return pulumi.get(self, "client_connection_port")
    ...
    def cluster_certificate_thumbprints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="clusterCodeVersion")
    def cluster_code_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
        """
        return pulumi.get(self, "cluster_code_version")
    ...
    @property
    @pulumi.getter(name="clusterUpgradeCadence")
    def cluster_upgrade_cadence(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
        """
        return pulumi.get(self, "cluster_upgrade_cadence")
    ...
    @property
    @pulumi.getter(name="clusterUpgradeMode")
    def cluster_upgrade_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The upgrade mode of the cluster when new Service Fabric runtime version is available.
        """
        return pulumi.get(self, "cluster_upgrade_mode")
    ...
    @property
    @pulumi.getter(name="enableAutoOSUpgrade")
    def enable_auto_os_upgrade(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Setting this to true enables automatic OS upgrade for the node types that are created using any platform OS image with version 'latest'. The default value for this setting is false.
        """
        return pulumi.get(self, "enable_auto_os_upgrade")
    ...
    @property
    @pulumi.getter(name="enableHttpGatewayExclusiveAuthMode")
    def enable_http_gateway_exclusive_auth_mode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, token-based authentication is not allowed on the HttpGatewayEndpoint. This is required to support TLS versions 1.3 and above. If token-based authentication is used, HttpGatewayTokenAuthConnectionPort must be defined.
        """
        return pulumi.get(self, "enable_http_gateway_exclusive_auth_mode")
    ...
    @property
    @pulumi.getter(name="enableServicePublicIP")
    def enable_service_public_ip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Setting this to true will link the IPv4 address as the ServicePublicIP of the IPv6 address. It can only be set to True if IPv6 is enabled on the cluster.
        """
        return pulumi.get(self, "enable_service_public_ip")
    ...
    @property
    @pulumi.getter(name="httpGatewayConnectionPort")
    def http_gateway_connection_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port used for HTTP connections to the cluster.
        """
        return pulumi.get(self, "http_gateway_connection_port")
    ...
    @property
    @pulumi.getter(name="httpGatewayTokenAuthConnectionPort")
    def http_gateway_token_auth_connection_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port used for token-auth based HTTPS connections to the cluster. Cannot be set to the same port as HttpGatewayEndpoint.
        """
        return pulumi.get(self, "http_gateway_token_auth_connection_port")
    ...
    @property
    @pulumi.getter(name="publicIPv6PrefixId")
    def public_i_pv6_prefix_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the resource id of a public IPv6 prefix that the load balancer will allocate a public IPv6 address from. This setting cannot be changed once the cluster is created.
        """
        return pulumi.get(self, "public_i_pv6_prefix_id")
    ...
    @property
    @pulumi.getter(name="useCustomVnet")
    def use_custom_vnet(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        For new clusters, this parameter indicates that it uses Bring your own VNet, but the subnet is specified at node type level; and for such clusters, the subnetId property is required for node types.
        """
        return pulumi.get(self, "use_custom_vnet")
    ...
    @property
    @pulumi.getter(name="zonalResiliency")
    def zonal_resiliency(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if the cluster has zone resiliency.
        """
        return pulumi.get(self, "zonal_resiliency")
    ...
    @property
    @pulumi.getter(name="zonalUpdateMode")
    def zonal_update_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates the update mode for Cross Az clusters.
        """
        return pulumi.get(self, "zonal_update_mode")
