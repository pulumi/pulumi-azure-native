...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:servicefabric:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:ApplicationType":
                return ApplicationType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:ApplicationTypeVersion":
                return ApplicationTypeVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:ManagedCluster":
                return ManagedCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:NodeType":
                return NodeType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicefabric:Service":
    ...
    pulumi.runtime.register_resource_module("azure-native", "servicefabric", _module_instance)
