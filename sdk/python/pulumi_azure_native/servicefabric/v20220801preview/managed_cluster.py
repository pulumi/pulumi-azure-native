...
warnings.warn("""azure-native:servicefabric/v20220801preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20221001preview:ManagedCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zonal_resiliency: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedCluster is deprecated: azure-native:servicefabric/v20220801preview:ManagedCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:servicefabric/v20221001preview:ManagedCluster to guarantee forwards compatibility.""")
