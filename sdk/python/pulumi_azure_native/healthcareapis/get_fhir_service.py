...
def get_fhir_service(fhir_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fhir_service_name: The name of FHIR Service resource.
...
def get_fhir_service_output(fhir_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
