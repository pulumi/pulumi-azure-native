...
class IotConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['IotMappingPropertiesArgs', 'IotMappingPropertiesArgsDict']] device_mapping: Device Mappings.
        ...
        :param pulumi.Input[Union['IotEventHubIngestionEndpointConfigurationArgs', 'IotEventHubIngestionEndpointConfigurationArgsDict']] ingestion_endpoint_configuration: Source configuration.
        :param pulumi.Input[str] iot_connector_name: The name of IoT Connector resource.
        :param pulumi.Input[str] location: The resource location.
        :param pulumi.Input[str] resource_group_name: The name of the resource group that contains the service instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
