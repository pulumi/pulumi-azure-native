...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20230906:getIotConnector', __args__, opts=opts, typ=GetIotConnectorResult).value
...
def get_iot_connector_output(iot_connector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20230906:getIotConnector', __args__, opts=opts, typ=GetIotConnectorResult)
