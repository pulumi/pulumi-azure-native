...
def get_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20210601preview will be removed in the next major version of the provider. Upgrade to version v20211101 or later.""")
    __args__ = dict()
