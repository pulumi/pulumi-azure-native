...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dicom_service is deprecated: Version v20210601preview will be removed in the next major version of the provider. Upgrade to version v20220515 or later.""")
    __args__ = dict()
