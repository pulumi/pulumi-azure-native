...
class IotConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if device_mapping is not None and not isinstance(device_mapping, IotMappingPropertiesArgs):
            ...
            if ingestion_endpoint_configuration is not None and not isinstance(ingestion_endpoint_configuration, IotEventHubIngestionEndpointConfigurationArgs):
