...
def get_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20200330 will be removed in the next major version of the provider. Upgrade to version v20211101 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20200330:getService', __args__, opts=opts, typ=GetServiceResult).value
