...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:healthcareapis:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:healthcareapis/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20210111:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:healthcareapis/v20210111:PrivateEndpointConnection")])
