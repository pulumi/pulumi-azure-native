...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20250301preview:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult).value
...
def get_dicom_service_output(dicom_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20250301preview:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult)
