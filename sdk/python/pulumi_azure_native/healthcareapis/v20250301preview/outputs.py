...
__all__ = [
    ...
    'StorageMonitorConfigurationResponse',
    'SystemDataResponse',
...
class StorageConfigurationResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "storageMonitorConfiguration":
            suggest = "storage_monitor_configuration"
    ...
    def __init__(__self__, *,
                 ...
                 storage_monitor_configuration: Optional['outputs.StorageMonitorConfigurationResponse'] = None,
                 storage_resource_id: Optional[str] = None):
        """
        The configuration of connected storage
        :param str file_system_name: The filesystem name of connected storage account.
        :param 'StorageMonitorConfigurationResponse' storage_monitor_configuration: The configuration for monitoring changes in the specified storage account.
        :param str storage_resource_id: The resource id of connected storage account.
        """
        if file_system_name is not None:
            pulumi.set(__self__, "file_system_name", file_system_name)
        if storage_monitor_configuration is not None:
            pulumi.set(__self__, "storage_monitor_configuration", storage_monitor_configuration)
    ...
    @property
    @pulumi.getter(name="storageMonitorConfiguration")
    def storage_monitor_configuration(self) -> Optional['outputs.StorageMonitorConfigurationResponse']:
        """
        The configuration for monitoring changes in the specified storage account.
        """
        return pulumi.get(self, "storage_monitor_configuration")
...
@pulumi.output_type
class StorageMonitorConfigurationResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "eventSubscriptionName":
            suggest = "event_subscription_name"
        elif key == "namespaceResourceId":
            suggest = "namespace_resource_id"
        elif key == "topicName":
            suggest = "topic_name"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in StorageMonitorConfigurationResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        StorageMonitorConfigurationResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration for monitoring changes in a connected storage.
        :param str event_subscription_name: The name of the event subscription associated with the given namespace topic that contains storage events.
        :param str namespace_resource_id: The resource id of the Azure Event Grid Namespace.
        :param str topic_name: The name of the namespace topic within the specified namespace.
        """
        if event_subscription_name is not None:
            pulumi.set(__self__, "event_subscription_name", event_subscription_name)
        if namespace_resource_id is not None:
            pulumi.set(__self__, "namespace_resource_id", namespace_resource_id)
        if topic_name is not None:
            pulumi.set(__self__, "topic_name", topic_name)

    @property
    @pulumi.getter(name="eventSubscriptionName")
    def event_subscription_name(self) -> Optional[str]:
        """
    ...
    @property
    @pulumi.getter(name="namespaceResourceId")
    def namespace_resource_id(self) -> Optional[str]:
        """
        The resource id of the Azure Event Grid Namespace.
        """
        return pulumi.get(self, "namespace_resource_id")
