...
def get_fhir_service(fhir_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20250301preview:getFhirService', __args__, opts=opts, typ=GetFhirServiceResult).value
...
def get_fhir_service_output(fhir_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20250301preview:getFhirService', __args__, opts=opts, typ=GetFhirServiceResult)
