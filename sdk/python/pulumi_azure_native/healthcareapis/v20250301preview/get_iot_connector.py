...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20250301preview:getIotConnector', __args__, opts=opts, typ=GetIotConnectorResult).value
...
def get_iot_connector_output(iot_connector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20250301preview:getIotConnector', __args__, opts=opts, typ=GetIotConnectorResult)
