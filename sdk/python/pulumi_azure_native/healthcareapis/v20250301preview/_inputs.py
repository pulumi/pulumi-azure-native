...
__all__ = [
    ...
    'StorageMonitorConfigurationArgsDict',
]
...
if not MYPY:
    class StorageConfigurationArgsDict(TypedDict):
        ...
        """
        storage_monitor_configuration: NotRequired[pulumi.Input['StorageMonitorConfigurationArgsDict']]
        """
...
class StorageConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 storage_monitor_configuration: Optional[pulumi.Input['StorageMonitorConfigurationArgs']] = None,
        ...
        :param pulumi.Input['StorageMonitorConfigurationArgs'] storage_monitor_configuration: The configuration for monitoring changes in the specified storage account.
    ...
    def storage_monitor_configuration(self) -> Optional[pulumi.Input['StorageMonitorConfigurationArgs']]:
        """
        The configuration for monitoring changes in the specified storage account.
        """
        return pulumi.get(self, "storage_monitor_configuration")

    @storage_monitor_configuration.setter
    def storage_monitor_configuration(self, value: Optional[pulumi.Input['StorageMonitorConfigurationArgs']]):
        pulumi.set(self, "storage_monitor_configuration", value)
...
if not MYPY:
    ...
    StorageMonitorConfigurationArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class StorageMonitorConfigurationArgs:
    def __init__(__self__, *,
                 event_subscription_name: Optional[pulumi.Input[str]] = None,
                 namespace_resource_id: Optional[pulumi.Input[str]] = None,
                 topic_name: Optional[pulumi.Input[str]] = None):
        """
        The configuration for monitoring changes in a connected storage.
        :param pulumi.Input[str] event_subscription_name: The name of the event subscription associated with the given namespace topic that contains storage events.
        :param pulumi.Input[str] namespace_resource_id: The resource id of the Azure Event Grid Namespace.
        :param pulumi.Input[str] topic_name: The name of the namespace topic within the specified namespace.
        """
    ...
    def namespace_resource_id(self) -> Optional[pulumi.Input[str]]:
        """
        The resource id of the Azure Event Grid Namespace.
        """
        return pulumi.get(self, "namespace_resource_id")

    @namespace_resource_id.setter
    def namespace_resource_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "namespace_resource_id", value)
