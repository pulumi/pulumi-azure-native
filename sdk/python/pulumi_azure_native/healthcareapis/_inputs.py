...
class AnalyticsConnectorDataLakeDataDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] data_lake_name: The name for the Data Lake.
        :param pulumi.Input[_builtins.str] type: Type of data destination.
               Expected value is 'datalake'.
        :param pulumi.Input[_builtins.str] name: Name of data destination.
        """
...
class AnalyticsConnectorFhirServiceDataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'FhirServiceVersion']] kind: The kind of FHIR Service.
        :param pulumi.Input[_builtins.str] type: Type of data source.
               Expected value is 'fhirservice'.
        :param pulumi.Input[_builtins.str] url: The URL of FHIR service.
        """
...
class AnalyticsConnectorFhirToParquetMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Type of data mapping.
               Expected value is 'fhirToParquet'.
        :param pulumi.Input[_builtins.str] extension_schema_reference: Artifact reference for extension schema.
        :param pulumi.Input[_builtins.str] filter_configuration_reference: Artifact reference for filter configurations.
        """
...
class CorsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_age: The max age to be allowed via CORS.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] methods: The methods to be allowed via CORS.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] origins: The origins to be allowed via CORS.
        """
...
class EncryptionArgsDict(TypedDict):
    ...
    """
    customer_managed_key_encryption: NotRequired[pulumi.Input[Optional['EncryptionCustomerManagedKeyEncryptionArgs']]]
    """
    The encryption settings for the customer-managed key
    """
...
class FhirServiceAcrConfigurationArgsDict(TypedDict):
    ...
    """
    oci_artifacts: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceOciArtifactEntryArgs']]]]]
    """
...
class FhirServiceAcrConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] login_servers: The list of the Azure container registry login servers.
...
class FhirServiceAuthenticationConfigurationArgsDict(TypedDict):
    ...
    """
    smart_identity_providers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SmartIdentityProviderConfigurationArgs']]]]]
    """
...
class FhirServiceImportConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: If the import operation is enabled.
        :param pulumi.Input[_builtins.bool] initial_import_mode: If the FHIR service is in InitialImportMode.
        :param pulumi.Input[_builtins.str] integration_data_store: The name of the default integration storage account.
        """
...
class ImplementationGuidesConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] us_core_missing_data: If US Core Missing Data requirement is enabled.
        """
...
class IotEventHubIngestionEndpointConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] consumer_group: Consumer group of the event hub to connected to.
        :param pulumi.Input[_builtins.str] event_hub_name: Event Hub name to connect to.
        :param pulumi.Input[_builtins.str] fully_qualified_event_hub_namespace: Fully qualified namespace of the Event Hub to connect to.
        """
...
class ResourceVersionPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'FhirResourceVersionPolicy']] default: The default value for tracking history across all resources.
        :param pulumi.Input[Mapping[str, pulumi.Input[Union[_builtins.str, 'FhirResourceVersionPolicy']]]] resource_type_overrides: A list of FHIR Resources and their version policy overrides.
        """
...
class ServiceAcrConfigurationInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] login_servers: The list of the ACR login servers.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceOciArtifactEntryArgs']]] oci_artifacts: The list of Open Container Initiative (OCI) artifacts.
        """
        if login_servers is not None:
            pulumi.set(__self__, "login_servers", login_servers)
...
class ServiceCosmosDbConfigurationInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cross_tenant_cmk_application_id: The multi-tenant application id used to enable CMK access for services in a data sovereign region.
        :param pulumi.Input[_builtins.str] key_vault_key_uri: The URI of the customer-managed key for the backing database.
        :param pulumi.Input[_builtins.int] offer_throughput: The provisioned throughput for the backing database.
        """
...
class ServiceManagedIdentityIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ServiceManagedIdentityType']] type: Type of identity being specified, currently SystemAssigned and None are allowed.
    ...
    @_builtins.property
    @pulumi.getter
    def type(self) -> pulumi.Input[Union[_builtins.str, 'ServiceManagedIdentityType']]:
        """
        Type of identity being specified, currently SystemAssigned and None are allowed.
        """
        return pulumi.get(self, "type")
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'ServiceManagedIdentityType']]):
        pulumi.set(self, "type", value)
...
class ServiceOciArtifactEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] digest: The artifact digest.
        :param pulumi.Input[_builtins.str] image_name: The artifact name.
        :param pulumi.Input[_builtins.str] login_server: The Azure Container Registry login server.
        """
...
class ServicesPropertiesArgsDict(TypedDict):
    ...
    """
    access_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceAccessPolicyEntryArgs']]]]]
    """
    The access policies of the service instance.
    """
    acr_configuration: NotRequired[pulumi.Input[Optional['ServiceAcrConfigurationInfoArgs']]]
    """
    The azure container registry settings used for convert data operation of the service instance.
    """
    authentication_configuration: NotRequired[pulumi.Input[Optional['ServiceAuthenticationConfigurationInfoArgs']]]
    """
    The authentication configuration for the service instance.
    """
    cors_configuration: NotRequired[pulumi.Input[Optional['ServiceCorsConfigurationInfoArgs']]]
    """
    The settings for the CORS configuration of the service instance.
    """
    cosmos_db_configuration: NotRequired[pulumi.Input[Optional['ServiceCosmosDbConfigurationInfoArgs']]]
    """
    The settings for the Cosmos DB database backing the service.
    """
    export_configuration: NotRequired[pulumi.Input[Optional['ServiceExportConfigurationInfoArgs']]]
    """
    The settings for the export operation of the service instance.
    """
    import_configuration: NotRequired[pulumi.Input[Optional['ServiceImportConfigurationInfoArgs']]]
    """
...
class SmartIdentityProviderApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'SmartDataActions']]]] allowed_data_actions: The actions that are permitted to be performed on FHIR resources for the application.
        :param pulumi.Input[_builtins.str] audience: The audience that will be used to validate bearer tokens against the given authority.
        :param pulumi.Input[_builtins.str] client_id: The application client id defined in the identity provider. This value will be used to validate bearer tokens against the given authority.
        """
...
class SmartIdentityProviderConfigurationArgsDict(TypedDict):
    ...
    """
    applications: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SmartIdentityProviderApplicationArgs']]]]]
    """
...
class SmartIdentityProviderConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authority: The identity provider token authority also known as the token issuing authority.
        """
...
class StorageConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_system_name: The filesystem name of connected storage account.
        :param pulumi.Input[_builtins.str] storage_resource_id: The resource id of connected storage account.
        """
