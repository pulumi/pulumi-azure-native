...
class AnalyticsConnectorDataLakeDataDestinationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Name of data destination.
        """
...
class AnalyticsConnectorFhirServiceDataSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str url: The URL of FHIR service.
        """
...
class AnalyticsConnectorFhirToParquetMappingResponse(dict):
    ...
    def __init__(__self__, *,
                 type: _builtins.str,
                 extension_schema_reference: Optional[_builtins.str] = None,
        ...
        :param _builtins.str filter_configuration_reference: Artifact reference for filter configurations.
        """
...
class FhirServiceAcrConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 login_servers: Optional[Sequence[_builtins.str]] = None,
...
class FhirServiceImportConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 initial_import_mode: Optional[_builtins.bool] = None,
...
class ServiceCosmosDbConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 cross_tenant_cmk_application_id: Optional[_builtins.str] = None,
...
class ServicesPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_endpoint_connections: Optional[Sequence['_commontypesv1.outputs.PrivateEndpointConnectionResponse']] = None,
        ...
        :param Sequence['_commontypesv1.PrivateEndpointConnectionResponse'] private_endpoint_connections: The list of private endpoint connections that are set up for this resource.
    ...
    def private_endpoint_connections(self) -> Optional[Sequence['_commontypesv1.outputs.PrivateEndpointConnectionResponse']]:
        """
...
class WorkspaceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 private_endpoint_connections: Sequence['_commontypesv1.outputs.PrivateEndpointConnectionResponse'],
                 provisioning_state: _builtins.str,
