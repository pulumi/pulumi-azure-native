...
class AnalyticsConnectorDataLakeDataDestinationResponse(dict):
    ...
    def __init__(__self__, *,
                 data_lake_name: builtins.str,
                 type: builtins.str,
                 name: Optional[builtins.str] = None):
        """
        The Data Lake data destination for Analytics Connector.
        :param builtins.str data_lake_name: The name for the Data Lake.
        :param builtins.str type: Type of data destination.
               Expected value is 'datalake'.
        :param builtins.str name: Name of data destination.
        """
    ...
    def data_lake_name(self) -> builtins.str:
        """
...
class AnalyticsConnectorFhirServiceDataSourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The FHIR service data source for Analytics Connector.
        :param builtins.str kind: The kind of FHIR Service.
        :param builtins.str type: Type of data source.
               Expected value is 'fhirservice'.
        :param builtins.str url: The URL of FHIR service.
        """
...
class AnalyticsConnectorFhirToParquetMappingResponse(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 extension_schema_reference: Optional[builtins.str] = None,
                 filter_configuration_reference: Optional[builtins.str] = None):
        """
        FHIR Service data mapping configuration for Analytics Connector.
        :param builtins.str type: Type of data mapping.
               Expected value is 'fhirToParquet'.
        :param builtins.str extension_schema_reference: Artifact reference for extension schema.
        :param builtins.str filter_configuration_reference: Artifact reference for filter configurations.
        """
    ...
    def extension_schema_reference(self) -> Optional[builtins.str]:
        """
    ...
    def filter_configuration_reference(self) -> Optional[builtins.str]:
        """
...
class CorsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_age: The max age to be allowed via CORS.
...
class DicomServiceAuthenticationConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Authentication configuration information
        :param Sequence[builtins.str] audiences: The audiences for the service
...
class EncryptionResponseCustomerManagedKeyEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The encryption settings for the customer-managed key
        :param builtins.str key_encryption_key_url: The URL of the key to use for encryption
        """
...
class FhirServiceAcrConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 login_servers: Optional[Sequence[builtins.str]] = None,
                 oci_artifacts: Optional[Sequence['outputs.ServiceOciArtifactEntryResponse']] = None):
        """
        Azure container registry configuration information
        :param Sequence[builtins.str] login_servers: The list of the Azure container registry login servers.
    ...
    def login_servers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FhirServiceImportConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 initial_import_mode: Optional[builtins.bool] = None,
                 integration_data_store: Optional[builtins.str] = None):
        """
        Import operation configuration information
        :param builtins.bool enabled: If the import operation is enabled.
        :param builtins.bool initial_import_mode: If the FHIR service is in InitialImportMode.
        :param builtins.str integration_data_store: The name of the default integration storage account.
        """
    ...
    def initial_import_mode(self) -> Optional[builtins.bool]:
        """
    ...
    def integration_data_store(self) -> Optional[builtins.str]:
        """
...
class ImplementationGuidesConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 us_core_missing_data: Optional[builtins.bool] = None):
        """
        The settings for Implementation Guides - defining capabilities for national standards, vendor consortiums, clinical societies, etc.
        :param builtins.bool us_core_missing_data: If US Core Missing Data requirement is enabled.
        """
    ...
    def us_core_missing_data(self) -> Optional[builtins.bool]:
        """
...
class IotEventHubIngestionEndpointConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fully_qualified_event_hub_namespace: Optional[builtins.str] = None):
        """
        Event Hub ingestion endpoint configuration
        :param builtins.str consumer_group: Consumer group of the event hub to connected to.
        :param builtins.str event_hub_name: Event Hub name to connect to.
        :param builtins.str fully_qualified_event_hub_namespace: Fully qualified namespace of the Event Hub to connect to.
        """
    ...
    def fully_qualified_event_hub_namespace(self) -> Optional[builtins.str]:
        """
...
class ResourceVersionPolicyConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_type_overrides: Optional[Mapping[str, builtins.str]] = None):
        """
        The settings for history tracking for FHIR resources.
        :param builtins.str default: The default value for tracking history across all resources.
        :param Mapping[str, builtins.str] resource_type_overrides: A list of FHIR Resources and their version policy overrides.
        """
    ...
    def resource_type_overrides(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ServiceAcrConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure container registry configuration information
        :param Sequence[builtins.str] login_servers: The list of the ACR login servers.
        :param Sequence['ServiceOciArtifactEntryResponse'] oci_artifacts: The list of Open Container Initiative (OCI) artifacts.
        """
        if login_servers is not None:
            pulumi.set(__self__, "login_servers", login_servers)
...
class ServiceCosmosDbConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 cross_tenant_cmk_application_id: Optional[builtins.str] = None,
                 key_vault_key_uri: Optional[builtins.str] = None,
                 offer_throughput: Optional[builtins.int] = None):
        """
        The settings for the Cosmos DB database backing the service.
        :param builtins.str cross_tenant_cmk_application_id: The multi-tenant application id used to enable CMK access for services in a data sovereign region.
        :param builtins.str key_vault_key_uri: The URI of the customer-managed key for the backing database.
        :param builtins.int offer_throughput: The provisioned throughput for the backing database.
        """
    ...
    def cross_tenant_cmk_application_id(self) -> Optional[builtins.str]:
        """
    ...
    def offer_throughput(self) -> Optional[builtins.int]:
        """
...
class ServiceOciArtifactEntryResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 login_server: Optional[builtins.str] = None):
        """
        An Open Container Initiative (OCI) artifact.
        :param builtins.str digest: The artifact digest.
        :param builtins.str image_name: The artifact name.
        :param builtins.str login_server: The Azure Container Registry login server.
        """
...
class SmartIdentityProviderApplicationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An Application configured in the Identity Provider used to access FHIR resources.
        :param Sequence[builtins.str] allowed_data_actions: The actions that are permitted to be performed on FHIR resources for the application.
        :param builtins.str audience: The audience that will be used to validate bearer tokens against the given authority.
        :param builtins.str client_id: The application client id defined in the identity provider. This value will be used to validate bearer tokens against the given authority.
        """
...
class SmartIdentityProviderConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str authority: The identity provider token authority also known as the token issuing authority.
        """
...
class StorageConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str storage_resource_id: The resource id of connected storage account.
        """
