...
def get_iot_connector_fhir_destination(fhir_destination_name: Optional[_builtins.str] = None,
                                       iot_connector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fhir_destination_name: The name of IoT Connector FHIR destination resource.
    :param _builtins.str iot_connector_name: The name of IoT Connector resource.
...
def get_iot_connector_fhir_destination_output(fhir_destination_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
