...
warnings.warn("""azure-native:healthcareapis/v20221001preview:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_connector is deprecated: azure-native:healthcareapis/v20221001preview:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.""")
    __args__ = dict()
