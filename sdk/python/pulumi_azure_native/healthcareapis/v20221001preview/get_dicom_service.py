...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dicom_service is deprecated: azure-native:healthcareapis/v20221001preview:DicomService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:DicomService to guarantee forwards compatibility.""")
    __args__ = dict()
