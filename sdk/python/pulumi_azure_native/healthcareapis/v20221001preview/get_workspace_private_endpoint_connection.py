...
warnings.warn("""azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workspace_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_private_endpoint_connection is deprecated: azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['privateEndpointConnectionName'] = private_endpoint_connection_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20221001preview:getWorkspacePrivateEndpointConnection', __args__, opts=opts, typ=GetWorkspacePrivateEndpointConnectionResult).value
