...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_connector is deprecated: azure-native:healthcareapis/v20220601:IotConnector is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:IotConnector to guarantee forwards compatibility.""")
    __args__ = dict()
