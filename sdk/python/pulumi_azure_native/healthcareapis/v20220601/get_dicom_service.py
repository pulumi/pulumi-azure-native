...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dicom_service is deprecated: azure-native:healthcareapis/v20220601:DicomService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:DicomService to guarantee forwards compatibility.""")
    __args__ = dict()
