...
def get_iot_connector_fhir_destination(fhir_destination_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_connector_fhir_destination is deprecated: azure-native:healthcareapis/v20220601:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnectorFhirDestination to guarantee forwards compatibility.""")
    __args__ = dict()
