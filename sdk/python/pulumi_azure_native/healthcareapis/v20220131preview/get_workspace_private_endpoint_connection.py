...
warnings.warn("""azure-native:healthcareapis/v20220131preview:WorkspacePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workspace_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_private_endpoint_connection is deprecated: azure-native:healthcareapis/v20220131preview:WorkspacePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
