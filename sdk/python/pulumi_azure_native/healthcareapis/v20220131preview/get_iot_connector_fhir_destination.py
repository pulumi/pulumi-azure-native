...
warnings.warn("""azure-native:healthcareapis/v20220131preview:IotConnectorFhirDestination is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnectorFhirDestination to guarantee forwards compatibility.""", DeprecationWarning)
