...
warnings.warn("""azure-native:healthcareapis/v20220131preview:FhirService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:FhirService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_fhir_service(fhir_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fhir_service is deprecated: azure-native:healthcareapis/v20220131preview:FhirService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:FhirService to guarantee forwards compatibility.""")
    __args__ = dict()
