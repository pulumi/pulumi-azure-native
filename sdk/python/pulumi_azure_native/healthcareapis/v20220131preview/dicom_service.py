...
warnings.warn("""azure-native:healthcareapis/v20220131preview:DicomService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:DicomService to guarantee forwards compatibility.""", DeprecationWarning)
...
class DicomService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DicomService is deprecated: azure-native:healthcareapis/v20220131preview:DicomService is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:DicomService to guarantee forwards compatibility.""")
