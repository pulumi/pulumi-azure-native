...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dicom_service is deprecated: azure-native:healthcareapis/v20220131preview:DicomService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20221201:DicomService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dicomServiceName'] = dicom_service_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20220131preview:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult).value
