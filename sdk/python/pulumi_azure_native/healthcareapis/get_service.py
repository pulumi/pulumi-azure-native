...
def get_service(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis:getService', __args__, opts=opts, typ=GetServiceResult)
