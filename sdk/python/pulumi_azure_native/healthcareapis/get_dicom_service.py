...
class GetDicomServiceResult:
    ...
    def enable_data_partitions(self) -> Optional[builtins.bool]:
        """
...
def get_dicom_service(dicom_service_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dicom_service_name: The name of DICOM Service resource.
...
def get_dicom_service_output(dicom_service_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult)
