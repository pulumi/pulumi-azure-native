...
def get_dicom_service(dicom_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dicom_service_name: The name of DICOM Service resource.
...
def get_dicom_service_output(dicom_service_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
