...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20240301:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20240301:getService', __args__, opts=opts, typ=GetServiceResult)
