...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis/v20180820preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20190916:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20200315:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20200330:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20210111:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20210601preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20211101:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220131preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220515:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220601:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20230228:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20230906:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20231101:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20231201:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20240331:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20250301preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:healthcareapis/v20240301:Service',
            resource_name,
            __props__,
            opts)
