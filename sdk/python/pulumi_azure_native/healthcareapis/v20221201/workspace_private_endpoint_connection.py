...
class WorkspacePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace_private_endpoint_connection = azure_native.healthcareapis.v20221201.WorkspacePrivateEndpointConnection("workspacePrivateEndpointConnection",
