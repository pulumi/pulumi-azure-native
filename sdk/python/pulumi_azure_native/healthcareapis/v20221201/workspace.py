...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace = azure_native.healthcareapis.v20221201.Workspace("workspace",
            location="westus",
        ...
        ```sh
        $ pulumi import azure-native:healthcareapis/v20221201:Workspace workspace1 /subscriptions/subid/resourceGroups/testRG/providers/Microsoft.HealthcareApis/workspaces/workspace1 
        ```
