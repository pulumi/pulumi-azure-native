...
def get_fhir_service(fhir_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fhir_service is deprecated: azure-native:healthcareapis/v20221201:FhirService is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:FhirService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['fhirServiceName'] = fhir_service_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20221201:getFhirService', __args__, opts=opts, typ=GetFhirServiceResult).value
