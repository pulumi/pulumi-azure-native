...
class FhirService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fhir_service = azure_native.healthcareapis.v20230228.FhirService("fhirService",
            access_policies=[
                {
            ...
            acr_configuration=azure_native.healthcareapis.v20230228.FhirServiceAcrConfigurationArgs(
                login_servers=["test1.azurecr.io"],
            ),
            authentication_configuration=azure_native.healthcareapis.v20230228.FhirServiceAuthenticationConfigurationArgs(
                audience="https://azurehealthcareapis.com",
                authority="https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
                smart_proxy_enabled=True,
            ),
            cors_configuration=azure_native.healthcareapis.v20230228.FhirServiceCorsConfigurationArgs(
            ...
            export_configuration=azure_native.healthcareapis.v20230228.FhirServiceExportConfigurationArgs(
                storage_account_name="existingStorageAccount",
            ),
            fhir_service_name="fhirservice1",
            identity=azure_native.healthcareapis.v20230228.ServiceManagedIdentityResponseIdentityArgs(
                type="SystemAssigned",
            ),
            implementation_guides_configuration=azure_native.healthcareapis.v20230228.ImplementationGuidesConfigurationArgs(
                us_core_missing_data=False,
            ),
            import_configuration=azure_native.healthcareapis.v20230228.FhirServiceImportConfigurationArgs(
                enabled=False,
