...
class FhirService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(acr_configuration, FhirServiceAcrConfigurationArgs):
            ...
            if not isinstance(authentication_configuration, FhirServiceAuthenticationConfigurationArgs):
            ...
            if not isinstance(cors_configuration, FhirServiceCorsConfigurationArgs):
            ...
            if not isinstance(export_configuration, FhirServiceExportConfigurationArgs):
            ...
            if not isinstance(implementation_guides_configuration, ImplementationGuidesConfigurationArgs):
            ...
            if not isinstance(import_configuration, FhirServiceImportConfigurationArgs):
            ...
            if not isinstance(resource_version_policy_configuration, ResourceVersionPolicyConfigurationArgs):
