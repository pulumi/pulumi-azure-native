...
class DicomServiceArgs:
    ...
    def _configure(
        ...
        if 'dicomServiceName' in kwargs:
            dicom_service_name = kwargs['dicomServiceName']
        ...
        if dicom_service_name is not None:
            _setter("dicom_service_name", dicom_service_name)
...
class DicomService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cors_configuration is not None and not isinstance(cors_configuration, CorsConfigurationArgs):
                cors_configuration = cors_configuration or {}
                def _setter(key, value):
                    cors_configuration[key] = value
                CorsConfigurationArgs._configure(_setter, **cors_configuration)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20210601preview:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20211101:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20220131preview:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20220515:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20220601:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:DicomService"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:DicomService")])
