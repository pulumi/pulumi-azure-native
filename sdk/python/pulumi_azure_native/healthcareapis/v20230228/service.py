...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service = azure_native.healthcareapis.v20230228.Service("service",
            identity=azure_native.healthcareapis.v20230228.ServicesResourceIdentityArgs(
                type="SystemAssigned",
            ),
            kind=azure_native.healthcareapis/v20230228.Kind.FHIR_R4,
            location="westus2",
            properties=azure_native.healthcareapis.v20230228.ServicesPropertiesResponseArgs(
                access_policies=[
                    azure_native.healthcareapis.v20230228.ServiceAccessPolicyEntryArgs(
                ...
                authentication_configuration=azure_native.healthcareapis.v20230228.ServiceAuthenticationConfigurationInfoArgs(
                    audience="https://azurehealthcareapis.com",
                    authority="https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
                    smart_proxy_enabled=True,
                ),
                cors_configuration=azure_native.healthcareapis.v20230228.ServiceCorsConfigurationInfoArgs(
                ...
                cosmos_db_configuration=azure_native.healthcareapis.v20230228.ServiceCosmosDbConfigurationInfoArgs(
                    key_vault_key_uri="https://my-vault.vault.azure.net/keys/my-key",
                    offer_throughput=1000,
                ),
                export_configuration=azure_native.healthcareapis.v20230228.ServiceExportConfigurationInfoArgs(
        ...
        service = azure_native.healthcareapis.v20230228.Service("service",
            kind=azure_native.healthcareapis/v20230228.Kind.FHIR_R4,
            location="westus2",
            properties=azure_native.healthcareapis.v20230228.ServicesPropertiesArgs(
                access_policies=[azure_native.healthcareapis.v20230228.ServiceAccessPolicyEntryArgs(
                    object_id="c487e7d1-3210-41a3-8ccc-e9372b78da47",
                )],
            ),
            resource_group_name="rg1",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20180820preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20190916:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20200315:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20200330:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20210111:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20210601preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20211101:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220131preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220515:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20220601:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:Service"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:healthcareapis/v20230228:Service',
            resource_name,
            __props__,
            opts)
