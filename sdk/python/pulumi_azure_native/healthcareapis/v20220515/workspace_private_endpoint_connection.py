...
class WorkspacePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace_private_endpoint_connection = azure_native.healthcareapis.v20220515.WorkspacePrivateEndpointConnection("workspacePrivateEndpointConnection",
            private_endpoint_connection_name="myConnection",
            private_link_service_connection_state=azure_native.healthcareapis.v20220515.PrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20211101:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20220131preview:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20220601:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20230228:WorkspacePrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspacePrivateEndpointConnection, __self__).__init__(
            'azure-native:healthcareapis/v20220515:WorkspacePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
