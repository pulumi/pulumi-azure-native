...
class WorkspacePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:WorkspacePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthcareapis/v20230228:WorkspacePrivateEndpointConnection")])
