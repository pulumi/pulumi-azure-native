...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_connector is deprecated: azure-native:healthcareapis/v20220515:IotConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:healthcareapis/v20230228:IotConnector to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['iotConnectorName'] = iot_connector_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20220515:getIotConnector', __args__, opts=opts, typ=GetIotConnectorResult).value
