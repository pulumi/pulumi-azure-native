...
class IotConnectorFhirDestination(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_connector_fhir_destination = azure_native.healthcareapis.v20220515.IotConnectorFhirDestination("iotConnectorFhirDestination",
            fhir_destination_name="dest1",
            fhir_mapping=azure_native.healthcareapis.v20220515.IotMappingPropertiesArgs(
                content={
                    "template": [{
                        "template": {
                            "codes": [{
