...
class FhirService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fhir_service = azure_native.healthcareapis.v20220515.FhirService("fhirService",
            access_policies=[
                {
            ...
            acr_configuration=azure_native.healthcareapis.v20220515.FhirServiceAcrConfigurationArgs(
                login_servers=["test1.azurecr.io"],
            ),
            authentication_configuration=azure_native.healthcareapis.v20220515.FhirServiceAuthenticationConfigurationArgs(
                audience="https://azurehealthcareapis.com",
                authority="https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
                smart_proxy_enabled=True,
            ),
            cors_configuration=azure_native.healthcareapis.v20220515.FhirServiceCorsConfigurationArgs(
            ...
            export_configuration=azure_native.healthcareapis.v20220515.FhirServiceExportConfigurationArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20210601preview:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20211101:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20220131preview:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20220601:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20221201:FhirService"), pulumi.Alias(type_="azure-native:healthcareapis/v20230228:FhirService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FhirService, __self__).__init__(
            'azure-native:healthcareapis/v20220515:FhirService',
            resource_name,
            __props__,
            opts)
