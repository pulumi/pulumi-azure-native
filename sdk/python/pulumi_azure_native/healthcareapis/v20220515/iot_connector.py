...
class IotConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        iot_connector = azure_native.healthcareapis.v20220515.IotConnector("iotConnector",
            device_mapping=azure_native.healthcareapis.v20220515.IotMappingPropertiesArgs(
                content={
                    "template": [{
                        "template": {
            ...
            identity=azure_native.healthcareapis.v20220515.ServiceManagedIdentityResponseIdentityArgs(
                type="SystemAssigned",
            ),
            ingestion_endpoint_configuration=azure_native.healthcareapis.v20220515.IotEventHubIngestionEndpointConfigurationArgs(
        ...
        ```sh
        $ pulumi import azure-native:healthcareapis/v20220515:IotConnector blue /subscriptions/subid/resourceGroups/testRG/providers/Microsoft.HealthcareApis/workspaces/workspace1/iotconnectors/blue 
        ```
