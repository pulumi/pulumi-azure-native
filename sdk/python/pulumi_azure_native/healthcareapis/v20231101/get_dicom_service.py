...
class GetDicomServiceResult:
    ...
    """
    def __init__(__self__, authentication_configuration=None, cors_configuration=None, encryption=None, etag=None, event_state=None, id=None, identity=None, location=None, name=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, service_url=None, system_data=None, tags=None, type=None):
...
def get_dicom_service(dicom_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:healthcareapis/v20231101:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult).value
...
def get_dicom_service_output(dicom_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:healthcareapis/v20231101:getDicomService', __args__, opts=opts, typ=GetDicomServiceResult)
