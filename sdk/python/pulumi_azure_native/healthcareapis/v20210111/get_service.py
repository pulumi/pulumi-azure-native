...
warnings.warn("""Version v20210111 will be removed in the next major version of the provider. Upgrade to version v20220515 or later.""", DeprecationWarning)
...
def get_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20210111 will be removed in the next major version of the provider. Upgrade to version v20220515 or later.""")
    __args__ = dict()
