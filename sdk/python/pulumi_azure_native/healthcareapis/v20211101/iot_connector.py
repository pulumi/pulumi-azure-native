...
warnings.warn("""azure-native:healthcareapis/v20211101:IotConnector is being removed in the next major version of this provider. Please upgrade to azure-native:healthcareapis/v20221201:IotConnector to guarantee forwards compatibility.""", DeprecationWarning)
