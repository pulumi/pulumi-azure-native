...
def get_iot_connector(iot_connector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_connector is deprecated: Version v20211101 will be removed in the next major version of the provider. Upgrade to version v20220515 or later.""")
    __args__ = dict()
