...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis:Workspace"), pulumi.Alias(type_="azure-native:healthcareapis/v20210601preview:Workspace")])
