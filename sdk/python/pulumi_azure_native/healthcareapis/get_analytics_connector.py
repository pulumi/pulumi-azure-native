...
def get_analytics_connector(analytics_connector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str analytics_connector_name: The name of Analytics Connector resource.
...
def get_analytics_connector_output(analytics_connector_name: Optional[pulumi.Input[builtins.str]] = None,
