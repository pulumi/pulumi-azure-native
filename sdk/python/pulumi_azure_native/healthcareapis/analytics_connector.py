...
class AnalyticsConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthcareapis/v20221001preview:AnalyticsConnector"), pulumi.Alias(type_="azure-native_healthcareapis_v20221001preview:healthcareapis:AnalyticsConnector")])
