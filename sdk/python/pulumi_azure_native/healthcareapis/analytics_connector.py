...
class AnalyticsConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(data_destination_configuration, AnalyticsConnectorDataLakeDataDestinationArgs):
            ...
            if not isinstance(data_mapping_configuration, AnalyticsConnectorFhirToParquetMappingArgs):
            ...
            if not isinstance(data_source_configuration, AnalyticsConnectorFhirServiceDataSourceArgs):
