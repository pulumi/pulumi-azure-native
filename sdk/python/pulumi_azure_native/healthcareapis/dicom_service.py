...
class DicomServiceArgs:
    def __init__(__self__, *,
                 ...
                 dicom_service_name: Optional[pulumi.Input[builtins.str]] = None,
                 enable_data_partitions: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dicom_service_name: The name of DICOM Service resource.
        :param pulumi.Input[builtins.bool] enable_data_partitions: If data partitions is enabled or not.
    ...
    def dicom_service_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dicom_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dicom_service_name", value)

    @property
    @pulumi.getter(name="enableDataPartitions")
    def enable_data_partitions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_data_partitions(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DicomService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableDataPartitions")
    def enable_data_partitions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If data partitions is enabled or not.
        """
        return pulumi.get(self, "enable_data_partitions")
