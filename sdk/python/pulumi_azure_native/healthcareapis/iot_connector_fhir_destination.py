...
class IotConnectorFhirDestinationArgs:
    def __init__(__self__, *,
                 ...
                 fhir_service_resource_id: pulumi.Input[builtins.str],
                 iot_connector_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 resource_identity_resolution_type: pulumi.Input[Union[builtins.str, 'IotIdentityResolutionType']],
                 workspace_name: pulumi.Input[builtins.str],
                 fhir_destination_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] fhir_service_resource_id: Fully qualified resource id of the FHIR service to connect to.
        ...
        :param pulumi.Input[Union[builtins.str, 'IotIdentityResolutionType']] resource_identity_resolution_type: Determines how resource identity is resolved on the destination.
        :param pulumi.Input[builtins.str] workspace_name: The name of workspace resource.
        :param pulumi.Input[builtins.str] fhir_destination_name: The name of IoT Connector FHIR destination resource.
    ...
    def fhir_service_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fhir_service_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "fhir_service_resource_id", value)

    @property
    @pulumi.getter(name="iotConnectorName")
    def iot_connector_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def iot_connector_name(self, value: pulumi.Input[builtins.str]):
    ...
    def resource_identity_resolution_type(self) -> pulumi.Input[Union[builtins.str, 'IotIdentityResolutionType']]:
        """
    ...
    def resource_identity_resolution_type(self, value: pulumi.Input[Union[builtins.str, 'IotIdentityResolutionType']]):
    ...
    def fhir_destination_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fhir_destination_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:healthcareapis:IotConnectorFhirDestination")
class IotConnectorFhirDestination(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 fhir_service_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 iot_connector_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_identity_resolution_type: Optional[pulumi.Input[Union[builtins.str, 'IotIdentityResolutionType']]] = None,
    ...
    @property
    @pulumi.getter(name="fhirServiceResourceId")
    def fhir_service_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Fully qualified resource id of the FHIR service to connect to.
        """
        return pulumi.get(self, "fhir_service_resource_id")
    ...
    @property
    @pulumi.getter(name="resourceIdentityResolutionType")
    def resource_identity_resolution_type(self) -> pulumi.Output[builtins.str]:
        """
        Determines how resource identity is resolved on the destination.
        """
        return pulumi.get(self, "resource_identity_resolution_type")
