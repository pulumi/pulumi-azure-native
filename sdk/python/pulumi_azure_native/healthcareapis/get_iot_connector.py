...
def get_iot_connector(iot_connector_name: Optional[builtins.str] = None,
...
def get_iot_connector_output(iot_connector_name: Optional[pulumi.Input[builtins.str]] = None,
