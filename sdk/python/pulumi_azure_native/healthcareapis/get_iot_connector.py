...
def get_iot_connector(iot_connector_name: Optional[_builtins.str] = None,
...
def get_iot_connector_output(iot_connector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
