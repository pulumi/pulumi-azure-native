...
class Account(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:engagementfabric/v20180901preview:Account"), pulumi.Alias(type_="azure-nextgen:engagementfabric/v20180901preview:Account")])
