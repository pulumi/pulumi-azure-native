...
class GetAccountResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, sku=None, tags=None, type=None):
...
def get_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:engagementfabric:getAccount', __args__, opts=opts, typ=GetAccountResult)
