...
def get_tenant_action_group(management_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20230501preview:getTenantActionGroup', __args__, opts=opts, typ=GetTenantActionGroupResult).value
...
def get_tenant_action_group_output(management_group_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20230501preview:getTenantActionGroup', __args__, opts=opts, typ=GetTenantActionGroupResult)
