...
class DataCollectionEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'KnownDataCollectionEndpointResourceKind']] kind: The kind of the resource.
