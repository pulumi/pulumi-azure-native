...
def get_data_collection_rule_association(association_name: Optional[_builtins.str] = None,
...
def get_data_collection_rule_association_output(association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
