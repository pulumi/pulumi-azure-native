...
def get_management_group_diagnostic_setting(management_group_id: Optional[builtins.str] = None,
...
def get_management_group_diagnostic_setting_output(management_group_id: Optional[pulumi.Input[builtins.str]] = None,
