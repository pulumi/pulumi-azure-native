...
def get_issue_output(azure_monitor_workspace_name: pulumi.Input[Optional[_builtins.str]] = None,
                     issue_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
