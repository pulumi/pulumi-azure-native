...
class GuestDiagnosticsSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20180601preview:GuestDiagnosticsSetting"), pulumi.Alias(type_="azure-native:insights:GuestDiagnosticsSetting"), pulumi.Alias(type_="azure-native:monitor:GuestDiagnosticsSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestDiagnosticsSetting, __self__).__init__(
            'azure-native:monitor/v20180601preview:GuestDiagnosticsSetting',
            resource_name,
            __props__,
            opts)
