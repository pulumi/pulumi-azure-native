...
def get_guest_diagnostics_setting(diagnostic_settings_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getGuestDiagnosticsSetting', __args__, opts=opts, typ=GetGuestDiagnosticsSettingResult).value
...
def get_guest_diagnostics_setting_output(diagnostic_settings_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getGuestDiagnosticsSetting', __args__, opts=opts, typ=GetGuestDiagnosticsSettingResult)
