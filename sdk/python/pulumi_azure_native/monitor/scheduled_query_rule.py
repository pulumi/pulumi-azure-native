...
class ScheduledQueryRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] auto_mitigate: The flag that indicates whether the alert should be automatically resolved or not. The default is true. Relevant only for rules of the kind LogAlert.
