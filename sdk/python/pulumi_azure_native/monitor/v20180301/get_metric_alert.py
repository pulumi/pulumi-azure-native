...
def get_metric_alert(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20180301:getMetricAlert', __args__, opts=opts, typ=GetMetricAlertResult).value
...
def get_metric_alert_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20180301:getMetricAlert', __args__, opts=opts, typ=GetMetricAlertResult)
