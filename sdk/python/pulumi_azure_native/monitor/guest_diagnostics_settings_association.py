...
class GuestDiagnosticsSettingsAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20180601preview:GuestDiagnosticsSettingsAssociation"), pulumi.Alias(type_="azure-native:insights:GuestDiagnosticsSettingsAssociation"), pulumi.Alias(type_="azure-native:monitor/v20180601preview:GuestDiagnosticsSettingsAssociation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestDiagnosticsSettingsAssociation, __self__).__init__(
            'azure-native:monitor:GuestDiagnosticsSettingsAssociation',
            resource_name,
            __props__,
            opts)
