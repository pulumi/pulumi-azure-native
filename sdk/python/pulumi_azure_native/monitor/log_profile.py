...
class LogProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20160301:LogProfile"), pulumi.Alias(type_="azure-native:insights:LogProfile"), pulumi.Alias(type_="azure-native:monitor/v20160301:LogProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LogProfile, __self__).__init__(
            'azure-native:monitor:LogProfile',
            resource_name,
            __props__,
            opts)
