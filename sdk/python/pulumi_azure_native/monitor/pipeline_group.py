...
class PipelineGroupArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['PipelineGroupPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['PipelineGroupPropertiesArgs']]):
...
class PipelineGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 pipeline_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['PipelineGroupPropertiesArgs', 'PipelineGroupPropertiesArgsDict']]] = None,
