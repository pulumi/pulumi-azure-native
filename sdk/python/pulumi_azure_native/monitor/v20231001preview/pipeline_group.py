...
class PipelineGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:monitor/v20241001preview:PipelineGroup"), pulumi.Alias(type_="azure-native:monitor:PipelineGroup")])
