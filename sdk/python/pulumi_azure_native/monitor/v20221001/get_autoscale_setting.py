...
def get_autoscale_setting(autoscale_setting_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20221001:getAutoscaleSetting', __args__, opts=opts, typ=GetAutoscaleSettingResult).value
...
def get_autoscale_setting_output(autoscale_setting_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20221001:getAutoscaleSetting', __args__, opts=opts, typ=GetAutoscaleSettingResult)
