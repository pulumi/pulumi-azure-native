...
class AzureMonitorWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:monitor:AzureMonitorWorkspace"), pulumi.Alias(type_="azure-native:monitor/v20230403:AzureMonitorWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureMonitorWorkspace, __self__).__init__(
            'azure-native:monitor/v20210603preview:AzureMonitorWorkspace',
            resource_name,
            __props__,
            opts)
