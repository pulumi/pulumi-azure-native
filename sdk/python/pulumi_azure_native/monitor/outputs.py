...
class AzureMonitorWorkspaceResponseDefaultIngestionSettings(dict):
    ...
    def _configure(
             ...
             data_collection_endpoint_resource_id: Optional[str] = None,
             data_collection_rule_resource_id: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if data_collection_endpoint_resource_id is None and 'dataCollectionEndpointResourceId' in kwargs:
            data_collection_endpoint_resource_id = kwargs['dataCollectionEndpointResourceId']
        if data_collection_endpoint_resource_id is None:
            raise TypeError("Missing 'data_collection_endpoint_resource_id' argument")
        if data_collection_rule_resource_id is None and 'dataCollectionRuleResourceId' in kwargs:
            data_collection_rule_resource_id = kwargs['dataCollectionRuleResourceId']
        if data_collection_rule_resource_id is None:
            raise TypeError("Missing 'data_collection_rule_resource_id' argument")
...
class AzureMonitorWorkspaceResponseMetrics(dict):
    ...
    def _configure(
        ...
        if prometheus_query_endpoint is None and 'prometheusQueryEndpoint' in kwargs:
            prometheus_query_endpoint = kwargs['prometheusQueryEndpoint']
        if prometheus_query_endpoint is None:
            raise TypeError("Missing 'prometheus_query_endpoint' argument")
