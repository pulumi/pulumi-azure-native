...
class IngestionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Settings for data ingestion
        :param builtins.str data_collection_endpoint_resource_id: The Azure resource Id of the default data collection endpoint for this workspace.
        :param builtins.str data_collection_rule_resource_id: The Azure resource Id of the default data collection rule for this workspace.
        """
...
class MetricsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str prometheus_query_endpoint: The Prometheus query endpoint for the workspace
        """
