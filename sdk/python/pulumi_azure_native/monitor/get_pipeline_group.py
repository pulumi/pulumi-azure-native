...
def get_pipeline_group(pipeline_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pipeline_group_name: The name of pipeline group. The name is case insensitive.
...
def get_pipeline_group_output(pipeline_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
