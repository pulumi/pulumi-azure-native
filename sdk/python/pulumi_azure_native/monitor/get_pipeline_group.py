...
def get_pipeline_group(pipeline_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_group_name: The name of pipeline group. The name is case insensitive.
...
def get_pipeline_group_output(pipeline_group_name: Optional[pulumi.Input[builtins.str]] = None,
