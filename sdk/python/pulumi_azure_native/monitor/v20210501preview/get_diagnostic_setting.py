...
def get_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20210501preview:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult).value
...
def get_diagnostic_setting_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20210501preview:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult)
