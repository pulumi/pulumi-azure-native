...
def get_subscription_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20210501preview:getSubscriptionDiagnosticSetting', __args__, opts=opts, typ=GetSubscriptionDiagnosticSettingResult).value
...
def get_subscription_diagnostic_setting_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20210501preview:getSubscriptionDiagnosticSetting', __args__, opts=opts, typ=GetSubscriptionDiagnosticSettingResult)
