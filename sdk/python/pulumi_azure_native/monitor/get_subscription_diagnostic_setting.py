...
def get_subscription_diagnostic_setting(name: Optional[_builtins.str] = None,
...
def get_subscription_diagnostic_setting_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
