...
def get_azure_monitor_workspace(azure_monitor_workspace_name: Optional[_builtins.str] = None,
...
def get_azure_monitor_workspace_output(azure_monitor_workspace_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
