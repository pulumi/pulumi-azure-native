...
def get_guest_diagnostics_settings_association(association_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getGuestDiagnosticsSettingsAssociation', __args__, opts=opts, typ=GetGuestDiagnosticsSettingsAssociationResult).value
...
def get_guest_diagnostics_settings_association_output(association_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getGuestDiagnosticsSettingsAssociation', __args__, opts=opts, typ=GetGuestDiagnosticsSettingsAssociationResult)
