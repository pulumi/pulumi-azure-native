...
class DiscoveryRuleArgs:
    def __init__(__self__, *,
                 ...
                 discovery_rule_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[Union['ApplicationInsightsTopologyDiscoveryRulePropertiesArgs', 'ResourceGraphQueryDiscoveryRulePropertiesArgs']] properties: The resource-specific properties for this resource.
        """
    ...
    def discovery_rule_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def discovery_rule_name(self, value: pulumi.Input[_builtins.str]):
...
class DiscoveryRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] discovery_rule_name: Name of the discovery rule. Must be unique within a health model.
        :param pulumi.Input[_builtins.str] health_model_name: Name of health model resource
        :param pulumi.Input[Union[Union['ApplicationInsightsTopologyDiscoveryRulePropertiesArgs', 'ApplicationInsightsTopologyDiscoveryRulePropertiesArgsDict'], Union['ResourceGraphQueryDiscoveryRulePropertiesArgs', 'ResourceGraphQueryDiscoveryRulePropertiesArgsDict']]] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if discovery_rule_name is None and not opts.urn:
                raise TypeError("Missing required property 'discovery_rule_name'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:monitor/v20250503preview:DiscoveryRule")])
