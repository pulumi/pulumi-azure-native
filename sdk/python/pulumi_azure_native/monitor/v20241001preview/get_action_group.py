...
def get_action_group(action_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20241001preview:getActionGroup', __args__, opts=opts, typ=GetActionGroupResult).value
...
def get_action_group_output(action_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20241001preview:getActionGroup', __args__, opts=opts, typ=GetActionGroupResult)
