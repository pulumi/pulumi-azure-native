...
def get_log_profile(log_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getLogProfile', __args__, opts=opts, typ=GetLogProfileResult).value
...
def get_log_profile_output(log_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getLogProfile', __args__, opts=opts, typ=GetLogProfileResult)
