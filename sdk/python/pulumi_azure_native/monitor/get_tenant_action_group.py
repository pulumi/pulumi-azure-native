...
def get_tenant_action_group(management_group_id: Optional[builtins.str] = None,
                            tenant_action_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str management_group_id: The management group id.
    :param builtins.str tenant_action_group_name: The name of the action group.
    """
    __args__ = dict()
    __args__['managementGroupId'] = management_group_id
    __args__['tenantActionGroupName'] = tenant_action_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getTenantActionGroup', __args__, opts=opts, typ=GetTenantActionGroupResult).value
...
def get_tenant_action_group_output(management_group_id: Optional[pulumi.Input[builtins.str]] = None,
                                   tenant_action_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getTenantActionGroup', __args__, opts=opts, typ=GetTenantActionGroupResult)
