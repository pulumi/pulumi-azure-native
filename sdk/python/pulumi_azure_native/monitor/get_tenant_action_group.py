...
class GetTenantActionGroupResult:
    ...
    def webhook_receivers(self) -> Optional[Sequence['outputs.WebhookReceiverTenantActionGroupResponse']]:
        """
...
def get_tenant_action_group(management_group_id: Optional[_builtins.str] = None,
                            tenant_action_group_name: Optional[_builtins.str] = None,
