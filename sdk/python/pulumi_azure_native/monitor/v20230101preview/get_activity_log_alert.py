...
def get_activity_log_alert(activity_log_alert_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20230101preview:getActivityLogAlert', __args__, opts=opts, typ=GetActivityLogAlertResult).value
...
def get_activity_log_alert_output(activity_log_alert_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20230101preview:getActivityLogAlert', __args__, opts=opts, typ=GetActivityLogAlertResult)
