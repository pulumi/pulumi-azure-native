...
class MetricAlertArgs:
    ...
    def target_resource_region(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def target_resource_region(self, value: pulumi.Input[Optional[_builtins.str]]):
