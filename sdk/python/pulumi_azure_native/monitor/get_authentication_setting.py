...
def get_authentication_setting(authentication_setting_name: Optional[_builtins.str] = None,
                               azure_monitor_workspace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str authentication_setting_name: Name of the authentication setting. Must be unique within a health model.
    ...
    """
    __args__ = dict()
    __args__['authenticationSettingName'] = authentication_setting_name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getAuthenticationSetting', __args__, opts=opts, typ=GetAuthenticationSettingResult).value
...
def get_authentication_setting_output(authentication_setting_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getAuthenticationSetting', __args__, opts=opts, typ=GetAuthenticationSettingResult)
