...
def get_authentication_setting(authentication_setting_name: Optional[builtins.str] = None,
                               azure_monitor_workspace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str authentication_setting_name: Name of the authentication setting. Must be unique within a health model.
...
def get_authentication_setting_output(authentication_setting_name: Optional[pulumi.Input[builtins.str]] = None,
