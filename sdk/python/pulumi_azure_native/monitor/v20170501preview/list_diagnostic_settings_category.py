...
def list_diagnostic_settings_category(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20170501preview:listDiagnosticSettingsCategory', __args__, opts=opts, typ=ListDiagnosticSettingsCategoryResult).value
...
def list_diagnostic_settings_category_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20170501preview:listDiagnosticSettingsCategory', __args__, opts=opts, typ=ListDiagnosticSettingsCategoryResult)
