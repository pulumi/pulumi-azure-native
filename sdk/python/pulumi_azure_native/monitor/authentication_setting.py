...
class AuthenticationSettingArgs:
    def __init__(__self__, *,
                 ...
                 authentication_setting_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] authentication_setting_name: Name of the authentication setting. Must be unique within a health model.
    ...
    def authentication_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authentication_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ManagedIdentityAuthenticationSettingPropertiesArgs']]):
...
class AuthenticationSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['ManagedIdentityAuthenticationSettingPropertiesArgs', 'ManagedIdentityAuthenticationSettingPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[builtins.str] azure_monitor_workspace_name: The name of the Azure Monitor Workspace. The name is case insensitive
        :param pulumi.Input[builtins.str] health_model_name: Name of health model resource
        :param pulumi.Input[Union['ManagedIdentityAuthenticationSettingPropertiesArgs', 'ManagedIdentityAuthenticationSettingPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:monitor/v20250503preview:AuthenticationSetting")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AuthenticationSetting':
        """
