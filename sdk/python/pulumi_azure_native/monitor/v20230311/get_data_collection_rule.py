...
def get_data_collection_rule(data_collection_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20230311:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult).value
...
def get_data_collection_rule_output(data_collection_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20230311:getDataCollectionRule', __args__, opts=opts, typ=GetDataCollectionRuleResult)
