...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 access_mode_settings: pulumi.Input[Optional[Union['AccessModeSettingsArgs', 'AccessModeSettingsArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def private_endpoint_connections(self) -> pulumi.Output[Sequence['outputs.PrivateEndpointConnectionPrivateLinkScopeResponse']]:
        """
