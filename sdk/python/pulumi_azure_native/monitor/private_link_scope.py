...
class PrivateLinkScopeArgs:
    ...
    def scope_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @scope_name.setter
    def scope_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:monitor:PrivateLinkScope"
