...
def get_data_collection_endpoint(data_collection_endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_collection_endpoint_name: The name of the data collection endpoint. The name is case insensitive.
...
def get_data_collection_endpoint_output(data_collection_endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
