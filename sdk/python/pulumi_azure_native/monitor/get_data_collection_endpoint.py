...
class GetDataCollectionEndpointResult:
    ...
    def immutable_id(self) -> Optional[builtins.str]:
        """
...
def get_data_collection_endpoint(data_collection_endpoint_name: Optional[builtins.str] = None,
...
def get_data_collection_endpoint_output(data_collection_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
