...
class AzureMonitorWorkspaceArgs:
    def __init__(__self__, *,
        ...
        """
        AzureMonitorWorkspaceArgs._configure(
    ...
    def _configure(
        ...
        if azure_monitor_workspace_name is None and 'azureMonitorWorkspaceName' in kwargs:
            azure_monitor_workspace_name = kwargs['azureMonitorWorkspaceName']

        _setter("resource_group_name", resource_group_name)
        if azure_monitor_workspace_name is not None:
            _setter("azure_monitor_workspace_name", azure_monitor_workspace_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AzureMonitorWorkspaceArgs._configure(_setter, **kwargs)
