...
class ActivityLogAlertArgs:
    def __init__(__self__, *,
                 ...
                 activity_log_alert_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: A list of resource IDs that will be used as prefixes. The alert will only apply to Activity Log events with resource IDs that fall under one of these prefixes. This list must include at least one item.
        :param pulumi.Input[builtins.str] activity_log_alert_name: The name of the Activity Log Alert rule.
        :param pulumi.Input[builtins.str] description: A description of this Activity Log Alert rule.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether this Activity Log Alert rule is enabled. If an Activity Log Alert rule is not enabled, then none of its actions will be activated.
        :param pulumi.Input[builtins.str] location: The location of the resource. Azure Activity Log Alert rules are supported on Global, West Europe and North Europe regions.
    ...
    def activity_log_alert_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def activity_log_alert_name(self, value: Optional[pulumi.Input[builtins.str]]):
