...
def list_issue_resources(azure_monitor_workspace_name: Optional[builtins.str] = None,
...
def list_issue_resources_output(azure_monitor_workspace_name: Optional[pulumi.Input[builtins.str]] = None,
