...
def list_issue_alerts(azure_monitor_workspace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str azure_monitor_workspace_name: The name of the AzureMonitorWorkspaceResource
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:listIssueAlerts', __args__, opts=opts, typ=ListIssueAlertsResult).value

    return AwaitableListIssueAlertsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_issue_alerts_output(azure_monitor_workspace_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:listIssueAlerts', __args__, opts=opts, typ=ListIssueAlertsResult)
