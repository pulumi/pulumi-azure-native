...
def list_issue_alerts(azure_monitor_workspace_name: Optional[builtins.str] = None,
...
def list_issue_alerts_output(azure_monitor_workspace_name: Optional[pulumi.Input[builtins.str]] = None,
