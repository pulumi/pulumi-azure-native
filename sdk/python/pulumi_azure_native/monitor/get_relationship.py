...
def get_relationship(azure_monitor_workspace_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getRelationship', __args__, opts=opts, typ=GetRelationshipResult).value
...
def get_relationship_output(azure_monitor_workspace_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getRelationship', __args__, opts=opts, typ=GetRelationshipResult)
