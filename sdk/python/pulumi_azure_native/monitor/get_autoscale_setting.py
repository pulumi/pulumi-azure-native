...
def get_autoscale_setting(autoscale_setting_name: Optional[_builtins.str] = None,
...
def get_autoscale_setting_output(autoscale_setting_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
