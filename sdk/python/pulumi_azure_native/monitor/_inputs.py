...
class ConditionArgs:
    def __init__(__self__, *,
        ...
        """
        A condition of the scheduled query rule.
        :param pulumi.Input[_builtins.str] alert_sensitivity: The extent of deviation required to trigger an alert. Allowed values are 'Low', 'Medium' and 'High'. This will affect how tight the threshold is to the metric series pattern. Relevant and required only for dynamic threshold rules of the kind LogAlert.
