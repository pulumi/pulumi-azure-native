...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20191017preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20210701preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20210901:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights/v20230601preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:insights:PrivateLinkScope"), pulumi.Alias(type_="azure-native:monitor/v20210701preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:monitor/v20210901:PrivateLinkScope"), pulumi.Alias(type_="azure-native:monitor/v20230601preview:PrivateLinkScope"), pulumi.Alias(type_="azure-native:monitor:PrivateLinkScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkScope, __self__).__init__(
            'azure-native:monitor/v20191017preview:PrivateLinkScope',
            resource_name,
            __props__,
            opts)
