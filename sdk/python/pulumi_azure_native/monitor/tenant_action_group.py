...
class TenantActionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Indicates whether this tenant action group is enabled. If a tenant action group is not enabled, then none of its receivers will receive communications.
        ...
        :param pulumi.Input[builtins.str] tenant_action_group_name: The name of the action group.
    ...
    def tenant_action_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tenant_action_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TenantActionGroup(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:monitor:TenantActionGroup"
