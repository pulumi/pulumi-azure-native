...
class RelationshipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] relationship_name: Name of the relationship. Must be unique within a health model. For example, a concatenation of parentEntityName and childEntityName can be used as the name.
        """
...
@pulumi.type_token("azure-native:monitor:Relationship")
class Relationship(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] azure_monitor_workspace_name: The name of the Azure Monitor Workspace. The name is case insensitive
        :param pulumi.Input[builtins.str] health_model_name: Name of health model resource
        :param pulumi.Input[Union['RelationshipPropertiesArgs', 'RelationshipPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] relationship_name: Name of the relationship. Must be unique within a health model. For example, a concatenation of parentEntityName and childEntityName can be used as the name.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:monitor/v20250503preview:Relationship")])
