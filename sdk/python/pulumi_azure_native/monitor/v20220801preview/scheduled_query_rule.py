...
class ScheduledQueryRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20180416:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20200501preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20220801preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20230315preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20231201:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights/v20240101preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:insights:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20180416:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20200501preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20210201preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20210801:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20220615:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20230315preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20231201:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor/v20240101preview:ScheduledQueryRule"), pulumi.Alias(type_="azure-native:monitor:ScheduledQueryRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledQueryRule, __self__).__init__(
            'azure-native:monitor/v20220801preview:ScheduledQueryRule',
            resource_name,
            __props__,
            opts)
