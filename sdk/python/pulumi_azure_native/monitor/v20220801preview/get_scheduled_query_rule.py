...
def get_scheduled_query_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor/v20220801preview:getScheduledQueryRule', __args__, opts=opts, typ=GetScheduledQueryRuleResult).value
...
def get_scheduled_query_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor/v20220801preview:getScheduledQueryRule', __args__, opts=opts, typ=GetScheduledQueryRuleResult)
