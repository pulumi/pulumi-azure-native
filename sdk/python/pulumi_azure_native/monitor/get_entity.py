...
def get_entity(azure_monitor_workspace_name: Optional[_builtins.str] = None,
...
def get_entity_output(azure_monitor_workspace_name: Optional[pulumi.Input[_builtins.str]] = None,
