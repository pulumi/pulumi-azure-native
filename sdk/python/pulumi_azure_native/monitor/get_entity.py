...
def get_entity(azure_monitor_workspace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str entity_name: Name of the entity. Must be unique within a health model.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:monitor:getEntity', __args__, opts=opts, typ=GetEntityResult).value
...
def get_entity_output(azure_monitor_workspace_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:monitor:getEntity', __args__, opts=opts, typ=GetEntityResult)
