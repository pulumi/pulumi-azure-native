...
class DiscountArgs:
    def __init__(__self__, *,
                 entity_type: pulumi.Input[Union[builtins.str, 'DiscountEntityType']],
        ...
        :param pulumi.Input[Union[builtins.str, 'DiscountEntityType']] entity_type: This defines whether the entity being created is primary or affiliate. Supported values: primary, affiliate. Validation: Required, must match one of the 2 values.
    ...
    def entity_type(self) -> pulumi.Input[Union[builtins.str, 'DiscountEntityType']]:
        """
    ...
    @entity_type.setter
    def entity_type(self, value: pulumi.Input[Union[builtins.str, 'DiscountEntityType']]):
...
class Discount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 discount_name: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 entity_type: Optional[pulumi.Input[Union[builtins.str, 'DiscountEntityType']]] = None,
    ...
    @property
    @pulumi.getter(name="appliedScopeType")
    def applied_scope_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        List of applied scopes supported for discounts.
        """
        return pulumi.get(self, "applied_scope_type")
    ...
    def benefit_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def billing_account_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def billing_profile_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def customer_resource_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="systemId")
    def system_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This is the globally unique identifier of the Discount which will not change for the lifetime of the Discount.
        """
        return pulumi.get(self, "system_id")
