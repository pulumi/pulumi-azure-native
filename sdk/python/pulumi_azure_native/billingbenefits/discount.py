...
class Discount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billingbenefits/v20241101preview:Discount"), pulumi.Alias(type_="azure-native:billingbenefits/v20250501preview:Discount"), pulumi.Alias(type_="azure-native:billingbenefits/v20251201preview:Discount"), pulumi.Alias(type_="azure-native:billingbenefits/v20260601:Discount")])
