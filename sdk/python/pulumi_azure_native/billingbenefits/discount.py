...
class DiscountArgs:
    def __init__(__self__, *,
                 entity_type: pulumi.Input[Union[_builtins.str, 'DiscountEntityType']],
        ...
        :param pulumi.Input[Union[_builtins.str, 'DiscountEntityType']] entity_type: This defines whether the entity being created is primary or affiliate. Supported values: primary, affiliate. Validation: Required, must match one of the 2 values.
    ...
    def entity_type(self) -> pulumi.Input[Union[_builtins.str, 'DiscountEntityType']]:
        """
    ...
    @entity_type.setter
    def entity_type(self, value: pulumi.Input[Union[_builtins.str, 'DiscountEntityType']]):
...
class Discount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 discount_name: Optional[pulumi.Input[_builtins.str]] = None,
                 display_name: Optional[pulumi.Input[_builtins.str]] = None,
                 entity_type: Optional[pulumi.Input[Union[_builtins.str, 'DiscountEntityType']]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="appliedScopeType")
    def applied_scope_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        List of applied scopes supported for discounts.
        """
        return pulumi.get(self, "applied_scope_type")
