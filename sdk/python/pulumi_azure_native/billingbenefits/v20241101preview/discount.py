...
class DiscountArgs:
    def __init__(__self__, *,
                 entity_type: pulumi.Input[Union[str, 'DiscountEntityType']],
                 product_code: pulumi.Input[str],
                 resource_group_name: pulumi.Input[str],
                 start_at: pulumi.Input[str],
                 applied_scope_type: Optional[pulumi.Input[Union[str, 'DiscountAppliedScopeType']]] = None,
                 discount_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union[str, 'DiscountEntityType']] entity_type: This defines whether the entity being created is primary or affiliate. Supported values: primary, affiliate. Validation: Required, must match one of the 2 values.
        :param pulumi.Input[str] product_code: This is the catalog UPN for the product.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] start_at: Start date of the discount. Value is the date the discount started or will start in the future.
        :param pulumi.Input[Union[str, 'DiscountAppliedScopeType']] applied_scope_type: List of applied scopes supported for discounts.
        :param pulumi.Input[str] discount_name: Name of the discount
        :param pulumi.Input[str] display_name: This defines a user friendly display name for the discount.
        ...
        :param pulumi.Input[str] system_id: This is the globally unique identifier of the Discount which will not change for the lifetime of the Discount.
    ...
    def entity_type(self) -> pulumi.Input[Union[str, 'DiscountEntityType']]:
        """
    ...
    @entity_type.setter
    def entity_type(self, value: pulumi.Input[Union[str, 'DiscountEntityType']]):
    ...
    def applied_scope_type(self) -> Optional[pulumi.Input[Union[str, 'DiscountAppliedScopeType']]]:
        """
    ...
    def applied_scope_type(self, value: Optional[pulumi.Input[Union[str, 'DiscountAppliedScopeType']]]):
        pulumi.set(self, "applied_scope_type", value)

    @property
    @pulumi.getter(name="discountName")
    def discount_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def discount_name(self, value: Optional[pulumi.Input[str]]):
...
class Discount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 discount_name: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 entity_type: Optional[pulumi.Input[Union[str, 'DiscountEntityType']]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["applied_scope_type"] = applied_scope_type
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billingbenefits:Discount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Discount, __self__).__init__(
            'azure-native:billingbenefits/v20241101preview:Discount',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="appliedScopeType")
    def applied_scope_type(self) -> pulumi.Output[Optional[str]]:
        """
        List of applied scopes supported for discounts.
        """
        return pulumi.get(self, "applied_scope_type")
    ...
    def benefit_resource_id(self) -> pulumi.Output[str]:
        """
    ...
    def billing_account_resource_id(self) -> pulumi.Output[str]:
        """
    ...
    def billing_profile_resource_id(self) -> pulumi.Output[str]:
        """
    ...
    def customer_resource_id(self) -> pulumi.Output[str]:
        """
    ...
    @property
    @pulumi.getter(name="systemId")
    def system_id(self) -> pulumi.Output[Optional[str]]:
        """
        This is the globally unique identifier of the Discount which will not change for the lifetime of the Discount.
        """
        return pulumi.get(self, "system_id")
