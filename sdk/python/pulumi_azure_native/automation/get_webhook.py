...
def get_webhook(automation_account_name: Optional[_builtins.str] = None,
...
def get_webhook_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
