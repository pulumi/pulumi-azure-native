...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20180630:getRunbook', __args__, opts=opts, typ=GetRunbookResult).value
...
def get_runbook_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20180630:getRunbook', __args__, opts=opts, typ=GetRunbookResult)
