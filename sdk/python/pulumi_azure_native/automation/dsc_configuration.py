...
class DscConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] configuration_name: The create or update parameters for configuration.
        :param pulumi.Input[builtins.str] description: Gets or sets the description of the configuration.
        :param pulumi.Input[builtins.str] location: Gets or sets the location of the resource.
        :param pulumi.Input[builtins.bool] log_progress: Gets or sets progress log option.
        :param pulumi.Input[builtins.bool] log_verbose: Gets or sets verbose log option.
...
class DscConfiguration(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:automation:DscConfiguration"
    ...
    def job_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
    ...
    def node_configuration_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
