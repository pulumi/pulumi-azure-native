...
def get_python3_package(automation_account_name: Optional[_builtins.str] = None,
...
def get_python3_package_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
