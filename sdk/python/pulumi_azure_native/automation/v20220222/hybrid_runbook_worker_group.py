...
class HybridRunbookWorkerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""HybridRunbookWorkerGroup is deprecated: azure-native:automation/v20220222:HybridRunbookWorkerGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:HybridRunbookWorkerGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20210622:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20220808:HybridRunbookWorkerGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridRunbookWorkerGroup, __self__).__init__(
            'azure-native:automation/v20220222:HybridRunbookWorkerGroup',
            resource_name,
            __props__,
            opts)
