...
def get_automation_account(automation_account_name: Optional[_builtins.str] = None,
...
def get_automation_account_output(automation_account_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
