...
def list_key_by_automation_account(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20231101:listKeyByAutomationAccount', __args__, opts=opts, typ=ListKeyByAutomationAccountResult).value
...
def list_key_by_automation_account_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20231101:listKeyByAutomationAccount', __args__, opts=opts, typ=ListKeyByAutomationAccountResult)
