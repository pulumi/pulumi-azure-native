...
def get_python3_package(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20231101:getPython3Package', __args__, opts=opts, typ=GetPython3PackageResult).value
...
def get_python3_package_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20231101:getPython3Package', __args__, opts=opts, typ=GetPython3PackageResult)
