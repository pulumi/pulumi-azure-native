...
class PowerShell72Module(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] automation_account_name: The name of the automation account.
        :param pulumi.Input[pulumi.InputType['ContentLinkArgs']] content_link: Sets the hash.
        :param pulumi.Input[str] location: Sets the location of the resource.
        :param pulumi.Input[str] module_name: The name of module.
        :param pulumi.Input[str] name: Sets name of the resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:PowerShell72Module")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PowerShell72Module, __self__).__init__(
            'azure-native:automation/v20231101:PowerShell72Module',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PowerShell72Module':
        """
