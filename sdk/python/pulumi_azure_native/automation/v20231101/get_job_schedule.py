...
def get_job_schedule(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20231101:getJobSchedule', __args__, opts=opts, typ=GetJobScheduleResult).value
...
def get_job_schedule_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20231101:getJobSchedule', __args__, opts=opts, typ=GetJobScheduleResult)
