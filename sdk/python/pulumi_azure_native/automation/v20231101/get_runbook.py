...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20231101:getRunbook', __args__, opts=opts, typ=GetRunbookResult).value
...
def get_runbook_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['runbookName'] = runbook_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20231101:getRunbook', __args__, opts=opts, typ=GetRunbookResult)
