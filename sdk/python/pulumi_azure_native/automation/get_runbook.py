...
class GetRunbookResult:
    ...
    def log_activity_trace(self) -> Optional[builtins.int]:
        """
    ...
    def log_progress(self) -> Optional[builtins.bool]:
        """
...
def get_runbook(automation_account_name: Optional[builtins.str] = None,
                ...
                runbook_name: Optional[builtins.str] = None,
    ...
    :param builtins.str runbook_name: The runbook name.
    """
    __args__ = dict()
