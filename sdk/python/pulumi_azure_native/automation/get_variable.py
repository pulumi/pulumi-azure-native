...
class GetVariableResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, description=None, id=None, is_encrypted=None, last_modified_time=None, name=None, system_data=None, type=None, value=None):
...
def get_variable(automation_account_name: Optional[_builtins.str] = None,
...
def get_variable_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
