...
class Variable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 variable_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Variable is deprecated: azure-native:automation/v20190601:Variable is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Variable to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Variable"), pulumi.Alias(type_="azure-native:automation/v20151031:Variable"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Variable"), pulumi.Alias(type_="azure-native:automation/v20220808:Variable")])
