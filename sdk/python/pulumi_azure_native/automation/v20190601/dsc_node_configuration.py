...
class DscNodeConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dsc_node_configuration = azure_native.automation.v20190601.DscNodeConfiguration("dscNodeConfiguration",
            automation_account_name="myAutomationAccount20",
            configuration=azure_native.automation.v20190601.DscConfigurationAssociationPropertyArgs(
                name="configName",
            ),
            ...
            source=azure_native.automation.v20190601.ContentSourceArgs(
                hash=azure_native.automation.v20190601.ContentHashArgs(
                    algorithm="sha256",
        ...
        ```sh
        $ pulumi import azure-native:automation/v20190601:DscNodeConfiguration configName.nodeConfigName /subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount20/nodeConfigurations/configName.nodeConfigName 
        ```
