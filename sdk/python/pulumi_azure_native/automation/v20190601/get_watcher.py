...
def get_watcher(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watcher is deprecated: azure-native:automation/v20190601:Watcher is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20200113preview:Watcher to guarantee forwards compatibility.""")
    __args__ = dict()
