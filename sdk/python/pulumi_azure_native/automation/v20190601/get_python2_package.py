...
def get_python2_package(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_python2_package is deprecated: azure-native:automation/v20190601:Python2Package is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Python2Package to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['automationAccountName'] = automation_account_name
    __args__['packageName'] = package_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20190601:getPython2Package', __args__, opts=opts, typ=GetPython2PackageResult).value
