...
def get_job_schedule(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_schedule is deprecated: azure-native:automation/v20190601:JobSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.""")
    __args__ = dict()
