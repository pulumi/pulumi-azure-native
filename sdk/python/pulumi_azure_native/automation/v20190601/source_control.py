...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_type: Optional[pulumi.Input[Union[str, 'SourceType']]] = None,
                 __props__=None):
        pulumi.log.warn("""SourceControl is deprecated: azure-native:automation/v20190601:SourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:SourceControl to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20200113preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20220808:SourceControl")])
