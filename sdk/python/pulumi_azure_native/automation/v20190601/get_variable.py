...
def get_variable(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20190601:getVariable', __args__, opts=opts, typ=GetVariableResult).value
...
def get_variable_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20190601:getVariable', __args__, opts=opts, typ=GetVariableResult)
