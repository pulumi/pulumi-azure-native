...
class Runbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        runbook = azure_native.automation.v20190601.Runbook("runbook",
            ...
            publish_content_link=azure_native.automation.v20190601.ContentLinkArgs(
        ...
        runbook = azure_native.automation.v20190601.Runbook("runbook",
            automation_account_name="ContoseAutomationAccount",
            description="Description of the Runbook",
            draft=azure_native.automation.v20190601.RunbookDraftArgs(),
            location="East US 2",
            log_progress=False,
            log_verbose=False,
            name="Get-AzureVMTutorial",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Runbook"), pulumi.Alias(type_="azure-native:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-native:automation/v20180630:Runbook"), pulumi.Alias(type_="azure-native:automation/v20220808:Runbook")])
