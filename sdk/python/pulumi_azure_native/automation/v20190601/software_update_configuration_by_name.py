...
class SoftwareUpdateConfigurationByNameArgs:
    ...
    def _configure(
             ...
             schedule_info: Optional[pulumi.Input['SUCSchedulePropertiesArgs']] = None,
...
class SoftwareUpdateConfigurationByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            schedule_info = _utilities.configure(schedule_info, SUCSchedulePropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:SoftwareUpdateConfigurationByName"), pulumi.Alias(type_="azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName")])
