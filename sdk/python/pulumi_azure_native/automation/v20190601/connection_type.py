...
class ConnectionType(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connection_type = azure_native.automation.v20190601.ConnectionType("connectionType",
            automation_account_name="myAutomationAccount22",
            connection_type_name="myCT",
            field_definitions={
                "myBoolField": azure_native.automation.v20190601.FieldDefinitionArgs(
                    is_encrypted=False,
                    is_optional=False,
                    type="bool",
                ),
                "myStringField": azure_native.automation.v20190601.FieldDefinitionArgs(
                    is_encrypted=False,
                    is_optional=False,
                    type="string",
                ),
                "myStringFieldEncrypted": azure_native.automation.v20190601.FieldDefinitionArgs(
                    is_encrypted=True,
                    is_optional=False,
                    type="string",
                ),
