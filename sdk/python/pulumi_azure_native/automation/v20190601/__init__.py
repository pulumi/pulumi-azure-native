...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:automation/v20190601:AutomationAccount":
                return AutomationAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Connection":
                return Connection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:ConnectionType":
                return ConnectionType(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Credential":
                return Credential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:DscConfiguration":
                return DscConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:DscNodeConfiguration":
                return DscNodeConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:JobSchedule":
                return JobSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Module":
                return Module(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Python2Package":
                return Python2Package(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Runbook":
                return Runbook(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Schedule":
                return Schedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:SoftwareUpdateConfigurationByName":
                return SoftwareUpdateConfigurationByName(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:SourceControl":
                return SourceControl(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Variable":
                return Variable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20190601:Watcher":
    ...
    pulumi.runtime.register_resource_module("azure-native", "automation/v20190601", _module_instance)
