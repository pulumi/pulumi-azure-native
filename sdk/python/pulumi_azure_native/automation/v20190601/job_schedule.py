...
class JobSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        job_schedule = azure_native.automation.v20190601.JobSchedule("jobSchedule",
            ...
            runbook=azure_native.automation.v20190601.RunbookAssociationPropertyArgs(
                name="TestRunbook",
            ),
            schedule=azure_native.automation.v20190601.ScheduleAssociationPropertyArgs(
