...
warnings.warn("""azure-native:automation/v20190601:JobSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.""", DeprecationWarning)
...
class JobSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 schedule: Optional[pulumi.Input[pulumi.InputType['ScheduleAssociationPropertyArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""JobSchedule is deprecated: azure-native:automation/v20190601:JobSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20151031:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20200113preview:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20220808:JobSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobSchedule, __self__).__init__(
            'azure-native:automation/v20190601:JobSchedule',
            resource_name,
            __props__,
            opts)
