...
class CredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: Gets or sets the password of the credential.
        :param pulumi.Input[builtins.str] resource_group_name: Name of an Azure Resource group.
        :param pulumi.Input[builtins.str] user_name: Gets or sets the user name of the credential.
        :param pulumi.Input[builtins.str] credential_name: The parameters supplied to the create or update credential operation.
        :param pulumi.Input[builtins.str] description: Gets or sets the description of the credential.
        """
