...
class HybridRunbookWorker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20220808:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20230515preview:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20231101:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20241023:HybridRunbookWorker"), pulumi.Alias(type_="azure-native_automation_v20210622:automation:HybridRunbookWorker"), pulumi.Alias(type_="azure-native_automation_v20220808:automation:HybridRunbookWorker"), pulumi.Alias(type_="azure-native_automation_v20230515preview:automation:HybridRunbookWorker"), pulumi.Alias(type_="azure-native_automation_v20231101:automation:HybridRunbookWorker"), pulumi.Alias(type_="azure-native_automation_v20241023:automation:HybridRunbookWorker")])
