...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getRunbook'.""", DeprecationWarning)
...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getRunbook', __args__, opts=opts, typ=GetRunbookResult).value
