...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:automation:Webhook'.""", DeprecationWarning)
...
class Webhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:Webhook"), pulumi.Alias(type_="azure-native:automation:Webhook"), pulumi.Alias(type_="azure-nextgen:automation:Webhook"), pulumi.Alias(type_="azure-native:automation/v20151031:Webhook"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Webhook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Webhook, __self__).__init__(
            'azure-native:automation/latest:Webhook',
            resource_name,
            __props__,
            opts)
