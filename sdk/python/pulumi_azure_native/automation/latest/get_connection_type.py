...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getConnectionType'.""", DeprecationWarning)
...
def get_connection_type(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getConnectionType', __args__, opts=opts, typ=GetConnectionTypeResult).value
