...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getPython2Package'.""", DeprecationWarning)
...
def get_python2_package(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getPython2Package', __args__, opts=opts, typ=GetPython2PackageResult).value
