...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getDscConfiguration'.""", DeprecationWarning)
...
def get_dsc_configuration(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dsc_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getDscConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getDscConfiguration', __args__, opts=opts, typ=GetDscConfigurationResult).value
