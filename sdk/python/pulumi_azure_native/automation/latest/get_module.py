...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getModule'.""", DeprecationWarning)
...
def get_module(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getModule', __args__, opts=opts, typ=GetModuleResult).value
