...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getWebhook'.""", DeprecationWarning)
...
def get_webhook(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getWebhook', __args__, opts=opts, typ=GetWebhookResult).value
