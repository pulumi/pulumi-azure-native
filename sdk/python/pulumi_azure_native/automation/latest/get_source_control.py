...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getSourceControl'.""", DeprecationWarning)
...
def get_source_control(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult).value
