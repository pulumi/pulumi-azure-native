...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getSchedule'.""", DeprecationWarning)
...
def get_schedule(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_schedule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getSchedule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
