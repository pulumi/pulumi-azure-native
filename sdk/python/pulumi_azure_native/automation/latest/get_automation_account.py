...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getAutomationAccount'.""", DeprecationWarning)
...
def get_automation_account(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getAutomationAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getAutomationAccount', __args__, opts=opts, typ=GetAutomationAccountResult).value
