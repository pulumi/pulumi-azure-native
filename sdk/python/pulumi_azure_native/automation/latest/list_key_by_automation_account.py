...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:listKeyByAutomationAccount'.""", DeprecationWarning)
...
def list_key_by_automation_account(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_key_by_automation_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:listKeyByAutomationAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:listKeyByAutomationAccount', __args__, opts=opts, typ=ListKeyByAutomationAccountResult).value
