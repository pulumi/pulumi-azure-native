...
class Python2Package(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:Python2Package"), pulumi.Alias(type_="azure-native:automation:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation:Python2Package"), pulumi.Alias(type_="azure-native:automation/v20180630:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation/v20180630:Python2Package"), pulumi.Alias(type_="azure-native:automation/v20190601:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Python2Package"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Python2Package"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Python2Package")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Python2Package, __self__).__init__(
            'azure-native:automation/latest:Python2Package',
            resource_name,
            __props__,
            opts)
