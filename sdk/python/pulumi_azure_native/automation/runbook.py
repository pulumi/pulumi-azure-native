...
class RunbookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] log_activity_trace: Gets or sets the activity-level tracing options of the runbook.
    ...
    @runbook_type.setter
    def runbook_type(self, value: pulumi.Input[Union[_builtins.str, 'RunbookTypeEnum']]):
