...
def get_automation_account(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getAutomationAccount', __args__, opts=opts, typ=GetAutomationAccountResult).value
...
def get_automation_account_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getAutomationAccount', __args__, opts=opts, typ=GetAutomationAccountResult)
