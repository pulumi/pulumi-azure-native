...
def list_automation_account_deleted_runbooks(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:listAutomationAccountDeletedRunbooks', __args__, opts=opts, typ=ListAutomationAccountDeletedRunbooksResult).value
...
def list_automation_account_deleted_runbooks_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:listAutomationAccountDeletedRunbooks', __args__, opts=opts, typ=ListAutomationAccountDeletedRunbooksResult)
