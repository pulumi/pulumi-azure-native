...
class GetDscNodeConfigurationResult:
    ...
    """
    def __init__(__self__, configuration=None, creation_time=None, id=None, increment_node_configuration_build=None, last_modified_time=None, name=None, node_count=None, source=None, system_data=None, type=None):
...
def get_dsc_node_configuration(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getDscNodeConfiguration', __args__, opts=opts, typ=GetDscNodeConfigurationResult).value
...
def get_dsc_node_configuration_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getDscNodeConfiguration', __args__, opts=opts, typ=GetDscNodeConfigurationResult)
