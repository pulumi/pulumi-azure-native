...
def get_package(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getPackage', __args__, opts=opts, typ=GetPackageResult).value
...
def get_package_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getPackage', __args__, opts=opts, typ=GetPackageResult)
