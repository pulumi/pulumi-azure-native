...
def get_connection_type(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getConnectionType', __args__, opts=opts, typ=GetConnectionTypeResult).value
...
def get_connection_type_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getConnectionType', __args__, opts=opts, typ=GetConnectionTypeResult)
