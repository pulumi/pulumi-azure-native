...
class Connection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:Connection"), pulumi.Alias(type_="azure-native:automation/v20190601:Connection"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Connection"), pulumi.Alias(type_="azure-native:automation/v20220808:Connection"), pulumi.Alias(type_="azure-native:automation/v20230515preview:Connection"), pulumi.Alias(type_="azure-native:automation/v20231101:Connection"), pulumi.Alias(type_="azure-native:automation:Connection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connection, __self__).__init__(
            'azure-native:automation/v20241023:Connection',
            resource_name,
            __props__,
            opts)
