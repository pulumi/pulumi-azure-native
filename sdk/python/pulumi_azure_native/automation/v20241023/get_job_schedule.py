...
def get_job_schedule(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getJobSchedule', __args__, opts=opts, typ=GetJobScheduleResult).value
...
def get_job_schedule_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getJobSchedule', __args__, opts=opts, typ=GetJobScheduleResult)
