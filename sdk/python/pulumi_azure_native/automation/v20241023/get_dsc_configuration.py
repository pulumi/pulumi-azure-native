...
def get_dsc_configuration(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getDscConfiguration', __args__, opts=opts, typ=GetDscConfigurationResult).value
...
def get_dsc_configuration_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getDscConfiguration', __args__, opts=opts, typ=GetDscConfigurationResult)
