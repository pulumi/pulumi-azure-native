...
class GetCertificateResult:
    ...
    """
    def __init__(__self__, creation_time=None, description=None, expiry_time=None, id=None, is_exportable=None, last_modified_time=None, name=None, system_data=None, thumbprint=None, type=None):
...
def get_certificate(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
