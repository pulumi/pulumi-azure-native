...
def get_webhook(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getWebhook', __args__, opts=opts, typ=GetWebhookResult).value
...
def get_webhook_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getWebhook', __args__, opts=opts, typ=GetWebhookResult)
