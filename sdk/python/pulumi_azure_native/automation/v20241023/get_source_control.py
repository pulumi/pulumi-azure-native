...
def get_source_control(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult).value
...
def get_source_control_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult)
