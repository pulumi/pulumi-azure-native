...
class Package(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Package"), pulumi.Alias(type_="azure-native:automation/v20230515preview:Package")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Package, __self__).__init__(
            'azure-native:automation/v20241023:Package',
            resource_name,
            __props__,
            opts)
