...
def get_hybrid_runbook_worker(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20241023:getHybridRunbookWorker', __args__, opts=opts, typ=GetHybridRunbookWorkerResult).value
...
def get_hybrid_runbook_worker_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20241023:getHybridRunbookWorker', __args__, opts=opts, typ=GetHybridRunbookWorkerResult)
