...
class GetConnectionResult:
    ...
    def field_definition_values(self) -> Mapping[str, builtins.str]:
        """
...
def get_connection(automation_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_name: The name of connection.
...
def get_connection_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
