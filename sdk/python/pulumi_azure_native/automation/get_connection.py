...
class GetConnectionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, connection_type=None, creation_time=None, description=None, field_definition_values=None, id=None, last_modified_time=None, name=None, system_data=None, type=None):
...
def get_connection(automation_account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: The name of connection.
...
def get_connection_output(automation_account_name: pulumi.Input[Optional[_builtins.str]] = None,
