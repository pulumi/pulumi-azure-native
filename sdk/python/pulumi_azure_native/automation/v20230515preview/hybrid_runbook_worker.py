...
class HybridRunbookWorker(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20210622:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20220808:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20231101:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation/v20241023:HybridRunbookWorker"), pulumi.Alias(type_="azure-native:automation:HybridRunbookWorker")])
