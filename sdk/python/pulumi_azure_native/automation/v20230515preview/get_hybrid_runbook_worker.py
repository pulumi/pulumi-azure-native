...
class GetHybridRunbookWorkerResult:
    ...
    """
    def __init__(__self__, id=None, ip=None, last_seen_date_time=None, location=None, name=None, registered_date_time=None, system_data=None, tags=None, type=None, vm_resource_id=None, worker_name=None, worker_type=None):
...
def get_hybrid_runbook_worker(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20230515preview:getHybridRunbookWorker', __args__, opts=opts, typ=GetHybridRunbookWorkerResult).value
...
def get_hybrid_runbook_worker_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20230515preview:getHybridRunbookWorker', __args__, opts=opts, typ=GetHybridRunbookWorkerResult)
