...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20190601:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20200113preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20220808:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20231101:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20241023:SourceControl"), pulumi.Alias(type_="azure-native:automation:SourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SourceControl, __self__).__init__(
            'azure-native:automation/v20230515preview:SourceControl',
            resource_name,
            __props__,
            opts)
