...
class Variable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:Variable"), pulumi.Alias(type_="azure-native:automation/v20190601:Variable"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Variable"), pulumi.Alias(type_="azure-native:automation/v20220808:Variable"), pulumi.Alias(type_="azure-native:automation/v20231101:Variable"), pulumi.Alias(type_="azure-native:automation/v20241023:Variable"), pulumi.Alias(type_="azure-native:automation:Variable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Variable, __self__).__init__(
            'azure-native:automation/v20230515preview:Variable',
            resource_name,
            __props__,
            opts)
