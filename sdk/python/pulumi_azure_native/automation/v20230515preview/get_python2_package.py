...
def get_python2_package(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20230515preview:getPython2Package', __args__, opts=opts, typ=GetPython2PackageResult).value
...
def get_python2_package_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20230515preview:getPython2Package', __args__, opts=opts, typ=GetPython2PackageResult)
