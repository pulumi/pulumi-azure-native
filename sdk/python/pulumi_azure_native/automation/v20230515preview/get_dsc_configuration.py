...
class GetDscConfigurationResult:
    ...
    """
    def __init__(__self__, creation_time=None, description=None, etag=None, id=None, job_count=None, last_modified_time=None, location=None, log_verbose=None, name=None, node_configuration_count=None, parameters=None, provisioning_state=None, source=None, state=None, system_data=None, tags=None, type=None):
...
def get_dsc_configuration(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20230515preview:getDscConfiguration', __args__, opts=opts, typ=GetDscConfigurationResult).value
...
def get_dsc_configuration_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20230515preview:getDscConfiguration', __args__, opts=opts, typ=GetDscConfigurationResult)
