...
class GetVariableResult:
    ...
    """
    def __init__(__self__, creation_time=None, description=None, id=None, is_encrypted=None, last_modified_time=None, name=None, system_data=None, type=None, value=None):
...
def get_variable(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20230515preview:getVariable', __args__, opts=opts, typ=GetVariableResult).value
...
def get_variable_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['variableName'] = variable_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20230515preview:getVariable', __args__, opts=opts, typ=GetVariableResult)
