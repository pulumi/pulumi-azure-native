...
class Module(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:Module"), pulumi.Alias(type_="azure-native:automation/v20190601:Module"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Module"), pulumi.Alias(type_="azure-native:automation/v20220808:Module"), pulumi.Alias(type_="azure-native:automation/v20231101:Module"), pulumi.Alias(type_="azure-native:automation/v20241023:Module"), pulumi.Alias(type_="azure-native:automation:Module")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Module, __self__).__init__(
            'azure-native:automation/v20230515preview:Module',
            resource_name,
            __props__,
            opts)
