...
class Package(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20241023:Package"), pulumi.Alias(type_="azure-native:automation:Package")])
