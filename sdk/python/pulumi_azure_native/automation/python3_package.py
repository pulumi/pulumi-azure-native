...
class Python3PackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] package_name: The name of python package.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Gets or sets the tags attached to the resource.
        """
...
class Python3Package(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:automation:Python3Package"
    ...
    def activity_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
    ...
    def is_composite(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
