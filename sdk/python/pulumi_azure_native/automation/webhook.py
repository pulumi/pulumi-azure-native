...
class Webhook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:Webhook"), pulumi.Alias(type_="azure-native:automation/v20230515preview:Webhook"), pulumi.Alias(type_="azure-native:automation/v20241023:Webhook"), pulumi.Alias(type_="azure-native_automation_v20151031:automation:Webhook"), pulumi.Alias(type_="azure-native_automation_v20230515preview:automation:Webhook"), pulumi.Alias(type_="azure-native_automation_v20241023:automation:Webhook")])
