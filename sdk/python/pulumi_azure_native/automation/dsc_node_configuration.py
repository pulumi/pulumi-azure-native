...
class DscNodeConfigurationArgs:
    ...
    def _configure(
        ...
        if 'incrementNodeConfigurationBuild' in kwargs:
            increment_node_configuration_build = kwargs['incrementNodeConfigurationBuild']
        if 'nodeConfigurationName' in kwargs:
...
class DscNodeConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if configuration is not None and not isinstance(configuration, DscConfigurationAssociationPropertyArgs):
                configuration = configuration or {}
                def _setter(key, value):
                    configuration[key] = value
                DscConfigurationAssociationPropertyArgs._configure(_setter, **configuration)
