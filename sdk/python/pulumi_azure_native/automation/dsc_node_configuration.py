...
class DscNodeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 increment_node_configuration_build: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] increment_node_configuration_build: If a new build version of NodeConfiguration is required.
        :param pulumi.Input[builtins.str] name: Name of the node configuration.
        :param pulumi.Input[builtins.str] node_configuration_name: The Dsc node configuration name.
    ...
    def increment_node_configuration_build(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def increment_node_configuration_build(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DscNodeConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="incrementNodeConfigurationBuild")
    def increment_node_configuration_build(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If a new build version of NodeConfiguration is required.
        """
        return pulumi.get(self, "increment_node_configuration_build")
    ...
    def node_count(self) -> pulumi.Output[Optional[builtins.float]]:
        """
