...
class HybridRunbookWorkerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hybrid_runbook_worker_group = azure_native.automation.v20210622.HybridRunbookWorkerGroup("hybridRunbookWorkerGroup",
            automation_account_name="testaccount",
            credential=azure_native.automation.v20210622.RunAsCredentialAssociationPropertyArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20220222:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20220808:HybridRunbookWorkerGroup")])
