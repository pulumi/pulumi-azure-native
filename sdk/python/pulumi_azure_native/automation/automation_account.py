...
class AutomationAccountArgs:
    def __init__(__self__, *,
                 ...
                 public_network_access: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] disable_local_auth: Indicates whether requests using non-AAD authentication are blocked
        ...
        :param pulumi.Input[builtins.str] location: Gets or sets the location of the resource.
        :param pulumi.Input[builtins.str] name: Gets or sets name of the resource.
        :param pulumi.Input[builtins.bool] public_network_access: Indicates whether traffic on the non-ARM endpoint (Webhook/Agent) is allowed from the public internet
    ...
    def public_network_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def public_network_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AutomationAccount(pulumi.CustomResource):
    ...
    def automation_hybrid_service_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="publicNetworkAccess")
    def public_network_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether traffic on the non-ARM endpoint (Webhook/Agent) is allowed from the public internet
        """
        return pulumi.get(self, "public_network_access")
