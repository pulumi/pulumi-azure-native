...
def get_power_shell72_module(automation_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str module_name: The name of module.
...
def get_power_shell72_module_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
