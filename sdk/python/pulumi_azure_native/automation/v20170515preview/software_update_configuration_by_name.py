...
class SoftwareUpdateConfigurationByName(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        software_update_configuration_by_name = azure_native.automation.v20170515preview.SoftwareUpdateConfigurationByName("softwareUpdateConfigurationByName",
            automation_account_name="myaccount",
            resource_group_name="mygroup",
            schedule_info=azure_native.automation.v20170515preview.SchedulePropertiesResponseArgs(
                advanced_schedule=azure_native.automation.v20170515preview.AdvancedScheduleArgs(
                    week_days=[
                        "Monday",
                        "Thursday",
                    ],
            ...
            tasks=azure_native.automation.v20170515preview.SoftwareUpdateConfigurationTasksResponseArgs(
                post_task=azure_native.automation.v20170515preview.TaskPropertiesArgs(
                    source="GetCache",
                ),
                pre_task=azure_native.automation.v20170515preview.TaskPropertiesArgs(
                    parameters={
            ...
            update_configuration=azure_native.automation.v20170515preview.UpdateConfigurationResponseArgs(
                ...
                operating_system=azure_native.automation/v20170515preview.OperatingSystemType.WINDOWS,
                targets={
                    "azureQueries": [{
                        "locations": [
                            "Japan East",
                        ...
                        "tagSettings": azure_native.automation.v20170515preview.TagSettingsPropertiesArgs(
                            filter_operator=azure_native.automation/v20170515preview.TagOperators.ALL,
                            tags=[
                                {
                                    "tag1": [
                                        "tag1Value1",
                    ...
                    "nonAzureQueries": [
                        azure_native.automation.v20170515preview.NonAzureQueryPropertiesArgs(
                ...
                windows=azure_native.automation.v20170515preview.WindowsPropertiesArgs(
                    excluded_kb_numbers=[
                        "168934",
                        "168973",
                    ],
        ...
        ```sh
        $ pulumi import azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName testpatch /subscriptions/51766542-3ed7-4a72-a187-0c8ab644ddab/resourceGroups/mygroup/providers/Microsoft.Automation/automationAccounts/myaccount/softwareUpdateConfigurations/testpatch 
        ```
