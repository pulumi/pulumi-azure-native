...
class SoftwareUpdateConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 schedule_info: 'outputs.SchedulePropertiesResponse',
        ...
        :param 'SchedulePropertiesResponse' schedule_info: Schedule information for the Software update configuration
