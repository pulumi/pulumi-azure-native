...
class WatcherArgs:
    def __init__(__self__, *,
                 ...
                 execution_frequency_in_seconds: Optional[pulumi.Input[_builtins.float]] = None,
    ...
    def execution_frequency_in_seconds(self, value: Optional[pulumi.Input[_builtins.float]]):
