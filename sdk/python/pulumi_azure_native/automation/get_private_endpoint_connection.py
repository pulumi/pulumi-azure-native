...
def get_private_endpoint_connection(automation_account_name: Optional[_builtins.str] = None,
...
def get_private_endpoint_connection_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
