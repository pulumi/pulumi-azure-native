...
warnings.warn("""azure-native:automation/v20151031:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.""", DeprecationWarning)
...
class Runbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Runbook is deprecated: azure-native:automation/v20151031:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.""")
