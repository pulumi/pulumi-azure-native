...
def get_connection_type(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection_type is deprecated: azure-native:automation/v20151031:ConnectionType is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:ConnectionType to guarantee forwards compatibility.""")
    __args__ = dict()
