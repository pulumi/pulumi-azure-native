...
def get_certificate(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: azure-native:automation/v20151031:Certificate is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Certificate to guarantee forwards compatibility.""")
    __args__ = dict()
