...
class DscConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscConfiguration")])
