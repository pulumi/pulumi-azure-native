...
class DscConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DscConfiguration is deprecated: azure-native:automation/v20151031:DscConfiguration is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:DscConfiguration to guarantee forwards compatibility.""")
