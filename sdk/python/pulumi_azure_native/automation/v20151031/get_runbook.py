...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_runbook is deprecated: azure-native:automation/v20151031:Runbook is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.""")
    __args__ = dict()
