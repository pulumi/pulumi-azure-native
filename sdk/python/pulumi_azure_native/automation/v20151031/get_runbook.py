...
def get_runbook(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_runbook is deprecated: azure-native:automation/v20151031:Runbook is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Runbook to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['automationAccountName'] = automation_account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['runbookName'] = runbook_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20151031:getRunbook', __args__, opts=opts, typ=GetRunbookResult).value
