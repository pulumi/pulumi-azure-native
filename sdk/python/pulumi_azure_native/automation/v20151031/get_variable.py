...
warnings.warn("""azure-native:automation/v20151031:Variable is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Variable to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_variable(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_variable is deprecated: azure-native:automation/v20151031:Variable is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Variable to guarantee forwards compatibility.""")
    __args__ = dict()
