...
warnings.warn("""azure-native:automation/v20151031:Variable is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Variable to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_variable(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_variable is deprecated: azure-native:automation/v20151031:Variable is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:Variable to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['automationAccountName'] = automation_account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['variableName'] = variable_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20151031:getVariable', __args__, opts=opts, typ=GetVariableResult).value
