...
def get_watcher(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20151031:getWatcher', __args__, opts=opts, typ=GetWatcherResult).value
...
def get_watcher_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20151031:getWatcher', __args__, opts=opts, typ=GetWatcherResult)
