...
def get_module(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20151031:getModule', __args__, opts=opts, typ=GetModuleResult).value
...
def get_module_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20151031:getModule', __args__, opts=opts, typ=GetModuleResult)
