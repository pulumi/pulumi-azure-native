...
warnings.warn("""azure-native:automation/v20151031:JobSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job_schedule(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_schedule is deprecated: azure-native:automation/v20151031:JobSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:JobSchedule to guarantee forwards compatibility.""")
    __args__ = dict()
