...
class Watcher(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 watcher_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Watcher is deprecated: azure-native:automation/v20151031:Watcher is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20200113preview:Watcher to guarantee forwards compatibility.""")
