...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20220808:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20230515preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20231101:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20241023:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20170515preview:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20190601:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20200113preview:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20220808:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20230515preview:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20231101:automation:SourceControl"), pulumi.Alias(type_="azure-native_automation_v20241023:automation:SourceControl")])
