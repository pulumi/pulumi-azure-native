...
class SourceControlArgs:
    ...
    def _configure(
        ...
        if publish_runbook is None and 'publishRunbook' in kwargs:
...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            security_token = _utilities.configure(security_token, SourceControlSecurityTokenPropertiesArgs, True)
