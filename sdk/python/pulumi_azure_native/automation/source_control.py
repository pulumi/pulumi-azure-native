...
class SourceControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_sync: The auto async of the source control. Default is false.
        :param pulumi.Input[builtins.str] branch: The repo branch of the source control. Include branch as empty string for VsoTfvc.
        :param pulumi.Input[builtins.str] description: The user description of the source control.
        :param pulumi.Input[builtins.str] folder_path: The folder path of the source control. Path must be relative.
        :param pulumi.Input[builtins.bool] publish_runbook: The auto publish of the source control. Default is true.
        :param pulumi.Input[builtins.str] repo_url: The repo url of the source control.
        ...
        :param pulumi.Input[builtins.str] source_control_name: The source control name.
        :param pulumi.Input[Union[builtins.str, 'SourceType']] source_type: The source type. Must be one of VsoGit, VsoTfvc, GitHub, case sensitive.
        """
    ...
    def auto_sync(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auto_sync.setter
    def auto_sync(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def publish_runbook(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_runbook(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def source_control_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_control_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SourceControl(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:automation:SourceControl"
    ...
    @property
    @pulumi.getter(name="autoSync")
    def auto_sync(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
    ...
    @property
    @pulumi.getter(name="publishRunbook")
    def publish_runbook(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The auto publish of the source control. Default is true.
        """
        return pulumi.get(self, "publish_runbook")
