...
class ModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: Sets the location of the resource.
        :param pulumi.Input[builtins.str] module_name: The name of module.
        :param pulumi.Input[builtins.str] name: Sets name of the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Sets the tags attached to the resource.
        """
