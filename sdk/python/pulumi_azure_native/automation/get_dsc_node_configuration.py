...
class GetDscNodeConfigurationResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, configuration=None, creation_time=None, id=None, increment_node_configuration_build=None, last_modified_time=None, name=None, node_count=None, source=None, system_data=None, type=None):
...
def get_dsc_node_configuration(automation_account_name: Optional[_builtins.str] = None,
                               node_configuration_name: Optional[_builtins.str] = None,
...
def get_dsc_node_configuration_output(automation_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                      node_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
