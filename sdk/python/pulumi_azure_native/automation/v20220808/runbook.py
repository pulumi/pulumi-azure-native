...
class Runbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        runbook = azure_native.automation.v20220808.Runbook("runbook",
            ...
            publish_content_link=azure_native.automation.v20220808.ContentLinkArgs(
        ...
        runbook = azure_native.automation.v20220808.Runbook("runbook",
            automation_account_name="ContoseAutomationAccount",
            description="Description of the Runbook",
            draft=azure_native.automation.v20220808.RunbookDraftArgs(),
            location="East US 2",
            log_progress=False,
            log_verbose=False,
            name="Get-AzureVMTutorial",
