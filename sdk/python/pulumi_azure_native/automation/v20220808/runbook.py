...
class RunbookArgs:
    ...
    def _configure(
        ...
        if 'logActivityTrace' in kwargs:
            log_activity_trace = kwargs['logActivityTrace']
        ...
        if log_activity_trace is not None:
            _setter("log_activity_trace", log_activity_trace)
...
class Runbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if publish_content_link is not None and not isinstance(publish_content_link, ContentLinkArgs):
                publish_content_link = publish_content_link or {}
                def _setter(key, value):
                    publish_content_link[key] = value
                ContentLinkArgs._configure(_setter, **publish_content_link)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Runbook"), pulumi.Alias(type_="azure-native:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-native:automation/v20180630:Runbook"), pulumi.Alias(type_="azure-native:automation/v20190601:Runbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Runbook, __self__).__init__(
            'azure-native:automation/v20220808:Runbook',
            resource_name,
            __props__,
            opts)
