...
class ConnectionTypeArgs:
    ...
    def _configure(
             ...
             field_definitions: Optional[pulumi.Input[Mapping[str, pulumi.Input['FieldDefinitionArgs']]]] = None,
        ...
        if field_definitions is None and 'fieldDefinitions' in kwargs:
            field_definitions = kwargs['fieldDefinitions']
        if field_definitions is None:
            raise TypeError("Missing 'field_definitions' argument")
        if name is None:
        ...
        if connection_type_name is None and 'connectionTypeName' in kwargs:
            connection_type_name = kwargs['connectionTypeName']
...
class ConnectionType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ConnectionType, __self__).__init__(
            'azure-native:automation/v20220808:ConnectionType',
            resource_name,
            __props__,
            opts)
