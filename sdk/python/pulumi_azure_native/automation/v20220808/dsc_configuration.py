...
class DscConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20230515preview:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20231101:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20241023:DscConfiguration"), pulumi.Alias(type_="azure-native:automation:DscConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DscConfiguration, __self__).__init__(
            'azure-native:automation/v20220808:DscConfiguration',
            resource_name,
            __props__,
            opts)
