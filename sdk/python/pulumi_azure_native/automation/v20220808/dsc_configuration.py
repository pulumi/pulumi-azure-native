...
class DscConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dsc_configuration = azure_native.automation.v20220808.DscConfiguration("dscConfiguration",
            ...
            source=azure_native.automation.v20220808.ContentSourceArgs(
                hash=azure_native.automation.v20220808.ContentHashArgs(
                    algorithm="sha256",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20151031:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscConfiguration")])
