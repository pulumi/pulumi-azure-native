...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connection = azure_native.automation.v20220808.Connection("connection",
            automation_account_name="myAutomationAccount28",
            connection_name="mysConnection",
            connection_type=azure_native.automation.v20220808.ConnectionTypeAssociationPropertyArgs(
                name="Azure",
            ),
