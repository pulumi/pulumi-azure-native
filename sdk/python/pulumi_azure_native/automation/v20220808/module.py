...
class Module(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        module = azure_native.automation.v20220808.Module("module",
            automation_account_name="myAutomationAccount33",
            content_link=azure_native.automation.v20220808.ContentLinkArgs(
                content_hash=azure_native.automation.v20220808.ContentHashArgs(
                    algorithm="sha265",
        ...
        ```sh
        $ pulumi import azure-native:automation/v20220808:Module OmsCompositeResources /subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/modules/OmsCompositeResources 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Module"), pulumi.Alias(type_="azure-native:automation/v20151031:Module"), pulumi.Alias(type_="azure-native:automation/v20190601:Module"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Module")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Module, __self__).__init__(
            'azure-native:automation/v20220808:Module',
            resource_name,
            __props__,
            opts)
