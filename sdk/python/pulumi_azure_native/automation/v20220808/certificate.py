...
class CertificateArgs:
    ...
    def _configure(
        ...
        if base64_value is None and 'base64Value' in kwargs:
            base64_value = kwargs['base64Value']
        if base64_value is None:
            raise TypeError("Missing 'base64_value' argument")
        if name is None:
        ...
        if is_exportable is None and 'isExportable' in kwargs:
            is_exportable = kwargs['isExportable']
...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Certificate"), pulumi.Alias(type_="azure-native:automation/v20151031:Certificate"), pulumi.Alias(type_="azure-native:automation/v20190601:Certificate"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azure-native:automation/v20220808:Certificate',
            resource_name,
            __props__,
            opts)
