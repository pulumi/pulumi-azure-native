...
class Python3Package(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Python3Package"), pulumi.Alias(type_="azure-native:automation/v20230515preview:Python3Package"), pulumi.Alias(type_="azure-native:automation/v20231101:Python3Package")])
