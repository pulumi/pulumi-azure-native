...
def get_module(automation_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str module_name: The module name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation:getModule', __args__, opts=opts, typ=GetModuleResult).value
...
def get_module_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
