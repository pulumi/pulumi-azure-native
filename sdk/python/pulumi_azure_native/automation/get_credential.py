...
class GetCredentialResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, description=None, id=None, last_modified_time=None, name=None, system_data=None, type=None, user_name=None):
...
def get_credential(automation_account_name: Optional[_builtins.str] = None,
...
def get_credential_output(automation_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                          credential_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
