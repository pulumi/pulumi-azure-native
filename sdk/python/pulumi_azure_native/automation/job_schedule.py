...
class JobScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_schedule_id: The job schedule name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Gets or sets a list of job properties.
        :param pulumi.Input[builtins.str] run_on: Gets or sets the hybrid worker group that the scheduled job should run on.
        """
...
class JobSchedule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="jobScheduleId")
    def job_schedule_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
