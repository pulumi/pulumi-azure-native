...
class JobSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20220808:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20230515preview:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20231101:JobSchedule"), pulumi.Alias(type_="azure-native:automation/v20241023:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20151031:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20190601:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20200113preview:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20220808:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20230515preview:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20231101:automation:JobSchedule"), pulumi.Alias(type_="azure-native_automation_v20241023:automation:JobSchedule")])
