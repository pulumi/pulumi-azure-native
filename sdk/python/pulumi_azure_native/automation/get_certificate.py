...
class GetCertificateResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, description=None, expiry_time=None, id=None, is_exportable=None, last_modified_time=None, name=None, system_data=None, thumbprint=None, type=None):
...
def get_certificate(automation_account_name: Optional[_builtins.str] = None,
...
def get_certificate_output(automation_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                           certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
