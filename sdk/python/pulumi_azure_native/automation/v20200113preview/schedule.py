...
warnings.warn("""azure-native:automation/v20200113preview:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Schedule to guarantee forwards compatibility.""", DeprecationWarning)
...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_zone: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Schedule is deprecated: azure-native:automation/v20200113preview:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Schedule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation:Schedule"), pulumi.Alias(type_="azure-native:automation/v20151031:Schedule"), pulumi.Alias(type_="azure-native:automation/v20190601:Schedule"), pulumi.Alias(type_="azure-native:automation/v20220808:Schedule")])
