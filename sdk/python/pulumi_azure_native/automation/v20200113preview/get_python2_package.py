...
warnings.warn("""azure-native:automation/v20200113preview:Python2Package is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Python2Package to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_python2_package(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_python2_package is deprecated: azure-native:automation/v20200113preview:Python2Package is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Python2Package to guarantee forwards compatibility.""")
    __args__ = dict()
