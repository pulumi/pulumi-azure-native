...
def get_credential(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_credential is deprecated: azure-native:automation/v20200113preview:Credential is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Credential to guarantee forwards compatibility.""")
    __args__ = dict()
