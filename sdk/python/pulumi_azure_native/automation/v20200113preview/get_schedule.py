...
def get_schedule(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_schedule is deprecated: azure-native:automation/v20200113preview:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Schedule to guarantee forwards compatibility.""")
    __args__ = dict()
