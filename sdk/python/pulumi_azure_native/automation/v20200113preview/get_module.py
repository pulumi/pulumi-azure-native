...
warnings.warn("""azure-native:automation/v20200113preview:Module is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Module to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_module(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_module is deprecated: azure-native:automation/v20200113preview:Module is being removed in the next major version of this provider. Please upgrade to azure-native:automation/v20220808:Module to guarantee forwards compatibility.""")
    __args__ = dict()
