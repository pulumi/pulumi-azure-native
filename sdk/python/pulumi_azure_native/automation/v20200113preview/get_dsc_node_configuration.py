...
def get_dsc_node_configuration_output(automation_account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:automation/v20200113preview:getDscNodeConfiguration', __args__, opts=opts, typ=GetDscNodeConfigurationResult)
