...
class Watcher(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20151031:Watcher"), pulumi.Alias(type_="azure-native:automation/v20190601:Watcher"), pulumi.Alias(type_="azure-native:automation/v20230515preview:Watcher"), pulumi.Alias(type_="azure-native:automation/v20241023:Watcher"), pulumi.Alias(type_="azure-native:automation:Watcher")])
