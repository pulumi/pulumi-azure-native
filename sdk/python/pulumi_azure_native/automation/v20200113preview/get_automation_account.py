...
def get_automation_account(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_account is deprecated: azure-native:automation/v20200113preview:AutomationAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:automation/v20220808:AutomationAccount to guarantee forwards compatibility.""")
    __args__ = dict()
