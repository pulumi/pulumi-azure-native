...
class HybridRunbookWorkerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:automation/v20210622:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20220808:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20230515preview:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20231101:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20241023:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20210622:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20220222:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20220808:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20230515preview:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20231101:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native_automation_v20241023:automation:HybridRunbookWorkerGroup")])
