...
class HybridRunbookWorkerGroupArgs:
    ...
    def hybrid_runbook_worker_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hybrid_runbook_worker_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
