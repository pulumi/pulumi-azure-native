...
class HybridRunbookWorkerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-native:automation/v20210622:HybridRunbookWorkerGroup"), pulumi.Alias(type_="azure-nextgen:automation/v20210622:HybridRunbookWorkerGroup")])
