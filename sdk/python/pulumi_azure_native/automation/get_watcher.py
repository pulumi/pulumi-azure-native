...
def get_watcher(automation_account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str watcher_name: The watcher name.
    """
    __args__ = dict()
...
def get_watcher_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
