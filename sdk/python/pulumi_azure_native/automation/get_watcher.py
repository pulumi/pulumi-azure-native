...
class GetWatcherResult:
    ...
    def execution_frequency_in_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def script_parameters(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def script_run_on(self) -> Optional[builtins.str]:
        """
...
def get_watcher(automation_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str watcher_name: The watcher name.
    """
    __args__ = dict()
...
def get_watcher_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
