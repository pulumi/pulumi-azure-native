...
class PrivateEndpointConnectionProxyArgs:
    def __init__(__self__, *,
                 ...
                 private_endpoint_connection_proxy_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
    ...
    def private_endpoint_connection_proxy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_endpoint_connection_proxy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20240901:PrivateEndpointConnectionProxy")])
