...
class Fabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20240901:Fabric"), pulumi.Alias(type_="azure-native:datareplication:Fabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Fabric, __self__).__init__(
            'azure-native:datareplication/v20210216preview:Fabric',
            resource_name,
            __props__,
            opts)
