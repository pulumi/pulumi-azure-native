...
class ReplicationExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20240901:ReplicationExtension"), pulumi.Alias(type_="azure-native:datareplication:ReplicationExtension")])
