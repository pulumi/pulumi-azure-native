...
class Dra(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20240901:Dra"), pulumi.Alias(type_="azure-native:datareplication:Dra")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dra, __self__).__init__(
            'azure-native:datareplication/v20210216preview:Dra',
            resource_name,
            __props__,
            opts)
