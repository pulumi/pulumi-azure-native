...
class PolicyArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['PolicyModelPropertiesArgs']] = None,
...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, PolicyModelPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication:Policy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Policy, __self__).__init__(
            'azure-native:datareplication/v20210216preview:Policy',
            resource_name,
            __props__,
            opts)
