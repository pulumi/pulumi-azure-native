...
def get_private_endpoint_connection_proxy(private_endpoint_connection_proxy_name: Optional[str] = None,
    ...
    :param str private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datareplication/v20240901:getPrivateEndpointConnectionProxy', __args__, opts=opts, typ=GetPrivateEndpointConnectionProxyResult).value
...
def get_private_endpoint_connection_proxy_output(private_endpoint_connection_proxy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datareplication/v20240901:getPrivateEndpointConnectionProxy', __args__, opts=opts, typ=GetPrivateEndpointConnectionProxyResult)
