...
__all__ = [
    ...
    'ProtectedItemJobPropertiesResponse',
...
class AzStackHCIFabricModelCustomPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str instance_type: Discriminator property for FabricModelCustomProperties.
...
@pulumi.output_type
class DiskControllerInputsResponse(dict):
    """
    Disk controller.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        elif key == "controllerLocation":
            suggest = "controller_location"
        elif key == "controllerName":
            suggest = "controller_name"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DiskControllerInputsResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DiskControllerInputsResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Disk controller.
        :param int controller_id: Gets or sets the controller ID.
        :param int controller_location: Gets or sets the controller Location.
        :param str controller_name: Gets or sets the controller name (IDE,SCSI).
        """
    ...
    def controller_location(self) -> int:
        """
...
class HealthErrorModelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] affected_resource_correlation_ids: Gets or sets the list of affected resource correlation Ids. This can be used to uniquely identify the count of items affected by a specific category and severity as well as count of item affected by an specific issue.
...
class HyperVToAzStackHCIDiskInputResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "diskFileFormat":
            ...
            suggest = "is_os_disk"
        elif key == "diskBlockSize":
            suggest = "disk_block_size"
        elif key == "diskController":
            suggest = "disk_controller"
        elif key == "diskIdentifier":
            suggest = "disk_identifier"
        elif key == "diskLogicalSectorSize":
            suggest = "disk_logical_sector_size"
        elif key == "diskPhysicalSectorSize":
            suggest = "disk_physical_sector_size"
        elif key == "isDynamic":
            suggest = "is_dynamic"
    ...
    def __init__(__self__, *,
                 ...
                 disk_size_gb: float,
                 is_os_disk: bool,
                 disk_block_size: Optional[float] = None,
                 disk_controller: Optional['outputs.DiskControllerInputsResponse'] = None,
                 disk_identifier: Optional[str] = None,
                 disk_logical_sector_size: Optional[float] = None,
                 disk_physical_sector_size: Optional[float] = None,
        ...
        :param float disk_block_size: Gets or sets a value of disk block size.
        :param 'DiskControllerInputsResponse' disk_controller: Disk controller.
        :param str disk_identifier: Gets or sets a value of disk identifier.
        :param float disk_logical_sector_size: Gets or sets a value of disk logical sector size.
        :param float disk_physical_sector_size: Gets or sets a value of disk physical sector size.
        :param bool is_dynamic: Gets or sets a value indicating whether dynamic sizing is enabled on the virtual hard disk.
    ...
    def disk_block_size(self) -> Optional[float]:
        """
    ...
    def disk_controller(self) -> Optional['outputs.DiskControllerInputsResponse']:
        """
        Disk controller.
        """
    ...
    def disk_identifier(self) -> Optional[str]:
        """
    ...
    def disk_logical_sector_size(self) -> Optional[float]:
        """
    ...
    def disk_physical_sector_size(self) -> Optional[float]:
        """
...
class HyperVToAzStackHCINicInputResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "isMacMigrationEnabled":
            suggest = "is_mac_migration_enabled"
        elif key == "isStaticIpMigrationEnabled":
            suggest = "is_static_ip_migration_enabled"
    ...
    def __init__(__self__, *,
        ...
        :param bool is_mac_migration_enabled: Gets or sets a value indicating whether mac address migration is enabled.
        :param bool is_static_ip_migration_enabled: Gets or sets a value indicating whether static ip migration is enabled.
    ...
    def is_mac_migration_enabled(self) -> Optional[bool]:
        """
    ...
    def is_static_ip_migration_enabled(self) -> Optional[bool]:
        """
...
class HyperVToAzStackHCIPolicyModelCustomPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str instance_type: Discriminator property for PolicyModelCustomProperties.
               Expected value is 'HyperVToAzStackHCI'.
        :param int recovery_point_history_in_minutes: Gets or sets the duration in minutes until which the recovery points need to be stored.
        """
...
class HyperVToAzStackHCIProtectedDiskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disk_logical_sector_size: float,
                 disk_physical_sector_size: float,
                 disk_type: str,
                 is_dynamic: bool,
                 is_os_disk: bool,
    ...
    @property
    @pulumi.getter(name="diskBlockSize")
    def disk_block_size(self) -> float:
        """
        Gets or sets a value of disk block size.
        """
        return pulumi.get(self, "disk_block_size")
    ...
    @property
    @pulumi.getter(name="diskLogicalSectorSize")
    def disk_logical_sector_size(self) -> float:
        """
        Gets or sets a value of disk logical sector size.
        """
        return pulumi.get(self, "disk_logical_sector_size")
    ...
    @property
    @pulumi.getter(name="diskPhysicalSectorSize")
    def disk_physical_sector_size(self) -> float:
        """
        Gets or sets a value of disk physical sector size.
        """
        return pulumi.get(self, "disk_physical_sector_size")
...
class HyperVToAzStackHCIProtectedItemModelCustomPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "sourceFabricAgentName":
            suggest = "source_fabric_agent_name"
        ...
        elif key == "targetFabricAgentName":
            suggest = "target_fabric_agent_name"
    ...
    def __init__(__self__, *,
        ...
        :param int initial_replication_progress_percentage: Gets or sets the initial replication progress percentage. This is calculated based on total bytes processed for all disks in the source VM.
        :param str instance_type: Discriminator property for ProtectedItemModelCustomProperties.
               Expected value is 'HyperVToAzStackHCI'.
        ...
        :param int resync_progress_percentage: Gets or sets the resync progress percentage. This is calculated based on total bytes processed for all disks in the source VM.
        ...
        :param str source_fabric_agent_name: Gets or sets the source fabric agent name.
        ...
        :param str target_fabric_agent_name: Gets or sets the target fabric agent name.
    ...
    def source_fabric_agent_name(self) -> str:
        """
    ...
    def target_fabric_agent_name(self) -> str:
        """
...
class HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str hyper_v_site_id: Gets or sets the ARM Id of the HyperV site.
        :param str instance_type: Discriminator property for ReplicationExtensionModelCustomProperties.
               Expected value is 'HyperVToAzStackHCI'.
...
@pulumi.output_type
class ProtectedItemJobPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProtectedItemJobPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProtectedItemJobPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Protected item job properties.
        :param str display_name: Gets or sets the job friendly display name.
        :param str end_time: Gets or sets end time of the job.
        :param str id: Gets or sets job Id.
        :param str name: Gets or sets job name.
        :param str scenario_name: Gets or sets protection scenario name.
        :param str start_time: Gets or sets start time of the job.
        :param str state: Gets or sets job state.
        """
...
class ProtectedItemModelPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "allowedJobs":
            ...
            suggest = "custom_properties"
        elif key == "fabricAgentId":
            suggest = "fabric_agent_id"
        elif key == "fabricId":
            suggest = "fabric_id"
        ...
        elif key == "targetFabricAgentId":
            suggest = "target_fabric_agent_id"
    ...
    def __init__(__self__, *,
                 ...
                 correlation_id: str,
                 current_job: 'outputs.ProtectedItemJobPropertiesResponse',
                 custom_properties: Any,
                 fabric_agent_id: str,
                 fabric_id: str,
                 ...
                 health_errors: Sequence['outputs.HealthErrorModelResponse'],
                 last_failed_enable_protection_job: 'outputs.ProtectedItemJobPropertiesResponse',
                 last_failed_planned_failover_job: 'outputs.ProtectedItemJobPropertiesResponse',
                 ...
                 last_test_failover_job: 'outputs.ProtectedItemJobPropertiesResponse',
                 policy_name: str,
        ...
        :param 'ProtectedItemJobPropertiesResponse' current_job: Gets or sets the current scenario.
        ...
        :param str fabric_agent_id: Gets or sets the fabric agent Id.
        ...
        :param Sequence['HealthErrorModelResponse'] health_errors: Gets or sets the list of health errors.
        :param 'ProtectedItemJobPropertiesResponse' last_failed_enable_protection_job: Gets or sets the last failed enabled protection job.
        :param 'ProtectedItemJobPropertiesResponse' last_failed_planned_failover_job: Gets or sets the last failed planned failover job.
        ...
        :param 'ProtectedItemJobPropertiesResponse' last_test_failover_job: Gets or sets the last test failover job.
        ...
        :param str target_fabric_agent_id: Gets or sets the target fabric agent Id.
        ...
        pulumi.set(__self__, "custom_properties", custom_properties)
        pulumi.set(__self__, "fabric_agent_id", fabric_agent_id)
        ...
        pulumi.set(__self__, "target_fabric_agent_id", target_fabric_agent_id)
    ...
    def current_job(self) -> 'outputs.ProtectedItemJobPropertiesResponse':
        """
    ...
    @property
    @pulumi.getter(name="fabricAgentId")
    def fabric_agent_id(self) -> str:
        """
        Gets or sets the fabric agent Id.
        """
        return pulumi.get(self, "fabric_agent_id")
    ...
    def last_failed_enable_protection_job(self) -> 'outputs.ProtectedItemJobPropertiesResponse':
        """
    ...
    def last_failed_planned_failover_job(self) -> 'outputs.ProtectedItemJobPropertiesResponse':
        """
    ...
    def last_test_failover_job(self) -> 'outputs.ProtectedItemJobPropertiesResponse':
        """
    ...
    @property
    @pulumi.getter(name="targetFabricAgentId")
    def target_fabric_agent_id(self) -> str:
        """
        Gets or sets the target fabric agent Id.
        """
        return pulumi.get(self, "target_fabric_agent_id")
