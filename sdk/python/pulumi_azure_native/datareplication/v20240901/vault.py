...
class VaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VaultModelPropertiesArgs'] properties: The resource-specific properties for this resource.
...
class Vault(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['VaultModelPropertiesArgs', 'VaultModelPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] vault_name: The vault name.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:Vault"), pulumi.Alias(type_="azure-native:datareplication:Vault")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Vault, __self__).__init__(
            'azure-native:datareplication/v20240901:Vault',
            resource_name,
            __props__,
            opts)
