...
class FabricAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] fabric_agent_name: The fabric agent name.
        :param pulumi.Input['FabricAgentModelPropertiesArgs'] properties: The resource-specific properties for this resource.
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['FabricAgentModelPropertiesArgs']]):
...
class FabricAgent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['FabricAgentModelPropertiesArgs', 'FabricAgentModelPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] fabric_agent_name: The fabric agent name.
        :param pulumi.Input[str] fabric_name: The fabric name.
        :param pulumi.Input[Union['FabricAgentModelPropertiesArgs', 'FabricAgentModelPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FabricAgentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FabricAgentArgs.__new__(FabricAgentArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:FabricAgent"), pulumi.Alias(type_="azure-native:datareplication:FabricAgent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FabricAgent, __self__).__init__(
            'azure-native:datareplication/v20240901:FabricAgent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FabricAgent':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return FabricAgent(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.FabricAgentModelPropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
