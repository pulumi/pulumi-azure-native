...
class PrivateEndpointConnectionProxyArgs:
    def __init__(__self__, *,
                 ...
                 private_endpoint_connection_proxy_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
    ...
    def private_endpoint_connection_proxy_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def private_endpoint_connection_proxy_name(self, value: Optional[pulumi.Input[str]]):
...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
        :param pulumi.Input[Union['PrivateEndpointConnectionProxyPropertiesArgs', 'PrivateEndpointConnectionProxyPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] vault_name: The vault name.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication:PrivateEndpointConnectionProxy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionProxy, __self__).__init__(
            'azure-native:datareplication/v20240901:PrivateEndpointConnectionProxy',
            resource_name,
            __props__,
            opts)
