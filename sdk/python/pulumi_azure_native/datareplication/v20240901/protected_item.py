...
class ProtectedItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProtectedItemModelPropertiesArgs'] properties: The resource-specific properties for this resource.
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['ProtectedItemModelPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ProtectedItemModelPropertiesArgs']]):
...
class ProtectedItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['ProtectedItemModelPropertiesArgs', 'ProtectedItemModelPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[str] protected_item_name: The protected item name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] vault_name: The vault name.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:ProtectedItem"), pulumi.Alias(type_="azure-native:datareplication:ProtectedItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProtectedItem, __self__).__init__(
            'azure-native:datareplication/v20240901:ProtectedItem',
            resource_name,
            __props__,
            opts)
