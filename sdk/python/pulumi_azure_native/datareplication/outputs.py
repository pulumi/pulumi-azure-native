...
class IdentityModelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity model.
        :param builtins.str aad_authority: Gets or sets the authority of the SPN with which Dra communicates to service.
        :param builtins.str application_id: Gets or sets the client/application Id of the SPN with which Dra communicates to
               service.
        :param builtins.str audience: Gets or sets the audience of the SPN with which Dra communicates to service.
        :param builtins.str object_id: Gets or sets the object Id of the SPN with which Dra communicates to service.
        :param builtins.str tenant_id: Gets or sets the tenant Id of the SPN with which Dra communicates to service.
        """
