...
def get_protected_item(protected_item_name: Optional[builtins.str] = None,
    ...
    :param builtins.str protected_item_name: The protected item name.
    :param builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param builtins.str vault_name: The vault name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datareplication:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult).value
...
def get_protected_item_output(protected_item_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datareplication:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult)
