...
def get_protected_item(protected_item_name: Optional[_builtins.str] = None,
...
def get_protected_item_output(protected_item_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
