...
class Dra(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:Dra"), pulumi.Alias(type_="azure-native:datareplication/v20240901:Dra"), pulumi.Alias(type_="azure-native:datareplication/v20260501:Dra")])
