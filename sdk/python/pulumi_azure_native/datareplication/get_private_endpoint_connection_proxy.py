...
def get_private_endpoint_connection_proxy(private_endpoint_connection_proxy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
...
def get_private_endpoint_connection_proxy_output(private_endpoint_connection_proxy_name: Optional[pulumi.Input[builtins.str]] = None,
