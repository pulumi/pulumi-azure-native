...
def get_private_endpoint_connection_proxy(private_endpoint_connection_proxy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_endpoint_connection_proxy_name: The private endpoint connection proxy name.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str vault_name: The vault name.
    """
    __args__ = dict()
    __args__['privateEndpointConnectionProxyName'] = private_endpoint_connection_proxy_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:datareplication:getPrivateEndpointConnectionProxy', __args__, opts=opts, typ=GetPrivateEndpointConnectionProxyResult).value
...
def get_private_endpoint_connection_proxy_output(private_endpoint_connection_proxy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datareplication:getPrivateEndpointConnectionProxy', __args__, opts=opts, typ=GetPrivateEndpointConnectionProxyResult)
