...
def get_dra(fabric_agent_name: Optional[builtins.str] = None,
    ...
    :param builtins.str fabric_agent_name: The fabric agent (Dra) name.
...
def get_dra_output(fabric_agent_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datareplication:getDra', __args__, opts=opts, typ=GetDraResult)
