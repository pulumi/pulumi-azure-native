...
class Fabric(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['FabricModelPropertiesArgs', 'FabricModelPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:Fabric"), pulumi.Alias(type_="azure-native:datareplication/v20240901:Fabric"), pulumi.Alias(type_="azure-native:datareplication/v20260501:Fabric")])
