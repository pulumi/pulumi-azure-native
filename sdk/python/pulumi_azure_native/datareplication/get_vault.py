...
class GetVaultResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.VaultModelPropertiesResponse':
        """
        Vault properties.
        """
    ...
    def system_data(self) -> 'outputs.VaultModelResponseSystemData':
...
def get_vault(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datareplication:getVault', __args__, opts=opts, typ=GetVaultResult).value
...
def get_vault_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
