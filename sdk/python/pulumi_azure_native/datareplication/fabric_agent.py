...
class FabricAgentArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['FabricAgentModelPropertiesArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['FabricAgentModelPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['FabricAgentModelPropertiesArgs']]):
...
class FabricAgent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['FabricAgentModelPropertiesArgs', 'FabricAgentModelPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:Dra"), pulumi.Alias(type_="azure-native:datareplication/v20210216preview:FabricAgent"), pulumi.Alias(type_="azure-native:datareplication/v20240901:FabricAgent"), pulumi.Alias(type_="azure-native:datareplication/v20260501:FabricAgent"), pulumi.Alias(type_="azure-native:datareplication:Dra")])
