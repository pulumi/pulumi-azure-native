...
class FabricAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datareplication/v20210216preview:FabricAgent"), pulumi.Alias(type_="azure-native:datareplication/v20240901:FabricAgent")])
