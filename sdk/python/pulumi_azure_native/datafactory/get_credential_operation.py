...
def get_credential_operation(credential_name: Optional[builtins.str] = None,
...
def get_credential_operation_output(credential_name: Optional[pulumi.Input[builtins.str]] = None,
