...
def get_credential_operation(credential_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory:getCredentialOperation', __args__, opts=opts, typ=GetCredentialOperationResult).value
...
def get_credential_operation_output(credential_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
