...
class CredentialOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] credential_name: Credential name
        :param pulumi.Input[str] factory_name: The factory name.
        :param pulumi.Input[Union[Union['ManagedIdentityCredentialArgs', 'ManagedIdentityCredentialArgsDict'], Union['ServicePrincipalCredentialArgs', 'ServicePrincipalCredentialArgsDict']]] properties: Properties of credentials.
        :param pulumi.Input[str] resource_group_name: The resource group name.
        """
        ...
    @overload
