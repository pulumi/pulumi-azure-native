...
def get_private_endpoint_connection(factory_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_endpoint_connection_name: The private endpoint connection name.
...
def get_private_endpoint_connection_output(factory_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult)
