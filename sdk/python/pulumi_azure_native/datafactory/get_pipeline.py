...
def get_pipeline(factory_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_name: The pipeline name.
...
def get_pipeline_output(factory_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory:getPipeline', __args__, opts=opts, typ=GetPipelineResult)
