...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getDataFlow'.""", DeprecationWarning)
...
def get_data_flow(data_flow_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult).value
