...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getExposureControlFeatureValue'.""", DeprecationWarning)
...
def get_exposure_control_feature_value(feature_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getExposureControlFeatureValue', __args__, opts=opts, typ=GetExposureControlFeatureValueResult).value
