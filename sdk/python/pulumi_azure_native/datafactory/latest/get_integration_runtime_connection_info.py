...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getIntegrationRuntimeConnectionInfo'.""", DeprecationWarning)
...
def get_integration_runtime_connection_info(factory_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime_connection_info is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getIntegrationRuntimeConnectionInfo'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getIntegrationRuntimeConnectionInfo', __args__, opts=opts, typ=GetIntegrationRuntimeConnectionInfoResult).value
