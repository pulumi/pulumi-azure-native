...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getLinkedService'.""", DeprecationWarning)
...
def get_linked_service(factory_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getLinkedService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult).value
