...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getDataset'.""", DeprecationWarning)
...
def get_dataset(dataset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getDataset', __args__, opts=opts, typ=GetDatasetResult).value
