...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getIntegrationRuntime'.""", DeprecationWarning)
...
def get_integration_runtime(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
