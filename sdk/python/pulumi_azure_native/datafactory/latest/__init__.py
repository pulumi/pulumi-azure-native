...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datafactory/latest:DataFlow":
                return DataFlow(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:Dataset":
                return Dataset(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:Factory":
                return Factory(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:IntegrationRuntime":
                return IntegrationRuntime(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:LinkedService":
                return LinkedService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:ManagedPrivateEndpoint":
                return ManagedPrivateEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:Pipeline":
                return Pipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/latest:Trigger":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datafactory/latest", _module_instance)
