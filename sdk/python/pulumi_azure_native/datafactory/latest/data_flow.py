...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datafactory:DataFlow'.""", DeprecationWarning)
...
class DataFlow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:DataFlow"), pulumi.Alias(type_="azure-nextgen:datafactory:DataFlow"), pulumi.Alias(type_="azure-native:datafactory/v20180601:DataFlow"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:DataFlow")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataFlow, __self__).__init__(
            'azure-native:datafactory/latest:DataFlow',
            resource_name,
            __props__,
            opts)
