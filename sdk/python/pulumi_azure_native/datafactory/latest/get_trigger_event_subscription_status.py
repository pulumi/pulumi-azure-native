...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getTriggerEventSubscriptionStatus'.""", DeprecationWarning)
...
def get_trigger_event_subscription_status(factory_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_trigger_event_subscription_status is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getTriggerEventSubscriptionStatus'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getTriggerEventSubscriptionStatus', __args__, opts=opts, typ=GetTriggerEventSubscriptionStatusResult).value
