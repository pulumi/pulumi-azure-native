...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getFactory'.""", DeprecationWarning)
...
def get_factory(factory_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_factory is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getFactory'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getFactory', __args__, opts=opts, typ=GetFactoryResult).value
