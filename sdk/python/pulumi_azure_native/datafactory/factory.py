...
class Factory(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(encryption, EncryptionConfigurationArgs):
            ...
            if not isinstance(identity, FactoryIdentityArgs):
            ...
            if not isinstance(purview_configuration, PurviewConfigurationArgs):
