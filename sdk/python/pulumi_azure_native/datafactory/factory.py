...
class Factory(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory/latest:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/latest:Factory"), pulumi.Alias(type_="azure-native:datafactory/v20170901preview:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:Factory"), pulumi.Alias(type_="azure-native:datafactory/v20180601:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Factory")])
    ...
    def get(resource_name: str,
        ...
        __props__["global_parameters"] = None
        __props__["identity"] = None
        __props__["location"] = None
        __props__["name"] = None
        __props__["provisioning_state"] = None
        __props__["public_network_access"] = None
        __props__["repo_configuration"] = None
        __props__["tags"] = None
        __props__["type"] = None
        __props__["version"] = None
