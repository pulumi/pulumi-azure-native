...
def get_dataset(dataset_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory:getDataset', __args__, opts=opts, typ=GetDatasetResult).value
...
def get_dataset_output(dataset_name: pulumi.Input[Optional[_builtins.str]] = None,
