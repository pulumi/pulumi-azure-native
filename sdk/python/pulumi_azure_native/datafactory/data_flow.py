...
class DataFlowArgs:
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['MappingDataFlowArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['MappingDataFlowArgs']):
