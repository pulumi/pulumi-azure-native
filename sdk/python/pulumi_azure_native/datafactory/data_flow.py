...
class DataFlow(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory:DataFlow"), pulumi.Alias(type_="azure-native:datafactory/latest:DataFlow"), pulumi.Alias(type_="azure-nextgen:datafactory/latest:DataFlow"), pulumi.Alias(type_="azure-native:datafactory/v20180601:DataFlow"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:DataFlow")])
