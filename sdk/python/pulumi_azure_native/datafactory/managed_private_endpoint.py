...
class ManagedPrivateEndpointInitArgs:
    ...
    def _configure(
        ...
        if 'managedVirtualNetworkName' in kwargs:
...
class ManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ManagedPrivateEndpointArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ManagedPrivateEndpointArgs._configure(_setter, **properties)
