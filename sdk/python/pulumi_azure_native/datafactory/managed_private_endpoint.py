...
class ManagedPrivateEndpointInitArgs:
    def __init__(__self__, *,
        ...
        """
        ManagedPrivateEndpointInitArgs._configure(
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['ManagedPrivateEndpointArgs']] = None,
        ...
        if managed_virtual_network_name is None and 'managedVirtualNetworkName' in kwargs:
            managed_virtual_network_name = kwargs['managedVirtualNetworkName']
        if managed_virtual_network_name is None:
            raise TypeError("Missing 'managed_virtual_network_name' argument")
        ...
        _setter("managed_virtual_network_name", managed_virtual_network_name)
...
class ManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ManagedPrivateEndpointInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ManagedPrivateEndpointArgs, True)
