...
def list_integration_runtime_auth_keys(factory_name: Optional[_builtins.str] = None,
...
def list_integration_runtime_auth_keys_output(factory_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory:listIntegrationRuntimeAuthKeys', __args__, opts=opts, typ=ListIntegrationRuntimeAuthKeysResult)
