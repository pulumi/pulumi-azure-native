...
def get_exposure_control_feature_value(feature_name: Optional[builtins.str] = None,
    ...
    :param builtins.str location_id: The location identifier.
    """
    __args__ = dict()
...
def get_exposure_control_feature_value_output(feature_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
