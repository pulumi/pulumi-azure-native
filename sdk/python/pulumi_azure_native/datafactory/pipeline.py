...
class PipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] concurrency: The max number of concurrent runs for the pipeline.
        ...
        :param pulumi.Input[builtins.str] pipeline_name: The pipeline name.
