...
def get_data_flow(data_flow_name: Optional[_builtins.str] = None,
                  factory_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_flow_name: The data flow name.
...
def get_data_flow_output(data_flow_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult)
