...
def get_data_flow(data_flow_name: Optional[builtins.str] = None,
    ...
    :param builtins.str data_flow_name: The data flow name.
...
def get_data_flow_output(data_flow_name: Optional[pulumi.Input[builtins.str]] = None,
