...
def get_linked_service(factory_name: Optional[builtins.str] = None,
                       linked_service_name: Optional[builtins.str] = None,
    ...
    :param builtins.str linked_service_name: The linked service name.
...
def get_linked_service_output(factory_name: Optional[pulumi.Input[builtins.str]] = None,
