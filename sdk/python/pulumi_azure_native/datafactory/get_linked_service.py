...
def get_linked_service(factory_name: Optional[_builtins.str] = None,
                       linked_service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str linked_service_name: The linked service name.
