...
def get_integration_runtime(factory_name: Optional[builtins.str] = None,
...
def get_integration_runtime_output(factory_name: Optional[pulumi.Input[builtins.str]] = None,
