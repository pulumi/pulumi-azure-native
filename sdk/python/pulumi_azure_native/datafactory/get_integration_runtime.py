...
def get_integration_runtime(factory_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
...
def get_integration_runtime_output(factory_name: pulumi.Input[Optional[_builtins.str]] = None,
                                   integration_runtime_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult)
