...
def get_change_data_capture(change_data_capture_name: Optional[_builtins.str] = None,
...
def get_change_data_capture_output(change_data_capture_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
