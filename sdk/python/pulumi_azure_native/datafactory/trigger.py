...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory/v20180601:Trigger"), pulumi.Alias(type_="azure-native_datafactory_v20170901preview:datafactory:Trigger"), pulumi.Alias(type_="azure-native_datafactory_v20180601:datafactory:Trigger")])
