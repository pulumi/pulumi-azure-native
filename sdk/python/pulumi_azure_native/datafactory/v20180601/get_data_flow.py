...
def get_data_flow(data_flow_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/v20180601:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult).value
...
def get_data_flow_output(data_flow_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory/v20180601:getDataFlow', __args__, opts=opts, typ=GetDataFlowResult)
