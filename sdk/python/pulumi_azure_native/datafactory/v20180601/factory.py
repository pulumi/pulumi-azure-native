...
class Factory(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        factory = azure_native.datafactory.v20180601.Factory("factory",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:Factory"), pulumi.Alias(type_="azure-native:datafactory/v20170901preview:Factory")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Factory, __self__).__init__(
            'azure-native:datafactory/v20180601:Factory',
            resource_name,
            __props__,
            opts)
