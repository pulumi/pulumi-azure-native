...
class ChangeDataCapture(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:ChangeDataCapture")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ChangeDataCapture, __self__).__init__(
            'azure-native:datafactory/v20180601:ChangeDataCapture',
            resource_name,
            __props__,
            opts)
