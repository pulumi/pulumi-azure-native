...
class CredentialOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        credential_operation = azure_native.datafactory.v20180601.CredentialOperation("credentialOperation",
            credential_name="exampleCredential",
            factory_name="exampleFactoryName",
            properties=azure_native.datafactory.v20180601.ManagedIdentityCredentialResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:CredentialOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CredentialOperation, __self__).__init__(
            'azure-native:datafactory/v20180601:CredentialOperation',
            resource_name,
            __props__,
            opts)
