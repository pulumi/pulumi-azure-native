...
class IntegrationRuntimeArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input[Union['ManagedIntegrationRuntimeArgs', 'SelfHostedIntegrationRuntimeArgs']]] = None,
...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:IntegrationRuntime"), pulumi.Alias(type_="azure-native:datafactory/v20170901preview:IntegrationRuntime")])
