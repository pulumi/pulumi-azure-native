...
def get_linked_service(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/v20180601:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult).value
...
def get_linked_service_output(factory_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:datafactory/v20180601:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult)
