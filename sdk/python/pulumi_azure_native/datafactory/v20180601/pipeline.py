...
class PipelineArgs:
    ...
    def _configure(
        ...
        if run_dimensions is None and 'runDimensions' in kwargs:
...
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            folder = _utilities.configure(folder, PipelineFolderArgs, True)
            __props__.__dict__["folder"] = folder
            __props__.__dict__["parameters"] = parameters
            __props__.__dict__["pipeline_name"] = pipeline_name
            policy = _utilities.configure(policy, PipelinePolicyArgs, True)
