...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:datafactory/v20180601:DataFlow":
                return DataFlow(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/v20180601:Dataset":
                return Dataset(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/v20180601:Factory":
                return Factory(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/v20180601:IntegrationRuntime":
                return IntegrationRuntime(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/v20180601:LinkedService":
                return LinkedService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:datafactory/v20180601:ManagedPrivateEndpoint":
    ...
    pulumi.runtime.register_resource_module("azure-native", "datafactory/v20180601", _module_instance)
