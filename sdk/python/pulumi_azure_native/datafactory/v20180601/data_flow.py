...
class DataFlow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:DataFlow"), pulumi.Alias(type_="azure-native:datafactory:DataFlow"), pulumi.Alias(type_="azure-nextgen:datafactory:DataFlow")])
