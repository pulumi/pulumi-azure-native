...
azure-native:datafactory/v20170901preview:IntegrationRuntime is being removed in the next major version of this provider. Please upgrade to azure-native:datafactory/v20180601:IntegrationRuntime to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:datafactory/v20170901preview:IntegrationRuntime is being removed in the next major version of this provider. Please upgrade to azure-native:datafactory/v20180601:IntegrationRuntime to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/v20170901preview:getIntegrationRuntime', __args__, opts=opts, typ=GetIntegrationRuntimeResult).value
