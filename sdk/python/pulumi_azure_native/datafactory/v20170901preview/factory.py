...
class Factory(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:datafactory:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory:Factory"), pulumi.Alias(type_="azure-native:datafactory/latest:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/latest:Factory"), pulumi.Alias(type_="azure-native:datafactory/v20180601:Factory"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Factory")])
