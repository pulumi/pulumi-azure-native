...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis/v20241101:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult).value
...
def get_access_policy_output(access_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redis/v20241101:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult)
