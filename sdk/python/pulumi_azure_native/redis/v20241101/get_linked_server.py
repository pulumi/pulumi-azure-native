...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis/v20241101:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult).value
...
def get_linked_server_output(linked_server_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redis/v20241101:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult)
