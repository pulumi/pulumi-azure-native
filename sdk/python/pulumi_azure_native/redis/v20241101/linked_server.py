...
class LinkedServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20230401:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20230501preview:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20230801:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20240301:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20240401preview:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20241101:LinkedServer"), pulumi.Alias(type_="azure-native:cache:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20170201:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20171001:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20180301:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20190701:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20200601:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20201201:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20210601:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20220501:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20220601:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20230401:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20230501preview:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20230801:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20240301:LinkedServer"), pulumi.Alias(type_="azure-native:redis/v20240401preview:LinkedServer"), pulumi.Alias(type_="azure-native:redis:LinkedServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedServer, __self__).__init__(
            'azure-native:redis/v20241101:LinkedServer',
            resource_name,
            __props__,
            opts)
