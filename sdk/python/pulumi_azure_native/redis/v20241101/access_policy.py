...
class AccessPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20230501preview:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20230801:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20240301:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20240401preview:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20241101:AccessPolicy"), pulumi.Alias(type_="azure-native:cache:AccessPolicy"), pulumi.Alias(type_="azure-native:redis/v20230501preview:AccessPolicy"), pulumi.Alias(type_="azure-native:redis/v20230801:AccessPolicy"), pulumi.Alias(type_="azure-native:redis/v20240301:AccessPolicy"), pulumi.Alias(type_="azure-native:redis/v20240401preview:AccessPolicy"), pulumi.Alias(type_="azure-native:redis:AccessPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessPolicy, __self__).__init__(
            'azure-native:redis/v20241101:AccessPolicy',
            resource_name,
            __props__,
            opts)
