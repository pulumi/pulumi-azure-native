...
def get_patch_schedule(default: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis/v20241101:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult).value
...
def get_patch_schedule_output(default: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redis/v20241101:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult)
