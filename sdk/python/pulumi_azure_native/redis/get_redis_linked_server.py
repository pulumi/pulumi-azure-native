...
def get_redis_linked_server(linked_server_name: Optional[_builtins.str] = None,
...
def get_redis_linked_server_output(linked_server_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
