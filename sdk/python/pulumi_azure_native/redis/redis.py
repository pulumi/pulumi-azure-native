...
class RedisArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Whether or not public endpoint access is allowed for this cache.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'
        ...
        :param pulumi.Input[_builtins.int] replicas_per_master: The number of replicas to be created per primary.
        :param pulumi.Input[_builtins.int] replicas_per_primary: The number of replicas to be created per primary.
        :param pulumi.Input[_builtins.int] shard_count: The number of shards to be created on a Premium Cluster Cache.
        :param pulumi.Input[_builtins.str] static_ip: Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
        :param pulumi.Input[_builtins.str] subnet_id: The full resource ID of a subnet in a virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tenant_settings: A dictionary of tenant settings
        :param pulumi.Input[Union[_builtins.str, 'UpdateChannel']] update_channel: Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
...
class Redis(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="disableAccessKeyAuthentication")
    def disable_access_key_authentication(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Authentication to Redis through access keys is disabled when set as true. Default value is false.
        """
        return pulumi.get(self, "disable_access_key_authentication")
