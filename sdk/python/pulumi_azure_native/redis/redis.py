...
class RedisArgs:
    def __init__(__self__, *,
                 ...
                 disable_access_key_authentication: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_non_ssl_port: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 replicas_per_master: Optional[pulumi.Input[builtins.int]] = None,
                 replicas_per_primary: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 tenant_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 update_channel: Optional[pulumi.Input[Union[builtins.str, 'UpdateChannel']]] = None,
                 zonal_allocation_policy: Optional[pulumi.Input[Union[builtins.str, 'ZonalAllocationPolicy']]] = None,
        ...
        :param pulumi.Input[builtins.bool] disable_access_key_authentication: Authentication to Redis through access keys is disabled when set as true. Default value is false.
        :param pulumi.Input[builtins.bool] enable_non_ssl_port: Specifies whether the non-ssl Redis server port (6379) is enabled.
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: The identity of the resource.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union[builtins.str, 'TlsVersion']] minimum_tls_version: Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
        :param pulumi.Input[builtins.str] name: The name of the RedisResource
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Whether or not public endpoint access is allowed for this cache.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method.
        ...
        :param pulumi.Input[builtins.str] redis_version: Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.
        :param pulumi.Input[builtins.int] replicas_per_master: The number of replicas to be created per primary.
        :param pulumi.Input[builtins.int] replicas_per_primary: The number of replicas to be created per primary.
        :param pulumi.Input[builtins.int] shard_count: The number of shards to be created on a Premium Cluster Cache.
        :param pulumi.Input[builtins.str] static_ip: Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
        :param pulumi.Input[builtins.str] subnet_id: The full resource ID of a subnet in a virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tenant_settings: A dictionary of tenant settings
        :param pulumi.Input[Union[builtins.str, 'UpdateChannel']] update_channel: Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
        :param pulumi.Input[Union[builtins.str, 'ZonalAllocationPolicy']] zonal_allocation_policy: Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
    ...
    def disable_access_key_authentication(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_access_key_authentication(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_access_key_authentication", value)

    @property
    @pulumi.getter(name="enableNonSslPort")
    def enable_non_ssl_port(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_non_ssl_port(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def replicas_per_master(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def replicas_per_master(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "replicas_per_master", value)

    @property
    @pulumi.getter(name="replicasPerPrimary")
    def replicas_per_primary(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of replicas to be created per primary.
        """
    ...
    def replicas_per_primary(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def tenant_settings(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def tenant_settings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "tenant_settings", value)

    @property
    @pulumi.getter(name="updateChannel")
    def update_channel(self) -> Optional[pulumi.Input[Union[builtins.str, 'UpdateChannel']]]:
        """
    ...
    def update_channel(self, value: Optional[pulumi.Input[Union[builtins.str, 'UpdateChannel']]]):
        pulumi.set(self, "update_channel", value)

    @property
    @pulumi.getter(name="zonalAllocationPolicy")
    def zonal_allocation_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'ZonalAllocationPolicy']]]:
        """
    ...
    def zonal_allocation_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'ZonalAllocationPolicy']]]):
...
class Redis(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20200601:Redis"), pulumi.Alias(type_="azure-native:cache/v20230401:Redis"), pulumi.Alias(type_="azure-native:cache/v20230501preview:Redis"), pulumi.Alias(type_="azure-native:cache/v20230801:Redis"), pulumi.Alias(type_="azure-native:cache/v20240301:Redis"), pulumi.Alias(type_="azure-native:cache/v20240401preview:Redis"), pulumi.Alias(type_="azure-native:cache/v20241101:Redis"), pulumi.Alias(type_="azure-native:cache:Redis"), pulumi.Alias(type_="azure-native:redis/v20150801:Redis"), pulumi.Alias(type_="azure-native:redis/v20160401:Redis"), pulumi.Alias(type_="azure-native:redis/v20170201:Redis"), pulumi.Alias(type_="azure-native:redis/v20171001:Redis"), pulumi.Alias(type_="azure-native:redis/v20180301:Redis"), pulumi.Alias(type_="azure-native:redis/v20190701:Redis"), pulumi.Alias(type_="azure-native:redis/v20200601:Redis"), pulumi.Alias(type_="azure-native:redis/v20201201:Redis"), pulumi.Alias(type_="azure-native:redis/v20210601:Redis"), pulumi.Alias(type_="azure-native:redis/v20220501:Redis"), pulumi.Alias(type_="azure-native:redis/v20220601:Redis"), pulumi.Alias(type_="azure-native:redis/v20230401:Redis"), pulumi.Alias(type_="azure-native:redis/v20230501preview:Redis"), pulumi.Alias(type_="azure-native:redis/v20230801:Redis"), pulumi.Alias(type_="azure-native:redis/v20240301:Redis"), pulumi.Alias(type_="azure-native:redis/v20240401preview:Redis"), pulumi.Alias(type_="azure-native:redis/v20241101:Redis")])
    ...
    @property
    @pulumi.getter(name="disableAccessKeyAuthentication")
    def disable_access_key_authentication(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Authentication to Redis through access keys is disabled when set as true. Default value is false.
        """
        return pulumi.get(self, "disable_access_key_authentication")
    ...
    @property
    @pulumi.getter(name="enableNonSslPort")
    def enable_non_ssl_port(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the non-ssl Redis server port (6379) is enabled.
        """
        return pulumi.get(self, "enable_non_ssl_port")
    ...
    @property
    @pulumi.getter(name="redisConfiguration")
    def redis_configuration(self) -> pulumi.Output[Optional['outputs.RedisCommonPropertiesRedisConfigurationResponse']]:
        """
        All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta, maxmemory-policy,notify-keyspace-events, aof-backup-enabled, aof-storage-connection-string-0, aof-storage-connection-string-1 etc.
        """
        return pulumi.get(self, "redis_configuration")
    ...
    @property
    @pulumi.getter(name="redisVersion")
    def redis_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.
        """
        return pulumi.get(self, "redis_version")
    ...
    @property
    @pulumi.getter(name="replicasPerMaster")
    def replicas_per_master(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of replicas to be created per primary.
        """
        return pulumi.get(self, "replicas_per_master")
    ...
    @property
    @pulumi.getter(name="replicasPerPrimary")
    def replicas_per_primary(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of replicas to be created per primary.
        """
        return pulumi.get(self, "replicas_per_primary")
    ...
    def ssl_port(self) -> pulumi.Output[builtins.int]:
        """
        Redis SSL port.
        """
    ...
    @property
    @pulumi.getter(name="tenantSettings")
    def tenant_settings(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        A dictionary of tenant settings
        """
        return pulumi.get(self, "tenant_settings")
    ...
    @property
    @pulumi.getter(name="updateChannel")
    def update_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional: Specifies the update channel for the monthly Redis updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'.
        """
        return pulumi.get(self, "update_channel")
    ...
    @property
    @pulumi.getter(name="zonalAllocationPolicy")
    def zonal_allocation_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional: Specifies how availability zones are allocated to the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional availability and capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported.
        """
        return pulumi.get(self, "zonal_allocation_policy")
