...
def get_redis_firewall_rule(cache_name: Optional[_builtins.str] = None,
...
def get_redis_firewall_rule_output(cache_name: Optional[pulumi.Input[_builtins.str]] = None,
