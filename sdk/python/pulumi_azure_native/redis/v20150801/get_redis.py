...
def get_redis(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis/v20150801:getRedis', __args__, opts=opts, typ=GetRedisResult).value
...
def get_redis_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redis/v20150801:getRedis', __args__, opts=opts, typ=GetRedisResult)
