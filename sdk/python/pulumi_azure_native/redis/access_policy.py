...
class AccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permissions: Permissions for the access policy. Learn how to configure permissions at https://aka.ms/redis/AADPreRequisites
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] access_policy_name: The name of the access policy that is being added to the Redis cache.
        """
