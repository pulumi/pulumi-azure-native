...
class Redis(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20200601:Redis"), pulumi.Alias(type_="azure-native:cache/v20230401:Redis"), pulumi.Alias(type_="azure-native:cache/v20230501preview:Redis"), pulumi.Alias(type_="azure-native:cache/v20230801:Redis"), pulumi.Alias(type_="azure-native:cache/v20240301:Redis"), pulumi.Alias(type_="azure-native:cache/v20240401preview:Redis"), pulumi.Alias(type_="azure-native:cache/v20241101:Redis"), pulumi.Alias(type_="azure-native:cache:Redis"), pulumi.Alias(type_="azure-native:redis/v20150801:Redis"), pulumi.Alias(type_="azure-native:redis/v20160401:Redis"), pulumi.Alias(type_="azure-native:redis/v20170201:Redis"), pulumi.Alias(type_="azure-native:redis/v20171001:Redis"), pulumi.Alias(type_="azure-native:redis/v20180301:Redis"), pulumi.Alias(type_="azure-native:redis/v20200601:Redis"), pulumi.Alias(type_="azure-native:redis/v20201201:Redis"), pulumi.Alias(type_="azure-native:redis/v20210601:Redis"), pulumi.Alias(type_="azure-native:redis/v20220501:Redis"), pulumi.Alias(type_="azure-native:redis/v20220601:Redis"), pulumi.Alias(type_="azure-native:redis/v20230401:Redis"), pulumi.Alias(type_="azure-native:redis/v20230501preview:Redis"), pulumi.Alias(type_="azure-native:redis/v20230801:Redis"), pulumi.Alias(type_="azure-native:redis/v20240301:Redis"), pulumi.Alias(type_="azure-native:redis/v20240401preview:Redis"), pulumi.Alias(type_="azure-native:redis/v20241101:Redis"), pulumi.Alias(type_="azure-native:redis:Redis")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Redis, __self__).__init__(
            'azure-native:redis/v20190701:Redis',
            resource_name,
            __props__,
            opts)
