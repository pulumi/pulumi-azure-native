...
def get_redis_firewall_rule(cache_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis/v20160401:getRedisFirewallRule', __args__, opts=opts, typ=GetRedisFirewallRuleResult).value
...
def get_redis_firewall_rule_output(cache_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redis/v20160401:getRedisFirewallRule', __args__, opts=opts, typ=GetRedisFirewallRuleResult)
