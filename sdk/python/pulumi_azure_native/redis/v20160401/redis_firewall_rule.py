...
class RedisFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20230401:FirewallRule"), pulumi.Alias(type_="azure-native:cache/v20230501preview:FirewallRule"), pulumi.Alias(type_="azure-native:cache/v20230801:FirewallRule"), pulumi.Alias(type_="azure-native:cache/v20240301:FirewallRule"), pulumi.Alias(type_="azure-native:cache/v20240401preview:FirewallRule"), pulumi.Alias(type_="azure-native:cache/v20241101:FirewallRule"), pulumi.Alias(type_="azure-native:cache:FirewallRule"), pulumi.Alias(type_="azure-native:redis/v20170201:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20171001:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20180301:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20190701:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20200601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20201201:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20210601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20220501:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20220601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20230401:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20230501preview:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20230801:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20240301:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20240401preview:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis/v20241101:RedisFirewallRule"), pulumi.Alias(type_="azure-native:redis:RedisFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RedisFirewallRule, __self__).__init__(
            'azure-native:redis/v20160401:RedisFirewallRule',
            resource_name,
            __props__,
            opts)
