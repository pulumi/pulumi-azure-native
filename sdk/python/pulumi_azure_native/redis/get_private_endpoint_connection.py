...
def get_private_endpoint_connection(cache_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redis:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(cache_name: Optional[pulumi.Input[_builtins.str]] = None,
