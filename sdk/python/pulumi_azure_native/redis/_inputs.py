...
class RedisCommonPropertiesRedisConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authnotrequired: Specifies whether the authentication is disabled. Setting this property is highly discouraged from security point of view.
