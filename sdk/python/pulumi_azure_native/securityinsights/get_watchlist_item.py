...
class GetWatchlistItemResult:
    ...
    def watchlist_item_id(self) -> Optional[builtins.str]:
        """
    ...
    def watchlist_item_type(self) -> Optional[builtins.str]:
        """
...
def get_watchlist_item(resource_group_name: Optional[builtins.str] = None,
                       watchlist_alias: Optional[builtins.str] = None,
                       watchlist_item_id: Optional[builtins.str] = None,
    ...
    :param builtins.str watchlist_item_id: The watchlist item id (GUID)
...
def get_watchlist_item_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
