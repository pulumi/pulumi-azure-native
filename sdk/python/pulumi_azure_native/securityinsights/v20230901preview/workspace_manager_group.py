...
class WorkspaceManagerGroupArgs:
    ...
    def _configure(
        ...
        if member_resource_names is None and 'memberResourceNames' in kwargs:
            member_resource_names = kwargs['memberResourceNames']
        if member_resource_names is None:
            raise TypeError("Missing 'member_resource_names' argument")
        ...
        if workspace_manager_group_name is None and 'workspaceManagerGroupName' in kwargs:
...
class WorkspaceManagerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WorkspaceManagerGroup, __self__).__init__(
            'azure-native:securityinsights/v20230901preview:WorkspaceManagerGroup',
            resource_name,
            __props__,
            opts)
