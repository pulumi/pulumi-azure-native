...
class ContentTemplateArgs:
    ...
    def _configure(
        ...
        if content_product_id is None and 'contentProductId' in kwargs:
            content_product_id = kwargs['contentProductId']
        if content_product_id is None:
            raise TypeError("Missing 'content_product_id' argument")
        ...
        _setter("content_product_id", content_product_id)
