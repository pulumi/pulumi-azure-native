...
def get_content_package(package_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230901preview:getContentPackage', __args__, opts=opts, typ=GetContentPackageResult).value
...
def get_content_package_output(package_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230901preview:getContentPackage', __args__, opts=opts, typ=GetContentPackageResult)
