...
def get_hunt_comment(hunt_comment_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230901preview:getHuntComment', __args__, opts=opts, typ=GetHuntCommentResult).value
...
def get_hunt_comment_output(hunt_comment_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230901preview:getHuntComment', __args__, opts=opts, typ=GetHuntCommentResult)
