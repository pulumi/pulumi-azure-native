...
class FusionAlertRuleArgs:
    def __init__(__self__, *,
                 alert_rule_template_name: pulumi.Input[_builtins.str],
    ...
    def alert_rule_template_name(self, value: pulumi.Input[_builtins.str]):
