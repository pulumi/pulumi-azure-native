...
class ScheduledAlertRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] query: The query that creates alerts for this rule.
        ...
        :param pulumi.Input[_builtins.int] trigger_threshold: The threshold triggers this alert rule.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] custom_details: Dictionary of string key-value pairs of columns to be attached to the alert
        :param pulumi.Input[_builtins.str] description: The description of the alert rule.
