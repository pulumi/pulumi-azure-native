...
class ScheduledAlertRuleArgs:
    def __init__(__self__, *,
                 ...
                 query_frequency: pulumi.Input[builtins.str],
                 query_period: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 severity: pulumi.Input[Union[builtins.str, 'AlertSeverity']],
                 suppression_duration: pulumi.Input[builtins.str],
                 suppression_enabled: pulumi.Input[builtins.bool],
                 trigger_operator: pulumi.Input['TriggerOperator'],
                 trigger_threshold: pulumi.Input[builtins.int],
                 ...
                 custom_details: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 tactics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AttackTactic']]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name for alerts created by this alert rule.
        ...
        :param pulumi.Input[builtins.str] query: The query that creates alerts for this rule.
        :param pulumi.Input[builtins.str] query_frequency: The frequency (in ISO 8601 duration format) for this alert rule to run.
        :param pulumi.Input[builtins.str] query_period: The period (in ISO 8601 duration format) that this alert rule looks at.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Union[builtins.str, 'AlertSeverity']] severity: The severity for alerts created by this alert rule.
        :param pulumi.Input[builtins.str] suppression_duration: The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
        :param pulumi.Input[builtins.bool] suppression_enabled: Determines whether the suppression for this alert rule is enabled or disabled.
        :param pulumi.Input['TriggerOperator'] trigger_operator: The operation against the threshold that triggers alert rule.
        :param pulumi.Input[builtins.int] trigger_threshold: The threshold triggers this alert rule.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_details: Dictionary of string key-value pairs of columns to be attached to the alert
        :param pulumi.Input[builtins.str] description: The description of the alert rule.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AttackTactic']]]] tactics: The tactics of the alert rule
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] techniques: The techniques of the alert rule
        :param pulumi.Input[builtins.str] template_version: The version of the alert rule template used to create this rule - in format <a.b.c>, where all are numbers, for example 0 <1.0.2>
        """
    ...
    def query_frequency(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def query_frequency(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "query_frequency", value)

    @property
    @pulumi.getter(name="queryPeriod")
    def query_period(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @query_period.setter
    def query_period(self, value: pulumi.Input[builtins.str]):
    ...
    def suppression_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def suppression_duration(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "suppression_duration", value)

    @property
    @pulumi.getter(name="suppressionEnabled")
    def suppression_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def suppression_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def trigger_threshold(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def trigger_threshold(self, value: pulumi.Input[builtins.int]):
    ...
    def alert_rule_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_rule_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_rule_template_name", value)

    @property
    @pulumi.getter(name="customDetails")
    def custom_details(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def custom_details(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter
    def tactics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AttackTactic']]]]]:
        """
    ...
    @tactics.setter
    def tactics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AttackTactic']]]]]):
...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 query_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 query_period: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 severity: Optional[pulumi.Input[Union[builtins.str, 'AlertSeverity']]] = None,
                 suppression_duration: Optional[pulumi.Input[builtins.str]] = None,
                 suppression_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tactics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'AttackTactic']]]]] = None,
                 techniques: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 template_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="alertRuleTemplateName")
    def alert_rule_template_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Name of the alert rule template used to create this rule.
        """
        return pulumi.get(self, "alert_rule_template_name")
    ...
    @property
    @pulumi.getter(name="customDetails")
    def custom_details(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Dictionary of string key-value pairs of columns to be attached to the alert
        """
        return pulumi.get(self, "custom_details")
    ...
    @property
    @pulumi.getter(name="queryFrequency")
    def query_frequency(self) -> pulumi.Output[builtins.str]:
        """
        The frequency (in ISO 8601 duration format) for this alert rule to run.
        """
        return pulumi.get(self, "query_frequency")
    ...
    @property
    @pulumi.getter(name="queryPeriod")
    def query_period(self) -> pulumi.Output[builtins.str]:
        """
        The period (in ISO 8601 duration format) that this alert rule looks at.
        """
        return pulumi.get(self, "query_period")
    ...
    @property
    @pulumi.getter(name="suppressionDuration")
    def suppression_duration(self) -> pulumi.Output[builtins.str]:
        """
        The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
        """
        return pulumi.get(self, "suppression_duration")
    ...
    @property
    @pulumi.getter(name="suppressionEnabled")
    def suppression_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Determines whether the suppression for this alert rule is enabled or disabled.
        """
        return pulumi.get(self, "suppression_enabled")
    ...
    @property
    @pulumi.getter(name="triggerOperator")
    def trigger_operator(self) -> pulumi.Output[builtins.str]:
        """
        The operation against the threshold that triggers alert rule.
        """
        return pulumi.get(self, "trigger_operator")
    ...
    @property
    @pulumi.getter(name="triggerThreshold")
    def trigger_threshold(self) -> pulumi.Output[builtins.int]:
        """
        The threshold triggers this alert rule.
        """
        return pulumi.get(self, "trigger_threshold")
