...
def get_hunt_relation(hunt_id: Optional[_builtins.str] = None,
                      hunt_relation_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hunt_relation_id: The hunt relation id (GUID)
...
def get_hunt_relation_output(hunt_id: pulumi.Input[Optional[_builtins.str]] = None,
                             hunt_relation_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
