...
def list_system_actions(agent_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str system_resource_name: The name of the system.
...
def list_system_actions_output(agent_resource_name: Optional[pulumi.Input[_builtins.str]] = None,
