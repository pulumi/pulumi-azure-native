...
def list_source_control_repositories(client_id: Optional[_builtins.str] = None,
                                     code: Optional[_builtins.str] = None,
                                     installation_id: Optional[_builtins.str] = None,
                                     kind: Optional[Union[_builtins.str, 'RepositoryAccessKind']] = None,
    ...
    :param Union[_builtins.str, 'RepositoryAccessKind'] kind: The kind of repository access credentials
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str state: OAuth State. Required when `kind` is `OAuth`
    :param _builtins.str token: Personal Access Token. Required when `kind` is `PAT`
