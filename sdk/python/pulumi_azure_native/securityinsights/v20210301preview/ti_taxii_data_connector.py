...
class TiTaxiiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20210301preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20210301preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
            ...
            data_types=azure_native.securityinsights.v20210301preview.TiTaxiiDataConnectorDataTypesArgs(
                taxii_client=azure_native.securityinsights.v20210301preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs(
                    state="Enabled",
                ),
            ),
