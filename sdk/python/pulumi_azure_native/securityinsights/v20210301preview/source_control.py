...
class SourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        source_control = azure_native.securityinsights.v20210301preview.SourceControl("sourceControl",
            content_types=[
                "AnalyticRules",
                "Workbook",
            ],
            ...
            repo_type="Github",
            repository=azure_native.securityinsights.v20210301preview.RepositoryResponseArgs(
                branch="master",
                display_url="https://github.com/user/repo",
                path_mapping=[
                    azure_native.securityinsights.v20210301preview.ContentPathMapArgs(
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20210301preview:SourceControl 789e0c1f-4a3d-43ad-809c-e713b677b04a /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalIinsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/sourcecontrols/789e0c1f-4a3d-43ad-809c-e713b677b04a 
        ```
