...
class EntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights:EntityQuery"), pulumi.Alias(type_="azure-nextgen:securityinsights:EntityQuery")])
