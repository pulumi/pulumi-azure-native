...
class OfficeATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_atp_data_connector = azure_native.securityinsights.v20210301preview.OfficeATPDataConnector("officeATPDataConnector",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20210301preview:OfficeATPDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
