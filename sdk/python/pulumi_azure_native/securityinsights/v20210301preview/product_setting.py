...
class ProductSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights:ProductSetting"), pulumi.Alias(type_="azure-nextgen:securityinsights:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:ProductSetting"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:ProductSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProductSetting, __self__).__init__(
            'azure-native:securityinsights/v20210301preview:ProductSetting',
            resource_name,
            __props__,
            opts)
