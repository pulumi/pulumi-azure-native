...
class MSTIDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:MSTIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:MSTIDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:MSTIDataConnector")])
