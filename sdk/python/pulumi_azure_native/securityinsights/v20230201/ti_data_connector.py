...
class TIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ti_data_connector = azure_native.securityinsights.v20230201.TIDataConnector("tiDataConnector",
        ...
        ti_data_connector = azure_native.securityinsights.v20230201.TIDataConnector("tiDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20230201.TIDataConnectorDataTypesResponseArgs(
                indicators=azure_native.securityinsights.v20230201.TIDataConnectorDataTypesIndicatorsArgs(
                    state="Enabled",
                ),
            ),
