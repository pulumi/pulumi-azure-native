...
warnings.warn("""azure-native:securityinsights/v20230201:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.""", DeprecationWarning)
...
class Bookmark(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Bookmark is deprecated: azure-native:securityinsights/v20230201:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Bookmark to guarantee forwards compatibility.""")
        ...
        super(Bookmark, __self__).__init__(
            'azure-native:securityinsights/v20230201:Bookmark',
            resource_name,
            __props__,
            opts)
