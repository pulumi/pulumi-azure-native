...
warnings.warn("""azure-native:securityinsights/v20230201:WatchlistItem is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:WatchlistItem to guarantee forwards compatibility.""", DeprecationWarning)
...
class WatchlistItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WatchlistItem, __self__).__init__(
            'azure-native:securityinsights/v20230201:WatchlistItem',
            resource_name,
            __props__,
            opts)
