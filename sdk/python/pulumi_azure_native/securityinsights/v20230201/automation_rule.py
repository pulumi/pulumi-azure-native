...
warnings.warn("""azure-native:securityinsights/v20230201:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:AutomationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class AutomationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(AutomationRule, __self__).__init__(
            'azure-native:securityinsights/v20230201:AutomationRule',
            resource_name,
            __props__,
            opts)
