...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_rule is deprecated: azure-native:securityinsights/v20230201:AutomationRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AutomationRule to guarantee forwards compatibility.""")
    __args__ = dict()
