...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        scheduled_alert_rule = azure_native.securityinsights.v20230201.ScheduledAlertRule("scheduledAlertRule",
        ...
        scheduled_alert_rule = azure_native.securityinsights.v20230201.ScheduledAlertRule("scheduledAlertRule",
            alert_details_override=azure_native.securityinsights.v20230201.AlertDetailsOverrideResponseArgs(
                ...
                alert_dynamic_properties=[
                    azure_native.securityinsights.v20230201.AlertPropertyMappingArgs(
            ...
            entity_mappings=[
                {
                    "entityType": "Host",
                    "fieldMappings": [azure_native.securityinsights.v20230201.FieldMappingArgs(
            ...
            event_grouping_settings=azure_native.securityinsights.v20230201.EventGroupingSettingsArgs(
                aggregation_kind="AlertPerResult",
            ),
            incident_configuration=azure_native.securityinsights.v20230201.IncidentConfigurationResponseArgs(
                create_incident=True,
                grouping_configuration=azure_native.securityinsights.v20230201.GroupingConfigurationArgs(
                    enabled=True,
            ...
            trigger_operator=azure_native.securityinsights/v20230201.TriggerOperator.GREATER_THAN,
            trigger_threshold=0,
            workspace_name="myWorkspace")
    ...
    def _internal_init(__self__,
        ...
        super(ScheduledAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20230201:ScheduledAlertRule',
            resource_name,
            __props__,
            opts)
