...
warnings.warn("""azure-native:securityinsights/v20230201:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ASCDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_asc_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asc_data_connector is deprecated: azure-native:securityinsights/v20230201:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ASCDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataConnectorId'] = data_connector_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230201:getASCDataConnector', __args__, opts=opts, typ=GetASCDataConnectorResult).value
