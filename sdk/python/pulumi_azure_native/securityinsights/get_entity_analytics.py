...
def get_entity_analytics(resource_group_name: Optional[_builtins.str] = None,
...
def get_entity_analytics_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
