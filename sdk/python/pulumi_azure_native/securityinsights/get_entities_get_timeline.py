...
def get_entities_get_timeline(end_time: Optional[_builtins.str] = None,
                              entity_id: Optional[_builtins.str] = None,
                              kinds: Optional[Sequence[Union[_builtins.str, 'EntityTimelineKind']]] = None,
                              number_of_bucket: Optional[_builtins.int] = None,
    ...
    :param _builtins.int number_of_bucket: The number of bucket for timeline queries aggregation.
