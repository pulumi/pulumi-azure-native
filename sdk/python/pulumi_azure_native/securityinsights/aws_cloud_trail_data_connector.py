...
class AwsCloudTrailDataConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_role_arn: The Aws Role Arn (with CloudTrailReadOnly policy) that is used to access the Aws account.
...
class AwsCloudTrailDataConnector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="awsRoleArn")
    def aws_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Aws Role Arn (with CloudTrailReadOnly policy) that is used to access the Aws account.
        """
        return pulumi.get(self, "aws_role_arn")
