...
def get_premium_microsoft_defender_for_threat_intelligence(data_connector_id: Optional[_builtins.str] = None,
...
def get_premium_microsoft_defender_for_threat_intelligence_output(data_connector_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
