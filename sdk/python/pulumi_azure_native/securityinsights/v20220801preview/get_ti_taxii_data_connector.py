...
warnings.warn("""azure-native:securityinsights/v20220801preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ti_taxii_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ti_taxii_data_connector is deprecated: azure-native:securityinsights/v20220801preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
