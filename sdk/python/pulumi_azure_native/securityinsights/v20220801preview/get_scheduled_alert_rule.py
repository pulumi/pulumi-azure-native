...
def get_scheduled_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_alert_rule is deprecated: azure-native:securityinsights/v20220801preview:ScheduledAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
