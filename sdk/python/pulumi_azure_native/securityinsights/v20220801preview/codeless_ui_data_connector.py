...
warnings.warn("""azure-native:securityinsights/v20220801preview:CodelessUiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:CodelessUiDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class CodelessUiDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CodelessUiDataConnector is deprecated: azure-native:securityinsights/v20220801preview:CodelessUiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:CodelessUiDataConnector to guarantee forwards compatibility.""")
