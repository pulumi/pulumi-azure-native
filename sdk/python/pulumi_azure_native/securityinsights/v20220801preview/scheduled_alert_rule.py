...
warnings.warn("""azure-native:securityinsights/v20220801preview:ScheduledAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
