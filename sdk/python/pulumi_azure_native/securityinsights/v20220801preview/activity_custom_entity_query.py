...
warnings.warn("""azure-native:securityinsights/v20220801preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.""", DeprecationWarning)
...
class ActivityCustomEntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ActivityCustomEntityQuery is deprecated: azure-native:securityinsights/v20220801preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.""")
