...
def get_aws_s3_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220801preview:getAwsS3DataConnector', __args__, opts=opts, typ=GetAwsS3DataConnectorResult)
