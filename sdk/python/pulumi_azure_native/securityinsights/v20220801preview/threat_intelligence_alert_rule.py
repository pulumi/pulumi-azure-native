...
class ThreatIntelligenceAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        threat_intelligence_alert_rule = azure_native.securityinsights.v20220801preview.ThreatIntelligenceAlertRule("threatIntelligenceAlertRule",
