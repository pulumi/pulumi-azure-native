...
def get_ti_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ti_data_connector is deprecated: azure-native:securityinsights/v20220801preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:TIDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
