...
def get_msti_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_msti_data_connector is deprecated: azure-native:securityinsights/v20220801preview:MSTIDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:MSTIDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
