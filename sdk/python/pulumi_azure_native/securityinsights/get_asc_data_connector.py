...
class GetASCDataConnectorResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_types=None, etag=None, id=None, kind=None, name=None, subscription_id=None, system_data=None, type=None):
...
def get_asc_data_connector(data_connector_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights:getASCDataConnector', __args__, opts=opts, typ=GetASCDataConnectorResult).value
...
def get_asc_data_connector_output(data_connector_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights:getASCDataConnector', __args__, opts=opts, typ=GetASCDataConnectorResult)
