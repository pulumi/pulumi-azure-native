...
def get_bookmark_relation(bookmark_id: Optional[builtins.str] = None,
...
def get_bookmark_relation_output(bookmark_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights:getBookmarkRelation', __args__, opts=opts, typ=GetBookmarkRelationResult)
