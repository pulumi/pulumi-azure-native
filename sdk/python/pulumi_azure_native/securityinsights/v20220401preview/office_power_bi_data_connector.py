...
class OfficePowerBIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_power_bi_data_connector = azure_native.securityinsights.v20220401preview.OfficePowerBIDataConnector("officePowerBIDataConnector",
        ...
        office_power_bi_data_connector = azure_native.securityinsights.v20220401preview.OfficePowerBIDataConnector("officePowerBIDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20220401preview.OfficePowerBIConnectorDataTypesArgs(
                logs=azure_native.securityinsights.v20220401preview.OfficePowerBIConnectorDataTypesLogsArgs(
                    state="Enabled",
                ),
            ),
            kind="OfficePowerBI",
    ...
    def _internal_init(__self__,
        ...
        super(OfficePowerBIDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20220401preview:OfficePowerBIDataConnector',
            resource_name,
            __props__,
            opts)
