...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mcas_data_connector = azure_native.securityinsights.v20220401preview.MCASDataConnector("mcasDataConnector",
    ...
    def _internal_init(__self__,
        ...
        super(MCASDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20220401preview:MCASDataConnector',
            resource_name,
            __props__,
            opts)
