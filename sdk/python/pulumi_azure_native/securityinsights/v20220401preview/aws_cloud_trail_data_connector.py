...
class AwsCloudTrailDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aws_cloud_trail_data_connector = azure_native.securityinsights.v20220401preview.AwsCloudTrailDataConnector("awsCloudTrailDataConnector",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20220401preview:AwsCloudTrailDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
