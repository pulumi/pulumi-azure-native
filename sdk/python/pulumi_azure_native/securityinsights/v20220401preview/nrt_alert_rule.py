...
class NrtAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        nrt_alert_rule = azure_native.securityinsights.v20220401preview.NrtAlertRule("nrtAlertRule",
