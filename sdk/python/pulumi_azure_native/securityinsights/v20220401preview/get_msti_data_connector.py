...
def get_msti_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220401preview:getMSTIDataConnector', __args__, opts=opts, typ=GetMSTIDataConnectorResult)
