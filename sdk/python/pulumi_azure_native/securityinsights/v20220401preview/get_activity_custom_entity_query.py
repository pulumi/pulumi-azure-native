...
warnings.warn("""azure-native:securityinsights/v20220401preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_activity_custom_entity_query(entity_query_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_activity_custom_entity_query is deprecated: azure-native:securityinsights/v20220401preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery to guarantee forwards compatibility.""")
    __args__ = dict()
