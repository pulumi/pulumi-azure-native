...
class ProductSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220101preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220501preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220601preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220901preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221001preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221101preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221201preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20230201preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20230301preview:ProductSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProductSetting, __self__).__init__(
            'azure-native:securityinsights/v20220401preview:ProductSetting',
            resource_name,
            __props__,
            opts)
