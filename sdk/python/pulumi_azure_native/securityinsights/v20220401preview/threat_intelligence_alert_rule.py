...
warnings.warn("""azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class ThreatIntelligenceAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ThreatIntelligenceAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule',
            resource_name,
            __props__,
            opts)
