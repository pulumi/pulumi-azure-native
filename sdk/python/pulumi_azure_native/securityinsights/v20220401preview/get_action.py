...
def get_action(action_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action is deprecated: azure-native:securityinsights/v20220401preview:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.""")
    __args__ = dict()
