...
warnings.warn("""azure-native:securityinsights/v20220401preview:Watchlist is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_watchlist(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watchlist is deprecated: azure-native:securityinsights/v20220401preview:Watchlist is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['watchlistAlias'] = watchlist_alias
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20220401preview:getWatchlist', __args__, opts=opts, typ=GetWatchlistResult).value
