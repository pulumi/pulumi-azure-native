...
class OfficeATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_atp_data_connector = azure_native.securityinsights.v20220401preview.OfficeATPDataConnector("officeATPDataConnector",
