...
warnings.warn("""azure-native:securityinsights/v20220401preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Ueba to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ueba(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ueba is deprecated: azure-native:securityinsights/v20220401preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:Ueba to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['settingsName'] = settings_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20220401preview:getUeba', __args__, opts=opts, typ=GetUebaResult).value
