...
class MLBehaviorAnalyticsAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ml_behavior_analytics_alert_rule = azure_native.securityinsights.v20220401preview.MLBehaviorAnalyticsAlertRule("mlBehaviorAnalyticsAlertRule",
