...
def get_mcas_data_connector(data_connector_id: Optional[builtins.str] = None,
...
def get_mcas_data_connector_output(data_connector_id: Optional[pulumi.Input[builtins.str]] = None,
