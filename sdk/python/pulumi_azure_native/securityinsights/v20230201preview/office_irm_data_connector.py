...
class OfficeIRMDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_irm_data_connector = azure_native.securityinsights.v20230201preview.OfficeIRMDataConnector("officeIRMDataConnector",
    ...
    def _internal_init(__self__,
        ...
        super(OfficeIRMDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230201preview:OfficeIRMDataConnector',
            resource_name,
            __props__,
            opts)
