...
class MicrosoftPurviewInformationProtectionDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        microsoft_purview_information_protection_data_connector = azure_native.securityinsights.v20230201preview.MicrosoftPurviewInformationProtectionDataConnector("microsoftPurviewInformationProtectionDataConnector",
        ...
        microsoft_purview_information_protection_data_connector = azure_native.securityinsights.v20230201preview.MicrosoftPurviewInformationProtectionDataConnector("microsoftPurviewInformationProtectionDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20230201preview.MicrosoftPurviewInformationProtectionConnectorDataTypesArgs(
                logs=azure_native.securityinsights.v20230201preview.MicrosoftPurviewInformationProtectionConnectorDataTypesLogsArgs(
                    state="Enabled",
                ),
            ),
