...
warnings.warn("""azure-native:securityinsights/v20230201preview:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ScheduledAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scheduled_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scheduled_alert_rule is deprecated: azure-native:securityinsights/v20230201preview:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ScheduledAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
