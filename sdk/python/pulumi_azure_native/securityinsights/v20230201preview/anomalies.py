...
class Anomalies(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        anomalies = azure_native.securityinsights.v20230201preview.Anomalies("anomalies",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20230201preview:Anomalies EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
        ```
