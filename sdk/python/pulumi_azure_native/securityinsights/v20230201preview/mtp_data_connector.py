...
class MTPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mtp_data_connector = azure_native.securityinsights.v20230201preview.MTPDataConnector("mtpDataConnector",
        ...
        mtp_data_connector = azure_native.securityinsights.v20230201preview.MTPDataConnector("mtpDataConnector",
            ...
            data_types=azure_native.securityinsights.v20230201preview.MTPDataConnectorDataTypesArgs(
                alerts=azure_native.securityinsights.v20230201preview.MTPDataConnectorDataTypesAlertsArgs(
                    state="Enabled",
                ),
                incidents=azure_native.securityinsights.v20230201preview.MTPDataConnectorDataTypesIncidentsArgs(
                    state="Disabled",
                ),
            ),
            filtered_providers=azure_native.securityinsights.v20230201preview.MtpFilteredProvidersResponseArgs(
