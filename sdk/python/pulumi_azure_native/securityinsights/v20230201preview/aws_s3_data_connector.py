...
class AwsS3DataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aws_s3_data_connector = azure_native.securityinsights.v20230201preview.AwsS3DataConnector("awsS3DataConnector",
