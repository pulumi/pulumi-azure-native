...
class AwsCloudTrailDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aws_cloud_trail_data_connector = azure_native.securityinsights.v20230201preview.AwsCloudTrailDataConnector("awsCloudTrailDataConnector",
