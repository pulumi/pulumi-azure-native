...
warnings.warn("""azure-native:securityinsights/v20230201preview:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AwsCloudTrailDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
