...
class EyesOn(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        eyes_on = azure_native.securityinsights.v20230201preview.EyesOn("eyesOn",
            kind="EyesOn",
