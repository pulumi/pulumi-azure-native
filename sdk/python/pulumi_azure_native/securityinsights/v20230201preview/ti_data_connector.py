...
warnings.warn("""azure-native:securityinsights/v20230201preview:TIDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:TIDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
