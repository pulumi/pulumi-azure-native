...
def get_incident_comment(incident_comment_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident_comment is deprecated: azure-native:securityinsights/v20230201preview:IncidentComment is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:IncidentComment to guarantee forwards compatibility.""")
    __args__ = dict()
