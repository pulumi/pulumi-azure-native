...
warnings.warn("""azure-native:securityinsights/v20230201preview:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FusionAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_fusion_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_fusion_alert_rule is deprecated: azure-native:securityinsights/v20230201preview:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:FusionAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
