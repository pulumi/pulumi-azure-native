...
def get_incident_task(incident_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident_task is deprecated: azure-native:securityinsights/v20230201preview:IncidentTask is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IncidentTask to guarantee forwards compatibility.""")
    __args__ = dict()
