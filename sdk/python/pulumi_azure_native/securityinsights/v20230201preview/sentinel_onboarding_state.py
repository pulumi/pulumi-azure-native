...
warnings.warn("""azure-native:securityinsights/v20230201preview:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:SentinelOnboardingState to guarantee forwards compatibility.""", DeprecationWarning)
...
class SentinelOnboardingState(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SentinelOnboardingState, __self__).__init__(
            'azure-native:securityinsights/v20230201preview:SentinelOnboardingState',
            resource_name,
            __props__,
            opts)
