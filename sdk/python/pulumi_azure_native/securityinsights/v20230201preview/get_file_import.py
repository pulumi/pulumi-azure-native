...
def get_file_import(file_import_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_import is deprecated: azure-native:securityinsights/v20230201preview:FileImport is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:FileImport to guarantee forwards compatibility.""")
    __args__ = dict()
