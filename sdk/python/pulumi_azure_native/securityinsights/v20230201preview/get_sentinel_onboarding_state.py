...
def get_sentinel_onboarding_state(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sentinel_onboarding_state is deprecated: azure-native:securityinsights/v20230201preview:SentinelOnboardingState is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SentinelOnboardingState to guarantee forwards compatibility.""")
    __args__ = dict()
