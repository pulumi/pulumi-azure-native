...
def get_sentinel_onboarding_state(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sentinel_onboarding_state is deprecated: azure-native:securityinsights/v20230201preview:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:SentinelOnboardingState to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['sentinelOnboardingStateName'] = sentinel_onboarding_state_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230201preview:getSentinelOnboardingState', __args__, opts=opts, typ=GetSentinelOnboardingStateResult).value
