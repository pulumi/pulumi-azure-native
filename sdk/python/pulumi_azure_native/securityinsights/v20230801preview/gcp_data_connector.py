...
class GCPDataConnectorArgs:
    ...
    def _configure(
             ...
             auth: Optional[pulumi.Input['GCPAuthPropertiesArgs']] = None,
             connector_definition_name: Optional[pulumi.Input[str]] = None,
             kind: Optional[pulumi.Input[str]] = None,
             request: Optional[pulumi.Input['GCPRequestPropertiesArgs']] = None,
        ...
        if connector_definition_name is None and 'connectorDefinitionName' in kwargs:
            connector_definition_name = kwargs['connectorDefinitionName']
        if connector_definition_name is None:
            raise TypeError("Missing 'connector_definition_name' argument")
        if kind is None:
        ...
        if dcr_config is None and 'dcrConfig' in kwargs:
            dcr_config = kwargs['dcrConfig']
...
class GCPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auth = _utilities.configure(auth, GCPAuthPropertiesArgs, True)
            ...
            dcr_config = _utilities.configure(dcr_config, DCRConfigurationArgs, True)
            __props__.__dict__["dcr_config"] = dcr_config
            if kind is None and not opts.urn:
                raise TypeError("Missing required property 'kind'")
            __props__.__dict__["kind"] = 'GCP'
            request = _utilities.configure(request, GCPRequestPropertiesArgs, True)
