...
class GCPDataConnectorArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'connectorDefinitionName' in kwargs:
...
class GCPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auth is not None and not isinstance(auth, GCPAuthPropertiesArgs):
                auth = auth or {}
                def _setter(key, value):
                    auth[key] = value
            ...
            if dcr_config is not None and not isinstance(dcr_config, DCRConfigurationArgs):
            ...
            if request is not None and not isinstance(request, GCPRequestPropertiesArgs):
                request = request or {}
                def _setter(key, value):
                    request[key] = value
