...
def get_incident_relation(incident_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230801preview:getIncidentRelation', __args__, opts=opts, typ=GetIncidentRelationResult).value
...
def get_incident_relation_output(incident_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230801preview:getIncidentRelation', __args__, opts=opts, typ=GetIncidentRelationResult)
