...
class WorkspaceManagerAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20231001preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights:WorkspaceManagerAssignment")])
