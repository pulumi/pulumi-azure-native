...
class MicrosoftPurviewInformationProtectionDataConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        MicrosoftPurviewInformationProtectionDataConnectorArgs._configure(
    ...
    def _configure(
             ...
             data_types: Optional[pulumi.Input['MicrosoftPurviewInformationProtectionConnectorDataTypesArgs']] = None,
        ...
        _setter("kind", 'MicrosoftPurviewInformationProtection')
...
class MicrosoftPurviewInformationProtectionDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_connector_id: Optional[pulumi.Input[str]] = None,
                 data_types: Optional[pulumi.Input[pulumi.InputType['MicrosoftPurviewInformationProtectionConnectorDataTypesArgs']]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 workspace_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] data_connector_id: Connector ID
        :param pulumi.Input[pulumi.InputType['MicrosoftPurviewInformationProtectionConnectorDataTypesArgs']] data_types: The available data types for the connector.
        :param pulumi.Input[str] kind: The kind of the data connector
               Expected value is 'MicrosoftPurviewInformationProtection'.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] tenant_id: The tenant id to connect to, and get the data from.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MicrosoftPurviewInformationProtectionDataConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            data_types = _utilities.configure(data_types, MicrosoftPurviewInformationProtectionConnectorDataTypesArgs, True)
