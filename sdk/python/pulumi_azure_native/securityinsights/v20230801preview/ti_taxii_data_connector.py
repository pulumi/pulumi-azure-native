...
class TiTaxiiDataConnectorArgs:
    ...
    def _configure(
        ...
        if 'taxiiLookbackPeriod' in kwargs:
            taxii_lookback_period = kwargs['taxiiLookbackPeriod']
        if 'taxiiServer' in kwargs:
