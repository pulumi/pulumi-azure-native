...
class WorkspaceManagerMemberArgs:
    def __init__(__self__, *,
                 ...
                 target_workspace_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] target_workspace_id: Fully qualified resource ID of the target Sentinel workspace joining the given Sentinel workspace manager
    ...
    def _configure(
        ...
        _setter("target_workspace_id", target_workspace_id)
    ...
    def target_workspace_id(self) -> pulumi.Input[str]:
        """
    ...
    def target_workspace_id(self, value: pulumi.Input[str]):
...
class WorkspaceManagerMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 target_workspace_id: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target_workspace_id is None and not opts.urn:
                raise TypeError("Missing required property 'target_workspace_id'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:WorkspaceManagerMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceManagerMember, __self__).__init__(
            'azure-native:securityinsights/v20230801preview:WorkspaceManagerMember',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["system_data"] = None
        __props__.__dict__["target_workspace_id"] = None
    ...
    @property
    @pulumi.getter(name="targetWorkspaceId")
    def target_workspace_id(self) -> pulumi.Output[str]:
        """
        Fully qualified resource ID of the target Sentinel workspace joining the given Sentinel workspace manager
        """
        return pulumi.get(self, "target_workspace_id")
