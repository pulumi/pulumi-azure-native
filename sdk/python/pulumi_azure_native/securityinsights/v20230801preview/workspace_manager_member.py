...
class WorkspaceManagerMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20231001preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:WorkspaceManagerMember"), pulumi.Alias(type_="azure-native:securityinsights:WorkspaceManagerMember")])
