...
class MTPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_connector_id: Optional[pulumi.Input[str]] = None,
                 data_types: Optional[pulumi.Input[Union['MTPDataConnectorDataTypesArgs', 'MTPDataConnectorDataTypesArgsDict']]] = None,
                 filtered_providers: Optional[pulumi.Input[Union['MtpFilteredProvidersArgs', 'MtpFilteredProvidersArgsDict']]] = None,
        ...
        :param pulumi.Input[str] data_connector_id: Connector ID
        :param pulumi.Input[Union['MTPDataConnectorDataTypesArgs', 'MTPDataConnectorDataTypesArgsDict']] data_types: The available data types for the connector.
        :param pulumi.Input[Union['MtpFilteredProvidersArgs', 'MtpFilteredProvidersArgsDict']] filtered_providers: The available filtered providers for the connector.
        :param pulumi.Input[str] kind: The kind of the data connector
               Expected value is 'MicrosoftThreatProtection'.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] tenant_id: The tenant id to connect to, and get the data from.
