...
def get_workspace_manager_member(resource_group_name: Optional[_builtins.str] = None,
                                 workspace_manager_member_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workspace_manager_member_name: The name of the workspace manager member
...
def get_workspace_manager_member_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                        workspace_manager_member_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
