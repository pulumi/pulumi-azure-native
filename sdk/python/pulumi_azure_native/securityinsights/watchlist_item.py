...
class WatchlistItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_deleted: A flag that indicates if the watchlist item is deleted or not
