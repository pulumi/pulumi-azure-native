...
class Metadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:Metadatum"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:Metadatum"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:Metadatum")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Metadatum, __self__).__init__(
            'azure-native:securityinsights:Metadatum',
            resource_name,
            __props__,
            opts)
