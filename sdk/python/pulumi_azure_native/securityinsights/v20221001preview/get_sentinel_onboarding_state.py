...
warnings.warn("""azure-native:securityinsights/v20221001preview:SentinelOnboardingState is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SentinelOnboardingState to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sentinel_onboarding_state(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sentinel_onboarding_state is deprecated: azure-native:securityinsights/v20221001preview:SentinelOnboardingState is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SentinelOnboardingState to guarantee forwards compatibility.""")
    __args__ = dict()
