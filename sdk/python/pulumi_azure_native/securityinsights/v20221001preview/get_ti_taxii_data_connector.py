...
warnings.warn("""azure-native:securityinsights/v20221001preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
