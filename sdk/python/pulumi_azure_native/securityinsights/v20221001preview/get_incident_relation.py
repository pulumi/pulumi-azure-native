...
def get_incident_relation(incident_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident_relation is deprecated: azure-native:securityinsights/v20221001preview:IncidentRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentRelation to guarantee forwards compatibility.""")
    __args__ = dict()
