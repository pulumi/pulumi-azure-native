...
def get_bookmark_relation_output(bookmark_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20221001preview:getBookmarkRelation', __args__, opts=opts, typ=GetBookmarkRelationResult)
