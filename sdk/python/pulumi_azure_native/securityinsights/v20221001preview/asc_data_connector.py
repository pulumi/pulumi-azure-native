...
class ASCDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        asc_data_connector = azure_native.securityinsights.v20221001preview.ASCDataConnector("ascDataConnector",
