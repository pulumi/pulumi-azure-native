...
__all__ = ['Office365ProjectDataConnectorArgs', 'Office365ProjectDataConnector']

@pulumi.input_type
class Office365ProjectDataConnectorArgs:
    def __init__(__self__, *,
                 data_types: pulumi.Input['Office365ProjectConnectorDataTypesArgs'],
        ...
        :param pulumi.Input['Office365ProjectConnectorDataTypesArgs'] data_types: The available data types for the connector.
        ...
        pulumi.set(__self__, "kind", 'Office365Project')
    ...
    def data_types(self) -> pulumi.Input['Office365ProjectConnectorDataTypesArgs']:
        """
    ...
    @data_types.setter
    def data_types(self, value: pulumi.Input['Office365ProjectConnectorDataTypesArgs']):
...
class Office365ProjectDataConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_connector_id: Optional[pulumi.Input[str]] = None,
                 data_types: Optional[pulumi.Input[pulumi.InputType['Office365ProjectConnectorDataTypesArgs']]] = None,
        ...
        office365_project_data_connector = azure_native.securityinsights.v20221001preview.Office365ProjectDataConnector("office365ProjectDataConnector",
        ...
        office365_project_data_connector = azure_native.securityinsights.v20221001preview.Office365ProjectDataConnector("office365ProjectDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20221001preview.Office365ProjectConnectorDataTypesArgs(
                logs=azure_native.securityinsights.v20221001preview.Office365ProjectConnectorDataTypesLogsArgs(
                    state="Enabled",
                ),
            ),
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20221001preview:Office365ProjectDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] data_connector_id: Connector ID
        :param pulumi.Input[pulumi.InputType['Office365ProjectConnectorDataTypesArgs']] data_types: The available data types for the connector.
        :param pulumi.Input[str] kind: The kind of the data connector
               Expected value is 'Office365Project'.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] tenant_id: The tenant id to connect to, and get the data from.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Office365ProjectDataConnectorArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Represents Office Microsoft Project data connector.
        ...
        :param str resource_name: The name of the resource.
        :param Office365ProjectDataConnectorArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Office365ProjectDataConnectorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Office365ProjectDataConnectorArgs.__new__(Office365ProjectDataConnectorArgs)
            ...
            __props__.__dict__["kind"] = 'Office365Project'
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Office365ProjectDataConnector':
        """
        ...
        __props__.__dict__["type"] = None
        return Office365ProjectDataConnector(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="dataTypes")
    def data_types(self) -> pulumi.Output['outputs.Office365ProjectConnectorDataTypesResponse']:
        """
        The available data types for the connector.
        """
        return pulumi.get(self, "data_types")
