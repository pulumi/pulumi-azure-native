...
class EyesOn(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        eyes_on = azure_native.securityinsights.v20221001preview.EyesOn("eyesOn",
            kind="EyesOn",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20221001preview:EyesOn EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
        ```
