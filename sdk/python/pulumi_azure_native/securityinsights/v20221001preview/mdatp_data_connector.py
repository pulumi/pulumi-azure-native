...
warnings.warn("""azure-native:securityinsights/v20221001preview:MDATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class MDATPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MDATPDataConnector is deprecated: azure-native:securityinsights/v20221001preview:MDATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.""")
