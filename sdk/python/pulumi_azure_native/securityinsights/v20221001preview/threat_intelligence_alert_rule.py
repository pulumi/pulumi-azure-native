...
class ThreatIntelligenceAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        threat_intelligence_alert_rule = azure_native.securityinsights.v20221001preview.ThreatIntelligenceAlertRule("threatIntelligenceAlertRule",
