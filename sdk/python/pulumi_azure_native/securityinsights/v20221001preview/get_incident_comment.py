...
def get_incident_comment_output(incident_comment_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20221001preview:getIncidentComment', __args__, opts=opts, typ=GetIncidentCommentResult)
