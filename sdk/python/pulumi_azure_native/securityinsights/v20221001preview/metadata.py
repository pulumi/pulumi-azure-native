...
warnings.warn("""azure-native:securityinsights/v20221001preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.""", DeprecationWarning)
...
class Metadata(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Metadata is deprecated: azure-native:securityinsights/v20221001preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.""")
        ...
        super(Metadata, __self__).__init__(
            'azure-native:securityinsights/v20221001preview:Metadata',
            resource_name,
            __props__,
            opts)
