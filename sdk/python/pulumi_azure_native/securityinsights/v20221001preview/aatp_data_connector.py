...
class AATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aatp_data_connector = azure_native.securityinsights.v20221001preview.AATPDataConnector("aatpDataConnector",
