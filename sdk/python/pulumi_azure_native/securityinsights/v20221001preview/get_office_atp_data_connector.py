...
warnings.warn("""azure-native:securityinsights/v20221001preview:OfficeATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficeATPDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_office_atp_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_office_atp_data_connector is deprecated: azure-native:securityinsights/v20221001preview:OfficeATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficeATPDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
