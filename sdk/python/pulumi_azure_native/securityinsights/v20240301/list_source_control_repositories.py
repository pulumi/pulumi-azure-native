...
def list_source_control_repositories(client_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240301:listSourceControlRepositories', __args__, opts=opts, typ=ListSourceControlRepositoriesResult).value
