...
def get_metadata(metadata_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240301:getMetadata', __args__, opts=opts, typ=GetMetadataResult).value
...
def get_metadata_output(metadata_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240301:getMetadata', __args__, opts=opts, typ=GetMetadataResult)
