...
class WatchlistArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] raw_content: The raw content that represents to watchlist items to create. Example : This line will be skipped
               header1,header2
               value1,value2
        :param pulumi.Input[str] source: The source of the watchlist. Only accepts "Local file" and "Remote storage". And it must included in the request.
