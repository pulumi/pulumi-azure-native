...
class ASCDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        asc_data_connector = azure_native.securityinsights.v20221201preview.ASCDataConnector("ascDataConnector",
    ...
    def _internal_init(__self__,
        ...
        super(ASCDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:ASCDataConnector',
            resource_name,
            __props__,
            opts)
