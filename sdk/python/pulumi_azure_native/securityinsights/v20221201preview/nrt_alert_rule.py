...
warnings.warn("""azure-native:securityinsights/v20221201preview:NrtAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class NrtAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""NrtAlertRule is deprecated: azure-native:securityinsights/v20221201preview:NrtAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:NrtAlertRule to guarantee forwards compatibility.""")
        ...
        super(NrtAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:NrtAlertRule',
            resource_name,
            __props__,
            opts)
