...
class NrtAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        nrt_alert_rule = azure_native.securityinsights.v20221201preview.NrtAlertRule("nrtAlertRule",
        ...
        nrt_alert_rule = azure_native.securityinsights.v20221201preview.NrtAlertRule("nrtAlertRule",
            ...
            display_name="Rule2",
            enabled=True,
            event_grouping_settings=azure_native.securityinsights.v20221201preview.EventGroupingSettingsArgs(
                aggregation_kind="AlertPerResult",
            ),
            incident_configuration=azure_native.securityinsights.v20221201preview.IncidentConfigurationResponseArgs(
                create_incident=True,
                grouping_configuration=azure_native.securityinsights.v20221201preview.GroupingConfigurationArgs(
                    enabled=True,
                    group_by_entities=[
                        "Host",
                        "Account",
