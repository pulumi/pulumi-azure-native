...
warnings.warn("""azure-native:securityinsights/v20221201preview:Dynamics365DataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Dynamics365DataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class Dynamics365DataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Dynamics365DataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:Dynamics365DataConnector',
            resource_name,
            __props__,
            opts)
