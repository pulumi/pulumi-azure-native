...
warnings.warn("""azure-native:securityinsights/v20221201preview:AADDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class AADDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AADDataConnector is deprecated: azure-native:securityinsights/v20221201preview:AADDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AADDataConnector to guarantee forwards compatibility.""")
        ...
        super(AADDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:AADDataConnector',
            resource_name,
            __props__,
            opts)
