...
class ActivityCustomEntityQuery(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        activity_custom_entity_query = azure_native.securityinsights.v20221201preview.ActivityCustomEntityQuery("activityCustomEntityQuery",
            ...
            kind="Activity",
            query_definitions=azure_native.securityinsights.v20221201preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs(
