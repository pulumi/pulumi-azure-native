...
warnings.warn("""azure-native:securityinsights/v20221201preview:EntityAnalytics is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:EntityAnalytics to guarantee forwards compatibility.""", DeprecationWarning)
