...
warnings.warn("""azure-native:securityinsights/v20221201preview:EntityAnalytics is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:EntityAnalytics to guarantee forwards compatibility.""", DeprecationWarning)
...
class EntityAnalytics(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(EntityAnalytics, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:EntityAnalytics',
            resource_name,
            __props__,
            opts)
