...
class MTPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mtp_data_connector = azure_native.securityinsights.v20221201preview.MTPDataConnector("mtpDataConnector",
    ...
    def _internal_init(__self__,
        ...
        super(MTPDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:MTPDataConnector',
            resource_name,
            __props__,
            opts)
