...
def get_fusion_alert_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20221201preview:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult)
