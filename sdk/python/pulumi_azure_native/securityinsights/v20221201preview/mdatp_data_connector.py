...
class MDATPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MDATPDataConnector is deprecated: azure-native:securityinsights/v20221201preview:MDATPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:MDATPDataConnector to guarantee forwards compatibility.""")
        ...
        super(MDATPDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:MDATPDataConnector',
            resource_name,
            __props__,
            opts)
