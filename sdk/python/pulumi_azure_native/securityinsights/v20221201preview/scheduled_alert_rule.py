...
warnings.warn("""azure-native:securityinsights/v20221201preview:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:ScheduledAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ScheduledAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:ScheduledAlertRule',
            resource_name,
            __props__,
            opts)
