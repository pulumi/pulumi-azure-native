...
warnings.warn("""azure-native:securityinsights/v20221201preview:Watchlist is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.""", DeprecationWarning)
...
class Watchlist(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Watchlist is deprecated: azure-native:securityinsights/v20221201preview:Watchlist is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.""")
        ...
        super(Watchlist, __self__).__init__(
            'azure-native:securityinsights/v20221201preview:Watchlist',
            resource_name,
            __props__,
            opts)
