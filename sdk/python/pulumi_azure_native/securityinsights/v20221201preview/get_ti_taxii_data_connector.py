...
warnings.warn("""azure-native:securityinsights/v20221201preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:TiTaxiiDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
