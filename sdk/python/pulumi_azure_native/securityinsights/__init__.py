...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityinsights:Action":
            ...
            elif typ == "azure-native:securityinsights:DataConnector":
                return DataConnector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights:Incident":
                return Incident(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights:IncidentComment":
                return IncidentComment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights:IncidentRelation":
                return IncidentRelation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights:ProductSetting":
                return ProductSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights:ThreatIntelligenceIndicator":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityinsights", _module_instance)
