...
class IncidentAdditionalDataResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "mergedIncidentNumber":
            suggest = "merged_incident_number"
        elif key == "mergedIncidentUrl":
            suggest = "merged_incident_url"
    ...
    def __init__(__self__, *,
                 ...
                 bookmarks_count: int,
                 comments_count: int,
                 merged_incident_number: str,
                 merged_incident_url: str,
        ...
        :param str merged_incident_number: The incident number of the incident that the current incident was merged into
        :param str merged_incident_url: The URL to the incident that the current incident was merged into
        ...
        pulumi.set(__self__, "merged_incident_number", merged_incident_number)
        pulumi.set(__self__, "merged_incident_url", merged_incident_url)
    ...
    @property
    @pulumi.getter(name="mergedIncidentNumber")
    def merged_incident_number(self) -> str:
        """
        The incident number of the incident that the current incident was merged into
        """
        return pulumi.get(self, "merged_incident_number")

    @property
    @pulumi.getter(name="mergedIncidentUrl")
    def merged_incident_url(self) -> str:
        """
        The URL to the incident that the current incident was merged into
        """
        return pulumi.get(self, "merged_incident_url")
