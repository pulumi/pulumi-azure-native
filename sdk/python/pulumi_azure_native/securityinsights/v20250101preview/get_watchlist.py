...
def get_watchlist(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250101preview:getWatchlist', __args__, opts=opts, typ=GetWatchlistResult).value
...
def get_watchlist_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250101preview:getWatchlist', __args__, opts=opts, typ=GetWatchlistResult)
