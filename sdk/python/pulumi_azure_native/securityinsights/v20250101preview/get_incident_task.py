...
def get_incident_task(incident_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250101preview:getIncidentTask', __args__, opts=opts, typ=GetIncidentTaskResult).value
...
def get_incident_task_output(incident_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250101preview:getIncidentTask', __args__, opts=opts, typ=GetIncidentTaskResult)
