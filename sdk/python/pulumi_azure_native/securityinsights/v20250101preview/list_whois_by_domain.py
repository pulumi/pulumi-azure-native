...
def list_whois_by_domain(domain: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250101preview:listWhoisByDomain', __args__, opts=opts, typ=ListWhoisByDomainResult).value
...
def list_whois_by_domain_output(domain: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250101preview:listWhoisByDomain', __args__, opts=opts, typ=ListWhoisByDomainResult)
