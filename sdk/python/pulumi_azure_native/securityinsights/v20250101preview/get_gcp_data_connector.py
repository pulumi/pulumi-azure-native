...
def get_gcp_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250101preview:getGCPDataConnector', __args__, opts=opts, typ=GetGCPDataConnectorResult).value
...
def get_gcp_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250101preview:getGCPDataConnector', __args__, opts=opts, typ=GetGCPDataConnectorResult)
