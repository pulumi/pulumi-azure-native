...
def get_business_application_agent(agent_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250101preview:getBusinessApplicationAgent', __args__, opts=opts, typ=GetBusinessApplicationAgentResult).value
...
def get_business_application_agent_output(agent_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250101preview:getBusinessApplicationAgent', __args__, opts=opts, typ=GetBusinessApplicationAgentResult)
