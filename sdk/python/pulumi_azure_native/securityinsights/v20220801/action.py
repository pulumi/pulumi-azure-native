...
warnings.warn("""azure-native:securityinsights/v20220801:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.""", DeprecationWarning)
...
class Action(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Action is deprecated: azure-native:securityinsights/v20220801:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.""")
