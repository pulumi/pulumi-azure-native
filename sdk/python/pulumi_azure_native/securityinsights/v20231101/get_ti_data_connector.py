...
class GetTIDataConnectorResult:
    ...
    """
    def __init__(__self__, data_types=None, etag=None, id=None, kind=None, name=None, system_data=None, tenant_id=None, tip_lookback_period=None, type=None):
...
def get_ti_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20231101:getTIDataConnector', __args__, opts=opts, typ=GetTIDataConnectorResult).value
...
def get_ti_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20231101:getTIDataConnector', __args__, opts=opts, typ=GetTIDataConnectorResult)
    return __ret__.apply(lambda __response__: GetTIDataConnectorResult(
        ...
        tip_lookback_period=pulumi.get(__response__, 'tip_lookback_period'),
