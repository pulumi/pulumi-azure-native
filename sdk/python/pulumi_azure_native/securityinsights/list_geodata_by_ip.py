...
class ListGeodataByIpResult:
    ...
    @property
    @pulumi.getter
    def carrier(self) -> Optional[builtins.str]:
        """
    ...
    def city_confidence_factor(self) -> Optional[builtins.int]:
        """
    ...
    def country_confidence_factor(self) -> Optional[builtins.int]:
        """
    ...
    def ip_addr(self) -> Optional[builtins.str]:
        """
    ...
    def ip_routing_type(self) -> Optional[builtins.str]:
        """
    ...
    def organization_type(self) -> Optional[builtins.str]:
        """
    ...
    def state_code(self) -> Optional[builtins.str]:
        """
    ...
    def state_confidence_factor(self) -> Optional[builtins.int]:
        """
...
def list_geodata_by_ip(enrichment_type: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_address: The dotted-decimal or colon-separated string representation of the IP address
...
def list_geodata_by_ip_output(enrichment_type: Optional[pulumi.Input[builtins.str]] = None,
