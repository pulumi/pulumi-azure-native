...
class BookmarkArgs:
    ...
    def _configure(
        ...
        if incident_info is None and 'incidentInfo' in kwargs:
            incident_info = kwargs['incidentInfo']
        if query_end_time is None and 'queryEndTime' in kwargs:
            query_end_time = kwargs['queryEndTime']
        if query_result is None and 'queryResult' in kwargs:
            query_result = kwargs['queryResult']
...
class Bookmark(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            created_by = _utilities.configure(created_by, UserInfoArgs, True)
            __props__.__dict__["created_by"] = created_by
            if display_name is None and not opts.urn:
                raise TypeError("Missing required property 'display_name'")
            __props__.__dict__["display_name"] = display_name
            __props__.__dict__["event_time"] = event_time
            incident_info = _utilities.configure(incident_info, IncidentInfoArgs, True)
            ...
            updated_by = _utilities.configure(updated_by, UserInfoArgs, True)
