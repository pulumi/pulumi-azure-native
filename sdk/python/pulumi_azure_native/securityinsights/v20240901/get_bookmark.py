...
def get_bookmark(bookmark_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240901:getBookmark', __args__, opts=opts, typ=GetBookmarkResult).value
...
def get_bookmark_output(bookmark_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240901:getBookmark', __args__, opts=opts, typ=GetBookmarkResult)
