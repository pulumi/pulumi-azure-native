...
def get_sentinel_onboarding_state(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240901:getSentinelOnboardingState', __args__, opts=opts, typ=GetSentinelOnboardingStateResult).value
...
def get_sentinel_onboarding_state_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240901:getSentinelOnboardingState', __args__, opts=opts, typ=GetSentinelOnboardingStateResult)
