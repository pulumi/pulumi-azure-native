...
def get_premium_microsoft_defender_for_threat_intelligence(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240901:getPremiumMicrosoftDefenderForThreatIntelligence', __args__, opts=opts, typ=GetPremiumMicrosoftDefenderForThreatIntelligenceResult).value
