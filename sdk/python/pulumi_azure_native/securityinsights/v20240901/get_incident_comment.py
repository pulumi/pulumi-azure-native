...
def get_incident_comment(incident_comment_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240901:getIncidentComment', __args__, opts=opts, typ=GetIncidentCommentResult).value
...
def get_incident_comment_output(incident_comment_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240901:getIncidentComment', __args__, opts=opts, typ=GetIncidentCommentResult)
