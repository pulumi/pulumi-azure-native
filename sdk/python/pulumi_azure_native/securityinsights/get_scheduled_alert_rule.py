...
class GetScheduledAlertRuleResult:
    ...
    def custom_details(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def suppression_enabled(self) -> builtins.bool:
        """
...
def get_scheduled_alert_rule(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights:getScheduledAlertRule', __args__, opts=opts, typ=GetScheduledAlertRuleResult).value
...
def get_scheduled_alert_rule_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights:getScheduledAlertRule', __args__, opts=opts, typ=GetScheduledAlertRuleResult)
