...
def get_watchlist_item(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watchlist_item is deprecated: azure-native:securityinsights/v20221101preview:WatchlistItem is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:WatchlistItem to guarantee forwards compatibility.""")
    __args__ = dict()
