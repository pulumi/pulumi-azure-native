...
warnings.warn("""azure-native:securityinsights/v20221101preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class ThreatIntelligenceAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ThreatIntelligenceAlertRule is deprecated: azure-native:securityinsights/v20221101preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.""")
