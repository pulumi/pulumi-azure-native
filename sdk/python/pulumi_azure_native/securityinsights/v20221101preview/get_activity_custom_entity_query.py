...
warnings.warn("""azure-native:securityinsights/v20221101preview:ActivityCustomEntityQuery is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ActivityCustomEntityQuery to guarantee forwards compatibility.""", DeprecationWarning)
