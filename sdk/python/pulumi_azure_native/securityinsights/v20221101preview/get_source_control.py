...
def get_source_control(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_source_control is deprecated: azure-native:securityinsights/v20221101preview:SourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:SourceControl to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['sourceControlId'] = source_control_id
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20221101preview:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult).value
