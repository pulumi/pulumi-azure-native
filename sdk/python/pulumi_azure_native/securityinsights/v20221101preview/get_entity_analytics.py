...
def get_entity_analytics(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_entity_analytics is deprecated: azure-native:securityinsights/v20221101preview:EntityAnalytics is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EntityAnalytics to guarantee forwards compatibility.""")
    __args__ = dict()
