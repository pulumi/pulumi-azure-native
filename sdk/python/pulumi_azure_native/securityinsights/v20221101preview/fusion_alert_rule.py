...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fusion_alert_rule = azure_native.securityinsights.v20221101preview.FusionAlertRule("fusionAlertRule",
            ...
            source_settings=[
                ...
                },
                {
                    ...
                    "sourceSubTypes": [
                        {
                            "enabled": True,
                            "severityFilters": azure_native.securityinsights.v20221101preview.FusionSubTypeSeverityFilterArgs(
                                filters=[
                                    azure_native.securityinsights.v20221101preview.FusionSubTypeSeverityFiltersItemArgs(
                                        enabled=True,
                                        severity="High",
                                    ),
                                    azure_native.securityinsights.v20221101preview.FusionSubTypeSeverityFiltersItemArgs(
