...
def get_incident(incident_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident is deprecated: azure-native:securityinsights/v20221101preview:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['incidentId'] = incident_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20221101preview:getIncident', __args__, opts=opts, typ=GetIncidentResult).value
