...
warnings.warn("""azure-native:securityinsights/v20221101preview:AwsCloudTrailDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201:AwsCloudTrailDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class AwsCloudTrailDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(AwsCloudTrailDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221101preview:AwsCloudTrailDataConnector',
            resource_name,
            __props__,
            opts)
