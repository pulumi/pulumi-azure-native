...
class EntityAnalytics(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        entity_analytics = azure_native.securityinsights.v20221101preview.EntityAnalytics("entityAnalytics",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20221101preview:EntityAnalytics EyesOn /subscriptions/bd794837-4d29-4647-9105-6339bfdb4e6a/resourceGroups/mms-eus/providers/Microsoft.OperationalInsights/workspaces/avdvirInt/providers/Microsoft.SecurityInsights/settings/EyesOn 
        ```
