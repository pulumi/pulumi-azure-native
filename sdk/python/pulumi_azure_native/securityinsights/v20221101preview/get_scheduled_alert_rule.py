...
def get_scheduled_alert_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20221101preview:getScheduledAlertRule', __args__, opts=opts, typ=GetScheduledAlertRuleResult)
    return __ret__.apply(lambda __response__: GetScheduledAlertRuleResult(
        ...
        sentinel_entities_mappings=pulumi.get(__response__, 'sentinel_entities_mappings'),
