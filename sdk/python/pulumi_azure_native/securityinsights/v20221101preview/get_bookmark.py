...
warnings.warn("""azure-native:securityinsights/v20221101preview:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Bookmark to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bookmark(bookmark_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bookmark is deprecated: azure-native:securityinsights/v20221101preview:Bookmark is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Bookmark to guarantee forwards compatibility.""")
    __args__ = dict()
