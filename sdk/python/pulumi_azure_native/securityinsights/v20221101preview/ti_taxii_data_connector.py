...
class TiTaxiiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20221101preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20221101preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
            ...
            data_types=azure_native.securityinsights.v20221101preview.TiTaxiiDataConnectorDataTypesArgs(
                taxii_client=azure_native.securityinsights.v20221101preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs(
                    state="Enabled",
                ),
            ),
