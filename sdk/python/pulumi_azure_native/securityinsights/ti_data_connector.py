...
class TIDataConnectorArgs:
    def __init__(__self__, *,
                 ...
                 tip_lookback_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] tip_lookback_period: The lookback period for the feed to be imported.
        """
    ...
    def tip_lookback_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tip_lookback_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TIDataConnector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="tipLookbackPeriod")
    def tip_lookback_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The lookback period for the feed to be imported.
        """
        return pulumi.get(self, "tip_lookback_period")
