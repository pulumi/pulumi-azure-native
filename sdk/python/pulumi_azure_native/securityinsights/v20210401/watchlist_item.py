...
class WatchlistItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        watchlist_item = azure_native.securityinsights.v20210401.WatchlistItem("watchlistItem",
            items_key_value={
