...
class Watchlist(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        watchlist = azure_native.securityinsights.v20210401.Watchlist("watchlist",
