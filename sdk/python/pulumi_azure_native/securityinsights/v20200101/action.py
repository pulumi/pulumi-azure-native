...
class Action(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:Action"), pulumi.Alias(type_="azure-native:securityinsights:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights:Action"), pulumi.Alias(type_="azure-native:securityinsights/latest:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights/latest:Action")])
