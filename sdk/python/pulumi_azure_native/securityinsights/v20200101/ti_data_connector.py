...
class TIDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:TIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights:TIDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights:TIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:TIDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:TIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:TIDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:TIDataConnector")])
