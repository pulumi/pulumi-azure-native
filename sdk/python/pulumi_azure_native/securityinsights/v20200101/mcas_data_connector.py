...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MCASDataConnector is deprecated: azure-native:securityinsights/v20200101:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MCASDataConnector to guarantee forwards compatibility.""")
