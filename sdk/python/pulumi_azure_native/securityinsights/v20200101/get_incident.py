...
warnings.warn("""azure-native:securityinsights/v20200101:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:Incident to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_incident(incident_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident is deprecated: azure-native:securityinsights/v20200101:Incident is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:Incident to guarantee forwards compatibility.""")
    __args__ = dict()
