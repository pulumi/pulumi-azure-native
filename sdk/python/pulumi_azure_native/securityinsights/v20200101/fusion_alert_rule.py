...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fusion_alert_rule = azure_native.securityinsights.v20200101.FusionAlertRule("fusionAlertRule",
