...
class AlertRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:AlertRule"), pulumi.Alias(type_="azure-native:securityinsights:AlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights:AlertRule"), pulumi.Alias(type_="azure-native:securityinsights/latest:AlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights/latest:AlertRule")])
