...
def get_entity_insights(add_default_extended_time_range: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240401preview:getEntityInsights', __args__, opts=opts, typ=GetEntityInsightsResult).value
...
def get_entity_insights_output(add_default_extended_time_range: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240401preview:getEntityInsights', __args__, opts=opts, typ=GetEntityInsightsResult)
