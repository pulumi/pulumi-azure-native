...
def get_entity_analytics(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240401preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult).value

    return AwaitableGetEntityAnalyticsResult(
        entity_providers=pulumi.get(__ret__, 'entity_providers'),
...
def get_entity_analytics_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEntityAnalyticsResult]:
    """
    Gets a setting.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240401preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult)
    return __ret__.apply(lambda __response__: GetEntityAnalyticsResult(
        entity_providers=pulumi.get(__response__, 'entity_providers'),
