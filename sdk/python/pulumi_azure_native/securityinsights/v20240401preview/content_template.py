...
class ContentTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20231001preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20231101:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20240301:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20240901:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights/v20250301:ContentTemplate"), pulumi.Alias(type_="azure-native:securityinsights:ContentTemplate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentTemplate, __self__).__init__(
            'azure-native:securityinsights/v20240401preview:ContentTemplate',
            resource_name,
            __props__,
            opts)
