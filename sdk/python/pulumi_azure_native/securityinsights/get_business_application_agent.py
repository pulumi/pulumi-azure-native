...
def get_business_application_agent(agent_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str agent_resource_name: Business Application Agent Name
...
def get_business_application_agent_output(agent_resource_name: Optional[pulumi.Input[_builtins.str]] = None,
