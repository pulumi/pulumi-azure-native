...
def get_business_application_agent(agent_resource_name: Optional[builtins.str] = None,
...
def get_business_application_agent_output(agent_resource_name: Optional[pulumi.Input[builtins.str]] = None,
