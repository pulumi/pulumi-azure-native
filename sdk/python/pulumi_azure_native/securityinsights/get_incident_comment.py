...
def get_incident_comment(incident_comment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str incident_comment_id: Incident comment ID
...
def get_incident_comment_output(incident_comment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
