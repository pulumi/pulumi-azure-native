...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getAlertRule'.""", DeprecationWarning)
...
def get_alert_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/latest:getAlertRule', __args__, opts=opts, typ=GetAlertRuleResult).value
