...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityinsights/latest:Action":
                return Action(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/latest:AlertRule":
                return AlertRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/latest:Bookmark":
                return Bookmark(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/latest:DataConnector":
                return DataConnector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/latest:Incident":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityinsights/latest", _module_instance)
