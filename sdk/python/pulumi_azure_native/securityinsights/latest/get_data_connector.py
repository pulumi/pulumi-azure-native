...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getDataConnector'.""", DeprecationWarning)
...
def get_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/latest:getDataConnector', __args__, opts=opts, typ=GetDataConnectorResult).value
