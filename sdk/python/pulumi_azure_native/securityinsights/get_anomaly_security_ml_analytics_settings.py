...
def get_anomaly_security_ml_analytics_settings(resource_group_name: Optional[_builtins.str] = None,
                                               settings_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str settings_resource_name: Security ML Analytics Settings resource name
