...
class GetAnomalySecurityMLAnalyticsSettingsResult:
    ...
    def anomaly_settings_version(self) -> Optional[builtins.int]:
        """
    ...
    def is_default_settings(self) -> builtins.bool:
        """
    ...
    def settings_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def settings_status(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def tactics(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_anomaly_security_ml_analytics_settings(resource_group_name: Optional[builtins.str] = None,
                                               settings_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str settings_resource_name: Security ML Analytics Settings resource name
...
def get_anomaly_security_ml_analytics_settings_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                                      settings_resource_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights:getAnomalySecurityMLAnalyticsSettings', __args__, opts=opts, typ=GetAnomalySecurityMLAnalyticsSettingsResult)
