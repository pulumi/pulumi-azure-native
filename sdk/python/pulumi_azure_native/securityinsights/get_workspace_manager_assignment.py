...
def get_workspace_manager_assignment(resource_group_name: Optional[_builtins.str] = None,
                                     workspace_manager_assignment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workspace_manager_assignment_name: The name of the workspace manager assignment
...
def get_workspace_manager_assignment_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
