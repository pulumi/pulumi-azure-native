...
def get_eyes_on(operational_insights_resource_provider: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20190101preview:getEyesOn', __args__, opts=opts, typ=GetEyesOnResult).value
...
def get_eyes_on_output(operational_insights_resource_provider: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20190101preview:getEyesOn', __args__, opts=opts, typ=GetEyesOnResult)
