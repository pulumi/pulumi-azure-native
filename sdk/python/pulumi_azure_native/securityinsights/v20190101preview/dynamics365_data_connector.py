...
class Dynamics365DataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:Dynamics365DataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:Dynamics365DataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:Dynamics365DataConnector")])
