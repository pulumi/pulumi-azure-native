...
warnings.warn("""Version 2019-01-01-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_rule is deprecated: Version 2019-01-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20190101preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult).value
