...
class ThreatIntelligenceAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20211001:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220101preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220401preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220501preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220601preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:ThreatIntelligenceAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:ThreatIntelligenceAlertRule")])
