...
class AADDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aad_data_connector = azure_native.securityinsights.v20190101preview.AADDataConnector("aadDataConnector",
