...
class EntityAnalytics(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        entity_analytics = azure_native.securityinsights.v20190101preview.EntityAnalytics("entityAnalytics",
