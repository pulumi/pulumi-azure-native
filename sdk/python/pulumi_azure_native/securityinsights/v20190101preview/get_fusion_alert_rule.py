...
def get_fusion_alert_rule(operational_insights_resource_provider: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20190101preview:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult).value
...
def get_fusion_alert_rule_output(operational_insights_resource_provider: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20190101preview:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult)
