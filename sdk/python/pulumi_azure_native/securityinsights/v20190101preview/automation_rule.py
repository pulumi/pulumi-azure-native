...
class AutomationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[int] order: The order of execution of the automation rule
        :param pulumi.Input[str] resource_group_name: The name of the resource group within the user's subscription. The name is case insensitive.
        :param pulumi.Input[Union['AutomationRuleTriggeringLogicArgs', 'AutomationRuleTriggeringLogicArgsDict']] triggering_logic: The triggering logic of the automation rule
        :param pulumi.Input[str] workspace_name: The name of the workspace.
        """
        ...
    @overload
