...
def get_mtp_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mtp_data_connector is deprecated: azure-native:securityinsights/v20190101preview:MTPDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:MTPDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
