...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:ScheduledAlertRule"), pulumi.Alias(type_="azure-native:securityinsights:ScheduledAlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights:ScheduledAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:ScheduledAlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:ScheduledAlertRule")])
