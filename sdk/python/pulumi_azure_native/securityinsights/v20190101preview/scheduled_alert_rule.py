...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScheduledAlertRule is deprecated: azure-native:securityinsights/v20190101preview:ScheduledAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20210301preview:ScheduledAlertRule to guarantee forwards compatibility.""")
