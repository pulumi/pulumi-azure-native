...
class MDATPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:MDATPDataConnector"), pulumi.Alias(type_="azure-native:securityinsights:MDATPDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights:MDATPDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:MDATPDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:MDATPDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:MDATPDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:MDATPDataConnector")])
