...
def get_entity_analytics_output(operational_insights_resource_provider: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20190101preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult)
