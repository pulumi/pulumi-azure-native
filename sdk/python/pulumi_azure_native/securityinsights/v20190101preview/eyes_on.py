...
class EyesOn(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        eyes_on = azure_native.securityinsights.v20190101preview.EyesOn("eyesOn",
            kind="EyesOn",
