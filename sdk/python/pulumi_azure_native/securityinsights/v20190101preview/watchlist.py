...
class Watchlist(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Watchlist is deprecated: Version 2019-01-01-preview will be removed in v2 of the provider.""")
