...
class BookmarkRelation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bookmark_relation = azure_native.securityinsights.v20190101preview.BookmarkRelation("bookmarkRelation",
