...
class AwaitableGetIPSyncerResult(GetIPSyncerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIPSyncerResult(
            etag=self.etag,
            id=self.id,
...
def get_ip_syncer(operational_insights_resource_provider: Optional[str] = None,
                  resource_group_name: Optional[str] = None,
                  settings_name: Optional[str] = None,
                  workspace_name: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIPSyncerResult:
    """
    Gets a setting.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20190101preview:getIPSyncer', __args__, opts=opts, typ=GetIPSyncerResult).value

    return AwaitableGetIPSyncerResult(
