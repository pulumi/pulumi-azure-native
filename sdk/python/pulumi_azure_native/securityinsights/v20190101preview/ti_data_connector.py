...
class TIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ti_data_connector = azure_native.securityinsights.v20190101preview.TIDataConnector("tiDataConnector",
        ...
        ti_data_connector = azure_native.securityinsights.v20190101preview.TIDataConnector("tiDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20190101preview.TIDataConnectorDataTypesArgs(
                indicators=azure_native.securityinsights.v20190101preview.TIDataConnectorDataTypesIndicatorsArgs(
                    state="Enabled",
                ),
            ),
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20190101preview:TIDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
