...
class Action(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:Action"), pulumi.Alias(type_="azure-native:securityinsights:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights:Action"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:Action"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:Action")])
