...
warnings.warn("""azure-native:securityinsights/v20190101preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ml_behavior_analytics_alert_rule(operational_insights_resource_provider: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ml_behavior_analytics_alert_rule is deprecated: azure-native:securityinsights/v20190101preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20210301preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
