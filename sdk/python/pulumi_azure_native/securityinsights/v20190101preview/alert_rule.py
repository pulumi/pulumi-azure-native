...
class AlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:AlertRule"), pulumi.Alias(type_="azure-native:securityinsights:AlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights:AlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:AlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:AlertRule")])
