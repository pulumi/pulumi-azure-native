...
def get_workspace_manager_configuration(resource_group_name: Optional[_builtins.str] = None,
                                        workspace_manager_configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workspace_manager_configuration_name: The name of the workspace manager configuration
...
def get_workspace_manager_configuration_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                               workspace_manager_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
