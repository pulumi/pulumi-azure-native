...
class AutomationRuleArgs:
    def __init__(__self__, *,
                 ...
                 automation_rule_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the automation rule.
        :param pulumi.Input[builtins.int] order: The order of execution of the automation rule.
        ...
        :param pulumi.Input[builtins.str] automation_rule_id: Automation rule ID
        """
    ...
    def automation_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Automation rule ID
        """
    ...
    def automation_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
