...
class WatchlistArgs:
    def __init__(__self__, *,
                 ...
                 items_search_key: pulumi.Input[builtins.str],
                 ...
                 number_of_lines_to_skip: Optional[pulumi.Input[builtins.int]] = None,
                 raw_content: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 watchlist_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Watchlist resource.
        :param pulumi.Input[builtins.str] display_name: The display name of the watchlist
        :param pulumi.Input[builtins.str] items_search_key: The search key is used to optimize query performance when using watchlists for joins with other data. For example, enable a column with IP addresses to be the designated SearchKey field, then use this field as the key field when joining to other event data by IP address.
        :param pulumi.Input[builtins.str] provider: The provider of the watchlist
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] workspace_name: The name of the workspace.
        :param pulumi.Input[builtins.str] content_type: The content type of the raw content. Example : text/csv or text/tsv
        :param pulumi.Input[builtins.str] created: The time the watchlist was created
        :param pulumi.Input['WatchlistUserInfoArgs'] created_by: Describes a user that created the watchlist
        :param pulumi.Input[builtins.str] default_duration: The default duration of a watchlist (in ISO 8601 duration format)
        :param pulumi.Input[builtins.str] description: A description of the watchlist
        :param pulumi.Input[builtins.bool] is_deleted: A flag that indicates if the watchlist is deleted or not
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] labels: List of labels relevant to this watchlist
        :param pulumi.Input[builtins.int] number_of_lines_to_skip: The number of lines in a csv/tsv content to skip before the header
        :param pulumi.Input[builtins.str] raw_content: The raw content that represents to watchlist items to create. In case of csv/tsv content type, it's the content of the file that will parsed by the endpoint
        :param pulumi.Input[builtins.str] source: The filename of the watchlist, called 'source'
        :param pulumi.Input[Union[builtins.str, 'SourceType']] source_type: The sourceType of the watchlist
        :param pulumi.Input[builtins.str] tenant_id: The tenantId where the watchlist belongs to
        :param pulumi.Input[builtins.str] updated: The last time the watchlist was updated
        :param pulumi.Input['WatchlistUserInfoArgs'] updated_by: Describes a user that updated the watchlist
        :param pulumi.Input[builtins.str] upload_status: The status of the Watchlist upload : New, InProgress or Complete. **Note** : When a Watchlist upload status is InProgress, the Watchlist cannot be deleted
        :param pulumi.Input[builtins.str] watchlist_alias: The alias of the watchlist
        :param pulumi.Input[builtins.str] watchlist_id: The id (a Guid) of the watchlist
        :param pulumi.Input[builtins.str] watchlist_type: The type of the watchlist
        """
    ...
    def items_search_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def items_search_key(self, value: pulumi.Input[builtins.str]):
    ...
    def number_of_lines_to_skip(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_lines_to_skip(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_lines_to_skip", value)

    @property
    @pulumi.getter(name="rawContent")
    def raw_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @raw_content.setter
    def raw_content(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'SourceType']]]:
        """
    ...
    @source_type.setter
    def source_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'SourceType']]]):
    ...
    def watchlist_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def watchlist_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def watchlist_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def watchlist_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Watchlist(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_deleted: Optional[pulumi.Input[builtins.bool]] = None,
                 items_search_key: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 number_of_lines_to_skip: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="itemsSearchKey")
    def items_search_key(self) -> pulumi.Output[builtins.str]:
        """
        The search key is used to optimize query performance when using watchlists for joins with other data. For example, enable a column with IP addresses to be the designated SearchKey field, then use this field as the key field when joining to other event data by IP address.
        """
        return pulumi.get(self, "items_search_key")
    ...
    @property
    @pulumi.getter(name="numberOfLinesToSkip")
    def number_of_lines_to_skip(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of lines in a csv/tsv content to skip before the header
        """
        return pulumi.get(self, "number_of_lines_to_skip")
    ...
    @property
    @pulumi.getter(name="rawContent")
    def raw_content(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The raw content that represents to watchlist items to create. In case of csv/tsv content type, it's the content of the file that will parsed by the endpoint
        """
        return pulumi.get(self, "raw_content")
    ...
    @property
    @pulumi.getter(name="sourceType")
    def source_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sourceType of the watchlist
        """
        return pulumi.get(self, "source_type")
    ...
    @property
    @pulumi.getter(name="uploadStatus")
    def upload_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The status of the Watchlist upload : New, InProgress or Complete. **Note** : When a Watchlist upload status is InProgress, the Watchlist cannot be deleted
        """
        return pulumi.get(self, "upload_status")
    ...
    @property
    @pulumi.getter(name="watchlistAlias")
    def watchlist_alias(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alias of the watchlist
        """
        return pulumi.get(self, "watchlist_alias")
    ...
    @property
    @pulumi.getter(name="watchlistId")
    def watchlist_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The id (a Guid) of the watchlist
        """
        return pulumi.get(self, "watchlist_id")
    ...
    @property
    @pulumi.getter(name="watchlistType")
    def watchlist_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the watchlist
        """
        return pulumi.get(self, "watchlist_type")
