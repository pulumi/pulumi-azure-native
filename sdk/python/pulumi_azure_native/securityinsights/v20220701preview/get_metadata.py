...
def get_metadata(metadata_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_metadata is deprecated: azure-native:securityinsights/v20220701preview:Metadata is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.""")
    __args__ = dict()
