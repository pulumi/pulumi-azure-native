...
def get_codeless_api_polling_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220701preview:getCodelessApiPollingDataConnector', __args__, opts=opts, typ=GetCodelessApiPollingDataConnectorResult)
