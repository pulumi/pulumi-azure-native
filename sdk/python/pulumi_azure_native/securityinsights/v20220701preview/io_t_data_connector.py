...
warnings.warn("""azure-native:securityinsights/v20220701preview:IoTDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IoTDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class IoTDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IoTDataConnector is deprecated: azure-native:securityinsights/v20220701preview:IoTDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:IoTDataConnector to guarantee forwards compatibility.""")
