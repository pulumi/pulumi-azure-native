...
warnings.warn("""azure-native:securityinsights/v20220701preview:AwsS3DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AwsS3DataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class AwsS3DataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AwsS3DataConnector is deprecated: azure-native:securityinsights/v20220701preview:AwsS3DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AwsS3DataConnector to guarantee forwards compatibility.""")
