...
class CodelessUiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20220701preview.CodelessUiDataConnector("codelessUiDataConnector",
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20220701preview.CodelessUiDataConnector("codelessUiDataConnector",
            connector_ui_config=azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesResponseArgs(
                availability=azure_native.securityinsights.v20220701preview.AvailabilityArgs(
                    is_preview=True,
                    status=1,
                ),
                connectivity_criteria=[azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs(
                    type="IsConnectedQuery",
                    value=[\"\"\"{{graphQueriesTableName}}
                    | summarize LastLogReceived = max(TimeGenerated)
                    | project IsConnected = LastLogReceived > ago(30d)\"\"\"],
                )],
                data_types=[azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesDataTypesArgs(
                ...
                graph_queries=[azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs(
                ...
                instruction_steps=[
                    azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs(
        ...
        >**IMPORTANT:** Before deploying the Qualys VM connector, have the Workspace ID and Workspace Primary Key (can be copied from the following), as well as the Qualys VM API Authorization Key(s), readily available.\"\"\",
                        "instructions": [
                            azure_native.securityinsights.v20220701preview.InstructionStepsInstructionsArgs(
                                parameters={
        ...
        > NOTE: If a longer timeout duration is required, consider upgrading to an [App Service Plan](https://docs.microsoft.com/azure/azure-functions/functions-scale#timeout)\"\"\",
                ...
                permissions={
                    "customs": [
                        azure_native.securityinsights.v20220701preview.PermissionsCustomsArgs(
                    ...
                    "resourceProvider": [
                        {
                            ...
                            "requiredPermissions": azure_native.securityinsights.v20220701preview.RequiredPermissionsArgs(
                                delete=True,
                                read=True,
                                write=True,
                            ),
                ...
                publisher="Qualys",
                sample_queries=[azure_native.securityinsights.v20220701preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs(
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20220701preview:CodelessUiDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
