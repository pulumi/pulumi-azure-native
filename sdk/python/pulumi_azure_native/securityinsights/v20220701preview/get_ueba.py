...
def get_ueba(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ueba is deprecated: azure-native:securityinsights/v20220701preview:Ueba is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Ueba to guarantee forwards compatibility.""")
    __args__ = dict()
