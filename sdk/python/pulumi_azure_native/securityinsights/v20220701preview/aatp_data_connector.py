...
class AATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aatp_data_connector = azure_native.securityinsights.v20220701preview.AATPDataConnector("aatpDataConnector",
