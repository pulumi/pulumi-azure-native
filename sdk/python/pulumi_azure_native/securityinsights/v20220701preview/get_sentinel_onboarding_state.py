...
warnings.warn("""azure-native:securityinsights/v20220701preview:SentinelOnboardingState is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:SentinelOnboardingState to guarantee forwards compatibility.""", DeprecationWarning)
