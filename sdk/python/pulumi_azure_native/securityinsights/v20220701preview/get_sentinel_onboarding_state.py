...
def get_sentinel_onboarding_state_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220701preview:getSentinelOnboardingState', __args__, opts=opts, typ=GetSentinelOnboardingStateResult)
