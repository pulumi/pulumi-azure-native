...
class WorkspaceManagerGroupArgs:
    ...
    def workspace_manager_group_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class WorkspaceManagerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 member_resource_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
