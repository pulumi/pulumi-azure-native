...
class WorkspaceManagerGroupArgs:
    ...
    def member_resource_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class WorkspaceManagerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 member_resource_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
