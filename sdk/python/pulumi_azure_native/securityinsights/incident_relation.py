...
class IncidentRelationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] related_resource_id: The resource ID of the related resource
...
class IncidentRelation(pulumi.CustomResource):
    ...
    def related_resource_type(self) -> pulumi.Output[builtins.str]:
        """
