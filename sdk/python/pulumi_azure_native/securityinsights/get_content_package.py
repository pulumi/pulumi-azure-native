...
class GetContentPackageResult:
    ...
    def is_deprecated(self) -> Optional[builtins.str]:
        """
    ...
    def is_featured(self) -> Optional[builtins.str]:
        """
    ...
    def is_new(self) -> Optional[builtins.str]:
        """
    ...
    def is_preview(self) -> Optional[builtins.str]:
        """
...
def get_content_package(package_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights:getContentPackage', __args__, opts=opts, typ=GetContentPackageResult).value
...
def get_content_package_output(package_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights:getContentPackage', __args__, opts=opts, typ=GetContentPackageResult)
