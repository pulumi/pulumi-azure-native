...
def get_content_package(package_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str package_id: package Id
...
def get_content_package_output(package_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
