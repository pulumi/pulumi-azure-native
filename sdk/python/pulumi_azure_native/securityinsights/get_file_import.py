...
def get_file_import(file_import_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_import_id: File import ID
...
def get_file_import_output(file_import_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
