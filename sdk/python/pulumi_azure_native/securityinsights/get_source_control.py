...
def get_source_control(resource_group_name: Optional[builtins.str] = None,
                       source_control_id: Optional[builtins.str] = None,
    ...
    :param builtins.str source_control_id: Source control Id
...
def get_source_control_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
