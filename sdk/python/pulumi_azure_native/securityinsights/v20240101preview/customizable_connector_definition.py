...
class CustomizableConnectorDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20231001preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20240901:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20250301:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights:CustomizableConnectorDefinition")])
