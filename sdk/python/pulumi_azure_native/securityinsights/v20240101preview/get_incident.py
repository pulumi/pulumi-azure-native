...
def get_incident(incident_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240101preview:getIncident', __args__, opts=opts, typ=GetIncidentResult).value
...
def get_incident_output(incident_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240101preview:getIncident', __args__, opts=opts, typ=GetIncidentResult)
