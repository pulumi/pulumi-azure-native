...
def get_dynamics365_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240101preview:getDynamics365DataConnector', __args__, opts=opts, typ=GetDynamics365DataConnectorResult).value
...
def get_dynamics365_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDynamics365DataConnectorResult]:
    """
    Gets a data connector.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20240101preview:getDynamics365DataConnector', __args__, opts=opts, typ=GetDynamics365DataConnectorResult)
    return __ret__.apply(lambda __response__: GetDynamics365DataConnectorResult(
