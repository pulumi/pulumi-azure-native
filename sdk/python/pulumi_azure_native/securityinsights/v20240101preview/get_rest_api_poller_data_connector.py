...
def get_rest_api_poller_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20240101preview:getRestApiPollerDataConnector', __args__, opts=opts, typ=GetRestApiPollerDataConnectorResult).value
