...
class ContentPackageArgs:
    def __init__(__self__, *,
                 ...
                 content_kind: pulumi.Input[Union[builtins.str, 'PackageKind']],
                 content_product_id: pulumi.Input[builtins.str],
                 ...
                 is_deprecated: Optional[pulumi.Input[Union[builtins.str, 'Flag']]] = None,
                 is_featured: Optional[pulumi.Input[Union[builtins.str, 'Flag']]] = None,
                 is_new: Optional[pulumi.Input[Union[builtins.str, 'Flag']]] = None,
                 is_preview: Optional[pulumi.Input[Union[builtins.str, 'Flag']]] = None,
                 ...
                 publisher_display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] content_id: The content id of the package
        :param pulumi.Input[Union[builtins.str, 'PackageKind']] content_kind: The package kind
        :param pulumi.Input[builtins.str] content_product_id: Unique ID for the content. It should be generated based on the contentId, contentKind and the contentVersion of the package
        :param pulumi.Input[builtins.str] display_name: The display name of the package
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] version: the latest version number of the package
        ...
        :param pulumi.Input[builtins.str] content_schema_version: The version of the content schema.
        :param pulumi.Input['MetadataDependenciesArgs'] dependencies: The support tier of the package
        :param pulumi.Input[builtins.str] description: The description of the package
        :param pulumi.Input[builtins.str] first_publish_date: first publish date package item
        :param pulumi.Input[builtins.str] icon: the icon identifier. this id can later be fetched from the content metadata
        :param pulumi.Input[Union[builtins.str, 'Flag']] is_deprecated: Flag indicates if this template is deprecated
        :param pulumi.Input[Union[builtins.str, 'Flag']] is_featured: Flag indicates if this package is among the featured list.
        :param pulumi.Input[Union[builtins.str, 'Flag']] is_new: Flag indicates if this is a newly published package.
        :param pulumi.Input[Union[builtins.str, 'Flag']] is_preview: Flag indicates if this package is in preview.
        :param pulumi.Input[builtins.str] last_publish_date: last publish date for the package item
        :param pulumi.Input[builtins.str] package_id: package Id
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] providers: Providers for the package item
        :param pulumi.Input[builtins.str] publisher_display_name: The publisher display name of the package
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] threat_analysis_tactics: the tactics the resource covers
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] threat_analysis_techniques: the techniques the resource covers, these have to be aligned with the tactics being used
        """
    ...
    def content_kind(self) -> pulumi.Input[Union[builtins.str, 'PackageKind']]:
        """
        The package kind
        """
    ...
    @content_kind.setter
    def content_kind(self, value: pulumi.Input[Union[builtins.str, 'PackageKind']]):
        pulumi.set(self, "content_kind", value)

    @property
    @pulumi.getter(name="contentProductId")
    def content_product_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def content_product_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_deprecated(self) -> Optional[pulumi.Input[Union[builtins.str, 'Flag']]]:
        """
    ...
    def is_deprecated(self, value: Optional[pulumi.Input[Union[builtins.str, 'Flag']]]):
        pulumi.set(self, "is_deprecated", value)

    @property
    @pulumi.getter(name="isFeatured")
    def is_featured(self) -> Optional[pulumi.Input[Union[builtins.str, 'Flag']]]:
        """
    ...
    @is_featured.setter
    def is_featured(self, value: Optional[pulumi.Input[Union[builtins.str, 'Flag']]]):
        pulumi.set(self, "is_featured", value)

    @property
    @pulumi.getter(name="isNew")
    def is_new(self) -> Optional[pulumi.Input[Union[builtins.str, 'Flag']]]:
        """
    ...
    @is_new.setter
    def is_new(self, value: Optional[pulumi.Input[Union[builtins.str, 'Flag']]]):
        pulumi.set(self, "is_new", value)

    @property
    @pulumi.getter(name="isPreview")
    def is_preview(self) -> Optional[pulumi.Input[Union[builtins.str, 'Flag']]]:
        """
    ...
    @is_preview.setter
    def is_preview(self, value: Optional[pulumi.Input[Union[builtins.str, 'Flag']]]):
    ...
    def package_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        package Id
        """
    ...
    @package_id.setter
    def package_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def publisher_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def publisher_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContentPackage(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 content_kind: Optional[pulumi.Input[Union[builtins.str, 'PackageKind']]] = None,
                 content_product_id: Optional[pulumi.Input[builtins.str]] = None,
                 content_schema_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        Other available API versions: 2023-04-01-preview, 2023-05-01-preview, 2023-06-01-preview, 2023-07-01-preview, 2023-08-01-preview, 2023-09-01-preview, 2023-10-01-preview, 2023-11-01, 2023-12-01-preview, 2024-01-01-preview, 2024-03-01, 2024-04-01-preview, 2024-10-01-preview, 2025-01-01-preview, 2025-03-01, 2025-04-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native securityinsights [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    @property
    @pulumi.getter(name="contentKind")
    def content_kind(self) -> pulumi.Output[builtins.str]:
        """
        The package kind
        """
        return pulumi.get(self, "content_kind")
    ...
    @property
    @pulumi.getter(name="contentProductId")
    def content_product_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique ID for the content. It should be generated based on the contentId, contentKind and the contentVersion of the package
        """
        return pulumi.get(self, "content_product_id")
    ...
    @property
    @pulumi.getter(name="isDeprecated")
    def is_deprecated(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag indicates if this template is deprecated
        """
        return pulumi.get(self, "is_deprecated")
    ...
    @property
    @pulumi.getter(name="isFeatured")
    def is_featured(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag indicates if this package is among the featured list.
        """
        return pulumi.get(self, "is_featured")
    ...
    @property
    @pulumi.getter(name="isNew")
    def is_new(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag indicates if this is a newly published package.
        """
        return pulumi.get(self, "is_new")
    ...
    @property
    @pulumi.getter(name="isPreview")
    def is_preview(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag indicates if this package is in preview.
        """
        return pulumi.get(self, "is_preview")
    ...
    @property
    @pulumi.getter(name="publisherDisplayName")
    def publisher_display_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The publisher display name of the package
        """
        return pulumi.get(self, "publisher_display_name")
