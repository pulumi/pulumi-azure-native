...
class ContentPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_id: The content id of the package
        ...
        :param pulumi.Input[_builtins.str] content_schema_version: The version of the content schema.
        :param pulumi.Input['MetadataDependenciesArgs'] dependencies: The support tier of the package
        :param pulumi.Input[_builtins.str] description: The description of the package
        :param pulumi.Input[_builtins.str] first_publish_date: first publish date package item
        :param pulumi.Input[_builtins.str] icon: the icon identifier. this id can later be fetched from the content metadata
        :param pulumi.Input[Union[_builtins.str, 'Flag']] is_deprecated: Flag indicates if this template is deprecated
        :param pulumi.Input[Union[_builtins.str, 'Flag']] is_featured: Flag indicates if this package is among the featured list.
...
class ContentPackage(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="threatAnalysisTactics")
    def threat_analysis_tactics(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        the tactics the resource covers
        """
        return pulumi.get(self, "threat_analysis_tactics")
    ...
    @_builtins.property
    @pulumi.getter(name="threatAnalysisTechniques")
    def threat_analysis_techniques(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        the techniques the resource covers, these have to be aligned with the tactics being used
        """
        return pulumi.get(self, "threat_analysis_techniques")
