...
warnings.warn("""azure-native:securityinsights/v20211001:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20211001preview:Watchlist to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_watchlist(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watchlist is deprecated: azure-native:securityinsights/v20211001:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20211001preview:Watchlist to guarantee forwards compatibility.""")
    __args__ = dict()
