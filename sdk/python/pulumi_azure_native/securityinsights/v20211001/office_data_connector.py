...
warnings.warn("""azure-native:securityinsights/v20211001:OfficeDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class OfficeDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""OfficeDataConnector is deprecated: azure-native:securityinsights/v20211001:OfficeDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:OfficeDataConnector to guarantee forwards compatibility.""")
