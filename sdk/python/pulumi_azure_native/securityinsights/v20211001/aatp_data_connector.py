...
class AATPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AATPDataConnector is deprecated: azure-native:securityinsights/v20211001:AATPDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:AATPDataConnector to guarantee forwards compatibility.""")
