...
warnings.warn("""azure-native:securityinsights/v20211001:FusionAlertRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20211001preview:FusionAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(FusionAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20211001:FusionAlertRule',
            resource_name,
            __props__,
            opts)
