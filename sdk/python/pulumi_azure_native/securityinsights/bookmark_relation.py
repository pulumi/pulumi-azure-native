...
class BookmarkRelationArgs:
    def __init__(__self__, *,
                 bookmark_id: pulumi.Input[builtins.str],
    ...
    def bookmark_id(self) -> pulumi.Input[builtins.str]:
        """
        Bookmark ID
        """
    ...
    @bookmark_id.setter
    def bookmark_id(self, value: pulumi.Input[builtins.str]):
