...
def get_bookmark(bookmark_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bookmark_id: Bookmark ID
...
def get_bookmark_output(bookmark_id: pulumi.Input[Optional[_builtins.str]] = None,
