...
class WorkspaceManagerAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:WorkspaceManagerAssignment"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:WorkspaceManagerAssignment")])
