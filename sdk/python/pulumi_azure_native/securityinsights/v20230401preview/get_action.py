...
warnings.warn("""azure-native:securityinsights/v20230401preview:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_action(action_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action is deprecated: azure-native:securityinsights/v20230401preview:Action is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Action to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230401preview:getAction', __args__, opts=opts, typ=GetActionResult).value
