...
def get_entity_analytics_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230401preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult)
