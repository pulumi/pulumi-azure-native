...
class Bookmark(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bookmark = azure_native.securityinsights.v20230401preview.Bookmark("bookmark",
            bookmark_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            created="2021-09-01T13:15:30Z",
            created_by=azure_native.securityinsights.v20230401preview.UserInfoArgs(
                object_id="2046feea-040d-4a46-9e2b-91c2941bfa70",
            ),
            display_name="My bookmark",
            entity_mappings=[{
                "entityType": "Account",
                "fieldMappings": [azure_native.securityinsights.v20230401preview.EntityFieldMappingArgs(
                    identifier="Fullname",
            ...
            updated_by=azure_native.securityinsights.v20230401preview.UserInfoArgs(
                object_id="2046feea-040d-4a46-9e2b-91c2941bfa70",
            ),
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20230401preview:Bookmark 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/bookmarks/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Bookmark, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:Bookmark',
            resource_name,
            __props__,
            opts)
