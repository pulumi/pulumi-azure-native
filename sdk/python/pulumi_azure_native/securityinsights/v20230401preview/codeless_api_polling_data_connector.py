...
class CodelessApiPollingDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        codeless_api_polling_data_connector = azure_native.securityinsights.v20230401preview.CodelessApiPollingDataConnector("codelessApiPollingDataConnector",
            connector_ui_config=azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesResponseArgs(
                availability=azure_native.securityinsights.v20230401preview.AvailabilityArgs(
                    is_preview=True,
                    status=1,
                ),
                connectivity_criteria=[azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs(
                    type="SentinelKindsV2",
                    value=[],
                )],
                data_types=[azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesDataTypesArgs(
                ...
                graph_queries=[azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs(
         ...
         Follow [this](https://docs.github.com/en/github/authenticating-to-github/keeping-your-account-and-data-secure/creating-a-personal-access-token) to create or find your personal key\"\"\",
                    "instructions": [azure_native.securityinsights.v20230401preview.InstructionStepsInstructionsArgs(
                        parameters={
                            "enable": "true",
                ...
                permissions={
                    "customs": [azure_native.securityinsights.v20230401preview.PermissionsCustomsArgs(
                    ...
                    "resourceProvider": [{
                        ...
                        "requiredPermissions": azure_native.securityinsights.v20230401preview.RequiredPermissionsArgs(
                            delete=True,
                            read=True,
                            write=True,
                        ),
                ...
                publisher="GitHub",
                sample_queries=[azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs(
         ...
         | take 10 <change>\"\"\",
            ...
            kind="APIPolling",
            polling_config=azure_native.securityinsights.v20230401preview.CodelessConnectorPollingConfigPropertiesResponseArgs(
                auth={
                    "apiKeyIdentifier": "token",
                    "apiKeyName": "Authorization",
                    "authType": "APIKey",
                },
                paging=azure_native.securityinsights.v20230401preview.CodelessConnectorPollingPagingPropertiesArgs(
                ...
                response=azure_native.securityinsights.v20230401preview.CodelessConnectorPollingResponsePropertiesArgs(
                    events_json_paths=["$"],
                ),
            ),
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20230401preview:CodelessApiPollingDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(CodelessApiPollingDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:CodelessApiPollingDataConnector',
            resource_name,
            __props__,
            opts)
