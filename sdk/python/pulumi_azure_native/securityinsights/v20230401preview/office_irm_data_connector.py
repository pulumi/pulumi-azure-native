...
warnings.warn("""azure-native:securityinsights/v20230401preview:OfficeIRMDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:OfficeIRMDataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class OfficeIRMDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(OfficeIRMDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:OfficeIRMDataConnector',
            resource_name,
            __props__,
            opts)
