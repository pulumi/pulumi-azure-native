...
class MSTIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        msti_data_connector = azure_native.securityinsights.v20230401preview.MSTIDataConnector("mstiDataConnector",
        ...
        msti_data_connector = azure_native.securityinsights.v20230401preview.MSTIDataConnector("mstiDataConnector",
            ...
            data_types=azure_native.securityinsights.v20230401preview.MSTIDataConnectorDataTypesArgs(
                microsoft_emerging_threat_feed=azure_native.securityinsights.v20230401preview.MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeedArgs(
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20230401preview:MSTIDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(MSTIDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:MSTIDataConnector',
            resource_name,
            __props__,
            opts)
