...
def get_hunt_comment_output(hunt_comment_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230401preview:getHuntComment', __args__, opts=opts, typ=GetHuntCommentResult)
    return __ret__.apply(lambda __response__: GetHuntCommentResult(
