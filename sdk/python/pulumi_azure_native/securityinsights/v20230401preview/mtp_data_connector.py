...
class MTPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mtp_data_connector = azure_native.securityinsights.v20230401preview.MTPDataConnector("mtpDataConnector",
        ...
        mtp_data_connector = azure_native.securityinsights.v20230401preview.MTPDataConnector("mtpDataConnector",
            ...
            data_types=azure_native.securityinsights.v20230401preview.MTPDataConnectorDataTypesArgs(
                alerts=azure_native.securityinsights.v20230401preview.MTPDataConnectorDataTypesAlertsArgs(
                    state="Enabled",
                ),
                incidents=azure_native.securityinsights.v20230401preview.MTPDataConnectorDataTypesIncidentsArgs(
                    state="Disabled",
                ),
            ),
            filtered_providers=azure_native.securityinsights.v20230401preview.MtpFilteredProvidersResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        super(MTPDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:MTPDataConnector',
            resource_name,
            __props__,
            opts)
