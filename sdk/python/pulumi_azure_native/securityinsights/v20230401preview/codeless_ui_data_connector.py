...
class CodelessUiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20230401preview.CodelessUiDataConnector("codelessUiDataConnector",
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20230401preview.CodelessUiDataConnector("codelessUiDataConnector",
            connector_ui_config=azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesResponseArgs(
                ...
                instruction_steps=[
                    azure_native.securityinsights.v20230401preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs(
        ...
        >**IMPORTANT:** Before deploying the Qualys VM connector, have the Workspace ID and Workspace Primary Key (can be copied from the following), as well as the Qualys VM API Authorization Key(s), readily available.\"\"\",
                        "instructions": [
                            azure_native.securityinsights.v20230401preview.InstructionStepsInstructionsArgs(
                                parameters={
        ...
        > NOTE: If a longer timeout duration is required, consider upgrading to an [App Service Plan](https://docs.microsoft.com/azure/azure-functions/functions-scale#timeout)\"\"\",
                ...
                permissions={
                    "customs": [
                        azure_native.securityinsights.v20230401preview.PermissionsCustomsArgs(
