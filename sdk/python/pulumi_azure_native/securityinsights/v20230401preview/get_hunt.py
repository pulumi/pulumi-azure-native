...
def get_hunt(hunt_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hunt is deprecated: azure-native:securityinsights/v20230401preview:Hunt is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Hunt to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['huntId'] = hunt_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230401preview:getHunt', __args__, opts=opts, typ=GetHuntResult).value
