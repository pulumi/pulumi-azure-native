...
class ThreatIntelligenceIndicator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ThreatIntelligenceIndicator is deprecated: azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.""")
        ...
        super(ThreatIntelligenceIndicator, __self__).__init__(
            'azure-native:securityinsights/v20230401preview:ThreatIntelligenceIndicator',
            resource_name,
            __props__,
            opts)
