...
class MLBehaviorAnalyticsAlertRuleArgs:
    def __init__(__self__, *,
        ...
        """
        MLBehaviorAnalyticsAlertRuleArgs._configure(
    ...
    def _configure(
        ...
        _setter("kind", 'MLBehaviorAnalytics')
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MLBehaviorAnalyticsAlertRuleArgs._configure(_setter, **kwargs)
