...
class HuntArgs:
    ...
    def _configure(
        ...
        if attack_tactics is None and 'attackTactics' in kwargs:
            attack_tactics = kwargs['attackTactics']
        if attack_techniques is None and 'attackTechniques' in kwargs:
            attack_techniques = kwargs['attackTechniques']
        if hunt_id is None and 'huntId' in kwargs:
            hunt_id = kwargs['huntId']
        if hypothesis_status is None and 'hypothesisStatus' in kwargs:
...
class Hunt(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            owner = _utilities.configure(owner, HuntOwnerArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:Hunt")])
