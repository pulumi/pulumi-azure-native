...
class MCASDataConnectorArgs:
    def __init__(__self__, *,
                 data_types: pulumi.Input['MCASDataConnectorDataTypesArgs'],
    ...
    def data_types(self) -> pulumi.Input['MCASDataConnectorDataTypesArgs']:
        """
    ...
    @data_types.setter
    def data_types(self, value: pulumi.Input['MCASDataConnectorDataTypesArgs']):
...
class MCASDataConnector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataTypes")
    def data_types(self) -> pulumi.Output['outputs.MCASDataConnectorDataTypesResponse']:
        """
        The available data types for the connector.
        """
        return pulumi.get(self, "data_types")
