...
class MCASDataConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        MCASDataConnectorArgs._configure(
    ...
    def _configure(
        ...
        _setter("kind", 'MicrosoftCloudAppSecurity')
...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MCASDataConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if data_types is not None and not isinstance(data_types, MCASDataConnectorDataTypesArgs):
                data_types = data_types or {}
                def _setter(key, value):
                    data_types[key] = value
                MCASDataConnectorDataTypesArgs._configure(_setter, **data_types)
