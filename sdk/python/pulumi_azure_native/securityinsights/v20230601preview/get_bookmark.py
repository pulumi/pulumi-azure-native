...
def get_bookmark(bookmark_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230601preview:getBookmark', __args__, opts=opts, typ=GetBookmarkResult).value
...
def get_bookmark_output(bookmark_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230601preview:getBookmark', __args__, opts=opts, typ=GetBookmarkResult)
