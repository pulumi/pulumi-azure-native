...
class ActivityCustomEntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if query_definitions is not None and not isinstance(query_definitions, ActivityEntityQueriesPropertiesQueryDefinitionsArgs):
                query_definitions = query_definitions or {}
                def _setter(key, value):
                    query_definitions[key] = value
                ActivityEntityQueriesPropertiesQueryDefinitionsArgs._configure(_setter, **query_definitions)
