...
class OfficePowerBIDataConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        OfficePowerBIDataConnectorArgs._configure(
...
class OfficePowerBIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OfficePowerBIDataConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if data_types is not None and not isinstance(data_types, OfficePowerBIConnectorDataTypesArgs):
                data_types = data_types or {}
                def _setter(key, value):
                    data_types[key] = value
                OfficePowerBIConnectorDataTypesArgs._configure(_setter, **data_types)
        ...
        super(OfficePowerBIDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230601preview:OfficePowerBIDataConnector',
            resource_name,
            __props__,
            opts)
