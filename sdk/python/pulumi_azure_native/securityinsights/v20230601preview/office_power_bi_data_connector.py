...
class OfficePowerBIDataConnectorArgs:
    ...
    def _configure(
             ...
             data_types: Optional[pulumi.Input['OfficePowerBIConnectorDataTypesArgs']] = None,
...
class OfficePowerBIDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            data_types = _utilities.configure(data_types, OfficePowerBIConnectorDataTypesArgs, True)
