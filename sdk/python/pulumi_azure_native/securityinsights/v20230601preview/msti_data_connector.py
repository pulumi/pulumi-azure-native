...
class MSTIDataConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        MSTIDataConnectorArgs._configure(
    ...
    def _configure(
        ...
        _setter("kind", 'MicrosoftThreatIntelligence')
...
class MSTIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MSTIDataConnectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if data_types is not None and not isinstance(data_types, MSTIDataConnectorDataTypesArgs):
                data_types = data_types or {}
                def _setter(key, value):
                    data_types[key] = value
                MSTIDataConnectorDataTypesArgs._configure(_setter, **data_types)
