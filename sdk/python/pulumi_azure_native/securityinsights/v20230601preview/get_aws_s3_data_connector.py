...
def get_aws_s3_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230601preview:getAwsS3DataConnector', __args__, opts=opts, typ=GetAwsS3DataConnectorResult)
