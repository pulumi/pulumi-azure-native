...
class WorkspaceManagerConfigurationArgs:
    ...
    def _configure(
        ...
        if workspace_manager_configuration_name is None and 'workspaceManagerConfigurationName' in kwargs:
...
class WorkspaceManagerConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WorkspaceManagerConfiguration, __self__).__init__(
            'azure-native:securityinsights/v20230601preview:WorkspaceManagerConfiguration',
            resource_name,
            __props__,
            opts)
