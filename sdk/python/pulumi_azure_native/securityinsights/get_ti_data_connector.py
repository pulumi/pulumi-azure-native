...
def get_ti_data_connector(data_connector_id: Optional[_builtins.str] = None,
...
def get_ti_data_connector_output(data_connector_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
