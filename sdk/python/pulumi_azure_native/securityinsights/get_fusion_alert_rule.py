...
class GetFusionAlertRuleResult:
    ...
    def alert_rule_template_name(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def techniques(self) -> Sequence[builtins.str]:
        """
...
def get_fusion_alert_rule(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult).value
...
def get_fusion_alert_rule_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
