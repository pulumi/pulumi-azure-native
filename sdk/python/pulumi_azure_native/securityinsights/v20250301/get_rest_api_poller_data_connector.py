...
def get_rest_api_poller_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250301:getRestApiPollerDataConnector', __args__, opts=opts, typ=GetRestApiPollerDataConnectorResult).value
...
def get_rest_api_poller_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250301:getRestApiPollerDataConnector', __args__, opts=opts, typ=GetRestApiPollerDataConnectorResult)
