...
class PremiumMicrosoftDefenderForThreatIntelligenceArgs:
    def __init__(__self__, *,
                 ...
                 required_skus_present: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] required_skus_present: The flag to indicate whether the tenant has the premium SKU required to access this connector.
    ...
    def required_skus_present(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def required_skus_present(self, value: Optional[pulumi.Input[bool]]):
...
class PremiumMicrosoftDefenderForThreatIntelligence(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lookbackPeriod")
    def lookback_period(self) -> pulumi.Output[str]:
        """
        The lookback period for the feed to be imported. The date-time to begin importing the feed from, for example: 2024-01-01T00:00:00.000Z.
        """
        return pulumi.get(self, "lookback_period")
    ...
    @property
    @pulumi.getter(name="requiredSKUsPresent")
    def required_skus_present(self) -> pulumi.Output[Optional[bool]]:
        """
        The flag to indicate whether the tenant has the premium SKU required to access this connector.
        """
        return pulumi.get(self, "required_skus_present")
