...
class GetPremiumMicrosoftDefenderForThreatIntelligenceResult:
    ...
    """
    def __init__(__self__, data_types=None, etag=None, id=None, kind=None, lookback_period=None, name=None, required_skus_present=None, system_data=None, tenant_id=None, type=None):
    ...
    def required_skus_present(self) -> Optional[bool]:
        """
...
def get_premium_microsoft_defender_for_threat_intelligence(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250301:getPremiumMicrosoftDefenderForThreatIntelligence', __args__, opts=opts, typ=GetPremiumMicrosoftDefenderForThreatIntelligenceResult).value
...
def get_premium_microsoft_defender_for_threat_intelligence_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250301:getPremiumMicrosoftDefenderForThreatIntelligence', __args__, opts=opts, typ=GetPremiumMicrosoftDefenderForThreatIntelligenceResult)
