...
def get_action(action_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20250301:getAction', __args__, opts=opts, typ=GetActionResult).value
...
def get_action_output(action_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20250301:getAction', __args__, opts=opts, typ=GetActionResult)
