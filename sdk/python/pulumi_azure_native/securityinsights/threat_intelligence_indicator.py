...
class ThreatIntelligenceIndicatorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created: Created by
        :param pulumi.Input[_builtins.str] created_by_ref: Created by reference of threat intelligence entity
        :param pulumi.Input[_builtins.bool] defanged: Is threat intelligence entity defanged
        :param pulumi.Input[_builtins.str] description: Description of a threat intelligence entity
        :param pulumi.Input[_builtins.str] display_name: Display name of a threat intelligence entity
        :param Any extensions: Extensions map
        :param pulumi.Input[_builtins.str] external_id: External ID of threat intelligence entity
        :param pulumi.Input[_builtins.str] external_last_updated_time_utc: External last updated time in UTC
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] indicator_types: Indicator types of threat intelligence entities
        :param pulumi.Input[Sequence[pulumi.Input['ThreatIntelligenceKillChainPhaseArgs']]] kill_chain_phases: Kill chain phases
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] labels: Labels  of threat intelligence entity
        ...
        :param pulumi.Input[_builtins.str] pattern_type: Pattern type of a threat intelligence entity
        :param pulumi.Input[_builtins.str] pattern_version: Pattern version of a threat intelligence entity
        :param pulumi.Input[_builtins.bool] revoked: Is threat intelligence entity revoked
        :param pulumi.Input[_builtins.str] source: Source of a threat intelligence entity
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] threat_intelligence_tags: List of tags
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] threat_types: Threat types
        :param pulumi.Input[_builtins.str] valid_from: Valid from
