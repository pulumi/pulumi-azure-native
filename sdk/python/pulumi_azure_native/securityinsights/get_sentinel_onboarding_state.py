...
def get_sentinel_onboarding_state(resource_group_name: Optional[_builtins.str] = None,
                                  sentinel_onboarding_state_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sentinel_onboarding_state_name: The Sentinel onboarding state name. Supports - default
...
def get_sentinel_onboarding_state_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                         sentinel_onboarding_state_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
