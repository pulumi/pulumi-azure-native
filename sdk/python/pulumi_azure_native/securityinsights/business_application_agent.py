...
class BusinessApplicationAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:BusinessApplicationAgent"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:BusinessApplicationAgent"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:BusinessApplicationAgent"), pulumi.Alias(type_="azure-native:securityinsights/v20250401preview:BusinessApplicationAgent"), pulumi.Alias(type_="azure-native:securityinsights/v20250701preview:BusinessApplicationAgent")])
