...
class MetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kind: The kind of content the metadata is for.
        :param pulumi.Input[builtins.str] parent_id: Full parent resource ID of the content item the metadata is for.  This is the full resource ID including the scope (subscription and resource group)
        ...
        :param pulumi.Input[builtins.str] first_publish_date: first publish date solution content item
        :param pulumi.Input[builtins.str] icon: the icon identifier. this id can later be fetched from the solution template
        :param pulumi.Input[builtins.str] last_publish_date: last publish date for the solution content item
        :param pulumi.Input[builtins.str] metadata_name: The Metadata name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] providers: Providers for the solution content item
        ...
        :param pulumi.Input[builtins.str] version: Version of the content.  Default and recommended format is numeric (e.g. 1, 1.0, 1.0.0, 1.0.0.0), following ARM template best practices.  Can also be any string, but then we cannot guarantee any version checks
        """
...
class Metadata(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contentId")
    def content_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
        """
        return pulumi.get(self, "content_id")
