...
class IoTDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20211001:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220401preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220501preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220601preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220801:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20220901preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20221001preview:IoTDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20221101preview:IoTDataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IoTDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20220101preview:IoTDataConnector',
            resource_name,
            __props__,
            opts)
