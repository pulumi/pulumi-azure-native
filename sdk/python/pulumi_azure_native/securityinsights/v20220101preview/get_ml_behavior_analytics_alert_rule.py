...
def get_ml_behavior_analytics_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ml_behavior_analytics_alert_rule is deprecated: azure-native:securityinsights/v20220101preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
