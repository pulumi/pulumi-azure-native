...
warnings.warn("""azure-native:securityinsights/v20220101preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:BookmarkRelation to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bookmark_relation(bookmark_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bookmark_relation is deprecated: azure-native:securityinsights/v20220101preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:BookmarkRelation to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20220101preview:getBookmarkRelation', __args__, opts=opts, typ=GetBookmarkRelationResult).value
