...
warnings.warn("""azure-native:securityinsights/v20220101preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EyesOn to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_eyes_on(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_eyes_on is deprecated: azure-native:securityinsights/v20220101preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:EyesOn to guarantee forwards compatibility.""")
    __args__ = dict()
