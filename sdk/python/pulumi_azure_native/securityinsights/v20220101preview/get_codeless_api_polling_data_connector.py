...
def get_codeless_api_polling_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_codeless_api_polling_data_connector is deprecated: azure-native:securityinsights/v20220101preview:CodelessApiPollingDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:CodelessApiPollingDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
