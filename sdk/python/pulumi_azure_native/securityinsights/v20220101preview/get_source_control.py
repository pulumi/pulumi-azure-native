...
def get_source_control(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_source_control is deprecated: azure-native:securityinsights/v20220101preview:SourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:SourceControl to guarantee forwards compatibility.""")
    __args__ = dict()
