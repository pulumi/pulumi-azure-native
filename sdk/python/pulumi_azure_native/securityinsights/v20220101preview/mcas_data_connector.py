...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mcas_data_connector = azure_native.securityinsights.v20220101preview.MCASDataConnector("mcasDataConnector",
