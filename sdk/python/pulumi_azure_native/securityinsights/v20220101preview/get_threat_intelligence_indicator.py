...
warnings.warn("""azure-native:securityinsights/v20220101preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.""", DeprecationWarning)
