...
warnings.warn("""azure-native:securityinsights/v20220101preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_dynamics365_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dynamics365_data_connector is deprecated: azure-native:securityinsights/v20220101preview:Dynamics365DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Dynamics365DataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
