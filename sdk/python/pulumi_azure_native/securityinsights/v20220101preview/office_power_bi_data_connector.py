...
class OfficePowerBIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_power_bi_data_connector = azure_native.securityinsights.v20220101preview.OfficePowerBIDataConnector("officePowerBIDataConnector",
        ...
        office_power_bi_data_connector = azure_native.securityinsights.v20220101preview.OfficePowerBIDataConnector("officePowerBIDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20220101preview.OfficePowerBIConnectorDataTypesArgs(
                logs=azure_native.securityinsights.v20220101preview.OfficePowerBIConnectorDataTypesLogsArgs(
                    state="Enabled",
                ),
            ),
            kind="OfficePowerBI",
