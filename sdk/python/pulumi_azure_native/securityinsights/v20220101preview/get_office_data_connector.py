...
def get_office_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220101preview:getOfficeDataConnector', __args__, opts=opts, typ=GetOfficeDataConnectorResult)
