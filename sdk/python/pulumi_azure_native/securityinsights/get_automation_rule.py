...
def get_automation_rule(automation_rule_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str automation_rule_id: Automation rule ID
...
def get_automation_rule_output(automation_rule_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
