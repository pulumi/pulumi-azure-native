...
def get_automation_rule(automation_rule_id: Optional[builtins.str] = None,
...
def get_automation_rule_output(automation_rule_id: Optional[pulumi.Input[builtins.str]] = None,
