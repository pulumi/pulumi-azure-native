...
class ContentTemplateArgs:
    def __init__(__self__, *,
                 ...
                 custom_version: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 package_kind: Optional[pulumi.Input[Union[_builtins.str, 'PackageKind']]] = None,
                 package_name: Optional[pulumi.Input[_builtins.str]] = None,
                 preview_images: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 preview_images_dark: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] content_id: Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
        :param pulumi.Input[Union[_builtins.str, 'Kind']] content_kind: The kind of content the template is for.
        :param pulumi.Input[_builtins.str] content_product_id: Unique ID for the content. It should be generated based on the contentId of the package, contentId of the template, contentKind of the template and the contentVersion of the template
        :param pulumi.Input[_builtins.str] display_name: The display name of the template
        :param pulumi.Input[_builtins.str] package_id: the package Id contains this template
        ...
        :param pulumi.Input[_builtins.str] content_schema_version: Schema version of the content. Can be used to distinguish between different flow based on the schema version
        :param pulumi.Input[_builtins.str] custom_version: The custom version of the content. A optional free text
        ...
        :param pulumi.Input[_builtins.str] first_publish_date: first publish date content item
        :param pulumi.Input[_builtins.str] icon: the icon identifier. this id can later be fetched from the content metadata
        :param pulumi.Input[_builtins.str] last_publish_date: last publish date for the content item
        :param Any main_template: The JSON of the ARM template to deploy active content. Expandable.
        :param pulumi.Input[Union[_builtins.str, 'PackageKind']] package_kind: the packageKind of the package contains this template
        :param pulumi.Input[_builtins.str] package_name: the name of the package contains this template
    ...
    def package_kind(self) -> Optional[pulumi.Input[Union[_builtins.str, 'PackageKind']]]:
        """
    ...
    @package_kind.setter
    def package_kind(self, value: Optional[pulumi.Input[Union[_builtins.str, 'PackageKind']]]):
    ...
    def preview_images(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def preview_images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "preview_images", value)

    @_builtins.property
    @pulumi.getter(name="previewImagesDark")
    def preview_images_dark(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def preview_images_dark(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class ContentTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 content_kind: Optional[pulumi.Input[Union[_builtins.str, 'Kind']]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="previewImagesDark")
    def preview_images_dark(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        preview image file names. These will be taken from the solution artifacts. used for dark theme support
        """
        return pulumi.get(self, "preview_images_dark")
