...
def get_metadata(metadata_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metadata_name: The Metadata name.
...
def get_metadata_output(metadata_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
