...
warnings.warn("""azure-native:securityinsights/v20221101:IncidentRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:IncidentRelation to guarantee forwards compatibility.""", DeprecationWarning)
...
class IncidentRelation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IncidentRelation, __self__).__init__(
            'azure-native:securityinsights/v20221101:IncidentRelation',
            resource_name,
            __props__,
            opts)
