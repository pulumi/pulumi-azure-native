...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        scheduled_alert_rule = azure_native.securityinsights.v20221101.ScheduledAlertRule("scheduledAlertRule",
        ...
        scheduled_alert_rule = azure_native.securityinsights.v20221101.ScheduledAlertRule("scheduledAlertRule",
            alert_details_override=azure_native.securityinsights.v20221101.AlertDetailsOverrideArgs(
            ...
            entity_mappings=[
                {
                    "entityType": "Host",
                    "fieldMappings": [azure_native.securityinsights.v20221101.FieldMappingArgs(
            ...
            event_grouping_settings=azure_native.securityinsights.v20221101.EventGroupingSettingsArgs(
                aggregation_kind="AlertPerResult",
            ),
            incident_configuration=azure_native.securityinsights.v20221101.IncidentConfigurationResponseArgs(
                create_incident=True,
                grouping_configuration=azure_native.securityinsights.v20221101.GroupingConfigurationArgs(
                    enabled=True,
            ...
            trigger_operator=azure_native.securityinsights/v20221101.TriggerOperator.GREATER_THAN,
            trigger_threshold=0,
            workspace_name="myWorkspace")
