...
warnings.warn("""azure-native:securityinsights/v20221101:FusionAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:FusionAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FusionAlertRule is deprecated: azure-native:securityinsights/v20221101:FusionAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:FusionAlertRule to guarantee forwards compatibility.""")
