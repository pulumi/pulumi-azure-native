...
def get_security_ml_analytics_setting(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20221101:getSecurityMLAnalyticsSetting', __args__, opts=opts, typ=GetSecurityMLAnalyticsSettingResult).value
