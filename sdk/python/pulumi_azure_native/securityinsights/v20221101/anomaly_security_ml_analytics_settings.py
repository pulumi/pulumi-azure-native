...
class AnomalySecurityMLAnalyticsSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        anomaly_security_ml_analytics_settings = azure_native.securityinsights.v20221101.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings",
            ...
            kind="Anomaly",
            required_data_connectors=[azure_native.securityinsights.v20221101.SecurityMLAnalyticsSettingsDataSourceArgs(
                connector_id="AWS",
    ...
    def _internal_init(__self__,
        ...
        super(AnomalySecurityMLAnalyticsSettings, __self__).__init__(
            'azure-native:securityinsights/v20221101:AnomalySecurityMLAnalyticsSettings',
            resource_name,
            __props__,
            opts)
