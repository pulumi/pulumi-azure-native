...
class MDATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mdatp_data_connector = azure_native.securityinsights.v20221101.MDATPDataConnector("mdatpDataConnector",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20221101:MDATPDataConnector 73e01a99-5cd7-4139-a149-9f2736ff2ab5 /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/dataConnectors/73e01a99-5cd7-4139-a149-9f2736ff2ab5 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(MDATPDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20221101:MDATPDataConnector',
            resource_name,
            __props__,
            opts)
