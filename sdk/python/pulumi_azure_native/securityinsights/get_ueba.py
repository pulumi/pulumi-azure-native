...
def get_ueba(resource_group_name: Optional[_builtins.str] = None,
             settings_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str settings_name: The setting name. Supports - Anomalies, EyesOn, EntityAnalytics, Ueba
...
def get_ueba_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                    settings_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
