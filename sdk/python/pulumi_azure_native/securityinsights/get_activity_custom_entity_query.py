...
class GetActivityCustomEntityQueryResult:
    ...
    def required_input_fields_sets(self) -> Optional[Sequence[Sequence[_builtins.str]]]:
        """
...
def get_activity_custom_entity_query(entity_query_id: Optional[_builtins.str] = None,
