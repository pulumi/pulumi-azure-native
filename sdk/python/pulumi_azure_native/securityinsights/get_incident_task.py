...
def get_incident_task(incident_id: Optional[_builtins.str] = None,
                      incident_task_id: Optional[_builtins.str] = None,
...
def get_incident_task_output(incident_id: pulumi.Input[Optional[_builtins.str]] = None,
                             incident_task_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
