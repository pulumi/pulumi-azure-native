...
class GetWorkspaceManagerGroupResult:
    ...
    def member_resource_names(self) -> Sequence[builtins.str]:
        """
...
def get_workspace_manager_group(resource_group_name: Optional[builtins.str] = None,
                                workspace_manager_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str workspace_manager_group_name: The name of the workspace manager group
...
def get_workspace_manager_group_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
