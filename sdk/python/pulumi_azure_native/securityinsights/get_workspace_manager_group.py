...
def get_workspace_manager_group(resource_group_name: Optional[_builtins.str] = None,
                                workspace_manager_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workspace_manager_group_name: The name of the workspace manager group
...
def get_workspace_manager_group_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                       workspace_manager_group_name: Optional[pulumi.Input[_builtins.str]] = None,
