...
class Hunt(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:Hunt"), pulumi.Alias(type_="azure-native:securityinsights:Hunt")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Hunt, __self__).__init__(
            'azure-native:securityinsights/v20231001preview:Hunt',
            resource_name,
            __props__,
            opts)
