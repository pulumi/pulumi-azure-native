...
class ContentPackage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230501preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20231101:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20240301:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20240901:ContentPackage"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:ContentPackage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentPackage, __self__).__init__(
            'azure-native:securityinsights/v20231001preview:ContentPackage',
            resource_name,
            __props__,
            opts)
