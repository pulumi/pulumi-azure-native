...
def get_file_import(file_import_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20231001preview:getFileImport', __args__, opts=opts, typ=GetFileImportResult).value
...
def get_file_import_output(file_import_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20231001preview:getFileImport', __args__, opts=opts, typ=GetFileImportResult)
