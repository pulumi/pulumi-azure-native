...
def get_anomalies(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20231001preview:getAnomalies', __args__, opts=opts, typ=GetAnomaliesResult).value
...
def get_anomalies_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAnomaliesResult]:
    """
    Gets a setting.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20231001preview:getAnomalies', __args__, opts=opts, typ=GetAnomaliesResult)
    return __ret__.apply(lambda __response__: GetAnomaliesResult(
