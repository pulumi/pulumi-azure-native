...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20231001preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult).value
...
def get_automation_rule_output(automation_rule_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20231001preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult)
