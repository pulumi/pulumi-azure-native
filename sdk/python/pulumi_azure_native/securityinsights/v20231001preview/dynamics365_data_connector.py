...
__all__ = ['Dynamics365DataConnectorArgs', 'Dynamics365DataConnector']

@pulumi.input_type
class Dynamics365DataConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['Dynamics365DataConnectorDataTypesArgs'] data_types: The available data types for the connector.
    ...
    def data_types(self) -> pulumi.Input['Dynamics365DataConnectorDataTypesArgs']:
        """
    ...
    @data_types.setter
    def data_types(self, value: pulumi.Input['Dynamics365DataConnectorDataTypesArgs']):
...
class Dynamics365DataConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_connector_id: Optional[pulumi.Input[str]] = None,
                 data_types: Optional[pulumi.Input[Union['Dynamics365DataConnectorDataTypesArgs', 'Dynamics365DataConnectorDataTypesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] data_connector_id: Connector ID
        :param pulumi.Input[Union['Dynamics365DataConnectorDataTypesArgs', 'Dynamics365DataConnectorDataTypesArgsDict']] data_types: The available data types for the connector.
        :param pulumi.Input[str] kind: The kind of the data connector
               Expected value is 'Dynamics365'.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] tenant_id: The tenant id to connect to, and get the data from.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Dynamics365DataConnectorArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Represents Dynamics365 data connector.

        :param str resource_name: The name of the resource.
        :param Dynamics365DataConnectorArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Dynamics365DataConnectorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'Dynamics365'
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Dynamics365DataConnector':
        """
        ...
        __props__.__dict__["type"] = None
        return Dynamics365DataConnector(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="dataTypes")
    def data_types(self) -> pulumi.Output['outputs.Dynamics365DataConnectorDataTypesResponse']:
        """
        The available data types for the connector.
        """
        return pulumi.get(self, "data_types")
