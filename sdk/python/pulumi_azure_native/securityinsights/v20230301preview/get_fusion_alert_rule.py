...
def get_fusion_alert_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230301preview:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult).value
    ...
    return AwaitableGetFusionAlertRuleResult(
        ...
        scenario_exclusion_patterns=pulumi.get(__ret__, 'scenario_exclusion_patterns'),
        severity=pulumi.get(__ret__, 'severity'),
        source_settings=pulumi.get(__ret__, 'source_settings'),
...
def get_fusion_alert_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230301preview:getFusionAlertRule', __args__, opts=opts, typ=GetFusionAlertRuleResult)
