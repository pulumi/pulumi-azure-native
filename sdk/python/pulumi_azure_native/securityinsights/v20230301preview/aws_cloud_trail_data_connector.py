...
class AwsCloudTrailDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aws_cloud_trail_data_connector = azure_native.securityinsights.v20230301preview.AwsCloudTrailDataConnector("awsCloudTrailDataConnector",
    ...
    def _internal_init(__self__,
        ...
        super(AwsCloudTrailDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20230301preview:AwsCloudTrailDataConnector',
            resource_name,
            __props__,
            opts)
