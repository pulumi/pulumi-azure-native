...
class FileImport(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        file_import = azure_native.securityinsights.v20230301preview.FileImport("fileImport",
            content_type="StixIndicator",
            file_import_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            import_file=azure_native.securityinsights.v20230301preview.FileMetadataArgs(
                file_format="JSON",
