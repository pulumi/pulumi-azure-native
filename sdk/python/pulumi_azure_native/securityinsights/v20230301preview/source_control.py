...
class SourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        source_control = azure_native.securityinsights.v20230301preview.SourceControl("sourceControl",
            content_types=[
                "AnalyticRules",
                "Workbook",
            ],
            ...
            repo_type="Github",
            repository=azure_native.securityinsights.v20230301preview.RepositoryResponseArgs(
                branch="master",
                display_url="https://github.com/user/repo",
                path_mapping=[
                    azure_native.securityinsights.v20230301preview.ContentPathMapArgs(
    ...
    def _internal_init(__self__,
        ...
        super(SourceControl, __self__).__init__(
            'azure-native:securityinsights/v20230301preview:SourceControl',
            resource_name,
            __props__,
            opts)
