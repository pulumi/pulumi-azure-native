...
class IncidentComment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        incident_comment = azure_native.securityinsights.v20230301preview.IncidentComment("incidentComment",
    ...
    def _internal_init(__self__,
        ...
        super(IncidentComment, __self__).__init__(
            'azure-native:securityinsights/v20230301preview:IncidentComment',
            resource_name,
            __props__,
            opts)
