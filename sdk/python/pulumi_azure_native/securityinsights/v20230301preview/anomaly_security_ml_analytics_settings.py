...
class AnomalySecurityMLAnalyticsSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        anomaly_security_ml_analytics_settings = azure_native.securityinsights.v20230301preview.AnomalySecurityMLAnalyticsSettings("anomalySecurityMLAnalyticsSettings",
            ...
            kind="Anomaly",
            required_data_connectors=[azure_native.securityinsights.v20230301preview.SecurityMLAnalyticsSettingsDataSourceArgs(
                connector_id="AWS",
