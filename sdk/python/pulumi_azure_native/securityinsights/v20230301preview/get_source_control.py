...
def get_source_control(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230301preview:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult).value
...
def get_source_control_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230301preview:getSourceControl', __args__, opts=opts, typ=GetSourceControlResult)
