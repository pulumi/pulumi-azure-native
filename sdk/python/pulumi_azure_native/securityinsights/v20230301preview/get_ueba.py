...
def get_ueba(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230301preview:getUeba', __args__, opts=opts, typ=GetUebaResult).value
...
def get_ueba_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230301preview:getUeba', __args__, opts=opts, typ=GetUebaResult)
