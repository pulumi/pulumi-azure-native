...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230301preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult).value
...
def get_automation_rule_output(automation_rule_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230301preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult)
