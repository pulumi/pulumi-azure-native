...
warnings.warn("""azure-native:securityinsights/v20220601preview:AwsS3DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AwsS3DataConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_aws_s3_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_aws_s3_data_connector is deprecated: azure-native:securityinsights/v20220601preview:AwsS3DataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:AwsS3DataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
