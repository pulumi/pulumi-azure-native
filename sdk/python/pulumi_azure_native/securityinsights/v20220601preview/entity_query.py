...
class EntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220101preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220401preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220501preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20220901preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20221001preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20221101preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20221201preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20230201preview:EntityQuery")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EntityQuery, __self__).__init__(
            'azure-native:securityinsights/v20220601preview:EntityQuery',
            resource_name,
            __props__,
            opts)
