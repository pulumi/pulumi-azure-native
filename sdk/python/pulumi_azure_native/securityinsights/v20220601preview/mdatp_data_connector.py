...
class MDATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mdatp_data_connector = azure_native.securityinsights.v20220601preview.MDATPDataConnector("mdatpDataConnector",
