...
def get_aatp_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20220601preview:getAATPDataConnector', __args__, opts=opts, typ=GetAATPDataConnectorResult)
