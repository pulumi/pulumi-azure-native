...
class Anomalies(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        anomalies = azure_native.securityinsights.v20220601preview.Anomalies("anomalies",
