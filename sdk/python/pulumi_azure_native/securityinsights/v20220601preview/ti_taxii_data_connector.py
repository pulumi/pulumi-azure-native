...
class TiTaxiiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20220601preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
        ...
        ti_taxii_data_connector = azure_native.securityinsights.v20220601preview.TiTaxiiDataConnector("tiTaxiiDataConnector",
            ...
            data_types=azure_native.securityinsights.v20220601preview.TiTaxiiDataConnectorDataTypesArgs(
                taxii_client=azure_native.securityinsights.v20220601preview.TiTaxiiDataConnectorDataTypesTaxiiClientArgs(
                    state="Enabled",
                ),
            ),
