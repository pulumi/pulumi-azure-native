...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_rule is deprecated: azure-native:securityinsights/v20220601preview:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:AutomationRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['automationRuleId'] = automation_rule_id
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20220601preview:getAutomationRule', __args__, opts=opts, typ=GetAutomationRuleResult).value
