...
warnings.warn("""azure-native:securityinsights/v20220601preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_metadata(metadata_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_metadata is deprecated: azure-native:securityinsights/v20220601preview:Metadata is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230201preview:Metadata to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['metadataName'] = metadata_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20220601preview:getMetadata', __args__, opts=opts, typ=GetMetadataResult).value
