...
class WorkspaceManagerMemberArgs:
    def __init__(__self__, *,
                 ...
                 target_workspace_resource_id: pulumi.Input[builtins.str],
                 target_workspace_tenant_id: pulumi.Input[builtins.str],
                 workspace_name: pulumi.Input[builtins.str],
                 workspace_manager_member_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WorkspaceManagerMember resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] target_workspace_resource_id: Fully qualified resource ID of the target Sentinel workspace joining the given Sentinel workspace manager
        :param pulumi.Input[builtins.str] target_workspace_tenant_id: Tenant id of the target Sentinel workspace joining the given Sentinel workspace manager
        :param pulumi.Input[builtins.str] workspace_name: The name of the workspace.
        :param pulumi.Input[builtins.str] workspace_manager_member_name: The name of the workspace manager member
        """
    ...
    def target_workspace_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_workspace_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_workspace_resource_id", value)

    @property
    @pulumi.getter(name="targetWorkspaceTenantId")
    def target_workspace_tenant_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_workspace_tenant_id(self, value: pulumi.Input[builtins.str]):
    ...
    def workspace_manager_member_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def workspace_manager_member_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceManagerMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 target_workspace_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_workspace_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 workspace_manager_member_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="targetWorkspaceResourceId")
    def target_workspace_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Fully qualified resource ID of the target Sentinel workspace joining the given Sentinel workspace manager
        """
        return pulumi.get(self, "target_workspace_resource_id")
    ...
    @property
    @pulumi.getter(name="targetWorkspaceTenantId")
    def target_workspace_tenant_id(self) -> pulumi.Output[builtins.str]:
        """
        Tenant id of the target Sentinel workspace joining the given Sentinel workspace manager
        """
        return pulumi.get(self, "target_workspace_tenant_id")
