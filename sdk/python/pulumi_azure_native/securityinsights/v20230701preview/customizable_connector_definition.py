...
class CustomizableConnectorDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:CustomizableConnectorDefinition"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:CustomizableConnectorDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomizableConnectorDefinition, __self__).__init__(
            'azure-native:securityinsights/v20230701preview:CustomizableConnectorDefinition',
            resource_name,
            __props__,
            opts)
