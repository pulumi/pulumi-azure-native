...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rule_id: Optional[pulumi.Input[str]] = None,
                 scenario_exclusion_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FusionScenarioExclusionPatternArgs', 'FusionScenarioExclusionPatternArgsDict']]]]] = None,
                 source_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FusionSourceSettingsArgs', 'FusionSourceSettingsArgsDict']]]]] = None,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] rule_id: Alert rule ID
        :param pulumi.Input[Sequence[pulumi.Input[Union['FusionScenarioExclusionPatternArgs', 'FusionScenarioExclusionPatternArgsDict']]]] scenario_exclusion_patterns: Configuration to exclude scenarios in fusion detection.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FusionSourceSettingsArgs', 'FusionSourceSettingsArgsDict']]]] source_settings: Configuration for all supported source signals in fusion detection.
        :param pulumi.Input[str] workspace_name: The name of the workspace.
        """
        ...
    @overload
