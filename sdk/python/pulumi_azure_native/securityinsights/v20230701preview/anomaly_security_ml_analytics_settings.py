...
class AnomalySecurityMLAnalyticsSettingsArgs:
    ...
    def _configure(
        ...
        if anomaly_version is None:
            raise TypeError("Missing 'anomaly_version' argument")
        ...
        if is_default_settings is None:
            raise TypeError("Missing 'is_default_settings' argument")
        if kind is None:
        ...
        if settings_status is None and 'settingsStatus' in kwargs:
            settings_status = kwargs['settingsStatus']
        if settings_status is None:
            raise TypeError("Missing 'settings_status' argument")
        ...
        if customizable_observations is None and 'customizableObservations' in kwargs:
            customizable_observations = kwargs['customizableObservations']
        ...
        if settings_resource_name is None and 'settingsResourceName' in kwargs:
            settings_resource_name = kwargs['settingsResourceName']
