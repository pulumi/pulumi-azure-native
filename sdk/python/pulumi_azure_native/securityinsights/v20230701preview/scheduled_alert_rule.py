...
class ScheduledAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(alert_details_override, AlertDetailsOverrideArgs):
            ...
            if not isinstance(event_grouping_settings, EventGroupingSettingsArgs):
            ...
            if not isinstance(incident_configuration, IncidentConfigurationArgs):
