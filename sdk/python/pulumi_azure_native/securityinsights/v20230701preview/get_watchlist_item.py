...
def get_watchlist_item(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230701preview:getWatchlistItem', __args__, opts=opts, typ=GetWatchlistItemResult).value
...
def get_watchlist_item_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230701preview:getWatchlistItem', __args__, opts=opts, typ=GetWatchlistItemResult)
