...
class AutomationRuleArgs:
    ...
    def _configure(
             ...
             actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutomationRuleAddIncidentTaskActionArgs', 'AutomationRuleModifyPropertiesActionArgs', 'AutomationRuleRunPlaybookActionArgs']]]]] = None,
...
class AutomationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(AutomationRule, __self__).__init__(
            'azure-native:securityinsights/v20230701preview:AutomationRule',
            resource_name,
            __props__,
            opts)
