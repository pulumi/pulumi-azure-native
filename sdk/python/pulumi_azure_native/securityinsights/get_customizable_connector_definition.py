...
def get_customizable_connector_definition(data_connector_definition_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_connector_definition_name: The data connector definition name.
...
def get_customizable_connector_definition_output(data_connector_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
