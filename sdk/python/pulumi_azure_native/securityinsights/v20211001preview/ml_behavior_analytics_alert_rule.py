...
class MLBehaviorAnalyticsAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ml_behavior_analytics_alert_rule = azure_native.securityinsights.v20211001preview.MLBehaviorAnalyticsAlertRule("mlBehaviorAnalyticsAlertRule",
    ...
    def _internal_init(__self__,
        ...
        super(MLBehaviorAnalyticsAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20211001preview:MLBehaviorAnalyticsAlertRule',
            resource_name,
            __props__,
            opts)
