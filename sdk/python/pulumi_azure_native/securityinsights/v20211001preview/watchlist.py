...
class Watchlist(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        watchlist = azure_native.securityinsights.v20211001preview.Watchlist("watchlist",
        ...
        ```sh
        $ pulumi import azure-native:securityinsights/v20211001preview:Watchlist highValueAsset /subscriptions/d0cfe6b2-9ac0-4464-9919-dccaee2e48c0/resourceGroups/myRg/providers/Microsoft.OperationalIinsights/workspaces/myWorkspace/providers/Microsoft.SecurityInsights/watchlists/highValueAsset 
        ```
