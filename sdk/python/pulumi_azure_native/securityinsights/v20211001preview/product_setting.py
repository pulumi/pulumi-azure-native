...
class ProductSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:ProductSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220101preview:ProductSetting")])
