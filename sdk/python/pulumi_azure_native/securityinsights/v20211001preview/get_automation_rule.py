...
warnings.warn("""azure-native:securityinsights/v20211001preview:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AutomationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_automation_rule(automation_rule_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_automation_rule is deprecated: azure-native:securityinsights/v20211001preview:AutomationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AutomationRule to guarantee forwards compatibility.""")
    __args__ = dict()
