...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        fusion_alert_rule = azure_native.securityinsights.v20211001preview.FusionAlertRule("fusionAlertRule",
            ...
            source_settings=[
                azure_native.securityinsights.v20211001preview.FusionSourceSettingsArgs(
                    enabled=True,
                    source_name="Anomalies",
                ),
                {
                    "enabled": True,
                    ...
                    "sourceSubTypes": [
                        {
                            "enabled": True,
                            "severityFilters": azure_native.securityinsights.v20211001preview.FusionSubTypeSeverityFilterArgs(
                                filters=[
                                    azure_native.securityinsights.v20211001preview.FusionSubTypeSeverityFiltersItemArgs(
                                        enabled=True,
                                        severity="High",
                                    ),
                                    azure_native.securityinsights.v20211001preview.FusionSubTypeSeverityFiltersItemArgs(
