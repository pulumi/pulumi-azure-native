...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MCASDataConnector is deprecated: azure-native:securityinsights/v20211001preview:MCASDataConnector is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:MCASDataConnector to guarantee forwards compatibility.""")
