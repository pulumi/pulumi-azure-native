...
def get_incident_relation_output(incident_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20211001preview:getIncidentRelation', __args__, opts=opts, typ=GetIncidentRelationResult)
