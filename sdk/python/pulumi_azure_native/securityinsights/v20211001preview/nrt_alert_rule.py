...
class NrtAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        nrt_alert_rule = azure_native.securityinsights.v20211001preview.NrtAlertRule("nrtAlertRule",
        ...
        nrt_alert_rule = azure_native.securityinsights.v20211001preview.NrtAlertRule("nrtAlertRule",
            ...
            display_name="Rule2",
            enabled=True,
            incident_configuration=azure_native.securityinsights.v20211001preview.IncidentConfigurationResponseArgs(
                create_incident=True,
                grouping_configuration=azure_native.securityinsights.v20211001preview.GroupingConfigurationArgs(
                    enabled=True,
                    group_by_entities=[
                        "Host",
                        "Account",
