...
class NrtAlertRuleArgs:
    ...
    @property
    @pulumi.getter
    def severity(self) -> Optional[pulumi.Input[Union[str, 'AlertSeverity']]]:
        """
    ...
    @severity.setter
    def severity(self, value: Optional[pulumi.Input[Union[str, 'AlertSeverity']]]):
