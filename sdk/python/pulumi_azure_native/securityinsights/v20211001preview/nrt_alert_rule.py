...
class NrtAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20211001:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220101preview:NrtAlertRule"), pulumi.Alias(type_="azure-native:securityinsights/v20220401preview:NrtAlertRule")])
