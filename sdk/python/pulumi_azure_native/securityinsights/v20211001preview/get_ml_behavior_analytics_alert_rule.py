...
warnings.warn("""azure-native:securityinsights/v20211001preview:MLBehaviorAnalyticsAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:MLBehaviorAnalyticsAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
