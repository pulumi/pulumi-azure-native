...
class MSTIDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        msti_data_connector = azure_native.securityinsights.v20211001preview.MSTIDataConnector("mstiDataConnector",
