...
class OfficePowerBIDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:OfficePowerBIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:OfficePowerBIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:OfficePowerBIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:OfficePowerBIDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210901preview:OfficePowerBIDataConnector")])
