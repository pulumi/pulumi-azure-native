...
def get_product_setting(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20211001preview:getProductSetting', __args__, opts=opts, typ=GetProductSettingResult).value
...
def get_product_setting_output(resource_group_name: Optional[pulumi.Input[str]] = None,
