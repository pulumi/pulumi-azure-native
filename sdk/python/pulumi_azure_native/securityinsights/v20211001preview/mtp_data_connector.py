...
class MTPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mtp_data_connector = azure_native.securityinsights.v20211001preview.MTPDataConnector("mtpDataConnector",
