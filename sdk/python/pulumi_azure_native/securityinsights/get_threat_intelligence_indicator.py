...
def get_threat_intelligence_indicator(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Threat intelligence indicator name field.
...
def get_threat_intelligence_indicator_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
