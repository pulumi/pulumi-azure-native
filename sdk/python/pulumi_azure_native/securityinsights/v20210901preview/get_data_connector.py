...
def get_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20210901preview:getDataConnector', __args__, opts=opts, typ=GetDataConnectorResult).value
