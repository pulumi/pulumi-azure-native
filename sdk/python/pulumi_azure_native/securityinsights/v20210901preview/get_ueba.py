...
warnings.warn("""azure-native:securityinsights/v20210901preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Ueba to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_ueba(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ueba is deprecated: azure-native:securityinsights/v20210901preview:Ueba is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:Ueba to guarantee forwards compatibility.""")
    __args__ = dict()
