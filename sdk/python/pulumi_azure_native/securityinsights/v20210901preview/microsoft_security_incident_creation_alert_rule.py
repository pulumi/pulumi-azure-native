...
class MicrosoftSecurityIncidentCreationAlertRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        microsoft_security_incident_creation_alert_rule = azure_native.securityinsights.v20210901preview.MicrosoftSecurityIncidentCreationAlertRule("microsoftSecurityIncidentCreationAlertRule",
