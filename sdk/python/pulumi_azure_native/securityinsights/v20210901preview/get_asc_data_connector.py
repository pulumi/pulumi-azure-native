...
def get_asc_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asc_data_connector is deprecated: azure-native:securityinsights/v20210901preview:ASCDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ASCDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
