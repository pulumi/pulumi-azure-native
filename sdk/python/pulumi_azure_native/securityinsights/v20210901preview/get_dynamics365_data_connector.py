...
def get_dynamics365_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20210901preview:getDynamics365DataConnector', __args__, opts=opts, typ=GetDynamics365DataConnectorResult)
