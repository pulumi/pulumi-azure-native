...
class EntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:EntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:EntityQuery")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EntityQuery, __self__).__init__(
            'azure-native:securityinsights/v20210901preview:EntityQuery',
            resource_name,
            __props__,
            opts)
