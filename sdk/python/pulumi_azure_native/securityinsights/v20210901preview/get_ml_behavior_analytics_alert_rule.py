...
def get_ml_behavior_analytics_alert_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20210901preview:getMLBehaviorAnalyticsAlertRule', __args__, opts=opts, typ=GetMLBehaviorAnalyticsAlertRuleResult)
