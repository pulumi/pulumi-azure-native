...
class CodelessApiPollingDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:CodelessApiPollingDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:CodelessApiPollingDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:CodelessApiPollingDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:CodelessApiPollingDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20211001preview:CodelessApiPollingDataConnector")])
