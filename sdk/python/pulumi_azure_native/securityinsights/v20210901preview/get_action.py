...
def get_action(action_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action is deprecated: azure-native:securityinsights/v20210901preview:Action is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:Action to guarantee forwards compatibility.""")
    __args__ = dict()
