...
class OfficeIRMDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_irm_data_connector = azure_native.securityinsights.v20210901preview.OfficeIRMDataConnector("officeIRMDataConnector",
