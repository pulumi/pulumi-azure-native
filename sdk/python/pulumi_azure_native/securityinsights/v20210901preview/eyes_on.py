...
warnings.warn("""azure-native:securityinsights/v20210901preview:EyesOn is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230401preview:EyesOn to guarantee forwards compatibility.""", DeprecationWarning)
...
class EyesOn(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(EyesOn, __self__).__init__(
            'azure-native:securityinsights/v20210901preview:EyesOn',
            resource_name,
            __props__,
            opts)
