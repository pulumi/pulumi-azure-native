...
class OfficeATPDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_atp_data_connector = azure_native.securityinsights.v20210901preview.OfficeATPDataConnector("officeATPDataConnector",
