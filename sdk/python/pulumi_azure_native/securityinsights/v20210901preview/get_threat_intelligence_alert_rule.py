...
warnings.warn("""azure-native:securityinsights/v20210901preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_threat_intelligence_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_threat_intelligence_alert_rule is deprecated: azure-native:securityinsights/v20210901preview:ThreatIntelligenceAlertRule is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230401preview:ThreatIntelligenceAlertRule to guarantee forwards compatibility.""")
    __args__ = dict()
