...
def get_content_template(resource_group_name: Optional[builtins.str] = None,
...
def get_content_template_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
