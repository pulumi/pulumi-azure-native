...
class EntityAnalyticsArgs:
    def __init__(__self__, *,
        ...
        """
        EntityAnalyticsArgs._configure(
    ...
    def _configure(
        ...
        if entity_providers is None and 'entityProviders' in kwargs:
            entity_providers = kwargs['entityProviders']
        if settings_name is None and 'settingsName' in kwargs:
            settings_name = kwargs['settingsName']

        _setter("kind", 'EntityAnalytics')
        _setter("resource_group_name", resource_group_name)
        _setter("workspace_name", workspace_name)
        if entity_providers is not None:
            _setter("entity_providers", entity_providers)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EntityAnalyticsArgs._configure(_setter, **kwargs)
