...
class SecurityMLAnalyticsSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220601preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220901preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221001preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221101preview:SecurityMLAnalyticsSetting")])
