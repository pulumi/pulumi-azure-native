...
def get_bookmark_relation(bookmark_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bookmark_relation is deprecated: azure-native:securityinsights/v20220501preview:BookmarkRelation is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:BookmarkRelation to guarantee forwards compatibility.""")
    __args__ = dict()
