...
def get_watchlist(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watchlist is deprecated: azure-native:securityinsights/v20220901preview:Watchlist is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201:Watchlist to guarantee forwards compatibility.""")
    __args__ = dict()
