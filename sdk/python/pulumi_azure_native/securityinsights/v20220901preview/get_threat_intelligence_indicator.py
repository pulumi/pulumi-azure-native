...
warnings.warn("""azure-native:securityinsights/v20220901preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_threat_intelligence_indicator(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_threat_intelligence_indicator is deprecated: azure-native:securityinsights/v20220901preview:ThreatIntelligenceIndicator is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:ThreatIntelligenceIndicator to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
