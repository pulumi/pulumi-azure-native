...
def get_ti_taxii_data_connector(data_connector_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_ti_taxii_data_connector is deprecated: azure-native:securityinsights/v20220901preview:TiTaxiiDataConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:TiTaxiiDataConnector to guarantee forwards compatibility.""")
    __args__ = dict()
