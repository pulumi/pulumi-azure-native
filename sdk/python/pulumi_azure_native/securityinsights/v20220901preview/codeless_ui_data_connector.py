...
class CodelessUiDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20220901preview.CodelessUiDataConnector("codelessUiDataConnector",
        ...
        codeless_ui_data_connector = azure_native.securityinsights.v20220901preview.CodelessUiDataConnector("codelessUiDataConnector",
            connector_ui_config=azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesResponseArgs(
                availability=azure_native.securityinsights.v20220901preview.AvailabilityArgs(
                    is_preview=True,
                    status=1,
                ),
                connectivity_criteria=[azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesConnectivityCriteriaArgs(
                    type="IsConnectedQuery",
                    value=[\"\"\"{{graphQueriesTableName}}
                    | summarize LastLogReceived = max(TimeGenerated)
                    | project IsConnected = LastLogReceived > ago(30d)\"\"\"],
                )],
                data_types=[azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesDataTypesArgs(
                ...
                graph_queries=[azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesGraphQueriesArgs(
                ...
                instruction_steps=[
                    azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesInstructionStepsArgs(
        ...
        >**IMPORTANT:** Before deploying the Qualys VM connector, have the Workspace ID and Workspace Primary Key (can be copied from the following), as well as the Qualys VM API Authorization Key(s), readily available.\"\"\",
                        "instructions": [
                            azure_native.securityinsights.v20220901preview.InstructionStepsInstructionsArgs(
                                parameters={
        ...
        > NOTE: If a longer timeout duration is required, consider upgrading to an [App Service Plan](https://docs.microsoft.com/azure/azure-functions/functions-scale#timeout)\"\"\",
                ...
                permissions={
                    "customs": [
                        azure_native.securityinsights.v20220901preview.PermissionsCustomsArgs(
                    ...
                    "resourceProvider": [
                        {
                            ...
                            "requiredPermissions": azure_native.securityinsights.v20220901preview.RequiredPermissionsArgs(
                                delete=True,
                                read=True,
                                write=True,
                            ),
                ...
                publisher="Qualys",
                sample_queries=[azure_native.securityinsights.v20220901preview.CodelessUiConnectorConfigPropertiesSampleQueriesArgs(
