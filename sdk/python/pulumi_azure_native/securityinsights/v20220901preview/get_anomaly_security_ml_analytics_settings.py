...
def get_anomaly_security_ml_analytics_settings(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_anomaly_security_ml_analytics_settings is deprecated: azure-native:securityinsights/v20220901preview:AnomalySecurityMLAnalyticsSettings is being removed in the next major version of this provider. Upgrade to at least azure-native:securityinsights/v20230601preview:AnomalySecurityMLAnalyticsSettings to guarantee forwards compatibility.""")
    __args__ = dict()
