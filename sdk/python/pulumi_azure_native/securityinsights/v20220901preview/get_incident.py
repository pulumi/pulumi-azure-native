...
warnings.warn("""azure-native:securityinsights/v20220901preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_incident(incident_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_incident is deprecated: azure-native:securityinsights/v20220901preview:Incident is being removed in the next major version of this provider. Please upgrade to azure-native:securityinsights/v20230201preview:Incident to guarantee forwards compatibility.""")
    __args__ = dict()
