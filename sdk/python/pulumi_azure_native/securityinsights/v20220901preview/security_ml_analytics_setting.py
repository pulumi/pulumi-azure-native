...
class SecurityMLAnalyticsSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220501preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220601preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220701preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20220801preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221001preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221101:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221101preview:SecurityMLAnalyticsSetting"), pulumi.Alias(type_="azure-native:securityinsights/v20221201preview:SecurityMLAnalyticsSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecurityMLAnalyticsSetting, __self__).__init__(
            'azure-native:securityinsights/v20220901preview:SecurityMLAnalyticsSetting',
            resource_name,
            __props__,
            opts)
