...
class OfficeDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        office_data_connector = azure_native.securityinsights.v20220901preview.OfficeDataConnector("officeDataConnector",
        ...
        office_data_connector = azure_native.securityinsights.v20220901preview.OfficeDataConnector("officeDataConnector",
            data_connector_id="73e01a99-5cd7-4139-a149-9f2736ff2ab5",
            data_types=azure_native.securityinsights.v20220901preview.OfficeDataConnectorDataTypesArgs(
                exchange=azure_native.securityinsights.v20220901preview.OfficeDataConnectorDataTypesExchangeArgs(
                    state="Enabled",
                ),
                share_point=azure_native.securityinsights.v20220901preview.OfficeDataConnectorDataTypesSharePointArgs(
                    state="Enabled",
                ),
                teams=azure_native.securityinsights.v20220901preview.OfficeDataConnectorDataTypesTeamsArgs(
                    state="Enabled",
                ),
            ),
            kind="Office365",
