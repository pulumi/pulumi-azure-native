...
class IoTDataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_data_connector = azure_native.securityinsights.v20220901preview.IoTDataConnector("ioTDataConnector",
