...
__all__ = [
    ...
    'AwaitableGetMicrosoftPurviewInformationProtectionDataConnectorResult',
...
@pulumi.output_type
class GetMicrosoftPurviewInformationProtectionDataConnectorResult:
    """
    ...
    def data_types(self) -> 'outputs.MicrosoftPurviewInformationProtectionConnectorDataTypesResponse':
        """
...
class AwaitableGetMicrosoftPurviewInformationProtectionDataConnectorResult(GetMicrosoftPurviewInformationProtectionDataConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMicrosoftPurviewInformationProtectionDataConnectorResult(
...
def get_microsoft_purview_information_protection_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getMicrosoftPurviewInformationProtectionDataConnector', __args__, opts=opts, typ=GetMicrosoftPurviewInformationProtectionDataConnectorResult).value
...
def get_microsoft_purview_information_protection_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getMicrosoftPurviewInformationProtectionDataConnector', __args__, opts=opts, typ=GetMicrosoftPurviewInformationProtectionDataConnectorResult)
