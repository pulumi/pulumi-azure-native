...
def get_hunt(hunt_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getHunt', __args__, opts=opts, typ=GetHuntResult).value
...
def get_hunt_output(hunt_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getHunt', __args__, opts=opts, typ=GetHuntResult)
