...
def get_content_template(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getContentTemplate', __args__, opts=opts, typ=GetContentTemplateResult).value
...
def get_content_template_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getContentTemplate', __args__, opts=opts, typ=GetContentTemplateResult)
