...
def get_threat_intelligence_alert_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getThreatIntelligenceAlertRule', __args__, opts=opts, typ=GetThreatIntelligenceAlertRuleResult).value
...
def get_threat_intelligence_alert_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getThreatIntelligenceAlertRule', __args__, opts=opts, typ=GetThreatIntelligenceAlertRuleResult)
