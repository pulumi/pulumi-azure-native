...
def get_bookmark_relation(bookmark_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getBookmarkRelation', __args__, opts=opts, typ=GetBookmarkRelationResult).value
...
def get_bookmark_relation_output(bookmark_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getBookmarkRelation', __args__, opts=opts, typ=GetBookmarkRelationResult)
