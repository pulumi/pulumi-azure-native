...
def get_eyes_on(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getEyesOn', __args__, opts=opts, typ=GetEyesOnResult).value
...
def get_eyes_on_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getEyesOn', __args__, opts=opts, typ=GetEyesOnResult)
