...
def get_office_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getOfficeDataConnector', __args__, opts=opts, typ=GetOfficeDataConnectorResult).value
...
def get_office_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getOfficeDataConnector', __args__, opts=opts, typ=GetOfficeDataConnectorResult)
