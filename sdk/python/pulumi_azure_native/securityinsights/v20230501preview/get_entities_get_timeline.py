...
def get_entities_get_timeline(end_time: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getEntitiesGetTimeline', __args__, opts=opts, typ=GetEntitiesGetTimelineResult).value
...
def get_entities_get_timeline_output(end_time: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getEntitiesGetTimeline', __args__, opts=opts, typ=GetEntitiesGetTimelineResult)
