...
def get_entity_analytics(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20230501preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult).value
...
def get_entity_analytics_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20230501preview:getEntityAnalytics', __args__, opts=opts, typ=GetEntityAnalyticsResult)
