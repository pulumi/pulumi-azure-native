...
class WorkspaceManagerGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_name: The display name of the workspace manager group
        :param pulumi.Input[Sequence[pulumi.Input[str]]] member_resource_names: The names of the workspace manager members participating in this group.
    ...
    def member_resource_names(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    def member_resource_names(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
    ...
    def workspace_manager_group_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def workspace_manager_group_name(self, value: Optional[pulumi.Input[str]]):
...
class WorkspaceManagerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 member_resource_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20230401preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20230601preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20230701preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20230801preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20230901preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20231001preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20231201preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20240101preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:WorkspaceManagerGroup"), pulumi.Alias(type_="azure-native:securityinsights/v20241001preview:WorkspaceManagerGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceManagerGroup, __self__).__init__(
            'azure-native:securityinsights/v20230501preview:WorkspaceManagerGroup',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="memberResourceNames")
    def member_resource_names(self) -> pulumi.Output[Sequence[str]]:
        """
        The names of the workspace manager members participating in this group.
        """
        return pulumi.get(self, "member_resource_names")
