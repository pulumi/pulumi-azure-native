...
class CustomizableConnectorDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 created_time_utc: Optional[pulumi.Input[builtins.str]] = None,
                 data_connector_definition_name: Optional[pulumi.Input[builtins.str]] = None,
                 last_modified_utc: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] kind: The kind of the data connector definitions
        ...
        :param pulumi.Input[builtins.str] created_time_utc: Gets or sets the connector definition created date in UTC format.
        :param pulumi.Input[builtins.str] data_connector_definition_name: The data connector definition name.
        :param pulumi.Input[builtins.str] last_modified_utc: Gets or sets the connector definition last modified date in UTC format.
        """
    ...
    def created_time_utc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def created_time_utc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "created_time_utc", value)

    @property
    @pulumi.getter(name="dataConnectorDefinitionName")
    def data_connector_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_connector_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_connector_definition_name", value)

    @property
    @pulumi.getter(name="lastModifiedUtc")
    def last_modified_utc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_modified_utc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomizableConnectorDefinition(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="createdTimeUtc")
    def created_time_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gets or sets the connector definition created date in UTC format.
        """
        return pulumi.get(self, "created_time_utc")
    ...
    @property
    @pulumi.getter(name="lastModifiedUtc")
    def last_modified_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gets or sets the connector definition last modified date in UTC format.
        """
        return pulumi.get(self, "last_modified_utc")
