...
class ASCDataConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The subscription id to connect to, and get the data from.
        """
