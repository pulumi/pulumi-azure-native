...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if last_deployment_info is not None and not isinstance(last_deployment_info, DeploymentInfoArgs):
            ...
            if repository is not None and not isinstance(repository, RepositoryArgs):
            ...
            if repository_resource_info is not None and not isinstance(repository_resource_info, RepositoryResourceInfoArgs):
