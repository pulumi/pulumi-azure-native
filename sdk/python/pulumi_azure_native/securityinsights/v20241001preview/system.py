...
class System(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityinsights/v20240401preview:System"), pulumi.Alias(type_="azure-native:securityinsights/v20250101preview:System"), pulumi.Alias(type_="azure-native:securityinsights:System")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(System, __self__).__init__(
            'azure-native:securityinsights/v20241001preview:System',
            resource_name,
            __props__,
            opts)
