...
def get_workspace_manager_group(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:getWorkspaceManagerGroup', __args__, opts=opts, typ=GetWorkspaceManagerGroupResult).value
...
def get_workspace_manager_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:getWorkspaceManagerGroup', __args__, opts=opts, typ=GetWorkspaceManagerGroupResult)
