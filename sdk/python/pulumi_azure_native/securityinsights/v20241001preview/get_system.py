...
def get_system(agent_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:getSystem', __args__, opts=opts, typ=GetSystemResult).value
...
def get_system_output(agent_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:getSystem', __args__, opts=opts, typ=GetSystemResult)
