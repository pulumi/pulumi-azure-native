...
def get_file_import(file_import_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:getFileImport', __args__, opts=opts, typ=GetFileImportResult).value
...
def get_file_import_output(file_import_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:getFileImport', __args__, opts=opts, typ=GetFileImportResult)
