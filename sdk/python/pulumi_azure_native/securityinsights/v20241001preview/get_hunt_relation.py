...
def get_hunt_relation(hunt_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:getHuntRelation', __args__, opts=opts, typ=GetHuntRelationResult).value
...
def get_hunt_relation_output(hunt_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:getHuntRelation', __args__, opts=opts, typ=GetHuntRelationResult)
