...
def list_system_actions(agent_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:listSystemActions', __args__, opts=opts, typ=ListSystemActionsResult).value
...
def list_system_actions_output(agent_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:listSystemActions', __args__, opts=opts, typ=ListSystemActionsResult)
