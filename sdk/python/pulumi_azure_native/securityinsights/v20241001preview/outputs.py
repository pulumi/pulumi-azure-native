...
__all__ = [
    ...
    'PurviewAuditConnectorDataTypesResponse',
    'PurviewAuditConnectorDataTypesResponseLogs',
    'RepoResponse',
...
@pulumi.output_type
class PurviewAuditConnectorDataTypesResponse(dict):
    """
    The available data types for PurviewAudit data connector.
    """
    def __init__(__self__, *,
                 logs: 'outputs.PurviewAuditConnectorDataTypesResponseLogs'):
        """
        The available data types for PurviewAudit data connector.
        :param 'PurviewAuditConnectorDataTypesResponseLogs' logs: Logs data type.
        """
        pulumi.set(__self__, "logs", logs)

    @property
    @pulumi.getter
    def logs(self) -> 'outputs.PurviewAuditConnectorDataTypesResponseLogs':
        """
        Logs data type.
        """
        return pulumi.get(self, "logs")
...
@pulumi.output_type
class PurviewAuditConnectorDataTypesResponseLogs(dict):
    """
    Logs data type.
    """
    def __init__(__self__, *,
