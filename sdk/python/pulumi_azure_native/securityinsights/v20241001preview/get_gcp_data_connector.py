...
def get_gcp_data_connector(data_connector_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/v20241001preview:getGCPDataConnector', __args__, opts=opts, typ=GetGCPDataConnectorResult).value
...
def get_gcp_data_connector_output(data_connector_id: Optional[pulumi.Input[str]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGCPDataConnectorResult]:
    """
    Gets a data connector.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityinsights/v20241001preview:getGCPDataConnector', __args__, opts=opts, typ=GetGCPDataConnectorResult)
    return __ret__.apply(lambda __response__: GetGCPDataConnectorResult(
