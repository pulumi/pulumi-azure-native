...
class AnomalySecurityMLAnalyticsSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] frequency: The frequency that this SecurityMLAnalyticsSettings will be run.
        :param pulumi.Input[_builtins.bool] is_default_settings: Determines whether this anomaly security ml analytics settings is a default settings
    ...
    def settings_status(self, value: pulumi.Input[Union[_builtins.str, 'SettingsStatus']]):
