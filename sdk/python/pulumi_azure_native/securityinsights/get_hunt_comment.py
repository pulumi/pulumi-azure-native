...
def get_hunt_comment(hunt_comment_id: Optional[builtins.str] = None,
                     hunt_id: Optional[builtins.str] = None,
...
def get_hunt_comment_output(hunt_comment_id: Optional[pulumi.Input[builtins.str]] = None,
