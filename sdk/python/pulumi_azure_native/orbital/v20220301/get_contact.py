...
def get_contact(contact_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:orbital/v20220301:getContact', __args__, opts=opts, typ=GetContactResult).value
...
def get_contact_output(contact_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['spacecraftName'] = spacecraft_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:orbital/v20220301:getContact', __args__, opts=opts, typ=GetContactResult)
