...
class Spacecraft(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:orbital:Spacecraft"), pulumi.Alias(type_="azure-native:orbital/v20210404preview:Spacecraft")])
