...
class EdgeSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:orbital:EdgeSite"), pulumi.Alias(type_="azure-native:orbital/v20240301:EdgeSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EdgeSite, __self__).__init__(
            'azure-native:orbital/v20240301preview:EdgeSite',
            resource_name,
            __props__,
            opts)
