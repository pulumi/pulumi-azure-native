...
def get_ground_station(ground_station_name: Optional[_builtins.str] = None,
...
def get_ground_station_output(ground_station_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
