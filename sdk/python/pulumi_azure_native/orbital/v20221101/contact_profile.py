...
class ContactProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        contact_profile = azure_native.orbital.v20221101.ContactProfile("contactProfile",
            auto_tracking_configuration=azure_native.orbital/v20221101.AutoTrackingConfiguration.DISABLED,
            ...
            links=[
                {
                    "channels": [azure_native.orbital.v20221101.ContactProfileLinkChannelArgs(
                        bandwidth_m_hz=2,
                        center_frequency_m_hz=2250,
                        end_point=azure_native.orbital.v20221101.EndPointArgs(
            ...
            network_configuration=azure_native.orbital.v20221101.ContactProfilesPropertiesNetworkConfigurationArgs(
