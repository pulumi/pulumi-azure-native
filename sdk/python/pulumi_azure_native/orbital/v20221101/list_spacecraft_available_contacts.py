...
def list_spacecraft_available_contacts(contact_profile: Optional[Union['ContactParametersContactProfile', 'ContactParametersContactProfileDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:orbital/v20221101:listSpacecraftAvailableContacts', __args__, opts=opts, typ=ListSpacecraftAvailableContactsResult).value
