...
class SpacecraftArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] title_line: Title line of the two-line element set (TLE).
        :param pulumi.Input[str] tle_line1: Line 1 of the two-line element set (TLE).
        :param pulumi.Input[str] tle_line2: Line 2 of the two-line element set (TLE).
    ...
    def tle_line1(self) -> pulumi.Input[str]:
        """
    ...
    @tle_line1.setter
    def tle_line1(self, value: pulumi.Input[str]):
        pulumi.set(self, "tle_line1", value)

    @property
    @pulumi.getter(name="tleLine2")
    def tle_line2(self) -> pulumi.Input[str]:
        """
    ...
    @tle_line2.setter
    def tle_line2(self, value: pulumi.Input[str]):
...
class Spacecraft(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if tle_line1 is None and not opts.urn:
                raise TypeError("Missing required property 'tle_line1'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:orbital:Spacecraft"), pulumi.Alias(type_="azure-native:orbital/v20210404preview:Spacecraft"), pulumi.Alias(type_="azure-native:orbital/v20220301:Spacecraft")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Spacecraft, __self__).__init__(
            'azure-native:orbital/v20221101:Spacecraft',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="noradId")
    def norad_id(self) -> pulumi.Output[Optional[str]]:
        """
        NORAD ID of the spacecraft.
        """
        return pulumi.get(self, "norad_id")
    ...
    @property
    @pulumi.getter(name="tleLine1")
    def tle_line1(self) -> pulumi.Output[str]:
        """
        Line 1 of the two-line element set (TLE).
        """
        return pulumi.get(self, "tle_line1")
    ...
    @property
    @pulumi.getter(name="tleLine2")
    def tle_line2(self) -> pulumi.Output[str]:
        """
        Line 2 of the two-line element set (TLE).
        """
        return pulumi.get(self, "tle_line2")
