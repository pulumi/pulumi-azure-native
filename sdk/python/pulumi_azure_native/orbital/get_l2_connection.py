...
def get_l2_connection(l2_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str l2_connection_name: L2 Connection name.
...
def get_l2_connection_output(l2_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
