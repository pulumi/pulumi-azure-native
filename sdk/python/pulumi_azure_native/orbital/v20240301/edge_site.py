...
class EdgeSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 edge_site_name: Optional[pulumi.Input[str]] = None,
                 global_communications_site: Optional[pulumi.Input[pulumi.InputType['EdgeSitesPropertiesGlobalCommunicationsSiteArgs']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] edge_site_name: Edge site name.
        :param pulumi.Input[pulumi.InputType['EdgeSitesPropertiesGlobalCommunicationsSiteArgs']] global_communications_site: A reference to global communications site.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
