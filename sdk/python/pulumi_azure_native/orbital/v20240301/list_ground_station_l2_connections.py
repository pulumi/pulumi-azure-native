...
def list_ground_station_l2_connections(ground_station_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:orbital/v20240301:listGroundStationL2Connections', __args__, opts=opts, typ=ListGroundStationL2ConnectionsResult).value
...
def list_ground_station_l2_connections_output(ground_station_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:orbital/v20240301:listGroundStationL2Connections', __args__, opts=opts, typ=ListGroundStationL2ConnectionsResult)
