...
class GroundStation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:orbital/v20240301preview:GroundStation"), pulumi.Alias(type_="azure-native:orbital:GroundStation")])
