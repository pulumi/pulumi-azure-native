...
def get_edge_site(edge_site_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:orbital/v20240301:getEdgeSite', __args__, opts=opts, typ=GetEdgeSiteResult).value
...
def get_edge_site_output(edge_site_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:orbital/v20240301:getEdgeSite', __args__, opts=opts, typ=GetEdgeSiteResult)
