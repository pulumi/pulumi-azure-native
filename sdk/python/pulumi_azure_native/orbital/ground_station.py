...
class GroundStationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] provider_name: Ground station provider name.
    ...
    @_builtins.property
    @pulumi.getter
    def capabilities(self) -> pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'Capability']]]]:
        """
    ...
    @capabilities.setter
    def capabilities(self, value: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'Capability']]]]):
