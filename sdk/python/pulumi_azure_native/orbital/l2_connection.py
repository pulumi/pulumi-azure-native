...
class L2Connection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:orbital/v20240301:L2Connection"), pulumi.Alias(type_="azure-native:orbital/v20240301preview:L2Connection"), pulumi.Alias(type_="azure-native_orbital_v20240301:orbital:L2Connection"), pulumi.Alias(type_="azure-native_orbital_v20240301preview:orbital:L2Connection")])
