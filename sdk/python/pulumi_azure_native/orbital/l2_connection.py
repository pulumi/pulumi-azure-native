...
class L2ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 l2_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the partner router that cross-connects with the Orbital Edge Router at the edge site.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.int] vlan_id: The VLAN ID for the L2 connection.
        :param pulumi.Input[builtins.str] l2_connection_name: L2 Connection name.
    ...
    def l2_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        L2 Connection name.
        """
    ...
    def l2_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class L2Connection(pulumi.CustomResource):
    ...
    def circuit_id(self) -> pulumi.Output[builtins.str]:
        """
