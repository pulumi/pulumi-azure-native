...
class GeoCatalogArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['GeoCatalogPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['GeoCatalogPropertiesArgs']]):
...
class GeoCatalog(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['GeoCatalogPropertiesArgs', 'GeoCatalogPropertiesArgsDict']]] = None,
