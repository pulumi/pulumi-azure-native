...
def get_edge_site(edge_site_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str edge_site_name: Edge site name.
...
def get_edge_site_output(edge_site_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
