...
def list_ground_station_l2_connections(ground_station_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ground_station_name: Ground Station name.
...
def list_ground_station_l2_connections_output(ground_station_name: Optional[pulumi.Input[_builtins.str]] = None,
