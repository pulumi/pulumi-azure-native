...
class AuthorizedGroundstationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ground_station: builtins.str):
        """
        Authorized groundstation.
        :param builtins.str expiration_date: Date of authorization expiration.
        :param builtins.str ground_station: Groundstation name.
        """
    ...
    def ground_station(self) -> builtins.str:
        """
        Groundstation name.
        """
...
class AvailableContactsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 end_azimuth_degrees: builtins.float,
                 end_elevation_degrees: builtins.float,
                 ground_station_name: builtins.str,
                 maximum_elevation_degrees: builtins.float,
                 rx_end_time: builtins.str,
                 rx_start_time: builtins.str,
                 start_azimuth_degrees: builtins.float,
                 start_elevation_degrees: builtins.float,
                 tx_end_time: builtins.str,
                 tx_start_time: builtins.str,
                 spacecraft: Optional['outputs.AvailableContactsResponseSpacecraft'] = None):
        """
        Customer retrieves list of Available Contacts for a spacecraft resource. Later, one of the available contact can be selected to create a contact.
        :param builtins.float end_azimuth_degrees: Azimuth of the antenna at the end of the contact in decimal degrees.
        :param builtins.float end_elevation_degrees: Spacecraft elevation above the horizon at contact end.
        :param builtins.str ground_station_name: Name of Azure Ground Station.
        :param builtins.float maximum_elevation_degrees: Maximum elevation of the antenna during the contact in decimal degrees.
        :param builtins.str rx_end_time: Time to lost receiving a signal (ISO 8601 UTC standard).
        :param builtins.str rx_start_time: Earliest time to receive a signal (ISO 8601 UTC standard).
        :param builtins.float start_azimuth_degrees: Azimuth of the antenna at the start of the contact in decimal degrees.
        :param builtins.float start_elevation_degrees: Spacecraft elevation above the horizon at contact start.
        :param builtins.str tx_end_time: Time at which antenna transmit will be disabled (ISO 8601 UTC standard).
        :param builtins.str tx_start_time: Time at which antenna transmit will be enabled (ISO 8601 UTC standard).
...
class ContactProfileLinkChannelResponse(dict):
    ...
    def __init__(__self__, *,
                 bandwidth_m_hz: builtins.float,
                 center_frequency_m_hz: builtins.float,
                 end_point: 'outputs.EndPointResponse',
                 name: builtins.str,
                 decoding_configuration: Optional[builtins.str] = None,
                 demodulation_configuration: Optional[builtins.str] = None,
                 encoding_configuration: Optional[builtins.str] = None,
                 modulation_configuration: Optional[builtins.str] = None):
        """
        Contact Profile Link Channel.
        :param builtins.float bandwidth_m_hz: Bandwidth in MHz.
        :param builtins.float center_frequency_m_hz: Center Frequency in MHz.
        :param 'EndPointResponse' end_point: Customer end point to store and retrieve data during a contact with the spacecraft.
        :param builtins.str name: Channel name.
        :param builtins.str decoding_configuration: Currently unused.
        ...
        :param builtins.str encoding_configuration: Currently unused.
    ...
    def bandwidth_m_hz(self) -> builtins.float:
        """
        Bandwidth in MHz.
        """
    ...
    def center_frequency_m_hz(self) -> builtins.float:
        """
    ...
    def decoding_configuration(self) -> Optional[builtins.str]:
        """
        Currently unused.
        """
    ...
    def encoding_configuration(self) -> Optional[builtins.str]:
        """
        Currently unused.
        """
...
class ContactProfileLinkResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 eirpd_bw: Optional[builtins.float] = None,
                 gain_over_temperature: Optional[builtins.float] = None):
        """
        Contact Profile Link.
        :param Sequence['ContactProfileLinkChannelResponse'] channels: Contact Profile Link Channel.
        :param builtins.str direction: Direction (Uplink or Downlink).
        :param builtins.str name: Link name.
        :param builtins.str polarization: Polarization. e.g. (RHCP, LHCP).
        :param builtins.float eirpd_bw: Effective Isotropic Radiated Power (EIRP) in dBW. It is the required EIRP by the customer. Not used yet.
        :param builtins.float gain_over_temperature: Gain to noise temperature in db/K. It is the required G/T by the customer. Not used yet.
        """
    ...
    def eirpd_bw(self) -> Optional[builtins.float]:
        """
    ...
    def gain_over_temperature(self) -> Optional[builtins.float]:
        """
...
class ContactProfileThirdPartyConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 mission_configuration: builtins.str,
                 provider_name: builtins.str):
        """
        Contact Profile third-party partner configuration.
        :param builtins.str mission_configuration: Name of string referencing the configuration describing contact set-up for a particular mission. Expected values are those which have been created in collaboration with the partner network.
        :param builtins.str provider_name: Name of the third-party provider.
        """
    ...
    def mission_configuration(self) -> builtins.str:
        """
...
class ContactProfilesPropertiesResponseNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Network configuration of customer virtual network.
        :param builtins.str subnet_id: ARM resource identifier of the subnet delegated to the Microsoft.Orbital/orbitalGateways. Needs to be at least a class C subnet, and should not have any IP created in it.
        """
...
class ContactsPropertiesResponseAntennaConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration associated with the allocated antenna.
        :param builtins.str destination_ip: The destination IP a packet can be sent to. This would for example be the TCP endpoint you would send data to.
        :param Sequence[builtins.str] source_ips: List of Source IP
        """
...
class EndPointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str ip_address: IP Address (IPv4).
        :param builtins.str port: TCP port to listen on to receive data.
        :param builtins.str protocol: Protocol either UDP or TCP.
        """
...
class GeoCatalogPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The details of the Microsoft Planetary Computer Pro GeoCatalog.
        :param builtins.str catalog_uri: The URI of the catalog management UI.
        :param builtins.str provisioning_state: The status of the last operation.
        :param builtins.str auto_generated_domain_name_label_scope: The scope of the auto-generated domain name label. If not provided, defaults to TenantReuse.
        :param builtins.str tier: Tier of the catalog. This cannot be changed after the catalog is created. If not provided, defaults to Basic.
        """
    ...
    def catalog_uri(self) -> builtins.str:
        """
...
class L2ConnectionsPropertiesResponseGroundStationPartnerRouter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The name of the partner router to establish a connection to within the ground station.
        :param builtins.str name: The unique name of the partner router that cross-connects with the Orbital Edge Router at the ground station site.
        """
        pulumi.set(__self__, "name", name)
