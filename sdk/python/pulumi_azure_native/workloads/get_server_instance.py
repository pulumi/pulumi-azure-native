...
def get_server_instance(resource_group_name: Optional[_builtins.str] = None,
                        sap_discovery_site_name: Optional[_builtins.str] = None,
                        sap_instance_name: Optional[_builtins.str] = None,
                        server_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str server_instance_name: The name of the Server instance resource for SAP Migration.
    """
    __args__ = dict()
...
def get_server_instance_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                               ...
                               server_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
