...
def get_sap_database_instance_output(database_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20211201preview:getSAPDatabaseInstance', __args__, opts=opts, typ=GetSAPDatabaseInstanceResult)
