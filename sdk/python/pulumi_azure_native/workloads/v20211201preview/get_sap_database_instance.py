...
warnings.warn("""azure-native:workloads/v20211201preview:SAPDatabaseInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:SAPDatabaseInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sap_database_instance(database_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sap_database_instance is deprecated: azure-native:workloads/v20211201preview:SAPDatabaseInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:SAPDatabaseInstance to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20211201preview:getSAPDatabaseInstance', __args__, opts=opts, typ=GetSAPDatabaseInstanceResult).value
