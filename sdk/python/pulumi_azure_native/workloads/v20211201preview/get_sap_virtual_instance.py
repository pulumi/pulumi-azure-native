...
def get_sap_virtual_instance(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sap_virtual_instance is deprecated: azure-native:workloads/v20211201preview:SAPVirtualInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:SAPVirtualInstance to guarantee forwards compatibility.""")
    __args__ = dict()
