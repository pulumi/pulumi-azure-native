...
def get_php_workload(php_workload_name: Optional[str] = None,
    ...
    return AwaitableGetPhpWorkloadResult(
        admin_user_profile=pulumi.get(__ret__, 'admin_user_profile'),
        app_location=pulumi.get(__ret__, 'app_location'),
        backup_profile=pulumi.get(__ret__, 'backup_profile'),
        cache_profile=pulumi.get(__ret__, 'cache_profile'),
        controller_profile=pulumi.get(__ret__, 'controller_profile'),
        database_profile=pulumi.get(__ret__, 'database_profile'),
        fileshare_profile=pulumi.get(__ret__, 'fileshare_profile'),
        ...
        php_profile=pulumi.get(__ret__, 'php_profile'),
        provisioning_state=pulumi.get(__ret__, 'provisioning_state'),
        search_profile=pulumi.get(__ret__, 'search_profile'),
        site_profile=pulumi.get(__ret__, 'site_profile'),
