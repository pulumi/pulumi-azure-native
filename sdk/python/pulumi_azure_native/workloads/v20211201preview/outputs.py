...
class NetworkProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'azureFrontDoorResourceId' in kwargs:
            azure_front_door_resource_id = kwargs['azureFrontDoorResourceId']
        if 'frontEndPublicIpResourceId' in kwargs:
        ...
        if 'outboundPublicIpResourceIds' in kwargs:
        ...
        if 'azureFrontDoorEnabled' in kwargs:
...
class NodeProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'nodeResourceIds' in kwargs:
            node_resource_ids = kwargs['nodeResourceIds']
        if 'nodeSku' in kwargs:
...
class VmssNodesProfileResponse(dict):
    ...
    def _configure(
        ...
        if 'osImage' in kwargs:
            os_image = kwargs['osImage']
        if 'autoScaleMaxCount' in kwargs:
            auto_scale_max_count = kwargs['autoScaleMaxCount']
        if 'autoScaleMinCount' in kwargs:
