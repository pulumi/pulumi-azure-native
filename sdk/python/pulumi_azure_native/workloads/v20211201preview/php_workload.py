...
class PhpWorkload(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(admin_user_profile, UserProfileArgs):
            ...
            if not isinstance(backup_profile, BackupProfileArgs):
            ...
            if not isinstance(cache_profile, CacheProfileArgs):
            ...
            if not isinstance(controller_profile, NodeProfileArgs):
            ...
            if not isinstance(database_profile, DatabaseProfileArgs):
            ...
            if not isinstance(fileshare_profile, FileshareProfileArgs):
            ...
            if not isinstance(identity, PhpWorkloadResourceIdentityArgs):
            ...
            if not isinstance(managed_resource_group_configuration, ManagedRGConfigurationArgs):
            ...
            if not isinstance(php_profile, PhpProfileArgs):
            ...
            if not isinstance(search_profile, SearchProfileArgs):
            ...
            if not isinstance(site_profile, SiteProfileArgs):
            ...
            if not isinstance(web_nodes_profile, VmssNodesProfileArgs):
