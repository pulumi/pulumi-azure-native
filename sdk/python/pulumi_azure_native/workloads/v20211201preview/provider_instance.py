...
class ProviderInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.DB2ProviderInstancePropertiesArgs(
                db_name="dbName",
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.MsSqlServerProviderInstancePropertiesArgs(
                db_password="****",
                db_password_uri="",
                db_port="5912",
                db_username="user",
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.PrometheusOSProviderInstancePropertiesArgs(
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.PrometheusHaClusterProviderInstancePropertiesArgs(
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.HanaDbProviderInstancePropertiesArgs(
                db_name="db",
                db_password="****",
                db_password_uri="",
                db_username="user",
        ...
        provider_instance = azure_native.workloads.v20211201preview.ProviderInstance("providerInstance",
            monitor_name="mySapMonitor",
            provider_instance_name="myProviderInstance",
            provider_settings=azure_native.workloads.v20211201preview.SapNetWeaverProviderInstancePropertiesArgs(
