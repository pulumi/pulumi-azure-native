...
def get_wordpress_instance_output(php_workload_name: Optional[pulumi.Input[str]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWordpressInstanceResult]:
    """
    Gets the WordPress instance resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20211201preview:getWordpressInstance', __args__, opts=opts, typ=GetWordpressInstanceResult)
    return __ret__.apply(lambda __response__: GetWordpressInstanceResult(
        database_name=pulumi.get(__response__, 'database_name'),
        database_user=pulumi.get(__response__, 'database_user'),
        id=pulumi.get(__response__, 'id'),
        name=pulumi.get(__response__, 'name'),
        provisioning_state=pulumi.get(__response__, 'provisioning_state'),
        site_url=pulumi.get(__response__, 'site_url'),
