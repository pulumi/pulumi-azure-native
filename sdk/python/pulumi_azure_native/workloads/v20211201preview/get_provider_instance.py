...
warnings.warn("""azure-native:workloads/v20211201preview:ProviderInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:ProviderInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_provider_instance(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_provider_instance is deprecated: azure-native:workloads/v20211201preview:ProviderInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:ProviderInstance to guarantee forwards compatibility.""")
    __args__ = dict()
