...
class SAPCentralInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        SAPCentralInstanceArgs._configure(
    ...
    def _configure(
        ...
        if sap_virtual_instance_name is None:
            raise TypeError("Missing 'sap_virtual_instance_name' argument")
        if central_instance_name is None and 'centralInstanceName' in kwargs:
            central_instance_name = kwargs['centralInstanceName']

        _setter("resource_group_name", resource_group_name)
        _setter("sap_virtual_instance_name", sap_virtual_instance_name)
        if central_instance_name is not None:
            _setter("central_instance_name", central_instance_name)
...
class SAPCentralInstance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SAPCentralInstanceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20221101preview:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20230401:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20231001preview:SAPCentralInstance")])
