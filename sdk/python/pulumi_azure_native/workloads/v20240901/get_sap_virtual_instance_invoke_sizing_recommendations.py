...
def get_sap_virtual_instance_invoke_sizing_recommendations(app_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceInvokeSizingRecommendations', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeSizingRecommendationsResult).value
...
def get_sap_virtual_instance_invoke_sizing_recommendations_output(app_location: Optional[pulumi.Input[str]] = None,
                                                                  ...
                                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapVirtualInstanceInvokeSizingRecommendationsResult]:
    """
    Gets the sizing recommendations.
    ...
    __args__['saps'] = saps
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20240901:getSapVirtualInstanceInvokeSizingRecommendations', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeSizingRecommendationsResult)
