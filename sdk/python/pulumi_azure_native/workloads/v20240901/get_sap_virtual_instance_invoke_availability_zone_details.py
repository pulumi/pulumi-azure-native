...
def get_sap_virtual_instance_invoke_availability_zone_details(app_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceInvokeAvailabilityZoneDetails', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeAvailabilityZoneDetailsResult).value
...
def get_sap_virtual_instance_invoke_availability_zone_details_output(app_location: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sapProduct'] = sap_product
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20240901:getSapVirtualInstanceInvokeAvailabilityZoneDetails', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeAvailabilityZoneDetailsResult)
