...
__all__ = [
    'GetSapVirtualInstanceSizingRecommendationsResult',
    'AwaitableGetSapVirtualInstanceSizingRecommendationsResult',
    'get_sap_virtual_instance_sizing_recommendations',
    'get_sap_virtual_instance_sizing_recommendations_output',
]

@pulumi.output_type
class GetSapVirtualInstanceSizingRecommendationsResult:
    """
...
class AwaitableGetSapVirtualInstanceSizingRecommendationsResult(GetSapVirtualInstanceSizingRecommendationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSapVirtualInstanceSizingRecommendationsResult(
            deployment_type=self.deployment_type)


def get_sap_virtual_instance_sizing_recommendations(app_location: Optional[str] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSapVirtualInstanceSizingRecommendationsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceSizingRecommendations', __args__, opts=opts, typ=GetSapVirtualInstanceSizingRecommendationsResult).value

    return AwaitableGetSapVirtualInstanceSizingRecommendationsResult(
        deployment_type=pulumi.get(__ret__, 'deployment_type'))


@_utilities.lift_output_func(get_sap_virtual_instance_sizing_recommendations)
def get_sap_virtual_instance_sizing_recommendations_output(app_location: Optional[pulumi.Input[str]] = None,
                                                           ...
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapVirtualInstanceSizingRecommendationsResult]:
    """
    Gets the sizing recommendations.
