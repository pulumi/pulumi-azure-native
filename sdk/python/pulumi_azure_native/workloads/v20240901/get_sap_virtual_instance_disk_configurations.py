...
__all__ = [
    'GetSapVirtualInstanceDiskConfigurationsResult',
    'AwaitableGetSapVirtualInstanceDiskConfigurationsResult',
    'get_sap_virtual_instance_disk_configurations',
    'get_sap_virtual_instance_disk_configurations_output',
]

@pulumi.output_type
class GetSapVirtualInstanceDiskConfigurationsResult:
    """
...
class AwaitableGetSapVirtualInstanceDiskConfigurationsResult(GetSapVirtualInstanceDiskConfigurationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSapVirtualInstanceDiskConfigurationsResult(
            volume_configurations=self.volume_configurations)


def get_sap_virtual_instance_disk_configurations(app_location: Optional[str] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSapVirtualInstanceDiskConfigurationsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceDiskConfigurations', __args__, opts=opts, typ=GetSapVirtualInstanceDiskConfigurationsResult).value

    return AwaitableGetSapVirtualInstanceDiskConfigurationsResult(
        volume_configurations=pulumi.get(__ret__, 'volume_configurations'))


@_utilities.lift_output_func(get_sap_virtual_instance_disk_configurations)
def get_sap_virtual_instance_disk_configurations_output(app_location: Optional[pulumi.Input[str]] = None,
                                                        ...
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapVirtualInstanceDiskConfigurationsResult]:
    """
    Get the SAP Disk Configuration Layout prod/non-prod SAP System.
