...
__all__ = [
    'GetSapVirtualInstanceSapSupportedSkuResult',
    'AwaitableGetSapVirtualInstanceSapSupportedSkuResult',
    'get_sap_virtual_instance_sap_supported_sku',
    'get_sap_virtual_instance_sap_supported_sku_output',
]

@pulumi.output_type
class GetSapVirtualInstanceSapSupportedSkuResult:
    """
...
class AwaitableGetSapVirtualInstanceSapSupportedSkuResult(GetSapVirtualInstanceSapSupportedSkuResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSapVirtualInstanceSapSupportedSkuResult(
            supported_skus=self.supported_skus)


def get_sap_virtual_instance_sap_supported_sku(app_location: Optional[str] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSapVirtualInstanceSapSupportedSkuResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceSapSupportedSku', __args__, opts=opts, typ=GetSapVirtualInstanceSapSupportedSkuResult).value

    return AwaitableGetSapVirtualInstanceSapSupportedSkuResult(
        supported_skus=pulumi.get(__ret__, 'supported_skus'))


@_utilities.lift_output_func(get_sap_virtual_instance_sap_supported_sku)
def get_sap_virtual_instance_sap_supported_sku_output(app_location: Optional[pulumi.Input[str]] = None,
                                                      ...
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapVirtualInstanceSapSupportedSkuResult]:
    """
    Get a list of SAP supported SKUs for ASCS, Application and Database tier.
