...
__all__ = [
    'GetSapVirtualInstanceAvailabilityZoneDetailsResult',
    'AwaitableGetSapVirtualInstanceAvailabilityZoneDetailsResult',
    'get_sap_virtual_instance_availability_zone_details',
    'get_sap_virtual_instance_availability_zone_details_output',
]

@pulumi.output_type
class GetSapVirtualInstanceAvailabilityZoneDetailsResult:
    """
...
class AwaitableGetSapVirtualInstanceAvailabilityZoneDetailsResult(GetSapVirtualInstanceAvailabilityZoneDetailsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSapVirtualInstanceAvailabilityZoneDetailsResult(
            availability_zone_pairs=self.availability_zone_pairs)


def get_sap_virtual_instance_availability_zone_details(app_location: Optional[str] = None,
                                                       database_type: Optional[Union[str, 'SAPDatabaseType']] = None,
                                                       location: Optional[str] = None,
                                                       sap_product: Optional[Union[str, 'SAPProductType']] = None,
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSapVirtualInstanceAvailabilityZoneDetailsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstanceAvailabilityZoneDetails', __args__, opts=opts, typ=GetSapVirtualInstanceAvailabilityZoneDetailsResult).value

    return AwaitableGetSapVirtualInstanceAvailabilityZoneDetailsResult(
        availability_zone_pairs=pulumi.get(__ret__, 'availability_zone_pairs'))


@_utilities.lift_output_func(get_sap_virtual_instance_availability_zone_details)
def get_sap_virtual_instance_availability_zone_details_output(app_location: Optional[pulumi.Input[str]] = None,
                                                              ...
                                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapVirtualInstanceAvailabilityZoneDetailsResult]:
    """
    Get the recommended SAP Availability Zone Pair Details for your region.
