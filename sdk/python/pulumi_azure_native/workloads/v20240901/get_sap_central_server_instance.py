...
def get_sap_central_server_instance(central_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapCentralServerInstance', __args__, opts=opts, typ=GetSapCentralServerInstanceResult).value
...
def get_sap_central_server_instance_output(central_instance_name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSapCentralServerInstanceResult]:
    """
    Gets the SAP Central Services Instance resource.
    ...
    __args__['sapVirtualInstanceName'] = sap_virtual_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20240901:getSapCentralServerInstance', __args__, opts=opts, typ=GetSapCentralServerInstanceResult)
