...
def get_sap_virtual_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240901:getSapVirtualInstance', __args__, opts=opts, typ=GetSapVirtualInstanceResult).value
...
def get_sap_virtual_instance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sapVirtualInstanceName'] = sap_virtual_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20240901:getSapVirtualInstance', __args__, opts=opts, typ=GetSapVirtualInstanceResult)
