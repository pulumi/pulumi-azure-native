...
def get_sap_virtual_instance_invoke_sap_supported_sku(app_location: Optional[builtins.str] = None,
...
def get_sap_virtual_instance_invoke_sap_supported_sku_output(app_location: Optional[pulumi.Input[builtins.str]] = None,
