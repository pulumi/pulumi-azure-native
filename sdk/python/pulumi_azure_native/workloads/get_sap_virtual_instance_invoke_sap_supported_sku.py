...
__all__ = [
    ...
    'AwaitableGetSapVirtualInstanceInvokeSapSupportedSkuResult',
    'get_sap_virtual_instance_invoke_sap_supported_sku',
    'get_sap_virtual_instance_invoke_sap_supported_sku_output',
]
...
def get_sap_virtual_instance_invoke_sap_supported_sku(app_location: Optional[_builtins.str] = None,
                                                      database_type: Optional[Union[_builtins.str, 'SAPDatabaseType']] = None,
                                                      deployment_type: Optional[Union[_builtins.str, 'SAPDeploymentType']] = None,
                                                      environment: Optional[Union[_builtins.str, 'SAPEnvironmentType']] = None,
                                                      high_availability_type: Optional[Union[_builtins.str, 'SAPHighAvailabilityType']] = None,
                                                      location: Optional[_builtins.str] = None,
                                                      sap_product: Optional[Union[_builtins.str, 'SAPProductType']] = None,
    ...
    :param Union[_builtins.str, 'SAPDeploymentType'] deployment_type: The deployment type. Eg: SingleServer/ThreeTier
    :param Union[_builtins.str, 'SAPEnvironmentType'] environment: Defines the environment type - Production/Non Production.
    :param Union[_builtins.str, 'SAPHighAvailabilityType'] high_availability_type: The high availability type.
    :param _builtins.str location: The name of the Azure region.
    :param Union[_builtins.str, 'SAPProductType'] sap_product: Defines the SAP Product type.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads:getSapVirtualInstanceInvokeSapSupportedSku', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeSapSupportedSkuResult).value
...
def get_sap_virtual_instance_invoke_sap_supported_sku_output(app_location: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads:getSapVirtualInstanceInvokeSapSupportedSku', __args__, opts=opts, typ=GetSapVirtualInstanceInvokeSapSupportedSkuResult)
