...
class ManagedServiceIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'ManagedServiceIdentityType']] type: The type of managed service identity.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] user_assigned_identities: The user assigned identities.
        """
