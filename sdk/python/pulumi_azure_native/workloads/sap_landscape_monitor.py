...
class SapLandscapeMonitorArgs:
    ...
    def _configure(
        ...
        if 'topMetricsThresholds' in kwargs:
...
class SapLandscapeMonitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if grouping is not None and not isinstance(grouping, SapLandscapeMonitorPropertiesGroupingArgs):
                grouping = grouping or {}
                def _setter(key, value):
                    grouping[key] = value
                SapLandscapeMonitorPropertiesGroupingArgs._configure(_setter, **grouping)
