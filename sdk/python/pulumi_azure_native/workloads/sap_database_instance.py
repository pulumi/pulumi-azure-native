...
class SapDatabaseInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_instance_name: Database resource name string modeled as parameter for auto generation to work correctly.
...
class SapDatabaseInstance(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:workloads:SapDatabaseInstance"
    ...
    def database_sid(self) -> pulumi.Output[builtins.str]:
        """
        Database SID name.
        """
