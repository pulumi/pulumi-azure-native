...
warnings.warn("""azure-native:workloads/v20221101preview:SAPCentralInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:workloads/v20230401:SAPCentralInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
class SAPCentralInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20230401:SAPCentralInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SAPCentralInstance, __self__).__init__(
            'azure-native:workloads/v20221101preview:SAPCentralInstance',
            resource_name,
            __props__,
            opts)
