...
class SAPApplicationServerInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SAPApplicationServerInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPApplicationServerInstance"), pulumi.Alias(type_="azure-native:workloads/v20230401:SAPApplicationServerInstance"), pulumi.Alias(type_="azure-native:workloads/v20231001preview:SAPApplicationServerInstance"), pulumi.Alias(type_="azure-native:workloads/v20240901:SAPApplicationServerInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SAPApplicationServerInstance, __self__).__init__(
            'azure-native:workloads/v20221101preview:SAPApplicationServerInstance',
            resource_name,
            __props__,
            opts)
