...
def get_sap_application_server_instance(application_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20221101preview:getSAPApplicationServerInstance', __args__, opts=opts, typ=GetSAPApplicationServerInstanceResult).value
...
def get_sap_application_server_instance_output(application_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20221101preview:getSAPApplicationServerInstance', __args__, opts=opts, typ=GetSAPApplicationServerInstanceResult)
