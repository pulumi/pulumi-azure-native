...
warnings.warn("""azure-native:workloads/v20221101preview:monitor is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:monitor to guarantee forwards compatibility.""", DeprecationWarning)
...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:monitor"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:monitor"), pulumi.Alias(type_="azure-native:workloads/v20230401:monitor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Monitor, __self__).__init__(
            'azure-native:workloads/v20221101preview:monitor',
            resource_name,
            __props__,
            opts)
