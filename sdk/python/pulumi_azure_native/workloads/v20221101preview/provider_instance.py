...
class ProviderInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ProviderInstance is deprecated: azure-native:workloads/v20221101preview:ProviderInstance is being removed in the next major version of this provider. Please upgrade to azure-native:workloads/v20230401:ProviderInstance to guarantee forwards compatibility.""")
