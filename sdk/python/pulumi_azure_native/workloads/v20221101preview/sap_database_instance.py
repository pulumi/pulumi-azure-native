...
class SAPDatabaseInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20230401:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20231001preview:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20240901:SAPDatabaseInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SAPDatabaseInstance, __self__).__init__(
            'azure-native:workloads/v20221101preview:SAPDatabaseInstance',
            resource_name,
            __props__,
            opts)
