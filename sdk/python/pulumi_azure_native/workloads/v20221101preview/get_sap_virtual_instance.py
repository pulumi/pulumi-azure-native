...
def get_sap_virtual_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20221101preview:getSAPVirtualInstance', __args__, opts=opts, typ=GetSAPVirtualInstanceResult).value
...
def get_sap_virtual_instance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20221101preview:getSAPVirtualInstance', __args__, opts=opts, typ=GetSAPVirtualInstanceResult)
