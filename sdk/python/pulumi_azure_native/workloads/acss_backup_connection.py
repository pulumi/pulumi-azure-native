...
class ACSSBackupConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connector_name: The name of the connector resource
        ...
        :param pulumi.Input[builtins.str] backup_name: The name of the backup connection resource of virtual instance for SAP.
