...
class GetmonitorResult:
    ...
    """
    def __init__(__self__, app_location=None, errors=None, id=None, location=None, log_analytics_workspace_arm_id=None, managed_resource_group_configuration=None, monitor_subnet=None, msi_arm_id=None, name=None, provisioning_state=None, routing_preference=None, system_data=None, tags=None, type=None):
