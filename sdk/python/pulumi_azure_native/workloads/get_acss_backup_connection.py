...
def get_acss_backup_connection(backup_name: Optional[_builtins.str] = None,
...
def get_acss_backup_connection_output(backup_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
