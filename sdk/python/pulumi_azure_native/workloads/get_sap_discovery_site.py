...
class GetSapDiscoverySiteResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, errors=None, extended_location=None, id=None, location=None, master_site_id=None, migrate_project_id=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_sap_discovery_site(resource_group_name: Optional[builtins.str] = None,
...
def get_sap_discovery_site_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
