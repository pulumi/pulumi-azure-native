...
def get_sap_disk_configurations(app_location: Optional[builtins.str] = None,
                                database_type: Optional[Union[builtins.str, 'SAPDatabaseType']] = None,
                                db_vm_sku: Optional[builtins.str] = None,
    ...
    :param builtins.str db_vm_sku: The VM SKU for database instance.
...
def get_sap_disk_configurations_output(app_location: Optional[pulumi.Input[builtins.str]] = None,
                                       database_type: Optional[pulumi.Input[Union[builtins.str, 'SAPDatabaseType']]] = None,
                                       db_vm_sku: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads:getSAPDiskConfigurations', __args__, opts=opts, typ=GetSAPDiskConfigurationsResult)
