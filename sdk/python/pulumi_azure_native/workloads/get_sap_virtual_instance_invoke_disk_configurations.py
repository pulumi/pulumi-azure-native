...
def get_sap_virtual_instance_invoke_disk_configurations(app_location: Optional[builtins.str] = None,
...
def get_sap_virtual_instance_invoke_disk_configurations_output(app_location: Optional[pulumi.Input[builtins.str]] = None,
