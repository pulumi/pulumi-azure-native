...
class ServerInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] server_instance_name: The name of the Server instance resource for SAP Migration.
        """
...
class ServerInstance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def errors(self) -> pulumi.Output['outputs.SAPMigrateErrorServerInstanceResponse']:
        """
