...
def get_sap_database_instance(database_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_instance_name: Database resource name string modeled as parameter for auto generation to work correctly.
...
def get_sap_database_instance_output(database_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
