...
def get_sap_supported_sku(app_location: Optional[_builtins.str] = None,
...
def get_sap_supported_sku_output(app_location: Optional[pulumi.Input[_builtins.str]] = None,
