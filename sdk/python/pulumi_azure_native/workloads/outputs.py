...
class EnqueueReplicationServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str health: Defines the SAP Instance health.
        :param str hostname: The ERS server SAP host name.
        :param str instance_no: The ERS server instance id.
        :param str ip_address: The ERS server SAP IP Address.
        :param str kernel_patch: The ERS server SAP kernel patch.
        :param str kernel_version: The ERS server SAP kernel version.
        """
...
class EnqueueServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the SAP enqueue server properties.
        :param str health: Defines the SAP Instance health.
        :param str hostname: The enqueue server SAP host name.
        :param str ip_address: The enqueue server SAP IP Address.
        :param float port: The enqueue server Port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "hostname", hostname)
        pulumi.set(__self__, "ip_address", ip_address)
...
class GatewayServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the SAP Gateway Server properties.
        :param str health: Defines the SAP Instance health.
        :param float port: The gateway Port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "port", port)
...
class MessageServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the SAP message server properties.
        :param str health: Defines the SAP Instance health.
        :param str hostname: The message server SAP host name.
        :param float http_port: The message server http port.
        :param float https_port: The message server https port.
        :param float internal_ms_port: The message server internal MS port.
        :param str ip_address: The message server IP Address.
        :param float ms_port: The message server port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "hostname", hostname)
...
class NetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the network configuration for SAP infrastructure
        :param bool is_secondary_ip_enabled: Specifies whether a secondary IP address should be added to the network interface on all VMs
        """
