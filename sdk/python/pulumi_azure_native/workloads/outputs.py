...
class AlertQueryParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the Alert Query Parameter.
        :param builtins.str name: The name of the alert query parameter.
        :param builtins.str value: The value of the alert query parameter.
        """
        if name is not None:
...
class AlertRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_mitigate: Optional[builtins.str] = None,
                 dimension: Optional[builtins.str] = None,
                 evaluation_frequency: Optional[builtins.int] = None,
                 failing_periods_operator: Optional[builtins.str] = None,
                 failing_periods_to_alert: Optional[builtins.int] = None,
                 mute_actions_duration: Optional[builtins.int] = None,
                 severity: Optional[builtins.int] = None,
                 status: Optional[builtins.str] = None,
                 threshold: Optional[builtins.int] = None,
                 threshold_operator: Optional[builtins.str] = None,
        ...
        :param builtins.str auto_mitigate: The value that indicates whether the alert should be automatically resolved or not. The default is Disable.
        :param builtins.str dimension: Evaluation of metric on a particular column.
        :param builtins.int evaluation_frequency: How often the scheduled query rule is evaluated.
        :param builtins.str failing_periods_operator: The operator for failing periods.
        :param builtins.int failing_periods_to_alert: The number of failing periods to trigger an alert.
        :param builtins.int mute_actions_duration: Mute actions for the chosen period of time after the alert is fired.
        :param builtins.int severity: Severity of the alert. Should be an integer between [0-4]. Value of 0 is severest.
        :param builtins.str status: Indicates whether the alert is in an enabled state.
        :param builtins.int threshold: The threshold of the alert.
        :param builtins.str threshold_operator: The threshold operator of the alert.
        :param builtins.int window_size: The period of time on which the Alert query will be executed.
        """
    ...
    def auto_mitigate(self) -> Optional[builtins.str]:
        """
    ...
    def failing_periods_operator(self) -> Optional[builtins.str]:
        """
    ...
    def failing_periods_to_alert(self) -> Optional[builtins.int]:
        """
    ...
    def mute_actions_duration(self) -> Optional[builtins.int]:
        """
    ...
    def threshold_operator(self) -> Optional[builtins.str]:
        """
...
class AppServicePlanConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration details of app service plan
        :param builtins.int capacity: The number of workers in app service plan. If this is not set or set to 0, auto scale will be configured for the app service plan, otherwise, instance count is set to this number.
        :param builtins.str tier: The App Service plan tier.
        """
...
class ApplicationServerConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 instance_count: builtins.float,
                 subnet_id: builtins.str,
                 virtual_machine_configuration: 'outputs.VirtualMachineConfigurationResponse'):
        """
        Gets or sets the application server configuration.
        :param builtins.float instance_count: The number of app server instances.
    ...
    def instance_count(self) -> builtins.float:
        """
...
class ApplicationServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
                 availability_set_name: Optional[builtins.str] = None,
                 virtual_machines: Optional[Sequence['outputs.VirtualMachineResourceNamesResponse']] = None):
        """
        The full resource names object for application layer resources. The number of entries in this list should be equal to the number VMs to be created for application layer.
        :param builtins.str availability_set_name: The full name for availability set. In case name is not provided, it will be defaulted to {SID}-App-AvSet.
...
class ApplicationServerVmDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Defines the type of application server VM.
...
class CentralServerConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Gets or sets the central server configuration.
        :param builtins.float instance_count: The number of central server VMs.
        :param builtins.str subnet_id: The subnet id.
        :param 'VirtualMachineConfigurationResponse' virtual_machine_configuration: Gets or sets the virtual machine configuration.
        """
        pulumi.set(__self__, "instance_count", instance_count)
...
class CentralServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The full resource names object for central server layer resources.
        :param builtins.str availability_set_name: The full name for availability set. In case name is not provided, it will be defaulted to {SID}-ASCS-AvSet.
...
class CentralServerVmDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Defines the type of central server VM.
        :param builtins.str virtual_machine_id: The virtual machine id.
        """
        pulumi.set(__self__, "storage_details", storage_details)
        pulumi.set(__self__, "type", type)
...
class ConfigurationDataResponse(dict):
    ...
    def __init__(__self__, *,
                 cpu: builtins.int,
                 cpu_in_mhz: builtins.int,
                 cpu_type: builtins.str,
                 database_type: builtins.str,
                 hardware_manufacturer: builtins.str,
                 model: builtins.str,
                 ram: builtins.int,
                 saps: builtins.int,
                 target_hana_ram_size_gb: builtins.int,
                 total_disk_iops: builtins.int,
                 total_disk_size_gb: builtins.int):
        """
        The SAP instance specific configuration data.
        :param builtins.int cpu: Provide the CPU value of the server. For example, 16, 32 etc.
        :param builtins.int cpu_in_mhz: Provide the CPU clock speed of the server in MHz. This should be a non-zero value. For example, 2100.
        :param builtins.str cpu_type: Provide the CPU architecture type of the server. For example, Xeon Platinum 8171M, Xeon E5-2673 v3.
        :param builtins.str database_type: The database of this is a server instance. Applicable only if SAP instance type for this server instance is 'DB'.
        :param builtins.str hardware_manufacturer: Provide the HW manufacturer company of the server.  For example, Microsoft Corporation.
        :param builtins.str model: Specify if the Hardware is a physical server or virtual machine.
        :param builtins.int ram: Provide the RAM of the server. This should be a non-zero value. For example, 256.
        :param builtins.int saps: Provide the SAPS for each server of the SAP system. This should be a non-zero value. For example, 1000.
        :param builtins.int target_hana_ram_size_gb: Provide the target HANA database size you need. Applicable only if SAP instance type for this server instance is 'DB' and you are migrating an AnyDb database to SAP S/4HANA.
        :param builtins.int total_disk_iops: Provide the total disk IOPS capacity. Add the disk volume for each individual disk and provide the sum total in this field.
        :param builtins.int total_disk_size_gb: Provide the total disk volume capacity in GB. Add the disk volume for each individual disks and provide the total sum in this field.
        """
    ...
    def cpu_in_mhz(self) -> builtins.int:
        """
    ...
    def hardware_manufacturer(self) -> builtins.str:
        """
    ...
    def target_hana_ram_size_gb(self) -> builtins.int:
        """
    ...
    def total_disk_iops(self) -> builtins.int:
        """
    ...
    def total_disk_size_gb(self) -> builtins.int:
        """
...
class CreateAndMountFileShareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Gets or sets the file share configuration where the transport directory fileshare is created and mounted as a part of the create infra flow. Please pre-create the resource group you intend to place the transport directory in. The storage account and fileshare will be auto-created by the ACSS and doesn't need to be pre-created.
        :param builtins.str configuration_type: The type of file share config.
               Expected value is 'CreateAndMount'.
        :param builtins.str resource_group: The name of transport file share resource group. This should be pre created by the customer. The app rg is used in case of missing input.
        :param builtins.str storage_account_name: The name of file share storage account name . A custom name is used in case of missing input.
        """
...
class DBBackupPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the DB backup policy.
...
class DatabaseConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Gets or sets the database configuration.
        :param builtins.float instance_count: The number of database VMs.
        :param builtins.str subnet_id: The subnet id.
        :param 'VirtualMachineConfigurationResponse' virtual_machine_configuration: Gets or sets the virtual machine configuration.
...
class DatabaseServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The full resource names object for database layer resources. The number of entries in this list should be equal to the number VMs to be created for database layer.
        :param builtins.str availability_set_name: The full name for availability set. In case name is not provided, it will be defaulted to {SID}-DB-AvSet.
        :param 'LoadBalancerResourceNamesResponse' load_balancer: The resource names object for load balancer and related resources.
        :param Sequence['VirtualMachineResourceNamesResponse'] virtual_machines: The list of virtual machine naming details.
        """
        if availability_set_name is not None:
...
class DatabaseVmDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Database VM details.
        :param builtins.str status: Defines the SAP Instance status.
...
class Db2ProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 db_password: Optional[builtins.str] = None,
                 db_password_uri: Optional[builtins.str] = None,
                 db_port: Optional[builtins.str] = None,
                 db_username: Optional[builtins.str] = None,
                 hostname: Optional[builtins.str] = None,
                 sap_sid: Optional[builtins.str] = None,
                 ssl_certificate_uri: Optional[builtins.str] = None,
                 ssl_preference: Optional[builtins.str] = None):
        """
        Gets or sets the DB2 provider properties.
        :param builtins.str provider_type: The provider type. For example, the value can be SapHana.
               Expected value is 'Db2'.
        :param builtins.str db_name: Gets or sets the db2 database name.
        :param builtins.str db_password: Gets or sets the db2 database password.
        :param builtins.str db_password_uri: Gets or sets the key vault URI to secret with the database password.
        :param builtins.str db_port: Gets or sets the db2 database sql port.
        :param builtins.str db_username: Gets or sets the db2 database user name.
        :param builtins.str hostname: Gets or sets the target virtual machine name.
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the DB2 Database.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
    ...
    def db_password(self) -> Optional[builtins.str]:
        """
    ...
    def db_password_uri(self) -> Optional[builtins.str]:
        """
    ...
    def db_port(self) -> Optional[builtins.str]:
        """
    ...
    def db_username(self) -> Optional[builtins.str]:
        """
    ...
    def sap_sid(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_certificate_uri(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_preference(self) -> Optional[builtins.str]:
        """
...
class DeployerVmPackagesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the url and storage account ID where deployer VM packages are uploaded
        :param builtins.str storage_account_id: The deployer VM packages storage account id
        :param builtins.str url: The URL to the deployer VM packages file.
        """
...
class DeploymentConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Deployment Configuration.
        :param builtins.str configuration_type: The configuration Type.
               Expected value is 'Deployment'.
        :param builtins.str app_location: The geo-location where the SAP system is to be created.
...
class DiscoveryConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 configuration_type: builtins.str,
                 central_server_vm_id: Optional[builtins.str] = None,
                 managed_rg_storage_account_name: Optional[builtins.str] = None):
        """
        Discovery Details.
        :param builtins.str app_location: The geo-location where the SAP system exists.
        :param builtins.str configuration_type: The configuration Type.
               Expected value is 'Discovery'.
        :param builtins.str central_server_vm_id: The virtual machine ID of the Central Server.
        :param builtins.str managed_rg_storage_account_name: The custom storage account name for the storage account created by the service in the managed resource group created as part of VIS deployment.<br><br>Refer to the storage account naming rules [here](https://learn.microsoft.com/azure/azure-resource-manager/management/resource-name-rules#microsoftstorage).<br><br>If not provided, the service will create the storage account with a random name.
        """
        pulumi.set(__self__, "app_location", app_location)
    ...
    def central_server_vm_id(self) -> Optional[builtins.str]:
        """
    ...
    def managed_rg_storage_account_name(self) -> Optional[builtins.str]:
        """
...
class DiskDetailsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 disk_tier: Optional[builtins.str] = None,
                 iops_read_write: Optional[builtins.float] = None,
                 maximum_supported_disk_count: Optional[builtins.float] = None,
                 mbps_read_write: Optional[builtins.float] = None,
                 minimum_supported_disk_count: Optional[builtins.float] = None,
                 size_gb: Optional[builtins.float] = None,
                 sku: Optional['outputs.DiskSkuResponse'] = None):
        """
        The supported disk size details for a disk type.
        :param builtins.str disk_tier: The disk tier, e.g. P10, E10.
        :param builtins.float iops_read_write: The disk Iops.
        :param builtins.float maximum_supported_disk_count: The maximum supported disk count.
        :param builtins.float mbps_read_write: The disk provisioned throughput in MBps.
        :param builtins.float minimum_supported_disk_count: The minimum supported disk count.
        :param builtins.float size_gb: The disk size in GB.
    ...
    def disk_tier(self) -> Optional[builtins.str]:
        """
    ...
    def iops_read_write(self) -> Optional[builtins.float]:
        """
        The disk Iops.
        """
    ...
    def maximum_supported_disk_count(self) -> Optional[builtins.float]:
        """
    ...
    def mbps_read_write(self) -> Optional[builtins.float]:
        """
    ...
    def minimum_supported_disk_count(self) -> Optional[builtins.float]:
        """
...
class DiskExclusionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 disk_lun_list: Sequence[builtins.int],
                 is_inclusion_list: builtins.bool):
        """
        Defines the disk exclusion properties for virtual machine backup.
    ...
    def disk_lun_list(self) -> Sequence[builtins.int]:
        """
    ...
    def is_inclusion_list(self) -> builtins.bool:
        """
...
class DiskSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The type of disk sku. For example, Standard_LRS, Standard_ZRS, Premium_LRS, Premium_ZRS.
        :param builtins.str name: Defines the disk sku name.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class DiskVolumeConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The disk configuration required for the selected volume.
        :param builtins.float count: The total number of disks required for the concerned volume.
        :param builtins.float size_gb: The disk size in GB.
...
class EnqueueReplicationServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ers_version: builtins.str,
                 health: builtins.str,
                 hostname: builtins.str,
                 instance_no: builtins.str,
                 ip_address: builtins.str,
                 kernel_patch: builtins.str,
                 kernel_version: builtins.str):
        """
        Defines the SAP Enqueue Replication Server (ERS) properties.
        :param builtins.str ers_version: Defines the type of Enqueue Replication Server.
        :param builtins.str health: Defines the health of SAP Instances.
        :param builtins.str hostname: ERS SAP Hostname.
        :param builtins.str instance_no: ERS Instance Number.
        :param builtins.str ip_address: ERS SAP IP Address.
        :param builtins.str kernel_patch: ERS SAP Kernel Patch level.
        :param builtins.str kernel_version: ERS SAP Kernel Version.
        """
    ...
    def ers_version(self) -> builtins.str:
        """
...
class EnqueueServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the SAP Enqueue Server properties.
        :param builtins.str health: Defines the health of SAP Instances.
        :param builtins.str hostname: Enqueue Server SAP Hostname.
        :param builtins.str ip_address: Enqueue Server SAP IP Address.
        :param builtins.float port: Enqueue Server Port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "hostname", hostname)
        pulumi.set(__self__, "ip_address", ip_address)
...
class ErrorDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str message: Description of the error.
        :param builtins.str recommendation: Description of the recommendation.
        """
        pulumi.set(__self__, "code", code)
        pulumi.set(__self__, "details", details)
        pulumi.set(__self__, "message", message)
...
class ExcelPerformanceDataResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_cpu_load: builtins.int,
                 total_source_db_size_gb: builtins.int):
        """
        The SAP instance specific performance data for Excel import.
        :param builtins.str data_source: The data source for this resource.
               Expected value is 'Excel'.
        :param builtins.int max_cpu_load: Provide the max CPU percentage load on the server. Omit the percentage symbol while filling this value.
        :param builtins.int total_source_db_size_gb: Provide the source Database size in GB. Applicable only if SAP instance type for this server instance is 'DB'.
        """
    ...
    def max_cpu_load(self) -> builtins.int:
        """
    ...
    def total_source_db_size_gb(self) -> builtins.int:
        """
...
class ExistingRecoveryServicesVaultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Existing recovery services vault.
        :param builtins.str id: The resource ID of the recovery services vault that has been created.
        :param builtins.str vault_type: The vault type, whether it is existing or has to be created.
...
class ExternalInstallationSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 software_installation_type: builtins.str,
                 central_server_vm_id: Optional[builtins.str] = None):
        """
        The SAP Software configuration Input when the software is installed externally outside the service.
        :param builtins.str software_installation_type: The SAP software installation Type.
               Expected value is 'External'.
        :param builtins.str central_server_vm_id: The resource ID of the virtual machine containing the central server instance.
        """
    ...
    def software_installation_type(self) -> builtins.str:
        """
...
class GatewayServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Defines the SAP Gateway Server properties.
        :param builtins.str health: Defines the health of SAP Instances.
        :param builtins.float port: Gateway Port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "port", port)
...
class HanaBackupDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str backup_type: The type of backup, VM, SQL or HANA.
               Expected value is 'HANA'.
        :param builtins.str hdbuserstore_key_name: Name of the HANA Database User Store Key.
        ...
        :param builtins.str instance_number: Gets or sets the database instance number.
    ...
    def hdbuserstore_key_name(self) -> builtins.str:
        """
    ...
    def instance_number(self) -> Optional[builtins.str]:
        """
...
class HanaDbProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_number: Optional[builtins.str] = None,
                 sap_sid: Optional[builtins.str] = None,
                 sql_port: Optional[builtins.str] = None,
                 ssl_certificate_uri: Optional[builtins.str] = None,
                 ssl_host_name_in_certificate: Optional[builtins.str] = None,
                 ssl_preference: Optional[builtins.str] = None):
        """
        Gets or sets the provider properties.
        :param builtins.str provider_type: The provider type. For example, the value can be SapHana.
               Expected value is 'SapHana'.
        :param builtins.str db_name: Gets or sets the hana database name.
        :param builtins.str db_password: Gets or sets the database password.
        :param builtins.str db_password_uri: Gets or sets the key vault URI to secret with the database password.
        :param builtins.str db_username: Gets or sets the database user name.
        :param builtins.str hostname: Gets or sets the target virtual machine size.
        :param builtins.str instance_number: Gets or sets the database instance number.
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier.
        :param builtins.str sql_port: Gets or sets the database sql port.
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the DB.
        :param builtins.str ssl_host_name_in_certificate: Gets or sets the hostname(s) in the SSL certificate.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
    ...
    def sql_port(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_host_name_in_certificate(self) -> Optional[builtins.str]:
        """
...
class HealthResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 impacting_reasons: builtins.str):
        """
        Resource health details
        :param builtins.str health_state: Health state of the resource
        :param builtins.str impacting_reasons: Reasons impacting health state
        """
    ...
    def impacting_reasons(self) -> builtins.str:
        """
...
class HighAvailabilityConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 high_availability_type: builtins.str):
        """
        Gets or sets the high availability configuration.
        :param builtins.str high_availability_type: The high availability type.
        """
...
class HighAvailabilitySoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 fencing_client_id: builtins.str,
                 fencing_client_password: builtins.str):
        """
        Gets or sets the HA software configuration.
        :param builtins.str fencing_client_id: The fencing client id.
        :param builtins.str fencing_client_password: The fencing client id secret/password. The secret should never expire. This will be used pacemaker to start/stop the cluster VMs.
        """
    ...
    def fencing_client_id(self) -> builtins.str:
        """
    ...
    def fencing_client_password(self) -> builtins.str:
        """
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies information about the image to use. You can specify information about platform images, marketplace images, or virtual machine images. This element is required when you want to use a platform image, marketplace image, or virtual machine image, but is not used in other creation operations. NOTE: Image reference publisher and offer can only be set when you create the scale set.
        :param builtins.str id: Specifies the ARM resource ID of the Azure Compute Gallery image version used for creating ACSS VMs. You will need to provide this input when you choose to deploy virtual machines in ACSS with OS image from the Azure Compute gallery.
...
class InstantRPAdditionalDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Instant recovery point additional details.
        :param builtins.str azure_backup_rg_name_prefix: Azure backup resource group name prefix.
        :param builtins.str azure_backup_rg_name_suffix: Azure backup resource group name suffix.
        """
...
class LoadBalancerDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Load Balancer details such as Load Balancer ID.
        :param builtins.str id: Fully qualified resource ID for the load balancer.
        """
        pulumi.set(__self__, "id", id)
...
class LoadBalancerResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 frontend_ip_configuration_names: Optional[Sequence[builtins.str]] = None,
                 health_probe_names: Optional[Sequence[builtins.str]] = None,
                 load_balancer_name: Optional[builtins.str] = None):
        """
        The resource names object for load balancer and related resources.
        :param Sequence[builtins.str] backend_pool_names: The list of backend pool names. Currently, ACSS deploys only one backend pool and hence, size of this list should be 1
        :param Sequence[builtins.str] frontend_ip_configuration_names: The list of frontend IP configuration names. If provided as input, size of this list should be 2 for cs layer and should be 1 for database layer.
        :param Sequence[builtins.str] health_probe_names: The list of health probe names. If provided as input, size of this list should be 2 for cs layer and should be 1 for database layer.
        :param builtins.str load_balancer_name: The full resource name for load balancer. If this value is not provided, load balancer will be name as {ASCS/DB}-loadBalancer.
        """
    ...
    def frontend_ip_configuration_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def health_probe_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MessageServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 health: builtins.str,
                 hostname: builtins.str,
                 http_port: builtins.float,
                 https_port: builtins.float,
                 internal_ms_port: builtins.float,
                 ip_address: builtins.str,
                 ms_port: builtins.float):
        """
        Defines the SAP message server properties.
        :param builtins.str health: Defines the health of SAP Instances.
        :param builtins.str hostname: message server SAP Hostname.
        :param builtins.float http_port: message server HTTP Port.
        :param builtins.float https_port: message server HTTPS Port.
        :param builtins.float internal_ms_port: message server internal MS port.
        :param builtins.str ip_address: message server IP Address.
        :param builtins.float ms_port: message server port.
        """
        pulumi.set(__self__, "health", health)
        pulumi.set(__self__, "hostname", hostname)
    ...
    def http_port(self) -> builtins.float:
        """
    ...
    def https_port(self) -> builtins.float:
        """
    ...
    def internal_ms_port(self) -> builtins.float:
        """
    ...
    def ms_port(self) -> builtins.float:
        """
        message server port.
        """
...
class MountFileShareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: The fileshare resource ID
        :param builtins.str private_endpoint_id: The private endpoint resource ID
        """
...
class MsSqlServerProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str db_password: Gets or sets the database password.
        :param builtins.str db_password_uri: Gets or sets the key vault URI to secret with the database password.
        :param builtins.str db_port: Gets or sets the database sql port.
        :param builtins.str db_username: Gets or sets the database user name.
        :param builtins.str hostname: Gets or sets the SQL server host name.
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the SQL Database.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
...
class NetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 is_secondary_ip_enabled: Optional[builtins.bool] = None):
        """
        Defines the network configuration type for SAP system infrastructure that is being deployed
        :param builtins.bool is_secondary_ip_enabled: Specifies whether a secondary IP address should be added to the network interface on all VMs of the SAP system being deployed
        """
    ...
    def is_secondary_ip_enabled(self) -> Optional[builtins.bool]:
        """
...
class NetworkInterfaceResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The resource names object for network interface and related resources.
        :param builtins.str network_interface_name: The full name for network interface. If name is not provided, service uses a default name based on the deployment type. For SingleServer, default name is {SID}-Nic. In case of HA-AvZone systems, default name will be {SID}-{App/ASCS/DB}-Zone{A/B}-Nic with an incrementor at the end in case of more than 1 instance per layer. For distributed and HA-AvSet systems, default name will be {SID}-{App/ASCS/DB}-Nic with an incrementor at the end in case of more than 1 instance per layer.
        """
...
class NewRecoveryServicesVaultResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        New recovery services vault.
        :param builtins.str name: The name of the recovery services vault has to be created.
        :param builtins.str resource_group: The name of the resource group where the recovery services vault has to be created.
        :param builtins.str vault_type: The vault type, whether it is existing or has to be created.
...
class OracleProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str db_name: Gets or sets the oracle database name.
        :param builtins.str db_password: Gets or sets the oracle database password.
        :param builtins.str db_password_uri: Gets or sets the key vault URI to secret with the database password.
        :param builtins.str db_port: Gets or sets the oracle database sql port.
        :param builtins.str db_username: Gets or sets the oracle database user name.
        :param builtins.str hostname: Gets or sets the target virtual machine name.
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the Oracle Database.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
...
class OsSapConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sap_fqdn: Optional[builtins.str] = None):
        """
        Defines the OS and SAP Configurations for Deployment
        ...
        :param builtins.str sap_fqdn: The FQDN to set for the SAP system
        """
    ...
    def sap_fqdn(self) -> Optional[builtins.str]:
        """
...
class PrometheusHaClusterProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hostname: Optional[builtins.str] = None,
                 prometheus_url: Optional[builtins.str] = None,
        ...
        :param builtins.str cluster_name: Gets or sets the clusterName.
        :param builtins.str hostname: Gets or sets the target machine name.
        :param builtins.str prometheus_url: URL of the Node Exporter endpoint.
        :param builtins.str sid: Gets or sets the cluster sid.
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the HA cluster exporter.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
    ...
    def prometheus_url(self) -> Optional[builtins.str]:
        """
...
class PrometheusOsProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str prometheus_url: URL of the Node Exporter endpoint
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the prometheus node exporter.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
...
class SAPAvailabilityZonePairResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 zone_a: Optional[builtins.float] = None,
                 zone_b: Optional[builtins.float] = None):
        """
        The SAP Availability Zone Pair.
        :param builtins.float zone_a: The zone A.
        :param builtins.float zone_b: The zone B.
        """
    ...
    def zone_a(self) -> Optional[builtins.float]:
        """
        The zone A.
        """
    ...
    def zone_b(self) -> Optional[builtins.float]:
        """
        The zone B.
        """
...
class SAPInstallWithoutOSConfigSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 bom_url: builtins.str,
                 sap_bits_storage_account_id: builtins.str,
                 software_installation_type: builtins.str,
        ...
        """
        The SAP Software configuration Input when the software is to be installed by service without OS Configurations
        :param builtins.str bom_url: The URL to the SAP Build of Materials(BOM) file.
        :param builtins.str sap_bits_storage_account_id: The SAP bits storage account id.
        :param builtins.str software_installation_type: The SAP software installation Type.
               Expected value is 'SAPInstallWithoutOSConfig'.
        :param builtins.str software_version: The software version to install.
    ...
    def sap_bits_storage_account_id(self) -> builtins.str:
        """
...
class SAPSupportedSkuResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 is_app_server_certified: Optional[builtins.bool] = None,
                 is_database_certified: Optional[builtins.bool] = None,
                 vm_sku: Optional[builtins.str] = None):
        """
        The SAP supported SKU.
        :param builtins.bool is_app_server_certified: True if the Sku is certified for App server in the SAP system.
        :param builtins.bool is_database_certified: True if the Sku is certified for Database server in the SAP system.
        :param builtins.str vm_sku: The VM Sku.
        """
    ...
    def is_app_server_certified(self) -> Optional[builtins.bool]:
        """
    ...
    def is_database_certified(self) -> Optional[builtins.bool]:
        """
    ...
    def vm_sku(self) -> Optional[builtins.str]:
        """
        The VM Sku.
        """
...
class SSLConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ssl_crypto_provider: Optional[builtins.str] = None,
                 ssl_host_name_in_certificate: Optional[builtins.str] = None,
                 ssl_key_store: Optional[builtins.str] = None,
                 ssl_trust_store: Optional[builtins.str] = None):
        """
        Specify the HANA database TLS/SSL properties which will be used for enabling Azure Backup for this database. You need to specify these details if you have enabled secure communication for your HANA database.
        :param builtins.str ssl_crypto_provider: Specify the crypto provider being used (commoncrypto/openssl). If this argument is not provided, it is automatically determined by searching in the configuration files.
        :param builtins.str ssl_host_name_in_certificate: Specify the hostname as mentioned in the SSL certificate. If this argument is not provided, it is automatically determined by searching in the SSL certificate.
        :param builtins.str ssl_key_store: Specify the name of the keystore file that contains the client's identity (eg. sapsrv.pse). The script will search for the file in the appropriate directory depending on the crypto provider mentioned. If this argument is not provided, it is automatically determined by searching in the configuration files.
        :param builtins.str ssl_trust_store: Specify the name of the trust store file that contains the server’s public certificates (eg. sapsrv.pse). The script will search for the file in the appropriate directory depending on the crypto provider mentioned. If this argument is not provided, it is automatically determined by searching in the configuration files.
        """
    ...
    def ssl_crypto_provider(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_key_store(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_trust_store(self) -> Optional[builtins.str]:
        """
        Specify the name of the trust store file that contains the server’s public certificates (eg. sapsrv.pse). The script will search for the file in the appropriate directory depending on the crypto provider mentioned. If this argument is not provided, it is automatically determined by searching in the configuration files.
        """
...
class SapLandscapeMonitorMetricThresholdsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 green: Optional[builtins.float] = None,
                 name: Optional[builtins.str] = None,
                 red: Optional[builtins.float] = None,
                 yellow: Optional[builtins.float] = None):
        """
        Gets or sets the Threshold Values for Top Metrics Health.
        :param builtins.float green: Gets or sets the threshold value for Green.
        :param builtins.str name: Gets or sets the name of the threshold.
        :param builtins.float red: Gets or sets the threshold value for Red.
        :param builtins.float yellow: Gets or sets the threshold value for Yellow.
        """
    ...
    @property
    @pulumi.getter
    def green(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def red(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def yellow(self) -> Optional[builtins.float]:
        """
...
class SapLandscapeMonitorSidMappingResponse(dict):
    ...
    def __init__(__self__, *,
                 name: Optional[builtins.str] = None,
                 top_sid: Optional[Sequence[builtins.str]] = None):
        """
        Gets or sets the mapping for SID to Environment/Applications.
        :param builtins.str name: Gets or sets the name of the grouping.
        :param Sequence[builtins.str] top_sid: Gets or sets the list of SID's.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def top_sid(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SapNetWeaverProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 provider_type: builtins.str,
                 sap_client_id: Optional[builtins.str] = None,
                 sap_host_file_entries: Optional[Sequence[builtins.str]] = None,
                 sap_hostname: Optional[builtins.str] = None,
                 sap_instance_nr: Optional[builtins.str] = None,
                 sap_password: Optional[builtins.str] = None,
                 sap_password_uri: Optional[builtins.str] = None,
                 sap_port_number: Optional[builtins.str] = None,
                 sap_sid: Optional[builtins.str] = None,
                 sap_username: Optional[builtins.str] = None,
                 ssl_certificate_uri: Optional[builtins.str] = None,
                 ssl_preference: Optional[builtins.str] = None):
        """
        Gets or sets the provider properties.
        ...
        :param builtins.str sap_client_id: Gets or sets the SAP Client ID.
        :param Sequence[builtins.str] sap_host_file_entries: Gets or sets the list of HostFile Entries
        :param builtins.str sap_hostname: Gets or sets the target virtual machine IP Address/FQDN.
        :param builtins.str sap_instance_nr: Gets or sets the instance number of SAP NetWeaver.
        :param builtins.str sap_password: Sets the SAP password.
        :param builtins.str sap_password_uri: Gets or sets the key vault URI to secret with the SAP password.
        :param builtins.str sap_port_number: Gets or sets the SAP HTTP port number.
        :param builtins.str sap_sid: Gets or sets the SAP System Identifier
        :param builtins.str sap_username: Gets or sets the SAP user name.
        :param builtins.str ssl_certificate_uri: Gets or sets the blob URI to SSL certificate for the SAP system.
        :param builtins.str ssl_preference: Gets or sets certificate preference if secure communication is enabled.
        """
    ...
    def sap_client_id(self) -> Optional[builtins.str]:
        """
    ...
    def sap_host_file_entries(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def sap_hostname(self) -> Optional[builtins.str]:
        """
    ...
    def sap_instance_nr(self) -> Optional[builtins.str]:
        """
    ...
    def sap_password(self) -> Optional[builtins.str]:
        """
    ...
    def sap_password_uri(self) -> Optional[builtins.str]:
        """
    ...
    def sap_port_number(self) -> Optional[builtins.str]:
        """
    ...
    def sap_username(self) -> Optional[builtins.str]:
        """
...
class ServiceInitiatedSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str bom_url: The URL to the SAP Build of Materials(BOM) file.
        :param builtins.str sap_bits_storage_account_id: The SAP bits storage account id.
        :param builtins.str sap_fqdn: The FQDN to set for the SAP system during install.
        :param builtins.str software_installation_type: The SAP software installation Type.
               Expected value is 'ServiceInitiated'.
        :param builtins.str software_version: The software version to install.
        :param builtins.str ssh_private_key: The SSH private key.
        :param 'HighAvailabilitySoftwareConfigurationResponse' high_availability_software_configuration: Gets or sets the HA software configuration.
        """
        pulumi.set(__self__, "bom_url", bom_url)
        pulumi.set(__self__, "sap_bits_storage_account_id", sap_bits_storage_account_id)
...
class SharedStorageResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
                 shared_storage_account_name: Optional[builtins.str] = None,
                 shared_storage_account_private_end_point_name: Optional[builtins.str] = None):
        """
        The resource names object for shared storage.
        :param builtins.str shared_storage_account_name: The full name of the shared storage account. If it is not provided, it will be defaulted to {SID}nfs{guid of 15 chars}.
        :param builtins.str shared_storage_account_private_end_point_name: The full name of private end point for the shared storage account. If it is not provided, it will be defaulted to {storageAccountName}_pe
        """
    ...
    def shared_storage_account_name(self) -> Optional[builtins.str]:
        """
    ...
    def shared_storage_account_private_end_point_name(self) -> Optional[builtins.str]:
        """
...
class SingleServerConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 app_resource_group: builtins.str,
        ...
        """
        Gets or sets the single server configuration. For prerequisites for creating the infrastructure, please see [here](https://go.microsoft.com/fwlink/?linkid=2212611&amp;clcid=0x409)
        :param builtins.str app_resource_group: The application resource group where SAP system resources will be deployed.
        :param builtins.str deployment_type: The type of SAP deployment, single server or Three tier.
    ...
    def app_resource_group(self) -> builtins.str:
        """
...
class SingleServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
                 naming_pattern_type: builtins.str,
                 virtual_machine: Optional['outputs.VirtualMachineResourceNamesResponse'] = None):
        """
        The resource name object where the specified values will be full resource names of the corresponding resources in a single server SAP system.
        :param builtins.str naming_pattern_type: The pattern type to be used for resource naming.
    ...
    def naming_pattern_type(self) -> builtins.str:
        """
...
class SnapshotBackupAdditionalDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Snapshot Backup related fields for WorkloadType SAP Hana system
        :param builtins.str instant_rp_details: Instant RP details for the snapshot.
        :param builtins.int instant_rp_retention_range_in_days: Retention range for instant Rp in days.
...
class StorageInformationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Storage details of all the Storage accounts attached to the VM. For e.g. NFS on AFS Shared Storage.
        :param builtins.str id: Fully qualified resource ID for the storage account.
        """
        pulumi.set(__self__, "id", id)
...
class UserAssignedServiceIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Managed service identity (user assigned identities)
        :param builtins.str type: Type of manage identity
...
class VMBackupPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the VM Backup policy.
        ...
        :param builtins.str policy_type: The policy type.
        :param builtins.int protected_items_count: Number of items associated with this policy.
        :param Sequence[builtins.str] resource_guard_operation_requests: ResourceGuard Operation Requests
        :param Union['LongTermRetentionPolicyResponse', 'SimpleRetentionPolicyResponse'] retention_policy: Retention policy with the details on backup copy retention ranges.
        :param Union['LogSchedulePolicyResponse', 'LongTermSchedulePolicyResponse', 'SimpleSchedulePolicyResponse', 'SimpleSchedulePolicyV2Response'] schedule_policy: Backup schedule specified as part of backup policy.
        :param Mapping[str, 'TieringPolicyResponse'] tiering_policy: Tiering policy to automatically move RPs to another tier
               Key is Target Tier, defined in RecoveryPointTierType enum.
               Tiering policy specifies the criteria to move RP to the target tier.
        :param builtins.str time_zone: Time zone optional input as string. For example: "Pacific Standard Time".
        """
...
class VirtualMachineConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str vm_size: The virtual machine size.
        """
...
class VirtualMachineResourceNamesResponse(dict):
    ...
    def __init__(__self__, *,
                 data_disk_names: Optional[Mapping[str, Sequence[builtins.str]]] = None,
                 ...
                 os_disk_name: Optional[builtins.str] = None,
                 vm_name: Optional[builtins.str] = None):
        """
        The resource names object for virtual machine and related resources.
        :param Mapping[str, Sequence[builtins.str]] data_disk_names: The full resource names for virtual machine data disks. This is a dictionary containing list of names of data disks per volume. Currently supported volumes for database layer are ['hana/data', 'hana/log', hana/shared', 'usr/sap', 'os', 'backup']. For application and cs layers, only 'default' volume is supported
        :param builtins.str host_name: The full name for virtual-machine's host (computer name). Currently, ACSS only supports host names which are less than or equal to 13 characters long. If this value is not provided, vmName will be used as host name.
        ...
        :param builtins.str os_disk_name: The full name for OS disk attached to the VM. If this value is not provided, it will be named by ARM as per its default naming standards (prefixed with vm name). There is only one OS disk attached per Virtual Machine.
        :param builtins.str vm_name: The full name for virtual machine. The length of this field can be upto 64 characters. If name is not provided, service uses a default name based on the deployment type. For SingleServer, default name is {SID}vm. In case of HA-AvZone systems, default name will be {SID}{app/ascs/db}z{a/b}vm with an incrementor at the end in case of more than 1 vm per layer. For distributed and HA-AvSet systems, default name will be {SID}{app/ascs/db}vm with an incrementor at the end in case of more than 1 vm per layer.
        """
    ...
    def data_disk_names(self) -> Optional[Mapping[str, Sequence[builtins.str]]]:
        """
    ...
    def os_disk_name(self) -> Optional[builtins.str]:
        """
...
class WeeklyScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Weekly schedule.
        :param Sequence[builtins.str] schedule_run_days: Schedule run days.
        :param Sequence[builtins.str] schedule_run_times: List of times of day this schedule has to be run.
        """
        if schedule_run_days is not None:
            pulumi.set(__self__, "schedule_run_days", schedule_run_days)
