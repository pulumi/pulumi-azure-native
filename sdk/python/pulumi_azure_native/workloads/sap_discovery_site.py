...
class SapDiscoverySiteArgs:
    ...
    def sap_discovery_site_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sap_discovery_site_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SapDiscoverySite(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:workloads:SapDiscoverySite"
    ...
    @property
    @pulumi.getter(name="masterSiteId")
    def master_site_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The master site ID from Azure Migrate.
        """
        return pulumi.get(self, "master_site_id")
    ...
    @property
    @pulumi.getter(name="migrateProjectId")
    def migrate_project_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The migrate project ID from Azure Migrate.
        """
        return pulumi.get(self, "migrate_project_id")
