...
def get_sap_database_instance(database_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20231001preview:getSAPDatabaseInstance', __args__, opts=opts, typ=GetSAPDatabaseInstanceResult).value
