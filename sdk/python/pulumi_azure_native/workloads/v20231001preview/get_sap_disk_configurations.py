...
def get_sap_disk_configurations(app_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20231001preview:getSAPDiskConfigurations', __args__, opts=opts, typ=GetSAPDiskConfigurationsResult).value
...
def get_sap_disk_configurations_output(app_location: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sapProduct'] = sap_product
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20231001preview:getSAPDiskConfigurations', __args__, opts=opts, typ=GetSAPDiskConfigurationsResult)
