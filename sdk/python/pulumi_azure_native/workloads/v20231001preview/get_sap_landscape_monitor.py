...
def get_sap_landscape_monitor(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20231001preview:getSapLandscapeMonitor', __args__, opts=opts, typ=GetSapLandscapeMonitorResult).value
...
def get_sap_landscape_monitor_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20231001preview:getSapLandscapeMonitor', __args__, opts=opts, typ=GetSapLandscapeMonitorResult)
