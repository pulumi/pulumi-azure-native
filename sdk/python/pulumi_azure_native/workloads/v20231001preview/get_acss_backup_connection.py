...
def get_acss_backup_connection(backup_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20231001preview:getACSSBackupConnection', __args__, opts=opts, typ=GetACSSBackupConnectionResult).value
