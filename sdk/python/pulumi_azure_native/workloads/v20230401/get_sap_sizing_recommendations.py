...
def get_sap_sizing_recommendations(app_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20230401:getSAPSizingRecommendations', __args__, opts=opts, typ=GetSAPSizingRecommendationsResult).value
...
def get_sap_sizing_recommendations_output(app_location: Optional[pulumi.Input[str]] = None,
    ...
    __args__['saps'] = saps
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20230401:getSAPSizingRecommendations', __args__, opts=opts, typ=GetSAPSizingRecommendationsResult)
