...
class SAPDatabaseInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        SAPDatabaseInstanceArgs._configure(
    ...
    def _configure(
        ...
        if database_instance_name is None and 'databaseInstanceName' in kwargs:
            database_instance_name = kwargs['databaseInstanceName']

        _setter("resource_group_name", resource_group_name)
        _setter("sap_virtual_instance_name", sap_virtual_instance_name)
        if database_instance_name is not None:
            _setter("database_instance_name", database_instance_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SAPDatabaseInstanceArgs._configure(_setter, **kwargs)
