...
class SAPDatabaseInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sap_database_instance = azure_native.workloads.v20230401.SAPDatabaseInstance("sapDatabaseInstance",
        ...
        ```sh
        $ pulumi import azure-native:workloads/v20230401:SAPDatabaseInstance databaseServer /subscriptions/6d875e77-e412-4d7d-9af4-8895278b4443/resourceGroups/test-rg/providers/Microsoft.Workloads/sapVirtualInstances/X00/databaseInstances/databaseServer 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPDatabaseInstance"), pulumi.Alias(type_="azure-native:workloads/v20221101preview:SAPDatabaseInstance")])
