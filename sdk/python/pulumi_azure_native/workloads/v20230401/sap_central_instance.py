...
class SAPCentralInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sap_central_instance = azure_native.workloads.v20230401.SAPCentralInstance("sapCentralInstance",
        ...
        ```sh
        $ pulumi import azure-native:workloads/v20230401:SAPCentralInstance centralServer /subscriptions/6d875e77-e412-4d7d-9af4-8895278b4443/resourceGroups/test-rg/providers/Microsoft.Workloads/sapVirtualInstances/X00/centralInstances/centralServer 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:SAPCentralInstance"), pulumi.Alias(type_="azure-native:workloads/v20221101preview:SAPCentralInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SAPCentralInstance, __self__).__init__(
            'azure-native:workloads/v20230401:SAPCentralInstance',
            resource_name,
            __props__,
            opts)
