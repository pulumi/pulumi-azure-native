...
class SapLandscapeMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sap_landscape_monitor = azure_native.workloads.v20230401.SapLandscapeMonitor("sapLandscapeMonitor",
            grouping=azure_native.workloads.v20230401.SapLandscapeMonitorPropertiesResponseGroupingArgs(
                landscape=[azure_native.workloads.v20230401.SapLandscapeMonitorSidMappingArgs(
                    name="Prod",
                    top_sid=[
                        "SID1",
                        "SID2",
                ...
                sap_application=[azure_native.workloads.v20230401.SapLandscapeMonitorSidMappingArgs(
                    name="ERP1",
                    top_sid=[
                        "SID1",
                        "SID2",
            ...
            top_metrics_thresholds=[azure_native.workloads.v20230401.SapLandscapeMonitorMetricThresholdsArgs(
                green=90,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:SapLandscapeMonitor"), pulumi.Alias(type_="azure-native:workloads/v20221101preview:SapLandscapeMonitor")])
