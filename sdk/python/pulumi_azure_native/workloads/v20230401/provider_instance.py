...
class ProviderInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads:ProviderInstance"), pulumi.Alias(type_="azure-native:workloads/v20211201preview:ProviderInstance")])
