...
def get_sap_landscape_monitor(monitor_name: Optional[_builtins.str] = None,
...
def get_sap_landscape_monitor_output(monitor_name: Optional[pulumi.Input[_builtins.str]] = None,
