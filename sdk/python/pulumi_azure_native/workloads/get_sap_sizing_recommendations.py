...
def get_sap_sizing_recommendations(app_location: Optional[builtins.str] = None,
...
def get_sap_sizing_recommendations_output(app_location: Optional[pulumi.Input[builtins.str]] = None,
