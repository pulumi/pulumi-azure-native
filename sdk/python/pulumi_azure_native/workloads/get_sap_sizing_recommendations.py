...
def get_sap_sizing_recommendations(app_location: Optional[_builtins.str] = None,
                                   database_type: Optional[Union[_builtins.str, 'SAPDatabaseType']] = None,
                                   db_memory: Optional[_builtins.float] = None,
                                   db_scale_method: Optional[Union[_builtins.str, 'SAPDatabaseScaleMethod']] = None,
                                   ...
                                   saps: Optional[_builtins.float] = None,
    ...
    :param Union[_builtins.str, 'SAPDatabaseScaleMethod'] db_scale_method: The DB scale method.
    ...
    :param _builtins.float saps: The SAP Application Performance Standard measurement.
    """
    __args__ = dict()
...
def get_sap_sizing_recommendations_output(app_location: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads:getSAPSizingRecommendations', __args__, opts=opts, typ=GetSAPSizingRecommendationsResult)
