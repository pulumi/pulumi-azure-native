...
class GetSapApplicationServerInstanceResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, dispatcher_status=None, errors=None, gateway_port=None, health=None, hostname=None, icm_http_port=None, icm_https_port=None, id=None, instance_no=None, ip_address=None, kernel_patch=None, kernel_version=None, load_balancer_details=None, location=None, name=None, provisioning_state=None, status=None, subnet=None, system_data=None, tags=None, type=None, vm_details=None):
    ...
    def dispatcher_status(self) -> builtins.str:
        """
    ...
    def gateway_port(self) -> builtins.float:
        """
    ...
    def icm_http_port(self) -> builtins.float:
        """
    ...
    def icm_https_port(self) -> builtins.float:
        """
...
def get_sap_application_server_instance(application_instance_name: Optional[builtins.str] = None,
    ...
    :param builtins.str application_instance_name: The name of SAP Application Server instance resource.
...
def get_sap_application_server_instance_output(application_instance_name: Optional[pulumi.Input[builtins.str]] = None,
