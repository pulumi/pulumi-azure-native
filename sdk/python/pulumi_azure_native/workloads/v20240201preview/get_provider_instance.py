...
def get_provider_instance(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:workloads/v20240201preview:getProviderInstance', __args__, opts=opts, typ=GetProviderInstanceResult).value
...
def get_provider_instance_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:workloads/v20240201preview:getProviderInstance', __args__, opts=opts, typ=GetProviderInstanceResult)
