...
def get_sap_central_server_instance(central_instance_name: Optional[str] = None,
...
def get_sap_central_server_instance_output(central_instance_name: Optional[pulumi.Input[str]] = None,
