...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] app_location: The monitor resources will be deployed in the monitoring region. The subnet region should be same as the monitoring region.
        ...
        :param pulumi.Input[Union[str, 'RoutingPreference']] routing_preference: Sets the routing preference of the monitor. By default only RFC1918 traffic is routed to the customer VNET.
...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:workloads/v20211201preview:monitor")])
