...
def get_cloud(cloud_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_name: Name of the Cloud.
...
def get_cloud_output(cloud_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
