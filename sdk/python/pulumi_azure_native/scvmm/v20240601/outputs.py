...
class OsProfileForVmInstanceResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "runOnceCommands":
            suggest = "run_once_commands"
    ...
    def __init__(__self__, *,
        ...
        :param str domain_name: Gets or sets the domain name.
        :param str domain_username: Gets or sets the domain username.
        :param str run_once_commands: Get or sets the commands to be run once at the time of creation separated by semicolons.
        :param int timezone: Gets or sets the index value of the timezone.
        :param str workgroup: Gets or sets the workgroup.
        """
        ...
        if run_once_commands is not None:
            pulumi.set(__self__, "run_once_commands", run_once_commands)
    ...
    @property
    @pulumi.getter(name="runOnceCommands")
    def run_once_commands(self) -> Optional[str]:
        """
        Get or sets the commands to be run once at the time of creation separated by semicolons.
        """
        return pulumi.get(self, "run_once_commands")
