...
if not MYPY:
    class OsProfileForVmInstanceArgsDict(TypedDict):
        ...
        """
        domain_password: NotRequired[pulumi.Input[str]]
        """
...
class OsProfileForVmInstanceArgs:
    def __init__(__self__, *,
                 ...
                 run_once_commands: Optional[pulumi.Input[str]] = None,
                 timezone: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[str] domain_name: Gets or sets the domain name.
        :param pulumi.Input[str] domain_password: Password of the domain the VM has to join.
        :param pulumi.Input[str] domain_username: Gets or sets the domain username.
        :param pulumi.Input[str] product_key: Gets or sets the product key.Input format xxxxx-xxxxx-xxxxx-xxxxx-xxxxx
        :param pulumi.Input[str] run_once_commands: Get or sets the commands to be run once at the time of creation separated by semicolons.
        :param pulumi.Input[int] timezone: Gets or sets the index value of the timezone.
        :param pulumi.Input[str] workgroup: Gets or sets the workgroup.
        """
    ...
    def run_once_commands(self) -> Optional[pulumi.Input[str]]:
        """
        Get or sets the commands to be run once at the time of creation separated by semicolons.
        """
        return pulumi.get(self, "run_once_commands")

    @run_once_commands.setter
    def run_once_commands(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "run_once_commands", value)

    @property
    @pulumi.getter
    def timezone(self) -> Optional[pulumi.Input[int]]:
        """
        Gets or sets the index value of the timezone.
        """
    ...
    @timezone.setter
    def timezone(self, value: Optional[pulumi.Input[int]]):
