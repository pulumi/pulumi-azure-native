...
class VirtualMachineInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability_sets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AvailabilitySetListItemArgs', 'AvailabilitySetListItemArgsDict']]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AvailabilitySetListItemArgs', 'AvailabilitySetListItemArgsDict']]]] availability_sets: Availability Sets in vm.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:scvmm/v20231007:VirtualMachineInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineInstance, __self__).__init__(
            'azure-native:scvmm/v20240601:VirtualMachineInstance',
            resource_name,
            __props__,
            opts)
