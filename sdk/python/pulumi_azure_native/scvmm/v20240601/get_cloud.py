...
def get_cloud(cloud_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20240601:getCloud', __args__, opts=opts, typ=GetCloudResult).value
...
def get_cloud_output(cloud_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20240601:getCloud', __args__, opts=opts, typ=GetCloudResult)
    return __ret__.apply(lambda __response__: GetCloudResult(
        ...
        storage_qos_policies=pulumi.get(__response__, 'storage_qos_policies'),
