...
class GetGuestAgentResult:
    ...
    """
    def __init__(__self__, credentials=None, custom_resource_name=None, http_proxy_config=None, id=None, name=None, private_link_scope_resource_id=None, provisioning_action=None, provisioning_state=None, status=None, system_data=None, type=None, uuid=None):
...
def get_guest_agent(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20240601:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult).value
