...
def get_hybrid_identity_metadata(metadata_name: Optional[builtins.str] = None,
    ...
    :param builtins.str metadata_name: Name of the HybridIdentityMetadata.
    :param builtins.str resource_group_name: The name of the resource group.
    :param builtins.str virtual_machine_name: Name of the vm.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm:getHybridIdentityMetadata', __args__, opts=opts, typ=GetHybridIdentityMetadataResult).value
...
def get_hybrid_identity_metadata_output(metadata_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm:getHybridIdentityMetadata', __args__, opts=opts, typ=GetHybridIdentityMetadataResult)
