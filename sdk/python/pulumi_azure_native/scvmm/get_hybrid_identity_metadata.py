...
def get_hybrid_identity_metadata(metadata_name: Optional[_builtins.str] = None,
...
def get_hybrid_identity_metadata_output(metadata_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
