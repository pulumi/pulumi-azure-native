...
class AvailabilitySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:AvailabilitySet"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:AvailabilitySet")])
