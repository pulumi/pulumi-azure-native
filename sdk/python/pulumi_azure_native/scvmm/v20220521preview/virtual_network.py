...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VirtualNetwork")])
