...
class VirtualMachineTemplateArgs:
    ...
    def _configure(
        ...
        if virtual_machine_template_name is None and 'virtualMachineTemplateName' in kwargs:
            virtual_machine_template_name = kwargs['virtualMachineTemplateName']
...
class VirtualMachineTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VirtualMachineTemplate"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:VirtualMachineTemplate"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VirtualMachineTemplate"), pulumi.Alias(type_="azure-native:scvmm/v20231007:VirtualMachineTemplate")])
