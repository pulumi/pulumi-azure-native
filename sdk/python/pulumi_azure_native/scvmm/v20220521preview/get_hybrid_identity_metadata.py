...
def get_hybrid_identity_metadata_output(metadata_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualMachineName'] = virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20220521preview:getHybridIdentityMetadata', __args__, opts=opts, typ=GetHybridIdentityMetadataResult)
    return __ret__.apply(lambda __response__: GetHybridIdentityMetadataResult(
