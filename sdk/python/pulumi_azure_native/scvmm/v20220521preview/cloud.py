...
class Cloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20231007:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20240601:Cloud")])
