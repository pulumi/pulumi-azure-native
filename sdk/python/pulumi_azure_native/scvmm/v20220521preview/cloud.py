...
class Cloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20200605preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20231007:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20240601:Cloud"), pulumi.Alias(type_="azure-native:scvmm:Cloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cloud, __self__).__init__(
            'azure-native:scvmm/v20220521preview:Cloud',
            resource_name,
            __props__,
            opts)
