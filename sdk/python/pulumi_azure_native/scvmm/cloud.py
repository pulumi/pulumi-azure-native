...
class CloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cloud_name: Name of the Cloud.
        ...
        :param pulumi.Input[builtins.str] uuid: Unique ID of the cloud.
...
class Cloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20200605preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20231007:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20240601:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20250313:Cloud")])
