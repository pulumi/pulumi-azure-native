...
class Cloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20220521preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20231007:Cloud"), pulumi.Alias(type_="azure-native:scvmm/v20240601:Cloud"), pulumi.Alias(type_="azure-native_scvmm_v20200605preview:scvmm:Cloud"), pulumi.Alias(type_="azure-native_scvmm_v20220521preview:scvmm:Cloud"), pulumi.Alias(type_="azure-native_scvmm_v20230401preview:scvmm:Cloud"), pulumi.Alias(type_="azure-native_scvmm_v20231007:scvmm:Cloud"), pulumi.Alias(type_="azure-native_scvmm_v20240601:scvmm:Cloud")])
