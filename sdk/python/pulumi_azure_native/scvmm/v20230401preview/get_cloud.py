...
def get_cloud(cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20230401preview:getCloud', __args__, opts=opts, typ=GetCloudResult).value
...
def get_cloud_output(cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20230401preview:getCloud', __args__, opts=opts, typ=GetCloudResult)
