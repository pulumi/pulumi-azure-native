...
class VmmServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            credentials = _utilities.configure(credentials, VMMServerPropertiesCredentialsArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20231007:VmmServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VmmServer, __self__).__init__(
            'azure-native:scvmm/v20230401preview:VmmServer',
            resource_name,
            __props__,
            opts)
