...
class VMInstanceGuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20231007:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native:scvmm/v20240601:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native:scvmm:VMInstanceGuestAgent")])
