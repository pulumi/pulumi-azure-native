...
def get_virtual_machine(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20230401preview:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
...
def get_virtual_machine_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualMachineName'] = virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20230401preview:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult)
