...
class GuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:GuestAgent"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:GuestAgent")])
