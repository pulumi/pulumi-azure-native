...
class AvailabilitySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:AvailabilitySet"), pulumi.Alias(type_="azure-native:scvmm/v20200605preview:AvailabilitySet"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:AvailabilitySet"), pulumi.Alias(type_="azure-native:scvmm/v20231007:AvailabilitySet"), pulumi.Alias(type_="azure-native:scvmm/v20240601:AvailabilitySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvailabilitySet, __self__).__init__(
            'azure-native:scvmm/v20230401preview:AvailabilitySet',
            resource_name,
            __props__,
            opts)
