...
def get_guest_agent(guest_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20230401preview:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult).value
...
def get_guest_agent_output(guest_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualMachineName'] = virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20230401preview:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult)
