...
class AvailabilitySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_set_name: Name of the availability set.
