...
def get_guest_agent(guest_agent_name: Optional[_builtins.str] = None,
...
def get_guest_agent_output(guest_agent_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
