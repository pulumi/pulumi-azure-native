...
def get_guest_agent(guest_agent_name: Optional[builtins.str] = None,
    ...
    :param builtins.str guest_agent_name: Name of the GuestAgent.
...
def get_guest_agent_output(guest_agent_name: Optional[pulumi.Input[builtins.str]] = None,
