...
class VmmServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: Fqdn is the hostname/ip of the vmmServer.
        ...
        :param pulumi.Input[builtins.int] port: Port is the port on which the vmmServer is listening.
    ...
    def vmm_server_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vmm_server_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vmm_server_name", value)


class VmmServer(pulumi.CustomResource):

    pulumi_type = "azure-native:scvmm:VmmServer"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20200605preview:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20231007:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20240601:VmmServer"), pulumi.Alias(type_="azure-native:scvmm/v20250313:VmmServer")])
