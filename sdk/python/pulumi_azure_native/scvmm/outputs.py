...
class GuestAgentProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 error_details: Sequence['_commontypesv2.outputs.ErrorDetailResponse'],
        ...
        :param Sequence['_commontypesv2.ErrorDetailResponse'] error_details: Details about the error state.
    ...
    def error_details(self) -> Sequence['_commontypesv2.outputs.ErrorDetailResponse']:
        """
