...
class CheckpointResponse(dict):
    ...
    def __init__(__self__, *,
                 checkpoint_id: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 parent_checkpoint_id: Optional[builtins.str] = None):
        """
        Defines the resource properties.
        :param builtins.str checkpoint_id: Gets ID of the checkpoint.
        :param builtins.str description: Gets description of the checkpoint.
        :param builtins.str name: Gets name of the checkpoint.
        :param builtins.str parent_checkpoint_id: Gets ID of parent of the checkpoint.
        """
    ...
    def checkpoint_id(self) -> Optional[builtins.str]:
        """
    ...
    def parent_checkpoint_id(self) -> Optional[builtins.str]:
        """
...
class CloudCapacityResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vm_count: Optional[builtins.float] = None):
        """
        Cloud Capacity model
        :param builtins.float cpu_count: CPUCount specifies the maximum number of CPUs that can be allocated in the cloud.
        :param builtins.float memory_mb: MemoryMB specifies a memory usage limit in megabytes.
        :param builtins.float vm_count: VMCount gives the max number of VMs that can be deployed in the cloud.
        """
    ...
    def vm_count(self) -> Optional[builtins.float]:
        """
...
class HardwareProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dynamic_memory_enabled: Optional[builtins.str] = None,
                 dynamic_memory_max_mb: Optional[builtins.int] = None,
                 dynamic_memory_min_mb: Optional[builtins.int] = None,
                 is_highly_available: Optional[builtins.str] = None,
                 limit_cpu_for_migration: Optional[builtins.str] = None,
                 memory_mb: Optional[builtins.int] = None):
        """
        Defines the resource properties.
        :param builtins.int cpu_count: Gets or sets the number of vCPUs for the vm.
        :param builtins.str dynamic_memory_enabled: Gets or sets a value indicating whether to enable dynamic memory or not.
        :param builtins.int dynamic_memory_max_mb: Gets or sets the max dynamic memory for the vm.
        :param builtins.int dynamic_memory_min_mb: Gets or sets the min dynamic memory for the vm.
        :param builtins.str is_highly_available: Gets highly available property.
        :param builtins.str limit_cpu_for_migration: Gets or sets a value indicating whether to enable processor compatibility mode for live migration of VMs.
        :param builtins.int memory_mb: MemoryMB is the size of a virtual machine's memory, in MB.
        """
        if cpu_count is not None:
            pulumi.set(__self__, "cpu_count", cpu_count)
    ...
    def dynamic_memory_enabled(self) -> Optional[builtins.str]:
        """
    ...
    def dynamic_memory_max_mb(self) -> Optional[builtins.int]:
        """
    ...
    def dynamic_memory_min_mb(self) -> Optional[builtins.int]:
        """
    ...
    def is_highly_available(self) -> Optional[builtins.str]:
        """
    ...
    def limit_cpu_for_migration(self) -> Optional[builtins.str]:
        """
...
class InfrastructureProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bios_guid: Optional[builtins.str] = None,
                 ...
                 vmm_server_id: Optional[builtins.str] = None):
        """
        Specifies the vmmServer infrastructure specific settings for the virtual machine instance.
        :param 'CheckpointResponse' last_restored_vm_checkpoint: Last restored checkpoint in the vm.
        :param builtins.str bios_guid: Gets or sets the bios guid for the vm.
        :param builtins.str checkpoint_type: Type of checkpoint supported for the vm.
        :param Sequence['CheckpointResponse'] checkpoints: Checkpoints in the vm.
        :param builtins.str cloud_id: ARM Id of the cloud resource to use for deploying the vm.
        :param builtins.int generation: Gets or sets the generation for the vm.
        :param builtins.str inventory_item_id: Gets or sets the inventory Item ID for the resource.
        :param builtins.str template_id: ARM Id of the template resource to use for deploying the vm.
        :param builtins.str uuid: Unique ID of the virtual machine.
        :param builtins.str vm_name: VMName is the name of VM on the SCVMM server.
        :param builtins.str vmm_server_id: ARM Id of the vmmServer resource in which this resource resides.
        """
    ...
    def bios_guid(self) -> Optional[builtins.str]:
        """
...
class NetworkInterfacesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Network Interface model
        :param builtins.str display_name: Gets the display name of the network interface as shown in the vmmServer. This is the fallback label for a NIC when the name is not set.
        :param Sequence[builtins.str] ipv4_addresses: Gets or sets the nic ipv4 addresses.
        :param Sequence[builtins.str] ipv6_addresses: Gets or sets the nic ipv6 addresses.
        :param builtins.str network_name: Gets or sets the name of the virtual network in vmmServer that the nic is connected to.
        :param builtins.str ipv4_address_type: Gets or sets the ipv4 address type.
        :param builtins.str ipv6_address_type: Gets or sets the ipv6 address type.
        :param builtins.str mac_address: Gets or sets the nic MAC address.
        :param builtins.str mac_address_type: Gets or sets the mac address type.
        :param builtins.str name: Gets or sets the name of the network interface.
        :param builtins.str nic_id: Gets or sets the nic id.
        :param builtins.str virtual_network_id: Gets or sets the ARM Id of the Microsoft.ScVmm/virtualNetwork resource to connect the nic.
        """
...
class OsProfileForVMInstanceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str os_version: Gets os version.
...
class StorageQoSPolicyDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The StorageQoSPolicyDetails definition.
        :param builtins.str id: The ID of the QoS policy.
...
class StorageQoSPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 bandwidth_limit: Optional[builtins.float] = None,
                 id: Optional[builtins.str] = None,
                 iops_maximum: Optional[builtins.float] = None,
                 iops_minimum: Optional[builtins.float] = None,
                 name: Optional[builtins.str] = None,
                 policy_id: Optional[builtins.str] = None):
        """
        The StorageQoSPolicy definition.
        :param builtins.float bandwidth_limit: The Bandwidth Limit for internet traffic.
        :param builtins.str id: The ID of the QoS policy.
        :param builtins.float iops_maximum: The maximum IO operations per second.
        :param builtins.float iops_minimum: The minimum IO operations per second.
        :param builtins.str name: The name of the policy.
        :param builtins.str policy_id: The underlying policy.
        """
    ...
    def bandwidth_limit(self) -> Optional[builtins.float]:
        """
    ...
    def iops_maximum(self) -> Optional[builtins.float]:
        """
    ...
    def iops_minimum(self) -> Optional[builtins.float]:
        """
...
class VMMServerPropertiesResponseCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Credentials to connect to VMMServer.
        :param builtins.str username: Username to use to connect to VMMServer.
        """
...
class VirtualDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Virtual disk model
        :param builtins.str display_name: Gets the display name of the virtual disk as shown in the vmmServer. This is the fallback label for a disk when the name is not set.
        :param builtins.int max_disk_size_gb: Gets or sets the max disk size.
        :param builtins.str vhd_format_type: Gets the disk vhd format type.
        :param builtins.str volume_type: Gets or sets the disk volume type.
        :param builtins.int bus: Gets or sets the disk bus.
        :param builtins.str bus_type: Gets or sets the disk bus type.
        :param builtins.str create_diff_disk: Gets or sets a value indicating diff disk.
        :param builtins.str disk_id: Gets or sets the disk id.
        :param builtins.int disk_size_gb: Gets or sets the disk total size.
        :param builtins.int lun: Gets or sets the disk lun.
        :param builtins.str name: Gets or sets the name of the disk.
        :param 'StorageQoSPolicyDetailsResponse' storage_qo_s_policy: The QoS policy for the disk.
        :param builtins.str template_disk_id: Gets or sets the disk id in the template.
        :param builtins.str vhd_type: Gets or sets the disk vhd type.
        """
        pulumi.set(__self__, "display_name", display_name)
    ...
    def max_disk_size_gb(self) -> builtins.int:
        """
    ...
    def vhd_format_type(self) -> builtins.str:
        """
    ...
    def create_diff_disk(self) -> Optional[builtins.str]:
        """
...
class VirtualMachineInstancePropertiesResponseAvailabilitySets(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Availability Set model
        :param builtins.str id: Gets the ARM Id of the microsoft.scvmm/availabilitySets resource.
        :param builtins.str name: Gets or sets the name of the availability set.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
