...
class CloudArgs:
    ...
    def _configure(
        ...
        if cloud_resource_name is None and 'cloudResourceName' in kwargs:
            cloud_resource_name = kwargs['cloudResourceName']
        ...
        if cloud_resource_name is not None:
            _setter("cloud_resource_name", cloud_resource_name)
