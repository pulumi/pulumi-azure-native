...
class InventoryItemArgs:
    ...
    def _configure(
        ...
        if inventory_item_resource_name is None and 'inventoryItemResourceName' in kwargs:
            inventory_item_resource_name = kwargs['inventoryItemResourceName']
        ...
        if inventory_item_resource_name is not None:
            _setter("inventory_item_resource_name", inventory_item_resource_name)
        if kind is not None:
            _setter("kind", kind)
