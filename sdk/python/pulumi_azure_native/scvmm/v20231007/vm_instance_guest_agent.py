...
class VMInstanceGuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VMInstanceGuestAgent"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VMInstanceGuestAgent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VMInstanceGuestAgent, __self__).__init__(
            'azure-native:scvmm/v20231007:VMInstanceGuestAgent',
            resource_name,
            __props__,
            opts)
