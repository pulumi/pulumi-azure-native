...
def get_vmm_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20231007:getVmmServer', __args__, opts=opts, typ=GetVmmServerResult).value
...
def get_vmm_server_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vmmServerName'] = vmm_server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:scvmm/v20231007:getVmmServer', __args__, opts=opts, typ=GetVmmServerResult)
