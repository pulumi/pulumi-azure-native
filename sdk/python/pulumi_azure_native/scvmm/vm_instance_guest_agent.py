...
class VMInstanceGuestAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_uri: The fully qualified Azure Resource manager identifier of the Hybrid Compute machine resource to be extended.
...
class VMInstanceGuestAgent(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:scvmm:VMInstanceGuestAgent"
