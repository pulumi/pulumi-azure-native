...
class VMInstanceGuestAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(credentials, GuestCredentialArgs):
                credentials = credentials or {}
                def _setter(key, value):
                    credentials[key] = value
                GuestCredentialArgs._configure(_setter, **credentials)
            __props__.__dict__["credentials"] = credentials
            if not isinstance(http_proxy_config, HttpProxyConfigurationArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VMInstanceGuestAgent")])
