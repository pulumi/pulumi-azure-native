...
warnings.warn("""azure-native:scvmm/v20200605preview:Cloud is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:Cloud to guarantee forwards compatibility.""", DeprecationWarning)
...
class Cloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vmm_server_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Cloud is deprecated: azure-native:scvmm/v20200605preview:Cloud is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:Cloud to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:Cloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cloud, __self__).__init__(
            'azure-native:scvmm/v20200605preview:Cloud',
            resource_name,
            __props__,
            opts)
