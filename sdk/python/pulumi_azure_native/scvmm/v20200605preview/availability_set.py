...
class AvailabilitySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vmm_server_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AvailabilitySet is deprecated: azure-native:scvmm/v20200605preview:AvailabilitySet is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:AvailabilitySet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:AvailabilitySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvailabilitySet, __self__).__init__(
            'azure-native:scvmm/v20200605preview:AvailabilitySet',
            resource_name,
            __props__,
            opts)
