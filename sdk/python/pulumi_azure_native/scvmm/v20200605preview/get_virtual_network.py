...
warnings.warn("""azure-native:scvmm/v20200605preview:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:VirtualNetwork to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network is deprecated: azure-native:scvmm/v20200605preview:VirtualNetwork is being removed in the next major version of this provider. Upgrade to at least azure-native:scvmm/v20220521preview:VirtualNetwork to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['virtualNetworkName'] = virtual_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:scvmm/v20200605preview:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
