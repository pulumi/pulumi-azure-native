...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scvmm:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20220521preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20230401preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20231007:VirtualNetwork"), pulumi.Alias(type_="azure-native:scvmm/v20240601:VirtualNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetwork, __self__).__init__(
            'azure-native:scvmm/v20200605preview:VirtualNetwork',
            resource_name,
            __props__,
            opts)
