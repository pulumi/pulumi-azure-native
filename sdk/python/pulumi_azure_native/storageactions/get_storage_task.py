...
class GetStorageTaskResult:
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> '_commontypesv5.outputs.ManagedServiceIdentityResponse':
        """
...
def get_storage_task(resource_group_name: Optional[_builtins.str] = None,
                     storage_task_name: Optional[_builtins.str] = None,
