...
class IfConditionArgs:
    def __init__(__self__, *,
        ...
        """
        The if block of storage task operation
        :param pulumi.Input[builtins.str] condition: Condition predicate to evaluate each object. See https://aka.ms/storagetaskconditions for valid properties and operators.
...
if not MYPY:
    class StorageTaskOperationArgsDict(TypedDict):
        ...
        """
        name: pulumi.Input[Union[builtins.str, 'StorageTaskOperationName']]
        """
        The operation to be performed on the object.
        """
        on_failure: NotRequired[pulumi.Input[Union[builtins.str, 'OnFailure']]]
        """
        Action to be taken when the operation fails for a object.
        """
        on_success: NotRequired[pulumi.Input[Union[builtins.str, 'OnSuccess']]]
        """
...
class StorageTaskOperationArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[Union[builtins.str, 'StorageTaskOperationName']],
                 on_failure: Optional[pulumi.Input[Union[builtins.str, 'OnFailure']]] = None,
                 on_success: Optional[pulumi.Input[Union[builtins.str, 'OnSuccess']]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Represents an operation to be performed on the object
        :param pulumi.Input[Union[builtins.str, 'StorageTaskOperationName']] name: The operation to be performed on the object.
        :param pulumi.Input[Union[builtins.str, 'OnFailure']] on_failure: Action to be taken when the operation fails for a object.
        :param pulumi.Input[Union[builtins.str, 'OnSuccess']] on_success: Action to be taken when the operation is successful for a object.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Key-value parameters for the operation.
        """
    ...
    @property
    @pulumi.getter
    def name(self) -> pulumi.Input[Union[builtins.str, 'StorageTaskOperationName']]:
        """
        The operation to be performed on the object.
        """
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[builtins.str, 'StorageTaskOperationName']]):
        pulumi.set(self, "name", value)

    @property
    @pulumi.getter(name="onFailure")
    def on_failure(self) -> Optional[pulumi.Input[Union[builtins.str, 'OnFailure']]]:
        """
        Action to be taken when the operation fails for a object.
        """
    ...
    @on_failure.setter
    def on_failure(self, value: Optional[pulumi.Input[Union[builtins.str, 'OnFailure']]]):
        pulumi.set(self, "on_failure", value)

    @property
    @pulumi.getter(name="onSuccess")
    def on_success(self) -> Optional[pulumi.Input[Union[builtins.str, 'OnSuccess']]]:
        """
        Action to be taken when the operation is successful for a object.
        """
    ...
    @on_success.setter
    def on_success(self, value: Optional[pulumi.Input[Union[builtins.str, 'OnSuccess']]]):
