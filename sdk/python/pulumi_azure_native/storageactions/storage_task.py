...
class StorageTaskArgs:
    ...
    def _configure(
             ...
             action: Optional[pulumi.Input['StorageTaskActionArgs']] = None,
        ...
        if storage_task_name is None and 'storageTaskName' in kwargs:
...
class StorageTask(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            action = _utilities.configure(action, StorageTaskActionArgs, True)
