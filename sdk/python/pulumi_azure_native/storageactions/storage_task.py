...
class StorageTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Text that describes the purpose of the storage task
        :param pulumi.Input[builtins.bool] enabled: Storage Task is enabled when set to true and disabled when set to false
        ...
        :param pulumi.Input[builtins.str] storage_task_name: The name of the storage task within the specified resource group. Storage task names must be between 3 and 18 characters in length and use numbers and lower-case letters only.
    ...
    def storage_task_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_task_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageTask(pulumi.CustomResource):
    ...
    def creation_time_in_utc(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def task_version(self) -> pulumi.Output[builtins.float]:
        """
