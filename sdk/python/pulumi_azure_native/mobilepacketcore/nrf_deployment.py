...
__all__ = ['NrfDeploymentArgs', 'NrfDeployment']

@pulumi.input_type
class NrfDeploymentArgs:
    def __init__(__self__, *,
                 cluster_service: pulumi.Input[str],
                 resource_group_name: pulumi.Input[str],
                 component_parameters: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 nrf_deployment_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] component_parameters: Azure for Operators 5G Core NRF component parameters
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] nrf_deployment_name: The name of the NrfDeployment
        :param pulumi.Input[str] secrets_parameters: Azure for Operators 5G Core NRF secrets parameters
        ...
        if nrf_deployment_name is not None:
            pulumi.set(__self__, "nrf_deployment_name", nrf_deployment_name)
    ...
    @property
    @pulumi.getter(name="nrfDeploymentName")
    def nrf_deployment_name(self) -> Optional[pulumi.Input[str]]:
        """
        The name of the NrfDeployment
        """
        return pulumi.get(self, "nrf_deployment_name")

    @nrf_deployment_name.setter
    def nrf_deployment_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "nrf_deployment_name", value)
...
class NrfDeployment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NrfDeploymentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NrfDeploymentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NrfDeploymentArgs.__new__(NrfDeploymentArgs)
            ...
            __props__.__dict__["nrf_deployment_name"] = nrf_deployment_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore/v20231015preview:NrfDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NrfDeployment, __self__).__init__(
            'azure-native:mobilepacketcore:NrfDeployment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NrfDeployment':
        """
        Get an existing NrfDeployment resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["type"] = None
        return NrfDeployment(resource_name, opts=opts, __props__=__props__)
