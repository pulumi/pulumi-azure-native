...
def get_amf_deployment(amf_deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore:getAmfDeployment', __args__, opts=opts, typ=GetAmfDeploymentResult).value
...
def get_amf_deployment_output(amf_deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore:getAmfDeployment', __args__, opts=opts, typ=GetAmfDeploymentResult)
