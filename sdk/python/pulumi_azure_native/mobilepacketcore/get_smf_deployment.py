...
def get_smf_deployment(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore:getSmfDeployment', __args__, opts=opts, typ=GetSmfDeploymentResult).value
...
def get_smf_deployment_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['smfDeploymentName'] = smf_deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore:getSmfDeployment', __args__, opts=opts, typ=GetSmfDeploymentResult)
