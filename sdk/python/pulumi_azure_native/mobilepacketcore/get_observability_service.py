...
def get_observability_service(observability_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore:getObservabilityService', __args__, opts=opts, typ=GetObservabilityServiceResult).value
...
def get_observability_service_output(observability_service_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore:getObservabilityService', __args__, opts=opts, typ=GetObservabilityServiceResult)
