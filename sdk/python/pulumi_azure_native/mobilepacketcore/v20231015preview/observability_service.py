...
class ObservabilityService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] cluster_service: Reference to cluster where the observability components are deployed
        :param pulumi.Input[Sequence[pulumi.Input[Union['QualifiedComponentDeploymentParametersArgs', 'QualifiedComponentDeploymentParametersArgsDict']]]] component_parameters: Azure for Operators 5G Core Observability component parameters.  One set per component type
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] observability_service_name: The name of the Observability Service
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
