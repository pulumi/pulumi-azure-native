...
def get_nssf_deployment_output(nssf_deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore/v20231015preview:getNssfDeployment', __args__, opts=opts, typ=GetNssfDeploymentResult)
    return __ret__.apply(lambda __response__: GetNssfDeploymentResult(
