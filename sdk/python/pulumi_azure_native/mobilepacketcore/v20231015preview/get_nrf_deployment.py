...
def get_nrf_deployment(nrf_deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore/v20231015preview:getNrfDeployment', __args__, opts=opts, typ=GetNrfDeploymentResult).value
...
def get_nrf_deployment_output(nrf_deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore/v20231015preview:getNrfDeployment', __args__, opts=opts, typ=GetNrfDeploymentResult)
