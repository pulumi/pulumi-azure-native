...
__all__ = [
    'GetSmfDeploymentResult',
    'AwaitableGetSmfDeploymentResult',
    'get_smf_deployment',
    'get_smf_deployment_output',
]

@pulumi.output_type
class GetSmfDeploymentResult:
    """
...
class AwaitableGetSmfDeploymentResult(GetSmfDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmfDeploymentResult(
...
def get_smf_deployment(resource_group_name: Optional[str] = None,
                       smf_deployment_name: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmfDeploymentResult:
    """
    Get a SmfDeploymentResource


    :param str resource_group_name: The name of the resource group. The name is case insensitive.
    :param str smf_deployment_name: The name of the SmfDeployment
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['smfDeploymentName'] = smf_deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore/v20231015preview:getSmfDeployment', __args__, opts=opts, typ=GetSmfDeploymentResult).value

    return AwaitableGetSmfDeploymentResult(
...
def get_smf_deployment_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                              smf_deployment_name: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSmfDeploymentResult]:
    """
    Get a SmfDeploymentResource
    ...
    __args__['smfDeploymentName'] = smf_deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore/v20231015preview:getSmfDeployment', __args__, opts=opts, typ=GetSmfDeploymentResult)
    return __ret__.apply(lambda __response__: GetSmfDeploymentResult(
