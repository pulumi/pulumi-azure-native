...
__all__ = ['AmfDeploymentArgs', 'AmfDeployment']

@pulumi.input_type
class AmfDeploymentArgs:
    def __init__(__self__, *,
                 cluster_service: pulumi.Input[str],
                 resource_group_name: pulumi.Input[str],
                 amf_deployment_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] amf_deployment_name: The name of the AMF Deployment
        :param pulumi.Input[str] component_parameters: Azure for Operators 5G Core AMF component parameters
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] secrets_parameters: Azure for Operators 5G Core AMF secrets parameters
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        pulumi.set(__self__, "cluster_service", cluster_service)
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        if amf_deployment_name is not None:
            pulumi.set(__self__, "amf_deployment_name", amf_deployment_name)
    ...
    @property
    @pulumi.getter(name="amfDeploymentName")
    def amf_deployment_name(self) -> Optional[pulumi.Input[str]]:
        """
        The name of the AMF Deployment
        """
        return pulumi.get(self, "amf_deployment_name")

    @amf_deployment_name.setter
    def amf_deployment_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "amf_deployment_name", value)
...
class AmfDeployment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AmfDeploymentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Azure for Operators 5G Core Access and Mobility Function (AMF) Deployment Resource

        :param str resource_name: The name of the resource.
        :param AmfDeploymentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AmfDeploymentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AmfDeploymentArgs.__new__(AmfDeploymentArgs)

            __props__.__dict__["amf_deployment_name"] = amf_deployment_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore:AmfDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AmfDeployment, __self__).__init__(
            'azure-native:mobilepacketcore/v20231015preview:AmfDeployment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AmfDeployment':
        """
        ...
        __props__.__dict__["type"] = None
        return AmfDeployment(resource_name, opts=opts, __props__=__props__)
