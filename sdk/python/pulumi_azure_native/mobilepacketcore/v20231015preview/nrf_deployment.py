...
class NrfDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore:NrfDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NrfDeployment, __self__).__init__(
            'azure-native:mobilepacketcore/v20231015preview:NrfDeployment',
            resource_name,
            __props__,
            opts)
