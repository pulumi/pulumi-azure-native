...
__all__ = [
    ...
    'AwaitableGetObservabilityServiceResult',
    'get_observability_service',
    'get_observability_service_output',
]

@pulumi.output_type
class GetObservabilityServiceResult:
    """
    Azure for Operators 5G Core Observability Service Resource
    """
    def __init__(__self__, cluster_service=None, component_parameters=None, id=None, location=None, name=None, operational_status=None, provisioning_state=None, release_version=None, system_data=None, tags=None, type=None):
...
class AwaitableGetObservabilityServiceResult(GetObservabilityServiceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObservabilityServiceResult(
...
def get_observability_service(observability_service_name: Optional[str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObservabilityServiceResult:
    """
    Get a ObservabilityServiceResource


    :param str observability_service_name: The name of the Observability Service
    :param str resource_group_name: The name of the resource group. The name is case insensitive.
    """
    __args__ = dict()
    __args__['observabilityServiceName'] = observability_service_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore/v20231015preview:getObservabilityService', __args__, opts=opts, typ=GetObservabilityServiceResult).value

    return AwaitableGetObservabilityServiceResult(
...
def get_observability_service_output(observability_service_name: Optional[pulumi.Input[str]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetObservabilityServiceResult]:
    """
    Get a ObservabilityServiceResource
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore/v20231015preview:getObservabilityService', __args__, opts=opts, typ=GetObservabilityServiceResult)
    return __ret__.apply(lambda __response__: GetObservabilityServiceResult(
