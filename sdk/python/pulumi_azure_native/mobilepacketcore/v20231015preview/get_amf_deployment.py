...
__all__ = [
    ...
    'AwaitableGetAmfDeploymentResult',
    'get_amf_deployment',
    'get_amf_deployment_output',
]

@pulumi.output_type
class GetAmfDeploymentResult:
    """
...
class AwaitableGetAmfDeploymentResult(GetAmfDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAmfDeploymentResult(
...
def get_amf_deployment(amf_deployment_name: Optional[str] = None,
                       resource_group_name: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAmfDeploymentResult:
    """
    Get a AmfDeploymentResource


    :param str amf_deployment_name: The name of the AMF Deployment
    :param str resource_group_name: The name of the resource group. The name is case insensitive.
    """
    __args__ = dict()
    __args__['amfDeploymentName'] = amf_deployment_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore/v20231015preview:getAmfDeployment', __args__, opts=opts, typ=GetAmfDeploymentResult).value

    return AwaitableGetAmfDeploymentResult(
...
def get_amf_deployment_output(amf_deployment_name: Optional[pulumi.Input[str]] = None,
                              resource_group_name: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAmfDeploymentResult]:
    """
    Get a AmfDeploymentResource
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:mobilepacketcore/v20231015preview:getAmfDeployment', __args__, opts=opts, typ=GetAmfDeploymentResult)
    return __ret__.apply(lambda __response__: GetAmfDeploymentResult(
