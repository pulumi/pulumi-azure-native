...
class UpfDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore:UpfDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UpfDeployment, __self__).__init__(
            'azure-native:mobilepacketcore/v20231015preview:UpfDeployment',
            resource_name,
            __props__,
            opts)
