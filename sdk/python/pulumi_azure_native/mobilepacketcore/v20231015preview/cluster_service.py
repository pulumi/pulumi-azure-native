...
class ClusterService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore:ClusterService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterService, __self__).__init__(
            'azure-native:mobilepacketcore/v20231015preview:ClusterService',
            resource_name,
            __props__,
            opts)
