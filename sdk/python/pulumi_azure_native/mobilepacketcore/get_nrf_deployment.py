...
__all__ = [
    'GetNrfDeploymentResult',
    'AwaitableGetNrfDeploymentResult',
    'get_nrf_deployment',
    'get_nrf_deployment_output',
]

@pulumi.output_type
class GetNrfDeploymentResult:
    """
...
class AwaitableGetNrfDeploymentResult(GetNrfDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNrfDeploymentResult(
...
def get_nrf_deployment(nrf_deployment_name: Optional[str] = None,
                       resource_group_name: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNrfDeploymentResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mobilepacketcore:getNrfDeployment', __args__, opts=opts, typ=GetNrfDeploymentResult).value

    return AwaitableGetNrfDeploymentResult(
