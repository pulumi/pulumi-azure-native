...
class AmfDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mobilepacketcore/v20231015preview:AmfDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AmfDeployment, __self__).__init__(
            'azure-native:mobilepacketcore:AmfDeployment',
            resource_name,
            __props__,
            opts)
