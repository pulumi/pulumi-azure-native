...
class NetworkFunctionArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if network_function_administrative_state is None and 'networkFunctionAdministrativeState' in kwargs:
            network_function_administrative_state = kwargs['networkFunctionAdministrativeState']
        if network_function_administrative_state is None:
            raise TypeError("Missing 'network_function_administrative_state' argument")
        if network_function_type is None and 'networkFunctionType' in kwargs:
            network_function_type = kwargs['networkFunctionType']
        if network_function_type is None:
            raise TypeError("Missing 'network_function_type' argument")
        ...
        if deployment_notes is None and 'deploymentNotes' in kwargs:
            deployment_notes = kwargs['deploymentNotes']
        if network_function_name is None and 'networkFunctionName' in kwargs:
            network_function_name = kwargs['networkFunctionName']
        if user_description is None and 'userDescription' in kwargs:
            user_description = kwargs['userDescription']
