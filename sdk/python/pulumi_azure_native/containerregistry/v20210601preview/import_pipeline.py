...
class ImportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trigger: Optional[pulumi.Input[pulumi.InputType['PipelineTriggerPropertiesArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ImportPipeline is deprecated: azure-native:containerregistry/v20210601preview:ImportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.""")
