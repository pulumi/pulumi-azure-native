...
warnings.warn("""azure-native:containerregistry/v20210601preview:Registry is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.""", DeprecationWarning)
...
class Registry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundancy: Optional[pulumi.Input[Union[str, 'ZoneRedundancy']]] = None,
                 __props__=None):
        pulumi.log.warn("""Registry is deprecated: azure-native:containerregistry/v20210601preview:Registry is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.""")
