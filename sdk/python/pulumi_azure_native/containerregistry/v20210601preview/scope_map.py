...
warnings.warn("""azure-native:containerregistry/v20210601preview:ScopeMap is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.""", DeprecationWarning)
...
class ScopeMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope_map_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScopeMap is deprecated: azure-native:containerregistry/v20210601preview:ScopeMap is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20190501preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20221201:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:ScopeMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScopeMap, __self__).__init__(
            'azure-native:containerregistry/v20210601preview:ScopeMap',
            resource_name,
            __props__,
            opts)
