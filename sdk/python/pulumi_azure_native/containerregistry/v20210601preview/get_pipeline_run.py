...
warnings.warn("""azure-native:containerregistry/v20210601preview:PipelineRun is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_pipeline_run(pipeline_run_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pipeline_run is deprecated: azure-native:containerregistry/v20210601preview:PipelineRun is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.""")
    __args__ = dict()
