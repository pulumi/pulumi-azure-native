...
def get_webhook_callback_config_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20210601preview:getWebhookCallbackConfig', __args__, opts=opts, typ=GetWebhookCallbackConfigResult)
