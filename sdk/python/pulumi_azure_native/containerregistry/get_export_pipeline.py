...
def get_export_pipeline(export_pipeline_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str export_pipeline_name: The name of the export pipeline.
...
def get_export_pipeline_output(export_pipeline_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
