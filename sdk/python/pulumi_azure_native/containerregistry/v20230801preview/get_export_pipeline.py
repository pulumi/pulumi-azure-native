...
def get_export_pipeline(export_pipeline_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20230801preview:getExportPipeline', __args__, opts=opts, typ=GetExportPipelineResult).value
...
def get_export_pipeline_output(export_pipeline_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20230801preview:getExportPipeline', __args__, opts=opts, typ=GetExportPipelineResult)
