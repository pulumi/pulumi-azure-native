...
class ImportPipelineArgs:
    ...
    def _configure(
             ...
             source: Optional[pulumi.Input['ImportPipelineSourcePropertiesArgs']] = None,
             identity: Optional[pulumi.Input['IdentityPropertiesArgs']] = None,
             import_pipeline_name: Optional[pulumi.Input[str]] = None,
             location: Optional[pulumi.Input[str]] = None,
             options: Optional[pulumi.Input[Sequence[pulumi.Input[Union[str, 'PipelineOptions']]]]] = None,
        ...
        if import_pipeline_name is None and 'importPipelineName' in kwargs:
...
class ImportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            source = _utilities.configure(source, ImportPipelineSourcePropertiesArgs, True)
            if source is None and not opts.urn:
                raise TypeError("Missing required property 'source'")
            __props__.__dict__["source"] = source
            trigger = _utilities.configure(trigger, PipelineTriggerPropertiesArgs, True)
