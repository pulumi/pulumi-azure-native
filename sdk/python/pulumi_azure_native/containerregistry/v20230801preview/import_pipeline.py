...
class ImportPipelineArgs:
    ...
    def _configure(
        ...
        if 'importPipelineName' in kwargs:
            import_pipeline_name = kwargs['importPipelineName']
        ...
        if import_pipeline_name is not None:
            _setter("import_pipeline_name", import_pipeline_name)
...
class ImportPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ImportPipelineArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if source is not None and not isinstance(source, ImportPipelineSourcePropertiesArgs):
                source = source or {}
                def _setter(key, value):
                    source[key] = value
                ImportPipelineSourcePropertiesArgs._configure(_setter, **source)
            if source is None and not opts.urn:
                raise TypeError("Missing required property 'source'")
            __props__.__dict__["source"] = source
            if trigger is not None and not isinstance(trigger, PipelineTriggerPropertiesArgs):
                trigger = trigger or {}
                def _setter(key, value):
                    trigger[key] = value
                PipelineTriggerPropertiesArgs._configure(_setter, **trigger)
            __props__.__dict__["trigger"] = trigger
            __props__.__dict__["name"] = None
            __props__.__dict__["provisioning_state"] = None
            __props__.__dict__["system_data"] = None
            __props__.__dict__["type"] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20191201preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:ImportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:ImportPipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ImportPipeline, __self__).__init__(
            'azure-native:containerregistry/v20230801preview:ImportPipeline',
            resource_name,
            __props__,
            opts)
