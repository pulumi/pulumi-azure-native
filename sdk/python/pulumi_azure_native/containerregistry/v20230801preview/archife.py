...
class Archife(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20231101preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20241101preview:Archife")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Archife, __self__).__init__(
            'azure-native:containerregistry/v20230801preview:Archife',
            resource_name,
            __props__,
            opts)
