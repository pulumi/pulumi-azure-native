...
class Archife(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20231101preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20241101preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry:Archife")])
