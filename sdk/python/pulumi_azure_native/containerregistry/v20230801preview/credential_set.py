...
class CredentialSetArgs:
    ...
    def _configure(
        ...
        if 'authCredentials' in kwargs:
            auth_credentials = kwargs['authCredentials']
        if 'credentialSetName' in kwargs:
...
class CredentialSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:CredentialSet"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:CredentialSet"), pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:CredentialSet"), pulumi.Alias(type_="azure-native:containerregistry/v20230701:CredentialSet")])
