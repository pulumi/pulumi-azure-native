...
def list_task_run_details_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['taskRunName'] = task_run_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20190601preview:listTaskRunDetails', __args__, opts=opts, typ=ListTaskRunDetailsResult)
