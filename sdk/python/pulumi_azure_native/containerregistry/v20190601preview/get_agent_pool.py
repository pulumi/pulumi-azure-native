...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20190601preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20190601preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
    return __ret__.apply(lambda __response__: GetAgentPoolResult(
        ...
        virtual_network_subnet_resource_id=pulumi.get(__response__, 'virtual_network_subnet_resource_id')))
