...
class ArchifeArgs:
    def __init__(__self__, *,
                 ...
                 published_version: Optional[pulumi.Input[builtins.str]] = None,
                 repository_endpoint_prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Archife resource.
        :param pulumi.Input[builtins.str] package_type: The type of the package resource.
        :param pulumi.Input[builtins.str] registry_name: The name of the container registry.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] archive_name: The name of the archive resource.
        :param pulumi.Input['ArchivePackageSourcePropertiesArgs'] package_source: The package source of the archive.
        :param pulumi.Input[builtins.str] published_version: The published version of the archive.
        """
    ...
    def published_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def published_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "published_version", value)

    @property
    @pulumi.getter(name="repositoryEndpointPrefix")
    def repository_endpoint_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "repository_endpoint_prefix")

    @repository_endpoint_prefix.setter
    def repository_endpoint_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Archife(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20230801preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20231101preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20241101preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20250301preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20250501preview:Archife"), pulumi.Alias(type_="azure-native:containerregistry/v20250601preview:Archife")])
    ...
    @property
    @pulumi.getter(name="publishedVersion")
    def published_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The published version of the archive.
        """
        return pulumi.get(self, "published_version")
    ...
    def repository_endpoint(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "repository_endpoint")

    @property
    @pulumi.getter(name="repositoryEndpointPrefix")
    def repository_endpoint_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "repository_endpoint_prefix")
