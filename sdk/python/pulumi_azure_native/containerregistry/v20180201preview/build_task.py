...
class BuildTask(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry/v20180201preview:BuildTask"), pulumi.Alias(type_="azure-native:containerregistry:BuildTask"), pulumi.Alias(type_="azure-nextgen:containerregistry:BuildTask"), pulumi.Alias(type_="azure-native:containerregistry/latest:BuildTask"), pulumi.Alias(type_="azure-nextgen:containerregistry/latest:BuildTask"), pulumi.Alias(type_="azure-native:containerregistry/v20180901:BuildTask"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20180901:BuildTask"), pulumi.Alias(type_="azure-native:containerregistry/v20190401:BuildTask"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20190401:BuildTask"), pulumi.Alias(type_="azure-native:containerregistry/v20190601preview:BuildTask"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20190601preview:BuildTask")])
