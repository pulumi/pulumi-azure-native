...
def get_build_task(build_task_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_build_task is deprecated: Version 2018-02-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
...
def get_build_task_output(build_task_name: Optional[pulumi.Input[str]] = None,
