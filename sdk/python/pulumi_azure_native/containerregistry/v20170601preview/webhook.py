...
warnings.warn("""azure-native:containerregistry/v20170601preview:Webhook is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Webhook to guarantee forwards compatibility.""", DeprecationWarning)
