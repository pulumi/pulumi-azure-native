...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/v20191201preview:ExportPipeline":
                return ExportPipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:ImportPipeline":
                return ImportPipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:PipelineRun":
                return PipelineRun(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20191201preview:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/v20191201preview", _module_instance)
