...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:containerregistry:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20201101preview:PrivateEndpointConnection")])
