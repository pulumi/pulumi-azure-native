...
warnings.warn("""azure-native:containerregistry/v20191201preview:PipelineRun is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.""", DeprecationWarning)
...
class PipelineRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PipelineRun is deprecated: azure-native:containerregistry/v20191201preview:PipelineRun is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:PipelineRun to guarantee forwards compatibility.""")
