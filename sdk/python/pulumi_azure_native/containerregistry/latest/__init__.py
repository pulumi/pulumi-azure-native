...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/latest:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/latest:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/latest:Task":
                return Task(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/latest:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/latest", _module_instance)
