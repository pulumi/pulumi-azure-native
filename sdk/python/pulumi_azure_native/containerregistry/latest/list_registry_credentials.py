...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:listRegistryCredentials'.""", DeprecationWarning)
...
def list_registry_credentials(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:listRegistryCredentials', __args__, opts=opts, typ=ListRegistryCredentialsResult).value
