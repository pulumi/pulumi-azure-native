...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:listRunLogSasUrl'.""", DeprecationWarning)
...
def list_run_log_sas_url(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:listRunLogSasUrl', __args__, opts=opts, typ=ListRunLogSasUrlResult).value
