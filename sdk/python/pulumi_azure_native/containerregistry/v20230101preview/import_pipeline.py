...
class ImportPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        import_pipeline = azure_native.containerregistry.v20230101preview.ImportPipeline("importPipeline",
            identity=azure_native.containerregistry.v20230101preview.IdentityPropertiesResponseArgs(
                type=azure_native.containerregistry/v20230101preview.ResourceIdentityType.USER_ASSIGNED,
                user_assigned_identities={
                    "/subscriptions/f9d7ebed-adbd-4cb4-b973-aaf82c136138/resourcegroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity2": azure_native.containerregistry.v20230101preview.UserIdentityPropertiesArgs(),
                },
            ),
            ...
            source=azure_native.containerregistry.v20230101preview.ImportPipelineSourcePropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        super(ImportPipeline, __self__).__init__(
            'azure-native:containerregistry/v20230101preview:ImportPipeline',
            resource_name,
            __props__,
            opts)
