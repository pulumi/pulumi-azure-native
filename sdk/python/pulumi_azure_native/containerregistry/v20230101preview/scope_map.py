...
class ScopeMapArgs:
    ...
    def _configure(
        ...
        if scope_map_name is None and 'scopeMapName' in kwargs:
            scope_map_name = kwargs['scopeMapName']
...
class ScopeMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20190501preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20221201:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20230701:ScopeMap"), pulumi.Alias(type_="azure-native:containerregistry/v20230801preview:ScopeMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScopeMap, __self__).__init__(
            'azure-native:containerregistry/v20230101preview:ScopeMap',
            resource_name,
            __props__,
            opts)
