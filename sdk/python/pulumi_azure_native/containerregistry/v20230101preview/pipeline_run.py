...
class PipelineRun(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        pipeline_run = azure_native.containerregistry.v20230101preview.PipelineRun("pipelineRun",
            pipeline_run_name="myPipelineRun",
            registry_name="myRegistry",
            request=azure_native.containerregistry.v20230101preview.PipelineRunRequestResponseArgs(
                artifacts=[
                ...
                target=azure_native.containerregistry.v20230101preview.PipelineRunTargetPropertiesArgs(
                    name="myblob.tar.gz",
        ...
        pipeline_run = azure_native.containerregistry.v20230101preview.PipelineRun("pipelineRun",
            ...
            request=azure_native.containerregistry.v20230101preview.PipelineRunRequestResponseArgs(
                ...
                source=azure_native.containerregistry.v20230101preview.PipelineRunSourcePropertiesArgs(
                    name="myblob.tar.gz",
                    type="AzureStorageBlob",
                ),
            ),
