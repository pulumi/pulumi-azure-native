...
class Token(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if credentials is not None and not isinstance(credentials, TokenCredentialsPropertiesArgs):
                credentials = credentials or {}
                def _setter(key, value):
                    credentials[key] = value
                TokenCredentialsPropertiesArgs._configure(_setter, **credentials)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20190501preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20221201:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20230701:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20230801preview:Token")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Token, __self__).__init__(
            'azure-native:containerregistry/v20230601preview:Token',
            resource_name,
            __props__,
            opts)
