...
class ArchiveVersionArgs:
    def __init__(__self__, *,
                 archive_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] archive_version_name: The name of the archive version resource.
        """
    ...
    def archive_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @archive_name.setter
    def archive_name(self, value: pulumi.Input[builtins.str]):
    ...
    def archive_version_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def archive_version_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ArchiveVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20230601preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20230801preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20231101preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20241101preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20250301preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20250501preview:ArchiveVersion"), pulumi.Alias(type_="azure-native:containerregistry/v20250601preview:ArchiveVersion")])
    ...
    def archive_version_error_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
