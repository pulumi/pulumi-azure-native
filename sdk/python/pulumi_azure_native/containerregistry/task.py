...
class TaskArgs:
    def __init__(__self__, *,
                 ...
                 is_system_task: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 log_template: Optional[pulumi.Input[builtins.str]] = None,
                 platform: Optional[pulumi.Input['PlatformPropertiesArgs']] = None,
                 status: Optional[pulumi.Input[Union[builtins.str, 'TaskStatus']]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_pool_name: The dedicated agent pool for the task.
        ...
        :param pulumi.Input[builtins.bool] is_system_task: The value of this property indicates whether the task resource is system task or not.
        ...
        :param pulumi.Input[builtins.str] log_template: The template that describes the repository and tag information for run log artifact.
        :param pulumi.Input['PlatformPropertiesArgs'] platform: The platform properties against which the run has to happen.
        :param pulumi.Input[Union[builtins.str, 'TaskStatus']] status: The current status of task.
        ...
        :param pulumi.Input[builtins.str] task_name: The name of the container registry task.
        :param pulumi.Input[builtins.int] timeout: Run timeout in seconds.
    ...
    def is_system_task(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_system_task(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def log_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @log_template.setter
    def log_template(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input[Union[builtins.str, 'TaskStatus']]]:
        """
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[builtins.str, 'TaskStatus']]]):
...
class Task(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isSystemTask")
    def is_system_task(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The value of this property indicates whether the task resource is system task or not.
        """
        return pulumi.get(self, "is_system_task")
    ...
    @property
    @pulumi.getter(name="logTemplate")
    def log_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The template that describes the repository and tag information for run log artifact.
        """
        return pulumi.get(self, "log_template")
