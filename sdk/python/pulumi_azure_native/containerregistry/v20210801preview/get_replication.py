...
def get_replication(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication is deprecated: azure-native:containerregistry/v20210801preview:Replication is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['registryName'] = registry_name
    __args__['replicationName'] = replication_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20210801preview:getReplication', __args__, opts=opts, typ=GetReplicationResult).value
