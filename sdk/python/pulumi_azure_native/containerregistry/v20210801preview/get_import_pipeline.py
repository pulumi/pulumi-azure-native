...
def get_import_pipeline(import_pipeline_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_import_pipeline is deprecated: azure-native:containerregistry/v20210801preview:ImportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['importPipelineName'] = import_pipeline_name
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20210801preview:getImportPipeline', __args__, opts=opts, typ=GetImportPipelineResult).value
