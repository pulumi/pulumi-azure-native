...
def get_connected_registry(connected_registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connected_registry is deprecated: azure-native:containerregistry/v20210801preview:ConnectedRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ConnectedRegistry to guarantee forwards compatibility.""")
    __args__ = dict()
