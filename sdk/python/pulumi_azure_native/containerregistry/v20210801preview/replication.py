...
warnings.warn("""azure-native:containerregistry/v20210801preview:Replication is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.""", DeprecationWarning)
