...
class GetTaskResult:
    ...
    def is_system_task(self) -> Optional[builtins.bool]:
        """
...
def get_task(registry_name: Optional[builtins.str] = None,
    ...
    :param builtins.str task_name: The name of the container registry task.
    """
    __args__ = dict()
...
def get_task_output(registry_name: Optional[pulumi.Input[builtins.str]] = None,
