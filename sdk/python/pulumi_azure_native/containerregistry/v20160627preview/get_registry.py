...
warnings.warn("""Version 2016-06-27-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_registry(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry is deprecated: Version 2016-06-27-preview will be removed in v2 of the provider.""")
    __args__ = dict()
