...
def get_webhook(registry_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry:getWebhook', __args__, opts=opts, typ=GetWebhookResult).value
...
def get_webhook_output(registry_name: Optional[pulumi.Input[_builtins.str]] = None,
