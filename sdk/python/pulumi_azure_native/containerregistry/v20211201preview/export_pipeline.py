...
warnings.warn("""azure-native:containerregistry/v20211201preview:ExportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target: Optional[pulumi.Input[pulumi.InputType['ExportPipelineTargetPropertiesArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""ExportPipeline is deprecated: azure-native:containerregistry/v20211201preview:ExportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.""")
