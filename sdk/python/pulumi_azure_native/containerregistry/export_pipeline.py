...
class ExportPipelineArgs:
    ...
    def _configure(
        ...
        if 'exportPipelineName' in kwargs:
...
class ExportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target is not None and not isinstance(target, ExportPipelineTargetPropertiesArgs):
                target = target or {}
                def _setter(key, value):
                    target[key] = value
                ExportPipelineTargetPropertiesArgs._configure(_setter, **target)
