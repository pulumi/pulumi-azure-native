...
class ExportPipelineArgs:
    def __init__(__self__, *,
                 ...
                 export_pipeline_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] export_pipeline_name: The name of the export pipeline.
        :param pulumi.Input['IdentityPropertiesArgs'] identity: The identity of the export pipeline.
        :param pulumi.Input[builtins.str] location: The location of the export pipeline.
    ...
    def export_pipeline_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def export_pipeline_name(self, value: Optional[pulumi.Input[builtins.str]]):
