...
warnings.warn("""azure-native:containerregistry/v20190501preview:Token is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Token to guarantee forwards compatibility.""", DeprecationWarning)
