...
if not MYPY:
    class ActiveDirectoryObjectArgsDict(TypedDict):
        """
    ...
    ActiveDirectoryObjectArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class TokenCredentialsPropertiesArgsDict(TypedDict):
        ...
        """
        active_directory_object: NotRequired[pulumi.Input['ActiveDirectoryObjectArgsDict']]
        """
        The Active Directory Object that will be used for authenticating the token of a container registry.
        """
