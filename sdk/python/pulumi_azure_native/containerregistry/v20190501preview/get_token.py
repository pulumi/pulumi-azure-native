...
def get_token(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_token is deprecated: azure-native:containerregistry/v20190501preview:Token is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Token to guarantee forwards compatibility.""")
    __args__ = dict()
