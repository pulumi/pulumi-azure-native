...
warnings.warn("""azure-native:containerregistry/v20221201:Webhook is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Webhook to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_webhook(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_webhook is deprecated: azure-native:containerregistry/v20221201:Webhook is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Webhook to guarantee forwards compatibility.""")
    __args__ = dict()
