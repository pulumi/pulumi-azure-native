...
def get_token(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_token is deprecated: azure-native:containerregistry/v20221201:Token is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Token to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['tokenName'] = token_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20221201:getToken', __args__, opts=opts, typ=GetTokenResult).value
