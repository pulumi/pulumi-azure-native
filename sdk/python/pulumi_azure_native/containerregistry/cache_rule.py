...
class CacheRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Azure REST API version: 2023-11-01-preview. Prior API version in Azure Native 2.x: 2023-01-01-preview.

        Other available API versions: 2023-01-01-preview, 2023-06-01-preview, 2023-07-01, 2023-08-01-preview, 2024-11-01-preview.
