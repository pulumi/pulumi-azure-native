...
class CacheRuleArgs:
    ...
    def _configure(
        ...
        if cache_rule_name is None and 'cacheRuleName' in kwargs:
            cache_rule_name = kwargs['cacheRuleName']
        if credential_set_resource_id is None and 'credentialSetResourceId' in kwargs:
            credential_set_resource_id = kwargs['credentialSetResourceId']
