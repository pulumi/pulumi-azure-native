...
class ExportPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        export_pipeline = azure_native.containerregistry.v20201101preview.ExportPipeline("exportPipeline",
            export_pipeline_name="myExportPipeline",
            identity=azure_native.containerregistry.v20201101preview.IdentityPropertiesArgs(
                type=azure_native.containerregistry/v20201101preview.ResourceIdentityType.SYSTEM_ASSIGNED,
            ),
            location="westus",
            options=["OverwriteBlobs"],
            registry_name="myRegistry",
            resource_group_name="myResourceGroup",
            target=azure_native.containerregistry.v20201101preview.ExportPipelineTargetPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20191201preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:ExportPipeline")])
