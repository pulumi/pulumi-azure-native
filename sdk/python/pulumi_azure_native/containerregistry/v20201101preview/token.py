...
class Token(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:Token")])
