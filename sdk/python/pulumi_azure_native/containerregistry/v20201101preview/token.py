...
class Token(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        token = azure_native.containerregistry.v20201101preview.Token("token",
            credentials=azure_native.containerregistry.v20201101preview.TokenCredentialsPropertiesResponseArgs(
                certificates=[azure_native.containerregistry.v20201101preview.TokenCertificateArgs(
        ...
        ```sh
        $ pulumi import azure-native:containerregistry/v20201101preview:Token myToken /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ContainerRegistry/registries/myRegistry/tokens/myToken 
        ```
