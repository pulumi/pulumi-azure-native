...
def get_export_pipeline(export_pipeline_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_export_pipeline is deprecated: azure-native:containerregistry/v20201101preview:ExportPipeline is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ExportPipeline to guarantee forwards compatibility.""")
    __args__ = dict()
