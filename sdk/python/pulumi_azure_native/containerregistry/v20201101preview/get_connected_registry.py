...
def get_connected_registry(connected_registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connected_registry is deprecated: azure-native:containerregistry/v20201101preview:ConnectedRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ConnectedRegistry to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['connectedRegistryName'] = connected_registry_name
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20201101preview:getConnectedRegistry', __args__, opts=opts, typ=GetConnectedRegistryResult).value
