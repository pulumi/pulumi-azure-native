...
def get_connected_registry_output(connected_registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20201101preview:getConnectedRegistry', __args__, opts=opts, typ=GetConnectedRegistryResult)
