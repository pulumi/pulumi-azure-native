...
warnings.warn("""azure-native:containerregistry/v20201101preview:ScopeMap is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_scope_map(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_scope_map is deprecated: azure-native:containerregistry/v20201101preview:ScopeMap is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['scopeMapName'] = scope_map_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20201101preview:getScopeMap', __args__, opts=opts, typ=GetScopeMapResult).value
