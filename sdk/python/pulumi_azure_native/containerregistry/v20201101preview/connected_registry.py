...
class ConnectedRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connected_registry = azure_native.containerregistry.v20201101preview.ConnectedRegistry("connectedRegistry",
            ...
            mode="Registry",
            parent=azure_native.containerregistry.v20201101preview.ParentPropertiesResponseArgs(
                sync_properties=azure_native.containerregistry.v20201101preview.SyncPropertiesArgs(
                    message_ttl="P2D",
                    schedule="0 9 * * *",
                    sync_window="PT3H",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:ConnectedRegistry"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:ConnectedRegistry"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:ConnectedRegistry"), pulumi.Alias(type_="azure-native:containerregistry/v20220201preview:ConnectedRegistry"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:ConnectedRegistry")])
