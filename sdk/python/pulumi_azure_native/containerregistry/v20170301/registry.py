...
class Registry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if storage_account is not None and not isinstance(storage_account, StorageAccountParametersArgs):
