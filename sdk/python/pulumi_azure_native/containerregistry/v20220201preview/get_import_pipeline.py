...
warnings.warn("""azure-native:containerregistry/v20220201preview:ImportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_import_pipeline(import_pipeline_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_import_pipeline is deprecated: azure-native:containerregistry/v20220201preview:ImportPipeline is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ImportPipeline to guarantee forwards compatibility.""")
    __args__ = dict()
