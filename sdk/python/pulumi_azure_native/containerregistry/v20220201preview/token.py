...
class Token(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 token_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Token is deprecated: azure-native:containerregistry/v20220201preview:Token is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Token to guarantee forwards compatibility.""")
