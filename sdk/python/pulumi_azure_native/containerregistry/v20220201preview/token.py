...
class Token(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20190501preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20210601preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20210801preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20211201preview:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20221201:Token"), pulumi.Alias(type_="azure-native:containerregistry/v20230101preview:Token")])
