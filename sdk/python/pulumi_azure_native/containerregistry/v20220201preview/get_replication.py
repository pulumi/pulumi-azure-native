...
warnings.warn("""azure-native:containerregistry/v20220201preview:Replication is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replication(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication is deprecated: azure-native:containerregistry/v20220201preview:Replication is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Replication to guarantee forwards compatibility.""")
    __args__ = dict()
