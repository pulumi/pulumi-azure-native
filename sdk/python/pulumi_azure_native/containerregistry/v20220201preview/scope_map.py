...
class ScopeMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope_map_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ScopeMap is deprecated: azure-native:containerregistry/v20220201preview:ScopeMap is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:ScopeMap to guarantee forwards compatibility.""")
