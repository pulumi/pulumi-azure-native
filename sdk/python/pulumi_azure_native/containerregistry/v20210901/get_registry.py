...
warnings.warn("""azure-native:containerregistry/v20210901:Registry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registry(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry is deprecated: azure-native:containerregistry/v20210901:Registry is being removed in the next major version of this provider. Upgrade to at least azure-native:containerregistry/v20230101preview:Registry to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20210901:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
