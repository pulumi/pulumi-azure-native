...
class Task(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(agent_configuration, AgentPropertiesArgs):
            ...
            if not isinstance(credentials, CredentialsArgs):
            ...
            if not isinstance(step, TaskStepPropertiesArgs):
                step = step or {}
                def _setter(key, value):
                    step[key] = value
            ...
            if not isinstance(trigger, TriggerPropertiesArgs):
                trigger = trigger or {}
                def _setter(key, value):
                    trigger[key] = value
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry:Task"), pulumi.Alias(type_="azure-native:containerregistry/v20180201preview:Task"), pulumi.Alias(type_="azure-native:containerregistry/v20190401:Task"), pulumi.Alias(type_="azure-native:containerregistry/v20190601preview:Task")])
