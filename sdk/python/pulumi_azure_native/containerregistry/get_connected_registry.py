...
def get_connected_registry(connected_registry_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connected_registry_name: The name of the connected registry.
...
def get_connected_registry_output(connected_registry_name: pulumi.Input[Optional[_builtins.str]] = None,
