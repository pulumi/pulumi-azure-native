...
class GetConnectedRegistryResult:
    ...
    def client_token_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def notifications_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_connected_registry(connected_registry_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connected_registry_name: The name of the connected registry.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry:getConnectedRegistry', __args__, opts=opts, typ=GetConnectedRegistryResult).value
...
def get_connected_registry_output(connected_registry_name: Optional[pulumi.Input[builtins.str]] = None,
