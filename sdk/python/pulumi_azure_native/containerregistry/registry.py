...
class RegistryArgs:
    def __init__(__self__, *,
                 ...
                 admin_user_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 network_rule_bypass_options: Optional[pulumi.Input[Union[builtins.str, 'NetworkRuleBypassOptions']]] = None,
        ...
        :param pulumi.Input[builtins.bool] admin_user_enabled: The value that indicates whether the admin user is enabled.
        :param pulumi.Input[builtins.bool] anonymous_pull_enabled: Enables registry-wide pull from unauthenticated clients.
        :param pulumi.Input[builtins.bool] data_endpoint_enabled: Enable a single data endpoint per region for serving data.
        ...
        :param pulumi.Input[Union[builtins.str, 'NetworkRuleBypassOptions']] network_rule_bypass_options: Whether to allow trusted Azure services to access a network restricted registry.
        ...
        :param pulumi.Input[Union[builtins.str, 'PublicNetworkAccess']] public_network_access: Whether or not public network access is allowed for the container registry.
        ...
        :param pulumi.Input[Union[builtins.str, 'ZoneRedundancy']] zone_redundancy: Whether or not zone redundancy is enabled for this container registry
        """
    ...
    def admin_user_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def admin_user_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def network_rule_bypass_options(self) -> Optional[pulumi.Input[Union[builtins.str, 'NetworkRuleBypassOptions']]]:
        """
    ...
    def network_rule_bypass_options(self, value: Optional[pulumi.Input[Union[builtins.str, 'NetworkRuleBypassOptions']]]):
...
class Registry(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="adminUserEnabled")
    def admin_user_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The value that indicates whether the admin user is enabled.
        """
        return pulumi.get(self, "admin_user_enabled")
    ...
    def data_endpoint_host_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="networkRuleBypassOptions")
    def network_rule_bypass_options(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to allow trusted Azure services to access a network restricted registry.
        """
        return pulumi.get(self, "network_rule_bypass_options")
