...
class RegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] anonymous_pull_enabled: Enables registry-wide pull from unauthenticated clients.
        :param pulumi.Input[_builtins.bool] data_endpoint_enabled: Enable a single data endpoint per region for serving data.
        ...
        :param pulumi.Input[Union[_builtins.str, 'NetworkRuleBypassOptions']] network_rule_bypass_options: Whether to allow trusted Azure services to access a network restricted registry.
