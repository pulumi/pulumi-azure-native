...
def get_pipeline_run(pipeline_run_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20231101preview:getPipelineRun', __args__, opts=opts, typ=GetPipelineRunResult).value
...
def get_pipeline_run_output(pipeline_run_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20231101preview:getPipelineRun', __args__, opts=opts, typ=GetPipelineRunResult)
