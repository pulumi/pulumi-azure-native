...
def get_connected_registry(connected_registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20231101preview:getConnectedRegistry', __args__, opts=opts, typ=GetConnectedRegistryResult).value
...
def get_connected_registry_output(connected_registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20231101preview:getConnectedRegistry', __args__, opts=opts, typ=GetConnectedRegistryResult)
