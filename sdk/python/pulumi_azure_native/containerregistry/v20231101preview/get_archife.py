...
def get_archife(archive_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20231101preview:getArchife', __args__, opts=opts, typ=GetArchifeResult).value
...
def get_archife_output(archive_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20231101preview:getArchife', __args__, opts=opts, typ=GetArchifeResult)
