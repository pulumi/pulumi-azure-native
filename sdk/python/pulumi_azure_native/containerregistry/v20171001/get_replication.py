...
def get_replication(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20171001:getReplication', __args__, opts=opts, typ=GetReplicationResult).value
...
def get_replication_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20171001:getReplication', __args__, opts=opts, typ=GetReplicationResult)
