...
class Webhook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 webhook_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Webhook is deprecated: azure-native:containerregistry/v20171001:Webhook is being removed in the next major version of this provider. Please upgrade to azure-native:containerregistry/v20230101preview:Webhook to guarantee forwards compatibility.""")
