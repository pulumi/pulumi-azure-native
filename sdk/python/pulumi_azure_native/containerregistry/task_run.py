...
class TaskRunArgs:
    def __init__(__self__, *,
                 ...
                 task_run_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] force_update_tag: How the run should be forced to rerun even if the run request configuration has not changed
        ...
        :param pulumi.Input[builtins.str] task_run_name: The name of the task run.
        """
    ...
    def task_run_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def task_run_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TaskRun(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] registry_name: The name of the container registry.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group to which the container registry belongs.
        :param pulumi.Input[Union[Union['DockerBuildRequestArgs', 'DockerBuildRequestArgsDict'], Union['EncodedTaskRunRequestArgs', 'EncodedTaskRunRequestArgsDict'], Union['FileTaskRunRequestArgs', 'FileTaskRunRequestArgsDict'], Union['TaskRunRequestArgs', 'TaskRunRequestArgsDict']]] run_request: The request (parameters) for the run
        :param pulumi.Input[builtins.str] task_run_name: The name of the task run.
        """
        ...
    @overload
