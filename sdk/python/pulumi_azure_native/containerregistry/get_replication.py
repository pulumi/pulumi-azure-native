...
def get_replication(registry_name: Optional[_builtins.str] = None,
                    replication_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str replication_name: The name of the replication.
