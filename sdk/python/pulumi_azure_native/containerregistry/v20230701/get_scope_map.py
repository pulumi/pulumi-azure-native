...
def get_scope_map(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20230701:getScopeMap', __args__, opts=opts, typ=GetScopeMapResult).value
...
def get_scope_map_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scopeMapName'] = scope_map_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20230701:getScopeMap', __args__, opts=opts, typ=GetScopeMapResult)
