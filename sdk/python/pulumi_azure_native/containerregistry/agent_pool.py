...
class AgentPool(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerregistry/v20190601preview:AgentPool"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20190601preview:AgentPool")])
