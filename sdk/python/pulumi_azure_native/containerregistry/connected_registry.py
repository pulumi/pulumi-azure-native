...
class ConnectedRegistryArgs:
    ...
    def _configure(
        ...
        if 'connectedRegistryName' in kwargs:
            connected_registry_name = kwargs['connectedRegistryName']
        if 'notificationsList' in kwargs:
...
class ConnectedRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if logging is not None and not isinstance(logging, LoggingPropertiesArgs):
                logging = logging or {}
                def _setter(key, value):
                    logging[key] = value
            ...
            if parent is not None and not isinstance(parent, ParentPropertiesArgs):
                parent = parent or {}
                def _setter(key, value):
                    parent[key] = value
