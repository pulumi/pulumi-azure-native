...
def get_pipeline_run(pipeline_run_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getPipelineRun', __args__, opts=opts, typ=GetPipelineRunResult).value
...
def get_pipeline_run_output(pipeline_run_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getPipelineRun', __args__, opts=opts, typ=GetPipelineRunResult)
