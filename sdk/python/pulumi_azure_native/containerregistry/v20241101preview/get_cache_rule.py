...
def get_cache_rule(cache_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getCacheRule', __args__, opts=opts, typ=GetCacheRuleResult).value
...
def get_cache_rule_output(cache_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getCacheRule', __args__, opts=opts, typ=GetCacheRuleResult)
