...
def get_scope_map(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getScopeMap', __args__, opts=opts, typ=GetScopeMapResult).value
...
def get_scope_map_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getScopeMap', __args__, opts=opts, typ=GetScopeMapResult)
