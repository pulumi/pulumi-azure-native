...
def get_import_pipeline(import_pipeline_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getImportPipeline', __args__, opts=opts, typ=GetImportPipelineResult).value
...
def get_import_pipeline_output(import_pipeline_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getImportPipeline', __args__, opts=opts, typ=GetImportPipelineResult)
