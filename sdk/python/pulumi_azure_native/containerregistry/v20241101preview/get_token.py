...
def get_token(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getToken', __args__, opts=opts, typ=GetTokenResult).value
...
def get_token_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getToken', __args__, opts=opts, typ=GetTokenResult)
