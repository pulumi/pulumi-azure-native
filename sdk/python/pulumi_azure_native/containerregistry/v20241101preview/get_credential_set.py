...
def get_credential_set(credential_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getCredentialSet', __args__, opts=opts, typ=GetCredentialSetResult).value
...
def get_credential_set_output(credential_set_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getCredentialSet', __args__, opts=opts, typ=GetCredentialSetResult)
