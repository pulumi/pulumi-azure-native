...
def get_archive_version(archive_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20241101preview:getArchiveVersion', __args__, opts=opts, typ=GetArchiveVersionResult).value
...
def get_archive_version_output(archive_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerregistry/v20241101preview:getArchiveVersion', __args__, opts=opts, typ=GetArchiveVersionResult)
