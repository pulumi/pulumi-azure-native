...
def get_import_pipeline(import_pipeline_name: Optional[_builtins.str] = None,
...
def get_import_pipeline_output(import_pipeline_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
