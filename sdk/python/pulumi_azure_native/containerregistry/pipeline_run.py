...
class PipelineRunArgs:
    def __init__(__self__, *,
                 ...
                 pipeline_run_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] force_update_tag: How the pipeline run should be forced to recreate even if the pipeline run configuration has not changed.
        :param pulumi.Input[builtins.str] pipeline_run_name: The name of the pipeline run.
    ...
    def pipeline_run_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pipeline_run_name(self, value: Optional[pulumi.Input[builtins.str]]):
