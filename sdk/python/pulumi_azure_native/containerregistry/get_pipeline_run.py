...
def get_pipeline_run(pipeline_run_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pipeline_run_name: The name of the pipeline run.
...
def get_pipeline_run_output(pipeline_run_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
