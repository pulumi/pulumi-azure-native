...
class Build(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:Build"), pulumi.Alias(type_="azure-native:app/v20230801preview:Build"), pulumi.Alias(type_="azure-native:app/v20231102preview:Build"), pulumi.Alias(type_="azure-native:app/v20240202preview:Build")])
