...
class GithubActionConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str dockerfile_path: Dockerfile path
...
class MetricsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool include_keda: Boolean indicating if including keda metrics
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
    ...
    def include_keda(self) -> Optional[bool]:
        """
...
class ScaleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App scaling configurations.
        :param int cooldown_period: Optional. KEDA Cooldown Period. Defaults to 300 seconds if not set.
        ...
        :param int polling_interval: Optional. KEDA Polling Interval. Defaults to 30 seconds if not set.
...
class TracesConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool include_dapr: Boolean indicating if including dapr traces
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
    ...
    def include_dapr(self) -> Optional[bool]:
        """
...
class WorkloadProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool enable_fips: Whether to use a FIPS-enabled OS. Supported only for dedicated workload profiles.
