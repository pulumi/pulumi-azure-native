...
def get_container_app_auth_token_output(container_app_name: Optional[pulumi.Input[str]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetContainerAppAuthTokenResult]:
    """
    Container App Auth Token.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20240802preview:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult)
    return __ret__.apply(lambda __response__: GetContainerAppAuthTokenResult(
