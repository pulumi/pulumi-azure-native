...
class DaprSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:DaprSubscription"), pulumi.Alias(type_="azure-native:app/v20230801preview:DaprSubscription"), pulumi.Alias(type_="azure-native:app/v20231102preview:DaprSubscription"), pulumi.Alias(type_="azure-native:app/v20240202preview:DaprSubscription"), pulumi.Alias(type_="azure-native:app/v20241002preview:DaprSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DaprSubscription, __self__).__init__(
            'azure-native:app/v20240802preview:DaprSubscription',
            resource_name,
            __props__,
            opts)
