...
class AppResiliency(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:AppResiliency"), pulumi.Alias(type_="azure-native:app/v20230801preview:AppResiliency"), pulumi.Alias(type_="azure-native:app/v20231102preview:AppResiliency"), pulumi.Alias(type_="azure-native:app/v20240202preview:AppResiliency")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AppResiliency, __self__).__init__(
            'azure-native:app/v20240802preview:AppResiliency',
            resource_name,
            __props__,
            opts)
