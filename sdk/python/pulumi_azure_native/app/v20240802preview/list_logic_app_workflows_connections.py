...
def list_logic_app_workflows_connections(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20240802preview:listLogicAppWorkflowsConnections', __args__, opts=opts, typ=ListLogicAppWorkflowsConnectionsResult).value
