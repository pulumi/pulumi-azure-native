...
def get_connected_environments_dapr_component(component_name: Optional[_builtins.str] = None,
                                              connected_environment_name: Optional[_builtins.str] = None,
...
def get_connected_environments_dapr_component_output(component_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:getConnectedEnvironmentsDaprComponent', __args__, opts=opts, typ=GetConnectedEnvironmentsDaprComponentResult)
