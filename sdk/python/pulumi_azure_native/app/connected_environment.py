...
class ConnectedEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connected_environment_name: Name of the connectedEnvironment.
        ...
        :param pulumi.Input[builtins.str] static_ip: Static IP of the connectedEnvironment
    ...
    def connected_environment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connected_environment_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dapr_ai_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dapr_ai_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectedEnvironment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="daprAIConnectionString")
    def dapr_ai_connection_string(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Insights connection string used by Dapr to export Service to Service communication telemetry
        """
        return pulumi.get(self, "dapr_ai_connection_string")
