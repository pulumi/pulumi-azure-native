...
class BlobStorageTokenStoreResponse(dict):
    ...
    def __init__(__self__, *,
                 sas_url_setting_name: _builtins.str):
        """
        The configuration settings of the storage of the tokens if blob storage is used.
        :param _builtins.str sas_url_setting_name: The name of the app secrets containing the SAS URL of the blob storage containing the tokens.
        """
        pulumi.set(__self__, "sas_url_setting_name", sas_url_setting_name)

    @_builtins.property
    @pulumi.getter(name="sasUrlSettingName")
    def sas_url_setting_name(self) -> _builtins.str:
        """
...
class NfsAzureFilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        NFS Azure File Properties.
        :param _builtins.str access_mode: Access mode for storage
        :param _builtins.str server: Server for NFS azure file. Specify the Azure storage account server address.
...
class ScaleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App scaling configurations.
        :param _builtins.int cooldown_period: Optional. KEDA Cooldown Period in seconds. Defaults to 300 seconds if not set.
        ...
        :param _builtins.int polling_interval: Optional. KEDA Polling Interval in seconds. Defaults to 30 seconds if not set.
