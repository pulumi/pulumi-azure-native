...
class AppLogsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration of application logs
        :param builtins.str destination: Logs destination, can be 'log-analytics', 'azure-monitor' or 'none'
...
class BuildConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 base_os: Optional[builtins.str] = None,
        ...
        """
        Configuration of the build.
        :param builtins.str base_os: Base OS used to build and run the app.
        ...
        :param builtins.str platform: Platform to be used to build and run the app.
        :param builtins.str platform_version: Platform version to be used to build and run the app.
    ...
    def base_os(self) -> Optional[builtins.str]:
        """
...
class CertificateResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str public_key_hash: Public key hash.
        :param Sequence[builtins.str] subject_alternative_names: Subject alternative names the certificate applies to.
    ...
    def public_key_hash(self) -> builtins.str:
        """
        Public key hash.
        """
...
class CircuitBreakerPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Policy that defines circuit breaker conditions
        :param builtins.int consecutive_errors: Number of consecutive errors before the circuit breaker opens
        :param builtins.int interval_in_seconds: The time interval, in seconds, between endpoint checks. This can result in opening the circuit breaker if the check fails as well as closing the circuit breaker if the check succeeds. Defaults to 10s.
        :param builtins.int max_ejection_percent: Maximum percentage of hosts that will be ejected after failure threshold has been met
        """
...
class ConfigurationResponse(dict):
    ...
    def max_inactive_revisions(self) -> Optional[builtins.int]:
        """
...
class ContainerAppProbeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of probe.
        """
...
class ContainerAppSecretResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_vault_url: Azure Key Vault URL pointing to the secret referenced by the container app.
...
class ContainerRegistryResponse(dict):
    ...
    def __init__(__self__, *,
                 container_registry_server: builtins.str,
                 identity_resource_id: builtins.str):
        """
        Model representing a mapping from a container registry to the identity used to connect to it.
        :param builtins.str container_registry_server: Login server of the container registry.
        :param builtins.str identity_resource_id: Resource ID of the managed identity.
        """
    ...
    def container_registry_server(self) -> builtins.str:
        """
    ...
    def identity_resource_id(self) -> builtins.str:
        """
...
class ContainerRegistryWithCustomImageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container registry that the final image will be uploaded to.
        :param builtins.str server: Login server of the container registry that the final image should be uploaded to. Builder resource needs to have this container registry defined along with an identity to use to access it.
        :param builtins.str image: Full name that the final image should be uploaded as, including both image name and tag.
        """
...
class ContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App container definition
        :param Sequence[builtins.str] args: Container start command arguments.
...
class CorsPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cross-Origin-Resource-Sharing policy
        :param Sequence[builtins.str] allowed_origins: Specifies the content for the access-control-allow-origins header
        :param builtins.bool allow_credentials: Specifies whether the resource allows credentials
        :param Sequence[builtins.str] allowed_headers: Specifies the content for the access-control-allow-headers header
        :param Sequence[builtins.str] allowed_methods: Specifies the content for the access-control-allow-methods header
        :param Sequence[builtins.str] expose_headers: Specifies the content for the access-control-expose-headers header 
        :param builtins.int max_age: Specifies the content for the access-control-max-age header
        """
...
class CustomDomainConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration properties for apps environment custom domain
        :param builtins.str custom_domain_verification_id: Id used to verify domain name ownership
        :param builtins.str expiration_date: Certificate expiration date.
        :param builtins.str subject_name: Subject name of the certificate.
        :param builtins.str thumbprint: Certificate thumbprint.
    ...
    def certificate_value(self) -> Optional[builtins.str]:
        """
        PFX or PEM blob
        """
...
class CustomDomainResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str binding_type: Custom Domain binding type.
        :param builtins.str certificate_id: Resource Id of the Certificate to be bound to this hostname. Must exist in the Managed Environment.
        """
        pulumi.set(__self__, "name", name)
...
class CustomHostnameAnalysisResultResponseCustomDomainVerificationFailureInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Raw failure information if DNS verification fails.
        :param builtins.str code: Standardized string to programmatically identify the error.
        :param builtins.str message: Detailed error description and debugging information.
        :param builtins.str target: Detailed error description and debugging information.
...
class DaprComponentResiliencyPolicyCircuitBreakerPolicyConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Dapr Component Resiliency Policy Circuit Breaker Policy Configuration.
        :param builtins.int consecutive_errors: The number of consecutive errors before the circuit is opened.
        :param builtins.int interval_in_seconds: The optional interval in seconds after which the error count resets to 0. An interval of 0 will never reset. If not specified, the timeoutInSeconds value will be used.
        :param builtins.int timeout_in_seconds: The interval in seconds until a retry attempt is made after the circuit is opened.
        """
        if consecutive_errors is not None:
            pulumi.set(__self__, "consecutive_errors", consecutive_errors)
        if interval_in_seconds is not None:
...
class DaprComponentResiliencyPolicyHttpRetryBackOffConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 initial_delay_in_milliseconds: Optional[builtins.int] = None,
                 max_interval_in_milliseconds: Optional[builtins.int] = None):
        """
        Dapr Component Resiliency Policy HTTP Retry Backoff Configuration.
        :param builtins.int initial_delay_in_milliseconds: The optional initial delay in milliseconds before an operation is retried
        :param builtins.int max_interval_in_milliseconds: The optional maximum time interval in milliseconds between retry attempts
        """
    ...
    def initial_delay_in_milliseconds(self) -> Optional[builtins.int]:
        """
    ...
    def max_interval_in_milliseconds(self) -> Optional[builtins.int]:
        """
...
class DaprComponentResiliencyPolicyHttpRetryPolicyConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Dapr Component Resiliency Policy HTTP Retry Policy Configuration.
        :param builtins.int max_retries: The optional maximum number of retries
...
class DaprComponentResiliencyPolicyTimeoutPolicyConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 response_timeout_in_seconds: Optional[builtins.int] = None):
        """
        Dapr Component Resiliency Policy Timeout Policy Configuration.
        :param builtins.int response_timeout_in_seconds: The optional response timeout in seconds
        """
    ...
    def response_timeout_in_seconds(self) -> Optional[builtins.int]:
        """
...
class DaprConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration properties Dapr component
        :param builtins.str version: The version of Dapr
        """
...
class DaprMetadataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_ref: Name of the Dapr Component secret from which to pull the metadata property value.
...
class DaprSubscriptionRouteRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Dapr Pubsub Event Subscription Route Rule is used to specify the condition for sending a message to a specific path.
        :param builtins.str match: The optional CEL expression used to match the event. If the match is not specified, then the route is considered the default. The rules are tested in the order specified, so they should be define from most-to-least specific. The default route should appear last in the list.
        :param builtins.str path: The path for events that match this rule
        """
...
class DaprSubscriptionRoutesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Dapr PubSub Event Subscription Routes configuration.
        :param builtins.str default: The default path to deliver events that do not match any of the rules.
...
class DotNetComponentConfigurationPropertyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration properties for a .NET Component
        :param builtins.str property_name: The name of the property
        :param builtins.str value: The value of the property
        """
...
class EncryptionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 container_app_auth_encryption_secret_name: Optional[builtins.str] = None,
                 container_app_auth_signing_secret_name: Optional[builtins.str] = None):
        """
        The configuration settings of the secrets references of encryption key and signing key for ContainerApp Service Authentication/Authorization.
        :param builtins.str container_app_auth_encryption_secret_name: The secret name which is referenced for EncryptionKey.
        :param builtins.str container_app_auth_signing_secret_name: The secret name which is referenced for SigningKey.
        """
    ...
    def container_app_auth_encryption_secret_name(self) -> Optional[builtins.str]:
        """
    ...
    def container_app_auth_signing_secret_name(self) -> Optional[builtins.str]:
        """
...
class EnvironmentVarResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_ref: Name of the Container App secret from which to pull the environment variable value.
...
class GithubActionConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str runtime_stack: Runtime stack
        :param builtins.str runtime_version: Runtime version
        """
    ...
    def publish_type(self) -> Optional[builtins.str]:
        """
        Code or Image
        """
...
class HeaderMatchResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Conditions required to match a header
        :param builtins.str exact_match: Exact value of the header
        :param builtins.str header: Name of the header
        :param builtins.str prefix_match: Prefix value of the header
        :param builtins.str regex_match: Regex value of the header
        :param builtins.str suffix_match: Suffix value of the header
        """
...
class HttpConnectionPoolResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 http2_max_requests: Optional[builtins.int] = None):
        """
        Defines parameters for http connection pooling
        :param builtins.int http1_max_pending_requests: Maximum number of pending http1 requests allowed
        :param builtins.int http2_max_requests: Maximum number of http2 requests allowed
        """
    ...
    def http2_max_requests(self) -> Optional[builtins.int]:
        """
...
class HttpGetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Model representing a http get request.
        :param builtins.str url: URL to make HTTP GET request against.
        :param builtins.str file_name: Name of the file that the request should be saved to.
        :param Sequence[builtins.str] headers: List of headers to send with the request.
        """
...
class HttpRetryPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 http_status_codes: Optional[Sequence[builtins.int]] = None,
                 initial_delay_in_milliseconds: Optional[builtins.float] = None,
                 max_interval_in_milliseconds: Optional[builtins.float] = None,
                 max_retries: Optional[builtins.int] = None):
        """
        Policy that defines http request retry conditions
        :param Sequence[builtins.str] errors: Errors that can trigger a retry
        :param Sequence['HeaderMatchResponse'] headers: Headers that must be present for a request to be retried
        :param Sequence[builtins.int] http_status_codes: Additional http status codes that can trigger a retry
        :param builtins.float initial_delay_in_milliseconds: Initial delay, in milliseconds, before retrying a request
        :param builtins.float max_interval_in_milliseconds: Maximum interval, in milliseconds, between retries
        :param builtins.int max_retries: Maximum number of times a request will retry
        """
    ...
    def http_status_codes(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    @property
    @pulumi.getter(name="initialDelayInMilliseconds")
    def initial_delay_in_milliseconds(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter(name="maxIntervalInMilliseconds")
    def max_interval_in_milliseconds(self) -> Optional[builtins.float]:
        """
...
class HttpRouteActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Action to perform once matching of routes is done
        :param builtins.str prefix_rewrite: Rewrite prefix, default is no rewrites
        """
...
class HttpRouteConfigResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Http Route Config properties
        :param builtins.str fqdn: FQDN of the route resource.
        ...
        :param builtins.str provisioning_state: The provisioning state of the Http Route Config in cluster
...
class HttpRouteMatchResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: Optional[builtins.str] = None,
                 path_separated_prefix: Optional[builtins.str] = None,
                 prefix: Optional[builtins.str] = None):
        """
        Criteria to match on
        :param builtins.bool case_sensitive: path case sensitive, default is true
        :param builtins.str path: match on exact path
        :param builtins.str path_separated_prefix: match on all prefix's. Not exact
        :param builtins.str prefix: match on all prefix's. Not exact
        """
    ...
    def path_separated_prefix(self) -> Optional[builtins.str]:
        """
...
class HttpRouteProvisioningErrorsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        List of provisioning errors for a http route config object
        :param builtins.str message: Description or error message
        :param builtins.str timestamp: Timestamp error occured at
        """
        pulumi.set(__self__, "message", message)
...
class HttpRouteRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Http Route rule.
        :param builtins.str description: Description of rule. Optional.
...
class HttpRouteTargetResponse(dict):
    ...
    def __init__(__self__, *,
                 container_app: builtins.str,
                 label: Optional[builtins.str] = None,
                 revision: Optional[builtins.str] = None,
                 weight: Optional[builtins.int] = None):
        """
        Targets - Container App Names, Revision Names, Labels.
        :param builtins.str container_app: Container App Name to route requests to
        :param builtins.str label: Label/Revision to route requests to
        :param builtins.str revision: Revision to route requests to
        :param builtins.int weight: Weighted routing
        """
    ...
    def container_app(self) -> builtins.str:
        """
...
class IngressPortMappingResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exposed_port: Optional[builtins.int] = None):
        """
        Port mappings of container app ingress
        :param builtins.bool external: Specifies whether the app port is accessible outside of the environment
        :param builtins.int target_port: Specifies the port user's container listens on
        :param builtins.int exposed_port: Specifies the exposed port for the target port. If not specified, it defaults to target port
        """
    ...
    def exposed_port(self) -> Optional[builtins.int]:
        """
...
class IngressResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_certificate_mode: Optional[builtins.str] = None,
        ...
        :param builtins.int exposed_port: Exposed Port in containers for TCP traffic from ingress
        :param builtins.bool external: Bool indicating if app exposes an external http endpoint
    ...
    def client_certificate_mode(self) -> Optional[builtins.str]:
        """
...
class IngressResponseStickySessions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Sticky Sessions for Single Revision Mode
        :param builtins.str affinity: Sticky Session Affinity
        """
...
class IpSecurityRestrictionRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Rule to restrict incoming IP address.
        :param builtins.str action: Allow or Deny rules to determine for incoming IP. Note: Rules can only consist of ALL Allow or ALL Deny
        :param builtins.str ip_address_range: CIDR notation to match incoming IP address
        :param builtins.str name: Name for the IP restriction rule.
        :param builtins.str description: Describe the IP restriction rule that is being sent to the container-app. This is an optional field.
        """
        pulumi.set(__self__, "action", action)
...
class JavaComponentIngressResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App Ingress configuration.
        :param builtins.str fqdn: Hostname of the Java Component endpoint
        """
        pulumi.set(__self__, "fqdn", fqdn)
...
class JavaComponentPropertiesResponseScale(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Java component scaling configurations
        :param builtins.int max_replicas: Optional. Maximum number of Java component replicas
        :param builtins.int min_replicas: Optional. Minimum number of Java component replicas. Defaults to 1 if not set
        """
...
class JobConfigurationResponse(dict):
    ...
    def replica_timeout(self) -> builtins.int:
        """
    ...
    def replica_retry_limit(self) -> Optional[builtins.int]:
        """
...
class JobConfigurationResponseEventTriggerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replica_completion_count: Optional[builtins.int] = None,
                 scale: Optional['outputs.JobScaleResponse'] = None):
        """
        Trigger configuration of an event driven job.
        :param builtins.int parallelism: Number of parallel replicas of a job that can run at a given time.
        :param builtins.int replica_completion_count: Minimum number of successful replica completions before overall job completion.
    ...
    def replica_completion_count(self) -> Optional[builtins.int]:
        """
...
class JobConfigurationResponseScheduleTriggerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cron formatted repeating trigger schedule ("* * * * *") for cronjobs. Properties completions and parallelism would be set to 1 by default
        :param builtins.str cron_expression: Cron formatted repeating schedule ("* * * * *") of a Cron Job.
        :param builtins.int parallelism: Number of parallel replicas of a job that can run at a given time.
        :param builtins.int replica_completion_count: Minimum number of successful replica completions before overall job completion.
        """
...
class JobScaleResponse(dict):
    ...
    def __init__(__self__, *,
                 max_executions: Optional[builtins.int] = None,
                 min_executions: Optional[builtins.int] = None,
                 polling_interval: Optional[builtins.int] = None,
                 rules: Optional[Sequence['outputs.JobScaleRuleResponse']] = None):
        """
        Scaling configurations for event driven jobs.
        :param builtins.int max_executions: Maximum number of job executions that are created for a trigger, default 100.
        :param builtins.int min_executions: Minimum number of job executions that are created for a trigger, default 0
        :param builtins.int polling_interval: Interval to check each event source in seconds. Defaults to 30s
    ...
    def max_executions(self) -> Optional[builtins.int]:
        """
    ...
    def min_executions(self) -> Optional[builtins.int]:
        """
...
class KedaConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration properties Keda component
        :param builtins.str version: The version of Keda
        """
        pulumi.set(__self__, "version", version)
...
class ManagedCertificateResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 domain_control_validation: Optional[builtins.str] = None,
                 subject_name: Optional[builtins.str] = None):
        """
        Certificate resource specific properties
        :param builtins.str error: Any error occurred during the certificate provision.
        :param builtins.str provisioning_state: Provisioning state of the certificate.
        :param builtins.str validation_token: A TXT token used for DNS TXT domain control validation when issuing this type of managed certificates.
        :param builtins.str domain_control_validation: Selected type of domain control validation for managed certificates.
        :param builtins.str subject_name: Subject name of the certificate.
        """
    ...
    def domain_control_validation(self) -> Optional[builtins.str]:
        """
...
class ManagedEnvironmentResponseEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Peer traffic encryption settings for the Managed Environment
        :param builtins.bool enabled: Boolean indicating whether the peer traffic encryption is enabled
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ManagedIdentitySettingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Optional settings for a Managed Identity that is assigned to the Session pool.
        :param builtins.str identity: The resource ID of a user-assigned managed identity that is assigned to the Session Pool, or 'system' for system-assigned identity.
        :param builtins.str lifecycle: Use to select the lifecycle stages of a Session Pool during which the Managed Identity should be available.
        """
        pulumi.set(__self__, "identity", identity)
...
class MtlsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration properties for mutual TLS authentication
        :param builtins.bool enabled: Boolean indicating whether the mutual TLS authentication is enabled
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class PreBuildStepResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scripts: Optional[Sequence[builtins.str]] = None):
        """
        Model representing a pre-build step.
        :param builtins.str description: Description of the pre-build step.
        :param 'HttpGetResponse' http_get: Http get request to send before the build.
        :param Sequence[builtins.str] scripts: List of custom commands to run.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if http_get is not None:
    ...
    @property
    @pulumi.getter
    def scripts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RegistryCredentialsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App Private Registry
        :param builtins.str identity: A Managed Identity to use to authenticate with Azure Container Registry. For user-assigned identities, use the full user-assigned identity Resource ID. For system-assigned identities, use 'system'
        :param builtins.str password_secret_ref: The name of the Secret that contains the registry login password
        :param builtins.str server: Container Registry Server
        :param builtins.str username: Container Registry Username
        """
...
class RegistryInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 registry_url: Optional[builtins.str] = None,
                 registry_user_name: Optional[builtins.str] = None):
        """
        Container App registry information.
        :param builtins.str registry_url: registry server Url.
        :param builtins.str registry_user_name: registry username.
        """
    ...
    def registry_url(self) -> Optional[builtins.str]:
        """
        registry server Url.
        """
    ...
    def registry_user_name(self) -> Optional[builtins.str]:
        """
        registry username.
        """
...
class ScaleConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ready_session_instances: Optional[builtins.int] = None):
        """
        Scale configuration.
        :param builtins.int max_concurrent_sessions: The maximum count of sessions at the same time.
        :param builtins.int ready_session_instances: The minimum count of ready session instances.
        """
    ...
    def ready_session_instances(self) -> Optional[builtins.int]:
        """
...
class ScaleRuleAuthResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Auth Secrets for Scale Rule
        :param builtins.str secret_ref: Name of the secret from which to pull the auth params.
...
class ScheduledEntryResponse(dict):
    ...
    def __init__(__self__, *,
                 duration_hours: builtins.int,
                 start_hour_utc: builtins.int,
                 week_day: builtins.str):
        """
        Maintenance schedule entry for a managed environment.
        :param builtins.int duration_hours: Length of maintenance window range from 8 to 24 hours.
        :param builtins.int start_hour_utc: Start hour after which managed environment maintenance can start from 0 to 23 hour.
        :param builtins.str week_day: Day of the week when a managed environment can be patched.
        """
    ...
    def duration_hours(self) -> builtins.int:
        """
...
class SecretVolumeItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Secret to be added to volume.
        :param builtins.str path: Path to project secret to. If no path is provided, path defaults to name of secret listed in secretRef.
        :param builtins.str secret_ref: Name of the Container App secret from which to pull the secret value.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
        if secret_ref is not None:
...
class ServiceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App to be a dev service
        :param builtins.str type: Dev ContainerApp service type
        """
        pulumi.set(__self__, "type", type)
...
class TcpConnectionPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines parameters for tcp connection pooling
        :param builtins.int max_connections: Maximum number of tcp connections allowed
        """
...
class TcpRetryPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 max_connect_attempts: Optional[builtins.int] = None):
        """
        Policy that defines tcp request retry conditions
        :param builtins.int max_connect_attempts: Maximum number of attempts to connect to the tcp service
        """
    ...
    def max_connect_attempts(self) -> Optional[builtins.int]:
        """
...
class TemplateResponse(dict):
    ...
    def __init__(__self__, *,
                 containers: Optional[Sequence['outputs.ContainerResponse']] = None,
                 init_containers: Optional[Sequence['outputs.InitContainerResponse']] = None,
                 revision_suffix: Optional[builtins.str] = None,
        ...
        :param Sequence['ContainerResponse'] containers: List of container definitions for the Container App.
        :param Sequence['InitContainerResponse'] init_containers: List of specialized containers that run before app containers.
        :param builtins.str revision_suffix: User friendly suffix that is appended to the revision name
        ...
        :param builtins.float termination_grace_period_seconds: Optional duration in seconds the Container App Instance needs to terminate gracefully. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). If this value is nil, the default grace period will be used instead. Set this value longer than the expected cleanup time for your process. Defaults to 30 seconds.
        :param Sequence['VolumeResponse'] volumes: List of volume definitions for the Container App.
        """
        if containers is not None:
            pulumi.set(__self__, "containers", containers)
    ...
    def revision_suffix(self) -> Optional[builtins.str]:
        """
...
class TimeoutPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 connection_timeout_in_seconds: Optional[builtins.int] = None,
                 response_timeout_in_seconds: Optional[builtins.int] = None):
        """
        Policy to set request timeouts
        :param builtins.int connection_timeout_in_seconds: Timeout, in seconds, for a request to initiate a connection
        :param builtins.int response_timeout_in_seconds: Timeout, in seconds, for a request to respond
        """
    ...
    def connection_timeout_in_seconds(self) -> Optional[builtins.int]:
        """
...
class TrafficWeightResponse(dict):
    ...
    def __init__(__self__, *,
                 label: Optional[builtins.str] = None,
                 latest_revision: Optional[builtins.bool] = None,
                 revision_name: Optional[builtins.str] = None,
                 weight: Optional[builtins.int] = None):
        """
        Traffic weight assigned to a revision
        :param builtins.str label: Associates a traffic label with a revision
        :param builtins.bool latest_revision: Indicates that the traffic weight belongs to a latest stable revision
        :param builtins.str revision_name: Name of a revision
        :param builtins.int weight: Traffic weight assigned to a revision
        """
        if label is not None:
            pulumi.set(__self__, "label", label)
    ...
    def latest_revision(self) -> Optional[builtins.bool]:
        """
    ...
    def revision_name(self) -> Optional[builtins.str]:
        """
        Name of a revision
        """
...
class VnetConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 infrastructure_subnet_id: Optional[builtins.str] = None,
        ...
        """
        Configuration properties for apps environment to join a Virtual Network
        :param builtins.str docker_bridge_cidr: CIDR notation IP range assigned to the Docker bridge, network. Must not overlap with any other provided IP ranges.
        :param builtins.str infrastructure_subnet_id: Resource ID of a subnet for infrastructure components. Must not overlap with any other provided IP ranges.
        :param builtins.bool internal: Boolean indicating the environment only has an internal load balancer. These environments do not have a public static IP resource. They must provide infrastructureSubnetId if enabling this property
        :param builtins.str platform_reserved_cidr: IP range in CIDR notation that can be reserved for environment infrastructure IP addresses. Must not overlap with any other provided IP ranges.
    ...
    def infrastructure_subnet_id(self) -> Optional[builtins.str]:
        """
...
class VolumeMountResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Volume mount for the Container App.
        :param builtins.str mount_path: Path within the container at which the volume should be mounted.Must not contain ':'.
        :param builtins.str sub_path: Path within the volume from which the container's volume should be mounted. Defaults to "" (volume's root).
        :param builtins.str volume_name: This must match the Name of a Volume.
        """
...
class VolumeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str storage_type: Storage type for the volume. If not provided, use EmptyDir.
        """
    ...
    def storage_name(self) -> Optional[builtins.str]:
        """
...
class WorkloadProfileResponse(dict):
    ...
    def minimum_count(self) -> Optional[builtins.int]:
        """
