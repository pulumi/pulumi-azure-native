...
class ConnectedEnvironmentsDaprComponentArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if connected_environment_name is None and 'connectedEnvironmentName' in kwargs:
            connected_environment_name = kwargs['connectedEnvironmentName']
        if connected_environment_name is None:
            raise TypeError("Missing 'connected_environment_name' argument")
...
class ConnectedEnvironmentsDaprComponent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ConnectedEnvironmentsDaprComponent"), pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent"), pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent"), pulumi.Alias(type_="azure-native:app/v20230501:ConnectedEnvironmentsDaprComponent"), pulumi.Alias(type_="azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironmentsDaprComponent, __self__).__init__(
            'azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent',
            resource_name,
            __props__,
            opts)
