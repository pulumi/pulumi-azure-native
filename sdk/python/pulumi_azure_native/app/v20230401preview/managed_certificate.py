...
class ManagedCertificateArgs:
    ...
    def _configure(
        ...
        if managed_certificate_name is None and 'managedCertificateName' in kwargs:
            managed_certificate_name = kwargs['managedCertificateName']
...
class ManagedCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ManagedCertificatePropertiesArgs, True)
