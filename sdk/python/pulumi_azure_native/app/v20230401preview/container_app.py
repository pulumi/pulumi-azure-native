...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20230501:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20230502preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20230801preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20231102preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20240202preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20240301:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20240802preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20241002preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20250101:ContainerApp"), pulumi.Alias(type_="azure-native:app:ContainerApp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerApp, __self__).__init__(
            'azure-native:app/v20230401preview:ContainerApp',
            resource_name,
            __props__,
            opts)
