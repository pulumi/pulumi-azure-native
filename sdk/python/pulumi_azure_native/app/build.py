...
class BuildArgs:
    def __init__(__self__, *,
                 builder_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 build_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] builder_name: The name of the builder.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] build_name: The name of a build.
    ...
    def builder_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @builder_name.setter
    def builder_name(self, value: pulumi.Input[builtins.str]):
    ...
    def build_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of a build.
        """
    ...
    @build_name.setter
    def build_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Build(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20230801preview:Build"), pulumi.Alias(type_="azure-native:app/v20231102preview:Build"), pulumi.Alias(type_="azure-native:app/v20240202preview:Build"), pulumi.Alias(type_="azure-native:app/v20240802preview:Build"), pulumi.Alias(type_="azure-native:app/v20241002preview:Build"), pulumi.Alias(type_="azure-native:app/v20250202preview:Build"), pulumi.Alias(type_="azure-native:app/v20251002preview:Build")])
    ...
    def log_stream_endpoint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def upload_endpoint(self) -> pulumi.Output[builtins.str]:
        """
