...
class AgentArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['AgentPropertiesArgs']] = None,
        ...
        :param pulumi.Input['AgentPropertiesArgs'] properties: The resource-specific properties for this resource.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['AgentPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['AgentPropertiesArgs']]):
...
@pulumi.type_token("azure-native:app:Agent")
class Agent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['AgentPropertiesArgs', 'AgentPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['AgentPropertiesArgs', 'AgentPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20260101:Agent")])
