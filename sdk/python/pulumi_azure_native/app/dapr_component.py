...
class DaprComponentArgs:
    def __init__(__self__, *,
                 ...
                 init_timeout: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] ignore_errors: Boolean describing if the component errors are ignores
        :param pulumi.Input[builtins.str] init_timeout: Initialization timeout
    ...
    def init_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @init_timeout.setter
    def init_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DaprComponent(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="initTimeout")
    def init_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Initialization timeout
        """
        return pulumi.get(self, "init_timeout")
    ...
    @property
    @pulumi.getter(name="secretStoreComponent")
    def secret_store_component(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of a Dapr component to retrieve component secrets from
        """
        return pulumi.get(self, "secret_store_component")
