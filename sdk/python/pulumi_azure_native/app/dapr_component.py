...
class DaprComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] scopes: Names of container apps that can use this Dapr component
        :param pulumi.Input[_builtins.str] secret_store_component: Name of a Dapr component to retrieve component secrets from
