...
def get_dapr_component(component_name: Optional[_builtins.str] = None,
...
def get_dapr_component_output(component_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
