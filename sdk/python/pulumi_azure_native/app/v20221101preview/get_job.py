...
def get_job(job_name: Optional[str] = None,
    ...
    :param str job_name: Name of the Container Apps Job.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20221101preview:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(job_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20221101preview:getJob', __args__, opts=opts, typ=GetJobResult)
