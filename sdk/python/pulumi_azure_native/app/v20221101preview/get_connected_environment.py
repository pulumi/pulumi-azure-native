...
def get_connected_environment(connected_environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20221101preview:getConnectedEnvironment', __args__, opts=opts, typ=GetConnectedEnvironmentResult).value
...
def get_connected_environment_output(connected_environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20221101preview:getConnectedEnvironment', __args__, opts=opts, typ=GetConnectedEnvironmentResult)
