...
class ManagedCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20230401preview:ManagedCertificate")])
