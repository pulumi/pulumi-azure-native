...
class DaprComponent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dapr_component = azure_native.app.v20221101preview.DaprComponent("daprComponent",
