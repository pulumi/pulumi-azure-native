...
def list_container_app_secrets(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20221101preview:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult).value
...
def list_container_app_secrets_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20221101preview:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult)
