...
def get_agent(agent_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app:getAgent', __args__, opts=opts, typ=GetAgentResult).value
...
def get_agent_output(agent_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:getAgent', __args__, opts=opts, typ=GetAgentResult)
