...
class LogicAppArgs:
    def __init__(__self__, *,
                 container_app_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] logic_app_name: Name of the Logic App, the extension resource.
        """
    ...
    def container_app_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_app_name(self, value: pulumi.Input[builtins.str]):
    ...
    def logic_app_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def logic_app_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LogicApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20240202preview:LogicApp"), pulumi.Alias(type_="azure-native:app/v20240802preview:LogicApp"), pulumi.Alias(type_="azure-native:app/v20241002preview:LogicApp"), pulumi.Alias(type_="azure-native:app/v20250202preview:LogicApp"), pulumi.Alias(type_="azure-native:app/v20250701:LogicApp"), pulumi.Alias(type_="azure-native:app/v20251002preview:LogicApp")])
