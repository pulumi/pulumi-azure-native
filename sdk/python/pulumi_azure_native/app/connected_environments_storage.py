...
class ConnectedEnvironmentsStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connected_environment_name: Name of the Environment.
...
class ConnectedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230401preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230501:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230502preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230801preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20231102preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240202preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240301:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240802preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20241002preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20250101:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20250202preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20250701:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20251002preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20260101:ConnectedEnvironmentsStorage")])
