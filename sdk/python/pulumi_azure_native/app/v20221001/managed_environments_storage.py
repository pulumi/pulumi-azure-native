...
class ManagedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_environments_storage = azure_native.app.v20221001.ManagedEnvironmentsStorage("managedEnvironmentsStorage",
            environment_name="managedEnv",
            properties=azure_native.app.v20221001.ManagedEnvironmentStorageResponsePropertiesArgs(
                azure_file=azure_native.app.v20221001.AzureFilePropertiesArgs(
        ...
        ```sh
        $ pulumi import azure-native:app/v20221001:ManagedEnvironmentsStorage jlaw-demo1 /subscriptions/8efdecc5-919e-44eb-b179-915dca89ebf9/resourceGroups/examplerg/providers/Microsoft.App/managedEnvironments/managedEnv/storages/jlaw-demo1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220101preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220301:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220601preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221101preview:ManagedEnvironmentsStorage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedEnvironmentsStorage, __self__).__init__(
            'azure-native:app/v20221001:ManagedEnvironmentsStorage',
            resource_name,
            __props__,
            opts)
