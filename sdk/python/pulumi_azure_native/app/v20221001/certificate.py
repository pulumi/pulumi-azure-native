...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:Certificate"), pulumi.Alias(type_="azure-native:app/v20220101preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20220301:Certificate"), pulumi.Alias(type_="azure-native:app/v20220601preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20221101preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20230401preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20230501:Certificate"), pulumi.Alias(type_="azure-native:app/v20230502preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20230801preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20231102preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20240202preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20240301:Certificate"), pulumi.Alias(type_="azure-native:app/v20240802preview:Certificate")])
