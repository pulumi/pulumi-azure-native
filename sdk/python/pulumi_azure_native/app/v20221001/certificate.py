...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate = azure_native.app.v20221001.Certificate("certificate",
            certificate_name="certificate-firendly-name",
            environment_name="testcontainerenv",
            location="East US",
            properties=azure_native.app.v20221001.CertificatePropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:Certificate"), pulumi.Alias(type_="azure-native:app/v20220101preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20220301:Certificate"), pulumi.Alias(type_="azure-native:app/v20220601preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20221101preview:Certificate")])
