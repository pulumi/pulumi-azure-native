...
def get_container_apps_auth_config(auth_config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_apps_auth_config is deprecated: azure-native:app/v20221001:ContainerAppsAuthConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsAuthConfig to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['authConfigName'] = auth_config_name
    __args__['containerAppName'] = container_app_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20221001:getContainerAppsAuthConfig', __args__, opts=opts, typ=GetContainerAppsAuthConfigResult).value
