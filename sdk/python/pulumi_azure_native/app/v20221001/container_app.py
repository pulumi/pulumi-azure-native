...
class ContainerApp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_app = azure_native.app.v20221001.ContainerApp("containerApp",
            configuration=azure_native.app.v20221001.ConfigurationResponseArgs(
                dapr=azure_native.app.v20221001.DaprArgs(
                    app_port=3000,
                    app_protocol="http",
                ...
                ingress={
                    ...
                    "corsPolicy": azure_native.app.v20221001.CorsPolicyArgs(
                    ...
                    "customDomains": [
                        azure_native.app.v20221001.CustomDomainArgs(
                    ...
                    "ipSecurityRestrictions": [
                        azure_native.app.v20221001.IpSecurityRestrictionRuleArgs(
                            action="Allow",
                    ...
                    "targetPort": 3000,
                    "traffic": [azure_native.app.v20221001.TrafficWeightArgs(
                        label="production",
            ...
            template=azure_native.app.v20221001.TemplateResponseArgs(
                containers=[{
                    "image": "repo/testcontainerApp0:v1",
                    "name": "testcontainerApp0",
                    "probes": [{
                        "httpGet": azure_native.app.v20221001.ContainerAppProbeHttpGetArgs(
                            http_headers=[azure_native.app.v20221001.ContainerAppProbeHttpHeadersArgs(
                                name="Custom-Header",
                                value="Awesome",
                            )],
                            path="/health",
                ...
                init_containers=[{
                    ...
                    "resources": azure_native.app.v20221001.ContainerResourcesArgs(
                        cpu=0.2,
                        memory="100Mi",
                    ),
                }],
                scale={
                    ...
                    "minReplicas": 1,
                    "rules": [{
                        "custom": azure_native.app.v20221001.CustomScaleRuleArgs(
                            metadata={
            ...
            template=azure_native.app.v20221001.TemplateResponseArgs(
                containers=[{
                    ...
                    "probes": [{
                        "initialDelaySeconds": 3,
                        "periodSeconds": 3,
                        "tcpSocket": azure_native.app.v20221001.ContainerAppProbeTcpSocketArgs(
                            port=8080,
                        ),
                        "type": "Liveness",
                    }],
                ...
                scale={
                    ...
                    "rules": [{
                        "name": "tcpscalingrule",
                        "tcp": azure_native.app.v20221001.TcpScaleRuleArgs(
                            metadata={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerApp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerApp, __self__).__init__(
            'azure-native:app/v20221001:ContainerApp',
            resource_name,
            __props__,
            opts)
