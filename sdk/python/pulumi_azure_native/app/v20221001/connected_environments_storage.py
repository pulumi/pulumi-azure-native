...
class ConnectedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connected_environments_storage = azure_native.app.v20221001.ConnectedEnvironmentsStorage("connectedEnvironmentsStorage",
            connected_environment_name="env",
            properties=azure_native.app.v20221001.ConnectedEnvironmentStorageResponsePropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsStorage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironmentsStorage, __self__).__init__(
            'azure-native:app/v20221001:ConnectedEnvironmentsStorage',
            resource_name,
            __props__,
            opts)
