...
class ContainerAppsSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_apps_source_control = azure_native.app.v20221001.ContainerAppsSourceControl("containerAppsSourceControl",
            branch="master",
            container_app_name="testcanadacentral",
            github_action_configuration=azure_native.app.v20221001.GithubActionConfigurationResponseArgs(
                azure_credentials=azure_native.app.v20221001.AzureCredentialsArgs(
                    client_id="<clientid>",
                ...
                context_path="./",
                image="image/tag",
                registry_info=azure_native.app.v20221001.RegistryInfoArgs(
