...
class DaprComponent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dapr_component = azure_native.app.v20221001.DaprComponent("daprComponent",
            ...
            init_timeout="50s",
            metadata=[
                azure_native.app.v20221001.DaprMetadataArgs(
                    name="url",
                    value="<COSMOS-URL>",
                ),
                azure_native.app.v20221001.DaprMetadataArgs(
        ...
        dapr_component = azure_native.app.v20221001.DaprComponent("daprComponent",
            ...
            secrets=[azure_native.app.v20221001.SecretArgs(
                name="masterkey",
                value="keyvalue",
            )],
            version="v1")
