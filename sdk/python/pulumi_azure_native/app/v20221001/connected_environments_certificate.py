...
class ConnectedEnvironmentsCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        connected_environments_certificate = azure_native.app.v20221001.ConnectedEnvironmentsCertificate("connectedEnvironmentsCertificate",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsCertificate")])
