...
def get_container_app_auth_token(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20221001:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult).value
...
def get_container_app_auth_token_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20221001:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult)
