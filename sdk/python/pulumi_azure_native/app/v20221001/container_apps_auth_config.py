...
class ContainerAppsAuthConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_apps_auth_config = azure_native.app.v20221001.ContainerAppsAuthConfig("containerAppsAuthConfig",
            auth_config_name="current",
            container_app_name="testcanadacentral",
            global_validation=azure_native.app.v20221001.GlobalValidationArgs(
                unauthenticated_client_action=azure_native.app/v20221001.UnauthenticatedClientActionV2.ALLOW_ANONYMOUS,
            ),
            identity_providers=azure_native.app.v20221001.IdentityProvidersResponseArgs(
                facebook={
                    "registration": azure_native.app.v20221001.AppRegistrationArgs(
                        app_id="123",
                        app_secret_setting_name="facebook-secret",
                    ),
                },
            ),
            platform=azure_native.app.v20221001.AuthPlatformArgs(
                enabled=True,
            ),
