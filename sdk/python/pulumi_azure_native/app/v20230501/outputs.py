...
class ConfigurationResponse(dict):
    ...
    def _configure(
        ...
        if 'maxInactiveRevisions' in kwargs:
...
class DaprResponse(dict):
    ...
    def _configure(
        ...
        if 'enableApiLogging' in kwargs:
            enable_api_logging = kwargs['enableApiLogging']
        if 'httpMaxRequestSize' in kwargs:
            http_max_request_size = kwargs['httpMaxRequestSize']
        if 'httpReadBufferSize' in kwargs:
...
class JobConfigurationResponseEventTriggerConfig(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'replicaCompletionCount' in kwargs:
...
class JobScaleResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'maxExecutions' in kwargs:
            max_executions = kwargs['maxExecutions']
        if 'minExecutions' in kwargs:
...
class ManagedCertificateResponseProperties(dict):
    ...
    def _configure(
        ...
        if 'domainControlValidation' in kwargs:
...
class WorkloadProfileResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'workloadProfileType' in kwargs:
