...
def get_managed_environment(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20230501:getManagedEnvironment', __args__, opts=opts, typ=GetManagedEnvironmentResult).value
    ...
    return AwaitableGetManagedEnvironmentResult(
        ...
        dapr_configuration=__ret__.dapr_configuration,
        ...
        id=__ret__.id,
        infrastructure_resource_group=__ret__.infrastructure_resource_group,
        keda_configuration=__ret__.keda_configuration,
        kind=__ret__.kind,
        location=__ret__.location,
        name=__ret__.name,
        peer_authentication=__ret__.peer_authentication,
