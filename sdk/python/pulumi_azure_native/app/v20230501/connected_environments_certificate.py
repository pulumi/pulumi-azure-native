...
class ConnectedEnvironmentsCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20230401preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20230502preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20230801preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20231102preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20240202preview:ConnectedEnvironmentsCertificate"), pulumi.Alias(type_="azure-native:app/v20240301:ConnectedEnvironmentsCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironmentsCertificate, __self__).__init__(
            'azure-native:app/v20230501:ConnectedEnvironmentsCertificate',
            resource_name,
            __props__,
            opts)
