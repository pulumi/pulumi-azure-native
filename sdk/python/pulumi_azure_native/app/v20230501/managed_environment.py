...
class ManagedEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220101preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20220301:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20220601preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221001:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221101preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230401preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230502preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230801preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20231102preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240202preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240301:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240802preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20241002preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app:ManagedEnvironment")])
