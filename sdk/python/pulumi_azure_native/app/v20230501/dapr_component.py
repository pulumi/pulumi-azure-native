...
class DaprComponent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20220101preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20220301:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20220601preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20221001:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20221101preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20230401preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20230502preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20230801preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20231102preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20240202preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20240301:DaprComponent")])
