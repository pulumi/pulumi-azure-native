...
def get_container_app(container_app_name: Optional[builtins.str] = None,
...
def get_container_app_output(container_app_name: Optional[pulumi.Input[builtins.str]] = None,
