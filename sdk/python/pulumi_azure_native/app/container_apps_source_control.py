...
class ContainerAppsSourceControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] branch: The branch which will trigger the auto deployment
        ...
        :param pulumi.Input[builtins.str] repo_url: The repo url which will be integrated to ContainerApp.
        :param pulumi.Input[builtins.str] source_control_name: Name of the Container App SourceControl.
        """
...
class ContainerAppsSourceControl(pulumi.CustomResource):
    ...
    def operation_state(self) -> pulumi.Output[builtins.str]:
        """
