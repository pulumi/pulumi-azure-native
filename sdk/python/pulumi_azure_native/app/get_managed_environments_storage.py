...
def get_managed_environments_storage(environment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str storage_name: Name of the storage.
    """
    __args__ = dict()
...
def get_managed_environments_storage_output(environment_name: Optional[pulumi.Input[_builtins.str]] = None,
