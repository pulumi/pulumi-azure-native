...
class BlobStorageTokenStoreArgs:
    ...
    def _configure(
        ...
        if sas_url_setting_name is None:
            raise TypeError("Missing 'sas_url_setting_name' argument")
...
class EncryptionSettingsArgs:
    def __init__(__self__, *,
        ...
        EncryptionSettingsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            container_app_auth_encryption_secret_name=container_app_auth_encryption_secret_name,
            container_app_auth_signing_secret_name=container_app_auth_signing_secret_name,
        )
    @staticmethod
    def _configure(
             _setter: Callable[[Any, Any], None],
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if container_app_auth_encryption_secret_name is None and 'containerAppAuthEncryptionSecretName' in kwargs:
            container_app_auth_encryption_secret_name = kwargs['containerAppAuthEncryptionSecretName']
        if container_app_auth_signing_secret_name is None and 'containerAppAuthSigningSecretName' in kwargs:
            container_app_auth_signing_secret_name = kwargs['containerAppAuthSigningSecretName']

        if container_app_auth_encryption_secret_name is not None:
            _setter("container_app_auth_encryption_secret_name", container_app_auth_encryption_secret_name)
        if container_app_auth_signing_secret_name is not None:
            _setter("container_app_auth_signing_secret_name", container_app_auth_signing_secret_name)
...
class GithubActionConfigurationArgs:
    ...
    def _configure(
        ...
        if github_personal_access_token is None and 'githubPersonalAccessToken' in kwargs:
...
class IngressPortMappingArgs:
    def __init__(__self__, *,
        ...
        """
        IngressPortMappingArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            external=external,
...
class IngressArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if additional_port_mappings is None and 'additionalPortMappings' in kwargs:
            additional_port_mappings = kwargs['additionalPortMappings']
        ...
        if additional_port_mappings is not None:
            _setter("additional_port_mappings", additional_port_mappings)
...
class JobConfigurationArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             replica_timeout: Optional[pulumi.Input[int]] = None,
             trigger_type: Optional[pulumi.Input[Union[str, 'TriggerType']]] = None,
             event_trigger_config: Optional[pulumi.Input['JobConfigurationEventTriggerConfigArgs']] = None,
             manual_trigger_config: Optional[pulumi.Input['JobConfigurationManualTriggerConfigArgs']] = None,
             registries: Optional[pulumi.Input[Sequence[pulumi.Input['RegistryCredentialsArgs']]]] = None,
