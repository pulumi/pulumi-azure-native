...
class ManagedEnvironmentArgs:
    ...
    def _configure(
        ...
        if infrastructure_resource_group is None and 'infrastructureResourceGroup' in kwargs:
            infrastructure_resource_group = kwargs['infrastructureResourceGroup']
        if peer_authentication is None and 'peerAuthentication' in kwargs:
...
class ManagedEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            peer_authentication = _utilities.configure(peer_authentication, ManagedEnvironmentPeerAuthenticationArgs, True)
