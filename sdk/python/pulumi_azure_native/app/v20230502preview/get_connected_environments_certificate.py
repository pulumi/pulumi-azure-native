...
__all__ = [
    ...
    'AwaitableGetConnectedEnvironmentsCertificateResult',
    'get_connected_environments_certificate',
    'get_connected_environments_certificate_output',
]

@pulumi.output_type
class GetConnectedEnvironmentsCertificateResult:
    """
...
class AwaitableGetConnectedEnvironmentsCertificateResult(GetConnectedEnvironmentsCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectedEnvironmentsCertificateResult(
            id=self.id,
...
def get_connected_environments_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20230502preview:getConnectedEnvironmentsCertificate', __args__, opts=opts, typ=GetConnectedEnvironmentsCertificateResult).value

    return AwaitableGetConnectedEnvironmentsCertificateResult(
...
def get_connected_environments_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20230502preview:getConnectedEnvironmentsCertificate', __args__, opts=opts, typ=GetConnectedEnvironmentsCertificateResult)
