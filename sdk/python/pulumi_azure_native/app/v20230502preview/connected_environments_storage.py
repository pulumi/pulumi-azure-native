...
class ConnectedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230401preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230501:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230801preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20231102preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240202preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240301:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240802preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20241002preview:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20250101:ConnectedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app:ConnectedEnvironmentsStorage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironmentsStorage, __self__).__init__(
            'azure-native:app/v20230502preview:ConnectedEnvironmentsStorage',
            resource_name,
            __props__,
            opts)
