...
class DaprSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 pubsub_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dead_letter_topic: Deadletter topic name
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Subscription metadata
        :param pulumi.Input[builtins.str] name: Name of the Dapr subscription.
        :param pulumi.Input[builtins.str] pubsub_name: Dapr PubSub component name
        :param pulumi.Input['DaprSubscriptionRoutesArgs'] routes: Subscription routes
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Application scopes to restrict the subscription to specific apps.
        :param pulumi.Input[builtins.str] topic: Topic name
        """
    ...
    def pubsub_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pubsub_name.setter
    def pubsub_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DaprSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deadLetterTopic")
    def dead_letter_topic(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Deadletter topic name
        """
        return pulumi.get(self, "dead_letter_topic")
    ...
    @property
    @pulumi.getter(name="pubsubName")
    def pubsub_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Dapr PubSub component name
        """
        return pulumi.get(self, "pubsub_name")
    ...
    @property
    @pulumi.getter
    def topic(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Topic name
        """
        return pulumi.get(self, "topic")
