...
if not MYPY:
    class BlobStorageTokenStoreArgsDict(TypedDict):
        ...
        """
        managed_identity_resource_id: NotRequired[pulumi.Input[str]]
        """
...
class BlobStorageTokenStoreArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration settings of the storage of the tokens if blob storage is used.
        :param pulumi.Input[str] blob_container_uri: The URI of the blob storage containing the tokens. Should not be used along with sasUrlSettingName.
        :param pulumi.Input[str] client_id: The Client ID of a User-Assigned Managed Identity. Should not be used along with managedIdentityResourceId.
        :param pulumi.Input[str] managed_identity_resource_id: The Resource ID of a User-Assigned Managed Identity. Should not be used along with clientId.
        :param pulumi.Input[str] sas_url_setting_name: The name of the app secrets containing the SAS URL of the blob storage containing the tokens. Should not be used along with blobContainerUri.
        """
...
if not MYPY:
    class ConfigurationArgsDict(TypedDict):
        ...
        """
        revision_transition_threshold: NotRequired[pulumi.Input[int]]
        """
        ...
        """
        target_label: NotRequired[pulumi.Input[str]]
        """
...
class ConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 revision_transition_threshold: Optional[pulumi.Input[int]] = None,
                 ...
                 target_label: Optional[pulumi.Input[str]] = None):
        """
        Non versioned Container App configuration properties that define the mutable settings of a Container app
        ...
        :param pulumi.Input[int] revision_transition_threshold: Optional. The percent of the total number of replicas that must be brought up before revision transition occurs. Defaults to 100 when none is given. Value must be greater than 0 and less than or equal to 100.
        ...
        :param pulumi.Input[str] target_label: Required in labels revisions mode. Label to apply to newly created revision.
        """
    ...
    def revision_transition_threshold(self) -> Optional[pulumi.Input[int]]:
        """
        Optional. The percent of the total number of replicas that must be brought up before revision transition occurs. Defaults to 100 when none is given. Value must be greater than 0 and less than or equal to 100.
        """
    ...
    def revision_transition_threshold(self, value: Optional[pulumi.Input[int]]):
    ...
    def target_label(self) -> Optional[pulumi.Input[str]]:
        """
        Required in labels revisions mode. Label to apply to newly created revision.
        """
    ...
    @target_label.setter
    def target_label(self, value: Optional[pulumi.Input[str]]):
...
if not MYPY:
    class ContainerResourcesArgsDict(TypedDict):
        ...
        """
        gpu: NotRequired[pulumi.Input[float]]
        """
...
class ContainerResourcesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] gpu: Required GPU in cores for GPU based app, e.g. 1.0
...
class GithubActionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dockerfile_path: Dockerfile path
...
if not MYPY:
    class MetricsConfigurationArgsDict(TypedDict):
        ...
        """
        include_keda: NotRequired[pulumi.Input[bool]]
        """
...
class MetricsConfigurationArgs:
    def __init__(__self__, *,
                 destinations: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 include_keda: Optional[pulumi.Input[bool]] = None):
        """
        Configuration of Open Telemetry metrics
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Open telemetry metrics destinations
        :param pulumi.Input[bool] include_keda: Boolean indicating if including keda metrics
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
    ...
    def include_keda(self) -> Optional[pulumi.Input[bool]]:
        """
        Boolean indicating if including keda metrics
        """
    ...
    @include_keda.setter
    def include_keda(self, value: Optional[pulumi.Input[bool]]):
...
class ScaleArgs:
    def __init__(__self__, *,
        ...
        """
        Container App scaling configurations.
        :param pulumi.Input[int] cooldown_period: Optional. KEDA Cooldown Period. Defaults to 300 seconds if not set.
        ...
        :param pulumi.Input[int] polling_interval: Optional. KEDA Polling Interval. Defaults to 30 seconds if not set.
...
if not MYPY:
    class TracesConfigurationArgsDict(TypedDict):
        ...
        """
        include_dapr: NotRequired[pulumi.Input[bool]]
        """
...
class TracesConfigurationArgs:
    def __init__(__self__, *,
                 destinations: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 include_dapr: Optional[pulumi.Input[bool]] = None):
        """
        Configuration of Open Telemetry traces
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Open telemetry traces destinations
        :param pulumi.Input[bool] include_dapr: Boolean indicating if including dapr traces
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
    ...
    def include_dapr(self) -> Optional[pulumi.Input[bool]]:
        """
        Boolean indicating if including dapr traces
        """
    ...
    @include_dapr.setter
    def include_dapr(self, value: Optional[pulumi.Input[bool]]):
...
class WorkloadProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enable_fips: Whether to use a FIPS-enabled OS. Supported only for dedicated workload profiles.
