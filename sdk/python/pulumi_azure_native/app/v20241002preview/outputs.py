...
class BlobStorageTokenStoreResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The configuration settings of the storage of the tokens if blob storage is used.
        :param str blob_container_uri: The URI of the blob storage containing the tokens. Should not be used along with sasUrlSettingName.
        :param str client_id: The Client ID of a User-Assigned Managed Identity. Should not be used along with managedIdentityResourceId.
        :param str managed_identity_resource_id: The Resource ID of a User-Assigned Managed Identity. Should not be used along with clientId.
        :param str sas_url_setting_name: The name of the app secrets containing the SAS URL of the blob storage containing the tokens. Should not be used along with blobContainerUri.
        """
...
class CertificateResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Certificate resource specific properties
        :param str deployment_errors: Any errors that occurred during deployment or deployment validation
...
class ConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int revision_transition_threshold: Optional. The percent of the total number of replicas that must be brought up before revision transition occurs. Defaults to 100 when none is given. Value must be greater than 0 and less than or equal to 100.
        ...
        :param str target_label: Required in labels revisions mode. Label to apply to newly created revision.
        """
    ...
    def revision_transition_threshold(self) -> Optional[int]:
        """
...
class ConnectedEnvironmentStorageResponseProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        Storage properties
        :param str deployment_errors: Any errors that occurred during deployment or deployment validation
        :param str provisioning_state: Provisioning state of the storage.
...
class ContainerResourcesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float gpu: Required GPU in cores for GPU based app, e.g. 1.0
