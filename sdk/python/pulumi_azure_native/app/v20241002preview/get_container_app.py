...
class GetContainerAppResult:
    ...
    Container App.
    """
    def __init__(__self__, configuration=None, custom_domain_verification_id=None, deployment_errors=None, environment_id=None, event_stream_endpoint=None, extended_location=None, id=None, identity=None, kind=None, latest_ready_revision_name=None, latest_revision_fqdn=None, latest_revision_name=None, location=None, managed_by=None, managed_environment_id=None, name=None, outbound_ip_addresses=None, patching_configuration=None, provisioning_state=None, running_status=None, system_data=None, tags=None, template=None, type=None, workload_profile_name=None):
...
def get_container_app(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20241002preview:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult).value
...
def get_container_app_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20241002preview:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult)
