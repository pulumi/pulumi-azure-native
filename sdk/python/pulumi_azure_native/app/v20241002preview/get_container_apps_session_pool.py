...
class GetContainerAppsSessionPoolResult:
    ...
    """
    def __init__(__self__, container_type=None, custom_container_template=None, dynamic_pool_configuration=None, environment_id=None, id=None, identity=None, location=None, managed_identity_settings=None, name=None, node_count=None, pool_management_endpoint=None, pool_management_type=None, provisioning_state=None, scale_configuration=None, secrets=None, session_network_configuration=None, system_data=None, tags=None, type=None):
...
def get_container_apps_session_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20241002preview:getContainerAppsSessionPool', __args__, opts=opts, typ=GetContainerAppsSessionPoolResult).value
...
def get_container_apps_session_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sessionPoolName'] = session_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20241002preview:getContainerAppsSessionPool', __args__, opts=opts, typ=GetContainerAppsSessionPoolResult)
