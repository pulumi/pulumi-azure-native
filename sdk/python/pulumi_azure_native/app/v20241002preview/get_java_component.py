...
def get_java_component(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20241002preview:getJavaComponent', __args__, opts=opts, typ=GetJavaComponentResult).value
...
def get_java_component_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20241002preview:getJavaComponent', __args__, opts=opts, typ=GetJavaComponentResult)
