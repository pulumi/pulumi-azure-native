...
class GetConnectedEnvironmentsDaprComponentResult:
    ...
    Dapr Component.
    """
    def __init__(__self__, component_type=None, deployment_errors=None, id=None, ignore_errors=None, init_timeout=None, metadata=None, name=None, provisioning_state=None, scopes=None, secret_store_component=None, secrets=None, service_component_bind=None, system_data=None, type=None, version=None):
...
def get_connected_environments_dapr_component(component_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20241002preview:getConnectedEnvironmentsDaprComponent', __args__, opts=opts, typ=GetConnectedEnvironmentsDaprComponentResult).value
...
def get_connected_environments_dapr_component_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20241002preview:getConnectedEnvironmentsDaprComponent', __args__, opts=opts, typ=GetConnectedEnvironmentsDaprComponentResult)
