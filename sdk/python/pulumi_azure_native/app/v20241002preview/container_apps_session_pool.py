...
class ContainerAppsSessionPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20240202preview:ContainerAppsSessionPool"), pulumi.Alias(type_="azure-native:app/v20240802preview:ContainerAppsSessionPool"), pulumi.Alias(type_="azure-native:app/v20250101:ContainerAppsSessionPool"), pulumi.Alias(type_="azure-native:app:ContainerAppsSessionPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerAppsSessionPool, __self__).__init__(
            'azure-native:app/v20241002preview:ContainerAppsSessionPool',
            resource_name,
            __props__,
            opts)
