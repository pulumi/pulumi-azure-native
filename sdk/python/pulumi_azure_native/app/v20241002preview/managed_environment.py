...
class ManagedEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] availability_zones: The list of availability zones to use for managed environment
...
class ManagedEnvironment(pulumi.CustomResource):
    ...
    def private_link_default_domain(self) -> pulumi.Output[str]:
        """
