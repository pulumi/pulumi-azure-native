...
def list_logic_app_workflows_connections(container_app_name: Optional[_builtins.str] = None,
...
def list_logic_app_workflows_connections_output(container_app_name: Optional[pulumi.Input[_builtins.str]] = None,
