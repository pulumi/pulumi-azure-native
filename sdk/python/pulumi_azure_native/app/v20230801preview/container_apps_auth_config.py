...
class ContainerAppsAuthConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] auth_config_name: Name of the Container App AuthConfig.
        :param pulumi.Input[str] container_app_name: Name of the Container App.
        :param pulumi.Input[pulumi.InputType['EncryptionSettingsArgs']] encryption_settings: The configuration settings of the secrets references of encryption key and signing key for ContainerApp Service Authentication/Authorization.
