...
class GetManagedEnvironmentResult:
    ...
    """
    def __init__(__self__, app_insights_configuration=None, app_logs_configuration=None, custom_domain_configuration=None, dapr_ai_connection_string=None, dapr_ai_instrumentation_key=None, dapr_configuration=None, default_domain=None, deployment_errors=None, event_stream_endpoint=None, id=None, infrastructure_resource_group=None, keda_configuration=None, kind=None, location=None, name=None, open_telemetry_configuration=None, peer_authentication=None, provisioning_state=None, static_ip=None, system_data=None, tags=None, type=None, vnet_configuration=None, workload_profiles=None, zone_redundant=None):
...
def get_managed_environment(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20230801preview:getManagedEnvironment', __args__, opts=opts, typ=GetManagedEnvironmentResult).value
...
def get_managed_environment_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20230801preview:getManagedEnvironment', __args__, opts=opts, typ=GetManagedEnvironmentResult)
