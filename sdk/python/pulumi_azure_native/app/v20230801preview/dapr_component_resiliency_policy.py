...
class DaprComponentResiliencyPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:DaprComponentResiliencyPolicy"), pulumi.Alias(type_="azure-native:app/v20231102preview:DaprComponentResiliencyPolicy")])
