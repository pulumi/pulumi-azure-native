...
def get_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20230801preview:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20230801preview:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
