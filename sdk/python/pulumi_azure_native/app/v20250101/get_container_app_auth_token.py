...
def get_container_app_auth_token(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20250101:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult).value
...
def get_container_app_auth_token_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20250101:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult)
