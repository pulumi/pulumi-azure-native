...
class LifecycleConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The lifecycle configuration properties of a session in the dynamic session pool
        :param int cooldown_period_in_seconds: The cooldown period of a session in seconds when the lifecycle type is 'Timed'.
        :param str lifecycle_type: The lifecycle type of the session pool.
        :param int max_alive_period_in_seconds: The maximum alive period of a session in seconds when the lifecycle type is 'OnContainerExit'.
        """
    ...
    def max_alive_period_in_seconds(self) -> Optional[int]:
        """
...
class NfsAzureFilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        NFS Azure File Properties.
        :param str access_mode: Access mode for storage
        :param str server: Server for NFS azure file. Specify the Azure storage account server address.
...
class ScaleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App scaling configurations.
        :param int cooldown_period: Optional. KEDA Cooldown Period in seconds. Defaults to 300 seconds if not set.
        ...
        :param int polling_interval: Optional. KEDA Polling Interval in seconds. Defaults to 30 seconds if not set.
