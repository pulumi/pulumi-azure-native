...
def list_connected_environments_dapr_component_secrets(component_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20250101:listConnectedEnvironmentsDaprComponentSecrets', __args__, opts=opts, typ=ListConnectedEnvironmentsDaprComponentSecretsResult).value
...
def list_connected_environments_dapr_component_secrets_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20250101:listConnectedEnvironmentsDaprComponentSecrets', __args__, opts=opts, typ=ListConnectedEnvironmentsDaprComponentSecretsResult)
