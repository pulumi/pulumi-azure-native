...
def list_job_secrets(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20250101:listJobSecrets', __args__, opts=opts, typ=ListJobSecretsResult).value
...
def list_job_secrets_output(job_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20250101:listJobSecrets', __args__, opts=opts, typ=ListJobSecretsResult)
