...
class ContainerApp(pulumi.CustomResource):
        ...
        container_app = azure_native.app.ContainerApp("containerApp",
            ...
            template=azure_native.app.TemplateResponseArgs(
                containers=[{
                    ...
                    "probes": [{
                        "httpGet": azure_native.app.ContainerAppProbeHttpGetArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerApp")])
