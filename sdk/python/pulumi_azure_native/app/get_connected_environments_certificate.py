...
def get_connected_environments_certificate(certificate_name: Optional[builtins.str] = None,
...
def get_connected_environments_certificate_output(certificate_name: Optional[pulumi.Input[builtins.str]] = None,
