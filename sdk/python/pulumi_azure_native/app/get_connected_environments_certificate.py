...
def get_connected_environments_certificate(certificate_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app:getConnectedEnvironmentsCertificate', __args__, opts=opts, typ=GetConnectedEnvironmentsCertificateResult).value
...
def get_connected_environments_certificate_output(certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:getConnectedEnvironmentsCertificate', __args__, opts=opts, typ=GetConnectedEnvironmentsCertificateResult)
