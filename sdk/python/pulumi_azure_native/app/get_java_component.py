...
def get_java_component(environment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the Java Component.
...
def get_java_component_output(environment_name: Optional[pulumi.Input[_builtins.str]] = None,
