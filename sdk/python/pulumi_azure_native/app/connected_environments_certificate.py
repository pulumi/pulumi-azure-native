...
class ConnectedEnvironmentsCertificateArgs:
    def __init__(__self__, *,
                 connected_environment_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] connected_environment_name: Name of the Connected Environment.
    ...
    def connected_environment_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connected_environment_name(self, value: pulumi.Input[builtins.str]):
