...
warnings.warn("""azure-native:app/v20220601preview:ConnectedEnvironmentsStorage is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:ConnectedEnvironmentsStorage to guarantee forwards compatibility.""", DeprecationWarning)
