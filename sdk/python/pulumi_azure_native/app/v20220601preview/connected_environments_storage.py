...
warnings.warn("""azure-native:app/v20220601preview:ConnectedEnvironmentsStorage is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ConnectedEnvironmentsStorage to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConnectedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironmentsStorage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironmentsStorage, __self__).__init__(
            'azure-native:app/v20220601preview:ConnectedEnvironmentsStorage',
            resource_name,
            __props__,
            opts)
