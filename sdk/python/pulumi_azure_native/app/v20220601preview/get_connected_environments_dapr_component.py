...
def get_connected_environments_dapr_component(component_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220601preview:getConnectedEnvironmentsDaprComponent', __args__, opts=opts, typ=GetConnectedEnvironmentsDaprComponentResult).value
...
def get_connected_environments_dapr_component_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20220601preview:getConnectedEnvironmentsDaprComponent', __args__, opts=opts, typ=GetConnectedEnvironmentsDaprComponentResult)
