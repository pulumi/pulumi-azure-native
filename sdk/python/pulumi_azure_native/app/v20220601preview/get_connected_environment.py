...
def get_connected_environment(connected_environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connected_environment is deprecated: azure-native:app/v20220601preview:ConnectedEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ConnectedEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
