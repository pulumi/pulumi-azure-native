...
def get_dapr_component(component_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dapr_component is deprecated: azure-native:app/v20220601preview:DaprComponent is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:DaprComponent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['componentName'] = component_name
    __args__['environmentName'] = environment_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220601preview:getDaprComponent', __args__, opts=opts, typ=GetDaprComponentResult).value
