...
def get_dapr_component(component_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dapr_component is deprecated: azure-native:app/v20220601preview:DaprComponent is being removed in the next major version of this provider. Please upgrade to azure-native:app/v20221001:DaprComponent to guarantee forwards compatibility.""")
    __args__ = dict()
