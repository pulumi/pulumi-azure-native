...
warnings.warn("""azure-native:app/v20220601preview:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetContainerAppResult:
    ...
    Container App.
    """
    def __init__(__self__, configuration=None, custom_domain_verification_id=None, environment_id=None, event_stream_endpoint=None, extended_location=None, id=None, identity=None, latest_revision_fqdn=None, latest_revision_name=None, location=None, managed_environment_id=None, name=None, outbound_ip_addresses=None, provisioning_state=None, system_data=None, tags=None, template=None, type=None, workload_profile_type=None):
...
def get_container_app(container_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_app is deprecated: azure-native:app/v20220601preview:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['containerAppName'] = container_app_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220601preview:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult).value
