...
class ManagedCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20230401preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20230501:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20230502preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20230801preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20231102preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20240202preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20240301:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20240802preview:ManagedCertificate"), pulumi.Alias(type_="azure-native:app/v20241002preview:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20221101preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20230401preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20230501:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20230502preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20230801preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20231102preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20240202preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20240301:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20240802preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20241002preview:app:ManagedCertificate"), pulumi.Alias(type_="azure-native_app_v20250101:app:ManagedCertificate")])
