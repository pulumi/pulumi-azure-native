...
def list_job_secrets(job_name: Optional[builtins.str] = None,
...
def list_job_secrets_output(job_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:listJobSecrets', __args__, opts=opts, typ=ListJobSecretsResult)
