...
def get_http_route_config(environment_name: Optional[_builtins.str] = None,
                          http_route_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str http_route_name: Name of the Http Route Config Resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app:getHttpRouteConfig', __args__, opts=opts, typ=GetHttpRouteConfigResult).value

    return AwaitableGetHttpRouteConfigResult(
...
def get_http_route_config_output(environment_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 http_route_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
