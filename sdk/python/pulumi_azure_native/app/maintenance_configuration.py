...
class MaintenanceConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20241002preview:MaintenanceConfiguration"), pulumi.Alias(type_="azure-native:app/v20250202preview:MaintenanceConfiguration"), pulumi.Alias(type_="azure-native:app/v20250701:MaintenanceConfiguration"), pulumi.Alias(type_="azure-native:app/v20251002preview:MaintenanceConfiguration")])
