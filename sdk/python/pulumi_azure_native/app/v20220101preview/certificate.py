...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate = azure_native.app.v20220101preview.Certificate("certificate",
            location="East US",
            managed_environment_name="testcontainerenv",
            name="certificate-firendly-name",
            properties=azure_native.app.v20220101preview.CertificatePropertiesArgs(
