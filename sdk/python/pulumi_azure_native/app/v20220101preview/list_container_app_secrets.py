...
def list_container_app_secrets(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220101preview:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult).value
...
def list_container_app_secrets_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20220101preview:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult)
