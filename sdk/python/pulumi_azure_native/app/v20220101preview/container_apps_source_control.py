...
class ContainerAppsSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_apps_source_control = azure_native.app.v20220101preview.ContainerAppsSourceControl("containerAppsSourceControl",
            branch="master",
            container_app_name="testcanadacentral",
            github_action_configuration=azure_native.app.v20220101preview.GithubActionConfigurationResponseArgs(
                azure_credentials=azure_native.app.v20220101preview.AzureCredentialsArgs(
                    client_id="<clientid>",
                    client_secret="<clientsecret>",
                    tenant_id="<tenantid>",
                ),
                registry_info=azure_native.app.v20220101preview.RegistryInfoArgs(
        ...
        ```sh
        $ pulumi import azure-native:app/v20220101preview:ContainerAppsSourceControl current /subscriptions/651f8027-33e8-4ec4-97b4-f6e9f3dc8744/resourceGroups/workerapps-rg-xj/providers/Microsoft.App/containerApps/myapp/sourcecontrols/current 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerAppsSourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerAppsSourceControl, __self__).__init__(
            'azure-native:app/v20220101preview:ContainerAppsSourceControl',
            resource_name,
            __props__,
            opts)
