...
def get_container_apps_source_control(container_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_apps_source_control is deprecated: Version v20220101preview will be removed in the next major version of the provider. Upgrade to version v20220301 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220101preview:getContainerAppsSourceControl', __args__, opts=opts, typ=GetContainerAppsSourceControlResult).value
