...
class ContainerAppsAuthConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_apps_auth_config = azure_native.app.v20220101preview.ContainerAppsAuthConfig("containerAppsAuthConfig",
            container_app_name="testcanadacentral",
            global_validation=azure_native.app.v20220101preview.GlobalValidationArgs(
                unauthenticated_client_action=azure_native.app/v20220101preview.UnauthenticatedClientActionV2.ALLOW_ANONYMOUS,
            ),
            identity_providers=azure_native.app.v20220101preview.IdentityProvidersResponseArgs(
                facebook={
                    "registration": azure_native.app.v20220101preview.AppRegistrationArgs(
                        app_id="123",
            ...
            name="current",
            platform=azure_native.app.v20220101preview.AuthPlatformArgs(
                enabled=True,
            ),
        ...
        ```sh
        $ pulumi import azure-native:app/v20220101preview:ContainerAppsAuthConfig current /subscriptions/651f8027-33e8-4ec4-97b4-f6e9f3dc8744/resourceGroups/workerapps-rg-xj/providers/Microsoft.App/containerApps/myapp/authconfigs/current 
        ```
