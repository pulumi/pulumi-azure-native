...
class ManagedEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_environment = azure_native.app.v20220101preview.ManagedEnvironment("managedEnvironment",
            app_logs_configuration=azure_native.app.v20220101preview.AppLogsConfigurationResponseArgs(
                log_analytics_configuration=azure_native.app.v20220101preview.LogAnalyticsConfigurationArgs(
                    customer_id="string",
                    shared_key="string",
                ),
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20220301:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20220601preview:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221001:ManagedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221101preview:ManagedEnvironment")])
