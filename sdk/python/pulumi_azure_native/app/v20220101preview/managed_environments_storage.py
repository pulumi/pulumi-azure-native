...
class ManagedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_environments_storage = azure_native.app.v20220101preview.ManagedEnvironmentsStorage("managedEnvironmentsStorage",
            env_name="managedEnv",
            name="jlaw-demo1",
            properties=azure_native.app.v20220101preview.ManagedEnvironmentStorageResponsePropertiesArgs(
                azure_file=azure_native.app.v20220101preview.AzureFilePropertiesArgs(
