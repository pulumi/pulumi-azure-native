...
def list_dapr_component_secrets(component_name: Optional[builtins.str] = None,
...
def list_dapr_component_secrets_output(component_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:listDaprComponentSecrets', __args__, opts=opts, typ=ListDaprComponentSecretsResult)
