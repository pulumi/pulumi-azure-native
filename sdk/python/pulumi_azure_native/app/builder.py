...
class BuilderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] environment_id: Resource ID of the container apps environment that the builder is associated with.
    ...
    def builder_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @builder_name.setter
    def builder_name(self, value: Optional[pulumi.Input[builtins.str]]):
