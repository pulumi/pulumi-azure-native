...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20230401preview:Job"), pulumi.Alias(type_="azure-native:app/v20230501:Job"), pulumi.Alias(type_="azure-native:app/v20230502preview:Job"), pulumi.Alias(type_="azure-native:app/v20230801preview:Job"), pulumi.Alias(type_="azure-native:app/v20231102preview:Job"), pulumi.Alias(type_="azure-native:app/v20240202preview:Job"), pulumi.Alias(type_="azure-native:app/v20240301:Job"), pulumi.Alias(type_="azure-native:app/v20240802preview:Job"), pulumi.Alias(type_="azure-native:app/v20241002preview:Job"), pulumi.Alias(type_="azure-native_app_v20221101preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20230401preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20230501:app:Job"), pulumi.Alias(type_="azure-native_app_v20230502preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20230801preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20231102preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20240202preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20240301:app:Job"), pulumi.Alias(type_="azure-native_app_v20240802preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20241002preview:app:Job"), pulumi.Alias(type_="azure-native_app_v20250101:app:Job")])
