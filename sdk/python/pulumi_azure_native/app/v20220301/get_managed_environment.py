...
def get_managed_environment(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_environment is deprecated: azure-native:app/v20220301:ManagedEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ManagedEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
