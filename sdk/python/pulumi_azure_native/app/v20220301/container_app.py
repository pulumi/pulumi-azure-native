...
class ContainerApp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_app = azure_native.app.v20220301.ContainerApp("containerApp",
            configuration=azure_native.app.v20220301.ConfigurationResponseArgs(
                dapr=azure_native.app.v20220301.DaprArgs(
                    app_port=3000,
                    app_protocol="http",
                    enabled=True,
                ),
                ingress={
                    "customDomains": [
                        azure_native.app.v20220301.CustomDomainArgs(
                    ...
                    "external": True,
                    "targetPort": 3000,
                    "traffic": [azure_native.app.v20220301.TrafficWeightArgs(
                        label="production",
            ...
            template=azure_native.app.v20220301.TemplateResponseArgs(
                containers=[{
                    "image": "repo/testcontainerApp0:v1",
                    "name": "testcontainerApp0",
                    "probes": [{
                        "httpGet": azure_native.app.v20220301.ContainerAppProbeHttpGetArgs(
                            http_headers=[azure_native.app.v20220301.ContainerAppProbeHttpHeadersArgs(
                                name="Custom-Header",
                                value="Awesome",
                            )],
                            path="/health",
                ...
                scale={
                    ...
                    "minReplicas": 1,
                    "rules": [{
                        "custom": azure_native.app.v20220301.CustomScaleRuleArgs(
                            metadata={
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerApp"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerApp")])
