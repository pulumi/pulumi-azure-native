...
warnings.warn("""azure-native:app/v20220301:ContainerAppsAuthConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsAuthConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container_apps_auth_config(auth_config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_apps_auth_config is deprecated: azure-native:app/v20220301:ContainerAppsAuthConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsAuthConfig to guarantee forwards compatibility.""")
    __args__ = dict()
