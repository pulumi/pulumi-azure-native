...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        certificate = azure_native.app.v20220301.Certificate("certificate",
            certificate_name="certificate-firendly-name",
            environment_name="testcontainerenv",
            location="East US",
            properties=azure_native.app.v20220301.CertificatePropertiesArgs(
        ...
        ```sh
        $ pulumi import azure-native:app/v20220301:Certificate myresource1 /subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/examplerg/providers/Microsoft.App/managedEnvironments/testcontainerenv/certificates/certificate-firendly-name 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:Certificate"), pulumi.Alias(type_="azure-native:app/v20220101preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20220601preview:Certificate"), pulumi.Alias(type_="azure-native:app/v20221001:Certificate"), pulumi.Alias(type_="azure-native:app/v20221101preview:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azure-native:app/v20220301:Certificate',
            resource_name,
            __props__,
            opts)
