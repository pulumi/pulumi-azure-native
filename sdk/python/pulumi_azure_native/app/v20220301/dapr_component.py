...
class DaprComponent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dapr_component = azure_native.app.v20220301.DaprComponent("daprComponent",
            ...
            init_timeout="50s",
            metadata=[
                azure_native.app.v20220301.DaprMetadataArgs(
                    name="url",
                    value="<COSMOS-URL>",
                ),
                azure_native.app.v20220301.DaprMetadataArgs(
            ...
            secrets=[azure_native.app.v20220301.SecretArgs(
                name="masterkey",
                value="keyvalue",
            )],
            version="v1")
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20220101preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20220601preview:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20221001:DaprComponent"), pulumi.Alias(type_="azure-native:app/v20221101preview:DaprComponent")])
