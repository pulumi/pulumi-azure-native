...
def get_container_app(container_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_app is deprecated: azure-native:app/v20220301:ContainerApp is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20221001:ContainerApp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['containerAppName'] = container_app_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220301:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult).value
