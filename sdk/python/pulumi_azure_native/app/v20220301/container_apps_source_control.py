...
class ContainerAppsSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        container_apps_source_control = azure_native.app.v20220301.ContainerAppsSourceControl("containerAppsSourceControl",
            branch="master",
            container_app_name="testcanadacentral",
            github_action_configuration=azure_native.app.v20220301.GithubActionConfigurationResponseArgs(
                azure_credentials=azure_native.app.v20220301.AzureCredentialsArgs(
                    client_id="<clientid>",
                ...
                context_path="./",
                image="image/tag",
                registry_info=azure_native.app.v20220301.RegistryInfoArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerAppsSourceControl")])
