...
def get_container_apps_source_control(container_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_apps_source_control is deprecated: azure-native:app/v20220301:ContainerAppsSourceControl is being removed in the next major version of this provider. Upgrade to at least azure-native:app/v20230401preview:ContainerAppsSourceControl to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['containerAppName'] = container_app_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['sourceControlName'] = source_control_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20220301:getContainerAppsSourceControl', __args__, opts=opts, typ=GetContainerAppsSourceControlResult).value
