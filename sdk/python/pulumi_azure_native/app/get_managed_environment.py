...
class GetManagedEnvironmentResult:
    ...
    def dapr_ai_connection_string(self) -> Optional[builtins.str]:
        """
    ...
    def infrastructure_resource_group(self) -> Optional[builtins.str]:
        """
...
def get_managed_environment(environment_name: Optional[builtins.str] = None,
...
def get_managed_environment_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
