...
def get_connected_environment(connected_environment_name: Optional[builtins.str] = None,
...
def get_connected_environment_output(connected_environment_name: Optional[pulumi.Input[builtins.str]] = None,
