...
def get_connected_environment(connected_environment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connected_environment_name: Name of the connectedEnvironment.
...
def get_connected_environment_output(connected_environment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
