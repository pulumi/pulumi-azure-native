...
class ConnectedEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20220601preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221001:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20221101preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230401preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230501:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230502preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20230801preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240202preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240301:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20240802preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20241002preview:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app/v20250101:ConnectedEnvironment"), pulumi.Alias(type_="azure-native:app:ConnectedEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectedEnvironment, __self__).__init__(
            'azure-native:app/v20231102preview:ConnectedEnvironment',
            resource_name,
            __props__,
            opts)
