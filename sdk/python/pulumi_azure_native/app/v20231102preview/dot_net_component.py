...
class DotNetComponent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:DotNetComponent"), pulumi.Alias(type_="azure-native:app/v20240202preview:DotNetComponent"), pulumi.Alias(type_="azure-native:app/v20240802preview:DotNetComponent"), pulumi.Alias(type_="azure-native:app/v20241002preview:DotNetComponent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DotNetComponent, __self__).__init__(
            'azure-native:app/v20231102preview:DotNetComponent',
            resource_name,
            __props__,
            opts)
