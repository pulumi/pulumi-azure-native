...
class ManagedEnvironmentsStorage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220101preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220301:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20220601preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221001:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20221101preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230401preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230501:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230502preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20230801preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240202preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240301:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20240802preview:ManagedEnvironmentsStorage"), pulumi.Alias(type_="azure-native:app/v20241002preview:ManagedEnvironmentsStorage")])
