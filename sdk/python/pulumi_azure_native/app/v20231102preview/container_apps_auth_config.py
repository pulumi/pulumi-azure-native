...
class ContainerAppsAuthConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20230401preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20230501:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20230502preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20230801preview:ContainerAppsAuthConfig"), pulumi.Alias(type_="azure-native:app/v20240301:ContainerAppsAuthConfig")])
