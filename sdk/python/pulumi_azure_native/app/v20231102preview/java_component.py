...
class JavaComponent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20240202preview:JavaComponent"), pulumi.Alias(type_="azure-native:app/v20240802preview:JavaComponent"), pulumi.Alias(type_="azure-native:app/v20241002preview:JavaComponent"), pulumi.Alias(type_="azure-native:app/v20250101:JavaComponent"), pulumi.Alias(type_="azure-native:app:JavaComponent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JavaComponent, __self__).__init__(
            'azure-native:app/v20231102preview:JavaComponent',
            resource_name,
            __props__,
            opts)
