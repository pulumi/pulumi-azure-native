...
def get_container_app(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20231102preview:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult).value
...
def get_container_app_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20231102preview:getContainerApp', __args__, opts=opts, typ=GetContainerAppResult)
