...
class Build(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app/v20230801preview:Build"), pulumi.Alias(type_="azure-native:app/v20240202preview:Build"), pulumi.Alias(type_="azure-native:app/v20240802preview:Build"), pulumi.Alias(type_="azure-native:app/v20241002preview:Build"), pulumi.Alias(type_="azure-native:app:Build")])
