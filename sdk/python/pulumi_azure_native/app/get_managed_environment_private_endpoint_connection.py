...
__all__ = [
    ...
    'AwaitableGetManagedEnvironmentPrivateEndpointConnectionResult',
    'get_managed_environment_private_endpoint_connection',
    'get_managed_environment_private_endpoint_connection_output',
]
...
class AwaitableGetManagedEnvironmentPrivateEndpointConnectionResult(GetManagedEnvironmentPrivateEndpointConnectionResult):
...
def get_managed_environment_private_endpoint_connection(environment_name: Optional[builtins.str] = None,
...
def get_managed_environment_private_endpoint_connection_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
