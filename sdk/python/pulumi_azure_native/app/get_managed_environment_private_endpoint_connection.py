...
def get_managed_environment_private_endpoint_connection(environment_name: Optional[str] = None,
...
@_utilities.lift_output_func(get_managed_environment_private_endpoint_connection)
