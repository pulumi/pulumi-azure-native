...
def list_container_app_secrets(container_app_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult).value

    return AwaitableListContainerAppSecretsResult(
        value=pulumi.get(__ret__, 'value'))
def list_container_app_secrets_output(container_app_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:listContainerAppSecrets', __args__, opts=opts, typ=ListContainerAppSecretsResult)
