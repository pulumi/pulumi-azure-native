...
def get_container_app_auth_token(container_app_name: Optional[builtins.str] = None,
...
def get_container_app_auth_token_output(container_app_name: Optional[pulumi.Input[builtins.str]] = None,
