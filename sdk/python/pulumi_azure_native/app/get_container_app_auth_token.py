...
def get_container_app_auth_token(container_app_name: Optional[_builtins.str] = None,
...
def get_container_app_auth_token_output(container_app_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:app:getContainerAppAuthToken', __args__, opts=opts, typ=GetContainerAppAuthTokenResult)
