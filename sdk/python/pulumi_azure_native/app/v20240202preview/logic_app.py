...
class LogicApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:LogicApp"), pulumi.Alias(type_="azure-native:app/v20240802preview:LogicApp"), pulumi.Alias(type_="azure-native:app/v20241002preview:LogicApp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LogicApp, __self__).__init__(
            'azure-native:app/v20240202preview:LogicApp',
            resource_name,
            __props__,
            opts)
