...
def list_logic_app_workflows_connections(container_app_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20240202preview:listLogicAppWorkflowsConnections', __args__, opts=opts, typ=ListLogicAppWorkflowsConnectionsResult).value
...
def list_logic_app_workflows_connections_output(container_app_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20240202preview:listLogicAppWorkflowsConnections', __args__, opts=opts, typ=ListLogicAppWorkflowsConnectionsResult)
