...
class AppResiliency(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:AppResiliency"), pulumi.Alias(type_="azure-native:app/v20230801preview:AppResiliency"), pulumi.Alias(type_="azure-native:app/v20231102preview:AppResiliency")])
