...
class CertificateKeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str key_vault_url: URL pointing to the Azure Key Vault secret that holds the certificate.
        """
...
class ContainerAppResponsePatchingConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App auto patch configuration.
        :param str patching_mode: Patching mode for the container app. Null or default in this field will be interpreted as Automatic by RP. Automatic mode will automatically apply available patches. Manual mode will require the user to manually apply patches. Disabled mode will stop patch detection and auto patching.
        """
...
class ContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str image_type: The type of the image. Set to CloudBuild to let the system manages the image, where user will not be able to update image through image field. Set to ContainerImage for user provided image.
...
class CustomScaleRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str identity: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
...
class HeaderResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Header of otlp configuration
        :param str key: The key of otlp configuration header
        :param str value: The value of otlp configuration header
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class IdentitySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Optional settings for a Managed Identity that is assigned to the Container App.
        :param str identity: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
        :param str lifecycle: Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.
        """
        pulumi.set(__self__, "identity", identity)
...
class IngressResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_port_http_scheme: Optional[str] = None,
        ...
        :param str target_port_http_scheme: Whether an http app listens on http or https
    ...
    def target_port_http_scheme(self) -> Optional[str]:
        """
...
class JobScaleRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str identity: The resource ID of a user-assigned managed identity that is assigned to the job, or 'system' for system-assigned identity.
...
class LoggerSettingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Logger settings for java workloads.
        :param str level: The specified logger's log level.
...
class NfsAzureFilePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        NFS Azure File Properties.
        :param str access_mode: Access mode for storage
        :param str server: Server for NFS azure file.
        :param str share_name: NFS Azure file share name.
        """
        if access_mode is not None:
            pulumi.set(__self__, "access_mode", access_mode)
...
class OtlpConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Configuration of otlp 
        :param str endpoint: The endpoint of otlp configuration
        :param Sequence['HeaderResponse'] headers: Headers of otlp configurations
        :param bool insecure: Boolean indicating if otlp configuration is insecure
        :param str name: The name of otlp configuration
        """
...
class QueueScaleRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Container App container Azure Queue based scaling rule.
        :param str account_name: Storage account name. required if using managed identity to authenticate
...
class RuntimeResponseDotnet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        .NET app configuration
        :param bool auto_configure_data_protection: Auto configure the ASP.NET Core Data Protection feature
        """
    ...
    def auto_configure_data_protection(self) -> Optional[bool]:
        """
...
class RuntimeResponseJava(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Java app configuration
        :param bool enable_metrics: Enable jmx core metrics for the java app
...
class RuntimeResponseJavaAgent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Diagnostic capabilities achieved by java agent
        :param bool enabled: Enable java agent injection for the java app.
...
class SmbStorageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        SMB storage properties
        :param str access_mode: Access mode for storage
        :param str domain: The domain name for the user.
        :param str host: The host name or IP address of the SMB server.
        :param str password: The password for the user.
        :param str share_name: The path to the SMB shared folder.
        :param str username: The user to log on to the SMB server.
        """
        if access_mode is not None:
            pulumi.set(__self__, "access_mode", access_mode)
...
class VolumeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Volume definitions for the Container App.
        :param str mount_options: Mount options used while mounting the Azure file share or NFS Azure file share. Must be a comma-separated string.
