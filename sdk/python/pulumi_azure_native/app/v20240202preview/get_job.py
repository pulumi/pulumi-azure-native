...
def get_job(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20240202preview:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(job_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20240202preview:getJob', __args__, opts=opts, typ=GetJobResult)
