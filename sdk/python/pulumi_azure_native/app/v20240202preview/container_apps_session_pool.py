...
class ContainerAppsSessionPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerAppsSessionPool"), pulumi.Alias(type_="azure-native:app/v20240802preview:ContainerAppsSessionPool")])
