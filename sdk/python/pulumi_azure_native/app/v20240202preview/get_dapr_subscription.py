...
def get_dapr_subscription(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:app/v20240202preview:getDaprSubscription', __args__, opts=opts, typ=GetDaprSubscriptionResult).value
...
def get_dapr_subscription_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:app/v20240202preview:getDaprSubscription', __args__, opts=opts, typ=GetDaprSubscriptionResult)
