...
class AppInsightsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of Application Insights 
        :param pulumi.Input[str] connection_string: Application Insights connection string
        """
...
class CertificateKeyVaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key_vault_url: URL pointing to the Azure Key Vault secret that holds the certificate.
        """
...
if not MYPY:
    class CertificatePropertiesArgsDict(TypedDict):
        ...
        Properties for a certificate stored in a Key Vault.
        """
        certificate_type: NotRequired[pulumi.Input[Union[str, 'CertificateType']]]
        """
...
class CertificatePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 certificate_type: Optional[pulumi.Input[Union[str, 'CertificateType']]] = None,
        ...
        :param pulumi.Input[Union[str, 'CertificateType']] certificate_type: The type of the certificate. Allowed values are `ServerSSLCertificate` and `ImagePullTrustedCA`
    ...
    def certificate_type(self) -> Optional[pulumi.Input[Union[str, 'CertificateType']]]:
        """
        The type of the certificate. Allowed values are `ServerSSLCertificate` and `ImagePullTrustedCA`
        """
    ...
    def certificate_type(self, value: Optional[pulumi.Input[Union[str, 'CertificateType']]]):
...
if not MYPY:
    class ContainerAppPatchingConfigurationArgsDict(TypedDict):
        ...
        """
        patching_mode: NotRequired[pulumi.Input[Union[str, 'PatchingMode']]]
        """
...
class ContainerAppPatchingConfigurationArgs:
    def __init__(__self__, *,
                 patching_mode: Optional[pulumi.Input[Union[str, 'PatchingMode']]] = None):
        """
        Container App auto patch configuration.
        :param pulumi.Input[Union[str, 'PatchingMode']] patching_mode: Patching mode for the container app. Null or default in this field will be interpreted as Automatic by RP. Automatic mode will automatically apply available patches. Manual mode will require the user to manually apply patches. Disabled mode will stop patch detection and auto patching.
        """
    ...
    def patching_mode(self) -> Optional[pulumi.Input[Union[str, 'PatchingMode']]]:
        """
        Patching mode for the container app. Null or default in this field will be interpreted as Automatic by RP. Automatic mode will automatically apply available patches. Manual mode will require the user to manually apply patches. Disabled mode will stop patch detection and auto patching.
        """
    ...
    def patching_mode(self, value: Optional[pulumi.Input[Union[str, 'PatchingMode']]]):
...
if not MYPY:
    class ContainerArgsDict(TypedDict):
        ...
        Container image tag.
        """
        image_type: NotRequired[pulumi.Input[Union[str, 'ImageType']]]
        """
...
class ContainerArgs:
    def __init__(__self__, *,
                 ...
                 image: Optional[pulumi.Input[str]] = None,
                 image_type: Optional[pulumi.Input[Union[str, 'ImageType']]] = None,
        ...
        :param pulumi.Input[Union[str, 'ImageType']] image_type: The type of the image. Set to CloudBuild to let the system manages the image, where user will not be able to update image through image field. Set to ContainerImage for user provided image.
    ...
    def image_type(self) -> Optional[pulumi.Input[Union[str, 'ImageType']]]:
        """
        The type of the image. Set to CloudBuild to let the system manages the image, where user will not be able to update image through image field. Set to ContainerImage for user provided image.
        """
    ...
    @image_type.setter
    def image_type(self, value: Optional[pulumi.Input[Union[str, 'ImageType']]]):
...
class CustomScaleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] identity: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
...
class DaprComponentResiliencyPolicyCircuitBreakerPolicyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Dapr Component Resiliency Policy Circuit Breaker Policy Configuration.
        :param pulumi.Input[int] consecutive_errors: The number of consecutive errors before the circuit is opened.
        :param pulumi.Input[int] interval_in_seconds: The optional interval in seconds after which the error count resets to 0. An interval of 0 will never reset. If not specified, the timeoutInSeconds value will be used.
        :param pulumi.Input[int] timeout_in_seconds: The interval in seconds until a retry attempt is made after the circuit is opened.
        """
        if consecutive_errors is not None:
            pulumi.set(__self__, "consecutive_errors", consecutive_errors)
        if interval_in_seconds is not None:
...
class DaprServiceBindMetadataArgs:
    def __init__(__self__, *,
        ...
        """
        Dapr component metadata.
        :param pulumi.Input[str] name: Service bind metadata property name.
        :param pulumi.Input[str] value: Service bind metadata property value.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class DataDogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of datadog 
        :param pulumi.Input[str] key: The data dog api key
        :param pulumi.Input[str] site: The data dog site
        """
        if key is not None:
...
class HeaderArgs:
    def __init__(__self__, *,
        ...
        """
        Header of otlp configuration
        :param pulumi.Input[str] key: The key of otlp configuration header
        :param pulumi.Input[str] value: The value of otlp configuration header
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
if not MYPY:
    class IdentitySettingsArgsDict(TypedDict):
        ...
        The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
        """
        lifecycle: NotRequired[pulumi.Input[Union[str, 'IdentitySettingsLifeCycle']]]
        """
...
class IdentitySettingsArgs:
    def __init__(__self__, *,
                 identity: pulumi.Input[str],
                 lifecycle: Optional[pulumi.Input[Union[str, 'IdentitySettingsLifeCycle']]] = None):
        """
        Optional settings for a Managed Identity that is assigned to the Container App.
        :param pulumi.Input[str] identity: The resource ID of a user-assigned managed identity that is assigned to the Container App, or 'system' for system-assigned identity.
        :param pulumi.Input[Union[str, 'IdentitySettingsLifeCycle']] lifecycle: Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.
        """
        pulumi.set(__self__, "identity", identity)
    ...
    @property
    @pulumi.getter
    def lifecycle(self) -> Optional[pulumi.Input[Union[str, 'IdentitySettingsLifeCycle']]]:
        """
        Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.
        """
    ...
    @lifecycle.setter
    def lifecycle(self, value: Optional[pulumi.Input[Union[str, 'IdentitySettingsLifeCycle']]]):
...
if not MYPY:
    class IngressArgsDict(TypedDict):
        ...
        """
        target_port_http_scheme: NotRequired[pulumi.Input[Union[str, 'IngressTargetPortHttpScheme']]]
        """
...
class IngressArgs:
    def __init__(__self__, *,
                 ...
                 target_port_http_scheme: Optional[pulumi.Input[Union[str, 'IngressTargetPortHttpScheme']]] = None,
        ...
        :param pulumi.Input[Union[str, 'IngressTargetPortHttpScheme']] target_port_http_scheme: Whether an http app listens on http or https
    ...
    def target_port_http_scheme(self) -> Optional[pulumi.Input[Union[str, 'IngressTargetPortHttpScheme']]]:
        """
        Whether an http app listens on http or https
        """
    ...
    def target_port_http_scheme(self, value: Optional[pulumi.Input[Union[str, 'IngressTargetPortHttpScheme']]]):
...
class JobScaleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] identity: The resource ID of a user-assigned managed identity that is assigned to the job, or 'system' for system-assigned identity.
...
if not MYPY:
    class LogAnalyticsConfigurationArgsDict(TypedDict):
        ...
        """
        dynamic_json_columns: NotRequired[pulumi.Input[bool]]
        """
...
class LogAnalyticsConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 dynamic_json_columns: Optional[pulumi.Input[bool]] = None,
                 shared_key: Optional[pulumi.Input[str]] = None):
        """
        Log Analytics configuration, must only be provided when destination is configured as 'log-analytics'
        :param pulumi.Input[str] customer_id: Log analytics customer id
        :param pulumi.Input[bool] dynamic_json_columns: Boolean indicating whether to parse json string log into dynamic json columns
    ...
    def dynamic_json_columns(self) -> Optional[pulumi.Input[bool]]:
        """
        Boolean indicating whether to parse json string log into dynamic json columns
        """
    ...
    def dynamic_json_columns(self, value: Optional[pulumi.Input[bool]]):
...
class LoggerSettingArgs:
    def __init__(__self__, *,
        ...
        """
        Logger settings for java workloads.
        :param pulumi.Input[Union[str, 'Level']] level: The specified logger's log level.
        :param pulumi.Input[str] logger: Logger name.
        """
    ...
    @property
    @pulumi.getter
    def logger(self) -> pulumi.Input[str]:
        """
        Logger name.
        """
    ...
    @logger.setter
    def logger(self, value: pulumi.Input[str]):
...
class LogsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of Open Telemetry logs
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Open telemetry logs destinations
        """
...
class MetricsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of Open Telemetry metrics
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Open telemetry metrics destinations
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
...
class NacosComponentArgs:
    def __init__(__self__, *,
        ...
        """
        Nacos properties.
        :param pulumi.Input[str] component_type: Type of the Java Component.
               Expected value is 'Nacos'.
...
class NfsAzureFilePropertiesArgs:
    def __init__(__self__, *,
        ...
        NFS Azure File Properties.
        :param pulumi.Input[Union[str, 'AccessMode']] access_mode: Access mode for storage
        :param pulumi.Input[str] server: Server for NFS azure file.
        :param pulumi.Input[str] share_name: NFS Azure file share name.
        """
        if access_mode is not None:
            pulumi.set(__self__, "access_mode", access_mode)
...
class OtlpConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of otlp 
        :param pulumi.Input[str] endpoint: The endpoint of otlp configuration
        :param pulumi.Input[Sequence[pulumi.Input['HeaderArgs']]] headers: Headers of otlp configurations
        :param pulumi.Input[bool] insecure: Boolean indicating if otlp configuration is insecure
        :param pulumi.Input[str] name: The name of otlp configuration
        """
...
class QueueScaleRuleArgs:
    def __init__(__self__, *,
        ...
        """
        Container App container Azure Queue based scaling rule.
        :param pulumi.Input[str] account_name: Storage account name. required if using managed identity to authenticate
...
if not MYPY:
    class RuntimeDotnetArgsDict(TypedDict):
        ...
        """
        auto_configure_data_protection: NotRequired[pulumi.Input[bool]]
        """
...
class RuntimeDotnetArgs:
    def __init__(__self__, *,
                 auto_configure_data_protection: Optional[pulumi.Input[bool]] = None):
        """
        .NET app configuration
        :param pulumi.Input[bool] auto_configure_data_protection: Auto configure the ASP.NET Core Data Protection feature
        """
    ...
    def auto_configure_data_protection(self) -> Optional[pulumi.Input[bool]]:
        """
        Auto configure the ASP.NET Core Data Protection feature
        """
    ...
    def auto_configure_data_protection(self, value: Optional[pulumi.Input[bool]]):
...
class RuntimeJavaAgentArgs:
    def __init__(__self__, *,
        ...
        """
        Diagnostic capabilities achieved by java agent
        :param pulumi.Input[bool] enabled: Enable java agent injection for the java app.
...
class RuntimeJavaArgs:
    def __init__(__self__, *,
        ...
        """
        Java app configuration
        :param pulumi.Input[bool] enable_metrics: Enable jmx core metrics for the java app
...
if not MYPY:
    class ServiceBindArgsDict(TypedDict):
        ...
        """
        client_type: NotRequired[pulumi.Input[str]]
        """
...
class ServiceBindArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration to bind a ContainerApp to a dev ContainerApp Service
        :param pulumi.Input[str] client_type: Type of the client to be used to connect to the service
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] customized_keys: Customized keys for customizing injected values to the app
        :param pulumi.Input[str] name: Name of the service bind
        :param pulumi.Input[str] service_id: Resource id of the target service
        """
...
class SmbStorageArgs:
    def __init__(__self__, *,
        ...
        SMB storage properties
        :param pulumi.Input[Union[str, 'AccessMode']] access_mode: Access mode for storage
        :param pulumi.Input[str] domain: The domain name for the user.
        :param pulumi.Input[str] host: The host name or IP address of the SMB server.
        :param pulumi.Input[str] password: The password for the user.
        :param pulumi.Input[str] share_name: The path to the SMB shared folder.
        :param pulumi.Input[str] username: The user to log on to the SMB server.
        """
        if access_mode is not None:
            pulumi.set(__self__, "access_mode", access_mode)
...
class TracesConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Configuration of Open Telemetry traces
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Open telemetry traces destinations
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        """
        Volume definitions for the Container App.
        :param pulumi.Input[str] mount_options: Mount options used while mounting the Azure file share or NFS Azure file share. Must be a comma-separated string.
