...
def get_container_apps_auth_config(auth_config_name: Optional[_builtins.str] = None,
                                   container_app_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str auth_config_name: Name of the Container App AuthConfig.
...
def get_container_apps_auth_config_output(auth_config_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
