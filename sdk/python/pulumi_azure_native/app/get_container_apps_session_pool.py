...
def get_container_apps_session_pool(resource_group_name: Optional[_builtins.str] = None,
                                    session_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str session_pool_name: Name of the session pool.
    """
    __args__ = dict()
