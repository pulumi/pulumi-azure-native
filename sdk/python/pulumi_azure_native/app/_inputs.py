...
if not MYPY:
    class BlobStorageTokenStoreArgsDict(TypedDict):
        ...
        """
        sas_url_setting_name: pulumi.Input[_builtins.str]
        """
...
class BlobStorageTokenStoreArgs:
    def __init__(__self__, *,
        ...
        """
        The configuration settings of the storage of the tokens if blob storage is used.
        :param pulumi.Input[_builtins.str] sas_url_setting_name: The name of the app secrets containing the SAS URL of the blob storage containing the tokens.
        """
        pulumi.set(__self__, "sas_url_setting_name", sas_url_setting_name)

    @_builtins.property
    @pulumi.getter(name="sasUrlSettingName")
    def sas_url_setting_name(self) -> pulumi.Input[_builtins.str]:
        """
        The name of the app secrets containing the SAS URL of the blob storage containing the tokens.
        """
    ...
    def sas_url_setting_name(self, value: pulumi.Input[_builtins.str]):
...
class NfsAzureFilePropertiesArgs:
    def __init__(__self__, *,
        ...
        NFS Azure File Properties.
        :param pulumi.Input[Union[_builtins.str, 'AccessMode']] access_mode: Access mode for storage
        :param pulumi.Input[_builtins.str] server: Server for NFS azure file. Specify the Azure storage account server address.
...
class ScaleArgs:
    def __init__(__self__, *,
        ...
        """
        Container App scaling configurations.
        :param pulumi.Input[_builtins.int] cooldown_period: Optional. KEDA Cooldown Period in seconds. Defaults to 300 seconds if not set.
        ...
        :param pulumi.Input[_builtins.int] polling_interval: Optional. KEDA Polling Interval in seconds. Defaults to 30 seconds if not set.
