...
class EnvironmentSkuPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        EnvironmentSkuPropertiesArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            name=name,
        )
    @staticmethod
...
class ManagedEnvironmentOutboundSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        ManagedEnvironmentOutboundSettingsArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            out_bound_type=out_bound_type,
            virtual_network_appliance_ip=virtual_network_appliance_ip,
        )
    @staticmethod
    def _configure(
             _setter: Callable[[Any, Any], None],
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if out_bound_type is None and 'outBoundType' in kwargs:
            out_bound_type = kwargs['outBoundType']
        if virtual_network_appliance_ip is None and 'virtualNetworkApplianceIp' in kwargs:
            virtual_network_appliance_ip = kwargs['virtualNetworkApplianceIp']

        if out_bound_type is not None:
            _setter("out_bound_type", out_bound_type)
        if virtual_network_appliance_ip is not None:
            _setter("virtual_network_appliance_ip", virtual_network_appliance_ip)
...
class VnetConfigurationArgs:
    ...
    def _configure(
        ...
        if outbound_settings is None and 'outboundSettings' in kwargs:
            outbound_settings = kwargs['outboundSettings']
        ...
        if runtime_subnet_id is None and 'runtimeSubnetId' in kwargs:
        ...
        if outbound_settings is not None:
            _setter("outbound_settings", outbound_settings)
