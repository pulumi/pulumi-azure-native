...
class ManagedEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 peer_traffic_configuration: Optional[pulumi.Input[pulumi.InputType['ManagedEnvironmentPeerTrafficConfigurationArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ManagedEnvironmentPeerTrafficConfigurationArgs']] peer_traffic_configuration: Peer traffic settings for the Managed Environment
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
    ...
    def _internal_init(__self__,
        ...
        super(ManagedEnvironment, __self__).__init__(
            'azure-native:app/v20240301:ManagedEnvironment',
            resource_name,
            __props__,
            opts)
