...
class ContainerAppsSourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:app:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220101preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220301:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20220601preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221001:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20221101preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20230401preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20230501:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20230502preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20230801preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20231102preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20240202preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20240802preview:ContainerAppsSourceControl"), pulumi.Alias(type_="azure-native:app/v20241002preview:ContainerAppsSourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContainerAppsSourceControl, __self__).__init__(
            'azure-native:app/v20240301:ContainerAppsSourceControl',
            resource_name,
            __props__,
            opts)
