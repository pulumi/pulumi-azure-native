...
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devops:Pipeline"), pulumi.Alias(type_="azure-native:devops/v20190701preview:Pipeline")])
