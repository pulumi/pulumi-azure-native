...
def get_app_service_certificate_order(certificate_order_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_certificate_order is deprecated: azure-native:certificateregistration/v20210115:AppServiceCertificateOrder is being removed in the next major version of this provider. Please upgrade to azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.""")
    __args__ = dict()
