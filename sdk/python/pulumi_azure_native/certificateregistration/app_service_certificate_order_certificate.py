...
class AppServiceCertificateOrderCertificateArgs:
    def __init__(__self__, *,
                 certificate_order_name: pulumi.Input[builtins.str],
    ...
    def certificate_order_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_order_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:certificateregistration:AppServiceCertificateOrderCertificate")
