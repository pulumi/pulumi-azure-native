...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:certificateregistration:AppServiceCertificateOrderCertificate'.""", DeprecationWarning)
...
class AppServiceCertificateOrderCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(AppServiceCertificateOrderCertificate, __self__).__init__(
            'azure-native:certificateregistration/latest:AppServiceCertificateOrderCertificate',
            resource_name,
            __props__,
            opts)
