...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:certificateregistration:getAppServiceCertificateOrderCertificate'.""", DeprecationWarning)
...
def get_app_service_certificate_order_certificate(certificate_order_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:certificateregistration/latest:getAppServiceCertificateOrderCertificate', __args__, opts=opts, typ=GetAppServiceCertificateOrderCertificateResult).value
