...
class AppServiceCertificateOrder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validity_in_years: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""AppServiceCertificateOrder is deprecated: Version 2020-12-01 will be removed in v2 of the provider.""")
