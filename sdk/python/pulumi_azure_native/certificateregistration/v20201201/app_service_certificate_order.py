...
warnings.warn("""azure-native:certificateregistration/v20201201:AppServiceCertificateOrder is being removed in the next major version of this provider. Please upgrade to azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.""", DeprecationWarning)
...
class AppServiceCertificateOrder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 validity_in_years: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""AppServiceCertificateOrder is deprecated: azure-native:certificateregistration/v20201201:AppServiceCertificateOrder is being removed in the next major version of this provider. Please upgrade to azure-native:certificateregistration/v20220901:AppServiceCertificateOrder to guarantee forwards compatibility.""")
