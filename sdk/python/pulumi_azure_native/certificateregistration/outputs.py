...
class AppServiceCertificateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Key Vault container for a certificate that is purchased through Azure.
        :param builtins.str provisioning_state: Status of the Key Vault secret.
        :param builtins.str key_vault_id: Key Vault resource Id.
        :param builtins.str key_vault_secret_name: Key Vault secret name.
        """
...
class CertificateDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str not_after: Date Certificate is valid to.
        :param builtins.str not_before: Date Certificate is valid from.
        :param builtins.str raw_data: Raw certificate data.
        ...
        :param builtins.int version: Certificate Version.
        """
    ...
    def raw_data(self) -> builtins.str:
        """
...
class CertificateOrderContactResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name_first: Optional[builtins.str] = None,
                 name_last: Optional[builtins.str] = None,
    ...
    def name_first(self) -> Optional[builtins.str]:
        return pulumi.get(self, "name_first")

    @property
    @pulumi.getter(name="nameLast")
    def name_last(self) -> Optional[builtins.str]:
