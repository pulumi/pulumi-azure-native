...
def get_address_by_name(address_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_address_by_name is deprecated: Version v20201201preview will be removed in the next major version of the provider. Upgrade to version v20211201 or later.""")
    __args__ = dict()
