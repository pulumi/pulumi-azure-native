...
def list_products_and_configuration_product_families(customer_subscription_details: Optional[pulumi.InputType['CustomerSubscriptionDetails']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edgeorder/v20240201:listProductsAndConfigurationProductFamilies', __args__, opts=opts, typ=ListProductsAndConfigurationProductFamiliesResult).value
