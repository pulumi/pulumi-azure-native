...
def get_order_item(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edgeorder/v20240201:getOrderItem', __args__, opts=opts, typ=GetOrderItemResult).value
...
def get_order_item_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:edgeorder/v20240201:getOrderItem', __args__, opts=opts, typ=GetOrderItemResult)
