...
class OrderItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edgeorder:OrderItem"), pulumi.Alias(type_="azure-native:edgeorder/v20201201preview:OrderItem"), pulumi.Alias(type_="azure-native:edgeorder/v20211201:OrderItem"), pulumi.Alias(type_="azure-native:edgeorder/v20220501preview:OrderItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OrderItem, __self__).__init__(
            'azure-native:edgeorder/v20240201:OrderItem',
            resource_name,
            __props__,
            opts)
