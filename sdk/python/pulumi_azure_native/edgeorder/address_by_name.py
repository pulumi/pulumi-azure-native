...
class AddressByName(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        address_by_name = azure_native.edgeorder.AddressByName("addressByName",
            ...
            shipping_address=azure_native.edgeorder.ShippingAddressResponseArgs(
                address_type="None",
                city="San Francisco",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edgeorder/v20201201preview:AddressByName"), pulumi.Alias(type_="azure-native:edgeorder/v20211201:AddressByName"), pulumi.Alias(type_="azure-native:edgeorder/v20220501preview:AddressByName")])
