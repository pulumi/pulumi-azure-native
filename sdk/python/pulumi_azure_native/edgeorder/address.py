...
class Address(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if contact_details is not None and not isinstance(contact_details, ContactDetailsArgs):
            ...
            if shipping_address is not None and not isinstance(shipping_address, ShippingAddressArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edgeorder/v20201201preview:Address"), pulumi.Alias(type_="azure-native:edgeorder/v20211201:Address"), pulumi.Alias(type_="azure-native:edgeorder/v20220501preview:Address")])
