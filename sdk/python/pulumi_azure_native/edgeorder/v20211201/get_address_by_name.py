...
def get_address_by_name(address_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:edgeorder/v20211201:getAddressByName', __args__, opts=opts, typ=GetAddressByNameResult).value
...
def get_address_by_name_output(address_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:edgeorder/v20211201:getAddressByName', __args__, opts=opts, typ=GetAddressByNameResult)
