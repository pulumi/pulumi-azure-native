...
class Address(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        address = azure_native.edgeorder.v20220501preview.Address("address",
            address_name="TestAddressName2",
            contact_details=azure_native.edgeorder.v20220501preview.ContactDetailsArgs(
            ...
            shipping_address=azure_native.edgeorder.v20220501preview.ShippingAddressResponseArgs(
                address_type="None",
                city="San Francisco",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:edgeorder:Address"), pulumi.Alias(type_="azure-native:edgeorder/v20201201preview:Address"), pulumi.Alias(type_="azure-native:edgeorder/v20211201:Address")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Address, __self__).__init__(
            'azure-native:edgeorder/v20220501preview:Address',
            resource_name,
            __props__,
            opts)
