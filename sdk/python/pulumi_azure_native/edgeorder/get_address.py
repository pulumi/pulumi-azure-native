...
def get_address(address_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str address_name: The name of the address Resource within the specified resource group. address names must be between 3 and 24 characters in length and use any alphanumeric and underscore only.
...
def get_address_output(address_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
