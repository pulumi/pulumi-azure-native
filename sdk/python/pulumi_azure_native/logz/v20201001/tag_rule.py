...
warnings.warn("""azure-native:logz/v20201001:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:TagRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class TagRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[pulumi.InputType['MonitoringTagRulesPropertiesArgs']] properties: Definition of the properties for a TagRules resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
                 ...
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagRule is deprecated: azure-native:logz/v20201001:TagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:TagRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:TagRule"), pulumi.Alias(type_="azure-native:logz/v20201001preview:TagRule"), pulumi.Alias(type_="azure-native:logz/v20220101preview:TagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagRule, __self__).__init__(
            'azure-native:logz/v20201001:TagRule',
            resource_name,
            __props__,
            opts)
