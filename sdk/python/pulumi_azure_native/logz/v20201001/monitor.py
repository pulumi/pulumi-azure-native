...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        monitor = azure_native.logz.v20201001.Monitor("monitor",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:Monitor"), pulumi.Alias(type_="azure-native:logz/v20201001preview:Monitor"), pulumi.Alias(type_="azure-native:logz/v20220101preview:Monitor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Monitor, __self__).__init__(
            'azure-native:logz/v20201001:Monitor',
            resource_name,
            __props__,
            opts)
