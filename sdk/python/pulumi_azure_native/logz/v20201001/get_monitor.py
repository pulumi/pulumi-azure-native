...
warnings.warn("""azure-native:logz/v20201001:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:Monitor to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_monitor(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitor is deprecated: azure-native:logz/v20201001:Monitor is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:Monitor to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['monitorName'] = monitor_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:logz/v20201001:getMonitor', __args__, opts=opts, typ=GetMonitorResult).value
