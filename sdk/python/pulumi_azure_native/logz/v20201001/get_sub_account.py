...
def get_sub_account(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sub_account is deprecated: azure-native:logz/v20201001:SubAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccount to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['monitorName'] = monitor_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['subAccountName'] = sub_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:logz/v20201001:getSubAccount', __args__, opts=opts, typ=GetSubAccountResult).value
