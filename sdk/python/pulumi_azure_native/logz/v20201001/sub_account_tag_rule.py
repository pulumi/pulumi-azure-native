...
warnings.warn("""azure-native:logz/v20201001:SubAccountTagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccountTagRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class SubAccountTagRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sub_account_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SubAccountTagRule is deprecated: azure-native:logz/v20201001:SubAccountTagRule is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccountTagRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20201001preview:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20220101preview:SubAccountTagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubAccountTagRule, __self__).__init__(
            'azure-native:logz/v20201001:SubAccountTagRule',
            resource_name,
            __props__,
            opts)
