...
class SubAccountArgs:
    ...
    def _configure(
        ...
        if sub_account_name is None and 'subAccountName' in kwargs:
            sub_account_name = kwargs['subAccountName']
...
class SubAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:SubAccount"), pulumi.Alias(type_="azure-native:logz/v20201001:SubAccount"), pulumi.Alias(type_="azure-native:logz/v20201001preview:SubAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubAccount, __self__).__init__(
            'azure-native:logz/v20220101preview:SubAccount',
            resource_name,
            __props__,
            opts)
