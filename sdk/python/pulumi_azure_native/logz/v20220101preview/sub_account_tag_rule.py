...
class SubAccountTagRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sub_account_tag_rule = azure_native.logz.v20220101preview.SubAccountTagRule("subAccountTagRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20201001:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20201001preview:SubAccountTagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubAccountTagRule, __self__).__init__(
            'azure-native:logz/v20220101preview:SubAccountTagRule',
            resource_name,
            __props__,
            opts)
