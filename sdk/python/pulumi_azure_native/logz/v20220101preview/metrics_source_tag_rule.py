...
class MetricsSourceTagRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        metrics_source_tag_rule = azure_native.logz.v20220101preview.MetricsSourceTagRule("metricsSourceTagRule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:MetricsSourceTagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetricsSourceTagRule, __self__).__init__(
            'azure-native:logz/v20220101preview:MetricsSourceTagRule',
            resource_name,
            __props__,
            opts)
