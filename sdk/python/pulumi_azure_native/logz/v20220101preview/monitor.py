...
class Monitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        monitor = azure_native.logz.v20220101preview.Monitor("monitor",
        ...
        ```sh
        $ pulumi import azure-native:logz/v20220101preview:Monitor myMonitor /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/monitors/myMonitor 
        ```
