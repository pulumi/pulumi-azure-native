...
def list_monitor_vm_hosts(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz/v20220101preview:listMonitorVMHosts', __args__, opts=opts, typ=ListMonitorVMHostsResult).value
...
def list_monitor_vm_hosts_output(monitor_name: Optional[pulumi.Input[str]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListMonitorVMHostsResult]:
    """
    Response of a list VM Host Update Operation.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz/v20220101preview:listMonitorVMHosts', __args__, opts=opts, typ=ListMonitorVMHostsResult)
    return __ret__.apply(lambda __response__: ListMonitorVMHostsResult(
