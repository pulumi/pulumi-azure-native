...
__all__ = ['MetricsSourceTagRuleArgs', 'MetricsSourceTagRule']

@pulumi.input_type
class MetricsSourceTagRuleArgs:
    ...
    def _configure(
        ...
        if metrics_source_name is None:
            raise TypeError("Missing 'metrics_source_name' argument")
    ...
    def metrics_source_name(self) -> pulumi.Input[str]:
        """
    ...
    def metrics_source_name(self, value: pulumi.Input[str]):
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['MetricsTagRulesPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['MetricsTagRulesPropertiesArgs']]):
...
class MetricsSourceTagRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 metrics_source_name: Optional[pulumi.Input[str]] = None,
                 monitor_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['MetricsTagRulesPropertiesArgs']]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] metrics_source_name: Metrics Account resource name
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[pulumi.InputType['MetricsTagRulesPropertiesArgs']] properties: Definition of the properties for a TagRules resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MetricsSourceTagRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if metrics_source_name is None and not opts.urn:
                raise TypeError("Missing required property 'metrics_source_name'")
            ...
            properties = _utilities.configure(properties, MetricsTagRulesPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz/v20220101preview:MetricsSourceTagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetricsSourceTagRule, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MetricsSourceTagRule':
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MetricsTagRulesPropertiesResponse']:
        """
        Definition of the properties for a TagRules resource.
        """
        return pulumi.get(self, "properties")
