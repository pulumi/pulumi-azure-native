...
class MetricsSourceTagRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['MetricsTagRulesPropertiesArgs', 'MetricsTagRulesPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[str] metrics_source_name: Metrics Account resource name
        :param pulumi.Input[str] monitor_name: Monitor resource name
        :param pulumi.Input[Union['MetricsTagRulesPropertiesArgs', 'MetricsTagRulesPropertiesArgsDict']] properties: Definition of the properties for a TagRules resource.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
