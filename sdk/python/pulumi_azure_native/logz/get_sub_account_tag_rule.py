...
__all__ = [
    ...
    'AwaitableGetSubAccountTagRuleResult',
    'get_sub_account_tag_rule',
    'get_sub_account_tag_rule_output',
]

@pulumi.output_type
class GetSubAccountTagRuleResult:
    """
...
class AwaitableGetSubAccountTagRuleResult(GetSubAccountTagRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSubAccountTagRuleResult(
            id=self.id,
            name=self.name,
...
def get_sub_account_tag_rule(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz:getSubAccountTagRule', __args__, opts=opts, typ=GetSubAccountTagRuleResult).value

    return AwaitableGetSubAccountTagRuleResult(
...
def get_sub_account_tag_rule_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['subAccountName'] = sub_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz:getSubAccountTagRule', __args__, opts=opts, typ=GetSubAccountTagRuleResult)
