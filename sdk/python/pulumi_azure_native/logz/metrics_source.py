...
__all__ = ['MetricsSourceArgs', 'MetricsSource']

@pulumi.input_type
class MetricsSourceArgs:
    def __init__(__self__, *,
                 monitor_name: pulumi.Input[str],
                 resource_group_name: pulumi.Input[str],
                 identity: Optional[pulumi.Input['IdentityPropertiesArgs']] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 metrics_source_name: Optional[pulumi.Input[str]] = None,
    ...
    def _configure(
        ...
        if metrics_source_name is None and 'metricsSourceName' in kwargs:
            metrics_source_name = kwargs['metricsSourceName']
    ...
    def metrics_source_name(self) -> Optional[pulumi.Input[str]]:
        """
        Metrics Account resource name
        """
        return pulumi.get(self, "metrics_source_name")

    @metrics_source_name.setter
    def metrics_source_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "metrics_source_name", value)
...
class MetricsSource(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MetricsSourceArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MetricsSourceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MetricsSourceArgs.__new__(MetricsSourceArgs)

            identity = _utilities.configure(identity, IdentityPropertiesArgs, True)
            __props__.__dict__["identity"] = identity
            __props__.__dict__["location"] = location
            __props__.__dict__["metrics_source_name"] = metrics_source_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz/v20220101preview:MetricsSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetricsSource, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MetricsSource':
        """
        ...
        __props__.__dict__["type"] = None
        return MetricsSource(resource_name, opts=opts, __props__=__props__)
