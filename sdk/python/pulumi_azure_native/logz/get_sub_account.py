...
def get_sub_account(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz:getSubAccount', __args__, opts=opts, typ=GetSubAccountResult).value
...
def get_sub_account_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['subAccountName'] = sub_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz:getSubAccount', __args__, opts=opts, typ=GetSubAccountResult)
