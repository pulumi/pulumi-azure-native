...
def list_monitor_vm_hosts(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz:listMonitorVMHosts', __args__, opts=opts, typ=ListMonitorVMHostsResult).value
...
def list_monitor_vm_hosts_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz:listMonitorVMHosts', __args__, opts=opts, typ=ListMonitorVMHostsResult)
