...
def list_sub_account_monitored_resources(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz:listSubAccountMonitoredResources', __args__, opts=opts, typ=ListSubAccountMonitoredResourcesResult).value
...
def list_sub_account_monitored_resources_output(monitor_name: Optional[pulumi.Input[str]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListSubAccountMonitoredResourcesResult]:
    """
    Response of a list operation.
    Azure REST API version: 2022-01-01-preview.
