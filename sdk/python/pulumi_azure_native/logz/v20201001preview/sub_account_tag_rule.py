...
warnings.warn("""azure-native:logz/v20201001preview:SubAccountTagRule is being removed in the next major version of this provider. Please upgrade to azure-native:logz/v20220101preview:SubAccountTagRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class SubAccountTagRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20201001:SubAccountTagRule"), pulumi.Alias(type_="azure-native:logz/v20220101preview:SubAccountTagRule")])
