...
def list_sub_account_vm_hosts(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz/v20201001preview:listSubAccountVMHosts', __args__, opts=opts, typ=ListSubAccountVMHostsResult).value
...
def list_sub_account_vm_hosts_output(monitor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz/v20201001preview:listSubAccountVMHosts', __args__, opts=opts, typ=ListSubAccountVMHostsResult)
