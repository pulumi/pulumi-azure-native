...
warnings.warn("""azure-native:logz/v20201001preview:TagRule is being removed in the next major version of this provider. Please upgrade to azure-native:logz/v20220101preview:TagRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class TagRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rule_set_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagRule is deprecated: azure-native:logz/v20201001preview:TagRule is being removed in the next major version of this provider. Please upgrade to azure-native:logz/v20220101preview:TagRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:TagRule"), pulumi.Alias(type_="azure-native:logz/v20201001:TagRule"), pulumi.Alias(type_="azure-native:logz/v20220101preview:TagRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TagRule, __self__).__init__(
            'azure-native:logz/v20201001preview:TagRule',
            resource_name,
            __props__,
            opts)
