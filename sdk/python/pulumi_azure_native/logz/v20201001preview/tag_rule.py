...
class TagRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logz/v20201001preview:TagRule"), pulumi.Alias(type_="azure-native:logz:TagRule"), pulumi.Alias(type_="azure-nextgen:logz:TagRule")])
