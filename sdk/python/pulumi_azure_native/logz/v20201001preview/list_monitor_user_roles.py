...
def list_monitor_user_roles(email_address: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logz/v20201001preview:listMonitorUserRoles', __args__, opts=opts, typ=ListMonitorUserRolesResult).value
...
def list_monitor_user_roles_output(email_address: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:logz/v20201001preview:listMonitorUserRoles', __args__, opts=opts, typ=ListMonitorUserRolesResult)
