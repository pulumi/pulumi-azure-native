...
class SubAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SubAccount is deprecated: azure-native:logz/v20201001preview:SubAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:logz/v20220101preview:SubAccount to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:logz:SubAccount"), pulumi.Alias(type_="azure-native:logz/v20201001:SubAccount"), pulumi.Alias(type_="azure-native:logz/v20220101preview:SubAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubAccount, __self__).__init__(
            'azure-native:logz/v20201001preview:SubAccount',
            resource_name,
            __props__,
            opts)
