...
def get_database_account_sql_container(account_name: Optional[_builtins.str] = None,
...
def get_database_account_sql_container_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
