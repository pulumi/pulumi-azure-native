...
def get_fleet_analytic(fleet_analytics_name: Optional[_builtins.str] = None,
...
def get_fleet_analytic_output(fleet_analytics_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
