...
class CassandraResourceCassandraViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] keyspace_name: Cosmos DB keyspace name.
        ...
        :param pulumi.Input[_builtins.str] view_name: Cosmos DB view name.
        """
...
class CassandraResourceCassandraView(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource: Optional[pulumi.Input[Union['CassandraViewResourceArgs', 'CassandraViewResourceArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['CassandraViewResourceArgs', 'CassandraViewResourceArgsDict']] resource: The standard JSON format of a Cassandra view
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
        :param pulumi.Input[_builtins.str] view_name: Cosmos DB view name.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20210701preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20211015preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20211115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20220215preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20220515preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20220815preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20221115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20230301preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20230315preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20230915preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20231115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20240215preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20240515preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20240901preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20241201preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20250501preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20251101preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:cosmosdb/v20260401preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20230915preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb:CassandraResourceCassandraView")])
