...
def get_table_resource_table(account_name: Optional[builtins.str] = None,
...
def get_table_resource_table_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
