...
@pulumi.type_token("azure-native:cosmosdb:MongoDBResourceMongoDBDatabase")
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource: pulumi.Input[Optional[Union['MongoDBDatabaseResourceArgs', 'MongoDBDatabaseResourceArgsDict']]] = None,
