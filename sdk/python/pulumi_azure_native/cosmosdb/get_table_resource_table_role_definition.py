...
def get_table_resource_table_role_definition(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult).value
...
def get_table_resource_table_role_definition_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult)
