...
class MongoDBResourceMongoUserDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 mechanisms: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_data: A custom definition for the USer Definition.
        :param pulumi.Input[builtins.str] database_name: The database name for which access is being granted for this User Definition.
        :param pulumi.Input[builtins.str] mechanisms: The Mongo Auth mechanism. For now, we only support auth mechanism SCRAM-SHA-256.
        :param pulumi.Input[builtins.str] mongo_user_definition_id: The ID for the User Definition {dbName.userName}.
        :param pulumi.Input[builtins.str] password: The password for User Definition. Response does not contain user password.
        :param pulumi.Input[Sequence[pulumi.Input['RoleArgs']]] roles: The set of roles inherited by the User Definition.
        :param pulumi.Input[builtins.str] user_name: The user name for User Definition.
        """
    ...
    @property
    @pulumi.getter
    def mechanisms(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mechanisms.setter
    def mechanisms(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mechanisms", value)

    @property
    @pulumi.getter(name="mongoUserDefinitionId")
    def mongo_user_definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mongo_user_definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:cosmosdb:MongoDBResourceMongoUserDefinition")
class MongoDBResourceMongoUserDefinition(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def mechanisms(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Mongo Auth mechanism. For now, we only support auth mechanism SCRAM-SHA-256.
        """
        return pulumi.get(self, "mechanisms")
