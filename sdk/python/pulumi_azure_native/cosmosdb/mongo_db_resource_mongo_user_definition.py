...
class MongoDBResourceMongoUserDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 mechanisms: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def mongo_user_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]):
