...
class FleetspaceArgs:
    def __init__(__self__, *,
                 ...
                 fleetspace_api_kind: Optional[pulumi.Input[Union[str, 'FleetspaceApiKind']]] = None,
        ...
        :param pulumi.Input[Union[str, 'FleetspaceApiKind']] fleetspace_api_kind: The kind of API this fleetspace belongs to. Acceptable values: 'NoSQL'
        :param pulumi.Input[str] fleetspace_name: Cosmos DB fleetspace name. Needs to be unique under a fleet.
    ...
    def fleetspace_api_kind(self) -> Optional[pulumi.Input[Union[str, 'FleetspaceApiKind']]]:
        """
    ...
    def fleetspace_api_kind(self, value: Optional[pulumi.Input[Union[str, 'FleetspaceApiKind']]]):
        pulumi.set(self, "fleetspace_api_kind", value)

    @property
    @pulumi.getter(name="fleetspaceName")
    def fleetspace_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def fleetspace_name(self, value: Optional[pulumi.Input[str]]):
...
class Fleetspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="fleetspaceApiKind")
    def fleetspace_api_kind(self) -> pulumi.Output[Optional[str]]:
        """
        The kind of API this fleetspace belongs to. Acceptable values: 'NoSQL'
        """
        return pulumi.get(self, "fleetspace_api_kind")
