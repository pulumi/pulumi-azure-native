...
class DatabaseAccountGremlinGraphArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] graph_name: Cosmos DB graph name.
        """
