...
def get_database_account_cassandra_keyspace(account_name: Optional[_builtins.str] = None,
...
def get_database_account_cassandra_keyspace_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
