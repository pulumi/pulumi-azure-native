...
class GetMongoDBResourceMongoRoleDefinitionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, database_name=None, id=None, name=None, privileges=None, role_name=None, roles=None, type=None):
...
def get_mongo_db_resource_mongo_role_definition(account_name: Optional[builtins.str] = None,
                                                mongo_role_definition_id: Optional[builtins.str] = None,
    ...
    :param builtins.str mongo_role_definition_id: The ID for the Role Definition {dbName.roleName}.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getMongoDBResourceMongoRoleDefinition', __args__, opts=opts, typ=GetMongoDBResourceMongoRoleDefinitionResult).value
...
def get_mongo_db_resource_mongo_role_definition_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getMongoDBResourceMongoRoleDefinition', __args__, opts=opts, typ=GetMongoDBResourceMongoRoleDefinitionResult)
