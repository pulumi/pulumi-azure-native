...
def get_mongo_db_resource_mongo_role_definition(account_name: Optional[_builtins.str] = None,
                                                mongo_role_definition_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str mongo_role_definition_id: The ID for the Role Definition {dbName.roleName}.
...
def get_mongo_db_resource_mongo_role_definition_output(account_name: pulumi.Input[Optional[_builtins.str]] = None,
                                                       mongo_role_definition_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
