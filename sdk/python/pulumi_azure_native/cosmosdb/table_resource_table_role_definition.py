...
class TableResourceTableRoleDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20241201preview:TableResourceTableRoleDefinition"), pulumi.Alias(type_="azure-native:cosmosdb/v20250501preview:TableResourceTableRoleDefinition"), pulumi.Alias(type_="azure-native:cosmosdb/v20251101preview:TableResourceTableRoleDefinition"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition"), pulumi.Alias(type_="azure-native:documentdb:TableResourceTableRoleDefinition")])
