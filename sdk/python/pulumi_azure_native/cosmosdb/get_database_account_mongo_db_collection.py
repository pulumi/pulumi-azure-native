...
class GetDatabaseAccountMongoDBCollectionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, indexes=None, location=None, name=None, shard_key=None, tags=None, type=None):
...
def get_database_account_mongo_db_collection(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getDatabaseAccountMongoDBCollection', __args__, opts=opts, typ=GetDatabaseAccountMongoDBCollectionResult).value
...
def get_database_account_mongo_db_collection_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getDatabaseAccountMongoDBCollection', __args__, opts=opts, typ=GetDatabaseAccountMongoDBCollectionResult)
    return __ret__.apply(lambda __response__: GetDatabaseAccountMongoDBCollectionResult(
        azure_api_version=pulumi.get(__response__, 'azure_api_version'),
        id=pulumi.get(__response__, 'id'),
        indexes=pulumi.get(__response__, 'indexes'),
        location=pulumi.get(__response__, 'location'),
        name=pulumi.get(__response__, 'name'),
        shard_key=pulumi.get(__response__, 'shard_key'),
