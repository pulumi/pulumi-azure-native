...
def list_database_account_connection_strings(account_name: Optional[_builtins.str] = None,
...
def list_database_account_connection_strings_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
