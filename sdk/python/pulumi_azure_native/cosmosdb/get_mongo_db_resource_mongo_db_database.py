...
def get_mongo_db_resource_mongo_db_database(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getMongoDBResourceMongoDBDatabase', __args__, opts=opts, typ=GetMongoDBResourceMongoDBDatabaseResult).value
...
def get_mongo_db_resource_mongo_db_database_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getMongoDBResourceMongoDBDatabase', __args__, opts=opts, typ=GetMongoDBResourceMongoDBDatabaseResult)
