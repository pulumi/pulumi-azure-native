...
@pulumi.type_token("azure-native:cosmosdb:MongoMIResourceMongoMIRoleDefinition")
class MongoMIResourceMongoMIRoleDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20250501preview:MongoMIResourceMongoMIRoleDefinition"), pulumi.Alias(type_="azure-native:cosmosdb/v20251101preview:MongoMIResourceMongoMIRoleDefinition"), pulumi.Alias(type_="azure-native:cosmosdb/v20260315:MongoMIResourceMongoMIRoleDefinition"), pulumi.Alias(type_="azure-native:cosmosdb/v20260401preview:MongoMIResourceMongoMIRoleDefinition")])
