...
class FleetspaceAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20250501preview:FleetspaceAccount"), pulumi.Alias(type_="azure-native:cosmosdb/v20251015:FleetspaceAccount"), pulumi.Alias(type_="azure-native:cosmosdb/v20251101preview:FleetspaceAccount"), pulumi.Alias(type_="azure-native:cosmosdb/v20260315:FleetspaceAccount"), pulumi.Alias(type_="azure-native:cosmosdb/v20260401preview:FleetspaceAccount")])
