...
class FleetspaceAccountArgs:
    def __init__(__self__, *,
                 ...
                 fleetspace_account_name: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] account_location: The location of  global database account in the Fleetspace Account.
        :param pulumi.Input[str] account_resource_identifier: The resource identifier of global database account in the Fleetspace Account.
        :param pulumi.Input[str] fleetspace_account_name: Cosmos DB fleetspace account name.
        """
    ...
    def fleetspace_account_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def fleetspace_account_name(self, value: Optional[pulumi.Input[str]]):
