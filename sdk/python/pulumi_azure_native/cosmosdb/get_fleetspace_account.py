...
def get_fleetspace_account(fleet_name: Optional[str] = None,
    ...
    :param str fleetspace_account_name: Cosmos DB fleetspace account name.
...
def get_fleetspace_account_output(fleet_name: Optional[pulumi.Input[str]] = None,
