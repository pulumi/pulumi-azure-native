...
class GetDatabaseAccountResult:
    ...
    def connector_offer(self) -> Optional[builtins.str]:
        """
    ...
    def customer_managed_key_status(self) -> Optional[builtins.str]:
        """
    ...
    def database_account_offer_type(self) -> builtins.str:
        """
    ...
    def default_identity(self) -> Optional[builtins.str]:
        """
    ...
    def disable_key_based_metadata_write_access(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_analytical_storage(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_automatic_failover(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_burst_capacity(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_cassandra_connector(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_free_tier(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_multiple_write_locations(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_partition_merge(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_per_region_per_partition_autoscale(self) -> Optional[builtins.bool]:
        """
    ...
    def is_virtual_network_filter_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def network_acl_bypass(self) -> Optional[builtins.str]:
        """
    ...
    def network_acl_bypass_resource_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_database_account(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult).value
...
def get_database_account_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult)
