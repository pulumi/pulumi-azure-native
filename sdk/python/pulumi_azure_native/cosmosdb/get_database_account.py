...
def get_database_account(account_name: Optional[_builtins.str] = None,
...
def get_database_account_output(account_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
