...
def list_notebook_workspace_connection_info(account_name: Optional[_builtins.str] = None,
                                            notebook_workspace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str notebook_workspace_name: The name of the notebook workspace resource.
