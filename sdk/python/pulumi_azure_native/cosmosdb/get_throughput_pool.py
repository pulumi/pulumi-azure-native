...
def get_throughput_pool(resource_group_name: Optional[builtins.str] = None,
...
def get_throughput_pool_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
