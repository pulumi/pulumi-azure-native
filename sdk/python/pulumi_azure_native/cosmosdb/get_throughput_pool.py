...
class GetThroughputPoolResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, max_throughput=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_throughput_pool(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult).value
...
def get_throughput_pool_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                               throughput_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult)
