...
class SqlResourceSqlTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] trigger_name: Cosmos DB trigger name.
        """
