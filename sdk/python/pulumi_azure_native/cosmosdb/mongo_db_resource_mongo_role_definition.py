...
class MongoDBResourceMongoRoleDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 mongo_role_definition_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_name: The database name for which access is being granted for this Role Definition.
        :param pulumi.Input[builtins.str] mongo_role_definition_id: The ID for the Role Definition {dbName.roleName}.
    ...
    def mongo_role_definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mongo_role_definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
