...
def get_cassandra_resource_cassandra_view(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str view_name: Cosmos DB view name.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getCassandraResourceCassandraView', __args__, opts=opts, typ=GetCassandraResourceCassandraViewResult).value

    return AwaitableGetCassandraResourceCassandraViewResult(
...
def get_cassandra_resource_cassandra_view_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getCassandraResourceCassandraView', __args__, opts=opts, typ=GetCassandraResourceCassandraViewResult)
    return __ret__.apply(lambda __response__: GetCassandraResourceCassandraViewResult(
