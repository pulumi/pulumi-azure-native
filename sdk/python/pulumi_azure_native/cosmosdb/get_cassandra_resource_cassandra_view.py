...
def get_cassandra_resource_cassandra_view(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str view_name: Cosmos DB view name.
    """
    __args__ = dict()
...
def get_cassandra_resource_cassandra_view_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
