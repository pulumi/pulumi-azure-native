...
class GetSqlResourceSqlRoleDefinitionResult:
    ...
    """
    def __init__(__self__, assignable_scopes=None, azure_api_version=None, id=None, name=None, permissions=None, role_name=None, type=None):
    ...
    @_builtins.property
    @pulumi.getter
    def permissions(self) -> Optional[Sequence['outputs.PermissionSqlResourceSqlRoleDefinitionResponse']]:
        """
...
def get_sql_resource_sql_role_definition(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str role_definition_id: The GUID for the Role Definition.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getSqlResourceSqlRoleDefinition', __args__, opts=opts, typ=GetSqlResourceSqlRoleDefinitionResult).value
...
def get_sql_resource_sql_role_definition_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getSqlResourceSqlRoleDefinition', __args__, opts=opts, typ=GetSqlResourceSqlRoleDefinitionResult)
