...
def get_sql_resource_sql_role_definition(account_name: Optional[builtins.str] = None,
...
def get_sql_resource_sql_role_definition_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
