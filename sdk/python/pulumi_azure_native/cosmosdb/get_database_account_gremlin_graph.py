...
def get_database_account_gremlin_graph(account_name: Optional[_builtins.str] = None,
...
def get_database_account_gremlin_graph_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
