...
class GetDatabaseAccountSqlDatabaseResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, colls=None, etag=None, id=None, location=None, name=None, rid=None, tags=None, ts=None, type=None, users=None):
...
def get_database_account_sql_database(account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getDatabaseAccountSqlDatabase', __args__, opts=opts, typ=GetDatabaseAccountSqlDatabaseResult).value

    return AwaitableGetDatabaseAccountSqlDatabaseResult(
        azure_api_version=pulumi.get(__ret__, 'azure_api_version'),
        colls=pulumi.get(__ret__, 'colls'),
...
def get_database_account_sql_database_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getDatabaseAccountSqlDatabase', __args__, opts=opts, typ=GetDatabaseAccountSqlDatabaseResult)
    return __ret__.apply(lambda __response__: GetDatabaseAccountSqlDatabaseResult(
        azure_api_version=pulumi.get(__response__, 'azure_api_version'),
        colls=pulumi.get(__response__, 'colls'),
