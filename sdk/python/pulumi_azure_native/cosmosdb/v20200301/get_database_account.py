...
def get_database_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb/v20200301:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult).value
...
def get_database_account_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb/v20200301:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult)
