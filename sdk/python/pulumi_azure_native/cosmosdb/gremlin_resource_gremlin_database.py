...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource: pulumi.Input[Optional[Union['GremlinDatabaseResourceArgs', 'GremlinDatabaseResourceArgsDict']]] = None,
