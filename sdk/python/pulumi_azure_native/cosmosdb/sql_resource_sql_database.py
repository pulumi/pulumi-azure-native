...
class SqlResourceSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource: pulumi.Input[Optional[Union['SqlDatabaseResourceArgs', 'SqlDatabaseResourceArgsDict']]] = None,
