...
def get_gremlin_resource_gremlin_graph(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str graph_name: Cosmos DB graph name.
...
def get_gremlin_resource_gremlin_graph_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
