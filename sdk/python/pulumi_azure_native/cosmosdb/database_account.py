...
class DatabaseAccountArgs:
    def __init__(__self__, *,
                 ...
                 connector_offer: Optional[pulumi.Input[Union[builtins.str, 'ConnectorOffer']]] = None,
                 ...
                 customer_managed_key_status: Optional[pulumi.Input[builtins.str]] = None,
                 default_identity: Optional[pulumi.Input[builtins.str]] = None,
                 disable_key_based_metadata_write_access: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_local_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_analytical_storage: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_automatic_failover: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_burst_capacity: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_cassandra_connector: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_free_tier: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_multiple_write_locations: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_partition_merge: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_per_region_per_partition_autoscale: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 key_vault_key_uri: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input[Union[builtins.str, 'DatabaseAccountKind']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 minimal_tls_version: Optional[pulumi.Input[Union[builtins.str, 'MinimalTlsVersion']]] = None,
                 network_acl_bypass: Optional[pulumi.Input['NetworkAclBypass']] = None,
                 network_acl_bypass_resource_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ConnectorOffer']] connector_offer: The cassandra connector offer type for the Cosmos DB database C* account.
        ...
        :param pulumi.Input[Union[builtins.str, 'CreateMode']] create_mode: Enum to indicate the mode of account creation.
        :param pulumi.Input[builtins.str] customer_managed_key_status: Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
        :param pulumi.Input[builtins.str] default_identity: The default identity for accessing key vault used in features like customer managed keys. The default identity needs to be explicitly set by the users. It can be "FirstPartyIdentity", "SystemAssignedIdentity" and more.
        :param pulumi.Input[builtins.bool] disable_key_based_metadata_write_access: Disable write operations on metadata resources (databases, containers, throughput) via account keys
        :param pulumi.Input[builtins.bool] disable_local_auth: Opt-out of local authentication and ensure only MSI and AAD can be used exclusively for authentication.
        :param pulumi.Input[builtins.bool] enable_analytical_storage: Flag to indicate whether to enable storage analytics.
        :param pulumi.Input[builtins.bool] enable_automatic_failover: Enables automatic failover of the write region in the rare event that the region is unavailable due to an outage. Automatic failover will result in a new write region for the account and is chosen based on the failover priorities configured for the account.
        :param pulumi.Input[builtins.bool] enable_burst_capacity: Flag to indicate enabling/disabling of Burst Capacity feature on the account
        :param pulumi.Input[builtins.bool] enable_cassandra_connector: Enables the cassandra connector on the Cosmos DB C* account
        :param pulumi.Input[builtins.bool] enable_free_tier: Flag to indicate whether Free Tier is enabled.
        :param pulumi.Input[builtins.bool] enable_multiple_write_locations: Enables the account to write in multiple locations
        :param pulumi.Input[builtins.bool] enable_partition_merge: Flag to indicate enabling/disabling of Partition Merge feature on the account
        :param pulumi.Input[builtins.bool] enable_per_region_per_partition_autoscale: Flag to indicate enabling/disabling of PerRegionPerPartitionAutoscale feature on the account
        ...
        :param pulumi.Input[builtins.bool] is_virtual_network_filter_enabled: Flag to indicate whether to enable/disable Virtual Network ACL rules.
        :param pulumi.Input[builtins.str] key_vault_key_uri: The URI of the key vault
        :param pulumi.Input[Union[builtins.str, 'DatabaseAccountKind']] kind: Indicates the type of database account. This can only be set at database account creation.
        :param pulumi.Input[builtins.str] location: The location of the resource group to which the resource belongs.
        :param pulumi.Input[Union[builtins.str, 'MinimalTlsVersion']] minimal_tls_version: Indicates the minimum allowed Tls version. The default value is Tls 1.2. Cassandra and Mongo APIs only work with Tls 1.2.
        :param pulumi.Input['NetworkAclBypass'] network_acl_bypass: Indicates what services are allowed to bypass firewall checks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_acl_bypass_resource_ids: An array that contains the Resource Ids for Network Acl Bypass for the Cosmos DB account.
    ...
    def connector_offer(self) -> Optional[pulumi.Input[Union[builtins.str, 'ConnectorOffer']]]:
        """
    ...
    def connector_offer(self, value: Optional[pulumi.Input[Union[builtins.str, 'ConnectorOffer']]]):
    ...
    def customer_managed_key_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def customer_managed_key_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "customer_managed_key_status", value)

    @property
    @pulumi.getter(name="defaultIdentity")
    def default_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_identity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_identity", value)

    @property
    @pulumi.getter(name="disableKeyBasedMetadataWriteAccess")
    def disable_key_based_metadata_write_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_key_based_metadata_write_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_analytical_storage(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_analytical_storage(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_analytical_storage", value)

    @property
    @pulumi.getter(name="enableAutomaticFailover")
    def enable_automatic_failover(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_automatic_failover(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_automatic_failover", value)

    @property
    @pulumi.getter(name="enableBurstCapacity")
    def enable_burst_capacity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_burst_capacity(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_burst_capacity", value)

    @property
    @pulumi.getter(name="enableCassandraConnector")
    def enable_cassandra_connector(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_cassandra_connector(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_cassandra_connector", value)

    @property
    @pulumi.getter(name="enableFreeTier")
    def enable_free_tier(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_free_tier(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_free_tier", value)

    @property
    @pulumi.getter(name="enableMultipleWriteLocations")
    def enable_multiple_write_locations(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_multiple_write_locations(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_multiple_write_locations", value)

    @property
    @pulumi.getter(name="enablePartitionMerge")
    def enable_partition_merge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_partition_merge(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_partition_merge", value)

    @property
    @pulumi.getter(name="enablePerRegionPerPartitionAutoscale")
    def enable_per_region_per_partition_autoscale(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_per_region_per_partition_autoscale(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def key_vault_key_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_vault_key_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_vault_key_uri", value)

    @property
    @pulumi.getter
    def kind(self) -> Optional[pulumi.Input[Union[builtins.str, 'DatabaseAccountKind']]]:
        """
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[builtins.str, 'DatabaseAccountKind']]]):
    ...
    def minimal_tls_version(self) -> Optional[pulumi.Input[Union[builtins.str, 'MinimalTlsVersion']]]:
        """
    ...
    def minimal_tls_version(self, value: Optional[pulumi.Input[Union[builtins.str, 'MinimalTlsVersion']]]):
    ...
    def network_acl_bypass_resource_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def network_acl_bypass_resource_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Other available API versions: 2015-04-01, 2015-04-08, 2015-11-06, 2016-03-19, 2016-03-31, 2019-08-01, 2019-12-12, 2020-03-01, 2020-04-01, 2020-06-01-preview, 2020-09-01, 2021-01-15, 2021-03-01-preview, 2021-03-15, 2021-04-01-preview, 2021-04-15, 2021-05-15, 2021-06-15, 2021-07-01-preview, 2021-10-15, 2021-10-15-preview, 2021-11-15-preview, 2022-02-15-preview, 2022-05-15, 2022-05-15-preview, 2022-08-15, 2022-08-15-preview, 2022-11-15, 2022-11-15-preview, 2023-03-01-preview, 2023-03-15, 2023-03-15-preview, 2023-04-15, 2023-09-15, 2023-09-15-preview, 2023-11-15, 2023-11-15-preview, 2024-02-15-preview, 2024-05-15, 2024-05-15-preview, 2024-08-15, 2024-09-01-preview, 2024-12-01-preview, 2025-04-15, 2025-05-01-preview, 2025-10-15. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cosmosdb [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    @property
    @pulumi.getter(name="connectorOffer")
    def connector_offer(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The cassandra connector offer type for the Cosmos DB database C* account.
        """
        return pulumi.get(self, "connector_offer")
    ...
    @property
    @pulumi.getter(name="customerManagedKeyStatus")
    def customer_managed_key_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
        """
        return pulumi.get(self, "customer_managed_key_status")
    ...
    @property
    @pulumi.getter(name="databaseAccountOfferType")
    def database_account_offer_type(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="defaultIdentity")
    def default_identity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default identity for accessing key vault used in features like customer managed keys. The default identity needs to be explicitly set by the users. It can be "FirstPartyIdentity", "SystemAssignedIdentity" and more.
        """
        return pulumi.get(self, "default_identity")
    ...
    @property
    @pulumi.getter(name="disableKeyBasedMetadataWriteAccess")
    def disable_key_based_metadata_write_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disable write operations on metadata resources (databases, containers, throughput) via account keys
        """
        return pulumi.get(self, "disable_key_based_metadata_write_access")
    ...
    def document_endpoint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="enableAnalyticalStorage")
    def enable_analytical_storage(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to indicate whether to enable storage analytics.
        """
        return pulumi.get(self, "enable_analytical_storage")
    ...
    @property
    @pulumi.getter(name="enableAutomaticFailover")
    def enable_automatic_failover(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables automatic failover of the write region in the rare event that the region is unavailable due to an outage. Automatic failover will result in a new write region for the account and is chosen based on the failover priorities configured for the account.
        """
        return pulumi.get(self, "enable_automatic_failover")
    ...
    @property
    @pulumi.getter(name="enableBurstCapacity")
    def enable_burst_capacity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to indicate enabling/disabling of Burst Capacity feature on the account
        """
        return pulumi.get(self, "enable_burst_capacity")
    ...
    @property
    @pulumi.getter(name="enableCassandraConnector")
    def enable_cassandra_connector(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables the cassandra connector on the Cosmos DB C* account
        """
        return pulumi.get(self, "enable_cassandra_connector")
    ...
    @property
    @pulumi.getter(name="enableFreeTier")
    def enable_free_tier(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to indicate whether Free Tier is enabled.
        """
        return pulumi.get(self, "enable_free_tier")
    ...
    @property
    @pulumi.getter(name="enableMultipleWriteLocations")
    def enable_multiple_write_locations(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables the account to write in multiple locations
        """
        return pulumi.get(self, "enable_multiple_write_locations")
    ...
    @property
    @pulumi.getter(name="enablePartitionMerge")
    def enable_partition_merge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to indicate enabling/disabling of Partition Merge feature on the account
        """
        return pulumi.get(self, "enable_partition_merge")
    ...
    @property
    @pulumi.getter(name="enablePerRegionPerPartitionAutoscale")
    def enable_per_region_per_partition_autoscale(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to indicate enabling/disabling of PerRegionPerPartitionAutoscale feature on the account
        """
        return pulumi.get(self, "enable_per_region_per_partition_autoscale")
    ...
    @property
    @pulumi.getter(name="keyVaultKeyUri")
    def key_vault_key_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URI of the key vault
        """
        return pulumi.get(self, "key_vault_key_uri")
    ...
    @property
    @pulumi.getter(name="networkAclBypass")
    def network_acl_bypass(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates what services are allowed to bypass firewall checks.
        """
        return pulumi.get(self, "network_acl_bypass")
    ...
    @property
    @pulumi.getter(name="networkAclBypassResourceIds")
    def network_acl_bypass_resource_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array that contains the Resource Ids for Network Acl Bypass for the Cosmos DB account.
        """
        return pulumi.get(self, "network_acl_bypass_resource_ids")
