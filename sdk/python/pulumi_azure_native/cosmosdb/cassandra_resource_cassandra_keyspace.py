...
class CassandraResourceCassandraKeyspaceArgs:
    ...
    def keyspace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def keyspace_name(self, value: Optional[pulumi.Input[builtins.str]]):
