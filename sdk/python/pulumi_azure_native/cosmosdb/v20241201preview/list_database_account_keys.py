...
def list_database_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb/v20241201preview:listDatabaseAccountKeys', __args__, opts=opts, typ=ListDatabaseAccountKeysResult).value
...
def list_database_account_keys_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb/v20241201preview:listDatabaseAccountKeys', __args__, opts=opts, typ=ListDatabaseAccountKeysResult)
