...
def get_table_resource_table_role_definition(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult).value
...
def get_table_resource_table_role_definition_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb/v20241201preview:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult)
