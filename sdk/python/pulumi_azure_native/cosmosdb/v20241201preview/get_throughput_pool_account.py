...
def get_throughput_pool_account(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb/v20241201preview:getThroughputPoolAccount', __args__, opts=opts, typ=GetThroughputPoolAccountResult).value
...
def get_throughput_pool_account_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb/v20241201preview:getThroughputPoolAccount', __args__, opts=opts, typ=GetThroughputPoolAccountResult)
