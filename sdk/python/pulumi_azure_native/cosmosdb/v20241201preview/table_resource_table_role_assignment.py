...
__all__ = ['TableResourceTableRoleAssignmentArgs', 'TableResourceTableRoleAssignment']

@pulumi.input_type
class TableResourceTableRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] principal_id: The unique identifier for the associated AAD principal in the AAD graph to which access is being granted through this Table Role Assignment. Tenant ID for the principal is inferred using the tenant associated with the subscription.
        ...
        :param pulumi.Input[str] scope: The data plane resource path for which access is being granted through this Table Role Assignment.
        """
...
class TableResourceTableRoleAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TableResourceTableRoleAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TableResourceTableRoleAssignmentArgs.__new__(TableResourceTableRoleAssignmentArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb:TableResourceTableRoleAssignment"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment"), pulumi.Alias(type_="azure-native:documentdb:TableResourceTableRoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableResourceTableRoleAssignment, __self__).__init__(
            'azure-native:cosmosdb/v20241201preview:TableResourceTableRoleAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TableResourceTableRoleAssignment':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return TableResourceTableRoleAssignment(resource_name, opts=opts, __props__=__props__)
