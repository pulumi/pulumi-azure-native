...
class GetMongoClusterFirewallRuleResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, end_ip_address=None, id=None, name=None, provisioning_state=None, start_ip_address=None, system_data=None, type=None):
...
def get_mongo_cluster_firewall_rule(firewall_rule_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getMongoClusterFirewallRule', __args__, opts=opts, typ=GetMongoClusterFirewallRuleResult).value
...
def get_mongo_cluster_firewall_rule_output(firewall_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           mongo_cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                           resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMongoClusterFirewallRuleResult]:
    """
    Gets information about a mongo cluster firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getMongoClusterFirewallRule', __args__, opts=opts, typ=GetMongoClusterFirewallRuleResult)
    return __ret__.apply(lambda __response__: GetMongoClusterFirewallRuleResult(
