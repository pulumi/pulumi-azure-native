...
class ThroughputPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_throughput: Value for throughput to be shared among CosmosDB resources in the pool.
    ...
    def throughput_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def throughput_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "throughput_pool_name", value)


class ThroughputPool(pulumi.CustomResource):

    pulumi_type = "azure-native:cosmosdb:ThroughputPool"
    ...
    @property
    @pulumi.getter(name="maxThroughput")
    def max_throughput(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Value for throughput to be shared among CosmosDB resources in the pool.
        """
        return pulumi.get(self, "max_throughput")
