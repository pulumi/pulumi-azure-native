...
class ThroughputPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20231115preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb:ThroughputPool"), pulumi.Alias(type_="azure-native_cosmosdb_v20231115preview:cosmosdb:ThroughputPool"), pulumi.Alias(type_="azure-native_cosmosdb_v20240215preview:cosmosdb:ThroughputPool"), pulumi.Alias(type_="azure-native_cosmosdb_v20240515preview:cosmosdb:ThroughputPool"), pulumi.Alias(type_="azure-native_cosmosdb_v20240901preview:cosmosdb:ThroughputPool"), pulumi.Alias(type_="azure-native_cosmosdb_v20241201preview:cosmosdb:ThroughputPool")])
