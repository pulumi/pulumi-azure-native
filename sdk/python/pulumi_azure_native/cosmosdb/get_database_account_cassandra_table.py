...
def get_database_account_cassandra_table(account_name: Optional[builtins.str] = None,
...
def get_database_account_cassandra_table_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
