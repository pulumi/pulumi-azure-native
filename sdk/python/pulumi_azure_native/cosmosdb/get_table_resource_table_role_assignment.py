...
def get_table_resource_table_role_assignment(account_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb:getTableResourceTableRoleAssignment', __args__, opts=opts, typ=GetTableResourceTableRoleAssignmentResult).value
...
def get_table_resource_table_role_assignment_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb:getTableResourceTableRoleAssignment', __args__, opts=opts, typ=GetTableResourceTableRoleAssignmentResult)
