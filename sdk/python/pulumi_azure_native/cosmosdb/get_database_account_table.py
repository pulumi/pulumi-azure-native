...
def get_database_account_table(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str table_name: Cosmos DB table name.
    """
    __args__ = dict()
...
def get_database_account_table_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
