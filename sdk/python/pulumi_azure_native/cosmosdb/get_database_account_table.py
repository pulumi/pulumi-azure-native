...
def get_database_account_table(account_name: Optional[_builtins.str] = None,
...
def get_database_account_table_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
