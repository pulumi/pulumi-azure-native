...
def get_sql_resource_sql_database(account_name: Optional[builtins.str] = None,
...
def get_sql_resource_sql_database_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
