...
def get_database_account_mongo_db_database(account_name: Optional[builtins.str] = None,
...
def get_database_account_mongo_db_database_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
