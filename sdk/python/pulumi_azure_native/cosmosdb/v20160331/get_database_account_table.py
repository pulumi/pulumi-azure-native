...
def get_database_account_table(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cosmosdb/v20160331:getDatabaseAccountTable', __args__, opts=opts, typ=GetDatabaseAccountTableResult).value
...
def get_database_account_table_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cosmosdb/v20160331:getDatabaseAccountTable', __args__, opts=opts, typ=GetDatabaseAccountTableResult)
