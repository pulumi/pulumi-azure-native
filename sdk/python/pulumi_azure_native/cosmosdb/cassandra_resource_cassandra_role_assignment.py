...
class CassandraResourceCassandraRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] principal_id: The unique identifier for the associated AAD principal in the AAD graph to which access is being granted through this Cassandra Role Assignment. Tenant ID for the principal is inferred using the tenant associated with the subscription.
        ...
        :param pulumi.Input[_builtins.str] scope: The data plane resource path for which access is being granted through this Cassandra Role Assignment.
        """
...
class CassandraResourceCassandraRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CassandraResourceCassandraRoleAssignmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CassandraResourceCassandraRoleAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CassandraResourceCassandraRoleAssignmentArgs.__new__(CassandraResourceCassandraRoleAssignmentArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20250501preview:CassandraResourceCassandraRoleAssignment"), pulumi.Alias(type_="azure-native:cosmosdb/v20251101preview:CassandraResourceCassandraRoleAssignment"), pulumi.Alias(type_="azure-native:cosmosdb/v20260315:CassandraResourceCassandraRoleAssignment"), pulumi.Alias(type_="azure-native:cosmosdb/v20260401preview:CassandraResourceCassandraRoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraResourceCassandraRoleAssignment, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CassandraResourceCassandraRoleAssignment':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return CassandraResourceCassandraRoleAssignment(resource_name, opts=opts, __props__=__props__)
