...
@pulumi.type_token("azure-native:cosmosdb:SqlResourceSqlContainer")
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 resource: pulumi.Input[Optional[Union['SqlContainerResourceArgs', 'SqlContainerResourceArgsDict']]] = None,
