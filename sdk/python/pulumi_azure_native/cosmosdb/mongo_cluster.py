...
class MongoClusterArgs:
    def __init__(__self__, *,
                 ...
                 create_mode: Optional[pulumi.Input[Union[builtins.str, 'MongoClusterCreateMode']]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_login: The administrator's login for the mongo cluster.
        :param pulumi.Input[builtins.str] administrator_login_password: The password of the administrator login.
        :param pulumi.Input[Union[builtins.str, 'MongoClusterCreateMode']] create_mode: The mode to create a mongo cluster.
    ...
    def create_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'MongoClusterCreateMode']]]:
        """
    ...
    @create_mode.setter
    def create_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'MongoClusterCreateMode']]]):
...
class MongoCluster(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:cosmosdb:MongoCluster"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cosmosdb/v20230301preview:MongoCluster"), pulumi.Alias(type_="azure-native:cosmosdb/v20230315preview:MongoCluster"), pulumi.Alias(type_="azure-native:cosmosdb/v20230915preview:MongoCluster"), pulumi.Alias(type_="azure-native:cosmosdb/v20231115preview:MongoCluster"), pulumi.Alias(type_="azure-native:cosmosdb/v20240215preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20230915preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240301preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240601preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240701:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20241001preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb:MongoCluster")])
    ...
    def cluster_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="serverVersion")
    def server_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Mongo DB server version. Defaults to the latest available version if not specified.
        """
        return pulumi.get(self, "server_version")
