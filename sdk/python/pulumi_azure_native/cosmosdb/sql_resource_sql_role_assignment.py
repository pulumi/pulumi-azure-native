...
class SqlResourceSqlRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] principal_id: The unique identifier for the associated AAD principal in the AAD graph to which access is being granted through this Role Assignment. Tenant ID for the principal is inferred using the tenant associated with the subscription.
        ...
        :param pulumi.Input[builtins.str] scope: The data plane resource path for which access is being granted through this Role Assignment.
        """
