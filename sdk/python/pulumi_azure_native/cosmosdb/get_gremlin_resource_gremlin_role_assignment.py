...
def get_gremlin_resource_gremlin_role_assignment(account_name: Optional[str] = None,
...
def get_gremlin_resource_gremlin_role_assignment_output(account_name: Optional[pulumi.Input[str]] = None,
