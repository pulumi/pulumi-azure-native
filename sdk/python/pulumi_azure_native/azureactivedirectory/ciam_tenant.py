...
class CIAMTenant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 create_tenant_properties: pulumi.Input[Optional[Union['CreateCIAMTenantPropertiesArgs', 'CreateCIAMTenantPropertiesArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_name_: pulumi.Input[Optional[_builtins.str]] = None,
                 sku: pulumi.Input[Optional[Union['CIAMResourceSKUArgs', 'CIAMResourceSKUArgsDict']]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 tenant_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] location: The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia'. Refer to [this documentation](https://aka.ms/ciam-data-location) for more information.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] resource_name_: The initial sub domain of the tenant.
