...
class CIAMTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory/v20230517preview:CIAMTenant"), pulumi.Alias(type_="azure-native_azureactivedirectory_v20230517preview:azureactivedirectory:CIAMTenant")])
