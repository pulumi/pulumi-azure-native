...
class GetCIAMTenantResult:
    ...
    def effective_start_date_utc(self) -> builtins.str:
        """
...
def get_ciam_tenant(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_name: The initial sub domain of the tenant.
    """
    __args__ = dict()
...
def get_ciam_tenant_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetCIAMTenantResult(
        ...
        effective_start_date_utc=pulumi.get(__response__, 'effective_start_date_utc'),
