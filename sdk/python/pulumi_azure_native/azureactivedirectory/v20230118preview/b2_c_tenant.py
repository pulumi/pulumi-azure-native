...
class B2CTenantArgs:
    def __init__(__self__, *,
        ...
        B2CTenantArgs._configure(
            ...
            is_go_local_tenant=is_go_local_tenant,
            location=location,
    ...
    def _configure(
        ...
        if is_go_local_tenant is None and 'isGoLocalTenant' in kwargs:
            is_go_local_tenant = kwargs['isGoLocalTenant']
        ...
        if is_go_local_tenant is not None:
            _setter("is_go_local_tenant", is_go_local_tenant)
...
class B2CTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory:B2CTenant"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20190101preview:B2CTenant"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20210401:B2CTenant")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(B2CTenant, __self__).__init__(
            'azure-native:azureactivedirectory/v20230118preview:B2CTenant',
            resource_name,
            __props__,
            opts)
