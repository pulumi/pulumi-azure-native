...
class GuestUsage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        guest_usage = azure_native.azureactivedirectory.v20200501preview.GuestUsage("guestUsage",
        ...
        ```sh
        $ pulumi import azure-native:azureactivedirectory/v20200501preview:GuestUsage contoso.onmicrosoft.com /subscriptions/c80fb759-c965-4c6a-9110-9b2b2d038882/resourceGroups/contosoResourceGroup/providers/Microsoft.AzureActiveDirectory/guestUsages/contoso.onmicrosoft.com 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20210401:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230118preview:GuestUsage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestUsage, __self__).__init__(
            'azure-native:azureactivedirectory/v20200501preview:GuestUsage',
            resource_name,
            __props__,
            opts)
