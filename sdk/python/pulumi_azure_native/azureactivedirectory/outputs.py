...
class B2CResourceSKUResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
        :param builtins.str name: The name of the SKU for the tenant.
        :param builtins.str tier: The tier of the tenant.
        """
        if name is not None:
...
class B2CTenantResourcePropertiesResponseBillingConfig(dict):
    ...
    def __init__(__self__, *,
                 effective_start_date_utc: builtins.str,
                 billing_type: Optional[builtins.str] = None):
        """
        The billing configuration for the tenant.
        :param builtins.str effective_start_date_utc: The data from which the billing type took effect
        :param builtins.str billing_type: The type of billing. Will be MAU for all new customers. If 'Auths', it can be updated to 'MAU'. Cannot be changed if value is 'MAU'. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cbilling).
        """
...
class CreateCIAMTenantPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        These properties are used to create the Azure AD for customers tenant. These properties are not part of the Azure resource.
        :param builtins.str country_code: Country code of Azure tenant (e.g. 'US'). Refer to [https://aka.ms/ciam-data-location](https://aka.ms/ciam-data-location) to see valid country codes and corresponding data residency locations. If you do not see a country code in an valid data residency location, choose one from the list.
        :param builtins.str display_name: The display name of the Azure AD for customers tenant.
        """
