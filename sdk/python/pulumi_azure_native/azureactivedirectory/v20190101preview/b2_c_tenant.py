...
class B2CTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, CreateTenantRequestBodyPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                CreateTenantRequestBodyPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory:B2CTenant"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20210401:B2CTenant"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230118preview:B2CTenant")])
