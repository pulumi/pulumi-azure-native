...
def get_ciam_tenant(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azureactivedirectory/v20230517preview:getCIAMTenant', __args__, opts=opts, typ=GetCIAMTenantResult).value
...
def get_ciam_tenant_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azureactivedirectory/v20230517preview:getCIAMTenant', __args__, opts=opts, typ=GetCIAMTenantResult)
