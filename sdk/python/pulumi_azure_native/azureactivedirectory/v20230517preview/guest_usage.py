...
class GuestUsage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory/v20200501preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20210401:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230118preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory:GuestUsage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestUsage, __self__).__init__(
            'azure-native:azureactivedirectory/v20230517preview:GuestUsage',
            resource_name,
            __props__,
            opts)
