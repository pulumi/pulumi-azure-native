...
class CIAMTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory:CIAMTenant")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CIAMTenant, __self__).__init__(
            'azure-native:azureactivedirectory/v20230517preview:CIAMTenant',
            resource_name,
            __props__,
            opts)
