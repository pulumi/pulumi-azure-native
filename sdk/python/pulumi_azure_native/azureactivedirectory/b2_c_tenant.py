...
class B2CTenantArgs:
    def __init__(__self__, *,
                 ...
                 is_go_local_tenant: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] country_code: Country code of Azure tenant (e.g. 'US'). Refer to [aka.ms/B2CDataResidency](https://aka.ms/B2CDataResidency) to see valid country codes and corresponding data residency locations. If you do not see a country code in an valid data residency location, choose one from the list.
        :param pulumi.Input[builtins.str] display_name: The display name of the Azure AD B2C tenant.
        :param pulumi.Input[builtins.bool] is_go_local_tenant: Enable GoLocal add-on to store data at rest in the specific Geo. Refer to [aka.ms/B2CDataResidency](https://aka.ms/B2CDataResidency) to see local data residency options.
        :param pulumi.Input[builtins.str] location: The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia'. Refer to [this documentation](https://aka.ms/B2CDataResidency) for more information.
        :param pulumi.Input[builtins.str] resource_name: The initial domain name of the Azure AD B2C tenant.
    ...
    def is_go_local_tenant(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_go_local_tenant(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class B2CTenant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sku: Optional[pulumi.Input[Union['B2CResourceSKUArgs', 'B2CResourceSKUArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[builtins.str] location: The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia'. Refer to [this documentation](https://aka.ms/B2CDataResidency) for more information.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[builtins.str] resource_name_: The initial domain name of the Azure AD B2C tenant.
        :param pulumi.Input[Union['B2CResourceSKUArgs', 'B2CResourceSKUArgsDict']] sku: SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource Tags
        """
        ...
    @overload
    ...
    @property
    @pulumi.getter(name="isGoLocalTenant")
    def is_go_local_tenant(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable GoLocal add-on to store data at rest in the specific Geo. Refer to [aka.ms/B2CDataResidency](https://aka.ms/B2CDataResidency) to see local data residency options.
        """
        return pulumi.get(self, "is_go_local_tenant")
