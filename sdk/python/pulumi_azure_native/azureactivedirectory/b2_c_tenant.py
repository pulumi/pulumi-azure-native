...
class B2CTenantArgs:
    ...
    def is_go_local_tenant(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_go_local_tenant(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class B2CTenant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sku: pulumi.Input[Optional[Union['B2CResourceSKUArgs', 'B2CResourceSKUArgsDict']]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] location: The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia'. Refer to [this documentation](https://aka.ms/B2CDataResidency) for more information.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group.
        :param pulumi.Input[_builtins.str] resource_name_: The initial domain name of the Azure AD B2C tenant.
