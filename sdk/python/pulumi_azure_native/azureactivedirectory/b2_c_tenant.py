...
class B2CTenantArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input['CreateTenantRequestBodyPropertiesArgs'],
        ...
        :param pulumi.Input[str] resource_name: The initial domain name of the B2C tenant.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['CreateTenantRequestBodyPropertiesArgs']:
        return pulumi.get(self, "properties")

    @properties.setter
    def properties(self, value: pulumi.Input['CreateTenantRequestBodyPropertiesArgs']):
...
class B2CTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azureactivedirectory:B2CTenant"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20190101preview:B2CTenant"), pulumi.Alias(type_="azure-nextgen:azureactivedirectory/v20190101preview:B2CTenant")])
