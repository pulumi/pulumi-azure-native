...
warnings.warn("""azure-native:azureactivedirectory/v20210401:GuestUsage is being removed in the next major version of this provider. Upgrade to at least azure-native:azureactivedirectory/v20230118preview:GuestUsage to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_guest_usage(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_usage is deprecated: azure-native:azureactivedirectory/v20210401:GuestUsage is being removed in the next major version of this provider. Upgrade to at least azure-native:azureactivedirectory/v20230118preview:GuestUsage to guarantee forwards compatibility.""")
    __args__ = dict()
