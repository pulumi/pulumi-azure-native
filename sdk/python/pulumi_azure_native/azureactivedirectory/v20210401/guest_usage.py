...
class GuestUsage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory/v20200501preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230118preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230517preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory:GuestUsage")])
