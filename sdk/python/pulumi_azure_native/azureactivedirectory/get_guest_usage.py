...
def get_guest_usage(resource_group_name: Optional[_builtins.str] = None,
...
def get_guest_usage_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
