...
class GuestUsage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azureactivedirectory/v20210401:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230118preview:GuestUsage"), pulumi.Alias(type_="azure-native:azureactivedirectory/v20230517preview:GuestUsage"), pulumi.Alias(type_="azure-native_azureactivedirectory_v20200501preview:azureactivedirectory:GuestUsage"), pulumi.Alias(type_="azure-native_azureactivedirectory_v20210401:azureactivedirectory:GuestUsage"), pulumi.Alias(type_="azure-native_azureactivedirectory_v20230118preview:azureactivedirectory:GuestUsage"), pulumi.Alias(type_="azure-native_azureactivedirectory_v20230517preview:azureactivedirectory:GuestUsage")])
