...
def get_firewall_rule(firewall_rule_name: Optional[_builtins.str] = None,
                      mongo_cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str firewall_rule_name: The name of the mongo cluster firewall rule.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mongocluster:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
...
def get_firewall_rule_output(firewall_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mongocluster:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult)
