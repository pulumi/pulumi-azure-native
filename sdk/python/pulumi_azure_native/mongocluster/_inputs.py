...
class MongoClusterPropertiesArgsDict(TypedDict):
    ...
    """
    administrator: NotRequired[pulumi.Input[Optional['AdministratorPropertiesArgs']]]
    """
    The local administrator properties for the mongo cluster.
    """
    compute: NotRequired[pulumi.Input[Optional['ComputePropertiesArgs']]]
    """
    ...
    """
    high_availability: NotRequired[pulumi.Input[Optional['HighAvailabilityPropertiesArgs']]]
    """
    ...
    """
    replica_parameters: NotRequired[pulumi.Input[Optional['MongoClusterReplicaParametersArgs']]]
    """
    The parameters to create a replica mongo cluster.
    """
    restore_parameters: NotRequired[pulumi.Input[Optional['MongoClusterRestoreParametersArgs']]]
    """
    ...
    """
    sharding: NotRequired[pulumi.Input[Optional['ShardingPropertiesArgs']]]
    """
    The sharding properties of the mongo cluster.
    """
    storage: NotRequired[pulumi.Input[Optional['StoragePropertiesArgs']]]
    """
...
class UserPropertiesArgsDict(TypedDict):
    ...
    """
    identity_provider: NotRequired[pulumi.Input[Optional['EntraIdentityProviderArgs']]]
    """
    The user's identity provider definition.
    """
    roles: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DatabaseRoleArgs']]]]]
    """
