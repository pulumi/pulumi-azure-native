...
class User(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] mongo_cluster_name: The name of the mongo cluster.
        :param pulumi.Input[Union['UserPropertiesArgs', 'UserPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] user_name: The name of the mongo cluster user.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mongocluster/v20250401preview:User"), pulumi.Alias(type_="azure-native:mongocluster/v20250701preview:User"), pulumi.Alias(type_="azure-native:mongocluster/v20250801preview:User"), pulumi.Alias(type_="azure-native:mongocluster/v20250901:User"), pulumi.Alias(type_="azure-native:mongocluster/v20260201preview:User"), pulumi.Alias(type_="azure-native:mongocluster/v20260601:User"), pulumi.Alias(type_="azure-native:mongocluster/v20260615preview:User")])
