...
def get_user(mongo_cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str user_name: The name of the mongo cluster user.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mongocluster:getUser', __args__, opts=opts, typ=GetUserResult).value
...
def get_user_output(mongo_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mongocluster:getUser', __args__, opts=opts, typ=GetUserResult)
