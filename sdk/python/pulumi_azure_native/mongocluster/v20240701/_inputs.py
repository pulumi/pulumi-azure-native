...
class AdministratorPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The local administrator login properties.
        :param pulumi.Input[str] password: The administrator password.
        :param pulumi.Input[str] user_name: The administrator user name.
        """
...
class ComputePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The compute properties of the cluster. This includes the virtual-cores/memory and scaling options applied to servers in the cluster.
        :param pulumi.Input[str] tier: The compute tier to assign to the cluster, where each tier maps to a virtual-core and memory size. Example values: 'M30', 'M40'.
        """
        if tier is not None:
...
if not MYPY:
    class HighAvailabilityPropertiesArgsDict(TypedDict):
        ...
        """
        target_mode: NotRequired[pulumi.Input[Union[str, 'HighAvailabilityMode']]]
        """
...
class HighAvailabilityPropertiesArgs:
    def __init__(__self__, *,
                 target_mode: Optional[pulumi.Input[Union[str, 'HighAvailabilityMode']]] = None):
        """
        The high availability properties of the cluster.
        :param pulumi.Input[Union[str, 'HighAvailabilityMode']] target_mode: The target high availability mode requested for the cluster.
        """
    ...
    def target_mode(self) -> Optional[pulumi.Input[Union[str, 'HighAvailabilityMode']]]:
        """
        The target high availability mode requested for the cluster.
        """
    ...
    @target_mode.setter
    def target_mode(self, value: Optional[pulumi.Input[Union[str, 'HighAvailabilityMode']]]):
...
class ShardingPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The sharding properties of the cluster. This includes the shard count and scaling options for the cluster.
        :param pulumi.Input[int] shard_count: Number of shards to provision on the cluster.
        """
...
class StoragePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        The storage properties of the cluster. This includes the data storage size and scaling applied to servers in the cluster.
        :param pulumi.Input[float] size_gb: The size of the data disk assigned to each server.
        """
