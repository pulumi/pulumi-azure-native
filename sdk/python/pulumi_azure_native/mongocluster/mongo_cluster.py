...
class MongoClusterArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['MongoClusterPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['MongoClusterPropertiesArgs']]):
...
class MongoCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 mongo_cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['MongoClusterPropertiesArgs', 'MongoClusterPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20230315preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20230915preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240301preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240601preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240701:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20241001preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240301preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240601preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240701:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20241001preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20250401preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20250701preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20250801preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20250901:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20260201preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20260601:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20260615preview:MongoCluster")])
