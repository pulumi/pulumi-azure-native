...
class FirewallRuleArgs:
    def __init__(__self__, *,
                 mongo_cluster_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] firewall_rule_name: The name of the mongo cluster firewall rule.
    ...
    def mongo_cluster_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mongo_cluster_name(self, value: pulumi.Input[builtins.str]):
