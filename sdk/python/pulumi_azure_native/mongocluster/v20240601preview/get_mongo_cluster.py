...
def get_mongo_cluster(mongo_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mongocluster/v20240601preview:getMongoCluster', __args__, opts=opts, typ=GetMongoClusterResult).value
...
def get_mongo_cluster_output(mongo_cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mongocluster/v20240601preview:getMongoCluster', __args__, opts=opts, typ=GetMongoClusterResult)
