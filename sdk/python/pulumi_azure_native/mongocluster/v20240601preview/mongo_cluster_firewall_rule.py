...
class MongoClusterFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20240601preview:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:mongocluster:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:documentdb:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:mongocluster/v20240301preview:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:documentdb/v20240301preview:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:mongocluster/v20240701:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:documentdb/v20240701:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:mongocluster/v20241001preview:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:documentdb/v20241001preview:MongoClusterFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MongoClusterFirewallRule, __self__).__init__(
            'azure-native:mongocluster/v20240601preview:MongoClusterFirewallRule',
            resource_name,
            __props__,
            opts)
