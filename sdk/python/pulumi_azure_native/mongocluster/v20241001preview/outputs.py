...
@pulumi.output_type
class DataApiPropertiesResponse(dict):
    """
    Data API properties.
    """
    def __init__(__self__, *,
        ...
        """
        Data API properties.
        :param str mode: The mode to indicate whether the Mongo Data API is enabled for a cluster.
        """
        if mode is not None:
...
class MongoClusterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_api: Optional['outputs.DataApiPropertiesResponse'] = None,
        ...
        :param 'DataApiPropertiesResponse' data_api: The Data API properties of the mongo cluster.
    ...
    def data_api(self) -> Optional['outputs.DataApiPropertiesResponse']:
        """
