...
class MongoCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20240301preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240601preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20240701:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb/v20241001preview:MongoCluster"), pulumi.Alias(type_="azure-native:documentdb:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240301preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240601preview:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster/v20240701:MongoCluster"), pulumi.Alias(type_="azure-native:mongocluster:MongoCluster")])
