...
class ConfigurationAssignmentsForSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentsForSubscription"), pulumi.Alias(type_="azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription"), pulumi.Alias(type_="azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationAssignmentsForSubscription, __self__).__init__(
            'azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription',
            resource_name,
            __props__,
            opts)
