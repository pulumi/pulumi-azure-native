...
class ConfigurationAssignmentParentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_parent_name: Resource parent name
        :param pulumi.Input[_builtins.str] resource_parent_type: Resource parent type
