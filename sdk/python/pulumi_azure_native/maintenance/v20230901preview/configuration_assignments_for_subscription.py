...
class ConfigurationAssignmentsForSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription"), pulumi.Alias(type_="azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription"), pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentsForSubscription")])
