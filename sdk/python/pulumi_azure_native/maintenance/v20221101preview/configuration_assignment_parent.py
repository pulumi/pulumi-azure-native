...
class ConfigurationAssignmentParentArgs:
    def __init__(__self__, *,
        ...
        """
        ConfigurationAssignmentParentArgs._configure(
    ...
    def _configure(
        ...
        if resource_parent_name is None and 'resourceParentName' in kwargs:
            resource_parent_name = kwargs['resourceParentName']
        if resource_parent_name is None:
            raise TypeError("Missing 'resource_parent_name' argument")
        if resource_parent_type is None and 'resourceParentType' in kwargs:
            resource_parent_type = kwargs['resourceParentType']
        if resource_parent_type is None:
            raise TypeError("Missing 'resource_parent_type' argument")
        ...
        _setter("resource_parent_name", resource_parent_name)
        _setter("resource_parent_type", resource_parent_type)
...
class ConfigurationAssignmentParent(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ConfigurationAssignmentParentArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20210401preview:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20230401:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationAssignmentParent, __self__).__init__(
            'azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent',
            resource_name,
            __props__,
            opts)
