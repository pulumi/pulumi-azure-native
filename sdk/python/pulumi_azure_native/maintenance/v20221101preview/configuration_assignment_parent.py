...
class ConfigurationAssignmentParent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_assignment_parent = azure_native.maintenance.v20221101preview.ConfigurationAssignmentParent("configurationAssignmentParent",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20210401preview:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent"), pulumi.Alias(type_="azure-native:maintenance/v20220701preview:ConfigurationAssignmentParent")])
