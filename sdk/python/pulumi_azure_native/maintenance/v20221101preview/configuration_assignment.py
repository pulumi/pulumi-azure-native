...
class ConfigurationAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_assignment = azure_native.maintenance.v20221101preview.ConfigurationAssignment("configurationAssignment",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20210401preview:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20210901preview:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20220701preview:ConfigurationAssignment")])
