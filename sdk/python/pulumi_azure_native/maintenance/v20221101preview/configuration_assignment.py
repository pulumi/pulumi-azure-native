...
class ConfigurationAssignmentArgs:
    ...
    def _configure(
        ...
        if 'configurationAssignmentName' in kwargs:
...
class ConfigurationAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20210401preview:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20210901preview:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20220701preview:ConfigurationAssignment"), pulumi.Alias(type_="azure-native:maintenance/v20230401:ConfigurationAssignment")])
