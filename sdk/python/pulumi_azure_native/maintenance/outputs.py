...
class ConfigurationAssignmentFilterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] resource_types: List of allowed resources.
...
class InputLinuxParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 classifications_to_include: Optional[Sequence[_builtins.str]] = None,
                 package_name_masks_to_exclude: Optional[Sequence[_builtins.str]] = None,
...
class InputWindowsParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 classifications_to_include: Optional[Sequence[_builtins.str]] = None,
                 exclude_kbs_requiring_reboot: Optional[_builtins.bool] = None,
                 kb_numbers_to_exclude: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] kb_numbers_to_include: Windows KBID to be included for patching.
        """
        if classifications_to_include is not None:
            pulumi.set(__self__, "classifications_to_include", classifications_to_include)
