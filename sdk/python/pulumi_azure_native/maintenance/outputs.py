...
class ConfigurationAssignmentFilterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] os_types: List of allowed operating systems.
        :param Sequence[builtins.str] resource_groups: List of allowed resource groups.
        :param Sequence[builtins.str] resource_types: List of allowed resources.
...
class InputLinuxParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 classifications_to_include: Optional[Sequence[builtins.str]] = None,
                 package_name_masks_to_exclude: Optional[Sequence[builtins.str]] = None,
                 package_name_masks_to_include: Optional[Sequence[builtins.str]] = None):
        """
        Input properties for patching a Linux machine.
        :param Sequence[builtins.str] classifications_to_include: Classification category of patches to be patched. Allowed values are 'Critical', 'Security', and 'Other'.
        :param Sequence[builtins.str] package_name_masks_to_exclude: Package names to be excluded for patching.
        :param Sequence[builtins.str] package_name_masks_to_include: Package names to be included for patching.
        """
    ...
    def classifications_to_include(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def package_name_masks_to_exclude(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def package_name_masks_to_include(self) -> Optional[Sequence[builtins.str]]:
        """
...
class InputPatchConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str reboot_setting: Possible reboot preference as defined by the user based on which it would be decided to reboot the machine or not after the patch operation is completed.
...
class InputWindowsParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 classifications_to_include: Optional[Sequence[builtins.str]] = None,
                 exclude_kbs_requiring_reboot: Optional[builtins.bool] = None,
                 kb_numbers_to_exclude: Optional[Sequence[builtins.str]] = None,
                 kb_numbers_to_include: Optional[Sequence[builtins.str]] = None):
        """
        Input properties for patching a Windows machine.
        :param Sequence[builtins.str] classifications_to_include: Classification category of patches to be patched. Allowed values are 'Critical', 'Security', 'UpdateRollup', 'FeaturePack', 'ServicePack', 'Definition', 'Tools', and 'Updates'.
        :param builtins.bool exclude_kbs_requiring_reboot: Exclude patches which need reboot
        :param Sequence[builtins.str] kb_numbers_to_exclude: Windows KBID to be excluded for patching.
        :param Sequence[builtins.str] kb_numbers_to_include: Windows KBID to be included for patching.
        """
        if classifications_to_include is not None:
            pulumi.set(__self__, "classifications_to_include", classifications_to_include)
    ...
    def exclude_kbs_requiring_reboot(self) -> Optional[builtins.bool]:
        """
    ...
    def kb_numbers_to_exclude(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def kb_numbers_to_include(self) -> Optional[Sequence[builtins.str]]:
        """
