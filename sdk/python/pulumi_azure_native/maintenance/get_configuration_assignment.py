...
def get_configuration_assignment(configuration_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_name: Resource parent name
    :param builtins.str resource_type: Resource parent type
    """
    __args__ = dict()
...
def get_configuration_assignment_output(configuration_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
