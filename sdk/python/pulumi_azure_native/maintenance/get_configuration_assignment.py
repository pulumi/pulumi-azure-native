...
def get_configuration_assignment(configuration_assignment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_name: Resource parent name
    :param _builtins.str resource_type: Resource parent type
    """
    __args__ = dict()
...
def get_configuration_assignment_output(configuration_assignment_name: Optional[pulumi.Input[_builtins.str]] = None,
