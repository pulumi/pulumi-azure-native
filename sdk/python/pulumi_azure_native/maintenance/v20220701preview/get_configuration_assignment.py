...
def get_configuration_assignment(configuration_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maintenance/v20220701preview:getConfigurationAssignment', __args__, opts=opts, typ=GetConfigurationAssignmentResult).value
...
def get_configuration_assignment_output(configuration_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:maintenance/v20220701preview:getConfigurationAssignment', __args__, opts=opts, typ=GetConfigurationAssignmentResult)
