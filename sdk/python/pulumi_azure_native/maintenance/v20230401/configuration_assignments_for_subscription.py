...
class ConfigurationAssignmentsForSubscriptionArgs:
    def __init__(__self__, *,
        ...
        """
        ConfigurationAssignmentsForSubscriptionArgs._configure(
...
class ConfigurationAssignmentsForSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ConfigurationAssignmentsForSubscriptionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentsForSubscription"), pulumi.Alias(type_="azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationAssignmentsForSubscription, __self__).__init__(
            'azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription',
            resource_name,
            __props__,
            opts)
