...
def get_configuration_assignment_parent(configuration_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maintenance/v20230401:getConfigurationAssignmentParent', __args__, opts=opts, typ=GetConfigurationAssignmentParentResult).value
...
def get_configuration_assignment_parent_output(configuration_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceType'] = resource_type
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:maintenance/v20230401:getConfigurationAssignmentParent', __args__, opts=opts, typ=GetConfigurationAssignmentParentResult)
