...
class ConfigurationAssignmentsForResourceGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(filter, ConfigurationAssignmentFilterPropertiesArgs):
                filter = filter or {}
                def _setter(key, value):
                    filter[key] = value
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maintenance:ConfigurationAssignmentsForResourceGroup")])
