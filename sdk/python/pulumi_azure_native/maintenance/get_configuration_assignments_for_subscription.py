...
def get_configuration_assignments_for_subscription(configuration_assignment_name: Optional[_builtins.str] = None,
...
def get_configuration_assignments_for_subscription_output(configuration_assignment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:maintenance:getConfigurationAssignmentsForSubscription', __args__, opts=opts, typ=GetConfigurationAssignmentsForSubscriptionResult)
