...
def get_configuration_assignments_for_resource_group(configuration_assignment_name: Optional[builtins.str] = None,
...
def get_configuration_assignments_for_resource_group_output(configuration_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
