...
def get_configuration_assignment(configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_assignment is deprecated: azure-native:maintenance/v20210901preview:ConfigurationAssignment is being removed in the next major version of this provider. Please upgrade to azure-native:maintenance/v20221101preview:ConfigurationAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maintenance/v20210901preview:getConfigurationAssignment', __args__, opts=opts, typ=GetConfigurationAssignmentResult).value
