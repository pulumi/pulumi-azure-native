...
def get_configuration_assignment_parent(configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_assignment_parent is deprecated: azure-native:maintenance/v20210901preview:ConfigurationAssignmentParent is being removed in the next major version of this provider. Upgrade to at least azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent to guarantee forwards compatibility.""")
    __args__ = dict()
