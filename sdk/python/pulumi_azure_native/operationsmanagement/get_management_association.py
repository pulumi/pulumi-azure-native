...
def get_management_association(management_association_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_name: Parent resource name.
    :param _builtins.str resource_type: Resource type for the parent resource
    """
    __args__ = dict()
...
def get_management_association_output(management_association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
