...
class ManagementAssociationArgs:
    ...
    def _configure(
        ...
        if 'managementAssociationName' in kwargs:
...
class ManagementAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ManagementAssociationPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ManagementAssociationPropertiesArgs._configure(_setter, **properties)
