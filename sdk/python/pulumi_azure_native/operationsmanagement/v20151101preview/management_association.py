...
class ManagementAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationsmanagement/v20151101preview:ManagementAssociation"), pulumi.Alias(type_="azure-native:operationsmanagement:ManagementAssociation"), pulumi.Alias(type_="azure-nextgen:operationsmanagement:ManagementAssociation")])
