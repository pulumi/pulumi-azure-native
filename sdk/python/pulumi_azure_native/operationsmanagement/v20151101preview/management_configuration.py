...
class ManagementConfigurationArgs:
    ...
    def _configure(
        ...
        if management_configuration_name is None and 'managementConfigurationName' in kwargs:
            management_configuration_name = kwargs['managementConfigurationName']
...
class ManagementConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ManagementConfigurationPropertiesArgs, True)
