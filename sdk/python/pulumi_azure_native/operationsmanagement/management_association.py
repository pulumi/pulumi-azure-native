...
class ManagementAssociationArgs:
    def __init__(__self__, *,
                 ...
                 management_association_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] provider_name: Provider name for the parent resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group to get. The name is case insensitive.
        :param pulumi.Input[builtins.str] resource_name: Parent resource name.
        :param pulumi.Input[builtins.str] resource_type: Resource type for the parent resource
        :param pulumi.Input[builtins.str] location: Resource location
        :param pulumi.Input[builtins.str] management_association_name: User ManagementAssociation Name.
    ...
    def management_association_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_association_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagementAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] location: Resource location
        :param pulumi.Input[builtins.str] management_association_name: User ManagementAssociation Name.
        :param pulumi.Input[Union['ManagementAssociationPropertiesArgs', 'ManagementAssociationPropertiesArgsDict']] properties: Properties for ManagementAssociation object supported by the OperationsManagement resource provider.
        :param pulumi.Input[builtins.str] provider_name: Provider name for the parent resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group to get. The name is case insensitive.
        :param pulumi.Input[builtins.str] resource_name_: Parent resource name.
        :param pulumi.Input[builtins.str] resource_type: Resource type for the parent resource
        """
        ...
    @overload
