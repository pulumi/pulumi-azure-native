...
class ManagementConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str application_id: The applicationId of the appliance for this Management.
        """
...
class SolutionPlanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str publisher: Publisher name. For gallery solution, it is Microsoft.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class SolutionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 contained_resources: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] referenced_resources: The resources that will be referenced from this solution. Deleting any of those solution out of band will break the solution.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
