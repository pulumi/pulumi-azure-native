...
class ImportCollectorsOperationArgs:
    def __init__(__self__, *,
        ...
        """
        ImportCollectorsOperationArgs._configure(
    ...
    def _configure(
        ...
        if import_collector_name is None and 'importCollectorName' in kwargs:
            import_collector_name = kwargs['importCollectorName']
        ...
        if import_collector_name is not None:
            _setter("import_collector_name", import_collector_name)
...
class ImportCollectorsOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ImportCollectorsOperationArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollectorsOperation")])
