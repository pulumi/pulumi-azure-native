...
class VMwareCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:VMwareCollector")])
