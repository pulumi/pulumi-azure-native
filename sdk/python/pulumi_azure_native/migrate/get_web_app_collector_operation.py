...
def get_web_app_collector_operation(collector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str collector_name: Web app collector ARM name.
...
def get_web_app_collector_operation_output(collector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
