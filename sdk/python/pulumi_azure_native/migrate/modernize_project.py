...
class ModernizeProjectArgs:
    def __init__(__self__, *,
        ...
        """
        ModernizeProjectArgs._configure(
...
class ModernizeProject(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ModernizeProjectArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ModernizeProjectModelPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ModernizeProjectModelPropertiesArgs._configure(_setter, **properties)
