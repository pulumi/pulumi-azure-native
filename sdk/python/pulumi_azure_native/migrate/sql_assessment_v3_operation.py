...
class SqlAssessmentV3OperationArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['SqlAssessmentV3PropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['SqlAssessmentV3PropertiesArgs']]):
...
class SqlAssessmentV3Operation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['SqlAssessmentV3PropertiesArgs', 'SqlAssessmentV3PropertiesArgsDict']]] = None,
