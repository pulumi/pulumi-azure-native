...
def get_sql_collector_operation(collector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str collector_name: Sql collector ARM name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getSqlCollectorOperation', __args__, opts=opts, typ=GetSqlCollectorOperationResult).value
...
def get_sql_collector_operation_output(collector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getSqlCollectorOperation', __args__, opts=opts, typ=GetSqlCollectorOperationResult)
