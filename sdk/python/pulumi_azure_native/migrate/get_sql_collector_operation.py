...
def get_sql_collector_operation(collector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str collector_name: Sql collector ARM name.
...
def get_sql_collector_operation_output(collector_name: Optional[pulumi.Input[builtins.str]] = None,
