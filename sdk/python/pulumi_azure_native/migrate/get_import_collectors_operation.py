...
def get_import_collectors_operation(import_collector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str import_collector_name: Import collector ARM name
...
def get_import_collectors_operation_output(import_collector_name: Optional[pulumi.Input[builtins.str]] = None,
