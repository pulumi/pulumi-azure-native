...
def get_import_collectors_operation(import_collector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str import_collector_name: Import collector ARM name
...
def get_import_collectors_operation_output(import_collector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
