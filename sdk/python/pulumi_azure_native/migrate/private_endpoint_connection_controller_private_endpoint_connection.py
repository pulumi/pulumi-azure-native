...
class PrivateEndpointConnectionControllerPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 migrate_project_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] migrate_project_name: Migrate project name.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the Azure Resource Group that project is part of.
        :param pulumi.Input[builtins.str] e_tag: Gets the tag for optimistic concurrency control.
        :param pulumi.Input[builtins.str] pe_connection_name: Private endpoint connection name.
    ...
    def migrate_project_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def migrate_project_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection")
class PrivateEndpointConnectionControllerPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] migrate_project_name: Migrate project name.
        :param pulumi.Input[builtins.str] pe_connection_name: Private endpoint connection name.
        :param pulumi.Input[Union['ConnectionStateRequestBodyPropertiesArgs', 'ConnectionStateRequestBodyPropertiesArgsDict']] properties: Properties of Connection state request.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the Azure Resource Group that project is part of.
        """
        ...
    @overload
