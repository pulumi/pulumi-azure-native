...
class PrivateEndpointConnectionControllerPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20200501:PrivateEndpointConnectionControllerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:migrate/v20230101:PrivateEndpointConnectionControllerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native_migrate_v20200501:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection"), pulumi.Alias(type_="azure-native_migrate_v20230101:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection")])
