...
def get_sql_assessment_v2_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230401preview:getSqlAssessmentV2Operation', __args__, opts=opts, typ=GetSqlAssessmentV2OperationResult).value
