...
__all__ = ['AssessmentProjectsAssessmentsOperationArgs', 'AssessmentProjectsAssessmentsOperation']

@pulumi.input_type
class AssessmentProjectsAssessmentsOperationArgs:
...
class AssessmentProjectsAssessmentsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsAssessmentsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Machine assessment resource.

        :param str resource_name: The name of the resource.
        :param AssessmentProjectsAssessmentsOperationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsAssessmentsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsAssessmentsOperationArgs.__new__(AssessmentProjectsAssessmentsOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsAssessmentsOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsAssessmentsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsAssessmentsOperation':
        """
        ...
        return AssessmentProjectsAssessmentsOperation(resource_name, opts=opts, __props__=__props__)
