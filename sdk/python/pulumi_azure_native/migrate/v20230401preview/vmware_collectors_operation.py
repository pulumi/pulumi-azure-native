...
__all__ = ['VmwareCollectorsOperationArgs', 'VmwareCollectorsOperation']
...
class VmwareCollectorsOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: VmwareCollectorsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        VMware collector resource.

        :param str resource_name: The name of the resource.
        :param VmwareCollectorsOperationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VmwareCollectorsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:VmwareCollectorsOperation")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VmwareCollectorsOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return VmwareCollectorsOperation(resource_name, opts=opts, __props__=__props__)
