...
def get_aks_assessment_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230401preview:getAksAssessmentOperation', __args__, opts=opts, typ=GetAksAssessmentOperationResult).value
...
def get_aks_assessment_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230401preview:getAksAssessmentOperation', __args__, opts=opts, typ=GetAksAssessmentOperationResult)
