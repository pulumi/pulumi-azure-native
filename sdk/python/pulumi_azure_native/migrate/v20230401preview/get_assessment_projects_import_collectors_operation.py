...
__all__ = [
    'GetAssessmentProjectsImportCollectorsOperationResult',
    'AwaitableGetAssessmentProjectsImportCollectorsOperationResult',
    'get_assessment_projects_import_collectors_operation',
    'get_assessment_projects_import_collectors_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsImportCollectorsOperationResult:
    """
...
class AwaitableGetAssessmentProjectsImportCollectorsOperationResult(GetAssessmentProjectsImportCollectorsOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsImportCollectorsOperationResult(
...
def get_assessment_projects_import_collectors_operation(import_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230401preview:getAssessmentProjectsImportCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsImportCollectorsOperationResult).value

    return AwaitableGetAssessmentProjectsImportCollectorsOperationResult(
...
def get_assessment_projects_import_collectors_operation_output(import_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230401preview:getAssessmentProjectsImportCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsImportCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsImportCollectorsOperationResult(
