...
class AssessmentProjectsBusinessCaseOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsBusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsBusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsBusinessCaseOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsBusinessCaseOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsBusinessCaseOperation',
            resource_name,
            __props__,
            opts)
