...
class ImportCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollectorsOperation")])
