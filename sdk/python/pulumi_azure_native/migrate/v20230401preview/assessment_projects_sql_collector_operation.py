...
class AssessmentProjectsSqlCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsSqlCollectorOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsSqlCollectorOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsSqlCollectorOperation',
            resource_name,
            __props__,
            opts)
