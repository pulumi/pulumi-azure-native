...
__all__ = ['AssessmentProjectsAvsAssessmentsOperationArgs', 'AssessmentProjectsAvsAssessmentsOperation']

@pulumi.input_type
class AssessmentProjectsAvsAssessmentsOperationArgs:
...
class AssessmentProjectsAvsAssessmentsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsAvsAssessmentsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        AVS assessment resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsAvsAssessmentsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsAvsAssessmentsOperationArgs.__new__(AssessmentProjectsAvsAssessmentsOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsAvsAssessmentsOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsAvsAssessmentsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsAvsAssessmentsOperation':
        """
        ...
        return AssessmentProjectsAvsAssessmentsOperation(resource_name, opts=opts, __props__=__props__)
