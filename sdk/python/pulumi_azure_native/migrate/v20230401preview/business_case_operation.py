...
class BusinessCaseOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:BusinessCaseOperation")])
