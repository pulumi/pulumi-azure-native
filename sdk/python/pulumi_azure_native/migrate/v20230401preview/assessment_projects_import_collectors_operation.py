...
__all__ = ['AssessmentProjectsImportCollectorsOperationArgs', 'AssessmentProjectsImportCollectorsOperation']

@pulumi.input_type
class AssessmentProjectsImportCollectorsOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] import_collector_name: Import collector ARM name
...
class AssessmentProjectsImportCollectorsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsImportCollectorsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Import collector resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsImportCollectorsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsImportCollectorsOperationArgs.__new__(AssessmentProjectsImportCollectorsOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsImportCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsImportCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsImportCollectorsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsImportCollectorsOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsImportCollectorsOperation(resource_name, opts=opts, __props__=__props__)
