...
class AvsAssessmentsOperationArgs:
    ...
    def azure_location(self, value: Optional[pulumi.Input[Union[str, 'AzureLocation']]]):
    ...
    def failures_to_tolerate_and_raid_level(self, value: Optional[pulumi.Input[Union[str, 'FttAndRaidLevel']]]):
    ...
    def node_type(self) -> Optional[pulumi.Input[Union[str, 'AzureAvsNodeType']]]:
        """
        AVS node type.
        """
...
class AvsAssessmentsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AvsAssessmentsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvsAssessmentsOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AvsAssessmentsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def cpu_utilization(self) -> pulumi.Output[float]:
        """
    ...
    @property
    @pulumi.getter(name="dedupeCompression")
    def dedupe_compression(self) -> pulumi.Output[Optional[float]]:
        """
        De-duplication compression.
        """
        return pulumi.get(self, "dedupe_compression")
    ...
    @property
    @pulumi.getter(name="isStretchClusterEnabled")
    def is_stretch_cluster_enabled(self) -> pulumi.Output[Optional[bool]]:
        """
        Is Stretch Cluster Enabled.
        """
        return pulumi.get(self, "is_stretch_cluster_enabled")
    ...
    def limiting_factor(self) -> pulumi.Output[str]:
        """
        Limiting factor.
        """
    ...
    @property
    @pulumi.getter(name="memOvercommit")
    def mem_overcommit(self) -> pulumi.Output[Optional[float]]:
        """
        Memory overcommit.
        """
        return pulumi.get(self, "mem_overcommit")
    ...
    def ram_utilization(self) -> pulumi.Output[float]:
        """
    ...
    def storage_utilization(self) -> pulumi.Output[float]:
        """
    ...
    @property
    @pulumi.getter
    def suitability(self) -> pulumi.Output[str]:
        """
    ...
    def suitability_explanation(self) -> pulumi.Output[str]:
        """
    ...
    def total_cpu_cores(self) -> pulumi.Output[float]:
        """
    ...
    def total_monthly_cost(self) -> pulumi.Output[float]:
        """
        Total monthly cost.
        """
    ...
    def total_ram_in_gb(self) -> pulumi.Output[float]:
        """
    ...
    def total_storage_in_gb(self) -> pulumi.Output[float]:
        """
    ...
    @property
    @pulumi.getter(name="vcpuOversubscription")
    def vcpu_oversubscription(self) -> pulumi.Output[Optional[float]]:
        """
        VCPU over subscription.
        """
        return pulumi.get(self, "vcpu_oversubscription")
