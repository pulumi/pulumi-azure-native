...
class AssessmentProjectsServerCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsServerCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsServerCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230401preview:AssessmentProjectsServerCollectorsOperation',
            resource_name,
            __props__,
            opts)
