...
class MigrateProjectsControllerMigrateProject(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20200501:MigrateProjectsControllerMigrateProject"), pulumi.Alias(type_="azure-native:migrate:MigrateProjectsControllerMigrateProject"), pulumi.Alias(type_="azure-nextgen:migrate:MigrateProjectsControllerMigrateProject"), pulumi.Alias(type_="azure-native:migrate/v20180901preview:MigrateProjectsControllerMigrateProject"), pulumi.Alias(type_="azure-nextgen:migrate/v20180901preview:MigrateProjectsControllerMigrateProject")])
