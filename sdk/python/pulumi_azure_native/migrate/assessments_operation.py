...
class AssessmentsOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'AzurePricingTier']] azure_pricing_tier: Gets or sets Azure Pricing Tier - Free, Basic, etc.
        :param pulumi.Input[Union[_builtins.str, 'AzureStorageRedundancy']] azure_storage_redundancy: Gets or sets the Azure Storage Redundancy. Example: Locally Redundant Storage.
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'AzureVmFamily']]]] azure_vm_families: Gets or sets the Azure VM families.
        ...
        :param pulumi.Input[_builtins.str] ea_subscription_id: Gets or sets enterprise agreement subscription id.
        :param pulumi.Input[Union[_builtins.str, 'AzureHybridUseBenefit']] linux_azure_hybrid_use_benefit: Gets or sets the user configurable setting to display the linux azure hybrid use
               benefit.
        ...
        :param pulumi.Input[Union[_builtins.str, 'AzureReservedInstance']] reserved_instance: Gets or sets the Azure Reserved Instance - 1-Year, 3-Year.
...
class AssessmentsOperation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="vmUptime")
    def vm_uptime(self) -> pulumi.Output[Optional['outputs.VmUptimeAssessmentsOperationResponse']]:
        """
        Gets or sets the duration for which the VMs are up in the on-premises
        environment.
        """
