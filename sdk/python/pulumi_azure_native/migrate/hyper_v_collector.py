...
class HyperVCollectorArgs:
    def __init__(__self__, *,
                 ...
                 hyper_v_collector_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] hyper_v_collector_name: Unique name of a Hyper-V collector within a project.
        """
    ...
    def hyper_v_collector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hyper_v_collector_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HyperVCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240115:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20240303preview:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate:HypervCollectorsOperation")])
