...
class ServerCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:ServerCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:ServerCollector"), pulumi.Alias(type_="azure-native_migrate_v20191001:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:ServerCollectorsOperation")])
