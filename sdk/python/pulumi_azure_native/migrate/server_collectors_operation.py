...
class ServerCollectorsOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_collector_name: Physical server collector ARM name
        """
