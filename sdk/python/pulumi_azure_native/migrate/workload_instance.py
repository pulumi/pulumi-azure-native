...
class WorkloadInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20220501preview:WorkloadInstance"), pulumi.Alias(type_="azure-native_migrate_v20220501preview:migrate:WorkloadInstance")])
