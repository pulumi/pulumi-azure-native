...
class Task(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] project_name: Migrate Project Name
        :param pulumi.Input[Union['TaskPropertiesArgs', 'TaskPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] task_name: Task ARM name
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20250330preview:Task"), pulumi.Alias(type_="azure-native:migrate/v20251201preview:Task"), pulumi.Alias(type_="azure-native:migrate/v20260201preview:Task")])
