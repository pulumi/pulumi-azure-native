...
class Group(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:Group"), pulumi.Alias(type_="azure-native:migrate/v20230315:GroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:GroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:GroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:GroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:GroupsOperation"), pulumi.Alias(type_="azure-native:migrate:GroupsOperation"), pulumi.Alias(type_="azure-native_migrate_v20191001:migrate:Group"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:Group"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:Group"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:Group"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:Group"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:Group")])
