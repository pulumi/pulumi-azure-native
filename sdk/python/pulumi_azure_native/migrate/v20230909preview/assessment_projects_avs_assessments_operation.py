...
class AssessmentProjectsAvsAssessmentsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsAvsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsAvsAssessmentsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsAvsAssessmentsOperation, __self__).__init__(
            'azure-native:migrate/v20230909preview:AssessmentProjectsAvsAssessmentsOperation',
            resource_name,
            __props__,
            opts)
