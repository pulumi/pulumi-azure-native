...
def get_aks_assessment_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAksAssessmentOperation', __args__, opts=opts, typ=GetAksAssessmentOperationResult).value
