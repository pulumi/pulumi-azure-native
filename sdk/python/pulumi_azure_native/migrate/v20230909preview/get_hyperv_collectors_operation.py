...
def get_hyperv_collectors_operation(hyperv_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult).value
...
def get_hyperv_collectors_operation_output(hyperv_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult)
