...
class AssessmentProjectsGroupsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsGroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsGroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsGroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsGroupsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsGroupsOperation")])
