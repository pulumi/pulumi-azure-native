...
def get_assessment_projects_assessments_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAssessmentProjectsAssessmentsOperation', __args__, opts=opts, typ=GetAssessmentProjectsAssessmentsOperationResult).value
...
def get_assessment_projects_assessments_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAssessmentProjectsAssessmentsOperation', __args__, opts=opts, typ=GetAssessmentProjectsAssessmentsOperationResult)
