...
def get_avs_assessments_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAvsAssessmentsOperation', __args__, opts=opts, typ=GetAvsAssessmentsOperationResult).value
...
def get_avs_assessments_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAvsAssessmentsOperation', __args__, opts=opts, typ=GetAvsAssessmentsOperationResult)
