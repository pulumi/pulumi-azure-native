...
__all__ = [
    'GetAssessmentProjectsGroupsOperationResult',
    'AwaitableGetAssessmentProjectsGroupsOperationResult',
    'get_assessment_projects_groups_operation',
    'get_assessment_projects_groups_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsGroupsOperationResult:
    """
    Group resource.
    """
...
class AwaitableGetAssessmentProjectsGroupsOperationResult(GetAssessmentProjectsGroupsOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsGroupsOperationResult(
...
def get_assessment_projects_groups_operation(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAssessmentProjectsGroupsOperation', __args__, opts=opts, typ=GetAssessmentProjectsGroupsOperationResult).value

    return AwaitableGetAssessmentProjectsGroupsOperationResult(
...
def get_assessment_projects_groups_operation_output(group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAssessmentProjectsGroupsOperation', __args__, opts=opts, typ=GetAssessmentProjectsGroupsOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsGroupsOperationResult(
