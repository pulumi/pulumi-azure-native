...
class AssessmentProjectsWebAppAssessmentV2Operation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsWebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsWebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:AssessmentProjectsWebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsWebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate:WebAppAssessmentV2Operation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsWebAppAssessmentV2Operation, __self__).__init__(
            'azure-native:migrate/v20230909preview:AssessmentProjectsWebAppAssessmentV2Operation',
            resource_name,
            __props__,
            opts)
