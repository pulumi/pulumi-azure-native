...
class AssessmentProjectsServerCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsServerCollectorsOperation")])
