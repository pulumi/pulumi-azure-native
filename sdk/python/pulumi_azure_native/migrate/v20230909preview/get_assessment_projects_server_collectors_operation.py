...
__all__ = [
    'GetAssessmentProjectsServerCollectorsOperationResult',
    'AwaitableGetAssessmentProjectsServerCollectorsOperationResult',
    'get_assessment_projects_server_collectors_operation',
    'get_assessment_projects_server_collectors_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsServerCollectorsOperationResult:
    """
...
class AwaitableGetAssessmentProjectsServerCollectorsOperationResult(GetAssessmentProjectsServerCollectorsOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsServerCollectorsOperationResult(
...
def get_assessment_projects_server_collectors_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAssessmentProjectsServerCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsServerCollectorsOperationResult).value

    return AwaitableGetAssessmentProjectsServerCollectorsOperationResult(
...
def get_assessment_projects_server_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAssessmentProjectsServerCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsServerCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsServerCollectorsOperationResult(
