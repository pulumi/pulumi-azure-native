...
def get_assessment_projects_hyperv_collectors_operation(hyperv_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAssessmentProjectsHypervCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsHypervCollectorsOperationResult).value
...
def get_assessment_projects_hyperv_collectors_operation_output(hyperv_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAssessmentProjectsHypervCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsHypervCollectorsOperationResult)
