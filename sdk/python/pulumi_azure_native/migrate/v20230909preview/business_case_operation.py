...
class BusinessCaseOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:BusinessCaseOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BusinessCaseOperation, __self__).__init__(
            'azure-native:migrate/v20230909preview:BusinessCaseOperation',
            resource_name,
            __props__,
            opts)
