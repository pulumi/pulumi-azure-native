...
class WebAppCollectorOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebAppCollectorOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate:WebAppCollectorOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppCollectorOperation, __self__).__init__(
            'azure-native:migrate/v20230909preview:WebAppCollectorOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WebAppCollectorOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return WebAppCollectorOperation(resource_name, opts=opts, __props__=__props__)
