...
class WebAppAssessmentV2Operation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:WebAppAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate:WebAppAssessmentV2Operation")])
