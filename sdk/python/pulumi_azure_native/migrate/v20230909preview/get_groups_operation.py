...
def get_groups_operation(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getGroupsOperation', __args__, opts=opts, typ=GetGroupsOperationResult).value
...
def get_groups_operation_output(group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getGroupsOperation', __args__, opts=opts, typ=GetGroupsOperationResult)
