...
class SqlAssessmentV2Operation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230315:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:SqlAssessmentV2Operation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlAssessmentV2Operation, __self__).__init__(
            'azure-native:migrate/v20230909preview:SqlAssessmentV2Operation',
            resource_name,
            __props__,
            opts)
