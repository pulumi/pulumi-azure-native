...
class AssessmentProjectsImportCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:ImportCollector"), pulumi.Alias(type_="azure-native:migrate:ImportCollectorsOperation")])
