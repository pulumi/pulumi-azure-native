...
def get_assessment_projects_sql_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230909preview:getAssessmentProjectsSqlCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsSqlCollectorOperationResult).value
...
def get_assessment_projects_sql_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230909preview:getAssessmentProjectsSqlCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsSqlCollectorOperationResult)
