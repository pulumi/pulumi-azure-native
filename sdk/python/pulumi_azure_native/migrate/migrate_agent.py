...
class MigrateAgentArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['MigrateAgentModelPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['MigrateAgentModelPropertiesArgs']]):
...
class MigrateAgent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['MigrateAgentModelPropertiesArgs', 'MigrateAgentModelPropertiesArgsDict']]] = None,
