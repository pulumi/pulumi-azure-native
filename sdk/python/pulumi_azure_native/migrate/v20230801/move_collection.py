...
class MoveCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 move_collection_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['MoveCollectionPropertiesArgs', 'MoveCollectionPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['IdentityArgs', 'IdentityArgsDict']] identity: Defines the MSI properties of the Move Collection.
        :param pulumi.Input[str] location: The geo-location where the resource lives.
        :param pulumi.Input[str] move_collection_name: The Move Collection Name.
        :param pulumi.Input[Union['MoveCollectionPropertiesArgs', 'MoveCollectionPropertiesArgsDict']] properties: Defines the move collection properties.
        :param pulumi.Input[str] resource_group_name: The Resource Group Name.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20191001preview:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210101:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210801:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20220801:MoveCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MoveCollection, __self__).__init__(
            'azure-native:migrate/v20230801:MoveCollection',
            resource_name,
            __props__,
            opts)
