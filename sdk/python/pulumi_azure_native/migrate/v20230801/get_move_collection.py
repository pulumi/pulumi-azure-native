...
def get_move_collection(move_collection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230801:getMoveCollection', __args__, opts=opts, typ=GetMoveCollectionResult).value
...
def get_move_collection_output(move_collection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230801:getMoveCollection', __args__, opts=opts, typ=GetMoveCollectionResult)
