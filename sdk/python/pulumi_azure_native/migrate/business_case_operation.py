...
class BusinessCaseOperationArgs:
    def __init__(__self__, *,
                 ...
                 business_case_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] business_case_name: Business case ARM name
    ...
    def business_case_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def business_case_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BusinessCaseOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:BusinessCaseOperation"), pulumi.Alias(type_="azure-native:migrate/v20240303preview:BusinessCaseOperation")])
