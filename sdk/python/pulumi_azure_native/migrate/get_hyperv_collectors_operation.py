...
def get_hyperv_collectors_operation(hyperv_collector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hyperv_collector_name: Hyper-V collector ARM name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult).value
...
def get_hyperv_collectors_operation_output(hyperv_collector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult)
