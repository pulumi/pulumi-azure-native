...
def get_hyperv_collectors_operation(hyperv_collector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str hyperv_collector_name: Hyper-V collector ARM name
...
def get_hyperv_collectors_operation_output(hyperv_collector_name: Optional[pulumi.Input[builtins.str]] = None,
