...
def get_migrate_project(migrate_project_name: Optional[_builtins.str] = None,
...
def get_migrate_project_output(migrate_project_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getMigrateProject', __args__, opts=opts, typ=GetMigrateProjectResult)
