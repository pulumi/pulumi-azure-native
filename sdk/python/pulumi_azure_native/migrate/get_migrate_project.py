...
def get_migrate_project(migrate_project_name: Optional[builtins.str] = None,
...
def get_migrate_project_output(migrate_project_name: Optional[pulumi.Input[builtins.str]] = None,
