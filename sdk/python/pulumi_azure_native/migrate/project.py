...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:Project"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsOperation"), pulumi.Alias(type_="azure-native_migrate_v20191001:migrate:Project"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:Project"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:Project"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:Project"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:Project"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:Project")])
