...
def get_modernize_project(modernize_project_name: Optional[_builtins.str] = None,
...
def get_modernize_project_output(modernize_project_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
