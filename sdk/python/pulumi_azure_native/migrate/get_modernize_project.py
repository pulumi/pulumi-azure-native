...
def get_modernize_project(modernize_project_name: Optional[builtins.str] = None,
    ...
    :param builtins.str modernize_project_name: Modernize project name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getModernizeProject', __args__, opts=opts, typ=GetModernizeProjectResult).value
...
def get_modernize_project_output(modernize_project_name: Optional[pulumi.Input[builtins.str]] = None,
