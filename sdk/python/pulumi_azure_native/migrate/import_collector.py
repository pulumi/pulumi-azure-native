...
class ImportCollectorArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['ImportCollectorPropertiesArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ImportCollectorPropertiesArgs']]:
        return pulumi.get(self, "properties")

    @properties.setter
    def properties(self, value: pulumi.Input[Optional['ImportCollectorPropertiesArgs']]):
...
class ImportCollector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['ImportCollectorPropertiesArgs', 'ImportCollectorPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ImportCollectorArgs.__new__(ImportCollectorArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240115:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20240303preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate:ImportCollectorsOperation")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ImportCollector':
        """
        ...
        __props__.__dict__["type"] = None
        return ImportCollector(resource_name, opts=opts, __props__=__props__)
