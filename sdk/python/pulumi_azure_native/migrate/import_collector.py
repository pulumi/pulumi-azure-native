...
class ImportCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:ImportCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20191001:migrate:ImportCollector"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:ImportCollector"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:ImportCollector"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:ImportCollector"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:ImportCollector"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:ImportCollector")])
