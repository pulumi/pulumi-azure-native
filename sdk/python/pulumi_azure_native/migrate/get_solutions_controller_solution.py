...
def get_solutions_controller_solution(migrate_project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getSolutionsControllerSolution', __args__, opts=opts, typ=GetSolutionsControllerSolutionResult).value
...
def get_solutions_controller_solution_output(migrate_project_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['solutionName'] = solution_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getSolutionsControllerSolution', __args__, opts=opts, typ=GetSolutionsControllerSolutionResult)
