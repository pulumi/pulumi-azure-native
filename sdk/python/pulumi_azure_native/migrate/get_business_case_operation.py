...
def get_business_case_operation(business_case_name: Optional[_builtins.str] = None,
...
def get_business_case_operation_output(business_case_name: pulumi.Input[Optional[_builtins.str]] = None,
