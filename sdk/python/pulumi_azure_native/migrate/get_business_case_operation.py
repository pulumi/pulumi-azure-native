...
def get_business_case_operation(business_case_name: Optional[builtins.str] = None,
...
def get_business_case_operation_output(business_case_name: Optional[pulumi.Input[builtins.str]] = None,
