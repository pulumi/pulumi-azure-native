...
class Group(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:Group"), pulumi.Alias(type_="azure-nextgen:migrate:Group"), pulumi.Alias(type_="azure-native:migrate/latest:Group"), pulumi.Alias(type_="azure-nextgen:migrate/latest:Group")])
