...
class Group(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:Group"), pulumi.Alias(type_="azure-native:migrate/v20230315:Group"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:Group"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:Group")])
