...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        project = azure_native.migrate.v20191001.Project("project",
            e_tag="",
            location="West Europe",
            project_name="abGoyalProject2",
            properties=azure_native.migrate.v20191001.ProjectPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:Project")])
