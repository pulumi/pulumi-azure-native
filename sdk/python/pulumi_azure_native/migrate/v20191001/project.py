...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:Project"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:Project"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:Project"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:Project"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:Project"), pulumi.Alias(type_="azure-native:migrate:Project")])
