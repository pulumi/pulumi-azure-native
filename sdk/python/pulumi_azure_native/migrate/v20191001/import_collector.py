...
class ImportCollectorArgs:
    def __init__(__self__, *,
        ...
        """
        ImportCollectorArgs._configure(
    ...
    def _configure(
        ...
        if 'eTag' in kwargs:
            e_tag = kwargs['eTag']
        if 'importCollectorName' in kwargs:
...
class ImportCollector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ImportCollectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ImportCollectorPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ImportCollectorPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:ImportCollector")])
