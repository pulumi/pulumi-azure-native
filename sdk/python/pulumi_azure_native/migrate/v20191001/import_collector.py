...
class ImportCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:ImportCollector"), pulumi.Alias(type_="azure-native:migrate:ImportCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ImportCollector, __self__).__init__(
            'azure-native:migrate/v20191001:ImportCollector',
            resource_name,
            __props__,
            opts)
