...
class Assessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:Assessment"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:Assessment"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:Assessment"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:Assessment"), pulumi.Alias(type_="azure-native:migrate:Assessment")])
