...
class Assessment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:Assessment"), pulumi.Alias(type_="azure-nextgen:migrate:Assessment"), pulumi.Alias(type_="azure-native:migrate/latest:Assessment"), pulumi.Alias(type_="azure-nextgen:migrate/latest:Assessment")])
