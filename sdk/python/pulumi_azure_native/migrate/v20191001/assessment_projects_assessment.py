...
class AssessmentProjectsAssessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsAssessment"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsAssessment"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsAssessment"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsAssessment"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsAssessment")])
