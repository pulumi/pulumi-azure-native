...
class VMwareCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:VMwareCollector")])
