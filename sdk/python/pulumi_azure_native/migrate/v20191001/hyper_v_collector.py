...
class HyperVCollectorArgs:
    def __init__(__self__, *,
        ...
        """
        HyperVCollectorArgs._configure(
    ...
    def _configure(
        ...
        if e_tag is None and 'eTag' in kwargs:
            e_tag = kwargs['eTag']
        if hyper_v_collector_name is None and 'hyperVCollectorName' in kwargs:
            hyper_v_collector_name = kwargs['hyperVCollectorName']
        ...
        if hyper_v_collector_name is not None:
            _setter("hyper_v_collector_name", hyper_v_collector_name)
...
class HyperVCollector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            HyperVCollectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:HyperVCollector")])
