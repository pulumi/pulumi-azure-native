...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:migrate/v20230315:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:PrivateEndpointConnection")])
