...
class SqlCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:SqlCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:SqlCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:SqlCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:SqlCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:SqlCollectorOperation")])
