...
def get_assessment_projects_web_app_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getAssessmentProjectsWebAppCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppCollectorOperationResult).value
...
def get_assessment_projects_web_app_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getAssessmentProjectsWebAppCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppCollectorOperationResult)
