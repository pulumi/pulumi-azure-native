...
class MoveCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        move_collection = azure_native.migrate.v20220801.MoveCollection("moveCollection",
            identity=azure_native.migrate.v20220801.IdentityArgs(
                type="SystemAssigned",
            ),
            location="eastus2",
            move_collection_name="movecollection1",
            properties=azure_native.migrate.v20220801.MoveCollectionPropertiesResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20191001preview:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210101:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210801:MoveCollection")])
