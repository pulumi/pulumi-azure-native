...
def get_avs_assessments_operation(assessment_name: Optional[_builtins.str] = None,
...
def get_avs_assessments_operation_output(assessment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
