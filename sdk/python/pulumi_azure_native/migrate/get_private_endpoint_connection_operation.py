...
def get_private_endpoint_connection_operation(private_endpoint_connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str private_endpoint_connection_name: Private endpoint connection ARM name
...
def get_private_endpoint_connection_operation_output(private_endpoint_connection_name: Optional[pulumi.Input[builtins.str]] = None,
