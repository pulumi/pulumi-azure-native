...
def get_project(project_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project is deprecated: Version v20171111preview will be removed in the next major version of the provider. Upgrade to version v20180202 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20171111preview:getProject', __args__, opts=opts, typ=GetProjectResult).value
