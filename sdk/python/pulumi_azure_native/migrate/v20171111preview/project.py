...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20171111preview:Project"), pulumi.Alias(type_="azure-native:migrate/v20180202:Project"), pulumi.Alias(type_="azure-nextgen:migrate/v20180202:Project")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Project, __self__).__init__(
            'azure-native:migrate/v20171111preview:Project',
            resource_name,
            __props__,
            opts)
