...
def get_groups_operation(group_name: Optional[_builtins.str] = None,
...
def get_groups_operation_output(group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
