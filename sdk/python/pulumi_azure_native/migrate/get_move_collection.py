...
def get_move_collection(move_collection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str move_collection_name: The Move Collection Name.
...
def get_move_collection_output(move_collection_name: Optional[pulumi.Input[builtins.str]] = None,
