...
class MigrateProjectsControllerMigrateProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Azure location in which project is created.
...
@pulumi.type_token("azure-native:migrate:MigrateProjectsControllerMigrateProject")
class MigrateProjectsControllerMigrateProject(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.MigrateProjectPropertiesMigrateProjectsControllerMigrateProjectResponse']:
        """
        Properties of a migrate project.
        """
        return pulumi.get(self, "properties")
