...
def get_assessment_projects_sql_assessment_v2_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getAssessmentProjectsSqlAssessmentV2Operation', __args__, opts=opts, typ=GetAssessmentProjectsSqlAssessmentV2OperationResult).value
...
def get_assessment_projects_sql_assessment_v2_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getAssessmentProjectsSqlAssessmentV2Operation', __args__, opts=opts, typ=GetAssessmentProjectsSqlAssessmentV2OperationResult)
