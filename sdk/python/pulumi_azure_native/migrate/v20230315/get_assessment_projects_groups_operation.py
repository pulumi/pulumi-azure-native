...
def get_assessment_projects_groups_operation(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getAssessmentProjectsGroupsOperation', __args__, opts=opts, typ=GetAssessmentProjectsGroupsOperationResult).value
...
def get_assessment_projects_groups_operation_output(group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getAssessmentProjectsGroupsOperation', __args__, opts=opts, typ=GetAssessmentProjectsGroupsOperationResult)
