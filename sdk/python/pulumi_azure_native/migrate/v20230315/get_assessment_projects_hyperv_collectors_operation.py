...
__all__ = [
    'GetAssessmentProjectsHypervCollectorsOperationResult',
    'AwaitableGetAssessmentProjectsHypervCollectorsOperationResult',
    'get_assessment_projects_hyperv_collectors_operation',
    'get_assessment_projects_hyperv_collectors_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsHypervCollectorsOperationResult:
    """
...
class AwaitableGetAssessmentProjectsHypervCollectorsOperationResult(GetAssessmentProjectsHypervCollectorsOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsHypervCollectorsOperationResult(
...
def get_assessment_projects_hyperv_collectors_operation(hyperv_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getAssessmentProjectsHypervCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsHypervCollectorsOperationResult).value

    return AwaitableGetAssessmentProjectsHypervCollectorsOperationResult(
...
def get_assessment_projects_hyperv_collectors_operation_output(hyperv_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getAssessmentProjectsHypervCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsHypervCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsHypervCollectorsOperationResult(
