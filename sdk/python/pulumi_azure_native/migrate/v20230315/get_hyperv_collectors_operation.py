...
class AwaitableGetHypervCollectorsOperationResult(GetHypervCollectorsOperationResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetHypervCollectorsOperationResult(
...
def get_hyperv_collectors_operation(hyperv_collector_name: Optional[str] = None,
                                    project_name: Optional[str] = None,
                                    resource_group_name: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHypervCollectorsOperationResult:
    """
    ...
    """
    __args__ = dict()
    __args__['hypervCollectorName'] = hyperv_collector_name
    __args__['projectName'] = project_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult).value

    return AwaitableGetHypervCollectorsOperationResult(
...
def get_hyperv_collectors_operation_output(hyperv_collector_name: Optional[pulumi.Input[str]] = None,
                                           project_name: Optional[pulumi.Input[str]] = None,
                                           resource_group_name: Optional[pulumi.Input[str]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetHypervCollectorsOperationResult]:
    """
    Get a HypervCollector
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getHypervCollectorsOperation', __args__, opts=opts, typ=GetHypervCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetHypervCollectorsOperationResult(
