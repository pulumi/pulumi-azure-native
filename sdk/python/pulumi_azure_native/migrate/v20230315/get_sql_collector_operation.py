...
class AwaitableGetSqlCollectorOperationResult(GetSqlCollectorOperationResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetSqlCollectorOperationResult(
...
def get_sql_collector_operation(collector_name: Optional[str] = None,
                                project_name: Optional[str] = None,
                                resource_group_name: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSqlCollectorOperationResult:
    """
    Get a SqlCollector
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getSqlCollectorOperation', __args__, opts=opts, typ=GetSqlCollectorOperationResult).value

    return AwaitableGetSqlCollectorOperationResult(
...
def get_sql_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getSqlCollectorOperation', __args__, opts=opts, typ=GetSqlCollectorOperationResult)
