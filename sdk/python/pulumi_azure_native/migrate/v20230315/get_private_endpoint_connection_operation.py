...
def get_private_endpoint_connection_operation(private_endpoint_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getPrivateEndpointConnectionOperation', __args__, opts=opts, typ=GetPrivateEndpointConnectionOperationResult).value
