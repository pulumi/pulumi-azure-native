...
def get_assessment_projects_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getAssessmentProjectsOperation', __args__, opts=opts, typ=GetAssessmentProjectsOperationResult).value
...
def get_assessment_projects_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getAssessmentProjectsOperation', __args__, opts=opts, typ=GetAssessmentProjectsOperationResult)
