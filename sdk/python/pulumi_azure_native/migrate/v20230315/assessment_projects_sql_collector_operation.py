...
__all__ = ['AssessmentProjectsSqlCollectorOperationArgs', 'AssessmentProjectsSqlCollectorOperation']

@pulumi.input_type
class AssessmentProjectsSqlCollectorOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] collector_name: Sql collector ARM name.
...
class AssessmentProjectsSqlCollectorOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsSqlCollectorOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The SQL collector REST object.

        :param str resource_name: The name of the resource.
        :param AssessmentProjectsSqlCollectorOperationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsSqlCollectorOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsSqlCollectorOperationArgs.__new__(AssessmentProjectsSqlCollectorOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsSqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsSqlCollectorOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsSqlCollectorOperation, __self__).__init__(
            'azure-native:migrate/v20230315:AssessmentProjectsSqlCollectorOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsSqlCollectorOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsSqlCollectorOperation(resource_name, opts=opts, __props__=__props__)
