...
class AssessmentProjectsVmwareCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsVmwareCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsVmwareCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230315:AssessmentProjectsVmwareCollectorsOperation',
            resource_name,
            __props__,
            opts)
