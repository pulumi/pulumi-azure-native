...
class ServerCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:ServerCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:ServerCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230315:ServerCollectorsOperation',
            resource_name,
            __props__,
            opts)
