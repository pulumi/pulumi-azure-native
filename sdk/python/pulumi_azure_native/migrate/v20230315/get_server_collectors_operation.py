...
def get_server_collectors_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230315:getServerCollectorsOperation', __args__, opts=opts, typ=GetServerCollectorsOperationResult).value
...
def get_server_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverCollectorName'] = server_collector_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230315:getServerCollectorsOperation', __args__, opts=opts, typ=GetServerCollectorsOperationResult)
