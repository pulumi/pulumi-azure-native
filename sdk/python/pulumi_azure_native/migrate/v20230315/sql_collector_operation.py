...
class SqlCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate:SqlCollectorOperation")])
