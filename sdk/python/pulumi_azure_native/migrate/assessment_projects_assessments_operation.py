...
class AssessmentProjectsAssessmentsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:Assessment"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:AssessmentProjectsAssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:AssessmentsOperation"), pulumi.Alias(type_="azure-native:migrate:Assessment"), pulumi.Alias(type_="azure-native:migrate:AssessmentsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsAssessmentsOperation, __self__).__init__(
            'azure-native:migrate:AssessmentProjectsAssessmentsOperation',
            resource_name,
            __props__,
            opts)
