...
def get_task(project_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str task_name: Task ARM name
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getTask', __args__, opts=opts, typ=GetTaskResult).value
...
def get_task_output(project_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getTask', __args__, opts=opts, typ=GetTaskResult)
