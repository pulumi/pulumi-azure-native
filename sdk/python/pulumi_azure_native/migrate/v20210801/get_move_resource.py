...
def get_move_resource(move_collection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_move_resource is deprecated: azure-native:migrate/v20210801:MoveResource is being removed in the next major version of this provider. Upgrade to at least azure-native:migrate/v20220801:MoveResource to guarantee forwards compatibility.""")
    __args__ = dict()
