...
class CompoundAssessmentOperationArgs:
    def __init__(__self__, *,
                 ...
                 compound_assessment_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compound_assessment_name: Compound Assessment ARM name
    ...
    def compound_assessment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compound_assessment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CompoundAssessmentOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] compound_assessment_name: Compound Assessment ARM name
        :param pulumi.Input[builtins.str] project_name: Assessment Project Name
        :param pulumi.Input[Union['CompoundAssessmentPropertiesArgs', 'CompoundAssessmentPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CompoundAssessmentOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20240303preview:CompoundAssessmentOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CompoundAssessmentOperation, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'CompoundAssessmentOperation':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return CompoundAssessmentOperation(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CompoundAssessmentPropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
