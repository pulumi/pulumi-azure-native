...
def get_private_endpoint_connection_controller_private_endpoint_connection(migrate_project_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pe_connection_name: Private endpoint connection name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getPrivateEndpointConnectionControllerPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_controller_private_endpoint_connection_output(migrate_project_name: Optional[pulumi.Input[builtins.str]] = None,
