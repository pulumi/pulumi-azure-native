...
def get_vmware_collectors_operation(project_name: Optional[builtins.str] = None,
    ...
    :param builtins.str vm_ware_collector_name: VMware collector ARM name
    """
    __args__ = dict()
...
def get_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[builtins.str]] = None,
