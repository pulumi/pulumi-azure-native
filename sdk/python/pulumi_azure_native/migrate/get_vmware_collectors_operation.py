...
def get_vmware_collectors_operation(project_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vm_ware_collector_name: VMware collector ARM name
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult).value
...
def get_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult)
