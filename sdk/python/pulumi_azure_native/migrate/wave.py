...
class WaveArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['WavePropertiesArgs']] = None,
...
class Wave(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['WavePropertiesArgs', 'WavePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] project_name: Migrate Project Name
        :param pulumi.Input[Union['WavePropertiesArgs', 'WavePropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] wave_name: Migration Wave Resource
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WaveArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WaveArgs.__new__(WaveArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20250330preview:Wave"), pulumi.Alias(type_="azure-native:migrate/v20251201preview:Wave"), pulumi.Alias(type_="azure-native:migrate/v20260201preview:Wave")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Wave':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return Wave(resource_name, opts=opts, __props__=__props__)
