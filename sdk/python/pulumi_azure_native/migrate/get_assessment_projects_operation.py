...
def get_assessment_projects_operation(project_name: Optional[_builtins.str] = None,
...
def get_assessment_projects_operation_output(project_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
