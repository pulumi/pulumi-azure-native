...
def get_import_collector(import_collector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str import_collector_name: Unique name of a Import collector within a project.
...
def get_import_collector_output(import_collector_name: Optional[pulumi.Input[builtins.str]] = None,
