...
def get_import_collector(import_collector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str import_collector_name: Unique name of a Import collector within a project.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getImportCollector', __args__, opts=opts, typ=GetImportCollectorResult).value
...
def get_import_collector_output(import_collector_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getImportCollector', __args__, opts=opts, typ=GetImportCollectorResult)
