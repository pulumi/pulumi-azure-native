...
def get_server_collectors_operation(project_name: Optional[builtins.str] = None,
                                    resource_group_name: Optional[builtins.str] = None,
                                    server_collector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str server_collector_name: Physical server collector ARM name
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getServerCollectorsOperation', __args__, opts=opts, typ=GetServerCollectorsOperationResult).value
...
def get_server_collectors_operation_output(project_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getServerCollectorsOperation', __args__, opts=opts, typ=GetServerCollectorsOperationResult)
