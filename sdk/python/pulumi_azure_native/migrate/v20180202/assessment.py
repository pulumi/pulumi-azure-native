...
class Assessment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        assessment = azure_native.migrate.v20180202.Assessment("assessment",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20171111preview:Assessment")])
