...
def get_hyper_v_collector(hyper_v_collector_name: Optional[_builtins.str] = None,
...
def get_hyper_v_collector_output(hyper_v_collector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
