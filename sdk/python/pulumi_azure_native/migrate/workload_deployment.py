...
class WorkloadDeploymentArgs:
    def __init__(__self__, *,
        ...
        """
        WorkloadDeploymentArgs._configure(
    ...
    def _configure(
        ...
        if 'workloadDeploymentName' in kwargs:
            workload_deployment_name = kwargs['workloadDeploymentName']
        ...
        if workload_deployment_name is not None:
            _setter("workload_deployment_name", workload_deployment_name)
...
class WorkloadDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WorkloadDeploymentArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, WorkloadDeploymentModelPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                WorkloadDeploymentModelPropertiesArgs._configure(_setter, **properties)
