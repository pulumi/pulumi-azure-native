...
class WorkloadDeploymentArgs:
    ...
    def _configure(
        ...
        if workload_deployment_name is None and 'workloadDeploymentName' in kwargs:
...
class WorkloadDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, WorkloadDeploymentModelPropertiesArgs, True)
