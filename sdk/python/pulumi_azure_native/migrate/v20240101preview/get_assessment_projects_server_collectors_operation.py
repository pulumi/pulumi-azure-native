...
def get_assessment_projects_server_collectors_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20240101preview:getAssessmentProjectsServerCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsServerCollectorsOperationResult).value
...
def get_assessment_projects_server_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20240101preview:getAssessmentProjectsServerCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsServerCollectorsOperationResult)
