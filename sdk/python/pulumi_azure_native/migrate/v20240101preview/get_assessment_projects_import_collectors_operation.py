...
def get_assessment_projects_import_collectors_operation(import_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20240101preview:getAssessmentProjectsImportCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsImportCollectorsOperationResult).value
...
def get_assessment_projects_import_collectors_operation_output(import_collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20240101preview:getAssessmentProjectsImportCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsImportCollectorsOperationResult)
