...
__all__ = ['AssessmentProjectsWebAppCollectorOperationArgs', 'AssessmentProjectsWebAppCollectorOperation']

@pulumi.input_type
class AssessmentProjectsWebAppCollectorOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] collector_name: Web app collector ARM name.
    ...
    def collector_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def collector_name(self, value: Optional[pulumi.Input[str]]):
...
class AssessmentProjectsWebAppCollectorOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsWebAppCollectorOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The web app collector REST object.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsWebAppCollectorOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsWebAppCollectorOperationArgs.__new__(AssessmentProjectsWebAppCollectorOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate:WebAppCollectorOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsWebAppCollectorOperation, __self__).__init__(
            'azure-native:migrate/v20240101preview:AssessmentProjectsWebAppCollectorOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsWebAppCollectorOperation':
        """
        Get an existing AssessmentProjectsWebAppCollectorOperation resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsWebAppCollectorOperation(resource_name, opts=opts, __props__=__props__)
