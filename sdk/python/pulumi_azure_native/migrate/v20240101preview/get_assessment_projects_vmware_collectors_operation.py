...
def get_assessment_projects_vmware_collectors_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20240101preview:getAssessmentProjectsVmwareCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsVmwareCollectorsOperationResult).value
...
def get_assessment_projects_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20240101preview:getAssessmentProjectsVmwareCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsVmwareCollectorsOperationResult)
