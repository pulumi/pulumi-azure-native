...
def get_business_case_operation_report_download_url(business_case_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20240101preview:getBusinessCaseOperationReportDownloadUrl', __args__, opts=opts, typ=GetBusinessCaseOperationReportDownloadUrlResult).value
...
def get_business_case_operation_report_download_url_output(business_case_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20240101preview:getBusinessCaseOperationReportDownloadUrl', __args__, opts=opts, typ=GetBusinessCaseOperationReportDownloadUrlResult)
