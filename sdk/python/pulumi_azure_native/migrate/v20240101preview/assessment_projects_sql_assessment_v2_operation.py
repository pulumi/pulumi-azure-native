...
__all__ = ['AssessmentProjectsSqlAssessmentV2OperationArgs', 'AssessmentProjectsSqlAssessmentV2Operation']

@pulumi.input_type
class AssessmentProjectsSqlAssessmentV2OperationArgs:
...
class AssessmentProjectsSqlAssessmentV2Operation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsSqlAssessmentV2OperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        SQL Assessment REST resource.

        :param str resource_name: The name of the resource.
        :param AssessmentProjectsSqlAssessmentV2OperationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsSqlAssessmentV2OperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsSqlAssessmentV2OperationArgs.__new__(AssessmentProjectsSqlAssessmentV2OperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsSqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230315:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsSqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:AssessmentProjectsSqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsSqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:SqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsSqlAssessmentV2Operation"), pulumi.Alias(type_="azure-native:migrate:SqlAssessmentV2Operation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsSqlAssessmentV2Operation, __self__).__init__(
            'azure-native:migrate/v20240101preview:AssessmentProjectsSqlAssessmentV2Operation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsSqlAssessmentV2Operation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsSqlAssessmentV2Operation(resource_name, opts=opts, __props__=__props__)
