...
def get_vmware_collectors_operation(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20240101preview:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult).value
...
def get_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20240101preview:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult)
