...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20180901preview:Solution"), pulumi.Alias(type_="azure-native:migrate:Solution"), pulumi.Alias(type_="azure-nextgen:migrate:Solution")])
