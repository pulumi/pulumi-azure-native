...
class WorkloadInstanceArgs:
    ...
    def _configure(
        ...
        if workload_instance_name is None and 'workloadInstanceName' in kwargs:
            workload_instance_name = kwargs['workloadInstanceName']
    ...
    def workload_instance_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def workload_instance_name(self, value: Optional[pulumi.Input[str]]):
...
class WorkloadInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 opts: Optional[pulumi.ResourceOptions] = None,
                 modernize_project_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['WorkloadInstanceModelPropertiesArgs']]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 subscription_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 workload_instance_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] modernize_project_name: ModernizeProject name.
        :param pulumi.Input[pulumi.InputType['WorkloadInstanceModelPropertiesArgs']] properties: Workload instance model properties.
        :param pulumi.Input[str] resource_group_name: Name of the Azure Resource Group that project is part of.
        :param pulumi.Input[str] subscription_id: Azure Subscription Id in which project was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Gets or sets the resource tags.
        :param pulumi.Input[str] workload_instance_name: Workload instance name.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, WorkloadInstanceModelPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:WorkloadInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadInstance, __self__).__init__(
            'azure-native:migrate/v20220501preview:WorkloadInstance',
            resource_name,
            __props__,
            opts)
