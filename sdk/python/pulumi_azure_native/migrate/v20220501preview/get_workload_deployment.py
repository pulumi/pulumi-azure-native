...
def get_workload_deployment(modernize_project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20220501preview:getWorkloadDeployment', __args__, opts=opts, typ=GetWorkloadDeploymentResult).value
...
def get_workload_deployment_output(modernize_project_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workloadDeploymentName'] = workload_deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20220501preview:getWorkloadDeployment', __args__, opts=opts, typ=GetWorkloadDeploymentResult)
    return __ret__.apply(lambda __response__: GetWorkloadDeploymentResult(
