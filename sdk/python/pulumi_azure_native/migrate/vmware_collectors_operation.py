...
class VmwareCollectorsOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vm_ware_collector_name: VMware collector ARM name
        """
    ...
    def vm_ware_collector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vm_ware_collector_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VmwareCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20191001:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240115:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240303preview:VmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:VMwareCollector")])
