...
def get_assessment_projects_avs_assessments_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getAssessmentProjectsAvsAssessmentsOperation', __args__, opts=opts, typ=GetAssessmentProjectsAvsAssessmentsOperationResult).value
...
def get_assessment_projects_avs_assessments_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate:getAssessmentProjectsAvsAssessmentsOperation', __args__, opts=opts, typ=GetAssessmentProjectsAvsAssessmentsOperationResult)
