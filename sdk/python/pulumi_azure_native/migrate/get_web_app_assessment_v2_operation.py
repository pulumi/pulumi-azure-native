...
def get_web_app_assessment_v2_operation(assessment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str assessment_name: Web app Assessment arm name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getWebAppAssessmentV2Operation', __args__, opts=opts, typ=GetWebAppAssessmentV2OperationResult).value
...
def get_web_app_assessment_v2_operation_output(assessment_name: Optional[pulumi.Input[builtins.str]] = None,
