...
def get_move_resource(move_collection_name: Optional[_builtins.str] = None,
                      move_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str move_resource_name: The Move Resource Name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate:getMoveResource', __args__, opts=opts, typ=GetMoveResourceResult).value
...
def get_move_resource_output(move_collection_name: Optional[pulumi.Input[_builtins.str]] = None,
