...
def get_move_resource(move_collection_name: Optional[builtins.str] = None,
                      move_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str move_resource_name: The Move Resource Name.
...
def get_move_resource_output(move_collection_name: Optional[pulumi.Input[builtins.str]] = None,
