...
class AvsAssessmentsV2OperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AvsAssessmentPropertiesV2Args'] properties: The resource-specific properties for this resource.
        """
...
class AvsAssessmentsV2Operation(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:migrate:AvsAssessmentsV2Operation"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] assessment_name: AVS Assessment ARM name
        :param pulumi.Input[builtins.str] project_name: Assessment Project Name
        :param pulumi.Input[Union['AvsAssessmentPropertiesV2Args', 'AvsAssessmentPropertiesV2ArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AvsAssessmentsV2OperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AvsAssessmentsV2OperationArgs.__new__(AvsAssessmentsV2OperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20240303preview:AvsAssessmentsV2Operation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AvsAssessmentsV2Operation, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AvsAssessmentsV2Operation':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return AvsAssessmentsV2Operation(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AvsAssessmentPropertiesV2Response']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
