...
def get_workload_deployment(modernize_project_name: Optional[builtins.str] = None,
...
def get_workload_deployment_output(modernize_project_name: Optional[pulumi.Input[builtins.str]] = None,
