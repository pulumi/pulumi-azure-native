...
class WebAppCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20230401preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:WebAppCollectorOperation"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:WebAppCollectorOperation")])
