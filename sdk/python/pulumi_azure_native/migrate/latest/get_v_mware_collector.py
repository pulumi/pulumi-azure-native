...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getVMwareCollector'.""", DeprecationWarning)
...
def get_v_mware_collector(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getVMwareCollector', __args__, opts=opts, typ=GetVMwareCollectorResult).value
