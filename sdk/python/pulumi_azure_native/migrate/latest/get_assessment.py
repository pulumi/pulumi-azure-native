...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getAssessment'.""", DeprecationWarning)
...
def get_assessment(assessment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_assessment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getAssessment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getAssessment', __args__, opts=opts, typ=GetAssessmentResult).value
