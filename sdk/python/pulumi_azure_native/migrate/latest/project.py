...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:Project"), pulumi.Alias(type_="azure-nextgen:migrate:Project"), pulumi.Alias(type_="azure-native:migrate/v20191001:Project"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:Project")])
