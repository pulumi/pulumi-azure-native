...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getMoveCollection'.""", DeprecationWarning)
...
def get_move_collection(move_collection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_move_collection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getMoveCollection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getMoveCollection', __args__, opts=opts, typ=GetMoveCollectionResult).value
