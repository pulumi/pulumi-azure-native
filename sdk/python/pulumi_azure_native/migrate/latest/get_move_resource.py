...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getMoveResource'.""", DeprecationWarning)
...
def get_move_resource(move_collection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getMoveResource', __args__, opts=opts, typ=GetMoveResourceResult).value
