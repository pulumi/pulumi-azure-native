...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:migrate:VMwareCollector'.""", DeprecationWarning)
...
class VMwareCollector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""VMwareCollector is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:migrate:VMwareCollector'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/latest:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate:VMwareCollector"), pulumi.Alias(type_="azure-nextgen:migrate:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/v20191001:VMwareCollector"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:VMwareCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VMwareCollector, __self__).__init__(
            'azure-native:migrate/latest:VMwareCollector',
            resource_name,
            __props__,
            opts)
