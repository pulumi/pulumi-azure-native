...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getHyperVCollector'.""", DeprecationWarning)
...
def get_hyper_v_collector(hyper_v_collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getHyperVCollector', __args__, opts=opts, typ=GetHyperVCollectorResult).value
