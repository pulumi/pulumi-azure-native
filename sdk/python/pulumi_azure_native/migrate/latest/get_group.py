...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getGroup'.""", DeprecationWarning)
...
def get_group(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getGroup', __args__, opts=opts, typ=GetGroupResult).value
