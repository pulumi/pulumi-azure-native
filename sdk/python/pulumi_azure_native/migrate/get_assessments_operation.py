...
def get_assessments_operation(assessment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str assessment_name: Machine Assessment ARM name
...
def get_assessments_operation_output(assessment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
