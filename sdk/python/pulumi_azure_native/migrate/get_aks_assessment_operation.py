...
def get_aks_assessment_operation(assessment_name: Optional[_builtins.str] = None,
...
def get_aks_assessment_operation_output(assessment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
