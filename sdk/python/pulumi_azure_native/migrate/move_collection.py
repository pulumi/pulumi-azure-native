...
class MoveCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20220801:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20230801:MoveCollection"), pulumi.Alias(type_="azure-native_migrate_v20191001preview:migrate:MoveCollection"), pulumi.Alias(type_="azure-native_migrate_v20210101:migrate:MoveCollection"), pulumi.Alias(type_="azure-native_migrate_v20210801:migrate:MoveCollection"), pulumi.Alias(type_="azure-native_migrate_v20220801:migrate:MoveCollection"), pulumi.Alias(type_="azure-native_migrate_v20230801:migrate:MoveCollection")])
