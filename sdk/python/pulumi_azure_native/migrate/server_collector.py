...
class ServerCollectorArgs:
    def __init__(__self__, *,
        ...
        """
        ServerCollectorArgs._configure(
...
class ServerCollector(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServerCollectorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, CollectorPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:ServerCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:ServerCollector")])
