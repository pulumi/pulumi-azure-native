...
class HypervCollectorsOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20230315:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230501preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate:HyperVCollector"), pulumi.Alias(type_="azure-native_migrate_v20191001:migrate:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230315:migrate:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230401preview:migrate:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230501preview:migrate:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20230909preview:migrate:HypervCollectorsOperation"), pulumi.Alias(type_="azure-native_migrate_v20240101preview:migrate:HypervCollectorsOperation")])
