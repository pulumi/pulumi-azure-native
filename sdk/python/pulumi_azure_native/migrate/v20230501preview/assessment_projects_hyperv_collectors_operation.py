...
__all__ = ['AssessmentProjectsHypervCollectorsOperationArgs', 'AssessmentProjectsHypervCollectorsOperation']

@pulumi.input_type
class AssessmentProjectsHypervCollectorsOperationArgs:
...
class AssessmentProjectsHypervCollectorsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsHypervCollectorsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Hyper-V collector resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsHypervCollectorsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsHypervCollectorsOperationArgs.__new__(AssessmentProjectsHypervCollectorsOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsHypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsHypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsHypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsHypervCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsHypervCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsHypervCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230501preview:AssessmentProjectsHypervCollectorsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsHypervCollectorsOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsHypervCollectorsOperation(resource_name, opts=opts, __props__=__props__)
