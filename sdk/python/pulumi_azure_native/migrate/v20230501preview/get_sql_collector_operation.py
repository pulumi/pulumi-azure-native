...
def get_sql_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getSqlCollectorOperation', __args__, opts=opts, typ=GetSqlCollectorOperationResult).value
