...
class SqlCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:SqlCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:SqlCollectorOperation")])
