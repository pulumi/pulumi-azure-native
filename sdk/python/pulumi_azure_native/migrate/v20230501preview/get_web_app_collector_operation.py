...
def get_web_app_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getWebAppCollectorOperation', __args__, opts=opts, typ=GetWebAppCollectorOperationResult).value
...
def get_web_app_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getWebAppCollectorOperation', __args__, opts=opts, typ=GetWebAppCollectorOperationResult)
