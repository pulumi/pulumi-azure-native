...
__all__ = [
    'GetAssessmentProjectsWebAppCollectorOperationResult',
    'AwaitableGetAssessmentProjectsWebAppCollectorOperationResult',
    'get_assessment_projects_web_app_collector_operation',
    'get_assessment_projects_web_app_collector_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsWebAppCollectorOperationResult:
    """
...
class AwaitableGetAssessmentProjectsWebAppCollectorOperationResult(GetAssessmentProjectsWebAppCollectorOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsWebAppCollectorOperationResult(
...
def get_assessment_projects_web_app_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getAssessmentProjectsWebAppCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppCollectorOperationResult).value

    return AwaitableGetAssessmentProjectsWebAppCollectorOperationResult(
...
def get_assessment_projects_web_app_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getAssessmentProjectsWebAppCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppCollectorOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsWebAppCollectorOperationResult(
