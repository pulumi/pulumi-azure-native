...
__all__ = ['PrivateEndpointConnectionOperationArgs', 'PrivateEndpointConnectionOperation']
...
class PrivateEndpointConnectionOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] private_endpoint_connection_name: Private endpoint connection ARM name
        """
...
class PrivateEndpointConnectionOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrivateEndpointConnectionOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PrivateEndpointConnectionOperationArgs.__new__(PrivateEndpointConnectionOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate/v20191001:PrivateEndpointConnectionOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:PrivateEndpointConnectionOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:PrivateEndpointConnectionOperation"), pulumi.Alias(type_="azure-native:migrate/v20240101preview:PrivateEndpointConnectionOperation"), pulumi.Alias(type_="azure-native:migrate:PrivateEndpointConnectionOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionOperation, __self__).__init__(
            'azure-native:migrate/v20230501preview:PrivateEndpointConnectionOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PrivateEndpointConnectionOperation':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return PrivateEndpointConnectionOperation(resource_name, opts=opts, __props__=__props__)
