...
class AwaitableGetVmwareCollectorsOperationResult(GetVmwareCollectorsOperationResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetVmwareCollectorsOperationResult(
...
def get_vmware_collectors_operation(project_name: Optional[str] = None,
                                    resource_group_name: Optional[str] = None,
                                    vm_ware_collector_name: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVmwareCollectorsOperationResult:
    """
    ...
    :param str vm_ware_collector_name: VMware collector ARM name
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult).value

    return AwaitableGetVmwareCollectorsOperationResult(
...
def get_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVmwareCollectorsOperationResult]:
    """
    Get a VmwareCollector
    ...
    __args__['vmWareCollectorName'] = vm_ware_collector_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getVmwareCollectorsOperation', __args__, opts=opts, typ=GetVmwareCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetVmwareCollectorsOperationResult(
