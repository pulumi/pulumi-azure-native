...
__all__ = ['AssessmentProjectsVmwareCollectorsOperationArgs', 'AssessmentProjectsVmwareCollectorsOperation']

@pulumi.input_type
class AssessmentProjectsVmwareCollectorsOperationArgs:
...
class AssessmentProjectsVmwareCollectorsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AssessmentProjectsVmwareCollectorsOperationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        VMware collector resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AssessmentProjectsVmwareCollectorsOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AssessmentProjectsVmwareCollectorsOperationArgs.__new__(AssessmentProjectsVmwareCollectorsOperationArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20191001:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230315:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsVmwareCollectorsOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsVmwareCollectorsOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsVmwareCollectorsOperation, __self__).__init__(
            'azure-native:migrate/v20230501preview:AssessmentProjectsVmwareCollectorsOperation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AssessmentProjectsVmwareCollectorsOperation':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["updated_timestamp"] = None
        return AssessmentProjectsVmwareCollectorsOperation(resource_name, opts=opts, __props__=__props__)
