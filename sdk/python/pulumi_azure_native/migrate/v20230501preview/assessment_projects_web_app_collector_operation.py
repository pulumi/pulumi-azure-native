...
class AssessmentProjectsWebAppCollectorOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsWebAppCollectorOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsWebAppCollectorOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsWebAppCollectorOperation, __self__).__init__(
            'azure-native:migrate/v20230501preview:AssessmentProjectsWebAppCollectorOperation',
            resource_name,
            __props__,
            opts)
