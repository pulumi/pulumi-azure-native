...
__all__ = [
    'GetAssessmentProjectsVmwareCollectorsOperationResult',
    'AwaitableGetAssessmentProjectsVmwareCollectorsOperationResult',
    'get_assessment_projects_vmware_collectors_operation',
    'get_assessment_projects_vmware_collectors_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsVmwareCollectorsOperationResult:
    """
...
class AwaitableGetAssessmentProjectsVmwareCollectorsOperationResult(GetAssessmentProjectsVmwareCollectorsOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsVmwareCollectorsOperationResult(
...
def get_assessment_projects_vmware_collectors_operation(project_name: Optional[str] = None,
                                                        resource_group_name: Optional[str] = None,
                                                        vm_ware_collector_name: Optional[str] = None,
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAssessmentProjectsVmwareCollectorsOperationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getAssessmentProjectsVmwareCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsVmwareCollectorsOperationResult).value

    return AwaitableGetAssessmentProjectsVmwareCollectorsOperationResult(
...
def get_assessment_projects_vmware_collectors_operation_output(project_name: Optional[pulumi.Input[str]] = None,
                                                               resource_group_name: Optional[pulumi.Input[str]] = None,
                                                               vm_ware_collector_name: Optional[pulumi.Input[str]] = None,
                                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAssessmentProjectsVmwareCollectorsOperationResult]:
    """
    Get a VmwareCollector
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getAssessmentProjectsVmwareCollectorsOperation', __args__, opts=opts, typ=GetAssessmentProjectsVmwareCollectorsOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsVmwareCollectorsOperationResult(
