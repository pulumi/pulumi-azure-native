...
class AssessmentProjectsAksAssessmentOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:migrate:AssessmentProjectsAksAssessmentOperation"), pulumi.Alias(type_="azure-native:migrate/v20230401preview:AssessmentProjectsAksAssessmentOperation"), pulumi.Alias(type_="azure-native:migrate/v20230909preview:AssessmentProjectsAksAssessmentOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssessmentProjectsAksAssessmentOperation, __self__).__init__(
            'azure-native:migrate/v20230501preview:AssessmentProjectsAksAssessmentOperation',
            resource_name,
            __props__,
            opts)
