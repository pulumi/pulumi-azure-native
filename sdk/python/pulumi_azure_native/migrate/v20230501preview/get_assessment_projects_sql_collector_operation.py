...
__all__ = [
    'GetAssessmentProjectsSqlCollectorOperationResult',
    'AwaitableGetAssessmentProjectsSqlCollectorOperationResult',
    'get_assessment_projects_sql_collector_operation',
    'get_assessment_projects_sql_collector_operation_output',
]

@pulumi.output_type
class GetAssessmentProjectsSqlCollectorOperationResult:
    """
...
class AwaitableGetAssessmentProjectsSqlCollectorOperationResult(GetAssessmentProjectsSqlCollectorOperationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAssessmentProjectsSqlCollectorOperationResult(
...
def get_assessment_projects_sql_collector_operation(collector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getAssessmentProjectsSqlCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsSqlCollectorOperationResult).value

    return AwaitableGetAssessmentProjectsSqlCollectorOperationResult(
...
def get_assessment_projects_sql_collector_operation_output(collector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getAssessmentProjectsSqlCollectorOperation', __args__, opts=opts, typ=GetAssessmentProjectsSqlCollectorOperationResult)
    return __ret__.apply(lambda __response__: GetAssessmentProjectsSqlCollectorOperationResult(
