...
def get_web_app_assessment_v2_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getWebAppAssessmentV2Operation', __args__, opts=opts, typ=GetWebAppAssessmentV2OperationResult).value
...
def get_web_app_assessment_v2_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getWebAppAssessmentV2Operation', __args__, opts=opts, typ=GetWebAppAssessmentV2OperationResult)
