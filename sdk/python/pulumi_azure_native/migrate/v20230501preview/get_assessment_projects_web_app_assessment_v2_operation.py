...
def get_assessment_projects_web_app_assessment_v2_operation(assessment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getAssessmentProjectsWebAppAssessmentV2Operation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppAssessmentV2OperationResult).value
...
def get_assessment_projects_web_app_assessment_v2_operation_output(assessment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getAssessmentProjectsWebAppAssessmentV2Operation', __args__, opts=opts, typ=GetAssessmentProjectsWebAppAssessmentV2OperationResult)
