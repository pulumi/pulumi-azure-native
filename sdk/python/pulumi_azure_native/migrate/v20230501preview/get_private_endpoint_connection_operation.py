...
__all__ = [
    ...
    'AwaitableGetPrivateEndpointConnectionOperationResult',
    'get_private_endpoint_connection_operation',
    'get_private_endpoint_connection_operation_output',
]

@pulumi.output_type
class GetPrivateEndpointConnectionOperationResult:
    """
...
class AwaitableGetPrivateEndpointConnectionOperationResult(GetPrivateEndpointConnectionOperationResult):
...
def get_private_endpoint_connection_operation(private_endpoint_connection_name: Optional[str] = None,
                                              project_name: Optional[str] = None,
                                              resource_group_name: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPrivateEndpointConnectionOperationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/v20230501preview:getPrivateEndpointConnectionOperation', __args__, opts=opts, typ=GetPrivateEndpointConnectionOperationResult).value
...
def get_private_endpoint_connection_operation_output(private_endpoint_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:migrate/v20230501preview:getPrivateEndpointConnectionOperation', __args__, opts=opts, typ=GetPrivateEndpointConnectionOperationResult)
