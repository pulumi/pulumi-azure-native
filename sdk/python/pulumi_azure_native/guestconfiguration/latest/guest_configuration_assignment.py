...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:guestconfiguration:GuestConfigurationAssignment'.""", DeprecationWarning)
...
class GuestConfigurationAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""GuestConfigurationAssignment is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:guestconfiguration:GuestConfigurationAssignment'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:guestconfiguration/latest:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-native:guestconfiguration:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-nextgen:guestconfiguration:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-native:guestconfiguration/v20180630preview:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-nextgen:guestconfiguration/v20180630preview:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-nextgen:guestconfiguration/v20181120:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-native:guestconfiguration/v20200625:GuestConfigurationAssignment"), pulumi.Alias(type_="azure-nextgen:guestconfiguration/v20200625:GuestConfigurationAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GuestConfigurationAssignment, __self__).__init__(
            'azure-native:guestconfiguration/latest:GuestConfigurationAssignment',
            resource_name,
            __props__,
            opts)
