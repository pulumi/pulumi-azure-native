...
def get_guest_configuration_assignment(guest_configuration_assignment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str guest_configuration_assignment_name: The guest configuration assignment name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:guestconfiguration:getGuestConfigurationAssignment', __args__, opts=opts, typ=GetGuestConfigurationAssignmentResult).value
...
def get_guest_configuration_assignment_output(guest_configuration_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:guestconfiguration:getGuestConfigurationAssignment', __args__, opts=opts, typ=GetGuestConfigurationAssignmentResult)
