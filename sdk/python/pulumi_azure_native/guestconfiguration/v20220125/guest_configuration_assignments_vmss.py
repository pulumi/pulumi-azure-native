...
class GuestConfigurationAssignmentsVMSS(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:guestconfiguration/v20240405:GuestConfigurationAssignmentsVMSS"), pulumi.Alias(type_="azure-native:guestconfiguration:GuestConfigurationAssignmentsVMSS")])
