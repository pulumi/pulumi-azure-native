...
class GuestConfigurationAssignmentsVMSSArgs:
    def __init__(__self__, *,
        ...
        """
        GuestConfigurationAssignmentsVMSSArgs._configure(
    ...
    def _configure(
        ...
        if vmss_name is None and 'vmssName' in kwargs:
            vmss_name = kwargs['vmssName']
        if vmss_name is None:
            raise TypeError("Missing 'vmss_name' argument")

        _setter("resource_group_name", resource_group_name)
        _setter("vmss_name", vmss_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            GuestConfigurationAssignmentsVMSSArgs._configure(_setter, **kwargs)
