...
def get_guest_configuration_hcrpassignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_configuration_hcrpassignment is deprecated: Version v20181120 will be removed in the next major version of the provider. Upgrade to version v20200625 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:guestconfiguration/v20181120:getGuestConfigurationHCRPAssignment', __args__, opts=opts, typ=GetGuestConfigurationHCRPAssignmentResult).value
