...
class GuestConfigurationConnectedVMwarevSphereAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        guest_configuration_connected_v_mwarev_sphere_assignment = azure_native.guestconfiguration.v20200625.GuestConfigurationConnectedVMwarevSphereAssignment("guestConfigurationConnectedVMwarevSphereAssignment",
