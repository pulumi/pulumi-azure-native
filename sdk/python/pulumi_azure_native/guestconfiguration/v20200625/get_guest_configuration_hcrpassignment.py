...
warnings.warn("""Version v20200625 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.""", DeprecationWarning)
...
def get_guest_configuration_hcrpassignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_configuration_hcrpassignment is deprecated: Version v20200625 will be removed in the next major version of the provider. Upgrade to version v20220125 or later.""")
    __args__ = dict()
