...
warnings.warn("""Version 2020-06-25 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_guest_configuration_hcrpassignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_configuration_hcrpassignment is deprecated: Version 2020-06-25 will be removed in v2 of the provider.""")
    __args__ = dict()
