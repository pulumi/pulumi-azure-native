...
def get_guest_configuration_connected_v_mwarev_sphere_assignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:guestconfiguration/v20200625:getGuestConfigurationConnectedVMwarevSphereAssignment', __args__, opts=opts, typ=GetGuestConfigurationConnectedVMwarevSphereAssignmentResult).value
...
def get_guest_configuration_connected_v_mwarev_sphere_assignment_output(guest_configuration_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:guestconfiguration/v20200625:getGuestConfigurationConnectedVMwarevSphereAssignment', __args__, opts=opts, typ=GetGuestConfigurationConnectedVMwarevSphereAssignmentResult)
