...
def get_guest_configuration_assignments_vmss(name: Optional[builtins.str] = None,
...
def get_guest_configuration_assignments_vmss_output(name: Optional[pulumi.Input[builtins.str]] = None,
