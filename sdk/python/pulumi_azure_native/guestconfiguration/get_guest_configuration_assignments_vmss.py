...
def get_guest_configuration_assignments_vmss(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The guest configuration assignment name.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str vmss_name: The name of the virtual machine scale set.
    """
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:guestconfiguration:getGuestConfigurationAssignmentsVMSS', __args__, opts=opts, typ=GetGuestConfigurationAssignmentsVMSSResult).value
...
def get_guest_configuration_assignments_vmss_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:guestconfiguration:getGuestConfigurationAssignmentsVMSS', __args__, opts=opts, typ=GetGuestConfigurationAssignmentsVMSSResult)
