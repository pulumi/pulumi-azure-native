...
def get_guest_configuration_assignment(guest_configuration_assignment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_guest_configuration_assignment is deprecated: Version v20180630preview will be removed in the next major version of the provider. Upgrade to version v20200625 or later.""")
    __args__ = dict()
