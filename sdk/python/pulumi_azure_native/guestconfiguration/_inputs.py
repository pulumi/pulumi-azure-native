...
class ConfigurationParameterArgs:
    def __init__(__self__, *,
        ...
        """
        Represents a configuration parameter.
        :param pulumi.Input[builtins.str] name: Name of the configuration parameter.
        :param pulumi.Input[builtins.str] value: Value of the configuration parameter.
        """
        if name is not None:
...
class GuestConfigurationAssignmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Guest configuration assignment properties.
        :param pulumi.Input[builtins.str] context: The source which initiated the guest configuration assignment. Ex: Azure Policy
...
if not MYPY:
    class GuestConfigurationNavigationArgsDict(TypedDict):
        ...
        """
        assignment_type: NotRequired[pulumi.Input[Union[builtins.str, 'AssignmentType']]]
        """
        ...
        """
        content_managed_identity: NotRequired[pulumi.Input[builtins.str]]
        """
        Managed identity with storage access of the guest configuration package and configuration parameters.
        """
        content_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GuestConfigurationNavigationArgs:
    def __init__(__self__, *,
                 assignment_type: Optional[pulumi.Input[Union[builtins.str, 'AssignmentType']]] = None,
                 ...
                 content_managed_identity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        Guest configuration is an artifact that encapsulates DSC configuration and its dependencies. The artifact is a zip file containing DSC configuration (as MOF) and dependent resources and other dependencies like modules.
        :param pulumi.Input[Union[builtins.str, 'AssignmentType']] assignment_type: Specifies the assignment type and execution of the configuration. Possible values are Audit, DeployAndAutoCorrect, ApplyAndAutoCorrect and ApplyAndMonitor.
        ...
        :param pulumi.Input[builtins.str] content_hash: Combined hash of the guest configuration package and configuration parameters.
        :param pulumi.Input[builtins.str] content_managed_identity: Managed identity with storage access of the guest configuration package and configuration parameters.
        :param pulumi.Input[builtins.str] content_uri: Uri of the storage where guest configuration package is uploaded.
        :param pulumi.Input[Union[builtins.str, 'Kind']] kind: Kind of the guest configuration. For example:DSC
        :param pulumi.Input[builtins.str] name: Name of the guest configuration.
        :param pulumi.Input[builtins.str] version: Version of the guest configuration.
        """
    ...
    def assignment_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'AssignmentType']]]:
        """
        Specifies the assignment type and execution of the configuration. Possible values are Audit, DeployAndAutoCorrect, ApplyAndAutoCorrect and ApplyAndMonitor.
        """
    ...
    def assignment_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'AssignmentType']]]):
    ...
    def content_managed_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Managed identity with storage access of the guest configuration package and configuration parameters.
        """
    ...
    def content_managed_identity(self, value: Optional[pulumi.Input[builtins.str]]):
