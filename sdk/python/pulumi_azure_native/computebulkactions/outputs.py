...
__all__ = [
    ...
    'LaunchBulkInstancesOperationPropertiesResponse',
    ...
    'NetworkInterfaceReferencePropertiesResponse',
...
class AllInstancesDownResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AllInstancesDownResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AllInstancesDownResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool automatically_approve: Specifies if Scheduled Events should be auto-approved when all instances are down. Its default value is true.
        """
...
class ApplicationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['VMGalleryApplicationResponse'] gallery_applications: Specifies the gallery applications that should be made available to the VM
        """
...
class CapacityReservationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SubResourceResponse' capacity_reservation_group: Specifies the capacity reservation group resource id that should be used for allocating the virtual machine provided enough capacity has been reserved. Please refer to https://aka.ms/CapacityReservation for more details.
        """
...
class ComputeProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 compute_api_version: Optional[_builtins.str] = None,
                 extensions: Optional[Sequence['outputs.VirtualMachineExtensionResponse']] = None):
        """
        Compute Profile to configure the Virtual Machines.

        :param 'VirtualMachineProfileResponse' virtual_machine_profile: Base Virtual Machine Profile Properties to be specified according to "specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/{computeApiVersion}/virtualMachine.json#/definitions/VirtualMachineProperties"
        :param _builtins.str compute_api_version: Specifies the Microsoft.Compute API version to use when creating underlying Virtual Machines.
               The default value will be the latest supported computeApiVersion by LaunchBulkInstancesOperation.
        :param Sequence['VirtualMachineExtensionResponse'] extensions: Virtual Machine Extensions Array to be specified according to "specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/{computeApiVersion}/virtualMachine.json#/definitions/VirtualMachineExtension"
        """
...
class DataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str create_option: Specifies how the virtual machine disk should be created. Possible values are Attach, FromImage, Empty, Copy, Restore.
        ...
        :param _builtins.str delete_option: Specifies whether data disk should be deleted or detached upon VM deletion. Possible values are: Delete, Detach. The default value is set to Detach.
...
class DiskEncryptionSetParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str id: The ID of the sub-resource.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class EventGridAndResourceGraphResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "scheduledEventsApiVersion":
            suggest = "scheduled_events_api_version"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EventGridAndResourceGraphResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EventGridAndResourceGraphResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 scheduled_events_api_version: Optional[_builtins.str] = None):
        """
        Specifies eventGridAndResourceGraph related Scheduled Event related configurations.
        ...
        :param _builtins.str scheduled_events_api_version: Specifies the api-version to determine which Scheduled Events configuration schema version will be delivered.
        """
...
class LaunchBulkInstancesOperationPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "computeProfile":
            suggest = "compute_profile"
        elif key == "priorityProfile":
            suggest = "priority_profile"
        ...
        elif key == "vmAttributes":
            suggest = "vm_attributes"
        elif key == "vmSizesProfile":
            suggest = "vm_sizes_profile"
        elif key == "zoneAllocationPolicy":
            suggest = "zone_allocation_policy"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LaunchBulkInstancesOperationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LaunchBulkInstancesOperationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 compute_profile: 'outputs.ComputeProfileResponse',
                 priority_profile: 'outputs.PriorityProfileResponse',
                 provisioning_state: _builtins.str,
                 capacity_type: Optional[_builtins.str] = None,
                 retry_policy: Optional['outputs.RetryPolicyResponse'] = None,
                 vm_attributes: Optional['outputs.VMAttributesResponse'] = None,
                 vm_sizes_profile: Optional[Sequence['outputs.VmSizeProfileResponse']] = None,
                 zone_allocation_policy: Optional['outputs.ZoneAllocationPolicyResponse'] = None):
        """
        Details of the LaunchBulkInstancesOperation.

        :param _builtins.int capacity: Total capacity to achieve. It can be in terms of VMs or vCPUs.
        :param 'ComputeProfileResponse' compute_profile: Compute Profile to configure the Virtual Machines.
        :param 'PriorityProfileResponse' priority_profile: Configuration Options for Regular or Spot instances in LaunchBulkInstancesOperation.
        :param _builtins.str provisioning_state: The status of the last operation.
        :param _builtins.str capacity_type: Specifies capacity type for launching instances. It can be in terms of VMs or vCPUs.
        :param 'RetryPolicyResponse' retry_policy: Retry policy the user can pass
        :param 'VMAttributesResponse' vm_attributes: Attributes to launch instances.
        :param Sequence['VmSizeProfileResponse'] vm_sizes_profile: List of VM sizes supported for LaunchBulkInstancesOperation
        :param 'ZoneAllocationPolicyResponse' zone_allocation_policy: Zone Allocation Policy for launching instances.
        """
...
class NetworkInterfaceReferencePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in NetworkInterfaceReferencePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        NetworkInterfaceReferencePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
...
class NetworkInterfaceReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 id: Optional[_builtins.str] = None,
                 properties: Optional['outputs.NetworkInterfaceReferencePropertiesResponse'] = None):
        """
        Describes a network interface reference.

        :param _builtins.str id: The ID of the sub-resource.
        :param 'NetworkInterfaceReferencePropertiesResponse' properties: Describes a network interface reference properties.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class OSDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int disk_size_gb: Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. The property 'diskSizeGB' is the number of bytes x 1024^3 for the disk and the value cannot be larger than 1023.
        :param 'DiskEncryptionSettingsResponse' encryption_settings: Specifies the encryption settings for the OS Disk. Minimum compute api-version: 2015-06-15.
        :param 'VirtualHardDiskResponse' image: The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.
        :param 'ManagedDiskParametersResponse' managed_disk: The managed disk parameters.
        :param _builtins.str name: The disk name.
...
class PriorityProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in PriorityProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        PriorityProfileResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 max_price_per_vm: Optional[_builtins.float] = None,
                 type: Optional[_builtins.str] = None):
        """
        Contains properties that are applicable to both Spot and Regular.

        :param _builtins.str allocation_strategy: Allocation strategy to follow when determining the VM sizes distribution.
        :param _builtins.str eviction_policy: Eviction Policy to follow when evicting Spot VMs.
        :param _builtins.float max_price_per_vm: Price per hour of each Spot VM will never exceed this.
        :param _builtins.str type: Specifies the type of Virtual Machine.
        """
...
class ProxyAgentSettingsResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "addProxyAgentExtension":
            suggest = "add_proxy_agent_extension"
        elif key == "keyIncarnationId":
    ...
    def __init__(__self__, *,
                 add_proxy_agent_extension: Optional[_builtins.bool] = None,
                 enabled: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool add_proxy_agent_extension: Specify whether to implicitly install the ProxyAgent Extension. This option is currently applicable only for Linux Os.
...
class ScheduledEventsPolicyResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "allInstancesDown":
            suggest = "all_instances_down"
        elif key == "scheduledEventsAdditionalPublishingTargets":
    ...
    def __init__(__self__, *,
                 all_instances_down: Optional['outputs.AllInstancesDownResponse'] = None,
        ...
        :param 'AllInstancesDownResponse' all_instances_down: The configuration parameters used while creating AllInstancesDown scheduled event setting creation.
...
class SecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ProxyAgentSettingsResponse' proxy_agent_settings: Specifies ProxyAgent settings while creating the virtual machine. Minimum compute api-version: 2023-09-01.
        ...
        :param 'UefiSettingsResponse' uefi_settings: Specifies the security settings like secure boot and vTPM used while creating the virtual machine. Minimum compute api-version: 2020-12-01.
        """
...
class UefiSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool secure_boot_enabled: Specifies whether secure boot should be enabled on the virtual machine. Minimum compute api-version: 2020-12-01.
        :param _builtins.bool v_tpm_enabled: Specifies whether vTPM should be enabled on the virtual machine. Minimum compute api-version: 2020-12-01.
        """
...
class VMAttributeMinMaxDoubleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float max: Maximum value. Must be greater than zero. Double.MaxValue(1.7976931348623157E+308).
        :param _builtins.float min: Minimum value. If not specified, no minimum filter is applied.
        """
        if max is not None:
...
class VMAttributeMinMaxIntegerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int max: Max VMSize from CRS, Max = 4294967295 (uint.MaxValue) if not specified.
        :param _builtins.int min: Min VMSize from CRS, Min = 0 (uint.MinValue) if not specified.
        """
        if max is not None:
            pulumi.set(__self__, "max", max)
        if min is not None:
...
class VMAttributesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "allowedVMSizes":
            suggest = "allowed_vm_sizes"
        ...
        elif key == "hyperVGenerations":
            suggest = "hyper_v_generations"
    ...
    def __init__(__self__, *,
                 architecture_types: Sequence[_builtins.str],
                 ...
                 accelerator_support: Optional[_builtins.str] = None,
                 accelerator_types: Optional[Sequence[_builtins.str]] = None,
                 allowed_vm_sizes: Optional[Sequence[_builtins.str]] = None,
                 burstable_support: Optional[_builtins.str] = None,
                 ...
                 hyper_v_generations: Optional[Sequence[_builtins.str]] = None,
                 local_storage_disk_types: Optional[Sequence[_builtins.str]] = None,
                 local_storage_in_gi_b: Optional['outputs.VMAttributeMinMaxDoubleResponse'] = None,
                 local_storage_support: Optional[_builtins.str] = None,
                 ...
                 rdma_support: Optional[_builtins.str] = None,
                 vm_categories: Optional[Sequence[_builtins.str]] = None):
        """
        VMAttributes that will be used to filter VMSizes which will be used to launch instances.

        :param Sequence[_builtins.str] architecture_types: The VM architecture types specified as a list. Must be specified if VMAttributes are specified. Must be compatible with image used.
        ...
        :param Sequence[_builtins.str] cpu_manufacturers: The VM CPU manufacturers specified as a list. Optional parameter.
...
class VirtualMachineExtensionPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualMachineExtensionPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualMachineExtensionPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
...
class VirtualMachineExtensionResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 properties: 'outputs.VirtualMachineExtensionPropertiesResponse'):
        """
        Defines a virtual machine extension.

        :param _builtins.str name: The name of the virtual machine extension.
        :param 'VirtualMachineExtensionPropertiesResponse' properties: Properties of the virtual machine extension.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "properties", properties)
...
class VirtualMachineNetworkInterfaceConfigurationPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualMachineNetworkInterfaceConfigurationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualMachineNetworkInterfaceConfigurationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param 'SubResourceResponse' dscp_configuration: The DSCP configuration for the network interface.
...
class VirtualMachineNetworkInterfaceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 properties: Optional['outputs.VirtualMachineNetworkInterfaceConfigurationPropertiesResponse'] = None,
                 tags: Optional[Mapping[str, _builtins.str]] = None):
        """
        Describes a virtual machine network interface configurations.

        :param _builtins.str name: The network interface configuration name.
        :param 'VirtualMachineNetworkInterfaceConfigurationPropertiesResponse' properties: Describes a virtual machine network profile's IP configuration.
        :param Mapping[str, _builtins.str] tags: Resource tags applied to the networkInterface address created by this NetworkInterfaceConfiguration
        """
        pulumi.set(__self__, "name", name)
        if properties is not None:
            pulumi.set(__self__, "properties", properties)
...
class VirtualMachineNetworkInterfaceIPConfigurationPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualMachineNetworkInterfaceIPConfigurationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualMachineNetworkInterfaceIPConfigurationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
...
class VirtualMachineNetworkInterfaceIPConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 properties: Optional['outputs.VirtualMachineNetworkInterfaceIPConfigurationPropertiesResponse'] = None):
        """
        Describes a virtual machine network profile's IP configuration.

        :param _builtins.str name: The IP configuration name.
        :param 'VirtualMachineNetworkInterfaceIPConfigurationPropertiesResponse' properties: Describes a virtual machine network interface IP configuration properties.
        """
        pulumi.set(__self__, "name", name)
        if properties is not None:
            pulumi.set(__self__, "properties", properties)
...
class VirtualMachineProfileResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "additionalCapabilities":
            ...
            suggest = "os_profile"
        elif key == "scheduledEventsPolicy":
            suggest = "scheduled_events_policy"
    ...
    def __init__(__self__, *,
                 ...
                 scheduled_events_policy: Optional['outputs.ScheduledEventsPolicyResponse'] = None,
        ...
        :param 'AdditionalCapabilitiesResponse' additional_capabilities: Specifies additional capabilities enabled or disabled on the virtual machine.
        :param 'ApplicationProfileResponse' application_profile: Specifies the gallery applications that should be made available to the VM.
        :param 'CapacityReservationProfileResponse' capacity_reservation: Specifies information about the capacity reservation that is used to allocate virtual machine. Minimum compute api-version: 2021-04-01.
        :param 'DiagnosticsProfileResponse' diagnostics_profile: Specifies the boot diagnostic settings state. Minimum compute api-version: 2015-06-15.
        :param _builtins.str extensions_time_budget: Specifies the time alloted for all extensions to start. The time duration should be between 15 minutes and 120 minutes (inclusive) and should be specified in ISO 8601 format. The default value is 90 minutes (PT1H30M). Minimum compute api-version: 2020-06-01.
        ...
        :param 'NetworkProfileResponse' network_profile: Specifies the network interfaces of the virtual machine.
        :param 'OSProfileResponse' os_profile: Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.
        :param 'ScheduledEventsPolicyResponse' scheduled_events_policy: Specifies Redeploy, Reboot and ScheduledEventsAdditionalPublishingTargets Scheduled Event related configurations for the virtual machine.
        :param 'ScheduledEventsProfileResponse' scheduled_events_profile: Specifies Scheduled Event related configurations.
        :param 'SecurityProfileResponse' security_profile: Specifies the Security related profile settings for the virtual machine.
        :param 'StorageProfileResponse' storage_profile: Specifies the storage settings for the virtual machine disks.
        :param _builtins.str user_data: UserData for the VM, which must be base-64 encoded. Customer should not pass any secrets in here. Minimum compute api-version: 2021-03-01.
        """
...
class VirtualMachinePublicIPAddressConfigurationPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualMachinePublicIPAddressConfigurationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualMachinePublicIPAddressConfigurationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
...
class VirtualMachinePublicIPAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 properties: Optional['outputs.VirtualMachinePublicIPAddressConfigurationPropertiesResponse'] = None,
        ...
        :param 'VirtualMachinePublicIPAddressConfigurationPropertiesResponse' properties: Describes a virtual machines IP Configuration's PublicIPAddress configuration
        :param 'PublicIPAddressSkuResponse' sku: Describes the public IP Sku. It can only be set with OrchestrationMode as Flexible.
        :param Mapping[str, _builtins.str] tags: Resource tags applied to the publicIP address created by this PublicIPAddressConfiguration
        """
        pulumi.set(__self__, "name", name)
        if properties is not None:
            pulumi.set(__self__, "properties", properties)
...
class VmSizeProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The Sku name (e.g. 'Standard_DS1_v2')
        :param _builtins.int rank: The rank of the VM size. This is used with 'AllocationStrategy.Prioritized'
...
class ZoneAllocationPolicyResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "distributionStrategy":
            suggest = "distribution_strategy"
        elif key == "zonePreferences":
            suggest = "zone_preferences"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ZoneAllocationPolicyResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ZoneAllocationPolicyResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 distribution_strategy: _builtins.str,
                 zone_preferences: Optional[Sequence['outputs.ZonePreferenceResponse']] = None):
        """
        ZoneAllocationPolicy for LaunchBulkInstancesOperation.

        :param _builtins.str distribution_strategy: Distribution strategy used for zone allocation policy.
        :param Sequence['ZonePreferenceResponse'] zone_preferences: Zone preferences, required when zone distribution strategy is Prioritized.
        """
...
class ZonePreferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str zone: Name of the zone.
        :param _builtins.int rank:     The rank of the zone. This is used with 'Prioritized' ZoneDistributionStrategy.
                   The lower the number, the higher the priority, starting with 0.
