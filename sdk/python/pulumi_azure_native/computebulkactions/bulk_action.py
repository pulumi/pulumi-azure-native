...
class BulkActionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['LaunchBulkInstancesOperationPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['LaunchBulkInstancesOperationPropertiesArgs']]):
...
class BulkAction(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['LaunchBulkInstancesOperationPropertiesArgs', 'LaunchBulkInstancesOperationPropertiesArgsDict']]] = None,
