...
class ProviderRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub/latest:ProviderRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:ProviderRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:ProviderRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:ProviderRegistration")])
