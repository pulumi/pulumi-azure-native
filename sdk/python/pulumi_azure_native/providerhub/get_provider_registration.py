...
def get_provider_registration(provider_namespace: Optional[builtins.str] = None,
...
def get_provider_registration_output(provider_namespace: Optional[pulumi.Input[builtins.str]] = None,
