...
def get_provider_registration(provider_namespace: Optional[_builtins.str] = None,
...
def get_provider_registration_output(provider_namespace: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
