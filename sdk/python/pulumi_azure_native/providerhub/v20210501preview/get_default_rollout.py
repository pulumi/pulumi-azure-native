...
def get_default_rollout(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_default_rollout is deprecated: azure-native:providerhub/v20210501preview:DefaultRollout is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:DefaultRollout to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['providerNamespace'] = provider_namespace
    __args__['rolloutName'] = rollout_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20210501preview:getDefaultRollout', __args__, opts=opts, typ=GetDefaultRolloutResult).value
