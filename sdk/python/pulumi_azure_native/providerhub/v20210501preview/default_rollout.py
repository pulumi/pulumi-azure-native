...
warnings.warn("""azure-native:providerhub/v20210501preview:DefaultRollout is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:DefaultRollout to guarantee forwards compatibility.""", DeprecationWarning)
...
class DefaultRollout(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rollout_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DefaultRollout is deprecated: azure-native:providerhub/v20210501preview:DefaultRollout is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:DefaultRollout to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:DefaultRollout"), pulumi.Alias(type_="azure-native:providerhub/v20201120:DefaultRollout"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:DefaultRollout"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:DefaultRollout")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DefaultRollout, __self__).__init__(
            'azure-native:providerhub/v20210501preview:DefaultRollout',
            resource_name,
            __props__,
            opts)
