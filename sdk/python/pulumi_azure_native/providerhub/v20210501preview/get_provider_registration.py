...
def get_provider_registration(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_provider_registration is deprecated: azure-native:providerhub/v20210501preview:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
