...
def get_provider_registration_output(provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub/v20210501preview:getProviderRegistration', __args__, opts=opts, typ=GetProviderRegistrationResult)
