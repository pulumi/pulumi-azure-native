...
warnings.warn("""azure-native:providerhub/v20210501preview:ProviderRegistration is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.""", DeprecationWarning)
