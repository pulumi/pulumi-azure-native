...
class Skus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Skus is deprecated: azure-native:providerhub/v20210501preview:Skus is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility.""")
