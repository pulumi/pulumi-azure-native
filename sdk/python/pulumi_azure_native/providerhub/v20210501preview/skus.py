...
class Skus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sku: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Skus is deprecated: azure-native:providerhub/v20210501preview:Skus is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20201120:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:Skus")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Skus, __self__).__init__(
            'azure-native:providerhub/v20210501preview:Skus',
            resource_name,
            __props__,
            opts)
