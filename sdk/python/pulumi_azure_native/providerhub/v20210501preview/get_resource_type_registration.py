...
def get_resource_type_registration(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20210501preview:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult).value
...
def get_resource_type_registration_output(provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub/v20210501preview:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult)
