...
class OperationByProviderRegistration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 contents: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OperationsDefinitionArgs', 'OperationsDefinitionArgsDict']]]]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub/v20201120:OperationByProviderRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:OperationByProviderRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:OperationByProviderRegistration"), pulumi.Alias(type_="azure-native:providerhub:OperationByProviderRegistration")])
