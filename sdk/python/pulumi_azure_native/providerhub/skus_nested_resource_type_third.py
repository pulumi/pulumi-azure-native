...
class SkusNestedResourceTypeThirdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] nested_resource_type_second: The second child resource type.
        :param pulumi.Input[_builtins.str] nested_resource_type_third: The third child resource type.
