...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getNotificationRegistration'.""", DeprecationWarning)
...
def get_notification_registration(notification_registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult).value
