...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:providerhub/latest:DefaultRollout":
                return DefaultRollout(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:NotificationRegistration":
                return NotificationRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:OperationByProviderRegistration":
                return OperationByProviderRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:ProviderRegistration":
                return ProviderRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:ResourceTypeRegistration":
                return ResourceTypeRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:Skus":
                return Skus(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:SkusNestedResourceTypeFirst":
                return SkusNestedResourceTypeFirst(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:SkusNestedResourceTypeSecond":
                return SkusNestedResourceTypeSecond(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/latest:SkusNestedResourceTypeThird":
    ...
    pulumi.runtime.register_resource_module("azure-native", "providerhub/latest", _module_instance)
