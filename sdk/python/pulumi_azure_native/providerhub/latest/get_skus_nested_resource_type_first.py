...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkusNestedResourceTypeFirst'.""", DeprecationWarning)
...
def get_skus_nested_resource_type_first(nested_resource_type_first: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getSkusNestedResourceTypeFirst', __args__, opts=opts, typ=GetSkusNestedResourceTypeFirstResult).value
