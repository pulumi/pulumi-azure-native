...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getDefaultRollout'.""", DeprecationWarning)
...
def get_default_rollout(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getDefaultRollout', __args__, opts=opts, typ=GetDefaultRolloutResult).value
