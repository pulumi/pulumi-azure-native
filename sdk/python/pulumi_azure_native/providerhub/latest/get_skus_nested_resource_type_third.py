...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkusNestedResourceTypeThird'.""", DeprecationWarning)
...
def get_skus_nested_resource_type_third(nested_resource_type_first: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_skus_nested_resource_type_third is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkusNestedResourceTypeThird'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getSkusNestedResourceTypeThird', __args__, opts=opts, typ=GetSkusNestedResourceTypeThirdResult).value
