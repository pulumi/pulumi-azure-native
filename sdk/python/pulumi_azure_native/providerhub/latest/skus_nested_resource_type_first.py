...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:SkusNestedResourceTypeFirst'.""", DeprecationWarning)
...
class SkusNestedResourceTypeFirst(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/latest:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeFirst")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeFirst, __self__).__init__(
            'azure-native:providerhub/latest:SkusNestedResourceTypeFirst',
            resource_name,
            __props__,
            opts)
