...
def get_skus_nested_resource_type_second(nested_resource_type_first: Optional[_builtins.str] = None,
                                         nested_resource_type_second: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sku: The SKU.
    """
    __args__ = dict()
