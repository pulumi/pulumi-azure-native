...
class DefaultRollout(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['DefaultRolloutPropertiesArgs', 'DefaultRolloutPropertiesArgsDict']]] = None,
