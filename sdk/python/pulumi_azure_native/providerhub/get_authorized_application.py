...
def get_authorized_application(application_id: Optional[builtins.str] = None,
...
def get_authorized_application_output(application_id: Optional[pulumi.Input[builtins.str]] = None,
