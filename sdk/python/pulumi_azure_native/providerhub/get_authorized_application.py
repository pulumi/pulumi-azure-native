...
def get_authorized_application(application_id: Optional[_builtins.str] = None,
                               provider_namespace: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthorizedApplicationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub:getAuthorizedApplication', __args__, opts=opts, typ=GetAuthorizedApplicationResult).value

    return AwaitableGetAuthorizedApplicationResult(
...
def get_authorized_application_output(application_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub:getAuthorizedApplication', __args__, opts=opts, typ=GetAuthorizedApplicationResult)
    return __ret__.apply(lambda __response__: GetAuthorizedApplicationResult(
