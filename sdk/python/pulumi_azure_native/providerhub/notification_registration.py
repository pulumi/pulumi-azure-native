...
class NotificationRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/latest:NotificationRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:NotificationRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:NotificationRegistration")])
