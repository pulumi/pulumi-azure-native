...
def get_default_rollout(provider_namespace: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub:getDefaultRollout', __args__, opts=opts, typ=GetDefaultRolloutResult).value
...
def get_default_rollout_output(provider_namespace: Optional[pulumi.Input[_builtins.str]] = None,
