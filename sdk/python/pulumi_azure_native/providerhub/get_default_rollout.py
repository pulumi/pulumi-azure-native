...
def get_default_rollout(provider_namespace: Optional[builtins.str] = None,
...
def get_default_rollout_output(provider_namespace: Optional[pulumi.Input[builtins.str]] = None,
