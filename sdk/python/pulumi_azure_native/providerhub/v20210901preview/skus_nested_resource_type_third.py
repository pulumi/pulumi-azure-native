...
class SkusNestedResourceTypeThirdArgs:
    ...
    def _configure(
        ...
        if nested_resource_type_third is None and 'nestedResourceTypeThird' in kwargs:
            nested_resource_type_third = kwargs['nestedResourceTypeThird']
        if nested_resource_type_third is None:
            raise TypeError("Missing 'nested_resource_type_third' argument")
