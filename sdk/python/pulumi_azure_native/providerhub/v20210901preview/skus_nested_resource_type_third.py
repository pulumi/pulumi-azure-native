...
class SkusNestedResourceTypeThird(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        skus_nested_resource_type_third = azure_native.providerhub.v20210901preview.SkusNestedResourceTypeThird("skusNestedResourceTypeThird",
            ...
            properties=azure_native.providerhub.v20210901preview.SkuResourceResponsePropertiesArgs(
                sku_settings=[
                    {
                        "kind": "Standard",
                        "name": "freeSku",
                    ...
                    {
                        "costs": [azure_native.providerhub.v20210901preview.SkuCostArgs(
                            meter_id="xxx",
                        )],
                        "kind": "Premium",
                        "name": "premiumSku",
