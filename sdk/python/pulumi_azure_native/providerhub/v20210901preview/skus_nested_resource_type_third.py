...
class SkusNestedResourceTypeThirdArgs:
    def __init__(__self__, *,
        ...
        """
        SkusNestedResourceTypeThirdArgs._configure(
    ...
    def _configure(
             ...
             **kwargs):
        if 'nestedResourceTypeFirst' in kwargs:
            nested_resource_type_first = kwargs['nestedResourceTypeFirst']
        if 'nestedResourceTypeSecond' in kwargs:
            nested_resource_type_second = kwargs['nestedResourceTypeSecond']
        if 'nestedResourceTypeThird' in kwargs:
            nested_resource_type_third = kwargs['nestedResourceTypeThird']
        ...
        _setter("nested_resource_type_third", nested_resource_type_third)
...
class SkusNestedResourceTypeThird(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SkusNestedResourceTypeThirdArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, SkuResourcePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                SkuResourcePropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:SkusNestedResourceTypeThird")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeThird, __self__).__init__(
            'azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird',
            resource_name,
            __props__,
            opts)
