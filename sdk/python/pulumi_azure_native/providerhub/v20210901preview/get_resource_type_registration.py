...
def get_resource_type_registration(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20210901preview:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult).value
