...
class ResourceTypeRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20210901preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210601preview:ResourceTypeRegistration")])
