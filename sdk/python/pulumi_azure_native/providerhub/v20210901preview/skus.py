...
class Skus(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        skus = azure_native.providerhub.v20210901preview.Skus("skus",
        ...
        ```sh
        $ pulumi import azure-native:providerhub/v20210901preview:Skus Microsoft.Contoso/ /subscriptions/ab7a8701-f7ef-471a-a2f4-d0ebbf494f77providers/Microsoft.ProviderHub/providerRegistrations/Microsoft.Contoso/ 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20201120:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:Skus")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Skus, __self__).__init__(
            'azure-native:providerhub/v20210901preview:Skus',
            resource_name,
            __props__,
            opts)
