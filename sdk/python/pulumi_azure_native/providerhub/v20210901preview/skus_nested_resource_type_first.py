...
class SkusNestedResourceTypeFirst(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        skus_nested_resource_type_first = azure_native.providerhub.v20210901preview.SkusNestedResourceTypeFirst("skusNestedResourceTypeFirst",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:SkusNestedResourceTypeFirst")])
