...
warnings.warn("""azure-native:providerhub/v20201120:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_provider_registration(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_provider_registration is deprecated: azure-native:providerhub/v20201120:ProviderRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:ProviderRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['providerNamespace'] = provider_namespace
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20201120:getProviderRegistration', __args__, opts=opts, typ=GetProviderRegistrationResult).value
