...
class SkusNestedResourceTypeSecond(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        skus_nested_resource_type_second = azure_native.providerhub.v20201120.SkusNestedResourceTypeSecond("skusNestedResourceTypeSecond",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:SkusNestedResourceTypeSecond")])
