...
class SkusNestedResourceTypeThird(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210601preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210901preview:SkusNestedResourceTypeThird")])
