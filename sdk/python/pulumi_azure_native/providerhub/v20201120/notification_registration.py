...
class NotificationRegistration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        notification_registration = azure_native.providerhub.v20201120.NotificationRegistration("notificationRegistration",
            notification_registration_name="fooNotificationRegistration",
            properties=azure_native.providerhub.v20201120.NotificationRegistrationResponsePropertiesArgs(
                included_events=[
                    "*/write",
                ...
                notification_endpoints=[
                    azure_native.providerhub.v20201120.NotificationEndpointArgs(
                        locations=[
                            "",
                            "East US",
                        ],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210601preview:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:NotificationRegistration")])
