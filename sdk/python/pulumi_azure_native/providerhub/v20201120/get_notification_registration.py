...
warnings.warn("""azure-native:providerhub/v20201120:NotificationRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:NotificationRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_notification_registration(notification_registration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_notification_registration is deprecated: azure-native:providerhub/v20201120:NotificationRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:NotificationRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20201120:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult).value
