...
class ResourceTypeRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:ResourceTypeRegistration")])
