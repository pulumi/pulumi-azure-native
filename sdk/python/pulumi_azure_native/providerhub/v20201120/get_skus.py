...
def get_skus(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_skus is deprecated: azure-native:providerhub/v20201120:Skus is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:Skus to guarantee forwards compatibility.""")
    __args__ = dict()
