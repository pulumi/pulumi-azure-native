...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:providerhub/v20201120:DefaultRollout":
                return DefaultRollout(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:NotificationRegistration":
                return NotificationRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:OperationByProviderRegistration":
                return OperationByProviderRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:ProviderRegistration":
                return ProviderRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:ResourceTypeRegistration":
                return ResourceTypeRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:Skus":
                return Skus(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst":
                return SkusNestedResourceTypeFirst(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond":
                return SkusNestedResourceTypeSecond(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:providerhub/v20201120:SkusNestedResourceTypeThird":
    ...
    pulumi.runtime.register_resource_module("azure-native", "providerhub/v20201120", _module_instance)
