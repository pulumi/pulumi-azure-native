...
class OperationByProviderRegistration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        operation_by_provider_registration = azure_native.providerhub.v20201120.OperationByProviderRegistration("operationByProviderRegistration",
            contents=[azure_native.providerhub.v20201120.OperationsDefinitionArgs(
                display=azure_native.providerhub.v20201120.OperationsDefinitionDisplayArgs(
