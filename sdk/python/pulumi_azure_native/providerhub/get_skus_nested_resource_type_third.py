...
def get_skus_nested_resource_type_third(nested_resource_type_first: Optional[_builtins.str] = None,
                                        nested_resource_type_second: Optional[_builtins.str] = None,
                                        nested_resource_type_third: Optional[_builtins.str] = None,
    ...
    :param _builtins.str nested_resource_type_third: The third child resource type.
...
def get_skus_nested_resource_type_third_output(nested_resource_type_first: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub:getSkusNestedResourceTypeThird', __args__, opts=opts, typ=GetSkusNestedResourceTypeThirdResult)
