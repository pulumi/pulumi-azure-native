...
def get_notification_registration(notification_registration_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult).value
...
def get_notification_registration_output(notification_registration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult)
