...
def get_notification_registration(notification_registration_name: Optional[builtins.str] = None,
...
def get_notification_registration_output(notification_registration_name: Optional[pulumi.Input[builtins.str]] = None,
