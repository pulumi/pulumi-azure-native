...
def get_default_rollout(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_default_rollout is deprecated: azure-native:providerhub/v20210601preview:DefaultRollout is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:DefaultRollout to guarantee forwards compatibility.""")
    __args__ = dict()
