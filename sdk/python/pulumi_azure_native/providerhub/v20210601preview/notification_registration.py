...
warnings.warn("""azure-native:providerhub/v20210601preview:NotificationRegistration is being removed in the next major version of this provider. Upgrade to at least azure-native:providerhub/v20210901preview:NotificationRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
class NotificationRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:providerhub:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210901preview:NotificationRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationRegistration, __self__).__init__(
            'azure-native:providerhub/v20210601preview:NotificationRegistration',
            resource_name,
            __props__,
            opts)
