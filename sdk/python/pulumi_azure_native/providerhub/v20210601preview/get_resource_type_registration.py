...
def get_resource_type_registration_output(provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub/v20210601preview:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult)
