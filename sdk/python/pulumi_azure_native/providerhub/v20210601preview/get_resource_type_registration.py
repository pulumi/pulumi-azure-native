...
warnings.warn("""azure-native:providerhub/v20210601preview:ResourceTypeRegistration is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:ResourceTypeRegistration to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_resource_type_registration(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_type_registration is deprecated: azure-native:providerhub/v20210601preview:ResourceTypeRegistration is being removed in the next major version of this provider. Please upgrade to azure-native:providerhub/v20210901preview:ResourceTypeRegistration to guarantee forwards compatibility.""")
    __args__ = dict()
