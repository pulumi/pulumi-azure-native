...
def get_notification_registration(notification_registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20210601preview:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult).value
...
def get_notification_registration_output(notification_registration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub/v20210601preview:getNotificationRegistration', __args__, opts=opts, typ=GetNotificationRegistrationResult)
