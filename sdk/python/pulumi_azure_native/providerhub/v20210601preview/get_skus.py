...
def get_skus(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/v20210601preview:getSkus', __args__, opts=opts, typ=GetSkusResult).value
...
def get_skus_output(provider_namespace: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:providerhub/v20210601preview:getSkus', __args__, opts=opts, typ=GetSkusResult)
