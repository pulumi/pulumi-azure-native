...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:powerbi:listWorkspaceCollectionAccessKeys'.""", DeprecationWarning)
...
def list_workspace_collection_access_keys(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_workspace_collection_access_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:powerbi:listWorkspaceCollectionAccessKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:powerbi/latest:listWorkspaceCollectionAccessKeys', __args__, opts=opts, typ=ListWorkspaceCollectionAccessKeysResult).value
