...
class PowerBIResourceByResourceName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:powerbi:PowerBIResourceByResourceName"), pulumi.Alias(type_="azure-native:powerbi/v20200601:PowerBIResourceByResourceName"), pulumi.Alias(type_="azure-nextgen:powerbi/v20200601:PowerBIResourceByResourceName")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PowerBIResourceByResourceName, __self__).__init__(
            'azure-native:powerbi:PowerBIResourceByResourceName',
            resource_name,
            __props__,
            opts)
