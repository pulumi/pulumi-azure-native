...
def get_private_endpoint_connection(azure_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str azure_resource_name: The name of the Azure resource.
...
def get_private_endpoint_connection_output(azure_resource_name: Optional[pulumi.Input[builtins.str]] = None,
