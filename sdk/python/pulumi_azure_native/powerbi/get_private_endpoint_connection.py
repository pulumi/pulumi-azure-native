...
def get_private_endpoint_connection(azure_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str azure_resource_name: The name of the Azure resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:powerbi:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
...
def get_private_endpoint_connection_output(azure_resource_name: Optional[pulumi.Input[_builtins.str]] = None,
