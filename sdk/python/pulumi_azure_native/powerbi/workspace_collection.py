...
class WorkspaceCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Azure resource group
        :param pulumi.Input[builtins.str] location: Azure location
        :param pulumi.Input[builtins.str] workspace_collection_name: Power BI Embedded Workspace Collection name
        """
    ...
    def workspace_collection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def workspace_collection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbi/v20160129:WorkspaceCollection")])
