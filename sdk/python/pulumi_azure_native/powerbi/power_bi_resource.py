...
class PowerBIResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbi/v20200601:PowerBIResource"), pulumi.Alias(type_="azure-native_powerbi_v20200601:powerbi:PowerBIResource")])
