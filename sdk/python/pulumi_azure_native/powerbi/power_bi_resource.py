...
class PowerBIResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies the tags of the resource.
        :param pulumi.Input[builtins.str] tenant_id: Specifies the tenant id of the resource.
        """
