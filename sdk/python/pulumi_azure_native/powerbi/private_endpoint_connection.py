...
class PrivateEndpointConnectionInitArgs:
    def __init__(__self__, *,
                 azure_resource_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] azure_resource_name: The name of the Azure resource.
    ...
    def azure_resource_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def azure_resource_name(self, value: pulumi.Input[builtins.str]):
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:powerbi:PrivateEndpointConnection"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:powerbi/v20200601:PrivateEndpointConnection")])
