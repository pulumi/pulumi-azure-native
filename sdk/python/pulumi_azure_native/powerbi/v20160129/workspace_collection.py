...
class WorkspaceCollectionArgs:
    def __init__(__self__, *,
        ...
        """
        WorkspaceCollectionArgs._configure(
    ...
    def _configure(
        ...
        if workspace_collection_name is None and 'workspaceCollectionName' in kwargs:
            workspace_collection_name = kwargs['workspaceCollectionName']
        ...
        if workspace_collection_name is not None:
            _setter("workspace_collection_name", workspace_collection_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WorkspaceCollectionArgs._configure(_setter, **kwargs)
