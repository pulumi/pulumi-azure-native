...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Specifies the id of the resource.
        :param builtins.str name: Specifies the name of the resource.
        :param 'SystemDataResponse' system_data: The system meta data relating to this resource.
        :param builtins.str type: Specifies the type of the resource.
...
class PrivateEndpointResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Specifies the id of private endpoint.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
