...
class LabPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/v20211001preview:LabPlan"), pulumi.Alias(type_="azure-native:labservices:LabPlan"), pulumi.Alias(type_="azure-nextgen:labservices:LabPlan")])
