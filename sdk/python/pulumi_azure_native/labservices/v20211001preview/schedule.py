...
class Schedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        schedule = azure_native.labservices.v20211001preview.Schedule("schedule",
            lab_name="testlab",
            notes="Schedule 1 for students",
            recurrence_pattern=azure_native.labservices.v20211001preview.RecurrencePatternResponseArgs(
                expiration_date="2020-08-14",
                frequency=azure_native.labservices/v20211001preview.RecurrenceFrequency.DAILY,
                interval=2,
            ),
