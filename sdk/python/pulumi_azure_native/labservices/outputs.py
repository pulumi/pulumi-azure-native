...
class AutoShutdownProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 disconnect_delay: Optional[builtins.str] = None,
                 idle_delay: Optional[builtins.str] = None,
                 no_connect_delay: Optional[builtins.str] = None,
                 shutdown_on_disconnect: Optional[builtins.str] = None,
                 shutdown_on_idle: Optional[builtins.str] = None,
                 shutdown_when_not_connected: Optional[builtins.str] = None):
        """
        Profile for how to handle shutting down virtual machines.
        :param builtins.str disconnect_delay: The amount of time a VM will stay running after a user disconnects if this behavior is enabled.
        :param builtins.str idle_delay: The amount of time a VM will idle before it is shutdown if this behavior is enabled.
        :param builtins.str no_connect_delay: The amount of time a VM will stay running before it is shutdown if no connection is made and this behavior is enabled.
        :param builtins.str shutdown_on_disconnect: Whether shutdown on disconnect is enabled
        :param builtins.str shutdown_on_idle: Whether a VM will get shutdown when it has idled for a period of time.
        :param builtins.str shutdown_when_not_connected: Whether a VM will get shutdown when it hasn't been connected to after a period of time.
        """
    ...
    def disconnect_delay(self) -> Optional[builtins.str]:
        """
    ...
    def idle_delay(self) -> Optional[builtins.str]:
        """
    ...
    def no_connect_delay(self) -> Optional[builtins.str]:
        """
    ...
    def shutdown_on_disconnect(self) -> Optional[builtins.str]:
        """
    ...
    def shutdown_on_idle(self) -> Optional[builtins.str]:
        """
    ...
    def shutdown_when_not_connected(self) -> Optional[builtins.str]:
        """
...
class ConnectionProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 client_rdp_access: Optional[builtins.str] = None,
                 client_ssh_access: Optional[builtins.str] = None,
                 web_rdp_access: Optional[builtins.str] = None,
                 web_ssh_access: Optional[builtins.str] = None):
        """
        Connection profile for how users connect to lab virtual machines.
        :param builtins.str client_rdp_access: The enabled access level for Client Access over RDP.
        :param builtins.str client_ssh_access: The enabled access level for Client Access over SSH.
        :param builtins.str web_rdp_access: The enabled access level for Web Access over RDP.
        :param builtins.str web_ssh_access: The enabled access level for Web Access over SSH.
        """
    ...
    def client_rdp_access(self) -> Optional[builtins.str]:
        """
    ...
    def client_ssh_access(self) -> Optional[builtins.str]:
        """
    ...
    def web_rdp_access(self) -> Optional[builtins.str]:
        """
    ...
    def web_ssh_access(self) -> Optional[builtins.str]:
        """
...
class CredentialsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Credentials for a user on a lab VM.
        :param builtins.str username: The username to use when signing in to lab VMs.
        """
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Image reference information. Used in the virtual machine profile.
        :param builtins.str exact_version: The actual version of the image after use.
        :param builtins.str id: Image resource ID
        :param builtins.str offer: The image offer if applicable.
        :param builtins.str publisher: The image publisher
        :param builtins.str sku: The image SKU
        :param builtins.str version: The image version specified on creation.
        """
...
class LabNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile for how to handle networking for Labs.
        :param builtins.str load_balancer_id: The external load balancer resource id
        :param builtins.str public_ip_id: The external public IP resource id
        :param builtins.str subnet_id: The external subnet resource id
        """
    ...
    def public_ip_id(self) -> Optional[builtins.str]:
        """
...
class RecurrencePatternResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Recurrence pattern of a lab schedule.
        :param builtins.str expiration_date: When the recurrence will expire. This date is inclusive.
        :param builtins.str frequency: The frequency of the recurrence.
        :param builtins.int interval: The interval to invoke the schedule on. For example, interval = 2 and RecurrenceFrequency.Daily will run every 2 days. When no interval is supplied, an interval of 1 is used.
        :param Sequence[builtins.str] week_days: The week days the schedule runs. Used for when the Frequency is set to Weekly.
        """
...
class ResourceOperationErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Error details of the latest operation failure on this resource
        :param builtins.str action: The operation action that failed
        :param builtins.str code: The code that corresponds to the type of operation failure
        :param builtins.str message: The operation failure message
        :param builtins.str timestamp: The datetime of when the error occured
        """
...
class RosterProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 active_directory_group_id: Optional[builtins.str] = None,
                 lms_instance: Optional[builtins.str] = None,
                 lti_client_id: Optional[builtins.str] = None,
                 lti_context_id: Optional[builtins.str] = None,
                 lti_roster_endpoint: Optional[builtins.str] = None):
        """
        The lab user list management profile.
        :param builtins.str active_directory_group_id: The AAD group ID which this lab roster is populated from. Having this set enables AAD sync mode.
        :param builtins.str lms_instance: The base URI identifying the lms instance.
        :param builtins.str lti_client_id: The unique id of the azure lab services tool in the lms.
        :param builtins.str lti_context_id: The unique context identifier for the lab in the lms.
        :param builtins.str lti_roster_endpoint: The uri of the names and roles service endpoint on the lms for the class attached to this lab.
        """
    ...
    def active_directory_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def lms_instance(self) -> Optional[builtins.str]:
        """
    ...
    def lti_client_id(self) -> Optional[builtins.str]:
        """
    ...
    def lti_context_id(self) -> Optional[builtins.str]:
        """
    ...
    def lti_roster_endpoint(self) -> Optional[builtins.str]:
        """
...
class SecurityProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 registration_code: builtins.str,
                 open_access: Optional[builtins.str] = None):
        """
        The lab security profile.
        :param builtins.str registration_code: The registration code for the lab.
        :param builtins.str open_access: Whether any user or only specified users can register to a lab.
        """
    ...
    def open_access(self) -> Optional[builtins.str]:
        """
...
class SupportInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Support contact information and instructions.
        :param builtins.str email: Support contact email address.
        :param builtins.str instructions: Support instructions.
        :param builtins.str phone: Support contact phone number.
        :param builtins.str url: Support web address.
        """
...
class VirtualMachineAdditionalCapabilitiesResponse(dict):
    ...
    def __init__(__self__, *,
                 install_gpu_drivers: Optional[builtins.str] = None):
        """
        The additional capabilities for a lab VM.
        :param builtins.str install_gpu_drivers: Flag to pre-install dedicated GPU drivers.
        """
    ...
    def install_gpu_drivers(self) -> Optional[builtins.str]:
        """
...
class VirtualMachineProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_shared_password: Optional[builtins.str] = None):
        """
        The base virtual machine configuration for a lab.
        :param 'CredentialsResponse' admin_user: Credentials for the admin user on the VM.
        :param builtins.str create_option: Indicates what lab virtual machines are created from.
        ...
        :param builtins.str usage_quota: The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
        ...
        :param builtins.str use_shared_password: Enabling this option will use the same password for all user VMs.
        """
    ...
    def use_shared_password(self) -> Optional[builtins.str]:
        """
