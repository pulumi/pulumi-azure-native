...
class AutoShutdownProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 disconnect_delay: Optional[_builtins.str] = None,
                 idle_delay: Optional[_builtins.str] = None,
                 no_connect_delay: Optional[_builtins.str] = None,
                 shutdown_on_disconnect: Optional[_builtins.str] = None,
                 shutdown_on_idle: Optional[_builtins.str] = None,
        ...
        :param _builtins.str shutdown_on_disconnect: Whether shutdown on disconnect is enabled
        :param _builtins.str shutdown_on_idle: Whether a VM will get shutdown when it has idled for a period of time.
        :param _builtins.str shutdown_when_not_connected: Whether a VM will get shutdown when it hasn't been connected to after a period of time.
        """
...
class ConnectionProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 client_rdp_access: Optional[_builtins.str] = None,
                 client_ssh_access: Optional[_builtins.str] = None,
                 web_rdp_access: Optional[_builtins.str] = None,
        ...
        :param _builtins.str web_ssh_access: The enabled access level for Web Access over SSH.
        """
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: The image version specified on creation.
        """
...
class RecurrencePatternResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] week_days: The week days the schedule runs. Used for when the Frequency is set to Weekly.
        """
...
class ResourceOperationErrorResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str timestamp: The datetime of when the error occured
        """
...
class RosterProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 active_directory_group_id: Optional[_builtins.str] = None,
                 lms_instance: Optional[_builtins.str] = None,
                 lti_client_id: Optional[_builtins.str] = None,
                 lti_context_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str lti_context_id: The unique context identifier for the lab in the lms.
        :param _builtins.str lti_roster_endpoint: The uri of the names and roles service endpoint on the lms for the class attached to this lab.
        """
...
class SupportInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str url: Support web address.
        """
...
class VirtualMachineProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sku: '_commontypesv2.outputs.SkuResponse',
                 usage_quota: _builtins.str,
        ...
        :param '_commontypesv2.SkuResponse' sku: The SKU for the lab. Defines the type of virtual machines used in the lab.
        :param _builtins.str usage_quota: The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
        ...
        :param _builtins.str use_shared_password: Enabling this option will use the same password for all user VMs.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sku(self) -> '_commontypesv2.outputs.SkuResponse':
        """
