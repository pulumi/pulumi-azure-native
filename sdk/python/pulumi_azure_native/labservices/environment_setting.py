...
class EnvironmentSettingArgs:
    ...
    def _configure(
        ...
        if 'environmentSettingName' in kwargs:
            environment_setting_name = kwargs['environmentSettingName']
...
class EnvironmentSetting(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EnvironmentSettingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if resource_settings is not None and not isinstance(resource_settings, ResourceSettingsArgs):
                resource_settings = resource_settings or {}
                def _setter(key, value):
                    resource_settings[key] = value
                ResourceSettingsArgs._configure(_setter, **resource_settings)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices/v20181015:EnvironmentSetting")])
