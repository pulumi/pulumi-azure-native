...
class EnvironmentSettingArgs:
    ...
    def _configure(
        ...
        if resource_settings is None:
            raise TypeError("Missing 'resource_settings' argument")
        if configuration_state is None and 'configurationState' in kwargs:
            configuration_state = kwargs['configurationState']
        if environment_setting_name is None and 'environmentSettingName' in kwargs:
...
class EnvironmentSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            resource_settings = _utilities.configure(resource_settings, ResourceSettingsArgs, True)
