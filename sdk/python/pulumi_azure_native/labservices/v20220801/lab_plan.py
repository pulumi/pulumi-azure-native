...
class LabPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        lab_plan = azure_native.labservices.v20220801.LabPlan("labPlan",
            default_auto_shutdown_profile=azure_native.labservices.v20220801.AutoShutdownProfileArgs(
            ...
            default_connection_profile=azure_native.labservices.v20220801.ConnectionProfileArgs(
            ...
            default_network_profile=azure_native.labservices.v20220801.LabPlanNetworkProfileArgs(
            ...
            support_info=azure_native.labservices.v20220801.SupportInfoArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices:LabPlan"), pulumi.Alias(type_="azure-native:labservices/v20211001preview:LabPlan"), pulumi.Alias(type_="azure-native:labservices/v20211115preview:LabPlan")])
