...
def get_lab_account_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLabAccountResult]:
    """
    Get lab account
    Azure REST API version: 2018-10-15.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:labservices:getLabAccount', __args__, opts=opts, typ=GetLabAccountResult)
