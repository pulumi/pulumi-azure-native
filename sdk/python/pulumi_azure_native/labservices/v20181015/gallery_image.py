...
class GalleryImageArgs:
    ...
    def _configure(
        ...
        if is_override is None and 'isOverride' in kwargs:
            is_override = kwargs['isOverride']
        if is_plan_authorized is None and 'isPlanAuthorized' in kwargs:
            is_plan_authorized = kwargs['isPlanAuthorized']
