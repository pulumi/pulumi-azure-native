...
class LabArgs:
    def __init__(__self__, *,
                 ...
                 lab_plan_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the lab.
        ...
        :param pulumi.Input[builtins.str] lab_plan_id: The ID of the lab plan. Used during resource creation to provide defaults and acts as a permission container when creating a lab via labs.azure.com. Setting a labPlanId on an existing lab provides organization..
        ...
        :param pulumi.Input[builtins.str] title: The title of the lab.
        """
    ...
    def lab_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @lab_name.setter
    def lab_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lab_name", value)

    @property
    @pulumi.getter(name="labPlanId")
    def lab_plan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @lab_plan_id.setter
    def lab_plan_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Lab(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:labservices:Lab"
    ...
    @property
    @pulumi.getter(name="labPlanId")
    def lab_plan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the lab plan. Used during resource creation to provide defaults and acts as a permission container when creating a lab via labs.azure.com. Setting a labPlanId on an existing lab provides organization..
        """
        return pulumi.get(self, "lab_plan_id")
