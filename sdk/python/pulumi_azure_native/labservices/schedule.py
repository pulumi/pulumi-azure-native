...
class ScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SchedulePropertiesArgs'] properties: Schedule resource properties
...
class Schedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] lab_name: The name of the lab that uniquely identifies it within containing lab account. Used in resource URIs.
        :param pulumi.Input[pulumi.InputType['SchedulePropertiesArgs']] properties: Schedule resource properties
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] schedule_name: The name of the schedule that uniquely identifies it within containing lab. Used in resource URIs.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices/v20211001preview:Schedule"), pulumi.Alias(type_="azure-native:labservices/v20211115preview:Schedule"), pulumi.Alias(type_="azure-native:labservices/v20220801:Schedule")])
