...
class ScheduleArgs:
    ...
    def _configure(
        ...
        if stop_at is None and 'stopAt' in kwargs:
            stop_at = kwargs['stopAt']
        if stop_at is None:
            raise TypeError("Missing 'stop_at' argument")
        ...
        if recurrence_pattern is None and 'recurrencePattern' in kwargs:
            recurrence_pattern = kwargs['recurrencePattern']
...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            recurrence_pattern = _utilities.configure(recurrence_pattern, RecurrencePatternArgs, True)
