...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:labservices/latest:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:labservices/latest:EnvironmentSetting":
                return EnvironmentSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:labservices/latest:GalleryImage":
                return GalleryImage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:labservices/latest:Lab":
                return Lab(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:labservices/latest:LabAccount":
                return LabAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:labservices/latest:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "labservices/latest", _module_instance)
