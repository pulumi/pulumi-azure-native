...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLabAccount'.""", DeprecationWarning)
...
def get_lab_account(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getLabAccount', __args__, opts=opts, typ=GetLabAccountResult).value
