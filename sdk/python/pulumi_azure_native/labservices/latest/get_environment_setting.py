...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getEnvironmentSetting'.""", DeprecationWarning)
...
def get_environment_setting(environment_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment_setting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getEnvironmentSetting'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getEnvironmentSetting', __args__, opts=opts, typ=GetEnvironmentSettingResult).value
