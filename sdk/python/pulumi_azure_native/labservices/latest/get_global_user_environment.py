...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getGlobalUserEnvironment'.""", DeprecationWarning)
...
def get_global_user_environment(environment_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getGlobalUserEnvironment', __args__, opts=opts, typ=GetGlobalUserEnvironmentResult).value
