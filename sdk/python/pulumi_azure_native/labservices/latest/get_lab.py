...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLab'.""", DeprecationWarning)
...
def get_lab(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_lab is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLab'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getLab', __args__, opts=opts, typ=GetLabResult).value
