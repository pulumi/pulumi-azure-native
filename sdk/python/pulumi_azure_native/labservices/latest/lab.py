...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:labservices:Lab'.""", DeprecationWarning)
...
class Lab(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices:Lab"), pulumi.Alias(type_="azure-nextgen:labservices:Lab"), pulumi.Alias(type_="azure-native:labservices/v20181015:Lab"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:Lab")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Lab, __self__).__init__(
            'azure-native:labservices/latest:Lab',
            resource_name,
            __props__,
            opts)
