...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLabAccountRegionalAvailability'.""", DeprecationWarning)
...
def get_lab_account_regional_availability(lab_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_lab_account_regional_availability is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getLabAccountRegionalAvailability'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getLabAccountRegionalAvailability', __args__, opts=opts, typ=GetLabAccountRegionalAvailabilityResult).value
