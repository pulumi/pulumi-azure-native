...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getUser'.""", DeprecationWarning)
...
def get_user(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getUser'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getUser', __args__, opts=opts, typ=GetUserResult).value
