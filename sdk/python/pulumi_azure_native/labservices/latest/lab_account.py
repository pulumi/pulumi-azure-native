...
class LabAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices:LabAccount"), pulumi.Alias(type_="azure-nextgen:labservices:LabAccount"), pulumi.Alias(type_="azure-native:labservices/v20181015:LabAccount"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:LabAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LabAccount, __self__).__init__(
            'azure-native:labservices/latest:LabAccount',
            resource_name,
            __props__,
            opts)
