...
class GalleryImage(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:labservices/latest:GalleryImage"), pulumi.Alias(type_="azure-nextgen:labservices/latest:GalleryImage"), pulumi.Alias(type_="azure-native:labservices/v20181015:GalleryImage"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:GalleryImage")])
