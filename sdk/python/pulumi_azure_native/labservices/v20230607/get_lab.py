...
def get_lab(lab_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/v20230607:getLab', __args__, opts=opts, typ=GetLabResult).value
...
def get_lab_output(lab_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:labservices/v20230607:getLab', __args__, opts=opts, typ=GetLabResult)
