...
class LabPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(default_auto_shutdown_profile, AutoShutdownProfileArgs):
            ...
            if not isinstance(default_connection_profile, ConnectionProfileArgs):
            ...
            if not isinstance(default_network_profile, LabPlanNetworkProfileArgs):
            ...
            if not isinstance(support_info, SupportInfoArgs):
