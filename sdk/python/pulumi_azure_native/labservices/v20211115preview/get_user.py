...
warnings.warn("""azure-native:labservices/v20211115preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:User to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_user(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user is deprecated: azure-native:labservices/v20211115preview:User is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:User to guarantee forwards compatibility.""")
    __args__ = dict()
