...
warnings.warn("""azure-native:labservices/v20211115preview:LabPlan is being removed in the next major version of this provider. Please upgrade to azure-native:labservices/v20220801:LabPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_lab_plan(lab_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_lab_plan is deprecated: azure-native:labservices/v20211115preview:LabPlan is being removed in the next major version of this provider. Please upgrade to azure-native:labservices/v20220801:LabPlan to guarantee forwards compatibility.""")
    __args__ = dict()
