...
warnings.warn("""azure-native:labservices/v20211115preview:LabPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:LabPlan to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_lab_plan(lab_plan_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_lab_plan is deprecated: azure-native:labservices/v20211115preview:LabPlan is being removed in the next major version of this provider. Upgrade to at least azure-native:labservices/v20220801:LabPlan to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['labPlanName'] = lab_plan_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/v20211115preview:getLabPlan', __args__, opts=opts, typ=GetLabPlanResult).value
