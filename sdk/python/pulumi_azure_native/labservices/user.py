...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 additional_usage_quota: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] additional_usage_quota: The amount of usage quota time the user gets in addition to the lab usage quota.
        :param pulumi.Input[builtins.str] user_name: The name of the user that uniquely identifies it within containing lab. Used in resource URIs.
        """
    ...
    def additional_usage_quota(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def additional_usage_quota(self, value: Optional[pulumi.Input[builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="additionalUsageQuota")
    def additional_usage_quota(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The amount of usage quota time the user gets in addition to the lab usage quota.
        """
        return pulumi.get(self, "additional_usage_quota")
    ...
    def invitation_sent(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def invitation_state(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def registration_state(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def total_usage(self) -> pulumi.Output[builtins.str]:
        """
