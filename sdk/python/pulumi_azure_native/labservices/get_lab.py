...
class GetLabResult:
    ...
    def lab_plan_id(self) -> Optional[builtins.str]:
        """
...
def get_lab(lab_name: Optional[builtins.str] = None,
...
def get_lab_output(lab_name: Optional[pulumi.Input[builtins.str]] = None,
