...
class LabPlanArgs:
    def __init__(__self__, *,
                 ...
                 lab_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 linked_lms_instance: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 shared_gallery_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_regions: The allowed regions for the lab creator to use when creating labs using this lab plan.
        ...
        :param pulumi.Input[builtins.str] lab_plan_name: The name of the lab plan that uniquely identifies it within containing resource group. Used in resource URIs and in UI.
        :param pulumi.Input[builtins.str] linked_lms_instance: Base Url of the lms instance this lab plan can link lab rosters against.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] shared_gallery_id: Resource ID of the Shared Image Gallery attached to this lab plan. When saving a lab template virtual machine image it will be persisted in this gallery. Shared images from the gallery can be made available to use when creating new labs.
    ...
    def lab_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def lab_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lab_plan_name", value)

    @property
    @pulumi.getter(name="linkedLmsInstance")
    def linked_lms_instance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def linked_lms_instance(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def shared_gallery_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_gallery_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LabPlan(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowedRegions")
    def allowed_regions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The allowed regions for the lab creator to use when creating labs using this lab plan.
        """
        return pulumi.get(self, "allowed_regions")
    ...
    @property
    @pulumi.getter(name="linkedLmsInstance")
    def linked_lms_instance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Base Url of the lms instance this lab plan can link lab rosters against.
        """
        return pulumi.get(self, "linked_lms_instance")
    ...
    @property
    @pulumi.getter(name="sharedGalleryId")
    def shared_gallery_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource ID of the Shared Image Gallery attached to this lab plan. When saving a lab template virtual machine image it will be persisted in this gallery. Shared images from the gallery can be made available to use when creating new labs.
        """
        return pulumi.get(self, "shared_gallery_id")
