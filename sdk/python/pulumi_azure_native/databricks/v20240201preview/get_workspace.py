...
class GetWorkspaceResult:
    ...
    """
    def __init__(__self__, access_connector=None, authorizations=None, created_by=None, created_date_time=None, default_catalog=None, disk_encryption_set_id=None, encryption=None, enhanced_security_compliance=None, id=None, is_uc_enabled=None, location=None, managed_disk_identity=None, managed_resource_group_id=None, name=None, parameters=None, private_dbfs_access=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, required_nsg_rules=None, sku=None, storage_account_identity=None, system_data=None, tags=None, type=None, ui_definition_uri=None, updated_by=None, workspace_id=None, workspace_url=None):
        ...
        if private_dbfs_access and not isinstance(private_dbfs_access, str):
            raise TypeError("Expected argument 'private_dbfs_access' to be a str")
        pulumi.set(__self__, "private_dbfs_access", private_dbfs_access)
    ...
    @property
    @pulumi.getter(name="privateDbfsAccess")
    def private_dbfs_access(self) -> Optional[str]:
        """
        Gets or Sets Private DBFS Access configuration information
        """
        return pulumi.get(self, "private_dbfs_access")
...
class AwaitableGetWorkspaceResult(GetWorkspaceResult):
    ...
    def __await__(self):
        ...
        return GetWorkspaceResult(
            ...
            private_dbfs_access=self.private_dbfs_access,
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databricks/v20240201preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
    ...
    return AwaitableGetWorkspaceResult(
        ...
        private_dbfs_access=pulumi.get(__ret__, 'private_dbfs_access'),
