...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if 'requiredNsgRules' in kwargs:
            required_nsg_rules = kwargs['requiredNsgRules']
        if 'uiDefinitionUri' in kwargs:
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption is not None and not isinstance(encryption, WorkspacePropertiesEncryptionArgs):
                encryption = encryption or {}
                def _setter(key, value):
                    encryption[key] = value
                WorkspacePropertiesEncryptionArgs._configure(_setter, **encryption)
            ...
            if parameters is not None and not isinstance(parameters, WorkspaceCustomParametersArgs):
                parameters = parameters or {}
                def _setter(key, value):
                    parameters[key] = value
                WorkspaceCustomParametersArgs._configure(_setter, **parameters)
