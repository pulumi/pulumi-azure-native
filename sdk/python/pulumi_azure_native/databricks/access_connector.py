...
class AccessConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connector_name: The name of the Azure Databricks Access Connector.
