...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:databricks/v20210401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:databricks/v20230201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:databricks/v20240501:PrivateEndpointConnection")])
