...
def get_v_net_peering(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databricks/v20180401:getVNetPeering', __args__, opts=opts, typ=GetVNetPeeringResult).value
...
def get_v_net_peering_output(peering_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databricks/v20180401:getVNetPeering', __args__, opts=opts, typ=GetVNetPeeringResult)
