...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks/v20180401:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20210401preview:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20230201:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20230915preview:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20240501:Workspace"), pulumi.Alias(type_="azure-native:databricks/v20250301preview:Workspace"), pulumi.Alias(type_="azure-native:databricks:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azure-native:databricks/v20240901preview:Workspace',
            resource_name,
            __props__,
            opts)
