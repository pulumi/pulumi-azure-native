...
def get_v_net_peering(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databricks/v20240901preview:getVNetPeering', __args__, opts=opts, typ=GetVNetPeeringResult).value
...
def get_v_net_peering_output(peering_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databricks/v20240901preview:getVNetPeering', __args__, opts=opts, typ=GetVNetPeeringResult)
