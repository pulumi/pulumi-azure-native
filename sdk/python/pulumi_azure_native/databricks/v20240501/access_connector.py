...
class AccessConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20221001preview:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20230501:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20240901preview:AccessConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessConnector, __self__).__init__(
            'azure-native:databricks/v20240501:AccessConnector',
            resource_name,
            __props__,
            opts)
