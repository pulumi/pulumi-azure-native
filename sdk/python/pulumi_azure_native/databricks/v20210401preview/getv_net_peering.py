...
def getv_net_peering(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""getv_net_peering is deprecated: azure-native:databricks/v20210401preview:vNetPeering is being removed in the next major version of this provider. Upgrade to at least azure-native:databricks/v20230201:vNetPeering to guarantee forwards compatibility.""")
    __args__ = dict()
