...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Workspace is deprecated: azure-native:databricks/v20210401preview:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:databricks/v20230201:Workspace to guarantee forwards compatibility.""")
