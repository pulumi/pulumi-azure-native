...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databricks:getvNetPeering'.""", DeprecationWarning)
...
def getv_net_peering(peering_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databricks/latest:getvNetPeering', __args__, opts=opts, typ=GetvNetPeeringResult).value
