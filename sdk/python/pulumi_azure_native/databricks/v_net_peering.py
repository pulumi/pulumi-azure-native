...
class VNetPeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] peering_name: The name of the workspace vNet peering.
...
class VNetPeering(pulumi.CustomResource):
    ...
    def peering_state(self) -> pulumi.Output[builtins.str]:
        """
