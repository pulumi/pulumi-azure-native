...
class VNetPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(databricks_address_space, AddressSpaceArgs):
            ...
            if not isinstance(databricks_virtual_network, VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs):
            ...
            if not isinstance(remote_virtual_network, VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs):
