...
class VNetPeeringArgs:
    ...
    def _configure(
             ...
             remote_virtual_network: Optional[pulumi.Input['VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs']] = None,
        ...
        if remote_virtual_network is None:
            raise TypeError("Missing 'remote_virtual_network' argument")
        ...
        if databricks_address_space is None and 'databricksAddressSpace' in kwargs:
            databricks_address_space = kwargs['databricksAddressSpace']
        if databricks_virtual_network is None and 'databricksVirtualNetwork' in kwargs:
            databricks_virtual_network = kwargs['databricksVirtualNetwork']
...
class VNetPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            databricks_address_space = _utilities.configure(databricks_address_space, AddressSpaceArgs, True)
            __props__.__dict__["databricks_address_space"] = databricks_address_space
            databricks_virtual_network = _utilities.configure(databricks_virtual_network, VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs, True)
            ...
            remote_virtual_network = _utilities.configure(remote_virtual_network, VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks/v20230201:vNetPeering"), pulumi.Alias(type_="azure-native:databricks:VNetPeering"), pulumi.Alias(type_="azure-native:databricks:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20180401:VNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20180401:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20210401preview:VNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20210401preview:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:VNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:vNetPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VNetPeering, __self__).__init__(
            'azure-native:databricks/v20230201:VNetPeering',
            resource_name,
            __props__,
            opts)
