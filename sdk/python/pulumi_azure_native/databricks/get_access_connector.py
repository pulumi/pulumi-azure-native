...
def get_access_connector(connector_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connector_name: The name of the Azure Databricks Access Connector.
...
def get_access_connector_output(connector_name: Optional[pulumi.Input[builtins.str]] = None,
