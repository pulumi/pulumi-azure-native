...
def get_access_connector(connector_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connector_name: The name of the Azure Databricks Access Connector.
...
def get_access_connector_output(connector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
