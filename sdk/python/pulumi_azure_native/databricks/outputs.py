...
class AccessConnectorPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 refered_by: Sequence[builtins.str]):
        """
        :param builtins.str provisioning_state: Provisioning status of the Access Connector.
        :param Sequence[builtins.str] refered_by: List of workspaces referring this Access Connector.
        """
    ...
    def refered_by(self) -> Sequence[builtins.str]:
        """
...
class AddressSpaceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        AddressSpace contains an array of IP address ranges that can be used by subnets of the virtual network.
        :param Sequence[builtins.str] address_prefixes: A list of address blocks reserved for this virtual network in CIDR notation.
        """
...
class ComplianceSecurityProfileDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Status of Compliance Security Profile feature.
        :param Sequence[builtins.str] compliance_standards: Compliance standards associated with the workspace.
        """
...
class CreatedByResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Provides details of the entity that created/updated the workspace.
        :param builtins.str application_id: The application ID of the application that initiated the creation of the workspace. For example, Azure Portal.
        :param builtins.str oid: The Object ID that created the workspace.
        :param builtins.str puid: The Personal Object ID corresponding to the object ID above
        """
...
class DefaultCatalogPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 initial_name: Optional[builtins.str] = None,
                 initial_type: Optional[builtins.str] = None):
        """
        These properties lets user specify default catalog properties during workspace creation.
        :param builtins.str initial_name: Specifies the initial Name of default catalog. If not specified, the name of the workspace will be used.
        :param builtins.str initial_type: Defines the initial type of the default catalog. Possible values (case-insensitive):  HiveMetastore, UnityCatalog
        """
    ...
    def initial_name(self) -> Optional[builtins.str]:
        """
    ...
    def initial_type(self) -> Optional[builtins.str]:
        """
...
class EncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_source: The encryption keySource (provider). Possible values (case-insensitive):  Default, Microsoft.Keyvault
...
class EncryptionV2Response(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The object that contains details of encryption used on the workspace.
        :param builtins.str key_source: The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Keyvault
...
class ManagedDiskEncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool rotation_to_latest_key_version_enabled: Indicate whether the latest key version should be automatically used for Managed Disk Encryption.
        """
        pulumi.set(__self__, "key_source", key_source)
        pulumi.set(__self__, "key_vault_properties", key_vault_properties)
...
class ManagedIdentityConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The Managed Identity details for storage account.
        :param builtins.str principal_id: The objectId of the Managed Identity that is linked to the Managed Storage account.
        :param builtins.str tenant_id: The tenant Id where the Managed Identity is created.
        :param builtins.str type: The type of Identity created. It can be either SystemAssigned or UserAssigned.
        """
...
class VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
         The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
        :param builtins.str id: The Id of the databricks virtual network.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
         The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
        :param builtins.str id: The Id of the remote virtual network.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class WorkspaceCustomBooleanParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The value which should be used for this field.
        :param builtins.str type: The type of variable that this is
        :param builtins.bool value: The value which should be used for this field.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class WorkspaceCustomStringParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        The Value.
        :param builtins.str type: The type of variable that this is
        :param builtins.str value: The value which should be used for this field.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class WorkspacePropertiesResponseAccessConnector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Access Connector Resource that is going to be associated with Databricks Workspace
        :param builtins.str id: The resource ID of Azure Databricks Access Connector Resource.
        :param builtins.str identity_type: The identity type of the Access Connector Resource.
        :param builtins.str user_assigned_identity_id: The resource ID of the User Assigned Identity associated with the Access Connector Resource. This is required for type 'UserAssigned' and not valid for type 'SystemAssigned'.
        """
        pulumi.set(__self__, "id", id)
...
class WorkspaceProviderAuthorizationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The workspace provider authorization.
        :param builtins.str principal_id: The provider's principal identifier. This is the identity that the provider will use to call ARM to manage the workspace resources.
        :param builtins.str role_definition_id: The provider's role definition identifier. This role will define all the permissions that the provider must have on the workspace's container resource group. This role definition cannot have permission to delete the resource group.
        """
        pulumi.set(__self__, "principal_id", principal_id)
