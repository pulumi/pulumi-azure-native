...
class AccessConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20220401preview:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20230501:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20240501:AccessConnector"), pulumi.Alias(type_="azure-native:databricks/v20240901preview:AccessConnector")])
