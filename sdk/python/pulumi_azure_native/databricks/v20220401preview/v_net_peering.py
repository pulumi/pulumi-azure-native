...
class VNetPeeringArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input['VirtualNetworkPeeringPropertiesFormatArgs'],
                 resource_group_name: pulumi.Input[str],
                 workspace_name: pulumi.Input[str],
                 peering_name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a VNetPeering resource.
        :param pulumi.Input['VirtualNetworkPeeringPropertiesFormatArgs'] properties: List of properties for vNet Peering
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['VirtualNetworkPeeringPropertiesFormatArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['VirtualNetworkPeeringPropertiesFormatArgs']):
...
class VNetPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 peering_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkPeeringPropertiesFormatArgs']]] = None,
        ...
        :param pulumi.Input[str] peering_name: The name of the workspace vNet peering.
        :param pulumi.Input[pulumi.InputType['VirtualNetworkPeeringPropertiesFormatArgs']] properties: List of properties for vNet Peering
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: The name of the workspace.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databricks:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20180401:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20210401preview:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/v20230201:vNetPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VNetPeering, __self__).__init__(
            'azure-native:databricks/v20220401preview:vNetPeering',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.VirtualNetworkPeeringPropertiesFormatResponse']:
        """
        List of properties for vNet Peering
        """
        return pulumi.get(self, "properties")
