...
__all__ = [
    ...
    'GitHubProviderProfileArgsDict',
    'GitHubRepositoryArgs',
    'GitHubRepositoryArgsDict',
    ...
    'OidcCredentialsArgs',
    'OidcCredentialsArgsDict',
    'StagePropertiesArgs',
    'StagePropertiesArgsDict',
    'TemplateReferenceArgs',
    'TemplateReferenceArgsDict',
    'TemplateWorkflowProfileArgs',
    'TemplateWorkflowProfileArgsDict',
...
if not MYPY:
    class ADOProviderProfileArgsDict(TypedDict):
        """
    ...
    ADOProviderProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ADOProviderProfileArgs:
    def __init__(__self__, *,
...
if not MYPY:
    class GitHubProviderProfileArgsDict(TypedDict):
        """
        Details of the GitHub repository and credentials associated with the workflow.
        """
        oidc_credentials: NotRequired[pulumi.Input['OidcCredentialsArgsDict']]
        """
        The fields needed for OIDC with GitHub.
        """
        repository: NotRequired[pulumi.Input['GitHubRepositoryArgsDict']]
        """
        Details of the GitHub repository associated with the workflow.
        """
elif False:
    GitHubProviderProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GitHubProviderProfileArgs:
    def __init__(__self__, *,
                 oidc_credentials: Optional[pulumi.Input['OidcCredentialsArgs']] = None,
                 repository: Optional[pulumi.Input['GitHubRepositoryArgs']] = None):
        """
        Details of the GitHub repository and credentials associated with the workflow.
        :param pulumi.Input['OidcCredentialsArgs'] oidc_credentials: The fields needed for OIDC with GitHub.
        :param pulumi.Input['GitHubRepositoryArgs'] repository: Details of the GitHub repository associated with the workflow.
        """
    ...
    def oidc_credentials(self) -> Optional[pulumi.Input['OidcCredentialsArgs']]:
        """
        The fields needed for OIDC with GitHub.
        """
    ...
    def oidc_credentials(self, value: Optional[pulumi.Input['OidcCredentialsArgs']]):
        pulumi.set(self, "oidc_credentials", value)

    @property
    @pulumi.getter
    def repository(self) -> Optional[pulumi.Input['GitHubRepositoryArgs']]:
        """
        Details of the GitHub repository associated with the workflow.
        """
        return pulumi.get(self, "repository")
    ...
    @repository.setter
    def repository(self, value: Optional[pulumi.Input['GitHubRepositoryArgs']]):
        pulumi.set(self, "repository", value)


if not MYPY:
    class GitHubRepositoryArgsDict(TypedDict):
        """
        Details of the GitHub repository associated with the workflow.
        """
        branch_name: NotRequired[pulumi.Input[str]]
    ...
    GitHubRepositoryArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class OidcCredentialsArgsDict(TypedDict):
        """
        The fields needed for OIDC with GitHub.
        """
        azure_client_id: NotRequired[pulumi.Input[str]]
    ...
    OidcCredentialsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class OidcCredentialsArgs:
    def __init__(__self__, *,
                 azure_client_id: Optional[pulumi.Input[str]] = None,
                 azure_tenant_id: Optional[pulumi.Input[str]] = None):
        """
...
if not MYPY:
    class TemplateReferenceArgsDict(TypedDict):
        """
    ...
    TemplateReferenceArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class TemplateReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        The properties of ADO OAuth.
        :param pulumi.Input[str] destination: destination for template creation
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] parameters: parameters for template creation
        :param pulumi.Input[str] template_id: The versioned template arm resource id.
        """
...
if not MYPY:
    class TemplateWorkflowProfileArgsDict(TypedDict):
        """
        Template Workflow Profile
        """
        ado_provider_profile: NotRequired[pulumi.Input['ADOProviderProfileArgsDict']]
        """
        Details of the GitHub repository associated with the workflow.
        """
        deployment_template: NotRequired[pulumi.Input['TemplateReferenceArgsDict']]
        """
        The properties of ADO OAuth.
        """
        dockerfile_template: NotRequired[pulumi.Input['TemplateReferenceArgsDict']]
        """
        The properties of ADO OAuth.
        """
        git_hub_provider_profile: NotRequired[pulumi.Input['GitHubProviderProfileArgsDict']]
        """
        Details of the GitHub repository and credentials associated with the workflow.
        """
        manifest_templates: NotRequired[pulumi.Input[Sequence[pulumi.Input['TemplateReferenceArgsDict']]]]
        repository_provider: NotRequired[pulumi.Input[Union[str, 'RepositoryProviderType']]]
        """
        The status of the Pull Request submitted against the users repository.
        """
        workflow_template: NotRequired[pulumi.Input['TemplateReferenceArgsDict']]
        """
        The properties of ADO OAuth.
        """
elif False:
    TemplateWorkflowProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class TemplateWorkflowProfileArgs:
    def __init__(__self__, *,
                 ado_provider_profile: Optional[pulumi.Input['ADOProviderProfileArgs']] = None,
                 deployment_template: Optional[pulumi.Input['TemplateReferenceArgs']] = None,
                 dockerfile_template: Optional[pulumi.Input['TemplateReferenceArgs']] = None,
                 git_hub_provider_profile: Optional[pulumi.Input['GitHubProviderProfileArgs']] = None,
                 manifest_templates: Optional[pulumi.Input[Sequence[pulumi.Input['TemplateReferenceArgs']]]] = None,
                 repository_provider: Optional[pulumi.Input[Union[str, 'RepositoryProviderType']]] = None,
                 workflow_template: Optional[pulumi.Input['TemplateReferenceArgs']] = None):
        """
        Template Workflow Profile
        :param pulumi.Input['ADOProviderProfileArgs'] ado_provider_profile: Details of the GitHub repository associated with the workflow.
        :param pulumi.Input['TemplateReferenceArgs'] deployment_template: The properties of ADO OAuth.
        :param pulumi.Input['TemplateReferenceArgs'] dockerfile_template: The properties of ADO OAuth.
        :param pulumi.Input['GitHubProviderProfileArgs'] git_hub_provider_profile: Details of the GitHub repository and credentials associated with the workflow.
        :param pulumi.Input[Union[str, 'RepositoryProviderType']] repository_provider: The status of the Pull Request submitted against the users repository.
        :param pulumi.Input['TemplateReferenceArgs'] workflow_template: The properties of ADO OAuth.
        """
    ...
    def ado_provider_profile(self) -> Optional[pulumi.Input['ADOProviderProfileArgs']]:
        """
        Details of the GitHub repository associated with the workflow.
        """
        return pulumi.get(self, "ado_provider_profile")

    @ado_provider_profile.setter
    def ado_provider_profile(self, value: Optional[pulumi.Input['ADOProviderProfileArgs']]):
        pulumi.set(self, "ado_provider_profile", value)

    @property
    @pulumi.getter(name="deploymentTemplate")
    def deployment_template(self) -> Optional[pulumi.Input['TemplateReferenceArgs']]:
        """
        The properties of ADO OAuth.
        """
    ...
    def deployment_template(self, value: Optional[pulumi.Input['TemplateReferenceArgs']]):
        pulumi.set(self, "deployment_template", value)

    @property
    @pulumi.getter(name="dockerfileTemplate")
    def dockerfile_template(self) -> Optional[pulumi.Input['TemplateReferenceArgs']]:
        """
        The properties of ADO OAuth.
        """
        return pulumi.get(self, "dockerfile_template")

    @dockerfile_template.setter
    def dockerfile_template(self, value: Optional[pulumi.Input['TemplateReferenceArgs']]):
        pulumi.set(self, "dockerfile_template", value)

    @property
    @pulumi.getter(name="gitHubProviderProfile")
    def git_hub_provider_profile(self) -> Optional[pulumi.Input['GitHubProviderProfileArgs']]:
        """
        Details of the GitHub repository and credentials associated with the workflow.
        """
        return pulumi.get(self, "git_hub_provider_profile")

    @git_hub_provider_profile.setter
    def git_hub_provider_profile(self, value: Optional[pulumi.Input['GitHubProviderProfileArgs']]):
        pulumi.set(self, "git_hub_provider_profile", value)

    @property
    @pulumi.getter(name="manifestTemplates")
    def manifest_templates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TemplateReferenceArgs']]]]:
        return pulumi.get(self, "manifest_templates")

    @manifest_templates.setter
    def manifest_templates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TemplateReferenceArgs']]]]):
        pulumi.set(self, "manifest_templates", value)

    @property
    @pulumi.getter(name="repositoryProvider")
    def repository_provider(self) -> Optional[pulumi.Input[Union[str, 'RepositoryProviderType']]]:
        """
        The status of the Pull Request submitted against the users repository.
        """
    ...
    def repository_provider(self, value: Optional[pulumi.Input[Union[str, 'RepositoryProviderType']]]):
        pulumi.set(self, "repository_provider", value)

    @property
    @pulumi.getter(name="workflowTemplate")
    def workflow_template(self) -> Optional[pulumi.Input['TemplateReferenceArgs']]:
        """
        The properties of ADO OAuth.
        """
    ...
    def workflow_template(self, value: Optional[pulumi.Input['TemplateReferenceArgs']]):
        pulumi.set(self, "workflow_template", value)
...
if not MYPY:
    class WorkflowPropertiesArgsDict(TypedDict):
        ...
        """
        template_workflow_profile: NotRequired[pulumi.Input['TemplateWorkflowProfileArgsDict']]
        """
...
class WorkflowPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 template_workflow_profile: Optional[pulumi.Input['TemplateWorkflowProfileArgs']] = None):
        """
        Workflow properties
        ...
        :param pulumi.Input['TemplateWorkflowProfileArgs'] template_workflow_profile: Profile of an template workflow.
        """
    ...
    def template_workflow_profile(self) -> Optional[pulumi.Input['TemplateWorkflowProfileArgs']]:
        """
        Profile of an template workflow.
        """
        return pulumi.get(self, "template_workflow_profile")

    @template_workflow_profile.setter
    def template_workflow_profile(self, value: Optional[pulumi.Input['TemplateWorkflowProfileArgs']]):
        pulumi.set(self, "template_workflow_profile", value)
