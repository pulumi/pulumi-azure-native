...
def get_iac_profile(iac_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devhub/v20250301preview:getIacProfile', __args__, opts=opts, typ=GetIacProfileResult).value
...
def get_iac_profile_output(iac_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devhub/v20250301preview:getIacProfile', __args__, opts=opts, typ=GetIacProfileResult)
