...
class IacProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devhub/v20240501preview:IacProfile"), pulumi.Alias(type_="azure-native:devhub/v20240801preview:IacProfile"), pulumi.Alias(type_="azure-native:devhub:IacProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IacProfile, __self__).__init__(
            'azure-native:devhub/v20250301preview:IacProfile',
            resource_name,
            __props__,
            opts)
