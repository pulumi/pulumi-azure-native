...
def get_adoo_auth_info(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devhub/v20250301preview:getADOOAuthInfo', __args__, opts=opts, typ=GetADOOAuthInfoResult).value
...
def get_adoo_auth_info_output(location: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devhub/v20250301preview:getADOOAuthInfo', __args__, opts=opts, typ=GetADOOAuthInfoResult)
