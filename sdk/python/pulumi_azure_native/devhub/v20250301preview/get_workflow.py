...
def get_workflow(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devhub/v20250301preview:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult).value
...
def get_workflow_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devhub/v20250301preview:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult)
