...
class Workflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workflow = azure_native.devhub.v20221011preview.Workflow("workflow",
            acr=azure_native.devhub.v20221011preview.ACRArgs(
            ...
            branch_name="branch1",
            deployment_properties=azure_native.devhub.v20221011preview.DeploymentPropertiesArgs(
            ...
            oidc_credentials=azure_native.devhub.v20221011preview.GitHubWorkflowProfileOidcCredentialsArgs(
        ...
        ```sh
        $ pulumi import azure-native:devhub/v20221011preview:Workflow workflow1 /subscription/subscriptionId1/resourceGroups/resourceGroup1/providers/Microsoft.DevHub/workflow/workflow1 
        ```
