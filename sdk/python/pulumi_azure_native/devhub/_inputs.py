...
class ACRArgs:
    def __init__(__self__, *,
                 acr_registry_name: Optional[pulumi.Input[_builtins.str]] = None,
                 acr_repository_name: Optional[pulumi.Input[_builtins.str]] = None,
                 acr_resource_group: Optional[pulumi.Input[_builtins.str]] = None,
...
class DeploymentPropertiesArgs:
    def __init__(__self__, *,
                 helm_chart_path: Optional[pulumi.Input[_builtins.str]] = None,
                 helm_values: Optional[pulumi.Input[_builtins.str]] = None,
                 kube_manifest_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 manifest_type: Optional[pulumi.Input[Union[_builtins.str, 'ManifestType']]] = None,
                 overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    def kube_manifest_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def manifest_type(self, value: Optional[pulumi.Input[Union[_builtins.str, 'ManifestType']]]):
    ...
    @overrides.setter
    def overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class GitHubWorkflowProfileArgs:
    def __init__(__self__, *,
                 ...
                 docker_build_context: Optional[pulumi.Input[_builtins.str]] = None,
...
class IacTemplateDetailsArgs:
    def __init__(__self__, *,
                 ...
                 naming_convention: Optional[pulumi.Input[_builtins.str]] = None,
...
class IacTemplatePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 instance_stage: Optional[pulumi.Input[_builtins.str]] = None,
                 quick_start_template_type: Optional[pulumi.Input[Union[_builtins.str, 'QuickStartTemplateType']]] = None,
    ...
    def quick_start_template_type(self, value: Optional[pulumi.Input[Union[_builtins.str, 'QuickStartTemplateType']]]):
...
class StagePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 git_environment: Optional[pulumi.Input[_builtins.str]] = None,
...
class WorkflowRunArgs:
    def __init__(__self__, *,
                 workflow_run_status: Optional[pulumi.Input[Union[_builtins.str, 'WorkflowRunStatus']]] = None):
        """
    ...
    def workflow_run_status(self, value: Optional[pulumi.Input[Union[_builtins.str, 'WorkflowRunStatus']]]):
