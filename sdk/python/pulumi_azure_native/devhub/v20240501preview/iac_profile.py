...
class IacProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devhub:IacProfile"), pulumi.Alias(type_="azure-native:devhub/v20240801preview:IacProfile")])
