...
class IacProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_account_name: Terraform Storage Account Name
        :param pulumi.Input[_builtins.str] storage_account_resource_group: Terraform Storage Account Resource Group
        :param pulumi.Input[_builtins.str] storage_account_subscription: Terraform Storage Account Subscription
...
class IacProfile(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="storageAccountResourceGroup")
    def storage_account_resource_group(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Terraform Storage Account Resource Group
        """
        return pulumi.get(self, "storage_account_resource_group")
    ...
    @_builtins.property
    @pulumi.getter(name="storageAccountSubscription")
    def storage_account_subscription(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Terraform Storage Account Subscription
        """
        return pulumi.get(self, "storage_account_subscription")
