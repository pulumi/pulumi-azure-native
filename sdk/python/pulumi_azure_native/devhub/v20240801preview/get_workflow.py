...
class GetWorkflowResult:
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.WorkflowPropertiesResponse':
        """
...
def get_workflow(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devhub/v20240801preview:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult).value
...
def get_workflow_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workflowName'] = workflow_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devhub/v20240801preview:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult)
