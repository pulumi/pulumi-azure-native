...
class Workflow(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(deployment_properties, DeploymentPropertiesArgs):
            ...
            if not isinstance(last_workflow_run, WorkflowRunArgs):
            ...
            if not isinstance(oidc_credentials, GitHubWorkflowProfileOidcCredentialsArgs):
