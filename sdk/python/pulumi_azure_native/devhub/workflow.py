...
class WorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dockerfile_output_directory: The directory to output the generated Dockerfile to.
        :param pulumi.Input[Union[_builtins.str, 'GenerationLanguage']] generation_language: The programming language used.
        :param pulumi.Input['GitHubWorkflowProfileArgs'] github_workflow_profile: Profile of a github workflow.
        :param pulumi.Input[_builtins.str] image_name: The name of the image to be generated.
        :param pulumi.Input[_builtins.str] image_tag: The tag to apply to the generated image.
        :param pulumi.Input[_builtins.str] language_version: The version of the language image used for execution in the generated dockerfile.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union[_builtins.str, 'ManifestGenerationMode']] manifest_generation_mode: The mode of generation to be used for generating Manifest.
        :param pulumi.Input[_builtins.str] manifest_output_directory: The directory to output the generated manifests to.
        :param pulumi.Input[Union[_builtins.str, 'GenerationManifestType']] manifest_type: Determines the type of manifests to be generated.
