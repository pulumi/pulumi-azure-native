...
def get_git_hub_o_auth(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devhub/v20230801:getGitHubOAuth', __args__, opts=opts, typ=GetGitHubOAuthResult).value
...
def get_git_hub_o_auth_output(location: Optional[pulumi.Input[str]] = None,
    ...
    __args__['redirectUrl'] = redirect_url
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devhub/v20230801:getGitHubOAuth', __args__, opts=opts, typ=GetGitHubOAuthResult)
