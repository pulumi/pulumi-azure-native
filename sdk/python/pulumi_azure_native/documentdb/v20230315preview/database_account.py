...
class DatabaseAccountArgs:
    ...
    def _configure(
        ...
        if 'diagnosticLogSettings' in kwargs:
        ...
        if 'enableBurstCapacity' in kwargs:
        ...
        if 'enableMaterializedViews' in kwargs:
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if diagnostic_log_settings is not None and not isinstance(diagnostic_log_settings, DiagnosticLogSettingsArgs):
                diagnostic_log_settings = diagnostic_log_settings or {}
                def _setter(key, value):
                    diagnostic_log_settings[key] = value
                DiagnosticLogSettingsArgs._configure(_setter, **diagnostic_log_settings)
        ...
        super(DatabaseAccount, __self__).__init__(
            'azure-native:documentdb/v20230315preview:DatabaseAccount',
            resource_name,
            __props__,
            opts)
