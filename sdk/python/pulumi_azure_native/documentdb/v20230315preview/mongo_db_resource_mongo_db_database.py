...
class MongoDBResourceMongoDBDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        MongoDBResourceMongoDBDatabaseArgs._configure(
...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MongoDBResourceMongoDBDatabaseArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if resource is not None and not isinstance(resource, MongoDBDatabaseResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                MongoDBDatabaseResourceArgs._configure(_setter, **resource)
        ...
        super(MongoDBResourceMongoDBDatabase, __self__).__init__(
            'azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBDatabase',
            resource_name,
            __props__,
            opts)
