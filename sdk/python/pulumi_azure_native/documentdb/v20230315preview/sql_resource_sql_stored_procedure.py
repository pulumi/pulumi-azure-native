...
class SqlResourceSqlStoredProcedureArgs:
    ...
    def _configure(
        ...
        if 'storedProcedureName' in kwargs:
...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if resource is not None and not isinstance(resource, SqlStoredProcedureResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                SqlStoredProcedureResourceArgs._configure(_setter, **resource)
