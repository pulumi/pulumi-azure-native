...
class SqlResourceSqlStoredProcedureArgs:
    def __init__(__self__, *,
        ...
        """
        SqlResourceSqlStoredProcedureArgs._configure(
    ...
    def _configure(
             ...
             resource: Optional[pulumi.Input['SqlStoredProcedureResourceArgs']] = None,
        ...
        if stored_procedure_name is None and 'storedProcedureName' in kwargs:
            stored_procedure_name = kwargs['storedProcedureName']
        ...
        if stored_procedure_name is not None:
            _setter("stored_procedure_name", stored_procedure_name)
        if tags is not None:
            _setter("tags", tags)
...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlResourceSqlStoredProcedureArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            resource = _utilities.configure(resource, SqlStoredProcedureResourceArgs, True)
        ...
        super(SqlResourceSqlStoredProcedure, __self__).__init__(
            'azure-native:documentdb/v20230315preview:SqlResourceSqlStoredProcedure',
            resource_name,
            __props__,
            opts)
