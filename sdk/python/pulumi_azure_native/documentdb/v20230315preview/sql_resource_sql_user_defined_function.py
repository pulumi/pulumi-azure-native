...
class SqlResourceSqlUserDefinedFunctionArgs:
    def __init__(__self__, *,
        ...
        """
        SqlResourceSqlUserDefinedFunctionArgs._configure(
    ...
    def _configure(
        ...
        if user_defined_function_name is not None:
            _setter("user_defined_function_name", user_defined_function_name)
...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlResourceSqlUserDefinedFunctionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(resource, SqlUserDefinedFunctionResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                SqlUserDefinedFunctionResourceArgs._configure(_setter, **resource)
