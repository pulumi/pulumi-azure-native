...
class SqlResourceSqlUserDefinedFunctionArgs:
    ...
    def _configure(
             ...
             resource: Optional[pulumi.Input['SqlUserDefinedFunctionResourceArgs']] = None,
        ...
        if user_defined_function_name is None and 'userDefinedFunctionName' in kwargs:
            user_defined_function_name = kwargs['userDefinedFunctionName']
...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            resource = _utilities.configure(resource, SqlUserDefinedFunctionResourceArgs, True)
