...
def get_gremlin_resource_gremlin_graph_output(account_name: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGremlinResourceGremlinGraphResult]:
    """
    Gets the Gremlin graph under an existing Azure Cosmos DB database account.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20210301preview:getGremlinResourceGremlinGraph', __args__, opts=opts, typ=GetGremlinResourceGremlinGraphResult)
    return __ret__.apply(lambda __response__: GetGremlinResourceGremlinGraphResult(
