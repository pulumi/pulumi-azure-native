...
def get_sql_resource_sql_stored_procedure(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_stored_procedure is deprecated: azure-native:documentdb/v20210301preview:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.""")
    __args__ = dict()
