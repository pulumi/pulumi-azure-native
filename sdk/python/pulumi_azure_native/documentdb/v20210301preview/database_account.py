...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: Optional[pulumi.Input[Union[str, 'DatabaseAccountKind']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union[Union['DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs', 'DefaultRequestDatabaseAccountCreateUpdatePropertiesArgsDict'], Union['RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs', 'RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgsDict']]]] = None,
        ...
        :param pulumi.Input[Union[str, 'DatabaseAccountKind']] kind: Indicates the type of database account. This can only be set at database account creation.
        :param pulumi.Input[str] location: The location of the resource group to which the resource belongs.
        :param pulumi.Input[Union[Union['DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs', 'DefaultRequestDatabaseAccountCreateUpdatePropertiesArgsDict'], Union['RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs', 'RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgsDict']]] properties: Properties to create and update Azure Cosmos DB database accounts.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
        """
        ...
