...
warnings.warn("""azure-native:documentdb/v20210301preview:DatabaseAccount is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20210401preview:DatabaseAccount to guarantee forwards compatibility.""", DeprecationWarning)
