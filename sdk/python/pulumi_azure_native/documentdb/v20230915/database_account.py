...
class DatabaseAccountArgs:
    def __init__(__self__, *,
        ...
        DatabaseAccountArgs._configure(
            ...
            customer_managed_key_status=customer_managed_key_status,
    ...
    def _configure(
        ...
        if customer_managed_key_status is None and 'customerManagedKeyStatus' in kwargs:
            customer_managed_key_status = kwargs['customerManagedKeyStatus']
        ...
        if customer_managed_key_status is not None:
            _setter("customer_managed_key_status", customer_managed_key_status)
    ...
    def customer_managed_key_status(self) -> Optional[pulumi.Input[Union[str, 'CustomerManagedKeyStatus']]]:
        """
    ...
    def customer_managed_key_status(self, value: Optional[pulumi.Input[Union[str, 'CustomerManagedKeyStatus']]]):
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DatabaseAccount, __self__).__init__(
            'azure-native:documentdb/v20230915:DatabaseAccount',
            resource_name,
            __props__,
            opts)
