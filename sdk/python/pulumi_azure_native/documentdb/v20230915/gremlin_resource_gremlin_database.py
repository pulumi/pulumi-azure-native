...
class GremlinResourceGremlinDatabaseArgs:
    ...
    def _configure(
             ...
             resource: Optional[pulumi.Input['GremlinDatabaseResourceArgs']] = None,
...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            options = _utilities.configure(options, CreateUpdateOptionsArgs, True)
            __props__.__dict__["options"] = options
            resource = _utilities.configure(resource, GremlinDatabaseResourceArgs, True)
