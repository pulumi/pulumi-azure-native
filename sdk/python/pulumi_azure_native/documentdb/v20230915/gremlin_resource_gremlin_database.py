...
class GremlinResourceGremlinDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        GremlinResourceGremlinDatabaseArgs._configure(
...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            GremlinResourceGremlinDatabaseArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if options is not None and not isinstance(options, CreateUpdateOptionsArgs):
                options = options or {}
                def _setter(key, value):
                    options[key] = value
                CreateUpdateOptionsArgs._configure(_setter, **options)
            __props__.__dict__["options"] = options
            if resource is not None and not isinstance(resource, GremlinDatabaseResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                GremlinDatabaseResourceArgs._configure(_setter, **resource)
