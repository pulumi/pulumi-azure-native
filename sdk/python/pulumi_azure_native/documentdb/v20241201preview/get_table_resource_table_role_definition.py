...
def get_table_resource_table_role_definition(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20241201preview:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult).value
...
def get_table_resource_table_role_definition_output(account_name: Optional[pulumi.Input[str]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetTableResourceTableRoleDefinitionResult]:
    """
    Retrieves the properties of an existing Azure Cosmos DB Table Role Definition with the given Id.
    ...
    __args__['roleDefinitionId'] = role_definition_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20241201preview:getTableResourceTableRoleDefinition', __args__, opts=opts, typ=GetTableResourceTableRoleDefinitionResult)
