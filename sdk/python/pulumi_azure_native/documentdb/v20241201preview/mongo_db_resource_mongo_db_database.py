...
__all__ = ['MongoDBResourceMongoDBDatabaseArgs', 'MongoDBResourceMongoDBDatabase']
...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MongoDBResourceMongoDBDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MongoDBResourceMongoDBDatabaseArgs.__new__(MongoDBResourceMongoDBDatabaseArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MongoDBResourceMongoDBDatabase':
        """
    ...
    @property
    @pulumi.getter
    def options(self) -> pulumi.Output[Optional['outputs.MongoDBDatabaseGetPropertiesResponseOptions']]:
        return pulumi.get(self, "options")

    @property
    @pulumi.getter
    def resource(self) -> pulumi.Output[Optional['outputs.MongoDBDatabaseGetPropertiesResponseResource']]:
        return pulumi.get(self, "resource")
