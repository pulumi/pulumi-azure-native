...
class GetDatabaseAccountResult:
    ...
    def __init__(__self__, analytical_storage_configuration=None, api_properties=None, backup_policy=None, capabilities=None, capacity=None, capacity_mode=None, capacity_mode_change_transition_state=None, connector_offer=None, consistency_policy=None, cors=None, create_mode=None, customer_managed_key_status=None, database_account_offer_type=None, default_identity=None, default_priority_level=None, diagnostic_log_settings=None, disable_key_based_metadata_write_access=None, disable_local_auth=None, document_endpoint=None, enable_analytical_storage=None, enable_automatic_failover=None, enable_burst_capacity=None, enable_cassandra_connector=None, enable_free_tier=None, enable_materialized_views=None, enable_multiple_write_locations=None, enable_partition_merge=None, enable_per_region_per_partition_autoscale=None, enable_priority_based_execution=None, failover_policies=None, id=None, identity=None, instance_id=None, ip_rules=None, is_virtual_network_filter_enabled=None, key_vault_key_uri=None, keys_metadata=None, kind=None, location=None, locations=None, minimal_tls_version=None, name=None, network_acl_bypass=None, network_acl_bypass_resource_ids=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, read_locations=None, restore_parameters=None, system_data=None, tags=None, type=None, virtual_network_rules=None, write_locations=None):
        ...
        if capacity_mode_change_transition_state and not isinstance(capacity_mode_change_transition_state, dict):
            raise TypeError("Expected argument 'capacity_mode_change_transition_state' to be a dict")
        pulumi.set(__self__, "capacity_mode_change_transition_state", capacity_mode_change_transition_state)
    ...
    @property
    @pulumi.getter(name="capacityModeChangeTransitionState")
    def capacity_mode_change_transition_state(self) -> Optional['outputs.CapacityModeChangeTransitionStateResponse']:
        """
        The object that represents the migration state for the CapacityMode of the Cosmos DB account.
        """
        return pulumi.get(self, "capacity_mode_change_transition_state")
...
class AwaitableGetDatabaseAccountResult(GetDatabaseAccountResult):
    ...
    def __await__(self):
        ...
        return GetDatabaseAccountResult(
            ...
            capacity_mode_change_transition_state=self.capacity_mode_change_transition_state,
...
def get_database_account(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20241201preview:getDatabaseAccount', __args__, opts=opts, typ=GetDatabaseAccountResult).value
    ...
    return AwaitableGetDatabaseAccountResult(
        ...
        capacity_mode_change_transition_state=pulumi.get(__ret__, 'capacity_mode_change_transition_state'),
...
def get_database_account_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDatabaseAccountResult(
        ...
        capacity_mode_change_transition_state=pulumi.get(__response__, 'capacity_mode_change_transition_state'),
