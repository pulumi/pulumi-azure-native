...
class TableResourceTableRoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:TableResourceTableRoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableResourceTableRoleAssignment, __self__).__init__(
            'azure-native:documentdb/v20241201preview:TableResourceTableRoleAssignment',
            resource_name,
            __props__,
            opts)
