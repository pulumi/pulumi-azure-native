...
def get_throughput_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20241201preview:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult).value
...
def get_throughput_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetThroughputPoolResult]:
    """
    Retrieves the properties of an existing Azure Cosmos DB Throughput Pool
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20241201preview:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult)
    return __ret__.apply(lambda __response__: GetThroughputPoolResult(
