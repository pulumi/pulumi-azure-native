...
warnings.warn("""azure-native:documentdb/v20210515:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_resource_sql_user_defined_function(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_user_defined_function is deprecated: azure-native:documentdb/v20210515:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20210515:getSqlResourceSqlUserDefinedFunction', __args__, opts=opts, typ=GetSqlResourceSqlUserDefinedFunctionResult).value
