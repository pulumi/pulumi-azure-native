...
class CassandraResourceCassandraView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20210701preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20211115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20220215preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20220515preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20230301preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb:CassandraResourceCassandraView")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraResourceCassandraView, __self__).__init__(
            'azure-native:documentdb/v20230915preview:CassandraResourceCassandraView',
            resource_name,
            __props__,
            opts)
