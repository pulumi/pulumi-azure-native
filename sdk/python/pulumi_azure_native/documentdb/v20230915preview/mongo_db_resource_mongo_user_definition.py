...
class MongoDBResourceMongoUserDefinitionArgs:
    ...
    def _configure(
        ...
        if mongo_user_definition_id is None and 'mongoUserDefinitionId' in kwargs:
            mongo_user_definition_id = kwargs['mongoUserDefinitionId']
