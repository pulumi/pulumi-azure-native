...
warnings.warn("""azure-native:documentdb/v20210401preview:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.""", DeprecationWarning)
