...
def get_mongo_db_resource_mongo_db_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mongo_db_resource_mongo_db_database is deprecated: azure-native:documentdb/v20210401preview:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
