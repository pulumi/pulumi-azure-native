...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:documentdb/v20210401preview:CassandraCluster":
                return CassandraCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:CassandraDataCenter":
                return CassandraDataCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:CassandraResourceCassandraKeyspace":
                return CassandraResourceCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:CassandraResourceCassandraTable":
                return CassandraResourceCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:GremlinResourceGremlinDatabase":
                return GremlinResourceGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:GremlinResourceGremlinGraph":
                return GremlinResourceGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:MongoDBResourceMongoDBCollection":
                return MongoDBResourceMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:MongoDBResourceMongoDBDatabase":
                return MongoDBResourceMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:NotebookWorkspace":
                return NotebookWorkspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:Service":
                return Service(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlContainer":
                return SqlResourceSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlDatabase":
                return SqlResourceSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlRoleAssignment":
                return SqlResourceSqlRoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlRoleDefinition":
                return SqlResourceSqlRoleDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlStoredProcedure":
                return SqlResourceSqlStoredProcedure(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger":
                return SqlResourceSqlTrigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:SqlResourceSqlUserDefinedFunction":
                return SqlResourceSqlUserDefinedFunction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20210401preview:TableResourceTable":
    ...
    pulumi.runtime.register_resource_module("azure-native", "documentdb/v20210401preview", _module_instance)
