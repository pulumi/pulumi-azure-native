...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        graph_resource_graph = azure_native.documentdb.v20221115preview.GraphResourceGraph("graphResourceGraph",
            account_name="ddb1",
            graph_name="graphName",
            location="West US",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.GraphResourceArgs(
                id="graphName",
            ),
