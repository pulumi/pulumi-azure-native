...
class CassandraResourceCassandraView(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_view = azure_native.documentdb.v20221115preview.CassandraResourceCassandraView("cassandraResourceCassandraView",
            account_name="ddb1",
            keyspace_name="keyspacename",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.CassandraViewResourceArgs(
                id="viewname",
    ...
    def _internal_init(__self__,
        ...
        super(CassandraResourceCassandraView, __self__).__init__(
            'azure-native:documentdb/v20221115preview:CassandraResourceCassandraView',
            resource_name,
            __props__,
            opts)
