...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_user_defined_function = azure_native.documentdb.v20221115preview.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.SqlUserDefinedFunctionResourceArgs(
                body="body",
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20221115preview:SqlResourceSqlUserDefinedFunction userDefinedFunctionName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/sqlContainers/containerName/sqlUserDefinedFunctions/userDefinedFunctionName 
        ```
