...
class MongoDBResourceMongoRoleDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_role_definition = azure_native.documentdb.v20221115preview.MongoDBResourceMongoRoleDefinition("mongoDBResourceMongoRoleDefinition",
            ...
            privileges=[{
                ...
                "resource": azure_native.documentdb.v20221115preview.PrivilegeResourceArgs(
                    collection="sales",
                    db="sales",
                ),
            }],
