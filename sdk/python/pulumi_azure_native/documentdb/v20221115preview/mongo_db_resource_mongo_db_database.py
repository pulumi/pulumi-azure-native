...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_database = azure_native.documentdb.v20221115preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase",
            account_name="ddb1",
            database_name="databaseName",
            location="West US",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.MongoDBDatabaseResourceArgs(
                id="databaseName",
            ),
        ...
        mongo_db_resource_mongo_db_database = azure_native.documentdb.v20221115preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase",
            ...
            location="West US",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.MongoDBDatabaseGetPropertiesResponseResourceArgs(
                create_mode="Restore",
                id="databaseName",
                restore_parameters=azure_native.documentdb.v20221115preview.ResourceRestoreParametersArgs(
    ...
    def _internal_init(__self__,
        ...
        super(MongoDBResourceMongoDBDatabase, __self__).__init__(
            'azure-native:documentdb/v20221115preview:MongoDBResourceMongoDBDatabase',
            resource_name,
            __props__,
            opts)
