...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_container = azure_native.documentdb.v20221115preview.SqlResourceSqlContainer("sqlResourceSqlContainer",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            location="West US",
            options=azure_native.documentdb.v20221115preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20221115preview.SqlContainerGetPropertiesResponseResourceArgs(
                client_encryption_policy=azure_native.documentdb.v20221115preview.ClientEncryptionPolicyArgs(
                    included_paths=[azure_native.documentdb.v20221115preview.ClientEncryptionIncludedPathArgs(
