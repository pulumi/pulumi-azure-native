...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20210315:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20230301preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20230315:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:SqlResourceSqlTrigger"), pulumi.Alias(type_="azure-native:documentdb/v20230415:SqlResourceSqlTrigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlResourceSqlTrigger, __self__).__init__(
            'azure-native:documentdb/v20221115preview:SqlResourceSqlTrigger',
            resource_name,
            __props__,
            opts)
