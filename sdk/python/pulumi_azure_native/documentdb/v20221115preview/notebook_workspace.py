...
class NotebookWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        notebook_workspace = azure_native.documentdb.v20221115preview.NotebookWorkspace("notebookWorkspace",
            account_name="ddb1",
