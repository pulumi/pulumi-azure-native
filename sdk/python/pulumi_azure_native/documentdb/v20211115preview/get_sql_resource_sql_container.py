...
warnings.warn("""azure-native:documentdb/v20211115preview:SqlResourceSqlContainer is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_resource_sql_container(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20211115preview:getSqlResourceSqlContainer', __args__, opts=opts, typ=GetSqlResourceSqlContainerResult).value
