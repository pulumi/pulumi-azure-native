...
def get_sql_resource_sql_container_output(account_name: Optional[pulumi.Input[str]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSqlResourceSqlContainerResult]:
    """
    Gets the SQL container under an existing Azure Cosmos DB database account.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20211115preview:getSqlResourceSqlContainer', __args__, opts=opts, typ=GetSqlResourceSqlContainerResult)
