...
def get_graph_resource_graph_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20211115preview:getGraphResourceGraph', __args__, opts=opts, typ=GetGraphResourceGraphResult)
