...
warnings.warn("""azure-native:documentdb/v20211115preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cassandra_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_cluster is deprecated: azure-native:documentdb/v20211115preview:CassandraCluster is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.""")
    __args__ = dict()
