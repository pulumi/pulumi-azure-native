...
warnings.warn("""azure-native:documentdb/v20211115preview:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cassandra_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_cluster is deprecated: azure-native:documentdb/v20211115preview:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:CassandraCluster to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20211115preview:getCassandraCluster', __args__, opts=opts, typ=GetCassandraClusterResult).value
