...
warnings.warn("""azure-native:documentdb/v20211115preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:CassandraResourceCassandraTable to guarantee forwards compatibility.""", DeprecationWarning)
