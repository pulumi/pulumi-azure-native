...
def get_mongo_db_resource_mongo_db_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mongo_db_resource_mongo_db_database is deprecated: Version v20200601preview will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
