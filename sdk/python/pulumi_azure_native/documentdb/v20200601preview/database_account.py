...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_account = azure_native.documentdb.v20200601preview.DatabaseAccount("databaseAccount",
            account_name="ddb1",
            identity=azure_native.documentdb.v20200601preview.ManagedServiceIdentityArgs(
                type=azure_native.documentdb/v20200601preview.ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED,
            ...
            kind="MongoDB",
            location="westus",
            properties=azure_native.documentdb.v20200601preview.DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs(
                api_properties=azure_native.documentdb.v20200601preview.ApiPropertiesArgs(
                    server_version="3.2",
                ),
                backup_policy=azure_native.documentdb.v20200601preview.PeriodicModeBackupPolicyArgs(
                    periodic_mode_properties=azure_native.documentdb.v20200601preview.PeriodicModePropertiesArgs(
                ...
                consistency_policy=azure_native.documentdb.v20200601preview.ConsistencyPolicyArgs(
                    default_consistency_level=azure_native.documentdb/v20200601preview.DefaultConsistencyLevel.BOUNDED_STALENESS,
                    max_interval_in_seconds=10,
                    max_staleness_prefix=200,
                ),
                cors=[azure_native.documentdb.v20200601preview.CorsPolicyArgs(
                    allowed_origins="https://test",
                )],
                create_mode="Default",
                database_account_offer_type=azure_native.documentdb/v20200601preview.DatabaseAccountOfferType.STANDARD,
                enable_analytical_storage=True,
                enable_free_tier=False,
                ip_rules=[
                    azure_native.documentdb.v20200601preview.IpAddressOrRangeArgs(
                ...
                locations=[
                    azure_native.documentdb.v20200601preview.LocationArgs(
                        failover_priority=0,
                ...
                virtual_network_rules=[azure_native.documentdb.v20200601preview.VirtualNetworkRuleArgs(
        ...
        database_account = azure_native.documentdb.v20200601preview.DatabaseAccount("databaseAccount",
            ...
            properties=azure_native.documentdb.v20200601preview.DefaultRequestDatabaseAccountCreateUpdatePropertiesArgs(
                create_mode="Default",
                database_account_offer_type=azure_native.documentdb/v20200601preview.DatabaseAccountOfferType.STANDARD,
                locations=[azure_native.documentdb.v20200601preview.LocationArgs(
                    failover_priority=0,
                    is_zone_redundant=False,
                    location_name="southcentralus",
                )],
        ...
        database_account = azure_native.documentdb.v20200601preview.DatabaseAccount("databaseAccount",
            ...
            kind="GlobalDocumentDB",
            location="westus",
            properties=azure_native.documentdb.v20200601preview.RestoreReqeustDatabaseAccountCreateUpdatePropertiesArgs(
                api_properties=azure_native.documentdb.v20200601preview.ApiPropertiesArgs(
                    server_version="3.2",
                ),
                backup_policy=azure_native.documentdb.v20200601preview.ContinuousModeBackupPolicyArgs(
                    type="Continuous",
                ),
                consistency_policy=azure_native.documentdb.v20200601preview.ConsistencyPolicyArgs(
                    default_consistency_level=azure_native.documentdb/v20200601preview.DefaultConsistencyLevel.BOUNDED_STALENESS,
                ...
                restore_parameters=azure_native.documentdb.v20200601preview.RestoreParametersArgs(
                    databases_to_restore=[
                        azure_native.documentdb.v20200601preview.DatabaseRestoreResourceArgs(
                            collection_names=[
                                "collection1",
                                "collection2",
                            ],
                    ...
                    restore_timestamp_in_utc="2020-06-11T22:05:09Z",
                ),
            ),
            resource_group_name="rg1",
            tags={})
