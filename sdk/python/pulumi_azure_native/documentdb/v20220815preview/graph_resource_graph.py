...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:GraphResourceGraph"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:GraphResourceGraph"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:GraphResourceGraph"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:GraphResourceGraph"), pulumi.Alias(type_="azure-native:documentdb/v20230301preview:GraphResourceGraph"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:GraphResourceGraph")])
