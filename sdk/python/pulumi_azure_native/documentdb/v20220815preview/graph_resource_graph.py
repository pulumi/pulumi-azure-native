...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        graph_resource_graph = azure_native.documentdb.v20220815preview.GraphResourceGraph("graphResourceGraph",
            account_name="ddb1",
            graph_name="graphName",
            location="West US",
            options=azure_native.documentdb.v20220815preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20220815preview.GraphResourceArgs(
                id="graphName",
            ),
