...
class TableResourceTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        table_resource_table = azure_native.documentdb.v20220815preview.TableResourceTable("tableResourceTable",
            account_name="ddb1",
            location="West US",
            options=azure_native.documentdb.v20220815preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20220815preview.TableResourceArgs(
                id="tableName",
            ),
