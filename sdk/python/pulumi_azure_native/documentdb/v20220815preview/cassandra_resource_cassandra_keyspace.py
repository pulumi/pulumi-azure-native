...
class CassandraResourceCassandraKeyspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_keyspace = azure_native.documentdb.v20220815preview.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace",
            account_name="ddb1",
            keyspace_name="keyspaceName",
            location="West US",
            options=azure_native.documentdb.v20220815preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20220815preview.CassandraKeyspaceResourceArgs(
                id="keyspaceName",
            ),
