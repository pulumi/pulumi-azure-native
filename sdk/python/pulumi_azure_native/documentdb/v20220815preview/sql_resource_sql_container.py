...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_container = azure_native.documentdb.v20220815preview.SqlResourceSqlContainer("sqlResourceSqlContainer",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            location="West US",
            options=azure_native.documentdb.v20220815preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20220815preview.SqlContainerGetPropertiesResponseResourceArgs(
                client_encryption_policy=azure_native.documentdb.v20220815preview.ClientEncryptionPolicyArgs(
                    included_paths=[azure_native.documentdb.v20220815preview.ClientEncryptionIncludedPathArgs(
                ...
                conflict_resolution_policy=azure_native.documentdb.v20220815preview.ConflictResolutionPolicyArgs(
                ...
                indexing_policy={
                    ...
                    "includedPaths": [{
                        "indexes": [
                            azure_native.documentdb.v20220815preview.IndexesArgs(
                                data_type="String",
                                kind="Range",
                                precision=-1,
                            ),
                ...
                partition_key=azure_native.documentdb.v20220815preview.ContainerPartitionKeyArgs(
                    kind="Hash",
                    paths=["/AccountNumber"],
                ),
                unique_key_policy={
                    "uniqueKeys": [azure_native.documentdb.v20220815preview.UniqueKeyArgs(
                        paths=["/testPath"],
                    )],
                },
            ),
