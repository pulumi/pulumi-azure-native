...
__all__ = [
    ...
    'CassandraViewCreateUpdatePropertiesArgs',
    ...
    'ExcludedPathArgs',
    'GraphResourceCreateUpdatePropertiesArgs',
    'GraphResourceArgs',
...
@pulumi.input_type
class CassandraViewCreateUpdatePropertiesArgs:
    def __init__(__self__, *,
...
class ClientEncryptionPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] policy_format_version: Version of the client encryption policy definition. Please note, user passed value is ignored. Default policy version is 1.
        """
    ...
    def policy_format_version(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def policy_format_version(self, value: Optional[pulumi.Input[int]]):
...
@pulumi.input_type
class GraphResourceCreateUpdatePropertiesArgs:
    def __init__(__self__, *,
