...
def get_service(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: azure-native:documentdb/v20220815preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:Service to guarantee forwards compatibility.""")
    __args__ = dict()
