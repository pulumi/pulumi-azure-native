...
warnings.warn("""azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlResourceSqlRoleDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SqlResourceSqlRoleDefinition, __self__).__init__(
            'azure-native:documentdb/v20220815preview:SqlResourceSqlRoleDefinition',
            resource_name,
            __props__,
            opts)
