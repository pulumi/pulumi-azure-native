...
def get_graph_resource_graph(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_graph_resource_graph is deprecated: azure-native:documentdb/v20220815preview:GraphResourceGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GraphResourceGraph to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['graphName'] = graph_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20220815preview:getGraphResourceGraph', __args__, opts=opts, typ=GetGraphResourceGraphResult).value
