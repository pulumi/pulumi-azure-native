...
warnings.warn("""azure-native:documentdb/v20220815preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
