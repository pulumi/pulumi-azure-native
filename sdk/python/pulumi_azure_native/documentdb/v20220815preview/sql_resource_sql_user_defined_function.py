...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_user_defined_function = azure_native.documentdb.v20220815preview.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options=azure_native.documentdb.v20220815preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20220815preview.SqlUserDefinedFunctionResourceArgs(
                body="body",
