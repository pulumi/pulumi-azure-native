...
warnings.warn("""azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlTrigger to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trigger_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlTrigger is deprecated: azure-native:documentdb/v20220815preview:SqlResourceSqlTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlTrigger to guarantee forwards compatibility.""")
