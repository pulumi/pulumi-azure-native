...
def get_database_account_sql_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_sql_container is deprecated: Version v20150408 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
