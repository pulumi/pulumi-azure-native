...
class DatabaseAccountCassandraTable(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20151106:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountCassandraTable")])
