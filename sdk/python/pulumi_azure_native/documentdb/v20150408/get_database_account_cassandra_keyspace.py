...
azure-native:documentdb/v20150408:DatabaseAccountCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountCassandraKeyspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database_account_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_cassandra_keyspace is deprecated: Version 2015-04-08 will be removed in v2 of the provider.
azure-native:documentdb/v20150408:DatabaseAccountCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountCassandraKeyspace to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20150408:getDatabaseAccountCassandraKeyspace', __args__, opts=opts, typ=GetDatabaseAccountCassandraKeyspaceResult).value
