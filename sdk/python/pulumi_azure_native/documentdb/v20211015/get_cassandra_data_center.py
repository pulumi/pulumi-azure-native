...
warnings.warn("""azure-native:documentdb/v20211015:CassandraDataCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraDataCenter to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cassandra_data_center(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_data_center is deprecated: azure-native:documentdb/v20211015:CassandraDataCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraDataCenter to guarantee forwards compatibility.""")
    __args__ = dict()
