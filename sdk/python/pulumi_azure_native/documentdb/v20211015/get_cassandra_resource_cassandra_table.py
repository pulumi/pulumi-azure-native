...
def get_cassandra_resource_cassandra_table(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_resource_cassandra_table is deprecated: azure-native:documentdb/v20211015:CassandraResourceCassandraTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraTable to guarantee forwards compatibility.""")
    __args__ = dict()
