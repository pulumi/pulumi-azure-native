...
warnings.warn("""azure-native:documentdb/v20211015:SqlResourceSqlContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_resource_sql_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_container is deprecated: azure-native:documentdb/v20211015:SqlResourceSqlContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlContainer to guarantee forwards compatibility.""")
    __args__ = dict()
