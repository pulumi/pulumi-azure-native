...
class TableResourceTableRoleDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] assignable_scopes: A set of fully qualified Scopes at or below which Table Role Assignments may be created using this Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Must have at least one element. Scopes higher than Database account are not enforceable as assignable Scopes. Note that resources referenced in assignable Scopes need not exist.
...
class TableResourceTableRoleDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TableResourceTableRoleDefinitionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TableResourceTableRoleDefinitionArgs.__new__(TableResourceTableRoleDefinitionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableResourceTableRoleDefinition, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TableResourceTableRoleDefinition':
        """
        ...
        return TableResourceTableRoleDefinition(resource_name, opts=opts, __props__=__props__)
