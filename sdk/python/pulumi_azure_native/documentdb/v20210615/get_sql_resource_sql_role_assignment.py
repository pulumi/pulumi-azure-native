...
def get_sql_resource_sql_role_assignment(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_role_assignment is deprecated: azure-native:documentdb/v20210615:SqlResourceSqlRoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment to guarantee forwards compatibility.""")
    __args__ = dict()
