...
def get_cassandra_resource_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_resource_cassandra_keyspace is deprecated: azure-native:documentdb/v20210615:CassandraResourceCassandraKeyspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:CassandraResourceCassandraKeyspace to guarantee forwards compatibility.""")
    __args__ = dict()
