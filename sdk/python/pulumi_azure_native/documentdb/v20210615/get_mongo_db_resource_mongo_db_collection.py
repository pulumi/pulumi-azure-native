...
warnings.warn("""azure-native:documentdb/v20210615:MongoDBResourceMongoDBCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_mongo_db_resource_mongo_db_collection(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mongo_db_resource_mongo_db_collection is deprecated: azure-native:documentdb/v20210615:MongoDBResourceMongoDBCollection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBCollection to guarantee forwards compatibility.""")
    __args__ = dict()
