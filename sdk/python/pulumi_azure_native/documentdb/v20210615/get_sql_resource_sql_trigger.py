...
def get_sql_resource_sql_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_trigger is deprecated: azure-native:documentdb/v20210615:SqlResourceSqlTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
