...
warnings.warn("""azure-native:documentdb/v20210615:NotebookWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_notebook_workspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_notebook_workspace is deprecated: azure-native:documentdb/v20210615:NotebookWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.""")
    __args__ = dict()
