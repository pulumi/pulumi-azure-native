...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_defined_function_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlUserDefinedFunction is deprecated: azure-native:documentdb/v20210615:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.""")
