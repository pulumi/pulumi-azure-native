...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20240301preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20240701:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20241001preview:PrivateEndpointConnection")])
