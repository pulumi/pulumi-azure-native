...
class CassandraCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if identity is not None and not isinstance(identity, ManagedCassandraManagedServiceIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                ManagedCassandraManagedServiceIdentityArgs._configure(_setter, **identity)
        ...
        super(CassandraCluster, __self__).__init__(
            'azure-native:documentdb/v20230415:CassandraCluster',
            resource_name,
            __props__,
            opts)
