...
class CassandraDataCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20230301preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20230315:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:CassandraDataCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraDataCenter, __self__).__init__(
            'azure-native:documentdb/v20230415:CassandraDataCenter',
            resource_name,
            __props__,
            opts)
