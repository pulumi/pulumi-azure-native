...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if private_endpoint is not None and not isinstance(private_endpoint, PrivateEndpointPropertyArgs):
            ...
            if private_link_service_connection_state is not None and not isinstance(private_link_service_connection_state, PrivateLinkServiceConnectionStatePropertyArgs):
