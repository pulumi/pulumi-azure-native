...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(private_endpoint, PrivateEndpointPropertyArgs):
                private_endpoint = private_endpoint or {}
                def _setter(key, value):
                    private_endpoint[key] = value
                PrivateEndpointPropertyArgs._configure(_setter, **private_endpoint)
            __props__.__dict__["private_endpoint"] = private_endpoint
            __props__.__dict__["private_endpoint_connection_name"] = private_endpoint_connection_name
            if not isinstance(private_link_service_connection_state, PrivateLinkServiceConnectionStatePropertyArgs):
                ...
                PrivateLinkServiceConnectionStatePropertyArgs._configure(_setter, **private_link_service_connection_state)
