...
class SqlResourceSqlTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        SqlResourceSqlTriggerArgs._configure(
...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlResourceSqlTriggerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(resource, SqlTriggerResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                SqlTriggerResourceArgs._configure(_setter, **resource)
