...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20241001preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
...
def get_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20241001preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult)
