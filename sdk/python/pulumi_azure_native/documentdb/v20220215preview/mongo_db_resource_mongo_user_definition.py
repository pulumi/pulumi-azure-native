...
warnings.warn("""azure-native:documentdb/v20220215preview:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.""", DeprecationWarning)
