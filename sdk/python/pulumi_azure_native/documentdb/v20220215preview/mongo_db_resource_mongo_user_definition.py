...
warnings.warn("""azure-native:documentdb/v20220215preview:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.""", DeprecationWarning)
