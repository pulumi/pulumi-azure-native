...
warnings.warn("""azure-native:documentdb/v20220215preview:TableResourceTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:TableResourceTable to guarantee forwards compatibility.""", DeprecationWarning)
...
class TableResourceTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""TableResourceTable is deprecated: azure-native:documentdb/v20220215preview:TableResourceTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:TableResourceTable to guarantee forwards compatibility.""")
