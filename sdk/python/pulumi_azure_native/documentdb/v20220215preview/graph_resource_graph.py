...
warnings.warn("""azure-native:documentdb/v20220215preview:GraphResourceGraph is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GraphResourceGraph to guarantee forwards compatibility.""", DeprecationWarning)
...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""GraphResourceGraph is deprecated: azure-native:documentdb/v20220215preview:GraphResourceGraph is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GraphResourceGraph to guarantee forwards compatibility.""")
