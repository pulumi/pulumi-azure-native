...
warnings.warn("""azure-native:documentdb/v20220215preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cassandra_resource_cassandra_view(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_resource_cassandra_view is deprecated: azure-native:documentdb/v20220215preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20220215preview:getCassandraResourceCassandraView', __args__, opts=opts, typ=GetCassandraResourceCassandraViewResult).value
