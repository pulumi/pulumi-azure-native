...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""GremlinResourceGremlinDatabase is deprecated: azure-native:documentdb/v20220215preview:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.""")
        ...
        super(GremlinResourceGremlinDatabase, __self__).__init__(
            'azure-native:documentdb/v20220215preview:GremlinResourceGremlinDatabase',
            resource_name,
            __props__,
            opts)
