...
warnings.warn("""azure-native:documentdb/v20220215preview:NotebookWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_notebook_workspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_notebook_workspace is deprecated: azure-native:documentdb/v20220215preview:NotebookWorkspace is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:NotebookWorkspace to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['notebookWorkspaceName'] = notebook_workspace_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20220215preview:getNotebookWorkspace', __args__, opts=opts, typ=GetNotebookWorkspaceResult).value
