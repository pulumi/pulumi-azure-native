...
class SqlResourceSqlRoleDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_role_definition = azure_native.documentdb.v20230315.SqlResourceSqlRoleDefinition("sqlResourceSqlRoleDefinition",
            account_name="myAccountName",
            assignable_scopes=[
                "/subscriptions/mySubscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/myAccountName/dbs/sales",
                "/subscriptions/mySubscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.DocumentDB/databaseAccounts/myAccountName/dbs/purchases",
            ],
            permissions=[azure_native.documentdb.v20230315.PermissionArgs(
                data_actions=[
            ...
            type=azure_native.documentdb/v20230315.RoleDefinitionType.CUSTOM_ROLE)
