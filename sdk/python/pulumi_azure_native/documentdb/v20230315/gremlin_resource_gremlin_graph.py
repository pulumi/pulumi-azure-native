...
class GremlinResourceGremlinGraph(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gremlin_resource_gremlin_graph = azure_native.documentdb.v20230315.GremlinResourceGremlinGraph("gremlinResourceGremlinGraph",
            account_name="ddb1",
            database_name="databaseName",
            graph_name="graphName",
            location="West US",
            options=azure_native.documentdb.v20230315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20230315.GremlinGraphGetPropertiesResponseResourceArgs(
                conflict_resolution_policy=azure_native.documentdb.v20230315.ConflictResolutionPolicyArgs(
                ...
                indexing_policy={
                    ...
                    "includedPaths": [{
                        "indexes": [
                            azure_native.documentdb.v20230315.IndexesArgs(
                                data_type="String",
                                kind="Range",
                                precision=-1,
                            ),
                ...
                partition_key=azure_native.documentdb.v20230315.ContainerPartitionKeyArgs(
                    kind="Hash",
                    paths=["/AccountNumber"],
                ),
                unique_key_policy={
                    "uniqueKeys": [azure_native.documentdb.v20230315.UniqueKeyArgs(
                        paths=["/testPath"],
                    )],
                },
            ),
