...
class MongoDBResourceMongoRoleDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_role_definition = azure_native.documentdb.v20230315.MongoDBResourceMongoRoleDefinition("mongoDBResourceMongoRoleDefinition",
            ...
            privileges=[{
                ...
                "resource": azure_native.documentdb.v20230315.PrivilegeResourceArgs(
                    collection="sales",
                    db="sales",
                ),
            }],
            ...
            roles=[azure_native.documentdb.v20230315.RoleArgs(
                db="sales",
