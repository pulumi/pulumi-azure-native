...
class CassandraResourceCassandraTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_table = azure_native.documentdb.v20230315.CassandraResourceCassandraTable("cassandraResourceCassandraTable",
            account_name="ddb1",
            keyspace_name="keyspaceName",
            location="West US",
            options=azure_native.documentdb.v20230315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20230315.CassandraTableGetPropertiesResponseResourceArgs(
                default_ttl=100,
                id="tableName",
                schema={
                    "clusterKeys": [azure_native.documentdb.v20230315.ClusterKeyArgs(
                        name="columnA",
                        order_by="Asc",
                    )],
                    "columns": [azure_native.documentdb.v20230315.ColumnArgs(
                        name="columnA",
                        type="Ascii",
                    )],
                    "partitionKeys": [azure_native.documentdb.v20230315.CassandraPartitionKeyArgs(
                        name="columnA",
                    )],
                },
            ),
