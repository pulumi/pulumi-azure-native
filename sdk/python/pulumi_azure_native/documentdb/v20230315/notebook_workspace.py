...
class NotebookWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        notebook_workspace = azure_native.documentdb.v20230315.NotebookWorkspace("notebookWorkspace",
            account_name="ddb1",
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20230315:NotebookWorkspace default /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/notebookWorkspaces/default 
        ```
