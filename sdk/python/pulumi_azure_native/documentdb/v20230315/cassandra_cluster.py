...
class CassandraCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_cluster = azure_native.documentdb.v20230315.CassandraCluster("cassandraCluster",
            cluster_name="cassandra-prod",
            location="West US",
            properties=azure_native.documentdb.v20230315.ClusterResourceResponsePropertiesArgs(
                authentication_method="Cassandra",
                cassandra_version="3.11",
                client_certificates=[azure_native.documentdb.v20230315.CertificateArgs(
        ...
        -----END CERTIFICATE-----\"\"\",
                ...
                external_gossip_certificates=[azure_native.documentdb.v20230315.CertificateArgs(
                    pem=\"\"\"-----BEGIN CERTIFICATE-----
        ...Base64 encoded certificate...
        -----END CERTIFICATE-----\"\"\",
                )],
                external_seed_nodes=[
                    azure_native.documentdb.v20230315.SeedNodeArgs(
