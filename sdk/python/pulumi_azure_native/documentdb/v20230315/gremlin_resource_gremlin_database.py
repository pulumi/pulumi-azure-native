...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gremlin_resource_gremlin_database = azure_native.documentdb.v20230315.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase",
            account_name="ddb1",
            database_name="databaseName",
            location="West US",
            options=azure_native.documentdb.v20230315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20230315.GremlinDatabaseResourceArgs(
                id="databaseName",
            ),
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20230315:GremlinResourceGremlinDatabase databaseName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/gremlinDatabases/databaseName 
        ```
