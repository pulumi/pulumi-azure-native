...
class CassandraResourceCassandraKeyspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_keyspace = azure_native.documentdb.v20230315.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace",
            account_name="ddb1",
            keyspace_name="keyspaceName",
            location="West US",
            options=azure_native.documentdb.v20230315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20230315.CassandraKeyspaceResourceArgs(
                id="keyspaceName",
            ),
