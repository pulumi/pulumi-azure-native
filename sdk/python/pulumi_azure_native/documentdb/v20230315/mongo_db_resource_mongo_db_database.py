...
warnings.warn("""azure-native:documentdb/v20230315:MongoDBResourceMongoDBDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:MongoDBResourceMongoDBDatabase to guarantee forwards compatibility.""", DeprecationWarning)
...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(MongoDBResourceMongoDBDatabase, __self__).__init__(
            'azure-native:documentdb/v20230315:MongoDBResourceMongoDBDatabase',
            resource_name,
            __props__,
            opts)
