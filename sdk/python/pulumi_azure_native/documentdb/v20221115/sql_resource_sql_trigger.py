...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trigger_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlTrigger is deprecated: azure-native:documentdb/v20221115:SqlResourceSqlTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:SqlResourceSqlTrigger to guarantee forwards compatibility.""")
