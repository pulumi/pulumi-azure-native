...
def get_gremlin_resource_gremlin_graph(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gremlin_resource_gremlin_graph is deprecated: azure-native:documentdb/v20221115:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:GremlinResourceGremlinGraph to guarantee forwards compatibility.""")
    __args__ = dict()
