...
class TableResourceTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""TableResourceTable is deprecated: azure-native:documentdb/v20221115:TableResourceTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:TableResourceTable to guarantee forwards compatibility.""")
