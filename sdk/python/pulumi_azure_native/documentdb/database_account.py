...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_account = azure_native.documentdb.DatabaseAccount("databaseAccount",
            account_name="ddb1",
            analytical_storage_configuration=azure_native.documentdb.AnalyticalStorageConfigurationArgs(
            ...
            capacity=azure_native.documentdb.CapacityArgs(
                total_throughput_limit=2000,
            ),
            consistency_policy=azure_native.documentdb.ConsistencyPolicyResponseArgs(
