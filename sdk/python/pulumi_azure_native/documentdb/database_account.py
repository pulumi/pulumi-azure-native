...
class DatabaseAccountArgs:
    ...
    def _configure(
        ...
        if 'analyticalStorageConfiguration' in kwargs:
        ...
        if 'enablePartitionMerge' in kwargs:
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if analytical_storage_configuration is not None and not isinstance(analytical_storage_configuration, AnalyticalStorageConfigurationArgs):
            ...
            if api_properties is not None and not isinstance(api_properties, ApiPropertiesArgs):
            ...
            if capacity is not None and not isinstance(capacity, CapacityArgs):
            ...
            if consistency_policy is not None and not isinstance(consistency_policy, ConsistencyPolicyArgs):
            ...
            if restore_parameters is not None and not isinstance(restore_parameters, RestoreParametersArgs):
