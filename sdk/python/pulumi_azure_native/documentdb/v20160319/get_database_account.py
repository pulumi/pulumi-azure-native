...
azure-native:documentdb/v20160319:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20200301:DatabaseAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account is deprecated: Version 2016-03-19 will be removed in v2 of the provider.
azure-native:documentdb/v20160319:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20200301:DatabaseAccount to guarantee forwards compatibility.""")
    __args__ = dict()
