...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualNetworkRuleArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabaseAccount is deprecated: Version v20160319 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
        if opts is None:
