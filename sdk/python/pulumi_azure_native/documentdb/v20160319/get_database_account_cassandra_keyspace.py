...
def get_database_account_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_cassandra_keyspace is deprecated: Version v20160319 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20160319:getDatabaseAccountCassandraKeyspace', __args__, opts=opts, typ=GetDatabaseAccountCassandraKeyspaceResult).value
