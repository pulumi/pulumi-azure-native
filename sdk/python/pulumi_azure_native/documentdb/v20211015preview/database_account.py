...
warnings.warn("""azure-native:documentdb/v20211015preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:DatabaseAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualNetworkRuleArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabaseAccount is deprecated: azure-native:documentdb/v20211015preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:DatabaseAccount to guarantee forwards compatibility.""")
