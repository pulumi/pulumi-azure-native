...
warnings.warn("""azure-native:documentdb/v20211015preview:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph to guarantee forwards compatibility.""", DeprecationWarning)
...
class GremlinResourceGremlinGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""GremlinResourceGremlinGraph is deprecated: azure-native:documentdb/v20211015preview:GremlinResourceGremlinGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:GremlinResourceGremlinGraph to guarantee forwards compatibility.""")
