...
warnings.warn("""azure-native:documentdb/v20211015preview:TableResourceTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:TableResourceTable to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_table_resource_table(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_table_resource_table is deprecated: azure-native:documentdb/v20211015preview:TableResourceTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:TableResourceTable to guarantee forwards compatibility.""")
    __args__ = dict()
