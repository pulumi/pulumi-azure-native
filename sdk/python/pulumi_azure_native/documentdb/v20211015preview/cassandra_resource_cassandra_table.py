...
warnings.warn("""azure-native:documentdb/v20211015preview:CassandraResourceCassandraTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:CassandraResourceCassandraTable to guarantee forwards compatibility.""", DeprecationWarning)
