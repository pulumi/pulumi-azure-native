...
warnings.warn("""azure-native:documentdb/v20211015preview:Service is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:Service to guarantee forwards compatibility.""", DeprecationWarning)
