...
class MongoDBResourceMongoUserDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_user_definition = azure_native.documentdb.v20211015preview.MongoDBResourceMongoUserDefinition("mongoDBResourceMongoUserDefinition",
            ...
            roles=[azure_native.documentdb.v20211015preview.RoleArgs(
                db="sales",
                role="myReadRole",
            )],
