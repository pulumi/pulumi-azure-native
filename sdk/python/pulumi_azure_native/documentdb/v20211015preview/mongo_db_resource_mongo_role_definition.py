...
class MongoDBResourceMongoRoleDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_role_definition = azure_native.documentdb.v20211015preview.MongoDBResourceMongoRoleDefinition("mongoDBResourceMongoRoleDefinition",
            ...
            privileges=[{
                ...
                "resource": azure_native.documentdb.v20211015preview.PrivilegeResourceArgs(
                    collection="sales",
                    db="sales",
                ),
            }],
