...
warnings.warn("""azure-native:documentdb/v20211015preview:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.""", DeprecationWarning)
...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_defined_function_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlUserDefinedFunction is deprecated: azure-native:documentdb/v20211015preview:SqlResourceSqlUserDefinedFunction is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:SqlResourceSqlUserDefinedFunction to guarantee forwards compatibility.""")
