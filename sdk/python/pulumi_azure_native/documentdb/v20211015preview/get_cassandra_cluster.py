...
def get_cassandra_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_cluster is deprecated: azure-native:documentdb/v20211015preview:CassandraCluster is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:CassandraCluster to guarantee forwards compatibility.""")
    __args__ = dict()
