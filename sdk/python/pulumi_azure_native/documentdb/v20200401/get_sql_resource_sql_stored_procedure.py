...
def get_sql_resource_sql_stored_procedure(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_stored_procedure is deprecated: Version v20200401 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
