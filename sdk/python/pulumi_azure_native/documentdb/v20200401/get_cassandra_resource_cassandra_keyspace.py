...
def get_cassandra_resource_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cassandra_resource_cassandra_keyspace is deprecated: Version v20200401 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20200401:getCassandraResourceCassandraKeyspace', __args__, opts=opts, typ=GetCassandraResourceCassandraKeyspaceResult).value
