...
class SqlResourceSqlDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        SqlResourceSqlDatabaseArgs._configure(
...
class SqlResourceSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlResourceSqlDatabaseArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if resource is not None and not isinstance(resource, SqlDatabaseResourceArgs):
                resource = resource or {}
                def _setter(key, value):
                    resource[key] = value
                SqlDatabaseResourceArgs._configure(_setter, **resource)
