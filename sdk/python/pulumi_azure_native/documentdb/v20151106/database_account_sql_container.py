...
class DatabaseAccountSqlContainer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20150408:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountSqlContainer"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountSqlContainer")])
