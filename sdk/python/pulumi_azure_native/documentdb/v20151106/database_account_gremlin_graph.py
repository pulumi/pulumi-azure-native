...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountGremlinGraph")])
