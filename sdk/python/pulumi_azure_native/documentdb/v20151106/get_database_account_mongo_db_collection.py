...
def get_database_account_mongo_db_collection(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_mongo_db_collection is deprecated: Version v20151106 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
