...
class TableResourceTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        table_resource_table = azure_native.documentdb.v20210315.TableResourceTable("tableResourceTable",
            account_name="ddb1",
            location="West US",
            options=azure_native.documentdb.v20210315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20210315.TableResourceArgs(
                id="tableName",
            ),
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20210315:TableResourceTable tableName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/tables/tableName 
        ```
