...
class TableResourceTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20230301preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20230315:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20230415:TableResourceTable")])
