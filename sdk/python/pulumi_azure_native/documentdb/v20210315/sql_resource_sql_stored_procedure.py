...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_stored_procedure = azure_native.documentdb.v20210315.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options=azure_native.documentdb.v20210315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20210315.SqlStoredProcedureResourceArgs(
                body="body",
