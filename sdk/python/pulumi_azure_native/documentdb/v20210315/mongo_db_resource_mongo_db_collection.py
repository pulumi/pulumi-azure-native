...
class MongoDBResourceMongoDBCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_db_collection = azure_native.documentdb.v20210315.MongoDBResourceMongoDBCollection("mongoDBResourceMongoDBCollection",
            account_name="ddb1",
            collection_name="collectionName",
            database_name="databaseName",
            location="West US",
            options=azure_native.documentdb.v20210315.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20210315.MongoDBCollectionGetPropertiesResponseResourceArgs(
                id="collectionName",
                indexes=[{
                    "key": azure_native.documentdb.v20210315.MongoIndexKeysArgs(
                        keys=["testKey"],
                    ),
                    "options": azure_native.documentdb.v20210315.MongoIndexOptionsArgs(
