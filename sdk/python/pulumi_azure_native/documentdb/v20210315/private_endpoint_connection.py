...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.documentdb.v20210315.PrivateEndpointConnection("privateEndpointConnection",
            account_name="ddb1",
            private_endpoint_connection_name="privateEndpointConnectionName",
            private_link_service_connection_state=azure_native.documentdb.v20210315.PrivateLinkServiceConnectionStatePropertyArgs(
