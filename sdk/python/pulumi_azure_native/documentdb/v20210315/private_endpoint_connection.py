...
warnings.warn("""azure-native:documentdb/v20210315:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:documentdb/v20210315:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20190801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210115:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210415:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210515:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210615:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20211015:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20211115preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20220215preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20220515:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20220515preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20220815:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20221115:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:documentdb/v20230315:PrivateEndpointConnection")])
