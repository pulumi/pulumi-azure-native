...
warnings.warn("""azure-native:documentdb/v20220815:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_mongo_db_resource_mongo_role_definition(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mongo_db_resource_mongo_role_definition is deprecated: azure-native:documentdb/v20220815:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
