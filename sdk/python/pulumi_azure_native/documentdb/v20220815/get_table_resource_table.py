...
def get_table_resource_table(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_table_resource_table is deprecated: azure-native:documentdb/v20220815:TableResourceTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:TableResourceTable to guarantee forwards compatibility.""")
    __args__ = dict()
