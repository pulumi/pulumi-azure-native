...
def get_gremlin_resource_gremlin_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gremlin_resource_gremlin_database is deprecated: azure-native:documentdb/v20220815:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['databaseName'] = database_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20220815:getGremlinResourceGremlinDatabase', __args__, opts=opts, typ=GetGremlinResourceGremlinDatabaseResult).value
