...
class SqlResourceSqlRoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlRoleAssignment is deprecated: azure-native:documentdb/v20220815:SqlResourceSqlRoleAssignment is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:SqlResourceSqlRoleAssignment to guarantee forwards compatibility.""")
