...
class MongoDBResourceMongoUserDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_resource_mongo_user_definition = azure_native.documentdb.v20230301preview.MongoDBResourceMongoUserDefinition("mongoDBResourceMongoUserDefinition",
    ...
    def _internal_init(__self__,
        ...
        super(MongoDBResourceMongoUserDefinition, __self__).__init__(
            'azure-native:documentdb/v20230301preview:MongoDBResourceMongoUserDefinition',
            resource_name,
            __props__,
            opts)
