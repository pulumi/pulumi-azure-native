...
class MongoClusterFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:MongoClusterFirewallRule"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:MongoClusterFirewallRule")])
