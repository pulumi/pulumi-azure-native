...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20210315:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20230315:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:SqlResourceSqlContainer"), pulumi.Alias(type_="azure-native:documentdb/v20230415:SqlResourceSqlContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlResourceSqlContainer, __self__).__init__(
            'azure-native:documentdb/v20230301preview:SqlResourceSqlContainer',
            resource_name,
            __props__,
            opts)
