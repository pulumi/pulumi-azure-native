...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_stored_procedure = azure_native.documentdb.v20230301preview.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options=azure_native.documentdb.v20230301preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20230301preview.SqlStoredProcedureResourceArgs(
                body="body",
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20230301preview:SqlResourceSqlStoredProcedure storedProcedureName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/sqlDatabases/databaseName/sqlContainers/containerName/sqlStoredProcedures/storedProcedureName 
        ```
