...
def get_gremlin_resource_gremlin_graph(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20230301preview:getGremlinResourceGremlinGraph', __args__, opts=opts, typ=GetGremlinResourceGremlinGraphResult).value
...
def get_gremlin_resource_gremlin_graph_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20230301preview:getGremlinResourceGremlinGraph', __args__, opts=opts, typ=GetGremlinResourceGremlinGraphResult)
