...
def get_cassandra_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20230301preview:getCassandraCluster', __args__, opts=opts, typ=GetCassandraClusterResult).value
...
def get_cassandra_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20230301preview:getCassandraCluster', __args__, opts=opts, typ=GetCassandraClusterResult)
