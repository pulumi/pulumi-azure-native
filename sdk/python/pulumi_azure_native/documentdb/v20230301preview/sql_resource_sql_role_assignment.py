...
class SqlResourceSqlRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_role_assignment = azure_native.documentdb.v20230301preview.SqlResourceSqlRoleAssignment("sqlResourceSqlRoleAssignment",
