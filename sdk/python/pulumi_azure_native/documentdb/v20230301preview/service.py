...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:Service"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20210701preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20220815preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20221115preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20230315:Service"), pulumi.Alias(type_="azure-native:documentdb/v20230315preview:Service"), pulumi.Alias(type_="azure-native:documentdb/v20230415:Service")])
