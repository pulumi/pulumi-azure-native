...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getSqlResourceSqlContainer'.""", DeprecationWarning)
...
def get_sql_resource_sql_container(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_container is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getSqlResourceSqlContainer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getSqlResourceSqlContainer', __args__, opts=opts, typ=GetSqlResourceSqlContainerResult).value
