...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getNotebookWorkspace'.""", DeprecationWarning)
...
def get_notebook_workspace(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getNotebookWorkspace', __args__, opts=opts, typ=GetNotebookWorkspaceResult).value
