...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:MongoDBResourceMongoDBDatabase'.""", DeprecationWarning)
...
class MongoDBResourceMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""MongoDBResourceMongoDBDatabase is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:MongoDBResourceMongoDBDatabase'.""")
