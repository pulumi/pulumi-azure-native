...
class GremlinResourceGremlinGraphArgs:
    ...
    def _configure(
             ...
             resource: Optional[pulumi.Input['GremlinGraphResourceArgs']] = None,
        ...
        if graph_name is None and 'graphName' in kwargs:
            graph_name = kwargs['graphName']
...
class GremlinResourceGremlinGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            resource = _utilities.configure(resource, GremlinGraphResourceArgs, True)
