...
class SqlResourceSqlUserDefinedFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_user_defined_function = azure_native.documentdb.v20190801.SqlResourceSqlUserDefinedFunction("sqlResourceSqlUserDefinedFunction",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options={},
            resource=azure_native.documentdb.v20190801.SqlUserDefinedFunctionResourceArgs(
                body="body",
