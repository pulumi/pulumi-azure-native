...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_stored_procedure = azure_native.documentdb.v20190801.SqlResourceSqlStoredProcedure("sqlResourceSqlStoredProcedure",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options={},
            resource=azure_native.documentdb.v20190801.SqlStoredProcedureResourceArgs(
                body="body",
