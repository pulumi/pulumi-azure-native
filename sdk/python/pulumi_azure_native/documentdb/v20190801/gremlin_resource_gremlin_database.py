...
class GremlinResourceGremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gremlin_resource_gremlin_database = azure_native.documentdb.v20190801.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase",
            account_name="ddb1",
            database_name="databaseName",
            location="West US",
            options={},
            resource=azure_native.documentdb.v20190801.GremlinDatabaseResourceArgs(
                id="databaseName",
            ),
