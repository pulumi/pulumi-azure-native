...
class TableResourceTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        table_resource_table = azure_native.documentdb.v20190801.TableResourceTable("tableResourceTable",
            account_name="ddb1",
            location="West US",
            options={},
            resource=azure_native.documentdb.v20190801.TableResourceArgs(
                id="tableName",
            ),
