...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_container = azure_native.documentdb.v20190801.SqlResourceSqlContainer("sqlResourceSqlContainer",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            location="West US",
            options={},
            resource=azure_native.documentdb.v20190801.SqlContainerGetPropertiesResponseResourceArgs(
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""SqlResourceSqlContainer is deprecated: Version 2019-08-01 will be removed in v2 of the provider.""")
