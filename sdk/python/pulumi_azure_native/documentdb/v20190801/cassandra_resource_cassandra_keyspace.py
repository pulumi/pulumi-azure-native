...
class CassandraResourceCassandraKeyspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_resource_cassandra_keyspace = azure_native.documentdb.v20190801.CassandraResourceCassandraKeyspace("cassandraResourceCassandraKeyspace",
            account_name="ddb1",
            keyspace_name="keyspaceName",
            location="West US",
            options={},
            resource=azure_native.documentdb.v20190801.CassandraKeyspaceResourceArgs(
                id="keyspaceName",
            ),
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20190801:CassandraResourceCassandraKeyspace keyspaceName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/cassandraKeyspaces/keyspaceName 
        ```
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CassandraResourceCassandraKeyspace is deprecated: Version 2019-08-01 will be removed in v2 of the provider.""")
