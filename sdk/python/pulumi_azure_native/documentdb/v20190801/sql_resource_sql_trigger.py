...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_resource_sql_trigger = azure_native.documentdb.v20190801.SqlResourceSqlTrigger("sqlResourceSqlTrigger",
            account_name="ddb1",
            container_name="containerName",
            database_name="databaseName",
            options={},
            resource=azure_native.documentdb.v20190801.SqlTriggerResourceArgs(
                body="body",
                id="triggerName",
