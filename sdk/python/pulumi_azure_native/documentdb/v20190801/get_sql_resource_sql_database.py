...
def get_sql_resource_sql_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_database is deprecated: Version v20190801 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20190801:getSqlResourceSqlDatabase', __args__, opts=opts, typ=GetSqlResourceSqlDatabaseResult).value
