...
warnings.warn("""azure-native:documentdb/v20210701preview:GraphResourceGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GraphResourceGraph to guarantee forwards compatibility.""", DeprecationWarning)
...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GraphResourceGraphArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""GraphResourceGraph is deprecated: azure-native:documentdb/v20210701preview:GraphResourceGraph is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315preview:GraphResourceGraph to guarantee forwards compatibility.""")
        ...
        if opts.id is None:
            ...
            __props__ = GraphResourceGraphArgs.__new__(GraphResourceGraphArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'GraphResourceGraph':
        """
        ...
        __props__.__dict__["type"] = None
        return GraphResourceGraph(resource_name, opts=opts, __props__=__props__)
