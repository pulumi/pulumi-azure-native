...
class GraphResourceGraph(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        graph_resource_graph = azure_native.documentdb.v20210701preview.GraphResourceGraph("graphResourceGraph",
            account_name="ddb1",
            graph_name="graphName",
            location="West US",
            options=azure_native.documentdb.v20210701preview.CreateUpdateOptionsArgs(),
            resource=azure_native.documentdb.v20210701preview.GraphResourceArgs(
                id="graphName",
            ),
        ...
        ```sh
        $ pulumi import azure-native:documentdb/v20210701preview:GraphResourceGraph graphName /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1/graphs/graphName 
        ```
