...
warnings.warn("""azure-native:documentdb/v20210701preview:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_resource_sql_stored_procedure(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_stored_procedure is deprecated: azure-native:documentdb/v20210701preview:SqlResourceSqlStoredProcedure is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:SqlResourceSqlStoredProcedure to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20210701preview:getSqlResourceSqlStoredProcedure', __args__, opts=opts, typ=GetSqlResourceSqlStoredProcedureResult).value
