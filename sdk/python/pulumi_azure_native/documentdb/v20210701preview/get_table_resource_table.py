...
def get_table_resource_table(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_table_resource_table is deprecated: azure-native:documentdb/v20210701preview:TableResourceTable is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:TableResourceTable to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accountName'] = account_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['tableName'] = table_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20210701preview:getTableResourceTable', __args__, opts=opts, typ=GetTableResourceTableResult).value
