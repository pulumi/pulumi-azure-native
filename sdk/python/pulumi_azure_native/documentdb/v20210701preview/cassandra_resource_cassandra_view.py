...
class CassandraResourceCassandraView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:CassandraResourceCassandraView"), pulumi.Alias(type_="azure-native:documentdb/v20211015preview:CassandraResourceCassandraView")])
