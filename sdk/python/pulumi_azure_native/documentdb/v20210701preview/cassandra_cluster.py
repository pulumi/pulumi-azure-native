...
class CassandraCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cassandra_cluster = azure_native.documentdb.v20210701preview.CassandraCluster("cassandraCluster",
            cluster_name="cassandra-prod",
            location="West US",
            properties=azure_native.documentdb.v20210701preview.ClusterResourceResponsePropertiesArgs(
                authentication_method="Cassandra",
                cassandra_version="3.11",
                client_certificates=[azure_native.documentdb.v20210701preview.CertificateArgs(
        ...
        -----END CERTIFICATE-----\"\"\",
                ...
                external_gossip_certificates=[azure_native.documentdb.v20210701preview.CertificateArgs(
                    pem=\"\"\"-----BEGIN CERTIFICATE-----
        ...Base64 encoded certificate...
        -----END CERTIFICATE-----\"\"\",
                )],
                external_seed_nodes=[
                    azure_native.documentdb.v20210701preview.SeedNodeArgs(
