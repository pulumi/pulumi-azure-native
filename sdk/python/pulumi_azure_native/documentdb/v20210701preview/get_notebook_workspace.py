...
warnings.warn("""azure-native:documentdb/v20210701preview:NotebookWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:NotebookWorkspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_notebook_workspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_notebook_workspace is deprecated: azure-native:documentdb/v20210701preview:NotebookWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:NotebookWorkspace to guarantee forwards compatibility.""")
    __args__ = dict()
