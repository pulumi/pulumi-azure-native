...
class DatabaseAccountArgs:
    def __init__(__self__, *,
                 create_mode: pulumi.Input[Union[str, 'CreateMode']],
    ...
    def create_mode(self) -> pulumi.Input[Union[str, 'CreateMode']]:
        """
    ...
    @create_mode.setter
    def create_mode(self, value: pulumi.Input[Union[str, 'CreateMode']]):
...
warnings.warn("""azure-native:documentdb/v20210701preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:DatabaseAccount to guarantee forwards compatibility.""", DeprecationWarning)
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualNetworkRuleArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabaseAccount is deprecated: azure-native:documentdb/v20210701preview:DatabaseAccount is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20220815preview:DatabaseAccount to guarantee forwards compatibility.""")
        ...
        if opts.id is None:
            ...
            if create_mode is None:
                create_mode = 'Default'
            if create_mode is None and not opts.urn:
                raise TypeError("Missing required property 'create_mode'")
