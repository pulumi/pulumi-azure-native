...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def keys_metadata(self) -> pulumi.Output[Optional['outputs.DatabaseAccountKeysMetadataResponse']]:
        """
