...
warnings.warn("""azure-native:documentdb/v20220515preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class MongoDBResourceMongoRoleDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input['MongoRoleDefinitionType']] = None,
                 __props__=None):
        pulumi.log.warn("""MongoDBResourceMongoRoleDefinition is deprecated: azure-native:documentdb/v20220515preview:MongoDBResourceMongoRoleDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:MongoDBResourceMongoRoleDefinition to guarantee forwards compatibility.""")
