...
warnings.warn("""azure-native:documentdb/v20220515preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:Service to guarantee forwards compatibility.""", DeprecationWarning)
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 service_type: Optional[pulumi.Input[Union[str, 'ServiceType']]] = None,
                 __props__=None):
        pulumi.log.warn("""Service is deprecated: azure-native:documentdb/v20220515preview:Service is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20230315:Service to guarantee forwards compatibility.""")
