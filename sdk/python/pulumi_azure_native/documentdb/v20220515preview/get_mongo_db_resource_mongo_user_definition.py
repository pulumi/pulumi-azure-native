...
warnings.warn("""azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_mongo_db_resource_mongo_user_definition(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mongo_db_resource_mongo_user_definition is deprecated: azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
