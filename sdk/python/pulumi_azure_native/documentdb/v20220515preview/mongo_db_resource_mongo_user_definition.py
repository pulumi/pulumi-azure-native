...
class MongoDBResourceMongoUserDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MongoDBResourceMongoUserDefinition is deprecated: azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230315:MongoDBResourceMongoUserDefinition to guarantee forwards compatibility.""")
        ...
        super(MongoDBResourceMongoUserDefinition, __self__).__init__(
            'azure-native:documentdb/v20220515preview:MongoDBResourceMongoUserDefinition',
            resource_name,
            __props__,
            opts)
