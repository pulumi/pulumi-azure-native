...
warnings.warn("""azure-native:documentdb/v20220515preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.""", DeprecationWarning)
...
class CassandraResourceCassandraView(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 view_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CassandraResourceCassandraView is deprecated: azure-native:documentdb/v20220515preview:CassandraResourceCassandraView is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:CassandraResourceCassandraView to guarantee forwards compatibility.""")
