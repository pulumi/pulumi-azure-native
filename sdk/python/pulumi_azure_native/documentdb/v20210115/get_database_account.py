...
def get_database_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account is deprecated: azure-native:documentdb/v20210115:DatabaseAccount is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20210401preview:DatabaseAccount to guarantee forwards compatibility.""")
    __args__ = dict()
