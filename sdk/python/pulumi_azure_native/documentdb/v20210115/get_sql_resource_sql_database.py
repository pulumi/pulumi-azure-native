...
def get_sql_resource_sql_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_database is deprecated: azure-native:documentdb/v20210115:SqlResourceSqlDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:SqlResourceSqlDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
