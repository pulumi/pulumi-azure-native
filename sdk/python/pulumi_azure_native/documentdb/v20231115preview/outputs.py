...
class BackupScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str cron_expression: The cron expression that defines when you want to back up your data.
        :param int retention_in_hours: The retention period (hours) of the backups. If you want to retain data forever, set retention to 0.
        :param str schedule_name: The unique identifier of backup schedule.
        """
...
class ClusterResourceResponseProperties(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "autoReplicate":
            suggest = "auto_replicate"
        ...
        elif key == "externalDataCenters":
            suggest = "external_data_centers"
        ...
        elif key == "scheduledEventStrategy":
            suggest = "scheduled_event_strategy"
    ...
    def __init__(__self__, *,
                 ...
                 auto_replicate: Optional[str] = None,
                 azure_connection_method: Optional[str] = None,
                 backup_schedules: Optional[Sequence['outputs.BackupScheduleResponse']] = None,
                 ...
                 external_data_centers: Optional[Sequence[str]] = None,
                 ...
                 scheduled_event_strategy: Optional[str] = None):
        """
        Properties of a managed Cassandra cluster.
        ...
        :param str auto_replicate: The form of AutoReplicate that is being used by this cluster.
        :param str azure_connection_method: How to connect to the azure services needed for running the cluster
        :param Sequence['BackupScheduleResponse'] backup_schedules: List of backup schedules that define when you want to back up your data.
        ...
        :param str cluster_type: Type of the cluster. If set to Production, some operations might not be permitted on cluster.
        ...
        :param Sequence[str] extensions: Extensions to be added or updated on cluster.
        :param Sequence[str] external_data_centers: List of the data center names for unmanaged data centers in this cluster to be included in auto-replication.
        ...
        :param str scheduled_event_strategy: How the nodes in the cluster react to scheduled events
        """
    ...
    def auto_replicate(self) -> Optional[str]:
        """
    ...
    def backup_schedules(self) -> Optional[Sequence['outputs.BackupScheduleResponse']]:
        """
    ...
    def external_data_centers(self) -> Optional[Sequence[str]]:
        """
    ...
    def scheduled_event_strategy(self) -> Optional[str]:
        """
...
class MaterializedViewDefinitionResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "sourceCollectionId":
            suggest = "source_collection_id"
        elif key == "sourceCollectionRid":
            suggest = "source_collection_rid"
    ...
    def __init__(__self__, *,
                 ...
                 source_collection_rid: str):
        """
        Materialized View definition for the container.
        :param str definition: The definition should be an SQL query which would be used to fetch data from the source container to populate into the Materialized View container.
        :param str source_collection_id: The name of the source container on which the Materialized View will be created.
        :param str source_collection_rid: An unique identifier for the source collection. This is a system generated property.
        """
        pulumi.set(__self__, "definition", definition)
        pulumi.set(__self__, "source_collection_id", source_collection_id)
        pulumi.set(__self__, "source_collection_rid", source_collection_rid)
    ...
    def source_collection_id(self) -> str:
        """
    ...
    @property
    @pulumi.getter(name="sourceCollectionRid")
    def source_collection_rid(self) -> str:
        """
        An unique identifier for the source collection. This is a system generated property.
        """
        return pulumi.get(self, "source_collection_rid")
...
class SqlContainerGetPropertiesResponseResource(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "analyticalStorageTtl":
            ...
            suggest = "indexing_policy"
        elif key == "materializedViewDefinition":
            suggest = "materialized_view_definition"
        elif key == "partitionKey":
            suggest = "partition_key"
        elif key == "restoreParameters":
            suggest = "restore_parameters"
    ...
    def __init__(__self__, *,
                 ...
                 default_ttl: Optional[int] = None,
                 indexing_policy: Optional['outputs.IndexingPolicyResponse'] = None,
                 materialized_view_definition: Optional['outputs.MaterializedViewDefinitionResponse'] = None,
                 partition_key: Optional['outputs.ContainerPartitionKeyResponse'] = None,
                 restore_parameters: Optional['outputs.ResourceRestoreParametersResponse'] = None,
                 unique_key_policy: Optional['outputs.UniqueKeyPolicyResponse'] = None):
        """
        ...
        :param 'MaterializedViewDefinitionResponse' materialized_view_definition: The configuration for defining Materialized Views. This must be specified only for creating a Materialized View container.
        :param 'ContainerPartitionKeyResponse' partition_key: The configuration of the partition key to be used for partitioning data into multiple partitions
        :param 'ResourceRestoreParametersResponse' restore_parameters: Parameters to indicate the information about the restore
        :param 'UniqueKeyPolicyResponse' unique_key_policy: The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
        """
    ...
    def materialized_view_definition(self) -> Optional['outputs.MaterializedViewDefinitionResponse']:
        """
