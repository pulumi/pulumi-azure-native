...
def get_table_resource_table(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20231115preview:getTableResourceTable', __args__, opts=opts, typ=GetTableResourceTableResult).value
...
def get_table_resource_table_output(account_name: Optional[pulumi.Input[str]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTableResourceTableResult]:
    """
    Gets the Tables under an existing Azure Cosmos DB database account with the provided name.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20231115preview:getTableResourceTable', __args__, opts=opts, typ=GetTableResourceTableResult)
    return __ret__.apply(lambda __response__: GetTableResourceTableResult(
