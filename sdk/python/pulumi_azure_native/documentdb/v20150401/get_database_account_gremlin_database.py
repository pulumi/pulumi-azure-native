...
def get_database_account_gremlin_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_gremlin_database is deprecated: Version v20150401 will be removed in the next major version of the provider. Upgrade to version v20210301preview or later.""")
    __args__ = dict()
