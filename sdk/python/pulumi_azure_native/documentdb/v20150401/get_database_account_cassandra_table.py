...
azure-native:documentdb/v20150401:DatabaseAccountCassandraTable is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20160331:DatabaseAccountCassandraTable to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20150401:getDatabaseAccountCassandraTable', __args__, opts=opts, typ=GetDatabaseAccountCassandraTableResult).value
