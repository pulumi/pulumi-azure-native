...
azure-native:documentdb/v20150401:DatabaseAccountMongoDBCollection is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountMongoDBCollection to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:documentdb/v20150401:DatabaseAccountMongoDBCollection is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountMongoDBCollection to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabaseAccountMongoDBCollection is deprecated: Version 2015-04-01 will be removed in v2 of the provider.
azure-native:documentdb/v20150401:DatabaseAccountMongoDBCollection is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20160331:DatabaseAccountMongoDBCollection to guarantee forwards compatibility.""")
