...
class ThroughputPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20231115preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb:ThroughputPool")])
