...
def get_throughput_pool_account(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20240901preview:getThroughputPoolAccount', __args__, opts=opts, typ=GetThroughputPoolAccountResult).value
