...
warnings.warn("""azure-native:documentdb/v20210415:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_resource_sql_role_definition(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_role_definition is deprecated: azure-native:documentdb/v20210415:SqlResourceSqlRoleDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:documentdb/v20230415:SqlResourceSqlRoleDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
