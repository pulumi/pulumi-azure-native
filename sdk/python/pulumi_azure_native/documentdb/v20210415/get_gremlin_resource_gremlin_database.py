...
def get_gremlin_resource_gremlin_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gremlin_resource_gremlin_database is deprecated: azure-native:documentdb/v20210415:GremlinResourceGremlinDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:documentdb/v20220815preview:GremlinResourceGremlinDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
