...
def get_cassandra_resource_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20240515preview:getCassandraResourceCassandraKeyspace', __args__, opts=opts, typ=GetCassandraResourceCassandraKeyspaceResult).value
...
def get_cassandra_resource_cassandra_keyspace_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20240515preview:getCassandraResourceCassandraKeyspace', __args__, opts=opts, typ=GetCassandraResourceCassandraKeyspaceResult)
