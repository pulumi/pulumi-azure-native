...
class ThroughputPoolAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb/v20231115preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20240215preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb:ThroughputPoolAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ThroughputPoolAccount, __self__).__init__(
            'azure-native:documentdb/v20240515preview:ThroughputPoolAccount',
            resource_name,
            __props__,
            opts)
