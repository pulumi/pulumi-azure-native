...
__all__ = [
    ...
    'CapabilityResponse',
    'CapacityModeChangeTransitionStateResponse',
    'CapacityResponse',
...
@pulumi.output_type
class CapacityModeChangeTransitionStateResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "capacityModeLastSuccessfulTransitionEndTimestamp":
            suggest = "capacity_mode_last_successful_transition_end_timestamp"
        elif key == "capacityModeTransitionBeginTimestamp":
            suggest = "capacity_mode_transition_begin_timestamp"
        elif key == "capacityModeTransitionEndTimestamp":
            suggest = "capacity_mode_transition_end_timestamp"
        elif key == "capacityModeTransitionStatus":
            suggest = "capacity_mode_transition_status"
        elif key == "currentCapacityMode":
            suggest = "current_capacity_mode"
        elif key == "previousCapacityMode":
            suggest = "previous_capacity_mode"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CapacityModeChangeTransitionStateResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CapacityModeChangeTransitionStateResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 capacity_mode_last_successful_transition_end_timestamp: str,
                 capacity_mode_transition_begin_timestamp: str,
                 capacity_mode_transition_end_timestamp: str,
                 capacity_mode_transition_status: Optional[str] = None,
                 current_capacity_mode: Optional[str] = None,
                 previous_capacity_mode: Optional[str] = None):
        """
        The transition state information related capacity mode change with update request.
        :param str capacity_mode_last_successful_transition_end_timestamp: End time in UTC of the last successful capacity mode change.
        :param str capacity_mode_transition_begin_timestamp: Begin time in UTC of the capacity mode change.
        :param str capacity_mode_transition_end_timestamp: End time in UTC of the capacity mode change.
        :param str capacity_mode_transition_status: The transition status of capacity mode.
        :param str current_capacity_mode: Indicates the current capacity mode of the account.
        :param str previous_capacity_mode: Indicates the previous capacity mode of the account before successful transition.
        """
        pulumi.set(__self__, "capacity_mode_last_successful_transition_end_timestamp", capacity_mode_last_successful_transition_end_timestamp)
        pulumi.set(__self__, "capacity_mode_transition_begin_timestamp", capacity_mode_transition_begin_timestamp)
        pulumi.set(__self__, "capacity_mode_transition_end_timestamp", capacity_mode_transition_end_timestamp)
        if capacity_mode_transition_status is not None:
            pulumi.set(__self__, "capacity_mode_transition_status", capacity_mode_transition_status)
        if current_capacity_mode is not None:
            pulumi.set(__self__, "current_capacity_mode", current_capacity_mode)
        if previous_capacity_mode is not None:
            pulumi.set(__self__, "previous_capacity_mode", previous_capacity_mode)

    @property
    @pulumi.getter(name="capacityModeLastSuccessfulTransitionEndTimestamp")
    def capacity_mode_last_successful_transition_end_timestamp(self) -> str:
        """
        End time in UTC of the last successful capacity mode change.
        """
        return pulumi.get(self, "capacity_mode_last_successful_transition_end_timestamp")

    @property
    @pulumi.getter(name="capacityModeTransitionBeginTimestamp")
    def capacity_mode_transition_begin_timestamp(self) -> str:
        """
        Begin time in UTC of the capacity mode change.
        """
        return pulumi.get(self, "capacity_mode_transition_begin_timestamp")

    @property
    @pulumi.getter(name="capacityModeTransitionEndTimestamp")
    def capacity_mode_transition_end_timestamp(self) -> str:
        """
        End time in UTC of the capacity mode change.
        """
        return pulumi.get(self, "capacity_mode_transition_end_timestamp")

    @property
    @pulumi.getter(name="capacityModeTransitionStatus")
    def capacity_mode_transition_status(self) -> Optional[str]:
        """
        The transition status of capacity mode.
        """
        return pulumi.get(self, "capacity_mode_transition_status")

    @property
    @pulumi.getter(name="currentCapacityMode")
    def current_capacity_mode(self) -> Optional[str]:
        """
        Indicates the current capacity mode of the account.
        """
        return pulumi.get(self, "current_capacity_mode")

    @property
    @pulumi.getter(name="previousCapacityMode")
    def previous_capacity_mode(self) -> Optional[str]:
        """
        Indicates the previous capacity mode of the account before successful transition.
        """
        return pulumi.get(self, "previous_capacity_mode")
