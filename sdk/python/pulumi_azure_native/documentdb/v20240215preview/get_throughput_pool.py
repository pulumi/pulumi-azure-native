...
def get_throughput_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20240215preview:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult).value
...
def get_throughput_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['throughputPoolName'] = throughput_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20240215preview:getThroughputPool', __args__, opts=opts, typ=GetThroughputPoolResult)
