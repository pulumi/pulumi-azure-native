...
def get_mongo_cluster(mongo_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/v20240215preview:getMongoCluster', __args__, opts=opts, typ=GetMongoClusterResult).value
...
def get_mongo_cluster_output(mongo_cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:documentdb/v20240215preview:getMongoCluster', __args__, opts=opts, typ=GetMongoClusterResult)
