...
class DatabaseAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enable_per_region_per_partition_autoscale: Flag to indicate enabling/disabling of Per-Region Per-partition autoscale Preview feature on the account
    ...
    def default_priority_level(self) -> Optional[pulumi.Input[Union[str, 'DefaultPriorityLevel']]]:
        """
    ...
    def default_priority_level(self, value: Optional[pulumi.Input[Union[str, 'DefaultPriorityLevel']]]):
    ...
    def enable_priority_based_execution(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enable_priority_based_execution(self, value: Optional[pulumi.Input[bool]]):
...
class DatabaseAccount(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultPriorityLevel")
    def default_priority_level(self) -> pulumi.Output[Optional[str]]:
        """
        Enum to indicate default Priority Level of request for Priority Based Execution.
        """
        return pulumi.get(self, "default_priority_level")
    ...
    @property
    @pulumi.getter(name="enablePriorityBasedExecution")
    def enable_priority_based_execution(self) -> pulumi.Output[Optional[bool]]:
        """
        Flag to indicate enabling/disabling of Priority Based Execution Preview feature on the account
        """
        return pulumi.get(self, "enable_priority_based_execution")
