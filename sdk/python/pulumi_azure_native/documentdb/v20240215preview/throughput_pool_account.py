...
class ThroughputPoolAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:ThroughputPoolAccount"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:ThroughputPoolAccount")])
