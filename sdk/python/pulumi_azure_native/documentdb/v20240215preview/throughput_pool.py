...
__all__ = ['ThroughputPoolArgs', 'ThroughputPool']
...
class ThroughputPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_throughput: Value for throughput to be shared among CosmosDB resources in the pool.
        ...
        if throughput_pool_name is not None:
    ...
    def throughput_pool_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def throughput_pool_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "throughput_pool_name", value)


class ThroughputPool(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ThroughputPoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ThroughputPoolArgs.__new__(ThroughputPoolArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:documentdb:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20231115preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240515preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20240901preview:ThroughputPool"), pulumi.Alias(type_="azure-native:documentdb/v20241201preview:ThroughputPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ThroughputPool, __self__).__init__(
            'azure-native:documentdb/v20240215preview:ThroughputPool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ThroughputPool':
        """
        ...
        __props__.__dict__["type"] = None
        return ThroughputPool(resource_name, opts=opts, __props__=__props__)
