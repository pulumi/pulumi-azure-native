...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        service = azure_native.search.v20220901.Service("service",
            hosting_mode=azure_native.search/v20220901.HostingMode.DEFAULT,
            location="westus",
            partition_count=1,
            replica_count=3,
            resource_group_name="rg1",
            search_service_name="mysearchservice",
            sku=azure_native.search.v20220901.SkuArgs(
        ...
        service = azure_native.search.v20220901.Service("service",
            auth_options=azure_native.search.v20220901.DataPlaneAuthOptionsResponseArgs(
                aad_or_api_key=azure_native.search.v20220901.DataPlaneAadOrApiKeyAuthOptionArgs(
                    aad_auth_failure_mode=azure_native.search/v20220901.AadAuthFailureMode.HTTP401_WITH_BEARER_CHALLENGE,
                ),
            ),
            hosting_mode=azure_native.search/v20220901.HostingMode.DEFAULT,
            location="westus",
        ...
        service = azure_native.search.v20220901.Service("service",
            ...
            location="westus",
            partition_count=1,
            public_network_access=azure_native.search/v20220901.PublicNetworkAccess.DISABLED,
            replica_count=3,
            resource_group_name="rg1",
            search_service_name="mysearchservice",
            sku=azure_native.search.v20220901.SkuArgs(
        ...
        service = azure_native.search.v20220901.Service("service",
            hosting_mode=azure_native.search/v20220901.HostingMode.DEFAULT,
            location="westus",
            network_rule_set=azure_native.search.v20220901.NetworkRuleSetResponseArgs(
                ip_rules=[
                    azure_native.search.v20220901.IpRuleArgs(
                        value="123.4.5.6",
                    ),
                    azure_native.search.v20220901.IpRuleArgs(
                        value="123.4.6.0/18",
        ...
        service = azure_native.search.v20220901.Service("service",
            encryption_with_cmk=azure_native.search.v20220901.EncryptionWithCmkArgs(
        ...
        service = azure_native.search.v20220901.Service("service",
            hosting_mode=azure_native.search/v20220901.HostingMode.DEFAULT,
            identity=azure_native.search.v20220901.IdentityResponseArgs(
                type=azure_native.search/v20220901.IdentityType.SYSTEM_ASSIGNED,
            ),
            location="westus",
            partition_count=1,
            replica_count=3,
