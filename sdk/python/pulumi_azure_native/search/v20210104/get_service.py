...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/v20210104:getService', __args__, opts=opts, typ=GetServiceResult).value
