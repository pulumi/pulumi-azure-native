...
__all__ = [
    ...
    'NonCmkEncryptedResourceResponse',
...
class EncryptionWithCmkResponse(dict):
    ...
    def __init__(__self__, *,
                 non_cmk_encrypted_resources: Sequence['outputs.NonCmkEncryptedResourceResponse'],
                 enforcement: Optional[str] = None):
        """
        Describes properties associated with encryption of resources using customer managed Keys.
        :param Sequence['NonCmkEncryptedResourceResponseArgs'] non_cmk_encrypted_resources: The list of Non Cmk encrypted resource.
        :param str enforcement: Enforcement state of encryption with customer managed keys. Can be enabled, disabled, or unspecified.
        """
        pulumi.set(__self__, "non_cmk_encrypted_resources", non_cmk_encrypted_resources)
        if enforcement is not None:
            pulumi.set(__self__, "enforcement", enforcement)

    @property
    @pulumi.getter(name="nonCmkEncryptedResources")
    def non_cmk_encrypted_resources(self) -> Sequence['outputs.NonCmkEncryptedResourceResponse']:
        """
        The list of Non Cmk encrypted resource.
        """
        return pulumi.get(self, "non_cmk_encrypted_resources")
...
@pulumi.output_type
class NonCmkEncryptedResourceResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Describes properties of resources not encrypted with customer managed keys.
        :param str name: Describes name of resource not encrypted by customer managed keys.
        :param str type: Describes type of resource (.i.e. index, indexer, skillset, synonym map and debug session) not encrypted by customer managed keys.
        """
        if name is not None:
