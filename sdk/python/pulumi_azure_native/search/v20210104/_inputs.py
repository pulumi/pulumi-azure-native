...
class EncryptionWithCmkArgs:
    def __init__(__self__, *,
                 enforcement: Optional[pulumi.Input['EncryptionEnforcementStatus']] = None):
        """
        Describes properties associated with encryption of resources using customer managed Keys.
        :param pulumi.Input['EncryptionEnforcementStatus'] enforcement: Enforcement state of encryption with customer managed keys. Can be enabled, disabled, or unspecified.
        """
    ...
    @property
    @pulumi.getter
    def enforcement(self) -> Optional[pulumi.Input['EncryptionEnforcementStatus']]:
        """
    ...
    @enforcement.setter
    def enforcement(self, value: Optional[pulumi.Input['EncryptionEnforcementStatus']]):
