...
def get_shared_private_link_resource(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str shared_private_link_resource_name: The name of the shared private link resource managed by the search service within the specified resource group.
    """
    __args__ = dict()
