...
def get_shared_private_link_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_shared_private_link_resource is deprecated: azure-native:search/v20210401preview:SharedPrivateLinkResource is being removed in the next major version of this provider. Please upgrade to azure-native:search/v20220901:SharedPrivateLinkResource to guarantee forwards compatibility.""")
    __args__ = dict()
