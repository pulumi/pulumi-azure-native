...
def list_admin_key(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search:listAdminKey', __args__, opts=opts, typ=ListAdminKeyResult).value

    return AwaitableListAdminKeyResult(
        primary_key=pulumi.get(__ret__, 'primary_key'),
        secondary_key=pulumi.get(__ret__, 'secondary_key'))
def list_admin_key_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:search:listAdminKey', __args__, opts=opts, typ=ListAdminKeyResult)
