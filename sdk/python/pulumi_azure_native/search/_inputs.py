...
class IpRuleArgs:
    def __init__(__self__, *,
        ...
        """
        The IP restriction rule of the search service.
        :param pulumi.Input[_builtins.str] value: Value corresponding to a single IPv4 address (for example, 123.1.2.3) or an IP range in CIDR format (for example, 123.1.2.3/24) to be allowed.
        """
...
class PrivateEndpointConnectionPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Describes the properties of an existing Private Endpoint connection to the search service.
        :param pulumi.Input[_builtins.str] group_id: The group id from the provider of resource the private link service connection is for.
        ...
        :param pulumi.Input[Union[_builtins.str, 'PrivateLinkServiceConnectionProvisioningState']] provisioning_state: The provisioning state of the private link service connection. Valid values are Updating, Deleting, Failed, Succeeded, or Incomplete
        """
...
class SharedPrivateLinkResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_region: Optional. Can be used to specify the Azure Resource Manager location of the resource to which a shared private link is to be created. This is only required for those resources whose DNS configuration are regional (such as Azure Kubernetes Service).
