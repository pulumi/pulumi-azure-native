...
class DataPlaneAuthOptionsArgsDict(TypedDict):
    ...
    """
    aad_or_api_key: NotRequired[pulumi.Input[Optional['DataPlaneAadOrApiKeyAuthOptionArgs']]]
    """
    Indicates that either the API key or an access token from a Microsoft Entra ID tenant can be used for authentication.
    """
    api_key_only: NotRequired[Optional[Any]]
    """
...
class IdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'IdentityType']] type: The type of identity used for the resource. The type 'SystemAssigned, UserAssigned' includes both an identity created by the system and a set of user assigned identities. The type 'None' will remove all identities from the service.
...
class IpRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: Value corresponding to a single IPv4 address (eg., 123.1.2.3) or an IP range in CIDR format (eg., 123.1.2.3/24) to be allowed.
        """
...
class NetworkRuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'SearchBypass']] bypass: Possible origins of inbound traffic that can bypass the rules defined in the 'ipRules' section.
...
class PrivateEndpointConnectionPropertiesArgsDict(TypedDict):
    ...
    """
    private_endpoint: NotRequired[pulumi.Input[Optional['PrivateEndpointConnectionPropertiesPrivateEndpointArgs']]]
    """
    The private endpoint resource from Microsoft.Network provider.
    """
    private_link_service_connection_state: NotRequired[pulumi.Input[Optional['PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs']]]
    """
    Describes the current state of an existing Azure Private Link service connection to the private endpoint.
    """
...
class PrivateEndpointConnectionPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group_id: The group ID of the Azure resource for which the private link service is for.
        ...
        :param pulumi.Input[Union[_builtins.str, 'PrivateLinkServiceConnectionProvisioningState']] provisioning_state: The provisioning state of the private link service connection. Valid values are Updating, Deleting, Failed, Succeeded, Incomplete, or Canceled.
        """
...
class SharedPrivateLinkResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'SharedPrivateLinkResourceProvisioningState']] provisioning_state: The provisioning state of the shared private link resource. Valid values are Updating, Deleting, Failed, Succeeded or Incomplete.
        :param pulumi.Input[_builtins.str] request_message: The message for requesting approval of the shared private link resource.
        :param pulumi.Input[_builtins.str] resource_region: Optional. Can be used to specify the Azure Resource Manager location of the resource for which a shared private link is being created. This is only required for those resources whose DNS configuration are regional (such as Azure Kubernetes Service).
        :param pulumi.Input[Union[_builtins.str, 'SharedPrivateLinkResourceStatus']] status: Status of the shared private link resource. Valid values are Pending, Approved, Rejected or Disconnected.
        """
        if group_id is not None:
            pulumi.set(__self__, "group_id", group_id)
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'SkuName']] name: The SKU of the search service. Valid values include: 'free': Shared service. 'basic': Dedicated service with up to 3 replicas. 'standard': Dedicated service with up to 12 partitions and 12 replicas. 'standard2': Similar to standard, but with more capacity per search unit. 'standard3': The largest Standard offering with up to 12 partitions and 12 replicas (or up to 3 partitions with more indexes if you also set the hostingMode property to 'highDensity'). 'storage_optimized_l1': Supports 1TB per partition, up to 12 partitions. 'storage_optimized_l2': Supports 2TB per partition, up to 12 partitions.'
        """
        if name is not None:
