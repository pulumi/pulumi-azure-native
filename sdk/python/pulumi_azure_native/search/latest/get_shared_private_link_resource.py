...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:getSharedPrivateLinkResource'.""", DeprecationWarning)
...
def get_shared_private_link_resource(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_shared_private_link_resource is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:getSharedPrivateLinkResource'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/latest:getSharedPrivateLinkResource', __args__, opts=opts, typ=GetSharedPrivateLinkResourceResult).value
