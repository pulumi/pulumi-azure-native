...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:listQueryKeyBySearchService'.""", DeprecationWarning)
...
def list_query_key_by_search_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_query_key_by_search_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:listQueryKeyBySearchService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/latest:listQueryKeyBySearchService', __args__, opts=opts, typ=ListQueryKeyBySearchServiceResult).value
