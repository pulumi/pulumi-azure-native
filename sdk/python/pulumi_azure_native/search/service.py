...
class ServiceArgs:
    ...
    def search_service_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def semantic_search(self, value: Optional[pulumi.Input[Union[builtins.str, 'SearchSemanticSearch']]]):
