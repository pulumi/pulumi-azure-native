...
class SharedPrivateLinkResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] search_service_name: The name of the search service associated with the specified resource group.
        ...
        :param pulumi.Input[_builtins.str] shared_private_link_resource_name: The name of the shared private link resource managed by the search service within the specified resource group.
        """
