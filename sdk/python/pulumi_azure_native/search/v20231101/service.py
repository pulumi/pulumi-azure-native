...
class ServiceArgs:
    ...
    def _configure(
        ...
        if semantic_search is None and 'semanticSearch' in kwargs:
            semantic_search = kwargs['semanticSearch']
        ...
        if semantic_search is not None:
            _setter("semantic_search", semantic_search)
        if sku is not None:
            _setter("sku", sku)
        if tags is not None:
            _setter("tags", tags)
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Service, __self__).__init__(
            'azure-native:search/v20231101:Service',
            resource_name,
            __props__,
            opts)
