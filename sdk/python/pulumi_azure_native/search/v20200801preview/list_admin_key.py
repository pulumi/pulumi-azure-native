...
def list_admin_key(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/v20200801preview:listAdminKey', __args__, opts=opts, typ=ListAdminKeyResult).value
...
def list_admin_key_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:search/v20200801preview:listAdminKey', __args__, opts=opts, typ=ListAdminKeyResult)
