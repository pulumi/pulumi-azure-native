...
class SharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 shared_private_link_resource_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SharedPrivateLinkResource is deprecated: azure-native:search/v20200801preview:SharedPrivateLinkResource is being removed in the next major version of this provider. Please upgrade to azure-native:search/v20220901:SharedPrivateLinkResource to guarantee forwards compatibility.""")
