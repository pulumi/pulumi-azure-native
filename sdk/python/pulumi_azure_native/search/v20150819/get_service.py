...
def get_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: Version v20150819 will be removed in the next major version of the provider. Upgrade to version v20200801 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/v20150819:getService', __args__, opts=opts, typ=GetServiceResult).value
