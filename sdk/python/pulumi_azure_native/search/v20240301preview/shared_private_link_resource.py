...
class SharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['SharedPrivateLinkResourcePropertiesArgs']] properties: Describes the properties of a shared private link resource managed by the Azure AI Search service.
        :param pulumi.Input[str] resource_group_name: The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[str] search_service_name: The name of the Azure AI Search service associated with the specified resource group.
        :param pulumi.Input[str] shared_private_link_resource_name: The name of the shared private link resource managed by the Azure AI Search service within the specified resource group.
        """
    ...
    def _internal_init(__self__,
        ...
        super(SharedPrivateLinkResource, __self__).__init__(
            'azure-native:search/v20240301preview:SharedPrivateLinkResource',
            resource_name,
            __props__,
            opts)
