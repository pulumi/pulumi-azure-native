...
class EncryptionWithCmkResponse(dict):
    ...
    def __init__(__self__, *,
                 encryption_compliance_status: _builtins.str,
                 enforcement: Optional[_builtins.str] = None):
        """
        Describes a policy that determines how resources within the search service are to be encrypted with customer=managed keys.
        :param _builtins.str encryption_compliance_status: Describes whether the search service is compliant or not with respect to having non-customer-encrypted resources. If a service has more than one non-customer-encrypted resource and 'Enforcement' is 'enabled' then the service will be marked as 'nonCompliant'.
        :param _builtins.str enforcement: Describes how a search service should enforce having one or more non-customer-encrypted resources.
        """
...
class IpRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The IP restriction rule of the search service.
        :param _builtins.str value: Value corresponding to a single IPv4 address (for example, 123.1.2.3) or an IP range in CIDR format (for example, 123.1.2.3/24) to be allowed.
        """
...
class PrivateEndpointConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the properties of an existing Private Endpoint connection to the search service.
        :param _builtins.str group_id: The group id from the provider of resource the private link service connection is for.
        ...
        :param _builtins.str provisioning_state: The provisioning state of the private link service connection. Valid values are Updating, Deleting, Failed, Succeeded, or Incomplete
        """
...
class QueryKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the query API key; may be empty.
        """
...
class SharedPrivateLinkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_region: Optional. Can be used to specify the Azure Resource Manager location of the resource to which a shared private link is to be created. This is only required for those resources whose DNS configuration are regional (such as Azure Kubernetes Service).
        :param _builtins.str status: Status of the shared private link resource. Valid values are Pending, Approved, Rejected or Disconnected.
        """
        if group_id is not None:
            pulumi.set(__self__, "group_id", group_id)
