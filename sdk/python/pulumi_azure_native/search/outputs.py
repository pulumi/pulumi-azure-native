...
class DataPlaneAadOrApiKeyAuthOptionResponse(dict):
    ...
    def __init__(__self__, *,
                 aad_auth_failure_mode: Optional[builtins.str] = None):
        """
        Indicates that either the API key or an access token from a Microsoft Entra ID tenant can be used for authentication.
        :param builtins.str aad_auth_failure_mode: Describes what response the data plane API of a search service would send for requests that failed authentication.
        """
    ...
    def aad_auth_failure_mode(self) -> Optional[builtins.str]:
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the SKU of a search service, which determines billing rate and capacity limits.
        :param builtins.str name: The SKU of the search service. Valid values include: 'free': Shared service. 'basic': Dedicated service with up to 3 replicas. 'standard': Dedicated service with up to 12 partitions and 12 replicas. 'standard2': Similar to standard, but with more capacity per search unit. 'standard3': The largest Standard offering with up to 12 partitions and 12 replicas (or up to 3 partitions with more indexes if you also set the hostingMode property to 'highDensity'). 'storage_optimized_l1': Supports 1TB per partition, up to 12 partitions. 'storage_optimized_l2': Supports 2TB per partition, up to 12 partitions.'
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
