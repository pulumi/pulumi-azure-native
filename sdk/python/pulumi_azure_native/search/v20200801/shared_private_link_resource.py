...
class SharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        shared_private_link_resource = azure_native.search.v20200801.SharedPrivateLinkResource("sharedPrivateLinkResource",
            properties=azure_native.search.v20200801.SharedPrivateLinkResourcePropertiesArgs(
                group_id="blob",
