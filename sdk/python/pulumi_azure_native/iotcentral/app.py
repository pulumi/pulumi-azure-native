...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotcentral/v20210601:App"), pulumi.Alias(type_="azure-native:iotcentral/v20211101preview:App"), pulumi.Alias(type_="azure-native_iotcentral_v20180901:iotcentral:App"), pulumi.Alias(type_="azure-native_iotcentral_v20210601:iotcentral:App"), pulumi.Alias(type_="azure-native_iotcentral_v20211101preview:iotcentral:App")])
