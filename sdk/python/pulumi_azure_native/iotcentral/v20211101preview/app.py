...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if network_rule_sets is not None and not isinstance(network_rule_sets, NetworkRuleSetsArgs):
                network_rule_sets = network_rule_sets or {}
                def _setter(key, value):
                    network_rule_sets[key] = value
                NetworkRuleSetsArgs._configure(_setter, **network_rule_sets)
