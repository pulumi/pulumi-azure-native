...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotcentral/v20211101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_iotcentral_v20211101preview:iotcentral:PrivateEndpointConnection")])
