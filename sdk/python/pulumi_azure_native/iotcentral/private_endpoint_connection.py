...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:iotcentral:PrivateEndpointConnection"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotcentral/v20211101preview:PrivateEndpointConnection")])
