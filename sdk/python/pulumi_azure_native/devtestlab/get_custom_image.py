...
class GetCustomImageResult:
    ...
    def is_plan_authorized(self) -> Optional[builtins.bool]:
        """
    ...
    def managed_image_id(self) -> Optional[builtins.str]:
        """
    ...
    def managed_snapshot_id(self) -> Optional[builtins.str]:
        """
...
def get_custom_image(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab:getCustomImage', __args__, opts=opts, typ=GetCustomImageResult).value
...
def get_custom_image_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
