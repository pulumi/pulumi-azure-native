...
class GetNotificationChannelResult:
    ...
    def web_hook_url(self) -> Optional[builtins.str]:
        """
...
def get_notification_channel(expand: Optional[builtins.str] = None,
...
def get_notification_channel_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
