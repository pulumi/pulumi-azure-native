...
class LabArgs:
    def __init__(__self__, *,
                 ...
                 environment_permission: Optional[pulumi.Input[Union[builtins.str, 'EnvironmentPermission']]] = None,
                 extended_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 lab_storage_type: Optional[pulumi.Input[Union[builtins.str, 'StorageType']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 mandatory_artifacts_resource_ids_linux: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 mandatory_artifacts_resource_ids_windows: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 premium_data_disks: Optional[pulumi.Input[Union[builtins.str, 'PremiumDataDisk']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'StorageType']] lab_storage_type: Type of storage used by the lab. It can be either Premium or Standard. Default is Premium.
        :param pulumi.Input[builtins.str] location: The location of the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mandatory_artifacts_resource_ids_linux: The ordered list of artifact resource IDs that should be applied on all Linux VM creations by default, prior to the artifacts specified by the user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mandatory_artifacts_resource_ids_windows: The ordered list of artifact resource IDs that should be applied on all Windows VM creations by default, prior to the artifacts specified by the user.
        :param pulumi.Input[builtins.str] name: The name of the lab.
    ...
    def environment_permission(self) -> Optional[pulumi.Input[Union[builtins.str, 'EnvironmentPermission']]]:
        """
    ...
    def environment_permission(self, value: Optional[pulumi.Input[Union[builtins.str, 'EnvironmentPermission']]]):
    ...
    def lab_storage_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'StorageType']]]:
        """
    ...
    def lab_storage_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'StorageType']]]):
    ...
    def mandatory_artifacts_resource_ids_linux(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def mandatory_artifacts_resource_ids_linux(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "mandatory_artifacts_resource_ids_linux", value)

    @property
    @pulumi.getter(name="mandatoryArtifactsResourceIdsWindows")
    def mandatory_artifacts_resource_ids_windows(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def mandatory_artifacts_resource_ids_windows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def premium_data_disks(self) -> Optional[pulumi.Input[Union[builtins.str, 'PremiumDataDisk']]]:
        """
    ...
    def premium_data_disks(self, value: Optional[pulumi.Input[Union[builtins.str, 'PremiumDataDisk']]]):
...
class Lab(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:devtestlab:Lab"
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:Lab"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Lab"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Lab")])
    ...
    def artifacts_storage_account(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def default_premium_storage_account(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def default_storage_account(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="environmentPermission")
    def environment_permission(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The access rights to be granted to the user when provisioning an environment
        """
        return pulumi.get(self, "environment_permission")
    ...
    @property
    @pulumi.getter(name="labStorageType")
    def lab_storage_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of storage used by the lab. It can be either Premium or Standard. Default is Premium.
        """
        return pulumi.get(self, "lab_storage_type")
    ...
    @property
    @pulumi.getter(name="mandatoryArtifactsResourceIdsLinux")
    def mandatory_artifacts_resource_ids_linux(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ordered list of artifact resource IDs that should be applied on all Linux VM creations by default, prior to the artifacts specified by the user.
        """
        return pulumi.get(self, "mandatory_artifacts_resource_ids_linux")
    ...
    @property
    @pulumi.getter(name="mandatoryArtifactsResourceIdsWindows")
    def mandatory_artifacts_resource_ids_windows(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ordered list of artifact resource IDs that should be applied on all Windows VM creations by default, prior to the artifacts specified by the user.
        """
        return pulumi.get(self, "mandatory_artifacts_resource_ids_windows")
    ...
    def premium_data_disk_storage_account(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="premiumDataDisks")
    def premium_data_disks(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The setting to enable usage of premium data disks.
        When its value is 'Enabled', creation of standard or premium data disks is allowed.
        When its value is 'Disabled', only creation of standard data disks is allowed.
    ...
    def vm_creation_resource_group(self) -> pulumi.Output[builtins.str]:
        """
