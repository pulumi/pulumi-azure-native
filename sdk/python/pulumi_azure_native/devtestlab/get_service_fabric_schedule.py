...
def get_service_fabric_schedule(expand: Optional[_builtins.str] = None,
                                lab_name: Optional[_builtins.str] = None,
                                name: Optional[_builtins.str] = None,
                                resource_group_name: Optional[_builtins.str] = None,
                                service_fabric_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_fabric_name: servicefabrics
    :param _builtins.str user_name: users
    """
    __args__ = dict()
...
def get_service_fabric_schedule_output(expand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devtestlab:getServiceFabricSchedule', __args__, opts=opts, typ=GetServiceFabricScheduleResult)
