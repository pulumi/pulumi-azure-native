...
def list_service_fabric_applicable_schedules(lab_name: Optional[builtins.str] = None,
...
def list_service_fabric_applicable_schedules_output(lab_name: Optional[pulumi.Input[builtins.str]] = None,
