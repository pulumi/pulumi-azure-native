...
class GlobalSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if daily_recurrence is not None and not isinstance(daily_recurrence, DayDetailsArgs):
            ...
            if hourly_recurrence is not None and not isinstance(hourly_recurrence, HourDetailsArgs):
            ...
            if weekly_recurrence is not None and not isinstance(weekly_recurrence, WeekDetailsArgs):
