...
class GlobalSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab/latest:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:GlobalSchedule")])
