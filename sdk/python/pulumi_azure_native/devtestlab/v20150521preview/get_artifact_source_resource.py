...
__all__ = [
    ...
    'get_artifact_source_resource_output',
]
...
def get_artifact_source_resource(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_artifact_source_resource is deprecated: Version v20150521preview will be removed in the next major version of the provider. Upgrade to version v20180915 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/v20150521preview:getArtifactSourceResource', __args__, opts=opts, typ=GetArtifactSourceResourceResult).value
...
@_utilities.lift_output_func(get_artifact_source_resource)
def get_artifact_source_resource_output(lab_name: Optional[pulumi.Input[str]] = None,
