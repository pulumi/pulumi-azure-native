...
class VirtualMachineResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:VirtualMachineResource"), pulumi.Alias(type_="azure-native:devtestlab:VirtualMachineResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualMachineResource"), pulumi.Alias(type_="azure-native:devtestlab/latest:VirtualMachineResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualMachineResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualMachineResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualMachineResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualMachineResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualMachineResource")])
