...
class FormulaResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
            __props__['vm'] = vm
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:FormulaResource"), pulumi.Alias(type_="azure-native:devtestlab:FormulaResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:FormulaResource"), pulumi.Alias(type_="azure-native:devtestlab/latest:FormulaResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:FormulaResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:FormulaResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:FormulaResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:FormulaResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:FormulaResource")])
