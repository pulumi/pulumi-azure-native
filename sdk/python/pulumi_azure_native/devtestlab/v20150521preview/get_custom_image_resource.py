...
def get_custom_image_resource(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_image_resource is deprecated: Version v20150521preview will be removed in the next major version of the provider. Upgrade to version v20180915 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/v20150521preview:getCustomImageResource', __args__, opts=opts, typ=GetCustomImageResourceResult).value
