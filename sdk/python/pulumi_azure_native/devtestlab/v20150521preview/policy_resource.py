...
class PolicyResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:PolicyResource"), pulumi.Alias(type_="azure-native:devtestlab:PolicyResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:PolicyResource"), pulumi.Alias(type_="azure-native:devtestlab/latest:PolicyResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:PolicyResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:PolicyResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:PolicyResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:PolicyResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:PolicyResource")])
