...
def get_lab_resource(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_lab_resource is deprecated: Version v20150521preview will be removed in the next major version of the provider. Upgrade to version v20180915 or later.""")
    __args__ = dict()
    __args__['name'] = name
