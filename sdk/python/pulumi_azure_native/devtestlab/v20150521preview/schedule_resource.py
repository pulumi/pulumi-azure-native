...
class ScheduleResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ScheduleResource")])
