...
class ScheduleResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab/latest:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:ScheduleResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:ScheduleResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ScheduleResource")])
