...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:VirtualNetwork'.""", DeprecationWarning)
...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetwork, __self__).__init__(
            'azure-native:devtestlab/latest:VirtualNetwork',
            resource_name,
            __props__,
            opts)
