...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:NotificationChannel'.""", DeprecationWarning)
...
class NotificationChannel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(NotificationChannel, __self__).__init__(
            'azure-native:devtestlab/latest:NotificationChannel',
            resource_name,
            __props__,
            opts)
