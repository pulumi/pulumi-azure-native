...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getVirtualMachine'.""", DeprecationWarning)
...
def get_virtual_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getVirtualMachine'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineResult).value
