...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getVirtualMachineSchedule'.""", DeprecationWarning)
...
def get_virtual_machine_schedule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getVirtualMachineSchedule', __args__, opts=opts, typ=GetVirtualMachineScheduleResult).value
