...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getFormula'.""", DeprecationWarning)
...
def get_formula(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_formula is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getFormula'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getFormula', __args__, opts=opts, typ=GetFormulaResult).value
