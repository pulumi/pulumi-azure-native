...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devtestlab/latest:ArtifactSource":
                return ArtifactSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:CustomImage":
                return CustomImage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Disk":
                return Disk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Formula":
                return Formula(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:GlobalSchedule":
                return GlobalSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Lab":
                return Lab(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:NotificationChannel":
                return NotificationChannel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Schedule":
                return Schedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:Secret":
                return Secret(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:ServiceFabric":
                return ServiceFabric(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:ServiceFabricSchedule":
                return ServiceFabricSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:ServiceRunner":
                return ServiceRunner(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:User":
                return User(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:VirtualMachine":
                return VirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:VirtualMachineSchedule":
                return VirtualMachineSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/latest:VirtualNetwork":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devtestlab/latest", _module_instance)
