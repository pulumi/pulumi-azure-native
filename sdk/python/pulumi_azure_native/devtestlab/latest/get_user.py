...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getUser'.""", DeprecationWarning)
...
def get_user(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getUser', __args__, opts=opts, typ=GetUserResult).value
