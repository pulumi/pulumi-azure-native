...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getGlobalSchedule'.""", DeprecationWarning)
...
def get_global_schedule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getGlobalSchedule', __args__, opts=opts, typ=GetGlobalScheduleResult).value
