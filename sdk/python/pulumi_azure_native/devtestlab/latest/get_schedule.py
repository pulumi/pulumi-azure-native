...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getSchedule'.""", DeprecationWarning)
...
def get_schedule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
