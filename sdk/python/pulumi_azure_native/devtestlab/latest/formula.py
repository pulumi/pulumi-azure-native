...
class Formula(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab:Formula"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:Formula"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Formula"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Formula")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Formula, __self__).__init__(
            'azure-native:devtestlab/latest:Formula',
            resource_name,
            __props__,
            opts)
