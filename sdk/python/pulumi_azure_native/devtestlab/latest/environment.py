...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:Environment'.""", DeprecationWarning)
...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Environment"), pulumi.Alias(type_="azure-native:devtestlab:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab:Environment"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Environment"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Environment, __self__).__init__(
            'azure-native:devtestlab/latest:Environment',
            resource_name,
            __props__,
            opts)
