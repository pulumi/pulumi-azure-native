...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:listVirtualMachineApplicableSchedules'.""", DeprecationWarning)
...
def list_virtual_machine_applicable_schedules(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_virtual_machine_applicable_schedules is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:listVirtualMachineApplicableSchedules'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:listVirtualMachineApplicableSchedules', __args__, opts=opts, typ=ListVirtualMachineApplicableSchedulesResult).value
