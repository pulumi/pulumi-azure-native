...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getArtifactSource'.""", DeprecationWarning)
...
def get_artifact_source(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getArtifactSource', __args__, opts=opts, typ=GetArtifactSourceResult).value
