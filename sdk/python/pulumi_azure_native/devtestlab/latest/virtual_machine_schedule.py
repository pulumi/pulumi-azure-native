...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:VirtualMachineSchedule'.""", DeprecationWarning)
...
class VirtualMachineSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualMachineSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineSchedule, __self__).__init__(
            'azure-native:devtestlab/latest:VirtualMachineSchedule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'VirtualMachineSchedule':
        """
