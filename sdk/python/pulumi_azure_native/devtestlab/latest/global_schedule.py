...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:GlobalSchedule'.""", DeprecationWarning)
...
class GlobalSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""GlobalSchedule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:GlobalSchedule'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:GlobalSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:GlobalSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:GlobalSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GlobalSchedule, __self__).__init__(
            'azure-native:devtestlab/latest:GlobalSchedule',
            resource_name,
            __props__,
            opts)
