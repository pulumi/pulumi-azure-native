...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getDisk'.""", DeprecationWarning)
...
def get_disk(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getDisk', __args__, opts=opts, typ=GetDiskResult).value
