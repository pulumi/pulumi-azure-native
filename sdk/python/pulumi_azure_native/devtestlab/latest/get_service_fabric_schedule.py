...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getServiceFabricSchedule'.""", DeprecationWarning)
...
def get_service_fabric_schedule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getServiceFabricSchedule', __args__, opts=opts, typ=GetServiceFabricScheduleResult).value
