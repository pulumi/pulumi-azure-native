...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_machine_creation_source: Optional[pulumi.Input[Union[str, 'VirtualMachineCreationSource']]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualMachine is deprecated: Version 2016-05-15 will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab:VirtualMachine"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:VirtualMachine"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualMachine")])
