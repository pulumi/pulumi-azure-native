...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Environment"), pulumi.Alias(type_="azure-native:devtestlab:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab:Environment"), pulumi.Alias(type_="azure-native:devtestlab/latest:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Environment"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Environment")])
