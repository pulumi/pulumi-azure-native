...
class VirtualNetwork(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/latest:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualNetwork")])
