...
def get_service_runner(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_runner is deprecated: Version v20160515 will be removed in the next major version of the provider. Upgrade to version v20180915 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/v20160515:getServiceRunner', __args__, opts=opts, typ=GetServiceRunnerResult).value
