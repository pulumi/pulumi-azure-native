...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devtestlab/v20160515:ArtifactSource":
                return ArtifactSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:CustomImage":
                return CustomImage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Disk":
                return Disk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Formula":
                return Formula(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:GlobalSchedule":
                return GlobalSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Lab":
                return Lab(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:NotificationChannel":
                return NotificationChannel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Policy":
                return Policy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Schedule":
                return Schedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:Secret":
                return Secret(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:ServiceRunner":
                return ServiceRunner(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:User":
                return User(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:VirtualMachine":
                return VirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:VirtualMachineSchedule":
                return VirtualMachineSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devtestlab/v20160515:VirtualNetwork":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devtestlab/v20160515", _module_instance)
