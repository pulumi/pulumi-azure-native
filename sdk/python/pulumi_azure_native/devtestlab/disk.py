...
class DiskArgs:
    def __init__(__self__, *,
                 ...
                 disk_blob_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 disk_uri: Optional[pulumi.Input[builtins.str]] = None,
                 host_caching: Optional[pulumi.Input[builtins.str]] = None,
                 leased_by_lab_vm_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] disk_uri: When backed by a blob, the URI of underlying blob.
        :param pulumi.Input[builtins.str] host_caching: The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).
    ...
    def disk_blob_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_blob_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def disk_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @disk_uri.setter
    def disk_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disk_uri", value)

    @property
    @pulumi.getter(name="hostCaching")
    def host_caching(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @host_caching.setter
    def host_caching(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_caching", value)

    @property
    @pulumi.getter(name="leasedByLabVmId")
    def leased_by_lab_vm_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def leased_by_lab_vm_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Disk(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab/v20160515:Disk"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Disk")])
    ...
    @property
    @pulumi.getter(name="diskBlobName")
    def disk_blob_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When backed by a blob, the name of the VHD blob without extension.
        """
        return pulumi.get(self, "disk_blob_name")
    ...
    @property
    @pulumi.getter(name="diskSizeGiB")
    def disk_size_gi_b(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The size of the disk in Gibibytes.
        """
        return pulumi.get(self, "disk_size_gi_b")
    ...
    @property
    @pulumi.getter(name="diskUri")
    def disk_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When backed by a blob, the URI of underlying blob.
        """
        return pulumi.get(self, "disk_uri")
    ...
    @property
    @pulumi.getter(name="hostCaching")
    def host_caching(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).
        """
        return pulumi.get(self, "host_caching")
    ...
    @property
    @pulumi.getter(name="leasedByLabVmId")
    def leased_by_lab_vm_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of the VM to which this disk is leased.
        """
        return pulumi.get(self, "leased_by_lab_vm_id")
    ...
    @property
    @pulumi.getter(name="managedDiskId")
    def managed_disk_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When backed by managed disk, this is the ID of the compute disk resource.
        """
        return pulumi.get(self, "managed_disk_id")
