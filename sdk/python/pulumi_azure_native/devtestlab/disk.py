...
class DiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] disk_size_gi_b: The size of the disk in Gibibytes.
        :param pulumi.Input[Union[_builtins.str, 'StorageType']] disk_type: The storage type for the disk (i.e. Standard, Premium).
        :param pulumi.Input[_builtins.str] disk_uri: When backed by a blob, the URI of underlying blob.
        :param pulumi.Input[_builtins.str] host_caching: The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).
