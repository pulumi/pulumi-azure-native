...
class DiskArgs:
    ...
    def _configure(
        ...
        if disk_blob_name is None and 'diskBlobName' in kwargs:
            disk_blob_name = kwargs['diskBlobName']
        ...
        if leased_by_lab_vm_id is None and 'leasedByLabVmId' in kwargs:
            leased_by_lab_vm_id = kwargs['leasedByLabVmId']
