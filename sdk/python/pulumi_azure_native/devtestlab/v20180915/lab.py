...
class LabArgs:
    ...
    def _configure(
        ...
        if environment_permission is None and 'environmentPermission' in kwargs:
        ...
        if lab_storage_type is None and 'labStorageType' in kwargs:
            lab_storage_type = kwargs['labStorageType']
        if mandatory_artifacts_resource_ids_linux is None and 'mandatoryArtifactsResourceIdsLinux' in kwargs:
            mandatory_artifacts_resource_ids_linux = kwargs['mandatoryArtifactsResourceIdsLinux']
        if mandatory_artifacts_resource_ids_windows is None and 'mandatoryArtifactsResourceIdsWindows' in kwargs:
            mandatory_artifacts_resource_ids_windows = kwargs['mandatoryArtifactsResourceIdsWindows']
        if premium_data_disks is None and 'premiumDataDisks' in kwargs:
...
class Lab(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            announcement = _utilities.configure(announcement, LabAnnouncementPropertiesArgs, True)
            ...
            support = _utilities.configure(support, LabSupportPropertiesArgs, True)
