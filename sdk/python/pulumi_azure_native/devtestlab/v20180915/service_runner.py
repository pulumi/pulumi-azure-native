...
class ServiceRunner(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab/v20160515:ServiceRunner"), pulumi.Alias(type_="azure-native:devtestlab:ServiceRunner")])
