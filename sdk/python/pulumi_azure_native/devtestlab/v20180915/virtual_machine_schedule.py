...
class VirtualMachineSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_machine_schedule = azure_native.devtestlab.v20180915.VirtualMachineSchedule("virtualMachineSchedule",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualMachineSchedule")])
