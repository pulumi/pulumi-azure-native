...
class ServiceFabricSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ServiceFabricSchedule"), pulumi.Alias(type_="azure-native:devtestlab:ServiceFabricSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:ServiceFabricSchedule"), pulumi.Alias(type_="azure-native:devtestlab/latest:ServiceFabricSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ServiceFabricSchedule")])
