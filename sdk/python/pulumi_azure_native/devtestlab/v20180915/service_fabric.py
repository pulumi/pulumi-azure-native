...
class ServiceFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ServiceFabric"), pulumi.Alias(type_="azure-native:devtestlab:ServiceFabric"), pulumi.Alias(type_="azure-nextgen:devtestlab:ServiceFabric")])
