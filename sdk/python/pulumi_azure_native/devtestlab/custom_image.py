...
class CustomImageArgs:
    ...
    def _configure(
        ...
        if custom_image_plan is None and 'customImagePlan' in kwargs:
            custom_image_plan = kwargs['customImagePlan']
        if data_disk_storage_info is None and 'dataDiskStorageInfo' in kwargs:
            data_disk_storage_info = kwargs['dataDiskStorageInfo']
        ...
        if managed_snapshot_id is None and 'managedSnapshotId' in kwargs:
            managed_snapshot_id = kwargs['managedSnapshotId']
...
class CustomImage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            custom_image_plan = _utilities.configure(custom_image_plan, CustomImagePropertiesFromPlanArgs, True)
            ...
            vhd = _utilities.configure(vhd, CustomImagePropertiesCustomArgs, True)
            __props__.__dict__["vhd"] = vhd
            vm = _utilities.configure(vm, CustomImagePropertiesFromVmArgs, True)
