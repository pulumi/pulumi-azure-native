...
class CustomImageArgs:
    ...
    def _configure(
        ...
        if 'customImagePlan' in kwargs:
            custom_image_plan = kwargs['customImagePlan']
        if 'dataDiskStorageInfo' in kwargs:
        ...
        if 'managedSnapshotId' in kwargs:
...
class CustomImage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if custom_image_plan is not None and not isinstance(custom_image_plan, CustomImagePropertiesFromPlanArgs):
            ...
            if vhd is not None and not isinstance(vhd, CustomImagePropertiesCustomArgs):
                vhd = vhd or {}
                def _setter(key, value):
                    vhd[key] = value
                CustomImagePropertiesCustomArgs._configure(_setter, **vhd)
            __props__.__dict__["vhd"] = vhd
            if vm is not None and not isinstance(vm, CustomImagePropertiesFromVmArgs):
                vm = vm or {}
                def _setter(key, value):
                    vm[key] = value
