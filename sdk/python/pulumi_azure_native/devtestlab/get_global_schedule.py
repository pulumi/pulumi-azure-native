...
def get_global_schedule(expand: Optional[builtins.str] = None,
...
def get_global_schedule_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devtestlab:getGlobalSchedule', __args__, opts=opts, typ=GetGlobalScheduleResult)
    return __ret__.apply(lambda __response__: GetGlobalScheduleResult(
