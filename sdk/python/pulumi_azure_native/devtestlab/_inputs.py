...
class ArtifactInstallPropertiesArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ArtifactParameterPropertiesArgs']]]]]
    """
...
class ArtifactInstallPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] install_time: The time that the artifact starts to install on the virtual machine.
        :param pulumi.Input[Sequence[pulumi.Input['ArtifactParameterPropertiesArgs']]] parameters: The parameters of the artifact.
        :param pulumi.Input[_builtins.str] status: The status of the artifact.
        :param pulumi.Input[_builtins.str] vm_extension_status_message: The status message from the virtual machine extension.
        """
...
class CustomImagePropertiesFromVmArgsDict(TypedDict):
    ...
    """
    linux_os_info: NotRequired[pulumi.Input[Optional['LinuxOsInfoArgs']]]
    """
    ...
    """
    windows_os_info: NotRequired[pulumi.Input[Optional['WindowsOsInfoArgs']]]
    """
...
class DataDiskPropertiesArgsDict(TypedDict):
    ...
    """
    attach_new_data_disk_options: NotRequired[pulumi.Input[Optional['AttachNewDataDiskOptionsArgs']]]
    """
...
class EnvironmentDeploymentPropertiesArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ArmTemplateParameterPropertiesArgs']]]]]
    """
...
class GalleryImageReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sku: The SKU of the gallery image.
        :param pulumi.Input[_builtins.str] version: The version of the gallery image.
        """
        if offer is not None:
            pulumi.set(__self__, "offer", offer)
...
class IdentityPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ManagedIdentityType']] type: Managed identity.
        """
...
class LabAnnouncementPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] title: The plain text title for the lab announcement
        """
...
class LabVirtualMachineCreationParameterArgsDict(TypedDict):
    ...
    """
    artifacts: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ArtifactInstallPropertiesArgs']]]]]
    """
    The artifacts to be installed on the virtual machine.
    """
    bulk_creation_parameters: NotRequired[pulumi.Input[Optional['BulkCreationParametersArgs']]]
    """
    The number of virtual machine instances to create.
    """
    ...
    """
    data_disk_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DataDiskPropertiesArgs']]]]]
    """
    ...
    """
    gallery_image_reference: NotRequired[pulumi.Input[Optional['GalleryImageReferenceArgs']]]
    """
    ...
    """
    network_interface: NotRequired[pulumi.Input[Optional['NetworkInterfacePropertiesArgs']]]
    """
    ...
    """
    schedule_parameters: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ScheduleCreationParameterArgs']]]]]
    """
...
class LabVirtualMachineCreationParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_date: The creation date of the virtual machine.
        :param pulumi.Input[_builtins.str] custom_image_id: The custom image identifier of the virtual machine.
        ...
        :param pulumi.Input[_builtins.bool] disallow_public_ip_address: Indicates whether the virtual machine is to be created without a public IP address.
        :param pulumi.Input[_builtins.str] environment_id: The resource ID of the environment that contains this virtual machine, if any.
        :param pulumi.Input[_builtins.str] expiration_date: The expiration date for VM.
        ...
        :param pulumi.Input[_builtins.str] location: The location of the new virtual machine or environment
        ...
        :param pulumi.Input[_builtins.str] owner_user_principal_name: The user principal name of the virtual machine owner.
        :param pulumi.Input[_builtins.str] password: The password of the virtual machine administrator.
        :param pulumi.Input[_builtins.str] plan_id: The id of the plan associated with the virtual machine image
...
class NetworkInterfacePropertiesArgsDict(TypedDict):
    ...
    """
    shared_public_ip_address_configuration: NotRequired[pulumi.Input[Optional['SharedPublicIpAddressConfigurationArgs']]]
    """
...
class NetworkInterfacePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_ip_address_id: The resource ID of the public IP address.
        :param pulumi.Input[_builtins.str] rdp_authority: The RdpAuthority property is a server DNS host name or IP address followed by the service port number for RDP (Remote Desktop Protocol).
        ...
        :param pulumi.Input[_builtins.str] ssh_authority: The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
        :param pulumi.Input[_builtins.str] subnet_id: The resource ID of the sub net.
        :param pulumi.Input[_builtins.str] virtual_network_id: The resource ID of the virtual network.
        """
...
class ScheduleCreationParameterArgsDict(TypedDict):
    ...
    """
    daily_recurrence: NotRequired[pulumi.Input[Optional['DayDetailsArgs']]]
    """
    If the schedule will occur once each day of the week, specify the daily recurrence.
    """
    hourly_recurrence: NotRequired[pulumi.Input[Optional['HourDetailsArgs']]]
    """
    ...
    The name of the virtual machine or environment
    """
    notification_settings: NotRequired[pulumi.Input[Optional['NotificationSettingsArgs']]]
    """
    ...
    """
    weekly_recurrence: NotRequired[pulumi.Input[Optional['WeekDetailsArgs']]]
    """
...
class SharedPublicIpAddressConfigurationArgsDict(TypedDict):
    ...
    """
    inbound_nat_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InboundNatRuleArgs']]]]]
    """
...
class SubnetOverrideArgsDict(TypedDict):
    ...
    """
    shared_public_ip_address_configuration: NotRequired[pulumi.Input[Optional['SubnetSharedPublicIpAddressConfigurationArgs']]]
    """
...
class SubnetOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'UsagePermissionType']] use_in_vm_creation_permission: Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
        :param pulumi.Input[Union[_builtins.str, 'UsagePermissionType']] use_public_ip_address_permission: Indicates whether public IP addresses can be assigned to virtual machines on this subnet (i.e. Allow, Deny).
        :param pulumi.Input[_builtins.str] virtual_network_pool_name: The virtual network pool associated with this subnet.
        """
        if lab_subnet_name is not None:
            pulumi.set(__self__, "lab_subnet_name", lab_subnet_name)
...
class SubnetSharedPublicIpAddressConfigurationArgsDict(TypedDict):
    ...
    """
    allowed_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PortArgs']]]]]
    """
...
class UserIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] principal_name: Set to the principal name / UPN of the client JWT making the request.
        :param pulumi.Input[_builtins.str] tenant_id: Set to the tenant ID of the client JWT making the request.
        """
