...
class VirtualNetworkArgs:
    def __init__(__self__, *,
        ...
        VirtualNetworkArgs._configure(
            ...
            external_provider_resource_id=external_provider_resource_id,
            location=location,
            name=name,
    ...
    def _configure(
        ...
        if allowed_subnets is None and 'allowedSubnets' in kwargs:
            allowed_subnets = kwargs['allowedSubnets']
        if external_provider_resource_id is None and 'externalProviderResourceId' in kwargs:
            external_provider_resource_id = kwargs['externalProviderResourceId']
        if subnet_overrides is None and 'subnetOverrides' in kwargs:
            subnet_overrides = kwargs['subnetOverrides']

        _setter("lab_name", lab_name)
        _setter("resource_group_name", resource_group_name)
        if allowed_subnets is not None:
            _setter("allowed_subnets", allowed_subnets)
        if description is not None:
            _setter("description", description)
        if external_provider_resource_id is not None:
            _setter("external_provider_resource_id", external_provider_resource_id)
        if location is not None:
            _setter("location", location)
        if name is not None:
            _setter("name", name)
        if subnet_overrides is not None:
            _setter("subnet_overrides", subnet_overrides)
        if tags is not None:
            _setter("tags", tags)
