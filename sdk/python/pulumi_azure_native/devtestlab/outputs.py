...
class ArtifactDeploymentStatusPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 artifacts_applied: Optional[_builtins.int] = None,
...
class ArtifactInstallPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 artifact_title: Optional[_builtins.str] = None,
                 deployment_status_message: Optional[_builtins.str] = None,
                 install_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str install_time: The time that the artifact starts to install on the virtual machine.
        :param Sequence['ArtifactParameterPropertiesResponse'] parameters: The parameters of the artifact.
        :param _builtins.str status: The status of the artifact.
        :param _builtins.str vm_extension_status_message: The status message from the virtual machine extension.
        """
...
class ComputeDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Gets data disk name.
        """
        if disk_size_gi_b is not None:
            pulumi.set(__self__, "disk_size_gi_b", disk_size_gi_b)
...
class ComputeVmPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str os_disk_id: Gets OS disk blob uri for the virtual machine.
        :param _builtins.str os_type: Gets the OS type of the virtual machine.
        :param Sequence['ComputeVmInstanceViewStatusResponse'] statuses: Gets the statuses of the virtual machine.
        :param _builtins.str vm_size: Gets the size of the virtual machine.
        """
...
class CustomImagePropertiesFromVmResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_vm_id: Optional[_builtins.str] = None,
...
class DataDiskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 existing_lab_disk_id: Optional[_builtins.str] = None,
...
class DataDiskStorageTypeInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 lun: Optional[_builtins.str] = None,
...
class EnvironmentDeploymentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 arm_template_id: Optional[_builtins.str] = None,
...
class GalleryImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sku: The SKU of the gallery image.
        :param _builtins.str version: The version of the gallery image.
        """
        if offer is not None:
            pulumi.set(__self__, "offer", offer)
        if os_type is not None:
...
class IdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 client_secret_url: Optional[_builtins.str] = None,
        ...
        :param _builtins.str type: Managed identity.
        """
...
class LabAnnouncementPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str expiration_date: The time at which the announcement expires (null for never)
        :param _builtins.bool expired: Has this announcement expired?
        ...
        :param _builtins.str title: The plain text title for the lab announcement
        """
...
class LabVirtualMachineCreationParameterResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_claim: Optional[_builtins.bool] = None,
                 ...
                 disallow_public_ip_address: Optional[_builtins.bool] = None,
                 environment_id: Optional[_builtins.str] = None,
                 expiration_date: Optional[_builtins.str] = None,
                 gallery_image_reference: Optional['outputs.GalleryImageReferenceResponse'] = None,
                 is_authentication_with_ssh_key: Optional[_builtins.bool] = None,
                 lab_subnet_name: Optional[_builtins.str] = None,
                 lab_virtual_network_id: Optional[_builtins.str] = None,
                 location: Optional[_builtins.str] = None,
                 name: Optional[_builtins.str] = None,
                 network_interface: Optional['outputs.NetworkInterfacePropertiesResponse'] = None,
                 notes: Optional[_builtins.str] = None,
                 owner_object_id: Optional[_builtins.str] = None,
                 owner_user_principal_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str created_date: The creation date of the virtual machine.
        :param _builtins.str custom_image_id: The custom image identifier of the virtual machine.
        ...
        :param _builtins.bool disallow_public_ip_address: Indicates whether the virtual machine is to be created without a public IP address.
        :param _builtins.str environment_id: The resource ID of the environment that contains this virtual machine, if any.
        :param _builtins.str expiration_date: The expiration date for VM.
        ...
        :param _builtins.bool is_authentication_with_ssh_key: Indicates whether this virtual machine uses an SSH key for authentication.
        :param _builtins.str lab_subnet_name: The lab subnet name of the virtual machine.
        :param _builtins.str lab_virtual_network_id: The lab virtual network identifier of the virtual machine.
        :param _builtins.str location: The location of the new virtual machine or environment
        :param _builtins.str name: The name of the virtual machine or environment
        :param 'NetworkInterfacePropertiesResponse' network_interface: The network interface properties.
        :param _builtins.str notes: The notes of the virtual machine.
        :param _builtins.str owner_object_id: The object identifier of the owner of the virtual machine.
        :param _builtins.str owner_user_principal_name: The user principal name of the virtual machine owner.
        :param _builtins.str password: The password of the virtual machine administrator.
        :param _builtins.str plan_id: The id of the plan associated with the virtual machine image
        :param Sequence['ScheduleCreationParameterResponse'] schedule_parameters: Virtual Machine schedules to be created
        :param _builtins.str size: The size of the virtual machine.
        :param _builtins.str ssh_key: The SSH key of the virtual machine administrator.
        :param _builtins.str storage_type: Storage type to use for virtual machine (i.e. Standard, Premium).
        :param Mapping[str, _builtins.str] tags: The tags of the resource.
        :param _builtins.str user_name: The user name of the virtual machine.
        """
...
class NetworkInterfacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str public_ip_address_id: The resource ID of the public IP address.
        :param _builtins.str rdp_authority: The RdpAuthority property is a server DNS host name or IP address followed by the service port number for RDP (Remote Desktop Protocol).
        ...
        :param _builtins.str ssh_authority: The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
        :param _builtins.str subnet_id: The resource ID of the sub net.
        :param _builtins.str virtual_network_id: The resource ID of the virtual network.
        """
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 email_recipient: Optional[_builtins.str] = None,
                 notification_locale: Optional[_builtins.str] = None,
                 status: Optional[_builtins.str] = None,
...
class SubnetOverrideResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_in_vm_creation_permission: Optional[_builtins.str] = None,
                 use_public_ip_address_permission: Optional[_builtins.str] = None,
        ...
        :param _builtins.str use_in_vm_creation_permission: Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
        :param _builtins.str use_public_ip_address_permission: Indicates whether public IP addresses can be assigned to virtual machines on this subnet (i.e. Allow, Deny).
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_public_ip: Optional[_builtins.str] = None,
                 lab_subnet_name: Optional[_builtins.str] = None,
                 resource_id: Optional[_builtins.str] = None):
        """
        Subnet information.
...
class UserIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str principal_name: Set to the principal name / UPN of the client JWT making the request.
        :param _builtins.str tenant_id: Set to the tenant ID of the client JWT making the request.
        """
