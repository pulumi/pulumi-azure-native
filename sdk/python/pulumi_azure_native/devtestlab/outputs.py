...
class ArmTemplateParameterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of an Azure Resource Manager template parameter.
        :param builtins.str name: The name of the template parameter.
        :param builtins.str value: The value of the template parameter.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class ArtifactDeploymentStatusPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 artifacts_applied: Optional[builtins.int] = None,
                 deployment_status: Optional[builtins.str] = None,
                 total_artifacts: Optional[builtins.int] = None):
        """
        Properties of an artifact deployment.
        :param builtins.int artifacts_applied: The total count of the artifacts that were successfully applied.
        :param builtins.str deployment_status: The deployment status of the artifact.
        :param builtins.int total_artifacts: The total count of the artifacts that were tentatively applied.
        """
    ...
    def artifacts_applied(self) -> Optional[builtins.int]:
        """
    ...
    def total_artifacts(self) -> Optional[builtins.int]:
        """
...
class ArtifactInstallPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 artifact_title: Optional[builtins.str] = None,
                 deployment_status_message: Optional[builtins.str] = None,
                 install_time: Optional[builtins.str] = None,
                 parameters: Optional[Sequence['outputs.ArtifactParameterPropertiesResponse']] = None,
                 status: Optional[builtins.str] = None,
                 vm_extension_status_message: Optional[builtins.str] = None):
        """
        Properties of an artifact.
        :param builtins.str artifact_id: The artifact's identifier.
        :param builtins.str artifact_title: The artifact's title.
        :param builtins.str deployment_status_message: The status message from the deployment.
        :param builtins.str install_time: The time that the artifact starts to install on the virtual machine.
        :param Sequence['ArtifactParameterPropertiesResponse'] parameters: The parameters of the artifact.
        :param builtins.str status: The status of the artifact.
        :param builtins.str vm_extension_status_message: The status message from the virtual machine extension.
        """
    ...
    def artifact_title(self) -> Optional[builtins.str]:
        """
    ...
    def deployment_status_message(self) -> Optional[builtins.str]:
        """
    ...
    def install_time(self) -> Optional[builtins.str]:
        """
    ...
    def vm_extension_status_message(self) -> Optional[builtins.str]:
        """
...
class ArtifactParameterPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of an artifact parameter.
        :param builtins.str name: The name of the artifact parameter.
        :param builtins.str value: The value of the artifact parameter.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class AttachNewDataDiskOptionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties to attach new disk to the Virtual Machine.
        :param builtins.str disk_name: The name of the disk to be attached.
        :param builtins.int disk_size_gi_b: Size of the disk to be attached in Gibibytes.
        :param builtins.str disk_type: The storage type for the disk (i.e. Standard, Premium).
        """
...
class BulkCreationParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameters for creating multiple virtual machines as a single action.
        :param builtins.int instance_count: The number of virtual machine instances to create.
        """
...
class ComputeDataDiskResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_disk_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None):
        """
        A data disks attached to a virtual machine.
        :param builtins.int disk_size_gi_b: Gets data disk size in GiB.
        :param builtins.str disk_uri: When backed by a blob, the URI of underlying blob.
        :param builtins.str managed_disk_id: When backed by managed disk, this is the ID of the compute disk resource.
        :param builtins.str name: Gets data disk name.
        """
        if disk_size_gi_b is not None:
            pulumi.set(__self__, "disk_size_gi_b", disk_size_gi_b)
...
class ComputeVmInstanceViewStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Status information about a virtual machine.
        :param builtins.str code: Gets the status Code.
        :param builtins.str display_status: Gets the short localizable label for the status.
        :param builtins.str message: Gets the message associated with the status.
        """
        if code is not None:
...
class ComputeVmPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 data_disk_ids: Optional[Sequence[builtins.str]] = None,
        ...
        """
        Properties of a virtual machine returned by the Microsoft.Compute API.
        :param Sequence[builtins.str] data_disk_ids: Gets data disks blob uri for the virtual machine.
        :param Sequence['ComputeDataDiskResponse'] data_disks: Gets all data disks attached to the virtual machine.
        :param builtins.str network_interface_id: Gets the network interface ID of the virtual machine.
        :param builtins.str os_disk_id: Gets OS disk blob uri for the virtual machine.
        :param builtins.str os_type: Gets the OS type of the virtual machine.
        :param Sequence['ComputeVmInstanceViewStatusResponse'] statuses: Gets the statuses of the virtual machine.
        :param builtins.str vm_size: Gets the size of the virtual machine.
        """
    ...
    def data_disk_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CustomImagePropertiesCustomResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sys_prep: Optional[builtins.bool] = None):
        """
        Properties for creating a custom image from a VHD.
        :param builtins.str os_type: The OS type of the custom image (i.e. Windows, Linux)
        :param builtins.str image_name: The image name.
        :param builtins.bool sys_prep: Indicates whether sysprep has been run on the VHD.
        """
        pulumi.set(__self__, "os_type", os_type)
    ...
    def sys_prep(self) -> Optional[builtins.bool]:
        """
...
class CustomImagePropertiesFromPlanResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties for plan on a custom image.
        :param builtins.str id: The id of the plan, equivalent to name of the plan
        :param builtins.str offer: The offer for the plan from the marketplace image the custom image is derived from
        :param builtins.str publisher: The publisher for the plan from the marketplace image the custom image is derived from
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class CustomImagePropertiesFromVmResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_vm_id: Optional[builtins.str] = None,
        ...
        :param builtins.str source_vm_id: The source vm identifier.
    ...
    def source_vm_id(self) -> Optional[builtins.str]:
        """
...
class DataDiskPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 existing_lab_disk_id: Optional[builtins.str] = None,
        ...
        :param builtins.str existing_lab_disk_id: Specifies the existing lab disk id to attach to virtual machine.
        :param builtins.str host_caching: Caching option for a data disk (i.e. None, ReadOnly, ReadWrite).
        """
    ...
    def existing_lab_disk_id(self) -> Optional[builtins.str]:
        """
...
class DataDiskStorageTypeInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 lun: Optional[builtins.str] = None,
                 storage_type: Optional[builtins.str] = None):
        """
        Storage information about the data disks present in the custom image
        :param builtins.str lun: Disk Lun
        :param builtins.str storage_type: Disk Storage Type
        """
        if lun is not None:
    ...
    @property
    @pulumi.getter
    def lun(self) -> Optional[builtins.str]:
        """
        Disk Lun
        """
...
class DayDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a daily schedule.
        :param builtins.str time: The time of day the schedule will occur.
        """
        if time is not None:
...
class EnvironmentDeploymentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 arm_template_id: Optional[builtins.str] = None,
                 parameters: Optional[Sequence['outputs.ArmTemplateParameterPropertiesResponse']] = None):
        """
        Properties of an environment deployment.
        :param builtins.str arm_template_id: The Azure Resource Manager template's identifier.
    ...
    def arm_template_id(self) -> Optional[builtins.str]:
        """
...
class EventResponse(dict):
    ...
    def __init__(__self__, *,
                 event_name: Optional[builtins.str] = None):
        """
        An event to be notified for.
        :param builtins.str event_name: The event type for which this notification is enabled (i.e. AutoShutdown, Cost)
        """
    ...
    def event_name(self) -> Optional[builtins.str]:
        """
...
class FormulaPropertiesFromVmResponse(dict):
    ...
    def __init__(__self__, *,
                 lab_vm_id: Optional[builtins.str] = None):
        """
        Information about a VM from which a formula is to be created.
        :param builtins.str lab_vm_id: The identifier of the VM from which a formula is to be created.
        """
    ...
    def lab_vm_id(self) -> Optional[builtins.str]:
        """
...
class GalleryImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The reference information for an Azure Marketplace image.
        :param builtins.str offer: The offer of the gallery image.
        :param builtins.str os_type: The OS type of the gallery image.
        :param builtins.str publisher: The publisher of the gallery image.
        :param builtins.str sku: The SKU of the gallery image.
        :param builtins.str version: The version of the gallery image.
        """
        if offer is not None:
            pulumi.set(__self__, "offer", offer)
        if os_type is not None:
...
class IdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 client_secret_url: Optional[builtins.str] = None,
                 principal_id: Optional[builtins.str] = None,
                 tenant_id: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        Properties of a managed identity
        :param builtins.str client_secret_url: The client secret URL of the identity.
        :param builtins.str principal_id: The principal id of resource identity.
        :param builtins.str tenant_id: The tenant identifier of resource.
        :param builtins.str type: Managed identity.
        """
    ...
    def client_secret_url(self) -> Optional[builtins.str]:
        """
...
class InboundNatRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A rule for NAT - exposing a VM's port (backendPort) on the public IP address using a load balancer.
        :param builtins.int backend_port: The port to which the external traffic will be redirected.
        :param builtins.int frontend_port: The external endpoint port of the inbound connection. Possible values range between 1 and 65535, inclusive. If unspecified, a value will be allocated automatically.
        :param builtins.str transport_protocol: The transport protocol for the endpoint.
        """
...
class LabAnnouncementPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 markdown: Optional[builtins.str] = None,
                 title: Optional[builtins.str] = None):
        """
        Properties of a lab's announcement banner
        :param builtins.str provisioning_state: The provisioning status of the resource.
        :param builtins.str unique_identifier: The unique immutable identifier of a resource (Guid).
        :param builtins.str enabled: Is the lab announcement active/enabled at this time?
        :param builtins.str expiration_date: The time at which the announcement expires (null for never)
        :param builtins.bool expired: Has this announcement expired?
        :param builtins.str markdown: The markdown text (if any) that this lab displays in the UI. If left empty/null, nothing will be shown.
        :param builtins.str title: The plain text title for the lab announcement
        """
    ...
    @property
    @pulumi.getter
    def markdown(self) -> Optional[builtins.str]:
        """
...
class LabSupportPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a lab's support banner
        :param builtins.str enabled: Is the lab support banner active/enabled at this time?
        :param builtins.str markdown: The markdown text (if any) that this lab displays in the UI. If left empty/null, nothing will be shown.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class LabVhdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a VHD in the lab.
        :param builtins.str id: The URI to the VHD.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class LabVirtualMachineCreationParameterResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_claim: Optional[builtins.bool] = None,
                 ...
                 disallow_public_ip_address: Optional[builtins.bool] = None,
                 environment_id: Optional[builtins.str] = None,
                 expiration_date: Optional[builtins.str] = None,
                 gallery_image_reference: Optional['outputs.GalleryImageReferenceResponse'] = None,
                 is_authentication_with_ssh_key: Optional[builtins.bool] = None,
                 lab_subnet_name: Optional[builtins.str] = None,
                 lab_virtual_network_id: Optional[builtins.str] = None,
                 location: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 network_interface: Optional['outputs.NetworkInterfacePropertiesResponse'] = None,
                 notes: Optional[builtins.str] = None,
                 owner_object_id: Optional[builtins.str] = None,
                 owner_user_principal_name: Optional[builtins.str] = None,
        ...
        """
        Properties for creating a virtual machine.
        :param builtins.bool allow_claim: Indicates whether another user can take ownership of the virtual machine
        ...
        :param builtins.str created_date: The creation date of the virtual machine.
        :param builtins.str custom_image_id: The custom image identifier of the virtual machine.
        ...
        :param builtins.bool disallow_public_ip_address: Indicates whether the virtual machine is to be created without a public IP address.
        :param builtins.str environment_id: The resource ID of the environment that contains this virtual machine, if any.
        :param builtins.str expiration_date: The expiration date for VM.
        ...
        :param builtins.bool is_authentication_with_ssh_key: Indicates whether this virtual machine uses an SSH key for authentication.
        :param builtins.str lab_subnet_name: The lab subnet name of the virtual machine.
        :param builtins.str lab_virtual_network_id: The lab virtual network identifier of the virtual machine.
        :param builtins.str location: The location of the new virtual machine or environment
        :param builtins.str name: The name of the virtual machine or environment
        :param 'NetworkInterfacePropertiesResponse' network_interface: The network interface properties.
        :param builtins.str notes: The notes of the virtual machine.
        :param builtins.str owner_object_id: The object identifier of the owner of the virtual machine.
        :param builtins.str owner_user_principal_name: The user principal name of the virtual machine owner.
        :param builtins.str password: The password of the virtual machine administrator.
        :param builtins.str plan_id: The id of the plan associated with the virtual machine image
        :param Sequence['ScheduleCreationParameterResponse'] schedule_parameters: Virtual Machine schedules to be created
        :param builtins.str size: The size of the virtual machine.
        :param builtins.str ssh_key: The SSH key of the virtual machine administrator.
        :param builtins.str storage_type: Storage type to use for virtual machine (i.e. Standard, Premium).
        :param Mapping[str, builtins.str] tags: The tags of the resource.
        :param builtins.str user_name: The user name of the virtual machine.
        """
...
class LinuxOsInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 linux_os_state: Optional[builtins.str] = None):
        """
        Information about a Linux OS.
        :param builtins.str linux_os_state: The state of the Linux OS (i.e. NonDeprovisioned, DeprovisionRequested, DeprovisionApplied).
        """
    ...
    def linux_os_state(self) -> Optional[builtins.str]:
        """
...
class NetworkInterfacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rdp_authority: Optional[builtins.str] = None,
                 shared_public_ip_address_configuration: Optional['outputs.SharedPublicIpAddressConfigurationResponse'] = None,
                 ssh_authority: Optional[builtins.str] = None,
                 subnet_id: Optional[builtins.str] = None,
                 virtual_network_id: Optional[builtins.str] = None):
        """
        Properties of a network interface.
        :param builtins.str dns_name: The DNS name.
        :param builtins.str private_ip_address: The private IP address.
        :param builtins.str public_ip_address: The public IP address.
        :param builtins.str public_ip_address_id: The resource ID of the public IP address.
        :param builtins.str rdp_authority: The RdpAuthority property is a server DNS host name or IP address followed by the service port number for RDP (Remote Desktop Protocol).
        ...
        :param builtins.str ssh_authority: The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
        :param builtins.str subnet_id: The resource ID of the sub net.
    ...
    def rdp_authority(self) -> Optional[builtins.str]:
        """
    ...
    def ssh_authority(self) -> Optional[builtins.str]:
        """
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 email_recipient: Optional[builtins.str] = None,
                 notification_locale: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None,
                 time_in_minutes: Optional[builtins.int] = None,
                 webhook_url: Optional[builtins.str] = None):
        """
        Notification settings for a schedule.
        :param builtins.str email_recipient: The email recipient to send notifications to (can be a list of semi-colon separated email addresses).
        :param builtins.str notification_locale: The locale to use when sending a notification (fallback for unsupported languages is EN).
        :param builtins.str status: If notifications are enabled for this schedule (i.e. Enabled, Disabled).
    ...
    def email_recipient(self) -> Optional[builtins.str]:
        """
    ...
    def notification_locale(self) -> Optional[builtins.str]:
        """
...
class PortResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a network port.
        :param builtins.int backend_port: Backend port of the target virtual machine.
        :param builtins.str transport_protocol: Protocol type of the port.
        """
        if backend_port is not None:
            pulumi.set(__self__, "backend_port", backend_port)
        if transport_protocol is not None:
...
class ScheduleCreationParameterResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_zone_id: Optional[builtins.str] = None,
        ...
        :param builtins.str status: The status of the schedule (i.e. Enabled, Disabled)
        :param Mapping[str, builtins.str] tags: The tags of the resource.
        :param builtins.str target_resource_id: The resource ID to which the schedule belongs
        :param builtins.str task_type: The task type of the schedule (e.g. LabVmsShutdownTask, LabVmAutoStart).
        :param builtins.str time_zone_id: The time zone ID (e.g. China Standard Time, Greenland Standard Time, Pacific Standard time, etc.). The possible values for this property can be found in `IReadOnlyCollection<string> TimeZoneConverter.TZConvert.KnownWindowsTimeZoneIds` (https://github.com/mattjohnsonpint/TimeZoneConverter/blob/main/README.md)
    ...
    def time_zone_id(self) -> Optional[builtins.str]:
        """
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A schedule.
        :param builtins.str created_date: The creation date of the schedule.
        :param builtins.str id: The identifier of the resource.
        :param builtins.str name: The name of the resource.
        :param builtins.str provisioning_state: The provisioning status of the resource.
        :param builtins.str type: The type of the resource.
...
class SubnetOverrideResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_in_vm_creation_permission: Optional[builtins.str] = None,
                 use_public_ip_address_permission: Optional[builtins.str] = None,
                 virtual_network_pool_name: Optional[builtins.str] = None):
        """
        Property overrides on a subnet of a virtual network.
        :param builtins.str lab_subnet_name: The name given to the subnet within the lab.
        :param builtins.str resource_id: The resource ID of the subnet.
        ...
        :param builtins.str use_in_vm_creation_permission: Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
        :param builtins.str use_public_ip_address_permission: Indicates whether public IP addresses can be assigned to virtual machines on this subnet (i.e. Allow, Deny).
    ...
    def use_in_vm_creation_permission(self) -> Optional[builtins.str]:
        """
    ...
    def use_public_ip_address_permission(self) -> Optional[builtins.str]:
        """
    ...
    def virtual_network_pool_name(self) -> Optional[builtins.str]:
        """
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_public_ip: Optional[builtins.str] = None,
                 lab_subnet_name: Optional[builtins.str] = None,
                 resource_id: Optional[builtins.str] = None):
        """
        Subnet information.
        :param builtins.str allow_public_ip: The permission policy of the subnet for allowing public IP addresses (i.e. Allow, Deny)).
        :param builtins.str lab_subnet_name: The name of the subnet as seen in the lab.
        :param builtins.str resource_id: The resource ID of the subnet.
        """
    ...
    def allow_public_ip(self) -> Optional[builtins.str]:
        """
...
class UserIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity attributes of a lab user.
        :param builtins.str app_id: Set to the app Id of the client JWT making the request.
        :param builtins.str object_id: Set to the object Id of the client JWT making the request. Not all users have object Id. For CSP (reseller) scenarios for example, object Id is not available.
        :param builtins.str principal_id: Set to the principal Id of the client JWT making the request. Service principal will not have the principal Id.
        :param builtins.str principal_name: Set to the principal name / UPN of the client JWT making the request.
        :param builtins.str tenant_id: Set to the tenant ID of the client JWT making the request.
        """
...
class UserSecretStoreResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a user's secret store.
        :param builtins.str key_vault_id: The ID of the user's Key vault.
        :param builtins.str key_vault_uri: The URI of the user's Key vault.
        """
...
class WeekDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of a weekly schedule.
        :param builtins.str time: The time of the day the schedule will occur.
        :param Sequence[builtins.str] weekdays: The days of the week for which the schedule is set (e.g. Sunday, Monday, Tuesday, etc.).
        """
        if time is not None:
            pulumi.set(__self__, "time", time)
...
class WindowsOsInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 windows_os_state: Optional[builtins.str] = None):
        """
        Information about a Windows OS.
        :param builtins.str windows_os_state: The state of the Windows OS (i.e. NonSysprepped, SysprepRequested, SysprepApplied).
        """
    ...
    def windows_os_state(self) -> Optional[builtins.str]:
        """
