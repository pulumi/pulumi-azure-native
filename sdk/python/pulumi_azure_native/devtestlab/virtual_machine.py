...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            gallery_image_reference = _utilities.configure(gallery_image_reference, GalleryImageReferenceArgs, True)
            ...
            network_interface = _utilities.configure(network_interface, NetworkInterfacePropertiesArgs, True)
