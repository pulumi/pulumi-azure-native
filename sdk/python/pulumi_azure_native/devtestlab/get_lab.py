...
class GetLabResult:
    ...
    def artifacts_storage_account(self) -> builtins.str:
        """
    ...
    def default_premium_storage_account(self) -> builtins.str:
        """
    ...
    def default_storage_account(self) -> builtins.str:
        """
    ...
    def environment_permission(self) -> Optional[builtins.str]:
        """
    ...
    def lab_storage_type(self) -> Optional[builtins.str]:
        """
    ...
    def mandatory_artifacts_resource_ids_linux(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def mandatory_artifacts_resource_ids_windows(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def premium_data_disk_storage_account(self) -> builtins.str:
        """
    ...
    def premium_data_disks(self) -> Optional[builtins.str]:
        """
    ...
    def vm_creation_resource_group(self) -> builtins.str:
        """
...
def get_lab(expand: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab:getLab', __args__, opts=opts, typ=GetLabResult).value
    ...
    return AwaitableGetLabResult(
        ...
        environment_permission=pulumi.get(__ret__, 'environment_permission'),
        extended_properties=pulumi.get(__ret__, 'extended_properties'),
        id=pulumi.get(__ret__, 'id'),
        lab_storage_type=pulumi.get(__ret__, 'lab_storage_type'),
        load_balancer_id=pulumi.get(__ret__, 'load_balancer_id'),
        location=pulumi.get(__ret__, 'location'),
        mandatory_artifacts_resource_ids_linux=pulumi.get(__ret__, 'mandatory_artifacts_resource_ids_linux'),
        mandatory_artifacts_resource_ids_windows=pulumi.get(__ret__, 'mandatory_artifacts_resource_ids_windows'),
        name=pulumi.get(__ret__, 'name'),
        network_security_group_id=pulumi.get(__ret__, 'network_security_group_id'),
        premium_data_disk_storage_account=pulumi.get(__ret__, 'premium_data_disk_storage_account'),
        premium_data_disks=pulumi.get(__ret__, 'premium_data_disks'),
...
def get_lab_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devtestlab:getLab', __args__, opts=opts, typ=GetLabResult)
