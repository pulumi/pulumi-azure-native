...
def get_virtual_machine_schedule(expand: Optional[_builtins.str] = None,
    ...
    :param _builtins.str virtual_machine_name: virtualmachines
    """
    __args__ = dict()
...
def get_virtual_machine_schedule_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
