...
def get_virtual_machine_schedule(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_machine_name: virtualmachines
    """
    __args__ = dict()
...
def get_virtual_machine_schedule_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
