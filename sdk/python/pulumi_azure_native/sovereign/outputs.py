...
class LandingZoneConfigurationResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 provisioning_state: _builtins.str,
                 azure_bastion_subnet_cidr_block: Optional[_builtins.str] = None,
                 ...
                 existing_azure_bastion_id: Optional[_builtins.str] = None,
                 existing_ddos_protection_id: Optional[_builtins.str] = None,
                 existing_log_analytics_workspace_id: Optional[_builtins.str] = None,
                 firewall_subnet_cidr_block: Optional[_builtins.str] = None,
                 ...
                 naming_convention_formula: Optional[_builtins.str] = None,
        ...
        :param _builtins.str firewall_creation_option: Parameter used for deploying a Firewall: Select 'No' to skip deployment, 'Standard' to deploy the Standard SKU, or 'Premium' to deploy the Premium SKU.
        :param _builtins.str gateway_subnet_cidr_block: The gateway subnet address used for deploying a virtual network. Specify the subnet using IPv4 CIDR notation.
        :param _builtins.str hub_network_cidr_block: The Virtual Network address. Specify the address using IPv4 CIDR notation.
        :param _builtins.str log_analytics_workspace_creation_option: Parameter used to deploy a log analytics workspace: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to reuse an existing log analytics workspace.
        :param _builtins.float log_retention_in_days: Parameter to define the retention period for logs, in days. The minimum duration is 30 days and the maximum is 730 days.
        ...
        :param _builtins.str provisioning_state: The state that reflects the current stage in the creation, updating, or deletion process of the landing zone configuration.
        :param _builtins.str azure_bastion_subnet_cidr_block: The Bastion subnet address. Specify the address using IPv4 CIDR notation.
        ...
        :param _builtins.str existing_azure_bastion_id: The resource ID of the Bastion when reusing an existing one.
        :param _builtins.str existing_ddos_protection_id: The resource ID of the DDoS protection plan when reusing an existing one.
        :param _builtins.str existing_log_analytics_workspace_id: The resource ID of the log analytics workspace when reusing an existing one.
        :param _builtins.str firewall_subnet_cidr_block: The Firewall subnet address used for deploying a firewall. Specify the Firewall subnet using IPv4 CIDR notation.
        ...
        :param _builtins.str naming_convention_formula: The default naming convention applied to all resources for this landing zone configuration. Example - {DeploymentPrefix}-Contoso-{ResourceTypeAbbreviation}{DeploymentSuffix}-{Environment}-testing
