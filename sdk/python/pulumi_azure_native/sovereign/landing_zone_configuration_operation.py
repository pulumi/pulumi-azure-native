...
class LandingZoneConfigurationOperationArgs:
    def __init__(__self__, *,
                 landing_zone_account_name: pulumi.Input[str],
        ...
        :param pulumi.Input[str] landing_zone_configuration_name: The landing zone configuration name
    ...
    def landing_zone_account_name(self, value: pulumi.Input[str]):
    ...
    def landing_zone_configuration_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def landing_zone_configuration_name(self, value: Optional[pulumi.Input[str]]):
...
class LandingZoneConfigurationOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 landing_zone_account_name: Optional[pulumi.Input[str]] = None,
                 landing_zone_configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native_sovereign_v20250227preview:sovereign:LandingZoneConfigurationOperation")])
