...
class LandingZoneAccountOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sovereign:LandingZoneAccountOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LandingZoneAccountOperation, __self__).__init__(
            'azure-native:sovereign/v20250227preview:LandingZoneAccountOperation',
            resource_name,
            __props__,
            opts)
