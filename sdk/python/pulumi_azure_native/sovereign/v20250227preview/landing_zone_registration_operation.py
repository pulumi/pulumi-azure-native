...
class LandingZoneRegistrationOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sovereign:LandingZoneRegistrationOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LandingZoneRegistrationOperation, __self__).__init__(
            'azure-native:sovereign/v20250227preview:LandingZoneRegistrationOperation',
            resource_name,
            __props__,
            opts)
