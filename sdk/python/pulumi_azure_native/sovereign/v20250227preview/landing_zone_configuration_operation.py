...
class LandingZoneConfigurationOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sovereign:LandingZoneConfigurationOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LandingZoneConfigurationOperation, __self__).__init__(
            'azure-native:sovereign/v20250227preview:LandingZoneConfigurationOperation',
            resource_name,
            __props__,
            opts)
