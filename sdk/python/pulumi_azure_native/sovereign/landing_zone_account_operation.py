...
class LandingZoneAccountOperationArgs:
    ...
    def landing_zone_account_name(self, value: Optional[pulumi.Input[str]]):
...
class LandingZoneAccountOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native_sovereign_v20250227preview:sovereign:LandingZoneAccountOperation")])
