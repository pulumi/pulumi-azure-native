...
class LandingZoneAccountOperationArgs:
    ...
    def landing_zone_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def landing_zone_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['LandingZoneAccountResourcePropertiesArgs']]):
