...
class CustomNamingConventionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] formula: The custom naming formula for the resource type.
        :param pulumi.Input[Union[_builtins.str, 'ResourceType']] resource_type: The type of the resource.
        """
...
class DecommissionedManagementGroupPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] create: This parameter determines whether the 'Decommissioned' management group will be created. If set to true, the group will be created; if set to false, it will not be created. The default value is false.
...
class LandingZoneAccountResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_account: The storage account that will host the generated infrastructure as code (IaC) for a landing zone deployment.
        """
...
class LandingZoneConfigurationResourcePropertiesArgsDict(TypedDict):
    ...
    """
    custom_naming_convention: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['CustomNamingConventionArgs']]]]]
    """
    ...
    """
    decommissioned_mg_metadata: NotRequired[pulumi.Input[Optional['DecommissionedManagementGroupPropertiesArgs']]]
    """
    ...
    """
    landing_zones_mg_children: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LandingZoneManagementGroupPropertiesArgs']]]]]
    """
    The child management groups of 'Landing Zones' management group and their assigned policies.
    """
    landing_zones_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
    ...
    """
    platform_connectivity_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
    The assigned policies of the 'Connectivity' management group under 'Platform' management group.
    """
    platform_identity_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
    The assigned policies of the 'Identity' management group under 'Platform' management group.
    """
    platform_management_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
    The assigned policies of the 'Management' management group under 'Platform' management group.
    """
    platform_mg_children: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PlatformManagementGroupPropertiesArgs']]]]]
    """
    ...
    """
    platform_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
    The assigned policies of the 'Platform' management group.
    """
    sandbox_mg_metadata: NotRequired[pulumi.Input[Optional['SandboxManagementGroupPropertiesArgs']]]
    """
    The assigned policies of the 'Sandbox' management group and indicator to create it or not.
    """
    tags: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['TagsArgs']]]]]
    """
    ...
    """
    top_level_mg_metadata: NotRequired[pulumi.Input[Optional['ManagementGroupPropertiesArgs']]]
    """
...
class LandingZoneConfigurationResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']] azure_bastion_creation_option: Parameter used to deploy a Bastion: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to reuse an existing Bastion.
        :param pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']] ddos_protection_creation_option: Parameter used to deploy a DDoS protection plan: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to reuse an existing DDoS protection plan.
        :param pulumi.Input[Union[_builtins.str, 'FirewallCreationOptions']] firewall_creation_option: Parameter used for deploying a Firewall: Select 'No' to skip deployment, 'Standard' to deploy the Standard SKU, or 'Premium' to deploy the Premium SKU.
        :param pulumi.Input[_builtins.str] gateway_subnet_cidr_block: The gateway subnet address used for deploying a virtual network. Specify the subnet using IPv4 CIDR notation.
        :param pulumi.Input[_builtins.str] hub_network_cidr_block: The Virtual Network address. Specify the address using IPv4 CIDR notation.
        :param pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']] log_analytics_workspace_creation_option: Parameter used to deploy a log analytics workspace: Select 'Yes' to enable deployment, 'No' to skip it, or 'Existing' to reuse an existing log analytics workspace.
        :param pulumi.Input[_builtins.float] log_retention_in_days: Parameter to define the retention period for logs, in days. The minimum duration is 30 days and the maximum is 730 days.
        ...
        :param pulumi.Input[_builtins.str] azure_bastion_subnet_cidr_block: The Bastion subnet address. Specify the address using IPv4 CIDR notation.
        ...
        :param pulumi.Input[_builtins.str] existing_azure_bastion_id: The resource ID of the Bastion when reusing an existing one.
        :param pulumi.Input[_builtins.str] existing_ddos_protection_id: The resource ID of the DDoS protection plan when reusing an existing one.
        :param pulumi.Input[_builtins.str] existing_log_analytics_workspace_id: The resource ID of the log analytics workspace when reusing an existing one.
        :param pulumi.Input[_builtins.str] firewall_subnet_cidr_block: The Firewall subnet address used for deploying a firewall. Specify the Firewall subnet using IPv4 CIDR notation.
        ...
        :param pulumi.Input[_builtins.str] naming_convention_formula: The default naming convention applied to all resources for this landing zone configuration. Example - {DeploymentPrefix}-Contoso-{ResourceTypeAbbreviation}{DeploymentSuffix}-{Environment}-testing
    ...
    def azure_bastion_creation_option(self, value: pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']]):
    ...
    def ddos_protection_creation_option(self, value: pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']]):
    ...
    def firewall_creation_option(self, value: pulumi.Input[Union[_builtins.str, 'FirewallCreationOptions']]):
    ...
    def log_analytics_workspace_creation_option(self, value: pulumi.Input[Union[_builtins.str, 'ResourceCreationOptions']]):
...
class LandingZoneManagementGroupPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Management group name.
        :param pulumi.Input[Sequence[pulumi.Input['PolicyInitiativeAssignmentPropertiesArgs']]] policy_initiatives_assignment_properties: Array of policy initiatives applied to the management group.
        """
...
class LandingZoneRegistrationResourcePropertiesArgsDict(TypedDict):
    ...
    """
    managed_identity: NotRequired[pulumi.Input[Optional['ManagedIdentityPropertiesArgs']]]
    """
...
class LandingZoneRegistrationResourcePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] existing_landing_zone_configuration_id: The resource id of the associated landing zone configuration.
        :param pulumi.Input[_builtins.str] existing_top_level_mg_id: The resource id of the top level management group
    ...
    def existing_landing_zone_configuration_id(self, value: pulumi.Input[_builtins.str]):
...
class ManagedIdentityPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ManagedIdentityResourceType']] type: The type of managed identity.
        :param pulumi.Input[_builtins.str] user_assigned_identity_resource_id: The resource id of the managed identity.
        """
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'ManagedIdentityResourceType']]):
...
class PolicyInitiativeAssignmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_initiative_id: The fully qualified id of the policy initiative.
        """
...
class SandboxManagementGroupPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] create: This parameter determines whether the 'Sandbox' management group will be created. If set to true, the group will be created; if set to false, it will not be created. The default value is false.
        :param pulumi.Input[Sequence[pulumi.Input['PolicyInitiativeAssignmentPropertiesArgs']]] policy_initiatives_assignment_properties: Array of policy initiatives applied to the management group.
        """
        pulumi.set(__self__, "create", create)
        pulumi.set(__self__, "policy_initiatives_assignment_properties", policy_initiatives_assignment_properties)
...
class TagsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: A tag name.
        :param pulumi.Input[_builtins.str] value: A tag value.
        """
        pulumi.set(__self__, "name", name)
