...
class LandingZoneRegistrationOperationArgs:
    def __init__(__self__, *,
                 ...
                 landing_zone_registration_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] landing_zone_registration_name: The name of the landing zone registration resource.
    ...
    def landing_zone_registration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def landing_zone_registration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LandingZoneRegistrationOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LandingZoneRegistrationOperationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sovereign/v20250227preview:LandingZoneRegistrationOperation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LandingZoneRegistrationOperation, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LandingZoneRegistrationOperation':
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.LandingZoneRegistrationResourcePropertiesResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
