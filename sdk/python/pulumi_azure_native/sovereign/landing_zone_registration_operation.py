...
class LandingZoneRegistrationOperationArgs:
    def __init__(__self__, *,
                 ...
                 landing_zone_registration_name: Optional[pulumi.Input[str]] = None,
    ...
    def landing_zone_registration_name(self, value: Optional[pulumi.Input[str]]):
...
class LandingZoneRegistrationOperation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native_sovereign_v20250227preview:sovereign:LandingZoneRegistrationOperation")])
