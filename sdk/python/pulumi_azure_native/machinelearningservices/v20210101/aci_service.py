...
class ACIService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aci_service = azure_native.machinelearningservices.v20210101.ACIService("aciService",
            app_insights_enabled=True,
            auth_enabled=True,
            compute_type="ACI",
            container_resource_requirements=azure_native.machinelearningservices.v20210101.ContainerResourceRequirementsArgs(
                cpu=1,
                memory_in_gb=1,
            ),
            environment_image_request=azure_native.machinelearningservices.v20210101.CreateServiceRequestEnvironmentImageRequestArgs(
                assets=[azure_native.machinelearningservices.v20210101.ImageAssetArgs(
                    mime_type="application/x-python",
                    unpack=False,
                    url="aml://storage/azureml/score.py",
                )],
                driver_program="score.py",
                environment=azure_native.machinelearningservices.v20210101.EnvironmentImageRequestEnvironmentArgs(
                    docker=azure_native.machinelearningservices.v20210101.ModelEnvironmentDefinitionDockerArgs(
                        base_image="mcr.microsoft.com/azureml/base:openmpi3.1.2-ubuntu16.04",
                        base_image_registry=azure_native.machinelearningservices.v20210101.ModelDockerSectionBaseImageRegistryArgs(),
                    ),
                    environment_variables={
                        "EXAMPLE_ENV_VAR": "EXAMPLE_VALUE",
                    },
                    name="AzureML-Scikit-learn-0.20.3",
                    python=azure_native.machinelearningservices.v20210101.ModelEnvironmentDefinitionPythonArgs(
                        conda_dependencies={
                    ...
                    spark=azure_native.machinelearningservices.v20210101.ModelEnvironmentDefinitionSparkArgs(
                        packages=[],
                ...
                models=[azure_native.machinelearningservices.v20210101.ModelArgs(
                    mime_type="application/x-python",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:ACIService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:ACIService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:ACIService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210401:ACIService")])
