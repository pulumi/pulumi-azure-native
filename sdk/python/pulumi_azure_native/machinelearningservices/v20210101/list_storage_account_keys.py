...
def list_storage_account_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210101:listStorageAccountKeys', __args__, opts=opts, typ=ListStorageAccountKeysResult).value
...
def list_storage_account_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210101:listStorageAccountKeys', __args__, opts=opts, typ=ListStorageAccountKeysResult)
