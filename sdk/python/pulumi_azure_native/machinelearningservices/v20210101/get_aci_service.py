...
def get_aci_service(expand: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210101:getACIService', __args__, opts=opts, typ=GetACIServiceResult).value
...
def get_aci_service_output(expand: Optional[pulumi.Input[Optional[bool]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetACIServiceResult]:
    """
    Get a Service by name.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210101:getACIService', __args__, opts=opts, typ=GetACIServiceResult)
    return __ret__.apply(lambda __response__: GetACIServiceResult(
