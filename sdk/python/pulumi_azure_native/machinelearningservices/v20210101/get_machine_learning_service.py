...
def get_machine_learning_service(expand: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210101:getMachineLearningService', __args__, opts=opts, typ=GetMachineLearningServiceResult).value
