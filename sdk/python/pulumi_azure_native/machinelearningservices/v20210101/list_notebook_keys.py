...
def list_notebook_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210101:listNotebookKeys', __args__, opts=opts, typ=ListNotebookKeysResult).value
...
def list_notebook_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210101:listNotebookKeys', __args__, opts=opts, typ=ListNotebookKeysResult)
