...
def get_managed_network_settings_rule(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getManagedNetworkSettingsRule', __args__, opts=opts, typ=GetManagedNetworkSettingsRuleResult).value
...
def get_managed_network_settings_rule_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
