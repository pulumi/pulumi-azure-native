...
class Datastore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 datastore_properties: Optional[pulumi.Input[Union[pulumi.InputType['AzureBlobDatastoreArgs'], pulumi.InputType['AzureDataLakeGen1DatastoreArgs'], pulumi.InputType['AzureDataLakeGen2DatastoreArgs'], pulumi.InputType['AzureFileDatastoreArgs'], pulumi.InputType['HdfsDatastoreArgs'], pulumi.InputType['OneLakeDatastoreArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union[pulumi.InputType['AzureBlobDatastoreArgs'], pulumi.InputType['AzureDataLakeGen1DatastoreArgs'], pulumi.InputType['AzureDataLakeGen2DatastoreArgs'], pulumi.InputType['AzureFileDatastoreArgs'], pulumi.InputType['HdfsDatastoreArgs'], pulumi.InputType['OneLakeDatastoreArgs']]] datastore_properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Datastore name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[bool] skip_validation: Flag to skip validation.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
