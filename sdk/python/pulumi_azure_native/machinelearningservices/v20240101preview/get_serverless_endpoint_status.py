...
def get_serverless_endpoint_status(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240101preview:getServerlessEndpointStatus', __args__, opts=opts, typ=GetServerlessEndpointStatusResult).value
