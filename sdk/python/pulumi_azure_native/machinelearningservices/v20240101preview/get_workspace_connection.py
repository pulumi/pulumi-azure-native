...
def get_workspace_connection(aoai_models_to_deploy: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240101preview:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult).value
...
def get_workspace_connection_output(aoai_models_to_deploy: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240101preview:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult)
