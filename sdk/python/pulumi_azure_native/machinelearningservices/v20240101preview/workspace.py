...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union[str, 'PublicNetworkAccessType']] public_network_access: Whether requests from Public Network are allowed.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[pulumi.InputType['ServerlessComputeSettingsArgs']] serverless_compute_settings: Settings for serverless compute in a workspace
