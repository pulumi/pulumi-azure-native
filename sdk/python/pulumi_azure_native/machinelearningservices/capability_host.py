...
class CapabilityHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['CapabilityHostPropertiesArgs', 'CapabilityHostPropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250601:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250901:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251201:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260301:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260501:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:CapabilityHost")])
