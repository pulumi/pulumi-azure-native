...
class CapabilityHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250601:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250901:CapabilityHost")])
