...
def get_labeling_job(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The name and identifier for the LabelingJob.
...
def get_labeling_job_output(id: Optional[pulumi.Input[builtins.str]] = None,
