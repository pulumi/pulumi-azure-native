...
def get_outbound_rule(managed_network_name: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_network_name: Name of the managedNetwork associated with the workspace. Only 'default' is supported.
    :param builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param builtins.str rule_name: Name of the workspace managed network outbound rule
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getOutboundRule', __args__, opts=opts, typ=GetOutboundRuleResult).value

    return AwaitableGetOutboundRuleResult(
...
def get_outbound_rule_output(managed_network_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getOutboundRule', __args__, opts=opts, typ=GetOutboundRuleResult)
    return __ret__.apply(lambda __response__: GetOutboundRuleResult(
