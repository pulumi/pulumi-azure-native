...
def get_outbound_rule(managed_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rule_name: Name of the workspace managed network outbound rule
...
def get_outbound_rule_output(managed_network_name: Optional[pulumi.Input[_builtins.str]] = None,
