...
azure-native:machinelearningservices/v20191101:MachineLearningCompute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_machine_learning_compute(compute_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_learning_compute is deprecated: Version 2019-11-01 will be removed in v2 of the provider.
azure-native:machinelearningservices/v20191101:MachineLearningCompute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20191101:getMachineLearningCompute', __args__, opts=opts, typ=GetMachineLearningComputeResult).value
