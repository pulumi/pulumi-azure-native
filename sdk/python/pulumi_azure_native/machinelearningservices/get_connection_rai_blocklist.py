...
def get_connection_rai_blocklist(connection_name: Optional[builtins.str] = None,
...
def get_connection_rai_blocklist_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
