...
def get_connection_rai_blocklist(connection_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult).value
...
def get_connection_rai_blocklist_output(connection_name: pulumi.Input[Optional[_builtins.str]] = None,
                                        rai_blocklist_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult)
