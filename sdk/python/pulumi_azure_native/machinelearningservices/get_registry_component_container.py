...
def get_registry_component_container(component_name: Optional[_builtins.str] = None,
...
def get_registry_component_container_output(component_name: Optional[pulumi.Input[_builtins.str]] = None,
