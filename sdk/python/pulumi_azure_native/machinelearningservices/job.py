...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: The name and identifier for the Job. This is case-sensitive.
        """
