...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230601preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
    ...
    return AwaitableGetWorkspaceResult(
        ...
        container_registries=__ret__.container_registries,
        container_registry=__ret__.container_registry,
        description=__ret__.description,
        discovery_url=__ret__.discovery_url,
        enable_data_isolation=__ret__.enable_data_isolation,
        encryption=__ret__.encryption,
        existing_workspaces=__ret__.existing_workspaces,
        feature_store_settings=__ret__.feature_store_settings,
        friendly_name=__ret__.friendly_name,
        hbi_workspace=__ret__.hbi_workspace,
        hub_resource_id=__ret__.hub_resource_id,
        id=__ret__.id,
        ...
        managed_network=__ret__.managed_network,
        ...
        system_datastores_auth_mode=__ret__.system_datastores_auth_mode,
        tags=__ret__.tags,
        tenant_id=__ret__.tenant_id,
        type=__ret__.type,
        v1_legacy_mode=__ret__.v1_legacy_mode,
        workspace_hub_config=__ret__.workspace_hub_config,
