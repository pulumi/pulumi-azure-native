...
def get_data_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230601preview:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult).value
...
def get_data_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230601preview:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult)
