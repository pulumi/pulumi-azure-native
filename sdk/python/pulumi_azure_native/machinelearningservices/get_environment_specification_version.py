...
def get_environment_specification_version(name: Optional[builtins.str] = None,
...
def get_environment_specification_version_output(name: Optional[pulumi.Input[builtins.str]] = None,
