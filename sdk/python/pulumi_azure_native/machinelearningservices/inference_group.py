...
class InferenceGroupInitArgs:
    ...
    def _configure(
             ...
             inference_group_properties: Optional[pulumi.Input['InferenceGroupArgs']] = None,
             ...
             **kwargs):
        if inference_group_properties is None and 'inferenceGroupProperties' in kwargs:
            inference_group_properties = kwargs['inferenceGroupProperties']
        if inference_group_properties is None:
            raise TypeError("Missing 'inference_group_properties' argument")
...
class InferenceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 inference_group_properties: Optional[pulumi.Input[pulumi.InputType['InferenceGroupArgs']]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 pool_name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InferenceGroupArgs']] inference_group_properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] kind: Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] pool_name: InferencePool name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            inference_group_properties = _utilities.configure(inference_group_properties, InferenceGroupArgs, True)
