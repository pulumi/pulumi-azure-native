...
class InferenceGroupInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group_name: InferenceGroup name.
...
class InferenceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 inference_group_properties: pulumi.Input[Optional[Union['InferenceGroupArgs', 'InferenceGroupArgsDict']]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:InferenceGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:InferenceGroup")])
