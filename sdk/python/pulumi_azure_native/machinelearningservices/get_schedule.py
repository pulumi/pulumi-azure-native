...
class GetScheduleResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, schedule_properties=None, system_data=None, type=None):
...
def get_schedule_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getSchedule', __args__, opts=opts, typ=GetScheduleResult)
