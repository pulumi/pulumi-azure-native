...
def get_code_version(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_code_version is deprecated: azure-native:machinelearningservices/v20220501:CodeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:CodeVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
