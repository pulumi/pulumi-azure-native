...
warnings.warn("""azure-native:machinelearningservices/v20220501:EnvironmentVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
class EnvironmentVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EnvironmentVersion is deprecated: azure-native:machinelearningservices/v20220501:EnvironmentVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:EnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:EnvironmentVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnvironmentVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20220501:EnvironmentVersion',
            resource_name,
            __props__,
            opts)
