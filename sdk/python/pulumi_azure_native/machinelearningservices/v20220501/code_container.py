...
warnings.warn("""azure-native:machinelearningservices/v20220501:CodeContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:CodeContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
class CodeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CodeContainer is deprecated: azure-native:machinelearningservices/v20220501:CodeContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:CodeContainer to guarantee forwards compatibility.""")
