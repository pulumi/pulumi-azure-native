...
def get_online_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_online_endpoint is deprecated: azure-native:machinelearningservices/v20220501:OnlineEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:OnlineEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
