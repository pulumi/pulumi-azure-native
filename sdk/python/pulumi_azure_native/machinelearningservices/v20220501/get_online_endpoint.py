...
def get_online_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_online_endpoint is deprecated: azure-native:machinelearningservices/v20220501:OnlineEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
