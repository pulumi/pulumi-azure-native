...
def get_data_container(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_container is deprecated: azure-native:machinelearningservices/v20220501:DataContainer is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:DataContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
