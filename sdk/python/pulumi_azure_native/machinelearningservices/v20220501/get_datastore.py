...
warnings.warn("""azure-native:machinelearningservices/v20220501:Datastore is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:Datastore to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_datastore(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_datastore is deprecated: azure-native:machinelearningservices/v20220501:Datastore is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:Datastore to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
