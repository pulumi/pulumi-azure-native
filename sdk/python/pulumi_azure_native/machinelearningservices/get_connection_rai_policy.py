...
def get_connection_rai_policy(connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str rai_policy_name: Name of the Rai Policy.
...
def get_connection_rai_policy_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
