...
def get_connection_rai_policy(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rai_policy_name: Name of the Rai Policy.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getConnectionRaiPolicy', __args__, opts=opts, typ=GetConnectionRaiPolicyResult).value
...
def get_connection_rai_policy_output(connection_name: pulumi.Input[Optional[_builtins.str]] = None,
                                     rai_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getConnectionRaiPolicy', __args__, opts=opts, typ=GetConnectionRaiPolicyResult)
