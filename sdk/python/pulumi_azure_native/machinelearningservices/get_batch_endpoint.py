...
def get_batch_endpoint(endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_name: Name for the Batch Endpoint.
...
def get_batch_endpoint_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
