...
warnings.warn("""azure-native:machinelearningservices/v20200601:WorkspaceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:WorkspaceConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkspaceConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkspaceConnection is deprecated: azure-native:machinelearningservices/v20200601:WorkspaceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:WorkspaceConnection to guarantee forwards compatibility.""")
