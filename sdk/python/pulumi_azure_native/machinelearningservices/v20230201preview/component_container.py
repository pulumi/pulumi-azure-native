...
class ComponentContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        component_container = azure_native.machinelearningservices.v20230201preview.ComponentContainer("componentContainer",
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20230201preview:ComponentContainer string string 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:ComponentContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComponentContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230201preview:ComponentContainer',
            resource_name,
            __props__,
            opts)
