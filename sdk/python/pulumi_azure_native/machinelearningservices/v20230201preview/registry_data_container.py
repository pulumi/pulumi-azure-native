...
class RegistryDataContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:RegistryDataContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:RegistryDataContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryDataContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryDataContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230201preview:RegistryDataContainer',
            resource_name,
            __props__,
            opts)
