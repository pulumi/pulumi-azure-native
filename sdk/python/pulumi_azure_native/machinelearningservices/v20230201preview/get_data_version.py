...
def get_data_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult).value
...
def get_data_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult)
