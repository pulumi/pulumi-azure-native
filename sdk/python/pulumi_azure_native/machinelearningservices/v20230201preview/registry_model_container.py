...
class RegistryModelContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_model_container = azure_native.machinelearningservices.v20230201preview.RegistryModelContainer("registryModelContainer",
            model_container_properties=azure_native.machinelearningservices.v20230201preview.ModelContainerArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryModelContainer")])
