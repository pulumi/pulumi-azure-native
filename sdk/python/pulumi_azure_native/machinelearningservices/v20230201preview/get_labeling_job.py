...
def get_labeling_job(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getLabelingJob', __args__, opts=opts, typ=GetLabelingJobResult).value
...
def get_labeling_job_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getLabelingJob', __args__, opts=opts, typ=GetLabelingJobResult)
