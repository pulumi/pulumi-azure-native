...
def list_featureset_version_materialization_jobs(feature_window_end: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:listFeaturesetVersionMaterializationJobs', __args__, opts=opts, typ=ListFeaturesetVersionMaterializationJobsResult).value
...
def list_featureset_version_materialization_jobs_output(feature_window_end: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:listFeaturesetVersionMaterializationJobs', __args__, opts=opts, typ=ListFeaturesetVersionMaterializationJobsResult)
