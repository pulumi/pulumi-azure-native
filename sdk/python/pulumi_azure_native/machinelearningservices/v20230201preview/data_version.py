...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_version = azure_native.machinelearningservices.v20230201preview.DataVersion("dataVersion",
            data_version_base_properties=azure_native.machinelearningservices.v20230201preview.UriFileDataVersionArgs(
                data_type="uri_file",
                data_uri="string",
                description="string",
                is_anonymous=False,
