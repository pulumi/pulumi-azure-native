...
class Schedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        schedule = azure_native.machinelearningservices.v20230201preview.Schedule("schedule",
            name="string",
            resource_group_name="test-rg",
            schedule_properties=azure_native.machinelearningservices.v20230201preview.ScheduleResponseArgs(
                action=azure_native.machinelearningservices.v20230201preview.EndpointScheduleActionArgs(
                ...
                trigger=azure_native.machinelearningservices.v20230201preview.CronTriggerArgs(
                    end_time="string",
                    expression="string",
                    start_time="string",
                    time_zone="string",
