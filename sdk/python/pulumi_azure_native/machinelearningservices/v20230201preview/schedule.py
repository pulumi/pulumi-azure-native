...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:Schedule")])
