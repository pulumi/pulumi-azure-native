...
def get_component_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult).value
...
def get_component_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult)
