...
class BatchEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        batch_endpoint = azure_native.machinelearningservices.v20230201preview.BatchEndpoint("batchEndpoint",
            batch_endpoint_properties=azure_native.machinelearningservices.v20230201preview.BatchEndpointResponseArgs(
                auth_mode="AMLToken",
                defaults=azure_native.machinelearningservices.v20230201preview.BatchEndpointDefaultsArgs(
