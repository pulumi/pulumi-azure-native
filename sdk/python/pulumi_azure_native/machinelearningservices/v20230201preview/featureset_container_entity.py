...
class FeaturesetContainerEntity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 featureset_container_properties: Optional[pulumi.Input[pulumi.InputType['FeaturesetContainerArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        featureset_container_entity = azure_native.machinelearningservices.v20230201preview.FeaturesetContainerEntity("featuresetContainerEntity",
            featureset_container_properties=azure_native.machinelearningservices.v20230201preview.FeaturesetContainerArgs(
                description="string",
                is_archived=False,
                properties={
                    "string": "string",
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20230201preview:FeaturesetContainerEntity string string 
        ```

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['FeaturesetContainerArgs']] featureset_container_properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:FeaturesetContainerEntity")])
