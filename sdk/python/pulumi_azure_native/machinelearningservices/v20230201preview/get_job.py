...
def get_job(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getJob', __args__, opts=opts, typ=GetJobResult)
