...
def get_registry_component_container(component_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getRegistryComponentContainer', __args__, opts=opts, typ=GetRegistryComponentContainerResult).value
...
def get_registry_component_container_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getRegistryComponentContainer', __args__, opts=opts, typ=GetRegistryComponentContainerResult)
