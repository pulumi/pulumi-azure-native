...
def get_batch_deployment(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getBatchDeployment', __args__, opts=opts, typ=GetBatchDeploymentResult).value
...
def get_batch_deployment_output(deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getBatchDeployment', __args__, opts=opts, typ=GetBatchDeploymentResult)
