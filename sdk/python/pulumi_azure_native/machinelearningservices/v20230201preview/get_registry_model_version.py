...
def get_registry_model_version(model_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230201preview:getRegistryModelVersion', __args__, opts=opts, typ=GetRegistryModelVersionResult).value
...
def get_registry_model_version_output(model_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230201preview:getRegistryModelVersion', __args__, opts=opts, typ=GetRegistryModelVersionResult)
