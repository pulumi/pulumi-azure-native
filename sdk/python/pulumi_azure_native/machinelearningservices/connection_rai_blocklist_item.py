...
class ConnectionRaiBlocklistItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rai_blocklist_item_name: Name of the RaiBlocklist Item
        """
