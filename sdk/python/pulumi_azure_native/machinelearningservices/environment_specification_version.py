...
class EnvironmentSpecificationVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices:EnvironmentSpecificationVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:EnvironmentSpecificationVersion"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:EnvironmentSpecificationVersion")])
