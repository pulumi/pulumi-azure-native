...
class EnvironmentSpecificationVersionInitArgs:
    def __init__(__self__, *,
        ...
        """
        EnvironmentSpecificationVersionInitArgs._configure(
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['EnvironmentSpecificationVersionArgs']] = None,
...
class EnvironmentSpecificationVersion(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EnvironmentSpecificationVersionInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, EnvironmentSpecificationVersionArgs, True)
