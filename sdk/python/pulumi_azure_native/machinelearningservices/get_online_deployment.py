...
def get_online_deployment(deployment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint_name: Inference endpoint name.
...
def get_online_deployment_output(deployment_name: Optional[pulumi.Input[_builtins.str]] = None,
