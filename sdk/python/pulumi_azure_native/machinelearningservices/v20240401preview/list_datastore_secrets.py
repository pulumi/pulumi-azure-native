...
def list_datastore_secrets(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401preview:listDatastoreSecrets', __args__, opts=opts, typ=ListDatastoreSecretsResult).value
...
def list_datastore_secrets_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401preview:listDatastoreSecrets', __args__, opts=opts, typ=ListDatastoreSecretsResult)
