...
class RegistryDataVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices:RegistryDataVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryDataVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20240401preview:RegistryDataVersion',
            resource_name,
            __props__,
            opts)
