...
class AwaitableGetEnvironmentVersionResult(GetEnvironmentVersionResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetEnvironmentVersionResult(
...
def get_environment_version(name: Optional[str] = None,
                            resource_group_name: Optional[str] = None,
                            version: Optional[str] = None,
                            workspace_name: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnvironmentVersionResult:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401preview:getEnvironmentVersion', __args__, opts=opts, typ=GetEnvironmentVersionResult).value

    return AwaitableGetEnvironmentVersionResult(
...
def get_environment_version_output(name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnvironmentVersionResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401preview:getEnvironmentVersion', __args__, opts=opts, typ=GetEnvironmentVersionResult)
    return __ret__.apply(lambda __response__: GetEnvironmentVersionResult(
