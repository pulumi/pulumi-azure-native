...
def get_labeling_job(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401preview:getLabelingJob', __args__, opts=opts, typ=GetLabelingJobResult).value
...
def get_labeling_job_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401preview:getLabelingJob', __args__, opts=opts, typ=GetLabelingJobResult)
