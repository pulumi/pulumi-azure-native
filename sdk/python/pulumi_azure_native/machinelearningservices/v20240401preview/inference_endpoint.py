...
class InferenceEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:InferenceEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(InferenceEndpoint, __self__).__init__(
            'azure-native:machinelearningservices/v20240401preview:InferenceEndpoint',
            resource_name,
            __props__,
            opts)
