...
__all__ = [
    ...
    'AwaitableGetEndpointDeploymentResult',
    'get_endpoint_deployment',
...
class AwaitableGetEndpointDeploymentResult(GetEndpointDeploymentResult):
...
def get_endpoint_deployment(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401preview:getEndpointDeployment', __args__, opts=opts, typ=GetEndpointDeploymentResult).value
...
@_utilities.lift_output_func(get_endpoint_deployment)
def get_endpoint_deployment_output(deployment_name: Optional[pulumi.Input[str]] = None,
