...
class EndpointDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:EndpointDeployment")])
