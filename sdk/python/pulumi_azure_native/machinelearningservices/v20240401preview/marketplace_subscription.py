...
class MarketplaceSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 marketplace_subscription_properties: Optional[pulumi.Input[pulumi.InputType['MarketplaceSubscriptionArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401:MarketplaceSubscription")])
