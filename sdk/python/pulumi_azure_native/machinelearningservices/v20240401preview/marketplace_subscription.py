...
class MarketplaceSubscriptionInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Marketplace Subscription name.
        """
...
class MarketplaceSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices:MarketplaceSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MarketplaceSubscription, __self__).__init__(
            'azure-native:machinelearningservices/v20240401preview:MarketplaceSubscription',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MarketplaceSubscription':
        """
