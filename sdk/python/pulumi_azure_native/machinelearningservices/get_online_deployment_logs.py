...
def get_online_deployment_logs(container_type: Optional[Union[_builtins.str, 'ContainerType']] = None,
                               deployment_name: Optional[_builtins.str] = None,
                               endpoint_name: Optional[_builtins.str] = None,
                               resource_group_name: Optional[_builtins.str] = None,
                               tail: Optional[_builtins.int] = None,
    ...
    :param _builtins.str deployment_name: The name and identifier for the endpoint.
    :param _builtins.str endpoint_name: Inference endpoint name.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.int tail: The maximum number of lines to tail.
