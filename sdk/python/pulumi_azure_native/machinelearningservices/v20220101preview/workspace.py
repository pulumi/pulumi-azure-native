...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 allow_recover_soft_deleted_workspace: Optional[pulumi.Input[Union[str, 'AllowRecoverSoftDeletedWorkspace']]] = None,
                 ...
                 soft_delete_enabled: Optional[pulumi.Input[Union[str, 'SoftDeleteEnabled']]] = None,
        ...
        :param pulumi.Input[Union[str, 'AllowRecoverSoftDeletedWorkspace']] allow_recover_soft_deleted_workspace: Allow a soft deleted workspace to be recovered
        ...
        :param pulumi.Input[Union[str, 'SoftDeleteEnabled']] soft_delete_enabled: create a workspace with soft delete capability
        ...
        if allow_recover_soft_deleted_workspace is not None:
    ...
    def allow_recover_soft_deleted_workspace(self) -> Optional[pulumi.Input[Union[str, 'AllowRecoverSoftDeletedWorkspace']]]:
        """
        Allow a soft deleted workspace to be recovered
        """
        return pulumi.get(self, "allow_recover_soft_deleted_workspace")

    @allow_recover_soft_deleted_workspace.setter
    def allow_recover_soft_deleted_workspace(self, value: Optional[pulumi.Input[Union[str, 'AllowRecoverSoftDeletedWorkspace']]]):
        pulumi.set(self, "allow_recover_soft_deleted_workspace", value)
    ...
    def soft_delete_enabled(self) -> Optional[pulumi.Input[Union[str, 'SoftDeleteEnabled']]]:
        """
    ...
    def soft_delete_enabled(self, value: Optional[pulumi.Input[Union[str, 'SoftDeleteEnabled']]]):
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["allow_recover_soft_deleted_workspace"] = allow_recover_soft_deleted_workspace
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200301:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200401:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200601:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200801:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210401:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210701:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:Workspace"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:Workspace")])
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["allow_recover_soft_deleted_workspace"] = None
        ...
        __props__.__dict__["soft_delete_enabled"] = None
    ...
    @property
    @pulumi.getter(name="allowRecoverSoftDeletedWorkspace")
    def allow_recover_soft_deleted_workspace(self) -> pulumi.Output[Optional[str]]:
        """
        Allow a soft deleted workspace to be recovered
        """
        return pulumi.get(self, "allow_recover_soft_deleted_workspace")
    ...
    @property
    @pulumi.getter(name="softDeleteEnabled")
    def soft_delete_enabled(self) -> pulumi.Output[Optional[str]]:
        """
        create a workspace with soft delete capability
        """
        return pulumi.get(self, "soft_delete_enabled")
