...
def get_workspace_connection_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220101preview:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult)
