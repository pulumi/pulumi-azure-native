...
def get_workspace_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_connection is deprecated: azure-native:machinelearningservices/v20220101preview:WorkspaceConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20220201preview:WorkspaceConnection to guarantee forwards compatibility.""")
    __args__ = dict()
