...
def get_workspace_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220101preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
    return __ret__.apply(lambda __response__: GetWorkspaceResult(
        ...
        allow_recover_soft_deleted_workspace=pulumi.get(__response__, 'allow_recover_soft_deleted_workspace'),
        ...
        soft_delete_enabled=pulumi.get(__response__, 'soft_delete_enabled'),
