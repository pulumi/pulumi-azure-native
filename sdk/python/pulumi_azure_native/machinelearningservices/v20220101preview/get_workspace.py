...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    return AwaitableGetWorkspaceResult(
        ...
        allow_recover_soft_deleted_workspace=__ret__.allow_recover_soft_deleted_workspace,
        ...
        ml_flow_tracking_uri=__ret__.ml_flow_tracking_uri,
        name=__ret__.name,
        ...
        storage_hns_enabled=__ret__.storage_hns_enabled,
