...
def list_compute_nodes(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220101preview:listComputeNodes', __args__, opts=opts, typ=ListComputeNodesResult).value
