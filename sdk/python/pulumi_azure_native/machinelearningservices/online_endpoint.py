...
class OnlineEndpointInitArgs:
    def __init__(__self__, *,
        ...
        """
        OnlineEndpointInitArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            online_endpoint_properties=online_endpoint_properties,
    ...
    def _configure(
             ...
             **kwargs):
        if 'onlineEndpointProperties' in kwargs:
            online_endpoint_properties = kwargs['onlineEndpointProperties']
        ...
        _setter("online_endpoint_properties", online_endpoint_properties)
...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OnlineEndpointInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if online_endpoint_properties is not None and not isinstance(online_endpoint_properties, OnlineEndpointArgs):
                online_endpoint_properties = online_endpoint_properties or {}
                def _setter(key, value):
                    online_endpoint_properties[key] = value
                OnlineEndpointArgs._configure(_setter, **online_endpoint_properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:OnlineEndpoint")])
