...
class OnlineEndpointInitArgs:
    ...
    def _configure(
             ...
             online_endpoint_properties: Optional[pulumi.Input['OnlineEndpointArgs']] = None,
             ...
             **kwargs):
        if online_endpoint_properties is None and 'onlineEndpointProperties' in kwargs:
            online_endpoint_properties = kwargs['onlineEndpointProperties']
        if online_endpoint_properties is None:
            raise TypeError("Missing 'online_endpoint_properties' argument")
...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            online_endpoint_properties = _utilities.configure(online_endpoint_properties, OnlineEndpointArgs, True)
