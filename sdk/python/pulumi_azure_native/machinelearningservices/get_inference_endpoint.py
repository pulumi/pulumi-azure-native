...
def get_inference_endpoint(endpoint_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint_name: InferenceEndpoint name.
...
def get_inference_endpoint_output(endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
