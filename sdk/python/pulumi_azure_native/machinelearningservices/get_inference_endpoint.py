...
def get_inference_endpoint(endpoint_name: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_name: InferenceEndpoint name.
...
def get_inference_endpoint_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
