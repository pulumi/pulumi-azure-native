...
def get_featureset_version(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getFeaturesetVersion', __args__, opts=opts, typ=GetFeaturesetVersionResult).value
...
def get_featureset_version_output(name: pulumi.Input[Optional[_builtins.str]] = None,
