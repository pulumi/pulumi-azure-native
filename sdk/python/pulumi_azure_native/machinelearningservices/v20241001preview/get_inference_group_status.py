...
def get_inference_group_status(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:getInferenceGroupStatus', __args__, opts=opts, typ=GetInferenceGroupStatusResult).value
...
def get_inference_group_status_output(group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001preview:getInferenceGroupStatus', __args__, opts=opts, typ=GetInferenceGroupStatusResult)
