...
def list_serverless_endpoint_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:listServerlessEndpointKeys', __args__, opts=opts, typ=ListServerlessEndpointKeysResult).value
