...
class RaiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:RaiPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RaiPolicy, __self__).__init__(
            'azure-native:machinelearningservices/v20241001preview:RaiPolicy',
            resource_name,
            __props__,
            opts)
