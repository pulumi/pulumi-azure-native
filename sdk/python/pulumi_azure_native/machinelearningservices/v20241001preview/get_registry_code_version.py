...
def get_registry_code_version(code_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:getRegistryCodeVersion', __args__, opts=opts, typ=GetRegistryCodeVersionResult).value
...
def get_registry_code_version_output(code_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['version'] = version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001preview:getRegistryCodeVersion', __args__, opts=opts, typ=GetRegistryCodeVersionResult)
