...
class CapabilityHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:CapabilityHost"), pulumi.Alias(type_="azure-native:machinelearningservices:CapabilityHost")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapabilityHost, __self__).__init__(
            'azure-native:machinelearningservices/v20241001preview:CapabilityHost',
            resource_name,
            __props__,
            opts)
