...
def get_model_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:getModelContainer', __args__, opts=opts, typ=GetModelContainerResult).value
...
def get_model_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001preview:getModelContainer', __args__, opts=opts, typ=GetModelContainerResult)
