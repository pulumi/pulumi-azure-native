...
def list_datastore_secrets(expirable_secret: Optional[bool] = None,
    ...
    :param bool expirable_secret: Indicates if the secret is expirable.
    :param int expire_after_hours: Number of hours after which the secret will expire.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:listDatastoreSecrets', __args__, opts=opts, typ=ListDatastoreSecretsResult).value
...
def list_datastore_secrets_output(expirable_secret: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001preview:listDatastoreSecrets', __args__, opts=opts, typ=ListDatastoreSecretsResult)
