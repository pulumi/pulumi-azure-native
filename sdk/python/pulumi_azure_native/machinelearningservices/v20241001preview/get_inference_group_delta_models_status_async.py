...
def get_inference_group_delta_models_status_async(delta_models: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001preview:getInferenceGroupDeltaModelsStatusAsync', __args__, opts=opts, typ=GetInferenceGroupDeltaModelsStatusAsyncResult).value
...
def get_inference_group_delta_models_status_async_output(delta_models: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                         ...
                                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetInferenceGroupDeltaModelsStatusAsyncResult]:
    """
    Contract returning to user the delta models.
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001preview:getInferenceGroupDeltaModelsStatusAsync', __args__, opts=opts, typ=GetInferenceGroupDeltaModelsStatusAsyncResult)
