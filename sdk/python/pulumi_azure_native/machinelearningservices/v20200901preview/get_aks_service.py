...
def get_aks_service(expand: Optional[bool] = None,
    ...
    """
    pulumi.log.warn("""get_aks_service is deprecated: azure-native:machinelearningservices/v20200901preview:AKSService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:AKSService to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200901preview:getAKSService', __args__, opts=opts, typ=GetAKSServiceResult).value
