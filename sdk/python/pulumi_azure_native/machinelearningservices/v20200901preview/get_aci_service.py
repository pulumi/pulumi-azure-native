...
def get_aci_service(expand: Optional[bool] = None,
    ...
    """
    pulumi.log.warn("""get_aci_service is deprecated: azure-native:machinelearningservices/v20200901preview:ACIService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.""")
    __args__ = dict()
