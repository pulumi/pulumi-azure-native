...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if allow_public_access_when_behind_vnet is None and 'allowPublicAccessWhenBehindVnet' in kwargs:
        ...
        if hbi_workspace is None and 'hbiWorkspace' in kwargs:
            hbi_workspace = kwargs['hbiWorkspace']
        if image_build_compute is None and 'imageBuildCompute' in kwargs:
            image_build_compute = kwargs['imageBuildCompute']
        if key_vault is None and 'keyVault' in kwargs:
            key_vault = kwargs['keyVault']
        if shared_private_link_resources is None and 'sharedPrivateLinkResources' in kwargs:
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            encryption = _utilities.configure(encryption, EncryptionPropertyArgs, True)
