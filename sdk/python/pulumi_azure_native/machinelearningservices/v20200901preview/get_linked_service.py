...
def get_linked_service(link_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200901preview:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult).value
...
def get_linked_service_output(link_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20200901preview:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult)
