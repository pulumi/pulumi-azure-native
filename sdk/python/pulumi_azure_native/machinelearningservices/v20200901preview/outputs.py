...
class LabelingDatasetConfigurationResponse(dict):
    ...
    def _configure(
        ...
        if 'datasetVersion' in kwargs:
            dataset_version = kwargs['datasetVersion']
        if 'enableIncrementalDatasetRefresh' in kwargs:
...
class LinkedServicePropsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'linkedServiceResourceId' in kwargs:
