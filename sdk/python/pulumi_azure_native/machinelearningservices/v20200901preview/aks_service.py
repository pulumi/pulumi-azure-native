...
class AKSService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        aks_service = azure_native.machinelearningservices.v20200901preview.AKSService("aksService",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210401:AKSService")])
