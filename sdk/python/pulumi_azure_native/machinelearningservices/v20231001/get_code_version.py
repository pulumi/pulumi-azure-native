...
def get_code_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20231001:getCodeVersion', __args__, opts=opts, typ=GetCodeVersionResult).value
...
def get_code_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20231001:getCodeVersion', __args__, opts=opts, typ=GetCodeVersionResult)
