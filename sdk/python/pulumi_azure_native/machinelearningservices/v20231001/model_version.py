...
class ModelVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:ModelVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ModelVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20231001:ModelVersion',
            resource_name,
            __props__,
            opts)
