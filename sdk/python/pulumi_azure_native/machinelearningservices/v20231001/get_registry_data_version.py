...
def get_registry_data_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20231001:getRegistryDataVersion', __args__, opts=opts, typ=GetRegistryDataVersionResult).value
...
def get_registry_data_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['version'] = version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20231001:getRegistryDataVersion', __args__, opts=opts, typ=GetRegistryDataVersionResult)
