...
def get_registry_data_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20231001:getRegistryDataContainer', __args__, opts=opts, typ=GetRegistryDataContainerResult).value
...
def get_registry_data_container_output(name: Optional[pulumi.Input[str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRegistryDataContainerResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20231001:getRegistryDataContainer', __args__, opts=opts, typ=GetRegistryDataContainerResult)
    return __ret__.apply(lambda __response__: GetRegistryDataContainerResult(
        data_container_properties=pulumi.get(__response__, 'data_container_properties'),
