...
class DatastoreArgs:
    ...
    def _configure(
             ...
             datastore_properties: Optional[pulumi.Input[Union['AzureBlobDatastoreArgs', 'AzureDataLakeGen1DatastoreArgs', 'AzureDataLakeGen2DatastoreArgs', 'AzureFileDatastoreArgs']]] = None,
             ...
             **kwargs):
        if datastore_properties is None and 'datastoreProperties' in kwargs:
            datastore_properties = kwargs['datastoreProperties']
        if datastore_properties is None:
            raise TypeError("Missing 'datastore_properties' argument")
...
class Datastore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 datastore_properties: Optional[pulumi.Input[Union[pulumi.InputType['AzureBlobDatastoreArgs'], pulumi.InputType['AzureDataLakeGen1DatastoreArgs'], pulumi.InputType['AzureDataLakeGen2DatastoreArgs'], pulumi.InputType['AzureFileDatastoreArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 skip_validation: Optional[pulumi.Input[bool]] = None,
                 workspace_name: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:Datastore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Datastore, __self__).__init__(
            'azure-native:machinelearningservices/v20231001:Datastore',
            resource_name,
            __props__,
            opts)
