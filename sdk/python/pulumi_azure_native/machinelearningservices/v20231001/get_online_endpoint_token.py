...
def get_online_endpoint_token(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20231001:getOnlineEndpointToken', __args__, opts=opts, typ=GetOnlineEndpointTokenResult).value
