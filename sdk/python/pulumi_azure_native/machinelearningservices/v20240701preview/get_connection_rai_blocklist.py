...
def get_connection_rai_blocklist(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult).value
...
def get_connection_rai_blocklist_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240701preview:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult)
    return __ret__.apply(lambda __response__: GetConnectionRaiBlocklistResult(
