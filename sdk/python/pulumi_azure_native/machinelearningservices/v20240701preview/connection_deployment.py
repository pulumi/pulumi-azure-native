...
class ConnectionDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:ConnectionDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:ConnectionDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:ConnectionDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices:ConnectionDeployment")])
