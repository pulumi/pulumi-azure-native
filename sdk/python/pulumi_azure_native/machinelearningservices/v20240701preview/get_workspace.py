...
class GetWorkspaceResult:
    ...
    def __init__(__self__, allow_public_access_when_behind_vnet=None, allow_role_assignment_on_rg=None, application_insights=None, associated_workspaces=None, container_registries=None, container_registry=None, description=None, discovery_url=None, enable_data_isolation=None, enable_service_side_cmk_encryption=None, enable_simplified_cmk=None, enable_software_bill_of_materials=None, encryption=None, existing_workspaces=None, feature_store_settings=None, friendly_name=None, hbi_workspace=None, hub_resource_id=None, id=None, identity=None, image_build_compute=None, ip_allowlist=None, key_vault=None, key_vaults=None, kind=None, location=None, managed_network=None, ml_flow_tracking_uri=None, name=None, notebook_info=None, primary_user_assigned_identity=None, private_endpoint_connections=None, private_link_count=None, provisioning_state=None, public_network_access=None, serverless_compute_settings=None, service_managed_resources_settings=None, service_provisioned_resource_group=None, shared_private_link_resources=None, sku=None, soft_delete_retention_in_days=None, storage_account=None, storage_accounts=None, storage_hns_enabled=None, system_data=None, system_datastores_auth_mode=None, tags=None, tenant_id=None, type=None, v1_legacy_mode=None, workspace_hub_config=None, workspace_id=None):
        ...
        if allow_role_assignment_on_rg and not isinstance(allow_role_assignment_on_rg, bool):
            raise TypeError("Expected argument 'allow_role_assignment_on_rg' to be a bool")
        ...
        if enable_simplified_cmk and not isinstance(enable_simplified_cmk, bool):
            raise TypeError("Expected argument 'enable_simplified_cmk' to be a bool")
    ...
    def allow_role_assignment_on_rg(self) -> Optional[bool]:
        """
    ...
    def enable_service_side_cmk_encryption(self) -> Optional[bool]:
        return pulumi.get(self, "enable_service_side_cmk_encryption")

    @property
    @pulumi.getter(name="enableSimplifiedCmk")
    def enable_simplified_cmk(self) -> Optional[bool]:
        """
...
class AwaitableGetWorkspaceResult(GetWorkspaceResult):
    ...
    def __await__(self):
        ...
        return GetWorkspaceResult(
            ...
            allow_role_assignment_on_rg=self.allow_role_assignment_on_rg,
            ...
            enable_simplified_cmk=self.enable_simplified_cmk,
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value

    return AwaitableGetWorkspaceResult(
        allow_public_access_when_behind_vnet=pulumi.get(__ret__, 'allow_public_access_when_behind_vnet'),
        allow_role_assignment_on_rg=pulumi.get(__ret__, 'allow_role_assignment_on_rg'),
        ...
        enable_simplified_cmk=pulumi.get(__ret__, 'enable_simplified_cmk'),
