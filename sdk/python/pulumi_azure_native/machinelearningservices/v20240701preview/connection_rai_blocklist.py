...
class ConnectionRaiBlocklist(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ConnectionRaiBlocklist"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:ConnectionRaiBlocklist")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectionRaiBlocklist, __self__).__init__(
            'azure-native:machinelearningservices/v20240701preview:ConnectionRaiBlocklist',
            resource_name,
            __props__,
            opts)
