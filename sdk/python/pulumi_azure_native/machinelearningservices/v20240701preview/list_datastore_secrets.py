...
def list_datastore_secrets(expirable_secret: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:listDatastoreSecrets', __args__, opts=opts, typ=ListDatastoreSecretsResult).value
