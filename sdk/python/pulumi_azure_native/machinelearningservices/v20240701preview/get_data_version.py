...
def get_data_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult).value
...
def get_data_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240701preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult)
