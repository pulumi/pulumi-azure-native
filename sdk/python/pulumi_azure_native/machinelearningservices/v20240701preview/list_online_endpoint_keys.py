...
def list_online_endpoint_keys(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:listOnlineEndpointKeys', __args__, opts=opts, typ=ListOnlineEndpointKeysResult).value
...
def list_online_endpoint_keys_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240701preview:listOnlineEndpointKeys', __args__, opts=opts, typ=ListOnlineEndpointKeysResult)
