...
def get_connection_deployment(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:getConnectionDeployment', __args__, opts=opts, typ=GetConnectionDeploymentResult).value
