...
def get_compute_allowed_resize_sizes(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240701preview:getComputeAllowedResizeSizes', __args__, opts=opts, typ=GetComputeAllowedResizeSizesResult).value
...
def get_compute_allowed_resize_sizes_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240701preview:getComputeAllowedResizeSizes', __args__, opts=opts, typ=GetComputeAllowedResizeSizesResult)
