...
azure-native:machinelearningservices/v20190501:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200801:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: Version 2019-05-01 will be removed in v2 of the provider.
azure-native:machinelearningservices/v20190501:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200801:Workspace to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20190501:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
