...
def get_data_container(name: Optional[_builtins.str] = None,
...
def get_data_container_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult)
