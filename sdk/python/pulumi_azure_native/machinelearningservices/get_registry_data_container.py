...
class GetRegistryDataContainerResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, data_container_properties=None, id=None, name=None, system_data=None, type=None):
...
def get_registry_data_container(name: Optional[_builtins.str] = None,
...
def get_registry_data_container_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getRegistryDataContainer', __args__, opts=opts, typ=GetRegistryDataContainerResult)
