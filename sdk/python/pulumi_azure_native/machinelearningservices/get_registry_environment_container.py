...
def get_registry_environment_container(environment_name: Optional[_builtins.str] = None,
...
def get_registry_environment_container_output(environment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
