...
class RaiPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:RaiPolicy"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:RaiPolicy")])
