...
def get_batch_deployment(deployment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_name: The identifier for the Batch deployments.
    :param builtins.str endpoint_name: Endpoint name
...
def get_batch_deployment_output(deployment_name: Optional[pulumi.Input[builtins.str]] = None,
