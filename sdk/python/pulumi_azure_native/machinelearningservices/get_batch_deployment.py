...
def get_batch_deployment(deployment_name: Optional[_builtins.str] = None,
...
def get_batch_deployment_output(deployment_name: Optional[pulumi.Input[_builtins.str]] = None,
