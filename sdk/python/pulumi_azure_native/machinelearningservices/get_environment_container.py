...
def get_environment_container(name: Optional[_builtins.str] = None,
...
def get_environment_container_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
