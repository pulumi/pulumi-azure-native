...
def get_registry_component_version(component_name: Optional[builtins.str] = None,
    ...
    :param builtins.str component_name: Container name.
...
def get_registry_component_version_output(component_name: Optional[pulumi.Input[builtins.str]] = None,
