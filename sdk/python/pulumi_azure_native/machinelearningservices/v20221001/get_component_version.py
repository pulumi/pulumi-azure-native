...
def get_component_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221001:getComponentVersion', __args__, opts=opts, typ=GetComponentVersionResult)
