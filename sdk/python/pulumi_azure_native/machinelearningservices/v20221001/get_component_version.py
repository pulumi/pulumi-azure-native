...
warnings.warn("""azure-native:machinelearningservices/v20221001:ComponentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_component_version(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component_version is deprecated: azure-native:machinelearningservices/v20221001:ComponentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001:getComponentVersion', __args__, opts=opts, typ=GetComponentVersionResult).value
