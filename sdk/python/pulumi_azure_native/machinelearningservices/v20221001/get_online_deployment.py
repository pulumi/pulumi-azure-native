...
def get_online_deployment_output(deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221001:getOnlineDeployment', __args__, opts=opts, typ=GetOnlineDeploymentResult)
