...
def get_batch_deployment(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_deployment is deprecated: azure-native:machinelearningservices/v20221001:BatchDeployment is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:BatchDeployment to guarantee forwards compatibility.""")
    __args__ = dict()
