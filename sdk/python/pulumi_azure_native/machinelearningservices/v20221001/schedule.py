...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:Schedule")])
