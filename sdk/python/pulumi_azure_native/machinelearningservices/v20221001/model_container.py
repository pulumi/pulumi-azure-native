...
class ModelContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ModelContainer is deprecated: azure-native:machinelearningservices/v20221001:ModelContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ModelContainer to guarantee forwards compatibility.""")
