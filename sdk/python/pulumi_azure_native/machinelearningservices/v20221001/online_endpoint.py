...
warnings.warn("""azure-native:machinelearningservices/v20221001:OnlineEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:OnlineEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""OnlineEndpoint is deprecated: azure-native:machinelearningservices/v20221001:OnlineEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:OnlineEndpoint to guarantee forwards compatibility.""")
