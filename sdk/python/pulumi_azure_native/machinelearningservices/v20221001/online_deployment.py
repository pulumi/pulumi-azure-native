...
warnings.warn("""azure-native:machinelearningservices/v20221001:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineDeployment to guarantee forwards compatibility.""", DeprecationWarning)
...
class OnlineDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""OnlineDeployment is deprecated: azure-native:machinelearningservices/v20221001:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineDeployment to guarantee forwards compatibility.""")
