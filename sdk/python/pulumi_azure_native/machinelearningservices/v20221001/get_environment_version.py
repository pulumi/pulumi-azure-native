...
def get_environment_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221001:getEnvironmentVersion', __args__, opts=opts, typ=GetEnvironmentVersionResult)
