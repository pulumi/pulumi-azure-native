...
warnings.warn("""azure-native:machinelearningservices/v20221001:ComponentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_component_container(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component_container is deprecated: azure-native:machinelearningservices/v20221001:ComponentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:ComponentContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult).value
