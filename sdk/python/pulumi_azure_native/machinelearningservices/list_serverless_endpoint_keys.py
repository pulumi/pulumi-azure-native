...
def list_serverless_endpoint_keys(name: Optional[_builtins.str] = None,
...
def list_serverless_endpoint_keys_output(name: Optional[pulumi.Input[_builtins.str]] = None,
