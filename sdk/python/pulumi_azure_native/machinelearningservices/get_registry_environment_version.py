...
def get_registry_environment_version(environment_name: Optional[builtins.str] = None,
...
def get_registry_environment_version_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
