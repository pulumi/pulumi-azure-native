...
class OutboundRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:OutboundRule")])
