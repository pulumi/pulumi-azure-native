...
class OutboundRuleArgs:
    def __init__(__self__, *,
                 managed_network_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] managed_network_name: Name of the managedNetwork associated with the workspace. Only 'default' is supported.
        ...
        :param pulumi.Input[builtins.str] rule_name: Name of the workspace managed network outbound rule
        """
    ...
    def managed_network_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def managed_network_name(self, value: pulumi.Input[builtins.str]):
...
class OutboundRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:OutboundRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:OutboundRule")])
