...
class GetDataVersionResult:
    ...
    """
    def __init__(__self__, data_version_base_details=None, id=None, name=None, system_data=None, type=None):
        if data_version_base_details and not isinstance(data_version_base_details, dict):
            raise TypeError("Expected argument 'data_version_base_details' to be a dict")
    ...
    def data_version_base_details(self) -> Any:
        """
...
class AwaitableGetDataVersionResult(GetDataVersionResult):
    ...
    def __await__(self):
        ...
        return GetDataVersionResult(
            data_version_base_details=self.data_version_base_details,
            id=self.id,
            name=self.name,
...
def get_data_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult)
    return __ret__.apply(lambda __response__: GetDataVersionResult(
        data_version_base_details=pulumi.get(__response__, 'data_version_base_details'),
