...
def get_component_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220201preview:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult).value

    return AwaitableGetComponentContainerResult(
        component_container_details=pulumi.get(__ret__, 'component_container_details'),
...
def get_component_container_output(name: Optional[pulumi.Input[str]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetComponentContainerResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult)
    return __ret__.apply(lambda __response__: GetComponentContainerResult(
        component_container_details=pulumi.get(__response__, 'component_container_details'),
