...
class GetBatchEndpointResult:
    def __init__(__self__, batch_endpoint_details=None, id=None, identity=None, kind=None, location=None, name=None, sku=None, system_data=None, tags=None, type=None):
...
def get_batch_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getBatchEndpoint', __args__, opts=opts, typ=GetBatchEndpointResult)
    return __ret__.apply(lambda __response__: GetBatchEndpointResult(
        batch_endpoint_details=pulumi.get(__response__, 'batch_endpoint_details'),
