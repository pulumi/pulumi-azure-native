...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        online_endpoint = azure_native.machinelearningservices.v20220201preview.OnlineEndpoint("onlineEndpoint",
            endpoint_name="testEndpointName",
            identity=azure_native.machinelearningservices.v20220201preview.ManagedServiceIdentityResponseArgs(
                type="SystemAssigned",
            ...
            kind="string",
            location="string",
            online_endpoint_details=azure_native.machinelearningservices.v20220201preview.OnlineEndpointArgs(
                auth_mode="AMLToken",
                compute="string",
                description="string",
                properties={
            ...
            sku=azure_native.machinelearningservices.v20220201preview.SkuResponseArgs(
                capacity=1,
                family="string",
                name="string",
                size="string",
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20220201preview:OnlineEndpoint string string 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:OnlineEndpoint")])
