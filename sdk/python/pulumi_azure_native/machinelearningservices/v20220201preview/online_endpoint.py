...
class OnlineEndpointInitArgs:
    ...
    def _configure(
             ...
             online_endpoint_details: Optional[pulumi.Input['OnlineEndpointArgs']] = None,
             ...
             **kwargs):
        if online_endpoint_details is None and 'onlineEndpointDetails' in kwargs:
            online_endpoint_details = kwargs['onlineEndpointDetails']
        if online_endpoint_details is None:
            raise TypeError("Missing 'online_endpoint_details' argument")
...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            online_endpoint_details = _utilities.configure(online_endpoint_details, OnlineEndpointArgs, True)
