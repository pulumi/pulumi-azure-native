...
class OnlineEndpointInitArgs:
    def __init__(__self__, *,
        ...
        OnlineEndpointInitArgs._configure(
            ...
            online_endpoint_details=online_endpoint_details,
    ...
    def _configure(
             ...
             **kwargs):
        if 'onlineEndpointDetails' in kwargs:
            online_endpoint_details = kwargs['onlineEndpointDetails']
        ...
        _setter("online_endpoint_details", online_endpoint_details)
...
class OnlineEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 online_endpoint_details: Optional[pulumi.Input[pulumi.InputType['OnlineEndpointArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['OnlineEndpointArgs']] online_endpoint_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if online_endpoint_details is not None and not isinstance(online_endpoint_details, OnlineEndpointArgs):
                online_endpoint_details = online_endpoint_details or {}
                def _setter(key, value):
                    online_endpoint_details[key] = value
                OnlineEndpointArgs._configure(_setter, **online_endpoint_details)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:OnlineEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:OnlineEndpoint")])
