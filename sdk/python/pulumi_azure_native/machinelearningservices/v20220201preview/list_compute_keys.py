...
def list_compute_keys_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:listComputeKeys', __args__, opts=opts, typ=ListComputeKeysResult)
