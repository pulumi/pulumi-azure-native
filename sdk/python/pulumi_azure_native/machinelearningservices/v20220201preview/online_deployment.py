...
class OnlineDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 online_deployment_details: Optional[pulumi.Input[Union[Union['KubernetesOnlineDeploymentArgs', 'KubernetesOnlineDeploymentArgsDict'], Union['ManagedOnlineDeploymentArgs', 'ManagedOnlineDeploymentArgsDict']]]] = None,
        ...
        :param pulumi.Input[str] kind: Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[Union[Union['KubernetesOnlineDeploymentArgs', 'KubernetesOnlineDeploymentArgsDict'], Union['ManagedOnlineDeploymentArgs', 'ManagedOnlineDeploymentArgsDict']]] online_deployment_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
