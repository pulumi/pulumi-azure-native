...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 code_container_details: Optional[pulumi.Input[Union['CodeContainerArgs', 'CodeContainerArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['CodeContainerArgs', 'CodeContainerArgsDict']] code_container_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
