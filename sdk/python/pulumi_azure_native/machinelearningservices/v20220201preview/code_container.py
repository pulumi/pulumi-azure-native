...
class CodeContainerInitArgs:
    ...
    def _configure(
             ...
             code_container_details: Optional[pulumi.Input['CodeContainerArgs']] = None,
             resource_group_name: Optional[pulumi.Input[str]] = None,
             workspace_name: Optional[pulumi.Input[str]] = None,
             name: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if code_container_details is None and 'codeContainerDetails' in kwargs:
            code_container_details = kwargs['codeContainerDetails']
        if code_container_details is None:
            raise TypeError("Missing 'code_container_details' argument")
...
class CodeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            code_container_details = _utilities.configure(code_container_details, CodeContainerArgs, True)
