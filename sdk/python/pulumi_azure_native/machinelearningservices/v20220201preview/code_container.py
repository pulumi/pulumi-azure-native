...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        code_container = azure_native.machinelearningservices.v20220201preview.CodeContainer("codeContainer",
            code_container_details=azure_native.machinelearningservices.v20220201preview.CodeContainerArgs(
                description="string",
                tags={
                    "tag1": "value1",
                    "tag2": "value2",
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20220201preview:CodeContainer testContainer /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/testworkspace/codes/testContainer 
        ```
