...
class CodeContainerInitArgs:
    def __init__(__self__, *,
        ...
        """
        CodeContainerInitArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            code_container_details=code_container_details,
    ...
    def _configure(
             ...
             **kwargs):
        if 'codeContainerDetails' in kwargs:
            code_container_details = kwargs['codeContainerDetails']
        if 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if 'workspaceName' in kwargs:
            workspace_name = kwargs['workspaceName']

        _setter("code_container_details", code_container_details)
...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CodeContainerInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if code_container_details is not None and not isinstance(code_container_details, CodeContainerArgs):
                code_container_details = code_container_details or {}
                def _setter(key, value):
                    code_container_details[key] = value
                CodeContainerArgs._configure(_setter, **code_container_details)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:CodeContainer")])
