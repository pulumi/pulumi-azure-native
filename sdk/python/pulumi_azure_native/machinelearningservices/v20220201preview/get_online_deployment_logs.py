...
def get_online_deployment_logs(container_type: Optional[Union[str, 'ContainerType']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220201preview:getOnlineDeploymentLogs', __args__, opts=opts, typ=GetOnlineDeploymentLogsResult).value
...
def get_online_deployment_logs_output(container_type: Optional[pulumi.Input[Optional[Union[str, 'ContainerType']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getOnlineDeploymentLogs', __args__, opts=opts, typ=GetOnlineDeploymentLogsResult)
