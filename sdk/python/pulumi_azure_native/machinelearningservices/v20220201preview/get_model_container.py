...
def get_model_container(name: Optional[str] = None,
    ...
    return AwaitableGetModelContainerResult(
        ...
        model_container_details=pulumi.get(__ret__, 'model_container_details'),
...
def get_model_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getModelContainer', __args__, opts=opts, typ=GetModelContainerResult)
    return __ret__.apply(lambda __response__: GetModelContainerResult(
        id=pulumi.get(__response__, 'id'),
        model_container_details=pulumi.get(__response__, 'model_container_details'),
