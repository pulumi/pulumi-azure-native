...
class EnvironmentVersionInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EnvironmentVersionArgs'] environment_version_details: [Required] Additional attributes of the entity.
    ...
    def environment_version_details(self) -> pulumi.Input['EnvironmentVersionArgs']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "environment_version_details")

    @environment_version_details.setter
    def environment_version_details(self, value: pulumi.Input['EnvironmentVersionArgs']):
        pulumi.set(self, "environment_version_details", value)
...
class EnvironmentVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_version_details: Optional[pulumi.Input[pulumi.InputType['EnvironmentVersionArgs']]] = None,
        ...
        environment_version = azure_native.machinelearningservices.v20220201preview.EnvironmentVersion("environmentVersion",
            environment_version_details=azure_native.machinelearningservices.v20220201preview.EnvironmentVersionResponseArgs(
                build=azure_native.machinelearningservices.v20220201preview.BuildContextArgs(
                ...
                inference_config=azure_native.machinelearningservices.v20220201preview.InferenceContainerPropertiesArgs(
                    liveness_route=azure_native.machinelearningservices.v20220201preview.RouteArgs(
                        path="string",
                        port=1,
                    ),
                    readiness_route=azure_native.machinelearningservices.v20220201preview.RouteArgs(
                        path="string",
                        port=1,
                    ),
                    scoring_route=azure_native.machinelearningservices.v20220201preview.RouteArgs(
                        path="string",
                        port=1,
                    ),
                ),
        ...
        :param pulumi.Input[pulumi.InputType['EnvironmentVersionArgs']] environment_version_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Name of EnvironmentVersion. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version of EnvironmentVersion.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["environment_version_details"] = None
    ...
    @property
    @pulumi.getter(name="environmentVersionDetails")
    def environment_version_details(self) -> pulumi.Output['outputs.EnvironmentVersionResponse']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "environment_version_details")
