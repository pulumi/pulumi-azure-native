...
class EnvironmentVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_version_details: Optional[pulumi.Input[Union['EnvironmentVersionArgs', 'EnvironmentVersionArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['EnvironmentVersionArgs', 'EnvironmentVersionArgsDict']] environment_version_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Name of EnvironmentVersion. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version of EnvironmentVersion.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
