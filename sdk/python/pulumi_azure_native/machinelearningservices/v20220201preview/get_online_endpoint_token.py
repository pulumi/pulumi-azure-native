...
def get_online_endpoint_token(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220201preview:getOnlineEndpointToken', __args__, opts=opts, typ=GetOnlineEndpointTokenResult).value
...
def get_online_endpoint_token_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220201preview:getOnlineEndpointToken', __args__, opts=opts, typ=GetOnlineEndpointTokenResult)
