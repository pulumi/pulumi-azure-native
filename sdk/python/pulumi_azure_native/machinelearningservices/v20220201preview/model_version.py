...
class ModelVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 model_version_details: Optional[pulumi.Input[Union['ModelVersionArgs', 'ModelVersionArgsDict']]] = None,
        ...
        :param pulumi.Input[Union['ModelVersionArgs', 'ModelVersionArgsDict']] model_version_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version identifier. This is case-sensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
