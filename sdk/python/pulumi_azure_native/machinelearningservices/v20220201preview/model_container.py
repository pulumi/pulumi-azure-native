...
class ModelContainerInitArgs:
    def __init__(__self__, *,
                 model_container_details: pulumi.Input['ModelContainerArgs'],
                 resource_group_name: pulumi.Input[str],
                 workspace_name: pulumi.Input[str],
                 name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a ModelContainer resource.
        :param pulumi.Input['ModelContainerArgs'] model_container_details: [Required] Additional attributes of the entity.
        ...
        ModelContainerInitArgs._configure(
            ...
            model_container_details=model_container_details,
    ...
    def _configure(
             ...
             model_container_details: Optional[pulumi.Input['ModelContainerArgs']] = None,
             resource_group_name: Optional[pulumi.Input[str]] = None,
             workspace_name: Optional[pulumi.Input[str]] = None,
             name: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if model_container_details is None and 'modelContainerDetails' in kwargs:
            model_container_details = kwargs['modelContainerDetails']
        if model_container_details is None:
            raise TypeError("Missing 'model_container_details' argument")
        ...
        _setter("model_container_details", model_container_details)
    ...
    def model_container_details(self) -> pulumi.Input['ModelContainerArgs']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "model_container_details")

    @model_container_details.setter
    def model_container_details(self, value: pulumi.Input['ModelContainerArgs']):
        pulumi.set(self, "model_container_details", value)
...
class ModelContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 model_container_details: Optional[pulumi.Input[pulumi.InputType['ModelContainerArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[pulumi.InputType['ModelContainerArgs']] model_container_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name. This is case-sensitive.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            model_container_details = _utilities.configure(model_container_details, ModelContainerArgs, True)
            if model_container_details is None and not opts.urn:
                raise TypeError("Missing required property 'model_container_details'")
            __props__.__dict__["model_container_details"] = model_container_details
        ...
        super(ModelContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20220201preview:ModelContainer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["model_container_details"] = None
    ...
    @property
    @pulumi.getter(name="modelContainerDetails")
    def model_container_details(self) -> pulumi.Output['outputs.ModelContainerResponse']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "model_container_details")
