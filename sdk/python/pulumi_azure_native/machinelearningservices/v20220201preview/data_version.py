...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_version_base_details: Optional[pulumi.Input[Union[Union['MLTableDataArgs', 'MLTableDataArgsDict'], Union['UriFileDataVersionArgs', 'UriFileDataVersionArgsDict'], Union['UriFolderDataVersionArgs', 'UriFolderDataVersionArgsDict']]]] = None,
        ...
        :param pulumi.Input[Union[Union['MLTableDataArgs', 'MLTableDataArgsDict'], Union['UriFileDataVersionArgs', 'UriFileDataVersionArgsDict'], Union['UriFolderDataVersionArgs', 'UriFolderDataVersionArgsDict']]] data_version_base_details: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version identifier.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
