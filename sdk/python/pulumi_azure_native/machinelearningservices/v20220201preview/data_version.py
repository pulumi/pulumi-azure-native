...
class DataVersionArgs:
    def __init__(__self__, *,
        ...
        DataVersionArgs._configure(
            ...
            data_version_base_details=data_version_base_details,
            name=name,
    ...
    def _configure(
             ...
             data_version_base_details: Optional[pulumi.Input[Union['MLTableDataArgs', 'UriFileDataVersionArgs', 'UriFolderDataVersionArgs']]] = None,
             ...
             **kwargs):
        if data_version_base_details is None and 'dataVersionBaseDetails' in kwargs:
            data_version_base_details = kwargs['dataVersionBaseDetails']
        if data_version_base_details is None:
            raise TypeError("Missing 'data_version_base_details' argument")
        if name is None:
        ...
        _setter("data_version_base_details", data_version_base_details)
        _setter("name", name)
