...
class DatastoreArgs:
    ...
    def _configure(
             ...
             datastore_details: Optional[pulumi.Input[Union['AzureBlobDatastoreArgs', 'AzureDataLakeGen1DatastoreArgs', 'AzureDataLakeGen2DatastoreArgs', 'AzureFileDatastoreArgs', 'HdfsDatastoreArgs']]] = None,
             ...
             **kwargs):
        if datastore_details is None and 'datastoreDetails' in kwargs:
            datastore_details = kwargs['datastoreDetails']
        if datastore_details is None:
            raise TypeError("Missing 'datastore_details' argument")
