...
class BatchDeploymentInitArgs:
    def __init__(__self__, *,
        ...
        BatchDeploymentInitArgs._configure(
            ...
            batch_deployment_details=batch_deployment_details,
    ...
    def _configure(
             ...
             batch_deployment_details: Optional[pulumi.Input['BatchDeploymentArgs']] = None,
             ...
             **kwargs):
        if batch_deployment_details is None and 'batchDeploymentDetails' in kwargs:
            batch_deployment_details = kwargs['batchDeploymentDetails']
        if batch_deployment_details is None:
            raise TypeError("Missing 'batch_deployment_details' argument")
        ...
        _setter("batch_deployment_details", batch_deployment_details)
...
class BatchDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            batch_deployment_details = _utilities.configure(batch_deployment_details, BatchDeploymentArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:BatchDeployment")])
