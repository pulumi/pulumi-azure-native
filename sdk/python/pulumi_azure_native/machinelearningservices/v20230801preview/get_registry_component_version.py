...
def get_registry_component_version(component_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230801preview:getRegistryComponentVersion', __args__, opts=opts, typ=GetRegistryComponentVersionResult).value
...
def get_registry_component_version_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['version'] = version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230801preview:getRegistryComponentVersion', __args__, opts=opts, typ=GetRegistryComponentVersionResult)
