...
def get_featurestore_entity_container_entity(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230801preview:getFeaturestoreEntityContainerEntity', __args__, opts=opts, typ=GetFeaturestoreEntityContainerEntityResult).value
...
def get_featurestore_entity_container_entity_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230801preview:getFeaturestoreEntityContainerEntity', __args__, opts=opts, typ=GetFeaturestoreEntityContainerEntityResult)
