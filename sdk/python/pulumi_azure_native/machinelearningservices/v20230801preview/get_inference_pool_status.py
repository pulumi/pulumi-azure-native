...
def get_inference_pool_status(inference_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230801preview:getInferencePoolStatus', __args__, opts=opts, typ=GetInferencePoolStatusResult).value
...
def get_inference_pool_status_output(inference_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230801preview:getInferencePoolStatus', __args__, opts=opts, typ=GetInferencePoolStatusResult)
