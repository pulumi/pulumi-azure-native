...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:machinelearningservices:CapacityReservationGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CapacityReservationGroup, __self__).__init__(
            'azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup',
            resource_name,
            __props__,
            opts)
