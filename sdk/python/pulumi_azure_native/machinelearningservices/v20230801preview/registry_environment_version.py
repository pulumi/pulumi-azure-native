...
class RegistryEnvironmentVersionArgs:
    ...
    def _configure(
        ...
        if 'environmentVersionProperties' in kwargs:
            environment_version_properties = kwargs['environmentVersionProperties']
...
class RegistryEnvironmentVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if environment_version_properties is not None and not isinstance(environment_version_properties, EnvironmentVersionArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:RegistryEnvironmentVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryEnvironmentVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20230801preview:RegistryEnvironmentVersion',
            resource_name,
            __props__,
            opts)
