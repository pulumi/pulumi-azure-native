...
def get_datastore(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230801preview:getDatastore', __args__, opts=opts, typ=GetDatastoreResult).value
...
def get_datastore_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230801preview:getDatastore', __args__, opts=opts, typ=GetDatastoreResult)
