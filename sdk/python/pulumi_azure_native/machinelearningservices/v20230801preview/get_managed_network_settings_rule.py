...
def get_managed_network_settings_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230801preview:getManagedNetworkSettingsRule', __args__, opts=opts, typ=GetManagedNetworkSettingsRuleResult).value
...
def get_managed_network_settings_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230801preview:getManagedNetworkSettingsRule', __args__, opts=opts, typ=GetManagedNetworkSettingsRuleResult)
