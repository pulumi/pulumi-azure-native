...
class ServerlessEndpointInitArgs:
    def __init__(__self__, *,
        ...
        """
        ServerlessEndpointInitArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            resource_group_name=resource_group_name,
            serverless_endpoint_properties=serverless_endpoint_properties,
    ...
    def _configure(
             ...
             serverless_endpoint_properties: Optional[pulumi.Input['ServerlessEndpointArgs']] = None,
        ...
        if serverless_endpoint_properties is None and 'serverlessEndpointProperties' in kwargs:
            serverless_endpoint_properties = kwargs['serverlessEndpointProperties']
        if serverless_endpoint_properties is None:
            raise TypeError("Missing 'serverless_endpoint_properties' argument")
        ...
        _setter("serverless_endpoint_properties", serverless_endpoint_properties)
...
class ServerlessEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 serverless_endpoint_properties: Optional[pulumi.Input[pulumi.InputType['ServerlessEndpointArgs']]] = None,
                 sku: Optional[pulumi.Input[pulumi.InputType['SkuArgs']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a ServerlessEndpoint resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] name: Serverless Endpoint name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[pulumi.InputType['ServerlessEndpointArgs']] serverless_endpoint_properties: [Required] Additional attributes of the entity.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ServerlessEndpointInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            serverless_endpoint_properties = _utilities.configure(serverless_endpoint_properties, ServerlessEndpointArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ServerlessEndpoint")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerlessEndpoint, __self__).__init__(
            'azure-native:machinelearningservices/v20230801preview:ServerlessEndpoint',
            resource_name,
            __props__,
            opts)
