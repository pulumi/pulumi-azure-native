...
class InferencePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if inference_pool_properties is not None and not isinstance(inference_pool_properties, InferencePoolArgs):
                inference_pool_properties = inference_pool_properties or {}
                def _setter(key, value):
                    inference_pool_properties[key] = value
                InferencePoolArgs._configure(_setter, **inference_pool_properties)
