...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if associated_workspaces is None and 'associatedWorkspaces' in kwargs:
        ...
        if serverless_compute_settings is None and 'serverlessComputeSettings' in kwargs:
        ...
        if workspace_hub_config is None and 'workspaceHubConfig' in kwargs:
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            serverless_compute_settings = _utilities.configure(serverless_compute_settings, ServerlessComputeSettingsArgs, True)
            ...
            workspace_hub_config = _utilities.configure(workspace_hub_config, WorkspaceHubConfigArgs, True)
