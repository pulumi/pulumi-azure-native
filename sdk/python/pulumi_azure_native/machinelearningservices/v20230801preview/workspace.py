...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        WorkspaceArgs._configure(
            ...
            associated_workspaces=associated_workspaces,
    ...
    def _configure(
        ...
        if 'associatedWorkspaces' in kwargs:
            associated_workspaces = kwargs['associatedWorkspaces']
        ...
        if 'serverlessComputeSettings' in kwargs:
            serverless_compute_settings = kwargs['serverlessComputeSettings']
        ...
        if 'workspaceHubConfig' in kwargs:
            workspace_hub_config = kwargs['workspaceHubConfig']
        ...
        if associated_workspaces is not None:
            _setter("associated_workspaces", associated_workspaces)
        ...
        if serverless_compute_settings is not None:
            _setter("serverless_compute_settings", serverless_compute_settings)
        ...
        if workspace_hub_config is not None:
            _setter("workspace_hub_config", workspace_hub_config)
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if serverless_compute_settings is not None and not isinstance(serverless_compute_settings, ServerlessComputeSettingsArgs):
                serverless_compute_settings = serverless_compute_settings or {}
                def _setter(key, value):
                    serverless_compute_settings[key] = value
                ServerlessComputeSettingsArgs._configure(_setter, **serverless_compute_settings)
            ...
            if workspace_hub_config is not None and not isinstance(workspace_hub_config, WorkspaceHubConfigArgs):
                workspace_hub_config = workspace_hub_config or {}
                def _setter(key, value):
                    workspace_hub_config[key] = value
                WorkspaceHubConfigArgs._configure(_setter, **workspace_hub_config)
