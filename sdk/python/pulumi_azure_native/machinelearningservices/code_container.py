...
class CodeContainerArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input['CodeContainerPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['CodeContainerPropertiesArgs']):
...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['CodeContainerPropertiesArgs', 'CodeContainerPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Container name. This is case-sensitive.
        :param pulumi.Input[Union['CodeContainerPropertiesArgs', 'CodeContainerPropertiesArgsDict']] properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] workspace_name: Name of Azure Machine Learning workspace.
        """
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.CodeContainerPropertiesResponse']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "properties")
