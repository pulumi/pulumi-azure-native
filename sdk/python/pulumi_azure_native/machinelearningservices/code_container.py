...
class CodeContainerInitArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'codeContainerProperties' in kwargs:
...
class CodeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if code_container_properties is not None and not isinstance(code_container_properties, CodeContainerArgs):
                code_container_properties = code_container_properties or {}
                def _setter(key, value):
                    code_container_properties[key] = value
                CodeContainerArgs._configure(_setter, **code_container_properties)
