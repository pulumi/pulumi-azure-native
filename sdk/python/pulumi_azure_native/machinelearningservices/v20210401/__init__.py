...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:machinelearningservices/v20210401:MachineLearningCompute":
                return MachineLearningCompute(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20210401:MachineLearningService":
                return MachineLearningService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20210401:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20210401:Workspace":
                return Workspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20210401:WorkspaceConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "machinelearningservices/v20210401", _module_instance)
