...
class ACIService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            data_collection = _utilities.configure(data_collection, ACIServiceCreateRequestDataCollectionArgs, True)
            __props__.__dict__["data_collection"] = data_collection
            __props__.__dict__["description"] = description
            __props__.__dict__["dns_name_label"] = dns_name_label
            encryption_properties = _utilities.configure(encryption_properties, ACIServiceCreateRequestEncryptionPropertiesArgs, True)
            ...
            vnet_configuration = _utilities.configure(vnet_configuration, ACIServiceCreateRequestVnetConfigurationArgs, True)
