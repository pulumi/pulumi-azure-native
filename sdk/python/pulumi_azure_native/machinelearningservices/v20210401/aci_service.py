...
class ACIService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(container_resource_requirements, ContainerResourceRequirementsArgs):
            ...
            if not isinstance(data_collection, ACIServiceCreateRequestDataCollectionArgs):
            ...
            if not isinstance(encryption_properties, ACIServiceCreateRequestEncryptionPropertiesArgs):
            ...
            if not isinstance(vnet_configuration, ACIServiceCreateRequestVnetConfigurationArgs):
