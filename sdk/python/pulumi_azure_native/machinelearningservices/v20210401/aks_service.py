...
class AKSService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auto_scaler is not None and not isinstance(auto_scaler, AKSServiceCreateRequestAutoScalerArgs):
                auto_scaler = auto_scaler or {}
                def _setter(key, value):
                    auto_scaler[key] = value
                AKSServiceCreateRequestAutoScalerArgs._configure(_setter, **auto_scaler)
            ...
            if data_collection is not None and not isinstance(data_collection, AKSServiceCreateRequestDataCollectionArgs):
                data_collection = data_collection or {}
                def _setter(key, value):
                    data_collection[key] = value
                AKSServiceCreateRequestDataCollectionArgs._configure(_setter, **data_collection)
            ...
            if liveness_probe_requirements is not None and not isinstance(liveness_probe_requirements, AKSServiceCreateRequestLivenessProbeRequirementsArgs):
                liveness_probe_requirements = liveness_probe_requirements or {}
                def _setter(key, value):
                    liveness_probe_requirements[key] = value
                AKSServiceCreateRequestLivenessProbeRequirementsArgs._configure(_setter, **liveness_probe_requirements)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:AKSService")])
