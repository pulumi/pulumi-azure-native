...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: azure-native:machinelearningservices/v20210401:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20220101preview:Workspace to guarantee forwards compatibility.""")
    __args__ = dict()
