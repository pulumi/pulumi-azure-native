...
class MachineLearningCompute(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        machine_learning_compute = azure_native.machinelearningservices.v20210401.MachineLearningCompute("machineLearningCompute",
            compute_name="compute123",
            location="eastus",
            properties=azure_native.machinelearningservices.v20210401.AKSArgs(
                compute_type="AKS",
            ),
        ...
        machine_learning_compute = azure_native.machinelearningservices.v20210401.MachineLearningCompute("machineLearningCompute",
            compute_name="compute123",
            location="eastus",
            properties=azure_native.machinelearningservices.v20210401.AmlComputeArgs(
                compute_type="AmlCompute",
                properties=azure_native.machinelearningservices.v20210401.AmlComputePropertiesArgs(
                    enable_node_public_ip=True,
                    isolated_network=False,
                    os_type="Windows",
                    remote_login_port_public_access="NotSpecified",
                    scale_settings=azure_native.machinelearningservices.v20210401.ScaleSettingsArgs(
                        max_node_count=1,
                        min_node_count=0,
                        node_idle_time_before_scale_down="PT5M",
                    ),
                    virtual_machine_image=azure_native.machinelearningservices.v20210401.VirtualMachineImageArgs(
        ...
        machine_learning_compute = azure_native.machinelearningservices.v20210401.MachineLearningCompute("machineLearningCompute",
            compute_name="compute123",
            location="eastus",
            properties=azure_native.machinelearningservices.v20210401.DataFactoryArgs(
        ...
        machine_learning_compute = azure_native.machinelearningservices.v20210401.MachineLearningCompute("machineLearningCompute",
            compute_name="compute123",
            location="eastus",
            properties=azure_native.machinelearningservices.v20210401.ComputeInstanceArgs(
                compute_type="ComputeInstance",
                properties=azure_native.machinelearningservices.v20210401.ComputeInstancePropertiesArgs(
                    application_sharing_policy="Personal",
                    compute_instance_authorization_type="personal",
                    personal_compute_instance_settings=azure_native.machinelearningservices.v20210401.PersonalComputeInstanceSettingsArgs(
                        assigned_user=azure_native.machinelearningservices.v20210401.AssignedUserArgs(
                            object_id="00000000-0000-0000-0000-000000000000",
                            tenant_id="00000000-0000-0000-0000-000000000000",
                        ),
                    ),
                    ssh_settings=azure_native.machinelearningservices.v20210401.ComputeInstanceSshSettingsArgs(
        ...
        machine_learning_compute = azure_native.machinelearningservices.v20210401.MachineLearningCompute("machineLearningCompute",
            ...
            properties=azure_native.machinelearningservices.v20210401.AKSArgs(
                ...
                properties=azure_native.machinelearningservices.v20210401.AKSPropertiesArgs(
                    agent_count=4,
                ),
