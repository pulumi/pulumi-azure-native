...
class MachineLearningCompute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200301:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200801:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220101preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:MachineLearningCompute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:MachineLearningCompute")])
