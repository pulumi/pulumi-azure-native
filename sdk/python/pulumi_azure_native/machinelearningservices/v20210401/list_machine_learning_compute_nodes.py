...
def list_machine_learning_compute_nodes(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210401:listMachineLearningComputeNodes', __args__, opts=opts, typ=ListMachineLearningComputeNodesResult).value
...
def list_machine_learning_compute_nodes_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210401:listMachineLearningComputeNodes', __args__, opts=opts, typ=ListMachineLearningComputeNodesResult)
