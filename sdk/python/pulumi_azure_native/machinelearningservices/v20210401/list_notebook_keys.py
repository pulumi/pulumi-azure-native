...
def list_notebook_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210401:listNotebookKeys', __args__, opts=opts, typ=ListNotebookKeysResult).value
...
def list_notebook_keys_output(resource_group_name: Optional[pulumi.Input[str]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListNotebookKeysResult]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210401:listNotebookKeys', __args__, opts=opts, typ=ListNotebookKeysResult)
    return __ret__.apply(lambda __response__: ListNotebookKeysResult(
