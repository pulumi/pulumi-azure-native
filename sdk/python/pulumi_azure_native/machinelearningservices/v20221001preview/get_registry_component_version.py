...
def get_registry_component_version_output(component_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221001preview:getRegistryComponentVersion', __args__, opts=opts, typ=GetRegistryComponentVersionResult)
