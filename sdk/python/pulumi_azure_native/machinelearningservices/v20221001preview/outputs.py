...
__all__ = [
    ...
    'TableFixedParametersResponse',
    'TableParameterSubspaceResponse',
...
@pulumi.output_type
class AutologgerSettingsResponse(dict):
    """
    Settings for Autologger.
    """
    def __init__(__self__, *,
                 mlflow_autologger: str):
        """
        Settings for Autologger.
        :param str mlflow_autologger: [Required] Indicates whether mlflow autologger is enabled.
        """
        pulumi.set(__self__, "mlflow_autologger", mlflow_autologger)

    @property
    @pulumi.getter(name="mlflowAutologger")
    def mlflow_autologger(self) -> str:
        """
...
class ClassificationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fixed_parameters: Optional['outputs.TableFixedParametersResponse'] = None,
                 ...
                 search_space: Optional[Sequence['outputs.TableParameterSubspaceResponse']] = None,
                 sweep_settings: Optional['outputs.TableSweepSettingsResponse'] = None,
        ...
        :param 'TableFixedParametersResponse' fixed_parameters: Model/training parameters that will remain constant throughout training.
        ...
        :param Sequence['TableParameterSubspaceResponse'] search_space: Search space for sampling different combinations of models and their hyperparameters.
        :param 'TableSweepSettingsResponse' sweep_settings: Settings for model sweeping and hyperparameter tuning.
    ...
    def fixed_parameters(self) -> Optional['outputs.TableFixedParametersResponse']:
        """
    ...
    def search_space(self) -> Optional[Sequence['outputs.TableParameterSubspaceResponse']]:
        """
    ...
    def sweep_settings(self) -> Optional['outputs.TableSweepSettingsResponse']:
        """
...
class CommandJobResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parameters: Any,
                 status: str,
                 autologger_settings: Optional['outputs.AutologgerSettingsResponse'] = None,
                 code_id: Optional[str] = None,
                 component_id: Optional[str] = None,
                 compute_id: Optional[str] = None,
                 description: Optional[str] = None,
        ...
        :param str status: Status of the job.
        :param 'AutologgerSettingsResponse' autologger_settings: Distribution configuration of the job. If set, this should be one of Mpi, Tensorflow, PyTorch, or null.
        :param str code_id: ARM resource ID of the code asset.
        :param str component_id: ARM resource ID of the component resource.
        :param str compute_id: ARM resource ID of the compute resource.
        :param str description: The asset description text.
    ...
    def autologger_settings(self) -> Optional['outputs.AutologgerSettingsResponse']:
        """
...
@pulumi.output_type
class ComputeInstanceAutologgerSettingsResponse(dict):
    """
    Specifies settings for autologger.
    """
    def __init__(__self__, *,
                 mlflow_autologger: Optional[str] = None):
        """
        Specifies settings for autologger.
        :param str mlflow_autologger: Indicates whether mlflow autologger is enabled for notebooks.
        """
    ...
    @property
    @pulumi.getter(name="mlflowAutologger")
    def mlflow_autologger(self) -> Optional[str]:
        """
...
class ComputeInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 autologger_settings: Optional['outputs.ComputeInstanceAutologgerSettingsResponse'] = None,
        ...
        :param 'ComputeInstanceAutologgerSettingsResponse' autologger_settings: Specifies settings for autologger.
    ...
    @property
    @pulumi.getter(name="autologgerSettings")
    def autologger_settings(self) -> Optional['outputs.ComputeInstanceAutologgerSettingsResponse']:
        """
        Specifies settings for autologger.
        """
        return pulumi.get(self, "autologger_settings")
...
class MLTableDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str data_uri: [Required] Uri of the data. Usage/meaning depends on Microsoft.MachineLearning.ManagementFrontEnd.Contracts.V20221001Preview.Assets.DataVersionBase.DataType
        :param str description: The asset description text.
        :param bool is_anonymous: If the name version are system generated (anonymous registration).
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
...
@pulumi.output_type
class NlpFixedParametersResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Fixed training parameters that won't be swept over during AutoML NLP training.
        :param int gradient_accumulation_steps: Number of steps to accumulate gradients over before running a backward pass.
        :param float learning_rate: The learning rate for the training procedure.
        :param str learning_rate_scheduler: The type of learning rate schedule to use during the training procedure.
        :param str model_name: The name of the model to train.
        :param int number_of_epochs: Number of training epochs.
        :param int training_batch_size: The batch size for the training procedure.
        :param int validation_batch_size: The batch size to be used during evaluation.
        :param float warmup_ratio: The warmup ratio, used alongside LrSchedulerType.
        :param float weight_decay: The weight decay for the training procedure.
        """
    ...
    def gradient_accumulation_steps(self) -> Optional[int]:
        """
    ...
    def warmup_ratio(self) -> Optional[float]:
        """
...
@pulumi.output_type
class NlpParameterSubspaceResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Stringified search spaces for each parameter. See below examples.
        :param str gradient_accumulation_steps: Number of steps to accumulate gradients over before running a backward pass.
        :param str learning_rate: The learning rate for the training procedure.
        :param str learning_rate_scheduler: The type of learning rate schedule to use during the training procedure.
        :param str model_name: The name of the model to train.
        :param str number_of_epochs: Number of training epochs.
        :param str training_batch_size: The batch size for the training procedure.
        :param str validation_batch_size: The batch size to be used during evaluation.
        :param str warmup_ratio: The warmup ratio, used alongside LrSchedulerType.
        :param str weight_decay: The weight decay for the training procedure.
        """
        if gradient_accumulation_steps is not None:
            pulumi.set(__self__, "gradient_accumulation_steps", gradient_accumulation_steps)
        if learning_rate is not None:
    ...
    @property
    @pulumi.getter(name="gradientAccumulationSteps")
    def gradient_accumulation_steps(self) -> Optional[str]:
        """
        Number of steps to accumulate gradients over before running a backward pass.
        """
        return pulumi.get(self, "gradient_accumulation_steps")
    ...
    @property
    @pulumi.getter(name="warmupRatio")
    def warmup_ratio(self) -> Optional[str]:
        """
        The warmup ratio, used alongside LrSchedulerType.
        """
        return pulumi.get(self, "warmup_ratio")
...
@pulumi.output_type
class NlpSweepSettingsResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Model sweeping and hyperparameter tuning related settings.
        :param str sampling_algorithm: [Required] Type of sampling algorithm.
        :param Union['BanditPolicyResponse', 'MedianStoppingPolicyResponse', 'TruncationSelectionPolicyResponse'] early_termination: Type of early termination policy for the sweeping job.
        """
        pulumi.set(__self__, "sampling_algorithm", sampling_algorithm)
        if early_termination is not None:
            pulumi.set(__self__, "early_termination", early_termination)
...
class NlpVerticalLimitSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int max_nodes: Maximum nodes to leverage for training in any single trial. Controls multi-node distributed training.
        :param int max_trials: Number of AutoML iterations.
        :param str timeout: AutoML job timeout.
        :param str trial_timeout: Timeout for individual HD trials.
        """
        if max_concurrent_trials is None:
            max_concurrent_trials = 1
        if max_concurrent_trials is not None:
...
class RegistryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Details of the Registry
        :param str description: The asset description text.
        :param 'ArmResourceIdResponse' managed_resource_group: Managed resource group created for the registry
        :param Mapping[str, str] properties: The asset property dictionary.
    ...
    def private_link_count(self) -> Optional[int]:
...
@pulumi.output_type
class TableFixedParametersResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Fixed training parameters that won't be swept over during AutoML Table training.
        :param str booster: Specify the boosting type, e.g gbdt for XGBoost.
        :param str boosting_type: Specify the boosting type, e.g gbdt for LightGBM.
        :param str grow_policy: Specify the grow policy, which controls the way new nodes are added to the tree.
        :param float learning_rate: The learning rate for the training procedure.
        :param int max_bin: Specify the Maximum number of discrete bins to bucket continuous features .
        :param int max_depth: Specify the max depth to limit the tree depth explicitly.
        :param int max_leaves: Specify the max leaves to limit the tree leaves explicitly.
        :param int min_data_in_leaf: The minimum number of data per leaf.
        :param float min_split_gain: Minimum loss reduction required to make a further partition on a leaf node of the tree.
        :param str model_name: The name of the model to train.
        :param int n_estimators: Specify the number of trees (or rounds) in an model.
        :param int num_leaves: Specify the number of leaves.
        :param str preprocessor_name: The name of the preprocessor to use.
        :param float reg_alpha: L1 regularization term on weights.
        :param float reg_lambda: L2 regularization term on weights.
        :param float subsample: Subsample ratio of the training instance.
        :param float subsample_freq: Frequency of subsample.
        :param str tree_method: Specify the tree method.
        :param bool with_mean: If true, center before scaling the data with StandardScalar.
        :param bool with_std: If true, scaling the data with Unit Variance with StandardScalar.
        """
    ...
    def boosting_type(self) -> Optional[str]:
        """
    ...
    def grow_policy(self) -> Optional[str]:
        """
    ...
    def max_leaves(self) -> Optional[int]:
        """
    ...
    def min_data_in_leaf(self) -> Optional[int]:
        """
    ...
    def min_split_gain(self) -> Optional[float]:
        """
    ...
    def n_estimators(self) -> Optional[int]:
        """
    ...
    def reg_alpha(self) -> Optional[float]:
        """
    ...
    def reg_lambda(self) -> Optional[float]:
        """
    ...
    @property
    @pulumi.getter
    def subsample(self) -> Optional[float]:
        """
    ...
    def subsample_freq(self) -> Optional[float]:
        """
    ...
    def tree_method(self) -> Optional[str]:
        """
    ...
    def with_mean(self) -> Optional[bool]:
        """
    ...
    def with_std(self) -> Optional[bool]:
        """
...
@pulumi.output_type
class TableParameterSubspaceResponse(dict):
    def __init__(__self__, *,
                 booster: Optional[str] = None,
                 boosting_type: Optional[str] = None,
                 grow_policy: Optional[str] = None,
        ...
        :param str grow_policy: Specify the grow policy, which controls the way new nodes are added to the tree.
        :param str learning_rate: The learning rate for the training procedure.
        :param str max_bin: Specify the Maximum number of discrete bins to bucket continuous features .
        :param str max_depth: Specify the max depth to limit the tree depth explicitly.
        :param str max_leaves: Specify the max leaves to limit the tree leaves explicitly.
        :param str min_data_in_leaf: The minimum number of data per leaf.
        :param str min_split_gain: Minimum loss reduction required to make a further partition on a leaf node of the tree.
        :param str model_name: The name of the model to train.
        :param str n_estimators: Specify the number of trees (or rounds) in an model.
        :param str num_leaves: Specify the number of leaves.
        :param str preprocessor_name: The name of the preprocessor to use.
        :param str reg_alpha: L1 regularization term on weights.
        :param str reg_lambda: L2 regularization term on weights.
        :param str subsample: Subsample ratio of the training instance.
        :param str subsample_freq: Frequency of subsample
        :param str tree_method: Specify the tree method.
        :param str with_mean: If true, center before scaling the data with StandardScalar.
        :param str with_std: If true, scaling the data with Unit Variance with StandardScalar.
        """
        if booster is not None:
            pulumi.set(__self__, "booster", booster)
        if boosting_type is not None:
    ...
    @property
    @pulumi.getter(name="maxDepth")
    def max_depth(self) -> Optional[str]:
        """
        Specify the max depth to limit the tree depth explicitly.
        """
        return pulumi.get(self, "max_depth")
    ...
    @property
    @pulumi.getter(name="maxLeaves")
    def max_leaves(self) -> Optional[str]:
        """
        Specify the max leaves to limit the tree leaves explicitly.
        """
        return pulumi.get(self, "max_leaves")
    ...
    @property
    @pulumi.getter(name="minDataInLeaf")
    def min_data_in_leaf(self) -> Optional[str]:
        """
        The minimum number of data per leaf.
        """
        return pulumi.get(self, "min_data_in_leaf")
    ...
    @property
    @pulumi.getter(name="minSplitGain")
    def min_split_gain(self) -> Optional[str]:
        """
        Minimum loss reduction required to make a further partition on a leaf node of the tree.
        """
        return pulumi.get(self, "min_split_gain")
    ...
    @property
    @pulumi.getter(name="nEstimators")
    def n_estimators(self) -> Optional[str]:
        """
        Specify the number of trees (or rounds) in an model.
        """
        return pulumi.get(self, "n_estimators")
    ...
    @property
    @pulumi.getter(name="numLeaves")
    def num_leaves(self) -> Optional[str]:
        """
        Specify the number of leaves.
        """
        return pulumi.get(self, "num_leaves")
    ...
    @property
    @pulumi.getter(name="regAlpha")
    def reg_alpha(self) -> Optional[str]:
        """
        L1 regularization term on weights.
        """
        return pulumi.get(self, "reg_alpha")
    ...
    @property
    @pulumi.getter(name="regLambda")
    def reg_lambda(self) -> Optional[str]:
        """
        L2 regularization term on weights.
        """
        return pulumi.get(self, "reg_lambda")
    ...
    @property
    @pulumi.getter
    def subsample(self) -> Optional[str]:
        """
        Subsample ratio of the training instance.
        """
        return pulumi.get(self, "subsample")
    ...
    @property
    @pulumi.getter(name="subsampleFreq")
    def subsample_freq(self) -> Optional[str]:
        """
        Frequency of subsample
        """
        return pulumi.get(self, "subsample_freq")
    ...
    @property
    @pulumi.getter(name="withMean")
    def with_mean(self) -> Optional[str]:
        """
        If true, center before scaling the data with StandardScalar.
        """
        return pulumi.get(self, "with_mean")
    ...
    @property
    @pulumi.getter(name="withStd")
    def with_std(self) -> Optional[str]:
        """
        If true, scaling the data with Unit Variance with StandardScalar.
        """
        return pulumi.get(self, "with_std")
...
@pulumi.output_type
class TableSweepSettingsResponse(dict):
    def __init__(__self__, *,
                 sampling_algorithm: str,
                 early_termination: Optional[Any] = None):
        """
...
class TableVerticalLimitSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int sweep_concurrent_trials: Number of concurrent sweeping runs that user wants to trigger.
        :param int sweep_trials: Number of sweeping runs that user wants to trigger.
        :param str timeout: AutoML job timeout.
    ...
    def sweep_concurrent_trials(self) -> Optional[int]:
        """
    ...
    def sweep_trials(self) -> Optional[int]:
        """
...
class TextClassificationMultilabelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fixed_parameters: Optional['outputs.NlpFixedParametersResponse'] = None,
                 limit_settings: Optional['outputs.NlpVerticalLimitSettingsResponse'] = None,
                 log_verbosity: Optional[str] = None,
                 search_space: Optional[Sequence['outputs.NlpParameterSubspaceResponse']] = None,
                 sweep_settings: Optional['outputs.NlpSweepSettingsResponse'] = None,
                 target_column_name: Optional[str] = None,
                 validation_data: Optional['outputs.MLTableJobInputResponse'] = None):
        """
        Text Classification Multilabel task in AutoML NLP vertical.
        ...
        :param 'NlpFixedParametersResponse' fixed_parameters: Model/training parameters that will remain constant throughout training.
        :param 'NlpVerticalLimitSettingsResponse' limit_settings: Execution constraints for AutoMLJob.
        :param str log_verbosity: Log verbosity for the job.
        :param Sequence['NlpParameterSubspaceResponse'] search_space: Search space for sampling different combinations of models and their hyperparameters.
        :param 'NlpSweepSettingsResponse' sweep_settings: Settings for model sweeping and hyperparameter tuning.
        :param str target_column_name: Target column name: This is prediction values column.
               Also known as label column name in context of classification tasks.
        :param 'MLTableJobInputResponse' validation_data: Validation data inputs.
        """
    ...
    @property
    @pulumi.getter(name="fixedParameters")
    def fixed_parameters(self) -> Optional['outputs.NlpFixedParametersResponse']:
        """
        Model/training parameters that will remain constant throughout training.
        """
        return pulumi.get(self, "fixed_parameters")
    ...
    @property
    @pulumi.getter(name="searchSpace")
    def search_space(self) -> Optional[Sequence['outputs.NlpParameterSubspaceResponse']]:
        """
        Search space for sampling different combinations of models and their hyperparameters.
        """
        return pulumi.get(self, "search_space")
    ...
    @property
    @pulumi.getter(name="sweepSettings")
    def sweep_settings(self) -> Optional['outputs.NlpSweepSettingsResponse']:
        """
        Settings for model sweeping and hyperparameter tuning.
        """
        return pulumi.get(self, "sweep_settings")
