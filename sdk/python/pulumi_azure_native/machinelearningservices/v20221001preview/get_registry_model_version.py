...
def get_registry_model_version(model_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry_model_version is deprecated: azure-native:machinelearningservices/v20221001preview:RegistryModelVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:RegistryModelVersion to guarantee forwards compatibility.""")
    __args__ = dict()
