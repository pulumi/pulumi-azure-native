...
def get_schedule(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_schedule is deprecated: azure-native:machinelearningservices/v20221001preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Schedule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
