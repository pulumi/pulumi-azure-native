...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:CodeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:CodeVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_code_version(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_code_version is deprecated: azure-native:machinelearningservices/v20221001preview:CodeVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:CodeVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001preview:getCodeVersion', __args__, opts=opts, typ=GetCodeVersionResult).value
