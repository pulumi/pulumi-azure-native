...
def get_component_container(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_component_container is deprecated: azure-native:machinelearningservices/v20221001preview:ComponentContainer is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:ComponentContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
