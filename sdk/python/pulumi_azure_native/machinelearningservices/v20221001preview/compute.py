...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Compute to guarantee forwards compatibility.""", DeprecationWarning)
...
class Compute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Compute is deprecated: azure-native:machinelearningservices/v20221001preview:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Compute to guarantee forwards compatibility.""")
