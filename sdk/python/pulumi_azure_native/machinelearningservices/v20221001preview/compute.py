...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:Compute is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:Compute to guarantee forwards compatibility.""", DeprecationWarning)
...
class Compute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Compute is deprecated: azure-native:machinelearningservices/v20221001preview:Compute is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:Compute to guarantee forwards compatibility.""")
