...
def get_online_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_online_endpoint is deprecated: azure-native:machinelearningservices/v20221001preview:OnlineEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:OnlineEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['endpointName'] = endpoint_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001preview:getOnlineEndpoint', __args__, opts=opts, typ=GetOnlineEndpointResult).value
