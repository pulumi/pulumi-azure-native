...
def get_online_deployment(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_online_deployment is deprecated: azure-native:machinelearningservices/v20221001preview:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineDeployment to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001preview:getOnlineDeployment', __args__, opts=opts, typ=GetOnlineDeploymentResult).value
