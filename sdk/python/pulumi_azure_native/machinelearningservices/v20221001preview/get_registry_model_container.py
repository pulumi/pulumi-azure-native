...
def get_registry_model_container(model_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry_model_container is deprecated: azure-native:machinelearningservices/v20221001preview:RegistryModelContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:RegistryModelContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['modelName'] = model_name
    __args__['registryName'] = registry_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221001preview:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult).value
