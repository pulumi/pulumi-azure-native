...
def get_datastore(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_datastore is deprecated: azure-native:machinelearningservices/v20221001preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Datastore to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
