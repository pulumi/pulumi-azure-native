...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_registry_environment_version(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry_environment_version is deprecated: azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentVersion to guarantee forwards compatibility.""")
    __args__ = dict()
