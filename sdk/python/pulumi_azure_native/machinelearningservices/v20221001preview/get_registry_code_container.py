...
def get_registry_code_container(code_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry_code_container is deprecated: azure-native:machinelearningservices/v20221001preview:RegistryCodeContainer is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:RegistryCodeContainer to guarantee forwards compatibility.""")
    __args__ = dict()
