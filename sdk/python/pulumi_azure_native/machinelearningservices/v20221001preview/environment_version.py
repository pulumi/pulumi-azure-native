...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:EnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.""", DeprecationWarning)
