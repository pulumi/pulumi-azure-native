...
def get_model_version_output(name: Optional[pulumi.Input[str]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetModelVersionResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221001preview:getModelVersion', __args__, opts=opts, typ=GetModelVersionResult)
    return __ret__.apply(lambda __response__: GetModelVersionResult(
