...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchDeployment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_batch_deployment(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_deployment is deprecated: azure-native:machinelearningservices/v20221001preview:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchDeployment to guarantee forwards compatibility.""")
    __args__ = dict()
