...
warnings.warn("""azure-native:machinelearningservices/v20221001preview:DataVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 data_version_base_properties: Optional[pulumi.Input[Union[pulumi.InputType['MLTableDataArgs'], pulumi.InputType['UriFileDataVersionArgs'], pulumi.InputType['UriFolderDataVersionArgs']]]] = None,
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DataVersion is deprecated: azure-native:machinelearningservices/v20221001preview:DataVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:DataVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20221001preview:DataVersion',
            resource_name,
            __props__,
            opts)
