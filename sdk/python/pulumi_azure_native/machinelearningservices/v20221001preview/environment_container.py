...
class EnvironmentContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EnvironmentContainer is deprecated: azure-native:machinelearningservices/v20221001preview:EnvironmentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:EnvironmentContainer to guarantee forwards compatibility.""")
