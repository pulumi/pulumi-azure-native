...
def get_model_container(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_model_container is deprecated: azure-native:machinelearningservices/v20221001preview:ModelContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:ModelContainer to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
