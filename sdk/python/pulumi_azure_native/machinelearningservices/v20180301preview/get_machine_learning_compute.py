...
warnings.warn("""Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""", DeprecationWarning)
...
def get_machine_learning_compute(compute_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_learning_compute is deprecated: Version v20180301preview will be removed in the next major version of the provider. Upgrade to version v20200301 or later.""")
    __args__ = dict()
