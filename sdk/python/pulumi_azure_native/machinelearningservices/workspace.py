...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 allow_public_access_when_behind_vnet: Optional[pulumi.Input[builtins.bool]] = None,
                 application_insights: Optional[pulumi.Input[builtins.str]] = None,
                 associated_workspaces: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 container_registry: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 hbi_workspace: Optional[pulumi.Input[builtins.bool]] = None,
                 hub_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['ManagedServiceIdentityArgs']] = None,
                 image_build_compute: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_public_access_when_behind_vnet: The flag to indicate whether to allow public access when behind VNet.
        :param pulumi.Input[builtins.str] application_insights: ARM id of the application insights associated with this workspace.
        :param pulumi.Input[builtins.str] container_registry: ARM id of the container registry associated with this workspace.
        :param pulumi.Input[builtins.str] description: The description of this workspace.
        :param pulumi.Input[builtins.str] discovery_url: Url for the discovery service to identify regional endpoints for machine learning experimentation services
        ...
        :param pulumi.Input[builtins.str] friendly_name: The friendly name for this workspace. This name in mutable
        :param pulumi.Input[builtins.bool] hbi_workspace: The flag to signal HBI data in the workspace and reduce diagnostic data collected by the service
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: The identity of the resource.
        :param pulumi.Input[builtins.str] image_build_compute: The compute name for image build
        :param pulumi.Input[builtins.str] key_vault: ARM id of the key vault associated with this workspace. This cannot be changed once the workspace has been created
    ...
    def allow_public_access_when_behind_vnet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_public_access_when_behind_vnet(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_public_access_when_behind_vnet", value)

    @property
    @pulumi.getter(name="applicationInsights")
    def application_insights(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_insights(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_insights", value)

    @property
    @pulumi.getter(name="associatedWorkspaces")
    def associated_workspaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "associated_workspaces")

    @associated_workspaces.setter
    def associated_workspaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "associated_workspaces", value)

    @property
    @pulumi.getter(name="containerRegistry")
    def container_registry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_registry(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_data_isolation(self) -> Optional[pulumi.Input[builtins.bool]]:
    ...
    def hbi_workspace(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hbi_workspace(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "hbi_workspace", value)

    @property
    @pulumi.getter(name="hubResourceId")
    def hub_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hub_resource_id")

    @hub_resource_id.setter
    def hub_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def image_build_compute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_build_compute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_build_compute", value)

    @property
    @pulumi.getter(name="keyVault")
    def key_vault(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @key_vault.setter
    def key_vault(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def v1_legacy_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def v1_legacy_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Workspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowPublicAccessWhenBehindVnet")
    def allow_public_access_when_behind_vnet(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The flag to indicate whether to allow public access when behind VNet.
        """
        return pulumi.get(self, "allow_public_access_when_behind_vnet")
    ...
    @property
    @pulumi.getter(name="applicationInsights")
    def application_insights(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM id of the application insights associated with this workspace.
        """
        return pulumi.get(self, "application_insights")
    ...
    @property
    @pulumi.getter(name="associatedWorkspaces")
    def associated_workspaces(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "associated_workspaces")
    ...
    @property
    @pulumi.getter(name="containerRegistry")
    def container_registry(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM id of the container registry associated with this workspace.
        """
        return pulumi.get(self, "container_registry")
    ...
    @property
    @pulumi.getter(name="discoveryUrl")
    def discovery_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Url for the discovery service to identify regional endpoints for machine learning experimentation services
        """
        return pulumi.get(self, "discovery_url")
    ...
    @property
    @pulumi.getter(name="hbiWorkspace")
    def hbi_workspace(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The flag to signal HBI data in the workspace and reduce diagnostic data collected by the service
        """
        return pulumi.get(self, "hbi_workspace")
    ...
    @property
    @pulumi.getter(name="hubResourceId")
    def hub_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "hub_resource_id")
    ...
    @property
    @pulumi.getter(name="imageBuildCompute")
    def image_build_compute(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compute name for image build
        """
        return pulumi.get(self, "image_build_compute")
    ...
    @property
    @pulumi.getter(name="keyVault")
    def key_vault(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM id of the key vault associated with this workspace. This cannot be changed once the workspace has been created
        """
        return pulumi.get(self, "key_vault")
    ...
    def ml_flow_tracking_uri(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def private_link_count(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def service_provisioned_resource_group(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="storageAccount")
    def storage_account(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM id of the storage account associated with this workspace. This cannot be changed once the workspace has been created
        """
        return pulumi.get(self, "storage_account")
    ...
    def storage_hns_enabled(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="v1LegacyMode")
    def v1_legacy_mode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enabling v1_legacy_mode may prevent you from using features provided by the v2 API.
        """
        return pulumi.get(self, "v1_legacy_mode")
