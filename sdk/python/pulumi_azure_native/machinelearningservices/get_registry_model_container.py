...
def get_registry_model_container(model_name: Optional[builtins.str] = None,
...
def get_registry_model_container_output(model_name: Optional[pulumi.Input[builtins.str]] = None,
