...
def get_registry_model_container(model_name: Optional[_builtins.str] = None,
...
def get_registry_model_container_output(model_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult)
