...
__all__ = [
    ...
    'get_machine_learning_service_output',
]
...
def get_machine_learning_service(expand: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200515preview:getMachineLearningService', __args__, opts=opts, typ=GetMachineLearningServiceResult).value
...
@_utilities.lift_output_func(get_machine_learning_service)
def get_machine_learning_service_output(expand: Optional[pulumi.Input[Optional[bool]]] = None,
