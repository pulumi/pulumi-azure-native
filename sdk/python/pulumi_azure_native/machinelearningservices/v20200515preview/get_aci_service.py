...
def get_aci_service(expand: Optional[bool] = None,
    ...
    """
    pulumi.log.warn("""get_aci_service is deprecated: azure-native:machinelearningservices/v20200515preview:ACIService is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200515preview:getACIService', __args__, opts=opts, typ=GetACIServiceResult).value
