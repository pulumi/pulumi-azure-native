...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200515preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
...
def get_workspace_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20200515preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
