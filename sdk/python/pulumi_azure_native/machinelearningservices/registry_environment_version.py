...
@pulumi.type_token("azure-native:machinelearningservices:RegistryEnvironmentVersion")
class RegistryEnvironmentVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['EnvironmentVersionPropertiesArgs', 'EnvironmentVersionPropertiesArgsDict']]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse']:
        """
        [Required] Additional attributes of the entity.
        """
        return pulumi.get(self, "properties")
