...
def get_compute(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001:getCompute', __args__, opts=opts, typ=GetComputeResult).value
...
def get_compute_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001:getCompute', __args__, opts=opts, typ=GetComputeResult)
