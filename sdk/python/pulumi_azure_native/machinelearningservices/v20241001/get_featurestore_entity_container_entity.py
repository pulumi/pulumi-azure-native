...
def get_featurestore_entity_container_entity(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001:getFeaturestoreEntityContainerEntity', __args__, opts=opts, typ=GetFeaturestoreEntityContainerEntityResult).value
...
def get_featurestore_entity_container_entity_output(name: Optional[pulumi.Input[str]] = None,
                                                    ...
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFeaturestoreEntityContainerEntityResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001:getFeaturestoreEntityContainerEntity', __args__, opts=opts, typ=GetFeaturestoreEntityContainerEntityResult)
    return __ret__.apply(lambda __response__: GetFeaturestoreEntityContainerEntityResult(
        featurestore_entity_container_properties=pulumi.get(__response__, 'featurestore_entity_container_properties'),
