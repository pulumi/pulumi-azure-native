...
def get_registry_model_container(model_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20241001:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult).value
...
def get_registry_model_container_output(model_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20241001:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult)
