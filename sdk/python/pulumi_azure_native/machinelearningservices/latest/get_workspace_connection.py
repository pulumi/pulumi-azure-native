...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:getWorkspaceConnection'.""", DeprecationWarning)
...
def get_workspace_connection(connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:getWorkspaceConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/latest:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult).value
