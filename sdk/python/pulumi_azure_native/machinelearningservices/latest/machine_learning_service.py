...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:machinelearningservices:MachineLearningService'.""", DeprecationWarning)
...
class MachineLearningService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(MachineLearningService, __self__).__init__(
            'azure-native:machinelearningservices/latest:MachineLearningService',
            resource_name,
            __props__,
            opts)
