...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:machinelearningservices/latest:LinkedWorkspace":
                return LinkedWorkspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/latest:MachineLearningCompute":
                return MachineLearningCompute(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/latest:MachineLearningService":
                return MachineLearningService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/latest:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/latest:Workspace":
                return Workspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/latest:WorkspaceConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "machinelearningservices/latest", _module_instance)
