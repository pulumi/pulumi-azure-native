...
def get_connection_rai_blocklist_item(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rai_blocklist_item_name: Name of the RaiBlocklist Item
    :param _builtins.str rai_blocklist_name: The name of the RaiBlocklist.
...
def get_connection_rai_blocklist_item_output(connection_name: pulumi.Input[Optional[_builtins.str]] = None,
