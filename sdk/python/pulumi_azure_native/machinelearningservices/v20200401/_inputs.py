...
if not MYPY:
    class AKSPropertiesArgsDict(TypedDict):
        ...
        """
        cluster_purpose: NotRequired[pulumi.Input[str]]
...
class SslConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] leaf_domain_label: The leaf domain label name
        :param pulumi.Input[bool] overwrite_existing_domain: Boolean value for overwriting the domain
