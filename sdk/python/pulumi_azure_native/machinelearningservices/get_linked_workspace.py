...
def get_linked_workspace(link_name: Optional[_builtins.str] = None,
...
def get_linked_workspace_output(link_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
