...
class GetOnlineEndpointTokenResult:
    ...
    def expiry_time_utc(self) -> Optional[builtins.float]:
        """
    ...
    def refresh_after_time_utc(self) -> Optional[builtins.float]:
        """
...
def get_online_endpoint_token(endpoint_name: Optional[builtins.str] = None,
...
def get_online_endpoint_token_output(endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getOnlineEndpointToken', __args__, opts=opts, typ=GetOnlineEndpointTokenResult)
