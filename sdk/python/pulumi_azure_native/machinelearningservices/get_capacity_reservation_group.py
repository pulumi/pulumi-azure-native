...
def get_capacity_reservation_group(group_id: Optional[builtins.str] = None,
...
def get_capacity_reservation_group_output(group_id: Optional[pulumi.Input[builtins.str]] = None,
