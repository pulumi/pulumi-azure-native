...
def get_capacity_reservation_group(group_id: Optional[_builtins.str] = None,
...
def get_capacity_reservation_group_output(group_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
