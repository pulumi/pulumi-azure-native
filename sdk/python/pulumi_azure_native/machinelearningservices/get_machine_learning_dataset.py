...
def get_machine_learning_dataset(dataset_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dataset_name: The Dataset name.
...
def get_machine_learning_dataset_output(dataset_name: Optional[pulumi.Input[builtins.str]] = None,
