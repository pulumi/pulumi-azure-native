...
class GetMachineLearningDatasetResult:
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> Optional['outputs.IdentityMachineLearningDatasetResponse']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sku(self) -> Optional['outputs.SkuMachineLearningDatasetResponse']:
        """
...
def get_machine_learning_dataset(dataset_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dataset_name: The Dataset name.
...
def get_machine_learning_dataset_output(dataset_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getMachineLearningDataset', __args__, opts=opts, typ=GetMachineLearningDatasetResult)
    return __ret__.apply(lambda __response__: GetMachineLearningDatasetResult(
