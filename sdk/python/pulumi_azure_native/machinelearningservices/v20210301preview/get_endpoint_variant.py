...
def get_endpoint_variant(expand: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210301preview:getEndpointVariant', __args__, opts=opts, typ=GetEndpointVariantResult).value
