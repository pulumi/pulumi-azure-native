...
def get_data_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20210301preview:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult).value
...
def get_data_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20210301preview:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult)
