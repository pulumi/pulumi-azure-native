...
__all__ = ['DataContainerArgs', 'DataContainer']
...
class DataContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DataContainerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataContainerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:DataContainer"), pulumi.Alias(type_="azure-native:machinelearningservices:DataContainer"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:DataContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20210301preview:DataContainer',
            resource_name,
            __props__,
            opts)
