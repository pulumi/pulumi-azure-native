...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 id: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union[Union['CommandJobArgs', 'CommandJobArgsDict'], Union['SweepJobArgs', 'SweepJobArgsDict']]]] = None,
        ...
        :param pulumi.Input[str] id: The name and identifier for the Job.
        :param pulumi.Input[Union[Union['CommandJobArgs', 'CommandJobArgsDict'], Union['SweepJobArgs', 'SweepJobArgsDict']]] properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
        ...
