...
class EnvironmentContainerInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EnvironmentContainerArgs'] properties: Additional attributes of the entity.
...
class EnvironmentContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Container name.
        :param pulumi.Input[pulumi.InputType['EnvironmentContainerArgs']] properties: Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:EnvironmentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices:EnvironmentContainer"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:EnvironmentContainer")])
