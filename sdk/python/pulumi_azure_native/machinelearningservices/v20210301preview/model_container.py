...
class ModelContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        model_container = azure_native.machinelearningservices.v20210301preview.ModelContainer("modelContainer",
            name="testContainer",
            properties=azure_native.machinelearningservices.v20210301preview.ModelContainerArgs(
