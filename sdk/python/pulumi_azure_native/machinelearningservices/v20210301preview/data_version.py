...
class DataVersionInitArgs:
    def __init__(__self__, *,
        ...
        """
        DataVersionInitArgs._configure(
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['DataVersionArgs']] = None,
...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataVersionInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, DataVersionArgs, True)
