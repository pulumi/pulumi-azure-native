...
class CodeVersionInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CodeVersionArgs'] properties: Additional attributes of the entity.
...
class CodeVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Container name.
        :param pulumi.Input[pulumi.InputType['CodeVersionArgs']] properties: Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version identifier.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:CodeVersion"), pulumi.Alias(type_="azure-native:machinelearningservices:CodeVersion"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:CodeVersion")])
