...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union['CodeContainerArgs', 'CodeContainerArgsDict']]] = None,
        ...
        :param pulumi.Input[str] name: Container name.
        :param pulumi.Input[Union['CodeContainerArgs', 'CodeContainerArgsDict']] properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] workspace_name: Name of Azure Machine Learning workspace.
        """
        ...
