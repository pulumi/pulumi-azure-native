...
def get_component_container(name: Optional[_builtins.str] = None,
...
def get_component_container_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult)
