...
class GetCapabilityHostResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, capability_host_properties=None, id=None, name=None, system_data=None, type=None):
...
def get_capability_host(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: CapabilityHost name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices:getCapabilityHost', __args__, opts=opts, typ=GetCapabilityHostResult).value
...
def get_capability_host_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getCapabilityHost', __args__, opts=opts, typ=GetCapabilityHostResult)
