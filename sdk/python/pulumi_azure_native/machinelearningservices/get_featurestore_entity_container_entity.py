...
def get_featurestore_entity_container_entity(name: Optional[builtins.str] = None,
...
def get_featurestore_entity_container_entity_output(name: Optional[pulumi.Input[builtins.str]] = None,
