...
class EndpointDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:EndpointDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:EndpointDeployment")])
