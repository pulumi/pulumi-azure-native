...
def list_inference_group_delta_models_async(count: Optional[_builtins.int] = None,
                                            ...
                                            target_base_model: Optional[_builtins.str] = None,
    ...
    :param _builtins.int count: Gets or sets number of delta models to return. Default: -1, means that all will be returned.
    :param _builtins.str group_name: InferenceGroup name.
    :param _builtins.str pool_name: InferencePool name.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.str skip_token: Gets or sets skip token for paginated response.
    :param _builtins.str target_base_model: Gets or sets target base model.
