...
class CapacityReservationGroupInitArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'capacityReservationGroupProperties' in kwargs:
...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if capacity_reservation_group_properties is not None and not isinstance(capacity_reservation_group_properties, CapacityReservationGroupArgs):
                capacity_reservation_group_properties = capacity_reservation_group_properties or {}
                def _setter(key, value):
                    capacity_reservation_group_properties[key] = value
                CapacityReservationGroupArgs._configure(_setter, **capacity_reservation_group_properties)
