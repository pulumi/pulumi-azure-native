...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:CapacityReservationGroup"), pulumi.Alias(type_="azure-native_machinelearningservices_v20230801preview:machinelearningservices:CapacityReservationGroup"), pulumi.Alias(type_="azure-native_machinelearningservices_v20240101preview:machinelearningservices:CapacityReservationGroup"), pulumi.Alias(type_="azure-native_machinelearningservices_v20240401preview:machinelearningservices:CapacityReservationGroup")])
