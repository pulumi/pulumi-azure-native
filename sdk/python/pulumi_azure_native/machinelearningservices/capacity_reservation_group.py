...
@pulumi.type_token("azure-native:machinelearningservices:CapacityReservationGroup")
class CapacityReservationGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 capacity_reservation_group_properties: pulumi.Input[Optional[Union['CapacityReservationGroupArgs', 'CapacityReservationGroupArgsDict']]] = None,
                 group_id: pulumi.Input[Optional[_builtins.str]] = None,
