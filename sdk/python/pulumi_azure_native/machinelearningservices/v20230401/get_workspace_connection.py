...
def get_workspace_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult).value
...
def get_workspace_connection_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401:getWorkspaceConnection', __args__, opts=opts, typ=GetWorkspaceConnectionResult)
