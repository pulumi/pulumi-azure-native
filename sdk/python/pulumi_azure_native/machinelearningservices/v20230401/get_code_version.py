...
def get_code_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401:getCodeVersion', __args__, opts=opts, typ=GetCodeVersionResult).value
...
def get_code_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401:getCodeVersion', __args__, opts=opts, typ=GetCodeVersionResult)
