...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(service_managed_resources_settings, ServiceManagedResourcesSettingsArgs):
