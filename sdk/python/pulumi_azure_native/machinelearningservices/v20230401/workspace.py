...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if service_managed_resources_settings is None and 'serviceManagedResourcesSettings' in kwargs:
        ...
        if v1_legacy_mode is None and 'v1LegacyMode' in kwargs:
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            service_managed_resources_settings = _utilities.configure(service_managed_resources_settings, ServiceManagedResourcesSettingsArgs, True)
