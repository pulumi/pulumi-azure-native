...
class ComponentContainerInitArgs:
    def __init__(__self__, *,
        ...
        """
        ComponentContainerInitArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            component_container_properties=component_container_properties,
    ...
    def _configure(
             ...
             component_container_properties: Optional[pulumi.Input['ComponentContainerArgs']] = None,
             resource_group_name: Optional[pulumi.Input[str]] = None,
             workspace_name: Optional[pulumi.Input[str]] = None,
             name: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if component_container_properties is None and 'componentContainerProperties' in kwargs:
            component_container_properties = kwargs['componentContainerProperties']
        if component_container_properties is None:
            raise TypeError("Missing 'component_container_properties' argument")
        ...
        _setter("component_container_properties", component_container_properties)
...
class ComponentContainer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ComponentContainerInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            component_container_properties = _utilities.configure(component_container_properties, ComponentContainerArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:ComponentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:ComponentContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComponentContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230401:ComponentContainer',
            resource_name,
            __props__,
            opts)
