...
class ArmResourceIdResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ARM ResourceId of a resource
        :param str resource_id: Arm ResourceId is in the format "/subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Storage/storageAccounts/{StorageAccountName}"
...
class CodeContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str provisioning_state: Provisioning state for the code container.
        :param str description: The asset description text.
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
...
class CodeVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Code asset version details.
        :param str provisioning_state: Provisioning state for the code version.
...
class ComponentContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str latest_version: The latest version inside this container.
        :param str next_version: The next auto incremental version
        :param str provisioning_state: Provisioning state for the component container.
        :param str description: The asset description text.
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
...
class ComponentVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Definition of a component version: defines resources that span component types.
        :param str provisioning_state: Provisioning state for the component version.
...
class EnvironmentContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str latest_version: The latest version inside this container.
        :param str next_version: The next auto incremental version
        :param str provisioning_state: Provisioning state for the environment container.
        :param str description: The asset description text.
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
...
class EnvironmentVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str provisioning_state: Provisioning state for the environment version.
        ...
        :param Mapping[str, str] properties: The asset property dictionary.
        :param str stage: Stage in the environment lifecycle assigned to this environment
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
        """
...
class MLTableDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str data_uri: [Required] Uri of the data. Example: https://go.microsoft.com/fwlink/?linkid=2202330
        :param str description: The asset description text.
        :param bool is_anonymous: If the name version are system generated (anonymous registration).
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
...
class ModelContainerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str latest_version: The latest version inside this container.
        :param str next_version: The next auto incremental version
        :param str provisioning_state: Provisioning state for the model container.
        :param str description: The asset description text.
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
...
class ModelVersionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Model asset version details.
        :param str provisioning_state: Provisioning state for the model version.
        :param str description: The asset description text.
        ...
        :param Mapping[str, str] properties: The asset property dictionary.
        :param str stage: Stage in the model lifecycle assigned to this model
        :param Mapping[str, str] tags: Tag dictionary. Tags can be added, removed, and updated.
        """
        pulumi.set(__self__, "provisioning_state", provisioning_state)
        if description is not None:
...
class PrivateEndpointResourceResponse(dict):
    ...
    def subnet_arm_id(self) -> Optional[str]:
        """
...
class RegistryPrivateEndpointConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_link_service_connection_state: Optional['outputs.RegistryPrivateLinkServiceConnectionStateResponse'] = None,
                 provisioning_state: Optional[str] = None):
        """
        Properties of the Private Endpoint Connection
        :param Sequence[str] group_ids: The group ids
        :param 'PrivateEndpointResourceResponse' private_endpoint: The PE network resource that is linked to this PE connection.
        :param 'RegistryPrivateLinkServiceConnectionStateResponse' private_link_service_connection_state: The connection state.
        :param str provisioning_state: One of null, "Succeeded", "Provisioning", "Failed". While not approved, it's null.
        """
    ...
    @property
    @pulumi.getter(name="privateLinkServiceConnectionState")
    def private_link_service_connection_state(self) -> Optional['outputs.RegistryPrivateLinkServiceConnectionStateResponse']:
        """
...
class RegistryPrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Private endpoint connection definition.
        :param str id: This is the private endpoint connection name created on SRP
...
class RegistryRegionArmDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str location: The location where the registry exists
...
class RegistryResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_endpoint_connections: Optional[Sequence['outputs.RegistryPrivateEndpointConnectionResponse']] = None,
                 public_network_access: Optional[str] = None,
        ...
        :param str intellectual_property_publisher: IntellectualPropertyPublisher for the registry
        ...
        :param str ml_flow_registry_uri: MLFlow Registry URI for the Registry
        :param Sequence['RegistryPrivateEndpointConnectionResponse'] private_endpoint_connections: Private endpoint connections info used for pending connections in private link portal
        :param str public_network_access: Is the Registry accessible from the internet?
    ...
    def intellectual_property_publisher(self) -> Optional[str]:
        """
    ...
    def ml_flow_registry_uri(self) -> Optional[str]:
        """
    ...
    def private_endpoint_connections(self) -> Optional[Sequence['outputs.RegistryPrivateEndpointConnectionResponse']]:
        """
...
class SystemCreatedAcrAccountResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str acr_account_name: Name of the ACR account
        :param str acr_account_sku: SKU of the ACR account
    ...
    def acr_account_name(self) -> Optional[str]:
        """
    ...
    def acr_account_sku(self) -> Optional[str]:
        """
...
class SystemCreatedStorageAccountResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_account_type: Optional[str] = None):
        """
        :param bool allow_blob_public_access: Public blob access allowed
        :param 'ArmResourceIdResponse' arm_resource_id: This is populated once the storage account is created.
        :param bool storage_account_hns_enabled: HNS enabled for storage account
        :param str storage_account_name: Name of the storage account
        :param str storage_account_type: Allowed values:
               "Standard_LRS",
               "Standard_GRS",
               "Standard_RAGRS",
               "Standard_ZRS",
    ...
    def storage_account_hns_enabled(self) -> Optional[bool]:
        """
