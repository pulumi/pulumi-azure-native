...
def get_registry_code_container_output(code_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401:getRegistryCodeContainer', __args__, opts=opts, typ=GetRegistryCodeContainerResult)
