...
class CodeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:CodeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CodeContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230401:CodeContainer',
            resource_name,
            __props__,
            opts)
