...
class RegistryModelContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:RegistryModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:RegistryModelContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryModelContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230401:RegistryModelContainer',
            resource_name,
            __props__,
            opts)
