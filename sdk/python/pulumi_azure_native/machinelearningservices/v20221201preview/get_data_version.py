...
def get_data_version(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_version is deprecated: azure-native:machinelearningservices/v20221201preview:DataVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:DataVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221201preview:getDataVersion', __args__, opts=opts, typ=GetDataVersionResult).value
