...
class RegistryComponentVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_component_version = azure_native.machinelearningservices.v20221201preview.RegistryComponentVersion("registryComponentVersion",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryComponentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryComponentVersion")])
