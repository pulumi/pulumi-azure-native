...
def get_model_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221201preview:getModelContainer', __args__, opts=opts, typ=GetModelContainerResult)
