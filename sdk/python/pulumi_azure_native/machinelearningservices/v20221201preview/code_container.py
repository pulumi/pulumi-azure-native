...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        code_container = azure_native.machinelearningservices.v20221201preview.CodeContainer("codeContainer",
