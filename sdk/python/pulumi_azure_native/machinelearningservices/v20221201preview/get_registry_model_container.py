...
def get_registry_model_container_output(model_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221201preview:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult)
