...
def get_registry_model_version(model_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry_model_version is deprecated: azure-native:machinelearningservices/v20221201preview:RegistryModelVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryModelVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221201preview:getRegistryModelVersion', __args__, opts=opts, typ=GetRegistryModelVersionResult).value
