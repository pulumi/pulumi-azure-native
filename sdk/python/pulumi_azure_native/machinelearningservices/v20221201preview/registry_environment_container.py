...
warnings.warn("""azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
class RegistryEnvironmentContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RegistryEnvironmentContainer is deprecated: azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentContainer to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryEnvironmentContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentContainer',
            resource_name,
            __props__,
            opts)
