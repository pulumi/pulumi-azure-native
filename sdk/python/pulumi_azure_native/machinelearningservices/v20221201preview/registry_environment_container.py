...
class RegistryEnvironmentContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_environment_container = azure_native.machinelearningservices.v20221201preview.RegistryEnvironmentContainer("registryEnvironmentContainer",
            environment_container_properties=azure_native.machinelearningservices.v20221201preview.EnvironmentContainerArgs(
                description="string",
                properties={
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20221201preview:RegistryEnvironmentContainer testEnvironment /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/registries/testregistry/environments/testEnvironment 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryEnvironmentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryEnvironmentContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:RegistryEnvironmentContainer")])
