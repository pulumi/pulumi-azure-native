...
def get_data_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221201preview:getDataContainer', __args__, opts=opts, typ=GetDataContainerResult)
