...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.machinelearningservices.v20221201preview.PrivateEndpointConnection("privateEndpointConnection",
            private_endpoint_connection_name="{privateEndpointConnectionName}",
            private_link_service_connection_state=azure_native.machinelearningservices.v20221201preview.PrivateLinkServiceConnectionStateArgs(
