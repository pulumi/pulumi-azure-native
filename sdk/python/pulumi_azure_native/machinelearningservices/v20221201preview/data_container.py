...
class DataContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_container = azure_native.machinelearningservices.v20221201preview.DataContainer("dataContainer",
            data_container_properties=azure_native.machinelearningservices.v20221201preview.DataContainerArgs(
                data_type="UriFile",
                description="string",
                properties={
                    "properties1": "value1",
