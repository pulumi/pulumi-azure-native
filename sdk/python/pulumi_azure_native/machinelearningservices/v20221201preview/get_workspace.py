...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    return AwaitableGetWorkspaceResult(
        ...
        scheduled_purge_date=pulumi.get(__ret__, 'scheduled_purge_date'),
        ...
        soft_deleted_at=pulumi.get(__ret__, 'soft_deleted_at'),
...
def get_workspace_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20221201preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
    return __ret__.apply(lambda __response__: GetWorkspaceResult(
        ...
        scheduled_purge_date=pulumi.get(__response__, 'scheduled_purge_date'),
        ...
        soft_deleted_at=pulumi.get(__response__, 'soft_deleted_at'),
