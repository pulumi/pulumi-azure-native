...
warnings.warn("""azure-native:machinelearningservices/v20221201preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetWorkspaceResult:
    ...
    """
    def __init__(__self__, allow_public_access_when_behind_vnet=None, application_insights=None, container_registry=None, description=None, discovery_url=None, encryption=None, feature_store_settings=None, friendly_name=None, hbi_workspace=None, id=None, identity=None, image_build_compute=None, key_vault=None, kind=None, location=None, ml_flow_tracking_uri=None, name=None, notebook_info=None, primary_user_assigned_identity=None, private_endpoint_connections=None, private_link_count=None, provisioning_state=None, public_network_access=None, scheduled_purge_date=None, service_managed_resources_settings=None, service_provisioned_resource_group=None, shared_private_link_resources=None, sku=None, soft_deleted_at=None, storage_account=None, storage_hns_enabled=None, system_data=None, system_datastores_auth_mode=None, tags=None, tenant_id=None, type=None, v1_legacy_mode=None, workspace_id=None):
        ...
        if scheduled_purge_date and not isinstance(scheduled_purge_date, str):
            raise TypeError("Expected argument 'scheduled_purge_date' to be a str")
        ...
        if soft_deleted_at and not isinstance(soft_deleted_at, str):
            raise TypeError("Expected argument 'soft_deleted_at' to be a str")
        pulumi.set(__self__, "soft_deleted_at", soft_deleted_at)
...
class AwaitableGetWorkspaceResult(GetWorkspaceResult):
    ...
    def __await__(self):
        ...
        return GetWorkspaceResult(
            ...
            scheduled_purge_date=self.scheduled_purge_date,
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: azure-native:machinelearningservices/v20221201preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:Workspace to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20221201preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
    ...
    return AwaitableGetWorkspaceResult(
        ...
        scheduled_purge_date=__ret__.scheduled_purge_date,
        ...
        sku=__ret__.sku,
        soft_deleted_at=__ret__.soft_deleted_at,
