...
class ModelVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        model_version = azure_native.machinelearningservices.v20221201preview.ModelVersion("modelVersion",
