...
class Schedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        schedule = azure_native.machinelearningservices.v20221201preview.Schedule("schedule",
            name="string",
            resource_group_name="test-rg",
            schedule_properties=azure_native.machinelearningservices.v20221201preview.ScheduleResponseArgs(
                action=azure_native.machinelearningservices.v20221201preview.EndpointScheduleActionArgs(
                ...
                trigger=azure_native.machinelearningservices.v20221201preview.CronTriggerArgs(
                    end_time="string",
                    expression="string",
                    start_time="string",
                    time_zone="string",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:Schedule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:Schedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Schedule, __self__).__init__(
            'azure-native:machinelearningservices/v20221201preview:Schedule',
            resource_name,
            __props__,
            opts)
