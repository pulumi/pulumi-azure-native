...
class WorkspaceConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workspace_connection = azure_native.machinelearningservices.v20221201preview.WorkspaceConnection("workspaceConnection",
            connection_name="connection-1",
            properties=azure_native.machinelearningservices.v20221201preview.NoneAuthTypeWorkspaceConnectionPropertiesArgs(
                auth_type="None",
