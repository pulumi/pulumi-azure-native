...
class OnlineDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        online_deployment = azure_native.machinelearningservices.v20221201preview.OnlineDeployment("onlineDeployment",
            ...
            kind="string",
            location="string",
            online_deployment_properties=azure_native.machinelearningservices.v20221201preview.KubernetesOnlineDeploymentArgs(
                app_insights_enabled=False,
                code_configuration=azure_native.machinelearningservices.v20221201preview.CodeConfigurationArgs(
                    code_id="string",
                    scoring_script="string",
                ),
                container_resource_requirements=azure_native.machinelearningservices.v20221201preview.ContainerResourceRequirementsArgs(
                    container_resource_limits=azure_native.machinelearningservices.v20221201preview.ContainerResourceSettingsArgs(
                        cpu="\\"1\\"",
                        gpu="\\"1\\"",
                        memory="\\"2Gi\\"",
                    ),
                    container_resource_requests=azure_native.machinelearningservices.v20221201preview.ContainerResourceSettingsArgs(
                        cpu="\\"1\\"",
                        gpu="\\"1\\"",
                        memory="\\"2Gi\\"",
                    ),
                ...
                liveness_probe=azure_native.machinelearningservices.v20221201preview.ProbeSettingsArgs(
                    failure_threshold=1,
                    initial_delay="PT5M",
                    period="PT5M",
                    success_threshold=1,
                ...
                request_settings=azure_native.machinelearningservices.v20221201preview.OnlineRequestSettingsArgs(
                    max_concurrent_requests_per_instance=1,
                    max_queue_wait="PT5M",
                    request_timeout="PT5M",
                ),
                scale_settings=azure_native.machinelearningservices.v20221201preview.DefaultScaleSettingsArgs(
                    scale_type="Default",
                ),
            ),
        ...
        online_deployment = azure_native.machinelearningservices.v20221201preview.OnlineDeployment("onlineDeployment",
            ...
            kind="string",
            location="string",
            online_deployment_properties=azure_native.machinelearningservices.v20221201preview.ManagedOnlineDeploymentArgs(
                app_insights_enabled=False,
                code_configuration=azure_native.machinelearningservices.v20221201preview.CodeConfigurationArgs(
                    code_id="string",
                    scoring_script="string",
                ...
                readiness_probe=azure_native.machinelearningservices.v20221201preview.ProbeSettingsArgs(
