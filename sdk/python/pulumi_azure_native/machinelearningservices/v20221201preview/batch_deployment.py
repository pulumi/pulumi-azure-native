...
class BatchDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        batch_deployment = azure_native.machinelearningservices.v20221201preview.BatchDeployment("batchDeployment",
            batch_deployment_properties=azure_native.machinelearningservices.v20221201preview.BatchDeploymentResponseArgs(
                code_configuration=azure_native.machinelearningservices.v20221201preview.CodeConfigurationArgs(
                    code_id="string",
                ...
                mini_batch_size=1,
                model=azure_native.machinelearningservices.v20221201preview.IdAssetReferenceArgs(
                    asset_id="string",
                    reference_type="Id",
                ),
                ...
                resources=azure_native.machinelearningservices.v20221201preview.DeploymentResourceConfigurationArgs(
                    instance_count=1,
                ...
                retry_settings=azure_native.machinelearningservices.v20221201preview.BatchRetrySettingsArgs(
                    max_retries=1,
                    timeout="PT5M",
                ),
            ),
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:BatchDeployment"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:BatchDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BatchDeployment, __self__).__init__(
            'azure-native:machinelearningservices/v20221201preview:BatchDeployment',
            resource_name,
            __props__,
            opts)
