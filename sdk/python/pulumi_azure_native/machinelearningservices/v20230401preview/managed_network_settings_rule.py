...
class ManagedNetworkSettingsRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ManagedNetworkSettingsRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:ManagedNetworkSettingsRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:ManagedNetworkSettingsRule"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:ManagedNetworkSettingsRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedNetworkSettingsRule, __self__).__init__(
            'azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule',
            resource_name,
            __props__,
            opts)
