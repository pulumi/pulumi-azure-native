...
def get_registry(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
...
def get_registry_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:getRegistry', __args__, opts=opts, typ=GetRegistryResult)
