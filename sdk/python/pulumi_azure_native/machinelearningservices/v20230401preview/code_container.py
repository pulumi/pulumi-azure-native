...
class CodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        code_container = azure_native.machinelearningservices.v20230401preview.CodeContainer("codeContainer",
            code_container_properties=azure_native.machinelearningservices.v20230401preview.CodeContainerArgs(
                description="string",
                tags={
                    "tag1": "value1",
                    "tag2": "value2",
