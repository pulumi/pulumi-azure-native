...
class FeaturesetContainerEntity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        featureset_container_entity = azure_native.machinelearningservices.v20230401preview.FeaturesetContainerEntity("featuresetContainerEntity",
            featureset_container_properties=azure_native.machinelearningservices.v20230401preview.FeaturesetContainerArgs(
                description="string",
                is_archived=False,
                properties={
                    "string": "string",
    ...
    def _internal_init(__self__,
        ...
        super(FeaturesetContainerEntity, __self__).__init__(
            'azure-native:machinelearningservices/v20230401preview:FeaturesetContainerEntity',
            resource_name,
            __props__,
            opts)
