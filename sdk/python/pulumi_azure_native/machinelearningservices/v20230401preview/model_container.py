...
class ModelContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:ModelContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:ModelContainer")])
