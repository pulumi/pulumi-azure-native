...
def get_online_deployment(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:getOnlineDeployment', __args__, opts=opts, typ=GetOnlineDeploymentResult).value
...
def get_online_deployment_output(deployment_name: Optional[pulumi.Input[str]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOnlineDeploymentResult]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:getOnlineDeployment', __args__, opts=opts, typ=GetOnlineDeploymentResult)
    return __ret__.apply(lambda __response__: GetOnlineDeploymentResult(
        id=pulumi.get(__response__, 'id'),
        identity=pulumi.get(__response__, 'identity'),
        kind=pulumi.get(__response__, 'kind'),
        location=pulumi.get(__response__, 'location'),
        name=pulumi.get(__response__, 'name'),
        online_deployment_properties=pulumi.get(__response__, 'online_deployment_properties'),
