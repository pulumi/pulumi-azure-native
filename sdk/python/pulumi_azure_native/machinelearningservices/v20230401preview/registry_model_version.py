...
class RegistryModelVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_model_version = azure_native.machinelearningservices.v20230401preview.RegistryModelVersion("registryModelVersion",
            model_name="string",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:RegistryModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryModelVersion")])
