...
class RegistryComponentContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_component_container = azure_native.machinelearningservices.v20230401preview.RegistryComponentContainer("registryComponentContainer",
