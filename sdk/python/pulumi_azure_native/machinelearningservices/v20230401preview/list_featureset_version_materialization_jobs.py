...
def list_featureset_version_materialization_jobs(feature_window_end: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:listFeaturesetVersionMaterializationJobs', __args__, opts=opts, typ=ListFeaturesetVersionMaterializationJobsResult).value
...
def list_featureset_version_materialization_jobs_output(feature_window_end: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:listFeaturesetVersionMaterializationJobs', __args__, opts=opts, typ=ListFeaturesetVersionMaterializationJobsResult)
