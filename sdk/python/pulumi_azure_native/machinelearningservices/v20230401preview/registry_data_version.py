...
class RegistryDataVersionArgs:
    def __init__(__self__, *,
        ...
        """
        RegistryDataVersionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            data_version_base_properties=data_version_base_properties,
            name=name,
    ...
    def _configure(
             ...
             data_version_base_properties: Optional[pulumi.Input[Union['DataImportArgs', 'MLTableDataArgs', 'UriFileDataVersionArgs', 'UriFolderDataVersionArgs']]] = None,
             ...
             **kwargs):
        if data_version_base_properties is None and 'dataVersionBaseProperties' in kwargs:
            data_version_base_properties = kwargs['dataVersionBaseProperties']
        if data_version_base_properties is None:
            raise TypeError("Missing 'data_version_base_properties' argument")
        if name is None:
        ...
        _setter("data_version_base_properties", data_version_base_properties)
        _setter("name", name)
...
class RegistryDataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_version_base_properties: Optional[pulumi.Input[Union[pulumi.InputType['DataImportArgs'], pulumi.InputType['MLTableDataArgs'], pulumi.InputType['UriFileDataVersionArgs'], pulumi.InputType['UriFolderDataVersionArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 registry_name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 version: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union[pulumi.InputType['DataImportArgs'], pulumi.InputType['MLTableDataArgs'], pulumi.InputType['UriFileDataVersionArgs'], pulumi.InputType['UriFolderDataVersionArgs']]] data_version_base_properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] name: Container name.
        :param pulumi.Input[str] registry_name: Name of Azure Machine Learning registry. This is case-insensitive
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] version: Version identifier.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RegistryDataVersionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230601preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:RegistryDataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20231001:RegistryDataVersion")])
