...
class RegistryDataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_data_version = azure_native.machinelearningservices.v20230401preview.RegistryDataVersion("registryDataVersion",
            data_version_base_properties=azure_native.machinelearningservices.v20230401preview.MLTableDataArgs(
                data_type="mltable",
                data_uri="string",
                description="string",
                is_anonymous=False,
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20230401preview:RegistryDataVersion string string 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryDataVersion")])
