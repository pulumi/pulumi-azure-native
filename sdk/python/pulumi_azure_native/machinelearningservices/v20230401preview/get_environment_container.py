...
def get_environment_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:getEnvironmentContainer', __args__, opts=opts, typ=GetEnvironmentContainerResult).value
...
def get_environment_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:getEnvironmentContainer', __args__, opts=opts, typ=GetEnvironmentContainerResult)
