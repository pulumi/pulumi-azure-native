...
def get_registry_environment_version(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:getRegistryEnvironmentVersion', __args__, opts=opts, typ=GetRegistryEnvironmentVersionResult).value
...
def get_registry_environment_version_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['version'] = version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:getRegistryEnvironmentVersion', __args__, opts=opts, typ=GetRegistryEnvironmentVersionResult)
