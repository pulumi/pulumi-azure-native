...
def list_compute_keys(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:listComputeKeys', __args__, opts=opts, typ=ListComputeKeysResult).value
...
def list_compute_keys_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:listComputeKeys', __args__, opts=opts, typ=ListComputeKeysResult)
