...
class WorkspaceArgs:
    ...
    def _configure(
        ...
        if enable_data_isolation is None and 'enableDataIsolation' in kwargs:
            enable_data_isolation = kwargs['enableDataIsolation']
        if existing_workspaces is None and 'existingWorkspaces' in kwargs:
            existing_workspaces = kwargs['existingWorkspaces']
        if feature_store_settings is None and 'featureStoreSettings' in kwargs:
        ...
        if hub_resource_id is None and 'hubResourceId' in kwargs:
        ...
        if key_vaults is None and 'keyVaults' in kwargs:
            key_vaults = kwargs['keyVaults']
        if managed_network is None and 'managedNetwork' in kwargs:
        ...
        if system_datastores_auth_mode is None and 'systemDatastoresAuthMode' in kwargs:
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            feature_store_settings = _utilities.configure(feature_store_settings, FeatureStoreSettingsArgs, True)
            ...
            managed_network = _utilities.configure(managed_network, ManagedNetworkSettingsArgs, True)
