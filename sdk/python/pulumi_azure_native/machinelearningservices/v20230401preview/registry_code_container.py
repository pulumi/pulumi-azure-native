...
class RegistryCodeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        registry_code_container = azure_native.machinelearningservices.v20230401preview.RegistryCodeContainer("registryCodeContainer",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:RegistryCodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:RegistryCodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:RegistryCodeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegistryCodeContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20230401preview:RegistryCodeContainer',
            resource_name,
            __props__,
            opts)
