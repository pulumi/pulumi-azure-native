...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_version = azure_native.machinelearningservices.v20230401preview.DataVersion("dataVersion",
            data_version_base_properties=azure_native.machinelearningservices.v20230401preview.UriFileDataVersionArgs(
                data_type="uri_file",
                data_uri="string",
                description="string",
                is_anonymous=False,
        ...
        ```sh
        $ pulumi import azure-native:machinelearningservices/v20230401preview:DataVersion string string 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:DataVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20230401preview:DataVersion',
            resource_name,
            __props__,
            opts)
