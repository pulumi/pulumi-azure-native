...
class DataContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_container = azure_native.machinelearningservices.v20230401preview.DataContainer("dataContainer",
