...
def get_registry_environment_container(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20230401preview:getRegistryEnvironmentContainer', __args__, opts=opts, typ=GetRegistryEnvironmentContainerResult).value
...
def get_registry_environment_container_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20230401preview:getRegistryEnvironmentContainer', __args__, opts=opts, typ=GetRegistryEnvironmentContainerResult)
