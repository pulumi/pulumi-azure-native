...
class FeaturestoreEntityContainerEntity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        featurestore_entity_container_entity = azure_native.machinelearningservices.v20230401preview.FeaturestoreEntityContainerEntity("featurestoreEntityContainerEntity",
            featurestore_entity_container_properties=azure_native.machinelearningservices.v20230401preview.FeaturestoreEntityContainerArgs(
                description="string",
                is_archived=False,
                properties={
                    "string": "string",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityContainerEntity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FeaturestoreEntityContainerEntity, __self__).__init__(
            'azure-native:machinelearningservices/v20230401preview:FeaturestoreEntityContainerEntity',
            resource_name,
            __props__,
            opts)
