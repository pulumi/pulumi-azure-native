...
class ACIService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ACIService is deprecated: azure-native:machinelearningservices/v20200501preview:ACIService is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:ACIService to guarantee forwards compatibility.""")
