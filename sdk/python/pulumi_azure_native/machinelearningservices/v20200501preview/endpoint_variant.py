...
warnings.warn("""azure-native:machinelearningservices/v20200501preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.""", DeprecationWarning)
...
class EndpointVariant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""EndpointVariant is deprecated: azure-native:machinelearningservices/v20200501preview:EndpointVariant is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:EndpointVariant to guarantee forwards compatibility.""")
