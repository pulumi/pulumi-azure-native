...
def get_linked_workspace_output(link_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20200501preview:getLinkedWorkspace', __args__, opts=opts, typ=GetLinkedWorkspaceResult)
