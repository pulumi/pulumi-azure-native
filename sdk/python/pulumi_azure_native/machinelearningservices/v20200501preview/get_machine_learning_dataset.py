...
def get_machine_learning_dataset(dataset_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200501preview:getMachineLearningDataset', __args__, opts=opts, typ=GetMachineLearningDatasetResult).value
...
def get_machine_learning_dataset_output(dataset_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20200501preview:getMachineLearningDataset', __args__, opts=opts, typ=GetMachineLearningDatasetResult)
