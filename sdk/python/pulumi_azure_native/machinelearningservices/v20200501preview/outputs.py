...
class DatasetResponseDataPath(dict):
    ...
    def _configure(
        ...
        if 'partitionFormatIgnoreError' in kwargs:
...
class DatasetResponseLatest(dict):
    ...
    def _configure(
        ...
        if 'modifiedTime' in kwargs:
            modified_time = kwargs['modifiedTime']
        if 'partitionFormatInPath' in kwargs:
            partition_format_in_path = kwargs['partitionFormatInPath']
        if 'savedDatasetId' in kwargs:
            saved_dataset_id = kwargs['savedDatasetId']
        if 'telemetryInfo' in kwargs:
            telemetry_info = kwargs['telemetryInfo']
        if 'useDescriptionTagsFromDefinition' in kwargs:
        ...
        if 'datasetDefinitionState' in kwargs:
...
class DatasetResponseSqlDataPath(dict):
    ...
    def _configure(
        ...
        if 'sqlStoredProcedureName' in kwargs:
            sql_stored_procedure_name = kwargs['sqlStoredProcedureName']
        if 'sqlTableName' in kwargs:
...
class DatasetStateResponseDeprecatedBy(dict):
    ...
    def _configure(
        ...
        if 'datasetId' in kwargs:
            dataset_id = kwargs['datasetId']
        if 'definitionVersion' in kwargs:
...
class LinkedInfoResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'linkedId' in kwargs:
            linked_id = kwargs['linkedId']
        if 'linkedResourceName' in kwargs:
