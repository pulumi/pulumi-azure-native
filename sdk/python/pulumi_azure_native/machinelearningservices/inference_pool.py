...
class InferencePool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 inference_pool_name: pulumi.Input[Optional[_builtins.str]] = None,
                 inference_pool_properties: pulumi.Input[Optional[Union['InferencePoolArgs', 'InferencePoolArgsDict']]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:InferencePool"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:InferencePool")])
