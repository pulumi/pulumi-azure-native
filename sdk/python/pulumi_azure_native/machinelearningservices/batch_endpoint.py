...
class BatchEndpointInitArgs:
    ...
    def _configure(
             ...
             batch_endpoint_properties: Optional[pulumi.Input['BatchEndpointArgs']] = None,
             ...
             **kwargs):
        if batch_endpoint_properties is None and 'batchEndpointProperties' in kwargs:
            batch_endpoint_properties = kwargs['batchEndpointProperties']
        if batch_endpoint_properties is None:
            raise TypeError("Missing 'batch_endpoint_properties' argument")
...
class BatchEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            batch_endpoint_properties = _utilities.configure(batch_endpoint_properties, BatchEndpointArgs, True)
