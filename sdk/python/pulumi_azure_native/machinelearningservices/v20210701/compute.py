...
warnings.warn("""azure-native:machinelearningservices/v20210701:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20220101preview:Compute to guarantee forwards compatibility.""", DeprecationWarning)
...
class Compute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Compute is deprecated: azure-native:machinelearningservices/v20210701:Compute is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20220101preview:Compute to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20180301preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20181119:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20190501:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20190601:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20191101:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200101:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200218preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200301:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200401:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200601:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200801:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210401:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220101preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220601preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:Compute"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:Compute")])
