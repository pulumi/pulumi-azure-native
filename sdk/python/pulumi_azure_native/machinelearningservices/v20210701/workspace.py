...
warnings.warn("""azure-native:machinelearningservices/v20210701:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20220101preview:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Workspace is deprecated: azure-native:machinelearningservices/v20210701:Workspace is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20220101preview:Workspace to guarantee forwards compatibility.""")
