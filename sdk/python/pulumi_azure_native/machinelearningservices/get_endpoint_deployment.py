...
def get_endpoint_deployment(deployment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_name: Name of the endpoint resource.
...
def get_endpoint_deployment_output(deployment_name: Optional[pulumi.Input[builtins.str]] = None,
