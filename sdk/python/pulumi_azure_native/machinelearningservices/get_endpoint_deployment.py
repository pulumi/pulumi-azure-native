...
def get_endpoint_deployment(deployment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint_name: Name of the endpoint resource.
...
def get_endpoint_deployment_output(deployment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
