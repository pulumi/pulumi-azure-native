...
def get_workspace_connection(connection_name: Optional[_builtins.str] = None,
...
def get_workspace_connection_output(connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
