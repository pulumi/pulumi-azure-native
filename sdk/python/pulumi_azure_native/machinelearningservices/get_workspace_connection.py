...
def get_workspace_connection(connection_name: Optional[builtins.str] = None,
...
def get_workspace_connection_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
