...
def get_registry_data_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401:getRegistryDataContainer', __args__, opts=opts, typ=GetRegistryDataContainerResult).value
...
def get_registry_data_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401:getRegistryDataContainer', __args__, opts=opts, typ=GetRegistryDataContainerResult)
