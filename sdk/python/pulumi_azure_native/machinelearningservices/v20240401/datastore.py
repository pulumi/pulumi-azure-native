...
class Datastore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 datastore_properties: Optional[pulumi.Input[Union[pulumi.InputType['AzureBlobDatastoreArgs'], pulumi.InputType['AzureDataLakeGen1DatastoreArgs'], pulumi.InputType['AzureDataLakeGen2DatastoreArgs'], pulumi.InputType['AzureFileDatastoreArgs'], pulumi.InputType['OneLakeDatastoreArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        super(Datastore, __self__).__init__(
            'azure-native:machinelearningservices/v20240401:Datastore',
            resource_name,
            __props__,
            opts)
