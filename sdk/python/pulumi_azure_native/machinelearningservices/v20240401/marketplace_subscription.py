...
class MarketplaceSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240701preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:MarketplaceSubscription"), pulumi.Alias(type_="azure-native:machinelearningservices:MarketplaceSubscription")])
