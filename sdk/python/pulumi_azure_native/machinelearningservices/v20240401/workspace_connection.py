...
class WorkspaceConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connection_name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[Union[pulumi.InputType['AADAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['AccessKeyAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['AccountKeyAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['ApiKeyAuthWorkspaceConnectionPropertiesArgs'], pulumi.InputType['CustomKeysWorkspaceConnectionPropertiesArgs'], pulumi.InputType['ManagedIdentityAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['NoneAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['OAuth2AuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['PATAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['SASAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['ServicePrincipalAuthTypeWorkspaceConnectionPropertiesArgs'], pulumi.InputType['UsernamePasswordAuthTypeWorkspaceConnectionPropertiesArgs']]]] = None,
    ...
    def _internal_init(__self__,
        ...
        super(WorkspaceConnection, __self__).__init__(
            'azure-native:machinelearningservices/v20240401:WorkspaceConnection',
            resource_name,
            __props__,
            opts)
