...
def list_serverless_endpoint_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401:listServerlessEndpointKeys', __args__, opts=opts, typ=ListServerlessEndpointKeysResult).value
...
def list_serverless_endpoint_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401:listServerlessEndpointKeys', __args__, opts=opts, typ=ListServerlessEndpointKeysResult)
