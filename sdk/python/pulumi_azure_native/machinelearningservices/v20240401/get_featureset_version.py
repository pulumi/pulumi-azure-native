...
__all__ = [
    ...
    'AwaitableGetFeaturesetVersionResult',
    'get_featureset_version',
...
class GetFeaturesetVersionResult:
    ...
    """
    def __init__(__self__, featureset_version_properties=None, id=None, name=None, system_data=None, type=None):
...
class AwaitableGetFeaturesetVersionResult(GetFeaturesetVersionResult):
...
def get_featureset_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401:getFeaturesetVersion', __args__, opts=opts, typ=GetFeaturesetVersionResult).value
...
def get_featureset_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401:getFeaturesetVersion', __args__, opts=opts, typ=GetFeaturesetVersionResult)
