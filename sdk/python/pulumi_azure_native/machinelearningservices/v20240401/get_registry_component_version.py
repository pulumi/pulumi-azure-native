...
__all__ = [
    ...
    'AwaitableGetRegistryComponentVersionResult',
...
class AwaitableGetRegistryComponentVersionResult(GetRegistryComponentVersionResult):
...
def get_registry_component_version(component_name: Optional[str] = None,
                                   registry_name: Optional[str] = None,
                                   resource_group_name: Optional[str] = None,
                                   version: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRegistryComponentVersionResult:
    """
    Azure Resource Manager resource envelope.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20240401:getRegistryComponentVersion', __args__, opts=opts, typ=GetRegistryComponentVersionResult).value

    return AwaitableGetRegistryComponentVersionResult(
        component_version_properties=pulumi.get(__ret__, 'component_version_properties'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        system_data=pulumi.get(__ret__, 'system_data'),
        type=pulumi.get(__ret__, 'type'))
def get_registry_component_version_output(component_name: Optional[pulumi.Input[str]] = None,
                                          registry_name: Optional[pulumi.Input[str]] = None,
                                          resource_group_name: Optional[pulumi.Input[str]] = None,
                                          version: Optional[pulumi.Input[str]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRegistryComponentVersionResult]:
    """
    Azure Resource Manager resource envelope.
    ...
    __args__['version'] = version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20240401:getRegistryComponentVersion', __args__, opts=opts, typ=GetRegistryComponentVersionResult)
    return __ret__.apply(lambda __response__: GetRegistryComponentVersionResult(
