...
class GetOnlineEndpointResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.OnlineEndpointPropertiesResponse':
        """
...
def get_online_endpoint_output(endpoint_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
