...
def get_online_endpoint(endpoint_name: Optional[_builtins.str] = None,
...
def get_online_endpoint_output(endpoint_name: Optional[pulumi.Input[_builtins.str]] = None,
