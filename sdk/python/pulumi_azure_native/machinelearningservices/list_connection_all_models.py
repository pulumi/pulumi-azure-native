...
def list_connection_all_models(resource_group_name: Optional[_builtins.str] = None,
...
def list_connection_all_models_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
