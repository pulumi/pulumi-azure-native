...
warnings.warn("""azure-native:machinelearningservices/v20200301:LinkedWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200515preview:LinkedWorkspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_linked_workspace(link_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_workspace is deprecated: azure-native:machinelearningservices/v20200301:LinkedWorkspace is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20200515preview:LinkedWorkspace to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['linkName'] = link_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200301:getLinkedWorkspace', __args__, opts=opts, typ=GetLinkedWorkspaceResult).value
