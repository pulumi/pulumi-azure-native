...
def get_machine_learning_compute(compute_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine_learning_compute is deprecated: azure-native:machinelearningservices/v20200301:MachineLearningCompute is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20210401:MachineLearningCompute to guarantee forwards compatibility.""")
    __args__ = dict()
