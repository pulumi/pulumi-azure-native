...
class ListWorkspaceKeysResult:
    ...
    def notebook_access_keys(self) -> Optional['outputs.NotebookListCredentialsResultResponse']:
...
def list_workspace_keys(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20200301:listWorkspaceKeys', __args__, opts=opts, typ=ListWorkspaceKeysResult).value
