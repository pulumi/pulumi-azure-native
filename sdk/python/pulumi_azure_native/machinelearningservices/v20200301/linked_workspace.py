...
class LinkedWorkspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        linked_workspace = azure_native.machinelearningservices.v20200301.LinkedWorkspace("linkedWorkspace",
            link_name="link-1",
            name="link-1",
            properties=azure_native.machinelearningservices.v20200301.LinkedWorkspacePropsArgs(
