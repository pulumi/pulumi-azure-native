...
class MachineLearningDataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(parameters, DatasetCreateRequestParametersArgs):
            ...
            if not isinstance(registration, DatasetCreateRequestRegistrationArgs):
            ...
            if not isinstance(time_series, DatasetCreateRequestTimeSeriesArgs):
