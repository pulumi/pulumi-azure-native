...
class MachineLearningDataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:MachineLearningDataset"), pulumi.Alias(type_="azure-native_machinelearningservices_v20200501preview:machinelearningservices:MachineLearningDataset")])
