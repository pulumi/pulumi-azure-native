...
def get_batch_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_endpoint is deprecated: azure-native:machinelearningservices/v20220601preview:BatchEndpoint is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:BatchEndpoint to guarantee forwards compatibility.""")
    __args__ = dict()
