...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:BatchEndpoint is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchEndpoint to guarantee forwards compatibility.""", DeprecationWarning)
