...
def get_environment_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220601preview:getEnvironmentContainer', __args__, opts=opts, typ=GetEnvironmentContainerResult)
