...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:BatchDeployment to guarantee forwards compatibility.""", DeprecationWarning)
