...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:CodeContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:CodeContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
class CodeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CodeContainer is deprecated: azure-native:machinelearningservices/v20220601preview:CodeContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:CodeContainer to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20220501:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221001preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20221201preview:CodeContainer"), pulumi.Alias(type_="azure-native:machinelearningservices/v20230401preview:CodeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CodeContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20220601preview:CodeContainer',
            resource_name,
            __props__,
            opts)
