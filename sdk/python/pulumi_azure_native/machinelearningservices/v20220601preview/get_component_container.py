...
def get_component_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220601preview:getComponentContainer', __args__, opts=opts, typ=GetComponentContainerResult)
