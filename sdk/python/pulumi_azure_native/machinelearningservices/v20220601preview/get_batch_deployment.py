...
def get_batch_deployment(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_deployment is deprecated: azure-native:machinelearningservices/v20220601preview:BatchDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:BatchDeployment to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220601preview:getBatchDeployment', __args__, opts=opts, typ=GetBatchDeploymentResult).value
