...
def get_environment_version(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220601preview:getEnvironmentVersion', __args__, opts=opts, typ=GetEnvironmentVersionResult).value
...
def get_environment_version_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20220601preview:getEnvironmentVersion', __args__, opts=opts, typ=GetEnvironmentVersionResult)
