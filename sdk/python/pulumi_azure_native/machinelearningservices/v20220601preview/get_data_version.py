...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:DataVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_version(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_version is deprecated: azure-native:machinelearningservices/v20220601preview:DataVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:DataVersion to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
