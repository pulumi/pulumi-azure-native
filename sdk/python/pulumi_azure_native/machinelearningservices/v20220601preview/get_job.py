...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:machinelearningservices/v20220601preview:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:Job to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['id'] = id
