...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:CodeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:CodeVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
class CodeVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""CodeVersion is deprecated: azure-native:machinelearningservices/v20220601preview:CodeVersion is being removed in the next major version of this provider. Please upgrade to azure-native:machinelearningservices/v20221201preview:CodeVersion to guarantee forwards compatibility.""")
