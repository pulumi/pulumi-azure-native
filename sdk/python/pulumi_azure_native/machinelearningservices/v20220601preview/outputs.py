...
class ComputeInstancePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "connectivityEndpoints":
            ...
            suggest = "enable_node_public_ip"
        elif key == "idleTimeBeforeShutdown":
            suggest = "idle_time_before_shutdown"
    ...
    def __init__(__self__, *,
        ...
        :param bool enable_node_public_ip: Enable or disable node public IP address provisioning. Possible values are: Possible values are: true - Indicates that the compute nodes will have public IPs provisioned. false - Indicates that the compute nodes will have a private endpoint and no public IPs.
        :param str idle_time_before_shutdown: Stops compute instance after user defined period of inactivity. Time is defined in ISO8601 format. Minimum is 15 min, maximum is 3 days.
    ...
    def idle_time_before_shutdown(self) -> Optional[str]:
        """
...
class ImageResponse(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[str] = None):
        """
        :param str reference: Image reference URL
...
class JobScheduleActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Union['AutoMLJobResponse', 'CommandJobResponse', 'LabelingJobResponse', 'PipelineJobResponse', 'SparkJobResponse', 'SweepJobResponse'] job_base_properties: [Required] Defines Schedule action definition details.
        """
...
class LabelCategoryResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "displayName":
            suggest = "display_name"
        elif key == "multiSelectEnabled":
            suggest = "multi_select_enabled"
    ...
    def __init__(__self__, *,
                 ...
                 display_name: Optional[str] = None,
                 multi_select_enabled: Optional[bool] = None):
        """
        Label category definition
        ...
        :param bool multi_select_enabled: Indicates whether it is allowed to select multiple classes in this category.
        """
        if classes is not None:
            pulumi.set(__self__, "classes", classes)
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if multi_select_enabled is None:
            multi_select_enabled = False
        if multi_select_enabled is not None:
            pulumi.set(__self__, "multi_select_enabled", multi_select_enabled)
    ...
    @property
    @pulumi.getter(name="multiSelectEnabled")
    def multi_select_enabled(self) -> Optional[bool]:
        """
        Indicates whether it is allowed to select multiple classes in this category.
        """
        return pulumi.get(self, "multi_select_enabled")
...
class LabelingDataConfigurationResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "dataId":
            suggest = "data_id"
        elif key == "incrementalDataRefreshEnabled":
            suggest = "incremental_data_refresh_enabled"
    ...
    def __init__(__self__, *,
                 ...
                 incremental_data_refresh_enabled: Optional[bool] = None):
        """
        Labeling data configuration definition
        :param str data_id: Resource Id of the data asset to perform labeling.
        :param bool incremental_data_refresh_enabled: Indicates whether to enable incremental data refresh.
        """
        if data_id is not None:
            pulumi.set(__self__, "data_id", data_id)
        if incremental_data_refresh_enabled is None:
            incremental_data_refresh_enabled = False
        if incremental_data_refresh_enabled is not None:
            pulumi.set(__self__, "incremental_data_refresh_enabled", incremental_data_refresh_enabled)
    ...
    @property
    @pulumi.getter(name="incrementalDataRefreshEnabled")
    def incremental_data_refresh_enabled(self) -> Optional[bool]:
        """
        Indicates whether to enable incremental data refresh.
        """
        return pulumi.get(self, "incremental_data_refresh_enabled")
...
class MLTableDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str data_uri: [Required] Uri of the data. Usage/meaning depends on Microsoft.MachineLearning.ManagementFrontEnd.Contracts.V20220601Preview.Assets.DataVersionBase.DataType
        :param str description: The asset description text.
        :param bool is_anonymous: If the name version are system generated (anonymous registration).
        :param bool is_archived: Is the asset archived?
        :param Mapping[str, str] properties: The asset property dictionary.
...
class RecurrenceTriggerResponse(dict):
    ...
    def __init__(__self__, *,
                 frequency: str,
                 interval: int,
                 schedule: 'outputs.RecurrenceScheduleResponse',
                 trigger_type: str,
                 end_time: Optional[str] = None,
                 start_time: Optional[str] = None,
                 time_zone: Optional[str] = None):
    ...
    @property
    @pulumi.getter
    def schedule(self) -> 'outputs.RecurrenceScheduleResponse':
        """
...
class SparkJobPythonEntryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str file: [Required] Relative python file path for job entry point.
...
class SparkJobResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Spark job definition.
        :param str code_id: [Required] ARM resource ID of the code asset.
        ...
        :param str status: Status of the job.
        :param Sequence[str] archives: Archive files used in the job.
        :param str args: Arguments for the job.
        :param str component_id: ARM resource ID of the component resource.
        :param str compute_id: ARM resource ID of the compute resource.
        :param Mapping[str, str] conf: Spark configured properties.
        :param str description: The asset description text.
        :param str display_name: Display name of job.
        :param str environment_id: The ARM resource ID of the Environment specification for the job.
        :param str experiment_name: The name of the experiment the job belongs to. If not set, the job is placed in the "Default" experiment.
        :param Sequence[str] files: Files used in the job.
        :param Union['AmlTokenResponse', 'ManagedIdentityResponse', 'UserIdentityResponse'] identity: Identity configuration. If set, this should be one of AmlToken, ManagedIdentity, UserIdentity or null.
               Defaults to AmlToken if null.
        :param Mapping[str, Union['CustomModelJobInputResponse', 'LiteralJobInputResponse', 'MLFlowModelJobInputResponse', 'MLTableJobInputResponse', 'TritonModelJobInputResponse', 'UriFileJobInputResponse', 'UriFolderJobInputResponse']] inputs: Mapping of input data bindings used in the job.
        :param bool is_archived: Is the asset archived?
        :param Sequence[str] jars: Jar files used in the job.
        :param Mapping[str, Union['CustomModelJobOutputResponse', 'MLFlowModelJobOutputResponse', 'MLTableJobOutputResponse', 'TritonModelJobOutputResponse', 'UriFileJobOutputResponse', 'UriFolderJobOutputResponse']] outputs: Mapping of output data bindings used in the job.
        :param Mapping[str, str] properties: The asset property dictionary.
        :param Sequence[str] py_files: Python files used in the job.
    ...
    @property
    @pulumi.getter
    def archives(self) -> Optional[Sequence[str]]:
        """
    ...
    @property
    @pulumi.getter
    def conf(self) -> Optional[Mapping[str, str]]:
        """
    ...
    @property
    @pulumi.getter
    def jars(self) -> Optional[Sequence[str]]:
        """
    ...
    def py_files(self) -> Optional[Sequence[str]]:
        """
...
class SparkResourceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str instance_type: Optional type of VM used as supported by the compute target.
        :param str runtime_version: Version of spark runtime used for the job.
        """
        if instance_type is not None:
            pulumi.set(__self__, "instance_type", instance_type)
