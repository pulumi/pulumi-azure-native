...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:OnlineDeployment is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20230401preview:OnlineDeployment to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_online_deployment(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20220601preview:getOnlineDeployment', __args__, opts=opts, typ=GetOnlineDeploymentResult).value
