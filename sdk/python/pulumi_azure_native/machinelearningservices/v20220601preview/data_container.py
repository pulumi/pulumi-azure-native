...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:DataContainer is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:DataContainer to guarantee forwards compatibility.""", DeprecationWarning)
...
class DataContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DataContainer, __self__).__init__(
            'azure-native:machinelearningservices/v20220601preview:DataContainer',
            resource_name,
            __props__,
            opts)
