...
warnings.warn("""azure-native:machinelearningservices/v20220601preview:EnvironmentVersion is being removed in the next major version of this provider. Upgrade to at least azure-native:machinelearningservices/v20221201preview:EnvironmentVersion to guarantee forwards compatibility.""", DeprecationWarning)
...
class EnvironmentVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(EnvironmentVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20220601preview:EnvironmentVersion',
            resource_name,
            __props__,
            opts)
