...
def get_inference_pool(inference_pool_name: Optional[builtins.str] = None,
...
def get_inference_pool_output(inference_pool_name: Optional[pulumi.Input[builtins.str]] = None,
