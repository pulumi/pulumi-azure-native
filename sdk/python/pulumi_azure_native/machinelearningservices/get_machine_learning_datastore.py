...
class GetMachineLearningDatastoreResult:
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> Optional['outputs.IdentityMachineLearningDatastoreResponse']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sku(self) -> Optional['outputs.SkuMachineLearningDatastoreResponse']:
        """
...
def get_machine_learning_datastore(datastore_name: Optional[_builtins.str] = None,
