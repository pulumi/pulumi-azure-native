...
class GetComponentVersionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, component_version_properties=None, id=None, name=None, system_data=None, type=None):
...
def get_component_version(name: Optional[_builtins.str] = None,
...
def get_component_version_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices:getComponentVersion', __args__, opts=opts, typ=GetComponentVersionResult)
