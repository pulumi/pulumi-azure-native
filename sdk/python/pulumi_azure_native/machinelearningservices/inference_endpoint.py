...
class InferenceEndpointInitArgs:
    def __init__(__self__, *,
        ...
        """
        InferenceEndpointInitArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            inference_endpoint_properties=inference_endpoint_properties,
            pool_name=pool_name,
    ...
    def _configure(
             ...
             inference_endpoint_properties: Optional[pulumi.Input['InferenceEndpointArgs']] = None,
             ...
             **kwargs):
        if inference_endpoint_properties is None and 'inferenceEndpointProperties' in kwargs:
            inference_endpoint_properties = kwargs['inferenceEndpointProperties']
        if inference_endpoint_properties is None:
            raise TypeError("Missing 'inference_endpoint_properties' argument")
        ...
        _setter("inference_endpoint_properties", inference_endpoint_properties)
...
class InferenceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 inference_endpoint_properties: Optional[pulumi.Input[pulumi.InputType['InferenceEndpointArgs']]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 pool_name: Optional[pulumi.Input[str]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['InferenceEndpointArgs']] inference_endpoint_properties: [Required] Additional attributes of the entity.
        :param pulumi.Input[str] kind: Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] pool_name: InferencePool name.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            InferenceEndpointInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            inference_endpoint_properties = _utilities.configure(inference_endpoint_properties, InferenceEndpointArgs, True)
