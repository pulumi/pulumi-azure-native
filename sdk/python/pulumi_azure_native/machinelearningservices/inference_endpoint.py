...
class InferenceEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native_machinelearningservices_v20230801preview:machinelearningservices:InferenceEndpoint"), pulumi.Alias(type_="azure-native_machinelearningservices_v20240101preview:machinelearningservices:InferenceEndpoint"), pulumi.Alias(type_="azure-native_machinelearningservices_v20240401preview:machinelearningservices:InferenceEndpoint"), pulumi.Alias(type_="azure-native_machinelearningservices_v20241001preview:machinelearningservices:InferenceEndpoint"), pulumi.Alias(type_="azure-native_machinelearningservices_v20250101preview:machinelearningservices:InferenceEndpoint")])
