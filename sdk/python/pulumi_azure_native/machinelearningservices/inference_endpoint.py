...
@pulumi.type_token("azure-native:machinelearningservices:InferenceEndpoint")
class InferenceEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 inference_endpoint_properties: pulumi.Input[Optional[Union['InferenceEndpointArgs', 'InferenceEndpointArgsDict']]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearningservices/v20230801preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240101preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20240401preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20241001preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250101preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250401preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20250701preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20251001preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260115preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260315preview:InferenceEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices/v20260515preview:InferenceEndpoint")])
