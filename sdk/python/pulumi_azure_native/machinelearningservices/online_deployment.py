...
class OnlineDeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] deployment_name: Inference Endpoint Deployment name.
