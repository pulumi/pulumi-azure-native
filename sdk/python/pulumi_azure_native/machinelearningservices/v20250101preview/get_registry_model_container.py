...
def get_registry_model_container(model_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult).value
...
def get_registry_model_container_output(model_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getRegistryModelContainer', __args__, opts=opts, typ=GetRegistryModelContainerResult)
