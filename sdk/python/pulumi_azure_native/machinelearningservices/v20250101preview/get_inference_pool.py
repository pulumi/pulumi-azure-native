...
def get_inference_pool(inference_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getInferencePool', __args__, opts=opts, typ=GetInferencePoolResult).value
...
def get_inference_pool_output(inference_pool_name: Optional[pulumi.Input[str]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInferencePoolResult]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getInferencePool', __args__, opts=opts, typ=GetInferencePoolResult)
    return __ret__.apply(lambda __response__: GetInferencePoolResult(
        id=pulumi.get(__response__, 'id'),
        identity=pulumi.get(__response__, 'identity'),
        inference_pool_properties=pulumi.get(__response__, 'inference_pool_properties'),
