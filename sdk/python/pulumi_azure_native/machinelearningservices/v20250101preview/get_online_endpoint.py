...
def get_online_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getOnlineEndpoint', __args__, opts=opts, typ=GetOnlineEndpointResult).value
...
def get_online_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getOnlineEndpoint', __args__, opts=opts, typ=GetOnlineEndpointResult)
