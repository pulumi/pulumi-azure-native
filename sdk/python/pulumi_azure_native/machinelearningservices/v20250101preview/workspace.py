...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 provision_network_now: Optional[pulumi.Input[bool]] = None,
                 ...
                 system_datastores_auth_mode: Optional[pulumi.Input[Union[str, 'SystemDatastoresAuthMode']]] = None,
        ...
        :param pulumi.Input['NetworkAclsArgs'] network_acls: A set of rules governing the network accessibility of the workspace.
        ...
        :param pulumi.Input[bool] provision_network_now: Set to trigger the provisioning of the managed VNet with the default Options when creating a Workspace with the managed VNet enabled, or else it does nothing.
        ...
        :param pulumi.Input[Union[str, 'SystemDatastoresAuthMode']] system_datastores_auth_mode: The auth mode used for accessing the system datastores of the workspace.
    ...
    def provision_network_now(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def provision_network_now(self, value: Optional[pulumi.Input[bool]]):
    ...
    def system_datastores_auth_mode(self) -> Optional[pulumi.Input[Union[str, 'SystemDatastoresAuthMode']]]:
        """
    ...
    def system_datastores_auth_mode(self, value: Optional[pulumi.Input[Union[str, 'SystemDatastoresAuthMode']]]):
...
class Workspace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['NetworkAclsArgs', 'NetworkAclsArgsDict']] network_acls: A set of rules governing the network accessibility of the workspace.
        :param pulumi.Input[str] primary_user_assigned_identity: The user assigned identity resource id that represents the workspace identity.
        :param pulumi.Input[bool] provision_network_now: Set to trigger the provisioning of the managed VNet with the default Options when creating a Workspace with the managed VNet enabled, or else it does nothing.
        :param pulumi.Input[Union[str, 'PublicNetworkAccessType']] public_network_access: Whether requests from Public Network are allowed.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["agents_endpoint_uri"] = None
    ...
    @property
    @pulumi.getter(name="agentsEndpointUri")
    def agents_endpoint_uri(self) -> pulumi.Output[str]:
        """
        The URI of agents endpoint associated with this workspace.
        """
        return pulumi.get(self, "agents_endpoint_uri")
    ...
    @property
    @pulumi.getter(name="provisionNetworkNow")
    def provision_network_now(self) -> pulumi.Output[Optional[bool]]:
        """
        Set to trigger the provisioning of the managed VNet with the default Options when creating a Workspace with the managed VNet enabled, or else it does nothing.
        """
        return pulumi.get(self, "provision_network_now")
