...
def get_compute(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getCompute', __args__, opts=opts, typ=GetComputeResult).value
...
def get_compute_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getCompute', __args__, opts=opts, typ=GetComputeResult)
