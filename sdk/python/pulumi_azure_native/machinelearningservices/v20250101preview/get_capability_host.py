...
class GetCapabilityHostResult:
    ...
    """
    def __init__(__self__, capability_host_properties=None, id=None, name=None, system_data=None, type=None):
...
def get_capability_host(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getCapabilityHost', __args__, opts=opts, typ=GetCapabilityHostResult).value

    return AwaitableGetCapabilityHostResult(
        capability_host_properties=pulumi.get(__ret__, 'capability_host_properties'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        system_data=pulumi.get(__ret__, 'system_data'),
        type=pulumi.get(__ret__, 'type'))
def get_capability_host_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getCapabilityHost', __args__, opts=opts, typ=GetCapabilityHostResult)
    return __ret__.apply(lambda __response__: GetCapabilityHostResult(
