...
def list_compute_nodes(compute_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:listComputeNodes', __args__, opts=opts, typ=ListComputeNodesResult).value
...
def list_compute_nodes_output(compute_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:listComputeNodes', __args__, opts=opts, typ=ListComputeNodesResult)
