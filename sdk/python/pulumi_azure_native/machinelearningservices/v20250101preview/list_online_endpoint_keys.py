...
def list_online_endpoint_keys(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:listOnlineEndpointKeys', __args__, opts=opts, typ=ListOnlineEndpointKeysResult).value
...
def list_online_endpoint_keys_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:listOnlineEndpointKeys', __args__, opts=opts, typ=ListOnlineEndpointKeysResult)
