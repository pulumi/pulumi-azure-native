...
def list_connection_all_models(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:listConnectionAllModels', __args__, opts=opts, typ=ListConnectionAllModelsResult).value

    return AwaitableListConnectionAllModelsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_connection_all_models_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:listConnectionAllModels', __args__, opts=opts, typ=ListConnectionAllModelsResult)
