...
def get_code_container(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getCodeContainer', __args__, opts=opts, typ=GetCodeContainerResult).value
...
def get_code_container_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getCodeContainer', __args__, opts=opts, typ=GetCodeContainerResult)
