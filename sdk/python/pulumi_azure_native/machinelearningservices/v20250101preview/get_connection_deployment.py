...
def get_connection_deployment(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getConnectionDeployment', __args__, opts=opts, typ=GetConnectionDeploymentResult).value
...
def get_connection_deployment_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getConnectionDeployment', __args__, opts=opts, typ=GetConnectionDeploymentResult)
