...
def get_connection_rai_blocklist(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult).value
...
def get_connection_rai_blocklist_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getConnectionRaiBlocklist', __args__, opts=opts, typ=GetConnectionRaiBlocklistResult)
