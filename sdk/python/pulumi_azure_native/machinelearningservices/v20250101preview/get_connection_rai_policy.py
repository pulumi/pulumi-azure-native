...
def get_connection_rai_policy(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getConnectionRaiPolicy', __args__, opts=opts, typ=GetConnectionRaiPolicyResult).value
...
def get_connection_rai_policy_output(connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getConnectionRaiPolicy', __args__, opts=opts, typ=GetConnectionRaiPolicyResult)
