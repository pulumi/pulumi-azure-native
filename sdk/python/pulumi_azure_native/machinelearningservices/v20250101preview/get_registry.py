...
def get_registry(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
...
def get_registry_output(registry_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getRegistry', __args__, opts=opts, typ=GetRegistryResult)
    return __ret__.apply(lambda __response__: GetRegistryResult(
        ...
        registry_properties=pulumi.get(__response__, 'registry_properties'),
