...
class JobArgs:
    def __init__(__self__, *,
                 job_base_properties: pulumi.Input[Union['AutoMLJobArgs', 'CommandJobArgs', 'DistillationJobArgs', 'FineTuningJobArgs', 'PipelineJobArgs', 'SparkJobArgs', 'SweepJobArgs']],
                 resource_group_name: pulumi.Input[str],
                 workspace_name: pulumi.Input[str],
                 id: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a Job resource.
        :param pulumi.Input[Union['AutoMLJobArgs', 'CommandJobArgs', 'DistillationJobArgs', 'FineTuningJobArgs', 'PipelineJobArgs', 'SparkJobArgs', 'SweepJobArgs']] job_base_properties: [Required] Additional attributes of the entity.
    ...
    def job_base_properties(self) -> pulumi.Input[Union['AutoMLJobArgs', 'CommandJobArgs', 'DistillationJobArgs', 'FineTuningJobArgs', 'PipelineJobArgs', 'SparkJobArgs', 'SweepJobArgs']]:
        """
    ...
    def job_base_properties(self, value: pulumi.Input[Union['AutoMLJobArgs', 'CommandJobArgs', 'DistillationJobArgs', 'FineTuningJobArgs', 'PipelineJobArgs', 'SparkJobArgs', 'SweepJobArgs']]):
...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Job, __self__).__init__(
            'azure-native:machinelearningservices/v20250101preview:Job',
            resource_name,
            __props__,
            opts)
