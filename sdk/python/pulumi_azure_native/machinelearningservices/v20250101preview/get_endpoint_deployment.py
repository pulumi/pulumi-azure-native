...
def get_endpoint_deployment(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/v20250101preview:getEndpointDeployment', __args__, opts=opts, typ=GetEndpointDeploymentResult).value
...
def get_endpoint_deployment_output(deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:machinelearningservices/v20250101preview:getEndpointDeployment', __args__, opts=opts, typ=GetEndpointDeploymentResult)
