...
def list_featureset_version_features(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str tags: Comma-separated list of tag names (and optionally values). Example: tag1,tag2=value2
    :param _builtins.str version: Featureset Version identifier. This is case-sensitive.
