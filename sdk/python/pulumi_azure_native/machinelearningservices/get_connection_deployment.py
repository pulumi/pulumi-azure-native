...
__all__ = [
    ...
    'AwaitableGetConnectionDeploymentResult',
    'get_connection_deployment',
    'get_connection_deployment_output',
]
...
class AwaitableGetConnectionDeploymentResult(GetConnectionDeploymentResult):
...
def get_connection_deployment(connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_name: Friendly name of the workspace connection
    :param _builtins.str deployment_name: Name of the deployment resource
...
def get_connection_deployment_output(connection_name: Optional[pulumi.Input[_builtins.str]] = None,
