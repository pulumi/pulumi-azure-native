...
def get_connection_deployment(connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_name: Friendly name of the workspace connection
    :param builtins.str deployment_name: Name of the deployment resource
...
def get_connection_deployment_output(connection_name: Optional[pulumi.Input[builtins.str]] = None,
