...
def get_diagnostic_service_token_read_write(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20210303preview:getDiagnosticServiceTokenReadWrite', __args__, opts=opts, typ=GetDiagnosticServiceTokenReadWriteResult).value
...
def get_diagnostic_service_token_read_write_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20210303preview:getDiagnosticServiceTokenReadWrite', __args__, opts=opts, typ=GetDiagnosticServiceTokenReadWriteResult)
    return __ret__.apply(lambda __response__: GetDiagnosticServiceTokenReadWriteResult(
