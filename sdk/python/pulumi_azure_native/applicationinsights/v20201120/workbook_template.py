...
class WorkbookTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights/v20191017preview:WorkbookTemplate"), pulumi.Alias(type_="azure-native:applicationinsights:WorkbookTemplate"), pulumi.Alias(type_="azure-native:insights/v20201120:WorkbookTemplate"), pulumi.Alias(type_="azure-native:insights:WorkbookTemplate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkbookTemplate, __self__).__init__(
            'azure-native:applicationinsights/v20201120:WorkbookTemplate',
            resource_name,
            __props__,
            opts)
