...
def get_workbook_template(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20201120:getWorkbookTemplate', __args__, opts=opts, typ=GetWorkbookTemplateResult).value
...
def get_workbook_template_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20201120:getWorkbookTemplate', __args__, opts=opts, typ=GetWorkbookTemplateResult)
