...
def get_component(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20200202preview:getComponent', __args__, opts=opts, typ=GetComponentResult).value
...
def get_component_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20200202preview:getComponent', __args__, opts=opts, typ=GetComponentResult)
