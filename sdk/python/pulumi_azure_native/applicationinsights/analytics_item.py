...
class AnalyticsItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20150501:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights:AnalyticsItem"), pulumi.Alias(type_="azure-native_applicationinsights_v20150501:applicationinsights:AnalyticsItem")])
