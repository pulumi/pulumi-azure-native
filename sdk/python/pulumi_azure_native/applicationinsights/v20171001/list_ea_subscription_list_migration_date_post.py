...
def list_ea_subscription_list_migration_date_post(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListEASubscriptionListMigrationDatePostResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20171001:listEASubscriptionListMigrationDatePost', __args__, opts=opts, typ=ListEASubscriptionListMigrationDatePostResult).value
...
def list_ea_subscription_list_migration_date_post_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListEASubscriptionListMigrationDatePostResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20171001:listEASubscriptionListMigrationDatePost', __args__, opts=opts, typ=ListEASubscriptionListMigrationDatePostResult)
