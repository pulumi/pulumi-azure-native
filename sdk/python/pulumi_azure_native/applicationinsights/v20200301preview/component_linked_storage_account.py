...
class ComponentLinkedStorageAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights:ComponentLinkedStorageAccount"), pulumi.Alias(type_="azure-native:insights/v20200301preview:ComponentLinkedStorageAccount"), pulumi.Alias(type_="azure-native:insights:ComponentLinkedStorageAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComponentLinkedStorageAccount, __self__).__init__(
            'azure-native:applicationinsights/v20200301preview:ComponentLinkedStorageAccount',
            resource_name,
            __props__,
            opts)
