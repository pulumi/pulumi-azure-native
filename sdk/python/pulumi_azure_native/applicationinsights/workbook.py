...
class Workbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210308:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210801:Workbook"), pulumi.Alias(type_="azure-native:insights/v20220401:Workbook"), pulumi.Alias(type_="azure-native:insights/v20230601:Workbook"), pulumi.Alias(type_="azure-native:insights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20150501:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20180617preview:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20201020:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20210308:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20210801:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20220401:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native_applicationinsights_v20230601:applicationinsights:Workbook")])
