...
class WorkbookArgs:
    def __init__(__self__, *,
                 ...
                 kind: Optional[pulumi.Input[Union[builtins.str, 'WorkbookSharedTypeKind']]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The user-defined name (display name) of the workbook.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] serialized_data: Configuration of this particular workbook. Configuration data is a string containing valid JSON
        :param pulumi.Input[builtins.str] description: The description of the workbook.
        :param pulumi.Input['WorkbookResourceIdentityArgs'] identity: Identity used for BYOS
        :param pulumi.Input[Union[builtins.str, 'WorkbookSharedTypeKind']] kind: The kind of workbook. Only valid value is shared.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] resource_name: The name of the workbook resource. The value must be an UUID.
        :param pulumi.Input[builtins.str] source_id: ResourceId for a source resource.
        :param pulumi.Input[builtins.str] storage_uri: The resourceId to the storage account when bring your own storage is used
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.str] version: Workbook schema version format, like 'Notebook/1.0', which should match the workbook in serializedData
        """
    ...
    @property
    @pulumi.getter
    def kind(self) -> Optional[pulumi.Input[Union[builtins.str, 'WorkbookSharedTypeKind']]]:
        """
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[builtins.str, 'WorkbookSharedTypeKind']]]):
...
class Workbook(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:applicationinsights:Workbook"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] resource_name_: The name of the workbook resource. The value must be an UUID.
        :param pulumi.Input[builtins.str] serialized_data: Configuration of this particular workbook. Configuration data is a string containing valid JSON
        :param pulumi.Input[builtins.str] source_id: ResourceId for a source resource.
        :param pulumi.Input[builtins.str] storage_uri: The resourceId to the storage account when bring your own storage is used
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
