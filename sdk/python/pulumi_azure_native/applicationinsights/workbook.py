...
class WorkbookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: Workbook schema version format, like 'Notebook/1.0', which should match the workbook in serializedData
        """
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['WorkbookResourceIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['WorkbookResourceIdentityArgs']]):
        pulumi.set(self, "identity", value)

    @_builtins.property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Optional[Union[_builtins.str, 'WorkbookSharedTypeKind']]]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Optional[Union[_builtins.str, 'WorkbookSharedTypeKind']]]):
...
class Workbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 identity: pulumi.Input[Optional[Union['WorkbookResourceIdentityArgs', 'WorkbookResourceIdentityArgsDict']]] = None,
                 kind: pulumi.Input[Optional[Union[_builtins.str, 'WorkbookSharedTypeKind']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] resource_name_: The name of the workbook resource. The value must be an UUID.
        :param pulumi.Input[_builtins.str] serialized_data: Configuration of this particular workbook. Configuration data is a string containing valid JSON
        :param pulumi.Input[_builtins.str] source_id: ResourceId for a source resource.
        :param pulumi.Input[_builtins.str] storage_uri: The resourceId to the storage account when bring your own storage is used
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Output[Optional['outputs.WorkbookResourceIdentityResponse']]:
        """
        Identity used for BYOS
        """
        return pulumi.get(self, "identity")
