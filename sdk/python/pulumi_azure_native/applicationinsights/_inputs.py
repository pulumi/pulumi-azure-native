...
class ApplicationInsightsComponentAnalyticsItemPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] function_alias: A function alias, used when the type of the item is Function
        """
...
class ApplicationInsightsComponentDataVolumeCapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] cap: Daily data volume cap in GB.
        :param pulumi.Input[_builtins.bool] stop_send_notification_when_hit_cap: Do not send a notification email when the daily data volume cap is met.
        :param pulumi.Input[_builtins.bool] stop_send_notification_when_hit_threshold: Reserved, not used for now.
        :param pulumi.Input[_builtins.int] warning_threshold: Reserved, not used for now.
        """
        if cap is not None:
...
class ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesRuleDefinitionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The rule name as it is displayed in UI
        :param pulumi.Input[_builtins.str] help_url: URL which displays additional info about the proactive detection rule
        :param pulumi.Input[_builtins.bool] is_enabled_by_default: A flag indicating whether the rule is enabled by default
        :param pulumi.Input[_builtins.bool] is_hidden: A flag indicating whether the rule is hidden (from the UI)
        :param pulumi.Input[_builtins.bool] is_in_preview: A flag indicating whether the rule is in preview
        :param pulumi.Input[_builtins.str] name: The rule name
        :param pulumi.Input[_builtins.bool] supports_email_notifications: A flag indicating whether email notifications are supported for detections for this rule
        """
...
class HeaderFieldArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] header_field_name: The name of the header.
        :param pulumi.Input[_builtins.str] header_field_value: The value of the header.
        """
...
class WebTestGeolocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location ID for the WebTest to run from.
        """
...
class WebTestPropertiesConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] web_test: The XML specification of a WebTest to run against an application.
        """
...
class WebTestPropertiesRequestArgsDict(TypedDict):
    ...
    """
    headers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['HeaderFieldArgs']]]]]
    """
...
class WebTestPropertiesRequestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] follow_redirects: Follow redirects for this web test.
        ...
        :param pulumi.Input[_builtins.str] http_verb: Http verb to use for this web test.
        :param pulumi.Input[_builtins.bool] parse_dependent_requests: Parse Dependent request for this WebTest.
        :param pulumi.Input[_builtins.str] request_body: Base64 encoded string body to send with this web test.
        :param pulumi.Input[_builtins.str] request_url: Url location to test.
        """
...
class WebTestPropertiesValidationRulesArgsDict(TypedDict):
    ...
    """
    content_validation: NotRequired[pulumi.Input[Optional['WebTestPropertiesContentValidationArgs']]]
    """
    The collection of content validation properties
    """
...
class WebTestPropertiesValidationRulesArgs:
    def __init__(__self__, *,
                 content_validation: pulumi.Input[Optional['WebTestPropertiesContentValidationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.bool] s_sl_check: Checks to see if the SSL cert is still valid.
        """
    ...
    def content_validation(self) -> pulumi.Input[Optional['WebTestPropertiesContentValidationArgs']]:
        """
        The collection of content validation properties
        """
    ...
    def content_validation(self, value: pulumi.Input[Optional['WebTestPropertiesContentValidationArgs']]):
...
class WorkbookTemplateGalleryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] order: Order of the template within the gallery.
        :param pulumi.Input[_builtins.str] resource_type: Azure resource type supported by the gallery.
        :param pulumi.Input[_builtins.str] type: Type of workbook supported by the workbook template.
        """
...
class WorkbookTemplateLocalizedGalleryArgsDict(TypedDict):
    ...
    """
    galleries: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['WorkbookTemplateGalleryArgs']]]]]
    """
    Workbook galleries supported by the template.
    """
    template_data: NotRequired[Optional[Any]]
    """
