...
class ComponentLinkedStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 linked_storage_account: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] linked_storage_account: Linked storage account resource ID
        :param pulumi.Input[builtins.str] storage_type: The type of the Application Insights component data source for the linked storage account.
        """
    ...
    def linked_storage_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def linked_storage_account(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComponentLinkedStorageAccount(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="linkedStorageAccount")
    def linked_storage_account(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Linked storage account resource ID
        """
        return pulumi.get(self, "linked_storage_account")
