...
class WebTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20201005preview:WebTest"), pulumi.Alias(type_="azure-native:insights/v20220615:WebTest"), pulumi.Alias(type_="azure-native:insights:WebTest"), pulumi.Alias(type_="azure-native_applicationinsights_v20150501:applicationinsights:WebTest"), pulumi.Alias(type_="azure-native_applicationinsights_v20180501preview:applicationinsights:WebTest"), pulumi.Alias(type_="azure-native_applicationinsights_v20201005preview:applicationinsights:WebTest"), pulumi.Alias(type_="azure-native_applicationinsights_v20220615:applicationinsights:WebTest")])
