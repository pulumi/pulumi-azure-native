...
class WebTestArgs:
    def __init__(__self__, *,
                 ...
                 synthetic_monitor_id: pulumi.Input[builtins.str],
                 ...
                 retry_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] synthetic_monitor_id: Unique ID of this WebTest. This is typically the same value as the Name field.
        ...
        :param pulumi.Input[builtins.str] description: User defined description for this WebTest.
        :param pulumi.Input[builtins.bool] enabled: Is the test actively being monitored.
        :param pulumi.Input[builtins.int] frequency: Interval in seconds between test runs for this WebTest. Default value is 300.
        ...
        :param pulumi.Input[builtins.bool] retry_enabled: Allow for retries should this WebTest fail.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags
        :param pulumi.Input[builtins.int] timeout: Seconds until this WebTest will timeout and fail. Default value is 30.
        :param pulumi.Input['WebTestPropertiesValidationRulesArgs'] validation_rules: The collection of validation rule properties
        :param pulumi.Input[builtins.str] web_test_name: User defined name if this WebTest.
        """
    ...
    def synthetic_monitor_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def synthetic_monitor_id(self, value: pulumi.Input[builtins.str]):
    ...
    def retry_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retry_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def web_test_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def web_test_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 retry_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 synthetic_monitor_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="retryEnabled")
    def retry_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allow for retries should this WebTest fail.
        """
        return pulumi.get(self, "retry_enabled")
    ...
    @property
    @pulumi.getter(name="syntheticMonitorId")
    def synthetic_monitor_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique ID of this WebTest. This is typically the same value as the Name field.
        """
        return pulumi.get(self, "synthetic_monitor_id")
    ...
    @property
    @pulumi.getter(name="webTestKind")
    def web_test_kind(self) -> pulumi.Output[builtins.str]:
        """
        The kind of web test this is, valid choices are ping, multistep and standard.
        """
        return pulumi.get(self, "web_test_kind")
    ...
    @property
    @pulumi.getter(name="webTestName")
    def web_test_name(self) -> pulumi.Output[builtins.str]:
        """
        User defined name if this WebTest.
        """
        return pulumi.get(self, "web_test_name")
