...
def get_live_token(resource_uri: Optional[str] = None,
    ...
    **Gets an access token for live metrics stream data.**
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20211014:getLiveToken', __args__, opts=opts, typ=GetLiveTokenResult).value
...
def get_live_token_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    **Gets an access token for live metrics stream data.**
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20211014:getLiveToken', __args__, opts=opts, typ=GetLiveTokenResult)
