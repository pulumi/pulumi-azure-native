...
def get_my_workbook(resource_group_name: Optional[_builtins.str] = None,
...
def get_my_workbook_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
