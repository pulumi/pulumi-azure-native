...
def get_workbook(can_fetch_content: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20230601:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
...
def get_workbook_output(can_fetch_content: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20230601:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult)
