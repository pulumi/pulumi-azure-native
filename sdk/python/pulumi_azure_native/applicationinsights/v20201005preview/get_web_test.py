...
def get_web_test(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20201005preview:getWebTest', __args__, opts=opts, typ=GetWebTestResult).value
...
def get_web_test_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20201005preview:getWebTest', __args__, opts=opts, typ=GetWebTestResult)
