...
class WebTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights/v20150501:WebTest"), pulumi.Alias(type_="azure-native:applicationinsights/v20180501preview:WebTest"), pulumi.Alias(type_="azure-native:applicationinsights/v20220615:WebTest"), pulumi.Alias(type_="azure-native:applicationinsights:WebTest"), pulumi.Alias(type_="azure-native:insights/v20201005preview:WebTest"), pulumi.Alias(type_="azure-native:insights/v20220615:WebTest"), pulumi.Alias(type_="azure-native:insights:WebTest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebTest, __self__).__init__(
            'azure-native:applicationinsights/v20201005preview:WebTest',
            resource_name,
            __props__,
            opts)
