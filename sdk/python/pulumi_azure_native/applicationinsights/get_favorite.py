...
def get_favorite(favorite_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str favorite_id: The Id of a specific favorite defined in the Application Insights component
...
def get_favorite_output(favorite_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
