...
def get_export_configuration(export_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20150501:getExportConfiguration', __args__, opts=opts, typ=GetExportConfigurationResult).value
...
def get_export_configuration_output(export_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20150501:getExportConfiguration', __args__, opts=opts, typ=GetExportConfigurationResult)
