...
class Favorite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights:Favorite"), pulumi.Alias(type_="azure-native:insights/v20150501:Favorite"), pulumi.Alias(type_="azure-native:insights:Favorite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Favorite, __self__).__init__(
            'azure-native:applicationinsights/v20150501:Favorite',
            resource_name,
            __props__,
            opts)
