...
def get_favorite(favorite_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20150501:getFavorite', __args__, opts=opts, typ=GetFavoriteResult).value
...
def get_favorite_output(favorite_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20150501:getFavorite', __args__, opts=opts, typ=GetFavoriteResult)
