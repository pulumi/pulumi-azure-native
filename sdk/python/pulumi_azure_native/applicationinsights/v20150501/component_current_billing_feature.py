...
class ComponentCurrentBillingFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] current_billing_features: Current enabled pricing plan. When the component is in the Enterprise plan, this will list both 'Basic' and 'Application Insights Enterprise'.
        :param pulumi.Input[Union['ApplicationInsightsComponentDataVolumeCapArgs', 'ApplicationInsightsComponentDataVolumeCapArgsDict']] data_volume_cap: An Application Insights component daily data volume cap
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights/v20150501:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights:ComponentCurrentBillingFeature")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComponentCurrentBillingFeature, __self__).__init__(
            'azure-native:applicationinsights/v20150501:ComponentCurrentBillingFeature',
            resource_name,
            __props__,
            opts)
