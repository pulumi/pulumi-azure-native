...
class AnalyticsItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights/v20150501:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights:AnalyticsItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AnalyticsItem, __self__).__init__(
            'azure-native:applicationinsights/v20150501:AnalyticsItem',
            resource_name,
            __props__,
            opts)
