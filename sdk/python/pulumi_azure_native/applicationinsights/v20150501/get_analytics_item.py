...
def get_analytics_item(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20150501:getAnalyticsItem', __args__, opts=opts, typ=GetAnalyticsItemResult).value
...
def get_analytics_item_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20150501:getAnalyticsItem', __args__, opts=opts, typ=GetAnalyticsItemResult)
