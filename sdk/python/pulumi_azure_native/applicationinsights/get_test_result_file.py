...
def get_test_result_file(continuation_token: Optional[_builtins.str] = None,
                         download_as: Optional[_builtins.str] = None,
                         geo_location_id: Optional[_builtins.str] = None,
                         resource_group_name: Optional[_builtins.str] = None,
                         test_successful_criteria: Optional[_builtins.bool] = None,
                         time_stamp: Optional[_builtins.int] = None,
                         web_test_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool test_successful_criteria: The success state criteria for the webtest result.
    :param _builtins.int time_stamp: The posix (epoch) time stamp for the webtest result.
    :param _builtins.str web_test_name: The name of the Application Insights webtest resource.
    """
    __args__ = dict()
