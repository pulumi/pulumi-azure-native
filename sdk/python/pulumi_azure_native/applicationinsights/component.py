...
class ComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] force_customer_storage_for_profiler: Force users to create their own storage account for profiler and debugger.
        :param pulumi.Input[_builtins.str] hockey_app_id: The unique application ID created when a new application is added to HockeyApp, used for communications with HockeyApp.
        :param pulumi.Input[_builtins.bool] immediate_purge_data_on30_days: Purge data immediately after 30 days.
        :param pulumi.Input[Union[_builtins.str, 'IngestionMode']] ingestion_mode: Indicates the flow of the ingestion.
        ...
        :param pulumi.Input[_builtins.str] workspace_resource_id: Resource Id of the log analytics workspace which the data will be ingested to. This property is required to create an application with this API version. Applications from older versions will not have this property.
        """
    ...
    def application_type(self, value: pulumi.Input[Union[_builtins.str, 'ApplicationType']]):
