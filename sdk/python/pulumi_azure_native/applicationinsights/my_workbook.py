...
class MyWorkbookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Azure resource type
        :param pulumi.Input[_builtins.str] version: This instance's version of the data model. This can change as new features are added that can be marked private workbook.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['MyWorkbookManagedIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['MyWorkbookManagedIdentityArgs']]):
...
class MyWorkbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 id: pulumi.Input[Optional[_builtins.str]] = None,
                 identity: pulumi.Input[Optional[Union['MyWorkbookManagedIdentityArgs', 'MyWorkbookManagedIdentityArgsDict']]] = None,
                 kind: pulumi.Input[Optional[Union[_builtins.str, 'Kind']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
