...
def get_test_result_file(continuation_token: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20200210preview:getTestResultFile', __args__, opts=opts, typ=GetTestResultFileResult).value
...
def get_test_result_file_output(continuation_token: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20200210preview:getTestResultFile', __args__, opts=opts, typ=GetTestResultFileResult)
