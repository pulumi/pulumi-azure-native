...
class GetComponentResult:
    ...
    def disable_ip_masking(self) -> Optional[builtins.bool]:
        """
        Disable IP masking.
        """
    ...
    def force_customer_storage_for_profiler(self) -> Optional[builtins.bool]:
        """
    ...
    def hockey_app_id(self) -> Optional[builtins.str]:
        """
    ...
    def hockey_app_token(self) -> builtins.str:
        """
    ...
    def ingestion_mode(self) -> Optional[builtins.str]:
        """
    ...
    def la_migration_date(self) -> builtins.str:
        """
    ...
    def request_source(self) -> Optional[builtins.str]:
        """
    ...
    def sampling_percentage(self) -> Optional[builtins.float]:
        """
...
def get_component(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights:getComponent', __args__, opts=opts, typ=GetComponentResult).value
...
def get_component_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights:getComponent', __args__, opts=opts, typ=GetComponentResult)
