...
class WorkbookTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:insights/v20201120:WorkbookTemplate"), pulumi.Alias(type_="azure-native:insights:WorkbookTemplate"), pulumi.Alias(type_="azure-native_applicationinsights_v20191017preview:applicationinsights:WorkbookTemplate"), pulumi.Alias(type_="azure-native_applicationinsights_v20201120:applicationinsights:WorkbookTemplate")])
