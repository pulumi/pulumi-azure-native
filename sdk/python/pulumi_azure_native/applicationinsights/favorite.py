...
class FavoriteArgs:
    def __init__(__self__, *,
                 ...
                 favorite_id: Optional[pulumi.Input[builtins.str]] = None,
                 favorite_type: Optional[pulumi.Input['FavoriteType']] = None,
                 is_generated_from_template: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] category: Favorite category, as defined by the user at creation time.
        :param pulumi.Input[builtins.str] config: Configuration of this particular favorite, which are driven by the Azure portal UX. Configuration data is a string containing valid JSON
        :param pulumi.Input[builtins.str] favorite_id: The Id of a specific favorite defined in the Application Insights component
        ...
        :param pulumi.Input[builtins.bool] is_generated_from_template: Flag denoting wether or not this favorite was generated from a template.
        :param pulumi.Input[builtins.str] name: The user-defined name of the favorite.
        :param pulumi.Input[builtins.str] source_type: The source of the favorite definition.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of 0 or more tags that are associated with this favorite definition
        :param pulumi.Input[builtins.str] version: This instance's version of the data model. This can change as new features are added that can be marked favorite. Current examples include MetricsExplorer (ME) and Search.
        """
    ...
    def favorite_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @favorite_id.setter
    def favorite_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_generated_from_template(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_generated_from_template(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Favorite(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="favoriteId")
    def favorite_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="favoriteType")
    def favorite_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enum indicating if this favorite definition is owned by a specific user or is shared between all users with access to the Application Insights component.
        """
        return pulumi.get(self, "favorite_type")
    ...
    @property
    @pulumi.getter(name="isGeneratedFromTemplate")
    def is_generated_from_template(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag denoting wether or not this favorite was generated from a template.
        """
        return pulumi.get(self, "is_generated_from_template")
