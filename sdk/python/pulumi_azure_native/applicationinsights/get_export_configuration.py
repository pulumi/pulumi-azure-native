...
def get_export_configuration(export_id: Optional[_builtins.str] = None,
...
def get_export_configuration_output(export_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
