...
class GetExportConfigurationResult:
    ...
    """
    def __init__(__self__, application_name=None, azure_api_version=None, container_name=None, destination_account_id=None, destination_storage_location_id=None, destination_storage_subscription_id=None, destination_type=None, export_id=None, export_status=None, instrumentation_key=None, is_user_enabled=None, last_gap_time=None, last_success_time=None, last_user_update=None, notification_queue_enabled=None, permanent_error_reason=None, record_types=None, resource_group=None, storage_name=None, subscription_id=None):
    ...
    def destination_account_id(self) -> builtins.str:
        """
    ...
    def destination_storage_location_id(self) -> builtins.str:
        """
    ...
    def destination_storage_subscription_id(self) -> builtins.str:
        """
    ...
    def is_user_enabled(self) -> builtins.str:
        """
    ...
    def last_gap_time(self) -> builtins.str:
        """
    ...
    def last_success_time(self) -> builtins.str:
        """
    ...
    def last_user_update(self) -> builtins.str:
        """
    ...
    def notification_queue_enabled(self) -> Optional[builtins.str]:
        """
        Deprecated
        """
    ...
    def permanent_error_reason(self) -> builtins.str:
        """
    ...
    def record_types(self) -> Optional[builtins.str]:
        """
...
def get_export_configuration(export_id: Optional[builtins.str] = None,
    ...
    :param builtins.str export_id: The Continuous Export configuration ID. This is unique within a Application Insights component.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights:getExportConfiguration', __args__, opts=opts, typ=GetExportConfigurationResult).value
...
def get_export_configuration_output(export_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights:getExportConfiguration', __args__, opts=opts, typ=GetExportConfigurationResult)
