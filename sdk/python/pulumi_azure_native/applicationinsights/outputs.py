...
class WorkbookResourceResponseIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: _builtins.str,
                 type: _builtins.str,
                 user_assigned_identities: Optional[Mapping[str, '_commontypesv3.outputs.UserAssignedIdentityResponse']] = None):
        """
        Identity used for BYOS
        ...
        :param Mapping[str, '_commontypesv3.UserAssignedIdentityResponse'] user_assigned_identities: The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
        pulumi.set(__self__, "type", type)
    ...
    @_builtins.property
    @pulumi.getter(name="userAssignedIdentities")
    def user_assigned_identities(self) -> Optional[Mapping[str, '_commontypesv3.outputs.UserAssignedIdentityResponse']]:
        """
