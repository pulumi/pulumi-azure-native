...
def get_workbook(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:applicationinsights/v20210308:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult).value
...
def get_workbook_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:applicationinsights/v20210308:getWorkbook', __args__, opts=opts, typ=GetWorkbookResult)
