...
class Workbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 id: Optional[pulumi.Input[str]] = None,
                 identity: Optional[pulumi.Input[Union['WorkbookManagedIdentityArgs', 'WorkbookManagedIdentityArgsDict']]] = None,
                 kind: Optional[pulumi.Input[Union[str, 'Kind']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] display_name: The user-defined name (display name) of the workbook.
        :param pulumi.Input[str] id: Azure resource Id
        :param pulumi.Input[Union['WorkbookManagedIdentityArgs', 'WorkbookManagedIdentityArgsDict']] identity: Identity used for BYOS
        :param pulumi.Input[Union[str, 'Kind']] kind: The kind of workbook. Choices are user and shared.
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[str] name: Azure resource name
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20180617preview:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20201020:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20210801:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20220401:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20230601:Workbook"), pulumi.Alias(type_="azure-native:applicationinsights:Workbook"), pulumi.Alias(type_="azure-native:insights/v20150501:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210308:Workbook"), pulumi.Alias(type_="azure-native:insights/v20210801:Workbook"), pulumi.Alias(type_="azure-native:insights/v20220401:Workbook"), pulumi.Alias(type_="azure-native:insights/v20230601:Workbook"), pulumi.Alias(type_="azure-native:insights:Workbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workbook, __self__).__init__(
            'azure-native:applicationinsights/v20210308:Workbook',
            resource_name,
            __props__,
            opts)
