...
class MyWorkbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:applicationinsights/v20150501:MyWorkbook"), pulumi.Alias(type_="azure-native:applicationinsights/v20201020:MyWorkbook"), pulumi.Alias(type_="azure-native:applicationinsights:MyWorkbook"), pulumi.Alias(type_="azure-native:insights/v20210308:MyWorkbook"), pulumi.Alias(type_="azure-native:insights:MyWorkbook")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MyWorkbook, __self__).__init__(
            'azure-native:applicationinsights/v20210308:MyWorkbook',
            resource_name,
            __props__,
            opts)
