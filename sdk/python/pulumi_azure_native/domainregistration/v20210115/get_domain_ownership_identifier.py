...
def get_domain_ownership_identifier(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_ownership_identifier is deprecated: azure-native:domainregistration/v20210115:DomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20220901:DomainOwnershipIdentifier to guarantee forwards compatibility.""")
    __args__ = dict()
