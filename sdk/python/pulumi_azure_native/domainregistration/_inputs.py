...
class AddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] postal_code: The postal code for the address.
        :param pulumi.Input[_builtins.str] state: The state or province for the address.
        :param pulumi.Input[_builtins.str] address2: The second line of the Address. Optional.
        """
...
class ContactArgsDict(TypedDict):
    ...
    Phone number.
    """
    address_mailing: NotRequired[pulumi.Input[Optional['AddressArgs']]]
    """
    Mailing address.
    """
...
class ContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fax: Fax number.
        :param pulumi.Input[_builtins.str] job_title: Job title.
        :param pulumi.Input[_builtins.str] name_middle: Middle name.
        :param pulumi.Input[_builtins.str] organization: Organization contact belongs to.
        """
