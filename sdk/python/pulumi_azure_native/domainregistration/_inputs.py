...
class AddressArgs:
    def __init__(__self__, *,
        ...
        """
        Address information for domain registration.
        :param pulumi.Input[builtins.str] address1: First line of an Address.
        :param pulumi.Input[builtins.str] city: The city for the address.
        :param pulumi.Input[builtins.str] country: The country for the address.
        :param pulumi.Input[builtins.str] postal_code: The postal code for the address.
        :param pulumi.Input[builtins.str] state: The state or province for the address.
        :param pulumi.Input[builtins.str] address2: The second line of the Address. Optional.
        """
...
if not MYPY:
    class ContactArgsDict(TypedDict):
        ...
        Email address.
        """
        name_first: pulumi.Input[builtins.str]
        """
        First name.
        """
        name_last: pulumi.Input[builtins.str]
        """
        Last name.
        """
        ...
        Job title.
        """
        name_middle: NotRequired[pulumi.Input[builtins.str]]
        """
        Middle name.
        """
...
class ContactArgs:
    def __init__(__self__, *,
                 ...
                 name_middle: Optional[pulumi.Input[builtins.str]] = None,
                 organization: Optional[pulumi.Input[builtins.str]] = None):
        """
        Contact information for domain registration. If 'Domain Privacy' option is not selected then the contact information is made publicly available through the Whois 
        directories as per ICANN requirements.
        :param pulumi.Input[builtins.str] email: Email address.
        :param pulumi.Input[builtins.str] name_first: First name.
        :param pulumi.Input[builtins.str] name_last: Last name.
        :param pulumi.Input[builtins.str] phone: Phone number.
        :param pulumi.Input['AddressArgs'] address_mailing: Mailing address.
        :param pulumi.Input[builtins.str] fax: Fax number.
        :param pulumi.Input[builtins.str] job_title: Job title.
        :param pulumi.Input[builtins.str] name_middle: Middle name.
        :param pulumi.Input[builtins.str] organization: Organization contact belongs to.
        """
    ...
    def name_first(self) -> pulumi.Input[builtins.str]:
        """
        First name.
        """
    ...
    @name_first.setter
    def name_first(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "name_first", value)

    @property
    @pulumi.getter(name="nameLast")
    def name_last(self) -> pulumi.Input[builtins.str]:
        """
        Last name.
        """
    ...
    @name_last.setter
    def name_last(self, value: pulumi.Input[builtins.str]):
    ...
    def name_middle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Middle name.
        """
    ...
    @name_middle.setter
    def name_middle(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainPurchaseConsentArgsDict(TypedDict):
        ...
        """
        agreed_at: NotRequired[pulumi.Input[builtins.str]]
        """
        Timestamp when the agreements were accepted.
        """
        agreed_by: NotRequired[pulumi.Input[builtins.str]]
        """
        Client IP address.
        """
        agreement_keys: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DomainPurchaseConsentArgs:
    def __init__(__self__, *,
                 agreed_at: Optional[pulumi.Input[builtins.str]] = None,
                 agreed_by: Optional[pulumi.Input[builtins.str]] = None,
                 agreement_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Domain purchase consent object, representing acceptance of applicable legal agreements.
        :param pulumi.Input[builtins.str] agreed_at: Timestamp when the agreements were accepted.
        :param pulumi.Input[builtins.str] agreed_by: Client IP address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] agreement_keys: List of applicable legal agreement keys. This list can be retrieved using ListLegalAgreements API under <code>TopLevelDomain</code> resource.
        """
    ...
    def agreed_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Timestamp when the agreements were accepted.
        """
    ...
    @agreed_at.setter
    def agreed_at(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agreed_at", value)

    @property
    @pulumi.getter(name="agreedBy")
    def agreed_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Client IP address.
        """
    ...
    @agreed_by.setter
    def agreed_by(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agreed_by", value)

    @property
    @pulumi.getter(name="agreementKeys")
    def agreement_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of applicable legal agreement keys. This list can be retrieved using ListLegalAgreements API under <code>TopLevelDomain</code> resource.
        """
    ...
    def agreement_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
