...
class DomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:domainregistration:DomainOwnershipIdentifier"), pulumi.Alias(type_="azure-native:domainregistration/v20201001:DomainOwnershipIdentifier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DomainOwnershipIdentifier, __self__).__init__(
            'azure-native:domainregistration/v20220901:DomainOwnershipIdentifier',
            resource_name,
            __props__,
            opts)
