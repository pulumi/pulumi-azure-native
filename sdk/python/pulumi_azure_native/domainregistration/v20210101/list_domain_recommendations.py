...
def list_domain_recommendations(keywords: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/v20210101:listDomainRecommendations', __args__, opts=opts, typ=ListDomainRecommendationsResult).value
...
def list_domain_recommendations_output(keywords: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['maxDomainRecommendations'] = max_domain_recommendations
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:domainregistration/v20210101:listDomainRecommendations', __args__, opts=opts, typ=ListDomainRecommendationsResult)
