...
class ContactArgs:
    ...
    def _configure(
        ...
        if name_first is None:
            raise TypeError("Missing 'name_first' argument")
        if name_last is None and 'nameLast' in kwargs:
            name_last = kwargs['nameLast']
        if name_last is None:
            raise TypeError("Missing 'name_last' argument")
        if phone is None:
            raise TypeError("Missing 'phone' argument")
        if address_mailing is None and 'addressMailing' in kwargs:
            address_mailing = kwargs['addressMailing']
        if job_title is None and 'jobTitle' in kwargs:
            job_title = kwargs['jobTitle']
        if name_middle is None and 'nameMiddle' in kwargs:
            name_middle = kwargs['nameMiddle']
...
class DomainPurchaseConsentArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if agreed_at is None and 'agreedAt' in kwargs:
            agreed_at = kwargs['agreedAt']
        if agreed_by is None and 'agreedBy' in kwargs:
            agreed_by = kwargs['agreedBy']
        if agreement_keys is None and 'agreementKeys' in kwargs:
            agreement_keys = kwargs['agreementKeys']
