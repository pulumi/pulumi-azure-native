...
azure-native:domainregistration/v20190801:DomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20201001:DomainOwnershipIdentifier to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:domainregistration/v20190801:DomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20201001:DomainOwnershipIdentifier to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DomainOwnershipIdentifier is deprecated: Version 2019-08-01 will be removed in v2 of the provider.
azure-native:domainregistration/v20190801:DomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20201001:DomainOwnershipIdentifier to guarantee forwards compatibility.""")
