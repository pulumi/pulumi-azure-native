...
def get_domain_ownership_identifier(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_ownership_identifier is deprecated: Version v20190801 will be removed in the next major version of the provider. Upgrade to version v20201001 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/v20190801:getDomainOwnershipIdentifier', __args__, opts=opts, typ=GetDomainOwnershipIdentifierResult).value
