...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: <code>true</code> if the domain should be automatically renewed; otherwise, <code>false</code>.
        :param pulumi.Input['DnsType'] dns_type: Current DNS type
        :param pulumi.Input[builtins.str] dns_zone_id: Azure DNS Zone to use
        ...
        :param pulumi.Input[builtins.bool] privacy: <code>true</code> if domain privacy is enabled for this domain; otherwise, <code>false</code>.
...
class Domain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authCode")
    def auth_code(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "auth_code")
    ...
    @property
    @pulumi.getter(name="dnsType")
    def dns_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Current DNS type
        """
        return pulumi.get(self, "dns_type")
    ...
    def domain_not_renewable_reasons(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def last_renewed_time(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def ready_for_dns_record_management(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def registration_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="targetDnsType")
    def target_dns_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Target DNS type (would be used for migration)
        """
        return pulumi.get(self, "target_dns_type")
