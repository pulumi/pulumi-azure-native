...
class HostNameResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_resource_name: Optional[builtins.str] = None,
                 azure_resource_type: Optional[builtins.str] = None,
                 custom_host_name_dns_record_type: Optional[builtins.str] = None,
                 host_name_type: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 site_names: Optional[Sequence[builtins.str]] = None):
        """
        Details of a hostname derived from a domain.
        :param builtins.str azure_resource_name: Name of the Azure resource the hostname is assigned to. If it is assigned to a Traffic Manager then it will be the Traffic Manager name otherwise it will be the app name.
        :param builtins.str azure_resource_type: Type of the Azure resource the hostname is assigned to.
        :param builtins.str custom_host_name_dns_record_type: Type of the DNS record.
        :param builtins.str host_name_type: Type of the hostname.
        :param builtins.str name: Name of the hostname.
        :param Sequence[builtins.str] site_names: List of apps the hostname is assigned to. This list will have more than one app only if the hostname is pointing to a Traffic Manager.
        """
    ...
    def site_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class TldLegalAgreementResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 agreement_key: builtins.str,
                 content: builtins.str,
                 title: builtins.str,
                 url: Optional[builtins.str] = None):
        """
        Legal agreement for a top level domain.
        :param builtins.str agreement_key: Unique identifier for the agreement.
        :param builtins.str content: Agreement details.
        :param builtins.str title: Agreement title.
        :param builtins.str url: URL where a copy of the agreement details is hosted.
        """
    ...
    def agreement_key(self) -> builtins.str:
        """
