...
class HostNameResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_resource_name: Optional[_builtins.str] = None,
                 azure_resource_type: Optional[_builtins.str] = None,
                 custom_host_name_dns_record_type: Optional[_builtins.str] = None,
                 host_name_type: Optional[_builtins.str] = None,
        ...
        :param _builtins.str host_name_type: Type of the hostname.
        :param _builtins.str name: Name of the hostname.
        :param Sequence[_builtins.str] site_names: List of apps the hostname is assigned to. This list will have more than one app only if the hostname is pointing to a Traffic Manager.
        """
...
class TldLegalAgreementResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str url: URL where a copy of the agreement details is hosted.
        """
