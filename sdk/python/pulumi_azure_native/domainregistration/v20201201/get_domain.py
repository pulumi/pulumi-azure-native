...
warnings.warn("""azure-native:domainregistration/v20201201:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain is deprecated: azure-native:domainregistration/v20201201:Domain is being removed in the next major version of this provider. Please upgrade to azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.""")
    __args__ = dict()
