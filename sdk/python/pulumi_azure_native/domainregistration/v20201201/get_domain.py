...
warnings.warn("""azure-native:domainregistration/v20201201:Domain is being removed in the next major version of this provider. Upgrade to at least azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain is deprecated: azure-native:domainregistration/v20201201:Domain is being removed in the next major version of this provider. Upgrade to at least azure-native:domainregistration/v20220901:Domain to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['domainName'] = domain_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/v20201201:getDomain', __args__, opts=opts, typ=GetDomainResult).value
