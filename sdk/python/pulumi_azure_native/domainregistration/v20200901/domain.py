...
warnings.warn("""Version v20200901 will be removed in the next major version of the provider. Upgrade to version v20201001 or later.""", DeprecationWarning)
...
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_dns_type: Optional[pulumi.Input['DnsType']] = None,
                 __props__=None):
        pulumi.log.warn("""Domain is deprecated: Version v20200901 will be removed in the next major version of the provider. Upgrade to version v20201001 or later.""")
        if opts is None:
