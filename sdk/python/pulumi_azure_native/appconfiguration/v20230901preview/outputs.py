...
__all__ = [
    ...
    'ExperimentationPropertiesResponse',
...
@pulumi.output_type
class ExperimentationPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if key == "dataPlaneEndpoint":
            suggest = "data_plane_endpoint"
        elif key == "resourceId":
            suggest = "resource_id"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ExperimentationPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ExperimentationPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 data_plane_endpoint: Optional[str] = None,
                 resource_id: Optional[str] = None):
        """
        Experimentation settings
        :param str data_plane_endpoint: The data plane endpoint of the Split experimentation workspace resource where experimentation data can be retrieved
        :param str resource_id: Resource ID of a resource enabling experimentation
        """
    ...
    def data_plane_endpoint(self) -> Optional[str]:
        """
...
@pulumi.output_type
class TelemetryPropertiesResponse(dict):
    """
    Telemetry settings
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TelemetryPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TelemetryPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Telemetry settings
        :param str resource_id: Resource ID of a resource enabling telemetry collection
        """
        if resource_id is not None:
            pulumi.set(__self__, "resource_id", resource_id)
