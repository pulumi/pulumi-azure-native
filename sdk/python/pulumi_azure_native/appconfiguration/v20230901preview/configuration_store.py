...
class ConfigurationStoreArgs:
    def __init__(__self__, *,
                 ...
                 experimentation: Optional[pulumi.Input['ExperimentationPropertiesArgs']] = None,
                 identity: Optional[pulumi.Input['ResourceIdentityArgs']] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 public_network_access: Optional[pulumi.Input[Union[str, 'PublicNetworkAccess']]] = None,
                 soft_delete_retention_in_days: Optional[pulumi.Input[int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 telemetry: Optional[pulumi.Input['TelemetryPropertiesArgs']] = None):
        """
        ...
        :param pulumi.Input['ExperimentationPropertiesArgs'] experimentation: Property specifying the configuration of experimentation for this configuration store
        ...
        :param pulumi.Input['TelemetryPropertiesArgs'] telemetry: Property specifying the configuration of telemetry for this configuration store
        """
        ...
        if experimentation is not None:
    ...
    @property
    @pulumi.getter
    def experimentation(self) -> Optional[pulumi.Input['ExperimentationPropertiesArgs']]:
        """
    ...
    @experimentation.setter
    def experimentation(self, value: Optional[pulumi.Input['ExperimentationPropertiesArgs']]):
        pulumi.set(self, "experimentation", value)
    ...
    @property
    @pulumi.getter
    def telemetry(self) -> Optional[pulumi.Input['TelemetryPropertiesArgs']]:
        """
    ...
    @telemetry.setter
    def telemetry(self, value: Optional[pulumi.Input['TelemetryPropertiesArgs']]):
...
class ConfigurationStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 experimentation: Optional[pulumi.Input[Union['ExperimentationPropertiesArgs', 'ExperimentationPropertiesArgsDict']]] = None,
                 ...
                 soft_delete_retention_in_days: Optional[pulumi.Input[int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 telemetry: Optional[pulumi.Input[Union['TelemetryPropertiesArgs', 'TelemetryPropertiesArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ExperimentationPropertiesArgs', 'ExperimentationPropertiesArgsDict']] experimentation: Property specifying the configuration of experimentation for this configuration store
        ...
        :param pulumi.Input[int] soft_delete_retention_in_days: The amount of time in days that the configuration store will be retained when it is soft deleted.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[Union['TelemetryPropertiesArgs', 'TelemetryPropertiesArgsDict']] telemetry: Property specifying the configuration of telemetry for this configuration store
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["experimentation"] = experimentation
        ...
        super(ConfigurationStore, __self__).__init__(
            'azure-native:appconfiguration/v20230901preview:ConfigurationStore',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["endpoint"] = None
        __props__.__dict__["experimentation"] = None
    ...
    @property
    @pulumi.getter
    def experimentation(self) -> pulumi.Output[Optional['outputs.ExperimentationPropertiesResponse']]:
        """
        Property specifying the configuration of experimentation for this configuration store
        """
        return pulumi.get(self, "experimentation")
    ...
    @property
    @pulumi.getter
    def telemetry(self) -> pulumi.Output[Optional['outputs.TelemetryPropertiesResponse']]:
        """
        Property specifying the configuration of telemetry for this configuration store
        """
        return pulumi.get(self, "telemetry")
