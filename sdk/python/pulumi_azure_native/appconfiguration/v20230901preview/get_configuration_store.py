...
class GetConfigurationStoreResult:
    ...
    def __init__(__self__, creation_date=None, data_plane_proxy=None, disable_local_auth=None, enable_purge_protection=None, encryption=None, endpoint=None, experimentation=None, id=None, identity=None, location=None, name=None, private_endpoint_connections=None, provisioning_state=None, public_network_access=None, sku=None, soft_delete_retention_in_days=None, system_data=None, tags=None, telemetry=None, type=None):
        ...
        if experimentation and not isinstance(experimentation, dict):
            raise TypeError("Expected argument 'experimentation' to be a dict")
        pulumi.set(__self__, "experimentation", experimentation)
    ...
    @property
    @pulumi.getter
    def experimentation(self) -> Optional['outputs.ExperimentationPropertiesResponse']:
        """
        Property specifying the configuration of experimentation for this configuration store
        """
        return pulumi.get(self, "experimentation")
    ...
    @property
    @pulumi.getter
    def telemetry(self) -> Optional['outputs.TelemetryPropertiesResponse']:
        """
...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20230901preview:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
    ...
    return AwaitableGetConfigurationStoreResult(
        ...
        experimentation=pulumi.get(__ret__, 'experimentation'),
...
def get_configuration_store_output(config_store_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:appconfiguration/v20230901preview:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult)
    return __ret__.apply(lambda __response__: GetConfigurationStoreResult(
        ...
        experimentation=pulumi.get(__response__, 'experimentation'),
