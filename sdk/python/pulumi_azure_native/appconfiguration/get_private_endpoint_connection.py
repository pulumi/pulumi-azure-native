...
def get_private_endpoint_connection(config_store_name: Optional[builtins.str] = None,
...
def get_private_endpoint_connection_output(config_store_name: Optional[pulumi.Input[builtins.str]] = None,
