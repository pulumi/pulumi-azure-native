...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.appconfiguration.v20200601.PrivateEndpointConnection("privateEndpointConnection",
            config_store_name="contoso",
            private_endpoint_connection_name="myConnection",
            private_link_service_connection_state=azure_native.appconfiguration.v20200601.PrivateLinkServiceConnectionStateArgs(
