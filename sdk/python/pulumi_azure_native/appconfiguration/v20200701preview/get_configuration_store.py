...
warnings.warn("""azure-native:appconfiguration/v20200701preview:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_store is deprecated: azure-native:appconfiguration/v20200701preview:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['configStoreName'] = config_store_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20200701preview:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
