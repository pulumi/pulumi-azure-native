...
warnings.warn("""azure-native:appconfiguration/v20220301preview:Replica is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:Replica to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_replica(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replica is deprecated: azure-native:appconfiguration/v20220301preview:Replica is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:Replica to guarantee forwards compatibility.""")
    __args__ = dict()
