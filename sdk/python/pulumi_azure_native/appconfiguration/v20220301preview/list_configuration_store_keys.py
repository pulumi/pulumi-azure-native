...
def list_configuration_store_keys(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20220301preview:listConfigurationStoreKeys', __args__, opts=opts, typ=ListConfigurationStoreKeysResult).value
...
def list_configuration_store_keys_output(config_store_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:appconfiguration/v20220301preview:listConfigurationStoreKeys', __args__, opts=opts, typ=ListConfigurationStoreKeysResult)
