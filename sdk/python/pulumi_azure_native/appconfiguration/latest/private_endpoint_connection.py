...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appconfiguration:PrivateEndpointConnection'.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appconfiguration:PrivateEndpointConnection'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appconfiguration/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:appconfiguration:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:appconfiguration:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:appconfiguration/v20191101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:appconfiguration/v20191101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:appconfiguration/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:appconfiguration/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:appconfiguration/v20200701preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:appconfiguration/v20200701preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:appconfiguration/latest:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
