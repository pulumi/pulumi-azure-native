...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appconfiguration:listConfigurationStoreKeys'.""", DeprecationWarning)
...
def list_configuration_store_keys(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/latest:listConfigurationStoreKeys', __args__, opts=opts, typ=ListConfigurationStoreKeysResult).value
