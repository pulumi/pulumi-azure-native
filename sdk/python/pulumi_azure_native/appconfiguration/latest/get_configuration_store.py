...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appconfiguration:getConfigurationStore'.""", DeprecationWarning)
...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/latest:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
