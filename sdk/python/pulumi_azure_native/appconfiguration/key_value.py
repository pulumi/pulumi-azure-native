...
class KeyValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:appconfiguration/v20230301:KeyValue"), pulumi.Alias(type_="azure-native:appconfiguration/v20230801preview:KeyValue"), pulumi.Alias(type_="azure-native:appconfiguration/v20230901preview:KeyValue"), pulumi.Alias(type_="azure-native:appconfiguration/v20240501:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20200701preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20210301preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20211001preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20220301preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20220501:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20230301:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20230801preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20230901preview:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native_appconfiguration_v20240501:appconfiguration:KeyValue")])
