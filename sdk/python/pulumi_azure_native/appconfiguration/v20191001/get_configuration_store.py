...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_store is deprecated: Version v20191001 will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20191001:getConfigurationStore', __args__, opts=opts, typ=GetConfigurationStoreResult).value
