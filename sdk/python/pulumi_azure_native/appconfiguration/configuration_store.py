...
class ConfigurationStoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_purge_protection: Property specifying whether protection against purge is enabled for this configuration store.
