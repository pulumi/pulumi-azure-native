...
warnings.warn("""azure-native:appconfiguration/v20220501:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConfigurationStore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ConfigurationStore is deprecated: azure-native:appconfiguration/v20220501:ConfigurationStore is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.""")
        ...
        super(ConfigurationStore, __self__).__init__(
            'azure-native:appconfiguration/v20220501:ConfigurationStore',
            resource_name,
            __props__,
            opts)
