...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_store is deprecated: azure-native:appconfiguration/v20220501:ConfigurationStore is being removed in the next major version of this provider. Please upgrade to azure-native:appconfiguration/v20230301:ConfigurationStore to guarantee forwards compatibility.""")
    __args__ = dict()
