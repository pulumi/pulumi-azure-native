...
def get_key_value(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key_value is deprecated: azure-native:appconfiguration/v20220501:KeyValue is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['configStoreName'] = config_store_name
    __args__['keyValueName'] = key_value_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20220501:getKeyValue', __args__, opts=opts, typ=GetKeyValueResult).value
