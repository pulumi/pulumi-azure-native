...
warnings.warn("""azure-native:appconfiguration/v20211001preview:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:appconfiguration/v20230301:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:appconfiguration/v20211001preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
