...
def get_configuration_store(config_store_name: Optional[_builtins.str] = None,
...
def get_configuration_store_output(config_store_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
