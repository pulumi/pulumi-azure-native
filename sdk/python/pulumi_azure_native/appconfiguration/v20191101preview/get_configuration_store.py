...
def get_configuration_store(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration_store is deprecated: Version v20191101preview will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
