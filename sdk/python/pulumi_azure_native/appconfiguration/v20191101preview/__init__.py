...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:appconfiguration/v20191101preview:ConfigurationStore":
                return ConfigurationStore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appconfiguration/v20191101preview:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "appconfiguration/v20191101preview", _module_instance)
