...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:appconfiguration/v20190201preview:ConfigurationStore":
    ...
    pulumi.runtime.register_resource_module("azure-native", "appconfiguration/v20190201preview", _module_instance)
