...
warnings.warn("""azure-native:appconfiguration/v20210301preview:KeyValue is being removed in the next major version of this provider. Please upgrade to azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_key_value(config_store_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key_value is deprecated: azure-native:appconfiguration/v20210301preview:KeyValue is being removed in the next major version of this provider. Please upgrade to azure-native:appconfiguration/v20230301:KeyValue to guarantee forwards compatibility.""")
    __args__ = dict()
