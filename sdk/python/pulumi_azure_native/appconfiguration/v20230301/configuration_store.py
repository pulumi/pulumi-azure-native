...
class ConfigurationStore(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        configuration_store = azure_native.appconfiguration.v20230301.ConfigurationStore("configurationStore",
            config_store_name="contoso",
            location="westus",
            resource_group_name="myResourceGroup",
            sku=azure_native.appconfiguration.v20230301.SkuArgs(
                name="Standard",
            ),
            tags={
                "myTag": "myTagValue",
        ...
        configuration_store = azure_native.appconfiguration.v20230301.ConfigurationStore("configurationStore",
            config_store_name="contoso",
            identity=azure_native.appconfiguration.v20230301.ResourceIdentityArgs(
