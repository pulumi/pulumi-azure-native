...
class DatasetPropertyKeyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Key that can be used for joining on enrich.
        :param builtins.str path: Path to the input value from the message.
        :param builtins.bool primary_key: If true the property will be used as a primary key. At most one primary key can exists.
        """
...
class PipelineInputResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 next: Sequence[builtins.str],
                 type: builtins.str,
                 description: Optional[builtins.str] = None):
        """
        Stage configuration for Pipeline input stage.
        :param Sequence[builtins.str] next: Next stage in the pipeline.
        :param builtins.str type: ARM resource type.
        :param builtins.str description: Description for stage.
        """
    ...
    @property
    @pulumi.getter
    def next(self) -> Sequence[builtins.str]:
        """
...
class PipelineStageResponse(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 description: Optional[builtins.str] = None,
                 next: Optional[Sequence[builtins.str]] = None):
        """
        Stage configurations for all Pipeline processing and output stages.
        :param builtins.str type: ARM resource type.
        :param builtins.str description: Description for stage.
        :param Sequence[builtins.str] next: Next stage in the pipeline. Not required if output stage.
        """
        pulumi.set(__self__, "type", type)
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter
    def next(self) -> Optional[Sequence[builtins.str]]:
        """
