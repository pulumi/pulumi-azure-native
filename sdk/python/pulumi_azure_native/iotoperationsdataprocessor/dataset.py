...
class DatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataset_name: Name of dataset.
        :param pulumi.Input[builtins.str] description: Detailed description of the Dataset.
        ...
        :param pulumi.Input[builtins.str] payload: Path to the payload in the message. Enrich will add only the payload to the enriched message, other fields will not be kept except for in the indexes.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.str] timestamp: Path to an RFC3339 timestamp in the message. If no path is provided, the ingestion time of the record is used for time-based joins.
        :param pulumi.Input[builtins.str] ttl: Time to live for individual records.
        """
...
class Dataset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 keys: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union['DatasetPropertyKeyArgs', 'DatasetPropertyKeyArgsDict']]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 payload: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_name: Name of instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['DatasetPropertyKeyArgs', 'DatasetPropertyKeyArgsDict']]]] keys: List of keys that can be used for joining on enrich.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] payload: Path to the payload in the message. Enrich will add only the payload to the enriched message, other fields will not be kept except for in the indexes.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
    ...
    @property
    @pulumi.getter
    def timestamp(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Path to an RFC3339 timestamp in the message. If no path is provided, the ingestion time of the record is used for time-based joins.
        """
        return pulumi.get(self, "timestamp")
