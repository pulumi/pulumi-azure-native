...
def get_pipeline(instance_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_name: Name of pipeline
...
def get_pipeline_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
