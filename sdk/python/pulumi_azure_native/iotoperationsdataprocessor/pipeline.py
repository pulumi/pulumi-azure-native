...
class PipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Flag indicating whether the pipeline should be running or not.
        ...
        :param pulumi.Input[builtins.str] description: Detailed description of the Pipeline.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] pipeline_name: Name of pipeline
