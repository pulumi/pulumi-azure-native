...
class Dataset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsdataprocessor:Dataset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dataset, __self__).__init__(
            'azure-native:iotoperationsdataprocessor/v20231004preview:Dataset',
            resource_name,
            __props__,
            opts)
