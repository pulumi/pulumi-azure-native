...
def get_remediation_at_management_group(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_remediation_at_management_group is deprecated: Version v20180701preview will be removed in the next major version of the provider. Upgrade to version v20190701 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20180701preview:getRemediationAtManagementGroup', __args__, opts=opts, typ=GetRemediationAtManagementGroupResult).value
