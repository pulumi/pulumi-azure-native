...
def list_remediation_deployments_at_management_group(management_group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20180701preview:listRemediationDeploymentsAtManagementGroup', __args__, opts=opts, typ=ListRemediationDeploymentsAtManagementGroupResult).value
