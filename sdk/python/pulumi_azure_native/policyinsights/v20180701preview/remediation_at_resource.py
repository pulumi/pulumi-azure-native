...
class RemediationAtResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        remediation_at_resource = azure_native.policyinsights.v20180701preview.RemediationAtResource("remediationAtResource",
    ...
    def _internal_init(__self__,
                 ...
                 resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RemediationAtResource is deprecated: Version 2018-07-01-preview will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtResource")])
