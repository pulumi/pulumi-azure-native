...
def get_remediation_at_subscription(remediation_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_remediation_at_subscription is deprecated: Version v20180701preview will be removed in the next major version of the provider. Upgrade to version v20190701 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20180701preview:getRemediationAtSubscription', __args__, opts=opts, typ=GetRemediationAtSubscriptionResult).value
