...
class RemediationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""RemediationAtResource is deprecated: Version 2019-07-01 will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtResource, __self__).__init__(
            'azure-native:policyinsights/v20190701:RemediationAtResource',
            resource_name,
            __props__,
            opts)
