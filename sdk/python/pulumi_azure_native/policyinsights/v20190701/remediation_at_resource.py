...
class RemediationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/v20190701:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20180701preview:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20211001:RemediationAtResource")])
