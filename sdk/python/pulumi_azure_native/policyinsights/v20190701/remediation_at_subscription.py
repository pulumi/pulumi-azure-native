...
class RemediationAtSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        remediation_at_subscription = azure_native.policyinsights.v20190701.RemediationAtSubscription("remediationAtSubscription",
        ...
        remediation_at_subscription = azure_native.policyinsights.v20190701.RemediationAtSubscription("remediationAtSubscription",
            filters=azure_native.policyinsights.v20190701.RemediationFiltersArgs(
                locations=[
                    "eastus",
                    "westus",
                ],
