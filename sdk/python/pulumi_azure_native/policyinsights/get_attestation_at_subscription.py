...
def get_attestation_at_subscription(attestation_name: Optional[_builtins.str] = None,
...
def get_attestation_at_subscription_output(attestation_name: pulumi.Input[Optional[_builtins.str]] = None,
