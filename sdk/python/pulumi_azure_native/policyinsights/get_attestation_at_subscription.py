...
def get_attestation_at_subscription(attestation_name: Optional[builtins.str] = None,
...
def get_attestation_at_subscription_output(attestation_name: Optional[pulumi.Input[builtins.str]] = None,
