...
def get_attestation_at_resource_group(attestation_name: Optional[_builtins.str] = None,
...
def get_attestation_at_resource_group_output(attestation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
