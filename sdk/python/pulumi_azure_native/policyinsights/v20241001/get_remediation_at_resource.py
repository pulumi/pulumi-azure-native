...
def get_remediation_at_resource(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20241001:getRemediationAtResource', __args__, opts=opts, typ=GetRemediationAtResourceResult).value
...
def get_remediation_at_resource_output(remediation_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceId'] = resource_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:policyinsights/v20241001:getRemediationAtResource', __args__, opts=opts, typ=GetRemediationAtResourceResult)
