...
class RemediationAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights:RemediationAtManagementGroup")])
