...
def get_attestation_at_resource_group(attestation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20241001:getAttestationAtResourceGroup', __args__, opts=opts, typ=GetAttestationAtResourceGroupResult).value
