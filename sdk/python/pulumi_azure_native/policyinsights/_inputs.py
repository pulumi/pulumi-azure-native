...
class AttestationEvidenceArgs:
    def __init__(__self__, *,
        ...
        """
        A piece of evidence supporting the compliance state set in the attestation.
        :param pulumi.Input[_builtins.str] description: The description for this piece of evidence.
        :param pulumi.Input[_builtins.str] source_uri: The URI location of the evidence.
        """
...
class RemediationFiltersArgs:
    def __init__(__self__, *,
        ...
        """
        The filters that will be applied to determine which resources to remediate.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] locations: The resource locations that will be remediated.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resource_ids: The IDs of the resources that will be remediated. Can specify at most 100 IDs. This filter cannot be used when ReEvaluateCompliance is set to ReEvaluateCompliance, and cannot be empty if provided.
        """
...
class RemediationPropertiesFailureThresholdArgs:
    def __init__(__self__, *,
        ...
        """
        The remediation failure threshold settings
        :param pulumi.Input[_builtins.float] percentage: A number between 0.0 to 1.0 representing the percentage failure threshold. The remediation will fail if the percentage of failed remediation operations (i.e. failed deployments) exceeds this threshold.
        """
