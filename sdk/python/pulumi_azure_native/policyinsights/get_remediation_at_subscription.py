...
def get_remediation_at_subscription(remediation_name: Optional[_builtins.str] = None,
...
def get_remediation_at_subscription_output(remediation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
