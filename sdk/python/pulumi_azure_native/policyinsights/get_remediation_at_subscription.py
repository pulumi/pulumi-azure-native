...
def get_remediation_at_subscription(remediation_name: Optional[builtins.str] = None,
...
def get_remediation_at_subscription_output(remediation_name: Optional[pulumi.Input[builtins.str]] = None,
