...
class RemediationDeploymentResponse(dict):
    ...
    def _configure(
        ...
        if 'lastUpdatedOn' in kwargs:
            last_updated_on = kwargs['lastUpdatedOn']
        if 'remediatedResourceId' in kwargs:
