...
class RemediationDeploymentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_updated_on: The time at which the remediation deployment was last updated.
        :param _builtins.str remediated_resource_id: Resource ID of the resource that is being remediated by the deployment.
        :param _builtins.str resource_location: Location of the resource that is being remediated.
        :param _builtins.str status: Status of the remediation deployment.
        """
