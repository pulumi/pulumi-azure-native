...
class AttestationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20241001:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights:AttestationAtResource")])
