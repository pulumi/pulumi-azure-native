...
class AttestationAtResourceArgs:
    def __init__(__self__, *,
        ...
        """
        AttestationAtResourceArgs._configure(
    ...
    def _configure(
        ...
        if assessment_date is None and 'assessmentDate' in kwargs:
            assessment_date = kwargs['assessmentDate']
        if attestation_name is None and 'attestationName' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AttestationAtResourceArgs._configure(_setter, **kwargs)
