...
class AttestationAtSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        attestation_at_subscription = azure_native.policyinsights.v20220901.AttestationAtSubscription("attestationAtSubscription",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttestationAtSubscription, __self__).__init__(
            'azure-native:policyinsights/v20220901:AttestationAtSubscription',
            resource_name,
            __props__,
            opts)
