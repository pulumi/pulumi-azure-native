...
class RemediationAtResourceArgs:
    def __init__(__self__, *,
                 ...
                 parallel_deployments: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 resource_count: Optional[pulumi.Input[builtins.int]] = None,
                 resource_discovery_mode: Optional[pulumi.Input[Union[builtins.str, 'ResourceDiscoveryMode']]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] parallel_deployments: Determines how many resources to remediate at any given time. Can be used to increase or reduce the pace of the remediation. If not provided, the default parallel deployments value is used.
        :param pulumi.Input[builtins.str] policy_assignment_id: The resource ID of the policy assignment that should be remediated.
        :param pulumi.Input[builtins.str] policy_definition_reference_id: The policy definition reference ID of the individual definition that should be remediated. Required when the policy assignment being remediated assigns a policy set definition.
        :param pulumi.Input[builtins.str] remediation_name: The name of the remediation.
        :param pulumi.Input[builtins.int] resource_count: Determines the max number of resources that can be remediated by the remediation job. If not provided, the default resource count is used.
        :param pulumi.Input[Union[builtins.str, 'ResourceDiscoveryMode']] resource_discovery_mode: The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified.
        """
    ...
    def parallel_deployments(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def parallel_deployments(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "parallel_deployments", value)

    @property
    @pulumi.getter(name="policyAssignmentId")
    def policy_assignment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_assignment_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def remediation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remediation_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remediation_name", value)

    @property
    @pulumi.getter(name="resourceCount")
    def resource_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def resource_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "resource_count", value)

    @property
    @pulumi.getter(name="resourceDiscoveryMode")
    def resource_discovery_mode(self) -> Optional[pulumi.Input[Union[builtins.str, 'ResourceDiscoveryMode']]]:
        """
    ...
    def resource_discovery_mode(self, value: Optional[pulumi.Input[Union[builtins.str, 'ResourceDiscoveryMode']]]):
        pulumi.set(self, "resource_discovery_mode", value)


@pulumi.type_token("azure-native:policyinsights:RemediationAtResource")
class RemediationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20241001:RemediationAtResource")])
    ...
    def last_updated_on(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="parallelDeployments")
    def parallel_deployments(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Determines how many resources to remediate at any given time. Can be used to increase or reduce the pace of the remediation. If not provided, the default parallel deployments value is used.
        """
        return pulumi.get(self, "parallel_deployments")
    ...
    @property
    @pulumi.getter(name="policyAssignmentId")
    def policy_assignment_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of the policy assignment that should be remediated.
        """
        return pulumi.get(self, "policy_assignment_id")
    ...
    @property
    @pulumi.getter(name="policyDefinitionReferenceId")
    def policy_definition_reference_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The policy definition reference ID of the individual definition that should be remediated. Required when the policy assignment being remediated assigns a policy set definition.
        """
        return pulumi.get(self, "policy_definition_reference_id")
    ...
    @property
    @pulumi.getter(name="resourceCount")
    def resource_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Determines the max number of resources that can be remediated by the remediation job. If not provided, the default resource count is used.
        """
        return pulumi.get(self, "resource_count")
    ...
    @property
    @pulumi.getter(name="resourceDiscoveryMode")
    def resource_discovery_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The way resources to remediate are discovered. Defaults to ExistingNonCompliant if not specified.
        """
        return pulumi.get(self, "resource_discovery_mode")
