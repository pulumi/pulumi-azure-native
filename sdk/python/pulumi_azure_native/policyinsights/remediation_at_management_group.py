...
class RemediationAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20211001:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20241001:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native_policyinsights_v20180701preview:policyinsights:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native_policyinsights_v20190701:policyinsights:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native_policyinsights_v20211001:policyinsights:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native_policyinsights_v20241001:policyinsights:RemediationAtManagementGroup")])
