...
class RemediationAtManagementGroup(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/latest:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20180701preview:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20190701:RemediationAtManagementGroup")])
