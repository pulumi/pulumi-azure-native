...
def get_remediation_at_resource_group(remediation_name: Optional[builtins.str] = None,
...
def get_remediation_at_resource_group_output(remediation_name: Optional[pulumi.Input[builtins.str]] = None,
