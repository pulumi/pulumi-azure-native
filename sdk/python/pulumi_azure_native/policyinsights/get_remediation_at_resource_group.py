...
def get_remediation_at_resource_group(remediation_name: Optional[_builtins.str] = None,
...
def get_remediation_at_resource_group_output(remediation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:policyinsights:getRemediationAtResourceGroup', __args__, opts=opts, typ=GetRemediationAtResourceGroupResult)
