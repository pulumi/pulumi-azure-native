...
def get_attestation_at_resource(attestation_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights:getAttestationAtResource', __args__, opts=opts, typ=GetAttestationAtResourceResult).value
...
def get_attestation_at_resource_output(attestation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:policyinsights:getAttestationAtResource', __args__, opts=opts, typ=GetAttestationAtResourceResult)
    return __ret__.apply(lambda __response__: GetAttestationAtResourceResult(
