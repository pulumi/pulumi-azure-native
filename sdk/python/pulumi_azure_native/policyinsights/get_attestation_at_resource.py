...
def get_attestation_at_resource(attestation_name: Optional[builtins.str] = None,
...
def get_attestation_at_resource_output(attestation_name: Optional[pulumi.Input[builtins.str]] = None,
