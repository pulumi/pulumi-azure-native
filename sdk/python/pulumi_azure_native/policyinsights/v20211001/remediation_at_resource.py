...
class RemediationAtResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        remediation_at_resource = azure_native.policyinsights.v20211001.RemediationAtResource("remediationAtResource",
        ...
        ```sh
        $ pulumi import azure-native:policyinsights/v20211001:RemediationAtResource storageRemediation /subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourcegroups/myResourceGroup/providers/microsoft.storage/storageaccounts/storAc1/providers/microsoft.policyinsights/remediations/storageRemediation 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtResource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtResource, __self__).__init__(
            'azure-native:policyinsights/v20211001:RemediationAtResource',
            resource_name,
            __props__,
            opts)
