...
def get_remediation_at_resource_group(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20211001:getRemediationAtResourceGroup', __args__, opts=opts, typ=GetRemediationAtResourceGroupResult).value
...
def get_remediation_at_resource_group_output(remediation_name: Optional[pulumi.Input[str]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemediationAtResourceGroupResult]:
    """
    Gets an existing remediation at resource group scope.
