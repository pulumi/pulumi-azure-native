...
def get_remediation_at_resource(remediation_name: Optional[_builtins.str] = None,
...
def get_remediation_at_resource_output(remediation_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
