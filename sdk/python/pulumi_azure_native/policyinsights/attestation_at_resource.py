...
class AttestationAtResourceArgs:
    def __init__(__self__, *,
                 ...
                 assessment_date: Optional[pulumi.Input[builtins.str]] = None,
                 attestation_name: Optional[pulumi.Input[builtins.str]] = None,
                 comments: Optional[pulumi.Input[builtins.str]] = None,
                 compliance_state: Optional[pulumi.Input[Union[builtins.str, 'ComplianceState']]] = None,
        ...
        :param pulumi.Input[builtins.str] policy_assignment_id: The resource ID of the policy assignment that the attestation is setting the state for.
        :param pulumi.Input[builtins.str] resource_id: Resource ID.
        :param pulumi.Input[builtins.str] assessment_date: The time the evidence was assessed
        :param pulumi.Input[builtins.str] attestation_name: The name of the attestation.
        :param pulumi.Input[builtins.str] comments: Comments describing why this attestation was created.
        :param pulumi.Input[Union[builtins.str, 'ComplianceState']] compliance_state: The compliance state that should be set on the resource.
        ...
        :param pulumi.Input[builtins.str] expires_on: The time the compliance state should expire.
        :param Any metadata: Additional metadata for this attestation
        :param pulumi.Input[builtins.str] owner: The person responsible for setting the state of the resource. This value is typically an Azure Active Directory object ID.
        :param pulumi.Input[builtins.str] policy_definition_reference_id: The policy definition reference ID from a policy set definition that the attestation is setting the state for. If the policy assignment assigns a policy set definition the attestation can choose a definition within the set definition with this property or omit this and set the state for the entire set definition.
        """
    ...
    def assessment_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assessment_date(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assessment_date", value)

    @property
    @pulumi.getter(name="attestationName")
    def attestation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attestation_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def compliance_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'ComplianceState']]]:
        """
    ...
    def compliance_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'ComplianceState']]]):
...
@pulumi.type_token("azure-native:policyinsights:AttestationAtResource")
class AttestationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20220901:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20241001:AttestationAtResource")])
    ...
    @property
    @pulumi.getter(name="assessmentDate")
    def assessment_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time the evidence was assessed
        """
        return pulumi.get(self, "assessment_date")
    ...
    @property
    @pulumi.getter(name="complianceState")
    def compliance_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compliance state that should be set on the resource.
        """
        return pulumi.get(self, "compliance_state")
    ...
    def last_compliance_state_change_at(self) -> pulumi.Output[builtins.str]:
        """
