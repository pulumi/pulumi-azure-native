...
class AttestationAtResource(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/latest:AttestationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtResource"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20210101:AttestationAtResource")])
