...
class AttestationAtResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights/v20220901:AttestationAtResource"), pulumi.Alias(type_="azure-native:policyinsights/v20241001:AttestationAtResource"), pulumi.Alias(type_="azure-native_policyinsights_v20210101:policyinsights:AttestationAtResource"), pulumi.Alias(type_="azure-native_policyinsights_v20220901:policyinsights:AttestationAtResource"), pulumi.Alias(type_="azure-native_policyinsights_v20241001:policyinsights:AttestationAtResource")])
