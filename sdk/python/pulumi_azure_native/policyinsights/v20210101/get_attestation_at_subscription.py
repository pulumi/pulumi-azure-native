...
def get_attestation_at_subscription(attestation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20210101:getAttestationAtSubscription', __args__, opts=opts, typ=GetAttestationAtSubscriptionResult).value
...
def get_attestation_at_subscription_output(attestation_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:policyinsights/v20210101:getAttestationAtSubscription', __args__, opts=opts, typ=GetAttestationAtSubscriptionResult)
