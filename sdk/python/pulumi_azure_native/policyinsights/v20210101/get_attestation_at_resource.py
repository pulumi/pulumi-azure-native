...
def get_attestation_at_resource_output(attestation_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:policyinsights/v20210101:getAttestationAtResource', __args__, opts=opts, typ=GetAttestationAtResourceResult)
