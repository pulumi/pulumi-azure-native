...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:policyinsights/v20210101:AttestationAtResource":
                return AttestationAtResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:policyinsights/v20210101:AttestationAtResourceGroup":
                return AttestationAtResourceGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:policyinsights/v20210101:AttestationAtSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-native", "policyinsights/v20210101", _module_instance)
