...
class AttestationAtResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        attestation_at_resource = azure_native.policyinsights.v20210101.AttestationAtResource("attestationAtResource",
