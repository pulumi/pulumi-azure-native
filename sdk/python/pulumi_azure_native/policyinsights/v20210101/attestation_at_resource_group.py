...
class AttestationAtResourceGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:policyinsights:AttestationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20220901:AttestationAtResourceGroup")])
