...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getRemediationAtResource'.""", DeprecationWarning)
...
def get_remediation_at_resource(remediation_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_remediation_at_resource is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getRemediationAtResource'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/latest:getRemediationAtResource', __args__, opts=opts, typ=GetRemediationAtResourceResult).value
