...
class HybridUseBenefit(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hybrid_use_benefit = azure_native.softwareplan.v20190601preview.HybridUseBenefit("hybridUseBenefit",
            ...
            sku=azure_native.softwareplan.v20190601preview.SkuArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:softwareplan:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan/v20191201:HybridUseBenefit")])
