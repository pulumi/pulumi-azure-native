...
class HybridUseBenefitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: The scope at which the operation is performed. This is limited to Microsoft.Compute/virtualMachines and Microsoft.Compute/hostGroups/hosts for now
        :param pulumi.Input['SkuArgs'] sku: Hybrid use benefit SKU
        :param pulumi.Input[builtins.str] plan_id: This is a unique identifier for a plan. Should be a guid.
        """
...
class HybridUseBenefit(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def etag(self) -> pulumi.Output[builtins.int]:
        """
