...
class DatabaseThreatDetectionPolicyArgs:
    ...
    def _configure(
        ...
        if use_server_default is None and 'useServerDefault' in kwargs:
            use_server_default = kwargs['useServerDefault']
        ...
        if use_server_default is not None:
            _setter("use_server_default", use_server_default)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DatabaseThreatDetectionPolicyArgs._configure(_setter, **kwargs)
