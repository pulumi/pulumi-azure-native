...
class TransparentDataEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 tde_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TransparentDataEncryption resource.
        :param pulumi.Input[builtins.str] database_name: The name of the logical database for which the security alert policy is defined.
        ...
        :param pulumi.Input[builtins.str] tde_name: The name of the transparent data encryption configuration.
        """
    ...
    def tde_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tde_name.setter
    def tde_name(self, value: Optional[pulumi.Input[builtins.str]]):
