...
class TransparentDataEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_name: The name of the logical database for which the security alert policy is defined.
        ...
        :param pulumi.Input[_builtins.str] tde_name: The name of the transparent data encryption configuration.
        """
