...
class DatabaseBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_blob_auditing_policy = azure_native.sql.v20201101preview.DatabaseBlobAuditingPolicy("databaseBlobAuditingPolicy",
