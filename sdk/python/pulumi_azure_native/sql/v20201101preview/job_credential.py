...
class JobCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:JobCredential"), pulumi.Alias(type_="azure-native:sql:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20170301preview:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20200202preview:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20200801preview:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20210201preview:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20210501preview:JobCredential"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:JobCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobCredential, __self__).__init__(
            'azure-native:sql/v20201101preview:JobCredential',
            resource_name,
            __props__,
            opts)
