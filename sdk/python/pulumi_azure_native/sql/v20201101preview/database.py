...
warnings.warn("""azure-native:sql/v20201101preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""Database is deprecated: azure-native:sql/v20201101preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.""")
