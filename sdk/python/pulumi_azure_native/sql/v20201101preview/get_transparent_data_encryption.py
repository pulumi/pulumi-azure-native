...
def get_transparent_data_encryption(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transparent_data_encryption is deprecated: azure-native:sql/v20201101preview:TransparentDataEncryption is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.""")
    __args__ = dict()
