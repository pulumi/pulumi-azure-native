...
class JobTargetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        job_target_group = azure_native.sql.v20201101preview.JobTargetGroup("jobTargetGroup",
            job_agent_name="agent1",
            members=[
                azure_native.sql.v20201101preview.JobTargetArgs(
                    database_name="database1",
                    membership_type=azure_native.sql/v20201101preview.JobTargetGroupMembershipType.EXCLUDE,
                    server_name="server1",
                    type="SqlDatabase",
                ),
                azure_native.sql.v20201101preview.JobTargetArgs(
                    membership_type=azure_native.sql/v20201101preview.JobTargetGroupMembershipType.INCLUDE,
