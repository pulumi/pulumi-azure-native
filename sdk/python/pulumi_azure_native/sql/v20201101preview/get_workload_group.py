...
def get_workload_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_group is deprecated: azure-native:sql/v20201101preview:WorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:WorkloadGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20201101preview:getWorkloadGroup', __args__, opts=opts, typ=GetWorkloadGroupResult).value
