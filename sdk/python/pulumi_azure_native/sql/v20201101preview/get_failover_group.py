...
warnings.warn("""azure-native:sql/v20201101preview:FailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:FailoverGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_failover_group(failover_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_failover_group is deprecated: azure-native:sql/v20201101preview:FailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:FailoverGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['failoverGroupName'] = failover_group_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20201101preview:getFailoverGroup', __args__, opts=opts, typ=GetFailoverGroupResult).value
