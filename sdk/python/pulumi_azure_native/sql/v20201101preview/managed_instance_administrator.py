...
warnings.warn("""azure-native:sql/v20201101preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstanceAdministrator is deprecated: azure-native:sql/v20201101preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""")
