...
warnings.warn("""azure-native:sql/v20201101preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_member(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_member is deprecated: azure-native:sql/v20201101preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncMember to guarantee forwards compatibility.""")
    __args__ = dict()
