...
warnings.warn("""azure-native:sql/v20201101preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.""", DeprecationWarning)
...
class TransparentDataEncryption(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tde_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TransparentDataEncryption is deprecated: azure-native:sql/v20201101preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.""")
