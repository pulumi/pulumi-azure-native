...
class ExtendedServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ExtendedServerBlobAuditingPolicy is deprecated: azure-native:sql/v20201101preview:ExtendedServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedServerBlobAuditingPolicy to guarantee forwards compatibility.""")
