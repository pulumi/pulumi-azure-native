...
class FailoverGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        failover_group = azure_native.sql.v20201101preview.FailoverGroup("failoverGroup",
            databases=[
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/failover-group-primary-server/databases/testdb-1",
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/failover-group-primary-server/databases/testdb-2",
            ],
            failover_group_name="failover-group-test-3",
            partner_servers=[azure_native.sql.v20201101preview.PartnerInfoArgs(
                id="/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/failover-group-secondary-server",
            )],
            read_only_endpoint=azure_native.sql.v20201101preview.FailoverGroupReadOnlyEndpointArgs(
                failover_policy="Disabled",
            ),
            read_write_endpoint=azure_native.sql.v20201101preview.FailoverGroupReadWriteEndpointArgs(
        ...
        ```sh
        $ pulumi import azure-native:sql/v20201101preview:FailoverGroup failover-group-test-3 /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/failover-group-primary-server/failoverGroups/failover-group-test-3 
        ```
