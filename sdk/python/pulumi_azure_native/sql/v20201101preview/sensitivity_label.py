...
class SensitivityLabel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sensitivity_label = azure_native.sql.v20201101preview.SensitivityLabel("sensitivityLabel",
