...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_security_alert_policy = azure_native.sql.v20201101preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy",
            disabled_alerts=[
                "Access_Anomaly",
                "Usage_Anomaly",
            ],
        ...
        ```sh
        $ pulumi import azure-native:sql/v20201101preview:ServerSecurityAlertPolicy Default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securityalert-4799/providers/Microsoft.Sql/servers/securityalert-6440/securityAlertPolicies/default 
        ```
