...
class InstanceFailoverGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        instance_failover_group = azure_native.sql.v20201101preview.InstanceFailoverGroup("instanceFailoverGroup",
            failover_group_name="failover-group-test-3",
            location_name="Japan East",
            managed_instance_pairs=[azure_native.sql.v20201101preview.ManagedInstancePairInfoArgs(
            ...
            partner_regions=[azure_native.sql.v20201101preview.PartnerRegionInfoArgs(
                location="Japan West",
            )],
            read_only_endpoint=azure_native.sql.v20201101preview.InstanceFailoverGroupReadOnlyEndpointArgs(
                failover_policy="Disabled",
            ),
            read_write_endpoint=azure_native.sql.v20201101preview.InstanceFailoverGroupReadWriteEndpointArgs(
