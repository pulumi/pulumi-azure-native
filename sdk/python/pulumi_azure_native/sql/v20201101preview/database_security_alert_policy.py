...
class DatabaseSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20140401:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20180601preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20180601preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210501preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:DatabaseSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseSecurityAlertPolicy, __self__).__init__(
            'azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy',
            resource_name,
            __props__,
            opts)
