...
warnings.warn("""azure-native:sql/v20201101preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_instance_pool(instance_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_instance_pool is deprecated: azure-native:sql/v20201101preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['instancePoolName'] = instance_pool_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20201101preview:getInstancePool', __args__, opts=opts, typ=GetInstancePoolResult).value
