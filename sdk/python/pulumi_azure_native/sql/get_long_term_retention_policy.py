...
def get_long_term_retention_policy(database_name: Optional[builtins.str] = None,
...
def get_long_term_retention_policy_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
