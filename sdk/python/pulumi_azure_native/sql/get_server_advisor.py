...
def get_server_advisor(advisor_name: Optional[builtins.str] = None,
    ...
    :param builtins.str advisor_name: The name of the Server Advisor.
...
def get_server_advisor_output(advisor_name: Optional[pulumi.Input[builtins.str]] = None,
