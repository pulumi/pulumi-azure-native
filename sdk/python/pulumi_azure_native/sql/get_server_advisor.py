...
def get_server_advisor(advisor_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str advisor_name: The name of the Server Advisor.
...
def get_server_advisor_output(advisor_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql:getServerAdvisor', __args__, opts=opts, typ=GetServerAdvisorResult)
