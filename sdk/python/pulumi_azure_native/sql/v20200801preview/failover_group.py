...
warnings.warn("""azure-native:sql/v20200801preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class FailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""FailoverGroup is deprecated: azure-native:sql/v20200801preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.""")
