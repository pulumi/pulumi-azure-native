...
warnings.warn("""azure-native:sql/v20200801preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_agent(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_agent is deprecated: azure-native:sql/v20200801preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.""")
    __args__ = dict()
