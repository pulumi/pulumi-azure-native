...
warnings.warn("""azure-native:sql/v20200801preview:JobAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.""", DeprecationWarning)
