...
warnings.warn("""azure-native:sql/v20200801preview:ServerAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerAdvisor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerAdvisor is deprecated: azure-native:sql/v20200801preview:ServerAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.""")
