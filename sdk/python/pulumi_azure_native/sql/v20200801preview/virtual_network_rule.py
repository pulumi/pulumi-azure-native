...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20150501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20150501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20200202preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20201101preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20210201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20210501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:VirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRule, __self__).__init__(
            'azure-native:sql/v20200801preview:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
