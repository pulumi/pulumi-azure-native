...
warnings.warn("""azure-native:sql/v20200801preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedDatabaseSensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 table_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedDatabaseSensitivityLabel is deprecated: azure-native:sql/v20200801preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.""")
