...
def get_encryption_protector(encryption_protector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_protector is deprecated: azure-native:sql/v20200801preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:EncryptionProtector to guarantee forwards compatibility.""")
    __args__ = dict()
