...
def get_encryption_protector(encryption_protector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_protector is deprecated: azure-native:sql/v20200801preview:EncryptionProtector is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['encryptionProtectorName'] = encryption_protector_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20200801preview:getEncryptionProtector', __args__, opts=opts, typ=GetEncryptionProtectorResult).value
