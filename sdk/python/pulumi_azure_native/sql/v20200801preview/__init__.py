...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:sql/v20200801preview:BackupShortTermRetentionPolicy":
                return BackupShortTermRetentionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:DatabaseBlobAuditingPolicy":
                return DatabaseBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy":
                return DatabaseSecurityAlertPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:DatabaseVulnerabilityAssessment":
                return DatabaseVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:DatabaseVulnerabilityAssessmentRuleBaseline":
                return DatabaseVulnerabilityAssessmentRuleBaseline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ElasticPool":
                return ElasticPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy":
                return ExtendedDatabaseBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ExtendedServerBlobAuditingPolicy":
                return ExtendedServerBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:FailoverGroup":
                return FailoverGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:InstanceFailoverGroup":
                return InstanceFailoverGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:InstancePool":
                return InstancePool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:JobAgent":
                return JobAgent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:JobCredential":
                return JobCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:JobStep":
                return JobStep(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:JobTargetGroup":
                return JobTargetGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:LongTermRetentionPolicy":
                return LongTermRetentionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedDatabase":
                return ManagedDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedDatabaseSensitivityLabel":
                return ManagedDatabaseSensitivityLabel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedDatabaseVulnerabilityAssessment":
                return ManagedDatabaseVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedDatabaseVulnerabilityAssessmentRuleBaseline":
                return ManagedDatabaseVulnerabilityAssessmentRuleBaseline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstance":
                return ManagedInstance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstanceAdministrator":
                return ManagedInstanceAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstanceAzureADOnlyAuthentication":
                return ManagedInstanceAzureADOnlyAuthentication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstanceKey":
                return ManagedInstanceKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstancePrivateEndpointConnection":
                return ManagedInstancePrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ManagedInstanceVulnerabilityAssessment":
                return ManagedInstanceVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:SensitivityLabel":
                return SensitivityLabel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerAzureADAdministrator":
                return ServerAzureADAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerAzureADOnlyAuthentication":
                return ServerAzureADOnlyAuthentication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerBlobAuditingPolicy":
                return ServerBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerDnsAlias":
                return ServerDnsAlias(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerKey":
                return ServerKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerSecurityAlertPolicy":
                return ServerSecurityAlertPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerTrustGroup":
                return ServerTrustGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:ServerVulnerabilityAssessment":
                return ServerVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:SyncAgent":
                return SyncAgent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:SyncGroup":
                return SyncGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:SyncMember":
                return SyncMember(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:TransparentDataEncryption":
                return TransparentDataEncryption(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:VirtualNetworkRule":
                return VirtualNetworkRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:WorkloadClassifier":
                return WorkloadClassifier(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200801preview:WorkloadGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "sql/v20200801preview", _module_instance)
