...
def get_job_target_group(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_target_group is deprecated: azure-native:sql/v20200801preview:JobTargetGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobTargetGroup to guarantee forwards compatibility.""")
    __args__ = dict()
