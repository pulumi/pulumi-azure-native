...
def get_extended_server_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_extended_server_blob_auditing_policy is deprecated: azure-native:sql/v20200801preview:ExtendedServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedServerBlobAuditingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
