...
warnings.warn("""azure-native:sql/v20200801preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 start_ip_address: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""FirewallRule is deprecated: azure-native:sql/v20200801preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.""")
