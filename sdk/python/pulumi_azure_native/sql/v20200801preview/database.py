...
class DatabaseArgs:
    ...
    def _configure(
        ...
        if 'autoPauseDelay' in kwargs:
            auto_pause_delay = kwargs['autoPauseDelay']
        if 'catalogCollation' in kwargs:
