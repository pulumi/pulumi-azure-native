...
def get_workload_classifier(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_classifier is deprecated: azure-native:sql/v20200801preview:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20200801preview:getWorkloadClassifier', __args__, opts=opts, typ=GetWorkloadClassifierResult).value
