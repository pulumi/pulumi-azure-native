...
class ManagedInstancePrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ManagedInstancePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstancePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstancePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ManagedInstancePrivateEndpointConnection")])
