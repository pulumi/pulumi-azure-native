...
warnings.warn("""azure-native:sql/v20200801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerDnsAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerDnsAlias is deprecated: azure-native:sql/v20200801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""")
