...
class ManagedServerDnsAliasArgs:
    def __init__(__self__, *,
                 ...
                 create_dns_record: Optional[pulumi.Input[builtins.bool]] = None,
                 dns_alias_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] create_dns_record: Whether or not DNS record should be created for this alias.
        """
    ...
    def create_dns_record(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_dns_record(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "create_dns_record", value)

    @property
    @pulumi.getter(name="dnsAliasName")
    def dns_alias_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dns_alias_name")

    @dns_alias_name.setter
    def dns_alias_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedServerDnsAlias(pulumi.CustomResource):
    ...
    def azure_dns_record(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def public_azure_dns_record(self) -> pulumi.Output[builtins.str]:
        """
