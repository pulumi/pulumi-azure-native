...
class ManagedInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(administrators, ManagedInstanceExternalAdministratorArgs):
            ...
            if not isinstance(service_principal, ServicePrincipalArgs):
                service_principal = service_principal or {}
                def _setter(key, value):
                    service_principal[key] = value
                ServicePrincipalArgs._configure(_setter, **service_principal)
