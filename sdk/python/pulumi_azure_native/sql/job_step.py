...
class JobStepArgs:
    def __init__(__self__, *,
                 ...
                 target_group: pulumi.Input[builtins.str],
                 ...
                 step_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] target_group: The resource ID of the target group that the job step will be executed on.
        :param pulumi.Input[builtins.str] credential: The resource ID of the job credential that will be used to connect to the targets.
        ...
        :param pulumi.Input[builtins.int] step_id: The job step's index within the job. If not specified when creating the job step, it will be created as the last step. If not specified when updating the job step, the step id is not modified.
        :param pulumi.Input[builtins.str] step_name: The name of the job step.
        """
    ...
    def target_group(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @target_group.setter
    def target_group(self, value: pulumi.Input[builtins.str]):
    ...
    def step_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @step_id.setter
    def step_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class JobStep(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 step_id: Optional[pulumi.Input[builtins.int]] = None,
                 step_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_group: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        A job step.
    ...
    @property
    @pulumi.getter(name="stepId")
    def step_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The job step's index within the job. If not specified when creating the job step, it will be created as the last step. If not specified when updating the job step, the step id is not modified.
        """
        return pulumi.get(self, "step_id")
    ...
    @property
    @pulumi.getter(name="targetGroup")
    def target_group(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the target group that the job step will be executed on.
        """
        return pulumi.get(self, "target_group")
