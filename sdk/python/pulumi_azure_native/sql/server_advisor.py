...
class ServerAdvisorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] advisor_name: The name of the Server Advisor.
        """
