...
class JobCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The credential password.
        ...
        :param pulumi.Input[builtins.str] username: The credential user name.
        :param pulumi.Input[builtins.str] credential_name: The name of the credential.
        """
