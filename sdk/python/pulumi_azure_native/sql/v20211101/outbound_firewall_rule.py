...
class OutboundFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20210201preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20210501preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20210801preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220201preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220501preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220801preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20221101preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230201preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230501preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230801:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230801preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql/v20240501preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql:OutboundFirewallRule")])
