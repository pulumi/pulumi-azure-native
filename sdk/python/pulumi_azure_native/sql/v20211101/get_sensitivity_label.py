...
warnings.warn("""azure-native:sql/v20211101:SensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SensitivityLabel to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sensitivity_label(column_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sensitivity_label is deprecated: azure-native:sql/v20211101:SensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SensitivityLabel to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101:getSensitivityLabel', __args__, opts=opts, typ=GetSensitivityLabelResult).value
