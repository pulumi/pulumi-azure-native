...
class WorkloadGroupArgs:
    ...
    def _configure(
        ...
        if 'queryExecutionTimeout' in kwargs:
            query_execution_timeout = kwargs['queryExecutionTimeout']
        if 'workloadGroupName' in kwargs:
