...
warnings.warn("""azure-native:sql/v20211101:WorkloadGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadGroup is deprecated: azure-native:sql/v20211101:WorkloadGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.""")
