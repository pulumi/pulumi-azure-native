...
class DistributedAvailabilityGroupArgs:
    ...
    def _configure(
        ...
        if 'distributedAvailabilityGroupName' in kwargs:
            distributed_availability_group_name = kwargs['distributedAvailabilityGroupName']
        if 'primaryAvailabilityGroupName' in kwargs:
        ...
        if 'secondaryAvailabilityGroupName' in kwargs:
