...
class FailoverGroupArgs:
    ...
    def _configure(
             ...
             partner_servers: Optional[pulumi.Input[Sequence[pulumi.Input['PartnerInfoArgs']]]] = None,
             read_write_endpoint: Optional[pulumi.Input['FailoverGroupReadWriteEndpointArgs']] = None,
...
class FailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            read_only_endpoint = _utilities.configure(read_only_endpoint, FailoverGroupReadOnlyEndpointArgs, True)
            __props__.__dict__["read_only_endpoint"] = read_only_endpoint
            read_write_endpoint = _utilities.configure(read_write_endpoint, FailoverGroupReadWriteEndpointArgs, True)
