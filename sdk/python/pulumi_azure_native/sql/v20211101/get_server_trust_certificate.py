...
warnings.warn("""azure-native:sql/v20211101:ServerTrustCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_trust_certificate(certificate_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_trust_certificate is deprecated: azure-native:sql/v20211101:ServerTrustCertificate is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility.""")
    __args__ = dict()
