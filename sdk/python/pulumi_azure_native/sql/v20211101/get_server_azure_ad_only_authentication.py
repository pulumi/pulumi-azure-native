...
def get_server_azure_ad_only_authentication(authentication_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_azure_ad_only_authentication is deprecated: azure-native:sql/v20211101:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.""")
    __args__ = dict()
