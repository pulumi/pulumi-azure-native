...
warnings.warn("""azure-native:sql/v20211101:ServerAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_advisor(advisor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_advisor is deprecated: azure-native:sql/v20211101:ServerAdvisor is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAdvisor to guarantee forwards compatibility.""")
    __args__ = dict()
