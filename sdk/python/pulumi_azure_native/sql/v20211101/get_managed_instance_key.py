...
def get_managed_instance_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance_key is deprecated: azure-native:sql/v20211101:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceKey to guarantee forwards compatibility.""")
    __args__ = dict()
