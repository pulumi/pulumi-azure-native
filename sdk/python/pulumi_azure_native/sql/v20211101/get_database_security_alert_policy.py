...
warnings.warn("""azure-native:sql/v20211101:DatabaseSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database_security_alert_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_security_alert_policy is deprecated: azure-native:sql/v20211101:DatabaseSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
