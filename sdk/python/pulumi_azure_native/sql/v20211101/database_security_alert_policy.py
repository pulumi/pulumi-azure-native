...
class DatabaseSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20140401:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20140401:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql/v20180601preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210501preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220201preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220501preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20230201preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20230501preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20230801preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20240501preview:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql:DatabaseSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql:DatabaseThreatDetectionPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseSecurityAlertPolicy, __self__).__init__(
            'azure-native:sql/v20211101:DatabaseSecurityAlertPolicy',
            resource_name,
            __props__,
            opts)
