...
class ServerTrustCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20210501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20221101preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20230201preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20230501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20230801:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20230801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20240501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql:ServerTrustCertificate")])
