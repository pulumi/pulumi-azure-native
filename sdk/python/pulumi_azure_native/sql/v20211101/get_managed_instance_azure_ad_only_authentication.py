...
warnings.warn("""azure-native:sql/v20211101:ManagedInstanceAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceAzureADOnlyAuthentication to guarantee forwards compatibility.""", DeprecationWarning)
