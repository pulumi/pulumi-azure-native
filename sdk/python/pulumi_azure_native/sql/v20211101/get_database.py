...
warnings.warn("""azure-native:sql/v20211101:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: azure-native:sql/v20211101:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['databaseName'] = database_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
