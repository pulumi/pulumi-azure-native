...
class SyncAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20150501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20200202preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20200801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20201101preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20210201preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20210501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20210801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20211101preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20220201preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20220501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20220801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20221101preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20230201preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20230501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20230801:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20230801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20240501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql:SyncAgent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SyncAgent, __self__).__init__(
            'azure-native:sql/v20211101:SyncAgent',
            resource_name,
            __props__,
            opts)
