...
warnings.warn("""azure-native:sql/v20211101:JobAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.""", DeprecationWarning)
...
class JobAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""JobAgent is deprecated: azure-native:sql/v20211101:JobAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.""")
