...
def get_long_term_retention_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_long_term_retention_policy is deprecated: azure-native:sql/v20211101:LongTermRetentionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:LongTermRetentionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
