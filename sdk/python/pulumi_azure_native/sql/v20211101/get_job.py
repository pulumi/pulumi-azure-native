...
warnings.warn("""azure-native:sql/v20211101:Job is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:sql/v20211101:Job is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Job to guarantee forwards compatibility.""")
    __args__ = dict()
