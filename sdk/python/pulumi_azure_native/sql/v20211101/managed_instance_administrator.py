...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstanceAdministrator is deprecated: azure-native:sql/v20211101:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""")
