...
def get_workload_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_group is deprecated: azure-native:sql/v20211101:WorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.""")
    __args__ = dict()
