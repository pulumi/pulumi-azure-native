...
class ServerTrustGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 trust_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerTrustGroup is deprecated: azure-native:sql/v20211101:ServerTrustGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.""")
