...
def get_server(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:sql/v20211101:Server is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101:getServer', __args__, opts=opts, typ=GetServerResult).value
