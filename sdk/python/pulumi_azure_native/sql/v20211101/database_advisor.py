...
class DatabaseAdvisorArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if auto_execute_status is None and 'autoExecuteStatus' in kwargs:
            auto_execute_status = kwargs['autoExecuteStatus']
        if auto_execute_status is None:
            raise TypeError("Missing 'auto_execute_status' argument")
