...
class GeoBackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] geo_backup_policy_name: The name of the Geo backup policy. This should always be 'Default'.
        """
    ...
    def geo_backup_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def geo_backup_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
