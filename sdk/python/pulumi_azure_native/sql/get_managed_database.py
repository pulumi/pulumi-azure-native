...
def get_managed_database(database_name: Optional[_builtins.str] = None,
...
def get_managed_database_output(database_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
