...
class InstanceFailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(read_only_endpoint, InstanceFailoverGroupReadOnlyEndpointArgs):
            ...
            if not isinstance(read_write_endpoint, InstanceFailoverGroupReadWriteEndpointArgs):
