...
class IPv6FirewallRuleArgs:
    def __init__(__self__, *,
                 ...
                 end_i_pv6_address: Optional[pulumi.Input[builtins.str]] = None,
                 firewall_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 start_i_pv6_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] end_i_pv6_address: The end IP address of the firewall rule. Must be IPv6 format. Must be greater than or equal to startIpv6Address.
        :param pulumi.Input[builtins.str] firewall_rule_name: The name of the firewall rule.
        :param pulumi.Input[builtins.str] name: Resource name.
        :param pulumi.Input[builtins.str] start_i_pv6_address: The start IP address of the firewall rule. Must be IPv6 format.
        """
    ...
    def end_i_pv6_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def end_i_pv6_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def start_i_pv6_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def start_i_pv6_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IPv6FirewallRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endIPv6Address")
    def end_i_pv6_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end IP address of the firewall rule. Must be IPv6 format. Must be greater than or equal to startIpv6Address.
        """
        return pulumi.get(self, "end_i_pv6_address")
    ...
    @property
    @pulumi.getter(name="startIPv6Address")
    def start_i_pv6_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The start IP address of the firewall rule. Must be IPv6 format.
        """
        return pulumi.get(self, "start_i_pv6_address")
