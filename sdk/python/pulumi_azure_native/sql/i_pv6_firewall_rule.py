...
class IPv6FirewallRuleArgs:
    ...
    def end_i_pv6_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def start_i_pv6_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def start_i_pv6_address(self, value: pulumi.Input[Optional[_builtins.str]]):
