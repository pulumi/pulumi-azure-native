...
def get_managed_instance(managed_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance is deprecated: azure-native:sql/v20180601preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20210201preview:ManagedInstance to guarantee forwards compatibility.""")
    __args__ = dict()
