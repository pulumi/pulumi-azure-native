...
class PrivateEndpointConnection(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20200202preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20200801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:PrivateEndpointConnection")])
