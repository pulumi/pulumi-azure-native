...
warnings.warn("""azure-native:sql/v20180601preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_instance_pool(instance_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_instance_pool is deprecated: azure-native:sql/v20180601preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""")
    __args__ = dict()
