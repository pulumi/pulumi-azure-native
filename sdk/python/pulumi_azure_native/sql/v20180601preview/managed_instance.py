...
warnings.warn("""azure-native:sql/v20180601preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20210201preview:ManagedInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_cores: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstance is deprecated: azure-native:sql/v20180601preview:ManagedInstance is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20210201preview:ManagedInstance to guarantee forwards compatibility.""")
