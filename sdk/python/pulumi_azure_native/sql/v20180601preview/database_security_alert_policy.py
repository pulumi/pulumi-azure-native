...
class DatabaseSecurityAlertPolicyArgs:
    def __init__(__self__, *,
                 ...
                 state: pulumi.Input['SecurityAlertPolicyState'],
    ...
    @property
    @pulumi.getter
    def state(self) -> pulumi.Input['SecurityAlertPolicyState']:
        """
    ...
    @state.setter
    def state(self, value: pulumi.Input['SecurityAlertPolicyState']):
