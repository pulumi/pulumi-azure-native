...
class ManagedInstanceKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20171001preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:ManagedInstanceKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedInstanceKey, __self__).__init__(
            'azure-native:sql/v20171001preview:ManagedInstanceKey',
            resource_name,
            __props__,
            opts)
