...
class ManagedInstanceKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20171001preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ManagedInstanceKey")])
