...
def get_managed_server_dns_alias(dns_alias_name: Optional[_builtins.str] = None,
...
def get_managed_server_dns_alias_output(dns_alias_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
