...
class ReplicationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20230501preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20230801:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20230801preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20240501preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20241101preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20250101:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20250201preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20250801preview:ReplicationLink")])
