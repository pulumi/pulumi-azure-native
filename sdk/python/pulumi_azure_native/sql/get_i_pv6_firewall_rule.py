...
def get_i_pv6_firewall_rule(firewall_rule_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str firewall_rule_name: The name of the firewall rule.
...
def get_i_pv6_firewall_rule_output(firewall_rule_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
