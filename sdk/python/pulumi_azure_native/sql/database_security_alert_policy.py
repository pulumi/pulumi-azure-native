...
class DatabaseSecurityAlertPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_name: The name of the  database for which the security alert policy is defined.
