...
def get_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getVirtualNetworkRule', __args__, opts=opts, typ=GetVirtualNetworkRuleResult).value
...
def get_virtual_network_rule_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getVirtualNetworkRule', __args__, opts=opts, typ=GetVirtualNetworkRuleResult)
