...
def get_job_target_group(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getJobTargetGroup', __args__, opts=opts, typ=GetJobTargetGroupResult).value
...
def get_job_target_group_output(job_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getJobTargetGroup', __args__, opts=opts, typ=GetJobTargetGroupResult)
