...
def get_server_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getServerKey', __args__, opts=opts, typ=GetServerKeyResult).value
...
def get_server_key_output(key_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getServerKey', __args__, opts=opts, typ=GetServerKeyResult)
