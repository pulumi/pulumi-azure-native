...
def get_job_private_endpoint(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getJobPrivateEndpoint', __args__, opts=opts, typ=GetJobPrivateEndpointResult).value
...
def get_job_private_endpoint_output(job_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getJobPrivateEndpoint', __args__, opts=opts, typ=GetJobPrivateEndpointResult)
