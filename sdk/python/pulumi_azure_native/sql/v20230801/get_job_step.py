...
def get_job_step(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getJobStep', __args__, opts=opts, typ=GetJobStepResult).value
...
def get_job_step_output(job_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getJobStep', __args__, opts=opts, typ=GetJobStepResult)
