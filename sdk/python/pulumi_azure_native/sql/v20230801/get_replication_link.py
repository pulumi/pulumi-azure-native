...
def get_replication_link(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getReplicationLink', __args__, opts=opts, typ=GetReplicationLinkResult).value
...
def get_replication_link_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getReplicationLink', __args__, opts=opts, typ=GetReplicationLinkResult)
