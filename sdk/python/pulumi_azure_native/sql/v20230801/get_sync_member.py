...
def get_sync_member(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getSyncMember', __args__, opts=opts, typ=GetSyncMemberResult).value
...
def get_sync_member_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getSyncMember', __args__, opts=opts, typ=GetSyncMemberResult)
