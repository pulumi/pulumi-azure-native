...
def get_database_advisor(advisor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getDatabaseAdvisor', __args__, opts=opts, typ=GetDatabaseAdvisorResult).value
...
def get_database_advisor_output(advisor_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getDatabaseAdvisor', __args__, opts=opts, typ=GetDatabaseAdvisorResult)
