...
def get_geo_backup_policy(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getGeoBackupPolicy', __args__, opts=opts, typ=GetGeoBackupPolicyResult).value
...
def get_geo_backup_policy_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getGeoBackupPolicy', __args__, opts=opts, typ=GetGeoBackupPolicyResult)
