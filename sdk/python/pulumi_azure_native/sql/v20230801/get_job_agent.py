...
def get_job_agent(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getJobAgent', __args__, opts=opts, typ=GetJobAgentResult).value
...
def get_job_agent_output(job_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getJobAgent', __args__, opts=opts, typ=GetJobAgentResult)
