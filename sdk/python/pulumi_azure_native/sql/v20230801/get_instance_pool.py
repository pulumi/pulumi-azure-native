...
class GetInstancePoolResult:
    ...
    """
    def __init__(__self__, dns_zone=None, id=None, license_type=None, location=None, maintenance_configuration_id=None, name=None, sku=None, subnet_id=None, tags=None, type=None, v_cores=None):
...
def get_instance_pool(instance_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getInstancePool', __args__, opts=opts, typ=GetInstancePoolResult).value
...
def get_instance_pool_output(instance_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getInstancePool', __args__, opts=opts, typ=GetInstancePoolResult)
