...
def get_sensitivity_label(column_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getSensitivityLabel', __args__, opts=opts, typ=GetSensitivityLabelResult).value
...
def get_sensitivity_label_output(column_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getSensitivityLabel', __args__, opts=opts, typ=GetSensitivityLabelResult)
