...
def get_encryption_protector(encryption_protector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getEncryptionProtector', __args__, opts=opts, typ=GetEncryptionProtectorResult).value
...
def get_encryption_protector_output(encryption_protector_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getEncryptionProtector', __args__, opts=opts, typ=GetEncryptionProtectorResult)
