...
def get_elastic_pool(elastic_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getElasticPool', __args__, opts=opts, typ=GetElasticPoolResult).value
...
def get_elastic_pool_output(elastic_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getElasticPool', __args__, opts=opts, typ=GetElasticPoolResult)
