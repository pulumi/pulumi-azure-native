...
def get_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
