...
def get_transparent_data_encryption(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801:getTransparentDataEncryption', __args__, opts=opts, typ=GetTransparentDataEncryptionResult).value
...
def get_transparent_data_encryption_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801:getTransparentDataEncryption', __args__, opts=opts, typ=GetTransparentDataEncryptionResult)
