...
class JobAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20170301preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20200202preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20200801preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20201101preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20210201preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20210501preview:JobAgent"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:JobAgent")])
