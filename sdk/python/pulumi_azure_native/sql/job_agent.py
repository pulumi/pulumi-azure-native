...
class JobAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_id: Resource ID of the database to store job metadata in.
        ...
        :param pulumi.Input[builtins.str] job_agent_name: The name of the job agent to be created or updated.
    ...
    def job_agent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def job_agent_name(self, value: Optional[pulumi.Input[builtins.str]]):
