...
class ManagedDatabaseArgs:
    ...
    def _configure(
        ...
        if auto_complete_restore is None and 'autoCompleteRestore' in kwargs:
            auto_complete_restore = kwargs['autoCompleteRestore']
        ...
        if last_backup_name is None and 'lastBackupName' in kwargs:
            last_backup_name = kwargs['lastBackupName']
        ...
        if storage_container_sas_token is None and 'storageContainerSasToken' in kwargs:
            storage_container_sas_token = kwargs['storageContainerSasToken']
        if storage_container_uri is None and 'storageContainerUri' in kwargs:
            storage_container_uri = kwargs['storageContainerUri']
