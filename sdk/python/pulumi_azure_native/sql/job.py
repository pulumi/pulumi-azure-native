...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: User-defined description of the job.
        :param pulumi.Input[builtins.str] job_name: The name of the job to get.
