...
class JobArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def schedule(self) -> pulumi.Input[Optional['JobScheduleArgs']]:
        """
    ...
    @schedule.setter
    def schedule(self, value: pulumi.Input[Optional['JobScheduleArgs']]):
...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] job_name: The name of the job to get.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
        :param pulumi.Input[Union['JobScheduleArgs', 'JobScheduleArgsDict']] schedule: Schedule properties of the job.
        :param pulumi.Input[_builtins.str] server_name: The name of the server.
        """
        ...
    @overload
