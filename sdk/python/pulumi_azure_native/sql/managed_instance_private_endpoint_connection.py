...
class ManagedInstancePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(private_endpoint, ManagedInstancePrivateEndpointPropertyArgs):
            ...
            if not isinstance(private_link_service_connection_state, ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs):
