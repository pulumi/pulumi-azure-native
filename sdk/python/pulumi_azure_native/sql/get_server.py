...
class GetServerResult:
    ...
    def is_i_pv6_enabled(self) -> Optional[builtins.str]:
        """
    ...
    def workspace_feature(self) -> builtins.str:
        """
...
def get_server(expand: Optional[builtins.str] = None,
...
def get_server_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql:getServer', __args__, opts=opts, typ=GetServerResult)
