...
class ServerKeyArgs:
    def __init__(__self__, *,
                 ...
                 server_key_type: pulumi.Input[Union[builtins.str, 'ServerKeyType']],
        ...
        :param pulumi.Input[Union[builtins.str, 'ServerKeyType']] server_key_type: The server key type like 'ServiceManaged', 'AzureKeyVault'.
        :param pulumi.Input[builtins.str] server_name: The name of the server.
        :param pulumi.Input[builtins.str] key_name: The name of the server key to be operated on (updated or created). The key name is required to be in the format of 'vault_key_version'. For example, if the keyId is https://YourVaultName.vault.azure.net/keys/YourKeyName/YourKeyVersion, then the server key name should be formatted as: YourVaultName_YourKeyName_YourKeyVersion
        :param pulumi.Input[builtins.str] uri: The URI of the server key. If the ServerKeyType is AzureKeyVault, then the URI is required. The AKV URI is required to be in this format: 'https://YourVaultName.vault.azure.net/keys/YourKeyName/YourKeyVersion'
        """
    ...
    def server_key_type(self) -> pulumi.Input[Union[builtins.str, 'ServerKeyType']]:
        """
    ...
    def server_key_type(self, value: pulumi.Input[Union[builtins.str, 'ServerKeyType']]):
...
class ServerKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 server_key_type: Optional[pulumi.Input[Union[builtins.str, 'ServerKeyType']]] = None,
    ...
    def auto_rotation_enabled(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def subregion(self) -> pulumi.Output[builtins.str]:
        """
