...
def get_extended_server_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230201preview:getExtendedServerBlobAuditingPolicy', __args__, opts=opts, typ=GetExtendedServerBlobAuditingPolicyResult).value
...
def get_extended_server_blob_auditing_policy_output(blob_auditing_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230201preview:getExtendedServerBlobAuditingPolicy', __args__, opts=opts, typ=GetExtendedServerBlobAuditingPolicyResult)
