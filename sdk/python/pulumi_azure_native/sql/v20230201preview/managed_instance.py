...
class ManagedInstanceArgs:
    def __init__(__self__, *,
        ...
        ManagedInstanceArgs._configure(
            ...
            is_general_purpose_v2=is_general_purpose_v2,
            key_id=key_id,
            ...
            storage_i_ops=storage_i_ops,
            storage_size_in_gb=storage_size_in_gb,
            storage_throughput_m_bps=storage_throughput_m_bps,
            subnet_id=subnet_id,
            tags=tags,
    ...
    def _configure(
        ...
        if hybrid_secondary_usage is None and 'hybridSecondaryUsage' in kwargs:
            hybrid_secondary_usage = kwargs['hybridSecondaryUsage']
        if instance_pool_id is None and 'instancePoolId' in kwargs:
            instance_pool_id = kwargs['instancePoolId']
        if is_general_purpose_v2 is None and 'isGeneralPurposeV2' in kwargs:
            is_general_purpose_v2 = kwargs['isGeneralPurposeV2']
        ...
        if storage_i_ops is None and 'storageIOps' in kwargs:
            storage_i_ops = kwargs['storageIOps']
        if storage_size_in_gb is None and 'storageSizeInGB' in kwargs:
            storage_size_in_gb = kwargs['storageSizeInGB']
        if storage_throughput_m_bps is None and 'storageThroughputMBps' in kwargs:
            storage_throughput_m_bps = kwargs['storageThroughputMBps']
        ...
        if hybrid_secondary_usage is not None:
            _setter("hybrid_secondary_usage", hybrid_secondary_usage)
        if identity is not None:
            _setter("identity", identity)
        if instance_pool_id is not None:
            _setter("instance_pool_id", instance_pool_id)
        if is_general_purpose_v2 is not None:
            _setter("is_general_purpose_v2", is_general_purpose_v2)
