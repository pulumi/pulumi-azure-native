...
def get_managed_instance(expand: Optional[str] = None,
    ...
    return AwaitableGetManagedInstanceResult(
        ...
        hybrid_secondary_usage=__ret__.hybrid_secondary_usage,
        hybrid_secondary_usage_detected=__ret__.hybrid_secondary_usage_detected,
        id=__ret__.id,
        identity=__ret__.identity,
        instance_pool_id=__ret__.instance_pool_id,
        is_general_purpose_v2=__ret__.is_general_purpose_v2,
        ...
        name=__ret__.name,
        pricing_model=__ret__.pricing_model,
        ...
        sku=__ret__.sku,
        state=__ret__.state,
        storage_i_ops=__ret__.storage_i_ops,
        storage_size_in_gb=__ret__.storage_size_in_gb,
        storage_throughput_m_bps=__ret__.storage_throughput_m_bps,
