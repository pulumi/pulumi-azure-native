...
def get_managed_instance_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230201preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult)
    return __ret__.apply(lambda __response__: GetManagedInstanceResult(
        ...
        hybrid_secondary_usage=pulumi.get(__response__, 'hybrid_secondary_usage'),
        hybrid_secondary_usage_detected=pulumi.get(__response__, 'hybrid_secondary_usage_detected'),
        id=pulumi.get(__response__, 'id'),
        identity=pulumi.get(__response__, 'identity'),
        instance_pool_id=pulumi.get(__response__, 'instance_pool_id'),
        is_general_purpose_v2=pulumi.get(__response__, 'is_general_purpose_v2'),
        ...
        storage_i_ops=pulumi.get(__response__, 'storage_i_ops'),
        storage_size_in_gb=pulumi.get(__response__, 'storage_size_in_gb'),
        storage_throughput_m_bps=pulumi.get(__response__, 'storage_throughput_m_bps'),
