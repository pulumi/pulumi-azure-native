...
class LongTermRetentionPolicyArgs:
    def __init__(__self__, *,
        ...
        LongTermRetentionPolicyArgs._configure(
            ...
            make_backups_immutable=make_backups_immutable,
    ...
    def _configure(
        ...
        if make_backups_immutable is None and 'makeBackupsImmutable' in kwargs:
            make_backups_immutable = kwargs['makeBackupsImmutable']
        ...
        if make_backups_immutable is not None:
            _setter("make_backups_immutable", make_backups_immutable)
