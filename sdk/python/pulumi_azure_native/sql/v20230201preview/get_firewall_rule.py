...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230201preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
...
def get_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230201preview:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult)
