...
class DatabaseArgs:
    ...
    def _configure(
        ...
        if 'encryptionProtector' in kwargs:
            encryption_protector = kwargs['encryptionProtector']
        if 'encryptionProtectorAutoRotation' in kwargs:
        ...
        if 'freeLimitExhaustionBehavior' in kwargs:
        ...
        if 'performCutover' in kwargs:
            perform_cutover = kwargs['performCutover']
        if 'preferredEnclaveType' in kwargs:
        ...
        if 'requestedBackupStorageRedundancy' in kwargs:
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if identity is not None and not isinstance(identity, DatabaseIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                DatabaseIdentityArgs._configure(_setter, **identity)
