...
class DistributedAvailabilityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'ReplicationModeType']] replication_mode: The replication mode of a distributed availability group. Parameter will be ignored during link creation.
...
class DistributedAvailabilityGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def databases(self) -> pulumi.Output[Sequence['outputs.DistributedAvailabilityGroupDatabaseResponse']]:
        """
    ...
    def instance_availability_group_name(self) -> pulumi.Output[str]:
        """
    ...
    def instance_link_role(self) -> pulumi.Output[str]:
        """
    ...
    def partner_availability_group_name(self) -> pulumi.Output[str]:
        """
    ...
    def partner_endpoint(self) -> pulumi.Output[str]:
        """
