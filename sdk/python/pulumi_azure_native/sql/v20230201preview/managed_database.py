...
class ManagedDatabaseArgs:
    def __init__(__self__, *,
        ...
        ManagedDatabaseArgs._configure(
            ...
            cross_subscription_restorable_dropped_database_id=cross_subscription_restorable_dropped_database_id,
            cross_subscription_source_database_id=cross_subscription_source_database_id,
            cross_subscription_target_managed_instance_id=cross_subscription_target_managed_instance_id,
            ...
            storage_container_identity=storage_container_identity,
    ...
    def _configure(
        ...
        if cross_subscription_restorable_dropped_database_id is None and 'crossSubscriptionRestorableDroppedDatabaseId' in kwargs:
            cross_subscription_restorable_dropped_database_id = kwargs['crossSubscriptionRestorableDroppedDatabaseId']
        if cross_subscription_source_database_id is None and 'crossSubscriptionSourceDatabaseId' in kwargs:
            cross_subscription_source_database_id = kwargs['crossSubscriptionSourceDatabaseId']
        if cross_subscription_target_managed_instance_id is None and 'crossSubscriptionTargetManagedInstanceId' in kwargs:
            cross_subscription_target_managed_instance_id = kwargs['crossSubscriptionTargetManagedInstanceId']
        ...
        if storage_container_identity is None and 'storageContainerIdentity' in kwargs:
            storage_container_identity = kwargs['storageContainerIdentity']
        ...
        if cross_subscription_restorable_dropped_database_id is not None:
            _setter("cross_subscription_restorable_dropped_database_id", cross_subscription_restorable_dropped_database_id)
        if cross_subscription_source_database_id is not None:
            _setter("cross_subscription_source_database_id", cross_subscription_source_database_id)
        if cross_subscription_target_managed_instance_id is not None:
            _setter("cross_subscription_target_managed_instance_id", cross_subscription_target_managed_instance_id)
        ...
        if storage_container_identity is not None:
            _setter("storage_container_identity", storage_container_identity)
...
class ManagedDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ManagedDatabase, __self__).__init__(
            'azure-native:sql/v20230201preview:ManagedDatabase',
            resource_name,
            __props__,
            opts)
