...
class DatabaseSecurityAlertPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        DatabaseSecurityAlertPolicyArgs._configure(
    ...
    def _configure(
        ...
        if security_alert_policy_name is None and 'securityAlertPolicyName' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DatabaseSecurityAlertPolicyArgs._configure(_setter, **kwargs)
