...
def get_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230201preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
    ...
    return AwaitableGetDatabaseResult(
        ...
        encryption_protector_auto_rotation=__ret__.encryption_protector_auto_rotation,
        failover_group_id=__ret__.failover_group_id,
        federated_client_id=__ret__.federated_client_id,
        free_limit_exhaustion_behavior=__ret__.free_limit_exhaustion_behavior,
        ...
        tags=__ret__.tags,
        type=__ret__.type,
        use_free_limit=__ret__.use_free_limit,
