...
class EncryptionProtectorArgs:
    ...
    def _configure(
        ...
        if 'encryptionProtectorName' in kwargs:
            encryption_protector_name = kwargs['encryptionProtectorName']
        if 'serverKeyName' in kwargs:
