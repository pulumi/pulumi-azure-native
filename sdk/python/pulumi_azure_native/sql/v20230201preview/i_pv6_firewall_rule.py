...
class IPv6FirewallRuleArgs:
    ...
    def _configure(
        ...
        if end_i_pv6_address is None and 'endIPv6Address' in kwargs:
            end_i_pv6_address = kwargs['endIPv6Address']
        if firewall_rule_name is None and 'firewallRuleName' in kwargs:
            firewall_rule_name = kwargs['firewallRuleName']
        if start_i_pv6_address is None and 'startIPv6Address' in kwargs:
            start_i_pv6_address = kwargs['startIPv6Address']
