...
class ServerArgs:
    def __init__(__self__, *,
        ...
        ServerArgs._configure(
            ...
            identity=identity,
            is_i_pv6_enabled=is_i_pv6_enabled,
            key_id=key_id,
            location=location,
    ...
    def _configure(
        ...
        if is_i_pv6_enabled is None and 'isIPv6Enabled' in kwargs:
            is_i_pv6_enabled = kwargs['isIPv6Enabled']
        ...
        if is_i_pv6_enabled is not None:
            _setter("is_i_pv6_enabled", is_i_pv6_enabled)
