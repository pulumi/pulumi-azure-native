...
def get_workload_group(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230201preview:getWorkloadGroup', __args__, opts=opts, typ=GetWorkloadGroupResult).value
...
def get_workload_group_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workloadGroupName'] = workload_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230201preview:getWorkloadGroup', __args__, opts=opts, typ=GetWorkloadGroupResult)
