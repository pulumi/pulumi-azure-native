...
def get_database_advisor(advisor_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str advisor_name: The name of the Database Advisor.
...
def get_database_advisor_output(advisor_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
