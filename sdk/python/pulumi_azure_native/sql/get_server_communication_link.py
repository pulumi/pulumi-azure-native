...
class GetServerCommunicationLinkResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, kind=None, location=None, name=None, partner_server=None, state=None, type=None):
...
def get_server_communication_link(communication_link_name: Optional[builtins.str] = None,
    ...
    :param builtins.str communication_link_name: The name of the server communication link.
...
def get_server_communication_link_output(communication_link_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql:getServerCommunicationLink', __args__, opts=opts, typ=GetServerCommunicationLinkResult)
