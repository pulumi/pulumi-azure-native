...
def get_server_communication_link(communication_link_name: Optional[_builtins.str] = None,
...
def get_server_communication_link_output(communication_link_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
