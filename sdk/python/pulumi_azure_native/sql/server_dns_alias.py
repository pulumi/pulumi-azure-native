...
class ServerDnsAliasArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_name: The name of the server that the alias is pointing to.
        :param pulumi.Input[builtins.str] dns_alias_name: The name of the server dns alias.
        """
