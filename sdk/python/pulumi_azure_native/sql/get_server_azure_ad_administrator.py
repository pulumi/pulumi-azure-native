...
class GetServerAzureADAdministratorResult:
    ...
    """
    def __init__(__self__, administrator_type=None, azure_ad_only_authentication=None, azure_api_version=None, id=None, login=None, name=None, sid=None, tenant_id=None, type=None):
...
def get_server_azure_ad_administrator(administrator_name: Optional[builtins.str] = None,
    ...
    :param builtins.str administrator_name: The name of server active directory administrator.
...
def get_server_azure_ad_administrator_output(administrator_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql:getServerAzureADAdministrator', __args__, opts=opts, typ=GetServerAzureADAdministratorResult)
