...
def get_server_azure_ad_administrator(administrator_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str administrator_name: The name of server active directory administrator.
...
def get_server_azure_ad_administrator_output(administrator_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
