...
class ReplicationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20230501preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20230801:ReplicationLink"), pulumi.Alias(type_="azure-native:sql/v20240501preview:ReplicationLink"), pulumi.Alias(type_="azure-native:sql:ReplicationLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationLink, __self__).__init__(
            'azure-native:sql/v20230801preview:ReplicationLink',
            resource_name,
            __props__,
            opts)
