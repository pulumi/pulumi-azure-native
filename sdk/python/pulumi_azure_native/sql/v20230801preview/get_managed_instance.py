...
class GetManagedInstanceResult:
    ...
    def __init__(__self__, administrator_login=None, administrators=None, authentication_metadata=None, collation=None, create_time=None, current_backup_storage_redundancy=None, database_format=None, dns_zone=None, external_governance_status=None, fully_qualified_domain_name=None, hybrid_secondary_usage=None, hybrid_secondary_usage_detected=None, id=None, identity=None, instance_pool_id=None, is_general_purpose_v2=None, key_id=None, license_type=None, location=None, maintenance_configuration_id=None, minimal_tls_version=None, name=None, pricing_model=None, primary_user_assigned_identity_id=None, private_endpoint_connections=None, provisioning_state=None, proxy_override=None, public_data_endpoint_enabled=None, requested_backup_storage_redundancy=None, service_principal=None, sku=None, state=None, storage_i_ops=None, storage_size_in_gb=None, storage_throughput_m_bps=None, subnet_id=None, tags=None, timezone_id=None, total_memory_mb=None, type=None, v_cores=None, virtual_cluster_id=None, zone_redundant=None):
        ...
        if authentication_metadata and not isinstance(authentication_metadata, str):
            raise TypeError("Expected argument 'authentication_metadata' to be a str")
        ...
        if total_memory_mb and not isinstance(total_memory_mb, int):
            raise TypeError("Expected argument 'total_memory_mb' to be a int")
    ...
    def authentication_metadata(self) -> Optional[str]:
        """
    ...
    def database_format(self) -> Optional[str]:
        """
...
def get_managed_instance(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult).value
    ...
    return AwaitableGetManagedInstanceResult(
        ...
        authentication_metadata=pulumi.get(__ret__, 'authentication_metadata'),
        ...
        total_memory_mb=pulumi.get(__ret__, 'total_memory_mb'),
...
def get_managed_instance_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230801preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult)
    return __ret__.apply(lambda __response__: GetManagedInstanceResult(
        ...
        authentication_metadata=pulumi.get(__response__, 'authentication_metadata'),
        ...
        total_memory_mb=pulumi.get(__response__, 'total_memory_mb'),
