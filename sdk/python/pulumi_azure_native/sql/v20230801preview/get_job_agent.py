...
class GetJobAgentResult:
    ...
    """
    def __init__(__self__, database_id=None, id=None, identity=None, location=None, name=None, sku=None, state=None, tags=None, type=None):
...
def get_job_agent(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230801preview:getJobAgent', __args__, opts=opts, typ=GetJobAgentResult).value
