...
class GetDatabaseSecurityAlertPolicyResult:
    ...
    def email_account_admins(self) -> Optional[builtins.bool]:
        """
...
def get_database_security_alert_policy(database_name: Optional[builtins.str] = None,
    ...
    :param builtins.str database_name: The name of the  database for which the security alert policy is defined.
...
def get_database_security_alert_policy_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
