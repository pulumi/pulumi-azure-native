...
class ExtendedServerBlobAuditingPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        ExtendedServerBlobAuditingPolicyArgs._configure(
            ...
            is_devops_audit_enabled=is_devops_audit_enabled,
    ...
    def _configure(
        ...
        if is_devops_audit_enabled is None and 'isDevopsAuditEnabled' in kwargs:
            is_devops_audit_enabled = kwargs['isDevopsAuditEnabled']
        ...
        if is_devops_audit_enabled is not None:
            _setter("is_devops_audit_enabled", is_devops_audit_enabled)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ExtendedServerBlobAuditingPolicyArgs._configure(_setter, **kwargs)
