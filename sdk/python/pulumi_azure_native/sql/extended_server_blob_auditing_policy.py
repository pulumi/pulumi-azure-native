...
class ExtendedServerBlobAuditingPolicyArgs:
    def __init__(__self__, *,
                 ...
                 is_devops_audit_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_devops_audit_enabled: Specifies the state of devops audit. If state is Enabled, devops logs will be sent to Azure Monitor.
    ...
    def is_devops_audit_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_devops_audit_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ExtendedServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isDevopsAuditEnabled")
    def is_devops_audit_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies the state of devops audit. If state is Enabled, devops logs will be sent to Azure Monitor.
        In order to send the events to Azure Monitor, specify 'State' as 'Enabled', 'IsAzureMonitorTargetEnabled' as true and 'IsDevopsAuditEnabled' as true
