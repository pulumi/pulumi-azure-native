...
class ExtendedServerBlobAuditingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] audit_actions_and_groups: Specifies the Actions-Groups and Actions to audit.
        ...
        :param pulumi.Input[_builtins.bool] is_devops_audit_enabled: Specifies the state of devops audit. If state is Enabled, devops logs will be sent to Azure Monitor.
               ...
               For more information, see [Diagnostic Settings REST API](https://go.microsoft.com/fwlink/?linkid=2033207)
               or [Diagnostic Settings PowerShell](https://go.microsoft.com/fwlink/?linkid=2033043)
        :param pulumi.Input[_builtins.bool] is_managed_identity_in_use: Specifies whether Managed Identity is used to access blob storage
        :param pulumi.Input[_builtins.bool] is_storage_secondary_key_in_use: Specifies whether storageAccountAccessKey value is the storage's secondary key.
...
@pulumi.type_token("azure-native:sql:ExtendedServerBlobAuditingPolicy")
class ExtendedServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isDevopsAuditEnabled")
    def is_devops_audit_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies the state of devops audit. If state is Enabled, devops logs will be sent to Azure Monitor.
        In order to send the events to Azure Monitor, specify 'State' as 'Enabled', 'IsAzureMonitorTargetEnabled' as true and 'IsDevopsAuditEnabled' as true
