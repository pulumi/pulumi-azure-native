...
def get_server_dns_alias(dns_alias_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dns_alias_name: The name of the server dns alias.
    ...
    :param builtins.str server_name: The name of the server that the alias is pointing to.
    """
    __args__ = dict()
...
def get_server_dns_alias_output(dns_alias_name: Optional[pulumi.Input[builtins.str]] = None,
