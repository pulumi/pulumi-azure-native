...
warnings.warn("""azure-native:sql/v20211101preview:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class DistributedAvailabilityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_database: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DistributedAvailabilityGroup is deprecated: azure-native:sql/v20211101preview:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20210501preview:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20210801preview:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20211101:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20220201preview:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20220501preview:DistributedAvailabilityGroup"), pulumi.Alias(type_="azure-native:sql/v20220801preview:DistributedAvailabilityGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DistributedAvailabilityGroup, __self__).__init__(
            'azure-native:sql/v20211101preview:DistributedAvailabilityGroup',
            resource_name,
            __props__,
            opts)
