...
warnings.warn("""azure-native:sql/v20211101preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_blob_auditing_policy is deprecated: azure-native:sql/v20211101preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['blobAuditingPolicyName'] = blob_auditing_policy_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101preview:getServerBlobAuditingPolicy', __args__, opts=opts, typ=GetServerBlobAuditingPolicyResult).value
