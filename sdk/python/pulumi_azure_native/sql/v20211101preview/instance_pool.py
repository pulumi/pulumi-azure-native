...
warnings.warn("""azure-native:sql/v20211101preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""", DeprecationWarning)
...
class InstancePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 v_cores: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        pulumi.log.warn("""InstancePool is deprecated: azure-native:sql/v20211101preview:InstancePool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstancePool to guarantee forwards compatibility.""")
