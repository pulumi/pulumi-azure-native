...
warnings.warn("""azure-native:sql/v20211101preview:Job is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Job is deprecated: azure-native:sql/v20211101preview:Job is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Job to guarantee forwards compatibility.""")
