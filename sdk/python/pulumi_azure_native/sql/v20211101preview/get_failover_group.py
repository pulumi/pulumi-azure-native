...
warnings.warn("""azure-native:sql/v20211101preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_failover_group(failover_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_failover_group is deprecated: azure-native:sql/v20211101preview:FailoverGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FailoverGroup to guarantee forwards compatibility.""")
    __args__ = dict()
