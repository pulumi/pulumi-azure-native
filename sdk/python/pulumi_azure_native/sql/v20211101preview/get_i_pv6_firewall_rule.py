...
warnings.warn("""azure-native:sql/v20211101preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_i_pv6_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_i_pv6_firewall_rule is deprecated: azure-native:sql/v20211101preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
