...
warnings.warn("""azure-native:sql/v20211101preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_managed_database_sensitivity_label(column_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_database_sensitivity_label is deprecated: azure-native:sql/v20211101preview:ManagedDatabaseSensitivityLabel is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedDatabaseSensitivityLabel to guarantee forwards compatibility.""")
    __args__ = dict()
