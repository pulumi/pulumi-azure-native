...
class ServerTrustCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20211101:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ServerTrustCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerTrustCertificate, __self__).__init__(
            'azure-native:sql/v20211101preview:ServerTrustCertificate',
            resource_name,
            __props__,
            opts)
