...
def get_managed_server_dns_alias(dns_alias_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_server_dns_alias is deprecated: azure-native:sql/v20211101preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedServerDnsAlias to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dnsAliasName'] = dns_alias_name
    __args__['managedInstanceName'] = managed_instance_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101preview:getManagedServerDnsAlias', __args__, opts=opts, typ=GetManagedServerDnsAliasResult).value
