...
warnings.warn("""azure-native:sql/v20211101preview:JobCredential is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job_credential(credential_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_credential is deprecated: azure-native:sql/v20211101preview:JobCredential is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.""")
    __args__ = dict()
