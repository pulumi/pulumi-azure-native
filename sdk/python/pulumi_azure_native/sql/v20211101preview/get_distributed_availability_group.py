...
def get_distributed_availability_group(distributed_availability_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_distributed_availability_group is deprecated: azure-native:sql/v20211101preview:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101preview:getDistributedAvailabilityGroup', __args__, opts=opts, typ=GetDistributedAvailabilityGroupResult).value
