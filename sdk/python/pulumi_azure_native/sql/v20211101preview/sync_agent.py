...
warnings.warn("""azure-native:sql/v20211101preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.""", DeprecationWarning)
...
class SyncAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sync_database_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SyncAgent is deprecated: azure-native:sql/v20211101preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:SyncAgent to guarantee forwards compatibility.""")
