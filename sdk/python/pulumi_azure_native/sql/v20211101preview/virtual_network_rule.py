...
warnings.warn("""azure-native:sql/v20211101preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:VirtualNetworkRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkRule is deprecated: azure-native:sql/v20211101preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:VirtualNetworkRule to guarantee forwards compatibility.""")
