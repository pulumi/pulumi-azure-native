...
warnings.warn("""azure-native:sql/v20211101preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:VirtualNetworkRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualNetworkRule is deprecated: azure-native:sql/v20211101preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:VirtualNetworkRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20150501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20200202preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20200801preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20201101preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20210201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20210501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20210801preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20211101:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20220201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20220501preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:sql/v20220801preview:VirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRule, __self__).__init__(
            'azure-native:sql/v20211101preview:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
