...
def get_outbound_firewall_rule(outbound_rule_fqdn: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_outbound_firewall_rule is deprecated: azure-native:sql/v20211101preview:OutboundFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:OutboundFirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
