...
def get_instance_pool(instance_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_instance_pool is deprecated: azure-native:sql/v20211101preview:InstancePool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:InstancePool to guarantee forwards compatibility.""")
    __args__ = dict()
