...
warnings.warn("""azure-native:sql/v20211101preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
