...
def get_database_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_blob_auditing_policy is deprecated: azure-native:sql/v20211101preview:DatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DatabaseBlobAuditingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20211101preview:getDatabaseBlobAuditingPolicy', __args__, opts=opts, typ=GetDatabaseBlobAuditingPolicyResult).value
