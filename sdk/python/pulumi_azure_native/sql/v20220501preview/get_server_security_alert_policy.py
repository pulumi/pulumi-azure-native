...
def get_server_security_alert_policy(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_security_alert_policy is deprecated: azure-native:sql/v20220501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
