...
def get_i_pv6_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220501preview:getIPv6FirewallRule', __args__, opts=opts, typ=GetIPv6FirewallRuleResult).value
...
def get_i_pv6_firewall_rule_output(firewall_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20220501preview:getIPv6FirewallRule', __args__, opts=opts, typ=GetIPv6FirewallRuleResult)
