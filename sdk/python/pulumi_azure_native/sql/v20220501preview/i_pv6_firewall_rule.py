...
warnings.warn("""azure-native:sql/v20220501preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class IPv6FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20210801preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220201preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220801preview:IPv6FirewallRule")])
