...
warnings.warn("""azure-native:sql/v20220501preview:IPv6FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:IPv6FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
