...
warnings.warn("""azure-native:sql/v20220501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstance is deprecated: azure-native:sql/v20220501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstance to guarantee forwards compatibility.""")
