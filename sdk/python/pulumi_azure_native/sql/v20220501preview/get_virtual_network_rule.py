...
def get_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_rule is deprecated: azure-native:sql/v20220501preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:VirtualNetworkRule to guarantee forwards compatibility.""")
    __args__ = dict()
