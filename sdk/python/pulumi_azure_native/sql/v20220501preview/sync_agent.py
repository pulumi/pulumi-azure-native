...
warnings.warn("""azure-native:sql/v20220501preview:SyncAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.""", DeprecationWarning)
