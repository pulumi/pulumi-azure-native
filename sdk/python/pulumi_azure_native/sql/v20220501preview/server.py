...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:Server"), pulumi.Alias(type_="azure-native:sql/v20140401:Server"), pulumi.Alias(type_="azure-native:sql/v20150501preview:Server"), pulumi.Alias(type_="azure-native:sql/v20190601preview:Server"), pulumi.Alias(type_="azure-native:sql/v20200202preview:Server"), pulumi.Alias(type_="azure-native:sql/v20200801preview:Server"), pulumi.Alias(type_="azure-native:sql/v20201101preview:Server"), pulumi.Alias(type_="azure-native:sql/v20210201preview:Server"), pulumi.Alias(type_="azure-native:sql/v20210501preview:Server"), pulumi.Alias(type_="azure-native:sql/v20210801preview:Server"), pulumi.Alias(type_="azure-native:sql/v20211101:Server"), pulumi.Alias(type_="azure-native:sql/v20211101preview:Server"), pulumi.Alias(type_="azure-native:sql/v20220201preview:Server"), pulumi.Alias(type_="azure-native:sql/v20220801preview:Server"), pulumi.Alias(type_="azure-native:sql/v20221101preview:Server"), pulumi.Alias(type_="azure-native:sql/v20230201preview:Server"), pulumi.Alias(type_="azure-native:sql/v20230501preview:Server"), pulumi.Alias(type_="azure-native:sql/v20230801preview:Server"), pulumi.Alias(type_="azure-native:sql/v20240501preview:Server")])
