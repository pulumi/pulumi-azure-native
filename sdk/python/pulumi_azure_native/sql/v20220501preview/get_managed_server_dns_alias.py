...
def get_managed_server_dns_alias(dns_alias_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_server_dns_alias is deprecated: azure-native:sql/v20220501preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.""")
    __args__ = dict()
