...
warnings.warn("""azure-native:sql/v20220501preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
