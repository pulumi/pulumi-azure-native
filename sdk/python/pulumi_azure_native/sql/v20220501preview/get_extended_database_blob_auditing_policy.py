...
def get_extended_database_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220501preview:getExtendedDatabaseBlobAuditingPolicy', __args__, opts=opts, typ=GetExtendedDatabaseBlobAuditingPolicyResult).value
...
def get_extended_database_blob_auditing_policy_output(blob_auditing_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20220501preview:getExtendedDatabaseBlobAuditingPolicy', __args__, opts=opts, typ=GetExtendedDatabaseBlobAuditingPolicyResult)
