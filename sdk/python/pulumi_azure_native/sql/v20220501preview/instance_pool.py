...
class InstancePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20180601preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20200202preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20200801preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20201101preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20210201preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20210501preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20210801preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20211101:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20211101preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20220201preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20220801preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20221101preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20230201preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20230501preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20230801preview:InstancePool"), pulumi.Alias(type_="azure-native:sql/v20240501preview:InstancePool")])
