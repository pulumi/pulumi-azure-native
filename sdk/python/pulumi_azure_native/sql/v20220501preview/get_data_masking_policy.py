...
def get_data_masking_policy(data_masking_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_masking_policy is deprecated: azure-native:sql/v20220501preview:DataMaskingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:DataMaskingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
