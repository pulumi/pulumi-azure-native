...
def get_managed_instance(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance is deprecated: azure-native:sql/v20220501preview:ManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstance to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['managedInstanceName'] = managed_instance_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220501preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult).value
