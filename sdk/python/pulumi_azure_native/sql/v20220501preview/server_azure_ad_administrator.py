...
warnings.warn("""azure-native:sql/v20220501preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
