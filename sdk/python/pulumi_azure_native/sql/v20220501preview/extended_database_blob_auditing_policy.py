...
class ExtendedDatabaseBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20221101preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230201preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230501preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230801preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20240501preview:ExtendedDatabaseBlobAuditingPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExtendedDatabaseBlobAuditingPolicy, __self__).__init__(
            'azure-native:sql/v20220501preview:ExtendedDatabaseBlobAuditingPolicy',
            resource_name,
            __props__,
            opts)
