...
def get_long_term_retention_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_long_term_retention_policy is deprecated: azure-native:sql/v20220501preview:LongTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:LongTermRetentionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
