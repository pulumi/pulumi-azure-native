...
warnings.warn("""azure-native:sql/v20220501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerSecurityAlertPolicy is deprecated: azure-native:sql/v20220501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.""")
