...
warnings.warn("""azure-native:sql/v20220501preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job_step(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_step is deprecated: azure-native:sql/v20220501preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.""")
    __args__ = dict()
