...
class JobStep(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_group: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""JobStep is deprecated: azure-native:sql/v20220501preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobStep to guarantee forwards compatibility.""")
