...
warnings.warn("""azure-native:sql/v20220501preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:InstanceFailoverGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_instance_failover_group(failover_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_instance_failover_group is deprecated: azure-native:sql/v20220501preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:InstanceFailoverGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['failoverGroupName'] = failover_group_name
    __args__['locationName'] = location_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220501preview:getInstanceFailoverGroup', __args__, opts=opts, typ=GetInstanceFailoverGroupResult).value
