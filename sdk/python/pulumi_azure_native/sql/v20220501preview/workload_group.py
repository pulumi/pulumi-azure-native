...
class WorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20190601preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20200202preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20200801preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20201101preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20210201preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20210501preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20210801preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20211101:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20211101preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20220201preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20220801preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20221101preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20230201preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20230501preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20230801preview:WorkloadGroup"), pulumi.Alias(type_="azure-native:sql/v20240501preview:WorkloadGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadGroup, __self__).__init__(
            'azure-native:sql/v20220501preview:WorkloadGroup',
            resource_name,
            __props__,
            opts)
