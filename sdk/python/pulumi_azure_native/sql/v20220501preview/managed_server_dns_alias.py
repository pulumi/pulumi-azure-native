...
warnings.warn("""azure-native:sql/v20220501preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedServerDnsAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedServerDnsAlias is deprecated: azure-native:sql/v20220501preview:ManagedServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedServerDnsAlias to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20211101:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ManagedServerDnsAlias")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedServerDnsAlias, __self__).__init__(
            'azure-native:sql/v20220501preview:ManagedServerDnsAlias',
            resource_name,
            __props__,
            opts)
