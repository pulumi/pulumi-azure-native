...
def get_sync_agent(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_agent is deprecated: azure-native:sql/v20220501preview:SyncAgent is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.""")
    __args__ = dict()
