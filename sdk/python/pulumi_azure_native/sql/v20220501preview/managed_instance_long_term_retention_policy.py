...
warnings.warn("""azure-native:sql/v20220501preview:ManagedInstanceLongTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceLongTermRetentionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstanceLongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20220801preview:ManagedInstanceLongTermRetentionPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedInstanceLongTermRetentionPolicy, __self__).__init__(
            'azure-native:sql/v20220501preview:ManagedInstanceLongTermRetentionPolicy',
            resource_name,
            __props__,
            opts)
