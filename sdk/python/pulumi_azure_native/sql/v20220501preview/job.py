...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:Job"), pulumi.Alias(type_="azure-native:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-native:sql/v20200202preview:Job"), pulumi.Alias(type_="azure-native:sql/v20200801preview:Job"), pulumi.Alias(type_="azure-native:sql/v20201101preview:Job"), pulumi.Alias(type_="azure-native:sql/v20210201preview:Job"), pulumi.Alias(type_="azure-native:sql/v20210501preview:Job"), pulumi.Alias(type_="azure-native:sql/v20210801preview:Job"), pulumi.Alias(type_="azure-native:sql/v20211101:Job"), pulumi.Alias(type_="azure-native:sql/v20211101preview:Job"), pulumi.Alias(type_="azure-native:sql/v20220201preview:Job"), pulumi.Alias(type_="azure-native:sql/v20220801preview:Job"), pulumi.Alias(type_="azure-native:sql/v20221101preview:Job"), pulumi.Alias(type_="azure-native:sql/v20230201preview:Job"), pulumi.Alias(type_="azure-native:sql/v20230501preview:Job"), pulumi.Alias(type_="azure-native:sql/v20230801preview:Job"), pulumi.Alias(type_="azure-native:sql/v20240501preview:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-native:sql/v20220501preview:Job',
            resource_name,
            __props__,
            opts)
