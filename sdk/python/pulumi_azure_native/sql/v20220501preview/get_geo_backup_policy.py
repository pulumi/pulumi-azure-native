...
warnings.warn("""azure-native:sql/v20220501preview:GeoBackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:GeoBackupPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_geo_backup_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_geo_backup_policy is deprecated: azure-native:sql/v20220501preview:GeoBackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:GeoBackupPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
