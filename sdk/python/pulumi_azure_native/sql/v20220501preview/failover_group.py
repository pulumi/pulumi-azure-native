...
class FailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20150501preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20200202preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20200801preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20201101preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20210201preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20210501preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20210801preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20211101:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20211101preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20220201preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20220801preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20221101preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20230201preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20230501preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20230801preview:FailoverGroup"), pulumi.Alias(type_="azure-native:sql/v20240501preview:FailoverGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FailoverGroup, __self__).__init__(
            'azure-native:sql/v20220501preview:FailoverGroup',
            resource_name,
            __props__,
            opts)
