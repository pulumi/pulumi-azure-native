...
class BackupLongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_long_term_retention_policy = azure_native.sql.v20170301preview.BackupLongTermRetentionPolicy("backupLongTermRetentionPolicy",
        ...
        ```sh
        $ pulumi import azure-native:sql/v20170301preview:BackupLongTermRetentionPolicy default /subscriptions/00000000-1111-2222-3333-444444444444/providers/Microsoft.Sql/resourceGroups/resourceGroup/servers/testserver/databases/testDatabase/backupLongTermRetentionPolicies/default 
        ```
