...
class BackupLongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-native:sql/v20210501preview:BackupLongTermRetentionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:BackupLongTermRetentionPolicy")])
