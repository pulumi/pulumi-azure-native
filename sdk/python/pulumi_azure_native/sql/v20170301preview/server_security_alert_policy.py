...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_security_alert_policy = azure_native.sql.v20170301preview.ServerSecurityAlertPolicy("serverSecurityAlertPolicy",
            disabled_alerts=[
                "Access_Anomaly",
                "Usage_Anomaly",
            ],
