...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:ManagedInstanceAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedInstanceAdministrator, __self__).__init__(
            'azure-native:sql/v20170301preview:ManagedInstanceAdministrator',
            resource_name,
            __props__,
            opts)
