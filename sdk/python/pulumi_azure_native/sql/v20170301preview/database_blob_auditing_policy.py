...
__all__ = ['DatabaseBlobAuditingPolicyArgs', 'DatabaseBlobAuditingPolicy']

@pulumi.input_type
class DatabaseBlobAuditingPolicyArgs:
...
class DatabaseBlobAuditingPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseBlobAuditingPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseBlobAuditingPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseBlobAuditingPolicyArgs.__new__(DatabaseBlobAuditingPolicyArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20150501preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20150501preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:DatabaseBlobAuditingPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseBlobAuditingPolicy, __self__).__init__(
            'azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DatabaseBlobAuditingPolicy':
        """
        ...
        __props__.__dict__["type"] = None
        return DatabaseBlobAuditingPolicy(resource_name, opts=opts, __props__=__props__)
