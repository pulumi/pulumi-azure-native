...
warnings.warn("""azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DatabaseBlobAuditingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class DatabaseBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DatabaseBlobAuditingPolicy is deprecated: azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DatabaseBlobAuditingPolicy to guarantee forwards compatibility.""")
