...
warnings.warn("""azure-native:sql/v20170301preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20190601preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: azure-native:sql/v20170301preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20190601preview:Database to guarantee forwards compatibility.""")
    __args__ = dict()
