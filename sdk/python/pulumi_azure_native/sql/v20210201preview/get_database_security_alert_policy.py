...
def get_database_security_alert_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_security_alert_policy is deprecated: azure-native:sql/v20210201preview:DatabaseSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210201preview:getDatabaseSecurityAlertPolicy', __args__, opts=opts, typ=GetDatabaseSecurityAlertPolicyResult).value
