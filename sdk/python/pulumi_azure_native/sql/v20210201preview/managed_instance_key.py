...
warnings.warn("""azure-native:sql/v20210201preview:ManagedInstanceKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstanceKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstanceKey is deprecated: azure-native:sql/v20210201preview:ManagedInstanceKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.""")
