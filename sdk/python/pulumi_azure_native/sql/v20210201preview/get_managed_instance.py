...
def get_managed_instance(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210201preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult).value
...
def get_managed_instance_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20210201preview:getManagedInstance', __args__, opts=opts, typ=GetManagedInstanceResult)
