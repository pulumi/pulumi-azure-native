...
warnings.warn("""azure-native:sql/v20210201preview:SyncGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class SyncGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 use_private_link_connection: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""SyncGroup is deprecated: azure-native:sql/v20210201preview:SyncGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""")
