...
def get_elastic_pool(elastic_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_elastic_pool is deprecated: azure-native:sql/v20210201preview:ElasticPool is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ElasticPool to guarantee forwards compatibility.""")
    __args__ = dict()
