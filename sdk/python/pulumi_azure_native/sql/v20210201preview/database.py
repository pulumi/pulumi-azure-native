...
warnings.warn("""azure-native:sql/v20210201preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""Database is deprecated: azure-native:sql/v20210201preview:Database is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Database to guarantee forwards compatibility.""")
