...
warnings.warn("""azure-native:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_extended_database_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_extended_database_blob_auditing_policy is deprecated: azure-native:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ExtendedDatabaseBlobAuditingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
