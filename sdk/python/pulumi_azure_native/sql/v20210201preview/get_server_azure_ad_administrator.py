...
warnings.warn("""azure-native:sql/v20210201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_azure_ad_administrator(administrator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_azure_ad_administrator is deprecated: azure-native:sql/v20210201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.""")
    __args__ = dict()
