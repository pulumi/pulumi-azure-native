...
class ManagedInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_instance = azure_native.sql.v20210201preview.ManagedInstance("managedInstance",
            administrator_login="dummylogin",
            administrator_login_password="PLACEHOLDER",
            administrators=azure_native.sql.v20210201preview.ManagedInstanceExternalAdministratorArgs(
            ...
            sku=azure_native.sql.v20210201preview.SkuResponseArgs(
                name="GP_Gen5",
                tier="GeneralPurpose",
            ),
