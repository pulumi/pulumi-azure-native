...
warnings.warn("""azure-native:sql/v20210201preview:ElasticPool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ElasticPool to guarantee forwards compatibility.""", DeprecationWarning)
...
class ElasticPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""ElasticPool is deprecated: azure-native:sql/v20210201preview:ElasticPool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ElasticPool to guarantee forwards compatibility.""")
