...
warnings.warn("""azure-native:sql/v20210201preview:ManagedDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabase to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedDatabase is deprecated: azure-native:sql/v20210201preview:ManagedDatabase is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedDatabase to guarantee forwards compatibility.""")
