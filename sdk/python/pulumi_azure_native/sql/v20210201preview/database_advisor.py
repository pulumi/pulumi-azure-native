...
class DatabaseAdvisor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20140401:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20150501preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20150501preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20200202preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20200801preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20201101preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-native:sql/v20210501preview:DatabaseAdvisor"), pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:DatabaseAdvisor")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAdvisor, __self__).__init__(
            'azure-native:sql/v20210201preview:DatabaseAdvisor',
            resource_name,
            __props__,
            opts)
