...
def get_sync_group(database_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sync_group_name: The name of the sync group.
    """
    __args__ = dict()
...
def get_sync_group_output(database_name: Optional[pulumi.Input[_builtins.str]] = None,
