...
def get_data_masking_policy(data_masking_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_masking_policy_name: The name of the database for which the data masking policy applies.
...
def get_data_masking_policy_output(data_masking_policy_name: pulumi.Input[Optional[_builtins.str]] = None,
