...
class EncryptionProtectorArgs:
    def __init__(__self__, *,
                 ...
                 encryption_protector_name: Optional[pulumi.Input[builtins.str]] = None,
                 server_key_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Union[builtins.str, 'ServerKeyType']] server_key_type: The encryption protector type like 'ServiceManaged', 'AzureKeyVault'.
        :param pulumi.Input[builtins.str] server_name: The name of the server.
        :param pulumi.Input[builtins.bool] auto_rotation_enabled: Key auto rotation opt-in flag. Either true or false.
        :param pulumi.Input[builtins.str] encryption_protector_name: The name of the encryption protector to be updated.
        :param pulumi.Input[builtins.str] server_key_name: The name of the server key.
        """
    ...
    def encryption_protector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryption_protector_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encryption_protector_name", value)

    @property
    @pulumi.getter(name="serverKeyName")
    def server_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EncryptionProtector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="serverKeyName")
    def server_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the server key.
        """
        return pulumi.get(self, "server_key_name")
    ...
    @property
    @pulumi.getter(name="serverKeyType")
    def server_key_type(self) -> pulumi.Output[builtins.str]:
        """
        The encryption protector type like 'ServiceManaged', 'AzureKeyVault'.
        """
        return pulumi.get(self, "server_key_type")
