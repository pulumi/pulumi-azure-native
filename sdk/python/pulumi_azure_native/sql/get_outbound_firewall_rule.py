...
def get_outbound_firewall_rule(outbound_rule_fqdn: Optional[_builtins.str] = None,
...
def get_outbound_firewall_rule_output(outbound_rule_fqdn: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
