...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:GeoBackupPolicy'.""", DeprecationWarning)
...
class GeoBackupPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/latest:GeoBackupPolicy"), pulumi.Alias(type_="azure-native:sql:GeoBackupPolicy"), pulumi.Alias(type_="azure-nextgen:sql:GeoBackupPolicy"), pulumi.Alias(type_="azure-native:sql/v20140401:GeoBackupPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:GeoBackupPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GeoBackupPolicy, __self__).__init__(
            'azure-native:sql/latest:GeoBackupPolicy',
            resource_name,
            __props__,
            opts)
