...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:ServerCommunicationLink'.""", DeprecationWarning)
...
class ServerCommunicationLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/latest:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql/v20140401:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:ServerCommunicationLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerCommunicationLink, __self__).__init__(
            'azure-native:sql/latest:ServerCommunicationLink',
            resource_name,
            __props__,
            opts)
