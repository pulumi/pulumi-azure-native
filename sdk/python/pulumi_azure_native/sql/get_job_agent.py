...
def get_job_agent(job_agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str job_agent_name: The name of the job agent to be retrieved.
...
def get_job_agent_output(job_agent_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
