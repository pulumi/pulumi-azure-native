...
warnings.warn("""azure-native:sql/v20210801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_dns_alias(dns_alias_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_dns_alias is deprecated: azure-native:sql/v20210801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""")
    __args__ = dict()
