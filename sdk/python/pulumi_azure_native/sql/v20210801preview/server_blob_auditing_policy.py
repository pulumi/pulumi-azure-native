...
class ServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerBlobAuditingPolicy is deprecated: azure-native:sql/v20210801preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.""")
