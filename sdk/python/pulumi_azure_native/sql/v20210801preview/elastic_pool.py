...
class ElasticPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] high_availability_replica_count: The number of secondary replicas associated with the elastic pool that are used to provide high availability.
...
class ElasticPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ElasticPool, __self__).__init__(
            'azure-native:sql/v20210801preview:ElasticPool',
            resource_name,
            __props__,
            opts)
