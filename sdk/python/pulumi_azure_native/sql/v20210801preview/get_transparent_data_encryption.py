...
def get_transparent_data_encryption(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transparent_data_encryption is deprecated: azure-native:sql/v20210801preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:TransparentDataEncryption to guarantee forwards compatibility.""")
    __args__ = dict()
