...
def get_managed_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_database is deprecated: azure-native:sql/v20210801preview:ManagedDatabase is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedDatabase to guarantee forwards compatibility.""")
    __args__ = dict()
