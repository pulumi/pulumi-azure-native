...
def get_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: azure-native:sql/v20210801preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.""")
    __args__ = dict()
