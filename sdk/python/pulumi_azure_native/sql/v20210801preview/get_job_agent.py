...
def get_job_agent(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_agent is deprecated: azure-native:sql/v20210801preview:JobAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobAgent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['jobAgentName'] = job_agent_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210801preview:getJobAgent', __args__, opts=opts, typ=GetJobAgentResult).value
