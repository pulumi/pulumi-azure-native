...
def get_job_step(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_step is deprecated: azure-native:sql/v20210801preview:JobStep is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobStep to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210801preview:getJobStep', __args__, opts=opts, typ=GetJobStepResult).value
