...
warnings.warn("""azure-native:sql/v20210801preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_managed_instance_private_endpoint_connection(managed_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance_private_endpoint_connection is deprecated: azure-native:sql/v20210801preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
