...
def get_server_trust_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20210801preview:getServerTrustCertificate', __args__, opts=opts, typ=GetServerTrustCertificateResult)
