...
def get_sync_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: azure-native:sql/v20210801preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210801preview:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
