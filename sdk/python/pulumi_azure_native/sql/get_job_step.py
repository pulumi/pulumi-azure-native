...
def get_job_step(job_agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str job_agent_name: The name of the job agent.
    :param _builtins.str job_name: The name of the job.
    ...
    :param _builtins.str step_name: The name of the job step.
    """
    __args__ = dict()
