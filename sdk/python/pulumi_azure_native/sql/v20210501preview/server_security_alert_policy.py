...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20210501preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ServerSecurityAlertPolicy")])
