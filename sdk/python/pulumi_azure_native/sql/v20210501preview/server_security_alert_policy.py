...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_endpoint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerSecurityAlertPolicy is deprecated: azure-native:sql/v20210501preview:ServerSecurityAlertPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerSecurityAlertPolicy to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ServerSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerSecurityAlertPolicy, __self__).__init__(
            'azure-native:sql/v20210501preview:ServerSecurityAlertPolicy',
            resource_name,
            __props__,
            opts)
