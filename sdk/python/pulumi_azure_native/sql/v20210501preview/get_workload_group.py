...
warnings.warn("""azure-native:sql/v20210501preview:WorkloadGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workload_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_group is deprecated: azure-native:sql/v20210501preview:WorkloadGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadGroup to guarantee forwards compatibility.""")
    __args__ = dict()
