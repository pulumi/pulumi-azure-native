...
def get_job_step(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_step is deprecated: azure-native:sql/v20210501preview:JobStep is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobStep to guarantee forwards compatibility.""")
    __args__ = dict()
