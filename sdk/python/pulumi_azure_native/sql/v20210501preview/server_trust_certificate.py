...
class ServerTrustCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20221101preview:ServerTrustCertificate")])
