...
class JobAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20170301preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20200202preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20200801preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20201101preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20210201preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20210801preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20211101:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20211101preview:JobAgent"), pulumi.Alias(type_="azure-native:sql/v20220201preview:JobAgent")])
