...
def get_server_dns_alias(dns_alias_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_dns_alias is deprecated: azure-native:sql/v20210501preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerDnsAlias to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dnsAliasName'] = dns_alias_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210501preview:getServerDnsAlias', __args__, opts=opts, typ=GetServerDnsAliasResult).value
