...
class ManagedInstanceKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstanceKey is deprecated: azure-native:sql/v20210501preview:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20171001preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20211101:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ManagedInstanceKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedInstanceKey, __self__).__init__(
            'azure-native:sql/v20210501preview:ManagedInstanceKey',
            resource_name,
            __props__,
            opts)
