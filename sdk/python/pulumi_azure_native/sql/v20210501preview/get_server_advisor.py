...
def get_server_advisor(advisor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_advisor is deprecated: azure-native:sql/v20210501preview:ServerAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAdvisor to guarantee forwards compatibility.""")
    __args__ = dict()
