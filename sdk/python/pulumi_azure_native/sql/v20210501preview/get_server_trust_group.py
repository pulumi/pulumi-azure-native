...
warnings.warn("""azure-native:sql/v20210501preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_trust_group(location_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_trust_group is deprecated: azure-native:sql/v20210501preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['locationName'] = location_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverTrustGroupName'] = server_trust_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20210501preview:getServerTrustGroup', __args__, opts=opts, typ=GetServerTrustGroupResult).value
