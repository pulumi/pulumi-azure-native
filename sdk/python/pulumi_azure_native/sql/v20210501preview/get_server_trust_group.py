...
warnings.warn("""azure-native:sql/v20210501preview:ServerTrustGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_trust_group(location_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_trust_group is deprecated: azure-native:sql/v20210501preview:ServerTrustGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustGroup to guarantee forwards compatibility.""")
    __args__ = dict()
