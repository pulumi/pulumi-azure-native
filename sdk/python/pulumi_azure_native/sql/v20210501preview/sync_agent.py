...
class SyncAgent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20150501preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20200202preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20200801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20201101preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20210201preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20210801preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20211101:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20211101preview:SyncAgent"), pulumi.Alias(type_="azure-native:sql/v20220201preview:SyncAgent")])
