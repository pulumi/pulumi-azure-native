...
warnings.warn("""azure-native:sql/v20210501preview:BackupShortTermRetentionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
