...
warnings.warn("""azure-native:sql/v20210501preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.""", DeprecationWarning)
...
class JobCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""JobCredential is deprecated: azure-native:sql/v20210501preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20170301preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20200202preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20200801preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20201101preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20210201preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20210801preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20211101:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20211101preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20220201preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20220501preview:JobCredential"), pulumi.Alias(type_="azure-native:sql/v20220801preview:JobCredential")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobCredential, __self__).__init__(
            'azure-native:sql/v20210501preview:JobCredential',
            resource_name,
            __props__,
            opts)
