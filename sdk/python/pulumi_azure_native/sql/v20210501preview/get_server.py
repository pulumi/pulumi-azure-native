...
warnings.warn("""azure-native:sql/v20210501preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: azure-native:sql/v20210501preview:Server is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:Server to guarantee forwards compatibility.""")
    __args__ = dict()
