...
def get_job(job_agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str job_name: The name of the job to get.
...
def get_job_output(job_agent_name: Optional[pulumi.Input[_builtins.str]] = None,
