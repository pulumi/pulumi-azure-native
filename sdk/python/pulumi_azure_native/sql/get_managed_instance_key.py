...
def get_managed_instance_key(key_name: Optional[_builtins.str] = None,
                             managed_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key_name: The name of the managed instance key to be retrieved.
...
def get_managed_instance_key_output(key_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
