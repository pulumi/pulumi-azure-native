...
class SyncMemberArgs:
    def __init__(__self__, *,
                 ...
                 database_type: Optional[pulumi.Input[Union[builtins.str, 'SyncMemberDbType']]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 sql_server_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 sync_agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 sync_direction: Optional[pulumi.Input[Union[builtins.str, 'SyncDirection']]] = None,
                 sync_member_azure_database_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_name: Database name of the member database in the sync member.
        ...
        :param pulumi.Input[builtins.str] server_name: Server name of the member database in the sync member
        :param pulumi.Input[builtins.str] sync_group_name: The name of the sync group on which the sync member is hosted.
        :param pulumi.Input[Union[builtins.str, 'SyncMemberDbType']] database_type: Database type of the sync member.
        :param pulumi.Input[builtins.str] password: Password of the member database in the sync member.
        :param pulumi.Input[builtins.str] sql_server_database_id: SQL Server database id of the sync member.
        :param pulumi.Input[builtins.str] sync_agent_id: ARM resource id of the sync agent in the sync member.
        :param pulumi.Input[Union[builtins.str, 'SyncDirection']] sync_direction: Sync direction of the sync member.
        :param pulumi.Input[builtins.str] sync_member_azure_database_resource_id: ARM resource id of the sync member logical database, for sync members in Azure.
        :param pulumi.Input[builtins.str] sync_member_name: The name of the sync member.
        :param pulumi.Input[builtins.bool] use_private_link_connection: Whether to use private link connection.
        :param pulumi.Input[builtins.str] user_name: User name of the member database in the sync member.
        """
    ...
    def database_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'SyncMemberDbType']]]:
        """
    ...
    def database_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'SyncMemberDbType']]]):
    ...
    def sql_server_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_server_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_server_database_id", value)

    @property
    @pulumi.getter(name="syncAgentId")
    def sync_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_agent_id", value)

    @property
    @pulumi.getter(name="syncDirection")
    def sync_direction(self) -> Optional[pulumi.Input[Union[builtins.str, 'SyncDirection']]]:
        """
    ...
    def sync_direction(self, value: Optional[pulumi.Input[Union[builtins.str, 'SyncDirection']]]):
        pulumi.set(self, "sync_direction", value)

    @property
    @pulumi.getter(name="syncMemberAzureDatabaseResourceId")
    def sync_member_azure_database_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_member_azure_database_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_member_azure_database_resource_id", value)

    @property
    @pulumi.getter(name="syncMemberName")
    def sync_member_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_member_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SyncMember(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sqlServerDatabaseId")
    def sql_server_database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        SQL Server database id of the sync member.
        """
        return pulumi.get(self, "sql_server_database_id")
    ...
    @property
    @pulumi.getter(name="syncAgentId")
    def sync_agent_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM resource id of the sync agent in the sync member.
        """
        return pulumi.get(self, "sync_agent_id")
    ...
    @property
    @pulumi.getter(name="syncDirection")
    def sync_direction(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Sync direction of the sync member.
        """
        return pulumi.get(self, "sync_direction")
    ...
    @property
    @pulumi.getter(name="syncMemberAzureDatabaseResourceId")
    def sync_member_azure_database_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARM resource id of the sync member logical database, for sync members in Azure.
        """
        return pulumi.get(self, "sync_member_azure_database_resource_id")
