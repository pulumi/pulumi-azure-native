...
warnings.warn("""azure-native:sql/v20190601preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetSyncGroupResult:
    ...
    """
    def __init__(__self__, conflict_resolution_policy=None, hub_database_user_name=None, id=None, interval=None, last_sync_time=None, name=None, private_endpoint_name=None, schema=None, sync_database_id=None, sync_state=None, type=None, use_private_link_connection=None):
...
def get_sync_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: azure-native:sql/v20190601preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20190601preview:getSyncGroup', __args__, opts=opts, typ=GetSyncGroupResult).value
