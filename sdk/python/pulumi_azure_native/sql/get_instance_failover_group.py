...
def get_instance_failover_group(failover_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location_name: The name of the region where the resource is located.
...
def get_instance_failover_group_output(failover_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
