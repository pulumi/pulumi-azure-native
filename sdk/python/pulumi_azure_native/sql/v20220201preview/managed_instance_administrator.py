...
warnings.warn("""azure-native:sql/v20220201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedInstanceAdministrator is deprecated: azure-native:sql/v20220201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""")
        ...
        super(ManagedInstanceAdministrator, __self__).__init__(
            'azure-native:sql/v20220201preview:ManagedInstanceAdministrator',
            resource_name,
            __props__,
            opts)
