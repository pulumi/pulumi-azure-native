...
warnings.warn("""azure-native:sql/v20220201preview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_server_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_key is deprecated: azure-native:sql/v20220201preview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.""")
    __args__ = dict()
