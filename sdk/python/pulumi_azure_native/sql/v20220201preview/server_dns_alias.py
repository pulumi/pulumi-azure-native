...
warnings.warn("""azure-native:sql/v20220201preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""", DeprecationWarning)
