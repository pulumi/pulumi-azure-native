...
class JobCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 username: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""JobCredential is deprecated: azure-native:sql/v20220201preview:JobCredential is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:JobCredential to guarantee forwards compatibility.""")
