...
warnings.warn("""azure-native:sql/v20220201preview:DatabaseAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseAdvisor to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database_advisor(advisor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_advisor is deprecated: azure-native:sql/v20220201preview:DatabaseAdvisor is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DatabaseAdvisor to guarantee forwards compatibility.""")
    __args__ = dict()
