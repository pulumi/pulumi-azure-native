...
warnings.warn("""azure-native:sql/v20220201preview:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(WorkloadClassifier, __self__).__init__(
            'azure-native:sql/v20220201preview:WorkloadClassifier',
            resource_name,
            __props__,
            opts)
