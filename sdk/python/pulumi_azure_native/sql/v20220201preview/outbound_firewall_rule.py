...
warnings.warn("""azure-native:sql/v20220201preview:OutboundFirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:OutboundFirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
