...
warnings.warn("""azure-native:sql/v20220201preview:ServerAzureADOnlyAuthentication is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerAzureADOnlyAuthentication to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerAzureADOnlyAuthentication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ServerAzureADOnlyAuthentication, __self__).__init__(
            'azure-native:sql/v20220201preview:ServerAzureADOnlyAuthentication',
            resource_name,
            __props__,
            opts)
