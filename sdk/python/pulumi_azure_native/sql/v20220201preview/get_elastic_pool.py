...
def get_elastic_pool(elastic_pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_elastic_pool is deprecated: azure-native:sql/v20220201preview:ElasticPool is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ElasticPool to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['elasticPoolName'] = elastic_pool_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220201preview:getElasticPool', __args__, opts=opts, typ=GetElasticPoolResult).value
