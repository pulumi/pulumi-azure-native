...
warnings.warn("""azure-native:sql/v20220201preview:JobTargetGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobTargetGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class JobTargetGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""JobTargetGroup is deprecated: azure-native:sql/v20220201preview:JobTargetGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobTargetGroup to guarantee forwards compatibility.""")
