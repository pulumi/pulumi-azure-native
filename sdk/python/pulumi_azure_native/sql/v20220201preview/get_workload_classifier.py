...
def get_workload_classifier(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_classifier is deprecated: azure-native:sql/v20220201preview:WorkloadClassifier is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.""")
    __args__ = dict()
