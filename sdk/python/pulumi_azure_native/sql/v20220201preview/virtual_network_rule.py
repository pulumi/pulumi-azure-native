...
warnings.warn("""azure-native:sql/v20220201preview:VirtualNetworkRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:VirtualNetworkRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualNetworkRule, __self__).__init__(
            'azure-native:sql/v20220201preview:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
