...
def get_job_target_group(job_agent_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_target_group is deprecated: azure-native:sql/v20220201preview:JobTargetGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobTargetGroup to guarantee forwards compatibility.""")
    __args__ = dict()
