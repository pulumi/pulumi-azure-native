...
def get_outbound_firewall_rule(outbound_rule_fqdn: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_outbound_firewall_rule is deprecated: azure-native:sql/v20220201preview:OutboundFirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:OutboundFirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['outboundRuleFqdn'] = outbound_rule_fqdn
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220201preview:getOutboundFirewallRule', __args__, opts=opts, typ=GetOutboundFirewallRuleResult).value
