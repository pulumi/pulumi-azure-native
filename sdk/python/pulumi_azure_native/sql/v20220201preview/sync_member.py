...
warnings.warn("""azure-native:sql/v20220201preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.""", DeprecationWarning)
...
class SyncMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SyncMember is deprecated: azure-native:sql/v20220201preview:SyncMember is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncMember to guarantee forwards compatibility.""")
        ...
        super(SyncMember, __self__).__init__(
            'azure-native:sql/v20220201preview:SyncMember',
            resource_name,
            __props__,
            opts)
