...
warnings.warn("""azure-native:sql/v20220201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerAzureADAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerAzureADAdministrator is deprecated: azure-native:sql/v20220201preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerAzureADAdministrator to guarantee forwards compatibility.""")
