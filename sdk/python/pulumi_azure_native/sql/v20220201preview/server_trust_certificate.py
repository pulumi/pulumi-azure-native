...
warnings.warn("""azure-native:sql/v20220201preview:ServerTrustCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerTrustCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerTrustCertificate is deprecated: azure-native:sql/v20220201preview:ServerTrustCertificate is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerTrustCertificate to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20211101:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ServerTrustCertificate"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ServerTrustCertificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerTrustCertificate, __self__).__init__(
            'azure-native:sql/v20220201preview:ServerTrustCertificate',
            resource_name,
            __props__,
            opts)
