...
class ServerKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerKey is deprecated: azure-native:sql/v20220201preview:ServerKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.""")
