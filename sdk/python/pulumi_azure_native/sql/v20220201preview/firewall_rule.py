...
warnings.warn("""azure-native:sql/v20220201preview:FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(FirewallRule, __self__).__init__(
            'azure-native:sql/v20220201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
