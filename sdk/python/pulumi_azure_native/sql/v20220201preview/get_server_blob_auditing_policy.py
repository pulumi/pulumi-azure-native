...
def get_server_blob_auditing_policy(blob_auditing_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_blob_auditing_policy is deprecated: azure-native:sql/v20220201preview:ServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerBlobAuditingPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
