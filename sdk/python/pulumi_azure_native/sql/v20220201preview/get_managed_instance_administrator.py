...
def get_managed_instance_administrator(administrator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance_administrator is deprecated: azure-native:sql/v20220201preview:ManagedInstanceAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceAdministrator to guarantee forwards compatibility.""")
    __args__ = dict()
