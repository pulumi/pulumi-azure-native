...
def get_instance_pool(instance_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_pool_name: The name of the instance pool to be retrieved.
...
def get_instance_pool_output(instance_pool_name: pulumi.Input[Optional[_builtins.str]] = None,
