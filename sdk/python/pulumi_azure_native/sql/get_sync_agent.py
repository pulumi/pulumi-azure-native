...
def get_sync_agent(resource_group_name: Optional[_builtins.str] = None,
                   server_name: Optional[_builtins.str] = None,
                   sync_agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str server_name: The name of the server on which the sync agent is hosted.
    :param _builtins.str sync_agent_name: The name of the sync agent.
    """
    __args__ = dict()
