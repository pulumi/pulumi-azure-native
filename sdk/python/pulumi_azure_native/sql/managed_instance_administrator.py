...
class ManagedInstanceAdministratorArgs:
    ...
    def administrator_type(self, value: pulumi.Input[Union[_builtins.str, 'ManagedInstanceAdministratorType']]):
...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 administrator_name: pulumi.Input[Optional[_builtins.str]] = None,
                 administrator_type: pulumi.Input[Optional[Union[_builtins.str, 'ManagedInstanceAdministratorType']]] = None,
