...
class ServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] federated_client_id: The Client id used for cross tenant CMK scenario
        :param pulumi.Input['ResourceIdentityArgs'] identity: The Azure Active Directory identity of the server.
        :param pulumi.Input[Union[_builtins.str, 'ServerNetworkAccessFlag']] is_i_pv6_enabled: Whether or not to enable IPv6 support for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
        :param pulumi.Input[_builtins.str] key_id: A CMK URI of the key to use for encryption.
        :param pulumi.Input[_builtins.str] location: Resource location.
        :param pulumi.Input[Union[_builtins.str, 'MinimalTlsVersion']] minimal_tls_version: Minimal TLS version. Allowed values: 'None', 1.0', '1.1', '1.2', '1.3'
