...
class ServerArgs:
    def __init__(__self__, *,
                 ...
                 is_i_pv6_enabled: Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]] = None,
                 ...
                 public_network_access: Optional[pulumi.Input[Union[builtins.str, 'ServerPublicNetworkAccessFlag']]] = None,
                 restrict_outbound_network_access: Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_login: Administrator username for the server. Once created it cannot be changed.
        ...
        :param pulumi.Input[builtins.str] federated_client_id: The Client id used for cross tenant CMK scenario
        :param pulumi.Input['ResourceIdentityArgs'] identity: The Azure Active Directory identity of the server.
        :param pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']] is_i_pv6_enabled: Whether or not to enable IPv6 support for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
        ...
        :param pulumi.Input[Union[builtins.str, 'MinimalTlsVersion']] minimal_tls_version: Minimal TLS version. Allowed values: 'None', 1.0', '1.1', '1.2', '1.3'
        ...
        :param pulumi.Input[Union[builtins.str, 'ServerPublicNetworkAccessFlag']] public_network_access: Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled' or 'SecuredByPerimeter'
        :param pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']] restrict_outbound_network_access: Whether or not to restrict outbound network access for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
        :param pulumi.Input[builtins.str] server_name: The name of the server.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.str] version: The version of the server.
        """
    ...
    def is_i_pv6_enabled(self) -> Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]]:
        """
    ...
    def is_i_pv6_enabled(self, value: Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]]):
    ...
    def public_network_access(self) -> Optional[pulumi.Input[Union[builtins.str, 'ServerPublicNetworkAccessFlag']]]:
        """
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[builtins.str, 'ServerPublicNetworkAccessFlag']]]):
        pulumi.set(self, "public_network_access", value)

    @property
    @pulumi.getter(name="restrictOutboundNetworkAccess")
    def restrict_outbound_network_access(self) -> Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]]:
        """
    ...
    def restrict_outbound_network_access(self, value: Optional[pulumi.Input[Union[builtins.str, 'ServerNetworkAccessFlag']]]):
...
class Server(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isIPv6Enabled")
    def is_i_pv6_enabled(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether or not to enable IPv6 support for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
        """
        return pulumi.get(self, "is_i_pv6_enabled")
    ...
    def workspace_feature(self) -> pulumi.Output[builtins.str]:
        """
