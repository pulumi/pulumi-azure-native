...
def get_job_credential(credential_name: Optional[_builtins.str] = None,
                       job_agent_name: Optional[_builtins.str] = None,
...
def get_job_credential_output(credential_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
