...
warnings.warn("""azure-native:sql/v20220801preview:ServerDnsAlias is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerDnsAlias to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerDnsAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ServerDnsAlias, __self__).__init__(
            'azure-native:sql/v20220801preview:ServerDnsAlias',
            resource_name,
            __props__,
            opts)
