...
class ManagedInstanceAzureADOnlyAuthentication(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_instance_azure_ad_only_authentication = azure_native.sql.v20220801preview.ManagedInstanceAzureADOnlyAuthentication("managedInstanceAzureADOnlyAuthentication",
