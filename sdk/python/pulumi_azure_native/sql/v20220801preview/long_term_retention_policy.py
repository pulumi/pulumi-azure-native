...
class LongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        long_term_retention_policy = azure_native.sql.v20220801preview.LongTermRetentionPolicy("longTermRetentionPolicy",
        ...
        ```sh
        $ pulumi import azure-native:sql/v20220801preview:LongTermRetentionPolicy default /subscriptions/00000000-1111-2222-3333-444444444444/providers/Microsoft.Sql/resourceGroups/resourceGroup/servers/testserver/databases/testDatabase/backupLongTermRetentionPolicies/default 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(LongTermRetentionPolicy, __self__).__init__(
            'azure-native:sql/v20220801preview:LongTermRetentionPolicy',
            resource_name,
            __props__,
            opts)
