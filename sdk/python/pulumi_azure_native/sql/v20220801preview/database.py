...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 keys: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] keys: The resource ids of the user assigned identities to use
    ...
    @property
    @pulumi.getter
    def keys(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        """
    ...
    @keys.setter
    def keys(self, value: Optional[pulumi.Input[Mapping[str, Any]]]):
...
warnings.warn("""azure-native:sql/v20220801preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone_redundant: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""Database is deprecated: azure-native:sql/v20220801preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:Database to guarantee forwards compatibility.""")
        ...
        super(Database, __self__).__init__(
            'azure-native:sql/v20220801preview:Database',
            resource_name,
            __props__,
            opts)
