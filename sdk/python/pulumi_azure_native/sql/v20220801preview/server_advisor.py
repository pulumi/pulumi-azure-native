...
class ServerAdvisor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        server_advisor = azure_native.sql.v20220801preview.ServerAdvisor("serverAdvisor",
            advisor_name="CreateIndex",
            auto_execute_status=azure_native.sql/v20220801preview.AutoExecuteStatus.DISABLED,
    ...
    def _internal_init(__self__,
        ...
        super(ServerAdvisor, __self__).__init__(
            'azure-native:sql/v20220801preview:ServerAdvisor',
            resource_name,
            __props__,
            opts)
