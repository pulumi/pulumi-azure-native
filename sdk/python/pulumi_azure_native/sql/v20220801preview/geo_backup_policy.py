...
class GeoBackupPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 state: Optional[pulumi.Input['GeoBackupPolicyState']] = None,
                 __props__=None):
        pulumi.log.warn("""GeoBackupPolicy is deprecated: azure-native:sql/v20220801preview:GeoBackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:GeoBackupPolicy to guarantee forwards compatibility.""")
