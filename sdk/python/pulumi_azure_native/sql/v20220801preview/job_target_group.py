...
class JobTargetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        job_target_group = azure_native.sql.v20220801preview.JobTargetGroup("jobTargetGroup",
            job_agent_name="agent1",
            members=[
                azure_native.sql.v20220801preview.JobTargetArgs(
                    database_name="database1",
                    membership_type=azure_native.sql/v20220801preview.JobTargetGroupMembershipType.EXCLUDE,
                    server_name="server1",
                    type="SqlDatabase",
                ),
                azure_native.sql.v20220801preview.JobTargetArgs(
                    membership_type=azure_native.sql/v20220801preview.JobTargetGroupMembershipType.INCLUDE,
        ...
        ```sh
        $ pulumi import azure-native:sql/v20220801preview:JobTargetGroup targetGroup1 /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/jobAgents/agent1/targetGroups/targetGroup1 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(JobTargetGroup, __self__).__init__(
            'azure-native:sql/v20220801preview:JobTargetGroup',
            resource_name,
            __props__,
            opts)
