...
class DistributedAvailabilityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 target_database: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DistributedAvailabilityGroup is deprecated: azure-native:sql/v20220801preview:DistributedAvailabilityGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:DistributedAvailabilityGroup to guarantee forwards compatibility.""")
        ...
        super(DistributedAvailabilityGroup, __self__).__init__(
            'azure-native:sql/v20220801preview:DistributedAvailabilityGroup',
            resource_name,
            __props__,
            opts)
