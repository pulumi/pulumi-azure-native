...
warnings.warn("""azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ExtendedServerBlobAuditingPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class ExtendedServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExtendedServerBlobAuditingPolicy, __self__).__init__(
            'azure-native:sql/v20220801preview:ExtendedServerBlobAuditingPolicy',
            resource_name,
            __props__,
            opts)
