...
class DatabaseSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database_security_alert_policy = azure_native.sql.v20220801preview.DatabaseSecurityAlertPolicy("databaseSecurityAlertPolicy",
        ...
        ```sh
        $ pulumi import azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy default /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securityalert-4799/providers/Microsoft.Sql/servers/securityalert-6440/databases/testdb 
        ```
