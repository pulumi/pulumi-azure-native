...
def get_managed_instance_long_term_retention_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance_long_term_retention_policy is deprecated: azure-native:sql/v20220801preview:ManagedInstanceLongTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceLongTermRetentionPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220801preview:getManagedInstanceLongTermRetentionPolicy', __args__, opts=opts, typ=GetManagedInstanceLongTermRetentionPolicyResult).value
