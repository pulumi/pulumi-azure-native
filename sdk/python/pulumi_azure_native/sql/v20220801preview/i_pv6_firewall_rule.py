...
class IPv6FirewallRuleArgs:
    ...
    def end_i_pv6_address(self, value: Optional[pulumi.Input[str]]):
    ...
    def start_i_pv6_address(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def start_i_pv6_address(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "start_i_pv6_address", value)


warnings.warn("""azure-native:sql/v20220801preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class IPv6FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IPv6FirewallRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
                 ...
                 start_i_pv6_address: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IPv6FirewallRule is deprecated: azure-native:sql/v20220801preview:IPv6FirewallRule is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:IPv6FirewallRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20210801preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220201preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220501preview:IPv6FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IPv6FirewallRule, __self__).__init__(
            'azure-native:sql/v20220801preview:IPv6FirewallRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'IPv6FirewallRule':
        """
    ...
    @property
    @pulumi.getter(name="startIPv6Address")
    def start_i_pv6_address(self) -> pulumi.Output[Optional[str]]:
        """
        The start IP address of the firewall rule. Must be IPv6 format.
        """
        return pulumi.get(self, "start_i_pv6_address")
