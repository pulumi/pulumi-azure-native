...
class ManagedInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_instance = azure_native.sql.v20220801preview.ManagedInstance("managedInstance",
            administrator_login="dummylogin",
            administrator_login_password="PLACEHOLDER",
            administrators=azure_native.sql.v20220801preview.ManagedInstanceExternalAdministratorArgs(
            ...
            service_principal=azure_native.sql.v20220801preview.ServicePrincipalArgs(
                type="SystemAssigned",
            ),
