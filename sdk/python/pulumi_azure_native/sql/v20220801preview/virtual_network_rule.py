...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        virtual_network_rule = azure_native.sql.v20220801preview.VirtualNetworkRule("virtualNetworkRule",
        ...
        ```sh
        $ pulumi import azure-native:sql/v20220801preview:VirtualNetworkRule vnet-firewall-rule /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/vnet-test-svr/virtualNetworkRules/vnet-firewall-rule 
        ```
