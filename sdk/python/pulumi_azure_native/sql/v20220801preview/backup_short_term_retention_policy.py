...
warnings.warn("""azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:BackupShortTermRetentionPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
class BackupShortTermRetentionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BackupShortTermRetentionPolicy is deprecated: azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:BackupShortTermRetentionPolicy to guarantee forwards compatibility.""")
        ...
        super(BackupShortTermRetentionPolicy, __self__).__init__(
            'azure-native:sql/v20220801preview:BackupShortTermRetentionPolicy',
            resource_name,
            __props__,
            opts)
