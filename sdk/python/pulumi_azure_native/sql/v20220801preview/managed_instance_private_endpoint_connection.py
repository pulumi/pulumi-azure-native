...
warnings.warn("""azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstancePrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstancePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ManagedInstancePrivateEndpointConnection, __self__).__init__(
            'azure-native:sql/v20220801preview:ManagedInstancePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
