...
class ManagedInstancePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_instance_private_endpoint_connection = azure_native.sql.v20220801preview.ManagedInstancePrivateEndpointConnection("managedInstancePrivateEndpointConnection",
            managed_instance_name="test-cl",
            private_endpoint_connection_name="private-endpoint-connection-name",
            private_link_service_connection_state=azure_native.sql.v20220801preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponseArgs(
