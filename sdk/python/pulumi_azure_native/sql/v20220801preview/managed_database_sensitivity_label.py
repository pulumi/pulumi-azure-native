...
class ManagedDatabaseSensitivityLabel(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_database_sensitivity_label = azure_native.sql.v20220801preview.ManagedDatabaseSensitivityLabel("managedDatabaseSensitivityLabel",
            ...
            rank=azure_native.sql/v20220801preview.SensitivityLabelRank.HIGH,
