...
def get_sync_agent(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20220801preview:getSyncAgent', __args__, opts=opts, typ=GetSyncAgentResult).value
...
def get_sync_agent_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20220801preview:getSyncAgent', __args__, opts=opts, typ=GetSyncAgentResult)
