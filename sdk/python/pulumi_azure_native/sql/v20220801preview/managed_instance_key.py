...
warnings.warn("""azure-native:sql/v20220801preview:ManagedInstanceKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ManagedInstanceKey to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedInstanceKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ManagedInstanceKey, __self__).__init__(
            'azure-native:sql/v20220801preview:ManagedInstanceKey',
            resource_name,
            __props__,
            opts)
