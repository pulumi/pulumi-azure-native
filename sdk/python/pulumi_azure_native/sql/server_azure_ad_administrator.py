...
class ServerAzureADAdministratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] administrator_name: The name of server active directory administrator.
