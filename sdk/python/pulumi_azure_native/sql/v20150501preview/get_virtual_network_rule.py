...
warnings.warn("""azure-native:sql/v20150501preview:VirtualNetworkRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:VirtualNetworkRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_network_rule is deprecated: azure-native:sql/v20150501preview:VirtualNetworkRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:VirtualNetworkRule to guarantee forwards compatibility.""")
    __args__ = dict()
