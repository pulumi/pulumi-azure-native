...
warnings.warn("""azure-native:sql/v20150501preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_agent(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_agent is deprecated: azure-native:sql/v20150501preview:SyncAgent is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncAgent to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    __args__['syncAgentName'] = sync_agent_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20150501preview:getSyncAgent', __args__, opts=opts, typ=GetSyncAgentResult).value
