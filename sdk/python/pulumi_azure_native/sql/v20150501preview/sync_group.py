...
warnings.warn("""azure-native:sql/v20150501preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class SyncGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 sync_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SyncGroup is deprecated: azure-native:sql/v20150501preview:SyncGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""")
