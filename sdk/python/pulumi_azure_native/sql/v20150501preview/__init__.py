...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:sql/v20150501preview:ManagedInstance":
                return ManagedInstance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:ServerKey":
                return ServerKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:SyncAgent":
                return SyncAgent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:SyncGroup":
                return SyncGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:SyncMember":
                return SyncMember(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20150501preview:VirtualNetworkRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "sql/v20150501preview", _module_instance)
