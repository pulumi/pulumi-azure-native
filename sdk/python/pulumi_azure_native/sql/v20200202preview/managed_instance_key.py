...
class ManagedInstanceKey(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20171001preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20171001preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ManagedInstanceKey"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ManagedInstanceKey")])
