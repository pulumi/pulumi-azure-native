...
warnings.warn("""azure-native:sql/v20200202preview:SyncGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sync_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sync_group is deprecated: azure-native:sql/v20200202preview:SyncGroup is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SyncGroup to guarantee forwards compatibility.""")
    __args__ = dict()
