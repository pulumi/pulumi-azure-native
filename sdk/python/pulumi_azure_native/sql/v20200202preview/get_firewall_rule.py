...
warnings.warn("""azure-native:sql/v20200202preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_firewall_rule(firewall_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: azure-native:sql/v20200202preview:FirewallRule is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:FirewallRule to guarantee forwards compatibility.""")
    __args__ = dict()
