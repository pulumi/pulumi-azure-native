...
def get_managed_instance_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_instance_key is deprecated: azure-native:sql/v20200202preview:ManagedInstanceKey is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ManagedInstanceKey to guarantee forwards compatibility.""")
    __args__ = dict()
