...
class LongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 yearly_retention: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""LongTermRetentionPolicy is deprecated: azure-native:sql/v20200202preview:LongTermRetentionPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:LongTermRetentionPolicy to guarantee forwards compatibility.""")
