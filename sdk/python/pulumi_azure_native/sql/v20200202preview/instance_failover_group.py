...
warnings.warn("""azure-native:sql/v20200202preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstanceFailoverGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class InstanceFailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""InstanceFailoverGroup is deprecated: azure-native:sql/v20200202preview:InstanceFailoverGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:InstanceFailoverGroup to guarantee forwards compatibility.""")
