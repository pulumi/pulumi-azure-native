...
def get_workload_group(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_group is deprecated: azure-native:sql/v20200202preview:WorkloadGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:WorkloadGroup to guarantee forwards compatibility.""")
    __args__ = dict()
