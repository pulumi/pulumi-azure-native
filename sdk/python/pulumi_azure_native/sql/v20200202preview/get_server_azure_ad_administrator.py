...
def get_server_azure_ad_administrator(administrator_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_azure_ad_administrator is deprecated: azure-native:sql/v20200202preview:ServerAzureADAdministrator is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:ServerAzureADAdministrator to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['administratorName'] = administrator_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20200202preview:getServerAzureADAdministrator', __args__, opts=opts, typ=GetServerAzureADAdministratorResult).value
