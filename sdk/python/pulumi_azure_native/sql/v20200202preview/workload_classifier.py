...
class WorkloadClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workload_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadClassifier is deprecated: azure-native:sql/v20200202preview:WorkloadClassifier is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:WorkloadClassifier to guarantee forwards compatibility.""")
        ...
        super(WorkloadClassifier, __self__).__init__(
            'azure-native:sql/v20200202preview:WorkloadClassifier',
            resource_name,
            __props__,
            opts)
