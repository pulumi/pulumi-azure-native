...
def get_job_credential(credential_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_credential is deprecated: azure-native:sql/v20200202preview:JobCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:JobCredential to guarantee forwards compatibility.""")
    __args__ = dict()
