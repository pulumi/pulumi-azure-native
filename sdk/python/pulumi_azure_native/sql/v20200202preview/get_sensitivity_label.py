...
warnings.warn("""azure-native:sql/v20200202preview:SensitivityLabel is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SensitivityLabel to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sensitivity_label(column_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sensitivity_label is deprecated: azure-native:sql/v20200202preview:SensitivityLabel is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:SensitivityLabel to guarantee forwards compatibility.""")
    __args__ = dict()
