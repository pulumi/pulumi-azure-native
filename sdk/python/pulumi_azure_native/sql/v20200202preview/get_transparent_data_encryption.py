...
def get_transparent_data_encryption(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transparent_data_encryption is deprecated: azure-native:sql/v20200202preview:TransparentDataEncryption is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:TransparentDataEncryption to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20200202preview:getTransparentDataEncryption', __args__, opts=opts, typ=GetTransparentDataEncryptionResult).value
