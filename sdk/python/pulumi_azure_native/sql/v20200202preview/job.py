...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:Job"), pulumi.Alias(type_="azure-nextgen:sql:Job"), pulumi.Alias(type_="azure-native:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-native:sql/v20200801preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:Job")])
