...
warnings.warn("""azure-native:sql/v20200202preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.""", DeprecationWarning)
...
class ServerKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ServerKey is deprecated: azure-native:sql/v20200202preview:ServerKey is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20220801preview:ServerKey to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20150501preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20210501preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20210801preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20211101:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ServerKey"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ServerKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerKey, __self__).__init__(
            'azure-native:sql/v20200202preview:ServerKey',
            resource_name,
            __props__,
            opts)
