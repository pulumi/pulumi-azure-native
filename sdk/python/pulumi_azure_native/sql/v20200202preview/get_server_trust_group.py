...
def get_server_trust_group(location_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_trust_group is deprecated: azure-native:sql/v20200202preview:ServerTrustGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:sql/v20221101preview:ServerTrustGroup to guarantee forwards compatibility.""")
    __args__ = dict()
