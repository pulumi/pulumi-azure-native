...
warnings.warn("""azure-native:sql/v20200202preview:EncryptionProtector is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_encryption_protector(encryption_protector_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_encryption_protector is deprecated: azure-native:sql/v20200202preview:EncryptionProtector is being removed in the next major version of this provider. Please upgrade to azure-native:sql/v20220801preview:EncryptionProtector to guarantee forwards compatibility.""")
    __args__ = dict()
