...
def get_job_private_endpoint(job_agent_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_endpoint_name: The name of the private endpoint to get.
