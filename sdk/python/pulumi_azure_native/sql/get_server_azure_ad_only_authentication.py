...
def get_server_azure_ad_only_authentication(authentication_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str authentication_name: The name of server azure active directory only authentication.
...
def get_server_azure_ad_only_authentication_output(authentication_name: Optional[pulumi.Input[_builtins.str]] = None,
