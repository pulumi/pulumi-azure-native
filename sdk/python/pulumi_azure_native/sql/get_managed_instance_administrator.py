...
def get_managed_instance_administrator(administrator_name: Optional[_builtins.str] = None,
...
def get_managed_instance_administrator_output(administrator_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
