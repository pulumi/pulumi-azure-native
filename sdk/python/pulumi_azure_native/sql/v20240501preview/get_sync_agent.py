...
def get_sync_agent(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getSyncAgent', __args__, opts=opts, typ=GetSyncAgentResult).value
...
def get_sync_agent_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['syncAgentName'] = sync_agent_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getSyncAgent', __args__, opts=opts, typ=GetSyncAgentResult)
