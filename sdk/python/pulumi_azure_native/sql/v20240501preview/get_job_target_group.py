...
def get_job_target_group(job_agent_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getJobTargetGroup', __args__, opts=opts, typ=GetJobTargetGroupResult).value
...
def get_job_target_group_output(job_agent_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['targetGroupName'] = target_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getJobTargetGroup', __args__, opts=opts, typ=GetJobTargetGroupResult)
