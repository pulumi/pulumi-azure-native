...
class JobPrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:JobPrivateEndpoint"), pulumi.Alias(type_="azure-native:sql/v20230501preview:JobPrivateEndpoint"), pulumi.Alias(type_="azure-native:sql/v20230801preview:JobPrivateEndpoint")])
