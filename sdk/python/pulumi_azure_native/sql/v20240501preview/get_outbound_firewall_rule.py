...
def get_outbound_firewall_rule(outbound_rule_fqdn: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getOutboundFirewallRule', __args__, opts=opts, typ=GetOutboundFirewallRuleResult).value
...
def get_outbound_firewall_rule_output(outbound_rule_fqdn: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getOutboundFirewallRule', __args__, opts=opts, typ=GetOutboundFirewallRuleResult)
