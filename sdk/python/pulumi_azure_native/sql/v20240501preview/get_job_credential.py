...
def get_job_credential(credential_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getJobCredential', __args__, opts=opts, typ=GetJobCredentialResult).value
...
def get_job_credential_output(credential_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getJobCredential', __args__, opts=opts, typ=GetJobCredentialResult)
