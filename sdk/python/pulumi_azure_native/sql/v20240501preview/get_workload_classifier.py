...
def get_workload_classifier(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getWorkloadClassifier', __args__, opts=opts, typ=GetWorkloadClassifierResult).value
...
def get_workload_classifier_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workloadGroupName'] = workload_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getWorkloadClassifier', __args__, opts=opts, typ=GetWorkloadClassifierResult)
