...
def get_server_trust_group(location_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getServerTrustGroup', __args__, opts=opts, typ=GetServerTrustGroupResult).value
...
def get_server_trust_group_output(location_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverTrustGroupName'] = server_trust_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getServerTrustGroup', __args__, opts=opts, typ=GetServerTrustGroupResult)
