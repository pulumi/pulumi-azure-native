...
def get_sync_member(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getSyncMember', __args__, opts=opts, typ=GetSyncMemberResult).value
...
def get_sync_member_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['syncMemberName'] = sync_member_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getSyncMember', __args__, opts=opts, typ=GetSyncMemberResult)
