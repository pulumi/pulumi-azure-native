...
def get_managed_instance_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20240501preview:getManagedInstanceKey', __args__, opts=opts, typ=GetManagedInstanceKeyResult).value
...
def get_managed_instance_key_output(key_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20240501preview:getManagedInstanceKey', __args__, opts=opts, typ=GetManagedInstanceKeyResult)
