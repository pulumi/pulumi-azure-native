...
class StartStopManagedInstanceSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 schedule_list: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ScheduleItemArgs', 'ScheduleItemArgsDict']]]]] = None,
                 start_stop_schedule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 time_zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20221101preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230501preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230801:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230801preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20240501preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20241101preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20250101:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20250201preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20250801preview:StartStopManagedInstanceSchedule")])
