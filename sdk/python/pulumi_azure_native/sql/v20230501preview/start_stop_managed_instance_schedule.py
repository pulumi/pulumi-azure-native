...
class StartStopManagedInstanceSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20221101preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule"), pulumi.Alias(type_="azure-native:sql/v20230801preview:StartStopManagedInstanceSchedule")])
