...
def get_encryption_protector(encryption_protector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230501preview:getEncryptionProtector', __args__, opts=opts, typ=GetEncryptionProtectorResult).value
...
def get_encryption_protector_output(encryption_protector_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230501preview:getEncryptionProtector', __args__, opts=opts, typ=GetEncryptionProtectorResult)
