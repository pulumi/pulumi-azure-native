...
class ManagedInstanceLongTermRetentionPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] monthly_retention: The monthly retention policy for an LTR backup.
        :param pulumi.Input[str] policy_name: The policy name. Should always be Default.
        :param pulumi.Input[int] week_of_year: The week of year to take the yearly backup.
        :param pulumi.Input[str] weekly_retention: The weekly retention policy for an LTR backup.
        :param pulumi.Input[str] yearly_retention: The yearly retention policy for an LTR backup.
        """
...
class ManagedInstanceLongTermRetentionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ManagedInstanceLongTermRetentionPolicy, __self__).__init__(
            'azure-native:sql/v20230501preview:ManagedInstanceLongTermRetentionPolicy',
            resource_name,
            __props__,
            opts)
