...
class IPv6FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20210801preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20211101preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220201preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220501preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20220801preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20221101preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230201preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230801:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20230801preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql/v20240501preview:IPv6FirewallRule"), pulumi.Alias(type_="azure-native:sql:IPv6FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IPv6FirewallRule, __self__).__init__(
            'azure-native:sql/v20230501preview:IPv6FirewallRule',
            resource_name,
            __props__,
            opts)
