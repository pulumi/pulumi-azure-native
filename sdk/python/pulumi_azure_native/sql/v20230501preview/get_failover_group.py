...
def get_failover_group(failover_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20230501preview:getFailoverGroup', __args__, opts=opts, typ=GetFailoverGroupResult).value
...
def get_failover_group_output(failover_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20230501preview:getFailoverGroup', __args__, opts=opts, typ=GetFailoverGroupResult)
