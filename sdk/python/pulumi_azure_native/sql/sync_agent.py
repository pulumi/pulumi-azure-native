...
class SyncAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_name: The name of the server on which the sync agent is hosted.
        :param pulumi.Input[builtins.str] sync_agent_name: The name of the sync agent.
        :param pulumi.Input[builtins.str] sync_database_id: ARM resource id of the sync database in the sync agent.
        """
    ...
    def sync_agent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_agent_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SyncAgent(pulumi.CustomResource):
    ...
    def is_up_to_date(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def last_alive_time(self) -> pulumi.Output[builtins.str]:
        """
