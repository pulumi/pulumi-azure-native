...
def get_managed_database_sensitivity_label(column_name: Optional[builtins.str] = None,
...
def get_managed_database_sensitivity_label_output(column_name: Optional[pulumi.Input[builtins.str]] = None,
