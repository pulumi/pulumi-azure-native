...
def get_elastic_pool(elastic_pool_name: Optional[builtins.str] = None,
    ...
    :param builtins.str elastic_pool_name: The name of the elastic pool.
...
def get_elastic_pool_output(elastic_pool_name: Optional[pulumi.Input[builtins.str]] = None,
