...
def get_elastic_pool(elastic_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str elastic_pool_name: The name of the elastic pool.
...
def get_elastic_pool_output(elastic_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
