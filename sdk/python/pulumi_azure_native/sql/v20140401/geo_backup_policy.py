...
class GeoBackupPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:GeoBackupPolicy"), pulumi.Alias(type_="azure-nextgen:sql:GeoBackupPolicy"), pulumi.Alias(type_="azure-native:sql/latest:GeoBackupPolicy"), pulumi.Alias(type_="azure-nextgen:sql/latest:GeoBackupPolicy")])
