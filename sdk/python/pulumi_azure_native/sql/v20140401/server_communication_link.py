...
class ServerCommunicationLink(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql/latest:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql/latest:ServerCommunicationLink")])
