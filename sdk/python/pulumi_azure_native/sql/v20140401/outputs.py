...
class RecommendedIndexResponse(dict):
    ...
    def _configure(
        ...
        if 'includedColumns' in kwargs:
            included_columns = kwargs['includedColumns']
        if 'indexScript' in kwargs:
...
class ServiceTierAdvisorResponse(dict):
    ...
    def _configure(
        ...
        if 'disasterPlanBasedRecommendationServiceLevelObjective' in kwargs:
            disaster_plan_based_recommendation_service_level_objective = kwargs['disasterPlanBasedRecommendationServiceLevelObjective']
        if 'disasterPlanBasedRecommendationServiceLevelObjectiveId' in kwargs:
...
class SloUsageMetricResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'inRangeTimeRatio' in kwargs:
            in_range_time_ratio = kwargs['inRangeTimeRatio']
        if 'serviceLevelObjective' in kwargs:
            service_level_objective = kwargs['serviceLevelObjective']
        if 'serviceLevelObjectiveId' in kwargs:
