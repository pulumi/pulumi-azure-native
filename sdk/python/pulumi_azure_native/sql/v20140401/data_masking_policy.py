...
class DataMaskingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        data_masking_policy = azure_native.sql.v20140401.DataMaskingPolicy("dataMaskingPolicy",
            data_masking_policy_name="Default",
            data_masking_state=azure_native.sql/v20140401.DataMaskingState.ENABLED,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220201preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220801preview:DataMaskingPolicy")])
