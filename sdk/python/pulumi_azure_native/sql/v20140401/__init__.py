...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:sql/v20140401:DisasterRecoveryConfiguration":
                return DisasterRecoveryConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:ElasticPool":
                return ElasticPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:GeoBackupPolicy":
                return GeoBackupPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:ServerAzureADAdministrator":
                return ServerAzureADAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:ServerCommunicationLink":
                return ServerCommunicationLink(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20140401:TransparentDataEncryption":
    ...
    pulumi.runtime.register_resource_module("azure-native", "sql/v20140401", _module_instance)
