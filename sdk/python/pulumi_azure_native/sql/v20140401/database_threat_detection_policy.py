...
class DatabaseThreatDetectionPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20140401:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-nextgen:sql:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql/latest:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/latest:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql/v20180601preview:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20180601preview:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:DatabaseThreatDetectionPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:DatabaseThreatDetectionPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseThreatDetectionPolicy, __self__).__init__(
            'azure-native:sql/v20140401:DatabaseThreatDetectionPolicy',
            resource_name,
            __props__,
            opts)
