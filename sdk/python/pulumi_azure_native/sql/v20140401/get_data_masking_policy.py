...
def get_data_masking_policy(data_masking_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20140401:getDataMaskingPolicy', __args__, opts=opts, typ=GetDataMaskingPolicyResult).value
...
def get_data_masking_policy_output(data_masking_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20140401:getDataMaskingPolicy', __args__, opts=opts, typ=GetDataMaskingPolicyResult)
