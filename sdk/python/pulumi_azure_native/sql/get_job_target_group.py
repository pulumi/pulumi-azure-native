...
def get_job_target_group(job_agent_name: Optional[_builtins.str] = None,
...
def get_job_target_group_output(job_agent_name: Optional[pulumi.Input[_builtins.str]] = None,
