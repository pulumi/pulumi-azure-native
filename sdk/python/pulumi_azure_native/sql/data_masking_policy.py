...
class DataMaskingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20140401:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20211101:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220201preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20220801preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20221101preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230201preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230801:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230801preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20240501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20241101preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20250101:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20250201preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20250801preview:DataMaskingPolicy")])
