...
class DataMaskingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20211101:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20221101preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230201preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20230801preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native:sql/v20240501preview:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20140401:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20211101:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20220201preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20220501preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20220801preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20221101preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20230201preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20230501preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20230801:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20230801preview:sql:DataMaskingPolicy"), pulumi.Alias(type_="azure-native_sql_v20240501preview:sql:DataMaskingPolicy")])
