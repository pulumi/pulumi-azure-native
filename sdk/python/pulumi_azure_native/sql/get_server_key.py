...
def get_server_key(key_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key_name: The name of the server key to be retrieved.
...
def get_server_key_output(key_name: pulumi.Input[Optional[_builtins.str]] = None,
