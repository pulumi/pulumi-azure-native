...
def get_server(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20221101preview:getServer', __args__, opts=opts, typ=GetServerResult).value
...
def get_server_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20221101preview:getServer', __args__, opts=opts, typ=GetServerResult)
