...
class BackupShortTermRetentionPolicyArgs:
    ...
    def _configure(
        ...
        if diff_backup_interval_in_hours is None and 'diffBackupIntervalInHours' in kwargs:
