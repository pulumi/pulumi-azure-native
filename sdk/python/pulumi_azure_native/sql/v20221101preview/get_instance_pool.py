...
def get_instance_pool(instance_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20221101preview:getInstancePool', __args__, opts=opts, typ=GetInstancePoolResult).value
...
def get_instance_pool_output(instance_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20221101preview:getInstancePool', __args__, opts=opts, typ=GetInstancePoolResult)
