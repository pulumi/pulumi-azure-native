...
def get_managed_instance_long_term_retention_policy(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20221101preview:getManagedInstanceLongTermRetentionPolicy', __args__, opts=opts, typ=GetManagedInstanceLongTermRetentionPolicyResult).value
