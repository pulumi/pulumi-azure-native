...
class JobStep(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if action is not None and not isinstance(action, JobStepActionArgs):
                action = action or {}
                def _setter(key, value):
                    action[key] = value
            ...
            if execution_options is not None and not isinstance(execution_options, JobStepExecutionOptionsArgs):
            ...
            if output is not None and not isinstance(output, JobStepOutputArgs):
                output = output or {}
                def _setter(key, value):
                    output[key] = value
