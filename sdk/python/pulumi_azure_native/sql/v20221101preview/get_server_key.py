...
def get_server_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20221101preview:getServerKey', __args__, opts=opts, typ=GetServerKeyResult).value
...
def get_server_key_output(key_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20221101preview:getServerKey', __args__, opts=opts, typ=GetServerKeyResult)
