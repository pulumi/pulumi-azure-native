...
class ManagedServerDnsAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:sql/v20211101:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20211101preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20220201preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20220501preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20220801preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20230201preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20230501preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20230801:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20230801preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20240501preview:ManagedServerDnsAlias"), pulumi.Alias(type_="azure-native:sql:ManagedServerDnsAlias")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedServerDnsAlias, __self__).__init__(
            'azure-native:sql/v20221101preview:ManagedServerDnsAlias',
            resource_name,
            __props__,
            opts)
