...
def get_elastic_pool(elastic_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/v20221101preview:getElasticPool', __args__, opts=opts, typ=GetElasticPoolResult).value
...
def get_elastic_pool_output(elastic_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serverName'] = server_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:sql/v20221101preview:getElasticPool', __args__, opts=opts, typ=GetElasticPoolResult)
