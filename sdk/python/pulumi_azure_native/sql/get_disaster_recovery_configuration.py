...
def get_disaster_recovery_configuration(disaster_recovery_configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str disaster_recovery_configuration_name: The name of the disaster recovery configuration.
...
def get_disaster_recovery_configuration_output(disaster_recovery_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
