...
def get_geo_backup_policy(database_name: Optional[_builtins.str] = None,
                          geo_backup_policy_name: Optional[_builtins.str] = None,
...
def get_geo_backup_policy_output(database_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 geo_backup_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
