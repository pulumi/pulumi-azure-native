...
class ManagedInstanceKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'ServerKeyType']] server_key_type: The key type like 'ServiceManaged', 'AzureKeyVault'.
        :param pulumi.Input[builtins.str] key_name: The name of the managed instance key to be operated on (updated or created).
        :param pulumi.Input[builtins.str] uri: The URI of the key. If the ServerKeyType is AzureKeyVault, then the URI is required.
        """
