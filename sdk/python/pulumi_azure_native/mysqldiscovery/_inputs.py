...
class ErrorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The error ID.
        :param pulumi.Input[_builtins.str] message: The detailed error message.
        :param pulumi.Input[_builtins.str] possible_cause: The error possible cause.
        :param pulumi.Input[_builtins.str] recommended_action: Gets description of the checkpoint.
        :param pulumi.Input[_builtins.str] run_as_account_id: The account ID used to login.
        :param pulumi.Input[_builtins.str] severity: Gets description of the severity.
        :param pulumi.Input[_builtins.str] summary_message: The summarized error message.
        :param pulumi.Input[_builtins.str] updated_time_stamp: Time when this error was last updated.
        """
        if code is not None:
