...
class MySQLSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mysqldiscovery:MySQLSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MySQLSite, __self__).__init__(
            'azure-native:mysqldiscovery/v20240930preview:MySQLSite',
            resource_name,
            __props__,
            opts)
