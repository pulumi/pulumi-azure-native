...
def get_my_sql_site(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mysqldiscovery/v20240930preview:getMySQLSite', __args__, opts=opts, typ=GetMySQLSiteResult).value
...
def get_my_sql_site_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mysqldiscovery/v20240930preview:getMySQLSite', __args__, opts=opts, typ=GetMySQLSiteResult)
