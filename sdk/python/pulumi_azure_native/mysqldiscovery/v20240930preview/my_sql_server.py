...
class MySQLServerArgs:
    def __init__(__self__, *,
                 ...
                 port_number: pulumi.Input[str],
                 resource_group_name: pulumi.Input[str],
                 site_name: pulumi.Input[str],
                 edition: Optional[pulumi.Input[Union[str, 'Edition']]] = None,
                 errors: Optional[pulumi.Input[Sequence[pulumi.Input['ErrorArgs']]]] = None,
                 host_ip: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 machine_id: Optional[pulumi.Input[str]] = None,
                 mysql_version: Optional[pulumi.Input[str]] = None,
                 number_of_database: Optional[pulumi.Input[float]] = None,
                 provisioning_state: Optional[pulumi.Input[Union[str, 'ProvisioningState']]] = None,
                 server_name: Optional[pulumi.Input[str]] = None,
                 support_end_in: Optional[pulumi.Input[str]] = None,
                 support_status: Optional[pulumi.Input[Union[str, 'SupportStatus']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None):
        """
        The set of arguments for constructing a MySQLServer resource.
        :param pulumi.Input[str] host_name: The Server IP/host name.
        :param pulumi.Input[str] port_number: MySQL Server port number
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] site_name: The name of Site
        :param pulumi.Input[Union[str, 'Edition']] edition: mysql server edition.
        :param pulumi.Input[Sequence[pulumi.Input['ErrorArgs']]] errors: The list of errors.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] host_ip: The Server IP/host name.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Resource labels.
        :param pulumi.Input[str] machine_id: discovery Machine Id
        :param pulumi.Input[str] mysql_version: The mysql server version.
        :param pulumi.Input[float] number_of_database: The number of database.
        :param pulumi.Input[Union[str, 'ProvisioningState']] provisioning_state: Gets or sets the provisioning state.
        :param pulumi.Input[str] server_name: The name of Server
        :param pulumi.Input[str] support_end_in: Time when mysql version support end.
        :param pulumi.Input[Union[str, 'SupportStatus']] support_status: mysql version support status.
    ...
    def port_number(self) -> pulumi.Input[str]:
        """
    ...
    @port_number.setter
    def port_number(self, value: pulumi.Input[str]):
    ...
    @property
    @pulumi.getter
    def edition(self) -> Optional[pulumi.Input[Union[str, 'Edition']]]:
        """
    ...
    @edition.setter
    def edition(self, value: Optional[pulumi.Input[Union[str, 'Edition']]]):
    ...
    def host_ip(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        The Server IP/host name.
        """
    ...
    @host_ip.setter
    def host_ip(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def number_of_database(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def number_of_database(self, value: Optional[pulumi.Input[float]]):
    ...
    def support_end_in(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def support_end_in(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "support_end_in", value)

    @property
    @pulumi.getter(name="supportStatus")
    def support_status(self) -> Optional[pulumi.Input[Union[str, 'SupportStatus']]]:
        """
    ...
    def support_status(self, value: Optional[pulumi.Input[Union[str, 'SupportStatus']]]):
...
class MySQLServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:mysqldiscovery:MySQLServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MySQLServer, __self__).__init__(
            'azure-native:mysqldiscovery/v20240930preview:MySQLServer',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="hostIp")
    def host_ip(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        The Server IP/host name.
        """
        return pulumi.get(self, "host_ip")
    ...
    @property
    @pulumi.getter(name="machineId")
    def machine_id(self) -> pulumi.Output[Optional[str]]:
        """
        discovery Machine Id
        """
        return pulumi.get(self, "machine_id")
    ...
    @property
    @pulumi.getter(name="numberOfDatabase")
    def number_of_database(self) -> pulumi.Output[Optional[float]]:
        """
        The number of database.
        """
        return pulumi.get(self, "number_of_database")
    ...
    @property
    @pulumi.getter(name="supportEndIn")
    def support_end_in(self) -> pulumi.Output[Optional[str]]:
        """
        Time when mysql version support end.
        """
        return pulumi.get(self, "support_end_in")
    ...
    @property
    @pulumi.getter(name="supportStatus")
    def support_status(self) -> pulumi.Output[Optional[str]]:
        """
        mysql version support status.
        """
        return pulumi.get(self, "support_status")
