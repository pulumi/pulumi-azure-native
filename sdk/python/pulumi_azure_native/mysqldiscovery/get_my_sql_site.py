...
class GetMySQLSiteResult:
    ...
    """
    def __init__(__self__, extended_location=None, id=None, location=None, master_site_id=None, migrate_project_id=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
