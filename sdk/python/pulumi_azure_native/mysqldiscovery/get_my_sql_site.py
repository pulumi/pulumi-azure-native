...
__all__ = [
    'GetMySQLSiteResult',
    'AwaitableGetMySQLSiteResult',
    'get_my_sql_site',
    'get_my_sql_site_output',
]
...
class GetMySQLSiteResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, extended_location=None, id=None, location=None, master_site_id=None, migrate_project_id=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
    ...
    def migrate_project_id(self) -> _builtins.str:
        """
...
class AwaitableGetMySQLSiteResult(GetMySQLSiteResult):
...
def get_my_sql_site(resource_group_name: Optional[_builtins.str] = None,
                    site_name: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMySQLSiteResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mysqldiscovery:getMySQLSite', __args__, opts=opts, typ=GetMySQLSiteResult).value

    return AwaitableGetMySQLSiteResult(
...
def get_my_sql_site_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                           site_name: Optional[pulumi.Input[_builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMySQLSiteResult]:
    """
    Gets the MySQLSites resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:mysqldiscovery:getMySQLSite', __args__, opts=opts, typ=GetMySQLSiteResult)
    return __ret__.apply(lambda __response__: GetMySQLSiteResult(
