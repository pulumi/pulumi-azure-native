...
class MySQLServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] host_ip: The Server IP/host name.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Resource labels.
        :param pulumi.Input[_builtins.str] machine_id: discovery Machine Id
