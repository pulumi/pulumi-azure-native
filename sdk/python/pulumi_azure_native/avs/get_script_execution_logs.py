...
class GetScriptExecutionLogsResult:
    ...
    @property
    @pulumi.getter
    def information(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def output(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def script_cmdlet_id(self) -> Optional[builtins.str]:
        """
...
def get_script_execution_logs(private_cloud_name: Optional[builtins.str] = None,
                              resource_group_name: Optional[builtins.str] = None,
                              script_execution_name: Optional[builtins.str] = None,
    ...
    :param builtins.str script_execution_name: Name of the script cmdlet.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs:getScriptExecutionLogs', __args__, opts=opts, typ=GetScriptExecutionLogsResult).value
...
def get_script_execution_logs_output(private_cloud_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs:getScriptExecutionLogs', __args__, opts=opts, typ=GetScriptExecutionLogsResult)
