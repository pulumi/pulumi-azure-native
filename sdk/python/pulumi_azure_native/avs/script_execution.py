...
class ScriptExecutionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] output: Standard output stream from the powershell execution
