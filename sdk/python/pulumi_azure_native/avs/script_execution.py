...
class ScriptExecutionArgs:
    def __init__(__self__, *,
                 ...
                 output: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 script_cmdlet_id: Optional[pulumi.Input[builtins.str]] = None,
                 script_execution_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] timeout: Time limit for execution
        :param pulumi.Input[builtins.str] failure_reason: Error message if the script was able to run, but if the script itself had
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] output: Standard output stream from the powershell execution
        ...
        :param pulumi.Input[builtins.str] retention: Time to live for the resource. If not provided, will be available for 60 days
        :param pulumi.Input[builtins.str] script_cmdlet_id: A reference to the script cmdlet resource if user is running a AVS script
        :param pulumi.Input[builtins.str] script_execution_name: Name of the script cmdlet.
        """
    ...
    @property
    @pulumi.getter
    def output(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @output.setter
    def output(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def script_cmdlet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def script_cmdlet_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "script_cmdlet_id", value)

    @property
    @pulumi.getter(name="scriptExecutionName")
    def script_execution_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def script_execution_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScriptExecution(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="failureReason")
    def failure_reason(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Error message if the script was able to run, but if the script itself had
        errors or powershell threw an exception
        """
    ...
    @property
    @pulumi.getter
    def information(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def output(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Standard output stream from the powershell execution
        """
        return pulumi.get(self, "output")
    ...
    @property
    @pulumi.getter(name="scriptCmdletId")
    def script_cmdlet_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A reference to the script cmdlet resource if user is running a AVS script
        """
        return pulumi.get(self, "script_cmdlet_id")
    ...
    def submitted_at(self) -> pulumi.Output[builtins.str]:
        """
