...
def get_datastore(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_datastore is deprecated: azure-native:avs/v20210101preview:Datastore is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:Datastore to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20210101preview:getDatastore', __args__, opts=opts, typ=GetDatastoreResult).value
