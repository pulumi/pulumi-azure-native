...
warnings.warn("""azure-native:avs/v20210101preview:PrivateCloud is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_private_cloud(private_cloud_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_cloud is deprecated: azure-native:avs/v20210101preview:PrivateCloud is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.""")
    __args__ = dict()
