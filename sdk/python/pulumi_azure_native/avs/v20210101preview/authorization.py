...
warnings.warn("""azure-native:avs/v20210101preview:Authorization is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:Authorization to guarantee forwards compatibility.""", DeprecationWarning)
...
class Authorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Authorization is deprecated: azure-native:avs/v20210101preview:Authorization is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:Authorization to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:Authorization"), pulumi.Alias(type_="azure-native:avs/v20200320:Authorization"), pulumi.Alias(type_="azure-native:avs/v20200717preview:Authorization"), pulumi.Alias(type_="azure-native:avs/v20210601:Authorization"), pulumi.Alias(type_="azure-native:avs/v20211201:Authorization"), pulumi.Alias(type_="azure-native:avs/v20220501:Authorization")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Authorization, __self__).__init__(
            'azure-native:avs/v20210101preview:Authorization',
            resource_name,
            __props__,
            opts)
