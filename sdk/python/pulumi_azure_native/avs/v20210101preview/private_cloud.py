...
class PrivateCloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vcenter_password: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateCloud is deprecated: azure-native:avs/v20210101preview:PrivateCloud is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:PrivateCloud to guarantee forwards compatibility.""")
