...
warnings.warn("""azure-native:avs/v20210101preview:GlobalReachConnection is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_global_reach_connection(global_reach_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_global_reach_connection is deprecated: azure-native:avs/v20210101preview:GlobalReachConnection is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.""")
    __args__ = dict()
