...
warnings.warn("""azure-native:avs/v20210101preview:WorkloadNetworkDnsService is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadNetworkDnsService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 revision: Optional[pulumi.Input[float]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkDnsService is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkDnsService is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20200717preview:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkDnsService")])
