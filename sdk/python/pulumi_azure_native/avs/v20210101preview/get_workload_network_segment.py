...
def get_workload_network_segment(private_cloud_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_segment is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkSegment is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkSegment to guarantee forwards compatibility.""")
    __args__ = dict()
