...
def get_workload_network_dns_zone(dns_zone_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_dns_zone is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.""")
    __args__ = dict()
