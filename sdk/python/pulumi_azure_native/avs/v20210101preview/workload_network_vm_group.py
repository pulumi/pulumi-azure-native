...
warnings.warn("""azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadNetworkVMGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_group_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkVMGroup is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.""")
