...
warnings.warn("""azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadNetworkVMGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vm_group_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkVMGroup is deprecated: azure-native:avs/v20210101preview:WorkloadNetworkVMGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkVMGroup to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20200717preview:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkVMGroup")])
