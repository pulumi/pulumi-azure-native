...
def get_authorization(authorization_name: Optional[_builtins.str] = None,
...
def get_authorization_output(authorization_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
