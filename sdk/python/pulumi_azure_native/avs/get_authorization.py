...
class GetAuthorizationResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, express_route_authorization_id=None, express_route_authorization_key=None, express_route_id=None, id=None, name=None, provisioning_state=None, system_data=None, type=None):
...
def get_authorization(authorization_name: Optional[builtins.str] = None,
    ...
    :param builtins.str authorization_name: Name of the ExpressRoute Circuit Authorization
...
def get_authorization_output(authorization_name: Optional[pulumi.Input[builtins.str]] = None,
