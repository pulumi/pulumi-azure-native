...
warnings.warn("""azure-native:avs/v20200320:HcxEnterpriseSite is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_hcx_enterprise_site(hcx_enterprise_site_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hcx_enterprise_site is deprecated: azure-native:avs/v20200320:HcxEnterpriseSite is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.""")
    __args__ = dict()
