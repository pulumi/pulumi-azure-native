...
def get_cloud_link(cloud_link_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_link_name: Name of the cloud link.
...
def get_cloud_link_output(cloud_link_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
