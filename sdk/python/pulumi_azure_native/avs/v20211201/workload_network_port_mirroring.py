...
class WorkloadNetworkPortMirroring(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkPortMirroring is deprecated: azure-native:avs/v20211201:WorkloadNetworkPortMirroring is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPortMirroring to guarantee forwards compatibility.""")
