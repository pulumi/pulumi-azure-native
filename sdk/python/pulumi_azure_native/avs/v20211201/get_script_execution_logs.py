...
def get_script_execution_logs(private_cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20211201:getScriptExecutionLogs', __args__, opts=opts, typ=GetScriptExecutionLogsResult).value
...
def get_script_execution_logs_output(private_cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20211201:getScriptExecutionLogs', __args__, opts=opts, typ=GetScriptExecutionLogsResult)
