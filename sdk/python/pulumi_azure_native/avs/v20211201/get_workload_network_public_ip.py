...
warnings.warn("""azure-native:avs/v20211201:WorkloadNetworkPublicIP is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPublicIP to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workload_network_public_ip(private_cloud_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_public_ip is deprecated: azure-native:avs/v20211201:WorkloadNetworkPublicIP is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkPublicIP to guarantee forwards compatibility.""")
    __args__ = dict()
