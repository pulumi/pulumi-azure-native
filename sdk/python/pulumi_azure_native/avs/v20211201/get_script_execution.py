...
def get_script_execution(private_cloud_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_script_execution is deprecated: azure-native:avs/v20211201:ScriptExecution is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:ScriptExecution to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['privateCloudName'] = private_cloud_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['scriptExecutionName'] = script_execution_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20211201:getScriptExecution', __args__, opts=opts, typ=GetScriptExecutionResult).value
