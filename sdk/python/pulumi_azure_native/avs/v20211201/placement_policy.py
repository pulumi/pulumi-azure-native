...
class PlacementPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20211201:PlacementPolicy"), pulumi.Alias(type_="azure-native:avs:PlacementPolicy"), pulumi.Alias(type_="azure-nextgen:avs:PlacementPolicy")])
