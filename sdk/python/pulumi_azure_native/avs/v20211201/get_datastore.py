...
def get_datastore(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_datastore is deprecated: azure-native:avs/v20211201:Datastore is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:Datastore to guarantee forwards compatibility.""")
    __args__ = dict()
