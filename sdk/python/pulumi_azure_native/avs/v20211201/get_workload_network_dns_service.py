...
def get_workload_network_dns_service(dns_service_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_dns_service is deprecated: azure-native:avs/v20211201:WorkloadNetworkDnsService is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.""")
    __args__ = dict()
