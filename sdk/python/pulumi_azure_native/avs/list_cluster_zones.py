...
def list_cluster_zones(cluster_name: Optional[builtins.str] = None,
...
def list_cluster_zones_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs:listClusterZones', __args__, opts=opts, typ=ListClusterZonesResult)
