...
def get_workload_network_dns_zone(dns_zone_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dns_zone_id: ID of the DNS zone.
...
def get_workload_network_dns_zone_output(dns_zone_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
