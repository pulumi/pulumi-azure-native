...
def get_workload_network_port_mirroring(port_mirroring_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str port_mirroring_id: ID of the NSX port mirroring profile.
...
def get_workload_network_port_mirroring_output(port_mirroring_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
