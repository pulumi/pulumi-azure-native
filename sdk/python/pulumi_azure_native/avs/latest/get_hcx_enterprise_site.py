...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getHcxEnterpriseSite'.""", DeprecationWarning)
...
def get_hcx_enterprise_site(hcx_enterprise_site_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hcx_enterprise_site is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getHcxEnterpriseSite'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/latest:getHcxEnterpriseSite', __args__, opts=opts, typ=GetHcxEnterpriseSiteResult).value
