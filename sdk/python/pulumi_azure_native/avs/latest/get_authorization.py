...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getAuthorization'.""", DeprecationWarning)
...
def get_authorization(authorization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:avs:getAuthorization'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/latest:getAuthorization', __args__, opts=opts, typ=GetAuthorizationResult).value
