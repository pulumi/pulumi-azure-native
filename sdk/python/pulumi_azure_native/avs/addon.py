...
class AddonArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional[Union['AddonArcPropertiesArgs', 'AddonHcxPropertiesArgs', 'AddonSrmPropertiesArgs', 'AddonVrPropertiesArgs']]]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional[Union['AddonArcPropertiesArgs', 'AddonHcxPropertiesArgs', 'AddonSrmPropertiesArgs', 'AddonVrPropertiesArgs']]]):
...
class Addon(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union[Union['AddonArcPropertiesArgs', 'AddonArcPropertiesArgsDict'], Union['AddonHcxPropertiesArgs', 'AddonHcxPropertiesArgsDict'], Union['AddonSrmPropertiesArgs', 'AddonSrmPropertiesArgsDict'], Union['AddonVrPropertiesArgs', 'AddonVrPropertiesArgsDict']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] addon_name: Name of the addon.
        :param pulumi.Input[_builtins.str] private_cloud_name: Name of the private cloud
        :param pulumi.Input[Union[Union['AddonArcPropertiesArgs', 'AddonArcPropertiesArgsDict'], Union['AddonHcxPropertiesArgs', 'AddonHcxPropertiesArgsDict'], Union['AddonSrmPropertiesArgs', 'AddonSrmPropertiesArgsDict'], Union['AddonVrPropertiesArgs', 'AddonVrPropertiesArgsDict']]] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
