...
class AddonArgs:
    ...
    def addon_type(self) -> pulumi.Input[Union[builtins.str, 'AddonType']]:
        """
        Addon type
        """
    ...
    @addon_type.setter
    def addon_type(self, value: pulumi.Input[Union[builtins.str, 'AddonType']]):
...
class Addon(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 addon_name: Optional[pulumi.Input[builtins.str]] = None,
                 addon_type: Optional[pulumi.Input[Union[builtins.str, 'AddonType']]] = None,
    ...
    @property
    @pulumi.getter(name="addonType")
    def addon_type(self) -> pulumi.Output[builtins.str]:
        """
        Addon type
        """
        return pulumi.get(self, "addon_type")
