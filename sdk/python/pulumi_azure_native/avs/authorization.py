...
class AuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authorization_name: Name of the ExpressRoute Circuit Authorization
        :param pulumi.Input[builtins.str] express_route_id: The ID of the ExpressRoute Circuit
        """
