...
class PrivateCloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] extended_network_blocks: Array of additional networks noncontiguous with networkBlock. Networks must be
...
class PrivateCloud(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="extendedNetworkBlocks")
    def extended_network_blocks(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Array of additional networks noncontiguous with networkBlock. Networks must be
        unique and non-overlapping across VNet in your subscription, on-premise, and
        this privateCloud networkBlock attribute. Make sure the CIDR format conforms to
