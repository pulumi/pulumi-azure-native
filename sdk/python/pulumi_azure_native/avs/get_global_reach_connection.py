...
def get_global_reach_connection(global_reach_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str global_reach_connection_name: Name of the global reach connection
...
def get_global_reach_connection_output(global_reach_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
