...
class WorkloadNetworkSegmentArgs:
    def __init__(__self__, *,
                 ...
                 connected_gateway: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connected_gateway: Gateway which to connect segment to.
        :param pulumi.Input[builtins.str] display_name: Display name of the segment.
        :param pulumi.Input[builtins.float] revision: NSX revision number.
        :param pulumi.Input[builtins.str] segment_id: The ID of the NSX Segment
    ...
    def connected_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connected_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkloadNetworkSegment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectedGateway")
    def connected_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gateway which to connect segment to.
        """
        return pulumi.get(self, "connected_gateway")
