...
def get_authorization(authorization_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization is deprecated: azure-native:avs/v20210601:Authorization is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:Authorization to guarantee forwards compatibility.""")
    __args__ = dict()
