...
class WorkloadNetworkPublicIP(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20230301:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20230901:WorkloadNetworkPublicIP")])
