...
warnings.warn("""azure-native:avs/v20210601:GlobalReachConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_global_reach_connection(global_reach_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_global_reach_connection is deprecated: azure-native:avs/v20210601:GlobalReachConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:GlobalReachConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['globalReachConnectionName'] = global_reach_connection_name
    __args__['privateCloudName'] = private_cloud_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20210601:getGlobalReachConnection', __args__, opts=opts, typ=GetGlobalReachConnectionResult).value
