...
warnings.warn("""azure-native:avs/v20210601:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workload_network_dns_zone(dns_zone_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_dns_zone is deprecated: azure-native:avs/v20210601:WorkloadNetworkDnsZone is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsZone to guarantee forwards compatibility.""")
    __args__ = dict()
