...
class Addon(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union[Union['AddonHcxPropertiesArgs', 'AddonHcxPropertiesArgsDict'], Union['AddonSrmPropertiesArgs', 'AddonSrmPropertiesArgsDict'], Union['AddonVrPropertiesArgs', 'AddonVrPropertiesArgsDict']]]] = None,
        ...
        :param pulumi.Input[str] addon_name: Name of the addon for the private cloud
        :param pulumi.Input[str] private_cloud_name: The name of the private cloud.
        :param pulumi.Input[Union[Union['AddonHcxPropertiesArgs', 'AddonHcxPropertiesArgsDict'], Union['AddonSrmPropertiesArgs', 'AddonSrmPropertiesArgsDict'], Union['AddonVrPropertiesArgs', 'AddonVrPropertiesArgsDict']]] properties: The properties of an addon resource
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:Addon"), pulumi.Alias(type_="azure-native:avs/v20200717preview:Addon"), pulumi.Alias(type_="azure-native:avs/v20210101preview:Addon"), pulumi.Alias(type_="azure-native:avs/v20211201:Addon"), pulumi.Alias(type_="azure-native:avs/v20220501:Addon"), pulumi.Alias(type_="azure-native:avs/v20230301:Addon"), pulumi.Alias(type_="azure-native:avs/v20230901:Addon")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Addon, __self__).__init__(
            'azure-native:avs/v20210601:Addon',
            resource_name,
            __props__,
            opts)
