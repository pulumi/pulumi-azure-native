...
def list_private_cloud_admin_credentials(private_cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20210601:listPrivateCloudAdminCredentials', __args__, opts=opts, typ=ListPrivateCloudAdminCredentialsResult).value
...
def list_private_cloud_admin_credentials_output(private_cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20210601:listPrivateCloudAdminCredentials', __args__, opts=opts, typ=ListPrivateCloudAdminCredentialsResult)
