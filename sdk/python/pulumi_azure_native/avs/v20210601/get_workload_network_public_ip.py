...
def get_workload_network_public_ip(private_cloud_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_public_ip is deprecated: azure-native:avs/v20210601:WorkloadNetworkPublicIP is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkPublicIP to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['privateCloudName'] = private_cloud_name
    __args__['publicIPId'] = public_ip_id
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20210601:getWorkloadNetworkPublicIP', __args__, opts=opts, typ=GetWorkloadNetworkPublicIPResult).value
