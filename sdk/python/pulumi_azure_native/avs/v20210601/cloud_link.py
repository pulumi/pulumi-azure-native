...
class CloudLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20210601:CloudLink"), pulumi.Alias(type_="azure-native:avs:CloudLink"), pulumi.Alias(type_="azure-nextgen:avs:CloudLink"), pulumi.Alias(type_="azure-native:avs/v20211201:CloudLink"), pulumi.Alias(type_="azure-nextgen:avs/v20211201:CloudLink")])
