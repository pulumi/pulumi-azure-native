...
warnings.warn("""azure-native:avs/v20210601:WorkloadNetworkDhcp is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDhcp to guarantee forwards compatibility.""", DeprecationWarning)
...
class WorkloadNetworkDhcp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkDhcp is deprecated: azure-native:avs/v20210601:WorkloadNetworkDhcp is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:WorkloadNetworkDhcp to guarantee forwards compatibility.""")
