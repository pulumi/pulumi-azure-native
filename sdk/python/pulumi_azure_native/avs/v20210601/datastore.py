...
warnings.warn("""azure-native:avs/v20210601:Datastore is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:Datastore to guarantee forwards compatibility.""", DeprecationWarning)
...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:Datastore"), pulumi.Alias(type_="azure-native:avs/v20210101preview:Datastore"), pulumi.Alias(type_="azure-native:avs/v20211201:Datastore"), pulumi.Alias(type_="azure-native:avs/v20220501:Datastore")])
