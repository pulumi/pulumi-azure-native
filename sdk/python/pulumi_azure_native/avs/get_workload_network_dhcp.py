...
def get_workload_network_dhcp(dhcp_id: Optional[_builtins.str] = None,
...
def get_workload_network_dhcp_output(dhcp_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
