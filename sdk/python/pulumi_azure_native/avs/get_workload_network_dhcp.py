...
class GetWorkloadNetworkDhcpResult:
    ...
    NSX DHCP
    """
    def __init__(__self__, dhcp_type=None, display_name=None, id=None, name=None, provisioning_state=None, revision=None, segments=None, system_data=None, type=None):
...
def get_workload_network_dhcp(dhcp_id: Optional[str] = None,
    ...
    :param str dhcp_id: The ID of the DHCP configuration
