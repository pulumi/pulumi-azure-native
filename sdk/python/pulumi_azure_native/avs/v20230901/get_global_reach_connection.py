...
def get_global_reach_connection(global_reach_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230901:getGlobalReachConnection', __args__, opts=opts, typ=GetGlobalReachConnectionResult).value
...
def get_global_reach_connection_output(global_reach_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20230901:getGlobalReachConnection', __args__, opts=opts, typ=GetGlobalReachConnectionResult)
