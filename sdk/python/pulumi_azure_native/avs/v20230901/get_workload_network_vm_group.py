...
class GetWorkloadNetworkVMGroupResult:
    ...
    NSX VM Group
    """
    def __init__(__self__, display_name=None, id=None, members=None, name=None, provisioning_state=None, revision=None, status=None, system_data=None, type=None):
...
def get_workload_network_vm_group(private_cloud_name: Optional[str] = None,
    ...
    :param str vm_group_id: ID of the VM group.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230901:getWorkloadNetworkVMGroup', __args__, opts=opts, typ=GetWorkloadNetworkVMGroupResult).value
...
def get_workload_network_vm_group_output(private_cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vmGroupId'] = vm_group_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20230901:getWorkloadNetworkVMGroup', __args__, opts=opts, typ=GetWorkloadNetworkVMGroupResult)
