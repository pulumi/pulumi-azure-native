...
class WorkloadNetworkPublicIPArgs:
    def __init__(__self__, *,
                 ...
                 number_of_public_ips: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: Display name of the Public IP Block.
        :param pulumi.Input[builtins.float] number_of_public_ips: Number of Public IPs requested.
        :param pulumi.Input[builtins.str] public_ip_id: ID of the DNS zone.
        """
    ...
    def number_of_public_ips(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def number_of_public_ips(self, value: Optional[pulumi.Input[builtins.float]]):
...
class WorkloadNetworkPublicIP(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="numberOfPublicIPs")
    def number_of_public_ips(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Number of Public IPs requested.
        """
        return pulumi.get(self, "number_of_public_ips")
    ...
    def public_ip_block(self) -> pulumi.Output[builtins.str]:
        """
