...
def get_script_execution(private_cloud_name: Optional[_builtins.str] = None,
...
def get_script_execution_output(private_cloud_name: Optional[pulumi.Input[_builtins.str]] = None,
