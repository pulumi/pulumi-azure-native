...
def get_script_execution(private_cloud_name: Optional[builtins.str] = None,
...
def get_script_execution_output(private_cloud_name: Optional[pulumi.Input[builtins.str]] = None,
