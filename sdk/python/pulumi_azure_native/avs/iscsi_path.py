...
class IscsiPath(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs/v20230901:IscsiPath"), pulumi.Alias(type_="azure-native:avs/v20240901:IscsiPath"), pulumi.Alias(type_="azure-native:avs/v20250901:IscsiPath")])
