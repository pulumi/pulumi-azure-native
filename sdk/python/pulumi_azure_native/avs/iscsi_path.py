...
class IscsiPathArgs:
    def __init__(__self__, *,
                 network_block: pulumi.Input[builtins.str],
    ...
    def network_block(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_block(self, value: pulumi.Input[builtins.str]):
...
class IscsiPath(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_block: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="networkBlock")
    def network_block(self) -> pulumi.Output[builtins.str]:
        """
        CIDR Block for iSCSI path.
        """
        return pulumi.get(self, "network_block")
