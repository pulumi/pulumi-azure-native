...
class GlobalReachConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        global_reach_connection = azure_native.avs.v20200717preview.GlobalReachConnection("globalReachConnection",
