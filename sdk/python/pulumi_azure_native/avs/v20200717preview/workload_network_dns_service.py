...
class WorkloadNetworkDnsService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workload_network_dns_service = azure_native.avs.v20200717preview.WorkloadNetworkDnsService("workloadNetworkDnsService",
        ...
        ```sh
        $ pulumi import azure-native:avs/v20200717preview:WorkloadNetworkDnsService dnsService1 /subscriptions/{subscription-id}/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1/workloadNetworks/default/dnsServices/dnsService1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20210101preview:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkDnsService"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkDnsService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkDnsService, __self__).__init__(
            'azure-native:avs/v20200717preview:WorkloadNetworkDnsService',
            resource_name,
            __props__,
            opts)
