...
class WorkloadNetworkSegment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workload_network_segment = azure_native.avs.v20200717preview.WorkloadNetworkSegment("workloadNetworkSegment",
            ...
            revision=1,
            segment_id="segment1",
            subnet=azure_native.avs.v20200717preview.WorkloadNetworkSegmentSubnetArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20210101preview:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkSegment")])
