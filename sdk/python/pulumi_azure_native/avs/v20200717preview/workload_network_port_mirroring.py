...
warnings.warn("""Version 2020-07-17-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
class WorkloadNetworkPortMirroring(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WorkloadNetworkPortMirroring is deprecated: Version 2020-07-17-preview will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20220501:WorkloadNetworkPortMirroring")])
