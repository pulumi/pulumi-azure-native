...
def get_addon(addon_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20200717preview:getAddon', __args__, opts=opts, typ=GetAddonResult).value
...
def get_addon_output(addon_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20200717preview:getAddon', __args__, opts=opts, typ=GetAddonResult)
