...
def get_workload_network_dhcp(dhcp_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_dhcp is deprecated: azure-native:avs/v20200717preview:WorkloadNetworkDhcp is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20210101preview:WorkloadNetworkDhcp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dhcpId'] = dhcp_id
    __args__['privateCloudName'] = private_cloud_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20200717preview:getWorkloadNetworkDhcp', __args__, opts=opts, typ=GetWorkloadNetworkDhcpResult).value
