...
warnings.warn("""azure-native:avs/v20200717preview:WorkloadNetworkDnsService is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workload_network_dns_service(dns_service_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workload_network_dns_service is deprecated: azure-native:avs/v20200717preview:WorkloadNetworkDnsService is being removed in the next major version of this provider. Upgrade to at least azure-native:avs/v20220501:WorkloadNetworkDnsService to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dnsServiceId'] = dns_service_id
    __args__['privateCloudName'] = private_cloud_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20200717preview:getWorkloadNetworkDnsService', __args__, opts=opts, typ=GetWorkloadNetworkDnsServiceResult).value
