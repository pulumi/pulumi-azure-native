...
def get_hcx_enterprise_site(hcx_enterprise_site_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hcx_enterprise_site is deprecated: azure-native:avs/v20200717preview:HcxEnterpriseSite is being removed in the next major version of this provider. Please upgrade to azure-native:avs/v20220501:HcxEnterpriseSite to guarantee forwards compatibility.""")
    __args__ = dict()
