...
class WorkloadNetworkDhcpArgs:
    def __init__(__self__, *,
                 dhcp_type: pulumi.Input[Union[builtins.str, 'DhcpTypeEnum']],
        ...
        :param pulumi.Input[Union[builtins.str, 'DhcpTypeEnum']] dhcp_type: Type of DHCP: SERVER or RELAY.
        :param pulumi.Input[builtins.str] private_cloud_name: Name of the private cloud
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] dhcp_id: The ID of the DHCP configuration
        :param pulumi.Input[builtins.str] display_name: Display name of the DHCP entity.
    ...
    def dhcp_type(self) -> pulumi.Input[Union[builtins.str, 'DhcpTypeEnum']]:
        """
    ...
    @dhcp_type.setter
    def dhcp_type(self, value: pulumi.Input[Union[builtins.str, 'DhcpTypeEnum']]):
...
class WorkloadNetworkDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dhcp_id: Optional[pulumi.Input[builtins.str]] = None,
                 dhcp_type: Optional[pulumi.Input[Union[builtins.str, 'DhcpTypeEnum']]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dhcpType")
    def dhcp_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of DHCP: SERVER or RELAY.
        """
        return pulumi.get(self, "dhcp_type")
    ...
    @property
    @pulumi.getter
    def segments(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
