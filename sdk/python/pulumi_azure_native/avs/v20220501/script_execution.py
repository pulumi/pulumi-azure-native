...
class ScriptExecution(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        script_execution = azure_native.avs.v20220501.ScriptExecution("scriptExecution",
            hidden_parameters=[azure_native.avs.v20220501.ScriptSecureStringExecutionParameterArgs(
                name="Password",
                secure_value="PlaceholderPassword",
                type="SecureValue",
            )],
            parameters=[
                azure_native.avs.v20220501.ScriptStringExecutionParameterArgs(
                    name="DomainName",
                    type="Value",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:ScriptExecution"), pulumi.Alias(type_="azure-native:avs/v20210601:ScriptExecution"), pulumi.Alias(type_="azure-native:avs/v20211201:ScriptExecution")])
