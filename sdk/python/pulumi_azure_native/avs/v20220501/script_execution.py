...
class ScriptExecutionArgs:
    ...
    def _configure(
        ...
        if hidden_parameters is None and 'hiddenParameters' in kwargs:
            hidden_parameters = kwargs['hiddenParameters']
        if named_outputs is None and 'namedOutputs' in kwargs:
            named_outputs = kwargs['namedOutputs']
        if script_cmdlet_id is None and 'scriptCmdletId' in kwargs:
            script_cmdlet_id = kwargs['scriptCmdletId']
        if script_execution_name is None and 'scriptExecutionName' in kwargs:
...
class ScriptExecution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:ScriptExecution"), pulumi.Alias(type_="azure-native:avs/v20210601:ScriptExecution"), pulumi.Alias(type_="azure-native:avs/v20211201:ScriptExecution"), pulumi.Alias(type_="azure-native:avs/v20230301:ScriptExecution")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScriptExecution, __self__).__init__(
            'azure-native:avs/v20220501:ScriptExecution',
            resource_name,
            __props__,
            opts)
