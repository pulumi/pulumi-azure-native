...
class WorkloadNetworkPublicIP(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workload_network_public_ip = azure_native.avs.v20220501.WorkloadNetworkPublicIP("workloadNetworkPublicIP",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkPublicIP"), pulumi.Alias(type_="azure-native:avs/v20211201:WorkloadNetworkPublicIP")])
