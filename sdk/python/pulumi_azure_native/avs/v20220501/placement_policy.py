...
class PlacementPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        placement_policy = azure_native.avs.v20220501.PlacementPolicy("placementPolicy",
            cluster_name="cluster1",
            placement_policy_name="policy1",
            private_cloud_name="cloud1",
            properties=azure_native.avs.v20220501.VmHostPlacementPolicyPropertiesArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:PlacementPolicy"), pulumi.Alias(type_="azure-native:avs/v20211201:PlacementPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PlacementPolicy, __self__).__init__(
            'azure-native:avs/v20220501:PlacementPolicy',
            resource_name,
            __props__,
            opts)
