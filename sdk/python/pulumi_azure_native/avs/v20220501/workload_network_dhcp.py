...
class WorkloadNetworkDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        workload_network_dhcp = azure_native.avs.v20220501.WorkloadNetworkDhcp("workloadNetworkDhcp",
            dhcp_id="dhcp1",
            private_cloud_name="cloud1",
            properties=azure_native.avs.v20220501.WorkloadNetworkDhcpServerArgs(
                dhcp_type="SERVER",
    ...
    def _internal_init(__self__,
        ...
        super(WorkloadNetworkDhcp, __self__).__init__(
            'azure-native:avs/v20220501:WorkloadNetworkDhcp',
            resource_name,
            __props__,
            opts)
