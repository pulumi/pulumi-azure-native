...
class Datastore(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        datastore = azure_native.avs.v20220501.Datastore("datastore",
            cluster_name="cluster1",
            datastore_name="datastore1",
            net_app_volume=azure_native.avs.v20220501.NetAppVolumeResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:Datastore"), pulumi.Alias(type_="azure-native:avs/v20210101preview:Datastore"), pulumi.Alias(type_="azure-native:avs/v20210601:Datastore"), pulumi.Alias(type_="azure-native:avs/v20211201:Datastore")])
