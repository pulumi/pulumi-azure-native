...
class WorkloadNetworkPortMirroringArgs:
    ...
    def _configure(
        ...
        if port_mirroring_id is None and 'portMirroringId' in kwargs:
            port_mirroring_id = kwargs['portMirroringId']
