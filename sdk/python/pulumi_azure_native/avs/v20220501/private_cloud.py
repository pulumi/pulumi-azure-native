...
class PrivateCloud(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_cloud = azure_native.avs.v20220501.PrivateCloud("privateCloud",
            identity=azure_native.avs.v20220501.PrivateCloudIdentityArgs(
                type="SystemAssigned",
            ),
            location="eastus2",
            management_cluster=azure_native.avs.v20220501.ManagementClusterArgs(
                cluster_size=4,
            ),
        ...
        private_cloud = azure_native.avs.v20220501.PrivateCloud("privateCloud",
            availability=azure_native.avs.v20220501.AvailabilityPropertiesArgs(
                secondary_zone=2,
                strategy="DualZone",
                zone=1,
            ),
        ...
        ```sh
        $ pulumi import azure-native:avs/v20220501:PrivateCloud cloud1 /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/cloud1 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20200320:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20200717preview:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20210101preview:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20210601:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20211201:PrivateCloud")])
