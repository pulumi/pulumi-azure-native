...
class PrivateCloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(availability, AvailabilityPropertiesArgs):
            ...
            if not isinstance(identity, PrivateCloudIdentityArgs):
            ...
            if not isinstance(management_cluster, ManagementClusterArgs):
