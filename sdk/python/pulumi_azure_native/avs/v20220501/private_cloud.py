...
class PrivateCloudArgs:
    ...
    def _configure(
        ...
        if 'networkBlock' in kwargs:
            network_block = kwargs['networkBlock']
        if 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if 'identitySources' in kwargs:
...
class PrivateCloud(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if availability is not None and not isinstance(availability, AvailabilityPropertiesArgs):
                availability = availability or {}
                def _setter(key, value):
                    availability[key] = value
                AvailabilityPropertiesArgs._configure(_setter, **availability)
            ...
            if identity is not None and not isinstance(identity, PrivateCloudIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                PrivateCloudIdentityArgs._configure(_setter, **identity)
            ...
            if management_cluster is not None and not isinstance(management_cluster, ManagementClusterArgs):
                management_cluster = management_cluster or {}
                def _setter(key, value):
                    management_cluster[key] = value
                ManagementClusterArgs._configure(_setter, **management_cluster)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20200320:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20200717preview:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20210101preview:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20210601:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20211201:PrivateCloud"), pulumi.Alias(type_="azure-native:avs/v20230301:PrivateCloud")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateCloud, __self__).__init__(
            'azure-native:avs/v20220501:PrivateCloud',
            resource_name,
            __props__,
            opts)
