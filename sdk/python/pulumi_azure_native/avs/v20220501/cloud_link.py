...
class CloudLinkArgs:
    ...
    def _configure(
        ...
        if 'cloudLinkName' in kwargs:
            cloud_link_name = kwargs['cloudLinkName']
        if 'linkedCloud' in kwargs:
...
class CloudLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:avs:CloudLink"), pulumi.Alias(type_="azure-native:avs/v20210601:CloudLink"), pulumi.Alias(type_="azure-native:avs/v20211201:CloudLink"), pulumi.Alias(type_="azure-native:avs/v20230301:CloudLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudLink, __self__).__init__(
            'azure-native:avs/v20220501:CloudLink',
            resource_name,
            __props__,
            opts)
