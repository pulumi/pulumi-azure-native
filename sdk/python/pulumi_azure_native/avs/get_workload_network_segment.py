...
def get_workload_network_segment(private_cloud_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str segment_id: The ID of the NSX Segment
    """
    __args__ = dict()
...
def get_workload_network_segment_output(private_cloud_name: Optional[pulumi.Input[_builtins.str]] = None,
