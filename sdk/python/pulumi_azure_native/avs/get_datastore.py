...
def get_datastore(cluster_name: Optional[builtins.str] = None,
                  datastore_name: Optional[builtins.str] = None,
...
def get_datastore_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
