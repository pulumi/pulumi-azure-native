...
def get_private_cloud(private_cloud_name: Optional[_builtins.str] = None,
...
def get_private_cloud_output(private_cloud_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
