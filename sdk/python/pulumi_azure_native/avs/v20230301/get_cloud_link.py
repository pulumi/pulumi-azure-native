...
def get_cloud_link(cloud_link_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230301:getCloudLink', __args__, opts=opts, typ=GetCloudLinkResult).value
...
def get_cloud_link_output(cloud_link_name: Optional[pulumi.Input[str]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCloudLinkResult]:
    """
    A cloud link resource
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20230301:getCloudLink', __args__, opts=opts, typ=GetCloudLinkResult)
