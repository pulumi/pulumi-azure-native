...
def get_workload_network_segment(private_cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230301:getWorkloadNetworkSegment', __args__, opts=opts, typ=GetWorkloadNetworkSegmentResult).value
...
def get_workload_network_segment_output(private_cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['segmentId'] = segment_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20230301:getWorkloadNetworkSegment', __args__, opts=opts, typ=GetWorkloadNetworkSegmentResult)
