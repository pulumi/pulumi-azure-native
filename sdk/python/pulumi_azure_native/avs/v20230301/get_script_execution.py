...
def get_script_execution(private_cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230301:getScriptExecution', __args__, opts=opts, typ=GetScriptExecutionResult).value
...
def get_script_execution_output(private_cloud_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scriptExecutionName'] = script_execution_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:avs/v20230301:getScriptExecution', __args__, opts=opts, typ=GetScriptExecutionResult)
