...
class HcxEnterpriseSiteArgs:
    ...
    def _configure(
        ...
        if hcx_enterprise_site_name is None and 'hcxEnterpriseSiteName' in kwargs:
            hcx_enterprise_site_name = kwargs['hcxEnterpriseSiteName']
...
class HcxEnterpriseSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(HcxEnterpriseSite, __self__).__init__(
            'azure-native:avs/v20230301:HcxEnterpriseSite',
            resource_name,
            __props__,
            opts)
