...
def get_private_cloud(private_cloud_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:avs/v20230301:getPrivateCloud', __args__, opts=opts, typ=GetPrivateCloudResult).value
    ...
    return AwaitableGetPrivateCloudResult(
        ...
        extended_network_blocks=__ret__.extended_network_blocks,
