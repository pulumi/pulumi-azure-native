...
class GlobalReachConnectionArgs:
    def __init__(__self__, *,
                 ...
                 express_route_id: Optional[pulumi.Input[builtins.str]] = None,
                 global_reach_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 peer_express_route_circuit: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] authorization_key: Authorization key from the peer express route used for the global reach
               connection
        :param pulumi.Input[builtins.str] express_route_id: The ID of the Private Cloud's ExpressRoute Circuit that is participating in the
               global reach connection
        :param pulumi.Input[builtins.str] global_reach_connection_name: Name of the global reach connection
        :param pulumi.Input[builtins.str] peer_express_route_circuit: Identifier of the ExpressRoute Circuit to peer with in the global reach
               connection
        """
    ...
    def express_route_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def express_route_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_route_id", value)

    @property
    @pulumi.getter(name="globalReachConnectionName")
    def global_reach_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def global_reach_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_reach_connection_name", value)

    @property
    @pulumi.getter(name="peerExpressRouteCircuit")
    def peer_express_route_circuit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_express_route_circuit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GlobalReachConnection(pulumi.CustomResource):
    ...
    def circuit_connection_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="expressRouteId")
    def express_route_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Private Cloud's ExpressRoute Circuit that is participating in the
        global reach connection
        """
    ...
    @property
    @pulumi.getter(name="peerExpressRouteCircuit")
    def peer_express_route_circuit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifier of the ExpressRoute Circuit to peer with in the global reach
        connection
        """
