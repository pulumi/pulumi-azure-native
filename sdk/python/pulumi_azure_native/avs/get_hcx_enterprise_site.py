...
def get_hcx_enterprise_site(hcx_enterprise_site_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str hcx_enterprise_site_name: Name of the HCX Enterprise Site
...
def get_hcx_enterprise_site_output(hcx_enterprise_site_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
