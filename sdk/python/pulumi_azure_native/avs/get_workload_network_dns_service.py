...
def get_workload_network_dns_service(dns_service_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dns_service_id: ID of the DNS service.
...
def get_workload_network_dns_service_output(dns_service_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
