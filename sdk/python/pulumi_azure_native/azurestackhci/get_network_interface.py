...
def get_network_interface(network_interface_name: Optional[builtins.str] = None,
...
def get_network_interface_output(network_interface_name: Optional[pulumi.Input[builtins.str]] = None,
