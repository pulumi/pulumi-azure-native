...
class VirtualMachineInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20230901preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20241001preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci:VirtualMachineInstance")])
