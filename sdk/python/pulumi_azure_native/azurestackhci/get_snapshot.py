...
def get_snapshot(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str snapshot_name: Name of the snapshot
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['snapshotName'] = snapshot_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
...
def get_snapshot_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult)
