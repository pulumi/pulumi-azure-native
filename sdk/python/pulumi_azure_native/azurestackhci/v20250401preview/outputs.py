...
__all__ = [
    ...
    'VirtualMachineInstancePropertiesPlacementProfileResponse',
...
@pulumi.output_type
class VirtualMachineInstancePropertiesPlacementProfileResponse(dict):
    """
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "strictPlacementPolicy":
            suggest = "strict_placement_policy"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualMachineInstancePropertiesPlacementProfileResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualMachineInstancePropertiesPlacementProfileResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        PlacementProfile - Specifies the placement related settings for the virtual machine.
        :param bool strict_placement_policy: Specifies whether VM can only failover strictly within the zone it was placed in
        :param str zone: The zone in which the VM should be placed in.
        """
        if strict_placement_policy is not None:
            pulumi.set(__self__, "strict_placement_policy", strict_placement_policy)
        if zone is not None:
            pulumi.set(__self__, "zone", zone)

    @property
    @pulumi.getter(name="strictPlacementPolicy")
    def strict_placement_policy(self) -> Optional[bool]:
        """
        Specifies whether VM can only failover strictly within the zone it was placed in
        """
        return pulumi.get(self, "strict_placement_policy")
