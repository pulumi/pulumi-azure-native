...
__all__ = [
    ...
    'VirtualMachineInstancePropertiesPlacementProfileArgsDict',
...
if not MYPY:
    class VirtualMachineInstancePropertiesPlacementProfileArgsDict(TypedDict):
        """
        PlacementProfile - Specifies the placement related settings for the virtual machine.
        """
        strict_placement_policy: NotRequired[pulumi.Input[bool]]
        """
    ...
    VirtualMachineInstancePropertiesPlacementProfileArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class VirtualMachineInstancePropertiesPlacementProfileArgs:
    def __init__(__self__, *,
                 strict_placement_policy: Optional[pulumi.Input[bool]] = None,
                 zone: Optional[pulumi.Input[str]] = None):
        """
        PlacementProfile - Specifies the placement related settings for the virtual machine.
        :param pulumi.Input[bool] strict_placement_policy: Specifies whether VM can only failover strictly within the zone it was placed in
        :param pulumi.Input[str] zone: The zone in which the VM should be placed in.
        """
    ...
    def strict_placement_policy(self) -> Optional[pulumi.Input[bool]]:
        """
        Specifies whether VM can only failover strictly within the zone it was placed in
        """
        return pulumi.get(self, "strict_placement_policy")

    @strict_placement_policy.setter
    def strict_placement_policy(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "strict_placement_policy", value)
