...
class VirtualMachineInstanceArgs:
    def __init__(__self__, *,
                 ...
                 placement_profile: Optional[pulumi.Input['VirtualMachineInstancePropertiesPlacementProfileArgs']] = None,
        ...
        :param pulumi.Input[bool] create_from_local: Boolean indicating whether this is an existing local virtual machine or if one should be created.
        ...
        :param pulumi.Input['VirtualMachineInstancePropertiesPlacementProfileArgs'] placement_profile: PlacementProfile - Specifies the placement related settings for the virtual machine.
    ...
    def placement_profile(self) -> Optional[pulumi.Input['VirtualMachineInstancePropertiesPlacementProfileArgs']]:
        """
    ...
    def placement_profile(self, value: Optional[pulumi.Input['VirtualMachineInstancePropertiesPlacementProfileArgs']]):
...
class VirtualMachineInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 placement_profile: Optional[pulumi.Input[Union['VirtualMachineInstancePropertiesPlacementProfileArgs', 'VirtualMachineInstancePropertiesPlacementProfileArgsDict']]] = None,
                 resource_uid: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Union['VirtualMachineInstancePropertiesPlacementProfileArgs', 'VirtualMachineInstancePropertiesPlacementProfileArgsDict']] placement_profile: PlacementProfile - Specifies the placement related settings for the virtual machine.
        :param pulumi.Input[str] resource_uid: Unique identifier defined by ARC to identify the guest of the VM.
        :param pulumi.Input[str] resource_uri: The fully qualified Azure Resource manager identifier of the resource.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["host_node_name"] = None
            __props__.__dict__["hyper_v_vm_id"] = None
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20230901preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20241001preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:VirtualMachineInstance"), pulumi.Alias(type_="azure-native:azurestackhci:VirtualMachineInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineInstance, __self__).__init__(
            'azure-native:azurestackhci/v20250401preview:VirtualMachineInstance',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="hostNodeName")
    def host_node_name(self) -> pulumi.Output[str]:
        """
        Name of the host node that the VM is on.
        """
        return pulumi.get(self, "host_node_name")
    ...
    @property
    @pulumi.getter(name="hyperVVmId")
    def hyper_v_vm_id(self) -> pulumi.Output[str]:
        """
        Unique identifier for the Hyper-V VM resource.
        """
        return pulumi.get(self, "hyper_v_vm_id")
    ...
    @property
    @pulumi.getter(name="placementProfile")
    def placement_profile(self) -> pulumi.Output[Optional['outputs.VirtualMachineInstancePropertiesPlacementProfileResponse']]:
        """
        PlacementProfile - Specifies the placement related settings for the virtual machine.
        """
        return pulumi.get(self, "placement_profile")
