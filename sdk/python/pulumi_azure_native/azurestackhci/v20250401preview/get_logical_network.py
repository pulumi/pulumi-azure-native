...
def get_logical_network(logical_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250401preview:getLogicalNetwork', __args__, opts=opts, typ=GetLogicalNetworkResult).value
...
def get_logical_network_output(logical_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250401preview:getLogicalNetwork', __args__, opts=opts, typ=GetLogicalNetworkResult)
