...
class GetVirtualMachineInstanceResult:
    ...
    """
    def __init__(__self__, create_from_local=None, extended_location=None, guest_agent_install_status=None, hardware_profile=None, host_node_name=None, http_proxy_config=None, hyper_v_vm_id=None, id=None, identity=None, instance_view=None, name=None, network_profile=None, os_profile=None, placement_profile=None, provisioning_state=None, resource_uid=None, security_profile=None, status=None, storage_profile=None, system_data=None, type=None, vm_id=None):
        ...
        if host_node_name and not isinstance(host_node_name, str):
            raise TypeError("Expected argument 'host_node_name' to be a str")
        pulumi.set(__self__, "host_node_name", host_node_name)
        ...
        if hyper_v_vm_id and not isinstance(hyper_v_vm_id, str):
            raise TypeError("Expected argument 'hyper_v_vm_id' to be a str")
        pulumi.set(__self__, "hyper_v_vm_id", hyper_v_vm_id)
    ...
    def placement_profile(self) -> Optional['outputs.VirtualMachineInstancePropertiesPlacementProfileResponse']:
        """
...
class AwaitableGetVirtualMachineInstanceResult(GetVirtualMachineInstanceResult):
    ...
    def __await__(self):
        ...
        return GetVirtualMachineInstanceResult(
            ...
            host_node_name=self.host_node_name,
            http_proxy_config=self.http_proxy_config,
            hyper_v_vm_id=self.hyper_v_vm_id,
            id=self.id,
...
def get_virtual_machine_instance(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250401preview:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult).value
    ...
    return AwaitableGetVirtualMachineInstanceResult(
        ...
        host_node_name=pulumi.get(__ret__, 'host_node_name'),
        http_proxy_config=pulumi.get(__ret__, 'http_proxy_config'),
        hyper_v_vm_id=pulumi.get(__ret__, 'hyper_v_vm_id'),
...
def get_virtual_machine_instance_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250401preview:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult)
    return __ret__.apply(lambda __response__: GetVirtualMachineInstanceResult(
        ...
        host_node_name=pulumi.get(__response__, 'host_node_name'),
        http_proxy_config=pulumi.get(__response__, 'http_proxy_config'),
        hyper_v_vm_id=pulumi.get(__response__, 'hyper_v_vm_id'),
