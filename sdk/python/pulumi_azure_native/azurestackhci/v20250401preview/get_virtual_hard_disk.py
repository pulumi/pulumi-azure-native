...
def get_virtual_hard_disk(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250401preview:getVirtualHardDisk', __args__, opts=opts, typ=GetVirtualHardDiskResult).value
...
def get_virtual_hard_disk_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250401preview:getVirtualHardDisk', __args__, opts=opts, typ=GetVirtualHardDiskResult)
