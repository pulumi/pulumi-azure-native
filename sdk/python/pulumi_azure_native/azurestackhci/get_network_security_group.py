...
def get_network_security_group(network_security_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_security_group_name: Name of the network security group
...
def get_network_security_group_output(network_security_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
