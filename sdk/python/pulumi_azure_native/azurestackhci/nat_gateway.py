...
class NatGatewayArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['NatGatewayPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['NatGatewayPropertiesArgs']]):
...
class NatGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 nat_gateway_name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['NatGatewayPropertiesArgs', 'NatGatewayPropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] nat_gateway_name: Name of the nat gateway
        :param pulumi.Input[Union['NatGatewayPropertiesArgs', 'NatGatewayPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20250901preview:NatGateway"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201preview:NatGateway"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:NatGateway")])
