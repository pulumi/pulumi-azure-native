...
class StorageContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: Path of the storage container on the disk
        ...
        :param pulumi.Input[builtins.str] storage_container_name: Name of the storage container
