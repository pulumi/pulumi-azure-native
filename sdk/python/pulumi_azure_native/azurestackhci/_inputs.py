...
class VirtualMachineInstancePropertiesOsProfileLinuxConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] provision_vm_agent: Used to indicate whether Arc for Servers agent onboarding should be triggered during the virtual machine instance creation process.
        :param pulumi.Input[builtins.bool] provision_vm_config_agent: Used to indicate whether the VM Config Agent should be installed during the virtual machine creation process.
...
class VirtualMachinePropertiesLinuxConfigurationArgs:
    def __init__(__self__, *,
        ...
        LinuxConfiguration - linux specific configuration values for the virtual machine
        :param pulumi.Input[builtins.bool] disable_password_authentication: DisablePasswordAuthentication - whether password authentication should be disabled
        :param pulumi.Input[builtins.bool] provision_vm_agent: Used to indicate whether Arc for Servers agent onboarding should be triggered during the virtual machine creation process.
