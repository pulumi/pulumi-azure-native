...
def get_marketplace_gallery_image(marketplace_gallery_image_name: Optional[_builtins.str] = None,
...
def get_marketplace_gallery_image_output(marketplace_gallery_image_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
