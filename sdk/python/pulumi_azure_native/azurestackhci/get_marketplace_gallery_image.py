...
class GetMarketplaceGalleryImageResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, cloud_init_data_source=None, container_id=None, extended_location=None, hyper_v_generation=None, id=None, identifier=None, location=None, name=None, os_type=None, provisioning_state=None, status=None, system_data=None, tags=None, type=None, version=None):
...
def get_marketplace_gallery_image(marketplace_gallery_image_name: Optional[builtins.str] = None,
    ...
    :param builtins.str marketplace_gallery_image_name: Name of the marketplace gallery image
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getMarketplaceGalleryImage', __args__, opts=opts, typ=GetMarketplaceGalleryImageResult).value
...
def get_marketplace_gallery_image_output(marketplace_gallery_image_name: Optional[pulumi.Input[builtins.str]] = None,
