...
class PublicIPAddressArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input['PublicIPAddressPropertiesArgs']] = None,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['PublicIPAddressPropertiesArgs']]):
...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['PublicIPAddressPropertiesArgs', 'PublicIPAddressPropertiesArgsDict']]] = None,
                 public_ip_address_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['PublicIPAddressPropertiesArgs', 'PublicIPAddressPropertiesArgsDict']] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] public_ip_address_name: Name of the public IP
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20250901preview:PublicIPAddress"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201preview:PublicIPAddress"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:PublicIPAddress")])
