...
class PublicIPAddressArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['PublicIPAddressPropertiesArgs']]:
        """
...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['PublicIPAddressPropertiesArgs', 'PublicIPAddressPropertiesArgsDict']]] = None,
                 public_ip_address_name: pulumi.Input[Optional[_builtins.str]] = None,
