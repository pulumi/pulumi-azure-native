...
class GetMachineExtensionResult:
    ...
    """
    def __init__(__self__, auto_upgrade_minor_version=None, azure_api_version=None, force_update_tag=None, id=None, instance_view=None, location=None, name=None, protected_settings=None, provisioning_state=None, publisher=None, settings=None, system_data=None, tags=None, type=None, type_handler_version=None):
...
def get_machine_extension(extension_name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the machine containing the extension.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult).value
...
def get_machine_extension_output(extension_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getMachineExtension', __args__, opts=opts, typ=GetMachineExtensionResult)
