...
def get_logical_network(logical_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230901preview:getLogicalNetwork', __args__, opts=opts, typ=GetLogicalNetworkResult).value
...
def get_logical_network_output(logical_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20230901preview:getLogicalNetwork', __args__, opts=opts, typ=GetLogicalNetworkResult)
