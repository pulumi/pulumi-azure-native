...
class StorageContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:StorageContainer"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:StorageContainer")])
