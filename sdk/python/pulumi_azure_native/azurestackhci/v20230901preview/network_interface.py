...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20241001preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci/v20250401preview:NetworkInterface"), pulumi.Alias(type_="azure-native:azurestackhci:NetworkInterface")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkInterface, __self__).__init__(
            'azure-native:azurestackhci/v20230901preview:NetworkInterface',
            resource_name,
            __props__,
            opts)
