...
def get_guest_agent(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230901preview:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult).value
...
def get_guest_agent_output(resource_uri: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20230901preview:getGuestAgent', __args__, opts=opts, typ=GetGuestAgentResult)
