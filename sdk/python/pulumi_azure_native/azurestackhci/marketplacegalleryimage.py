...
class MarketplacegalleryimageArgs:
    def __init__(__self__, *,
                 ...
                 marketplacegalleryimages_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] marketplacegalleryimages_name: Name of the marketplace gallery image
        ...
        if marketplacegalleryimages_name is not None:
            pulumi.set(__self__, "marketplacegalleryimages_name", marketplacegalleryimages_name)
    ...
    @property
    @pulumi.getter(name="marketplacegalleryimagesName")
    def marketplacegalleryimages_name(self) -> Optional[pulumi.Input[str]]:
        """
        Name of the marketplace gallery image
        """
        return pulumi.get(self, "marketplacegalleryimages_name")

    @marketplacegalleryimages_name.setter
    def marketplacegalleryimages_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "marketplacegalleryimages_name", value)
...
class Marketplacegalleryimage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["marketplacegalleryimages_name"] = marketplacegalleryimages_name
