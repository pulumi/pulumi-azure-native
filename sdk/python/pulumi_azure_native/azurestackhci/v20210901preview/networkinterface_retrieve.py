...
class NetworkinterfaceRetrieveArgs:
    ...
    def _configure(
        ...
        if 'networkinterfacesName' in kwargs:
...
class NetworkinterfaceRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if dns_settings is not None and not isinstance(dns_settings, InterfaceDNSSettingsArgs):
                dns_settings = dns_settings or {}
                def _setter(key, value):
                    dns_settings[key] = value
                InterfaceDNSSettingsArgs._configure(_setter, **dns_settings)
