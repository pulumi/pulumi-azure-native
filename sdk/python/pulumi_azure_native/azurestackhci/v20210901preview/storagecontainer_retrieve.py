...
class StoragecontainerRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if extended_location is not None and not isinstance(extended_location, StoragecontainersExtendedLocationArgs):
                extended_location = extended_location or {}
                def _setter(key, value):
                    extended_location[key] = value
                StoragecontainersExtendedLocationArgs._configure(_setter, **extended_location)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:storagecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci:StoragecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci:storagecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:StoragecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:storagecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:StoragecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:storagecontainerRetrieve")])
