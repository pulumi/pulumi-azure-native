...
class GalleryimageRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:galleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci:GalleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci:galleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:GalleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:galleryimageRetrieve")])
