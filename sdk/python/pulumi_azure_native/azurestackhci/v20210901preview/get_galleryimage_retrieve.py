...
__all__ = [
    ...
    'get_galleryimage_retrieve',
    'get_galleryimage_retrieve_output',
]
...
class GetGalleryimageRetrieveResult:
    ...
    """
    def __init__(__self__, cloud_init_data_source=None, container_name=None, extended_location=None, hyper_v_generation=None, id=None, identifier=None, image_path=None, location=None, name=None, os_type=None, provisioning_state=None, resource_name=None, status=None, system_data=None, tags=None, type=None, version=None):
...
def get_galleryimage_retrieve(galleryimages_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20210901preview:getGalleryimageRetrieve', __args__, opts=opts, typ=GetGalleryimageRetrieveResult).value
...
def get_galleryimage_retrieve_output(galleryimages_name: Optional[pulumi.Input[str]] = None,
                                     resource_group_name: Optional[pulumi.Input[str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGalleryimageRetrieveResult]:
    """
    Gets galleryimages by resource name
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20210901preview:getGalleryimageRetrieve', __args__, opts=opts, typ=GetGalleryimageRetrieveResult)
    return __ret__.apply(lambda __response__: GetGalleryimageRetrieveResult(
