...
__all__ = [
    ...
    'getmarketplacegalleryimage_output',
]
...
def getmarketplacegalleryimage(marketplacegalleryimages_name: Optional[str] = None,
...
@_utilities.lift_output_func(getmarketplacegalleryimage)
def getmarketplacegalleryimage_output(marketplacegalleryimages_name: Optional[pulumi.Input[str]] = None,
