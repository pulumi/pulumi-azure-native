...
class MarketplacegalleryimageArgs:
    ...
    def _configure(
        ...
        if marketplacegalleryimages_name is None and 'marketplacegalleryimagesName' in kwargs:
            marketplacegalleryimages_name = kwargs['marketplacegalleryimagesName']
        ...
        if marketplacegalleryimages_name is not None:
            _setter("marketplacegalleryimages_name", marketplacegalleryimages_name)
