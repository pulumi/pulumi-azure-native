...
warnings.warn("""azure-native:azurestackhci/v20210901preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:MachineExtension to guarantee forwards compatibility.""", DeprecationWarning)
...
class MachineExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type_handler_version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MachineExtension is deprecated: azure-native:azurestackhci/v20210901preview:MachineExtension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:MachineExtension to guarantee forwards compatibility.""")
        ...
        super(MachineExtension, __self__).__init__(
            'azure-native:azurestackhci/v20210901preview:MachineExtension',
            resource_name,
            __props__,
            opts)
