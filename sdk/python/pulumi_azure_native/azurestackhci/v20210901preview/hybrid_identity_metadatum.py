...
class HybridIdentityMetadatum(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:HybridIdentityMetadatum"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:HybridIdentityMetadatum")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridIdentityMetadatum, __self__).__init__(
            'azure-native:azurestackhci/v20210901preview:HybridIdentityMetadatum',
            resource_name,
            __props__,
            opts)
