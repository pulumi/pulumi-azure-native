...
def getvirtualnetwork_retrieve(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20210901preview:getvirtualnetworkRetrieve', __args__, opts=opts, typ=GetvirtualnetworkRetrieveResult).value
