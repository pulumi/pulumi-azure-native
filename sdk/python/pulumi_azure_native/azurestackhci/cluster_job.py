...
class ClusterJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] cluster_name: The name of the cluster.
        :param pulumi.Input[_builtins.str] jobs_name: Name of ClusterJob
        :param pulumi.Input[Union[Union['HciConfigureCvmJobPropertiesArgs', 'HciConfigureCvmJobPropertiesArgsDict'], Union['HciConfigureSdnIntegrationJobPropertiesArgs', 'HciConfigureSdnIntegrationJobPropertiesArgsDict']]] properties: The resource-specific properties for this resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ClusterJobArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClusterJobArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClusterJobArgs.__new__(ClusterJobArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20260215preview:ClusterJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260301preview:ClusterJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:ClusterJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260501preview:ClusterJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterJob, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterJob':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ClusterJob(resource_name, opts=opts, __props__=__props__)
