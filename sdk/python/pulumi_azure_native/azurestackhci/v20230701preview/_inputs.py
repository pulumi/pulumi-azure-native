...
class VirtualMachineInstancePropertiesDynamicMemoryConfigArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'maximumMemoryMB' in kwargs:
            maximum_memory_mb = kwargs['maximumMemoryMB']
        if 'minimumMemoryMB' in kwargs:
            minimum_memory_mb = kwargs['minimumMemoryMB']
        if 'targetMemoryBuffer' in kwargs:
...
class VirtualMachineInstancePropertiesLinuxConfigurationArgs:
    ...
    def _configure(
        ...
        if 'provisionVMConfigAgent' in kwargs:
...
class VirtualMachineInstancePropertiesStorageProfileArgs:
    ...
    def _configure(
        ...
        if 'vmConfigStoragePathId' in kwargs:
...
class VirtualNetworkPropertiesSubnetsArgs:
    ...
    def _configure(
        ...
        if 'ipConfigurationReferences' in kwargs:
