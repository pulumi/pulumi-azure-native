...
def get_network_interface(network_interface_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230701preview:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult).value
...
def get_network_interface_output(network_interface_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20230701preview:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
