...
class VirtualMachineInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(hardware_profile, VirtualMachineInstancePropertiesHardwareProfileArgs):
            ...
            if not isinstance(network_profile, VirtualMachineInstancePropertiesNetworkProfileArgs):
            ...
            if not isinstance(os_profile, VirtualMachineInstancePropertiesOsProfileArgs):
            ...
            if not isinstance(security_profile, VirtualMachineInstancePropertiesSecurityProfileArgs):
            ...
            if not isinstance(storage_profile, VirtualMachineInstancePropertiesStorageProfileArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:VirtualMachineInstance")])
