...
def get_edge_device(edge_device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getEdgeDevice', __args__, opts=opts, typ=GetEdgeDeviceResult).value
...
def get_edge_device_output(edge_device_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getEdgeDevice', __args__, opts=opts, typ=GetEdgeDeviceResult)
