...
def get_cluster_job(cluster_name: Optional[_builtins.str] = None,
                    jobs_name: Optional[_builtins.str] = None,
                    resource_group_name: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClusterJobResult:
    """
    Get a ClusterJob
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getClusterJob', __args__, opts=opts, typ=GetClusterJobResult).value

    return AwaitableGetClusterJobResult(
...
def get_cluster_job_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getClusterJob', __args__, opts=opts, typ=GetClusterJobResult)
    return __ret__.apply(lambda __response__: GetClusterJobResult(
