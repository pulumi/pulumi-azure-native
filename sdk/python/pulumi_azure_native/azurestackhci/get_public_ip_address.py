...
def get_public_ip_address(public_ip_address_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult).value
...
def get_public_ip_address_output(public_ip_address_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getPublicIPAddress', __args__, opts=opts, typ=GetPublicIPAddressResult)
