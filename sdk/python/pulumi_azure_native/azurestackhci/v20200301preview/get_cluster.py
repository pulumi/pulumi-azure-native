...
warnings.warn("""Version 2020-03-01-preview will be removed in v2 of the provider.
azure-native:azurestackhci/v20200301preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20220101:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: Version 2020-03-01-preview will be removed in v2 of the provider.
azure-native:azurestackhci/v20200301preview:Cluster is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20220101:Cluster to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20200301preview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
