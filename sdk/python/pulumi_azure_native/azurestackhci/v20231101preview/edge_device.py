...
class EdgeDeviceArgs:
    def __init__(__self__, *,
                 device_configuration: pulumi.Input['DeviceConfigurationArgs'],
    ...
    def device_configuration(self) -> pulumi.Input['DeviceConfigurationArgs']:
        """
    ...
    def device_configuration(self, value: pulumi.Input['DeviceConfigurationArgs']):
...
class EdgeDevice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if device_configuration is None and not opts.urn:
                raise TypeError("Missing required property 'device_configuration'")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230801preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:HciEdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:HciEdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:HciEdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:HciEdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci:EdgeDevice")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EdgeDevice, __self__).__init__(
            'azure-native:azurestackhci/v20231101preview:EdgeDevice',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="deviceConfiguration")
    def device_configuration(self) -> pulumi.Output['outputs.DeviceConfigurationResponse']:
        """
        Device Configuration
        """
        return pulumi.get(self, "device_configuration")
