...
def get_hybrid_identity_metadatum(metadata_name: Optional[builtins.str] = None,
...
def get_hybrid_identity_metadatum_output(metadata_name: Optional[pulumi.Input[builtins.str]] = None,
