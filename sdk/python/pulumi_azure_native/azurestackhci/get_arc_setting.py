...
def get_arc_setting(arc_setting_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str arc_setting_name: The name of the proxy resource holding details of HCI ArcSetting information.
...
def get_arc_setting_output(arc_setting_name: pulumi.Input[Optional[_builtins.str]] = None,
