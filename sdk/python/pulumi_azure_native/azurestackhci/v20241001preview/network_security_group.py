...
class NetworkSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci/v20250401preview:NetworkSecurityGroup"), pulumi.Alias(type_="azure-native:azurestackhci:NetworkSecurityGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NetworkSecurityGroup, __self__).__init__(
            'azure-native:azurestackhci/v20241001preview:NetworkSecurityGroup',
            resource_name,
            __props__,
            opts)
