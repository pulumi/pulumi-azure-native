...
def get_marketplace_gallery_image(marketplace_gallery_image_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20241001preview:getMarketplaceGalleryImage', __args__, opts=opts, typ=GetMarketplaceGalleryImageResult).value
...
def get_marketplace_gallery_image_output(marketplace_gallery_image_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20241001preview:getMarketplaceGalleryImage', __args__, opts=opts, typ=GetMarketplaceGalleryImageResult)
