...
def get_device_pool(device_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str device_pool_name: The name of the DevicePool
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    """
    __args__ = dict()
    __args__['devicePoolName'] = device_pool_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getDevicePool', __args__, opts=opts, typ=GetDevicePoolResult).value
...
def get_device_pool_output(device_pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getDevicePool', __args__, opts=opts, typ=GetDevicePoolResult)
