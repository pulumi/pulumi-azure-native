...
def get_storage_container(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240801preview:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult).value
...
def get_storage_container_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageContainerName'] = storage_container_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20240801preview:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult)
