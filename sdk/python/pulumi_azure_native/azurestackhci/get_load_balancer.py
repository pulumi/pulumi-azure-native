...
def get_load_balancer(load_balancer_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str load_balancer_name: Name of the load balancer
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult).value
...
def get_load_balancer_output(load_balancer_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult)
