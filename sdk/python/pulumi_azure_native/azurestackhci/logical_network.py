...
class LogicalNetworkArgs:
    ...
    def _configure(
        ...
        if logical_network_name is None and 'logicalNetworkName' in kwargs:
...
class LogicalNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            dhcp_options = _utilities.configure(dhcp_options, LogicalNetworkPropertiesDhcpOptionsArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230901preview:LogicalNetwork")])
