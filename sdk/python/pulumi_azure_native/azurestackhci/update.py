...
class UpdateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: Display name of the Update
        :param pulumi.Input[_builtins.str] health_check_date: Last time the package-specific checks were run.
        :param pulumi.Input[_builtins.str] installed_date: Date that the update was installed.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] min_sbe_version_required: Minimum Sbe Version of the update.
        :param pulumi.Input[_builtins.str] notify_message: Brief message with instructions for updates of AvailabilityType Notify.
        :param pulumi.Input[_builtins.str] package_path: Path where the update package is available.
        :param pulumi.Input[_builtins.float] package_size_in_mb: Size of the package. This value is a combination of the size from update metadata and size of the payload that results from the live scan operation for OS update content.
        :param pulumi.Input[_builtins.str] package_type: Customer-visible type of the update.
        ...
        :param pulumi.Input[_builtins.float] progress_percentage: Progress percentage of ongoing operation. Currently this property is only valid when the update is in the Downloading state, where it maps to how much of the update content has been downloaded.
...
class Update(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20221201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230301:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230601:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20250915preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20251001:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20251101preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20251201preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260215preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260301preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260430:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20260501preview:Update")])
