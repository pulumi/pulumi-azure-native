...
class UpdateRunArgs:
    def __init__(__self__, *,
                 ...
                 update_name: pulumi.Input[builtins.str],
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'UpdateRunPropertiesState']]] = None,
                 ...
                 update_run_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] duration: Duration of the update run.
        ...
        :param pulumi.Input[builtins.str] last_updated_time: Timestamp of the most recently completed step in the update run.
        ...
        :param pulumi.Input[Union[builtins.str, 'UpdateRunPropertiesState']] state: State of the update run.
        ...
        :param pulumi.Input[builtins.str] time_started: Timestamp of the update run was started.
        :param pulumi.Input[builtins.str] update_run_name: The name of the Update Run
        """
    ...
    def update_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @update_name.setter
    def update_name(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'UpdateRunPropertiesState']]]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'UpdateRunPropertiesState']]]):
    ...
    def update_run_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def update_run_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UpdateRun(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endTimeUtc")
    def end_time_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When the step reached a terminal state.
        """
        return pulumi.get(self, "end_time_utc")
    ...
    @property
    @pulumi.getter(name="errorMessage")
    def error_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Error message, specified if the step is in a failed state.
        """
        return pulumi.get(self, "error_message")
    ...
    @property
    @pulumi.getter(name="expectedExecutionTime")
    def expected_execution_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Expected execution time of a given step. This is optionally authored in the update action plan and can be empty.
        """
        return pulumi.get(self, "expected_execution_time")
    ...
    @property
    @pulumi.getter(name="lastUpdatedTime")
    def last_updated_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Timestamp of the most recently completed step in the update run.
        """
        return pulumi.get(self, "last_updated_time")
    ...
    @property
    @pulumi.getter(name="lastUpdatedTimeUtc")
    def last_updated_time_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Completion time of this step or the last completed sub-step.
        """
        return pulumi.get(self, "last_updated_time_utc")
    ...
    @property
    @pulumi.getter(name="startTimeUtc")
    def start_time_utc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When the step started, or empty if it has not started executing.
        """
        return pulumi.get(self, "start_time_utc")
    ...
    @property
    @pulumi.getter(name="timeStarted")
    def time_started(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Timestamp of the update run was started.
        """
        return pulumi.get(self, "time_started")
