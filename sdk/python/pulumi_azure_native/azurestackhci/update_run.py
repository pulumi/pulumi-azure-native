...
class UpdateRunArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_updated_time: Timestamp of the most recently completed step in the update run.
        ...
        :param pulumi.Input[Union[_builtins.str, 'UpdateRunPropertiesState']] state: State of the update run.
...
class UpdateRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20221201:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20230201:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20230301:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20230601:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20250915preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20251001:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20251101preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20251201preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260215preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260301preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260430:UpdateRun"), pulumi.Alias(type_="azure-native:azurestackhci/v20260501preview:UpdateRun")])
