...
class StoragecontainerRetrieve(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 extended_location: Optional[pulumi.Input[pulumi.InputType['StoragecontainersExtendedLocationArgs']]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 path: Optional[pulumi.Input[str]] = None,
                 provisioning_state: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:storagecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:StoragecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:storagecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:StoragecontainerRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:storagecontainerRetrieve")])
