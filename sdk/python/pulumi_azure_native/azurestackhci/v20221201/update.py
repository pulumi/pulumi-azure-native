...
class Update(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Update is deprecated: azure-native:azurestackhci/v20221201:Update is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Update to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230201:Update")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Update, __self__).__init__(
            'azure-native:azurestackhci/v20221201:Update',
            resource_name,
            __props__,
            opts)
