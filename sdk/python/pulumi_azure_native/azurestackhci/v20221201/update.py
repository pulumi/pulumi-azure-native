...
class Update(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Update is deprecated: azure-native:azurestackhci/v20221201:Update is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:Update to guarantee forwards compatibility.""")
