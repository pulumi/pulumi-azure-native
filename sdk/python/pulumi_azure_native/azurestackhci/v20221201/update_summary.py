...
warnings.warn("""azure-native:azurestackhci/v20221201:UpdateSummary is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:UpdateSummary to guarantee forwards compatibility.""", DeprecationWarning)
...
class UpdateSummary(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 state: Optional[pulumi.Input[Union[str, 'UpdateSummariesPropertiesState']]] = None,
                 __props__=None):
        pulumi.log.warn("""UpdateSummary is deprecated: azure-native:azurestackhci/v20221201:UpdateSummary is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:UpdateSummary to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230201:UpdateSummary")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UpdateSummary, __self__).__init__(
            'azure-native:azurestackhci/v20221201:UpdateSummary',
            resource_name,
            __props__,
            opts)
