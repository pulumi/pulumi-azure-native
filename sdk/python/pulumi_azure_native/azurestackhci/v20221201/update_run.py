...
warnings.warn("""azure-native:azurestackhci/v20221201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:UpdateRun to guarantee forwards compatibility.""", DeprecationWarning)
...
class UpdateRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 update_run_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""UpdateRun is deprecated: azure-native:azurestackhci/v20221201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:UpdateRun to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230201:UpdateRun")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UpdateRun, __self__).__init__(
            'azure-native:azurestackhci/v20221201:UpdateRun',
            resource_name,
            __props__,
            opts)
