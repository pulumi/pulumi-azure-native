...
class UpdateRun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 update_run_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""UpdateRun is deprecated: azure-native:azurestackhci/v20221201:UpdateRun is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:UpdateRun to guarantee forwards compatibility.""")
