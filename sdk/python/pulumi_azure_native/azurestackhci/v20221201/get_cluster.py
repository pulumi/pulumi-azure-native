...
warnings.warn("""azure-native:azurestackhci/v20221201:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:Cluster to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: azure-native:azurestackhci/v20221201:Cluster is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20230201:Cluster to guarantee forwards compatibility.""")
    __args__ = dict()
