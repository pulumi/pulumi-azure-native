...
class MarketplaceGalleryImageArgs:
    def __init__(__self__, *,
                 ...
                 marketplace_gallery_image_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] container_id: Storage ContainerID of the storage container to be used for marketplace gallery image
    ...
    def marketplace_gallery_image_name(self, value: Optional[pulumi.Input[_builtins.str]]):
