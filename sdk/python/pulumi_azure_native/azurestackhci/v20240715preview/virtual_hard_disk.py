...
class VirtualHardDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] create_from_local: Boolean indicating whether this is a local hard disk or if one should be created.
        ...
        :param pulumi.Input[Union[str, 'OperatingSystemTypes']] os_type: Operating system type of the OS disk. Possible values are: Windows, Linux.
...
class VirtualHardDisk(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20230901preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20241001preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20250401preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci:VirtualHardDisk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualHardDisk, __self__).__init__(
            'azure-native:azurestackhci/v20240715preview:VirtualHardDisk',
            resource_name,
            __props__,
            opts)
