...
def get_virtual_hard_disk(resource_group_name: Optional[_builtins.str] = None,
                          virtual_hard_disk_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str virtual_hard_disk_name: Name of the virtual hard disk
    """
    __args__ = dict()
...
def get_virtual_hard_disk_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 virtual_hard_disk_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
