...
def get_hci_edge_device(edge_device_name: Optional[builtins.str] = None,
    ...
    :param builtins.str edge_device_name: Name of Device
...
def get_hci_edge_device_output(edge_device_name: Optional[pulumi.Input[builtins.str]] = None,
