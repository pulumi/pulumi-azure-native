...
def get_hci_edge_device(edge_device_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str edge_device_name: Name of Device
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getHciEdgeDevice', __args__, opts=opts, typ=GetHciEdgeDeviceResult).value
...
def get_hci_edge_device_output(edge_device_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getHciEdgeDevice', __args__, opts=opts, typ=GetHciEdgeDeviceResult)
