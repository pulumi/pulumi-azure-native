...
def get_update_run(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240401:getUpdateRun', __args__, opts=opts, typ=GetUpdateRunResult).value
...
def get_update_run_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['updateRunName'] = update_run_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20240401:getUpdateRun', __args__, opts=opts, typ=GetUpdateRunResult)
