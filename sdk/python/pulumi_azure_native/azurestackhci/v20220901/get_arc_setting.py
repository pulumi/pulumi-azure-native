...
warnings.warn("""azure-native:azurestackhci/v20220901:ArcSetting is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20221001:ArcSetting to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_arc_setting(arc_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_arc_setting is deprecated: azure-native:azurestackhci/v20220901:ArcSetting is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20221001:ArcSetting to guarantee forwards compatibility.""")
    __args__ = dict()
