...
class EdgeMachineJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20251201preview:EdgeMachineJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260215preview:EdgeMachineJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260301preview:EdgeMachineJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:EdgeMachineJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20260501preview:EdgeMachineJob")])
