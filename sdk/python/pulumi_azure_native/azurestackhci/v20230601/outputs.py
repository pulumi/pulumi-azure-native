...
class ClusterNodeResponse(dict):
    ...
    def _configure(
             ...
             last_licensing_timestamp: Optional[str] = None,
             manufacturer: Optional[str] = None,
             memory_in_gi_b: Optional[float] = None,
             model: Optional[str] = None,
             name: Optional[str] = None,
             node_type: Optional[str] = None,
             oem_activation: Optional[str] = None,
        ...
        if last_licensing_timestamp is None and 'lastLicensingTimestamp' in kwargs:
            last_licensing_timestamp = kwargs['lastLicensingTimestamp']
        if last_licensing_timestamp is None:
            raise TypeError("Missing 'last_licensing_timestamp' argument")
        ...
        if oem_activation is None and 'oemActivation' in kwargs:
            oem_activation = kwargs['oemActivation']
        if oem_activation is None:
            raise TypeError("Missing 'oem_activation' argument")
        ...
        _setter("oem_activation", oem_activation)
...
class ServiceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ServiceConfigurationResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            port=port,
