...
class UpdateArgs:
    ...
    def _configure(
        ...
        if installed_date is None and 'installedDate' in kwargs:
            installed_date = kwargs['installedDate']
        if notify_message is None and 'notifyMessage' in kwargs:
            notify_message = kwargs['notifyMessage']
        if package_path is None and 'packagePath' in kwargs:
            package_path = kwargs['packagePath']
        if package_size_in_mb is None and 'packageSizeInMb' in kwargs:
        ...
        if progress_percentage is None and 'progressPercentage' in kwargs:
            progress_percentage = kwargs['progressPercentage']
        if release_link is None and 'releaseLink' in kwargs:
...
class Update(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20221201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230301:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801:Update")])
