...
def get_logical_network(logical_network_name: Optional[builtins.str] = None,
    ...
    :param builtins.str logical_network_name: Name of the logical network
...
def get_logical_network_output(logical_network_name: Optional[pulumi.Input[builtins.str]] = None,
