...
def get_logical_network(logical_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str logical_network_name: Name of the logical network
...
def get_logical_network_output(logical_network_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
