...
def get_update_run(cluster_name: Optional[_builtins.str] = None,
                   resource_group_name: Optional[_builtins.str] = None,
                   update_name: Optional[_builtins.str] = None,
                   update_run_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str update_name: The name of the Update
    :param _builtins.str update_run_name: The name of the Update Run
    """
    __args__ = dict()
...
def get_update_run_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
