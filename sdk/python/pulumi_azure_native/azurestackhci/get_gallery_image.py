...
class GetGalleryImageResult:
    ...
    def cloud_init_data_source(self) -> Optional[builtins.str]:
        """
    ...
    def source_virtual_machine_id(self) -> Optional[builtins.str]:
        """
...
def get_gallery_image(gallery_image_name: Optional[builtins.str] = None,
    ...
    :param builtins.str gallery_image_name: Name of the gallery image
