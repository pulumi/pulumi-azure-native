...
class GetNatGatewayResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.NatGatewayPropertiesResponse':
        """
...
def get_nat_gateway(nat_gateway_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str nat_gateway_name: Name of the nat gateway
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult).value
...
def get_nat_gateway_output(nat_gateway_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getNatGateway', __args__, opts=opts, typ=GetNatGatewayResult)
