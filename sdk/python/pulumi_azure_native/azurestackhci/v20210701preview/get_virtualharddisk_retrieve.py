...
class GetVirtualharddiskRetrieveResult:
    ...
    """
    def __init__(__self__, block_size_bytes=None, disk_size_bytes=None, dynamic=None, extended_location=None, id=None, location=None, logical_sector_bytes=None, name=None, physical_sector_bytes=None, provisioning_state=None, resource_name=None, status=None, system_data=None, tags=None, type=None):
...
def get_virtualharddisk_retrieve(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20210701preview:getVirtualharddiskRetrieve', __args__, opts=opts, typ=GetVirtualharddiskRetrieveResult).value
