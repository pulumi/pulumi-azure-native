...
class VirtualnetworkRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:VirtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:virtualnetworkRetrieve")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualnetworkRetrieve, __self__).__init__(
            'azure-native:azurestackhci/v20210701preview:VirtualnetworkRetrieve',
            resource_name,
            __props__,
            opts)
