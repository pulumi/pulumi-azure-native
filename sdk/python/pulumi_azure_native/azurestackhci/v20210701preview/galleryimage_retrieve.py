...
class GalleryimageRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:galleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:GalleryimageRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:galleryimageRetrieve")])
