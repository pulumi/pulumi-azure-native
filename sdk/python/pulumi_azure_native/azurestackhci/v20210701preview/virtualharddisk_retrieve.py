...
warnings.warn("""azure-native:azurestackhci/v20210701preview:virtualharddiskRetrieve is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20210901preview:virtualharddiskRetrieve to guarantee forwards compatibility.""", DeprecationWarning)
...
class VirtualharddiskRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtualharddisks_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""VirtualharddiskRetrieve is deprecated: azure-native:azurestackhci/v20210701preview:virtualharddiskRetrieve is being removed in the next major version of this provider. Please upgrade to azure-native:azurestackhci/v20210901preview:virtualharddiskRetrieve to guarantee forwards compatibility.""")
