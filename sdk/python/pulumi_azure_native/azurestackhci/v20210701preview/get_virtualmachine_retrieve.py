...
class GetVirtualmachineRetrieveResult:
    ...
    """
    def __init__(__self__, extended_location=None, hardware_profile=None, id=None, location=None, name=None, network_profile=None, os_profile=None, provisioning_state=None, resource_name=None, security_profile=None, status=None, storage_profile=None, system_data=None, tags=None, type=None):
...
def get_virtualmachine_retrieve(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20210701preview:getVirtualmachineRetrieve', __args__, opts=opts, typ=GetVirtualmachineRetrieveResult).value
