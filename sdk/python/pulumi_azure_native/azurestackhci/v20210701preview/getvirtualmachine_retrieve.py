...
def getvirtualmachine_retrieve(resource_group_name: Optional[str] = None,
...
@_utilities.lift_output_func(getvirtualmachine_retrieve)
def getvirtualmachine_retrieve_output(resource_group_name: Optional[pulumi.Input[str]] = None,
