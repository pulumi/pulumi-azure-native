...
def get_virtual_machine_instance_output(resource_uri: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult)
