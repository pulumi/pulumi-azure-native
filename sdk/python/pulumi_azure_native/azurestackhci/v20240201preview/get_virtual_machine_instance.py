...
def get_virtual_machine_instance(resource_uri: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240201preview:getVirtualMachineInstance', __args__, opts=opts, typ=GetVirtualMachineInstanceResult).value
