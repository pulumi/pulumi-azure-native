...
class NetworkInterface(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 mac_address: Optional[pulumi.Input[str]] = None,
                 network_interface_name: Optional[pulumi.Input[str]] = None,
                 network_security_group: Optional[pulumi.Input[pulumi.InputType['NetworkSecurityGroupArmReferenceArgs']]] = None,
        ...
        :param pulumi.Input[str] mac_address: MacAddress - The MAC address of the network interface.
        :param pulumi.Input[str] network_interface_name: Name of the network interface
        :param pulumi.Input[pulumi.InputType['NetworkSecurityGroupArmReferenceArgs']] network_security_group: NetworkSecurityGroup - Network Security Group attached to the network interface.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
