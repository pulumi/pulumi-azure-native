...
class SecuritySettingArgs:
    def __init__(__self__, *,
                 ...
                 secured_core_compliance_assignment: Optional[pulumi.Input[Union[_builtins.str, 'ComplianceAssignmentType']]] = None,
                 security_settings_name: Optional[pulumi.Input[_builtins.str]] = None,
                 smb_encryption_for_intra_cluster_traffic_compliance_assignment: Optional[pulumi.Input[Union[_builtins.str, 'ComplianceAssignmentType']]] = None,
    ...
    def secured_core_compliance_assignment(self, value: Optional[pulumi.Input[Union[_builtins.str, 'ComplianceAssignmentType']]]):
    ...
    def smb_encryption_for_intra_cluster_traffic_compliance_assignment(self, value: Optional[pulumi.Input[Union[_builtins.str, 'ComplianceAssignmentType']]]):
    ...
    def wdac_compliance_assignment(self, value: Optional[pulumi.Input[Union[_builtins.str, 'ComplianceAssignmentType']]]):
...
class SecuritySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20250915preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251001:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260215preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260301preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260401preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260430:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260501preview:SecuritySetting")])
