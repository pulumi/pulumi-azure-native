...
class SecuritySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20231101preview:azurestackhci:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20240101:azurestackhci:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20240215preview:azurestackhci:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20240401:azurestackhci:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20240901preview:azurestackhci:SecuritySetting"), pulumi.Alias(type_="azure-native_azurestackhci_v20241201preview:azurestackhci:SecuritySetting")])
