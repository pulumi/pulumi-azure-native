...
class SecuritySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20250915preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251001:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20251201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20260201:SecuritySetting")])
