...
class HciEdgeDeviceJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:HciEdgeDeviceJob"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:HciEdgeDeviceJob"), pulumi.Alias(type_="azure-native:azurestackhci:HciEdgeDeviceJob")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HciEdgeDeviceJob, __self__).__init__(
            'azure-native:azurestackhci/v20250201preview:HciEdgeDeviceJob',
            resource_name,
            __props__,
            opts)
