...
def get_security_setting(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getSecuritySetting', __args__, opts=opts, typ=GetSecuritySettingResult).value
...
def get_security_setting_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getSecuritySetting', __args__, opts=opts, typ=GetSecuritySettingResult)
