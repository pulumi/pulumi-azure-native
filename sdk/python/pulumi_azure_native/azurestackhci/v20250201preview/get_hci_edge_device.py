...
def get_hci_edge_device(edge_device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getHciEdgeDevice', __args__, opts=opts, typ=GetHciEdgeDeviceResult).value
...
def get_hci_edge_device_output(edge_device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getHciEdgeDevice', __args__, opts=opts, typ=GetHciEdgeDeviceResult)
