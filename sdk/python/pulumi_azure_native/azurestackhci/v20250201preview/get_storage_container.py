...
def get_storage_container(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult).value
...
def get_storage_container_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getStorageContainer', __args__, opts=opts, typ=GetStorageContainerResult)
