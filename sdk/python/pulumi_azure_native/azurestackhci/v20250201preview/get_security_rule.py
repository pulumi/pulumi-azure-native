...
def get_security_rule(network_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult).value
...
def get_security_rule_output(network_security_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getSecurityRule', __args__, opts=opts, typ=GetSecurityRuleResult)
