...
class GetNetworkInterfaceResult:
    ...
    """
    def __init__(__self__, create_from_local=None, dns_settings=None, extended_location=None, id=None, ip_configurations=None, location=None, mac_address=None, name=None, network_security_group=None, provisioning_state=None, status=None, system_data=None, tags=None, type=None):
...
def get_network_interface(network_interface_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult).value
...
def get_network_interface_output(network_interface_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult)
