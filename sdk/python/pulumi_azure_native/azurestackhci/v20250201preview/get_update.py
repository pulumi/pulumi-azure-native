...
def get_update(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getUpdate', __args__, opts=opts, typ=GetUpdateResult).value
...
def get_update_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getUpdate', __args__, opts=opts, typ=GetUpdateResult)
