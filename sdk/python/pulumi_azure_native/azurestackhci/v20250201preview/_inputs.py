...
__all__ = [
    ...
    'IpPoolsArgs',
    'IpPoolsArgsDict',
    'LocalAvailabilityZonesArgs',
    'LocalAvailabilityZonesArgsDict',
...
if not MYPY:
    class DeploymentClusterArgsDict(TypedDict):
        ...
        """
        cluster_pattern: NotRequired[pulumi.Input[Union[str, 'ClusterPattern']]]
        """
...
class DeploymentClusterArgs:
    def __init__(__self__, *,
                 ...
                 cluster_pattern: Optional[pulumi.Input[Union[str, 'ClusterPattern']]] = None,
        ...
        :param pulumi.Input[Union[str, 'ClusterPattern']] cluster_pattern: Cluster Pattern supported.
    ...
    def cluster_pattern(self) -> Optional[pulumi.Input[Union[str, 'ClusterPattern']]]:
        """
        Cluster Pattern supported.
        """
        return pulumi.get(self, "cluster_pattern")

    @cluster_pattern.setter
    def cluster_pattern(self, value: Optional[pulumi.Input[Union[str, 'ClusterPattern']]]):
        pulumi.set(self, "cluster_pattern", value)
...
if not MYPY:
    class DeploymentDataArgsDict(TypedDict):
        ...
        """
        local_availability_zones: NotRequired[pulumi.Input[Sequence[pulumi.Input['LocalAvailabilityZonesArgsDict']]]]
        """
...
if not MYPY:
    class LocalAvailabilityZonesArgsDict(TypedDict):
        """
        Local Availability Zone information for HCI cluster
        """
        local_availability_zone_name: NotRequired[pulumi.Input[str]]
        """
        Local Availability Zone name for HCI cluster
        """
        nodes: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        Nodes belonging to a particular zone
        """
elif False:
    LocalAvailabilityZonesArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class LocalAvailabilityZonesArgs:
    def __init__(__self__, *,
                 local_availability_zone_name: Optional[pulumi.Input[str]] = None,
                 nodes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        Local Availability Zone information for HCI cluster
        :param pulumi.Input[str] local_availability_zone_name: Local Availability Zone name for HCI cluster
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nodes: Nodes belonging to a particular zone
        """
    ...
    def local_availability_zone_name(self) -> Optional[pulumi.Input[str]]:
        """
        Local Availability Zone name for HCI cluster
        """
        return pulumi.get(self, "local_availability_zone_name")

    @local_availability_zone_name.setter
    def local_availability_zone_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "local_availability_zone_name", value)
