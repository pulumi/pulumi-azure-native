...
def get_hci_edge_device_job(edge_device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getHciEdgeDeviceJob', __args__, opts=opts, typ=GetHciEdgeDeviceJobResult).value
...
def get_hci_edge_device_job_output(edge_device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getHciEdgeDeviceJob', __args__, opts=opts, typ=GetHciEdgeDeviceJobResult)
