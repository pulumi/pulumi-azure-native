...
def get_arc_setting(arc_setting_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getArcSetting', __args__, opts=opts, typ=GetArcSettingResult).value
...
def get_arc_setting_output(arc_setting_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getArcSetting', __args__, opts=opts, typ=GetArcSettingResult)
