...
class GetClusterResult:
    ...
    Cluster details.
    """
    def __init__(__self__, aad_application_object_id=None, aad_client_id=None, aad_service_principal_object_id=None, aad_tenant_id=None, billing_model=None, cloud_id=None, cloud_management_endpoint=None, cluster_pattern=None, connectivity_status=None, desired_properties=None, id=None, isolated_vm_attestation_configuration=None, last_billing_timestamp=None, last_sync_timestamp=None, local_availability_zones=None, location=None, log_collection_properties=None, name=None, principal_id=None, provisioning_state=None, registration_timestamp=None, remote_support_properties=None, reported_properties=None, resource_provider_object_id=None, secrets_locations=None, service_endpoint=None, software_assurance_properties=None, status=None, system_data=None, tags=None, tenant_id=None, trial_days_remaining=None, type=None, user_assigned_identities=None):
        ...
        if cluster_pattern and not isinstance(cluster_pattern, str):
            raise TypeError("Expected argument 'cluster_pattern' to be a str")
        ...
        if local_availability_zones and not isinstance(local_availability_zones, list):
            raise TypeError("Expected argument 'local_availability_zones' to be a list")
...
class AwaitableGetClusterResult(GetClusterResult):
    ...
    def __await__(self):
        ...
        return GetClusterResult(
            ...
            cluster_pattern=self.cluster_pattern,
            ...
            local_availability_zones=self.local_availability_zones,
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getCluster', __args__, opts=opts, typ=GetClusterResult).value
    ...
    return AwaitableGetClusterResult(
        ...
        cluster_pattern=pulumi.get(__ret__, 'cluster_pattern'),
        ...
        local_availability_zones=pulumi.get(__ret__, 'local_availability_zones'),
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getCluster', __args__, opts=opts, typ=GetClusterResult)
    return __ret__.apply(lambda __response__: GetClusterResult(
        ...
        cluster_pattern=pulumi.get(__response__, 'cluster_pattern'),
        ...
        local_availability_zones=pulumi.get(__response__, 'local_availability_zones'),
