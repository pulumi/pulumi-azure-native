...
class GetVirtualHardDiskResult:
    ...
    """
    def __init__(__self__, block_size_bytes=None, container_id=None, create_from_local=None, disk_file_format=None, disk_size_gb=None, download_url=None, dynamic=None, extended_location=None, hyper_v_generation=None, id=None, location=None, logical_sector_bytes=None, name=None, physical_sector_bytes=None, provisioning_state=None, status=None, system_data=None, tags=None, type=None):
...
def get_virtual_hard_disk(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20250201preview:getVirtualHardDisk', __args__, opts=opts, typ=GetVirtualHardDiskResult).value
...
def get_virtual_hard_disk_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20250201preview:getVirtualHardDisk', __args__, opts=opts, typ=GetVirtualHardDiskResult)
