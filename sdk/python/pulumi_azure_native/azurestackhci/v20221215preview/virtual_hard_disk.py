...
class VirtualHardDisk(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20230701preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20230901preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240201preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240501preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240715preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20240801preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20241001preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:VirtualHardDisk"), pulumi.Alias(type_="azure-native:azurestackhci:VirtualHardDisk")])
