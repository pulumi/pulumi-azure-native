...
class MachineExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:MachineExtension"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:MachineExtension")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MachineExtension, __self__).__init__(
            'azure-native:azurestackhci/v20221215preview:MachineExtension',
            resource_name,
            __props__,
            opts)
