...
class ArcSettingArgs:
    ...
    def _configure(
        ...
        if arc_application_client_id is None and 'arcApplicationClientId' in kwargs:
            arc_application_client_id = kwargs['arcApplicationClientId']
        if arc_application_object_id is None and 'arcApplicationObjectId' in kwargs:
            arc_application_object_id = kwargs['arcApplicationObjectId']
        if arc_application_tenant_id is None and 'arcApplicationTenantId' in kwargs:
            arc_application_tenant_id = kwargs['arcApplicationTenantId']
        if arc_instance_resource_group is None and 'arcInstanceResourceGroup' in kwargs:
            arc_instance_resource_group = kwargs['arcInstanceResourceGroup']
        if arc_service_principal_object_id is None and 'arcServicePrincipalObjectId' in kwargs:
            arc_service_principal_object_id = kwargs['arcServicePrincipalObjectId']
        if arc_setting_name is None and 'arcSettingName' in kwargs:
            arc_setting_name = kwargs['arcSettingName']
        if connectivity_properties is None and 'connectivityProperties' in kwargs:
            connectivity_properties = kwargs['connectivityProperties']
...
class ArcSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20210101preview:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20220101:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20220301:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20220501:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20220901:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20221001:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20221201:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20230201:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20230301:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20230601:ArcSetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20230801:ArcSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArcSetting, __self__).__init__(
            'azure-native:azurestackhci/v20221215preview:ArcSetting',
            resource_name,
            __props__,
            opts)
