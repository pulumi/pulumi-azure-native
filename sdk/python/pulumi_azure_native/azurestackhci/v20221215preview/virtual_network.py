...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:VirtualNetwork"), pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:VirtualNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetwork, __self__).__init__(
            'azure-native:azurestackhci/v20221215preview:VirtualNetwork',
            resource_name,
            __props__,
            opts)
