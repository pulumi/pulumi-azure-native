...
class GetUpdateSummaryResult:
    ...
    """
    def __init__(__self__, current_oem_version=None, current_version=None, hardware_model=None, health_check_date=None, id=None, last_checked=None, last_updated=None, location=None, name=None, oem_family=None, provisioning_state=None, state=None, system_data=None, type=None):
...
def get_update_summary(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20221215preview:getUpdateSummary', __args__, opts=opts, typ=GetUpdateSummaryResult).value
...
def get_update_summary_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20221215preview:getUpdateSummary', __args__, opts=opts, typ=GetUpdateSummaryResult)
