...
def get_arc_setting(arc_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_arc_setting is deprecated: azure-native:azurestackhci/v20210101preview:ArcSetting is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20210901preview:ArcSetting to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['arcSettingName'] = arc_setting_name
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20210101preview:getArcSetting', __args__, opts=opts, typ=GetArcSettingResult).value
