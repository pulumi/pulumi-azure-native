...
class ArcSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        arc_setting = azure_native.azurestackhci.v20221001.ArcSetting("arcSetting",
