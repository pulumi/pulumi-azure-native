...
def get_extension(arc_setting_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240901preview:getExtension', __args__, opts=opts, typ=GetExtensionResult).value
...
def get_extension_output(arc_setting_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20240901preview:getExtension', __args__, opts=opts, typ=GetExtensionResult)
