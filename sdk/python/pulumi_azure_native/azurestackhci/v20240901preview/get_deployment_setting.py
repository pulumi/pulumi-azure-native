...
def get_deployment_setting(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240901preview:getDeploymentSetting', __args__, opts=opts, typ=GetDeploymentSettingResult).value
