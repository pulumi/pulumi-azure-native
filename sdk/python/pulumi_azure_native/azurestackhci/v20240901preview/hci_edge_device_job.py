...
class HciEdgeDeviceJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:HciEdgeDeviceJob"), pulumi.Alias(type_="azure-native:azurestackhci:HciEdgeDeviceJob")])
