...
warnings.warn("""azure-native:azurestackhci/v20230201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:UpdateRun to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_update_run(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_update_run is deprecated: azure-native:azurestackhci/v20230201:UpdateRun is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:UpdateRun to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230201:getUpdateRun', __args__, opts=opts, typ=GetUpdateRunResult).value
