...
class Update(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        update = azure_native.azurestackhci.v20230201.Update("update",
            ...
            prerequisites=[azure_native.azurestackhci.v20230201.UpdatePrerequisiteArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20221201:Update"), pulumi.Alias(type_="azure-native:azurestackhci/v20230301:Update")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Update, __self__).__init__(
            'azure-native:azurestackhci/v20230201:Update',
            resource_name,
            __props__,
            opts)
