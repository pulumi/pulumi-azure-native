...
def get_update(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_update is deprecated: azure-native:azurestackhci/v20230201:Update is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20230301:Update to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['updateName'] = update_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230201:getUpdate', __args__, opts=opts, typ=GetUpdateResult).value
