...
class VirtualnetworkRetrieve(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:virtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:VirtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210701preview:virtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:VirtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:virtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:VirtualnetworkRetrieve"), pulumi.Alias(type_="azure-native:azurestackhci/v20221215preview:virtualnetworkRetrieve")])
