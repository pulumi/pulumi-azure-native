...
def get_extension(arc_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_extension is deprecated: azure-native:azurestackhci/v20210901:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.""")
    __args__ = dict()
