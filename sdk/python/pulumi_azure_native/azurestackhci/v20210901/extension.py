...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurestackhci/v20210901:Extension"), pulumi.Alias(type_="azure-native:azurestackhci:Extension"), pulumi.Alias(type_="azure-nextgen:azurestackhci:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20210101preview:Extension"), pulumi.Alias(type_="azure-nextgen:azurestackhci/v20210101preview:Extension")])
