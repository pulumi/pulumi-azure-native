...
def get_update(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20230801:getUpdate', __args__, opts=opts, typ=GetUpdateResult).value
...
def get_update_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['updateName'] = update_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20230801:getUpdate', __args__, opts=opts, typ=GetUpdateResult)
