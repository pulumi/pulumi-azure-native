...
class IsolatedVmAttestationConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IsolatedVmAttestationConfigurationResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attestation_resource_id=attestation_resource_id,
            attestation_service_endpoint=attestation_service_endpoint,
            relying_party_service_endpoint=relying_party_service_endpoint,
        )
    @staticmethod
    def _configure(
             _setter: Callable[[Any, Any], None],
             attestation_resource_id: Optional[str] = None,
             attestation_service_endpoint: Optional[str] = None,
             relying_party_service_endpoint: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if attestation_resource_id is None and 'attestationResourceId' in kwargs:
            attestation_resource_id = kwargs['attestationResourceId']
        if attestation_resource_id is None:
            raise TypeError("Missing 'attestation_resource_id' argument")
        if attestation_service_endpoint is None and 'attestationServiceEndpoint' in kwargs:
            attestation_service_endpoint = kwargs['attestationServiceEndpoint']
        if attestation_service_endpoint is None:
            raise TypeError("Missing 'attestation_service_endpoint' argument")
        if relying_party_service_endpoint is None and 'relyingPartyServiceEndpoint' in kwargs:
            relying_party_service_endpoint = kwargs['relyingPartyServiceEndpoint']
        if relying_party_service_endpoint is None:
            raise TypeError("Missing 'relying_party_service_endpoint' argument")

        _setter("attestation_resource_id", attestation_resource_id)
        _setter("attestation_service_endpoint", attestation_service_endpoint)
        _setter("relying_party_service_endpoint", relying_party_service_endpoint)
...
class SoftwareAssurancePropertiesResponse(dict):
    ...
    def _configure(
        ...
        if software_assurance_status is None:
            raise TypeError("Missing 'software_assurance_status' argument")
