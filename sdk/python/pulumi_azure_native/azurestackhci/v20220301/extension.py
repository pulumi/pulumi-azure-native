...
warnings.warn("""azure-native:azurestackhci/v20220301:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.""", DeprecationWarning)
...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type_handler_version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Extension is deprecated: azure-native:azurestackhci/v20220301:Extension is being removed in the next major version of this provider. Upgrade to at least azure-native:azurestackhci/v20221215preview:Extension to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20210101preview:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20210901preview:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20220101:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20220501:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20220901:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20221001:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20221201:Extension"), pulumi.Alias(type_="azure-native:azurestackhci/v20230201:Extension")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Extension, __self__).__init__(
            'azure-native:azurestackhci/v20220301:Extension',
            resource_name,
            __props__,
            opts)
