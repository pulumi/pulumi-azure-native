...
class GetClusterResult:
    ...
    Cluster details.
    """
    def __init__(__self__, aad_application_object_id=None, aad_client_id=None, aad_service_principal_object_id=None, aad_tenant_id=None, billing_model=None, cloud_id=None, cloud_management_endpoint=None, connectivity_status=None, desired_properties=None, id=None, isolated_vm_attestation_configuration=None, last_billing_timestamp=None, last_sync_timestamp=None, location=None, name=None, principal_id=None, provisioning_state=None, registration_timestamp=None, reported_properties=None, resource_provider_object_id=None, service_endpoint=None, software_assurance_properties=None, status=None, system_data=None, tags=None, tenant_id=None, trial_days_remaining=None, type=None, user_assigned_identities=None):
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240101:getCluster', __args__, opts=opts, typ=GetClusterResult).value
...
def get_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20240101:getCluster', __args__, opts=opts, typ=GetClusterResult)
