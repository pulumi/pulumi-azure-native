...
def get_security_setting(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/v20240101:getSecuritySetting', __args__, opts=opts, typ=GetSecuritySettingResult).value
...
def get_security_setting_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['securitySettingsName'] = security_settings_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci/v20240101:getSecuritySetting', __args__, opts=opts, typ=GetSecuritySettingResult)
