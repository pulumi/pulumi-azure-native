...
class EdgeDevice(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20230801preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240215preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:EdgeDevice"), pulumi.Alias(type_="azure-native:azurestackhci:EdgeDevice")])
