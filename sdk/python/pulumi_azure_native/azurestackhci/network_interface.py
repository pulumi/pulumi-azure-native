...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] create_from_local: Boolean indicating whether this is a existing local network interface or if one should be created.
        ...
        :param pulumi.Input[builtins.str] mac_address: MacAddress - The MAC address of the network interface.
