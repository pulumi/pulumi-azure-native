...
class SecuritySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestackhci/v20231101preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240101:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240401:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20240901preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20241201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci/v20250201preview:SecuritySetting"), pulumi.Alias(type_="azure-native:azurestackhci:SecuritySetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SecuritySetting, __self__).__init__(
            'azure-native:azurestackhci/v20240215preview:SecuritySetting',
            resource_name,
            __props__,
            opts)
