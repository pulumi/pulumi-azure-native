...
def get_virtual_network_subnet(resource_group_name: Optional[_builtins.str] = None,
                               subnet_name: Optional[_builtins.str] = None,
                               virtual_network_name: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualNetworkSubnetResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci:getVirtualNetworkSubnet', __args__, opts=opts, typ=GetVirtualNetworkSubnetResult).value
...
def get_virtual_network_subnet_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestackhci:getVirtualNetworkSubnet', __args__, opts=opts, typ=GetVirtualNetworkSubnetResult)
    return __ret__.apply(lambda __response__: GetVirtualNetworkSubnetResult(
