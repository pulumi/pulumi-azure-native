...
def get_customer_event(customer_event_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str customer_event_name: The resource name of the Test Base Customer event.
...
def get_customer_event_output(customer_event_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
