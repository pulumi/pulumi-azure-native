...
def get_custom_image(custom_image_name: Optional[_builtins.str] = None,
...
def get_custom_image_output(custom_image_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
