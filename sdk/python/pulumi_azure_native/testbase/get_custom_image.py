...
class GetCustomImageResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, definition_name=None, id=None, name=None, os_disk_image_size_in_gb=None, product=None, provisioning_state=None, release=None, release_version_date=None, source=None, status=None, system_data=None, type=None, validation_results=None, version_name=None, vhd_file_name=None, vhd_id=None):
    ...
    def definition_name(self) -> builtins.str:
        """
    ...
    def os_disk_image_size_in_gb(self) -> builtins.float:
        """
    ...
    def release_version_date(self) -> builtins.str:
        """
    ...
    def vhd_file_name(self) -> builtins.str:
        """
...
def get_custom_image(custom_image_name: Optional[builtins.str] = None,
    ...
    :param builtins.str custom_image_name: The resource name of the test base custom image.
...
def get_custom_image_output(custom_image_name: Optional[pulumi.Input[builtins.str]] = None,
