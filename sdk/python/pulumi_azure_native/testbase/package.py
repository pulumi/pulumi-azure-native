...
class PackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] blob_path: The file path of the package.
        :param pulumi.Input[_builtins.str] draft_package_id: The id of draft package. Used to create or update this package from a draft package.
