...
class TestBaseAccountArgs:
    def __init__(__self__, *,
        ...
        """
        TestBaseAccountArgs._configure(
    ...
    def _configure(
             ...
             sku: Optional[pulumi.Input['TestBaseAccountSKUArgs']] = None,
             location: Optional[pulumi.Input[str]] = None,
             restore: Optional[pulumi.Input[bool]] = None,
             tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
             test_base_account_name: Optional[pulumi.Input[str]] = None,
...
class TestBaseAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TestBaseAccountArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            sku = _utilities.configure(sku, TestBaseAccountSKUArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:testbase:TestBaseAccount"), pulumi.Alias(type_="azure-native:testbase/v20201216preview:TestBaseAccount")])
