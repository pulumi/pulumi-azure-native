...
def get_test_result_download_url_output(package_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testResultName'] = test_result_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20220401preview:getTestResultDownloadURL', __args__, opts=opts, typ=GetTestResultDownloadURLResult)
