...
def get_customer_event(customer_event_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20220401preview:getCustomerEvent', __args__, opts=opts, typ=GetCustomerEventResult).value
...
def get_customer_event_output(customer_event_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testBaseAccountName'] = test_base_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20220401preview:getCustomerEvent', __args__, opts=opts, typ=GetCustomerEventResult)
