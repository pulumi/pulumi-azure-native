...
class FavoriteProcess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:testbase:FavoriteProcess"), pulumi.Alias(type_="azure-native:testbase/v20201216preview:FavoriteProcess"), pulumi.Alias(type_="azure-native:testbase/v20231101preview:FavoriteProcess")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FavoriteProcess, __self__).__init__(
            'azure-native:testbase/v20220401preview:FavoriteProcess',
            resource_name,
            __props__,
            opts)
