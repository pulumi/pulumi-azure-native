...
class ImageDefinitionArgs:
    ...
    def security_type(self) -> pulumi.Input[Union[_builtins.str, 'ImageSecurityType']]:
        """
    ...
    def security_type(self, value: pulumi.Input[Union[_builtins.str, 'ImageSecurityType']]):
