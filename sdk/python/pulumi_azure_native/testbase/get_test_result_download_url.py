...
def get_test_result_download_url(package_name: Optional[builtins.str] = None,
                                 resource_group_name: Optional[builtins.str] = None,
                                 test_base_account_name: Optional[builtins.str] = None,
                                 test_result_name: Optional[builtins.str] = None,
    ...
    :param builtins.str test_result_name: The Test Result Name. It equals to TestResult-{TestResultId} string.
    """
    __args__ = dict()
...
def get_test_result_download_url_output(package_name: Optional[pulumi.Input[builtins.str]] = None,
                                        resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                        test_base_account_name: Optional[pulumi.Input[builtins.str]] = None,
                                        test_result_name: Optional[pulumi.Input[builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTestResultDownloadURLResult]:
    """
    Gets the download URL of the test result.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase:getTestResultDownloadURL', __args__, opts=opts, typ=GetTestResultDownloadURLResult)
    return __ret__.apply(lambda __response__: GetTestResultDownloadURLResult(
