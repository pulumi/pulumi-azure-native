...
class CustomerEventArgs:
    def __init__(__self__, *,
                 ...
                 customer_event_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CustomerEvent resource.
        :param pulumi.Input[builtins.str] event_name: The name of the event subscribed to.
        ...
        :param pulumi.Input[builtins.str] customer_event_name: The resource name of the Test Base Customer event.
        """
    ...
    def customer_event_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def customer_event_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomerEvent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:testbase/v20201216preview:CustomerEvent"), pulumi.Alias(type_="azure-native:testbase/v20220401preview:CustomerEvent"), pulumi.Alias(type_="azure-native:testbase/v20231101preview:CustomerEvent")])
    ...
    @property
    @pulumi.getter(name="eventName")
    def event_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the event subscribed to.
        """
        return pulumi.get(self, "event_name")
