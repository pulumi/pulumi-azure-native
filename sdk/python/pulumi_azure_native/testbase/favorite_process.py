...
class FavoriteProcessArgs:
    def __init__(__self__, *,
                 actual_process_name: pulumi.Input[builtins.str],
                 package_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 test_base_account_name: pulumi.Input[builtins.str],
                 favorite_process_resource_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FavoriteProcess resource.
        :param pulumi.Input[builtins.str] actual_process_name: The actual name of the favorite process. It will be equal to resource name except for the scenario that the process name contains characters that are not allowed in the resource name.
        ...
        :param pulumi.Input[builtins.str] favorite_process_resource_name: The resource name of a favorite process in a package. If the process name contains characters that are not allowed in Azure Resource Name, we use 'actualProcessName' in request body to submit the name.
        """
    ...
    def actual_process_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def actual_process_name(self, value: pulumi.Input[builtins.str]):
    ...
    def favorite_process_resource_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def favorite_process_resource_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FavoriteProcess(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 actual_process_name: Optional[pulumi.Input[builtins.str]] = None,
                 favorite_process_resource_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="actualProcessName")
    def actual_process_name(self) -> pulumi.Output[builtins.str]:
        """
        The actual name of the favorite process. It will be equal to resource name except for the scenario that the process name contains characters that are not allowed in the resource name.
        """
        return pulumi.get(self, "actual_process_name")
