...
def get_credential(credential_name: Optional[_builtins.str] = None,
...
def get_credential_output(credential_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
