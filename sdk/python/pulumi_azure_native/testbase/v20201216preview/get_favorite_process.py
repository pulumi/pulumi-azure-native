...
def get_favorite_process(favorite_process_resource_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_favorite_process is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.""")
    __args__ = dict()
