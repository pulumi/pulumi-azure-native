...
warnings.warn("""Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.""", DeprecationWarning)
...
def get_customer_event(customer_event_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_customer_event is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.""")
    __args__ = dict()
