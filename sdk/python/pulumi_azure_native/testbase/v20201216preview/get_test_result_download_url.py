...
def get_test_result_download_url(package_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20201216preview:getTestResultDownloadURL', __args__, opts=opts, typ=GetTestResultDownloadURLResult).value
