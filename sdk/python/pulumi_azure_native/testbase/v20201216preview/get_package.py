...
def get_package(package_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_package is deprecated: Version v20201216preview will be removed in the next major version of the provider. Upgrade to version v20220401preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20201216preview:getPackage', __args__, opts=opts, typ=GetPackageResult).value
