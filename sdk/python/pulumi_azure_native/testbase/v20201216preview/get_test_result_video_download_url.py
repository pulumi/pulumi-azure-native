...
def get_test_result_video_download_url(package_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20201216preview:getTestResultVideoDownloadURL', __args__, opts=opts, typ=GetTestResultVideoDownloadURLResult).value
