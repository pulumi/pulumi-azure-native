...
class GetPackageResult:
    ...
    """
    def __init__(__self__, application_name=None, azure_api_version=None, blob_path=None, draft_package_id=None, first_party_apps=None, flighting_ring=None, gallery_apps=None, id=None, inplace_upgrade_os_pair=None, intune_enrollment_metadata=None, is_enabled=None, last_modified_time=None, location=None, name=None, package_status=None, provisioning_state=None, system_data=None, tags=None, target_os_list=None, test_types=None, tests=None, type=None, validation_results=None, version=None):
    ...
    def blob_path(self) -> Optional[builtins.str]:
        """
    ...
    def draft_package_id(self) -> Optional[builtins.str]:
        """
    ...
    def package_status(self) -> builtins.str:
        """
    ...
    def test_types(self) -> Sequence[builtins.str]:
        """
...
def get_package(package_name: Optional[builtins.str] = None,
...
def get_package_output(package_name: Optional[pulumi.Input[builtins.str]] = None,
