...
def get_draft_package_path(draft_package_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase:getDraftPackagePath', __args__, opts=opts, typ=GetDraftPackagePathResult).value
...
def get_draft_package_path_output(draft_package_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase:getDraftPackagePath', __args__, opts=opts, typ=GetDraftPackagePathResult)
