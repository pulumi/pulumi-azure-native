...
def get_test_result_console_log_download_url(log_file_name: Optional[builtins.str] = None,
    ...
    :param builtins.str log_file_name: The log file name corresponding to the download URL.
...
def get_test_result_console_log_download_url_output(log_file_name: Optional[pulumi.Input[builtins.str]] = None,
