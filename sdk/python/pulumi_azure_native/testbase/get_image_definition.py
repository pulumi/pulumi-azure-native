...
def get_image_definition(image_definition_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str image_definition_name: The resource name of the test base image definition.
...
def get_image_definition_output(image_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
