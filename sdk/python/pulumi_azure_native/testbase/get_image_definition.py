...
def get_image_definition(image_definition_name: Optional[builtins.str] = None,
    ...
    :param builtins.str image_definition_name: The resource name of the test base image definition.
...
def get_image_definition_output(image_definition_name: Optional[pulumi.Input[builtins.str]] = None,
