...
def get_draft_package(draft_package_name: Optional[_builtins.str] = None,
...
def get_draft_package_output(draft_package_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
