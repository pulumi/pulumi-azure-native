...
def get_image_definition(image_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20231101preview:getImageDefinition', __args__, opts=opts, typ=GetImageDefinitionResult).value
...
def get_image_definition_output(image_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testBaseAccountName'] = test_base_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20231101preview:getImageDefinition', __args__, opts=opts, typ=GetImageDefinitionResult)
