...
def get_credential(credential_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20231101preview:getCredential', __args__, opts=opts, typ=GetCredentialResult).value
...
def get_credential_output(credential_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testBaseAccountName'] = test_base_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20231101preview:getCredential', __args__, opts=opts, typ=GetCredentialResult)
