...
class CustomerEvent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:testbase/v20201216preview:CustomerEvent"), pulumi.Alias(type_="azure-native:testbase/v20220401preview:CustomerEvent"), pulumi.Alias(type_="azure-native:testbase:CustomerEvent")])
