...
def get_billing_hub_service_usage(end_time_stamp: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20231101preview:getBillingHubServiceUsage', __args__, opts=opts, typ=GetBillingHubServiceUsageResult).value
