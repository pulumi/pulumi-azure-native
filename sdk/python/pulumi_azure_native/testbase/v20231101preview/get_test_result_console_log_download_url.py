...
def get_test_result_console_log_download_url(log_file_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20231101preview:getTestResultConsoleLogDownloadURL', __args__, opts=opts, typ=GetTestResultConsoleLogDownloadURLResult).value
...
def get_test_result_console_log_download_url_output(log_file_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testResultName'] = test_result_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20231101preview:getTestResultConsoleLogDownloadURL', __args__, opts=opts, typ=GetTestResultConsoleLogDownloadURLResult)
