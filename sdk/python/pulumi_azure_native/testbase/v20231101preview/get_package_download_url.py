...
def get_package_download_url(package_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:testbase/v20231101preview:getPackageDownloadURL', __args__, opts=opts, typ=GetPackageDownloadURLResult).value
...
def get_package_download_url_output(package_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['testBaseAccountName'] = test_base_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:testbase/v20231101preview:getPackageDownloadURL', __args__, opts=opts, typ=GetPackageDownloadURLResult)
