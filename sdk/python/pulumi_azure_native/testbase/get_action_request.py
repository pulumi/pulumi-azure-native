...
def get_action_request(action_request_name: Optional[builtins.str] = None,
...
def get_action_request_output(action_request_name: Optional[pulumi.Input[builtins.str]] = None,
