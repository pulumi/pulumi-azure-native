...
def get_action_request(action_request_name: Optional[_builtins.str] = None,
...
def get_action_request_output(action_request_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
