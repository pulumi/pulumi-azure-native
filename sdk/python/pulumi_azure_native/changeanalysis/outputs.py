...
class AzureMonitorWorkspacePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 include_change_details: Optional[builtins.str] = None,
                 workspace_id: Optional[builtins.str] = None,
                 workspace_resource_id: Optional[builtins.str] = None):
        """
        Configuration properties of an Azure Monitor workspace that receives change notifications.
        :param builtins.str include_change_details: The mode of includeChangeDetails feature. The flag configures whether to include or exclude content of the change before and after values.
        :param builtins.str workspace_id: The Azure Monitor workspace ID - the unique identifier for the Log Analytics workspace.
        :param builtins.str workspace_resource_id: The Azure Monitor workspace ARM Resource ID. The resource ID should be in the following format: /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}
        """
    ...
    def include_change_details(self) -> Optional[builtins.str]:
        """
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 activation_state: Optional[builtins.str] = None,
                 azure_monitor_workspace_properties: Optional['outputs.AzureMonitorWorkspacePropertiesResponse'] = None):
        """
        Settings of change notification configuration for a subscription.
        :param builtins.str activation_state: The state of notifications feature.
...
class SystemDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str created_by_type: The type of identity that created the resource: user, application, managedIdentity, key
        :param builtins.str last_modified_at: The timestamp of resource last modification (UTC)
        :param builtins.str last_modified_by: A string identifier for the identity that last modified the resource
        :param builtins.str last_modified_by_type: The type of identity that last modified the resource: user, application, managedIdentity, key
        """
