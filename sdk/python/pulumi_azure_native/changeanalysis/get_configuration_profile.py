...
def get_configuration_profile(profile_name: Optional[builtins.str] = None,
    ...
    :param builtins.str profile_name: The name of the configuration profile. The profile name should be set to 'default', all other names will be overwritten.
    """
    __args__ = dict()
...
def get_configuration_profile_output(profile_name: Optional[pulumi.Input[builtins.str]] = None,
