...
def get_configuration_profile(profile_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str profile_name: The name of the configuration profile. The profile name should be set to 'default', all other names will be overwritten.
    """
    __args__ = dict()
...
def get_configuration_profile_output(profile_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:changeanalysis:getConfigurationProfile', __args__, opts=opts, typ=GetConfigurationProfileResult)
