...
class ConfigurationProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The location where the resource is to be deployed.
        :param pulumi.Input[builtins.str] profile_name: The name of the configuration profile. The profile name should be set to 'default', all other names will be overwritten.
