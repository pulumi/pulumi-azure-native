...
class ConfigurationProfileResourcePropertiesArgsDict(TypedDict):
    ...
    """
    notifications: NotRequired[pulumi.Input[Optional['NotificationSettingsArgs']]]
    """
...
class NotificationSettingsArgsDict(TypedDict):
    ...
    """
    azure_monitor_workspace_properties: NotRequired[pulumi.Input[Optional['AzureMonitorWorkspacePropertiesArgs']]]
    """
    Configuration properties of an Azure Monitor workspace that receives change notifications.
    """
