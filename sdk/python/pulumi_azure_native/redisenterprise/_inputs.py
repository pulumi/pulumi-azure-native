...
class PersistenceArgs:
    def __init__(__self__, *,
        ...
        """
        Persistence-related configuration for the RedisEnterprise database
        :param pulumi.Input[_builtins.bool] aof_enabled: Sets whether AOF is enabled.
        :param pulumi.Input[Union[_builtins.str, 'AofFrequency']] aof_frequency: Sets the frequency at which data is written to disk.
        :param pulumi.Input[_builtins.bool] rdb_enabled: Sets whether RDB is enabled.
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        """
        SKU parameters supplied to the create RedisEnterprise operation.
        :param pulumi.Input[Union[_builtins.str, 'SkuName']] name: The type of RedisEnterprise cluster to deploy. Possible values: (Enterprise_E10, EnterpriseFlash_F300 etc.)
        :param pulumi.Input[_builtins.int] capacity: The size of the RedisEnterprise cluster. Defaults to 2 or 3 depending on SKU. Valid values are (2, 4, 6, ...) for Enterprise SKUs and (3, 9, 15, ...) for Flash SKUs.
        """
        pulumi.set(__self__, "name", name)
