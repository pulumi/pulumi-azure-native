...
__all__ = ['EnterpriseAccessPolicyAssignmentArgs', 'EnterpriseAccessPolicyAssignment']

@pulumi.input_type
class EnterpriseAccessPolicyAssignmentArgs:
...
class EnterpriseAccessPolicyAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: EnterpriseAccessPolicyAssignmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Describes the access policy assignment of Redis Enterprise database

        :param str resource_name: The name of the resource.
        :param EnterpriseAccessPolicyAssignmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EnterpriseAccessPolicyAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EnterpriseAccessPolicyAssignmentArgs.__new__(EnterpriseAccessPolicyAssignmentArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20240901preview:AccessPolicyAssignment"), pulumi.Alias(type_="azure-native:redisenterprise:EnterpriseAccessPolicyAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseAccessPolicyAssignment, __self__).__init__(
            'azure-native:redisenterprise/v20240901preview:EnterpriseAccessPolicyAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EnterpriseAccessPolicyAssignment':
        """
        ...
        return EnterpriseAccessPolicyAssignment(resource_name, opts=opts, __props__=__props__)
