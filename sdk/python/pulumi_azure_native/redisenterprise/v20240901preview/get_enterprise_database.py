...
def get_enterprise_database(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redisenterprise/v20240901preview:getEnterpriseDatabase', __args__, opts=opts, typ=GetEnterpriseDatabaseResult).value
...
def get_enterprise_database_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redisenterprise/v20240901preview:getEnterpriseDatabase', __args__, opts=opts, typ=GetEnterpriseDatabaseResult)
