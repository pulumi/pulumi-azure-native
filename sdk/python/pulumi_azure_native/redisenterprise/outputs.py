...
class PersistenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Persistence-related configuration for the RedisEnterprise database
        :param _builtins.bool aof_enabled: Sets whether AOF is enabled.
        :param _builtins.str aof_frequency: Sets the frequency at which data is written to disk.
        :param _builtins.bool rdb_enabled: Sets whether RDB is enabled.
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SKU parameters supplied to the create RedisEnterprise operation.
        :param _builtins.str name: The type of RedisEnterprise cluster to deploy. Possible values: (Enterprise_E10, EnterpriseFlash_F300 etc.)
        :param _builtins.int capacity: The size of the RedisEnterprise cluster. Defaults to 2 or 3 depending on SKU. Valid values are (2, 4, 6, ...) for Enterprise SKUs and (3, 9, 15, ...) for Flash SKUs.
        """
        pulumi.set(__self__, "name", name)
