...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_name: The name of the Redis Enterprise cluster.
