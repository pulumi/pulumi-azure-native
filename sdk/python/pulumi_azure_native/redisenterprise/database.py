...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 defer_upgrade: Optional[pulumi.Input[Union[builtins.str, 'DeferUpgradeSetting']]] = None,
        ...
        :param pulumi.Input[builtins.int] port: TCP port of the database endpoint. Specified at create time. Defaults to an available port.
        """
    ...
    def client_protocol(self, value: Optional[pulumi.Input[Union[builtins.str, 'Protocol']]]):
    ...
    def clustering_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'ClusteringPolicy']]]):
    ...
    def defer_upgrade(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeferUpgradeSetting']]]):
...
class Database(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="clientProtocol")
    def client_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Default is TLS-encrypted.
        """
        return pulumi.get(self, "client_protocol")
