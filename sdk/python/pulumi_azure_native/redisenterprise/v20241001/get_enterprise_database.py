...
def get_enterprise_database(cluster_name: Optional[str] = None,
    ...
    :param str cluster_name: The name of the Redis Enterprise cluster. Name must be 1-60 characters long. Allowed characters(A-Z, a-z, 0-9) and hyphen(-). There can be no leading nor trailing nor consecutive hyphens
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redisenterprise/v20241001:getEnterpriseDatabase', __args__, opts=opts, typ=GetEnterpriseDatabaseResult).value
...
def get_enterprise_database_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redisenterprise/v20241001:getEnterpriseDatabase', __args__, opts=opts, typ=GetEnterpriseDatabaseResult)
