...
class EnterprisePrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_name: The name of the Redis Enterprise cluster. Name must be 1-60 characters long. Allowed characters(A-Z, a-z, 0-9) and hyphen(-). There can be no leading nor trailing nor consecutive hyphens
...
class EnterprisePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20230301preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20230701:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20230801preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20231001preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20231101:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20240201:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20240301preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20240601preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20240901preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20241001:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20201001preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20210201preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20210301:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20210801:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20220101:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20221101preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20230301preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20230701:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20230801preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20231001preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20231101:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20240201:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20240301preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20240601preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise/v20240901preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:redisenterprise:EnterprisePrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterprisePrivateEndpointConnection, __self__).__init__(
            'azure-native:redisenterprise/v20241001:EnterprisePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
