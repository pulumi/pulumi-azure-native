...
def get_enterprise_private_endpoint_connection(cluster_name: Optional[str] = None,
    ...
    Other available API versions: 2023-10-01-preview, 2024-10-01.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redisenterprise:getEnterprisePrivateEndpointConnection', __args__, opts=opts, typ=GetEnterprisePrivateEndpointConnectionResult).value
...
def get_enterprise_private_endpoint_connection_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:redisenterprise:getEnterprisePrivateEndpointConnection', __args__, opts=opts, typ=GetEnterprisePrivateEndpointConnectionResult)
