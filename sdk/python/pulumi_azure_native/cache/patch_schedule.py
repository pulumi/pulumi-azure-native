...
class PatchScheduleArgs:
    ...
    def _configure(
             ...
             schedule_entries: Optional[pulumi.Input[Sequence[pulumi.Input['ScheduleEntryArgs']]]] = None,
             default: Optional[pulumi.Input[str]] = None,
        ...
        if schedule_entries is None and 'scheduleEntries' in kwargs:
            schedule_entries = kwargs['scheduleEntries']
        if schedule_entries is None:
            raise TypeError("Missing 'schedule_entries' argument")

        _setter("name", name)
        _setter("resource_group_name", resource_group_name)
        _setter("schedule_entries", schedule_entries)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PatchScheduleArgs._configure(_setter, **kwargs)
