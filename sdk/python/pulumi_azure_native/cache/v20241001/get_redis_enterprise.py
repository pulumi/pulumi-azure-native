...
def get_redis_enterprise(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20241001:getRedisEnterprise', __args__, opts=opts, typ=GetRedisEnterpriseResult).value
...
def get_redis_enterprise_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20241001:getRedisEnterprise', __args__, opts=opts, typ=GetRedisEnterpriseResult)
