...
def get_redis_enterprise(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20250401:getRedisEnterprise', __args__, opts=opts, typ=GetRedisEnterpriseResult).value
...
def get_redis_enterprise_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20250401:getRedisEnterprise', __args__, opts=opts, typ=GetRedisEnterpriseResult)
