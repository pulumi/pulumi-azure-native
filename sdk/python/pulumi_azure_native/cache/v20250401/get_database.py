...
def get_database(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20250401:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20250401:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
