...
warnings.warn("""azure-native:cache/v20220101:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_redis_enterprise(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis_enterprise is deprecated: azure-native:cache/v20220101:RedisEnterprise is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.""")
    __args__ = dict()
