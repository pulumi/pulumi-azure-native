...
class Database(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        database = azure_native.cache.v20230301preview.Database("database",
            ...
            persistence=azure_native.cache.v20230301preview.PersistenceArgs(
                aof_enabled=True,
                aof_frequency="1s",
            ),
            port=10000,
        ...
        database = azure_native.cache.v20230301preview.Database("database",
            ...
            geo_replication=azure_native.cache.v20230301preview.DatabasePropertiesResponseGeoReplicationArgs(
                group_nickname="groupName",
                linked_databases=[
                    azure_native.cache.v20230301preview.LinkedDatabaseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:Database"), pulumi.Alias(type_="azure-native:cache/v20201001preview:Database"), pulumi.Alias(type_="azure-native:cache/v20210201preview:Database"), pulumi.Alias(type_="azure-native:cache/v20210301:Database"), pulumi.Alias(type_="azure-native:cache/v20210801:Database"), pulumi.Alias(type_="azure-native:cache/v20220101:Database"), pulumi.Alias(type_="azure-native:cache/v20221101preview:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azure-native:cache/v20230301preview:Database',
            resource_name,
            __props__,
            opts)
