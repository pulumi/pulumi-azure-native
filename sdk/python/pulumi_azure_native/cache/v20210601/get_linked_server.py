...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_server is deprecated: azure-native:cache/v20210601:LinkedServer is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20220601:LinkedServer to guarantee forwards compatibility.""")
    __args__ = dict()
