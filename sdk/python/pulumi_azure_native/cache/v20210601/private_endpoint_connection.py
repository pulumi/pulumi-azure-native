...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20200601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20201201:PrivateEndpointConnection")])
