...
warnings.warn("""azure-native:cache/v20210601:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:Redis to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_redis(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis is deprecated: azure-native:cache/v20210601:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:Redis to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20210601:getRedis', __args__, opts=opts, typ=GetRedisResult).value
