...
class LinkedServerArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['RedisLinkedServerCreatePropertiesArgs'],
        ...
        :param pulumi.Input['RedisLinkedServerCreatePropertiesArgs'] properties: Properties required to create a linked server.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['RedisLinkedServerCreatePropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['RedisLinkedServerCreatePropertiesArgs']):
...
class LinkedServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['RedisLinkedServerCreatePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] linked_server_name: The name of the linked server that is being added to the Redis cache.
        :param pulumi.Input[str] name: The name of the Redis cache.
        :param pulumi.Input[pulumi.InputType['RedisLinkedServerCreatePropertiesArgs']] properties: Properties required to create a linked server.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20170201:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20171001:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20180301:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20190701:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20200601:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20201201:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20220501:LinkedServer"), pulumi.Alias(type_="azure-native:cache/v20220601:LinkedServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkedServer, __self__).__init__(
            'azure-native:cache/v20210601:LinkedServer',
            resource_name,
            __props__,
            opts)
