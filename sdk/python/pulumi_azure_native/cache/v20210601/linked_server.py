...
warnings.warn("""azure-native:cache/v20210601:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.""", DeprecationWarning)
...
class LinkedServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 server_role: Optional[pulumi.Input['ReplicationRole']] = None,
                 __props__=None):
        pulumi.log.warn("""LinkedServer is deprecated: azure-native:cache/v20210601:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.""")
