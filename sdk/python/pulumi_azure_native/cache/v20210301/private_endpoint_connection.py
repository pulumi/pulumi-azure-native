...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.cache.v20210301.PrivateEndpointConnection("privateEndpointConnection",
            cluster_name="cache1",
            private_endpoint_connection_name="pectest01",
            private_link_service_connection_state=azure_native.cache.v20210301.PrivateLinkServiceConnectionStateArgs(
