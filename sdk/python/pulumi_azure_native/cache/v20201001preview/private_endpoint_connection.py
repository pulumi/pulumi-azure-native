...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: Version 2020-10-01-preview will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20210201preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20210301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20210801:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20220101:PrivateEndpointConnection")])
