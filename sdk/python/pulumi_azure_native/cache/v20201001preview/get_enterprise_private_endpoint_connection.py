...
def get_enterprise_private_endpoint_connection(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20201001preview:getEnterprisePrivateEndpointConnection', __args__, opts=opts, typ=GetEnterprisePrivateEndpointConnectionResult).value
...
def get_enterprise_private_endpoint_connection_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20201001preview:getEnterprisePrivateEndpointConnection', __args__, opts=opts, typ=GetEnterprisePrivateEndpointConnectionResult)
    return __ret__.apply(lambda __response__: GetEnterprisePrivateEndpointConnectionResult(
