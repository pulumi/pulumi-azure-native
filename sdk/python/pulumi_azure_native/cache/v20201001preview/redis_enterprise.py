...
class RedisEnterprise(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        redis_enterprise = azure_native.cache.v20201001preview.RedisEnterprise("redisEnterprise",
            cluster_name="cache1",
            location="West US",
            minimum_tls_version="1.2",
            resource_group_name="rg1",
            sku=azure_native.cache.v20201001preview.EnterpriseSkuArgs(
                capacity=3,
