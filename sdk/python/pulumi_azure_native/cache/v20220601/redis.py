...
class Redis(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        redis = azure_native.cache.v20220601.Redis("redis",
            enable_non_ssl_port=True,
            location="West US",
            minimum_tls_version="1.2",
            name="cache1",
            redis_configuration=azure_native.cache.v20220601.RedisCommonPropertiesRedisConfigurationArgs(
            ...
            shard_count=2,
            sku=azure_native.cache.v20220601.SkuArgs(
                capacity=1,
                family="P",
                name="Premium",
            ),
