...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RedisFirewallRulePropertiesArgs'] properties: redis cache firewall rule properties
...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] cache_name: The name of the Redis cache.
        :param pulumi.Input[pulumi.InputType['RedisFirewallRulePropertiesArgs']] properties: redis cache firewall rule properties
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[str] rule_name: The name of the firewall rule.
        """
        ...
