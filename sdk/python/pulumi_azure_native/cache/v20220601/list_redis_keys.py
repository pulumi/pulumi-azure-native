...
def list_redis_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20220601:listRedisKeys', __args__, opts=opts, typ=ListRedisKeysResult).value
...
def list_redis_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20220601:listRedisKeys', __args__, opts=opts, typ=ListRedisKeysResult)
