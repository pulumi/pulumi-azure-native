...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20240301:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult).value
...
def get_linked_server_output(linked_server_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20240301:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult)
