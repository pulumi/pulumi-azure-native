...
def list_redis_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20240301:listRedisKeys', __args__, opts=opts, typ=ListRedisKeysResult).value
...
def list_redis_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20240301:listRedisKeys', __args__, opts=opts, typ=ListRedisKeysResult)
