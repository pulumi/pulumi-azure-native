...
def get_access_policy_assignment(access_policy_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20240301:getAccessPolicyAssignment', __args__, opts=opts, typ=GetAccessPolicyAssignmentResult).value
...
def get_access_policy_assignment_output(access_policy_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20240301:getAccessPolicyAssignment', __args__, opts=opts, typ=GetAccessPolicyAssignmentResult)
