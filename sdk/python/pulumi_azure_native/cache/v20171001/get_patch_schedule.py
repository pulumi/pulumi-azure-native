...
def get_patch_schedule(default: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_patch_schedule is deprecated: Version v20171001 will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20171001:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult).value
