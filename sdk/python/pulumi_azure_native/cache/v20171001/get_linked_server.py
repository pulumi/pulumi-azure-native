...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_server is deprecated: Version 2017-10-01 will be removed in v2 of the provider.
azure-native:cache/v20171001:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20171001:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult).value
