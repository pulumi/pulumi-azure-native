...
class EnterpriseDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20201001preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210201preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210301:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210801:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20220101:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20221101preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20230301preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20230801preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20231001preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20231101:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240201:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240301preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240601preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240901preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20241001:EnterpriseDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseDatabase, __self__).__init__(
            'azure-native:cache/v20230701:EnterpriseDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'EnterpriseDatabase':
        """
