...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:listDatabaseKeys'.""", DeprecationWarning)
...
def list_database_keys(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_database_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:listDatabaseKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:listDatabaseKeys', __args__, opts=opts, typ=ListDatabaseKeysResult).value
