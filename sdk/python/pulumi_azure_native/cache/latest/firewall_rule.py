...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cache:FirewallRule'.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""FirewallRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cache:FirewallRule'.""")
        ...
        super(FirewallRule, __self__).__init__(
            'azure-native:cache/latest:FirewallRule',
            resource_name,
            __props__,
            opts)
