...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getRedisEnterprise'.""", DeprecationWarning)
...
def get_redis_enterprise(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis_enterprise is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getRedisEnterprise'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:getRedisEnterprise', __args__, opts=opts, typ=GetRedisEnterpriseResult).value
