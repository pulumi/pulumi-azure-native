...
class RedisPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "replicasPerPrimary":
            suggest = "replicas_per_primary"
        elif key == "shardCount":
            suggest = "shard_count"
        elif key == "staticIP":
            suggest = "static_ip"
    ...
    def __init__(__self__, *,
        ...
        :param str redis_version: Redis version. This should be in the form 'major[.minor[.build]]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Only the major and minor version are used in a PUT/PATCH request. Supported versions: 4.0, 6.0.
        :param int replicas_per_master: The number of replicas to be created per primary.
        :param int replicas_per_primary: The number of replicas to be created per primary.
