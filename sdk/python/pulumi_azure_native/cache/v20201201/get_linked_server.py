...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linked_server is deprecated: azure-native:cache/v20201201:LinkedServer is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:LinkedServer to guarantee forwards compatibility.""")
    __args__ = dict()
