...
def get_patch_schedule(default: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_patch_schedule is deprecated: Version v20190701 will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
