...
azure-native:cache/v20180301:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20190701:Redis to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetRedisResult:
    ...
    """
    def __init__(__self__, access_keys=None, enable_non_ssl_port=None, host_name=None, id=None, linked_servers=None, location=None, minimum_tls_version=None, name=None, port=None, provisioning_state=None, redis_configuration=None, redis_version=None, shard_count=None, sku=None, ssl_port=None, static_ip=None, subnet_id=None, tags=None, tenant_settings=None, type=None, zones=None):
...
def get_redis(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis is deprecated: Version 2018-03-01 will be removed in v2 of the provider.
azure-native:cache/v20180301:Redis is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20190701:Redis to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20180301:getRedis', __args__, opts=opts, typ=GetRedisResult).value
