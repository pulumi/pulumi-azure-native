...
class GetRedisResult:
    ...
    """
    def __init__(__self__, id=None, location=None, name=None, properties=None, tags=None, type=None, zones=None):
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.RedisPropertiesResponse':
        """
