...
def get_database(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: azure-native:cache/v20210801:Database is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.""")
    __args__ = dict()
