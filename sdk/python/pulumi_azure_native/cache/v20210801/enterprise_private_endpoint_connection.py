...
class EnterprisePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20201001preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20210201preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20210301:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20220101:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20221101preview:EnterprisePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20230301preview:EnterprisePrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterprisePrivateEndpointConnection, __self__).__init__(
            'azure-native:cache/v20210801:EnterprisePrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
