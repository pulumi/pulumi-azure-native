...
class RedisEnterpriseArgs:
    def __init__(__self__, *,
        ...
        """
        RedisEnterpriseArgs._configure(
...
class RedisEnterprise(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RedisEnterpriseArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption is not None and not isinstance(encryption, ClusterPropertiesEncryptionArgs):
                encryption = encryption or {}
                def _setter(key, value):
                    encryption[key] = value
                ClusterPropertiesEncryptionArgs._configure(_setter, **encryption)
            ...
            if sku is not None and not isinstance(sku, EnterpriseSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                EnterpriseSkuArgs._configure(_setter, **sku)
