...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if geo_replication is not None and not isinstance(geo_replication, DatabasePropertiesGeoReplicationArgs):
            ...
            if persistence is not None and not isinstance(persistence, PersistenceArgs):
