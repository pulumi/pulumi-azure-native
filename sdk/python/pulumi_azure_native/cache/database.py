...
class DatabaseArgs:
    ...
    def _configure(
        ...
        if geo_replication is None and 'geoReplication' in kwargs:
            geo_replication = kwargs['geoReplication']
...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            geo_replication = _utilities.configure(geo_replication, DatabasePropertiesGeoReplicationArgs, True)
            __props__.__dict__["geo_replication"] = geo_replication
            __props__.__dict__["modules"] = modules
            persistence = _utilities.configure(persistence, PersistenceArgs, True)
