...
def get_enterprise_access_policy_assignment(access_policy_assignment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache:getEnterpriseAccessPolicyAssignment', __args__, opts=opts, typ=GetEnterpriseAccessPolicyAssignmentResult).value
...
def get_enterprise_access_policy_assignment_output(access_policy_assignment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache:getEnterpriseAccessPolicyAssignment', __args__, opts=opts, typ=GetEnterpriseAccessPolicyAssignmentResult)
