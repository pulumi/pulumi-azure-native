...
warnings.warn("""azure-native:cache/v20200601:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:PrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: azure-native:cache/v20200601:PrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:PrivateEndpointConnection to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20210601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20220501:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cache/v20220601:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:cache/v20200601:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
