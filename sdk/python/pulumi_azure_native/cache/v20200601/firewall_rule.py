...
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        firewall_rule = azure_native.cache.v20200601.FirewallRule("firewallRule",
            cache_name="cache1",
            end_ip="192.168.1.4",
