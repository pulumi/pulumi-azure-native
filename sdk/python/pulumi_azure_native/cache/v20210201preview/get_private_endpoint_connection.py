...
def get_private_endpoint_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection is deprecated: azure-native:cache/v20210201preview:PrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20220601:PrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
