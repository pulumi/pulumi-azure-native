...
warnings.warn("""azure-native:cache/v20210201preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_database(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: azure-native:cache/v20210201preview:Database is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230301preview:Database to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['clusterName'] = cluster_name
    __args__['databaseName'] = database_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20210201preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
