...
class RedisLinkedServer(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache:RedisLinkedServer"), pulumi.Alias(type_="azure-native:cache/latest:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache/latest:RedisLinkedServer"), pulumi.Alias(type_="azure-native:cache/v20171001:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache/v20171001:RedisLinkedServer"), pulumi.Alias(type_="azure-native:cache/v20180301:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache/v20180301:RedisLinkedServer"), pulumi.Alias(type_="azure-native:cache/v20190701:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache/v20190701:RedisLinkedServer"), pulumi.Alias(type_="azure-native:cache/v20200601:RedisLinkedServer"), pulumi.Alias(type_="azure-nextgen:cache/v20200601:RedisLinkedServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RedisLinkedServer, __self__).__init__(
            'azure-native:cache/v20170201:RedisLinkedServer',
            resource_name,
            __props__,
            opts)
