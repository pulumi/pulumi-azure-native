...
def get_redis_linked_server(linked_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20170201:getRedisLinkedServer', __args__, opts=opts, typ=GetRedisLinkedServerResult).value
...
@_utilities.lift_output_func(get_redis_linked_server)
def get_redis_linked_server_output(linked_server_name: Optional[pulumi.Input[str]] = None,
                                   name: Optional[pulumi.Input[str]] = None,
                                   resource_group_name: Optional[pulumi.Input[str]] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetRedisLinkedServerResult]:
    """
    Response to put/get linked server (with properties) for Redis cache.
