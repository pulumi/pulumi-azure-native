...
warnings.warn("""Version 2017-02-01 will be removed in v2 of the provider.
azure-native:cache/v20170201:PatchSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:PatchSchedule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_patch_schedule(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_patch_schedule is deprecated: Version 2017-02-01 will be removed in v2 of the provider.
azure-native:cache/v20170201:PatchSchedule is being removed in the next major version of this provider. Upgrade to at least azure-native:cache/v20230501preview:PatchSchedule to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20170201:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult).value
