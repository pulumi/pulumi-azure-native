...
def get_patch_schedule(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_patch_schedule is deprecated: Version v20170201 will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
    __args__['name'] = name
