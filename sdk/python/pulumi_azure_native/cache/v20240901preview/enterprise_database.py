...
class EnterpriseDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20201001preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210201preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210301:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20210801:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20220101:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20221101preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20230301preview:Database"), pulumi.Alias(type_="azure-native:cache/v20230301preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20230701:Database"), pulumi.Alias(type_="azure-native:cache/v20230701:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20230801preview:Database"), pulumi.Alias(type_="azure-native:cache/v20230801preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20231001preview:Database"), pulumi.Alias(type_="azure-native:cache/v20231001preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20231101:Database"), pulumi.Alias(type_="azure-native:cache/v20231101:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240201:Database"), pulumi.Alias(type_="azure-native:cache/v20240201:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240301preview:Database"), pulumi.Alias(type_="azure-native:cache/v20240301preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240601preview:Database"), pulumi.Alias(type_="azure-native:cache/v20240601preview:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache/v20240901preview:Database"), pulumi.Alias(type_="azure-native:cache/v20241001:Database"), pulumi.Alias(type_="azure-native:cache/v20241001:EnterpriseDatabase"), pulumi.Alias(type_="azure-native:cache:Database"), pulumi.Alias(type_="azure-native:cache:EnterpriseDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnterpriseDatabase, __self__).__init__(
            'azure-native:cache/v20240901preview:EnterpriseDatabase',
            resource_name,
            __props__,
            opts)
