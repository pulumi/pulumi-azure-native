...
class GetDatabaseResult:
    ...
    """
    def __init__(__self__, access_keys_authentication=None, client_protocol=None, clustering_policy=None, defer_upgrade=None, eviction_policy=None, geo_replication=None, id=None, modules=None, name=None, persistence=None, port=None, provisioning_state=None, redis_version=None, resource_state=None, system_data=None, type=None):
    ...
    def access_keys_authentication(self) -> Optional[str]:
        """
...
def get_database(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20240901preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
...
def get_database_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20240901preview:getDatabase', __args__, opts=opts, typ=GetDatabaseResult)
