...
class RedisFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20170201:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20171001:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20180301:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20190701:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20200601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20201201:RedisFirewallRule")])
