...
class RedisFirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        redis_firewall_rule = azure_native.cache.v20160401.RedisFirewallRule("redisFirewallRule",
            cache_name="cache1",
            end_ip="192.168.1.4",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20170201:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20171001:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20180301:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20190701:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20200601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20201201:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20210601:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20220501:RedisFirewallRule"), pulumi.Alias(type_="azure-native:cache/v20220601:RedisFirewallRule")])
