...
def get_redis(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis is deprecated: Version v20160401 will be removed in the next major version of the provider. Upgrade to version v20200601 or later.""")
    __args__ = dict()
    __args__['name'] = name
