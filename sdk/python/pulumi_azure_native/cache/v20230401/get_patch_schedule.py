...
def get_patch_schedule(default: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20230401:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult).value
...
def get_patch_schedule_output(default: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20230401:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult)
