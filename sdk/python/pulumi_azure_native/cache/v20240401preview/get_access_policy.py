...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/v20240401preview:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult).value
...
def get_access_policy_output(access_policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cache/v20240401preview:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult)
