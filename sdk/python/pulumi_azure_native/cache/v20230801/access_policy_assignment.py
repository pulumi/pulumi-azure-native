...
class AccessPolicyAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:AccessPolicyAssignment"), pulumi.Alias(type_="azure-native:cache/v20230501preview:AccessPolicyAssignment")])
