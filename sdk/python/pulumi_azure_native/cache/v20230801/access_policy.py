...
class AccessPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20230501preview:AccessPolicy"), pulumi.Alias(type_="azure-native:cache/v20240301:AccessPolicy")])
