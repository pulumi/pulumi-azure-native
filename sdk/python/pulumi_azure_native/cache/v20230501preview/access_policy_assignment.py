...
class AccessPolicyAssignmentArgs:
    ...
    def _configure(
        ...
        if 'objectIdAlias' in kwargs:
            object_id_alias = kwargs['objectIdAlias']
        if 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if 'accessPolicyAssignmentName' in kwargs:
...
class AccessPolicyAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache:AccessPolicyAssignment"), pulumi.Alias(type_="azure-native:cache/v20230801:AccessPolicyAssignment")])
