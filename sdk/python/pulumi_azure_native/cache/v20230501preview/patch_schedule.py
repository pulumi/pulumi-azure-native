...
class PatchSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cache/v20171001:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20180301:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20190701:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20200601:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20201201:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20210601:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20220501:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20220601:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20230401:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20230801:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20240301:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20240401preview:PatchSchedule"), pulumi.Alias(type_="azure-native:cache/v20241101:PatchSchedule"), pulumi.Alias(type_="azure-native:cache:PatchSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PatchSchedule, __self__).__init__(
            'azure-native:cache/v20230501preview:PatchSchedule',
            resource_name,
            __props__,
            opts)
