...
warnings.warn("""azure-native:cache/v20221101preview:RedisEnterprise is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_redis_enterprise(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis_enterprise is deprecated: azure-native:cache/v20221101preview:RedisEnterprise is being removed in the next major version of this provider. Please upgrade to azure-native:cache/v20230301preview:RedisEnterprise to guarantee forwards compatibility.""")
    __args__ = dict()
