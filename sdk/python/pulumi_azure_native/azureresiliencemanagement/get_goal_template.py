...
__all__ = [
    'GetGoalTemplateResult',
    'AwaitableGetGoalTemplateResult',
    'get_goal_template',
    'get_goal_template_output',
]
...
class GetGoalTemplateResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.GoalTemplatePropertiesResponse':
        """
...
class AwaitableGetGoalTemplateResult(GetGoalTemplateResult):
...
def get_goal_template(goal_template_name: Optional[_builtins.str] = None,
                      service_group_name: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGoalTemplateResult:
    """
    Get a GoalTemplate
    ...
    """
    __args__ = dict()
    __args__['goalTemplateName'] = goal_template_name
    __args__['serviceGroupName'] = service_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azureresiliencemanagement:getGoalTemplate', __args__, opts=opts, typ=GetGoalTemplateResult).value

    return AwaitableGetGoalTemplateResult(
...
def get_goal_template_output(goal_template_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azureresiliencemanagement:getGoalTemplate', __args__, opts=opts, typ=GetGoalTemplateResult)
    return __ret__.apply(lambda __response__: GetGoalTemplateResult(
