...
def get_recovery_plan(recovery_plan_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str recovery_plan_name: The name of the recovery orchestration plan.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azureresiliencemanagement:getRecoveryPlan', __args__, opts=opts, typ=GetRecoveryPlanResult).value
...
def get_recovery_plan_output(recovery_plan_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azureresiliencemanagement:getRecoveryPlan', __args__, opts=opts, typ=GetRecoveryPlanResult)
