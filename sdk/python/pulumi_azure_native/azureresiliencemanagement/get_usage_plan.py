...
class GetUsagePlanResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.UsagePlanPropertiesResponse':
        """
...
def get_usage_plan(resource_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azureresiliencemanagement:getUsagePlan', __args__, opts=opts, typ=GetUsagePlanResult).value
...
def get_usage_plan_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azureresiliencemanagement:getUsagePlan', __args__, opts=opts, typ=GetUsagePlanResult)
