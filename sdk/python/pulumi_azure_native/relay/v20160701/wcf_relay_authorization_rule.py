...
azure-native:relay/v20160701:WCFRelayAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:relay/v20170401:WCFRelayAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:relay/v20160701:WCFRelayAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:relay/v20170401:WCFRelayAuthorizationRule to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20211101:WCFRelayAuthorizationRule")])
