...
def get_hybrid_connection(hybrid_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hybrid_connection is deprecated: Version v20160701 will be removed in the next major version of the provider. Upgrade to version v20211101 or later.""")
    __args__ = dict()
