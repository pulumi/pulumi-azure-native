...
class HybridConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay/v20211101:HybridConnection"), pulumi.Alias(type_="azure-native:relay/v20240101:HybridConnection"), pulumi.Alias(type_="azure-native_relay_v20160701:relay:HybridConnection"), pulumi.Alias(type_="azure-native_relay_v20170401:relay:HybridConnection"), pulumi.Alias(type_="azure-native_relay_v20211101:relay:HybridConnection"), pulumi.Alias(type_="azure-native_relay_v20240101:relay:HybridConnection")])
