...
def list_hybrid_connection_keys(authorization_rule_name: Optional[_builtins.str] = None,
...
def list_hybrid_connection_keys_output(authorization_rule_name: Optional[pulumi.Input[_builtins.str]] = None,
