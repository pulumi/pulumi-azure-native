...
def get_hybrid_connection_authorization_rule(authorization_rule_name: Optional[builtins.str] = None,
...
def get_hybrid_connection_authorization_rule_output(authorization_rule_name: Optional[pulumi.Input[builtins.str]] = None,
