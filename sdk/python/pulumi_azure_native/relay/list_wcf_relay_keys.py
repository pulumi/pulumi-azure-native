...
def list_wcf_relay_keys(authorization_rule_name: Optional[_builtins.str] = None,
                        namespace_name: Optional[_builtins.str] = None,
                        relay_name: Optional[_builtins.str] = None,
...
def list_wcf_relay_keys_output(authorization_rule_name: Optional[pulumi.Input[_builtins.str]] = None,
