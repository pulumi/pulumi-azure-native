...
def list_wcf_relay_keys(authorization_rule_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay:listWCFRelayKeys', __args__, opts=opts, typ=ListWCFRelayKeysResult).value
...
def list_wcf_relay_keys_output(authorization_rule_name: Optional[pulumi.Input[builtins.str]] = None,
