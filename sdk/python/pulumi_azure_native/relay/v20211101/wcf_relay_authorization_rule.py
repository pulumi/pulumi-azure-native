...
class WCFRelayAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        wcf_relay_authorization_rule = azure_native.relay.v20211101.WCFRelayAuthorizationRule("wcfRelayAuthorizationRule",
        ...
        ```sh
        $ pulumi import azure-native:relay/v20211101:WCFRelayAuthorizationRule example-RelayAuthRules-01 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/resourcegroup/providers/Microsoft.Relay/namespaces/example-RelayNamespace-01/WcfRelays/example-Relay-Wcf-01/AuthorizationRules/example-RelayAuthRules-01 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelayAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelayAuthorizationRule, __self__).__init__(
            'azure-native:relay/v20211101:WCFRelayAuthorizationRule',
            resource_name,
            __props__,
            opts)
