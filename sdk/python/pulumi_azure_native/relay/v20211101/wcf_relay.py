...
class WCFRelay(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        wcf_relay = azure_native.relay.v20211101.WCFRelay("wcfRelay",
            namespace_name="example-RelayNamespace-9953",
            relay_name="example-Relay-Wcf-1194",
            relay_type=azure_native.relay/v20211101.Relaytype.NET_TCP,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelay")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelay, __self__).__init__(
            'azure-native:relay/v20211101:WCFRelay',
            resource_name,
            __props__,
            opts)
