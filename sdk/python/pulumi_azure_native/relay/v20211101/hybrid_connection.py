...
class HybridConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        hybrid_connection = azure_native.relay.v20211101.HybridConnection("hybridConnection",
        ...
        ```sh
        $ pulumi import azure-native:relay/v20211101:HybridConnection example-Relay-Hybrid-01 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/resourcegroup/providers/Microsoft.Relay/namespaces/example-RelayNamespace-01/HybridConnections/example-Relay-Hybrid-01 
        ```
