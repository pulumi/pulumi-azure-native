...
class WCFRelay(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20211101:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20240101:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20260101:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20260701preview:WCFRelay")])
