...
class WCFRelayArgs:
    ...
    def _configure(
        ...
        if relay_type is None and 'relayType' in kwargs:
            relay_type = kwargs['relayType']
        ...
        if requires_transport_security is None and 'requiresTransportSecurity' in kwargs:
            requires_transport_security = kwargs['requiresTransportSecurity']
...
class WCFRelay(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20211101:WCFRelay")])
