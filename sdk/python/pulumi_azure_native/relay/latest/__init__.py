...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:relay/latest:HybridConnection":
                return HybridConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:relay/latest:HybridConnectionAuthorizationRule":
                return HybridConnectionAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:relay/latest:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:relay/latest:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:relay/latest:WCFRelay":
                return WCFRelay(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:relay/latest:WCFRelayAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "relay/latest", _module_instance)
