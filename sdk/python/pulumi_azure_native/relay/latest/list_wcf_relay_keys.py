...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:listWCFRelayKeys'.""", DeprecationWarning)
...
def list_wcf_relay_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:listWCFRelayKeys', __args__, opts=opts, typ=ListWCFRelayKeysResult).value
