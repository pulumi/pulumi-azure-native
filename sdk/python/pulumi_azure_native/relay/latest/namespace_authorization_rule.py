...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:relay:NamespaceAuthorizationRule'.""", DeprecationWarning)
...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay/latest:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:relay:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20160701:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:NamespaceAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceAuthorizationRule, __self__).__init__(
            'azure-native:relay/latest:NamespaceAuthorizationRule',
            resource_name,
            __props__,
            opts)
