...
def list_hybrid_connection_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/v20240101:listHybridConnectionKeys', __args__, opts=opts, typ=ListHybridConnectionKeysResult).value
...
def list_hybrid_connection_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:relay/v20240101:listHybridConnectionKeys', __args__, opts=opts, typ=ListHybridConnectionKeysResult)
