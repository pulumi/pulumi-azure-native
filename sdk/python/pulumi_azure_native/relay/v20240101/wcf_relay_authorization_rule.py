...
class WCFRelayAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20211101:WCFRelayAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelayAuthorizationRule, __self__).__init__(
            'azure-native:relay/v20240101:WCFRelayAuthorizationRule',
            resource_name,
            __props__,
            opts)
