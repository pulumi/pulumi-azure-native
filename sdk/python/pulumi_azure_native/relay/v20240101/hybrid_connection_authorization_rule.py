...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay/v20160701:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20211101:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native:relay:HybridConnectionAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridConnectionAuthorizationRule, __self__).__init__(
            'azure-native:relay/v20240101:HybridConnectionAuthorizationRule',
            resource_name,
            __props__,
            opts)
