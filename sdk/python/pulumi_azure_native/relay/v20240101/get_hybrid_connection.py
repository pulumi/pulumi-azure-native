...
def get_hybrid_connection(hybrid_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/v20240101:getHybridConnection', __args__, opts=opts, typ=GetHybridConnectionResult).value
...
def get_hybrid_connection_output(hybrid_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:relay/v20240101:getHybridConnection', __args__, opts=opts, typ=GetHybridConnectionResult)
