...
def get_wcf_relay(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/v20240101:getWCFRelay', __args__, opts=opts, typ=GetWCFRelayResult).value
...
def get_wcf_relay_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:relay/v20240101:getWCFRelay', __args__, opts=opts, typ=GetWCFRelayResult)
