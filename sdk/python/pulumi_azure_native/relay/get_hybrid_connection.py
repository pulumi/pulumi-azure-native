...
def get_hybrid_connection(hybrid_connection_name: Optional[_builtins.str] = None,
...
def get_hybrid_connection_output(hybrid_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
