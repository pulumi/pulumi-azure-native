...
def get_hybrid_connection(hybrid_connection_name: Optional[builtins.str] = None,
...
def get_hybrid_connection_output(hybrid_connection_name: Optional[pulumi.Input[builtins.str]] = None,
