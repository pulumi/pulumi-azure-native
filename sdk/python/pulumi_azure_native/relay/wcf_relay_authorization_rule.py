...
class WCFRelayAuthorizationRuleArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def rights(self) -> pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'AccessRights']]]]:
        """
