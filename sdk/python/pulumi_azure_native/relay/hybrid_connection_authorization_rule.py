...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay/v20170401:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20211101:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20240101:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native_relay_v20160701:relay:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native_relay_v20170401:relay:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native_relay_v20211101:relay:HybridConnectionAuthorizationRule"), pulumi.Alias(type_="azure-native_relay_v20240101:relay:HybridConnectionAuthorizationRule")])
