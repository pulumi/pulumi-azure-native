...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rights: Optional[pulumi.Input[Sequence[pulumi.Input['AccessRights']]]] = None,
                 __props__=None):
        pulumi.log.warn("""HybridConnectionAuthorizationRule is deprecated: Version v20170401 will be removed in the next major version of the provider. Upgrade to version v20211101 or later.""")
        if opts is None:
