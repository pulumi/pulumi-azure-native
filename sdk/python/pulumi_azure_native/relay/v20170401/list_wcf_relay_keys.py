...
def list_wcf_relay_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/v20170401:listWCFRelayKeys', __args__, opts=opts, typ=ListWCFRelayKeysResult).value
...
def list_wcf_relay_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:relay/v20170401:listWCFRelayKeys', __args__, opts=opts, typ=ListWCFRelayKeysResult)
