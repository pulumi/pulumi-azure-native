...
def get_wcf_relay(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_wcf_relay is deprecated: Version v20170401 will be removed in the next major version of the provider. Upgrade to version v20211101 or later.""")
    __args__ = dict()
