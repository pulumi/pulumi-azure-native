...
class WCFRelay(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        wcf_relay = azure_native.relay.v20170401.WCFRelay("wcfRelay",
            namespace_name="example-RelayNamespace-9953",
            relay_name="example-Relay-Wcf-1194",
            relay_type=azure_native.relay/v20170401.Relaytype.NET_TCP,
        ...
        ```sh
        $ pulumi import azure-native:relay/v20170401:WCFRelay example-Relay-Wcf-1194 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/resourcegroup/providers/Microsoft.Relay/namespaces/example-RelayNamespace-9953/WcfRelays/example-Relay-Wcf-1194 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:relay:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelay"), pulumi.Alias(type_="azure-native:relay/v20211101:WCFRelay")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelay, __self__).__init__(
            'azure-native:relay/v20170401:WCFRelay',
            resource_name,
            __props__,
            opts)
