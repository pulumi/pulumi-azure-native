...
class WCFRelay(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_metadata: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WCFRelay is deprecated: azure-native:relay/v20170401:WCFRelay is being removed in the next major version of this provider. Upgrade to at least azure-native:relay/v20211101:WCFRelay to guarantee forwards compatibility.""")
