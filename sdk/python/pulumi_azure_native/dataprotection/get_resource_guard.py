...
def get_resource_guard(resource_group_name: Optional[builtins.str] = None,
                       resource_guards_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_guards_name: The name of ResourceGuard
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceGuardsName'] = resource_guards_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection:getResourceGuard', __args__, opts=opts, typ=GetResourceGuardResult).value
...
def get_resource_guard_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                              resource_guards_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection:getResourceGuard', __args__, opts=opts, typ=GetResourceGuardResult)
