...
def get_resource_guard(resource_group_name: Optional[_builtins.str] = None,
                       resource_guards_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_guards_name: The name of ResourceGuard
    """
    __args__ = dict()
...
def get_resource_guard_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                              resource_guards_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
