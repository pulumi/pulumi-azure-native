...
class ResourceGuardInitArgs:
    def __init__(__self__, *,
        ...
        """
        ResourceGuardInitArgs._configure(
    ...
    def _configure(
        ...
        if 'eTag' in kwargs:
            e_tag = kwargs['eTag']
        if 'resourceGuardsName' in kwargs:
            resource_guards_name = kwargs['resourceGuardsName']
        ...
        if resource_guards_name is not None:
            _setter("resource_guards_name", resource_guards_name)
        if tags is not None:
            _setter("tags", tags)
...
class ResourceGuard(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ResourceGuardInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ResourceGuardArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ResourceGuardArgs._configure(_setter, **properties)
