...
class BackupInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BackupInstance is deprecated: azure-native:dataprotection/v20221101preview:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.""")
        ...
        super(BackupInstance, __self__).__init__(
            'azure-native:dataprotection/v20221101preview:BackupInstance',
            resource_name,
            __props__,
            opts)
