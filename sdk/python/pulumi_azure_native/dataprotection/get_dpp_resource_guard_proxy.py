...
def get_dpp_resource_guard_proxy(resource_group_name: Optional[builtins.str] = None,
                                 resource_guard_proxy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_guard_proxy_name: name of the resource guard proxy
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection:getDppResourceGuardProxy', __args__, opts=opts, typ=GetDppResourceGuardProxyResult).value
...
def get_dpp_resource_guard_proxy_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection:getDppResourceGuardProxy', __args__, opts=opts, typ=GetDppResourceGuardProxyResult)
