...
def get_dpp_resource_guard_proxy(resource_group_name: Optional[_builtins.str] = None,
                                 resource_guard_proxy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_guard_proxy_name: name of the resource guard proxy
    :param _builtins.str vault_name: The name of the backup vault.
    """
    __args__ = dict()
