...
warnings.warn("""azure-native:dataprotection/v20220901preview:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
class BackupInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(BackupInstance, __self__).__init__(
            'azure-native:dataprotection/v20220901preview:BackupInstance',
            resource_name,
            __props__,
            opts)
