...
def get_dpp_resource_guard_proxy_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection/v20221001preview:getDppResourceGuardProxy', __args__, opts=opts, typ=GetDppResourceGuardProxyResult)
