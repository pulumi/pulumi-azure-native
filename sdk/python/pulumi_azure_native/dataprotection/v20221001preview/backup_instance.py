...
class BackupInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""BackupInstance is deprecated: azure-native:dataprotection/v20221001preview:BackupInstance is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupInstance to guarantee forwards compatibility.""")
