...
class PolicyParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 backup_datasource_parameters_list: Optional[Sequence['outputs.KubernetesClusterBackupDatasourceParametersResponse']] = None,
                 data_store_parameters_list: Optional[Sequence['outputs.AzureOperationalStoreParametersResponse']] = None):
        """
        Parameters in Policy
        :param Sequence['KubernetesClusterBackupDatasourceParametersResponse'] backup_datasource_parameters_list: Gets or sets the Backup Data Source Parameters
    ...
    def backup_datasource_parameters_list(self) -> Optional[Sequence['outputs.KubernetesClusterBackupDatasourceParametersResponse']]:
        """
