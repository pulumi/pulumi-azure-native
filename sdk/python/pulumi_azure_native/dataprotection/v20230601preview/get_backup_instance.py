...
def get_backup_instance(backup_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20230601preview:getBackupInstance', __args__, opts=opts, typ=GetBackupInstanceResult).value
...
def get_backup_instance_output(backup_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection/v20230601preview:getBackupInstance', __args__, opts=opts, typ=GetBackupInstanceResult)
