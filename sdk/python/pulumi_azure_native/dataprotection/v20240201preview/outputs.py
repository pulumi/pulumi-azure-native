...
__all__ = [
    ...
    'GenericBackupDatasourceParametersResponse',
...
@pulumi.output_type
class GenericBackupDatasourceParametersResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GenericBackupDatasourceParametersResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GenericBackupDatasourceParametersResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 object_type: str,
                 resource_selectors: Sequence[str]):
        """
        Generic parameters to be used during configuration of backup
        :param str object_type: Type of the specific object - used for deserializing
               Expected value is 'GenericBackupDatasourceParameters'.
        :param Sequence[str] resource_selectors: List of resource selectors to be backed up during configuration of backup
        """
    ...
    def resource_selectors(self) -> Sequence[str]:
        """
...
class PolicyParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameters in Policy
        :param Sequence[Union['BlobBackupDatasourceParametersResponse', 'GenericBackupDatasourceParametersResponse', 'KubernetesClusterBackupDatasourceParametersResponse']] backup_datasource_parameters_list: Gets or sets the Backup Data Source Parameters
