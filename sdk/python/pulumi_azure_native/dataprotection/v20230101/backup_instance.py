...
class BackupInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_instance = azure_native.dataprotection.v20230101.BackupInstance("backupInstance",
            backup_instance_name="testInstance1",
            properties=azure_native.dataprotection.v20230101.BackupInstanceResponseArgs(
                data_source_info={
                ...
                data_source_set_info=azure_native.dataprotection.v20230101.DatasourceSetArgs(
                ...
                datasource_auth_credentials=azure_native.dataprotection.v20230101.SecretStoreBasedAuthCredentialsResponseArgs(
                    object_type="SecretStoreBasedAuthCredentials",
                    secret_store_resource=azure_native.dataprotection.v20230101.SecretStoreResourceArgs(
                ...
                policy_info={
                    ...
                    "policyParameters": {
                        "dataStoreParametersList": [azure_native.dataprotection.v20230101.AzureOperationalStoreParametersResponseArgs(
