...
def get_backup_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_vault is deprecated: azure-native:dataprotection/v20230101:BackupVault is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupVault to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20230101:getBackupVault', __args__, opts=opts, typ=GetBackupVaultResult).value
