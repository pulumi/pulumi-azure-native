...
class BackupPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_policy = azure_native.dataprotection.v20230101.BackupPolicy("backupPolicy",
            backup_policy_name="OSSDBPolicy",
            properties=azure_native.dataprotection.v20230101.BackupPolicyResponseArgs(
                datasource_types=["OssDB"],
                object_type="BackupPolicy",
                policy_rules=[
                    azure_native.dataprotection.v20230101.AzureBackupRuleArgs(
                        backup_parameters=azure_native.dataprotection.v20230101.AzureBackupParamsArgs(
                            backup_type="Full",
                            object_type="AzureBackupParams",
                        ),
                        data_store=azure_native.dataprotection.v20230101.DataStoreInfoBaseArgs(
                            data_store_type="VaultStore",
                            object_type="DataStoreInfoBase",
                        ),
                        name="BackupWeekly",
                        object_type="AzureBackupRule",
                        trigger=azure_native.dataprotection.v20230101.ScheduleBasedTriggerContextArgs(
                            object_type="ScheduleBasedTriggerContext",
                            schedule=azure_native.dataprotection.v20230101.BackupScheduleArgs(
                                repeating_time_intervals=["R/2019-11-20T08:00:00-08:00/P1W"],
                            ),
                            tagging_criteria=[
                                azure_native.dataprotection.v20230101.TaggingCriteriaArgs(
                                    is_default=True,
                                    tag_info=azure_native.dataprotection.v20230101.RetentionTagArgs(
                                        tag_name="Default",
                                    ),
                                    tagging_priority=99,
                                ),
                                azure_native.dataprotection.v20230101.TaggingCriteriaArgs(
                                    criteria=[azure_native.dataprotection.v20230101.ScheduleBasedBackupCriteriaArgs(
                    ...
                    azure_native.dataprotection.v20230101.AzureRetentionRuleArgs(
                        is_default=True,
                        lifecycles=[azure_native.dataprotection.v20230101.SourceLifeCycleArgs(
                            delete_after=azure_native.dataprotection.v20230101.AbsoluteDeleteOptionArgs(
                                duration="P1W",
                                object_type="AbsoluteDeleteOption",
                            ),
                            source_data_store=azure_native.dataprotection.v20230101.DataStoreInfoBaseArgs(
                                data_store_type="VaultStore",
                                object_type="DataStoreInfoBase",
                            ),
                        )],
