...
class BackupVault(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_vault = azure_native.dataprotection.v20230101.BackupVault("backupVault",
            identity=azure_native.dataprotection.v20230101.DppIdentityDetailsArgs(
                type="None",
            ),
            location="WestUS",
            properties=azure_native.dataprotection.v20230101.BackupVaultResponseArgs(
                monitoring_settings={
                    "azureMonitorAlertSettings": azure_native.dataprotection.v20230101.AzureMonitorAlertSettingsArgs(
                        alerts_for_all_job_failures="Enabled",
                    ),
                },
                storage_settings=[azure_native.dataprotection.v20230101.StorageSettingArgs(
        ...
        ```sh
        $ pulumi import azure-native:dataprotection/v20230101:BackupVault swaggerExample /subscriptions/0b352192-dcac-4cc7-992e-a96190ccc68c/resourceGroups/SampleResourceGroup/providers/Microsoft.DataProtection/Backupvaults/swaggerExample 
        ```
