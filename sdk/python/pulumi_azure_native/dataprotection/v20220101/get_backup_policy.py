...
warnings.warn("""azure-native:dataprotection/v20220101:BackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backup_policy(backup_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_policy is deprecated: azure-native:dataprotection/v20220101:BackupPolicy is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
