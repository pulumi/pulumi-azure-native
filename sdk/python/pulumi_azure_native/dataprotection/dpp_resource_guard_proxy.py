...
class DppResourceGuardProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_guard_proxy_name: name of the resource guard proxy
        """
