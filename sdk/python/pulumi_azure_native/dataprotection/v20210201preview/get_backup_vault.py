...
def get_backup_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_vault is deprecated: azure-native:dataprotection/v20210201preview:BackupVault is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupVault to guarantee forwards compatibility.""")
    __args__ = dict()
