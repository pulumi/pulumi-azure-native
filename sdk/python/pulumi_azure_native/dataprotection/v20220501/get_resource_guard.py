...
def get_resource_guard(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_guard is deprecated: azure-native:dataprotection/v20220501:ResourceGuard is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceGuardsName'] = resource_guards_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20220501:getResourceGuard', __args__, opts=opts, typ=GetResourceGuardResult).value
