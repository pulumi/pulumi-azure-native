...
def get_resource_guard(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_guard is deprecated: azure-native:dataprotection/v20220501:ResourceGuard is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20221101preview:ResourceGuard to guarantee forwards compatibility.""")
    __args__ = dict()
