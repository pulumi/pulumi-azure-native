...
warnings.warn("""azure-native:dataprotection/v20210601preview:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupPolicy to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backup_policy(backup_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_policy is deprecated: azure-native:dataprotection/v20210601preview:BackupPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['backupPolicyName'] = backup_policy_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20210601preview:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult).value
