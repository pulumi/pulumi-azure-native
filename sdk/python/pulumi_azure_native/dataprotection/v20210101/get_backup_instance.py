...
warnings.warn("""azure-native:dataprotection/v20210101:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backup_instance(backup_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_instance is deprecated: azure-native:dataprotection/v20210101:BackupInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230401preview:BackupInstance to guarantee forwards compatibility.""")
    __args__ = dict()
