...
class DppResourceGuardProxyArgs:
    ...
    def _configure(
        ...
        if resource_guard_proxy_name is None and 'resourceGuardProxyName' in kwargs:
            resource_guard_proxy_name = kwargs['resourceGuardProxyName']
...
class DppResourceGuardProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ResourceGuardProxyBaseArgs, True)
