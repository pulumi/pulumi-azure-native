...
class BackupInstanceInitArgs:
    ...
    def _configure(
        ...
        if backup_instance_name is None and 'backupInstanceName' in kwargs:
            backup_instance_name = kwargs['backupInstanceName']
...
class BackupInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, BackupInstanceArgs, True)
