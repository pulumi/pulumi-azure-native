...
def get_backup_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_vault is deprecated: azure-native:dataprotection/v20221201:BackupVault is being removed in the next major version of this provider. Upgrade to at least azure-native:dataprotection/v20230101:BackupVault to guarantee forwards compatibility.""")
    __args__ = dict()
