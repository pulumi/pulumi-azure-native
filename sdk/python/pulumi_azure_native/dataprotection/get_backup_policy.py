...
def get_backup_policy_output(backup_policy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult)
