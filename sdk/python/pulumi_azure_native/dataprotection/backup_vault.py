...
class BackupVaultInitArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['BackupVaultArgs']] = None,
...
class BackupVault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            identity = _utilities.configure(identity, DppIdentityDetailsArgs, True)
            __props__.__dict__["identity"] = identity
            __props__.__dict__["location"] = location
            properties = _utilities.configure(properties, BackupVaultArgs, True)
