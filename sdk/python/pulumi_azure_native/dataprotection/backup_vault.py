...
class BackupVaultInitArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['DppIdentityDetailsArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['DppIdentityDetailsArgs']]):
...
class BackupVault(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 e_tag: pulumi.Input[Optional[_builtins.str]] = None,
                 identity: pulumi.Input[Optional[Union['DppIdentityDetailsArgs', 'DppIdentityDetailsArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['BackupVaultArgs', 'BackupVaultArgsDict']]] = None,
