...
def get_backup_instance(backup_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backup_instance_name: The name of the backup instance.
...
def get_backup_instance_output(backup_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
