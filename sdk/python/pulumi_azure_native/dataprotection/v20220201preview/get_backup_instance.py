...
warnings.warn("""azure-native:dataprotection/v20220201preview:BackupInstance is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_backup_instance(backup_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_instance is deprecated: azure-native:dataprotection/v20220201preview:BackupInstance is being removed in the next major version of this provider. Please upgrade to azure-native:dataprotection/v20230101:BackupInstance to guarantee forwards compatibility.""")
    __args__ = dict()
