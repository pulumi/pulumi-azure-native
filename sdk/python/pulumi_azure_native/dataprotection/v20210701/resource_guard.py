...
class ResourceGuard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dataprotection/v20210701:ResourceGuard"), pulumi.Alias(type_="azure-native:dataprotection:ResourceGuard"), pulumi.Alias(type_="azure-nextgen:dataprotection:ResourceGuard")])
