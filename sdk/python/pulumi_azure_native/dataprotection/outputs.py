...
class AbsoluteDeleteOptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Delete option with duration
        :param builtins.str duration: Duration of deletion after given timespan
...
class AzureBackupParamsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure backup parameters
        :param builtins.str backup_type: BackupType ; Full/Incremental etc
        :param builtins.str object_type: Type of the specific object - used for deserializing
...
class AzureBackupRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str object_type: 
...
class AzureOperationalStoreParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameters for Operational-Tier DataStore
        :param builtins.str data_store_type: type of datastore; Operational/Vault/Archive
        :param builtins.str object_type: Type of the specific object - used for deserializing
               Expected value is 'AzureOperationalStoreParameters'.
        :param builtins.str resource_group_id: Gets or sets the Snapshot Resource Group Uri.
        """
...
class BackupInstanceResponse(dict):
    ...
    def __init__(__self__, *,
                 current_protection_state: builtins.str,
        ...
        """
        Backup Instance
        :param builtins.str current_protection_state: Specifies the current protection state of the resource
        ...
        :param builtins.str provisioning_state: Specifies the provisioning state of the resource i.e. provisioning/updating/Succeeded/Failed
        ...
        :param builtins.str friendly_name: Gets or sets the Backup Instance friendly name.
        ...
        :param builtins.str validation_type: Specifies the type of validation. In case of DeepValidation, all validations from /validateForBackup API will run again.
        """
    ...
    def current_protection_state(self) -> builtins.str:
        """
...
class BackupPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 datasource_types: Sequence[builtins.str],
                 object_type: builtins.str,
                 policy_rules: Sequence[Any]):
        """
        Rule based backup policy
        :param Sequence[builtins.str] datasource_types: Type of datasource for the backup management
        :param builtins.str object_type: 
    ...
    def datasource_types(self) -> Sequence[builtins.str]:
        """
...
class BackupScheduleResponse(dict):
    ...
    def __init__(__self__, *,
                 repeating_time_intervals: Sequence[builtins.str],
...
class BackupVaultResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_vault_protected_by_resource_guard: builtins.bool,
                 provisioning_state: builtins.str,
                 resource_move_details: 'outputs.ResourceMoveDetailsResponse',
                 resource_move_state: builtins.str,
                 ...
                 replicated_regions: Optional[Sequence[builtins.str]] = None,
                 resource_guard_operation_requests: Optional[Sequence[builtins.str]] = None,
                 security_settings: Optional['outputs.SecuritySettingsResponse'] = None):
        """
        Backup Vault
        :param builtins.str bcdr_security_level: Security Level of Backup Vault
        :param builtins.bool is_vault_protected_by_resource_guard: Is vault protected by resource guard
        :param builtins.str provisioning_state: Provisioning state of the BackupVault resource
        :param 'ResourceMoveDetailsResponse' resource_move_details: Resource move details for backup vault
        :param builtins.str resource_move_state: Resource move state for backup vault
        :param builtins.str secure_score: Secure Score of Backup Vault
        ...
        :param Sequence[builtins.str] replicated_regions: List of replicated regions for Backup Vault
        :param Sequence[builtins.str] resource_guard_operation_requests: ResourceGuardOperationRequests on which LAC check will be performed
    ...
    def is_vault_protected_by_resource_guard(self) -> builtins.bool:
        """
    ...
    def resource_move_state(self) -> builtins.str:
        """
    ...
    def replicated_regions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BlobBackupDatasourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 containers_list: Sequence[builtins.str],
                 object_type: builtins.str):
        """
        Parameters to be used during configuration of backup of blobs
        :param Sequence[builtins.str] containers_list: List of containers to be backed up during configuration of backup of blobs
        :param builtins.str object_type: Type of the specific object - used for deserializing
    ...
    def containers_list(self) -> Sequence[builtins.str]:
        """
...
class CmkKekIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The details of the managed identity used for CMK
        :param builtins.str identity_id: The managed identity to be used which has access permissions to the Key Vault. Provide a value here in case identity types: 'UserAssigned' only.
        :param builtins.str identity_type: The identity type. 'SystemAssigned' and 'UserAssigned' are mutually exclusive. 'SystemAssigned' will use implicitly created managed identity.
        """
...
class CrossRegionRestoreSettingsResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str state: CrossRegionRestore state
        """
...
class CrossSubscriptionRestoreSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CrossSubscriptionRestore Settings
        :param builtins.str state: CrossSubscriptionRestore state
        """
        if state is not None:
            pulumi.set(__self__, "state", state)
...
class CustomCopyOptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str duration: Data copied after given timespan
        """
...
class DataStoreInfoBaseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        DataStoreInfo base
        :param builtins.str data_store_type: type of datastore; Operational/Vault/Archive
        :param builtins.str object_type: Type of Datasource object, used to initialize the right inherited type
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "object_type", object_type)
...
class DatasourceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_location: Optional[builtins.str] = None,
        ...
        """
        Datasource to be backed up
        :param builtins.str resource_id: Full ARM ID of the resource. For azure resources, this is ARM ID. For non azure resources, this will be the ID created by backup service via Fabric/Vault.
        :param builtins.str datasource_type: DatasourceType of the resource.
        :param builtins.str object_type: Type of Datasource object, used to initialize the right inherited type
        :param builtins.str resource_location: Location of datasource.
        :param builtins.str resource_name: Unique identifier of the resource in the context of parent.
        :param 'DefaultResourcePropertiesResponse' resource_properties: Properties specific to data source
        :param builtins.str resource_type: Resource Type of Datasource.
        :param builtins.str resource_uri: Uri of the resource.
        """
...
class DppIdentityDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity details
        :param builtins.str principal_id: The object ID of the service principal object for the managed identity that is used to grant role-based access to an Azure resource.
        :param builtins.str tenant_id: A Globally Unique Identifier (GUID) that represents the Azure AD tenant where the resource is now a member.
        :param builtins.str type: The identityType which can be either SystemAssigned, UserAssigned, 'SystemAssigned,UserAssigned' or None
...
class EncryptionSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str state: Encryption state of the Backup Vault.
        """
...
class IdentityDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_assigned_identity_arm_url: Optional[builtins.str] = None):
        """
        :param builtins.bool use_system_assigned_identity: Specifies if the BI is protected by System Identity.
        :param builtins.str user_assigned_identity_arm_url: ARM URL for User Assigned Identity.
        """
    ...
    def user_assigned_identity_arm_url(self) -> Optional[builtins.str]:
        """
...
class ImmutabilitySettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Immutability Settings at vault level
        :param builtins.str state: Immutability state
        """
        if state is not None:
            pulumi.set(__self__, "state", state)
...
class InnerErrorResponse(dict):
    ...
    def __init__(__self__, *,
                 additional_info: Optional[Mapping[str, builtins.str]] = None,
                 code: Optional[builtins.str] = None,
                 embedded_inner_error: Optional['outputs.InnerErrorResponse'] = None):
        """
        Inner Error
        :param Mapping[str, builtins.str] additional_info: Any Key value pairs that can be provided to the client for additional  verbose information.
        :param builtins.str code: Unique code for this error
    ...
    def additional_info(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class KubernetesClusterBackupDatasourceParametersResponse(dict):
    ...
    def __init__(__self__, *,
                 include_cluster_scope_resources: builtins.bool,
                 object_type: builtins.str,
                 snapshot_volumes: builtins.bool,
                 ...
                 included_volume_types: Optional[Sequence[builtins.str]] = None,
                 label_selectors: Optional[Sequence[builtins.str]] = None):
        """
        Parameters for Kubernetes Cluster Backup Datasource
        :param builtins.bool include_cluster_scope_resources: Gets or sets the include cluster resources property. This property if enabled will include cluster scope resources during backup.
        :param builtins.str object_type: Type of the specific object - used for deserializing
               Expected value is 'KubernetesClusterBackupDatasourceParameters'.
        :param builtins.bool snapshot_volumes: Gets or sets the volume snapshot property. This property if enabled will take volume snapshots during backup.
        ...
        :param Sequence[builtins.str] excluded_namespaces: Gets or sets the exclude namespaces property. This property sets the namespaces to be excluded during backup.
        :param Sequence[builtins.str] excluded_resource_types: Gets or sets the exclude resource types property. This property sets the resource types to be excluded during backup.
        :param Sequence[builtins.str] included_namespaces: Gets or sets the include namespaces property. This property sets the namespaces to be included during backup.
        :param Sequence[builtins.str] included_resource_types: Gets or sets the include resource types property. This property sets the resource types to be included during backup.
        :param Sequence[builtins.str] included_volume_types: Gets or sets the include volume types property. This property sets the volume types to be included during backup.
        :param Sequence[builtins.str] label_selectors: Gets or sets the LabelSelectors property. This property sets the resource with such label selectors to be included during backup.
        """
    ...
    def include_cluster_scope_resources(self) -> builtins.bool:
        """
    ...
    def snapshot_volumes(self) -> builtins.bool:
        """
    ...
    def included_volume_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NamespacedNameResourceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str namespace: Namespace in which the resource exists
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class ProtectionStatusDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str status: Specifies the protection status of the resource
        """
...
class ResourceGuardOperationResponse(dict):
    ...
    def __init__(__self__, *,
                 request_resource_type: builtins.str,
                 vault_critical_operation: builtins.str):
        """
        This class contains all the details about a critical operation.
        :param builtins.str request_resource_type: Type of resource request.
        :param builtins.str vault_critical_operation: Name of the critical operation.
        """
    ...
    def request_resource_type(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="vaultCriticalOperation")
    def vault_critical_operation(self) -> builtins.str:
        """
...
class ResourceGuardProxyBaseResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_guard_resource_id: Optional[builtins.str] = None):
        """
        ResourceGuardProxyBase object, used in ResourceGuardProxyBaseResource
        """
    ...
    def resource_guard_resource_id(self) -> Optional[builtins.str]:
...
class ResourceGuardResponse(dict):
    ...
    def __init__(__self__, *,
                 allow_auto_approvals: builtins.bool,
                 description: builtins.str,
                 provisioning_state: builtins.str,
                 resource_guard_operations: Sequence['outputs.ResourceGuardOperationResponse'],
                 vault_critical_operation_exclusion_list: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool allow_auto_approvals: This flag indicates whether auto approval is allowed or not.
        :param builtins.str description: Description about the pre-req steps to perform all the critical operations.
        :param builtins.str provisioning_state: Provisioning state of the BackupVault resource
        ...
        :param Sequence[builtins.str] vault_critical_operation_exclusion_list: List of critical operations which are not protected by this resourceGuard
        """
    ...
    def allow_auto_approvals(self) -> builtins.bool:
        """
    ...
    def vault_critical_operation_exclusion_list(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResourceMoveDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 completion_time_utc: Optional[builtins.str] = None,
                 operation_id: Optional[builtins.str] = None,
                 source_resource_path: Optional[builtins.str] = None,
                 start_time_utc: Optional[builtins.str] = None,
                 target_resource_path: Optional[builtins.str] = None):
        """
        ResourceMoveDetails will be returned in response to GetResource call from ARM
        :param builtins.str completion_time_utc: Completion time in UTC of latest ResourceMove operation attempted. ISO 8601 format.
        :param builtins.str operation_id: CorrelationId of latest ResourceMove operation attempted
        :param builtins.str source_resource_path: ARM resource path of source resource
        :param builtins.str start_time_utc: Start time in UTC of latest ResourceMove operation attempted. ISO 8601 format.
        :param builtins.str target_resource_path: ARM resource path of target resource used in latest ResourceMove operation
        """
    ...
    def completion_time_utc(self) -> Optional[builtins.str]:
        """
    ...
    def source_resource_path(self) -> Optional[builtins.str]:
        """
    ...
    def target_resource_path(self) -> Optional[builtins.str]:
        """
...
class RetentionTagResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Retention tag
        :param builtins.str e_tag: Retention Tag version.
        :param builtins.str id: Retention Tag version.
        :param builtins.str tag_name: Retention Tag Name to relate it to retention rule.
        """
...
class ScheduleBasedBackupCriteriaResponse(dict):
    ...
    def __init__(__self__, *,
                 object_type: builtins.str,
                 absolute_criteria: Optional[Sequence[builtins.str]] = None,
                 ...
                 schedule_times: Optional[Sequence[builtins.str]] = None,
                 weeks_of_the_month: Optional[Sequence[builtins.str]] = None):
        """
        Schedule based backup criteria
        :param builtins.str object_type: Type of the specific object - used for deserializing
               Expected value is 'ScheduleBasedBackupCriteria'.
        :param Sequence[builtins.str] absolute_criteria: it contains absolute values like "AllBackup" / "FirstOfDay" / "FirstOfWeek" / "FirstOfMonth"
               and should be part of AbsoluteMarker enum
        :param Sequence['DayResponse'] days_of_month: This is day of the month from 1 to 28 other wise last of month
        :param Sequence[builtins.str] days_of_the_week: It should be Sunday/Monday/T..../Saturday
        :param Sequence[builtins.str] months_of_year: It should be January/February/....../December
        :param Sequence[builtins.str] schedule_times: List of schedule times for backup
        :param Sequence[builtins.str] weeks_of_the_month: It should be First/Second/Third/Fourth/Last
        """
    ...
    def absolute_criteria(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def schedule_times(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SecretStoreResourceResponse(dict):
    ...
    def __init__(__self__, *,
                 secret_store_type: builtins.str,
                 uri: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        Class representing a secret store resource.
        :param builtins.str secret_store_type: Gets or sets the type of secret store
        :param builtins.str uri: Uri to get to the resource
        :param builtins.str value: Gets or sets value stored in secret store resource
        """
    ...
    def secret_store_type(self) -> builtins.str:
        """
...
class SoftDeleteSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 retention_duration_in_days: Optional[builtins.float] = None,
                 state: Optional[builtins.str] = None):
        """
        Soft delete related settings
        :param builtins.float retention_duration_in_days: Soft delete retention duration
        :param builtins.str state: State of soft delete
        """
    ...
    def retention_duration_in_days(self) -> Optional[builtins.float]:
        """
...
class StorageSettingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Storage setting
        :param builtins.str datastore_type: Gets or sets the type of the datastore.
...
class TaggingCriteriaResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tagging_priority: builtins.float,
                 criteria: Optional[Sequence['outputs.ScheduleBasedBackupCriteriaResponse']] = None):
        """
        Tagging criteria
        :param builtins.bool is_default: Specifies if tag is default.
        :param 'RetentionTagResponse' tag_info: Retention tag information
        :param builtins.float tagging_priority: Retention Tag priority.
    ...
    def tagging_priority(self) -> builtins.float:
        """
...
class UserFacingErrorResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_retryable: Optional[builtins.bool] = None,
                 is_user_error: Optional[builtins.bool] = None,
                 message: Optional[builtins.str] = None,
                 properties: Optional[Mapping[str, builtins.str]] = None,
                 recommended_action: Optional[Sequence[builtins.str]] = None,
        ...
        :param builtins.bool is_retryable: Whether the operation will be retryable or not
        :param builtins.bool is_user_error: Whether the operation is due to a user error or service error
        :param Mapping[str, builtins.str] properties: Any key value pairs that can be injected inside error object
        :param Sequence[builtins.str] recommended_action: RecommendedAction � localized.
    ...
    def is_retryable(self) -> Optional[builtins.bool]:
        """
    ...
    def is_user_error(self) -> Optional[builtins.bool]:
        """
    ...
    def recommended_action(self) -> Optional[Sequence[builtins.str]]:
        """
