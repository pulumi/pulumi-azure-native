...
if not MYPY:
    class DatasourceSetArgsDict(TypedDict):
        ...
        """
        resource_properties: NotRequired[pulumi.Input['VmwareVMPropertiesArgsDict']]
        """
...
if not MYPY:
    class VmwareVMPropertiesArgsDict(TypedDict):
        """
    ...
    VmwareVMPropertiesArgsDict: TypeAlias = Mapping[str, Any]
