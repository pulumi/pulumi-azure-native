...
class DatasourceResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_properties: Optional['outputs.VmwareVMPropertiesResponse'] = None,
        ...
        :param 'VmwareVMPropertiesResponse' resource_properties: Properties specific to data source
    ...
    def resource_properties(self) -> Optional['outputs.VmwareVMPropertiesResponse']:
        """
...
class DatasourceSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str resource_location: Location of datasource.
        :param str resource_name: Unique identifier of the resource in the context of parent.
        :param 'VmwareVMPropertiesResponse' resource_properties: Properties specific to data source set
        :param str resource_type: Resource Type of Datasource.
        :param str resource_uri: Uri of the resource.
        """
        pulumi.set(__self__, "resource_id", resource_id)
...
@pulumi.output_type
class VmwareVMPropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VmwareVMPropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VmwareVMPropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param str instance_uuid: Unique Identifier of Vmware VM on VCenter (guid)
        """
