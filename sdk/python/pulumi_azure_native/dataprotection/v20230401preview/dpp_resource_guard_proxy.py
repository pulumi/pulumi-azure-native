...
class DppResourceGuardProxy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:dataprotection:DppResourceGuardProxy"), pulumi.Alias(type_="azure-native:dataprotection/v20221101preview:DppResourceGuardProxy"), pulumi.Alias(type_="azure-native:dataprotection/v20230101:DppResourceGuardProxy")])
