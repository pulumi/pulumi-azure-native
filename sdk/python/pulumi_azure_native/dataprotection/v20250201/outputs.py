...
__all__ = [
    ...
    'AdlsBlobBackupDatasourceParametersResponse',
...
@pulumi.output_type
class AdlsBlobBackupDatasourceParametersResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in AdlsBlobBackupDatasourceParametersResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        AdlsBlobBackupDatasourceParametersResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "object_type", 'AdlsBlobBackupDatasourceParameters')
...
class PolicyParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Parameters in Policy
        :param Sequence[Union['AdlsBlobBackupDatasourceParametersResponse', 'BlobBackupDatasourceParametersResponse', 'KubernetesClusterBackupDatasourceParametersResponse']] backup_datasource_parameters_list: Gets or sets the Backup Data Source Parameters
