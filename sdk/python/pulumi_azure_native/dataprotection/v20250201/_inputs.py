...
__all__ = [
    ...
    'AdlsBlobBackupDatasourceParametersArgsDict',
...
if not MYPY:
    class AdlsBlobBackupDatasourceParametersArgsDict(TypedDict):
        """
    ...
    AdlsBlobBackupDatasourceParametersArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class AdlsBlobBackupDatasourceParametersArgs:
    def __init__(__self__, *,
                 containers_list: pulumi.Input[Sequence[pulumi.Input[str]]],
                 object_type: pulumi.Input[str]):
        """
...
if not MYPY:
    class PolicyParametersArgsDict(TypedDict):
        ...
        """
        backup_datasource_parameters_list: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union['AdlsBlobBackupDatasourceParametersArgsDict', 'BlobBackupDatasourceParametersArgsDict', 'KubernetesClusterBackupDatasourceParametersArgsDict']]]]]
        """
...
class PolicyParametersArgs:
    def __init__(__self__, *,
                 backup_datasource_parameters_list: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AdlsBlobBackupDatasourceParametersArgs', 'BlobBackupDatasourceParametersArgs', 'KubernetesClusterBackupDatasourceParametersArgs']]]]] = None,
                 data_store_parameters_list: Optional[pulumi.Input[Sequence[pulumi.Input['AzureOperationalStoreParametersArgs']]]] = None):
        """
        Parameters in Policy
        :param pulumi.Input[Sequence[pulumi.Input[Union['AdlsBlobBackupDatasourceParametersArgs', 'BlobBackupDatasourceParametersArgs', 'KubernetesClusterBackupDatasourceParametersArgs']]]] backup_datasource_parameters_list: Gets or sets the Backup Data Source Parameters
    ...
    def backup_datasource_parameters_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union['AdlsBlobBackupDatasourceParametersArgs', 'BlobBackupDatasourceParametersArgs', 'KubernetesClusterBackupDatasourceParametersArgs']]]]]:
        """
        Gets or sets the Backup Data Source Parameters
        """
    ...
    def backup_datasource_parameters_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AdlsBlobBackupDatasourceParametersArgs', 'BlobBackupDatasourceParametersArgs', 'KubernetesClusterBackupDatasourceParametersArgs']]]]]):
