...
def get_backup_instance(backup_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20250201:getBackupInstance', __args__, opts=opts, typ=GetBackupInstanceResult).value
...
def get_backup_instance_output(backup_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection/v20250201:getBackupInstance', __args__, opts=opts, typ=GetBackupInstanceResult)
