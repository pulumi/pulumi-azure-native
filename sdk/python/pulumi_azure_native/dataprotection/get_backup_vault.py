...
def get_backup_vault(resource_group_name: Optional[builtins.str] = None,
...
def get_backup_vault_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
