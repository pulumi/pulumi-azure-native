...
def get_resource_guard(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20231201:getResourceGuard', __args__, opts=opts, typ=GetResourceGuardResult).value
...
def get_resource_guard_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGuardsName'] = resource_guards_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection/v20231201:getResourceGuard', __args__, opts=opts, typ=GetResourceGuardResult)
