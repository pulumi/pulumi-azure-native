...
def get_backup_vault(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dataprotection/v20231201:getBackupVault', __args__, opts=opts, typ=GetBackupVaultResult).value
...
def get_backup_vault_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vaultName'] = vault_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:dataprotection/v20231201:getBackupVault', __args__, opts=opts, typ=GetBackupVaultResult)
