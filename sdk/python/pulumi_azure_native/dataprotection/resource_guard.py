...
class ResourceGuardInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_guards_name: The name of ResourceGuard
    ...
    def resource_guards_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_guards_name(self, value: Optional[pulumi.Input[builtins.str]]):
