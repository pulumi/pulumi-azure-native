...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if cluster_arm_id is None and 'clusterArmId' in kwargs:
            cluster_arm_id = kwargs['clusterArmId']
        if disable_local_auth is None and 'disableLocalAuth' in kwargs:
            disable_local_auth = kwargs['disableLocalAuth']
        if is_auto_inflate_enabled is None and 'isAutoInflateEnabled' in kwargs:
            is_auto_inflate_enabled = kwargs['isAutoInflateEnabled']
        if kafka_enabled is None and 'kafkaEnabled' in kwargs:
            kafka_enabled = kwargs['kafkaEnabled']
        ...
        if cluster_arm_id is not None:
            _setter("cluster_arm_id", cluster_arm_id)
        ...
        if is_auto_inflate_enabled is not None:
            _setter("is_auto_inflate_enabled", is_auto_inflate_enabled)
        if kafka_enabled is not None:
            _setter("kafka_enabled", kafka_enabled)
