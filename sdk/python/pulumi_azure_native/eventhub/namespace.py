...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 alternate_name: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_arm_id: Optional[pulumi.Input[builtins.str]] = None,
                 disable_local_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption: Optional[pulumi.Input['EncryptionArgs']] = None,
                 identity: Optional[pulumi.Input['IdentityArgs']] = None,
                 is_auto_inflate_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kafka_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_throughput_units: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] alternate_name: Alternate name specified when alias and namespace names are same.
        :param pulumi.Input[builtins.str] cluster_arm_id: Cluster ARM ID of the Namespace.
        :param pulumi.Input[builtins.bool] disable_local_auth: This property disables SAS authentication for the Event Hubs namespace.
        ...
        :param pulumi.Input[builtins.bool] is_auto_inflate_enabled: Value that indicates whether AutoInflate is enabled for eventhub namespace.
        :param pulumi.Input[builtins.bool] kafka_enabled: Value that indicates whether Kafka is enabled for eventhub namespace.
        :param pulumi.Input[builtins.str] location: Resource location.
        :param pulumi.Input[builtins.int] maximum_throughput_units: Upper limit of throughput units when AutoInflate is enabled, value should be within 0 to 20 throughput units. ( '0' if AutoInflateEnabled = true)
        ...
        :param pulumi.Input[builtins.bool] zone_redundant: Enabling this property creates a Standard Event Hubs Namespace in regions supported availability zones.
        """
    ...
    def alternate_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alternate_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alternate_name", value)

    @property
    @pulumi.getter(name="clusterArmId")
    def cluster_arm_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_arm_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_auto_inflate_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_inflate_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_auto_inflate_enabled", value)

    @property
    @pulumi.getter(name="kafkaEnabled")
    def kafka_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def kafka_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def maximum_throughput_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_throughput_units(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def minimum_tls_version(self, value: Optional[pulumi.Input[Union[builtins.str, 'TlsVersion']]]):
...
class Namespace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="alternateName")
    def alternate_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alternate name specified when alias and namespace names are same.
        """
        return pulumi.get(self, "alternate_name")
    ...
    @property
    @pulumi.getter(name="clusterArmId")
    def cluster_arm_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cluster ARM ID of the Namespace.
        """
        return pulumi.get(self, "cluster_arm_id")
    ...
    @property
    @pulumi.getter(name="isAutoInflateEnabled")
    def is_auto_inflate_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Value that indicates whether AutoInflate is enabled for eventhub namespace.
        """
        return pulumi.get(self, "is_auto_inflate_enabled")
    ...
    @property
    @pulumi.getter(name="kafkaEnabled")
    def kafka_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Value that indicates whether Kafka is enabled for eventhub namespace.
        """
        return pulumi.get(self, "kafka_enabled")
    ...
    @property
    @pulumi.getter(name="maximumThroughputUnits")
    def maximum_throughput_units(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Upper limit of throughput units when AutoInflate is enabled, value should be within 0 to 20 throughput units. ( '0' if AutoInflateEnabled = true)
        """
        return pulumi.get(self, "maximum_throughput_units")
    ...
    def metric_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def service_bus_endpoint(self) -> pulumi.Output[builtins.str]:
        """
