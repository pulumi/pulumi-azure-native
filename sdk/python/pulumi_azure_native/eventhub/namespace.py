...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 cluster_arm_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 is_auto_inflate_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 kafka_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] cluster_arm_id: Cluster ARM ID of the Namespace.
        :param pulumi.Input[_builtins.bool] disable_local_auth: This property disables SAS authentication for the Event Hubs namespace.
        ...
        :param pulumi.Input[_builtins.bool] is_auto_inflate_enabled: Value that indicates whether AutoInflate is enabled for eventhub namespace.
        :param pulumi.Input[_builtins.bool] kafka_enabled: Value that indicates whether Kafka is enabled for eventhub namespace.
        :param pulumi.Input[_builtins.str] location: Resource location.
        :param pulumi.Input[_builtins.int] maximum_throughput_units: Upper limit of throughput units when AutoInflate is enabled, value should be within 0 to 20 throughput units. ( '0' if AutoInflateEnabled = true)
        ...
        :param pulumi.Input[_builtins.bool] zone_redundant: Enabling this property creates a Standard Event Hubs Namespace in regions supported availability zones.
        """
    ...
    def cluster_arm_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def cluster_arm_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def is_auto_inflate_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_auto_inflate_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_auto_inflate_enabled", value)

    @_builtins.property
    @pulumi.getter(name="kafkaEnabled")
    def kafka_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def kafka_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
