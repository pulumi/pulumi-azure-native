...
class ConsumerGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] consumer_group_name: The consumer group name
        :param pulumi.Input[builtins.str] user_metadata: User Metadata is a placeholder to store user-defined string data with maximum length 1024. e.g. it can be used to store descriptive data, such as list of teams and their contact information also user-defined configuration settings can be stored.
        """
