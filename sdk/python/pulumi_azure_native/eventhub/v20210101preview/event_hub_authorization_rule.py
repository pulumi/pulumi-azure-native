...
warnings.warn("""azure-native:eventhub/v20210101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventHubAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rights: Optional[pulumi.Input[Sequence[pulumi.Input[Union[str, 'AccessRights']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""EventHubAuthorizationRule is deprecated: azure-native:eventhub/v20210101preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.""")
        ...
        super(EventHubAuthorizationRule, __self__).__init__(
            'azure-native:eventhub/v20210101preview:EventHubAuthorizationRule',
            resource_name,
            __props__,
            opts)
