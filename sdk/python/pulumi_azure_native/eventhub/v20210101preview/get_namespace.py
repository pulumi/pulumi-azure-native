...
def get_namespace(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace is deprecated: azure-native:eventhub/v20210101preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['namespaceName'] = namespace_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20210101preview:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
