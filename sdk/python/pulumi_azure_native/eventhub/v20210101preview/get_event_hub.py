...
warnings.warn("""azure-native:eventhub/v20210101preview:EventHub is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_event_hub(event_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub is deprecated: azure-native:eventhub/v20210101preview:EventHub is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""")
    __args__ = dict()
