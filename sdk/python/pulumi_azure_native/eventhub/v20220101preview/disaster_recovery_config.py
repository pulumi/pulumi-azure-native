...
warnings.warn("""azure-native:eventhub/v20220101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DisasterRecoveryConfig is deprecated: azure-native:eventhub/v20220101preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""")
