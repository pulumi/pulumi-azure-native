...
warnings.warn("""azure-native:eventhub/v20220101preview:EventHub is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input['EntityStatus']] = None,
                 __props__=None):
        pulumi.log.warn("""EventHub is deprecated: azure-native:eventhub/v20220101preview:EventHub is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""")
