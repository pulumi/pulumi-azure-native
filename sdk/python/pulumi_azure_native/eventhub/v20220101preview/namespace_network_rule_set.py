...
class NamespaceNetworkRuleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NWRuleSetVirtualNetworkRulesArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NamespaceNetworkRuleSet is deprecated: azure-native:eventhub/v20220101preview:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.""")
        ...
        super(NamespaceNetworkRuleSet, __self__).__init__(
            'azure-native:eventhub/v20220101preview:NamespaceNetworkRuleSet',
            resource_name,
            __props__,
            opts)
