...
class Namespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 geo_data_replication: Optional[pulumi.Input[pulumi.InputType['GeoDataReplicationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['GeoDataReplicationPropertiesArgs']] geo_data_replication: Geo Data Replication settings for the namespace
    ...
    def _internal_init(__self__,
        ...
        super(Namespace, __self__).__init__(
            'azure-native:eventhub/v20240501preview:Namespace',
            resource_name,
            __props__,
            opts)
