...
def get_event_hub(event_hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20240501preview:getEventHub', __args__, opts=opts, typ=GetEventHubResult).value
...
def get_event_hub_output(event_hub_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventhub/v20240501preview:getEventHub', __args__, opts=opts, typ=GetEventHubResult)
    return __ret__.apply(lambda __response__: GetEventHubResult(
        ...
        message_timestamp_description=pulumi.get(__response__, 'message_timestamp_description'),
