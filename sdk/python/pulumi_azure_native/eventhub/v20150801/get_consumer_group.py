...
def get_consumer_group(consumer_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_consumer_group is deprecated: Version v20150801 will be removed in the next major version of the provider. Upgrade to version v20170401 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20150801:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult).value
