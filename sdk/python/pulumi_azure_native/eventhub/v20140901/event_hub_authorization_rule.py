...
class EventHubAuthorizationRule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Name of the AuthorizationRule.
