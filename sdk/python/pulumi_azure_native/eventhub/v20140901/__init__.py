...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:eventhub/v20140901:ConsumerGroup":
                return ConsumerGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventhub/v20140901:EventHub":
                return EventHub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventhub/v20140901:EventHubAuthorizationRule":
                return EventHubAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventhub/v20140901:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventhub/v20140901:NamespaceAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "eventhub/v20140901", _module_instance)
