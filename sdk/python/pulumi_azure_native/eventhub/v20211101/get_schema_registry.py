...
def get_schema_registry(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20211101:getSchemaRegistry', __args__, opts=opts, typ=GetSchemaRegistryResult).value
...
def get_schema_registry_output(namespace_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventhub/v20211101:getSchemaRegistry', __args__, opts=opts, typ=GetSchemaRegistryResult)
