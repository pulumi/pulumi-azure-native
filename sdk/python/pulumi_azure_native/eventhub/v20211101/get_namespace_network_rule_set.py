...
warnings.warn("""azure-native:eventhub/v20211101:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_namespace_network_rule_set(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace_network_rule_set is deprecated: azure-native:eventhub/v20211101:NamespaceNetworkRuleSet is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:NamespaceNetworkRuleSet to guarantee forwards compatibility.""")
    __args__ = dict()
