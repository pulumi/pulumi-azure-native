...
class EventHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 status: Optional[pulumi.Input['EntityStatus']] = None,
                 __props__=None):
        pulumi.log.warn("""EventHub is deprecated: azure-native:eventhub/v20211101:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""")
        ...
        super(EventHub, __self__).__init__(
            'azure-native:eventhub/v20211101:EventHub',
            resource_name,
            __props__,
            opts)
