...
warnings.warn("""azure-native:eventhub/v20211101:ConsumerGroup is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:ConsumerGroup to guarantee forwards compatibility.""", DeprecationWarning)
...
class ConsumerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_metadata: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ConsumerGroup is deprecated: azure-native:eventhub/v20211101:ConsumerGroup is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:ConsumerGroup to guarantee forwards compatibility.""")
