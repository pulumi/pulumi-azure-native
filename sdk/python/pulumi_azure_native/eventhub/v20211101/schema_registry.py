...
class SchemaRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 schema_type: Optional[pulumi.Input[Union[str, 'SchemaType']]] = None,
                 __props__=None):
        pulumi.log.warn("""SchemaRegistry is deprecated: azure-native:eventhub/v20211101:SchemaRegistry is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:SchemaRegistry to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventhub:SchemaRegistry"), pulumi.Alias(type_="azure-native:eventhub/v20220101preview:SchemaRegistry"), pulumi.Alias(type_="azure-native:eventhub/v20221001preview:SchemaRegistry")])
