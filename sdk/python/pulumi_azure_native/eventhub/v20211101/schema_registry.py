...
class SchemaRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventhub/v20211101:SchemaRegistry"), pulumi.Alias(type_="azure-native:eventhub:SchemaRegistry"), pulumi.Alias(type_="azure-nextgen:eventhub:SchemaRegistry")])
