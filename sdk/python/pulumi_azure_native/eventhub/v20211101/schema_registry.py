...
class SchemaRegistry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 schema_type: Optional[pulumi.Input[Union[str, 'SchemaType']]] = None,
                 __props__=None):
        pulumi.log.warn("""SchemaRegistry is deprecated: azure-native:eventhub/v20211101:SchemaRegistry is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:SchemaRegistry to guarantee forwards compatibility.""")
