...
def list_disaster_recovery_config_keys(alias: Optional[_builtins.str] = None,
                                       authorization_rule_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub:listDisasterRecoveryConfigKeys', __args__, opts=opts, typ=ListDisasterRecoveryConfigKeysResult).value
