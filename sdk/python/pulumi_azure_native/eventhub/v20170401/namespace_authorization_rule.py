...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 rights: Optional[pulumi.Input[Sequence[pulumi.Input[Union[str, 'AccessRights']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""NamespaceAuthorizationRule is deprecated: azure-native:eventhub/v20170401:NamespaceAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:NamespaceAuthorizationRule to guarantee forwards compatibility.""")
        ...
        super(NamespaceAuthorizationRule, __self__).__init__(
            'azure-native:eventhub/v20170401:NamespaceAuthorizationRule',
            resource_name,
            __props__,
            opts)
