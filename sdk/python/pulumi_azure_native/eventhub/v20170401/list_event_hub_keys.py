...
def list_event_hub_keys(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20170401:listEventHubKeys', __args__, opts=opts, typ=ListEventHubKeysResult).value
...
def list_event_hub_keys_output(authorization_rule_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventhub/v20170401:listEventHubKeys', __args__, opts=opts, typ=ListEventHubKeysResult)
