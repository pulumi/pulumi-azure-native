...
def get_consumer_group(consumer_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20230101preview:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult).value
...
def get_consumer_group_output(consumer_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventhub/v20230101preview:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult)
