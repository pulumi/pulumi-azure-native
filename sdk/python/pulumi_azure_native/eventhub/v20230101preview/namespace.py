...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        NamespaceArgs._configure(
            ...
            geo_data_replication=geo_data_replication,
            identity=identity,
    ...
    def _configure(
        ...
        if 'geoDataReplication' in kwargs:
            geo_data_replication = kwargs['geoDataReplication']
        ...
        if geo_data_replication is not None:
            _setter("geo_data_replication", geo_data_replication)
...
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if geo_data_replication is not None and not isinstance(geo_data_replication, GeoDataReplicationPropertiesArgs):
                geo_data_replication = geo_data_replication or {}
                def _setter(key, value):
                    geo_data_replication[key] = value
                GeoDataReplicationPropertiesArgs._configure(_setter, **geo_data_replication)
