...
class NamespaceArgs:
    ...
    def _configure(
        ...
        if geo_data_replication is None and 'geoDataReplication' in kwargs:
...
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            geo_data_replication = _utilities.configure(geo_data_replication, GeoDataReplicationPropertiesArgs, True)
