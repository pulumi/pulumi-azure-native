...
class NamespaceVirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_network_rule_name: The Virtual Network Rule name.
        :param pulumi.Input[builtins.str] virtual_network_subnet_id: ARM ID of Virtual Network Subnet
        """
...
class NamespaceVirtualNetworkRule(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:eventhub:NamespaceVirtualNetworkRule"
