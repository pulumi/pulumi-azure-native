...
class ApplicationGroupArgs:
    def __init__(__self__, *,
                 client_app_group_identifier: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] client_app_group_identifier: The Unique identifier for application group.Supports SAS(SASKeyName=KeyName) or AAD(AADAppID=Guid)
        ...
        :param pulumi.Input[builtins.str] application_group_name: The Application Group name 
        :param pulumi.Input[builtins.bool] is_enabled: Determines if Application Group is allowed to create connection with namespace or not. Once the isEnabled is set to false, all the existing connections of application group gets dropped and no new connections will be allowed
    ...
    def client_app_group_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def client_app_group_identifier(self, value: pulumi.Input[builtins.str]):
...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 application_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 client_app_group_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="clientAppGroupIdentifier")
    def client_app_group_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The Unique identifier for application group.Supports SAS(SASKeyName=KeyName) or AAD(AADAppID=Guid)
        """
        return pulumi.get(self, "client_app_group_identifier")
