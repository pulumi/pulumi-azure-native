...
def get_namespace_authorization_rule(authorization_rule_name: Optional[builtins.str] = None,
...
def get_namespace_authorization_rule_output(authorization_rule_name: Optional[pulumi.Input[builtins.str]] = None,
