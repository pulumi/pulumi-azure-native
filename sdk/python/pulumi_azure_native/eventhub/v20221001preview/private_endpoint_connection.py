...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.eventhub.v20221001preview.PrivateEndpointConnection("privateEndpointConnection",
            namespace_name="sdk-Namespace-2924",
            private_endpoint=azure_native.eventhub.v20221001preview.PrivateEndpointArgs(
            ...
            private_link_service_connection_state=azure_native.eventhub.v20221001preview.ConnectionStateArgs(
                description="testing",
                status="Rejected",
            ),
