...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application_group = azure_native.eventhub.v20221001preview.ApplicationGroup("applicationGroup",
            application_group_name="appGroup1",
            client_app_group_identifier="SASKeyName=KeyName",
            is_enabled=True,
            namespace_name="contoso-ua-test-eh-system-1",
            policies=[
                azure_native.eventhub.v20221001preview.ThrottlingPolicyResponseArgs(
