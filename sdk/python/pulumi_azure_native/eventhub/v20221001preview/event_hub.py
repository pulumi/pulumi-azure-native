...
class EventHubArgs:
    ...
    def _configure(
        ...
        if message_retention_in_days is None and 'messageRetentionInDays' in kwargs:
        ...
        if retention_description is None and 'retentionDescription' in kwargs:
...
class EventHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            capture_description = _utilities.configure(capture_description, CaptureDescriptionArgs, True)
            ...
            retention_description = _utilities.configure(retention_description, RetentionDescriptionArgs, True)
