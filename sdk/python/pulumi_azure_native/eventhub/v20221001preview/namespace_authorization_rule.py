...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        namespace_authorization_rule = azure_native.eventhub.v20221001preview.NamespaceAuthorizationRule("namespaceAuthorizationRule",
        ...
        ```sh
        $ pulumi import azure-native:eventhub/v20221001preview:NamespaceAuthorizationRule sdk-Authrules-1746 /subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.EventHub/namespaces/sdk-Namespace-2702/AuthorizationRules/sdk-Authrules-1746 
        ```
