...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getConsumerGroup'.""", DeprecationWarning)
...
def get_consumer_group(consumer_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/latest:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult).value
