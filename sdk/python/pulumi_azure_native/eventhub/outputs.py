...
class CaptureDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool skip_empty_archives: A value that indicates whether to Skip Empty Archives
        """
...
class DestinationResponse(dict):
    ...
    def __init__(__self__, *,
                 archive_name_format: Optional[_builtins.str] = None,
                 blob_container: Optional[_builtins.str] = None,
                 data_lake_account_name: Optional[_builtins.str] = None,
                 data_lake_folder_path: Optional[_builtins.str] = None,
                 data_lake_subscription_id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str data_lake_folder_path: The destination folder path for the captured events
        :param _builtins.str data_lake_subscription_id: Subscription Id of Azure Data Lake Store
        :param 'CaptureIdentityResponse' identity: A value that indicates whether capture description is enabled.
        :param _builtins.str name: Name for capture destination
        :param _builtins.str storage_account_resource_id: Resource id of the storage account to be used to create the blobs
        """
...
class RetentionDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retention_time_in_hours: Optional[_builtins.float] = None,
...
class ThrottlingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: Application Group Policy types
...
class UserAssignedIdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 user_assigned_identity: Optional[_builtins.str] = None):
        """
        :param _builtins.str user_assigned_identity: ARM ID of user Identity selected for encryption
        """
        if user_assigned_identity is not None:
            pulumi.set(__self__, "user_assigned_identity", user_assigned_identity)
