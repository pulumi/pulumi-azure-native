...
class CaptureDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 size_limit_in_bytes: Optional[builtins.int] = None,
                 skip_empty_archives: Optional[builtins.bool] = None):
        """
        Properties to configure capture description for eventhub
        :param 'DestinationResponse' destination: Properties of Destination where capture will be stored. (Storage Account, Blob Names)
        :param builtins.bool enabled: A value that indicates whether capture description is enabled. 
        :param builtins.str encoding: Enumerates the possible values for the encoding format of capture description. Note: 'AvroDeflate' will be deprecated in New API Version
        :param builtins.int interval_in_seconds: The time window allows you to set the frequency with which the capture to Azure Blobs will happen, value should between 60 to 900 seconds
        :param builtins.int size_limit_in_bytes: The size window defines the amount of data built up in your Event Hub before an capture operation, value should be between 10485760 to 524288000 bytes
        :param builtins.bool skip_empty_archives: A value that indicates whether to Skip Empty Archives
        """
    ...
    def size_limit_in_bytes(self) -> Optional[builtins.int]:
        """
    ...
    def skip_empty_archives(self) -> Optional[builtins.bool]:
        """
...
class CaptureIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A value that indicates whether capture description is enabled.
        :param builtins.str type: Type of Azure Active Directory Managed Identity.
        :param builtins.str user_assigned_identity: ARM ID of Managed User Identity. This property is required is the type is UserAssignedIdentity. If type is SystemAssigned, then the System Assigned Identity Associated with the namespace will be used.
        """
        if type is not None:
...
class ClusterSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int capacity: The quantity of Event Hubs Cluster Capacity Units contained in this cluster.
        """
...
class DestinationResponse(dict):
    ...
    def __init__(__self__, *,
                 archive_name_format: Optional[builtins.str] = None,
                 blob_container: Optional[builtins.str] = None,
                 data_lake_account_name: Optional[builtins.str] = None,
                 data_lake_folder_path: Optional[builtins.str] = None,
                 data_lake_subscription_id: Optional[builtins.str] = None,
                 identity: Optional['outputs.CaptureIdentityResponse'] = None,
                 name: Optional[builtins.str] = None,
                 storage_account_resource_id: Optional[builtins.str] = None):
        """
        Capture storage details for capture description
        :param builtins.str archive_name_format: Blob naming convention for archive, e.g. {Namespace}/{EventHub}/{PartitionId}/{Year}/{Month}/{Day}/{Hour}/{Minute}/{Second}. Here all the parameters (Namespace,EventHub .. etc) are mandatory irrespective of order
        :param builtins.str blob_container: Blob container Name
        :param builtins.str data_lake_account_name: The Azure Data Lake Store name for the captured events
        :param builtins.str data_lake_folder_path: The destination folder path for the captured events
        :param builtins.str data_lake_subscription_id: Subscription Id of Azure Data Lake Store
        :param 'CaptureIdentityResponse' identity: A value that indicates whether capture description is enabled.
        :param builtins.str name: Name for capture destination
        :param builtins.str storage_account_resource_id: Resource id of the storage account to be used to create the blobs
        """
    ...
    def archive_name_format(self) -> Optional[builtins.str]:
        """
    ...
    def blob_container(self) -> Optional[builtins.str]:
        """
        Blob container Name
        """
    ...
    def data_lake_account_name(self) -> Optional[builtins.str]:
        """
    ...
    def data_lake_folder_path(self) -> Optional[builtins.str]:
        """
    ...
    def data_lake_subscription_id(self) -> Optional[builtins.str]:
        """
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_version: Key Version
        """
        if identity is not None:
            pulumi.set(__self__, "identity", identity)
...
class RetentionDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retention_time_in_hours: Optional[builtins.float] = None,
                 tombstone_retention_time_in_hours: Optional[builtins.int] = None):
        """
        Properties to configure retention settings for the  eventhub
        :param builtins.str cleanup_policy: Enumerates the possible values for cleanup policy
        :param builtins.float retention_time_in_hours: Number of hours to retain the events for this Event Hub. This value is only used when cleanupPolicy is Delete. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue 
        :param builtins.int tombstone_retention_time_in_hours: Number of hours to retain the tombstone markers of a compacted Event Hub. This value is only used when cleanupPolicy is Compact. Consumer must complete reading the tombstone marker within this specified amount of time if consumer begins from starting offset to ensure they get a valid snapshot for the specific key described by the tombstone marker within the compacted Event Hub
        """
    ...
    def retention_time_in_hours(self) -> Optional[builtins.float]:
        """
    ...
    def tombstone_retention_time_in_hours(self) -> Optional[builtins.int]:
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        SKU parameters supplied to the create namespace operation
        :param builtins.str name: Name of this SKU.
        :param builtins.int capacity: The Event Hubs throughput units for Basic or Standard tiers, where value should be 0 to 20 throughput units. The Event Hubs premium units for Premium tier, where value should be 0 to 10 premium units.
...
class ThrottlingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 rate_limit_threshold: builtins.float,
                 type: builtins.str):
        """
        Properties of the throttling policy
        :param builtins.str metric_id: Metric Id on which the throttle limit should be set, MetricId can be discovered by hovering over Metric in the Metrics section of Event Hub Namespace inside Azure Portal
        :param builtins.str name: The Name of this policy
        :param builtins.float rate_limit_threshold: The Threshold limit above which the application group will be throttled.Rate limit is always per second.
        :param builtins.str type: Application Group Policy types
    ...
    def rate_limit_threshold(self) -> builtins.float:
        """
