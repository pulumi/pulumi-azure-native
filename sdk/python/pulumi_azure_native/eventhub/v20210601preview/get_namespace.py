...
warnings.warn("""azure-native:eventhub/v20210601preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_namespace(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace is deprecated: azure-native:eventhub/v20210601preview:Namespace is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:Namespace to guarantee forwards compatibility.""")
    __args__ = dict()
