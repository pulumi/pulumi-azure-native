...
warnings.warn("""azure-native:eventhub/v20210601preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_disaster_recovery_config(alias: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disaster_recovery_config is deprecated: azure-native:eventhub/v20210601preview:DisasterRecoveryConfig is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:DisasterRecoveryConfig to guarantee forwards compatibility.""")
    __args__ = dict()
