...
warnings.warn("""azure-native:eventhub/v20210601preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventHubAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(EventHubAuthorizationRule, __self__).__init__(
            'azure-native:eventhub/v20210601preview:EventHubAuthorizationRule',
            resource_name,
            __props__,
            opts)
