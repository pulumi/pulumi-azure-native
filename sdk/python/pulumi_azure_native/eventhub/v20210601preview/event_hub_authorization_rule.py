...
warnings.warn("""azure-native:eventhub/v20210601preview:EventHubAuthorizationRule is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:EventHubAuthorizationRule to guarantee forwards compatibility.""", DeprecationWarning)
