...
warnings.warn("""azure-native:eventhub/v20210601preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetEventHubResult:
    ...
    """
    def __init__(__self__, capture_description=None, created_at=None, id=None, message_retention_in_days=None, name=None, partition_count=None, partition_ids=None, status=None, system_data=None, type=None, updated_at=None):
...
def get_event_hub(event_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub is deprecated: azure-native:eventhub/v20210601preview:EventHub is being removed in the next major version of this provider. Upgrade to at least azure-native:eventhub/v20221001preview:EventHub to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['eventHubName'] = event_hub_name
    __args__['namespaceName'] = namespace_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/v20210601preview:getEventHub', __args__, opts=opts, typ=GetEventHubResult).value
