...
class EventHubArgs:
    def __init__(__self__, *,
                 ...
                 message_retention_in_days: Optional[pulumi.Input[builtins.float]] = None,
                 partition_count: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] event_hub_name: The Event Hub name
        :param pulumi.Input[builtins.float] message_retention_in_days: Number of days to retain the events for this Event Hub, value should be 1 to 7 days
        :param pulumi.Input[builtins.float] partition_count: Number of partitions created for the Event Hub, allowed values are from 1 to 32 partitions.
        ...
        :param pulumi.Input[builtins.str] user_metadata: Gets and Sets Metadata of User.
        """
    ...
    def message_retention_in_days(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def message_retention_in_days(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "message_retention_in_days", value)

    @property
    @pulumi.getter(name="partitionCount")
    def partition_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def partition_count(self, value: Optional[pulumi.Input[builtins.float]]):
...
class EventHub(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="messageRetentionInDays")
    def message_retention_in_days(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Number of days to retain the events for this Event Hub, value should be 1 to 7 days
        """
        return pulumi.get(self, "message_retention_in_days")
    ...
    @property
    @pulumi.getter(name="partitionCount")
    def partition_count(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Number of partitions created for the Event Hub, allowed values are from 1 to 32 partitions.
        """
        return pulumi.get(self, "partition_count")
    ...
    def partition_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
