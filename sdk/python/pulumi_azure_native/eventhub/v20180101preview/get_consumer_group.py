...
def get_consumer_group(consumer_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_consumer_group is deprecated: azure-native:eventhub/v20180101preview:ConsumerGroup is being removed in the next major version of this provider. Please upgrade to azure-native:eventhub/v20221001preview:ConsumerGroup to guarantee forwards compatibility.""")
    __args__ = dict()
