...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.eventhub.v20180101preview.PrivateEndpointConnection("privateEndpointConnection",
            namespace_name="sdk-Namespace-2924",
            private_endpoint=azure_native.eventhub.v20180101preview.PrivateEndpointArgs(
            ...
            private_link_service_connection_state=azure_native.eventhub.v20180101preview.ConnectionStateArgs(
                description="testing",
                status="Rejected",
            ),
    ...
    def _internal_init(__self__,
        ...
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:eventhub/v20180101preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
