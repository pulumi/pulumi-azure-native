...
def list_event_hub_keys(authorization_rule_name: Optional[builtins.str] = None,
...
def list_event_hub_keys_output(authorization_rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:eventhub:listEventHubKeys', __args__, opts=opts, typ=ListEventHubKeysResult)
