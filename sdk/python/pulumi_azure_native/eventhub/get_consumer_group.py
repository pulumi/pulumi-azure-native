...
def get_consumer_group(consumer_group_name: Optional[_builtins.str] = None,
                       event_hub_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str consumer_group_name: The consumer group name
...
def get_consumer_group_output(consumer_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
