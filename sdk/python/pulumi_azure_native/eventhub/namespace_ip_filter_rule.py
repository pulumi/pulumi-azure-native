...
class NamespaceIpFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:eventhub/v20180101preview:NamespaceIpFilterRule"), pulumi.Alias(type_="azure-native_eventhub_v20180101preview:eventhub:NamespaceIpFilterRule")])
