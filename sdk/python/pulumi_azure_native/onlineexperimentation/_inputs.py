...
class CustomerManagedKeyEncryptionArgsDict(TypedDict):
    ...
    """
    key_encryption_key_identity: NotRequired[pulumi.Input[Optional['KeyEncryptionKeyIdentityArgs']]]
    """
...
class OnlineExperimentationWorkspacePropertiesArgsDict(TypedDict):
    ...
    """
    encryption: NotRequired[pulumi.Input[Optional['ResourceEncryptionConfigurationArgs']]]
    """
...
class ResourceEncryptionConfigurationArgsDict(TypedDict):
    ...
    The encryption configuration for the online experimentation workspace resource.
    """
    customer_managed_key_encryption: NotRequired[pulumi.Input[Optional['CustomerManagedKeyEncryptionArgs']]]
    """
