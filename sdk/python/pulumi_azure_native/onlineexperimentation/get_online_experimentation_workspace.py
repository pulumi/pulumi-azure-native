...
def get_online_experimentation_workspace(resource_group_name: Optional[_builtins.str] = None,
...
def get_online_experimentation_workspace_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
