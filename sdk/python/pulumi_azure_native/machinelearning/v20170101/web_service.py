...
class WebService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:machinelearning:WebService"), pulumi.Alias(type_="azure-native:machinelearning/v20160501preview:WebService")])
