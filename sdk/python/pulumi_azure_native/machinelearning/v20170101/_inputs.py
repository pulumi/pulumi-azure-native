...
class AssetItemArgs:
    ...
    def _configure(
             ...
             location_info: Optional[pulumi.Input['BlobLocationArgs']] = None,
             name: Optional[pulumi.Input[str]] = None,
             type: Optional[pulumi.Input[Union[str, 'AssetType']]] = None,
             id: Optional[pulumi.Input[str]] = None,
             input_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input['InputPortArgs']]]] = None,
             metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
             output_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input['OutputPortArgs']]]] = None,
...
class ColumnSpecificationArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             type: Optional[pulumi.Input[Union[str, 'ColumnType']]] = None,
             enum: Optional[pulumi.Input[Sequence[Any]]] = None,
             format: Optional[pulumi.Input[Union[str, 'ColumnFormat']]] = None,
             x_ms_isnullable: Optional[pulumi.Input[bool]] = None,
             x_ms_isordered: Optional[pulumi.Input[bool]] = None,
...
class DiagnosticsConfigurationArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             level: Optional[pulumi.Input[Union[str, 'DiagnosticsLevel']]] = None,
             expiry: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if level is None:
...
class GraphParameterArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             links: Optional[pulumi.Input[Sequence[pulumi.Input['GraphParameterLinkArgs']]]] = None,
...
class ServiceInputOutputSpecificationArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             properties: Optional[pulumi.Input[Mapping[str, pulumi.Input['TableSpecificationArgs']]]] = None,
             type: Optional[pulumi.Input[str]] = None,
             description: Optional[pulumi.Input[str]] = None,
             title: Optional[pulumi.Input[str]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class WebServicePropertiesForGraphArgs:
    ...
    def _configure(
        ...
        if payloads_in_blob_storage is None and 'payloadsInBlobStorage' in kwargs:
            payloads_in_blob_storage = kwargs['payloadsInBlobStorage']
        if payloads_location is None and 'payloadsLocation' in kwargs:
