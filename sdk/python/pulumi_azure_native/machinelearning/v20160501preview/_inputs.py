...
if not MYPY:
    class AssetItemArgsDict(TypedDict):
        ...
        """
        location_info: pulumi.Input['AssetLocationArgsDict']
        """
...
if not MYPY:
    class AssetLocationArgsDict(TypedDict):
        """
    ...
    AssetLocationArgsDict: TypeAlias = Mapping[str, Any]
