...
warnings.warn("""Version 2016-05-01-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_web_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_service is deprecated: Version 2016-05-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
