...
class BlobLocationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BlobLocationResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            uri=uri,
...
class PlanQuantityResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'includedQuantityMeter' in kwargs:
            included_quantity_meter = kwargs['includedQuantityMeter']
        if 'overageMeter' in kwargs:
...
class WebServiceParameterResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        WebServiceParameterResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
