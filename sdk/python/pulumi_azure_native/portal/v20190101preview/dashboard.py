...
class Dashboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dashboard_name: Optional[pulumi.Input[str]] = None,
                 lenses: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union['DashboardLensArgs', 'DashboardLensArgsDict']]]]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[str] dashboard_name: The name of the dashboard.
        :param pulumi.Input[Mapping[str, pulumi.Input[Union['DashboardLensArgs', 'DashboardLensArgsDict']]]] lenses: The dashboard lenses.
        :param pulumi.Input[str] location: Resource location
        :param pulumi.Input[Mapping[str, Any]] metadata: The dashboard metadata.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20200901preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20221201preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20250401preview:Dashboard"), pulumi.Alias(type_="azure-native:portal:Dashboard")])
