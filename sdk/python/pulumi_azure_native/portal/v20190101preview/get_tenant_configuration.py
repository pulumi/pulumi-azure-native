...
def get_tenant_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20190101preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult).value
...
def get_tenant_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20190101preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult)
    return __ret__.apply(lambda __response__: GetTenantConfigurationResult(
        enforce_private_markdown_storage=pulumi.get(__response__, 'enforce_private_markdown_storage'),
