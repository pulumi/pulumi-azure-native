...
class TenantConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portal:TenantConfiguration"), pulumi.Alias(type_="azure-native:portal/v20200901preview:TenantConfiguration")])
