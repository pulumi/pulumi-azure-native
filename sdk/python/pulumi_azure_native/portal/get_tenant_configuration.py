...
def get_tenant_configuration(configuration_name: Optional[_builtins.str] = None,
...
def get_tenant_configuration_output(configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
