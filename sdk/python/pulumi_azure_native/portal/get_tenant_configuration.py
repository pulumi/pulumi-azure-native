...
def get_tenant_configuration(configuration_name: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_name: The name of the Configuration
    """
    __args__ = dict()
...
def get_tenant_configuration_output(configuration_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult)
