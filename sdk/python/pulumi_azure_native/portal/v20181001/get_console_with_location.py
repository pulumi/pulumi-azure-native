...
def get_console_with_location(console_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20181001:getConsoleWithLocation', __args__, opts=opts, typ=GetConsoleWithLocationResult).value
...
def get_console_with_location_output(console_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['location'] = location
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20181001:getConsoleWithLocation', __args__, opts=opts, typ=GetConsoleWithLocationResult)
