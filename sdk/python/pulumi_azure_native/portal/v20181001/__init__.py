...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:portal/v20181001:Console":
                return Console(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/v20181001:ConsoleWithLocation":
                return ConsoleWithLocation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/v20181001:UserSettings":
                return UserSettings(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/v20181001:UserSettingsWithLocation":
    ...
    pulumi.runtime.register_resource_module("azure-native", "portal/v20181001", _module_instance)
