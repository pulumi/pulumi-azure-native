...
def get_tenant_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20221201preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult).value
...
def get_tenant_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['configurationName'] = configuration_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20221201preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult)
