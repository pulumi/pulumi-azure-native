...
def get_dashboard(dashboard_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dashboard_name: The name of the dashboard.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal:getDashboard', __args__, opts=opts, typ=GetDashboardResult).value
