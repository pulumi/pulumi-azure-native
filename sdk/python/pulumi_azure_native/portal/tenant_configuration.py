...
class TenantConfigurationArgs:
    ...
    def _configure(
        ...
        if enforce_private_markdown_storage is None and 'enforcePrivateMarkdownStorage' in kwargs:
            enforce_private_markdown_storage = kwargs['enforcePrivateMarkdownStorage']
