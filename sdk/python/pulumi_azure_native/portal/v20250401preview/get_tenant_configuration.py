...
def get_tenant_configuration(configuration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20250401preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult).value
...
def get_tenant_configuration_output(configuration_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20250401preview:getTenantConfiguration', __args__, opts=opts, typ=GetTenantConfigurationResult)
