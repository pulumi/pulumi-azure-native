...
def list_list_tenant_configuration_violation(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListListTenantConfigurationViolationResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20250401preview:listListTenantConfigurationViolation', __args__, opts=opts, typ=ListListTenantConfigurationViolationResult).value
...
def list_list_tenant_configuration_violation_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListListTenantConfigurationViolationResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20250401preview:listListTenantConfigurationViolation', __args__, opts=opts, typ=ListListTenantConfigurationViolationResult)
