...
def get_dashboard(dashboard_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/v20250401preview:getDashboard', __args__, opts=opts, typ=GetDashboardResult).value
...
def get_dashboard_output(dashboard_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:portal/v20250401preview:getDashboard', __args__, opts=opts, typ=GetDashboardResult)
