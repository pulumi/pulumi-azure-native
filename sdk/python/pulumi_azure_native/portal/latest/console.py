...
class Console(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portal:Console"), pulumi.Alias(type_="azure-nextgen:portal:Console"), pulumi.Alias(type_="azure-native:portal/v20181001:Console"), pulumi.Alias(type_="azure-nextgen:portal/v20181001:Console")])
