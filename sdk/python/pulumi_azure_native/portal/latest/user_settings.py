...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:portal:UserSettings'.""", DeprecationWarning)
...
class UserSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""UserSettings is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:portal:UserSettings'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal/latest:UserSettings"), pulumi.Alias(type_="azure-native:portal:UserSettings"), pulumi.Alias(type_="azure-nextgen:portal:UserSettings"), pulumi.Alias(type_="azure-native:portal/v20181001:UserSettings"), pulumi.Alias(type_="azure-nextgen:portal/v20181001:UserSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserSettings, __self__).__init__(
            'azure-native:portal/latest:UserSettings',
            resource_name,
            __props__,
            opts)
