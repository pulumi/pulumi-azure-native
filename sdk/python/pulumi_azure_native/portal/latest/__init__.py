...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:portal/latest:Console":
                return Console(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/latest:ConsoleWithLocation":
                return ConsoleWithLocation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/latest:UserSettings":
                return UserSettings(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:portal/latest:UserSettingsWithLocation":
    ...
    pulumi.runtime.register_resource_module("azure-native", "portal/latest", _module_instance)
