...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:portal:UserSettingsWithLocation'.""", DeprecationWarning)
...
class UserSettingsWithLocation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal/latest:UserSettingsWithLocation"), pulumi.Alias(type_="azure-native:portal:UserSettingsWithLocation"), pulumi.Alias(type_="azure-nextgen:portal:UserSettingsWithLocation"), pulumi.Alias(type_="azure-native:portal/v20181001:UserSettingsWithLocation"), pulumi.Alias(type_="azure-nextgen:portal/v20181001:UserSettingsWithLocation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserSettingsWithLocation, __self__).__init__(
            'azure-native:portal/latest:UserSettingsWithLocation',
            resource_name,
            __props__,
            opts)
