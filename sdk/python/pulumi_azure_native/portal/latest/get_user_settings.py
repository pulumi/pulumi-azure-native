...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:portal:getUserSettings'.""", DeprecationWarning)
...
def get_user_settings(user_settings_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/latest:getUserSettings', __args__, opts=opts, typ=GetUserSettingsResult).value
