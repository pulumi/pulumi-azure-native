...
class DashboardArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['DashboardPropertiesWithProvisioningStateArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['DashboardPropertiesWithProvisioningStateArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['DashboardPropertiesWithProvisioningStateArgs']]):
...
class Dashboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dashboard_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['DashboardPropertiesWithProvisioningStateArgs', 'DashboardPropertiesWithProvisioningStateArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20190101preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20200901preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20221201preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20250401preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20260401:Dashboard")])
