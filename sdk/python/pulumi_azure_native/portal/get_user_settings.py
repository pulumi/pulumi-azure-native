...
def get_user_settings(user_settings_name: Optional[_builtins.str] = None,
...
def get_user_settings_output(user_settings_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
