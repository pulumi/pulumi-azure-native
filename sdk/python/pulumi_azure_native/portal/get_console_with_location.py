...
def get_console_with_location(console_name: Optional[_builtins.str] = None,
...
def get_console_with_location_output(console_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
