...
class Extension(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        extension = azure_native.visualstudio.v20140401preview.Extension("extension",
            account_resource_name="ExampleAccount",
            extension_resource_name="ms.example",
            location="Central US",
            plan=azure_native.visualstudio.v20140401preview.ExtensionResourcePlanArgs(
                name="ExamplePlan",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:visualstudio:Extension"), pulumi.Alias(type_="azure-native:visualstudio/v20171101preview:Extension")])
