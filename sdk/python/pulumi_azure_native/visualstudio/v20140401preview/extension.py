...
class Extension(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:visualstudio:Extension"), pulumi.Alias(type_="azure-nextgen:visualstudio:Extension"), pulumi.Alias(type_="azure-native:visualstudio/v20171101preview:Extension"), pulumi.Alias(type_="azure-nextgen:visualstudio/v20171101preview:Extension")])
