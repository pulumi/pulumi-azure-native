...
def get_extension(account_resource_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:visualstudio/v20140401preview:getExtension', __args__, opts=opts, typ=GetExtensionResult).value
...
def get_extension_output(account_resource_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:visualstudio/v20140401preview:getExtension', __args__, opts=opts, typ=GetExtensionResult)
