...
class ExtensionArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if account_resource_name is None and 'accountResourceName' in kwargs:
            account_resource_name = kwargs['accountResourceName']
        if account_resource_name is None:
            raise TypeError("Missing 'account_resource_name' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if extension_resource_name is None and 'extensionResourceName' in kwargs:
            extension_resource_name = kwargs['extensionResourceName']
...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            plan = _utilities.configure(plan, ExtensionResourcePlanArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:visualstudio/v20140401preview:Extension"), pulumi.Alias(type_="azure-native:visualstudio/v20171101preview:Extension")])
