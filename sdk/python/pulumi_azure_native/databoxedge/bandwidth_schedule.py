...
class BandwidthScheduleArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DayOfWeek']]]],
                 device_name: pulumi.Input[builtins.str],
                 rate_in_mbps: pulumi.Input[builtins.int],
                 resource_group_name: pulumi.Input[builtins.str],
                 start: pulumi.Input[builtins.str],
                 stop: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BandwidthSchedule resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DayOfWeek']]]] days: The days of the week when this schedule is applicable.
        :param pulumi.Input[builtins.str] device_name: The device name.
        :param pulumi.Input[builtins.int] rate_in_mbps: The bandwidth rate in Mbps.
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name.
        :param pulumi.Input[builtins.str] start: The start time of the schedule in UTC.
        :param pulumi.Input[builtins.str] stop: The stop time of the schedule in UTC.
        :param pulumi.Input[builtins.str] name: The bandwidth schedule name which needs to be added/updated.
        """
    ...
    @property
    @pulumi.getter
    def days(self) -> pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DayOfWeek']]]]:
        """
    ...
    @days.setter
    def days(self, value: pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DayOfWeek']]]]):
    ...
    def rate_in_mbps(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @rate_in_mbps.setter
    def rate_in_mbps(self, value: pulumi.Input[builtins.int]):
    ...
    @property
    @pulumi.getter
    def stop(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @stop.setter
    def stop(self, value: pulumi.Input[builtins.str]):
...
class BandwidthSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 days: Optional[pulumi.Input[Sequence[pulumi.Input[Union[builtins.str, 'DayOfWeek']]]]] = None,
                 device_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rate_in_mbps: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 start: Optional[pulumi.Input[builtins.str]] = None,
                 stop: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter
    def days(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The days of the week when this schedule is applicable.
        """
        return pulumi.get(self, "days")
    ...
    @property
    @pulumi.getter(name="rateInMbps")
    def rate_in_mbps(self) -> pulumi.Output[builtins.int]:
        """
        The bandwidth rate in Mbps.
        """
        return pulumi.get(self, "rate_in_mbps")
    ...
    @property
    @pulumi.getter
    def stop(self) -> pulumi.Output[builtins.str]:
        """
        The stop time of the schedule in UTC.
        """
        return pulumi.get(self, "stop")
