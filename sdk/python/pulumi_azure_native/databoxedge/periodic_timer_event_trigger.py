...
class PeriodicTimerEventTriggerArgs:
    def __init__(__self__, *,
                 ...
                 custom_context_tag: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PeriodicTimerEventTrigger resource.
        :param pulumi.Input[builtins.str] device_name: Creates or updates a trigger
        :param pulumi.Input[builtins.str] kind: Trigger Kind.
        ...
        :param pulumi.Input[builtins.str] custom_context_tag: A custom context tag typically used to correlate the trigger against its usage. For example, if a periodic timer trigger is intended for certain specific IoT modules in the device, the tag can be the name or the image URL of the module.
        :param pulumi.Input[builtins.str] name: The trigger name.
        """
    ...
    def custom_context_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_context_tag(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="customContextTag")
    def custom_context_tag(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A custom context tag typically used to correlate the trigger against its usage. For example, if a periodic timer trigger is intended for certain specific IoT modules in the device, the tag can be the name or the image URL of the module.
        """
        return pulumi.get(self, "custom_context_tag")
