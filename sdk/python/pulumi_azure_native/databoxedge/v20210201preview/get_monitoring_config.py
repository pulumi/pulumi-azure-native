...
warnings.warn("""azure-native:databoxedge/v20210201preview:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_monitoring_config(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitoring_config is deprecated: azure-native:databoxedge/v20210201preview:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['resourceGroupName'] = resource_group_name
    __args__['roleName'] = role_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210201preview:getMonitoringConfig', __args__, opts=opts, typ=GetMonitoringConfigResult).value
