...
warnings.warn("""azure-native:databoxedge/v20210201preview:Share is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.""", DeprecationWarning)
...
class Share(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_access_rights: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['UserAccessRightArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Share is deprecated: azure-native:databoxedge/v20210201preview:Share is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.""")
