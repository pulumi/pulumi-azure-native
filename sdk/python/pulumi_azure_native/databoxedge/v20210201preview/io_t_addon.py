...
class IoTAddon(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_addon = azure_native.databoxedge.v20210201preview.IoTAddon("ioTAddon",
            addon_name="arcName",
        ...
        ```sh
        $ pulumi import azure-native:databoxedge/v20210201preview:IoTAddon arcName /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourcegroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/addonExamples/roles/kubernetesRole/addons/arcName 
        ```
