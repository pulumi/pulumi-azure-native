...
class IoTRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_role = azure_native.databoxedge.v20210201preview.IoTRole("ioTRole",
            device_name="testedgedevice",
            host_platform="Linux",
            io_t_device_details=azure_native.databoxedge.v20210201preview.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20210201preview.AsymmetricEncryptedSecretArgs(
            ...
            io_t_edge_device_details=azure_native.databoxedge.v20210201preview.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20210201preview.AsymmetricEncryptedSecretArgs(
                            encryption_algorithm="AES256",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:IoTRole")])
