...
def get_io_t_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_addon is deprecated: azure-native:databoxedge/v20210201preview:IoTAddon is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20220301:IoTAddon to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210201preview:getIoTAddon', __args__, opts=opts, typ=GetIoTAddonResult).value
