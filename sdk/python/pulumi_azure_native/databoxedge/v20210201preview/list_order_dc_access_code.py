...
def list_order_dc_access_code(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210201preview:listOrderDCAccessCode', __args__, opts=opts, typ=ListOrderDCAccessCodeResult).value
...
def list_order_dc_access_code_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20210201preview:listOrderDCAccessCode', __args__, opts=opts, typ=ListOrderDCAccessCodeResult)
