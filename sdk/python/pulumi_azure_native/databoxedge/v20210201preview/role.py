...
class Role(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:Role"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:Role")])
