...
class StorageAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:StorageAccount"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:StorageAccount")])
