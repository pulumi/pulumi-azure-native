...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:databoxedge/v20201201:Addon":
                return Addon(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:BandwidthSchedule":
                return BandwidthSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Container":
                return Container(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:MonitoringConfig":
                return MonitoringConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Order":
                return Order(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:Trigger":
                return Trigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20201201:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "databoxedge/v20201201", _module_instance)
