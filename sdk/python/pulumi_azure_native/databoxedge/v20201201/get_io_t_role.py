...
def get_io_t_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_role is deprecated: azure-native:databoxedge/v20201201:IoTRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""")
    __args__ = dict()
