...
warnings.warn("""azure-native:databoxedge/v20201201:IoTRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""", DeprecationWarning)
...
class IoTRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 share_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MountPointMapArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""IoTRole is deprecated: azure-native:databoxedge/v20201201:IoTRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""")
