...
def get_file_event_trigger(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_event_trigger is deprecated: azure-native:databoxedge/v20201201:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
