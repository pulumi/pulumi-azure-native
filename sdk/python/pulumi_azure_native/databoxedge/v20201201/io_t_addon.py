...
class IoTAddon(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_addon = azure_native.databoxedge.v20201201.IoTAddon("ioTAddon",
            addon_name="arcName",
