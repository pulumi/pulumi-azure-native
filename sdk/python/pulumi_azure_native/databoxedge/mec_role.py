...
class MECRoleArgs:
    ...
    def _configure(
        ...
        if 'controllerEndpoint' in kwargs:
            controller_endpoint = kwargs['controllerEndpoint']
        if 'resourceUniqueId' in kwargs:
            resource_unique_id = kwargs['resourceUniqueId']
        ...
        if controller_endpoint is not None:
            _setter("controller_endpoint", controller_endpoint)
        if name is not None:
            _setter("name", name)
        if resource_unique_id is not None:
            _setter("resource_unique_id", resource_unique_id)
...
class MECRole(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MECRoleArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if connection_string is not None and not isinstance(connection_string, AsymmetricEncryptedSecretArgs):
                connection_string = connection_string or {}
                def _setter(key, value):
                    connection_string[key] = value
                AsymmetricEncryptedSecretArgs._configure(_setter, **connection_string)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge/v20190301:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:MECRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230701:MECRole")])
