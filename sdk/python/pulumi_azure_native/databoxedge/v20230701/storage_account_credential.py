...
class StorageAccountCredentialArgs:
    ...
    def _configure(
        ...
        if ssl_status is None:
            raise TypeError("Missing 'ssl_status' argument")
        if account_key is None and 'accountKey' in kwargs:
            account_key = kwargs['accountKey']
        if blob_domain_name is None and 'blobDomainName' in kwargs:
...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            account_key = _utilities.configure(account_key, AsymmetricEncryptedSecretArgs, True)
