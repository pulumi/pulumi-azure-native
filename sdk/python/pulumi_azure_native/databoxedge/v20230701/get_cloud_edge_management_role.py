...
def get_cloud_edge_management_role(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20230701:getCloudEdgeManagementRole', __args__, opts=opts, typ=GetCloudEdgeManagementRoleResult).value
...
def get_cloud_edge_management_role_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20230701:getCloudEdgeManagementRole', __args__, opts=opts, typ=GetCloudEdgeManagementRoleResult)
