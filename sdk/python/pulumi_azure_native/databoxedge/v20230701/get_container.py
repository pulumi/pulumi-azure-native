...
def get_container(container_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20230701:getContainer', __args__, opts=opts, typ=GetContainerResult).value
...
def get_container_output(container_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageAccountName'] = storage_account_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20230701:getContainer', __args__, opts=opts, typ=GetContainerResult)
