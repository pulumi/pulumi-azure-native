...
class IoTRoleArgs:
    ...
    def _configure(
        ...
        if 'hostPlatform' in kwargs:
            host_platform = kwargs['hostPlatform']
        if 'ioTDeviceDetails' in kwargs:
            io_t_device_details = kwargs['ioTDeviceDetails']
        if 'ioTEdgeDeviceDetails' in kwargs:
        ...
        if 'ioTEdgeAgentInfo' in kwargs:
            io_t_edge_agent_info = kwargs['ioTEdgeAgentInfo']
        if 'shareMappings' in kwargs:
            share_mappings = kwargs['shareMappings']
...
class IoTRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if compute_resource is not None and not isinstance(compute_resource, ComputeResourceArgs):
            ...
            if io_t_device_details is not None and not isinstance(io_t_device_details, IoTDeviceInfoArgs):
            ...
            if io_t_edge_agent_info is not None and not isinstance(io_t_edge_agent_info, IoTEdgeAgentInfoArgs):
            ...
            if io_t_edge_device_details is not None and not isinstance(io_t_edge_device_details, IoTDeviceInfoArgs):
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:IoTRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:IoTRole")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IoTRole, __self__).__init__(
            'azure-native:databoxedge/v20230701:IoTRole',
            resource_name,
            __props__,
            opts)
