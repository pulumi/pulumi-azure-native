...
class IoTAddon(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge/v20200901:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge/v20231201:IoTAddon"), pulumi.Alias(type_="azure-native:databoxedge:IoTAddon")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IoTAddon, __self__).__init__(
            'azure-native:databoxedge/v20230701:IoTAddon',
            resource_name,
            __props__,
            opts)
