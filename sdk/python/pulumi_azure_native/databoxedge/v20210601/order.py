...
class Order(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 shipping_address: Optional[pulumi.Input[pulumi.InputType['AddressArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Order is deprecated: azure-native:databoxedge/v20210601:Order is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20220401preview:Order to guarantee forwards compatibility.""")
