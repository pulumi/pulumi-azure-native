...
def get_cloud_edge_management_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_edge_management_role is deprecated: azure-native:databoxedge/v20210601:CloudEdgeManagementRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""")
    __args__ = dict()
