...
def get_user(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user is deprecated: azure-native:databoxedge/v20210601:User is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:User to guarantee forwards compatibility.""")
    __args__ = dict()
