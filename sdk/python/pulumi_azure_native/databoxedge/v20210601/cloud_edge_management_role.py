...
warnings.warn("""azure-native:databoxedge/v20210601:CloudEdgeManagementRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""", DeprecationWarning)
...
class CloudEdgeManagementRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole")])
