...
azure-native:databoxedge/v20190801:StorageAccountCredential is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_storage_account_credential(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account_credential is deprecated: Version 2019-08-01 will be removed in v2 of the provider.
azure-native:databoxedge/v20190801:StorageAccountCredential is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20190801:getStorageAccountCredential', __args__, opts=opts, typ=GetStorageAccountCredentialResult).value
