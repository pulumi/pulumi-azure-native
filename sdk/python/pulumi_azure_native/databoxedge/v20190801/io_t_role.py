...
class IoTRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_role = azure_native.databoxedge.v20190801.IoTRole("ioTRole",
            device_name="testedgedevice",
            host_platform="Linux",
            io_t_device_details=azure_native.databoxedge.v20190801.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20190801.AsymmetricEncryptedSecretArgs(
            ...
            io_t_edge_device_details=azure_native.databoxedge.v20190801.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20190801.AsymmetricEncryptedSecretArgs(
                            encryption_algorithm="AES256",
