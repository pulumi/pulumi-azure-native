...
def get_order(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_order is deprecated: Version v20190801 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20190801:getOrder', __args__, opts=opts, typ=GetOrderResult).value
