...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        periodic_timer_event_trigger = azure_native.databoxedge.v20190801.PeriodicTimerEventTrigger("periodicTimerEventTrigger",
