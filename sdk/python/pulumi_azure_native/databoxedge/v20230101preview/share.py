...
class Share(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        share = azure_native.databoxedge.v20230101preview.Share("share",
            access_protocol="SMB",
            azure_container_info=azure_native.databoxedge.v20230101preview.AzureContainerInfoResponseArgs(
