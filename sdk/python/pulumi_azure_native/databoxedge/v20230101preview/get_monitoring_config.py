...
def get_monitoring_config(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20230101preview:getMonitoringConfig', __args__, opts=opts, typ=GetMonitoringConfigResult).value
...
def get_monitoring_config_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['roleName'] = role_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20230101preview:getMonitoringConfig', __args__, opts=opts, typ=GetMonitoringConfigResult)
