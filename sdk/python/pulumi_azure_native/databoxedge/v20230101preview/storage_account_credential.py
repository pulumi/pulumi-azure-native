...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_account_credential = azure_native.databoxedge.v20230101preview.StorageAccountCredential("storageAccountCredential",
            account_key=azure_native.databoxedge.v20230101preview.AsymmetricEncryptedSecretResponseArgs(
