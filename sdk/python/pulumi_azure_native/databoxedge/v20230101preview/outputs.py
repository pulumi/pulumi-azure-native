...
class KubernetesRoleComputeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        KubernetesRoleComputeResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            huge_page1_g=huge_page1_g,
            huge_page2_m=huge_page2_m,
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             huge_page1_g: Optional[int] = None,
             huge_page2_m: Optional[int] = None,
             memory_in_bytes: Optional[float] = None,
             processor_count: Optional[int] = None,
             vm_profile: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if huge_page1_g is None and 'hugePage1G' in kwargs:
            huge_page1_g = kwargs['hugePage1G']
        if huge_page1_g is None:
            raise TypeError("Missing 'huge_page1_g' argument")
        if huge_page2_m is None and 'hugePage2M' in kwargs:
            huge_page2_m = kwargs['hugePage2M']
        if huge_page2_m is None:
            raise TypeError("Missing 'huge_page2_m' argument")
        ...
        _setter("huge_page1_g", huge_page1_g)
        _setter("huge_page2_m", huge_page2_m)
