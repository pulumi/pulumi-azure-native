...
class ArcAddonPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "customLocationsObjectId":
            suggest = "custom_locations_object_id"
        elif key == "hostPlatform":
    ...
    def __init__(__self__, *,
                 custom_locations_object_id: str,
                 host_platform: str,
        ...
        """
        Arc addon properties.
        :param str custom_locations_object_id: Arc Custom Locations ObjectId
