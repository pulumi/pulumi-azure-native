...
class PeriodicTimerEventTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        PeriodicTimerEventTriggerArgs._configure(
...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PeriodicTimerEventTriggerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if sink_info is not None and not isinstance(sink_info, RoleSinkInfoArgs):
                sink_info = sink_info or {}
                def _setter(key, value):
                    sink_info[key] = value
                RoleSinkInfoArgs._configure(_setter, **sink_info)
            ...
            if source_info is not None and not isinstance(source_info, PeriodicTimerSourceInfoArgs):
                source_info = source_info or {}
                def _setter(key, value):
                    source_info[key] = value
                PeriodicTimerSourceInfoArgs._configure(_setter, **source_info)
