...
class KubernetesRoleArgs:
    ...
    def _configure(
        ...
        if 'kubernetesClusterInfo' in kwargs:
            kubernetes_cluster_info = kwargs['kubernetesClusterInfo']
        if 'kubernetesRoleResources' in kwargs:
...
class KubernetesRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if kubernetes_cluster_info is not None and not isinstance(kubernetes_cluster_info, KubernetesClusterInfoArgs):
            ...
            if kubernetes_role_resources is not None and not isinstance(kubernetes_role_resources, KubernetesRoleResourcesArgs):
