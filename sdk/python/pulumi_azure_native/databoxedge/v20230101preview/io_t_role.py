...
class IoTRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_role = azure_native.databoxedge.v20230101preview.IoTRole("ioTRole",
            device_name="testedgedevice",
            host_platform="Linux",
            io_t_device_details=azure_native.databoxedge.v20230101preview.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20230101preview.AsymmetricEncryptedSecretArgs(
            ...
            io_t_edge_device_details=azure_native.databoxedge.v20230101preview.IoTDeviceInfoResponseArgs(
                authentication={
                    "symmetricKey": {
                        "connectionString": azure_native.databoxedge.v20230101preview.AsymmetricEncryptedSecretArgs(
                            encryption_algorithm="AES256",
