...
class Device(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        device = azure_native.databoxedge.v20220401preview.Device("device",
            device_name="testedgedevice",
            location="WUS",
            resource_group_name="GroupForEdgeAutomation",
            sku=azure_native.databoxedge.v20220401preview.SkuArgs(
                name="Edge",
                tier="Standard",
            ),
            tags={})
        ...
        device = azure_native.databoxedge.v20220401preview.Device("device",
            data_residency=azure_native.databoxedge.v20220401preview.DataResidencyArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:Device"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:Device")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Device, __self__).__init__(
            'azure-native:databoxedge/v20220401preview:Device',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def identity(self) -> pulumi.Output['outputs.ResourceIdentityResponse']:
        """
