...
class OrderArgs:
    ...
    def contact_information(self) -> Optional[pulumi.Input['ContactDetailsArgs']]:
        """
        The contact details.
        """
    ...
    def contact_information(self, value: Optional[pulumi.Input['ContactDetailsArgs']]):
...
class Order(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        order = azure_native.databoxedge.v20220401preview.Order("order",
            contact_information=azure_native.databoxedge.v20220401preview.ContactDetailsResponseArgs(
            ...
            shipping_address=azure_native.databoxedge.v20220401preview.AddressResponseArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:Order"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:Order")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Order, __self__).__init__(
            'azure-native:databoxedge/v20220401preview:Order',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="contactInformation")
    def contact_information(self) -> pulumi.Output[Optional['outputs.ContactDetailsResponse']]:
        """
        The contact details.
        """
        return pulumi.get(self, "contact_information")
