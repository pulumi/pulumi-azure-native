...
class CloudEdgeManagementRole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cloud_edge_management_role = azure_native.databoxedge.v20220401preview.CloudEdgeManagementRole("cloudEdgeManagementRole",
