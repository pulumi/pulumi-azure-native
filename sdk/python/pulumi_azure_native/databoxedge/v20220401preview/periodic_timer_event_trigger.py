...
warnings.warn("""azure-native:databoxedge/v20220401preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.""", DeprecationWarning)
