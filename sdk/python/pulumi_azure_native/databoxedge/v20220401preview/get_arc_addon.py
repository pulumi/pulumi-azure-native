...
def get_arc_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_arc_addon is deprecated: azure-native:databoxedge/v20220401preview:ArcAddon is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20220401preview:getArcAddon', __args__, opts=opts, typ=GetArcAddonResult).value
