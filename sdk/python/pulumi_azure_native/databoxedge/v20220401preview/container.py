...
warnings.warn("""azure-native:databoxedge/v20220401preview:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""", DeprecationWarning)
...
class Container(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 storage_account_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Container is deprecated: azure-native:databoxedge/v20220401preview:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""")
