...
warnings.warn("""azure-native:databoxedge/v20220401preview:MonitoringConfig is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
class MonitoringConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 role_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MonitoringConfig is deprecated: azure-native:databoxedge/v20220401preview:MonitoringConfig is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""")
