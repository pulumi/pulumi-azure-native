...
def get_mec_role(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210601preview:getMECRole', __args__, opts=opts, typ=GetMECRoleResult).value
...
def get_mec_role_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20210601preview:getMECRole', __args__, opts=opts, typ=GetMECRoleResult)
