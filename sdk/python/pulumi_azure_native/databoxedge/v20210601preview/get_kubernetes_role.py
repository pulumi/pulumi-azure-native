...
def get_kubernetes_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kubernetes_role is deprecated: azure-native:databoxedge/v20210601preview:KubernetesRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.""")
    __args__ = dict()
