...
warnings.warn("""azure-native:databoxedge/v20210601preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_periodic_timer_event_trigger(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_periodic_timer_event_trigger is deprecated: azure-native:databoxedge/v20210601preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
