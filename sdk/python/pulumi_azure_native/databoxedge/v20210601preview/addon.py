...
class Addon(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:Addon")])
