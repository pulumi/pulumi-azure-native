...
def get_io_t_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_role is deprecated: azure-native:databoxedge/v20210601preview:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210601preview:getIoTRole', __args__, opts=opts, typ=GetIoTRoleResult).value
