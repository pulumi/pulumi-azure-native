...
class FileEventTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_info: Optional[pulumi.Input[pulumi.InputType['FileSourceInfoArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""FileEventTrigger is deprecated: azure-native:databoxedge/v20210601preview:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""")
