...
warnings.warn("""azure-native:databoxedge/v20210601preview:Device is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20220401preview:Device to guarantee forwards compatibility.""", DeprecationWarning)
