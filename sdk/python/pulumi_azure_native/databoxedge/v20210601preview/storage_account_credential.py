...
warnings.warn("""azure-native:databoxedge/v20210601preview:StorageAccountCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.""", DeprecationWarning)
...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""StorageAccountCredential is deprecated: azure-native:databoxedge/v20210601preview:StorageAccountCredential is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:StorageAccountCredential to guarantee forwards compatibility.""")
