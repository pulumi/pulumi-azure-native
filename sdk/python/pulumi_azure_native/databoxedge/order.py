...
class OrderArgs:
    def __init__(__self__, *,
                 ...
                 shipment_type: Optional[pulumi.Input[Union[builtins.str, 'ShipmentType']]] = None,
        ...
        :param pulumi.Input[builtins.str] device_name: The order details of a device.
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name.
        :param pulumi.Input[Union[builtins.str, 'ShipmentType']] shipment_type: ShipmentType of the order
    ...
    def shipment_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'ShipmentType']]]:
        """
    ...
    def shipment_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'ShipmentType']]]):
...
class Order(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="shipmentType")
    def shipment_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ShipmentType of the order
        """
        return pulumi.get(self, "shipment_type")
