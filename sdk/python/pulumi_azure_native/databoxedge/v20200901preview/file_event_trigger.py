...
warnings.warn("""azure-native:databoxedge/v20200901preview:FileEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""", DeprecationWarning)
