...
class IoTAddon(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 role_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IoTAddon is deprecated: azure-native:databoxedge/v20200901preview:IoTAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20220301:IoTAddon to guarantee forwards compatibility.""")
