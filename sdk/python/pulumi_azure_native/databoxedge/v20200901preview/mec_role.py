...
class MECRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 role_status: Optional[pulumi.Input[Union[str, 'RoleStatus']]] = None,
                 __props__=None):
        pulumi.log.warn("""MECRole is deprecated: azure-native:databoxedge/v20200901preview:MECRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:MECRole to guarantee forwards compatibility.""")
