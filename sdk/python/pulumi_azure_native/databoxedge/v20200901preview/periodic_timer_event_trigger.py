...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        periodic_timer_event_trigger = azure_native.databoxedge.v20200901preview.PeriodicTimerEventTrigger("periodicTimerEventTrigger",
        ...
        ```sh
        $ pulumi import azure-native:databoxedge/v20200901preview:PeriodicTimerEventTrigger trigger1 /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/triggers/trigger1 
        ```
