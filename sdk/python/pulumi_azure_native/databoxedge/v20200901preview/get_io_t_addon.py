...
def get_io_t_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_addon is deprecated: azure-native:databoxedge/v20200901preview:IoTAddon is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20220301:IoTAddon to guarantee forwards compatibility.""")
    __args__ = dict()
