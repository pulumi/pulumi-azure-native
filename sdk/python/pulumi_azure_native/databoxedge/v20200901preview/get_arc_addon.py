...
def get_arc_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_arc_addon is deprecated: azure-native:databoxedge/v20200901preview:ArcAddon is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:ArcAddon to guarantee forwards compatibility.""")
    __args__ = dict()
