...
azure-native:databoxedge/v20200901preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20210201preview:User to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:databoxedge/v20200901preview:User is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20210201preview:User to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200901preview:getUser', __args__, opts=opts, typ=GetUserResult).value
