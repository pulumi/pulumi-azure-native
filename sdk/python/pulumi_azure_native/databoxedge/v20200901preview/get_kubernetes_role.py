...
warnings.warn("""azure-native:databoxedge/v20200901preview:KubernetesRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_kubernetes_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kubernetes_role is deprecated: azure-native:databoxedge/v20200901preview:KubernetesRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:KubernetesRole to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200901preview:getKubernetesRole', __args__, opts=opts, typ=GetKubernetesRoleResult).value
