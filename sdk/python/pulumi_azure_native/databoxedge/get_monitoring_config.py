...
def get_monitoring_config(device_name: Optional[_builtins.str] = None,
...
def get_monitoring_config_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
