...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge/v20201201:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:Trigger"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:Trigger")])
