...
class StorageAccountCredentialArgs:
    def __init__(__self__, *,
                 ...
                 ssl_status: pulumi.Input[Union[builtins.str, 'SSLStatus']],
                 account_key: Optional[pulumi.Input['AsymmetricEncryptedSecretArgs']] = None,
                 blob_domain_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'AccountType']] account_type: Type of storage accessed on the storage account.
        :param pulumi.Input[builtins.str] alias: Alias for the storage account.
        ...
        :param pulumi.Input[Union[builtins.str, 'SSLStatus']] ssl_status: Signifies whether SSL needs to be enabled or not.
        :param pulumi.Input['AsymmetricEncryptedSecretArgs'] account_key: Encrypted storage key.
        :param pulumi.Input[builtins.str] blob_domain_name: Blob end point for private clouds.
        :param pulumi.Input[builtins.str] connection_string: Connection string for the storage account. Use this string if username and account key are not specified.
        :param pulumi.Input[builtins.str] name: The storage account credential name.
        :param pulumi.Input[builtins.str] storage_account_id: Id of the storage account.
        :param pulumi.Input[builtins.str] user_name: Username for the storage account.
        """
    ...
    def ssl_status(self) -> pulumi.Input[Union[builtins.str, 'SSLStatus']]:
        """
    ...
    @ssl_status.setter
    def ssl_status(self, value: pulumi.Input[Union[builtins.str, 'SSLStatus']]):
    ...
    def blob_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ssl_status: Optional[pulumi.Input[Union[builtins.str, 'SSLStatus']]] = None,
                 storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="blobDomainName")
    def blob_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Blob end point for private clouds.
        """
        return pulumi.get(self, "blob_domain_name")
