...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getShare'.""", DeprecationWarning)
...
def get_share(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getShare', __args__, opts=opts, typ=GetShareResult).value
