...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getDevice'.""", DeprecationWarning)
...
def get_device(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getDevice'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getDevice', __args__, opts=opts, typ=GetDeviceResult).value
