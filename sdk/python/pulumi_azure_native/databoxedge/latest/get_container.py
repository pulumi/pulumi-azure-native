...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getContainer'.""", DeprecationWarning)
...
def get_container(container_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getContainer', __args__, opts=opts, typ=GetContainerResult).value
