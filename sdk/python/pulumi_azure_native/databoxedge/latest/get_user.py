...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getUser'.""", DeprecationWarning)
...
def get_user(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getUser', __args__, opts=opts, typ=GetUserResult).value
