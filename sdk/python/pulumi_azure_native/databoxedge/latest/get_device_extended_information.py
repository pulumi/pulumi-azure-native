...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getDeviceExtendedInformation'.""", DeprecationWarning)
...
def get_device_extended_information(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device_extended_information is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getDeviceExtendedInformation'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getDeviceExtendedInformation', __args__, opts=opts, typ=GetDeviceExtendedInformationResult).value
