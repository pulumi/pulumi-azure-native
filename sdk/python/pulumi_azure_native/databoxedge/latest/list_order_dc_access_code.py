...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:listOrderDCAccessCode'.""", DeprecationWarning)
...
def list_order_dc_access_code(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_order_dc_access_code is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:listOrderDCAccessCode'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:listOrderDCAccessCode', __args__, opts=opts, typ=ListOrderDCAccessCodeResult).value
