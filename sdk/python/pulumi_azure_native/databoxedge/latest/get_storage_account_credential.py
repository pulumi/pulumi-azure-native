...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getStorageAccountCredential'.""", DeprecationWarning)
...
def get_storage_account_credential(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account_credential is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getStorageAccountCredential'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getStorageAccountCredential', __args__, opts=opts, typ=GetStorageAccountCredentialResult).value
