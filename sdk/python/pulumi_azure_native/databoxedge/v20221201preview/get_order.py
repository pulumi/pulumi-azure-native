...
warnings.warn("""azure-native:databoxedge/v20221201preview:Order is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Order to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_order(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_order is deprecated: azure-native:databoxedge/v20221201preview:Order is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Order to guarantee forwards compatibility.""")
    __args__ = dict()
