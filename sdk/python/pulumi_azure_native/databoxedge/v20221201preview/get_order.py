...
warnings.warn("""azure-native:databoxedge/v20221201preview:Order is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Order to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_order(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_order is deprecated: azure-native:databoxedge/v20221201preview:Order is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Order to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20221201preview:getOrder', __args__, opts=opts, typ=GetOrderResult).value
