...
def get_marketplace_image_sas_token_sas_token(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20221201preview:getMarketplaceImageSasTokenSASToken', __args__, opts=opts, typ=GetMarketplaceImageSasTokenSASTokenResult).value
...
def get_marketplace_image_sas_token_sas_token_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20221201preview:getMarketplaceImageSasTokenSASToken', __args__, opts=opts, typ=GetMarketplaceImageSasTokenSASTokenResult)
