...
warnings.warn("""azure-native:databoxedge/v20221201preview:Device is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Device to guarantee forwards compatibility.""", DeprecationWarning)
...
class Device(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Device is deprecated: azure-native:databoxedge/v20221201preview:Device is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Device to guarantee forwards compatibility.""")
