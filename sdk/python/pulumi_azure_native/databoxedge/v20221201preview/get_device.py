...
def get_device(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device is deprecated: azure-native:databoxedge/v20221201preview:Device is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Device to guarantee forwards compatibility.""")
    __args__ = dict()
