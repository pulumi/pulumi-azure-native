...
def get_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_addon is deprecated: Please use one of the variants: ArcAddon.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20221201preview:getAddon', __args__, opts=opts, typ=GetAddonResult).value
