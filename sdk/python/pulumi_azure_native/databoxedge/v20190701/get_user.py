...
def get_user(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user is deprecated: Version v20190701 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
