...
def get_device(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device is deprecated: Version 2019-07-01 will be removed in v2 of the provider.
azure-native:databoxedge/v20190701:Device is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20200501preview:Device to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20190701:getDevice', __args__, opts=opts, typ=GetDeviceResult).value
