...
def get_file_event_trigger(device_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The trigger name.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge:getFileEventTrigger', __args__, opts=opts, typ=GetFileEventTriggerResult).value
...
def get_file_event_trigger_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
