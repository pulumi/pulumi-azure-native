...
def get_file_event_trigger(device_name: Optional[builtins.str] = None,
...
def get_file_event_trigger_output(device_name: Optional[pulumi.Input[builtins.str]] = None,
