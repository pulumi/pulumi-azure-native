...
def get_share(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share is deprecated: azure-native:databoxedge/v20210201:Share is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Share to guarantee forwards compatibility.""")
    __args__ = dict()
