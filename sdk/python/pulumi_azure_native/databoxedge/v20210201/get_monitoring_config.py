...
warnings.warn("""azure-native:databoxedge/v20210201:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_monitoring_config(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitoring_config is deprecated: azure-native:databoxedge/v20210201:MonitoringConfig is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:MonitoringConfig to guarantee forwards compatibility.""")
    __args__ = dict()
