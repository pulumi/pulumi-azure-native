...
warnings.warn("""azure-native:databoxedge/v20210201:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""", DeprecationWarning)
...
class CloudEdgeManagementRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 role_status: Optional[pulumi.Input[Union[str, 'RoleStatus']]] = None,
                 __props__=None):
        pulumi.log.warn("""CloudEdgeManagementRole is deprecated: azure-native:databoxedge/v20210201:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:CloudEdgeManagementRole"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole")])
