...
warnings.warn("""azure-native:databoxedge/v20210201:FileEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""", DeprecationWarning)
...
class FileEventTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_info: Optional[pulumi.Input[pulumi.InputType['FileSourceInfoArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""FileEventTrigger is deprecated: azure-native:databoxedge/v20210201:FileEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20220301:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:FileEventTrigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileEventTrigger, __self__).__init__(
            'azure-native:databoxedge/v20210201:FileEventTrigger',
            resource_name,
            __props__,
            opts)
