...
warnings.warn("""azure-native:databoxedge/v20210201:Container is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container is deprecated: azure-native:databoxedge/v20210201:Container is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20210201:getContainer', __args__, opts=opts, typ=GetContainerResult).value
