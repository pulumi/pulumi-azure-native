...
class IoTAddon(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        io_t_addon = azure_native.databoxedge.v20210201.IoTAddon("ioTAddon",
            addon_name="arcName",
