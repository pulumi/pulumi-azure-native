...
class FileEventTrigger(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        file_event_trigger = azure_native.databoxedge.v20200901.FileEventTrigger("fileEventTrigger",
            custom_context_tag="CustomContextTags-1235346475",
            device_name="testedgedevice",
            kind="FileEvent",
            name="trigger1",
            resource_group_name="GroupForEdgeAutomation",
            sink_info=azure_native.databoxedge.v20200901.RoleSinkInfoArgs(
            ...
            source_info=azure_native.databoxedge.v20200901.FileSourceInfoArgs(
