...
azure-native:databoxedge/v20200901:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_container(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container is deprecated: Version 2020-09-01 will be removed in v2 of the provider.
azure-native:databoxedge/v20200901:Container is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:Container to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200901:getContainer', __args__, opts=opts, typ=GetContainerResult).value
