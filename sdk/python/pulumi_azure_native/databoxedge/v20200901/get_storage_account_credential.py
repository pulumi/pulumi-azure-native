...
def get_storage_account_credential(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_storage_account_credential is deprecated: Version v20200901 will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
