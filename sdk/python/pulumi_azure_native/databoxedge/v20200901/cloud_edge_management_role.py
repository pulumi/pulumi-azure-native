...
warnings.warn("""azure-native:databoxedge/v20200901:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""", DeprecationWarning)
...
class CloudEdgeManagementRole(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 role_status: Optional[pulumi.Input[Union[str, 'RoleStatus']]] = None,
                 __props__=None):
        pulumi.log.warn("""CloudEdgeManagementRole is deprecated: azure-native:databoxedge/v20200901:CloudEdgeManagementRole is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:CloudEdgeManagementRole to guarantee forwards compatibility.""")
