...
def get_periodic_timer_event_trigger(device_name: Optional[_builtins.str] = None,
...
def get_periodic_timer_event_trigger_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
