...
warnings.warn("""azure-native:databoxedge/v20220301:User is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:User to guarantee forwards compatibility.""", DeprecationWarning)
...
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_type: Optional[pulumi.Input[Union[str, 'UserType']]] = None,
                 __props__=None):
        pulumi.log.warn("""User is deprecated: azure-native:databoxedge/v20220301:User is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:User to guarantee forwards compatibility.""")
