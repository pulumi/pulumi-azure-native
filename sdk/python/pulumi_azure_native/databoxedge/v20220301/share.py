...
class Share(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if azure_container_info is not None and not isinstance(azure_container_info, AzureContainerInfoArgs):
            ...
            if refresh_details is not None and not isinstance(refresh_details, RefreshDetailsArgs):
