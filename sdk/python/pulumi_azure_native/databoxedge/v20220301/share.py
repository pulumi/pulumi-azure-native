...
class ShareArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if access_protocol is None and 'accessProtocol' in kwargs:
            access_protocol = kwargs['accessProtocol']
        if access_protocol is None:
            raise TypeError("Missing 'access_protocol' argument")
        ...
        if share_status is None:
            raise TypeError("Missing 'share_status' argument")
        if azure_container_info is None and 'azureContainerInfo' in kwargs:
            azure_container_info = kwargs['azureContainerInfo']
        if client_access_rights is None and 'clientAccessRights' in kwargs:
            client_access_rights = kwargs['clientAccessRights']
        if data_policy is None and 'dataPolicy' in kwargs:
            data_policy = kwargs['dataPolicy']
        if refresh_details is None and 'refreshDetails' in kwargs:
            refresh_details = kwargs['refreshDetails']
        if user_access_rights is None and 'userAccessRights' in kwargs:
            user_access_rights = kwargs['userAccessRights']
...
class Share(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            azure_container_info = _utilities.configure(azure_container_info, AzureContainerInfoArgs, True)
            ...
            refresh_details = _utilities.configure(refresh_details, RefreshDetailsArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:databoxedge:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20210201:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20210601:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20210601preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20220401preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20221201preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20230101preview:Share"), pulumi.Alias(type_="azure-native:databoxedge/v20230701:Share")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Share, __self__).__init__(
            'azure-native:databoxedge/v20220301:Share',
            resource_name,
            __props__,
            opts)
