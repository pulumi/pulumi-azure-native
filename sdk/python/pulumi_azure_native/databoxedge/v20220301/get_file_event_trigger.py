...
def get_file_event_trigger(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_event_trigger is deprecated: azure-native:databoxedge/v20220301:FileEventTrigger is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:FileEventTrigger to guarantee forwards compatibility.""")
    __args__ = dict()
