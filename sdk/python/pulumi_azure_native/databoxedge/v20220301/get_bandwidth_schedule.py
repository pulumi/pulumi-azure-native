...
warnings.warn("""azure-native:databoxedge/v20220301:BandwidthSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:BandwidthSchedule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_bandwidth_schedule(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bandwidth_schedule is deprecated: azure-native:databoxedge/v20220301:BandwidthSchedule is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:BandwidthSchedule to guarantee forwards compatibility.""")
    __args__ = dict()
