...
warnings.warn("""azure-native:databoxedge/v20200501preview:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetIoTRoleResult:
    ...
    Compute role.
    """
    def __init__(__self__, host_platform=None, host_platform_type=None, id=None, io_t_device_details=None, io_t_edge_agent_info=None, io_t_edge_device_details=None, kind=None, name=None, role_status=None, share_mappings=None, type=None):
...
def get_io_t_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_role is deprecated: azure-native:databoxedge/v20200501preview:IoTRole is being removed in the next major version of this provider. Upgrade to at least azure-native:databoxedge/v20230101preview:IoTRole to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200501preview:getIoTRole', __args__, opts=opts, typ=GetIoTRoleResult).value
