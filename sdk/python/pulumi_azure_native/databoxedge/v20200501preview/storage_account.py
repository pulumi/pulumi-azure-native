...
class StorageAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_account = azure_native.databoxedge.v20200501preview.StorageAccount("storageAccount",
            data_policy="Cloud",
