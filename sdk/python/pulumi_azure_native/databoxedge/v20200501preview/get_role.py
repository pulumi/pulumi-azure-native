...
def get_role(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_role is deprecated: Version 2020-05-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    __args__['deviceName'] = device_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200501preview:getRole', __args__, opts=opts, typ=GetRoleResult).value
