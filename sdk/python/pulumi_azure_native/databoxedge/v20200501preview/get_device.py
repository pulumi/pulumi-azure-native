...
def get_device(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_device is deprecated: Version v20200501preview will be removed in the next major version of the provider. Upgrade to version v20201201 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200501preview:getDevice', __args__, opts=opts, typ=GetDeviceResult).value
