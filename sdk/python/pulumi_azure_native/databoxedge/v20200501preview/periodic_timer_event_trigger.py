...
warnings.warn("""azure-native:databoxedge/v20200501preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.""", DeprecationWarning)
...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 source_info: Optional[pulumi.Input[pulumi.InputType['PeriodicTimerSourceInfoArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""PeriodicTimerEventTrigger is deprecated: azure-native:databoxedge/v20200501preview:PeriodicTimerEventTrigger is being removed in the next major version of this provider. Please upgrade to azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger to guarantee forwards compatibility.""")
