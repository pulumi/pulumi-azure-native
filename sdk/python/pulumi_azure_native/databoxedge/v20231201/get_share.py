...
def get_share(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20231201:getShare', __args__, opts=opts, typ=GetShareResult).value
...
def get_share_output(device_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20231201:getShare', __args__, opts=opts, typ=GetShareResult)
