...
def get_arc_addon(addon_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20231201:getArcAddon', __args__, opts=opts, typ=GetArcAddonResult).value
...
def get_arc_addon_output(addon_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['roleName'] = role_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databoxedge/v20231201:getArcAddon', __args__, opts=opts, typ=GetArcAddonResult)
