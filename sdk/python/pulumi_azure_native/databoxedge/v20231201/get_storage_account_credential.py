...
def get_storage_account_credential(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20231201:getStorageAccountCredential', __args__, opts=opts, typ=GetStorageAccountCredentialResult).value
