...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:management:getHierarchySetting'.""", DeprecationWarning)
...
def get_hierarchy_setting(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/latest:getHierarchySetting', __args__, opts=opts, typ=GetHierarchySettingResult).value
