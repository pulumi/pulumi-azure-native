...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:management:getManagementGroup'.""", DeprecationWarning)
...
def get_management_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/latest:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult).value
