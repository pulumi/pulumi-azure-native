...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:management:getManagementGroupSubscription'.""", DeprecationWarning)
...
def get_management_group_subscription(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/latest:getManagementGroupSubscription', __args__, opts=opts, typ=GetManagementGroupSubscriptionResult).value
