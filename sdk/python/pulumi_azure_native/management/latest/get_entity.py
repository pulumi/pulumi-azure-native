...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:management:getEntity'.""", DeprecationWarning)
...
def get_entity(filter: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/latest:getEntity', __args__, opts=opts, typ=GetEntityResult).value
