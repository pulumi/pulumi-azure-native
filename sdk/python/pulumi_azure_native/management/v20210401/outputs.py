...
class ManagementGroupDetailsResponse(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if management_group_ancestors is None and 'managementGroupAncestors' in kwargs:
            management_group_ancestors = kwargs['managementGroupAncestors']
        if management_group_ancestors_chain is None and 'managementGroupAncestorsChain' in kwargs:
            management_group_ancestors_chain = kwargs['managementGroupAncestorsChain']
