...
def get_management_group_subscription(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20210401:getManagementGroupSubscription', __args__, opts=opts, typ=GetManagementGroupSubscriptionResult).value
...
def get_management_group_subscription_output(group_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['subscriptionId'] = subscription_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20210401:getManagementGroupSubscription', __args__, opts=opts, typ=GetManagementGroupSubscriptionResult)
