...
def get_hierarchy_setting(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20210401:getHierarchySetting', __args__, opts=opts, typ=GetHierarchySettingResult).value
...
def get_hierarchy_setting_output(group_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['groupId'] = group_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20210401:getHierarchySetting', __args__, opts=opts, typ=GetHierarchySettingResult)
