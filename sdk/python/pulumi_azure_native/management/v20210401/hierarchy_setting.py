...
class HierarchySettingArgs:
    ...
    def _configure(
        ...
        if default_management_group is None and 'defaultManagementGroup' in kwargs:
            default_management_group = kwargs['defaultManagementGroup']
        if require_authorization_for_group_creation is None and 'requireAuthorizationForGroupCreation' in kwargs:
...
class HierarchySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:management:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200201:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200501:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20201001:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20230401:HierarchySetting")])
