...
class ManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_group = azure_native.management.v20200501.ManagementGroup("managementGroup",
            details=azure_native.management.v20200501.ManagementGroupDetailsResponseArgs(
                parent=azure_native.management.v20200501.CreateParentGroupInfoArgs(
