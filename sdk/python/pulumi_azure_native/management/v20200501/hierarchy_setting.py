...
class HierarchySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:management:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20210401:HierarchySetting")])
