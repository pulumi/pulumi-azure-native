...
class GetServiceGroupResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, kind=None, name=None, properties=None, system_data=None, tags=None, type=None):
...
def get_service_group(service_group_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management:getServiceGroup', __args__, opts=opts, typ=GetServiceGroupResult).value
...
def get_service_group_output(service_group_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:management:getServiceGroup', __args__, opts=opts, typ=GetServiceGroupResult)
