...
def get_management_group(expand: Optional[_builtins.str] = None,
                         filter: Optional[_builtins.str] = None,
                         group_id: Optional[_builtins.str] = None,
                         recurse: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool recurse: The $recurse=true query string parameter allows clients to request inclusion of entire hierarchy in the response payload. Note that  $expand=children must be passed up if $recurse is set to true.
    """
    __args__ = dict()
