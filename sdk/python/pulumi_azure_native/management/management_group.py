...
class ManagementGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The friendly name of the management group. If no value is passed then this  field will be set to the groupId.
        :param pulumi.Input[builtins.str] group_id: Management Group ID.
        :param pulumi.Input[builtins.str] name: The name of the management group. For example, 00000000-0000-0000-0000-000000000000
        """
