...
warnings.warn("""azure-native:management/v20201001:HierarchySetting is being removed in the next major version of this provider. Upgrade to at least azure-native:management/v20210401:HierarchySetting to guarantee forwards compatibility.""", DeprecationWarning)
...
class HierarchySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 require_authorization_for_group_creation: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        pulumi.log.warn("""HierarchySetting is deprecated: azure-native:management/v20201001:HierarchySetting is being removed in the next major version of this provider. Upgrade to at least azure-native:management/v20210401:HierarchySetting to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:management:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200201:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200501:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20210401:HierarchySetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HierarchySetting, __self__).__init__(
            'azure-native:management/v20201001:HierarchySetting',
            resource_name,
            __props__,
            opts)
