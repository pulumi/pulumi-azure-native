...
def get_management_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20201001:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult).value
...
def get_management_group_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20201001:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult)
