...
class ManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagementGroup is deprecated: azure-native:management/v20201001:ManagementGroup is being removed in the next major version of this provider. Please upgrade to azure-native:management/v20210401:ManagementGroup to guarantee forwards compatibility.""")
