...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:management/v20201001:HierarchySetting":
                return HierarchySetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:management/v20201001:ManagementGroup":
                return ManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:management/v20201001:ManagementGroupSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-native", "management/v20201001", _module_instance)
