...
def get_management_group_subscription_output(group_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20201001:getManagementGroupSubscription', __args__, opts=opts, typ=GetManagementGroupSubscriptionResult)
