...
warnings.warn("""Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200501 or later.""", DeprecationWarning)
...
def get_management_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_group is deprecated: Version v20191101 will be removed in the next major version of the provider. Upgrade to version v20200501 or later.""")
    __args__ = dict()
