...
def get_entity(filter: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20230401:getEntity', __args__, opts=opts, typ=GetEntityResult).value
...
def get_entity_output(filter: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['view'] = view
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20230401:getEntity', __args__, opts=opts, typ=GetEntityResult)
