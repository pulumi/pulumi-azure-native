...
def get_management_group_subscription(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20230401:getManagementGroupSubscription', __args__, opts=opts, typ=GetManagementGroupSubscriptionResult).value
