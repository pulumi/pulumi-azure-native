...
def get_management_group(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20230401:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult).value
...
def get_management_group_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['recurse'] = recurse
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:management/v20230401:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult)
