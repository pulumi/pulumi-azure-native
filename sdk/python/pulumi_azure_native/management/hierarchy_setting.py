...
class HierarchySettingArgs:
    def __init__(__self__, *,
                 ...
                 default_management_group: Optional[pulumi.Input[builtins.str]] = None,
                 require_authorization_for_group_creation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] default_management_group: Settings that sets the default Management Group under which new subscriptions get added in this tenant. For example, /providers/Microsoft.Management/managementGroups/defaultGroup
        :param pulumi.Input[builtins.bool] require_authorization_for_group_creation: Indicates whether RBAC access is required upon group creation under the root Management Group. If set to true, user will require Microsoft.Management/managementGroups/write action on the root Management Group scope in order to create new Groups directly under the root. This will prevent new users from creating new Management Groups, unless they are given access.
        """
    ...
    def default_management_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_management_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_management_group", value)

    @property
    @pulumi.getter(name="requireAuthorizationForGroupCreation")
    def require_authorization_for_group_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_authorization_for_group_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HierarchySetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:management/v20200201:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200501:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20201001:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20210401:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20230401:HierarchySetting")])
    ...
    @property
    @pulumi.getter(name="defaultManagementGroup")
    def default_management_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Settings that sets the default Management Group under which new subscriptions get added in this tenant. For example, /providers/Microsoft.Management/managementGroups/defaultGroup
        """
        return pulumi.get(self, "default_management_group")
    ...
    @property
    @pulumi.getter(name="requireAuthorizationForGroupCreation")
    def require_authorization_for_group_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether RBAC access is required upon group creation under the root Management Group. If set to true, user will require Microsoft.Management/managementGroups/write action on the root Management Group scope in order to create new Groups directly under the root. This will prevent new users from creating new Management Groups, unless they are given access.
        """
        return pulumi.get(self, "require_authorization_for_group_creation")
