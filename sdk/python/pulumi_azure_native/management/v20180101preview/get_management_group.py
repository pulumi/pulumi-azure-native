...
def get_management_group(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_management_group is deprecated: Version v20180101preview will be removed in the next major version of the provider. Upgrade to version v20200501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:management/v20180101preview:getManagementGroup', __args__, opts=opts, typ=GetManagementGroupResult).value
