...
class ManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        management_group = azure_native.management.v20200201.ManagementGroup("managementGroup",
            details=azure_native.management.v20200201.ManagementGroupDetailsResponseArgs(
                parent=azure_native.management.v20200201.CreateParentGroupInfoArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:management:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20171101preview:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20180101preview:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20180301preview:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20191101:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20200501:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20201001:ManagementGroup"), pulumi.Alias(type_="azure-native:management/v20210401:ManagementGroup")])
