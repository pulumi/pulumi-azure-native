...
def get_load_test(load_test_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:loadtestservice/v20231201preview:getLoadTest', __args__, opts=opts, typ=GetLoadTestResult).value
...
def get_load_test_output(load_test_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:loadtestservice/v20231201preview:getLoadTest', __args__, opts=opts, typ=GetLoadTestResult)
