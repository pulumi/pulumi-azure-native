...
class LoadTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] description: Description of the resource.
        :param pulumi.Input[Union['SystemAssignedServiceIdentityArgs', 'SystemAssignedServiceIdentityArgsDict']] identity: The type of identity used for the resource.
        :param pulumi.Input[str] load_test_name: Load Test resource name.
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20220415preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20221201:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20241201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice:LoadTest")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LoadTest, __self__).__init__(
            'azure-native:loadtestservice/v20211201preview:LoadTest',
            resource_name,
            __props__,
            opts)
