...
class GetLoadTestMappingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, azure_load_testing_resource_id=None, id=None, name=None, source_resource_id=None, system_data=None, test_id=None, type=None):
    ...
    def test_id(self) -> Optional[builtins.str]:
        """
...
def get_load_test_mapping(load_test_mapping_name: Optional[builtins.str] = None,
    ...
    :param builtins.str load_test_mapping_name: Load Test Mapping name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:loadtestservice:getLoadTestMapping', __args__, opts=opts, typ=GetLoadTestMappingResult).value
...
def get_load_test_mapping_output(load_test_mapping_name: Optional[pulumi.Input[builtins.str]] = None,
