...
class LoadTestArgs:
    def __init__(__self__, *,
                 ...
                 load_test_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] load_test_name: Load Test name
    ...
    def load_test_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Load Test name
        """
    ...
    def load_test_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:loadtestservice:LoadTest")
class LoadTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20211201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20221201:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20241201preview:LoadTest")])
