...
class EncryptionPropertiesIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
        :param builtins.str resource_id: User assigned identity to use for accessing key encryption key Url. Ex: /subscriptions/a0a0a0a0-bbbb-cccd-dddd-e1e1e1e1e1e1/resourceGroups/<resource group>/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
        :param builtins.str type: Managed identity type to use for accessing encryption key Url.
        """
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_url: key encryption key Url, versioned. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78 or https://contosovault.vault.azure.net/keys/contosokek.
        """
