...
class LoadTestProfileMappingArgs:
    def __init__(__self__, *,
                 ...
                 load_test_profile_mapping_name: Optional[pulumi.Input[str]] = None,
                 source_resource_id: Optional[pulumi.Input[str]] = None,
                 test_profile_id: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] load_test_profile_mapping_name: Load Test Profile Mapping name
        :param pulumi.Input[str] source_resource_id: Mapped source resource Id.
        :param pulumi.Input[str] test_profile_id: Mapped Azure Load Test resource test-profile-id.
        """
    ...
    def load_test_profile_mapping_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def load_test_profile_mapping_name(self, value: Optional[pulumi.Input[str]]):
    ...
    def test_profile_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def test_profile_id(self, value: Optional[pulumi.Input[str]]):
...
class LoadTestProfileMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LoadTestProfileMappingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoadTestProfileMappingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["test_profile_id"] = test_profile_id
            __props__.__dict__["name"] = None
            __props__.__dict__["system_data"] = None
            __props__.__dict__["type"] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTestProfileMapping"), pulumi.Alias(type_="azure-native:loadtestservice:LoadTestProfileMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LoadTestProfileMapping, __self__).__init__(
            'azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LoadTestProfileMapping':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["test_profile_id"] = None
        __props__.__dict__["type"] = None
        return LoadTestProfileMapping(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="testProfileId")
    def test_profile_id(self) -> pulumi.Output[Optional[str]]:
        """
        Mapped Azure Load Test resource test-profile-id.
        """
        return pulumi.get(self, "test_profile_id")
