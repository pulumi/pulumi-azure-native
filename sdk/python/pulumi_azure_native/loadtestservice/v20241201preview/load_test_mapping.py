...
class LoadTestMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTestMapping"), pulumi.Alias(type_="azure-native:loadtestservice:LoadTestMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LoadTestMapping, __self__).__init__(
            'azure-native:loadtestservice/v20241201preview:LoadTestMapping',
            resource_name,
            __props__,
            opts)
