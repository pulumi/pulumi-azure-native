...
def get_load_test(load_test_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:loadtestservice/v20241201preview:getLoadTest', __args__, opts=opts, typ=GetLoadTestResult).value
...
def get_load_test_output(load_test_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:loadtestservice/v20241201preview:getLoadTest', __args__, opts=opts, typ=GetLoadTestResult)
