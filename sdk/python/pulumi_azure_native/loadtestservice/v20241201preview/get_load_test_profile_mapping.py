...
def get_load_test_profile_mapping(load_test_profile_mapping_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:loadtestservice/v20241201preview:getLoadTestProfileMapping', __args__, opts=opts, typ=GetLoadTestProfileMappingResult).value
...
def get_load_test_profile_mapping_output(load_test_profile_mapping_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:loadtestservice/v20241201preview:getLoadTestProfileMapping', __args__, opts=opts, typ=GetLoadTestProfileMappingResult)
