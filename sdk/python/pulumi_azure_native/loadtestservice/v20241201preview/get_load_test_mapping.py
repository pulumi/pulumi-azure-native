...
def get_load_test_mapping(load_test_mapping_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:loadtestservice/v20241201preview:getLoadTestMapping', __args__, opts=opts, typ=GetLoadTestMappingResult).value
...
def get_load_test_mapping_output(load_test_mapping_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:loadtestservice/v20241201preview:getLoadTestMapping', __args__, opts=opts, typ=GetLoadTestMappingResult)
