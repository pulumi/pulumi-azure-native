...
class LoadTestProfileMappingArgs:
    def __init__(__self__, *,
                 ...
                 load_test_profile_mapping_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 test_profile_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] load_test_profile_mapping_name: Load Test Profile Mapping name
        :param pulumi.Input[builtins.str] source_resource_id: Mapped source resource Id.
        :param pulumi.Input[builtins.str] test_profile_id: Mapped Azure Load Test resource test-profile-id.
        """
    ...
    def load_test_profile_mapping_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_test_profile_mapping_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def test_profile_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def test_profile_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "test_profile_id", value)


@pulumi.type_token("azure-native:loadtestservice:LoadTestProfileMapping")
class LoadTestProfileMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTestProfileMapping"), pulumi.Alias(type_="azure-native:loadtestservice/v20241201preview:LoadTestProfileMapping")])
    ...
    @property
    @pulumi.getter(name="testProfileId")
    def test_profile_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Mapped Azure Load Test resource test-profile-id.
        """
        return pulumi.get(self, "test_profile_id")
