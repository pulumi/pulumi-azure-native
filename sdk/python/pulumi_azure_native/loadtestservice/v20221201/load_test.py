...
class LoadTestArgs:
    ...
    def _configure(
        ...
        if 'loadTestName' in kwargs:
            load_test_name = kwargs['loadTestName']
        ...
        if load_test_name is not None:
            _setter("load_test_name", load_test_name)
...
class LoadTest(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LoadTestArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption is not None and not isinstance(encryption, EncryptionPropertiesArgs):
                encryption = encryption or {}
                def _setter(key, value):
                    encryption[key] = value
                EncryptionPropertiesArgs._configure(_setter, **encryption)
