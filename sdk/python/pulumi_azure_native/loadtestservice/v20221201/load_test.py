...
class LoadTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] description: Description of the resource.
        :param pulumi.Input[Union['EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict']] encryption: CMK Encryption property.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice/v20211201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20220415preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20241201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice:LoadTest")])
