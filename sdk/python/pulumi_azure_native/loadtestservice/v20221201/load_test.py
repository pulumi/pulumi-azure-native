...
class LoadTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        load_test = azure_native.loadtestservice.v20221201.LoadTest("loadTest",
            description="This is new load test resource",
            encryption=azure_native.loadtestservice.v20221201.EncryptionPropertiesResponseArgs(
                identity=azure_native.loadtestservice.v20221201.EncryptionPropertiesIdentityArgs(
            ...
            identity=azure_native.loadtestservice.v20221201.ManagedServiceIdentityResponseArgs(
        ...
        ```sh
        $ pulumi import azure-native:loadtestservice/v20221201:LoadTest myLoadTest /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/dummyrg/providers/Microsoft.LoadTestService/loadTests/myLoadTest 
        ```
