...
def get_load_test_profile_mapping(load_test_profile_mapping_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str load_test_profile_mapping_name: Load Test Profile Mapping name
...
def get_load_test_profile_mapping_output(load_test_profile_mapping_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
