...
def get_load_test(load_test_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str load_test_name: Load Test name
...
def get_load_test_output(load_test_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
