...
class LoadTest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:loadtestservice:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20211201preview:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20221201:LoadTest"), pulumi.Alias(type_="azure-native:loadtestservice/v20231201preview:LoadTest")])
