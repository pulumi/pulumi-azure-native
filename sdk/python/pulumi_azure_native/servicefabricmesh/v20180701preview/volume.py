...
class VolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VolumeResourcePropertiesArgs'] properties: Describes properties of a volume resource.
...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['VolumeResourcePropertiesArgs']] properties: Describes properties of a volume resource.
        :param pulumi.Input[str] resource_group_name: Azure resource group name
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[str] volume_name: The identity of the volume.
        """
    ...
    def _internal_init(__self__,
                 ...
                 volume_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Volume is deprecated: Version 2018-07-01-preview will be removed in v2 of the provider.""")
