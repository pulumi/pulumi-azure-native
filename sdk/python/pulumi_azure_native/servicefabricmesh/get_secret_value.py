...
def get_secret_value(resource_group_name: Optional[_builtins.str] = None,
...
def get_secret_value_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
