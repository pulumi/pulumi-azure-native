...
class NetworkArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['NetworkResourcePropertiesArgs']] = None,
        ...
        if network_resource_name is None and 'networkResourceName' in kwargs:
            network_resource_name = kwargs['networkResourceName']
        ...
        if network_resource_name is not None:
            _setter("network_resource_name", network_resource_name)
        if tags is not None:
            _setter("tags", tags)
...
class Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, NetworkResourcePropertiesArgs, True)
