...
class NetworkArgs:
    ...
    def _configure(
        ...
        if 'networkResourceName' in kwargs:
...
class Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, NetworkResourcePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                NetworkResourcePropertiesArgs._configure(_setter, **properties)
