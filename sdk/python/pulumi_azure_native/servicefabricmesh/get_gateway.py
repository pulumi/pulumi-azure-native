...
def get_gateway(gateway_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str gateway_resource_name: The identity of the gateway.
...
def get_gateway_output(gateway_resource_name: Optional[pulumi.Input[builtins.str]] = None,
