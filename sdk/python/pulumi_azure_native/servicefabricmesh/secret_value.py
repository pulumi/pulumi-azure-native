...
class SecretValueArgs:
    ...
    def _configure(
        ...
        if secret_resource_name is None and 'secretResourceName' in kwargs:
            secret_resource_name = kwargs['secretResourceName']
        if secret_resource_name is None:
            raise TypeError("Missing 'secret_resource_name' argument")
        if secret_value_resource_name is None and 'secretValueResourceName' in kwargs:
            secret_value_resource_name = kwargs['secretValueResourceName']
