...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 gateway_resource_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: User readable description of the gateway.
        :param pulumi.Input[builtins.str] gateway_resource_name: The identity of the gateway.
    ...
    def gateway_resource_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gateway_resource_name(self, value: Optional[pulumi.Input[builtins.str]]):
