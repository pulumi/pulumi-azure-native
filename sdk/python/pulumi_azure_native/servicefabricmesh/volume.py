...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabricmesh/v20180901preview:Volume"), pulumi.Alias(type_="azure-native_servicefabricmesh_v20180701preview:servicefabricmesh:Volume"), pulumi.Alias(type_="azure-native_servicefabricmesh_v20180901preview:servicefabricmesh:Volume")])
