...
def get_application(application_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_resource_name: The identity of the application.
