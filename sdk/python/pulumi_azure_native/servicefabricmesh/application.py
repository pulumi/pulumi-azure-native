...
class ApplicationArgs:
    ...
    def _configure(
        ...
        if application_resource_name is None and 'applicationResourceName' in kwargs:
            application_resource_name = kwargs['applicationResourceName']
        if debug_params is None and 'debugParams' in kwargs:
            debug_params = kwargs['debugParams']
...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            diagnostics = _utilities.configure(diagnostics, DiagnosticsDescriptionArgs, True)
