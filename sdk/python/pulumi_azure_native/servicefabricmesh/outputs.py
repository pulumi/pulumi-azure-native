...
class AddRemoveReplicaScalingMechanismResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int min_count: Minimum number of containers (scale down won't be performed below this number).
        :param _builtins.int scale_increment: Each time auto scaling is performed, this number of containers will be added or removed.
        """
...
class ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str description: User readable description of the volume.
        """
...
class AverageLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int scale_interval_in_seconds: Scale interval that indicates how often will this trigger be checked.
        :param _builtins.float upper_load_threshold: Upper load threshold (if average load is above this threshold, service will scale up).
        """
...
class AzureInternalMonitoringPipelineSinkDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_key_config_url: Optional[_builtins.str] = None,
                 description: Optional[_builtins.str] = None,
                 fluentd_config_url: Optional[Any] = None,
                 ma_config_url: Optional[_builtins.str] = None,
        ...
        :param _builtins.str auto_key_config_url: Azure Internal monitoring pipeline autokey associated with the certificate.
        :param _builtins.str description: A description of the sink.
        :param Any fluentd_config_url: Azure Internal monitoring agent fluentd configuration.
        :param _builtins.str ma_config_url: Azure Internal monitoring agent configuration.
        :param _builtins.str name: Name of the sink. This value is referenced by DiagnosticsReferenceDescription
        :param _builtins.str namespace: Azure Internal monitoring pipeline account namespace.
        """
...
class ContainerCodePackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] commands: Command array to execute within the container in exec form.
        ...
        :param _builtins.str entrypoint: Override for the default entry point in the container.
...
class ContainerEventResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the container event.
...
class ContainerInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int restart_count: The number of times the container has been restarted.
        """
...
class ContainerStateResponse(dict):
    ...
    def __init__(__self__, *,
                 detail_status: Optional[_builtins.str] = None,
                 exit_code: Optional[_builtins.str] = None,
        ...
        :param _builtins.str start_time: Date/time when the container state started.
        :param _builtins.str state: The state of this container
        """
...
class DiagnosticsDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 default_sink_refs: Optional[Sequence[_builtins.str]] = None,
...
class NetworkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str status_details: Gives additional information about the current status of the network.
        :param _builtins.str description: User readable description of the network.
        """
...
class SecretResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: State of the resource.
        :param _builtins.str status: Status of the resource.
        :param _builtins.str status_details: Gives additional information about the current status of the secret.
        :param _builtins.str content_type: The type of the content stored in the secret value. The value of this property is opaque to Service Fabric. Once set, the value of this property cannot be changed.
        :param _builtins.str description: User readable description of the secret.
        """
...
class ServiceResourceDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str os_type: The operation system required by the code in service.
        :param _builtins.str provisioning_state: State of the resource.
        :param _builtins.str status: Status of the service.
        :param _builtins.str status_details: Gives additional information about the current status of the service.
        ...
        :param _builtins.str unhealthy_evaluation: When the service's health state is not 'Ok', this additional details from service fabric Health Manager for the user to know why the service is marked unhealthy.
        :param Sequence['AutoScalingPolicyResponse'] auto_scaling_policies: Auto scaling policies
        :param _builtins.str description: User readable description of the service.
        :param 'DiagnosticsRefResponse' diagnostics: Reference to sinks in DiagnosticsDescription.
        ...
        :param _builtins.int replica_count: The number of replicas of the service to create. Defaults to 1 if not specified.
        """
