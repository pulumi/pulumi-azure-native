...
class AddRemoveReplicaScalingMechanismResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the horizontal auto scaling mechanism that adds or removes replicas (containers or container groups).
        :param builtins.str kind: Enumerates the mechanisms for auto scaling.
               Expected value is 'AddRemoveReplica'.
        :param builtins.int max_count: Maximum number of containers (scale up won't be performed above this number).
        :param builtins.int min_count: Minimum number of containers (scale down won't be performed below this number).
        :param builtins.int scale_increment: Each time auto scaling is performed, this number of containers will be added or removed.
        """
...
class ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse(dict):
    ...
    def __init__(__self__, *,
                 kind: builtins.str,
                 size_disk: builtins.str,
                 description: Optional[builtins.str] = None):
        """
        Describes parameters for creating application-scoped volumes provided by Service Fabric Volume Disks
        :param builtins.str kind: Specifies the application-scoped volume kind.
               Expected value is 'ServiceFabricVolumeDisk'.
        :param builtins.str size_disk: Volume size
        :param builtins.str description: User readable description of the volume.
        """
    ...
    def size_disk(self) -> builtins.str:
        """
        Volume size
        """
...
class ApplicationScopedVolumeResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str destination_path: The path within the container at which the volume should be mounted. Only valid path characters are allowed.
        :param builtins.str name: Name of the volume being referenced.
        :param builtins.bool read_only: The flag indicating whether the volume is read only. Default is 'false'.
        """
...
class AutoScalingPolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the auto scaling policy.
...
class AutoScalingResourceMetricResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the resource that is used for triggering auto scaling.
        :param builtins.str kind: Enumerates the metrics that are used for triggering auto scaling.
...
class AverageLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scale_interval_in_seconds: builtins.int,
                 upper_load_threshold: builtins.float):
        """
        Describes the average load trigger used for auto scaling.
        :param builtins.str kind: Enumerates the triggers for auto scaling.
               Expected value is 'AverageLoad'.
        :param builtins.float lower_load_threshold: Lower load threshold (if average load is below this threshold, service will scale down).
        :param 'AutoScalingResourceMetricResponse' metric: Description of the metric that is used for scaling.
        :param builtins.int scale_interval_in_seconds: Scale interval that indicates how often will this trigger be checked.
        :param builtins.float upper_load_threshold: Upper load threshold (if average load is above this threshold, service will scale up).
        """
    ...
    def scale_interval_in_seconds(self) -> builtins.int:
        """
...
class AzureInternalMonitoringPipelineSinkDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_key_config_url: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 fluentd_config_url: Optional[Any] = None,
                 ma_config_url: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 namespace: Optional[builtins.str] = None):
        """
        Diagnostics settings for Geneva.
        :param builtins.str kind: The kind of DiagnosticsSink.
               Expected value is 'AzureInternalMonitoringPipeline'.
        :param builtins.str account_name: Azure Internal monitoring pipeline account.
        :param builtins.str auto_key_config_url: Azure Internal monitoring pipeline autokey associated with the certificate.
        :param builtins.str description: A description of the sink.
        :param Any fluentd_config_url: Azure Internal monitoring agent fluentd configuration.
        :param builtins.str ma_config_url: Azure Internal monitoring agent configuration.
        :param builtins.str name: Name of the sink. This value is referenced by DiagnosticsReferenceDescription
        :param builtins.str namespace: Azure Internal monitoring pipeline account namespace.
        """
    ...
    def auto_key_config_url(self) -> Optional[builtins.str]:
        """
    ...
    def ma_config_url(self) -> Optional[builtins.str]:
        """
...
class ContainerCodePackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a container and its runtime properties.
        :param builtins.str image: The Container image to use.
        :param 'ContainerInstanceViewResponse' instance_view: Runtime information of a container instance.
        :param builtins.str name: The name of the code package.
        :param 'ResourceRequirementsResponse' resources: The resources required by this container.
        :param Sequence[builtins.str] commands: Command array to execute within the container in exec form.
        ...
        :param builtins.str entrypoint: Override for the default entry point in the container.
...
class ContainerEventResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 first_timestamp: Optional[builtins.str] = None,
        ...
        :param builtins.str first_timestamp: Date/time of the first event.
        :param builtins.str last_timestamp: Date/time of the last event.
        :param builtins.str message: The event message
        :param builtins.str name: The name of the container event.
    ...
    def first_timestamp(self) -> Optional[builtins.str]:
        """
...
class ContainerInstanceViewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int restart_count: The number of times the container has been restarted.
        """
...
class ContainerLabelResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a container label.
        :param builtins.str name: The name of the container label.
        :param builtins.str value: The value of the container label.
        """
        pulumi.set(__self__, "name", name)
...
class ContainerStateResponse(dict):
    ...
    def __init__(__self__, *,
                 detail_status: Optional[builtins.str] = None,
                 exit_code: Optional[builtins.str] = None,
                 finish_time: Optional[builtins.str] = None,
                 start_time: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None):
        """
        The container state.
        :param builtins.str detail_status: Human-readable status of this state.
        :param builtins.str exit_code: The container exit code.
        :param builtins.str finish_time: Date/time when the container state finished.
        :param builtins.str start_time: Date/time when the container state started.
        :param builtins.str state: The state of this container
        """
    ...
    def detail_status(self) -> Optional[builtins.str]:
        """
    ...
    def exit_code(self) -> Optional[builtins.str]:
        """
...
class DiagnosticsDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 default_sink_refs: Optional[Sequence[builtins.str]] = None,
                 enabled: Optional[builtins.bool] = None,
                 sinks: Optional[Sequence['outputs.AzureInternalMonitoringPipelineSinkDescriptionResponse']] = None):
        """
        Describes the diagnostics options available
        :param Sequence[builtins.str] default_sink_refs: The sinks to be used if diagnostics is enabled. Sink choices can be overridden at the service and code package level.
        :param builtins.bool enabled: Status of whether or not sinks are enabled.
    ...
    def default_sink_refs(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DiagnosticsRefResponse(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None,
                 sink_refs: Optional[Sequence[builtins.str]] = None):
        """
        Reference to sinks in DiagnosticsDescription.
        :param builtins.bool enabled: Status of whether or not sinks are enabled.
        :param Sequence[builtins.str] sink_refs: List of sinks to be used if enabled. References the list of sinks in DiagnosticsDescription.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def sink_refs(self) -> Optional[Sequence[builtins.str]]:
        """
...
class EndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int port: Port used by the container.
        """
        pulumi.set(__self__, "name", name)
        if port is not None:
...
class GatewayDestinationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes destination endpoint for routing traffic.
        :param builtins.str application_name: Name of the service fabric Mesh application.
        :param builtins.str endpoint_name: name of the endpoint in the service.
        :param builtins.str service_name: service that contains the endpoint.
        """
...
class HttpConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: http gateway config name.
        :param builtins.int port: Specifies the port at which the service endpoint below needs to be exposed.
        """
...
class HttpHostConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the hostname properties for http routing.
        :param builtins.str name: http hostname config name.
...
class HttpRouteConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: http route name.
        """
...
class HttpRouteMatchHeaderResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes header information for http route matching.
        :param builtins.str name: Name of header to match in request.
        :param builtins.str type: how to match header value
        :param builtins.str value: Value of header to match in request.
        """
        pulumi.set(__self__, "name", name)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class HttpRouteMatchPathResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Path to match for routing.
        :param builtins.str type: how to match value in the Uri
        :param builtins.str value: Uri path to match for request.
        :param builtins.str rewrite: replacement string for matched part of the Uri.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class ImageRegistryCredentialResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Image registry credential.
        :param builtins.str server: Docker image registry server, without protocol such as `http` and `https`.
        :param builtins.str username: The username for the private registry.
        :param builtins.str password: The password for the private registry. The password is required for create or update operations, however it is not returned in the get or list operations.
        """
...
class NetworkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes properties of a network resource.
        :param builtins.str kind: The type of a Service Fabric container network.
               Expected value is 'NetworkResourceProperties'.
        :param builtins.str provisioning_state: State of the resource.
        :param builtins.str status: Status of the network.
        :param builtins.str status_details: Gives additional information about the current status of the network.
        :param builtins.str description: User readable description of the network.
        """
...
class ReliableCollectionsRefResponse(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 do_not_persist_state: Optional[builtins.bool] = None):
        """
        Specifying this parameter adds support for reliable collections
        :param builtins.str name: Name of ReliableCollection resource. Right now it's not used and you can use any string.
        :param builtins.bool do_not_persist_state: False (the default) if ReliableCollections state is persisted to disk as usual. True if you do not want to persist state, in which case replication is still enabled and you can use ReliableCollections as distributed cache.
        """
        pulumi.set(__self__, "name", name)
    ...
    def do_not_persist_state(self) -> Optional[builtins.bool]:
        """
...
class ResourceLimitsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This type describes the resource limits for a given container. It describes the most amount of resources a container is allowed to use before being restarted.
        :param builtins.float cpu: CPU limits in cores. At present, only full cores are supported.
        :param builtins.float memory_in_gb: The memory limit in GB.
        """
        if cpu is not None:
...
class ResourceRequestsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This type describes the requested resources for a given container. It describes the least amount of resources required for the container. A container can consume more than requested resources up to the specified limits before being restarted. Currently, the requested resources are treated as limits.
        :param builtins.float cpu: Requested number of CPU cores. At present, only full cores are supported.
        :param builtins.float memory_in_gb: The memory request in GB for this container.
        """
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "memory_in_gb", memory_in_gb)
...
class SecretResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the properties of a secret resource.
        :param builtins.str kind: Describes the kind of secret.
               Expected value is 'SecretResourceProperties'.
        :param builtins.str provisioning_state: State of the resource.
        :param builtins.str status: Status of the resource.
        :param builtins.str status_details: Gives additional information about the current status of the secret.
        :param builtins.str content_type: The type of the content stored in the secret value. The value of this property is opaque to Service Fabric. Once set, the value of this property cannot be changed.
        :param builtins.str description: User readable description of the secret.
        """
...
class ServiceResourceDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status_details: builtins.str,
                 type: builtins.str,
                 unhealthy_evaluation: builtins.str,
        ...
        :param builtins.str health_state: Describes the health state of an application resource.
        :param builtins.str id: Fully qualified identifier for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param builtins.str os_type: The operation system required by the code in service.
        :param builtins.str provisioning_state: State of the resource.
        :param builtins.str status: Status of the service.
        :param builtins.str status_details: Gives additional information about the current status of the service.
        ...
        :param builtins.str unhealthy_evaluation: When the service's health state is not 'Ok', this additional details from service fabric Health Manager for the user to know why the service is marked unhealthy.
        :param Sequence['AutoScalingPolicyResponse'] auto_scaling_policies: Auto scaling policies
        :param builtins.str description: User readable description of the service.
        :param 'DiagnosticsRefResponse' diagnostics: Reference to sinks in DiagnosticsDescription.
        ...
        :param builtins.int replica_count: The number of replicas of the service to create. Defaults to 1 if not specified.
        """
...
class SettingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes a setting for the container. The setting file path can be fetched from environment variable "Fabric_SettingPath". The path for Windows container is "C:\\\\secrets". The path for Linux container is "/var/secrets".
        :param builtins.str name: The name of the setting.
        :param builtins.str value: The value of the setting.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class TcpConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Describes the tcp configuration for external connectivity for this network.
        :param 'GatewayDestinationResponse' destination: Describes destination endpoint for routing traffic.
        :param builtins.str name: tcp gateway config name.
        :param builtins.int port: Specifies the port at which the service endpoint below needs to be exposed.
        """
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "name", name)
...
class VolumeProviderParametersAzureFileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        This type describes a volume provided by an Azure Files file share.
        :param builtins.str account_name: Name of the Azure storage account for the File Share.
        :param builtins.str share_name: Name of the Azure Files file share that provides storage for the volume.
        :param builtins.str account_key: Access key of the Azure storage account for the File Share.
        """
        pulumi.set(__self__, "account_name", account_name)
