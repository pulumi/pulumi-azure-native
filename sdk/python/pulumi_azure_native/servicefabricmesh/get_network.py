...
def get_network(network_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_resource_name: The identity of the network.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabricmesh:getNetwork', __args__, opts=opts, typ=GetNetworkResult).value
...
def get_network_output(network_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
