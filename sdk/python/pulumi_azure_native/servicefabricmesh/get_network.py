...
def get_network(network_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_resource_name: The identity of the network.
...
def get_network_output(network_resource_name: Optional[pulumi.Input[builtins.str]] = None,
