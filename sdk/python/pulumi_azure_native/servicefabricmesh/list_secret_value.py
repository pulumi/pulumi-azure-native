...
def list_secret_value(resource_group_name: Optional[_builtins.str] = None,
                      secret_resource_name: Optional[_builtins.str] = None,
                      secret_value_resource_name: Optional[_builtins.str] = None,
