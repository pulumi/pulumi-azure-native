...
class VolumeArgs:
    ...
    def _configure(
        ...
        if 'azureFileParameters' in kwargs:
            azure_file_parameters = kwargs['azureFileParameters']
        if 'volumeResourceName' in kwargs:
...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if azure_file_parameters is not None and not isinstance(azure_file_parameters, VolumeProviderParametersAzureFileArgs):
                azure_file_parameters = azure_file_parameters or {}
                def _setter(key, value):
                    azure_file_parameters[key] = value
                VolumeProviderParametersAzureFileArgs._configure(_setter, **azure_file_parameters)
        ...
        super(Volume, __self__).__init__(
            'azure-native:servicefabricmesh/v20180901preview:Volume',
            resource_name,
            __props__,
            opts)
