...
class SecretValue(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        secret_value = azure_native.servicefabricmesh.v20180901preview.SecretValue("secretValue",
            location="West US",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicefabricmesh:SecretValue")])
