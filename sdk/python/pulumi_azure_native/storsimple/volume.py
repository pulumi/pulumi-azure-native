...
class VolumeArgs:
    def __init__(__self__, *,
                 access_control_record_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 ...
                 size_in_bytes: pulumi.Input[_builtins.float],
                 volume_container_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] access_control_record_ids: The IDs of the access control records, associated with the volume.
        ...
        :param pulumi.Input[_builtins.float] size_in_bytes: The size of the volume in bytes.
        :param pulumi.Input[_builtins.str] volume_container_name: The volume container name.
    ...
    def access_control_record_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def access_control_record_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def size_in_bytes(self) -> pulumi.Input[_builtins.float]:
        """
    ...
    def size_in_bytes(self, value: pulumi.Input[_builtins.float]):
        pulumi.set(self, "size_in_bytes", value)

    @_builtins.property
    @pulumi.getter(name="volumeContainerName")
    def volume_container_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def volume_container_name(self, value: pulumi.Input[_builtins.str]):
...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 access_control_record_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="accessControlRecordIds")
    def access_control_record_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The IDs of the access control records, associated with the volume.
        """
        return pulumi.get(self, "access_control_record_ids")
    ...
    def backup_policy_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
    ...
    def volume_container_id(self) -> pulumi.Output[_builtins.str]:
        """
