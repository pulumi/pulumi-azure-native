...
class VolumeArgs:
    def __init__(__self__, *,
                 access_control_record_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 size_in_bytes: pulumi.Input[builtins.float],
                 volume_container_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] access_control_record_ids: The IDs of the access control records, associated with the volume.
        ...
        :param pulumi.Input[builtins.float] size_in_bytes: The size of the volume in bytes.
        :param pulumi.Input[builtins.str] volume_container_name: The volume container name.
        ...
        :param pulumi.Input[builtins.str] volume_name: The volume name.
        """
    ...
    def access_control_record_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def access_control_record_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def size_in_bytes(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def size_in_bytes(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "size_in_bytes", value)

    @property
    @pulumi.getter(name="volumeContainerName")
    def volume_container_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def volume_container_name(self, value: pulumi.Input[builtins.str]):
...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 access_control_record_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="accessControlRecordIds")
    def access_control_record_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IDs of the access control records, associated with the volume.
        """
        return pulumi.get(self, "access_control_record_ids")
    ...
    def backup_policy_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    def volume_container_id(self) -> pulumi.Output[builtins.str]:
        """
