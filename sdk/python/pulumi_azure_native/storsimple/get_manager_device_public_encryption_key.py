...
def get_manager_device_public_encryption_key(device_name: Optional[_builtins.str] = None,
...
def get_manager_device_public_encryption_key_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
