...
class AsymmetricEncryptedSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] encryption_cert_thumbprint: Thumbprint certificate that was used to encrypt "Value". If the value in unencrypted, it will be null.
        """
...
class BandwidthScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] rate_in_mbps: The rate in Mbps.
...
if not MYPY:
    class ScheduleRecurrenceArgsDict(TypedDict):
        ...
        The recurrence type.
        """
        recurrence_value: pulumi.Input[_builtins.int]
        """
...
class ScheduleRecurrenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] recurrence_value: The recurrence value.
    ...
    def recurrence_value(self) -> pulumi.Input[_builtins.int]:
        """
        The recurrence value.
        """
    ...
    def recurrence_value(self, value: pulumi.Input[_builtins.int]):
...
class TimeArgs:
    def __init__(__self__, *,
        ...
        """
        The time.
        :param pulumi.Input[_builtins.int] hours: The hour.
        :param pulumi.Input[_builtins.int] minutes: The minute.
        :param pulumi.Input[_builtins.int] seconds: The second.
        """
