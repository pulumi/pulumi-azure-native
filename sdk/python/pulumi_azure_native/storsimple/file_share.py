...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:FileShare"), pulumi.Alias(type_="azure-native:storsimple/latest:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:FileShare"), pulumi.Alias(type_="azure-native:storsimple/v20161001:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:FileShare")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileShare, __self__).__init__(
            'azure-native:storsimple:FileShare',
            resource_name,
            __props__,
            opts)
