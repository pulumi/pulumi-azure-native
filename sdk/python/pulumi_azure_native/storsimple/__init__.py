...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:storsimple:BackupScheduleGroup":
            ...
            elif typ == "azure-native:storsimple:ChapSetting":
                return ChapSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple:FileServer":
                return FileServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple:FileShare":
                return FileShare(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple:IscsiDisk":
                return IscsiDisk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple:IscsiServer":
            ...
            elif typ == "azure-native:storsimple:StorageDomain":
