...
class VolumeContainerArgs:
    def __init__(__self__, *,
                 ...
                 band_width_rate_in_mbps: Optional[pulumi.Input[builtins.int]] = None,
                 bandwidth_setting_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] storage_account_credential_id: The path ID of storage account associated with the volume container.
        :param pulumi.Input[builtins.int] band_width_rate_in_mbps: The bandwidth-rate set on the volume container.
        :param pulumi.Input[builtins.str] bandwidth_setting_id: The ID of the bandwidth setting associated with the volume container.
        ...
        :param pulumi.Input[builtins.str] volume_container_name: The name of the volume container.
        """
    ...
    def band_width_rate_in_mbps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def band_width_rate_in_mbps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "band_width_rate_in_mbps", value)

    @property
    @pulumi.getter(name="bandwidthSettingId")
    def bandwidth_setting_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bandwidth_setting_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def volume_container_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def volume_container_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VolumeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 storage_account_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                 volume_container_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="bandWidthRateInMbps")
    def band_width_rate_in_mbps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The bandwidth-rate set on the volume container.
        """
        return pulumi.get(self, "band_width_rate_in_mbps")
    ...
    @property
    @pulumi.getter(name="bandwidthSettingId")
    def bandwidth_setting_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the bandwidth setting associated with the volume container.
        """
        return pulumi.get(self, "bandwidth_setting_id")
    ...
    def encryption_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def owner_ship_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="storageAccountCredentialId")
    def storage_account_credential_id(self) -> pulumi.Output[builtins.str]:
        """
        The path ID of storage account associated with the volume container.
        """
        return pulumi.get(self, "storage_account_credential_id")
    ...
    def total_cloud_storage_usage_in_bytes(self) -> pulumi.Output[builtins.float]:
        """
