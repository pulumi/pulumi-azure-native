...
class VolumeContainerArgs:
    ...
    def _configure(
        ...
        if band_width_rate_in_mbps is None and 'bandWidthRateInMbps' in kwargs:
            band_width_rate_in_mbps = kwargs['bandWidthRateInMbps']
        if bandwidth_setting_id is None and 'bandwidthSettingId' in kwargs:
...
class VolumeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            encryption_key = _utilities.configure(encryption_key, AsymmetricEncryptedSecretArgs, True)
