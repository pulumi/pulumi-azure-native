...
class StorageAccountCredentialArgs:
    def __init__(__self__, *,
                 end_point: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] end_point: The storage endpoint
        ...
        :param pulumi.Input[_builtins.str] storage_account_credential_name: The storage account credential name.
        """
    ...
    def end_point(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @end_point.setter
    def end_point(self, value: pulumi.Input[_builtins.str]):
    ...
    def storage_account_credential_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def storage_account_credential_name(self, value: Optional[pulumi.Input[_builtins.str]]):
