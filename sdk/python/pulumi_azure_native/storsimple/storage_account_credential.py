...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple/v20170601:StorageAccountCredential"), pulumi.Alias(type_="azure-native_storsimple_v20161001:storsimple:StorageAccountCredential"), pulumi.Alias(type_="azure-native_storsimple_v20170601:storsimple:StorageAccountCredential")])
