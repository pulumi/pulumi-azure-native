...
class GetBackupPolicyResult:
    ...
    def backup_policy_creation_type(self) -> _builtins.str:
        """
    ...
    def next_backup_time(self) -> _builtins.str:
        """
    ...
    def scheduled_backup_status(self) -> _builtins.str:
        """
    ...
    def schedules_count(self) -> _builtins.float:
        """
    ...
    def ssm_host_name(self) -> _builtins.str:
        """
...
def get_backup_policy(backup_policy_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backup_policy_name: The name of backup policy to be fetched.
...
def get_backup_policy_output(backup_policy_name: Optional[pulumi.Input[_builtins.str]] = None,
