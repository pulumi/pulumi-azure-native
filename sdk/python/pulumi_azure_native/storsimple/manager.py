...
class ManagerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] provisioning_state: Specifies the state of the resource as it is getting provisioned. Value of "Succeeded" means the Manager was successfully created.
        :param pulumi.Input['ManagerSkuArgs'] sku: Specifies the Sku.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The tags attached to the resource.
        """
