...
class ManagerArgs:
    ...
    def _configure(
        ...
        if 'cisIntrinsicSettings' in kwargs:
...
class Manager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cis_intrinsic_settings is not None and not isinstance(cis_intrinsic_settings, ManagerIntrinsicSettingsArgs):
            ...
            if sku is not None and not isinstance(sku, ManagerSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
