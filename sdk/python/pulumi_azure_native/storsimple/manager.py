...
class ManagerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] provisioning_state: Specifies the state of the resource as it is getting provisioned. Value of "Succeeded" means the Manager was successfully created.
        :param pulumi.Input['ManagerSkuArgs'] sku: Specifies the Sku.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags attached to the resource.
        """
    ...
    def manager_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The manager name
        """
    ...
    @manager_name.setter
    def manager_name(self, value: Optional[pulumi.Input[builtins.str]]):
