...
def get_bandwidth_setting(bandwidth_setting_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bandwidth_setting_name: The name of bandwidth setting to be fetched.
...
def get_bandwidth_setting_output(bandwidth_setting_name: Optional[pulumi.Input[_builtins.str]] = None,
