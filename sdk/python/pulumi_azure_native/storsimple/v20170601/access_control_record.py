...
class AccessControlRecord(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:AccessControlRecord")])
