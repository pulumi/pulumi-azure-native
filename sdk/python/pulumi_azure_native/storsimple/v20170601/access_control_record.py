...
class AccessControlRecordArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if initiator_name is None and 'initiatorName' in kwargs:
            initiator_name = kwargs['initiatorName']
        if initiator_name is None:
            raise TypeError("Missing 'initiator_name' argument")
        ...
        if access_control_record_name is None and 'accessControlRecordName' in kwargs:
            access_control_record_name = kwargs['accessControlRecordName']
