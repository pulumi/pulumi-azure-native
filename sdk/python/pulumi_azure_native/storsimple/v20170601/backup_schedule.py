...
class BackupSchedule(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BackupSchedule"), pulumi.Alias(type_="azure-native:storsimple:BackupSchedule"), pulumi.Alias(type_="azure-nextgen:storsimple:BackupSchedule"), pulumi.Alias(type_="azure-native:storsimple/latest:BackupSchedule"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:BackupSchedule")])
