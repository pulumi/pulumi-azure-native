...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storsimple/v20170601:AccessControlRecord":
                return AccessControlRecord(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:BackupPolicy":
                return BackupPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:BackupSchedule":
                return BackupSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:BandwidthSetting":
                return BandwidthSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:Manager":
                return Manager(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:ManagerExtendedInfo":
                return ManagerExtendedInfo(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:Volume":
                return Volume(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20170601:VolumeContainer":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storsimple/v20170601", _module_instance)
