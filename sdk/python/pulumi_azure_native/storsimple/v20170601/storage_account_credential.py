...
class StorageAccountCredentialArgs:
    ...
    def _configure(
        ...
        if storage_account_credential_name is None and 'storageAccountCredentialName' in kwargs:
...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            access_key = _utilities.configure(access_key, AsymmetricEncryptedSecretArgs, True)
