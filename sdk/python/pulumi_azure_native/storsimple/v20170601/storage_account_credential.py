...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_account_credential = azure_native.storsimple.v20170601.StorageAccountCredential("storageAccountCredential",
            access_key=azure_native.storsimple.v20170601.AsymmetricEncryptedSecretResponseArgs(
                encryption_algorithm=azure_native.storsimple/v20170601.EncryptionAlgorithm.RSAE_S_PKCS1_V_1_5,
            ...
            ssl_status=azure_native.storsimple/v20170601.SslStatus.ENABLED,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:StorageAccountCredential"), pulumi.Alias(type_="azure-native:storsimple/v20161001:StorageAccountCredential")])
