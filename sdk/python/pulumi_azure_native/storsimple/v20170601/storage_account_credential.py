...
class StorageAccountCredentialArgs:
    ...
    def _configure(
        ...
        if 'storageAccountCredentialName' in kwargs:
            storage_account_credential_name = kwargs['storageAccountCredentialName']
        ...
        if storage_account_credential_name is not None:
            _setter("storage_account_credential_name", storage_account_credential_name)
...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if access_key is not None and not isinstance(access_key, AsymmetricEncryptedSecretArgs):
                access_key = access_key or {}
                def _setter(key, value):
                    access_key[key] = value
                AsymmetricEncryptedSecretArgs._configure(_setter, **access_key)
