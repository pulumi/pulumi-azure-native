...
class ManagerArgs:
    ...
    def _configure(
        ...
        if cis_intrinsic_settings is None and 'cisIntrinsicSettings' in kwargs:
            cis_intrinsic_settings = kwargs['cisIntrinsicSettings']
...
class Manager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cis_intrinsic_settings = _utilities.configure(cis_intrinsic_settings, ManagerIntrinsicSettingsArgs, True)
            ...
            sku = _utilities.configure(sku, ManagerSkuArgs, True)
