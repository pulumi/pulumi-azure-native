...
class VolumeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        volume_container = azure_native.storsimple.v20170601.VolumeContainer("volumeContainer",
            ...
            encryption_key=azure_native.storsimple.v20170601.AsymmetricEncryptedSecretResponseArgs(
