...
class BandwidthSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:BandwidthSetting"), pulumi.Alias(type_="azure-nextgen:storsimple:BandwidthSetting"), pulumi.Alias(type_="azure-native:storsimple/latest:BandwidthSetting"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:BandwidthSetting")])
