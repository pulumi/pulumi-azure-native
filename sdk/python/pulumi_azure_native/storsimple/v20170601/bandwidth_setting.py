...
class BandwidthSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BandwidthSetting"), pulumi.Alias(type_="azure-native:storsimple:BandwidthSetting"), pulumi.Alias(type_="azure-nextgen:storsimple:BandwidthSetting")])
