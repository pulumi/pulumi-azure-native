...
def get_manager(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/v20170601:getManager', __args__, opts=opts, typ=GetManagerResult).value
...
def get_manager_output(manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:storsimple/v20170601:getManager', __args__, opts=opts, typ=GetManagerResult)
