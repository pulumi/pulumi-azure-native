...
class ManagerExtendedInfoArgs:
    def __init__(__self__, *,
                 ...
                 integrity_key: pulumi.Input[builtins.str],
                 manager_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 encryption_key: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_key_thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input['Kind']] = None,
                 portal_certificate_thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ManagerExtendedInfo resource.
        :param pulumi.Input[builtins.str] algorithm: Represents the encryption algorithm used to encrypt the keys. None - if Key is saved in plain text format. Algorithm name - if key is encrypted
        :param pulumi.Input[builtins.str] integrity_key: Represents the CIK of the resource.
        ...
        :param pulumi.Input[builtins.str] encryption_key: Represents the CEK of the resource.
        :param pulumi.Input[builtins.str] encryption_key_thumbprint: Represents the Cert thumbprint that was used to encrypt the CEK.
        :param pulumi.Input['Kind'] kind: The Kind of the object. Currently only Series8000 is supported
        :param pulumi.Input[builtins.str] portal_certificate_thumbprint: Represents the portal thumbprint which can be used optionally to encrypt the entire data before storing it.
        :param pulumi.Input[builtins.str] version: The version of the extended info being persisted.
        """
    ...
    def integrity_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def integrity_key(self, value: pulumi.Input[builtins.str]):
    ...
    def encryption_key_thumbprint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryption_key_thumbprint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def portal_certificate_thumbprint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def portal_certificate_thumbprint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagerExtendedInfo(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 encryption_key: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_key_thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 integrity_key: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input['Kind']] = None,
    ...
    @property
    @pulumi.getter(name="encryptionKeyThumbprint")
    def encryption_key_thumbprint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Represents the Cert thumbprint that was used to encrypt the CEK.
        """
        return pulumi.get(self, "encryption_key_thumbprint")
    ...
    @property
    @pulumi.getter(name="integrityKey")
    def integrity_key(self) -> pulumi.Output[builtins.str]:
        """
        Represents the CIK of the resource.
        """
        return pulumi.get(self, "integrity_key")
    ...
    @property
    @pulumi.getter(name="portalCertificateThumbprint")
    def portal_certificate_thumbprint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Represents the portal thumbprint which can be used optionally to encrypt the entire data before storing it.
        """
        return pulumi.get(self, "portal_certificate_thumbprint")
