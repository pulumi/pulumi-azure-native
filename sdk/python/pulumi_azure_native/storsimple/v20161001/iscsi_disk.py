...
class IscsiDisk(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-native:storsimple/latest:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiDisk")])
