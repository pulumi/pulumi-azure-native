...
class FileShare(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple:FileShare"), pulumi.Alias(type_="azure-native:storsimple/latest:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:FileShare")])
