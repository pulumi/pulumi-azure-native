...
def list_device_failover_sets(device_name: Optional[_builtins.str] = None,
...
def list_device_failover_sets_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
