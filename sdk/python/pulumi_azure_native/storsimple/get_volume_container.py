...
class GetVolumeContainerResult:
    ...
    def band_width_rate_in_mbps(self) -> Optional[_builtins.int]:
        """
    ...
    def bandwidth_setting_id(self) -> Optional[_builtins.str]:
        """
    ...
    def owner_ship_status(self) -> _builtins.str:
        """
    ...
    def total_cloud_storage_usage_in_bytes(self) -> _builtins.float:
        """
...
def get_volume_container(device_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str volume_container_name: The name of the volume container.
    """
    __args__ = dict()
...
def get_volume_container_output(device_name: Optional[pulumi.Input[_builtins.str]] = None,
