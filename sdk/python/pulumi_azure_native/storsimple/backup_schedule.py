...
class BackupSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:BackupSchedule"), pulumi.Alias(type_="azure-native:storsimple/v20170601:BackupSchedule"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BackupSchedule")])
