...
class BackupScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backup_policy_name: The backup policy name.
        ...
        :param pulumi.Input[builtins.float] retention_count: The number of backups to be retained.
        ...
        :param pulumi.Input[builtins.str] start_time: The start time of the schedule.
        :param pulumi.Input[builtins.str] backup_schedule_name: The backup schedule name.
    ...
    def backup_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def backup_policy_name(self, value: pulumi.Input[builtins.str]):
    ...
    def retention_count(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def retention_count(self, value: pulumi.Input[builtins.float]):
    ...
    def backup_schedule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_schedule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 retention_count: Optional[pulumi.Input[builtins.float]] = None,
    ...
    def last_successful_run(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="retentionCount")
    def retention_count(self) -> pulumi.Output[builtins.float]:
        """
        The number of backups to be retained.
        """
        return pulumi.get(self, "retention_count")
    ...
    @property
    @pulumi.getter(name="scheduleStatus")
    def schedule_status(self) -> pulumi.Output[builtins.str]:
        """
        The schedule status.
        """
        return pulumi.get(self, "schedule_status")
