...
class AccessControlRecordArgs:
    def __init__(__self__, *,
                 initiator_name: pulumi.Input[builtins.str],
                 manager_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 access_control_record_name: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input['Kind']] = None):
        """
        The set of arguments for constructing a AccessControlRecord resource.
        :param pulumi.Input[builtins.str] initiator_name: The iSCSI initiator name (IQN).
        ...
        :param pulumi.Input[builtins.str] access_control_record_name: The name of the access control record.
    ...
    def initiator_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def initiator_name(self, value: pulumi.Input[builtins.str]):
    ...
    def access_control_record_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_control_record_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 access_control_record_name: Optional[pulumi.Input[builtins.str]] = None,
                 initiator_name: Optional[pulumi.Input[builtins.str]] = None,
                 kind: Optional[pulumi.Input['Kind']] = None,
    ...
    @property
    @pulumi.getter(name="initiatorName")
    def initiator_name(self) -> pulumi.Output[builtins.str]:
        """
        The iSCSI initiator name (IQN).
        """
        return pulumi.get(self, "initiator_name")
