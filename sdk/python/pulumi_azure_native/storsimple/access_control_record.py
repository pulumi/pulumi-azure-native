...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple/v20170601:AccessControlRecord"), pulumi.Alias(type_="azure-native_storsimple_v20161001:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native_storsimple_v20170601:storsimple:AccessControlRecord")])
