...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getVolume'.""", DeprecationWarning)
...
def get_volume(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_volume is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getVolume'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
