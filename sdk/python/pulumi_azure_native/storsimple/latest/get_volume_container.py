...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getVolumeContainer'.""", DeprecationWarning)
...
def get_volume_container(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getVolumeContainer', __args__, opts=opts, typ=GetVolumeContainerResult).value
