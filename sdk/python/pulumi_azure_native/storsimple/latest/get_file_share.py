...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getFileShare'.""", DeprecationWarning)
...
def get_file_share(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
