...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:listDeviceFailoverTars'.""", DeprecationWarning)
...
def list_device_failover_tars(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:listDeviceFailoverTars', __args__, opts=opts, typ=ListDeviceFailoverTarsResult).value
