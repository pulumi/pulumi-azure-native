...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getIscsiDisk'.""", DeprecationWarning)
...
def get_iscsi_disk(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iscsi_disk is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getIscsiDisk'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getIscsiDisk', __args__, opts=opts, typ=GetIscsiDiskResult).value
