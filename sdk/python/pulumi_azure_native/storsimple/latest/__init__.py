...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storsimple/latest:AccessControlRecord":
                return AccessControlRecord(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/latest:BackupPolicy":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storsimple/latest", _module_instance)
