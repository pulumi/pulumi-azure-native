...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManagerEncryptionKey'.""", DeprecationWarning)
...
def get_manager_encryption_key(manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_manager_encryption_key is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManagerEncryptionKey'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getManagerEncryptionKey', __args__, opts=opts, typ=GetManagerEncryptionKeyResult).value
