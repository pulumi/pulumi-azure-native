...
class Volume(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:Volume"), pulumi.Alias(type_="azure-nextgen:storsimple:Volume"), pulumi.Alias(type_="azure-native:storsimple/v20170601:Volume"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:Volume")])
