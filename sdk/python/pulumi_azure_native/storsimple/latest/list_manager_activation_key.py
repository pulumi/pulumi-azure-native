...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:listManagerActivationKey'.""", DeprecationWarning)
...
def list_manager_activation_key(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:listManagerActivationKey', __args__, opts=opts, typ=ListManagerActivationKeyResult).value
