...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getStorageDomain'.""", DeprecationWarning)
...
def get_storage_domain(manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getStorageDomain', __args__, opts=opts, typ=GetStorageDomainResult).value
