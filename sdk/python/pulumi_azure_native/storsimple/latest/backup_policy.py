...
class BackupPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:storsimple:BackupPolicy"), pulumi.Alias(type_="azure-nextgen:storsimple:BackupPolicy"), pulumi.Alias(type_="azure-native:storsimple/v20170601:BackupPolicy"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BackupPolicy")])
