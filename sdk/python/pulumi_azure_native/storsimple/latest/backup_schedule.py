...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:BackupSchedule'.""", DeprecationWarning)
...
class BackupSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:BackupSchedule"), pulumi.Alias(type_="azure-native:storsimple:BackupSchedule"), pulumi.Alias(type_="azure-nextgen:storsimple:BackupSchedule"), pulumi.Alias(type_="azure-native:storsimple/v20170601:BackupSchedule"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BackupSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupSchedule, __self__).__init__(
            'azure-native:storsimple/latest:BackupSchedule',
            resource_name,
            __props__,
            opts)
