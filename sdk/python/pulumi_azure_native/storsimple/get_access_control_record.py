...
class GetAccessControlRecordResult:
    ...
    def initiator_name(self) -> _builtins.str:
        """
...
def get_access_control_record(access_control_record_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str access_control_record_name: Name of access control record to be fetched.
    :param _builtins.str manager_name: The manager name
...
def get_access_control_record_output(access_control_record_name: Optional[pulumi.Input[_builtins.str]] = None,
