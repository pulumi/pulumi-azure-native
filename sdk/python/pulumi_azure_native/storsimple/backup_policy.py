...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] volume_ids: The path IDs of the volumes which are part of the backup policy.
        :param pulumi.Input[_builtins.str] backup_policy_name: The name of the backup policy to be created/updated.
...
class BackupPolicy(pulumi.CustomResource):
    ...
    def backup_policy_creation_type(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def last_backup_time(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def next_backup_time(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def scheduled_backup_status(self) -> pulumi.Output[_builtins.str]:
        """
    ...
    def schedules_count(self) -> pulumi.Output[_builtins.float]:
        """
    ...
    def ssm_host_name(self) -> pulumi.Output[_builtins.str]:
        """
