...
def list_device_failover_tars(manager_name: Optional[builtins.str] = None,
                              resource_group_name: Optional[builtins.str] = None,
                              source_device_name: Optional[builtins.str] = None,
                              volume_containers: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str source_device_name: The source device name on which failover is performed.
    :param Sequence[builtins.str] volume_containers: The list of path IDs of the volume containers that needs to be failed-over, for which we want to fetch the eligible targets.
    """
    __args__ = dict()
...
def list_device_failover_tars_output(manager_name: Optional[pulumi.Input[builtins.str]] = None,
                                     resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                     source_device_name: Optional[pulumi.Input[builtins.str]] = None,
                                     volume_containers: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
