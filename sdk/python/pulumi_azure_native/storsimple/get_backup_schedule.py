...
class GetBackupScheduleResult:
    ...
    def last_successful_run(self) -> _builtins.str:
        """
    ...
    def retention_count(self) -> _builtins.float:
        """
...
def get_backup_schedule(backup_policy_name: Optional[_builtins.str] = None,
                        backup_schedule_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backup_schedule_name: The name of the backup schedule to be fetched
...
def get_backup_schedule_output(backup_policy_name: Optional[pulumi.Input[_builtins.str]] = None,
