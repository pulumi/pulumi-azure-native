...
class AuthorityArgs:
    def __init__(__self__, *,
                 authority_name: pulumi.Input[_builtins.str],
    ...
    def authority_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def authority_name(self, value: pulumi.Input[_builtins.str]):
...
class Authority(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 authority_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authority_name is None and not opts.urn:
                raise TypeError("Missing required property 'authority_name'")
