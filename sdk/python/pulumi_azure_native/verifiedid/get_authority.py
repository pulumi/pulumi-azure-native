...
def get_authority(authority_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str authority_name: The ID of the authority
...
def get_authority_output(authority_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:verifiedid:getAuthority', __args__, opts=opts, typ=GetAuthorityResult)
