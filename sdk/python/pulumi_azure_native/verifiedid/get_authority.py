...
def get_authority(authority_name: Optional[builtins.str] = None,
    ...
    :param builtins.str authority_name: The ID of the authority
...
def get_authority_output(authority_name: Optional[pulumi.Input[builtins.str]] = None,
