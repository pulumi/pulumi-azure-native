...
class SqlServerRegistrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] property_bag: Optional Properties as JSON string
        :param pulumi.Input[builtins.str] resource_group: Resource Group Name
    ...
    def sql_server_registration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_server_registration_name(self, value: Optional[pulumi.Input[builtins.str]]):
