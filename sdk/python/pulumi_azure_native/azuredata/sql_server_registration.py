...
class SqlServerRegistrationArgs:
    ...
    def sql_server_registration_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def sql_server_registration_name(self, value: Optional[pulumi.Input[_builtins.str]]):
