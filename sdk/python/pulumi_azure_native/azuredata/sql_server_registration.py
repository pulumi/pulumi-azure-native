...
class SqlServerRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredata/v20190724preview:SqlServerRegistration"), pulumi.Alias(type_="azure-native_azuredata_v20170301preview:azuredata:SqlServerRegistration"), pulumi.Alias(type_="azure-native_azuredata_v20190724preview:azuredata:SqlServerRegistration")])
