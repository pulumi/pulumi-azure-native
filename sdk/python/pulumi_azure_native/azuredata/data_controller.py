...
class DataController(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredata/v20190724preview:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:DataController"), pulumi.Alias(type_="azure-native:azuredata/v20200908preview:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata/v20200908preview:DataController")])
