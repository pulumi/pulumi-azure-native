...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:azuredata/v20200908preview:DataController":
                return DataController(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:azuredata/v20200908preview:PostgresInstance":
                return PostgresInstance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:azuredata/v20200908preview:SqlManagedInstance":
                return SqlManagedInstance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:azuredata/v20200908preview:SqlServerInstance":
    ...
    pulumi.runtime.register_resource_module("azure-native", "azuredata/v20200908preview", _module_instance)
