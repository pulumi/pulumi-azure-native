...
class SqlManagedInstance(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredata:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azuredata:SqlManagedInstance"), pulumi.Alias(type_="azure-native:azuredata/v20190724preview:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:SqlManagedInstance")])
