...
class SqlServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:SqlServer"), pulumi.Alias(type_="azure-native:azuredata:SqlServer"), pulumi.Alias(type_="azure-nextgen:azuredata:SqlServer"), pulumi.Alias(type_="azure-native:azuredata/v20170301preview:SqlServer"), pulumi.Alias(type_="azure-nextgen:azuredata/v20170301preview:SqlServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServer, __self__).__init__(
            'azure-native:azuredata/v20190724preview:SqlServer',
            resource_name,
            __props__,
            opts)
