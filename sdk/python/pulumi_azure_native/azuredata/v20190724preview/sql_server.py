...
class SqlServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_server = azure_native.azuredata.v20190724preview.SqlServer("sqlServer",
            cores=8,
            edition="Latin",
            property_bag="",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredata:SqlServer"), pulumi.Alias(type_="azure-native:azuredata/v20170301preview:SqlServer")])
