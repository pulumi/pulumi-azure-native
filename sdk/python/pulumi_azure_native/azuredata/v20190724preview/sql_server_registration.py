...
class SqlServerRegistrationArgs:
    def __init__(__self__, *,
        ...
        """
        SqlServerRegistrationArgs._configure(
    ...
    def _configure(
        ...
        if property_bag is None and 'propertyBag' in kwargs:
            property_bag = kwargs['propertyBag']
        if resource_group is None and 'resourceGroup' in kwargs:
            resource_group = kwargs['resourceGroup']
        if sql_server_registration_name is None and 'sqlServerRegistrationName' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlServerRegistrationArgs._configure(_setter, **kwargs)
