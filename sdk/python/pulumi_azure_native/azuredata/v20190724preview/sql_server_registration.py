...
class SqlServerRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:SqlServerRegistration"), pulumi.Alias(type_="azure-native:azuredata:SqlServerRegistration"), pulumi.Alias(type_="azure-nextgen:azuredata:SqlServerRegistration"), pulumi.Alias(type_="azure-native:azuredata/v20170301preview:SqlServerRegistration"), pulumi.Alias(type_="azure-nextgen:azuredata/v20170301preview:SqlServerRegistration")])
