...
class SqlServerRegistration(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuredata:SqlServerRegistration"), pulumi.Alias(type_="azure-nextgen:azuredata:SqlServerRegistration"), pulumi.Alias(type_="azure-native:azuredata/v20170301preview:SqlServerRegistration"), pulumi.Alias(type_="azure-nextgen:azuredata/v20170301preview:SqlServerRegistration")])
