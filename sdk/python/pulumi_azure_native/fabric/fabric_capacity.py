...
__all__ = ['FabricCapacityArgs', 'FabricCapacity']
...
class FabricCapacityArgs:
    ...
    @property
    @pulumi.getter
    def administration(self) -> pulumi.Input['CapacityAdministrationArgs']:
        """
    ...
    @property
    @pulumi.getter
    def sku(self) -> pulumi.Input['RpSkuArgs']:
        """
        The SKU details
        """
    ...
    def capacity_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def capacity_name(self, value: Optional[pulumi.Input[str]]):
...
class FabricCapacity(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FabricCapacityArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:fabric/v20231101:FabricCapacity"), pulumi.Alias(type_="azure-native:fabric/v20250115preview:FabricCapacity"), pulumi.Alias(type_="azure-native_fabric_v20231101:fabric:FabricCapacity"), pulumi.Alias(type_="azure-native_fabric_v20250115preview:fabric:FabricCapacity")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FabricCapacity':
        """
        ...
        __props__.__dict__["type"] = None
        return FabricCapacity(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def administration(self) -> pulumi.Output['outputs.CapacityAdministrationResponse']:
        """
        The capacity administration
        """
        return pulumi.get(self, "administration")
    ...
    @property
    @pulumi.getter
    def sku(self) -> pulumi.Output['outputs.RpSkuResponse']:
        """
        The SKU details
        """
        return pulumi.get(self, "sku")
