...
def get_fabric_capacity(capacity_name: Optional[_builtins.str] = None,
...
def get_fabric_capacity_output(capacity_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
