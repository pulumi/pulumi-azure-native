...
def get_fabric_capacity(capacity_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:fabric/v20250115preview:getFabricCapacity', __args__, opts=opts, typ=GetFabricCapacityResult).value
...
def get_fabric_capacity_output(capacity_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:fabric/v20250115preview:getFabricCapacity', __args__, opts=opts, typ=GetFabricCapacityResult)
