...
class FabricCapacity(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:fabric:FabricCapacity"), pulumi.Alias(type_="azure-native:fabric/v20231101:FabricCapacity")])
