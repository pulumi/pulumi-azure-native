...
class FabricCapacity(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:fabric/v20231101:FabricCapacity"), pulumi.Alias(type_="azure-native:fabric:FabricCapacity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FabricCapacity, __self__).__init__(
            'azure-native:fabric/v20250115preview:FabricCapacity',
            resource_name,
            __props__,
            opts)
