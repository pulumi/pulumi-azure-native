...
def list_account_keys(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/v20210201:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult).value
...
def list_account_keys_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:maps/v20210201:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult)
