...
def get_creator(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_creator is deprecated: azure-native:maps/v20210201:Creator is being removed in the next major version of this provider. Please upgrade to azure-native:maps/v20211201preview:Creator to guarantee forwards compatibility.""")
    __args__ = dict()
