...
def list_account_sas(account_name: Optional[_builtins.str] = None,
                     expiry: Optional[_builtins.str] = None,
                     max_rate_per_second: Optional[_builtins.int] = None,
                     principal_id: Optional[_builtins.str] = None,
                     regions: Optional[Sequence[_builtins.str]] = None,
                     resource_group_name: Optional[_builtins.str] = None,
                     signing_key: Optional[Union[_builtins.str, 'SigningKey']] = None,
    ...
    :param _builtins.str principal_id: The principal Id also known as the object Id of a User Assigned Managed Identity currently assigned to the Maps Account. To assign a Managed Identity of the account, use operation Create or Update an assign a User Assigned Identity resource Id.
    :param Sequence[_builtins.str] regions: Optional, allows control of which region locations are permitted access to Azure Maps REST APIs with the SAS token. Example: "eastus", "westus2". Omitting this parameter will allow all region locations to be accessible.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param Union[_builtins.str, 'SigningKey'] signing_key: The Maps account key to use for signing. Picking `primaryKey` or `secondaryKey` will use the Maps account Shared Keys, and using `managedIdentity` will use the auto-renewed private key to sign the SAS.
    :param _builtins.str start: The date time offset of when the token validity begins. For example "2017-05-24T10:42:03.1567373Z". Maximum duration allowed is 24 hours between `start` and `expiry`.
    """
    __args__ = dict()
