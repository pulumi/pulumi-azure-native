...
class MapsAccountPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Additional Maps account properties
        :param Sequence['PrivateEndpointConnectionResponse'] private_endpoint_connections: List of private endpoint connections associated with the Maps Account.
        ...
        :param str public_network_access: Property to specify whether the Maps Account will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked.
        """
