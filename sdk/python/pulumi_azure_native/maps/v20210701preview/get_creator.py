...
warnings.warn("""azure-native:maps/v20210701preview:Creator is being removed in the next major version of this provider. Upgrade to at least azure-native:maps/v20211201preview:Creator to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_creator(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_creator is deprecated: azure-native:maps/v20210701preview:Creator is being removed in the next major version of this provider. Upgrade to at least azure-native:maps/v20211201preview:Creator to guarantee forwards compatibility.""")
    __args__ = dict()
