...
def get_creator(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/v20230601:getCreator', __args__, opts=opts, typ=GetCreatorResult).value
...
def get_creator_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:maps/v20230601:getCreator', __args__, opts=opts, typ=GetCreatorResult)
