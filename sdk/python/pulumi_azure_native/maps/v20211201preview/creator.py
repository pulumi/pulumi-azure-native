...
class Creator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        creator = azure_native.maps.v20211201preview.Creator("creator",
            account_name="myMapsAccount",
            creator_name="myCreator",
            location="eastus2",
            properties=azure_native.maps.v20211201preview.CreatorPropertiesArgs(
                storage_units=5,
            ),
        ...
        ```sh
        $ pulumi import azure-native:maps/v20211201preview:Creator myCreator /subscriptions/21a9967a-e8a9-4656-a70b-96ff1c4d05a0/resourceGroups/myResourceGroup/providers/Microsoft.Maps/accounts/myMapsAccount/creators/myCreator 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maps:Creator"), pulumi.Alias(type_="azure-native:maps/v20200201preview:Creator"), pulumi.Alias(type_="azure-native:maps/v20210201:Creator"), pulumi.Alias(type_="azure-native:maps/v20210701preview:Creator")])
