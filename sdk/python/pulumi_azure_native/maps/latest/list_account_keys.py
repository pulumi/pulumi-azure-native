...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:maps:listAccountKeys'.""", DeprecationWarning)
...
def list_account_keys(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_account_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:maps:listAccountKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/latest:listAccountKeys', __args__, opts=opts, typ=ListAccountKeysResult).value
