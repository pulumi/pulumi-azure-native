...
def get_creator(account_name: Optional[builtins.str] = None,
                creator_name: Optional[builtins.str] = None,
    ...
    :param builtins.str creator_name: The name of the Maps Creator instance.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps:getCreator', __args__, opts=opts, typ=GetCreatorResult).value
...
def get_creator_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
