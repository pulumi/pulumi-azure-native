...
def list_account_sas(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/v20240701preview:listAccountSas', __args__, opts=opts, typ=ListAccountSasResult).value
...
def list_account_sas_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['start'] = start
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:maps/v20240701preview:listAccountSas', __args__, opts=opts, typ=ListAccountSasResult)
