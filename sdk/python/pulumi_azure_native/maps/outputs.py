...
class CreatorPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int consumed_storage_unit_size_in_bytes: The consumed storage unit size in bytes for the creator resource.
        :param int total_storage_unit_size_in_bytes: The total allocated storage unit size in bytes for the creator resource.
        """
    ...
    def consumed_storage_unit_size_in_bytes(self) -> Optional[int]:
        """
    ...
    def total_storage_unit_size_in_bytes(self) -> Optional[int]:
        """
...
class EncryptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str infrastructure_encryption: (Optional) Discouraged to include in resource definition. Only needed where it is possible to disable platform (AKA infrastructure) encryption. Azure SQL TDE is an example of this. Values are enabled and disabled.
        """
...
class MapsAccountPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Additional Maps account properties
        :param str provisioning_state: The provisioning state of the Maps account resource, Account updates can only be performed on terminal states. Terminal states: `Succeeded` and `Failed`
...
class MapsAccountPropertiesResponseLocations(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Data processing location.
        :param str location_name: The location name.
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The SKU of the Maps Account.
        :param str name: The name of the SKU, in standard format (such as G2).
