...
class PrivateAtlaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] private_atlas_name: The name of the Private Atlas instance.
    ...
    def private_atlas_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_atlas_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateAtlase(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:maps:PrivateAtlase"
