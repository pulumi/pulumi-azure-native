...
class CorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        Specifies a CORS rule for the Map Account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: Required if CorsRule element is present. A list of origin domains that will be allowed via CORS, or "*" to allow all domains
        """
...
if not MYPY:
    class CreatorPropertiesArgsDict(TypedDict):
        ...
        """
        consumed_storage_unit_size_in_bytes: NotRequired[pulumi.Input[builtins.int]]
        """
        The consumed storage unit size in bytes for the creator resource.
        """
        total_storage_unit_size_in_bytes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class CreatorPropertiesArgs:
    def __init__(__self__, *,
                 storage_units: pulumi.Input[builtins.int],
                 consumed_storage_unit_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 total_storage_unit_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None):
        """
        Creator resource properties
        :param pulumi.Input[builtins.int] storage_units: The storage units to be allocated. Integer values from 1 to 100, inclusive.
        :param pulumi.Input[builtins.int] consumed_storage_unit_size_in_bytes: The consumed storage unit size in bytes for the creator resource.
        :param pulumi.Input[builtins.int] total_storage_unit_size_in_bytes: The total allocated storage unit size in bytes for the creator resource.
        """
    ...
    def consumed_storage_unit_size_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The consumed storage unit size in bytes for the creator resource.
        """
    ...
    def consumed_storage_unit_size_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "consumed_storage_unit_size_in_bytes", value)

    @property
    @pulumi.getter(name="totalStorageUnitSizeInBytes")
    def total_storage_unit_size_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The total allocated storage unit size in bytes for the creator resource.
        """
    ...
    def total_storage_unit_size_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EncryptionCustomerManagedKeyEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_encryption_key_url: key encryption key Url, versioned or unversioned. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78 or https://contosovault.vault.azure.net/keys/contosokek.
        """
...
if not MYPY:
    class EncryptionKeyEncryptionKeyIdentityArgsDict(TypedDict):
        ...
        """
        identity_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EncryptionKeyEncryptionKeyIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identity_type: The type of identity to use. Values can be systemAssignedIdentity, userAssignedIdentity, or delegatedResourceIdentity.
...
class EncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'InfrastructureEncryption']] infrastructure_encryption: (Optional) Discouraged to include in resource definition. Only needed where it is possible to disable platform (AKA infrastructure) encryption. Azure SQL TDE is an example of this. Values are enabled and disabled.
        """
...
class LinkedResourceArgs:
    def __init__(__self__, *,
        ...
        """
        Linked resource is reference to a resource deployed in an Azure subscription, add the linked resource `uniqueName` value as an optional parameter for operations on Azure Maps Geospatial REST APIs.
        :param pulumi.Input[builtins.str] id: ARM resource id in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/accounts/{storageName}'.
        :param pulumi.Input[builtins.str] unique_name: A provided name which uniquely identifies the linked resource.
        """
...
class MapsAccountPropertiesLocationsArgs:
    def __init__(__self__, *,
        ...
        """
        Data processing location.
        :param pulumi.Input[builtins.str] location_name: The location name.
        """
...
class MapsAccountPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disable_local_auth: Allows toggle functionality on Azure Policy to disable Azure Maps local authentication support. This will disable Shared Keys and Shared Access Signature Token authentication from any usage.
...
if not MYPY:
    class SkuArgsDict(TypedDict):
        ...
        """
        name: pulumi.Input[Union[builtins.str, 'Name']]
        """
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        """
        The SKU of the Maps Account.
        :param pulumi.Input[Union[builtins.str, 'Name']] name: The name of the SKU, in standard format (such as G2).
        """
        pulumi.set(__self__, "name", name)

    @property
    @pulumi.getter
    def name(self) -> pulumi.Input[Union[builtins.str, 'Name']]:
        """
        The name of the SKU, in standard format (such as G2).
        """
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[builtins.str, 'Name']]):
