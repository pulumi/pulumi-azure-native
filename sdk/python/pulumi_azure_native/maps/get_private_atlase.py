...
def get_private_atlase(account_name: Optional[builtins.str] = None,
                       private_atlas_name: Optional[builtins.str] = None,
    ...
    :param builtins.str private_atlas_name: The name of the Private Atlas instance.
...
def get_private_atlase_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
                              private_atlas_name: Optional[pulumi.Input[builtins.str]] = None,
