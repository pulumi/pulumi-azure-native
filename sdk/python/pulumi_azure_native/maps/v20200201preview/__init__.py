...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:maps/v20200201preview:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maps/v20200201preview:Creator":
                return Creator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maps/v20200201preview:PrivateAtlase":
    ...
    pulumi.runtime.register_resource_module("azure-native", "maps/v20200201preview", _module_instance)
