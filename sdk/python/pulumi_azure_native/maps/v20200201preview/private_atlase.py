...
class PrivateAtlaseArgs:
    ...
    def _configure(
        ...
        if private_atlas_name is None and 'privateAtlasName' in kwargs:
            private_atlas_name = kwargs['privateAtlasName']
...
class PrivateAtlase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:maps:PrivateAtlase")])
