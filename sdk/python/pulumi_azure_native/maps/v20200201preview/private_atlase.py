...
__all__ = ['PrivateAtlaseArgs', 'PrivateAtlase']
...
class PrivateAtlaseArgs:
    ...
    def private_atlas_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def private_atlas_name(self, value: Optional[pulumi.Input[str]]):
...
class PrivateAtlase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrivateAtlaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:maps/v20200201preview:PrivateAtlase"), pulumi.Alias(type_="azure-native:maps:PrivateAtlase"), pulumi.Alias(type_="azure-nextgen:maps:PrivateAtlase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateAtlase, __self__).__init__(
            'azure-native:maps/v20200201preview:PrivateAtlase',
            resource_name,
            __props__,
            opts)
