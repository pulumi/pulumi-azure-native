...
def get_private_atlase(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/v20200201preview:getPrivateAtlase', __args__, opts=opts, typ=GetPrivateAtlaseResult).value
...
def get_private_atlase_output(account_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:maps/v20200201preview:getPrivateAtlase', __args__, opts=opts, typ=GetPrivateAtlaseResult)
