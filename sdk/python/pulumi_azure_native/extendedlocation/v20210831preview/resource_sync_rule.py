...
class ResourceSyncRuleArgs:
    def __init__(__self__, *,
        ...
        """
        ResourceSyncRuleArgs._configure(
...
class ResourceSyncRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ResourceSyncRuleArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if selector is not None and not isinstance(selector, ResourceSyncRulePropertiesSelectorArgs):
                selector = selector or {}
                def _setter(key, value):
                    selector[key] = value
                ResourceSyncRulePropertiesSelectorArgs._configure(_setter, **selector)
