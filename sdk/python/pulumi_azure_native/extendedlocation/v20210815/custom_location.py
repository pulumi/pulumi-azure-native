...
warnings.warn("""azure-native:extendedlocation/v20210815:CustomLocation is being removed in the next major version of this provider. Upgrade to at least azure-native:extendedlocation/v20210831preview:CustomLocation to guarantee forwards compatibility.""", DeprecationWarning)
...
class CustomLocation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CustomLocation is deprecated: azure-native:extendedlocation/v20210815:CustomLocation is being removed in the next major version of this provider. Upgrade to at least azure-native:extendedlocation/v20210831preview:CustomLocation to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:extendedlocation:CustomLocation"), pulumi.Alias(type_="azure-native:extendedlocation/v20210315preview:CustomLocation"), pulumi.Alias(type_="azure-native:extendedlocation/v20210831preview:CustomLocation")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomLocation, __self__).__init__(
            'azure-native:extendedlocation/v20210815:CustomLocation',
            resource_name,
            __props__,
            opts)
