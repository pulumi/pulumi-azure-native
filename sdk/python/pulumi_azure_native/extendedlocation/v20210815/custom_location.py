...
class CustomLocationArgs:
    ...
    def _configure(
        ...
        if cluster_extension_ids is None and 'clusterExtensionIds' in kwargs:
            cluster_extension_ids = kwargs['clusterExtensionIds']
        if display_name is None and 'displayName' in kwargs:
            display_name = kwargs['displayName']
        if host_resource_id is None and 'hostResourceId' in kwargs:
            host_resource_id = kwargs['hostResourceId']
...
class CustomLocation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, CustomLocationPropertiesAuthenticationArgs, True)
