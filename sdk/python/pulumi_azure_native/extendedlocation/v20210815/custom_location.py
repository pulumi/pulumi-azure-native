...
class CustomLocation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""CustomLocation is deprecated: azure-native:extendedlocation/v20210815:CustomLocation is being removed in the next major version of this provider. Please upgrade to azure-native:extendedlocation/v20210831preview:CustomLocation to guarantee forwards compatibility.""")
