...
def get_custom_location(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_location is deprecated: azure-native:extendedlocation/v20210815:CustomLocation is being removed in the next major version of this provider. Upgrade to at least azure-native:extendedlocation/v20210831preview:CustomLocation to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:extendedlocation/v20210815:getCustomLocation', __args__, opts=opts, typ=GetCustomLocationResult).value
