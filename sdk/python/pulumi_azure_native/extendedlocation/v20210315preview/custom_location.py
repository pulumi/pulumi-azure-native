...
class CustomLocation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        custom_location = azure_native.extendedlocation.v20210315preview.CustomLocation("customLocation",
            authentication=azure_native.extendedlocation.v20210315preview.CustomLocationPropertiesAuthenticationArgs(
                type="KubeConfig",
        ...
        ```sh
        $ pulumi import azure-native:extendedlocation/v20210315preview:CustomLocation customLocation01 /subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/customLocation01 
        ```
