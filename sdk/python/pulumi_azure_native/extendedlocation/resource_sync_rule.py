...
class ResourceSyncRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:extendedlocation/v20210831preview:ResourceSyncRule"), pulumi.Alias(type_="azure-native_extendedlocation_v20210831preview:extendedlocation:ResourceSyncRule")])
