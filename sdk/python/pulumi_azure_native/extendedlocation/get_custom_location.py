...
class GetCustomLocationResult:
    ...
    @_builtins.property
    @pulumi.getter
    def authentication(self) -> Optional['outputs.CustomLocationPropertiesAuthenticationResponse']:
        """
...
def get_custom_location(resource_group_name: Optional[_builtins.str] = None,
...
def get_custom_location_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
