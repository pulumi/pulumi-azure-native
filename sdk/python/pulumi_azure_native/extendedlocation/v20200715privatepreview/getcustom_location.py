...
def getcustom_location(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:extendedlocation/v20200715privatepreview:getcustomLocation', __args__, opts=opts, typ=GetcustomLocationResult).value
