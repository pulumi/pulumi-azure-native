...
def list_linker_configurations(linker_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicelinker/v20220501:listLinkerConfigurations', __args__, opts=opts, typ=ListLinkerConfigurationsResult).value
...
def list_linker_configurations_output(linker_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicelinker/v20220501:listLinkerConfigurations', __args__, opts=opts, typ=ListLinkerConfigurationsResult)
