...
warnings.warn("""azure-native:servicelinker/v20220501:Linker is being removed in the next major version of this provider. Please upgrade to azure-native:servicelinker/v20221101preview:Linker to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_linker(linker_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_linker is deprecated: azure-native:servicelinker/v20220501:Linker is being removed in the next major version of this provider. Please upgrade to azure-native:servicelinker/v20221101preview:Linker to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['linkerName'] = linker_name
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:servicelinker/v20220501:getLinker', __args__, opts=opts, typ=GetLinkerResult).value
