...
def get_linker_dryrun(dryrun_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicelinker:getLinkerDryrun', __args__, opts=opts, typ=GetLinkerDryrunResult).value
...
def get_linker_dryrun_output(dryrun_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
