...
class Linker(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 target_service: Optional[pulumi.Input[Union[Union['AzureResourceArgs', 'AzureResourceArgsDict'], Union['ConfluentBootstrapServerArgs', 'ConfluentBootstrapServerArgsDict'], Union['ConfluentSchemaRegistryArgs', 'ConfluentSchemaRegistryArgsDict'], Union['FabricPlatformArgs', 'FabricPlatformArgsDict'], Union['SelfHostedServerArgs', 'SelfHostedServerArgsDict']]]] = None,
        ...
        :param pulumi.Input[Union[Union['AzureResourceArgs', 'AzureResourceArgsDict'], Union['ConfluentBootstrapServerArgs', 'ConfluentBootstrapServerArgsDict'], Union['ConfluentSchemaRegistryArgs', 'ConfluentSchemaRegistryArgsDict'], Union['FabricPlatformArgs', 'FabricPlatformArgsDict'], Union['SelfHostedServerArgs', 'SelfHostedServerArgsDict']]] target_service: The target service properties
