...
def list_linker_configurations(linker_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicelinker/v20240701preview:listLinkerConfigurations', __args__, opts=opts, typ=ListLinkerConfigurationsResult).value
