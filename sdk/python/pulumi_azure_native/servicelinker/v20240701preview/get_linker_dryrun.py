...
def get_linker_dryrun(dryrun_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicelinker/v20240701preview:getLinkerDryrun', __args__, opts=opts, typ=GetLinkerDryrunResult).value
...
def get_linker_dryrun_output(dryrun_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:servicelinker/v20240701preview:getLinkerDryrun', __args__, opts=opts, typ=GetLinkerDryrunResult)
