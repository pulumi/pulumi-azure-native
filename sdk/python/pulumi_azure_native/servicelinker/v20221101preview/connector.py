...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicelinker/v20230401preview:Connector"), pulumi.Alias(type_="azure-native:servicelinker/v20240401:Connector"), pulumi.Alias(type_="azure-native:servicelinker/v20240701preview:Connector"), pulumi.Alias(type_="azure-native:servicelinker:Connector")])
