...
class LinkerDryrun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicelinker:LinkerDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20221101preview:LinkerDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20230401preview:LinkerDryrun")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LinkerDryrun, __self__).__init__(
            'azure-native:servicelinker/v20240401:LinkerDryrun',
            resource_name,
            __props__,
            opts)
