...
class AccessKeyInfoBaseResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] permissions: Permissions of the accessKey. `Read` and `Write` are for Azure Cosmos DB and Azure App Configuration, `Listen`, `Send` and `Manage` are for Azure Event Hub and Azure Service Bus.
        """
...
class ConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 additional_configurations: Optional[Mapping[str, _builtins.str]] = None,
                 additional_connection_string_properties: Optional[Mapping[str, _builtins.str]] = None,
        ...
        :param Mapping[str, _builtins.str] customized_keys: Optional. A dictionary of default key name and customized key name mapping. If not specified, default key name will be used for generate configurations
...
class CreateOrUpdateDryrunParametersResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str scope: connection scope in source service.
...
class DaprMetadataResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 required: Optional[_builtins.str] = None,
        ...
        :param _builtins.str secret_ref: The secret name where dapr could get value
...
class DaprPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_store_component: Optional[_builtins.str] = None,
        ...
        :param Sequence[_builtins.str] scopes: The dapr component scopes
        :param _builtins.str secret_store_component: The name of a secret store dapr to retrieve secret
        :param _builtins.str version: The dapr component version
        """
...
class DryrunOperationPreviewResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str scope: The scope of the operation, refer https://docs.microsoft.com/azure/role-based-access-control/scope-overview
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if description is not None:
...
class EasyAuthMicrosoftEntraIDAuthInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auth_mode: Optional. Indicates how to configure authentication. If optInAllAuth, service linker configures authentication such as enabling identity on source resource and granting RBAC roles. If optOutAllAuth, opt out authentication setup. Default is optInAllAuth.
        :param _builtins.str client_id: Application clientId for EasyAuth Microsoft Entra ID.
        :param _builtins.str delete_or_update_behavior: Indicates whether to clean up previous operation when Linker is updating or deleting
        :param _builtins.str secret: Application Secret for EasyAuth Microsoft Entra ID.
        """
...
class FirewallRulesResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_services: Optional[_builtins.str] = None,
                 caller_client_ip: Optional[_builtins.str] = None,
...
class KeyVaultSecretReferenceSecretInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str version: Version of the Key Vault secret.
        """
...
class PermissionsMissingDryrunPrerequisiteResultResponse(dict):
    ...
    def __init__(__self__, *,
                 type: _builtins.str,
                 permissions: Optional[Sequence[_builtins.str]] = None,
                 recommended_role: Optional[_builtins.str] = None,
                 scope: Optional[_builtins.str] = None):
        """
        The represent of missing permissions
        :param _builtins.str type: The type of dryrun result.
        ...
        :param _builtins.str recommended_role: The recommended role to resolve permissions missing
        :param _builtins.str scope: The permission scope
        """
...
class SecretAuthInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auth_mode: Optional. Indicates how to configure authentication. If optInAllAuth, service linker configures authentication such as enabling identity on source resource and granting RBAC roles. If optOutAllAuth, opt out authentication setup. Default is optInAllAuth.
        :param _builtins.str name: Username or account name for secret auth.
...
class ServicePrincipalCertificateAuthInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str client_id: Application clientId for servicePrincipal auth.
...
class SourceConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of setting.
        :param _builtins.str value: The value of setting
        """
...
class SystemAssignedIdentityAuthInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auth_mode: Optional. Indicates how to configure authentication. If optInAllAuth, service linker configures authentication such as enabling identity on source resource and granting RBAC roles. If optOutAllAuth, opt out authentication setup. Default is optInAllAuth.
        :param _builtins.str delete_or_update_behavior: Indicates whether to clean up previous operation when Linker is updating or deleting
        :param Sequence[_builtins.str] roles: Optional, this value specifies the Azure role to be assigned
        :param _builtins.str user_name: Username created in the database which is mapped to a user in AAD.
        """
...
class UserAssignedIdentityAuthInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auth_mode: Optional. Indicates how to configure authentication. If optInAllAuth, service linker configures authentication such as enabling identity on source resource and granting RBAC roles. If optOutAllAuth, opt out authentication setup. Default is optInAllAuth.
        :param _builtins.str client_id: Client Id for userAssignedIdentity.
        :param _builtins.str delete_or_update_behavior: Indicates whether to clean up previous operation when Linker is updating or deleting
        :param Sequence[_builtins.str] roles: Optional, this value specifies the Azure role to be assigned
        :param _builtins.str subscription_id: Subscription id for userAssignedIdentity.
        :param _builtins.str user_name: Username created in the database which is mapped to a user in AAD.
        """
