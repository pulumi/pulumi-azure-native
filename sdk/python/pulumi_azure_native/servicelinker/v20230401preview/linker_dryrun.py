...
class LinkerDryrun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicelinker/v20221101preview:LinkerDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20240401:LinkerDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20240701preview:LinkerDryrun"), pulumi.Alias(type_="azure-native:servicelinker:LinkerDryrun")])
