...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicelinker:Connector"), pulumi.Alias(type_="azure-native:servicelinker/v20221101preview:Connector"), pulumi.Alias(type_="azure-native:servicelinker/v20240401:Connector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connector, __self__).__init__(
            'azure-native:servicelinker/v20230401preview:Connector',
            resource_name,
            __props__,
            opts)
