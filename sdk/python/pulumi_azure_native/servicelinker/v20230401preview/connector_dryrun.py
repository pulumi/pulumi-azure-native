...
class ConnectorDryrun(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:servicelinker:ConnectorDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20221101preview:ConnectorDryrun"), pulumi.Alias(type_="azure-native:servicelinker/v20240401:ConnectorDryrun")])
