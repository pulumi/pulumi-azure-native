...
def list_security_advisory_impacted_resource_by_subscription_id_and_event_id(event_tracking_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resourcehealth/v20221001:listSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId', __args__, opts=opts, typ=ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResult).value
