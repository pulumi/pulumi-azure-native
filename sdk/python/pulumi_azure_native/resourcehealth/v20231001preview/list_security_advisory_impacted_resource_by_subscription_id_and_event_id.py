...
def list_security_advisory_impacted_resource_by_subscription_id_and_event_id(event_tracking_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resourcehealth/v20231001preview:listSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId', __args__, opts=opts, typ=ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResult).value
...
def list_security_advisory_impacted_resource_by_subscription_id_and_event_id_output(event_tracking_id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['filter'] = filter
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resourcehealth/v20231001preview:listSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventId', __args__, opts=opts, typ=ListSecurityAdvisoryImpactedResourceBySubscriptionIdAndEventIdResult)
