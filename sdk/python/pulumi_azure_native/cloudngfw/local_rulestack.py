...
class LocalRulestackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] pan_location: Rulestack Location, Required for GlobalRulestacks, Not for LocalRulestacks
...
class LocalRulestack(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="associatedSubscriptions")
    def associated_subscriptions(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        subscription scope of global rulestack
        """
        return pulumi.get(self, "associated_subscriptions")
