...
def list_local_rulestack_security_services(local_rulestack_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:listLocalRulestackSecurityServices', __args__, opts=opts, typ=ListLocalRulestackSecurityServicesResult).value

    return AwaitableListLocalRulestackSecurityServicesResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_local_rulestack_security_services_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:listLocalRulestackSecurityServices', __args__, opts=opts, typ=ListLocalRulestackSecurityServicesResult)
