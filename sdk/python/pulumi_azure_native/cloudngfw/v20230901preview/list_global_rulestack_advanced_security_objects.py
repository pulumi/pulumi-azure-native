...
def list_global_rulestack_advanced_security_objects(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20230901preview:listGlobalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListGlobalRulestackAdvancedSecurityObjectsResult).value
...
def list_global_rulestack_advanced_security_objects_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['type'] = type
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20230901preview:listGlobalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListGlobalRulestackAdvancedSecurityObjectsResult)
