...
def get_firewall_log_profile(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20230901preview:getFirewallLogProfile', __args__, opts=opts, typ=GetFirewallLogProfileResult).value
...
def get_firewall_log_profile_output(firewall_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20230901preview:getFirewallLogProfile', __args__, opts=opts, typ=GetFirewallLogProfileResult)
