...
class CertificateObjectGlobalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:CertificateObjectGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:CertificateObjectGlobalRulestack")])
