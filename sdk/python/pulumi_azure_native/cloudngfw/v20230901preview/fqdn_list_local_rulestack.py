...
class FqdnListLocalRulestack(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FqdnListLocalRulestackArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FqdnListLocalRulestackArgs.__new__(FqdnListLocalRulestackArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw/v20220829:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20250206preview:FqdnListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw:FqdnListLocalRulestack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FqdnListLocalRulestack, __self__).__init__(
            'azure-native:cloudngfw/v20230901preview:FqdnListLocalRulestack',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FqdnListLocalRulestack':
        """
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return FqdnListLocalRulestack(resource_name, opts=opts, __props__=__props__)
