...
class GlobalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:GlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:GlobalRulestack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GlobalRulestack, __self__).__init__(
            'azure-native:cloudngfw/v20230901preview:GlobalRulestack',
            resource_name,
            __props__,
            opts)
