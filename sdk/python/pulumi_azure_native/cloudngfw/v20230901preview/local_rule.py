...
class LocalRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw/v20220829:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20250206preview:LocalRule"), pulumi.Alias(type_="azure-native:cloudngfw:LocalRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LocalRule, __self__).__init__(
            'azure-native:cloudngfw/v20230901preview:LocalRule',
            resource_name,
            __props__,
            opts)
