...
def get_local_rule_counters(firewall_name: Optional[builtins.str] = None,
                            local_rulestack_name: Optional[builtins.str] = None,
    ...
    :param builtins.str priority: Local Rule priority
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getLocalRuleCounters', __args__, opts=opts, typ=GetLocalRuleCountersResult).value
...
def get_local_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:getLocalRuleCounters', __args__, opts=opts, typ=GetLocalRuleCountersResult)
