...
def get_local_rule_counters(firewall_name: Optional[_builtins.str] = None,
                            local_rulestack_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str priority: Local Rule priority
...
def get_local_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
