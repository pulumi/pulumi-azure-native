...
def get_pre_rule_counters(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20231010preview:getPreRuleCounters', __args__, opts=opts, typ=GetPreRuleCountersResult).value
...
def get_pre_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['priority'] = priority
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20231010preview:getPreRuleCounters', __args__, opts=opts, typ=GetPreRuleCountersResult)
