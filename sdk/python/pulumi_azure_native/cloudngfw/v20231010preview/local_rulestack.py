...
class LocalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:LocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:LocalRulestack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LocalRulestack, __self__).__init__(
            'azure-native:cloudngfw/v20231010preview:LocalRulestack',
            resource_name,
            __props__,
            opts)
