...
def get_global_rulestack(global_rulestack_name: Optional[_builtins.str] = None,
...
def get_global_rulestack_output(global_rulestack_name: pulumi.Input[Optional[_builtins.str]] = None,
