...
class FqdnListGlobalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:FqdnListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:FqdnListGlobalRulestack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FqdnListGlobalRulestack, __self__).__init__(
            'azure-native:cloudngfw/v20230901:FqdnListGlobalRulestack',
            resource_name,
            __props__,
            opts)
