...
def list_global_rulestack_firewalls(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20230901:listGlobalRulestackFirewalls', __args__, opts=opts, typ=ListGlobalRulestackFirewallsResult).value
...
def list_global_rulestack_firewalls_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['globalRulestackName'] = global_rulestack_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20230901:listGlobalRulestackFirewalls', __args__, opts=opts, typ=ListGlobalRulestackFirewallsResult)
