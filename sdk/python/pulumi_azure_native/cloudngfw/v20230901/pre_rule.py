...
class PreRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw/v20220829:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20250206preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw:PreRule")])
