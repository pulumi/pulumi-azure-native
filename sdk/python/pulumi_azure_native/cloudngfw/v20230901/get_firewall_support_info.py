...
def get_firewall_support_info(email: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20230901:getFirewallSupportInfo', __args__, opts=opts, typ=GetFirewallSupportInfoResult).value
...
def get_firewall_support_info_output(email: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20230901:getFirewallSupportInfo', __args__, opts=opts, typ=GetFirewallSupportInfoResult)
