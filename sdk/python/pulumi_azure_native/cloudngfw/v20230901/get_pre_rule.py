...
__all__ = [
    'GetPreRuleResult',
    'AwaitableGetPreRuleResult',
    'get_pre_rule',
    'get_pre_rule_output',
]

@pulumi.output_type
class GetPreRuleResult:
    """
...
class AwaitableGetPreRuleResult(GetPreRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPreRuleResult(
...
def get_pre_rule(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20230901:getPreRule', __args__, opts=opts, typ=GetPreRuleResult).value

    return AwaitableGetPreRuleResult(
...
def get_pre_rule_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['priority'] = priority
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20230901:getPreRule', __args__, opts=opts, typ=GetPreRuleResult)
