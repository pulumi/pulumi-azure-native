...
def list_local_rulestack_countries(local_rulestack_name: Optional[_builtins.str] = None,
...
def list_local_rulestack_countries_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
