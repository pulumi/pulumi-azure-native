...
def get_firewall_global_rulestack(firewall_name: Optional[_builtins.str] = None,
...
def get_firewall_global_rulestack_output(firewall_name: Optional[pulumi.Input[_builtins.str]] = None,
