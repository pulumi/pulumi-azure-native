...
def list_local_rulestack_predefined_url_categories(local_rulestack_name: Optional[builtins.str] = None,
...
def list_local_rulestack_predefined_url_categories_output(local_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
