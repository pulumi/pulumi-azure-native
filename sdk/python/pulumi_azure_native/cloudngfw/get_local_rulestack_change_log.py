...
def get_local_rulestack_change_log(local_rulestack_name: Optional[_builtins.str] = None,
...
def get_local_rulestack_change_log_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
