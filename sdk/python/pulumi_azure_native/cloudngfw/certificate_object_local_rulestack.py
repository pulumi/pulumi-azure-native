...
class CertificateObjectLocalRulestackArgs:
    def __init__(__self__, *,
                 certificate_self_signed: pulumi.Input[Union[builtins.str, 'BooleanEnum']],
                 local_rulestack_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 audit_comment: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_signer_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CertificateObjectLocalRulestack resource.
        :param pulumi.Input[Union[builtins.str, 'BooleanEnum']] certificate_self_signed: use certificate self signed
        :param pulumi.Input[builtins.str] local_rulestack_name: LocalRulestack resource name
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] audit_comment: comment for this object
        :param pulumi.Input[builtins.str] certificate_signer_resource_id: Resource Id of certificate signer, to be populated only when certificateSelfSigned is false
        :param pulumi.Input[builtins.str] description: user description for this object
        :param pulumi.Input[builtins.str] name: certificate name
        """
    ...
    def certificate_self_signed(self) -> pulumi.Input[Union[builtins.str, 'BooleanEnum']]:
        """
    ...
    def certificate_self_signed(self, value: pulumi.Input[Union[builtins.str, 'BooleanEnum']]):
        pulumi.set(self, "certificate_self_signed", value)

    @property
    @pulumi.getter(name="localRulestackName")
    def local_rulestack_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def local_rulestack_name(self, value: pulumi.Input[builtins.str]):
    ...
    def certificate_signer_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def certificate_signer_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateObjectLocalRulestack(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 audit_comment: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_self_signed: Optional[pulumi.Input[Union[builtins.str, 'BooleanEnum']]] = None,
                 certificate_signer_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 local_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="certificateSelfSigned")
    def certificate_self_signed(self) -> pulumi.Output[builtins.str]:
        """
        use certificate self signed
        """
        return pulumi.get(self, "certificate_self_signed")
    ...
    @property
    @pulumi.getter(name="certificateSignerResourceId")
    def certificate_signer_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource Id of certificate signer, to be populated only when certificateSelfSigned is false
        """
        return pulumi.get(self, "certificate_signer_resource_id")
