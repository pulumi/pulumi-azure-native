...
def get_local_rule(local_rulestack_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getLocalRule', __args__, opts=opts, typ=GetLocalRuleResult).value
...
def get_local_rule_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
