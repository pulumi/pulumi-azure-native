...
def get_local_rule(local_rulestack_name: Optional[builtins.str] = None,
...
def get_local_rule_output(local_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
