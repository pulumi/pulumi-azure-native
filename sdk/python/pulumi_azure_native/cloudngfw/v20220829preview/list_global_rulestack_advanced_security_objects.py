...
def list_global_rulestack_advanced_security_objects(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829preview:listGlobalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListGlobalRulestackAdvancedSecurityObjectsResult).value
