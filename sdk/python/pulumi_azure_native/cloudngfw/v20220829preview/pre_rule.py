...
class PreRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:PreRule"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:PreRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PreRule, __self__).__init__(
            'azure-native:cloudngfw/v20220829preview:PreRule',
            resource_name,
            __props__,
            opts)
