...
def get_local_rulestack(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829preview:getLocalRulestack', __args__, opts=opts, typ=GetLocalRulestackResult).value
...
def get_local_rulestack_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20220829preview:getLocalRulestack', __args__, opts=opts, typ=GetLocalRulestackResult)
