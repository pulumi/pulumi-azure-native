...
def get_prefix_list_local_rulestack(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829preview:getPrefixListLocalRulestack', __args__, opts=opts, typ=GetPrefixListLocalRulestackResult).value
