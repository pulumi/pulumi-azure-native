...
def list_local_rulestack_advanced_security_objects(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829preview:listLocalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListLocalRulestackAdvancedSecurityObjectsResult).value
