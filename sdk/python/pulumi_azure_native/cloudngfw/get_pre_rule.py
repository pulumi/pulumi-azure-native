...
def get_pre_rule(global_rulestack_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getPreRule', __args__, opts=opts, typ=GetPreRuleResult).value
...
def get_pre_rule_output(global_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:getPreRule', __args__, opts=opts, typ=GetPreRuleResult)
