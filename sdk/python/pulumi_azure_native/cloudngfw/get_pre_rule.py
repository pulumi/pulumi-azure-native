...
def get_pre_rule(global_rulestack_name: Optional[_builtins.str] = None,
...
def get_pre_rule_output(global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
