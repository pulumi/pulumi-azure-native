...
def get_prefix_list_global_rulestack(global_rulestack_name: Optional[builtins.str] = None,
...
def get_prefix_list_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
