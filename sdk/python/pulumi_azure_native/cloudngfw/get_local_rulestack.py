...
def get_local_rulestack(local_rulestack_name: Optional[builtins.str] = None,
...
def get_local_rulestack_output(local_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
