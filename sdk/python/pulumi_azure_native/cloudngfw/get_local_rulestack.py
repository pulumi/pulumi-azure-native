...
def get_local_rulestack(local_rulestack_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getLocalRulestack', __args__, opts=opts, typ=GetLocalRulestackResult).value
...
def get_local_rulestack_output(local_rulestack_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
