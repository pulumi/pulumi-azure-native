...
def list_local_rulestack_app_ids(app_id_version: Optional[builtins.str] = None,
...
def list_local_rulestack_app_ids_output(app_id_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
