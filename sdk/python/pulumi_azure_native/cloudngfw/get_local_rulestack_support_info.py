...
def get_local_rulestack_support_info(email: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getLocalRulestackSupportInfo', __args__, opts=opts, typ=GetLocalRulestackSupportInfoResult).value
...
def get_local_rulestack_support_info_output(email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
