...
class GetCertificateObjectGlobalRulestackResult:
    ...
    def certificate_self_signed(self) -> builtins.str:
        """
    ...
    def certificate_signer_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_certificate_object_global_rulestack(global_rulestack_name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: certificate name
    """
    __args__ = dict()
    __args__['globalRulestackName'] = global_rulestack_name
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getCertificateObjectGlobalRulestack', __args__, opts=opts, typ=GetCertificateObjectGlobalRulestackResult).value
...
def get_certificate_object_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:getCertificateObjectGlobalRulestack', __args__, opts=opts, typ=GetCertificateObjectGlobalRulestackResult)
