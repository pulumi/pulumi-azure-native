...
def get_certificate_object_global_rulestack(global_rulestack_name: Optional[_builtins.str] = None,
...
def get_certificate_object_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
