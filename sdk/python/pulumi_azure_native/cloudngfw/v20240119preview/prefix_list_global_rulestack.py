...
class PrefixListGlobalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw/v20220829:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:PrefixListGlobalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw:PrefixListGlobalRulestack")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrefixListGlobalRulestack, __self__).__init__(
            'azure-native:cloudngfw/v20240119preview:PrefixListGlobalRulestack',
            resource_name,
            __props__,
            opts)
