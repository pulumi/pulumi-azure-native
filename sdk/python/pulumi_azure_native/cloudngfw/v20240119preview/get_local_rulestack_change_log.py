...
def get_local_rulestack_change_log(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20240119preview:getLocalRulestackChangeLog', __args__, opts=opts, typ=GetLocalRulestackChangeLogResult).value
...
def get_local_rulestack_change_log_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20240119preview:getLocalRulestackChangeLog', __args__, opts=opts, typ=GetLocalRulestackChangeLogResult)
