...
def list_global_rulestack_countries_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20240119preview:listGlobalRulestackCountries', __args__, opts=opts, typ=ListGlobalRulestackCountriesResult)
