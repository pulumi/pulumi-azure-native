...
class PreRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] priority: Pre Rule priority
...
class PreRule(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PreRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PreRuleArgs.__new__(PreRuleArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PreRule':
        """
        ...
        __props__.__dict__["type"] = None
        return PreRule(resource_name, opts=opts, __props__=__props__)
