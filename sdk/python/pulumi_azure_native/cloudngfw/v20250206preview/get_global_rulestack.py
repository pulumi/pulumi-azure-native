...
def get_global_rulestack(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getGlobalRulestack', __args__, opts=opts, typ=GetGlobalRulestackResult).value
...
def get_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getGlobalRulestack', __args__, opts=opts, typ=GetGlobalRulestackResult)
