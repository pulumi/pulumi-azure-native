...
def get_fqdn_list_local_rulestack(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getFqdnListLocalRulestack', __args__, opts=opts, typ=GetFqdnListLocalRulestackResult).value
...
def get_fqdn_list_local_rulestack_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getFqdnListLocalRulestack', __args__, opts=opts, typ=GetFqdnListLocalRulestackResult)
