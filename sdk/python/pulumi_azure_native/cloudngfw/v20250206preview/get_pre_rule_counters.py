...
def get_pre_rule_counters(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getPreRuleCounters', __args__, opts=opts, typ=GetPreRuleCountersResult).value
...
def get_pre_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getPreRuleCounters', __args__, opts=opts, typ=GetPreRuleCountersResult)
