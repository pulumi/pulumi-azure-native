...
def get_prefix_list_global_rulestack(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getPrefixListGlobalRulestack', __args__, opts=opts, typ=GetPrefixListGlobalRulestackResult).value
...
def get_prefix_list_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getPrefixListGlobalRulestack', __args__, opts=opts, typ=GetPrefixListGlobalRulestackResult)
