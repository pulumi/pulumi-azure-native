...
def get_prefix_list_local_rulestack(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getPrefixListLocalRulestack', __args__, opts=opts, typ=GetPrefixListLocalRulestackResult).value
...
def get_prefix_list_local_rulestack_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getPrefixListLocalRulestack', __args__, opts=opts, typ=GetPrefixListLocalRulestackResult)
