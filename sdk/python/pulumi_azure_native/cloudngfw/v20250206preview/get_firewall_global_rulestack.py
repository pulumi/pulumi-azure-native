...
def get_firewall_global_rulestack(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getFirewallGlobalRulestack', __args__, opts=opts, typ=GetFirewallGlobalRulestackResult).value
...
def get_firewall_global_rulestack_output(firewall_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getFirewallGlobalRulestack', __args__, opts=opts, typ=GetFirewallGlobalRulestackResult)
