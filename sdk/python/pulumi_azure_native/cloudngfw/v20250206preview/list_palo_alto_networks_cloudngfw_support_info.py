...
def list_palo_alto_networks_cloudngfw_support_info(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListPaloAltoNetworksCloudngfwSupportInfoResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:listPaloAltoNetworksCloudngfwSupportInfo', __args__, opts=opts, typ=ListPaloAltoNetworksCloudngfwSupportInfoResult).value
...
def list_palo_alto_networks_cloudngfw_support_info_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListPaloAltoNetworksCloudngfwSupportInfoResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:listPaloAltoNetworksCloudngfwSupportInfo', __args__, opts=opts, typ=ListPaloAltoNetworksCloudngfwSupportInfoResult)
