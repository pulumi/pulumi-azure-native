...
def get_post_rule(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getPostRule', __args__, opts=opts, typ=GetPostRuleResult).value
...
def get_post_rule_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getPostRule', __args__, opts=opts, typ=GetPostRuleResult)
