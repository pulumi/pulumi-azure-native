...
def list_global_rulestack_countries(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:listGlobalRulestackCountries', __args__, opts=opts, typ=ListGlobalRulestackCountriesResult).value
...
def list_global_rulestack_countries_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:listGlobalRulestackCountries', __args__, opts=opts, typ=ListGlobalRulestackCountriesResult)
