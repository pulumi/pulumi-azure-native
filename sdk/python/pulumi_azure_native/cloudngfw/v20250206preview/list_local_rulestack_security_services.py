...
def list_local_rulestack_security_services(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:listLocalRulestackSecurityServices', __args__, opts=opts, typ=ListLocalRulestackSecurityServicesResult).value
...
def list_local_rulestack_security_services_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:listLocalRulestackSecurityServices', __args__, opts=opts, typ=ListLocalRulestackSecurityServicesResult)
