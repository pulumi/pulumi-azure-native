...
def get_local_rulestack_change_log(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20250206preview:getLocalRulestackChangeLog', __args__, opts=opts, typ=GetLocalRulestackChangeLogResult).value
...
def get_local_rulestack_change_log_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20250206preview:getLocalRulestackChangeLog', __args__, opts=opts, typ=GetLocalRulestackChangeLogResult)
