...
class GetFirewallSupportInfoResult:
    ...
    def account_id_for_billing(self) -> Optional[_builtins.str]:
        """
...
def get_firewall_support_info(email: Optional[_builtins.str] = None,
    ...
    :param _builtins.str email: email address on behalf of which this API called
...
def get_firewall_support_info_output(email: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
