...
def get_pre_rule(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20240207preview:getPreRule', __args__, opts=opts, typ=GetPreRuleResult).value
...
def get_pre_rule_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['priority'] = priority
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20240207preview:getPreRule', __args__, opts=opts, typ=GetPreRuleResult)
