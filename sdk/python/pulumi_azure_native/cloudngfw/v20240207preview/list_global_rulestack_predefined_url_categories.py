...
def list_global_rulestack_predefined_url_categories(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20240207preview:listGlobalRulestackPredefinedUrlCategories', __args__, opts=opts, typ=ListGlobalRulestackPredefinedUrlCategoriesResult).value
...
def list_global_rulestack_predefined_url_categories_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20240207preview:listGlobalRulestackPredefinedUrlCategories', __args__, opts=opts, typ=ListGlobalRulestackPredefinedUrlCategoriesResult)
