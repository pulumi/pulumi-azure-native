...
def list_local_rulestack_countries(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20240207preview:listLocalRulestackCountries', __args__, opts=opts, typ=ListLocalRulestackCountriesResult).value
...
def list_local_rulestack_countries_output(local_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20240207preview:listLocalRulestackCountries', __args__, opts=opts, typ=ListLocalRulestackCountriesResult)
