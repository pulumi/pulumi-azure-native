...
class Firewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 strata_cloud_manager_config: Optional[pulumi.Input[pulumi.InputType['StrataCloudManagerConfigArgs']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[pulumi.InputType['StrataCloudManagerConfigArgs']] strata_cloud_manager_config: Strata Cloud Manager Configuration, only applicable if Strata Cloud Manager is selected.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    @overload
