...
def get_prefix_list_local_rulestack(local_rulestack_name: Optional[_builtins.str] = None,
...
def get_prefix_list_local_rulestack_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
