...
def list_local_rulestack_advanced_security_objects(local_rulestack_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:listLocalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListLocalRulestackAdvancedSecurityObjectsResult).value

    return AwaitableListLocalRulestackAdvancedSecurityObjectsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_local_rulestack_advanced_security_objects_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:listLocalRulestackAdvancedSecurityObjects', __args__, opts=opts, typ=ListLocalRulestackAdvancedSecurityObjectsResult)
