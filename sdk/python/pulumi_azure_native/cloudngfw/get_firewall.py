...
class GetFirewallResult:
    ...
    def is_panorama_managed(self) -> Optional[builtins.str]:
        """
    ...
    def is_strata_cloud_managed(self) -> Optional[builtins.str]:
        """
...
def get_firewall(firewall_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getFirewall', __args__, opts=opts, typ=GetFirewallResult).value
...
def get_firewall_output(firewall_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:getFirewall', __args__, opts=opts, typ=GetFirewallResult)
