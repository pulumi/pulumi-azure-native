...
def get_firewall_global_rulestack(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829:getFirewallGlobalRulestack', __args__, opts=opts, typ=GetFirewallGlobalRulestackResult).value
