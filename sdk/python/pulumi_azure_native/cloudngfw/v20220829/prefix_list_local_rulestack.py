...
class PrefixListLocalRulestack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:cloudngfw/v20220829preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20230901preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20231010preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240119preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20240207preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw/v20250206preview:PrefixListLocalRulestack"), pulumi.Alias(type_="azure-native:cloudngfw:PrefixListLocalRulestack")])
