...
def get_certificate_object_local_rulestack(local_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829:getCertificateObjectLocalRulestack', __args__, opts=opts, typ=GetCertificateObjectLocalRulestackResult).value
