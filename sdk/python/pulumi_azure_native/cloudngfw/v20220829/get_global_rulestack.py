...
def get_global_rulestack(global_rulestack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829:getGlobalRulestack', __args__, opts=opts, typ=GetGlobalRulestackResult).value
...
def get_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['globalRulestackName'] = global_rulestack_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20220829:getGlobalRulestack', __args__, opts=opts, typ=GetGlobalRulestackResult)
