...
def get_local_rule_counters(firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw/v20220829:getLocalRuleCounters', __args__, opts=opts, typ=GetLocalRuleCountersResult).value
...
def get_local_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20220829:getLocalRuleCounters', __args__, opts=opts, typ=GetLocalRuleCountersResult)
