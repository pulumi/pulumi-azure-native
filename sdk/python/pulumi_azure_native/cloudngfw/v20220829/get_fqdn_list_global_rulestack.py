...
def get_fqdn_list_global_rulestack_output(global_rulestack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw/v20220829:getFqdnListGlobalRulestack', __args__, opts=opts, typ=GetFqdnListGlobalRulestackResult)
