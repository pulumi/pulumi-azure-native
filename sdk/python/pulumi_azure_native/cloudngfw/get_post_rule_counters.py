...
def get_post_rule_counters(firewall_name: Optional[_builtins.str] = None,
                           global_rulestack_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str priority: Post Rule priority
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cloudngfw:getPostRuleCounters', __args__, opts=opts, typ=GetPostRuleCountersResult).value
...
def get_post_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = None,
                                  priority: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPostRuleCountersResult]:
    """
    Get counters
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:cloudngfw:getPostRuleCounters', __args__, opts=opts, typ=GetPostRuleCountersResult)
    return __ret__.apply(lambda __response__: GetPostRuleCountersResult(
