...
def get_post_rule_counters(firewall_name: Optional[builtins.str] = None,
...
def get_post_rule_counters_output(firewall_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
