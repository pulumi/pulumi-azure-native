...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Experiment"), pulumi.Alias(type_="azure-native:batchai:Experiment"), pulumi.Alias(type_="azure-nextgen:batchai:Experiment")])
