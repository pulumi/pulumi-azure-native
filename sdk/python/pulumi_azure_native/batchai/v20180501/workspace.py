...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:batchai:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai:Workspace"), pulumi.Alias(type_="azure-native:batchai/latest:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai/latest:Workspace")])
