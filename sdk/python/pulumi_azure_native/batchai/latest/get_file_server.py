...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:getFileServer'.""", DeprecationWarning)
...
def get_file_server(file_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/latest:getFileServer', __args__, opts=opts, typ=GetFileServerResult).value
