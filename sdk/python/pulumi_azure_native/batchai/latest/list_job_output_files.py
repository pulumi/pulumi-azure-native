...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:listJobOutputFiles'.""", DeprecationWarning)
...
def list_job_output_files(directory: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/latest:listJobOutputFiles', __args__, opts=opts, typ=ListJobOutputFilesResult).value
