...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:batchai/latest:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/latest:Experiment":
                return Experiment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/latest:FileServer":
                return FileServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/latest:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/latest:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-native", "batchai/latest", _module_instance)
