...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:listClusterRemoteLoginInformation'.""", DeprecationWarning)
...
def list_cluster_remote_login_information(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_cluster_remote_login_information is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:listClusterRemoteLoginInformation'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/latest:listClusterRemoteLoginInformation', __args__, opts=opts, typ=ListClusterRemoteLoginInformationResult).value
