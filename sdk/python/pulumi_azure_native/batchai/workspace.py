...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai:Workspace"), pulumi.Alias(type_="azure-native:batchai/v20180501:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Workspace")])
