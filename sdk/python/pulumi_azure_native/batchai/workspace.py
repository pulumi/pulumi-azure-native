...
class Workspace(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai:Workspace"), pulumi.Alias(type_="azure-native:batchai/latest:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai/latest:Workspace"), pulumi.Alias(type_="azure-native:batchai/v20180501:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azure-native:batchai:Workspace',
            resource_name,
            __props__,
            opts)
