...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:batchai/v20180301:Job"), pulumi.Alias(type_="azure-nextgen:batchai/v20180301:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-native:batchai/v20170901preview:Job',
            resource_name,
            __props__,
            opts)
    ...
    def environment_variables(self) -> pulumi.Output[Optional[Sequence['outputs.EnvironmentSettingResponse']]]:
        """
