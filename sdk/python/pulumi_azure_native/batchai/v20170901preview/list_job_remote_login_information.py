...
def list_job_remote_login_information(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/v20170901preview:listJobRemoteLoginInformation', __args__, opts=opts, typ=ListJobRemoteLoginInformationResult).value
