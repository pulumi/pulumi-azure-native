...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentVariableArgs']]] environment_variables: Batch AI will setup these additional environment variables for the job.
        ...
        :param pulumi.Input['MountVolumesArgs'] mount_volumes: These volumes will be mounted before the job execution and will be unmounted after the job completion. The volumes will be mounted at location specified by $AZ_BATCHAI_JOB_MOUNT_ROOT environment variable.
        ...
        :param pulumi.Input['PyTorchSettingsArgs'] py_torch_settings: Specifies the settings for pyTorch job.
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentVariableWithSecretValueArgs']]] secrets: Batch AI will setup these additional environment variables for the job. Server will never report values of these variables back.
...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai/v20180301:Job"), pulumi.Alias(type_="azure-native:batchai/v20170901preview:Job"), pulumi.Alias(type_="azure-nextgen:batchai/v20170901preview:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-native:batchai/v20180301:Job',
            resource_name,
            __props__,
            opts)
