...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The image reference.
        :param str virtual_machine_image_id: The virtual machine image must be in the same region and subscription as the cluster. For information about the firewall settings for the Batch node agent to communicate with the Batch service see https://docs.microsoft.com/en-us/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration. Note, you need to provide publisher, offer and sku of the base OS image of which the custom image has been derived from.
        """
...
class InputDirectoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Input directory for the job.
        :param str id: The path of the input directory will be available as a value of an environment variable with AZ_BATCHAI_INPUT_<id> name, where <id> is the value of id attribute.
        """
...
class OutputDirectoryResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Output directory for the job.
        :param str id: The path of the output directory will be available as a value of an environment variable with AZ_BATCHAI_OUTPUT_<id> name, where <id> is the value of id attribute.
        :param str path_prefix: NOTE: This is an absolute path to prefix. E.g. $AZ_BATCHAI_MOUNT_ROOT/MyNFS/MyLogs. You can find the full path to the output directory by combining pathPrefix, jobOutputDirectoryPathSegment (reported by get job) and pathSuffix.
...
class PyTorchSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the settings for pyTorch job.
        :param str communication_backend: Valid values are 'TCP', 'Gloo' or 'MPI'. Not required for non-distributed jobs.
        :param int process_count: The default value for this property is equal to nodeCount property.
        """
        pulumi.set(__self__, "python_script_file_path", python_script_file_path)
        if command_line_args is not None:
...
class UnmanagedFileSystemReferenceResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Details of the file system to mount on the compute cluster nodes.
        :param str relative_mount_path: Note that all cluster level unmanaged file system will be mounted under $AZ_BATCHAI_MOUNT_ROOT location and job level unmanaged file system will be mounted under $AZ_BATCHAI_JOB_MOUNT_ROOT.
        """
