...
def get_deid_service(deid_service_name: Optional[builtins.str] = None,
...
def get_deid_service_output(deid_service_name: Optional[pulumi.Input[builtins.str]] = None,
