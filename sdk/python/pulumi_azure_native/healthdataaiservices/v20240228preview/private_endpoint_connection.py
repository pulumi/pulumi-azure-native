...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthdataaiservices:PrivateEndpointConnection")])
