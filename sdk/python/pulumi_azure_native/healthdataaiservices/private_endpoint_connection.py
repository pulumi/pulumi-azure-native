...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 deid_service_name: pulumi.Input[str],
        ...
        """
        pulumi.set(__self__, "deid_service_name", deid_service_name)
    ...
    @property
    @pulumi.getter(name="deidServiceName")
    def deid_service_name(self) -> pulumi.Input[str]:
        """
        The name of the deid service
        """
        return pulumi.get(self, "deid_service_name")

    @deid_service_name.setter
    def deid_service_name(self, value: pulumi.Input[str]):
        pulumi.set(self, "deid_service_name", value)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deid_service_name: Optional[pulumi.Input[str]] = None,
                 private_endpoint_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if deid_service_name is None and not opts.urn:
                raise TypeError("Missing required property 'deid_service_name'")
            __props__.__dict__["deid_service_name"] = deid_service_name
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:healthdataaiservices/v20240228preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:healthdataaiservices/v20240920:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_healthdataaiservices_v20240228preview:healthdataaiservices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_healthdataaiservices_v20240920:healthdataaiservices:PrivateEndpointConnection")])
