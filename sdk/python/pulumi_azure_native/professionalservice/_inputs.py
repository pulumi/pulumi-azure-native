...
class ProfessionalServiceCreationPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] publisher_id: The publisher id.
        :param pulumi.Input[_builtins.str] quote_id: The quote id which the ProfessionalService will be purchase with.
        :param pulumi.Input[_builtins.str] sku_id: The plan id.
        :param pulumi.Input[_builtins.str] store_front: The store front which initiates the purchase.
        :param pulumi.Input[_builtins.str] term_unit: The unit term eg P1M,P1Y,P2Y,P3Y meaning month,1year,2year,3year respectively
        """
