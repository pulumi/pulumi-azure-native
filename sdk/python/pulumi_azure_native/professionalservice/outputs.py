...
class ProfessionalServiceResourceResponseProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 quote_id: Optional[_builtins.str] = None,
                 sku_id: Optional[_builtins.str] = None,
                 status: Optional[_builtins.str] = None,
                 store_front: Optional[_builtins.str] = None,
        ...
        :param Mapping[str, _builtins.str] payment_channel_metadata: The metadata about the ProfessionalService subscription such as the AzureSubscriptionId and ResourceUri.
        :param _builtins.str payment_channel_type: The Payment channel for the ProfessionalServiceSubscription.
        :param _builtins.str publisher_id: The publisher id.
        :param _builtins.str quote_id: The quote id which the ProfessionalService will be purchase with.
        :param _builtins.str sku_id: The plan id.
        :param _builtins.str status: The ProfessionalService Subscription Status.
        :param _builtins.str store_front: The store front which initiates the purchase.
