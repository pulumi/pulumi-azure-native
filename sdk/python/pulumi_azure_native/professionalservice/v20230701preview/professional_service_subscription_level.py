...
class ProfessionalServiceSubscriptionLevelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] subscription_id: The Azure subscription ID. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000)
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: the resource tags.
        """
        ProfessionalServiceSubscriptionLevelArgs._configure(
...
class ProfessionalServiceSubscriptionLevel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['ProfessionalServiceCreationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] location: Resource location. Only value allowed for ProfessionalService is 'global'
        :param pulumi.Input[str] name: The resource name
        :param pulumi.Input[pulumi.InputType['ProfessionalServiceCreationPropertiesArgs']] properties: Properties of the ProfessionalService resource that are relevant for creation.
        :param pulumi.Input[str] resource_group_name: The name of the resource group.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ProfessionalServiceSubscriptionLevelArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ProfessionalServiceCreationPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ProfessionalServiceCreationPropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:professionalservice:ProfessionalServiceSubscriptionLevel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProfessionalServiceSubscriptionLevel, __self__).__init__(
            'azure-native:professionalservice/v20230701preview:ProfessionalServiceSubscriptionLevel',
            resource_name,
            __props__,
            opts)
