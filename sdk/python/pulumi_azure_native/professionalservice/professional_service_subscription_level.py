...
class ProfessionalServiceSubscriptionLevelArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ProfessionalServiceCreationPropertiesArgs']]:
        """
...
class ProfessionalServiceSubscriptionLevel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ProfessionalServiceCreationPropertiesArgs', 'ProfessionalServiceCreationPropertiesArgsDict']]] = None,
