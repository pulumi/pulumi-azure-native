...
def list_iot_hub_resource_keys_for_key_name(key_name: Optional[_builtins.str] = None,
...
def list_iot_hub_resource_keys_for_key_name_output(key_name: Optional[pulumi.Input[_builtins.str]] = None,
