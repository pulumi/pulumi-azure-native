...
def list_iot_hub_resource_keys(resource_group_name: Optional[_builtins.str] = None,
...
def list_iot_hub_resource_keys_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
