...
def get_iot_hub_resource(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iothub/v20230630preview:getIotHubResource', __args__, opts=opts, typ=GetIotHubResourceResult).value
...
def get_iot_hub_resource_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iothub/v20230630preview:getIotHubResource', __args__, opts=opts, typ=GetIotHubResourceResult)
