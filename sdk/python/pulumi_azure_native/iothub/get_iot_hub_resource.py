...
def get_iot_hub_resource(resource_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_name: The name of the IoT hub.
    """
    __args__ = dict()
...
def get_iot_hub_resource_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
