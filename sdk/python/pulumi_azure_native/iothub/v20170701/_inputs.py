...
__all__ = [
    ...
    'OperationsMonitoringPropertiesArgsDict',
    'RoutePropertiesArgs',
...
if not MYPY:
    class IotHubPropertiesArgsDict(TypedDict):
        ...
        """
        operations_monitoring_properties: NotRequired[pulumi.Input['OperationsMonitoringPropertiesArgsDict']]
        """
...
if not MYPY:
    class OperationsMonitoringPropertiesArgsDict(TypedDict):
        """
        The operations monitoring properties for the IoT hub. The possible keys to the dictionary are Connections, DeviceTelemetry, C2DCommands, DeviceIdentityOperations, FileUploadOperations, Routes, D2CTwinOperations, C2DTwinOperations, TwinQueries, JobsOperations, DirectMethods.
        """
        events: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[Union[str, 'OperationMonitoringLevel']]]]]
elif False:
    OperationsMonitoringPropertiesArgsDict: TypeAlias = Mapping[str, Any]
