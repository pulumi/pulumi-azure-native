...
def get_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iothub/v20200401:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
...
def get_certificate_output(certificate_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:iothub/v20200401:getCertificate', __args__, opts=opts, typ=GetCertificateResult)
