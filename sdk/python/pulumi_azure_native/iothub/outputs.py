...
class ArmIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str principal_id: Principal Id
...
class CertificatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The description of an X509 CA Certificate.
        :param builtins.str created: The certificate's create date and time.
        ...
        :param builtins.str certificate: The certificate content
...
class CloudToDevicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 default_ttl_as_iso8601: Optional[builtins.str] = None,
                 feedback: Optional['outputs.FeedbackPropertiesResponse'] = None,
                 max_delivery_count: Optional[builtins.int] = None):
        """
        The IoT hub cloud-to-device messaging properties.
        :param builtins.str default_ttl_as_iso8601: The default time to live for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param 'FeedbackPropertiesResponse' feedback: The properties of the feedback queue for cloud-to-device messages.
        :param builtins.int max_delivery_count: The max delivery count for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def default_ttl_as_iso8601(self) -> Optional[builtins.str]:
        """
...
class EnrichmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of an enrichment that your IoT hub applies to messages delivered to endpoints.
        :param Sequence[builtins.str] endpoint_names: The list of endpoints for which the enrichment is applied to the message.
        :param builtins.str key: The key or name for the enrichment property.
        :param builtins.str value: The value for the enrichment property.
        """
...
class EventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 partition_ids: Sequence[builtins.str],
                 path: builtins.str,
                 partition_count: Optional[builtins.int] = None,
                 retention_time_in_days: Optional[builtins.float] = None):
        """
        The properties of the provisioned Event Hub-compatible endpoint used by the IoT hub.
        :param builtins.str endpoint: The Event Hub-compatible endpoint.
        :param Sequence[builtins.str] partition_ids: The partition ids in the Event Hub-compatible endpoint.
        :param builtins.str path: The Event Hub-compatible name.
        :param builtins.int partition_count: The number of partitions for receiving device-to-cloud messages in the Event Hub-compatible endpoint. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages.
        :param builtins.float retention_time_in_days: The retention time for device-to-cloud messages in days. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages
        """
    ...
    def retention_time_in_days(self) -> Optional[builtins.float]:
        """
...
class FallbackRoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of the fallback route. IoT Hub uses these properties when it routes messages to the fallback endpoint.
        :param Sequence[builtins.str] endpoint_names: The list of endpoints to which the messages that satisfy the condition are routed to. Currently only 1 endpoint is allowed.
        :param builtins.bool is_enabled: Used to specify whether the fallback route is enabled.
        :param builtins.str source: The source to which the routing rule is to be applied to. For example, DeviceMessages
        :param builtins.str condition: The condition which is evaluated in order to apply the fallback route. If the condition is not provided it will evaluate to true by default. For grammar, See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
        :param builtins.str name: The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.
        """
        pulumi.set(__self__, "endpoint_names", endpoint_names)
...
class FeedbackPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 lock_duration_as_iso8601: Optional[builtins.str] = None,
                 max_delivery_count: Optional[builtins.int] = None,
                 ttl_as_iso8601: Optional[builtins.str] = None):
        """
        The properties of the feedback queue for cloud-to-device messages.
        :param builtins.str lock_duration_as_iso8601: The lock duration for the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param builtins.int max_delivery_count: The number of times the IoT hub attempts to deliver a message on the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param builtins.str ttl_as_iso8601: The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def lock_duration_as_iso8601(self) -> Optional[builtins.str]:
        """
    ...
    def ttl_as_iso8601(self) -> Optional[builtins.str]:
        """
...
class IotHubLocationDescriptionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role: The role of the region, can be either primary or secondary. The primary region is where the IoT hub is currently provisioned. The secondary region is the Azure disaster recovery (DR) paired region and also the region where the IoT hub can failover to.
        """
...
class IotHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_device_sas: Optional[builtins.bool] = None,
                 disable_local_auth: Optional[builtins.bool] = None,
                 disable_module_sas: Optional[builtins.bool] = None,
                 enable_data_residency: Optional[builtins.bool] = None,
                 enable_file_upload_notifications: Optional[builtins.bool] = None,
        ...
        :param builtins.str state: The hub state.
        :param Sequence[builtins.str] allowed_fqdn_list: List of allowed FQDNs(Fully Qualified Domain Name) for egress from Iot Hub.
        ...
        :param builtins.str comments: IoT hub comments.
        :param builtins.bool disable_device_sas: If true, all device(including Edge devices but excluding modules) scoped SAS keys cannot be used for authentication.
        :param builtins.bool disable_local_auth: If true, SAS tokens with Iot hub scoped SAS keys cannot be used for authentication.
        :param builtins.bool disable_module_sas: If true, all module scoped SAS keys cannot be used for authentication.
        :param builtins.bool enable_data_residency: This property when set to true, will enable data residency, thus, disabling disaster recovery.
        :param builtins.bool enable_file_upload_notifications: If True, file upload notifications are enabled.
        ...
        :param builtins.str features: The capabilities and features enabled for the IoT hub.
        ...
        :param builtins.str min_tls_version: Specifies the minimum TLS version to support for this hub. Can be set to "1.2" to have clients that use a TLS version below 1.2 to be rejected.
        ...
        :param builtins.bool restrict_outbound_network_access: If true, egress from IotHub will be restricted to only the allowed FQDNs that are configured via allowedFqdnList.
    ...
    def disable_device_sas(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_module_sas(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_file_upload_notifications(self) -> Optional[builtins.bool]:
        """
...
class IotHubSkuInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str tier: The billing tier for the IoT hub.
        :param builtins.float capacity: The number of provisioned IoT Hub units. See: https://docs.microsoft.com/azure/azure-subscription-service-limits#iot-hub-limits.
        """
        pulumi.set(__self__, "name", name)
...
class ManagedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of the Managed identity.
        :param builtins.str user_assigned_identity: The user assigned identity.
        """
...
class MessagingEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of the messaging endpoints used by this IoT hub.
        :param builtins.str lock_duration_as_iso8601: The lock duration. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        :param builtins.int max_delivery_count: The number of times the IoT hub attempts to deliver a message. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        :param builtins.str ttl_as_iso8601: The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        """
        if lock_duration_as_iso8601 is not None:
            pulumi.set(__self__, "lock_duration_as_iso8601", lock_duration_as_iso8601)
        if max_delivery_count is not None:
...
class NetworkRuleSetIpRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        IP Rule to be applied as part of Network Rule Set
        :param builtins.str filter_name: Name of the IP filter rule.
        :param builtins.str ip_mask: A string that contains the IP address range in CIDR notation for the rule.
        :param builtins.str action: IP Filter Action
        """
        pulumi.set(__self__, "filter_name", filter_name)
        pulumi.set(__self__, "ip_mask", ip_mask)
        if action is None:
...
class NetworkRuleSetPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Network Rule Set Properties of IotHub
        :param builtins.bool apply_to_built_in_event_hub_endpoint: If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
        :param Sequence['NetworkRuleSetIpRuleResponse'] ip_rules: List of IP Rules
        :param builtins.str default_action: Default Action for Network Rule Set
        """
    ...
    def apply_to_built_in_event_hub_endpoint(self) -> builtins.bool:
        """
...
class RoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of a routing rule that your IoT hub uses to route messages to endpoints.
        :param Sequence[builtins.str] endpoint_names: The list of endpoints to which messages that satisfy the condition are routed. Currently only one endpoint is allowed.
        :param builtins.bool is_enabled: Used to specify whether a route is enabled.
        :param builtins.str name: The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.
        :param builtins.str source: The source that the routing rule is to be applied to, such as DeviceMessages.
        :param builtins.str condition: The condition that is evaluated to apply the routing rule. If no condition is provided, it evaluates to true by default. For grammar, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
        """
        pulumi.set(__self__, "endpoint_names", endpoint_names)
        pulumi.set(__self__, "is_enabled", is_enabled)
        pulumi.set(__self__, "name", name)
...
class RoutingCosmosDBSqlApiPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 partition_key_name: Optional[builtins.str] = None,
                 partition_key_template: Optional[builtins.str] = None,
        ...
        """
        The properties related to a cosmos DB sql container endpoint.
        :param builtins.str container_name: The name of the cosmos DB sql container in the cosmos DB database.
        :param builtins.str database_name: The name of the cosmos DB database in the cosmos DB account.
        :param builtins.str endpoint_uri: The url of the cosmos DB account. It must include the protocol https://
        :param builtins.str id: Id of the cosmos DB sql container endpoint
        :param builtins.str name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param builtins.str authentication_type: Method used to authenticate against the cosmos DB sql container endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing cosmos DB container endpoint.
        :param builtins.str partition_key_name: The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter.
        :param builtins.str partition_key_template: The template for generating a synthetic partition key value for use with this cosmos DB sql container. The template must include at least one of the following placeholders: {iothub}, {deviceid}, {DD}, {MM}, and {YYYY}. Any one placeholder may be specified at most once, but order and non-placeholder components are arbitrary. This parameter is only required if PartitionKeyName is specified.
        :param builtins.str primary_key: The primary key of the cosmos DB account.
        :param builtins.str resource_group: The name of the resource group of the cosmos DB account.
        :param builtins.str secondary_key: The secondary key of the cosmos DB account.
        :param builtins.str subscription_id: The subscription identifier of the cosmos DB account.
        """
    ...
    def partition_key_name(self) -> Optional[builtins.str]:
        """
    ...
    def partition_key_template(self) -> Optional[builtins.str]:
        """
...
class RoutingEventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        The properties related to an event hub endpoint.
        :param builtins.str name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param builtins.str authentication_type: Method used to authenticate against the event hub endpoint
        :param builtins.str connection_string: The connection string of the event hub endpoint. 
        :param builtins.str endpoint_uri: The url of the event hub endpoint. It must include the protocol sb://
        :param builtins.str entity_path: Event hub name on the event hub namespace
        :param builtins.str id: Id of the event hub endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing event hub endpoint.
        :param builtins.str resource_group: The name of the resource group of the event hub endpoint.
        :param builtins.str subscription_id: The subscription identifier of the event hub endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingServiceBusQueueEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties related to service bus queue endpoint types.
        :param builtins.str name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types. The name need not be the same as the actual queue name.
        :param builtins.str authentication_type: Method used to authenticate against the service bus queue endpoint
        :param builtins.str connection_string: The connection string of the service bus queue endpoint.
        :param builtins.str endpoint_uri: The url of the service bus queue endpoint. It must include the protocol sb://
        :param builtins.str entity_path: Queue name on the service bus namespace
        :param builtins.str id: Id of the service bus queue endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing service bus queue endpoint.
        :param builtins.str resource_group: The name of the resource group of the service bus queue endpoint.
        :param builtins.str subscription_id: The subscription identifier of the service bus queue endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingServiceBusTopicEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str authentication_type: Method used to authenticate against the service bus topic endpoint
        :param builtins.str connection_string: The connection string of the service bus topic endpoint.
        :param builtins.str endpoint_uri: The url of the service bus topic endpoint. It must include the protocol sb://
        :param builtins.str entity_path: Queue name on the service bus topic
        :param builtins.str id: Id of the service bus topic endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing service bus topic endpoint.
        :param builtins.str resource_group: The name of the resource group of the service bus topic endpoint.
        :param builtins.str subscription_id: The subscription identifier of the service bus topic endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingStorageContainerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties related to a storage container endpoint.
        :param builtins.str container_name: The name of storage container in the storage account.
        :param builtins.str name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param builtins.str authentication_type: Method used to authenticate against the storage endpoint
        :param builtins.int batch_frequency_in_seconds: Time interval at which blobs are written to storage. Value should be between 60 and 720 seconds. Default value is 300 seconds.
        :param builtins.str connection_string: The connection string of the storage account.
        :param builtins.str encoding: Encoding that is used to serialize messages to blobs. Supported values are 'avro', 'avrodeflate', and 'JSON'. Default value is 'avro'.
        :param builtins.str endpoint_uri: The url of the storage endpoint. It must include the protocol https://
        :param builtins.str file_name_format: File name format for the blob. Default format is {iothub}/{partition}/{YYYY}/{MM}/{DD}/{HH}/{mm}. All parameters are mandatory but can be reordered.
        :param builtins.str id: Id of the storage container endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing storage endpoint.
        :param builtins.int max_chunk_size_in_bytes: Maximum number of bytes for each blob written to storage. Value should be between 10485760(10MB) and 524288000(500MB). Default value is 314572800(300MB).
        :param builtins.str resource_group: The name of the resource group of the storage account.
        :param builtins.str subscription_id: The subscription identifier of the storage account.
        """
        pulumi.set(__self__, "container_name", container_name)
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
...
class SharedAccessSignatureAuthorizationRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str rights: The permissions assigned to the shared access policy.
...
class StorageEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authentication_type: Optional[builtins.str] = None,
                 identity: Optional['outputs.ManagedIdentityResponse'] = None,
                 sas_ttl_as_iso8601: Optional[builtins.str] = None):
        """
        The properties of the Azure Storage endpoint for file upload.
        :param builtins.str connection_string: The connection string for the Azure Storage account to which files are uploaded.
        :param builtins.str container_name: The name of the root container where you upload files. The container need not exist but should be creatable using the connectionString specified.
        :param builtins.str authentication_type: Specifies authentication type being used for connecting to the storage account.
        :param 'ManagedIdentityResponse' identity: Managed identity properties of storage endpoint for file upload.
        :param builtins.str sas_ttl_as_iso8601: The period of time for which the SAS URI generated by IoT Hub for file upload is valid. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.
        """
        pulumi.set(__self__, "connection_string", connection_string)
        pulumi.set(__self__, "container_name", container_name)
        if authentication_type is not None:
    ...
    def sas_ttl_as_iso8601(self) -> Optional[builtins.str]:
        """
