...
class ArmIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str principal_id: Principal Id
...
class CertificatePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str certificate: The certificate content
...
class CloudToDevicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 default_ttl_as_iso8601: Optional[_builtins.str] = None,
...
class EventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: _builtins.str,
                 partition_count: Optional[_builtins.int] = None,
        ...
        :param _builtins.int partition_count: The number of partitions for receiving device-to-cloud messages in the Event Hub-compatible endpoint. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages.
        :param _builtins.float retention_time_in_days: The retention time for device-to-cloud messages in days. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages
        """
...
class FallbackRoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str condition: The condition which is evaluated in order to apply the fallback route. If the condition is not provided it will evaluate to true by default. For grammar, See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
...
class FeedbackPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 lock_duration_as_iso8601: Optional[_builtins.str] = None,
                 max_delivery_count: Optional[_builtins.int] = None,
...
class IotHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_device_sas: Optional[_builtins.bool] = None,
                 disable_local_auth: Optional[_builtins.bool] = None,
                 disable_module_sas: Optional[_builtins.bool] = None,
                 enable_data_residency: Optional[_builtins.bool] = None,
                 enable_file_upload_notifications: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str state: The hub state.
        :param Sequence[_builtins.str] allowed_fqdn_list: List of allowed FQDNs(Fully Qualified Domain Name) for egress from Iot Hub.
        ...
        :param _builtins.str comments: IoT hub comments.
        :param _builtins.bool disable_device_sas: If true, all device(including Edge devices but excluding modules) scoped SAS keys cannot be used for authentication.
        :param _builtins.bool disable_local_auth: If true, SAS tokens with Iot hub scoped SAS keys cannot be used for authentication.
        :param _builtins.bool disable_module_sas: If true, all module scoped SAS keys cannot be used for authentication.
        :param _builtins.bool enable_data_residency: This property when set to true, will enable data residency, thus, disabling disaster recovery.
        :param _builtins.bool enable_file_upload_notifications: If True, file upload notifications are enabled.
        ...
        :param _builtins.str features: The capabilities and features enabled for the IoT hub.
        ...
        :param _builtins.str min_tls_version: Specifies the minimum TLS version to support for this hub. Can be set to "1.2" to have clients that use a TLS version below 1.2 to be rejected.
        ...
        :param _builtins.bool restrict_outbound_network_access: If true, egress from IotHub will be restricted to only the allowed FQDNs that are configured via allowedFqdnList.
...
class RoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.
        :param _builtins.str source: The source that the routing rule is to be applied to, such as DeviceMessages.
        :param _builtins.str condition: The condition that is evaluated to apply the routing rule. If no condition is provided, it evaluates to true by default. For grammar, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
        """
        pulumi.set(__self__, "endpoint_names", endpoint_names)
        pulumi.set(__self__, "is_enabled", is_enabled)
        pulumi.set(__self__, "name", name)
...
class RoutingCosmosDBSqlApiPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 partition_key_name: Optional[_builtins.str] = None,
                 partition_key_template: Optional[_builtins.str] = None,
        ...
        :param _builtins.str id: Id of the cosmos DB sql container endpoint
        ...
        :param _builtins.str authentication_type: Method used to authenticate against the cosmos DB sql container endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing cosmos DB container endpoint.
        :param _builtins.str partition_key_name: The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter.
        :param _builtins.str partition_key_template: The template for generating a synthetic partition key value for use with this cosmos DB sql container. The template must include at least one of the following placeholders: {iothub}, {deviceid}, {DD}, {MM}, and {YYYY}. Any one placeholder may be specified at most once, but order and non-placeholder components are arbitrary. This parameter is only required if PartitionKeyName is specified.
        :param _builtins.str primary_key: The primary key of the cosmos DB account.
        :param _builtins.str resource_group: The name of the resource group of the cosmos DB account.
        :param _builtins.str secondary_key: The secondary key of the cosmos DB account.
        :param _builtins.str subscription_id: The subscription identifier of the cosmos DB account.
        """
...
class RoutingEventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_group: The name of the resource group of the event hub endpoint.
        :param _builtins.str subscription_id: The subscription identifier of the event hub endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingServiceBusQueueEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str endpoint_uri: The url of the service bus queue endpoint. It must include the protocol sb://
        :param _builtins.str entity_path: Queue name on the service bus namespace
        :param _builtins.str id: Id of the service bus queue endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing service bus queue endpoint.
        :param _builtins.str resource_group: The name of the resource group of the service bus queue endpoint.
        :param _builtins.str subscription_id: The subscription identifier of the service bus queue endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingServiceBusTopicEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str endpoint_uri: The url of the service bus topic endpoint. It must include the protocol sb://
        :param _builtins.str entity_path: Queue name on the service bus topic
        :param _builtins.str id: Id of the service bus topic endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing service bus topic endpoint.
        :param _builtins.str resource_group: The name of the resource group of the service bus topic endpoint.
        :param _builtins.str subscription_id: The subscription identifier of the service bus topic endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingStorageContainerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int batch_frequency_in_seconds: Time interval at which blobs are written to storage. Value should be between 60 and 720 seconds. Default value is 300 seconds.
        :param _builtins.str connection_string: The connection string of the storage account.
        :param _builtins.str encoding: Encoding that is used to serialize messages to blobs. Supported values are 'avro', 'avrodeflate', and 'JSON'. Default value is 'avro'.
        :param _builtins.str endpoint_uri: The url of the storage endpoint. It must include the protocol https://
        :param _builtins.str file_name_format: File name format for the blob. Default format is {iothub}/{partition}/{YYYY}/{MM}/{DD}/{HH}/{mm}. All parameters are mandatory but can be reordered.
        :param _builtins.str id: Id of the storage container endpoint
        :param 'ManagedIdentityResponse' identity: Managed identity properties of routing storage endpoint.
        :param _builtins.int max_chunk_size_in_bytes: Maximum number of bytes for each blob written to storage. Value should be between 10485760(10MB) and 524288000(500MB). Default value is 314572800(300MB).
        :param _builtins.str resource_group: The name of the resource group of the storage account.
        :param _builtins.str subscription_id: The subscription identifier of the storage account.
        """
        pulumi.set(__self__, "container_name", container_name)
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
...
class StorageEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sas_ttl_as_iso8601: The period of time for which the SAS URI generated by IoT Hub for file upload is valid. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.
        """
        pulumi.set(__self__, "connection_string", connection_string)
        pulumi.set(__self__, "container_name", container_name)
        if authentication_type is not None:
