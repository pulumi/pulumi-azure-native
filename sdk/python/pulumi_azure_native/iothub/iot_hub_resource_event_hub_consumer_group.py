...
class IotHubResourceEventHubConsumerGroupArgs:
    def __init__(__self__, *,
                 event_hub_endpoint_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] event_hub_endpoint_name: The name of the Event Hub-compatible endpoint in the IoT hub.
        ...
        :param pulumi.Input[builtins.str] name: The name of the consumer group to add.
        """
    ...
    def event_hub_endpoint_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_hub_endpoint_name(self, value: pulumi.Input[builtins.str]):
...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 event_hub_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
