...
class CloudToDevicePropertiesArgsDict(TypedDict):
    ...
    """
    default_ttl_as_iso8601: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The default time to live for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
    """
    feedback: NotRequired[pulumi.Input[Optional['FeedbackPropertiesArgs']]]
    """
...
class CloudToDevicePropertiesArgs:
    def __init__(__self__, *,
                 default_ttl_as_iso8601: pulumi.Input[Optional[_builtins.str]] = None,
                 feedback: pulumi.Input[Optional['FeedbackPropertiesArgs']] = None,
                 max_delivery_count: pulumi.Input[Optional[_builtins.int]] = None):
        """
        The IoT hub cloud-to-device messaging properties.

        :param pulumi.Input[_builtins.str] default_ttl_as_iso8601: The default time to live for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param pulumi.Input['FeedbackPropertiesArgs'] feedback: The properties of the feedback queue for cloud-to-device messages.
        :param pulumi.Input[_builtins.int] max_delivery_count: The max delivery count for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def default_ttl_as_iso8601(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The default time to live for cloud-to-device messages in the device queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def default_ttl_as_iso8601(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_ttl_as_iso8601", value)

    @_builtins.property
    @pulumi.getter
    def feedback(self) -> pulumi.Input[Optional['FeedbackPropertiesArgs']]:
        """
        The properties of the feedback queue for cloud-to-device messages.
        """
    ...
    @feedback.setter
    def feedback(self, value: pulumi.Input[Optional['FeedbackPropertiesArgs']]):
...
class EnrichmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] endpoint_names: The list of endpoints for which the enrichment is applied to the message.
        :param pulumi.Input[_builtins.str] key: The key or name for the enrichment property.
        :param pulumi.Input[_builtins.str] value: The value for the enrichment property.
        """
...
class EventHubConsumerGroupNameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: EventHub consumer group name
        """
...
class EventHubPropertiesArgsDict(TypedDict):
    ...
    """
    partition_count: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The number of partitions for receiving device-to-cloud messages in the Event Hub-compatible endpoint. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages.
    """
    retention_time_in_days: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    """
...
class EventHubPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 retention_time_in_days: pulumi.Input[Optional[_builtins.float]] = None):
        """
        The properties of the provisioned Event Hub-compatible endpoint used by the IoT hub.

        :param pulumi.Input[_builtins.int] partition_count: The number of partitions for receiving device-to-cloud messages in the Event Hub-compatible endpoint. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages.
        :param pulumi.Input[_builtins.float] retention_time_in_days: The retention time for device-to-cloud messages in days. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages
        """
    ...
    def retention_time_in_days(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The retention time for device-to-cloud messages in days. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#device-to-cloud-messages
        """
    ...
    def retention_time_in_days(self, value: pulumi.Input[Optional[_builtins.float]]):
...
class FallbackRoutePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] endpoint_names: The list of endpoints to which the messages that satisfy the condition are routed to. Currently only 1 endpoint is allowed.
        :param pulumi.Input[_builtins.bool] is_enabled: Used to specify whether the fallback route is enabled.
        :param pulumi.Input[Union[_builtins.str, 'RoutingSource']] source: The source to which the routing rule is to be applied to. For example, DeviceMessages
        :param pulumi.Input[_builtins.str] condition: The condition which is evaluated in order to apply the fallback route. If the condition is not provided it will evaluate to true by default. For grammar, See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
        :param pulumi.Input[_builtins.str] name: The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.
        """
        pulumi.set(__self__, "endpoint_names", endpoint_names)
...
class FeedbackPropertiesArgsDict(TypedDict):
    ...
    The properties of the feedback queue for cloud-to-device messages.
    """
    lock_duration_as_iso8601: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    ttl_as_iso8601: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class FeedbackPropertiesArgs:
    def __init__(__self__, *,
                 lock_duration_as_iso8601: pulumi.Input[Optional[_builtins.str]] = None,
                 max_delivery_count: pulumi.Input[Optional[_builtins.int]] = None,
                 ttl_as_iso8601: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The properties of the feedback queue for cloud-to-device messages.

        :param pulumi.Input[_builtins.str] lock_duration_as_iso8601: The lock duration for the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param pulumi.Input[_builtins.int] max_delivery_count: The number of times the IoT hub attempts to deliver a message on the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        :param pulumi.Input[_builtins.str] ttl_as_iso8601: The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def lock_duration_as_iso8601(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The lock duration for the feedback queue. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def lock_duration_as_iso8601(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def ttl_as_iso8601(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
        """
    ...
    def ttl_as_iso8601(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class IotHubPropertiesArgsDict(TypedDict):
    ...
    """
    authorization_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SharedAccessSignatureAuthorizationRuleArgs']]]]]
    """
    The shared access policies you can use to secure a connection to the IoT hub.
    """
    cloud_to_device: NotRequired[pulumi.Input[Optional['CloudToDevicePropertiesArgs']]]
    """
    The IoT hub cloud-to-device messaging properties.
    """
    ...
    IoT hub comments.
    """
    disable_device_sas: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    disable_module_sas: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    enable_file_upload_notifications: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    If True, file upload notifications are enabled.
    """
    event_hub_endpoints: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['EventHubPropertiesArgs']]]]]
    """
    The Event Hub-compatible endpoint properties. The only possible keys to this dictionary is events. This key has to be present in the dictionary while making create or update calls for the IoT hub.
    """
    features: NotRequired[pulumi.Input[Optional[Union[_builtins.str, 'Capabilities']]]]
    """
    The capabilities and features enabled for the IoT hub.
    """
    ip_filter_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['IpFilterRuleArgs']]]]]
    """
    The IP filter rules.
    """
    messaging_endpoints: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['MessagingEndpointPropertiesArgs']]]]]
    """
    ...
    """
    network_rule_sets: NotRequired[pulumi.Input[Optional['NetworkRuleSetPropertiesArgs']]]
    """
    Network Rule Set Properties of IotHub
    """
    private_endpoint_connections: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['PrivateEndpointConnectionArgs']]]]]
    """
    ...
    """
    routing: NotRequired[pulumi.Input[Optional['RoutingPropertiesArgs']]]
    """
    The routing related properties of the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging
    """
    storage_endpoints: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['StorageEndpointPropertiesArgs']]]]]
    """
...
class IotHubPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 authorization_policies: pulumi.Input[Optional[Sequence[pulumi.Input['SharedAccessSignatureAuthorizationRuleArgs']]]] = None,
                 cloud_to_device: pulumi.Input[Optional['CloudToDevicePropertiesArgs']] = None,
                 comments: pulumi.Input[Optional[_builtins.str]] = None,
                 disable_device_sas: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_local_auth: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_module_sas: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_data_residency: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_file_upload_notifications: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_hub_endpoints: pulumi.Input[Optional[Mapping[str, pulumi.Input['EventHubPropertiesArgs']]]] = None,
                 features: pulumi.Input[Optional[Union[_builtins.str, 'Capabilities']]] = None,
                 ip_filter_rules: pulumi.Input[Optional[Sequence[pulumi.Input['IpFilterRuleArgs']]]] = None,
                 messaging_endpoints: pulumi.Input[Optional[Mapping[str, pulumi.Input['MessagingEndpointPropertiesArgs']]]] = None,
                 min_tls_version: pulumi.Input[Optional[_builtins.str]] = None,
                 network_rule_sets: pulumi.Input[Optional['NetworkRuleSetPropertiesArgs']] = None,
                 ...
                 routing: pulumi.Input[Optional['RoutingPropertiesArgs']] = None,
                 storage_endpoints: pulumi.Input[Optional[Mapping[str, pulumi.Input['StorageEndpointPropertiesArgs']]]] = None):
        """
        The properties of an IoT hub.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_fqdn_list: List of allowed FQDNs(Fully Qualified Domain Name) for egress from Iot Hub.
        ...
        :param pulumi.Input[_builtins.str] comments: IoT hub comments.
        :param pulumi.Input[_builtins.bool] disable_device_sas: If true, all device(including Edge devices but excluding modules) scoped SAS keys cannot be used for authentication.
        :param pulumi.Input[_builtins.bool] disable_local_auth: If true, SAS tokens with Iot hub scoped SAS keys cannot be used for authentication.
        :param pulumi.Input[_builtins.bool] disable_module_sas: If true, all module scoped SAS keys cannot be used for authentication.
        :param pulumi.Input[_builtins.bool] enable_data_residency: This property when set to true, will enable data residency, thus, disabling disaster recovery.
        :param pulumi.Input[_builtins.bool] enable_file_upload_notifications: If True, file upload notifications are enabled.
        ...
        :param pulumi.Input[Union[_builtins.str, 'Capabilities']] features: The capabilities and features enabled for the IoT hub.
        ...
        :param pulumi.Input[_builtins.str] min_tls_version: Specifies the minimum TLS version to support for this hub. Can be set to "1.2" to have clients that use a TLS version below 1.2 to be rejected.
        ...
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Whether requests from Public Network are allowed
        :param pulumi.Input[_builtins.bool] restrict_outbound_network_access: If true, egress from IotHub will be restricted to only the allowed FQDNs that are configured via allowedFqdnList.
    ...
    def authorization_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SharedAccessSignatureAuthorizationRuleArgs']]]]:
        """
        The shared access policies you can use to secure a connection to the IoT hub.
        """
    ...
    def authorization_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SharedAccessSignatureAuthorizationRuleArgs']]]]):
        pulumi.set(self, "authorization_policies", value)

    @_builtins.property
    @pulumi.getter(name="cloudToDevice")
    def cloud_to_device(self) -> pulumi.Input[Optional['CloudToDevicePropertiesArgs']]:
        """
        The IoT hub cloud-to-device messaging properties.
        """
    ...
    def cloud_to_device(self, value: pulumi.Input[Optional['CloudToDevicePropertiesArgs']]):
    ...
    def disable_device_sas(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, all device(including Edge devices but excluding modules) scoped SAS keys cannot be used for authentication.
        """
    ...
    def disable_device_sas(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def disable_module_sas(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, all module scoped SAS keys cannot be used for authentication.
        """
    ...
    def disable_module_sas(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def enable_file_upload_notifications(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If True, file upload notifications are enabled.
        """
    ...
    def enable_file_upload_notifications(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_file_upload_notifications", value)

    @_builtins.property
    @pulumi.getter(name="eventHubEndpoints")
    def event_hub_endpoints(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input['EventHubPropertiesArgs']]]]:
        """
        The Event Hub-compatible endpoint properties. The only possible keys to this dictionary is events. This key has to be present in the dictionary while making create or update calls for the IoT hub.
        """
    ...
    def event_hub_endpoints(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input['EventHubPropertiesArgs']]]]):
        pulumi.set(self, "event_hub_endpoints", value)

    @_builtins.property
    @pulumi.getter
    def features(self) -> pulumi.Input[Optional[Union[_builtins.str, 'Capabilities']]]:
        """
        The capabilities and features enabled for the IoT hub.
        """
    ...
    @features.setter
    def features(self, value: pulumi.Input[Optional[Union[_builtins.str, 'Capabilities']]]):
    ...
    def messaging_endpoints(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input['MessagingEndpointPropertiesArgs']]]]:
        """
        The messaging endpoint properties for the file upload notification queue.
        """
    ...
    def messaging_endpoints(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input['MessagingEndpointPropertiesArgs']]]]):
    ...
    def network_rule_sets(self) -> pulumi.Input[Optional['NetworkRuleSetPropertiesArgs']]:
        """
        Network Rule Set Properties of IotHub
        """
    ...
    def network_rule_sets(self, value: pulumi.Input[Optional['NetworkRuleSetPropertiesArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def routing(self) -> pulumi.Input[Optional['RoutingPropertiesArgs']]:
        """
        The routing related properties of the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging
        """
    ...
    @routing.setter
    def routing(self, value: pulumi.Input[Optional['RoutingPropertiesArgs']]):
        pulumi.set(self, "routing", value)

    @_builtins.property
    @pulumi.getter(name="storageEndpoints")
    def storage_endpoints(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input['StorageEndpointPropertiesArgs']]]]:
        """
        The list of Azure Storage endpoints where you can upload files. Currently you can configure only one Azure Storage account and that MUST have its key as $default. Specifying more than one storage account causes an error to be thrown. Not specifying a value for this property when the enableFileUploadNotifications property is set to True, causes an error to be thrown.
        """
    ...
    def storage_endpoints(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input['StorageEndpointPropertiesArgs']]]]):
...
class IotHubSkuInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'IotHubSku']] name: The name of the SKU.
        :param pulumi.Input[_builtins.float] capacity: The number of provisioned IoT Hub units. See: https://docs.microsoft.com/azure/azure-subscription-service-limits#iot-hub-limits.
        """
        pulumi.set(__self__, "name", name)
...
class ManagedIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_assigned_identity: The user assigned identity.
        """
...
class MessagingEndpointPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] lock_duration_as_iso8601: The lock duration. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        :param pulumi.Input[_builtins.int] max_delivery_count: The number of times the IoT hub attempts to deliver a message. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        :param pulumi.Input[_builtins.str] ttl_as_iso8601: The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload.
        """
        if lock_duration_as_iso8601 is not None:
            pulumi.set(__self__, "lock_duration_as_iso8601", lock_duration_as_iso8601)
        if max_delivery_count is not None:
...
class NetworkRuleSetIpRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] filter_name: Name of the IP filter rule.
        :param pulumi.Input[_builtins.str] ip_mask: A string that contains the IP address range in CIDR notation for the rule.
        :param pulumi.Input[Union[_builtins.str, 'NetworkRuleIPAction']] action: IP Filter Action
        """
        pulumi.set(__self__, "filter_name", filter_name)
        pulumi.set(__self__, "ip_mask", ip_mask)
        if action is None:
...
class NetworkRuleSetPropertiesArgsDict(TypedDict):
    ...
    List of IP Rules
    """
    default_action: NotRequired[pulumi.Input[Optional[Union[_builtins.str, 'DefaultAction']]]]
    """
...
class NetworkRuleSetPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] apply_to_built_in_event_hub_endpoint: If True, then Network Rule Set is also applied to BuiltIn EventHub EndPoint of IotHub
        :param pulumi.Input[Sequence[pulumi.Input['NetworkRuleSetIpRuleArgs']]] ip_rules: List of IP Rules
        :param pulumi.Input[Union[_builtins.str, 'DefaultAction']] default_action: Default Action for Network Rule Set
        """
    ...
    def apply_to_built_in_event_hub_endpoint(self, value: pulumi.Input[_builtins.bool]):
...
class RoutePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] endpoint_names: The list of endpoints to which messages that satisfy the condition are routed. Currently only one endpoint is allowed.
        :param pulumi.Input[_builtins.bool] is_enabled: Used to specify whether a route is enabled.
        :param pulumi.Input[_builtins.str] name: The name of the route. The name can only include alphanumeric characters, periods, underscores, hyphens, has a maximum length of 64 characters, and must be unique.
        :param pulumi.Input[Union[_builtins.str, 'RoutingSource']] source: The source that the routing rule is to be applied to, such as DeviceMessages.
        :param pulumi.Input[_builtins.str] condition: The condition that is evaluated to apply the routing rule. If no condition is provided, it evaluates to true by default. For grammar, see: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
        """
        pulumi.set(__self__, "endpoint_names", endpoint_names)
        pulumi.set(__self__, "is_enabled", is_enabled)
        pulumi.set(__self__, "name", name)
...
class RoutingCosmosDBSqlApiPropertiesArgsDict(TypedDict):
    ...
    """
    identity: NotRequired[pulumi.Input[Optional['ManagedIdentityArgs']]]
    """
    Managed identity properties of routing cosmos DB container endpoint.
    """
    partition_key_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter.
    """
    partition_key_template: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RoutingCosmosDBSqlApiPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] container_name: The name of the cosmos DB sql container in the cosmos DB database.
        :param pulumi.Input[_builtins.str] database_name: The name of the cosmos DB database in the cosmos DB account.
        :param pulumi.Input[_builtins.str] endpoint_uri: The url of the cosmos DB account. It must include the protocol https://
        :param pulumi.Input[_builtins.str] name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Method used to authenticate against the cosmos DB sql container endpoint
        :param pulumi.Input['ManagedIdentityArgs'] identity: Managed identity properties of routing cosmos DB container endpoint.
        :param pulumi.Input[_builtins.str] partition_key_name: The name of the partition key associated with this cosmos DB sql container if one exists. This is an optional parameter.
        :param pulumi.Input[_builtins.str] partition_key_template: The template for generating a synthetic partition key value for use with this cosmos DB sql container. The template must include at least one of the following placeholders: {iothub}, {deviceid}, {DD}, {MM}, and {YYYY}. Any one placeholder may be specified at most once, but order and non-placeholder components are arbitrary. This parameter is only required if PartitionKeyName is specified.
        :param pulumi.Input[_builtins.str] primary_key: The primary key of the cosmos DB account.
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group of the cosmos DB account.
        :param pulumi.Input[_builtins.str] secondary_key: The secondary key of the cosmos DB account.
        :param pulumi.Input[_builtins.str] subscription_id: The subscription identifier of the cosmos DB account.
        """
...
class RoutingEndpointsArgsDict(TypedDict):
    ...
    """
    cosmos_db_sql_containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutingCosmosDBSqlApiPropertiesArgs']]]]]
    """
    The list of Cosmos DB container endpoints that IoT hub routes messages to, based on the routing rules.
    """
    event_hubs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutingEventHubPropertiesArgs']]]]]
    """
    The list of Event Hubs endpoints that IoT hub routes messages to, based on the routing rules. This list does not include the built-in Event Hubs endpoint.
    """
    service_bus_queues: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusQueueEndpointPropertiesArgs']]]]]
    """
    The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
    """
    service_bus_topics: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusTopicEndpointPropertiesArgs']]]]]
    """
    The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
    """
    storage_containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutingStorageContainerPropertiesArgs']]]]]
    """
...
class RoutingEndpointsArgs:
    def __init__(__self__, *,
                 cosmos_db_sql_containers: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingCosmosDBSqlApiPropertiesArgs']]]] = None,
                 event_hubs: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingEventHubPropertiesArgs']]]] = None,
                 service_bus_queues: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusQueueEndpointPropertiesArgs']]]] = None,
                 service_bus_topics: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusTopicEndpointPropertiesArgs']]]] = None,
                 storage_containers: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingStorageContainerPropertiesArgs']]]] = None):
        """
        The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
        ...
        if cosmos_db_sql_containers is not None:
            pulumi.set(__self__, "cosmos_db_sql_containers", cosmos_db_sql_containers)
    ...
    def cosmos_db_sql_containers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutingCosmosDBSqlApiPropertiesArgs']]]]:
        """
        The list of Cosmos DB container endpoints that IoT hub routes messages to, based on the routing rules.
        """
    ...
    def cosmos_db_sql_containers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingCosmosDBSqlApiPropertiesArgs']]]]):
        pulumi.set(self, "cosmos_db_sql_containers", value)

    @_builtins.property
    @pulumi.getter(name="eventHubs")
    def event_hubs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutingEventHubPropertiesArgs']]]]:
        """
        The list of Event Hubs endpoints that IoT hub routes messages to, based on the routing rules. This list does not include the built-in Event Hubs endpoint.
        """
    ...
    @event_hubs.setter
    def event_hubs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingEventHubPropertiesArgs']]]]):
        pulumi.set(self, "event_hubs", value)

    @_builtins.property
    @pulumi.getter(name="serviceBusQueues")
    def service_bus_queues(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusQueueEndpointPropertiesArgs']]]]:
        """
        The list of Service Bus queue endpoints that IoT hub routes the messages to, based on the routing rules.
        """
    ...
    def service_bus_queues(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusQueueEndpointPropertiesArgs']]]]):
        pulumi.set(self, "service_bus_queues", value)

    @_builtins.property
    @pulumi.getter(name="serviceBusTopics")
    def service_bus_topics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusTopicEndpointPropertiesArgs']]]]:
        """
        The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
        """
    ...
    def service_bus_topics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingServiceBusTopicEndpointPropertiesArgs']]]]):
        pulumi.set(self, "service_bus_topics", value)

    @_builtins.property
    @pulumi.getter(name="storageContainers")
    def storage_containers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutingStorageContainerPropertiesArgs']]]]:
        """
        The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
        """
    ...
    def storage_containers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutingStorageContainerPropertiesArgs']]]]):
...
class RoutingEventHubPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Method used to authenticate against the event hub endpoint
        :param pulumi.Input[_builtins.str] connection_string: The connection string of the event hub endpoint. 
        :param pulumi.Input[_builtins.str] endpoint_uri: The url of the event hub endpoint. It must include the protocol sb://
        :param pulumi.Input[_builtins.str] entity_path: Event hub name on the event hub namespace
        :param pulumi.Input[_builtins.str] id: Id of the event hub endpoint
        :param pulumi.Input['ManagedIdentityArgs'] identity: Managed identity properties of routing event hub endpoint.
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group of the event hub endpoint.
        :param pulumi.Input[_builtins.str] subscription_id: The subscription identifier of the event hub endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingPropertiesArgsDict(TypedDict):
    ...
    The routing related properties of the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging
    """
    endpoints: NotRequired[pulumi.Input[Optional['RoutingEndpointsArgs']]]
    """
    The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
    """
    enrichments: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EnrichmentPropertiesArgs']]]]]
    """
    The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
    """
    fallback_route: NotRequired[pulumi.Input[Optional['FallbackRoutePropertiesArgs']]]
    """
    ...
    """
    routes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RoutePropertiesArgs']]]]]
    """
...
class RoutingPropertiesArgs:
    def __init__(__self__, *,
                 endpoints: pulumi.Input[Optional['RoutingEndpointsArgs']] = None,
                 enrichments: pulumi.Input[Optional[Sequence[pulumi.Input['EnrichmentPropertiesArgs']]]] = None,
                 fallback_route: pulumi.Input[Optional['FallbackRoutePropertiesArgs']] = None,
                 routes: pulumi.Input[Optional[Sequence[pulumi.Input['RoutePropertiesArgs']]]] = None):
        """
        The routing related properties of the IoT hub. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional['RoutingEndpointsArgs']]:
        """
        The properties related to the custom endpoints to which your IoT hub routes messages based on the routing rules. A maximum of 10 custom endpoints are allowed across all endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types for free hubs.
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional['RoutingEndpointsArgs']]):
        pulumi.set(self, "endpoints", value)

    @_builtins.property
    @pulumi.getter
    def enrichments(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EnrichmentPropertiesArgs']]]]:
        """
        The list of user-provided enrichments that the IoT hub applies to messages to be delivered to built-in and custom endpoints. See: https://aka.ms/telemetryoneventgrid
        """
    ...
    @enrichments.setter
    def enrichments(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EnrichmentPropertiesArgs']]]]):
        pulumi.set(self, "enrichments", value)

    @_builtins.property
    @pulumi.getter(name="fallbackRoute")
    def fallback_route(self) -> pulumi.Input[Optional['FallbackRoutePropertiesArgs']]:
        """
        The properties of the route that is used as a fall-back route when none of the conditions specified in the 'routes' section are met. This is an optional parameter. When this property is not present in the template, the fallback route is disabled by default.
        """
    ...
    def fallback_route(self, value: pulumi.Input[Optional['FallbackRoutePropertiesArgs']]):
        pulumi.set(self, "fallback_route", value)

    @_builtins.property
    @pulumi.getter
    def routes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RoutePropertiesArgs']]]]:
        """
        The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
        """
    ...
    @routes.setter
    def routes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RoutePropertiesArgs']]]]):
...
class RoutingServiceBusQueueEndpointPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types. The name need not be the same as the actual queue name.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Method used to authenticate against the service bus queue endpoint
        :param pulumi.Input[_builtins.str] connection_string: The connection string of the service bus queue endpoint.
        :param pulumi.Input[_builtins.str] endpoint_uri: The url of the service bus queue endpoint. It must include the protocol sb://
        :param pulumi.Input[_builtins.str] entity_path: Queue name on the service bus namespace
        :param pulumi.Input[_builtins.str] id: Id of the service bus queue endpoint
        :param pulumi.Input['ManagedIdentityArgs'] identity: Managed identity properties of routing service bus queue endpoint.
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group of the service bus queue endpoint.
        :param pulumi.Input[_builtins.str] subscription_id: The subscription identifier of the service bus queue endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingServiceBusTopicEndpointPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.  The name need not be the same as the actual topic name.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Method used to authenticate against the service bus topic endpoint
        :param pulumi.Input[_builtins.str] connection_string: The connection string of the service bus topic endpoint.
        :param pulumi.Input[_builtins.str] endpoint_uri: The url of the service bus topic endpoint. It must include the protocol sb://
        :param pulumi.Input[_builtins.str] entity_path: Queue name on the service bus topic
        :param pulumi.Input[_builtins.str] id: Id of the service bus topic endpoint
        :param pulumi.Input['ManagedIdentityArgs'] identity: Managed identity properties of routing service bus topic endpoint.
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group of the service bus topic endpoint.
        :param pulumi.Input[_builtins.str] subscription_id: The subscription identifier of the service bus topic endpoint.
        """
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
            pulumi.set(__self__, "authentication_type", authentication_type)
...
class RoutingStorageContainerPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Method used to authenticate against the storage endpoint
        ...
        :param pulumi.Input[_builtins.str] connection_string: The connection string of the storage account.
        :param pulumi.Input[_builtins.str] encoding: Encoding that is used to serialize messages to blobs. Supported values are 'avro', 'avrodeflate', and 'JSON'. Default value is 'avro'.
        :param pulumi.Input[_builtins.str] endpoint_uri: The url of the storage endpoint. It must include the protocol https://
        :param pulumi.Input[_builtins.str] file_name_format: File name format for the blob. Default format is {iothub}/{partition}/{YYYY}/{MM}/{DD}/{HH}/{mm}. All parameters are mandatory but can be reordered.
        :param pulumi.Input[_builtins.str] id: Id of the storage container endpoint
        ...
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group of the storage account.
        :param pulumi.Input[_builtins.str] subscription_id: The subscription identifier of the storage account.
        """
        pulumi.set(__self__, "container_name", container_name)
        pulumi.set(__self__, "name", name)
        if authentication_type is not None:
...
class StorageEndpointPropertiesArgsDict(TypedDict):
    ...
    """
    sas_ttl_as_iso8601: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class StorageEndpointPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 authentication_type: pulumi.Input[Optional[Union[_builtins.str, 'AuthenticationType']]] = None,
                 identity: pulumi.Input[Optional['ManagedIdentityArgs']] = None,
                 sas_ttl_as_iso8601: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The properties of the Azure Storage endpoint for file upload.
        ...
        :param pulumi.Input[_builtins.str] container_name: The name of the root container where you upload files. The container need not exist but should be creatable using the connectionString specified.
        :param pulumi.Input[Union[_builtins.str, 'AuthenticationType']] authentication_type: Specifies authentication type being used for connecting to the storage account.
        :param pulumi.Input['ManagedIdentityArgs'] identity: Managed identity properties of storage endpoint for file upload.
        :param pulumi.Input[_builtins.str] sas_ttl_as_iso8601: The period of time for which the SAS URI generated by IoT Hub for file upload is valid. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.
        """
        pulumi.set(__self__, "connection_string", connection_string)
        pulumi.set(__self__, "container_name", container_name)
        if authentication_type is not None:
    ...
    def sas_ttl_as_iso8601(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The period of time for which the SAS URI generated by IoT Hub for file upload is valid. See: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.
        """
    ...
    def sas_ttl_as_iso8601(self, value: pulumi.Input[Optional[_builtins.str]]):
