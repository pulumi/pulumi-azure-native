...
def get_private_endpoint_connections_for_edm(private_endpoint_connection_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForEDMResult).value
...
def get_private_endpoint_connections_for_edm_output(private_endpoint_connection_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForEDMResult)
