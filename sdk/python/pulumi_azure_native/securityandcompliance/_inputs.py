...
class ServiceCorsConfigurationInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] max_age: The max age to be allowed via CORS.
...
if not MYPY:
    class ServiceCosmosDbConfigurationInfoArgsDict(TypedDict):
        ...
        """
        offer_throughput: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ServiceCosmosDbConfigurationInfoArgs:
    def __init__(__self__, *,
                 ...
                 offer_throughput: Optional[pulumi.Input[builtins.float]] = None):
        """
        The settings for the Cosmos DB database backing the service.
        :param pulumi.Input[builtins.str] key_vault_key_uri: The URI of the customer-managed key for the backing database.
        :param pulumi.Input[builtins.float] offer_throughput: The provisioned throughput for the backing database.
        """
    ...
    def offer_throughput(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The provisioned throughput for the backing database.
        """
    ...
    def offer_throughput(self, value: Optional[pulumi.Input[builtins.float]]):
