...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI":
                return PrivateEndpointConnectionsAdtAPI(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/latest:PrivateEndpointConnectionsComp":
            ...
            elif typ == "azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload":
                return PrivateLinkServicesForEDMUpload(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/latest:privateLinkServicesForM365ComplianceCenter":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityandcompliance/latest", _module_instance)
