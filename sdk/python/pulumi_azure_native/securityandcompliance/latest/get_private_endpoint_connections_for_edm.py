...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM'.""", DeprecationWarning)
...
def get_private_endpoint_connections_for_edm(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connections_for_edm is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getPrivateEndpointConnectionsForEDM'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getPrivateEndpointConnectionsForEDM', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForEDMResult).value
