...
__all__ = ['PrivateLinkServicesForMIPPolicySync']

warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync'.""", DeprecationWarning)
...
class PrivateLinkServicesForMIPPolicySync(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""PrivateLinkServicesForMIPPolicySync is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForMIPPolicySync")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForMIPPolicySync, __self__).__init__(
            'azure-native:securityandcompliance/latest:privateLinkServicesForMIPPolicySync',
            resource_name,
            __props__,
            opts)
