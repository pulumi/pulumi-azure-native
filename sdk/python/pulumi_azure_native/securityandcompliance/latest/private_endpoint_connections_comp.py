...
class PrivateEndpointConnectionsComp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:PrivateEndpointConnectionsComp")])
