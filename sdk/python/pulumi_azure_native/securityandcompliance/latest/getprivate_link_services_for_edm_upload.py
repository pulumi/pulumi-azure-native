...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForEDMUpload'.""", DeprecationWarning)
...
def getprivate_link_services_for_edm_upload(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getprivateLinkServicesForEDMUpload', __args__, opts=opts, typ=GetprivateLinkServicesForEDMUploadResult).value
