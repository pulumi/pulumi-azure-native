...
class PrivateEndpointConnectionsComp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native_securityandcompliance_v20210111:securityandcompliance:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native_securityandcompliance_v20210308:securityandcompliance:PrivateEndpointConnectionsComp")])
