...
def get_private_endpoint_connections_for_scc_powershell(private_endpoint_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/v20210308:getPrivateEndpointConnectionsForSCCPowershell', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForSCCPowershellResult).value
...
def get_private_endpoint_connections_for_scc_powershell_output(private_endpoint_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance/v20210308:getPrivateEndpointConnectionsForSCCPowershell', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForSCCPowershellResult)
