...
class AwaitableGetprivateLinkServicesForO365ManagementActivityAPIResult(GetprivateLinkServicesForO365ManagementActivityAPIResult):
...
def getprivate_link_services_for_o365_management_activity_api(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/v20210308:getprivateLinkServicesForO365ManagementActivityAPI', __args__, opts=opts, typ=GetprivateLinkServicesForO365ManagementActivityAPIResult).value

    return AwaitableGetprivateLinkServicesForO365ManagementActivityAPIResult(
        etag=__ret__.etag,
        id=__ret__.id,
