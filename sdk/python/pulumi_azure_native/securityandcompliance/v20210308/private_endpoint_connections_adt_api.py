...
class PrivateEndpointConnectionsAdtAPI(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connections_adt_api = azure_native.securityandcompliance.v20210308.PrivateEndpointConnectionsAdtAPI("privateEndpointConnectionsAdtAPI",
            private_endpoint_connection_name="myConnection",
            private_link_service_connection_state=azure_native.securityandcompliance.v20210308.PrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI")])
