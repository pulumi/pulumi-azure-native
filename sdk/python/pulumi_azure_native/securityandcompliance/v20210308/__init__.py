...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI":
                return PrivateEndpointConnectionsAdtAPI(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsComp":
                return PrivateEndpointConnectionsComp(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForEDM":
                return PrivateEndpointConnectionsForEDM(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForMIPPolicySync":
                return PrivateEndpointConnectionsForMIPPolicySync(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForSCCPowershell":
                return PrivateEndpointConnectionsForSCCPowershell(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsSec":
                return PrivateEndpointConnectionsSec(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForEDMUpload":
                return PrivateLinkServicesForEDMUpload(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForM365ComplianceCenter":
                return PrivateLinkServicesForM365ComplianceCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter":
                return PrivateLinkServicesForM365SecurityCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForMIPPolicySync":
                return PrivateLinkServicesForMIPPolicySync(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForO365ManagementActivityAPI":
                return PrivateLinkServicesForO365ManagementActivityAPI(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityandcompliance/v20210308:privateLinkServicesForSCCPowershell":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityandcompliance/v20210308", _module_instance)
