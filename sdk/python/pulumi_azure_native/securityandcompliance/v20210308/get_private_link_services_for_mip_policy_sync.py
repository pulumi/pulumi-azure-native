...
def get_private_link_services_for_mip_policy_sync(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/v20210308:getPrivateLinkServicesForMIPPolicySync', __args__, opts=opts, typ=GetPrivateLinkServicesForMIPPolicySyncResult).value
...
def get_private_link_services_for_mip_policy_sync_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance/v20210308:getPrivateLinkServicesForMIPPolicySync', __args__, opts=opts, typ=GetPrivateLinkServicesForMIPPolicySyncResult)
