...
class PrivateEndpointConnectionsForEDM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForEDM"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsForEDM")])
