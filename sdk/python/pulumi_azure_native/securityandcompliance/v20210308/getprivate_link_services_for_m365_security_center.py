...
__all__ = [
    ...
    'getprivate_link_services_for_m365_security_center',
...
def getprivate_link_services_for_m365_security_center(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/v20210308:getprivateLinkServicesForM365SecurityCenter', __args__, opts=opts, typ=GetprivateLinkServicesForM365SecurityCenterResult).value
...
@_utilities.lift_output_func(getprivate_link_services_for_m365_security_center)
