...
class PrivateLinkServicesForSCCPowershell(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForSCCPowershell")])
