...
__all__ = ['PrivateLinkServicesForM365SecurityCenterArgs', 'PrivateLinkServicesForM365SecurityCenter']
...
class PrivateLinkServicesForM365SecurityCenter(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        private_link_services_for_m365_security_center = azure_native.securityandcompliance.v20210308.PrivateLinkServicesForM365SecurityCenter("privateLinkServicesForM365SecurityCenter",
            identity=azure_native.securityandcompliance.v20210308.ServicesResourceIdentityArgs(
                type="SystemAssigned",
            ),
            kind=azure_native.securityandcompliance/v20210308.Kind.FHIR_R4,
            location="westus2",
            properties=azure_native.securityandcompliance.v20210308.ServicesPropertiesResponseArgs(
                access_policies=[
                    azure_native.securityandcompliance.v20210308.ServiceAccessPolicyEntryArgs(
                ...
                authentication_configuration=azure_native.securityandcompliance.v20210308.ServiceAuthenticationConfigurationInfoArgs(
                    audience="https://azurehealthcareapis.com",
                    authority="https://login.microsoftonline.com/abfde7b2-df0f-47e6-aabf-2462b07508dc",
                    smart_proxy_enabled=True,
                ),
                cors_configuration=azure_native.securityandcompliance.v20210308.ServiceCorsConfigurationInfoArgs(
                ...
                cosmos_db_configuration=azure_native.securityandcompliance.v20210308.ServiceCosmosDbConfigurationInfoArgs(
                    key_vault_key_uri="https://my-vault.vault.azure.net/keys/my-key",
                    offer_throughput=1000,
                ),
                export_configuration=azure_native.securityandcompliance.v20210308.ServiceExportConfigurationInfoArgs(
        ...
        private_link_services_for_m365_security_center = azure_native.securityandcompliance.v20210308.PrivateLinkServicesForM365SecurityCenter("privateLinkServicesForM365SecurityCenter",
            kind=azure_native.securityandcompliance/v20210308.Kind.FHIR_R4,
            location="westus2",
            properties=azure_native.securityandcompliance.v20210308.ServicesPropertiesArgs(
                access_policies=[azure_native.securityandcompliance.v20210308.ServiceAccessPolicyEntryArgs(
                    object_id="c487e7d1-3210-41a3-8ccc-e9372b78da47",
                )],
            ),
            resource_group_name="rg1",
        ...
        ```sh
        $ pulumi import azure-native:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter service2 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForM365SecurityCenter/service2 
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrivateLinkServicesForM365SecurityCenterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForM365SecurityCenter, __self__).__init__(
            'azure-native:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PrivateLinkServicesForM365SecurityCenter':
        """
        ...
        __props__.__dict__["type"] = None
        return PrivateLinkServicesForM365SecurityCenter(resource_name, opts=opts, __props__=__props__)
