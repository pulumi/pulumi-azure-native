...
def get_private_endpoint_connections_for_mip_policy_sync_output(private_endpoint_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance/v20210308:getPrivateEndpointConnectionsForMIPPolicySync', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForMIPPolicySyncResult)
