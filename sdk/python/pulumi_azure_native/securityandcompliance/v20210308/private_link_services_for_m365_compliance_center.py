...
class PrivateLinkServicesForM365ComplianceCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_services_for_m365_compliance_center = azure_native.securityandcompliance.v20210308.PrivateLinkServicesForM365ComplianceCenter("privateLinkServicesForM365ComplianceCenter",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForM365ComplianceCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForM365ComplianceCenter, __self__).__init__(
            'azure-native:securityandcompliance/v20210308:privateLinkServicesForM365ComplianceCenter',
            resource_name,
            __props__,
            opts)
