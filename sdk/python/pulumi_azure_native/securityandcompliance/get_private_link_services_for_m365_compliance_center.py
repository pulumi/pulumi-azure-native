...
def get_private_link_services_for_m365_compliance_center(resource_group_name: Optional[builtins.str] = None,
...
def get_private_link_services_for_m365_compliance_center_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance:getPrivateLinkServicesForM365ComplianceCenter', __args__, opts=opts, typ=GetPrivateLinkServicesForM365ComplianceCenterResult)
