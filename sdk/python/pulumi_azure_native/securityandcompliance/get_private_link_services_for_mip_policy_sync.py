...
def get_private_link_services_for_mip_policy_sync(resource_group_name: Optional[builtins.str] = None,
...
def get_private_link_services_for_mip_policy_sync_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
