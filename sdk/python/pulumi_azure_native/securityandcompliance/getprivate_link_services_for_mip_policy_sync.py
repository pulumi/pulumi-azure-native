...
def getprivate_link_services_for_mip_policy_sync(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance:getprivateLinkServicesForMIPPolicySync', __args__, opts=opts, typ=GetprivateLinkServicesForMIPPolicySyncResult).value
