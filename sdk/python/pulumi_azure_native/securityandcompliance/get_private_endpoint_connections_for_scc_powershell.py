...
def get_private_endpoint_connections_for_scc_powershell(private_endpoint_connection_name: Optional[_builtins.str] = None,
...
def get_private_endpoint_connections_for_scc_powershell_output(private_endpoint_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
