...
def getprivate_link_services_for_m365_compliance_center(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""getprivate_link_services_for_m365_compliance_center is deprecated: Version v20210111 will be removed in the next major version of the provider. Upgrade to version v20210308 or later.""")
    __args__ = dict()
