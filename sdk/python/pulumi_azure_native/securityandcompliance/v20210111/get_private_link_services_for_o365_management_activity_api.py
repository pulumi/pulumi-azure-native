...
def get_private_link_services_for_o365_management_activity_api_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance/v20210111:getPrivateLinkServicesForO365ManagementActivityAPI', __args__, opts=opts, typ=GetPrivateLinkServicesForO365ManagementActivityAPIResult)
