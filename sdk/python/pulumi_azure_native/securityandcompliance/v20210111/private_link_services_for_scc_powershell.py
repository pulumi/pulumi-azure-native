...
class PrivateLinkServicesForSCCPowershell(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForSCCPowershell")])
