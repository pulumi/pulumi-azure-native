...
__all__ = ['PrivateLinkServicesForM365ComplianceCenter']
...
class PrivateLinkServicesForM365ComplianceCenter(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForM365ComplianceCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForM365ComplianceCenter")])
