...
def get_private_endpoint_connections_for_scc_powershell(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connections_for_scc_powershell is deprecated: Version v20210111 will be removed in the next major version of the provider. Upgrade to version v20210308 or later.""")
    __args__ = dict()
