...
def get_private_endpoint_connections_for_scc_powershell(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connections_for_scc_powershell is deprecated: azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForSCCPowershell is being removed in the next major version of this provider. Please upgrade to azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForSCCPowershell to guarantee forwards compatibility.""")
    __args__ = dict()
