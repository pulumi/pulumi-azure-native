...
def get_private_link_services_for_m365_security_center_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:securityandcompliance/v20210111:getPrivateLinkServicesForM365SecurityCenter', __args__, opts=opts, typ=GetPrivateLinkServicesForM365SecurityCenterResult)
