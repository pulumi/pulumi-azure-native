...
__all__ = ['PrivateEndpointConnectionsAdtAPIArgs', 'PrivateEndpointConnectionsAdtAPI']
...
class PrivateEndpointConnectionsAdtAPI(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PrivateEndpointConnectionsAdtAPIArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrivateEndpointConnectionsAdtAPIArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PrivateEndpointConnectionsAdtAPIArgs.__new__(PrivateEndpointConnectionsAdtAPIArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI")])
