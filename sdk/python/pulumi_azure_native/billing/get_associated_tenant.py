...
def get_associated_tenant(associated_tenant_name: Optional[_builtins.str] = None,
...
def get_associated_tenant_output(associated_tenant_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
