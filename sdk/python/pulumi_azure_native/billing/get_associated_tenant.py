...
def get_associated_tenant(associated_tenant_name: Optional[builtins.str] = None,
    ...
    :param builtins.str associated_tenant_name: The ID that uniquely identifies a tenant.
...
def get_associated_tenant_output(associated_tenant_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:billing:getAssociatedTenant', __args__, opts=opts, typ=GetAssociatedTenantResult)
