...
def get_billing_role_assignment_by_enrollment_account(billing_account_name: Optional[builtins.str] = None,
                                                      billing_role_assignment_name: Optional[builtins.str] = None,
                                                      enrollment_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str enrollment_account_name: The name of the enrollment account.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:billing:getBillingRoleAssignmentByEnrollmentAccount', __args__, opts=opts, typ=GetBillingRoleAssignmentByEnrollmentAccountResult).value
...
def get_billing_role_assignment_by_enrollment_account_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
                                                             billing_role_assignment_name: Optional[pulumi.Input[builtins.str]] = None,
                                                             enrollment_account_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:billing:getBillingRoleAssignmentByEnrollmentAccount', __args__, opts=opts, typ=GetBillingRoleAssignmentByEnrollmentAccountResult)
