...
def get_billing_role_assignment_by_enrollment_account(billing_account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str enrollment_account_name: The name of the enrollment account.
    """
    __args__ = dict()
...
def get_billing_role_assignment_by_enrollment_account_output(billing_account_name: Optional[pulumi.Input[_builtins.str]] = None,
