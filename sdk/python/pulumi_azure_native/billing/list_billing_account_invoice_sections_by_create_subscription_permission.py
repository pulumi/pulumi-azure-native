...
def list_billing_account_invoice_sections_by_create_subscription_permission(billing_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: The filter query option allows clients to filter a collection of resources that are addressed by a request URL.
    """
    __args__ = dict()
...
def list_billing_account_invoice_sections_by_create_subscription_permission_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
