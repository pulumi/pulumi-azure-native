...
class AssociatedTenantPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'BillingManagementTenantState']] billing_management_state: The state determines whether users from the associated tenant can be assigned roles for commerce activities like viewing and downloading invoices, managing payments, and making purchases.
        :param pulumi.Input[_builtins.str] display_name: The name of the associated tenant.
        :param pulumi.Input[Union[_builtins.str, 'ProvisioningTenantState']] provisioning_management_state: The state determines whether subscriptions and licenses can be provisioned in the associated tenant. It can be set to 'Pending' to initiate a billing request.
        :param pulumi.Input[_builtins.str] tenant_id: The ID that uniquely identifies a tenant.
        """
...
class AzurePlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] product_id: The ID that uniquely identifies a product.
        :param pulumi.Input[_builtins.str] sku_description: The sku description.
        :param pulumi.Input[_builtins.str] sku_id: The ID that uniquely identifies a sku.
        """
...
class BillingProfilePropertiesArgsDict(TypedDict):
    ...
    A billing profile.
    """
    bill_to: NotRequired[pulumi.Input[Optional['BillingProfilePropertiesBillToArgs']]]
    """
    Billing address.
    """
    current_payment_term: NotRequired[pulumi.Input[Optional['BillingProfilePropertiesCurrentPaymentTermArgs']]]
    """
    The current payment term of the billing profile.
    """
    display_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    ...
    """
    enabled_azure_plans: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AzurePlanArgs']]]]]
    """
    Information about the enabled azure plans.
    """
    indirect_relationship_info: NotRequired[pulumi.Input[Optional['BillingProfilePropertiesIndirectRelationshipInfoArgs']]]
    """
    Identifies the billing profile that is linked to another billing profile in indirect purchase motion.
    """
    ...
    """
    ship_to: NotRequired[pulumi.Input[Optional['BillingProfilePropertiesShipToArgs']]]
    """
    The default address where the products are shipped, or the services are being used. If a ship to is not specified for a product or a subscription, then this address will be used.
    """
    sold_to: NotRequired[pulumi.Input[Optional['BillingProfilePropertiesSoldToArgs']]]
    """
    The address of the individual or organization that is responsible for the billing account.
    """
...
class BillingProfilePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The name of the billing profile.
        ...
        :param pulumi.Input[_builtins.bool] invoice_email_opt_in: Flag controlling whether the invoices for the billing profile are sent through email.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] invoice_recipients: The list of email addresses to receive invoices by email for the billing profile.
        :param pulumi.Input[_builtins.str] po_number: The default purchase order number that will appear on the invoices generated for the billing profile.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Dictionary of metadata associated with the resource. Maximum key/value length supported of 256 characters. Keys/value should not empty value nor null. Keys can not contain < > % & \\ ? /
        """
...
class BillingRoleAssignmentPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] principal_id: The object id of the user to whom the role was assigned.
        :param pulumi.Input[_builtins.str] principal_puid: The principal PUID of the user to whom the role was assigned.
        :param pulumi.Input[_builtins.str] principal_tenant_id: The principal tenant id of the user to whom the role was assigned.
        :param pulumi.Input[_builtins.str] scope: The scope at which the role was assigned.
        :param pulumi.Input[_builtins.str] user_authentication_type: The authentication type of the user, whether Organization or MSA, of the user to whom the role was assigned. This is supported only for billing accounts with agreement type Enterprise Agreement.
        :param pulumi.Input[_builtins.str] user_email_address: The email address of the user to whom the role was assigned. This is supported only for billing accounts with agreement type Enterprise Agreement.
        """
...
class InvoiceSectionPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The name of the invoice section.
        :param pulumi.Input[Union[_builtins.str, 'InvoiceSectionStateReasonCode']] reason_code: Reason for the specified invoice section status.
        :param pulumi.Input[Union[_builtins.str, 'InvoiceSectionState']] state: Identifies the status of an invoice section.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Dictionary of metadata associated with the resource. Maximum key/value length supported of 256 characters. Keys/value should not empty value nor null. Keys can not contain < > % & \\ ? /
        :param pulumi.Input[_builtins.str] target_cloud: Identifies the cloud environments that are associated with an invoice section. This is a system managed optional field and gets updated as the invoice section gets associated with accounts in various clouds.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
