...
class BillingRoleAssignmentByDepartment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billing/v20191001preview:BillingRoleAssignmentByDepartment"), pulumi.Alias(type_="azure-native:billing:BillingRoleAssignmentByDepartment")])
