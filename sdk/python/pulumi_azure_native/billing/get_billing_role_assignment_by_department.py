...
def get_billing_role_assignment_by_department(billing_account_name: Optional[_builtins.str] = None,
                                              billing_role_assignment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str department_name: The name of the department.
    """
    __args__ = dict()
