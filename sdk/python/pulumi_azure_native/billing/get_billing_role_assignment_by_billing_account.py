...
def get_billing_role_assignment_by_billing_account(billing_account_name: Optional[builtins.str] = None,
...
def get_billing_role_assignment_by_billing_account_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
