...
class BillingRoleAssignmentByBillingAccountArgs:
    def __init__(__self__, *,
        ...
        """
        BillingRoleAssignmentByBillingAccountArgs._configure(
...
class BillingRoleAssignmentByBillingAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BillingRoleAssignmentByBillingAccountArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billing:BillingRoleAssignmentByBillingAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BillingRoleAssignmentByBillingAccount, __self__).__init__(
            'azure-native:billing/v20191001preview:BillingRoleAssignmentByBillingAccount',
            resource_name,
            __props__,
            opts)
