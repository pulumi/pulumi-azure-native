...
class BillingRoleAssignmentByBillingAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        billing_role_assignment_by_billing_account = azure_native.billing.v20191001preview.BillingRoleAssignmentByBillingAccount("billingRoleAssignmentByBillingAccount",
