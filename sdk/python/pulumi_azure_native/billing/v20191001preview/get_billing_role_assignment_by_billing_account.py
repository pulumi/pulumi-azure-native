...
def get_billing_role_assignment_by_billing_account(billing_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_billing_role_assignment_by_billing_account is deprecated: Version 2019-10-01-preview will be removed in v2 of the provider.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:billing/v20191001preview:getBillingRoleAssignmentByBillingAccount', __args__, opts=opts, typ=GetBillingRoleAssignmentByBillingAccountResult).value
