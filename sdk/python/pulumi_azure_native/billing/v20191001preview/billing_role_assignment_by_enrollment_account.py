...
class BillingRoleAssignmentByEnrollmentAccountArgs:
    def __init__(__self__, *,
        ...
        """
        BillingRoleAssignmentByEnrollmentAccountArgs._configure(
    ...
    def _configure(
        ...
        if enrollment_account_name is None and 'enrollmentAccountName' in kwargs:
            enrollment_account_name = kwargs['enrollmentAccountName']
        if enrollment_account_name is None:
            raise TypeError("Missing 'enrollment_account_name' argument")
        ...
        _setter("enrollment_account_name", enrollment_account_name)
...
class BillingRoleAssignmentByEnrollmentAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BillingRoleAssignmentByEnrollmentAccountArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billing:BillingRoleAssignmentByEnrollmentAccount")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BillingRoleAssignmentByEnrollmentAccount, __self__).__init__(
            'azure-native:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount',
            resource_name,
            __props__,
            opts)
