...
class BillingRoleAssignmentByEnrollmentAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        billing_role_assignment_by_enrollment_account = azure_native.billing.v20191001preview.BillingRoleAssignmentByEnrollmentAccount("billingRoleAssignmentByEnrollmentAccount",
