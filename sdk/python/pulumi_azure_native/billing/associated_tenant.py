...
class AssociatedTenant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:billing/v20240401:AssociatedTenant"), pulumi.Alias(type_="azure-native_billing_v20240401:billing:AssociatedTenant")])
