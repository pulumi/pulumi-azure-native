...
class BillingRoleAssignmentByEnrollmentAccountArgs:
    def __init__(__self__, *,
                 ...
                 enrollment_account_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] enrollment_account_name: The name of the enrollment account.
    ...
    def enrollment_account_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def enrollment_account_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure-native:billing:BillingRoleAssignmentByEnrollmentAccount")
