...
def get_invoice_section(billing_account_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:billing:getInvoiceSection', __args__, opts=opts, typ=GetInvoiceSectionResult).value
...
def get_invoice_section_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
