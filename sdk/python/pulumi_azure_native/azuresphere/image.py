...
class ImageInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image: Image as a UTF-8 encoded base 64 string on image create. This field contains the image URI on image reads.
        :param pulumi.Input[builtins.str] image_id: Image ID
        :param pulumi.Input[builtins.str] image_name: Image name. Use an image GUID for GA versions of the API.
        :param pulumi.Input[Union[builtins.str, 'RegionalDataBoundary']] regional_data_boundary: Regional data boundary for an image
        """
...
class Image(pulumi.CustomResource):
    ...
    def component_id(self) -> pulumi.Output[builtins.str]:
        """
