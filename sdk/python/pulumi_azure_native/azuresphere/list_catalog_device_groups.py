...
def list_catalog_device_groups(catalog_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuresphere:listCatalogDeviceGroups', __args__, opts=opts, typ=ListCatalogDeviceGroupsResult).value

    return AwaitableListCatalogDeviceGroupsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_catalog_device_groups_output(catalog_name: Optional[pulumi.Input[builtins.str]] = None,
                                      device_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuresphere:listCatalogDeviceGroups', __args__, opts=opts, typ=ListCatalogDeviceGroupsResult)
