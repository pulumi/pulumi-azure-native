...
def get_image(catalog_name: Optional[builtins.str] = None,
    ...
    :param builtins.str image_name: Image name. Use an image GUID for GA versions of the API.
...
def get_image_output(catalog_name: Optional[pulumi.Input[builtins.str]] = None,
