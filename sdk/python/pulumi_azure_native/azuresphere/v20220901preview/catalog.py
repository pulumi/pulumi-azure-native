...
class Catalog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuresphere/v20240401:Catalog"), pulumi.Alias(type_="azure-native:azuresphere:Catalog")])
