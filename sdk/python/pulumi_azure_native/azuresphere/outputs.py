...
class DeploymentResponse(dict):
    ...
    def __init__(__self__, *,
                 deployment_date_utc: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
        ...
        """
        An deployment resource belonging to a device group resource.
        :param builtins.str deployment_date_utc: Deployment date UTC
...
class DeviceGroupResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 has_deployment: builtins.bool,
                 id: builtins.str,
                 name: builtins.str,
                 provisioning_state: builtins.str,
                 system_data: 'outputs.SystemDataResponse',
                 type: builtins.str,
                 allow_crash_dumps_collection: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 os_feed_type: Optional[builtins.str] = None,
                 regional_data_boundary: Optional[builtins.str] = None,
                 update_policy: Optional[builtins.str] = None):
        """
        An device group resource belonging to a product resource.
        :param builtins.bool has_deployment: Deployment status for the device group.
        :param builtins.str id: Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param builtins.str name: The name of the resource
        :param builtins.str provisioning_state: The status of the last operation.
        :param 'SystemDataResponse' system_data: Azure Resource Manager metadata containing createdBy and modifiedBy information.
        :param builtins.str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
        :param builtins.str allow_crash_dumps_collection: Flag to define if the user allows for crash dump collection.
        :param builtins.str description: Description of the device group.
        :param builtins.str os_feed_type: Operating system feed type of the device group.
        :param builtins.str regional_data_boundary: Regional data boundary for the device group.
        :param builtins.str update_policy: Update policy of the device group.
        """
...
class DeviceInsightResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 end_timestamp_utc: builtins.str,
                 event_category: builtins.str,
                 event_class: builtins.str,
                 event_count: builtins.int,
                 event_type: builtins.str,
                 start_timestamp_utc: builtins.str):
        """
        Device insight report.
        :param builtins.str description: Event description
        :param builtins.str device_id: Device ID
        :param builtins.str end_timestamp_utc: Event end timestamp
        :param builtins.str event_category: Event category
        :param builtins.str event_class: Event class
        :param builtins.int event_count: Event count
        :param builtins.str event_type: Event type
        :param builtins.str start_timestamp_utc: Event start timestamp
        """
        pulumi.set(__self__, "description", description)
    ...
    def end_timestamp_utc(self) -> builtins.str:
        """
        Event end timestamp
        """
    ...
    def event_class(self) -> builtins.str:
        """
        Event class
        """
    ...
    def start_timestamp_utc(self) -> builtins.str:
        """
...
class DeviceResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 chip_sku: builtins.str,
                 id: builtins.str,
                 last_available_os_version: builtins.str,
                 last_installed_os_version: builtins.str,
                 last_os_update_utc: builtins.str,
                 last_update_request_utc: builtins.str,
                 name: builtins.str,
                 provisioning_state: builtins.str,
                 system_data: 'outputs.SystemDataResponse',
                 type: builtins.str,
        ...
        """
        An device resource belonging to a device group resource.
        :param builtins.str chip_sku: SKU of the chip
        :param builtins.str id: Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param builtins.str last_available_os_version: OS version available for installation when update requested
        :param builtins.str last_installed_os_version: OS version running on device when update requested
        :param builtins.str last_os_update_utc: Time when update requested and new OS version available
        :param builtins.str last_update_request_utc: Time when update was last requested
        :param builtins.str name: The name of the resource
        :param builtins.str provisioning_state: The status of the last operation.
        :param 'SystemDataResponse' system_data: Azure Resource Manager metadata containing createdBy and modifiedBy information.
        :param builtins.str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
...
class ImageResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An image resource belonging to a catalog resource.
        :param builtins.str component_id: The image component id.
        :param builtins.str description: The image description.
        :param builtins.str id: Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        :param builtins.str image_name: Image name
        :param builtins.str image_type: The image type.
        :param builtins.str name: The name of the resource
        :param builtins.str provisioning_state: The status of the last operation.
        :param 'SystemDataResponse' system_data: Azure Resource Manager metadata containing createdBy and modifiedBy information.
        :param builtins.str type: The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
        :param builtins.str uri: Location the image
        :param builtins.str image: Image as a UTF-8 encoded base 64 string on image create. This field contains the image URI on image reads.
        :param builtins.str image_id: Image ID
        :param builtins.str regional_data_boundary: Regional data boundary for an image
        """
