...
class DeviceGroupArgs:
    def __init__(__self__, *,
                 ...
                 allow_crash_dumps_collection: Optional[pulumi.Input[Union[builtins.str, 'AllowCrashDumpCollection']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 device_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 os_feed_type: Optional[pulumi.Input[Union[builtins.str, 'OSFeedType']]] = None,
                 regional_data_boundary: Optional[pulumi.Input[Union[builtins.str, 'RegionalDataBoundary']]] = None,
                 update_policy: Optional[pulumi.Input[Union[builtins.str, 'UpdatePolicy']]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: Description of the device group.
        :param pulumi.Input[builtins.str] device_group_name: Name of device group.
        :param pulumi.Input[Union[builtins.str, 'OSFeedType']] os_feed_type: Operating system feed type of the device group.
        :param pulumi.Input[Union[builtins.str, 'RegionalDataBoundary']] regional_data_boundary: Regional data boundary for the device group.
        :param pulumi.Input[Union[builtins.str, 'UpdatePolicy']] update_policy: Update policy of the device group.
        """
    ...
    def allow_crash_dumps_collection(self) -> Optional[pulumi.Input[Union[builtins.str, 'AllowCrashDumpCollection']]]:
        """
    ...
    def allow_crash_dumps_collection(self, value: Optional[pulumi.Input[Union[builtins.str, 'AllowCrashDumpCollection']]]):
    ...
    def device_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "device_group_name", value)

    @property
    @pulumi.getter(name="osFeedType")
    def os_feed_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'OSFeedType']]]:
        """
    ...
    @os_feed_type.setter
    def os_feed_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'OSFeedType']]]):
        pulumi.set(self, "os_feed_type", value)

    @property
    @pulumi.getter(name="regionalDataBoundary")
    def regional_data_boundary(self) -> Optional[pulumi.Input[Union[builtins.str, 'RegionalDataBoundary']]]:
        """
    ...
    def regional_data_boundary(self, value: Optional[pulumi.Input[Union[builtins.str, 'RegionalDataBoundary']]]):
        pulumi.set(self, "regional_data_boundary", value)

    @property
    @pulumi.getter(name="updatePolicy")
    def update_policy(self) -> Optional[pulumi.Input[Union[builtins.str, 'UpdatePolicy']]]:
        """
    ...
    def update_policy(self, value: Optional[pulumi.Input[Union[builtins.str, 'UpdatePolicy']]]):
...
class DeviceGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowCrashDumpsCollection")
    def allow_crash_dumps_collection(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Flag to define if the user allows for crash dump collection.
        """
        return pulumi.get(self, "allow_crash_dumps_collection")
    ...
    def has_deployment(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="osFeedType")
    def os_feed_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Operating system feed type of the device group.
        """
        return pulumi.get(self, "os_feed_type")
    ...
    @property
    @pulumi.getter(name="regionalDataBoundary")
    def regional_data_boundary(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Regional data boundary for the device group.
        """
        return pulumi.get(self, "regional_data_boundary")
    ...
    @property
    @pulumi.getter(name="updatePolicy")
    def update_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Update policy of the device group.
        """
        return pulumi.get(self, "update_policy")
