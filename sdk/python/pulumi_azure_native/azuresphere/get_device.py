...
def get_device(catalog_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str device_name: Device name
...
def get_device_output(catalog_name: Optional[pulumi.Input[_builtins.str]] = None,
