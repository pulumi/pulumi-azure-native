...
def get_deployment(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuresphere/v20240401:getDeployment', __args__, opts=opts, typ=GetDeploymentResult).value
...
def get_deployment_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuresphere/v20240401:getDeployment', __args__, opts=opts, typ=GetDeploymentResult)
