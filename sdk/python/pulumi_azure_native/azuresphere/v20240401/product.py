...
class Product(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuresphere:Product"), pulumi.Alias(type_="azure-native:azuresphere/v20220901preview:Product")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Product, __self__).__init__(
            'azure-native:azuresphere/v20240401:Product',
            resource_name,
            __props__,
            opts)
