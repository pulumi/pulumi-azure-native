...
def list_catalog_devices(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuresphere/v20240401:listCatalogDevices', __args__, opts=opts, typ=ListCatalogDevicesResult).value
...
def list_catalog_devices_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuresphere/v20240401:listCatalogDevices', __args__, opts=opts, typ=ListCatalogDevicesResult)
