...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azuresphere:Deployment"), pulumi.Alias(type_="azure-native:azuresphere/v20220901preview:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azure-native:azuresphere/v20240401:Deployment',
            resource_name,
            __props__,
            opts)
