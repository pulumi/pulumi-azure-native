...
def get_image(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuresphere/v20240401:getImage', __args__, opts=opts, typ=GetImageResult).value
...
def get_image_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuresphere/v20240401:getImage', __args__, opts=opts, typ=GetImageResult)
