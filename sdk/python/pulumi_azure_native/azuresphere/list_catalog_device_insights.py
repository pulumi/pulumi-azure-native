...
def list_catalog_device_insights(catalog_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azuresphere:listCatalogDeviceInsights', __args__, opts=opts, typ=ListCatalogDeviceInsightsResult).value

    return AwaitableListCatalogDeviceInsightsResult(
        next_link=pulumi.get(__ret__, 'next_link'),
        value=pulumi.get(__ret__, 'value'))
def list_catalog_device_insights_output(catalog_name: Optional[pulumi.Input[_builtins.str]] = None,
