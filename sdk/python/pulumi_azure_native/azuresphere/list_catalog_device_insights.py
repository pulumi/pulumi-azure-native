...
def list_catalog_device_insights(catalog_name: Optional[builtins.str] = None,
...
def list_catalog_device_insights_output(catalog_name: Optional[pulumi.Input[builtins.str]] = None,
