...
def list_catalog_deployments(catalog_name: Optional[_builtins.str] = None,
                             filter: Optional[_builtins.str] = None,
                             maxpagesize: Optional[_builtins.int] = None,
    ...
    :param _builtins.int maxpagesize: The maximum number of result items per page.
    :param _builtins.str resource_group_name: The name of the resource group. The name is case insensitive.
    :param _builtins.int skip: The number of result items to skip.
    :param _builtins.int top: The number of result items to return.
    """
    __args__ = dict()
...
def list_catalog_deployments_output(catalog_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azuresphere:listCatalogDeployments', __args__, opts=opts, typ=ListCatalogDeploymentsResult)
