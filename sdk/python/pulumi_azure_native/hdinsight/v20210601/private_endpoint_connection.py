...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hdinsight:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:hdinsight/v20230415preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:hdinsight/v20230815preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:hdinsight/v20240801preview:PrivateEndpointConnection")])
