...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        application = azure_native.hdinsight.v20210601.Application("application",
            application_name="hue",
            cluster_name="cluster1",
            properties=azure_native.hdinsight.v20210601.ApplicationPropertiesResponseArgs(
                ...
                errors=[],
                https_endpoints=[azure_native.hdinsight.v20210601.ApplicationGetHttpsEndpointArgs(
                    access_modes=["WebPage"],
                    destination_port=20000,
                    sub_domain_suffix="dss",
                )],
                install_script_actions=[azure_native.hdinsight.v20210601.RuntimeScriptActionArgs(
