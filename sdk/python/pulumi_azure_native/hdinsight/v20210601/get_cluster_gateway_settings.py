...
def get_cluster_gateway_settings_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight/v20210601:getClusterGatewaySettings', __args__, opts=opts, typ=GetClusterGatewaySettingsResult)
