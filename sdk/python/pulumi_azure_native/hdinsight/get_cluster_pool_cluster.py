...
def get_cluster_pool_cluster(cluster_name: Optional[_builtins.str] = None,
                             cluster_pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_name: The name of the HDInsight cluster.
    :param _builtins.str cluster_pool_name: The name of the cluster pool.
...
def get_cluster_pool_cluster_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
