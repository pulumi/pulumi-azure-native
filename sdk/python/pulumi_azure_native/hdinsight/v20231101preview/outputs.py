...
class ClusterProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'IdentityProfileResponse' identity_profile: This property is required by Trino, Spark and Flink cluster but is optional for Kafka cluster.
...
class KafkaProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 cluster_identity: 'outputs.IdentityProfileResponse',
        ...
        """
        The Kafka cluster profile.
        :param 'IdentityProfileResponse' cluster_identity: Identity of the internal service components inside the Kafka cluster.
    ...
    def cluster_identity(self) -> 'outputs.IdentityProfileResponse':
        """
