...
def get_cluster_pool_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hdinsight/v20231101preview:getClusterPoolCluster', __args__, opts=opts, typ=GetClusterPoolClusterResult).value
...
def get_cluster_pool_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight/v20231101preview:getClusterPoolCluster', __args__, opts=opts, typ=GetClusterPoolClusterResult)
