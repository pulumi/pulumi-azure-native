...
def get_application(application_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hdinsight/v20230415preview:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
...
def get_application_output(application_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight/v20230415preview:getApplication', __args__, opts=opts, typ=GetApplicationResult)
