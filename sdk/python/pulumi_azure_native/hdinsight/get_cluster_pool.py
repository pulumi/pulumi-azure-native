...
class GetClusterPoolResult:
    ...
    Cluster pool.
    """
    def __init__(__self__, aks_cluster_profile=None, aks_managed_resource_group_name=None, azure_api_version=None, cluster_pool_profile=None, compute_profile=None, deployment_id=None, id=None, location=None, log_analytics_profile=None, managed_resource_group_name=None, name=None, network_profile=None, provisioning_state=None, status=None, system_data=None, tags=None, type=None):
    ...
    def aks_managed_resource_group_name(self) -> _builtins.str:
        """
...
def get_cluster_pool(cluster_pool_name: Optional[_builtins.str] = None,
...
def get_cluster_pool_output(cluster_pool_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight:getClusterPool', __args__, opts=opts, typ=GetClusterPoolResult)
