...
class AksClusterProfileResponseAksClusterAgentPoolIdentityProfile(dict):
    ...
    def _configure(
             ...
             msi_client_id: Optional[str] = None,
             msi_object_id: Optional[str] = None,
...
class ClusterPoolResourcePropertiesResponseAksClusterProfile(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if aks_version is None and 'aksVersion' in kwargs:
            aks_version = kwargs['aksVersion']
        if aks_version is None:
            raise TypeError("Missing 'aks_version' argument")
        if aks_cluster_agent_pool_identity_profile is None and 'aksClusterAgentPoolIdentityProfile' in kwargs:
            aks_cluster_agent_pool_identity_profile = kwargs['aksClusterAgentPoolIdentityProfile']
        if aks_cluster_resource_id is None and 'aksClusterResourceId' in kwargs:
...
class ClusterProfileResponse(dict):
    ...
    def _configure(
             ...
             components: Optional[Sequence['outputs.ClusterProfileResponseComponents']] = None,
        ...
        if connectivity_profile is None and 'connectivityProfile' in kwargs:
            connectivity_profile = kwargs['connectivityProfile']
        if connectivity_profile is None:
            raise TypeError("Missing 'connectivity_profile' argument")
...
class ClusterServiceConfigResponse(dict):
    ...
    def _configure(
             ...
             files: Optional[Sequence['outputs.ClusterConfigFileResponse']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class ClusterServiceConfigsProfileResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             configs: Optional[Sequence['outputs.ClusterServiceConfigResponse']] = None,
...
class ComputeProfileResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             nodes: Optional[Sequence['outputs.NodeProfileResponse']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if nodes is None:
...
class ConnectivityProfileResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             web: Optional['outputs.ConnectivityProfileResponseWeb'] = None,
             ssh: Optional[Sequence['outputs.SshConnectivityEndpointResponse']] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if web is None:
...
class FlinkHiveCatalogOptionResponse(dict):
    ...
    def _configure(
             ...
             metastore_db_connection_url: Optional[str] = None,
...
class FlinkProfileResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             job_manager: Optional['outputs.ComputeResourceDefinitionResponse'] = None,
             storage: Optional['outputs.FlinkStorageProfileResponse'] = None,
             task_manager: Optional['outputs.ComputeResourceDefinitionResponse'] = None,
             catalog_options: Optional['outputs.FlinkCatalogOptionsResponse'] = None,
             history_server: Optional['outputs.ComputeResourceDefinitionResponse'] = None,
             num_replicas: Optional[int] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
...
class HiveCatalogOptionResponse(dict):
    ...
    def _configure(
             ...
             metastore_db_connection_url: Optional[str] = None,
             metastore_db_connection_user_name: Optional[str] = None,
             metastore_warehouse_dir: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class LoadBasedConfigResponse(dict):
    ...
    def _configure(
             ...
             scaling_rules: Optional[Sequence['outputs.ScalingRuleResponse']] = None,
             cooldown_period: Optional[int] = None,
             poll_interval: Optional[int] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class ScalingRuleResponse(dict):
    ...
    def _configure(
             ...
             comparison_rule: Optional['outputs.ComparisonRuleResponse'] = None,
...
class SecretReferenceResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             key_vault_object_name: Optional[str] = None,
...
class SparkMetastoreSpecResponse(dict):
    ...
    def _configure(
             ...
             db_server_host: Optional[str] = None,
...
class SshProfileResponse(dict):
    ...
    def _configure(
        ...
        if count is None:
            raise TypeError("Missing 'count' argument")
        if pod_prefix is None and 'podPrefix' in kwargs:
            pod_prefix = kwargs['podPrefix']
        if pod_prefix is None:
            raise TypeError("Missing 'pod_prefix' argument")
