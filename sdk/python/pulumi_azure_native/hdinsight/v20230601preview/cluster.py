...
class ClusterArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if cluster_pool_name is None and 'clusterPoolName' in kwargs:
            cluster_pool_name = kwargs['clusterPoolName']
        if cluster_pool_name is None:
            raise TypeError("Missing 'cluster_pool_name' argument")
        if cluster_profile is None and 'clusterProfile' in kwargs:
            cluster_profile = kwargs['clusterProfile']
        if cluster_profile is None:
            raise TypeError("Missing 'cluster_profile' argument")
        ...
        if compute_profile is None:
            raise TypeError("Missing 'compute_profile' argument")
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cluster_profile = _utilities.configure(cluster_profile, ClusterProfileArgs, True)
            ...
            compute_profile = _utilities.configure(compute_profile, ComputeProfileArgs, True)
