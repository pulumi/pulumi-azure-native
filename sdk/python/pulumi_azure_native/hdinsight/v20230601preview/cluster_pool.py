...
class ClusterPoolArgs:
    ...
    def _configure(
        ...
        if 'clusterPoolProfile' in kwargs:
...
class ClusterPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cluster_pool_profile is not None and not isinstance(cluster_pool_profile, ClusterPoolResourcePropertiesClusterPoolProfileArgs):
            ...
            if compute_profile is not None and not isinstance(compute_profile, ClusterPoolResourcePropertiesComputeProfileArgs):
            ...
            if log_analytics_profile is not None and not isinstance(log_analytics_profile, ClusterPoolResourcePropertiesLogAnalyticsProfileArgs):
            ...
            if network_profile is not None and not isinstance(network_profile, ClusterPoolResourcePropertiesNetworkProfileArgs):
