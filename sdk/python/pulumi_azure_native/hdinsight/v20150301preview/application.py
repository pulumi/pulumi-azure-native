...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hdinsight/v20150301preview:Application"), pulumi.Alias(type_="azure-native:hdinsight:Application"), pulumi.Alias(type_="azure-nextgen:hdinsight:Application"), pulumi.Alias(type_="azure-native:hdinsight/v20180601preview:Application"), pulumi.Alias(type_="azure-nextgen:hdinsight/v20180601preview:Application")])
