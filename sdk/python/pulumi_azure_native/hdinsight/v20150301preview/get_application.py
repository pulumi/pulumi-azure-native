...
def get_application(application_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: Version v20150301preview will be removed in the next major version of the provider. Upgrade to version v20180601preview or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hdinsight/v20150301preview:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
