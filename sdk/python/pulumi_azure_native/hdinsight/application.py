...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_name: The constant value for the application name.
        :param pulumi.Input['ApplicationPropertiesArgs'] properties: The properties of the application.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags for the application.
        """
