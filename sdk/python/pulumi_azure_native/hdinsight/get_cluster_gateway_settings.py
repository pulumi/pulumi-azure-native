...
class GetClusterGatewaySettingsResult:
    ...
    def is_credential_enabled(self) -> builtins.str:
        """
...
def get_cluster_gateway_settings(cluster_name: Optional[builtins.str] = None,
...
def get_cluster_gateway_settings_output(cluster_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight:getClusterGatewaySettings', __args__, opts=opts, typ=GetClusterGatewaySettingsResult)
