...
@pulumi.output_type
class EntraUserInfoResponse(dict):
    """
    ...
    def __init__(__self__, *,
        ...
        """
        Details of an Entra user for gateway access.
        :param str display_name: The display name of the Entra user.
        :param str object_id: The unique object ID of the Entra user or client ID of the enterprise applications.
        :param str upn: The User Principal Name (UPN) of the Entra user. It may be empty in certain cases, such as for enterprise applications.
        """
