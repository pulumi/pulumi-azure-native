...
def get_cluster_gateway_settings_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight/v20180601preview:getClusterGatewaySettings', __args__, opts=opts, typ=GetClusterGatewaySettingsResult)
