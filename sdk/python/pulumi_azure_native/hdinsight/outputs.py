...
class AksClusterProfileResponseAksClusterAgentPoolIdentityProfile(dict):
    ...
    def __init__(__self__, *,
                 msi_client_id: _builtins.str,
                 msi_object_id: _builtins.str,
                 msi_resource_id: _builtins.str):
        """
        Identity properties of the AKS cluster agentpool MSI
        :param _builtins.str msi_client_id: ClientId of the MSI.
        :param _builtins.str msi_object_id: ObjectId of the MSI.
        :param _builtins.str msi_resource_id: ResourceId of the MSI.
        """
    ...
    def msi_client_id(self) -> _builtins.str:
        """
        ClientId of the MSI.
        """
    ...
    def msi_object_id(self) -> _builtins.str:
        """
        ObjectId of the MSI.
        """
...
class AuthorizationProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Authorization profile with details of AAD user Ids and group Ids authorized for data plane access.
        :param Sequence[_builtins.str] group_ids: AAD group Ids authorized for data plane access.
        :param Sequence[_builtins.str] user_ids: AAD user Ids authorized for data plane access.
        """
...
class AutoscaleProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 graceful_decommission_timeout: Optional[_builtins.int] = None,
        ...
        """
        This is the Autoscale profile for the cluster. This will allow customer to create cluster enabled with Autoscale.
        :param _builtins.bool enabled: This indicates whether auto scale is enabled on HDInsight on AKS cluster.
        :param _builtins.str autoscale_type: User to specify which type of Autoscale to be implemented - Scheduled Based or Load Based.
        :param _builtins.int graceful_decommission_timeout: This property is for graceful decommission timeout; It has a default setting of 3600 seconds before forced shutdown takes place. This is the maximal time to wait for running containers and applications to complete before transition a DECOMMISSIONING node into DECOMMISSIONED. The default value is 3600 seconds. Negative value (like -1) is handled as infinite timeout.
    ...
    def graceful_decommission_timeout(self) -> Optional[_builtins.int]:
        """
...
class ClusterAccessProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 enable_internal_ingress: _builtins.bool,
                 private_link_service_id: _builtins.str):
        """
        Cluster access profile.
        :param _builtins.bool enable_internal_ingress: Whether to create cluster using private IP instead of public IP. This property must be set at create time.
        :param _builtins.str private_link_service_id: Private link service resource ID. Only when enableInternalIngress is true, this property will be returned.
        """
    ...
    def enable_internal_ingress(self) -> _builtins.bool:
        """
...
class ClusterConfigFileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str content: Free form content of the entire configuration file.
        :param _builtins.str encoding: This property indicates if the content is encoded and is case-insensitive. Please set the value to base64 if the content is base64 encoded. Set it to none or skip it if the content is plain text.
        :param _builtins.str path: Path of the config file if content is specified.
        :param Mapping[str, _builtins.str] values: List of key value pairs
...
class ClusterLogAnalyticsApplicationLogsResponse(dict):
    ...
    def __init__(__self__, *,
                 std_error_enabled: Optional[_builtins.bool] = None,
                 std_out_enabled: Optional[_builtins.bool] = None):
        """
        Collection of logs to be enabled or disabled for log analytics.
        :param _builtins.bool std_error_enabled: True if stderror is enabled, otherwise false.
        :param _builtins.bool std_out_enabled: True if stdout is enabled, otherwise false.
        """
    ...
    def std_error_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def std_out_enabled(self) -> Optional[_builtins.bool]:
        """
...
class ClusterLogAnalyticsProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster log analytics profile to enable or disable OMS agent for cluster.
        :param _builtins.bool enabled: True if log analytics is enabled for the cluster, otherwise false.
        ...
        :param _builtins.bool metrics_enabled: True if metrics are enabled, otherwise false.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterPoolComputeProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] availability_zones: The list of Availability zones to use for AKS VMSS nodes.
        """
...
class ClusterPoolResourcePropertiesResponseAksClusterProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aks_cluster_resource_id: Optional[_builtins.str] = None):
        """
        Properties of underlying AKS cluster.
        :param _builtins.str aks_version: AKS control plane and default node pool version of this ClusterPool
        ...
        :param _builtins.str aks_cluster_resource_id: ARM Resource ID of the AKS cluster
        """
    ...
    def aks_version(self) -> _builtins.str:
        """
    ...
    def aks_cluster_resource_id(self) -> Optional[_builtins.str]:
        """
...
class ClusterPoolResourcePropertiesResponseClusterPoolProfile(dict):
    ...
    def __init__(__self__, *,
                 cluster_pool_version: _builtins.str,
                 public_ip_tag: Optional['outputs.IpTagResponse'] = None):
        """
        CLuster pool profile.
        :param _builtins.str cluster_pool_version: Cluster pool version is a 2-part version.
    ...
    def cluster_pool_version(self) -> _builtins.str:
        """
...
class ClusterPoolResourcePropertiesResponseComputeProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        CLuster pool compute profile.
        :param _builtins.int count: The number of virtual machines.
        :param _builtins.str vm_size: The virtual machine SKU.
        :param Sequence[_builtins.str] availability_zones: The list of Availability zones to use for AKS VMSS nodes.
        """
...
class ClusterPoolResourcePropertiesResponseLogAnalyticsProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster pool log analytics profile to enable OMS agent for AKS cluster.
        :param _builtins.bool enabled: True if log analytics is enabled for cluster pool, otherwise false.
        :param _builtins.str workspace_id: Log analytics workspace to associate with the OMS agent.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterPoolResourcePropertiesResponseNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 api_server_authorized_ip_ranges: Optional[Sequence[_builtins.str]] = None,
                 enable_private_api_server: Optional[_builtins.bool] = None,
                 outbound_type: Optional[_builtins.str] = None):
        """
        Cluster pool network profile.
        :param _builtins.str subnet_id: Cluster pool subnet resource id.
        :param Sequence[_builtins.str] api_server_authorized_ip_ranges: IP ranges are specified in CIDR format, e.g. 137.117.106.88/29. This feature is not compatible with private AKS clusters. So you cannot set enablePrivateApiServer to true and apiServerAuthorizedIpRanges at the same time. Currently, this property is not supported and please don't use it.
        :param _builtins.bool enable_private_api_server: ClusterPool is based on AKS cluster. AKS cluster exposes the API server to public internet by default. If you set this property to true, a private AKS cluster will be created, and it will use private apiserver, which is not exposed to public internet.
        :param _builtins.str outbound_type: This can only be set at cluster pool creation time and cannot be changed later. 
        """
    ...
    def api_server_authorized_ip_ranges(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def enable_private_api_server(self) -> Optional[_builtins.bool]:
        """
...
class ClusterPoolSshProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 count: _builtins.int,
                 pod_prefix: _builtins.str,
                 vm_size: Optional[_builtins.str] = None):
        """
        Ssh profile for the cluster.
        :param _builtins.int count: Number of ssh pods per cluster.
        :param _builtins.str pod_prefix: Prefix of the pod names. Pod number will be appended to the prefix. The ingress URLs for the pods will be available at <clusterFqdn>/<sshBasePath>/<prefix>-<number>
        :param _builtins.str vm_size: The virtual machine SKU.
        """
        pulumi.set(__self__, "count", count)
    ...
    def pod_prefix(self) -> _builtins.str:
        """
...
class ClusterProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str cluster_version: Version with 3/4 part.
        ...
        :param _builtins.str oss_version: Version with three part.
    ...
    def oss_version(self) -> _builtins.str:
        """
...
class ClusterPrometheusProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster Prometheus profile.
        :param _builtins.bool enabled: Enable Prometheus for cluster or not.
        """
        if enabled is None:
            enabled = False
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterRangerPluginProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster Ranger plugin profile.
        :param _builtins.bool enabled: Enable Ranger for cluster or not.
        """
        if enabled is None:
            enabled = False
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterServiceConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cluster configs per component.
        :param _builtins.str component: Name of the component the config files should apply to.
...
class ClusterServiceConfigsProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str service_name: Name of the service the configurations should apply to.
        """
...
class ComparisonRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float threshold: Threshold setting.
        """
...
class ComputeResourceDefinitionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The cpu and memory requirement definition.
        :param _builtins.float cpu: The required CPU.
        :param _builtins.float memory: The required memory in MB, Container memory will be 110 percentile
        """
...
class ConnectivityProfileResponseWeb(dict):
    ...
    def __init__(__self__, *,
                 fqdn: _builtins.str,
                 private_fqdn: Optional[_builtins.str] = None):
        """
        Web connectivity endpoint details.
        :param _builtins.str fqdn: Web connectivity endpoint.
        :param _builtins.str private_fqdn: Private web connectivity endpoint. This property will only be returned when enableInternalIngress is true.
        """
    ...
    def private_fqdn(self) -> Optional[_builtins.str]:
        """
...
class DiskStorageProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Kafka disk storage profile.
        :param _builtins.int data_disk_size: Managed Disk size in GB. The maximum supported disk size for Standard and Premium HDD/SSD is 32TB, except for Premium SSD v2, which supports up to 64TB.
        :param _builtins.str data_disk_type: Managed Disk Type.
        """
...
class FlinkHiveCatalogOptionResponse(dict):
    ...
    def __init__(__self__, *,
                 metastore_db_connection_url: _builtins.str,
                 metastore_db_connection_authentication_mode: Optional[_builtins.str] = None,
                 metastore_db_connection_password_secret: Optional[_builtins.str] = None,
                 metastore_db_connection_user_name: Optional[_builtins.str] = None):
        """
        Hive Catalog Option for Flink cluster.
        :param _builtins.str metastore_db_connection_url: Connection string for hive metastore database.
        :param _builtins.str metastore_db_connection_authentication_mode: The authentication mode to connect to your Hive metastore database. More details: https://learn.microsoft.com/en-us/azure/azure-sql/database/logins-create-manage?view=azuresql#authentication-and-authorization
        :param _builtins.str metastore_db_connection_password_secret: Secret reference name from secretsProfile.secrets containing password for database connection.
        :param _builtins.str metastore_db_connection_user_name: User name for database connection.
        """
    ...
    def metastore_db_connection_url(self) -> _builtins.str:
        """
    ...
    def metastore_db_connection_authentication_mode(self) -> Optional[_builtins.str]:
        """
    ...
    def metastore_db_connection_password_secret(self) -> Optional[_builtins.str]:
        """
    ...
    def metastore_db_connection_user_name(self) -> Optional[_builtins.str]:
        """
...
class FlinkJobProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 jar_name: _builtins.str,
                 job_jar_directory: _builtins.str,
                 upgrade_mode: _builtins.str,
                 args: Optional[_builtins.str] = None,
                 entry_class: Optional[_builtins.str] = None,
                 save_point_name: Optional[_builtins.str] = None):
        """
        Job specifications for flink clusters in application deployment mode. The specification is immutable even if job properties are changed by calling the RunJob API, please use the ListJob API to get the latest job information.
        :param _builtins.str jar_name: A string property that represents the name of the job JAR.
        :param _builtins.str job_jar_directory: A string property that specifies the directory where the job JAR is located.
        :param _builtins.str upgrade_mode: A string property that indicates the upgrade mode to be performed on the Flink job. It can have one of the following enum values => STATELESS_UPDATE, UPDATE, LAST_STATE_UPDATE.
        :param _builtins.str args: A string property representing additional JVM arguments for the Flink job. It should be space separated value.
        :param _builtins.str entry_class: A string property that specifies the entry class for the Flink job. If not specified, the entry point is auto-detected from the flink job jar package.
        :param _builtins.str save_point_name: A string property that represents the name of the savepoint for the Flink job
        """
    ...
    def jar_name(self) -> _builtins.str:
        """
    ...
    def job_jar_directory(self) -> _builtins.str:
        """
    ...
    def upgrade_mode(self) -> _builtins.str:
        """
    ...
    def save_point_name(self) -> Optional[_builtins.str]:
        """
...
class FlinkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 num_replicas: Optional[_builtins.int] = None):
        """
        The Flink cluster profile.
        ...
        :param _builtins.str deployment_mode: A string property that indicates the deployment mode of Flink cluster. It can have one of the following enum values => Application, Session. Default value is Session
        ...
        :param _builtins.int num_replicas: The number of task managers.
        """
    ...
    def num_replicas(self) -> Optional[_builtins.int]:
        """
...
class FlinkStorageProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storagekey: Optional[_builtins.str] = None):
        """
        The storage profile
        :param _builtins.str storage_uri: Storage account uri which is used for savepoint and checkpoint state.
        :param _builtins.str storagekey: Storage key is only required for wasb(s) storage.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def storagekey(self) -> Optional[_builtins.str]:
        """
...
class HiveCatalogOptionResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metastore_db_connection_url: _builtins.str,
                 metastore_warehouse_dir: _builtins.str,
                 metastore_db_connection_authentication_mode: Optional[_builtins.str] = None,
                 metastore_db_connection_password_secret: Optional[_builtins.str] = None,
                 metastore_db_connection_user_name: Optional[_builtins.str] = None):
        """
        Hive Catalog Option
        :param _builtins.str catalog_name: Name of trino catalog which should use specified hive metastore.
        :param _builtins.str metastore_db_connection_url: Connection string for hive metastore database.
        :param _builtins.str metastore_warehouse_dir: Metastore root directory URI, format: abfs[s]://<container>@<account_name>.dfs.core.windows.net/<path>. More details: https://docs.microsoft.com/en-us/azure/storage/blobs/data-lake-storage-introduction-abfs-uri
        :param _builtins.str metastore_db_connection_authentication_mode: The authentication mode to connect to your Hive metastore database. More details: https://learn.microsoft.com/en-us/azure/azure-sql/database/logins-create-manage?view=azuresql#authentication-and-authorization
        :param _builtins.str metastore_db_connection_password_secret: Secret reference name from secretsProfile.secrets containing password for database connection.
        :param _builtins.str metastore_db_connection_user_name: User name for database connection.
        """
    ...
    def metastore_warehouse_dir(self) -> _builtins.str:
        """
...
class KafkaConnectivityEndpointsResponse(dict):
    ...
    def __init__(__self__, *,
                 bootstrap_server_endpoint: Optional[_builtins.str] = None,
                 broker_endpoints: Optional[Sequence[_builtins.str]] = None):
        """
        Kafka bootstrap server and broker related connectivity endpoints.
        :param _builtins.str bootstrap_server_endpoint: bootstrap server connectivity endpoint.
        :param Sequence[_builtins.str] broker_endpoints: Kafka broker endpoint list.
        """
    ...
    def bootstrap_server_endpoint(self) -> Optional[_builtins.str]:
        """
    ...
    def broker_endpoints(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class KafkaProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_k_raft: Optional[_builtins.bool] = None,
                 enable_public_endpoints: Optional[_builtins.bool] = None,
                 remote_storage_uri: Optional[_builtins.str] = None):
        """
        The Kafka cluster profile.
        ...
        :param _builtins.bool enable_k_raft: Expose Kafka cluster in KRaft mode.
        :param _builtins.bool enable_public_endpoints: Expose worker nodes as public endpoints.
        :param _builtins.str remote_storage_uri: Fully qualified path of Azure Storage container used for Tiered Storage.
        """
        pulumi.set(__self__, "connectivity_endpoints", connectivity_endpoints)
    ...
    def enable_k_raft(self) -> Optional[_builtins.bool]:
        """
    ...
    def enable_public_endpoints(self) -> Optional[_builtins.bool]:
        """
    ...
    def remote_storage_uri(self) -> Optional[_builtins.str]:
        """
...
class LoadBasedConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile of load based Autoscale.
        :param _builtins.int max_nodes: User needs to set the maximum number of nodes for load based scaling, the load based scaling will use this to scale up and scale down between minimum and maximum number of nodes.
        :param _builtins.int min_nodes: User needs to set the minimum number of nodes for load based scaling, the load based scaling will use this to scale up and scale down between minimum and maximum number of nodes.
        :param Sequence['ScalingRuleResponse'] scaling_rules: The scaling rules.
        :param _builtins.int cooldown_period: This is a cool down period, this is a time period in seconds, which determines the amount of time that must elapse between a scaling activity started by a rule and the start of the next scaling activity, regardless of the rule that triggers it. The default value is 300 seconds.
        :param _builtins.int poll_interval: User can specify the poll interval, this is the time period (in seconds) after which scaling metrics are polled for triggering a scaling operation.
        """
...
class ManagedIdentitySpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The details of a managed identity.
        :param _builtins.str client_id: ClientId of the managed identity.
        :param _builtins.str object_id: ObjectId of the managed identity.
        :param _builtins.str resource_id: ResourceId of the managed identity.
...
class NodeProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        The node profile.
        :param _builtins.int count: The number of virtual machines.
        :param _builtins.str type: The node type.
        :param _builtins.str vm_size: The virtual machine SKU.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "type", type)
...
class RangerAdminSpecResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 admins: Sequence[_builtins.str],
                 database: 'outputs.RangerAdminSpecResponseDatabase'):
        """
        Specification for the Ranger Admin service.
        :param Sequence[_builtins.str] admins: List of usernames that should be marked as ranger admins. These usernames should match the user principal name (UPN) of the respective AAD users.
        """
...
class RangerAdminSpecResponseDatabase(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: Optional[_builtins.str] = None):
        """
        :param _builtins.str host: The database URL
        :param _builtins.str name: The database name
        :param _builtins.str password_secret_ref: Reference for the database password
...
class RangerAuditSpecResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties required to describe audit log storage.
        :param _builtins.str storage_account: Azure storage location of the blobs. MSI should have read/write access to this Storage account.
        """
...
class RangerUsersyncSpecResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_mapping_location: Optional[_builtins.str] = None,
                 users: Optional[Sequence[_builtins.str]] = None):
        """
        Specification for the Ranger Usersync service
        :param _builtins.bool enabled: Denotes whether usersync service should be enabled
        :param Sequence[_builtins.str] groups: List of groups that should be synced. These group names should match the object id of the respective AAD groups.
        :param _builtins.str mode: User & groups can be synced automatically or via a static list that's refreshed.
        :param _builtins.str user_mapping_location: Azure storage location of a mapping file that lists user & group associations.
        :param Sequence[_builtins.str] users: List of user names that should be synced. These usernames should match the User principal name of the respective AAD users.
        """
        if enabled is None:
            enabled = True
    ...
    def user_mapping_location(self) -> Optional[_builtins.str]:
        """
...
class ScalingRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The scaling rule.
        :param _builtins.str action_type: The action type.
        :param 'ComparisonRuleResponse' comparison_rule: The comparison rule.
        :param _builtins.int evaluation_count: This is an evaluation count for a scaling condition, the number of times a trigger condition should be successful, before scaling activity is triggered.
        :param _builtins.str scaling_metric: Metrics name for individual workloads. For example: cpu
        """
...
class ScheduleBasedConfigResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Profile of schedule based Autoscale.
        :param _builtins.int default_count: Setting default node count of current schedule configuration. Default node count specifies the number of nodes which are default when an specified scaling operation is executed (scale up/scale down)
        ...
        :param _builtins.str time_zone: User has to specify the timezone on which the schedule has to be set for schedule based autoscale configuration.
        """
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Schedule definition.
        :param _builtins.int count: User has to set the node count anticipated at end of the scaling operation of the set current schedule configuration, format is integer.
        :param Sequence[_builtins.str] days: User has to set the days where schedule has to be set for autoscale operation.
        :param _builtins.str end_time: User has to set the end time of current schedule configuration, format like 10:30 (HH:MM).
        :param _builtins.str start_time: User has to set the start time of current schedule configuration, format like 10:30 (HH:MM).
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "days", days)
...
class ScriptActionProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: _builtins.str,
                 parameters: Optional[_builtins.str] = None,
                 should_persist: Optional[_builtins.bool] = None,
                 timeout_in_minutes: Optional[_builtins.int] = None):
        """
        The script action profile.
        :param _builtins.str name: Script name.
        :param Sequence[_builtins.str] services: List of services to apply the script action.
        :param _builtins.str type: Type of the script action. Supported type is bash scripts.
        :param _builtins.str url: Url of the script file.
        :param _builtins.str parameters: Additional parameters for the script action. It should be space-separated list of arguments required for script execution.
        :param _builtins.bool should_persist: Specify if the script should persist on the cluster.
        :param _builtins.int timeout_in_minutes: Timeout duration for the script action in minutes.
        """
        pulumi.set(__self__, "name", name)
    ...
    def should_persist(self) -> Optional[_builtins.bool]:
        """
...
class SecretReferenceResponse(dict):
    ...
    def __init__(__self__, *,
                 key_vault_object_name: _builtins.str,
                 reference_name: _builtins.str,
                 type: _builtins.str,
                 version: Optional[_builtins.str] = None):
        """
        Secret reference and corresponding properties of a key vault secret.
        :param _builtins.str key_vault_object_name: Object identifier name of the secret in key vault.
        :param _builtins.str reference_name: Reference name of the secret to be used in service configs.
        :param _builtins.str type: Type of key vault object: secret, key or certificate.
        :param _builtins.str version: Version of the secret in key vault.
        """
    ...
    def key_vault_object_name(self) -> _builtins.str:
        """
...
class SecretsProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The cluster secret profile.
        :param _builtins.str key_vault_resource_id: Name of the user Key Vault where all the cluster specific user secrets are stored.
...
class SparkMetastoreSpecResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 db_server_host: _builtins.str,
                 db_connection_authentication_mode: Optional[_builtins.str] = None,
                 db_password_secret_name: Optional[_builtins.str] = None,
                 db_user_name: Optional[_builtins.str] = None,
                 key_vault_id: Optional[_builtins.str] = None,
                 thrift_url: Optional[_builtins.str] = None):
        """
        The metastore specification for Spark cluster.
        :param _builtins.str db_name: The database name.
        :param _builtins.str db_server_host: The database server host.
        :param _builtins.str db_connection_authentication_mode: The authentication mode to connect to your Hive metastore database. More details: https://learn.microsoft.com/en-us/azure/azure-sql/database/logins-create-manage?view=azuresql#authentication-and-authorization
        :param _builtins.str db_password_secret_name: The secret name which contains the database user password.
        :param _builtins.str db_user_name: The database user name.
        :param _builtins.str key_vault_id: The key vault resource id.
        :param _builtins.str thrift_url: The thrift url.
        """
    ...
    def db_server_host(self) -> _builtins.str:
        """
    ...
    def db_connection_authentication_mode(self) -> Optional[_builtins.str]:
        """
        The authentication mode to connect to your Hive metastore database. More details: https://learn.microsoft.com/en-us/azure/azure-sql/database/logins-create-manage?view=azuresql#authentication-and-authorization
        """
    ...
    def db_password_secret_name(self) -> Optional[_builtins.str]:
        """
    ...
    def thrift_url(self) -> Optional[_builtins.str]:
        """
        The thrift url.
        """
...
class SparkProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 default_storage_url: Optional[_builtins.str] = None,
        ...
        """
        The spark cluster profile.
        :param _builtins.str default_storage_url: The default storage URL.
    ...
    def default_storage_url(self) -> Optional[_builtins.str]:
        """
...
class SparkUserPluginResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Spark user plugin.
        :param _builtins.str path: Fully qualified path to the folder containing the plugins.
        """
        pulumi.set(__self__, "path", path)
...
class SshConnectivityEndpointResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ssh_endpoint: Optional[_builtins.str] = None):
        """
        SSH connectivity endpoint details.
        :param _builtins.str endpoint: SSH connectivity endpoint.
        :param _builtins.str private_ssh_endpoint: Private SSH connectivity endpoint. This property will only be returned when enableInternalIngress is true.
        """
    ...
    def private_ssh_endpoint(self) -> Optional[_builtins.str]:
        """
...
class TrinoCoordinatorResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 high_availability_enabled: Optional[_builtins.bool] = None,
                 port: Optional[_builtins.int] = None,
                 suspend: Optional[_builtins.bool] = None):
        """
        Trino Coordinator.
        :param _builtins.bool enable: The flag that if enable debug or not.
        :param _builtins.bool high_availability_enabled: The flag that if enable coordinator HA, uses multiple coordinator replicas with auto failover, one per each head node. Default: true.
        :param _builtins.int port: The debug port.
        :param _builtins.bool suspend: The flag that if suspend debug or not.
        """
        if enable is None:
            enable = False
    ...
    def high_availability_enabled(self) -> Optional[_builtins.bool]:
        """
...
class TrinoTelemetryConfigResponse(dict):
    ...
    def __init__(__self__, *,
                 hivecatalog_name: Optional[_builtins.str] = None,
                 hivecatalog_schema: Optional[_builtins.str] = None,
                 partition_retention_in_days: Optional[_builtins.int] = None,
                 path: Optional[_builtins.str] = None):
        """
        Trino user telemetry definition.
        :param _builtins.str hivecatalog_name: Hive Catalog name used to mount external tables on the logs written by trino, if not specified there tables are not created.
        :param _builtins.str hivecatalog_schema: Schema of the above catalog to use, to mount query logs as external tables, if not specified tables will be mounted under schema trinologs.
        :param _builtins.int partition_retention_in_days: Retention period for query log table partitions, this doesn't have any affect on actual data.
        :param _builtins.str path: Azure storage location of the blobs.
        """
    ...
    def hivecatalog_name(self) -> Optional[_builtins.str]:
        """
    ...
    def hivecatalog_schema(self) -> Optional[_builtins.str]:
        """
    ...
    def partition_retention_in_days(self) -> Optional[_builtins.int]:
        """
...
class TrinoUserPluginResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Trino user plugin.
        :param _builtins.bool enabled: Denotes whether the plugin is active or not.
        :param _builtins.str name: This field maps to the sub-directory in trino plugins location, that will contain all the plugins under path.
        :param _builtins.str path: Fully qualified path to the folder containing the plugins.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
