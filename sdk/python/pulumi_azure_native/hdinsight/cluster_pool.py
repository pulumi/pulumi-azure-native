...
class ClusterPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] managed_resource_group_name: A resource group created by RP, to hold the resources created by RP on-behalf of customers. It will also be used to generate aksManagedResourceGroupName by pattern: MC_{managedResourceGroupName}_{clusterPoolName}_{region}. Please make sure it meets resource group name restriction.
    ...
    def cluster_pool_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def cluster_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class ClusterPool(pulumi.CustomResource):
    ...
    def aks_managed_resource_group_name(self) -> pulumi.Output[_builtins.str]:
        """
