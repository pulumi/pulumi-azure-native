...
def get_cluster_pool(cluster_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hdinsight/v20240501preview:getClusterPool', __args__, opts=opts, typ=GetClusterPoolResult).value
...
def get_cluster_pool_output(cluster_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hdinsight/v20240501preview:getClusterPool', __args__, opts=opts, typ=GetClusterPoolResult)
