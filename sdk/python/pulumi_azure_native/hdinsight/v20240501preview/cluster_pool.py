...
class ClusterPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:hdinsight/v20230601preview:ClusterPool"), pulumi.Alias(type_="azure-native:hdinsight/v20231101preview:ClusterPool"), pulumi.Alias(type_="azure-native:hdinsight:ClusterPool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ClusterPool, __self__).__init__(
            'azure-native:hdinsight/v20240501preview:ClusterPool',
            resource_name,
            __props__,
            opts)
