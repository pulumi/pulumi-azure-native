...
__all__ = ['ClusterPoolClusterArgs', 'ClusterPoolCluster']

@pulumi.input_type
class ClusterPoolClusterArgs:
    def __init__(__self__, *,
                 cluster_pool_name: pulumi.Input[_builtins.str],
                 cluster_profile: pulumi.Input['ClusterProfileArgs'],
                 cluster_type: pulumi.Input[_builtins.str],
                 compute_profile: pulumi.Input['ClusterPoolComputeProfileArgs'],
        ...
        :param pulumi.Input[_builtins.str] cluster_pool_name: The name of the cluster pool.
        :param pulumi.Input['ClusterProfileArgs'] cluster_profile: Cluster profile.
        :param pulumi.Input[_builtins.str] cluster_type: The type of cluster.
        :param pulumi.Input['ClusterPoolComputeProfileArgs'] compute_profile: The compute profile.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] cluster_name: The name of the HDInsight cluster.
    ...
    def cluster_pool_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def cluster_pool_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def compute_profile(self) -> pulumi.Input['ClusterPoolComputeProfileArgs']:
        """
        The compute profile.
        """
    ...
    def compute_profile(self, value: pulumi.Input['ClusterPoolComputeProfileArgs']):
...
@pulumi.type_token("azure-native:hdinsight:ClusterPoolCluster")
class ClusterPoolCluster(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
                 cluster_pool_name: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 compute_profile: Optional[pulumi.Input[Union['ClusterPoolComputeProfileArgs', 'ClusterPoolComputeProfileArgsDict']]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] cluster_type: The type of cluster.
        :param pulumi.Input[Union['ClusterPoolComputeProfileArgs', 'ClusterPoolComputeProfileArgsDict']] compute_profile: The compute profile.
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ClusterPoolClusterArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ClusterPoolClusterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ClusterPoolClusterArgs.__new__(ClusterPoolClusterArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ClusterPoolCluster':
        """
        ...
        __props__.__dict__["type"] = None
        return ClusterPoolCluster(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="computeProfile")
    def compute_profile(self) -> pulumi.Output['outputs.ClusterPoolComputeProfileResponse']:
        """
        The compute profile.
        """
        return pulumi.get(self, "compute_profile")
