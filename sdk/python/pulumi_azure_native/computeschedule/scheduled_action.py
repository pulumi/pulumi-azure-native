...
class ScheduledActionArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['ScheduledActionPropertiesArgs']]:
        """
...
class ScheduledAction(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['ScheduledActionPropertiesArgs', 'ScheduledActionPropertiesArgsDict']]] = None,
