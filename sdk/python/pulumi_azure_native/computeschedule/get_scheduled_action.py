...
def get_scheduled_action(resource_group_name: Optional[builtins.str] = None,
                         scheduled_action_name: Optional[builtins.str] = None,
    ...
    :param builtins.str scheduled_action_name: The name of the ScheduledAction
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['scheduledActionName'] = scheduled_action_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:computeschedule:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult).value
...
def get_scheduled_action_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:computeschedule:getScheduledAction', __args__, opts=opts, typ=GetScheduledActionResult)
