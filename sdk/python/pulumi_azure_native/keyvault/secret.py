...
class Secret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['SecretPropertiesArgs', 'SecretPropertiesArgsDict']]] = None,
