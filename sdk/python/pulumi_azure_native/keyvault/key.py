...
class KeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group which contains the specified key vault.
        :param pulumi.Input[builtins.str] vault_name: The name of the key vault which contains the key to be created.
        :param pulumi.Input[builtins.str] key_name: The name of the key to be created. The value you provide may be copied globally for the purpose of running the service. The value provided should not include personally identifiable or sensitive information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags that will be assigned to the key.
        """
...
class Key(pulumi.CustomResource):
    ...
    def curve_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def key_ops(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
    ...
    def key_uri(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def key_uri_with_version(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def kty(self) -> pulumi.Output[Optional[builtins.str]]:
        """
