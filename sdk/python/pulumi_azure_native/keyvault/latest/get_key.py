...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:keyvault:getKey'.""", DeprecationWarning)
...
def get_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/latest:getKey', __args__, opts=opts, typ=GetKeyResult).value
