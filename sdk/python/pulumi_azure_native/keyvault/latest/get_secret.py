...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:keyvault:getSecret'.""", DeprecationWarning)
...
def get_secret(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/latest:getSecret', __args__, opts=opts, typ=GetSecretResult).value
