...
class MHSMPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        MHSMPrivateEndpointConnectionArgs._configure(
...
class MHSMPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MHSMPrivateEndpointConnectionArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if private_link_service_connection_state is not None and not isinstance(private_link_service_connection_state, MHSMPrivateLinkServiceConnectionStateArgs):
                ...
                MHSMPrivateLinkServiceConnectionStateArgs._configure(_setter, **private_link_service_connection_state)
        ...
        super(MHSMPrivateEndpointConnection, __self__).__init__(
            'azure-native:keyvault/v20230701:MHSMPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
