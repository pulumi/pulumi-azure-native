...
def get_vault(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_group_name: The name of the Resource Group to which the vault belongs.
    :param builtins.str vault_name: The name of the vault.
    """
    __args__ = dict()
...
def get_vault_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:keyvault:getVault', __args__, opts=opts, typ=GetVaultResult)
