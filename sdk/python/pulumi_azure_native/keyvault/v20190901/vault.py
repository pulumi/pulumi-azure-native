...
class Vault(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vault = azure_native.keyvault.v20190901.Vault("vault",
            location="westus",
            properties=azure_native.keyvault.v20190901.VaultPropertiesResponseArgs(
                access_policies=[{
                    "objectId": "00000000-0000-0000-0000-000000000000",
                    "permissions": azure_native.keyvault.v20190901.PermissionsArgs(
                        certificates=[
                            "get",
                            "list",
                            "delete",
                ...
                sku=azure_native.keyvault.v20190901.SkuArgs(
                    family="A",
                    name=azure_native.keyvault/v20190901.SkuName.STANDARD,
                ),
        ...
        vault = azure_native.keyvault.v20190901.Vault("vault",
            ...
            properties=azure_native.keyvault.v20190901.VaultPropertiesResponseArgs(
                ...
                network_acls={
                    ...
                    "defaultAction": "Deny",
                    "ipRules": [
                        azure_native.keyvault.v20190901.IPRuleArgs(
                            value="124.56.78.91",
                        ),
                        azure_native.keyvault.v20190901.IPRuleArgs(
                            value="'10.91.4.0/24'",
                    ...
                    "virtualNetworkRules": [azure_native.keyvault.v20190901.VirtualNetworkRuleArgs(
        ...
        ```sh
        $ pulumi import azure-native:keyvault/v20190901:Vault sample-vault /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sample-resource-group/providers/Microsoft.KeyVault/vaults/sample-vault 
        ```
