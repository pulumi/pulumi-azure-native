...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:keyvault:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:keyvault/v20210601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:keyvault/v20230201:PrivateEndpointConnection")])
