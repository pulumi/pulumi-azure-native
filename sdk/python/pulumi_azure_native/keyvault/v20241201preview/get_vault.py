...
def get_vault(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20241201preview:getVault', __args__, opts=opts, typ=GetVaultResult).value
...
def get_vault_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:keyvault/v20241201preview:getVault', __args__, opts=opts, typ=GetVaultResult)
