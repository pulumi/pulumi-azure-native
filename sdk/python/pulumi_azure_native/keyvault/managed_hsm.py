...
class ManagedHsmArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group that contains the managed HSM pool.
        :param pulumi.Input['ManagedServiceIdentityArgs'] identity: Managed service identity (system assigned and/or user assigned identities)
        :param pulumi.Input[builtins.str] location: The supported Azure location where the managed HSM Pool should be created.
        :param pulumi.Input[builtins.str] name: Name of the managed HSM Pool
...
class ManagedHsm(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:keyvault:ManagedHsm"
