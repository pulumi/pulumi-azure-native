...
class ManagedHsm(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        managed_hsm = azure_native.keyvault.v20230201.ManagedHsm("managedHsm",
            location="westus",
            name="hsm1",
            properties=azure_native.keyvault.v20230201.ManagedHsmPropertiesArgs(
            ...
            sku=azure_native.keyvault.v20230201.ManagedHsmSkuResponseArgs(
                family="B",
