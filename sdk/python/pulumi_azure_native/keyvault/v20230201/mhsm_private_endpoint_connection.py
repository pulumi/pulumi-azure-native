...
class MHSMPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mhsm_private_endpoint_connection = azure_native.keyvault.v20230201.MHSMPrivateEndpointConnection("mhsmPrivateEndpointConnection",
            name="sample-mhsm",
            private_endpoint_connection_name="sample-pec",
            private_link_service_connection_state=azure_native.keyvault.v20230201.MHSMPrivateLinkServiceConnectionStateArgs(
