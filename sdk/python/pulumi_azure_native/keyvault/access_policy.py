...
class AccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group that contains the vault.
        :param pulumi.Input[builtins.str] vault_name: Name of the Key Vault.
        """
...
class AccessPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vaultName")
    def vault_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Key Vault.
        """
        return pulumi.get(self, "vault_name")
