...
class MHSMPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:keyvault:MHSMPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:keyvault/v20210401preview:MHSMPrivateEndpointConnection")])
