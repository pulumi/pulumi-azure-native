...
warnings.warn("""azure-native:keyvault/v20210601preview:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_managed_hsm(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_hsm is deprecated: azure-native:keyvault/v20210601preview:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20210601preview:getManagedHsm', __args__, opts=opts, typ=GetManagedHsmResult).value
