...
def get_vault(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vault is deprecated: Version v20180214preview will be removed in the next major version of the provider. Upgrade to version v20190901 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20180214preview:getVault', __args__, opts=opts, typ=GetVaultResult).value
