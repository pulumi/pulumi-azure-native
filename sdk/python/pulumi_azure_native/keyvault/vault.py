...
class VaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group to which the server belongs.
        :param pulumi.Input[builtins.str] location: The supported Azure location where the key vault should be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags that will be assigned to the key vault.
