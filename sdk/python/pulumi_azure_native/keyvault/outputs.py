...
class AccessPolicyEntry(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str application_id:  Application ID of the client making request on behalf of a principal
        """
...
class KeyAttributesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expires: Optional[_builtins.float] = None,
                 exportable: Optional[_builtins.bool] = None,
        ...
        :param _builtins.bool enabled: Determines whether or not the object is enabled.
        :param _builtins.float expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param _builtins.bool exportable: Indicates if the private key can be exported.
        :param _builtins.float not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
...
class KeyReleasePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str content_type: Content type and version of key release policy
        :param _builtins.str data: Blob encoding the policy rules under which the key can be released.
        """
...
class KeyRotationPolicyAttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float created: Creation time in seconds since 1970-01-01T00:00:00Z.
        :param _builtins.float updated: Last updated time in seconds since 1970-01-01T00:00:00Z.
        :param _builtins.str expiry_time: The expiration time for the new key version. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.
        """
        pulumi.set(__self__, "created", created)
        pulumi.set(__self__, "updated", updated)
...
class ManagedHsmPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_purge_protection: Optional[_builtins.bool] = None,
                 enable_soft_delete: Optional[_builtins.bool] = None,
                 initial_admin_object_ids: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.str scheduled_purge_date: The scheduled purge date in UTC.
        :param 'ManagedHSMSecurityDomainPropertiesResponse' security_domain_properties: Managed HSM security domain properties.
        :param _builtins.str status_message: Resource Status Message.
        :param _builtins.bool enable_purge_protection: Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. Enabling this functionality is irreversible.
        :param _builtins.bool enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this managed HSM pool. Soft delete is enabled by default for all managed HSMs and is immutable.
        :param Sequence[_builtins.str] initial_admin_object_ids: Array of initial administrators object ids for this managed hsm pool.
        ...
        :param _builtins.str public_network_access: Control permission to the managed HSM from public networks.
        :param Sequence['MHSMGeoReplicatedRegionResponse'] regions: List of all regions associated with the managed hsm pool.
        :param _builtins.int soft_delete_retention_in_days: Soft deleted data retention days. When you delete an HSM or a key, it will remain recoverable for the configured retention period or for a default period of 90 days. It accepts values between 7 and 90.
        :param _builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the managed HSM pool.
        """
...
class Permissions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[Union[_builtins.str, 'StoragePermissions']] storage: Permissions to storage accounts
        """
...
class PermissionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] storage: Permissions to storage accounts
        """
        if certificates is not None:
            pulumi.set(__self__, "certificates", certificates)
        if keys is not None:
...
class SecretAttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param _builtins.int not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
        pulumi.set(__self__, "created", created)
        pulumi.set(__self__, "updated", updated)
        if enabled is not None:
...
class SecretPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str content_type: The content type of the secret.
        :param _builtins.str value: The value of the secret. NOTE: 'value' will never be returned from the service, as APIs using this model are is intended for internal use in ARM deployments. Users should use the data-plane REST service for interaction with vault secrets.
        """
...
class SystemDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_modified_at: The timestamp of the key vault resource last modification (UTC).
        :param _builtins.str last_modified_by: The identity that last modified the key vault resource.
        :param _builtins.str last_modified_by_type: The type of identity that last modified the key vault resource.
        """
...
class TriggerResponse(dict):
    ...
    def __init__(__self__, *,
                 time_after_create: Optional[_builtins.str] = None,
                 time_before_expiry: Optional[_builtins.str] = None):
        """
        :param _builtins.str time_after_create: The time duration after key creation to rotate the key. It only applies to rotate. It will be in ISO 8601 duration format. Eg: 'P90D', 'P1Y'.
        :param _builtins.str time_before_expiry: The time duration before key expiring to rotate or notify. It will be in ISO 8601 duration format. Eg: 'P90D', 'P1Y'.
        """
...
class VaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_purge_protection: Optional[_builtins.bool] = None,
                 enable_rbac_authorization: Optional[_builtins.bool] = None,
                 enable_soft_delete: Optional[_builtins.bool] = None,
                 enabled_for_deployment: Optional[_builtins.bool] = None,
                 enabled_for_disk_encryption: Optional[_builtins.bool] = None,
                 enabled_for_template_deployment: Optional[_builtins.bool] = None,
        ...
        :param _builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
        :param _builtins.str vault_uri: The URI of the vault for performing operations on keys and secrets.
        ...
        :param _builtins.bool enable_rbac_authorization: Property that controls how data actions are authorized. When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be  ignored. When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored. If null or not specified, the vault is created with the default value of false. Note that management actions are always authorized with RBAC.
        :param _builtins.bool enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this key vault. If it's not set to any value(true or false) when creating new key vault, it will be set to true by default. Once set to true, it cannot be reverted to false.
        :param _builtins.bool enabled_for_deployment: Property to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault.
        :param _builtins.bool enabled_for_disk_encryption: Property to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys.
        :param _builtins.bool enabled_for_template_deployment: Property to specify whether Azure Resource Manager is permitted to retrieve secrets from the key vault.
        ...
        :param _builtins.str public_network_access: Property to specify whether the vault will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked. This will override the set firewall rules, meaning that even if the firewall rules are present we will not honor the rules.
        :param _builtins.int soft_delete_retention_in_days: softDelete data retention days. It accepts >=7 and <=90.
        """
