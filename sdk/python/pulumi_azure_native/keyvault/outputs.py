...
class AccessPolicyEntry(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
        :param builtins.str application_id:  Application ID of the client making request on behalf of a principal
        """
...
class ActionResponse(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of action.
        """
        if type is not None:
...
class KeyAttributesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 recovery_level: builtins.str,
                 updated: builtins.float,
                 enabled: Optional[builtins.bool] = None,
                 expires: Optional[builtins.float] = None,
                 exportable: Optional[builtins.bool] = None,
                 not_before: Optional[builtins.float] = None):
        """
        The object attributes managed by the Azure Key Vault service.
        :param builtins.float created: Creation time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.str recovery_level: The deletion recovery level currently in effect for the object. If it contains 'Purgeable', then the object can be permanently deleted by a privileged user; otherwise, only the system can purge the object at the end of the retention interval.
        :param builtins.float updated: Last updated time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.bool enabled: Determines whether or not the object is enabled.
        :param builtins.float expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param builtins.bool exportable: Indicates if the private key can be exported.
        :param builtins.float not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
    ...
    @property
    @pulumi.getter
    def created(self) -> builtins.float:
        """
    ...
    @property
    @pulumi.getter
    def updated(self) -> builtins.float:
        """
    ...
    @property
    @pulumi.getter
    def expires(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def exportable(self) -> Optional[builtins.bool]:
        """
    ...
    def not_before(self) -> Optional[builtins.float]:
        """
...
class KeyReleasePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content_type: Content type and version of key release policy
        :param builtins.str data: Blob encoding the policy rules under which the key can be released.
        """
...
class KeyRotationPolicyAttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float created: Creation time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.float updated: Last updated time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.str expiry_time: The expiration time for the new key version. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'.
        """
        pulumi.set(__self__, "created", created)
        pulumi.set(__self__, "updated", updated)
...
class MHSMGeoReplicatedRegionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A region that this managed HSM Pool has been extended to.
        :param builtins.str provisioning_state: Provisioning state of the geo replicated region.
        :param builtins.bool is_primary: A boolean value that indicates whether the region is the primary region or a secondary region.
        :param builtins.str name: Name of the geo replicated region.
        """
...
class MHSMNetworkRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A set of rules governing the network accessibility of a managed hsm pool.
        :param builtins.str bypass: Tells what traffic can bypass network rules. This can be 'AzureServices' or 'None'.  If not specified the default is 'AzureServices'.
...
class MHSMPrivateEndpointConnectionItemResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: Id of private endpoint connection.
...
class MHSMPrivateEndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Private endpoint object properties.
        :param builtins.str id: Full identifier of the private endpoint resource.
        """
        pulumi.set(__self__, "id", id)
...
class MHSMPrivateLinkServiceConnectionStateResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: The reason for approval or rejection.
        :param builtins.str status: Indicates whether the connection has been approved, rejected or removed by the key vault owner.
        """
...
class ManagedHSMSecurityDomainPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 activation_status_message: builtins.str):
        """
        The security domain properties of the managed hsm.
        :param builtins.str activation_status: Activation Status
        :param builtins.str activation_status_message: Activation Status Message.
        """
    ...
    def activation_status_message(self) -> builtins.str:
        """
...
class ManagedHsmPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_purge_protection: Optional[builtins.bool] = None,
                 enable_soft_delete: Optional[builtins.bool] = None,
                 initial_admin_object_ids: Optional[Sequence[builtins.str]] = None,
                 ...
                 soft_delete_retention_in_days: Optional[builtins.int] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        Properties of the managed HSM Pool
        :param builtins.str hsm_uri: The URI of the managed hsm pool for performing operations on keys.
        ...
        :param builtins.str scheduled_purge_date: The scheduled purge date in UTC.
        :param 'ManagedHSMSecurityDomainPropertiesResponse' security_domain_properties: Managed HSM security domain properties.
        :param builtins.str status_message: Resource Status Message.
        :param builtins.bool enable_purge_protection: Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. Enabling this functionality is irreversible.
        :param builtins.bool enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this managed HSM pool. Soft delete is enabled by default for all managed HSMs and is immutable.
        :param Sequence[builtins.str] initial_admin_object_ids: Array of initial administrators object ids for this managed hsm pool.
        ...
        :param builtins.str public_network_access: Control permission to the managed HSM from public networks.
        :param Sequence['MHSMGeoReplicatedRegionResponse'] regions: List of all regions associated with the managed hsm pool.
        :param builtins.int soft_delete_retention_in_days: Soft deleted data retention days. When you delete an HSM or a key, it will remain recoverable for the configured retention period or for a default period of 90 days. It accepts values between 7 and 90.
        :param builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the managed HSM pool.
        """
    ...
    def enable_soft_delete(self) -> Optional[builtins.bool]:
        """
    ...
    def initial_admin_object_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ManagedHsmSkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SKU details
        :param builtins.str family: SKU Family of the managed HSM Pool
        :param builtins.str name: SKU of the managed HSM Pool
        """
...
class Permissions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage: Optional[Sequence[builtins.str]] = None):
        """
        Permissions the identity has for keys, secrets, certificates and storage.
        :param Sequence[Union[builtins.str, 'CertificatePermissions']] certificates: Permissions to certificates
        :param Sequence[Union[builtins.str, 'KeyPermissions']] keys: Permissions to keys
        :param Sequence[Union[builtins.str, 'SecretPermissions']] secrets: Permissions to secrets
        :param Sequence[Union[builtins.str, 'StoragePermissions']] storage: Permissions to storage accounts
        """
    ...
    @property
    @pulumi.getter
    def storage(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PermissionsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Permissions the identity has for keys, secrets, certificates and storage.
        :param Sequence[builtins.str] certificates: Permissions to certificates
        :param Sequence[builtins.str] keys: Permissions to keys
        :param Sequence[builtins.str] secrets: Permissions to secrets
        :param Sequence[builtins.str] storage: Permissions to storage accounts
        """
        if certificates is not None:
            pulumi.set(__self__, "certificates", certificates)
        if keys is not None:
...
class SecretAttributesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The secret management attributes.
        :param builtins.int created: Creation time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.int updated: Last updated time in seconds since 1970-01-01T00:00:00Z.
        :param builtins.bool enabled: Determines whether the object is enabled.
        :param builtins.int expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param builtins.int not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
        pulumi.set(__self__, "created", created)
        pulumi.set(__self__, "updated", updated)
        if enabled is not None:
...
class SecretPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_uri_with_version: builtins.str,
                 attributes: Optional['outputs.SecretAttributesResponse'] = None,
                 content_type: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        Properties of the secret
        :param builtins.str secret_uri: The URI to retrieve the current version of the secret.
        :param builtins.str secret_uri_with_version: The URI to retrieve the specific version of the secret.
        :param 'SecretAttributesResponse' attributes: The attributes of the secret.
        :param builtins.str content_type: The content type of the secret.
        :param builtins.str value: The value of the secret. NOTE: 'value' will never be returned from the service, as APIs using this model are is intended for internal use in ARM deployments. Users should use the data-plane REST service for interaction with vault secrets.
        """
    ...
    def secret_uri_with_version(self) -> builtins.str:
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SKU details
        :param builtins.str family: SKU family name
        :param builtins.str name: SKU name to specify whether the key vault is a standard vault or a premium vault.
        """
        pulumi.set(__self__, "family", family)
        pulumi.set(__self__, "name", name)
...
class SystemDataResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Metadata pertaining to creation and last modification of the key vault resource.
        :param builtins.str created_at: The timestamp of the key vault resource creation (UTC).
        :param builtins.str created_by: The identity that created the key vault resource.
        :param builtins.str created_by_type: The type of identity that created the key vault resource.
        :param builtins.str last_modified_at: The timestamp of the key vault resource last modification (UTC).
        :param builtins.str last_modified_by: The identity that last modified the key vault resource.
        :param builtins.str last_modified_by_type: The type of identity that last modified the key vault resource.
        """
...
class TriggerResponse(dict):
    ...
    def __init__(__self__, *,
                 time_after_create: Optional[builtins.str] = None,
                 time_before_expiry: Optional[builtins.str] = None):
        """
        :param builtins.str time_after_create: The time duration after key creation to rotate the key. It only applies to rotate. It will be in ISO 8601 duration format. Eg: 'P90D', 'P1Y'.
        :param builtins.str time_before_expiry: The time duration before key expiring to rotate or notify. It will be in ISO 8601 duration format. Eg: 'P90D', 'P1Y'.
        """
    ...
    def time_after_create(self) -> Optional[builtins.str]:
        """
...
class VaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 hsm_pool_resource_id: builtins.str,
                 ...
                 enable_purge_protection: Optional[builtins.bool] = None,
                 enable_rbac_authorization: Optional[builtins.bool] = None,
                 enable_soft_delete: Optional[builtins.bool] = None,
                 enabled_for_deployment: Optional[builtins.bool] = None,
                 enabled_for_disk_encryption: Optional[builtins.bool] = None,
                 enabled_for_template_deployment: Optional[builtins.bool] = None,
                 network_acls: Optional['outputs.NetworkRuleSetResponse'] = None,
                 public_network_access: Optional[builtins.str] = None,
                 soft_delete_retention_in_days: Optional[builtins.int] = None):
        """
        Properties of the vault
        :param builtins.str hsm_pool_resource_id: The resource id of HSM Pool.
        ...
        :param builtins.str provisioning_state: Provisioning state of the vault.
        :param 'SkuResponse' sku: SKU details
        :param builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
        :param builtins.str vault_uri: The URI of the vault for performing operations on keys and secrets.
        ...
        :param builtins.bool enable_rbac_authorization: Property that controls how data actions are authorized. When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be  ignored. When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored. If null or not specified, the vault is created with the default value of false. Note that management actions are always authorized with RBAC.
        :param builtins.bool enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this key vault. If it's not set to any value(true or false) when creating new key vault, it will be set to true by default. Once set to true, it cannot be reverted to false.
        :param builtins.bool enabled_for_deployment: Property to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault.
        :param builtins.bool enabled_for_disk_encryption: Property to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys.
        :param builtins.bool enabled_for_template_deployment: Property to specify whether Azure Resource Manager is permitted to retrieve secrets from the key vault.
        ...
        :param builtins.str public_network_access: Property to specify whether the vault will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked. This will override the set firewall rules, meaning that even if the firewall rules are present we will not honor the rules.
        :param builtins.int soft_delete_retention_in_days: softDelete data retention days. It accepts >=7 and <=90.
        """
    ...
    def hsm_pool_resource_id(self) -> builtins.str:
        """
    ...
    def enable_rbac_authorization(self) -> Optional[builtins.bool]:
        """
    ...
    def enabled_for_deployment(self) -> Optional[builtins.bool]:
        """
    ...
    def enabled_for_disk_encryption(self) -> Optional[builtins.bool]:
        """
    ...
    def enabled_for_template_deployment(self) -> Optional[builtins.bool]:
        """
...
class VirtualNetworkRuleResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        A rule governing the accessibility of a vault from a specific virtual network.
        :param builtins.str id: Full resource id of a vnet subnet, such as '/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet/subnets/subnet1'.
        :param builtins.bool ignore_missing_vnet_service_endpoint: Property to specify whether NRP will ignore the check if parent subnet has serviceEndpoints configured.
        """
        pulumi.set(__self__, "id", id)
