...
warnings.warn("""azure-native:keyvault/v20220701:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_managed_hsm(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_hsm is deprecated: azure-native:keyvault/v20220701:ManagedHsm is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
