...
warnings.warn("""azure-native:keyvault/v20220701:Secret is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.""", DeprecationWarning)
...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vault_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Secret is deprecated: azure-native:keyvault/v20220701:Secret is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Secret to guarantee forwards compatibility.""")
