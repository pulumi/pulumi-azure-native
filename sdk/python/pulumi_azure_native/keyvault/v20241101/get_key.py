...
def get_key(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20241101:getKey', __args__, opts=opts, typ=GetKeyResult).value
...
def get_key_output(key_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:keyvault/v20241101:getKey', __args__, opts=opts, typ=GetKeyResult)
