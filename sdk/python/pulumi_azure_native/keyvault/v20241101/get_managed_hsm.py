...
def get_managed_hsm(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20241101:getManagedHsm', __args__, opts=opts, typ=GetManagedHsmResult).value
...
def get_managed_hsm_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:keyvault/v20241101:getManagedHsm', __args__, opts=opts, typ=GetManagedHsmResult)
