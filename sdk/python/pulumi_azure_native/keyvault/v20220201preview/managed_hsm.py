...
warnings.warn("""azure-native:keyvault/v20220201preview:ManagedHsm is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""", DeprecationWarning)
...
class ManagedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ManagedHsm is deprecated: azure-native:keyvault/v20220201preview:ManagedHsm is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""")
