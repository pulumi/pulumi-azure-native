...
class Key(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:keyvault:Key"), pulumi.Alias(type_="azure-native:keyvault/v20190901:Key"), pulumi.Alias(type_="azure-native:keyvault/v20200401preview:Key"), pulumi.Alias(type_="azure-native:keyvault/v20210401preview:Key"), pulumi.Alias(type_="azure-native:keyvault/v20210601preview:Key"), pulumi.Alias(type_="azure-native:keyvault/v20211001:Key"), pulumi.Alias(type_="azure-native:keyvault/v20220201preview:Key"), pulumi.Alias(type_="azure-native:keyvault/v20220701:Key"), pulumi.Alias(type_="azure-native:keyvault/v20221101:Key"), pulumi.Alias(type_="azure-native:keyvault/v20230201:Key")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Key, __self__).__init__(
            'azure-native:keyvault/v20211101preview:Key',
            resource_name,
            __props__,
            opts)
