...
warnings.warn("""azure-native:keyvault/v20210401preview:MHSMPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:MHSMPrivateEndpointConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_mhsm_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mhsm_private_endpoint_connection is deprecated: azure-native:keyvault/v20210401preview:MHSMPrivateEndpointConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:keyvault/v20230201:MHSMPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['privateEndpointConnectionName'] = private_endpoint_connection_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/v20210401preview:getMHSMPrivateEndpointConnection', __args__, opts=opts, typ=GetMHSMPrivateEndpointConnectionResult).value
