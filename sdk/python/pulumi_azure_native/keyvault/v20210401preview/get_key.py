...
def get_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_key is deprecated: azure-native:keyvault/v20210401preview:Key is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:Key to guarantee forwards compatibility.""")
    __args__ = dict()
