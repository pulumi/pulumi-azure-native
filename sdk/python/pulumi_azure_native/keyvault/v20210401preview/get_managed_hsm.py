...
def get_managed_hsm(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_hsm is deprecated: azure-native:keyvault/v20210401preview:ManagedHsm is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:ManagedHsm to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
