...
class MHSMPrivateEndpointConnectionArgs:
    ...
    def private_link_service_connection_state(self) -> pulumi.Input[Optional['MHSMPrivateLinkServiceConnectionStateArgs']]:
        """
    ...
    def private_link_service_connection_state(self, value: pulumi.Input[Optional['MHSMPrivateLinkServiceConnectionStateArgs']]):
...
class MHSMPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 private_endpoint_connection_name: pulumi.Input[Optional[_builtins.str]] = None,
                 private_link_service_connection_state: pulumi.Input[Optional[Union['MHSMPrivateLinkServiceConnectionStateArgs', 'MHSMPrivateLinkServiceConnectionStateArgsDict']]] = None,
