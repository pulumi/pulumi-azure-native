...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group that contains the key vault.
        :param pulumi.Input[builtins.str] vault_name: The name of the key vault.
        :param pulumi.Input[builtins.str] private_endpoint_connection_name: Name of the private endpoint connection associated with the key vault.
...
@pulumi.type_token("azure-native:keyvault:PrivateEndpointConnection")
