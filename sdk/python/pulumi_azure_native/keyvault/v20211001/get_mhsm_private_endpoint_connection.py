...
def get_mhsm_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_mhsm_private_endpoint_connection is deprecated: azure-native:keyvault/v20211001:MHSMPrivateEndpointConnection is being removed in the next major version of this provider. Please upgrade to azure-native:keyvault/v20230201:MHSMPrivateEndpointConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
