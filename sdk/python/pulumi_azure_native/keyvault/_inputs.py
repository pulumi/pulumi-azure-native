...
class AccessPolicyEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] application_id:  Application ID of the client making request on behalf of a principal
        """
...
class KeyAttributesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Determines whether or not the object is enabled.
        :param pulumi.Input[_builtins.float] expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param pulumi.Input[_builtins.bool] exportable: Indicates if the private key can be exported.
        :param pulumi.Input[_builtins.float] not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
...
class KeyPropertiesArgsDict(TypedDict):
    ...
    """
    attributes: NotRequired[pulumi.Input[Optional['KeyAttributesArgs']]]
    """
    ...
    """
    release_policy: NotRequired[pulumi.Input[Optional['KeyReleasePolicyArgs']]]
    """
    Key release policy in response. It will be used for both output and input. Omitted if empty
    """
    rotation_policy: NotRequired[pulumi.Input[Optional['RotationPolicyArgs']]]
    """
...
class KeyPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'JsonWebKeyCurveName']] curve_name: The elliptic curve name. For valid values, see JsonWebKeyCurveName. Default for EC and EC-HSM keys is P-256
        :param pulumi.Input[_builtins.int] key_size: The key size in bits. For example: 2048, 3072, or 4096 for RSA. Default for RSA and RSA-HSM keys is 2048. Exception made for bring your own key (BYOK), key exchange keys default to 4096.
        :param pulumi.Input[Union[_builtins.str, 'JsonWebKeyType']] kty: The type of the key. For valid values, see JsonWebKeyType.
...
class LifetimeActionArgsDict(TypedDict):
    action: NotRequired[pulumi.Input[Optional['ActionArgs']]]
    """
    The action of key rotation policy lifetimeAction.
    """
    trigger: NotRequired[pulumi.Input[Optional['TriggerArgs']]]
    """
...
class MHSMGeoReplicatedRegionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_primary: A boolean value that indicates whether the region is the primary region or a secondary region.
        :param pulumi.Input[_builtins.str] name: Name of the geo replicated region.
        """
...
class MHSMNetworkRuleSetArgsDict(TypedDict):
    ...
    """
    ip_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MHSMIPRuleArgs']]]]]
    """
    The list of IP address rules.
    """
    virtual_network_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MHSMVirtualNetworkRuleArgs']]]]]
    """
...
class MHSMNetworkRuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'NetworkRuleBypassOptions']] bypass: Tells what traffic can bypass network rules. This can be 'AzureServices' or 'None'.  If not specified the default is 'AzureServices'.
...
class MHSMPrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The reason for approval or rejection.
        :param pulumi.Input[Union[_builtins.str, 'PrivateEndpointServiceConnectionStatus']] status: Indicates whether the connection has been approved, rejected or removed by the key vault owner.
        """
...
class ManagedHsmPropertiesArgsDict(TypedDict):
    ...
    """
    network_acls: NotRequired[pulumi.Input[Optional['MHSMNetworkRuleSetArgs']]]
    """
    ...
    """
    regions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['MHSMGeoReplicatedRegionArgs']]]]]
    """
...
class ManagedHsmPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_purge_protection: Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. Enabling this functionality is irreversible.
        :param pulumi.Input[_builtins.bool] enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this managed HSM pool. Soft delete is enabled by default for all managed HSMs and is immutable.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] initial_admin_object_ids: Array of initial administrators object ids for this managed hsm pool.
        ...
        :param pulumi.Input[Union[_builtins.str, 'PublicNetworkAccess']] public_network_access: Control permission to the managed HSM from public networks.
        ...
        :param pulumi.Input[_builtins.int] soft_delete_retention_in_days: Soft deleted data retention days. When you delete an HSM or a key, it will remain recoverable for the configured retention period or for a default period of 90 days. It accepts values between 7 and 90.
        :param pulumi.Input[_builtins.str] tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the managed HSM pool.
        """
...
class ManagedHsmSkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ManagedHsmSkuFamily']] family: SKU Family of the managed HSM Pool
    ...
    @family.setter
    def family(self, value: pulumi.Input[Union[_builtins.str, 'ManagedHsmSkuFamily']]):
...
class PermissionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'CertificatePermissions']]]] certificates: Permissions to certificates
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'KeyPermissions']]]] keys: Permissions to keys
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'SecretPermissions']]]] secrets: Permissions to secrets
        :param pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, 'StoragePermissions']]]] storage: Permissions to storage accounts
        """
...
class RotationPolicyArgsDict(TypedDict):
    attributes: NotRequired[pulumi.Input[Optional['KeyRotationPolicyAttributesArgs']]]
    """
    The attributes of key rotation policy.
    """
    lifetime_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LifetimeActionArgs']]]]]
    """
...
class SecretAttributesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Determines whether the object is enabled.
        :param pulumi.Input[_builtins.int] expires: Expiry date in seconds since 1970-01-01T00:00:00Z.
        :param pulumi.Input[_builtins.int] not_before: Not before date in seconds since 1970-01-01T00:00:00Z.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if expires is not None:
...
class SecretPropertiesArgsDict(TypedDict):
    ...
    """
    attributes: NotRequired[pulumi.Input[Optional['SecretAttributesArgs']]]
    """
...
class SecretPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_type: The content type of the secret.
        :param pulumi.Input[_builtins.str] value: The value of the secret. NOTE: 'value' will never be returned from the service, as APIs using this model are is intended for internal use in ARM deployments. Users should use the data-plane REST service for interaction with vault secrets.
        """
        if attributes is not None:
            pulumi.set(__self__, "attributes", attributes)
        if content_type is not None:
...
class SkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'SkuFamily']] family: SKU family name
...
class VaultPropertiesArgsDict(TypedDict):
    ...
    The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
    """
    access_policies: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['AccessPolicyEntryArgs']]]]]
    """
...
class VaultPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_purge_protection: Property specifying whether protection against purge is enabled for this vault. Setting this property to true activates protection against purge for this vault and its content - only the Key Vault service may initiate a hard, irrecoverable deletion. The setting is effective only if soft delete is also enabled. Enabling this functionality is irreversible - that is, the property does not accept false as its value.
        :param pulumi.Input[_builtins.bool] enable_rbac_authorization: Property that controls how data actions are authorized. When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be  ignored. When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored. If null or not specified, the vault is created with the default value of false. Note that management actions are always authorized with RBAC.
        :param pulumi.Input[_builtins.bool] enable_soft_delete: Property to specify whether the 'soft delete' functionality is enabled for this key vault. If it's not set to any value(true or false) when creating new key vault, it will be set to true by default. Once set to true, it cannot be reverted to false.
        :param pulumi.Input[_builtins.bool] enabled_for_deployment: Property to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault.
        :param pulumi.Input[_builtins.bool] enabled_for_disk_encryption: Property to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys.
        :param pulumi.Input[_builtins.bool] enabled_for_template_deployment: Property to specify whether Azure Resource Manager is permitted to retrieve secrets from the key vault.
        ...
        :param pulumi.Input[_builtins.str] public_network_access: Property to specify whether the vault will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked. This will override the set firewall rules, meaning that even if the firewall rules are present we will not honor the rules.
        :param pulumi.Input[_builtins.int] soft_delete_retention_in_days: softDelete data retention days. It accepts >=7 and <=90.
        """
...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: Full resource id of a vnet subnet, such as '/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet/subnets/subnet1'.
        :param pulumi.Input[_builtins.bool] ignore_missing_vnet_service_endpoint: Property to specify whether NRP will ignore the check if parent subnet has serviceEndpoints configured.
        """
        pulumi.set(__self__, "id", id)
