...
class GetKeyResult:
    ...
    def curve_name(self) -> Optional[builtins.str]:
        """
    ...
    def key_ops(self) -> Optional[Sequence[builtins.str]]:
    ...
    def key_uri_with_version(self) -> builtins.str:
        """
...
def get_key(key_name: Optional[builtins.str] = None,
    ...
    :param builtins.str key_name: The name of the key to be retrieved.
    :param builtins.str resource_group_name: The name of the resource group which contains the specified key vault.
    :param builtins.str vault_name: The name of the vault which contains the key to be retrieved.
    """
    __args__ = dict()
