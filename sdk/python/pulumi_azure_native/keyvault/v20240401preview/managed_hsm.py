...
class ManagedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:keyvault/v20200401preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20210401preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20210601preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20211001:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20211101preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20220201preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20220701:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20221101:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20230201:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20230701:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20241101:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault/v20241201preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault:ManagedHsm")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagedHsm, __self__).__init__(
            'azure-native:keyvault/v20240401preview:ManagedHsm',
            resource_name,
            __props__,
            opts)
