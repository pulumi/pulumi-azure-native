...
class StandbyVirtualMachinePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:standbypool/v20231201preview:StandbyVirtualMachinePool"), pulumi.Alias(type_="azure-native:standbypool/v20240301:StandbyVirtualMachinePool"), pulumi.Alias(type_="azure-native:standbypool/v20240301preview:StandbyVirtualMachinePool"), pulumi.Alias(type_="azure-native:standbypool:StandbyVirtualMachinePool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StandbyVirtualMachinePool, __self__).__init__(
            'azure-native:standbypool/v20250301:StandbyVirtualMachinePool',
            resource_name,
            __props__,
            opts)
