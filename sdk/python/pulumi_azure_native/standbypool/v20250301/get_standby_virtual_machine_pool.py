...
def get_standby_virtual_machine_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:standbypool/v20250301:getStandbyVirtualMachinePool', __args__, opts=opts, typ=GetStandbyVirtualMachinePoolResult).value
...
def get_standby_virtual_machine_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:standbypool/v20250301:getStandbyVirtualMachinePool', __args__, opts=opts, typ=GetStandbyVirtualMachinePoolResult)
