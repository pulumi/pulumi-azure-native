...
class StandbyContainerGroupPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:standbypool:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20240301preview:StandbyContainerGroupPool")])
