...
def get_standby_container_group_pool(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool', __args__, opts=opts, typ=GetStandbyContainerGroupPoolResult).value
...
def get_standby_container_group_pool_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['standbyContainerGroupPoolName'] = standby_container_group_pool_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:standbypool/v20240301preview:getStandbyContainerGroupPool', __args__, opts=opts, typ=GetStandbyContainerGroupPoolResult)
