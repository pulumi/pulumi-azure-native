...
class StandbyContainerGroupPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 container_group_properties: pulumi.Input[Optional[Union['ContainerGroupPropertiesArgs', 'ContainerGroupPropertiesArgsDict']]] = None,
                 elasticity_profile: pulumi.Input[Optional[Union['StandbyContainerGroupPoolElasticityProfileArgs', 'StandbyContainerGroupPoolElasticityProfileArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:standbypool/v20231201preview:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20240301:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20240301preview:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20250301:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20251001:StandbyContainerGroupPool"), pulumi.Alias(type_="azure-native:standbypool/v20260401:StandbyContainerGroupPool")])
