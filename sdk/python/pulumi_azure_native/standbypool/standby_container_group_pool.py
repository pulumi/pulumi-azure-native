...
class StandbyContainerGroupPoolArgs:
    def __init__(__self__, *,
                 ...
                 standby_container_group_pool_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] standby_container_group_pool_name: Name of the standby container group pool
    ...
    def standby_container_group_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def standby_container_group_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
