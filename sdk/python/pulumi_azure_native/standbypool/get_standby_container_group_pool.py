...
def get_standby_container_group_pool(resource_group_name: Optional[builtins.str] = None,
                                     standby_container_group_pool_name: Optional[builtins.str] = None,
    ...
    :param builtins.str standby_container_group_pool_name: Name of the standby container group pool
    """
    __args__ = dict()
...
def get_standby_container_group_pool_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
