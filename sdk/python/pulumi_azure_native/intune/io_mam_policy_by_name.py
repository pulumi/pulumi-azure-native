...
class IoMAMPolicyByNameArgs:
    def __init__(__self__, *,
                 ...
                 file_encryption_level: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def file_encryption_level(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "file_encryption_level")

    @file_encryption_level.setter
    def file_encryption_level(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def touch_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "touch_id")

    @touch_id.setter
    def touch_id(self, value: pulumi.Input[Optional[_builtins.str]]):
