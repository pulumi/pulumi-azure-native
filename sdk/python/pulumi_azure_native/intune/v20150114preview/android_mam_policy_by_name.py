...
class AndroidMAMPolicyByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:intune:AndroidMAMPolicyByName"), pulumi.Alias(type_="azure-native:intune/v20150114privatepreview:AndroidMAMPolicyByName")])
