...
def get_android_mam_policy_by_name_output(host_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['select'] = select
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:intune/v20150114preview:getAndroidMAMPolicyByName', __args__, opts=opts, typ=GetAndroidMAMPolicyByNameResult)
