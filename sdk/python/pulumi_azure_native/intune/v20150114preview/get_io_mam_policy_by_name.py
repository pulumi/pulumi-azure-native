...
def get_io_mam_policy_by_name_output(host_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['select'] = select
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:intune/v20150114preview:getIoMAMPolicyByName', __args__, opts=opts, typ=GetIoMAMPolicyByNameResult)
    return __ret__.apply(lambda __response__: GetIoMAMPolicyByNameResult(
        ...
        file_encryption_level=pulumi.get(__response__, 'file_encryption_level'),
        ...
        touch_id=pulumi.get(__response__, 'touch_id'),
