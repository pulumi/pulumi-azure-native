...
class AndroidMAMPolicyByNameArgs:
    def __init__(__self__, *,
                 ...
                 file_encryption: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 screen_capture: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def file_encryption(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "file_encryption")

    @file_encryption.setter
    def file_encryption(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def screen_capture(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "screen_capture")

    @screen_capture.setter
    def screen_capture(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AndroidMAMPolicyByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:intune/v20150114preview:AndroidMAMPolicyByName"), pulumi.Alias(type_="azure-native:intune/v20150114privatepreview:AndroidMAMPolicyByName")])
    ...
    @property
    @pulumi.getter(name="fileEncryption")
    def file_encryption(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "file_encryption")
    ...
    @property
    @pulumi.getter(name="screenCapture")
    def screen_capture(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "screen_capture")
