...
class GetIoMAMPolicyByNameResult:
    ...
    def file_encryption_level(self) -> Optional[builtins.str]:
    ...
    def touch_id(self) -> Optional[builtins.str]:
...
def get_io_mam_policy_by_name(host_name: Optional[builtins.str] = None,
...
def get_io_mam_policy_by_name_output(host_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:intune:getIoMAMPolicyByName', __args__, opts=opts, typ=GetIoMAMPolicyByNameResult)
