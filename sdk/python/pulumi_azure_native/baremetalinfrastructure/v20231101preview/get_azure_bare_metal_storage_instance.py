...
def get_azure_bare_metal_storage_instance(azure_bare_metal_storage_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:baremetalinfrastructure/v20231101preview:getAzureBareMetalStorageInstance', __args__, opts=opts, typ=GetAzureBareMetalStorageInstanceResult).value
