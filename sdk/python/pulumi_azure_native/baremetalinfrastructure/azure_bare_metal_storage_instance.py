...
class AzureBareMetalStorageInstanceArgs:
    def __init__(__self__, *,
                 ...
                 azure_bare_metal_storage_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 azure_bare_metal_storage_instance_unique_identifier: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] azure_bare_metal_storage_instance_name: Name of the Azure Bare Metal Storage Instance, also known as the ResourceName.
        :param pulumi.Input[builtins.str] azure_bare_metal_storage_instance_unique_identifier: Specifies the AzureBareMetaStorageInstance unique ID.
    ...
    def azure_bare_metal_storage_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_bare_metal_storage_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def azure_bare_metal_storage_instance_unique_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_bare_metal_storage_instance_unique_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance")
class AzureBareMetalStorageInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="azureBareMetalStorageInstanceUniqueIdentifier")
    def azure_bare_metal_storage_instance_unique_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the AzureBareMetaStorageInstance unique ID.
        """
        return pulumi.get(self, "azure_bare_metal_storage_instance_unique_identifier")
