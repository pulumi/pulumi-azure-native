...
class AzureBareMetalInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:baremetalinfrastructure:AzureBareMetalInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureBareMetalInstance, __self__).__init__(
            'azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalInstance',
            resource_name,
            __props__,
            opts)
