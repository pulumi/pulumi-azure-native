...
class StorageBillingPropertiesArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if azure_bare_metal_storage_instance_size is None and 'azureBareMetalStorageInstanceSize' in kwargs:
...
class StoragePropertiesArgs:
    ...
    def _configure(
        ...
        if storage_billing_properties is None and 'storageBillingProperties' in kwargs:
