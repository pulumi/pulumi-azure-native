...
class HardwareProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_bare_metal_instance_size: Optional[_builtins.str] = None,
...
class StorageBillingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_bare_metal_storage_instance_size: Optional[_builtins.str] = None,
...
class StoragePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str provisioning_state: State of provisioning of the AzureBareMetalStorageInstance
