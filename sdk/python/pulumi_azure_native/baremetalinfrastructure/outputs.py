...
class AzureBareMetalStorageInstanceIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Identity for Azure Bare Metal Storage Instance.
        :param builtins.str principal_id: The principal ID of Azure Bare Metal Storage Instance identity. This property will only be provided for a system assigned identity.
        :param builtins.str tenant_id: The tenant ID associated with the Azure Bare Metal Storage Instance. This property will only be provided for a system assigned identity.
        :param builtins.str type: The type of identity used for the Azure Bare Metal Storage Instance. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Azure Bare Metal Storage Instance.
        """
...
class HardwareProfileResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_bare_metal_instance_size: Optional[builtins.str] = None,
                 hardware_type: Optional[builtins.str] = None):
        """
        Specifies the hardware settings for the Azure Bare Metal Instance.
        :param builtins.str azure_bare_metal_instance_size: Specifies the Azure Bare Metal Instance SKU.
    ...
    def azure_bare_metal_instance_size(self) -> Optional[builtins.str]:
        """
...
class OSProfileResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the operating system settings for the Azure Bare Metal instance.
        :param builtins.str computer_name: Specifies the host OS name of the Azure Bare Metal instance.
...
class StorageBillingPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 azure_bare_metal_storage_instance_size: Optional[builtins.str] = None,
                 billing_mode: Optional[builtins.str] = None):
        """
        Describes the billing related details of the AzureBareMetalStorageInstance.
        :param builtins.str azure_bare_metal_storage_instance_size: the SKU type that is provisioned
    ...
    def azure_bare_metal_storage_instance_size(self) -> Optional[builtins.str]:
        """
...
class StoragePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str provisioning_state: State of provisioning of the AzureBareMetalStorageInstance
