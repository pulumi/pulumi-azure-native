...
def get_azure_bare_metal_instance(azure_bare_metal_instance_name: Optional[_builtins.str] = None,
...
def get_azure_bare_metal_instance_output(azure_bare_metal_instance_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
