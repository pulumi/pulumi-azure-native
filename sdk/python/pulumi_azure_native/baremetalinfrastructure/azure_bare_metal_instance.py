...
class AzureBareMetalInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] partner_node_id: ARM ID of another AzureBareMetalInstance that will share a network with this AzureBareMetalInstance
        :param pulumi.Input[Union[_builtins.str, 'AzureBareMetalInstancePowerStateEnum']] power_state: Resource power state
        :param pulumi.Input[_builtins.str] proximity_placement_group: Resource proximity placement group
