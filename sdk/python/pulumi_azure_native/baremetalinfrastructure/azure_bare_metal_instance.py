...
class AzureBareMetalInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:baremetalinfrastructure/v20240801preview:AzureBareMetalInstance"), pulumi.Alias(type_="azure-native_baremetalinfrastructure_v20240801preview:baremetalinfrastructure:AzureBareMetalInstance")])
