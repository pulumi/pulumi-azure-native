...
class AzureBareMetalStorageInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if storage_properties is not None and not isinstance(storage_properties, StoragePropertiesArgs):
                storage_properties = storage_properties or {}
                def _setter(key, value):
                    storage_properties[key] = value
                StoragePropertiesArgs._configure(_setter, **storage_properties)
