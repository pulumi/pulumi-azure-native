...
class AzureBareMetalStorageInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] azure_bare_metal_storage_instance_name: Name of the AzureBareMetalStorage on Azure instance.
        ...
        """
        AzureBareMetalStorageInstanceArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            resource_group_name=resource_group_name,
            azure_bare_metal_storage_instance_name=azure_bare_metal_storage_instance_name,
            azure_bare_metal_storage_instance_unique_identifier=azure_bare_metal_storage_instance_unique_identifier,
            location=location,
    ...
    def _configure(
        ...
        if azure_bare_metal_storage_instance_name is None and 'azureBareMetalStorageInstanceName' in kwargs:
            azure_bare_metal_storage_instance_name = kwargs['azureBareMetalStorageInstanceName']
        if azure_bare_metal_storage_instance_unique_identifier is None and 'azureBareMetalStorageInstanceUniqueIdentifier' in kwargs:
            azure_bare_metal_storage_instance_unique_identifier = kwargs['azureBareMetalStorageInstanceUniqueIdentifier']
        if storage_properties is None and 'storageProperties' in kwargs:
            storage_properties = kwargs['storageProperties']

        _setter("resource_group_name", resource_group_name)
        if azure_bare_metal_storage_instance_name is not None:
            _setter("azure_bare_metal_storage_instance_name", azure_bare_metal_storage_instance_name)
        if azure_bare_metal_storage_instance_unique_identifier is not None:
            _setter("azure_bare_metal_storage_instance_unique_identifier", azure_bare_metal_storage_instance_unique_identifier)
        if location is not None:
            _setter("location", location)
        if storage_properties is not None:
            _setter("storage_properties", storage_properties)
        if tags is not None:
            _setter("tags", tags)
...
class AzureBareMetalStorageInstance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AzureBareMetalStorageInstanceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            storage_properties = _utilities.configure(storage_properties, StoragePropertiesArgs, True)
