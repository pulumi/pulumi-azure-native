...
class GetDelegatedSubnetServiceDetailsResult:
    ...
    def allocation_block_prefix_size(self) -> Optional[builtins.int]:
        """
...
def get_delegated_subnet_service_details(resource_group_name: Optional[builtins.str] = None,
...
def get_delegated_subnet_service_details_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
