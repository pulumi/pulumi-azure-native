...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getControllerDetails'.""", DeprecationWarning)
...
def get_controller_details(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_controller_details is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getControllerDetails'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:delegatednetwork/latest:getControllerDetails', __args__, opts=opts, typ=GetControllerDetailsResult).value
