...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getDelegatedSubnetServiceDetails'.""", DeprecationWarning)
...
def get_delegated_subnet_service_details(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_delegated_subnet_service_details is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getDelegatedSubnetServiceDetails'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:delegatednetwork/latest:getDelegatedSubnetServiceDetails', __args__, opts=opts, typ=GetDelegatedSubnetServiceDetailsResult).value
