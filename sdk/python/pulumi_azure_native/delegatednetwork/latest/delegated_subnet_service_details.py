...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:DelegatedSubnetServiceDetails'.""", DeprecationWarning)
...
class DelegatedSubnetServiceDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        """
        pulumi.log.warn("""DelegatedSubnetServiceDetails is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:DelegatedSubnetServiceDetails'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:delegatednetwork/latest:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20210315:DelegatedSubnetServiceDetails")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DelegatedSubnetServiceDetails, __self__).__init__(
            'azure-native:delegatednetwork/latest:DelegatedSubnetServiceDetails',
            resource_name,
            __props__,
            opts)
