...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getOrchestratorInstanceServiceDetails'.""", DeprecationWarning)
...
def get_orchestrator_instance_service_details(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_orchestrator_instance_service_details is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:delegatednetwork:getOrchestratorInstanceServiceDetails'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:delegatednetwork/latest:getOrchestratorInstanceServiceDetails', __args__, opts=opts, typ=GetOrchestratorInstanceServiceDetailsResult).value
