...
class ControllerDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        controller details
        :param builtins.str id: controller arm resource id
        """
        if id is not None:
...
class OrchestratorIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str principal_id: The principal id of the system assigned identity which is used by orchestrator.
        :param builtins.str tenant_id: The tenant id of the system assigned identity which is used by orchestrator.
        :param builtins.str type: The type of identity used for orchestrator cluster. Type 'SystemAssigned' will use an implicitly created identity orchestrator clusters
        """
...
class SubnetDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Properties of orchestrator
        :param builtins.str id: subnet arm resource id
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
