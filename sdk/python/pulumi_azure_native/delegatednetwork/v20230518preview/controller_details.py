...
class ControllerDetailsInitArgs:
    def __init__(__self__, *,
        ...
        """
        ControllerDetailsInitArgs._configure(
...
class ControllerDetails(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ControllerDetailsInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20200808preview:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20210315:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20230627preview:ControllerDetails")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ControllerDetails, __self__).__init__(
            'azure-native:delegatednetwork/v20230518preview:ControllerDetails',
            resource_name,
            __props__,
            opts)
