...
def get_controller_details(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:delegatednetwork/v20230518preview:getControllerDetails', __args__, opts=opts, typ=GetControllerDetailsResult).value
...
def get_controller_details_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:delegatednetwork/v20230518preview:getControllerDetails', __args__, opts=opts, typ=GetControllerDetailsResult)
