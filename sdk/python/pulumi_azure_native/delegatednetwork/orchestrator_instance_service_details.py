...
class OrchestratorInstanceServiceDetailsArgs:
    def __init__(__self__, *,
                 ...
                 kind: pulumi.Input[Union[builtins.str, 'OrchestratorKind']],
                 resource_group_name: pulumi.Input[builtins.str],
                 api_server_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_root_ca: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['OrchestratorIdentityArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 orchestrator_app_id: Optional[pulumi.Input[builtins.str]] = None,
                 orchestrator_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'OrchestratorKind']] kind: The kind of workbook. Choices are user and shared.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] api_server_endpoint: K8s APIServer url. Either one of apiServerEndpoint or privateLinkResourceId can be specified
        :param pulumi.Input[builtins.str] cluster_root_ca: RootCA certificate of kubernetes cluster base64 encoded
        ...
        :param pulumi.Input[builtins.str] orchestrator_app_id: AAD ID used with apiserver
        :param pulumi.Input[builtins.str] orchestrator_tenant_id: TenantID of server App ID
        :param pulumi.Input[builtins.str] private_link_resource_id: private link arm resource id. Either one of apiServerEndpoint or privateLinkResourceId can be specified
    ...
    @property
    @pulumi.getter
    def kind(self) -> pulumi.Input[Union[builtins.str, 'OrchestratorKind']]:
        """
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Union[builtins.str, 'OrchestratorKind']]):
    ...
    def api_server_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_server_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_server_endpoint", value)

    @property
    @pulumi.getter(name="clusterRootCA")
    def cluster_root_ca(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_root_ca(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def orchestrator_app_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def orchestrator_app_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "orchestrator_app_id", value)

    @property
    @pulumi.getter(name="orchestratorTenantId")
    def orchestrator_tenant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def orchestrator_tenant_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrchestratorInstanceServiceDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kind: Optional[pulumi.Input[Union[builtins.str, 'OrchestratorKind']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 orchestrator_app_id: Optional[pulumi.Input[builtins.str]] = None,
                 orchestrator_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_resource_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="apiServerEndpoint")
    def api_server_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        K8s APIServer url. Either one of apiServerEndpoint or privateLinkResourceId can be specified
        """
        return pulumi.get(self, "api_server_endpoint")
    ...
    @property
    @pulumi.getter(name="clusterRootCA")
    def cluster_root_ca(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        RootCA certificate of kubernetes cluster base64 encoded
        """
        return pulumi.get(self, "cluster_root_ca")
    ...
    @property
    @pulumi.getter(name="orchestratorAppId")
    def orchestrator_app_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AAD ID used with apiserver
        """
        return pulumi.get(self, "orchestrator_app_id")
    ...
    @property
    @pulumi.getter(name="orchestratorTenantId")
    def orchestrator_tenant_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        TenantID of server App ID
        """
        return pulumi.get(self, "orchestrator_tenant_id")
