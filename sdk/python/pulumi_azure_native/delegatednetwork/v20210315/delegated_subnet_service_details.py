...
class DelegatedSubnetServiceDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['SubnetDetailsArgs', 'SubnetDetailsArgsDict']] subnet_details: subnet details
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: The resource tags.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20230627preview:DelegatedSubnetServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork:DelegatedSubnetServiceDetails")])
