...
class ControllerDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20210315:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20200808preview:ControllerDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20200808preview:ControllerDetails")])
