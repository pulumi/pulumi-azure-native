...
def get_controller_details(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_controller_details is deprecated: Version v20200808preview will be removed in the next major version of the provider. Upgrade to version v20210315 or later.""")
    __args__ = dict()
