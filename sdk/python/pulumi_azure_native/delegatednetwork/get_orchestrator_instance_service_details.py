...
class GetOrchestratorInstanceServiceDetailsResult:
    ...
    def api_server_endpoint(self) -> Optional[builtins.str]:
        """
    ...
    def cluster_root_ca(self) -> Optional[builtins.str]:
        """
    ...
    def orchestrator_app_id(self) -> Optional[builtins.str]:
        """
    ...
    def orchestrator_tenant_id(self) -> Optional[builtins.str]:
        """
...
def get_orchestrator_instance_service_details(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_name: The name of the resource. It must be a minimum of 3 characters, and a maximum of 63.
    """
    __args__ = dict()
...
def get_orchestrator_instance_service_details_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
