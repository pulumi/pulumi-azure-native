...
def get_orchestrator_instance_service_details(resource_group_name: Optional[_builtins.str] = None,
...
def get_orchestrator_instance_service_details_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
