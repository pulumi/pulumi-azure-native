...
class GetControllerDetailsResult:
    ...
    """
    def __init__(__self__, dnc_app_id=None, dnc_endpoint=None, dnc_tenant_id=None, id=None, location=None, name=None, provisioning_state=None, purpose=None, resource_guid=None, tags=None, type=None):
...
def get_controller_details(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:delegatednetwork/v20230627preview:getControllerDetails', __args__, opts=opts, typ=GetControllerDetailsResult).value
...
def get_controller_details_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceName'] = resource_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:delegatednetwork/v20230627preview:getControllerDetails', __args__, opts=opts, typ=GetControllerDetailsResult)
