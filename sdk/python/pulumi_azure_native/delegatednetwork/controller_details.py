...
class ControllerDetailsInitArgs:
    def __init__(__self__, *,
                 ...
                 purpose: Optional[pulumi.Input[Union[_builtins.str, 'ControllerPurpose']]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def purpose(self) -> Optional[pulumi.Input[Union[_builtins.str, 'ControllerPurpose']]]:
        """
    ...
    @purpose.setter
    def purpose(self, value: Optional[pulumi.Input[Union[_builtins.str, 'ControllerPurpose']]]):
...
class ControllerDetails(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union[_builtins.str, 'ControllerPurpose']] purpose: The purpose of the dnc controller resource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] resource_name_: The name of the resource. It must be a minimum of 3 characters, and a maximum of 63.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The resource tags.
        """
        ...
    @overload
