...
class ControllerDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:delegatednetwork/v20210315:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20230518preview:ControllerDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20230627preview:ControllerDetails"), pulumi.Alias(type_="azure-native_delegatednetwork_v20200808preview:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-native_delegatednetwork_v20210315:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-native_delegatednetwork_v20230518preview:delegatednetwork:ControllerDetails"), pulumi.Alias(type_="azure-native_delegatednetwork_v20230627preview:delegatednetwork:ControllerDetails")])
