...
class BlockchainMember(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blockchain/v20180601preview:BlockchainMember"), pulumi.Alias(type_="azure-nextgen:blockchain/v20180601preview:BlockchainMember")])
