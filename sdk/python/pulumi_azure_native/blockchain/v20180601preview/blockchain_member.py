...
class BlockchainMemberArgs:
    ...
    def _configure(
        ...
        if consortium_management_account_password is None and 'consortiumManagementAccountPassword' in kwargs:
            consortium_management_account_password = kwargs['consortiumManagementAccountPassword']
        if consortium_member_display_name is None and 'consortiumMemberDisplayName' in kwargs:
            consortium_member_display_name = kwargs['consortiumMemberDisplayName']
        if consortium_role is None and 'consortiumRole' in kwargs:
        ...
        if validator_nodes_sku is None and 'validatorNodesSku' in kwargs:
...
class BlockchainMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            validator_nodes_sku = _utilities.configure(validator_nodes_sku, BlockchainMemberNodesSkuArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blockchain:BlockchainMember")])
