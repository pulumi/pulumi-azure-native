...
class BlockchainMember(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blockchain:BlockchainMember"), pulumi.Alias(type_="azure-nextgen:blockchain:BlockchainMember")])
