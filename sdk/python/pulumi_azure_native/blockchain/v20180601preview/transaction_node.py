...
class TransactionNode(pulumi.CustomResource):
    def __init__(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:blockchain:TransactionNode"), pulumi.Alias(type_="azure-nextgen:blockchain:TransactionNode")])
