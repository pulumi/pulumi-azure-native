...
def get_gen2_environment(environment_name: Optional[builtins.str] = None,
...
def get_gen2_environment_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
