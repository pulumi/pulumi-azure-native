...
class GetGen2EnvironmentResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, creation_time=None, data_access_fqdn=None, data_access_id=None, id=None, kind=None, location=None, name=None, provisioning_state=None, sku=None, status=None, storage_configuration=None, tags=None, time_series_id_properties=None, type=None, warm_store_configuration=None):
...
def get_gen2_environment(environment_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str expand: Setting $expand=status will include the status of the internal services of the environment in the Time Series Insights service.
...
def get_gen2_environment_output(environment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
