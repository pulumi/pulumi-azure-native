...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:timeseriesinsights/latest:AccessPolicy":
                return AccessPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/latest:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/latest:EventSource":
                return EventSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/latest:ReferenceDataSet":
    ...
    pulumi.runtime.register_resource_module("azure-native", "timeseriesinsights/latest", _module_instance)
