...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:timeseriesinsights:getReferenceDataSet'.""", DeprecationWarning)
...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_reference_data_set is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:timeseriesinsights:getReferenceDataSet'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/latest:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult).value
