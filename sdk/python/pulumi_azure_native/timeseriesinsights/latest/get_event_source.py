...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:timeseriesinsights:getEventSource'.""", DeprecationWarning)
...
def get_event_source(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/latest:getEventSource', __args__, opts=opts, typ=GetEventSourceResult).value
