...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:timeseriesinsights:getAccessPolicy'.""", DeprecationWarning)
...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_access_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:timeseriesinsights:getAccessPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/latest:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult).value
