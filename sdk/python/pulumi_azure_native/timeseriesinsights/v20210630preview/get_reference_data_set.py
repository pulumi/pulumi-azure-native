...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20210630preview:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult).value
