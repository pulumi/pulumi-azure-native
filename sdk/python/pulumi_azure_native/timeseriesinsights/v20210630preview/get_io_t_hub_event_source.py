...
def get_io_t_hub_event_source(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20210630preview:getIoTHubEventSource', __args__, opts=opts, typ=GetIoTHubEventSourceResult).value
...
def get_io_t_hub_event_source_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20210630preview:getIoTHubEventSource', __args__, opts=opts, typ=GetIoTHubEventSourceResult)
