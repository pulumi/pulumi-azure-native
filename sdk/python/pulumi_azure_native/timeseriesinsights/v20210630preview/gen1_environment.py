...
class Gen1Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gen1_environment = azure_native.timeseriesinsights.v20210630preview.Gen1Environment("gen1Environment",
            data_retention_time="P31D",
            environment_name="env1",
            kind="Gen1",
            location="West US",
            partition_key_properties=[azure_native.timeseriesinsights.v20210630preview.TimeSeriesIdPropertyArgs(
                name="DeviceId1",
                type="String",
            )],
            resource_group_name="rg1",
            sku=azure_native.timeseriesinsights.v20210630preview.SkuArgs(
                capacity=1,
                name="S1",
            ))
        ...
        ```sh
        $ pulumi import azure-native:timeseriesinsights/v20210630preview:Gen1Environment env1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1 
        ```
