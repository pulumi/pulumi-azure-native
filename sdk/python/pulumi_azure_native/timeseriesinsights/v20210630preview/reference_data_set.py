...
class ReferenceDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        reference_data_set = azure_native.timeseriesinsights.v20210630preview.ReferenceDataSet("referenceDataSet",
            environment_name="env1",
            key_properties=[
                azure_native.timeseriesinsights.v20210630preview.ReferenceDataSetKeyPropertyArgs(
                    name="DeviceId1",
                    type="String",
                ),
                azure_native.timeseriesinsights.v20210630preview.ReferenceDataSetKeyPropertyArgs(
        ...
        ```sh
        $ pulumi import azure-native:timeseriesinsights/v20210630preview:ReferenceDataSet rds1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1/referenceDataSets/rds1 
        ```
