...
def get_event_hub_event_source(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20210630preview:getEventHubEventSource', __args__, opts=opts, typ=GetEventHubEventSourceResult).value
