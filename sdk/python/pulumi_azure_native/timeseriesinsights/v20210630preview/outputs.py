...
class Gen1EnvironmentResourcePropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "creationTime":
            ...
            suggest = "provisioning_state"
        elif key == "supportsCustomerManagedKey":
            suggest = "supports_customer_managed_key"
    ...
    def __init__(__self__, *,
                 ...
                 supports_customer_managed_key: bool,
        ...
        :param bool supports_customer_managed_key: Indicates whether an environment supports Encryption at Rest with Customer Managed Key.
