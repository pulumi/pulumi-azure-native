...
class GetReferenceDataSetResult:
    ...
    def data_string_comparison_behavior(self) -> Optional[builtins.str]:
        """
...
def get_reference_data_set(environment_name: Optional[builtins.str] = None,
                           reference_data_set_name: Optional[builtins.str] = None,
    ...
    :param builtins.str reference_data_set_name: The name of the Time Series Insights reference data set associated with the specified environment.
...
def get_reference_data_set_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
                                  reference_data_set_name: Optional[pulumi.Input[builtins.str]] = None,
