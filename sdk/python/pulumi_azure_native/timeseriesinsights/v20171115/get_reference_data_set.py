...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_reference_data_set is deprecated: Version v20171115 will be removed in the next major version of the provider. Upgrade to version v20200515 or later.""")
    __args__ = dict()
