...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_access_policy is deprecated: Version v20171115 will be removed in the next major version of the provider. Upgrade to version v20200515 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20171115:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult).value
