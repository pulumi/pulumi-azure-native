...
class IoTHubEventSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 timestamp_property_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""IoTHubEventSource is deprecated: azure-native:timeseriesinsights/v20171115:IoTHubEventSource is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""")
