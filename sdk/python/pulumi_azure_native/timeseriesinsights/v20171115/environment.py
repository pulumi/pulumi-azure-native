...
class EnvironmentArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input['EnvironmentCreationPropertiesArgs'],
        ...
        :param pulumi.Input['EnvironmentCreationPropertiesArgs'] properties: Properties used to create an environment.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['EnvironmentCreationPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['EnvironmentCreationPropertiesArgs']):
...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 environment_name: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['EnvironmentCreationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] environment_name: Name of the environment
        :param pulumi.Input[str] location: The location of the resource.
        :param pulumi.Input[pulumi.InputType['EnvironmentCreationPropertiesArgs']] properties: Properties used to create an environment.
        :param pulumi.Input[str] resource_group_name: Name of an Azure Resource group.
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Environment is deprecated: Version 2017-11-15 will be removed in v2 of the provider.""")
