...
class Environment(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20171115:Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights:Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/latest:Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/latest:Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20170228preview:Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20180815preview:Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20180815preview:Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20200515:Environment")])
    ...
    def get(resource_name: str,
        ...
        __props__["data_access_fqdn"] = None
        __props__["data_access_id"] = None
        __props__["data_retention_time"] = None
        __props__["location"] = None
        __props__["name"] = None
        __props__["partition_key_properties"] = None
        __props__["provisioning_state"] = None
        __props__["sku"] = None
        __props__["status"] = None
        __props__["storage_limit_exceeded_behavior"] = None
        __props__["tags"] = None
        __props__["type"] = None
