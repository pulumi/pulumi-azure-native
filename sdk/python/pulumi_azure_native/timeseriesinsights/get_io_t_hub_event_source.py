...
def get_io_t_hub_event_source(environment_name: Optional[_builtins.str] = None,
...
def get_io_t_hub_event_source_output(environment_name: Optional[pulumi.Input[_builtins.str]] = None,
