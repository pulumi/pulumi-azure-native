...
class GetIoTHubEventSourceResult:
    ...
    def timestamp_property_name(self) -> Optional[builtins.str]:
        """
...
def get_io_t_hub_event_source(environment_name: Optional[builtins.str] = None,
    ...
    :param builtins.str event_source_name: The name of the Time Series Insights event source associated with the specified environment.
...
def get_io_t_hub_event_source_output(environment_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetIoTHubEventSourceResult(
        ...
        iot_hub_name=pulumi.get(__response__, 'iot_hub_name'),
