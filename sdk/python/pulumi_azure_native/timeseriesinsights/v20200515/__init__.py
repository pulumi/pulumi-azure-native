...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:timeseriesinsights/v20200515:AccessPolicy":
                return AccessPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20200515:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20200515:EventSource":
                return EventSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20200515:ReferenceDataSet":
    ...
    pulumi.runtime.register_resource_module("azure-native", "timeseriesinsights/v20200515", _module_instance)
