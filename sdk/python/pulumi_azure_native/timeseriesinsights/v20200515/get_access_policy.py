...
warnings.warn("""Version 2020-05-15 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_access_policy is deprecated: Version 2020-05-15 will be removed in v2 of the provider.""")
    __args__ = dict()
