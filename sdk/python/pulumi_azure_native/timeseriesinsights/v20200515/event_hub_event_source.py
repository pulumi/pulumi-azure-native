...
warnings.warn("""azure-native:timeseriesinsights/v20200515:EventHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:EventHubEventSource to guarantee forwards compatibility.""", DeprecationWarning)
...
class EventHubEventSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[Union[str, 'IngressStartAtType']]] = None,
                 __props__=None):
        pulumi.log.warn("""EventHubEventSource is deprecated: azure-native:timeseriesinsights/v20200515:EventHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:EventHubEventSource to guarantee forwards compatibility.""")
        ...
        super(EventHubEventSource, __self__).__init__(
            'azure-native:timeseriesinsights/v20200515:EventHubEventSource',
            resource_name,
            __props__,
            opts)
