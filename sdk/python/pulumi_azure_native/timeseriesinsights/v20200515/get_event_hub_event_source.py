...
def get_event_hub_event_source_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20200515:getEventHubEventSource', __args__, opts=opts, typ=GetEventHubEventSourceResult)
