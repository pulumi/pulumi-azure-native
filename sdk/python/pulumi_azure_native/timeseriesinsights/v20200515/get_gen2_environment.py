...
def get_gen2_environment(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gen2_environment is deprecated: azure-native:timeseriesinsights/v20200515:Gen2Environment is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210331preview:Gen2Environment to guarantee forwards compatibility.""")
    __args__ = dict()
