...
def get_gen1_environment(environment_name: Optional[_builtins.str] = None,
...
def get_gen1_environment_output(environment_name: pulumi.Input[Optional[_builtins.str]] = None,
