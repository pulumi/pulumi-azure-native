...
class EventHubEventSourceArgs:
    def __init__(__self__, *,
                 ...
                 service_bus_namespace: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] consumer_group_name: The name of the event hub's consumer group that holds the partitions from which events will be read.
        ...
        :param pulumi.Input[builtins.str] event_hub_name: The name of the event hub.
        :param pulumi.Input[builtins.str] event_source_resource_id: The resource id of the event source in Azure Resource Manager.
        :param pulumi.Input[builtins.str] key_name: The name of the SAS key that grants the Time Series Insights service access to the event hub. The shared access policies for this key must grant 'Listen' permissions to the event hub.
        ...
        :param pulumi.Input[builtins.str] service_bus_namespace: The name of the service bus that contains the event hub.
        :param pulumi.Input[builtins.str] shared_access_key: The value of the shared access key that grants the Time Series Insights service read access to the event hub. This property is not shown in event source responses.
    ...
    def service_bus_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_bus_namespace(self, value: pulumi.Input[builtins.str]):
...
class EventHubEventSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_bus_namespace: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="eventHubName")
    def event_hub_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the event hub.
        """
        return pulumi.get(self, "event_hub_name")
    ...
    @property
    @pulumi.getter(name="serviceBusNamespace")
    def service_bus_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The name of the service bus that contains the event hub.
        """
        return pulumi.get(self, "service_bus_namespace")
