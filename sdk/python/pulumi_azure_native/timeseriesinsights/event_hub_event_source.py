...
class EventHubEventSourceArgs:
    ...
    def _configure(
        ...
        if service_bus_namespace is None:
            raise TypeError("Missing 'service_bus_namespace' argument")
        ...
        if local_timestamp is None and 'localTimestamp' in kwargs:
            local_timestamp = kwargs['localTimestamp']
...
class EventHubEventSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            local_timestamp = _utilities.configure(local_timestamp, LocalTimestampArgs, True)
