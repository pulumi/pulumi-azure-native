...
class EventHubEventSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time: ISO8601 UTC datetime with seconds precision (milliseconds are optional), specifying the date and time that will be the starting point for Events to be consumed.
        :param pulumi.Input[_builtins.str] timestamp_property_name: The event property that will be used as the event source's timestamp. If a value isn't specified for timestampPropertyName, or if null or empty-string is specified, the event creation time will be used.
        :param pulumi.Input[Union[_builtins.str, 'IngressStartAtType']] type: The type of the ingressStartAt, It can be "EarliestAvailable", "EventSourceCreationTime", "CustomEnqueuedTime".
        """
    ...
    def service_bus_namespace(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def service_bus_namespace(self, value: pulumi.Input[_builtins.str]):
...
class EventHubEventSource(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="eventHubName")
    def event_hub_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the event hub.
        """
        return pulumi.get(self, "event_hub_name")
