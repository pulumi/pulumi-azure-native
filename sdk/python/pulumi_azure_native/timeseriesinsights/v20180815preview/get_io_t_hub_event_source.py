...
warnings.warn("""azure-native:timeseriesinsights/v20180815preview:IoTHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""", DeprecationWarning)
...
class GetIoTHubEventSourceResult:
    ...
    """
    def __init__(__self__, consumer_group_name=None, creation_time=None, event_source_resource_id=None, id=None, iot_hub_name=None, key_name=None, kind=None, location=None, name=None, provisioning_state=None, tags=None, timestamp_property_name=None, type=None):
...
def get_io_t_hub_event_source(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_hub_event_source is deprecated: azure-native:timeseriesinsights/v20180815preview:IoTHubEventSource is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['environmentName'] = environment_name
    __args__['eventSourceName'] = event_source_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20180815preview:getIoTHubEventSource', __args__, opts=opts, typ=GetIoTHubEventSourceResult).value
