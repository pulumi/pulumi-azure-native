...
class EventHubEventSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        event_hub_event_source = azure_native.timeseriesinsights.v20180815preview.EventHubEventSource("eventHubEventSource",
        ...
        ```sh
        $ pulumi import azure-native:timeseriesinsights/v20180815preview:EventHubEventSource es1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.TimeSeriesInsights/Environments/env1/eventSources/es1 
        ```
    ...
    def _internal_init(__self__,
        ...
        super(EventHubEventSource, __self__).__init__(
            'azure-native:timeseriesinsights/v20180815preview:EventHubEventSource',
            resource_name,
            __props__,
            opts)
