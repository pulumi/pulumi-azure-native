...
__all__ = [
    ...
    'LongTermEnvironmentResourcePropertiesResponse',
    'LongTermStorageConfigurationOutputResponse',
    'ReferenceDataSetKeyPropertyResponse',
    'SkuResponse',
    'StandardEnvironmentResourcePropertiesResponse',
...
@pulumi.output_type
class LongTermEnvironmentResourcePropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LongTermEnvironmentResourcePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LongTermEnvironmentResourcePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 storage_configuration: 'outputs.LongTermStorageConfigurationOutputResponse',
        ...
        :param 'LongTermStorageConfigurationOutputResponse' storage_configuration: The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
...
@pulumi.output_type
class StandardEnvironmentResourcePropertiesResponse(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in StandardEnvironmentResourcePropertiesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        StandardEnvironmentResourcePropertiesResponse.__key_warning(key)
        return super().__getitem__(key)
