...
__all__ = ['LongTermEnvironmentArgs', 'LongTermEnvironment']

@pulumi.input_type
class LongTermEnvironmentArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "kind", 'LongTerm')
...
class LongTermEnvironment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 storage_configuration: Optional[pulumi.Input[pulumi.InputType['LongTermStorageConfigurationInputArgs']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['LongTermStorageConfigurationInputArgs']] storage_configuration: The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Key-value pairs of additional properties for the resource.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LongTermEnvironmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        An environment is a set of time-series data available for query, and is the top level Azure Time Series Insights resource. LongTerm environments do not have set data retention limits.

        :param str resource_name: The name of the resource.
        :param LongTermEnvironmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LongTermEnvironmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LongTermEnvironmentArgs.__new__(LongTermEnvironmentArgs)

            __props__.__dict__["environment_name"] = environment_name
            if kind is None and not opts.urn:
                raise TypeError("Missing required property 'kind'")
            __props__.__dict__["kind"] = 'LongTerm'
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20180815preview:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20170228preview:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20171115:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20171115:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20200515:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210331preview:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20210331preview:LongTermEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210630preview:LongTermEnvironment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20210630preview:LongTermEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LongTermEnvironment, __self__).__init__(
            'azure-native:timeseriesinsights/v20180815preview:LongTermEnvironment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LongTermEnvironment':
        """
        ...
        return LongTermEnvironment(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="storageConfiguration")
    def storage_configuration(self) -> pulumi.Output['outputs.LongTermStorageConfigurationOutputResponse']:
        """
        The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
        """
        return pulumi.get(self, "storage_configuration")
