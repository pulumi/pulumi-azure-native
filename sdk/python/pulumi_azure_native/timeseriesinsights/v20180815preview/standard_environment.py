...
class StandardEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        standard_environment = azure_native.timeseriesinsights.v20180815preview.StandardEnvironment("standardEnvironment",
            data_retention_time="P31D",
            environment_name="env1",
            kind="Standard",
            location="West US",
            partition_key_properties=[azure_native.timeseriesinsights.v20180815preview.TimeSeriesIdPropertyArgs(
                name="DeviceId1",
                type="String",
            )],
            resource_group_name="rg1",
            sku=azure_native.timeseriesinsights.v20180815preview.SkuArgs(
                capacity=1,
                name="S1",
            ))
