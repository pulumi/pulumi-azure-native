...
class StandardEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['StandardEnvironmentCreationPropertiesArgs'],
        ...
        :param pulumi.Input['StandardEnvironmentCreationPropertiesArgs'] properties: Properties used to create a standard environment.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['StandardEnvironmentCreationPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['StandardEnvironmentCreationPropertiesArgs']):
...
class StandardEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['StandardEnvironmentCreationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: The kind of the environment.
               Expected value is 'Standard'.
        :param pulumi.Input[str] location: The location of the resource.
        :param pulumi.Input[pulumi.InputType['StandardEnvironmentCreationPropertiesArgs']] properties: Properties used to create a standard environment.
        :param pulumi.Input[str] resource_group_name: Name of an Azure Resource group.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:timeseriesinsights:StandardEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:StandardEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20171115:StandardEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:StandardEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210331preview:StandardEnvironment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210630preview:StandardEnvironment")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.StandardEnvironmentResourcePropertiesResponse']:
        """
