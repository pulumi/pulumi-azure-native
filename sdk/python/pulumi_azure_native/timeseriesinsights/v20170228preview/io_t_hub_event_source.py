...
class IoTHubEventSourceArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['IoTHubEventSourceCreationPropertiesArgs'],
        ...
        :param pulumi.Input['IoTHubEventSourceCreationPropertiesArgs'] properties: Properties of the IoTHub event source that are required on create or update requests.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['IoTHubEventSourceCreationPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['IoTHubEventSourceCreationPropertiesArgs']):
...
class IoTHubEventSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['IoTHubEventSourceCreationPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: The kind of the event source.
               Expected value is 'Microsoft.IoTHub'.
        :param pulumi.Input[str] location: The location of the resource.
        :param pulumi.Input[pulumi.InputType['IoTHubEventSourceCreationPropertiesArgs']] properties: Properties of the IoTHub event source that are required on create or update requests.
        :param pulumi.Input[str] resource_group_name: Name of an Azure Resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Key-value pairs of additional properties for the resource.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:timeseriesinsights:IoTHubEventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20171115:IoTHubEventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20180815preview:IoTHubEventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:IoTHubEventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource")])
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.IoTHubEventSourceResourcePropertiesResponse']:
        """
