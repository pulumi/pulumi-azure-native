...
warnings.warn("""azure-native:timeseriesinsights/v20170228preview:IoTHubEventSource is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""", DeprecationWarning)
