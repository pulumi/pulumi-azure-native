...
class GetReferenceDataSetResult:
    ...
    """
    def __init__(__self__, creation_time=None, id=None, key_properties=None, location=None, name=None, provisioning_state=None, tags=None, type=None):
...
def get_reference_data_set(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_reference_data_set is deprecated: Version v20170228preview will be removed in the next major version of the provider. Upgrade to version v20200515 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20170228preview:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult).value
