...
def get_io_t_hub_event_source_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20210331preview:getIoTHubEventSource', __args__, opts=opts, typ=GetIoTHubEventSourceResult)
