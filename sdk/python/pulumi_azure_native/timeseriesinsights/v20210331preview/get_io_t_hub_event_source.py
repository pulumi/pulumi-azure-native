...
def get_io_t_hub_event_source(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_io_t_hub_event_source is deprecated: azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""")
    __args__ = dict()
