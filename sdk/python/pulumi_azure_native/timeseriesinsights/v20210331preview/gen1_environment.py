...
class Gen1Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        gen1_environment = azure_native.timeseriesinsights.v20210331preview.Gen1Environment("gen1Environment",
            data_retention_time="P31D",
            environment_name="env1",
            kind="Gen1",
            location="West US",
            partition_key_properties=[azure_native.timeseriesinsights.v20210331preview.TimeSeriesIdPropertyArgs(
                name="DeviceId1",
                type="String",
            )],
            resource_group_name="rg1",
            sku=azure_native.timeseriesinsights.v20210331preview.SkuArgs(
                capacity=1,
                name="S1",
            ))
