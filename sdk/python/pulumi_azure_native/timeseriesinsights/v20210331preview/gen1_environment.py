...
class Gen1Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20210331preview:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20170228preview:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20171115:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20171115:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20180815preview:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20180815preview:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20200515:Gen1Environment"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20210630preview:Gen1Environment"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20210630preview:Gen1Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Gen1Environment, __self__).__init__(
            'azure-native:timeseriesinsights/v20210331preview:Gen1Environment',
            resource_name,
            __props__,
            opts)
