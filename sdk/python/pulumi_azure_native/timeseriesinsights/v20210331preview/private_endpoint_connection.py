...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] group_ids: The provisioning state of the private endpoint connection resource.
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20210331preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:timeseriesinsights:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:timeseriesinsights/v20210331preview:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
