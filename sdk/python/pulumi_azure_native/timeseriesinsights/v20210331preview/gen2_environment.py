...
class Gen2Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(storage_configuration, Gen2StorageConfigurationInputArgs):
            ...
            if not isinstance(warm_store_configuration, WarmStoreConfigurationPropertiesArgs):
