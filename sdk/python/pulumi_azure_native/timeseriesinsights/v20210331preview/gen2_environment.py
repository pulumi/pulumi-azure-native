...
class Gen2EnvironmentArgs:
    ...
    def _configure(
             ...
             storage_configuration: Optional[pulumi.Input['Gen2StorageConfigurationInputArgs']] = None,
             time_series_id_properties: Optional[pulumi.Input[Sequence[pulumi.Input['TimeSeriesIdPropertyArgs']]]] = None,
             environment_name: Optional[pulumi.Input[str]] = None,
             location: Optional[pulumi.Input[str]] = None,
             public_network_access: Optional[pulumi.Input[Union[str, 'PublicNetworkAccess']]] = None,
             tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        ...
        if storage_configuration is None:
            raise TypeError("Missing 'storage_configuration' argument")
        if time_series_id_properties is None and 'timeSeriesIdProperties' in kwargs:
            time_series_id_properties = kwargs['timeSeriesIdProperties']
        if time_series_id_properties is None:
            raise TypeError("Missing 'time_series_id_properties' argument")
        ...
        if warm_store_configuration is None and 'warmStoreConfiguration' in kwargs:
...
class Gen2Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            storage_configuration = _utilities.configure(storage_configuration, Gen2StorageConfigurationInputArgs, True)
            ...
            warm_store_configuration = _utilities.configure(warm_store_configuration, WarmStoreConfigurationPropertiesArgs, True)
