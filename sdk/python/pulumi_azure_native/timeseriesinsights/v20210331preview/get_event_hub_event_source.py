...
def get_event_hub_event_source(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20210331preview:getEventHubEventSource', __args__, opts=opts, typ=GetEventHubEventSourceResult).value
...
def get_event_hub_event_source_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20210331preview:getEventHubEventSource', __args__, opts=opts, typ=GetEventHubEventSourceResult)
