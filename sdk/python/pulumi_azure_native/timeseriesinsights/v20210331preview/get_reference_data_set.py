...
def get_reference_data_set_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20210331preview:getReferenceDataSet', __args__, opts=opts, typ=GetReferenceDataSetResult)
