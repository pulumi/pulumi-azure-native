...
def get_access_policy(access_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_access_policy is deprecated: azure-native:timeseriesinsights/v20210331preview:AccessPolicy is being removed in the next major version of this provider. Upgrade to at least azure-native:timeseriesinsights/v20210630preview:AccessPolicy to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['accessPolicyName'] = access_policy_name
    __args__['environmentName'] = environment_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20210331preview:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult).value
