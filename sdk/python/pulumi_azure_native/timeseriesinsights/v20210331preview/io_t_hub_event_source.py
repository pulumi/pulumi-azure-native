...
warnings.warn("""azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""", DeprecationWarning)
...
class IoTHubEventSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 type: Optional[pulumi.Input[Union[str, 'IngressStartAtType']]] = None,
                 __props__=None):
        pulumi.log.warn("""IoTHubEventSource is deprecated: azure-native:timeseriesinsights/v20210331preview:IoTHubEventSource is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:IoTHubEventSource to guarantee forwards compatibility.""")
