...
def get_gen1_environment_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:timeseriesinsights/v20210331preview:getGen1Environment', __args__, opts=opts, typ=GetGen1EnvironmentResult)
