...
def get_gen1_environment(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gen1_environment is deprecated: azure-native:timeseriesinsights/v20210331preview:Gen1Environment is being removed in the next major version of this provider. Please upgrade to azure-native:timeseriesinsights/v20210630preview:Gen1Environment to guarantee forwards compatibility.""")
    __args__ = dict()
