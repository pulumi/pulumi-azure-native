...
def get_managed_gateway(instance_name: Optional[builtins.str] = None,
                        managed_gateway_name: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_name: Name of the SCOM managed instance.
    :param builtins.str managed_gateway_name: The gateway resource name.
...
def get_managed_gateway_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
                               managed_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:scom:getManagedGateway', __args__, opts=opts, typ=GetManagedGatewayResult)
    return __ret__.apply(lambda __response__: GetManagedGatewayResult(
