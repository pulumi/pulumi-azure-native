...
class MonitoredResourceArgs:
    ...
    def monitored_resource_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def monitored_resource_name(self, value: Optional[pulumi.Input[str]]):
...
class MonitoredResource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scom/v20230707preview:MonitoredResource"), pulumi.Alias(type_="azure-native_scom_v20230707preview:scom:MonitoredResource")])
