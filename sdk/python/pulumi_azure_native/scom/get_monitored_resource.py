...
def get_monitored_resource(instance_name: Optional[_builtins.str] = None,
                           monitored_resource_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str monitored_resource_name: The monitored resource name.
...
def get_monitored_resource_output(instance_name: pulumi.Input[Optional[_builtins.str]] = None,
                                  monitored_resource_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
