...
def get_monitored_resource(instance_name: Optional[builtins.str] = None,
                           monitored_resource_name: Optional[builtins.str] = None,
    ...
    :param builtins.str monitored_resource_name: The monitored resource name.
...
def get_monitored_resource_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:scom:getMonitoredResource', __args__, opts=opts, typ=GetMonitoredResourceResult)
