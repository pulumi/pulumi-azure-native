...
class DatabaseInstancePropertiesResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             database_fqdn: Optional[str] = None,
             dw_database_id: Optional[str] = None,
             dw_database_name: Optional[str] = None,
             operational_database_id: Optional[str] = None,
             database_instance_id: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if database_fqdn is None and 'databaseFqdn' in kwargs:
            database_fqdn = kwargs['databaseFqdn']
        if database_fqdn is None:
            raise TypeError("Missing 'database_fqdn' argument")
        if dw_database_id is None and 'dwDatabaseId' in kwargs:
            dw_database_id = kwargs['dwDatabaseId']
        if dw_database_id is None:
            raise TypeError("Missing 'dw_database_id' argument")
        if dw_database_name is None and 'dwDatabaseName' in kwargs:
            dw_database_name = kwargs['dwDatabaseName']
        if dw_database_name is None:
            raise TypeError("Missing 'dw_database_name' argument")
        if operational_database_id is None and 'operationalDatabaseId' in kwargs:
            operational_database_id = kwargs['operationalDatabaseId']
        if operational_database_id is None:
            raise TypeError("Missing 'operational_database_id' argument")
...
class LogAnalyticsConfigurationResponse(dict):
    ...
    def _configure(
        ...
        if import_data is None and 'importData' in kwargs:
...
class ManagedGatewayPropertiesResponse(dict):
    ...
    def _configure(
             ...
             management_server_endpoint: Optional[str] = None,
        ...
        if management_server_endpoint is None and 'managementServerEndpoint' in kwargs:
            management_server_endpoint = kwargs['managementServerEndpoint']
        if management_server_endpoint is None:
            raise TypeError("Missing 'management_server_endpoint' argument")
...
class ManagementServerPropertiesResponse(dict):
    ...
    def _configure(
             ...
             server_roles: Optional[str] = None,
             vm_res_id: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if fqdn is None:
        ...
        if server_roles is None:
            raise TypeError("Missing 'server_roles' argument")
        if vm_res_id is None and 'vmResId' in kwargs:
            vm_res_id = kwargs['vmResId']
        if vm_res_id is None:
            raise TypeError("Missing 'vm_res_id' argument")
...
class MonitoringInstancePropertiesResponse(dict):
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             log_analytics_properties: Optional['outputs.LogAnalyticsConfigurationResponse'] = None,
             management_endpoints: Optional[Sequence['outputs.ManagementServerPropertiesResponse']] = None,
             operations_status: Optional[Sequence['outputs.ManagedInstanceOperationStatusResponse']] = None,
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if log_analytics_properties is None and 'logAnalyticsProperties' in kwargs:
            log_analytics_properties = kwargs['logAnalyticsProperties']
        if log_analytics_properties is None:
            raise TypeError("Missing 'log_analytics_properties' argument")
        ...
        if operations_status is None and 'operationsStatus' in kwargs:
            operations_status = kwargs['operationsStatus']
        if operations_status is None:
            raise TypeError("Missing 'operations_status' argument")
        if product_version is None and 'productVersion' in kwargs:
            product_version = kwargs['productVersion']
        if product_version is None:
            raise TypeError("Missing 'product_version' argument")
        if provisioning_state is None and 'provisioningState' in kwargs:
            provisioning_state = kwargs['provisioningState']
        if provisioning_state is None:
            raise TypeError("Missing 'provisioning_state' argument")
