...
class AzureHybridBenefitPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 scom_license_type: Optional[builtins.str] = None,
                 sql_server_license_type: Optional[builtins.str] = None,
                 windows_server_license_type: Optional[builtins.str] = None):
        """
        The properties to maximize savings by using Azure Hybrid Benefit
        :param builtins.str scom_license_type: SCOM license type. Maximize savings by using license you already own
        :param builtins.str sql_server_license_type: SQL Server license type. Maximize savings by using Azure Hybrid Benefit for SQL Server with license you already own
        :param builtins.str windows_server_license_type: Specifies that the image or disk that is being used was licensed on-premises. <br><br> For more information, see [Azure Hybrid Use Benefit for Windows Server](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-hybrid-use-benefit-licensing?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
        """
    ...
    def scom_license_type(self) -> Optional[builtins.str]:
        """
    ...
    def windows_server_license_type(self) -> Optional[builtins.str]:
        """
...
class DatabaseInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 database_fqdn: builtins.str,
                 dw_database_id: builtins.str,
                 dw_database_name: builtins.str,
                 operational_database_id: builtins.str,
                 database_instance_id: Optional[builtins.str] = None):
        """
        The properties of database instance
        :param builtins.str database_fqdn: Fully qualified domain name of existing database instance
        :param builtins.str dw_database_id: Resource Id of warehouse database on database instance
        :param builtins.str dw_database_name: Name of warehouse database on database instance
        :param builtins.str operational_database_id: Resource Id of operational database on database instance
        :param builtins.str database_instance_id: Resource Id of existing database instance
        """
    ...
    def database_fqdn(self) -> builtins.str:
        """
    ...
    def dw_database_id(self) -> builtins.str:
        """
    ...
    def dw_database_name(self) -> builtins.str:
        """
    ...
    def operational_database_id(self) -> builtins.str:
        """
    ...
    def database_instance_id(self) -> Optional[builtins.str]:
        """
...
class DomainControllerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of domain controller to which SCOM and SQL servers join for AuthN/AuthZ.
        :param builtins.str dns_server: IP address of DNS server 
        :param builtins.str domain_name: Fully qualified domain name
        :param builtins.str ou_path: Organizational Unit path in which the SCOM servers will be present
        """
...
class DomainUserCredentialsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 password_secret: Optional[builtins.str] = None,
                 user_name_secret: Optional[builtins.str] = None):
        """
        Get Domain user name and password from key vault
        :param builtins.str key_vault_url: Key vault url to get the domain username and password
        :param builtins.str password_secret: Domain Password secret 
        :param builtins.str user_name_secret: Domain user name secret 
        """
    ...
    def user_name_secret(self) -> Optional[builtins.str]:
        """
...
class GmsaDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gmsa_account: Optional[builtins.str] = None,
                 load_balancer_ip: Optional[builtins.str] = None,
                 management_server_group_name: Optional[builtins.str] = None):
        """
        Gmsa Details
        :param builtins.str dns_name: Frontend DNS name for Load Balancer which will be used by Agents to initiate communication
        :param builtins.str gmsa_account: gMSA account under which context all Management Server services will run
        :param builtins.str load_balancer_ip: Frontend IP configuration for Load Balancer, which should be an available IP in customer VNet
        :param builtins.str management_server_group_name: OnPrem AD Computer Group where we will join VMs for ease of management
        """
    ...
    def gmsa_account(self) -> Optional[builtins.str]:
        """
    ...
    def load_balancer_ip(self) -> Optional[builtins.str]:
        """
    ...
    def management_server_group_name(self) -> Optional[builtins.str]:
        """
...
class LogAnalyticsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 import_data: Optional[builtins.bool] = None,
                 workspace_id: Optional[builtins.str] = None):
        """
        Configuration for Log Analytics linking to SCOM managed instance.
        :param Sequence[builtins.str] data_types: The types of data to be ingested to Log Analytics workspace.
        :param builtins.bool import_data: A one-time optional parameter to import data of last 7 days.
        :param builtins.str workspace_id: The resource ID of the Log Analytics workspace to be used.
        """
    ...
    def import_data(self) -> Optional[builtins.bool]:
        """
...
class ManagedGatewayPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 management_server_endpoint: builtins.str,
        ...
        """
        The properties of a gateway resource.
        :param builtins.str connection_status: The connection status of the gateway resource.
        :param builtins.str health_status: The health status of the gateway resource.
        :param builtins.str install_type: Install type of gateway resource.
        :param builtins.str management_server_endpoint: The management server endpoint to which the gateway is directed.
        :param builtins.str version: The version of the gateway resource.
        :param builtins.str computer_name: ComputerName of the gateway to be monitored.
        :param builtins.str domain_name: The domain name associated with the gateway to be monitored.
        :param builtins.str resource_id: ArmId of the gateway to be monitored.
        :param builtins.str resource_location: Location of the gateway to be monitored.
        """
    ...
    def management_server_endpoint(self) -> builtins.str:
        """
...
class ManagedIdentityResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure Active Directory identity configuration for a resource.
        :param builtins.str principal_id: System Assigned Identity ObjectId.
...
class ManagedInstanceOperationStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Gets status of current and latest SCOM managed instance operation.
        :param builtins.str id: Operation id
        :param builtins.str operation_name: Operation Name
        :param builtins.str operation_state: Operation status
        """
...
class ManagementServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 server_roles: builtins.str,
                 vm_res_id: builtins.str):
        """
        The properties of management server
        :param builtins.str fqdn: Management server Fully Qualified Domain Name.
        :param builtins.str health_state: Management server health state.
        :param builtins.str server_name: Management server Name
        :param builtins.str server_roles: Represent whether the Server is a Management Server and/or Web Console Server.
        :param builtins.str vm_res_id: Azure VM Resource Id of the Management server.
        """
    ...
    def server_roles(self) -> builtins.str:
        """
    ...
    def vm_res_id(self) -> builtins.str:
        """
...
class MonitoredResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        The properties of a monitored resource.
        :param builtins.str agent_version: The version of the monitored resource agent version.
        :param builtins.str connection_status: The connection status of the monitored resource.
        :param builtins.str health_status: The health status of the monitored resource.
        :param builtins.str install_type: Install type of monitored resource.
        :param builtins.str management_server_endpoint: The management server endpoint to which the monitored resource is directed.
        :param builtins.str computer_name: ComputerName of the monitored resource.
        :param builtins.str domain_name: The domain name associated with the monitored resource.
        :param builtins.str resource_id: ArmId of the monitored resource.
        :param builtins.str resource_location: Location of the monitored resource.
        """
...
class MonitoringInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 v_net_subnet_id: Optional[builtins.str] = None):
        """
        The properties of a SCOM instance resource
        ...
        :param builtins.str product_version: SCOM product version to be installed on instance
        :param builtins.str provisioning_state: Gets or sets the provisioning state.
        ...
        :param builtins.str v_net_subnet_id: Virtual Network subnet id on which Aquila instance will be provisioned
        """
    ...
    def v_net_subnet_id(self) -> Optional[builtins.str]:
        """
