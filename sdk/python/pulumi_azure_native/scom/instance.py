...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:scom/v20230707preview:Instance"), pulumi.Alias(type_="azure-native_scom_v20230707preview:scom:Instance")])
