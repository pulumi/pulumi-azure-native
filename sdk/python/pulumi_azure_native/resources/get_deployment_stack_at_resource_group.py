...
def get_deployment_stack_at_resource_group(deployment_stack_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources:getDeploymentStackAtResourceGroup', __args__, opts=opts, typ=GetDeploymentStackAtResourceGroupResult).value
...
def get_deployment_stack_at_resource_group_output(deployment_stack_name: Optional[pulumi.Input[builtins.str]] = None,
