...
class ActionOnUnmanageResponseV2(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ActionOnUnmanageResponseV2. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ActionOnUnmanageResponseV2.__key_warning(key)
        return super().__getitem__(key)
...
class ActionOnUnmanageResponseV3(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ActionOnUnmanageResponseV3. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ActionOnUnmanageResponseV3.__key_warning(key)
        return super().__getitem__(key)
...
class DeploymentStacksWhatIfResultPropertiesResponseV1(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DeploymentStacksWhatIfResultPropertiesResponseV1. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DeploymentStacksWhatIfResultPropertiesResponseV1.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param 'ActionOnUnmanageResponseV2' action_on_unmanage: Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
        :param 'DeploymentStacksWhatIfChangeResponse' changes: All of the changes predicted by the deployment stack what-if operation.
        :param _builtins.str correlation_id: The correlation id of the last Deployment stack upsert or delete operation. It is in GUID format and is used for tracing.
        :param 'DenySettingsResponse' deny_settings: Defines how resources deployed by the stack are locked.
        :param _builtins.str deployment_stack_last_modified: The timestamp for when the deployment stack was last modified. This can be used to determine if the what-if data is still current.
...
class DeploymentStacksWhatIfResultPropertiesResponseV2(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DeploymentStacksWhatIfResultPropertiesResponseV2. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DeploymentStacksWhatIfResultPropertiesResponseV2.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        :param 'ActionOnUnmanageResponseV3' action_on_unmanage: Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
        :param 'DeploymentStacksWhatIfChangeResponse' changes: All of the changes predicted by the deployment stack what-if operation.
        :param _builtins.str correlation_id: The correlation id of the last Deployment stack upsert or delete operation. It is in GUID format and is used for tracing.
        :param 'DenySettingsResponse' deny_settings: Defines how resources deployed by the stack are locked.
        :param _builtins.str deployment_stack_last_modified: The timestamp for when the deployment stack was last modified. This can be used to determine if the what-if data is still current.
