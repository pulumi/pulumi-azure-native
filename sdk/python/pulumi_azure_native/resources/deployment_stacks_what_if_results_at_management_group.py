...
class DeploymentStacksWhatIfResultsAtManagementGroupArgs:
    def __init__(__self__, *,
                 ...
                 deployment_stacks_what_if_result_name: Optional[pulumi.Input[_builtins.str]] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input['DeploymentStacksWhatIfResultPropertiesArgs']] = None,
    ...
    def deployment_stacks_what_if_result_name(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['DeploymentStacksWhatIfResultPropertiesArgs']]):
...
@pulumi.type_token("azure-native:resources:DeploymentStacksWhatIfResultsAtManagementGroup")
class DeploymentStacksWhatIfResultsAtManagementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: Optional[pulumi.Input[Union['DeploymentStacksWhatIfResultPropertiesArgs', 'DeploymentStacksWhatIfResultPropertiesArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DeploymentStacksWhatIfResultsAtManagementGroupArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Deployment stack object.
        ...
        :param str resource_name: The name of the resource.
        :param DeploymentStacksWhatIfResultsAtManagementGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeploymentStacksWhatIfResultsAtManagementGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DeploymentStacksWhatIfResultsAtManagementGroupArgs.__new__(DeploymentStacksWhatIfResultsAtManagementGroupArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20250701:DeploymentStacksWhatIfResultsAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentStacksWhatIfResultsAtManagementGroup, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DeploymentStacksWhatIfResultsAtManagementGroup':
        """
        ...
        __props__.__dict__["type"] = None
        return DeploymentStacksWhatIfResultsAtManagementGroup(resource_name, opts=opts, __props__=__props__)
