...
def get_deployment_at_subscription_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_subscription_scope is deprecated: azure-native:resources/v20191001:DeploymentAtSubscriptionScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtSubscriptionScope to guarantee forwards compatibility.""")
    __args__ = dict()
