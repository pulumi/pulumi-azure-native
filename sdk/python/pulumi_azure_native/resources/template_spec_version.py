...
class TemplateSpecVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Template Spec version description.
        ...
        :param pulumi.Input[builtins.str] location: The location of the Template Spec Version. It must match the location of the parent Template Spec.
        ...
        :param pulumi.Input[builtins.str] template_spec_version: The version of the Template Spec.
    ...
    def template_spec_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_spec_version(self, value: Optional[pulumi.Input[builtins.str]]):
