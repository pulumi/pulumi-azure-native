...
def get_deployment(deployment_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources:getDeployment', __args__, opts=opts, typ=GetDeploymentResult).value
...
def get_deployment_output(deployment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources:getDeployment', __args__, opts=opts, typ=GetDeploymentResult)
