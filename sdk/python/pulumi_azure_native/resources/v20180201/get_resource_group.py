...
warnings.warn("""Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""", DeprecationWarning)
...
class GetResourceGroupResult:
    ...
    """
    def __init__(__self__, id=None, location=None, managed_by=None, name=None, properties=None, tags=None):
...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_group is deprecated: Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20180201:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult).value
