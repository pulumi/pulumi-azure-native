...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource is deprecated: Version v20180201 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""")
    __args__ = dict()
