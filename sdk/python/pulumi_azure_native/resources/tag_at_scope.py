...
class TagAtScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 properties: pulumi.Input[Optional[Union['TagsArgs', 'TagsArgsDict']]] = None,
