...
def get_deployment_at_scope(deployment_name: Optional[_builtins.str] = None,
...
def get_deployment_at_scope_output(deployment_name: pulumi.Input[Optional[_builtins.str]] = None,
