...
def get_tag_at_scope(scope: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_at_scope is deprecated: azure-native:resources/v20200601:TagAtScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:TagAtScope to guarantee forwards compatibility.""")
    __args__ = dict()
