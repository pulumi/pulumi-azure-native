...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20220901:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult).value
...
def get_resource_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20220901:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult)
