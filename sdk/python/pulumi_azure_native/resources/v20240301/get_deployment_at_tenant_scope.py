...
def get_deployment_at_tenant_scope(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20240301:getDeploymentAtTenantScope', __args__, opts=opts, typ=GetDeploymentAtTenantScopeResult).value
...
def get_deployment_at_tenant_scope_output(deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['deploymentName'] = deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20240301:getDeploymentAtTenantScope', __args__, opts=opts, typ=GetDeploymentAtTenantScopeResult)
