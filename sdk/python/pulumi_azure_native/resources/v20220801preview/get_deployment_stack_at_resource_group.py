...
def get_deployment_stack_at_resource_group(deployment_stack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20220801preview:getDeploymentStackAtResourceGroup', __args__, opts=opts, typ=GetDeploymentStackAtResourceGroupResult).value
...
def get_deployment_stack_at_resource_group_output(deployment_stack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20220801preview:getDeploymentStackAtResourceGroup', __args__, opts=opts, typ=GetDeploymentStackAtResourceGroupResult)
