...
def get_deployment_stack_at_management_group(deployment_stack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20220801preview:getDeploymentStackAtManagementGroup', __args__, opts=opts, typ=GetDeploymentStackAtManagementGroupResult).value

    return AwaitableGetDeploymentStackAtManagementGroupResult(
        action_on_unmanage=__ret__.action_on_unmanage,
        debug_setting=__ret__.debug_setting,
        deleted_resources=__ret__.deleted_resources,
        deny_settings=__ret__.deny_settings,
        deployment_id=__ret__.deployment_id,
        deployment_scope=__ret__.deployment_scope,
        description=__ret__.description,
        detached_resources=__ret__.detached_resources,
        duration=__ret__.duration,
        error=__ret__.error,
        failed_resources=__ret__.failed_resources,
        id=__ret__.id,
