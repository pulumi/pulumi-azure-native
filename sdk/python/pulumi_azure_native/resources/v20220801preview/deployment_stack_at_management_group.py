...
class DeploymentStackAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20240301:DeploymentStackAtManagementGroup"), pulumi.Alias(type_="azure-native:resources:DeploymentStackAtManagementGroup")])
