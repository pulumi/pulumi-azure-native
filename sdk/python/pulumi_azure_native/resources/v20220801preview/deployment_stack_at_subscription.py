...
class DeploymentStackAtSubscriptionArgs:
    ...
    def deny_settings(self) -> Optional[pulumi.Input['DenySettingsArgs']]:
        """
    ...
    def deny_settings(self, value: Optional[pulumi.Input['DenySettingsArgs']]):
...
class DeploymentStackAtSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        deployment_stack_at_subscription = azure_native.resources.v20220801preview.DeploymentStackAtSubscription("deploymentStackAtSubscription",
    ...
    @property
    @pulumi.getter(name="denySettings")
    def deny_settings(self) -> pulumi.Output[Optional['outputs.DenySettingsResponse']]:
        """
        Defines how resources deployed by the stack are locked.
        """
        return pulumi.get(self, "deny_settings")
