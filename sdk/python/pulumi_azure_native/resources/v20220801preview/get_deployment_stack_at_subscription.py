...
def get_deployment_stack_at_subscription(deployment_stack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20220801preview:getDeploymentStackAtSubscription', __args__, opts=opts, typ=GetDeploymentStackAtSubscriptionResult).value
...
def get_deployment_stack_at_subscription_output(deployment_stack_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['deploymentStackName'] = deployment_stack_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20220801preview:getDeploymentStackAtSubscription', __args__, opts=opts, typ=GetDeploymentStackAtSubscriptionResult)
