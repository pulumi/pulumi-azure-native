...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getResourceGroup'.""", DeprecationWarning)
...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult).value
