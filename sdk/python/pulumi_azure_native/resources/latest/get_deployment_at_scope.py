...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentAtScope'.""", DeprecationWarning)
...
def get_deployment_at_scope(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getDeploymentAtScope', __args__, opts=opts, typ=GetDeploymentAtScopeResult).value
