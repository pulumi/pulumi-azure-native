...
def get_template_spec_version(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_template_spec_version is deprecated: azure-native:resources/v20210301preview:TemplateSpecVersion is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220201:TemplateSpecVersion to guarantee forwards compatibility.""")
    __args__ = dict()
