...
warnings.warn("""azure-native:resources/v20210301preview:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_template_spec(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_template_spec is deprecated: azure-native:resources/v20210301preview:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""")
    __args__ = dict()
