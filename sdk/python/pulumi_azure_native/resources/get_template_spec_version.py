...
def get_template_spec_version(resource_group_name: Optional[_builtins.str] = None,
                              template_spec_name: Optional[_builtins.str] = None,
                              template_spec_version: Optional[_builtins.str] = None,
...
def get_template_spec_version_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                     ...
                                     template_spec_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
