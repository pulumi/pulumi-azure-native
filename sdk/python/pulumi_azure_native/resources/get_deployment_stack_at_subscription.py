...
def get_deployment_stack_at_subscription(deployment_stack_name: Optional[_builtins.str] = None,
...
def get_deployment_stack_at_subscription_output(deployment_stack_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources:getDeploymentStackAtSubscription', __args__, opts=opts, typ=GetDeploymentStackAtSubscriptionResult)
