...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource is deprecated: Version v20170510 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20170510:getResource', __args__, opts=opts, typ=GetResourceResult).value
