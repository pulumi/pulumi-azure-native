...
warnings.warn("""azure-native:resources/v20190801:DeploymentAtManagementGroupScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtManagementGroupScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_deployment_at_management_group_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_management_group_scope is deprecated: azure-native:resources/v20190801:DeploymentAtManagementGroupScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtManagementGroupScope to guarantee forwards compatibility.""")
    __args__ = dict()
