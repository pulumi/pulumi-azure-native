...
warnings.warn("""azure-native:resources/v20190801:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_deployment_at_tenant_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_tenant_scope is deprecated: azure-native:resources/v20190801:DeploymentAtTenantScope is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['deploymentName'] = deployment_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20190801:getDeploymentAtTenantScope', __args__, opts=opts, typ=GetDeploymentAtTenantScopeResult).value
