...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource is deprecated: azure-native:resources/v20210401:Resource is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:Resource to guarantee forwards compatibility.""")
    __args__ = dict()
