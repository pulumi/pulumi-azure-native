...
class TemplateSpecVersionArgs:
    ...
    def _configure(
        ...
        if linked_templates is None and 'linkedTemplates' in kwargs:
            linked_templates = kwargs['linkedTemplates']
        ...
        if ui_form_definition is None and 'uiFormDefinition' in kwargs:
            ui_form_definition = kwargs['uiFormDefinition']
...
class TemplateSpecVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources/v20190601preview:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources/v20210301preview:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources/v20210501:TemplateSpecVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpecVersion, __self__).__init__(
            'azure-native:resources/v20220201:TemplateSpecVersion',
            resource_name,
            __props__,
            opts)
