...
class DeploymentStackAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20220801preview:DeploymentStackAtManagementGroup"), pulumi.Alias(type_="azure-native:resources/v20240301:DeploymentStackAtManagementGroup"), pulumi.Alias(type_="azure-native_resources_v20220801preview:resources:DeploymentStackAtManagementGroup"), pulumi.Alias(type_="azure-native_resources_v20240301:resources:DeploymentStackAtManagementGroup")])
