...
warnings.warn("""Version v20180501 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""", DeprecationWarning)
...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_group is deprecated: Version v20180501 will be removed in the next major version of the provider. Upgrade to version v20190501 or later.""")
    __args__ = dict()
