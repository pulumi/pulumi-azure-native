...
def get_resource(api_version: Optional[_builtins.str] = None,
                 parent_resource_path: Optional[_builtins.str] = None,
    ...
    :param _builtins.str api_version: The API version to use for the operation.
    :param _builtins.str parent_resource_path: The parent resource identity.
    :param _builtins.str resource_group_name: The name of the resource group containing the resource to get. The name is case insensitive.
    :param _builtins.str resource_name: The name of the resource to get.
    :param _builtins.str resource_provider_namespace: The namespace of the resource provider.
    :param _builtins.str resource_type: The resource type of the resource.
    """
    __args__ = dict()
...
def get_resource_output(api_version: Optional[pulumi.Input[_builtins.str]] = None,
