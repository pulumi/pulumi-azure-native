...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_group is deprecated: azure-native:resources/v20210101:ResourceGroup is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:ResourceGroup to guarantee forwards compatibility.""")
    __args__ = dict()
