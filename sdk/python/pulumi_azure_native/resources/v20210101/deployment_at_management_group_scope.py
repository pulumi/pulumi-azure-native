...
class DeploymentAtManagementGroupScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        deployment_at_management_group_scope = azure_native.resources.v20210101.DeploymentAtManagementGroupScope("deploymentAtManagementGroupScope",
