...
class DeploymentAtManagementGroupScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 properties: Optional[pulumi.Input[pulumi.InputType['DeploymentPropertiesArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""DeploymentAtManagementGroupScope is deprecated: azure-native:resources/v20190701:DeploymentAtManagementGroupScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtManagementGroupScope to guarantee forwards compatibility.""")
