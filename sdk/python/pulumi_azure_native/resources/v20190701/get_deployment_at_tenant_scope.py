...
warnings.warn("""azure-native:resources/v20190701:DeploymentAtTenantScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_deployment_at_tenant_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_tenant_scope is deprecated: azure-native:resources/v20190701:DeploymentAtTenantScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:DeploymentAtTenantScope to guarantee forwards compatibility.""")
    __args__ = dict()
