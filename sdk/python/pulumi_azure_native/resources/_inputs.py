...
if not MYPY:
    class ActionOnUnmanageArgsDict(TypedDict):
        ...
        """
        resources: pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
        management_groups: NotRequired[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
        resource_groups: NotRequired[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
elif False:
...
class ActionOnUnmanageArgs:
    def __init__(__self__, *,
                 resources: pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']],
                 management_groups: Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]] = None,
                 resource_groups: Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]] = None):
        """
        Defines the behavior of resources that are no longer managed after the stack is updated or deleted.
        :param pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']] resources: Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        :param pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']] management_groups: Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        :param pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']] resource_groups: Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
    ...
    @property
    @pulumi.getter
    def resources(self) -> pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]:
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
    ...
    @resources.setter
    def resources(self, value: pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]):
        pulumi.set(self, "resources", value)

    @property
    @pulumi.getter(name="managementGroups")
    def management_groups(self) -> Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]:
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
    ...
    def management_groups(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]):
        pulumi.set(self, "management_groups", value)

    @property
    @pulumi.getter(name="resourceGroups")
    def resource_groups(self) -> Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]:
        """
        Specifies an action for a newly unmanaged resource. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
        """
    ...
    def resource_groups(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeploymentStacksDeleteDetachEnum']]]):
...
if not MYPY:
    class ContainerConfigurationArgsDict(TypedDict):
        ...
        """
        container_group_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ContainerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Settings to customize ACI container instance.
        :param pulumi.Input[builtins.str] container_group_name: Container group name, if not specified then the name will get auto-generated. Not specifying a 'containerGroupName' indicates the system to generate a unique name which might end up flagging an Azure Policy as non-compliant. Use 'containerGroupName' when you have an Azure Policy that expects a specific naming convention or when you want to fully control the name. 'containerGroupName' property must be between 1 and 63 characters long, must contain only lowercase letters, numbers, and dashes and it cannot start or end with a dash and consecutive dashes are not allowed. To specify a 'containerGroupName', add the following object to properties: { "containerSettings": { "containerGroupName": "contoso-container" } }. If you do not want to specify a 'containerGroupName' then do not add 'containerSettings' property.
...
class ContainerGroupSubnetIdArgs:
    def __init__(__self__, *,
        ...
        """
        Container group subnet information.
        :param pulumi.Input[builtins.str] id: Resource ID of subnet.
        :param pulumi.Input[builtins.str] name: Friendly name for the subnet.
        """
...
if not MYPY:
    class DebugSettingArgsDict(TypedDict):
        ...
        The debug setting.
        """
        detail_level: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DebugSettingArgs:
    def __init__(__self__, *,
                 detail_level: Optional[pulumi.Input[builtins.str]] = None):
        """
        The debug setting.
        :param pulumi.Input[builtins.str] detail_level: Specifies the type of information to log for debugging. The permitted values are none, requestContent, responseContent, or both requestContent and responseContent separated by a comma. The default is none. When setting this value, carefully consider the type of information you are passing in during deployment. By logging information about the request or response, you could potentially expose sensitive data that is retrieved through the deployment operations.
        """
    ...
    def detail_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of information to log for debugging. The permitted values are none, requestContent, responseContent, or both requestContent and responseContent separated by a comma. The default is none. When setting this value, carefully consider the type of information you are passing in during deployment. By logging information about the request or response, you could potentially expose sensitive data that is retrieved through the deployment operations.
        """
    ...
    @detail_level.setter
    def detail_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DenySettingsArgsDict(TypedDict):
        ...
        """
        mode: pulumi.Input[Union[builtins.str, 'DenySettingsMode']]
        """
        denySettings Mode that defines denied actions.
        """
        apply_to_child_scopes: NotRequired[pulumi.Input[builtins.bool]]
        """
        DenySettings will be applied to child resource scopes of every managed resource with a deny assignment.
        """
        excluded_actions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of role-based management operations that are excluded from the denySettings. Up to 200 actions are permitted. If the denySetting mode is set to 'denyWriteAndDelete', then the following actions are automatically appended to 'excludedActions': '*\\/read' and 'Microsoft.Authorization/locks/delete'. If the denySetting mode is set to 'denyDelete', then the following actions are automatically appended to 'excludedActions': 'Microsoft.Authorization/locks/delete'. Duplicate actions will be removed.
        """
        excluded_principals: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DenySettingsArgs:
    def __init__(__self__, *,
                 mode: pulumi.Input[Union[builtins.str, 'DenySettingsMode']],
                 apply_to_child_scopes: Optional[pulumi.Input[builtins.bool]] = None,
                 excluded_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 excluded_principals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Defines how resources deployed by the Deployment stack are locked.
        :param pulumi.Input[Union[builtins.str, 'DenySettingsMode']] mode: denySettings Mode that defines denied actions.
        :param pulumi.Input[builtins.bool] apply_to_child_scopes: DenySettings will be applied to child resource scopes of every managed resource with a deny assignment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_actions: List of role-based management operations that are excluded from the denySettings. Up to 200 actions are permitted. If the denySetting mode is set to 'denyWriteAndDelete', then the following actions are automatically appended to 'excludedActions': '*\\/read' and 'Microsoft.Authorization/locks/delete'. If the denySetting mode is set to 'denyDelete', then the following actions are automatically appended to 'excludedActions': 'Microsoft.Authorization/locks/delete'. Duplicate actions will be removed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_principals: List of AAD principal IDs excluded from the lock. Up to 5 principals are permitted.
        """
    ...
    @property
    @pulumi.getter
    def mode(self) -> pulumi.Input[Union[builtins.str, 'DenySettingsMode']]:
        """
        denySettings Mode that defines denied actions.
        """
    ...
    @mode.setter
    def mode(self, value: pulumi.Input[Union[builtins.str, 'DenySettingsMode']]):
        pulumi.set(self, "mode", value)

    @property
    @pulumi.getter(name="applyToChildScopes")
    def apply_to_child_scopes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        DenySettings will be applied to child resource scopes of every managed resource with a deny assignment.
        """
    ...
    def apply_to_child_scopes(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "apply_to_child_scopes", value)

    @property
    @pulumi.getter(name="excludedActions")
    def excluded_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of role-based management operations that are excluded from the denySettings. Up to 200 actions are permitted. If the denySetting mode is set to 'denyWriteAndDelete', then the following actions are automatically appended to 'excludedActions': '*\\/read' and 'Microsoft.Authorization/locks/delete'. If the denySetting mode is set to 'denyDelete', then the following actions are automatically appended to 'excludedActions': 'Microsoft.Authorization/locks/delete'. Duplicate actions will be removed.
        """
    ...
    def excluded_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_actions", value)

    @property
    @pulumi.getter(name="excludedPrincipals")
    def excluded_principals(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of AAD principal IDs excluded from the lock. Up to 5 principals are permitted.
        """
    ...
    def excluded_principals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DeploymentParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of the value.
...
if not MYPY:
    class DeploymentStacksParametersLinkArgsDict(TypedDict):
        ...
        """
        content_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentStacksParametersLinkArgs:
    def __init__(__self__, *,
        ...
        """
        Entity representing the reference to the deployment parameters.
        :param pulumi.Input[builtins.str] uri: The URI of the parameters file.
        :param pulumi.Input[builtins.str] content_version: If included, must match the ContentVersion in the template.
        """
...
class DeploymentStacksTemplateLinkArgs:
    def __init__(__self__, *,
        ...
        Entity representing the reference to the template.
        :param pulumi.Input[builtins.str] content_version: If included, must match the ContentVersion in the template.
        :param pulumi.Input[builtins.str] id: The resourceId of a Template Spec. Use either the id or uri property, but not both.
        :param pulumi.Input[builtins.str] query_string: The query string (for example, a SAS token) to be used with the templateLink URI.
        :param pulumi.Input[builtins.str] relative_path: The relativePath property can be used to deploy a linked template at a location relative to the parent. If the parent template was linked with a TemplateSpec, this will reference an artifact in the TemplateSpec.  If the parent was linked with a URI, the child deployment will be a combination of the parent and relativePath URIs.
        :param pulumi.Input[builtins.str] uri: The URI of the template to deploy. Use either the uri or id property, but not both.
        """
        if content_version is not None:
            pulumi.set(__self__, "content_version", content_version)
        if id is not None:
...
class EnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secure_value: The value of the secure environment variable.
...
if not MYPY:
    class ExpressionEvaluationOptionsArgsDict(TypedDict):
        ...
        """
        scope: NotRequired[pulumi.Input[Union[builtins.str, 'ExpressionEvaluationOptionsScopeType']]]
        """
...
class ExpressionEvaluationOptionsArgs:
    def __init__(__self__, *,
                 scope: Optional[pulumi.Input[Union[builtins.str, 'ExpressionEvaluationOptionsScopeType']]] = None):
        """
        Specifies whether template expressions are evaluated within the scope of the parent template or nested template.
        :param pulumi.Input[Union[builtins.str, 'ExpressionEvaluationOptionsScopeType']] scope: The scope to be used for evaluation of parameters, variables and functions in a nested template.
        """
    ...
    @property
    @pulumi.getter
    def scope(self) -> Optional[pulumi.Input[Union[builtins.str, 'ExpressionEvaluationOptionsScopeType']]]:
        """
        The scope to be used for evaluation of parameters, variables and functions in a nested template.
        """
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[Union[builtins.str, 'ExpressionEvaluationOptionsScopeType']]]):
...
class ExtendedLocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'ExtendedLocationType']] type: The extended location type.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if type is not None:
...
class KeyVaultParameterReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_name: Azure Key Vault secret name.
        :param pulumi.Input[builtins.str] secret_version: Azure Key Vault secret version.
        """
...
class KeyVaultReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        Azure Key Vault reference.
        :param pulumi.Input[builtins.str] id: Azure Key Vault resourceId.
        """
        pulumi.set(__self__, "id", id)
...
class LinkedTemplateArtifactArgs:
    def __init__(__self__, *,
        ...
        """
        Represents a Template Spec artifact containing an embedded Azure Resource Manager template for use as a linked template.
        :param pulumi.Input[builtins.str] path: A filesystem safe relative path of the artifact.
...
class OnErrorDeploymentArgs:
    def __init__(__self__, *,
        ...
        """
        Deployment on error behavior.
        :param pulumi.Input[builtins.str] deployment_name: The deployment to be used on error case.
...
class PlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] product: The offer ID.
...
class StorageAccountConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        Settings to use an existing storage account. Valid storage account kinds are: Storage, StorageV2 and FileStorage
        :param pulumi.Input[builtins.str] storage_account_key: The storage account access key.
...
class TemplateLinkArgs:
    def __init__(__self__, *,
        ...
        Entity representing the reference to the template.
        :param pulumi.Input[builtins.str] content_version: If included, must match the ContentVersion in the template.
        :param pulumi.Input[builtins.str] id: The resource id of a Template Spec. Use either the id or uri property, but not both.
        :param pulumi.Input[builtins.str] query_string: The query string (for example, a SAS token) to be used with the templateLink URI.
        :param pulumi.Input[builtins.str] relative_path: The relativePath property can be used to deploy a linked template at a location relative to the parent. If the parent template was linked with a TemplateSpec, this will reference an artifact in the TemplateSpec.  If the parent was linked with a URI, the child deployment will be a combination of the parent and relativePath URIs
        :param pulumi.Input[builtins.str] uri: The URI of the template to deploy. Use either the uri or id property, but not both.
        """
