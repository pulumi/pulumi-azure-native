...
class GetAzurePowerShellScriptResult:
    ...
    def az_power_shell_version(self) -> builtins.str:
        """
...
def get_azure_power_shell_script(resource_group_name: Optional[builtins.str] = None,
...
def get_azure_power_shell_script_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources:getAzurePowerShellScript', __args__, opts=opts, typ=GetAzurePowerShellScriptResult)
    return __ret__.apply(lambda __response__: GetAzurePowerShellScriptResult(
        arguments=pulumi.get(__response__, 'arguments'),
        az_power_shell_version=pulumi.get(__response__, 'az_power_shell_version'),
