...
warnings.warn("""azure-native:resources/v20190510:Resource is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:Resource to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource is deprecated: azure-native:resources/v20190510:Resource is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:Resource to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20190510:getResource', __args__, opts=opts, typ=GetResourceResult).value
