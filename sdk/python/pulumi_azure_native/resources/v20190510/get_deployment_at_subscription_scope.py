...
warnings.warn("""Version 2019-05-10 will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_deployment_at_subscription_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_subscription_scope is deprecated: Version 2019-05-10 will be removed in v2 of the provider.""")
    __args__ = dict()
