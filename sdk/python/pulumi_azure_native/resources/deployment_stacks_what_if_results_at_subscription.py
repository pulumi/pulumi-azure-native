...
@pulumi.type_token("azure-native:resources:DeploymentStacksWhatIfResultsAtSubscription")
class DeploymentStacksWhatIfResultsAtSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeploymentStacksWhatIfResultsAtSubscriptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20250701:DeploymentStacksWhatIfResultsAtSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentStacksWhatIfResultsAtSubscription, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DeploymentStacksWhatIfResultsAtSubscription':
        """
        ...
        __props__.__dict__["type"] = None
        return DeploymentStacksWhatIfResultsAtSubscription(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
