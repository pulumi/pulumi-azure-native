...
def get_deployment_at_management_group_scope(deployment_name: Optional[_builtins.str] = None,
...
def get_deployment_at_management_group_scope_output(deployment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
