...
def get_deployment_at_management_group_scope(deployment_name: Optional[builtins.str] = None,
...
def get_deployment_at_management_group_scope_output(deployment_name: Optional[pulumi.Input[builtins.str]] = None,
