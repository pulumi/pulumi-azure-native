...
def get_deployment_at_scope(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20241101:getDeploymentAtScope', __args__, opts=opts, typ=GetDeploymentAtScopeResult).value
...
def get_deployment_at_scope_output(deployment_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20241101:getDeploymentAtScope', __args__, opts=opts, typ=GetDeploymentAtScopeResult)
