...
def get_tag_at_scope(scope: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20241101:getTagAtScope', __args__, opts=opts, typ=GetTagAtScopeResult).value
...
def get_tag_at_scope_output(scope: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20241101:getTagAtScope', __args__, opts=opts, typ=GetTagAtScopeResult)
