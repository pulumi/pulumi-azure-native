...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20241101:getResource', __args__, opts=opts, typ=GetResourceResult).value
...
def get_resource_output(parent_resource_path: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20241101:getResource', __args__, opts=opts, typ=GetResourceResult)
