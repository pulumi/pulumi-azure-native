...
class TemplateSpec(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20210501:TemplateSpec"), pulumi.Alias(type_="azure-native:resources:TemplateSpec"), pulumi.Alias(type_="azure-nextgen:resources:TemplateSpec"), pulumi.Alias(type_="azure-native:resources/v20190601preview:TemplateSpec"), pulumi.Alias(type_="azure-nextgen:resources/v20190601preview:TemplateSpec"), pulumi.Alias(type_="azure-native:resources/v20210301preview:TemplateSpec"), pulumi.Alias(type_="azure-nextgen:resources/v20210301preview:TemplateSpec")])
