...
warnings.warn("""azure-native:resources/v20210501:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""", DeprecationWarning)
...
class TemplateSpec(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 template_spec_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TemplateSpec is deprecated: azure-native:resources/v20210501:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources:TemplateSpec"), pulumi.Alias(type_="azure-native:resources/v20190601preview:TemplateSpec"), pulumi.Alias(type_="azure-native:resources/v20210301preview:TemplateSpec"), pulumi.Alias(type_="azure-native:resources/v20220201:TemplateSpec")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpec, __self__).__init__(
            'azure-native:resources/v20210501:TemplateSpec',
            resource_name,
            __props__,
            opts)
