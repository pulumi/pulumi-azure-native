...
def get_template_spec(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_template_spec is deprecated: azure-native:resources/v20210501:TemplateSpec is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['resourceGroupName'] = resource_group_name
    __args__['templateSpecName'] = template_spec_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20210501:getTemplateSpec', __args__, opts=opts, typ=GetTemplateSpecResult).value
