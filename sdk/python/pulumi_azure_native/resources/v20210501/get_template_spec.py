...
def get_template_spec(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_template_spec is deprecated: azure-native:resources/v20210501:TemplateSpec is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""")
    __args__ = dict()
