...
def get_resource_group(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_group is deprecated: azure-native:resources/v20201001:ResourceGroup is being removed in the next major version of this provider. Upgrade to at least azure-native:resources/v20220901:ResourceGroup to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20201001:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult).value
