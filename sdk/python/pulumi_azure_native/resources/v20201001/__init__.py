...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:resources/v20201001:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:DeploymentAtManagementGroupScope":
                return DeploymentAtManagementGroupScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:DeploymentAtScope":
                return DeploymentAtScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:DeploymentAtSubscriptionScope":
                return DeploymentAtSubscriptionScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:DeploymentAtTenantScope":
                return DeploymentAtTenantScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:DeploymentScript":
                return DeploymentScript(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:Resource":
                return Resource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:ResourceGroup":
                return ResourceGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20201001:TagAtScope":
    ...
    pulumi.runtime.register_resource_module("azure-native", "resources/v20201001", _module_instance)
