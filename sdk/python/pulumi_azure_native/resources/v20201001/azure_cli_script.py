...
class AzureCliScriptArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'azCliVersion' in kwargs:
            az_cli_version = kwargs['azCliVersion']
        ...
        if 'storageAccountSettings' in kwargs:
        ...
        _setter("az_cli_version", az_cli_version)
        _setter("kind", 'AzureCLI')
...
class AzureCliScript(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AzureCliScriptArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if container_settings is not None and not isinstance(container_settings, ContainerConfigurationArgs):
                container_settings = container_settings or {}
                def _setter(key, value):
                    container_settings[key] = value
                ContainerConfigurationArgs._configure(_setter, **container_settings)
            ...
            if storage_account_settings is not None and not isinstance(storage_account_settings, StorageAccountConfigurationArgs):
                storage_account_settings = storage_account_settings or {}
                def _setter(key, value):
                    storage_account_settings[key] = value
                StorageAccountConfigurationArgs._configure(_setter, **storage_account_settings)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources:AzureCliScript"), pulumi.Alias(type_="azure-native:resources/v20191001preview:AzureCliScript"), pulumi.Alias(type_="azure-native:resources/v20230801:AzureCliScript")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzureCliScript, __self__).__init__(
            'azure-native:resources/v20201001:AzureCliScript',
            resource_name,
            __props__,
            opts)
