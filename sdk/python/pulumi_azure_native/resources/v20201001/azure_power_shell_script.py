...
class AzurePowerShellScriptArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['AzurePowerShellScriptPropertiesArgs'],
        ...
        :param pulumi.Input['AzurePowerShellScriptPropertiesArgs'] properties: Properties of the Azure PowerShell script object.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['AzurePowerShellScriptPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['AzurePowerShellScriptPropertiesArgs']):
...
class AzurePowerShellScript(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['AzurePowerShellScriptPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] kind: Type of the script.
               Expected value is 'AzurePowerShell'.
        :param pulumi.Input[str] location: The location of the ACI and the storage account for the deployment script.
        :param pulumi.Input[pulumi.InputType['AzurePowerShellScriptPropertiesArgs']] properties: Properties of the Azure PowerShell script object.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[str] script_name: Name of the deployment script.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources:AzurePowerShellScript"), pulumi.Alias(type_="azure-native:resources/v20191001preview:AzurePowerShellScript")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AzurePowerShellScript, __self__).__init__(
            'azure-native:resources/v20201001:AzurePowerShellScript',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.AzurePowerShellScriptPropertiesResponse']:
        """
        Properties of the Azure PowerShell script object.
        """
        return pulumi.get(self, "properties")
