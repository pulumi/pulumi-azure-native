...
warnings.warn("""azure-native:resources/v20201001:TagAtScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:TagAtScope to guarantee forwards compatibility.""", DeprecationWarning)
...
class TagAtScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TagAtScope is deprecated: azure-native:resources/v20201001:TagAtScope is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:TagAtScope to guarantee forwards compatibility.""")
