...
def get_deployment(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment is deprecated: azure-native:resources/v20200801:Deployment is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220901:Deployment to guarantee forwards compatibility.""")
    __args__ = dict()
