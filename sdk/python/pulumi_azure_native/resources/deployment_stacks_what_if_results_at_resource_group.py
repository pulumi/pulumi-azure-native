...
@pulumi.type_token("azure-native:resources:DeploymentStacksWhatIfResultsAtResourceGroup")
class DeploymentStacksWhatIfResultsAtResourceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeploymentStacksWhatIfResultsAtResourceGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DeploymentStacksWhatIfResultsAtResourceGroupArgs.__new__(DeploymentStacksWhatIfResultsAtResourceGroupArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20250701:DeploymentStacksWhatIfResultsAtResourceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeploymentStacksWhatIfResultsAtResourceGroup, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DeploymentStacksWhatIfResultsAtResourceGroup':
        """
        ...
        __props__.__dict__["type"] = None
        return DeploymentStacksWhatIfResultsAtResourceGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse']:
        """
        The resource-specific properties for this resource.
        """
        return pulumi.get(self, "properties")
