...
class ResourceGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The location of the resource group. It cannot be changed after the resource group has been created. It must be one of the supported Azure locations.
        :param pulumi.Input[builtins.str] managed_by: The ID of the resource that manages this resource group.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group to create or update. Can include alphanumeric, underscore, parentheses, hyphen, period (except at end), and Unicode characters that match the allowed characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags attached to the resource group.
        """
...
@pulumi.type_token("azure-native:resources:ResourceGroup")
class ResourceGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20151101:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20160201:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20160701:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20160901:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20170510:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20180201:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20180501:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20190301:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20190501:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20190510:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20190701:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20190801:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20191001:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20200601:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20200801:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20201001:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20210101:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20210401:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20220901:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20230701:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20240301:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20240701:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20241101:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20250301:ResourceGroup"), pulumi.Alias(type_="azure-native:resources/v20250401:ResourceGroup")])
