...
class AzureCliScriptArgs:
    def __init__(__self__, *,
                 az_cli_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] az_cli_version: Azure CLI module version to be used.
    ...
    def az_cli_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def az_cli_version(self, value: pulumi.Input[builtins.str]):
...
class AzureCliScript(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 arguments: Optional[pulumi.Input[builtins.str]] = None,
                 az_cli_version: Optional[pulumi.Input[builtins.str]] = None,
                 cleanup_preference: Optional[pulumi.Input[Union[builtins.str, 'CleanupOptions']]] = None,
    ...
    @property
    @pulumi.getter(name="azCliVersion")
    def az_cli_version(self) -> pulumi.Output[builtins.str]:
        """
        Azure CLI module version to be used.
        """
        return pulumi.get(self, "az_cli_version")
