...
class AzurePowerShellScript(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        azure_power_shell_script = azure_native.resources.v20191001preview.AzurePowerShellScript("azurePowerShellScript",
            arguments="-Location 'westus' -Name \\"*rg2\\"",
            az_power_shell_version="1.7.0",
            cleanup_preference="Always",
            identity=azure_native.resources.v20191001preview.ManagedServiceIdentityArgs(
                type="UserAssigned",
        ...
        azure_power_shell_script = azure_native.resources.v20191001preview.AzurePowerShellScript("azurePowerShellScript",
            ...
            az_power_shell_version="1.7.0",
            cleanup_preference="Always",
            container_settings=azure_native.resources.v20191001preview.ContainerConfigurationArgs(
        ...
        azure_power_shell_script = azure_native.resources.v20191001preview.AzurePowerShellScript("azurePowerShellScript",
            ...
            script_content="Param([string]$Location,[string]$Name) $deploymentScriptOutputs['test'] = 'value' Get-AzResourceGroup -Location $Location -Name $Name",
            script_name="MyDeploymentScript",
            storage_account_settings=azure_native.resources.v20191001preview.StorageAccountConfigurationArgs(
