...
def get_azure_cli_script(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/v20191001preview:getAzureCliScript', __args__, opts=opts, typ=GetAzureCliScriptResult).value
...
def get_azure_cli_script_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['scriptName'] = script_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:resources/v20191001preview:getAzureCliScript', __args__, opts=opts, typ=GetAzureCliScriptResult)
