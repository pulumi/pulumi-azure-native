...
class GetAzureCliScriptResult:
    ...
    def az_cli_version(self) -> builtins.str:
        """
    ...
    def cleanup_preference(self) -> Optional[builtins.str]:
        """
    ...
    def primary_script_uri(self) -> Optional[builtins.str]:
        """
    ...
    def script_content(self) -> Optional[builtins.str]:
        """
        Script body.
        """
    ...
    def supporting_script_uris(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_azure_cli_script(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str script_name: Name of the deployment script.
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['scriptName'] = script_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:resources:getAzureCliScript', __args__, opts=opts, typ=GetAzureCliScriptResult).value
...
def get_azure_cli_script_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
