...
def get_azure_cli_script(resource_group_name: Optional[_builtins.str] = None,
...
def get_azure_cli_script_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
