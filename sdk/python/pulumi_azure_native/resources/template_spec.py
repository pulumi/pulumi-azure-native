...
class TemplateSpec(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:resources/v20220201:TemplateSpec"), pulumi.Alias(type_="azure-native_resources_v20190601preview:resources:TemplateSpec"), pulumi.Alias(type_="azure-native_resources_v20210301preview:resources:TemplateSpec"), pulumi.Alias(type_="azure-native_resources_v20210501:resources:TemplateSpec"), pulumi.Alias(type_="azure-native_resources_v20220201:resources:TemplateSpec")])
