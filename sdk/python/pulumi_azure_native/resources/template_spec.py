...
class TemplateSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Template Spec description.
        :param pulumi.Input[builtins.str] display_name: Template Spec display name.
        :param pulumi.Input[builtins.str] location: The location of the Template Spec. It cannot be changed after Template Spec creation. It must be one of the supported Azure locations.
        ...
        :param pulumi.Input[builtins.str] template_spec_name: Name of the Template Spec.
        """
    ...
    def template_spec_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_spec_name(self, value: Optional[pulumi.Input[builtins.str]]):
