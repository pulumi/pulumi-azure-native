...
class TemplateSpec(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 template_spec_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""TemplateSpec is deprecated: azure-native:resources/v20190601preview:TemplateSpec is being removed in the next major version of this provider. Please upgrade to azure-native:resources/v20220201:TemplateSpec to guarantee forwards compatibility.""")
