...
def get_job(job_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: Version v20161101 will be removed in the next major version of the provider. Upgrade to version v20200801 or later.""")
    __args__ = dict()
