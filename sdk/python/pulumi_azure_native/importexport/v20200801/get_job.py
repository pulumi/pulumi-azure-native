...
def get_job(job_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:importexport/v20200801:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:importexport/v20210101:Job to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['jobName'] = job_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:importexport/v20200801:getJob', __args__, opts=opts, typ=GetJobResult).value
