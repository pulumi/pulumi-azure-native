...
class Job(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:importexport:Job"), pulumi.Alias(type_="azure-nextgen:importexport:Job"), pulumi.Alias(type_="azure-native:importexport/latest:Job"), pulumi.Alias(type_="azure-nextgen:importexport/latest:Job"), pulumi.Alias(type_="azure-native:importexport/v20161101:Job"), pulumi.Alias(type_="azure-nextgen:importexport/v20161101:Job"), pulumi.Alias(type_="azure-native:importexport/v20200801:Job"), pulumi.Alias(type_="azure-nextgen:importexport/v20200801:Job")])
