...
def get_job(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:importexport/v20210101:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(job_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:importexport/v20210101:getJob', __args__, opts=opts, typ=GetJobResult)
