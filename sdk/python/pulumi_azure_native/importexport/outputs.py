...
class DeliveryPackageInformationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tracking_number: builtins.str,
                 drive_count: Optional[builtins.float] = None,
                 ship_date: Optional[builtins.str] = None):
        """
        Contains information about the delivery package being shipped by the customer to the Microsoft data center.
        :param builtins.str carrier_name: The name of the carrier that is used to ship the import or export drives.
        :param builtins.str tracking_number: The tracking number of the package.
        :param builtins.float drive_count: The number of drives included in the package.
        :param builtins.str ship_date: The date when the package is shipped.
        """
    ...
    def tracking_number(self) -> builtins.str:
        """
    ...
    def drive_count(self) -> Optional[builtins.float]:
        """
    ...
    def ship_date(self) -> Optional[builtins.str]:
        """
...
class DriveBitLockerKeyResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 bit_locker_key: Optional[builtins.str] = None,
                 drive_id: Optional[builtins.str] = None):
        """
        BitLocker recovery key or password to the specified drive
        :param builtins.str bit_locker_key: BitLocker recovery key or password
        :param builtins.str drive_id: Drive ID
        """
    ...
    def bit_locker_key(self) -> Optional[builtins.str]:
        """
    ...
    def drive_id(self) -> Optional[builtins.str]:
        """
        Drive ID
        """
...
class DriveStatusResponse(dict):
    ...
    def __init__(__self__, *,
                 bit_locker_key: Optional[builtins.str] = None,
                 bytes_succeeded: Optional[builtins.float] = None,
                 copy_status: Optional[builtins.str] = None,
                 drive_header_hash: Optional[builtins.str] = None,
                 drive_id: Optional[builtins.str] = None,
                 error_log_uri: Optional[builtins.str] = None,
                 manifest_file: Optional[builtins.str] = None,
                 manifest_hash: Optional[builtins.str] = None,
                 manifest_uri: Optional[builtins.str] = None,
                 percent_complete: Optional[builtins.float] = None,
                 state: Optional[builtins.str] = None,
                 verbose_log_uri: Optional[builtins.str] = None):
        """
        Provides information about the drive's status
        :param builtins.str bit_locker_key: The BitLocker key used to encrypt the drive.
        :param builtins.float bytes_succeeded: Bytes successfully transferred for the drive.
        :param builtins.str copy_status: Detailed status about the data transfer process. This field is not returned in the response until the drive is in the Transferring state.
        :param builtins.str drive_header_hash: The drive header hash value.
        :param builtins.str drive_id: The drive's hardware serial number, without spaces.
        :param builtins.str error_log_uri: A URI that points to the blob containing the error log for the data transfer operation.
        :param builtins.str manifest_file: The relative path of the manifest file on the drive. 
        :param builtins.str manifest_hash: The Base16-encoded MD5 hash of the manifest file on the drive.
        :param builtins.str manifest_uri: A URI that points to the blob containing the drive manifest file. 
        :param builtins.float percent_complete: Percentage completed for the drive. 
        :param builtins.str state: The drive's current state. 
        :param builtins.str verbose_log_uri: A URI that points to the blob containing the verbose log for the data transfer operation. 
        """
        if bit_locker_key is not None:
            pulumi.set(__self__, "bit_locker_key", bit_locker_key)
    ...
    def bytes_succeeded(self) -> Optional[builtins.float]:
        """
    ...
    def copy_status(self) -> Optional[builtins.str]:
        """
    ...
    def drive_header_hash(self) -> Optional[builtins.str]:
        """
    ...
    def error_log_uri(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_file(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_hash(self) -> Optional[builtins.str]:
        """
    ...
    def manifest_uri(self) -> Optional[builtins.str]:
        """
    ...
    def percent_complete(self) -> Optional[builtins.float]:
        """
    ...
    def verbose_log_uri(self) -> Optional[builtins.str]:
        """
...
class EncryptionKeyDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the encryption key properties
        :param builtins.str kek_type: The type of kek encryption key
        :param builtins.str kek_url: Specifies the url for kek encryption key. 
        :param builtins.str kek_vault_resource_id: Specifies the keyvault resource id for kek encryption key. 
        """
        if kek_type is None:
    ...
    def kek_type(self) -> Optional[builtins.str]:
        """
...
class ExportResponse(dict):
    ...
    def __init__(__self__, *,
                 blob_list_blob_path: Optional[builtins.str] = None,
                 blob_path: Optional[Sequence[builtins.str]] = None,
                 blob_path_prefix: Optional[Sequence[builtins.str]] = None):
        """
        A property containing information about the blobs to be exported for an export job. This property is required for export jobs, but must not be specified for import jobs.
        :param builtins.str blob_list_blob_path: The relative URI to the block blob that contains the list of blob paths or blob path prefixes as defined above, beginning with the container name. If the blob is in root container, the URI must begin with $root. 
        :param Sequence[builtins.str] blob_path: A collection of blob-path strings.
        :param Sequence[builtins.str] blob_path_prefix: A collection of blob-prefix strings.
        """
    ...
    def blob_list_blob_path(self) -> Optional[builtins.str]:
        """
    ...
    def blob_path(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def blob_path_prefix(self) -> Optional[Sequence[builtins.str]]:
        """
...
class IdentityDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the identity properties. 
        :param builtins.str principal_id: Specifies the principal id for the identity for the job. 
        :param builtins.str tenant_id: Specifies the tenant id for the identity for the job. 
        :param builtins.str type: The type of identity
        """
...
class JobDetailsResponse(dict):
    ...
    def __init__(__self__, *,
                 backup_drive_manifest: Optional[builtins.bool] = None,
                 cancel_requested: Optional[builtins.bool] = None,
                 delivery_package: Optional['outputs.DeliveryPackageInformationResponse'] = None,
                 diagnostics_path: Optional[builtins.str] = None,
                 ...
                 incomplete_blob_list_uri: Optional[builtins.str] = None,
        ...
        """
        Specifies the job properties
        :param builtins.bool backup_drive_manifest: Default value is false. Indicates whether the manifest files on the drives should be copied to block blobs.
        :param builtins.bool cancel_requested: Indicates whether a request has been submitted to cancel the job.
        ...
        :param builtins.str diagnostics_path: The virtual blob directory to which the copy logs and backups of drive manifest files (if enabled) will be stored.
        ...
        :param builtins.str incomplete_blob_list_uri: A blob path that points to a block blob containing a list of blob names that were not exported due to insufficient drive space. If all blobs were exported successfully, then this element is not included in the response.
        :param builtins.str job_type: The type of job
        :param builtins.str log_level: Default value is Error. Indicates whether error logging or verbose logging will be enabled.
        :param builtins.float percent_complete: Overall percentage completed for the job.
        :param builtins.str provisioning_state: Specifies the provisioning state of the job.
        ...
        :param builtins.str state: Current state of the job.
        :param builtins.str storage_account_id: The resource identifier of the storage account where data will be imported to or exported from.
        """
    ...
    def backup_drive_manifest(self) -> Optional[builtins.bool]:
        """
    ...
    def cancel_requested(self) -> Optional[builtins.bool]:
        """
    ...
    def diagnostics_path(self) -> Optional[builtins.str]:
        """
    ...
    def incomplete_blob_list_uri(self) -> Optional[builtins.str]:
        """
    ...
    def job_type(self) -> Optional[builtins.str]:
        """
        The type of job
        """
...
class PackageInformationResponse(dict):
    ...
    def __init__(__self__, *,
                 carrier_name: builtins.str,
                 drive_count: builtins.float,
                 ship_date: builtins.str,
                 tracking_number: builtins.str):
        """
        Contains information about the package being shipped by the customer to the Microsoft data center.
        :param builtins.str carrier_name: The name of the carrier that is used to ship the import or export drives.
    ...
    @property
    @pulumi.getter(name="driveCount")
    def drive_count(self) -> builtins.float:
        """
        The number of drives included in the package.
        """
        return pulumi.get(self, "drive_count")
    ...
    @property
    @pulumi.getter(name="shipDate")
    def ship_date(self) -> builtins.str:
        """
        The date when the package is shipped.
        """
        return pulumi.get(self, "ship_date")
...
class ReturnAddressResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the return address information for the job.
        :param builtins.str city: The city name to use when returning the drives.
        :param builtins.str country_or_region: The country or region to use when returning the drives. 
        :param builtins.str email: Email address of the recipient of the returned drives.
        :param builtins.str phone: Phone number of the recipient of the returned drives.
        :param builtins.str postal_code: The postal code to use when returning the drives.
        :param builtins.str recipient_name: The name of the recipient who will receive the hard drives when they are returned. 
        :param builtins.str street_address1: The first line of the street address to use when returning the drives. 
        :param builtins.str state_or_province: The state or province to use when returning the drives.
        :param builtins.str street_address2: The second line of the street address to use when returning the drives. 
        """
    ...
    def recipient_name(self) -> builtins.str:
        """
...
class ReturnShippingResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Specifies the return carrier and customer's account with the carrier.
        :param builtins.str carrier_account_number: The customer's account number with the carrier.
        :param builtins.str carrier_name: The carrier's name.
        """
...
class ShippingInformationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 recipient_name: Optional[builtins.str] = None,
                 state_or_province: Optional[builtins.str] = None,
                 street_address1: Optional[builtins.str] = None,
                 street_address2: Optional[builtins.str] = None):
        """
        Contains information about the Microsoft datacenter to which the drives should be shipped.
        :param builtins.str additional_information: Additional shipping information for customer, specific to datacenter to which customer should send their disks.
        :param builtins.str city: The city name to use when returning the drives.
        :param builtins.str country_or_region: The country or region to use when returning the drives. 
        :param builtins.str phone: Phone number of the recipient of the returned drives.
        :param builtins.str postal_code: The postal code to use when returning the drives.
    ...
    @property
    @pulumi.getter(name="recipientName")
    def recipient_name(self) -> Optional[builtins.str]:
        """
        The name of the recipient who will receive the hard drives when they are returned. 
        """
        return pulumi.get(self, "recipient_name")
