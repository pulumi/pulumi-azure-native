...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] provider_sku: The sku associated with pricing information for this provider.
        :param pulumi.Input[Union[_builtins.str, 'ProviderStatus']] provisioning_state: Provisioning status field
        :param pulumi.Input[_builtins.str] resource_usage_id: Id to track resource usage for the provider.
        """
...
class WorkspaceResourcePropertiesArgsDict(TypedDict):
    ...
    """
    providers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ProviderArgs']]]]]
    """
