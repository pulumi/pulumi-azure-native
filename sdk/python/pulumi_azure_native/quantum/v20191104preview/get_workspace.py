...
warnings.warn("""azure-native:quantum/v20191104preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:quantum/v20220110preview:Workspace to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: azure-native:quantum/v20191104preview:Workspace is being removed in the next major version of this provider. Upgrade to at least azure-native:quantum/v20220110preview:Workspace to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:quantum/v20191104preview:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
