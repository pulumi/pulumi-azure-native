...
warnings.warn("""Version 2019-11-04-preview will be removed in v2 of the provider.""", DeprecationWarning)
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: Version 2019-11-04-preview will be removed in v2 of the provider.""")
    __args__ = dict()
