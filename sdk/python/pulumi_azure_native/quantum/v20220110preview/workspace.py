...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if identity is not None and not isinstance(identity, QuantumWorkspaceIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                QuantumWorkspaceIdentityArgs._configure(_setter, **identity)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:quantum:Workspace"), pulumi.Alias(type_="azure-native:quantum/v20191104preview:Workspace")])
