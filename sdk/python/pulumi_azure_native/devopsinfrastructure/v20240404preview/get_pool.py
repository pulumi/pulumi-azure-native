...
def get_pool(pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devopsinfrastructure/v20240404preview:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devopsinfrastructure/v20240404preview:getPool', __args__, opts=opts, typ=GetPoolResult)
