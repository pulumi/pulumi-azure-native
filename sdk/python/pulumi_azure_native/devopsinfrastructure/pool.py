...
class PoolArgs:
    def __init__(__self__, *,
                 ...
                 dev_center_project_resource_id: pulumi.Input[builtins.str],
                 fabric_profile: pulumi.Input['VmssFabricProfileArgs'],
                 maximum_concurrency: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] dev_center_project_resource_id: The resource id of the DevCenter Project the pool belongs to.
        :param pulumi.Input['VmssFabricProfileArgs'] fabric_profile: Defines the type of fabric the agent will run on.
        :param pulumi.Input[builtins.int] maximum_concurrency: Defines how many resources can there be created at any given time.
        ...
        :param pulumi.Input[builtins.str] pool_name: Name of the pool. It needs to be globally unique.
        :param pulumi.Input[Union[builtins.str, 'ProvisioningState']] provisioning_state: The status of the current operation.
    ...
    def dev_center_project_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dev_center_project_resource_id(self, value: pulumi.Input[builtins.str]):
    ...
    def maximum_concurrency(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def maximum_concurrency(self, value: pulumi.Input[builtins.int]):
...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dev_center_project_resource_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="devCenterProjectResourceId")
    def dev_center_project_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource id of the DevCenter Project the pool belongs to.
        """
        return pulumi.get(self, "dev_center_project_resource_id")
    ...
    @property
    @pulumi.getter(name="maximumConcurrency")
    def maximum_concurrency(self) -> pulumi.Output[builtins.int]:
        """
        Defines how many resources can there be created at any given time.
        """
        return pulumi.get(self, "maximum_concurrency")
