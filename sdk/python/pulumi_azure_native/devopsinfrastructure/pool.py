...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devopsinfrastructure/v20231030preview:Pool"), pulumi.Alias(type_="azure-native:devopsinfrastructure/v20231213preview:Pool"), pulumi.Alias(type_="azure-native:devopsinfrastructure/v20240326preview:Pool"), pulumi.Alias(type_="azure-native:devopsinfrastructure/v20240404preview:Pool"), pulumi.Alias(type_="azure-native:devopsinfrastructure/v20241019:Pool"), pulumi.Alias(type_="azure-native:devopsinfrastructure/v20250121:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20231030preview:devopsinfrastructure:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20231213preview:devopsinfrastructure:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20240326preview:devopsinfrastructure:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20240404preview:devopsinfrastructure:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20241019:devopsinfrastructure:Pool"), pulumi.Alias(type_="azure-native_devopsinfrastructure_v20250121:devopsinfrastructure:Pool")])
