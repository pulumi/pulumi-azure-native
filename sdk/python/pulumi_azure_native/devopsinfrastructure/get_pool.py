...
def get_pool(pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pool_name: Name of the pool. It needs to be globally unique.
...
def get_pool_output(pool_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
