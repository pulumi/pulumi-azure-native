...
warnings.warn("""Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.""", DeprecationWarning)
...
class Budget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 time_period: Optional[pulumi.Input[pulumi.InputType['BudgetTimePeriodArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Budget is deprecated: Version v20190601 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.""")
        if opts is None:
