...
def get_budget(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget is deprecated: azure-native:consumption/v20210501:Budget is being removed in the next major version of this provider. Please upgrade to azure-native:consumption/v20220901:Budget to guarantee forwards compatibility.""")
    __args__ = dict()
