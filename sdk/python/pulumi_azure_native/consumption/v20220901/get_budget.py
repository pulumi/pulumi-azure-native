...
warnings.warn("""azure-native:consumption/v20220901:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20230501:Budget to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_budget(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget is deprecated: azure-native:consumption/v20220901:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20230501:Budget to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['budgetName'] = budget_name
    __args__['scope'] = scope
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:consumption/v20220901:getBudget', __args__, opts=opts, typ=GetBudgetResult).value
