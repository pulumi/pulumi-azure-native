...
def get_budget(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget is deprecated: Version v20181001 will be removed in the next major version of the provider. Upgrade to version v20191001 or later.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:consumption/v20181001:getBudget', __args__, opts=opts, typ=GetBudgetResult).value
