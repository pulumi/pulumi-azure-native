...
azure-native:consumption/v20180831:BudgetByResourceGroupName is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20181001:BudgetByResourceGroupName to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_budget_by_resource_group_name(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget_by_resource_group_name is deprecated: Version 2018-08-31 will be removed in v2 of the provider.
azure-native:consumption/v20180831:BudgetByResourceGroupName is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20181001:BudgetByResourceGroupName to guarantee forwards compatibility.""")
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:consumption/v20180831:getBudgetByResourceGroupName', __args__, opts=opts, typ=GetBudgetByResourceGroupNameResult).value
