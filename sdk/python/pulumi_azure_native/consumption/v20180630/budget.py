...
azure-native:consumption/v20180630:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20181001:Budget to guarantee forwards compatibility.""", DeprecationWarning)
...
azure-native:consumption/v20180630:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20181001:Budget to guarantee forwards compatibility.""", DeprecationWarning)
    ...
    def _internal_init(__self__,
                 ...
                 time_period: Optional[pulumi.Input[pulumi.InputType['BudgetTimePeriodArgs']]] = None,
                 __props__=None):
        pulumi.log.warn("""Budget is deprecated: Version 2018-06-30 will be removed in v2 of the provider.
azure-native:consumption/v20180630:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20181001:Budget to guarantee forwards compatibility.""")
        ...
        super(Budget, __self__).__init__(
            'azure-native:consumption/v20180630:Budget',
            resource_name,
            __props__,
            opts)
