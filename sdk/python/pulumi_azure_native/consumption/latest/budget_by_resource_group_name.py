...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:consumption:BudgetByResourceGroupName'.""", DeprecationWarning)
...
class BudgetByResourceGroupName(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(BudgetByResourceGroupName, __self__).__init__(
            'azure-native:consumption/latest:BudgetByResourceGroupName',
            resource_name,
            __props__,
            opts)
