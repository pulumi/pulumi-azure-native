...
warnings.warn("""azure-native:consumption/v20191101:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20230501:Budget to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_budget(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget is deprecated: azure-native:consumption/v20191101:Budget is being removed in the next major version of this provider. Upgrade to at least azure-native:consumption/v20230501:Budget to guarantee forwards compatibility.""")
    __args__ = dict()
