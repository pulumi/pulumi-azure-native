...
class Association(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customproviders:Association"), pulumi.Alias(type_="azure-native:customproviders/v20180901preview:Association"), pulumi.Alias(type_="azure-nextgen:customproviders/v20180901preview:Association")])
