...
class AssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of the association. The scope can be any valid REST resource instance. For example, use '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{vm-name}' for a virtual machine resource.
        :param pulumi.Input[builtins.str] association_name: The name of the association.
        :param pulumi.Input[builtins.str] target_resource_id: The REST resource instance of the target resource for this association.
        """
