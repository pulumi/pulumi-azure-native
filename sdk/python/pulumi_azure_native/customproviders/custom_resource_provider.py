...
class CustomResourceProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:customproviders/v20180901preview:CustomResourceProvider"), pulumi.Alias(type_="azure-native_customproviders_v20180901preview:customproviders:CustomResourceProvider")])
