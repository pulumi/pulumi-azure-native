...
class CustomResourceProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_provider_name: The name of the resource provider.
    ...
    def resource_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
