...
def get_association(association_name: Optional[_builtins.str] = None,
...
def get_association_output(association_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
