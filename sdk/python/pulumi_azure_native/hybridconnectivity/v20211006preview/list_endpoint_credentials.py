...
def list_endpoint_credentials_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridconnectivity/v20211006preview:listEndpointCredentials', __args__, opts=opts, typ=ListEndpointCredentialsResult)
