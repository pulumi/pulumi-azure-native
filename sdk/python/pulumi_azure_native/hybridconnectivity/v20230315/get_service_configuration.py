...
def get_service_configuration(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridconnectivity/v20230315:getServiceConfiguration', __args__, opts=opts, typ=GetServiceConfigurationResult).value
...
def get_service_configuration_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceConfigurationName'] = service_configuration_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridconnectivity/v20230315:getServiceConfiguration', __args__, opts=opts, typ=GetServiceConfigurationResult)
