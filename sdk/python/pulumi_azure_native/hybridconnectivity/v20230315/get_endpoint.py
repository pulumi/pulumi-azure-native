...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridconnectivity/v20230315:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
...
def get_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceUri'] = resource_uri
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridconnectivity/v20230315:getEndpoint', __args__, opts=opts, typ=GetEndpointResult)
