...
class GetEndpointResult:
    ...
    """
    def __init__(__self__, id=None, name=None, provisioning_state=None, resource_id=None, system_data=None, type=None):
...
def get_endpoint_output(endpoint_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:hybridconnectivity/v20241201:getEndpoint', __args__, opts=opts, typ=GetEndpointResult)
