...
def get_public_cloud_connector(public_cloud_connector: Optional[_builtins.str] = None,
...
def get_public_cloud_connector_output(public_cloud_connector: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
