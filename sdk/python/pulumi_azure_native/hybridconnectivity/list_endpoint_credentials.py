...
def list_endpoint_credentials(endpoint_name: Optional[_builtins.str] = None,
                              expiresin: Optional[_builtins.int] = None,
    ...
    :param Union[_builtins.str, 'ServiceName'] service_name: The name of the service. If not provided, the request will by pass the generation of service configuration token
    """
    __args__ = dict()
...
def list_endpoint_credentials_output(endpoint_name: Optional[pulumi.Input[_builtins.str]] = None,
