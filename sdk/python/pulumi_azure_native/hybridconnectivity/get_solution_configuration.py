...
def get_solution_configuration(resource_uri: Optional[_builtins.str] = None,
                               solution_configuration: Optional[_builtins.str] = None,
...
def get_solution_configuration_output(resource_uri: pulumi.Input[Optional[_builtins.str]] = None,
                                      solution_configuration: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
