...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if pool_type is not None and not isinstance(pool_type, PoolTypeArgs):
                pool_type = pool_type or {}
                def _setter(key, value):
                    pool_type[key] = value
                PoolTypeArgs._configure(_setter, **pool_type)
            ...
            if resources is not None and not isinstance(resources, ResourcesArgs):
                resources = resources or {}
                def _setter(key, value):
                    resources[key] = value
                ResourcesArgs._configure(_setter, **resources)
