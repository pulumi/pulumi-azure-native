...
class PoolArgs:
    ...
    def _configure(
             ...
             pool_type: Optional[pulumi.Input['PoolTypeArgs']] = None,
...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            pool_type = _utilities.configure(pool_type, PoolTypeArgs, True)
            ...
            resources = _utilities.configure(resources, ResourcesArgs, True)
