...
class AssignmentResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Assignment Properties
        :param builtins.str id: Resource id for the assigned resource
...
class AssignmentStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Status of the assignment resource
        :param builtins.str state: State of the assignment resource
        :param builtins.str message: Reason for the status
        """
...
class AzureDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Azure Disk Pool Properties
        :param builtins.str resource_group: Managed resource group for the pool.
        ...
        :param builtins.str sku_name: Sku name
        """
...
class DiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Model for disk for that pool is using
        :param builtins.str id: ID is the disk identifier visible to the OS. It is typically the WWN or disk ID in formats such as eui.e8238fa6bf530001001b448b45263379 or 0x5002cf6cbc5dd460
        :param builtins.str reference: Reference is the location of the disk in an external system.
        """
        pulumi.set(__self__, "id", id)
...
class ElasticSanVolumePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 target_iqn: builtins.str,
                 target_portal_hostname: builtins.str,
                 target_portal_port: builtins.int):
        """
        Properties of the ElasticSAN iSCSI target
        :param builtins.str target_iqn: iSCSI Target IQN (iSCSI Qualified Name); example: "iqn.2005-03.org.iscsi:server"
        :param builtins.str target_portal_hostname: iSCSI Target Portal Host Name
        :param builtins.int target_portal_port: iSCSI Target Portal Port
        """
    ...
    def target_portal_port(self) -> builtins.int:
        """
...
class EphemeralDiskResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        Ephemeral Disk Pool Properties
        :param Sequence['DiskResponse'] disks: Only required if individual disk selection is desired. Path to disk, e.g. <nodename>:/dev/sda or WWN. Supports specifying multiple disks (same syntax as tags).
        :param builtins.float replicas: The number of data copies. Default 3.
        """
        if disks is not None:
            pulumi.set(__self__, "disks", disks)
        if replicas is None:
...
class RequestsResponse(dict):
    ...
    """
    def __init__(__self__, *,
                 storage: Optional[builtins.float] = None):
        """
        Requests for capacity for the pool.
        :param builtins.float storage: Requested capacity of the pool in GiB.
        """
        if storage is None:
            storage = 1024
    ...
    @property
    @pulumi.getter
    def storage(self) -> Optional[builtins.float]:
        """
...
class ResourceOperationalStatusResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Status of the resource
        :param builtins.str state: state of the resource
        :param builtins.str message: Reason for state.
        """
        pulumi.set(__self__, "state", state)
        if message is not None:
            pulumi.set(__self__, "message", message)
