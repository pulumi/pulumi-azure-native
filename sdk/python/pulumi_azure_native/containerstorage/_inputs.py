...
class AssignmentArgs:
    def __init__(__self__, *,
        ...
        """
        Assignment Properties
        :param pulumi.Input[builtins.str] id: Resource id for the assigned resource
        """
...
if not MYPY:
    class AzureDiskArgsDict(TypedDict):
        ...
        """
        sku_name: NotRequired[pulumi.Input[Union[builtins.str, 'AzureDiskSkuName']]]
        """
        Sku name
        """
elif False:
...
class AzureDiskArgs:
    def __init__(__self__, *,
                 ...
                 sku_name: Optional[pulumi.Input[Union[builtins.str, 'AzureDiskSkuName']]] = None):
        """
        Azure Disk Pool Properties
        ...
        :param pulumi.Input[Union[builtins.str, 'AzureDiskSkuName']] sku_name: Sku name
        """
    ...
    def sku_name(self) -> Optional[pulumi.Input[Union[builtins.str, 'AzureDiskSkuName']]]:
        """
        Sku name
        """
    ...
    @sku_name.setter
    def sku_name(self, value: Optional[pulumi.Input[Union[builtins.str, 'AzureDiskSkuName']]]):
...
class DiskArgs:
    def __init__(__self__, *,
        ...
        """
        Model for disk for that pool is using
        :param pulumi.Input[builtins.str] id: ID is the disk identifier visible to the OS. It is typically the WWN or disk ID in formats such as eui.e8238fa6bf530001001b448b45263379 or 0x5002cf6cbc5dd460
        :param pulumi.Input[builtins.str] reference: Reference is the location of the disk in an external system.
        """
        pulumi.set(__self__, "id", id)
...
if not MYPY:
    class ElasticSanArgsDict(TypedDict):
        ...
        Encryption specifies the encryption configuration for the Azure Disk pool
        """
        sku_name: NotRequired[pulumi.Input[Union[builtins.str, 'ElasticSanSkuName']]]
        """
        Sku name
        """
elif False:
...
class ElasticSanArgs:
    def __init__(__self__, *,
                 encryption: Optional[pulumi.Input['EncryptionArgs']] = None,
                 sku_name: Optional[pulumi.Input[Union[builtins.str, 'ElasticSanSkuName']]] = None):
        """
        Elastic San Pool Properties
        :param pulumi.Input['EncryptionArgs'] encryption: Encryption specifies the encryption configuration for the Azure Disk pool
        :param pulumi.Input[Union[builtins.str, 'ElasticSanSkuName']] sku_name: Sku name
        """
        if encryption is not None:
            pulumi.set(__self__, "encryption", encryption)
        if sku_name is not None:
    ...
    @property
    @pulumi.getter(name="skuName")
    def sku_name(self) -> Optional[pulumi.Input[Union[builtins.str, 'ElasticSanSkuName']]]:
        """
        Sku name
        """
        return pulumi.get(self, "sku_name")
    ...
    @sku_name.setter
    def sku_name(self, value: Optional[pulumi.Input[Union[builtins.str, 'ElasticSanSkuName']]]):
        pulumi.set(self, "sku_name", value)
...
class EphemeralDiskArgs:
    def __init__(__self__, *,
        ...
        Ephemeral Disk Pool Properties
        :param pulumi.Input[Sequence[pulumi.Input['DiskArgs']]] disks: Only required if individual disk selection is desired. Path to disk, e.g. <nodename>:/dev/sda or WWN. Supports specifying multiple disks (same syntax as tags).
        :param pulumi.Input[builtins.float] replicas: The number of data copies. Default 3.
        """
        if disks is not None:
            pulumi.set(__self__, "disks", disks)
        if replicas is None:
...
if not MYPY:
    class RequestsArgsDict(TypedDict):
        ...
        """
        storage: NotRequired[pulumi.Input[builtins.float]]
        """
...
class RequestsArgs:
    def __init__(__self__, *,
                 storage: Optional[pulumi.Input[builtins.float]] = None):
        """
        Requests for capacity for the pool.
        :param pulumi.Input[builtins.float] storage: Requested capacity of the pool in GiB.
        """
        if storage is None:
            storage = 1024
    ...
    @property
    @pulumi.getter
    def storage(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Requested capacity of the pool in GiB.
        """
    ...
    @storage.setter
    def storage(self, value: Optional[pulumi.Input[builtins.float]]):
