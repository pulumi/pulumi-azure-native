...
class GetSnapshotResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, name=None, provisioning_state=None, source=None, status=None, system_data=None, type=None):
...
def get_snapshot(pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str snapshot_name: Volume Snapshot Resource
    """
    __args__ = dict()
...
def get_snapshot_output(pool_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:containerstorage:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult)
