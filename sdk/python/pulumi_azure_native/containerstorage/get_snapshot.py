...
def get_snapshot(pool_name: Optional[builtins.str] = None,
    ...
    :param builtins.str snapshot_name: Volume Snapshot Resource
    """
    __args__ = dict()
...
def get_snapshot_output(pool_name: Optional[pulumi.Input[builtins.str]] = None,
