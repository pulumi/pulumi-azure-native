...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        pool = azure_native.containerstorage.Pool("pool",
            ...
            ephemeral_pool_properties=azure_native.containerstorage.EphemeralPoolPropertiesResponseArgs(
                disk_format=True,
                disk_selector=["nvpe"],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:containerstorage/v20230301preview:Pool")])
