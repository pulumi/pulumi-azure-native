...
class ClusterManagerArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if fabric_controller_id is None and 'fabricControllerId' in kwargs:
            fabric_controller_id = kwargs['fabricControllerId']
        if fabric_controller_id is None:
            raise TypeError("Missing 'fabric_controller_id' argument")
        ...
        if cluster_manager_name is None and 'clusterManagerName' in kwargs:
