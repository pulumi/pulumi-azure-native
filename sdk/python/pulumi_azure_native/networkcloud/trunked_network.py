...
class TrunkedNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        TrunkedNetworkArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            extended_location=extended_location,
            isolation_domain_ids=isolation_domain_ids,
    ...
    def _configure(
        ...
        if isolation_domain_ids is None and 'isolationDomainIds' in kwargs:
            isolation_domain_ids = kwargs['isolationDomainIds']
        if isolation_domain_ids is None:
            raise TypeError("Missing 'isolation_domain_ids' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if vlans is None:
            raise TypeError("Missing 'vlans' argument")
        ...
        if trunked_network_name is None and 'trunkedNetworkName' in kwargs:
            trunked_network_name = kwargs['trunkedNetworkName']

        _setter("extended_location", extended_location)
        _setter("isolation_domain_ids", isolation_domain_ids)
        ...
        if trunked_network_name is not None:
            _setter("trunked_network_name", trunked_network_name)
...
class TrunkedNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TrunkedNetworkArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:TrunkedNetwork")])
