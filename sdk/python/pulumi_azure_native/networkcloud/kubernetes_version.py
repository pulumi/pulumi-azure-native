...
class KubernetesVersionArgs:
    ...
    def kubernetes_version_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def kubernetes_version_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("azure-native:networkcloud:KubernetesVersion")
class KubernetesVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param KubernetesVersionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KubernetesVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KubernetesVersionArgs.__new__(KubernetesVersionArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'KubernetesVersion':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["values"] = None
        return KubernetesVersion(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def values(self) -> pulumi.Output[Sequence['outputs.KubernetesVersionValueResponse']]:
        """
