...
def get_rack(rack_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rack_name: The name of the rack.
...
def get_rack_output(rack_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
