...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:Volume"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:Volume"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:Volume"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:Volume")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Volume, __self__).__init__(
            'azure-native:networkcloud/v20240701:Volume',
            resource_name,
            __props__,
            opts)
