...
def get_console(console_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20240701:getConsole', __args__, opts=opts, typ=GetConsoleResult).value
...
def get_console_output(console_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['virtualMachineName'] = virtual_machine_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20240701:getConsole', __args__, opts=opts, typ=GetConsoleResult)
