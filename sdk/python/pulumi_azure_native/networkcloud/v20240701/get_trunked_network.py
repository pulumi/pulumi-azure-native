...
def get_trunked_network(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20240701:getTrunkedNetwork', __args__, opts=opts, typ=GetTrunkedNetworkResult).value
...
def get_trunked_network_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['trunkedNetworkName'] = trunked_network_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20240701:getTrunkedNetwork', __args__, opts=opts, typ=GetTrunkedNetworkResult)
