...
class GetTrunkedNetworkResult:
    ...
    def hybrid_aks_plugin_type(self) -> Optional[builtins.str]:
        """
    ...
    def isolation_domain_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def vlans(self) -> Sequence[builtins.float]:
        """
...
def get_trunked_network(resource_group_name: Optional[builtins.str] = None,
                        trunked_network_name: Optional[builtins.str] = None,
    ...
    :param builtins.str trunked_network_name: The name of the trunked network.
    """
    __args__ = dict()
...
def get_trunked_network_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
