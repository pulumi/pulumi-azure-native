...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 cpu_cores: pulumi.Input[builtins.float],
                 extended_location: pulumi.Input['ExtendedLocationArgs'],
                 memory_size_gb: pulumi.Input[builtins.float],
                 resource_group_name: pulumi.Input[builtins.str],
                 storage_profile: pulumi.Input['StorageProfileArgs'],
                 vm_image: pulumi.Input[builtins.str],
                 boot_method: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineBootMethod']]] = None,
                 console_extended_location: Optional[pulumi.Input['ExtendedLocationArgs']] = None,
                 isolate_emulator_thread: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineIsolateEmulatorThread']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 network_attachments: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkAttachmentArgs']]]] = None,
                 network_data: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 virtio_interface: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineVirtioInterfaceType']]] = None,
                 virtual_machine_name: Optional[pulumi.Input[builtins.str]] = None,
                 vm_device_model: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineDeviceModelType']]] = None,
                 vm_image_repository_credentials: Optional[pulumi.Input['ImageRepositoryCredentialsArgs']] = None):
        """
        The set of arguments for constructing a VirtualMachine resource.
        :param pulumi.Input[builtins.str] admin_username: The name of the administrator to which the ssh public keys will be added into the authorized keys.
        ...
        :param pulumi.Input[builtins.float] cpu_cores: The number of CPU cores in the virtual machine.
        ...
        :param pulumi.Input[builtins.float] memory_size_gb: The memory size of the virtual machine. Allocations are measured in gibibytes.
        ...
        :param pulumi.Input[builtins.str] vm_image: The virtual machine image that is currently provisioned to the OS disk, using the full url and tag notation used to pull the image.
        :param pulumi.Input[Union[builtins.str, 'VirtualMachineBootMethod']] boot_method: Selects the boot method for the virtual machine.
        ...
        :param pulumi.Input[Union[builtins.str, 'VirtualMachineIsolateEmulatorThread']] isolate_emulator_thread: Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
        ...
        :param pulumi.Input[builtins.str] network_data: The Base64 encoded cloud-init network data.
        ...
        :param pulumi.Input[builtins.str] user_data: The Base64 encoded cloud-init user data.
        :param pulumi.Input[Union[builtins.str, 'VirtualMachineVirtioInterfaceType']] virtio_interface: Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
        :param pulumi.Input[builtins.str] virtual_machine_name: The name of the virtual machine.
        :param pulumi.Input[Union[builtins.str, 'VirtualMachineDeviceModelType']] vm_device_model: The type of the device model to use.
    ...
    def cpu_cores(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @cpu_cores.setter
    def cpu_cores(self, value: pulumi.Input[builtins.float]):
    ...
    def memory_size_gb(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def memory_size_gb(self, value: pulumi.Input[builtins.float]):
    ...
    def boot_method(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineBootMethod']]]:
        """
    ...
    @boot_method.setter
    def boot_method(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineBootMethod']]]):
    ...
    def isolate_emulator_thread(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineIsolateEmulatorThread']]]:
        """
    ...
    def isolate_emulator_thread(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineIsolateEmulatorThread']]]):
    ...
    def network_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @network_data.setter
    def network_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def virtio_interface(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineVirtioInterfaceType']]]:
        """
    ...
    def virtio_interface(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineVirtioInterfaceType']]]):
    ...
    def vm_device_model(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineDeviceModelType']]]:
        """
    ...
    def vm_device_model(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineDeviceModelType']]]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cpu_cores: Optional[pulumi.Input[builtins.float]] = None,
                 extended_location: Optional[pulumi.Input[Union['ExtendedLocationArgs', 'ExtendedLocationArgsDict']]] = None,
                 isolate_emulator_thread: Optional[pulumi.Input[Union[builtins.str, 'VirtualMachineIsolateEmulatorThread']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 memory_size_gb: Optional[pulumi.Input[builtins.float]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:VirtualMachine")])
    ...
    def bare_metal_machine_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="bootMethod")
    def boot_method(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Selects the boot method for the virtual machine.
        """
        return pulumi.get(self, "boot_method")
    ...
    @property
    @pulumi.getter(name="cpuCores")
    def cpu_cores(self) -> pulumi.Output[builtins.float]:
        """
        The number of CPU cores in the virtual machine.
        """
        return pulumi.get(self, "cpu_cores")
    ...
    @property
    @pulumi.getter(name="isolateEmulatorThread")
    def isolate_emulator_thread(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
        """
        return pulumi.get(self, "isolate_emulator_thread")
    ...
    @property
    @pulumi.getter(name="networkData")
    def network_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Base64 encoded cloud-init network data.
        """
        return pulumi.get(self, "network_data")
    ...
    @property
    @pulumi.getter(name="virtioInterface")
    def virtio_interface(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
        """
        return pulumi.get(self, "virtio_interface")
    ...
    @property
    @pulumi.getter(name="vmDeviceModel")
    def vm_device_model(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the device model to use.
        """
        return pulumi.get(self, "vm_device_model")
    ...
    @property
    @pulumi.getter
    def volumes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
