...
class VirtualMachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'VirtualMachineIsolateEmulatorThread']] isolate_emulator_thread: Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
        ...
        :param pulumi.Input[_builtins.str] network_data: The Base64 encoded cloud-init network data.
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:VirtualMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:VirtualMachine")])
