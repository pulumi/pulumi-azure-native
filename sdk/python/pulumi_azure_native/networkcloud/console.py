...
class ConsoleArgs:
    ...
    @enabled.setter
    def enabled(self, value: pulumi.Input[Union[_builtins.str, 'ConsoleEnabled']]):
...
class Console(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 console_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[Union[_builtins.str, 'ConsoleEnabled']]] = None,
                 expiration: pulumi.Input[Optional[_builtins.str]] = None,
                 extended_location: pulumi.Input[Optional[Union['ExtendedLocationArgs', 'ExtendedLocationArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ssh_public_key: pulumi.Input[Optional[Union['SshPublicKeyArgs', 'SshPublicKeyArgsDict']]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:Console")])
