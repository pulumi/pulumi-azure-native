...
class Console(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if ssh_public_key is not None and not isinstance(ssh_public_key, SshPublicKeyArgs):
                ssh_public_key = ssh_public_key or {}
                def _setter(key, value):
                    ssh_public_key[key] = value
                SshPublicKeyArgs._configure(_setter, **ssh_public_key)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:Console"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:Console")])
