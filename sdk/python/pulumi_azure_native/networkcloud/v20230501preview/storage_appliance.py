...
class StorageAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:StorageAppliance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageAppliance, __self__).__init__(
            'azure-native:networkcloud/v20230501preview:StorageAppliance',
            resource_name,
            __props__,
            opts)
