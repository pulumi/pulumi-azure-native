...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20230501preview:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value

    return AwaitableGetAgentPoolResult(
        administrator_configuration=__ret__.administrator_configuration,
        agent_options=__ret__.agent_options,
        attached_network_configuration=__ret__.attached_network_configuration,
        ...
        vm_sku_name=__ret__.vm_sku_name)
