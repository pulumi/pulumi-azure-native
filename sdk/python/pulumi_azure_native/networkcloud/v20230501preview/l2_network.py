...
class L2Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:L2Network"), pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:L2Network")])
