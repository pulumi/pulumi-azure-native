...
class KubernetesClusterArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'controlPlaneNodeConfiguration' in kwargs:
        ...
        if 'initialAgentPoolConfigurations' in kwargs:
...
class KubernetesCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if aad_configuration is not None and not isinstance(aad_configuration, AadConfigurationArgs):
            ...
            if control_plane_node_configuration is not None and not isinstance(control_plane_node_configuration, ControlPlaneNodeConfigurationArgs):
