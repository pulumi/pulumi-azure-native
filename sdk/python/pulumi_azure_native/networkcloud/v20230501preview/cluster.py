...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(aggregator_or_single_rack_definition, RackDefinitionArgs):
            ...
            if not isinstance(cluster_service_principal, ServicePrincipalInformationArgs):
            ...
            if not isinstance(compute_deployment_threshold, ValidationThresholdArgs):
