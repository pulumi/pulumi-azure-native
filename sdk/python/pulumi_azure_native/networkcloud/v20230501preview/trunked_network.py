...
class TrunkedNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:TrunkedNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TrunkedNetwork, __self__).__init__(
            'azure-native:networkcloud/v20230501preview:TrunkedNetwork',
            resource_name,
            __props__,
            opts)
