...
class GetVolumeResult:
    def __init__(__self__, attached_to=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, id=None, location=None, name=None, provisioning_state=None, serial_number=None, size_mi_b=None, system_data=None, tags=None, type=None):
...
def get_volume(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
...
def get_volume_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getVolume', __args__, opts=opts, typ=GetVolumeResult)
