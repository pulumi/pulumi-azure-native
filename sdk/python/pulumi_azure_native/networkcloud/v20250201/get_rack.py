...
@pulumi.output_type
class GetRackResult:
    def __init__(__self__, availability_zone=None, cluster_id=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, id=None, location=None, name=None, provisioning_state=None, rack_location=None, rack_serial_number=None, rack_sku_id=None, system_data=None, tags=None, type=None):
...
def get_rack(rack_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getRack', __args__, opts=opts, typ=GetRackResult).value
...
def get_rack_output(rack_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getRack', __args__, opts=opts, typ=GetRackResult)
