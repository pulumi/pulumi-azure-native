...
class GetStorageApplianceResult:
    def __init__(__self__, administrator_credentials=None, capacity=None, capacity_used=None, cluster_id=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, id=None, location=None, management_ipv4_address=None, manufacturer=None, model=None, name=None, provisioning_state=None, rack_id=None, rack_slot=None, remote_vendor_management_feature=None, remote_vendor_management_status=None, secret_rotation_status=None, serial_number=None, storage_appliance_sku_id=None, system_data=None, tags=None, type=None, version=None):
...
def get_storage_appliance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getStorageAppliance', __args__, opts=opts, typ=GetStorageApplianceResult).value
...
def get_storage_appliance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getStorageAppliance', __args__, opts=opts, typ=GetStorageApplianceResult)
