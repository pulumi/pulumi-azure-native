...
class GetMetricsConfigurationResult:
    def __init__(__self__, collection_interval=None, detailed_status=None, detailed_status_message=None, disabled_metrics=None, enabled_metrics=None, etag=None, extended_location=None, id=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_metrics_configuration(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getMetricsConfiguration', __args__, opts=opts, typ=GetMetricsConfigurationResult).value
...
def get_metrics_configuration_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getMetricsConfiguration', __args__, opts=opts, typ=GetMetricsConfigurationResult)
