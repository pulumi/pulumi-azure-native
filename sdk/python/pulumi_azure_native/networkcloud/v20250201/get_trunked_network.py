...
class GetTrunkedNetworkResult:
    def __init__(__self__, associated_resource_ids=None, cluster_id=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, hybrid_aks_clusters_associated_ids=None, hybrid_aks_plugin_type=None, id=None, interface_name=None, isolation_domain_ids=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, virtual_machines_associated_ids=None, vlans=None):
...
def get_trunked_network(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getTrunkedNetwork', __args__, opts=opts, typ=GetTrunkedNetworkResult).value
...
def get_trunked_network_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getTrunkedNetwork', __args__, opts=opts, typ=GetTrunkedNetworkResult)
