...
def get_bare_metal_machine(bare_metal_machine_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getBareMetalMachine', __args__, opts=opts, typ=GetBareMetalMachineResult).value
...
def get_bare_metal_machine_output(bare_metal_machine_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getBareMetalMachine', __args__, opts=opts, typ=GetBareMetalMachineResult)
