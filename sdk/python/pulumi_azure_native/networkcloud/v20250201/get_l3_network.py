...
class GetL3NetworkResult:
    def __init__(__self__, associated_resource_ids=None, cluster_id=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, hybrid_aks_clusters_associated_ids=None, hybrid_aks_ipam_enabled=None, hybrid_aks_plugin_type=None, id=None, interface_name=None, ip_allocation_type=None, ipv4_connected_prefix=None, ipv6_connected_prefix=None, l3_isolation_domain_id=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, virtual_machines_associated_ids=None, vlan=None):
...
def get_l3_network(l3_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getL3Network', __args__, opts=opts, typ=GetL3NetworkResult).value
...
def get_l3_network_output(l3_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getL3Network', __args__, opts=opts, typ=GetL3NetworkResult)
