...
class GetAgentPoolResult:
    def __init__(__self__, administrator_configuration=None, agent_options=None, attached_network_configuration=None, availability_zones=None, count=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, id=None, kubernetes_version=None, labels=None, location=None, mode=None, name=None, provisioning_state=None, system_data=None, tags=None, taints=None, type=None, upgrade_settings=None, vm_sku_name=None):
...
def get_agent_pool(agent_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult).value
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
