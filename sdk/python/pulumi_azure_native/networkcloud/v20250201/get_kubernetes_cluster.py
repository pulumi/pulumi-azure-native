...
class GetKubernetesClusterResult:
    def __init__(__self__, aad_configuration=None, administrator_configuration=None, attached_network_ids=None, available_upgrades=None, cluster_id=None, connected_cluster_id=None, control_plane_kubernetes_version=None, control_plane_node_configuration=None, detailed_status=None, detailed_status_message=None, etag=None, extended_location=None, feature_statuses=None, id=None, initial_agent_pool_configurations=None, kubernetes_version=None, location=None, managed_resource_group_configuration=None, name=None, network_configuration=None, nodes=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_kubernetes_cluster(kubernetes_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getKubernetesCluster', __args__, opts=opts, typ=GetKubernetesClusterResult).value
...
def get_kubernetes_cluster_output(kubernetes_cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getKubernetesCluster', __args__, opts=opts, typ=GetKubernetesClusterResult)
