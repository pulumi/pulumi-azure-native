...
class GetKubernetesClusterFeatureResult:
    def __init__(__self__, availability_lifecycle=None, detailed_status=None, detailed_status_message=None, etag=None, id=None, location=None, name=None, options=None, provisioning_state=None, required=None, system_data=None, tags=None, type=None, version=None):
...
def get_kubernetes_cluster_feature(feature_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getKubernetesClusterFeature', __args__, opts=opts, typ=GetKubernetesClusterFeatureResult).value
...
def get_kubernetes_cluster_feature_output(feature_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getKubernetesClusterFeature', __args__, opts=opts, typ=GetKubernetesClusterFeatureResult)
