...
class GetClusterManagerResult:
    def __init__(__self__, analytics_workspace_id=None, availability_zones=None, cluster_versions=None, detailed_status=None, detailed_status_message=None, etag=None, fabric_controller_id=None, id=None, identity=None, location=None, managed_resource_group_configuration=None, manager_extended_location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, vm_size=None):
...
def get_cluster_manager(cluster_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getClusterManager', __args__, opts=opts, typ=GetClusterManagerResult).value
...
def get_cluster_manager_output(cluster_manager_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getClusterManager', __args__, opts=opts, typ=GetClusterManagerResult)
