...
class GetBmcKeySetResult:
    def __init__(__self__, azure_group_id=None, detailed_status=None, detailed_status_message=None, etag=None, expiration=None, extended_location=None, id=None, last_validation=None, location=None, name=None, privilege_level=None, provisioning_state=None, system_data=None, tags=None, type=None, user_list=None, user_list_status=None):
...
def get_bmc_key_set(bmc_key_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getBmcKeySet', __args__, opts=opts, typ=GetBmcKeySetResult).value
...
def get_bmc_key_set_output(bmc_key_set_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getBmcKeySet', __args__, opts=opts, typ=GetBmcKeySetResult)
