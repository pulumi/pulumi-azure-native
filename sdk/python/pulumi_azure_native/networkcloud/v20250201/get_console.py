...
class GetConsoleResult:
    def __init__(__self__, detailed_status=None, detailed_status_message=None, enabled=None, etag=None, expiration=None, extended_location=None, id=None, location=None, name=None, private_link_service_id=None, provisioning_state=None, ssh_public_key=None, system_data=None, tags=None, type=None, virtual_machine_access_id=None):
...
def get_console(console_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getConsole', __args__, opts=opts, typ=GetConsoleResult).value
...
def get_console_output(console_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getConsole', __args__, opts=opts, typ=GetConsoleResult)
