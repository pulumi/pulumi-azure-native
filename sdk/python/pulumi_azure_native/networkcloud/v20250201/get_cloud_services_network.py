...
class GetCloudServicesNetworkResult:
    ...
    """
    def __init__(__self__, additional_egress_endpoints=None, associated_resource_ids=None, cluster_id=None, detailed_status=None, detailed_status_message=None, enable_default_egress_endpoints=None, enabled_egress_endpoints=None, etag=None, extended_location=None, hybrid_aks_clusters_associated_ids=None, id=None, interface_name=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, virtual_machines_associated_ids=None):
...
def get_cloud_services_network(cloud_services_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20250201:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult).value
...
def get_cloud_services_network_output(cloud_services_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20250201:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult)
