...
def get_bmc_key_set(bmc_key_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20231001preview:getBmcKeySet', __args__, opts=opts, typ=GetBmcKeySetResult).value
...
def get_bmc_key_set_output(bmc_key_set_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20231001preview:getBmcKeySet', __args__, opts=opts, typ=GetBmcKeySetResult)
