...
def get_kubernetes_cluster(kubernetes_cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20231001preview:getKubernetesCluster', __args__, opts=opts, typ=GetKubernetesClusterResult).value
...
def get_kubernetes_cluster_output(kubernetes_cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20231001preview:getKubernetesCluster', __args__, opts=opts, typ=GetKubernetesClusterResult)
