...
def get_volume(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20231001preview:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
...
def get_volume_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['volumeName'] = volume_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20231001preview:getVolume', __args__, opts=opts, typ=GetVolumeResult)
