...
class BareMetalMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud:BareMetalMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BareMetalMachine, __self__).__init__(
            'azure-native:networkcloud/v20231001preview:BareMetalMachine',
            resource_name,
            __props__,
            opts)
