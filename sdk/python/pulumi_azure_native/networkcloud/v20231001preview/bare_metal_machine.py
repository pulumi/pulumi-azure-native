...
class BareMetalMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:BareMetalMachine")])
