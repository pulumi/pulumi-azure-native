...
def get_cloud_services_network(cloud_services_network_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_services_network_name: The name of the cloud services network.
...
def get_cloud_services_network_output(cloud_services_network_name: pulumi.Input[Optional[_builtins.str]] = None,
