...
class GetCloudServicesNetworkResult:
    ...
    def enable_default_egress_endpoints(self) -> Optional[builtins.str]:
        """
...
def get_cloud_services_network(cloud_services_network_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_services_network_name: The name of the cloud services network.
...
def get_cloud_services_network_output(cloud_services_network_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult)
