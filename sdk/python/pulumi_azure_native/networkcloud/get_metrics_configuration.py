...
def get_metrics_configuration(cluster_name: Optional[_builtins.str] = None,
                              metrics_configuration_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metrics_configuration_name: The name of the metrics configuration for the cluster.
...
def get_metrics_configuration_output(cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                                     metrics_configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
