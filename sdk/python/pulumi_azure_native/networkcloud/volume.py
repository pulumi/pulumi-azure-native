...
class VolumeArgs:
    ...
    def _configure(
        ...
        if size_mi_b is None and 'sizeMiB' in kwargs:
            size_mi_b = kwargs['sizeMiB']
        if size_mi_b is None:
            raise TypeError("Missing 'size_mi_b' argument")
...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:Volume"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:Volume"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:Volume")])
