...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 volume_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Volume is deprecated: azure-native:networkcloud/v20221212preview:Volume is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:Volume to guarantee forwards compatibility.""")
        ...
        super(Volume, __self__).__init__(
            'azure-native:networkcloud/v20221212preview:Volume',
            resource_name,
            __props__,
            opts)
