...
class BareMetalMachineArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['BareMetalMachinePropertiesArgs'],
        ...
        :param pulumi.Input['BareMetalMachinePropertiesArgs'] properties: The list of the resource properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['BareMetalMachinePropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['BareMetalMachinePropertiesArgs']):
...
class BareMetalMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['BareMetalMachinePropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['BareMetalMachinePropertiesArgs']] properties: The list of the resource properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        super(BareMetalMachine, __self__).__init__(
            'azure-native:networkcloud/v20221212preview:BareMetalMachine',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BareMetalMachinePropertiesResponse']:
        """
        The list of the resource properties.
        """
        return pulumi.get(self, "properties")
