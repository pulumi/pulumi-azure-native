...
class BmcKeySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_list: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KeySetUserArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""BmcKeySet is deprecated: azure-native:networkcloud/v20221212preview:BmcKeySet is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:BmcKeySet to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:BmcKeySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BmcKeySet, __self__).__init__(
            'azure-native:networkcloud/v20221212preview:BmcKeySet',
            resource_name,
            __props__,
            opts)
