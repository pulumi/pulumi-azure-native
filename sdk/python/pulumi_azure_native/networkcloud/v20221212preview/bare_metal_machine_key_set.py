...
class BareMetalMachineKeySetArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input['BareMetalMachineKeySetPropertiesArgs'],
        ...
        :param pulumi.Input['BareMetalMachineKeySetPropertiesArgs'] properties: The list of the resource properties.
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input['BareMetalMachineKeySetPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['BareMetalMachineKeySetPropertiesArgs']):
...
class BareMetalMachineKeySet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input[pulumi.InputType['BareMetalMachineKeySetPropertiesArgs']]] = None,
        ...
        :param pulumi.Input[str] location: The geo-location where the resource lives
        :param pulumi.Input[pulumi.InputType['BareMetalMachineKeySetPropertiesArgs']] properties: The list of the resource properties.
        :param pulumi.Input[str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:BareMetalMachineKeySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BareMetalMachineKeySet, __self__).__init__(
            'azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.BareMetalMachineKeySetPropertiesResponse']:
        """
        The list of the resource properties.
        """
        return pulumi.get(self, "properties")
