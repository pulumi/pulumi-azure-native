...
warnings.warn("""azure-native:networkcloud/v20221212preview:Rack is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:Rack to guarantee forwards compatibility.""", DeprecationWarning)
...
class Rack(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Rack is deprecated: azure-native:networkcloud/v20221212preview:Rack is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:Rack to guarantee forwards compatibility.""")
