...
class MetricsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""MetricsConfiguration is deprecated: azure-native:networkcloud/v20221212preview:MetricsConfiguration is being removed in the next major version of this provider. Upgrade to at least azure-native:networkcloud/v20230501preview:MetricsConfiguration to guarantee forwards compatibility.""")
