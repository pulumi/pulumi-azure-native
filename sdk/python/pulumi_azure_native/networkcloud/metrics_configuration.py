...
class MetricsConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 collection_interval: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.float] collection_interval: The interval in minutes by which metrics will be collected.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_metrics: The list of metric names that have been chosen to be enabled in addition to the core set of enabled metrics.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] metrics_configuration_name: The name of the metrics configuration for the cluster.
    ...
    def collection_interval(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def collection_interval(self, value: pulumi.Input[builtins.float]):
    ...
    def metrics_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def metrics_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetricsConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 collection_interval: Optional[pulumi.Input[builtins.float]] = None,
                 enabled_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:MetricsConfiguration")])
    ...
    @property
    @pulumi.getter(name="collectionInterval")
    def collection_interval(self) -> pulumi.Output[builtins.float]:
        """
        The interval in minutes by which metrics will be collected.
        """
        return pulumi.get(self, "collection_interval")
    ...
    def disabled_metrics(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
