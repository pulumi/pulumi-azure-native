...
class KubernetesClusterFeature(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:KubernetesClusterFeature")])
