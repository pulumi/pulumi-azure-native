...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 cluster_type: pulumi.Input[Union[builtins.str, 'ClusterType']],
        ...
        :param pulumi.Input[Union[builtins.str, 'ClusterType']] cluster_type: The type of rack configuration for the cluster.
        :param pulumi.Input[builtins.str] cluster_version: The current runtime version of the cluster.
        ...
        :param pulumi.Input[builtins.str] network_fabric_id: The resource ID of the Network Fabric associated with the cluster.
        ...
        :param pulumi.Input[builtins.str] analytics_workspace_id: Field Deprecated. The resource ID of the Log Analytics Workspace that will be used for storing relevant logs.
        :param pulumi.Input[builtins.str] cluster_location: The customer-provided location information to identify where the cluster resides.
    ...
    def cluster_type(self) -> pulumi.Input[Union[builtins.str, 'ClusterType']]:
        """
    ...
    @cluster_type.setter
    def cluster_type(self, value: pulumi.Input[Union[builtins.str, 'ClusterType']]):
...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cluster_type: Optional[pulumi.Input[Union[builtins.str, 'ClusterType']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:Cluster")])
    ...
    def cluster_connection_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="clusterLocation")
    def cluster_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The customer-provided location information to identify where the cluster resides.
        """
        return pulumi.get(self, "cluster_location")
    ...
    def cluster_manager_connection_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def cluster_manager_id(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def manual_action_count(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def support_expiry_date(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def workload_resource_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
