...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cluster = azure_native.networkcloud.Cluster("cluster",
            ...
            cluster_service_principal=azure_native.networkcloud.ServicePrincipalInformationResponseArgs(
            ...
            compute_deployment_threshold=azure_native.networkcloud.ValidationThresholdResponseArgs(
                grouping="PerCluster",
                type="PercentSuccess",
                value=90,
            ),
            compute_rack_definitions=[{
                ...
                "storageApplianceConfigurationData": [azure_native.networkcloud.StorageApplianceConfigurationDataArgs(
                    admin_credentials=azure_native.networkcloud.AdministrativeCredentialsArgs(
                        password="{password}",
                        username="username",
                    ),
