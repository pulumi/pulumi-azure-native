...
class StorageApplianceArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'administratorCredentials' in kwargs:
        ...
        if 'storageApplianceSkuId' in kwargs:
...
class StorageAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if administrator_credentials is not None and not isinstance(administrator_credentials, AdministrativeCredentialsArgs):
                administrator_credentials = administrator_credentials or {}
                def _setter(key, value):
                    administrator_credentials[key] = value
                AdministrativeCredentialsArgs._configure(_setter, **administrator_credentials)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:StorageAppliance")])
