...
class StorageApplianceArgs:
    def __init__(__self__, *,
                 ...
                 rack_id: pulumi.Input[builtins.str],
                 rack_slot: pulumi.Input[builtins.float],
                 resource_group_name: pulumi.Input[builtins.str],
                 serial_number: pulumi.Input[builtins.str],
                 storage_appliance_sku_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] rack_id: The resource ID of the rack where this storage appliance resides.
        :param pulumi.Input[builtins.float] rack_slot: The slot the storage appliance is in the rack based on the BOM configuration.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] serial_number: The serial number for the storage appliance.
        :param pulumi.Input[builtins.str] storage_appliance_sku_id: The SKU for the storage appliance.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] storage_appliance_name: The name of the storage appliance.
    ...
    def rack_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @rack_id.setter
    def rack_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rack_id", value)

    @property
    @pulumi.getter(name="rackSlot")
    def rack_slot(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @rack_slot.setter
    def rack_slot(self, value: pulumi.Input[builtins.float]):
    ...
    def serial_number(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def serial_number(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "serial_number", value)

    @property
    @pulumi.getter(name="storageApplianceSkuId")
    def storage_appliance_sku_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_appliance_sku_id(self, value: pulumi.Input[builtins.str]):
    ...
    def storage_appliance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_appliance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StorageAppliance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 rack_id: Optional[pulumi.Input[builtins.str]] = None,
                 rack_slot: Optional[pulumi.Input[builtins.float]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 serial_number: Optional[pulumi.Input[builtins.str]] = None,
                 storage_appliance_name: Optional[pulumi.Input[builtins.str]] = None,
                 storage_appliance_sku_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:StorageAppliance")])
    ...
    @property
    @pulumi.getter
    def capacity(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def capacity_used(self) -> pulumi.Output[builtins.float]:
        """
    ...
    def management_ipv4_address(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def manufacturer(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="rackId")
    def rack_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the rack where this storage appliance resides.
        """
        return pulumi.get(self, "rack_id")
    ...
    @property
    @pulumi.getter(name="rackSlot")
    def rack_slot(self) -> pulumi.Output[builtins.float]:
        """
        The slot the storage appliance is in the rack based on the BOM configuration.
        """
        return pulumi.get(self, "rack_slot")
    ...
    def remote_vendor_management_feature(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def remote_vendor_management_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="storageApplianceSkuId")
    def storage_appliance_sku_id(self) -> pulumi.Output[builtins.str]:
        """
        The SKU for the storage appliance.
        """
        return pulumi.get(self, "storage_appliance_sku_id")
