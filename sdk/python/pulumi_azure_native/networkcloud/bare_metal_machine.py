...
class BareMetalMachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] boot_mac_address: The MAC address of a NIC connected to the PXE network.
        ...
        :param pulumi.Input[_builtins.str] machine_details: The custom details provided by the customer.
        :param pulumi.Input[_builtins.str] machine_name: The OS-level hostname assigned to this machine.
        :param pulumi.Input[_builtins.str] machine_sku_id: The unique internal identifier of the bare metal machine SKU.
        :param pulumi.Input[_builtins.str] rack_id: The resource ID of the rack where this bare metal machine resides.
...
class BareMetalMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:BareMetalMachine")])
