...
class BareMetalMachineArgs:
    def __init__(__self__, *,
                 bmc_connection_string: pulumi.Input[builtins.str],
                 ...
                 machine_details: pulumi.Input[builtins.str],
                 machine_name: pulumi.Input[builtins.str],
                 machine_sku_id: pulumi.Input[builtins.str],
                 rack_id: pulumi.Input[builtins.str],
                 rack_slot: pulumi.Input[builtins.float],
                 resource_group_name: pulumi.Input[builtins.str],
                 serial_number: pulumi.Input[builtins.str],
                 bare_metal_machine_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 machine_cluster_version: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a BareMetalMachine resource.
        :param pulumi.Input[builtins.str] bmc_connection_string: The connection string for the baseboard management controller including IP address and protocol.
        ...
        :param pulumi.Input[builtins.str] bmc_mac_address: The MAC address of the BMC device.
        :param pulumi.Input[builtins.str] boot_mac_address: The MAC address of a NIC connected to the PXE network.
        ...
        :param pulumi.Input[builtins.str] machine_details: The custom details provided by the customer.
        :param pulumi.Input[builtins.str] machine_name: The OS-level hostname assigned to this machine.
        :param pulumi.Input[builtins.str] machine_sku_id: The unique internal identifier of the bare metal machine SKU.
        :param pulumi.Input[builtins.str] rack_id: The resource ID of the rack where this bare metal machine resides.
        :param pulumi.Input[builtins.float] rack_slot: The rack slot in which this bare metal machine is located, ordered from the bottom up i.e. the lowest slot is 1.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] serial_number: The serial number of the bare metal machine.
        :param pulumi.Input[builtins.str] bare_metal_machine_name: The name of the bare metal machine.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] machine_cluster_version: The cluster version that has been applied to this machine during deployment or a version update.
    ...
    def bmc_connection_string(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bmc_connection_string(self, value: pulumi.Input[builtins.str]):
    ...
    def machine_details(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def machine_details(self, value: pulumi.Input[builtins.str]):
    ...
    def machine_sku_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def machine_sku_id(self, value: pulumi.Input[builtins.str]):
    ...
    def bare_metal_machine_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bare_metal_machine_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def machine_cluster_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def machine_cluster_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BareMetalMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bare_metal_machine_name: Optional[pulumi.Input[builtins.str]] = None,
                 bmc_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 bmc_credentials: Optional[pulumi.Input[Union['AdministrativeCredentialsArgs', 'AdministrativeCredentialsArgsDict']]] = None,
                 bmc_mac_address: Optional[pulumi.Input[builtins.str]] = None,
                 boot_mac_address: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 machine_sku_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:BareMetalMachine"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:BareMetalMachine")])
    ...
    @property
    @pulumi.getter(name="bmcConnectionString")
    def bmc_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        The connection string for the baseboard management controller including IP address and protocol.
        """
        return pulumi.get(self, "bmc_connection_string")
    ...
    @property
    @pulumi.getter(name="bmcMacAddress")
    def bmc_mac_address(self) -> pulumi.Output[builtins.str]:
        """
        The MAC address of the BMC device.
        """
        return pulumi.get(self, "bmc_mac_address")
    ...
    @property
    @pulumi.getter(name="bootMacAddress")
    def boot_mac_address(self) -> pulumi.Output[builtins.str]:
        """
        The MAC address of a NIC connected to the PXE network.
        """
        return pulumi.get(self, "boot_mac_address")
    ...
    def cordon_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def kubernetes_node_name(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="machineClusterVersion")
    def machine_cluster_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The cluster version that has been applied to this machine during deployment or a version update.
        """
        return pulumi.get(self, "machine_cluster_version")
    ...
    @property
    @pulumi.getter(name="machineDetails")
    def machine_details(self) -> pulumi.Output[builtins.str]:
        """
        The custom details provided by the customer.
        """
        return pulumi.get(self, "machine_details")
    ...
    def machine_roles(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="machineSkuId")
    def machine_sku_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique internal identifier of the bare metal machine SKU.
        """
        return pulumi.get(self, "machine_sku_id")
    ...
    def oam_ipv4_address(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def oam_ipv6_address(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def os_image(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def ready_state(self) -> pulumi.Output[builtins.str]:
        """
