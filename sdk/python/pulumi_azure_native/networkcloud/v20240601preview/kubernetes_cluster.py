...
class KubernetesCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:KubernetesCluster"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:KubernetesCluster"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:KubernetesCluster"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:KubernetesCluster"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:KubernetesCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KubernetesCluster, __self__).__init__(
            'azure-native:networkcloud/v20240601preview:KubernetesCluster',
            resource_name,
            __props__,
            opts)
