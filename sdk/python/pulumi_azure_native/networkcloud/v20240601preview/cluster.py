...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:Cluster"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:Cluster"), pulumi.Alias(type_="azure-native:networkcloud:Cluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cluster, __self__).__init__(
            'azure-native:networkcloud/v20240601preview:Cluster',
            resource_name,
            __props__,
            opts)
