...
class BmcKeySetArgs:
    ...
    def bmc_key_set_name(self) -> Optional[pulumi.Input[str]]:
        """
        The name of the baseboard management controller key set.
        """
        return pulumi.get(self, "bmc_key_set_name")

    @bmc_key_set_name.setter
    def bmc_key_set_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "bmc_key_set_name", value)
...
class BmcKeySet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BmcKeySetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud:BmcKeySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BmcKeySet, __self__).__init__(
            'azure-native:networkcloud/v20240601preview:BmcKeySet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BmcKeySet':
        """
