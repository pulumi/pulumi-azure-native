...
def get_bare_metal_machine(bare_metal_machine_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20240601preview:getBareMetalMachine', __args__, opts=opts, typ=GetBareMetalMachineResult).value
...
def get_bare_metal_machine_output(bare_metal_machine_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20240601preview:getBareMetalMachine', __args__, opts=opts, typ=GetBareMetalMachineResult)
