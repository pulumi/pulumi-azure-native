...
def get_storage_appliance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20240601preview:getStorageAppliance', __args__, opts=opts, typ=GetStorageApplianceResult).value
...
def get_storage_appliance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['storageApplianceName'] = storage_appliance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20240601preview:getStorageAppliance', __args__, opts=opts, typ=GetStorageApplianceResult)
