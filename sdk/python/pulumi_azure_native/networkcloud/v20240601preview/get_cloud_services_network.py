...
def get_cloud_services_network(cloud_services_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20240601preview:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult).value
