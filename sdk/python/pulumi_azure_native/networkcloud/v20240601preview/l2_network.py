...
class L2Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:L2Network"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:L2Network"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:L2Network"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:L2Network"), pulumi.Alias(type_="azure-native:networkcloud:L2Network")])
