...
class KubernetesClusterFeature(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:KubernetesClusterFeature"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:KubernetesClusterFeature")])
