...
class CloudServicesNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:CloudServicesNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:CloudServicesNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:CloudServicesNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:CloudServicesNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:CloudServicesNetwork")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudServicesNetwork, __self__).__init__(
            'azure-native:networkcloud/v20240601preview:CloudServicesNetwork',
            resource_name,
            __props__,
            opts)
