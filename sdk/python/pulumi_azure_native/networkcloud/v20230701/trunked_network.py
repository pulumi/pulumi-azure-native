...
class TrunkedNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:TrunkedNetwork"), pulumi.Alias(type_="azure-native:networkcloud:TrunkedNetwork")])
