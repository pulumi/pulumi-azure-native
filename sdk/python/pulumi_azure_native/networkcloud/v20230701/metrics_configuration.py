...
class MetricsConfigurationArgs:
    ...
    def _configure(
        ...
        if 'collectionInterval' in kwargs:
        ...
        if 'enabledMetrics' in kwargs:
            enabled_metrics = kwargs['enabledMetrics']
        if 'metricsConfigurationName' in kwargs:
...
class MetricsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:MetricsConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetricsConfiguration, __self__).__init__(
            'azure-native:networkcloud/v20230701:MetricsConfiguration',
            resource_name,
            __props__,
            opts)
