...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if not isinstance(cloud_services_network_attachment, NetworkAttachmentArgs):
            ...
            if not isinstance(vm_image_repository_credentials, ImageRepositoryCredentialsArgs):
