...
class BmcKeySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20221212preview:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:BmcKeySet")])
