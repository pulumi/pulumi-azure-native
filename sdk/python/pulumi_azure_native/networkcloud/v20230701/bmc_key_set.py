...
class BmcKeySet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:BmcKeySet"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:BmcKeySet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BmcKeySet, __self__).__init__(
            'azure-native:networkcloud/v20230701:BmcKeySet',
            resource_name,
            __props__,
            opts)
