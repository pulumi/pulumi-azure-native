...
def get_cloud_services_network(cloud_services_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20230701:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult).value
...
def get_cloud_services_network_output(cloud_services_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20230701:getCloudServicesNetwork', __args__, opts=opts, typ=GetCloudServicesNetworkResult)
