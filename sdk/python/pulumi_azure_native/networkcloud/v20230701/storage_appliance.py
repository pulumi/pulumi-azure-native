...
class StorageAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20230501preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:StorageAppliance")])
