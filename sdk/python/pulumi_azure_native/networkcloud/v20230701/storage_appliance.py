...
class StorageAppliance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:StorageAppliance"), pulumi.Alias(type_="azure-native:networkcloud:StorageAppliance")])
