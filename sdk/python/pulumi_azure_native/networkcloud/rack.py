...
class RackArgs:
    def __init__(__self__, *,
                 ...
                 rack_location: pulumi.Input[builtins.str],
                 rack_serial_number: pulumi.Input[builtins.str],
                 rack_sku_id: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 rack_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Rack resource.
        :param pulumi.Input[builtins.str] availability_zone: The value that will be used for machines in this rack to represent the availability zones that can be referenced by Hybrid AKS Clusters for node arrangement.
        ...
        :param pulumi.Input[builtins.str] rack_location: The free-form description of the rack location. (e.g. “DTN Datacenter, Floor 3, Isle 9, Rack 2B”)
        :param pulumi.Input[builtins.str] rack_serial_number: The unique identifier for the rack within Network Cloud cluster. An alternate unique alphanumeric value other than a serial number may be provided if desired.
        :param pulumi.Input[builtins.str] rack_sku_id: The SKU for the rack.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[builtins.str] rack_name: The name of the rack.
    ...
    def rack_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rack_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rack_location", value)

    @property
    @pulumi.getter(name="rackSerialNumber")
    def rack_serial_number(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rack_serial_number(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rack_serial_number", value)

    @property
    @pulumi.getter(name="rackSkuId")
    def rack_sku_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @rack_sku_id.setter
    def rack_sku_id(self, value: pulumi.Input[builtins.str]):
    ...
    def rack_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @rack_name.setter
    def rack_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Rack(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 rack_location: Optional[pulumi.Input[builtins.str]] = None,
                 rack_name: Optional[pulumi.Input[builtins.str]] = None,
                 rack_serial_number: Optional[pulumi.Input[builtins.str]] = None,
                 rack_sku_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:Rack"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:Rack")])
    ...
    @property
    @pulumi.getter(name="rackLocation")
    def rack_location(self) -> pulumi.Output[builtins.str]:
        """
        The free-form description of the rack location. (e.g. “DTN Datacenter, Floor 3, Isle 9, Rack 2B”)
        """
        return pulumi.get(self, "rack_location")
    ...
    @property
    @pulumi.getter(name="rackSerialNumber")
    def rack_serial_number(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier for the rack within Network Cloud cluster. An alternate unique alphanumeric value other than a serial number may be provided if desired.
        """
        return pulumi.get(self, "rack_serial_number")
    ...
    @property
    @pulumi.getter(name="rackSkuId")
    def rack_sku_id(self) -> pulumi.Output[builtins.str]:
        """
        The SKU for the rack.
        """
        return pulumi.get(self, "rack_sku_id")
