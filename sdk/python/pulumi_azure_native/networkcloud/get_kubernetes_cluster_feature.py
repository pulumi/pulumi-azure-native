...
def get_kubernetes_cluster_feature(feature_name: Optional[_builtins.str] = None,
                                   kubernetes_cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str feature_name: The name of the feature.
...
def get_kubernetes_cluster_feature_output(feature_name: pulumi.Input[Optional[_builtins.str]] = None,
