...
def get_agent_pool(agent_pool_name: Optional[builtins.str] = None,
    ...
    :param builtins.str agent_pool_name: The name of the Kubernetes cluster agent pool.
...
def get_agent_pool_output(agent_pool_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud:getAgentPool', __args__, opts=opts, typ=GetAgentPoolResult)
