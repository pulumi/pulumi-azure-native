...
def get_kubernetes_cluster(kubernetes_cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str kubernetes_cluster_name: The name of the Kubernetes cluster.
...
def get_kubernetes_cluster_output(kubernetes_cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
