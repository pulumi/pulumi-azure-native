...
def get_kubernetes_cluster(kubernetes_cluster_name: Optional[str] = None,
    ...
    return AwaitableGetKubernetesClusterResult(
        aad_configuration=__ret__.aad_configuration,
        administrator_configuration=__ret__.administrator_configuration,
        attached_network_ids=__ret__.attached_network_ids,
        available_upgrades=__ret__.available_upgrades,
        cluster_id=__ret__.cluster_id,
        connected_cluster_id=__ret__.connected_cluster_id,
        control_plane_kubernetes_version=__ret__.control_plane_kubernetes_version,
        control_plane_node_configuration=__ret__.control_plane_node_configuration,
        detailed_status=__ret__.detailed_status,
        detailed_status_message=__ret__.detailed_status_message,
        extended_location=__ret__.extended_location,
        feature_statuses=__ret__.feature_statuses,
        id=__ret__.id,
        initial_agent_pool_configurations=__ret__.initial_agent_pool_configurations,
