...
class GetBareMetalMachineResult:
    ...
    def associated_resource_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def bmc_connection_string(self) -> builtins.str:
        """
    ...
    def bmc_mac_address(self) -> builtins.str:
        """
    ...
    def boot_mac_address(self) -> builtins.str:
        """
    ...
    def cordon_status(self) -> builtins.str:
        """
    ...
    def hybrid_aks_clusters_associated_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def kubernetes_node_name(self) -> builtins.str:
        """
    ...
    def machine_cluster_version(self) -> Optional[builtins.str]:
        """
    ...
    def machine_details(self) -> builtins.str:
        """
    ...
    def machine_roles(self) -> Sequence[builtins.str]:
        """
    ...
    def machine_sku_id(self) -> builtins.str:
        """
    ...
    def oam_ipv4_address(self) -> builtins.str:
        """
    ...
    def oam_ipv6_address(self) -> builtins.str:
        """
    ...
    def ready_state(self) -> builtins.str:
        """
    ...
    def virtual_machines_associated_ids(self) -> Sequence[builtins.str]:
        """
...
def get_bare_metal_machine(bare_metal_machine_name: Optional[builtins.str] = None,
    ...
    :param builtins.str bare_metal_machine_name: The name of the bare metal machine.
...
def get_bare_metal_machine_output(bare_metal_machine_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud:getBareMetalMachine', __args__, opts=opts, typ=GetBareMetalMachineResult)
