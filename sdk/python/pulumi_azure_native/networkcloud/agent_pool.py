...
class AgentPoolArgs:
    def __init__(__self__, *,
                 count: pulumi.Input[builtins.float],
                 kubernetes_cluster_name: pulumi.Input[builtins.str],
                 mode: pulumi.Input[Union[builtins.str, 'AgentPoolMode']],
                 resource_group_name: pulumi.Input[builtins.str],
                 vm_sku_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.float] count: The number of virtual machines that use this configuration.
        :param pulumi.Input[builtins.str] kubernetes_cluster_name: The name of the Kubernetes cluster.
        :param pulumi.Input[Union[builtins.str, 'AgentPoolMode']] mode: The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] vm_sku_name: The name of the VM SKU that determines the size of resources allocated for node VMs.
        ...
        :param pulumi.Input[builtins.str] agent_pool_name: The name of the Kubernetes cluster agent pool.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
    ...
    @property
    @pulumi.getter
    def count(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @count.setter
    def count(self, value: pulumi.Input[builtins.float]):
    ...
    @property
    @pulumi.getter
    def mode(self) -> pulumi.Input[Union[builtins.str, 'AgentPoolMode']]:
        """
        The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
        """
    ...
    @mode.setter
    def mode(self, value: pulumi.Input[Union[builtins.str, 'AgentPoolMode']]):
    ...
    def vm_sku_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @vm_sku_name.setter
    def vm_sku_name(self, value: pulumi.Input[builtins.str]):
...
class AgentPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 vm_sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:AgentPool")])
    ...
    @property
    @pulumi.getter
    def count(self) -> pulumi.Output[builtins.float]:
        """
        The number of virtual machines that use this configuration.
        """
        return pulumi.get(self, "count")
    ...
    @property
    @pulumi.getter(name="vmSkuName")
    def vm_sku_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the VM SKU that determines the size of resources allocated for node VMs.
        """
        return pulumi.get(self, "vm_sku_name")
