...
class AgentPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:AgentPool"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:AgentPool")])
