...
class L3NetworkArgs:
    def __init__(__self__, *,
                 ...
                 l3_isolation_domain_id: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 vlan: pulumi.Input[builtins.float],
                 hybrid_aks_ipam_enabled: Optional[pulumi.Input[Union[builtins.str, 'HybridAksIpamEnabled']]] = None,
                 ...
                 ip_allocation_type: Optional[pulumi.Input[Union[builtins.str, 'IpAllocationType']]] = None,
                 ipv4_connected_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_connected_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 l3_network_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] l3_isolation_domain_id: The resource ID of the Network Fabric l3IsolationDomain.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.float] vlan: The VLAN from the l3IsolationDomain that is used for this network.
        :param pulumi.Input[Union[builtins.str, 'HybridAksIpamEnabled']] hybrid_aks_ipam_enabled: Field Deprecated. The field was previously optional, now it will have no defined behavior and will be ignored. The indicator of whether or not to disable IPAM allocation on the network attachment definition injected into the Hybrid AKS Cluster.
        ...
        :param pulumi.Input[builtins.str] interface_name: The default interface name for this L3 network in the virtual machine. This name can be overridden by the name supplied in the network attachment configuration of that virtual machine.
        :param pulumi.Input[Union[builtins.str, 'IpAllocationType']] ip_allocation_type: The type of the IP address allocation, defaulted to "DualStack".
        :param pulumi.Input[builtins.str] ipv4_connected_prefix: The IPV4 prefix (CIDR) assigned to this L3 network. Required when the IP allocation type
               is IPV4 or DualStack.
        :param pulumi.Input[builtins.str] ipv6_connected_prefix: The IPV6 prefix (CIDR) assigned to this L3 network. Required when the IP allocation type
               is IPV6 or DualStack.
        :param pulumi.Input[builtins.str] l3_network_name: The name of the L3 network.
    ...
    def l3_isolation_domain_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def l3_isolation_domain_id(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def vlan(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @vlan.setter
    def vlan(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "vlan", value)

    @property
    @pulumi.getter(name="hybridAksIpamEnabled")
    def hybrid_aks_ipam_enabled(self) -> Optional[pulumi.Input[Union[builtins.str, 'HybridAksIpamEnabled']]]:
        """
    ...
    def hybrid_aks_ipam_enabled(self, value: Optional[pulumi.Input[Union[builtins.str, 'HybridAksIpamEnabled']]]):
    ...
    def ip_allocation_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'IpAllocationType']]]:
        """
    ...
    def ip_allocation_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'IpAllocationType']]]):
        pulumi.set(self, "ip_allocation_type", value)

    @property
    @pulumi.getter(name="ipv4ConnectedPrefix")
    def ipv4_connected_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv4_connected_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv4_connected_prefix", value)

    @property
    @pulumi.getter(name="ipv6ConnectedPrefix")
    def ipv6_connected_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_connected_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv6_connected_prefix", value)

    @property
    @pulumi.getter(name="l3NetworkName")
    def l3_network_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def l3_network_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class L3Network(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ipv4_connected_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_connected_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 l3_isolation_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 l3_network_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 vlan: Optional[pulumi.Input[builtins.float]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20250701preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:L3Network")])
    ...
    @property
    @pulumi.getter(name="hybridAksIpamEnabled")
    def hybrid_aks_ipam_enabled(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Field Deprecated. The field was previously optional, now it will have no defined behavior and will be ignored. The indicator of whether or not to disable IPAM allocation on the network attachment definition injected into the Hybrid AKS Cluster.
        """
        return pulumi.get(self, "hybrid_aks_ipam_enabled")
    ...
    @property
    @pulumi.getter(name="ipAllocationType")
    def ip_allocation_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the IP address allocation, defaulted to "DualStack".
        """
        return pulumi.get(self, "ip_allocation_type")
    ...
    @property
    @pulumi.getter(name="ipv4ConnectedPrefix")
    def ipv4_connected_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPV4 prefix (CIDR) assigned to this L3 network. Required when the IP allocation type
        is IPV4 or DualStack.
        """
    ...
    @property
    @pulumi.getter(name="ipv6ConnectedPrefix")
    def ipv6_connected_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPV6 prefix (CIDR) assigned to this L3 network. Required when the IP allocation type
        is IPV6 or DualStack.
        """
    ...
    @property
    @pulumi.getter(name="l3IsolationDomainId")
    def l3_isolation_domain_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Network Fabric l3IsolationDomain.
        """
        return pulumi.get(self, "l3_isolation_domain_id")
    ...
    @property
    @pulumi.getter
    def vlan(self) -> pulumi.Output[builtins.float]:
        """
        The VLAN from the l3IsolationDomain that is used for this network.
        """
        return pulumi.get(self, "vlan")
