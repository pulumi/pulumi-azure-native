...
class L3NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] interface_name: The default interface name for this L3 network in the virtual machine. This name can be overridden by the name supplied in the network attachment configuration of that virtual machine.
        :param pulumi.Input[Union[_builtins.str, 'IpAllocationType']] ip_allocation_type: The type of the IP address allocation, defaulted to "DualStack".
        :param pulumi.Input[_builtins.str] ipv4_connected_prefix: The IPV4 prefix (CIDR) assigned to this L3 network. Required when the IP allocation type
...
class L3Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud/v20230701:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20241001preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20250201:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20250901:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20260101preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20260501preview:L3Network"), pulumi.Alias(type_="azure-native:networkcloud/v20260701:L3Network")])
