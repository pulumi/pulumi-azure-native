...
class GetL2NetworkResult:
    ...
    def l2_isolation_domain_id(self) -> builtins.str:
        """
...
def get_l2_network(l2_network_name: Optional[builtins.str] = None,
...
def get_l2_network_output(l2_network_name: Optional[pulumi.Input[builtins.str]] = None,
