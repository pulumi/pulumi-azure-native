...
class MetricsConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:networkcloud:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20230701:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20231001preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20240601preview:MetricsConfiguration"), pulumi.Alias(type_="azure-native:networkcloud/v20240701:MetricsConfiguration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetricsConfiguration, __self__).__init__(
            'azure-native:networkcloud/v20241001preview:MetricsConfiguration',
            resource_name,
            __props__,
            opts)
