...
def get_l2_network(l2_network_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud/v20241001preview:getL2Network', __args__, opts=opts, typ=GetL2NetworkResult).value
...
def get_l2_network_output(l2_network_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud/v20241001preview:getL2Network', __args__, opts=opts, typ=GetL2NetworkResult)
