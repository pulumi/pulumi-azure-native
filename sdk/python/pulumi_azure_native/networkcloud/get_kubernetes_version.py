...
class GetKubernetesVersionResult:
    def __init__(__self__, azure_api_version=None, etag=None, extended_location=None, id=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, values=None):
...
def get_kubernetes_version(kubernetes_version_name: Optional[_builtins.str] = None,
    ...
    """
    __args__ = dict()
    __args__['kubernetesVersionName'] = kubernetes_version_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:networkcloud:getKubernetesVersion', __args__, opts=opts, typ=GetKubernetesVersionResult).value
...
def get_kubernetes_version_output(kubernetes_version_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:networkcloud:getKubernetesVersion', __args__, opts=opts, typ=GetKubernetesVersionResult)
