...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str model: The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
        """
        pulumi.set(__self__, "name", name)
