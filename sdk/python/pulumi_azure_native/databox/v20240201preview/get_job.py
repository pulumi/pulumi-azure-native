...
def get_job(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databox/v20240201preview:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:databox/v20240201preview:getJob', __args__, opts=opts, typ=GetJobResult)
