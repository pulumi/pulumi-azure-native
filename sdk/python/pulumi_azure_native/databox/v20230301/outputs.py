...
class JobDelayDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        JobDelayDetailsResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
        ...
        if resolution_time is None and 'resolutionTime' in kwargs:
            resolution_time = kwargs['resolutionTime']
        if resolution_time is None:
            raise TypeError("Missing 'resolution_time' argument")
        ...
        _setter("resolution_time", resolution_time)
...
class JobStagesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        JobStagesResponse._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            delay_information=delay_information,
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             delay_information: Optional[Sequence['outputs.JobDelayDetailsResponse']] = None,
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if delay_information is None and 'delayInformation' in kwargs:
            delay_information = kwargs['delayInformation']
        if delay_information is None:
            raise TypeError("Missing 'delay_information' argument")
        ...
        _setter("delay_information", delay_information)
