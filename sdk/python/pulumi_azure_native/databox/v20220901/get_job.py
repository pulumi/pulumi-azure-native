...
warnings.warn("""azure-native:databox/v20220901:Job is being removed in the next major version of this provider. Please upgrade to azure-native:databox/v20221201:Job to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_job(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:databox/v20220901:Job is being removed in the next major version of this provider. Please upgrade to azure-native:databox/v20221201:Job to guarantee forwards compatibility.""")
    __args__ = dict()
