...
def list_job_credentials(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databox/v20211201:listJobCredentials', __args__, opts=opts, typ=ListJobCredentialsResult).value
...
def list_job_credentials_output(job_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databox/v20211201:listJobCredentials', __args__, opts=opts, typ=ListJobCredentialsResult)
