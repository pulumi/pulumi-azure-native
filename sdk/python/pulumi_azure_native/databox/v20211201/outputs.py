...
class JobPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Union['DataBoxCustomerDiskJobDetailsResponse', 'DataBoxDiskJobDetailsResponse', 'DataBoxHeavyJobDetailsResponse', 'DataBoxJobDetailsResponse'] details: Details of a job run. This field will only be sent for expand details filter.
        """
