...
def get_job(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databox/v20210801preview:getJob', __args__, opts=opts, typ=GetJobResult).value
...
def get_job_output(expand: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:databox/v20210801preview:getJob', __args__, opts=opts, typ=GetJobResult)
