...
def get_job(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job is deprecated: azure-native:databox/v20221001:Job is being removed in the next major version of this provider. Upgrade to at least azure-native:databox/v20221201:Job to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['expand'] = expand
    __args__['jobName'] = job_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:databox/v20221001:getJob', __args__, opts=opts, typ=GetJobResult).value
