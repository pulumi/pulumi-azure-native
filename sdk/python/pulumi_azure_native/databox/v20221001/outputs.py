...
class JobPropertiesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "reverseShippingDetailsUpdate":
            suggest = "reverse_shipping_details_update"
        elif key == "reverseTransportPreferenceUpdate":
            suggest = "reverse_transport_preference_update"
        elif key == "startTime":
            suggest = "start_time"
        elif key == "transferType":
            suggest = "transfer_type"
    ...
    def __init__(__self__, *,
        ...
        :param str reverse_shipping_details_update: The Editable status for Reverse Shipping Address and Contact Info
        :param str reverse_transport_preference_update: The Editable status for Reverse Transport preferences
