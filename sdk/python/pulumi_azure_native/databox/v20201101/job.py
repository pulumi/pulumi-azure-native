...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 delivery_type: Optional[pulumi.Input[Union[str, 'JobDeliveryType']]] = None,
                 details: Optional[pulumi.Input[Union[Union['DataBoxDiskJobDetailsArgs', 'DataBoxDiskJobDetailsArgsDict'], Union['DataBoxHeavyJobDetailsArgs', 'DataBoxHeavyJobDetailsArgsDict'], Union['DataBoxJobDetailsArgs', 'DataBoxJobDetailsArgsDict']]]] = None,
        ...
        :param pulumi.Input[Union[str, 'JobDeliveryType']] delivery_type: Delivery type of Job.
        :param pulumi.Input[Union[Union['DataBoxDiskJobDetailsArgs', 'DataBoxDiskJobDetailsArgsDict'], Union['DataBoxHeavyJobDetailsArgs', 'DataBoxHeavyJobDetailsArgsDict'], Union['DataBoxJobDetailsArgs', 'DataBoxJobDetailsArgsDict']]] details: Details of a job run. This field will only be sent for expand details filter.
