...
class JobArgs:
    def __init__(__self__, *,
                 ...
                 transfer_type: pulumi.Input[Union[builtins.str, 'TransferType']],
                 delivery_info: Optional[pulumi.Input['JobDeliveryInfoArgs']] = None,
                 delivery_type: Optional[pulumi.Input[Union[builtins.str, 'JobDeliveryType']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'TransferType']] transfer_type: Type of the data transfer.
        :param pulumi.Input['JobDeliveryInfoArgs'] delivery_info: Delivery Info of Job.
        :param pulumi.Input[Union[builtins.str, 'JobDeliveryType']] delivery_type: Delivery type of Job.
        ...
        :param pulumi.Input[builtins.str] job_name: The name of the job Resource within the specified resource group. job names must be between 3 and 24 characters in length and use any alphanumeric and underscore only
        :param pulumi.Input[builtins.str] location: The location of the resource. This will be one of the supported and registered Azure Regions (e.g. West US, East US, Southeast Asia, etc.). The region of a resource cannot be changed once it is created, but if an identical region is specified on update the request will succeed.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups).
        """
    ...
    def transfer_type(self) -> pulumi.Input[Union[builtins.str, 'TransferType']]:
        """
    ...
    def transfer_type(self, value: pulumi.Input[Union[builtins.str, 'TransferType']]):
    ...
    def delivery_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'JobDeliveryType']]]:
        """
    ...
    def delivery_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'JobDeliveryType']]]):
...
class Job(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transfer_type: Optional[pulumi.Input[Union[builtins.str, 'TransferType']]] = None,
                 __props__=None):
        """
        Job Resource.
    ...
    def all_devices_lost(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def cancellation_reason(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def delayed_stage(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="deliveryType")
    def delivery_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Delivery type of Job.
        """
        return pulumi.get(self, "delivery_type")
    ...
    def is_cancellable(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def is_cancellable_without_fee(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def is_deletable(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def is_prepare_to_ship_enabled(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def is_shipping_address_editable(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    def reverse_shipping_details_update(self) -> pulumi.Output[builtins.str]:
        """
    ...
    def reverse_transport_preference_update(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="transferType")
    def transfer_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of the data transfer.
        """
        return pulumi.get(self, "transfer_type")
