...
def get_linked_subscription(linked_subscription_name: Optional[_builtins.str] = None,
...
def get_linked_subscription_output(linked_subscription_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
