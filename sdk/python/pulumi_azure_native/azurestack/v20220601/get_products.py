...
def get_products(product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/v20220601:getProducts', __args__, opts=opts, typ=GetProductsResult).value
...
def get_products_output(product_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroup'] = resource_group
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestack/v20220601:getProducts', __args__, opts=opts, typ=GetProductsResult)
