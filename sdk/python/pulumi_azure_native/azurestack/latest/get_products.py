...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:getProducts'.""", DeprecationWarning)
...
def get_products(product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/latest:getProducts', __args__, opts=opts, typ=GetProductsResult).value
