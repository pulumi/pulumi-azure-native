...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:listProductDetails'.""", DeprecationWarning)
...
def list_product_details(product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/latest:listProductDetails', __args__, opts=opts, typ=ListProductDetailsResult).value
