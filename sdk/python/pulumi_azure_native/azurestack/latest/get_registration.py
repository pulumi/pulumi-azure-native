...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:getRegistration'.""", DeprecationWarning)
...
def get_registration(registration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:getRegistration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/latest:getRegistration', __args__, opts=opts, typ=GetRegistrationResult).value
