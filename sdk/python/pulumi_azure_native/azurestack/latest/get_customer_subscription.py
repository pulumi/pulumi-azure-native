...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:getCustomerSubscription'.""", DeprecationWarning)
...
def get_customer_subscription(customer_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/latest:getCustomerSubscription', __args__, opts=opts, typ=GetCustomerSubscriptionResult).value
