...
def get_customer_subscription_output(customer_subscription_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroup'] = resource_group
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestack/v20200601preview:getCustomerSubscription', __args__, opts=opts, typ=GetCustomerSubscriptionResult)
