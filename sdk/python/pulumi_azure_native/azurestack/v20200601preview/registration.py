...
class Registration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Registration is deprecated: Version 2020-06-01-preview will be removed in v2 of the provider.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestack:Registration"), pulumi.Alias(type_="azure-native:azurestack/v20160101:Registration"), pulumi.Alias(type_="azure-native:azurestack/v20170601:Registration"), pulumi.Alias(type_="azure-native:azurestack/v20220601:Registration")])
