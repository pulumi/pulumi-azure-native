...
class LinkedSubscriptionArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if linked_subscription_id is None and 'linkedSubscriptionId' in kwargs:
            linked_subscription_id = kwargs['linkedSubscriptionId']
        if linked_subscription_id is None:
            raise TypeError("Missing 'linked_subscription_id' argument")
        if registration_resource_id is None and 'registrationResourceId' in kwargs:
            registration_resource_id = kwargs['registrationResourceId']
        if registration_resource_id is None:
            raise TypeError("Missing 'registration_resource_id' argument")
        ...
        if linked_subscription_name is None and 'linkedSubscriptionName' in kwargs:
...
class LinkedSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurestack:LinkedSubscription")])
