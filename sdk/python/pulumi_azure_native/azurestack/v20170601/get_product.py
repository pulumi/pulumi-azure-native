...
def get_product(product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/v20170601:getProduct', __args__, opts=opts, typ=GetProductResult).value
...
def get_product_output(product_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestack/v20170601:getProduct', __args__, opts=opts, typ=GetProductResult)
