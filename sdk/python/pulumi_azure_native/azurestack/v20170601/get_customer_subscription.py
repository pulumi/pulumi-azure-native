...
def get_customer_subscription(customer_subscription_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/v20170601:getCustomerSubscription', __args__, opts=opts, typ=GetCustomerSubscriptionResult).value
...
def get_customer_subscription_output(customer_subscription_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestack/v20170601:getCustomerSubscription', __args__, opts=opts, typ=GetCustomerSubscriptionResult)
