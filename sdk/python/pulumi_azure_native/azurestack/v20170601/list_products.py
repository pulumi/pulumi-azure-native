...
def list_products(product_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/v20170601:listProducts', __args__, opts=opts, typ=ListProductsResult).value
...
def list_products_output(product_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurestack/v20170601:listProducts', __args__, opts=opts, typ=ListProductsResult)
