...
def get_experiment(experiment_name: Optional[_builtins.str] = None,
...
def get_experiment_output(experiment_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
