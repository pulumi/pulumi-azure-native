...
class GetPolicyResult:
    ...
    """
    def __init__(__self__, custom_rules=None, etag=None, frontend_endpoint_links=None, id=None, location=None, managed_rules=None, name=None, policy_settings=None, provisioning_state=None, resource_state=None, routing_rule_links=None, security_policy_links=None, sku=None, tags=None, type=None):
...
def get_policy(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:frontdoor/v20220501:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:frontdoor/v20220501:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
