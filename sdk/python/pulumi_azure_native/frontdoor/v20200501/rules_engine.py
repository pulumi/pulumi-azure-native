...
class RulesEngine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20200501:RulesEngine"), pulumi.Alias(type_="azure-native:frontdoor:RulesEngine"), pulumi.Alias(type_="azure-native:network:RulesEngine"), pulumi.Alias(type_="azure-native:frontdoor/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:frontdoor/v20200401:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200401:RulesEngine"), pulumi.Alias(type_="azure-native:frontdoor/v20210601:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20210601:RulesEngine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RulesEngine, __self__).__init__(
            'azure-native:frontdoor/v20200501:RulesEngine',
            resource_name,
            __props__,
            opts)
