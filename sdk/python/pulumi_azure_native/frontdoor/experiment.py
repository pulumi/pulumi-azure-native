...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20191101:Experiment"), pulumi.Alias(type_="azure-native:network:Experiment"), pulumi.Alias(type_="azure-native_frontdoor_v20191101:frontdoor:Experiment")])
