...
class Policy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20201101:Policy"), pulumi.Alias(type_="azure-native:frontdoor:Policy"), pulumi.Alias(type_="azure-native:network:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20190301:Policy"), pulumi.Alias(type_="azure-native:network/v20190301:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20191001:Policy"), pulumi.Alias(type_="azure-native:network/v20191001:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20200401:Policy"), pulumi.Alias(type_="azure-native:network/v20200401:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20210601:Policy"), pulumi.Alias(type_="azure-native:network/v20210601:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20220501:Policy"), pulumi.Alias(type_="azure-native:network/v20220501:Policy"), pulumi.Alias(type_="azure-native:frontdoor/v20240201:Policy"), pulumi.Alias(type_="azure-native:network/v20240201:Policy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Policy, __self__).__init__(
            'azure-native:frontdoor/v20201101:Policy',
            resource_name,
            __props__,
            opts)
