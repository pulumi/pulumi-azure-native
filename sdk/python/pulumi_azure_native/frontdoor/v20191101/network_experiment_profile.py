...
class NetworkExperimentProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:network/v20191101:NetworkExperimentProfile"), pulumi.Alias(type_="azure-native:frontdoor:NetworkExperimentProfile"), pulumi.Alias(type_="azure-native:network:NetworkExperimentProfile")])
