...
class BackendPoolsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 enforce_certificate_name_check: Optional[_builtins.str] = None,
...
class BackendResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 backend_host_header: Optional[_builtins.str] = None,
        ...
        :param _builtins.str enabled_state: Whether to enable use of this backend. Permitted values are 'Enabled' or 'Disabled'
        :param _builtins.int http_port: The HTTP TCP port number. Must be between 1 and 65535.
        :param _builtins.int https_port: The HTTPS TCP port number. Must be between 1 and 65535.
        :param _builtins.int priority: Priority to use for load balancing. Higher priorities will not be used for load balancing if any lower priority backend is healthy.
        :param _builtins.str private_link_alias: The Alias of the Private Link resource. Populating this optional field indicates that this backend is 'Private'
        ...
        :param _builtins.int weight: Weight of this endpoint for load balancing purposes.
        """
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dynamic_compression: Optional[_builtins.str] = None,
                 query_parameter_strip_directive: Optional[_builtins.str] = None,
...
class ForwardingConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str odata_type: Expected value is '#Microsoft.Azure.FrontDoor.Models.FrontdoorForwardingConfiguration'.
        ...
        :param _builtins.str custom_forwarding_path: A custom path used to rewrite resource paths matched by this rule. Leave empty to use incoming path.
...
class FrontendEndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_state: Resource status.
        :param _builtins.str type: Resource type.
        :param _builtins.str host_name: The host name of the frontendEndpoint. Must be a domain name.
        :param _builtins.str id: Resource ID.
        :param _builtins.str name: Resource name.
...
class HealthProbeSettingsModelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: _builtins.str,
                 enabled_state: Optional[_builtins.str] = None,
                 health_probe_method: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None,
        ...
        :param _builtins.str health_probe_method: Configures which HTTP method to use to probe the backends defined under backendPools.
        :param _builtins.str id: Resource ID.
        :param _builtins.int interval_in_seconds: The number of seconds between health probes.
        :param _builtins.str name: Resource name.
        :param _builtins.str path: The path to use for the health probe. Default is /
        :param _builtins.str protocol: Protocol scheme to use for this probe
        """
        pulumi.set(__self__, "resource_state", resource_state)
        pulumi.set(__self__, "type", type)
        if enabled_state is not None:
...
class RedirectConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str odata_type: Expected value is '#Microsoft.Azure.FrontDoor.Models.FrontdoorRedirectConfiguration'.
        ...
        :param _builtins.str custom_host: Host to redirect. Leave empty to use the incoming host as the destination host.
        ...
        :param _builtins.str custom_query_string: The set of query strings to be placed in the redirect URL. Setting this value would replace any existing query string; leave empty to preserve the incoming query string. Query string must be in <key>=<value> format. The first ? and & will be added automatically so do not include them in the front, but do separate multiple query strings with &.
        :param _builtins.str redirect_protocol: The protocol of the destination to where the traffic is redirected
...
class RoutingRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 resource_state: _builtins.str,
                 type: _builtins.str,
                 accepted_protocols: Optional[Sequence[_builtins.str]] = None,
                 enabled_state: Optional[_builtins.str] = None,
        ...
        :param _builtins.str enabled_state: Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'
...
class RulesEngineMatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str selector: Name of selector in RequestHeader or RequestBody to be matched
        :param Sequence[_builtins.str] transforms: List of transforms
        """
