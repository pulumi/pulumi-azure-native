...
class BackendPoolResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A backend pool is a collection of backends that can be routed to.
        :param builtins.str resource_state: Resource status.
...
class BackendPoolsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 enforce_certificate_name_check: Optional[builtins.str] = None,
                 send_recv_timeout_seconds: Optional[builtins.int] = None):
        """
        Settings that apply to all backend pools.
        :param builtins.str enforce_certificate_name_check: Whether to enforce certificate name check on HTTPS requests to all backend pools. No effect on non-HTTPS requests.
        :param builtins.int send_recv_timeout_seconds: Send and receive timeout on forwarding request to the backend. When timeout is reached, the request fails and returns.
        """
    ...
    def enforce_certificate_name_check(self) -> Optional[builtins.str]:
        """
    ...
    def send_recv_timeout_seconds(self) -> Optional[builtins.int]:
        """
...
class BackendResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 backend_host_header: Optional[builtins.str] = None,
        ...
        :param builtins.str address: Location of the backend (IP address or FQDN)
        :param builtins.str backend_host_header: The value to use as the host header sent to the backend. If blank or unspecified, this defaults to the incoming host.
        :param builtins.str enabled_state: Whether to enable use of this backend. Permitted values are 'Enabled' or 'Disabled'
        :param builtins.int http_port: The HTTP TCP port number. Must be between 1 and 65535.
        :param builtins.int https_port: The HTTPS TCP port number. Must be between 1 and 65535.
        :param builtins.int priority: Priority to use for load balancing. Higher priorities will not be used for load balancing if any lower priority backend is healthy.
        :param builtins.str private_link_alias: The Alias of the Private Link resource. Populating this optional field indicates that this backend is 'Private'
        ...
        :param builtins.int weight: Weight of this endpoint for load balancing purposes.
        """
    ...
    def backend_host_header(self) -> Optional[builtins.str]:
        """
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dynamic_compression: Optional[builtins.str] = None,
                 query_parameter_strip_directive: Optional[builtins.str] = None,
                 query_parameters: Optional[builtins.str] = None):
        """
        Caching settings for a caching-type route. To disable caching, do not provide a cacheConfiguration object.
        :param builtins.str cache_duration: The duration for which the content needs to be cached. Allowed format is in ISO 8601 format (http://en.wikipedia.org/wiki/ISO_8601#Durations). HTTP requires the value to be no more than a year
        :param builtins.str dynamic_compression: Whether to use dynamic compression for cached content
        :param builtins.str query_parameter_strip_directive: Treatment of URL query terms when forming the cache key.
    ...
    def dynamic_compression(self) -> Optional[builtins.str]:
        """
    ...
    def query_parameter_strip_directive(self) -> Optional[builtins.str]:
        """
...
class CustomHttpsConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str minimum_tls_version: The minimum TLS version required from the clients to establish an SSL handshake with Front Door.
        :param builtins.str protocol_type: Defines the TLS extension protocol that is used for secure delivery
        :param builtins.str certificate_type: Defines the type of the certificate used for secure connections to a frontendEndpoint
        :param builtins.str secret_name: The name of the Key Vault secret representing the full certificate PFX
        :param builtins.str secret_version: The version of the Key Vault secret representing the full certificate PFX
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 rate_limit_duration_in_minutes: Optional[builtins.int] = None,
        ...
        :param builtins.int priority: Describes priority of the rule. Rules with a lower value will be evaluated before rules with a higher value.
        :param builtins.str rule_type: Describes type of rule.
        ...
        :param builtins.str name: Describes the name of the rule.
        :param builtins.int rate_limit_duration_in_minutes: Time window for resetting the rate limit count. Default is 1 minute.
        :param builtins.int rate_limit_threshold: Number of allowed requests per client within the time window.
        """
    ...
    def rate_limit_duration_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def rate_limit_threshold(self) -> Optional[builtins.int]:
        """
...
class EndpointResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the endpoint properties
        :param builtins.str endpoint: The endpoint URL
...
class ForwardingConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_forwarding_path: Optional[builtins.str] = None,
                 forwarding_protocol: Optional[builtins.str] = None):
        """
        Describes Forwarding Route.
        :param builtins.str odata_type: 
        ...
        :param builtins.str custom_forwarding_path: A custom path used to rewrite resource paths matched by this rule. Leave empty to use incoming path.
    ...
    def custom_forwarding_path(self) -> Optional[builtins.str]:
        """
...
class FrontendEndpointResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_https_provisioning_state: builtins.str,
                 custom_https_provisioning_substate: builtins.str,
                 resource_state: builtins.str,
                 type: builtins.str,
                 host_name: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 session_affinity_enabled_state: Optional[builtins.str] = None,
                 session_affinity_ttl_seconds: Optional[builtins.int] = None,
        ...
        :param builtins.str custom_https_provisioning_state: Provisioning status of Custom Https of the frontendEndpoint.
        :param builtins.str custom_https_provisioning_substate: Provisioning substate shows the progress of custom HTTPS enabling/disabling process step by step.
        :param builtins.str resource_state: Resource status.
        :param builtins.str type: Resource type.
        :param builtins.str host_name: The host name of the frontendEndpoint. Must be a domain name.
        :param builtins.str id: Resource ID.
        :param builtins.str name: Resource name.
        :param builtins.str session_affinity_enabled_state: Whether to allow session affinity on this host. Valid options are 'Enabled' or 'Disabled'
        :param builtins.int session_affinity_ttl_seconds: UNUSED. This field will be ignored. The TTL to use in seconds for session affinity, if applicable.
    ...
    def session_affinity_enabled_state(self) -> Optional[builtins.str]:
        """
    ...
    def session_affinity_ttl_seconds(self) -> Optional[builtins.int]:
        """
...
class GroupByVariableResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Describes the variables available to group the rate limit requests
        :param builtins.str variable_name: Describes the supported variable for group by
        """
...
class HeaderActionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        An action that can manipulate an http header.
        :param builtins.str header_action_type: Which type of manipulation to apply to the header.
        :param builtins.str header_name: The name of the header this action will apply to.
        :param builtins.str value: The value to update the given header name with. This value is not used if the actionType is Delete.
        """
...
class HealthProbeSettingsModelResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 enabled_state: Optional[builtins.str] = None,
                 health_probe_method: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
        ...
        :param builtins.str resource_state: Resource status.
        :param builtins.str type: Resource type.
        :param builtins.str enabled_state: Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.
        :param builtins.str health_probe_method: Configures which HTTP method to use to probe the backends defined under backendPools.
        :param builtins.str id: Resource ID.
        :param builtins.int interval_in_seconds: The number of seconds between health probes.
        :param builtins.str name: Resource name.
        :param builtins.str path: The path to use for the health probe. Default is /
        :param builtins.str protocol: Protocol scheme to use for this probe
        """
        pulumi.set(__self__, "resource_state", resource_state)
        pulumi.set(__self__, "type", type)
        if enabled_state is not None:
    ...
    def health_probe_method(self) -> Optional[builtins.str]:
        """
...
class LoadBalancingSettingsModelResponse(dict):
    ...
    def __init__(__self__, *,
                 resource_state: builtins.str,
                 type: builtins.str,
                 additional_latency_milliseconds: Optional[builtins.int] = None,
                 id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
        ...
        :param builtins.str resource_state: Resource status.
        :param builtins.str type: Resource type.
        :param builtins.int additional_latency_milliseconds: The additional latency in milliseconds for probes to fall into the lowest latency bucket
        :param builtins.str id: Resource ID.
        :param builtins.str name: Resource name.
    ...
    def additional_latency_milliseconds(self) -> Optional[builtins.int]:
        """
...
class ManagedRuleExclusionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Exclude variables from managed rule evaluation.
        :param builtins.str match_variable: The variable type to be excluded.
        :param builtins.str selector: Selector value for which elements in the collection this exclusion applies to.
        :param builtins.str selector_match_operator: Comparison operator to apply to the selector when specifying which elements in the collection this exclusion applies to.
        """
...
class ManagedRuleGroupOverrideResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines a managed rule group override setting.
        :param builtins.str rule_group_name: Describes the managed rule group to override.
...
class ManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rule_set_action: Optional[builtins.str] = None):
        """
        Defines a managed rule set.
        ...
        :param builtins.str rule_set_action: Defines the rule set action.
        """
    ...
    def rule_set_action(self) -> Optional[builtins.str]:
        """
...
class MatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str match_variable: Request variable to compare with.
        :param builtins.str operator: Comparison type to use for matching with the variable value.
        :param builtins.bool negate_condition: Describes if the result of this condition should be negated.
        :param builtins.str selector: Match against a specific key from the QueryString, PostArgs, RequestHeader or Cookies variables. Default is null.
...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *,
                 custom_block_response_body: Optional[builtins.str] = None,
                 custom_block_response_status_code: Optional[builtins.int] = None,
                 enabled_state: Optional[builtins.str] = None,
                 javascript_challenge_expiration_in_minutes: Optional[builtins.int] = None,
                 mode: Optional[builtins.str] = None,
                 redirect_url: Optional[builtins.str] = None,
                 request_body_check: Optional[builtins.str] = None,
                 scrubbing_rules: Optional[Sequence['outputs.WebApplicationFirewallScrubbingRulesResponse']] = None,
                 state: Optional[builtins.str] = None):
        """
        Defines top-level WebApplicationFirewallPolicy configuration settings.
        :param builtins.str custom_block_response_body: If the action type is block, customer can override the response body. The body must be specified in base64 encoding.
        :param builtins.int custom_block_response_status_code: If the action type is block, customer can override the response status code.
        :param builtins.str enabled_state: Describes if the policy is in enabled or disabled state. Defaults to Enabled if not specified.
        :param builtins.int javascript_challenge_expiration_in_minutes: Defines the JavaScript challenge cookie validity lifetime in minutes. This setting is only applicable to Premium_AzureFrontDoor. Value must be an integer between 5 and 1440 with the default value being 30.
        :param builtins.str mode: Describes if it is in detection mode or prevention mode at policy level.
        :param builtins.str redirect_url: If action type is redirect, this field represents redirect URL for the client.
        :param builtins.str request_body_check: Describes if policy managed rules will inspect the request body content.
    ...
    def custom_block_response_body(self) -> Optional[builtins.str]:
        """
    ...
    def custom_block_response_status_code(self) -> Optional[builtins.int]:
        """
    ...
    def javascript_challenge_expiration_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def request_body_check(self) -> Optional[builtins.str]:
        """
...
class RedirectConfigurationResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_host: Optional[builtins.str] = None,
        ...
        :param builtins.str custom_host: Host to redirect. Leave empty to use the incoming host as the destination host.
        ...
        :param builtins.str custom_query_string: The set of query strings to be placed in the redirect URL. Setting this value would replace any existing query string; leave empty to preserve the incoming query string. Query string must be in <key>=<value> format. The first ? and & will be added automatically so do not include them in the front, but do separate multiple query strings with &.
        :param builtins.str redirect_protocol: The protocol of the destination to where the traffic is redirected
    ...
    def custom_host(self) -> Optional[builtins.str]:
        """
...
class RoutingRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 resource_state: builtins.str,
                 type: builtins.str,
                 accepted_protocols: Optional[Sequence[builtins.str]] = None,
                 enabled_state: Optional[builtins.str] = None,
        ...
        :param builtins.str resource_state: Resource status.
        :param builtins.str type: Resource type.
        :param Sequence[builtins.str] accepted_protocols: Protocol schemes to match for this rule
        :param builtins.str enabled_state: Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'
        :param Sequence['SubResourceResponse'] frontend_endpoints: Frontend endpoints associated with this rule
        :param builtins.str id: Resource ID.
        :param builtins.str name: Resource name.
        :param Sequence[builtins.str] patterns_to_match: The route patterns of the rule.
    ...
    def accepted_protocols(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RulesEngineMatchConditionResponse(dict):
    ...
    def __init__(__self__, *,
                 rules_engine_match_value: Sequence[builtins.str],
        ...
        """
        Define a match condition
        :param Sequence[builtins.str] rules_engine_match_value: Match values to match against. The operator will apply to each value in here with OR semantics. If any of them match the variable with the given operator this match condition is considered a match.
        :param builtins.str rules_engine_match_variable: Match Variable
        :param builtins.str rules_engine_operator: Describes operator to apply to the match condition.
        :param builtins.bool negate_condition: Describes if this is negate condition or not
        :param builtins.str selector: Name of selector in RequestHeader or RequestBody to be matched
        :param Sequence[builtins.str] transforms: List of transforms
        """
    ...
    def rules_engine_match_value(self) -> Sequence[builtins.str]:
        """
    ...
    def rules_engine_match_variable(self) -> builtins.str:
        """
        Match Variable
        """
    ...
    def rules_engine_operator(self) -> builtins.str:
        """
...
class RulesEngineRuleResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 match_processing_behavior: Optional[builtins.str] = None):
        """
        Contains a list of match conditions, and an action on how to modify the request/response. If multiple rules match, the actions from one rule that conflict with a previous rule overwrite for a singular action, or append in the case of headers manipulation.
        ...
        :param builtins.str name: A name to refer to this specific rule.
        :param builtins.int priority: A priority assigned to this rule. 
        ...
        :param builtins.str match_processing_behavior: If this rule is a match should the rules engine continue running the remaining rules or stop. If not present, defaults to Continue.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "priority", priority)
