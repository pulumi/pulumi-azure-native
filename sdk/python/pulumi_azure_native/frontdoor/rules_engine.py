...
class RulesEngineArgs:
    def __init__(__self__, *,
                 front_door_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] rules_engine_name: Name of the Rules Engine which is unique within the Front Door.
        """
    ...
    def front_door_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def front_door_name(self, value: pulumi.Input[builtins.str]):
    ...
    def rules_engine_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rules_engine_name(self, value: Optional[pulumi.Input[builtins.str]]):
