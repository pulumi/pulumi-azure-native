...
class FrontDoorArgs:
    def __init__(__self__, *,
                 ...
                 enabled_state: Optional[pulumi.Input[Union[builtins.str, 'FrontDoorEnabledState']]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 front_door_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'FrontDoorEnabledState']] enabled_state: Operational status of the Front Door load balancer. Permitted values are 'Enabled' or 'Disabled'
        :param pulumi.Input[builtins.str] friendly_name: A friendly name for the frontDoor
        :param pulumi.Input[builtins.str] front_door_name: Name of the Front Door which is globally unique.
    ...
    def enabled_state(self) -> Optional[pulumi.Input[Union[builtins.str, 'FrontDoorEnabledState']]]:
        """
    ...
    def enabled_state(self, value: Optional[pulumi.Input[Union[builtins.str, 'FrontDoorEnabledState']]]):
    ...
    def front_door_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def front_door_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FrontDoor(pulumi.CustomResource):
    ...
    def frontdoor_id(self) -> pulumi.Output[builtins.str]:
        """
