...
def get_front_door(front_door_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:frontdoor/v20200401:getFrontDoor', __args__, opts=opts, typ=GetFrontDoorResult).value
...
def get_front_door_output(front_door_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:frontdoor/v20200401:getFrontDoor', __args__, opts=opts, typ=GetFrontDoorResult)
