...
def get_rules_engine(front_door_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:frontdoor/v20200401:getRulesEngine', __args__, opts=opts, typ=GetRulesEngineResult).value
...
def get_rules_engine_output(front_door_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:frontdoor/v20200401:getRulesEngine', __args__, opts=opts, typ=GetRulesEngineResult)
