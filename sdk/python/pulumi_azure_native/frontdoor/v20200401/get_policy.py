...
def get_policy(policy_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:frontdoor/v20200401:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(policy_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:frontdoor/v20200401:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
