...
def get_serial_port(parent_resource: Optional[_builtins.str] = None,
                    parent_resource_type: Optional[_builtins.str] = None,
                    resource_group_name: Optional[_builtins.str] = None,
                    resource_provider_namespace: Optional[_builtins.str] = None,
                    serial_port: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_provider_namespace: The namespace of the resource provider.
    :param _builtins.str serial_port: The name of the serial port to connect to.
    """
    __args__ = dict()
