...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 onboarding: Optional[pulumi.Input[pulumi.InputType['OnboardingArgs']]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 server: Optional[pulumi.Input[pulumi.InputType['EnvironmentServerArgs']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Environment"), pulumi.Alias(type_="azure-native:apicenter/v20240301:Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Environment, __self__).__init__(
            'azure-native:apicenter/v20240315preview:Environment',
            resource_name,
            __props__,
            opts)
