...
class Api(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Api"), pulumi.Alias(type_="azure-native:apicenter/v20240301:Api"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:Api")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Api, __self__).__init__(
            'azure-native:apicenter/v20240315preview:Api',
            resource_name,
            __props__,
            opts)
