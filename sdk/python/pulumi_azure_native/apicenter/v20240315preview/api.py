...
class Api(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter/v20240301:Api"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:Api"), pulumi.Alias(type_="azure-native:apicenter:Api")])
