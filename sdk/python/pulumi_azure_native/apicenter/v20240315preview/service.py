...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] restore: Flag used to restore soft-deleted API Center service. If specified and set to 'true' all other properties will be ignored.
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Service"), pulumi.Alias(type_="azure-native:apicenter/v20230701preview:Service"), pulumi.Alias(type_="azure-native:apicenter/v20240301:Service"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:apicenter/v20240315preview:Service',
            resource_name,
            __props__,
            opts)
