...
def get_api_definition(api_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apicenter/v20240315preview:getApiDefinition', __args__, opts=opts, typ=GetApiDefinitionResult).value
...
def get_api_definition_output(api_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apicenter/v20240315preview:getApiDefinition', __args__, opts=opts, typ=GetApiDefinitionResult)
