...
def get_environment(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apicenter/v20240315preview:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
...
def get_environment_output(environment_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apicenter/v20240315preview:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult)
