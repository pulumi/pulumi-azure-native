...
class ApiVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter/v20240301:ApiVersion"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:ApiVersion"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:ApiVersion"), pulumi.Alias(type_="azure-native_apicenter_v20240301:apicenter:ApiVersion"), pulumi.Alias(type_="azure-native_apicenter_v20240315preview:apicenter:ApiVersion"), pulumi.Alias(type_="azure-native_apicenter_v20240601preview:apicenter:ApiVersion")])
