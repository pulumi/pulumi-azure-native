...
class Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Environment"), pulumi.Alias(type_="azure-native:apicenter/v20240301:Environment"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:Environment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Environment, __self__).__init__(
            'azure-native:apicenter/v20240601preview:Environment',
            resource_name,
            __props__,
            opts)
