...
class ApiVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:ApiVersion"), pulumi.Alias(type_="azure-native:apicenter/v20240301:ApiVersion"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:ApiVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiVersion, __self__).__init__(
            'azure-native:apicenter/v20240601preview:ApiVersion',
            resource_name,
            __props__,
            opts)
