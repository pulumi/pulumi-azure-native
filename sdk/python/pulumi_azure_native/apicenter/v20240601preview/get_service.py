...
def get_service(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apicenter/v20240601preview:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['serviceName'] = service_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apicenter/v20240601preview:getService', __args__, opts=opts, typ=GetServiceResult)
