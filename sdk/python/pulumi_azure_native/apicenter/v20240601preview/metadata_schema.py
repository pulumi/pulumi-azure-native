...
class MetadataSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:MetadataSchema"), pulumi.Alias(type_="azure-native:apicenter/v20240301:MetadataSchema"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:MetadataSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MetadataSchema, __self__).__init__(
            'azure-native:apicenter/v20240601preview:MetadataSchema',
            resource_name,
            __props__,
            opts)
