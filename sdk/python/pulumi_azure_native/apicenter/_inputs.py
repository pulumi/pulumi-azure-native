...
class AzureApiManagementSourceArgs:
    def __init__(__self__, *,
        ...
        """
        API source configuration for Azure API Management.
        :param pulumi.Input[builtins.str] resource_id: API Management service resource ID.
        :param pulumi.Input[builtins.str] msi_resource_id: The resource ID of the managed identity that has access to the API Management instance.
        """
...
class ContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the contact.
        :param pulumi.Input[builtins.str] url: URL for the contact.
        """
...
if not MYPY:
    class DeploymentServerArgsDict(TypedDict):
        ...
        Server
        """
        runtime_uri: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DeploymentServerArgs:
    def __init__(__self__, *,
                 runtime_uri: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Server
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] runtime_uri: Base runtime URLs for this deployment.
        """
    ...
    def runtime_uri(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Base runtime URLs for this deployment.
        """
    ...
    @runtime_uri.setter
    def runtime_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class EnvironmentServerArgsDict(TypedDict):
        ...
        """
        management_portal_uri: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The location of the management portal
        """
        type: NotRequired[pulumi.Input[Union[builtins.str, 'EnvironmentServerType']]]
        """
...
class EnvironmentServerArgs:
    def __init__(__self__, *,
                 management_portal_uri: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 type: Optional[pulumi.Input[Union[builtins.str, 'EnvironmentServerType']]] = None):
        """
        Server information of the environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] management_portal_uri: The location of the management portal
        :param pulumi.Input[Union[builtins.str, 'EnvironmentServerType']] type: Type of the server that represents the environment.
        """
    ...
    def management_portal_uri(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The location of the management portal
        """
    ...
    def management_portal_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "management_portal_uri", value)

    @property
    @pulumi.getter
    def type(self) -> Optional[pulumi.Input[Union[builtins.str, 'EnvironmentServerType']]]:
        """
        Type of the server that represents the environment.
        """
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[builtins.str, 'EnvironmentServerType']]]):
...
class ExternalDocumentationArgs:
    def __init__(__self__, *,
        ...
        """
        Additional, external documentation for the API.
        :param pulumi.Input[builtins.str] url: URL pointing to the documentation.
        :param pulumi.Input[builtins.str] description: Description of the documentation.
        :param pulumi.Input[builtins.str] title: Title of the documentation.
        """
        pulumi.set(__self__, "url", url)
...
class LicenseArgs:
    def __init__(__self__, *,
        ...
        """
        The license information for the API.
        :param pulumi.Input[builtins.str] identifier: SPDX license information for the API. The identifier field is mutually
               exclusive of the URL field.
        :param pulumi.Input[builtins.str] name: Name of the license.
        :param pulumi.Input[builtins.str] url: URL pointing to the license details. The URL field is mutually exclusive of the
               identifier field.
        """
...
if not MYPY:
    class MetadataAssignmentArgsDict(TypedDict):
        ...
        """
        entity: NotRequired[pulumi.Input[Union[builtins.str, 'MetadataAssignmentEntity']]]
        """
...
class MetadataAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 entity: Optional[pulumi.Input[Union[builtins.str, 'MetadataAssignmentEntity']]] = None,
                 required: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Assignment metadata
        :param pulumi.Input[builtins.bool] deprecated: Deprecated assignment
        :param pulumi.Input[Union[builtins.str, 'MetadataAssignmentEntity']] entity: The entities this metadata schema component gets applied to.
        :param pulumi.Input[builtins.bool] required: Required assignment
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> Optional[pulumi.Input[Union[builtins.str, 'MetadataAssignmentEntity']]]:
        """
        The entities this metadata schema component gets applied to.
        """
    ...
    @entity.setter
    def entity(self, value: Optional[pulumi.Input[Union[builtins.str, 'MetadataAssignmentEntity']]]):
...
if not MYPY:
    class OnboardingArgsDict(TypedDict):
        ...
        """
        developer_portal_uri: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class OnboardingArgs:
    def __init__(__self__, *,
                 developer_portal_uri: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 instructions: Optional[pulumi.Input[builtins.str]] = None):
        """
        Onboarding information
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] developer_portal_uri: The location of the development portal
        :param pulumi.Input[builtins.str] instructions: Onboarding guide.
        """
    ...
    def developer_portal_uri(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The location of the development portal
        """
    ...
    def developer_portal_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class TermsOfServiceArgs:
    def __init__(__self__, *,
        ...
        """
        Terms of service for the API.
        :param pulumi.Input[builtins.str] url: URL pointing to the terms of service.
        """
        pulumi.set(__self__, "url", url)
