...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 definition_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 state: Optional[pulumi.Input[Union[builtins.str, 'DeploymentState']]] = None,
        ...
        :param pulumi.Input[builtins.str] definition_id: API center-scoped definition resource ID.
        :param pulumi.Input[builtins.str] deployment_name: The name of the API deployment.
        :param pulumi.Input[builtins.str] description: Description of the deployment.
        :param pulumi.Input[builtins.str] environment_id: API center-scoped environment resource ID.
        :param pulumi.Input['DeploymentServerArgs'] server: The deployment server
        :param pulumi.Input[Union[builtins.str, 'DeploymentState']] state: State of API deployment.
        :param pulumi.Input[builtins.str] title: API deployment title
        """
    ...
    def definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[builtins.str, 'DeploymentState']]]:
        """
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[builtins.str, 'DeploymentState']]]):
...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter/v20240301:Deployment"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:Deployment"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:Deployment")])
    ...
    @property
    @pulumi.getter(name="definitionId")
    def definition_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        API center-scoped definition resource ID.
        """
        return pulumi.get(self, "definition_id")
