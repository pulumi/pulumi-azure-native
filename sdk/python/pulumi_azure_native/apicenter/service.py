...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] restore: Flag used to restore soft-deleted API Center service. If specified and set to 'true' all other properties will be ignored.
...
class Service(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:apicenter:Service"
