...
def get_api_source(api_source_name: Optional[_builtins.str] = None,
...
def get_api_source_output(api_source_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
