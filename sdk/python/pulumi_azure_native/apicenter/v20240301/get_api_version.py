...
def get_api_version(api_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apicenter/v20240301:getApiVersion', __args__, opts=opts, typ=GetApiVersionResult).value
...
def get_api_version_output(api_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['workspaceName'] = workspace_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:apicenter/v20240301:getApiVersion', __args__, opts=opts, typ=GetApiVersionResult)
