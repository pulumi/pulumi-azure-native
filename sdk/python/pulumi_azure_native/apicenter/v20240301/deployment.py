...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Deployment"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:Deployment"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azure-native:apicenter/v20240301:Deployment',
            resource_name,
            __props__,
            opts)
