...
class Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter:Environment"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:Environment")])
