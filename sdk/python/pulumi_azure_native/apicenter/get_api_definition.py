...
class GetApiDefinitionResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, description=None, id=None, name=None, specification=None, system_data=None, title=None, type=None):
...
def get_api_definition(api_name: Optional[builtins.str] = None,
    ...
    :param builtins.str definition_name: The name of the API definition.
...
def get_api_definition_output(api_name: Optional[pulumi.Input[builtins.str]] = None,
