...
class ApiDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter/v20240301:ApiDefinition"), pulumi.Alias(type_="azure-native:apicenter/v20240315preview:ApiDefinition"), pulumi.Alias(type_="azure-native:apicenter/v20240601preview:ApiDefinition"), pulumi.Alias(type_="azure-native_apicenter_v20240301:apicenter:ApiDefinition"), pulumi.Alias(type_="azure-native_apicenter_v20240315preview:apicenter:ApiDefinition"), pulumi.Alias(type_="azure-native_apicenter_v20240601preview:apicenter:ApiDefinition")])
