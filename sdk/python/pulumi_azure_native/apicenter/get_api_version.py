...
def get_api_version(api_name: Optional[builtins.str] = None,
    ...
    :param builtins.str version_name: The name of the API version.
...
def get_api_version_output(api_name: Optional[pulumi.Input[builtins.str]] = None,
