...
def get_api_version(api_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str version_name: The name of the API version.
...
def get_api_version_output(api_name: Optional[pulumi.Input[_builtins.str]] = None,
