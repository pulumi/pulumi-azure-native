...
class ApiSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:apicenter/v20240601preview:ApiSource"), pulumi.Alias(type_="azure-native_apicenter_v20240601preview:apicenter:ApiSource")])
