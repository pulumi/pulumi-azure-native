...
def get_metadata_schema(metadata_schema_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metadata_schema_name: The name of the metadata schema.
...
def get_metadata_schema_output(metadata_schema_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
