...
class PrivateLinkForAzureAd(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:aadiam/v20200301preview:privateLinkForAzureAd"), pulumi.Alias(type_="azure-nextgen:aadiam/v20200301preview:privateLinkForAzureAd")])
