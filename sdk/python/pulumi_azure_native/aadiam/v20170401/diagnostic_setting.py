...
class DiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:aadiam/v20170401preview:DiagnosticSetting"), pulumi.Alias(type_="azure-native:aadiam:DiagnosticSetting")])
