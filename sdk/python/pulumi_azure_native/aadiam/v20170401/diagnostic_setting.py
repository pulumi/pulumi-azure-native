...
class DiagnosticSetting(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:aadiam/v20170401:DiagnosticSetting"), pulumi.Alias(type_="azure-native:aadiam:DiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:aadiam:DiagnosticSetting"), pulumi.Alias(type_="azure-native:aadiam/latest:DiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:aadiam/latest:DiagnosticSetting")])
