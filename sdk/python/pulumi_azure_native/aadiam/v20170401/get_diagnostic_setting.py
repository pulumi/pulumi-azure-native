...
def get_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:aadiam/v20170401:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult).value
...
def get_diagnostic_setting_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:aadiam/v20170401:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult)
