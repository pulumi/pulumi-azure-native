...
class PrivateLinkForAzureAd(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_for_azure_ad = azure_native.aadiam.v20200301preview.PrivateLinkForAzureAd("privateLinkForAzureAd",
            all_tenants=False,
        ...
        ```sh
        $ pulumi import azure-native:aadiam/v20200301preview:privateLinkForAzureAd myOrgPrivateLinkPolicy /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/microsoft.aadiam/privateLinkForAzureAd/{policyName} 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:aadiam:privateLinkForAzureAd"), pulumi.Alias(type_="azure-native:aadiam/v20200301:privateLinkForAzureAd")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkForAzureAd, __self__).__init__(
            'azure-native:aadiam/v20200301preview:privateLinkForAzureAd',
            resource_name,
            __props__,
            opts)
