...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        if private_link_connection_tags is not None:
            pulumi.set(__self__, "private_link_connection_tags", private_link_connection_tags)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_endpoint_connection = azure_native.aadiam.v20200301.PrivateEndpointConnection("privateEndpointConnection",
            policy_name="example-policy-5849",
            private_endpoint=azure_native.aadiam.v20200301.PrivateEndpointArgs(
            ...
            private_link_service_connection_state=azure_native.aadiam.v20200301.PrivateLinkServiceConnectionStateArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:aadiam:PrivateEndpointConnection")])
