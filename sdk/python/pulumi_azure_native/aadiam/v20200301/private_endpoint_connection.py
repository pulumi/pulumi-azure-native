...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:aadiam/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:aadiam:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:aadiam:PrivateEndpointConnection")])
