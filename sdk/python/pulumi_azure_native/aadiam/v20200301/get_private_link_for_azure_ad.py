...
def get_private_link_for_azure_ad_output(policy_name: Optional[pulumi.Input[str]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPrivateLinkForAzureAdResult]:
    """
    Gets a private link policy with a given name.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:aadiam/v20200301:getPrivateLinkForAzureAd', __args__, opts=opts, typ=GetPrivateLinkForAzureAdResult)
