...
class DiagnosticSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        diagnostic_setting = azure_native.aadiam.v20170401preview.DiagnosticSetting("diagnosticSetting",
            ...
            logs=[{
                "category": "AuditLogs",
                "enabled": True,
                "retentionPolicy": azure_native.aadiam.v20170401preview.RetentionPolicyArgs(
                    days=0,
                    enabled=False,
                ),
            }],
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:aadiam:DiagnosticSetting"), pulumi.Alias(type_="azure-native:aadiam/v20170401:DiagnosticSetting")])
