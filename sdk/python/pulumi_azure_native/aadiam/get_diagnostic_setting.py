...
class GetDiagnosticSettingResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, event_hub_authorization_rule_id=None, event_hub_name=None, id=None, logs=None, name=None, service_bus_rule_id=None, storage_account_id=None, type=None, workspace_id=None):
    ...
    def event_hub_authorization_rule_id(self) -> Optional[builtins.str]:
        """
    ...
    def service_bus_rule_id(self) -> Optional[builtins.str]:
        """
...
def get_diagnostic_setting(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the diagnostic setting.
    """
    __args__ = dict()
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:aadiam:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult).value
...
def get_diagnostic_setting_output(name: Optional[pulumi.Input[builtins.str]] = None,
