...
def get_azure_ad_metric(azure_ad_metrics_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:aadiam/v20200701preview:getAzureADMetric', __args__, opts=opts, typ=GetAzureADMetricResult).value
...
def get_azure_ad_metric_output(azure_ad_metrics_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:aadiam/v20200701preview:getAzureADMetric', __args__, opts=opts, typ=GetAzureADMetricResult)
