...
class GetSolutionResult:
    ...
    """
    def __init__(__self__, components=None, extended_location=None, id=None, location=None, name=None, provisioning_state=None, system_data=None, tags=None, type=None, version=None):
