...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of Instance.
        :param pulumi.Input['ReconciliationPolicyArgs'] reconciliation_policy: Reconciliation Policy.
        :param pulumi.Input[builtins.str] scope: Deployment scope (such as Kubernetes namespace).
        :param pulumi.Input[builtins.str] solution: Name of the solution.
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "azure-native:iotoperationsorchestrator:Instance"
    ...
    @property
    @pulumi.getter
    def solution(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the solution.
        """
        return pulumi.get(self, "solution")
