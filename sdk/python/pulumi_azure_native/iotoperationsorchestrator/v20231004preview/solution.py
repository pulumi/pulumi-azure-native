...
class SolutionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name of solution.
...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsorchestrator:Solution")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Solution, __self__).__init__(
            'azure-native:iotoperationsorchestrator/v20231004preview:Solution',
            resource_name,
            __props__,
            opts)
