...
def get_solution(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotoperationsorchestrator/v20231004preview:getSolution', __args__, opts=opts, typ=GetSolutionResult).value
...
def get_solution_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:iotoperationsorchestrator/v20231004preview:getSolution', __args__, opts=opts, typ=GetSolutionResult)
