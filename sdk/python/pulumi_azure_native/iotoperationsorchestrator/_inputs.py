...
class ReconciliationPolicyArgs:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, 'ReconciliationPolicies']]):
        pulumi.set(self, "type", value)
...
class TopologiesPropertiesArgsDict(TypedDict):
    ...
    Defines a desired runtime component.
    """
    bindings: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['BindingPropertiesArgs']]]]]
    """
