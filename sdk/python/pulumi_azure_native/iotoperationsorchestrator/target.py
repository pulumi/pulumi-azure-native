...
class Target(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:iotoperationsorchestrator/v20231004preview:Target"), pulumi.Alias(type_="azure-native_iotoperationsorchestrator_v20231004preview:iotoperationsorchestrator:Target")])
