...
def get_import_sites_controller(resource_group_name: Optional[_builtins.str] = None,
...
def get_import_sites_controller_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
