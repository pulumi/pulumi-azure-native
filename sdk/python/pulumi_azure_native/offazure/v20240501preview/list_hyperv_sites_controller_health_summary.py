...
def list_hyperv_sites_controller_health_summary(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary', __args__, opts=opts, typ=ListHypervSitesControllerHealthSummaryResult).value
...
def list_hyperv_sites_controller_health_summary_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:listHypervSitesControllerHealthSummary', __args__, opts=opts, typ=ListHypervSitesControllerHealthSummaryResult)
    return __ret__.apply(lambda __response__: ListHypervSitesControllerHealthSummaryResult(
