...
class SqlDiscoverySiteDataSourceController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure:SqlDiscoverySiteDataSourceController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDiscoverySiteDataSourceController, __self__).__init__(
            'azure-native:offazure/v20240501preview:SqlDiscoverySiteDataSourceController',
            resource_name,
            __props__,
            opts)
