...
class WebAppSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure:WebAppSitesController"), pulumi.Alias(type_="azure-native:offazure/v20230606:WebAppSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:WebAppSitesController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSitesController, __self__).__init__(
            'azure-native:offazure/v20240501preview:WebAppSitesController',
            resource_name,
            __props__,
            opts)
