...
def get_hyperv_cluster_controller_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getHypervClusterControllerCluster', __args__, opts=opts, typ=GetHypervClusterControllerClusterResult).value
...
def get_hyperv_cluster_controller_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getHypervClusterControllerCluster', __args__, opts=opts, typ=GetHypervClusterControllerClusterResult)
