...
def get_web_app_discovery_site_data_sources_controller(discovery_site_data_source_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getWebAppDiscoverySiteDataSourcesController', __args__, opts=opts, typ=GetWebAppDiscoverySiteDataSourcesControllerResult).value
...
def get_web_app_discovery_site_data_sources_controller_output(discovery_site_data_source_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getWebAppDiscoverySiteDataSourcesController', __args__, opts=opts, typ=GetWebAppDiscoverySiteDataSourcesControllerResult)
