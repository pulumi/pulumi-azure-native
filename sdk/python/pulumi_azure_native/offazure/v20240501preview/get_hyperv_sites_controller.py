...
def get_hyperv_sites_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getHypervSitesController', __args__, opts=opts, typ=GetHypervSitesControllerResult).value
...
def get_hyperv_sites_controller_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getHypervSitesController', __args__, opts=opts, typ=GetHypervSitesControllerResult)
