...
__all__ = ['SitesControllerArgs', 'SitesController']
...
class SitesController(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SitesControllerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20200707:Site"), pulumi.Alias(type_="azure-native:offazure/v20200707:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20230606:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SitesController"), pulumi.Alias(type_="azure-native:offazure:Site"), pulumi.Alias(type_="azure-native:offazure:SitesController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SitesController, __self__).__init__(
            'azure-native:offazure/v20240501preview:SitesController',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SitesController':
        """
        ...
        __props__.__dict__["type"] = None
        return SitesController(resource_name, opts=opts, __props__=__props__)
