...
class ServerSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20230606:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:ServerSitesController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerSitesController, __self__).__init__(
            'azure-native:offazure/v20240501preview:ServerSitesController',
            resource_name,
            __props__,
            opts)
