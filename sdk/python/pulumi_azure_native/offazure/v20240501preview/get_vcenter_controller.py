...
def get_vcenter_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getVcenterController', __args__, opts=opts, typ=GetVcenterControllerResult).value
...
def get_vcenter_controller_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getVcenterController', __args__, opts=opts, typ=GetVcenterControllerResult)
