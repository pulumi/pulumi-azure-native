...
def get_hyperv_host_controller(host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getHypervHostController', __args__, opts=opts, typ=GetHypervHostControllerResult).value
...
def get_hyperv_host_controller_output(host_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getHypervHostController', __args__, opts=opts, typ=GetHypervHostControllerResult)
