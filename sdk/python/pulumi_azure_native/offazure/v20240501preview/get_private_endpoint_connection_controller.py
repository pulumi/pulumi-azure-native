...
def get_private_endpoint_connection_controller(pe_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20240501preview:getPrivateEndpointConnectionController', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerResult).value
...
def get_private_endpoint_connection_controller_output(pe_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20240501preview:getPrivateEndpointConnectionController', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerResult)
