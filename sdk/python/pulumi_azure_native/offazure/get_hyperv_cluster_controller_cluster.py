...
def get_hyperv_cluster_controller_cluster(cluster_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_name:  Cluster ARM name
...
def get_hyperv_cluster_controller_cluster_output(cluster_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
