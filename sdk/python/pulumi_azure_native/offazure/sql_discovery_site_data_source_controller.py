...
class SqlDiscoverySiteDataSourceControllerArgs:
    def __init__(__self__, *,
                 ...
                 sql_site_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] discovery_site_data_source_name: SQL Discovery site data source name.
    ...
    def sql_site_name(self) -> pulumi.Input[builtins.str]:
        """
        SQL site name.
        """
    ...
    def sql_site_name(self, value: pulumi.Input[builtins.str]):
...
class SqlDiscoverySiteDataSourceController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:SqlDiscoverySiteDataSourceController"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:SqlDiscoverySiteDataSourceController")])
