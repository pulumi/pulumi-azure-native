...
class HealthErrorDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float id: Gets the error ID.
        :param _builtins.str message: Gets the error message.
        :param Mapping[str, _builtins.str] message_parameters: Gets the message parameters.
        :param _builtins.str possible_causes: Gets the possible causes of error.
        :param _builtins.str recommended_action: Gets the recommended action to resolve error.
        :param _builtins.str run_as_account_id: Gets run as account id used while performing discovery             of entity.
        :param _builtins.str severity: Gets the error severity.
        :param _builtins.str source: Gets the error source.
        :param _builtins.str summary_message: Gets the error summary message.
        :param _builtins.str updated_time_stamp: Gets the time stamp when the error was updated.
        """
...
class SiteAgentPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str key_vault_id: Gets or sets the key vault ARM Id.
        :param _builtins.str key_vault_uri: Gets or sets the key vault URI.
        """
        pulumi.set(__self__, "id", id)
...
class SiteAppliancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 appliance_name: Optional[_builtins.str] = None,
...
class SiteHealthSummaryResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 severity: _builtins.str,
                 summary_message: _builtins.str,
                 affected_objects_count: Optional[_builtins.float] = None,
                 affected_resources: Optional[Sequence[_builtins.str]] = None,
                 fabric_layout_update_sources: Optional[Sequence[_builtins.str]] = None,
        ...
        :param _builtins.float error_id: Gets the error Id.
        :param _builtins.str error_message: Gets the error message.
        :param _builtins.str remediation_guidance: Gets the remediation guidance.
        :param _builtins.str severity: Gets the severity of error.
        :param _builtins.str summary_message: Gets the summary message.
        :param _builtins.float affected_objects_count: Gets or sets the count of affected objects.
        :param Sequence[_builtins.str] affected_resources: Gets or sets the affected resources.
        :param Sequence[_builtins.str] fabric_layout_update_sources: Gets or sets sources of the exception.
        :param _builtins.float hit_count: Gets or sets the hit count of the error.
        """
...
class SitePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 agent_details: Optional['outputs.SiteAgentPropertiesResponse'] = None,
                 appliance_name: Optional[_builtins.str] = None,
                 discovery_solution_id: Optional[_builtins.str] = None,
                 service_principal_identity_details: Optional['outputs.SiteSpnPropertiesResponse'] = None):
        """
        Class for site properties.
        ...
        :param _builtins.str discovery_solution_id: ARM ID of migration hub solution for SDS.
...
class SiteSpnPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 raw_cert_data: Optional[_builtins.str] = None,
        ...
        :param _builtins.str object_id: Gets or sets the object Id of the service principal with which the on-premise
               ...
               services.
        :param _builtins.str raw_cert_data: Gets or sets the raw certificate data for building certificate expiry flows.
        :param _builtins.str tenant_id: Gets or sets the tenant Id for the service principal with which the
               on-premise
