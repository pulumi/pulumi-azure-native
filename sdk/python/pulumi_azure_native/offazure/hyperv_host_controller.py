...
class HypervHostControllerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: Gets or sets the FQDN/IPAddress of the Hyper-V host.
        ...
        :param pulumi.Input[builtins.str] run_as_account_id: Gets or sets the run as account ID of the Hyper-V host.
        """
...
class HypervHostController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:HypervHostController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:HypervHostController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervHostController")])
