...
class ServerSitesControllerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] discovery_solution_id: Gets or sets the ARM ID of migration hub solution for SDS.
...
@pulumi.type_token("azure-native:offazure:ServerSitesController")
class ServerSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:ServerSitesController"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:ServerSitesController")])
    ...
    @property
    @pulumi.getter(name="applianceName")
    def appliance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gets or sets the Appliance Name.
        """
        return pulumi.get(self, "appliance_name")
    ...
    @property
    @pulumi.getter(name="discoverySolutionId")
    def discovery_solution_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Gets or sets the ARM ID of migration hub solution for SDS.
        """
        return pulumi.get(self, "discovery_solution_id")
