...
class MasterSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:MasterSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:MasterSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:MasterSitesController"), pulumi.Alias(type_="azure-native_offazure_v20200707:offazure:MasterSitesController"), pulumi.Alias(type_="azure-native_offazure_v20230606:offazure:MasterSitesController"), pulumi.Alias(type_="azure-native_offazure_v20231001preview:offazure:MasterSitesController"), pulumi.Alias(type_="azure-native_offazure_v20240501preview:offazure:MasterSitesController")])
