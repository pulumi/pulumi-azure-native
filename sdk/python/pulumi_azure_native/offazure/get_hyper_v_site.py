...
def get_hyper_v_site(resource_group_name: Optional[_builtins.str] = None,
...
def get_hyper_v_site_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
