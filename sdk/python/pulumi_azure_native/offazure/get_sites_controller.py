...
def get_sites_controller(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure:getSitesController', __args__, opts=opts, typ=GetSitesControllerResult).value
...
def get_sites_controller_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure:getSitesController', __args__, opts=opts, typ=GetSitesControllerResult)
