...
class SqlSitesControllerArgs:
    def __init__(__self__, *,
                 ...
                 discovery_scenario: Optional[pulumi.Input[Union[builtins.str, 'SqlSitePropertiesDiscoveryScenario']]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'SqlSitePropertiesDiscoveryScenario']] discovery_scenario: Gets or sets the discovery scenario.
        :param pulumi.Input[Sequence[pulumi.Input['SiteAppliancePropertiesArgs']]] site_appliance_properties_collection: Gets or sets the appliance details used by service to communicate
               ...
               to the appliance.
        :param pulumi.Input[builtins.str] sql_site_name: SQL site name.
        """
    ...
    def discovery_scenario(self) -> Optional[pulumi.Input[Union[builtins.str, 'SqlSitePropertiesDiscoveryScenario']]]:
        """
    ...
    def discovery_scenario(self, value: Optional[pulumi.Input[Union[builtins.str, 'SqlSitePropertiesDiscoveryScenario']]]):
    ...
    def sql_site_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SQL site name.
        """
    ...
    def sql_site_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SqlSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:SqlSitesController")])
