...
class VcenterControllerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] friendly_name: Gets or sets the friendly name of the vCenter.
        :param pulumi.Input[builtins.str] port: Gets or sets the port of the vCenter.
        :param pulumi.Input[Union[builtins.str, 'ProvisioningState']] provisioning_state: The status of the last operation.
        :param pulumi.Input[builtins.str] run_as_account_id: Gets or sets the run as account ID of the vCenter.
        :param pulumi.Input[builtins.str] vcenter_name:  VCenters name
        """
...
class VcenterController(pulumi.CustomResource):
    ...
    def perf_statistics_level(self) -> pulumi.Output[builtins.str]:
        """
