...
def get_site(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_site is deprecated: azure-native:offazure/v20200101:Site is being removed in the next major version of this provider. Upgrade to at least azure-native:offazure/v20200707:Site to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20200101:getSite', __args__, opts=opts, typ=GetSiteResult).value
