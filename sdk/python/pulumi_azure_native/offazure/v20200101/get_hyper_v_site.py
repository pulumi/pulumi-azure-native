...
def get_hyper_v_site(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20200101:getHyperVSite', __args__, opts=opts, typ=GetHyperVSiteResult).value
...
def get_hyper_v_site_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20200101:getHyperVSite', __args__, opts=opts, typ=GetHyperVSiteResult)
