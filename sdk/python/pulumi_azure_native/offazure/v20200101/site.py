...
warnings.warn("""azure-native:offazure/v20200101:Site is being removed in the next major version of this provider. Upgrade to at least azure-native:offazure/v20200707:Site to guarantee forwards compatibility.""", DeprecationWarning)
...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""Site is deprecated: azure-native:offazure/v20200101:Site is being removed in the next major version of this provider. Upgrade to at least azure-native:offazure/v20200707:Site to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure:Site"), pulumi.Alias(type_="azure-native:offazure/v20200707:Site")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Site, __self__).__init__(
            'azure-native:offazure/v20200101:Site',
            resource_name,
            __props__,
            opts)
