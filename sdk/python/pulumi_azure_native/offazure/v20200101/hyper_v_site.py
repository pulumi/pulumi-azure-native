...
class HyperVSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure/v20200101:HyperVSite"), pulumi.Alias(type_="azure-native:offazure:HyperVSite"), pulumi.Alias(type_="azure-nextgen:offazure:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:HyperVSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200707:HyperVSite")])
