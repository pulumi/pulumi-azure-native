...
class HypervClusterControllerCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:HypervClusterControllerCluster"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervClusterControllerCluster"), pulumi.Alias(type_="azure-native:offazure:HypervClusterControllerCluster")])
