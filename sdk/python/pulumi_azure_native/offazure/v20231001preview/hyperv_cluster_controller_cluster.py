...
class HypervClusterControllerCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure:HypervClusterControllerCluster"), pulumi.Alias(type_="azure-native:offazure/v20230606:HypervClusterControllerCluster"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervClusterControllerCluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HypervClusterControllerCluster, __self__).__init__(
            'azure-native:offazure/v20231001preview:HypervClusterControllerCluster',
            resource_name,
            __props__,
            opts)
