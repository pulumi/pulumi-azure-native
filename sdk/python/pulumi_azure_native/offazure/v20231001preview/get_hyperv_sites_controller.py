...
def get_hyperv_sites_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20231001preview:getHypervSitesController', __args__, opts=opts, typ=GetHypervSitesControllerResult).value
