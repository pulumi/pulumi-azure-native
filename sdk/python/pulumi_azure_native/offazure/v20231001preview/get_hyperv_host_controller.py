...
def get_hyperv_host_controller_output(host_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20231001preview:getHypervHostController', __args__, opts=opts, typ=GetHypervHostControllerResult)
