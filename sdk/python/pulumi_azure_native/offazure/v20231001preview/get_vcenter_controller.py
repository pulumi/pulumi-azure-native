...
def get_vcenter_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20231001preview:getVcenterController', __args__, opts=opts, typ=GetVcenterControllerResult).value
...
def get_vcenter_controller_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['vcenterName'] = vcenter_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20231001preview:getVcenterController', __args__, opts=opts, typ=GetVcenterControllerResult)
