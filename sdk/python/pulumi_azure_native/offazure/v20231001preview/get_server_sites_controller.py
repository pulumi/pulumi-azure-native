...
def get_server_sites_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20231001preview:getServerSitesController', __args__, opts=opts, typ=GetServerSitesControllerResult).value
...
def get_server_sites_controller_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20231001preview:getServerSitesController', __args__, opts=opts, typ=GetServerSitesControllerResult)
