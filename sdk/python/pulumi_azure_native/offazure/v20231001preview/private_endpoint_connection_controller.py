...
class PrivateEndpointConnectionController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200707:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure/v20200707:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure/v20230606:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure:PrivateEndpointConnectionController")])
