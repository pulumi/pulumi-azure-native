...
def get_private_endpoint_connection_controller(pe_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20231001preview:getPrivateEndpointConnectionController', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerResult).value
...
def get_private_endpoint_connection_controller_output(pe_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20231001preview:getPrivateEndpointConnectionController', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerResult)
