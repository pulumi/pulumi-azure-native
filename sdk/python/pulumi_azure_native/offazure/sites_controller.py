...
class SitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200707:Site"), pulumi.Alias(type_="azure-native:offazure/v20230606:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:SitesController"), pulumi.Alias(type_="azure-native:offazure:Site"), pulumi.Alias(type_="azure-native_offazure_v20200101:offazure:SitesController"), pulumi.Alias(type_="azure-native_offazure_v20200707:offazure:SitesController"), pulumi.Alias(type_="azure-native_offazure_v20230606:offazure:SitesController"), pulumi.Alias(type_="azure-native_offazure_v20231001preview:offazure:SitesController"), pulumi.Alias(type_="azure-native_offazure_v20240501preview:offazure:SitesController")])
