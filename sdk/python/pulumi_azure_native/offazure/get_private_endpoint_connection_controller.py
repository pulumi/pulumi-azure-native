...
def get_private_endpoint_connection_controller(pe_connection_name: Optional[builtins.str] = None,
...
def get_private_endpoint_connection_controller_output(pe_connection_name: Optional[pulumi.Input[builtins.str]] = None,
