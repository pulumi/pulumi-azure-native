...
__all__ = [
    ...
    'AwaitableGetPrivateEndpointConnectionControllerResult',
    'get_private_endpoint_connection_controller',
    'get_private_endpoint_connection_controller_output',
]
...
def get_private_endpoint_connection_controller(pe_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pe_connection_name:  Private link resource name.
...
def get_private_endpoint_connection_controller_output(pe_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
