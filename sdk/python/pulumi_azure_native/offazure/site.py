...
class Site(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, SitePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                SitePropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:Site"), pulumi.Alias(type_="azure-native:offazure/v20200707:Site"), pulumi.Alias(type_="azure-native:offazure/v20230606:Site")])
