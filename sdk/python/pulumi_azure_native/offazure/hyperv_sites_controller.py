...
class HypervSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20200707:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20230606:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure:HyperVSite")])
