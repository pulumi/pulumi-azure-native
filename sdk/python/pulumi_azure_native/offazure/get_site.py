...
def get_site(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure:getSite', __args__, opts=opts, typ=GetSiteResult).value
...
def get_site_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure:getSite', __args__, opts=opts, typ=GetSiteResult)
