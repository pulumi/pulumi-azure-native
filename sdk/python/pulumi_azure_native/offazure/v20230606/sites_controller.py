...
class SitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20200707:Site"), pulumi.Alias(type_="azure-native:offazure/v20200707:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:SitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:SitesController"), pulumi.Alias(type_="azure-native:offazure:Site"), pulumi.Alias(type_="azure-native:offazure:SitesController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SitesController, __self__).__init__(
            'azure-native:offazure/v20230606:SitesController',
            resource_name,
            __props__,
            opts)
