...
class WebAppDiscoverySiteDataSourcesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20231001preview:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure:WebAppDiscoverySiteDataSourcesController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppDiscoverySiteDataSourcesController, __self__).__init__(
            'azure-native:offazure/v20230606:WebAppDiscoverySiteDataSourcesController',
            resource_name,
            __props__,
            opts)
