...
class SqlSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20231001preview:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:SqlSitesController"), pulumi.Alias(type_="azure-native:offazure:SqlSitesController")])
