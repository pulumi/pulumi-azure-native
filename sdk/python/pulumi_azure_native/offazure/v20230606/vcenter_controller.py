...
class VcenterController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:VcenterController"), pulumi.Alias(type_="azure-native:offazure/v20200707:VcenterController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:VcenterController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:VcenterController"), pulumi.Alias(type_="azure-native:offazure:VcenterController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VcenterController, __self__).__init__(
            'azure-native:offazure/v20230606:VcenterController',
            resource_name,
            __props__,
            opts)
