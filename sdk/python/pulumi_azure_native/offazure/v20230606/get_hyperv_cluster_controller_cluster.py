...
def get_hyperv_cluster_controller_cluster(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20230606:getHypervClusterControllerCluster', __args__, opts=opts, typ=GetHypervClusterControllerClusterResult).value
...
def get_hyperv_cluster_controller_cluster_output(cluster_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['siteName'] = site_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure/v20230606:getHypervClusterControllerCluster', __args__, opts=opts, typ=GetHypervClusterControllerClusterResult)
