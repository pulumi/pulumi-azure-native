...
class HealthErrorDetailsResponse(dict):
    ...
    def _configure(
        ...
        if 'discoveryScope' in kwargs:
            discovery_scope = kwargs['discoveryScope']
        if 'messageParameters' in kwargs:
            message_parameters = kwargs['messageParameters']
        if 'possibleCauses' in kwargs:
