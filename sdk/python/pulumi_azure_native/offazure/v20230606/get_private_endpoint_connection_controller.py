...
def get_private_endpoint_connection_controller(pe_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20230606:getPrivateEndpointConnectionController', __args__, opts=opts, typ=GetPrivateEndpointConnectionControllerResult).value
