...
def get_sites_controller(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/v20230606:getSitesController', __args__, opts=opts, typ=GetSitesControllerResult).value
...
@_utilities.lift_output_func(get_sites_controller)
