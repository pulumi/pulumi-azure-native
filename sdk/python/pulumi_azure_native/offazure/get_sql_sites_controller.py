...
def get_sql_sites_controller(resource_group_name: Optional[_builtins.str] = None,
                             site_name: Optional[_builtins.str] = None,
                             sql_site_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sql_site_name: SQL site name.
    """
    __args__ = dict()
...
def get_sql_sites_controller_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
