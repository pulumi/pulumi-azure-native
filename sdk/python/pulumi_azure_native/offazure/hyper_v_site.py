...
class HyperVSiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the Hyper-V site.
...
class HyperVSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200101:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20230606:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20230606:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:HyperVSite"), pulumi.Alias(type_="azure-native:offazure:HypervSitesController")])
