...
class HyperVSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200707:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20230606:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:HypervSitesController"), pulumi.Alias(type_="azure-native:offazure:HypervSitesController"), pulumi.Alias(type_="azure-native_offazure_v20200101:offazure:HyperVSite"), pulumi.Alias(type_="azure-native_offazure_v20200707:offazure:HyperVSite"), pulumi.Alias(type_="azure-native_offazure_v20230606:offazure:HyperVSite"), pulumi.Alias(type_="azure-native_offazure_v20231001preview:offazure:HyperVSite"), pulumi.Alias(type_="azure-native_offazure_v20240501preview:offazure:HyperVSite")])
