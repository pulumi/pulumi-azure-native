...
def get_hyperv_sites_controller(resource_group_name: Optional[builtins.str] = None,
...
def get_hyperv_sites_controller_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure:getHypervSitesController', __args__, opts=opts, typ=GetHypervSitesControllerResult)
