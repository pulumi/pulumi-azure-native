...
def get_vcenter_controller(resource_group_name: Optional[_builtins.str] = None,
                           site_name: Optional[_builtins.str] = None,
                           vcenter_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str vcenter_name:  VCenters name
    """
    __args__ = dict()
