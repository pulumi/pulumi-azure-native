...
class GetVcenterControllerResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, created_timestamp=None, errors=None, fqdn=None, friendly_name=None, id=None, instance_uuid=None, name=None, perf_statistics_level=None, port=None, provisioning_state=None, run_as_account_id=None, system_data=None, type=None, updated_timestamp=None, version=None):
    ...
    def perf_statistics_level(self) -> builtins.str:
        """
...
def get_vcenter_controller(resource_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str vcenter_name:  VCenters name
    """
    __args__ = dict()
...
def get_vcenter_controller_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
