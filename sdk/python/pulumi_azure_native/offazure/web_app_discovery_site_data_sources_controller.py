...
class WebAppDiscoverySiteDataSourcesControllerArgs:
    def __init__(__self__, *,
                 ...
                 web_app_site_name: pulumi.Input[builtins.str],
                 discovery_site_data_source_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] web_app_site_name: Web app site name.
        :param pulumi.Input[builtins.str] discovery_site_data_source_name: Data Source ARM name.
        :param pulumi.Input[builtins.str] discovery_site_id: Gets or sets the discovery site Id.
        """
    ...
    def web_app_site_name(self) -> pulumi.Input[builtins.str]:
        """
        Web app site name.
        """
    ...
    def web_app_site_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "web_app_site_name", value)

    @property
    @pulumi.getter(name="discoverySiteDataSourceName")
    def discovery_site_data_source_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discovery_site_data_source_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure-native:offazure:WebAppDiscoverySiteDataSourcesController")
class WebAppDiscoverySiteDataSourcesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:WebAppDiscoverySiteDataSourcesController"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:WebAppDiscoverySiteDataSourcesController")])
