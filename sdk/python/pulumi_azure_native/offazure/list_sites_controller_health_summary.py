...
def list_sites_controller_health_summary(resource_group_name: Optional[_builtins.str] = None,
...
def list_sites_controller_health_summary_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure:listSitesControllerHealthSummary', __args__, opts=opts, typ=ListSitesControllerHealthSummaryResult)
