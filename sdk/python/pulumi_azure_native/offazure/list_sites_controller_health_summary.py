...
def list_sites_controller_health_summary(resource_group_name: Optional[builtins.str] = None,
...
def list_sites_controller_health_summary_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
