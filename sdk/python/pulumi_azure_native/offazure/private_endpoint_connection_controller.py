...
class PrivateEndpointConnectionController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20200707:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure/v20230606:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native:offazure:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native_offazure_v20200707:offazure:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native_offazure_v20230606:offazure:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native_offazure_v20231001preview:offazure:PrivateEndpointConnectionController"), pulumi.Alias(type_="azure-native_offazure_v20240501preview:offazure:PrivateEndpointConnectionController")])
