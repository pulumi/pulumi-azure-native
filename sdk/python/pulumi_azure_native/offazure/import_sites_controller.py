...
class ImportSitesController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure/v20230606:ImportSitesController"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:ImportSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:ImportSitesController"), pulumi.Alias(type_="azure-native:offazure/v20240701preview:ImportSitesController"), pulumi.Alias(type_="azure-native:offazure/v20241201preview:ImportSitesController")])
