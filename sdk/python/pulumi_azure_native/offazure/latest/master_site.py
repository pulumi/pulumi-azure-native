...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:offazure:MasterSite'.""", DeprecationWarning)
...
class MasterSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure/latest:MasterSite"), pulumi.Alias(type_="azure-native:offazure:MasterSite"), pulumi.Alias(type_="azure-nextgen:offazure:MasterSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:MasterSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200707:MasterSite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MasterSite, __self__).__init__(
            'azure-native:offazure/latest:MasterSite',
            resource_name,
            __props__,
            opts)
