...
def get_web_app_sites_controller(resource_group_name: Optional[builtins.str] = None,
...
def get_web_app_sites_controller_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:offazure:getWebAppSitesController', __args__, opts=opts, typ=GetWebAppSitesControllerResult)
