...
__all__ = ['MasterSiteArgs', 'MasterSite']

@pulumi.input_type
class MasterSiteArgs:
    def __init__(__self__, *,
                 resource_group_name: pulumi.Input[str],
                 e_tag: Optional[pulumi.Input[str]] = None,
                 location: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 properties: Optional[pulumi.Input['MasterSitePropertiesArgs']] = None,
        ...
        :param pulumi.Input['MasterSitePropertiesArgs'] properties: Nested properties of Master site.
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['MasterSitePropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['MasterSitePropertiesArgs']]):
...
class MasterSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MasterSiteArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MasterSiteArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MasterSiteArgs.__new__(MasterSiteArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure:MasterSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:MasterSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200707:MasterSite")])
