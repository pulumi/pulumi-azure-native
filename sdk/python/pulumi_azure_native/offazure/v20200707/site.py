...
class Site(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        site = azure_native.offazure.v20200707.Site("site",
            location="eastus",
            properties=azure_native.offazure.v20200707.SitePropertiesResponseArgs(
                service_principal_identity_details=azure_native.offazure.v20200707.SiteSpnPropertiesArgs(
