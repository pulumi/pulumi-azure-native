...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure/v20200707:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:offazure:PrivateEndpointConnection")])
