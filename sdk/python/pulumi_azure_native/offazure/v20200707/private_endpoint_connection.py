...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:offazure:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure/v20230606:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure/v20231001preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:offazure/v20240501preview:PrivateEndpointConnection")])
