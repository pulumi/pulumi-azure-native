...
class AssetEndpointProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20231101preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20240901preview:AssetEndpointProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssetEndpointProfile, __self__).__init__(
            'azure-native:deviceregistry/v20241101:AssetEndpointProfile',
            resource_name,
            __props__,
            opts)
