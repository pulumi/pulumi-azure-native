...
def get_asset_endpoint_profile(asset_endpoint_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceregistry/v20241101:getAssetEndpointProfile', __args__, opts=opts, typ=GetAssetEndpointProfileResult).value
...
def get_asset_endpoint_profile_output(asset_endpoint_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:deviceregistry/v20241101:getAssetEndpointProfile', __args__, opts=opts, typ=GetAssetEndpointProfileResult)
