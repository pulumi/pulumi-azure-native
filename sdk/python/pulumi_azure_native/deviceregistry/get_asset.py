...
def get_asset(asset_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str asset_name: Asset name parameter.
...
def get_asset_output(asset_name: Optional[pulumi.Input[_builtins.str]] = None,
