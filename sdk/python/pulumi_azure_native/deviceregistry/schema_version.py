...
class SchemaVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] schema_content: Schema content.
        ...
        :param pulumi.Input[str] schema_version_name: Schema version name parameter.
        """
    ...
    def schema_version_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def schema_version_name(self, value: Optional[pulumi.Input[str]]):
