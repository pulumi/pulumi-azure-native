...
__all__ = [
    ...
    'AwaitableGetNamespaceDiscoveredAssetResult',
    'get_namespace_discovered_asset',
    'get_namespace_discovered_asset_output',
]
...
class GetNamespaceDiscoveredAssetResult:
    ...
    def asset_type_refs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def default_management_groups_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def default_streams_configuration(self) -> Optional[builtins.str]:
        """
...
def get_namespace_discovered_asset(discovered_asset_name: Optional[builtins.str] = None,
                                   namespace_name: Optional[builtins.str] = None,
                                   resource_group_name: Optional[builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNamespaceDiscoveredAssetResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceregistry:getNamespaceDiscoveredAsset', __args__, opts=opts, typ=GetNamespaceDiscoveredAssetResult).value

    return AwaitableGetNamespaceDiscoveredAssetResult(
...
def get_namespace_discovered_asset_output(discovered_asset_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:deviceregistry:getNamespaceDiscoveredAsset', __args__, opts=opts, typ=GetNamespaceDiscoveredAssetResult)
    return __ret__.apply(lambda __response__: GetNamespaceDiscoveredAssetResult(
