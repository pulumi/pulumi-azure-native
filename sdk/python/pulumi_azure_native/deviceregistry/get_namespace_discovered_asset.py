...
def get_namespace_discovered_asset(discovered_asset_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str discovered_asset_name: The name of the discovered asset.
...
def get_namespace_discovered_asset_output(discovered_asset_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
