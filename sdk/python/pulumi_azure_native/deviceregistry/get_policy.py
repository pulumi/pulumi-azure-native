...
def get_policy(namespace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_name: The name of the Policy tracked resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceregistry:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
