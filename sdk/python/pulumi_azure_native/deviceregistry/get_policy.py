...
def get_policy(namespace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_name: The name of the Policy tracked resource.
...
def get_policy_output(namespace_name: Optional[pulumi.Input[builtins.str]] = None,
