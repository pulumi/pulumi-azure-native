...
def get_namespace_asset(asset_name: Optional[builtins.str] = None,
    ...
    :param builtins.str asset_name: The name of the asset.
...
def get_namespace_asset_output(asset_name: Optional[pulumi.Input[builtins.str]] = None,
