...
class NamespaceDeviceArgs:
    ...
    def discovered_device_ref(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def discovered_device_ref(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional['MessagingEndpointsArgs']]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional['MessagingEndpointsArgs']]):
...
class NamespaceDevice(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 discovered_device_ref: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 endpoints: pulumi.Input[Optional[Union['MessagingEndpointsArgs', 'MessagingEndpointsArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry/v20250701preview:NamespaceDevice"), pulumi.Alias(type_="azure-native:deviceregistry/v20251001:NamespaceDevice"), pulumi.Alias(type_="azure-native:deviceregistry/v20251101preview:NamespaceDevice"), pulumi.Alias(type_="azure-native:deviceregistry/v20260301preview:NamespaceDevice"), pulumi.Alias(type_="azure-native:deviceregistry/v20260401:NamespaceDevice"), pulumi.Alias(type_="azure-native:deviceregistry/v20261101preview:NamespaceDevice")])
