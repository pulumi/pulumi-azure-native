...
class Namespace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry/v20250701preview:Namespace"), pulumi.Alias(type_="azure-native:deviceregistry/v20251001:Namespace")])
