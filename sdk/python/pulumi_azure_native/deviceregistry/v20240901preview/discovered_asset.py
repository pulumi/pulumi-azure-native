...
class DiscoveredAssetArgs:
    def __init__(__self__, *,
                 ...
                 discovered_asset_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] discovery_id: Identifier used to detect changes in the asset.
        ...
        :param pulumi.Input[str] discovered_asset_name: Discovered Asset name parameter.
    ...
    def discovered_asset_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def discovered_asset_name(self, value: Optional[pulumi.Input[str]]):
...
class DiscoveredAsset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry:DiscoveredAsset")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiscoveredAsset, __self__).__init__(
            'azure-native:deviceregistry/v20240901preview:DiscoveredAsset',
            resource_name,
            __props__,
            opts)
