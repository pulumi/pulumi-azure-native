...
class SchemaVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry:SchemaVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SchemaVersion, __self__).__init__(
            'azure-native:deviceregistry/v20240901preview:SchemaVersion',
            resource_name,
            __props__,
            opts)
