...
def get_credential(namespace_name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:deviceregistry:getCredential', __args__, opts=opts, typ=GetCredentialResult).value
...
def get_credential_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:deviceregistry:getCredential', __args__, opts=opts, typ=GetCredentialResult)
