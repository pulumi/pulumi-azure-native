...
def get_namespace_discovered_device(discovered_device_name: Optional[builtins.str] = None,
...
def get_namespace_discovered_device_output(discovered_device_name: Optional[pulumi.Input[builtins.str]] = None,
