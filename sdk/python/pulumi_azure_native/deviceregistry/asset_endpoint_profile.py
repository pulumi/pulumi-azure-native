...
class AssetEndpointProfileArgs:
    def __init__(__self__, *,
                 ...
                 asset_endpoint_profile_name: Optional[pulumi.Input[_builtins.str]] = None,
                 authentication: Optional[pulumi.Input['AuthenticationArgs']] = None,
                 discovered_asset_endpoint_profile_ref: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def asset_endpoint_profile_name(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def discovered_asset_endpoint_profile_ref(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def discovered_asset_endpoint_profile_ref(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class AssetEndpointProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry/v20231101preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20240901preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20241101:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20250701preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20251001:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20251101preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20260301preview:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20260401:AssetEndpointProfile"), pulumi.Alias(type_="azure-native:deviceregistry/v20261101preview:AssetEndpointProfile")])
    ...
    @_builtins.property
    @pulumi.getter(name="discoveredAssetEndpointProfileRef")
    def discovered_asset_endpoint_profile_ref(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Reference to a discovered asset endpoint profile. Populated only if the asset endpoint profile has been created from discovery flow. Discovered asset endpoint profile name must be provided.
        """
        return pulumi.get(self, "discovered_asset_endpoint_profile_ref")
