...
class NamespaceDiscoveredDeviceArgs:
    def __init__(__self__, *,
                 ...
                 discovered_device_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] discovery_id: Identifier used to detect changes in the discovered device.
        ...
        :param pulumi.Input[builtins.str] discovered_device_name: The name of the discovered device.
        :param pulumi.Input['DiscoveredMessagingEndpointsArgs'] endpoints: Endpoints for discovered devices.
        :param pulumi.Input[builtins.str] external_device_id: A device ID that represents the device in a system external to Azure. Unique within scope of an Azure tenant.
        ...
        :param pulumi.Input[builtins.str] operating_system: Device operating system name.
    ...
    def discovered_device_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discovered_device_name(self, value: Optional[pulumi.Input[builtins.str]]):
