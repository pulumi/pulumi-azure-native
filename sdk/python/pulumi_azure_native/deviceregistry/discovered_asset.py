...
class DiscoveredAsset(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry/v20240901preview:DiscoveredAsset"), pulumi.Alias(type_="azure-native_deviceregistry_v20240901preview:deviceregistry:DiscoveredAsset")])
