...
class Schema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:deviceregistry/v20240901preview:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20250701preview:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20251001:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20251101preview:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20260301preview:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20260401:Schema"), pulumi.Alias(type_="azure-native:deviceregistry/v20261101preview:Schema")])
