...
class AuthenticationArgsDict(TypedDict):
    ...
    """
    username_password_credentials: NotRequired[pulumi.Input[Optional['UsernamePasswordCredentialsArgs']]]
    """
    Defines the username and password references when UsernamePassword user authentication mode is selected.
    """
    x509_credentials: NotRequired[pulumi.Input[Optional['X509CredentialsArgs']]]
    """
...
class CertificateAuthorityConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[_builtins.str, 'SupportedKeyType']] key_type: Crypto type: ECC.
        """
...
class DatasetArgsDict(TypedDict):
    ...
    Name of the dataset.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DataPointArgs']]]]]
    """
    ...
    """
    topic: NotRequired[pulumi.Input[Optional['TopicArgs']]]
    """
...
class DiscoveredDatasetArgsDict(TypedDict):
    ...
    Name of the dataset.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DiscoveredDataPointArgs']]]]]
    """
    Array of data points that are part of the dataset. Each data point can have per-data point configuration.
    """
    dataset_configuration: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class DiscoveredMessagingEndpointsArgsDict(TypedDict):
    ...
    """
    inbound: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['DiscoveredInboundEndpointsArgs']]]]]
    """
    Set of endpoints to connect to the device.
    """
    outbound: NotRequired[pulumi.Input[Optional['DiscoveredOutboundEndpointsArgs']]]
    """
...
class InboundEndpointsArgsDict(TypedDict):
    ...
    Stringified JSON that contains configuration to be used by the connector (e.g., OPC UA, ONVIF).
    """
    authentication: NotRequired[pulumi.Input[Optional['HostAuthenticationArgs']]]
    """
    Defines the client authentication mechanism to the server.
    """
    trust_settings: NotRequired[pulumi.Input[Optional['TrustSettingsArgs']]]
    """
...
class LeafCertificateConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] validity_period_in_days: The validity period in days.
        """
...
class ManagementGroupArgsDict(TypedDict):
    ...
    """
    actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ManagementActionArgs']]]]]
    """
...
class MessagingEndpointsArgsDict(TypedDict):
    ...
    Connection endpoint URL a device can use to connect to a service.
    """
    inbound: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['InboundEndpointsArgs']]]]]
    """
    Set of endpoints to connect to the device.
    """
    outbound: NotRequired[pulumi.Input[Optional['OutboundEndpointsArgs']]]
    """
    Set of endpoints a device can connect to.
    """
...
class MessagingArgsDict(TypedDict):
    ...
    """
    endpoints: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['MessagingEndpointArgs']]]]]
    """
...
class NamespaceDatasetArgsDict(TypedDict):
    ...
    Name of the dataset.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamespaceDatasetDataPointArgs']]]]]
    """
    Array of data points that are part of the dataset. Each data point can have per-data point configuration.
    """
    ...
    Stringified JSON that contains connector-specific JSON string that describes configuration for the specific dataset.
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['DatasetBrokerStateStoreDestinationArgs', 'DatasetMqttDestinationArgs', 'DatasetStorageDestinationArgs']]]]]]
    """
...
class NamespaceDiscoveredDatasetArgsDict(TypedDict):
    ...
    Name of the dataset.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamespaceDiscoveredDatasetDataPointArgs']]]]]
    """
    Array of data points that are part of the dataset. Each data point can have per-data point configuration.
    """
    data_source: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class NamespaceDiscoveredEventArgsDict(TypedDict):
    ...
    The name of the event.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamespaceDiscoveredEventDataPointArgs']]]]]
    """
    Array of data points that are part of the event. Each data point can have a per-data point configuration.
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['EventMqttDestinationArgs', 'EventStorageDestinationArgs']]]]]]
    """
...
class NamespaceDiscoveredManagementGroupArgsDict(TypedDict):
    ...
    Name of the management group.
    """
    actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamespaceDiscoveredManagementActionArgs']]]]]
    """
    Array of actions that are part of the management group. Each action can have an individual configuration.
    """
    default_timeout_in_seconds: NotRequired[pulumi.Input[Optional[_builtins.int]]]
...
class NamespaceDiscoveredStreamArgsDict(TypedDict):
    ...
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['StreamMqttDestinationArgs', 'StreamStorageDestinationArgs']]]]]]
    """
...
class NamespaceEventArgsDict(TypedDict):
    ...
    The name of the event.
    """
    data_points: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['NamespaceEventDataPointArgs']]]]]
    """
    Array of data points that are part of the event. Each data point can have a per-data point configuration.
    """
    destinations: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[Union['EventMqttDestinationArgs', 'EventStorageDestinationArgs']]]]]]
...
class OutboundEndpointsArgsDict(TypedDict):
    ...
    Endpoints the device can connect to.
    """
    unassigned: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['DeviceMessagingEndpointArgs']]]]]
    """
...
class PolicyPropertiesArgsDict(TypedDict):
    ...
    """
    certificate: NotRequired[pulumi.Input[Optional['CertificateConfigurationArgs']]]
    """
    The certificate configuration.
    """
