...
class EnergyService(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EnergyServiceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, EnergyServicePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                EnergyServicePropertiesArgs._configure(_setter, **properties)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:openenergyplatform:EnergyService"), pulumi.Alias(type_="azure-native:openenergyplatform/v20210601preview:EnergyService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnergyService, __self__).__init__(
            'azure-native:openenergyplatform/v20220404preview:EnergyService',
            resource_name,
            __props__,
            opts)
