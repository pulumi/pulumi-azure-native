...
class EnergyService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:openenergyplatform/v20210601preview:EnergyService"), pulumi.Alias(type_="azure-native:openenergyplatform:EnergyService")])
