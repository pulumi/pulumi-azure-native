...
class EnergyServiceArgs:
    def __init__(__self__, *,
                 ...
                 properties: pulumi.Input[Optional['EnergyServicePropertiesArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] location: Geo-location where the resource lives.
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['EnergyServicePropertiesArgs']]:
        return pulumi.get(self, "properties")

    @properties.setter
    def properties(self, value: pulumi.Input[Optional['EnergyServicePropertiesArgs']]):
...
class EnergyService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['EnergyServicePropertiesArgs', 'EnergyServicePropertiesArgsDict']]] = None,
