...
class EnergyService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:openenergyplatform/v20220404preview:EnergyService"), pulumi.Alias(type_="azure-native_openenergyplatform_v20210601preview:openenergyplatform:EnergyService"), pulumi.Alias(type_="azure-native_openenergyplatform_v20220404preview:openenergyplatform:EnergyService")])
