...
class DataPartitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Defines the properties of an individual data partition.
        :param builtins.str name: Name of the data partition
        :param builtins.str provisioning_state: Name of the data partition
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class EnergyServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auth_app_id: Optional[builtins.str] = None,
    ...
    def auth_app_id(self) -> Optional[builtins.str]:
