...
class GetNetworkConnectionResult:
    ...
    def domain_password(self) -> Optional[builtins.str]:
        """
    ...
    def networking_resource_group_name(self) -> Optional[builtins.str]:
        """
    ...
    def organization_unit(self) -> Optional[builtins.str]:
        """
...
def get_network_connection(network_connection_name: Optional[builtins.str] = None,
    ...
    :param builtins.str network_connection_name: Name of the Network Connection that can be applied to a Pool.
...
def get_network_connection_output(network_connection_name: Optional[pulumi.Input[builtins.str]] = None,
