...
def get_network_connection(network_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_connection_name: Name of the Network Connection that can be applied to a Pool.
...
def get_network_connection_output(network_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
