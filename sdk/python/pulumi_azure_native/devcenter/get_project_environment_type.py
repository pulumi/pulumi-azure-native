...
def get_project_environment_type(environment_type_name: Optional[_builtins.str] = None,
...
def get_project_environment_type_output(environment_type_name: Optional[pulumi.Input[_builtins.str]] = None,
