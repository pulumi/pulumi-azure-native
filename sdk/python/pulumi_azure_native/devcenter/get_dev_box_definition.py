...
def get_dev_box_definition(dev_box_definition_name: Optional[_builtins.str] = None,
                           dev_center_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dev_box_definition_name: The name of the Dev Box definition.
...
def get_dev_box_definition_output(dev_box_definition_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
