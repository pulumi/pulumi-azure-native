...
class CurationProfileArgs:
    def __init__(__self__, *,
                 ...
                 curation_profile_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: Resources that have access to the shared resources that are a part of this curation profile.
        """
    ...
    def curation_profile_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def curation_profile_name(self, value: Optional[pulumi.Input[str]]):
...
class CurationProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20240801preview:CurationProfile"), pulumi.Alias(type_="azure-native:devcenter/v20241001preview:CurationProfile"), pulumi.Alias(type_="azure-native_devcenter_v20240801preview:devcenter:CurationProfile"), pulumi.Alias(type_="azure-native_devcenter_v20241001preview:devcenter:CurationProfile")])
