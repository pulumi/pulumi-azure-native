...
class ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        """
        ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            roles=roles,
        )
    @staticmethod
...
class StopOnDisconnectConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        StopOnDisconnectConfigurationArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if grace_period_minutes is None and 'gracePeriodMinutes' in kwargs:
            grace_period_minutes = kwargs['gracePeriodMinutes']
...
class UserRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        """
        UserRoleAssignmentArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            roles=roles,
        )
    @staticmethod
