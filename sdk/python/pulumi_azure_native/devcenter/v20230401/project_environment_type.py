...
class ProjectEnvironmentTypeArgs:
    ...
    def _configure(
        ...
        if creator_role_assignment is None and 'creatorRoleAssignment' in kwargs:
        ...
        if environment_type_name is None and 'environmentTypeName' in kwargs:
            environment_type_name = kwargs['environmentTypeName']
        if user_role_assignments is None and 'userRoleAssignments' in kwargs:
...
class ProjectEnvironmentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            creator_role_assignment = _utilities.configure(creator_role_assignment, ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignmentArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230801preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20231001preview:ProjectEnvironmentType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectEnvironmentType, __self__).__init__(
            'azure-native:devcenter/v20230401:ProjectEnvironmentType',
            resource_name,
            __props__,
            opts)
