...
class EnvironmentTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the environment type.
