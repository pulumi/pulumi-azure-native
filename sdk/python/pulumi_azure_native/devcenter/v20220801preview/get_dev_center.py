...
def get_dev_center(dev_center_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_center is deprecated: azure-native:devcenter/v20220801preview:DevCenter is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:DevCenter to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['devCenterName'] = dev_center_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20220801preview:getDevCenter', __args__, opts=opts, typ=GetDevCenterResult).value
