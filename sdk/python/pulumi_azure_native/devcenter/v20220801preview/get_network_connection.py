...
warnings.warn("""azure-native:devcenter/v20220801preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:NetworkConnection to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_network_connection(network_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_connection is deprecated: azure-native:devcenter/v20220801preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:NetworkConnection to guarantee forwards compatibility.""")
    __args__ = dict()
