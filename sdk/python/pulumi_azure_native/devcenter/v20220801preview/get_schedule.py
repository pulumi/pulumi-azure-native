...
def get_schedule(pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_schedule is deprecated: azure-native:devcenter/v20220801preview:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Schedule to guarantee forwards compatibility.""")
    __args__ = dict()
