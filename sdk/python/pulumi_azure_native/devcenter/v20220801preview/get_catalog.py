...
warnings.warn("""azure-native:devcenter/v20220801preview:Catalog is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Catalog to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_catalog(catalog_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_catalog is deprecated: azure-native:devcenter/v20220801preview:Catalog is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Catalog to guarantee forwards compatibility.""")
    __args__ = dict()
