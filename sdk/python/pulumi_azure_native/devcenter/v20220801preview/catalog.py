...
class Catalog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Catalog is deprecated: azure-native:devcenter/v20220801preview:Catalog is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Catalog to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:Catalog")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Catalog, __self__).__init__(
            'azure-native:devcenter/v20220801preview:Catalog',
            resource_name,
            __props__,
            opts)
