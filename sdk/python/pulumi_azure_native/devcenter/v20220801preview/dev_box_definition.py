...
class DevBoxDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""DevBoxDefinition is deprecated: azure-native:devcenter/v20220801preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.""")
        ...
        super(DevBoxDefinition, __self__).__init__(
            'azure-native:devcenter/v20220801preview:DevBoxDefinition',
            resource_name,
            __props__,
            opts)
