...
warnings.warn("""azure-native:devcenter/v20220801preview:Schedule is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Schedule to guarantee forwards compatibility.""", DeprecationWarning)
