...
def get_attached_network_by_dev_center(attached_network_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attached_network_by_dev_center is deprecated: azure-native:devcenter/v20220801preview:AttachedNetworkByDevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:AttachedNetworkByDevCenter to guarantee forwards compatibility.""")
    __args__ = dict()
