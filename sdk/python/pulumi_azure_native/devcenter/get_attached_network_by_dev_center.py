...
def get_attached_network_by_dev_center(attached_network_connection_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str attached_network_connection_name: The name of the attached NetworkConnection.
...
def get_attached_network_by_dev_center_output(attached_network_connection_name: Optional[pulumi.Input[_builtins.str]] = None,
