...
class AttachedNetworkByDevCenterArgs:
    def __init__(__self__, *,
        ...
        """
        AttachedNetworkByDevCenterArgs._configure(
    ...
    def _configure(
        ...
        if network_connection_id is None and 'networkConnectionId' in kwargs:
            network_connection_id = kwargs['networkConnectionId']
        if network_connection_id is None:
            raise TypeError("Missing 'network_connection_id' argument")
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if resource_group_name is None:
            raise TypeError("Missing 'resource_group_name' argument")
        if attached_network_connection_name is None and 'attachedNetworkConnectionName' in kwargs:
            attached_network_connection_name = kwargs['attachedNetworkConnectionName']

        _setter("dev_center_name", dev_center_name)
        _setter("network_connection_id", network_connection_id)
        _setter("resource_group_name", resource_group_name)
        if attached_network_connection_name is not None:
            _setter("attached_network_connection_name", attached_network_connection_name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AttachedNetworkByDevCenterArgs._configure(_setter, **kwargs)
