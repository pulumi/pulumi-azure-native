...
def get_network_connection(network_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20231001preview:getNetworkConnection', __args__, opts=opts, typ=GetNetworkConnectionResult).value
...
def get_network_connection_output(network_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20231001preview:getNetworkConnection', __args__, opts=opts, typ=GetNetworkConnectionResult)
