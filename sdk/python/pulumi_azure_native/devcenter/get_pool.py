...
class GetPoolResult:
    ...
    def dev_box_count(self) -> builtins.int:
        """
    ...
    def local_administrator(self) -> builtins.str:
        """
    ...
    def managed_virtual_network_regions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def network_connection_name(self) -> builtins.str:
        """
    ...
    def single_sign_on_status(self) -> Optional[builtins.str]:
        """
...
def get_pool(pool_name: Optional[builtins.str] = None,
    ...
    :param builtins.str pool_name: Name of the pool.
