...
def get_project_catalog_environment_definition_error_details(catalog_name: Optional[_builtins.str] = None,
                                                             environment_definition_name: Optional[_builtins.str] = None,
