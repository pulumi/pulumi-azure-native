...
def get_project_policy(dev_center_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getProjectPolicy', __args__, opts=opts, typ=GetProjectPolicyResult).value
...
def get_project_policy_output(dev_center_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getProjectPolicy', __args__, opts=opts, typ=GetProjectPolicyResult)
