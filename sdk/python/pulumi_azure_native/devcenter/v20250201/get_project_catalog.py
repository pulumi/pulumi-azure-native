...
def get_project_catalog(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getProjectCatalog', __args__, opts=opts, typ=GetProjectCatalogResult).value
...
def get_project_catalog_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getProjectCatalog', __args__, opts=opts, typ=GetProjectCatalogResult)
