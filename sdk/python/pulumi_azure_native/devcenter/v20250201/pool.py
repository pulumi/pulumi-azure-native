...
class PoolArgs:
    def __init__(__self__, *,
                 ...
                 stop_on_no_connect: Optional[pulumi.Input['StopOnNoConnectConfigurationArgs']] = None,
        ...
        :param pulumi.Input['StopOnNoConnectConfigurationArgs'] stop_on_no_connect: Stop on no connect configuration settings for Dev Boxes created in this pool.
    ...
    def stop_on_no_connect(self) -> Optional[pulumi.Input['StopOnNoConnectConfigurationArgs']]:
        """
        Stop on no connect configuration settings for Dev Boxes created in this pool.
        """
        return pulumi.get(self, "stop_on_no_connect")

    @stop_on_no_connect.setter
    def stop_on_no_connect(self, value: Optional[pulumi.Input['StopOnNoConnectConfigurationArgs']]):
        pulumi.set(self, "stop_on_no_connect", value)
...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 stop_on_no_connect: Optional[pulumi.Input[Union['StopOnNoConnectConfigurationArgs', 'StopOnNoConnectConfigurationArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 virtual_network_type: Optional[pulumi.Input[Union[str, 'VirtualNetworkType']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['StopOnNoConnectConfigurationArgs', 'StopOnNoConnectConfigurationArgsDict']] stop_on_no_connect: Stop on no connect configuration settings for Dev Boxes created in this pool.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Resource tags.
        :param pulumi.Input[Union[str, 'VirtualNetworkType']] virtual_network_type: Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
        """
        ...
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["stop_on_no_connect"] = stop_on_no_connect
        ...
        super(Pool, __self__).__init__(
            'azure-native:devcenter/v20250201:Pool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["stop_on_no_connect"] = None
        __props__.__dict__["system_data"] = None
    ...
    @property
    @pulumi.getter(name="stopOnNoConnect")
    def stop_on_no_connect(self) -> pulumi.Output[Optional['outputs.StopOnNoConnectConfigurationResponse']]:
        """
        Stop on no connect configuration settings for Dev Boxes created in this pool.
        """
        return pulumi.get(self, "stop_on_no_connect")
