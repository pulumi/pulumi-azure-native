...
class ResourcePolicyResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A resource policy.
        :param str action: Policy action to be taken on the resources. This is optional, and defaults to allow
        :param str filter: Optional. When specified, this expression is used to filter the resources.
        :param str resource_type: Optional. The resource type being restricted or allowed by a project policy. Used with a given action to restrict or allow access to a resource type.
