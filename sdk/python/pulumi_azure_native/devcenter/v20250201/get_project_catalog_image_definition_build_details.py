...
def get_project_catalog_image_definition_build_details(build_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionBuildDetails', __args__, opts=opts, typ=GetProjectCatalogImageDefinitionBuildDetailsResult).value
...
def get_project_catalog_image_definition_build_details_output(build_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionBuildDetails', __args__, opts=opts, typ=GetProjectCatalogImageDefinitionBuildDetailsResult)
