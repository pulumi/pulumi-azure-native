...
if not MYPY:
    class ResourcePolicyArgsDict(TypedDict):
        ...
        A resource policy.
        """
        action: NotRequired[pulumi.Input[Union[str, 'PolicyAction']]]
        """
        ...
        """
        resource_type: NotRequired[pulumi.Input[Union[str, 'DevCenterResourceType']]]
        """
...
class ResourcePolicyArgs:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[Union[str, 'PolicyAction']]] = None,
                 filter: Optional[pulumi.Input[str]] = None,
                 resource_type: Optional[pulumi.Input[Union[str, 'DevCenterResourceType']]] = None,
                 resources: Optional[pulumi.Input[str]] = None):
        """
        A resource policy.
        :param pulumi.Input[Union[str, 'PolicyAction']] action: Policy action to be taken on the resources. This is optional, and defaults to allow
        :param pulumi.Input[str] filter: Optional. When specified, this expression is used to filter the resources.
        :param pulumi.Input[Union[str, 'DevCenterResourceType']] resource_type: Optional. The resource type being restricted or allowed by a project policy. Used with a given action to restrict or allow access to a resource type.
    ...
    @property
    @pulumi.getter
    def action(self) -> Optional[pulumi.Input[Union[str, 'PolicyAction']]]:
        """
        Policy action to be taken on the resources. This is optional, and defaults to allow
        """
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Union[str, 'PolicyAction']]]):
    ...
    def resource_type(self) -> Optional[pulumi.Input[Union[str, 'DevCenterResourceType']]]:
        """
        Optional. The resource type being restricted or allowed by a project policy. Used with a given action to restrict or allow access to a resource type.
        """
    ...
    def resource_type(self, value: Optional[pulumi.Input[Union[str, 'DevCenterResourceType']]]):
