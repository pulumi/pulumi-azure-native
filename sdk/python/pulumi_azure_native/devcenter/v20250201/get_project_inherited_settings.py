...
def get_project_inherited_settings(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getProjectInheritedSettings', __args__, opts=opts, typ=GetProjectInheritedSettingsResult).value
...
def get_project_inherited_settings_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getProjectInheritedSettings', __args__, opts=opts, typ=GetProjectInheritedSettingsResult)
