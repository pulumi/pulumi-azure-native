...
def get_schedule(pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
...
def get_schedule_output(pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getSchedule', __args__, opts=opts, typ=GetScheduleResult)
