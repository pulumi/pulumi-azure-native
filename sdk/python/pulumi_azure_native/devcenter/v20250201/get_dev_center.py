...
class GetDevCenterResult:
    ...
    """
    def __init__(__self__, dev_box_provisioning_settings=None, dev_center_uri=None, display_name=None, encryption=None, id=None, identity=None, location=None, name=None, network_settings=None, project_catalog_settings=None, provisioning_state=None, system_data=None, tags=None, type=None):
...
def get_dev_center(dev_center_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getDevCenter', __args__, opts=opts, typ=GetDevCenterResult).value
...
def get_dev_center_output(dev_center_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getDevCenter', __args__, opts=opts, typ=GetDevCenterResult)
