...
def get_project_catalog_image_definition_error_details(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionErrorDetails', __args__, opts=opts, typ=GetProjectCatalogImageDefinitionErrorDetailsResult).value
...
def get_project_catalog_image_definition_error_details_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:getProjectCatalogImageDefinitionErrorDetails', __args__, opts=opts, typ=GetProjectCatalogImageDefinitionErrorDetailsResult)
