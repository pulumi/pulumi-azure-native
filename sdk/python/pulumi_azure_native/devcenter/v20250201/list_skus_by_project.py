...
def list_skus_by_project(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20250201:listSkusByProject', __args__, opts=opts, typ=ListSkusByProjectResult).value
...
def list_skus_by_project_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20250201:listSkusByProject', __args__, opts=opts, typ=ListSkusByProjectResult)
