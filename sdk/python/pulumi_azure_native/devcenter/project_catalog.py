...
class ProjectCatalog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20240201:ProjectCatalog"), pulumi.Alias(type_="azure-native:devcenter/v20240501preview:ProjectCatalog"), pulumi.Alias(type_="azure-native:devcenter/v20240601preview:ProjectCatalog"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:ProjectCatalog"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:ProjectCatalog"), pulumi.Alias(type_="azure-native:devcenter/v20241001preview:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20240201:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20240501preview:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20240601preview:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20240701preview:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20240801preview:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20241001preview:devcenter:ProjectCatalog"), pulumi.Alias(type_="azure-native_devcenter_v20250201:devcenter:ProjectCatalog")])
