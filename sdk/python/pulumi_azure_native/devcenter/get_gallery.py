...
class GetGalleryResult:
    ...
    def gallery_resource_id(self) -> _builtins.str:
        """
...
def get_gallery(dev_center_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str gallery_name: The name of the gallery.
...
def get_gallery_output(dev_center_name: pulumi.Input[Optional[_builtins.str]] = None,
                       gallery_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
