...
class GetGalleryResult:
    ...
    def gallery_resource_id(self) -> builtins.str:
        """
...
def get_gallery(dev_center_name: Optional[builtins.str] = None,
    ...
    :param builtins.str gallery_name: The name of the gallery.
...
def get_gallery_output(dev_center_name: Optional[pulumi.Input[builtins.str]] = None,
