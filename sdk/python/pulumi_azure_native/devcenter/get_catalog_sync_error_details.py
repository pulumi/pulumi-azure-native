...
def get_catalog_sync_error_details(catalog_name: Optional[_builtins.str] = None,
...
def get_catalog_sync_error_details_output(catalog_name: Optional[pulumi.Input[_builtins.str]] = None,
