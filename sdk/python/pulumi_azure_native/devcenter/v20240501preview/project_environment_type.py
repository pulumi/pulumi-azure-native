...
class ProjectEnvironmentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230401:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230801preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20231001preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240201:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240601preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:ProjectEnvironmentType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectEnvironmentType, __self__).__init__(
            'azure-native:devcenter/v20240501preview:ProjectEnvironmentType',
            resource_name,
            __props__,
            opts)
