...
class EnvironmentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20220801preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230401:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230801preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20231001preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240201:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240601preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20241001preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter:EnvironmentType")])
