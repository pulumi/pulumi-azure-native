...
def get_plan(plan_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240501preview:getPlan', __args__, opts=opts, typ=GetPlanResult).value
...
def get_plan_output(plan_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240501preview:getPlan', __args__, opts=opts, typ=GetPlanResult)
