...
def get_attached_network_by_dev_center(attached_network_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240201:getAttachedNetworkByDevCenter', __args__, opts=opts, typ=GetAttachedNetworkByDevCenterResult).value
...
def get_attached_network_by_dev_center_output(attached_network_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240201:getAttachedNetworkByDevCenter', __args__, opts=opts, typ=GetAttachedNetworkByDevCenterResult)
