...
def get_dev_box_definition(dev_box_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240201:getDevBoxDefinition', __args__, opts=opts, typ=GetDevBoxDefinitionResult).value
...
def get_dev_box_definition_output(dev_box_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240201:getDevBoxDefinition', __args__, opts=opts, typ=GetDevBoxDefinitionResult)
