...
class GetEncryptionSetResult:
    ...
    def devbox_disks_encryption_enable_status(self) -> Optional[builtins.str]:
        """
...
def get_encryption_set(dev_center_name: Optional[builtins.str] = None,
                       encryption_set_name: Optional[builtins.str] = None,
    ...
    :param builtins.str encryption_set_name: The name of the devcenter encryption set.
...
def get_encryption_set_output(dev_center_name: Optional[pulumi.Input[builtins.str]] = None,
