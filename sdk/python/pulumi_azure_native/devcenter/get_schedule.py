...
def get_schedule(pool_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str schedule_name: The name of the schedule that uniquely identifies it.
    :param _builtins.int top: The maximum number of resources to return from the operation. Example: '$top=10'.
    """
    __args__ = dict()
