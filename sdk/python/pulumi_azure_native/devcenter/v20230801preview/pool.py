...
class PoolArgs:
    ...
    def _configure(
        ...
        if dev_box_definition_name is None:
            raise TypeError("Missing 'dev_box_definition_name' argument")
        if license_type is None and 'licenseType' in kwargs:
            license_type = kwargs['licenseType']
        if license_type is None:
            raise TypeError("Missing 'license_type' argument")
        if local_administrator is None and 'localAdministrator' in kwargs:
            local_administrator = kwargs['localAdministrator']
        if local_administrator is None:
            raise TypeError("Missing 'local_administrator' argument")
        ...
        if network_connection_name is None:
            raise TypeError("Missing 'network_connection_name' argument")
        ...
        if single_sign_on_status is None and 'singleSignOnStatus' in kwargs:
            single_sign_on_status = kwargs['singleSignOnStatus']
        if stop_on_disconnect is None and 'stopOnDisconnect' in kwargs:
...
class Pool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            stop_on_disconnect = _utilities.configure(stop_on_disconnect, StopOnDisconnectConfigurationArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20230401:Pool"), pulumi.Alias(type_="azure-native:devcenter/v20231001preview:Pool")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Pool, __self__).__init__(
            'azure-native:devcenter/v20230801preview:Pool',
            resource_name,
            __props__,
            opts)
