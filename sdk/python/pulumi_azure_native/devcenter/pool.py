...
class PoolArgs:
    def __init__(__self__, *,
                 dev_box_definition_name: pulumi.Input[builtins.str],
                 license_type: pulumi.Input[Union[builtins.str, 'LicenseType']],
                 local_administrator: pulumi.Input[Union[builtins.str, 'LocalAdminStatus']],
                 network_connection_name: pulumi.Input[builtins.str],
                 project_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 managed_virtual_network_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 single_sign_on_status: Optional[pulumi.Input[Union[builtins.str, 'SingleSignOnStatus']]] = None,
                 stop_on_disconnect: Optional[pulumi.Input['StopOnDisconnectConfigurationArgs']] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 virtual_network_type: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkType']]] = None):
        """
        The set of arguments for constructing a Pool resource.
        :param pulumi.Input[builtins.str] dev_box_definition_name: Name of a Dev Box definition in parent Project of this Pool
        :param pulumi.Input[Union[builtins.str, 'LicenseType']] license_type: Specifies the license type indicating the caller has already acquired licenses for the Dev Boxes that will be created.
        :param pulumi.Input[Union[builtins.str, 'LocalAdminStatus']] local_administrator: Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        :param pulumi.Input[builtins.str] network_connection_name: Name of a Network Connection in parent Project of this Pool
        :param pulumi.Input[builtins.str] project_name: The name of the project.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[builtins.str] display_name: The display name of the pool.
        :param pulumi.Input[builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] managed_virtual_network_regions: The regions of the managed virtual network (required when managedNetworkType is Managed).
        :param pulumi.Input[builtins.str] pool_name: Name of the pool.
        :param pulumi.Input[Union[builtins.str, 'SingleSignOnStatus']] single_sign_on_status: Indicates whether Dev Boxes in this pool are created with single sign on enabled. The also requires that single sign on be enabled on the tenant.
        ...
        :param pulumi.Input[Union[builtins.str, 'VirtualNetworkType']] virtual_network_type: Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
        """
    ...
    def dev_box_definition_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dev_box_definition_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dev_box_definition_name", value)

    @property
    @pulumi.getter(name="licenseType")
    def license_type(self) -> pulumi.Input[Union[builtins.str, 'LicenseType']]:
        """
    ...
    @license_type.setter
    def license_type(self, value: pulumi.Input[Union[builtins.str, 'LicenseType']]):
        pulumi.set(self, "license_type", value)

    @property
    @pulumi.getter(name="localAdministrator")
    def local_administrator(self) -> pulumi.Input[Union[builtins.str, 'LocalAdminStatus']]:
        """
    ...
    def local_administrator(self, value: pulumi.Input[Union[builtins.str, 'LocalAdminStatus']]):
        pulumi.set(self, "local_administrator", value)

    @property
    @pulumi.getter(name="networkConnectionName")
    def network_connection_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_connection_name(self, value: pulumi.Input[builtins.str]):
    ...
    def managed_virtual_network_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def managed_virtual_network_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def single_sign_on_status(self) -> Optional[pulumi.Input[Union[builtins.str, 'SingleSignOnStatus']]]:
        """
    ...
    def single_sign_on_status(self, value: Optional[pulumi.Input[Union[builtins.str, 'SingleSignOnStatus']]]):
    ...
    def virtual_network_type(self) -> Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkType']]]:
        """
    ...
    def virtual_network_type(self, value: Optional[pulumi.Input[Union[builtins.str, 'VirtualNetworkType']]]):
...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 local_administrator: Optional[pulumi.Input[Union[builtins.str, 'LocalAdminStatus']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 managed_virtual_network_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 network_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 pool_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def dev_box_count(self) -> pulumi.Output[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="devBoxDefinitionName")
    def dev_box_definition_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of a Dev Box definition in parent Project of this Pool
        """
        return pulumi.get(self, "dev_box_definition_name")
    ...
    def health_status(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="localAdministrator")
    def local_administrator(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether owners of Dev Boxes in this pool are added as local administrators on the Dev Box.
        """
        return pulumi.get(self, "local_administrator")
    ...
    @property
    @pulumi.getter(name="managedVirtualNetworkRegions")
    def managed_virtual_network_regions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The regions of the managed virtual network (required when managedNetworkType is Managed).
        """
        return pulumi.get(self, "managed_virtual_network_regions")
    ...
    @property
    @pulumi.getter(name="networkConnectionName")
    def network_connection_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of a Network Connection in parent Project of this Pool
        """
        return pulumi.get(self, "network_connection_name")
    ...
    @property
    @pulumi.getter(name="singleSignOnStatus")
    def single_sign_on_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether Dev Boxes in this pool are created with single sign on enabled. The also requires that single sign on be enabled on the tenant.
        """
        return pulumi.get(self, "single_sign_on_status")
    ...
    @property
    @pulumi.getter(name="virtualNetworkType")
    def virtual_network_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether the pool uses a Virtual Network managed by Microsoft or a customer provided network.
        """
        return pulumi.get(self, "virtual_network_type")
