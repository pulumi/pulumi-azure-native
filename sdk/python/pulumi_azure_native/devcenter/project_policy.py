...
class ProjectPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Other available API versions: 2025-02-01, 2025-04-01-preview, 2025-07-01-preview, 2025-10-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native devcenter [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20241001preview:ProjectPolicy"), pulumi.Alias(type_="azure-native:devcenter/v20250201:ProjectPolicy"), pulumi.Alias(type_="azure-native:devcenter/v20250401preview:ProjectPolicy"), pulumi.Alias(type_="azure-native:devcenter/v20250701preview:ProjectPolicy"), pulumi.Alias(type_="azure-native:devcenter/v20251001preview:ProjectPolicy")])
