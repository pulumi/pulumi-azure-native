...
class ProjectPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] project_policy_name: The name of the project policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: Resources that have access to the shared resources that are a part of this project policy.
        """
    ...
    def project_policy_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def project_policy_name(self, value: Optional[pulumi.Input[str]]):
...
class ProjectPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20241001preview:ProjectPolicy"), pulumi.Alias(type_="azure-native_devcenter_v20241001preview:devcenter:ProjectPolicy"), pulumi.Alias(type_="azure-native_devcenter_v20250201:devcenter:ProjectPolicy")])
