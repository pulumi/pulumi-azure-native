...
def get_project_catalog_image_definition_build_details(build_name: Optional[builtins.str] = None,
...
def get_project_catalog_image_definition_build_details_output(build_name: Optional[pulumi.Input[builtins.str]] = None,
