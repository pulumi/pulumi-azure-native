...
def get_project_catalog_image_definition_build_details(build_name: Optional[_builtins.str] = None,
                                                       catalog_name: Optional[_builtins.str] = None,
                                                       image_definition_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str build_name: The ID of the Image Definition Build.
