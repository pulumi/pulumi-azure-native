...
def get_catalog_sync_error_details(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240601preview:getCatalogSyncErrorDetails', __args__, opts=opts, typ=GetCatalogSyncErrorDetailsResult).value
...
def get_catalog_sync_error_details_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240601preview:getCatalogSyncErrorDetails', __args__, opts=opts, typ=GetCatalogSyncErrorDetailsResult)
