...
class PlanMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:PlanMember"), pulumi.Alias(type_="azure-native:devcenter/v20240501preview:PlanMember"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:PlanMember")])
