...
class EncryptionSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:EncryptionSet"), pulumi.Alias(type_="azure-native:devcenter/v20240501preview:EncryptionSet"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:EncryptionSet"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:EncryptionSet")])
