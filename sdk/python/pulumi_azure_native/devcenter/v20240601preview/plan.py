...
class Plan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240501preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:Plan")])
