...
class GetPlanResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, id=None, location=None, name=None, provisioning_state=None, sku=None, system_data=None, tags=None, type=None):
...
def get_plan(plan_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str plan_name: The name of the devcenter plan.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter:getPlan', __args__, opts=opts, typ=GetPlanResult).value
...
def get_plan_output(plan_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter:getPlan', __args__, opts=opts, typ=GetPlanResult)
