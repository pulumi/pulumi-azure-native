...
warnings.warn("""azure-native:devcenter/v20221111preview:Project is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Project to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_project(project_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project is deprecated: azure-native:devcenter/v20221111preview:Project is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Project to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['projectName'] = project_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20221111preview:getProject', __args__, opts=opts, typ=GetProjectResult).value
