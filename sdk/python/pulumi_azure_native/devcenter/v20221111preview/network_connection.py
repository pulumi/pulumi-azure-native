...
class NetworkConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network_connection = azure_native.devcenter.v20221111preview.NetworkConnection("networkConnection",
        ...
        ```sh
        $ pulumi import azure-native:devcenter/v20221111preview:NetworkConnection uswest3network /subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.DevCenter/networkconnections/uswest3network 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:NetworkConnection"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:NetworkConnection"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:NetworkConnection"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:NetworkConnection"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:NetworkConnection")])
