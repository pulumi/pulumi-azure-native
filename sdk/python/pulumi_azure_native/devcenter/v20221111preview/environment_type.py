...
class EnvironmentType(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        environment_type = azure_native.devcenter.v20221111preview.EnvironmentType("environmentType",
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:EnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20230101preview:EnvironmentType")])
