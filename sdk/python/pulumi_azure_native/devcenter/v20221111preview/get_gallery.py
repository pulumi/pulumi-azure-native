...
def get_gallery(dev_center_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20221111preview:getGallery', __args__, opts=opts, typ=GetGalleryResult).value
...
def get_gallery_output(dev_center_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20221111preview:getGallery', __args__, opts=opts, typ=GetGalleryResult)
