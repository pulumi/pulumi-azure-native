...
def get_project_environment_type_output(environment_type_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240701preview:getProjectEnvironmentType', __args__, opts=opts, typ=GetProjectEnvironmentTypeResult)
