...
warnings.warn("""azure-native:devcenter/v20221012preview:Pool is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Pool to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_pool(pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_pool is deprecated: azure-native:devcenter/v20221012preview:Pool is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:Pool to guarantee forwards compatibility.""")
    __args__ = dict()
