...
def get_environment_type(dev_center_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment_type is deprecated: azure-native:devcenter/v20221012preview:EnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:EnvironmentType to guarantee forwards compatibility.""")
    __args__ = dict()
