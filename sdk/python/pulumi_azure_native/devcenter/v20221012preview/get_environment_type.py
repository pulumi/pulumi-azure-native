...
def get_environment_type(dev_center_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment_type is deprecated: azure-native:devcenter/v20221012preview:EnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:EnvironmentType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['devCenterName'] = dev_center_name
    __args__['environmentTypeName'] = environment_type_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20221012preview:getEnvironmentType', __args__, opts=opts, typ=GetEnvironmentTypeResult).value
