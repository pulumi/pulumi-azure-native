...
def get_dev_box_definition(dev_box_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_box_definition is deprecated: azure-native:devcenter/v20221012preview:DevBoxDefinition is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
