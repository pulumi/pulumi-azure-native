...
def get_dev_center(dev_center_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_center is deprecated: azure-native:devcenter/v20221012preview:DevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:DevCenter to guarantee forwards compatibility.""")
    __args__ = dict()
