...
class AttachedNetworkByDevCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""AttachedNetworkByDevCenter is deprecated: azure-native:devcenter/v20221012preview:AttachedNetworkByDevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:AttachedNetworkByDevCenter to guarantee forwards compatibility.""")
