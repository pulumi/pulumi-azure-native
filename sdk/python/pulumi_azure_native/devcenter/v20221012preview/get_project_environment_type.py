...
warnings.warn("""azure-native:devcenter/v20221012preview:ProjectEnvironmentType is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:ProjectEnvironmentType to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_project_environment_type(environment_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project_environment_type is deprecated: azure-native:devcenter/v20221012preview:ProjectEnvironmentType is being removed in the next major version of this provider. Please upgrade to azure-native:devcenter/v20221111preview:ProjectEnvironmentType to guarantee forwards compatibility.""")
    __args__ = dict()
