...
def get_catalog(catalog_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_catalog is deprecated: azure-native:devcenter/v20221012preview:Catalog is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:Catalog to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['catalogName'] = catalog_name
    __args__['devCenterName'] = dev_center_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20221012preview:getCatalog', __args__, opts=opts, typ=GetCatalogResult).value
