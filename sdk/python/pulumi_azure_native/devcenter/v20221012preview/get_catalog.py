...
def get_catalog(catalog_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_catalog is deprecated: azure-native:devcenter/v20221012preview:Catalog is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Catalog to guarantee forwards compatibility.""")
    __args__ = dict()
