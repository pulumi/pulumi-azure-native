...
def get_gallery(dev_center_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery is deprecated: azure-native:devcenter/v20221012preview:Gallery is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Gallery to guarantee forwards compatibility.""")
    __args__ = dict()
