...
def get_plan_member(member_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str member_name: The name of a devcenter plan member.
...
def get_plan_member_output(member_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
