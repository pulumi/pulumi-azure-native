...
def get_dev_box_definition(dev_box_definition_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20230101preview:getDevBoxDefinition', __args__, opts=opts, typ=GetDevBoxDefinitionResult).value
...
def get_dev_box_definition_output(dev_box_definition_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20230101preview:getDevBoxDefinition', __args__, opts=opts, typ=GetDevBoxDefinitionResult)
