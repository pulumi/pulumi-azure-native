...
class Catalog(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20220901preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20230401:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20230801preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20231001preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20240201:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20240501preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20240601preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:Catalog"), pulumi.Alias(type_="azure-native:devcenter/v20241001preview:Catalog")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Catalog, __self__).__init__(
            'azure-native:devcenter/v20230101preview:Catalog',
            resource_name,
            __props__,
            opts)
