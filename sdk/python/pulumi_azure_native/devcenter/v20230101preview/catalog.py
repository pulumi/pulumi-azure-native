...
class Catalog(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        catalog = azure_native.devcenter.v20230101preview.Catalog("catalog",
            ado_git=azure_native.devcenter.v20230101preview.GitCatalogArgs(
                branch="main",
                path="/templates",
        ...
        catalog = azure_native.devcenter.v20230101preview.Catalog("catalog",
            catalog_name="CentralCatalog",
            dev_center_name="Contoso",
            git_hub=azure_native.devcenter.v20230101preview.GitCatalogArgs(
                branch="main",
                path="/templates",
                secret_identifier="https://contosokv.vault.azure.net/secrets/CentralRepoPat",
        ...
        ```sh
        $ pulumi import azure-native:devcenter/v20230101preview:Catalog CentralCatalog /subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.DevCenter/devcenters/Contoso/catalogs/CentralCatalog 
        ```
