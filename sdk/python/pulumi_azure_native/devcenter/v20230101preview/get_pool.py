...
def get_pool(pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20230101preview:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20230101preview:getPool', __args__, opts=opts, typ=GetPoolResult)
