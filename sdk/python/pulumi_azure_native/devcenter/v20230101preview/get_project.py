...
def get_project(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20230101preview:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20230101preview:getProject', __args__, opts=opts, typ=GetProjectResult)
