...
def get_network_connection(network_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20230101preview:getNetworkConnection', __args__, opts=opts, typ=GetNetworkConnectionResult).value
...
def get_network_connection_output(network_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20230101preview:getNetworkConnection', __args__, opts=opts, typ=GetNetworkConnectionResult)
