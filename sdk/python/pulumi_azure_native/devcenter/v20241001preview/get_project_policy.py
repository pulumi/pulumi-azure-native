...
def get_project_policy(dev_center_name: Optional[str] = None,
                       project_policy_name: Optional[str] = None,
    ...
    __args__['projectPolicyName'] = project_policy_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20241001preview:getProjectPolicy', __args__, opts=opts, typ=GetProjectPolicyResult).value
...
def get_project_policy_output(dev_center_name: Optional[pulumi.Input[str]] = None,
                              project_policy_name: Optional[pulumi.Input[str]] = None,
                              resource_group_name: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetProjectPolicyResult]:
    """
    Gets a specific project policy.
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20241001preview:getProjectPolicy', __args__, opts=opts, typ=GetProjectPolicyResult)
