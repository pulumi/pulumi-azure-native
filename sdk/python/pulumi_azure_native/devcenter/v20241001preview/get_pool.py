...
class GetPoolResult:
    ...
    def __init__(__self__, dev_box_count=None, dev_box_definition=None, dev_box_definition_name=None, dev_box_definition_type=None, display_name=None, health_status=None, health_status_details=None, id=None, license_type=None, local_administrator=None, location=None, managed_virtual_network_regions=None, name=None, network_connection_name=None, provisioning_state=None, single_sign_on_status=None, stop_on_disconnect=None, stop_on_no_connect=None, system_data=None, tags=None, type=None, virtual_network_type=None):
        ...
        if dev_box_definition and not isinstance(dev_box_definition, dict):
            raise TypeError("Expected argument 'dev_box_definition' to be a dict")
        ...
        if dev_box_definition_type and not isinstance(dev_box_definition_type, str):
            raise TypeError("Expected argument 'dev_box_definition_type' to be a str")
        ...
        if stop_on_no_connect and not isinstance(stop_on_no_connect, dict):
            raise TypeError("Expected argument 'stop_on_no_connect' to be a dict")
        pulumi.set(__self__, "stop_on_no_connect", stop_on_no_connect)
    ...
    def dev_box_definition(self) -> Optional['outputs.PoolDevBoxDefinitionResponse']:
        """
    ...
    def dev_box_definition_type(self) -> Optional[str]:
        """
    ...
    @property
    @pulumi.getter(name="stopOnNoConnect")
    def stop_on_no_connect(self) -> Optional['outputs.StopOnNoConnectConfigurationResponse']:
        """
        Stop on no connect configuration settings for Dev Boxes created in this pool.
        """
        return pulumi.get(self, "stop_on_no_connect")
...
class AwaitableGetPoolResult(GetPoolResult):
    ...
    def __await__(self):
        ...
        return GetPoolResult(
            ...
            dev_box_definition=self.dev_box_definition,
            dev_box_definition_name=self.dev_box_definition_name,
            dev_box_definition_type=self.dev_box_definition_type,
            ...
            stop_on_no_connect=self.stop_on_no_connect,
...
def get_pool(pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20241001preview:getPool', __args__, opts=opts, typ=GetPoolResult).value

    return AwaitableGetPoolResult(
        dev_box_count=pulumi.get(__ret__, 'dev_box_count'),
        dev_box_definition=pulumi.get(__ret__, 'dev_box_definition'),
        ...
        stop_on_no_connect=pulumi.get(__ret__, 'stop_on_no_connect'),
...
def get_pool_output(pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20241001preview:getPool', __args__, opts=opts, typ=GetPoolResult)
    return __ret__.apply(lambda __response__: GetPoolResult(
        dev_box_count=pulumi.get(__response__, 'dev_box_count'),
        dev_box_definition=pulumi.get(__response__, 'dev_box_definition'),
        dev_box_definition_name=pulumi.get(__response__, 'dev_box_definition_name'),
        dev_box_definition_type=pulumi.get(__response__, 'dev_box_definition_type'),
        ...
        stop_on_no_connect=pulumi.get(__response__, 'stop_on_no_connect'),
