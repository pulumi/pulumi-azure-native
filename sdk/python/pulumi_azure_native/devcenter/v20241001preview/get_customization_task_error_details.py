...
def get_customization_task_error_details(catalog_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20241001preview:getCustomizationTaskErrorDetails', __args__, opts=opts, typ=GetCustomizationTaskErrorDetailsResult).value
...
def get_customization_task_error_details_output(catalog_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['taskName'] = task_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20241001preview:getCustomizationTaskErrorDetails', __args__, opts=opts, typ=GetCustomizationTaskErrorDetailsResult)
