...
class CurationProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:CurationProfile"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:CurationProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CurationProfile, __self__).__init__(
            'azure-native:devcenter/v20241001preview:CurationProfile',
            resource_name,
            __props__,
            opts)
