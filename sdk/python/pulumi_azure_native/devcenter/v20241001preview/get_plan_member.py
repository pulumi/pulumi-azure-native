...
def get_plan_member(member_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20241001preview:getPlanMember', __args__, opts=opts, typ=GetPlanMemberResult).value
...
def get_plan_member_output(member_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20241001preview:getPlanMember', __args__, opts=opts, typ=GetPlanMemberResult)
