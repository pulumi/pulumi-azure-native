...
class DevCenterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union[str, 'DevCenterResourceType']]]] restricted_resource_types: Indicates the resource types that are restricted from being accessed by a project unless allowed by a project policy.
