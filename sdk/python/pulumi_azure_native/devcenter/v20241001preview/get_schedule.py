...
def get_schedule(pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20241001preview:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
...
def get_schedule_output(pool_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['top'] = top
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20241001preview:getSchedule', __args__, opts=opts, typ=GetScheduleResult)
