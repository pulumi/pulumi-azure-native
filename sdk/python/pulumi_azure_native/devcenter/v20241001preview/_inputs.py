...
__all__ = [
    ...
    'StopOnNoConnectConfigurationArgsDict',
...
if not MYPY:
    class StopOnNoConnectConfigurationArgsDict(TypedDict):
        """
        ...
        """
        status: NotRequired[pulumi.Input[Union[str, 'StopOnNoConnectEnableStatus']]]
        """
        Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
        """
elif False:
    StopOnNoConnectConfigurationArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class StopOnNoConnectConfigurationArgs:
    def __init__(__self__, *,
                 grace_period_minutes: Optional[pulumi.Input[int]] = None,
                 status: Optional[pulumi.Input[Union[str, 'StopOnNoConnectEnableStatus']]] = None):
        """
        Stop on no connect configuration settings for Dev Boxes created in this pool.
        :param pulumi.Input[int] grace_period_minutes: The specified time in minutes to wait before stopping a Dev Box if no connection is made.
        :param pulumi.Input[Union[str, 'StopOnNoConnectEnableStatus']] status: Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
        """
        if grace_period_minutes is not None:
            pulumi.set(__self__, "grace_period_minutes", grace_period_minutes)
        if status is not None:
    ...
    @property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input[Union[str, 'StopOnNoConnectEnableStatus']]]:
        """
        Enables the feature to stop a started Dev Box when it has not been connected to, once the grace period has lapsed.
        """
        return pulumi.get(self, "status")
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[str, 'StopOnNoConnectEnableStatus']]]):
        pulumi.set(self, "status", value)
