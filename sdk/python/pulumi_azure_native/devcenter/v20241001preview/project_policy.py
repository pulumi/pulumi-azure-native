...
class ProjectPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20250201:ProjectPolicy"), pulumi.Alias(type_="azure-native:devcenter:ProjectPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectPolicy, __self__).__init__(
            'azure-native:devcenter/v20241001preview:ProjectPolicy',
            resource_name,
            __props__,
            opts)
