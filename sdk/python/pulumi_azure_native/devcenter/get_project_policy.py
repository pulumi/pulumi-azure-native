...
def get_project_policy(dev_center_name: Optional[builtins.str] = None,
                       project_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str project_policy_name: The name of the project policy.
...
def get_project_policy_output(dev_center_name: Optional[pulumi.Input[builtins.str]] = None,
