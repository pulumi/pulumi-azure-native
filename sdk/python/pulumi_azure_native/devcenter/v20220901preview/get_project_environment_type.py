...
def get_project_environment_type(environment_type_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project_environment_type is deprecated: azure-native:devcenter/v20220901preview:ProjectEnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:ProjectEnvironmentType to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['environmentTypeName'] = environment_type_name
    __args__['projectName'] = project_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20220901preview:getProjectEnvironmentType', __args__, opts=opts, typ=GetProjectEnvironmentTypeResult).value
