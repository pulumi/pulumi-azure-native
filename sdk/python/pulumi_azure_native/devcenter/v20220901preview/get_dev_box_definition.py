...
def get_dev_box_definition(dev_box_definition_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dev_box_definition is deprecated: azure-native:devcenter/v20220901preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['devBoxDefinitionName'] = dev_box_definition_name
    __args__['devCenterName'] = dev_center_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20220901preview:getDevBoxDefinition', __args__, opts=opts, typ=GetDevBoxDefinitionResult).value
