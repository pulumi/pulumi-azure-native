...
def get_network_connection(network_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_network_connection is deprecated: azure-native:devcenter/v20220901preview:NetworkConnection is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:NetworkConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['networkConnectionName'] = network_connection_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20220901preview:getNetworkConnection', __args__, opts=opts, typ=GetNetworkConnectionResult).value
