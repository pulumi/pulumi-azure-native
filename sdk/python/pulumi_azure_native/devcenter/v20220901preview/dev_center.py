...
warnings.warn("""azure-native:devcenter/v20220901preview:DevCenter is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:DevCenter to guarantee forwards compatibility.""", DeprecationWarning)
...
class DevCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:DevCenter"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:DevCenter"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:DevCenter"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:DevCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DevCenter, __self__).__init__(
            'azure-native:devcenter/v20220901preview:DevCenter',
            resource_name,
            __props__,
            opts)
