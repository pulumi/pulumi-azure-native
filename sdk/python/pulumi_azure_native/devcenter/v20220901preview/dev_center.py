...
class DevCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        dev_center = azure_native.devcenter.v20220901preview.DevCenter("devCenter",
