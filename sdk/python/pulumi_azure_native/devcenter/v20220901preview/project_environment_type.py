...
warnings.warn("""azure-native:devcenter/v20220901preview:ProjectEnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:ProjectEnvironmentType to guarantee forwards compatibility.""", DeprecationWarning)
...
class ProjectEnvironmentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 user_role_assignments: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['UserRoleAssignmentArgs']]]]] = None,
                 __props__=None):
        pulumi.log.warn("""ProjectEnvironmentType is deprecated: azure-native:devcenter/v20220901preview:ProjectEnvironmentType is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:ProjectEnvironmentType to guarantee forwards compatibility.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20220801preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221012preview:ProjectEnvironmentType"), pulumi.Alias(type_="azure-native:devcenter/v20221111preview:ProjectEnvironmentType")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProjectEnvironmentType, __self__).__init__(
            'azure-native:devcenter/v20220901preview:ProjectEnvironmentType',
            resource_name,
            __props__,
            opts)
