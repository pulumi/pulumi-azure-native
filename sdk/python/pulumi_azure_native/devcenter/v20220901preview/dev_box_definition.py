...
warnings.warn("""azure-native:devcenter/v20220901preview:DevBoxDefinition is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20221111preview:DevBoxDefinition to guarantee forwards compatibility.""", DeprecationWarning)
...
class DevBoxDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DevBoxDefinition, __self__).__init__(
            'azure-native:devcenter/v20220901preview:DevBoxDefinition',
            resource_name,
            __props__,
            opts)
