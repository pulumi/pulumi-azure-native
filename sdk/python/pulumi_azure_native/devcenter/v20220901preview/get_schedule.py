...
warnings.warn("""azure-native:devcenter/v20220901preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Schedule to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_schedule(pool_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_schedule is deprecated: azure-native:devcenter/v20220901preview:Schedule is being removed in the next major version of this provider. Upgrade to at least azure-native:devcenter/v20230401:Schedule to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20220901preview:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
