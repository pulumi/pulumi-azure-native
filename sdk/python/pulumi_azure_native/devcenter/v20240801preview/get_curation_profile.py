...
def get_curation_profile(curation_profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240801preview:getCurationProfile', __args__, opts=opts, typ=GetCurationProfileResult).value
...
def get_curation_profile_output(curation_profile_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240801preview:getCurationProfile', __args__, opts=opts, typ=GetCurationProfileResult)
