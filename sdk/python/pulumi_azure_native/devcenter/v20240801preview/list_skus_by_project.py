...
def list_skus_by_project(project_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter/v20240801preview:listSkusByProject', __args__, opts=opts, typ=ListSkusByProjectResult).value
...
def list_skus_by_project_output(project_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter/v20240801preview:listSkusByProject', __args__, opts=opts, typ=ListSkusByProjectResult)
