...
def get_customization_task_error_details(catalog_name: Optional[builtins.str] = None,
    ...
    :param builtins.str task_name: The name of the Task.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devcenter:getCustomizationTaskErrorDetails', __args__, opts=opts, typ=GetCustomizationTaskErrorDetailsResult).value

    return AwaitableGetCustomizationTaskErrorDetailsResult(
        errors=pulumi.get(__ret__, 'errors'))
def get_customization_task_error_details_output(catalog_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:devcenter:getCustomizationTaskErrorDetails', __args__, opts=opts, typ=GetCustomizationTaskErrorDetailsResult)
