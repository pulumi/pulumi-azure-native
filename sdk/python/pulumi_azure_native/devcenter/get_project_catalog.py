...
def get_project_catalog(catalog_name: Optional[_builtins.str] = None,
...
def get_project_catalog_output(catalog_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
