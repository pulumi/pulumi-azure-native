...
class Plan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:devcenter/v20240501preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240601preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240701preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20240801preview:Plan"), pulumi.Alias(type_="azure-native:devcenter/v20241001preview:Plan"), pulumi.Alias(type_="azure-native_devcenter_v20240501preview:devcenter:Plan"), pulumi.Alias(type_="azure-native_devcenter_v20240601preview:devcenter:Plan"), pulumi.Alias(type_="azure-native_devcenter_v20240701preview:devcenter:Plan"), pulumi.Alias(type_="azure-native_devcenter_v20240801preview:devcenter:Plan"), pulumi.Alias(type_="azure-native_devcenter_v20241001preview:devcenter:Plan")])
