...
def get_document_processor(processor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:syntex/v20220915preview:getDocumentProcessor', __args__, opts=opts, typ=GetDocumentProcessorResult).value
...
def get_document_processor_output(processor_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:syntex/v20220915preview:getDocumentProcessor', __args__, opts=opts, typ=GetDocumentProcessorResult)
