...
def get_document_processor(processor_name: Optional[_builtins.str] = None,
...
def get_document_processor_output(processor_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
