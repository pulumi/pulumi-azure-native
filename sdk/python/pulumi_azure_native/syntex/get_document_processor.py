...
__all__ = [
    'GetDocumentProcessorResult',
    'AwaitableGetDocumentProcessorResult',
    'get_document_processor',
    'get_document_processor_output',
]

@pulumi.output_type
class GetDocumentProcessorResult:
    """
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.DocumentProcessorPropertiesResponse':
        """
...
class AwaitableGetDocumentProcessorResult(GetDocumentProcessorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDocumentProcessorResult(
...
def get_document_processor(processor_name: Optional[builtins.str] = None,
    ...
    :param builtins.str processor_name: The name of document processor resource.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:syntex:getDocumentProcessor', __args__, opts=opts, typ=GetDocumentProcessorResult).value

    return AwaitableGetDocumentProcessorResult(
...
def get_document_processor_output(processor_name: Optional[pulumi.Input[builtins.str]] = None,
