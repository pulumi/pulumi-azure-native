...
class DocumentProcessorPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        Document processor properties
        :param pulumi.Input[_builtins.str] spo_tenant_id: The ID (GUID) of an SharePoint Online (SPO) tenant associated with this document processor resource
        :param pulumi.Input[_builtins.str] spo_tenant_url: The URL of an SharePoint Online (SPO) tenant associated with this document processor resource
        """
