...
def get_sql_server_availability_group_detail_view(availability_group_name: Optional[builtins.str] = None,
...
def get_sql_server_availability_group_detail_view_output(availability_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata:getSqlServerAvailabilityGroupDetailView', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupDetailViewResult)
