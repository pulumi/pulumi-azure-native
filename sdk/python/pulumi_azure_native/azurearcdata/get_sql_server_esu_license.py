...
def get_sql_server_esu_license(resource_group_name: Optional[builtins.str] = None,
                               sql_server_esu_license_name: Optional[builtins.str] = None,
    ...
    :param builtins.str sql_server_esu_license_name: Name of SQL Server ESU License
    """
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['sqlServerEsuLicenseName'] = sql_server_esu_license_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata:getSqlServerEsuLicense', __args__, opts=opts, typ=GetSqlServerEsuLicenseResult).value
...
def get_sql_server_esu_license_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata:getSqlServerEsuLicense', __args__, opts=opts, typ=GetSqlServerEsuLicenseResult)
