...
def get_sql_server_esu_license(resource_group_name: Optional[_builtins.str] = None,
                               sql_server_esu_license_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sql_server_esu_license_name: Name of SQL Server ESU License
    """
    __args__ = dict()
...
def get_sql_server_esu_license_output(resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                                      sql_server_esu_license_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
