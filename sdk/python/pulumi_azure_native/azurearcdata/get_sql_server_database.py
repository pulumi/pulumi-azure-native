...
def get_sql_server_database(database_name: Optional[builtins.str] = None,
...
def get_sql_server_database_output(database_name: Optional[pulumi.Input[builtins.str]] = None,
