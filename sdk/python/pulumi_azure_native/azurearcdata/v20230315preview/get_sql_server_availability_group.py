...
def get_sql_server_availability_group(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20230315preview:getSqlServerAvailabilityGroup', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupResult).value
...
def get_sql_server_availability_group_output(resource_group_name: Optional[pulumi.Input[str]] = None,
