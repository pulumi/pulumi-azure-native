...
class SqlManagedInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_managed_instance = azure_native.azurearcdata.v20230315preview.SqlManagedInstance("sqlManagedInstance",
            extended_location=azure_native.azurearcdata.v20230315preview.ExtendedLocationArgs(
                name="/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/arclocation",
                type="CustomLocation",
            ),
            location="northeurope",
            properties=azure_native.azurearcdata.v20230315preview.SqlManagedInstancePropertiesResponseArgs(
                active_directory_information=azure_native.azurearcdata.v20230315preview.ActiveDirectoryInformationArgs(
                    keytab_information=azure_native.azurearcdata.v20230315preview.KeytabInformationArgs(
                        keytab="********",
                    ),
                ),
                admin="Admin user",
                ...
                k8s_raw={
                    "spec": {
                        ...
                        "scheduling": {
                            "default": {
                                "resources": azure_native.azurearcdata.v20230315preview.K8sResourceRequirementsArgs(
                                    limits={
            ...
            sku=azure_native.azurearcdata.v20230315preview.SqlManagedInstanceSkuResponseArgs(
                dev=True,
                name=azure_native.azurearcdata/v20230315preview.SqlManagedInstanceSkuName.V_CORE,
                tier=azure_native.azurearcdata/v20230315preview.SqlManagedInstanceSkuTier.GENERAL_PURPOSE,
            ),
    ...
    def _internal_init(__self__,
        ...
        super(SqlManagedInstance, __self__).__init__(
            'azure-native:azurearcdata/v20230315preview:SqlManagedInstance',
            resource_name,
            __props__,
            opts)
