...
class FailoverGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        failover_group = azure_native.azurearcdata.v20230315preview.FailoverGroup("failoverGroup",
            failover_group_name="testFailoverGroupName",
            properties=azure_native.azurearcdata.v20230315preview.FailoverGroupPropertiesResponseArgs(
                ...
                spec=azure_native.azurearcdata.v20230315preview.FailoverGroupSpecArgs(
    ...
    def _internal_init(__self__,
        ...
        super(FailoverGroup, __self__).__init__(
            'azure-native:azurearcdata/v20230315preview:FailoverGroup',
            resource_name,
            __props__,
            opts)
