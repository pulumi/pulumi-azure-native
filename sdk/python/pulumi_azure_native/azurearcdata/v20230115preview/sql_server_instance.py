...
class SqlServerInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_server_instance = azure_native.azurearcdata.v20230115preview.SqlServerInstance("sqlServerInstance",
            location="northeurope",
            properties=azure_native.azurearcdata.v20230115preview.SqlServerInstancePropertiesResponseArgs(
