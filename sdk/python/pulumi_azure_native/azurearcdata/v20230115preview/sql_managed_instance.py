...
class SqlManagedInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        SqlManagedInstanceArgs._configure(
...
class SqlManagedInstance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SqlManagedInstanceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, SqlManagedInstancePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                SqlManagedInstancePropertiesArgs._configure(_setter, **properties)
            ...
            if sku is not None and not isinstance(sku, SqlManagedInstanceSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                SqlManagedInstanceSkuArgs._configure(_setter, **sku)
