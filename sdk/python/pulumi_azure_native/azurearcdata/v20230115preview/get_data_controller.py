...
def get_data_controller(data_controller_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20230115preview:getDataController', __args__, opts=opts, typ=GetDataControllerResult).value
...
def get_data_controller_output(data_controller_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20230115preview:getDataController', __args__, opts=opts, typ=GetDataControllerResult)
