...
class ActiveDirectoryConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        active_directory_connector = azure_native.azurearcdata.v20230115preview.ActiveDirectoryConnector("activeDirectoryConnector",
            active_directory_connector_name="testADConnector",
            data_controller_name="testdataController",
            properties=azure_native.azurearcdata.v20230115preview.ActiveDirectoryConnectorPropertiesResponseArgs(
                spec={
                    "activeDirectory": {
                        "domainControllers": azure_native.azurearcdata.v20230115preview.ActiveDirectoryDomainControllersArgs(
                            primary_domain_controller=azure_native.azurearcdata.v20230115preview.ActiveDirectoryDomainControllerArgs(
                                hostname="dc1.contoso.local",
                            ),
                            secondary_domain_controllers=[
                                azure_native.azurearcdata.v20230115preview.ActiveDirectoryDomainControllerArgs(
                    ...
                    "dns": azure_native.azurearcdata.v20230115preview.ActiveDirectoryConnectorDNSDetailsArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20230315preview:ActiveDirectoryConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ActiveDirectoryConnector, __self__).__init__(
            'azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector',
            resource_name,
            __props__,
            opts)
