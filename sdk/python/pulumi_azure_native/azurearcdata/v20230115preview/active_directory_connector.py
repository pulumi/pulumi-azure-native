...
class ActiveDirectoryConnectorArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['ActiveDirectoryConnectorPropertiesArgs']] = None,
        ...
        if data_controller_name is None:
            raise TypeError("Missing 'data_controller_name' argument")
        ...
        if active_directory_connector_name is None and 'activeDirectoryConnectorName' in kwargs:
            active_directory_connector_name = kwargs['activeDirectoryConnectorName']
...
class ActiveDirectoryConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, ActiveDirectoryConnectorPropertiesArgs, True)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector")])
