...
class SqlServerDatabaseArgs:
    ...
    def _configure(
        ...
        if 'sqlServerInstanceName' in kwargs:
...
class SqlServerDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, SqlServerDatabaseResourcePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                SqlServerDatabaseResourcePropertiesArgs._configure(_setter, **properties)
