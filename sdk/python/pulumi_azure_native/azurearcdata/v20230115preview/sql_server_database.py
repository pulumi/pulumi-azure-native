...
class SqlServerDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20240101:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20240501preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20250301preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata:SqlServerDatabase")])
