...
class SqlServerDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_server_database = azure_native.azurearcdata.v20230115preview.SqlServerDatabase("sqlServerDatabase",
            database_name="testdb",
            location="southeastasia",
            properties=azure_native.azurearcdata.v20230115preview.SqlServerDatabaseResourcePropertiesResponseArgs(
                backup_information=azure_native.azurearcdata.v20230115preview.SqlServerDatabaseResourcePropertiesBackupInformationArgs(
                ...
                database_options=azure_native.azurearcdata.v20230115preview.SqlServerDatabaseResourcePropertiesDatabaseOptionsArgs(
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20230315preview:SqlServerDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerDatabase, __self__).__init__(
            'azure-native:azurearcdata/v20230115preview:SqlServerDatabase',
            resource_name,
            __props__,
            opts)
