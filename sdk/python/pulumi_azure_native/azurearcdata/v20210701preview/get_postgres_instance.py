...
def get_postgres_instance(postgres_instance_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_postgres_instance is deprecated: azure-native:azurearcdata/v20210701preview:PostgresInstance is being removed in the next major version of this provider. Please upgrade to azure-native:azurearcdata/v20220615preview:PostgresInstance to guarantee forwards compatibility.""")
    __args__ = dict()
