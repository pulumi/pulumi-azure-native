...
if not MYPY:
    class SqlManagedInstancePropertiesArgsDict(TypedDict):
        ...
        Last uploaded date from Kubernetes cluster. Defaults to current date time
        """
        license_type: NotRequired[pulumi.Input['LicenseType']]
        """
...
class SqlManagedInstancePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 k8s_raw: Optional[Any] = None,
                 last_uploaded_date: Optional[pulumi.Input[str]] = None,
                 license_type: Optional[pulumi.Input['LicenseType']] = None,
        ...
        :param Any k8s_raw: The raw kubernetes information
        :param pulumi.Input[str] last_uploaded_date: Last uploaded date from Kubernetes cluster. Defaults to current date time
        :param pulumi.Input['LicenseType'] license_type: The license type to apply for this managed instance.
    ...
    def license_type(self) -> Optional[pulumi.Input['LicenseType']]:
        """
        The license type to apply for this managed instance.
        """
    ...
    @license_type.setter
    def license_type(self, value: Optional[pulumi.Input['LicenseType']]):
...
class SqlManagedInstanceSkuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] dev: Whether dev/test is enabled. When the dev field is set to true, the resource is used for dev/test purpose. 
        :param pulumi.Input[str] size: The SKU size. When the name field is the combination of tier and some other value, this would be the standalone code. 
        :param pulumi.Input['SqlManagedInstanceSkuTier'] tier: The tier for this managed instance.
        """
        pulumi.set(__self__, "name", name)
        if capacity is not None:
            pulumi.set(__self__, "capacity", capacity)
...
if not MYPY:
    class SqlServerInstancePropertiesArgsDict(TypedDict):
        ...
        """
        azure_defender_status: NotRequired[pulumi.Input[str]]
        """
...
class SqlServerInstancePropertiesArgs:
    def __init__(__self__, *,
                 container_resource_id: pulumi.Input[str],
                 status: pulumi.Input[str],
                 azure_defender_status: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] azure_defender_status: Status of Azure Defender.
    ...
    def azure_defender_status(self) -> Optional[pulumi.Input[str]]:
        """
        Status of Azure Defender.
        """
    ...
    def azure_defender_status(self, value: Optional[pulumi.Input[str]]):
