...
warnings.warn("""azure-native:azurearcdata/v20210701preview:PostgresInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:PostgresInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
class PostgresInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""PostgresInstance is deprecated: azure-native:azurearcdata/v20210701preview:PostgresInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:PostgresInstance to guarantee forwards compatibility.""")
        ...
        super(PostgresInstance, __self__).__init__(
            'azure-native:azurearcdata/v20210701preview:PostgresInstance',
            resource_name,
            __props__,
            opts)
