...
warnings.warn("""azure-native:azurearcdata/v20210701preview:DataController is being removed in the next major version of this provider. Please upgrade to azure-native:azurearcdata/v20220615preview:DataController to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_controller(data_controller_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_controller is deprecated: azure-native:azurearcdata/v20210701preview:DataController is being removed in the next major version of this provider. Please upgrade to azure-native:azurearcdata/v20220615preview:DataController to guarantee forwards compatibility.""")
    __args__ = dict()
