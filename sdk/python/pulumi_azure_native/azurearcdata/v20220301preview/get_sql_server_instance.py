...
warnings.warn("""azure-native:azurearcdata/v20220301preview:SqlServerInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:SqlServerInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_server_instance(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_server_instance is deprecated: azure-native:azurearcdata/v20220301preview:SqlServerInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20220615preview:SqlServerInstance to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['resourceGroupName'] = resource_group_name
    __args__['sqlServerInstanceName'] = sql_server_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20220301preview:getSqlServerInstance', __args__, opts=opts, typ=GetSqlServerInstanceResult).value
