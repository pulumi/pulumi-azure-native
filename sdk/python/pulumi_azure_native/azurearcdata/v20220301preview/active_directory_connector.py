...
class ActiveDirectoryConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        active_directory_connector = azure_native.azurearcdata.v20220301preview.ActiveDirectoryConnector("activeDirectoryConnector",
            active_directory_connector_name="testADConnector",
            data_controller_name="testdataController",
            properties=azure_native.azurearcdata.v20220301preview.ActiveDirectoryConnectorPropertiesResponseArgs(
                spec={
                    "activeDirectory": {
                        "domainControllers": azure_native.azurearcdata.v20220301preview.ActiveDirectoryDomainControllersArgs(
                            primary_domain_controller=azure_native.azurearcdata.v20220301preview.ActiveDirectoryDomainControllerArgs(
                                hostname="dc1.contoso.local",
                            ),
                            secondary_domain_controllers=[
                                azure_native.azurearcdata.v20220301preview.ActiveDirectoryDomainControllerArgs(
                    ...
                    "dns": azure_native.azurearcdata.v20220301preview.ActiveDirectoryConnectorDNSDetailsArgs(
