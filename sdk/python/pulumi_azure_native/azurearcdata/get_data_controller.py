...
def get_data_controller(data_controller_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_controller_name: The name of the data controller
...
def get_data_controller_output(data_controller_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
