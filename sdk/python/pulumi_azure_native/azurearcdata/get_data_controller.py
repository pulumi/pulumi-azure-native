...
def get_data_controller(data_controller_name: Optional[builtins.str] = None,
    ...
    :param builtins.str data_controller_name: The name of the data controller
...
def get_data_controller_output(data_controller_name: Optional[pulumi.Input[builtins.str]] = None,
