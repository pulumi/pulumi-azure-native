...
class ActiveDirectoryDomainControllersArgs:
    def __init__(__self__, *,
                 primary_domain_controller: pulumi.Input['ActiveDirectoryDomainControllerArgs'],
    ...
    def primary_domain_controller(self) -> pulumi.Input['ActiveDirectoryDomainControllerArgs']:
        """
    ...
    def primary_domain_controller(self, value: pulumi.Input['ActiveDirectoryDomainControllerArgs']):
