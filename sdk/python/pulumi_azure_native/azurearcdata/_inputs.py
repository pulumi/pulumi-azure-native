...
class ActiveDirectoryConnectorDomainDetailsArgsDict(TypedDict):
    ...
    """
    domain_controllers: NotRequired[pulumi.Input[Optional['ActiveDirectoryDomainControllersArgs']]]
    """
    null
    """
...
class ActiveDirectoryConnectorPropertiesArgsDict(TypedDict):
    ...
    null
    """
    domain_service_account_login_information: NotRequired[pulumi.Input[Optional['BasicLoginInformationArgs']]]
    """
    Username and password for domain service account authentication.
    """
    status: NotRequired[pulumi.Input[Optional['ActiveDirectoryConnectorStatusArgs']]]
    """
    null
    """
...
class ActiveDirectoryDomainControllersArgsDict(TypedDict):
    ...
    """
    primary_domain_controller: NotRequired[pulumi.Input[Optional['ActiveDirectoryDomainControllerArgs']]]
    """
    Information about the Primary Domain Controller (PDC) in the AD domain.
    """
    secondary_domain_controllers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ActiveDirectoryDomainControllerArgs']]]]]
    """
    null
    """
...
class ActiveDirectoryInformationArgsDict(TypedDict):
    ...
    """
    keytab_information: NotRequired[pulumi.Input[Optional['KeytabInformationArgs']]]
    """
...
class AuthenticationArgsDict(TypedDict):
    ...
    """
    sql_server_entra_identity: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EntraAuthenticationArgs']]]]]
    """
...
class AvailabilityGroupInfoArgsDict(TypedDict):
    ...
    """
    listener: NotRequired[pulumi.Input[Optional['SqlAvailabilityGroupStaticIPListenerPropertiesArgs']]]
    """
...
class DataControllerPropertiesArgsDict(TypedDict):
    ...
    """
    basic_login_information: NotRequired[pulumi.Input[Optional['BasicLoginInformationArgs']]]
    """
    ...
    """
    k8s_raw: NotRequired[Optional[Any]]
    """
    ...
    """
    log_analytics_workspace_config: NotRequired[pulumi.Input[Optional['LogAnalyticsWorkspaceConfigArgs']]]
    """
    Log analytics workspace id and primary key
    """
    logs_dashboard_credential: NotRequired[pulumi.Input[Optional['BasicLoginInformationArgs']]]
    """
    Login credential for logs dashboard on the Kubernetes cluster.
    """
    metrics_dashboard_credential: NotRequired[pulumi.Input[Optional['BasicLoginInformationArgs']]]
    """
    Login credential for metrics dashboard on the Kubernetes cluster.
    """
    on_premise_property: NotRequired[pulumi.Input[Optional['OnPremisePropertyArgs']]]
    """
    Properties from the Kubernetes data controller
    """
    upload_service_principal: NotRequired[pulumi.Input[Optional['UploadServicePrincipalArgs']]]
    """
    Deprecated. Service principal is deprecated in favor of Arc Kubernetes service extension managed identity.
    """
    upload_watermark: NotRequired[pulumi.Input[Optional['UploadWatermarkArgs']]]
    """
...
class K8sActiveDirectoryArgsDict(TypedDict):
    ...
    """
    connector: NotRequired[pulumi.Input[Optional['K8sActiveDirectoryConnectorArgs']]]
...
class K8sSchedulingOptionsArgsDict(TypedDict):
    ...
    """
    resources: NotRequired[pulumi.Input[Optional['K8sResourceRequirementsArgs']]]
    """
    The kubernetes resource limits and requests used to restrict or reserve resource usage.
    """
...
class K8sSchedulingArgsDict(TypedDict):
    ...
    """
    default: NotRequired[pulumi.Input[Optional['K8sSchedulingOptionsArgs']]]
    """
    The kubernetes scheduling options. It describes restrictions used to help Kubernetes select appropriate nodes to host the database service
    """
...
class K8sSecurityArgsDict(TypedDict):
    ...
    """
    active_directory: NotRequired[pulumi.Input[Optional['K8sActiveDirectoryArgs']]]
    """
    The kubernetes active directory information.
    """
    ...
    """
    transparent_data_encryption: NotRequired[pulumi.Input[Optional['K8stransparentDataEncryptionArgs']]]
    """
...
class K8sSettingsArgsDict(TypedDict):
    ...
    """
    network: NotRequired[pulumi.Input[Optional['K8sNetworkSettingsArgs']]]
    """
    The kubernetes network settings information.
    """
...
class MigrationArgsDict(TypedDict):
    ...
    """
    assessment: NotRequired[pulumi.Input[Optional['MigrationAssessmentArgs']]]
    """
...
class SqlAvailabilityGroupReplicaResourcePropertiesArgsDict(TypedDict):
    ...
    """
    configure: NotRequired[pulumi.Input[Optional['AvailabilityGroupConfigureArgs']]]
    """
    null
    """
...
class SqlAvailabilityGroupStaticIPListenerPropertiesArgsDict(TypedDict):
    ...
    """
    ip_v4_addresses_and_masks: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SqlAvailabilityGroupStaticIPListenerPropertiesIpV4AddressesAndMasksArgs']]]]]
    """
...
class SqlManagedInstanceK8sRawArgsDict(TypedDict):
    ...
    The raw kubernetes information.
    """
    spec: NotRequired[pulumi.Input[Optional['SqlManagedInstanceK8sSpecArgs']]]
    """
...
class SqlManagedInstanceK8sSpecArgsDict(TypedDict):
    ...
    """
    scheduling: NotRequired[pulumi.Input[Optional['K8sSchedulingArgs']]]
    """
    The kubernetes scheduling information.
    """
    security: NotRequired[pulumi.Input[Optional['K8sSecurityArgs']]]
    """
    The kubernetes security information.
    """
    settings: NotRequired[pulumi.Input[Optional['K8sSettingsArgs']]]
    """
    The kubernetes settings information.
    """
...
class SqlManagedInstancePropertiesArgsDict(TypedDict):
    ...
    """
    active_directory_information: NotRequired[pulumi.Input[Optional['ActiveDirectoryInformationArgs']]]
    """
    ...
    If a CustomLocation is provided, this contains the ARM id of the extension the custom location belongs to.
    """
    k8s_raw: NotRequired[pulumi.Input[Optional['SqlManagedInstanceK8sRawArgs']]]
    """
    The raw kubernetes information
    """
    last_uploaded_date: NotRequired[pulumi.Input[Optional[_builtins.str]]]
...
class SqlServerAvailabilityGroupResourcePropertiesDatabasesArgsDict(TypedDict):
    ...
    """
    value: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SqlAvailabilityGroupDatabaseReplicaResourcePropertiesArgs']]]]]
    """
...
class SqlServerAvailabilityGroupResourcePropertiesReplicasArgsDict(TypedDict):
    ...
    """
    value: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['SqlAvailabilityGroupReplicaResourcePropertiesArgs']]]]]
    """
...
class SqlServerAvailabilityGroupResourcePropertiesArgsDict(TypedDict):
    ...
    """
    databases: NotRequired[pulumi.Input[Optional['SqlServerAvailabilityGroupResourcePropertiesDatabasesArgs']]]
    """
    A list of Availability Group Database Replicas.
    """
    info: NotRequired[pulumi.Input[Optional['AvailabilityGroupInfoArgs']]]
    """
    Availability Group Info
    """
    replicas: NotRequired[pulumi.Input[Optional['SqlServerAvailabilityGroupResourcePropertiesReplicasArgs']]]
    """
    A list of Availability Group Replicas.
    """
...
class SqlServerDatabaseResourcePropertiesArgsDict(TypedDict):
    ...
    """
    backup_information: NotRequired[pulumi.Input[Optional['SqlServerDatabaseResourcePropertiesBackupInformationArgs']]]
    backup_policy: NotRequired[pulumi.Input[Optional['BackupPolicyArgs']]]
    """
    The backup profile for the SQL server.
    """
    ...
    """
    database_options: NotRequired[pulumi.Input[Optional['SqlServerDatabaseResourcePropertiesDatabaseOptionsArgs']]]
    """
    List of features that are enabled for the database
    """
...
class SqlServerInstancePropertiesArgsDict(TypedDict):
    ...
    """
    authentication: NotRequired[pulumi.Input[Optional['AuthenticationArgs']]]
    """
    Authentication related configuration for the SQL Server Instance.
    """
    backup_policy: NotRequired[pulumi.Input[Optional['BackupPolicyArgs']]]
    ...
    The backup profile for the SQL server.
    """
    client_connection: NotRequired[pulumi.Input[Optional['ClientConnectionArgs']]]
    """
    Client connection related configuration.
    """
    ...
    """
    migration: NotRequired[pulumi.Input[Optional['MigrationArgs']]]
    """
    Migration related configuration.
    """
    monitoring: NotRequired[pulumi.Input[Optional['MonitoringArgs']]]
    """
    The monitoring configuration.
    """
