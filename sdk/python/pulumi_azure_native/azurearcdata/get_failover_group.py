...
def get_failover_group(failover_group_name: Optional[_builtins.str] = None,
                       resource_group_name: Optional[_builtins.str] = None,
                       sql_managed_instance_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str failover_group_name: The name of the Failover Group
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata:getFailoverGroup', __args__, opts=opts, typ=GetFailoverGroupResult).value
...
def get_failover_group_output(failover_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
