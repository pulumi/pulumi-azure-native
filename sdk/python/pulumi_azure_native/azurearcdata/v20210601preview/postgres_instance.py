...
class PostgresInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        postgres_instance = azure_native.azurearcdata.v20210601preview.PostgresInstance("postgresInstance",
            ...
            properties=azure_native.azurearcdata.v20210601preview.PostgresInstancePropertiesResponseArgs(
                admin="admin",
            ...
            sku=azure_native.azurearcdata.v20210601preview.PostgresInstanceSkuResponseArgs(
                dev=True,
                name="default",
                tier=azure_native.azurearcdata/v20210601preview.PostgresInstanceSkuTier.HYPERSCALE,
            ))
        ...
        ```sh
        $ pulumi import azure-native:azurearcdata/v20210601preview:PostgresInstance testpostgresInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/PostgresInstance/testpostgresInstance 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210701preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20230115preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20230315preview:PostgresInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PostgresInstance, __self__).__init__(
            'azure-native:azurearcdata/v20210601preview:PostgresInstance',
            resource_name,
            __props__,
            opts)
