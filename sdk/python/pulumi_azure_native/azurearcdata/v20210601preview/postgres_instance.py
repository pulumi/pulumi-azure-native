...
class PostgresInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210601preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azurearcdata:PostgresInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata:PostgresInstance")])
