...
class SqlManagedInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210601preview:SqlManagedInstance"), pulumi.Alias(type_="azure-native:azurearcdata:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata:SqlManagedInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210701preview:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210701preview:SqlManagedInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210801:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210801:SqlManagedInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20211101:SqlManagedInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20211101:SqlManagedInstance")])
