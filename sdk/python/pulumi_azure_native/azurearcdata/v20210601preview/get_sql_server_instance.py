...
def get_sql_server_instance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20210601preview:getSqlServerInstance', __args__, opts=opts, typ=GetSqlServerInstanceResult)
