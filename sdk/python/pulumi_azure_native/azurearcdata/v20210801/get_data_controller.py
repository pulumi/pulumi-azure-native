...
warnings.warn("""azure-native:azurearcdata/v20210801:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_controller(data_controller_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_controller is deprecated: azure-native:azurearcdata/v20210801:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.""")
    __args__ = dict()
