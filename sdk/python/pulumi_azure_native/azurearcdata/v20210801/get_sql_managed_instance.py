...
warnings.warn("""azure-native:azurearcdata/v20210801:SqlManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:SqlManagedInstance to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_sql_managed_instance(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_managed_instance is deprecated: azure-native:azurearcdata/v20210801:SqlManagedInstance is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:SqlManagedInstance to guarantee forwards compatibility.""")
    __args__ = dict()
