...
class DataControllerArgs:
    ...
    def _configure(
        ...
        if 'dataControllerName' in kwargs:
...
class DataController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, DataControllerPropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                DataControllerPropertiesArgs._configure(_setter, **properties)
