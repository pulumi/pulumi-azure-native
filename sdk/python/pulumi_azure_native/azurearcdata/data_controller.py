...
class DataController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurearcdata:DataController"), pulumi.Alias(type_="azure-native:azurearcdata/v20210601preview:DataController"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210601preview:DataController")])
