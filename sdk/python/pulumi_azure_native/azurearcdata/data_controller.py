...
class DataControllerArgs:
    ...
    def _configure(
             ...
             properties: Optional[pulumi.Input['DataControllerPropertiesArgs']] = None,
        ...
        if data_controller_name is None and 'dataControllerName' in kwargs:
            data_controller_name = kwargs['dataControllerName']
...
class DataController(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataControllerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            properties = _utilities.configure(properties, DataControllerPropertiesArgs, True)
