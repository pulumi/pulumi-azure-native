...
def get_sql_server_availability_group(availability_group_name: Optional[_builtins.str] = None,
...
def get_sql_server_availability_group_output(availability_group_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
