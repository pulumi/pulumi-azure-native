...
class FailoverGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:FailoverGroup"), pulumi.Alias(type_="azure-native:azurearcdata/v20230115preview:FailoverGroup"), pulumi.Alias(type_="azure-native:azurearcdata/v20240501preview:FailoverGroup")])
