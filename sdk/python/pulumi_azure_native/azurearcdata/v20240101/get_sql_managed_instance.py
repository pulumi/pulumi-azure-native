...
def get_sql_managed_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240101:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult).value
...
def get_sql_managed_instance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sqlManagedInstanceName'] = sql_managed_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20240101:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult)
