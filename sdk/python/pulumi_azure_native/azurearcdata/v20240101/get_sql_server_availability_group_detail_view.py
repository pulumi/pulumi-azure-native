...
def get_sql_server_availability_group_detail_view(availability_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240101:getSqlServerAvailabilityGroupDetailView', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupDetailViewResult).value
...
def get_sql_server_availability_group_detail_view_output(availability_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sqlServerInstanceName'] = sql_server_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20240101:getSqlServerAvailabilityGroupDetailView', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupDetailViewResult)
