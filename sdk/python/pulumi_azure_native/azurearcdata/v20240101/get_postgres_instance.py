...
def get_postgres_instance(postgres_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240101:getPostgresInstance', __args__, opts=opts, typ=GetPostgresInstanceResult).value
...
def get_postgres_instance_output(postgres_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20240101:getPostgresInstance', __args__, opts=opts, typ=GetPostgresInstanceResult)
