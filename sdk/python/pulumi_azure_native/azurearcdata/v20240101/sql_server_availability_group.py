...
class SqlServerAvailabilityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata/v20240501preview:SqlServerAvailabilityGroup"), pulumi.Alias(type_="azure-native:azurearcdata:SqlServerAvailabilityGroup")])
