...
class SqlServerInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azurearcdata/v20211101:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210601preview:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210601preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210701preview:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210701preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210801:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azurearcdata/v20210801:SqlServerInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerInstance, __self__).__init__(
            'azure-native:azurearcdata/v20211101:SqlServerInstance',
            resource_name,
            __props__,
            opts)
