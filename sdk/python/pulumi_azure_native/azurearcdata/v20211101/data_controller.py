...
class DataController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:DataController"), pulumi.Alias(type_="azure-native:azurearcdata/v20210601preview:DataController"), pulumi.Alias(type_="azure-native:azurearcdata/v20210701preview:DataController"), pulumi.Alias(type_="azure-native:azurearcdata/v20210801:DataController"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:DataController")])
