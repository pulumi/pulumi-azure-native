...
class SqlServerDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 database_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['SqlServerDatabaseResourcePropertiesArgs', 'SqlServerDatabaseResourcePropertiesArgsDict']]] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata/v20220615preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20230115preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20240101:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20240501preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20250301preview:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20260101:SqlServerDatabase"), pulumi.Alias(type_="azure-native:azurearcdata/v20260301preview:SqlServerDatabase")])
