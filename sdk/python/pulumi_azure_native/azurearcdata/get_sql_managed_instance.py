...
class GetSqlManagedInstanceResult:
    ...
    """
    def __init__(__self__, azure_api_version=None, extended_location=None, id=None, location=None, name=None, properties=None, sku=None, system_data=None, tags=None, type=None):
...
def get_sql_managed_instance(resource_group_name: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult).value
...
def get_sql_managed_instance_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult)
