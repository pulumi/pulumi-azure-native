...
def get_active_directory_connector(active_directory_connector_name: Optional[_builtins.str] = None,
                                   data_controller_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str active_directory_connector_name: The name of the Active Directory connector instance
...
def get_active_directory_connector_output(active_directory_connector_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata:getActiveDirectoryConnector', __args__, opts=opts, typ=GetActiveDirectoryConnectorResult)
