...
def get_active_directory_connector(active_directory_connector_name: Optional[builtins.str] = None,
                                   data_controller_name: Optional[builtins.str] = None,
    ...
    :param builtins.str active_directory_connector_name: The name of the Active Directory connector instance
...
def get_active_directory_connector_output(active_directory_connector_name: Optional[pulumi.Input[builtins.str]] = None,
