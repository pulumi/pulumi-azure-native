...
def get_sql_server_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getSqlServerInstance', __args__, opts=opts, typ=GetSqlServerInstanceResult).value
...
def get_sql_server_instance_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getSqlServerInstance', __args__, opts=opts, typ=GetSqlServerInstanceResult)
