...
class AuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        Authentication related configuration for the SQL Server Instance.
        :param pulumi.Input[Union[str, 'Mode']] mode: Mode of authentication in SqlServer.
...
if not MYPY:
    class AvailabilityGroupConfigureArgsDict(TypedDict):
        ...
        """
        availability_mode: NotRequired[pulumi.Input[Union[str, 'ArcSqlServerAvailabilityMode']]]
        """
        ...
        """
        endpoint_authentication_mode: NotRequired[pulumi.Input[Union[str, 'ConnectionAuth']]]
        """
        Permitted authentication modes for the mirroring endpoint.
        """
        endpoint_connect_login: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        failover_mode: NotRequired[pulumi.Input[Union[str, 'ArcSqlServerFailoverMode']]]
        """
...
class AvailabilityGroupConfigureArgs:
    def __init__(__self__, *,
                 availability_mode: Optional[pulumi.Input[Union[str, 'ArcSqlServerAvailabilityMode']]] = None,
                 backup_priority: Optional[pulumi.Input[int]] = None,
                 certificate_name: Optional[pulumi.Input[str]] = None,
                 endpoint_authentication_mode: Optional[pulumi.Input[Union[str, 'ConnectionAuth']]] = None,
                 endpoint_connect_login: Optional[pulumi.Input[str]] = None,
                 endpoint_name: Optional[pulumi.Input[str]] = None,
                 endpoint_url: Optional[pulumi.Input[str]] = None,
                 failover_mode: Optional[pulumi.Input[Union[str, 'ArcSqlServerFailoverMode']]] = None,
        ...
        """
        The specifications of the availability group replica configuration
        :param pulumi.Input[Union[str, 'ArcSqlServerAvailabilityMode']] availability_mode: Property that determines whether a given availability replica can run in synchronous-commit mode
        ...
        :param pulumi.Input[str] certificate_name: Name of certificate to use for authentication. Required if any CERTIFICATE authentication modes are specified.
        :param pulumi.Input[Union[str, 'ConnectionAuth']] endpoint_authentication_mode: Permitted authentication modes for the mirroring endpoint.
        :param pulumi.Input[str] endpoint_connect_login: The login which will connect to the mirroring endpoint.
        :param pulumi.Input[str] endpoint_name: Name of the mirroring endpoint URL
        :param pulumi.Input[str] endpoint_url: Mirroring endpoint URL of availability group replica
        :param pulumi.Input[Union[str, 'ArcSqlServerFailoverMode']] failover_mode: Property to set the failover mode of the availability group replica
    ...
    def availability_mode(self) -> Optional[pulumi.Input[Union[str, 'ArcSqlServerAvailabilityMode']]]:
        """
        Property that determines whether a given availability replica can run in synchronous-commit mode
        """
    ...
    def availability_mode(self, value: Optional[pulumi.Input[Union[str, 'ArcSqlServerAvailabilityMode']]]):
    ...
    def endpoint_authentication_mode(self) -> Optional[pulumi.Input[Union[str, 'ConnectionAuth']]]:
        """
        Permitted authentication modes for the mirroring endpoint.
        """
    ...
    def endpoint_authentication_mode(self, value: Optional[pulumi.Input[Union[str, 'ConnectionAuth']]]):
        pulumi.set(self, "endpoint_authentication_mode", value)

    @property
    @pulumi.getter(name="endpointConnectLogin")
    def endpoint_connect_login(self) -> Optional[pulumi.Input[str]]:
        """
        The login which will connect to the mirroring endpoint.
        """
    ...
    def endpoint_connect_login(self, value: Optional[pulumi.Input[str]]):
    ...
    def failover_mode(self) -> Optional[pulumi.Input[Union[str, 'ArcSqlServerFailoverMode']]]:
        """
        Property to set the failover mode of the availability group replica
        """
    ...
    def failover_mode(self, value: Optional[pulumi.Input[Union[str, 'ArcSqlServerFailoverMode']]]):
...
class ClientConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        Client connection related configuration.
        :param pulumi.Input[bool] enabled: Indicates if client connection is enabled for this SQL Server instance.
        """
...
class EntraAuthenticationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'IdentityType']] identity_type: The method used for Entra authentication
        """
...
class MigrationAssessmentArgs:
    def __init__(__self__, *,
        ...
        """
        The migration assessment related configuration.
        :param pulumi.Input[bool] enabled: Indicates if migration assessment is enabled for this SQL Server instance.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class SqlAvailabilityGroupReplicaResourcePropertiesArgsDict(TypedDict):
        ...
        The replica name.
        """
        replica_resource_id: NotRequired[pulumi.Input[str]]
        """
...
class SqlAvailabilityGroupReplicaResourcePropertiesArgs:
    ...
    def replica_resource_id(self) -> Optional[pulumi.Input[str]]:
        """
        Resource id of this replica. This is required for a distributed availability group, in which case it describes the location of the availability group that hosts one replica in the DAG. In a non-distributed availability group this field is optional but can be used to store the Azure resource id for AG.
        """
    ...
    def replica_resource_id(self, value: Optional[pulumi.Input[str]]):
...
class SqlAvailabilityGroupStaticIPListenerPropertiesIpV4AddressesAndMasksArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] mask: IPV4 netmask
        """
...
if not MYPY:
    class SqlAvailabilityGroupStaticIPListenerPropertiesArgsDict(TypedDict):
        ...
        """
        ip_v6_addresses: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
...
class SqlAvailabilityGroupStaticIPListenerPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 ip_v6_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 port: Optional[pulumi.Input[int]] = None):
        """
        The properties of a static IP Arc Sql availability group listener
        :param pulumi.Input[str] dns_name: the DNS name for the listener.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ip_v6_addresses: IP V6 Addresses for the listener
        :param pulumi.Input[int] port: Network port for the listener. Default is 1433.
        """
    ...
    def ip_v6_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        IP V6 Addresses for the listener
        """
    ...
    def ip_v6_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
if not MYPY:
    class SqlServerDatabaseResourcePropertiesArgsDict(TypedDict):
        ...
        """
        data_file_size_mb: NotRequired[pulumi.Input[float]]
        """
        ...
        """
        log_file_size_mb: NotRequired[pulumi.Input[float]]
        """
...
class SqlServerDatabaseResourcePropertiesArgs:
    def __init__(__self__, *,
                 ...
                 data_file_size_mb: Optional[pulumi.Input[float]] = None,
                 ...
                 log_file_size_mb: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[float] data_file_size_mb: Total size in MB for the data (mdf and ndf) files for this database.
        ...
        :param pulumi.Input[float] log_file_size_mb: Total size in MB for the log (ldf) files for this database.
        ...
        :param pulumi.Input[str] source_database_id: The name of the source database associated with create operation of this database.
    ...
    def data_file_size_mb(self) -> Optional[pulumi.Input[float]]:
        """
        Total size in MB for the data (mdf and ndf) files for this database.
        """
    ...
    def data_file_size_mb(self, value: Optional[pulumi.Input[float]]):
    ...
    def log_file_size_mb(self) -> Optional[pulumi.Input[float]]:
        """
        Total size in MB for the log (ldf) files for this database.
        """
    ...
    def log_file_size_mb(self, value: Optional[pulumi.Input[float]]):
...
class SqlServerInstancePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[str, 'ServiceType']] service_type: Indicates if the resource represents a SQL Server engine or a SQL Server component service installed on the host.
