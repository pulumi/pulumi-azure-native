...
def get_sql_server_instance_jobs_status(feature_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getSqlServerInstanceJobsStatus', __args__, opts=opts, typ=GetSqlServerInstanceJobsStatusResult).value
...
def get_sql_server_instance_jobs_status_output(feature_name: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getSqlServerInstanceJobsStatus', __args__, opts=opts, typ=GetSqlServerInstanceJobsStatusResult)
