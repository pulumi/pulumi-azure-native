...
def get_sql_server_instance_telemetry(aggregation_type: Optional[Union[str, 'AggregationType']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getSqlServerInstanceTelemetry', __args__, opts=opts, typ=GetSqlServerInstanceTelemetryResult).value
...
def get_sql_server_instance_telemetry_output(aggregation_type: Optional[pulumi.Input[Optional[Union[str, 'AggregationType']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getSqlServerInstanceTelemetry', __args__, opts=opts, typ=GetSqlServerInstanceTelemetryResult)
