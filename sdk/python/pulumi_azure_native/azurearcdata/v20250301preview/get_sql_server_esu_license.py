...
def get_sql_server_esu_license(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getSqlServerEsuLicense', __args__, opts=opts, typ=GetSqlServerEsuLicenseResult).value
...
def get_sql_server_esu_license_output(resource_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getSqlServerEsuLicense', __args__, opts=opts, typ=GetSqlServerEsuLicenseResult)
