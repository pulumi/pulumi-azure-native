...
def get_postgres_instance(postgres_instance_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getPostgresInstance', __args__, opts=opts, typ=GetPostgresInstanceResult).value
...
def get_postgres_instance_output(postgres_instance_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getPostgresInstance', __args__, opts=opts, typ=GetPostgresInstanceResult)
