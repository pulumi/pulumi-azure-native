...
def get_sql_server_availability_group(availability_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20250301preview:getSqlServerAvailabilityGroup', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupResult).value
...
def get_sql_server_availability_group_output(availability_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20250301preview:getSqlServerAvailabilityGroup', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupResult)
