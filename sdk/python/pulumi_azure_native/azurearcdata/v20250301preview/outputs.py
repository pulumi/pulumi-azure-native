...
class AuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Authentication related configuration for the SQL Server Instance.
        :param str mode: Mode of authentication in SqlServer.
...
class EntraAuthenticationResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str identity_type: The method used for Entra authentication
        """
...
class SqlAvailabilityGroupReplicaResourcePropertiesResponse(dict):
    ...
    def replica_resource_id(self) -> Optional[str]:
        """
...
class SqlServerAvailabilityGroupResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str vm_id: The unique ID of the hybrid machine that this resource belongs to.
...
class SqlServerDatabaseResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param float data_file_size_mb: Total size in MB for the data (mdf and ndf) files for this database.
        ...
        :param float log_file_size_mb: Total size in MB for the log (ldf) files for this database.
    ...
    def data_file_size_mb(self) -> Optional[float]:
        """
    ...
    def log_file_size_mb(self) -> Optional[float]:
        """
...
class SqlServerInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool is_digi_cert_pki_cert_trust_configured: Indicates whether DigiCert PKI root-authority certificate (trusted by Azure) exists in SQL Server and trusted for Azure database.windows.net domains.
        :param bool is_hadr_enabled: Indicates whether always On availability groups is enabled in SQL Server.
        :param bool is_microsoft_pki_cert_trust_configured: Indicates whether Microsoft PKI root-authority certificate (trusted by Azure) exists in SQL Server and trusted for Azure database.windows.net domains.
        ...
        :param float max_server_memory_mb: max server memory (MB) value configured for this instance.
    ...
    def is_digi_cert_pki_cert_trust_configured(self) -> bool:
        """
    ...
    def is_microsoft_pki_cert_trust_configured(self) -> bool:
        """
    ...
    def max_server_memory_mb(self) -> float:
        """
