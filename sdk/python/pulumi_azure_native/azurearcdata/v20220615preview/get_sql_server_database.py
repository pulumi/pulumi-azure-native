...
def get_sql_server_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20220615preview:getSqlServerDatabase', __args__, opts=opts, typ=GetSqlServerDatabaseResult).value
...
def get_sql_server_database_output(database_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20220615preview:getSqlServerDatabase', __args__, opts=opts, typ=GetSqlServerDatabaseResult)
