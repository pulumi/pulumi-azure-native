...
class SqlServerInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        sql_server_instance = azure_native.azurearcdata.v20220615preview.SqlServerInstance("sqlServerInstance",
            location="northeurope",
            properties=azure_native.azurearcdata.v20220615preview.SqlServerInstancePropertiesResponseArgs(
        ...
        ```sh
        $ pulumi import azure-native:azurearcdata/v20220615preview:SqlServerInstance testsqlServerInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureArcData/SqlServerInstances/testsqlServerInstance 
        ```
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210601preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210701preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20210801:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20211101:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20230115preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azurearcdata/v20230315preview:SqlServerInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerInstance, __self__).__init__(
            'azure-native:azurearcdata/v20220615preview:SqlServerInstance',
            resource_name,
            __props__,
            opts)
