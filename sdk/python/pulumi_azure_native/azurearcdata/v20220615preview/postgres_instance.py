...
class PostgresInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        postgres_instance = azure_native.azurearcdata.v20220615preview.PostgresInstance("postgresInstance",
            ...
            properties=azure_native.azurearcdata.v20220615preview.PostgresInstancePropertiesResponseArgs(
                admin="admin",
            ...
            sku=azure_native.azurearcdata.v20220615preview.PostgresInstanceSkuResponseArgs(
                dev=True,
                name="default",
