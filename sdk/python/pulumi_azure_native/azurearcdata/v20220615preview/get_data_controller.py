...
warnings.warn("""azure-native:azurearcdata/v20220615preview:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_data_controller(data_controller_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_controller is deprecated: azure-native:azurearcdata/v20220615preview:DataController is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:DataController to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['dataControllerName'] = data_controller_name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20220615preview:getDataController', __args__, opts=opts, typ=GetDataControllerResult).value
