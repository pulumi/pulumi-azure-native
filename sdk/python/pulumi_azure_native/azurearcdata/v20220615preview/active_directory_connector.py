...
warnings.warn("""azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector is being removed in the next major version of this provider. Upgrade to at least azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector to guarantee forwards compatibility.""", DeprecationWarning)
...
class ActiveDirectoryConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata:ActiveDirectoryConnector"), pulumi.Alias(type_="azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector")])
