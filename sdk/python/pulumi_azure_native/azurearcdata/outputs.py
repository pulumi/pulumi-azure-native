...
class ActiveDirectoryDomainControllersResponse(dict):
    ...
    def __init__(__self__, *,
                 primary_domain_controller: 'outputs.ActiveDirectoryDomainControllerResponse',
    ...
    def primary_domain_controller(self) -> 'outputs.ActiveDirectoryDomainControllerResponse':
        """
