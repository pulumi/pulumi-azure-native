...
def get_sql_server_instance_telemetry(aggregation_type: Optional[Union[_builtins.str, 'AggregationType']] = None,
    ...
    :param _builtins.str end_time: The end time for the time range to fetch telemetry for. If not specified, the current time is used.
    :param _builtins.str interval: The time granularity to fetch telemetry for. This is an ISO8601 duration. Examples: PT15M, PT1H, P1D
    ...
    :param _builtins.str start_time: The start time for the time range to fetch telemetry for. If not specified, the current time minus 1 hour is used.
    """
    __args__ = dict()
