...
class GetSqlServerInstanceTelemetryResult:
    ...
    @property
    @pulumi.getter
    def rows(self) -> Sequence[Sequence[builtins.str]]:
        """
...
def get_sql_server_instance_telemetry(aggregation_type: Optional[Union[builtins.str, 'AggregationType']] = None,
                                      database_names: Optional[Sequence[builtins.str]] = None,
                                      dataset_name: Optional[builtins.str] = None,
    ...
    :param Union[builtins.str, 'AggregationType'] aggregation_type: The aggregation type to use for the numerical columns in the dataset.
    :param Sequence[builtins.str] database_names: The list of database names to return telemetry for. If not specified, telemetry for all databases will be aggregated and returned.
    :param builtins.str dataset_name: The name of the telemetry dataset to retrieve.
    :param builtins.str end_time: The end time for the time range to fetch telemetry for. If not specified, the current time is used.
    :param builtins.str interval: The time granularity to fetch telemetry for. This is an ISO8601 duration. Examples: PT15M, PT1H, P1D
    ...
    :param builtins.str start_time: The start time for the time range to fetch telemetry for. If not specified, the current time minus 1 hour is used.
    """
    __args__ = dict()
...
def get_sql_server_instance_telemetry_output(aggregation_type: Optional[pulumi.Input[Optional[Union[builtins.str, 'AggregationType']]]] = None,
                                             database_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                             dataset_name: Optional[pulumi.Input[builtins.str]] = None,
                                             end_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             interval: Optional[pulumi.Input[Optional[builtins.str]]] = None,
