...
def get_sql_server_instance(resource_group_name: Optional[builtins.str] = None,
...
def get_sql_server_instance_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
