...
__all__ = ['SqlServerEsuLicenseArgs', 'SqlServerEsuLicense']
...
class SqlServerEsuLicenseArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input['SqlServerEsuLicensePropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['SqlServerEsuLicensePropertiesArgs']):
    ...
    def sql_server_esu_license_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def sql_server_esu_license_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("azure-native:azurearcdata:SqlServerEsuLicense")
class SqlServerEsuLicense(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 location: Optional[pulumi.Input[_builtins.str]] = None,
                 properties: Optional[pulumi.Input[Union['SqlServerEsuLicensePropertiesArgs', 'SqlServerEsuLicensePropertiesArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The geo-location where the resource lives
        :param pulumi.Input[Union['SqlServerEsuLicensePropertiesArgs', 'SqlServerEsuLicensePropertiesArgsDict']] properties: SQL Server ESU license properties
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group. The name is case insensitive.
        :param pulumi.Input[_builtins.str] sql_server_esu_license_name: Name of SQL Server ESU License
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Resource tags.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SqlServerEsuLicenseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata/v20240501preview:SqlServerEsuLicense"), pulumi.Alias(type_="azure-native:azurearcdata/v20250301preview:SqlServerEsuLicense"), pulumi.Alias(type_="azure-native:azurearcdata/v20260101:SqlServerEsuLicense"), pulumi.Alias(type_="azure-native:azurearcdata/v20260301preview:SqlServerEsuLicense")])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SqlServerEsuLicense':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.SqlServerEsuLicensePropertiesResponse']:
        """
        SQL Server ESU license properties
        """
        return pulumi.get(self, "properties")
