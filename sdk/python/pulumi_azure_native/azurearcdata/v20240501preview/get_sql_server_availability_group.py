...
__all__ = [
    ...
    'AwaitableGetSqlServerAvailabilityGroupResult',
    'get_sql_server_availability_group',
    'get_sql_server_availability_group_output',
]

@pulumi.output_type
class GetSqlServerAvailabilityGroupResult:
    """
    ...
    @property
    @pulumi.getter
    def properties(self) -> 'outputs.SqlServerAvailabilityGroupResourcePropertiesResponse':
        """
...
def get_sql_server_availability_group(availability_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240501preview:getSqlServerAvailabilityGroup', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupResult).value
...
def get_sql_server_availability_group_output(availability_group_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['sqlServerInstanceName'] = sql_server_instance_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:azurearcdata/v20240501preview:getSqlServerAvailabilityGroup', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupResult)
