...
def get_sql_managed_instance(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240501preview:getSqlManagedInstance', __args__, opts=opts, typ=GetSqlManagedInstanceResult).value
