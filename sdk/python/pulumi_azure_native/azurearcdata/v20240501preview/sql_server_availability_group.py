...
class SqlServerAvailabilityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:azurearcdata/v20240101:SqlServerAvailabilityGroup"), pulumi.Alias(type_="azure-native:azurearcdata/v20250301preview:SqlServerAvailabilityGroup"), pulumi.Alias(type_="azure-native:azurearcdata:SqlServerAvailabilityGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerAvailabilityGroup, __self__).__init__(
            'azure-native:azurearcdata/v20240501preview:SqlServerAvailabilityGroup',
            resource_name,
            __props__,
            opts)
