...
__all__ = [
    ...
    'get_sql_server_availability_group_detail_view_output',
]
...
def get_sql_server_availability_group_detail_view(availability_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurearcdata/v20240501preview:getSqlServerAvailabilityGroupDetailView', __args__, opts=opts, typ=GetSqlServerAvailabilityGroupDetailViewResult).value
