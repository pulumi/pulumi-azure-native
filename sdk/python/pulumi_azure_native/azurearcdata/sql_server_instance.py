...
class SqlServerInstanceArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['SqlServerInstancePropertiesArgs']]:
        """
        null
        """
...
class SqlServerInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Union['SqlServerInstancePropertiesArgs', 'SqlServerInstancePropertiesArgsDict']]] = None,
