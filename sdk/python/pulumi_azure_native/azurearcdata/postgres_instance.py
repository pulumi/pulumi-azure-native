...
class PostgresInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        PostgresInstanceArgs._configure(
    ...
    def _configure(
        ...
        if 'postgresInstanceName' in kwargs:
            postgres_instance_name = kwargs['postgresInstanceName']
        ...
        if postgres_instance_name is not None:
            _setter("postgres_instance_name", postgres_instance_name)
        if sku is not None:
            _setter("sku", sku)
        if tags is not None:
            _setter("tags", tags)
...
class PostgresInstance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PostgresInstanceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, PostgresInstancePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                PostgresInstancePropertiesArgs._configure(_setter, **properties)
            ...
            if sku is not None and not isinstance(sku, PostgresInstanceSkuArgs):
                sku = sku or {}
                def _setter(key, value):
                    sku[key] = value
                PostgresInstanceSkuArgs._configure(_setter, **sku)
