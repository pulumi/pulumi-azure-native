...
class KubernetesConnectionDetailsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kube_config: Gets the kubeconfig for the cluster.
        """
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Model representing SKU for Azure Dev Spaces Controller.
        :param builtins.str name: The name of the SKU for Azure Dev Spaces Controller.
        :param builtins.str tier: The tier of the SKU for Azure Dev Spaces Controller.
        """
