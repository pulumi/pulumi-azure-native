...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devspaces:listControllerConnectionDetails'.""", DeprecationWarning)
...
def list_controller_connection_details(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devspaces/latest:listControllerConnectionDetails', __args__, opts=opts, typ=ListControllerConnectionDetailsResult).value
