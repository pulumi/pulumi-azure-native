...
def get_web_app_vnet_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_vnet_connection is deprecated: azure-native:web/v20160801:WebAppVnetConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppVnetConnection to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
