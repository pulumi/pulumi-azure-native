...
__all__ = [
    ...
    'SnapshotRecoveryRequestResponse',
    'SnapshotRecoveryTargetResponse',
...
class CloningInfoResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        :param bool ignore_quotas: <code>true</code> if quotas should be ignored; otherwise, <code>false</code>.
    ...
    def ignore_quotas(self) -> Optional[bool]:
        """
...
@pulumi.output_type
class SnapshotRecoveryRequestResponse(dict):
    """
    ...
    def __init__(__self__, *,
                 ...
                 recovery_target: Optional['outputs.SnapshotRecoveryTargetResponse'] = None,
                 snapshot_time: Optional[str] = None):
        """
        Details about app recovery operation.
        :param str id: Resource Id.
        :param str name: Resource Name.
        :param bool overwrite: If <code>true</code> the recovery operation can overwrite source app; otherwise, <code>false</code>.
        :param str type: Resource type.
        :param bool ignore_conflicting_host_names: If true, custom hostname conflicts will be ignored when recovering to a target web app.
               This setting is only necessary when RecoverConfiguration is enabled.
        :param str kind: Kind of resource.
        :param bool recover_configuration: If true, site configuration, in addition to content, will be reverted.
        :param 'SnapshotRecoveryTargetResponseArgs' recovery_target: Specifies the web app that snapshot contents will be written to.
        :param str snapshot_time: Point in time in which the app recovery should be attempted, formatted as a DateTime string.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "overwrite", overwrite)
    ...
    def ignore_conflicting_host_names(self) -> Optional[bool]:
        """
    ...
    def recover_configuration(self) -> Optional[bool]:
        """
    ...
    def recovery_target(self) -> Optional['outputs.SnapshotRecoveryTargetResponse']:
        """
...
@pulumi.output_type
class SnapshotRecoveryTargetResponse(dict):
    """
    Specifies the web app that snapshot contents will be written to.
    """
    def __init__(__self__, *,
        ...
        """
        Specifies the web app that snapshot contents will be written to.
        :param str id: ARM resource ID of the target app. 
               /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName} for production slots and 
               /subscriptions/{subId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{siteName}/slots/{slotName} for other slots.
        :param str location: Geographical location of the target web app, e.g. SouthEastAsia, SouthCentralUS
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
