...
def get_web_app_premier_add_on_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:getWebAppPremierAddOnSlot', __args__, opts=opts, typ=GetWebAppPremierAddOnSlotResult).value
    ...
    return AwaitableGetWebAppPremierAddOnSlotResult(
        ...
        premier_add_on_name=pulumi.get(__ret__, 'premier_add_on_name'),
...
def get_web_app_premier_add_on_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['slot'] = slot
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:getWebAppPremierAddOnSlot', __args__, opts=opts, typ=GetWebAppPremierAddOnSlotResult)
    return __ret__.apply(lambda __response__: GetWebAppPremierAddOnSlotResult(
        ...
        premier_add_on_name=pulumi.get(__response__, 'premier_add_on_name'),
