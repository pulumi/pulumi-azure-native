...
__all__ = [
    ...
    'list_web_app_auth_settings_slot_output',
]
...
class ListWebAppAuthSettingsSlotResult:
    ...
    """
    def __init__(__self__, additional_login_params=None, allowed_audiences=None, allowed_external_redirect_urls=None, client_id=None, client_secret=None, default_provider=None, enabled=None, facebook_app_id=None, facebook_app_secret=None, facebook_o_auth_scopes=None, google_client_id=None, google_client_secret=None, google_o_auth_scopes=None, id=None, issuer=None, kind=None, microsoft_account_client_id=None, microsoft_account_client_secret=None, microsoft_account_o_auth_scopes=None, name=None, runtime_version=None, token_refresh_extension_hours=None, token_store_enabled=None, twitter_consumer_key=None, twitter_consumer_secret=None, type=None, unauthenticated_client_action=None):
...
def list_web_app_auth_settings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:listWebAppAuthSettingsSlot', __args__, opts=opts, typ=ListWebAppAuthSettingsSlotResult).value
...
def list_web_app_auth_settings_slot_output(name: Optional[pulumi.Input[str]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ListWebAppAuthSettingsSlotResult]:
    """
    Gets the Authentication/Authorization settings of an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:listWebAppAuthSettingsSlot', __args__, opts=opts, typ=ListWebAppAuthSettingsSlotResult)
    return __ret__.apply(lambda __response__: ListWebAppAuthSettingsSlotResult(
