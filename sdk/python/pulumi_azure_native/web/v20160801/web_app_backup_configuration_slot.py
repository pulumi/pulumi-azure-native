...
class WebAppBackupConfigurationSlot(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['backup_request_name'] = backup_request_name
    ...
    def get(resource_name: str,
        ...
        __props__["backup_request_name"] = None
