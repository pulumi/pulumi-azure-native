...
class WebAppSiteExtensionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppSiteExtensionSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppSiteExtensionSlot")])
