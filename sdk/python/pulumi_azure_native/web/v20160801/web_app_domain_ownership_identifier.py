...
warnings.warn("""azure-native:web/v20160801:WebAppDomainOwnershipIdentifier is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20181101:WebAppDomainOwnershipIdentifier to guarantee forwards compatibility.""", DeprecationWarning)
