...
warnings.warn("""azure-native:web/v20160801:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppDomainOwnershipIdentifierSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppDomainOwnershipIdentifierSlot is deprecated: azure-native:web/v20160801:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20181101:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""")
