...
class GetWebAppConfigurationResult:
    ...
    """
    def __init__(__self__, always_on=None, api_definition=None, app_command_line=None, app_settings=None, auto_heal_enabled=None, auto_heal_rules=None, auto_swap_slot_name=None, connection_strings=None, cors=None, default_documents=None, detailed_error_logging_enabled=None, document_root=None, experiments=None, handler_mappings=None, http20_enabled=None, http_logging_enabled=None, id=None, ip_security_restrictions=None, java_container=None, java_container_version=None, java_version=None, kind=None, limits=None, linux_fx_version=None, load_balancing=None, local_my_sql_enabled=None, logs_directory_size_limit=None, machine_key=None, managed_pipeline_mode=None, min_tls_version=None, name=None, net_framework_version=None, node_version=None, number_of_workers=None, php_version=None, publishing_username=None, push=None, python_version=None, remote_debugging_enabled=None, remote_debugging_version=None, request_tracing_enabled=None, request_tracing_expiration_time=None, scm_type=None, tracing_options=None, type=None, use32_bit_worker_process=None, virtual_applications=None, vnet_name=None, web_sockets_enabled=None):
...
def get_web_app_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:getWebAppConfiguration', __args__, opts=opts, typ=GetWebAppConfigurationResult).value
