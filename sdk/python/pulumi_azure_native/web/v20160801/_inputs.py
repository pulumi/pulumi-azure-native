...
class CloningInfoArgs:
    ...
    def _configure(
        ...
        if ignore_quotas is None and 'ignoreQuotas' in kwargs:
            ignore_quotas = kwargs['ignoreQuotas']
        ...
        if ignore_quotas is not None:
            _setter("ignore_quotas", ignore_quotas)
...
class SnapshotRecoveryRequestArgs:
    def __init__(__self__, *,
        ...
        """
        SnapshotRecoveryRequestArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            overwrite=overwrite,
    ...
    def _configure(
        ...
        if overwrite is None:
            raise TypeError("Missing 'overwrite' argument")
        if ignore_conflicting_host_names is None and 'ignoreConflictingHostNames' in kwargs:
            ignore_conflicting_host_names = kwargs['ignoreConflictingHostNames']
        if recover_configuration is None and 'recoverConfiguration' in kwargs:
            recover_configuration = kwargs['recoverConfiguration']
        if recovery_target is None and 'recoveryTarget' in kwargs:
            recovery_target = kwargs['recoveryTarget']
        ...
        if ignore_conflicting_host_names is not None:
            _setter("ignore_conflicting_host_names", ignore_conflicting_host_names)
        if kind is not None:
            _setter("kind", kind)
        if recover_configuration is not None:
            _setter("recover_configuration", recover_configuration)
        if recovery_target is not None:
            _setter("recovery_target", recovery_target)
...
class SnapshotRecoveryTargetArgs:
    def __init__(__self__, *,
        ...
        """
        SnapshotRecoveryTargetArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            id=id,
            location=location,
        )
