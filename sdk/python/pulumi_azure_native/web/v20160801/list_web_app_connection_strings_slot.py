...
def list_web_app_connection_strings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:listWebAppConnectionStringsSlot', __args__, opts=opts, typ=ListWebAppConnectionStringsSlotResult).value
...
def list_web_app_connection_strings_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:listWebAppConnectionStringsSlot', __args__, opts=opts, typ=ListWebAppConnectionStringsSlotResult)
