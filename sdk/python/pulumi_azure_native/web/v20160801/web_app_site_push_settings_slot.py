...
warnings.warn("""azure-native:web/v20160801:WebAppSitePushSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSitePushSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
