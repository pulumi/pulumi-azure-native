...
def list_web_app_auth_settings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:listWebAppAuthSettings', __args__, opts=opts, typ=ListWebAppAuthSettingsResult).value
...
def list_web_app_auth_settings_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:listWebAppAuthSettings', __args__, opts=opts, typ=ListWebAppAuthSettingsResult)
