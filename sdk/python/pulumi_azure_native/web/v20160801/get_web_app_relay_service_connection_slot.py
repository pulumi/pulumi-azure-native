...
def get_web_app_relay_service_connection_slot(entity_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:getWebAppRelayServiceConnectionSlot', __args__, opts=opts, typ=GetWebAppRelayServiceConnectionSlotResult).value
...
def get_web_app_relay_service_connection_slot_output(entity_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:getWebAppRelayServiceConnectionSlot', __args__, opts=opts, typ=GetWebAppRelayServiceConnectionSlotResult)
