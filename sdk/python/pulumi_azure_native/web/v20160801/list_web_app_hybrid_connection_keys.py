...
def list_web_app_hybrid_connection_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20160801:listWebAppHybridConnectionKeys', __args__, opts=opts, typ=ListWebAppHybridConnectionKeysResult).value
...
def list_web_app_hybrid_connection_keys_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20160801:listWebAppHybridConnectionKeys', __args__, opts=opts, typ=ListWebAppHybridConnectionKeysResult)
