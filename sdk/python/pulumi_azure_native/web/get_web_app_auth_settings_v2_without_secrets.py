...
def get_web_app_auth_settings_v2_without_secrets(name: Optional[builtins.str] = None,
...
def get_web_app_auth_settings_v2_without_secrets_output(name: Optional[pulumi.Input[builtins.str]] = None,
