...
def list_web_app_site_push_settings(name: Optional[builtins.str] = None,
...
def list_web_app_site_push_settings_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:listWebAppSitePushSettings', __args__, opts=opts, typ=ListWebAppSitePushSettingsResult)
