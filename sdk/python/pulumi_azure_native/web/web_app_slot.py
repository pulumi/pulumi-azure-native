...
class WebAppSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Unique name of the app to create or update. To create or update a deployment slot, use the {slot} parameter.
        :param pulumi.Input[_builtins.str] resource_group_name: Name of the resource group to which the resource belongs.
        :param pulumi.Input[_builtins.str] slot: Name of the deployment slot to create or update. By default, this API attempts to create or modify the production slot.
