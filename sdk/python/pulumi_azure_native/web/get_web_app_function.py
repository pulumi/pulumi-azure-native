...
def get_web_app_function(function_name: Optional[_builtins.str] = None,
...
def get_web_app_function_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
