...
class StaticSiteArgs:
    def __init__(__self__, *,
                 ...
                 allow_config_file_updates: Optional[pulumi.Input[builtins.bool]] = None,
                 branch: Optional[pulumi.Input[builtins.str]] = None,
                 build_properties: Optional[pulumi.Input['StaticSiteBuildPropertiesArgs']] = None,
                 enterprise_grade_cdn_status: Optional[pulumi.Input[Union[builtins.str, 'EnterpriseGradeCdnStatus']]] = None,
                 ...
                 repository_token: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_config_file_updates: <code>false</code> if config file is locked for this static web app; otherwise, <code>true</code>.
        :param pulumi.Input[builtins.str] branch: The target branch in the repository.
        :param pulumi.Input['StaticSiteBuildPropertiesArgs'] build_properties: Build properties to configure on the repository.
        :param pulumi.Input[Union[builtins.str, 'EnterpriseGradeCdnStatus']] enterprise_grade_cdn_status: State indicating the status of the enterprise grade CDN serving traffic to the static web app.
        ...
        :param pulumi.Input[builtins.str] name: Name of the static site to create or update.
        :param pulumi.Input[builtins.str] provider: The provider that submitted the last deployment to the primary environment of the static site.
        :param pulumi.Input[builtins.str] public_network_access: State indicating whether public traffic are allowed or not for a static web app. Allowed Values: 'Enabled', 'Disabled' or an empty string.
        :param pulumi.Input[builtins.str] repository_token: A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
        :param pulumi.Input[builtins.str] repository_url: URL for the repository of the static site.
    ...
    def allow_config_file_updates(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_config_file_updates(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enterprise_grade_cdn_status(self) -> Optional[pulumi.Input[Union[builtins.str, 'EnterpriseGradeCdnStatus']]]:
        """
    ...
    def enterprise_grade_cdn_status(self, value: Optional[pulumi.Input[Union[builtins.str, 'EnterpriseGradeCdnStatus']]]):
    ...
    def repository_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def repository_token(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StaticSite(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allowConfigFileUpdates")
    def allow_config_file_updates(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        <code>false</code> if config file is locked for this static web app; otherwise, <code>true</code>.
        """
        return pulumi.get(self, "allow_config_file_updates")
    ...
    def content_distribution_endpoint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="enterpriseGradeCdnStatus")
    def enterprise_grade_cdn_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        State indicating the status of the enterprise grade CDN serving traffic to the static web app.
        """
        return pulumi.get(self, "enterprise_grade_cdn_status")
    ...
    def key_vault_reference_identity(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="repositoryToken")
    def repository_token(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A user's github repository token. This is used to setup the Github Actions workflow file and API secrets.
        """
        return pulumi.get(self, "repository_token")
    ...
    @property
    @pulumi.getter(name="repositoryUrl")
    def repository_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL for the repository of the static site.
        """
        return pulumi.get(self, "repository_url")
    ...
    @property
    @pulumi.getter(name="stagingEnvironmentPolicy")
    def staging_environment_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        State indicating whether staging environments are allowed or not allowed for a static web app.
        """
        return pulumi.get(self, "staging_environment_policy")
