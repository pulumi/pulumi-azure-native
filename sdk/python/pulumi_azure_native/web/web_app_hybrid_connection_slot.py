...
class WebAppHybridConnectionSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_bus_suffix: The suffix for the service bus endpoint. By default this is .servicebus.windows.net
        """
