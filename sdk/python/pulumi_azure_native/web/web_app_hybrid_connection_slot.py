...
class WebAppHybridConnectionSlotArgs:
    def __init__(__self__, *,
                 ...
                 relay_arm_uri: Optional[pulumi.Input[builtins.str]] = None,
                 relay_name: Optional[pulumi.Input[builtins.str]] = None,
                 send_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 send_key_value: Optional[pulumi.Input[builtins.str]] = None,
                 service_bus_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 service_bus_suffix: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WebAppHybridConnectionSlot resource.
        :param pulumi.Input[builtins.str] name: The name of the web app.
        :param pulumi.Input[builtins.str] namespace_name: The namespace for this hybrid connection.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group to which the resource belongs.
        :param pulumi.Input[builtins.str] slot: The name of the slot for the web app.
        :param pulumi.Input[builtins.str] hostname: The hostname of the endpoint.
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.int] port: The port of the endpoint.
        :param pulumi.Input[builtins.str] relay_arm_uri: The ARM URI to the Service Bus relay.
        :param pulumi.Input[builtins.str] relay_name: The name of the Service Bus relay.
        :param pulumi.Input[builtins.str] send_key_name: The name of the Service Bus key which has Send permissions. This is used to authenticate to Service Bus.
        :param pulumi.Input[builtins.str] send_key_value: The value of the Service Bus key. This is used to authenticate to Service Bus. In ARM this key will not be returned
               normally, use the POST /listKeys API instead.
        :param pulumi.Input[builtins.str] service_bus_namespace: The name of the Service Bus namespace.
        :param pulumi.Input[builtins.str] service_bus_suffix: The suffix for the service bus endpoint. By default this is .servicebus.windows.net
        """
    ...
    def relay_arm_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def relay_arm_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def send_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def send_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "send_key_name", value)

    @property
    @pulumi.getter(name="sendKeyValue")
    def send_key_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def send_key_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "send_key_value", value)

    @property
    @pulumi.getter(name="serviceBusNamespace")
    def service_bus_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_bus_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_bus_namespace", value)

    @property
    @pulumi.getter(name="serviceBusSuffix")
    def service_bus_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_bus_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebAppHybridConnectionSlot(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="relayArmUri")
    def relay_arm_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARM URI to the Service Bus relay.
        """
        return pulumi.get(self, "relay_arm_uri")
    ...
    @property
    @pulumi.getter(name="relayName")
    def relay_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Service Bus relay.
        """
        return pulumi.get(self, "relay_name")
    ...
    @property
    @pulumi.getter(name="sendKeyName")
    def send_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Service Bus key which has Send permissions. This is used to authenticate to Service Bus.
        """
        return pulumi.get(self, "send_key_name")
    ...
    @property
    @pulumi.getter(name="sendKeyValue")
    def send_key_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The value of the Service Bus key. This is used to authenticate to Service Bus. In ARM this key will not be returned
        normally, use the POST /listKeys API instead.
        """
    ...
    @property
    @pulumi.getter(name="serviceBusNamespace")
    def service_bus_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Service Bus namespace.
        """
        return pulumi.get(self, "service_bus_namespace")
    ...
    @property
    @pulumi.getter(name="serviceBusSuffix")
    def service_bus_suffix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The suffix for the service bus endpoint. By default this is .servicebus.windows.net
        """
        return pulumi.get(self, "service_bus_suffix")
