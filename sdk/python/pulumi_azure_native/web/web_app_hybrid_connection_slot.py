...
class WebAppHybridConnectionSlotArgs:
    def __init__(__self__, *,
        ...
        """
        WebAppHybridConnectionSlotArgs._configure(
    ...
    def _configure(
        ...
        if relay_arm_uri is None and 'relayArmUri' in kwargs:
            relay_arm_uri = kwargs['relayArmUri']
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebAppHybridConnectionSlotArgs._configure(_setter, **kwargs)
