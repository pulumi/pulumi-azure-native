...
class CustomApi(pulumi.CustomResource):
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/latest:CustomApi"), pulumi.Alias(type_="azure-nextgen:web/latest:CustomApi"), pulumi.Alias(type_="azure-native:web/v20160601:CustomApi"), pulumi.Alias(type_="azure-nextgen:web/v20160601:CustomApi")])
