...
class GetAiGatewayResult:
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> 'outputs.AiGatewayPropertiesResponse':
        """
...
def get_ai_gateway(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the AI gateway
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getAiGateway', __args__, opts=opts, typ=GetAiGatewayResult).value
...
def get_ai_gateway_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getAiGateway', __args__, opts=opts, typ=GetAiGatewayResult)
