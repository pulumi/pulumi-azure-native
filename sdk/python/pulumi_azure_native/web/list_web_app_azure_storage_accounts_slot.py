...
def list_web_app_azure_storage_accounts_slot(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will update the Azure storage account configurations for the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
