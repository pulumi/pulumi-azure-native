...
def get_web_app_host_name_binding(host_name: Optional[builtins.str] = None,
...
def get_web_app_host_name_binding_output(host_name: Optional[pulumi.Input[builtins.str]] = None,
