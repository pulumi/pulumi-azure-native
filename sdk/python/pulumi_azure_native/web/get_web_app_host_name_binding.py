...
def get_web_app_host_name_binding(host_name: Optional[_builtins.str] = None,
...
def get_web_app_host_name_binding_output(host_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
