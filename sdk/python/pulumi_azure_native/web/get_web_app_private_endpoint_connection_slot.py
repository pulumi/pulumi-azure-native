...
def get_web_app_private_endpoint_connection_slot(name: Optional[builtins.str] = None,
    ...
    :param builtins.str slot: Name of the site deployment slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_web_app_private_endpoint_connection_slot_output(name: Optional[pulumi.Input[builtins.str]] = None,
