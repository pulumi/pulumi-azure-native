...
class AppServicePlanArgs:
    def __init__(__self__, *,
                 ...
                 elastic_scale_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 extended_location: Optional[pulumi.Input['ExtendedLocationArgs']] = None,
                 free_offer_expiration_time: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_spot: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 maximum_elastic_worker_count: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 per_site_scaling: Optional[pulumi.Input[builtins.bool]] = None,
                 reserved: Optional[pulumi.Input[builtins.bool]] = None,
                 sku: Optional[pulumi.Input['SkuDescriptionArgs']] = None,
                 spot_expiration_time: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 target_worker_count: Optional[pulumi.Input[builtins.int]] = None,
                 target_worker_size_id: Optional[pulumi.Input[builtins.int]] = None,
                 worker_tier_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] elastic_scale_enabled: ServerFarm supports ElasticScale. Apps in this plan will scale as if the ServerFarm was ElasticPremium sku
        :param pulumi.Input['ExtendedLocationArgs'] extended_location: Extended Location.
        :param pulumi.Input[builtins.str] free_offer_expiration_time: The time when the server farm free offer expires.
        ...
        :param pulumi.Input[builtins.bool] hyper_v: If Hyper-V container app service plan <code>true</code>, <code>false</code> otherwise.
        :param pulumi.Input[builtins.bool] is_spot: If <code>true</code>, this App Service Plan owns spot instances.
        :param pulumi.Input[builtins.bool] is_xenon: Obsolete: If Hyper-V container app service plan <code>true</code>, <code>false</code> otherwise.
        ...
        :param pulumi.Input[builtins.int] maximum_elastic_worker_count: Maximum number of total workers allowed for this ElasticScaleEnabled App Service Plan
        :param pulumi.Input[builtins.str] name: Name of the App Service plan.
        :param pulumi.Input[builtins.bool] per_site_scaling: If <code>true</code>, apps assigned to this App Service plan can be scaled independently.
               If <code>false</code>, apps assigned to this App Service plan will scale to all instances of the plan.
        :param pulumi.Input[builtins.bool] reserved: If Linux app service plan <code>true</code>, <code>false</code> otherwise.
        :param pulumi.Input['SkuDescriptionArgs'] sku: Description of a SKU for a scalable resource.
        :param pulumi.Input[builtins.str] spot_expiration_time: The time when the server farm expires. Valid only if it is a spot server farm.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Resource tags.
        :param pulumi.Input[builtins.int] target_worker_count: Scaling worker count.
        :param pulumi.Input[builtins.int] target_worker_size_id: Scaling worker size ID.
        :param pulumi.Input[builtins.str] worker_tier_name: Target worker tier assigned to the App Service plan.
        :param pulumi.Input[builtins.bool] zone_redundant: If <code>true</code>, this App Service Plan will perform availability zone balancing.
    ...
    def elastic_scale_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def elastic_scale_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def free_offer_expiration_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def free_offer_expiration_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_spot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_spot.setter
    def is_spot(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def maximum_elastic_worker_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_elastic_worker_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def per_site_scaling(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def per_site_scaling(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def spot_expiration_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spot_expiration_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_worker_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_worker_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_worker_count", value)

    @property
    @pulumi.getter(name="targetWorkerSizeId")
    def target_worker_size_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_worker_size_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_worker_size_id", value)

    @property
    @pulumi.getter(name="workerTierName")
    def worker_tier_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def worker_tier_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppServicePlan(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="elasticScaleEnabled")
    def elastic_scale_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        ServerFarm supports ElasticScale. Apps in this plan will scale as if the ServerFarm was ElasticPremium sku
        """
        return pulumi.get(self, "elastic_scale_enabled")
    ...
    @property
    @pulumi.getter(name="freeOfferExpirationTime")
    def free_offer_expiration_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time when the server farm free offer expires.
        """
        return pulumi.get(self, "free_offer_expiration_time")
    ...
    def geo_region(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="isSpot")
    def is_spot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If <code>true</code>, this App Service Plan owns spot instances.
        """
        return pulumi.get(self, "is_spot")
    ...
    @property
    @pulumi.getter(name="maximumElasticWorkerCount")
    def maximum_elastic_worker_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum number of total workers allowed for this ElasticScaleEnabled App Service Plan
        """
        return pulumi.get(self, "maximum_elastic_worker_count")
    ...
    def maximum_number_of_workers(self) -> pulumi.Output[builtins.int]:
        """
    ...
    def number_of_sites(self) -> pulumi.Output[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="perSiteScaling")
    def per_site_scaling(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If <code>true</code>, apps assigned to this App Service plan can be scaled independently.
        If <code>false</code>, apps assigned to this App Service plan will scale to all instances of the plan.
        """
    ...
    @property
    @pulumi.getter(name="spotExpirationTime")
    def spot_expiration_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time when the server farm expires. Valid only if it is a spot server farm.
        """
        return pulumi.get(self, "spot_expiration_time")
    ...
    @property
    @pulumi.getter(name="targetWorkerCount")
    def target_worker_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Scaling worker count.
        """
        return pulumi.get(self, "target_worker_count")
    ...
    @property
    @pulumi.getter(name="targetWorkerSizeId")
    def target_worker_size_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Scaling worker size ID.
        """
        return pulumi.get(self, "target_worker_size_id")
    ...
    @property
    @pulumi.getter(name="workerTierName")
    def worker_tier_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Target worker tier assigned to the App Service plan.
        """
        return pulumi.get(self, "worker_tier_name")
