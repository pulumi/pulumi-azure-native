...
class AppServicePlanArgs:
    ...
    def _configure(
        ...
        if elastic_scale_enabled is None and 'elasticScaleEnabled' in kwargs:
        ...
        if free_offer_expiration_time is None and 'freeOfferExpirationTime' in kwargs:
        ...
        if kube_environment_profile is None and 'kubeEnvironmentProfile' in kwargs:
...
class AppServicePlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            kube_environment_profile = _utilities.configure(kube_environment_profile, KubeEnvironmentProfileArgs, True)
