...
def get_web_app_private_endpoint_connection(name: Optional[builtins.str] = None,
...
def get_web_app_private_endpoint_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
