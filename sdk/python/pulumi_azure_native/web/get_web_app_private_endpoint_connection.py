...
def get_web_app_private_endpoint_connection(name: Optional[_builtins.str] = None,
...
def get_web_app_private_endpoint_connection_output(name: Optional[pulumi.Input[_builtins.str]] = None,
