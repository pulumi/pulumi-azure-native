...
class WebAppSourceControlSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppSourceControlSlot is deprecated: azure-native:web/v20200901:WebAppSourceControlSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSourceControlSlot to guarantee forwards compatibility.""")
