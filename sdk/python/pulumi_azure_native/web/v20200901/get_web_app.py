...
def get_web_app(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app is deprecated: azure-native:web/v20200901:WebApp is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebApp to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
