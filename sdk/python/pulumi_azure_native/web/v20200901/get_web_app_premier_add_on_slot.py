...
def get_web_app_premier_add_on_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_premier_add_on_slot is deprecated: azure-native:web/v20200901:WebAppPremierAddOnSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppPremierAddOnSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:getWebAppPremierAddOnSlot', __args__, opts=opts, typ=GetWebAppPremierAddOnSlotResult).value
