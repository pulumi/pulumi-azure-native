...
def list_web_app_metadata(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:listWebAppMetadata', __args__, opts=opts, typ=ListWebAppMetadataResult).value
...
def list_web_app_metadata_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200901:listWebAppMetadata', __args__, opts=opts, typ=ListWebAppMetadataResult)
