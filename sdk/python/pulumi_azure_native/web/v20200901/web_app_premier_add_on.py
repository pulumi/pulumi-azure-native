...
warnings.warn("""azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppPremierAddOn(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vendor: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppPremierAddOn is deprecated: azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.""")
