...
warnings.warn("""azure-native:web/v20200901:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAzureStorageAccounts(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAzureStorageAccounts is deprecated: azure-native:web/v20200901:WebAppAzureStorageAccounts is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAzureStorageAccounts to guarantee forwards compatibility.""")
