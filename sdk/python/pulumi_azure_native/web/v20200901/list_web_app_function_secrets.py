...
def list_web_app_function_secrets(function_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:listWebAppFunctionSecrets', __args__, opts=opts, typ=ListWebAppFunctionSecretsResult).value
...
def list_web_app_function_secrets_output(function_name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200901:listWebAppFunctionSecrets', __args__, opts=opts, typ=ListWebAppFunctionSecretsResult)
