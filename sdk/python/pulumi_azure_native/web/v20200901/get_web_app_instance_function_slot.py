...
warnings.warn("""azure-native:web/v20200901:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_instance_function_slot(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_instance_function_slot is deprecated: azure-native:web/v20200901:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:getWebAppInstanceFunctionSlot', __args__, opts=opts, typ=GetWebAppInstanceFunctionSlotResult).value
