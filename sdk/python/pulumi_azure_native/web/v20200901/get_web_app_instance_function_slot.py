...
warnings.warn("""azure-native:web/v20200901:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_instance_function_slot(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_instance_function_slot is deprecated: azure-native:web/v20200901:WebAppInstanceFunctionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppInstanceFunctionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
