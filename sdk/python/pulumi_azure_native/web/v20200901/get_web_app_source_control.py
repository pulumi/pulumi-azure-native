...
def get_web_app_source_control(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_source_control is deprecated: azure-native:web/v20200901:WebAppSourceControl is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppSourceControl to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
