...
def get_web_app_domain_ownership_identifier_slot(domain_ownership_identifier_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_domain_ownership_identifier_slot is deprecated: azure-native:web/v20200901:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""")
    __args__ = dict()
