...
class WebAppVnetConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 vnet_resource_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppVnetConnection is deprecated: azure-native:web/v20200901:WebAppVnetConnection is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppVnetConnection to guarantee forwards compatibility.""")
