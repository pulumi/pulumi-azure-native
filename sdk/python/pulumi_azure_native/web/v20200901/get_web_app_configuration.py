...
class GetWebAppConfigurationResult:
    ...
    """
    def __init__(__self__, always_on=None, api_definition=None, api_management_config=None, app_command_line=None, app_settings=None, auto_heal_enabled=None, auto_heal_rules=None, auto_swap_slot_name=None, connection_strings=None, cors=None, default_documents=None, detailed_error_logging_enabled=None, document_root=None, experiments=None, ftps_state=None, handler_mappings=None, health_check_path=None, http20_enabled=None, http_logging_enabled=None, id=None, ip_security_restrictions=None, java_container=None, java_container_version=None, java_version=None, kind=None, limits=None, linux_fx_version=None, load_balancing=None, local_my_sql_enabled=None, logs_directory_size_limit=None, machine_key=None, managed_pipeline_mode=None, managed_service_identity_id=None, min_tls_version=None, name=None, net_framework_version=None, node_version=None, number_of_workers=None, php_version=None, power_shell_version=None, pre_warmed_instance_count=None, publishing_username=None, push=None, python_version=None, remote_debugging_enabled=None, remote_debugging_version=None, request_tracing_enabled=None, request_tracing_expiration_time=None, scm_ip_security_restrictions=None, scm_ip_security_restrictions_use_main=None, scm_min_tls_version=None, scm_type=None, system_data=None, tracing_options=None, type=None, use32_bit_worker_process=None, virtual_applications=None, vnet_name=None, vnet_private_ports_count=None, vnet_route_all_enabled=None, web_sockets_enabled=None, windows_fx_version=None, x_managed_service_identity_id=None):
        ...
        if api_management_config and not isinstance(api_management_config, dict):
            raise TypeError("Expected argument 'api_management_config' to be a dict")
        ...
        if power_shell_version and not isinstance(power_shell_version, str):
            raise TypeError("Expected argument 'power_shell_version' to be a str")
        pulumi.set(__self__, "power_shell_version", power_shell_version)
        if pre_warmed_instance_count and not isinstance(pre_warmed_instance_count, int):
            raise TypeError("Expected argument 'pre_warmed_instance_count' to be a int")
        ...
        if scm_min_tls_version and not isinstance(scm_min_tls_version, str):
            raise TypeError("Expected argument 'scm_min_tls_version' to be a str")
        ...
        if vnet_private_ports_count and not isinstance(vnet_private_ports_count, int):
            raise TypeError("Expected argument 'vnet_private_ports_count' to be a int")
...
class AwaitableGetWebAppConfigurationResult(GetWebAppConfigurationResult):
    ...
    def __await__(self):
        ...
        return GetWebAppConfigurationResult(
            ...
            api_management_config=self.api_management_config,
            ...
            power_shell_version=self.power_shell_version,
            pre_warmed_instance_count=self.pre_warmed_instance_count,
            ...
            scm_min_tls_version=self.scm_min_tls_version,
            ...
            vnet_private_ports_count=self.vnet_private_ports_count,
...
def get_web_app_configuration(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:getWebAppConfiguration', __args__, opts=opts, typ=GetWebAppConfigurationResult).value

    return AwaitableGetWebAppConfigurationResult(
        always_on=__ret__.always_on,
        api_definition=__ret__.api_definition,
        api_management_config=__ret__.api_management_config,
        ...
        power_shell_version=__ret__.power_shell_version,
        pre_warmed_instance_count=__ret__.pre_warmed_instance_count,
        ...
        scm_min_tls_version=__ret__.scm_min_tls_version,
        ...
        vnet_private_ports_count=__ret__.vnet_private_ports_count,
