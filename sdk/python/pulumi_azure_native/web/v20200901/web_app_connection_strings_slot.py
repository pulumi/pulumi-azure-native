...
warnings.warn("""azure-native:web/v20200901:WebAppConnectionStringsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppConnectionStringsSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppConnectionStringsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppConnectionStringsSlot")])
