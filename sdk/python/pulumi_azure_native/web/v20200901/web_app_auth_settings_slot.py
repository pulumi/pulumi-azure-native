...
warnings.warn("""azure-native:web/v20200901:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20201001:WebAppAuthSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
