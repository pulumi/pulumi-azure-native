...
def get_web_app_premier_add_on(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_premier_add_on is deprecated: azure-native:web/v20200901:WebAppPremierAddOn is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppPremierAddOn to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
