...
warnings.warn("""azure-native:web/v20200901:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.""", DeprecationWarning)
...
class StaticSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        pulumi.log.warn("""StaticSite is deprecated: azure-native:web/v20200901:StaticSite is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:StaticSite to guarantee forwards compatibility.""")
