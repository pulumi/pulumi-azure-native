...
def get_web_app_site_extension_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20200901:getWebAppSiteExtensionSlot', __args__, opts=opts, typ=GetWebAppSiteExtensionSlotResult).value
...
def get_web_app_site_extension_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20200901:getWebAppSiteExtensionSlot', __args__, opts=opts, typ=GetWebAppSiteExtensionSlotResult)
