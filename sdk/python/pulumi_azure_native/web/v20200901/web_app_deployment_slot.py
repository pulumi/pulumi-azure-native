...
warnings.warn("""azure-native:web/v20200901:WebAppDeploymentSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20201001:WebAppDeploymentSlot to guarantee forwards compatibility.""", DeprecationWarning)
