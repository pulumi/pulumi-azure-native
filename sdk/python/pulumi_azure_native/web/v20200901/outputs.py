...
class AzureActiveDirectoryLoginResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "systemData":
            suggest = "system_data"
        elif key == "disableWWWAuthenticate":
...
class CustomOpenIdConnectProviderResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in CustomOpenIdConnectProviderResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        CustomOpenIdConnectProviderResponse.__key_warning(key)
        return super().__getitem__(key)
...
class FileSystemTokenStoreResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FileSystemTokenStoreResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FileSystemTokenStoreResponse.__key_warning(key)
        return super().__getitem__(key)
...
class GitHubResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GitHubResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GitHubResponse.__key_warning(key)
        return super().__getitem__(key)
...
class GoogleResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in GoogleResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        GoogleResponse.__key_warning(key)
        return super().__getitem__(key)
...
class JwtClaimChecksResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "systemData":
            suggest = "system_data"
        elif key == "allowedClientApplications":
...
class LoginScopesResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LoginScopesResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LoginScopesResponse.__key_warning(key)
        return super().__getitem__(key)
...
class NonceResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "systemData":
            suggest = "system_data"
        elif key == "nonceExpirationInterval":
...
class TwitterResponse(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TwitterResponse. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TwitterResponse.__key_warning(key)
        return super().__getitem__(key)
