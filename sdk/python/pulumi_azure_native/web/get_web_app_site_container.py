...
def get_web_app_site_container(container_name: Optional[_builtins.str] = None,
...
def get_web_app_site_container_output(container_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
