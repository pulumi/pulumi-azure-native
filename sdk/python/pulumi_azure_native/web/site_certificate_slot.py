...
class SiteCertificateSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20241101:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20250301:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20250501:SiteCertificateSlot")])
