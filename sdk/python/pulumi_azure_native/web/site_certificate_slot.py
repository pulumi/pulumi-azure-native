...
class SiteCertificateSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SiteCertificateSlotArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20241101:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20250301:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20250501:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20260301preview:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20260315:SiteCertificateSlot"), pulumi.Alias(type_="azure-native:web/v20260715:SiteCertificateSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteCertificateSlot, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SiteCertificateSlot':
        """
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["valid"] = None
        return SiteCertificateSlot(resource_name, opts=opts, __props__=__props__)
