...
def get_static_site_database_connection(database_connection_name: Optional[_builtins.str] = None,
...
def get_static_site_database_connection_output(database_connection_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
