...
class WebAppAuthSettingsV2WithoutSecretsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20200601:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20231201:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppAuthSettingsV2WithoutSecretsSlot"), pulumi.Alias(type_="azure-native:web:WebAppAuthSettingsV2WithoutSecretsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppAuthSettingsV2WithoutSecretsSlot, __self__).__init__(
            'azure-native:web/v20230101:WebAppAuthSettingsV2WithoutSecretsSlot',
            resource_name,
            __props__,
            opts)
