...
class WebAppScmAllowedSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20201201:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20210115:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20210201:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20210301:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20220301:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20220901:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20231201:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web/v20240401:WebAppScmAllowedSlot"), pulumi.Alias(type_="azure-native:web:WebAppScmAllowedSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppScmAllowedSlot, __self__).__init__(
            'azure-native:web/v20230101:WebAppScmAllowedSlot',
            resource_name,
            __props__,
            opts)
