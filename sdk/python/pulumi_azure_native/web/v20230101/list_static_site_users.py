...
def list_static_site_users(authprovider: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20230101:listStaticSiteUsers', __args__, opts=opts, typ=ListStaticSiteUsersResult).value
...
def list_static_site_users_output(authprovider: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20230101:listStaticSiteUsers', __args__, opts=opts, typ=ListStaticSiteUsersResult)
