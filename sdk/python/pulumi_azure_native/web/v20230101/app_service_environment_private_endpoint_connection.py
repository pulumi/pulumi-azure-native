...
class AppServiceEnvironmentPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppServiceEnvironmentPrivateEndpointConnectionArgs.__new__(AppServiceEnvironmentPrivateEndpointConnectionArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20201201:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210101:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210115:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210201:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20210301:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20220301:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20220901:AppServiceEnvironmentPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20231201:AppServiceEnvironmentPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AppServiceEnvironmentPrivateEndpointConnection, __self__).__init__(
            'azure-native:web/v20230101:AppServiceEnvironmentPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AppServiceEnvironmentPrivateEndpointConnection':
        """
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return AppServiceEnvironmentPrivateEndpointConnection(resource_name, opts=opts, __props__=__props__)
