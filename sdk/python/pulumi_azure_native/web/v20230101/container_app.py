...
class ContainerApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20210301:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20220301:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20220901:ContainerApp"), pulumi.Alias(type_="azure-native:web/v20231201:ContainerApp")])
