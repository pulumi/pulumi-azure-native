...
def get_web_app_source_control(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20230101:getWebAppSourceControl', __args__, opts=opts, typ=GetWebAppSourceControlResult).value
...
def get_web_app_source_control_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20230101:getWebAppSourceControl', __args__, opts=opts, typ=GetWebAppSourceControlResult)
