...
class StaticSiteBuildDatabaseConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteBuildDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteBuildDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20231201:StaticSiteBuildDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20240401:StaticSiteBuildDatabaseConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSiteBuildDatabaseConnection, __self__).__init__(
            'azure-native:web/v20230101:StaticSiteBuildDatabaseConnection',
            resource_name,
            __props__,
            opts)
