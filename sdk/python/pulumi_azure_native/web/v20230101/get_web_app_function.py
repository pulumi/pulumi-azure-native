...
def get_web_app_function(function_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20230101:getWebAppFunction', __args__, opts=opts, typ=GetWebAppFunctionResult).value
...
def get_web_app_function_output(function_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20230101:getWebAppFunction', __args__, opts=opts, typ=GetWebAppFunctionResult)
