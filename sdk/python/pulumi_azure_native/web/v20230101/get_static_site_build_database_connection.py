...
def get_static_site_build_database_connection(database_connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20230101:getStaticSiteBuildDatabaseConnection', __args__, opts=opts, typ=GetStaticSiteBuildDatabaseConnectionResult).value
...
def get_static_site_build_database_connection_output(database_connection_name: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20230101:getStaticSiteBuildDatabaseConnection', __args__, opts=opts, typ=GetStaticSiteBuildDatabaseConnectionResult)
