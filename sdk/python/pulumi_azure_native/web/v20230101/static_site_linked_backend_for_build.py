...
class StaticSiteLinkedBackendForBuild(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220301:StaticSiteLinkedBackendForBuild"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteLinkedBackendForBuild"), pulumi.Alias(type_="azure-native:web/v20231201:StaticSiteLinkedBackendForBuild"), pulumi.Alias(type_="azure-native:web/v20240401:StaticSiteLinkedBackendForBuild"), pulumi.Alias(type_="azure-native:web:StaticSiteLinkedBackendForBuild")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSiteLinkedBackendForBuild, __self__).__init__(
            'azure-native:web/v20230101:StaticSiteLinkedBackendForBuild',
            resource_name,
            __props__,
            opts)
