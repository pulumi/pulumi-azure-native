...
class StaticSiteDatabaseConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:StaticSiteDatabaseConnection"), pulumi.Alias(type_="azure-native:web/v20220901:StaticSiteDatabaseConnection")])
