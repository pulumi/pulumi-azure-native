...
def list_web_app_connection_strings_slot(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slot: Name of the deployment slot. If a slot is not specified, the API will get the connection settings for the production slot.
    """
    __args__ = dict()
    __args__['name'] = name
...
def list_web_app_connection_strings_slot_output(name: Optional[pulumi.Input[_builtins.str]] = None,
