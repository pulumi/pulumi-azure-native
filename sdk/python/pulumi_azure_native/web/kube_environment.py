...
class KubeEnvironmentArgs:
    ...
    def _configure(
        ...
        if 'arcConfiguration' in kwargs:
            arc_configuration = kwargs['arcConfiguration']
        if 'containerAppsConfiguration' in kwargs:
...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if arc_configuration is not None and not isinstance(arc_configuration, ArcConfigurationArgs):
            ...
            if container_apps_configuration is not None and not isinstance(container_apps_configuration, ContainerAppsConfigurationArgs):
