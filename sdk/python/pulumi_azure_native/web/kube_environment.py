...
class KubeEnvironmentArgs:
    ...
    def _configure(
        ...
        if arc_configuration is None and 'arcConfiguration' in kwargs:
            arc_configuration = kwargs['arcConfiguration']
        if container_apps_configuration is None and 'containerAppsConfiguration' in kwargs:
            container_apps_configuration = kwargs['containerAppsConfiguration']
...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            arc_configuration = _utilities.configure(arc_configuration, ArcConfigurationArgs, True)
            __props__.__dict__["arc_configuration"] = arc_configuration
            container_apps_configuration = _utilities.configure(container_apps_configuration, ContainerAppsConfigurationArgs, True)
