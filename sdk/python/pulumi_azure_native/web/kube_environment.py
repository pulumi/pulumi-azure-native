...
class KubeEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 internal_load_balancer_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kind: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 static_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] environment_type: Type of Kubernetes Environment. Only supported for Container App Environments with value as Managed
        :param pulumi.Input['ExtendedLocationArgs'] extended_location: Extended Location.
        :param pulumi.Input[builtins.bool] internal_load_balancer_enabled: Only visible within Vnet/Subnet
        ...
        :param pulumi.Input[builtins.str] name: Name of the Kubernetes Environment.
        :param pulumi.Input[builtins.str] static_ip: Static IP of the KubeEnvironment
    ...
    def internal_load_balancer_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def internal_load_balancer_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def static_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @static_ip.setter
    def static_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Other available API versions: 2021-01-01, 2021-01-15, 2021-02-01, 2021-03-01, 2022-03-01, 2022-09-01, 2023-01-01, 2023-12-01, 2024-11-01, 2025-03-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native web [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
    ...
    @property
    @pulumi.getter(name="aksResourceID")
    def aks_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "aks_resource_id")
    ...
    @property
    @pulumi.getter(name="internalLoadBalancerEnabled")
    def internal_load_balancer_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Only visible within Vnet/Subnet
        """
        return pulumi.get(self, "internal_load_balancer_enabled")
    ...
    @property
    @pulumi.getter(name="staticIp")
    def static_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Static IP of the KubeEnvironment
        """
        return pulumi.get(self, "static_ip")
