...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20220901:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20230101:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20231201:KubeEnvironment"), pulumi.Alias(type_="azure-native:web/v20240401:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20210101:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20210115:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20210201:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20210301:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20220301:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20220901:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20230101:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20231201:web:KubeEnvironment"), pulumi.Alias(type_="azure-native_web_v20240401:web:KubeEnvironment")])
