...
warnings.warn("""azure-native:web/v20210101:WebAppDomainOwnershipIdentifierSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppDomainOwnershipIdentifierSlot to guarantee forwards compatibility.""", DeprecationWarning)
