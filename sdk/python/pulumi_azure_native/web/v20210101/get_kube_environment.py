...
def get_kube_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_kube_environment is deprecated: azure-native:web/v20210101:KubeEnvironment is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:KubeEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
