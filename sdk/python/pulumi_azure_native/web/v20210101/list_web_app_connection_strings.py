...
def list_web_app_connection_strings(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210101:listWebAppConnectionStrings', __args__, opts=opts, typ=ListWebAppConnectionStringsResult).value
...
def list_web_app_connection_strings_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210101:listWebAppConnectionStrings', __args__, opts=opts, typ=ListWebAppConnectionStringsResult)
