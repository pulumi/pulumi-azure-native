...
warnings.warn("""azure-native:web/v20210101:WebAppSitePushSettings is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSitePushSettings to guarantee forwards compatibility.""", DeprecationWarning)
