...
def get_web_app_slot_configuration_names(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_slot_configuration_names is deprecated: azure-native:web/v20210101:WebAppSlotConfigurationNames is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppSlotConfigurationNames to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
