...
warnings.warn("""azure-native:web/v20210101:WebAppHostNameBinding is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHostNameBinding to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppHostNameBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 thumbprint: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppHostNameBinding is deprecated: azure-native:web/v20210101:WebAppHostNameBinding is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppHostNameBinding to guarantee forwards compatibility.""")
