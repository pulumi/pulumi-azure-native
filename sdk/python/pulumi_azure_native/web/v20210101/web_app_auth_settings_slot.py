...
warnings.warn("""azure-native:web/v20210101:WebAppAuthSettingsSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppAuthSettingsSlot to guarantee forwards compatibility.""", DeprecationWarning)
