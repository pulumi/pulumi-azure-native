...
def list_web_app_host_keys_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210101:listWebAppHostKeysSlot', __args__, opts=opts, typ=ListWebAppHostKeysSlotResult).value
...
def list_web_app_host_keys_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20210101:listWebAppHostKeysSlot', __args__, opts=opts, typ=ListWebAppHostKeysSlotResult)
