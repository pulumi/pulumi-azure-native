...
class StaticSiteCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210101:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web/v20201201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20210115:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web/v20210115:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20210201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web/v20210201:StaticSiteCustomDomain")])
