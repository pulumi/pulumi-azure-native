...
def get_app_service_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_environment is deprecated: azure-native:web/v20210101:AppServiceEnvironment is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210115:AppServiceEnvironment to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
