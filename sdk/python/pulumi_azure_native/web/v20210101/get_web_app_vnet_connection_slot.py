...
warnings.warn("""azure-native:web/v20210101:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.""", DeprecationWarning)
...
def get_web_app_vnet_connection_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_vnet_connection_slot is deprecated: azure-native:web/v20210101:WebAppVnetConnectionSlot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20220901:WebAppVnetConnectionSlot to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['name'] = name
