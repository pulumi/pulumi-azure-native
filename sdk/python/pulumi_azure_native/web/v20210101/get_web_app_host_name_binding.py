...
def get_web_app_host_name_binding(host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_host_name_binding is deprecated: azure-native:web/v20210101:WebAppHostNameBinding is being removed in the next major version of this provider. Upgrade to at least azure-native:web/v20220901:WebAppHostNameBinding to guarantee forwards compatibility.""")
    __args__ = dict()
    __args__['hostName'] = host_name
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20210101:getWebAppHostNameBinding', __args__, opts=opts, typ=GetWebAppHostNameBindingResult).value
