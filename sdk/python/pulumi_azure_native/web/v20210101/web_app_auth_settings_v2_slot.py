...
warnings.warn("""azure-native:web/v20210101:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.""", DeprecationWarning)
...
class WebAppAuthSettingsV2Slot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 slot: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""WebAppAuthSettingsV2Slot is deprecated: azure-native:web/v20210101:WebAppAuthSettingsV2Slot is being removed in the next major version of this provider. Please upgrade to azure-native:web/v20210201:WebAppAuthSettingsV2Slot to guarantee forwards compatibility.""")
