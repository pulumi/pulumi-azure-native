...
class WebAppBackupConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_url: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] storage_account_url: SAS URL to the container.
        ...
        :param pulumi.Input[builtins.bool] enabled: True if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.
    ...
    def storage_account_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_account_url(self, value: pulumi.Input[builtins.str]):
...
class WebAppBackupConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupName")
    def backup_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the backup.
        """
        return pulumi.get(self, "backup_name")
    ...
    @property
    @pulumi.getter(name="storageAccountUrl")
    def storage_account_url(self) -> pulumi.Output[builtins.str]:
        """
        SAS URL to the container.
        """
        return pulumi.get(self, "storage_account_url")
