...
class WebAppVnetConnectionSlotArgs:
    def __init__(__self__, *,
                 ...
                 is_swift: Optional[pulumi.Input[builtins.bool]] = None,
                 kind: Optional[pulumi.Input[builtins.str]] = None,
                 vnet_name: Optional[pulumi.Input[builtins.str]] = None,
                 vnet_resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] slot: Name of the deployment slot. If a slot is not specified, the API will add or update connections for the production slot.
        :param pulumi.Input[builtins.str] cert_blob: A certificate file (.cer) blob containing the public key of the private key used to authenticate a 
               Point-To-Site VPN connection.
        :param pulumi.Input[builtins.str] dns_servers: DNS servers to be used by this Virtual Network. This should be a comma-separated list of IP addresses.
        :param pulumi.Input[builtins.bool] is_swift: Flag that is used to denote if this is VNET injection
        :param pulumi.Input[builtins.str] kind: Kind of resource.
        :param pulumi.Input[builtins.str] vnet_name: Name of an existing Virtual Network.
        :param pulumi.Input[builtins.str] vnet_resource_id: The Virtual Network's resource ID.
        """
    ...
    def is_swift(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_swift.setter
    def is_swift(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vnet_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vnet_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    ...
    def cert_thumbprint(self) -> pulumi.Output[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="dnsServers")
    def dns_servers(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        DNS servers to be used by this Virtual Network. This should be a comma-separated list of IP addresses.
        """
        return pulumi.get(self, "dns_servers")
    ...
    @property
    @pulumi.getter(name="isSwift")
    def is_swift(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that is used to denote if this is VNET injection
        """
        return pulumi.get(self, "is_swift")
    ...
    def resync_required(self) -> pulumi.Output[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter(name="vnetResourceId")
    def vnet_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Virtual Network's resource ID.
        """
        return pulumi.get(self, "vnet_resource_id")
