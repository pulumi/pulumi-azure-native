...
class GetSiteCertificateResult:
    ...
    def canonical_name(self) -> Optional[builtins.str]:
        """
    ...
    def cer_blob(self) -> builtins.str:
        """
    ...
    def domain_validation_method(self) -> Optional[builtins.str]:
        """
    ...
    def host_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def key_vault_secret_status(self) -> builtins.str:
        """
    ...
    def pfx_blob(self) -> Optional[builtins.str]:
        """
        Pfx blob.
        """
...
def get_site_certificate(certificate_name: Optional[builtins.str] = None,
                         name: Optional[builtins.str] = None,
                         resource_group_name: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSiteCertificateResult:
    """
    SSL certificate for an app.
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web:getSiteCertificate', __args__, opts=opts, typ=GetSiteCertificateResult).value

    return AwaitableGetSiteCertificateResult(
...
def get_site_certificate_output(certificate_name: Optional[pulumi.Input[builtins.str]] = None,
                                name: Optional[pulumi.Input[builtins.str]] = None,
                                resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSiteCertificateResult]:
    """
    SSL certificate for an app.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web:getSiteCertificate', __args__, opts=opts, typ=GetSiteCertificateResult)
    return __ret__.apply(lambda __response__: GetSiteCertificateResult(
