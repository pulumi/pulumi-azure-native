...
def get_site_certificate(certificate_name: Optional[_builtins.str] = None,
...
def get_site_certificate_output(certificate_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
