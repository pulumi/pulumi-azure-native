...
def list_web_app_backup_status_secrets(backup_id: Optional[_builtins.str] = None,
...
def list_web_app_backup_status_secrets_output(backup_id: Optional[pulumi.Input[_builtins.str]] = None,
