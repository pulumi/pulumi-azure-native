...
def get_web_app_instance_function_slot(function_name: Optional[builtins.str] = None,
...
def get_web_app_instance_function_slot_output(function_name: Optional[pulumi.Input[builtins.str]] = None,
