...
def get_web_app_auth_settings_v2_without_secrets_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20240401:getWebAppAuthSettingsV2WithoutSecretsSlot', __args__, opts=opts, typ=GetWebAppAuthSettingsV2WithoutSecretsSlotResult).value
...
def get_web_app_auth_settings_v2_without_secrets_slot_output(name: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20240401:getWebAppAuthSettingsV2WithoutSecretsSlot', __args__, opts=opts, typ=GetWebAppAuthSettingsV2WithoutSecretsSlotResult)
