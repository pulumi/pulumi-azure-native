...
class WebAppSiteContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web:WebAppSiteContainer"), pulumi.Alias(type_="azure-native:web/v20231201:WebAppSiteContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSiteContainer, __self__).__init__(
            'azure-native:web/v20240401:WebAppSiteContainer',
            resource_name,
            __props__,
            opts)
