...
class WebAppSiteContainerSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-native:web/v20231201:WebAppSiteContainerSlot"), pulumi.Alias(type_="azure-native:web:WebAppSiteContainerSlot")])
