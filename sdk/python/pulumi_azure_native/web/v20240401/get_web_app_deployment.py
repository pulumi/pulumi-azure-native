...
def get_web_app_deployment(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20240401:getWebAppDeployment', __args__, opts=opts, typ=GetWebAppDeploymentResult).value
...
def get_web_app_deployment_output(id: Optional[pulumi.Input[str]] = None,
    ...
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('azure-native:web/v20240401:getWebAppDeployment', __args__, opts=opts, typ=GetWebAppDeploymentResult)
