...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppFunction'.""", DeprecationWarning)
...
def get_web_app_function(function_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppFunction', __args__, opts=opts, typ=GetWebAppFunctionResult).value
