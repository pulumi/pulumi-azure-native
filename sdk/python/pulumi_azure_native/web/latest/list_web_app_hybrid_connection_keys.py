...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppHybridConnectionKeys'.""", DeprecationWarning)
...
def list_web_app_hybrid_connection_keys(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppHybridConnectionKeys', __args__, opts=opts, typ=ListWebAppHybridConnectionKeysResult).value
