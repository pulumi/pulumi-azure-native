...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppVnetConnectionSlot'.""", DeprecationWarning)
...
class WebAppVnetConnectionSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppVnetConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppVnetConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppVnetConnectionSlot, __self__).__init__(
            'azure-native:web/latest:WebAppVnetConnectionSlot',
            resource_name,
            __props__,
            opts)
