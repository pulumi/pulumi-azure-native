...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppHostNameBinding'.""", DeprecationWarning)
...
def get_web_app_host_name_binding(host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppHostNameBinding', __args__, opts=opts, typ=GetWebAppHostNameBindingResult).value
