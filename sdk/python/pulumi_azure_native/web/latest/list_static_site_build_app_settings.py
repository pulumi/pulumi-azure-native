...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteBuildAppSettings'.""", DeprecationWarning)
...
def list_static_site_build_app_settings(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_static_site_build_app_settings is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteBuildAppSettings'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listStaticSiteBuildAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildAppSettingsResult).value
