...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppDomainOwnershipIdentifier'.""", DeprecationWarning)
...
def get_web_app_domain_ownership_identifier(domain_ownership_identifier_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_domain_ownership_identifier is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppDomainOwnershipIdentifier'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppDomainOwnershipIdentifier', __args__, opts=opts, typ=GetWebAppDomainOwnershipIdentifierResult).value
