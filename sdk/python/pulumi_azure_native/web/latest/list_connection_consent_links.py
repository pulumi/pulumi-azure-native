...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listConnectionConsentLinks'.""", DeprecationWarning)
...
def list_connection_consent_links(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listConnectionConsentLinks', __args__, opts=opts, typ=ListConnectionConsentLinksResult).value
