...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteCustomDomain'.""", DeprecationWarning)
...
def get_static_site_custom_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_custom_domain is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteCustomDomain'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getStaticSiteCustomDomain', __args__, opts=opts, typ=GetStaticSiteCustomDomainResult).value
