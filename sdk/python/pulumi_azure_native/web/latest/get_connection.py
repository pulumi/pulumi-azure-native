...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getConnection'.""", DeprecationWarning)
...
def get_connection(connection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
