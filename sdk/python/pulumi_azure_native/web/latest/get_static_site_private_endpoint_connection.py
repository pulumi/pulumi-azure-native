...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSitePrivateEndpointConnection'.""", DeprecationWarning)
...
def get_static_site_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_private_endpoint_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSitePrivateEndpointConnection'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getStaticSitePrivateEndpointConnection', __args__, opts=opts, typ=GetStaticSitePrivateEndpointConnectionResult).value
