...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppAzureStorageAccounts'.""", DeprecationWarning)
...
def list_web_app_azure_storage_accounts(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppAzureStorageAccounts', __args__, opts=opts, typ=ListWebAppAzureStorageAccountsResult).value
