...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppPremierAddOnSlot'.""", DeprecationWarning)
...
class WebAppPremierAddOnSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        super(WebAppPremierAddOnSlot, __self__).__init__(
            'azure-native:web/latest:WebAppPremierAddOnSlot',
            resource_name,
            __props__,
            opts)
