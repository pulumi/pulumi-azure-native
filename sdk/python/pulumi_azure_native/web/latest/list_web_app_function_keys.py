...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppFunctionKeys'.""", DeprecationWarning)
...
def list_web_app_function_keys(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_function_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppFunctionKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppFunctionKeys', __args__, opts=opts, typ=ListWebAppFunctionKeysResult).value
