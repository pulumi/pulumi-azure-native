...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getAppServicePlan'.""", DeprecationWarning)
...
def get_app_service_plan(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getAppServicePlan', __args__, opts=opts, typ=GetAppServicePlanResult).value
