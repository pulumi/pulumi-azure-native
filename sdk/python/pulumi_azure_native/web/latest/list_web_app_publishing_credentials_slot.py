...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppPublishingCredentialsSlot'.""", DeprecationWarning)
...
def list_web_app_publishing_credentials_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_publishing_credentials_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppPublishingCredentialsSlot'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppPublishingCredentialsSlot', __args__, opts=opts, typ=ListWebAppPublishingCredentialsSlotResult).value
